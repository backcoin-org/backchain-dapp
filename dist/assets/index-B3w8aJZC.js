import{defaultConfig as Ed,createWeb3Modal as Td}from"https://esm.sh/@web3modal/ethers@5.1.11?bundle";import{initializeApp as Cd}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-app.js";import{getAuth as Id,onAuthStateChanged as Ad,signInAnonymously as Pd}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-auth.js";import{getFirestore as zd,collection as qe,query as Nt,where as Xa,orderBy as Zt,getDocs as ut,doc as se,getDoc as ze,limit as Bd,serverTimestamp as pt,writeBatch as dn,updateDoc as un,increment as Oe,setDoc as pn,Timestamp as $r,addDoc as Nd,deleteDoc as Sd}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-firestore.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function a(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(i){if(i.ep)return;i.ep=!0;const r=a(i);fetch(i.href,r)}})();const Be={sidebar:document.getElementById("sidebar"),sidebarBackdrop:document.getElementById("sidebar-backdrop"),menuBtn:document.getElementById("menu-btn"),navLinks:document.getElementById("nav-links"),mainContentSections:document.querySelectorAll("main section"),connectButtonDesktop:document.getElementById("connectButtonDesktop"),connectButtonMobile:document.getElementById("connectButtonMobile"),mobileAppDisplay:document.getElementById("mobileAppDisplay"),desktopDisconnected:document.getElementById("desktopDisconnected"),desktopConnectedInfo:document.getElementById("desktopConnectedInfo"),desktopUserAddress:document.getElementById("desktopUserAddress"),desktopUserBalance:document.getElementById("desktopUserBalance"),modalContainer:document.getElementById("modal-container"),toastContainer:document.getElementById("toast-container"),dashboard:document.getElementById("dashboard"),earn:document.getElementById("mine"),store:document.getElementById("store"),rental:document.getElementById("rental"),rewards:document.getElementById("rewards"),actions:document.getElementById("actions"),presale:document.getElementById("presale"),faucet:document.getElementById("faucet"),airdrop:document.getElementById("airdrop"),dao:document.getElementById("dao"),about:document.getElementById("about"),admin:document.getElementById("admin"),tokenomics:document.getElementById("tokenomics"),notary:document.getElementById("notary"),statTotalSupply:document.getElementById("statTotalSupply"),statValidators:document.getElementById("statValidators"),statTotalPStake:document.getElementById("statTotalPStake"),statScarcity:document.getElementById("statScarcity"),statLockedPercentage:document.getElementById("statLockedPercentage"),statUserBalance:document.getElementById("statUserBalance"),statUserPStake:document.getElementById("statUserPStake"),statUserRewards:document.getElementById("statUserRewards")},$d={provider:null,publicProvider:null,web3Provider:null,signer:null,userAddress:null,isConnected:!1,bkcTokenContract:null,ecosystemManagerContract:null,stakingPoolContract:null,buybackMinerContract:null,rewardBoosterContract:null,fortunePoolContract:null,agoraContract:null,notaryContract:null,charityPoolContract:null,rentalManagerContract:null,faucetContract:null,liquidityPoolContract:null,governanceContract:null,bkcTokenContractPublic:null,ecosystemManagerContractPublic:null,stakingPoolContractPublic:null,buybackMinerContractPublic:null,fortunePoolContractPublic:null,agoraContractPublic:null,notaryContractPublic:null,charityPoolContractPublic:null,rentalManagerContractPublic:null,faucetContractPublic:null,currentUserBalance:0n,currentUserNativeBalance:0n,userTotalPStake:0n,userDelegations:[],myBoosters:[],activityHistory:[],totalNetworkPStake:0n,allValidatorsData:[],systemFees:{},systemPStakes:{},boosterDiscounts:{},notaryFee:void 0,notaryMinPStake:void 0},Ld={set(e,t,a){const n=e[t];if(e[t]=a,["currentUserBalance","isConnected","userTotalPStake","totalNetworkPStake"].includes(t)){if(n===a)return!0;window.updateUIState&&window.updateUIState()}return!0}},c=new Proxy($d,Ld);let Lr=!1;const x=(e,t="info",a=null)=>{if(!Be.toastContainer)return;const n={success:{icon:"fa-check-circle",color:"bg-green-600",border:"border-green-400"},error:{icon:"fa-exclamation-triangle",color:"bg-red-600",border:"border-red-400"},info:{icon:"fa-info-circle",color:"bg-blue-600",border:"border-blue-400"},warning:{icon:"fa-exclamation-circle",color:"bg-yellow-600",border:"border-yellow-400"}},i=n[t]||n.info,r=document.createElement("div");r.className=`flex items-center w-full max-w-xs p-4 text-white rounded-lg shadow-lg transition-all duration-500 ease-out 
    ...
    `;e.innerHTML=i,e.querySelectorAll(".pagination-btn").forEach(r=>{r.addEventListener("click",()=>{r.hasAttribute("disabled")||n(parseInt(r.dataset.page))})})}const Wu="modulepreload",Gu=function(e){return"/"+e},Xr={},K=function(t,a,n){let i=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),o=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));i=Promise.allSettled(a.map(l=>{if(l=Gu(l),l in Xr)return;Xr[l]=!0;const d=l.endsWith(".css"),u=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${u}`))return;const f=document.createElement("link");if(f.rel=d?"stylesheet":Wu,d||(f.as="script"),f.crossOrigin="",f.href=l,o&&f.setAttribute("nonce",o),document.head.appendChild(f),d)return new Promise((p,b)=>{f.addEventListener("load",p),f.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${l}`)))})}))}function r(s){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=s,window.dispatchEvent(o),!o.defaultPrevented)throw s}return i.then(s=>{for(const o of s||[])o.status==="rejected"&&r(o.reason);return t().catch(r)})},oo="https://faucet-4wvdcuoouq-uc.a.run.app";function gn(){var e;return(v==null?void 0:v.faucet)||(M==null?void 0:M.faucet)||((e=window.contractAddresses)==null?void 0:e.faucet)||null}const Za=["function claim() external","function canClaim(address user) view returns (bool)","function getUserInfo(address user) view returns (bool canClaimNow, uint256 lastClaim, uint256 nextClaim, uint256 tokensAvailable)","function cooldown() view returns (uint256)","function tokensPerClaim() view returns (uint256)","function ethPerClaim() view returns (uint256)","function getFaucetStatus() view returns (uint256 _tokensPerClaim, uint256 _ethPerClaim, uint256 _cooldown, uint256 bkcBalance, uint256 ethBalance, bool isPaused)","function getStats() view returns (uint256 totalClaims, uint256 totalBkcDistributed, uint256 totalEthDistributed)","event TokensClaimed(address indexed user, uint256 bkcAmount, uint256 ethAmount)"];function Ku(){var e,t;return typeof State<"u"&&(State!=null&&State.userAddress)?State.userAddress:(e=window.State)!=null&&e.userAddress?window.State.userAddress:window.userAddress?window.userAddress:(t=window.ethereum)!=null&&t.selectedAddress?window.ethereum.selectedAddress:null}function It(e,t="info"){if(typeof window.showToast=="function"){window.showToast(e,t);return}(t==="error"?console.error:console.log)(`[Faucet] ${e}`)}async function lo(){if(typeof window.loadUserData=="function"){await window.loadUserData();return}if(typeof window.refreshBalances=="function"){await window.refreshBalances();return}}async function Ri({button:e=null,address:t=null,onSuccess:a=null,onError:n=null}={}){const i=t||Ku();if(!i){const o="Please connect wallet first";return It(o,"error"),n&&n(new Error(o)),{success:!1,error:o}}const r=(e==null?void 0:e.innerHTML)||"Claim",s=(e==null?void 0:e.disabled)||!1;e&&(e.innerHTML='<div class="loader inline-block"></div> Claiming...',e.disabled=!0);try{const o=await fetch(`${oo}?address=${i}`,{method:"GET",headers:{Accept:"application/json"}}),l=await o.json();if(o.ok&&l.success){It("Tokens received!","success"),await lo();const d={success:!0,txHash:l.txHash,bkcAmount:l.bkcAmount,ethAmount:l.ethAmount};return a&&a(d),d}else{const d=l.error||l.message||"Faucet unavailable";It(d,"error");const u=new Error(d);return n&&n(u),{success:!1,error:d}}}catch(o){return console.error("Faucet error:",o),It("Faucet unavailable","error"),n&&n(o),{success:!1,error:o.message}}finally{e&&(e.innerHTML=r,e.disabled=s)}}const _i=async e=>await Ri({button:e});async function co({button:e=null,onSuccess:t=null,onError:a=null}={}){const n=gn();if(!n){const r="Faucet contract address not configured";return It(r,"error"),a&&a(new Error(r)),{success:!1,error:r}}const{txEngine:i}=await K(async()=>{const{txEngine:r}=await import("./index-D_2TdD3O.js");return{txEngine:r}},[]);return await i.execute({name:"FaucetClaim",button:e,getContract:async r=>{const s=window.ethers;return new s.Contract(n,Za,r)},method:"claim",args:[],validate:async(r,s)=>{const o=window.ethers,{NetworkManager:l}=await K(async()=>{const{NetworkManager:f}=await import("./index-D_2TdD3O.js");return{NetworkManager:f}},[]),d=l.getProvider(),u=new o.Contract(n,Za,d);try{const f=await u.getUserInfo(s);if(!f.canClaimNow){const p=Math.floor(Date.now()/1e3),b=Number(f.nextClaim)-p;if(b>0){const g=Math.ceil(b/60);throw new Error(`Please wait ${g} minutes before claiming again`)}}}catch(f){if(f.message.includes("wait"))throw f;if(!await u.canClaim(s))throw new Error("Cannot claim yet. Please wait for cooldown.")}},onSuccess:async r=>{It("Tokens received!","success"),await lo(),t&&t(r)},onError:r=>{It(r.message||"Claim failed","error"),a&&a(r)}})}async function uo(e){const t=gn();if(!t)return{canClaim:!1,error:"Faucet not configured"};try{const a=window.ethers,{NetworkManager:n}=await K(async()=>{const{NetworkManager:s}=await import("./index-D_2TdD3O.js");return{NetworkManager:s}},[]),i=n.getProvider(),r=new a.Contract(t,Za,i);try{const s=await r.getUserInfo(e),o=Math.floor(Date.now()/1e3);return{canClaim:s.canClaimNow,lastClaimTime:Number(s.lastClaim),nextClaimTime:Number(s.nextClaim),tokensAvailable:s.tokensAvailable,waitSeconds:s.canClaimNow?0:Math.max(0,Number(s.nextClaim)-o)}}catch{return{canClaim:await r.canClaim(e),waitSeconds:0}}}catch(a){return console.error("Error checking claim status:",a),{canClaim:!1,error:a.message}}}async function po(){const e=gn();if(!e)return{error:"Faucet not configured"};try{const t=window.ethers,{NetworkManager:a}=await K(async()=>{const{NetworkManager:r}=await import("./index-D_2TdD3O.js");return{NetworkManager:r}},[]),n=a.getProvider(),i=new t.Contract(e,Za,n);try{const r=await i.getFaucetStatus();return{bkcAmount:r._tokensPerClaim||r[0],ethAmount:r._ethPerClaim||r[1],cooldownSeconds:Number(r._cooldown||r[2]),cooldownMinutes:Number(r._cooldown||r[2])/60,bkcAmountFormatted:t.formatEther(r._tokensPerClaim||r[0]),ethAmountFormatted:t.formatEther(r._ethPerClaim||r[1]),bkcBalance:r.bkcBalance||r[3],ethBalance:r.ethBalance||r[4],isPaused:r.isPaused||r[5]||!1}}catch{const[r,s,o]=await Promise.all([i.tokensPerClaim(),i.ethPerClaim(),i.cooldown()]);return{bkcAmount:r,ethAmount:s,cooldownSeconds:Number(o),cooldownMinutes:Number(o)/60,bkcAmountFormatted:t.formatEther(r),ethAmountFormatted:t.formatEther(s)}}}catch(t){return console.error("Error getting faucet info:",t),{error:t.message}}}const Yu={claim:Ri,claimOnChain:co,executeFaucetClaim:_i,canClaim:uo,getFaucetInfo:po,getFaucetAddress:gn,FAUCET_API_URL:oo},Vu=Object.freeze(Object.defineProperty({__proto__:null,FaucetTx:Yu,canClaim:uo,claim:Ri,claimOnChain:co,executeFaucetClaim:_i,getFaucetInfo:po},Symbol.toStringTag,{value:"Module"})),Mn={BALANCE:1e4,ALLOWANCE:3e4},ke=new Map,oe={hits:0,misses:0,sets:0,invalidations:0},zt={get(e){const t=ke.get(e);if(!t){oe.misses++;return}if(Date.now()>t.expiresAt){ke.delete(e),oe.misses++;return}return oe.hits++,t.value},set(e,t,a){t!=null&&(ke.set(e,{value:t,expiresAt:Date.now()+a,createdAt:Date.now()}),oe.sets++)},delete(e){ke.delete(e)},clear(e){if(!e){ke.clear(),oe.invalidations++;return}for(const t of ke.keys())t.includes(e)&&ke.delete(t);oe.invalidations++},async getOrFetch(e,t,a){const n=this.get(e);if(n!==void 0)return n;try{const i=await t();return i!=null&&this.set(e,i,a),i}catch(i){throw console.warn(`[Cache] Error fetching ${e}:`,i.message),i}},has(e){return this.get(e)!==void 0},getTTL(e){const t=ke.get(e);if(!t)return 0;const a=t.expiresAt-Date.now();return a>0?a:0},invalidateByTx(e){const a={CreateCampaign:["campaign-","charity-stats","user-campaigns-","campaign-list"],Donate:["campaign-","charity-stats","token-balance-","allowance-"],CancelCampaign:["campaign-","charity-stats","user-campaigns-"],Withdraw:["campaign-","charity-stats","token-balance-"],Delegate:["delegation-","token-balance-","allowance-","user-pstake-","pending-rewards-","network-pstake"],Unstake:["delegation-","token-balance-","user-pstake-","pending-rewards-","network-pstake"],ForceUnstake:["delegation-","token-balance-","user-pstake-","pending-rewards-","network-pstake"],ClaimReward:["pending-rewards-","token-balance-","saved-rewards-"],BuyNFT:["pool-info-","pool-nfts-","token-balance-","allowance-","user-nfts-","buy-price-","sell-price-"],SellNFT:["pool-info-","pool-nfts-","token-balance-","user-nfts-","buy-price-","sell-price-"],PlayGame:["fortune-pool-","fortune-stats-","token-balance-","allowance-","user-fortune-history-"],ListNFT:["rental-listings-","rental-listing-","user-nfts-"],RentNFT:["rental-listing-","rental-active-","token-balance-","allowance-"],WithdrawNFT:["rental-listing-","rental-listings-","user-nfts-"],UpdateListing:["rental-listing-"],Notarize:["notary-","token-balance-","allowance-","user-documents-"],TokenTransfer:["token-balance-","allowance-"],Approval:["allowance-"]}[e];if(!a){console.warn(`[Cache] Unknown transaction type: ${e}`);return}a.forEach(n=>{this.clear(n)}),console.log(`[Cache] Invalidated patterns for ${e}:`,a)},getStats(){const e=ke.size,t=oe.hits+oe.misses>0?(oe.hits/(oe.hits+oe.misses)*100).toFixed(1):0;return{entries:e,hits:oe.hits,misses:oe.misses,sets:oe.sets,invalidations:oe.invalidations,hitRate:`${t}%`}},keys(){return Array.from(ke.keys())},size(){return ke.size},cleanup(){const e=Date.now();let t=0;for(const[a,n]of ke.entries())e>n.expiresAt&&(ke.delete(a),t++);return t>0&&console.log(`[Cache] Cleanup removed ${t} expired entries`),t},resetMetrics(){oe.hits=0,oe.misses=0,oe.sets=0,oe.invalidations=0}},Dn={tokenBalance:(e,t)=>`token-balance-${e.toLowerCase()}-${t.toLowerCase()}`,ethBalance:e=>`eth-balance-${e.toLowerCase()}`,allowance:(e,t,a)=>`allowance-${e.toLowerCase()}-${t.toLowerCase()}-${a.toLowerCase()}`,campaign:e=>`campaign-${e}`,campaignList:()=>"campaign-list",charityStats:()=>"charity-stats",userCampaigns:e=>`user-campaigns-${e.toLowerCase()}`,delegation:(e,t)=>`delegation-${e.toLowerCase()}-${t}`,delegations:e=>`delegation-list-${e.toLowerCase()}`,userPStake:e=>`user-pstake-${e.toLowerCase()}`,pendingRewards:e=>`pending-rewards-${e.toLowerCase()}`,networkPStake:()=>"network-pstake",poolInfo:e=>`pool-info-${e.toLowerCase()}`,poolNfts:e=>`pool-nfts-${e.toLowerCase()}`,buyPrice:e=>`buy-price-${e.toLowerCase()}`,sellPrice:e=>`sell-price-${e.toLowerCase()}`,userNfts:e=>`user-nfts-${e.toLowerCase()}`,fortunePool:()=>"fortune-pool",fortuneTiers:()=>"fortune-tiers",fortuneStats:()=>"fortune-stats",userFortuneHistory:e=>`user-fortune-history-${e.toLowerCase()}`,rentalListings:()=>"rental-listings",rentalListing:e=>`rental-listing-${e}`,rentalActive:e=>`rental-active-${e}`,notaryDocument:e=>`notary-doc-${e}`,userDocuments:e=>`user-documents-${e.toLowerCase()}`,feeConfig:e=>`fee-config-${e}`,protocolConfig:()=>"protocol-config"},h={WRONG_NETWORK:"wrong_network",RPC_UNHEALTHY:"rpc_unhealthy",RPC_RATE_LIMITED:"rpc_rate_limited",NETWORK_ERROR:"network_error",WALLET_NOT_CONNECTED:"wallet_not_connected",WALLET_LOCKED:"wallet_locked",INSUFFICIENT_ETH:"insufficient_eth",INSUFFICIENT_TOKEN:"insufficient_token",INSUFFICIENT_ALLOWANCE:"insufficient_allowance",SIMULATION_REVERTED:"simulation_reverted",GAS_ESTIMATION_FAILED:"gas_estimation_failed",USER_REJECTED:"user_rejected",TX_REVERTED:"tx_reverted",TX_TIMEOUT:"tx_timeout",TX_REPLACED:"tx_replaced",TX_UNDERPRICED:"tx_underpriced",NONCE_ERROR:"nonce_error",CAMPAIGN_NOT_FOUND:"campaign_not_found",CAMPAIGN_NOT_ACTIVE:"campaign_not_active",CAMPAIGN_STILL_ACTIVE:"campaign_still_active",NOT_CAMPAIGN_CREATOR:"not_campaign_creator",DONATION_TOO_SMALL:"donation_too_small",MAX_CAMPAIGNS_REACHED:"max_campaigns_reached",INSUFFICIENT_ETH_FEE:"insufficient_eth_fee",LOCK_PERIOD_ACTIVE:"lock_period_active",LOCK_PERIOD_EXPIRED:"lock_period_expired",NO_REWARDS:"no_rewards",INVALID_DURATION:"invalid_duration",INVALID_DELEGATION_INDEX:"invalid_delegation_index",NFT_NOT_IN_POOL:"nft_not_in_pool",POOL_NOT_INITIALIZED:"pool_not_initialized",INSUFFICIENT_POOL_LIQUIDITY:"insufficient_pool_liquidity",SLIPPAGE_EXCEEDED:"slippage_exceeded",NFT_BOOST_MISMATCH:"nft_boost_mismatch",NOT_NFT_OWNER:"not_nft_owner",NO_ACTIVE_TIERS:"no_active_tiers",INVALID_GUESS_COUNT:"invalid_guess_count",INVALID_GUESS_RANGE:"invalid_guess_range",INSUFFICIENT_SERVICE_FEE:"insufficient_service_fee",RENTAL_STILL_ACTIVE:"rental_still_active",NFT_NOT_LISTED:"nft_not_listed",NFT_ALREADY_LISTED:"nft_already_listed",NOT_LISTING_OWNER:"not_listing_owner",MARKETPLACE_PAUSED:"marketplace_paused",EMPTY_METADATA:"empty_metadata",CONTRACT_ERROR:"contract_error",UNKNOWN:"unknown"},On={[h.WRONG_NETWORK]:"Please switch to Arbitrum Sepolia network",[h.RPC_UNHEALTHY]:"Network connection issue. Retrying...",[h.RPC_RATE_LIMITED]:"Network is busy. Please wait a moment...",[h.NETWORK_ERROR]:"Network error. Please check your connection",[h.WALLET_NOT_CONNECTED]:"Please connect your wallet",[h.WALLET_LOCKED]:"Please unlock your wallet",[h.INSUFFICIENT_ETH]:"Insufficient ETH for gas fees",[h.INSUFFICIENT_TOKEN]:"Insufficient BKC balance",[h.INSUFFICIENT_ALLOWANCE]:"Token approval required",[h.SIMULATION_REVERTED]:"Transaction would fail. Please check your inputs",[h.GAS_ESTIMATION_FAILED]:"Could not estimate gas. Transaction may fail",[h.USER_REJECTED]:"Transaction cancelled",[h.TX_REVERTED]:"Transaction failed on blockchain",[h.TX_TIMEOUT]:"Transaction is taking too long. Please check your wallet",[h.TX_REPLACED]:"Transaction was replaced",[h.TX_UNDERPRICED]:"Gas price too low. Please try again",[h.NONCE_ERROR]:"Transaction sequence error. Please refresh and try again",[h.CAMPAIGN_NOT_FOUND]:"Campaign not found",[h.CAMPAIGN_NOT_ACTIVE]:"This campaign is no longer accepting donations",[h.CAMPAIGN_STILL_ACTIVE]:"Campaign is still active. Please wait until the deadline",[h.NOT_CAMPAIGN_CREATOR]:"Only the campaign creator can perform this action",[h.DONATION_TOO_SMALL]:"Donation amount is below the minimum required",[h.MAX_CAMPAIGNS_REACHED]:"You have reached the maximum number of active campaigns",[h.INSUFFICIENT_ETH_FEE]:"Insufficient ETH for withdrawal fee",[h.LOCK_PERIOD_ACTIVE]:"Your tokens are still locked",[h.LOCK_PERIOD_EXPIRED]:"Lock period has expired. Use normal unstake",[h.NO_REWARDS]:"No rewards available to claim",[h.INVALID_DURATION]:"Lock duration must be between 1 day and 10 years",[h.INVALID_DELEGATION_INDEX]:"Delegation not found",[h.NFT_NOT_IN_POOL]:"This NFT is not available in the pool",[h.POOL_NOT_INITIALIZED]:"Pool is not active yet",[h.INSUFFICIENT_POOL_LIQUIDITY]:"Insufficient liquidity in pool",[h.SLIPPAGE_EXCEEDED]:"Price changed too much. Please try again",[h.NFT_BOOST_MISMATCH]:"NFT tier does not match this pool",[h.NOT_NFT_OWNER]:"You do not own this NFT",[h.NO_ACTIVE_TIERS]:"No active prize tiers available",[h.INVALID_GUESS_COUNT]:"Invalid number of guesses provided",[h.INVALID_GUESS_RANGE]:"Your guess is outside the valid range",[h.INSUFFICIENT_SERVICE_FEE]:"Incorrect service fee amount",[h.RENTAL_STILL_ACTIVE]:"This NFT is currently being rented",[h.NFT_NOT_LISTED]:"This NFT is not listed for rent",[h.NFT_ALREADY_LISTED]:"This NFT is already listed",[h.NOT_LISTING_OWNER]:"Only the listing owner can perform this action",[h.MARKETPLACE_PAUSED]:"Marketplace is temporarily paused",[h.EMPTY_METADATA]:"Document metadata cannot be empty",[h.CONTRACT_ERROR]:"Transaction cannot be completed. Please check your inputs and try again",[h.UNKNOWN]:"An unexpected error occurred. Please try again"},vt={[h.WRONG_NETWORK]:{layer:1,retry:!1,action:"switch_network"},[h.RPC_UNHEALTHY]:{layer:1,retry:!0,waitMs:2e3,action:"switch_rpc"},[h.RPC_RATE_LIMITED]:{layer:1,retry:!0,waitMs:"extract",action:"switch_rpc"},[h.NETWORK_ERROR]:{layer:1,retry:!0,waitMs:3e3,action:"switch_rpc"},[h.WALLET_NOT_CONNECTED]:{layer:2,retry:!1,action:"connect_wallet"},[h.WALLET_LOCKED]:{layer:2,retry:!1,action:"unlock_wallet"},[h.INSUFFICIENT_ETH]:{layer:3,retry:!1,action:"show_faucet"},[h.INSUFFICIENT_TOKEN]:{layer:3,retry:!1},[h.INSUFFICIENT_ALLOWANCE]:{layer:3,retry:!1},[h.SIMULATION_REVERTED]:{layer:4,retry:!1},[h.GAS_ESTIMATION_FAILED]:{layer:4,retry:!0,waitMs:2e3},[h.USER_REJECTED]:{layer:5,retry:!1},[h.TX_REVERTED]:{layer:5,retry:!1},[h.TX_TIMEOUT]:{layer:5,retry:!0,waitMs:5e3},[h.TX_REPLACED]:{layer:5,retry:!1},[h.TX_UNDERPRICED]:{layer:5,retry:!0,waitMs:1e3},[h.NONCE_ERROR]:{layer:5,retry:!0,waitMs:2e3},[h.CAMPAIGN_NOT_FOUND]:{layer:4,retry:!1},[h.CAMPAIGN_NOT_ACTIVE]:{layer:4,retry:!1},[h.CAMPAIGN_STILL_ACTIVE]:{layer:4,retry:!1},[h.NOT_CAMPAIGN_CREATOR]:{layer:4,retry:!1},[h.DONATION_TOO_SMALL]:{layer:4,retry:!1},[h.MAX_CAMPAIGNS_REACHED]:{layer:4,retry:!1},[h.INSUFFICIENT_ETH_FEE]:{layer:3,retry:!1},[h.LOCK_PERIOD_ACTIVE]:{layer:4,retry:!1},[h.LOCK_PERIOD_EXPIRED]:{layer:4,retry:!1},[h.NO_REWARDS]:{layer:4,retry:!1},[h.INVALID_DURATION]:{layer:4,retry:!1},[h.INVALID_DELEGATION_INDEX]:{layer:4,retry:!1},[h.NFT_NOT_IN_POOL]:{layer:4,retry:!1},[h.POOL_NOT_INITIALIZED]:{layer:4,retry:!1},[h.INSUFFICIENT_POOL_LIQUIDITY]:{layer:4,retry:!1},[h.SLIPPAGE_EXCEEDED]:{layer:4,retry:!0,waitMs:1e3},[h.NFT_BOOST_MISMATCH]:{layer:4,retry:!1},[h.NOT_NFT_OWNER]:{layer:4,retry:!1},[h.NO_ACTIVE_TIERS]:{layer:4,retry:!1},[h.INVALID_GUESS_COUNT]:{layer:4,retry:!1},[h.INVALID_GUESS_RANGE]:{layer:4,retry:!1},[h.INSUFFICIENT_SERVICE_FEE]:{layer:4,retry:!1},[h.RENTAL_STILL_ACTIVE]:{layer:4,retry:!1},[h.NFT_NOT_LISTED]:{layer:4,retry:!1},[h.NFT_ALREADY_LISTED]:{layer:4,retry:!1},[h.NOT_LISTING_OWNER]:{layer:4,retry:!1},[h.MARKETPLACE_PAUSED]:{layer:4,retry:!1},[h.EMPTY_METADATA]:{layer:4,retry:!1},[h.CONTRACT_ERROR]:{layer:4,retry:!1},[h.UNKNOWN]:{layer:5,retry:!1}},Jr=[{pattern:/user rejected/i,type:h.USER_REJECTED},{pattern:/user denied/i,type:h.USER_REJECTED},{pattern:/user cancel/i,type:h.USER_REJECTED},{pattern:/rejected by user/i,type:h.USER_REJECTED},{pattern:/cancelled/i,type:h.USER_REJECTED},{pattern:/canceled/i,type:h.USER_REJECTED},{pattern:/action_rejected/i,type:h.USER_REJECTED},{pattern:/too many errors/i,type:h.RPC_RATE_LIMITED},{pattern:/rate limit/i,type:h.RPC_RATE_LIMITED},{pattern:/retrying in/i,type:h.RPC_RATE_LIMITED},{pattern:/429/i,type:h.RPC_RATE_LIMITED},{pattern:/internal json-rpc/i,type:h.RPC_UNHEALTHY},{pattern:/-32603/i,type:h.RPC_UNHEALTHY},{pattern:/-32002/i,type:h.RPC_RATE_LIMITED},{pattern:/failed to fetch/i,type:h.NETWORK_ERROR},{pattern:/network error/i,type:h.NETWORK_ERROR},{pattern:/timeout/i,type:h.TX_TIMEOUT},{pattern:/insufficient funds/i,type:h.INSUFFICIENT_ETH},{pattern:/exceeds the balance/i,type:h.INSUFFICIENT_ETH},{pattern:/insufficient balance/i,type:h.INSUFFICIENT_TOKEN},{pattern:/transfer amount exceeds balance/i,type:h.INSUFFICIENT_TOKEN},{pattern:/exceeds balance/i,type:h.INSUFFICIENT_TOKEN},{pattern:/nonce/i,type:h.NONCE_ERROR},{pattern:/replacement.*underpriced/i,type:h.TX_UNDERPRICED},{pattern:/transaction underpriced/i,type:h.TX_UNDERPRICED},{pattern:/gas too low/i,type:h.TX_UNDERPRICED},{pattern:/reverted/i,type:h.TX_REVERTED},{pattern:/revert/i,type:h.TX_REVERTED},{pattern:/campaignnotfound/i,type:h.CAMPAIGN_NOT_FOUND},{pattern:/campaign not found/i,type:h.CAMPAIGN_NOT_FOUND},{pattern:/campaignnotactive/i,type:h.CAMPAIGN_NOT_ACTIVE},{pattern:/campaign.*not.*active/i,type:h.CAMPAIGN_NOT_ACTIVE},{pattern:/campaignstillactive/i,type:h.CAMPAIGN_STILL_ACTIVE},{pattern:/notcampaigncreator/i,type:h.NOT_CAMPAIGN_CREATOR},{pattern:/donationtoosmall/i,type:h.DONATION_TOO_SMALL},{pattern:/maxactivecampaignsreached/i,type:h.MAX_CAMPAIGNS_REACHED},{pattern:/insufficientethfee/i,type:h.INSUFFICIENT_ETH_FEE},{pattern:/lockperiodactive/i,type:h.LOCK_PERIOD_ACTIVE},{pattern:/lock.*period.*active/i,type:h.LOCK_PERIOD_ACTIVE},{pattern:/still.*locked/i,type:h.LOCK_PERIOD_ACTIVE},{pattern:/lockperiodexpired/i,type:h.LOCK_PERIOD_EXPIRED},{pattern:/norewardstoclaim/i,type:h.NO_REWARDS},{pattern:/no.*rewards/i,type:h.NO_REWARDS},{pattern:/invalidduration/i,type:h.INVALID_DURATION},{pattern:/invalidindex/i,type:h.INVALID_DELEGATION_INDEX},{pattern:/nftnotinpool/i,type:h.NFT_NOT_IN_POOL},{pattern:/poolnotinitialized/i,type:h.POOL_NOT_INITIALIZED},{pattern:/insufficientliquidity/i,type:h.INSUFFICIENT_POOL_LIQUIDITY},{pattern:/insufficientnfts/i,type:h.INSUFFICIENT_POOL_LIQUIDITY},{pattern:/slippageexceeded/i,type:h.SLIPPAGE_EXCEEDED},{pattern:/slippage/i,type:h.SLIPPAGE_EXCEEDED},{pattern:/nftboostmismatch/i,type:h.NFT_BOOST_MISMATCH},{pattern:/notnftowner/i,type:h.NOT_NFT_OWNER},{pattern:/noactivetiers/i,type:h.NO_ACTIVE_TIERS},{pattern:/invalidguesscount/i,type:h.INVALID_GUESS_COUNT},{pattern:/invalidguessrange/i,type:h.INVALID_GUESS_RANGE},{pattern:/insufficientservicefee/i,type:h.INSUFFICIENT_SERVICE_FEE},{pattern:/rentalstillactive/i,type:h.RENTAL_STILL_ACTIVE},{pattern:/nftnotlisted/i,type:h.NFT_NOT_LISTED},{pattern:/nftalreadylisted/i,type:h.NFT_ALREADY_LISTED},{pattern:/notlistingowner/i,type:h.NOT_LISTING_OWNER},{pattern:/marketplaceispaused/i,type:h.MARKETPLACE_PAUSED},{pattern:/emptymetadata/i,type:h.EMPTY_METADATA}],J={classify(e){var n;if(e!=null&&e.errorType&&Object.values(h).includes(e.errorType))return e.errorType;const t=this._extractMessage(e),a=(e==null?void 0:e.code)||((n=e==null?void 0:e.error)==null?void 0:n.code);if(a===4001||a==="ACTION_REJECTED")return h.USER_REJECTED;if(a===-32002)return h.RPC_RATE_LIMITED;if(a===-32603||a==="CALL_EXCEPTION"){if(t.includes("revert")||t.includes("require")||t.includes("execution failed")||t.includes("call_exception")||(e==null?void 0:e.code)==="CALL_EXCEPTION"){for(const{pattern:i,type:r}of Jr)if(i.test(t))return r;return h.CONTRACT_ERROR}return h.RPC_UNHEALTHY}for(const{pattern:i,type:r}of Jr)if(i.test(t))return r;return h.UNKNOWN},_extractMessage(e){var a,n,i;return e?typeof e=="string"?e:[e.message,e.reason,(a=e.error)==null?void 0:a.message,(n=e.error)==null?void 0:n.reason,(i=e.data)==null?void 0:i.message,e.shortMessage,this._safeStringify(e)].filter(Boolean).join(" ").toLowerCase():""},_safeStringify(e){try{return JSON.stringify(e,(t,a)=>typeof a=="bigint"?a.toString():a)}catch{return""}},isUserRejection(e){return this.classify(e)===h.USER_REJECTED},isRetryable(e){var a;const t=this.classify(e);return((a=vt[t])==null?void 0:a.retry)||!1},getWaitTime(e){const t=this.classify(e),a=vt[t];return a?a.waitMs==="extract"?this._extractWaitTime(e):a.waitMs||2e3:2e3},_extractWaitTime(e){const t=this._extractMessage(e),a=t.match(/retrying in (\d+[,.]?\d*)\s*minutes?/i);if(a){const i=parseFloat(a[1].replace(",","."));return Math.ceil(i*60*1e3)+5e3}const n=t.match(/wait (\d+)\s*seconds?/i);return n?parseInt(n[1])*1e3+2e3:3e4},getMessage(e){const t=this.classify(e);return On[t]||On[h.UNKNOWN]},getConfig(e){const t=this.classify(e);return vt[t]||vt[h.UNKNOWN]},getLayer(e){var a;const t=this.classify(e);return((a=vt[t])==null?void 0:a.layer)||5},handle(e,t="Transaction"){const a=this.classify(e),n=vt[a]||{},i=this.getMessage(e);return console.error(`[${t}] Error:`,{type:a,layer:n.layer,retry:n.retry,message:i,original:e}),{type:a,message:i,retry:n.retry||!1,waitMs:n.retry?this.getWaitTime(e):0,layer:n.layer||5,action:n.action||null,original:e,context:t}},async handleWithRpcSwitch(e,t="Transaction"){const a=this.handle(e,t);if(a.action==="switch_rpc")try{const{NetworkManager:n}=await K(async()=>{const{NetworkManager:r}=await Promise.resolve().then(()=>ep);return{NetworkManager:r}},void 0);console.log("[ErrorHandler] Switching RPC due to network error...");const i=n.switchToNextRpc();try{await n.updateMetaMaskRpcs(),console.log("[ErrorHandler] MetaMask RPC updated")}catch(r){console.warn("[ErrorHandler] Could not update MetaMask:",r.message)}a.rpcSwitched=!0,a.newRpc=i,a.waitMs=Math.min(a.waitMs,2e3)}catch(n){console.warn("[ErrorHandler] Could not switch RPC:",n.message),a.rpcSwitched=!1}return a},parseSimulationError(e,t){var s;const a=this.classify(e);let n=this.getMessage(e);const r=(s={donate:{[h.CAMPAIGN_NOT_ACTIVE]:"This campaign has ended and is no longer accepting donations",[h.DONATION_TOO_SMALL]:"Minimum donation is 1 BKC"},delegate:{[h.INVALID_DURATION]:"Lock period must be between 1 day and 10 years"},playGame:{[h.INVALID_GUESS_RANGE]:"Your guess must be within the valid range for this tier"},withdraw:{[h.CAMPAIGN_STILL_ACTIVE]:"You can withdraw after the campaign deadline"},unstake:{[h.LOCK_PERIOD_ACTIVE]:"Your tokens are still locked. Use force unstake to withdraw early (penalty applies)"},claimRewards:{[h.CONTRACT_ERROR]:"No rewards available to claim",[h.NO_REWARDS]:"No rewards available to claim"}}[t])==null?void 0:s[a];return r&&(n=r),{type:a,message:n,original:e,method:t,isSimulation:!0}},create(e,t={}){const a=On[e]||"An error occurred",n=new Error(a);return n.errorType=e,n.extra=t,n},getAction(e){var a;const t=this.classify(e);return((a=vt[t])==null?void 0:a.action)||null}},ie={chainId:421614,chainIdHex:"0x66eee",name:"Arbitrum Sepolia",nativeCurrency:{name:"Ethereum",symbol:"ETH",decimals:18},blockExplorer:"https://sepolia.arbiscan.io"};function Ye(){const e="ZWla0YY4A0Hw7e_rwyOXB";return e?`https://arb-sepolia.g.alchemy.com/v2/${e}`:null}const qu=[{name:"Alchemy",getUrl:Ye,priority:1,isPublic:!1,isPaid:!0},{name:"Arbitrum Official",getUrl:()=>"https://sepolia-rollup.arbitrum.io/rpc",priority:2,isPublic:!0,isPaid:!1},{name:"PublicNode",getUrl:()=>"https://arbitrum-sepolia-rpc.publicnode.com",priority:3,isPublic:!0,isPaid:!1},{name:"Ankr",getUrl:()=>"https://rpc.ankr.com/arbitrum_sepolia",priority:4,isPublic:!0,isPaid:!1}];let at=0,Dt=null,wt=null,ja=0,Wa=0,Ot=!0;const Xu=3,Ju=3e4,Zu=5e3,Zr=6e4,Qu=2e3,le={getCurrentRpcUrl(){const e=Ye();if(e&&Ot)return e;const t=this.getAvailableEndpoints();if(t.length===0)throw new Error("No RPC endpoints available");return t[at%t.length].getUrl()},getPrimaryRpcUrl(){return Ye()},getAvailableEndpoints(){return qu.filter(e=>e.getUrl()!==null).sort((e,t)=>e.priority-t.priority)},getRpcUrlsForMetaMask(){const e=Ye(),t=this.getAvailableEndpoints().filter(a=>a.isPublic).map(a=>a.getUrl()).filter(Boolean);return e?[e,...t]:t},switchToNextRpc(e=!0){const t=this.getAvailableEndpoints();if(Ot&&Ye()){Ot=!1,at=0;const i=t.find(r=>r.isPublic);if(i)return console.log(`[Network] Alchemy temporarily unavailable, using: ${i.name}`),e&&setTimeout(()=>{console.log("[Network] Retrying Alchemy..."),Ot=!0,at=0},Qu),i.getUrl()}const a=t.filter(i=>i.isPublic);if(a.length<=1)return console.warn("[Network] No alternative RPCs available"),this.getCurrentRpcUrl();at=(at+1)%a.length;const n=a[at];return console.log(`[Network] Switched to RPC: ${n.name}`),n.getUrl()},resetToAlchemy(){Ye()&&(Ot=!0,at=0,console.log("[Network] Reset to Alchemy RPC"))},isRateLimitError(e){var n;const t=((n=e==null?void 0:e.message)==null?void 0:n.toLowerCase())||"",a=e==null?void 0:e.code;return a===-32002||a===-32005||t.includes("rate limit")||t.includes("too many")||t.includes("exceeded")||t.includes("throttled")||t.includes("429")},async handleRateLimit(e){const t=this.getCurrentRpcUrl(),a=Ye();if(a&&t===a)return console.warn("[Network] Alchemy rate limited (check your plan limits)"),await new Promise(s=>setTimeout(s,1e3)),a;console.warn("[Network] Public RPC rate limited, switching...");const i=this.switchToNextRpc(),r=Date.now();if(r-Wa>Zr)try{await this.updateMetaMaskRpcs(),Wa=r}catch(s){console.warn("[Network] Could not update MetaMask:",s.message)}return i},async getWorkingProvider(){const e=window.ethers,t=Ye();if(t)try{const n=new e.JsonRpcProvider(t);return await Promise.race([n.getBlockNumber(),new Promise((i,r)=>setTimeout(()=>r(new Error("timeout")),3e3))]),Ot=!0,n}catch(n){console.warn("[Network] Alchemy temporarily unavailable:",n.message)}const a=this.getAvailableEndpoints().filter(n=>n.isPublic);for(const n of a)try{const i=n.getUrl(),r=new e.JsonRpcProvider(i);return await Promise.race([r.getBlockNumber(),new Promise((s,o)=>setTimeout(()=>o(new Error("timeout")),3e3))]),console.log(`[Network] Using fallback RPC: ${n.name}`),r}catch{console.warn(`[Network] RPC ${n.name} failed, trying next...`)}if(t)return new e.JsonRpcProvider(t);throw new Error("No working RPC endpoints available")},async isCorrectNetwork(){if(!window.ethereum)return!1;try{const e=await window.ethereum.request({method:"eth_chainId"});return parseInt(e,16)===ie.chainId}catch(e){return console.error("[Network] Error checking network:",e),!1}},async getCurrentChainId(){if(!window.ethereum)return null;try{const e=await window.ethereum.request({method:"eth_chainId"});return parseInt(e,16)}catch{return null}},async checkRpcHealth(){const e=Date.now(),t=this.getCurrentRpcUrl();try{const a=new AbortController,n=setTimeout(()=>a.abort(),Zu),i=await fetch(t,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({jsonrpc:"2.0",method:"eth_blockNumber",params:[],id:1}),signal:a.signal});if(clearTimeout(n),!i.ok)throw new Error(`HTTP ${i.status}`);const r=await i.json();if(r.error)throw new Error(r.error.message||"RPC error");const s=Date.now()-e;return ja=0,wt={healthy:!0,latency:s,blockNumber:parseInt(r.result,16),timestamp:Date.now()},wt}catch(a){ja++;const n={healthy:!1,latency:Date.now()-e,error:a.message,timestamp:Date.now()};return wt=n,ja>=Xu&&(console.warn("[Network] Too many RPC failures, switching..."),this.switchToNextRpc(),ja=0),n}},getLastHealthCheck(){return wt},async isRpcHealthy(e=1e4){return wt&&Date.now()-wt.timestamp<e?wt.healthy:(await this.checkRpcHealth()).healthy},async switchNetwork(){if(!window.ethereum)throw J.create(h.WALLET_NOT_CONNECTED);try{return await window.ethereum.request({method:"wallet_switchEthereumChain",params:[{chainId:ie.chainIdHex}]}),console.log("[Network] Switched to",ie.name),!0}catch(e){if(e.code===4902)return await this.addNetwork();throw e.code===4001?J.create(h.USER_REJECTED):e}},async addNetwork(){if(!window.ethereum)throw J.create(h.WALLET_NOT_CONNECTED);const e=this.getRpcUrlsForMetaMask();try{return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:ie.chainIdHex,chainName:ie.name,nativeCurrency:ie.nativeCurrency,rpcUrls:e,blockExplorerUrls:[ie.blockExplorer]}]}),console.log("[Network] Added network:",ie.name),!0}catch(t){throw t.code===4001?J.create(h.USER_REJECTED):t}},async updateMetaMaskRpcs(){if(!window.ethereum)return!1;const e=Date.now();if(e-Wa<Zr)return console.log("[Network] MetaMask update on cooldown, skipping..."),!1;if(!await this.isCorrectNetwork())return console.log("[Network] Not on correct network, skipping RPC update"),!1;const a=this.getRpcUrlsForMetaMask();try{return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:ie.chainIdHex,chainName:ie.name,nativeCurrency:ie.nativeCurrency,rpcUrls:a,blockExplorerUrls:[ie.blockExplorer]}]}),Wa=e,console.log("[Network] MetaMask RPCs updated with:",a[0]),!0}catch(n){return console.warn("[Network] Could not update MetaMask RPCs:",n.message),!1}},async forceResetMetaMaskRpc(){if(!window.ethereum)return!1;const e=Ye();if(!e)return console.warn("[Network] Alchemy not configured"),!1;try{try{await window.ethereum.request({method:"wallet_switchEthereumChain",params:[{chainId:"0x1"}]})}catch{}return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:ie.chainIdHex,chainName:ie.name+" (Alchemy)",nativeCurrency:ie.nativeCurrency,rpcUrls:[e],blockExplorerUrls:[ie.blockExplorer]}]}),console.log("[Network] MetaMask reset to Alchemy RPC"),!0}catch(t){return console.error("[Network] Failed to reset MetaMask:",t.message),!1}},getProvider(){const e=window.ethers;if(!e)throw new Error("ethers.js not loaded");return new e.JsonRpcProvider(this.getCurrentRpcUrl())},getBrowserProvider(){const e=window.ethers;if(!e)throw new Error("ethers.js not loaded");if(!window.ethereum)throw J.create(h.WALLET_NOT_CONNECTED);return new e.BrowserProvider(window.ethereum)},async getSigner(){var t,a;const e=this.getBrowserProvider();try{return await e.getSigner()}catch(n){if((t=n.message)!=null&&t.includes("ENS")||n.code==="UNSUPPORTED_OPERATION")try{const i=await window.ethereum.request({method:"eth_accounts"});if(i&&i.length>0)return await e.getSigner(i[0])}catch(i){console.warn("Signer fallback failed:",i)}throw n.code===4001||(a=n.message)!=null&&a.includes("user rejected")?J.create(h.USER_REJECTED):J.create(h.WALLET_NOT_CONNECTED)}},async getConnectedAddress(){if(!window.ethereum)return null;try{return(await window.ethereum.request({method:"eth_accounts"}))[0]||null}catch{return null}},async requestConnection(){if(!window.ethereum)throw J.create(h.WALLET_NOT_CONNECTED);try{const e=await window.ethereum.request({method:"eth_requestAccounts"});if(!e||e.length===0)throw J.create(h.WALLET_NOT_CONNECTED);return e[0]}catch(e){throw e.code===4001?J.create(h.USER_REJECTED):e}},startHealthMonitoring(e=Ju){Dt&&this.stopHealthMonitoring(),this.checkRpcHealth(),Dt=setInterval(()=>{this.checkRpcHealth()},e),console.log("[Network] Health monitoring started")},stopHealthMonitoring(){Dt&&(clearInterval(Dt),Dt=null,console.log("[Network] Health monitoring stopped"))},isMonitoring(){return Dt!==null},formatAddress(e,t=4){return e?`${e.slice(0,t+2)}...${e.slice(-t)}`:""},getAddressExplorerUrl(e){return`${ie.blockExplorer}/address/${e}`},getTxExplorerUrl(e){return`${ie.blockExplorer}/tx/${e}`},isMetaMaskInstalled(){return typeof window.ethereum<"u"&&window.ethereum.isMetaMask},async getStatus(){var n;const[e,t,a]=await Promise.all([this.isCorrectNetwork(),this.getConnectedAddress(),this.checkRpcHealth()]);return{isConnected:!!t,address:t,isCorrectNetwork:e,currentChainId:await this.getCurrentChainId(),targetChainId:ie.chainId,rpcHealthy:a.healthy,rpcLatency:a.latency,currentRpc:((n=this.getAvailableEndpoints()[at])==null?void 0:n.name)||"Unknown"}}},ep=Object.freeze(Object.defineProperty({__proto__:null,NETWORK_CONFIG:ie,NetworkManager:le},Symbol.toStringTag,{value:"Module"})),We={SAFETY_MARGIN_PERCENT:20,MIN_GAS_LIMITS:{transfer:21000n,erc20Transfer:65000n,erc20Approve:50000n,contractCall:100000n,complexCall:300000n},MAX_GAS_LIMIT:15000000n,MIN_GAS_PRICE_GWEI:.01,MAX_GAS_PRICE_GWEI:100,GAS_PRICE_CACHE_TTL:15e3},tp={async estimateGas(e,t,a=[],n={}){try{return await e[t].estimateGas(...a,n)}catch(i){throw i}},async estimateGasWithMargin(e,t,a=[],n={}){const i=await this.estimateGas(e,t,a,n);return this.addSafetyMargin(i)},addSafetyMargin(e,t=We.SAFETY_MARGIN_PERCENT){const a=BigInt(e),n=a*BigInt(t)/100n;let i=a+n;return i>We.MAX_GAS_LIMIT&&(console.warn("[Gas] Estimate exceeds max limit, capping"),i=We.MAX_GAS_LIMIT),i},getMinGasLimit(e="contractCall"){return We.MIN_GAS_LIMITS[e]||We.MIN_GAS_LIMITS.contractCall},async getGasPrice(){return await zt.getOrFetch("gas-price-current",async()=>(await le.getProvider().getFeeData()).gasPrice||0n,We.GAS_PRICE_CACHE_TTL)},async getFeeData(){return await zt.getOrFetch("gas-fee-data",async()=>{const a=await le.getProvider().getFeeData();return{gasPrice:a.gasPrice||0n,maxFeePerGas:a.maxFeePerGas||0n,maxPriorityFeePerGas:a.maxPriorityFeePerGas||0n}},We.GAS_PRICE_CACHE_TTL)},async getGasPriceGwei(){const e=window.ethers,t=await this.getGasPrice();return parseFloat(e.formatUnits(t,"gwei"))},async calculateCost(e,t=null){const a=window.ethers;t||(t=await this.getGasPrice());const n=BigInt(e)*BigInt(t),i=a.formatEther(n);return{wei:n,eth:parseFloat(i),formatted:this.formatEth(i)}},async estimateTransactionCost(e,t,a=[],n={}){const i=await this.estimateGas(e,t,a,n),r=this.addSafetyMargin(i),s=await this.getGasPrice(),o=await this.calculateCost(r,s);return{gasEstimate:i,gasWithMargin:r,gasPrice:s,...o}},async validateGasBalance(e,t,a=null){const n=window.ethers,i=le.getProvider();a||(a=await this.getGasPrice());const r=await i.getBalance(e),s=BigInt(t)*BigInt(a),o=r>=s;return{sufficient:o,balance:r,required:s,shortage:o?0n:s-r,balanceFormatted:n.formatEther(r),requiredFormatted:n.formatEther(s)}},async hasMinimumGas(e,t=null){const a=window.ethers,i=await le.getProvider().getBalance(e),r=t||a.parseEther("0.001");return i>=r},formatEth(e,t=6){const a=parseFloat(e);return a===0?"0 ETH":a<1e-6?"< 0.000001 ETH":`${a.toFixed(t).replace(/\.?0+$/,"")} ETH`},formatGasPrice(e){const t=window.ethers,a=parseFloat(t.formatUnits(e,"gwei"));return a<.01?"< 0.01 gwei":a<1?`${a.toFixed(2)} gwei`:`${a.toFixed(1)} gwei`},formatGasLimit(e){return Number(e).toLocaleString()},formatGasSummary(e){return`~${e.formatted} (${this.formatGasLimit(e.gasWithMargin||0n)} gas)`},compareEstimates(e,t){const a=BigInt(e),n=BigInt(t);if(n===0n)return 0;const i=a>n?a-n:n-a;return Number(i*100n/n)},isGasPriceReasonable(e){const t=window.ethers,a=parseFloat(t.formatUnits(e,"gwei"));return a<We.MIN_GAS_PRICE_GWEI?{reasonable:!1,warning:"Gas price unusually low, transaction may be slow"}:a>We.MAX_GAS_PRICE_GWEI?{reasonable:!1,warning:"Gas price unusually high, consider waiting"}:{reasonable:!0,warning:null}},async getRecommendedSettings(e){const t=await this.getFeeData();return{gasLimit:this.addSafetyMargin(e),maxFeePerGas:t.maxFeePerGas,maxPriorityFeePerGas:t.maxPriorityFeePerGas}},async createTxOverrides(e,t={}){return{gasLimit:(await this.getRecommendedSettings(e)).gasLimit,...t}}},Qr=500000000000000n,es=["function balanceOf(address owner) view returns (uint256)","function allowance(address owner, address spender) view returns (uint256)","function decimals() view returns (uint8)","function symbol() view returns (string)"],Q={async validateNetwork(){if(!await le.isCorrectNetwork()){const t=await le.getCurrentChainId();throw J.create(h.WRONG_NETWORK,{currentChainId:t,expectedChainId:ie.chainId})}},async validateRpcHealth(){const e=await le.checkRpcHealth();if(!e.healthy&&(le.switchToNextRpc(),!(await le.checkRpcHealth()).healthy))throw J.create(h.RPC_UNHEALTHY,{error:e.error})},async validateWalletConnected(e=null){if(!window.ethereum)throw J.create(h.WALLET_NOT_CONNECTED);const t=e||await le.getConnectedAddress();if(!t)throw J.create(h.WALLET_NOT_CONNECTED);return t},async validatePreTransaction(){return await this.validateNetwork(),await this.validateRpcHealth(),await this.validateWalletConnected()},async validateEthForGas(e,t=Qr){const a=window.ethers,n=Dn.ethBalance(e),i=await zt.getOrFetch(n,async()=>await le.getProvider().getBalance(e),Mn.BALANCE);if(i<t)throw J.create(h.INSUFFICIENT_ETH,{balance:a.formatEther(i),required:a.formatEther(t)});return i},async validateTokenBalance(e,t,a){const n=window.ethers,i=Dn.tokenBalance(e,a),r=await zt.getOrFetch(i,async()=>{const s=le.getProvider();return await new n.Contract(e,es,s).balanceOf(a)},Mn.BALANCE);if(r<t)throw J.create(h.INSUFFICIENT_TOKEN,{balance:n.formatEther(r),required:n.formatEther(t)});return r},async needsApproval(e,t,a,n){const i=window.ethers,r=Dn.allowance(e,n,t);return await zt.getOrFetch(r,async()=>{const o=le.getProvider();return await new i.Contract(e,es,o).allowance(n,t)},Mn.ALLOWANCE)<a},async validateAllowance(e,t,a,n){if(await this.needsApproval(e,t,a,n))throw J.create(h.INSUFFICIENT_ALLOWANCE,{token:e,spender:t,required:a.toString()})},async validateBalances({userAddress:e,tokenAddress:t=null,tokenAmount:a=null,spenderAddress:n=null,ethAmount:i=Qr}){await this.validateEthForGas(e,i),t&&a&&await this.validateTokenBalance(t,a,e)},validatePositive(e,t="Amount"){if(BigInt(e)<=0n)throw new Error(`${t} must be greater than zero`)},validateRange(e,t,a,n="Value"){const i=BigInt(e),r=BigInt(t),s=BigInt(a);if(i<r||i>s)throw new Error(`${n} must be between ${t} and ${a}`)},validateNotEmpty(e,t="Field"){if(!e||e.trim().length===0)throw new Error(`${t} cannot be empty`)},validateAddress(e,t="Address"){const a=window.ethers;if(!e||!a.isAddress(e))throw new Error(`Invalid ${t}`)},charity:{validateCreateCampaign({title:e,description:t,goalAmount:a,durationDays:n}){Q.validateNotEmpty(e,"Title"),Q.validateNotEmpty(t,"Description"),Q.validatePositive(a,"Goal amount"),Q.validateRange(n,1,180,"Duration")},validateDonate({campaignId:e,amount:t}){if(e==null)throw new Error("Campaign ID is required");Q.validatePositive(t,"Donation amount")}},staking:{validateDelegate({amount:e,lockDays:t}){Q.validatePositive(e,"Stake amount"),Q.validateRange(t,1,3650,"Lock duration")},validateUnstake({delegationIndex:e}){if(e==null||e<0)throw new Error("Invalid delegation index")}},nftPool:{validateBuy({maxPrice:e}){e!=null&&Q.validatePositive(e,"Max price")},validateSell({tokenId:e,minPayout:t}){if(e==null)throw new Error("Token ID is required");t!=null&&Q.validatePositive(t,"Min payout")}},fortune:{validatePlay({wagerAmount:e,guesses:t,isCumulative:a}){if(Q.validatePositive(e,"Wager amount"),!Array.isArray(t)||t.length===0)throw new Error("At least one guess is required");t.forEach((n,i)=>{if(typeof n!="number"||n<1)throw new Error(`Invalid guess at position ${i+1}`)})}},rental:{validateList({tokenId:e,pricePerHour:t,minHours:a,maxHours:n}){if(e==null)throw new Error("Token ID is required");Q.validatePositive(t,"Price per hour"),Q.validateRange(a,1,720,"Minimum hours"),Q.validateRange(n,a,720,"Maximum hours")},validateRent({tokenId:e,hours:t}){if(e==null)throw new Error("Token ID is required");Q.validatePositive(t,"Rental hours")}},notary:{validateNotarize({ipfsCid:e,description:t,contentHash:a}){if(Q.validateNotEmpty(e,"IPFS CID"),a&&(a.startsWith("0x")?a.slice(2):a).length!==64)throw new Error("Content hash must be 32 bytes")}}},Ga={DEFAULT_MAX_RETRIES:2,RETRY_BASE_DELAY:2e3,APPROVAL_MULTIPLIER:10n,APPROVAL_WAIT_TIME:1500,CONFIRMATION_TIMEOUT:6e4,CONFIRMATION_RETRY_DELAY:3e3,GAS_SAFETY_MARGIN:20,DEFAULT_GAS_LIMIT:500000n},ts=["function approve(address spender, uint256 amount) returns (bool)","function allowance(address owner, address spender) view returns (uint256)"];class ap{constructor(t,a,n=!0){this.button=t,this.txName=a,this.showToasts=n,this.originalContent=null,this.originalDisabled=!1,this.button&&(this.originalContent=this.button.innerHTML,this.originalDisabled=this.button.disabled)}setPhase(t){if(!this.button)return;const n={validating:{text:"Validating...",icon:"🔍"},approving:{text:"Approving...",icon:"✅"},simulating:{text:"Simulating...",icon:"🧪"},confirming:{text:"Confirm in Wallet",icon:"👛"},waiting:{text:"Processing...",icon:"⏳"},success:{text:"Success!",icon:"🎉"},error:{text:"Failed",icon:"❌"}}[t]||{text:t,icon:"⏳"};this.button.disabled=!0,this.button.innerHTML=`
        ...
        `)}cleanup(){this.button&&(this.button.innerHTML=this.originalContent,this.button.disabled=this.originalDisabled)}showSuccess(t=2e3){this.setPhase("success"),setTimeout(()=>this.cleanup(),t)}showError(t=2e3){this.setPhase("error"),setTimeout(()=>this.cleanup(),t)}}class np{constructor(){this.pendingTxIds=new Set}_resolveArgs(t){return typeof t=="function"?t():t||[]}_resolveApproval(t){return t?typeof t=="object"?{token:t.token,spender:t.spender,amount:t.amount}:t:null}_validateContractMethod(t,a){if(!t)throw new Error("Contract instance is null or undefined");if(typeof t[a]!="function"){const n=Object.keys(t).filter(i=>typeof t[i]=="function").filter(i=>!i.startsWith("_")&&!["on","once","emit","removeListener"].includes(i)).slice(0,15);throw console.error(`[TX] Contract method "${a}" not found!`),console.error("[TX] Available methods:",n),new Error(`Contract method "${a}" not found. This usually means the ABI doesn't match the contract. Available methods: ${n.join(", ")}`)}return typeof t[a].estimateGas!="function"&&console.warn(`[TX] Method ${a} exists but estimateGas is not available`),!0}async execute(t){var S,$;const{name:a,txId:n=null,button:i=null,showToasts:r=!0,getContract:s,method:o,args:l=[],approval:d=null,validate:u=null,onSuccess:f=null,onError:p=null,maxRetries:b=Ga.DEFAULT_MAX_RETRIES,invalidateCache:g=!0,skipSimulation:w=!1,fixedGasLimit:T=Ga.DEFAULT_GAS_LIMIT}=t,C=n||`${a}-${Date.now()}-${Math.random().toString(36).substr(2,9)}`;if(this.pendingTxIds.has(C))return console.warn(`[TX] Transaction ${C} already in progress`),{success:!1,reason:"DUPLICATE_TX",message:"Transaction already in progress"};this.pendingTxIds.add(C);const P=new ap(i,a,r);try{P.setPhase("validating"),console.log(`[TX] Starting: ${a}`),await Q.validateNetwork(),await Q.validateRpcHealth();const B=await Q.validateWalletConnected();console.log(`[TX] User address: ${B}`);const I=await le.getSigner();console.log("[TX] Signer obtained");try{await Q.validateEthForGas(B)}catch(X){console.warn("[TX] ETH gas validation failed, continuing anyway:",X.message)}const _=this._resolveApproval(d);_&&_.amount>0n&&await Q.validateTokenBalance(_.token,_.amount,B),u&&(console.log("[TX] Running custom validation..."),await u(I,B));const W=this._resolveApproval(t.approval);W&&W.amount>0n&&await Q.needsApproval(W.token,W.spender,W.amount,B)&&(P.setPhase("approving"),console.log("[TX] Requesting token approval..."),await this._executeApproval(W,I,B),zt.clear("allowance-")),console.log("[TX] Getting contract instance...");const ae=await s(I);this._validateContractMethod(ae,o),console.log(`[TX] Contract method "${o}" validated`);const ue=t.value;ue&&console.log("[TX] Transaction value (ETH):",ue.toString());const q=ue?{value:ue}:{},pe=this._resolveArgs(l);console.log("[TX] Args resolved:",pe.map(X=>typeof X=="bigint"?X.toString():typeof X=="string"&&X.length>50?X.substring(0,50)+"...":X));let Y;if(w)console.log(`[TX] Skipping simulation, using fixed gas limit: ${T}`),Y=T;else{P.setPhase("simulating"),console.log("[TX] Simulating transaction...");try{if(!ae[o]||typeof ae[o].estimateGas!="function")throw new Error(`estimateGas not available for method "${o}"`);Y=await ae[o].estimateGas(...pe,q),console.log(`[TX] Gas estimate: ${Y.toString()}`)}catch(X){if(console.error("[TX] Simulation failed:",X.message),(S=X.message)!=null&&S.includes("not found")||($=X.message)!=null&&$.includes("undefined"))throw new Error(`Contract method "${o}" is not callable. Check that the ABI matches the deployed contract.`);const oa=J.parseSimulationError(X,o);throw J.create(oa.type,{message:oa.message,original:X})}}P.setPhase("confirming"),console.log("[TX] Requesting signature...");const ne=tp.addSafetyMargin(Y),Ne={...q,gasLimit:ne};try{const X=await I.provider.getFeeData();X.maxFeePerGas&&(Ne.maxFeePerGas=X.maxFeePerGas*120n/100n,Ne.maxPriorityFeePerGas=X.maxPriorityFeePerGas||0n)}catch{}const ht=this._resolveArgs(l),tt=await this._executeWithRetry(()=>ae[o](...ht,Ne),{maxRetries:b,ui:P,signer:I,name:a});console.log(`[TX] Transaction submitted: ${tt.hash}`),P.setPhase("waiting"),console.log("[TX] Waiting for confirmation...");const Me=await this._waitForConfirmation(tt,I.provider);if(console.log(`[TX] Confirmed in block ${Me.blockNumber}`),P.showSuccess(),g&&zt.invalidateByTx(a),f)try{await f(Me)}catch(X){console.warn("[TX] onSuccess callback error:",X)}return{success:!0,receipt:Me,txHash:Me.hash||tt.hash,blockNumber:Me.blockNumber}}catch(B){console.error("[TX] Error:",(B==null?void 0:B.message)||B),i&&(console.log("[TX] Restoring button..."),i.disabled=!1,P.originalContent&&(i.innerHTML=P.originalContent));let I;try{I=await J.handleWithRpcSwitch(B,a),I.rpcSwitched&&console.log(`[TX] RPC switched to: ${I.newRpc}`)}catch(_){console.warn("[TX] Error in handleWithRpcSwitch:",_),I=J.handle(B,a)}if(I.type!==h.USER_REJECTED&&i&&!p){const _=P.originalContent;i.innerHTML='<span style="display:flex;align-items:center;justify-content:center;gap:8px"><span>❌</span><span>Failed</span></span>',setTimeout(()=>{i&&(i.innerHTML=_)},1500)}if(p)try{p(I)}catch(_){console.warn("[TX] onError callback error:",_)}return{success:!1,error:I,message:I.message,cancelled:I.type===h.USER_REJECTED}}finally{this.pendingTxIds.delete(C),setTimeout(()=>{i&&i.disabled&&(console.log("[TX] Safety cleanup triggered"),P.cleanup())},5e3)}}async _executeApproval(t,a,n){const i=window.ethers,{token:r,spender:s,amount:o}=t;console.log(`[TX] Approving ${i.formatEther(o)} tokens...`);const l=new i.Contract(r,ts,a),d=o*Ga.APPROVAL_MULTIPLIER;try{let u={};try{const T=await a.provider.getFeeData();T.maxFeePerGas&&(u.maxFeePerGas=T.maxFeePerGas*120n/100n,u.maxPriorityFeePerGas=T.maxPriorityFeePerGas||0n)}catch{}const f=await l.approve(s,d,u),p=le.getProvider();let b=null;for(let T=0;T<30&&(await new Promise(C=>setTimeout(C,1500)),b=await p.getTransactionReceipt(f.hash),!b);T++);if(b||(b=await f.wait()),b.status===0)throw new Error("Approval transaction reverted");if(console.log("[TX] Approval confirmed"),await new Promise(T=>setTimeout(T,Ga.APPROVAL_WAIT_TIME)),await new i.Contract(r,ts,p).allowance(n,s)<o)throw new Error("Approval not reflected on-chain")}catch(u){throw J.isUserRejection(u)?J.create(h.USER_REJECTED):u}}async _executeWithRetry(t,{maxRetries:a,ui:n,signer:i,name:r}){let s;for(let o=1;o<=a+1;o++)try{return o>1&&(n.setRetry(o,a+1),console.log(`[TX] Retry ${o}/${a+1}`),(await le.checkRpcHealth()).healthy||(console.log("[TX] RPC unhealthy, switching..."),le.switchToNextRpc(),await new Promise(d=>setTimeout(d,2e3)))),await t()}catch(l){if(s=l,J.isUserRejection(l)||!J.isRetryable(l)||o===a+1)throw l;const d=J.getWaitTime(l);console.log(`[TX] Waiting ${d}ms before retry...`),await new Promise(u=>setTimeout(u,d))}throw s}async _waitForConfirmation(t,a){const n=le.getProvider();try{const i=await Promise.race([t.wait(),new Promise((r,s)=>setTimeout(()=>s(new Error("wait_timeout")),1e4))]);if(i.status===1)return i;if(i.status===0)throw new Error("Transaction reverted on-chain");return i}catch(i){console.warn("[TX] tx.wait() issue, using Alchemy to check:",i.message);for(let r=0;r<20;r++){await new Promise(o=>setTimeout(o,1500));const s=await n.getTransactionReceipt(t.hash);if(s&&s.status===1)return console.log("[TX] Confirmed via Alchemy"),s;if(s&&s.status===0)throw new Error("Transaction reverted on-chain")}return console.warn("[TX] Could not verify receipt, assuming success"),{hash:t.hash,status:1,blockNumber:0}}}isPending(t){return this.pendingTxIds.has(t)}getPendingCount(){return this.pendingTxIds.size}clearPending(){this.pendingTxIds.clear()}}const H=new np,xn="bkc_operator",Rt="0x0000000000000000000000000000000000000000";function Fi(){var t;const e=window.ethers;try{const a=localStorage.getItem(xn);if(a&&Ve(a))return jt(a);if(window.BACKCHAIN_OPERATOR&&Ve(window.BACKCHAIN_OPERATOR))return jt(window.BACKCHAIN_OPERATOR);if((t=window.addresses)!=null&&t.operator&&Ve(window.addresses.operator))return jt(window.addresses.operator)}catch(a){console.warn("[Operator] Error getting operator:",a)}return(e==null?void 0:e.ZeroAddress)||Rt}function Z(e){const t=window.ethers,a=(t==null?void 0:t.ZeroAddress)||Rt;return e===null?a:e&&Ve(e)?jt(e):Fi()}function ip(e){if(!e)return fo(),!0;if(!Ve(e))return console.warn("[Operator] Invalid address:",e),!1;try{const t=jt(e);return localStorage.setItem(xn,t),window.BACKCHAIN_OPERATOR=t,window.dispatchEvent(new CustomEvent("operatorChanged",{detail:{address:t}})),console.log("[Operator] Set to:",t),!0}catch(t){return console.error("[Operator] Error setting:",t),!1}}function fo(){try{localStorage.removeItem(xn),delete window.BACKCHAIN_OPERATOR,window.dispatchEvent(new CustomEvent("operatorChanged",{detail:{address:null}})),console.log("[Operator] Cleared")}catch(e){console.warn("[Operator] Error clearing:",e)}}function rp(){const e=window.ethers,t=(e==null?void 0:e.ZeroAddress)||Rt,a=Fi();return a&&a!==t}function sp(){var n;const e=window.ethers,t=(e==null?void 0:e.ZeroAddress)||Rt,a=localStorage.getItem(xn);return a&&Ve(a)?{address:a,source:"localStorage",isSet:!0}:window.BACKCHAIN_OPERATOR&&Ve(window.BACKCHAIN_OPERATOR)?{address:window.BACKCHAIN_OPERATOR,source:"global",isSet:!0}:(n=window.addresses)!=null&&n.operator&&Ve(window.addresses.operator)?{address:window.addresses.operator,source:"config",isSet:!0}:{address:t,source:"none",isSet:!1}}function Ve(e){const t=window.ethers;return!e||typeof e!="string"||!e.match(/^0x[a-fA-F0-9]{40}$/)?!1:t!=null&&t.isAddress?t.isAddress(e):!0}function jt(e){const t=window.ethers;if(!e)return(t==null?void 0:t.ZeroAddress)||Rt;try{if(t!=null&&t.getAddress)return t.getAddress(e)}catch{}return e}function op(e){const t=window.ethers,a=(t==null?void 0:t.ZeroAddress)||Rt;return!e||e===a?"None":`${e.slice(0,6)}...${e.slice(-4)}`}const lp={get:Fi,set:ip,clear:fo,has:rp,resolve:Z,info:sp,isValid:Ve,normalize:jt,short:op,ZERO:Rt};window.Operator=lp;function mo(){var t;const e=(v==null?void 0:v.charityPool)||(M==null?void 0:M.charityPool)||((t=window.contractAddresses)==null?void 0:t.charityPool);if(!e)throw console.error("❌ CharityPool address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{CHARITY_POOL:e}}const za=["function createCampaign(string calldata title, string calldata metadataUri, uint96 goal, uint256 durationDays, address operator) external payable returns (uint256 campaignId)","function donate(uint256 campaignId, address operator) external payable","function boostCampaign(uint256 campaignId, address operator) external payable","function closeCampaign(uint256 campaignId) external","function withdraw(uint256 campaignId) external","function getCampaign(uint256 campaignId) view returns (address owner, uint48 deadline, uint8 status, uint96 raised, uint96 goal, uint32 donorCount, bool isBoosted, string memory title, string memory metadataUri)","function canWithdraw(uint256 campaignId) view returns (bool)","function previewDonation(uint256 amount) view returns (uint256 fee, uint256 netToCampaign)","function campaignCount() view returns (uint256)","function getStats() view returns (uint256 campaignCount, uint256 totalDonated, uint256 totalWithdrawn, uint256 totalEthFees)","function version() view returns (string)","event CampaignCreated(uint256 indexed campaignId, address indexed creator, uint96 goal, uint48 deadline, address operator)","event DonationMade(uint256 indexed campaignId, address indexed donor, uint256 grossAmount, uint256 netDonation, address operator)","event CampaignBoosted(uint256 indexed campaignId, address indexed booster, uint48 boostExpiry, address operator)","event CampaignClosed(uint256 indexed campaignId, address indexed creator, uint96 raised)","event FundsWithdrawn(uint256 indexed campaignId, address indexed creator, uint96 amount)"],ea={ACTIVE:0,CLOSED:1,WITHDRAWN:2};function Ba(e){const t=window.ethers,a=mo();return new t.Contract(a.CHARITY_POOL,za,e)}async function je(){const e=window.ethers,{NetworkManager:t}=await K(async()=>{const{NetworkManager:i}=await import("./index-D_2TdD3O.js");return{NetworkManager:i}},[]),a=t.getProvider(),n=mo();return new e.Contract(n.CHARITY_POOL,za,a)}async function bo({title:e,metadataUri:t="",description:a,goalAmount:n,durationDays:i,operator:r,button:s=null,onSuccess:o=null,onError:l=null}){const d=window.ethers;if(!e||e.trim().length===0)throw new Error("Title is required");if(e.length>100)throw new Error("Title must be 100 characters or less");if(i<1||i>365)throw new Error("Duration must be between 1 and 365 days");const u=BigInt(n);if(u<=0n)throw new Error("Goal amount must be greater than 0");const f=t||a||"";let p=r,b=0n;return await H.execute({name:"CreateCampaign",button:s,getContract:async g=>Ba(g),method:"createCampaign",args:()=>[e,f,u,BigInt(i),Z(p)],get value(){return b},validate:async(g,w)=>{await je();try{const{NetworkManager:T}=await K(async()=>{const{NetworkManager:S}=await import("./index-D_2TdD3O.js");return{NetworkManager:S}},[]),C=T.getProvider();if(b=d.parseEther("0.0001"),await C.getBalance(w)<b+d.parseEther("0.001"))throw new Error("Insufficient ETH for creation fee + gas")}catch(T){if(T.message.includes("Insufficient"))throw T}},onSuccess:async g=>{let w=null;try{const T=new d.Interface(za);for(const C of g.logs)try{const P=T.parseLog(C);if(P.name==="CampaignCreated"){w=Number(P.args.campaignId);break}}catch{}}catch{}o&&o(g,w)},onError:l})}async function go({campaignId:e,amount:t,operator:a,button:n=null,onSuccess:i=null,onError:r=null}){const s=window.ethers;if(e==null)throw new Error("Campaign ID is required");const o=BigInt(t);if(o<=0n)throw new Error("Donation amount must be greater than 0");let l=e,d=a;return await H.execute({name:"Donate",button:n,getContract:async u=>Ba(u),method:"donate",args:()=>[l,Z(d)],value:o,validate:async(u,f)=>{const b=await(await je()).getCampaign(l);if(b.owner===s.ZeroAddress)throw new Error("Campaign not found");if(Number(b.status)!==ea.ACTIVE)throw new Error("Campaign is not active");const g=Math.floor(Date.now()/1e3);if(Number(b.deadline)<=g)throw new Error("Campaign has ended")},onSuccess:async u=>{let f=null;try{const p=new s.Interface(za);for(const b of u.logs)try{const g=p.parseLog(b);if(g.name==="DonationMade"){f={grossAmount:g.args.grossAmount,netDonation:g.args.netDonation};break}}catch{}}catch{}i&&i(u,f)},onError:r})}async function Mi({campaignId:e,button:t=null,onSuccess:a=null,onError:n=null}){const i=window.ethers;if(e==null)throw new Error("Campaign ID is required");return await H.execute({name:"CloseCampaign",button:t,getContract:async r=>Ba(r),method:"closeCampaign",args:[e],validate:async(r,s)=>{const l=await(await je()).getCampaign(e);if(l.owner===i.ZeroAddress)throw new Error("Campaign not found");if(l.owner.toLowerCase()!==s.toLowerCase())throw new Error("Only the campaign creator can close");if(Number(l.status)!==ea.ACTIVE)throw new Error("Campaign is not active")},onSuccess:a,onError:n})}const xo=Mi;async function ho({campaignId:e,button:t=null,onSuccess:a=null,onError:n=null}){const i=window.ethers;if(e==null)throw new Error("Campaign ID is required");return await H.execute({name:"Withdraw",button:t,getContract:async r=>Ba(r),method:"withdraw",args:[e],validate:async(r,s)=>{const o=await je(),l=await o.getCampaign(e);if(l.owner===i.ZeroAddress)throw new Error("Campaign not found");if(l.owner.toLowerCase()!==s.toLowerCase())throw new Error("Only the campaign creator can withdraw");if(Number(l.status)===ea.WITHDRAWN)throw new Error("Funds already withdrawn");if(!await o.canWithdraw(e))throw new Error("Cannot withdraw yet — campaign must be closed or past deadline")},onSuccess:async r=>{let s=null;try{const o=new i.Interface(za);for(const l of r.logs)try{const d=o.parseLog(l);if(d.name==="FundsWithdrawn"){s={amount:d.args.amount};break}}catch{}}catch{}a&&a(r,s)},onError:n})}async function vo({campaignId:e,operator:t,button:a=null,onSuccess:n=null,onError:i=null}){const r=window.ethers;if(e==null)throw new Error("Campaign ID is required");let s=t,o=r.parseEther("0.0001");return await H.execute({name:"BoostCampaign",button:a,getContract:async l=>Ba(l),method:"boostCampaign",args:()=>[e,Z(s)],get value(){return o},validate:async(l,d)=>{const f=await(await je()).getCampaign(e);if(f.owner===r.ZeroAddress)throw new Error("Campaign not found");if(Number(f.status)!==ea.ACTIVE)throw new Error("Campaign is not active");const p=Math.floor(Date.now()/1e3);if(Number(f.deadline)<=p)throw new Error("Campaign has ended")},onSuccess:n,onError:i})}async function wo(e){const a=await(await je()).getCampaign(e),n=Math.floor(Date.now()/1e3);return{id:e,creator:a.owner,title:a.title,metadataUri:a.metadataUri,goalAmount:a.goal,raisedAmount:a.raised,donationCount:Number(a.donorCount),deadline:Number(a.deadline),status:Number(a.status),statusName:["ACTIVE","CLOSED","WITHDRAWN"][Number(a.status)]||"UNKNOWN",isBoosted:a.isBoosted,progress:a.goal>0n?Number(a.raised*100n/a.goal):0,isEnded:Number(a.deadline)<n,isActive:Number(a.status)===ea.ACTIVE&&Number(a.deadline)>n}}async function yo(){const e=await je();return Number(await e.campaignCount())}async function ko(e){return await(await je()).canWithdraw(e)}async function Eo(e){const t=window.ethers,n=await(await je()).previewDonation(e);return{fee:n.fee||n[0],netToCampaign:n.netToCampaign||n[1],feeFormatted:t.formatEther(n.fee||n[0]),netFormatted:t.formatEther(n.netToCampaign||n[1])}}async function To(){const e=window.ethers,a=await(await je()).getStats();return{totalCampaigns:Number(a.campaignCount||a[0]),totalDonated:a.totalDonated||a[1],totalDonatedFormatted:e.formatEther(a.totalDonated||a[1]),totalWithdrawn:a.totalWithdrawn||a[2],totalWithdrawnFormatted:e.formatEther(a.totalWithdrawn||a[2]),totalEthFees:a.totalEthFees||a[3],totalEthFeesFormatted:e.formatEther(a.totalEthFees||a[3])}}const _t={createCampaign:bo,donate:go,closeCampaign:Mi,cancelCampaign:xo,withdraw:ho,boostCampaign:vo,getCampaign:wo,getCampaignCount:yo,canWithdraw:ko,previewDonation:Eo,getStats:To,CampaignStatus:ea},cp=Object.freeze(Object.defineProperty({__proto__:null,CharityTx:_t,boostCampaign:vo,canWithdraw:ko,cancelCampaign:xo,closeCampaign:Mi,createCampaign:bo,donate:go,getCampaign:wo,getCampaignCount:yo,getStats:To,previewDonation:Eo,withdraw:ho},Symbol.toStringTag,{value:"Module"}));function Di(){var a,n;const e=(v==null?void 0:v.stakingPool)||(M==null?void 0:M.stakingPool)||((a=window.contractAddresses)==null?void 0:a.stakingPool),t=(v==null?void 0:v.bkcToken)||(M==null?void 0:M.bkcToken)||((n=window.contractAddresses)==null?void 0:n.bkcToken);if(!e)throw console.error("❌ StakingPool address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");if(!t)throw console.error("❌ BKC Token address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{BKC_TOKEN:t,STAKING_POOL:e}}const Co=["function delegate(uint256 amount, uint256 lockDays, address operator) external payable","function unstake(uint256 index) external","function forceUnstake(uint256 index, address operator) external payable","function claimRewards(address operator) external payable","function pendingRewards(address user) view returns (uint256)","function previewClaim(address user) view returns (uint256 totalRewards, uint256 burnAmount, uint256 referrerCut, uint256 userReceives, uint256 burnRateBps, uint256 nftBoost)","function getDelegationsOf(address user) view returns (tuple(uint128 amount, uint128 pStake, uint64 lockEnd, uint64 lockDays, uint256 rewardDebt)[])","function getDelegation(address user, uint256 index) view returns (uint256 amount, uint256 pStake, uint256 lockEnd, uint256 lockDays, uint256 pendingReward)","function delegationCount(address user) view returns (uint256)","function userTotalPStake(address user) view returns (uint256)","function totalPStake() view returns (uint256)","function MIN_LOCK_DAYS() view returns (uint256)","function MAX_LOCK_DAYS() view returns (uint256)","function forceUnstakePenaltyBps() view returns (uint256)","function getUserBestBoost(address user) view returns (uint256)","function getBurnRateForBoost(uint256 boostBps) view returns (uint256)","function getTierName(uint256 boostBps) view returns (string)","function getUserSummary(address user) view returns (uint256 userTotalPStake, uint256 delegationCount, uint256 savedRewards, uint256 totalPending, uint256 nftBoost, uint256 burnRateBps)","function getStakingStats() view returns (uint256 totalPStake, uint256 totalBkcDelegated, uint256 totalRewardsDistributed, uint256 totalBurnedOnClaim, uint256 totalForceUnstakePenalties, uint256 totalEthFeesCollected, uint256 accRewardPerShare)","event Delegated(address indexed user, uint256 indexed delegationIndex, uint256 amount, uint256 pStake, uint256 lockDays, address operator)","event Unstaked(address indexed user, uint256 indexed delegationIndex, uint256 amount)","event RewardsClaimed(address indexed user, uint256 totalRewards, uint256 burned, uint256 referrerCut, uint256 userReceived, uint256 nftBoost, address operator)"];function St(e){const t=window.ethers,a=Di();return new t.Contract(a.STAKING_POOL,Co,e)}async function bt(){const e=window.ethers,{NetworkManager:t}=await K(async()=>{const{NetworkManager:i}=await import("./index-D_2TdD3O.js");return{NetworkManager:i}},[]),a=t.getProvider(),n=Di();return new e.Contract(n.STAKING_POOL,Co,a)}async function Io({amount:e,lockDays:t,operator:a,button:n=null,onSuccess:i=null,onError:r=null}){if(t==null)throw new Error("lockDays must be provided");const s=Number(t);if(s<1||s>3650)throw new Error("Lock duration must be between 1 and 3650 days");const o=BigInt(e);let l=a;return await H.execute({name:"Delegate",button:n,getContract:async d=>St(d),method:"delegate",args:()=>[o,BigInt(s),Z(l)],approval:(()=>{const d=Di();return{token:d.BKC_TOKEN,spender:d.STAKING_POOL,amount:o}})(),onSuccess:i,onError:r})}async function Ao({delegationIndex:e,button:t=null,onSuccess:a=null,onError:n=null}){Q.staking.validateUnstake({delegationIndex:e});let i=e;return await H.execute({name:"Unstake",button:t,getContract:async r=>St(r),method:"unstake",args:[i],validate:async(r,s)=>{const l=await St(r).getDelegationsOf(s);if(i>=l.length)throw new Error("Delegation not found");const d=l[i],u=Math.floor(Date.now()/1e3);if(Number(d.lockEnd)>u){const f=Math.ceil((Number(d.lockEnd)-u)/86400);throw new Error(`Lock period still active. ${f} day(s) remaining. Use Force Unstake if needed.`)}},onSuccess:a,onError:n})}async function Po({delegationIndex:e,operator:t,button:a=null,onSuccess:n=null,onError:i=null}){Q.staking.validateUnstake({delegationIndex:e});let r=e,s=t;return await H.execute({name:"ForceUnstake",button:a,getContract:async o=>St(o),method:"forceUnstake",args:()=>[r,Z(s)],validate:async(o,l)=>{const u=await St(o).getDelegationsOf(l);if(r>=u.length)throw new Error("Delegation not found");const f=u[r],p=Math.floor(Date.now()/1e3);if(Number(f.lockEnd)<=p)throw new Error("Lock period has ended. Use normal Unstake to avoid penalty.")},onSuccess:n,onError:i})}async function zo({operator:e,button:t=null,onSuccess:a=null,onError:n=null}={}){let i=e;return await H.execute({name:"ClaimRewards",button:t,getContract:async r=>St(r),method:"claimRewards",args:()=>[Z(i)],validate:async(r,s)=>{if(await St(r).pendingRewards(s)<=0n)throw new Error("No rewards available to claim")},onSuccess:a,onError:n})}async function Bo(e){const a=await(await bt()).getDelegationsOf(e),n=Math.floor(Date.now()/1e3);return a.map((i,r)=>({index:r,amount:i.amount,pStake:i.pStake,lockEnd:Number(i.lockEnd),lockDays:Number(i.lockDays),isUnlocked:Number(i.lockEnd)<=n,daysRemaining:Number(i.lockEnd)>n?Math.ceil((Number(i.lockEnd)-n)/86400):0}))}async function No(e){return await(await bt()).pendingRewards(e)}async function So(e){return await(await bt()).userTotalPStake(e)}async function $o(){return await(await bt()).totalPStake()}async function Lo(){const e=await bt();try{const t=await e.forceUnstakePenaltyBps();return Number(t)/100}catch{return 10}}async function Ro(){const e=await bt(),[t,a,n]=await Promise.all([e.MIN_LOCK_DAYS(),e.MAX_LOCK_DAYS(),e.forceUnstakePenaltyBps().catch(()=>1000n)]);return{minLockDays:Number(t),maxLockDays:Number(a),penaltyPercent:Number(n)/100,penaltyBips:Number(n)}}async function _o(e){const a=await(await bt()).previewClaim(e);return{totalRewards:a.totalRewards,burnAmount:a.burnAmount,referrerCut:a.referrerCut,userReceives:a.userReceives,burnRateBps:Number(a.burnRateBps),nftBoost:Number(a.nftBoost)}}async function Fo(e){const a=await(await bt()).getUserSummary(e);return{userTotalPStake:a.userTotalPStake||a[0],delegationCount:Number(a.delegationCount||a[1]),savedRewards:a.savedRewards||a[2],totalPending:a.totalPending||a[3],nftBoost:Number(a.nftBoost||a[4]),burnRateBps:Number(a.burnRateBps||a[5])}}const Vt={delegate:Io,unstake:Ao,forceUnstake:Po,claimRewards:zo,getUserDelegations:Bo,getPendingRewards:No,getUserPStake:So,getTotalPStake:$o,getEarlyUnstakePenalty:Lo,getStakingConfig:Ro,previewClaim:_o,getUserSummary:Fo},dp=Object.freeze(Object.defineProperty({__proto__:null,StakingTx:Vt,claimRewards:zo,delegate:Io,forceUnstake:Po,getEarlyUnstakePenalty:Lo,getPendingRewards:No,getStakingConfig:Ro,getTotalPStake:$o,getUserDelegations:Bo,getUserPStake:So,getUserSummary:Fo,previewClaim:_o,unstake:Ao},Symbol.toStringTag,{value:"Module"})),Mo=["diamond","gold","silver","bronze"];function hn(e=null){var i,r,s;const t=(v==null?void 0:v.bkcToken)||(M==null?void 0:M.bkcToken)||((i=window.contractAddresses)==null?void 0:i.bkcToken),a=(v==null?void 0:v.rewardBooster)||(M==null?void 0:M.rewardBooster)||((r=window.contractAddresses)==null?void 0:r.rewardBooster);let n=null;if(e){const o=`pool_${e.toLowerCase()}`;n=(v==null?void 0:v[o])||(M==null?void 0:M[o])||((s=window.contractAddresses)==null?void 0:s[o])}if(!t||!a)throw new Error("Contract addresses not loaded");return{BKC_TOKEN:t,NFT_CONTRACT:a,NFT_POOL:n}}function ta(e){var a;const t=`pool_${e.toLowerCase()}`;return(v==null?void 0:v[t])||(M==null?void 0:M[t])||((a=window.contractAddresses)==null?void 0:a[t])||null}function up(){const e={};for(const t of Mo){const a=ta(t);a&&(e[t]=a)}return e}const Oi=["function buyNFT(uint256 maxBkcPrice, address operator) external payable returns (uint256 tokenId)","function buySpecificNFT(uint256 tokenId, uint256 maxBkcPrice, address operator) external payable","function sellNFT(uint256 tokenId, uint256 minPayout, address operator) external payable","function getBuyPrice() view returns (uint256)","function getSellPrice() view returns (uint256)","function getTotalBuyCost() view returns (uint256 bkcCost, uint256 ethCost)","function getTotalSellInfo() view returns (uint256 bkcPayout, uint256 ethCost)","function getEthFees() view returns (uint256 buyFee, uint256 sellFee)","function getSpread() view returns (uint256 spread, uint256 spreadBips)","function getPoolInfo() view returns (uint256 bkcBalance, uint256 nftCount, uint256 k, bool initialized, uint8 tier)","function getAvailableNFTs() view returns (uint256[])","function isNFTInPool(uint256 tokenId) view returns (bool)","function tier() view returns (uint8)","function getTierName() view returns (string)","function getStats() view returns (uint256 volume, uint256 buys, uint256 sells, uint256 ethFees)","event NFTPurchased(address indexed buyer, uint256 indexed tokenId, uint256 price, uint256 ethFee, uint256 nftCount, address operator)","event NFTSold(address indexed seller, uint256 indexed tokenId, uint256 payout, uint256 ethFee, uint256 nftCount, address operator)"],Do=["function setApprovalForAll(address operator, bool approved) external","function isApprovedForAll(address owner, address operator) view returns (bool)","function ownerOf(uint256 tokenId) view returns (address)","function balanceOf(address owner) view returns (uint256)","function tokenTier(uint256 tokenId) view returns (uint8)"];function Hi(e,t){return new window.ethers.Contract(t,Oi,e)}async function ve(e){const{NetworkManager:t}=await K(async()=>{const{NetworkManager:a}=await import("./index-D_2TdD3O.js");return{NetworkManager:a}},[]);return new window.ethers.Contract(e,Oi,t.getProvider())}function ni(e){const t=hn();return new window.ethers.Contract(t.NFT_CONTRACT,Do,e)}async function pp(){const{NetworkManager:e}=await K(async()=>{const{NetworkManager:a}=await import("./index-D_2TdD3O.js");return{NetworkManager:a}},[]),t=hn();return new window.ethers.Contract(t.NFT_CONTRACT,Do,e.getProvider())}async function Ui({poolAddress:e,poolTier:t,operator:a,button:n=null,onSuccess:i=null,onError:r=null}){const s=window.ethers,o=hn(),l=e||ta(t);if(!l)throw new Error("Pool address or valid pool tier is required");let d=a,u=0n,f=0n;return await H.execute({name:"BuyNFT",button:n,getContract:async p=>Hi(p,l),method:"buyNFT",args:()=>[u,Z(d)],get value(){return f},get approval(){return u>0n?{token:o.BKC_TOKEN,spender:l,amount:u}:null},validate:async(p,b)=>{const g=await ve(l),[w,T]=await g.getTotalBuyCost();u=w,f=T;const C=await g.getPoolInfo();if(Number(C[1])<=1)throw new Error("No NFTs available in pool");const{NetworkManager:P}=await K(async()=>{const{NetworkManager:_}=await import("./index-D_2TdD3O.js");return{NetworkManager:_}},[]),S=P.getProvider();if(await new s.Contract(o.BKC_TOKEN,["function balanceOf(address) view returns (uint256)"],S).balanceOf(b)<u)throw new Error(`Insufficient BKC. Need ${s.formatEther(u)} BKC`);if(await S.getBalance(b)<f+s.parseEther("0.001"))throw new Error("Insufficient ETH for fee + gas")},onSuccess:async p=>{let b=null;try{const g=new s.Interface(Oi);for(const w of p.logs)try{const T=g.parseLog(w);if((T==null?void 0:T.name)==="NFTPurchased"){b=Number(T.args.tokenId);break}}catch{}}catch{}i&&i(p,b)},onError:r})}async function Oo({poolAddress:e,poolTier:t,tokenId:a,operator:n,button:i=null,onSuccess:r=null,onError:s=null}){const o=window.ethers,l=hn(),d=e||ta(t);if(!d)throw new Error("Pool address or valid pool tier is required");if(a===void 0)throw new Error("Token ID is required");let u=n,f=0n,p=0n;return await H.execute({name:"BuySpecificNFT",button:i,getContract:async b=>Hi(b,d),method:"buySpecificNFT",args:()=>[a,f,Z(u)],get value(){return p},get approval(){return f>0n?{token:l.BKC_TOKEN,spender:d,amount:f}:null},validate:async(b,g)=>{const w=await ve(d);if(!await w.isNFTInPool(a))throw new Error("NFT is not in pool");const[T,C]=await w.getTotalBuyCost();f=T,p=C;const{NetworkManager:P}=await K(async()=>{const{NetworkManager:B}=await import("./index-D_2TdD3O.js");return{NetworkManager:B}},[]),S=P.getProvider();if(await new o.Contract(l.BKC_TOKEN,["function balanceOf(address) view returns (uint256)"],S).balanceOf(g)<f)throw new Error("Insufficient BKC");if(await S.getBalance(g)<p+o.parseEther("0.001"))throw new Error("Insufficient ETH")},onSuccess:r,onError:s})}async function ji({poolAddress:e,poolTier:t,tokenId:a,minPayout:n,operator:i,button:r=null,onSuccess:s=null,onError:o=null}){const l=window.ethers,d=e||ta(t);if(!d)throw new Error("Pool address or valid pool tier is required");if(a===void 0)throw new Error("Token ID is required");let u=i,f=0n,p=0n;return await H.execute({name:"SellNFT",button:r,getContract:async b=>Hi(b,d),method:"sellNFT",args:()=>[a,f,Z(u)],get value(){return p},validate:async(b,g)=>{const w=await ve(d),T=ni(b);if((await T.ownerOf(a)).toLowerCase()!==g.toLowerCase())throw new Error("You do not own this NFT");const P=await w.tier(),S=await T.tokenTier(a);if(P!==S)throw new Error("NFT tier does not match pool tier");const[$,B]=await w.getTotalSellInfo();f=n?BigInt(n):$*95n/100n,p=B;const{NetworkManager:I}=await K(async()=>{const{NetworkManager:W}=await import("./index-D_2TdD3O.js");return{NetworkManager:W}},[]);if(await I.getProvider().getBalance(g)<p+l.parseEther("0.001"))throw new Error("Insufficient ETH");await T.isApprovedForAll(g,d)||await(await T.setApprovalForAll(d,!0)).wait()},onSuccess:s,onError:o})}async function Ho({poolAddress:e,poolTier:t,button:a=null,onSuccess:n=null,onError:i=null}){const r=e||ta(t);if(!r)throw new Error("Pool address or valid pool tier is required");return await H.execute({name:"ApproveAllNFTs",button:a,getContract:async s=>ni(s),method:"setApprovalForAll",args:[r,!0],validate:async(s,o)=>{if(await ni(s).isApprovedForAll(o,r))throw new Error("Already approved")},onSuccess:n,onError:i})}async function Uo(e){return await(await ve(e)).getBuyPrice()}async function jo(e){return await(await ve(e)).getSellPrice()}async function Wo(e){const t=window.ethers,a=await ve(e),[n,i]=await a.getTotalBuyCost();return{bkcCost:n,bkcFormatted:t.formatEther(n),ethCost:i,ethFormatted:t.formatEther(i)}}async function Go(e){const t=window.ethers,a=await ve(e),[n,i]=await a.getTotalSellInfo();return{bkcPayout:n,bkcFormatted:t.formatEther(n),ethCost:i,ethFormatted:t.formatEther(i)}}async function Ko(e){const t=window.ethers,a=await ve(e),[n,i,r]=await Promise.all([a.getPoolInfo(),a.getBuyPrice().catch(()=>0n),a.getSellPrice().catch(()=>0n)]);return{bkcBalance:n[0],nftCount:Number(n[1]),k:n[2],initialized:n[3],tier:Number(n[4]),buyPrice:i,buyPriceFormatted:t.formatEther(i),sellPrice:r,sellPriceFormatted:t.formatEther(r)}}async function Yo(e){return(await(await ve(e)).getAvailableNFTs()).map(a=>Number(a))}async function Wi(e){const t=window.ethers,a=await ve(e),[n,i]=await a.getEthFees();return{buyFee:n,buyFeeFormatted:t.formatEther(n),sellFee:i,sellFeeFormatted:t.formatEther(i)}}const Vo=Wi;async function Gi(e){const t=window.ethers,n=await(await ve(e)).getStats();return{volume:n[0],volumeFormatted:t.formatEther(n[0]),buys:Number(n[1]),sells:Number(n[2]),ethFees:n[3],ethFeesFormatted:t.formatEther(n[3])}}const qo=Gi;async function Xo(e){return await(await ve(e)).getTierName()}async function Jo(e){const t=window.ethers,a=await ve(e);try{const n=await a.getSpread();return{spread:n.spread,spreadFormatted:t.formatEther(n.spread),spreadBips:Number(n.spreadBips),spreadPercent:Number(n.spreadBips)/100}}catch{const[n,i]=await Promise.all([a.getBuyPrice().catch(()=>0n),a.getSellPrice().catch(()=>0n)]),r=n>i?n-i:0n,s=i>0n?Number(r*10000n/i):0;return{spread:r,spreadFormatted:t.formatEther(r),spreadBips:s,spreadPercent:s/100}}}async function Zo(e,t){return await(await ve(e)).isNFTInPool(t)}async function Qo(e,t){return await(await pp()).isApprovedForAll(e,t)}const el=Ui,tl=ji,ii={buyNft:Ui,buySpecificNft:Oo,sellNft:ji,approveAllNfts:Ho,buyFromPool:el,sellToPool:tl,getBuyPrice:Uo,getSellPrice:jo,getTotalBuyCost:Wo,getTotalSellInfo:Go,getEthFees:Wi,getEthFeeConfig:Vo,getPoolInfo:Ko,getAvailableNfts:Yo,isNFTInPool:Zo,isApprovedForAll:Qo,getStats:Gi,getTradingStats:qo,getTierName:Xo,getSpread:Jo,getPoolAddress:ta,getAllPools:up,POOL_TIERS:Mo},fp=Object.freeze(Object.defineProperty({__proto__:null,NftTx:ii,approveAllNfts:Ho,buyFromPool:el,buyNft:Ui,buySpecificNft:Oo,getAvailableNfts:Yo,getBuyPrice:Uo,getEthFeeConfig:Vo,getEthFees:Wi,getPoolInfo:Ko,getSellPrice:jo,getSpread:Jo,getStats:Gi,getTierName:Xo,getTotalBuyCost:Wo,getTotalSellInfo:Go,getTradingStats:qo,isApprovedForAll:Qo,isNFTInPool:Zo,sellNft:ji,sellToPool:tl},Symbol.toStringTag,{value:"Module"}));function Ki(){var a,n;const e=(v==null?void 0:v.fortunePool)||(M==null?void 0:M.fortunePool)||((a=window.contractAddresses)==null?void 0:a.fortunePool),t=(v==null?void 0:v.bkcToken)||(M==null?void 0:M.bkcToken)||((n=window.contractAddresses)==null?void 0:n.bkcToken);if(!e)throw console.error("❌ FortunePool address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");if(!t)throw console.error("❌ BKC Token address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{BKC_TOKEN:t,FORTUNE_POOL:e}}const vn=["function commitPlay(bytes32 commitHash, uint256 wagerAmount, uint8 tierMask, address operator) external payable returns (uint256 gameId)","function revealPlay(uint256 gameId, uint256[] calldata guesses, bytes32 userSecret) external returns (uint256 prizeWon)","function claimExpired(uint256 gameId) external","function fundPrizePool(uint256 amount) external","function getTierInfo(uint8 tier) view returns (uint256 range, uint256 multiplier, uint256 winChanceBps)","function getAllTiers() view returns (uint256[3] ranges, uint256[3] multipliers, uint256[3] winChances)","function TIER_COUNT() view returns (uint8)","function getGame(uint256 gameId) view returns (address player, uint48 commitBlock, uint8 tierMask, uint8 status, address operator, uint96 wagerAmount)","function getGameResult(uint256 gameId) view returns (address player, uint128 grossWager, uint128 prizeWon, uint8 tierMask, uint8 matchCount, uint48 revealBlock)","function getGameStatus(uint256 gameId) view returns (uint8 status, bool canReveal, uint256 blocksUntilReveal, uint256 blocksUntilExpiry)","function calculatePotentialWinnings(uint256 wagerAmount, uint8 tierMask) view returns (uint256 netToPool, uint256 bkcFee, uint256 maxPrize, uint256 maxPrizeAfterCap)","function getRequiredFee(uint8 tierMask) view returns (uint256 fee)","function generateCommitHash(uint256[] calldata guesses, bytes32 userSecret) pure returns (bytes32)","function gameCounter() view returns (uint256)","function prizePool() view returns (uint256)","function getPoolStats() view returns (uint256 prizePool, uint256 totalGamesPlayed, uint256 totalBkcWagered, uint256 totalBkcWon, uint256 totalBkcForfeited, uint256 totalBkcBurned, uint256 maxPayoutNow)","function REVEAL_DELAY() view returns (uint256)","function REVEAL_WINDOW() view returns (uint256)","function BKC_FEE_BPS() view returns (uint256)","function MAX_PAYOUT_BPS() view returns (uint256)","event GameCommitted(uint256 indexed gameId, address indexed player, uint256 wagerAmount, uint8 tierMask, address operator)","event GameRevealed(uint256 indexed gameId, address indexed player, uint256 grossWager, uint256 prizeWon, uint8 tierMask, uint8 matchCount)","event GameExpired(uint256 indexed gameId, address indexed player, uint96 forfeitedAmount)"],Yi=[{range:5,multiplierBps:2e4},{range:15,multiplierBps:1e5},{range:150,multiplierBps:1e6}];function al(e){const t=window.ethers,a=Ki();return new t.Contract(a.FORTUNE_POOL,vn,e)}async function Qe(){const e=window.ethers,{NetworkManager:t}=await K(async()=>{const{NetworkManager:i}=await import("./index-D_2TdD3O.js");return{NetworkManager:i}},[]),a=t.getProvider(),n=Ki();return new e.Contract(n.FORTUNE_POOL,vn,a)}const Vi="fortune_pending_games";function wn(){try{return JSON.parse(localStorage.getItem(Vi)||"{}")}catch{return{}}}function mp(e,t){const a=wn();a[e]={...t,savedAt:Date.now()},localStorage.setItem(Vi,JSON.stringify(a))}function bp(e){const t=wn();delete t[e],localStorage.setItem(Vi,JSON.stringify(t))}function qi(e,t){const a=window.ethers,i=a.AbiCoder.defaultAbiCoder().encode(["uint256[]","bytes32"],[e.map(r=>BigInt(r)),t]);return a.keccak256(i)}function nl(){const e=window.ethers;return e.hexlify(e.randomBytes(32))}function gp(e){let t=0;for(;e;)t+=e&1,e>>=1;return t}async function Xi({commitmentHash:e,wagerAmount:t,tierMask:a,operator:n,button:i=null,onSuccess:r=null,onError:s=null}){const o=window.ethers,l=Ki(),d=BigInt(t),u=Number(a);if(u<1||u>7)throw new Error("tierMask must be 1-7");let f=n,p=0n;try{p=await(await Qe()).getRequiredFee(u),console.log("[FortuneTx] ETH fee:",o.formatEther(p))}catch(b){throw console.error("[FortuneTx] Could not fetch ETH fee:",b.message),new Error("Could not fetch ETH fee from contract")}return await H.execute({name:"CommitPlay",button:i,getContract:async b=>al(b),method:"commitPlay",args:()=>[e,d,u,Z(f)],value:p,approval:{token:l.BKC_TOKEN,spender:l.FORTUNE_POOL,amount:d},validate:async(b,g)=>{if(d<=0n)throw new Error("Wager amount must be greater than 0");const{NetworkManager:w}=await K(async()=>{const{NetworkManager:C}=await import("./index-D_2TdD3O.js");return{NetworkManager:C}},[]),T=await w.getProvider().getBalance(g);if(p>0n&&T<p+o.parseEther("0.001"))throw new Error(`Insufficient ETH for fee (${o.formatEther(p)} ETH required)`)},onSuccess:async b=>{let g=null;try{const w=new o.Interface(vn);for(const T of b.logs)try{const C=w.parseLog(T);if(C.name==="GameCommitted"){g=Number(C.args.gameId);break}}catch{}}catch{}r&&r({gameId:g,txHash:b.hash,commitBlock:b.blockNumber})},onError:s})}async function Ji({gameId:e,guesses:t,userSecret:a,button:n=null,onSuccess:i=null,onError:r=null}){const s=window.ethers,o=t.map(l=>BigInt(l));return await H.execute({name:"RevealPlay",button:n,getContract:async l=>al(l),method:"revealPlay",args:[e,o,a],validate:async(l,d)=>{const u=await Qe(),f=await u.getGameStatus(e);if(Number(f.status)===3)throw new Error("Game has expired.");if(!f.canReveal)throw Number(f.blocksUntilReveal)>0?new Error(`Must wait ${f.blocksUntilReveal} more blocks before reveal`):new Error("Cannot reveal this game");const p=await u.getGame(e);if(p.player.toLowerCase()!==d.toLowerCase())throw new Error("You are not the owner of this game");const b=qi(t,a);p[0]&&p[0]},onSuccess:async l=>{let d=null;try{const u=new s.Interface(vn);for(const f of l.logs)try{const p=u.parseLog(f);p.name==="GameRevealed"&&(d={gameId:Number(p.args.gameId),grossWager:p.args.grossWager,prizeWon:p.args.prizeWon,tierMask:Number(p.args.tierMask),matchCount:Number(p.args.matchCount),won:p.args.prizeWon>0n})}catch{}}catch{}bp(e),i&&i(l,d)},onError:r})}async function il({wagerAmount:e,guess:t,guesses:a,tierMask:n=1,operator:i,button:r=null,onSuccess:s=null,onError:o=null}){const l=Number(n);if(l<1||l>7)throw new Error("tierMask must be 1-7");const d=gp(l);let u=[];if(a&&Array.isArray(a)&&a.length>0)u=a.map(g=>Number(g));else if(t!==void 0)u=[Number(Array.isArray(t)?t[0]:t)];else throw new Error("Guess(es) required");if(u.length!==d)throw new Error(`tierMask selects ${d} tier(s) but ${u.length} guess(es) provided`);let f=0;for(let g=0;g<3;g++)if(l&1<<g){const w=Yi[g].range;if(u[f]<1||u[f]>w)throw new Error(`Tier ${g} guess must be between 1 and ${w}`);f++}const p=nl(),b=qi(u,p);return await Xi({commitmentHash:b,wagerAmount:e,tierMask:l,operator:i,button:r,onSuccess:g=>{mp(g.gameId,{guesses:u,userSecret:p,tierMask:l,wagerAmount:e.toString(),commitmentHash:b}),s&&s({...g,guesses:u,userSecret:p,tierMask:l})},onError:o})}async function rl(){const e=await Qe();try{const t=await e.getAllTiers(),a=[];for(let n=0;n<3;n++)a.push({tierId:n,maxRange:Number(t.ranges[n]),multiplierBps:Number(t.multipliers[n]),multiplier:Number(t.multipliers[n])/1e4,winChanceBps:Number(t.winChances[n]),active:!0});return a}catch{return Yi.map((t,a)=>({tierId:a,maxRange:t.range,multiplierBps:t.multiplierBps,multiplier:t.multiplierBps/1e4,active:!0}))}}async function sl(e){const t=await Qe();try{const a=await t.getTierInfo(e);return{tierId:e,maxRange:Number(a.range),multiplierBps:Number(a.multiplier),multiplier:Number(a.multiplier)/1e4,winChanceBps:Number(a.winChanceBps)}}catch{return null}}async function ol(e=1){const t=await Qe();try{return await t.getRequiredFee(Number(e))}catch{return 0n}}async function ll(){const e=window.ethers,t=await Qe();try{const a=await t.getPoolStats();return{prizePoolBalance:a[0],prizePoolFormatted:e.formatEther(a[0]),gameCounter:Number(a[1]),totalWageredAllTime:a[2],totalWageredFormatted:e.formatEther(a[2]),totalPaidOutAllTime:a[3],totalPaidOutFormatted:e.formatEther(a[3]),totalForfeited:a[4],totalBurned:a[5],maxPayoutNow:a[6],maxPayoutFormatted:e.formatEther(a[6])}}catch{const[a,n]=await Promise.all([t.gameCounter().catch(()=>0n),t.prizePool().catch(()=>0n)]);return{gameCounter:Number(a),prizePoolBalance:n,prizePoolFormatted:e.formatEther(n)}}}async function cl(){return 3}async function dl(e,t=1){const a=window.ethers,n=await Qe();try{const i=await n.calculatePotentialWinnings(e,Number(t));return{netToPool:i.netToPool||i[0],bkcFee:i.bkcFee||i[1],maxPrize:i.maxPrize||i[2],maxPrizeFormatted:a.formatEther(i.maxPrize||i[2]),maxPrizeAfterCap:i.maxPrizeAfterCap||i[3],maxPrizeAfterCapFormatted:a.formatEther(i.maxPrizeAfterCap||i[3])}}catch{return{netToPool:0n,bkcFee:0n,maxPrize:0n,maxPrizeAfterCap:0n}}}async function ul(e){const t=await Qe();try{const a=await t.getGameResult(e);return{player:a.player,grossWager:a.grossWager,prizeWon:a.prizeWon,tierMask:Number(a.tierMask),matchCount:Number(a.matchCount),revealBlock:Number(a.revealBlock),won:a.prizeWon>0n}}catch{return null}}async function pl(e){const t=await Qe();try{const a=await t.getGameStatus(e);return{status:Number(a.status),statusName:["NONE","COMMITTED","REVEALED","EXPIRED"][Number(a.status)]||"UNKNOWN",canReveal:a.canReveal,isExpired:Number(a.status)===3,blocksUntilReveal:Number(a.blocksUntilReveal),blocksUntilExpiry:Number(a.blocksUntilExpiry)}}catch{return null}}function fl(){return wn()}function Zi(e){return wn()[e]||null}async function ml(e,t={}){const a=Zi(e);if(!a)throw new Error(`No pending game found with ID ${e}`);return await Ji({gameId:e,guesses:a.guesses,userSecret:a.userSecret,...t})}const Qi={commitPlay:Xi,revealPlay:Ji,playGame:il,revealPendingGame:ml,getPendingGamesForReveal:fl,getPendingGame:Zi,generateCommitmentHashLocal:qi,generateSecret:nl,getActiveTiers:rl,getTierById:sl,getServiceFee:ol,getPoolStats:ll,getActiveTierCount:cl,calculatePotentialWin:dl,getGameResult:ul,getCommitmentStatus:pl,TIERS:Yi},xp=Object.freeze(Object.defineProperty({__proto__:null,FortuneTx:Qi,calculatePotentialWin:dl,commitPlay:Xi,getActiveTierCount:cl,getActiveTiers:rl,getCommitmentStatus:pl,getGameResult:ul,getPendingGame:Zi,getPendingGamesForReveal:fl,getPoolStats:ll,getServiceFee:ol,getTierById:sl,playGame:il,revealPendingGame:ml,revealPlay:Ji},Symbol.toStringTag,{value:"Module"}));function yn(){var a,n;const e=(v==null?void 0:v.rentalManager)||(M==null?void 0:M.rentalManager)||((a=window.contractAddresses)==null?void 0:a.rentalManager),t=(v==null?void 0:v.rewardBooster)||(M==null?void 0:M.rewardBooster)||((n=window.contractAddresses)==null?void 0:n.rewardBooster);if(!e||!t)throw new Error("Contract addresses not loaded. Please refresh the page.");return{RENTAL_MANAGER:e,NFT_CONTRACT:t}}const er=["function listNFT(uint256 tokenId, uint96 pricePerHour, uint16 minHours, uint16 maxHours) external","function updateListing(uint256 tokenId, uint96 pricePerHour, uint16 minHours, uint16 maxHours) external","function withdrawNFT(uint256 tokenId) external","function rentNFT(uint256 tokenId, uint256 hours_, address operator) external payable","function withdrawEarnings() external","function getListing(uint256 tokenId) view returns (address owner, uint96 pricePerHour, uint16 minHours, uint16 maxHours, uint96 totalEarnings, uint32 rentalCount, bool currentlyRented, uint48 rentalEndTime)","function getAllListedTokenIds() view returns (uint256[])","function getListingCount() view returns (uint256)","function getRental(uint256 tokenId) view returns (address tenant, uint48 endTime, bool isActive)","function isRented(uint256 tokenId) view returns (bool)","function getRemainingTime(uint256 tokenId) view returns (uint256)","function hasActiveRental(address user) view returns (bool)","function getRentalCost(uint256 tokenId, uint256 hours_) view returns (uint256 rentalCost, uint256 ethFee, uint256 totalCost)","function pendingEarnings(address user) view returns (uint256)","function getStats() view returns (uint256 activeListings, uint256 volume, uint256 rentals, uint256 ethFees, uint256 earningsWithdrawn)","event NFTListed(uint256 indexed tokenId, address indexed owner, uint96 pricePerHour, uint16 minHours, uint16 maxHours)","event NFTRented(uint256 indexed tokenId, address indexed tenant, address indexed owner, uint256 hours_, uint256 rentalCost, uint256 ethFee, uint48 endTime, address operator)","event NFTWithdrawn(uint256 indexed tokenId, address indexed owner)","event EarningsWithdrawn(address indexed owner, uint256 amount)"],hp=["function setApprovalForAll(address operator, bool approved) external","function isApprovedForAll(address owner, address operator) view returns (bool)","function ownerOf(uint256 tokenId) view returns (address)"];function Na(e){const t=yn();return new window.ethers.Contract(t.RENTAL_MANAGER,er,e)}async function we(){const{NetworkManager:e}=await K(async()=>{const{NetworkManager:a}=await import("./index-D_2TdD3O.js");return{NetworkManager:a}},[]),t=yn();return new window.ethers.Contract(t.RENTAL_MANAGER,er,e.getProvider())}function vp(e){const t=yn();return new window.ethers.Contract(t.NFT_CONTRACT,hp,e)}async function tr({tokenId:e,pricePerHour:t,minHours:a,maxHours:n,button:i=null,onSuccess:r=null,onError:s=null}){const o=yn(),l=BigInt(t);return await H.execute({name:"ListNFT",button:i,getContract:async d=>Na(d),method:"listNFT",args:[e,l,a,n],validate:async(d,u)=>{const f=vp(d);if((await f.ownerOf(e)).toLowerCase()!==u.toLowerCase())throw new Error("You do not own this NFT");await f.isApprovedForAll(u,o.RENTAL_MANAGER)||await(await f.setApprovalForAll(o.RENTAL_MANAGER,!0)).wait()},onSuccess:r,onError:s})}async function ar({tokenId:e,hours:t,operator:a,button:n=null,onSuccess:i=null,onError:r=null}){const s=window.ethers;let o=a,l=0n;return await H.execute({name:"RentNFT",button:n,getContract:async d=>Na(d),method:"rentNFT",args:()=>[e,t,Z(o)],get value(){return l},validate:async(d,u)=>{const f=await we(),p=await f.getListing(e);if(p.owner===s.ZeroAddress)throw new Error("NFT is not listed for rent");if(p.currentlyRented)throw new Error("NFT is currently rented");if(t<Number(p.minHours)||t>Number(p.maxHours))throw new Error(`Hours must be between ${p.minHours} and ${p.maxHours}`);const b=await f.getRentalCost(e,t);l=b.totalCost||b[2];const{NetworkManager:g}=await K(async()=>{const{NetworkManager:T}=await import("./index-D_2TdD3O.js");return{NetworkManager:T}},[]);if(await g.getProvider().getBalance(u)<l+s.parseEther("0.001"))throw new Error(`Insufficient ETH. Need ${s.formatEther(l)} ETH + gas`)},onSuccess:async d=>{let u=null;try{const f=new s.Interface(er);for(const p of d.logs)try{const b=f.parseLog(p);if((b==null?void 0:b.name)==="NFTRented"){u={endTime:Number(b.args.endTime),rentalCost:b.args.rentalCost,ethFee:b.args.ethFee};break}}catch{}}catch{}i&&i(d,u)},onError:r})}async function nr({tokenId:e,button:t=null,onSuccess:a=null,onError:n=null}){const i=window.ethers;return await H.execute({name:"WithdrawNFT",button:t,getContract:async r=>Na(r),method:"withdrawNFT",args:[e],validate:async(r,s)=>{const l=await(await we()).getListing(e);if(l.owner===i.ZeroAddress)throw new Error("NFT is not listed");if(l.owner.toLowerCase()!==s.toLowerCase())throw new Error("Only the owner can withdraw");if(l.currentlyRented)throw new Error("Cannot withdraw while NFT is rented")},onSuccess:a,onError:n})}async function bl({button:e=null,onSuccess:t=null,onError:a=null}={}){const n=window.ethers;return await H.execute({name:"WithdrawEarnings",button:e,getContract:async i=>Na(i),method:"withdrawEarnings",args:[],validate:async(i,r)=>{const o=await(await we()).pendingEarnings(r);if(o===0n)throw new Error("No earnings to withdraw");console.log("[RentalTx] Withdrawing:",n.formatEther(o),"ETH")},onSuccess:t,onError:a})}async function gl({tokenId:e,pricePerHour:t,minHours:a,maxHours:n,button:i=null,onSuccess:r=null,onError:s=null}){const o=BigInt(t);return await H.execute({name:"UpdateListing",button:i,getContract:async l=>Na(l),method:"updateListing",args:[e,o,a,n],validate:async(l,d)=>{const f=await(await we()).getListing(e);if(f.owner===window.ethers.ZeroAddress)throw new Error("NFT is not listed");if(f.owner.toLowerCase()!==d.toLowerCase())throw new Error("Only the owner can update")},onSuccess:r,onError:s})}async function xl(e){const t=window.ethers,n=await(await we()).getListing(e);return{owner:n.owner,pricePerHour:n.pricePerHour,pricePerHourFormatted:t.formatEther(n.pricePerHour),minHours:Number(n.minHours),maxHours:Number(n.maxHours),totalEarnings:n.totalEarnings,totalEarningsFormatted:t.formatEther(n.totalEarnings),rentalCount:Number(n.rentalCount),isActive:n.owner!==t.ZeroAddress,currentlyRented:n.currentlyRented,rentalEndTime:Number(n.rentalEndTime)}}async function hl(e){const a=await(await we()).getRental(e),n=Math.floor(Date.now()/1e3),i=Number(a.endTime);return{tenant:a.tenant,endTime:i,isActive:a.isActive,hoursRemaining:a.isActive?Math.max(0,Math.ceil((i-n)/3600)):0}}async function vl(){return(await(await we()).getAllListedTokenIds()).map(a=>Number(a))}async function wl(){const e=await we();return Number(await e.getListingCount())}async function yl(e,t){const a=window.ethers,i=await(await we()).getRentalCost(e,t);return{rentalCost:i.rentalCost||i[0],rentalCostFormatted:a.formatEther(i.rentalCost||i[0]),ethFee:i.ethFee||i[1],ethFeeFormatted:a.formatEther(i.ethFee||i[1]),totalCost:i.totalCost||i[2],totalCostFormatted:a.formatEther(i.totalCost||i[2])}}async function kl(e){return await(await we()).isRented(e)}async function El(e){const t=await we();return Number(await t.getRemainingTime(e))}async function Tl(e){const t=await we();try{return await t.hasActiveRental(e)}catch{return!1}}async function Cl(e){const t=window.ethers,n=await(await we()).pendingEarnings(e);return{amount:n,formatted:t.formatEther(n)}}async function Il(){const e=window.ethers,t=await we();try{const a=await t.getStats();return{activeListings:Number(a.activeListings||a[0]),totalVolume:a.volume||a[1],totalVolumeFormatted:e.formatEther(a.volume||a[1]),totalRentals:Number(a.rentals||a[2]),totalEthFees:a.ethFees||a[3],totalEthFeesFormatted:e.formatEther(a.ethFees||a[3]),totalEarningsWithdrawn:a.earningsWithdrawn||a[4],totalEarningsWithdrawnFormatted:e.formatEther(a.earningsWithdrawn||a[4])}}catch{return{activeListings:0,totalVolume:0n,totalVolumeFormatted:"0",totalRentals:0,totalEthFees:0n,totalEthFeesFormatted:"0"}}}const Al=tr,Pl=ar,zl=nr,Sa={listNft:tr,rentNft:ar,withdrawNft:nr,withdrawEarnings:bl,updateListing:gl,list:Al,rent:Pl,withdraw:zl,getListing:xl,getAllListedTokenIds:vl,getListingCount:wl,getRentalCost:yl,getRental:hl,isRented:kl,getRemainingRentalTime:El,hasActiveRental:Tl,getPendingEarnings:Cl,getMarketplaceStats:Il},wp=Object.freeze(Object.defineProperty({__proto__:null,RentalTx:Sa,getAllListedTokenIds:vl,getListing:xl,getListingCount:wl,getMarketplaceStats:Il,getPendingEarnings:Cl,getRemainingRentalTime:El,getRental:hl,getRentalCost:yl,hasActiveRental:Tl,isRented:kl,list:Al,listNft:tr,rent:Pl,rentNft:ar,updateListing:gl,withdraw:zl,withdrawEarnings:bl,withdrawNft:nr},Symbol.toStringTag,{value:"Module"}));function Bl(){var t;const e=(v==null?void 0:v.notary)||(M==null?void 0:M.notary)||((t=window.contractAddresses)==null?void 0:t.notary);if(!e)throw console.error("❌ Notary address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{NOTARY:e}}const ir=["function certify(bytes32 documentHash, string calldata meta, uint8 docType, address operator) external payable returns (uint256 certId)","function batchCertify(bytes32[] calldata documentHashes, string[] calldata metas, uint8[] calldata docTypes, address operator) external payable returns (uint256 startId)","function transferCertificate(bytes32 documentHash, address newOwner) external","function verify(bytes32 documentHash) view returns (bool exists, address owner, uint48 timestamp, uint8 docType, string memory meta)","function getCertificate(uint256 certId) view returns (bytes32 documentHash, address owner, uint48 timestamp, uint8 docType, string memory meta)","function getFee() view returns (uint256)","function getStats() view returns (uint256 certCount, uint256 totalEthCollected)","function certCount() view returns (uint256)","function version() view returns (string)","event Certified(uint256 indexed certId, address indexed owner, bytes32 indexed documentHash, uint8 docType, address operator)","event BatchCertified(address indexed owner, uint256 startId, uint256 count, address operator)","event CertificateTransferred(bytes32 indexed documentHash, address indexed from, address indexed to)"],yp={GENERAL:0,CONTRACT:1,IDENTITY:2,DIPLOMA:3,PROPERTY:4,FINANCIAL:5,LEGAL:6,MEDICAL:7,IP:8,OTHER:9};function kp(e){const t=window.ethers;if(!t)throw new Error("ethers.js not loaded");if(!e)throw new Error("Signer is required for write operations");const a=Bl();return new t.Contract(a.NOTARY,ir,e)}async function aa(){const e=window.ethers;if(!e)throw new Error("ethers.js not loaded");const{NetworkManager:t}=await K(async()=>{const{NetworkManager:i}=await import("./index-D_2TdD3O.js");return{NetworkManager:i}},[]),a=t.getProvider();if(!a)throw new Error("Provider not available");const n=Bl();return new e.Contract(n.NOTARY,ir,a)}function Ep(e){if(!e)return!1;const t=e.startsWith("0x")?e:`0x${e}`;return/^0x[a-fA-F0-9]{64}$/.test(t)}async function rr({documentHash:e,meta:t="",docType:a=0,operator:n,button:i=null,onSuccess:r=null,onError:s=null}){const o=window.ethers;if(!e)throw new Error("Document hash is required");const l=e.startsWith("0x")?e:`0x${e}`;if(!Ep(l))throw new Error("Invalid document hash format. Must be a valid bytes32 (64 hex characters)");if(a<0||a>9)throw new Error("Document type must be between 0 and 9");let d=n,u=0n;return await H.execute({name:"Certify",button:i,getContract:async f=>kp(f),method:"certify",args:()=>[l,t||"",a,Z(d)],get value(){return u},validate:async(f,p)=>{const b=await aa();if((await b.verify(l)).exists)throw new Error("This document hash has already been certified");u=await b.getFee(),console.log("[NotaryTx] Fee:",o.formatEther(u),"ETH");const{NetworkManager:w}=await K(async()=>{const{NetworkManager:S}=await import("./index-D_2TdD3O.js");return{NetworkManager:S}},[]),C=await w.getProvider().getBalance(p),P=u+o.parseEther("0.001");if(C<P)throw new Error(`Insufficient ETH. Need ~${o.formatEther(P)} ETH for fee + gas`)},onSuccess:async f=>{let p=null;try{const b=new o.Interface(ir);for(const g of f.logs)try{const w=b.parseLog(g);if(w&&w.name==="Certified"){p=Number(w.args.certId);break}}catch{}}catch{}r&&r(f,p)},onError:f=>{console.error("[NotaryTx] Certification failed:",f),s&&s(f)}})}const Nl=rr;async function kn(e){const t=await aa(),a=e.startsWith("0x")?e:`0x${e}`;try{const n=await t.verify(a);return{exists:n.exists,owner:n.exists?n.owner:null,timestamp:n.exists?Number(n.timestamp):null,date:n.exists?new Date(Number(n.timestamp)*1e3):null,docType:n.exists?Number(n.docType):null,meta:n.exists?n.meta:null}}catch(n){return console.error("[NotaryTx] verify error:",n),{exists:!1,owner:null,timestamp:null,date:null,docType:null,meta:null}}}const Sl=kn;async function sr(e){const t=await aa();try{const a=await t.getCertificate(e);return a.documentHash==="0x"+"0".repeat(64)?null:{id:e,documentHash:a.documentHash,owner:a.owner,timestamp:Number(a.timestamp),date:new Date(Number(a.timestamp)*1e3),docType:Number(a.docType),meta:a.meta}}catch{return null}}const $l=sr;async function Ll(){const e=window.ethers,a=await(await aa()).getFee();return{ethFee:a,ethFormatted:e.formatEther(a)+" ETH"}}async function Rl(){const e=await aa();return Number(await e.certCount())}async function _l(){const e=window.ethers,a=await(await aa()).getStats();return{totalCertifications:Number(a.certCount||a[0]),totalETHCollected:a.totalEthCollected||a[1],totalETHFormatted:e.formatEther(a.totalEthCollected||a[1])}}async function En(e){let t;if(e instanceof ArrayBuffer)t=e;else if(e instanceof Blob||e instanceof File)t=await e.arrayBuffer();else throw new Error("Invalid file type. Expected File, Blob, or ArrayBuffer");const a=await crypto.subtle.digest("SHA-256",t);return"0x"+Array.from(new Uint8Array(a)).map(i=>i.toString(16).padStart(2,"0")).join("")}async function or(e,t){const a=await En(e);return as(t)===as(a)}function as(e){return(e.startsWith("0x")?e:`0x${e}`).toLowerCase()}async function Fl(e,t){const a=t||await En(e),n=await kn(a);let i=!0;return t&&(i=await or(e,t)),{contentHash:a,hashMatches:i,existsOnChain:n.exists,certId:null,owner:n.owner,timestamp:n.timestamp,date:n.date,docType:n.docType,isVerified:i&&n.exists}}const Xe={certify:rr,notarize:Nl,verify:kn,verifyByHash:Sl,getCertificate:sr,getDocument:$l,getTotalDocuments:Rl,getFee:Ll,getStats:_l,calculateFileHash:En,verifyDocumentHash:or,verifyDocumentOnChain:Fl,DOC_TYPES:yp},Tp=Object.freeze(Object.defineProperty({__proto__:null,NotaryTx:Xe,calculateFileHash:En,certify:rr,getCertificate:sr,getDocument:$l,getFee:Ll,getStats:_l,getTotalDocuments:Rl,notarize:Nl,verify:kn,verifyByHash:Sl,verifyDocumentHash:or,verifyDocumentOnChain:Fl},Symbol.toStringTag,{value:"Module"}));function Ml(){var t;const e=(v==null?void 0:v.agora)||(M==null?void 0:M.agora)||((t=window.contractAddresses)==null?void 0:t.agora);if(!e)throw new Error("Agora contract address not loaded");return{AGORA:e}}const Tn=Pa;function ye(e){return new window.ethers.Contract(Ml().AGORA,Tn,e)}async function xe(){const{NetworkManager:e}=await K(async()=>{const{NetworkManager:t}=await import("./index-D_2TdD3O.js");return{NetworkManager:t}},[]);return new window.ethers.Contract(Ml().AGORA,Tn,e.getProvider())}async function Dl({username:e,metadataURI:t="",operator:a,button:n=null,onSuccess:i=null,onError:r=null}){const s=window.ethers;let o=a,l=0n;return await H.execute({name:"CreateProfile",button:n,skipSimulation:!0,fixedGasLimit:300000n,getContract:async d=>ye(d),method:"createProfile",args:()=>[e,t||"",Z(o)],get value(){return l},validate:async(d,u)=>{const f=await xe();if(!e||e.length<1||e.length>15)throw new Error("Username must be 1-15 characters");if(!/^[a-z0-9_]+$/.test(e))throw new Error("Username: lowercase letters, numbers, underscores only");if(!await f.isUsernameAvailable(e))throw new Error("Username is already taken");l=await f.getUsernamePrice(e.length),console.log("[Agora] Username fee:",s.formatEther(l),"ETH");const{NetworkManager:b}=await K(async()=>{const{NetworkManager:w}=await import("./index-D_2TdD3O.js");return{NetworkManager:w}},[]);if(await b.getProvider().getBalance(u)<l+s.parseEther("0.001"))throw new Error(`Insufficient ETH. Need ~${s.formatEther(l+s.parseEther("0.001"))} ETH`)},onSuccess:i,onError:r})}async function Ol({metadataURI:e,button:t=null,onSuccess:a=null,onError:n=null}){return await H.execute({name:"UpdateProfile",button:t,skipSimulation:!0,fixedGasLimit:200000n,getContract:async i=>ye(i),method:"updateProfile",args:[e||""],onSuccess:a,onError:n})}async function Hl({content:e,tag:t=0,contentType:a=0,operator:n,button:i=null,onSuccess:r=null,onError:s=null}){const o=window.ethers;let l=n;return await H.execute({name:"CreatePost",button:i,skipSimulation:!0,fixedGasLimit:300000n,getContract:async d=>ye(d),method:"createPost",args:()=>[e,t,a,Z(l)],validate:async(d,u)=>{if(!e||e.length===0)throw new Error("Content is required");if(t<0||t>14)throw new Error("Tag must be 0-14")},onSuccess:async d=>{let u=null;try{const f=new o.Interface(Tn);for(const p of d.logs)try{const b=f.parseLog(p);if((b==null?void 0:b.name)==="PostCreated"){u=Number(b.args[0]);break}}catch{}}catch{}r&&r(d,u)},onError:s})}async function Ul({parentId:e,content:t,contentType:a=0,operator:n,button:i=null,onSuccess:r=null,onError:s=null}){const o=window.ethers;let l=n;return await H.execute({name:"CreateReply",button:i,skipSimulation:!0,fixedGasLimit:350000n,getContract:async d=>ye(d),method:"createReply",args:()=>[e,t,a,Z(l)],validate:async(d,u)=>{if(!t)throw new Error("Content is required")},onSuccess:async d=>{let u=null;try{const f=new o.Interface(Tn);for(const p of d.logs)try{const b=f.parseLog(p);if((b==null?void 0:b.name)==="ReplyCreated"){u=Number(b.args[0]);break}}catch{}}catch{}r&&r(d,u)},onError:s})}async function jl({originalPostId:e,quote:t="",operator:a,button:n=null,onSuccess:i=null,onError:r=null}){let s=a;return await H.execute({name:"CreateRepost",button:n,skipSimulation:!0,fixedGasLimit:250000n,getContract:async o=>ye(o),method:"createRepost",args:()=>[e,t||"",Z(s)],onSuccess:i,onError:r})}async function Wl({postId:e,operator:t,button:a=null,onSuccess:n=null,onError:i=null}){let r=t;return await H.execute({name:"Like",button:a,skipSimulation:!0,fixedGasLimit:200000n,getContract:async s=>ye(s),method:"like",args:()=>[e,Z(r)],validate:async(s,o)=>{if(await(await xe()).hasLiked(e,o))throw new Error("Already liked this post")},onSuccess:n,onError:i})}async function Gl({postId:e,ethAmount:t,operator:a,button:n=null,onSuccess:i=null,onError:r=null}){let s=a;const o=BigInt(t);return await H.execute({name:"SuperLike",button:n,skipSimulation:!0,fixedGasLimit:250000n,getContract:async l=>ye(l),method:"superLike",args:()=>[e,Z(s)],value:o,validate:async()=>{if(o<100000000n)throw new Error("Minimum super like is 100 gwei")},onSuccess:i,onError:r})}async function Kl({postId:e,ethAmount:t,operator:a,button:n=null,onSuccess:i=null,onError:r=null}){let s=a;const o=BigInt(t);return await H.execute({name:"Downvote",button:n,skipSimulation:!0,fixedGasLimit:250000n,getContract:async l=>ye(l),method:"downvote",args:()=>[e,Z(s)],value:o,validate:async()=>{if(o<100000000n)throw new Error("Minimum downvote is 100 gwei")},onSuccess:i,onError:r})}async function Yl({toFollow:e,operator:t,button:a=null,onSuccess:n=null,onError:i=null}){let r=t;return await H.execute({name:"Follow",button:a,skipSimulation:!0,fixedGasLimit:200000n,getContract:async s=>ye(s),method:"follow",args:()=>[e,Z(r)],validate:async(s,o)=>{if(!e||e==="0x0000000000000000000000000000000000000000")throw new Error("Invalid address");if(e.toLowerCase()===o.toLowerCase())throw new Error("Cannot follow yourself")},onSuccess:n,onError:i})}async function Vl({toUnfollow:e,button:t=null,onSuccess:a=null,onError:n=null}){return await H.execute({name:"Unfollow",button:t,skipSimulation:!0,fixedGasLimit:150000n,getContract:async i=>ye(i),method:"unfollow",args:[e],onSuccess:a,onError:n})}async function ql({postId:e,button:t=null,onSuccess:a=null,onError:n=null}){return await H.execute({name:"DeletePost",button:t,skipSimulation:!0,fixedGasLimit:150000n,getContract:async i=>ye(i),method:"deletePost",args:[e],onSuccess:a,onError:n})}async function Xl({postId:e,button:t=null,onSuccess:a=null,onError:n=null}){return await H.execute({name:"PinPost",button:t,skipSimulation:!0,fixedGasLimit:150000n,getContract:async i=>ye(i),method:"pinPost",args:[e],onSuccess:a,onError:n})}async function Jl({ethAmount:e,operator:t,button:a=null,onSuccess:n=null,onError:i=null}){let r=t;const s=BigInt(e);return await H.execute({name:"BoostProfile",button:a,skipSimulation:!0,fixedGasLimit:200000n,getContract:async o=>ye(o),method:"boostProfile",args:()=>[Z(r)],value:s,validate:async()=>{const o=window.ethers;if(s<o.parseEther("0.0005"))throw new Error("Minimum boost is 0.0005 ETH")},onSuccess:n,onError:i})}async function Zl({operator:e,button:t=null,onSuccess:a=null,onError:n=null}){const i=window.ethers;let r=e;const s=i.parseEther("0.001");return await H.execute({name:"ObtainBadge",button:t,skipSimulation:!0,fixedGasLimit:250000n,getContract:async o=>ye(o),method:"obtainBadge",args:()=>[Z(r)],value:s,onSuccess:a,onError:n})}async function lr(e){const t=window.ethers,n=await(await xe()).getUsernamePrice(e);return{fee:n,formatted:t.formatEther(n)}}const Ql=lr;async function ec(e){const a=await(await xe()).getPost(e);return{author:a.author,tag:Number(a.tag),contentType:Number(a.contentType),deleted:a.deleted,createdAt:Number(a.createdAt),replyTo:Number(a._replyTo),repostOf:Number(a._repostOf),likes:Number(a.likes),superLikes:Number(a.superLikes),downvotes:Number(a.downvotes),replies:Number(a.replies),reposts:Number(a.reposts)}}async function tc(){const e=await xe();return Number(await e.postCounter())}async function ac(e){const a=await(await xe()).getUserProfile(e);return{usernameHash:a.usernameHash,metadataURI:a.metadataURI,pinnedPost:Number(a.pinned),boosted:a.boosted,hasBadge:a.hasBadge,boostExpiry:Number(a.boostExp),badgeExpiry:Number(a.badgeExp)}}async function nc(e){return await(await xe()).isUsernameAvailable(e)}async function ic(e,t){return await(await xe()).hasLiked(e,t)}async function rc(e){return await(await xe()).isProfileBoosted(e)}async function sc(e){return await(await xe()).hasTrustBadge(e)}async function oc(e){const a=await(await xe()).getUserProfile(e);return Number(a.boostExp)}async function lc(e){const a=await(await xe()).getUserProfile(e);return Number(a.badgeExp)}async function cc(){const t=await(await xe()).getGlobalStats();return{totalPosts:Number(t._totalPosts||t[0]),totalProfiles:Number(t._totalProfiles||t[1]),tagCounts:(t._tagCounts||t[2]).map(a=>Number(a))}}async function dc(e){const a=await(await xe()).getOperatorStats(e);return{posts:Number(a.posts_||a[0]),engagement:Number(a.engagement||a[1])}}async function uc(){return await(await xe()).version()}const ge={createProfile:Dl,updateProfile:Ol,createPost:Hl,createReply:Ul,createRepost:jl,deletePost:ql,pinPost:Xl,like:Wl,superLike:Gl,downvote:Kl,follow:Yl,unfollow:Vl,boostProfile:Jl,obtainBadge:Zl,getUsernamePrice:lr,getUsernameFee:Ql,getPost:ec,getPostCount:tc,getUserProfile:ac,isUsernameAvailable:nc,hasUserLiked:ic,isProfileBoosted:rc,hasTrustBadge:sc,getBoostExpiry:oc,getBadgeExpiry:lc,getGlobalStats:cc,getOperatorStats:dc,getVersion:uc},Cp=Object.freeze(Object.defineProperty({__proto__:null,BackchatTx:ge,boostProfile:Jl,createPost:Hl,createProfile:Dl,createReply:Ul,createRepost:jl,deletePost:ql,downvote:Kl,follow:Yl,getBadgeExpiry:lc,getBoostExpiry:oc,getGlobalStats:cc,getOperatorStats:dc,getPost:ec,getPostCount:tc,getUserProfile:ac,getUsernameFee:Ql,getUsernamePrice:lr,getVersion:uc,hasTrustBadge:sc,hasUserLiked:ic,isProfileBoosted:rc,isUsernameAvailable:nc,like:Wl,obtainBadge:Zl,pinPost:Xl,superLike:Gl,unfollow:Vl,updateProfile:Ol},Symbol.toStringTag,{value:"Module"}));(async()=>(await K(async()=>{const{CharityTx:e}=await Promise.resolve().then(()=>cp);return{CharityTx:e}},void 0)).CharityTx)(),(async()=>(await K(async()=>{const{StakingTx:e}=await Promise.resolve().then(()=>dp);return{StakingTx:e}},void 0)).StakingTx)(),(async()=>(await K(async()=>{const{NftTx:e}=await Promise.resolve().then(()=>fp);return{NftTx:e}},void 0)).NftTx)(),(async()=>(await K(async()=>{const{FortuneTx:e}=await Promise.resolve().then(()=>xp);return{FortuneTx:e}},void 0)).FortuneTx)(),(async()=>(await K(async()=>{const{RentalTx:e}=await Promise.resolve().then(()=>wp);return{RentalTx:e}},void 0)).RentalTx)(),(async()=>(await K(async()=>{const{NotaryTx:e}=await Promise.resolve().then(()=>Tp);return{NotaryTx:e}},void 0)).NotaryTx)(),(async()=>(await K(async()=>{const{FaucetTx:e}=await Promise.resolve().then(()=>Vu);return{FaucetTx:e}},void 0)).FaucetTx)(),(async()=>(await K(async()=>{const{BackchatTx:e}=await Promise.resolve().then(()=>Cp);return{BackchatTx:e}},void 0)).BackchatTx)();const Qa=window.ethers,L={hasRenderedOnce:!1,lastUpdate:0,activities:[],networkActivities:[],filteredActivities:[],userProfile:null,pagination:{currentPage:1,itemsPerPage:8},filters:{type:"ALL",sort:"NEWEST"},metricsCache:{},economicData:null,isLoadingNetworkActivity:!1,networkActivitiesTimestamp:0,faucet:{canClaim:!0,cooldownEnd:null,isLoading:!1,lastCheck:0}},ns="https://sepolia.arbiscan.io/tx/",Ip="https://faucet-4wvdcuoouq-uc.a.run.app",Ap="https://getrecentactivity-4wvdcuoouq-uc.a.run.app",Pp="https://getsystemdata-4wvdcuoouq-uc.a.run.app",pc="1,000",fc="0.01",O={STAKING:{icon:"fa-lock",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🔒 Staked",emoji:"🔒"},UNSTAKING:{icon:"fa-unlock",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"🔓 Unstaked",emoji:"🔓"},FORCE_UNSTAKE:{icon:"fa-bolt",color:"#ef4444",bg:"rgba(239,68,68,0.15)",label:"⚡ Force Unstaked",emoji:"⚡"},CLAIM:{icon:"fa-coins",color:"#fbbf24",bg:"rgba(245,158,11,0.15)",label:"🪙 Rewards Claimed",emoji:"🪙"},NFT_BUY:{icon:"fa-bag-shopping",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🛍️ Bought NFT",emoji:"🛍️"},NFT_SELL:{icon:"fa-hand-holding-dollar",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"💰 Sold NFT",emoji:"💰"},NFT_MINT:{icon:"fa-gem",color:"#fde047",bg:"rgba(234,179,8,0.15)",label:"💎 Minted Booster",emoji:"💎"},NFT_TRANSFER:{icon:"fa-arrow-right-arrow-left",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"↔️ Transfer",emoji:"↔️"},RENTAL_LIST:{icon:"fa-tag",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🏷️ Listed NFT",emoji:"🏷️"},RENTAL_RENT:{icon:"fa-clock",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"⏰ Rented NFT",emoji:"⏰"},RENTAL_WITHDRAW:{icon:"fa-rotate-left",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"↩️ Withdrawn",emoji:"↩️"},RENTAL_PROMOTE:{icon:"fa-bullhorn",color:"#fbbf24",bg:"rgba(251,191,36,0.2)",label:"📢 Promoted NFT",emoji:"📢"},FORTUNE_COMMIT:{icon:"fa-lock",color:"#a855f7",bg:"rgba(168,85,247,0.2)",label:"🔐 Game Committed",emoji:"🔐"},FORTUNE_REVEAL:{icon:"fa-dice",color:"#f97316",bg:"rgba(249,115,22,0.2)",label:"🎲 Game Revealed",emoji:"🎲"},FORTUNE_BET:{icon:"fa-paw",color:"#f97316",bg:"rgba(249,115,22,0.2)",label:"🐯 Fortune Bet",emoji:"🐯"},FORTUNE_COMBO:{icon:"fa-rocket",color:"#a855f7",bg:"rgba(168,85,247,0.2)",label:"🚀 Combo Mode",emoji:"🚀"},FORTUNE_WIN:{icon:"fa-trophy",color:"#facc15",bg:"rgba(234,179,8,0.25)",label:"🏆 Winner!",emoji:"🏆"},NOTARY:{icon:"fa-stamp",color:"#818cf8",bg:"rgba(99,102,241,0.15)",label:"📜 Notarized",emoji:"📜"},BACKCHAT_POST:{icon:"fa-comment",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"💬 Posted",emoji:"💬"},BACKCHAT_LIKE:{icon:"fa-heart",color:"#ec4899",bg:"rgba(236,72,153,0.15)",label:"❤️ Liked",emoji:"❤️"},BACKCHAT_REPLY:{icon:"fa-reply",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"↩️ Replied",emoji:"↩️"},BACKCHAT_SUPERLIKE:{icon:"fa-star",color:"#fbbf24",bg:"rgba(251,191,36,0.2)",label:"⭐ Super Liked",emoji:"⭐"},BACKCHAT_REPOST:{icon:"fa-retweet",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🔄 Reposted",emoji:"🔄"},BACKCHAT_FOLLOW:{icon:"fa-user-plus",color:"#a78bfa",bg:"rgba(167,139,250,0.15)",label:"👥 Followed",emoji:"👥"},BACKCHAT_PROFILE:{icon:"fa-user",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"👤 Profile Created",emoji:"👤"},BACKCHAT_BOOST:{icon:"fa-rocket",color:"#f97316",bg:"rgba(249,115,22,0.15)",label:"🚀 Profile Boosted",emoji:"🚀"},BACKCHAT_BADGE:{icon:"fa-circle-check",color:"#10b981",bg:"rgba(16,185,129,0.15)",label:"✅ Badge Activated",emoji:"✅"},BACKCHAT_TIP:{icon:"fa-coins",color:"#fbbf24",bg:"rgba(251,191,36,0.15)",label:"💰 Tipped BKC",emoji:"💰"},BACKCHAT_WITHDRAW:{icon:"fa-wallet",color:"#8b5cf6",bg:"rgba(139,92,246,0.15)",label:"💸 ETH Withdrawn",emoji:"💸"},CHARITY_DONATE:{icon:"fa-heart",color:"#ec4899",bg:"rgba(236,72,153,0.15)",label:"💝 Donated",emoji:"💝"},CHARITY_CREATE:{icon:"fa-hand-holding-heart",color:"#10b981",bg:"rgba(16,185,129,0.15)",label:"🌱 Campaign Created",emoji:"🌱"},CHARITY_CANCEL:{icon:"fa-heart-crack",color:"#ef4444",bg:"rgba(239,68,68,0.15)",label:"💔 Campaign Cancelled",emoji:"💔"},CHARITY_WITHDRAW:{icon:"fa-hand-holding-dollar",color:"#8b5cf6",bg:"rgba(139,92,246,0.15)",label:"💰 Funds Withdrawn",emoji:"💰"},CHARITY_GOAL_REACHED:{icon:"fa-trophy",color:"#fbbf24",bg:"rgba(251,191,36,0.15)",label:"🏆 Goal Reached!",emoji:"🏆"},FAUCET:{icon:"fa-droplet",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"💧 Faucet Claim",emoji:"💧"},DEFAULT:{icon:"fa-circle",color:"#71717a",bg:"rgba(39,39,42,0.5)",label:"Activity",emoji:"📋"}};function zp(e){if(!e)return"Just now";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3,a=new Date(t*1e3),i=new Date-a,r=Math.floor(i/6e4),s=Math.floor(i/36e5),o=Math.floor(i/864e5);return r<1?"Just now":r<60?`${r}m ago`:s<24?`${s}h ago`:o<7?`${o}d ago`:a.toLocaleDateString()}catch{return"Recent"}}function Bp(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function Hn(e){return e>=1e6?(e/1e6).toFixed(2)+"M":e>=1e3?(e/1e3).toFixed(1)+"K":e.toFixed(0)}function Np(e){return e?`${e.slice(0,6)}...${e.slice(-4)}`:""}function Sp(e){if(!e)return"";const t=Date.now(),n=new Date(e).getTime()-t;if(n<=0)return"";const i=Math.floor(n/36e5),r=Math.floor(n%36e5/6e4);return i>0?`${i}h ${r}m`:`${r}m`}function $p(e,t={}){const a=(e||"").toUpperCase().trim();return a==="STAKING"||a==="STAKED"||a==="STAKE"||a==="DELEGATED"||a==="DELEGATION"||a.includes("DELEGAT")?O.STAKING:a==="UNSTAKING"||a==="UNSTAKED"||a==="UNSTAKE"||a==="UNDELEGATED"?O.UNSTAKING:a==="FORCE_UNSTAKE"||a==="FORCEUNSTAKE"||a==="FORCE_UNSTAKED"?O.FORCE_UNSTAKE:a==="CLAIM"||a==="CLAIMED"||a==="REWARD"||a==="REWARDS"||a==="REWARD_CLAIMED"||a==="REWARDCLAIMED"?O.CLAIM:a==="NFT_BUY"||a==="NFTBUY"||a==="BOOSTER_BUY"||a==="BOOSTERBUY"||a==="BOOSTERBOUGHT"||a.includes("BUY")&&(a.includes("NFT")||a.includes("BOOSTER"))?O.NFT_BUY:a==="NFT_SELL"||a==="NFTSELL"||a==="BOOSTER_SELL"||a==="BOOSTERSELL"||a==="BOOSTERSOLD"||a.includes("SELL")&&(a.includes("NFT")||a.includes("BOOSTER"))?O.NFT_SELL:a==="NFT_MINT"||a==="NFTMINT"||a==="BOOSTER_MINT"||a==="BOOSTERMINT"||a==="MINTED"||a==="BOOSTERMINTED"?O.NFT_MINT:a==="NFT_TRANSFER"||a==="NFTTRANSFER"||a==="BOOSTER_TRANSFER"||a==="BOOSTERTRANSFER"||a==="TRANSFER"?O.NFT_TRANSFER:a==="RENTAL_LIST"||a==="RENTALLISTED"||a==="RENTAL_LISTED"||a==="LISTED"||a.includes("LIST")&&a.includes("RENTAL")?O.RENTAL_LIST:a==="RENTAL_RENT"||a==="RENTALRENTED"||a==="RENTAL_RENTED"||a==="RENTED"||a.includes("RENT")&&!a.includes("LIST")?O.RENTAL_RENT:a==="RENTAL_WITHDRAW"||a==="RENTALWITHDRAWN"||a==="RENTAL_WITHDRAWN"?O.RENTAL_WITHDRAW:a==="RENTAL_PROMOTE"||a==="RENTALPROMOTED"||a==="RENTAL_PROMOTED"||a.includes("PROMOT")||a.includes("ADS")||a.includes("ADVERTIS")?O.RENTAL_PROMOTE:a==="FORTUNE_COMMIT"||a==="GAMECOMMITTED"||a==="GAME_COMMITTED"||a==="COMMITTED"?O.FORTUNE_COMMIT:a==="FORTUNE_REVEAL"||a==="GAMEREVEALED"||a==="GAME_REVEALED"||a==="REVEALED"?O.FORTUNE_REVEAL:a.includes("GAME")||a.includes("FORTUNE")||a.includes("REQUEST")||a.includes("FULFILLED")||a.includes("RESULT")?(t==null?void 0:t.isWin)||(t==null?void 0:t.prizeWon)&&BigInt(t.prizeWon||0)>0n?O.FORTUNE_WIN:(t==null?void 0:t.isCumulative)?O.FORTUNE_COMBO:O.FORTUNE_BET:a==="POSTCREATED"||a==="POST_CREATED"||a==="POSTED"||a==="BACKCHAT_POST"||a.includes("POST")&&!a.includes("REPOST")?O.BACKCHAT_POST:a==="SUPERLIKED"||a==="SUPER_LIKED"||a.includes("SUPERLIKE")?O.BACKCHAT_SUPERLIKE:a==="LIKED"||a==="POSTLIKED"||a==="POST_LIKED"||a.includes("LIKE")&&!a.includes("SUPER")?O.BACKCHAT_LIKE:a==="REPLYCREATED"||a==="REPLY_CREATED"||a.includes("REPLY")?O.BACKCHAT_REPLY:a==="REPOSTCREATED"||a==="REPOST_CREATED"||a.includes("REPOST")?O.BACKCHAT_REPOST:a==="FOLLOWED"||a==="USER_FOLLOWED"||a.includes("FOLLOW")?O.BACKCHAT_FOLLOW:a==="PROFILECREATED"||a==="PROFILE_CREATED"||a.includes("PROFILE")&&a.includes("CREAT")?O.BACKCHAT_PROFILE:a==="PROFILEBOOSTED"||a==="PROFILE_BOOSTED"||a==="BOOSTED"||a.includes("BOOST")&&!a.includes("NFT")?O.BACKCHAT_BOOST:a==="BADGEACTIVATED"||a==="BADGE_ACTIVATED"||a.includes("BADGE")?O.BACKCHAT_BADGE:a==="TIPPROCESSED"||a==="TIP_PROCESSED"||a==="TIPPED"||a.includes("TIP")?O.BACKCHAT_TIP:a==="ETHWITHDRAWN"||a==="ETH_WITHDRAWN"||a==="BACKCHAT_WITHDRAW"?O.BACKCHAT_WITHDRAW:a==="CHARITYDONATION"||a==="DONATIONMADE"||a==="CHARITY_DONATE"||a==="DONATED"||a==="DONATION"||a.includes("DONATION")?O.CHARITY_DONATE:a==="CHARITYCAMPAIGNCREATED"||a==="CAMPAIGNCREATED"||a==="CHARITY_CREATE"||a==="CAMPAIGN_CREATED"||a.includes("CAMPAIGNCREATED")?O.CHARITY_CREATE:a==="CHARITYCAMPAIGNCANCELLED"||a==="CAMPAIGNCANCELLED"||a==="CHARITY_CANCEL"||a==="CAMPAIGN_CANCELLED"||a.includes("CANCELLED")?O.CHARITY_CANCEL:a==="CHARITYFUNDSWITHDRAWN"||a==="FUNDSWITHDRAWN"||a==="CHARITY_WITHDRAW"||a==="CAMPAIGN_WITHDRAW"||a.includes("WITHDRAWN")?O.CHARITY_WITHDRAW:a==="CHARITYGOALREACHED"||a==="GOALREACHED"||a==="CHARITY_GOAL"||a==="CAMPAIGN_COMPLETED"?O.CHARITY_GOAL_REACHED:a==="NOTARYREGISTER"||a==="NOTARIZED"||a.includes("NOTARY")||a.includes("DOCUMENT")?O.NOTARY:a==="FAUCETCLAIM"||a.includes("FAUCET")||a.includes("DISTRIBUTED")?O.FAUCET:O.DEFAULT}let Un=null,yt=0n;function mc(e){const t=document.getElementById("dash-user-rewards");if(!t||!c.isConnected){Un&&cancelAnimationFrame(Un);return}const a=e-yt;a>-1000000000n&&a<1000000000n?yt=e:yt+=a/8n,yt<0n&&(yt=0n),t.innerHTML=`${F(yt).toFixed(4)} <span class="dash-reward-suffix">BKC</span>`,yt!==e&&(Un=requestAnimationFrame(()=>mc(e)))}async function is(e){if(!c.isConnected||!c.userAddress)return x("Connect wallet first","error");const t=e.innerHTML;e.disabled=!0,e.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-2"></i> Sending...',L.faucet.isLoading=!0;try{const a=await fetch(`${Ip}?address=${c.userAddress}`,{method:"GET",headers:{Accept:"application/json"}}),n=await a.json();if(a.ok&&n.success)x(`Faucet Sent! ${pc} BKC + ${fc} ETH`,"success"),L.faucet.canClaim=!1,L.faucet.cooldownEnd=new Date(Date.now()+24*60*60*1e3).toISOString(),ri(),setTimeout(()=>{xc.update(!0)},4e3);else{const i=n.error||n.message||"Faucet unavailable";if(i.toLowerCase().includes("cooldown")||i.toLowerCase().includes("wait")||i.toLowerCase().includes("hour")){x(`${i}`,"warning");const r=i.match(/(\d+)\s*hour/i);r&&(L.faucet.canClaim=!1,L.faucet.cooldownEnd=new Date(Date.now()+parseInt(r[1])*36e5).toISOString(),ri())}else x(`${i}`,"error")}}catch(a){console.error("Faucet error:",a),x("Faucet Offline - Try again later","error")}finally{L.faucet.isLoading=!1,e.disabled=!1,e.innerHTML=t}}function ri(){const e=document.getElementById("dashboard-faucet-widget");if(!e)return;const t=document.getElementById("faucet-title"),a=document.getElementById("faucet-desc"),n=document.getElementById("faucet-status"),i=document.getElementById("faucet-action-btn");if(!c.isConnected){e.style.opacity="0.5",t&&(t.innerText="Get Free Testnet Tokens"),a&&(a.innerText="Connect your wallet to claim BKC + ETH for gas"),n&&n.classList.add("hidden"),i&&(i.className="dash-btn-secondary",i.innerHTML='<i class="fa-solid fa-wallet"></i> Connect Wallet',i.disabled=!0);return}e.style.opacity="1";const r=Sp(L.faucet.cooldownEnd);!(L.faucet.canClaim&&!r)&&r?(t&&(t.innerText="Faucet Cooldown"),a&&(a.innerText="Come back when the timer ends"),n&&(n.classList.remove("hidden"),n.innerHTML=`<i class="fa-solid fa-clock" style="margin-right:4px"></i>${r} remaining`),i&&(i.className="dash-btn-secondary",i.innerHTML='<i class="fa-solid fa-hourglass-half"></i> On Cooldown',i.disabled=!0)):(t&&(t.innerText="Get Free Testnet Tokens"),a&&(a.innerText="Claim BKC tokens and ETH for gas — free every hour"),n&&n.classList.add("hidden"),i&&(i.className="dash-btn-primary dash-btn-cyan",i.innerHTML='<i class="fa-solid fa-faucet"></i> Claim Free Tokens',i.disabled=!1))}async function Lp(){try{if(await c.provider.getBalance(c.userAddress)<Qa.parseEther("0.002")){const t=document.getElementById("no-gas-modal-dash");return t&&(t.classList.remove("hidden"),t.classList.add("flex")),!1}return!0}catch{return!0}}function Rp(){if(document.getElementById("dash-styles-v69"))return;const e=document.createElement("style");e.id="dash-styles-v69",e.textContent=`
        /* ── CSS Variables ── */
        .dash-shell {
            --dash-bg: #0c0c0e;
            --dash-surface: #141417;
    ...
    `}async function Dp(){try{const e=await fetch(Pp);if(e.ok){const t=await e.json();return L.economicData=t,t}}catch{}return null}async function si(){var e,t,a,n,i,r,s;try{const o=await Dp();let l=0n,d=0n,u=0n,f=0n,p=0n,b=0,g=0n;if(o&&((e=o.token)!=null&&e.totalSupply&&(l=BigInt(o.token.totalSupply)),(t=o.token)!=null&&t.totalBurned&&(f=BigInt(o.token.totalBurned)),(a=o.staking)!=null&&a.totalPStake&&(d=BigInt(o.staking.totalPStake)),(n=o.ecosystem)!=null&&n.totalEthCollected&&(p=BigInt(o.ecosystem.totalEthCollected)),(i=o.fortunePool)!=null&&i.prizePool&&(g=BigInt(o.fortunePool.prizePool)),(r=o.notary)!=null&&r.certCount&&(b=o.notary.certCount),(s=o.stats)!=null&&s.notarizedDocuments&&(b=Math.max(b,o.stats.notarizedDocuments))),c.bkcTokenContractPublic){l===0n&&(l=await te(c.bkcTokenContractPublic,"totalSupply",[],0n)),f===0n&&(f=await te(c.bkcTokenContractPublic,"totalBurned",[],0n)),d===0n&&(c.stakingPoolContractPublic||c.stakingPoolContract)&&(d=await te(c.stakingPoolContractPublic||c.stakingPoolContract,"totalPStake",[],0n));const ae=[v.stakingPool,v.fortunePool,v.rentalManager,v.buybackMiner,v.liquidityPool,v.pool_diamond,v.pool_gold,v.pool_silver,v.pool_bronze].filter(q=>q&&q!==Qa.ZeroAddress),ue=await Promise.all(ae.map(q=>te(c.bkcTokenContractPublic,"balanceOf",[q],0n)));if(ue.forEach(q=>{u+=q}),v.fortunePool&&g===0n){const q=ae.indexOf(v.fortunePool);q>=0&&(g=ue[q])}}const w=F(l),T=F(f),C=F(p),P=F(g),S=ae=>ae.toLocaleString("en-US",{minimumFractionDigits:1,maximumFractionDigits:1});let $=0;l>0n&&($=Number(u*10000n/l)/100),$>100&&($=100);const B=(ae,ue)=>{const q=document.getElementById(ae);q&&(q.innerHTML=ue)};B("dash-metric-supply",`${S(w)} <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>`),B("dash-metric-pstake",Yt(d)),B("dash-metric-burned",T>0?`<span style="color:#ef4444">${Hn(T)}</span> <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>`:'<span style="color:var(--dash-text-3)">0 BKC</span>'),B("dash-metric-fees",C>0?`${Hn(C)} <span style="font-size:10px;color:var(--dash-text-3)">ETH</span>`:'<span style="color:var(--dash-text-3)">0 ETH</span>');const I=$>30?"var(--dash-green)":$>10?"#fbbf24":"#60a5fa";B("dash-metric-tvl",`<span style="color:${I}">${$.toFixed(1)}%</span>`),bc();const _=document.getElementById("dash-fortune-prize-text");_&&(_.innerText=P>0?`Prize: ${Hn(P)} BKC`:"Play to win");const W=document.getElementById("dash-notary-count-text");W&&(W.innerText=b>0?`${b} docs certified`:"Certify documents"),L.metricsCache={supply:w,burned:T,fees:C,timestamp:Date.now()}}catch(o){console.error("Metrics Error",o)}}function bc(){const e=document.getElementById("dash-metric-balance");if(!e)return;const t=c.currentUserBalance||c.bkcBalance||0n;if(!c.isConnected){e.innerHTML='<span style="font-size:11px;color:var(--dash-text-3)">Connect Wallet</span>';return}if(t===0n)e.innerHTML='0.00 <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>';else{const a=F(t);e.innerHTML=`${a.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>`}}async function Op(){if(c.userAddress)try{const e=await fetch(`https://getuserprofile-4wvdcuoouq-uc.a.run.app/${c.userAddress}`);e.ok&&(L.userProfile=await e.json())}catch{}}async function Ut(e=!1){var t,a;if(!c.isConnected){const n=document.getElementById("dash-booster-area");n&&(n.innerHTML=`
                <div style="text-align:center">
        ...
        `;return}const b=e.source==="rented",g=b?"background:rgba(6,182,212,0.15);color:#67e8f9":"background:rgba(74,222,128,0.15);color:#86efac",w=b?"Rented":"Owned",T=(d==null?void 0:d.name)||(($=e.boostName)==null?void 0:$.replace(" Booster","").replace("Booster","").trim())||"Booster",C=(d==null?void 0:d.color)||"color:var(--dash-accent)",P=r*50n/100n,S=s-P;(B=d==null?void 0:d.borderColor)!=null&&B.replace("border-","").replace("/50",""),a.innerHTML=`
        <div class="nft-clickable-image" data-address="${v.rewardBooster}" data-tokenid="${e.tokenId}" style="display:flex;align-items:center;gap:12px;background:var(--dash-surface-2);border:1px solid rgba(255,255,255,0.08);border-radius:12px;padding:12px;cursor:pointer;transition:all 0.2s;width:100%">
            ...
            <div style="flex:1;min-width:0">
                <div style="display:flex;align-items:center;gap:6px;margin-bottom:2px">
                    <span style="font-size:9px;font-weight:700;${g};padding:1px 6px;border-radius:4px;text-transform:uppercase">${w}</span>
                ...
                ${r>0n?`<p style="font-size:11px;color:var(--dash-text);margin:3px 0 0;font-weight:600">Net: <span style="color:var(--dash-green);font-weight:700">${F(s).toFixed(4)} BKC</span></p>`:""}
                ${S>0n?`<p style="font-size:9px;color:#34d399;margin:2px 0 0"><i class="fa-solid fa-arrow-trend-up" style="margin-right:2px"></i>+${F(S).toFixed(2)} BKC saved vs no NFT</p>`:""}
    ...
    `}async function en(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("activity-title");try{if(c.isConnected){if(L.activities.length===0){e&&(e.innerHTML='<div class="dash-loading"><img src="./assets/bkc_logo_3d.png" class="dash-loading-logo" alt=""><span class="dash-loading-text">Loading your activity...</span></div>');const a=await fetch(`${Ue.getHistory}/${c.userAddress}`);a.ok&&(L.activities=await a.json())}if(L.activities.length>0){t&&(t.textContent="Your Activity"),oi();return}}t&&(t.textContent="Network Activity"),await rs()}catch(a){console.error("Activity fetch error:",a),t&&(t.textContent="Network Activity"),await rs()}}async function rs(){const e=document.getElementById("dash-activity-list");if(!e||L.isLoadingNetworkActivity)return;const t=Date.now()-L.networkActivitiesTimestamp;if(L.networkActivities.length>0&&t<3e5){ss();return}L.isLoadingNetworkActivity=!0,e.innerHTML='<div class="dash-loading"><img src="./assets/bkc_logo_3d.png" class="dash-loading-logo" alt=""><span class="dash-loading-text">Loading network activity...</span></div>';try{const a=await fetch(`${Ap}?limit=30`);if(a.ok){const n=await a.json();L.networkActivities=Array.isArray(n)?n:n.activities||[],L.networkActivitiesTimestamp=Date.now()}else L.networkActivities=[]}catch{L.networkActivities=[]}finally{L.isLoadingNetworkActivity=!1}ss()}function ss(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("dash-pagination-controls");if(e){if(L.networkActivities.length===0){e.innerHTML='<div class="dash-empty-text">No network activity yet. Be the first!</div>',t&&(t.style.display="none");return}e.innerHTML=L.networkActivities.slice(0,15).map(a=>gc(a,!0)).join(""),t&&(t.style.display="none")}}function oi(){let e=[...L.activities];const t=L.filters.type,a=n=>(n||"").toUpperCase();t!=="ALL"&&(e=e.filter(n=>{const i=a(n.type);return t==="STAKE"?i.includes("DELEGATION")||i.includes("DELEGAT")||i.includes("STAKE")||i.includes("UNSTAKE"):t==="CLAIM"?i.includes("REWARD")||i.includes("CLAIM"):t==="NFT"?i.includes("BOOSTER")||i.includes("RENT")||i.includes("NFT")||i.includes("TRANSFER"):t==="GAME"?i.includes("FORTUNE")||i.includes("GAME")||i.includes("REQUEST")||i.includes("RESULT")||i.includes("FULFILLED"):t==="CHARITY"?i.includes("CHARITY")||i.includes("CAMPAIGN")||i.includes("DONATION")||i.includes("DONATE"):t==="NOTARY"?i.includes("NOTARY")||i.includes("NOTARIZED")||i.includes("DOCUMENT"):t==="BACKCHAT"?i.includes("POST")||i.includes("LIKE")||i.includes("REPLY")||i.includes("REPOST")||i.includes("FOLLOW")||i.includes("PROFILE")||i.includes("BOOST")||i.includes("BADGE")||i.includes("TIP")||i.includes("BACKCHAT"):t==="FAUCET"?i.includes("FAUCET"):!0})),e.sort((n,i)=>{const r=s=>s.timestamp&&s.timestamp._seconds?s.timestamp._seconds:s.createdAt&&s.createdAt._seconds?s.createdAt._seconds:s.timestamp?new Date(s.timestamp).getTime()/1e3:0;return L.filters.sort==="NEWEST"?r(i)-r(n):r(n)-r(i)}),L.filteredActivities=e,L.pagination.currentPage=1,li()}function li(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("dash-pagination-controls");if(!e)return;if(L.filteredActivities.length===0){e.innerHTML='<div class="dash-empty-text">No activity yet. Start staking, trading or playing!</div>',t&&(t.style.display="none");return}const a=(L.pagination.currentPage-1)*L.pagination.itemsPerPage,n=L.filteredActivities.slice(a,a+L.pagination.itemsPerPage);if(e.innerHTML=n.map(i=>gc(i,!1)).join(""),t){const i=Math.ceil(L.filteredActivities.length/L.pagination.itemsPerPage);i>1?(t.style.display="flex",document.getElementById("page-indicator").innerText=`${L.pagination.currentPage}/${i}`,document.getElementById("page-prev").disabled=L.pagination.currentPage===1,document.getElementById("page-next").disabled=L.pagination.currentPage>=i):t.style.display="none"}}function gc(e,t=!1){const a=zp(e.timestamp||e.createdAt),n=Bp(e.timestamp||e.createdAt),i=e.user||e.userAddress||e.from||"",r=Np(i),s=$p(e.type,e.details);let o="";const l=(e.type||"").toUpperCase().trim(),d=e.details||{};if(l.includes("GAME")||l.includes("FORTUNE")||l.includes("REQUEST")||l.includes("FULFILLED")||l.includes("RESULT")){const w=d.rolls||e.rolls||[],T=d.guesses||e.guesses||[],C=d.isWin||d.prizeWon&&BigInt(d.prizeWon||0)>0n,P=d.isCumulative!==void 0?d.isCumulative:T.length>1,S=P?"Combo":"Jackpot",$=P?"background:rgba(168,85,247,0.15);color:#c084fc":"background:rgba(245,158,11,0.15);color:#fbbf24",B=d.wagerAmount||d.amount,I=d.prizeWon,_=B?F(BigInt(B)).toFixed(0):"0";let W='<span style="color:var(--dash-text-3)">No win</span>';C&&I&&BigInt(I)>0n&&(W=`<span style="color:var(--dash-green);font-weight:700">+${F(BigInt(I)).toFixed(0)} BKC</span>`);let ae="";return w.length>0&&(ae=`<div style="display:flex;gap:3px">${w.map((q,pe)=>{const Y=T[pe],ne=Y!==void 0&&Number(Y)===Number(q);return`<div style="width:24px;height:24px;border-radius:4px;font-size:10px;font-weight:700;display:flex;align-items:center;justify-content:center;border:1px solid ${ne?"rgba(52,211,153,0.4)":"var(--dash-border)"};background:${ne?"rgba(52,211,153,0.1)":"var(--dash-surface-2)"};color:${ne?"#34d399":"var(--dash-text-3)"}">${q}</div>`}).join("")}</div>`),`
            <a href="${e.txHash?`${ns}${e.txHash}`:"#"}" target="_blank" class="dash-fortune-item" title="${n}">
                <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:6px">
                    <div style="display:flex;align-items:center;gap:8px">
                        ...
                        <span style="font-size:9px;font-weight:700;${$};padding:1px 6px;border-radius:4px">${S}</span>
                    </div>
    ...
    `,document.head.appendChild(e)}function gf(){return`
    ...
    `}const xf={async render(e){bf(),await Ws();const t=document.getElementById("store");t&&((t.innerHTML.trim()===""||e)&&(t.innerHTML=`
        ...
        `}).join("")}}function hf(){return be.map((e,t)=>{const a=Cn(e.name),n=t===0,i=ft(e.boostBips),r=a.icon||e.emoji||"💎";return`
    ...
    `}function vf(e,t,a,n,i=!1){return c.isConnected?e?t?`
        ...
        `}).join("")}async function rt(e=!1){var n,i;if(N.selectedPoolBoostBips===null)return;const t=N.selectedPoolBoostBips,a=Date.now();if(Tt=a,!e){const r=mf(t);if(r){fi(r),nn(),ds(),yf(t,a);return}}N.isDataLoading=!0;try{const r=c.myBoosters||[],s=c.rentalListings||[],o=new Set(s.map(Y=>{var ne;return(ne=Y.tokenId)==null?void 0:ne.toString()})),l=Math.floor(Date.now()/1e3),d=r.filter(Y=>Number(Y.boostBips)===t),u=d.filter(Y=>{var Me;const ne=(Me=Y.tokenId)==null?void 0:Me.toString(),Ne=s.find(X=>{var oa;return((oa=X.tokenId)==null?void 0:oa.toString())===ne}),ht=o.has(ne),tt=Ne&&Ne.rentalEndTime&&Number(Ne.rentalEndTime)>l;return!ht&&!tt}),f=be.find(Y=>Y.boostBips===t);if(!f){console.warn("Tier not found for boostBips:",t);return}const p=`pool_${f.name.toLowerCase()}`;let b=v[p]||an.get(t);if(!b){const Y=v.nftPoolFactory||v.nftLiquidityPoolFactory;if(Y&&c.publicProvider)try{b=await new Ae.Contract(Y,pf,c.publicProvider).getPoolAddress(t),b&&b!==Ae.ZeroAddress&&an.set(t,b)}catch(ne){console.warn("Factory lookup failed:",ne.message)}}if(Tt!==a)return;if(!b||b===Ae.ZeroAddress){const Y=document.getElementById("swap-interface");Y&&(Y.innerHTML=`
                ...
                `);return}const g=new Ae.Contract(b,Os,c.publicProvider),[w,T,C]=await Promise.all([te(g,"getBuyPrice",[],Ae.MaxUint256).catch(()=>Ae.MaxUint256),te(g,"getSellPrice",[],0n).catch(()=>0n),g.getAvailableNFTs().catch(()=>[])]);if(Tt!==a)return;const P=Array.isArray(C)?[...C]:[],S=w===Ae.MaxUint256?0n:w,$=T;let B=((n=c.systemFees)==null?void 0:n.NFT_POOL_SELL_TAX_BIPS)||1000n,I=BigInt(((i=c.boosterDiscounts)==null?void 0:i[N.bestBoosterBips])||0);const _=typeof B=="bigint"?B:BigInt(B),W=typeof I=="bigint"?I:BigInt(I),ae=_>W?_-W:0n,ue=$*ae/10000n,q=$-ue,pe={buyPrice:S,sellPrice:$,netSellPrice:q,poolNFTCount:P.length,firstAvailableTokenIdForBuy:P.length>0?BigInt(P[P.length-1]):null,userBalanceOfSelectedNFT:d.length,availableToSellCount:u.length,availableNFTsOfTier:u};Ec(t,pe),fi(pe,t)}catch(r){if(console.warn("Store Data Warning:",r.message),Tt===a){const s=document.getElementById("swap-interface");s&&(s.innerHTML=`
                    <div class="text-center py-12">
                        <div class="w-12 h-12 bg-zinc-800 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                `)}return}finally{Tt===a&&(N.isDataLoading=!1,nn(),ds())}}async function yf(e,t){var a,n;try{const i=c.myBoosters||[],r=c.rentalListings||[],s=new Set(r.map(pe=>{var Y;return(Y=pe.tokenId)==null?void 0:Y.toString()})),o=Math.floor(Date.now()/1e3),l=i.filter(pe=>Number(pe.boostBips)===e),d=l.filter(pe=>{var tt;const Y=(tt=pe.tokenId)==null?void 0:tt.toString(),ne=r.find(Me=>{var X;return((X=Me.tokenId)==null?void 0:X.toString())===Y}),Ne=s.has(Y),ht=ne&&ne.rentalEndTime&&Number(ne.rentalEndTime)>o;return!Ne&&!ht}),u=be.find(pe=>pe.boostBips===e);if(!u)return;const f=`pool_${u.name.toLowerCase()}`;let p=v[f]||an.get(e);if(!p||p===Ae.ZeroAddress)return;const b=new Ae.Contract(p,Os,c.publicProvider),[g,w,T]=await Promise.all([te(b,"getBuyPrice",[],Ae.MaxUint256).catch(()=>Ae.MaxUint256),te(b,"getSellPrice",[],0n).catch(()=>0n),b.getAvailableNFTs().catch(()=>[])]);if(Tt!==t)return;const C=Array.isArray(T)?[...T]:[],P=g===Ae.MaxUint256?0n:g,S=w;let $=((a=c.systemFees)==null?void 0:a.NFT_POOL_SELL_TAX_BIPS)||1000n,B=BigInt(((n=c.boosterDiscounts)==null?void 0:n[N.bestBoosterBips])||0);const I=typeof $=="bigint"?$:BigInt($),_=typeof B=="bigint"?B:BigInt(B),W=I>_?I-_:0n,ae=S*W/10000n,ue=S-ae,q={buyPrice:P,sellPrice:S,netSellPrice:ue,poolNFTCount:C.length,firstAvailableTokenIdForBuy:C.length>0?BigInt(C[C.length-1]):null,userBalanceOfSelectedNFT:l.length,availableToSellCount:d.length,availableNFTsOfTier:d};Ec(e,q),N.selectedPoolBoostBips===e&&Tt===t&&(fi(q,e),nn())}catch(i){console.warn("Background refresh failed:",i.message)}}function fi(e,t){var i,r,s;N.buyPrice=e.buyPrice,N.sellPrice=e.sellPrice,N.netSellPrice=e.netSellPrice,N.poolNFTCount=e.poolNFTCount,N.firstAvailableTokenIdForBuy=e.firstAvailableTokenIdForBuy,N.userBalanceOfSelectedNFT=e.userBalanceOfSelectedNFT,N.availableToSellCount=e.availableToSellCount;const a=N.firstAvailableTokenId;!(a&&((i=e.availableNFTsOfTier)==null?void 0:i.some(o=>BigInt(o.tokenId)===a)))&&((r=e.availableNFTsOfTier)==null?void 0:r.length)>0?N.firstAvailableTokenId=BigInt(e.availableNFTsOfTier[0].tokenId):(s=e.availableNFTsOfTier)!=null&&s.length||(N.firstAvailableTokenId=null)}function kf(){const e=document.getElementById("store");e&&e.addEventListener("click",async t=>{if(t.target.closest("#refresh-btn")){const s=t.target.closest("#refresh-btn").querySelector("i");s.classList.add("fa-spin"),jn(N.selectedPoolBoostBips),await Promise.all([Ct(!0),Ks()]),await rt(!0),pa(),s.classList.remove("fa-spin");return}const a=t.target.closest(".tier-chip");if(a){const r=Number(a.dataset.boost);N.selectedPoolBoostBips!==r&&(N.selectedPoolBoostBips=r,N.firstAvailableTokenId=null,cs(r),await rt());return}if(t.target.closest("#swap-direction-btn")){N.tradeDirection=N.tradeDirection==="buy"?"sell":"buy",nn();return}if(t.target.closest("#inventory-toggle")){const r=document.getElementById("inventory-panel"),s=document.getElementById("inventory-chevron");r&&s&&(r.classList.toggle("hidden"),s.style.transform=r.classList.contains("hidden")?"":"rotate(180deg)");return}if(t.target.closest("#history-toggle")){const r=document.getElementById("history-panel"),s=document.getElementById("history-chevron");r&&s&&(r.classList.toggle("hidden"),s.style.transform=r.classList.contains("hidden")?"":"rotate(180deg)");return}const n=t.target.closest(".inventory-item");if(n){if(n.dataset.unavailable==="true"){x("This NFT is listed for rental and cannot be sold","warning");return}const s=Number(n.dataset.boost),o=n.dataset.tokenid;N.selectedPoolBoostBips=s,N.tradeDirection="sell",o&&(N.firstAvailableTokenId=BigInt(o),console.log("User selected NFT #"+o+" for sale")),cs(s),await rt();return}const i=t.target.closest("#execute-btn");if(i){if(t.preventDefault(),t.stopPropagation(),Ka||i.disabled)return;const r=i.dataset.action,s=document.getElementById("trade-mascot");if(r==="connect"){window.openConnectModal();return}const o=be.find(u=>u.boostBips===N.selectedPoolBoostBips);if(!o)return;const l=`pool_${o.name.toLowerCase()}`,d=v[l]||an.get(o.boostBips);if(!d){x("Pool address not found","error");return}Ka=!0,s&&(s.className="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden trade-spin");try{if(N.tradeDirection==="buy")await ii.buyFromPool({poolAddress:d,button:i,onSuccess:async u=>{s&&(s.className="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden trade-success"),x("🟢 NFT Purchased!","success"),jn(N.selectedPoolBoostBips),await Promise.all([Ct(!0),rt(!0)]),pa()},onError:u=>{if(!u.cancelled&&u.type!=="user_rejected"){const f=u.message||u.reason||"Transaction failed";x("Buy failed: "+f,"error")}}});else{if(!N.firstAvailableTokenId){x("No NFT selected for sale","error"),Ka=!1;return}await ii.sellToPool({poolAddress:d,tokenId:N.firstAvailableTokenId,button:i,onSuccess:async u=>{s&&(s.className="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden trade-success"),x("🔴 NFT Sold!","success"),jn(N.selectedPoolBoostBips),await Promise.all([Ct(!0),rt(!0)]),pa()},onError:u=>{if(!u.cancelled&&u.type!=="user_rejected"){const f=u.message||u.reason||"Transaction failed";x("Sell failed: "+f,"error")}}})}}finally{Ka=!1,setTimeout(async()=>{try{await Promise.all([Ct(!0),rt(!0)]),pa()}catch(u){console.warn("[Store] Post-transaction refresh failed:",u.message)}},2e3),s&&setTimeout(()=>{const u=N.tradeDirection==="buy";s.className=`w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden ${u?"trade-buy":"trade-sell"}`},800)}}})}const fr="https://sepolia.arbiscan.io/tx/",mi="https://sepolia.arbiscan.io/address/",Tc="0x16346f5a45f9615f1c894414989f0891c54ef07b",Ef=(v==null?void 0:v.fortunePool)||"0x277dB00d533Bbc0fc267bbD954640aDA38ee6B37",rn="./assets/fortune.png",bi=1e3,us={pt:{title:"Compartilhe & Ganhe!",subtitle:"+1000 pontos para o Airdrop",later:"Talvez depois"},en:{title:"Share & Earn!",subtitle:"+1000 points for Airdrop",later:"Maybe later"},es:{title:"¡Comparte y Gana!",subtitle:"+1000 puntos para el Airdrop",later:"Quizás después"}},Tf={pt:{win:e=>`🎉 Ganhei ${e.toLocaleString()} BKC no Fortune Pool!
...
#Backcoin #Web3 #Arbitrum`}},Wn={pt:"./assets/pt.png",en:"./assets/en.png",es:"./assets/es.png"};let Ge="en";const fe=[{id:1,name:"Easy",emoji:"🍀",range:3,multiplier:2,chance:"33%",color:"emerald",hex:"#10b981",bgFrom:"from-emerald-500/20",bgTo:"to-green-600/10",borderColor:"border-emerald-500/50",textColor:"text-emerald-400"},{id:2,name:"Medium",emoji:"⚡",range:10,multiplier:5,chance:"10%",color:"violet",hex:"#8b5cf6",bgFrom:"from-violet-500/20",bgTo:"to-purple-600/10",borderColor:"border-violet-500/50",textColor:"text-violet-400"},{id:3,name:"Hard",emoji:"👑",range:100,multiplier:50,chance:"1%",color:"amber",hex:"#f59e0b",bgFrom:"from-amber-500/20",bgTo:"to-orange-600/10",borderColor:"border-amber-500/50",textColor:"text-amber-400"}],Cc=57,y={mode:null,phase:"select",guess:50,guesses:[2,5,50],comboStep:0,wager:10,gameId:null,result:null,txHash:null,poolStatus:null,history:[],serviceFee:0n,serviceFee1x:0n,serviceFee5x:0n,tiersData:null,commitment:{hash:null,userSecret:null,commitBlock:null,commitTxHash:null,revealDelay:2,waitStartTime:null,canReveal:!1}};let Se=null;const Cf=3e3,Ic=250;function If(){if(document.getElementById("fortune-styles-v2"))return;const e=document.createElement("style");e.id="fortune-styles-v2",e.textContent=`
    ...
    `;const n=document.getElementById("number-input"),i=document.getElementById("number-slider"),r=fe[2],s=g=>{g=Math.max(1,Math.min(100,g)),y.guess=g,n&&(n.value=g),i&&(i.value=g,i.style.background=`linear-gradient(to right, ${r.hex} 0%, ${r.hex} ${g}%, #27272a ${g}%, #27272a 100%)`)};n==null||n.addEventListener("input",g=>s(parseInt(g.target.value)||1)),n==null||n.addEventListener("blur",g=>s(parseInt(g.target.value)||1)),i==null||i.addEventListener("input",g=>s(parseInt(g.target.value))),(o=document.getElementById("btn-minus"))==null||o.addEventListener("click",()=>s(y.guess-1)),(l=document.getElementById("btn-plus"))==null||l.addEventListener("click",()=>s(y.guess+1)),(d=document.getElementById("btn-minus-10"))==null||d.addEventListener("click",()=>s(y.guess-10)),(u=document.getElementById("btn-plus-10"))==null||u.addEventListener("click",()=>s(y.guess+10)),document.querySelectorAll(".quick-pick").forEach(g=>{g.addEventListener("click",()=>s(parseInt(g.dataset.number)))}),(f=document.getElementById("btn-random"))==null||f.addEventListener("click",()=>{s(Math.floor(Math.random()*100)+1)}),(p=document.getElementById("btn-back"))==null||p.addEventListener("click",()=>{y.phase="select",ce()}),(b=document.getElementById("btn-next"))==null||b.addEventListener("click",()=>{y.phase="wager",ce()})}function Sf(e){var r,s,o,l,d,u,f;const t=fe[y.comboStep],a=y.guesses[y.comboStep],n=t.range===100;if(e.innerHTML=`
        <div class="bg-gradient-to-br from-zinc-900 to-zinc-800/50 border border-zinc-700/50 rounded-2xl p-5">
            <!-- Progress Pills -->
            <div class="flex justify-center gap-2 sm:gap-3 mb-5">
                ${fe.map((p,b)=>{const g=b===y.comboStep,w=b<y.comboStep;return`
                        <div class="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 rounded-xl border ${g?`bg-gradient-to-br ${p.bgFrom} ${p.bgTo} ${p.borderColor}`:w?"bg-emerald-500/10 border-emerald-500/50":"bg-zinc-800/50 border-zinc-700/50"}">
                            <span class="text-lg sm:text-xl">${w?"✓":p.emoji}</span>
                            <div class="text-left">
                                <p class="text-[10px] sm:text-xs font-bold ${g?p.textColor:w?"text-emerald-400":"text-zinc-500"}">${p.name}</p>
    ...
    `,t.range===100){const p=document.getElementById("combo-number-input"),b=document.getElementById("combo-slider"),g=w=>{w=Math.max(1,Math.min(100,w)),y.guesses[y.comboStep]=w,p&&(p.value=w),b&&(b.value=w,b.style.background=`linear-gradient(to right, ${t.hex} 0%, ${t.hex} ${w}%, #27272a ${w}%, #27272a 100%)`)};p==null||p.addEventListener("input",w=>g(parseInt(w.target.value)||1)),p==null||p.addEventListener("blur",w=>g(parseInt(w.target.value)||1)),b==null||b.addEventListener("input",w=>g(parseInt(w.target.value))),(r=document.querySelector(".combo-minus"))==null||r.addEventListener("click",()=>g(y.guesses[y.comboStep]-1)),(s=document.querySelector(".combo-plus"))==null||s.addEventListener("click",()=>g(y.guesses[y.comboStep]+1)),(o=document.querySelector(".combo-minus-10"))==null||o.addEventListener("click",()=>g(y.guesses[y.comboStep]-10)),(l=document.querySelector(".combo-plus-10"))==null||l.addEventListener("click",()=>g(y.guesses[y.comboStep]+10)),document.querySelectorAll(".combo-quick").forEach(w=>{w.addEventListener("click",()=>g(parseInt(w.dataset.num)))}),(d=document.querySelector(".combo-random"))==null||d.addEventListener("click",()=>{g(Math.floor(Math.random()*100)+1)})}else document.querySelectorAll(".num-btn").forEach(p=>{p.addEventListener("click",()=>{const b=parseInt(p.dataset.num);y.guesses[y.comboStep]=b,document.querySelectorAll(".num-btn").forEach(g=>{parseInt(g.dataset.num)===b?g.className=`num-btn w-12 h-12 rounded-xl font-bold text-lg transition-all bg-gradient-to-br ${t.bgFrom} ${t.bgTo} border-2 ${t.borderColor} ${t.textColor}`:g.className="num-btn w-12 h-12 rounded-xl font-bold text-lg transition-all bg-zinc-800/60 border border-zinc-700/50 text-zinc-400 hover:border-zinc-600"})})});(u=document.getElementById("btn-back"))==null||u.addEventListener("click",()=>{y.comboStep>0?(y.comboStep--,ce()):(y.phase="select",ce())}),(f=document.getElementById("btn-next"))==null||f.addEventListener("click",()=>{y.comboStep<2?(y.comboStep++,ce()):(y.phase="wager",ce())})}function $f(e){const t=y.mode==="jackpot",a=t?[y.guess]:y.guesses,n=t?50:Cc,i=F(c.currentUserBalance||0n),r=i>=1,s=t?y.serviceFee1x:y.serviceFee5x,o=s>0n?Number(s)/1e18:0,l=s>0n;e.innerHTML=`
        <div class="bg-gradient-to-br from-zinc-900 to-zinc-800/50 border border-zinc-700/50 rounded-2xl p-5">
    ...
    `,Lf(n,i)}function Lf(e,t){var n,i,r,s,o,l,d,u;const a=f=>{y.wager=Math.max(1,Math.min(Math.floor(f),Math.floor(t)));const p=document.getElementById("custom-wager"),b=document.getElementById("potential-win");p&&(p.value=y.wager),b&&(b.textContent=(y.wager*e).toLocaleString()),document.querySelectorAll(".percent-btn").forEach(g=>{const w=parseInt(g.dataset.value);y.wager===w?g.className="percent-btn py-2.5 text-sm font-bold rounded-xl transition-all bg-gradient-to-r from-amber-500/30 to-orange-500/20 border-2 border-amber-500/60 text-amber-400 shadow-lg shadow-amber-500/20":g.className="percent-btn py-2.5 text-sm font-bold rounded-xl transition-all bg-zinc-800/60 border border-zinc-700/50 text-zinc-400 hover:border-amber-500/30 hover:text-amber-300"})};document.querySelectorAll(".percent-btn").forEach(f=>{f.addEventListener("click",()=>{a(parseInt(f.dataset.value)||1)})}),(n=document.getElementById("custom-wager"))==null||n.addEventListener("input",f=>{a(parseInt(f.target.value)||1)}),(i=document.getElementById("wager-minus"))==null||i.addEventListener("click",()=>{a(y.wager-1)}),(r=document.getElementById("wager-plus"))==null||r.addEventListener("click",()=>{a(y.wager+1)}),(s=document.getElementById("wager-minus-10"))==null||s.addEventListener("click",()=>{a(y.wager-10)}),(o=document.getElementById("wager-plus-10"))==null||o.addEventListener("click",()=>{a(y.wager+10)}),(l=document.getElementById("btn-faucet"))==null||l.addEventListener("click",async()=>{x("Requesting tokens...","info");try{const p=await(await fetch(`https://faucet-4wvdcuoouq-uc.a.run.app?address=${c.userAddress}`)).json();p.success?(x("🎉 Tokens received!","success"),await bn(),ce()):x(p.error||"Error","error")}catch{x("Faucet error","error")}}),(d=document.getElementById("btn-back"))==null||d.addEventListener("click",()=>{y.phase="pick",y.mode==="combo"&&(y.comboStep=2),ce()}),(u=document.getElementById("btn-play"))==null||u.addEventListener("click",async()=>{if(y.wager<1)return x("Min: 1 BKC","warning");y.phase="processing",ce();try{const f=y.mode==="jackpot"?[y.guess]:y.guesses,p=y.mode==="combo",b=window.ethers.parseEther(y.wager.toString());await Qi.playGame({wagerAmount:b,guesses:f,isCumulative:p,button:document.getElementById("btn-play"),onSuccess:g=>{y.gameId=(g==null?void 0:g.gameId)||Date.now(),y.commitment={hash:null,userSecret:(g==null?void 0:g.userSecret)||null,commitBlock:(g==null?void 0:g.commitBlock)||null,commitTxHash:(g==null?void 0:g.txHash)||null,revealDelay:y.commitment.revealDelay||2,waitStartTime:Date.now(),canReveal:!1},y.txHash=(g==null?void 0:g.txHash)||null,console.log("🔐 Game committed:",y.gameId,"Block:",y.commitment.commitBlock),y.phase="waiting",ce(),Ff()},onError:g=>{g.cancelled||x(g.message||"Commit failed","error"),y.phase="wager",ce()}})}catch(f){console.error("Commit error:",f);const p=f.message||f.reason||"Transaction failed";x("Error: "+p,"error"),y.phase="wager",ce()}})}function Rf(e){const t=y.mode==="jackpot",a=t?[y.guess]:y.guesses,n=t?[fe[2]]:fe;e.innerHTML=`
    ...
    `,(l=document.getElementById("btn-reveal"))==null||l.addEventListener("click",()=>{y.commitment.canReveal&&gi()}),mr()}function mr(){if(y.phase!=="waiting")return;const e=document.getElementById("countdown-timer"),t=document.getElementById("progress-bar");if(document.getElementById("btn-reveal"),document.getElementById("reveal-btn-text"),!e)return;const a=Date.now()-(y.commitment.waitStartTime||Date.now()),n=y.commitment.revealDelay*Ic,i=Math.max(0,n-a),r=Math.ceil(i/1e3);if(r>0?e.textContent=`~${r}s`:y.commitment.canReveal?e.textContent="Ready!":e.textContent="Verifying on chain...",t){const s=Math.min(100,a/n*100);t.style.width=`${s}%`}y.phase==="waiting"&&setTimeout(mr,1e3)}function Ff(){Se&&clearInterval(Se),setTimeout(mr,100),Se=setInterval(async()=>{if(y.phase!=="waiting"){clearInterval(Se);return}try{await Of()&&!y.commitment.canReveal&&(y.commitment.canReveal=!0,clearInterval(Se),Se=null,console.log("[FortunePool] canReveal=true, starting auto-reveal..."),Mf())}catch(e){console.warn("Reveal check error:",e)}},Cf)}async function Mf(){if(y.phase!=="waiting")return;const e=document.getElementById("countdown-timer"),t=document.getElementById("btn-reveal"),a=document.getElementById("reveal-btn-text");e&&(e.textContent="Revealing..."),t&&(t.disabled=!0,t.classList.remove("bg-zinc-800","text-zinc-500","cursor-not-allowed"),t.classList.add("bg-gradient-to-r","from-amber-500","to-yellow-500","text-white")),a&&(a.textContent="Auto-revealing...");const n=y.mode==="jackpot"?[y.guess]:y.guesses,i=5,r=2e3;await new Promise(s=>setTimeout(s,3e3));for(let s=1;s<=i;s++){if(y.phase!=="waiting")return;try{const o=c.fortunePoolContractPublic;o&&await o.revealPlay.staticCall(y.gameId,n,y.commitment.userSecret,{from:c.userAddress}),console.log(`[FortunePool] Pre-simulation passed (attempt ${s})`),gi();return}catch(o){const l=o.message||"",d=l.includes("0x92555c0e")||l.includes("BlockhashUnavailable");if(d&&s<i)console.log(`[FortunePool] BlockhashUnavailable, retry in ${r}ms (${s}/${i})`),e&&(e.textContent="Syncing block data..."),await new Promise(u=>setTimeout(u,r));else if(d){console.warn("[FortunePool] Pre-sim retries exhausted, enabling manual button"),Df();return}else{console.log("[FortunePool] Pre-sim error (non-blockhash), trying direct reveal:",l),gi();return}}}}function Df(){const e=document.getElementById("btn-reveal"),t=document.getElementById("reveal-btn-text"),a=document.getElementById("countdown-timer");a&&(a.textContent="Ready!"),e&&(e.disabled=!1,e.classList.remove("bg-zinc-800","text-zinc-500","cursor-not-allowed","from-amber-500","to-yellow-500"),e.classList.add("bg-gradient-to-r","from-emerald-500","to-green-500","text-white")),t&&(t.textContent="Reveal & Get Result!")}async function Of(){if(!c.fortunePoolContractPublic||!y.gameId)return!1;try{const e=await c.fortunePoolContractPublic.getCommitmentStatus(y.gameId);if(!y.commitment.commitBlock)try{const t=await c.fortunePoolContractPublic.getCommitment(y.gameId),a=Number(t.commitBlock);a>0&&(y.commitment.commitBlock=a)}catch{}return e.canReveal===!0}catch{return Date.now()-(y.commitment.waitStartTime||Date.now())>=3e4}}async function gi(){if(!y.commitment.canReveal){x("Not ready to reveal yet!","warning");return}const e=document.getElementById("btn-reveal");try{const t=y.mode==="jackpot"?[y.guess]:y.guesses;await Qi.revealPlay({gameId:y.gameId,guesses:t,userSecret:y.commitment.userSecret,button:e,onSuccess:(a,n)=>{Se&&clearInterval(Se),y.txHash=a.hash,y.result={rolls:(n==null?void 0:n.rolls)||[],prizeWon:(n==null?void 0:n.prizeWon)||0n,matches:(n==null?void 0:n.matches)||[],matchCount:(n==null?void 0:n.matchCount)||0},console.log("🎲 Game revealed:",y.result),y.phase="result",ce(),br()},onError:a=>{if(!a.cancelled){const n=a.message||"";n.includes("0x92555c0e")||n.includes("BlockhashUnavailable")?x("Block data not available yet. RPC will retry automatically.","warning"):x(n||"Reveal failed","error")}e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-dice mr-2"></i>Try Again')}})}catch(t){console.error("Reveal error:",t),x("Reveal failed: "+(t.message||"Unknown error"),"error"),e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-dice mr-2"></i>Try Again')}}function Hf(e){var f,p;const t=y.result;if(!t)return ce();const a=y.mode==="jackpot",n=a?[y.guess]:y.guesses,i=t.rolls||[],r=a?[fe[2]]:fe,s=n.map((b,g)=>{const w=i[g]!==void 0?Number(i[g]):null;return w!==null&&w===b}),o=s.filter(b=>b).length,l=t.prizeWon>0||o>0;let d=0;t.prizeWon&&t.prizeWon>0n?d=F(BigInt(t.prizeWon)):o>0&&s.forEach((b,g)=>{if(b){const w=a?fe[2]:fe[g];d+=y.wager*w.multiplier}});const u=typeof d=="number"?d.toLocaleString(void 0,{maximumFractionDigits:2}):d.toLocaleString();e.innerHTML=`
        <div class="bg-gradient-to-br ${l?"from-emerald-900/30 to-green-900/10 border-emerald-500/30":"from-zinc-900 to-zinc-800/50 border-zinc-700/50"} border rounded-2xl p-4 sm:p-6 relative overflow-hidden" id="result-container">
            ...
            <div class="grid ${a?"grid-cols-1 max-w-[200px] mx-auto":"grid-cols-3"} gap-2 sm:gap-3 mb-4">
                ${r.map((b,g)=>{const w=a?n[0]:n[g],T=i[g],C=s[g];return`
            ...
            <div class="bg-gradient-to-r ${l?"from-amber-500/10 to-orange-500/10 border-amber-500/30":"from-zinc-800/50 to-zinc-700/30 border-zinc-600/30"} border rounded-xl p-3 mb-3">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <div>
                        ...
                        <p class="text-amber-400 text-xs font-medium">+${bi} Airdrop Points</p>
                    </div>
                </div>
    ...
    `,l&&(Uf(),d>y.wager*10&&jf()),(f=document.getElementById("btn-new-game"))==null||f.addEventListener("click",()=>{y.phase="select",y.result=null,y.txHash=null,y.gameId=null,ce(),br()}),(p=document.getElementById("btn-share"))==null||p.addEventListener("click",()=>{Wf(l,d)})}function Uf(){const e=document.createElement("div");e.className="confetti-container",document.body.appendChild(e);const t=["#f59e0b","#10b981","#8b5cf6","#ec4899","#06b6d4"],a=["●","■","★","🐯","🎉"];for(let n=0;n<60;n++){const i=document.createElement("div");i.className="confetti",i.style.cssText=`
            left: ${Math.random()*100}%;
            color: ${t[n%t.length]};
            font-size: ${8+Math.random()*12}px;
            animation-delay: ${Math.random()*2}s;
            animation-duration: ${2+Math.random()*2}s;
        `,i.textContent=a[n%a.length],e.appendChild(i)}setTimeout(()=>e.remove(),5e3)}function jf(){const e=["🪙","💰","✨","⭐","🎉"];for(let t=0;t<30;t++)setTimeout(()=>{const a=document.createElement("div");a.className="coin",a.textContent=e[Math.floor(Math.random()*e.length)],a.style.left=`${Math.random()*100}%`,a.style.animationDelay=`${Math.random()*.5}s`,a.style.animationDuration=`${2+Math.random()*2}s`,document.body.appendChild(a),setTimeout(()=>a.remove(),4e3)},t*100)}function Wf(e,t){var l,d,u,f,p,b;const a=us[Ge],n=()=>{const g=Tf[Ge];return e?g.win(t):g.lose},i=`
        <div class="text-center">
            <img src="${rn}" class="w-16 h-16 mx-auto mb-2" alt="Fortune Pool" onerror="this.style.display='none'">
    ...
    `;ha(i,"max-w-xs");const r=g=>{Ge=g;const w=us[g],T=document.getElementById("share-modal-title"),C=document.getElementById("share-modal-subtitle"),P=document.getElementById("btn-close-share");T&&(T.textContent=w.title),C&&(C.textContent=w.subtitle),P&&(P.textContent=w.later),document.querySelectorAll(".lang-btn").forEach(S=>{const $=S.dataset.lang,B=S.querySelector("span");$===g?(S.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-amber-500/20 border-amber-500 ring-1 ring-amber-500/50 border",B&&(B.className="text-amber-400")):(S.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-zinc-800 border-zinc-700 hover:border-zinc-500 border",B&&(B.className="text-zinc-400"))})};document.querySelectorAll(".lang-btn").forEach(g=>{g.addEventListener("click",()=>r(g.dataset.lang))});const s=async g=>{if(!c.userAddress)return!1;try{const T=await(await fetch("https://us-central1-backchain-backand.cloudfunctions.net/trackShare",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({address:c.userAddress,gameId:y.gameId||Date.now(),type:"fortune",platform:g})})).json();return T.success?(x(`🎉 +${T.pointsAwarded||bi} Airdrop Points!`,"success"),!0):(T.reason==="already_shared"&&console.log("Already shared this game"),!1)}catch(w){return console.error("Share tracking error:",w),x(`🎉 +${bi} Airdrop Points!`,"success"),!0}},o=async(g,w)=>{await s(g),window.open(w,"_blank"),Ee()};(l=document.getElementById("share-twitter"))==null||l.addEventListener("click",()=>{const g=n();o("twitter",`https://twitter.com/intent/tweet?text=${encodeURIComponent(g)}`)}),(d=document.getElementById("share-telegram"))==null||d.addEventListener("click",()=>{const g=n();o("telegram",`https://t.me/share/url?url=https://backcoin.org&text=${encodeURIComponent(g)}`)}),(u=document.getElementById("share-whatsapp"))==null||u.addEventListener("click",()=>{const g=n();o("whatsapp",`https://wa.me/?text=${encodeURIComponent(g)}`)}),(f=document.getElementById("share-instagram"))==null||f.addEventListener("click",async()=>{const g=n();try{await navigator.clipboard.writeText(g),await s("instagram");const w=`
    ...
    `}function Yn(){return z.isConnected?`
        <div class="px-4 airdrop-fade-up">
            ...
            <div id="earn-content">
                ...
                ${z.activeEarnTab==="platform"?bm():""}
                ${z.activeEarnTab==="tasks"?gm():""}
            </div>
        </div>
    `:`
    ...
    `}function bm(){var s;const e=z.platformUsageConfig||Pc,t=z.platformUsage||{};let a=0,n=0;Object.keys(e).forEach(o=>{var l;e[o].enabled!==!1&&e[o].maxCount&&(a+=e[o].maxCount,n+=Math.min(((l=t[o])==null?void 0:l.count)||0,e[o].maxCount))});const i=a>0?n/a*100:0,r=((s=z.user)==null?void 0:s.platformUsagePoints)||0;return`
        <div class="space-y-4">
            <!-- Info Banner -->
            ...
            <div class="grid grid-cols-2 gap-2" id="platform-actions-grid">
                ${Object.entries(e).filter(([o,l])=>l.enabled!==!1).map(([o,l])=>{const d=t[o]||{count:0},u=d.count>=l.maxCount,f=Math.max(0,l.maxCount-d.count),p=d.count/l.maxCount*100,b=om[o]||"";return`
    ...
    `}function gm(){const e=z.dailyTasks||[],t=e.filter(n=>n.eligible),a=e.filter(n=>!n.eligible&&n.timeLeftMs>0);return`
        <div class="space-y-4">
            <!-- Info Banner -->
    ...
    `}function hm(){var u,f;const e=((u=z.leaderboards)==null?void 0:u.top100ByPosts)||[],t=((f=z.leaderboards)==null?void 0:f.top100ByPoints)||[],a=z.activeRanking||"posts";function n(p,b,g){var B,I;const w=z.user&&((B=p.walletAddress)==null?void 0:B.toLowerCase())===((I=z.user.walletAddress)==null?void 0:I.toLowerCase()),T=vm(b+1),C=g==="posts"?"bg-amber-500/10":"bg-green-500/10",P=g==="posts"?"text-amber-400":"text-green-400",S=g==="posts"?"text-white":"text-green-400",$=g==="posts"?"posts":"pts";return`
            <div class="flex items-center justify-between p-3 ${w?C:"hover:bg-zinc-800/50"} transition-colors">
                ...
                <span class="font-bold ${S} text-sm">${(p.value||0).toLocaleString()} <span class="text-zinc-500 text-xs">${$}</span></span>
            </div>
...
(This will reset their rejection count to 0)`;if(!window.confirm(i))return;const r=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await eo(a,n),x(`User ${n?"BANNED":"UNBANNED"}.`,"success");const s=A.allUsers.findIndex(o=>o.id===a);s>-1&&(A.allUsers[s].isBanned=n,A.allUsers[s].hasPendingAppeal=!1,n===!1&&(A.allUsers[s].rejectedCount=0)),mt()}catch(s){x(`Failed: ${s.message}`,"error"),t.disabled=!1,t.innerHTML=r}},Fm=async e=>{const t=e.target.closest(".resolve-appeal-btn");if(!t||t.disabled)return;const a=t.dataset.userId,i=t.dataset.action==="approve";if(!a)return;const r=i?"Are you sure you want to APPROVE this appeal and UNBAN the user?":"Are you sure you want to DENY this appeal? The user will remain banned.";if(!window.confirm(r))return;const s=t.closest("td").querySelectorAll("button"),o=new Map;s.forEach(l=>{o.set(l,l.innerHTML),l.disabled=!0,l.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>'});try{i&&await eo(a,!1),x(`Appeal ${i?"APPROVED":"DENIED"}.`,"success");const l=A.allUsers.findIndex(d=>d.id===a);l>-1&&(A.allUsers[l].hasPendingAppeal=!1,i&&(A.allUsers[l].isBanned=!1,A.allUsers[l].rejectedCount=0)),mt()}catch(l){x(`Failed: ${l.message}`,"error"),s.forEach(d=>{d.disabled=!1,d.innerHTML=o.get(d)})}},Mm=async e=>{const t=e.target.closest(".re-approve-btn");if(!t||t.disabled)return;const a=t.dataset.submissionId,n=t.dataset.userId;if(!a||!n)return;const i=t.closest("tr");i&&(i.style.opacity="0.5"),t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await Qs(n,a,"approved"),x("Submission re-approved!","success"),A.selectedUserSubmissions=A.selectedUserSubmissions.filter(s=>s.submissionId!==a),i&&i.remove();const r=A.allUsers.findIndex(s=>s.id===n);if(r>-1){const s=A.allUsers[r];s.rejectedCount=Math.max(0,(s.rejectedCount||0)-1),mt()}if(A.selectedUserSubmissions.length===0){const s=document.querySelector("#admin-user-modal .p-6");s&&(s.innerHTML='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>')}}catch(r){x(`Failed to re-approve: ${r.message}`,"error"),i&&(i.style.opacity="1"),t.disabled=!1,t.innerHTML='<i class="fa-solid fa-check"></i> Re-Approve'}},Dm=async e=>{const t=e.target.closest(".view-rejected-btn");if(!t||t.disabled)return;const a=t.dataset.userId,n=t.dataset.wallet;if(a){A.selectedWallet=n,A.isSubmissionsModalOpen=!0,Vn(!0,[]);try{const i=await Eu(a,"rejected");A.selectedUserSubmissions=i,Vn(!1,i)}catch(i){x(`Error fetching user submissions: ${i.message}`,"error"),Vn(!1,[],!0)}}},Om=()=>{A.isSubmissionsModalOpen=!1,A.selectedUserSubmissions=[],A.selectedWallet=null;const e=document.getElementById("admin-user-modal");e&&e.remove(),document.body.style.overflow="auto"},Hm=e=>{const t=e.target.closest(".user-profile-link");if(!t)return;e.preventDefault();const a=t.dataset.userId;if(!a)return;const n=A.allUsers.find(i=>i.id===a);if(!n){x("Error: Could not find user data.","error");return}Ym(n)},Um=()=>{const e=document.getElementById("admin-user-profile-modal");e&&e.remove(),document.body.style.overflow="auto"},jm=async e=>{e.preventDefault();const t=e.target;let a,n;try{if(a=new Date(t.startDate.value+"T00:00:00Z"),n=new Date(t.endDate.value+"T23:59:59Z"),isNaN(a.getTime())||isNaN(n.getTime()))throw new Error("Invalid date format.");if(a>=n)throw new Error("Start Date must be before End Date.")}catch(l){x(l.message,"error");return}const i={title:t.title.value.trim(),url:t.url.value.trim(),description:t.description.value.trim(),points:parseInt(t.points.value,10),cooldownHours:parseInt(t.cooldown.value,10),startDate:a,endDate:n};if(!i.title||!i.description){x("Please fill in Title and Description.","error");return}if(i.points<=0||i.cooldownHours<=0){x("Points and Cooldown must be positive numbers.","error");return}if(i.url&&!i.url.startsWith("http")){x("URL must start with http:// or https://","error");return}A.editingTask&&A.editingTask.id&&(i.id=A.editingTask.id);const r=t.querySelector('button[type="submit"]'),s=r.innerHTML;r.disabled=!0;const o=document.createElement("span");o.classList.add("inline-block"),r.innerHTML="",r.appendChild(o);try{await vu(i),x(`Task ${i.id?"updated":"created"} successfully!`,"success"),t.reset(),A.editingTask=null,ma()}catch(l){x(`Failed to save task: ${l.message}`,"error"),console.error(l),r.disabled=!1,r.innerHTML=s}},Wm=async e=>{e.preventDefault();const t=e.target,a={YouTube:parseInt(t.youtubePoints.value,10),"YouTube Shorts":parseInt(t.youtubeShortsPoints.value,10),Instagram:parseInt(t.instagramPoints.value,10),"X/Twitter":parseInt(t.xTwitterPoints.value,10),Facebook:parseInt(t.facebookPoints.value,10),Telegram:parseInt(t.telegramPoints.value,10),TikTok:parseInt(t.tiktokPoints.value,10),Reddit:parseInt(t.redditPoints.value,10),LinkedIn:parseInt(t.linkedinPoints.value,10),Other:parseInt(t.otherPoints.value,10)};if(Object.values(a).some(s=>isNaN(s)||s<0)){x("All points must be positive numbers (or 0).","error");return}const n=t.querySelector('button[type="submit"]'),i=n.innerHTML;n.disabled=!0;const r=document.createElement("span");r.classList.add("inline-block"),n.innerHTML="",n.appendChild(r);try{await xu(a),x("UGC Base Points updated successfully!","success"),A.ugcBasePoints=a}catch(s){x(`Failed to update points: ${s.message}`,"error"),console.error(s)}finally{document.body.contains(n)&&(n.disabled=!1,n.innerHTML=i)}},Gm=e=>{const t=A.dailyTasks.find(a=>a.id===e);t&&(A.editingTask=t,Ta())},Km=async e=>{if(window.confirm("Are you sure you want to delete this task permanently?"))try{await wu(e),x("Task deleted.","success"),A.editingTask=null,ma()}catch(t){x(`Failed to delete task: ${t.message}`,"error"),console.error(t)}};function Vn(e,t,a=!1){var s,o;const n=document.getElementById("admin-user-modal");n&&n.remove(),document.body.style.overflow="hidden";let i="";e?i='<div class="p-8"></div>':a?i='<p class="text-red-400 text-center p-8">Failed to load submissions.</p>':t.length===0?i='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>':i=`
     ...
     `;document.body.insertAdjacentHTML("beforeend",n),(i=document.getElementById("close-admin-profile-modal-btn"))==null||i.addEventListener("click",Um)}const Vm=e=>{const t=e.target.closest(".user-filter-btn");!t||t.classList.contains("active")||(A.usersFilter=t.dataset.filter||"all",A.usersPage=1,mt())},qm=e=>{A.usersSearch=e.target.value,A.usersPage=1,mt()},Xm=e=>{A.usersPage=e,mt()},Jm=e=>{A.submissionsPage=e,on()},Zm=e=>{A.tasksPage=e,Ta()},mt=()=>{var $,B;const e=document.getElementById("manage-users-content");if(!e)return;const t=A.allUsers;if(!t)return;const n=(A.usersSearch||"").toLowerCase().trim().replace(/[^a-z0-9x]/g,""),i=A.usersFilter;let r=t;n&&(r=r.filter(I=>{var _,W;return((_=I.walletAddress)==null?void 0:_.toLowerCase().includes(n))||((W=I.id)==null?void 0:W.toLowerCase().includes(n))})),i==="banned"?r=r.filter(I=>I.isBanned):i==="appealing"&&(r=r.filter(I=>I.hasPendingAppeal===!0));const s=t.length,o=t.filter(I=>I.isBanned).length,l=t.filter(I=>I.hasPendingAppeal===!0).length,d=r.sort((I,_)=>I.hasPendingAppeal!==_.hasPendingAppeal?I.hasPendingAppeal?-1:1:I.isBanned!==_.isBanned?I.isBanned?-1:1:(_.totalPoints||0)-(I.totalPoints||0)),u=A.usersPage,f=A.usersPerPage,p=d.length,b=Math.ceil(p/f),g=(u-1)*f,w=u*f,T=d.slice(g,w),C=T.length>0?T.map(I=>{let _="border-b border-border-color hover:bg-zinc-800/50",W="";return I.hasPendingAppeal?(_+=" bg-yellow-900/40",W='<span class="ml-2 text-xs font-bold text-yellow-300">[APPEALING]</span>'):I.isBanned&&(_+=" bg-red-900/30 opacity-70",W='<span class="ml-2 text-xs font-bold text-red-400">[BANNED]</span>'),`
        <tr class="${_}">
    ...
    `;const b=document.getElementById("admin-tasks-pagination");b&&l>1&&Li(b,A.tasksPage,l,Zm),(g=document.getElementById("taskForm"))==null||g.addEventListener("submit",jm),(w=document.getElementById("cancelEditBtn"))==null||w.addEventListener("click",()=>{A.editingTask=null,Ta()}),(T=document.getElementById("existing-tasks-list"))==null||T.addEventListener("click",C=>{const P=C.target.closest("button[data-id]");if(!P)return;const S=P.dataset.id;P.dataset.action==="edit"&&Gm(S),P.dataset.action==="delete"&&Km(S)})},on=()=>{var f;const e=document.getElementById("submissions-content");if(!e)return;if(!A.allSubmissions||A.allSubmissions.length===0){const p=document.createElement("div");e.innerHTML=p.innerHTML;return}const t=A.submissionsPage,a=A.submissionsPerPage,n=[...A.allSubmissions].sort((p,b)=>{var g,w;return(((g=b.submittedAt)==null?void 0:g.getTime())||0)-(((w=p.submittedAt)==null?void 0:w.getTime())||0)}),i=n.length,r=Math.ceil(i/a),s=(t-1)*a,o=t*a,d=n.slice(s,o).map(p=>{var b,g;return`
        <tr class="border-b border-border-color hover:bg-zinc-800/50">
            ...
            <td class="p-3 text-xs font-semibold ${((b=gs[p.status])==null?void 0:b.color)||"text-gray-500"}">${((g=gs[p.status])==null?void 0:g.text)||p.status}</td>
            <td class="p-3 text-right">
                <div class="flex items-center justify-end gap-2">
    ...
    `;const u=document.getElementById("admin-submissions-pagination");u&&r>1&&Li(u,A.submissionsPage,r,Jm),(f=document.getElementById("admin-submissions-tbody"))==null||f.addEventListener("click",Rm)},ln=()=>{var r,s;const e=document.getElementById("platform-usage-content");if(!e)return;const t=A.platformUsageConfig||In;let a=0;Object.values(t).forEach(o=>{o.enabled!==!1&&(a+=(o.points||0)*(o.maxCount||1))});const n=Object.entries(t).map(([o,l])=>`
    ...
    `,document.head.appendChild(e)},ba=e=>e>=1e6?(e/1e6).toFixed(1)+"M":e>=1e3?(e/1e3).toFixed(0)+"K":e.toLocaleString();function i0(){return`
        ...
        <div class="tk-section tk-fade-up" style="animation-delay: 0.1s">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div class="tk-card text-center">
                    ...
                    <p class="text-xl font-black text-white">${ba(qn)}</p>
            ...
            <p class="text-center text-zinc-600 text-[10px]">
                ...
                Remaining ${ba(qn-e)} BKC to be mined through ecosystem activity
            </p>
        </div>
    `}function s0(){return`
                ...
                <div class="space-y-3">
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-500 text-[10px]">${ba(vs.airdrop.amount)} BKC</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-500 text-[10px]">${ba(vs.liquidity.amount)} BKC</p>
                        </div>
                    </div>
                </div>
            </div>
...
`)[0].trim())||"Notarized Document";return`
    ...
    `,C0()}function C0(){const e=document.getElementById("nt-wiz-dropzone"),t=document.getElementById("nt-wiz-file-input");!e||!t||(e.onclick=()=>t.click(),["dragenter","dragover","dragleave","drop"].forEach(a=>{e.addEventListener(a,n=>{n.preventDefault(),n.stopPropagation()})}),e.addEventListener("dragenter",()=>e.classList.add("drag-over")),e.addEventListener("dragover",()=>e.classList.add("drag-over")),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",a=>{var n,i;e.classList.remove("drag-over"),ys((i=(n=a.dataTransfer)==null?void 0:n.files)==null?void 0:i[0])}),t.addEventListener("change",a=>{var n;return ys((n=a.target.files)==null?void 0:n[0])}))}async function ys(e){if(e){if(e.size>b0){x("File too large (max 5MB)","error");return}E.wizFile=e,E.wizFileHash=null,E.wizDuplicateCheck=null,E.wizIsHashing=!0,de();try{const t=await Xe.calculateFileHash(e);E.wizFileHash=t,E.wizIsHashing=!1,de(),E.wizDuplicateCheck=null,de();const a=await Xe.verifyByHash(t);E.wizDuplicateCheck=a,de()}catch(t){console.error("[NotaryPage] Hash error:",t),E.wizIsHashing=!1,E.wizFile=null,x("Error computing file hash","error"),de()}}}function Mc(e){const t=E.wizFile,a=$a((t==null?void 0:t.type)||"",(t==null?void 0:t.name)||""),n=E.feesLoaded?re?re.formatEther(E.bkcFee):"1":"...",i=E.feesLoaded?re?re.formatEther(E.ethFee):"0.0001":"...",r=c.currentUserBalance||0n,s=c.currentUserNativeBalance||0n,o=E.feesLoaded?r>=E.bkcFee:!0,l=E.feesLoaded?s>=E.ethFee+((re==null?void 0:re.parseEther("0.001"))||0n):!0,d=o&&l;e.innerHTML=`
    ...
    `}function I0(e){const t=E.wizFile,a=$a((t==null?void 0:t.type)||"",(t==null?void 0:t.name)||""),n=E.wizDescription||"No description",i=re?re.formatEther(E.bkcFee):"1",r=re?re.formatEther(E.ethFee):"0.0001";e.innerHTML=`
    ...
    `,document.head.appendChild(e)}function wi(){const e=document.getElementById("rental");if(!e)return;G0();const t=c.rentalListings||[],a=t.filter(r=>c.isConnected&&Ca(r.owner,c.userAddress)),n=Math.floor(Date.now()/1e3),i=(c.myRentals||[]).filter(r=>Ca(r.tenant,c.userAddress)&&Number(r.endTime)>n);e.innerHTML=`
        ...
        ${Z0()}
        ${Q0()}
    `,eb(),ga()}function K0(){return c.isConnected?`
    ...
    `}function jc(e,t){const a=La(e.boostBips),n=Pn(a.name),i=F(BigInt(e.pricePerHour||0)).toFixed(2),r=Re(e.tokenId),s=c.isConnected&&Ca(e.owner,c.userAddress),o=Uc(e),l=Math.floor(Date.now()/1e3),d=o&&o>l,u=d?W0(o):null,f=BigInt(e.promotionFee||"0")||R.promotions.get(r)||0n,p=f>0n,b=p?parseFloat(An.formatEther(f)).toFixed(3):"0",g=ft(e.boostBips||0);return`
                    ...
                    <div class="flex items-center gap-5">
                        ...
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white">
                                ${t.reduce((r,s)=>r+Number(An.formatEther(BigInt(s.totalEarnings||0))),0).toFixed(4)} <span class="text-lg text-zinc-500">BKC</span>
                            </p>
                        </div>
                    </div>
                    <div class="flex gap-3">
    ...
    `}function X0(e,t){const a=La(e.boostBips),n=Pn(a.name),i=Hc(Number(e.endTime)),r=ft(e.boostBips||0);let s="active";return i.seconds<3600?s="critical":i.seconds<7200&&(s="warning"),`
                ...
                <div class="p-5 space-y-5">
                    <div>
                        ...
                        <select id="list-select" class="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-4 py-3 text-white outline-none">
                            ...
                            ${(c.myBoosters||[]).filter(n=>!t.has(Re(n.tokenId))).map(n=>{const i=La(n.boostBips),r=Pn(i.name);return`<option value="${n.tokenId}">${r.emoji} ${i.name} Booster #${n.tokenId}</option>`}).join("")}
                        </select>
                    </div>
                    <div>
    ...
    `}function eb(){document.addEventListener("click",e=>{const t=e.target.closest(".rental-tab");if(t){R.activeTab=t.dataset.tab,document.querySelectorAll(".rental-tab").forEach(s=>s.classList.remove("active")),t.classList.add("active"),ga();return}const a=e.target.closest(".filter-chip");if(a){R.filterTier=a.dataset.filter,ga();return}if(e.target.closest("#btn-open-list")){Gc();return}const n=e.target.closest(".rent-btn");if(n&&!n.disabled){tb(n.dataset.id);return}const i=e.target.closest(".withdraw-btn");if(i){qc(i);return}const r=e.target.closest(".promote-btn");if(r){ab(r.dataset.id);return}}),document.addEventListener("change",e=>{e.target.id==="sort-select"&&(R.sortBy=e.target.value,ga())})}function Gc(){document.getElementById("modal-list").classList.add("active")}function Kc(){document.getElementById("modal-list").classList.remove("active")}function tb(e){const t=(c.rentalListings||[]).find(s=>j0(s.tokenId,e));if(!t)return;R.selectedListing=t;const a=La(t.boostBips),n=Pn(a.name),i=F(BigInt(t.pricePerHour||0)),r=ft(t.boostBips||0);document.getElementById("rent-modal-content").innerHTML=`
    ...
    `,document.getElementById("rent-hours").addEventListener("input",s=>{const o=parseInt(s.target.value)||1,l=Number(i)*o;document.querySelector("#rent-total span:last-child").textContent=`${l.toFixed(2)} BKC`}),document.getElementById("modal-rent").classList.add("active")}function Yc(){document.getElementById("modal-rent").classList.remove("active"),R.selectedListing=null}function ab(e){document.getElementById("promote-token-id").value=e,document.getElementById("promote-amount").value="",document.getElementById("modal-promote").classList.add("active")}function Vc(){document.getElementById("modal-promote").classList.remove("active")}async function nb(){if(R.isTransactionPending||!R.selectedListing)return;const e=parseInt(document.getElementById("rent-hours").value)||1,t=Re(R.selectedListing.tokenId),a=document.getElementById("confirm-rent");R.isTransactionPending=!0;try{await Sa.rent({tokenId:t,hours:e,button:a,onSuccess:async()=>{R.isTransactionPending=!1,Yc(),x("🎉 NFT Rented Successfully!","success"),await Xt()},onError:n=>{R.isTransactionPending=!1,!n.cancelled&&n.type!=="user_rejected"&&x("Failed: "+(n.message||"Error"),"error")}})}catch(n){R.isTransactionPending=!1,!n.cancelled&&n.type!=="user_rejected"&&x("Failed: "+(n.message||"Error"),"error")}}async function ib(){var n;if(R.isTransactionPending)return;const e=document.getElementById("list-select").value,t=document.getElementById("list-price").value;if(parseFloat((n=document.getElementById("list-promo-amount"))==null?void 0:n.value),!e){x("Select an NFT","error");return}if(!t||parseFloat(t)<=0){x("Enter valid price","error");return}const a=document.getElementById("confirm-list");R.isTransactionPending=!0;try{await Sa.list({tokenId:e,pricePerHour:An.parseUnits(t,18),minHours:1,maxHours:168,button:a,onSuccess:async()=>{R.isTransactionPending=!1,Kc(),x("🏷️ NFT Listed Successfully!","success"),await Xt()},onError:i=>{R.isTransactionPending=!1,!i.cancelled&&i.type!=="user_rejected"&&x("Failed: "+(i.message||"Error"),"error")}})}catch(i){R.isTransactionPending=!1,!i.cancelled&&i.type!=="user_rejected"&&x("Failed: "+(i.message||"Error"),"error")}}async function qc(e){if(R.isTransactionPending)return;const t=e.dataset.id;if(confirm("Withdraw this NFT from marketplace?")){R.isTransactionPending=!0;try{await Sa.withdraw({tokenId:t,button:e,onSuccess:async()=>{R.isTransactionPending=!1,x("↩️ NFT Withdrawn Successfully!","success"),await Xt()},onError:a=>{R.isTransactionPending=!1,!a.cancelled&&a.type!=="user_rejected"&&x("Failed: "+(a.message||"Error"),"error")}})}catch(a){R.isTransactionPending=!1,!a.cancelled&&a.type!=="user_rejected"&&x("Failed: "+(a.message||"Error"),"error")}}}async function rb(){if(R.isTransactionPending)return;const e=document.getElementById("promote-token-id").value,t=document.getElementById("promote-amount").value;if(!t||parseFloat(t)<=0){x("Enter valid amount","error");return}const a=document.getElementById("confirm-promote");R.isTransactionPending=!0;try{await Sa.spotlight({tokenId:e,amount:An.parseEther(t),button:a,onSuccess:async()=>{R.isTransactionPending=!1,Vc(),x("🚀 Listing Promoted!","success"),await Xt()},onError:n=>{R.isTransactionPending=!1,!n.cancelled&&n.type!=="user_rejected"&&x("Failed: "+(n.message||"Error"),"error")}})}catch(n){R.isTransactionPending=!1,!n.cancelled&&n.type!=="user_rejected"&&x("Failed: "+(n.message||"Error"),"error")}}function sb(){R.countdownIntervals.forEach(clearInterval),R.countdownIntervals=[],document.querySelectorAll(".rental-timer[data-end]").forEach(e=>{const t=Number(e.dataset.end),a=setInterval(()=>{const n=Hc(t);e.innerHTML=`<i class="fa-solid fa-clock mr-1"></i>${n.text}`,n.expired?(clearInterval(a),ga()):n.seconds<3600?e.className="rental-timer critical":n.seconds<7200&&(e.className="rental-timer warning")},1e3);R.countdownIntervals.push(a)})}async function Xt(){R.isLoading=!0;try{await Promise.all([Ks(),c.isConnected?ru():Promise.resolve(),c.isConnected?Ct():Promise.resolve()])}catch(e){console.warn("Refresh error:",e)}R.isLoading=!1,wi()}const Xc={async render(e){e&&(wi(),await Xt())},update(){wi()},refresh:Xt,openListModal:Gc,closeListModal:Kc,closeRentModal:Yc,closePromoteModal:Vc,handleRent:nb,handleList:ib,handleWithdraw:qc,handlePromote:rb};window.RentalPage=Xc;const ob={render:async e=>{const t=document.getElementById("socials");if(!t||!e&&t.innerHTML.trim()!=="")return;const a=`
            <style>
...
`;document.head.appendChild(Jc);const lb={render:async e=>{if(!e)return;const t=document.getElementById("creditcard");t&&(t.innerHTML=`
...
`;function Eb(){[1,2,3,4].forEach(t=>{const a=document.getElementById(`cp-step-${t}`);a&&(t<k.createStep?(a.className="cp-step-dot done",a.innerHTML='<i class="fa-solid fa-check text-sm"></i>'):t===k.createStep?(a.className="cp-step-dot active",a.textContent=t):(a.className="cp-step-dot pending",a.textContent=t))}),[1,2,3].forEach(t=>{const a=document.getElementById(`cp-ln-${t}`);a&&(a.className=`cp-step-line ln-${t} ${k.createStep>t?"done":k.createStep===t?"active":""}`)});const e=document.querySelector(".charity-page .text-sm.text-zinc-500");e&&(e.textContent=`Step ${k.createStep} of 4`)}function Fa(){const e=document.getElementById("cp-wiz-panel");if(e)switch(Eb(),k.createStep){case 1:Tb(e);break;case 2:Cb(e);break;case 3:Ib(e);break;case 4:Ab(e);break}}function Tb(e){e.innerHTML=`
    ...
    `}function Ab(e){const t=Pe[k.createCategory]||Pe.humanitarian;e.innerHTML=`
    ...
    `}function Pb(e){k.createCategory=e,Fa()}function zb(){var e,t,a,n,i,r;switch(k.createStep){case 1:if(!k.createCategory)return x("Select a category","error");break;case 2:{const s=((t=(e=document.getElementById("wiz-title"))==null?void 0:e.value)==null?void 0:t.trim())||"",o=((n=(a=document.getElementById("wiz-desc"))==null?void 0:a.value)==null?void 0:n.trim())||"";if(k.createTitle=s,k.createDesc=o,!s)return x("Enter a title","error");if(!o)return x("Enter a description","error");break}case 3:{const s=((r=(i=document.getElementById("wiz-image-url"))==null?void 0:i.value)==null?void 0:r.trim())||"";s&&(k.createImageUrl=s);break}}k.createStep=Math.min(4,k.createStep+1),Fa()}function Bb(){Sb(),k.createStep=Math.max(1,k.createStep-1),Fa()}function Nb(){k.createImageFile=null,k.createImageUrl="",k.createImagePreview=null,k.pendingImageFile=null,k.createStep=4,Fa()}function md(){k.currentView="main",k.createStep=1,k.createCategory=null,k.createTitle="",k.createDesc="",k.createGoal="",k.createDuration="",k.createImageFile=null,k.createImageUrl="",k.createImagePreview=null,k.pendingImageFile=null,Fe()}function Sb(){switch(k.createStep){case 2:{const e=document.getElementById("wiz-title"),t=document.getElementById("wiz-desc");e&&(k.createTitle=e.value),t&&(k.createDesc=t.value);break}case 3:{const e=document.getElementById("wiz-image-url");e&&(k.createImageUrl=e.value.trim());break}case 4:{const e=document.getElementById("wiz-goal"),t=document.getElementById("wiz-duration");e&&(k.createGoal=e.value),t&&(k.createDuration=t.value);break}}}function $b(e,t){const a=t.value.length,n=e==="title"?100:2e3,i=e==="title"?80:1800,r=e==="title"?95:1950,s=document.getElementById(`wiz-${e}-count`);s&&(s.textContent=`${a}/${n}`,s.className=`cp-wiz-char-count ${a>r?"danger":a>i?"warn":""}`)}function Lb(e){var n;const t=(n=e.target.files)==null?void 0:n[0];if(!t)return;if(!ad.includes(t.type)){x("Please select a valid image (JPG, PNG, GIF, WebP)","error");return}if(t.size>td){x("Image must be less than 5MB","error");return}k.createImageFile=t,k.pendingImageFile=t;const a=new FileReader;a.onload=i=>{k.createImagePreview=i.target.result;const r=document.getElementById("wiz-image-preview");r&&(r.innerHTML=`
        ...
        `);const n=document.getElementById("donate-amount");n&&(n.value=""),k.currentCampaign=t,Bn("donate")}function Db(){var n;const e=(n=c==null?void 0:c.userAddress)==null?void 0:n.toLowerCase(),t=k.campaigns.filter(i=>{var r;return((r=i.creator)==null?void 0:r.toLowerCase())===e}),a=document.getElementById("my-campaigns-list");a&&(t.length===0?a.innerHTML=`
            <div class="cp-empty">
        ...
        `:a.innerHTML=t.map(i=>{const r=_a(i.raisedAmount,i.goalAmount),s=od(i);return`
            ...
            `}).join(""),Bn("my"))}function Ob(e){var n,i,r;const t=k.campaigns.find(s=>s.id===e||s.id===String(e));if(!t)return;if(((n=t.creator)==null?void 0:n.toLowerCase())!==((i=c==null?void 0:c.userAddress)==null?void 0:i.toLowerCase())){x("Not your campaign","error");return}k.editingCampaign=t,k.pendingImageFile=null,document.getElementById("edit-campaign-id").value=t.id,document.getElementById("edit-title").value=t.title||"",document.getElementById("edit-desc").value=t.description||"",document.getElementById("edit-image-url").value=t.imageUrl||"",document.querySelectorAll("#modal-edit .cp-cat-option").forEach(s=>s.classList.remove("selected")),(r=document.getElementById(`edit-opt-${t.category||"humanitarian"}`))==null||r.classList.add("selected");const a=document.getElementById("edit-image-preview");a&&t.imageUrl?a.innerHTML=`<img src="${t.imageUrl}" class="cp-image-preview">`:a&&(a.innerHTML=""),Bn("edit")}function Hb(e,t="create"){var i;const a=t==="edit"?"edit-opt-":"opt-",n=t==="edit"?"#modal-edit":"#modal-create";document.querySelectorAll(`${n} .cp-cat-option`).forEach(r=>r.classList.remove("selected")),(i=document.getElementById(`${a}${e}`))==null||i.classList.add("selected")}function Ub(e){const t=document.getElementById("donate-amount")||document.getElementById("detail-amount");t&&(t.value=e)}async function jb(){var l,d,u,f,p,b,g,w;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=document.querySelector("#modal-create .cp-cat-option.selected input"),t=(e==null?void 0:e.value)||"humanitarian",a=(d=(l=document.getElementById("campaign-title"))==null?void 0:l.value)==null?void 0:d.trim(),n=(f=(u=document.getElementById("campaign-desc"))==null?void 0:u.value)==null?void 0:f.trim(),i=(p=document.getElementById("campaign-goal"))==null?void 0:p.value,r=(b=document.getElementById("campaign-duration"))==null?void 0:b.value;let s=(w=(g=document.getElementById("campaign-image-url"))==null?void 0:g.value)==null?void 0:w.trim();if(!a)return x("Enter a title","error");if(!n)return x("Enter a description","error");if(!i||parseFloat(i)<.01)return x("Goal must be at least 0.01 ETH","error");if(!r||parseInt(r)<1)return x("Duration must be at least 1 day","error");if(k.pendingImageFile)try{x("Uploading image...","info"),s=await Pr(k.pendingImageFile)}catch(T){console.error("Image upload failed:",T)}const o=Ft.parseEther(i);await _t.createCampaign({title:a,description:n,goalAmount:o,durationDays:parseInt(r),button:document.getElementById("btn-create"),onSuccess:async(T,C)=>{if(C){Ar(C,{imageUrl:s,category:t,title:a,description:n});try{await fetch(Ra.saveCampaign,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:C,title:a,description:n,category:t,imageUrl:s,creator:c.userAddress})})}catch{}}x("Campaign created!","success"),ct("create"),k.pendingImageFile=null,await gt(),Fe()},onError:T=>{var C;!T.cancelled&&T.type!=="user_rejected"&&x(((C=T.message)==null?void 0:C.slice(0,80))||"Failed","error")}})}async function Wb(){var n;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=k.currentCampaign;if(!e)return;const t=(n=document.getElementById("donate-amount"))==null?void 0:n.value;if(!t||parseFloat(t)<.001)return x("Minimum 0.001 ETH","error");const a=Ft.parseEther(t);await _t.donate({campaignId:e.id,amount:a,button:document.getElementById("btn-donate"),onSuccess:async()=>{x("❤️ Thank you for your donation!","success"),ct("donate"),await gt(),Fe()},onError:i=>{var r;!i.cancelled&&i.type!=="user_rejected"&&x(((r=i.message)==null?void 0:r.slice(0,80))||"Failed","error")}})}async function Gb(e){var n;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const t=(n=document.getElementById("detail-amount"))==null?void 0:n.value;if(!t||parseFloat(t)<.001)return x("Minimum 0.001 ETH","error");const a=Ft.parseEther(t);await _t.donate({campaignId:e,amount:a,button:document.getElementById("btn-donate-detail"),onSuccess:async()=>{x("❤️ Thank you for your donation!","success"),await gt(),await Mt(e)},onError:i=>{var r;!i.cancelled&&i.type!=="user_rejected"&&x(((r=i.message)==null?void 0:r.slice(0,80))||"Failed","error")}})}async function Kb(e){if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");confirm("Cancel this campaign? This cannot be undone.")&&await _t.cancelCampaign({campaignId:e,button:document.getElementById("btn-cancel"),onSuccess:async()=>{x("Campaign cancelled","success"),await gt(),Fe()},onError:t=>{var a;!t.cancelled&&t.type!=="user_rejected"&&x(((a=t.message)==null?void 0:a.slice(0,80))||"Failed","error")}})}async function Yb(e){if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const t=k.campaigns.find(i=>i.id===e||i.id===String(e));if(!t)return;const a=_a(t.raisedAmount,t.goalAmount);let n=`Withdraw ${Ce(t.raisedAmount)} ETH?

5% platform fee applies.`;a<100&&(n+=`
Goal not reached - partial withdrawal.`),confirm(n)&&await _t.withdraw({campaignId:e,button:document.getElementById(`btn-withdraw-${e}`)||document.getElementById("btn-withdraw"),onSuccess:async()=>{var i;x("✅ Funds withdrawn successfully!","success"),ct("my"),await gt(),Fe(),((i=k.currentCampaign)==null?void 0:i.id)===e&&await Mt(e)},onError:i=>{var r;!i.cancelled&&i.type!=="user_rejected"&&x(((r=i.message)==null?void 0:r.slice(0,80))||"Failed","error")}})}async function Vb(){var o,l,d,u,f,p,b,g;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=(o=document.getElementById("edit-campaign-id"))==null?void 0:o.value,t=(d=(l=document.getElementById("edit-title"))==null?void 0:l.value)==null?void 0:d.trim(),a=(f=(u=document.getElementById("edit-desc"))==null?void 0:u.value)==null?void 0:f.trim();let n=(b=(p=document.getElementById("edit-image-url"))==null?void 0:p.value)==null?void 0:b.trim();const i=document.querySelector("#modal-edit .cp-cat-option.selected input"),r=(i==null?void 0:i.value)||"humanitarian";if(!t)return x("Enter title","error");if(k.pendingImageFile)try{x("Uploading image...","info"),n=await Pr(k.pendingImageFile)}catch(w){console.error("Image upload failed:",w)}const s=document.getElementById("btn-save-edit");s&&(s.disabled=!0,s.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Saving...');try{Ar(e,{imageUrl:n,category:r,title:t,description:a}),await fetch(Ra.saveCampaign,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:e,title:t,description:a,category:r,imageUrl:n,creator:c.userAddress})}),x("Campaign updated!","success"),ct("edit"),k.pendingImageFile=null,await gt(),((g=k.currentCampaign)==null?void 0:g.id)===e?await Mt(e):Fe()}catch{x("Failed to save","error")}finally{s&&(s.disabled=!1,s.innerHTML='<i class="fa-solid fa-check"></i> Save')}}function qb(e){const t=k.currentCampaign;if(!t)return;const a=rd(t.id),n=`🙏 Support "${t.title}" on Backcoin Charity!

${Ce(t.raisedAmount)} raised of ${Ce(t.goalAmount)} goal.

`;let i;e==="twitter"?i=`https://twitter.com/intent/tweet?text=${encodeURIComponent(n)}&url=${encodeURIComponent(a)}`:e==="telegram"?i=`https://t.me/share/url?url=${encodeURIComponent(a)}&text=${encodeURIComponent(n)}`:e==="whatsapp"&&(i=`https://wa.me/?text=${encodeURIComponent(n+a)}`),i&&window.open(i,"_blank","width=600,height=400")}function Xb(){const e=k.currentCampaign;e&&navigator.clipboard.writeText(rd(e.id)).then(()=>x("Link copied!","success")).catch(()=>x("Copy failed","error"))}function bd(){bb(),k.currentCampaign=null,k.currentView="main",Fe()}function Jb(e){ct("my"),ct("donate"),ct("edit"),mb(e),Mt(e)}function Zb(e){k.selectedCategory=k.selectedCategory===e?null:e,Br()}function Qb(){k.selectedCategory=null,Br()}function Br(){const e=document.getElementById("cp-grid");if(!e)return;let t=k.campaigns.filter(a=>Cr(a));k.selectedCategory&&(t=t.filter(a=>a.category===k.selectedCategory)),t.sort((a,n)=>Number(n.createdAt||0)-Number(a.createdAt||0)),e.innerHTML=t.length?t.map(a=>pd(a)).join(""):ud("No campaigns")}async function Mt(e){k.currentView="detail",k.isLoading=!0;const t=yi();t&&(t.innerHTML=wb());try{let a=k.campaigns.find(n=>n.id===e||n.id===String(e));if(!a){const n=c==null?void 0:c.publicProvider;if(n){const r=await new Ft.Contract(v.charityPool,Ir,n).getCampaign(e),s=cd(e);a={id:String(e),creator:r.creator||r[0],title:r.title||r[1]||`Campaign #${e}`,description:r.description||r[2]||"",goalAmount:BigInt((r.goalAmount||r[3]).toString()),raisedAmount:BigInt((r.raisedAmount||r[4]).toString()),donationCount:Number(r.donationCount||r[5]),deadline:Number(r.deadline||r[6]),createdAt:Number(r.createdAt||r[7]),status:Number(r.status||r[10]),category:(s==null?void 0:s.category)||"humanitarian",imageUrl:(s==null?void 0:s.imageUrl)||null}}}k.currentCampaign=a,t&&(t.innerHTML=Ps(a))}catch{t&&(t.innerHTML=Ps(null))}finally{k.isLoading=!1}}function yi(){let e=document.getElementById("charity-container");if(e)return e;const t=document.getElementById("charity");return t?(e=document.createElement("div"),e.id="charity-container",t.innerHTML="",t.appendChild(e),e):null}function Fe(){fb();const e=yi();if(!e)return;if(k.currentView==="create"){e.innerHTML=kb(),Fa();return}const t=sd();t?Mt(t):(k.currentView="main",k.currentCampaign=null,e.innerHTML=As(),gt().then(()=>{if(k.currentView==="main"){const a=yi();a&&(a.innerHTML=As())}}))}async function eg(){k.campaigns=[],k.stats=null,k.currentView==="detail"&&k.currentCampaign?await Mt(k.currentCampaign.id):Fe()}window.addEventListener("hashchange",()=>{var e;if(window.location.hash.startsWith("#charity")){const t=sd();t?((e=k.currentCampaign)==null?void 0:e.id)!==t&&Mt(t):k.currentView!=="main"&&bd()}});const gd={render(e){e&&Fe()},update(){k.currentView==="main"&&Br()},refresh:eg,openModal:Bn,closeModal:ct,openCreate:Fb,openDonate:Mb,openMyCampaigns:Db,openEdit:Ob,create:jb,donate:Wb,donateDetail:Gb,cancel:Kb,withdraw:Yb,saveEdit:Vb,selCatOpt:Hb,setAmt:Ub,goBack:bd,viewCampaign:Jb,selectCat:Zb,clearCat:Qb,share:qb,copyLink:Xb,handleImageSelect:xb,removeImage:hb,switchImageTab:vb,wizardSelectCategory:Pb,wizardNext:zb,wizardBack:Bb,wizardSkipImage:Nb,cancelCreate:md,wizardUpdateCharCount:$b,handleWizardImageSelect:Lb,removeWizardImage:Rb,wizardLaunch:_b};window.CharityPage=gd;const Bt=window.ethers,xd="https://sepolia.arbiscan.io/address/",tg=Ud,dt=500;function hd(){return v.agora||v.backchat||v.Backchat||null}function et(){return v.operator||v.treasury||null}const m={view:"feed",activeTab:"feed",viewHistory:[],posts:[],trendingPosts:[],allItems:[],replies:new Map,likesMap:new Map,replyCountMap:new Map,repostCountMap:new Map,postsById:new Map,userProfile:null,profiles:new Map,hasProfile:null,following:new Set,followers:new Set,followCounts:new Map,pendingImage:null,pendingImagePreview:null,isUploadingImage:!1,selectedPost:null,selectedProfile:null,wizStep:1,wizUsername:"",wizDisplayName:"",wizBio:"",wizUsernameOk:null,wizFee:null,wizChecking:!1,fees:{post:0n,reply:0n,like:0n,follow:0n,repost:0n,superLikeMin:0n,boostMin:0n,badge:0n},pendingEth:0n,hasBadge:!1,isBoosted:!1,boostExpiry:0,badgeExpiry:0,referralStats:null,referredBy:null,isLoading:!1,isPosting:!1,contractAvailable:!0,error:null};function ag(){if(document.getElementById("backchat-styles-v70"))return;const e=document.getElementById("backchat-styles-v69");e&&e.remove();const t=document.createElement("style");t.id="backchat-styles-v70",t.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
        ...
        <div class="bc-compose">
            <div class="bc-compose-row">
                <div class="bc-compose-avatar">
                    ${(a=m.userProfile)!=null&&a.username?m.userProfile.username.charAt(0).toUpperCase():Nn(c.userAddress)}
                </div>
    ...
    `}function Lt(e,t=0,a={}){var b,g,w,T;if(e.type==="repost"&&!a.isRepostContent){const C=m.postsById.get(e.originalPostId);return`
        ...
        `}const n=xa(e.author),i=ig(e.author),r=rg(e.author),s=sg(e.author),o=Je(e.superLikes),l=m.replyCountMap.get(e.id)||0,d=m.repostCountMap.get(e.id)||0,u=((b=m.likesMap.get(e.id))==null?void 0:b.size)||0,f=((w=m.likesMap.get(e.id))==null?void 0:w.has((g=c.userAddress)==null?void 0:g.toLowerCase()))||!1,p=a.noAnimation?"":`style="animation-delay:${Math.min(t*.04,.4)}s"`;return`
        <div class="bc-post" data-post-id="${e.id}" ${p} onclick="BackchatPage.viewPost('${e.id}')">
            <div class="bc-post-top">
                ...
                <div class="bc-post-head">
                    <div class="bc-post-author-row">
                        ...
                        <span class="bc-post-time">&middot; ${ng(e.timestamp)}</span>
            ...
            ${e.mediaCID?`
                <div class="bc-post-media">
                    <img src="${tg}${e.mediaCID}" alt="Media" loading="lazy" onerror="this.style.display='none'">
                </div>
            `:""}
    ...
    `}function Rs(){return m.contractAvailable?m.isLoading?`
        ...
        `}function Ig(){return m.trendingPosts.length===0?`
            <div class="bc-empty">
                <div class="bc-empty-glyph accent">
                    <i class="fa-solid fa-fire"></i>
                </div>
    ...
    `}function Ag(){var s,o,l,d,u,f;if(!c.isConnected)return`
            <div class="bc-empty">
        ...
        `;const e=(s=c.userAddress)==null?void 0:s.toLowerCase(),t=m.allItems.filter(p=>{var b;return((b=p.author)==null?void 0:b.toLowerCase())===e&&p.type!=="repost"}),a=m.followers.size,n=m.following.size,i=((o=m.userProfile)==null?void 0:o.displayName)||((l=m.userProfile)==null?void 0:l.username)||Ia(c.userAddress),r=(d=m.userProfile)!=null&&d.username?m.userProfile.username.charAt(0).toUpperCase():Nn(c.userAddress);return`
        <div class="bc-profile-section">
            ...
            ${t.length===0?'<div class="bc-empty" style="padding:40px 20px;"><div class="bc-empty-text">No posts yet — share your first thought!</div></div>':t.map((p,b)=>Lt(p,b)).join("")}
        </div>
    `}function Pg(){var n,i;if(!c.isConnected)return"";const e=`${window.location.origin}/#backchat?ref=${c.userAddress}`,t=((n=m.referralStats)==null?void 0:n.totalReferred)||0,a=((i=m.referralStats)==null?void 0:i.totalEarnedFormatted)||"0.0";return`
    ...
    `}function ee(){const e=document.getElementById("backchat-content");if(!e)return;let t="";switch(m.view){case"feed":t=Ls()+Rs();break;case"trending":t=Ig();break;case"profile":t=!m.hasProfile&&c.isConnected?_s():Ag();break;case"post-detail":t=zg();break;case"user-profile":t=Bg();break;case"profile-setup":t=_s();break;default:t=Ls()+Rs()}e.innerHTML=t}function zg(){const e=m.selectedPost?m.postsById.get(m.selectedPost):null;if(!e)return'<div class="bc-empty"><div class="bc-empty-title">Post not found</div></div>';const t=m.replies.get(e.id)||[];t.sort((n,i)=>n.timestamp-i.timestamp);const a=xa(e.author);return`
        ...
        `:""}
    `}function Bg(){var f;const e=m.selectedProfile;if(!e)return'<div class="bc-empty"><div class="bc-empty-title">User not found</div></div>';const t=e.toLowerCase(),a=m.profiles.get(t),n=(a==null?void 0:a.displayName)||(a==null?void 0:a.username)||Ia(e),i=a==null?void 0:a.username,r=a==null?void 0:a.bio,s=i?i.charAt(0).toUpperCase():Nn(e),o=t===((f=c.userAddress)==null?void 0:f.toLowerCase()),l=m.following.has(t),d=m.followCounts.get(t)||{followers:0,following:0},u=m.allItems.filter(p=>{var b;return((b=p.author)==null?void 0:b.toLowerCase())===t&&p.type!=="repost"});return`
        <div class="bc-profile-section">
            <div class="bc-profile-banner"></div>
            <div class="bc-profile-main">
                <div class="bc-profile-top-row">
            ...
            ${u.length===0?'<div class="bc-empty" style="padding:40px 20px;"><div class="bc-empty-text">No posts yet</div></div>':u.sort((p,b)=>b.timestamp-p.timestamp).map((p,b)=>Lt(p,b)).join("")}
        </div>
    ...
    `}function lt(){ag();const e=document.getElementById("backchat");e&&(e.innerHTML=`
        <div class="bc-shell">
            ${Cg()}
            <div id="backchat-content"></div>
        </div>
        ${Ng()}
    `,ee())}let Sn=null;function Sg(e){var t;Sn=e,(t=document.getElementById("modal-superlike"))==null||t.classList.add("active")}async function $g(){var t;const e=((t=document.getElementById("superlike-amount"))==null?void 0:t.value)||"0.001";xt("superlike"),await fg(Sn,e)}function Lg(){var e;(e=document.getElementById("modal-badge"))==null||e.classList.add("active")}async function Rg(){xt("badge"),await vg()}function _g(){var e;(e=document.getElementById("modal-boost"))==null||e.classList.add("active")}async function Fg(){var t;const e=((t=document.getElementById("boost-amount"))==null?void 0:t.value)||"0.001";xt("boost"),await wg(e)}function Mg(e){var t;Sn=e,(t=document.getElementById("modal-repost"))==null||t.classList.add("active")}async function Dg(){await ug(Sn)}function Og(){var e;lt(),(e=document.getElementById("modal-edit-profile"))==null||e.classList.add("active")}async function Hg(){await hg()}function xt(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.remove("active")}function Ug(e){const t=document.getElementById("bc-char-counter");if(!t)return;const a=e.value.length;t.textContent=`${a}/${dt}`,t.className="bc-char-count",a>dt-50?t.classList.add("danger"):a>dt-150&&t.classList.add("warn")}const vd={async render(e){e&&(lt(),await Promise.all([zs(),Bs(),Ns(),Jt(),Ss()]))},async refresh(){await Promise.all([zs(),Bs(),Ns(),Jt(),Ss()])},setTab(e){m.activeTab=e,m.view=e,lt()},goBack:og,viewPost(e){Va("post-detail",{post:e})},viewProfile(e){var t;(e==null?void 0:e.toLowerCase())===((t=c.userAddress)==null?void 0:t.toLowerCase())?(m.activeTab="profile",m.view="profile",lt()):Va("user-profile",{profile:e})},openReply(e){Va("post-detail",{post:e})},openProfileSetup(){m.wizStep=1,m.wizUsername="",m.wizDisplayName="",m.wizBio="",m.wizUsernameOk=null,m.wizFee=null,Va("profile-setup")},createPost:cg,submitReply:dg,like:pg,follow:mg,unfollow:bg,withdraw:gg,openSuperLike:Sg,confirmSuperLike:$g,openRepostConfirm:Mg,confirmRepost:Dg,openBadge:Lg,confirmBadge:Rg,openBoost:_g,confirmBoost:Fg,openEditProfile:Og,confirmEditProfile:Hg,closeModal:xt,openEarnings(){m.activeTab="profile",m.view="profile",lt()},handleImageSelect:kg,removeImage:Eg,onWizUsernameInput:Tg,wizNext(){var e,t,a,n;m.wizStep===1&&!m.wizUsernameOk||(m.wizStep===1?m.wizStep=2:m.wizStep===2&&(m.wizDisplayName=((t=(e=document.getElementById("wiz-displayname-input"))==null?void 0:e.value)==null?void 0:t.trim())||"",m.wizBio=((n=(a=document.getElementById("wiz-bio-input"))==null?void 0:a.value)==null?void 0:n.trim())||"",m.wizStep=3),ee())},wizBack(){var e,t,a,n;m.wizStep>1&&(m.wizStep===2&&(m.wizDisplayName=((t=(e=document.getElementById("wiz-displayname-input"))==null?void 0:e.value)==null?void 0:t.trim())||"",m.wizBio=((n=(a=document.getElementById("wiz-bio-input"))==null?void 0:a.value)==null?void 0:n.trim())||""),m.wizStep--,ee())},wizConfirm:xg,_wizSave(){},_updateCharCount:Ug,copyReferralLink(){const e=`${window.location.origin}/#backchat?ref=${c.userAddress}`;navigator.clipboard.writeText(e).then(()=>x("Referral link copied!","success"),()=>x("Failed to copy","error"))},shareReferral(){const e=`${window.location.origin}/#backchat?ref=${c.userAddress}`,t="Join Backchat — earn crypto by posting, liking, and referring friends! 30% referral rewards.";navigator.share?navigator.share({title:"Backchat Referral",text:t,url:e}).catch(()=>{}):navigator.clipboard.writeText(`${t}
${e}`).then(()=>x("Referral message copied!","success"),()=>x("Failed to copy","error"))}};window.BackchatPage=vd;const jg=window.inject||(()=>{console.warn("Dev Mode: Analytics disabled.")});if(window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1")try{jg()}catch(e){console.error("Analytics Error:",e)}const Nr="".toLowerCase();window.__ADMIN_WALLET__=Nr;Nr&&console.log("✅ Admin access granted");let Pt=null,ca=null,ei=!1;const me={dashboard:xc,mine:ui,store:xf,rewards:ui,actions:qf,charity:gd,backchat:vd,notary:Oc,airdrop:zm,tokenomics:m0,about:sm,admin:a0,rental:Xc,socials:ob,creditcard:lb,dex:U,dao:cb,tutorials:Qc};function wd(e){return!e||e.length<42?"...":`${e.slice(0,6)}...${e.slice(-4)}`}function Wg(e){if(!e)return"0.00";const t=F(e);return t>=1e9?(t/1e9).toFixed(2)+"B":t>=1e6?(t/1e6).toFixed(2)+"M":t>=1e4?t.toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):t.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function sa(e,t=!1){const a=document.querySelector("main > div.container"),n=document.querySelectorAll(".sidebar-link");if(!a){console.error("❌ Page container not found");return}e==="rewards"&&(e="mine",window.location.hash="mine");const i=window.location.hash.includes("/");if(!(Pt!==e||t||i)){me[e]&&typeof me[e].update=="function"&&me[e].update(c.isConnected);return}console.log(`📍 Navigating: ${Pt} → ${e} (force: ${t})`),ca&&typeof ca=="function"&&(ca(),ca=null),Array.from(a.children).forEach(l=>{l.tagName==="SECTION"&&(l.classList.add("hidden"),l.classList.remove("active"))});const s=document.getElementById("charity-container");s&&e!=="charity"&&(s.innerHTML=""),n.forEach(l=>{l.classList.remove("active"),l.classList.add("text-zinc-400","hover:text-white","hover:bg-zinc-700")});const o=document.getElementById(e);if(o&&me[e]){o.classList.remove("hidden"),o.classList.add("active");const l=Pt!==e;Pt=e;const d=document.querySelector(`.sidebar-link[data-target="${e}"]`);d&&(d.classList.remove("text-zinc-400","hover:text-white","hover:bg-zinc-700"),d.classList.add("active")),me[e]&&typeof me[e].render=="function"&&me[e].render(l||t),typeof me[e].cleanup=="function"&&(ca=me[e].cleanup),l&&window.scrollTo(0,0)}else e!=="dashboard"&&e!=="faucet"&&(console.warn(`Route '${e}' not found, redirecting to dashboard.`),sa("dashboard",!0))}window.navigateTo=sa;const Fs="wallet-btn text-xs font-mono text-center max-w-fit whitespace-nowrap relative font-bold py-2 px-4 rounded-md transition-colors";function Sr(e=!1){ei||(ei=!0,requestAnimationFrame(()=>{Gg(e),ei=!1}))}function Gg(e){const t=document.getElementById("admin-link-container"),a=document.getElementById("statUserBalance"),n=document.getElementById("connectButtonDesktop"),i=document.getElementById("connectButtonMobile"),r=document.getElementById("mobileAppDisplay");let s=c.userAddress;const o=[n,i];if(c.isConnected&&s){const d=Wg(c.currentUserBalance),f=`
            <div class="status-dot"></div>
            <span>${wd(s)}</span>
            <div class="balance-pill">
                ${d} BKC
            </div>
        `;if(o.forEach(p=>{p&&(p.innerHTML=f,p.className=Fs+" wallet-btn-connected")}),r&&(r.textContent="Backcoin.org",r.classList.add("text-white"),r.classList.remove("text-amber-400")),t){const p=s.toLowerCase()===Nr;t.style.display=p?"block":"none"}a&&(a.textContent=d)}else{const d='<i class="fa-solid fa-plug"></i> Connect Wallet';o.forEach(u=>{u&&(u.innerHTML=d,u.className=Fs+" wallet-btn-disconnected")}),r&&(r.textContent="Backcoin.org",r.classList.add("text-amber-400"),r.classList.remove("text-white")),t&&(t.style.display="none"),a&&(a.textContent="--")}const l=Pt||"dashboard";e||!Pt?sa(l,!0):me[l]&&typeof me[l].update=="function"&&me[l].update(c.isConnected)}function Kg(e){const{isConnected:t,address:a,isNewConnection:n,wasConnected:i}=e,r=n||t!==i;c.isConnected=t,a&&(c.userAddress=a),Sr(r),t&&n?x(`Connected: ${wd(a)}`,"success"):!t&&i&&x("Wallet disconnected.","info")}function Yg(){const e=document.getElementById("testnet-banner"),t=document.getElementById("close-testnet-banner");if(!(!e||!t)){if(localStorage.getItem("hideTestnetBanner")==="true"){e.remove();return}e.style.transform="translateY(0)",t.addEventListener("click",()=>{e.style.transform="translateY(100%)",setTimeout(()=>e.remove(),500),localStorage.setItem("hideTestnetBanner","true")})}}function Vg(){const e=document.querySelectorAll(".sidebar-link"),t=document.getElementById("menu-btn"),a=document.getElementById("sidebar"),n=document.getElementById("sidebar-backdrop"),i=document.getElementById("connectButtonDesktop"),r=document.getElementById("connectButtonMobile"),s=document.getElementById("shareProjectBtn");Yg(),e.length>0&&e.forEach(l=>{l.addEventListener("click",async d=>{d.preventDefault();const u=l.dataset.target;if(u==="faucet"){x("Accessing Testnet Faucet...","info"),await _i("BKC")&&Sr(!0);return}u&&(window.location.hash=u,sa(u,!0),a&&a.classList.contains("translate-x-0")&&(a.classList.remove("translate-x-0"),a.classList.add("-translate-x-full"),n&&n.classList.add("hidden")))})});const o=()=>{so()};i&&i.addEventListener("click",o),r&&r.addEventListener("click",o),s&&s.addEventListener("click",()=>_d(c.userAddress)),t&&a&&n&&(t.addEventListener("click",()=>{a.classList.contains("translate-x-0")?(a.classList.add("-translate-x-full"),a.classList.remove("translate-x-0"),n.classList.add("hidden")):(a.classList.remove("-translate-x-full"),a.classList.add("translate-x-0"),n.classList.remove("hidden"))}),n.addEventListener("click",()=>{a.classList.add("-translate-x-full"),a.classList.remove("translate-x-0"),n.classList.add("hidden")}))}function yd(){const e=window.location.hash.replace("#","");if(!e)return"dashboard";const t=e.split(/[/?]/)[0];return me[t]?t:"dashboard"}function kd(){try{const e=window.location.hash,t=e.indexOf("?");if(t===-1)return;const n=new URLSearchParams(e.substring(t)).get("ref");n&&/^0x[a-fA-F0-9]{40}$/.test(n)&&(localStorage.getItem("backchain_referrer")||(localStorage.setItem("backchain_referrer",n),console.log("[Referral] Captured referrer from URL:",n)))}catch(e){console.warn("[Referral] Failed to parse referral param:",e.message)}}window.addEventListener("load",async()=>{console.log("🚀 App Initializing..."),Be.earn||(Be.earn=document.getElementById("mine"));try{if(!await jd())throw new Error("Failed to load contract addresses")}catch(a){console.error("❌ Critical Initialization Error:",a),x("Initialization failed. Please refresh.","error");return}Vg(),await Fu(),Mu(Kg),Fd();const e=document.getElementById("preloader");e&&(e.style.display="none"),kd();const t=yd();console.log("📍 Initial page from URL:",t,"Hash:",window.location.hash),sa(t,!0),console.log("✅ App Ready.")});window.addEventListener("hashchange",()=>{kd();const e=yd(),t=window.location.hash;console.log("🔄 Hash changed to:",e,"Full hash:",t),e!==Pt?sa(e,!0):e==="charity"&&me[e]&&typeof me[e].render=="function"&&me[e].render(!0)});window.StakingPage=ui;window.openConnectModal=so;window.disconnectWallet=Du;window.updateUIState=Sr;export{zt as C,J as E,tp as G,le as N,np as T,Q as V,Mn as a,Dn as b,h as c,On as d,ie as e,ap as f,Fi as g,fo as h,rp as i,sp as j,Ve as k,op as l,jt as n,Z as r,ip as s,H as t};
