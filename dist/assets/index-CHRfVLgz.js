import{defaultConfig as Za,createWeb3Modal as ei}from"https://esm.sh/@web3modal/ethers@5.1.11?bundle";import{initializeApp as ti}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-app.js";import{getAuth as si,onAuthStateChanged as ni,signInAnonymously as ai}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-auth.js";import{getFirestore as ii,doc as _,getDoc as te,writeBatch as bt,increment as ie,collection as ye,query as Me,where as Nt,orderBy as Ke,getDocs as ze,limit as oi,serverTimestamp as Ce,updateDoc as qt,setDoc as Yt,Timestamp as un,addDoc as ri,deleteDoc as li}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-firestore.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function s(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(a){if(a.ep)return;a.ep=!0;const i=s(a);fetch(a.href,i)}})();const se={sidebar:document.getElementById("sidebar"),sidebarBackdrop:document.getElementById("sidebar-backdrop"),menuBtn:document.getElementById("menu-btn"),navLinks:document.getElementById("nav-links"),mainContentSections:document.querySelectorAll("main section"),connectButtonDesktop:document.getElementById("connectButtonDesktop"),connectButtonMobile:document.getElementById("connectButtonMobile"),mobileAppDisplay:document.getElementById("mobileAppDisplay"),desktopDisconnected:document.getElementById("desktopDisconnected"),desktopConnectedInfo:document.getElementById("desktopConnectedInfo"),desktopUserAddress:document.getElementById("desktopUserAddress"),desktopUserBalance:document.getElementById("desktopUserBalance"),modalContainer:document.getElementById("modal-container"),toastContainer:document.getElementById("toast-container"),dashboard:document.getElementById("dashboard"),earn:document.getElementById("mine"),store:document.getElementById("store"),rental:document.getElementById("rental"),rewards:document.getElementById("rewards"),actions:document.getElementById("actions"),presale:document.getElementById("presale"),faucet:document.getElementById("faucet"),airdrop:document.getElementById("airdrop"),dao:document.getElementById("dao"),about:document.getElementById("about"),admin:document.getElementById("admin"),tokenomics:document.getElementById("tokenomics"),notary:document.getElementById("notary"),statTotalSupply:document.getElementById("statTotalSupply"),statValidators:document.getElementById("statValidators"),statTotalPStake:document.getElementById("statTotalPStake"),statScarcity:document.getElementById("statScarcity"),statLockedPercentage:document.getElementById("statLockedPercentage"),statUserBalance:document.getElementById("statUserBalance"),statUserPStake:document.getElementById("statUserPStake"),statUserRewards:document.getElementById("statUserRewards")},ci={provider:null,publicProvider:null,web3Provider:null,signer:null,userAddress:null,isConnected:!1,bkcTokenContract:null,delegationManagerContract:null,rewardBoosterContract:null,nftLiquidityPoolContract:null,actionsManagerContract:null,fortunePoolContract:null,faucetContract:null,decentralizedNotaryContract:null,ecosystemManagerContract:null,publicSaleContract:null,rentalManagerContract:null,bkcTokenContractPublic:null,delegationManagerContractPublic:null,faucetContractPublic:null,fortunePoolContractPublic:null,rentalManagerContractPublic:null,ecosystemManagerContractPublic:null,actionsManagerContractPublic:null,currentUserBalance:0n,currentUserNativeBalance:0n,userTotalPStake:0n,userDelegations:[],myBoosters:[],activityHistory:[],totalNetworkPStake:0n,allValidatorsData:[],systemFees:{},systemPStakes:{},boosterDiscounts:{},notaryFee:void 0,notaryMinPStake:void 0},di={set(e,t,s){return e[t]=s,["currentUserBalance","isConnected","userTotalPStake","totalNetworkPStake"].includes(t)&&window.updateUIState&&window.updateUIState(),!0}},c=new Proxy(ci,di);let pn=!1;const b=(e,t="info",s=null)=>{if(!se.toastContainer)return;const n={success:{icon:"fa-check-circle",color:"bg-green-600",border:"border-green-400"},error:{icon:"fa-exclamation-triangle",color:"bg-red-600",border:"border-red-400"},info:{icon:"fa-info-circle",color:"bg-blue-600",border:"border-blue-400"},warning:{icon:"fa-exclamation-circle",color:"bg-yellow-600",border:"border-yellow-400"}},a=n[t]||n.info,i=document.createElement("div");i.className=`flex items-center w-full max-w-xs p-4 text-white rounded-lg shadow-lg transition-all duration-500 ease-out 
    ...
    `;Kt(o,"max-w-md")}const fn=e=>{window.navigateTo?window.navigateTo(e):console.error("navigateTo function not found."),be()};function fi(){var a,i,o,r;if(pn)return;pn=!0;const e="https://backcoin.org/presale",t="https://t.me/BackCoinorg";Kt(`
    ...
    `,document.body.appendChild(t)}function ne(e){const t=go(e);return t==="INSUFFICIENT_GAS"?(xo(),"Insufficient ETH for gas"):(b(t,"error"),t)}function ga(e){const t=(e==null?void 0:e.message)||(e==null?void 0:e.reason)||"";return["Internal JSON-RPC","network","timeout","ETIMEDOUT","ECONNRESET","rate limit","Too Many Requests","nonce","replacement transaction","already known"].some(n=>t.toLowerCase().includes(n.toLowerCase()))}function xa(e){const t=(e==null?void 0:e.message)||(e==null?void 0:e.reason)||"";return t.includes("user rejected")||t.includes("User denied")||t.includes("cancelled")||t.includes("canceled")}async function xt(e,t,s,n,a=Te.MAX_RETRIES){const i=["function approve(address,uint256) returns (bool)","function allowance(address,address) view returns (uint256)"],o=new U.Contract(e,i,n);let r;try{r=await o.allowance(c.userAddress,t),console.log("Current allowance:",U.formatEther(r),"BKC")}catch(d){console.warn("Could not check allowance:",d.message),r=0n}if(r>=s)return console.log("✅ Already approved"),!0;const l=s*10n;for(let d=1;d<=a;d++)try{b(`Approve tokens... ${d>1?`(attempt ${d})`:""}`,"info");const u=await o.approve(t,l);if(b("Waiting for approval confirmation...","info"),(await u.wait()).status===0)throw new Error("Approval transaction reverted");if(await qe(Te.APPROVAL_WAIT_MS),await o.allowance(c.userAddress,t)>=s)return b("✅ Approved!","success"),!0;throw new Error("Approval not reflected yet")}catch(u){if(console.error(`Approval attempt ${d} failed:`,u),xa(u))return b("Approval cancelled","error"),!1;if(d<a&&ga(u)){b(`Retrying approval... (${d}/${a})`,"warning"),await qe(Te.RETRY_DELAY_MS*d);continue}return ne(u),!1}return!1}async function pe(e,t={}){const{retries:s=Te.MAX_RETRIES,onAttempt:n=()=>{},onSuccess:a=()=>{},description:i="Transaction"}=t;for(let o=1;o<=s;o++)try{n(o);const r=await e();b("Waiting for confirmation...","info");const l=await r.wait();if(l.status===0)throw new Error("Transaction reverted");return a(l),{success:!0,receipt:l,txHash:l.hash}}catch(r){if(console.error(`${i} attempt ${o} failed:`,r),xa(r))return b("Transaction cancelled","error"),{success:!1,cancelled:!0};if(o<s&&ga(r)){b(`Network issue, retrying... (${o}/${s})`,"warning"),await qe(Te.RETRY_DELAY_MS*o);continue}return ne(r),{success:!1,error:r}}return{success:!1}}async function ho(e,t,s,n){const a=await ue();if(!a)return!1;try{const i=BigInt(e),o=BigInt(t),r=BigInt(s||0);if(await c.bkcTokenContract.balanceOf(c.userAddress)<i)return b("Insufficient BKC balance","error"),!1;if(!await xt(v.bkcToken,v.delegationManager,i,a))return!1;const u=new U.Contract(v.delegationManager,De,a),p=await pe(()=>u.delegate(i,o,r),{description:"Delegation",onAttempt:m=>{m===1&&b("Confirm delegation in wallet...","info")},onSuccess:()=>{b("✅ Delegation successful!","success"),V()}});return p.success&&p.txHash&&de("delegation",p.txHash),p.success}catch(i){return console.error("Delegation error:",i),ne(i),!1}finally{}}async function wo(e,t,s){const n=await ue();if(!n)return!1;try{const a=Number(e);if(isNaN(a)||a<0)return b("Invalid delegation index","error"),!1;const i=BigInt(a),o=BigInt(t||0);console.log("Unstake params:",{index:i.toString(),boosterId:o.toString()});const r=new U.Contract(v.delegationManager,De,n),l=await pe(()=>r.unstake(i,o),{description:"Unstake",onAttempt:d=>{d===1&&b("Confirm unstake in wallet...","info")},onSuccess:async()=>{b("✅ Unstaked!","success"),await V(!0),await Gs(!0)}});return l.success&&l.txHash&&de("unstake",l.txHash),l.success}catch(a){return console.error("Unstake error:",a),ne(a),!1}finally{}}async function yo(e,t,s){const n=await ue();if(!n)return!1;try{const a=Number(e);if(isNaN(a)||a<0)return b("Invalid delegation index","error"),!1;const i=BigInt(a),o=BigInt(t||0),r=new U.Contract(v.delegationManager,De,n),l=await pe(()=>r.forceUnstake(i,o),{description:"Force Unstake",onAttempt:d=>{d===1&&b("Confirm force unstake in wallet...","info")},onSuccess:async()=>{b("✅ Force unstaked (penalty applied)","success"),await V(!0),await Gs(!0)}});return l.success&&l.txHash&&de("unstake",l.txHash),l.success}catch(a){return console.error("Force unstake error:",a),ne(a),!1}finally{}}async function Qs(e,t,s,n){const a=await ue();if(!a)return!1;const i=(n==null?void 0:n.innerHTML)||"Claim";n&&(n.innerHTML='<div class="loader inline-block"></div> Processing...',n.disabled=!0);try{let o=0n;try{const d=Number(s||0);d>0&&c.myBoosters&&c.myBoosters.length>0&&c.myBoosters.some(p=>Number(p.tokenId)===d)&&(o=BigInt(d))}catch(d){console.warn("Invalid booster ID for claim, using 0:",d)}const r=new U.Contract(v.delegationManager,De,a),l=await pe(()=>r.claimReward(o),{description:"Claim Rewards",onAttempt:d=>{d===1&&b("Confirm claim in wallet...","info")},onSuccess:async()=>{b("✅ Rewards claimed!","success"),await V(!0)}});return l.success&&l.txHash&&de("claimReward",l.txHash),l.success}catch(o){return console.error("Claim error:",o),ne(o),!1}finally{n&&(n.innerHTML=i,n.disabled=!1)}}async function ko(e,t,s){var i;const n=await ue();if(!n)return{success:!1};const a=(s==null?void 0:s.innerHTML)||"Buy";s&&(s.innerHTML='<div class="loader inline-block"></div> Processing...',s.disabled=!0);try{const o=BigInt(t);if(!await xt(v.bkcToken,e,o,n))return{success:!1};s&&(s.innerHTML='<div class="loader inline-block"></div> Buying...');const l=new U.Contract(e,Us,n),d=await pe(()=>l.buyNFT(),{description:"Buy NFT",onAttempt:u=>{u===1&&b("Confirm purchase in wallet...","info")}});if(d.success){let u=null;for(const p of d.receipt.logs)try{const m=l.interface.parseLog(p);if((m==null?void 0:m.name)==="NFTPurchased"){u=(i=m.args.tokenId)==null?void 0:i.toString();break}}catch{}return b(`✅ NFT purchased! ${u?`#${u}`:""}`,"success"),V(),de("buyNFT",d.txHash),{success:!0,tokenId:u,txHash:d.txHash}}return{success:!1}}catch(o){return console.error("Buy NFT error:",o),ne(o),{success:!1}}finally{s&&(s.innerHTML=a,s.disabled=!1)}}async function To(e,t,s,n){const a=await ue();if(!a)return{success:!1};const i=(n==null?void 0:n.innerHTML)||"Sell";n&&(n.innerHTML='<div class="loader inline-block"></div> Processing...',n.disabled=!0);try{let o=t;if(typeof t=="object"&&t!==null&&(o=t.tokenId||t.id||t.token_id,console.warn("executeSellNFT: Object passed instead of tokenId, extracted:",o)),o==null||o==="")return console.error("executeSellNFT: Invalid tokenId:",t),b("Invalid NFT token ID","error"),{success:!1};try{o=BigInt(o)}catch{return console.error("executeSellNFT: Cannot convert tokenId to BigInt:",o),b("Invalid NFT token ID format","error"),{success:!1}}let r=0n;if(s!=null&&s!=="")try{r=BigInt(s)}catch{console.warn("executeSellNFT: Invalid minPayout, using 0"),r=0n}const l=["function approve(address,uint256)","function getApproved(uint256) view returns (address)"],d=new U.Contract(v.rewardBoosterNFT,l,a);(await d.getApproved(o)).toLowerCase()!==e.toLowerCase()&&(b("Approving NFT...","info"),await(await d.approve(e,o)).wait(),await qe(Te.APPROVAL_WAIT_MS)),n&&(n.innerHTML='<div class="loader inline-block"></div> Selling...');const p=new U.Contract(e,Us,a),m=await pe(()=>p.sellNFT(o,r),{description:"Sell NFT",onAttempt:g=>{g===1&&b("Confirm sale in wallet...","info")}});return m.success?(b("✅ NFT sold!","success"),V(),de("sellNFT",m.txHash),{success:!0,txHash:m.txHash}):{success:!1}}catch(o){return console.error("Sell NFT error:",o),ne(o),{success:!1}}finally{n&&(n.innerHTML=i,n.disabled=!1)}}async function zo(e,t){const s=await ue();if(!s)return{success:!1};const n=(t==null?void 0:t.innerHTML)||"List";t&&(t.innerHTML='<div class="loader inline-block"></div> Processing...',t.disabled=!0);try{let a,i,o,r;typeof e=="object"&&e!==null?(a=e.tokenId,i=e.pricePerHour,o=e.minHours,r=e.maxHours):(a=e,i=arguments[1],o=arguments[2],r=arguments[3],t=arguments[4]);const l=v.rentalManager;if(!l)return b("Rental Manager not configured","error"),{success:!1};const d=["function setApprovalForAll(address,bool)","function isApprovedForAll(address,address) view returns (bool)"],u=new U.Contract(v.rewardBoosterNFT,d,s);await u.isApprovedForAll(c.userAddress,l)||(b("Approving NFTs for rental...","info"),await(await u.setApprovalForAll(l,!0)).wait(),await qe(Te.APPROVAL_WAIT_MS)),t&&(t.innerHTML='<div class="loader inline-block"></div> Listing...');const m=new U.Contract(l,Ee,s),g=await pe(()=>m.listNFT(BigInt(a),BigInt(i),BigInt(o),BigInt(r)),{description:"List NFT",onAttempt:f=>{f===1&&b("Confirm listing in wallet...","info")}});return g.success?(b(`✅ NFT #${a} listed for rent!`,"success"),gt(!0),de("listRental",g.txHash),{success:!0,txHash:g.txHash}):{success:!1}}catch(a){return console.error("List NFT error:",a),ne(a),{success:!1}}finally{t&&(t.innerHTML=n,t.disabled=!1)}}async function Co(e,t){const s=await ue();if(!s)return{success:!1};const n=(t==null?void 0:t.innerHTML)||"Rent";t&&(t.innerHTML='<div class="loader inline-block"></div> Processing...',t.disabled=!0);try{let a,i,o;typeof e=="object"&&e!==null?(a=e.tokenId,i=e.hours,o=e.totalCost):(a=e,i=arguments[1],o=arguments[2],t=arguments[3]);const r=v.rentalManager;if(!r)return b("Rental Manager not configured","error"),{success:!1};const l=BigInt(o);if(!await xt(v.bkcToken,r,l,s))return{success:!1};t&&(t.innerHTML='<div class="loader inline-block"></div> Renting...');const u=new U.Contract(r,Ee,s),p=await pe(()=>u.rentNFT(BigInt(a),BigInt(i)),{description:"Rent NFT",onAttempt:m=>{m===1&&b("Confirm rental in wallet...","info")}});return p.success?(b(`✅ NFT #${a} rented for ${i} hours!`,"success"),V(),gt(!0),de("rentNFT",p.txHash),{success:!0,txHash:p.txHash}):{success:!1}}catch(a){return console.error("Rent NFT error:",a),ne(a),{success:!1}}finally{t&&(t.innerHTML=n,t.disabled=!1)}}async function Bo(e,t){const s=await ue();if(!s)return{success:!1};const n=(t==null?void 0:t.innerHTML)||"Withdraw";t&&(t.innerHTML='<div class="loader inline-block"></div> Processing...',t.disabled=!0);try{const a=v.rentalManager,i=new U.Contract(a,Ee,s),o=await pe(()=>i.withdrawNFT(e),{description:"Withdraw NFT",onAttempt:r=>{r===1&&b("Confirm withdrawal in wallet...","info")}});return o.success?(b("✅ NFT withdrawn!","success"),V(),gt(),{success:!0,txHash:o.txHash}):{success:!1}}catch(a){return console.error("Withdraw NFT error:",a),ne(a),{success:!1}}finally{t&&(t.innerHTML=n,t.disabled=!1)}}async function Eo(e,t){var a;const s=await ue();if(!s)return!1;const n=(t==null?void 0:t.innerHTML)||"Notarize";t&&(t.innerHTML='<div class="loader inline-block"></div> Processing...',t.disabled=!0);try{const{ipfsUri:i,contentHash:o,description:r}=e,l=v.decentralizedNotary||v.notary;if(!l)return b("Notary contract not configured","error"),!1;let d=U.parseEther("1");try{d=await new U.Contract(l,Ts,s.provider).calculateFee(0)}catch{}if(!await xt(v.bkcToken,l,d,s))return!1;t&&(t.innerHTML='<div class="loader inline-block"></div> Notarizing...');const p=new U.Contract(l,Ts,s);let m=0n;try{const f=await Ge();f!=null&&f.tokenId&&(m=BigInt(f.tokenId))}catch{}const g=await pe(()=>p.notarize(i,r||"",o,m),{description:"Notarize",onAttempt:f=>{f===1&&b("Confirm notarization in wallet...","info")}});if(g.success){let f=null;for(const x of g.receipt.logs)try{const y=p.interface.parseLog(x);if((y==null?void 0:y.name)==="DocumentNotarized"){f=(a=y.args.tokenId)==null?void 0:a.toString();break}}catch{}return b(`✅ Document notarized! ${f?`#${f}`:""}`,"success"),de("notarize",g.txHash),{success:!0,tokenId:f,txHash:g.txHash}}return!1}catch(i){return console.error("Notarize error:",i),ne(i),!1}finally{t&&(t.innerHTML=n,t.disabled=!1)}}const Io=Eo,$o="https://faucet-4wvdcuoouq-uc.a.run.app";async function Ao(e){if(!c.isConnected||!c.userAddress)return b("Please connect wallet first","error"),{success:!1};const t=(e==null?void 0:e.innerHTML)||"Claim";e.innerHTML='<div class="loader inline-block"></div> Claiming...',e.disabled=!0;try{const s=await fetch(`${$o}?address=${c.userAddress}`,{method:"GET",headers:{Accept:"application/json"}}),n=await s.json();if(s.ok&&n.success)return b("✅ Tokens received!","success"),V(),n.txHash&&de("faucet",n.txHash),{success:!0,txHash:n.txHash,bkcAmount:n.bkcAmount,ethAmount:n.ethAmount};{const a=n.error||n.message||"Faucet unavailable";return b(a,"error"),{success:!1,error:a}}}catch(s){return console.error("Faucet error:",s),b("Faucet unavailable","error"),{success:!1}}finally{e.innerHTML=t,e.disabled=!1}}const Lo=["function play(uint256 _wagerAmount, uint256[] calldata _guesses, bool _isCumulative) external payable","function prizePoolBalance() external view returns (uint256)","function gameCounter() external view returns (uint256)","function activeTierCount() external view returns (uint256)","function serviceFee() external view returns (uint256)","function getRequiredServiceFee(bool _isCumulative) external view returns (uint256)","event GamePlayed(uint256 indexed gameId, address indexed player, uint256 wagerAmount, uint256 prizeWon, bool isCumulative, uint8 matchCount)","event GameDetails(uint256 indexed gameId, uint256[] guesses, uint256[] rolls, bool[] matches)","event JackpotWon(uint256 indexed gameId, address indexed player, uint256 prizeAmount, uint256 tier)"];async function So(e,t,s,n){const a=await ue();if(!a)return{success:!1};try{const i=U.parseEther(e.toString()),o=Array.isArray(t)?t.map(f=>BigInt(f)):[BigInt(t)];console.log("Fortune V2 Play params:",{wager:e.toString(),wagerWei:i.toString(),guesses:o.map(f=>f.toString()),isCumulative:s});const r=v.fortunePoolV2||v.fortunePool||v.actionsManager;if(!r)return b("Fortune Pool not configured","error"),{success:!1};const l=new U.Contract(r,Lo,a);let d=0n;try{if(d=await l.activeTierCount(),d===0n)return b("No active game tiers","error"),{success:!1};const f=s?Number(d):1;if(o.length!==f)return b(`Need ${f} guess(es), got ${o.length}`,"error"),{success:!1}}catch(f){console.warn("Could not verify tier count:",f.message)}let u=0n;try{u=await l.getRequiredServiceFee(s),console.log("Required service fee:",U.formatEther(u),"ETH")}catch(f){console.warn("Could not get service fee:",f.message)}if(u>0n&&await a.provider.getBalance(c.userAddress)<u)return b(`Need ${U.formatEther(u)} ETH for game fee`,"error"),{success:!1};if(await c.bkcTokenContract.balanceOf(c.userAddress)<i)return b("Insufficient BKC balance","error"),{success:!1};if(!await xt(v.bkcToken,r,i,a))return{success:!1};const g=await pe(()=>l.play(i,o,s,{value:u}),{description:"Fortune Game V2",retries:Te.MAX_RETRIES,onAttempt:f=>{f===1&&b("Confirm game in wallet...","info")}});if(g.success){let f=null,x=[],y=0,k=[],$=0,L=!1;for(const A of g.receipt.logs)try{const I=l.interface.parseLog({topics:A.topics,data:A.data});(I==null?void 0:I.name)==="GamePlayed"&&(f=Number(I.args.gameId),y=Number(U.formatEther(I.args.prizeWon)),$=Number(I.args.matchCount)),(I==null?void 0:I.name)==="GameDetails"&&(x=I.args.rolls.map(T=>Number(T)),k=Array.from(I.args.matches)),(I==null?void 0:I.name)==="JackpotWon"&&(L=!0)}catch{}return y>0?b(L?`🎰🎰🎰 JACKPOT! +${y.toLocaleString()} BKC!`:`🎉 YOU WON ${y.toLocaleString()} BKC!`,"success"):b("No match this time. Try again!","warning"),V(),de("fortune",g.txHash),{success:!0,gameId:f,rolls:x,guesses:o.map(A=>Number(A)),prizeWon:y,matches:k,matchCount:$,isJackpot:L,isCumulative:s,txHash:g.txHash}}return{success:!1}}catch(i){return console.error("Fortune V2 error:",i),ne(i),{success:!1}}finally{}}const Zt=window.ethers,E={hasRenderedOnce:!1,lastUpdate:0,activities:[],networkActivities:[],filteredActivities:[],userProfile:null,pagination:{currentPage:1,itemsPerPage:8},filters:{type:"ALL",sort:"NEWEST"},metricsCache:{},economicData:null,isLoadingNetworkActivity:!1,networkActivitiesTimestamp:0,faucet:{canClaim:!0,cooldownEnd:null,isLoading:!1,lastCheck:0}},Po="https://sepolia.arbiscan.io/tx/",No="https://sepolia.arbiscan.io/address/",Mo="https://faucet-4wvdcuoouq-uc.a.run.app",Fo="https://getrecentactivity-4wvdcuoouq-uc.a.run.app",Ro="https://getsystemdata-4wvdcuoouq-uc.a.run.app",Cs="1,000",Bs="0.01",Do=Zt.parseUnits("100",18),W={STAKING:{icon:"fa-lock",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🔒 Staked",emoji:"🔒"},UNSTAKING:{icon:"fa-unlock",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"🔓 Unstaked",emoji:"🔓"},FORCE_UNSTAKE:{icon:"fa-bolt",color:"#ef4444",bg:"rgba(239,68,68,0.15)",label:"⚡ Force Unstaked",emoji:"⚡"},CLAIM:{icon:"fa-coins",color:"#fbbf24",bg:"rgba(245,158,11,0.15)",label:"🪙 Rewards Claimed",emoji:"🪙"},NFT_BUY:{icon:"fa-bag-shopping",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🛍️ Bought NFT",emoji:"🛍️"},NFT_SELL:{icon:"fa-hand-holding-dollar",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"💰 Sold NFT",emoji:"💰"},NFT_MINT:{icon:"fa-gem",color:"#fde047",bg:"rgba(234,179,8,0.15)",label:"💎 Minted Booster",emoji:"💎"},NFT_TRANSFER:{icon:"fa-arrow-right-arrow-left",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"↔️ Transfer",emoji:"↔️"},RENTAL_LIST:{icon:"fa-tag",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🏷️ Listed NFT",emoji:"🏷️"},RENTAL_RENT:{icon:"fa-clock",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"⏰ Rented NFT",emoji:"⏰"},RENTAL_WITHDRAW:{icon:"fa-rotate-left",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"↩️ Withdrawn",emoji:"↩️"},FORTUNE_BET:{icon:"fa-paw",color:"#f97316",bg:"rgba(249,115,22,0.2)",label:"🐯 Fortune Bet",emoji:"🐯"},FORTUNE_ORACLE:{icon:"fa-eye",color:"#e879f9",bg:"rgba(232,121,249,0.25)",label:"🔮 Oracle Response",emoji:"🔮"},FORTUNE_WIN:{icon:"fa-crown",color:"#facc15",bg:"rgba(234,179,8,0.25)",label:"🏆 Fortune Winner!",emoji:"🏆"},FORTUNE_LOSE:{icon:"fa-paw",color:"#71717a",bg:"rgba(39,39,42,0.5)",label:"🐯 No Luck",emoji:"😿"},NOTARY:{icon:"fa-stamp",color:"#818cf8",bg:"rgba(99,102,241,0.15)",label:"📜 Notarized",emoji:"📜"},FAUCET:{icon:"fa-droplet",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"💧 Faucet Claim",emoji:"💧"},DEFAULT:{icon:"fa-circle",color:"#71717a",bg:"rgba(39,39,42,0.5)",label:"Activity",emoji:"📋"}};function jo(e){if(!e)return"Just now";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3,s=new Date(t*1e3),a=new Date-s,i=Math.floor(a/6e4),o=Math.floor(a/36e5),r=Math.floor(a/864e5);return i<1?"Just now":i<60?`${i}m ago`:o<24?`${o}h ago`:r<7?`${r}d ago`:s.toLocaleDateString()}catch{return"Recent"}}function Ho(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function cs(e){return e>=1e6?(e/1e6).toFixed(2)+"M":e>=1e3?(e/1e3).toFixed(1)+"K":e.toFixed(0)}function _o(e){return e?`${e.slice(0,6)}...${e.slice(-4)}`:""}function Uo(e){if(!e)return"";const t=Date.now(),n=new Date(e).getTime()-t;if(n<=0)return"";const a=Math.floor(n/36e5),i=Math.floor(n%36e5/6e4);return a>0?`${a}h ${i}m`:`${i}m`}function Oo(e,t={}){const s=(e||"").toUpperCase().trim();return s==="STAKING"||s==="STAKED"||s==="STAKE"||s==="DELEGATED"||s==="DELEGATION"||s.includes("DELEGAT")?W.STAKING:s==="UNSTAKE"||s==="UNSTAKED"||s==="UNSTAKING"||s.includes("UNDELEGAT")?s.includes("FORCE")?W.FORCE_UNSTAKE:W.UNSTAKING:s==="CLAIMREWARD"||s==="CLAIM"||s==="CLAIMED"||s.includes("REWARD")||s.includes("CLAIM")?W.CLAIM:s==="NFTBOUGHT"||s.includes("NFTBOUGHT")||s.includes("NFT_BOUGHT")?W.NFT_BUY:s==="NFTSOLD"||s.includes("NFTSOLD")||s.includes("NFT_SOLD")?W.NFT_SELL:s==="BOOSTERBUY"||s.includes("BOOSTER")||s.includes("PRESALE")||s.includes("MINTED")?W.NFT_MINT:s==="TRANSFER"||s.includes("TRANSFER")?W.NFT_TRANSFER:s==="RENTALLISTED"||s.includes("LISTED")||s.includes("LIST")?W.RENTAL_LIST:s==="RENTALRENTED"||s==="RENTED"||s.includes("RENTAL")&&s.includes("RENT")?W.RENTAL_RENT:s==="RENTALWITHDRAWN"||s.includes("WITHDRAW")?W.RENTAL_WITHDRAW:s==="GAMEREQUESTED"||s.includes("GAMEREQUESTED")||s.includes("GAME_REQUEST")||s.includes("REQUEST")?W.FORTUNE_BET:s==="GAMEFULFILLED"||s.includes("FULFILLED")||s.includes("ORACLE")?W.FORTUNE_ORACLE:s==="GAMERESULT"||s.includes("RESULT")?(t==null?void 0:t.isWin)||(t==null?void 0:t.prizeWon)>0?W.FORTUNE_WIN:W.FORTUNE_LOSE:s.includes("FORTUNE")||s.includes("GAME")?W.FORTUNE_BET:s==="NOTARYREGISTER"||s==="NOTARIZED"||s.includes("NOTARY")||s.includes("DOCUMENT")?W.NOTARY:s==="FAUCETCLAIM"||s.includes("FAUCET")||s.includes("DISTRIBUTED")?W.FAUCET:W.DEFAULT}let ds=null,Ie=0n;function va(e){const t=document.getElementById("dash-user-rewards");if(!t||!c.isConnected){ds&&cancelAnimationFrame(ds);return}const s=e-Ie;s>-1000000000n&&s<1000000000n?Ie=e:Ie+=s/8n,Ie<0n&&(Ie=0n),t.innerHTML=`${B(Ie).toFixed(4)} <span class="text-sm text-amber-500/80">BKC</span>`,Ie!==e&&(ds=requestAnimationFrame(()=>va(e)))}async function In(e){if(!c.isConnected||!c.userAddress)return b("Connect wallet first","error");const t=e.innerHTML;e.disabled=!0,e.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-2"></i> Sending...',E.faucet.isLoading=!0;try{const s=await fetch(`${Mo}?address=${c.userAddress}`,{method:"GET",headers:{Accept:"application/json"}}),n=await s.json();if(s.ok&&n.success)b(`✅ Faucet Sent! ${Cs} BKC + ${Bs} ETH`,"success"),E.faucet.canClaim=!1,E.faucet.cooldownEnd=new Date(Date.now()+24*60*60*1e3).toISOString(),Es(),setTimeout(()=>{ya.update(!0)},4e3);else{const a=n.error||n.message||"Faucet unavailable";if(a.toLowerCase().includes("cooldown")||a.toLowerCase().includes("wait")||a.toLowerCase().includes("hour")){b(`⏳ ${a}`,"warning");const i=a.match(/(\d+)\s*hour/i);if(i){const o=parseInt(i[1]);E.faucet.canClaim=!1,E.faucet.cooldownEnd=new Date(Date.now()+o*60*60*1e3).toISOString(),Es()}}else b(`❌ ${a}`,"error")}}catch(s){console.error("Faucet error:",s),b("Faucet Offline - Try again later","error")}finally{E.faucet.isLoading=!1,e.disabled=!1,e.innerHTML=t}}function Wo(){return c.isConnected?(c.currentUserBalance||c.bkcBalance||0n)<Do:!1}function Es(){const e=document.getElementById("dashboard-faucet-widget");if(!e)return;if(!Wo()){e.classList.add("hidden");return}e.classList.remove("hidden");const t=c.currentUserBalance||c.bkcBalance||0n,s=t===0n,n=Uo(E.faucet.cooldownEnd),a=E.faucet.canClaim&&!n,i=document.getElementById("faucet-title"),o=document.getElementById("faucet-desc"),r=document.getElementById("faucet-status"),l=document.getElementById("faucet-action-btn");if(e.className="glass-panel border-l-4 p-4",l&&(l.className="w-full sm:w-auto font-bold py-2.5 px-5 rounded-lg text-sm transition-all"),!a&&n)e.classList.add("border-zinc-500"),i&&(i.innerText="⏳ Faucet Cooldown"),o&&(o.innerText="Come back when the timer ends"),r&&(r.classList.remove("hidden"),r.innerHTML=`<i class="fa-solid fa-clock mr-1"></i> ${n} remaining`),l&&(l.classList.add("bg-zinc-700","text-zinc-400","cursor-not-allowed"),l.innerHTML='<i class="fa-solid fa-hourglass-half mr-2"></i> On Cooldown',l.disabled=!0);else if(s)e.classList.add("border-green-500"),i&&(i.innerText="🎉 Welcome to BackCoin!"),o&&(o.innerText=`Claim your free starter pack: ${Cs} BKC + ${Bs} ETH for gas`),r&&r.classList.add("hidden"),l&&(l.classList.add("bg-green-600","hover:bg-green-500","text-white","hover:scale-105"),l.innerHTML='<i class="fa-solid fa-gift mr-2"></i> Claim Starter Pack',l.disabled=!1);else{const d=B(t).toFixed(2);e.classList.add("border-cyan-500"),i&&(i.innerText="💧 Need More BKC?"),o&&(o.innerText=`Balance: ${d} BKC • Get ${Cs} BKC + ${Bs} ETH`),r&&r.classList.add("hidden"),l&&(l.classList.add("bg-cyan-600","hover:bg-cyan-500","text-white","hover:scale-105"),l.innerHTML='<i class="fa-solid fa-faucet mr-2"></i> Request Tokens',l.disabled=!1)}}async function qo(){try{if(await c.provider.getBalance(c.userAddress)<Zt.parseEther("0.002")){const t=document.getElementById("no-gas-modal-dash");return t&&(t.classList.remove("hidden"),t.classList.add("flex")),!1}return!0}catch{return!0}}function Yo(){if(!se.dashboard)return;const e=v.ecosystemManager||"",t=e?`${No}${e}`:"#";se.dashboard.innerHTML=`
        <div class="flex flex-col gap-6 pb-10 max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
                ${Ko("Total Supply","fa-coins","dash-metric-supply","Total BKC tokens in circulation")}
        ...
        ${Vo()}
        ${Xo()}
    `,tr()}function $t(e,t,s,n,a="zinc"){const i={zinc:"text-zinc-400",purple:"text-purple-400",blue:"text-blue-400",orange:"text-orange-400",green:"text-green-400"},o=i[a]||i.zinc;return`
    ...
    `}function Ko(e,t,s,n,a="zinc"){const i={zinc:"text-zinc-400",purple:"text-purple-400",blue:"text-blue-400",orange:"text-orange-400",green:"text-green-400"},o=i[a]||i.zinc;return`
        <div class="glass-panel p-3 sm:p-4 group hover:border-zinc-600 transition-all cursor-default" title="${n}">
            <div class="flex items-center gap-1.5 mb-1">
                <i class="fa-solid ${t} ${o} text-xs"></i>
                <span class="text-[10px] text-zinc-500 uppercase font-bold tracking-wider truncate">${e}</span>
    ...
    `}async function Rt(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("activity-title");try{if(c.isConnected){if(E.activities.length===0){e&&(e.innerHTML=`
                        <div class="flex flex-col items-center justify-center py-8">
                            <div class="relative">
                                <div class="absolute inset-0 bg-amber-500/30 blur-xl rounded-full animate-pulse"></div>
                                <img src="./assets/bkc_logo_3d.png" class="relative w-12 h-12 object-contain animate-bounce" alt="Loading">
                    ...
                    `);const s=await fetch(`${oe.getHistory}/${c.userAddress}`);s.ok&&(E.activities=await s.json())}if(E.activities.length>0){t&&(t.textContent="Your Activity"),$s();return}}t&&(t.textContent="Network Activity"),await $n()}catch(s){console.error("Activity fetch error:",s),t&&(t.textContent="Network Activity"),await $n()}}async function $n(){const e=document.getElementById("dash-activity-list");if(!e||E.isLoadingNetworkActivity)return;const t=Date.now()-E.networkActivitiesTimestamp;if(E.networkActivities.length>0&&t<3e5){An();return}E.isLoadingNetworkActivity=!0,e.innerHTML=`
        <div class="flex flex-col items-center justify-center py-8">
            <div class="relative">
                <div class="absolute inset-0 bg-amber-500/30 blur-xl rounded-full animate-pulse"></div>
                <img src="./assets/bkc_logo_3d.png" class="relative w-12 h-12 object-contain animate-bounce" alt="Loading">
    ...
    `;try{const s=await fetch(`${Fo}?limit=30`);if(s.ok){const n=await s.json();E.networkActivities=Array.isArray(n)?n:n.activities||[],E.networkActivitiesTimestamp=Date.now()}else E.networkActivities=[]}catch(s){console.error("Network activity fetch error:",s),E.networkActivities=[]}finally{E.isLoadingNetworkActivity=!1}An()}function An(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("dash-pagination-controls");if(e){if(E.networkActivities.length===0){e.innerHTML=`
        ...
        `,t&&t.classList.add("hidden");return}e.innerHTML=E.networkActivities.slice(0,15).map(s=>wa(s,!0)).join(""),t&&t.classList.add("hidden")}}function $s(){let e=[...E.activities];const t=E.filters.type,s=n=>(n||"").toUpperCase();t!=="ALL"&&(e=e.filter(n=>{const a=s(n.type);return t==="STAKE"?a.includes("DELEGATION")||a.includes("DELEGAT")||a.includes("STAKE")||a.includes("UNSTAKE"):t==="CLAIM"?a.includes("REWARD")||a.includes("CLAIM"):t==="NFT"?a.includes("BOOSTER")||a.includes("RENT")||a.includes("NFT")||a.includes("TRANSFER"):t==="GAME"?a.includes("FORTUNE")||a.includes("GAME")||a.includes("REQUEST")||a.includes("RESULT")||a.includes("FULFILLED"):t==="NOTARY"?a.includes("NOTARY")||a.includes("NOTARIZED")||a.includes("DOCUMENT"):t==="FAUCET"?a.includes("FAUCET"):!0})),e.sort((n,a)=>{const i=o=>o.timestamp&&o.timestamp._seconds?o.timestamp._seconds:o.createdAt&&o.createdAt._seconds?o.createdAt._seconds:o.timestamp?new Date(o.timestamp).getTime()/1e3:0;return E.filters.sort==="NEWEST"?i(a)-i(n):i(n)-i(a)}),E.filteredActivities=e,E.pagination.currentPage=1,As()}function As(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("dash-pagination-controls");if(!e)return;if(E.filteredActivities.length===0){e.innerHTML=`
            <div class="flex flex-col items-center justify-center py-8 px-4">
                <div class="relative mb-4">
                    <div class="absolute inset-0 bg-amber-500/20 blur-xl rounded-full animate-pulse"></div>
        ...
        `,t&&t.classList.add("hidden");return}const s=(E.pagination.currentPage-1)*E.pagination.itemsPerPage,n=s+E.pagination.itemsPerPage,a=E.filteredActivities.slice(s,n);if(e.innerHTML=a.map(i=>wa(i,!1)).join(""),t){const i=Math.ceil(E.filteredActivities.length/E.pagination.itemsPerPage);i>1?(t.classList.remove("hidden"),document.getElementById("page-indicator").innerText=`${E.pagination.currentPage}/${i}`,document.getElementById("page-prev").disabled=E.pagination.currentPage===1,document.getElementById("page-next").disabled=E.pagination.currentPage>=i):t.classList.add("hidden")}}function wa(e,t=!1){const s=jo(e.timestamp||e.createdAt),n=Ho(e.timestamp||e.createdAt),a=e.user||e.userAddress||e.from||"",i=_o(a),o=Oo(e.type,e.details);let r="";const l=(e.type||"").toUpperCase().trim(),d=e.details||{};if(l.includes("GAMEREQUESTED")||l.includes("REQUEST")){const f=d.guesses||e.guesses;f&&Array.isArray(f)&&f.length>0&&(r=`<span class="ml-2 px-2 py-0.5 rounded text-[10px] font-bold" style="background: rgba(249,115,22,0.2); color: #f97316">🎯 ${f.join(" • ")}</span>`);const x=d.amount||d.wagerAmount;if(x){const y=B(BigInt(x)).toFixed(2);r+=`<span class="ml-1 text-[10px] text-zinc-500">(${y} BKC)</span>`}}if(l.includes("FULFILLED")||l.includes("ORACLE")){const f=d.rolls||e.rolls||d.oracleNumbers;f&&Array.isArray(f)&&f.length>0&&(r=`<span class="ml-2 px-2 py-0.5 rounded text-[11px] font-bold" style="background: linear-gradient(135deg, rgba(168,85,247,0.3), rgba(232,121,249,0.3)); color: #e879f9; border: 1px solid rgba(232,121,249,0.4)">🔮 ${f.join(" • ")}</span>`)}if(l.includes("RESULT")||l.includes("GAMERESULT")){const f=d.isWin||d.prizeWon>0,x=d.rolls||e.rolls;x&&Array.isArray(x)&&x.length>0&&(f?r=`<span class="ml-2 px-2 py-0.5 rounded text-[10px] font-bold" style="background: rgba(234,179,8,0.2); color: #facc15">🏆 ${x.join(" • ")}</span>`:r=`<span class="ml-2 text-[9px] text-zinc-500">[${x.join(", ")}]</span>`)}if(l.includes("NOTARY")){const f=d.ipfsCid;f&&(r=`<span class="ml-2 text-[9px] text-indigo-400 font-mono">${f.replace("ipfs://","").slice(0,12)+"..."}</span>`)}if(l.includes("STAKING")||l.includes("DELEGAT")){const f=d.pStakeGenerated;f&&(r=`<span class="ml-2 text-[10px] text-purple-400">+${B(BigInt(f)).toFixed(0)} pStake</span>`)}if(l.includes("CLAIM")||l.includes("REWARD")){const f=d.feePaid;f&&BigInt(f)>0n&&(r=`<span class="ml-2 text-[9px] text-zinc-500">(fee: ${B(BigInt(f)).toFixed(2)})</span>`)}const u=e.txHash?`${Po}${e.txHash}`:"#";let p=e.amount||d.amount||d.wagerAmount||d.prizeWon||"0";const m=B(BigInt(p)),g=m>.001?m.toFixed(2):"";return`
    ...
    `}function tr(){if(!se.dashboard)return;se.dashboard.addEventListener("click",async t=>{const s=t.target;if(s.closest("#manual-refresh-btn")){const i=s.closest("#manual-refresh-btn");i.disabled=!0,i.innerHTML='<i class="fa-solid fa-rotate fa-spin"></i>',await Ft(!0),await Is(),E.activities=[],E.networkActivities=[],E.networkActivitiesTimestamp=0,E.faucet.lastCheck=0,await Rt(),setTimeout(()=>{i.innerHTML='<i class="fa-solid fa-rotate"></i> <span class="hidden sm:inline">Sync</span>',i.disabled=!1},1e3)}if(s.closest("#faucet-action-btn")){const i=s.closest("#faucet-action-btn");i.disabled||await In(i)}if(s.closest("#emergency-faucet-btn")&&await In(s.closest("#emergency-faucet-btn")),s.closest(".delegate-link")&&(t.preventDefault(),window.navigateTo("mine")),s.closest(".go-to-store")&&(t.preventDefault(),window.navigateTo("store")),s.closest(".go-to-rental")&&(t.preventDefault(),window.navigateTo("rental")),s.closest(".go-to-fortune")&&(t.preventDefault(),window.navigateTo("actions")),s.closest(".go-to-notary")&&(t.preventDefault(),window.navigateTo("notary")),s.closest("#open-booster-info")){const i=document.getElementById("booster-info-modal");i&&(i.classList.remove("hidden"),i.classList.add("flex"),setTimeout(()=>{i.classList.remove("opacity-0"),i.querySelector("div").classList.remove("scale-95")},10))}if(s.closest("#close-booster-modal")||s.id==="booster-info-modal"){const i=document.getElementById("booster-info-modal");i&&(i.classList.add("opacity-0"),i.querySelector("div").classList.add("scale-95"),setTimeout(()=>i.classList.add("hidden"),200))}if(s.closest("#close-gas-modal-dash")||s.id==="no-gas-modal-dash"){const i=document.getElementById("no-gas-modal-dash");i&&(i.classList.remove("flex"),i.classList.add("hidden"))}const n=s.closest(".nft-clickable-image");if(n){const i=n.dataset.address,o=n.dataset.tokenid;i&&o&&ui(i,o)}const a=s.closest("#dashboardClaimBtn");if(a&&!a.disabled)try{if(a.innerHTML='<i class="fa-solid fa-circle-notch fa-spin"></i>',a.disabled=!0,!await qo()){a.innerHTML='<i class="fa-solid fa-gift mr-2"></i> Claim',a.disabled=!1;return}const{stakingRewards:o,minerRewards:r}=await Jt();(o>0n||r>0n)&&await Qs(o,r,null)&&(b("Rewards claimed!","success"),await Ft(!0),E.activities=[],Rt())}catch{b("Claim failed","error")}finally{a.innerHTML='<i class="fa-solid fa-gift mr-2"></i> Claim',a.disabled=!1}if(s.closest("#page-prev")&&E.pagination.currentPage>1&&(E.pagination.currentPage--,As()),s.closest("#page-next")){const i=Math.ceil(E.filteredActivities.length/E.pagination.itemsPerPage);E.pagination.currentPage<i&&(E.pagination.currentPage++,As())}s.closest("#activity-sort-toggle")&&(E.filters.sort=E.filters.sort==="NEWEST"?"OLDEST":"NEWEST",$s())});const e=document.getElementById("activity-filter-type");e&&e.addEventListener("change",t=>{E.filters.type=t.target.value,$s()})}const ya={async render(e){Yo(),Is(),Rt(),c.isConnected&&await Ft(!1)},update(e){const t=Date.now();t-E.lastUpdate>1e4&&(E.lastUpdate=t,Is(),e&&Ft(!1),Rt())}},nt=window.ethers,ut="./assets/stake.png",sr="https://sepolia.arbiscan.io/tx/";let We=!1,pt=0,Zs=3650,es=0n,ge=!1,Ls=[],_e=0n;function ka(e){if(e<=0)return"Ready";const t=Math.floor(e/86400),s=Math.floor(e%86400/3600),n=Math.floor(e%3600/60);if(t>365){const a=Math.floor(t/365),i=t%365;return`${a}y : ${i}d`}return t>0?`${t}d : ${s}h : ${n}m`:s>0?`${s}h : ${n}m`:`${n}m`}function nr(e){if(e>=365){const t=e/365;return t>=2?`${Math.floor(t)} Years`:`${t.toFixed(1)} Year`}return e>=30?`${Math.floor(e/30)} Month${e>=60?"s":""}`:`${e} Day${e>1?"s":""}`}function Ta(e,t){try{const s=BigInt(e),n=BigInt(t);return s*(n/86400n)/10n**18n}catch{return 0n}}function ar(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function ir(){if(document.getElementById("staking-styles-v4"))return;const e=document.createElement("style");e.id="staking-styles-v4",e.textContent=`
    ...
    `,document.head.appendChild(e)}function or(){const e=document.getElementById("mine");e&&(ir(),e.innerHTML=`
    ...
    `,pr(),c.isConnected?Xe(!0):en())}async function Xe(e=!1){var s;if(!c.isConnected){en();return}const t=Date.now();if(!(!e&&We)&&!(!e&&t-pt<1e4)){We=!0,pt=t;try{const n=await Ge();es=n!=null&&n.tokenId?BigInt(n.tokenId):0n;try{const a=await fetch("https://getsystemdata-4wvdcuoouq-uc.a.run.app");if(a.ok){const i=await a.json();(s=i==null?void 0:i.economy)!=null&&s.totalPStake&&(_e=BigInt(i.economy.totalPStake),console.log("📊 Network pStake from Firebase:",Fe(_e)))}}catch{console.log("Firebase system data not available, using blockchain fallback")}if(_e===0n&&(c.delegationManagerContractPublic||c.delegationManagerContract)){const a=c.delegationManagerContractPublic||c.delegationManagerContract;_e=await O(a,"totalNetworkPStake",[],0n),console.log("📊 Network pStake from blockchain (fallback)")}await Promise.all([V(!0),Gs(!0),Ks()]),lr(),Ca(),at(),rr()}catch(n){console.error("Staking load error:",n)}finally{We=!1}}}let st="ALL";async function rr(){if(c.userAddress)try{const e=oe.getHistory||"https://gethistory-4wvdcuoouq-uc.a.run.app",t=await fetch(`${e}/${c.userAddress}`);t.ok&&(Ls=(await t.json()||[]).filter(n=>{const a=(n.type||"").toUpperCase();return a.includes("DELEGAT")||a.includes("STAKE")||a.includes("UNDELEGAT")||a.includes("CLAIM")||a.includes("REWARD")||a.includes("FORCE")}),za())}catch(e){console.error("History load error:",e)}}function za(){const e=document.getElementById("staking-history-list");if(!e)return;let t=Ls;if(st!=="ALL"&&(t=Ls.filter(s=>{const n=(s.type||"").toUpperCase();switch(st){case"STAKE":return(n.includes("DELEGAT")||n.includes("STAKE"))&&!n.includes("UNSTAKE")&&!n.includes("UNDELEGAT")&&!n.includes("FORCE");case"UNSTAKE":return n.includes("UNSTAKE")||n.includes("UNDELEGAT")||n.includes("FORCE");case"CLAIM":return n.includes("CLAIM")||n.includes("REWARD");default:return!0}})),t.length===0){e.innerHTML=`
        ...
        `;return}e.innerHTML=t.slice(0,20).map(s=>{const n=(s.type||"").toUpperCase(),a=s.details||{},i=ar(s.timestamp||s.createdAt);let o,r,l,d,u="";if(n.includes("FORCE")||n.includes("UNDELEGAT")&&a.feePaid&&BigInt(a.feePaid||0)>0n){o="fa-bolt",r="#ef4444",l="rgba(239,68,68,0.15)",d="⚡ Force Unstaked";const x=a.feePaid;x&&BigInt(x)>0n&&(u=`<span class="ml-2 text-[9px] text-red-400">(penalty: ${B(BigInt(x)).toFixed(2)} BKC)</span>`)}else if(n.includes("DELEGAT")||n.includes("STAKE")&&!n.includes("UNSTAKE")){o="fa-lock",r="#4ade80",l="rgba(34,197,94,0.15)",d="🔒 Delegated";const x=a.pStakeGenerated;x&&(u=`<span class="ml-2 text-[10px] text-purple-400 font-bold">+${B(BigInt(x)).toFixed(0)} pStake</span>`);const y=a.lockDuration;if(y){const k=Number(y)/86400;u+=`<span class="ml-1 text-[9px] text-zinc-500">(${nr(k)})</span>`}}else if(n.includes("UNSTAKE")||n.includes("UNDELEGAT")){o="fa-unlock",r="#fb923c",l="rgba(249,115,22,0.15)",d="🔓 Unstaked";const x=a.amountReceived;x&&BigInt(x)>0n&&(u=`<span class="ml-2 text-[9px] text-green-400">+${B(BigInt(x)).toFixed(2)} BKC</span>`)}else if(n.includes("CLAIM")||n.includes("REWARD")){o="fa-coins",r="#fbbf24",l="rgba(245,158,11,0.15)",d="🪙 Rewards Claimed";const x=a.amountReceived,y=a.feePaid;if(x&&BigInt(x)>0n&&(u=`<span class="ml-2 text-[9px] text-green-400">+${B(BigInt(x)).toFixed(2)} BKC</span>`),y&&BigInt(y)>0n){const k=B(BigInt(y)).toFixed(2);u+=`<span class="ml-1 text-[9px] text-zinc-500">(fee: ${k})</span>`}}else o="fa-circle",r="#71717a",l="rgba(39,39,42,0.5)",d=s.type||"Activity";const p=s.txHash?`${sr}${s.txHash}`:"#";let m=s.amount||a.amount||a.amountReceived||"0";const g=B(BigInt(m)),f=g>.001?g.toFixed(2):"";return`
        ...
        `}).join("")}function lr(){var l;const e=(d,u)=>{const p=document.getElementById(d);p&&(p.textContent=u)};e("stat-network",Fe(_e||c.totalNetworkPStake||0n)),e("stat-pstake",Fe(c.userTotalPStake||0n)),e("balance-display",B(c.currentUserBalance||0n).toFixed(2));const t=c.userTotalPStake||0n,s=_e||c.totalNetworkPStake||0n;let n=0;s>0n&&t>0n&&(n=Number(t*10000n/s)/100);const a=document.getElementById("stat-pstake-percent");a&&(a.textContent=n>0?`${n.toFixed(2)}% of network`:"0% of network");const i=((l=c.systemFees)==null?void 0:l.DELEGATION_FEE_BIPS)||50n,o=Number(i)/100,r=document.getElementById("fee-info");r&&(r.textContent=`${o}% fee`),Jt().then(({stakingRewards:d,minerRewards:u})=>{const p=d+u;e("stat-rewards",B(p).toFixed(4));const m=document.getElementById("claim-btn");m&&(m.disabled=p<=0n,p>0n&&(m.onclick=()=>ur(d,u,m)))})}function en(){const e=(a,i)=>{const o=document.getElementById(a);o&&(o.textContent=i)};e("stat-network","--"),e("stat-pstake","--"),e("stat-rewards","--"),e("balance-display","0.00"),e("delegation-count","0");const t=document.getElementById("stat-pstake-percent");t&&(t.textContent="--% of network");const s=document.getElementById("delegations-list");s&&(s.innerHTML=`
        ...
        `;return}const n=[...t].sort((a,i)=>Number(a.unlockTime)-Number(i.unlockTime));e.innerHTML=n.map(a=>cr(a)).join(""),Ln(),Ne=setInterval(Ln,6e4),e.querySelectorAll(".unstake-btn").forEach(a=>{a.addEventListener("click",()=>Sn(a.dataset.index,!1))}),e.querySelectorAll(".force-unstake-btn").forEach(a=>{a.addEventListener("click",()=>{confirm(`⚠️ Force Unstake will apply a 50% penalty!

Are you sure you want to continue?`)&&Sn(a.dataset.index,!0)})})}function Ln(){const e=document.querySelectorAll(".countdown-timer"),t=Math.floor(Date.now()/1e3);e.forEach(s=>{const a=parseInt(s.dataset.unlockTime)-t;s.textContent=ka(a)})}function cr(e){const t=B(e.amount).toFixed(2),s=Fe(Ta(e.amount,e.lockDuration)),n=Number(e.unlockTime),a=Math.floor(Date.now()/1e3),i=n>a,o=i?n-a:0;return`
    ...
    `,document.head.appendChild(e)}function hr(){return`
    ...
    `}const wr={async render(e){vr(),await ea();const t=document.getElementById("store");t&&((t.innerHTML.trim()===""||e)&&(t.innerHTML=`
        ...
        `;return}e.innerHTML=C.tradeHistory.slice(0,20).map(t=>{const s=(t.type||"").toUpperCase(),n=t.details||{},a=xr(t.timestamp||t.createdAt),i=s.includes("BOUGHT")||s.includes("PURCHASED"),o=i?"fa-cart-plus":"fa-money-bill-transfer",r=i?"#22c55e":"#f59e0b",l=i?"rgba(34,197,94,0.15)":"rgba(245,158,11,0.15)",d=i?"🛒 Bought NFT":"💰 Sold NFT",u=i?"-":"+",p=t.txHash?`${br}${t.txHash}`:"#";let m="";try{let x=t.amount||n.amount||n.price||n.payout||"0";if(typeof x=="string"&&x!=="0"){const y=B(BigInt(x));y>.001&&(m=y.toFixed(2))}}catch{}const g=n.tokenId||"",f=n.boostBips||n.boost||"";return`
        ...
        `}).join("")}}function yr(){return ee.map((e,t)=>{const s=ts(e.name);return`
    ...
    `}function kr(e,t,s,n,a=!1){return c.isConnected?e?t?`
        ...
        `}function Tr(e){const t=document.getElementById("trade-mascot");t&&(t.className=`w-14 h-14 object-contain ${e?"trade-buy":"trade-sell"}`)}function zr(){const e=document.getElementById("inventory-grid"),t=document.getElementById("nft-count");if(!e)return;const s=c.myBoosters||[];if(t&&(t.textContent=s.length),!c.isConnected){e.innerHTML='<div class="col-span-4 text-center py-4 text-xs text-zinc-600">Connect wallet</div>';return}if(s.length===0){e.innerHTML=`
        ...
        `;return}const n=c.rentalListings||[],a=new Set(n.map(o=>{var r;return(r=o.tokenId)==null?void 0:r.toString()})),i=Math.floor(Date.now()/1e3);e.innerHTML=s.map(o=>{var k;const r=ee.find($=>$.boostBips===Number(o.boostBips)),l=ts(r==null?void 0:r.name),d=Dt(o.image||(r==null?void 0:r.img)),u=C.firstAvailableTokenId&&BigInt(o.tokenId)===C.firstAvailableTokenId,p=(k=o.tokenId)==null?void 0:k.toString(),m=a.has(p),g=n.find($=>{var L;return((L=$.tokenId)==null?void 0:L.toString())===p}),f=g&&g.rentalEndTime&&Number(g.rentalEndTime)>i,x=m||f;let y="";return f?y='<span class="absolute top-1 right-1 bg-blue-500 text-white text-[7px] px-1.5 py-0.5 rounded-full font-bold">🔑 RENTED</span>':m&&(y='<span class="absolute top-1 right-1 bg-green-500 text-white text-[7px] px-1.5 py-0.5 rounded-full font-bold">📋 LISTED</span>'),`
        ...
        `}).join("")}async function Pe(){var s,n;if(C.isDataLoading||C.selectedPoolBoostBips===null)return;const e=Date.now();if(e-C.lastFetchTimestamp<2e3)return;C.isDataLoading=!0,C.lastFetchTimestamp=e;const t=C.selectedPoolBoostBips;try{const a=await Ge();C.bestBoosterTokenId=a!=null&&a.tokenId?BigInt(a.tokenId):0n,C.bestBoosterBips=(a==null?void 0:a.boostBips)||0,await Promise.all([Qt(!0),gt()]);const i=c.rentalListings||[],o=new Set(i.map(S=>{var X;return(X=S.tokenId)==null?void 0:X.toString()})),r=Math.floor(Date.now()/1e3),d=(c.myBoosters||[]).filter(S=>Number(S.boostBips)===t),u=d.filter(S=>{var zt;const X=(zt=S.tokenId)==null?void 0:zt.toString(),le=i.find(as=>{var dn;return((dn=as.tokenId)==null?void 0:dn.toString())===X}),K=o.has(X),Tt=le&&le.rentalEndTime&&Number(le.rentalEndTime)>r;return!K&&!Tt});C.userBalanceOfSelectedNFT=d.length,C.availableToSellCount=u.length;const p=C.firstAvailableTokenId;p&&u.some(S=>BigInt(S.tokenId)===p)||(C.firstAvailableTokenId=u.length>0?BigInt(u[0].tokenId):null);const g=ee.find(S=>S.boostBips===t);if(!g){console.warn("Tier not found for boostBips:",t);return}const f=`pool_${g.name.toLowerCase()}`;let x=v[f];if(!x){const S=v.nftLiquidityPoolFactory;if(S&&c.publicProvider)try{x=await new $e.Contract(S,gr,c.publicProvider).getPoolAddress(t),x&&x!==$e.ZeroAddress&&Ea.set(t,x)}catch(X){console.warn("Factory lookup failed:",X.message)}}if(!x||x===$e.ZeroAddress){const S=document.getElementById("swap-interface");S&&(S.innerHTML=`
                ...
                `);return}const y=new $e.Contract(x,Us,c.publicProvider);let k=$e.MaxUint256,$=0n,L=[],A=((s=c.systemFees)==null?void 0:s.NFT_POOL_SELL_TAX_BIPS)||1000n,I=BigInt(((n=c.boosterDiscounts)==null?void 0:n[C.bestBoosterBips])||0);try{k=await O(y,"getBuyPrice",[],$e.MaxUint256)}catch(S){console.warn("getBuyPrice failed:",S.message)}try{$=await O(y,"getSellPrice",[],0n)}catch(S){console.warn("getSellPrice failed:",S.message)}try{const S=await y.getAvailableNFTs();L=Array.isArray(S)?[...S]:[]}catch(S){console.warn("getAvailableNFTs failed:",S.message),L=[]}C.poolNFTCount=L.length,C.firstAvailableTokenIdForBuy=L.length>0?BigInt(L[L.length-1]):null,C.buyPrice=k===$e.MaxUint256?0n:k,C.sellPrice=$;const T=typeof A=="bigint"?A:BigInt(A),F=typeof I=="bigint"?I:BigInt(I),q=T>F?T-F:0n,re=$*q/10000n;C.netSellPrice=$-re}catch(a){console.warn("Store Data Warning:",a.message);const i=document.getElementById("swap-interface");i&&(i.innerHTML=`
                <div class="text-center py-12">
                    <div class="w-12 h-12 bg-zinc-800 rounded-full flex items-center justify-center mx-auto mb-3">
    ...
    `,document.head.appendChild(e)}const tn={async render(e){Er();const t=document.getElementById("rewards");t&&((t.innerHTML.trim()===""||e)&&(t.innerHTML=Lr()),c.isConnected?(Sr(),this.update(e)):Rn())},async update(e=!1){if(!c.isConnected){Rn();return}const t=Date.now();if(!(!e&&fs)&&!(!e&&t-Ss<6e4)){fs=!0,it("loading");try{let s={highestBoost:0,boostName:"None",tokenId:null,source:"none"},n={netClaimAmount:0n,feeAmount:0n,totalRewards:0n},a={stakingRewards:0n,minerRewards:0n};try{await V()}catch{}try{s=await Ge()||s}catch{}try{n=await sa()||n}catch{}try{a=await Jt()||a}catch{}try{await Ir()}catch{}Aa(n,a,s),Ss=t,it("idle")}catch(s){console.error("Rewards Error:",s)}finally{fs=!1}}}};function it(e){const t=document.getElementById("reward-mascot");if(t)switch(t.className="w-12 h-12 object-contain",e){case"loading":t.classList.add("reward-spin");break;case"claiming":t.classList.add("reward-bounce");break;case"success":t.classList.add("reward-success");break;default:t.classList.add("reward-float","reward-pulse")}}async function Ir(){if(c.userAddress)try{const e=await fetch(`${oe.getHistory}/${c.userAddress}`);e.ok&&(Ye=(await e.json()).filter(s=>{const n=(s.type||"").toUpperCase();return n.includes("REWARD")||n.includes("CLAIM")}).slice(0,15))}catch{Ye=[]}}function $r(){return Ye.length===0?`
        ...
        `:Ye.map(e=>{const t=Ar(e.timestamp||e.createdAt),s=e.details||{},n=e.txHash||"",a=n?`${Br}${n}`:"#";let i="0",o="0";s.amountReceived?i=s.amountReceived:e.amount?i=e.amount:s.amount&&(i=s.amount),s.feePaid?o=s.feePaid:s.feeAmount&&(o=s.feeAmount);const r=Fn(i),l=Fn(o);let d,u,p,m;const g=(e.type||"").toUpperCase();return g.includes("STAKING")||g.includes("DELEGAT")?(d="fa-lock",u="#a855f7",p="rgba(168,85,247,0.15)",m="🔒 Staking Reward"):g.includes("MINING")||g.includes("MINER")?(d="fa-hammer",u="#f97316",p="rgba(249,115,22,0.15)",m="⛏️ Mining Reward"):g.includes("CLAIM")||g.includes("REWARD")?(d="fa-gift",u="#22c55e",p="rgba(34,197,94,0.15)",m="🎁 Claimed"):(d="fa-coins",u="#eab308",p="rgba(234,179,8,0.15)",m="💰 Reward"),`
            <a href="${a}" target="_blank" rel="noopener" 
               class="history-item flex items-center justify-between p-3 bg-zinc-800/30 hover:bg-zinc-800/50 rounded-xl transition-all group border border-zinc-700/30">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-sm text-white font-medium">${m}</p>
        ...
        `}).join("")}function Ar(e){if(!e)return"Unknown date";try{let t;if(e.seconds||e._seconds){const a=e.seconds||e._seconds;t=new Date(a*1e3)}else if(typeof e=="string")t=new Date(e);else if(typeof e=="number")t=new Date(e<1e10?e*1e3:e);else if(e instanceof Date)t=e;else return"Unknown date";if(isNaN(t.getTime()))return"Unknown date";const n=new Date-t;return n<6e4?"Just now":n<36e5?`${Math.floor(n/6e4)}m ago`:n<864e5?`${Math.floor(n/36e5)}h ago`:n<6048e5?`${Math.floor(n/864e5)}d ago`:t.toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})}catch(t){return console.warn("Date parse error:",t),"Unknown date"}}function Fn(e){if(!e)return"0.00";try{if(typeof e=="string"){if(e.length>10&&!e.includes(".")){const t=ps.formatEther(BigInt(e));return parseFloat(t).toFixed(4)}return parseFloat(e).toFixed(4)}if(typeof e=="bigint"){const t=ps.formatEther(e);return parseFloat(t).toFixed(4)}if(typeof e=="number"&&e>1e10){const t=ps.formatEther(BigInt(Math.floor(e)));return parseFloat(t).toFixed(4)}return parseFloat(e).toFixed(4)}catch(t){return console.warn("Amount format error:",t),"0.00"}}function Lr(){return`
    ...
    `)}function Sr(){Aa({netClaimAmount:0n,feeAmount:0n,totalRewards:0n},{stakingRewards:0n,minerRewards:0n},{highestBoost:0,boostName:"None",tokenId:null,source:"none"})}function Aa(e,t,s){const n=document.getElementById("rewards-content");if(!n)return;const a=e||{},i=t||{},o=s||{},r=a.netClaimAmount||0n,l=a.totalRewards||0n,d=a.feeAmount||0n,u=i.stakingRewards||0n,p=i.minerRewards||0n,m=o.highestBoost||0,g=a.baseFeeBips||5e3,f=m/100,y=100-(a.finalFeeBips||g-g*m/1e4)/100,k=r>0n,$=m>0,L=BigInt(o.tokenId||0);Pt={stakingRewards:u,minerRewards:p,boosterTokenId:L};let A=0,I=0,T=0,F=0,q=0;try{A=B?B(r):Number(r)/1e18,I=B?B(l):Number(l)/1e18,T=B?B(d):Number(d)/1e18,F=B?B(u):Number(u)/1e18,q=B?B(p):Number(p)/1e18}catch{}const re=2*Math.PI*45,S=re-y/100*re;n.innerHTML=`
        <div class="space-y-4">
            <!-- MAIN CLAIM CARD -->
                ...
                <div class="flex flex-col items-center mb-5">
                    <div class="relative w-32 h-32 mb-3">
                        <svg class="w-full h-full" style="transform: rotate(-90deg)" viewBox="0 0 100 100">
                            ...
                            <circle cx="50" cy="50" r="45" fill="none" stroke="${$?"#4ade80":"#f59e0b"}" stroke-width="6" stroke-linecap="round" stroke-dasharray="${re}" stroke-dashoffset="${S}"/>
                        </svg>
                    ...
                    <p class="text-xs text-zinc-500">You keep <span class="${$?"text-green-400":"text-amber-400"} font-bold">${y.toFixed(1)}%</span> of earnings</p>
                </div>
            ...
            <div class="bg-zinc-900/50 border border-zinc-800 rounded-xl overflow-hidden">
                <div class="p-3 border-b border-zinc-800/50 flex items-center justify-between">
                    ...
                    ${$?'<span class="px-2 py-0.5 bg-green-500/20 text-green-400 text-[10px] font-bold rounded-full">ACTIVE</span>':'<span class="px-2 py-0.5 bg-zinc-700 text-zinc-400 text-[10px] font-bold rounded-full">NONE</span>'}
                </div>
                <div class="p-4">
                    ${$?`
                        <div class="flex items-center gap-3">
                            ...
                            <div class="text-right"><p class="text-xl font-bold text-green-400">+${f}%</p><p class="text-[10px] text-zinc-500">Discount</p></div>
                        </div>
                    `:`
                        <div class="text-center">
...
#Backcoin #Web3 #Arbitrum`}},ms={pt:"./assets/pt.png",en:"./assets/en.png",es:"./assets/es.png"};let he="en";const Q=[{id:1,name:"Easy",emoji:"🍀",range:3,multiplier:200,chance:"33%",color:"emerald",hex:"#10b981",bgFrom:"from-emerald-500/20",bgTo:"to-green-600/10",borderColor:"border-emerald-500/50",textColor:"text-emerald-400"},{id:2,name:"Medium",emoji:"⚡",range:10,multiplier:500,chance:"10%",color:"violet",hex:"#8b5cf6",bgFrom:"from-violet-500/20",bgTo:"to-purple-600/10",borderColor:"border-violet-500/50",textColor:"text-violet-400"},{id:3,name:"Hard",emoji:"👑",range:100,multiplier:5e3,chance:"1%",color:"amber",hex:"#f59e0b",bgFrom:"from-amber-500/20",bgTo:"to-orange-600/10",borderColor:"border-amber-500/50",textColor:"text-amber-400"}],Sa=5700,w={mode:null,phase:"select",guess:50,guesses:[2,5,50],comboStep:0,wager:10,gameId:null,result:null,txHash:null,poolStatus:null,history:[],serviceFee:0n,serviceFee1x:0n,serviceFee5x:0n,tiersData:null};function Rr(){if(document.getElementById("fortune-styles-v2"))return;const e=document.createElement("style");e.id="fortune-styles-v2",e.textContent=`
        ...
        <div class="max-w-md mx-auto px-4 py-6">
            ...
            <div class="text-center mb-6">
                ...
                <div class="flex items-center justify-center gap-2 mt-3 flex-wrap">
                    <a href="${Ps}${La}" target="_blank" rel="noopener" 
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center gap-3 mb-1">
                            ...
                            <span class="px-2.5 py-1 rounded-full bg-violet-500/20 border border-violet-500/40 text-violet-400 text-sm font-black">${Sa}x</span>
                        </div>
    ...
    `,(a=document.getElementById("btn-jackpot"))==null||a.addEventListener("click",()=>{if(!c.isConnected)return b("Connect wallet first","warning");w.mode="jackpot",w.guess=50,w.phase="pick",G()}),(i=document.getElementById("btn-combo"))==null||i.addEventListener("click",()=>{if(!c.isConnected)return b("Connect wallet first","warning");w.mode="combo",w.guesses=[2,5,50],w.comboStep=0,w.phase="pick",G()})}function _r(e){w.mode==="jackpot"?Ur(e):Or(e)}function Ur(e){var r,l,d,u,p,m,g;const t=Q[2],s=w.guess;e.innerHTML=`
            ...
            <div class="flex items-center justify-center gap-4 mb-4">
                ...
                <div class="relative">
                    <input type="number" id="number-input" min="1" max="100" value="${s}" 
                        class="w-24 h-24 text-center text-4xl font-black rounded-2xl bg-gradient-to-br ${t.bgFrom} ${t.bgTo} border-2 ${t.borderColor} ${t.textColor} focus:outline-none focus:ring-2 focus:ring-amber-500/50 appearance-none"
    ...
    `;const n=document.getElementById("number-input"),a=document.getElementById("number-slider"),i=Q[2],o=f=>{f=Math.max(1,Math.min(100,f)),w.guess=f,n&&(n.value=f),a&&(a.value=f,a.style.background=`linear-gradient(to right, ${i.hex} 0%, ${i.hex} ${f}%, #27272a ${f}%, #27272a 100%)`)};n==null||n.addEventListener("input",f=>{let x=parseInt(f.target.value)||1;o(x)}),n==null||n.addEventListener("blur",f=>{let x=parseInt(f.target.value)||1;o(x)}),a==null||a.addEventListener("input",f=>{o(parseInt(f.target.value))}),(r=document.getElementById("btn-minus"))==null||r.addEventListener("click",()=>o(w.guess-1)),(l=document.getElementById("btn-plus"))==null||l.addEventListener("click",()=>o(w.guess+1)),(d=document.getElementById("btn-minus-10"))==null||d.addEventListener("click",()=>o(w.guess-10)),(u=document.getElementById("btn-plus-10"))==null||u.addEventListener("click",()=>o(w.guess+10)),document.querySelectorAll(".quick-pick").forEach(f=>{f.addEventListener("click",()=>o(parseInt(f.dataset.number)))}),(p=document.getElementById("btn-random"))==null||p.addEventListener("click",()=>{o(Math.floor(Math.random()*100)+1)}),(m=document.getElementById("btn-back"))==null||m.addEventListener("click",()=>{w.phase="select",G()}),(g=document.getElementById("btn-next"))==null||g.addEventListener("click",()=>{w.phase="wager",G()})}function Or(e){var n,a;const t=Q[w.comboStep],s=w.guesses[w.comboStep];e.innerHTML=`
        <div class="bg-gradient-to-br from-zinc-900 to-zinc-800/50 border border-zinc-700/50 rounded-2xl p-5">
            <!-- Progress Pills -->
    ...
    `,qr(n,a)}function qr(e,t){var n,a,i,o;const s=r=>{w.wager=Math.max(1,Math.min(Math.floor(r),Math.floor(t)));const l=document.getElementById("custom-wager"),d=document.getElementById("potential-win");l&&(l.value=w.wager),d&&(d.textContent=(w.wager*e).toLocaleString()),document.querySelectorAll(".percent-btn").forEach(u=>{const p=parseInt(u.dataset.value),m=w.wager===p;u.classList.toggle("bg-amber-500/20",m),u.classList.toggle("border-amber-500/50",m),u.classList.toggle("text-amber-400",m),u.classList.toggle("border-zinc-700/50",!m),u.classList.toggle("bg-zinc-800/60",!m),u.classList.toggle("text-zinc-400",!m)})};document.querySelectorAll(".percent-btn").forEach(r=>{r.addEventListener("click",()=>{s(parseInt(r.dataset.value)||1)})}),(n=document.getElementById("custom-wager"))==null||n.addEventListener("input",r=>{s(parseInt(r.target.value)||1)}),(a=document.getElementById("btn-faucet"))==null||a.addEventListener("click",async()=>{b("Requesting tokens...","info");try{const l=await(await fetch(`https://faucet-4wvdcuoouq-uc.a.run.app?address=${c.userAddress}`)).json();l.success?(b("🎉 Tokens received!","success"),await V(),G()):b(l.error||"Error","error")}catch{b("Faucet error","error")}}),(i=document.getElementById("btn-back"))==null||i.addEventListener("click",()=>{w.phase="pick",w.mode==="combo"&&(w.comboStep=2),G()}),(o=document.getElementById("btn-play"))==null||o.addEventListener("click",async()=>{if(w.wager<1)return b("Min: 1 BKC","warning");w.phase="processing",G();try{const r=w.mode==="jackpot"?[w.guess]:w.guesses,l=w.mode==="combo",d=await So(w.wager,r,l);d!=null&&d.success?(w.gameId=d.gameId,w.txHash=d.txHash,w.result={rolls:d.rolls,prizeWon:d.prizeWon,matches:d.matches||[]},setTimeout(()=>{w.phase="result",G(),sn()},1500)):(b((d==null?void 0:d.error)||"Transaction failed","error"),w.phase="wager",G())}catch(r){console.error("Play error:",r),b("Error: "+r.message,"error"),w.phase="wager",G()}})}function Yr(e){const t=w.mode==="jackpot",s=t?[w.guess]:w.guesses,n=t?[Q[2]]:Q;e.innerHTML=`
    ...
    `,n.forEach((a,i)=>{const o=document.getElementById(`spin-${i}`);if(!o)return;setInterval(()=>{o.textContent=Math.floor(Math.random()*a.range)+1},80)})}function Kr(e){var u,p;const t=w.result;if(!t)return G();const s=w.mode==="jackpot",n=s?[w.guess]:w.guesses,a=t.rolls||[],i=s?[Q[2]]:Q,o=n.map((m,g)=>{const f=a[g]!==void 0?Number(a[g]):null;return f!==null&&f===m}),r=o.filter(m=>m).length,l=t.prizeWon>0||r>0;let d=t.prizeWon;!d&&r>0&&(d=0,o.forEach((m,g)=>{if(m){const f=s?Q[2]:Q[g];d+=w.wager*f.multiplier}})),e.innerHTML=`
        <div class="bg-gradient-to-br ${l?"from-emerald-900/30 to-green-900/10 border-emerald-500/30":"from-zinc-900 to-zinc-800/50 border-zinc-700/50"} border rounded-2xl p-6 relative overflow-hidden" id="result-container">
            ...
            <div class="grid ${s?"grid-cols-1":"grid-cols-3"} gap-4 mb-6">
                ${i.map((m,g)=>{const f=s?n[0]:n[g],x=a[g],y=o[g];return`
                        <div class="text-center p-4 rounded-xl ${y?"bg-emerald-500/20 border border-emerald-500/50":"bg-zinc-800/50 border border-zinc-700/50"}">
                            <p class="text-xs text-zinc-500 mb-2">${m.emoji} ${m.name}</p>
                            <div class="flex items-center justify-center gap-3">
                                <div class="text-center">
                                    <p class="text-[10px] text-zinc-600 mb-1">YOU</p>
                                    <div class="w-12 h-12 rounded-lg bg-gradient-to-br ${m.bgFrom} ${m.bgTo} border ${m.borderColor} flex items-center justify-center">
                                        <span class="text-xl font-black ${m.textColor}">${f}</span>
                                    </div>
                                </div>
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="w-12 h-12 rounded-lg ${y?"bg-emerald-500/30 border-emerald-500":"bg-zinc-700/50 border-zinc-600"} border flex items-center justify-center ${y?"match-pulse":"miss-shake"}">
                                        <span class="text-xl font-black ${y?"text-emerald-400":"text-zinc-300"}">${x}</span>
                                    </div>
                                </div>
                            </div>
                            ${y?`<p class="text-emerald-400 text-sm font-bold mt-2">+${m.multiplier}x WIN!</p>`:""}
                        </div>
                    `}).join("")}
            </div>
            ...
            ${w.txHash?`
                <div class="text-center mb-4">
                    <a href="${Nr}${w.txHash}" target="_blank" class="inline-flex items-center gap-2 text-xs text-zinc-500 hover:text-zinc-400">
                        <i class="fa-solid fa-external-link"></i>
                        View Transaction
                    </a>
                </div>
    ...
    `,l&&(Gr(),d>w.wager*10&&Vr()),(u=document.getElementById("btn-new-game"))==null||u.addEventListener("click",()=>{w.phase="select",w.result=null,w.txHash=null,w.gameId=null,G(),sn()}),(p=document.getElementById("btn-share"))==null||p.addEventListener("click",()=>{Xr(l,d)})}function Gr(){const e=document.createElement("div");e.className="confetti-container",document.body.appendChild(e);const t=["#f59e0b","#10b981","#8b5cf6","#ec4899","#06b6d4"],s=["●","■","★","🐯","🎉"];for(let n=0;n<60;n++){const a=document.createElement("div");a.className="confetti",a.style.cssText=`
            left: ${Math.random()*100}%;
            color: ${t[n%t.length]};
            font-size: ${8+Math.random()*12}px;
            animation-delay: ${Math.random()*2}s;
            animation-duration: ${2+Math.random()*2}s;
        `,a.textContent=s[n%s.length],e.appendChild(a)}setTimeout(()=>e.remove(),5e3)}function Vr(){const e=["🪙","💰","✨","⭐","🎉"];for(let t=0;t<30;t++)setTimeout(()=>{const s=document.createElement("div");s.className="coin",s.textContent=e[Math.floor(Math.random()*e.length)],s.style.left=`${Math.random()*100}%`,s.style.animationDelay=`${Math.random()*.5}s`,s.style.animationDuration=`${2+Math.random()*2}s`,document.body.appendChild(s),setTimeout(()=>s.remove(),4e3)},t*100)}function Xr(e,t){var l,d,u,p,m,g;const s=Dn[he],n=()=>{const f=Fr[he];return e?f.win(t):f.lose},a=`
        <div class="text-center">
    ...
    `;Kt(a,"max-w-xs");const i=f=>{he=f;const x=Dn[f],y=document.getElementById("share-modal-title"),k=document.getElementById("share-modal-subtitle"),$=document.getElementById("btn-close-share");y&&(y.textContent=x.title),k&&(k.textContent=x.subtitle),$&&($.textContent=x.later),document.querySelectorAll(".lang-btn").forEach(L=>{const A=L.dataset.lang,I=L.querySelector("span");A===f?(L.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-amber-500/20 border-amber-500 ring-1 ring-amber-500/50 border",I&&(I.className="text-amber-400")):(L.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-zinc-800 border-zinc-700 hover:border-zinc-500 border",I&&(I.className="text-zinc-400"))})};document.querySelectorAll(".lang-btn").forEach(f=>{f.addEventListener("click",()=>i(f.dataset.lang))});const o=async f=>{if(!c.userAddress)return!1;try{const y=await(await fetch("https://us-central1-backchain-backand.cloudfunctions.net/trackShare",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({address:c.userAddress,gameId:w.gameId||Date.now(),type:"fortune",platform:f})})).json();return y.success?(b(`🎉 +${y.pointsAwarded||Ns} Airdrop Points!`,"success"),!0):(y.reason==="already_shared"&&console.log("Already shared this game"),!1)}catch(x){return console.error("Share tracking error:",x),b(`🎉 +${Ns} Airdrop Points!`,"success"),!0}},r=async(f,x)=>{await o(f),window.open(x,"_blank"),be()};(l=document.getElementById("share-twitter"))==null||l.addEventListener("click",()=>{const f=n();r("twitter",`https://twitter.com/intent/tweet?text=${encodeURIComponent(f)}`)}),(d=document.getElementById("share-telegram"))==null||d.addEventListener("click",()=>{const f=n();r("telegram",`https://t.me/share/url?url=https://backcoin.org&text=${encodeURIComponent(f)}`)}),(u=document.getElementById("share-whatsapp"))==null||u.addEventListener("click",()=>{const f=n();r("whatsapp",`https://wa.me/?text=${encodeURIComponent(f)}`)}),(p=document.getElementById("share-instagram"))==null||p.addEventListener("click",async()=>{const f=n();try{await navigator.clipboard.writeText(f),b("📋 Text copied! Opening Instagram...","success"),await o("instagram")}catch{}window.open("https://www.instagram.com/backcoin.bkc/","_blank"),be()}),(m=document.getElementById("share-copy"))==null||m.addEventListener("click",async()=>{const f=n();try{await navigator.clipboard.writeText(f),b("📋 Copied!","success"),await o("copy")}catch{b("Copy failed","error")}be()}),(g=document.getElementById("btn-close-share"))==null||g.addEventListener("click",be)}async function Jr(){const e=c.fortunePoolContract||c.fortunePoolContractPublic;if(!e)return console.log("No fortune contract available"),null;try{const[t,s,n,a,i,o]=await Promise.all([e.prizePoolBalance().catch(()=>0n),e.gameCounter().catch(()=>0),e.serviceFee().catch(()=>0n),e.getRequiredServiceFee(!1).catch(()=>0n),e.getRequiredServiceFee(!0).catch(()=>0n),e.activeTierCount().catch(()=>3)]);w.serviceFee=n||0n,w.serviceFee1x=a||0n,w.serviceFee5x=i||0n;try{const[r,l]=await e.getAllTiers();w.tiersData=r.map((d,u)=>({range:Number(d),multiplier:Number(l[u])/1e4})),console.log("Tiers from contract:",w.tiersData)}catch{console.log("Using default tiers")}return{prizePool:t||0n,gameCounter:Number(s)||0,serviceFee:n||0n,serviceFee1x:a||0n,serviceFee5x:i||0n,tierCount:Number(o)||3}}catch(t){return console.error("getFortunePoolStatus error:",t),{prizePool:0n,gameCounter:0,serviceFee:0n}}}async function sn(){try{const e=await Jr();if(e){const s=document.getElementById("prize-pool"),n=document.getElementById("total-games");s&&(s.textContent=B(e.prizePool||0n).toFixed(2)+" BKC"),n&&(n.textContent=(e.gameCounter||0).toLocaleString())}const t=document.getElementById("user-balance");t&&(t.textContent=B(c.currentUserBalance||0n).toFixed(2)+" BKC"),Qr()}catch(e){console.error("Pool error:",e)}}async function Qr(){var e;try{const t=oe.fortuneGames||"https://getfortunegames-4wvdcuoouq-uc.a.run.app",s=c.userAddress?`${t}?player=${c.userAddress}&limit=15`:`${t}?limit=15`,a=await(await fetch(s)).json();if(((e=a.games)==null?void 0:e.length)>0){Zr(a.games);const i=a.games.filter(r=>r.isWin||r.prizeWon&&BigInt(r.prizeWon)>0n).length,o=document.getElementById("win-rate");o&&(o.textContent=`🏆 ${i}/${a.games.length} wins`)}else{const i=document.getElementById("history-list");i&&(i.innerHTML=`
            ...
            <div class="p-3 rounded-xl mb-2 ${n?"bg-emerald-500/10 border border-emerald-500/30":"bg-zinc-800/30 border border-zinc-700/30"} transition-all hover:scale-[1.01]">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex gap-1">
                        ${(o?Q:[Q[2]]).map((g,f)=>{const x=l[f],y=r[f];return`
                                <div class="w-6 h-6 rounded text-[10px] font-bold flex items-center justify-center ${x!==void 0&&y!==void 0&&Number(x)===Number(y)?"bg-emerald-500/30 text-emerald-400":"bg-zinc-700/50 text-zinc-500"}">
                                    ${y??"?"}
                                </div>
                            `}).join("")}
                    </div>
    ...
    `,document.head.appendChild(e)}async function Je(){var e;z.isConnected=c.isConnected,z.user=null,z.userSubmissions=[],z.platformUsage={},z.isBanned=!1;try{const t=await Vs();if(z.systemConfig=t.config,z.leaderboards=t.leaderboards,z.dailyTasks=t.dailyTasks||[],z.platformUsageConfig=t.platformUsageConfig||Na,z.isConnected&&c.userAddress){const[s,n]=await Promise.all([tt(c.userAddress),Ri()]);if(z.user=s,z.userSubmissions=n,s&&s.isBanned){z.isBanned=!0;return}try{typeof kn=="function"&&(z.platformUsage=await kn()||{})}catch(a){console.warn("Could not load platform usage:",a),z.platformUsage={}}z.dailyTasks.length>0&&(z.dailyTasks=await Promise.all(z.dailyTasks.map(async a=>{try{if(!a.id)return{...a,eligible:!1,timeLeftMs:0};const i=await ia(a.id,a.cooldownHours);return{...a,eligible:i.eligible,timeLeftMs:i.timeLeft}}catch{return{...a,eligible:!1,timeLeftMs:0}}})))}}catch(t){if(console.error("Airdrop Data Load Error:",t),t.code==="permission-denied"||(e=t.message)!=null&&e.includes("permission")){console.warn("Firebase permissions issue - user may need to connect wallet or sign in"),z.systemConfig=z.systemConfig||{},z.leaderboards=z.leaderboards||{top100ByPoints:[],top100ByPosts:[]},z.dailyTasks=z.dailyTasks||[];return}b("Error loading data. Please refresh.","error")}}function Ma(){const{user:e}=z,t=(e==null?void 0:e.totalPoints)||0,s=(e==null?void 0:e.platformUsagePoints)||0,n=(e==null?void 0:e.approvedSubmissionsCount)||0,a=gl(n);return`
        <!-- Mobile Header -->
    ...
    `}function hl(){var o;const e=z.platformUsageConfig||Na,t=z.platformUsage||{};let s=0,n=0;Object.keys(e).forEach(r=>{var l;e[r].enabled!==!1&&e[r].maxCount&&(s+=e[r].maxCount,n+=Math.min(((l=t[r])==null?void 0:l.count)||0,e[r].maxCount))});const a=s>0?n/s*100:0,i=((o=z.user)==null?void 0:o.platformUsagePoints)||0;return`
        <div class="space-y-4">
            <!-- Info Banner -->
            ...
            <div class="grid grid-cols-2 gap-2" id="platform-actions-grid">
                ${Object.entries(e).filter(([r,l])=>l.enabled!==!1).map(([r,l])=>{const d=t[r]||{count:0},u=d.count>=l.maxCount,p=Math.max(0,l.maxCount-d.count),m=d.count/l.maxCount*100,g=fl[r]||"";return`
    ...
    `}function yl(){const{user:e,userSubmissions:t}=z;if(!z.isConnected)return`
        ...
        `;const s=Date.now(),n=Pa*60*60*1e3,a=t.filter(l=>["pending","auditing"].includes(l.status)&&l.submittedAt&&s-l.submittedAt.getTime()>=n),i=(e==null?void 0:e.approvedSubmissionsCount)||0,o=t.filter(l=>["pending","auditing"].includes(l.status)).length,r=t.filter(l=>l.status==="rejected").length;return`
    ...
    `}function kl(){var u,p;const e=((u=z.leaderboards)==null?void 0:u.top100ByPosts)||[],t=((p=z.leaderboards)==null?void 0:p.top100ByPoints)||[],s=z.activeRanking||"posts";function n(m,g,f){var I,T;const x=z.user&&((I=m.walletAddress)==null?void 0:I.toLowerCase())===((T=z.user.walletAddress)==null?void 0:T.toLowerCase()),y=Tl(g+1),k=f==="posts"?"bg-amber-500/10":"bg-green-500/10",$=f==="posts"?"text-amber-400":"text-green-400",L=f==="posts"?"text-white":"text-green-400",A=f==="posts"?"posts":"pts";return`
    ...
    `}function Tl(e){return e<=2?{icon:"💎",bg:"bg-cyan-500/20 text-cyan-300"}:e<=10?{icon:"🏆",bg:"bg-slate-400/20 text-slate-300"}:e<=20?{icon:"🥇",bg:"bg-yellow-500/20 text-yellow-400"}:e<=50?{icon:"🥈",bg:"bg-gray-400/20 text-gray-300"}:e<=150?{icon:"🥉",bg:"bg-amber-700/20 text-amber-600"}:e<=300?{icon:"⚔️",bg:"bg-zinc-600/20 text-zinc-400"}:{icon:null,bg:"bg-zinc-800 text-zinc-400"}}function fe(){const e=document.getElementById("main-content"),t=document.getElementById("airdrop-header");if(e){if(t&&(t.innerHTML=Ma()),z.isBanned){e.innerHTML=`
    ...
    `;Kt(t,"max-w-md"),(a=document.getElementById("deletePostBtn"))==null||a.addEventListener("click",async i=>{const o=i.currentTarget,r=o.dataset.submissionId;o.disabled=!0,o.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-1"></i> Deleting...';try{await oa(r),b("Post deleted. No penalty applied.","info"),be(),await Je(),fe()}catch(l){b(l.message,"error"),o.disabled=!1,o.innerHTML='<i class="fa-solid fa-trash mr-1"></i> Delete Post'}});const s=document.getElementById("confirmCheckbox"),n=document.getElementById("finalConfirmBtn");s==null||s.addEventListener("change",()=>{s.checked?(n.disabled=!1,n.className="flex-1 bg-green-600 hover:bg-green-500 text-white py-3 rounded-xl font-bold text-sm transition-colors cursor-pointer",n.innerHTML='<i class="fa-solid fa-check mr-1"></i> Confirm & Earn ✓'):(n.disabled=!0,n.className="flex-1 bg-green-600/50 text-green-200 py-3 rounded-xl font-bold text-sm cursor-not-allowed transition-colors",n.innerHTML='<i class="fa-solid fa-lock mr-1"></i> Confirm & Earn')}),n==null||n.addEventListener("click",Il)}async function Il(e){const t=e.currentTarget,s=t.dataset.submissionId;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-2"></i> Verifying...';try{await Di(s),b("Success! Points added.","success"),be(),await Je(),fe()}catch{b("Verification failed.","error"),t.disabled=!1,t.innerHTML="Try Again"}}async function $l(e){const t=e.target.closest(".action-btn");if(!t)return;const s=t.dataset.action,n=t.dataset.id;if(s==="confirm"){const a=z.userSubmissions.find(i=>i.submissionId===n);a&&Fa(a)}else if(s==="delete"){if(!confirm("Remove this submission?"))return;try{await oa(n),b("Removed.","info"),await Je(),fe()}catch(a){b(a.message,"error")}}}async function Al(e){const t=e.target.closest("#submit-content-btn");if(!t)return;const s=document.getElementById("content-url-input"),n=s==null?void 0:s.value.trim();if(!n||!n.startsWith("http"))return b("Enter a valid URL.","warning");const a=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-circle-notch fa-spin"></i>';try{await Fi(n),b("📋 Submitted! Your post is now under security audit.","info"),s.value="",await Je(),z.activeTab="history",fe()}catch(i){b(i.message,"error")}finally{t.disabled=!1,t.innerHTML=a}}async function Ll(e){const t=e.target.closest(".task-card");if(!t)return;const s=t.dataset.id,n=t.dataset.url;n&&window.open(n,"_blank");const a=z.dailyTasks.find(i=>i.id===s);if(!(!a||!a.eligible))try{await Ni(a,z.user.pointsMultiplier),b(`Task completed! +${a.points} pts`,"success"),await Je(),fe()}catch(i){i.message.includes("Cooldown")||b(i.message,"error")}}function Sl(){const e=Date.now(),t=Pa*60*60*1e3,s=z.userSubmissions.filter(n=>["pending","auditing"].includes(n.status)&&n.submittedAt&&e-n.submittedAt.getTime()>=t);s.length>0&&(z.activeTab="history",fe(),setTimeout(()=>{Fa(s[0])},500))}const Pl={async render(e){const t=document.getElementById("airdrop");if(!t)return;xl();const s=bl();(t.innerHTML.trim()===""||e)&&(t.innerHTML=`
...
(This will reset their rejection count to 0)`;if(!window.confirm(a))return;const i=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await la(s,n),b(`User ${n?"BANNED":"UNBANNED"}.`,"success");const o=h.allUsers.findIndex(r=>r.id===s);o>-1&&(h.allUsers[o].isBanned=n,h.allUsers[o].hasPendingAppeal=!1,n===!1&&(h.allUsers[o].rejectedCount=0)),Be()}catch(o){b(`Failed: ${o.message}`,"error"),t.disabled=!1,t.innerHTML=i}},_l=async e=>{const t=e.target.closest(".resolve-appeal-btn");if(!t||t.disabled)return;const s=t.dataset.userId,a=t.dataset.action==="approve";if(!s)return;const i=a?"Are you sure you want to APPROVE this appeal and UNBAN the user?":"Are you sure you want to DENY this appeal? The user will remain banned.";if(!window.confirm(i))return;const o=t.closest("td").querySelectorAll("button"),r=new Map;o.forEach(l=>{r.set(l,l.innerHTML),l.disabled=!0,l.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>'});try{a&&await la(s,!1),b(`Appeal ${a?"APPROVED":"DENIED"}.`,"success");const l=h.allUsers.findIndex(d=>d.id===s);l>-1&&(h.allUsers[l].hasPendingAppeal=!1,a&&(h.allUsers[l].isBanned=!1,h.allUsers[l].rejectedCount=0)),Be()}catch(l){b(`Failed: ${l.message}`,"error"),o.forEach(d=>{d.disabled=!1,d.innerHTML=r.get(d)})}},Ul=async e=>{const t=e.target.closest(".re-approve-btn");if(!t||t.disabled)return;const s=t.dataset.submissionId,n=t.dataset.userId;if(!s||!n)return;const a=t.closest("tr");a&&(a.style.opacity="0.5"),t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await ra(n,s,"approved"),b("Submission re-approved!","success"),h.selectedUserSubmissions=h.selectedUserSubmissions.filter(o=>o.submissionId!==s),a&&a.remove();const i=h.allUsers.findIndex(o=>o.id===n);if(i>-1){const o=h.allUsers[i];o.rejectedCount=Math.max(0,(o.rejectedCount||0)-1),Be()}if(h.selectedUserSubmissions.length===0){const o=document.querySelector("#admin-user-modal .p-6");o&&(o.innerHTML='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>')}}catch(i){b(`Failed to re-approve: ${i.message}`,"error"),a&&(a.style.opacity="1"),t.disabled=!1,t.innerHTML='<i class="fa-solid fa-check"></i> Re-Approve'}},Ol=async e=>{const t=e.target.closest(".view-rejected-btn");if(!t||t.disabled)return;const s=t.dataset.userId,n=t.dataset.wallet;if(s){h.selectedWallet=n,h.isSubmissionsModalOpen=!0,vs(!0,[]);try{const a=await qi(s,"rejected");h.selectedUserSubmissions=a,vs(!1,a)}catch(a){b(`Error fetching user submissions: ${a.message}`,"error"),vs(!1,[],!0)}}},Wl=()=>{h.isSubmissionsModalOpen=!1,h.selectedUserSubmissions=[],h.selectedWallet=null;const e=document.getElementById("admin-user-modal");e&&e.remove(),document.body.style.overflow="auto"},ql=e=>{const t=e.target.closest(".user-profile-link");if(!t)return;e.preventDefault();const s=t.dataset.userId;if(!s)return;const n=h.allUsers.find(a=>a.id===s);if(!n){b("Error: Could not find user data.","error");return}Jl(n)},Yl=()=>{const e=document.getElementById("admin-user-profile-modal");e&&e.remove(),document.body.style.overflow="auto"},Kl=async e=>{e.preventDefault();const t=e.target;let s,n;try{if(s=new Date(t.startDate.value+"T00:00:00Z"),n=new Date(t.endDate.value+"T23:59:59Z"),isNaN(s.getTime())||isNaN(n.getTime()))throw new Error("Invalid date format.");if(s>=n)throw new Error("Start Date must be before End Date.")}catch(l){b(l.message,"error");return}const a={title:t.title.value.trim(),url:t.url.value.trim(),description:t.description.value.trim(),points:parseInt(t.points.value,10),cooldownHours:parseInt(t.cooldown.value,10),startDate:s,endDate:n};if(!a.title||!a.description){b("Please fill in Title and Description.","error");return}if(a.points<=0||a.cooldownHours<=0){b("Points and Cooldown must be positive numbers.","error");return}if(a.url&&!a.url.startsWith("http")){b("URL must start with http:// or https://","error");return}h.editingTask&&h.editingTask.id&&(a.id=h.editingTask.id);const i=t.querySelector('button[type="submit"]'),o=i.innerHTML;i.disabled=!0;const r=document.createElement("span");r.classList.add("inline-block"),i.innerHTML="",i.appendChild(r);try{await _i(a),b(`Task ${a.id?"updated":"created"} successfully!`,"success"),t.reset(),h.editingTask=null,ot()}catch(l){b(`Failed to save task: ${l.message}`,"error"),console.error(l),i.disabled=!1,i.innerHTML=o}},Gl=async e=>{e.preventDefault();const t=e.target,s={YouTube:parseInt(t.youtubePoints.value,10),"YouTube Shorts":parseInt(t.youtubeShortsPoints.value,10),Instagram:parseInt(t.instagramPoints.value,10),"X/Twitter":parseInt(t.xTwitterPoints.value,10),Facebook:parseInt(t.facebookPoints.value,10),Telegram:parseInt(t.telegramPoints.value,10),TikTok:parseInt(t.tiktokPoints.value,10),Reddit:parseInt(t.redditPoints.value,10),LinkedIn:parseInt(t.linkedinPoints.value,10),Other:parseInt(t.otherPoints.value,10)};if(Object.values(s).some(o=>isNaN(o)||o<0)){b("All points must be positive numbers (or 0).","error");return}const n=t.querySelector('button[type="submit"]'),a=n.innerHTML;n.disabled=!0;const i=document.createElement("span");i.classList.add("inline-block"),n.innerHTML="",n.appendChild(i);try{await ji(s),b("UGC Base Points updated successfully!","success"),h.ugcBasePoints=s}catch(o){b(`Failed to update points: ${o.message}`,"error"),console.error(o)}finally{document.body.contains(n)&&(n.disabled=!1,n.innerHTML=a)}},Vl=e=>{const t=h.dailyTasks.find(s=>s.id===e);t&&(h.editingTask=t,ft())},Xl=async e=>{if(window.confirm("Are you sure you want to delete this task permanently?"))try{await Ui(e),b("Task deleted.","success"),h.editingTask=null,ot()}catch(t){b(`Failed to delete task: ${t.message}`,"error"),console.error(t)}};function vs(e,t,s=!1){var o,r;const n=document.getElementById("admin-user-modal");n&&n.remove(),document.body.style.overflow="hidden";let a="";e?a='<div class="p-8"></div>':s?a='<p class="text-red-400 text-center p-8">Failed to load submissions.</p>':t.length===0?a='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>':a=`
    ...
    `;const $=document.getElementById("admin-users-pagination");$&&g>1&&Js($,h.usersPage,g,ec),(A=document.getElementById("admin-users-tbody"))==null||A.addEventListener("click",T=>{T.target.closest(".user-profile-link")&&ql(T),T.target.closest(".ban-user-btn")&&Hl(T),T.target.closest(".view-rejected-btn")&&Ol(T),T.target.closest(".resolve-appeal-btn")&&_l(T)}),(I=document.getElementById("user-filters-nav"))==null||I.addEventListener("click",Ql);const L=document.getElementById("user-search-input");if(L){let T;L.addEventListener("keyup",F=>{clearTimeout(T),T=setTimeout(()=>Zl(F),300)})}},Wn=()=>{var n;const e=document.getElementById("manage-ugc-points-content");if(!e)return;const t=h.ugcBasePoints;if(!t)return;const s={YouTube:5e3,"YouTube Shorts":2500,Instagram:3e3,"X/Twitter":1500,Facebook:2e3,Telegram:1e3,TikTok:3500,Reddit:1800,LinkedIn:2200,Other:1e3};e.innerHTML=`
    ...
    `,(n=document.getElementById("ugcPointsForm"))==null||n.addEventListener("submit",Gl)},ft=()=>{var f,x,y;const e=document.getElementById("manage-tasks-content");if(!e)return;const t=h.editingTask,s=!!t,n=k=>{if(!k)return"";try{return(k.toDate?k.toDate():k instanceof Date?k:new Date(k)).toISOString().split("T")[0]}catch{return""}},a=h.tasksPage,i=h.tasksPerPage,o=[...h.dailyTasks].sort((k,$)=>{var I,T;const L=(I=k.startDate)!=null&&I.toDate?k.startDate.toDate():new Date(k.startDate||0);return((T=$.startDate)!=null&&T.toDate?$.startDate.toDate():new Date($.startDate||0)).getTime()-L.getTime()}),r=o.length,l=Math.ceil(r/i),d=(a-1)*i,u=a*i,p=o.slice(d,u),m=p.length>0?p.map(k=>{var T,F;const $=new Date,L=(T=k.startDate)!=null&&T.toDate?k.startDate.toDate():k.startDate?new Date(k.startDate):null,A=(F=k.endDate)!=null&&F.toDate?k.endDate.toDate():k.endDate?new Date(k.endDate):null;let I="text-zinc-500";return L&&A&&($>=L&&$<=A?I="text-green-400":$<L&&(I="text-blue-400")),`
    ...
    `;const g=document.getElementById("admin-tasks-pagination");g&&l>1&&Js(g,h.tasksPage,l,sc),(f=document.getElementById("taskForm"))==null||f.addEventListener("submit",Kl),(x=document.getElementById("cancelEditBtn"))==null||x.addEventListener("click",()=>{h.editingTask=null,ft()}),(y=document.getElementById("existing-tasks-list"))==null||y.addEventListener("click",k=>{const $=k.target.closest("button[data-id]");if(!$)return;const L=$.dataset.id;$.dataset.action==="edit"&&Vl(L),$.dataset.action==="delete"&&Xl(L)})},_t=()=>{var p;const e=document.getElementById("submissions-content");if(!e)return;if(!h.allSubmissions||h.allSubmissions.length===0){const m=document.createElement("div");e.innerHTML=m.innerHTML;return}const t=h.submissionsPage,s=h.submissionsPerPage,n=[...h.allSubmissions].sort((m,g)=>{var f,x;return(((f=g.submittedAt)==null?void 0:f.getTime())||0)-(((x=m.submittedAt)==null?void 0:x.getTime())||0)}),a=n.length,i=Math.ceil(a/s),o=(t-1)*s,r=t*s,d=n.slice(o,r).map(m=>{var g,f;return`
        <tr class="border-b border-border-color hover:bg-zinc-800/50">
            <td class="p-3 text-xs text-zinc-400 font-mono" title="${m.userId}">${Ve(m.walletAddress)}</td>
            ...
            <td class="p-3 text-xs font-semibold ${((g=On[m.status])==null?void 0:g.color)||"text-gray-500"}">${((f=On[m.status])==null?void 0:f.text)||m.status}</td>
            <td class="p-3 text-right">
                <div class="flex items-center justify-end gap-2">
    ...
    `;const u=document.getElementById("admin-submissions-pagination");u&&i>1&&Js(u,h.submissionsPage,i,tc),(p=document.getElementById("admin-submissions-tbody"))==null||p.addEventListener("click",jl)},Ut=()=>{var i,o;const e=document.getElementById("platform-usage-content");if(!e)return;const t=h.platformUsageConfig||ss;let s=0;Object.values(t).forEach(r=>{r.enabled!==!1&&(s+=(r.points||0)*(r.maxCount||1))});const n=Object.entries(t).map(([r,l])=>`
    ...
    `;const a=document.getElementById("platform-usage-tbody");a==null||a.addEventListener("input",qn),a==null||a.addEventListener("change",qn),(i=document.getElementById("save-platform-config-btn"))==null||i.addEventListener("click",nc),(o=document.getElementById("reset-platform-config-btn"))==null||o.addEventListener("click",ac)},qn=e=>{const t=e.target;if(!t.classList.contains("platform-input")&&!t.classList.contains("platform-toggle"))return;const s=t.closest("tr"),n=s==null?void 0:s.dataset.actionKey,a=t.dataset.field;if(!n||!a)return;h.platformUsageConfig[n]||(h.platformUsageConfig[n]={...ss[n]}),a==="enabled"?h.platformUsageConfig[n].enabled=t.checked:h.platformUsageConfig[n][a]=parseInt(t.value)||0;const i=h.platformUsageConfig[n],o=s.querySelector("td:last-child");o&&(o.textContent=((i.points||0)*(i.maxCount||1)).toLocaleString())},nc=async e=>{const t=e.target.closest("button");if(!t)return;const s=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Saving...';try{await ca(h.platformUsageConfig),b("✅ Platform Usage config saved!","success"),Ut()}catch(n){console.error("Error saving platform config:",n),b("Failed to save config: "+n.message,"error")}finally{t.disabled=!1,t.innerHTML=s}},ac=async()=>{if(confirm("Are you sure you want to reset to default values? This will save immediately."))try{h.platformUsageConfig={...ss},await ca(h.platformUsageConfig),b("✅ Config reset to defaults!","success"),Ut()}catch(e){console.error("Error resetting platform config:",e),b("Failed to reset config: "+e.message,"error")}},ic=()=>{var s;const e=document.getElementById("admin-content-wrapper");if(!e)return;e.innerHTML=`
    ...
    `}function Ua(){const e=document.getElementById("marketplace-grid");if(!e)return;const t=J.translations.en;if(J.nftTiers[0].priceInWei===0n){e.innerHTML=`<p class="text-lg text-amber-400 text-center col-span-full animate-pulse">${t.loadingText}</p>`,Ha();return}e.innerHTML=J.nftTiers.map(_a).join(""),ht(c.isConnected),ja("en")}const Rs={render:()=>{const e=`
    ...
    `,Ot(),xe(),ns(),Rc())}function Ot(){const e=document.getElementById("mobile-badge"),t=document.getElementById("desktop-badge"),s=document.getElementById("fee-amount"),n=document.getElementById("user-balance"),a=c.notaryFee||0n,i=c.currentUserBalance||0n;s&&(s.textContent=`${B(a)} BKC`),n&&(n.textContent=`${B(i)} BKC`,n.className=`font-mono font-bold ${i>=a?"text-green-400":"text-red-400"}`),c.isConnected?i>=a?(e&&(e.className="text-[10px] px-2 py-1 rounded-full bg-green-500/20 text-green-400",e.textContent="Ready"),t&&(t.innerHTML=`
            ...
            <div class="bg-zinc-800/50 border border-zinc-700 rounded-xl p-4 mb-4 text-left">
                <div class="flex items-center gap-3 pb-3 border-b border-zinc-700/50 mb-3">
                    <div class="w-10 h-10 rounded-lg bg-amber-500/10 flex items-center justify-center">
                        <i class="${Wa((t==null?void 0:t.type)||"")} text-amber-400"></i>
                    </div>
                    <div class="flex-1 min-w-0">
...
`)[0].trim()||"Notarized Document";const p=Oa("",u),m=l&&l.length>10,g=Bc(r.timestamp);return`
        ...
        `}}}function Rc(){var e;(e=document.getElementById("btn-refresh"))==null||e.addEventListener("click",async()=>{const t=document.getElementById("btn-refresh");t&&(t.innerHTML='<i class="fa-solid fa-rotate fa-spin"></i> Loading...'),await ns(),t&&(t.innerHTML='<i class="fa-solid fa-rotate"></i> Refresh')})}async function Dc(){const e=Date.now();if(!(e-P.lastFetch<3e4&&c.notaryFee>0n))try{!c.ecosystemManagerContractPublic&&!c.ecosystemManagerContract&&await Ks();const t=c.ecosystemManagerContractPublic||c.ecosystemManagerContract;if(t){let s=0n;try{const n=Ue.id("NOTARY_SERVICE");s=await O(t,"getFee",[n],0n)}catch(n){console.warn("getFee with key failed:",n.message);try{s=await O(t,"notaryFee",[],0n)}catch(a){console.warn("notaryFee failed:",a.message);try{const i=Ue.id("NOTARY_SERVICE");s=await O(t,"fees",[i],0n)}catch(i){console.warn("fees mapping failed:",i.message)}}}s>0n?(c.notaryFee=s,console.log("📜 Notary fee loaded:",B(s),"BKC")):(c.notaryFee=Ue.parseEther("1"),console.log("📜 Using default notary fee: 1 BKC")),P.lastFetch=e}if(c.isConnected&&c.userAddress)try{if(c.bkcTokenContract||c.bkcTokenContractPublic){const s=c.bkcTokenContract||c.bkcTokenContractPublic,n=await O(s,"balanceOf",[c.userAddress],0n);n>0n&&(c.currentUserBalance=n,console.log("📜 User balance loaded:",B(n),"BKC"))}}catch(s){console.warn("Balance load error:",s.message)}Ot()}catch(t){console.warn("Notary data error:",t),(!c.notaryFee||c.notaryFee===0n)&&(c.notaryFee=Ue.parseEther("1"))}}const qa={async render(e){e&&(Ic(),await Dc(),c.isConnected&&await V(),Ot(),xe())},reset(){P.file=null,P.description="",P.step=1,xe()},update(){Ot(),P.isProcessing||xe()},refreshHistory(){ns()},async addToWallet(e,t){var s,n,a,i;try{const o=["https://dweb.link/ipfs/","https://w3s.link/ipfs/","https://nftstorage.link/ipfs/","https://cloudflare-ipfs.com/ipfs/","https://ipfs.io/ipfs/"],r=p=>p?p.startsWith("ipfs://")?p.replace("ipfs://","").split("?")[0]:p.includes("/ipfs/")?p.split("/ipfs/")[1].split("?")[0]:p.match(/^Qm[a-zA-Z0-9]{44}/)||p.match(/^bafy[a-zA-Z0-9]+/)?p:"":"",l=(p,m=0)=>{if(!p)return"";if(p.startsWith("https://")&&!p.includes("/ipfs/")&&!p.includes("ipfs.io"))return p;const g=r(p);return g?`${o[m]}${g}`:p};let d=l(t||"");if(console.log("📜 Input imageUrl:",t),console.log("📜 Converted to:",d),c.decentralizedNotaryContract)try{const p=await c.decentralizedNotaryContract.tokenURI(e);if(console.log("📜 TokenURI response:",p==null?void 0:p.slice(0,200)),p&&p.startsWith("data:application/json;base64,")){const m=p.replace("data:application/json;base64,",""),g=JSON.parse(atob(m));console.log("📜 Parsed metadata:",JSON.stringify(g).slice(0,300)),g.image&&(d=l(g.image),console.log("📜 Image from metadata:",d))}}catch(p){console.warn("Could not fetch tokenURI:",p.message)}console.log("📜 Final image URL for wallet:",d);const u=((s=c.decentralizedNotaryContract)==null?void 0:s.target)||((n=c.decentralizedNotaryContract)!=null&&n.getAddress?await c.decentralizedNotaryContract.getAddress():null);if(!u){b("Contract address not found","error");return}console.log("📜 Contract address:",u),console.log("📜 Token ID:",e),b("Adding NFT #"+e+" to wallet...","info");try{await window.ethereum.request({method:"wallet_watchAsset",params:{type:"ERC721",options:{address:u,tokenId:String(e),image:d}}})?b("📜 NFT #"+e+" added to wallet!","success"):b("NFT not added (cancelled)","warning");return}catch(p){if(console.warn("First attempt with image failed:",(a=p.message)==null?void 0:a.slice(0,100)),p.code!==4001)try{await window.ethereum.request({method:"wallet_watchAsset",params:{type:"ERC721",options:{address:u,tokenId:String(e)}}})?b("📜 NFT #"+e+" added to wallet!","success"):b("NFT not added (cancelled)","warning");return}catch(m){throw m}throw p}}catch(o){if(console.error("Add to wallet error:",o),o.code===4001)return;o.code===4100||(i=o.message)!=null&&i.includes("spam")?b("MetaMask blocked request. Wait a few seconds and try again.","warning"):b("Could not add NFT: "+(o.message||"Unknown error"),"error")}}};window.NotaryPage=qa;const mt=window.ethers,je="./assets/airbnft.png",jc="https://sepolia.arbiscan.io/tx/",j={activeTab:"marketplace",filterTier:"ALL",selectedRentalId:null,isLoading:!1,isTransactionPending:!1,rentalHistory:[]};function wt(e){return e?e.startsWith("https://")||e.startsWith("http://")?e:e.includes("ipfs.io/ipfs/")?`${Y}${e.split("ipfs.io/ipfs/")[1]}`:e.startsWith("ipfs://")?`${Y}${e.substring(7)}`:e:"./assets/nft.png"}function Ya(e){const t=Math.floor(Date.now()/1e3),s=e-t;if(s<=0)return{text:"Expired",expired:!0};const n=Math.floor(s/3600),a=Math.floor(s%3600/60);return n>0?{text:`${n}h ${a}m`,expired:!1}:{text:`${a}m`,expired:!1}}function He(e){return ee.find(s=>s.boostBips===Number(e))||{name:"Unknown",img:"./assets/bkc_logo_3d.png",boostBips:0}}function Ka(e){return{Diamond:"from-cyan-500 to-blue-600",Platinum:"from-slate-300 to-gray-500",Gold:"from-yellow-400 to-amber-600",Silver:"from-gray-300 to-zinc-500",Bronze:"from-orange-500 to-amber-700"}[e]||"from-zinc-500 to-zinc-700"}function Hc(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function _c(e="Loading..."){return`
    ...
    `}function Kc(e){const t=He(e.boostBips),s=B(BigInt(e.pricePerHour||0)).toFixed(2),n=`tier-${t.name.toLowerCase()}`,a=Ka(t.name),i=e.img||t.img||"./assets/nft.png";return`
        <div class="nft-card">
            <div class="nft-image">
    ...
    `}function Vc(e){const t=He(e.boostBips),s=B(BigInt(e.pricePerHour||0)).toFixed(2),n=Number(mt.formatEther(BigInt(e.totalEarnings||0))).toFixed(4),a=e.rentalCount||0,i=`tier-${t.name.toLowerCase()}`,o=Math.floor(Date.now()/1e3),r=e.isRented||e.rentalEndTime&&Number(e.rentalEndTime)>o,l=r&&e.rentalEndTime?Ya(Number(e.rentalEndTime)):null;return`
    ...
    `}function Jc(e){const t=(c.rentalListings||[]).find(o=>o.tokenId===e.tokenId),s=He((t==null?void 0:t.boostBips)||0),n=Ya(Number(e.endTime)),a=B(BigInt(e.paidAmount||0)).toFixed(2),i=`tier-${s.name.toLowerCase()}`;return Ka(s.name),`
    ...
    `,r.innerHTML=`${a} <span class="text-sm text-zinc-500 font-normal">BKC</span>`;const l=document.getElementById("rent-modal");l.classList.remove("hidden"),l.classList.add("flex")}function Ds(){const e=document.getElementById("rent-modal");e.classList.remove("flex"),e.classList.add("hidden"),j.selectedRentalId=null}function od(){const e=c.rentalListings||[],t=new Set(e.map(i=>{var o;return(o=i.tokenId)==null?void 0:o.toString()})),s=(c.myBoosters||[]).filter(i=>{var o;return!t.has((o=i.tokenId)==null?void 0:o.toString())}),n=document.getElementById("list-nft-select");n&&(s.length===0?n.innerHTML='<option value="">No NFTs available to list</option>':n.innerHTML=s.map(i=>{const o=He(i.boostBips);return`<option value="${i.tokenId}">#${i.tokenId} - ${o.name} (+${(i.boostBips||0)/100}%)</option>`}).join("")),document.getElementById("list-price-input").value="";const a=document.getElementById("list-modal");a.classList.remove("hidden"),a.classList.add("flex")}function js(){const e=document.getElementById("list-modal");e.classList.remove("flex"),e.classList.add("hidden")}async function rd(){if(j.isTransactionPending)return;const e=j.selectedRentalId,t=(c.rentalListings||[]).find(l=>l.tokenId===e);if(!t)return;const s=document.getElementById("confirm-rent-btn"),n=document.getElementById("airbnft-mascot"),a=s.innerHTML,i=1,r=BigInt(t.pricePerHour||0)*BigInt(i);j.isTransactionPending=!0,s.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Processing...',s.disabled=!0,n&&(n.className="w-16 h-16 object-contain airbnft-spin");try{await Co({tokenId:e,hours:i,totalCost:r.toString()},s)&&(n&&(n.className="w-16 h-16 object-contain airbnft-success"),Ds(),b("⏰ NFT rented successfully! Boost is now active for 1 hour.","success"),ld(5),await yt())}finally{j.isTransactionPending=!1,s.innerHTML=a,s.disabled=!1,n&&setTimeout(()=>{n.className="w-16 h-16 object-contain airbnft-float airbnft-pulse"},800)}}function ld(e){document.querySelectorAll(".rent-btn").forEach(s=>{s.disabled=!0,s.classList.add("opacity-50","cursor-not-allowed");let n=e;const a=s.innerHTML,i=setInterval(()=>{s.innerHTML=`<i class="fa-solid fa-clock mr-1"></i>${n}s`,n--,n<0&&(clearInterval(i),s.innerHTML=a,s.disabled=!1,s.classList.remove("opacity-50","cursor-not-allowed"))},1e3)})}async function cd(){if(j.isTransactionPending)return;const e=document.getElementById("list-nft-select").value,t=document.getElementById("list-price-input").value;if(!e)return b("Please select an NFT","error");if(!t||parseFloat(t)<=0)return b("Please enter a valid price","error");const s=document.getElementById("confirm-list-btn"),n=document.getElementById("airbnft-mascot"),a=s.innerHTML;j.isTransactionPending=!0,s.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Processing...',s.disabled=!0,n&&(n.className="w-16 h-16 object-contain airbnft-spin");try{const i=mt.parseUnits(t,18),o=document.getElementById("list-min-hours"),r=document.getElementById("list-max-hours"),l=o&&parseInt(o.value)||1,d=r&&parseInt(r.value)||168;await zo({tokenId:e,pricePerHour:i,minHours:l,maxHours:d},s)&&(n&&(n.className="w-16 h-16 object-contain airbnft-success"),js(),b("🏷️ NFT listed successfully!","success"),await yt())}finally{j.isTransactionPending=!1,s.innerHTML=a,s.disabled=!1,n&&setTimeout(()=>{n.className="w-16 h-16 object-contain airbnft-float airbnft-pulse"},800)}}async function dd(e){if(j.isTransactionPending)return;const t=e.dataset.id;if(!confirm("Are you sure you want to withdraw this NFT from the rental market?"))return;const s=e.innerHTML,n=document.getElementById("airbnft-mascot");j.isTransactionPending=!0,e.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>',e.disabled=!0,n&&(n.className="w-16 h-16 object-contain airbnft-spin");try{await Bo(t,e)&&(b("↩️ NFT withdrawn successfully!","success"),await yt())}finally{j.isTransactionPending=!1,e.innerHTML=s,e.disabled=!1,n&&setTimeout(()=>{n.className="w-16 h-16 object-contain airbnft-float airbnft-pulse"},800)}}const ud={render:async e=>{const t=document.getElementById("socials");if(!t||!e&&t.innerHTML.trim()!=="")return;const s=`
        ...
        `},cleanup:()=>{}},Va=document.createElement("style");Va.innerHTML=`
...
`;document.head.appendChild(Va);const pd={render:async e=>{if(!e)return;const t=document.getElementById("creditcard");t&&(t.innerHTML=`
    ...
    `,n=ys("getting-started","rocket","emerald",ws.gettingStarted,"catGettingStarted","catGettingStartedDesc",0);s+=n.html,n=ys("ecosystem","cubes","amber",ws.ecosystem,"catEcosystem","catEcosystemDesc",n.nextIndex),s+=n.html,n=ys("advanced","graduation-cap","cyan",ws.advanced,"catAdvanced","catAdvancedDesc",n.nextIndex),s+=n.html,e.innerHTML=s}const Ja={render:function(e=!1){const t=document.getElementById("tutorials");t&&(e||t.innerHTML.trim()==="")&&(t.innerHTML=`
