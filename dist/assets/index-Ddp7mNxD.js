import{defaultConfig as kd,createWeb3Modal as Ed}from"https://esm.sh/@web3modal/ethers@5.1.11?bundle";import{initializeApp as Td}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-app.js";import{getAuth as Cd,onAuthStateChanged as Id,signInAnonymously as Ad}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-auth.js";import{getFirestore as Pd,collection as qe,query as Bt,where as Xa,orderBy as Jt,getDocs as dt,doc as se,getDoc as ze,limit as zd,serverTimestamp as ut,writeBatch as dn,updateDoc as un,increment as Oe,setDoc as pn,Timestamp as $s,addDoc as Bd,deleteDoc as Nd}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-firestore.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(i){if(i.ep)return;i.ep=!0;const s=a(i);fetch(i.href,s)}})();const Be={sidebar:document.getElementById("sidebar"),sidebarBackdrop:document.getElementById("sidebar-backdrop"),menuBtn:document.getElementById("menu-btn"),navLinks:document.getElementById("nav-links"),mainContentSections:document.querySelectorAll("main section"),connectButtonDesktop:document.getElementById("connectButtonDesktop"),connectButtonMobile:document.getElementById("connectButtonMobile"),mobileAppDisplay:document.getElementById("mobileAppDisplay"),desktopDisconnected:document.getElementById("desktopDisconnected"),desktopConnectedInfo:document.getElementById("desktopConnectedInfo"),desktopUserAddress:document.getElementById("desktopUserAddress"),desktopUserBalance:document.getElementById("desktopUserBalance"),modalContainer:document.getElementById("modal-container"),toastContainer:document.getElementById("toast-container"),dashboard:document.getElementById("dashboard"),earn:document.getElementById("mine"),store:document.getElementById("store"),rental:document.getElementById("rental"),rewards:document.getElementById("rewards"),actions:document.getElementById("actions"),presale:document.getElementById("presale"),faucet:document.getElementById("faucet"),airdrop:document.getElementById("airdrop"),dao:document.getElementById("dao"),about:document.getElementById("about"),admin:document.getElementById("admin"),tokenomics:document.getElementById("tokenomics"),notary:document.getElementById("notary"),statTotalSupply:document.getElementById("statTotalSupply"),statValidators:document.getElementById("statValidators"),statTotalPStake:document.getElementById("statTotalPStake"),statScarcity:document.getElementById("statScarcity"),statLockedPercentage:document.getElementById("statLockedPercentage"),statUserBalance:document.getElementById("statUserBalance"),statUserPStake:document.getElementById("statUserPStake"),statUserRewards:document.getElementById("statUserRewards")},Sd={provider:null,publicProvider:null,web3Provider:null,signer:null,userAddress:null,isConnected:!1,bkcTokenContract:null,ecosystemManagerContract:null,stakingPoolContract:null,buybackMinerContract:null,rewardBoosterContract:null,fortunePoolContract:null,agoraContract:null,notaryContract:null,charityPoolContract:null,rentalManagerContract:null,faucetContract:null,liquidityPoolContract:null,governanceContract:null,bkcTokenContractPublic:null,ecosystemManagerContractPublic:null,stakingPoolContractPublic:null,buybackMinerContractPublic:null,fortunePoolContractPublic:null,agoraContractPublic:null,notaryContractPublic:null,charityPoolContractPublic:null,rentalManagerContractPublic:null,faucetContractPublic:null,currentUserBalance:0n,currentUserNativeBalance:0n,userTotalPStake:0n,userDelegations:[],myBoosters:[],activityHistory:[],totalNetworkPStake:0n,allValidatorsData:[],systemFees:{},systemPStakes:{},boosterDiscounts:{},notaryFee:void 0,notaryMinPStake:void 0},$d={set(e,t,a){const n=e[t];if(e[t]=a,["currentUserBalance","isConnected","userTotalPStake","totalNetworkPStake"].includes(t)){if(n===a)return!0;window.updateUIState&&window.updateUIState()}return!0}},c=new Proxy(Sd,$d);let Ls=!1;const x=(e,t="info",a=null)=>{if(!Be.toastContainer)return;const n={success:{icon:"fa-check-circle",color:"bg-green-600",border:"border-green-400"},error:{icon:"fa-exclamation-triangle",color:"bg-red-600",border:"border-red-400"},info:{icon:"fa-info-circle",color:"bg-blue-600",border:"border-blue-400"},warning:{icon:"fa-exclamation-circle",color:"bg-yellow-600",border:"border-yellow-400"}},i=n[t]||n.info,s=document.createElement("div");s.className=`flex items-center w-full max-w-xs p-4 text-white rounded-lg shadow-lg transition-all duration-500 ease-out 
    ...
    `;Be.modalContainer.innerHTML=i,requestAnimationFrame(()=>{const o=document.getElementById("modal-backdrop");o&&o.classList.remove("opacity-0"),o&&o.classList.add("opacity-100")}),(s=document.getElementById("modal-backdrop"))==null||s.addEventListener("click",o=>{a&&o.target.id==="modal-backdrop"&&Ee()}),(r=document.getElementById("modal-content"))==null||r.querySelectorAll(".closeModalBtn").forEach(o=>{o.addEventListener("click",Ee)})};async function Ld(e,t){if(!window.ethereum){x("MetaMask not detected","error");return}try{await window.ethereum.request({method:"wallet_watchAsset",params:{type:"ERC721",options:{address:"0xf2EA307686267dC674859da28C58CBb7a5866BCf",tokenId:e.toString()}}})?x(`${t} NFT #${e} added to wallet!`,"success"):x("NFT not added to wallet","info")}catch(a){console.error("Error adding NFT to wallet:",a),x("Failed to add NFT to wallet","error")}}function Rd(){const e=window.location.origin,t=encodeURIComponent("Check out Backcoin - The Unstoppable DeFi Protocol on Arbitrum! Build your own business. Be Your Own CEO. 🚀 #Backcoin #DeFi #Arbitrum #BeYourOwnCEO"),a=`
    ...
    `;xa(a,"max-w-md")}const Rs=e=>{window.navigateTo?window.navigateTo(e):console.error("navigateTo function not found."),Ee()};function _d(){var i,s,r,o,l,d;if(Ls)return;Ls=!0;const e="https://t.me/BackCoinorg",t="https://github.com/backcoin-org/backchain-dapp";xa(`
    ...
    `,"max-w-sm",!1);const n=document.getElementById("modal-content");n&&((i=n.querySelector("#btnAirdrop"))==null||i.addEventListener("click",()=>{Rs("airdrop")}),(s=n.querySelector("#btnExplore"))==null||s.addEventListener("click",()=>{Ee()}),(r=n.querySelector("#btnCEO"))==null||r.addEventListener("click",()=>{window.open(t+"/blob/main/docs/BE_YOUR_OWN_CEO.md","_blank")}),(o=n.querySelector("#btnDocs"))==null||o.addEventListener("click",()=>{window.open(t,"_blank")}),(l=n.querySelector("#btnSocials"))==null||l.addEventListener("click",()=>{Rs("socials")}),(d=n.querySelector("#btnTelegram"))==null||d.addEventListener("click",()=>{window.open(e,"_blank")}))}const Fd=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1";console.log(`Environment: ${Fd?"DEVELOPMENT":"PRODUCTION"}`);const ki="ZWla0YY4A0Hw7e_rwyOXB",Te={chainId:"0x66eee",chainIdDecimal:421614,chainName:"Arbitrum Sepolia",nativeCurrency:{name:"Ethereum",symbol:"ETH",decimals:18},blockExplorerUrls:["https://sepolia.arbiscan.io"],rpcUrls:[`https://arb-sepolia.g.alchemy.com/v2/${ki}`,"https://arbitrum-sepolia.blockpi.network/v1/rpc/public","https://arbitrum-sepolia-rpc.publicnode.com"]},kt=[{name:"Alchemy",url:`https://arb-sepolia.g.alchemy.com/v2/${ki}`,priority:1,isPublic:!1,corsCompatible:!0},{name:"BlockPI",url:"https://arbitrum-sepolia.blockpi.network/v1/rpc/public",priority:2,isPublic:!0,corsCompatible:!0},{name:"PublicNode",url:"https://arbitrum-sepolia-rpc.publicnode.com",priority:3,isPublic:!0,corsCompatible:!0},{name:"Arbitrum Official",url:"https://sepolia-rollup.arbitrum.io/rpc",priority:4,isPublic:!0,corsCompatible:!1}].filter(e=>e.url!==null),Mr=`https://arb-sepolia.g.alchemy.com/v2/${ki}`;let De=0,ha=new Map;function va(){var e;return((e=kt[De])==null?void 0:e.url)||Mr}function Dr(){const e=De;do{De=(De+1)%kt.length;const a=kt[De];if(!a.corsCompatible){console.warn(`⏭️ Skipping ${a.name} (CORS incompatible)`);continue}if(De===e)return console.warn("⚠️ All RPCs have been tried. Resetting to primary."),De=0,kt[0].url}while(ha.get(kt[De].url)==="unhealthy");const t=kt[De];return console.log(`🔄 Switched to RPC: ${t.name}`),t.url}function Md(e){ha.set(e,"unhealthy"),console.warn(`❌ RPC marked unhealthy: ${e}`),setTimeout(()=>{ha.delete(e),console.log(`♻️ RPC health reset: ${e}`)},6e4)}function Dd(e){ha.set(e,"healthy")}function Od(){De=0,ha.clear(),console.log(`✅ Reset to primary RPC: ${kt[0].name}`)}const Hd="https://white-defensive-eel-240.mypinata.cloud/ipfs/",ti=["https://dweb.link/ipfs/","https://w3s.link/ipfs/","https://nftstorage.link/ipfs/","https://cloudflare-ipfs.com/ipfs/","https://ipfs.io/ipfs/"],v={},M={bkcToken:null,backchainEcosystem:null,stakingPool:null,buybackMiner:null,rewardBooster:null,nftPoolFactory:null,fortunePool:null,agora:null,notary:null,charityPool:null,rentalManager:null,liquidityPool:null,faucet:null,backchainGovernance:null,treasuryWallet:null};async function Ud(){try{const e=await fetch(`./deployment-addresses.json?t=${Date.now()}`);if(!e.ok)throw new Error(`Failed to fetch deployment-addresses.json: ${e.status}`);const t=await e.json(),a=["bkcToken","backchainEcosystem","stakingPool","buybackMiner"];if(!a.every(i=>t[i]||t[_s(i)])){const i=a.filter(s=>!t[s]&&!t[_s(s)]);throw new Error(`Missing required addresses: ${i.join(", ")}`)}return v.bkcToken=t.bkcToken,v.backchainEcosystem=t.backchainEcosystem||t.ecosystemManager,v.stakingPool=t.stakingPool||t.delegationManager,v.buybackMiner=t.buybackMiner||t.miningManager,v.rewardBooster=t.rewardBooster||t.rewardBoosterNFT,v.nftPoolFactory=t.nftPoolFactory||t.nftLiquidityPoolFactory,v.fortunePool=t.fortunePool||t.fortunePoolV2,v.agora=t.agora||t.backchat,v.notary=t.notary||t.decentralizedNotary,v.charityPool=t.charityPool,v.rentalManager=t.rentalManager,v.liquidityPool=t.liquidityPool,v.faucet=t.faucet||t.simpleBkcFaucet,v.backchainGovernance=t.backchainGovernance,v.treasuryWallet=t.treasuryWallet,v.pool_bronze=t.pool_bronze,v.pool_silver=t.pool_silver,v.pool_gold=t.pool_gold,v.pool_diamond=t.pool_diamond,Object.assign(M,v),console.log("✅ V9 contract addresses loaded"),console.log("   Ecosystem:",v.backchainEcosystem),console.log("   StakingPool:",v.stakingPool),console.log("   Agora:",v.agora),console.log("   FortunePool:",v.fortunePool),!0}catch(e){return console.error("❌ Failed to load contract addresses:",e),!1}}function _s(e){return{backchainEcosystem:"ecosystemManager",stakingPool:"delegationManager",buybackMiner:"miningManager",rewardBooster:"rewardBoosterNFT",nftPoolFactory:"nftLiquidityPoolFactory",agora:"backchat",notary:"decentralizedNotary"}[e]||e}const me=[{name:"Diamond",boostBips:5e3,burnRate:0,keepRate:100,color:"text-cyan-400",emoji:"💎",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeicgip72jcqgsirlrhn3tq5cc226vmko6etnndzl6nlhqrktfikafq",borderColor:"border-cyan-400/50",glowColor:"bg-cyan-500/10",bgGradient:"from-cyan-500/20 to-blue-500/20"},{name:"Gold",boostBips:4e3,burnRate:10,keepRate:90,color:"text-amber-400",emoji:"🥇",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeifponccrbicg2pcjrn2hrfoqgc77xhm2r4ld7hdpw6cxxkbsckf44",borderColor:"border-amber-400/50",glowColor:"bg-amber-500/10",bgGradient:"from-amber-500/20 to-yellow-500/20"},{name:"Silver",boostBips:2500,burnRate:25,keepRate:75,color:"text-gray-300",emoji:"🥈",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeihvi2inujm5zpi7tl667g4srq273536pjkglwyrtbwmgnskmu7jg4",borderColor:"border-gray-400/50",glowColor:"bg-gray-500/10",bgGradient:"from-gray-400/20 to-zinc-500/20"},{name:"Bronze",boostBips:1e3,burnRate:40,keepRate:60,color:"text-yellow-600",emoji:"🥉",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeiclqidb67rt3tchhjpsib62s624li7j2bpxnr6b5w5mfp4tomhu7m",borderColor:"border-yellow-600/50",glowColor:"bg-yellow-600/10",bgGradient:"from-yellow-600/20 to-orange-600/20"}];function jd(e){const t=[...me].sort((a,n)=>n.boostBips-a.boostBips);for(const a of t)if(e>=a.boostBips)return a;return null}function Wd(e){return e>=5e3?0:e>=4e3?10:e>=2500?25:e>=1e3?40:50}function pt(e){return 100-Wd(e)}const Ei=["function name() view returns (string)","function symbol() view returns (string)","function decimals() view returns (uint8)","function totalSupply() view returns (uint256)","function balanceOf(address owner) view returns (uint256)","function transfer(address to, uint256 amount) returns (bool)","function approve(address spender, uint256 amount) returns (bool)","function allowance(address owner, address spender) view returns (uint256)","function transferFrom(address from, address to, uint256 amount) returns (bool)","function MAX_SUPPLY() view returns (uint256)","function TGE_SUPPLY() view returns (uint256)","function totalBurned() view returns (uint256)","function mintableRemaining() view returns (uint256)","function totalMinted() view returns (uint256)","event Transfer(address indexed from, address indexed to, uint256 value)","event Approval(address indexed owner, address indexed spender, uint256 value)"],Ti=["function totalPStake() view returns (uint256)","function totalBkcDelegated() view returns (uint256)","function userTotalPStake(address _user) view returns (uint256)","function pendingRewards(address _user) view returns (uint256)","function savedRewards(address _user) view returns (uint256)","function MIN_LOCK_DAYS() view returns (uint256)","function MAX_LOCK_DAYS() view returns (uint256)","function REFERRER_CUT_BPS() view returns (uint256)","function forceUnstakePenaltyBps() view returns (uint256)","function getDelegationsOf(address _user) view returns (tuple(uint128 amount, uint128 pStake, uint64 lockEnd, uint64 lockDays, uint256 rewardDebt)[])","function getDelegation(address _user, uint256 _index) view returns (uint256 amount, uint256 pStake, uint256 lockEnd, uint256 lockDays, uint256 pendingReward)","function delegationCount(address _user) view returns (uint256)","function delegate(uint256 _amount, uint256 _lockDays, address _operator) external payable","function unstake(uint256 _index) external","function forceUnstake(uint256 _index, address _operator) external payable","function claimRewards(address _operator) external payable","function claimRewards() external","function getUserBestBoost(address _user) view returns (uint256)","function getBurnRateForBoost(uint256 _boostBps) pure returns (uint256)","function getTierName(uint256 _boostBps) pure returns (string)","function previewClaim(address _user) view returns (uint256 totalRewards, uint256 burnAmount, uint256 referrerCut, uint256 userReceives, uint256 burnRateBps, uint256 nftBoost)","function getStakingStats() view returns (uint256 totalPStake, uint256 totalBkcDelegated, uint256 totalRewardsDistributed, uint256 totalBurnedOnClaim, uint256 totalForceUnstakePenalties, uint256 totalEthFeesCollected, uint256 accRewardPerShare)","function getUserSummary(address _user) view returns (uint256 userTotalPStake, uint256 delegationCount, uint256 savedRewards, uint256 totalPending, uint256 nftBoost, uint256 burnRateBps)","event Delegated(address indexed user, uint256 indexed delegationIndex, uint256 amount, uint256 pStake, uint256 lockDays, address operator)","event Unstaked(address indexed user, uint256 indexed delegationIndex, uint256 amountReturned)","event ForceUnstaked(address indexed user, uint256 indexed delegationIndex, uint256 amountReturned, uint256 penaltyBurned, address operator)","event RewardsClaimed(address indexed user, uint256 totalRewards, uint256 burnedAmount, uint256 userReceived, uint256 cutAmount, address cutRecipient, uint256 nftBoostUsed, address operator)","event TokensBurnedOnClaim(address indexed user, uint256 burnedAmount, uint256 burnRateBps, uint256 totalBurnedAllTime)"],Ia=["function listNFT(uint256 tokenId, uint96 pricePerHour, uint16 minHours, uint16 maxHours) external","function updateListing(uint256 tokenId, uint96 pricePerHour, uint16 minHours, uint16 maxHours) external","function withdrawNFT(uint256 tokenId) external","function rentNFT(uint256 tokenId, uint256 hours_, address operator) external payable","function withdrawEarnings() external","function getListing(uint256 tokenId) view returns (address owner, uint96 pricePerHour, uint16 minHours, uint16 maxHours, uint96 totalEarnings, uint32 rentalCount, bool currentlyRented, uint48 rentalEndTime)","function getRental(uint256 tokenId) view returns (address tenant, uint48 endTime, bool isActive)","function isRented(uint256 tokenId) view returns (bool)","function getRemainingTime(uint256 tokenId) view returns (uint256)","function hasActiveRental(address user) view returns (bool)","function getUserBestBoost(address user) view returns (uint256)","function pendingEarnings(address owner) view returns (uint256)","function userActiveRental(address user) view returns (uint256)","function getAllListedTokenIds() view returns (uint256[])","function getListingCount() view returns (uint256)","function getRentalCost(uint256 tokenId, uint256 hours_) view returns (uint256 rentalCost, uint256 ethFee, uint256 totalCost)","function getStats() view returns (uint256 activeListings, uint256 volume, uint256 rentals, uint256 ethFees, uint256 earningsWithdrawn)","event NFTListed(uint256 indexed tokenId, address indexed owner, uint96 pricePerHour, uint16 minHours, uint16 maxHours)","event ListingUpdated(uint256 indexed tokenId, uint96 pricePerHour, uint16 minHours, uint16 maxHours)","event NFTRented(uint256 indexed tokenId, address indexed tenant, address indexed owner, uint256 hours_, uint256 rentalCost, uint256 ethFee, uint48 endTime, address operator)","event NFTWithdrawn(uint256 indexed tokenId, address indexed owner)","event EarningsWithdrawn(address indexed owner, uint256 amount)"],Or=["function buyNFT(uint256 maxBkcPrice, address operator) external payable returns (uint256 tokenId)","function buySpecificNFT(uint256 tokenId, uint256 maxBkcPrice, address operator) external payable","function sellNFT(uint256 tokenId, uint256 minPayout, address operator) external payable","function getBuyPrice() view returns (uint256)","function getSellPrice() view returns (uint256)","function getTotalBuyCost() view returns (uint256 bkcCost, uint256 ethCost)","function getTotalSellInfo() view returns (uint256 bkcPayout, uint256 ethCost)","function getEthFees() view returns (uint256 buyFee, uint256 sellFee)","function getSpread() view returns (uint256 spread, uint256 spreadBips)","function getPoolInfo() view returns (uint256 bkcBalance, uint256 nftCount, uint256 k, bool initialized, uint8 tier)","function getAvailableNFTs() view returns (uint256[])","function isNFTInPool(uint256 tokenId) view returns (bool)","function bkcBalance() view returns (uint256)","function nftCount() view returns (uint256)","function tier() view returns (uint8)","function initialized() view returns (bool)","function getTierName() view returns (string)","function getStats() view returns (uint256 volume, uint256 buys, uint256 sells, uint256 ethFees)","function totalVolume() view returns (uint256)","function totalBuys() view returns (uint256)","function totalSells() view returns (uint256)","function totalEthFees() view returns (uint256)","event NFTPurchased(address indexed buyer, uint256 indexed tokenId, uint256 price, uint256 ethFee, uint256 newNftCount, address operator)","event NFTSold(address indexed seller, uint256 indexed tokenId, uint256 payout, uint256 ethFee, uint256 newNftCount, address operator)"],Ci=["function commitPlay(bytes32 _commitHash, uint256 _wagerAmount, uint8 _tierMask, address _operator) external payable returns (uint256 gameId)","function revealPlay(uint256 _gameId, uint256[] calldata _guesses, bytes32 _userSecret) external returns (uint256 prizeWon)","function claimExpired(uint256 _gameId) external","function fundPrizePool(uint256 _amount) external","function generateCommitHash(uint256[] calldata _guesses, bytes32 _userSecret) pure returns (bytes32)","function TIER_COUNT() view returns (uint8)","function BKC_FEE_BPS() view returns (uint256)","function MAX_PAYOUT_BPS() view returns (uint256)","function REVEAL_DELAY() view returns (uint256)","function REVEAL_WINDOW() view returns (uint256)","function POOL_CAP() view returns (uint256)","function getTierInfo(uint8 _tier) pure returns (uint256 range, uint256 multiplier, uint256 winChanceBps)","function getAllTiers() pure returns (uint256[3] ranges, uint256[3] multipliers, uint256[3] winChances)","function getGame(uint256 _gameId) view returns (address player, uint48 commitBlock, uint8 tierMask, uint8 status, address operator, uint96 wagerAmount)","function getGameResult(uint256 _gameId) view returns (address player, uint128 grossWager, uint128 prizeWon, uint8 tierMask, uint8 matchCount, uint48 revealBlock)","function getGameStatus(uint256 _gameId) view returns (uint8 status, bool canReveal, uint256 blocksUntilReveal, uint256 blocksUntilExpiry)","function activeGame(address _player) view returns (uint256)","function getRequiredFee(uint8 _tierMask) view returns (uint256 fee)","function calculatePotentialWinnings(uint256 _wagerAmount, uint8 _tierMask) view returns (uint256 netToPool, uint256 bkcFee, uint256 maxPrize, uint256 maxPrizeAfterCap)","function gameCounter() view returns (uint256)","function prizePool() view returns (uint256)","function getPoolStats() view returns (uint256 prizePool, uint256 totalGamesPlayed, uint256 totalBkcWagered, uint256 totalBkcWon, uint256 totalBkcForfeited, uint256 totalBkcBurned, uint256 maxPayoutNow)","event GameCommitted(uint256 indexed gameId, address indexed player, uint256 wagerAmount, uint8 tierMask, address operator)","event GameRevealed(uint256 indexed gameId, address indexed player, uint256 grossWager, uint256 prizeWon, uint8 tierMask, uint8 matchCount, address operator)","event GameDetails(uint256 indexed gameId, uint8 tierMask, uint256[] guesses, uint256[] rolls, bool[] matches)","event GameExpired(uint256 indexed gameId, address indexed player, uint256 forfeitedAmount)","event PrizePoolFunded(address indexed funder, uint256 amount)","event PoolExcessBurned(uint256 amount, uint256 newTotalBurned)"],Gd=["function balanceOf(address _owner) view returns (uint256)","function ownerOf(uint256 _tokenId) view returns (address)","function approve(address _to, uint256 _tokenId) external","function setApprovalForAll(address _operator, bool _approved) external","function transferFrom(address _from, address _to, uint256 _tokenId) external","function safeTransferFrom(address _from, address _to, uint256 _tokenId) external","function totalSupply() view returns (uint256)","function getUserBestBoost(address _user) view returns (uint256)","function getTokenInfo(uint256 _tokenId) view returns (address owner, uint8 tier, uint256 boostBips)","function getUserTokens(address _user) view returns (uint256[] tokenIds, uint8[] tiers)","function getTierBoost(uint8 _tier) pure returns (uint256)","function getTierName(uint8 _tier) pure returns (string)","event Transfer(address indexed from, address indexed to, uint256 indexed tokenId)","event Approval(address indexed owner, address indexed approved, uint256 indexed tokenId)"],Ii=["function certify(bytes32 _documentHash, string _meta, uint8 _docType, address _operator) external payable returns (uint256 certId)","function batchCertify(bytes32[] _documentHashes, string[] _metas, uint8[] _docTypes, address _operator) external payable returns (uint256 startId)","function transferCertificate(bytes32 _documentHash, address _newOwner) external","function verify(bytes32 _documentHash) view returns (bool exists, address owner, uint48 timestamp, uint8 docType, string meta)","function getCertificate(uint256 _certId) view returns (bytes32 documentHash, address owner, uint48 timestamp, uint8 docType, string meta)","function getFee() view returns (uint256)","function getStats() view returns (uint256 certCount, uint256 totalEthCollected)","function certCount() view returns (uint256)","function totalEthCollected() view returns (uint256)","function MAX_BATCH_SIZE() view returns (uint8)","event Certified(uint256 indexed certId, address indexed owner, bytes32 indexed documentHash, uint8 docType, address operator)","event BatchCertified(address indexed owner, uint256 startId, uint256 count, address operator)","event CertificateTransferred(bytes32 indexed documentHash, address indexed from, address indexed to)"],Ai=["function claim() external","function canClaim(address user) view returns (bool)","function getCooldownRemaining(address user) view returns (uint256)","function getUserInfo(address user) view returns (uint256 lastClaim, uint256 claims, bool eligible, uint256 cooldownLeft)","function getFaucetStatus() view returns (uint256 ethBalance, uint256 tokenBalance, uint256 ethPerDrip, uint256 tokensPerDrip, uint256 estimatedEthClaims, uint256 estimatedTokenClaims)","function getStats() view returns (uint256 tokens, uint256 eth, uint256 claims, uint256 users)","function cooldown() view returns (uint256)","function tokensPerClaim() view returns (uint256)","function ethPerClaim() view returns (uint256)","function paused() view returns (bool)","event Claimed(address indexed recipient, uint256 tokens, uint256 eth, address indexed via)"],Pi=["function calculateFee(bytes32 _actionId, uint256 _txValue) view returns (uint256)","function bkcToken() view returns (address)","function treasury() view returns (address)","function buybackAccumulated() view returns (uint256)","function referredBy(address _user) view returns (address)","function totalEthCollected() view returns (uint256)","function totalBkcCollected() view returns (uint256)","function totalFeeEvents() view returns (uint256)","function getStats() view returns (uint256 ethCollected, uint256 bkcCollected, uint256 feeEvents, uint256 buybackEth, uint256 moduleCount)","function isAuthorized(address _contract) view returns (bool)","function moduleCount() view returns (uint256)","event FeeCollected(bytes32 indexed moduleId, address indexed user, address operator, address customRecipient, uint256 ethAmount, uint256 bkcAmount)"],zi=["function executeBuyback() external","function executeBuybackWithSlippage(uint256 _minTotalBkcOut) external","function MAX_SUPPLY() view returns (uint256)","function MAX_MINTABLE() view returns (uint256)","function MIN_BUYBACK() view returns (uint256)","function CALLER_BPS() view returns (uint256)","function BURN_BPS() view returns (uint256)","function currentMiningRate() view returns (uint256 rateBps)","function pendingBuybackETH() view returns (uint256)","function getSupplyInfo() view returns (uint256 currentSupply, uint256 maxSupply, uint256 totalMintedViaMining, uint256 remainingMintable, uint256 miningRateBps, uint256 totalBurnedLifetime)","function previewBuyback() view returns (uint256 ethAvailable, uint256 estimatedBkcPurchased, uint256 estimatedBkcMined, uint256 estimatedBurn, uint256 estimatedToStakers, uint256 estimatedCallerReward, uint256 currentMiningRateBps, bool isReady)","function previewMiningAtSupply(uint256 _supplyLevel, uint256 _purchaseAmount) pure returns (uint256 miningAmount, uint256 rateBps)","function getBuybackStats() view returns (uint256 totalBuybacks, uint256 totalEthSpent, uint256 totalBkcPurchased, uint256 totalBkcMined, uint256 totalBkcBurned, uint256 totalBkcToStakers, uint256 totalCallerRewards, uint256 avgEthPerBuyback, uint256 avgBkcPerBuyback)","function getLastBuyback() view returns (uint256 timestamp, uint256 blockNumber, address caller, uint256 ethSpent, uint256 bkcTotal, uint256 timeSinceLast)","function totalBuybacks() view returns (uint256)","function totalEthSpent() view returns (uint256)","function totalBkcPurchased() view returns (uint256)","function totalBkcMined() view returns (uint256)","function totalBkcBurned() view returns (uint256)","function totalBkcToStakers() view returns (uint256)","function totalCallerRewards() view returns (uint256)","event BuybackExecuted(address indexed caller, uint256 indexed buybackNumber, uint256 callerReward, uint256 ethSpent, uint256 bkcPurchased, uint256 bkcMined, uint256 bkcBurned, uint256 bkcToStakers, uint256 miningRateBps)"],Bi=["function createCampaign(string title, string metadataUri, uint96 goal, uint256 durationDays, address operator) external payable returns (uint256)","function donate(uint256 campaignId, address operator) external payable","function boostCampaign(uint256 campaignId, address operator) external payable","function closeCampaign(uint256 campaignId) external","function withdraw(uint256 campaignId) external","function getCampaign(uint256 campaignId) view returns (address owner, uint48 deadline, uint8 status, uint96 raised, uint96 goal, uint32 donorCount, bool isBoosted, string title, string metadataUri)","function canWithdraw(uint256 campaignId) view returns (bool)","function titles(uint256 campaignId) view returns (string)","function metadataUris(uint256 campaignId) view returns (string)","function campaignCount() view returns (uint256)","function previewDonation(uint256 amount) view returns (uint256 fee, uint256 netToCampaign)","function getStats() view returns (uint256 campaignCount, uint256 totalDonated, uint256 totalWithdrawn, uint256 totalEthFees)","event CampaignCreated(uint256 indexed campaignId, address indexed owner, uint96 goal, uint48 deadline, address operator)","event DonationMade(uint256 indexed campaignId, address indexed donor, uint256 grossAmount, uint256 netAmount, address operator)","event CampaignBoosted(uint256 indexed campaignId, address indexed booster, uint48 boostExpiry, address operator)","event CampaignClosed(uint256 indexed campaignId, address indexed owner, uint96 raised)","event FundsWithdrawn(uint256 indexed campaignId, address indexed owner, uint96 amount)"],Aa=["function createPost(string contentHash, uint8 tag, uint8 contentType, address operator) external payable","function createReply(uint256 parentId, string contentHash, uint8 contentType, address operator) external payable","function createRepost(uint256 originalId, string contentHash, address operator) external payable","function deletePost(uint256 postId) external","function changeTag(uint256 postId, uint8 newTag) external","function like(uint256 postId, address operator) external payable","function superLike(uint256 postId, address operator) external payable","function downvote(uint256 postId, address operator) external payable","function follow(address user, address operator) external payable","function unfollow(address user) external","function createProfile(string username, string metadataURI, address operator) external payable","function updateProfile(string metadataURI) external","function pinPost(uint256 postId) external","function boostProfile(address operator) external payable","function obtainBadge(address operator) external payable","function VOTE_PRICE() view returns (uint256)","function TAG_COUNT() view returns (uint8)","function postCounter() view returns (uint256)","function totalProfiles() view returns (uint256)","function getPost(uint256 postId) view returns (address author, uint8 tag, uint8 contentType, bool deleted, uint32 createdAt, uint256 replyTo, uint256 repostOf, uint256 likes, uint256 superLikes, uint256 downvotes, uint256 replies, uint256 reposts)","function getUserProfile(address user) view returns (bytes32 usernameHash, string metadataURI, uint256 pinned, bool boosted, bool hasBadge, uint64 boostExp, uint64 badgeExp)","function isProfileBoosted(address user) view returns (bool)","function hasTrustBadge(address user) view returns (bool)","function isUsernameAvailable(string username) view returns (bool)","function getUsernamePrice(uint256 length) pure returns (uint256)","function hasLiked(uint256 postId, address user) view returns (bool)","function getOperatorStats(address operator) view returns (uint256 posts_, uint256 engagement)","function getGlobalStats() view returns (uint256 totalPosts, uint256 totalProfiles, uint256[15] tagCounts)","function version() pure returns (string)","event PostCreated(uint256 indexed postId, address indexed author, uint8 tag, uint8 contentType, string contentHash, address operator)","event ReplyCreated(uint256 indexed postId, uint256 indexed parentId, address indexed author, uint8 tag, uint8 contentType, string contentHash, address operator)","event RepostCreated(uint256 indexed postId, uint256 indexed originalId, address indexed author, uint8 tag, string contentHash, address operator)","event PostDeleted(uint256 indexed postId, address indexed author)","event Liked(uint256 indexed postId, address indexed liker, address indexed author, address operator)","event SuperLiked(uint256 indexed postId, address indexed voter, address indexed author, uint256 count, address operator)","event Downvoted(uint256 indexed postId, address indexed voter, address indexed author, uint256 count, address operator)","event Followed(address indexed follower, address indexed followed, address operator)","event Unfollowed(address indexed follower, address indexed followed)","event ProfileCreated(address indexed user, string username, string metadataURI, address operator)","event ProfileUpdated(address indexed user, string metadataURI)","event ProfileBoosted(address indexed user, uint256 daysAdded, uint64 expiresAt, address operator)","event BadgeObtained(address indexed user, uint64 expiresAt, address operator)"];let Fs=0;const Kd=5e3;async function Yd(){try{return window.ethereum?await window.ethereum.request({method:"eth_chainId"})===Te.chainId:!1}catch(e){return console.warn("Network check failed:",e.message),!1}}async function Gt(){if(!window.ethereum)return console.warn("MetaMask not detected"),!1;try{return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:Te.chainId,chainName:Te.chainName,nativeCurrency:Te.nativeCurrency,rpcUrls:Te.rpcUrls,blockExplorerUrls:Te.blockExplorerUrls}]}),console.log("✅ MetaMask network config updated"),!0}catch(e){return e.code===4001?(console.log("User rejected network update"),!1):(console.warn("Could not update MetaMask network:",e.message),!1)}}async function Vd(){if(!window.ethereum)return console.warn("MetaMask not detected"),!1;try{return await window.ethereum.request({method:"wallet_switchEthereumChain",params:[{chainId:Te.chainId}]}),console.log("✅ Switched to Arbitrum Sepolia"),!0}catch(e){return e.code===4902?(console.log("🔄 Network not found, adding..."),await Gt()):e.code===4001?(console.log("User rejected network switch"),!1):(console.error("Network switch error:",e),!1)}}async function wa(){var e;if(!window.ethereum)return{healthy:!1,reason:"no_provider"};try{const t=new window.ethers.BrowserProvider(window.ethereum),a=new Promise((i,s)=>setTimeout(()=>s(new Error("timeout")),5e3)),n=t.getBlockNumber();return await Promise.race([n,a]),{healthy:!0}}catch(t){const a=((e=t==null?void 0:t.message)==null?void 0:e.toLowerCase())||"";return a.includes("timeout")?{healthy:!1,reason:"timeout"}:a.includes("too many")||a.includes("rate limit")||a.includes("-32002")?{healthy:!1,reason:"rate_limited"}:a.includes("failed to fetch")||a.includes("network")?{healthy:!1,reason:"network_error"}:{healthy:!1,reason:"unknown",error:a}}}async function qd(){const e=Date.now();if(e-Fs<Kd)return{success:!0,skipped:!0};if(Fs=e,!window.ethereum)return{success:!1,error:"MetaMask not detected"};try{if(!await Yd()&&(console.log("🔄 Wrong network detected, switching..."),!await Vd()))return{success:!1,error:"Please switch to Arbitrum Sepolia network"};const a=await wa();if(!a.healthy&&(console.log(`⚠️ RPC unhealthy (${a.reason}), updating MetaMask config...`),await Gt())){await new Promise(s=>setTimeout(s,1e3));const i=await wa();return i.healthy?{success:!0,fixed:!0}:{success:!1,error:"Network is congested. Please try again in a moment.",rpcReason:i.reason}}return{success:!0}}catch(t){return console.error("Network config error:",t),{success:!1,error:t.message}}}function Xd(e){window.ethereum&&window.ethereum.on("chainChanged",async t=>{console.log("🔄 Network changed to:",t);const a=t===Te.chainId;e&&e({chainId:t,isCorrectNetwork:a,needsSwitch:!a})})}const Hr=window.ethers,Jd=5e3,Zd=6e4,Qd=15e3,eu=3e4,tu=3e4;let Ln=null,Ms=0;const Ds=new Map,Rn=new Map,Os=new Map,Hs=e=>new Promise(t=>setTimeout(t,e));async function fn(e,t){const a=new AbortController,n=setTimeout(()=>a.abort(),t);try{const i=await fetch(e,{signal:a.signal});return clearTimeout(n),i}catch(i){throw clearTimeout(n),i.name==="AbortError"?new Error("API request timed out."):i}}const Ue={getHistory:"https://gethistory-4wvdcuoouq-uc.a.run.app",getBoosters:"https://getboosters-4wvdcuoouq-uc.a.run.app",getSystemData:"https://getsystemdata-4wvdcuoouq-uc.a.run.app",getNotaryHistory:"https://getnotaryhistory-4wvdcuoouq-uc.a.run.app",getRentalListings:"https://getrentallistings-4wvdcuoouq-uc.a.run.app",getUserRentals:"https://getuserrentals-4wvdcuoouq-uc.a.run.app",fortuneGames:"https://getfortunegames-4wvdcuoouq-uc.a.run.app",uploadFileToIPFS:"/api/upload",claimAirdrop:"https://us-central1-airdropbackchainnew.cloudfunctions.net/claimAirdrop"};function Ur(e){var t;return((t=e==null?void 0:e.error)==null?void 0:t.code)===429||(e==null?void 0:e.code)===429||e.message&&(e.message.includes("429")||e.message.includes("Too Many Requests")||e.message.includes("rate limit"))}function jr(e){var a,n;const t=((a=e==null?void 0:e.error)==null?void 0:a.code)||(e==null?void 0:e.code);return t===-32603||t===-32e3||((n=e.message)==null?void 0:n.includes("Internal JSON-RPC"))}function mn(e,t,a){if(a)return a;if(!e||!c.publicProvider)return null;try{return new Hr.Contract(e,t,c.publicProvider)}catch{return null}}const Z=async(e,t,a=[],n=0n,i=2,s=!1)=>{if(!e)return n;const r=e.target||e.address,o=JSON.stringify(a,(f,p)=>typeof p=="bigint"?p.toString():p),l=`${r}-${t}-${o}`,d=Date.now(),u=["getPoolInfo","getBuyPrice","getSellPrice","getAvailableTokenIds","getAllListedTokenIds","tokenURI","tokenTier","getTokenInfo","getListing","balanceOf","totalSupply","totalPStake","MAX_SUPPLY","TGE_SUPPLY","userTotalPStake","pendingRewards","isRented","getRental","ownerOf","getDelegationsOf","allowance","getPoolStats","getAllTiers","getUserSummary","getUserBestBoost"];if(!s&&u.includes(t)){const f=Ds.get(l);if(f&&d-f.timestamp<Qd)return f.value}for(let f=0;f<=i;f++)try{const p=await e[t](...a);return u.includes(t)&&Ds.set(l,{value:p,timestamp:d}),p}catch(p){if(Ur(p)&&f<i){const g=Math.floor(Math.random()*1e3),b=1e3*Math.pow(2,f)+g;await Hs(b);continue}if(jr(p)&&f<i){await Hs(500);continue}break}return n},au=async(e,t,a=!1)=>{const n=`balance-${(e==null?void 0:e.target)||(e==null?void 0:e.address)}-${t}`,i=Date.now();if(!a){const r=Os.get(n);if(r&&i-r.timestamp<tu)return r.value}const s=await Z(e,"balanceOf",[t],0n,2,a);return Os.set(n,{value:s,timestamp:i}),s};async function Wr(){c.systemFees||(c.systemFees={}),c.systemPStakes||(c.systemPStakes={}),c.boosterDiscounts||(c.boosterDiscounts={});const e=Date.now();if(Ln&&e-Ms<Zd)return Us(Ln),!0;try{const t=await fn(Ue.getSystemData,Jd);if(!t.ok)throw new Error(`API Status: ${t.status}`);const a=await t.json();return Us(a),Ln=a,Ms=e,!0}catch{return c.systemFees.NOTARY_SERVICE||(c.systemFees.NOTARY_SERVICE=100n),c.systemFees.CLAIM_REWARD_FEE_BIPS||(c.systemFees.CLAIM_REWARD_FEE_BIPS=500n),!1}}function Us(e){if(e.fees)for(const t in e.fees)try{c.systemFees[t]=BigInt(e.fees[t])}catch{c.systemFees[t]=0n}if(e.pStakeRequirements)for(const t in e.pStakeRequirements)try{c.systemPStakes[t]=BigInt(e.pStakeRequirements[t])}catch{c.systemPStakes[t]=0n}if(e.discounts)for(const t in e.discounts)try{c.boosterDiscounts[t]=BigInt(e.discounts[t])}catch{c.boosterDiscounts[t]=0n}if(e.oracleFeeInWei){c.systemData=c.systemData||{};try{c.systemData.oracleFeeInWei=BigInt(e.oracleFeeInWei)}catch{c.systemData.oracleFeeInWei=0n}}}async function Gr(){!c.publicProvider||!c.bkcTokenContractPublic||await Promise.allSettled([Z(c.bkcTokenContractPublic,"totalSupply",[],0n),Wr()])}async function gn(e=!1){var t,a,n;if(!(!c.isConnected||!c.userAddress))try{const i=(a=(t=c.bkcTokenContractPublic)==null?void 0:t.runner)==null?void 0:a.provider,[s,r]=await Promise.allSettled([au(c.bkcTokenContractPublic||c.bkcTokenContract,c.userAddress,e),(n=i||c.provider)==null?void 0:n.getBalance(c.userAddress)]);s.status==="fulfilled"&&(c.currentUserBalance=s.value),r.status==="fulfilled"&&(c.currentUserNativeBalance=r.value),await Ct(e);const o=c.stakingPoolContractPublic||c.stakingPoolContract;if(o){const l=await Z(o,"userTotalPStake",[c.userAddress],0n,2,e);c.userTotalPStake=l}}catch(i){console.error("Error loading user data:",i)}}async function nu(e=!1){const t=c.stakingPoolContractPublic||c.stakingPoolContract;if(!c.isConnected||!t)return[];try{const a=await Z(t,"getDelegationsOf",[c.userAddress],[],2,e);return c.userDelegations=a.map((n,i)=>({amount:n.amount||n[0]||0n,pStake:n.pStake||n[1]||0n,lockEnd:Number(n.lockEnd||n[2]||0),lockDays:Number(n.lockDays||n[3]||0),rewardDebt:n.rewardDebt||n[4]||0n,unlockTime:BigInt(n.lockEnd||n[2]||0),lockDuration:BigInt(n.lockDays||n[3]||0)*86400n,index:i})),c.userDelegations}catch(a){return console.error("Error loading delegations:",a),[]}}async function Kr(e=!1){let t=[];try{const n=await fn(Ue.getRentalListings,4e3);n.ok&&(t=await n.json())}catch{}if(t&&t.length>0){const n=t.map(i=>{var r,o,l,d,u;const s=me.find(f=>f.boostBips===Number(i.boostBips||0));return{...i,tokenId:((r=i.tokenId)==null?void 0:r.toString())||((o=i.id)==null?void 0:o.toString()),pricePerHour:((l=i.pricePerHour)==null?void 0:l.toString())||((d=i.price)==null?void 0:d.toString())||"0",totalEarnings:((u=i.totalEarnings)==null?void 0:u.toString())||"0",rentalCount:Number(i.rentalCount||0),img:(s==null?void 0:s.img)||"./assets/nft.png",name:(s==null?void 0:s.name)||"Booster NFT"}});return c.rentalListings=n,n}const a=mn(v.rentalManager,Ia,c.rentalManagerContractPublic);if(!a)return c.rentalListings=[],[];try{const n=await Z(a,"getAllListedTokenIds",[],[],2,!0);if(!n||n.length===0)return c.rentalListings=[],[];const s=n.slice(0,30).map(async l=>{var d,u,f,p,g,b;try{const w=await Z(a,"getListing",[l],null,1,!0);if(w&&w.owner!==Hr.ZeroAddress){const T=await Z(a,"getRental",[l],null,1,!0),C=await Vr(l),P=Math.floor(Date.now()/1e3),S=T&&BigInt(T.endTime||0)>BigInt(P);return{tokenId:l.toString(),owner:w.owner,pricePerHour:((d=w.pricePerHour)==null?void 0:d.toString())||((u=w.price)==null?void 0:u.toString())||"0",minHours:((f=w.minHours)==null?void 0:f.toString())||"1",maxHours:((p=w.maxHours)==null?void 0:p.toString())||"1",totalEarnings:((g=w.totalEarnings)==null?void 0:g.toString())||"0",rentalCount:Number(w.rentalCount||0),boostBips:C.boostBips,img:C.img||"./assets/nft.png",name:C.name,isRented:S,currentTenant:S?T.tenant:null,rentalEndTime:S?(b=T.endTime)==null?void 0:b.toString():null}}}catch{}return null}),o=(await Promise.all(s)).filter(l=>l!==null);return c.rentalListings=o,o}catch{return c.rentalListings=[],[]}}async function iu(e=!1){var a,n;if(!c.userAddress)return c.myRentals=[],[];try{const i=await fn(`${Ue.getUserRentals}/${c.userAddress}`,4e3);if(i.ok){const r=(await i.json()).map(o=>{const l=me.find(d=>d.boostBips===Number(o.boostBips||0));return{...o,img:(l==null?void 0:l.img)||"./assets/nft.png",name:(l==null?void 0:l.name)||"Booster NFT"}});return c.myRentals=r,r}}catch{}const t=mn(v.rentalManager,Ia,c.rentalManagerContractPublic);if(!t)return c.myRentals=[],[];try{const i=await Z(t,"getAllListedTokenIds",[],[],2,e),s=[],r=Math.floor(Date.now()/1e3);for(const o of i.slice(0,30))try{const l=await Z(t,"getRental",[o],null,1,e);if(l&&((a=l.tenant)==null?void 0:a.toLowerCase())===c.userAddress.toLowerCase()&&(l.isActive||BigInt(l.endTime||0)>BigInt(r))){const d=await Vr(o);s.push({tokenId:o.toString(),tenant:l.tenant,endTime:((n=l.endTime)==null?void 0:n.toString())||"0",isActive:l.isActive,boostBips:d.boostBips,img:d.img,name:d.name})}}catch{}return c.myRentals=s,s}catch{return c.myRentals=[],[]}}let Ma=null,js=0;const su=3e4;async function Yr(e=!1){const t=Date.now();if(!e&&Ma&&t-js<su)return Ma;await Ct(e);let a=0,n=null,i="none";if(c.myBoosters&&c.myBoosters.length>0){const l=c.myBoosters.reduce((d,u)=>u.boostBips>d.boostBips?u:d,c.myBoosters[0]);l.boostBips>a&&(a=l.boostBips,n=l.tokenId,i="owned")}if(c.myRentals&&c.myRentals.length>0){const l=c.myRentals.reduce((d,u)=>u.boostBips>d.boostBips?u:d,c.myRentals[0]);l.boostBips>a&&(a=l.boostBips,n=l.tokenId,i="rented")}const s=me.find(l=>l.boostBips===a),r=(s==null?void 0:s.image)||(s==null?void 0:s.realImg)||(s==null?void 0:s.img)||"assets/bkc_logo_3d.png",o=s!=null&&s.name?`${s.name} Booster`:i!=="none"?"Booster NFT":"None";return Ma={highestBoost:a,boostName:o,imageUrl:r,tokenId:n?n.toString():null,source:i},js=Date.now(),Ma}async function Vr(e){const t=["function getTokenInfo(uint256) view returns (address owner, uint8 tier, uint256 boostBips)","function tokenTier(uint256) view returns (uint8)"],a=mn(v.rewardBooster,t,c.rewardBoosterContractPublic);if(!a)return{boostBips:0,img:"assets/bkc_logo_3d.png",name:"Unknown"};try{const n=await Z(a,"getTokenInfo",[e],null);if(n){const i=Number(n.boostBips||n[2]||0),s=me.find(r=>r.boostBips===i);return{boostBips:i,img:(s==null?void 0:s.image)||(s==null?void 0:s.img)||"./assets/nft.png",name:(s==null?void 0:s.name)||`Booster #${e}`}}return{boostBips:0,img:"assets/bkc_logo_3d.png",name:"Unknown"}}catch{return{boostBips:0,img:"assets/bkc_logo_3d.png",name:"Unknown"}}}async function Ni(){const e=c.stakingPoolContractPublic||c.stakingPoolContract;if(!c.isConnected||!e)return{stakingRewards:0n,minerRewards:0n,totalRewards:0n};try{const t=await Z(e,"pendingRewards",[c.userAddress],0n);return{stakingRewards:t,minerRewards:0n,totalRewards:t}}catch{return{stakingRewards:0n,minerRewards:0n,totalRewards:0n}}}async function ru(){const e=c.stakingPoolContractPublic||c.stakingPoolContract;if(!e||!c.userAddress)return{netClaimAmount:0n,feeAmount:0n,discountPercent:0,totalRewards:0n,burnRateBps:0,nftBoost:0};const{totalRewards:t}=await Ni();if(t===0n)return{netClaimAmount:0n,feeAmount:0n,discountPercent:0,totalRewards:0n,burnRateBps:0,nftBoost:0};try{const a=await Z(e,"previewClaim",[c.userAddress],null);if(a){const n=a.totalRewards||a[0]||0n,i=a.burnAmount||a[1]||0n,s=a.referrerCut||a[2]||0n,r=a.userReceives||a[3]||0n,o=Number(a.burnRateBps||a[4]||0),l=Number(a.nftBoost||a[5]||0),d=i+s;return console.log("[Data] V9 Claim preview:",{totalRewards:Number(n)/1e18,burnAmount:Number(i)/1e18,referrerCut:Number(s)/1e18,userReceives:Number(r)/1e18,burnRateBps:o,nftBoost:l}),{netClaimAmount:r,feeAmount:d,burnAmount:i,referrerCut:s,discountPercent:l/100,totalRewards:n,burnRateBps:o,nftBoost:l,baseFeeBips:5e3,finalFeeBips:o}}}catch(a){console.error("[Data] previewClaim error:",a)}return{netClaimAmount:t,feeAmount:0n,discountPercent:0,totalRewards:t,burnRateBps:0,nftBoost:0}}let _n=!1,Fn=0,Da=0;const ou=3e4,lu=3,cu=12e4;async function Ct(e=!1){if(!c.userAddress)return[];const t=Date.now();if(_n)return c.myBoosters||[];if(!e&&t-Fn<ou)return c.myBoosters||[];if(Da>=lu){if(t-Fn<cu)return c.myBoosters||[];Da=0}_n=!0,Fn=t;try{const a=await fn(`${Ue.getBoosters}/${c.userAddress}`,5e3);if(!a.ok)throw new Error(`API Error: ${a.status}`);let n=await a.json();const i=["function ownerOf(uint256) view returns (address)","function getTokenInfo(uint256) view returns (address owner, uint8 tier, uint256 boostBips)"],s=mn(v.rewardBooster,i,c.rewardBoosterContractPublic);if(s&&n.length>0){const r=await Promise.all(n.slice(0,50).map(async o=>{const l=BigInt(o.tokenId),d=`ownerOf-${l}`,u=Date.now();let f=Number(o.boostBips||o.boost||0);if(f===0)try{const p=await s.getTokenInfo(l);f=Number(p.boostBips||p[2]||0)}catch{}if(!e&&Rn.has(d)){const p=Rn.get(d);if(u-p.timestamp<eu)return p.owner.toLowerCase()===c.userAddress.toLowerCase()?{tokenId:l,boostBips:f,imageUrl:o.imageUrl||o.image||null}:null}try{const p=await s.ownerOf(l);return Rn.set(d,{owner:p,timestamp:u}),p.toLowerCase()===c.userAddress.toLowerCase()?{tokenId:l,boostBips:f,imageUrl:o.imageUrl||o.image||null}:null}catch(p){return Ur(p)||jr(p)?{tokenId:l,boostBips:f,imageUrl:o.imageUrl||o.image||null}:null}}));c.myBoosters=r.filter(o=>o!==null)}else c.myBoosters=n.map(r=>({tokenId:BigInt(r.tokenId),boostBips:Number(r.boostBips||r.boost||0),imageUrl:r.imageUrl||r.image||null}));return Da=0,c.myBoosters}catch{return Da++,c.myBoosters||(c.myBoosters=[]),c.myBoosters}finally{_n=!1}}const du={apiKey:"AIzaSyDKhF2_--fKtot96YPS8twuD0UoCpS-3T4",authDomain:"airdropbackchainnew.firebaseapp.com",projectId:"airdropbackchainnew",storageBucket:"airdropbackchainnew.appspot.com",messagingSenderId:"108371799661",appId:"1:108371799661:web:d126fcbd0ba56263561964",measurementId:"G-QD9EBZ0Y09"},qr=Td(du),Oa=Cd(qr),W=Pd(qr);let at=null,Ie=null,Ha=null;async function Xr(e){if(!e)throw new Error("Wallet address is required for Firebase sign-in.");const t=e.toLowerCase();return Ie=t,at?(Ha=await ca(t),at):Oa.currentUser?(at=Oa.currentUser,Ha=await ca(t),at):new Promise((a,n)=>{const i=Id(Oa,async s=>{if(i(),s){at=s;try{Ha=await ca(t),a(s)}catch(r){console.error("Error linking airdrop user profile:",r),n(r)}}else Ad(Oa).then(async r=>{at=r.user,Ha=await ca(t),a(at)}).catch(r=>{console.error("Firebase Anonymous sign-in failed:",r),n(r)})},s=>{console.error("Firebase Auth state change error:",s),i(),n(s)})})}function Je(){if(!at)throw new Error("User not authenticated with Firebase. Please sign-in first.");if(!Ie)throw new Error("Wallet address not set. Please connect wallet first.")}async function Si(){const e=se(W,"airdrop_public_data","data_v1"),t=await ze(e);if(t.exists()){const a=t.data(),n=(a.dailyTasks||[]).map(r=>{var d,u;const o=(d=r.startDate)!=null&&d.toDate?r.startDate.toDate():r.startDate?new Date(r.startDate):null,l=(u=r.endDate)!=null&&u.toDate?r.endDate.toDate():r.endDate?new Date(r.endDate):null;return{...r,id:r.id||null,startDate:o instanceof Date&&!isNaN(o)?o:null,endDate:l instanceof Date&&!isNaN(l)?l:null}}).filter(r=>r.id),i=Date.now(),s=n.filter(r=>{const o=r.startDate?r.startDate.getTime():0,l=r.endDate?r.endDate.getTime():1/0;return o<=i&&i<l});return{config:a.config||{ugcBasePoints:{}},leaderboards:a.leaderboards||{top100ByPoints:[],top100ByPosts:[],lastUpdated:null},dailyTasks:s,platformUsageConfig:a.platformUsageConfig||null}}else return console.warn("Public airdrop data document 'airdrop_public_data/data_v1' not found. Returning defaults."),{config:{isActive:!1,roundName:"Loading...",ugcBasePoints:{}},leaderboards:{top100ByPoints:[],top100ByPosts:[],lastUpdated:null},dailyTasks:[],platformUsageConfig:null}}function Ws(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";let t="";for(let a=0;a<6;a++)t+=e.charAt(Math.floor(Math.random()*e.length));return t}function Ja(e){return e>=100?10:e>=90?9:e>=80?8:e>=70?7:e>=60?6:e>=50?5:e>=40?4:e>=30?3:e>=20?2:1}async function ca(e){Je(),e||(e=Ie);const t=e.toLowerCase(),a=se(W,"airdrop_users",t),n=await ze(a);if(n.exists()){const i=n.data(),s={};if(i.referralCode||(s.referralCode=Ws()),typeof i.approvedSubmissionsCount!="number"&&(s.approvedSubmissionsCount=0),typeof i.rejectedCount!="number"&&(s.rejectedCount=0),typeof i.isBanned!="boolean"&&(s.isBanned=!1),typeof i.totalPoints!="number"&&(s.totalPoints=0),typeof i.pointsMultiplier!="number"&&(s.pointsMultiplier=1),i.walletAddress!==t&&(s.walletAddress=t),Object.keys(s).length>0)try{return await un(a,s),{id:n.id,...i,...s}}catch(r){return console.error("Error updating user default fields:",r),{id:n.id,...i}}return{id:n.id,...i}}else{const i=Ws(),s={walletAddress:t,referralCode:i,totalPoints:0,pointsMultiplier:1,approvedSubmissionsCount:0,rejectedCount:0,isBanned:!1,createdAt:ut()};return await pn(a,s),{id:a.id,...s,createdAt:new Date}}}async function Jr(e,t){if(Je(),!e||typeof e!="string"||e.trim()==="")return console.warn(`isTaskEligible called with invalid taskId: ${e}`),{eligible:!1,timeLeft:0};const a=se(W,"airdrop_users",Ie,"task_claims",e),n=await ze(a),i=t*60*60*1e3;if(!n.exists())return{eligible:!0,timeLeft:0};const s=n.data(),r=s==null?void 0:s.timestamp;if(typeof r!="string"||r.trim()==="")return console.warn(`Missing/invalid timestamp for task ${e}. Allowing claim.`),{eligible:!0,timeLeft:0};try{const o=new Date(r);if(isNaN(o.getTime()))return console.warn(`Invalid timestamp format for task ${e}:`,r,". Allowing claim."),{eligible:!0,timeLeft:0};const l=o.getTime(),u=Date.now()-l;return u>=i?{eligible:!0,timeLeft:0}:{eligible:!1,timeLeft:i-u}}catch(o){return console.error(`Error parsing timestamp string for task ${e}:`,r,o),{eligible:!0,timeLeft:0}}}async function uu(e,t){if(Je(),!e||!e.id)throw new Error("Invalid task data provided.");if(!(await Jr(e.id,e.cooldownHours)).eligible)throw new Error("Cooldown period is still active for this task.");const n=se(W,"airdrop_users",Ie),i=Math.round(e.points);if(isNaN(i)||i<0)throw new Error("Invalid points value for the task.");await un(n,{totalPoints:Oe(i)});const s=se(W,"airdrop_users",Ie,"task_claims",e.id);return await pn(s,{timestamp:new Date().toISOString(),points:i}),i}async function pu(e){var o;const t=e.trim().toLowerCase();let a="Other",n=!0;if(t.includes("youtube.com/shorts/")){a="YouTube Shorts";const l=t.match(/\/shorts\/([a-zA-Z0-9_-]+)/);if(!l||!l[1])throw n=!1,new Error("Invalid YouTube Shorts URL: Video ID not found or incorrect format.")}else if(t.includes("youtube.com/watch?v=")||t.includes("youtu.be/")){a="YouTube";const l=t.match(/(?:v=|\/)([a-zA-Z0-9_-]{11})(?:[?&]|$)/);if(!l||l[1].length!==11)throw n=!1,new Error("Invalid YouTube URL: Video ID not found or incorrect format.")}else{if(t.includes("youtube.com/"))throw a="YouTube",n=!1,new Error("Invalid YouTube URL: Only video links (youtube.com/watch?v=... or youtu.be/...) or Shorts links are accepted.");if(t.includes("instagram.com/p/")||t.includes("instagram.com/reel/")){a="Instagram";const l=t.match(/\/(?:p|reel)\/([a-zA-Z0-9_.-]+)/);(!l||!l[1])&&(n=!1)}else t.includes("twitter.com/")||t.includes("x.com/")?t.match(/(\w+)\/(?:status|statuses)\/(\d+)/)&&(a="X/Twitter"):t.includes("facebook.com/")&&t.includes("/posts/")?a="Facebook":t.includes("t.me/")||t.includes("telegram.org/")?a="Telegram":t.includes("tiktok.com/")?a="TikTok":t.includes("reddit.com/r/")?a="Reddit":t.includes("linkedin.com/posts/")&&(a="LinkedIn")}const s=((o=(await Si()).config)==null?void 0:o.ugcBasePoints)||{},r=s[a]||s.Other||1e3;if(isNaN(r)||r<0)throw new Error(`Invalid base points configured for platform: ${a}. Please contact admin.`);return{platform:a,basePoints:r,isValid:n,normalizedUrl:t}}async function fu(e){var re;Je();const t=se(W,"airdrop_users",Ie),a=qe(W,"airdrop_users",Ie,"submissions"),n=qe(W,"all_submissions_log"),i=e.trim();if(!i||!i.toLowerCase().startsWith("http://")&&!i.toLowerCase().startsWith("https://"))throw new Error("The provided URL must start with http:// or https://.");let s;try{s=await pu(i)}catch(J){throw J}const{platform:r,basePoints:o,isValid:l,normalizedUrl:d}=s;if(!l)throw new Error(`The provided URL for ${r} does not appear valid for submission.`);const u=Bt(a,Jt("submittedAt","desc"),zd(1)),f=await dt(u);if(!f.empty){const ye=(re=f.docs[0].data().submittedAt)==null?void 0:re.toDate();if(ye){const ue=new Date,Y=5*60*1e3,te=ue.getTime()-ye.getTime();if(te<Y){const Ne=Y-te,ht=Math.ceil(Ne/6e4);throw new Error(`We're building a strong community, and we value quality over quantity. To prevent spam, please wait ${ht} more minute(s) before submitting another post. We appreciate your thoughtful contribution!`)}}}const p=Bt(n,Xa("normalizedUrl","==",d),Xa("status","in",["pending","approved","auditing","flagged_suspicious"]));if(!(await dt(p)).empty)throw new Error("This content link has already been submitted. Repeatedly submitting duplicate or fraudulent content may lead to account suspension.");const b=await ze(t);if(!b.exists())throw new Error("User profile not found.");const w=b.data(),T=w.approvedSubmissionsCount||0,C=Ja(T),P=Math.round(o*C),S=ut(),L={url:i,platform:r,status:"pending",basePoints:o,_pointsCalculated:P,_multiplierApplied:C,pointsAwarded:0,submittedAt:S,resolvedAt:null},B={userId:Ie,walletAddress:w.walletAddress,normalizedUrl:d,platform:r,status:"pending",basePoints:o,submittedAt:S,resolvedAt:null},I=dn(W),_=se(a);I.set(_,L);const D=se(n,_.id);I.set(D,B),await I.commit()}async function mu(){Je();const e=qe(W,"airdrop_users",Ie,"submissions"),t=Bt(e,Jt("submittedAt","desc"));return(await dt(t)).docs.map(n=>{var s,r;const i=n.data();return{submissionId:n.id,...i,submittedAt:(s=i.submittedAt)!=null&&s.toDate?i.submittedAt.toDate():null,resolvedAt:(r=i.resolvedAt)!=null&&r.toDate?i.resolvedAt.toDate():null}})}async function gu(e){Je();const t=Ie,a=se(W,"airdrop_users",t),n=se(W,"airdrop_users",t,"submissions",e),i=se(W,"all_submissions_log",e),s=await ze(n);if(!s.exists())throw new Error("Cannot confirm submission: Document not found or already processed.");const r=s.data(),o=r.status;if(o==="approved"||o==="rejected")throw new Error(`Submission is already in status: ${o}.`);let l=r._pointsCalculated,d=r._multiplierApplied;if(typeof l!="number"||isNaN(l)||l<=0){console.warn(`[ConfirmSubmission] Legacy/Invalid submission ${e} missing/invalid _pointsCalculated. Recalculating...`);const f=r.basePoints||0,p=await ze(a);if(!p.exists())throw new Error("User profile not found for recalculation.");const b=p.data().approvedSubmissionsCount||0;d=Ja(b),l=Math.round(f*d),(isNaN(l)||l<=0)&&(console.warn(`[ConfirmSubmission] Recalculation failed (basePoints: ${f}). Using fallback 1000.`),l=Math.round(1e3*d))}const u=dn(W);u.update(a,{totalPoints:Oe(l),approvedSubmissionsCount:Oe(1)}),u.update(n,{status:"approved",pointsAwarded:l,_pointsCalculated:l,_multiplierApplied:d,resolvedAt:ut()}),await ze(i).then(f=>f.exists())&&u.update(i,{status:"approved",resolvedAt:ut()}),await u.commit()}async function Zr(e){Je();const a=se(W,"airdrop_users",Ie,"submissions",e),n=se(W,"all_submissions_log",e),i=await ze(a);if(!i.exists())return console.warn(`Delete submission skipped: Document ${e} not found.`);const s=i.data().status;if(s==="approved"||s==="rejected")throw new Error(`This submission was already ${s} and cannot be deleted.`);if(s==="flagged_suspicious")throw new Error("Flagged submissions must be resolved, not deleted.");const r=dn(W);r.update(a,{status:"deleted_by_user",resolvedAt:ut()}),await ze(n).then(o=>o.exists())&&r.update(n,{status:"deleted_by_user",resolvedAt:ut(),pointsAwarded:0}),await r.commit()}async function bu(e){const t=se(W,"airdrop_public_data","data_v1");await pn(t,{config:{ugcBasePoints:e}},{merge:!0})}async function xu(){const e=qe(W,"daily_tasks"),t=Bt(e,Jt("endDate","asc"));return(await dt(t)).docs.map(n=>{var i,s;return{id:n.id,...n.data(),startDate:(i=n.data().startDate)!=null&&i.toDate?n.data().startDate.toDate():null,endDate:(s=n.data().endDate)!=null&&s.toDate?n.data().endDate.toDate():null}})}async function hu(e){const t={...e};t.startDate instanceof Date&&(t.startDate=$s.fromDate(t.startDate)),t.endDate instanceof Date&&(t.endDate=$s.fromDate(t.endDate));const a=e.id;if(!a)delete t.id,await Bd(qe(W,"daily_tasks"),t);else{const n=se(W,"daily_tasks",a);delete t.id,await pn(n,t,{merge:!0})}}async function vu(e){if(!e)throw new Error("Task ID is required for deletion.");await Nd(se(W,"daily_tasks",e))}async function wu(){const e=qe(W,"all_submissions_log"),t=Bt(e,Xa("status","in",["pending","auditing","flagged_suspicious"]),Jt("submittedAt","desc"));return(await dt(t)).docs.map(n=>{var s,r;const i=n.data();return{userId:i.userId,walletAddress:i.walletAddress,submissionId:n.id,...i,submittedAt:(s=i.submittedAt)!=null&&s.toDate?i.submittedAt.toDate():null,resolvedAt:(r=i.resolvedAt)!=null&&r.toDate?i.resolvedAt.toDate():null}})}async function Qr(e,t,a){var C,P,S;if(!e)throw new Error("User ID (walletAddress) is required.");const n=e.toLowerCase(),i=se(W,"airdrop_users",n),s=se(W,"airdrop_users",n,"submissions",t),r=se(W,"all_submissions_log",t),[o,l,d]=await Promise.all([ze(i),ze(s),ze(r)]);if(!l.exists())throw new Error("Submission not found in user collection.");if(!o.exists())throw new Error("User profile not found.");d.exists()||console.warn(`Log entry ${t} not found. Log will not be updated.`);const u=l.data(),f=o.data(),p=u.status;if(p===a){console.warn(`Admin action ignored: Submission ${t} already has status ${a}.`);return}const g=dn(W),b={};let w=0,T=u._multiplierApplied||0;if(a==="approved"){let L=u._pointsCalculated;if(typeof L!="number"||isNaN(L)||L<=0){console.warn(`[Admin] Legacy/Invalid submission ${t} missing/invalid _pointsCalculated. Recalculating...`);const B=u.basePoints||0,I=f.approvedSubmissionsCount||0,_=Ja(I);if(L=Math.round(B*_),isNaN(L)||L<=0){console.warn(`[Admin] Recalculation failed (basePoints: ${B}). Using fallback 1000.`);const D=Ja(I);L=Math.round(1e3*D)}T=_}w=L,b.totalPoints=Oe(L),b.approvedSubmissionsCount=Oe(1),p==="rejected"&&(b.rejectedCount=Oe(-1))}else if(a==="rejected"){if(p!=="rejected"){const L=f.rejectedCount||0;b.rejectedCount=Oe(1),L+1>=3&&(b.isBanned=!0)}else if(p==="approved"){const L=u.pointsAwarded||0;b.totalPoints=Oe(-L),b.approvedSubmissionsCount=Oe(-1);const B=f.rejectedCount||0;b.rejectedCount=Oe(1),B+1>=3&&(b.isBanned=!0)}w=0}if(((C=b.approvedSubmissionsCount)==null?void 0:C.operand)<0&&(f.approvedSubmissionsCount||0)<=0&&(b.approvedSubmissionsCount=0),((P=b.rejectedCount)==null?void 0:P.operand)<0&&(f.rejectedCount||0)<=0&&(b.rejectedCount=0),((S=b.totalPoints)==null?void 0:S.operand)<0){const L=f.totalPoints||0,B=Math.abs(b.totalPoints.operand);L<B&&(b.totalPoints=0)}Object.keys(b).length>0&&g.update(i,b),g.update(s,{status:a,pointsAwarded:w,_pointsCalculated:a==="approved"?w:u._pointsCalculated||0,_multiplierApplied:T,resolvedAt:ut()}),d.exists()&&g.update(r,{status:a,resolvedAt:ut()}),await g.commit()}async function yu(){const e=qe(W,"airdrop_users"),t=Bt(e,Jt("totalPoints","desc"));return(await dt(t)).docs.map(n=>({id:n.id,...n.data()}))}async function ku(e,t){if(!e)throw new Error("User ID is required.");const a=e.toLowerCase(),n=qe(W,"airdrop_users",a,"submissions"),i=Bt(n,Xa("status","==",t),Jt("resolvedAt","desc"));return(await dt(i)).docs.map(r=>{var o,l;return{submissionId:r.id,userId:a,...r.data(),submittedAt:(o=r.data().submittedAt)!=null&&o.toDate?r.data().submittedAt.toDate():null,resolvedAt:(l=r.data().resolvedAt)!=null&&l.toDate?r.data().resolvedAt.toDate():null}})}async function eo(e,t){if(!e)throw new Error("User ID is required.");const a=e.toLowerCase(),n=se(W,"airdrop_users",a),i={isBanned:t};t===!1&&(i.rejectedCount=0),await un(n,i)}async function Gs(){Je();try{const e=qe(W,"airdrop_users",Ie,"platform_usage"),t=await dt(e),a={};return t.forEach(n=>{a[n.id]=n.data()}),a}catch(e){return console.error("Error fetching platform usage:",e),{}}}async function to(e){Je();const t=se(W,"airdrop_public_data","data_v1");await un(t,{platformUsageConfig:e}),console.log("✅ Platform usage config saved:",e)}const O=window.ethers,ao=421614,Eu="0x66eee";let $e=null,Ks=0,nt=0;const Tu=5e3,Ys=3,Cu=3e4;let $i=0;const Iu=3;let no=null;const Au="cd4bdedee7a7e909ebd3df8bbc502aed",Pu={chainId:Te.chainIdDecimal,name:Te.chainName,currency:Te.nativeCurrency.symbol,explorerUrl:Te.blockExplorerUrls[0],rpcUrl:Te.rpcUrls[0]},zu={name:"Backcoin Protocol",description:"DeFi Ecosystem",url:window.location.origin,icons:[window.location.origin+"/assets/bkc_logo_3d.png"]},Bu=kd({metadata:zu,enableEIP6963:!0,enableInjected:!0,enableCoinbase:!1,rpcUrl:Mr,defaultChainId:ao,enableEmail:!0,enableEns:!1,auth:{email:!0,showWallets:!0,walletFeatures:!0}}),Et=Ed({ethersConfig:Bu,chains:[Pu],projectId:Au,enableAnalytics:!0,themeMode:"dark",themeVariables:{"--w3m-accent":"#f59e0b","--w3m-border-radius-master":"1px","--w3m-z-index":100}});function Nu(e){var n,i;const t=((n=e==null?void 0:e.message)==null?void 0:n.toLowerCase())||"",a=(e==null?void 0:e.code)||((i=e==null?void 0:e.error)==null?void 0:i.code);return a===-32603||a===-32e3||a===429||t.includes("failed to fetch")||t.includes("network error")||t.includes("timeout")||t.includes("rate limit")||t.includes("too many requests")||t.includes("internal json-rpc")||t.includes("unexpected token")||t.includes("<html")}function ai(e){return new O.JsonRpcProvider(e||va())}async function io(e,t=Iu){var n;let a=null;for(let i=0;i<t;i++)try{const s=await e();return Dd(va()),$i=0,s}catch(s){if(a=s,Nu(s)){console.warn(`⚠️ RPC error (attempt ${i+1}/${t}):`,(n=s.message)==null?void 0:n.slice(0,80)),Md(va());const r=Dr();console.log(`🔄 Switching to: ${r}`),await ya(),await new Promise(o=>setTimeout(o,500*(i+1)))}else throw s}throw console.error("❌ All RPC attempts failed"),a}async function ya(){const e=va();try{c.publicProvider=ai(e),no=c.publicProvider;const t=c.publicProvider;G(v.bkcToken)&&(c.bkcTokenContractPublic=new O.Contract(v.bkcToken,Ei,t)),G(v.backchainEcosystem)&&(c.ecosystemManagerContractPublic=new O.Contract(v.backchainEcosystem,Pi,t)),G(v.stakingPool)&&(c.stakingPoolContractPublic=new O.Contract(v.stakingPool,Ti,t)),G(v.buybackMiner)&&(c.buybackMinerContractPublic=new O.Contract(v.buybackMiner,zi,t)),G(v.fortunePool)&&(c.fortunePoolContractPublic=new O.Contract(v.fortunePool,Ci,t)),G(v.agora)&&(c.agoraContractPublic=new O.Contract(v.agora,Aa,t)),G(v.notary)&&(c.notaryContractPublic=new O.Contract(v.notary,Ii,t)),G(v.charityPool)&&(c.charityPoolContractPublic=new O.Contract(v.charityPool,Bi,t)),G(v.rentalManager)&&(c.rentalManagerContractPublic=new O.Contract(v.rentalManager,Ia,t)),G(v.faucet)&&(c.faucetContractPublic=new O.Contract(v.faucet,Ai,t)),console.log(`✅ Public provider recreated with: ${e.slice(0,50)}...`)}catch(t){console.error("Failed to recreate public provider:",t)}}function Su(e){if(!e)return!1;try{return O.isAddress(e)}catch{return!1}}function G(e){return e&&e!==O.ZeroAddress&&!e.startsWith("0x...")}function $u(e){if(!e)return;const t=localStorage.getItem(`balance_${e.toLowerCase()}`);if(t)try{c.currentUserBalance=BigInt(t),window.updateUIState&&window.updateUIState()}catch{}}function Lu(e){try{const t=e;G(v.bkcToken)&&(c.bkcTokenContract=new O.Contract(v.bkcToken,Ei,t)),G(v.backchainEcosystem)&&(c.ecosystemManagerContract=new O.Contract(v.backchainEcosystem,Pi,t)),G(v.stakingPool)&&(c.stakingPoolContract=new O.Contract(v.stakingPool,Ti,t)),G(v.buybackMiner)&&(c.buybackMinerContract=new O.Contract(v.buybackMiner,zi,t)),G(v.rewardBooster)&&(c.rewardBoosterContract=new O.Contract(v.rewardBooster,Gd,t)),G(v.fortunePool)&&(c.fortunePoolContract=new O.Contract(v.fortunePool,Ci,t)),G(v.agora)&&(c.agoraContract=new O.Contract(v.agora,Aa,t)),G(v.notary)&&(c.notaryContract=new O.Contract(v.notary,Ii,t)),G(v.charityPool)&&(c.charityPoolContract=new O.Contract(v.charityPool,Bi,t)),G(v.rentalManager)&&(c.rentalManagerContract=new O.Contract(v.rentalManager,Ia,t)),G(v.faucet)&&(c.faucetContract=new O.Contract(v.faucet,Ai,t))}catch{console.warn("Contract init partial failure")}}function so(){if($e&&(clearInterval($e),$e=null),!c.bkcTokenContractPublic||!c.userAddress){console.warn("Cannot start balance polling: missing contract or address");return}nt=0,$i=0,setTimeout(()=>{Vs()},1e3),$e=setInterval(Vs,Cu),console.log("✅ Balance polling started (30s interval)")}async function Vs(){var t;if(document.hidden||!c.isConnected||!c.userAddress||!c.bkcTokenContractPublic)return;const e=Date.now();try{const a=await io(async()=>await c.bkcTokenContractPublic.balanceOf(c.userAddress),2);nt=0;const n=c.currentUserBalance||0n;a.toString()!==n.toString()&&(c.currentUserBalance=a,localStorage.setItem(`balance_${c.userAddress.toLowerCase()}`,a.toString()),e-Ks>Tu&&(Ks=e,window.updateUIState&&window.updateUIState(!1)))}catch(a){nt++,nt<=3&&console.warn(`⚠️ Balance check failed (${nt}/${Ys}):`,(t=a.message)==null?void 0:t.slice(0,50)),nt>=Ys&&(console.warn("❌ Too many balance check errors. Stopping polling temporarily."),$e&&(clearInterval($e),$e=null),setTimeout(()=>{console.log("🔄 Attempting to restart balance polling with primary RPC..."),Od(),ya().then(()=>{nt=0,so()})},6e4))}}async function Ru(e){try{const t=await e.getNetwork();if(Number(t.chainId)===ao)return!0;try{return await e.send("wallet_switchEthereumChain",[{chainId:Eu}]),!0}catch{return!0}}catch{return!0}}async function qs(e,t){try{if(!Su(t))return!1;await Ru(e),c.provider=e;try{c.signer=await e.getSigner()}catch(a){c.signer=e,console.warn(`Could not get standard Signer. Using Provider as read-only. Warning: ${a.message}`)}c.userAddress=t,c.isConnected=!0,$u(t),Lu(c.signer);try{Xr(c.userAddress)}catch{}return gn().then(()=>{window.updateUIState&&window.updateUIState(!1)}).catch(()=>{}),so(),!0}catch(a){return console.error("Setup warning:",a),!!t}}async function _u(){try{if(window.ethereum){const a=await qd();a.fixed?console.log("✅ MetaMask network config was auto-fixed"):!a.success&&!a.skipped&&console.warn("Initial network config check:",a.error)}const e=va();console.log(`🌐 Initializing public provider with: ${e.slice(0,50)}...`),c.publicProvider=ai(e),no=c.publicProvider;const t=c.publicProvider;G(v.bkcToken)&&(c.bkcTokenContractPublic=new O.Contract(v.bkcToken,Ei,t)),G(v.backchainEcosystem)&&(c.ecosystemManagerContractPublic=new O.Contract(v.backchainEcosystem,Pi,t)),G(v.stakingPool)&&(c.stakingPoolContractPublic=new O.Contract(v.stakingPool,Ti,t)),G(v.buybackMiner)&&(c.buybackMinerContractPublic=new O.Contract(v.buybackMiner,zi,t)),G(v.fortunePool)&&(c.fortunePoolContractPublic=new O.Contract(v.fortunePool,Ci,t)),G(v.agora)&&(c.agoraContractPublic=new O.Contract(v.agora,Aa,t)),G(v.notary)&&(c.notaryContractPublic=new O.Contract(v.notary,Ii,t)),G(v.charityPool)&&(c.charityPoolContractPublic=new O.Contract(v.charityPool,Bi,t)),G(v.rentalManager)&&(c.rentalManagerContractPublic=new O.Contract(v.rentalManager,Ia,t)),G(v.faucet)&&(c.faucetContractPublic=new O.Contract(v.faucet,Ai,t));try{await io(async()=>{await Gr()})}catch{console.warn("Initial public data load failed, will retry on user interaction")}Xd(async a=>{a.isCorrectNetwork?(await wa()).healthy||(console.log("⚠️ RPC issues after network change, updating..."),await Gt(),await ya()):(console.log("⚠️ User switched to wrong network"),x("Please switch back to Arbitrum Sepolia","warning"))}),Du(),window.updateUIState&&window.updateUIState(),console.log("✅ Public provider initialized")}catch(e){console.error("Public provider error:",e),window.ethereum&&await Gt();const t=Dr();console.log(`🔄 Retrying with: ${t}`);try{c.publicProvider=ai(t),console.log("✅ Public provider initialized with fallback RPC")}catch{console.error("❌ All RPC endpoints failed")}}}function Fu(e){let t=Et.getAddress();if(Et.getIsConnected()&&t){const n=Et.getWalletProvider();if(n){const i=new O.BrowserProvider(n);c.web3Provider=n,e({isConnected:!0,address:t,isNewConnection:!1}),qs(i,t)}}const a=async({provider:n,address:i,chainId:s,isConnected:r})=>{try{if(r){let o=i||Et.getAddress();if(!o&&n)try{o=await(await new O.BrowserProvider(n).getSigner()).getAddress()}catch{}if(o){const l=new O.BrowserProvider(n);c.web3Provider=n,e({isConnected:!0,address:o,chainId:s,isNewConnection:!0}),await qs(l,o)}else $e&&clearInterval($e),c.isConnected=!1,c.userAddress=null,c.signer=null,e({isConnected:!1})}else $e&&clearInterval($e),c.isConnected=!1,c.userAddress=null,c.signer=null,e({isConnected:!1})}catch{}};Et.subscribeProvider(a)}function ro(){Et.open()}async function Mu(){await Et.disconnect()}let Mn=null;function Du(){Mn&&clearInterval(Mn);let e=0;Mn=setInterval(async()=>{if(document.hidden||!c.isConnected)return;const t=await wa();if(!t.healthy){const a=Date.now();if(a-e<3e5)return;e=a,console.log(`⚠️ RPC health check failed (${t.reason}), attempting fix...`),await Gt()&&(console.log("✅ MetaMask RPCs updated via health monitor"),await ya(),nt=0,$i=0)}},6e4),document.addEventListener("visibilitychange",async()=>{if(!document.hidden&&c.isConnected){const t=Date.now();if(t-e<3e5)return;(await wa()).healthy||(e=t,console.log("⚠️ RPC unhealthy on tab focus, fixing..."),await Gt(),await ya())}}),console.log("✅ RPC health monitoring started (30s interval)")}const Ou=window.ethers,F=(e,t=18)=>{if(e===null||typeof e>"u")return 0;if(typeof e=="number")return e;if(typeof e=="string")return parseFloat(e);try{const a=BigInt(e);return parseFloat(Ou.formatUnits(a,t))}catch{return 0}},Zt=e=>!e||typeof e!="string"||!e.startsWith("0x")?"...":`${e.substring(0,6)}...${e.substring(e.length-4)}`,Kt=e=>{try{if(e==null)return"0";const t=typeof e=="bigint"?e:BigInt(e);if(t<1000n)return t.toString();const a=Number(t);if(!isFinite(a))return t.toLocaleString("en-US");const n=["","k","M","B","T"],i=Math.floor((""+Math.floor(a)).length/3);let s=parseFloat((i!==0?a/Math.pow(1e3,i):a).toPrecision(3));return s%1!==0&&(s=s.toFixed(2)),s+n[i]}catch{return"0"}},Hu=(e="An error occurred.")=>`<div class="bg-red-900/20 border border-red-500/30 rounded-lg p-4 text-center text-red-400 text-sm">${e}</div>`,Uu=(e="No data available.")=>`<div class="text-center p-8 bg-zinc-900/30 border border-dashed border-zinc-800 rounded-lg col-span-full">
    ...
    `;e.innerHTML=i,e.querySelectorAll(".pagination-btn").forEach(s=>{s.addEventListener("click",()=>{s.hasAttribute("disabled")||n(parseInt(s.dataset.page))})})}const ju="modulepreload",Wu=function(e){return"/"+e},Xs={},K=function(t,a,n){let i=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),o=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));i=Promise.allSettled(a.map(l=>{if(l=Wu(l),l in Xs)return;Xs[l]=!0;const d=l.endsWith(".css"),u=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${u}`))return;const f=document.createElement("link");if(f.rel=d?"stylesheet":ju,d||(f.as="script"),f.crossOrigin="",f.href=l,o&&f.setAttribute("nonce",o),document.head.appendChild(f),d)return new Promise((p,g)=>{f.addEventListener("load",p),f.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${l}`)))})}))}function s(r){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=r,window.dispatchEvent(o),!o.defaultPrevented)throw r}return i.then(r=>{for(const o of r||[])o.status==="rejected"&&s(o.reason);return t().catch(s)})},oo="https://faucet-4wvdcuoouq-uc.a.run.app";function bn(){var e;return(v==null?void 0:v.faucet)||(M==null?void 0:M.faucet)||((e=window.contractAddresses)==null?void 0:e.faucet)||null}const Za=["function claim() external","function canClaim(address user) view returns (bool)","function getUserInfo(address user) view returns (bool canClaimNow, uint256 lastClaim, uint256 nextClaim, uint256 tokensAvailable)","function cooldown() view returns (uint256)","function tokensPerClaim() view returns (uint256)","function ethPerClaim() view returns (uint256)","function getFaucetStatus() view returns (uint256 _tokensPerClaim, uint256 _ethPerClaim, uint256 _cooldown, uint256 bkcBalance, uint256 ethBalance, bool isPaused)","function getStats() view returns (uint256 totalClaims, uint256 totalBkcDistributed, uint256 totalEthDistributed)","event TokensClaimed(address indexed user, uint256 bkcAmount, uint256 ethAmount)"];function Gu(){var e,t;return typeof State<"u"&&(State!=null&&State.userAddress)?State.userAddress:(e=window.State)!=null&&e.userAddress?window.State.userAddress:window.userAddress?window.userAddress:(t=window.ethereum)!=null&&t.selectedAddress?window.ethereum.selectedAddress:null}function It(e,t="info"){if(typeof window.showToast=="function"){window.showToast(e,t);return}(t==="error"?console.error:console.log)(`[Faucet] ${e}`)}async function lo(){if(typeof window.loadUserData=="function"){await window.loadUserData();return}if(typeof window.refreshBalances=="function"){await window.refreshBalances();return}}async function Ri({button:e=null,address:t=null,onSuccess:a=null,onError:n=null}={}){const i=t||Gu();if(!i){const o="Please connect wallet first";return It(o,"error"),n&&n(new Error(o)),{success:!1,error:o}}const s=(e==null?void 0:e.innerHTML)||"Claim",r=(e==null?void 0:e.disabled)||!1;e&&(e.innerHTML='<div class="loader inline-block"></div> Claiming...',e.disabled=!0);try{const o=await fetch(`${oo}?address=${i}`,{method:"GET",headers:{Accept:"application/json"}}),l=await o.json();if(o.ok&&l.success){It("Tokens received!","success"),await lo();const d={success:!0,txHash:l.txHash,bkcAmount:l.bkcAmount,ethAmount:l.ethAmount};return a&&a(d),d}else{const d=l.error||l.message||"Faucet unavailable";It(d,"error");const u=new Error(d);return n&&n(u),{success:!1,error:d}}}catch(o){return console.error("Faucet error:",o),It("Faucet unavailable","error"),n&&n(o),{success:!1,error:o.message}}finally{e&&(e.innerHTML=s,e.disabled=r)}}const _i=async e=>await Ri({button:e});async function co({button:e=null,onSuccess:t=null,onError:a=null}={}){const n=bn();if(!n){const s="Faucet contract address not configured";return It(s,"error"),a&&a(new Error(s)),{success:!1,error:s}}const{txEngine:i}=await K(async()=>{const{txEngine:s}=await import("./index-CalnOfTr.js");return{txEngine:s}},[]);return await i.execute({name:"FaucetClaim",button:e,getContract:async s=>{const r=window.ethers;return new r.Contract(n,Za,s)},method:"claim",args:[],validate:async(s,r)=>{const o=window.ethers,{NetworkManager:l}=await K(async()=>{const{NetworkManager:f}=await import("./index-CalnOfTr.js");return{NetworkManager:f}},[]),d=l.getProvider(),u=new o.Contract(n,Za,d);try{const f=await u.getUserInfo(r);if(!f.canClaimNow){const p=Math.floor(Date.now()/1e3),g=Number(f.nextClaim)-p;if(g>0){const b=Math.ceil(g/60);throw new Error(`Please wait ${b} minutes before claiming again`)}}}catch(f){if(f.message.includes("wait"))throw f;if(!await u.canClaim(r))throw new Error("Cannot claim yet. Please wait for cooldown.")}},onSuccess:async s=>{It("Tokens received!","success"),await lo(),t&&t(s)},onError:s=>{It(s.message||"Claim failed","error"),a&&a(s)}})}async function uo(e){const t=bn();if(!t)return{canClaim:!1,error:"Faucet not configured"};try{const a=window.ethers,{NetworkManager:n}=await K(async()=>{const{NetworkManager:r}=await import("./index-CalnOfTr.js");return{NetworkManager:r}},[]),i=n.getProvider(),s=new a.Contract(t,Za,i);try{const r=await s.getUserInfo(e),o=Math.floor(Date.now()/1e3);return{canClaim:r.canClaimNow,lastClaimTime:Number(r.lastClaim),nextClaimTime:Number(r.nextClaim),tokensAvailable:r.tokensAvailable,waitSeconds:r.canClaimNow?0:Math.max(0,Number(r.nextClaim)-o)}}catch{return{canClaim:await s.canClaim(e),waitSeconds:0}}}catch(a){return console.error("Error checking claim status:",a),{canClaim:!1,error:a.message}}}async function po(){const e=bn();if(!e)return{error:"Faucet not configured"};try{const t=window.ethers,{NetworkManager:a}=await K(async()=>{const{NetworkManager:s}=await import("./index-CalnOfTr.js");return{NetworkManager:s}},[]),n=a.getProvider(),i=new t.Contract(e,Za,n);try{const s=await i.getFaucetStatus();return{bkcAmount:s._tokensPerClaim||s[0],ethAmount:s._ethPerClaim||s[1],cooldownSeconds:Number(s._cooldown||s[2]),cooldownMinutes:Number(s._cooldown||s[2])/60,bkcAmountFormatted:t.formatEther(s._tokensPerClaim||s[0]),ethAmountFormatted:t.formatEther(s._ethPerClaim||s[1]),bkcBalance:s.bkcBalance||s[3],ethBalance:s.ethBalance||s[4],isPaused:s.isPaused||s[5]||!1}}catch{const[s,r,o]=await Promise.all([i.tokensPerClaim(),i.ethPerClaim(),i.cooldown()]);return{bkcAmount:s,ethAmount:r,cooldownSeconds:Number(o),cooldownMinutes:Number(o)/60,bkcAmountFormatted:t.formatEther(s),ethAmountFormatted:t.formatEther(r)}}}catch(t){return console.error("Error getting faucet info:",t),{error:t.message}}}const Ku={claim:Ri,claimOnChain:co,executeFaucetClaim:_i,canClaim:uo,getFaucetInfo:po,getFaucetAddress:bn,FAUCET_API_URL:oo},Yu=Object.freeze(Object.defineProperty({__proto__:null,FaucetTx:Ku,canClaim:uo,claim:Ri,claimOnChain:co,executeFaucetClaim:_i,getFaucetInfo:po},Symbol.toStringTag,{value:"Module"})),Dn={BALANCE:1e4,ALLOWANCE:3e4},ke=new Map,oe={hits:0,misses:0,sets:0,invalidations:0},zt={get(e){const t=ke.get(e);if(!t){oe.misses++;return}if(Date.now()>t.expiresAt){ke.delete(e),oe.misses++;return}return oe.hits++,t.value},set(e,t,a){t!=null&&(ke.set(e,{value:t,expiresAt:Date.now()+a,createdAt:Date.now()}),oe.sets++)},delete(e){ke.delete(e)},clear(e){if(!e){ke.clear(),oe.invalidations++;return}for(const t of ke.keys())t.includes(e)&&ke.delete(t);oe.invalidations++},async getOrFetch(e,t,a){const n=this.get(e);if(n!==void 0)return n;try{const i=await t();return i!=null&&this.set(e,i,a),i}catch(i){throw console.warn(`[Cache] Error fetching ${e}:`,i.message),i}},has(e){return this.get(e)!==void 0},getTTL(e){const t=ke.get(e);if(!t)return 0;const a=t.expiresAt-Date.now();return a>0?a:0},invalidateByTx(e){const a={CreateCampaign:["campaign-","charity-stats","user-campaigns-","campaign-list"],Donate:["campaign-","charity-stats","token-balance-","allowance-"],CancelCampaign:["campaign-","charity-stats","user-campaigns-"],Withdraw:["campaign-","charity-stats","token-balance-"],Delegate:["delegation-","token-balance-","allowance-","user-pstake-","pending-rewards-","network-pstake"],Unstake:["delegation-","token-balance-","user-pstake-","pending-rewards-","network-pstake"],ForceUnstake:["delegation-","token-balance-","user-pstake-","pending-rewards-","network-pstake"],ClaimReward:["pending-rewards-","token-balance-","saved-rewards-"],BuyNFT:["pool-info-","pool-nfts-","token-balance-","allowance-","user-nfts-","buy-price-","sell-price-"],SellNFT:["pool-info-","pool-nfts-","token-balance-","user-nfts-","buy-price-","sell-price-"],PlayGame:["fortune-pool-","fortune-stats-","token-balance-","allowance-","user-fortune-history-"],ListNFT:["rental-listings-","rental-listing-","user-nfts-"],RentNFT:["rental-listing-","rental-active-","token-balance-","allowance-"],WithdrawNFT:["rental-listing-","rental-listings-","user-nfts-"],UpdateListing:["rental-listing-"],Notarize:["notary-","token-balance-","allowance-","user-documents-"],TokenTransfer:["token-balance-","allowance-"],Approval:["allowance-"]}[e];if(!a){console.warn(`[Cache] Unknown transaction type: ${e}`);return}a.forEach(n=>{this.clear(n)}),console.log(`[Cache] Invalidated patterns for ${e}:`,a)},getStats(){const e=ke.size,t=oe.hits+oe.misses>0?(oe.hits/(oe.hits+oe.misses)*100).toFixed(1):0;return{entries:e,hits:oe.hits,misses:oe.misses,sets:oe.sets,invalidations:oe.invalidations,hitRate:`${t}%`}},keys(){return Array.from(ke.keys())},size(){return ke.size},cleanup(){const e=Date.now();let t=0;for(const[a,n]of ke.entries())e>n.expiresAt&&(ke.delete(a),t++);return t>0&&console.log(`[Cache] Cleanup removed ${t} expired entries`),t},resetMetrics(){oe.hits=0,oe.misses=0,oe.sets=0,oe.invalidations=0}},On={tokenBalance:(e,t)=>`token-balance-${e.toLowerCase()}-${t.toLowerCase()}`,ethBalance:e=>`eth-balance-${e.toLowerCase()}`,allowance:(e,t,a)=>`allowance-${e.toLowerCase()}-${t.toLowerCase()}-${a.toLowerCase()}`,campaign:e=>`campaign-${e}`,campaignList:()=>"campaign-list",charityStats:()=>"charity-stats",userCampaigns:e=>`user-campaigns-${e.toLowerCase()}`,delegation:(e,t)=>`delegation-${e.toLowerCase()}-${t}`,delegations:e=>`delegation-list-${e.toLowerCase()}`,userPStake:e=>`user-pstake-${e.toLowerCase()}`,pendingRewards:e=>`pending-rewards-${e.toLowerCase()}`,networkPStake:()=>"network-pstake",poolInfo:e=>`pool-info-${e.toLowerCase()}`,poolNfts:e=>`pool-nfts-${e.toLowerCase()}`,buyPrice:e=>`buy-price-${e.toLowerCase()}`,sellPrice:e=>`sell-price-${e.toLowerCase()}`,userNfts:e=>`user-nfts-${e.toLowerCase()}`,fortunePool:()=>"fortune-pool",fortuneTiers:()=>"fortune-tiers",fortuneStats:()=>"fortune-stats",userFortuneHistory:e=>`user-fortune-history-${e.toLowerCase()}`,rentalListings:()=>"rental-listings",rentalListing:e=>`rental-listing-${e}`,rentalActive:e=>`rental-active-${e}`,notaryDocument:e=>`notary-doc-${e}`,userDocuments:e=>`user-documents-${e.toLowerCase()}`,feeConfig:e=>`fee-config-${e}`,protocolConfig:()=>"protocol-config"},h={WRONG_NETWORK:"wrong_network",RPC_UNHEALTHY:"rpc_unhealthy",RPC_RATE_LIMITED:"rpc_rate_limited",NETWORK_ERROR:"network_error",WALLET_NOT_CONNECTED:"wallet_not_connected",WALLET_LOCKED:"wallet_locked",INSUFFICIENT_ETH:"insufficient_eth",INSUFFICIENT_TOKEN:"insufficient_token",INSUFFICIENT_ALLOWANCE:"insufficient_allowance",SIMULATION_REVERTED:"simulation_reverted",GAS_ESTIMATION_FAILED:"gas_estimation_failed",USER_REJECTED:"user_rejected",TX_REVERTED:"tx_reverted",TX_TIMEOUT:"tx_timeout",TX_REPLACED:"tx_replaced",TX_UNDERPRICED:"tx_underpriced",NONCE_ERROR:"nonce_error",CAMPAIGN_NOT_FOUND:"campaign_not_found",CAMPAIGN_NOT_ACTIVE:"campaign_not_active",CAMPAIGN_STILL_ACTIVE:"campaign_still_active",NOT_CAMPAIGN_CREATOR:"not_campaign_creator",DONATION_TOO_SMALL:"donation_too_small",MAX_CAMPAIGNS_REACHED:"max_campaigns_reached",INSUFFICIENT_ETH_FEE:"insufficient_eth_fee",LOCK_PERIOD_ACTIVE:"lock_period_active",LOCK_PERIOD_EXPIRED:"lock_period_expired",NO_REWARDS:"no_rewards",INVALID_DURATION:"invalid_duration",INVALID_DELEGATION_INDEX:"invalid_delegation_index",NFT_NOT_IN_POOL:"nft_not_in_pool",POOL_NOT_INITIALIZED:"pool_not_initialized",INSUFFICIENT_POOL_LIQUIDITY:"insufficient_pool_liquidity",SLIPPAGE_EXCEEDED:"slippage_exceeded",NFT_BOOST_MISMATCH:"nft_boost_mismatch",NOT_NFT_OWNER:"not_nft_owner",NO_ACTIVE_TIERS:"no_active_tiers",INVALID_GUESS_COUNT:"invalid_guess_count",INVALID_GUESS_RANGE:"invalid_guess_range",INSUFFICIENT_SERVICE_FEE:"insufficient_service_fee",RENTAL_STILL_ACTIVE:"rental_still_active",NFT_NOT_LISTED:"nft_not_listed",NFT_ALREADY_LISTED:"nft_already_listed",NOT_LISTING_OWNER:"not_listing_owner",MARKETPLACE_PAUSED:"marketplace_paused",EMPTY_METADATA:"empty_metadata",CONTRACT_ERROR:"contract_error",UNKNOWN:"unknown"},Hn={[h.WRONG_NETWORK]:"Please switch to Arbitrum Sepolia network",[h.RPC_UNHEALTHY]:"Network connection issue. Retrying...",[h.RPC_RATE_LIMITED]:"Network is busy. Please wait a moment...",[h.NETWORK_ERROR]:"Network error. Please check your connection",[h.WALLET_NOT_CONNECTED]:"Please connect your wallet",[h.WALLET_LOCKED]:"Please unlock your wallet",[h.INSUFFICIENT_ETH]:"Insufficient ETH for gas fees",[h.INSUFFICIENT_TOKEN]:"Insufficient BKC balance",[h.INSUFFICIENT_ALLOWANCE]:"Token approval required",[h.SIMULATION_REVERTED]:"Transaction would fail. Please check your inputs",[h.GAS_ESTIMATION_FAILED]:"Could not estimate gas. Transaction may fail",[h.USER_REJECTED]:"Transaction cancelled",[h.TX_REVERTED]:"Transaction failed on blockchain",[h.TX_TIMEOUT]:"Transaction is taking too long. Please check your wallet",[h.TX_REPLACED]:"Transaction was replaced",[h.TX_UNDERPRICED]:"Gas price too low. Please try again",[h.NONCE_ERROR]:"Transaction sequence error. Please refresh and try again",[h.CAMPAIGN_NOT_FOUND]:"Campaign not found",[h.CAMPAIGN_NOT_ACTIVE]:"This campaign is no longer accepting donations",[h.CAMPAIGN_STILL_ACTIVE]:"Campaign is still active. Please wait until the deadline",[h.NOT_CAMPAIGN_CREATOR]:"Only the campaign creator can perform this action",[h.DONATION_TOO_SMALL]:"Donation amount is below the minimum required",[h.MAX_CAMPAIGNS_REACHED]:"You have reached the maximum number of active campaigns",[h.INSUFFICIENT_ETH_FEE]:"Insufficient ETH for withdrawal fee",[h.LOCK_PERIOD_ACTIVE]:"Your tokens are still locked",[h.LOCK_PERIOD_EXPIRED]:"Lock period has expired. Use normal unstake",[h.NO_REWARDS]:"No rewards available to claim",[h.INVALID_DURATION]:"Lock duration must be between 1 day and 10 years",[h.INVALID_DELEGATION_INDEX]:"Delegation not found",[h.NFT_NOT_IN_POOL]:"This NFT is not available in the pool",[h.POOL_NOT_INITIALIZED]:"Pool is not active yet",[h.INSUFFICIENT_POOL_LIQUIDITY]:"Insufficient liquidity in pool",[h.SLIPPAGE_EXCEEDED]:"Price changed too much. Please try again",[h.NFT_BOOST_MISMATCH]:"NFT tier does not match this pool",[h.NOT_NFT_OWNER]:"You do not own this NFT",[h.NO_ACTIVE_TIERS]:"No active prize tiers available",[h.INVALID_GUESS_COUNT]:"Invalid number of guesses provided",[h.INVALID_GUESS_RANGE]:"Your guess is outside the valid range",[h.INSUFFICIENT_SERVICE_FEE]:"Incorrect service fee amount",[h.RENTAL_STILL_ACTIVE]:"This NFT is currently being rented",[h.NFT_NOT_LISTED]:"This NFT is not listed for rent",[h.NFT_ALREADY_LISTED]:"This NFT is already listed",[h.NOT_LISTING_OWNER]:"Only the listing owner can perform this action",[h.MARKETPLACE_PAUSED]:"Marketplace is temporarily paused",[h.EMPTY_METADATA]:"Document metadata cannot be empty",[h.CONTRACT_ERROR]:"Transaction cannot be completed. Please check your inputs and try again",[h.UNKNOWN]:"An unexpected error occurred. Please try again"},vt={[h.WRONG_NETWORK]:{layer:1,retry:!1,action:"switch_network"},[h.RPC_UNHEALTHY]:{layer:1,retry:!0,waitMs:2e3,action:"switch_rpc"},[h.RPC_RATE_LIMITED]:{layer:1,retry:!0,waitMs:"extract",action:"switch_rpc"},[h.NETWORK_ERROR]:{layer:1,retry:!0,waitMs:3e3,action:"switch_rpc"},[h.WALLET_NOT_CONNECTED]:{layer:2,retry:!1,action:"connect_wallet"},[h.WALLET_LOCKED]:{layer:2,retry:!1,action:"unlock_wallet"},[h.INSUFFICIENT_ETH]:{layer:3,retry:!1,action:"show_faucet"},[h.INSUFFICIENT_TOKEN]:{layer:3,retry:!1},[h.INSUFFICIENT_ALLOWANCE]:{layer:3,retry:!1},[h.SIMULATION_REVERTED]:{layer:4,retry:!1},[h.GAS_ESTIMATION_FAILED]:{layer:4,retry:!0,waitMs:2e3},[h.USER_REJECTED]:{layer:5,retry:!1},[h.TX_REVERTED]:{layer:5,retry:!1},[h.TX_TIMEOUT]:{layer:5,retry:!0,waitMs:5e3},[h.TX_REPLACED]:{layer:5,retry:!1},[h.TX_UNDERPRICED]:{layer:5,retry:!0,waitMs:1e3},[h.NONCE_ERROR]:{layer:5,retry:!0,waitMs:2e3},[h.CAMPAIGN_NOT_FOUND]:{layer:4,retry:!1},[h.CAMPAIGN_NOT_ACTIVE]:{layer:4,retry:!1},[h.CAMPAIGN_STILL_ACTIVE]:{layer:4,retry:!1},[h.NOT_CAMPAIGN_CREATOR]:{layer:4,retry:!1},[h.DONATION_TOO_SMALL]:{layer:4,retry:!1},[h.MAX_CAMPAIGNS_REACHED]:{layer:4,retry:!1},[h.INSUFFICIENT_ETH_FEE]:{layer:3,retry:!1},[h.LOCK_PERIOD_ACTIVE]:{layer:4,retry:!1},[h.LOCK_PERIOD_EXPIRED]:{layer:4,retry:!1},[h.NO_REWARDS]:{layer:4,retry:!1},[h.INVALID_DURATION]:{layer:4,retry:!1},[h.INVALID_DELEGATION_INDEX]:{layer:4,retry:!1},[h.NFT_NOT_IN_POOL]:{layer:4,retry:!1},[h.POOL_NOT_INITIALIZED]:{layer:4,retry:!1},[h.INSUFFICIENT_POOL_LIQUIDITY]:{layer:4,retry:!1},[h.SLIPPAGE_EXCEEDED]:{layer:4,retry:!0,waitMs:1e3},[h.NFT_BOOST_MISMATCH]:{layer:4,retry:!1},[h.NOT_NFT_OWNER]:{layer:4,retry:!1},[h.NO_ACTIVE_TIERS]:{layer:4,retry:!1},[h.INVALID_GUESS_COUNT]:{layer:4,retry:!1},[h.INVALID_GUESS_RANGE]:{layer:4,retry:!1},[h.INSUFFICIENT_SERVICE_FEE]:{layer:4,retry:!1},[h.RENTAL_STILL_ACTIVE]:{layer:4,retry:!1},[h.NFT_NOT_LISTED]:{layer:4,retry:!1},[h.NFT_ALREADY_LISTED]:{layer:4,retry:!1},[h.NOT_LISTING_OWNER]:{layer:4,retry:!1},[h.MARKETPLACE_PAUSED]:{layer:4,retry:!1},[h.EMPTY_METADATA]:{layer:4,retry:!1},[h.CONTRACT_ERROR]:{layer:4,retry:!1},[h.UNKNOWN]:{layer:5,retry:!1}},Js=[{pattern:/user rejected/i,type:h.USER_REJECTED},{pattern:/user denied/i,type:h.USER_REJECTED},{pattern:/user cancel/i,type:h.USER_REJECTED},{pattern:/rejected by user/i,type:h.USER_REJECTED},{pattern:/cancelled/i,type:h.USER_REJECTED},{pattern:/canceled/i,type:h.USER_REJECTED},{pattern:/action_rejected/i,type:h.USER_REJECTED},{pattern:/too many errors/i,type:h.RPC_RATE_LIMITED},{pattern:/rate limit/i,type:h.RPC_RATE_LIMITED},{pattern:/retrying in/i,type:h.RPC_RATE_LIMITED},{pattern:/429/i,type:h.RPC_RATE_LIMITED},{pattern:/internal json-rpc/i,type:h.RPC_UNHEALTHY},{pattern:/-32603/i,type:h.RPC_UNHEALTHY},{pattern:/-32002/i,type:h.RPC_RATE_LIMITED},{pattern:/failed to fetch/i,type:h.NETWORK_ERROR},{pattern:/network error/i,type:h.NETWORK_ERROR},{pattern:/timeout/i,type:h.TX_TIMEOUT},{pattern:/insufficient funds/i,type:h.INSUFFICIENT_ETH},{pattern:/exceeds the balance/i,type:h.INSUFFICIENT_ETH},{pattern:/insufficient balance/i,type:h.INSUFFICIENT_TOKEN},{pattern:/transfer amount exceeds balance/i,type:h.INSUFFICIENT_TOKEN},{pattern:/exceeds balance/i,type:h.INSUFFICIENT_TOKEN},{pattern:/nonce/i,type:h.NONCE_ERROR},{pattern:/replacement.*underpriced/i,type:h.TX_UNDERPRICED},{pattern:/transaction underpriced/i,type:h.TX_UNDERPRICED},{pattern:/gas too low/i,type:h.TX_UNDERPRICED},{pattern:/reverted/i,type:h.TX_REVERTED},{pattern:/revert/i,type:h.TX_REVERTED},{pattern:/campaignnotfound/i,type:h.CAMPAIGN_NOT_FOUND},{pattern:/campaign not found/i,type:h.CAMPAIGN_NOT_FOUND},{pattern:/campaignnotactive/i,type:h.CAMPAIGN_NOT_ACTIVE},{pattern:/campaign.*not.*active/i,type:h.CAMPAIGN_NOT_ACTIVE},{pattern:/campaignstillactive/i,type:h.CAMPAIGN_STILL_ACTIVE},{pattern:/notcampaigncreator/i,type:h.NOT_CAMPAIGN_CREATOR},{pattern:/donationtoosmall/i,type:h.DONATION_TOO_SMALL},{pattern:/maxactivecampaignsreached/i,type:h.MAX_CAMPAIGNS_REACHED},{pattern:/insufficientethfee/i,type:h.INSUFFICIENT_ETH_FEE},{pattern:/lockperiodactive/i,type:h.LOCK_PERIOD_ACTIVE},{pattern:/lock.*period.*active/i,type:h.LOCK_PERIOD_ACTIVE},{pattern:/still.*locked/i,type:h.LOCK_PERIOD_ACTIVE},{pattern:/lockperiodexpired/i,type:h.LOCK_PERIOD_EXPIRED},{pattern:/norewardstoclaim/i,type:h.NO_REWARDS},{pattern:/no.*rewards/i,type:h.NO_REWARDS},{pattern:/invalidduration/i,type:h.INVALID_DURATION},{pattern:/invalidindex/i,type:h.INVALID_DELEGATION_INDEX},{pattern:/nftnotinpool/i,type:h.NFT_NOT_IN_POOL},{pattern:/poolnotinitialized/i,type:h.POOL_NOT_INITIALIZED},{pattern:/insufficientliquidity/i,type:h.INSUFFICIENT_POOL_LIQUIDITY},{pattern:/insufficientnfts/i,type:h.INSUFFICIENT_POOL_LIQUIDITY},{pattern:/slippageexceeded/i,type:h.SLIPPAGE_EXCEEDED},{pattern:/slippage/i,type:h.SLIPPAGE_EXCEEDED},{pattern:/nftboostmismatch/i,type:h.NFT_BOOST_MISMATCH},{pattern:/notnftowner/i,type:h.NOT_NFT_OWNER},{pattern:/noactivetiers/i,type:h.NO_ACTIVE_TIERS},{pattern:/invalidguesscount/i,type:h.INVALID_GUESS_COUNT},{pattern:/invalidguessrange/i,type:h.INVALID_GUESS_RANGE},{pattern:/insufficientservicefee/i,type:h.INSUFFICIENT_SERVICE_FEE},{pattern:/rentalstillactive/i,type:h.RENTAL_STILL_ACTIVE},{pattern:/nftnotlisted/i,type:h.NFT_NOT_LISTED},{pattern:/nftalreadylisted/i,type:h.NFT_ALREADY_LISTED},{pattern:/notlistingowner/i,type:h.NOT_LISTING_OWNER},{pattern:/marketplaceispaused/i,type:h.MARKETPLACE_PAUSED},{pattern:/emptymetadata/i,type:h.EMPTY_METADATA}],X={classify(e){var n;if(e!=null&&e.errorType&&Object.values(h).includes(e.errorType))return e.errorType;const t=this._extractMessage(e),a=(e==null?void 0:e.code)||((n=e==null?void 0:e.error)==null?void 0:n.code);if(a===4001||a==="ACTION_REJECTED")return h.USER_REJECTED;if(a===-32002)return h.RPC_RATE_LIMITED;if(a===-32603||a==="CALL_EXCEPTION"){if(t.includes("revert")||t.includes("require")||t.includes("execution failed")||t.includes("call_exception")||(e==null?void 0:e.code)==="CALL_EXCEPTION"){for(const{pattern:i,type:s}of Js)if(i.test(t))return s;return h.CONTRACT_ERROR}return h.RPC_UNHEALTHY}for(const{pattern:i,type:s}of Js)if(i.test(t))return s;return h.UNKNOWN},_extractMessage(e){var a,n,i;return e?typeof e=="string"?e:[e.message,e.reason,(a=e.error)==null?void 0:a.message,(n=e.error)==null?void 0:n.reason,(i=e.data)==null?void 0:i.message,e.shortMessage,this._safeStringify(e)].filter(Boolean).join(" ").toLowerCase():""},_safeStringify(e){try{return JSON.stringify(e,(t,a)=>typeof a=="bigint"?a.toString():a)}catch{return""}},isUserRejection(e){return this.classify(e)===h.USER_REJECTED},isRetryable(e){var a;const t=this.classify(e);return((a=vt[t])==null?void 0:a.retry)||!1},getWaitTime(e){const t=this.classify(e),a=vt[t];return a?a.waitMs==="extract"?this._extractWaitTime(e):a.waitMs||2e3:2e3},_extractWaitTime(e){const t=this._extractMessage(e),a=t.match(/retrying in (\d+[,.]?\d*)\s*minutes?/i);if(a){const i=parseFloat(a[1].replace(",","."));return Math.ceil(i*60*1e3)+5e3}const n=t.match(/wait (\d+)\s*seconds?/i);return n?parseInt(n[1])*1e3+2e3:3e4},getMessage(e){const t=this.classify(e);return Hn[t]||Hn[h.UNKNOWN]},getConfig(e){const t=this.classify(e);return vt[t]||vt[h.UNKNOWN]},getLayer(e){var a;const t=this.classify(e);return((a=vt[t])==null?void 0:a.layer)||5},handle(e,t="Transaction"){const a=this.classify(e),n=vt[a]||{},i=this.getMessage(e);return console.error(`[${t}] Error:`,{type:a,layer:n.layer,retry:n.retry,message:i,original:e}),{type:a,message:i,retry:n.retry||!1,waitMs:n.retry?this.getWaitTime(e):0,layer:n.layer||5,action:n.action||null,original:e,context:t}},async handleWithRpcSwitch(e,t="Transaction"){const a=this.handle(e,t);if(a.action==="switch_rpc")try{const{NetworkManager:n}=await K(async()=>{const{NetworkManager:s}=await Promise.resolve().then(()=>Qu);return{NetworkManager:s}},void 0);console.log("[ErrorHandler] Switching RPC due to network error...");const i=n.switchToNextRpc();try{await n.updateMetaMaskRpcs(),console.log("[ErrorHandler] MetaMask RPC updated")}catch(s){console.warn("[ErrorHandler] Could not update MetaMask:",s.message)}a.rpcSwitched=!0,a.newRpc=i,a.waitMs=Math.min(a.waitMs,2e3)}catch(n){console.warn("[ErrorHandler] Could not switch RPC:",n.message),a.rpcSwitched=!1}return a},parseSimulationError(e,t){var r;const a=this.classify(e);let n=this.getMessage(e);const s=(r={donate:{[h.CAMPAIGN_NOT_ACTIVE]:"This campaign has ended and is no longer accepting donations",[h.DONATION_TOO_SMALL]:"Minimum donation is 1 BKC"},delegate:{[h.INVALID_DURATION]:"Lock period must be between 1 day and 10 years"},playGame:{[h.INVALID_GUESS_RANGE]:"Your guess must be within the valid range for this tier"},withdraw:{[h.CAMPAIGN_STILL_ACTIVE]:"You can withdraw after the campaign deadline"},unstake:{[h.LOCK_PERIOD_ACTIVE]:"Your tokens are still locked. Use force unstake to withdraw early (penalty applies)"},claimRewards:{[h.CONTRACT_ERROR]:"No rewards available to claim",[h.NO_REWARDS]:"No rewards available to claim"}}[t])==null?void 0:r[a];return s&&(n=s),{type:a,message:n,original:e,method:t,isSimulation:!0}},create(e,t={}){const a=Hn[e]||"An error occurred",n=new Error(a);return n.errorType=e,n.extra=t,n},getAction(e){var a;const t=this.classify(e);return((a=vt[t])==null?void 0:a.action)||null}},ae={chainId:421614,chainIdHex:"0x66eee",name:"Arbitrum Sepolia",nativeCurrency:{name:"Ethereum",symbol:"ETH",decimals:18},blockExplorer:"https://sepolia.arbiscan.io"};function Ye(){const e="ZWla0YY4A0Hw7e_rwyOXB";return e?`https://arb-sepolia.g.alchemy.com/v2/${e}`:null}const Vu=[{name:"Alchemy",getUrl:Ye,priority:1,isPublic:!1,isPaid:!0},{name:"Arbitrum Official",getUrl:()=>"https://sepolia-rollup.arbitrum.io/rpc",priority:2,isPublic:!0,isPaid:!1},{name:"PublicNode",getUrl:()=>"https://arbitrum-sepolia-rpc.publicnode.com",priority:3,isPublic:!0,isPaid:!1},{name:"Ankr",getUrl:()=>"https://rpc.ankr.com/arbitrum_sepolia",priority:4,isPublic:!0,isPaid:!1}];let tt=0,Mt=null,wt=null,Ua=0,ja=0,Dt=!0;const qu=3,Xu=3e4,Ju=5e3,Zs=6e4,Zu=2e3,le={getCurrentRpcUrl(){const e=Ye();if(e&&Dt)return e;const t=this.getAvailableEndpoints();if(t.length===0)throw new Error("No RPC endpoints available");return t[tt%t.length].getUrl()},getPrimaryRpcUrl(){return Ye()},getAvailableEndpoints(){return Vu.filter(e=>e.getUrl()!==null).sort((e,t)=>e.priority-t.priority)},getRpcUrlsForMetaMask(){const e=Ye(),t=this.getAvailableEndpoints().filter(a=>a.isPublic).map(a=>a.getUrl()).filter(Boolean);return e?[e,...t]:t},switchToNextRpc(e=!0){const t=this.getAvailableEndpoints();if(Dt&&Ye()){Dt=!1,tt=0;const i=t.find(s=>s.isPublic);if(i)return console.log(`[Network] Alchemy temporarily unavailable, using: ${i.name}`),e&&setTimeout(()=>{console.log("[Network] Retrying Alchemy..."),Dt=!0,tt=0},Zu),i.getUrl()}const a=t.filter(i=>i.isPublic);if(a.length<=1)return console.warn("[Network] No alternative RPCs available"),this.getCurrentRpcUrl();tt=(tt+1)%a.length;const n=a[tt];return console.log(`[Network] Switched to RPC: ${n.name}`),n.getUrl()},resetToAlchemy(){Ye()&&(Dt=!0,tt=0,console.log("[Network] Reset to Alchemy RPC"))},isRateLimitError(e){var n;const t=((n=e==null?void 0:e.message)==null?void 0:n.toLowerCase())||"",a=e==null?void 0:e.code;return a===-32002||a===-32005||t.includes("rate limit")||t.includes("too many")||t.includes("exceeded")||t.includes("throttled")||t.includes("429")},async handleRateLimit(e){const t=this.getCurrentRpcUrl(),a=Ye();if(a&&t===a)return console.warn("[Network] Alchemy rate limited (check your plan limits)"),await new Promise(r=>setTimeout(r,1e3)),a;console.warn("[Network] Public RPC rate limited, switching...");const i=this.switchToNextRpc(),s=Date.now();if(s-ja>Zs)try{await this.updateMetaMaskRpcs(),ja=s}catch(r){console.warn("[Network] Could not update MetaMask:",r.message)}return i},async getWorkingProvider(){const e=window.ethers,t=Ye();if(t)try{const n=new e.JsonRpcProvider(t);return await Promise.race([n.getBlockNumber(),new Promise((i,s)=>setTimeout(()=>s(new Error("timeout")),3e3))]),Dt=!0,n}catch(n){console.warn("[Network] Alchemy temporarily unavailable:",n.message)}const a=this.getAvailableEndpoints().filter(n=>n.isPublic);for(const n of a)try{const i=n.getUrl(),s=new e.JsonRpcProvider(i);return await Promise.race([s.getBlockNumber(),new Promise((r,o)=>setTimeout(()=>o(new Error("timeout")),3e3))]),console.log(`[Network] Using fallback RPC: ${n.name}`),s}catch{console.warn(`[Network] RPC ${n.name} failed, trying next...`)}if(t)return new e.JsonRpcProvider(t);throw new Error("No working RPC endpoints available")},async isCorrectNetwork(){if(!window.ethereum)return!1;try{const e=await window.ethereum.request({method:"eth_chainId"});return parseInt(e,16)===ae.chainId}catch(e){return console.error("[Network] Error checking network:",e),!1}},async getCurrentChainId(){if(!window.ethereum)return null;try{const e=await window.ethereum.request({method:"eth_chainId"});return parseInt(e,16)}catch{return null}},async checkRpcHealth(){const e=Date.now(),t=this.getCurrentRpcUrl();try{const a=new AbortController,n=setTimeout(()=>a.abort(),Ju),i=await fetch(t,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({jsonrpc:"2.0",method:"eth_blockNumber",params:[],id:1}),signal:a.signal});if(clearTimeout(n),!i.ok)throw new Error(`HTTP ${i.status}`);const s=await i.json();if(s.error)throw new Error(s.error.message||"RPC error");const r=Date.now()-e;return Ua=0,wt={healthy:!0,latency:r,blockNumber:parseInt(s.result,16),timestamp:Date.now()},wt}catch(a){Ua++;const n={healthy:!1,latency:Date.now()-e,error:a.message,timestamp:Date.now()};return wt=n,Ua>=qu&&(console.warn("[Network] Too many RPC failures, switching..."),this.switchToNextRpc(),Ua=0),n}},getLastHealthCheck(){return wt},async isRpcHealthy(e=1e4){return wt&&Date.now()-wt.timestamp<e?wt.healthy:(await this.checkRpcHealth()).healthy},async switchNetwork(){if(!window.ethereum)throw X.create(h.WALLET_NOT_CONNECTED);try{return await window.ethereum.request({method:"wallet_switchEthereumChain",params:[{chainId:ae.chainIdHex}]}),console.log("[Network] Switched to",ae.name),!0}catch(e){if(e.code===4902)return await this.addNetwork();throw e.code===4001?X.create(h.USER_REJECTED):e}},async addNetwork(){if(!window.ethereum)throw X.create(h.WALLET_NOT_CONNECTED);const e=this.getRpcUrlsForMetaMask();try{return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:ae.chainIdHex,chainName:ae.name,nativeCurrency:ae.nativeCurrency,rpcUrls:e,blockExplorerUrls:[ae.blockExplorer]}]}),console.log("[Network] Added network:",ae.name),!0}catch(t){throw t.code===4001?X.create(h.USER_REJECTED):t}},async updateMetaMaskRpcs(){if(!window.ethereum)return!1;const e=Date.now();if(e-ja<Zs)return console.log("[Network] MetaMask update on cooldown, skipping..."),!1;if(!await this.isCorrectNetwork())return console.log("[Network] Not on correct network, skipping RPC update"),!1;const a=this.getRpcUrlsForMetaMask();try{return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:ae.chainIdHex,chainName:ae.name,nativeCurrency:ae.nativeCurrency,rpcUrls:a,blockExplorerUrls:[ae.blockExplorer]}]}),ja=e,console.log("[Network] MetaMask RPCs updated with:",a[0]),!0}catch(n){return console.warn("[Network] Could not update MetaMask RPCs:",n.message),!1}},async forceResetMetaMaskRpc(){if(!window.ethereum)return!1;const e=Ye();if(!e)return console.warn("[Network] Alchemy not configured"),!1;try{try{await window.ethereum.request({method:"wallet_switchEthereumChain",params:[{chainId:"0x1"}]})}catch{}return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:ae.chainIdHex,chainName:ae.name+" (Alchemy)",nativeCurrency:ae.nativeCurrency,rpcUrls:[e],blockExplorerUrls:[ae.blockExplorer]}]}),console.log("[Network] MetaMask reset to Alchemy RPC"),!0}catch(t){return console.error("[Network] Failed to reset MetaMask:",t.message),!1}},getProvider(){const e=window.ethers;if(!e)throw new Error("ethers.js not loaded");return new e.JsonRpcProvider(this.getCurrentRpcUrl())},getBrowserProvider(){const e=window.ethers;if(!e)throw new Error("ethers.js not loaded");if(!window.ethereum)throw X.create(h.WALLET_NOT_CONNECTED);return new e.BrowserProvider(window.ethereum)},async getSigner(){var t,a;const e=this.getBrowserProvider();try{return await e.getSigner()}catch(n){if((t=n.message)!=null&&t.includes("ENS")||n.code==="UNSUPPORTED_OPERATION")try{const i=await window.ethereum.request({method:"eth_accounts"});if(i&&i.length>0)return await e.getSigner(i[0])}catch(i){console.warn("Signer fallback failed:",i)}throw n.code===4001||(a=n.message)!=null&&a.includes("user rejected")?X.create(h.USER_REJECTED):X.create(h.WALLET_NOT_CONNECTED)}},async getConnectedAddress(){if(!window.ethereum)return null;try{return(await window.ethereum.request({method:"eth_accounts"}))[0]||null}catch{return null}},async requestConnection(){if(!window.ethereum)throw X.create(h.WALLET_NOT_CONNECTED);try{const e=await window.ethereum.request({method:"eth_requestAccounts"});if(!e||e.length===0)throw X.create(h.WALLET_NOT_CONNECTED);return e[0]}catch(e){throw e.code===4001?X.create(h.USER_REJECTED):e}},startHealthMonitoring(e=Xu){Mt&&this.stopHealthMonitoring(),this.checkRpcHealth(),Mt=setInterval(()=>{this.checkRpcHealth()},e),console.log("[Network] Health monitoring started")},stopHealthMonitoring(){Mt&&(clearInterval(Mt),Mt=null,console.log("[Network] Health monitoring stopped"))},isMonitoring(){return Mt!==null},formatAddress(e,t=4){return e?`${e.slice(0,t+2)}...${e.slice(-t)}`:""},getAddressExplorerUrl(e){return`${ae.blockExplorer}/address/${e}`},getTxExplorerUrl(e){return`${ae.blockExplorer}/tx/${e}`},isMetaMaskInstalled(){return typeof window.ethereum<"u"&&window.ethereum.isMetaMask},async getStatus(){var n;const[e,t,a]=await Promise.all([this.isCorrectNetwork(),this.getConnectedAddress(),this.checkRpcHealth()]);return{isConnected:!!t,address:t,isCorrectNetwork:e,currentChainId:await this.getCurrentChainId(),targetChainId:ae.chainId,rpcHealthy:a.healthy,rpcLatency:a.latency,currentRpc:((n=this.getAvailableEndpoints()[tt])==null?void 0:n.name)||"Unknown"}}},Qu=Object.freeze(Object.defineProperty({__proto__:null,NETWORK_CONFIG:ae,NetworkManager:le},Symbol.toStringTag,{value:"Module"})),We={SAFETY_MARGIN_PERCENT:20,MIN_GAS_LIMITS:{transfer:21000n,erc20Transfer:65000n,erc20Approve:50000n,contractCall:100000n,complexCall:300000n},MAX_GAS_LIMIT:15000000n,MIN_GAS_PRICE_GWEI:.01,MAX_GAS_PRICE_GWEI:100,GAS_PRICE_CACHE_TTL:15e3},ep={async estimateGas(e,t,a=[],n={}){try{return await e[t].estimateGas(...a,n)}catch(i){throw i}},async estimateGasWithMargin(e,t,a=[],n={}){const i=await this.estimateGas(e,t,a,n);return this.addSafetyMargin(i)},addSafetyMargin(e,t=We.SAFETY_MARGIN_PERCENT){const a=BigInt(e),n=a*BigInt(t)/100n;let i=a+n;return i>We.MAX_GAS_LIMIT&&(console.warn("[Gas] Estimate exceeds max limit, capping"),i=We.MAX_GAS_LIMIT),i},getMinGasLimit(e="contractCall"){return We.MIN_GAS_LIMITS[e]||We.MIN_GAS_LIMITS.contractCall},async getGasPrice(){return await zt.getOrFetch("gas-price-current",async()=>(await le.getProvider().getFeeData()).gasPrice||0n,We.GAS_PRICE_CACHE_TTL)},async getFeeData(){return await zt.getOrFetch("gas-fee-data",async()=>{const a=await le.getProvider().getFeeData();return{gasPrice:a.gasPrice||0n,maxFeePerGas:a.maxFeePerGas||0n,maxPriorityFeePerGas:a.maxPriorityFeePerGas||0n}},We.GAS_PRICE_CACHE_TTL)},async getGasPriceGwei(){const e=window.ethers,t=await this.getGasPrice();return parseFloat(e.formatUnits(t,"gwei"))},async calculateCost(e,t=null){const a=window.ethers;t||(t=await this.getGasPrice());const n=BigInt(e)*BigInt(t),i=a.formatEther(n);return{wei:n,eth:parseFloat(i),formatted:this.formatEth(i)}},async estimateTransactionCost(e,t,a=[],n={}){const i=await this.estimateGas(e,t,a,n),s=this.addSafetyMargin(i),r=await this.getGasPrice(),o=await this.calculateCost(s,r);return{gasEstimate:i,gasWithMargin:s,gasPrice:r,...o}},async validateGasBalance(e,t,a=null){const n=window.ethers,i=le.getProvider();a||(a=await this.getGasPrice());const s=await i.getBalance(e),r=BigInt(t)*BigInt(a),o=s>=r;return{sufficient:o,balance:s,required:r,shortage:o?0n:r-s,balanceFormatted:n.formatEther(s),requiredFormatted:n.formatEther(r)}},async hasMinimumGas(e,t=null){const a=window.ethers,i=await le.getProvider().getBalance(e),s=t||a.parseEther("0.001");return i>=s},formatEth(e,t=6){const a=parseFloat(e);return a===0?"0 ETH":a<1e-6?"< 0.000001 ETH":`${a.toFixed(t).replace(/\.?0+$/,"")} ETH`},formatGasPrice(e){const t=window.ethers,a=parseFloat(t.formatUnits(e,"gwei"));return a<.01?"< 0.01 gwei":a<1?`${a.toFixed(2)} gwei`:`${a.toFixed(1)} gwei`},formatGasLimit(e){return Number(e).toLocaleString()},formatGasSummary(e){return`~${e.formatted} (${this.formatGasLimit(e.gasWithMargin||0n)} gas)`},compareEstimates(e,t){const a=BigInt(e),n=BigInt(t);if(n===0n)return 0;const i=a>n?a-n:n-a;return Number(i*100n/n)},isGasPriceReasonable(e){const t=window.ethers,a=parseFloat(t.formatUnits(e,"gwei"));return a<We.MIN_GAS_PRICE_GWEI?{reasonable:!1,warning:"Gas price unusually low, transaction may be slow"}:a>We.MAX_GAS_PRICE_GWEI?{reasonable:!1,warning:"Gas price unusually high, consider waiting"}:{reasonable:!0,warning:null}},async getRecommendedSettings(e){const t=await this.getFeeData();return{gasLimit:this.addSafetyMargin(e),maxFeePerGas:t.maxFeePerGas,maxPriorityFeePerGas:t.maxPriorityFeePerGas}},async createTxOverrides(e,t={}){return{gasLimit:(await this.getRecommendedSettings(e)).gasLimit,...t}}},Qs=500000000000000n,er=["function balanceOf(address owner) view returns (uint256)","function allowance(address owner, address spender) view returns (uint256)","function decimals() view returns (uint8)","function symbol() view returns (string)"],ee={async validateNetwork(){if(!await le.isCorrectNetwork()){const t=await le.getCurrentChainId();throw X.create(h.WRONG_NETWORK,{currentChainId:t,expectedChainId:ae.chainId})}},async validateRpcHealth(){const e=await le.checkRpcHealth();if(!e.healthy&&(le.switchToNextRpc(),!(await le.checkRpcHealth()).healthy))throw X.create(h.RPC_UNHEALTHY,{error:e.error})},async validateWalletConnected(e=null){if(!window.ethereum)throw X.create(h.WALLET_NOT_CONNECTED);const t=e||await le.getConnectedAddress();if(!t)throw X.create(h.WALLET_NOT_CONNECTED);return t},async validatePreTransaction(){return await this.validateNetwork(),await this.validateRpcHealth(),await this.validateWalletConnected()},async validateEthForGas(e,t=Qs){const a=window.ethers,n=On.ethBalance(e),i=await zt.getOrFetch(n,async()=>await le.getProvider().getBalance(e),Dn.BALANCE);if(i<t)throw X.create(h.INSUFFICIENT_ETH,{balance:a.formatEther(i),required:a.formatEther(t)});return i},async validateTokenBalance(e,t,a){const n=window.ethers,i=On.tokenBalance(e,a),s=await zt.getOrFetch(i,async()=>{const r=le.getProvider();return await new n.Contract(e,er,r).balanceOf(a)},Dn.BALANCE);if(s<t)throw X.create(h.INSUFFICIENT_TOKEN,{balance:n.formatEther(s),required:n.formatEther(t)});return s},async needsApproval(e,t,a,n){const i=window.ethers,s=On.allowance(e,n,t);return await zt.getOrFetch(s,async()=>{const o=le.getProvider();return await new i.Contract(e,er,o).allowance(n,t)},Dn.ALLOWANCE)<a},async validateAllowance(e,t,a,n){if(await this.needsApproval(e,t,a,n))throw X.create(h.INSUFFICIENT_ALLOWANCE,{token:e,spender:t,required:a.toString()})},async validateBalances({userAddress:e,tokenAddress:t=null,tokenAmount:a=null,spenderAddress:n=null,ethAmount:i=Qs}){await this.validateEthForGas(e,i),t&&a&&await this.validateTokenBalance(t,a,e)},validatePositive(e,t="Amount"){if(BigInt(e)<=0n)throw new Error(`${t} must be greater than zero`)},validateRange(e,t,a,n="Value"){const i=BigInt(e),s=BigInt(t),r=BigInt(a);if(i<s||i>r)throw new Error(`${n} must be between ${t} and ${a}`)},validateNotEmpty(e,t="Field"){if(!e||e.trim().length===0)throw new Error(`${t} cannot be empty`)},validateAddress(e,t="Address"){const a=window.ethers;if(!e||!a.isAddress(e))throw new Error(`Invalid ${t}`)},charity:{validateCreateCampaign({title:e,description:t,goalAmount:a,durationDays:n}){ee.validateNotEmpty(e,"Title"),ee.validateNotEmpty(t,"Description"),ee.validatePositive(a,"Goal amount"),ee.validateRange(n,1,180,"Duration")},validateDonate({campaignId:e,amount:t}){if(e==null)throw new Error("Campaign ID is required");ee.validatePositive(t,"Donation amount")}},staking:{validateDelegate({amount:e,lockDays:t}){ee.validatePositive(e,"Stake amount"),ee.validateRange(t,1,3650,"Lock duration")},validateUnstake({delegationIndex:e}){if(e==null||e<0)throw new Error("Invalid delegation index")}},nftPool:{validateBuy({maxPrice:e}){e!=null&&ee.validatePositive(e,"Max price")},validateSell({tokenId:e,minPayout:t}){if(e==null)throw new Error("Token ID is required");t!=null&&ee.validatePositive(t,"Min payout")}},fortune:{validatePlay({wagerAmount:e,guesses:t,isCumulative:a}){if(ee.validatePositive(e,"Wager amount"),!Array.isArray(t)||t.length===0)throw new Error("At least one guess is required");t.forEach((n,i)=>{if(typeof n!="number"||n<1)throw new Error(`Invalid guess at position ${i+1}`)})}},rental:{validateList({tokenId:e,pricePerHour:t,minHours:a,maxHours:n}){if(e==null)throw new Error("Token ID is required");ee.validatePositive(t,"Price per hour"),ee.validateRange(a,1,720,"Minimum hours"),ee.validateRange(n,a,720,"Maximum hours")},validateRent({tokenId:e,hours:t}){if(e==null)throw new Error("Token ID is required");ee.validatePositive(t,"Rental hours")}},notary:{validateNotarize({ipfsCid:e,description:t,contentHash:a}){if(ee.validateNotEmpty(e,"IPFS CID"),a&&(a.startsWith("0x")?a.slice(2):a).length!==64)throw new Error("Content hash must be 32 bytes")}}},Wa={DEFAULT_MAX_RETRIES:2,RETRY_BASE_DELAY:2e3,APPROVAL_MULTIPLIER:10n,APPROVAL_WAIT_TIME:1500,CONFIRMATION_TIMEOUT:6e4,CONFIRMATION_RETRY_DELAY:3e3,GAS_SAFETY_MARGIN:20,DEFAULT_GAS_LIMIT:500000n},tr=["function approve(address spender, uint256 amount) returns (bool)","function allowance(address owner, address spender) view returns (uint256)"];class tp{constructor(t,a,n=!0){this.button=t,this.txName=a,this.showToasts=n,this.originalContent=null,this.originalDisabled=!1,this.button&&(this.originalContent=this.button.innerHTML,this.originalDisabled=this.button.disabled)}setPhase(t){if(!this.button)return;const n={validating:{text:"Validating...",icon:"🔍"},approving:{text:"Approving...",icon:"✅"},simulating:{text:"Simulating...",icon:"🧪"},confirming:{text:"Confirm in Wallet",icon:"👛"},waiting:{text:"Processing...",icon:"⏳"},success:{text:"Success!",icon:"🎉"},error:{text:"Failed",icon:"❌"}}[t]||{text:t,icon:"⏳"};this.button.disabled=!0,this.button.innerHTML=`
        ...
        `)}cleanup(){this.button&&(this.button.innerHTML=this.originalContent,this.button.disabled=this.originalDisabled)}showSuccess(t=2e3){this.setPhase("success"),setTimeout(()=>this.cleanup(),t)}showError(t=2e3){this.setPhase("error"),setTimeout(()=>this.cleanup(),t)}}class ap{constructor(){this.pendingTxIds=new Set}_resolveArgs(t){return typeof t=="function"?t():t||[]}_resolveApproval(t){return t?typeof t=="object"?{token:t.token,spender:t.spender,amount:t.amount}:t:null}_validateContractMethod(t,a){if(!t)throw new Error("Contract instance is null or undefined");if(typeof t[a]!="function"){const n=Object.keys(t).filter(i=>typeof t[i]=="function").filter(i=>!i.startsWith("_")&&!["on","once","emit","removeListener"].includes(i)).slice(0,15);throw console.error(`[TX] Contract method "${a}" not found!`),console.error("[TX] Available methods:",n),new Error(`Contract method "${a}" not found. This usually means the ABI doesn't match the contract. Available methods: ${n.join(", ")}`)}return typeof t[a].estimateGas!="function"&&console.warn(`[TX] Method ${a} exists but estimateGas is not available`),!0}async execute(t){var S,L;const{name:a,txId:n=null,button:i=null,showToasts:s=!0,getContract:r,method:o,args:l=[],approval:d=null,validate:u=null,onSuccess:f=null,onError:p=null,maxRetries:g=Wa.DEFAULT_MAX_RETRIES,invalidateCache:b=!0,skipSimulation:w=!1,fixedGasLimit:T=Wa.DEFAULT_GAS_LIMIT}=t,C=n||`${a}-${Date.now()}-${Math.random().toString(36).substr(2,9)}`;if(this.pendingTxIds.has(C))return console.warn(`[TX] Transaction ${C} already in progress`),{success:!1,reason:"DUPLICATE_TX",message:"Transaction already in progress"};this.pendingTxIds.add(C);const P=new tp(i,a,s);try{P.setPhase("validating"),console.log(`[TX] Starting: ${a}`),await ee.validateNetwork(),await ee.validateRpcHealth();const B=await ee.validateWalletConnected();console.log(`[TX] User address: ${B}`);const I=await le.getSigner();console.log("[TX] Signer obtained");try{await ee.validateEthForGas(B)}catch(q){console.warn("[TX] ETH gas validation failed, continuing anyway:",q.message)}const _=this._resolveApproval(d);_&&_.amount>0n&&await ee.validateTokenBalance(_.token,_.amount,B),u&&(console.log("[TX] Running custom validation..."),await u(I,B));const D=this._resolveApproval(t.approval);D&&D.amount>0n&&await ee.needsApproval(D.token,D.spender,D.amount,B)&&(P.setPhase("approving"),console.log("[TX] Requesting token approval..."),await this._executeApproval(D,I,B),zt.clear("allowance-")),console.log("[TX] Getting contract instance...");const re=await r(I);this._validateContractMethod(re,o),console.log(`[TX] Contract method "${o}" validated`);const J=t.value;J&&console.log("[TX] Transaction value (ETH):",J.toString());const ye=J?{value:J}:{},ue=this._resolveArgs(l);console.log("[TX] Args resolved:",ue.map(q=>typeof q=="bigint"?q.toString():typeof q=="string"&&q.length>50?q.substring(0,50)+"...":q));let Y;if(w)console.log(`[TX] Skipping simulation, using fixed gas limit: ${T}`),Y=T;else{P.setPhase("simulating"),console.log("[TX] Simulating transaction...");try{if(!re[o]||typeof re[o].estimateGas!="function")throw new Error(`estimateGas not available for method "${o}"`);Y=await re[o].estimateGas(...ue,ye),console.log(`[TX] Gas estimate: ${Y.toString()}`)}catch(q){if(console.error("[TX] Simulation failed:",q.message),(S=q.message)!=null&&S.includes("not found")||(L=q.message)!=null&&L.includes("undefined"))throw new Error(`Contract method "${o}" is not callable. Check that the ABI matches the deployed contract.`);const ra=X.parseSimulationError(q,o);throw X.create(ra.type,{message:ra.message,original:q})}}P.setPhase("confirming"),console.log("[TX] Requesting signature...");const te=ep.addSafetyMargin(Y),Ne={...ye,gasLimit:te};try{const q=await I.provider.getFeeData();q.maxFeePerGas&&(Ne.maxFeePerGas=q.maxFeePerGas*120n/100n,Ne.maxPriorityFeePerGas=q.maxPriorityFeePerGas||0n)}catch{}const ht=this._resolveArgs(l),et=await this._executeWithRetry(()=>re[o](...ht,Ne),{maxRetries:g,ui:P,signer:I,name:a});console.log(`[TX] Transaction submitted: ${et.hash}`),P.setPhase("waiting"),console.log("[TX] Waiting for confirmation...");const Me=await this._waitForConfirmation(et,I.provider);if(console.log(`[TX] Confirmed in block ${Me.blockNumber}`),P.showSuccess(),b&&zt.invalidateByTx(a),f)try{await f(Me)}catch(q){console.warn("[TX] onSuccess callback error:",q)}return{success:!0,receipt:Me,txHash:Me.hash||et.hash,blockNumber:Me.blockNumber}}catch(B){console.error("[TX] Error:",(B==null?void 0:B.message)||B),i&&(console.log("[TX] Restoring button..."),i.disabled=!1,P.originalContent&&(i.innerHTML=P.originalContent));let I;try{I=await X.handleWithRpcSwitch(B,a),I.rpcSwitched&&console.log(`[TX] RPC switched to: ${I.newRpc}`)}catch(_){console.warn("[TX] Error in handleWithRpcSwitch:",_),I=X.handle(B,a)}if(I.type!==h.USER_REJECTED&&i&&!p){const _=P.originalContent;i.innerHTML='<span style="display:flex;align-items:center;justify-content:center;gap:8px"><span>❌</span><span>Failed</span></span>',setTimeout(()=>{i&&(i.innerHTML=_)},1500)}if(p)try{p(I)}catch(_){console.warn("[TX] onError callback error:",_)}return{success:!1,error:I,message:I.message,cancelled:I.type===h.USER_REJECTED}}finally{this.pendingTxIds.delete(C),setTimeout(()=>{i&&i.disabled&&(console.log("[TX] Safety cleanup triggered"),P.cleanup())},5e3)}}async _executeApproval(t,a,n){const i=window.ethers,{token:s,spender:r,amount:o}=t;console.log(`[TX] Approving ${i.formatEther(o)} tokens...`);const l=new i.Contract(s,tr,a),d=o*Wa.APPROVAL_MULTIPLIER;try{let u={};try{const T=await a.provider.getFeeData();T.maxFeePerGas&&(u.maxFeePerGas=T.maxFeePerGas*120n/100n,u.maxPriorityFeePerGas=T.maxPriorityFeePerGas||0n)}catch{}const f=await l.approve(r,d,u),p=le.getProvider();let g=null;for(let T=0;T<30&&(await new Promise(C=>setTimeout(C,1500)),g=await p.getTransactionReceipt(f.hash),!g);T++);if(g||(g=await f.wait()),g.status===0)throw new Error("Approval transaction reverted");if(console.log("[TX] Approval confirmed"),await new Promise(T=>setTimeout(T,Wa.APPROVAL_WAIT_TIME)),await new i.Contract(s,tr,p).allowance(n,r)<o)throw new Error("Approval not reflected on-chain")}catch(u){throw X.isUserRejection(u)?X.create(h.USER_REJECTED):u}}async _executeWithRetry(t,{maxRetries:a,ui:n,signer:i,name:s}){let r;for(let o=1;o<=a+1;o++)try{return o>1&&(n.setRetry(o,a+1),console.log(`[TX] Retry ${o}/${a+1}`),(await le.checkRpcHealth()).healthy||(console.log("[TX] RPC unhealthy, switching..."),le.switchToNextRpc(),await new Promise(d=>setTimeout(d,2e3)))),await t()}catch(l){if(r=l,X.isUserRejection(l)||!X.isRetryable(l)||o===a+1)throw l;const d=X.getWaitTime(l);console.log(`[TX] Waiting ${d}ms before retry...`),await new Promise(u=>setTimeout(u,d))}throw r}async _waitForConfirmation(t,a){const n=le.getProvider();try{const i=await Promise.race([t.wait(),new Promise((s,r)=>setTimeout(()=>r(new Error("wait_timeout")),1e4))]);if(i.status===1)return i;if(i.status===0)throw new Error("Transaction reverted on-chain");return i}catch(i){console.warn("[TX] tx.wait() issue, using Alchemy to check:",i.message);for(let s=0;s<20;s++){await new Promise(o=>setTimeout(o,1500));const r=await n.getTransactionReceipt(t.hash);if(r&&r.status===1)return console.log("[TX] Confirmed via Alchemy"),r;if(r&&r.status===0)throw new Error("Transaction reverted on-chain")}return console.warn("[TX] Could not verify receipt, assuming success"),{hash:t.hash,status:1,blockNumber:0}}}isPending(t){return this.pendingTxIds.has(t)}getPendingCount(){return this.pendingTxIds.size}clearPending(){this.pendingTxIds.clear()}}const U=new ap,xn="bkc_operator",Lt="0x0000000000000000000000000000000000000000";function Fi(){var t;const e=window.ethers;try{const a=localStorage.getItem(xn);if(a&&Ve(a))return Ut(a);if(window.BACKCHAIN_OPERATOR&&Ve(window.BACKCHAIN_OPERATOR))return Ut(window.BACKCHAIN_OPERATOR);if((t=window.addresses)!=null&&t.operator&&Ve(window.addresses.operator))return Ut(window.addresses.operator)}catch(a){console.warn("[Operator] Error getting operator:",a)}return(e==null?void 0:e.ZeroAddress)||Lt}function Q(e){const t=window.ethers,a=(t==null?void 0:t.ZeroAddress)||Lt;return e===null?a:e&&Ve(e)?Ut(e):Fi()}function np(e){if(!e)return fo(),!0;if(!Ve(e))return console.warn("[Operator] Invalid address:",e),!1;try{const t=Ut(e);return localStorage.setItem(xn,t),window.BACKCHAIN_OPERATOR=t,window.dispatchEvent(new CustomEvent("operatorChanged",{detail:{address:t}})),console.log("[Operator] Set to:",t),!0}catch(t){return console.error("[Operator] Error setting:",t),!1}}function fo(){try{localStorage.removeItem(xn),delete window.BACKCHAIN_OPERATOR,window.dispatchEvent(new CustomEvent("operatorChanged",{detail:{address:null}})),console.log("[Operator] Cleared")}catch(e){console.warn("[Operator] Error clearing:",e)}}function ip(){const e=window.ethers,t=(e==null?void 0:e.ZeroAddress)||Lt,a=Fi();return a&&a!==t}function sp(){var n;const e=window.ethers,t=(e==null?void 0:e.ZeroAddress)||Lt,a=localStorage.getItem(xn);return a&&Ve(a)?{address:a,source:"localStorage",isSet:!0}:window.BACKCHAIN_OPERATOR&&Ve(window.BACKCHAIN_OPERATOR)?{address:window.BACKCHAIN_OPERATOR,source:"global",isSet:!0}:(n=window.addresses)!=null&&n.operator&&Ve(window.addresses.operator)?{address:window.addresses.operator,source:"config",isSet:!0}:{address:t,source:"none",isSet:!1}}function Ve(e){const t=window.ethers;return!e||typeof e!="string"||!e.match(/^0x[a-fA-F0-9]{40}$/)?!1:t!=null&&t.isAddress?t.isAddress(e):!0}function Ut(e){const t=window.ethers;if(!e)return(t==null?void 0:t.ZeroAddress)||Lt;try{if(t!=null&&t.getAddress)return t.getAddress(e)}catch{}return e}function rp(e){const t=window.ethers,a=(t==null?void 0:t.ZeroAddress)||Lt;return!e||e===a?"None":`${e.slice(0,6)}...${e.slice(-4)}`}const op={get:Fi,set:np,clear:fo,has:ip,resolve:Q,info:sp,isValid:Ve,normalize:Ut,short:rp,ZERO:Lt};window.Operator=op;function mo(){var t;const e=(v==null?void 0:v.charityPool)||(M==null?void 0:M.charityPool)||((t=window.contractAddresses)==null?void 0:t.charityPool);if(!e)throw console.error("❌ CharityPool address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{CHARITY_POOL:e}}const Pa=["function createCampaign(string calldata title, string calldata metadataUri, uint96 goal, uint256 durationDays, address operator) external payable returns (uint256 campaignId)","function donate(uint256 campaignId, address operator) external payable","function boostCampaign(uint256 campaignId, address operator) external payable","function closeCampaign(uint256 campaignId) external","function withdraw(uint256 campaignId) external","function getCampaign(uint256 campaignId) view returns (address owner, uint48 deadline, uint8 status, uint96 raised, uint96 goal, uint32 donorCount, bool isBoosted, string memory title, string memory metadataUri)","function canWithdraw(uint256 campaignId) view returns (bool)","function previewDonation(uint256 amount) view returns (uint256 fee, uint256 netToCampaign)","function campaignCount() view returns (uint256)","function getStats() view returns (uint256 campaignCount, uint256 totalDonated, uint256 totalWithdrawn, uint256 totalEthFees)","function version() view returns (string)","event CampaignCreated(uint256 indexed campaignId, address indexed creator, uint96 goal, uint48 deadline, address operator)","event DonationMade(uint256 indexed campaignId, address indexed donor, uint256 grossAmount, uint256 netDonation, address operator)","event CampaignBoosted(uint256 indexed campaignId, address indexed booster, uint48 boostExpiry, address operator)","event CampaignClosed(uint256 indexed campaignId, address indexed creator, uint96 raised)","event FundsWithdrawn(uint256 indexed campaignId, address indexed creator, uint96 amount)"],Qt={ACTIVE:0,CLOSED:1,WITHDRAWN:2};function za(e){const t=window.ethers,a=mo();return new t.Contract(a.CHARITY_POOL,Pa,e)}async function je(){const e=window.ethers,{NetworkManager:t}=await K(async()=>{const{NetworkManager:i}=await import("./index-CalnOfTr.js");return{NetworkManager:i}},[]),a=t.getProvider(),n=mo();return new e.Contract(n.CHARITY_POOL,Pa,a)}async function go({title:e,metadataUri:t="",description:a,goalAmount:n,durationDays:i,operator:s,button:r=null,onSuccess:o=null,onError:l=null}){const d=window.ethers;if(!e||e.trim().length===0)throw new Error("Title is required");if(e.length>100)throw new Error("Title must be 100 characters or less");if(i<1||i>365)throw new Error("Duration must be between 1 and 365 days");const u=BigInt(n);if(u<=0n)throw new Error("Goal amount must be greater than 0");const f=t||a||"";let p=s,g=0n;return await U.execute({name:"CreateCampaign",button:r,getContract:async b=>za(b),method:"createCampaign",args:()=>[e,f,u,BigInt(i),Q(p)],get value(){return g},validate:async(b,w)=>{await je();try{const{NetworkManager:T}=await K(async()=>{const{NetworkManager:S}=await import("./index-CalnOfTr.js");return{NetworkManager:S}},[]),C=T.getProvider();if(g=d.parseEther("0.0001"),await C.getBalance(w)<g+d.parseEther("0.001"))throw new Error("Insufficient ETH for creation fee + gas")}catch(T){if(T.message.includes("Insufficient"))throw T}},onSuccess:async b=>{let w=null;try{const T=new d.Interface(Pa);for(const C of b.logs)try{const P=T.parseLog(C);if(P.name==="CampaignCreated"){w=Number(P.args.campaignId);break}}catch{}}catch{}o&&o(b,w)},onError:l})}async function bo({campaignId:e,amount:t,operator:a,button:n=null,onSuccess:i=null,onError:s=null}){const r=window.ethers;if(e==null)throw new Error("Campaign ID is required");const o=BigInt(t);if(o<=0n)throw new Error("Donation amount must be greater than 0");let l=e,d=a;return await U.execute({name:"Donate",button:n,getContract:async u=>za(u),method:"donate",args:()=>[l,Q(d)],value:o,validate:async(u,f)=>{const g=await(await je()).getCampaign(l);if(g.owner===r.ZeroAddress)throw new Error("Campaign not found");if(Number(g.status)!==Qt.ACTIVE)throw new Error("Campaign is not active");const b=Math.floor(Date.now()/1e3);if(Number(g.deadline)<=b)throw new Error("Campaign has ended")},onSuccess:async u=>{let f=null;try{const p=new r.Interface(Pa);for(const g of u.logs)try{const b=p.parseLog(g);if(b.name==="DonationMade"){f={grossAmount:b.args.grossAmount,netDonation:b.args.netDonation};break}}catch{}}catch{}i&&i(u,f)},onError:s})}async function Mi({campaignId:e,button:t=null,onSuccess:a=null,onError:n=null}){const i=window.ethers;if(e==null)throw new Error("Campaign ID is required");return await U.execute({name:"CloseCampaign",button:t,getContract:async s=>za(s),method:"closeCampaign",args:[e],validate:async(s,r)=>{const l=await(await je()).getCampaign(e);if(l.owner===i.ZeroAddress)throw new Error("Campaign not found");if(l.owner.toLowerCase()!==r.toLowerCase())throw new Error("Only the campaign creator can close");if(Number(l.status)!==Qt.ACTIVE)throw new Error("Campaign is not active")},onSuccess:a,onError:n})}const xo=Mi;async function ho({campaignId:e,button:t=null,onSuccess:a=null,onError:n=null}){const i=window.ethers;if(e==null)throw new Error("Campaign ID is required");return await U.execute({name:"Withdraw",button:t,getContract:async s=>za(s),method:"withdraw",args:[e],validate:async(s,r)=>{const o=await je(),l=await o.getCampaign(e);if(l.owner===i.ZeroAddress)throw new Error("Campaign not found");if(l.owner.toLowerCase()!==r.toLowerCase())throw new Error("Only the campaign creator can withdraw");if(Number(l.status)===Qt.WITHDRAWN)throw new Error("Funds already withdrawn");if(!await o.canWithdraw(e))throw new Error("Cannot withdraw yet — campaign must be closed or past deadline")},onSuccess:async s=>{let r=null;try{const o=new i.Interface(Pa);for(const l of s.logs)try{const d=o.parseLog(l);if(d.name==="FundsWithdrawn"){r={amount:d.args.amount};break}}catch{}}catch{}a&&a(s,r)},onError:n})}async function vo({campaignId:e,operator:t,button:a=null,onSuccess:n=null,onError:i=null}){const s=window.ethers;if(e==null)throw new Error("Campaign ID is required");let r=t,o=s.parseEther("0.0001");return await U.execute({name:"BoostCampaign",button:a,getContract:async l=>za(l),method:"boostCampaign",args:()=>[e,Q(r)],get value(){return o},validate:async(l,d)=>{const f=await(await je()).getCampaign(e);if(f.owner===s.ZeroAddress)throw new Error("Campaign not found");if(Number(f.status)!==Qt.ACTIVE)throw new Error("Campaign is not active");const p=Math.floor(Date.now()/1e3);if(Number(f.deadline)<=p)throw new Error("Campaign has ended")},onSuccess:n,onError:i})}async function wo(e){const a=await(await je()).getCampaign(e),n=Math.floor(Date.now()/1e3);return{id:e,creator:a.owner,title:a.title,metadataUri:a.metadataUri,goalAmount:a.goal,raisedAmount:a.raised,donationCount:Number(a.donorCount),deadline:Number(a.deadline),status:Number(a.status),statusName:["ACTIVE","CLOSED","WITHDRAWN"][Number(a.status)]||"UNKNOWN",isBoosted:a.isBoosted,progress:a.goal>0n?Number(a.raised*100n/a.goal):0,isEnded:Number(a.deadline)<n,isActive:Number(a.status)===Qt.ACTIVE&&Number(a.deadline)>n}}async function yo(){const e=await je();return Number(await e.campaignCount())}async function ko(e){return await(await je()).canWithdraw(e)}async function Eo(e){const t=window.ethers,n=await(await je()).previewDonation(e);return{fee:n.fee||n[0],netToCampaign:n.netToCampaign||n[1],feeFormatted:t.formatEther(n.fee||n[0]),netFormatted:t.formatEther(n.netToCampaign||n[1])}}async function To(){const e=window.ethers,a=await(await je()).getStats();return{totalCampaigns:Number(a.campaignCount||a[0]),totalDonated:a.totalDonated||a[1],totalDonatedFormatted:e.formatEther(a.totalDonated||a[1]),totalWithdrawn:a.totalWithdrawn||a[2],totalWithdrawnFormatted:e.formatEther(a.totalWithdrawn||a[2]),totalEthFees:a.totalEthFees||a[3],totalEthFeesFormatted:e.formatEther(a.totalEthFees||a[3])}}const Rt={createCampaign:go,donate:bo,closeCampaign:Mi,cancelCampaign:xo,withdraw:ho,boostCampaign:vo,getCampaign:wo,getCampaignCount:yo,canWithdraw:ko,previewDonation:Eo,getStats:To,CampaignStatus:Qt},lp=Object.freeze(Object.defineProperty({__proto__:null,CharityTx:Rt,boostCampaign:vo,canWithdraw:ko,cancelCampaign:xo,closeCampaign:Mi,createCampaign:go,donate:bo,getCampaign:wo,getCampaignCount:yo,getStats:To,previewDonation:Eo,withdraw:ho},Symbol.toStringTag,{value:"Module"}));function Di(){var a,n;const e=(v==null?void 0:v.stakingPool)||(M==null?void 0:M.stakingPool)||((a=window.contractAddresses)==null?void 0:a.stakingPool),t=(v==null?void 0:v.bkcToken)||(M==null?void 0:M.bkcToken)||((n=window.contractAddresses)==null?void 0:n.bkcToken);if(!e)throw console.error("❌ StakingPool address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");if(!t)throw console.error("❌ BKC Token address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{BKC_TOKEN:t,STAKING_POOL:e}}const Co=["function delegate(uint256 amount, uint256 lockDays, address operator) external payable","function unstake(uint256 index) external","function forceUnstake(uint256 index, address operator) external payable","function claimRewards(address operator) external payable","function pendingRewards(address user) view returns (uint256)","function previewClaim(address user) view returns (uint256 totalRewards, uint256 burnAmount, uint256 referrerCut, uint256 userReceives, uint256 burnRateBps, uint256 nftBoost)","function getDelegationsOf(address user) view returns (tuple(uint128 amount, uint128 pStake, uint64 lockEnd, uint64 lockDays, uint256 rewardDebt)[])","function getDelegation(address user, uint256 index) view returns (uint256 amount, uint256 pStake, uint256 lockEnd, uint256 lockDays, uint256 pendingReward)","function delegationCount(address user) view returns (uint256)","function userTotalPStake(address user) view returns (uint256)","function totalPStake() view returns (uint256)","function MIN_LOCK_DAYS() view returns (uint256)","function MAX_LOCK_DAYS() view returns (uint256)","function forceUnstakePenaltyBps() view returns (uint256)","function getUserBestBoost(address user) view returns (uint256)","function getBurnRateForBoost(uint256 boostBps) view returns (uint256)","function getTierName(uint256 boostBps) view returns (string)","function getUserSummary(address user) view returns (uint256 userTotalPStake, uint256 delegationCount, uint256 savedRewards, uint256 totalPending, uint256 nftBoost, uint256 burnRateBps)","function getStakingStats() view returns (uint256 totalPStake, uint256 totalBkcDelegated, uint256 totalRewardsDistributed, uint256 totalBurnedOnClaim, uint256 totalForceUnstakePenalties, uint256 totalEthFeesCollected, uint256 accRewardPerShare)","event Delegated(address indexed user, uint256 indexed delegationIndex, uint256 amount, uint256 pStake, uint256 lockDays, address operator)","event Unstaked(address indexed user, uint256 indexed delegationIndex, uint256 amount)","event RewardsClaimed(address indexed user, uint256 totalRewards, uint256 burned, uint256 referrerCut, uint256 userReceived, uint256 nftBoost, address operator)"];function Nt(e){const t=window.ethers,a=Di();return new t.Contract(a.STAKING_POOL,Co,e)}async function gt(){const e=window.ethers,{NetworkManager:t}=await K(async()=>{const{NetworkManager:i}=await import("./index-CalnOfTr.js");return{NetworkManager:i}},[]),a=t.getProvider(),n=Di();return new e.Contract(n.STAKING_POOL,Co,a)}async function Io({amount:e,lockDays:t,operator:a,button:n=null,onSuccess:i=null,onError:s=null}){if(t==null)throw new Error("lockDays must be provided");const r=Number(t);if(r<1||r>3650)throw new Error("Lock duration must be between 1 and 3650 days");const o=BigInt(e);let l=a;return await U.execute({name:"Delegate",button:n,getContract:async d=>Nt(d),method:"delegate",args:()=>[o,BigInt(r),Q(l)],approval:(()=>{const d=Di();return{token:d.BKC_TOKEN,spender:d.STAKING_POOL,amount:o}})(),onSuccess:i,onError:s})}async function Ao({delegationIndex:e,button:t=null,onSuccess:a=null,onError:n=null}){ee.staking.validateUnstake({delegationIndex:e});let i=e;return await U.execute({name:"Unstake",button:t,getContract:async s=>Nt(s),method:"unstake",args:[i],validate:async(s,r)=>{const l=await Nt(s).getDelegationsOf(r);if(i>=l.length)throw new Error("Delegation not found");const d=l[i],u=Math.floor(Date.now()/1e3);if(Number(d.lockEnd)>u){const f=Math.ceil((Number(d.lockEnd)-u)/86400);throw new Error(`Lock period still active. ${f} day(s) remaining. Use Force Unstake if needed.`)}},onSuccess:a,onError:n})}async function Po({delegationIndex:e,operator:t,button:a=null,onSuccess:n=null,onError:i=null}){ee.staking.validateUnstake({delegationIndex:e});let s=e,r=t;return await U.execute({name:"ForceUnstake",button:a,getContract:async o=>Nt(o),method:"forceUnstake",args:()=>[s,Q(r)],validate:async(o,l)=>{const u=await Nt(o).getDelegationsOf(l);if(s>=u.length)throw new Error("Delegation not found");const f=u[s],p=Math.floor(Date.now()/1e3);if(Number(f.lockEnd)<=p)throw new Error("Lock period has ended. Use normal Unstake to avoid penalty.")},onSuccess:n,onError:i})}async function zo({operator:e,button:t=null,onSuccess:a=null,onError:n=null}={}){let i=e;return await U.execute({name:"ClaimRewards",button:t,getContract:async s=>Nt(s),method:"claimRewards",args:()=>[Q(i)],validate:async(s,r)=>{if(await Nt(s).pendingRewards(r)<=0n)throw new Error("No rewards available to claim")},onSuccess:a,onError:n})}async function Bo(e){const a=await(await gt()).getDelegationsOf(e),n=Math.floor(Date.now()/1e3);return a.map((i,s)=>({index:s,amount:i.amount,pStake:i.pStake,lockEnd:Number(i.lockEnd),lockDays:Number(i.lockDays),isUnlocked:Number(i.lockEnd)<=n,daysRemaining:Number(i.lockEnd)>n?Math.ceil((Number(i.lockEnd)-n)/86400):0}))}async function No(e){return await(await gt()).pendingRewards(e)}async function So(e){return await(await gt()).userTotalPStake(e)}async function $o(){return await(await gt()).totalPStake()}async function Lo(){const e=await gt();try{const t=await e.forceUnstakePenaltyBps();return Number(t)/100}catch{return 10}}async function Ro(){const e=await gt(),[t,a,n]=await Promise.all([e.MIN_LOCK_DAYS(),e.MAX_LOCK_DAYS(),e.forceUnstakePenaltyBps().catch(()=>1000n)]);return{minLockDays:Number(t),maxLockDays:Number(a),penaltyPercent:Number(n)/100,penaltyBips:Number(n)}}async function _o(e){const a=await(await gt()).previewClaim(e);return{totalRewards:a.totalRewards,burnAmount:a.burnAmount,referrerCut:a.referrerCut,userReceives:a.userReceives,burnRateBps:Number(a.burnRateBps),nftBoost:Number(a.nftBoost)}}async function Fo(e){const a=await(await gt()).getUserSummary(e);return{userTotalPStake:a.userTotalPStake||a[0],delegationCount:Number(a.delegationCount||a[1]),savedRewards:a.savedRewards||a[2],totalPending:a.totalPending||a[3],nftBoost:Number(a.nftBoost||a[4]),burnRateBps:Number(a.burnRateBps||a[5])}}const Yt={delegate:Io,unstake:Ao,forceUnstake:Po,claimRewards:zo,getUserDelegations:Bo,getPendingRewards:No,getUserPStake:So,getTotalPStake:$o,getEarlyUnstakePenalty:Lo,getStakingConfig:Ro,previewClaim:_o,getUserSummary:Fo},cp=Object.freeze(Object.defineProperty({__proto__:null,StakingTx:Yt,claimRewards:zo,delegate:Io,forceUnstake:Po,getEarlyUnstakePenalty:Lo,getPendingRewards:No,getStakingConfig:Ro,getTotalPStake:$o,getUserDelegations:Bo,getUserPStake:So,getUserSummary:Fo,previewClaim:_o,unstake:Ao},Symbol.toStringTag,{value:"Module"})),Mo=["diamond","gold","silver","bronze"];function hn(e=null){var i,s,r;const t=(v==null?void 0:v.bkcToken)||(M==null?void 0:M.bkcToken)||((i=window.contractAddresses)==null?void 0:i.bkcToken),a=(v==null?void 0:v.rewardBooster)||(M==null?void 0:M.rewardBooster)||((s=window.contractAddresses)==null?void 0:s.rewardBooster);let n=null;if(e){const o=`pool_${e.toLowerCase()}`;n=(v==null?void 0:v[o])||(M==null?void 0:M[o])||((r=window.contractAddresses)==null?void 0:r[o])}if(!t||!a)throw new Error("Contract addresses not loaded");return{BKC_TOKEN:t,NFT_CONTRACT:a,NFT_POOL:n}}function ea(e){var a;const t=`pool_${e.toLowerCase()}`;return(v==null?void 0:v[t])||(M==null?void 0:M[t])||((a=window.contractAddresses)==null?void 0:a[t])||null}function dp(){const e={};for(const t of Mo){const a=ea(t);a&&(e[t]=a)}return e}const Oi=["function buyNFT(uint256 maxBkcPrice, address operator) external payable returns (uint256 tokenId)","function buySpecificNFT(uint256 tokenId, uint256 maxBkcPrice, address operator) external payable","function sellNFT(uint256 tokenId, uint256 minPayout, address operator) external payable","function getBuyPrice() view returns (uint256)","function getSellPrice() view returns (uint256)","function getTotalBuyCost() view returns (uint256 bkcCost, uint256 ethCost)","function getTotalSellInfo() view returns (uint256 bkcPayout, uint256 ethCost)","function getEthFees() view returns (uint256 buyFee, uint256 sellFee)","function getSpread() view returns (uint256 spread, uint256 spreadBips)","function getPoolInfo() view returns (uint256 bkcBalance, uint256 nftCount, uint256 k, bool initialized, uint8 tier)","function getAvailableNFTs() view returns (uint256[])","function isNFTInPool(uint256 tokenId) view returns (bool)","function tier() view returns (uint8)","function getTierName() view returns (string)","function getStats() view returns (uint256 volume, uint256 buys, uint256 sells, uint256 ethFees)","event NFTPurchased(address indexed buyer, uint256 indexed tokenId, uint256 price, uint256 ethFee, uint256 nftCount, address operator)","event NFTSold(address indexed seller, uint256 indexed tokenId, uint256 payout, uint256 ethFee, uint256 nftCount, address operator)"],Do=["function setApprovalForAll(address operator, bool approved) external","function isApprovedForAll(address owner, address operator) view returns (bool)","function ownerOf(uint256 tokenId) view returns (address)","function balanceOf(address owner) view returns (uint256)","function tokenTier(uint256 tokenId) view returns (uint8)"];function Hi(e,t){return new window.ethers.Contract(t,Oi,e)}async function he(e){const{NetworkManager:t}=await K(async()=>{const{NetworkManager:a}=await import("./index-CalnOfTr.js");return{NetworkManager:a}},[]);return new window.ethers.Contract(e,Oi,t.getProvider())}function ni(e){const t=hn();return new window.ethers.Contract(t.NFT_CONTRACT,Do,e)}async function up(){const{NetworkManager:e}=await K(async()=>{const{NetworkManager:a}=await import("./index-CalnOfTr.js");return{NetworkManager:a}},[]),t=hn();return new window.ethers.Contract(t.NFT_CONTRACT,Do,e.getProvider())}async function Ui({poolAddress:e,poolTier:t,operator:a,button:n=null,onSuccess:i=null,onError:s=null}){const r=window.ethers,o=hn(),l=e||ea(t);if(!l)throw new Error("Pool address or valid pool tier is required");let d=a,u=0n,f=0n;return await U.execute({name:"BuyNFT",button:n,getContract:async p=>Hi(p,l),method:"buyNFT",args:()=>[u,Q(d)],get value(){return f},get approval(){return u>0n?{token:o.BKC_TOKEN,spender:l,amount:u}:null},validate:async(p,g)=>{const b=await he(l),[w,T]=await b.getTotalBuyCost();u=w,f=T;const C=await b.getPoolInfo();if(Number(C[1])<=1)throw new Error("No NFTs available in pool");const{NetworkManager:P}=await K(async()=>{const{NetworkManager:_}=await import("./index-CalnOfTr.js");return{NetworkManager:_}},[]),S=P.getProvider();if(await new r.Contract(o.BKC_TOKEN,["function balanceOf(address) view returns (uint256)"],S).balanceOf(g)<u)throw new Error(`Insufficient BKC. Need ${r.formatEther(u)} BKC`);if(await S.getBalance(g)<f+r.parseEther("0.001"))throw new Error("Insufficient ETH for fee + gas")},onSuccess:async p=>{let g=null;try{const b=new r.Interface(Oi);for(const w of p.logs)try{const T=b.parseLog(w);if((T==null?void 0:T.name)==="NFTPurchased"){g=Number(T.args.tokenId);break}}catch{}}catch{}i&&i(p,g)},onError:s})}async function Oo({poolAddress:e,poolTier:t,tokenId:a,operator:n,button:i=null,onSuccess:s=null,onError:r=null}){const o=window.ethers,l=hn(),d=e||ea(t);if(!d)throw new Error("Pool address or valid pool tier is required");if(a===void 0)throw new Error("Token ID is required");let u=n,f=0n,p=0n;return await U.execute({name:"BuySpecificNFT",button:i,getContract:async g=>Hi(g,d),method:"buySpecificNFT",args:()=>[a,f,Q(u)],get value(){return p},get approval(){return f>0n?{token:l.BKC_TOKEN,spender:d,amount:f}:null},validate:async(g,b)=>{const w=await he(d);if(!await w.isNFTInPool(a))throw new Error("NFT is not in pool");const[T,C]=await w.getTotalBuyCost();f=T,p=C;const{NetworkManager:P}=await K(async()=>{const{NetworkManager:B}=await import("./index-CalnOfTr.js");return{NetworkManager:B}},[]),S=P.getProvider();if(await new o.Contract(l.BKC_TOKEN,["function balanceOf(address) view returns (uint256)"],S).balanceOf(b)<f)throw new Error("Insufficient BKC");if(await S.getBalance(b)<p+o.parseEther("0.001"))throw new Error("Insufficient ETH")},onSuccess:s,onError:r})}async function ji({poolAddress:e,poolTier:t,tokenId:a,minPayout:n,operator:i,button:s=null,onSuccess:r=null,onError:o=null}){const l=window.ethers,d=e||ea(t);if(!d)throw new Error("Pool address or valid pool tier is required");if(a===void 0)throw new Error("Token ID is required");let u=i,f=0n,p=0n;return await U.execute({name:"SellNFT",button:s,getContract:async g=>Hi(g,d),method:"sellNFT",args:()=>[a,f,Q(u)],get value(){return p},validate:async(g,b)=>{const w=await he(d),T=ni(g);if((await T.ownerOf(a)).toLowerCase()!==b.toLowerCase())throw new Error("You do not own this NFT");const P=await w.tier(),S=await T.tokenTier(a);if(P!==S)throw new Error("NFT tier does not match pool tier");const[L,B]=await w.getTotalSellInfo();f=n?BigInt(n):L*95n/100n,p=B;const{NetworkManager:I}=await K(async()=>{const{NetworkManager:D}=await import("./index-CalnOfTr.js");return{NetworkManager:D}},[]);if(await I.getProvider().getBalance(b)<p+l.parseEther("0.001"))throw new Error("Insufficient ETH");await T.isApprovedForAll(b,d)||await(await T.setApprovalForAll(d,!0)).wait()},onSuccess:r,onError:o})}async function Ho({poolAddress:e,poolTier:t,button:a=null,onSuccess:n=null,onError:i=null}){const s=e||ea(t);if(!s)throw new Error("Pool address or valid pool tier is required");return await U.execute({name:"ApproveAllNFTs",button:a,getContract:async r=>ni(r),method:"setApprovalForAll",args:[s,!0],validate:async(r,o)=>{if(await ni(r).isApprovedForAll(o,s))throw new Error("Already approved")},onSuccess:n,onError:i})}async function Uo(e){return await(await he(e)).getBuyPrice()}async function jo(e){return await(await he(e)).getSellPrice()}async function Wo(e){const t=window.ethers,a=await he(e),[n,i]=await a.getTotalBuyCost();return{bkcCost:n,bkcFormatted:t.formatEther(n),ethCost:i,ethFormatted:t.formatEther(i)}}async function Go(e){const t=window.ethers,a=await he(e),[n,i]=await a.getTotalSellInfo();return{bkcPayout:n,bkcFormatted:t.formatEther(n),ethCost:i,ethFormatted:t.formatEther(i)}}async function Ko(e){const t=window.ethers,a=await he(e),[n,i,s]=await Promise.all([a.getPoolInfo(),a.getBuyPrice().catch(()=>0n),a.getSellPrice().catch(()=>0n)]);return{bkcBalance:n[0],nftCount:Number(n[1]),k:n[2],initialized:n[3],tier:Number(n[4]),buyPrice:i,buyPriceFormatted:t.formatEther(i),sellPrice:s,sellPriceFormatted:t.formatEther(s)}}async function Yo(e){return(await(await he(e)).getAvailableNFTs()).map(a=>Number(a))}async function Wi(e){const t=window.ethers,a=await he(e),[n,i]=await a.getEthFees();return{buyFee:n,buyFeeFormatted:t.formatEther(n),sellFee:i,sellFeeFormatted:t.formatEther(i)}}const Vo=Wi;async function Gi(e){const t=window.ethers,n=await(await he(e)).getStats();return{volume:n[0],volumeFormatted:t.formatEther(n[0]),buys:Number(n[1]),sells:Number(n[2]),ethFees:n[3],ethFeesFormatted:t.formatEther(n[3])}}const qo=Gi;async function Xo(e){return await(await he(e)).getTierName()}async function Jo(e){const t=window.ethers,a=await he(e);try{const n=await a.getSpread();return{spread:n.spread,spreadFormatted:t.formatEther(n.spread),spreadBips:Number(n.spreadBips),spreadPercent:Number(n.spreadBips)/100}}catch{const[n,i]=await Promise.all([a.getBuyPrice().catch(()=>0n),a.getSellPrice().catch(()=>0n)]),s=n>i?n-i:0n,r=i>0n?Number(s*10000n/i):0;return{spread:s,spreadFormatted:t.formatEther(s),spreadBips:r,spreadPercent:r/100}}}async function Zo(e,t){return await(await he(e)).isNFTInPool(t)}async function Qo(e,t){return await(await up()).isApprovedForAll(e,t)}const el=Ui,tl=ji,ii={buyNft:Ui,buySpecificNft:Oo,sellNft:ji,approveAllNfts:Ho,buyFromPool:el,sellToPool:tl,getBuyPrice:Uo,getSellPrice:jo,getTotalBuyCost:Wo,getTotalSellInfo:Go,getEthFees:Wi,getEthFeeConfig:Vo,getPoolInfo:Ko,getAvailableNfts:Yo,isNFTInPool:Zo,isApprovedForAll:Qo,getStats:Gi,getTradingStats:qo,getTierName:Xo,getSpread:Jo,getPoolAddress:ea,getAllPools:dp,POOL_TIERS:Mo},pp=Object.freeze(Object.defineProperty({__proto__:null,NftTx:ii,approveAllNfts:Ho,buyFromPool:el,buyNft:Ui,buySpecificNft:Oo,getAvailableNfts:Yo,getBuyPrice:Uo,getEthFeeConfig:Vo,getEthFees:Wi,getPoolInfo:Ko,getSellPrice:jo,getSpread:Jo,getStats:Gi,getTierName:Xo,getTotalBuyCost:Wo,getTotalSellInfo:Go,getTradingStats:qo,isApprovedForAll:Qo,isNFTInPool:Zo,sellNft:ji,sellToPool:tl},Symbol.toStringTag,{value:"Module"}));function Ki(){var a,n;const e=(v==null?void 0:v.fortunePool)||(M==null?void 0:M.fortunePool)||((a=window.contractAddresses)==null?void 0:a.fortunePool),t=(v==null?void 0:v.bkcToken)||(M==null?void 0:M.bkcToken)||((n=window.contractAddresses)==null?void 0:n.bkcToken);if(!e)throw console.error("❌ FortunePool address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");if(!t)throw console.error("❌ BKC Token address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{BKC_TOKEN:t,FORTUNE_POOL:e}}const vn=["function commitPlay(bytes32 commitHash, uint256 wagerAmount, uint8 tierMask, address operator) external payable returns (uint256 gameId)","function revealPlay(uint256 gameId, uint256[] calldata guesses, bytes32 userSecret) external returns (uint256 prizeWon)","function claimExpired(uint256 gameId) external","function fundPrizePool(uint256 amount) external","function getTierInfo(uint8 tier) view returns (uint256 range, uint256 multiplier, uint256 winChanceBps)","function getAllTiers() view returns (uint256[3] ranges, uint256[3] multipliers, uint256[3] winChances)","function TIER_COUNT() view returns (uint8)","function getGame(uint256 gameId) view returns (address player, uint48 commitBlock, uint8 tierMask, uint8 status, address operator, uint96 wagerAmount)","function getGameResult(uint256 gameId) view returns (address player, uint128 grossWager, uint128 prizeWon, uint8 tierMask, uint8 matchCount, uint48 revealBlock)","function getGameStatus(uint256 gameId) view returns (uint8 status, bool canReveal, uint256 blocksUntilReveal, uint256 blocksUntilExpiry)","function calculatePotentialWinnings(uint256 wagerAmount, uint8 tierMask) view returns (uint256 netToPool, uint256 bkcFee, uint256 maxPrize, uint256 maxPrizeAfterCap)","function getRequiredFee(uint8 tierMask) view returns (uint256 fee)","function generateCommitHash(uint256[] calldata guesses, bytes32 userSecret) pure returns (bytes32)","function gameCounter() view returns (uint256)","function prizePool() view returns (uint256)","function getPoolStats() view returns (uint256 prizePool, uint256 totalGamesPlayed, uint256 totalBkcWagered, uint256 totalBkcWon, uint256 totalBkcForfeited, uint256 totalBkcBurned, uint256 maxPayoutNow)","function REVEAL_DELAY() view returns (uint256)","function REVEAL_WINDOW() view returns (uint256)","function BKC_FEE_BPS() view returns (uint256)","function MAX_PAYOUT_BPS() view returns (uint256)","event GameCommitted(uint256 indexed gameId, address indexed player, uint256 wagerAmount, uint8 tierMask, address operator)","event GameRevealed(uint256 indexed gameId, address indexed player, uint256 grossWager, uint256 prizeWon, uint8 tierMask, uint8 matchCount)","event GameExpired(uint256 indexed gameId, address indexed player, uint96 forfeitedAmount)"],Yi=[{range:5,multiplierBps:2e4},{range:15,multiplierBps:1e5},{range:150,multiplierBps:1e6}];function al(e){const t=window.ethers,a=Ki();return new t.Contract(a.FORTUNE_POOL,vn,e)}async function Ze(){const e=window.ethers,{NetworkManager:t}=await K(async()=>{const{NetworkManager:i}=await import("./index-CalnOfTr.js");return{NetworkManager:i}},[]),a=t.getProvider(),n=Ki();return new e.Contract(n.FORTUNE_POOL,vn,a)}const Vi="fortune_pending_games";function wn(){try{return JSON.parse(localStorage.getItem(Vi)||"{}")}catch{return{}}}function fp(e,t){const a=wn();a[e]={...t,savedAt:Date.now()},localStorage.setItem(Vi,JSON.stringify(a))}function mp(e){const t=wn();delete t[e],localStorage.setItem(Vi,JSON.stringify(t))}function qi(e,t){const a=window.ethers,i=a.AbiCoder.defaultAbiCoder().encode(["uint256[]","bytes32"],[e.map(s=>BigInt(s)),t]);return a.keccak256(i)}function nl(){const e=window.ethers;return e.hexlify(e.randomBytes(32))}function gp(e){let t=0;for(;e;)t+=e&1,e>>=1;return t}async function Xi({commitmentHash:e,wagerAmount:t,tierMask:a,operator:n,button:i=null,onSuccess:s=null,onError:r=null}){const o=window.ethers,l=Ki(),d=BigInt(t),u=Number(a);if(u<1||u>7)throw new Error("tierMask must be 1-7");let f=n,p=0n;try{p=await(await Ze()).getRequiredFee(u),console.log("[FortuneTx] ETH fee:",o.formatEther(p))}catch(g){throw console.error("[FortuneTx] Could not fetch ETH fee:",g.message),new Error("Could not fetch ETH fee from contract")}return await U.execute({name:"CommitPlay",button:i,getContract:async g=>al(g),method:"commitPlay",args:()=>[e,d,u,Q(f)],value:p,approval:{token:l.BKC_TOKEN,spender:l.FORTUNE_POOL,amount:d},validate:async(g,b)=>{if(d<=0n)throw new Error("Wager amount must be greater than 0");const{NetworkManager:w}=await K(async()=>{const{NetworkManager:C}=await import("./index-CalnOfTr.js");return{NetworkManager:C}},[]),T=await w.getProvider().getBalance(b);if(p>0n&&T<p+o.parseEther("0.001"))throw new Error(`Insufficient ETH for fee (${o.formatEther(p)} ETH required)`)},onSuccess:async g=>{let b=null;try{const w=new o.Interface(vn);for(const T of g.logs)try{const C=w.parseLog(T);if(C.name==="GameCommitted"){b=Number(C.args.gameId);break}}catch{}}catch{}s&&s({gameId:b,txHash:g.hash,commitBlock:g.blockNumber})},onError:r})}async function Ji({gameId:e,guesses:t,userSecret:a,button:n=null,onSuccess:i=null,onError:s=null}){const r=window.ethers,o=t.map(l=>BigInt(l));return await U.execute({name:"RevealPlay",button:n,getContract:async l=>al(l),method:"revealPlay",args:[e,o,a],validate:async(l,d)=>{const u=await Ze(),f=await u.getGameStatus(e);if(Number(f.status)===3)throw new Error("Game has expired.");if(!f.canReveal)throw Number(f.blocksUntilReveal)>0?new Error(`Must wait ${f.blocksUntilReveal} more blocks before reveal`):new Error("Cannot reveal this game");const p=await u.getGame(e);if(p.player.toLowerCase()!==d.toLowerCase())throw new Error("You are not the owner of this game");const g=qi(t,a);p[0]&&p[0]},onSuccess:async l=>{let d=null;try{const u=new r.Interface(vn);for(const f of l.logs)try{const p=u.parseLog(f);p.name==="GameRevealed"&&(d={gameId:Number(p.args.gameId),grossWager:p.args.grossWager,prizeWon:p.args.prizeWon,tierMask:Number(p.args.tierMask),matchCount:Number(p.args.matchCount),won:p.args.prizeWon>0n})}catch{}}catch{}mp(e),i&&i(l,d)},onError:s})}async function il({wagerAmount:e,guess:t,guesses:a,tierMask:n=1,operator:i,button:s=null,onSuccess:r=null,onError:o=null}){const l=Number(n);if(l<1||l>7)throw new Error("tierMask must be 1-7");const d=gp(l);let u=[];if(a&&Array.isArray(a)&&a.length>0)u=a.map(b=>Number(b));else if(t!==void 0)u=[Number(Array.isArray(t)?t[0]:t)];else throw new Error("Guess(es) required");if(u.length!==d)throw new Error(`tierMask selects ${d} tier(s) but ${u.length} guess(es) provided`);let f=0;for(let b=0;b<3;b++)if(l&1<<b){const w=Yi[b].range;if(u[f]<1||u[f]>w)throw new Error(`Tier ${b} guess must be between 1 and ${w}`);f++}const p=nl(),g=qi(u,p);return await Xi({commitmentHash:g,wagerAmount:e,tierMask:l,operator:i,button:s,onSuccess:b=>{fp(b.gameId,{guesses:u,userSecret:p,tierMask:l,wagerAmount:e.toString(),commitmentHash:g}),r&&r({...b,guesses:u,userSecret:p,tierMask:l})},onError:o})}async function sl(){const e=await Ze();try{const t=await e.getAllTiers(),a=[];for(let n=0;n<3;n++)a.push({tierId:n,maxRange:Number(t.ranges[n]),multiplierBps:Number(t.multipliers[n]),multiplier:Number(t.multipliers[n])/1e4,winChanceBps:Number(t.winChances[n]),active:!0});return a}catch{return Yi.map((t,a)=>({tierId:a,maxRange:t.range,multiplierBps:t.multiplierBps,multiplier:t.multiplierBps/1e4,active:!0}))}}async function rl(e){const t=await Ze();try{const a=await t.getTierInfo(e);return{tierId:e,maxRange:Number(a.range),multiplierBps:Number(a.multiplier),multiplier:Number(a.multiplier)/1e4,winChanceBps:Number(a.winChanceBps)}}catch{return null}}async function ol(e=1){const t=await Ze();try{return await t.getRequiredFee(Number(e))}catch{return 0n}}async function ll(){const e=window.ethers,t=await Ze();try{const a=await t.getPoolStats();return{prizePoolBalance:a[0],prizePoolFormatted:e.formatEther(a[0]),gameCounter:Number(a[1]),totalWageredAllTime:a[2],totalWageredFormatted:e.formatEther(a[2]),totalPaidOutAllTime:a[3],totalPaidOutFormatted:e.formatEther(a[3]),totalForfeited:a[4],totalBurned:a[5],maxPayoutNow:a[6],maxPayoutFormatted:e.formatEther(a[6])}}catch{const[a,n]=await Promise.all([t.gameCounter().catch(()=>0n),t.prizePool().catch(()=>0n)]);return{gameCounter:Number(a),prizePoolBalance:n,prizePoolFormatted:e.formatEther(n)}}}async function cl(){return 3}async function dl(e,t=1){const a=window.ethers,n=await Ze();try{const i=await n.calculatePotentialWinnings(e,Number(t));return{netToPool:i.netToPool||i[0],bkcFee:i.bkcFee||i[1],maxPrize:i.maxPrize||i[2],maxPrizeFormatted:a.formatEther(i.maxPrize||i[2]),maxPrizeAfterCap:i.maxPrizeAfterCap||i[3],maxPrizeAfterCapFormatted:a.formatEther(i.maxPrizeAfterCap||i[3])}}catch{return{netToPool:0n,bkcFee:0n,maxPrize:0n,maxPrizeAfterCap:0n}}}async function ul(e){const t=await Ze();try{const a=await t.getGameResult(e);return{player:a.player,grossWager:a.grossWager,prizeWon:a.prizeWon,tierMask:Number(a.tierMask),matchCount:Number(a.matchCount),revealBlock:Number(a.revealBlock),won:a.prizeWon>0n}}catch{return null}}async function pl(e){const t=await Ze();try{const a=await t.getGameStatus(e);return{status:Number(a.status),statusName:["NONE","COMMITTED","REVEALED","EXPIRED"][Number(a.status)]||"UNKNOWN",canReveal:a.canReveal,isExpired:Number(a.status)===3,blocksUntilReveal:Number(a.blocksUntilReveal),blocksUntilExpiry:Number(a.blocksUntilExpiry)}}catch{return null}}function fl(){return wn()}function Zi(e){return wn()[e]||null}async function ml(e,t={}){const a=Zi(e);if(!a)throw new Error(`No pending game found with ID ${e}`);return await Ji({gameId:e,guesses:a.guesses,userSecret:a.userSecret,...t})}const Qi={commitPlay:Xi,revealPlay:Ji,playGame:il,revealPendingGame:ml,getPendingGamesForReveal:fl,getPendingGame:Zi,generateCommitmentHashLocal:qi,generateSecret:nl,getActiveTiers:sl,getTierById:rl,getServiceFee:ol,getPoolStats:ll,getActiveTierCount:cl,calculatePotentialWin:dl,getGameResult:ul,getCommitmentStatus:pl,TIERS:Yi},bp=Object.freeze(Object.defineProperty({__proto__:null,FortuneTx:Qi,calculatePotentialWin:dl,commitPlay:Xi,getActiveTierCount:cl,getActiveTiers:sl,getCommitmentStatus:pl,getGameResult:ul,getPendingGame:Zi,getPendingGamesForReveal:fl,getPoolStats:ll,getServiceFee:ol,getTierById:rl,playGame:il,revealPendingGame:ml,revealPlay:Ji},Symbol.toStringTag,{value:"Module"}));function yn(){var a,n;const e=(v==null?void 0:v.rentalManager)||(M==null?void 0:M.rentalManager)||((a=window.contractAddresses)==null?void 0:a.rentalManager),t=(v==null?void 0:v.rewardBooster)||(M==null?void 0:M.rewardBooster)||((n=window.contractAddresses)==null?void 0:n.rewardBooster);if(!e||!t)throw new Error("Contract addresses not loaded. Please refresh the page.");return{RENTAL_MANAGER:e,NFT_CONTRACT:t}}const es=["function listNFT(uint256 tokenId, uint96 pricePerHour, uint16 minHours, uint16 maxHours) external","function updateListing(uint256 tokenId, uint96 pricePerHour, uint16 minHours, uint16 maxHours) external","function withdrawNFT(uint256 tokenId) external","function rentNFT(uint256 tokenId, uint256 hours_, address operator) external payable","function withdrawEarnings() external","function getListing(uint256 tokenId) view returns (address owner, uint96 pricePerHour, uint16 minHours, uint16 maxHours, uint96 totalEarnings, uint32 rentalCount, bool currentlyRented, uint48 rentalEndTime)","function getAllListedTokenIds() view returns (uint256[])","function getListingCount() view returns (uint256)","function getRental(uint256 tokenId) view returns (address tenant, uint48 endTime, bool isActive)","function isRented(uint256 tokenId) view returns (bool)","function getRemainingTime(uint256 tokenId) view returns (uint256)","function hasActiveRental(address user) view returns (bool)","function getRentalCost(uint256 tokenId, uint256 hours_) view returns (uint256 rentalCost, uint256 ethFee, uint256 totalCost)","function pendingEarnings(address user) view returns (uint256)","function getStats() view returns (uint256 activeListings, uint256 volume, uint256 rentals, uint256 ethFees, uint256 earningsWithdrawn)","event NFTListed(uint256 indexed tokenId, address indexed owner, uint96 pricePerHour, uint16 minHours, uint16 maxHours)","event NFTRented(uint256 indexed tokenId, address indexed tenant, address indexed owner, uint256 hours_, uint256 rentalCost, uint256 ethFee, uint48 endTime, address operator)","event NFTWithdrawn(uint256 indexed tokenId, address indexed owner)","event EarningsWithdrawn(address indexed owner, uint256 amount)"],xp=["function setApprovalForAll(address operator, bool approved) external","function isApprovedForAll(address owner, address operator) view returns (bool)","function ownerOf(uint256 tokenId) view returns (address)"];function Ba(e){const t=yn();return new window.ethers.Contract(t.RENTAL_MANAGER,es,e)}async function ve(){const{NetworkManager:e}=await K(async()=>{const{NetworkManager:a}=await import("./index-CalnOfTr.js");return{NetworkManager:a}},[]),t=yn();return new window.ethers.Contract(t.RENTAL_MANAGER,es,e.getProvider())}function hp(e){const t=yn();return new window.ethers.Contract(t.NFT_CONTRACT,xp,e)}async function ts({tokenId:e,pricePerHour:t,minHours:a,maxHours:n,button:i=null,onSuccess:s=null,onError:r=null}){const o=yn(),l=BigInt(t);return await U.execute({name:"ListNFT",button:i,getContract:async d=>Ba(d),method:"listNFT",args:[e,l,a,n],validate:async(d,u)=>{const f=hp(d);if((await f.ownerOf(e)).toLowerCase()!==u.toLowerCase())throw new Error("You do not own this NFT");await f.isApprovedForAll(u,o.RENTAL_MANAGER)||await(await f.setApprovalForAll(o.RENTAL_MANAGER,!0)).wait()},onSuccess:s,onError:r})}async function as({tokenId:e,hours:t,operator:a,button:n=null,onSuccess:i=null,onError:s=null}){const r=window.ethers;let o=a,l=0n;return await U.execute({name:"RentNFT",button:n,getContract:async d=>Ba(d),method:"rentNFT",args:()=>[e,t,Q(o)],get value(){return l},validate:async(d,u)=>{const f=await ve(),p=await f.getListing(e);if(p.owner===r.ZeroAddress)throw new Error("NFT is not listed for rent");if(p.currentlyRented)throw new Error("NFT is currently rented");if(t<Number(p.minHours)||t>Number(p.maxHours))throw new Error(`Hours must be between ${p.minHours} and ${p.maxHours}`);const g=await f.getRentalCost(e,t);l=g.totalCost||g[2];const{NetworkManager:b}=await K(async()=>{const{NetworkManager:T}=await import("./index-CalnOfTr.js");return{NetworkManager:T}},[]);if(await b.getProvider().getBalance(u)<l+r.parseEther("0.001"))throw new Error(`Insufficient ETH. Need ${r.formatEther(l)} ETH + gas`)},onSuccess:async d=>{let u=null;try{const f=new r.Interface(es);for(const p of d.logs)try{const g=f.parseLog(p);if((g==null?void 0:g.name)==="NFTRented"){u={endTime:Number(g.args.endTime),rentalCost:g.args.rentalCost,ethFee:g.args.ethFee};break}}catch{}}catch{}i&&i(d,u)},onError:s})}async function ns({tokenId:e,button:t=null,onSuccess:a=null,onError:n=null}){const i=window.ethers;return await U.execute({name:"WithdrawNFT",button:t,getContract:async s=>Ba(s),method:"withdrawNFT",args:[e],validate:async(s,r)=>{const l=await(await ve()).getListing(e);if(l.owner===i.ZeroAddress)throw new Error("NFT is not listed");if(l.owner.toLowerCase()!==r.toLowerCase())throw new Error("Only the owner can withdraw");if(l.currentlyRented)throw new Error("Cannot withdraw while NFT is rented")},onSuccess:a,onError:n})}async function gl({button:e=null,onSuccess:t=null,onError:a=null}={}){const n=window.ethers;return await U.execute({name:"WithdrawEarnings",button:e,getContract:async i=>Ba(i),method:"withdrawEarnings",args:[],validate:async(i,s)=>{const o=await(await ve()).pendingEarnings(s);if(o===0n)throw new Error("No earnings to withdraw");console.log("[RentalTx] Withdrawing:",n.formatEther(o),"ETH")},onSuccess:t,onError:a})}async function bl({tokenId:e,pricePerHour:t,minHours:a,maxHours:n,button:i=null,onSuccess:s=null,onError:r=null}){const o=BigInt(t);return await U.execute({name:"UpdateListing",button:i,getContract:async l=>Ba(l),method:"updateListing",args:[e,o,a,n],validate:async(l,d)=>{const f=await(await ve()).getListing(e);if(f.owner===window.ethers.ZeroAddress)throw new Error("NFT is not listed");if(f.owner.toLowerCase()!==d.toLowerCase())throw new Error("Only the owner can update")},onSuccess:s,onError:r})}async function xl(e){const t=window.ethers,n=await(await ve()).getListing(e);return{owner:n.owner,pricePerHour:n.pricePerHour,pricePerHourFormatted:t.formatEther(n.pricePerHour),minHours:Number(n.minHours),maxHours:Number(n.maxHours),totalEarnings:n.totalEarnings,totalEarningsFormatted:t.formatEther(n.totalEarnings),rentalCount:Number(n.rentalCount),isActive:n.owner!==t.ZeroAddress,currentlyRented:n.currentlyRented,rentalEndTime:Number(n.rentalEndTime)}}async function hl(e){const a=await(await ve()).getRental(e),n=Math.floor(Date.now()/1e3),i=Number(a.endTime);return{tenant:a.tenant,endTime:i,isActive:a.isActive,hoursRemaining:a.isActive?Math.max(0,Math.ceil((i-n)/3600)):0}}async function vl(){return(await(await ve()).getAllListedTokenIds()).map(a=>Number(a))}async function wl(){const e=await ve();return Number(await e.getListingCount())}async function yl(e,t){const a=window.ethers,i=await(await ve()).getRentalCost(e,t);return{rentalCost:i.rentalCost||i[0],rentalCostFormatted:a.formatEther(i.rentalCost||i[0]),ethFee:i.ethFee||i[1],ethFeeFormatted:a.formatEther(i.ethFee||i[1]),totalCost:i.totalCost||i[2],totalCostFormatted:a.formatEther(i.totalCost||i[2])}}async function kl(e){return await(await ve()).isRented(e)}async function El(e){const t=await ve();return Number(await t.getRemainingTime(e))}async function Tl(e){const t=await ve();try{return await t.hasActiveRental(e)}catch{return!1}}async function Cl(e){const t=window.ethers,n=await(await ve()).pendingEarnings(e);return{amount:n,formatted:t.formatEther(n)}}async function Il(){const e=window.ethers,t=await ve();try{const a=await t.getStats();return{activeListings:Number(a.activeListings||a[0]),totalVolume:a.volume||a[1],totalVolumeFormatted:e.formatEther(a.volume||a[1]),totalRentals:Number(a.rentals||a[2]),totalEthFees:a.ethFees||a[3],totalEthFeesFormatted:e.formatEther(a.ethFees||a[3]),totalEarningsWithdrawn:a.earningsWithdrawn||a[4],totalEarningsWithdrawnFormatted:e.formatEther(a.earningsWithdrawn||a[4])}}catch{return{activeListings:0,totalVolume:0n,totalVolumeFormatted:"0",totalRentals:0,totalEthFees:0n,totalEthFeesFormatted:"0"}}}const Al=ts,Pl=as,zl=ns,Na={listNft:ts,rentNft:as,withdrawNft:ns,withdrawEarnings:gl,updateListing:bl,list:Al,rent:Pl,withdraw:zl,getListing:xl,getAllListedTokenIds:vl,getListingCount:wl,getRentalCost:yl,getRental:hl,isRented:kl,getRemainingRentalTime:El,hasActiveRental:Tl,getPendingEarnings:Cl,getMarketplaceStats:Il},vp=Object.freeze(Object.defineProperty({__proto__:null,RentalTx:Na,getAllListedTokenIds:vl,getListing:xl,getListingCount:wl,getMarketplaceStats:Il,getPendingEarnings:Cl,getRemainingRentalTime:El,getRental:hl,getRentalCost:yl,hasActiveRental:Tl,isRented:kl,list:Al,listNft:ts,rent:Pl,rentNft:as,updateListing:bl,withdraw:zl,withdrawEarnings:gl,withdrawNft:ns},Symbol.toStringTag,{value:"Module"}));function Bl(){var t;const e=(v==null?void 0:v.notary)||(M==null?void 0:M.notary)||((t=window.contractAddresses)==null?void 0:t.notary);if(!e)throw console.error("❌ Notary address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{NOTARY:e}}const is=["function certify(bytes32 documentHash, string calldata meta, uint8 docType, address operator) external payable returns (uint256 certId)","function batchCertify(bytes32[] calldata documentHashes, string[] calldata metas, uint8[] calldata docTypes, address operator) external payable returns (uint256 startId)","function transferCertificate(bytes32 documentHash, address newOwner) external","function verify(bytes32 documentHash) view returns (bool exists, address owner, uint48 timestamp, uint8 docType, string memory meta)","function getCertificate(uint256 certId) view returns (bytes32 documentHash, address owner, uint48 timestamp, uint8 docType, string memory meta)","function getFee() view returns (uint256)","function getStats() view returns (uint256 certCount, uint256 totalEthCollected)","function certCount() view returns (uint256)","function version() view returns (string)","event Certified(uint256 indexed certId, address indexed owner, bytes32 indexed documentHash, uint8 docType, address operator)","event BatchCertified(address indexed owner, uint256 startId, uint256 count, address operator)","event CertificateTransferred(bytes32 indexed documentHash, address indexed from, address indexed to)"],wp={GENERAL:0,CONTRACT:1,IDENTITY:2,DIPLOMA:3,PROPERTY:4,FINANCIAL:5,LEGAL:6,MEDICAL:7,IP:8,OTHER:9};function yp(e){const t=window.ethers;if(!t)throw new Error("ethers.js not loaded");if(!e)throw new Error("Signer is required for write operations");const a=Bl();return new t.Contract(a.NOTARY,is,e)}async function ta(){const e=window.ethers;if(!e)throw new Error("ethers.js not loaded");const{NetworkManager:t}=await K(async()=>{const{NetworkManager:i}=await import("./index-CalnOfTr.js");return{NetworkManager:i}},[]),a=t.getProvider();if(!a)throw new Error("Provider not available");const n=Bl();return new e.Contract(n.NOTARY,is,a)}function kp(e){if(!e)return!1;const t=e.startsWith("0x")?e:`0x${e}`;return/^0x[a-fA-F0-9]{64}$/.test(t)}async function ss({documentHash:e,meta:t="",docType:a=0,operator:n,button:i=null,onSuccess:s=null,onError:r=null}){const o=window.ethers;if(!e)throw new Error("Document hash is required");const l=e.startsWith("0x")?e:`0x${e}`;if(!kp(l))throw new Error("Invalid document hash format. Must be a valid bytes32 (64 hex characters)");if(a<0||a>9)throw new Error("Document type must be between 0 and 9");let d=n,u=0n;return await U.execute({name:"Certify",button:i,getContract:async f=>yp(f),method:"certify",args:()=>[l,t||"",a,Q(d)],get value(){return u},validate:async(f,p)=>{const g=await ta();if((await g.verify(l)).exists)throw new Error("This document hash has already been certified");u=await g.getFee(),console.log("[NotaryTx] Fee:",o.formatEther(u),"ETH");const{NetworkManager:w}=await K(async()=>{const{NetworkManager:S}=await import("./index-CalnOfTr.js");return{NetworkManager:S}},[]),C=await w.getProvider().getBalance(p),P=u+o.parseEther("0.001");if(C<P)throw new Error(`Insufficient ETH. Need ~${o.formatEther(P)} ETH for fee + gas`)},onSuccess:async f=>{let p=null;try{const g=new o.Interface(is);for(const b of f.logs)try{const w=g.parseLog(b);if(w&&w.name==="Certified"){p=Number(w.args.certId);break}}catch{}}catch{}s&&s(f,p)},onError:f=>{console.error("[NotaryTx] Certification failed:",f),r&&r(f)}})}const Nl=ss;async function kn(e){const t=await ta(),a=e.startsWith("0x")?e:`0x${e}`;try{const n=await t.verify(a);return{exists:n.exists,owner:n.exists?n.owner:null,timestamp:n.exists?Number(n.timestamp):null,date:n.exists?new Date(Number(n.timestamp)*1e3):null,docType:n.exists?Number(n.docType):null,meta:n.exists?n.meta:null}}catch(n){return console.error("[NotaryTx] verify error:",n),{exists:!1,owner:null,timestamp:null,date:null,docType:null,meta:null}}}const Sl=kn;async function rs(e){const t=await ta();try{const a=await t.getCertificate(e);return a.documentHash==="0x"+"0".repeat(64)?null:{id:e,documentHash:a.documentHash,owner:a.owner,timestamp:Number(a.timestamp),date:new Date(Number(a.timestamp)*1e3),docType:Number(a.docType),meta:a.meta}}catch{return null}}const $l=rs;async function Ll(){const e=window.ethers,a=await(await ta()).getFee();return{ethFee:a,ethFormatted:e.formatEther(a)+" ETH"}}async function Rl(){const e=await ta();return Number(await e.certCount())}async function _l(){const e=window.ethers,a=await(await ta()).getStats();return{totalCertifications:Number(a.certCount||a[0]),totalETHCollected:a.totalEthCollected||a[1],totalETHFormatted:e.formatEther(a.totalEthCollected||a[1])}}async function En(e){let t;if(e instanceof ArrayBuffer)t=e;else if(e instanceof Blob||e instanceof File)t=await e.arrayBuffer();else throw new Error("Invalid file type. Expected File, Blob, or ArrayBuffer");const a=await crypto.subtle.digest("SHA-256",t);return"0x"+Array.from(new Uint8Array(a)).map(i=>i.toString(16).padStart(2,"0")).join("")}async function os(e,t){const a=await En(e);return ar(t)===ar(a)}function ar(e){return(e.startsWith("0x")?e:`0x${e}`).toLowerCase()}async function Fl(e,t){const a=t||await En(e),n=await kn(a);let i=!0;return t&&(i=await os(e,t)),{contentHash:a,hashMatches:i,existsOnChain:n.exists,certId:null,owner:n.owner,timestamp:n.timestamp,date:n.date,docType:n.docType,isVerified:i&&n.exists}}const Xe={certify:ss,notarize:Nl,verify:kn,verifyByHash:Sl,getCertificate:rs,getDocument:$l,getTotalDocuments:Rl,getFee:Ll,getStats:_l,calculateFileHash:En,verifyDocumentHash:os,verifyDocumentOnChain:Fl,DOC_TYPES:wp},Ep=Object.freeze(Object.defineProperty({__proto__:null,NotaryTx:Xe,calculateFileHash:En,certify:ss,getCertificate:rs,getDocument:$l,getFee:Ll,getStats:_l,getTotalDocuments:Rl,notarize:Nl,verify:kn,verifyByHash:Sl,verifyDocumentHash:os,verifyDocumentOnChain:Fl},Symbol.toStringTag,{value:"Module"}));function Ml(){var t;const e=(v==null?void 0:v.agora)||(M==null?void 0:M.agora)||((t=window.contractAddresses)==null?void 0:t.agora);if(!e)throw new Error("Agora contract address not loaded");return{AGORA:e}}const Tn=Aa;function we(e){return new window.ethers.Contract(Ml().AGORA,Tn,e)}async function ge(){const{NetworkManager:e}=await K(async()=>{const{NetworkManager:t}=await import("./index-CalnOfTr.js");return{NetworkManager:t}},[]);return new window.ethers.Contract(Ml().AGORA,Tn,e.getProvider())}async function Dl({username:e,metadataURI:t="",operator:a,button:n=null,onSuccess:i=null,onError:s=null}){const r=window.ethers;let o=a,l=0n;return await U.execute({name:"CreateProfile",button:n,skipSimulation:!0,fixedGasLimit:300000n,getContract:async d=>we(d),method:"createProfile",args:()=>[e,t||"",Q(o)],get value(){return l},validate:async(d,u)=>{const f=await ge();if(!e||e.length<1||e.length>15)throw new Error("Username must be 1-15 characters");if(!/^[a-z0-9_]+$/.test(e))throw new Error("Username: lowercase letters, numbers, underscores only");if(!await f.isUsernameAvailable(e))throw new Error("Username is already taken");l=await f.getUsernamePrice(e.length),console.log("[Agora] Username fee:",r.formatEther(l),"ETH");const{NetworkManager:g}=await K(async()=>{const{NetworkManager:w}=await import("./index-CalnOfTr.js");return{NetworkManager:w}},[]);if(await g.getProvider().getBalance(u)<l+r.parseEther("0.001"))throw new Error(`Insufficient ETH. Need ~${r.formatEther(l+r.parseEther("0.001"))} ETH`)},onSuccess:i,onError:s})}async function Ol({metadataURI:e,button:t=null,onSuccess:a=null,onError:n=null}){return await U.execute({name:"UpdateProfile",button:t,skipSimulation:!0,fixedGasLimit:200000n,getContract:async i=>we(i),method:"updateProfile",args:[e||""],onSuccess:a,onError:n})}async function Hl({content:e,tag:t=0,contentType:a=0,operator:n,button:i=null,onSuccess:s=null,onError:r=null}){const o=window.ethers;let l=n;return await U.execute({name:"CreatePost",button:i,skipSimulation:!0,fixedGasLimit:300000n,getContract:async d=>we(d),method:"createPost",args:()=>[e,t,a,Q(l)],validate:async(d,u)=>{if(!e||e.length===0)throw new Error("Content is required");if(t<0||t>14)throw new Error("Tag must be 0-14")},onSuccess:async d=>{let u=null;try{const f=new o.Interface(Tn);for(const p of d.logs)try{const g=f.parseLog(p);if((g==null?void 0:g.name)==="PostCreated"){u=Number(g.args[0]);break}}catch{}}catch{}s&&s(d,u)},onError:r})}async function Ul({parentId:e,content:t,contentType:a=0,operator:n,button:i=null,onSuccess:s=null,onError:r=null}){const o=window.ethers;let l=n;return await U.execute({name:"CreateReply",button:i,skipSimulation:!0,fixedGasLimit:350000n,getContract:async d=>we(d),method:"createReply",args:()=>[e,t,a,Q(l)],validate:async(d,u)=>{if(!t)throw new Error("Content is required")},onSuccess:async d=>{let u=null;try{const f=new o.Interface(Tn);for(const p of d.logs)try{const g=f.parseLog(p);if((g==null?void 0:g.name)==="ReplyCreated"){u=Number(g.args[0]);break}}catch{}}catch{}s&&s(d,u)},onError:r})}async function jl({originalPostId:e,quote:t="",operator:a,button:n=null,onSuccess:i=null,onError:s=null}){let r=a;return await U.execute({name:"CreateRepost",button:n,skipSimulation:!0,fixedGasLimit:250000n,getContract:async o=>we(o),method:"createRepost",args:()=>[e,t||"",Q(r)],onSuccess:i,onError:s})}async function Wl({postId:e,operator:t,button:a=null,onSuccess:n=null,onError:i=null}){let s=t;return await U.execute({name:"Like",button:a,skipSimulation:!0,fixedGasLimit:200000n,getContract:async r=>we(r),method:"like",args:()=>[e,Q(s)],validate:async(r,o)=>{if(await(await ge()).hasLiked(e,o))throw new Error("Already liked this post")},onSuccess:n,onError:i})}async function Gl({postId:e,ethAmount:t,operator:a,button:n=null,onSuccess:i=null,onError:s=null}){let r=a;const o=BigInt(t);return await U.execute({name:"SuperLike",button:n,skipSimulation:!0,fixedGasLimit:250000n,getContract:async l=>we(l),method:"superLike",args:()=>[e,Q(r)],value:o,validate:async()=>{if(o<100000000n)throw new Error("Minimum super like is 100 gwei")},onSuccess:i,onError:s})}async function Kl({postId:e,ethAmount:t,operator:a,button:n=null,onSuccess:i=null,onError:s=null}){let r=a;const o=BigInt(t);return await U.execute({name:"Downvote",button:n,skipSimulation:!0,fixedGasLimit:250000n,getContract:async l=>we(l),method:"downvote",args:()=>[e,Q(r)],value:o,validate:async()=>{if(o<100000000n)throw new Error("Minimum downvote is 100 gwei")},onSuccess:i,onError:s})}async function Yl({toFollow:e,operator:t,button:a=null,onSuccess:n=null,onError:i=null}){let s=t;return await U.execute({name:"Follow",button:a,skipSimulation:!0,fixedGasLimit:200000n,getContract:async r=>we(r),method:"follow",args:()=>[e,Q(s)],validate:async(r,o)=>{if(!e||e==="0x0000000000000000000000000000000000000000")throw new Error("Invalid address");if(e.toLowerCase()===o.toLowerCase())throw new Error("Cannot follow yourself")},onSuccess:n,onError:i})}async function Vl({toUnfollow:e,button:t=null,onSuccess:a=null,onError:n=null}){return await U.execute({name:"Unfollow",button:t,skipSimulation:!0,fixedGasLimit:150000n,getContract:async i=>we(i),method:"unfollow",args:[e],onSuccess:a,onError:n})}async function ql({postId:e,button:t=null,onSuccess:a=null,onError:n=null}){return await U.execute({name:"DeletePost",button:t,skipSimulation:!0,fixedGasLimit:150000n,getContract:async i=>we(i),method:"deletePost",args:[e],onSuccess:a,onError:n})}async function Xl({postId:e,button:t=null,onSuccess:a=null,onError:n=null}){return await U.execute({name:"PinPost",button:t,skipSimulation:!0,fixedGasLimit:150000n,getContract:async i=>we(i),method:"pinPost",args:[e],onSuccess:a,onError:n})}async function Jl({ethAmount:e,operator:t,button:a=null,onSuccess:n=null,onError:i=null}){let s=t;const r=BigInt(e);return await U.execute({name:"BoostProfile",button:a,skipSimulation:!0,fixedGasLimit:200000n,getContract:async o=>we(o),method:"boostProfile",args:()=>[Q(s)],value:r,validate:async()=>{const o=window.ethers;if(r<o.parseEther("0.0005"))throw new Error("Minimum boost is 0.0005 ETH")},onSuccess:n,onError:i})}async function Zl({operator:e,button:t=null,onSuccess:a=null,onError:n=null}){const i=window.ethers;let s=e;const r=i.parseEther("0.001");return await U.execute({name:"ObtainBadge",button:t,skipSimulation:!0,fixedGasLimit:250000n,getContract:async o=>we(o),method:"obtainBadge",args:()=>[Q(s)],value:r,onSuccess:a,onError:n})}async function ls(e){const t=window.ethers,n=await(await ge()).getUsernamePrice(e);return{fee:n,formatted:t.formatEther(n)}}const Ql=ls;async function ec(e){const a=await(await ge()).getPost(e);return{author:a.author,tag:Number(a.tag),contentType:Number(a.contentType),deleted:a.deleted,createdAt:Number(a.createdAt),replyTo:Number(a._replyTo),repostOf:Number(a._repostOf),likes:Number(a.likes),superLikes:Number(a.superLikes),downvotes:Number(a.downvotes),replies:Number(a.replies),reposts:Number(a.reposts)}}async function tc(){const e=await ge();return Number(await e.postCounter())}async function ac(e){const a=await(await ge()).getUserProfile(e);return{usernameHash:a.usernameHash,metadataURI:a.metadataURI,pinnedPost:Number(a.pinned),boosted:a.boosted,hasBadge:a.hasBadge,boostExpiry:Number(a.boostExp),badgeExpiry:Number(a.badgeExp)}}async function nc(e){return await(await ge()).isUsernameAvailable(e)}async function ic(e,t){return await(await ge()).hasLiked(e,t)}async function sc(e){return await(await ge()).isProfileBoosted(e)}async function rc(e){return await(await ge()).hasTrustBadge(e)}async function oc(e){const a=await(await ge()).getUserProfile(e);return Number(a.boostExp)}async function lc(e){const a=await(await ge()).getUserProfile(e);return Number(a.badgeExp)}async function cc(){const t=await(await ge()).getGlobalStats();return{totalPosts:Number(t._totalPosts||t[0]),totalProfiles:Number(t._totalProfiles||t[1]),tagCounts:(t._tagCounts||t[2]).map(a=>Number(a))}}async function dc(e){const a=await(await ge()).getOperatorStats(e);return{posts:Number(a.posts_||a[0]),engagement:Number(a.engagement||a[1])}}async function uc(){return await(await ge()).version()}const xe={createProfile:Dl,updateProfile:Ol,createPost:Hl,createReply:Ul,createRepost:jl,deletePost:ql,pinPost:Xl,like:Wl,superLike:Gl,downvote:Kl,follow:Yl,unfollow:Vl,boostProfile:Jl,obtainBadge:Zl,getUsernamePrice:ls,getUsernameFee:Ql,getPost:ec,getPostCount:tc,getUserProfile:ac,isUsernameAvailable:nc,hasUserLiked:ic,isProfileBoosted:sc,hasTrustBadge:rc,getBoostExpiry:oc,getBadgeExpiry:lc,getGlobalStats:cc,getOperatorStats:dc,getVersion:uc},Tp=Object.freeze(Object.defineProperty({__proto__:null,BackchatTx:xe,boostProfile:Jl,createPost:Hl,createProfile:Dl,createReply:Ul,createRepost:jl,deletePost:ql,downvote:Kl,follow:Yl,getBadgeExpiry:lc,getBoostExpiry:oc,getGlobalStats:cc,getOperatorStats:dc,getPost:ec,getPostCount:tc,getUserProfile:ac,getUsernameFee:Ql,getUsernamePrice:ls,getVersion:uc,hasTrustBadge:rc,hasUserLiked:ic,isProfileBoosted:sc,isUsernameAvailable:nc,like:Wl,obtainBadge:Zl,pinPost:Xl,superLike:Gl,unfollow:Vl,updateProfile:Ol},Symbol.toStringTag,{value:"Module"}));(async()=>(await K(async()=>{const{CharityTx:e}=await Promise.resolve().then(()=>lp);return{CharityTx:e}},void 0)).CharityTx)(),(async()=>(await K(async()=>{const{StakingTx:e}=await Promise.resolve().then(()=>cp);return{StakingTx:e}},void 0)).StakingTx)(),(async()=>(await K(async()=>{const{NftTx:e}=await Promise.resolve().then(()=>pp);return{NftTx:e}},void 0)).NftTx)(),(async()=>(await K(async()=>{const{FortuneTx:e}=await Promise.resolve().then(()=>bp);return{FortuneTx:e}},void 0)).FortuneTx)(),(async()=>(await K(async()=>{const{RentalTx:e}=await Promise.resolve().then(()=>vp);return{RentalTx:e}},void 0)).RentalTx)(),(async()=>(await K(async()=>{const{NotaryTx:e}=await Promise.resolve().then(()=>Ep);return{NotaryTx:e}},void 0)).NotaryTx)(),(async()=>(await K(async()=>{const{FaucetTx:e}=await Promise.resolve().then(()=>Yu);return{FaucetTx:e}},void 0)).FaucetTx)(),(async()=>(await K(async()=>{const{BackchatTx:e}=await Promise.resolve().then(()=>Tp);return{BackchatTx:e}},void 0)).BackchatTx)();const Qa=window.ethers,$={hasRenderedOnce:!1,lastUpdate:0,activities:[],networkActivities:[],filteredActivities:[],userProfile:null,pagination:{currentPage:1,itemsPerPage:8},filters:{type:"ALL",sort:"NEWEST"},metricsCache:{},economicData:null,isLoadingNetworkActivity:!1,networkActivitiesTimestamp:0,faucet:{canClaim:!0,cooldownEnd:null,isLoading:!1,lastCheck:0}},nr="https://sepolia.arbiscan.io/tx/",Cp="https://faucet-4wvdcuoouq-uc.a.run.app",Ip="https://getrecentactivity-4wvdcuoouq-uc.a.run.app",Ap="https://getsystemdata-4wvdcuoouq-uc.a.run.app",pc="1,000",fc="0.01",H={STAKING:{icon:"fa-lock",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🔒 Staked",emoji:"🔒"},UNSTAKING:{icon:"fa-unlock",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"🔓 Unstaked",emoji:"🔓"},FORCE_UNSTAKE:{icon:"fa-bolt",color:"#ef4444",bg:"rgba(239,68,68,0.15)",label:"⚡ Force Unstaked",emoji:"⚡"},CLAIM:{icon:"fa-coins",color:"#fbbf24",bg:"rgba(245,158,11,0.15)",label:"🪙 Rewards Claimed",emoji:"🪙"},NFT_BUY:{icon:"fa-bag-shopping",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🛍️ Bought NFT",emoji:"🛍️"},NFT_SELL:{icon:"fa-hand-holding-dollar",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"💰 Sold NFT",emoji:"💰"},NFT_MINT:{icon:"fa-gem",color:"#fde047",bg:"rgba(234,179,8,0.15)",label:"💎 Minted Booster",emoji:"💎"},NFT_TRANSFER:{icon:"fa-arrow-right-arrow-left",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"↔️ Transfer",emoji:"↔️"},RENTAL_LIST:{icon:"fa-tag",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🏷️ Listed NFT",emoji:"🏷️"},RENTAL_RENT:{icon:"fa-clock",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"⏰ Rented NFT",emoji:"⏰"},RENTAL_WITHDRAW:{icon:"fa-rotate-left",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"↩️ Withdrawn",emoji:"↩️"},RENTAL_PROMOTE:{icon:"fa-bullhorn",color:"#fbbf24",bg:"rgba(251,191,36,0.2)",label:"📢 Promoted NFT",emoji:"📢"},FORTUNE_COMMIT:{icon:"fa-lock",color:"#a855f7",bg:"rgba(168,85,247,0.2)",label:"🔐 Game Committed",emoji:"🔐"},FORTUNE_REVEAL:{icon:"fa-dice",color:"#f97316",bg:"rgba(249,115,22,0.2)",label:"🎲 Game Revealed",emoji:"🎲"},FORTUNE_BET:{icon:"fa-paw",color:"#f97316",bg:"rgba(249,115,22,0.2)",label:"🐯 Fortune Bet",emoji:"🐯"},FORTUNE_COMBO:{icon:"fa-rocket",color:"#a855f7",bg:"rgba(168,85,247,0.2)",label:"🚀 Combo Mode",emoji:"🚀"},FORTUNE_WIN:{icon:"fa-trophy",color:"#facc15",bg:"rgba(234,179,8,0.25)",label:"🏆 Winner!",emoji:"🏆"},NOTARY:{icon:"fa-stamp",color:"#818cf8",bg:"rgba(99,102,241,0.15)",label:"📜 Notarized",emoji:"📜"},BACKCHAT_POST:{icon:"fa-comment",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"💬 Posted",emoji:"💬"},BACKCHAT_LIKE:{icon:"fa-heart",color:"#ec4899",bg:"rgba(236,72,153,0.15)",label:"❤️ Liked",emoji:"❤️"},BACKCHAT_REPLY:{icon:"fa-reply",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"↩️ Replied",emoji:"↩️"},BACKCHAT_SUPERLIKE:{icon:"fa-star",color:"#fbbf24",bg:"rgba(251,191,36,0.2)",label:"⭐ Super Liked",emoji:"⭐"},BACKCHAT_REPOST:{icon:"fa-retweet",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🔄 Reposted",emoji:"🔄"},BACKCHAT_FOLLOW:{icon:"fa-user-plus",color:"#a78bfa",bg:"rgba(167,139,250,0.15)",label:"👥 Followed",emoji:"👥"},BACKCHAT_PROFILE:{icon:"fa-user",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"👤 Profile Created",emoji:"👤"},BACKCHAT_BOOST:{icon:"fa-rocket",color:"#f97316",bg:"rgba(249,115,22,0.15)",label:"🚀 Profile Boosted",emoji:"🚀"},BACKCHAT_BADGE:{icon:"fa-circle-check",color:"#10b981",bg:"rgba(16,185,129,0.15)",label:"✅ Badge Activated",emoji:"✅"},BACKCHAT_TIP:{icon:"fa-coins",color:"#fbbf24",bg:"rgba(251,191,36,0.15)",label:"💰 Tipped BKC",emoji:"💰"},BACKCHAT_WITHDRAW:{icon:"fa-wallet",color:"#8b5cf6",bg:"rgba(139,92,246,0.15)",label:"💸 ETH Withdrawn",emoji:"💸"},CHARITY_DONATE:{icon:"fa-heart",color:"#ec4899",bg:"rgba(236,72,153,0.15)",label:"💝 Donated",emoji:"💝"},CHARITY_CREATE:{icon:"fa-hand-holding-heart",color:"#10b981",bg:"rgba(16,185,129,0.15)",label:"🌱 Campaign Created",emoji:"🌱"},CHARITY_CANCEL:{icon:"fa-heart-crack",color:"#ef4444",bg:"rgba(239,68,68,0.15)",label:"💔 Campaign Cancelled",emoji:"💔"},CHARITY_WITHDRAW:{icon:"fa-hand-holding-dollar",color:"#8b5cf6",bg:"rgba(139,92,246,0.15)",label:"💰 Funds Withdrawn",emoji:"💰"},CHARITY_GOAL_REACHED:{icon:"fa-trophy",color:"#fbbf24",bg:"rgba(251,191,36,0.15)",label:"🏆 Goal Reached!",emoji:"🏆"},FAUCET:{icon:"fa-droplet",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"💧 Faucet Claim",emoji:"💧"},DEFAULT:{icon:"fa-circle",color:"#71717a",bg:"rgba(39,39,42,0.5)",label:"Activity",emoji:"📋"}};function Pp(e){if(!e)return"Just now";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3,a=new Date(t*1e3),i=new Date-a,s=Math.floor(i/6e4),r=Math.floor(i/36e5),o=Math.floor(i/864e5);return s<1?"Just now":s<60?`${s}m ago`:r<24?`${r}h ago`:o<7?`${o}d ago`:a.toLocaleDateString()}catch{return"Recent"}}function zp(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function Ga(e){return e>=1e6?(e/1e6).toFixed(2)+"M":e>=1e3?(e/1e3).toFixed(1)+"K":e.toFixed(0)}function Bp(e){return e?`${e.slice(0,6)}...${e.slice(-4)}`:""}function Np(e){if(!e)return"";const t=Date.now(),n=new Date(e).getTime()-t;if(n<=0)return"";const i=Math.floor(n/36e5),s=Math.floor(n%36e5/6e4);return i>0?`${i}h ${s}m`:`${s}m`}function Sp(e,t={}){const a=(e||"").toUpperCase().trim();return a==="STAKING"||a==="STAKED"||a==="STAKE"||a==="DELEGATED"||a==="DELEGATION"||a.includes("DELEGAT")?H.STAKING:a==="UNSTAKING"||a==="UNSTAKED"||a==="UNSTAKE"||a==="UNDELEGATED"?H.UNSTAKING:a==="FORCE_UNSTAKE"||a==="FORCEUNSTAKE"||a==="FORCE_UNSTAKED"?H.FORCE_UNSTAKE:a==="CLAIM"||a==="CLAIMED"||a==="REWARD"||a==="REWARDS"||a==="REWARD_CLAIMED"||a==="REWARDCLAIMED"?H.CLAIM:a==="NFT_BUY"||a==="NFTBUY"||a==="BOOSTER_BUY"||a==="BOOSTERBUY"||a==="BOOSTERBOUGHT"||a.includes("BUY")&&(a.includes("NFT")||a.includes("BOOSTER"))?H.NFT_BUY:a==="NFT_SELL"||a==="NFTSELL"||a==="BOOSTER_SELL"||a==="BOOSTERSELL"||a==="BOOSTERSOLD"||a.includes("SELL")&&(a.includes("NFT")||a.includes("BOOSTER"))?H.NFT_SELL:a==="NFT_MINT"||a==="NFTMINT"||a==="BOOSTER_MINT"||a==="BOOSTERMINT"||a==="MINTED"||a==="BOOSTERMINTED"?H.NFT_MINT:a==="NFT_TRANSFER"||a==="NFTTRANSFER"||a==="BOOSTER_TRANSFER"||a==="BOOSTERTRANSFER"||a==="TRANSFER"?H.NFT_TRANSFER:a==="RENTAL_LIST"||a==="RENTALLISTED"||a==="RENTAL_LISTED"||a==="LISTED"||a.includes("LIST")&&a.includes("RENTAL")?H.RENTAL_LIST:a==="RENTAL_RENT"||a==="RENTALRENTED"||a==="RENTAL_RENTED"||a==="RENTED"||a.includes("RENT")&&!a.includes("LIST")?H.RENTAL_RENT:a==="RENTAL_WITHDRAW"||a==="RENTALWITHDRAWN"||a==="RENTAL_WITHDRAWN"?H.RENTAL_WITHDRAW:a==="RENTAL_PROMOTE"||a==="RENTALPROMOTED"||a==="RENTAL_PROMOTED"||a.includes("PROMOT")||a.includes("ADS")||a.includes("ADVERTIS")?H.RENTAL_PROMOTE:a==="FORTUNE_COMMIT"||a==="GAMECOMMITTED"||a==="GAME_COMMITTED"||a==="COMMITTED"?H.FORTUNE_COMMIT:a==="FORTUNE_REVEAL"||a==="GAMEREVEALED"||a==="GAME_REVEALED"||a==="REVEALED"?H.FORTUNE_REVEAL:a.includes("GAME")||a.includes("FORTUNE")||a.includes("REQUEST")||a.includes("FULFILLED")||a.includes("RESULT")?(t==null?void 0:t.isWin)||(t==null?void 0:t.prizeWon)&&BigInt(t.prizeWon||0)>0n?H.FORTUNE_WIN:(t==null?void 0:t.isCumulative)?H.FORTUNE_COMBO:H.FORTUNE_BET:a==="POSTCREATED"||a==="POST_CREATED"||a==="POSTED"||a==="BACKCHAT_POST"||a.includes("POST")&&!a.includes("REPOST")?H.BACKCHAT_POST:a==="SUPERLIKED"||a==="SUPER_LIKED"||a.includes("SUPERLIKE")?H.BACKCHAT_SUPERLIKE:a==="LIKED"||a==="POSTLIKED"||a==="POST_LIKED"||a.includes("LIKE")&&!a.includes("SUPER")?H.BACKCHAT_LIKE:a==="REPLYCREATED"||a==="REPLY_CREATED"||a.includes("REPLY")?H.BACKCHAT_REPLY:a==="REPOSTCREATED"||a==="REPOST_CREATED"||a.includes("REPOST")?H.BACKCHAT_REPOST:a==="FOLLOWED"||a==="USER_FOLLOWED"||a.includes("FOLLOW")?H.BACKCHAT_FOLLOW:a==="PROFILECREATED"||a==="PROFILE_CREATED"||a.includes("PROFILE")&&a.includes("CREAT")?H.BACKCHAT_PROFILE:a==="PROFILEBOOSTED"||a==="PROFILE_BOOSTED"||a==="BOOSTED"||a.includes("BOOST")&&!a.includes("NFT")?H.BACKCHAT_BOOST:a==="BADGEACTIVATED"||a==="BADGE_ACTIVATED"||a.includes("BADGE")?H.BACKCHAT_BADGE:a==="TIPPROCESSED"||a==="TIP_PROCESSED"||a==="TIPPED"||a.includes("TIP")?H.BACKCHAT_TIP:a==="ETHWITHDRAWN"||a==="ETH_WITHDRAWN"||a==="BACKCHAT_WITHDRAW"?H.BACKCHAT_WITHDRAW:a==="CHARITYDONATION"||a==="DONATIONMADE"||a==="CHARITY_DONATE"||a==="DONATED"||a==="DONATION"||a.includes("DONATION")?H.CHARITY_DONATE:a==="CHARITYCAMPAIGNCREATED"||a==="CAMPAIGNCREATED"||a==="CHARITY_CREATE"||a==="CAMPAIGN_CREATED"||a.includes("CAMPAIGNCREATED")?H.CHARITY_CREATE:a==="CHARITYCAMPAIGNCANCELLED"||a==="CAMPAIGNCANCELLED"||a==="CHARITY_CANCEL"||a==="CAMPAIGN_CANCELLED"||a.includes("CANCELLED")?H.CHARITY_CANCEL:a==="CHARITYFUNDSWITHDRAWN"||a==="FUNDSWITHDRAWN"||a==="CHARITY_WITHDRAW"||a==="CAMPAIGN_WITHDRAW"||a.includes("WITHDRAWN")?H.CHARITY_WITHDRAW:a==="CHARITYGOALREACHED"||a==="GOALREACHED"||a==="CHARITY_GOAL"||a==="CAMPAIGN_COMPLETED"?H.CHARITY_GOAL_REACHED:a==="NOTARYREGISTER"||a==="NOTARIZED"||a.includes("NOTARY")||a.includes("DOCUMENT")?H.NOTARY:a==="FAUCETCLAIM"||a.includes("FAUCET")||a.includes("DISTRIBUTED")?H.FAUCET:H.DEFAULT}let Un=null,yt=0n;function mc(e){const t=document.getElementById("dash-user-rewards");if(!t||!c.isConnected){Un&&cancelAnimationFrame(Un);return}const a=e-yt;a>-1000000000n&&a<1000000000n?yt=e:yt+=a/8n,yt<0n&&(yt=0n),t.innerHTML=`${F(yt).toFixed(4)} <span class="dash-reward-suffix">BKC</span>`,yt!==e&&(Un=requestAnimationFrame(()=>mc(e)))}async function ir(e){if(!c.isConnected||!c.userAddress)return x("Connect wallet first","error");const t=e.innerHTML;e.disabled=!0,e.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-2"></i> Sending...',$.faucet.isLoading=!0;try{const a=await fetch(`${Cp}?address=${c.userAddress}`,{method:"GET",headers:{Accept:"application/json"}}),n=await a.json();if(a.ok&&n.success)x(`Faucet Sent! ${pc} BKC + ${fc} ETH`,"success"),$.faucet.canClaim=!1,$.faucet.cooldownEnd=new Date(Date.now()+24*60*60*1e3).toISOString(),si(),setTimeout(()=>{xc.update(!0)},4e3);else{const i=n.error||n.message||"Faucet unavailable";if(i.toLowerCase().includes("cooldown")||i.toLowerCase().includes("wait")||i.toLowerCase().includes("hour")){x(`${i}`,"warning");const s=i.match(/(\d+)\s*hour/i);s&&($.faucet.canClaim=!1,$.faucet.cooldownEnd=new Date(Date.now()+parseInt(s[1])*36e5).toISOString(),si())}else x(`${i}`,"error")}}catch(a){console.error("Faucet error:",a),x("Faucet Offline - Try again later","error")}finally{$.faucet.isLoading=!1,e.disabled=!1,e.innerHTML=t}}function si(){const e=document.getElementById("dashboard-faucet-widget");if(!e)return;const t=document.getElementById("faucet-title"),a=document.getElementById("faucet-desc"),n=document.getElementById("faucet-status"),i=document.getElementById("faucet-action-btn");if(!c.isConnected){e.style.opacity="0.5",t&&(t.innerText="Get Free Testnet Tokens"),a&&(a.innerText="Connect your wallet to claim BKC + ETH for gas"),n&&n.classList.add("hidden"),i&&(i.className="dash-btn-secondary",i.innerHTML='<i class="fa-solid fa-wallet"></i> Connect Wallet',i.disabled=!0);return}e.style.opacity="1";const s=Np($.faucet.cooldownEnd);!($.faucet.canClaim&&!s)&&s?(t&&(t.innerText="Faucet Cooldown"),a&&(a.innerText="Come back when the timer ends"),n&&(n.classList.remove("hidden"),n.innerHTML=`<i class="fa-solid fa-clock" style="margin-right:4px"></i>${s} remaining`),i&&(i.className="dash-btn-secondary",i.innerHTML='<i class="fa-solid fa-hourglass-half"></i> On Cooldown',i.disabled=!0)):(t&&(t.innerText="Get Free Testnet Tokens"),a&&(a.innerText="Claim BKC tokens and ETH for gas — free every hour"),n&&n.classList.add("hidden"),i&&(i.className="dash-btn-primary dash-btn-cyan",i.innerHTML='<i class="fa-solid fa-faucet"></i> Claim Free Tokens',i.disabled=!1))}async function $p(){try{if(await c.provider.getBalance(c.userAddress)<Qa.parseEther("0.002")){const t=document.getElementById("no-gas-modal-dash");return t&&(t.classList.remove("hidden"),t.classList.add("flex")),!1}return!0}catch{return!0}}function Lp(){if(document.getElementById("dash-styles-v69"))return;const e=document.createElement("style");e.id="dash-styles-v69",e.textContent=`
        /* ── CSS Variables ── */
        .dash-shell {
            --dash-bg: #0c0c0e;
            --dash-surface: #141417;
    ...
    `,document.head.appendChild(e)}function Rp(){Be.dashboard&&(Lp(),Be.dashboard.innerHTML=`
    ...
    `}async function Mp(){try{const e=await fetch(Ap);if(e.ok){const t=await e.json();return $.economicData=t,t}}catch{}return null}async function ri(){var e,t,a,n,i,s,r;try{const o=await Mp();let l=0n,d=0n,u=0n,f=0n,p=0n,g=0,b=0n;if(o&&((e=o.token)!=null&&e.totalSupply&&(l=BigInt(o.token.totalSupply)),(t=o.token)!=null&&t.totalBurned&&(f=BigInt(o.token.totalBurned)),(a=o.staking)!=null&&a.totalPStake&&(d=BigInt(o.staking.totalPStake)),(n=o.ecosystem)!=null&&n.totalEthCollected&&(p=BigInt(o.ecosystem.totalEthCollected)),(i=o.fortunePool)!=null&&i.prizePool&&(b=BigInt(o.fortunePool.prizePool)),(s=o.notary)!=null&&s.certCount&&(g=o.notary.certCount),(r=o.stats)!=null&&r.notarizedDocuments&&(g=Math.max(g,o.stats.notarizedDocuments))),c.bkcTokenContractPublic){l===0n&&(l=await Z(c.bkcTokenContractPublic,"totalSupply",[],0n)),f===0n&&(f=await Z(c.bkcTokenContractPublic,"totalBurned",[],0n)),d===0n&&(c.stakingPoolContractPublic||c.stakingPoolContract)&&(d=await Z(c.stakingPoolContractPublic||c.stakingPoolContract,"totalPStake",[],0n));const D=[v.stakingPool,v.fortunePool,v.rentalManager,v.buybackMiner,v.liquidityPool,v.pool_diamond,v.pool_gold,v.pool_silver,v.pool_bronze].filter(J=>J&&J!==Qa.ZeroAddress),re=await Promise.all(D.map(J=>Z(c.bkcTokenContractPublic,"balanceOf",[J],0n)));if(re.forEach(J=>{u+=J}),v.fortunePool&&b===0n){const J=D.indexOf(v.fortunePool);J>=0&&(b=re[J])}}const w=F(l),T=F(f),C=F(p),P=F(b),S=D=>D.toLocaleString("en-US",{minimumFractionDigits:1,maximumFractionDigits:1}),L=F(u),B=(D,re)=>{const J=document.getElementById(D);J&&(J.innerHTML=re)};B("dash-metric-supply",`${S(w)} <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>`),B("dash-metric-pstake",Kt(d)),B("dash-metric-burned",T>0?`<span style="color:#ef4444">${Ga(T)}</span> <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>`:'<span style="color:var(--dash-text-3)">0 BKC</span>'),B("dash-metric-fees",C>0?`${Ga(C)} <span style="font-size:10px;color:var(--dash-text-3)">ETH</span>`:'<span style="color:var(--dash-text-3)">0 ETH</span>'),B("dash-metric-locked",L>0?`<span style="color:#60a5fa">${Ga(L)}</span> <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>`:'<span style="color:var(--dash-text-3)">0 BKC</span>'),gc();const I=document.getElementById("dash-fortune-prize-text");I&&(I.innerText=P>0?`Prize: ${Ga(P)} BKC`:"Play to win");const _=document.getElementById("dash-notary-count-text");_&&(_.innerText=g>0?`${g} docs certified`:"Certify documents"),$.metricsCache={supply:w,burned:T,fees:C,timestamp:Date.now()}}catch(o){console.error("Metrics Error",o)}}function gc(){const e=document.getElementById("dash-metric-balance");if(!e)return;const t=c.currentUserBalance||c.bkcBalance||0n;if(!c.isConnected){e.innerHTML='<span style="font-size:11px;color:var(--dash-text-3)">Connect Wallet</span>';return}if(t===0n)e.innerHTML='0.00 <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>';else{const a=F(t);e.innerHTML=`${a.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>`}}async function Dp(){if(c.userAddress)try{const e=await fetch(`https://getuserprofile-4wvdcuoouq-uc.a.run.app/${c.userAddress}`);e.ok&&($.userProfile=await e.json())}catch{}}async function Ht(e=!1){var t,a;if(!c.isConnected){const n=document.getElementById("dash-booster-area");n&&(n.innerHTML=`
                <div style="text-align:center">
        ...
        `;return}const p=e.source==="rented",g=(d==null?void 0:d.name)||((_=e.boostName)==null?void 0:_.replace(" Booster","").replace("Booster","").trim())||"Booster",b=(d==null?void 0:d.color)||"color:var(--dash-accent)",w=s*50n/100n,T=r-w,C=p?"fa-clock":"fa-check-circle",P=p?"#22d3ee":"#4ade80",S=p?"rgba(6,182,212,0.12)":"rgba(74,222,128,0.12)",L=p?"rgba(6,182,212,0.3)":"rgba(74,222,128,0.3)",B=p?"RENTED":"OWNED",I=p?"Active rental":"In your wallet";a.innerHTML=`
        <div class="nft-clickable-image" data-address="${v.rewardBooster}" data-tokenid="${e.tokenId}" style="width:100%;cursor:pointer;transition:all 0.2s">
            ...
            <div style="display:flex;gap:6px">
                <div style="flex:1;background:var(--dash-surface-2);border-radius:8px;padding:6px 8px;text-align:center">
                    ...
                    <div style="font-size:12px;font-weight:700;color:var(--dash-green)">${F(r).toFixed(4)} <span style="font-size:9px;color:var(--dash-text-3)">BKC</span></div>
                </div>
                ${T>0n?`
                <div style="flex:1;background:var(--dash-surface-2);border-radius:8px;padding:6px 8px;text-align:center">
    ...
    `}async function en(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("activity-title");try{if(c.isConnected){if($.activities.length===0){e&&(e.innerHTML='<div class="dash-loading"><img src="./assets/bkc_logo_3d.png" class="dash-loading-logo" alt=""><span class="dash-loading-text">Loading your activity...</span></div>');const a=await fetch(`${Ue.getHistory}/${c.userAddress}`);a.ok&&($.activities=await a.json())}if($.activities.length>0){t&&(t.textContent="Your Activity"),oi();return}}t&&(t.textContent="Network Activity"),await sr()}catch(a){console.error("Activity fetch error:",a),t&&(t.textContent="Network Activity"),await sr()}}async function sr(){const e=document.getElementById("dash-activity-list");if(!e||$.isLoadingNetworkActivity)return;const t=Date.now()-$.networkActivitiesTimestamp;if($.networkActivities.length>0&&t<3e5){rr();return}$.isLoadingNetworkActivity=!0,e.innerHTML='<div class="dash-loading"><img src="./assets/bkc_logo_3d.png" class="dash-loading-logo" alt=""><span class="dash-loading-text">Loading network activity...</span></div>';try{const a=await fetch(`${Ip}?limit=30`);if(a.ok){const n=await a.json();$.networkActivities=Array.isArray(n)?n:n.activities||[],$.networkActivitiesTimestamp=Date.now()}else $.networkActivities=[]}catch{$.networkActivities=[]}finally{$.isLoadingNetworkActivity=!1}rr()}function rr(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("dash-pagination-controls");if(!e)return;if($.networkActivities.length===0){e.innerHTML=`
            ...
            </div>`,t&&(t.style.display="none");const r=document.getElementById("activity-count");r&&(r.style.display="none");return}const a=document.getElementById("activity-count");a&&(a.style.display="inline",a.textContent=$.filteredActivities.length);const n=($.pagination.currentPage-1)*$.pagination.itemsPerPage,i=$.filteredActivities.slice(n,n+$.pagination.itemsPerPage);if(e.innerHTML=i.map(s=>bc(s,!1)).join(""),t){const s=Math.ceil($.filteredActivities.length/$.pagination.itemsPerPage);s>1?(t.style.display="flex",document.getElementById("page-indicator").innerText=`${$.pagination.currentPage}/${s}`,document.getElementById("page-prev").disabled=$.pagination.currentPage===1,document.getElementById("page-next").disabled=$.pagination.currentPage>=s):t.style.display="none"}}function bc(e,t=!1){const a=Pp(e.timestamp||e.createdAt),n=zp(e.timestamp||e.createdAt),i=e.user||e.userAddress||e.from||"",s=Bp(i),r=Sp(e.type,e.details);let o="";const l=(e.type||"").toUpperCase().trim(),d=e.details||{};if(l.includes("GAME")||l.includes("FORTUNE")||l.includes("REQUEST")||l.includes("FULFILLED")||l.includes("RESULT")){const w=d.rolls||e.rolls||[],T=d.guesses||e.guesses||[],C=d.isWin||d.prizeWon&&BigInt(d.prizeWon||0)>0n,P=d.isCumulative!==void 0?d.isCumulative:T.length>1,S=P?"Combo":"Jackpot",L=P?"background:rgba(168,85,247,0.15);color:#c084fc":"background:rgba(245,158,11,0.15);color:#fbbf24",B=d.wagerAmount||d.amount,I=d.prizeWon,_=B?F(BigInt(B)).toFixed(0):"0";let D='<span style="color:var(--dash-text-3)">No win</span>';C&&I&&BigInt(I)>0n&&(D=`<span style="color:var(--dash-green);font-weight:700">+${F(BigInt(I)).toFixed(0)} BKC</span>`);let re="";return w.length>0&&(re=`<div style="display:flex;gap:3px">${w.map((ye,ue)=>{const Y=T[ue],te=Y!==void 0&&Number(Y)===Number(ye);return`<div style="width:24px;height:24px;border-radius:4px;font-size:10px;font-weight:700;display:flex;align-items:center;justify-content:center;border:1px solid ${te?"rgba(52,211,153,0.4)":"var(--dash-border)"};background:${te?"rgba(52,211,153,0.1)":"var(--dash-surface-2)"};color:${te?"#34d399":"var(--dash-text-3)"}">${ye}</div>`}).join("")}</div>`),`
            <a href="${e.txHash?`${nr}${e.txHash}`:"#"}" target="_blank" class="dash-fortune-item" title="${n}">
    ...
    `}function Hp(){Be.dashboard&&Be.dashboard.addEventListener("click",async e=>{const t=e.target;if(t.closest("#manual-refresh-btn")){const s=t.closest("#manual-refresh-btn");s.disabled=!0,s.innerHTML='<i class="fa-solid fa-rotate fa-spin"></i>',await Ht(!0),await ri(),$.activities=[],$.networkActivities=[],$.networkActivitiesTimestamp=0,$.faucet.lastCheck=0,await en(),setTimeout(()=>{s.innerHTML='<i class="fa-solid fa-rotate"></i>',s.disabled=!1},1e3)}if(t.closest("#faucet-action-btn")){const s=t.closest("#faucet-action-btn");s.disabled||await ir(s)}if(t.closest("#emergency-faucet-btn")&&await ir(t.closest("#emergency-faucet-btn")),t.closest(".delegate-link")&&(e.preventDefault(),window.navigateTo("mine")),t.closest(".go-to-store")&&(e.preventDefault(),window.navigateTo("store")),t.closest(".go-to-rental")&&(e.preventDefault(),window.navigateTo("rental")),t.closest(".go-to-fortune")&&(e.preventDefault(),window.navigateTo("actions")),t.closest(".go-to-notary")&&(e.preventDefault(),window.navigateTo("notary")),t.closest(".go-to-charity")&&(e.preventDefault(),window.navigateTo("charity")),t.closest(".go-to-backchat")&&(e.preventDefault(),window.navigateTo("backchat")),t.closest("#open-booster-info")){const s=document.getElementById("booster-info-modal");s&&s.classList.add("visible")}if(t.closest("#close-booster-modal")||t.id==="booster-info-modal"){const s=document.getElementById("booster-info-modal");s&&s.classList.remove("visible")}if(t.closest("#close-gas-modal-dash")||t.id==="no-gas-modal-dash"){const s=document.getElementById("no-gas-modal-dash");s&&s.classList.remove("visible")}const a=t.closest(".nft-clickable-image");if(a){const s=a.dataset.address,r=a.dataset.tokenid;s&&r&&Ld(s,r)}const n=t.closest("#dashboardClaimBtn");if(n&&!n.disabled)try{if(n.innerHTML='<i class="fa-solid fa-circle-notch fa-spin"></i>',n.disabled=!0,!await $p()){n.innerHTML='<i class="fa-solid fa-coins" style="margin-right:6px"></i> Claim Rewards',n.disabled=!1;return}const{stakingRewards:r,minerRewards:o}=await Ni();(r>0n||o>0n)&&await Yt.claimRewards({button:n,onSuccess:async()=>{x("Rewards claimed!","success"),await Ht(!0),$.activities=[],en()},onError:l=>{l.cancelled||x("Claim failed","error")}})}catch{x("Claim failed","error")}finally{n.innerHTML='<i class="fa-solid fa-coins" style="margin-right:6px"></i> Claim Rewards',n.disabled=!1}if(t.closest("#page-prev")&&$.pagination.currentPage>1&&($.pagination.currentPage--,li()),t.closest("#page-next")){const s=Math.ceil($.filteredActivities.length/$.pagination.itemsPerPage);$.pagination.currentPage<s&&($.pagination.currentPage++,li())}t.closest("#activity-sort-toggle")&&($.filters.sort=$.filters.sort==="NEWEST"?"OLDEST":"NEWEST",oi());const i=t.closest(".dash-chip");i&&(document.querySelectorAll(".dash-chip").forEach(s=>s.classList.remove("active")),i.classList.add("active"),$.filters.type=i.dataset.filter,oi())})}const xc={async render(e){Rp(),ri(),en(),c.isConnected?await Ht(!1):(setTimeout(async()=>{c.isConnected&&await Ht(!1)},500),setTimeout(async()=>{c.isConnected&&await Ht(!1)},1500))},update(e){const t=Date.now();t-$.lastUpdate>1e4&&($.lastUpdate=t,ri(),e&&Ht(!1),en())}},jt=window.ethers,Up="https://sepolia.arbiscan.io/tx/",Ot={NONE:{boost:0,burnRate:50,keepRate:50,color:"#71717a",name:"None",icon:"○",class:"stk-tier-none"},BRONZE:{boost:1e3,burnRate:40,keepRate:60,color:"#cd7f32",name:"Bronze",icon:"🥉",class:"stk-tier-bronze"},SILVER:{boost:2500,burnRate:25,keepRate:75,color:"#c0c0c0",name:"Silver",icon:"🥈",class:"stk-tier-silver"},GOLD:{boost:4e3,burnRate:10,keepRate:90,color:"#ffd700",name:"Gold",icon:"🥇",class:"stk-tier-gold"},DIAMOND:{boost:5e3,burnRate:0,keepRate:100,color:"#b9f2ff",name:"Diamond",icon:"💎",class:"stk-tier-diamond"}};let Wt=!1,ka=0,cs=3650,He=!1,tn=[],qa=0n,At=null,da="ALL",st=0,ci=50,or="none",be=null,di=0n,ds=0n,us=0n;function hc(e){if(e<=0)return"Ready";const t=Math.floor(e/86400),a=Math.floor(e%86400/3600),n=Math.floor(e%3600/60);return t>365?`${Math.floor(t/365)}y ${Math.floor(t%365/30)}mo`:t>30?`${Math.floor(t/30)}mo ${t%30}d`:t>0?`${t}d ${a}h`:a>0?`${a}h ${n}m`:`${n}m`}function jp(e){if(e>=365){const t=Math.floor(e/365);return t===1?"1 Year":`${t} Years`}return e>=30?`${Math.floor(e/30)} Month(s)`:`${e} Day(s)`}function Wp(e,t){if(e<=0n||t<=0n)return 0n;const a=t/86400n;return e*a/10n**18n}function Gp(e){if(!e)return"Recent";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleDateString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return"Recent"}}function vc(e){const t=Number(e);return t>=5e3?Ot.DIAMOND:t>=4e3?Ot.GOLD:t>=2500?Ot.SILVER:t>=1e3?Ot.BRONZE:Ot.NONE}function Kp(){if(document.getElementById("stk-styles-v10"))return;const e=document.createElement("style");e.id="stk-styles-v10",e.textContent=`
        .stk-shell {
            --stk-bg: #0c0c0e;
            --stk-surface: #141417;
    ...
    `,of(),c.isConnected?aa():wc())}async function aa(e=!1){if(Wt)return;const t=Date.now();if(!(!e&&t-ka<1e4)){Wt=!0,ka=t;try{await Vp();const[,,a]=await Promise.all([gn(),Gr(),nu()]),n=c.stakingPoolContractPublic||c.stakingPoolContract;n&&(qa=await Z(n,"totalPStake",[],0n)),await qp();const{stakingRewards:i,minerRewards:s}=await Ni();ds=i||0n,us=s||0n,Xp(),Jp(),Zp(),Qp(),af(),pa()}catch(a){console.error("Staking data load error:",a)}finally{Wt=!1}}}async function Vp(){if(c.userAddress)try{const e=c.stakingPoolContractPublic||c.stakingPoolContract;if(e){const a=await Z(e,"getUserBestBoost",[c.userAddress],0n);st=Number(a)}if(st===0){const a=await Yr();a&&a.highestBoost>0&&(st=a.highestBoost,or=a.source||"api")}else or="active";ci=vc(st).burnRate}catch(e){console.error("NFT boost load error:",e)}}async function qp(){const e=c.stakingPoolContractPublic||c.stakingPoolContract;if(!(!c.userAddress||!e))try{const t=await Z(e,"previewClaim",[c.userAddress],null);t&&(be={totalRewards:t.totalRewards||t[0]||0n,burnAmount:t.burnAmount||t[1]||0n,referrerCut:t.referrerCut||t[2]||0n,userReceives:t.userReceives||t[3]||0n,burnRateBips:t.burnRateBps||t[4]||0n,nftBoost:t.nftBoost||t[5]||0n}),di=0n}catch(t){console.error("Claim preview error:",t);const a=ds+us,n=a*BigInt(ci)/100n;be={totalRewards:a,burnAmount:n,referrerCut:0n,userReceives:a-n,burnRateBips:BigInt(ci*100),nftBoost:BigInt(st)}}}function Xp(){const e=document.getElementById("stk-reward-value"),t=document.getElementById("stk-claim-btn"),a=document.getElementById("stk-breakdown"),n=document.getElementById("stk-eth-fee"),i=(be==null?void 0:be.userReceives)||0n;be!=null&&be.totalRewards;const s=(be==null?void 0:be.burnAmount)||0n,r=i>0n;if(e){const o=F(i);e.innerHTML=`${o.toFixed(4)} <span class="stk-reward-suffix">BKC</span>`}if(t){t.disabled=!r;const o=t.querySelector("span");o&&(o.textContent=r?"Claim Rewards":"No Rewards Yet")}if(a&&r){a.style.display="";const o=F(ds).toFixed(4),l=F(us).toFixed(4),d=F(s).toFixed(4);document.getElementById("stk-break-staking").textContent=`${o} BKC`,document.getElementById("stk-break-mining").textContent=`${l} BKC`,document.getElementById("stk-break-burned").textContent=s>0n?`-${d} BKC`:"None",document.getElementById("stk-break-burned").style.color=s>0n?"var(--stk-red)":"var(--stk-green)"}else a&&(a.style.display="none");if(n)if(r&&di>0n){const o=parseFloat(jt.formatEther(di)).toFixed(6);n.innerHTML=`<i class="fa-brands fa-ethereum" style="margin-right:3px"></i>Claim fee: ${o} ETH`}else n.textContent=""}function Jp(){const e=document.getElementById("stk-boost-panel");if(!e)return;const t=vc(st),a=st>0;e.innerHTML=`
    ...
    `}function Zp(){var u,f,p,g;const e=(b,w)=>{const T=document.getElementById(b);T&&(T.innerHTML=w)};e("stk-stat-network",Kt(qa));const t=((u=c.userData)==null?void 0:u.pStake)||((f=c.userData)==null?void 0:f.userTotalPStake)||c.userTotalPStake||0n,a=qa>0n?Number(t*10000n/qa)/100:0;e("stk-stat-power",`${Kt(t)} <span style="font-size:10px;color:var(--stk-text-3)">(${a.toFixed(2)}%)</span>`);const n=(be==null?void 0:be.userReceives)||0n,i=F(n);e("stk-stat-rewards",i>0?`<span style="color:var(--stk-green)">${i.toFixed(2)}</span> <span style="font-size:10px;color:var(--stk-text-3)">BKC</span>`:'<span style="color:var(--stk-text-3)">0 BKC</span>');const s=((p=c.userDelegations)==null?void 0:p.length)||0;e("stk-stat-locks",`${s}`);const r=c.currentUserBalance||0n,o=document.getElementById("stk-balance-display");o&&(o.textContent=r>0n?`${F(r).toFixed(2)} BKC`:"0.00 BKC");const l=((g=c.systemFees)==null?void 0:g.DELEGATION_FEE_BIPS)||50n,d=document.getElementById("stk-fee-info");d&&(d.textContent=`${Number(l)/100}%`)}function wc(){const e=(r,o)=>{const l=document.getElementById(r);l&&(l.innerHTML=o)};e("stk-reward-value",'-- <span class="stk-reward-suffix">BKC</span>'),e("stk-stat-network","--"),e("stk-stat-power","--"),e("stk-stat-rewards","--"),e("stk-stat-locks","--"),e("stk-balance-display","-- BKC");const t=document.getElementById("stk-claim-btn");t&&(t.disabled=!0);const a=document.getElementById("stk-breakdown");a&&(a.style.display="none");const n=document.getElementById("stk-deleg-list");n&&(n.innerHTML='<div class="stk-empty"><i class="fa-solid fa-wallet"></i><p>Connect wallet to view</p></div>');const i=document.getElementById("stk-history-list");i&&(i.innerHTML='<div class="stk-empty"><i class="fa-solid fa-wallet"></i><p>Connect wallet to view</p></div>');const s=document.getElementById("stk-boost-panel");s&&(s.innerHTML='<div class="stk-empty"><i class="fa-solid fa-wallet"></i><p>Connect wallet</p></div>')}function Qp(){const e=document.getElementById("stk-deleg-list"),t=document.getElementById("stk-deleg-count");if(!e)return;const a=c.userDelegations||[];if(t&&(t.textContent=a.length),a.length===0){e.innerHTML='<div class="stk-empty"><i class="fa-solid fa-inbox"></i><p>No active delegations</p></div>';return}At&&(clearInterval(At),At=null);const n=[...a].sort((i,s)=>Number(i.unlockTime)-Number(s.unlockTime));e.innerHTML=n.map((i,s)=>ef(i,s)).join(""),At=setInterval(tf,6e4),e.querySelectorAll(".stk-unstake-btn").forEach(i=>{i.addEventListener("click",()=>sf(parseInt(i.dataset.index),i.classList.contains("stk-unstake-force")))})}function ef(e,t){const a=F(e.amount||0n),n=e.lockDays||Number(e.lockDuration||0n)/86400,i=Number(e.unlockTime||e.lockEnd||0n),s=Math.floor(Date.now()/1e3),r=i>s,o=r?i-s:0,l=e.lockDuration||BigInt(e.lockDays||0)*86400n,d=e.pStake||Wp(e.amount||0n,l);return`
        <div class="stk-deleg-item">
            ...
            <div class="stk-deleg-info">
                ...
                <div class="stk-deleg-meta">
                    <span style="color:var(--stk-purple)">${Kt(d)} pS</span>
    ...
    `}function tf(){document.querySelectorAll(".stk-countdown").forEach(e=>{const t=parseInt(e.dataset.unlockTime),a=Math.floor(Date.now()/1e3);e.textContent=hc(t-a)})}async function af(){if(c.userAddress)try{const e=Ue.getHistory||"https://gethistory-4wvdcuoouq-uc.a.run.app",t=await fetch(`${e}/${c.userAddress}`);t.ok&&(tn=(await t.json()||[]).filter(n=>{const i=(n.type||"").toUpperCase();return i.includes("DELEGAT")||i.includes("STAKE")||i.includes("UNDELEGAT")||i.includes("CLAIM")||i.includes("REWARD")||i.includes("FORCE")}),yc())}catch(e){console.error("History load error:",e)}}function yc(){const e=document.getElementById("stk-history-list");if(!e)return;let t=tn;if(da!=="ALL"&&(t=tn.filter(a=>{const n=(a.type||"").toUpperCase();switch(da){case"STAKE":return(n.includes("DELEGAT")||n.includes("STAKE"))&&!n.includes("UNSTAKE")&&!n.includes("UNDELEGAT")&&!n.includes("FORCE");case"UNSTAKE":return n.includes("UNSTAKE")||n.includes("UNDELEGAT")||n.includes("FORCE");case"CLAIM":return n.includes("CLAIM")||n.includes("REWARD");default:return!0}})),t.length===0){e.innerHTML=`<div class="stk-empty"><i class="fa-solid fa-inbox"></i><p>No ${da==="ALL"?"":da.toLowerCase()+" "}history yet</p></div>`;return}e.innerHTML=t.slice(0,25).map(a=>{const n=(a.type||"").toUpperCase(),i=a.details||{},s=Gp(a.timestamp||a.createdAt);let r,o,l,d,u="";n.includes("FORCE")?(r="fa-bolt",o="rgba(239,68,68,0.12)",l="#ef4444",d="Force Unstaked",i.feePaid&&BigInt(i.feePaid)>0n&&(u=`<span style="color:#ef4444">-${F(BigInt(i.feePaid)).toFixed(2)}</span>`)):(n.includes("DELEGAT")||n.includes("STAKE"))&&!n.includes("UNSTAKE")?(r="fa-lock",o="rgba(74,222,128,0.12)",l="#4ade80",d="Delegated",i.pStakeGenerated&&(u=`<span style="color:var(--stk-purple)">+${F(BigInt(i.pStakeGenerated)).toFixed(0)} pS</span>`)):n.includes("UNSTAKE")||n.includes("UNDELEGAT")?(r="fa-unlock",o="rgba(249,115,22,0.12)",l="#f97316",d="Unstaked"):n.includes("CLAIM")||n.includes("REWARD")?(r="fa-coins",o="rgba(251,191,36,0.12)",l="#fbbf24",d="Claimed",i.amountReceived&&BigInt(i.amountReceived)>0n&&(u=`<span style="color:var(--stk-green)">+${F(BigInt(i.amountReceived)).toFixed(2)}</span>`),i.burnedAmount&&BigInt(i.burnedAmount)>0n&&(u+=` <span style="font-size:9px;color:rgba(239,68,68,0.6)">🔥-${F(BigInt(i.burnedAmount)).toFixed(2)}</span>`)):(r="fa-circle",o="rgba(113,113,122,0.12)",l="#71717a",d=a.type||"Activity");const f=a.txHash?`${Up}${a.txHash}`:"#",p=a.amount||i.amount||i.amountReceived||"0";let g=0;try{g=F(BigInt(p))}catch{}const b=g>.001?g.toFixed(2):"";return`
        ...
        `}).join("")}function pa(){var n;const e=document.getElementById("stk-amount-input"),t=document.getElementById("stk-delegate-btn");if(!e)return;const a=e.value;if(!a||parseFloat(a)<=0){const i=document.getElementById("stk-preview-pstake");i&&(i.textContent="0");const s=document.getElementById("stk-preview-net");s&&(s.textContent="0.00 BKC"),t&&(t.disabled=!0);return}try{const i=jt.parseUnits(a,18),s=((n=c.systemFees)==null?void 0:n.DELEGATION_FEE_BIPS)||50n,r=i*BigInt(s)/10000n,o=i-r,l=BigInt(cs),d=o*l/10n**18n,u=document.getElementById("stk-preview-pstake");u&&(u.textContent=Kt(d));const f=document.getElementById("stk-preview-net");f&&(f.textContent=`${F(o).toFixed(4)} BKC`);const p=c.currentUserBalance||0n;i>p?(e.classList.add("error"),t&&(t.disabled=!0)):(e.classList.remove("error"),t&&(t.disabled=He))}catch{t&&(t.disabled=!0)}}async function nf(){if(He)return;const e=document.getElementById("stk-amount-input"),t=document.getElementById("stk-delegate-btn");if(!e||!t)return;const a=e.value;if(!a||parseFloat(a)<=0)return x("Enter an amount","warning");const n=c.currentUserBalance||0n;let i;try{if(i=jt.parseUnits(a,18),i>n)return x("Insufficient BKC balance","error")}catch{return x("Invalid amount","error")}try{if(await new jt.BrowserProvider(window.ethereum).getBalance(c.userAddress)<jt.parseEther("0.001"))return x("Insufficient ETH for gas","error")}catch{}He=!0;try{await Yt.delegate({amount:i,lockDays:cs,button:t,onSuccess:async()=>{e.value="",x("Delegation successful!","success"),Wt=!1,ka=0,await aa(!0)},onError:s=>{s.cancelled||x("Delegation failed: "+(s.reason||s.message||"Unknown error"),"error")}})}catch(s){x("Delegation failed: "+(s.reason||s.message||"Unknown error"),"error")}finally{He=!1,pa()}}async function sf(e,t){if(He||t&&!confirm("Force unstake will incur a 50% penalty. Continue?"))return;const a=document.querySelector(`.stk-unstake-btn[data-index='${e}']`);He=!0;try{await(t?Yt.forceUnstake:Yt.unstake)({delegationIndex:BigInt(e),button:a,onSuccess:async()=>{x(t?"Force unstaked (50% penalty)":"Unstaked successfully!",t?"warning":"success"),Wt=!1,ka=0,await aa(!0)},onError:i=>{i.cancelled||x("Unstake failed: "+(i.reason||i.message||"Unknown error"),"error")}})}catch(n){x("Unstake failed: "+(n.reason||n.message||"Unknown error"),"error")}finally{He=!1}}async function rf(){if(He)return;const e=document.getElementById("stk-claim-btn");He=!0;try{await Yt.claimRewards({button:e,onSuccess:async()=>{x("Rewards claimed!","success"),Wt=!1,ka=0,tn=[],await aa(!0)},onError:t=>{t.cancelled||x("Claim failed: "+(t.reason||t.message||"Unknown error"),"error")}})}catch(t){x("Claim failed: "+(t.reason||t.message||"Unknown error"),"error")}finally{He=!1}}function of(){var o;const e=document.getElementById("mine");if(!e)return;const t=document.getElementById("stk-amount-input"),a=document.getElementById("stk-max-btn"),n=document.getElementById("stk-delegate-btn"),i=document.getElementById("stk-refresh-btn"),s=document.querySelectorAll(".stk-duration-chip"),r=document.querySelectorAll(".stk-tab");t==null||t.addEventListener("input",pa),a==null||a.addEventListener("click",()=>{const l=c.currentUserBalance||0n;t&&(t.value=jt.formatUnits(l,18),pa())}),s.forEach(l=>{l.addEventListener("click",()=>{s.forEach(d=>d.classList.remove("selected")),l.classList.add("selected"),cs=parseInt(l.dataset.days),pa()})}),r.forEach(l=>{l.addEventListener("click",()=>{r.forEach(d=>d.classList.remove("active")),l.classList.add("active"),da=l.dataset.filter,yc()})}),n==null||n.addEventListener("click",nf),i==null||i.addEventListener("click",()=>{const l=i.querySelector("i");l==null||l.classList.add("fa-spin"),aa(!0).then(()=>{setTimeout(()=>l==null?void 0:l.classList.remove("fa-spin"),500)})}),(o=document.getElementById("stk-claim-btn"))==null||o.addEventListener("click",rf),e.addEventListener("click",l=>{l.target.closest(".go-to-store")&&(l.preventDefault(),window.navigateTo("store")),l.target.closest(".go-to-rental")&&(l.preventDefault(),window.navigateTo("rental"))})}function lf(){At&&(clearInterval(At),At=null)}function cf(e){e?aa():wc()}const ui={render:Yp,update:cf,cleanup:lf},Ae=window.ethers,df="https://sepolia.arbiscan.io/tx/",uf=3e4,pi={Diamond:{color:"#22d3ee",gradient:"from-cyan-500/20 to-blue-500/20",border:"border-cyan-500/40",text:"text-cyan-400",glow:"shadow-cyan-500/30",icon:"💎",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeicgip72jcqgsirlrhn3tq5cc226vmko6etnndzl6nlhqrktfikafq",keepRate:100,burnRate:0},Gold:{color:"#fbbf24",gradient:"from-yellow-500/20 to-amber-500/20",border:"border-yellow-500/40",text:"text-yellow-400",glow:"shadow-yellow-500/30",icon:"🥇",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeifponccrbicg2pcjrn2hrfoqgc77xhm2r4ld7hdpw6cxxkbsckf44",keepRate:90,burnRate:10},Silver:{color:"#9ca3af",gradient:"from-gray-400/20 to-slate-400/20",border:"border-gray-400/40",text:"text-gray-300",glow:"shadow-gray-400/30",icon:"🥈",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeihvi2inujm5zpi7tl667g4srq273536pjkglwyrtbwmgnskmu7jg4",keepRate:75,burnRate:25},Bronze:{color:"#f97316",gradient:"from-orange-600/20 to-amber-700/20",border:"border-orange-600/40",text:"text-orange-400",glow:"shadow-orange-500/30",icon:"🥉",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeiclqidb67rt3tchhjpsib62s624li7j2bpxnr6b5w5mfp4tomhu7m",keepRate:60,burnRate:40}};function Cn(e){return pi[e]||pi.Bronze}const N={tradeDirection:"buy",selectedPoolBoostBips:null,buyPrice:0n,sellPrice:0n,netSellPrice:0n,poolNFTCount:0,userBalanceOfSelectedNFT:0,availableToSellCount:0,firstAvailableTokenId:null,firstAvailableTokenIdForBuy:null,bestBoosterTokenId:0n,bestBoosterBips:0,isDataLoading:!1,tradeHistory:[]},an=new Map,ps=new Map;let Ka=!1,Tt=null;const pf=["function getPoolAddress(uint256 boostBips) view returns (address)","function isPool(address) view returns (bool)"];function ff(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function mf(e){const t=ps.get(e);return t&&Date.now()-t.timestamp<uf?t.data:null}function kc(e,t){ps.set(e,{data:t,timestamp:Date.now()})}function jn(e){ps.delete(e)}function gf(){if(document.getElementById("swap-styles-v9"))return;const e=document.createElement("style");e.id="swap-styles-v9",e.textContent=`
    ...
    `}const xf={async render(e){gf(),await Wr();const t=document.getElementById("store");t&&((t.innerHTML.trim()===""||e)&&(t.innerHTML=`
            ...
            `,kf()),N.selectedPoolBoostBips===null&&me.length>0&&(N.selectedPoolBoostBips=me[0].boostBips),await it(),await ua())},async update(){N.selectedPoolBoostBips!==null&&!N.isDataLoading&&document.getElementById("store")&&!document.hidden&&await it()}};async function ua(){const e=document.getElementById("history-list");if(!c.userAddress){e&&(e.innerHTML='<div class="text-center py-4 text-xs text-zinc-600">Connect wallet to view history</div>');return}try{const t=Ue.getHistory||"https://gethistory-4wvdcuoouq-uc.a.run.app",a=await fetch(`${t}/${c.userAddress}`);if(!a.ok)throw new Error(`HTTP ${a.status}`);const n=await a.json();console.log("All history types:",[...new Set((n||[]).map(s=>s.type))]),N.tradeHistory=(n||[]).filter(s=>{const r=(s.type||"").toUpperCase();return r==="NFTBOUGHT"||r==="NFTSOLD"||r==="NFT_BOUGHT"||r==="NFT_SOLD"||r==="NFTPURCHASED"||r==="NFT_PURCHASED"||r.includes("NFTBOUGHT")||r.includes("NFTSOLD")||r.includes("NFTPURCHASED")}),console.log("NFT trade history:",N.tradeHistory.length,"items");const i=document.getElementById("history-count");i&&(i.textContent=N.tradeHistory.length),lr()}catch(t){console.error("History load error:",t),N.tradeHistory=[],lr()}}function lr(){const e=document.getElementById("history-list");if(e){if(!c.isConnected){e.innerHTML='<div class="text-center py-4 text-xs text-zinc-600">Connect wallet to view history</div>';return}if(N.tradeHistory.length===0){e.innerHTML=`
        ...
        `}).join("")}}function hf(){return me.map((e,t)=>{const a=Cn(e.name),n=t===0,i=pt(e.boostBips),s=a.icon||e.emoji||"💎";return`
    ...
    `}function vf(e,t,a,n,i=!1){return c.isConnected?e?t?`
        ...
        `}function wf(e){const t=document.getElementById("trade-mascot");t&&(t.className=`w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden ${e?"trade-buy":"trade-sell"}`)}function dr(){const e=document.getElementById("inventory-grid"),t=document.getElementById("nft-count");if(!e)return;const a=c.myBoosters||[];if(t&&(t.textContent=a.length),!c.isConnected){e.innerHTML='<div class="col-span-4 text-center py-4 text-xs text-zinc-600">Connect wallet</div>';return}if(a.length===0){e.innerHTML=`
        ...
        `;return}const n=c.rentalListings||[],i=new Set(n.map(r=>{var o;return(o=r.tokenId)==null?void 0:o.toString()})),s=Math.floor(Date.now()/1e3);e.innerHTML=a.map(r=>{var P;const o=me.find(S=>S.boostBips===Number(r.boostBips)),l=Cn(o==null?void 0:o.name),d=pt(Number(r.boostBips)),u=l.icon||(o==null?void 0:o.emoji)||"💎",f=N.firstAvailableTokenId&&BigInt(r.tokenId)===N.firstAvailableTokenId,p=(P=r.tokenId)==null?void 0:P.toString(),g=i.has(p),b=n.find(S=>{var L;return((L=S.tokenId)==null?void 0:L.toString())===p}),w=b&&b.rentalEndTime&&Number(b.rentalEndTime)>s,T=g||w;let C="";return w?C='<span class="absolute top-1 right-1 bg-blue-500 text-white text-[7px] px-1.5 py-0.5 rounded-full font-bold">🔑</span>':g&&(C='<span class="absolute top-1 right-1 bg-green-500 text-white text-[7px] px-1.5 py-0.5 rounded-full font-bold">📋</span>'),`
            <div class="inventory-item ${T?"opacity-50 cursor-not-allowed":"cursor-pointer"} rounded-xl p-2 border ${f&&!T?"border-amber-500 ring-2 ring-amber-500/50 bg-amber-500/10":"border-zinc-700/50 bg-zinc-800/30"} hover:bg-zinc-800/50 transition-all relative"
                ...
                <p class="text-[7px] text-center ${f&&!T?"text-amber-400 font-bold":"text-zinc-600"}">#${r.tokenId}</p>
            </div>
        `}).join("")}async function it(e=!1){var n,i;if(N.selectedPoolBoostBips===null)return;const t=N.selectedPoolBoostBips,a=Date.now();if(Tt=a,!e){const s=mf(t);if(s){fi(s),nn(),dr(),yf(t,a);return}}N.isDataLoading=!0;try{const s=c.myBoosters||[],r=c.rentalListings||[],o=new Set(r.map(Y=>{var te;return(te=Y.tokenId)==null?void 0:te.toString()})),l=Math.floor(Date.now()/1e3),d=s.filter(Y=>Number(Y.boostBips)===t),u=d.filter(Y=>{var Me;const te=(Me=Y.tokenId)==null?void 0:Me.toString(),Ne=r.find(q=>{var ra;return((ra=q.tokenId)==null?void 0:ra.toString())===te}),ht=o.has(te),et=Ne&&Ne.rentalEndTime&&Number(Ne.rentalEndTime)>l;return!ht&&!et}),f=me.find(Y=>Y.boostBips===t);if(!f){console.warn("Tier not found for boostBips:",t);return}const p=`pool_${f.name.toLowerCase()}`;let g=v[p]||an.get(t);if(!g){const Y=v.nftPoolFactory||v.nftLiquidityPoolFactory;if(Y&&c.publicProvider)try{g=await new Ae.Contract(Y,pf,c.publicProvider).getPoolAddress(t),g&&g!==Ae.ZeroAddress&&an.set(t,g)}catch(te){console.warn("Factory lookup failed:",te.message)}}if(Tt!==a)return;if(!g||g===Ae.ZeroAddress){const Y=document.getElementById("swap-interface");Y&&(Y.innerHTML=`
                ...
                `);return}const b=new Ae.Contract(g,Or,c.publicProvider),[w,T,C]=await Promise.all([Z(b,"getBuyPrice",[],Ae.MaxUint256).catch(()=>Ae.MaxUint256),Z(b,"getSellPrice",[],0n).catch(()=>0n),b.getAvailableNFTs().catch(()=>[])]);if(Tt!==a)return;const P=Array.isArray(C)?[...C]:[],S=w===Ae.MaxUint256?0n:w,L=T;let B=((n=c.systemFees)==null?void 0:n.NFT_POOL_SELL_TAX_BIPS)||1000n,I=BigInt(((i=c.boosterDiscounts)==null?void 0:i[N.bestBoosterBips])||0);const _=typeof B=="bigint"?B:BigInt(B),D=typeof I=="bigint"?I:BigInt(I),re=_>D?_-D:0n,J=L*re/10000n,ye=L-J,ue={buyPrice:S,sellPrice:L,netSellPrice:ye,poolNFTCount:P.length,firstAvailableTokenIdForBuy:P.length>0?BigInt(P[P.length-1]):null,userBalanceOfSelectedNFT:d.length,availableToSellCount:u.length,availableNFTsOfTier:u};kc(t,ue),fi(ue,t)}catch(s){if(console.warn("Store Data Warning:",s.message),Tt===a){const r=document.getElementById("swap-interface");r&&(r.innerHTML=`
                    <div class="text-center py-12">
                        <div class="w-12 h-12 bg-zinc-800 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                `)}return}finally{Tt===a&&(N.isDataLoading=!1,nn(),dr())}}async function yf(e,t){var a,n;try{const i=c.myBoosters||[],s=c.rentalListings||[],r=new Set(s.map(ue=>{var Y;return(Y=ue.tokenId)==null?void 0:Y.toString()})),o=Math.floor(Date.now()/1e3),l=i.filter(ue=>Number(ue.boostBips)===e),d=l.filter(ue=>{var et;const Y=(et=ue.tokenId)==null?void 0:et.toString(),te=s.find(Me=>{var q;return((q=Me.tokenId)==null?void 0:q.toString())===Y}),Ne=r.has(Y),ht=te&&te.rentalEndTime&&Number(te.rentalEndTime)>o;return!Ne&&!ht}),u=me.find(ue=>ue.boostBips===e);if(!u)return;const f=`pool_${u.name.toLowerCase()}`;let p=v[f]||an.get(e);if(!p||p===Ae.ZeroAddress)return;const g=new Ae.Contract(p,Or,c.publicProvider),[b,w,T]=await Promise.all([Z(g,"getBuyPrice",[],Ae.MaxUint256).catch(()=>Ae.MaxUint256),Z(g,"getSellPrice",[],0n).catch(()=>0n),g.getAvailableNFTs().catch(()=>[])]);if(Tt!==t)return;const C=Array.isArray(T)?[...T]:[],P=b===Ae.MaxUint256?0n:b,S=w;let L=((a=c.systemFees)==null?void 0:a.NFT_POOL_SELL_TAX_BIPS)||1000n,B=BigInt(((n=c.boosterDiscounts)==null?void 0:n[N.bestBoosterBips])||0);const I=typeof L=="bigint"?L:BigInt(L),_=typeof B=="bigint"?B:BigInt(B),D=I>_?I-_:0n,re=S*D/10000n,J=S-re,ye={buyPrice:P,sellPrice:S,netSellPrice:J,poolNFTCount:C.length,firstAvailableTokenIdForBuy:C.length>0?BigInt(C[C.length-1]):null,userBalanceOfSelectedNFT:l.length,availableToSellCount:d.length,availableNFTsOfTier:d};kc(e,ye),N.selectedPoolBoostBips===e&&Tt===t&&(fi(ye,e),nn())}catch(i){console.warn("Background refresh failed:",i.message)}}function fi(e,t){var i,s,r;N.buyPrice=e.buyPrice,N.sellPrice=e.sellPrice,N.netSellPrice=e.netSellPrice,N.poolNFTCount=e.poolNFTCount,N.firstAvailableTokenIdForBuy=e.firstAvailableTokenIdForBuy,N.userBalanceOfSelectedNFT=e.userBalanceOfSelectedNFT,N.availableToSellCount=e.availableToSellCount;const a=N.firstAvailableTokenId;!(a&&((i=e.availableNFTsOfTier)==null?void 0:i.some(o=>BigInt(o.tokenId)===a)))&&((s=e.availableNFTsOfTier)==null?void 0:s.length)>0?N.firstAvailableTokenId=BigInt(e.availableNFTsOfTier[0].tokenId):(r=e.availableNFTsOfTier)!=null&&r.length||(N.firstAvailableTokenId=null)}function kf(){const e=document.getElementById("store");e&&e.addEventListener("click",async t=>{if(t.target.closest("#refresh-btn")){const r=t.target.closest("#refresh-btn").querySelector("i");r.classList.add("fa-spin"),jn(N.selectedPoolBoostBips),await Promise.all([Ct(!0),Kr()]),await it(!0),ua(),r.classList.remove("fa-spin");return}const a=t.target.closest(".tier-chip");if(a){const s=Number(a.dataset.boost);N.selectedPoolBoostBips!==s&&(N.selectedPoolBoostBips=s,N.firstAvailableTokenId=null,cr(s),await it());return}if(t.target.closest("#swap-direction-btn")){N.tradeDirection=N.tradeDirection==="buy"?"sell":"buy",nn();return}if(t.target.closest("#inventory-toggle")){const s=document.getElementById("inventory-panel"),r=document.getElementById("inventory-chevron");s&&r&&(s.classList.toggle("hidden"),r.style.transform=s.classList.contains("hidden")?"":"rotate(180deg)");return}if(t.target.closest("#history-toggle")){const s=document.getElementById("history-panel"),r=document.getElementById("history-chevron");s&&r&&(s.classList.toggle("hidden"),r.style.transform=s.classList.contains("hidden")?"":"rotate(180deg)");return}const n=t.target.closest(".inventory-item");if(n){if(n.dataset.unavailable==="true"){x("This NFT is listed for rental and cannot be sold","warning");return}const r=Number(n.dataset.boost),o=n.dataset.tokenid;N.selectedPoolBoostBips=r,N.tradeDirection="sell",o&&(N.firstAvailableTokenId=BigInt(o),console.log("User selected NFT #"+o+" for sale")),cr(r),await it();return}const i=t.target.closest("#execute-btn");if(i){if(t.preventDefault(),t.stopPropagation(),Ka||i.disabled)return;const s=i.dataset.action,r=document.getElementById("trade-mascot");if(s==="connect"){window.openConnectModal();return}const o=me.find(u=>u.boostBips===N.selectedPoolBoostBips);if(!o)return;const l=`pool_${o.name.toLowerCase()}`,d=v[l]||an.get(o.boostBips);if(!d){x("Pool address not found","error");return}Ka=!0,r&&(r.className="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden trade-spin");try{if(N.tradeDirection==="buy")await ii.buyFromPool({poolAddress:d,button:i,onSuccess:async u=>{r&&(r.className="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden trade-success"),x("🟢 NFT Purchased!","success"),jn(N.selectedPoolBoostBips),await Promise.all([Ct(!0),it(!0)]),ua()},onError:u=>{if(!u.cancelled&&u.type!=="user_rejected"){const f=u.message||u.reason||"Transaction failed";x("Buy failed: "+f,"error")}}});else{if(!N.firstAvailableTokenId){x("No NFT selected for sale","error"),Ka=!1;return}await ii.sellToPool({poolAddress:d,tokenId:N.firstAvailableTokenId,button:i,onSuccess:async u=>{r&&(r.className="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden trade-success"),x("🔴 NFT Sold!","success"),jn(N.selectedPoolBoostBips),await Promise.all([Ct(!0),it(!0)]),ua()},onError:u=>{if(!u.cancelled&&u.type!=="user_rejected"){const f=u.message||u.reason||"Transaction failed";x("Sell failed: "+f,"error")}}})}}finally{Ka=!1,setTimeout(async()=>{try{await Promise.all([Ct(!0),it(!0)]),ua()}catch(u){console.warn("[Store] Post-transaction refresh failed:",u.message)}},2e3),r&&setTimeout(()=>{const u=N.tradeDirection==="buy";r.className=`w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden ${u?"trade-buy":"trade-sell"}`},800)}}})}const fs="https://sepolia.arbiscan.io/tx/",mi="https://sepolia.arbiscan.io/address/",Ec="0x16346f5a45f9615f1c894414989f0891c54ef07b",Ef=(v==null?void 0:v.fortunePool)||"0x277dB00d533Bbc0fc267bbD954640aDA38ee6B37",sn="./assets/fortune.png",gi=1e3,ur={pt:{title:"Compartilhe & Ganhe!",subtitle:"+1000 pontos para o Airdrop",later:"Talvez depois"},en:{title:"Share & Earn!",subtitle:"+1000 points for Airdrop",later:"Maybe later"},es:{title:"¡Comparte y Gana!",subtitle:"+1000 puntos para el Airdrop",later:"Quizás después"}},Tf={pt:{win:e=>`🎉 Ganhei ${e.toLocaleString()} BKC no Fortune Pool!
...
#Backcoin #Web3 #Arbitrum`}},Wn={pt:"./assets/pt.png",en:"./assets/en.png",es:"./assets/es.png"};let Ge="en";const pe=[{id:1,name:"Easy",emoji:"🍀",range:5,multiplier:2,chance:"20%",color:"emerald",hex:"#10b981",bgFrom:"from-emerald-500/20",bgTo:"to-green-600/10",borderColor:"border-emerald-500/50",textColor:"text-emerald-400"},{id:2,name:"Medium",emoji:"⚡",range:15,multiplier:10,chance:"6.7%",color:"violet",hex:"#8b5cf6",bgFrom:"from-violet-500/20",bgTo:"to-purple-600/10",borderColor:"border-violet-500/50",textColor:"text-violet-400"},{id:3,name:"Hard",emoji:"👑",range:150,multiplier:100,chance:"0.67%",color:"amber",hex:"#f59e0b",bgFrom:"from-amber-500/20",bgTo:"to-orange-600/10",borderColor:"border-amber-500/50",textColor:"text-amber-400"}],Tc=57,y={mode:null,phase:"select",guess:50,guesses:[2,5,50],comboStep:0,wager:10,gameId:null,result:null,txHash:null,poolStatus:null,history:[],serviceFee:0n,serviceFee1x:0n,serviceFee5x:0n,tiersData:null,commitment:{hash:null,userSecret:null,commitBlock:null,commitTxHash:null,revealDelay:2,waitStartTime:null,canReveal:!1}};let Se=null;const Cf=3e3,Cc=250;function If(){if(document.getElementById("fortune-styles-v2"))return;const e=document.createElement("style");e.id="fortune-styles-v2",e.textContent=`
        ...
        <div class="max-w-md mx-auto px-4 py-6">
            ...
            <div class="text-center mb-6">
                ...
                <div class="flex items-center justify-center gap-2 mt-3 flex-wrap">
                    <a href="${mi}${Ec}" target="_blank" rel="noopener" 
    ...
    `,gs(),ce()}function Pf(){Se&&(clearInterval(Se),Se=null),y.phase="select",y.result=null,y.commitment={hash:null,userSecret:null,commitBlock:null,commitTxHash:null,revealDelay:y.commitment.revealDelay||2,waitStartTime:null,canReveal:!1}}function ce(){const e=document.getElementById("game-area");if(e)switch(zf(y.phase),y.phase){case"select":pr(e);break;case"pick":Bf(e);break;case"wager":$f(e);break;case"processing":Rf(e);break;case"waiting":_f(e);break;case"result":Hf(e);break;default:pr(e)}}function zf(e){var a;const t=document.getElementById("tiger-mascot");if(t)switch(t.className="w-28 h-28 object-contain mx-auto",t.style.filter="",e){case"select":t.classList.add("tiger-float","tiger-pulse");break;case"pick":case"wager":t.classList.add("tiger-float");break;case"processing":t.classList.add("tiger-spin");break;case"waiting":t.classList.add("tiger-float"),t.style.filter="hue-rotate(270deg)";break;case"result":((a=y.result)==null?void 0:a.prizeWon)>0?t.classList.add("tiger-celebrate"):(t.style.filter="grayscale(0.5)",t.classList.add("tiger-float"));break}}function pr(e){var i,s;const t=y.serviceFee1x>0n?(Number(y.serviceFee1x)/1e18).toFixed(6):"0",a=y.serviceFee5x>0n?(Number(y.serviceFee5x)/1e18).toFixed(6):"0",n=y.serviceFee1x>0n||y.serviceFee5x>0n;e.innerHTML=`
        <div class="space-y-4">
            <!-- JACKPOT MODE -->
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center gap-3 mb-1">
                            ...
                            <span class="px-2.5 py-1 rounded-full bg-violet-500/20 border border-violet-500/40 text-violet-400 text-sm font-black">${Tc}x</span>
                        </div>
    ...
    `;const n=document.getElementById("number-input"),i=document.getElementById("number-slider"),s=pe[2],r=b=>{b=Math.max(1,Math.min(100,b)),y.guess=b,n&&(n.value=b),i&&(i.value=b,i.style.background=`linear-gradient(to right, ${s.hex} 0%, ${s.hex} ${b}%, #27272a ${b}%, #27272a 100%)`)};n==null||n.addEventListener("input",b=>r(parseInt(b.target.value)||1)),n==null||n.addEventListener("blur",b=>r(parseInt(b.target.value)||1)),i==null||i.addEventListener("input",b=>r(parseInt(b.target.value))),(o=document.getElementById("btn-minus"))==null||o.addEventListener("click",()=>r(y.guess-1)),(l=document.getElementById("btn-plus"))==null||l.addEventListener("click",()=>r(y.guess+1)),(d=document.getElementById("btn-minus-10"))==null||d.addEventListener("click",()=>r(y.guess-10)),(u=document.getElementById("btn-plus-10"))==null||u.addEventListener("click",()=>r(y.guess+10)),document.querySelectorAll(".quick-pick").forEach(b=>{b.addEventListener("click",()=>r(parseInt(b.dataset.number)))}),(f=document.getElementById("btn-random"))==null||f.addEventListener("click",()=>{r(Math.floor(Math.random()*100)+1)}),(p=document.getElementById("btn-back"))==null||p.addEventListener("click",()=>{y.phase="select",ce()}),(g=document.getElementById("btn-next"))==null||g.addEventListener("click",()=>{y.phase="wager",ce()})}function Sf(e){var s,r,o,l,d,u,f;const t=pe[y.comboStep],a=y.guesses[y.comboStep],n=t.range===100;if(e.innerHTML=`
        <div class="bg-gradient-to-br from-zinc-900 to-zinc-800/50 border border-zinc-700/50 rounded-2xl p-5">
            <!-- Progress Pills -->
    ...
    `,n.forEach((i,s)=>{const r=document.getElementById(`spin-${s}`);if(!r)return;setInterval(()=>{r.textContent=Math.floor(Math.random()*i.range)+1},80)})}function _f(e){var l;const t=y.mode==="jackpot",a=t?[y.guess]:y.guesses,n=t?[pe[2]]:pe,i=Date.now()-(y.commitment.waitStartTime||Date.now()),s=y.commitment.revealDelay*Cc,r=Math.max(0,s-i),o=Math.ceil(r/1e3);e.innerHTML=`
        <div class="bg-gradient-to-br from-violet-900/30 to-purple-900/20 border border-violet-500/30 rounded-2xl p-6 waiting-glow">
            ...
            ${y.commitment.commitTxHash?`
                <div class="text-center mt-3">
                    <a href="${fs}${y.commitment.commitTxHash}" target="_blank" 
    ...
    `,(l=document.getElementById("btn-reveal"))==null||l.addEventListener("click",()=>{y.commitment.canReveal&&bi()}),ms()}function ms(){if(y.phase!=="waiting")return;const e=document.getElementById("countdown-timer"),t=document.getElementById("progress-bar");if(document.getElementById("btn-reveal"),document.getElementById("reveal-btn-text"),!e)return;const a=Date.now()-(y.commitment.waitStartTime||Date.now()),n=y.commitment.revealDelay*Cc,i=Math.max(0,n-a),s=Math.ceil(i/1e3);if(s>0?e.textContent=`~${s}s`:y.commitment.canReveal?e.textContent="Ready!":e.textContent="Verifying on chain...",t){const r=Math.min(100,a/n*100);t.style.width=`${r}%`}y.phase==="waiting"&&setTimeout(ms,1e3)}function Ff(){Se&&clearInterval(Se),setTimeout(ms,100),Se=setInterval(async()=>{if(y.phase!=="waiting"){clearInterval(Se);return}try{await Of()&&!y.commitment.canReveal&&(y.commitment.canReveal=!0,clearInterval(Se),Se=null,console.log("[FortunePool] canReveal=true, starting auto-reveal..."),Mf())}catch(e){console.warn("Reveal check error:",e)}},Cf)}async function Mf(){if(y.phase!=="waiting")return;const e=document.getElementById("countdown-timer"),t=document.getElementById("btn-reveal"),a=document.getElementById("reveal-btn-text");e&&(e.textContent="Revealing..."),t&&(t.disabled=!0,t.classList.remove("bg-zinc-800","text-zinc-500","cursor-not-allowed"),t.classList.add("bg-gradient-to-r","from-amber-500","to-yellow-500","text-white")),a&&(a.textContent="Auto-revealing...");const n=y.mode==="jackpot"?[y.guess]:y.guesses,i=5,s=2e3;await new Promise(r=>setTimeout(r,3e3));for(let r=1;r<=i;r++){if(y.phase!=="waiting")return;try{const o=c.fortunePoolContractPublic;o&&await o.revealPlay.staticCall(y.gameId,n,y.commitment.userSecret,{from:c.userAddress}),console.log(`[FortunePool] Pre-simulation passed (attempt ${r})`),bi();return}catch(o){const l=o.message||"",d=l.includes("0x92555c0e")||l.includes("BlockhashUnavailable");if(d&&r<i)console.log(`[FortunePool] BlockhashUnavailable, retry in ${s}ms (${r}/${i})`),e&&(e.textContent="Syncing block data..."),await new Promise(u=>setTimeout(u,s));else if(d){console.warn("[FortunePool] Pre-sim retries exhausted, enabling manual button"),Df();return}else{console.log("[FortunePool] Pre-sim error (non-blockhash), trying direct reveal:",l),bi();return}}}}function Df(){const e=document.getElementById("btn-reveal"),t=document.getElementById("reveal-btn-text"),a=document.getElementById("countdown-timer");a&&(a.textContent="Ready!"),e&&(e.disabled=!1,e.classList.remove("bg-zinc-800","text-zinc-500","cursor-not-allowed","from-amber-500","to-yellow-500"),e.classList.add("bg-gradient-to-r","from-emerald-500","to-green-500","text-white")),t&&(t.textContent="Reveal & Get Result!")}async function Of(){if(!c.fortunePoolContractPublic||!y.gameId)return!1;try{const e=await c.fortunePoolContractPublic.getCommitmentStatus(y.gameId);if(!y.commitment.commitBlock)try{const t=await c.fortunePoolContractPublic.getCommitment(y.gameId),a=Number(t.commitBlock);a>0&&(y.commitment.commitBlock=a)}catch{}return e.canReveal===!0}catch{return Date.now()-(y.commitment.waitStartTime||Date.now())>=3e4}}async function bi(){if(!y.commitment.canReveal){x("Not ready to reveal yet!","warning");return}const e=document.getElementById("btn-reveal");try{const t=y.mode==="jackpot"?[y.guess]:y.guesses;await Qi.revealPlay({gameId:y.gameId,guesses:t,userSecret:y.commitment.userSecret,button:e,onSuccess:(a,n)=>{Se&&clearInterval(Se),y.txHash=a.hash,y.result={rolls:(n==null?void 0:n.rolls)||[],prizeWon:(n==null?void 0:n.prizeWon)||0n,matches:(n==null?void 0:n.matches)||[],matchCount:(n==null?void 0:n.matchCount)||0},console.log("🎲 Game revealed:",y.result),y.phase="result",ce(),gs()},onError:a=>{if(!a.cancelled){const n=a.message||"";n.includes("0x92555c0e")||n.includes("BlockhashUnavailable")?x("Block data not available yet. RPC will retry automatically.","warning"):x(n||"Reveal failed","error")}e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-dice mr-2"></i>Try Again')}})}catch(t){console.error("Reveal error:",t),x("Reveal failed: "+(t.message||"Unknown error"),"error"),e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-dice mr-2"></i>Try Again')}}function Hf(e){var f,p;const t=y.result;if(!t)return ce();const a=y.mode==="jackpot",n=a?[y.guess]:y.guesses,i=t.rolls||[],s=a?[pe[2]]:pe,r=n.map((g,b)=>{const w=i[b]!==void 0?Number(i[b]):null;return w!==null&&w===g}),o=r.filter(g=>g).length,l=t.prizeWon>0||o>0;let d=0;t.prizeWon&&t.prizeWon>0n?d=F(BigInt(t.prizeWon)):o>0&&r.forEach((g,b)=>{if(g){const w=a?pe[2]:pe[b];d+=y.wager*w.multiplier}});const u=typeof d=="number"?d.toLocaleString(void 0,{maximumFractionDigits:2}):d.toLocaleString();e.innerHTML=`
        <div class="bg-gradient-to-br ${l?"from-emerald-900/30 to-green-900/10 border-emerald-500/30":"from-zinc-900 to-zinc-800/50 border-zinc-700/50"} border rounded-2xl p-4 sm:p-6 relative overflow-hidden" id="result-container">
            ...
            <div class="grid ${a?"grid-cols-1 max-w-[200px] mx-auto":"grid-cols-3"} gap-2 sm:gap-3 mb-4">
                ${s.map((g,b)=>{const w=a?n[0]:n[b],T=i[b],C=r[b];return`
            ...
            ${y.txHash?`
                <div class="text-center mb-3">
                    <a href="${fs}${y.txHash}" target="_blank" class="inline-flex items-center gap-2 text-xs text-zinc-500 hover:text-zinc-400">
                        <i class="fa-solid fa-external-link"></i>
                        View Transaction
                    </a>
                </div>
    ...
    `,l&&(Uf(),d>y.wager*10&&jf()),(f=document.getElementById("btn-new-game"))==null||f.addEventListener("click",()=>{y.phase="select",y.result=null,y.txHash=null,y.gameId=null,ce(),gs()}),(p=document.getElementById("btn-share"))==null||p.addEventListener("click",()=>{Wf(l,d)})}function Uf(){const e=document.createElement("div");e.className="confetti-container",document.body.appendChild(e);const t=["#f59e0b","#10b981","#8b5cf6","#ec4899","#06b6d4"],a=["●","■","★","🐯","🎉"];for(let n=0;n<60;n++){const i=document.createElement("div");i.className="confetti",i.style.cssText=`
            left: ${Math.random()*100}%;
            color: ${t[n%t.length]};
            font-size: ${8+Math.random()*12}px;
            animation-delay: ${Math.random()*2}s;
            animation-duration: ${2+Math.random()*2}s;
        `,i.textContent=a[n%a.length],e.appendChild(i)}setTimeout(()=>e.remove(),5e3)}function jf(){const e=["🪙","💰","✨","⭐","🎉"];for(let t=0;t<30;t++)setTimeout(()=>{const a=document.createElement("div");a.className="coin",a.textContent=e[Math.floor(Math.random()*e.length)],a.style.left=`${Math.random()*100}%`,a.style.animationDelay=`${Math.random()*.5}s`,a.style.animationDuration=`${2+Math.random()*2}s`,document.body.appendChild(a),setTimeout(()=>a.remove(),4e3)},t*100)}function Wf(e,t){var l,d,u,f,p,g;const a=ur[Ge],n=()=>{const b=Tf[Ge];return e?b.win(t):b.lose},i=`
        <div class="text-center">
    ...
    `,document.head.appendChild(e)}async function na(){var e;z.isConnected=c.isConnected,z.user=null,z.userSubmissions=[],z.platformUsage={},z.isBanned=!1;try{const t=await Si();if(z.systemConfig=t.config,z.leaderboards=t.leaderboards,z.dailyTasks=t.dailyTasks||[],z.platformUsageConfig=t.platformUsageConfig||Ac,z.isConnected&&c.userAddress){const[a,n]=await Promise.all([ca(c.userAddress),mu()]);if(z.user=a,z.userSubmissions=n,a&&a.isBanned){z.isBanned=!0;return}try{typeof Gs=="function"&&(z.platformUsage=await Gs()||{})}catch(i){console.warn("Could not load platform usage:",i),z.platformUsage={}}z.dailyTasks.length>0&&(z.dailyTasks=await Promise.all(z.dailyTasks.map(async i=>{try{if(!i.id)return{...i,eligible:!1,timeLeftMs:0};const s=await Jr(i.id,i.cooldownHours);return{...i,eligible:s.eligible,timeLeftMs:s.timeLeft}}catch{return{...i,eligible:!1,timeLeftMs:0}}})))}}catch(t){if(console.error("Airdrop Data Load Error:",t),t.code==="permission-denied"||(e=t.message)!=null&&e.includes("permission")){console.warn("Firebase permissions issue - user may need to connect wallet or sign in"),z.systemConfig=z.systemConfig||{},z.leaderboards=z.leaderboards||{top100ByPoints:[],top100ByPosts:[]},z.dailyTasks=z.dailyTasks||[];return}x("Error loading data. Please refresh.","error")}}function pm(e){if(!z.user||!e||e.length===0)return null;const t=e.findIndex(a=>{var n,i;return((n=a.walletAddress)==null?void 0:n.toLowerCase())===((i=z.user.walletAddress)==null?void 0:i.toLowerCase())});return t>=0?t+1:null}function fm(e){return e?e<=5?rt[0]:e<=25?rt[1]:e<=75?rt[2]:e<=200?rt[3]:null:null}function Pc(){var l;const{user:e}=z,t=(e==null?void 0:e.totalPoints)||0,a=(e==null?void 0:e.platformUsagePoints)||0,n=(e==null?void 0:e.approvedSubmissionsCount)||0,i=dm(n),s=((l=z.leaderboards)==null?void 0:l.top100ByPosts)||[],r=pm(s),o=fm(r);return`
        <!-- Mobile Header -->
            ...
            <div class="flex items-center justify-between mb-3">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <span class="text-[9px] text-zinc-500">${Vt} NFTs • 4 Tiers</span>
                    </div>
                </div>
            ...
            <div class="flex items-center justify-between mb-5">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-zinc-500 text-sm">${Vt} NFT Boosters • 4 Reward Tiers</p>
                    </div>
                </div>
    ...
    `:`
            <div class="text-center px-4 py-12 airdrop-fade-up">
                ...
                <div class="max-w-xs mx-auto bg-zinc-900/60 border border-zinc-800 rounded-xl p-3">
                    <p class="text-zinc-500 text-[10px] uppercase tracking-wider mb-2">Win 1 of ${Vt} NFT Boosters</p>
        ...
        <div class="space-y-4">
            ...
            <div class="bg-zinc-900/60 border border-zinc-800 rounded-xl p-4">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <span class="text-[10px] text-zinc-600">${Vt} total</span>
                </div>
    ...
    `}function gm(){var r;const e=z.platformUsageConfig||Ac,t=z.platformUsage||{};let a=0,n=0;Object.keys(e).forEach(o=>{var l;e[o].enabled!==!1&&e[o].maxCount&&(a+=e[o].maxCount,n+=Math.min(((l=t[o])==null?void 0:l.count)||0,e[o].maxCount))});const i=a>0?n/a*100:0,s=((r=z.user)==null?void 0:r.platformUsagePoints)||0;return`
        <div class="space-y-4">
            <!-- Info Banner -->
    ...
    `}function xm(){const{user:e,userSubmissions:t}=z;if(!z.isConnected)return`
        ...
        `;const a=Date.now(),n=Ic*60*60*1e3,i=t.filter(l=>["pending","auditing"].includes(l.status)&&l.submittedAt&&a-l.submittedAt.getTime()>=n),s=(e==null?void 0:e.approvedSubmissionsCount)||0,r=t.filter(l=>["pending","auditing"].includes(l.status)).length,o=t.filter(l=>l.status==="rejected").length;return`
        ...
        <div class="px-4 airdrop-fade-up">
            ...
            <div class="bg-gradient-to-br from-zinc-900 to-zinc-900 border border-amber-500/20 rounded-xl p-4 mb-5 relative overflow-hidden">
                ...
                <div class="flex items-center justify-between mb-3">
                    ...
                    <span class="text-[10px] text-zinc-500 bg-zinc-800 px-2 py-0.5 rounded-full">${Vt} NFTs</span>
                </div>
    ...
    `;xa(t,"max-w-md"),(i=document.getElementById("deletePostBtn"))==null||i.addEventListener("click",async s=>{const r=s.currentTarget,o=r.dataset.submissionId;r.disabled=!0,r.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-1"></i> Deleting...';try{await Zr(o),x("Post deleted. No penalty applied.","info"),Ee(),await na(),_e()}catch(l){x(l.message,"error"),r.disabled=!1,r.innerHTML='<i class="fa-solid fa-trash mr-1"></i> Delete Post'}});const a=document.getElementById("confirmCheckbox"),n=document.getElementById("finalConfirmBtn");a==null||a.addEventListener("change",()=>{a.checked?(n.disabled=!1,n.className="flex-1 bg-green-600 hover:bg-green-500 text-white py-3 rounded-xl font-bold text-sm transition-colors cursor-pointer",n.innerHTML='<i class="fa-solid fa-check mr-1"></i> Confirm & Earn ✓'):(n.disabled=!0,n.className="flex-1 bg-green-600/50 text-green-200 py-3 rounded-xl font-bold text-sm cursor-not-allowed transition-colors",n.innerHTML='<i class="fa-solid fa-lock mr-1"></i> Confirm & Earn')}),n==null||n.addEventListener("click",Tm)}async function Tm(e){const t=e.currentTarget,a=t.dataset.submissionId;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-2"></i> Verifying...';try{await gu(a),x("Success! Points added.","success"),Ee(),await na(),_e()}catch{x("Verification failed.","error"),t.disabled=!1,t.innerHTML="Try Again"}}async function Cm(e){const t=e.target.closest(".action-btn");if(!t)return;const a=t.dataset.action,n=t.dataset.id;if(a==="confirm"){const i=z.userSubmissions.find(s=>s.submissionId===n);i&&zc(i)}else if(a==="delete"){if(!confirm("Remove this submission?"))return;try{await Zr(n),x("Removed.","info"),await na(),_e()}catch(i){x(i.message,"error")}}}async function Im(e){const t=e.target.closest("#submit-content-btn");if(!t)return;const a=document.getElementById("content-url-input"),n=a==null?void 0:a.value.trim();if(!n||!n.startsWith("http"))return x("Enter a valid URL.","warning");const i=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-circle-notch fa-spin"></i>';try{await fu(n),x("📋 Submitted! Your post is now under security audit.","info"),a.value="",await na(),z.activeTab="history",_e()}catch(s){x(s.message,"error")}finally{t.disabled=!1,t.innerHTML=i}}async function Am(e){const t=e.target.closest(".task-card");if(!t)return;const a=t.dataset.id,n=t.dataset.url;n&&window.open(n,"_blank");const i=z.dailyTasks.find(s=>s.id===a);if(!(!i||!i.eligible))try{await uu(i,z.user.pointsMultiplier),x(`Task completed! +${i.points} pts`,"success"),await na(),_e()}catch(s){s.message.includes("Cooldown")||x(s.message,"error")}}function Pm(){const e=Date.now(),t=Ic*60*60*1e3,a=z.userSubmissions.filter(n=>["pending","auditing"].includes(n.status)&&n.submittedAt&&e-n.submittedAt.getTime()>=t);a.length>0&&(z.activeTab="history",_e(),setTimeout(()=>{zc(a[0])},500))}const zm={async render(e){const t=document.getElementById("airdrop");if(!t)return;um();const a=cm();(t.innerHTML.trim()===""||e)&&(t.innerHTML=`
                    ...
                    <div class="relative z-10 text-center max-w-sm w-full">
                        ...
                        <div class="bg-zinc-900/50 border border-zinc-800 rounded-xl p-4 mb-6 text-left">
                            <p class="text-zinc-500 text-[10px] uppercase tracking-wider mb-3 text-center">
                                ${Vt} NFT Booster Rewards • 4 Tiers
                            </p>
                ...
                <div id="airdrop-main" class="hidden">
                    <div id="airdrop-header">${Pc()}</div>
                    <div id="airdrop-body" class="max-w-2xl mx-auto pb-24">
                        <div id="main-content"></div>
                    </div>
                </div>
            `,this.attachListeners());try{const n=new Promise(o=>setTimeout(o,4e3));await Promise.all([na(),n]);const i=document.getElementById("loading-state"),s=document.getElementById("airdrop-main"),r=document.getElementById("main-content");i&&(i.style.transition="opacity 0.5s ease-out",i.style.opacity="0",await new Promise(o=>setTimeout(o,500)),i.classList.add("hidden")),s&&s.classList.remove("hidden"),r&&(r.classList.remove("hidden"),_e()),Pm()}catch(n){console.error(n)}},attachListeners(){const e=document.getElementById("airdrop-body"),t=document.getElementById("airdrop-header");t==null||t.addEventListener("click",mr),e==null||e.addEventListener("click",a=>{a.target.closest("#guide-toggle-btn")&&Em(),a.target.closest("#submit-content-btn")&&Im(a),a.target.closest(".task-card")&&Am(a),a.target.closest(".action-btn")&&Cm(a),a.target.closest("#copy-viral-btn")&&wm(),a.target.closest(".ranking-tab-btn")&&km(a),a.target.closest(".earn-tab-btn")&&ym(a),a.target.closest(".nav-pill-btn")&&mr(a);const n=a.target.closest(".platform-action-card");if(n&&!n.classList.contains("completed")){const i=n.dataset.targetPage;i&&(console.log("🎯 Navigating to:",i),Bm(i))}})},update(e){z.isConnected!==e&&this.render(!0)}};function Bm(e){console.log("🎯 Platform card clicked, navigating to:",e);const t=document.querySelector(`a[data-target="${e}"]`)||document.querySelector(`[data-target="${e}"]`);if(t){console.log("✅ Found menu link, clicking..."),t.click();const i=document.getElementById("sidebar");i&&window.innerWidth<768&&i.classList.add("hidden");return}const a=document.querySelectorAll("main > section"),n=document.getElementById(e);if(n){console.log("✅ Found section, showing directly..."),a.forEach(s=>s.classList.add("hidden")),n.classList.remove("hidden"),document.querySelectorAll(".sidebar-link").forEach(s=>{s.classList.remove("active","bg-zinc-700","text-white"),s.classList.add("text-zinc-400")});const i=document.querySelector(`[data-target="${e}"]`);i&&(i.classList.add("active","bg-zinc-700","text-white"),i.classList.remove("text-zinc-400"));return}console.warn("⚠️ Could not navigate to:",e)}const Bc=window.ethers,rn="".toLowerCase(),Nm="",Nc="bkc_admin_auth_v3";window.__ADMIN_WALLET__=rn;setTimeout(()=>{document.dispatchEvent(new CustomEvent("adminConfigReady")),console.log("✅ Admin config ready, wallet:",rn?"configured":"not set")},100);function gr(){return sessionStorage.getItem(Nc)==="true"}function Sm(){sessionStorage.setItem(Nc,"true")}function $m(){return!c.isConnected||!c.userAddress||!rn?!1:c.userAddress.toLowerCase()===rn}const br={pending:{text:"Pending Review",color:"text-amber-400",bgColor:"bg-amber-900/50",icon:"fa-clock"},auditing:{text:"Auditing",color:"text-blue-400",bgColor:"bg-blue-900/50",icon:"fa-magnifying-glass"},approved:{text:"Approved",color:"text-green-400",bgColor:"bg-green-900/50",icon:"fa-check-circle"},rejected:{text:"Rejected",color:"text-red-400",bgColor:"bg-red-900/50",icon:"fa-times-circle"},flagged_suspicious:{text:"Flagged",color:"text-red-300",bgColor:"bg-red-800/60",icon:"fa-flag"}},In={faucet:{icon:"🚰",label:"Claim Faucet",points:1e3,maxCount:1,cooldownHours:0,enabled:!0},delegation:{icon:"📊",label:"Delegate BKC",points:2e3,maxCount:10,cooldownHours:24,enabled:!0},fortune:{icon:"🎰",label:"Play Fortune",points:1500,maxCount:10,cooldownHours:1,enabled:!0},buyNFT:{icon:"🛒",label:"Buy NFT",points:2500,maxCount:10,cooldownHours:0,enabled:!0},sellNFT:{icon:"💰",label:"Sell NFT",points:1500,maxCount:10,cooldownHours:0,enabled:!0},listRental:{icon:"🏷️",label:"List for Rent",points:1e3,maxCount:10,cooldownHours:0,enabled:!0},rentNFT:{icon:"⏰",label:"Rent NFT",points:2e3,maxCount:10,cooldownHours:0,enabled:!0},notarize:{icon:"📜",label:"Notarize Doc",points:2e3,maxCount:10,cooldownHours:0,enabled:!0},claimReward:{icon:"💸",label:"Claim Rewards",points:1e3,maxCount:10,cooldownHours:24,enabled:!0},unstake:{icon:"↩️",label:"Unstake",points:500,maxCount:10,cooldownHours:0,enabled:!0}};let A={allSubmissions:[],dailyTasks:[],ugcBasePoints:null,platformUsageConfig:null,editingTask:null,activeTab:"review-submissions",allUsers:[],selectedUserSubmissions:[],isSubmissionsModalOpen:!1,selectedWallet:null,usersFilter:"all",usersSearch:"",usersPage:1,usersPerPage:100,submissionsPage:1,submissionsPerPage:100,tasksPage:1,tasksPerPage:100};const fa=async()=>{var t;const e=document.getElementById("admin-content-wrapper");if(e){const a=document.createElement("div");e.innerHTML=a.innerHTML}try{c.userAddress&&(await Xr(c.userAddress),console.log("✅ Firebase Auth: Admin authenticated"));const[a,n,i,s]=await Promise.all([wu(),xu(),Si(),yu()]);A.allSubmissions=a,A.dailyTasks=n,A.allUsers=s,A.ugcBasePoints=((t=i.config)==null?void 0:t.ugcBasePoints)||{YouTube:5e3,"YouTube Shorts":2500,Instagram:3e3,"X/Twitter":1500,Facebook:2e3,Telegram:1e3,TikTok:3500,Reddit:1800,LinkedIn:2200,Other:1e3},A.platformUsageConfig=i.platformUsageConfig||In,A.editingTask&&(A.editingTask=n.find(r=>r.id===A.editingTask.id)||null),t0()}catch(a){if(console.error("Error loading admin data:",a),e){const n=document.createElement("div");Hu(n,`Failed to load admin data: ${a.message}`),e.innerHTML=n.innerHTML}else x("Failed to load admin data.","error")}},bs=async()=>{const e=document.getElementById("presale-balance-amount");if(e){e.innerHTML='<span class="loader !w-5 !h-5 inline-block"></span>';try{if(!c.signer||!c.signer.provider)throw new Error("Admin provider not found.");if(!v.publicSale)throw new Error("PublicSale address not configured.");const t=await c.signer.provider.getBalance(v.publicSale),a=Bc.formatEther(t);e.textContent=`${parseFloat(a).toFixed(6)} ETH/BNB`}catch(t){console.error("Error loading presale balance:",t),e.textContent="Error"}}},Lm=async e=>{if(!c.signer){x("Por favor, conecte a carteira do Owner primeiro.","error");return}if(!window.confirm("Are you sure you want to withdraw ALL funds from the Presale contract to the Treasury wallet?"))return;const t=["function withdrawFunds() external"],a=v.publicSale,n=new Bc.Contract(a,t,c.signer),i=e.innerHTML;e.disabled=!0,e.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i> Withdrawing...';try{console.log(`Calling withdrawFunds() on ${a}...`);const s=await n.withdrawFunds();x("Transaction sent. Awaiting confirmation...","info");const r=await s.wait();console.log("Funds withdrawn successfully!",r.hash),x("Funds withdrawn successfully!","success",r.hash),bs()}catch(s){console.error("Error withdrawing funds:",s);const r=s.reason||s.message||"Transaction failed.";x(`Error: ${r}`,"error")}finally{e.disabled=!1,e.innerHTML=i}},Rm=async e=>{const t=e.target.closest("button[data-action]");if(!t||t.disabled)return;const a=t.dataset.action,n=t.dataset.submissionId,i=t.dataset.userId;if(!a||!n||!i){console.warn("Missing data attributes for admin action:",t.dataset);return}const s=t.closest("tr"),r=t.closest("td").querySelectorAll("button");s?(s.style.opacity="0.5",s.style.pointerEvents="none"):r.forEach(o=>o.disabled=!0);try{(a==="approved"||a==="rejected")&&(await Qr(i,n,a),x(`Submission ${a==="approved"?"APPROVED":"REJECTED"}!`,"success"),A.allSubmissions=A.allSubmissions.filter(o=>o.submissionId!==n),on())}catch(o){x(`Failed to ${a} submission: ${o.message}`,"error"),console.error(o),s&&(s.style.opacity="1",s.style.pointerEvents="auto")}},_m=async e=>{const t=e.target.closest(".ban-user-btn");if(!t||t.disabled)return;const a=t.dataset.userId,n=t.dataset.action==="ban";if(!a)return;const i=n?`Are you sure you want to PERMANENTLY BAN this user?
(This is reversible)`:`Are you sure you want to UNBAN this user?
(This will reset their rejection count to 0)`;if(!window.confirm(i))return;const s=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await eo(a,n),x(`User ${n?"BANNED":"UNBANNED"}.`,"success");const r=A.allUsers.findIndex(o=>o.id===a);r>-1&&(A.allUsers[r].isBanned=n,A.allUsers[r].hasPendingAppeal=!1,n===!1&&(A.allUsers[r].rejectedCount=0)),ft()}catch(r){x(`Failed: ${r.message}`,"error"),t.disabled=!1,t.innerHTML=s}},Fm=async e=>{const t=e.target.closest(".resolve-appeal-btn");if(!t||t.disabled)return;const a=t.dataset.userId,i=t.dataset.action==="approve";if(!a)return;const s=i?"Are you sure you want to APPROVE this appeal and UNBAN the user?":"Are you sure you want to DENY this appeal? The user will remain banned.";if(!window.confirm(s))return;const r=t.closest("td").querySelectorAll("button"),o=new Map;r.forEach(l=>{o.set(l,l.innerHTML),l.disabled=!0,l.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>'});try{i&&await eo(a,!1),x(`Appeal ${i?"APPROVED":"DENIED"}.`,"success");const l=A.allUsers.findIndex(d=>d.id===a);l>-1&&(A.allUsers[l].hasPendingAppeal=!1,i&&(A.allUsers[l].isBanned=!1,A.allUsers[l].rejectedCount=0)),ft()}catch(l){x(`Failed: ${l.message}`,"error"),r.forEach(d=>{d.disabled=!1,d.innerHTML=o.get(d)})}},Mm=async e=>{const t=e.target.closest(".re-approve-btn");if(!t||t.disabled)return;const a=t.dataset.submissionId,n=t.dataset.userId;if(!a||!n)return;const i=t.closest("tr");i&&(i.style.opacity="0.5"),t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await Qr(n,a,"approved"),x("Submission re-approved!","success"),A.selectedUserSubmissions=A.selectedUserSubmissions.filter(r=>r.submissionId!==a),i&&i.remove();const s=A.allUsers.findIndex(r=>r.id===n);if(s>-1){const r=A.allUsers[s];r.rejectedCount=Math.max(0,(r.rejectedCount||0)-1),ft()}if(A.selectedUserSubmissions.length===0){const r=document.querySelector("#admin-user-modal .p-6");r&&(r.innerHTML='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>')}}catch(s){x(`Failed to re-approve: ${s.message}`,"error"),i&&(i.style.opacity="1"),t.disabled=!1,t.innerHTML='<i class="fa-solid fa-check"></i> Re-Approve'}},Dm=async e=>{const t=e.target.closest(".view-rejected-btn");if(!t||t.disabled)return;const a=t.dataset.userId,n=t.dataset.wallet;if(a){A.selectedWallet=n,A.isSubmissionsModalOpen=!0,Vn(!0,[]);try{const i=await ku(a,"rejected");A.selectedUserSubmissions=i,Vn(!1,i)}catch(i){x(`Error fetching user submissions: ${i.message}`,"error"),Vn(!1,[],!0)}}},Om=()=>{A.isSubmissionsModalOpen=!1,A.selectedUserSubmissions=[],A.selectedWallet=null;const e=document.getElementById("admin-user-modal");e&&e.remove(),document.body.style.overflow="auto"},Hm=e=>{const t=e.target.closest(".user-profile-link");if(!t)return;e.preventDefault();const a=t.dataset.userId;if(!a)return;const n=A.allUsers.find(i=>i.id===a);if(!n){x("Error: Could not find user data.","error");return}Ym(n)},Um=()=>{const e=document.getElementById("admin-user-profile-modal");e&&e.remove(),document.body.style.overflow="auto"},jm=async e=>{e.preventDefault();const t=e.target;let a,n;try{if(a=new Date(t.startDate.value+"T00:00:00Z"),n=new Date(t.endDate.value+"T23:59:59Z"),isNaN(a.getTime())||isNaN(n.getTime()))throw new Error("Invalid date format.");if(a>=n)throw new Error("Start Date must be before End Date.")}catch(l){x(l.message,"error");return}const i={title:t.title.value.trim(),url:t.url.value.trim(),description:t.description.value.trim(),points:parseInt(t.points.value,10),cooldownHours:parseInt(t.cooldown.value,10),startDate:a,endDate:n};if(!i.title||!i.description){x("Please fill in Title and Description.","error");return}if(i.points<=0||i.cooldownHours<=0){x("Points and Cooldown must be positive numbers.","error");return}if(i.url&&!i.url.startsWith("http")){x("URL must start with http:// or https://","error");return}A.editingTask&&A.editingTask.id&&(i.id=A.editingTask.id);const s=t.querySelector('button[type="submit"]'),r=s.innerHTML;s.disabled=!0;const o=document.createElement("span");o.classList.add("inline-block"),s.innerHTML="",s.appendChild(o);try{await hu(i),x(`Task ${i.id?"updated":"created"} successfully!`,"success"),t.reset(),A.editingTask=null,fa()}catch(l){x(`Failed to save task: ${l.message}`,"error"),console.error(l),s.disabled=!1,s.innerHTML=r}},Wm=async e=>{e.preventDefault();const t=e.target,a={YouTube:parseInt(t.youtubePoints.value,10),"YouTube Shorts":parseInt(t.youtubeShortsPoints.value,10),Instagram:parseInt(t.instagramPoints.value,10),"X/Twitter":parseInt(t.xTwitterPoints.value,10),Facebook:parseInt(t.facebookPoints.value,10),Telegram:parseInt(t.telegramPoints.value,10),TikTok:parseInt(t.tiktokPoints.value,10),Reddit:parseInt(t.redditPoints.value,10),LinkedIn:parseInt(t.linkedinPoints.value,10),Other:parseInt(t.otherPoints.value,10)};if(Object.values(a).some(r=>isNaN(r)||r<0)){x("All points must be positive numbers (or 0).","error");return}const n=t.querySelector('button[type="submit"]'),i=n.innerHTML;n.disabled=!0;const s=document.createElement("span");s.classList.add("inline-block"),n.innerHTML="",n.appendChild(s);try{await bu(a),x("UGC Base Points updated successfully!","success"),A.ugcBasePoints=a}catch(r){x(`Failed to update points: ${r.message}`,"error"),console.error(r)}finally{document.body.contains(n)&&(n.disabled=!1,n.innerHTML=i)}},Gm=e=>{const t=A.dailyTasks.find(a=>a.id===e);t&&(A.editingTask=t,Ea())},Km=async e=>{if(window.confirm("Are you sure you want to delete this task permanently?"))try{await vu(e),x("Task deleted.","success"),A.editingTask=null,fa()}catch(t){x(`Failed to delete task: ${t.message}`,"error"),console.error(t)}};function Vn(e,t,a=!1){var r,o;const n=document.getElementById("admin-user-modal");n&&n.remove(),document.body.style.overflow="hidden";let i="";e?i='<div class="p-8"></div>':a?i='<p class="text-red-400 text-center p-8">Failed to load submissions.</p>':t.length===0?i='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>':i=`
         ...
         <div id="admin-user-modal" class="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4" style="backdrop-filter: blur(5px);">
             <div class="bg-sidebar border border-border-color rounded-xl shadow-lg w-full max-w-3xl max-h-[90vh] flex flex-col">
                 <div class="p-5 border-b border-border-color flex justify-between items-center">
                     <h2 class="text-xl font-bold text-white">Rejected Posts for ${Zt(A.selectedWallet)}</h2>
     ...
     `;document.body.insertAdjacentHTML("beforeend",s),e&&document.getElementById("admin-user-modal").querySelector(".p-8"),(r=document.getElementById("close-admin-modal-btn"))==null||r.addEventListener("click",Om),(o=document.getElementById("modal-submissions-tbody"))==null||o.addEventListener("click",Mm)}function Ym(e){var i;const t=document.getElementById("admin-user-profile-modal");t&&t.remove(),document.body.style.overflow="hidden";const a=e.isBanned?'<span class="text-xs font-bold py-1 px-3 rounded-full bg-red-600 text-white">BANNED</span>':e.hasPendingAppeal?'<span class="text-xs font-bold py-1 px-3 rounded-full bg-yellow-600 text-white">APPEALING</span>':'<span class="text-xs font-bold py-1 px-3 rounded-full bg-green-600 text-white">ACTIVE</span>',n=`
         <div id="admin-user-profile-modal" class="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4" style="backdrop-filter: blur(5px);">
             <div class="bg-sidebar border border-border-color rounded-xl shadow-lg w-full max-w-2xl max-h-[90vh] flex flex-col">
                 ...
                 <div class="p-6 overflow-y-auto space-y-4">
                    ...
                    <div class="flex justify-between items-center">
                        <h3 class="text-lg font-semibold text-zinc-100">${Zt(e.walletAddress)}</h3>
                        ${a}
                    </div>
     ...
     `;document.body.insertAdjacentHTML("beforeend",n),(i=document.getElementById("close-admin-profile-modal-btn"))==null||i.addEventListener("click",Um)}const Vm=e=>{const t=e.target.closest(".user-filter-btn");!t||t.classList.contains("active")||(A.usersFilter=t.dataset.filter||"all",A.usersPage=1,ft())},qm=e=>{A.usersSearch=e.target.value,A.usersPage=1,ft()},Xm=e=>{A.usersPage=e,ft()},Jm=e=>{A.submissionsPage=e,on()},Zm=e=>{A.tasksPage=e,Ea()},ft=()=>{var L,B;const e=document.getElementById("manage-users-content");if(!e)return;const t=A.allUsers;if(!t)return;const n=(A.usersSearch||"").toLowerCase().trim().replace(/[^a-z0-9x]/g,""),i=A.usersFilter;let s=t;n&&(s=s.filter(I=>{var _,D;return((_=I.walletAddress)==null?void 0:_.toLowerCase().includes(n))||((D=I.id)==null?void 0:D.toLowerCase().includes(n))})),i==="banned"?s=s.filter(I=>I.isBanned):i==="appealing"&&(s=s.filter(I=>I.hasPendingAppeal===!0));const r=t.length,o=t.filter(I=>I.isBanned).length,l=t.filter(I=>I.hasPendingAppeal===!0).length,d=s.sort((I,_)=>I.hasPendingAppeal!==_.hasPendingAppeal?I.hasPendingAppeal?-1:1:I.isBanned!==_.isBanned?I.isBanned?-1:1:(_.totalPoints||0)-(I.totalPoints||0)),u=A.usersPage,f=A.usersPerPage,p=d.length,g=Math.ceil(p/f),b=(u-1)*f,w=u*f,T=d.slice(b,w),C=T.length>0?T.map(I=>{let _="border-b border-border-color hover:bg-zinc-800/50",D="";return I.hasPendingAppeal?(_+=" bg-yellow-900/40",D='<span class="ml-2 text-xs font-bold text-yellow-300">[APPEALING]</span>'):I.isBanned&&(_+=" bg-red-900/30 opacity-70",D='<span class="ml-2 text-xs font-bold text-red-400">[BANNED]</span>'),`
        <tr class="${_}">
    ...
    `,(n=document.getElementById("ugcPointsForm"))==null||n.addEventListener("submit",Wm)},Ea=()=>{var b,w,T;const e=document.getElementById("manage-tasks-content");if(!e)return;const t=A.editingTask,a=!!t,n=C=>{if(!C)return"";try{return(C.toDate?C.toDate():C instanceof Date?C:new Date(C)).toISOString().split("T")[0]}catch{return""}},i=A.tasksPage,s=A.tasksPerPage,r=[...A.dailyTasks].sort((C,P)=>{var B,I;const S=(B=C.startDate)!=null&&B.toDate?C.startDate.toDate():new Date(C.startDate||0);return((I=P.startDate)!=null&&I.toDate?P.startDate.toDate():new Date(P.startDate||0)).getTime()-S.getTime()}),o=r.length,l=Math.ceil(o/s),d=(i-1)*s,u=i*s,f=r.slice(d,u),p=f.length>0?f.map(C=>{var I,_;const P=new Date,S=(I=C.startDate)!=null&&I.toDate?C.startDate.toDate():C.startDate?new Date(C.startDate):null,L=(_=C.endDate)!=null&&_.toDate?C.endDate.toDate():C.endDate?new Date(C.endDate):null;let B="text-zinc-500";return S&&L&&(P>=S&&P<=L?B="text-green-400":P<S&&(B="text-blue-400")),`
    ...
    `;const g=document.getElementById("admin-tasks-pagination");g&&l>1&&Li(g,A.tasksPage,l,Zm),(b=document.getElementById("taskForm"))==null||b.addEventListener("submit",jm),(w=document.getElementById("cancelEditBtn"))==null||w.addEventListener("click",()=>{A.editingTask=null,Ea()}),(T=document.getElementById("existing-tasks-list"))==null||T.addEventListener("click",C=>{const P=C.target.closest("button[data-id]");if(!P)return;const S=P.dataset.id;P.dataset.action==="edit"&&Gm(S),P.dataset.action==="delete"&&Km(S)})},on=()=>{var f;const e=document.getElementById("submissions-content");if(!e)return;if(!A.allSubmissions||A.allSubmissions.length===0){const p=document.createElement("div");e.innerHTML=p.innerHTML;return}const t=A.submissionsPage,a=A.submissionsPerPage,n=[...A.allSubmissions].sort((p,g)=>{var b,w;return(((b=g.submittedAt)==null?void 0:b.getTime())||0)-(((w=p.submittedAt)==null?void 0:w.getTime())||0)}),i=n.length,s=Math.ceil(i/a),r=(t-1)*a,o=t*a,d=n.slice(r,o).map(p=>{var g,b;return`
        <tr class="border-b border-border-color hover:bg-zinc-800/50">
            <td class="p-3 text-xs text-zinc-400 font-mono" title="${p.userId}">${Zt(p.walletAddress)}</td>
            ...
            <td class="p-3 text-xs font-semibold ${((g=br[p.status])==null?void 0:g.color)||"text-gray-500"}">${((b=br[p.status])==null?void 0:b.text)||p.status}</td>
            <td class="p-3 text-right">
                <div class="flex items-center justify-end gap-2">
    ...
    `;const u=document.getElementById("admin-submissions-pagination");u&&s>1&&Li(u,A.submissionsPage,s,Jm),(f=document.getElementById("admin-submissions-tbody"))==null||f.addEventListener("click",Rm)},ln=()=>{var s,r;const e=document.getElementById("platform-usage-content");if(!e)return;const t=A.platformUsageConfig||In;let a=0;Object.values(t).forEach(o=>{o.enabled!==!1&&(a+=(o.points||0)*(o.maxCount||1))});const n=Object.entries(t).map(([o,l])=>`
    ...
    `;const i=document.getElementById("platform-usage-tbody");i==null||i.addEventListener("input",hr),i==null||i.addEventListener("change",hr),(s=document.getElementById("save-platform-config-btn"))==null||s.addEventListener("click",Qm),(r=document.getElementById("reset-platform-config-btn"))==null||r.addEventListener("click",e0)},hr=e=>{const t=e.target;if(!t.classList.contains("platform-input")&&!t.classList.contains("platform-toggle"))return;const a=t.closest("tr"),n=a==null?void 0:a.dataset.actionKey,i=t.dataset.field;if(!n||!i)return;A.platformUsageConfig[n]||(A.platformUsageConfig[n]={...In[n]}),i==="enabled"?A.platformUsageConfig[n].enabled=t.checked:A.platformUsageConfig[n][i]=parseInt(t.value)||0;const s=A.platformUsageConfig[n],r=a.querySelector("td:last-child");r&&(r.textContent=((s.points||0)*(s.maxCount||1)).toLocaleString())},Qm=async e=>{const t=e.target.closest("button");if(!t)return;const a=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Saving...';try{await to(A.platformUsageConfig),x("✅ Platform Usage config saved!","success"),ln()}catch(n){console.error("Error saving platform config:",n),x("Failed to save config: "+n.message,"error")}finally{t.disabled=!1,t.innerHTML=a}},e0=async()=>{if(confirm("Are you sure you want to reset to default values? This will save immediately."))try{A.platformUsageConfig={...In},await to(A.platformUsageConfig),x("✅ Config reset to defaults!","success"),ln()}catch(e){console.error("Error resetting platform config:",e),x("Failed to reset config: "+e.message,"error")}},t0=()=>{var a;const e=document.getElementById("admin-content-wrapper");if(!e)return;e.innerHTML=`
    ...
    `,(a=document.getElementById("withdraw-presale-funds-btn"))==null||a.addEventListener("click",n=>Lm(n.target)),bs(),A.activeTab==="manage-ugc-points"?xr():A.activeTab==="manage-tasks"?Ea():A.activeTab==="review-submissions"?on():A.activeTab==="manage-users"?ft():A.activeTab==="platform-usage"&&ln();const t=document.getElementById("admin-tabs");t&&!t._listenerAttached&&(t.addEventListener("click",n=>{const i=n.target.closest(".tab-btn");if(!i||i.classList.contains("active"))return;const s=i.dataset.target;A.activeTab=s,s!=="manage-users"&&(A.usersPage=1,A.usersFilter="all",A.usersSearch=""),s!=="review-submissions"&&(A.submissionsPage=1),s!=="manage-tasks"&&(A.tasksPage=1),document.querySelectorAll("#admin-tabs .tab-btn").forEach(o=>o.classList.remove("active")),i.classList.add("active"),e.querySelectorAll(".tab-content").forEach(o=>o.classList.remove("active"));const r=document.getElementById(s.replace(/-/g,"_")+"_tab");r?(r.classList.add("active"),s==="manage-ugc-points"&&xr(),s==="manage-tasks"&&Ea(),s==="review-submissions"&&on(),s==="manage-users"&&ft(),s==="platform-usage"&&ln()):console.warn(`Tab content container not found for target: ${s}`)}),t._listenerAttached=!0)},a0={render(){const e=document.getElementById("admin");if(e){if(!$m()){e.innerHTML='<div class="text-center text-red-400 p-8 bg-sidebar border border-red-500/50 rounded-lg">Access Denied. This page is restricted to administrators.</div>';return}if(gr()){e.innerHTML='<div id="admin-content-wrapper"></div>',fa();return}e.innerHTML=`
                ...
                <div class="bg-sidebar border border-yellow-500/30 rounded-2xl p-8 max-w-md w-full shadow-xl">
                    ...
                    <div class="mt-6 pt-4 border-t border-zinc-800">
                        <p class="text-zinc-500 text-xs text-center">
                            <i class="fa-solid fa-wallet mr-1"></i>Connected: ${Zt(c.userAddress)}
                        </p>
                    </div>
                </div>
            </div>
        `,document.getElementById("admin-login-btn").addEventListener("click",()=>{const t=document.getElementById("admin-key-input"),a=document.getElementById("admin-login-error");t.value===Nm?(Sm(),x("✅ Admin access granted!","success"),e.innerHTML='<div id="admin-content-wrapper"></div>',fa()):(a.classList.remove("hidden"),t.value="",t.focus(),setTimeout(()=>a.classList.add("hidden"),3e3))}),setTimeout(()=>{var t;(t=document.getElementById("admin-key-input"))==null||t.focus()},100)}},refreshData(){const e=document.getElementById("admin");e&&!e.classList.contains("hidden")&&gr()&&(console.log("Refreshing Admin Page data..."),fa(),bs())}},qn=2e8,vr={airdrop:{amount:7e7},liquidity:{amount:13e7}},n0=()=>{if(document.getElementById("tokenomics-styles-v5"))return;const e=document.createElement("style");e.id="tokenomics-styles-v5",e.innerHTML=`
    ...
    `,document.head.appendChild(e)},ma=e=>e>=1e6?(e/1e6).toFixed(1)+"M":e>=1e3?(e/1e3).toFixed(0)+"K":e.toLocaleString();function i0(){return`
    ...
    `}function s0(){const e=c.totalSupply?F(c.totalSupply):4e7,t=(e/qn*100).toFixed(1);return`
        <div class="tk-section tk-fade-up" style="animation-delay: 0.1s">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div class="tk-card text-center">
                    ...
                    <p class="text-xl font-black text-white">${ma(qn)}</p>
            ...
            <p class="text-center text-zinc-600 text-[10px]">
                ...
                Remaining ${ma(qn-e)} BKC to be mined through ecosystem activity
            </p>
        </div>
    `}function r0(){return`
                ...
                <div class="space-y-3">
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-500 text-[10px]">${ma(vr.airdrop.amount)} BKC</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-500 text-[10px]">${ma(vr.liquidity.amount)} BKC</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    `,e.scrollIntoView({behavior:"smooth",block:"start"}))}const m0={render:f0,init:()=>{},update:()=>{}},ne=window.ethers,g0=5*1024*1024,Sc="https://sepolia.arbiscan.io",b0=`${Sc}/tx/`,xs=`${Sc}/address/`,$c=["event Certified(uint256 indexed certId, address indexed owner, bytes32 documentHash, uint8 docType, address operator)"],Ke={image:{icon:"fa-regular fa-image",color:"#34d399",bg:"rgba(52,211,153,0.12)",label:"Image"},pdf:{icon:"fa-regular fa-file-pdf",color:"#f87171",bg:"rgba(248,113,113,0.12)",label:"PDF"},audio:{icon:"fa-solid fa-music",color:"#a78bfa",bg:"rgba(167,139,250,0.12)",label:"Audio"},video:{icon:"fa-regular fa-file-video",color:"#60a5fa",bg:"rgba(96,165,250,0.12)",label:"Video"},document:{icon:"fa-regular fa-file-word",color:"#60a5fa",bg:"rgba(96,165,250,0.12)",label:"Document"},spreadsheet:{icon:"fa-regular fa-file-excel",color:"#4ade80",bg:"rgba(74,222,128,0.12)",label:"Spreadsheet"},code:{icon:"fa-solid fa-code",color:"#22d3ee",bg:"rgba(34,211,238,0.12)",label:"Code"},archive:{icon:"fa-regular fa-file-zipper",color:"#facc15",bg:"rgba(250,204,21,0.12)",label:"Archive"},default:{icon:"fa-regular fa-file",color:"#fbbf24",bg:"rgba(251,191,36,0.12)",label:"File"}},E={view:"documents",activeTab:"documents",viewHistory:[],wizStep:1,wizFile:null,wizFileHash:null,wizDescription:"",wizDuplicateCheck:null,wizIsHashing:!1,wizIpfsCid:null,wizUploadDate:null,bkcFee:0n,ethFee:0n,feesLoaded:!1,certificates:[],certsLoading:!1,selectedCert:null,verifyFile:null,verifyHash:null,verifyResult:null,verifyIsChecking:!1,stats:null,totalSupply:0,recentNotarizations:[],statsLoading:!1,isProcessing:!1,processStep:"",isLoading:!1,contractAvailable:!0};function Sa(e="",t=""){const a=e.toLowerCase(),n=t.toLowerCase();return a.includes("image")||/\.(jpg|jpeg|png|gif|webp|svg|bmp|ico)$/.test(n)?Ke.image:a.includes("pdf")||n.endsWith(".pdf")?Ke.pdf:a.includes("audio")||/\.(mp3|wav|ogg|flac|aac|m4a)$/.test(n)?Ke.audio:a.includes("video")||/\.(mp4|avi|mov|mkv|webm|wmv)$/.test(n)?Ke.video:a.includes("word")||a.includes("document")||/\.(doc|docx|odt|rtf)$/.test(n)?Ke.document:a.includes("sheet")||a.includes("excel")||/\.(xls|xlsx|csv|ods)$/.test(n)?Ke.spreadsheet:/\.(js|ts|py|java|cpp|c|h|html|css|json|xml|sol|rs|go|php|rb)$/.test(n)?Ke.code:a.includes("zip")||a.includes("archive")||/\.(zip|rar|7z|tar|gz)$/.test(n)?Ke.archive:Ke.default}function Lc(e){if(!e)return"";let t;if(typeof e=="number")t=new Date(e>1e12?e:e*1e3);else if(typeof e=="string")t=new Date(e);else if(e!=null&&e.toDate)t=e.toDate();else if(e!=null&&e.seconds)t=new Date(e.seconds*1e3);else return"";if(isNaN(t.getTime()))return"";const a=new Date,n=a-t,i=Math.floor(n/6e4),s=Math.floor(n/36e5),r=Math.floor(n/864e5);return i<1?"Just now":i<60?`${i}m`:s<24?`${s}h`:r<7?`${r}d`:t.toLocaleDateString("en-US",{month:"short",day:"numeric",year:t.getFullYear()!==a.getFullYear()?"numeric":void 0})}function hs(e){if(!e)return"";const t=typeof e=="number"?new Date(e>1e12?e:e*1e3):new Date(e);return isNaN(t.getTime())?"":t.toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"2-digit",minute:"2-digit"})}function vs(e){return e?`${e.slice(0,6)}...${e.slice(-4)}`:""}function Rc(e){return e?e.startsWith("https://")?e:e.startsWith("ipfs://")?`${ti[0]}${e.replace("ipfs://","")}`:`${ti[0]}${e}`:""}function ws(e){return e<1024?`${e} B`:e<1048576?`${(e/1024).toFixed(1)} KB`:`${(e/1048576).toFixed(2)} MB`}function x0(e,t){E.viewHistory.push({view:E.view,data:E.selectedCert}),E.view=e,t&&(E.selectedCert=t),de(),ia()}function _c(){const e=E.viewHistory.pop();e?(E.view=e.view,E.activeTab=e.view==="cert-detail"?"documents":e.view,E.selectedCert=e.data):(E.view="documents",E.activeTab="documents"),de(),ia()}function h0(e){E.activeTab===e&&E.view===e||(E.viewHistory=[],E.view=e,E.activeTab=e,de(),ia())}function v0(){if(document.getElementById("notary-styles-v10"))return;const e=document.createElement("style");e.id="notary-styles-v10",e.textContent=`
        :root {
            --nt-bg:       #0c0c0e;
            --nt-bg2:      #141417;
            --nt-bg3:      #1c1c21;
    ...
    `,ia(),de(),Promise.all([S0(),ys(),L0()]).catch(()=>{}))}function ia(){var t;const e=document.getElementById("nt-header");if(e){if(E.view==="cert-detail"){e.innerHTML=`
    ...
    `}}function de(){const e=document.getElementById("nt-content");if(e)switch(E.view){case"documents":wr(e);break;case"notarize":k0(e);break;case"verify":P0(e);break;case"stats":B0(e);break;case"cert-detail":N0(e);break;default:wr(e)}}function wr(e){if(!c.isConnected){e.innerHTML=`
    ...
    `}function y0(e){var s,r;const t=Rc(e.ipfs),a=Sa(e.mimeType||"",e.description||e.fileName||""),n=Lc(e.timestamp),i=((s=e.description)==null?void 0:s.split("---")[0].trim().split(`
`)[0].trim())||"Notarized Document";return`
    ...
    `;const t=document.getElementById("nt-wiz-panel");if(t)switch(E.wizStep){case 1:T0(t);break;case 2:Fc(t);break;case 3:I0(t);break}}function E0(){const e=E.wizStep;return`
        <div class="nt-steps">
    ...
    `}function T0(e){if(E.wizFile&&E.wizFileHash){const t=E.wizFile,a=Sa(t.type,t.name),n=E.wizDuplicateCheck;e.innerHTML=`
            ...
            <div style="background:var(--nt-bg3);border:1px solid var(--nt-border);border-radius:var(--nt-radius);padding:16px;margin-bottom:16px">
                <div style="display:flex;align-items:center;gap:14px">
                    ...
                    <div style="flex:1;min-width:0">
                        ...
                        <div style="font-size:11px;color:var(--nt-text-3)">${ws(t.size)} &bull; ${a.label}</div>
                    </div>
            ...
            `:n!=null&&n.exists?`
                <div class="nt-duplicate-warn" style="margin-bottom:16px">
                    ...
                    <div style="font-size:12px;color:var(--nt-text-2);line-height:1.5">
                        ...
                        Owner: <span style="font-family:monospace;font-size:11px">${vs(n.owner)}</span><br>
                        Date: ${hs(n.timestamp)}
                    </div>
                </div>
            `:`
        ...
        <div style="max-width:420px;margin:0 auto">
            ...
            <div style="background:var(--nt-bg3);border:1px solid var(--nt-border);border-radius:var(--nt-radius);padding:12px;margin-bottom:16px;display:flex;align-items:center;gap:12px">
                ...
                <div style="flex:1;min-width:0">
                    ...
                    <div style="font-size:10px;color:var(--nt-text-3)">${ws((t==null?void 0:t.size)||0)}</div>
                </div>
            </div>
            ...
            <div class="nt-fee-box" style="margin-bottom:16px">
                ...
                ${o?"":`<div style="font-size:11px;color:var(--nt-red);margin-top:8px"><i class="fa-solid fa-circle-xmark" style="margin-right:4px"></i>Insufficient BKC balance (${F(s)} BKC)</div>`}
    ...
    `}function I0(e){const t=E.wizFile,a=Sa((t==null?void 0:t.type)||"",(t==null?void 0:t.name)||""),n=E.wizDescription||"No description",i=ne?ne.formatEther(E.bkcFee):"1",s=ne?ne.formatEther(E.ethFee):"0.0001";e.innerHTML=`
            ...
            <div style="background:var(--nt-bg3);border:1px solid var(--nt-border);border-radius:var(--nt-radius);padding:16px;text-align:left;margin-bottom:16px">
                <div style="display:flex;align-items:center;gap:12px;padding-bottom:12px;border-bottom:1px solid var(--nt-border);margin-bottom:12px">
                    ...
                    <div style="flex:1;min-width:0">
                        ...
                        <div style="font-size:11px;color:var(--nt-text-3)">${ws((t==null?void 0:t.size)||0)}</div>
                    </div>
                </div>
    ...
    `}async function A0(){if(E.isProcessing)return;E.isProcessing=!0,E.processStep="SIGNING";const e=document.getElementById("nt-btn-mint");e&&(e.disabled=!0,e.innerHTML='<i class="fa-solid fa-spinner fa-spin" style="margin-right:6px"></i>Signing...'),document.getElementById("nt-overlay"),Ya("signing");try{const n=await(await c.provider.getSigner()).signMessage("I am signing to authenticate my file for notarization on Backchain.");E.processStep="UPLOADING",Ya("uploading");const i=new FormData;i.append("file",E.wizFile),i.append("signature",n),i.append("address",c.userAddress),i.append("description",E.wizDescription||"No description");const s=Ue.uploadFileToIPFS||"/api/upload",r=await fetch(s,{method:"POST",body:i,signal:AbortSignal.timeout(18e4)});if(!r.ok)throw r.status===413?new Error("File too large (max 5MB)"):r.status===401?new Error("Signature verification failed"):new Error(`Upload failed (${r.status})`);const o=await r.json(),l=o.ipfsUri||o.metadataUri,d=o.contentHash||E.wizFileHash;if(!l)throw new Error("No IPFS URI returned");if(!d)throw new Error("No content hash returned");E.processStep="MINTING",Ya("minting"),await Xe.notarize({ipfsCid:l,contentHash:d,description:E.wizDescription||"No description",operator:Q(),button:e,onSuccess:(u,f,p)=>{E.processStep="SUCCESS",Ya("success",f),setTimeout(()=>{Xn(),E.wizFile=null,E.wizFileHash=null,E.wizDescription="",E.wizDuplicateCheck=null,E.wizStep=1,E.isProcessing=!1,E.view="documents",E.activeTab="documents",ia(),de(),ys(),x("Document notarized successfully!","success")},3e3)},onError:u=>{if(u.cancelled||u.type==="user_rejected"){E.isProcessing=!1,Xn(),e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-stamp" style="margin-right:6px"></i>Sign & Mint');return}throw u}})}catch(t){console.error("[NotaryPage] Mint error:",t),Xn(),E.isProcessing=!1,e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-stamp" style="margin-right:6px"></i>Sign & Mint'),t.code!==4001&&t.code!=="ACTION_REJECTED"&&x(t.message||"Notarization failed","error")}}function Ya(e,t){const a=document.getElementById("nt-overlay");if(!a)return;a.classList.add("active");const n={signing:{icon:"fa-solid fa-signature",text:"Signing message...",sub:"Confirm in MetaMask",pct:10},uploading:{icon:"fa-solid fa-cloud-arrow-up",text:"Uploading to IPFS...",sub:"Decentralized storage",pct:35},minting:{icon:"fa-solid fa-stamp",text:"Minting on Blockchain...",sub:"Waiting for confirmation",pct:65,animate:!0},success:{icon:"fa-solid fa-check",text:"Notarized!",sub:t?`Token ID #${t}`:"Certificate created",pct:100,success:!0}},i=n[e]||n.signing;if(a.innerHTML=`
    ...
    `,!document.getElementById("nt-spin-kf")){const s=document.createElement("style");s.id="nt-spin-kf",s.textContent="@keyframes nt-spin { to { transform: rotate(360deg); } }",document.head.appendChild(s)}}function Xn(){const e=document.getElementById("nt-overlay");e&&e.classList.remove("active")}function P0(e){e.innerHTML=`
        <div class="nt-card" style="margin-top:16px">
            <div style="text-align:center;margin-bottom:20px">
    ...
    `,z0(),E.verifyResult&&Mc()}function z0(){const e=document.getElementById("nt-verify-dropzone"),t=document.getElementById("nt-verify-file-input");!e||!t||(e.onclick=()=>t.click(),["dragenter","dragover","dragleave","drop"].forEach(a=>{e.addEventListener(a,n=>{n.preventDefault(),n.stopPropagation()})}),e.addEventListener("dragenter",()=>e.classList.add("drag-over")),e.addEventListener("dragover",()=>e.classList.add("drag-over")),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",a=>{var n,i;e.classList.remove("drag-over"),kr((i=(n=a.dataTransfer)==null?void 0:n.files)==null?void 0:i[0])}),t.addEventListener("change",a=>{var n;return kr((n=a.target.files)==null?void 0:n[0])}))}async function kr(e){if(!e)return;E.verifyFile=e,E.verifyHash=null,E.verifyResult=null,E.verifyIsChecking=!0;const t=document.getElementById("nt-verify-result");t&&(t.innerHTML=`
        ...
        `);try{const a=await Xe.calculateFileHash(e);E.verifyHash=a;const n=await Xe.verifyByHash(a);E.verifyResult=n,E.verifyIsChecking=!1,Mc()}catch(a){console.error("[NotaryPage] Verify error:",a),E.verifyIsChecking=!1,t&&(t.innerHTML=`
            ...
            `)}}function Mc(){const e=document.getElementById("nt-verify-result");if(!e||!E.verifyResult)return;const t=E.verifyResult,a=E.verifyFile;t.exists?e.innerHTML=`
            <div class="nt-verified">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:12px">
                    ...
                    <div style="background:rgba(0,0,0,0.2);border-radius:var(--nt-radius-sm);padding:10px">
                        ...
                        <div style="font-size:13px;font-weight:600;color:var(--nt-text)">${hs(t.timestamp)}</div>
                    </div>
                </div>
                ...
                <div style="margin-top:12px;display:flex;gap:8px">
                    <a href="${xs}${v==null?void 0:v.notary}?a=${t.tokenId}" target="_blank" class="nt-btn-secondary" style="font-size:12px;padding:8px 14px;text-decoration:none;display:inline-flex;align-items:center;gap:6px">
        ...
        <div style="margin-top:16px">
                    ...
                    `:E.recentNotarizations.map(n=>`
                        <div class="nt-recent-item">
                            ...
                            <div style="flex:1;min-width:0">
                                ...
                                <div style="font-size:11px;color:var(--nt-text-3)">${vs(n.owner)}</div>
                            </div>
                            <div style="text-align:right;flex-shrink:0">
                                <div style="font-size:11px;color:var(--nt-text-3)">${Lc(n.timestamp)}</div>
                            </div>
                        </div>
                    `).join("")}
                </div>
            ...
            <div style="text-align:center;margin-top:16px">
                <a href="${xs}${v==null?void 0:v.notary}" target="_blank" class="nt-btn-secondary" style="font-size:12px;padding:10px 20px;text-decoration:none;display:inline-flex;align-items:center;gap:6px">
                    <i class="fa-solid fa-arrow-up-right-from-square"></i>View Contract on Arbiscan
                </a>
            </div>
        </div>
    `}function N0(e){var i;const t=E.selectedCert;if(!t){_c();return}const a=Rc(t.ipfs),n=Sa(t.mimeType||"",t.description||"");(t.mimeType||"").includes("image")||/\.(jpg|jpeg|png|gif|webp|svg|bmp)$/i.test(t.fileName||t.description||""),e.innerHTML=`
        <div class="nt-detail" style="margin-top:8px">
            ...
            <div class="nt-detail-meta" style="margin-bottom:12px">
                <div class="nt-card" style="padding:14px">
                    ...
                    <div style="font-size:13px;font-weight:600;color:var(--nt-text)">${hs(t.timestamp)||"N/A"}</div>
                </div>
                <div class="nt-card" style="padding:14px">
                    <div style="font-size:10px;color:var(--nt-text-3);text-transform:uppercase;letter-spacing:0.05em;margin-bottom:4px">Owner</div>
                    <div style="font-size:12px;font-family:monospace;color:var(--nt-text-2)">${vs(t.owner||c.userAddress)}</div>
                </div>
            </div>
            ...
            <div style="display:flex;flex-wrap:wrap;gap:8px;margin-top:8px">
                ...
                `:""}
                <a href="${xs}${v==null?void 0:v.notary}?a=${t.id}" target="_blank" class="nt-btn-secondary" style="text-decoration:none;display:inline-flex;align-items:center;gap:6px;font-size:12px">
                    <i class="fa-solid fa-arrow-up-right-from-square"></i>View on Arbiscan
                </a>
                ${t.txHash?`
    ...
    `}async function S0(){try{const e=await Xe.getFee();E.bkcFee=e.bkcFee,E.ethFee=e.ethFee,E.feesLoaded=!0}catch{E.bkcFee=(ne==null?void 0:ne.parseEther("1"))||0n,E.ethFee=(ne==null?void 0:ne.parseEther("0.0001"))||0n,E.feesLoaded=!0}}async function ys(){if(!c.isConnected||!c.userAddress)return;E.certsLoading=!0,de();let e=!1;try{const t=Ue.getNotaryHistory;console.log("[NotaryPage] Loading certificates from API:",`${t}/${c.userAddress}`);const a=await fetch(`${t}/${c.userAddress}`);if(!a.ok)throw new Error(`API ${a.status}`);const n=await a.json();console.log("[NotaryPage] API response:",typeof n,Array.isArray(n)?`array(${n.length})`:JSON.stringify(n).substring(0,200));const i=Array.isArray(n)?n:Array.isArray(n==null?void 0:n.documents)?n.documents:Array.isArray(n==null?void 0:n.data)?n.data:Array.isArray(n==null?void 0:n.history)?n.history:null;i&&i.length>0&&(E.certificates=i.map(s=>({id:s.tokenId||s.id||"?",ipfs:s.ipfsCid||s.ipfsUri||"",description:s.description||"",hash:s.contentHash||"",timestamp:s.createdAt||s.timestamp||"",txHash:s.txHash||s.transactionHash||"",owner:s.owner||c.userAddress,mimeType:s.mimeType||"",fileName:s.fileName||""})).sort((s,r)=>parseInt(r.id)-parseInt(s.id)),e=!0,console.log("[NotaryPage] Loaded",E.certificates.length,"certificates from API"))}catch(t){console.warn("[NotaryPage] API failed:",t.message)}if(!e){console.log("[NotaryPage] Trying on-chain event fallback...");try{const t=await $0();E.certificates=t,console.log("[NotaryPage] Loaded",t.length,"certificates from chain events")}catch(t){console.error("[NotaryPage] Chain fallback also failed:",t),E.certificates=[]}}E.certsLoading=!1,de()}async function $0(){if(!ne||!(v!=null&&v.notary))return console.warn("[NotaryPage] Chain fallback: missing ethers or contract address"),[];const{NetworkManager:e}=await K(async()=>{const{NetworkManager:o}=await import("./index-CalnOfTr.js");return{NetworkManager:o}},[]),t=e.getProvider();if(!t)return console.warn("[NotaryPage] Chain fallback: no provider available"),[];console.log("[NotaryPage] Querying Certified events for:",c.userAddress);const a=new ne.Contract(v.notary,$c,t),n=a.filters.Certified(null,c.userAddress),i=await t.getBlockNumber(),s=Math.max(0,i-5e5);console.log("[NotaryPage] Block range:",s,"->",i);const r=await a.queryFilter(n,s,i);return console.log("[NotaryPage] Found",r.length,"events"),r.map(o=>({id:Number(o.args.certId),hash:o.args.documentHash||"",docType:Number(o.args.docType||0),timestamp:null,txHash:o.transactionHash,owner:o.args.owner})).sort((o,l)=>l.id-o.id)}async function L0(){E.statsLoading=!0;try{const[e,t]=await Promise.all([Xe.getStats(),Xe.getTotalDocuments()]);E.stats=e,E.totalSupply=t}catch(e){console.warn("[NotaryPage] Stats load error:",e)}try{await R0()}catch{}E.statsLoading=!1,E.view==="stats"&&de()}async function R0(){if(!ne||!(v!=null&&v.notary))return;const{NetworkManager:e}=await K(async()=>{const{NetworkManager:l}=await import("./index-CalnOfTr.js");return{NetworkManager:l}},[]),t=e.getProvider();if(!t)return;const a=new ne.Contract(v.notary,$c,t),n=a.filters.Certified(),i=await t.getBlockNumber(),s=Math.max(0,i-5e4),o=(await a.queryFilter(n,s,i)).slice(-20).reverse();E.recentNotarizations=o.map(l=>({tokenId:Number(l.args.certId),owner:l.args.owner,hash:l.args.documentHash,docType:Number(l.args.docType||0),timestamp:null,blockNumber:l.blockNumber}));try{const l=[...new Set(o.map(u=>u.blockNumber))],d={};await Promise.all(l.slice(0,10).map(async u=>{const f=await t.getBlock(u);f&&(d[u]=f.timestamp)})),E.recentNotarizations.forEach(u=>{d[u.blockNumber]&&(u.timestamp=d[u.blockNumber])})}catch{}}async function _0(e,t){var a,n;try{const i=l=>{var u;if(!l)return"";if(l.startsWith("https://")&&!l.includes("/ipfs/"))return l;const d=l.startsWith("ipfs://")?l.replace("ipfs://",""):l.includes("/ipfs/")?(u=l.split("/ipfs/")[1])==null?void 0:u.split("?")[0]:"";return d?`${ti[0]}${d}`:l};let s=i(t||"");if(c.notaryContract)try{const l=await c.notaryContract.tokenURI(e);if(l!=null&&l.startsWith("data:application/json;base64,")){const d=JSON.parse(atob(l.replace("data:application/json;base64,","")));d.image&&(s=i(d.image))}}catch{}const r=(v==null?void 0:v.notary)||((a=c.notaryContract)==null?void 0:a.target)||((n=c.notaryContract)!=null&&n.getAddress?await c.notaryContract.getAddress():null);if(!r){x("Contract address not found","error");return}x(`Adding NFT #${e} to wallet...`,"info"),await window.ethereum.request({method:"wallet_watchAsset",params:{type:"ERC721",options:{address:r,tokenId:String(e),image:s}}})&&x(`NFT #${e} added to wallet!`,"success")}catch(i){if(i.code===4001)return;x("Could not add NFT","error")}}function F0(e){e&&navigator.clipboard.writeText(e).then(()=>{x("Hash copied!","success")}).catch(()=>{x("Failed to copy","error")})}function M0(){var e;E.wizStep===1&&E.wizFileHash&&!((e=E.wizDuplicateCheck)!=null&&e.exists)?E.wizStep=2:E.wizStep===2&&(E.wizStep=3),de()}function D0(){E.wizStep>1&&(E.wizStep--,de())}function O0(){const e=document.getElementById("nt-wiz-desc");e&&(E.wizDescription=e.value||""),E.wizStep=3,de()}function H0(){E.wizFile=null,E.wizFileHash=null,E.wizDuplicateCheck=null,E.wizStep=1,de()}function U0(e){const t=E.certificates.find(a=>String(a.id)===String(e));t&&x0("cert-detail",t)}const Dc={async render(e){e&&w0()},reset(){E.wizFile=null,E.wizFileHash=null,E.wizDescription="",E.wizDuplicateCheck=null,E.wizStep=1,E.view="documents",E.activeTab="documents",E.viewHistory=[],de(),ia()},update(){if(!E.isProcessing&&E.view==="notarize"){const e=document.getElementById("nt-wiz-panel");e&&E.wizStep===2&&Fc(e)}},refreshHistory(){ys()},setTab:h0,goBack:_c,viewCert:U0,handleMint:A0,addToWallet:_0,copyHash:F0,wizNext:M0,wizBack:D0,wizToStep3:O0,wizRemoveFile:H0};window.NotaryPage=Dc;const An=window.ethers,Er=24*60*60,vi={Diamond:{emoji:"💎",color:"#22d3ee",bg:"rgba(34,211,238,0.15)",border:"rgba(34,211,238,0.3)",keepRate:100,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeicgip72jcqgsirlrhn3tq5cc226vmko6etnndzl6nlhqrktfikafq"},Gold:{emoji:"🥇",color:"#fbbf24",bg:"rgba(251,191,36,0.15)",border:"rgba(251,191,36,0.3)",keepRate:90,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeifponccrbicg2pcjrn2hrfoqgc77xhm2r4ld7hdpw6cxxkbsckf44"},Silver:{emoji:"🥈",color:"#9ca3af",bg:"rgba(156,163,175,0.15)",border:"rgba(156,163,175,0.3)",keepRate:75,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeihvi2inujm5zpi7tl667g4srq273536pjkglwyrtbwmgnskmu7jg4"},Bronze:{emoji:"🥉",color:"#fb923c",bg:"rgba(251,146,60,0.15)",border:"rgba(251,146,60,0.3)",keepRate:60,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeiclqidb67rt3tchhjpsib62s624li7j2bpxnr6b5w5mfp4tomhu7m"}},R={activeTab:"marketplace",filterTier:"ALL",sortBy:"featured",selectedListing:null,isLoading:!1,isTransactionPending:!1,countdownIntervals:[],promotions:new Map},Re=e=>e==null?"":String(e),j0=(e,t)=>Re(e)===Re(t),Ta=(e,t)=>e&&t&&e.toLowerCase()===t.toLowerCase();function $a(e){return me.find(t=>t.boostBips===Number(e))||{name:"Unknown",boostBips:0}}function Pn(e){return vi[e]||{emoji:"💎",color:"#71717a",bg:"rgba(113,113,122,0.15)",border:"rgba(113,113,122,0.3)",keepRate:50}}function Oc(e){const t=e-Math.floor(Date.now()/1e3);if(t<=0)return{text:"Expired",expired:!0,seconds:0};const a=Math.floor(t/3600),n=Math.floor(t%3600/60),i=t%60;return a>0?{text:`${a}h ${n}m`,expired:!1,seconds:t}:n>0?{text:`${n}m ${i}s`,expired:!1,seconds:t}:{text:`${i}s`,expired:!1,seconds:t}}function W0(e){const t=Math.floor(Date.now()/1e3),a=e-t;if(a<=0)return null;const n=Math.floor(a/3600),i=Math.floor(a%3600/60);return n>0?`${n}h ${i}m`:`${i}m`}function Hc(e){if(e.lastRentalEndTime)return Number(e.lastRentalEndTime)+Er;if(e.rentalEndTime&&!e.isRented){const t=Number(e.rentalEndTime),a=Math.floor(Date.now()/1e3);if(t<a)return t+Er}return null}function Tr(e){const t=Math.floor(Date.now()/1e3),a=Hc(e);return a&&a>t}function Cr(e){const t=Math.floor(Date.now()/1e3);if(!e.lastRentalEndTime&&!e.rentalEndTime)return e.createdAt?t-Number(e.createdAt):Number.MAX_SAFE_INTEGER;const a=e.lastRentalEndTime?Number(e.lastRentalEndTime):e.rentalEndTime?Number(e.rentalEndTime):0;return a>t?0:t-a}function G0(){if(document.getElementById("rental-styles-v6"))return;const e=document.createElement("style");e.id="rental-styles-v6",e.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(e)}function wi(){const e=document.getElementById("rental");if(!e)return;G0();const t=c.rentalListings||[],a=t.filter(s=>c.isConnected&&Ta(s.owner,c.userAddress)),n=Math.floor(Date.now()/1e3),i=(c.myRentals||[]).filter(s=>Ta(s.tenant,c.userAddress)&&Number(s.endTime)>n);e.innerHTML=`
        ...
        ${Z0()}
        ${Q0()}
    `,eg(),ga()}function K0(){return c.isConnected?`
    ...
    `:`
        ...
        `}function ga(){const e=document.getElementById("tab-content");if(e){switch(R.activeTab){case"marketplace":e.innerHTML=Y0();break;case"my-listings":e.innerHTML=V0();break;case"my-rentals":e.innerHTML=q0();break}document.getElementById("header-stats").innerHTML=K0(),R.activeTab==="my-rentals"&&rg()}}function Y0(){const e=c.rentalListings||[],t=Math.floor(Date.now()/1e3);let a=e.filter(n=>!(n.isRented||n.rentalEndTime&&Number(n.rentalEndTime)>t||R.filterTier!=="ALL"&&$a(n.boostBips).name!==R.filterTier));return a.sort((n,i)=>{const s=BigInt(n.promotionFee||"0")||R.promotions.get(Re(n.tokenId))||0n,r=BigInt(i.promotionFee||"0")||R.promotions.get(Re(i.tokenId))||0n,o=Tr(n),l=Tr(i);if(!o&&l)return-1;if(o&&!l||r>s)return 1;if(r<s)return-1;if(R.sortBy==="featured"){const f=Cr(n),p=Cr(i);if(p!==f)return p-f}const d=BigInt(n.pricePerHour||0),u=BigInt(i.pricePerHour||0);return R.sortBy==="price-low"?d<u?-1:1:R.sortBy==="price-high"?d>u?-1:1:(i.boostBips||0)-(n.boostBips||0)}),`
        <div>
            <!-- Filters & Sort -->
            ...
            <!-- NFT Grid -->
            ${a.length===0?ks("No NFTs Available","Be the first to list your NFT!"):`
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 nft-grid">
                    ${a.map((n,i)=>Uc(n,i)).join("")}
                </div>
            `}
        </div>
    `}function Uc(e,t){const a=$a(e.boostBips),n=Pn(a.name),i=F(BigInt(e.pricePerHour||0)).toFixed(2),s=Re(e.tokenId),r=c.isConnected&&Ta(e.owner,c.userAddress),o=Hc(e),l=Math.floor(Date.now()/1e3),d=o&&o>l,u=d?W0(o):null,f=BigInt(e.promotionFee||"0")||R.promotions.get(s)||0n,p=f>0n,g=p?parseFloat(An.formatEther(f)).toFixed(3):"0",b=pt(e.boostBips||0);return`
    ...
    `}function V0(){if(!c.isConnected)return jc("View your listings");const e=c.rentalListings||[],t=e.filter(s=>Ta(s.owner,c.userAddress)),a=new Set(e.map(s=>Re(s.tokenId))),n=(c.myBoosters||[]).filter(s=>!a.has(Re(s.tokenId)));return`
        <div>
            <!-- Earnings Card -->
            ...
            <!-- My Listed NFTs -->
            ${t.length===0?ks("No Listings Yet","List your first NFT to start earning!"):`
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 nft-grid">
                    ${t.map((s,r)=>Uc(s,r)).join("")}
                </div>
            `}
        </div>
    `}function q0(){if(!c.isConnected)return jc("View your active rentals");const e=Math.floor(Date.now()/1e3),t=(c.myRentals||[]).filter(a=>Ta(a.tenant,c.userAddress)&&Number(a.endTime)>e);return`
        <div>
            <!-- Info Card -->
            ...
            <!-- Active Rentals -->
            ${t.length===0?ks("No Active Rentals","Rent an NFT to reduce your claim burn rate!"):`
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    ${t.map((a,n)=>X0(a,n)).join("")}
                </div>
            `}
        </div>
    `}function X0(e,t){const a=$a(e.boostBips),n=Pn(a.name),i=Oc(Number(e.endTime)),s=pt(e.boostBips||0);let r="active";return i.seconds<3600?r="critical":i.seconds<7200&&(r="warning"),`
                ...
                <div class="p-5 space-y-5">
                    <div>
                        ...
                        <select id="list-select" class="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-4 py-3 text-white outline-none">
                            ...
                            ${(c.myBoosters||[]).filter(n=>!t.has(Re(n.tokenId))).map(n=>{const i=$a(n.boostBips),s=Pn(i.name);return`<option value="${n.tokenId}">${s.emoji} ${i.name} Booster #${n.tokenId}</option>`}).join("")}
                        </select>
                    </div>
                    <div>
    ...
    `}function eg(){document.addEventListener("click",e=>{const t=e.target.closest(".rental-tab");if(t){R.activeTab=t.dataset.tab,document.querySelectorAll(".rental-tab").forEach(r=>r.classList.remove("active")),t.classList.add("active"),ga();return}const a=e.target.closest(".filter-chip");if(a){R.filterTier=a.dataset.filter,ga();return}if(e.target.closest("#btn-open-list")){Wc();return}const n=e.target.closest(".rent-btn");if(n&&!n.disabled){tg(n.dataset.id);return}const i=e.target.closest(".withdraw-btn");if(i){Vc(i);return}const s=e.target.closest(".promote-btn");if(s){ag(s.dataset.id);return}}),document.addEventListener("change",e=>{e.target.id==="sort-select"&&(R.sortBy=e.target.value,ga())})}function Wc(){document.getElementById("modal-list").classList.add("active")}function Gc(){document.getElementById("modal-list").classList.remove("active")}function tg(e){const t=(c.rentalListings||[]).find(r=>j0(r.tokenId,e));if(!t)return;R.selectedListing=t;const a=$a(t.boostBips),n=Pn(a.name),i=F(BigInt(t.pricePerHour||0)),s=pt(t.boostBips||0);document.getElementById("rent-modal-content").innerHTML=`
    ...
    `,document.getElementById("rent-hours").addEventListener("input",r=>{const o=parseInt(r.target.value)||1,l=Number(i)*o;document.querySelector("#rent-total span:last-child").textContent=`${l.toFixed(2)} BKC`}),document.getElementById("modal-rent").classList.add("active")}function Kc(){document.getElementById("modal-rent").classList.remove("active"),R.selectedListing=null}function ag(e){document.getElementById("promote-token-id").value=e,document.getElementById("promote-amount").value="",document.getElementById("modal-promote").classList.add("active")}function Yc(){document.getElementById("modal-promote").classList.remove("active")}async function ng(){if(R.isTransactionPending||!R.selectedListing)return;const e=parseInt(document.getElementById("rent-hours").value)||1,t=Re(R.selectedListing.tokenId),a=document.getElementById("confirm-rent");R.isTransactionPending=!0;try{await Na.rent({tokenId:t,hours:e,button:a,onSuccess:async()=>{R.isTransactionPending=!1,Kc(),x("🎉 NFT Rented Successfully!","success"),await qt()},onError:n=>{R.isTransactionPending=!1,!n.cancelled&&n.type!=="user_rejected"&&x("Failed: "+(n.message||"Error"),"error")}})}catch(n){R.isTransactionPending=!1,!n.cancelled&&n.type!=="user_rejected"&&x("Failed: "+(n.message||"Error"),"error")}}async function ig(){var n;if(R.isTransactionPending)return;const e=document.getElementById("list-select").value,t=document.getElementById("list-price").value;if(parseFloat((n=document.getElementById("list-promo-amount"))==null?void 0:n.value),!e){x("Select an NFT","error");return}if(!t||parseFloat(t)<=0){x("Enter valid price","error");return}const a=document.getElementById("confirm-list");R.isTransactionPending=!0;try{await Na.list({tokenId:e,pricePerHour:An.parseUnits(t,18),minHours:1,maxHours:168,button:a,onSuccess:async()=>{R.isTransactionPending=!1,Gc(),x("🏷️ NFT Listed Successfully!","success"),await qt()},onError:i=>{R.isTransactionPending=!1,!i.cancelled&&i.type!=="user_rejected"&&x("Failed: "+(i.message||"Error"),"error")}})}catch(i){R.isTransactionPending=!1,!i.cancelled&&i.type!=="user_rejected"&&x("Failed: "+(i.message||"Error"),"error")}}async function Vc(e){if(R.isTransactionPending)return;const t=e.dataset.id;if(confirm("Withdraw this NFT from marketplace?")){R.isTransactionPending=!0;try{await Na.withdraw({tokenId:t,button:e,onSuccess:async()=>{R.isTransactionPending=!1,x("↩️ NFT Withdrawn Successfully!","success"),await qt()},onError:a=>{R.isTransactionPending=!1,!a.cancelled&&a.type!=="user_rejected"&&x("Failed: "+(a.message||"Error"),"error")}})}catch(a){R.isTransactionPending=!1,!a.cancelled&&a.type!=="user_rejected"&&x("Failed: "+(a.message||"Error"),"error")}}}async function sg(){if(R.isTransactionPending)return;const e=document.getElementById("promote-token-id").value,t=document.getElementById("promote-amount").value;if(!t||parseFloat(t)<=0){x("Enter valid amount","error");return}const a=document.getElementById("confirm-promote");R.isTransactionPending=!0;try{await Na.spotlight({tokenId:e,amount:An.parseEther(t),button:a,onSuccess:async()=>{R.isTransactionPending=!1,Yc(),x("🚀 Listing Promoted!","success"),await qt()},onError:n=>{R.isTransactionPending=!1,!n.cancelled&&n.type!=="user_rejected"&&x("Failed: "+(n.message||"Error"),"error")}})}catch(n){R.isTransactionPending=!1,!n.cancelled&&n.type!=="user_rejected"&&x("Failed: "+(n.message||"Error"),"error")}}function rg(){R.countdownIntervals.forEach(clearInterval),R.countdownIntervals=[],document.querySelectorAll(".rental-timer[data-end]").forEach(e=>{const t=Number(e.dataset.end),a=setInterval(()=>{const n=Oc(t);e.innerHTML=`<i class="fa-solid fa-clock mr-1"></i>${n.text}`,n.expired?(clearInterval(a),ga()):n.seconds<3600?e.className="rental-timer critical":n.seconds<7200&&(e.className="rental-timer warning")},1e3);R.countdownIntervals.push(a)})}async function qt(){R.isLoading=!0;try{await Promise.all([Kr(),c.isConnected?iu():Promise.resolve(),c.isConnected?Ct():Promise.resolve()])}catch(e){console.warn("Refresh error:",e)}R.isLoading=!1,wi()}const qc={async render(e){e&&(wi(),await qt())},update(){wi()},refresh:qt,openListModal:Wc,closeListModal:Gc,closeRentModal:Kc,closePromoteModal:Yc,handleRent:ng,handleList:ig,handleWithdraw:Vc,handlePromote:sg};window.RentalPage=qc;const og={render:async e=>{const t=document.getElementById("socials");if(!t||!e&&t.innerHTML.trim()!=="")return;const a=`
            <style>
        ...
        `},cleanup:()=>{}},Xc=document.createElement("style");Xc.innerHTML=`
...
`;document.head.appendChild(Xc);const lg={render:async e=>{if(!e)return;const t=document.getElementById("creditcard");t&&(t.innerHTML=`
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    ...
                    <div class="glass-mockup rounded-2xl p-6 h-full flex flex-col">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="space-y-2">
                                ${oa("Starbucks Coffee","Today, 8:30 AM","- $5.40","+ 15 BKC","fa-mug-hot")}
                                ${oa("Uber Ride","Yesterday, 6:15 PM","- $24.50","+ 82 BKC","fa-car")}
                                ${oa("Netflix Subscription","Oct 24, 2025","- $15.99","+ 53 BKC","fa-film")}
                                ${oa("Amazon Purchase","Oct 22, 2025","- $142.00","+ 475 BKC","fa-box-open")}
                                ${oa("Shell Station","Oct 20, 2025","- $45.00","+ 150 BKC","fa-gas-pump")}
                            </div>
                        </div>
                    </div>
    ...
    `}function Zn(e,t,a,n,i,s,r){const o=Es[St];let l=`
        <div class="mb-10">
    ...
    `,d=r;return n.forEach(u=>{l+=dg(u,d++)}),l+="</div></div>",{html:l,nextIndex:d}}function ug(e){var t,a,n,i,s,r,o,l;St=e,localStorage.setItem("backcoin-tutorials-lang",e),(t=document.getElementById("tutorials-btn-en"))==null||t.classList.toggle("bg-amber-500",e==="en"),(a=document.getElementById("tutorials-btn-en"))==null||a.classList.toggle("text-zinc-900",e==="en"),(n=document.getElementById("tutorials-btn-en"))==null||n.classList.toggle("bg-zinc-700",e!=="en"),(i=document.getElementById("tutorials-btn-en"))==null||i.classList.toggle("text-zinc-300",e!=="en"),(s=document.getElementById("tutorials-btn-pt"))==null||s.classList.toggle("bg-amber-500",e==="pt"),(r=document.getElementById("tutorials-btn-pt"))==null||r.classList.toggle("text-zinc-900",e==="pt"),(o=document.getElementById("tutorials-btn-pt"))==null||o.classList.toggle("bg-zinc-700",e!=="pt"),(l=document.getElementById("tutorials-btn-pt"))==null||l.classList.toggle("text-zinc-300",e!=="pt"),Jc()}function Jc(){const e=document.getElementById("tutorials-content");if(!e)return;const t=Es[St];let a=`
        <!-- Hero -->
        <div class="text-center mb-10">
    ...
    `,n=Zn("getting-started","rocket","emerald",Jn.gettingStarted,"catGettingStarted","catGettingStartedDesc",0);a+=n.html,n=Zn("ecosystem","cubes","amber",Jn.ecosystem,"catEcosystem","catEcosystemDesc",n.nextIndex),a+=n.html,n=Zn("advanced","graduation-cap","cyan",Jn.advanced,"catAdvanced","catAdvancedDesc",n.nextIndex),a+=n.html,e.innerHTML=a}const Zc={render:function(e=!1){const t=document.getElementById("tutorials");t&&(e||t.innerHTML.trim()==="")&&(t.innerHTML=`
                    ...
                    <div class="flex items-center justify-between mb-8">
                        ...
                        <div class="flex items-center gap-1 bg-zinc-800 p-1 rounded-lg border border-zinc-700">
                            <button id="tutorials-btn-en" onclick="TutorialsPage.setLang('en')" 
                                    class="flex items-center gap-2 px-3 py-2 rounded-md text-xs font-bold transition-all ${St==="en"?"bg-amber-500 text-zinc-900":"bg-zinc-700 text-zinc-300 hover:bg-zinc-600"}">
                            ...
                            <button id="tutorials-btn-pt" onclick="TutorialsPage.setLang('pt')" 
                                    class="flex items-center gap-2 px-3 py-2 rounded-md text-xs font-bold transition-all ${St==="pt"?"bg-amber-500 text-zinc-900":"bg-zinc-700 text-zinc-300 hover:bg-zinc-600"}">
            ...
            `,Jc())},update:function(e){},cleanup:function(){},setLang:ug};window.TutorialsPage=Zc;const _t=window.ethers,pg={ACTIVE:0,COMPLETED:1,CANCELLED:2,WITHDRAWN:3},Ts=e=>typeof e=="number"?e:typeof e=="string"?isNaN(parseInt(e))?pg[e.toUpperCase()]??0:parseInt(e):0,Cs=e=>Ts(e.status)===0&&Number(e.deadline)>Math.floor(Date.now()/1e3),Is=["function getCampaign(uint256 _campaignId) view returns (address creator, string title, string description, uint96 goalAmount, uint96 raisedAmount, uint32 donationCount, uint64 deadline, uint64 createdAt, uint96 boostAmount, uint64 boostTime, uint8 status, bool goalReached)","function campaignCounter() view returns (uint64)","function getStats() view returns (uint64 totalCampaigns, uint256 totalRaised, uint256 totalDonations, uint256 totalFees)"],La={getCampaigns:"https://getcharitycampaigns-4wvdcuoouq-uc.a.run.app",saveCampaign:"https://savecharitycampaign-4wvdcuoouq-uc.a.run.app",uploadImage:"/api/upload-image"},Qc="https://sepolia.arbiscan.io/address/",cn={animal:"https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=800&q=80",humanitarian:"https://images.unsplash.com/photo-1469571486292-0ba58a3f068b?w=800&q=80",default:"https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?w=800&q=80"},Pe={animal:{name:"Animal Welfare",emoji:"🐾",color:"#10b981",gradient:"from-emerald-500/20 to-green-600/20"},humanitarian:{name:"Humanitarian Aid",emoji:"💗",color:"#ec4899",gradient:"from-pink-500/20 to-rose-600/20"}},Ir={0:{label:"Active",color:"#10b981",icon:"fa-circle-play",bg:"bg-emerald-500/15"},1:{label:"Ended",color:"#3b82f6",icon:"fa-circle-check",bg:"bg-blue-500/15"},2:{label:"Cancelled",color:"#ef4444",icon:"fa-circle-xmark",bg:"bg-red-500/15"},3:{label:"Completed",color:"#8b5cf6",icon:"fa-circle-dollar-to-slot",bg:"bg-purple-500/15"}},ed=5*1024*1024,td=["image/jpeg","image/png","image/gif","image/webp"],k={campaigns:[],stats:null,currentView:"main",currentCampaign:null,selectedCategory:null,isLoading:!1,pendingImage:null,pendingImageFile:null,editingCampaign:null,createStep:1,createCategory:null,createTitle:"",createDesc:"",createGoal:"",createDuration:"",createImageFile:null,createImageUrl:"",createImagePreview:null};function fg(){if(document.getElementById("charity-styles-v6"))return;const e=document.createElement("style");e.id="charity-styles-v6",e.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(e)}const Ce=e=>{try{const t=Number(e)/1e18;return t<1e-4?"0":t<1?t.toFixed(4):t<1e3?t.toFixed(2):t.toLocaleString("en-US",{maximumFractionDigits:2})}catch{return"0"}},ad=e=>e?`${e.slice(0,6)}...${e.slice(-4)}`:"",Ra=(e,t)=>{const a=Number(e||0),n=Number(t||1);return Math.min(100,Math.round(a/n*100))},nd=e=>{const t=Math.floor(Date.now()/1e3),a=Number(e)-t;if(a<=0)return{text:"Ended",color:"#ef4444"};const n=Math.floor(a/86400);return n>0?{text:`${n}d left`,color:"#10b981"}:{text:`${Math.floor(a/3600)}h left`,color:"#f59e0b"}},zn=e=>(e==null?void 0:e.imageUrl)||cn[e==null?void 0:e.category]||cn.default,id=e=>`${window.location.origin}${window.location.pathname}#charity/${e}`,sd=()=>{const t=window.location.hash.match(/#charity\/(\d+)/);return t?t[1]:null},mg=e=>{window.location.hash=`charity/${e}`},gg=()=>{window.location.hash.startsWith("#charity/")&&(window.location.hash="charity")},rd=e=>{const t=Ts(e.status),a=Number(e.deadline)<=Math.floor(Date.now()/1e3);return(t===0||t===1)&&a&&!e.withdrawn&&BigInt(e.raisedAmount||0)>0n},od="charity-meta-";function As(e,t){try{localStorage.setItem(`${od}${e}`,JSON.stringify(t))}catch{}}function ld(e){try{return JSON.parse(localStorage.getItem(`${od}${e}`)||"null")}catch{return null}}async function bt(){k.isLoading=!0;try{const[e,t]=await Promise.all([fetch(La.getCampaigns).then(i=>i.json()).catch(()=>({campaigns:[]})),bg()]),a=(e==null?void 0:e.campaigns)||[],n=c==null?void 0:c.publicProvider;if(n){const i=new _t.Contract(v.charityPool,Is,n),s=await i.campaignCounter(),r=Number(s),o=await Promise.all(Array.from({length:r},(l,d)=>d+1).map(async l=>{try{const d=await i.getCampaign(l),u=a.find(p=>String(p.id)===String(l)),f=ld(l);return{id:String(l),creator:d.creator||d[0],title:(u==null?void 0:u.title)||d.title||d[1]||`Campaign #${l}`,description:(u==null?void 0:u.description)||d.description||d[2]||"",goalAmount:BigInt((d.goalAmount||d[3]).toString()),raisedAmount:BigInt((d.raisedAmount||d[4]).toString()),donationCount:Number(d.donationCount||d[5]),deadline:Number(d.deadline||d[6]),createdAt:Number(d.createdAt||d[7]),status:Number(d.status||d[10]),category:(u==null?void 0:u.category)||(f==null?void 0:f.category)||"humanitarian",imageUrl:(u==null?void 0:u.imageUrl)||(f==null?void 0:f.imageUrl)||null}}catch{return null}}));k.campaigns=o.filter(Boolean)}k.stats=t}catch(e){console.error("Load data:",e)}finally{k.isLoading=!1}}async function bg(){try{const e=c==null?void 0:c.publicProvider;if(!e)return null;const a=await new _t.Contract(v.charityPool,Is,e).getStats();return{raised:a.totalRaised??a[1],fees:a.totalFees??a[3],created:Number(a.totalCampaigns??a[0]),donations:Number(a.totalDonations??a[2])}}catch{return null}}function xg(e,t="create"){var i;const a=(i=e.target.files)==null?void 0:i[0];if(!a)return;if(!td.includes(a.type)){x("Please select a valid image (JPG, PNG, GIF, WebP)","error");return}if(a.size>ed){x("Image must be less than 5MB","error");return}k.pendingImageFile=a;const n=new FileReader;n.onload=s=>{const r=t==="edit"?"edit-image-preview":"create-image-preview",o=document.getElementById(t==="edit"?"edit-image-upload":"create-image-upload"),l=document.getElementById(r);l&&(l.innerHTML=`
            ...
            `),o&&o.classList.add("has-image")},n.readAsDataURL(a)}function hg(e="create"){k.pendingImageFile=null,k.pendingImage=null;const t=e==="edit"?"edit-image-preview":"create-image-preview",a=document.getElementById(e==="edit"?"edit-image-upload":"create-image-upload"),n=document.getElementById(t);n&&(n.innerHTML=""),a&&a.classList.remove("has-image");const i=document.getElementById(e==="edit"?"edit-image-file":"create-image-file");i&&(i.value="")}function vg(e,t="create"){document.querySelectorAll(`#${t}-image-tabs .cp-tab`).forEach(s=>s.classList.toggle("active",s.dataset.tab===e));const n=document.getElementById(`${t}-image-upload`),i=document.getElementById(`${t}-image-url-wrap`);n&&(n.style.display=e==="upload"?"block":"none"),i&&(i.style.display=e==="url"?"block":"none")}async function Ps(e){const t=new FormData;t.append("image",e);const a=await fetch(La.uploadImage,{method:"POST",body:t,signal:AbortSignal.timeout(6e4)});if(!a.ok){const i=await a.json().catch(()=>({}));throw new Error(i.error||`Upload failed (${a.status})`)}return(await a.json()).imageUrl}const cd=e=>{const t=Ir[Ts(e)]||Ir[0];return`<span class="cp-badge" style="background:${t.color}20;color:${t.color}"><i class="fa-solid ${t.icon}"></i> ${t.label}</span>`},wg=()=>'<div class="cp-loading"><div class="cp-spinner"></div><span class="text-zinc-500">Loading campaigns...</span></div>',dd=e=>`<div class="cp-empty"><i class="fa-solid fa-inbox"></i><h3>${e}</h3><p class="text-zinc-600 text-sm">Be the first to create a campaign!</p></div>`,ud=e=>{var i,s,r,o;const t=Ra(e.raisedAmount,e.goalAmount),a=nd(e.deadline),n=e.category||"humanitarian";return`
        <div class="cp-campaign-card" onclick="CharityPage.viewCampaign('${e.id}')">
            <img src="${zn(e)}" alt="${e.title}" onerror="this.src='${cn.default}'">
            <div class="p-4">
                ...
                <p class="text-zinc-500 text-xs mb-3">by <a href="${Qc}${e.creator}" target="_blank" class="text-amber-500 hover:text-amber-400">${ad(e.creator)}</a></p>
    ...
    `},Ar=()=>{var n,i,s,r;const e=k.campaigns.filter(o=>Cs(o)),t=e.filter(o=>o.category==="animal"),a=e.filter(o=>o.category==="humanitarian");return`
        <div class="charity-page">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4" id="cp-grid">
                ${e.length?e.filter(o=>!k.selectedCategory||o.category===k.selectedCategory).sort((o,l)=>Number(l.createdAt||0)-Number(o.createdAt||0)).map(o=>ud(o)).join(""):dd("No active campaigns")}
            </div>
        </div>
    `},Pr=e=>{var o,l,d,u,f,p;if(!e)return`
        <div class="charity-page">
    ...
    `;const t=Ra(e.raisedAmount,e.goalAmount),a=nd(e.deadline),n=e.category||"humanitarian",i=Cs(e),s=((o=e.creator)==null?void 0:o.toLowerCase())===((l=c==null?void 0:c.userAddress)==null?void 0:l.toLowerCase()),r=rd(e);return`
        <div class="charity-page">
            ${zs()}
            ${pd()}
            ...
            <div class="cp-detail">
                ...
                <img src="${zn(e)}" class="cp-detail-img" onerror="this.src='${cn.default}'">
                ...
                <div class="cp-detail-content">
                    ...
                    <div class="cp-card-base p-6">
                        ...
                        <p class="text-sm text-zinc-500 mb-4">
                            Created by <a href="${Qc}${e.creator}" target="_blank" class="text-amber-500 hover:text-amber-400">${ad(e.creator)}</a>
                        </p>
...
`;function Eg(){[1,2,3,4].forEach(t=>{const a=document.getElementById(`cp-step-${t}`);a&&(t<k.createStep?(a.className="cp-step-dot done",a.innerHTML='<i class="fa-solid fa-check text-sm"></i>'):t===k.createStep?(a.className="cp-step-dot active",a.textContent=t):(a.className="cp-step-dot pending",a.textContent=t))}),[1,2,3].forEach(t=>{const a=document.getElementById(`cp-ln-${t}`);a&&(a.className=`cp-step-line ln-${t} ${k.createStep>t?"done":k.createStep===t?"active":""}`)});const e=document.querySelector(".charity-page .text-sm.text-zinc-500");e&&(e.textContent=`Step ${k.createStep} of 4`)}function _a(){const e=document.getElementById("cp-wiz-panel");if(e)switch(Eg(),k.createStep){case 1:Tg(e);break;case 2:Cg(e);break;case 3:Ig(e);break;case 4:Ag(e);break}}function Tg(e){e.innerHTML=`
    ...
    `}function Pg(e){k.createCategory=e,_a()}function zg(){var e,t,a,n,i,s;switch(k.createStep){case 1:if(!k.createCategory)return x("Select a category","error");break;case 2:{const r=((t=(e=document.getElementById("wiz-title"))==null?void 0:e.value)==null?void 0:t.trim())||"",o=((n=(a=document.getElementById("wiz-desc"))==null?void 0:a.value)==null?void 0:n.trim())||"";if(k.createTitle=r,k.createDesc=o,!r)return x("Enter a title","error");if(!o)return x("Enter a description","error");break}case 3:{const r=((s=(i=document.getElementById("wiz-image-url"))==null?void 0:i.value)==null?void 0:s.trim())||"";r&&(k.createImageUrl=r);break}}k.createStep=Math.min(4,k.createStep+1),_a()}function Bg(){Sg(),k.createStep=Math.max(1,k.createStep-1),_a()}function Ng(){k.createImageFile=null,k.createImageUrl="",k.createImagePreview=null,k.pendingImageFile=null,k.createStep=4,_a()}function fd(){k.currentView="main",k.createStep=1,k.createCategory=null,k.createTitle="",k.createDesc="",k.createGoal="",k.createDuration="",k.createImageFile=null,k.createImageUrl="",k.createImagePreview=null,k.pendingImageFile=null,Fe()}function Sg(){switch(k.createStep){case 2:{const e=document.getElementById("wiz-title"),t=document.getElementById("wiz-desc");e&&(k.createTitle=e.value),t&&(k.createDesc=t.value);break}case 3:{const e=document.getElementById("wiz-image-url");e&&(k.createImageUrl=e.value.trim());break}case 4:{const e=document.getElementById("wiz-goal"),t=document.getElementById("wiz-duration");e&&(k.createGoal=e.value),t&&(k.createDuration=t.value);break}}}function $g(e,t){const a=t.value.length,n=e==="title"?100:2e3,i=e==="title"?80:1800,s=e==="title"?95:1950,r=document.getElementById(`wiz-${e}-count`);r&&(r.textContent=`${a}/${n}`,r.className=`cp-wiz-char-count ${a>s?"danger":a>i?"warn":""}`)}function Lg(e){var n;const t=(n=e.target.files)==null?void 0:n[0];if(!t)return;if(!td.includes(t.type)){x("Please select a valid image (JPG, PNG, GIF, WebP)","error");return}if(t.size>ed){x("Image must be less than 5MB","error");return}k.createImageFile=t,k.pendingImageFile=t;const a=new FileReader;a.onload=i=>{k.createImagePreview=i.target.result;const s=document.getElementById("wiz-image-preview");s&&(s.innerHTML=`
            ...
            <div class="cp-image-upload-icon"><i class="fa-solid fa-cloud-arrow-up"></i></div>
            <div class="cp-image-upload-text"><span>Click to upload</span> or drag and drop<br><small>PNG, JPG, GIF, WebP — max 5MB</small></div>
        `);const t=document.getElementById("wiz-image-file");t&&(t.value="")}async function _g(){var l,d;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=(l=document.getElementById("wiz-goal"))==null?void 0:l.value,t=(d=document.getElementById("wiz-duration"))==null?void 0:d.value;if(k.createGoal=e||"",k.createDuration=t||"",!k.createCategory)return x("Select a category","error");if(!k.createTitle)return x("Enter a title","error");if(!k.createDesc)return x("Enter a description","error");if(!e||parseFloat(e)<.01)return x("Goal must be at least 0.01 ETH","error");if(!t||parseInt(t)<1||parseInt(t)>180)return x("Duration must be 1-180 days","error");let a=k.createImageUrl||"";if(k.createImageFile)try{x("Uploading image to IPFS...","info"),a=await Ps(k.createImageFile),x("Image uploaded!","success")}catch(u){console.error("Image upload failed:",u),x("Image upload failed — campaign will be created without image","warning")}const n=k.createTitle,i=k.createDesc,s=k.createCategory,r=_t.parseEther(e),o=parseInt(t);await Rt.createCampaign({title:n,description:i,goalAmount:r,durationDays:o,button:document.getElementById("btn-wizard-launch"),onSuccess:async(u,f)=>{if(f){As(f,{imageUrl:a,category:s,title:n,description:i});try{await fetch(La.saveCampaign,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:f,title:n,description:i,category:s,imageUrl:a,creator:c.userAddress})})}catch{}}x("Campaign created!","success"),fd(),await bt(),Fe()},onError:u=>{var f;!u.cancelled&&u.type!=="user_rejected"&&x(((f=u.message)==null?void 0:f.slice(0,80))||"Failed","error")}})}function Bn(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.add("active")}function lt(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.remove("active")}function Fg(e=null){k.createStep=e?2:1,k.createCategory=e,k.createTitle="",k.createDesc="",k.createGoal="",k.createDuration="",k.createImageFile=null,k.createImageUrl="",k.createImagePreview=null,k.pendingImageFile=null,k.currentView="create",Fe()}function Mg(e){const t=k.campaigns.find(i=>i.id===e||i.id===String(e));if(!t)return;const a=document.getElementById("donate-campaign-info");a&&(a.innerHTML=`
            <div class="flex items-center gap-3 p-3 bg-zinc-800/50 rounded-xl mb-4">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-zinc-500 text-xs">${Ra(t.raisedAmount,t.goalAmount)}% funded</p>
                </div>
            </div>
        `);const n=document.getElementById("donate-amount");n&&(n.value=""),k.currentCampaign=t,Bn("donate")}function Dg(){var n;const e=(n=c==null?void 0:c.userAddress)==null?void 0:n.toLowerCase(),t=k.campaigns.filter(i=>{var s;return((s=i.creator)==null?void 0:s.toLowerCase())===e}),a=document.getElementById("my-campaigns-list");a&&(t.length===0?a.innerHTML=`
            <div class="cp-empty">
        ...
        `:a.innerHTML=t.map(i=>{const s=Ra(i.raisedAmount,i.goalAmount),r=rd(i);return`
            ...
            `}).join(""),Bn("my"))}function Og(e){var n,i,s;const t=k.campaigns.find(r=>r.id===e||r.id===String(e));if(!t)return;if(((n=t.creator)==null?void 0:n.toLowerCase())!==((i=c==null?void 0:c.userAddress)==null?void 0:i.toLowerCase())){x("Not your campaign","error");return}k.editingCampaign=t,k.pendingImageFile=null,document.getElementById("edit-campaign-id").value=t.id,document.getElementById("edit-title").value=t.title||"",document.getElementById("edit-desc").value=t.description||"",document.getElementById("edit-image-url").value=t.imageUrl||"",document.querySelectorAll("#modal-edit .cp-cat-option").forEach(r=>r.classList.remove("selected")),(s=document.getElementById(`edit-opt-${t.category||"humanitarian"}`))==null||s.classList.add("selected");const a=document.getElementById("edit-image-preview");a&&t.imageUrl?a.innerHTML=`<img src="${t.imageUrl}" class="cp-image-preview">`:a&&(a.innerHTML=""),Bn("edit")}function Hg(e,t="create"){var i;const a=t==="edit"?"edit-opt-":"opt-",n=t==="edit"?"#modal-edit":"#modal-create";document.querySelectorAll(`${n} .cp-cat-option`).forEach(s=>s.classList.remove("selected")),(i=document.getElementById(`${a}${e}`))==null||i.classList.add("selected")}function Ug(e){const t=document.getElementById("donate-amount")||document.getElementById("detail-amount");t&&(t.value=e)}async function jg(){var l,d,u,f,p,g,b,w;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=document.querySelector("#modal-create .cp-cat-option.selected input"),t=(e==null?void 0:e.value)||"humanitarian",a=(d=(l=document.getElementById("campaign-title"))==null?void 0:l.value)==null?void 0:d.trim(),n=(f=(u=document.getElementById("campaign-desc"))==null?void 0:u.value)==null?void 0:f.trim(),i=(p=document.getElementById("campaign-goal"))==null?void 0:p.value,s=(g=document.getElementById("campaign-duration"))==null?void 0:g.value;let r=(w=(b=document.getElementById("campaign-image-url"))==null?void 0:b.value)==null?void 0:w.trim();if(!a)return x("Enter a title","error");if(!n)return x("Enter a description","error");if(!i||parseFloat(i)<.01)return x("Goal must be at least 0.01 ETH","error");if(!s||parseInt(s)<1)return x("Duration must be at least 1 day","error");if(k.pendingImageFile)try{x("Uploading image...","info"),r=await Ps(k.pendingImageFile)}catch(T){console.error("Image upload failed:",T)}const o=_t.parseEther(i);await Rt.createCampaign({title:a,description:n,goalAmount:o,durationDays:parseInt(s),button:document.getElementById("btn-create"),onSuccess:async(T,C)=>{if(C){As(C,{imageUrl:r,category:t,title:a,description:n});try{await fetch(La.saveCampaign,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:C,title:a,description:n,category:t,imageUrl:r,creator:c.userAddress})})}catch{}}x("Campaign created!","success"),lt("create"),k.pendingImageFile=null,await bt(),Fe()},onError:T=>{var C;!T.cancelled&&T.type!=="user_rejected"&&x(((C=T.message)==null?void 0:C.slice(0,80))||"Failed","error")}})}async function Wg(){var n;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=k.currentCampaign;if(!e)return;const t=(n=document.getElementById("donate-amount"))==null?void 0:n.value;if(!t||parseFloat(t)<.001)return x("Minimum 0.001 ETH","error");const a=_t.parseEther(t);await Rt.donate({campaignId:e.id,amount:a,button:document.getElementById("btn-donate"),onSuccess:async()=>{x("❤️ Thank you for your donation!","success"),lt("donate"),await bt(),Fe()},onError:i=>{var s;!i.cancelled&&i.type!=="user_rejected"&&x(((s=i.message)==null?void 0:s.slice(0,80))||"Failed","error")}})}async function Gg(e){var n;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const t=(n=document.getElementById("detail-amount"))==null?void 0:n.value;if(!t||parseFloat(t)<.001)return x("Minimum 0.001 ETH","error");const a=_t.parseEther(t);await Rt.donate({campaignId:e,amount:a,button:document.getElementById("btn-donate-detail"),onSuccess:async()=>{x("❤️ Thank you for your donation!","success"),await bt(),await Ft(e)},onError:i=>{var s;!i.cancelled&&i.type!=="user_rejected"&&x(((s=i.message)==null?void 0:s.slice(0,80))||"Failed","error")}})}async function Kg(e){if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");confirm("Cancel this campaign? This cannot be undone.")&&await Rt.cancelCampaign({campaignId:e,button:document.getElementById("btn-cancel"),onSuccess:async()=>{x("Campaign cancelled","success"),await bt(),Fe()},onError:t=>{var a;!t.cancelled&&t.type!=="user_rejected"&&x(((a=t.message)==null?void 0:a.slice(0,80))||"Failed","error")}})}async function Yg(e){if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const t=k.campaigns.find(i=>i.id===e||i.id===String(e));if(!t)return;const a=Ra(t.raisedAmount,t.goalAmount);let n=`Withdraw ${Ce(t.raisedAmount)} ETH?

5% platform fee applies.`;a<100&&(n+=`
Goal not reached - partial withdrawal.`),confirm(n)&&await Rt.withdraw({campaignId:e,button:document.getElementById(`btn-withdraw-${e}`)||document.getElementById("btn-withdraw"),onSuccess:async()=>{var i;x("✅ Funds withdrawn successfully!","success"),lt("my"),await bt(),Fe(),((i=k.currentCampaign)==null?void 0:i.id)===e&&await Ft(e)},onError:i=>{var s;!i.cancelled&&i.type!=="user_rejected"&&x(((s=i.message)==null?void 0:s.slice(0,80))||"Failed","error")}})}async function Vg(){var o,l,d,u,f,p,g,b;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=(o=document.getElementById("edit-campaign-id"))==null?void 0:o.value,t=(d=(l=document.getElementById("edit-title"))==null?void 0:l.value)==null?void 0:d.trim(),a=(f=(u=document.getElementById("edit-desc"))==null?void 0:u.value)==null?void 0:f.trim();let n=(g=(p=document.getElementById("edit-image-url"))==null?void 0:p.value)==null?void 0:g.trim();const i=document.querySelector("#modal-edit .cp-cat-option.selected input"),s=(i==null?void 0:i.value)||"humanitarian";if(!t)return x("Enter title","error");if(k.pendingImageFile)try{x("Uploading image...","info"),n=await Ps(k.pendingImageFile)}catch(w){console.error("Image upload failed:",w)}const r=document.getElementById("btn-save-edit");r&&(r.disabled=!0,r.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Saving...');try{As(e,{imageUrl:n,category:s,title:t,description:a}),await fetch(La.saveCampaign,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:e,title:t,description:a,category:s,imageUrl:n,creator:c.userAddress})}),x("Campaign updated!","success"),lt("edit"),k.pendingImageFile=null,await bt(),((b=k.currentCampaign)==null?void 0:b.id)===e?await Ft(e):Fe()}catch{x("Failed to save","error")}finally{r&&(r.disabled=!1,r.innerHTML='<i class="fa-solid fa-check"></i> Save')}}function qg(e){const t=k.currentCampaign;if(!t)return;const a=id(t.id),n=`🙏 Support "${t.title}" on Backcoin Charity!

${Ce(t.raisedAmount)} raised of ${Ce(t.goalAmount)} goal.

`;let i;e==="twitter"?i=`https://twitter.com/intent/tweet?text=${encodeURIComponent(n)}&url=${encodeURIComponent(a)}`:e==="telegram"?i=`https://t.me/share/url?url=${encodeURIComponent(a)}&text=${encodeURIComponent(n)}`:e==="whatsapp"&&(i=`https://wa.me/?text=${encodeURIComponent(n+a)}`),i&&window.open(i,"_blank","width=600,height=400")}function Xg(){const e=k.currentCampaign;e&&navigator.clipboard.writeText(id(e.id)).then(()=>x("Link copied!","success")).catch(()=>x("Copy failed","error"))}function md(){gg(),k.currentCampaign=null,k.currentView="main",Fe()}function Jg(e){lt("my"),lt("donate"),lt("edit"),mg(e),Ft(e)}function Zg(e){k.selectedCategory=k.selectedCategory===e?null:e,Bs()}function Qg(){k.selectedCategory=null,Bs()}function Bs(){const e=document.getElementById("cp-grid");if(!e)return;let t=k.campaigns.filter(a=>Cs(a));k.selectedCategory&&(t=t.filter(a=>a.category===k.selectedCategory)),t.sort((a,n)=>Number(n.createdAt||0)-Number(a.createdAt||0)),e.innerHTML=t.length?t.map(a=>ud(a)).join(""):dd("No campaigns")}async function Ft(e){k.currentView="detail",k.isLoading=!0;const t=yi();t&&(t.innerHTML=wg());try{let a=k.campaigns.find(n=>n.id===e||n.id===String(e));if(!a){const n=c==null?void 0:c.publicProvider;if(n){const s=await new _t.Contract(v.charityPool,Is,n).getCampaign(e),r=ld(e);a={id:String(e),creator:s.creator||s[0],title:s.title||s[1]||`Campaign #${e}`,description:s.description||s[2]||"",goalAmount:BigInt((s.goalAmount||s[3]).toString()),raisedAmount:BigInt((s.raisedAmount||s[4]).toString()),donationCount:Number(s.donationCount||s[5]),deadline:Number(s.deadline||s[6]),createdAt:Number(s.createdAt||s[7]),status:Number(s.status||s[10]),category:(r==null?void 0:r.category)||"humanitarian",imageUrl:(r==null?void 0:r.imageUrl)||null}}}k.currentCampaign=a,t&&(t.innerHTML=Pr(a))}catch{t&&(t.innerHTML=Pr(null))}finally{k.isLoading=!1}}function yi(){let e=document.getElementById("charity-container");if(e)return e;const t=document.getElementById("charity");return t?(e=document.createElement("div"),e.id="charity-container",t.innerHTML="",t.appendChild(e),e):null}function Fe(){fg();const e=yi();if(!e)return;if(k.currentView==="create"){e.innerHTML=kg(),_a();return}const t=sd();t?Ft(t):(k.currentView="main",k.currentCampaign=null,e.innerHTML=Ar(),bt().then(()=>{if(k.currentView==="main"){const a=yi();a&&(a.innerHTML=Ar())}}))}async function eb(){k.campaigns=[],k.stats=null,k.currentView==="detail"&&k.currentCampaign?await Ft(k.currentCampaign.id):Fe()}window.addEventListener("hashchange",()=>{var e;if(window.location.hash.startsWith("#charity")){const t=sd();t?((e=k.currentCampaign)==null?void 0:e.id)!==t&&Ft(t):k.currentView!=="main"&&md()}});const gd={render(e){e&&Fe()},update(){k.currentView==="main"&&Bs()},refresh:eb,openModal:Bn,closeModal:lt,openCreate:Fg,openDonate:Mg,openMyCampaigns:Dg,openEdit:Og,create:jg,donate:Wg,donateDetail:Gg,cancel:Kg,withdraw:Yg,saveEdit:Vg,selCatOpt:Hg,setAmt:Ug,goBack:md,viewCampaign:Jg,selectCat:Zg,clearCat:Qg,share:qg,copyLink:Xg,handleImageSelect:xg,removeImage:hg,switchImageTab:vg,wizardSelectCategory:Pg,wizardNext:zg,wizardBack:Bg,wizardSkipImage:Ng,cancelCreate:fd,wizardUpdateCharCount:$g,handleWizardImageSelect:Lg,removeWizardImage:Rg,wizardLaunch:_g};window.CharityPage=gd;const Nn=window.ethers,bd="https://sepolia.arbiscan.io/address/",tb=Hd,ct=500;function xd(){return v.agora||v.backchat||v.Backchat||null}function Qe(){return v.operator||v.treasury||null}const m={view:"feed",activeTab:"feed",viewHistory:[],posts:[],trendingPosts:[],allItems:[],replies:new Map,likesMap:new Map,replyCountMap:new Map,repostCountMap:new Map,postsById:new Map,userProfile:null,profiles:new Map,hasProfile:null,following:new Set,followers:new Set,followCounts:new Map,pendingImage:null,pendingImagePreview:null,isUploadingImage:!1,selectedPost:null,selectedProfile:null,wizStep:1,wizUsername:"",wizDisplayName:"",wizBio:"",wizUsernameOk:null,wizFee:null,wizChecking:!1,fees:{post:0n,reply:0n,like:0n,follow:0n,repost:0n,superLikeMin:0n,boostMin:0n,badge:0n},pendingEth:0n,hasBadge:!1,isBoosted:!1,boostExpiry:0,badgeExpiry:0,referralStats:null,referredBy:null,isLoading:!1,isPosting:!1,contractAvailable:!0,error:null};function ab(){if(document.getElementById("backchat-styles-v70"))return;const e=document.getElementById("backchat-styles-v69");e&&e.remove();const t=document.createElement("style");t.id="backchat-styles-v70",t.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(t)}function Ca(e){return e?`${e.slice(0,6)}...${e.slice(-4)}`:""}function nb(e){const a=Date.now()/1e3-e;return a<60?"now":a<3600?`${Math.floor(a/60)}m`:a<86400?`${Math.floor(a/3600)}h`:a<604800?`${Math.floor(a/86400)}d`:new Date(e*1e3).toLocaleDateString("en-US",{month:"short",day:"numeric"})}function mt(e){if(!e||e===0n)return"0";const t=parseFloat(Nn.formatEther(e));return t<1e-4?"<0.0001":t<.01?t.toFixed(4):t<1?t.toFixed(3):t.toFixed(2)}function Sn(e){return e?e.slice(2,4).toUpperCase():"?"}function Le(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}function ba(e){if(!e)return"?";const t=m.profiles.get(e.toLowerCase());return t!=null&&t.displayName?t.displayName:t!=null&&t.username?`@${t.username}`:Ca(e)}function ib(e){if(!e)return null;const t=m.profiles.get(e.toLowerCase());return(t==null?void 0:t.username)||null}function sb(e){var t;return(e==null?void 0:e.toLowerCase())===((t=c.userAddress)==null?void 0:t.toLowerCase())?m.isBoosted:!1}function rb(e){var t;return(e==null?void 0:e.toLowerCase())===((t=c.userAddress)==null?void 0:t.toLowerCase())?m.hasBadge:!1}function Va(e,t){m.viewHistory.push({view:m.view,activeTab:m.activeTab,selectedPost:m.selectedPost,selectedProfile:m.selectedProfile}),m.view=e,t!=null&&t.post&&(m.selectedPost=t.post),t!=null&&t.profile&&(m.selectedProfile=t.profile),ot()}function ob(){if(m.viewHistory.length>0){const e=m.viewHistory.pop();m.view=e.view,m.activeTab=e.activeTab||m.view,m.selectedPost=e.selectedPost,m.selectedProfile=e.selectedProfile}else m.view="feed",m.activeTab="feed";ot()}function Fa(){if(c.agoraContract)return c.agoraContract;if(c.agoraContractPublic)return c.agoraContractPublic;const e=xd();return e?c.publicProvider?new Nn.Contract(e,Aa,c.publicProvider):null:(console.warn("Agora/Backchat address not found in deployment-addresses.json"),null)}async function zr(){try{const e=Fa();if(!e)return;let t=100000000n;try{t=await e.VOTE_PRICE()}catch{}const a=window.ethers.parseEther("0.0001");m.fees={post:a,reply:a,like:a,follow:a,repost:a,superLikeMin:t,boostMin:window.ethers.parseEther("0.0005"),badge:window.ethers.parseEther("0.001")}}catch(e){console.warn("Failed to load fees:",e.message)}}async function Br(){if(!(!c.isConnected||!c.userAddress))try{const e=Fa();if(!e)return;const[t,a,n]=await Promise.all([e.getUserProfile(c.userAddress).catch(()=>null),e.hasTrustBadge(c.userAddress).catch(()=>!1),e.isProfileBoosted(c.userAddress).catch(()=>!1)]);m.pendingEth=0n,m.hasBadge=a,m.isBoosted=n,m.boostExpiry=t?Number(t.boostExp||t[5]||0):0,m.badgeExpiry=t?Number(t.badgeExp||t[6]||0):0,m.referredBy=null,m.referralStats={totalReferred:0,totalEarned:0n,totalEarnedFormatted:"0.0"}}catch(e){console.warn("Failed to load user status:",e.message)}}async function Nr(){try{const e=Fa();if(!e){m.hasProfile=!1;return}const[t,a]=await Promise.all([e.queryFilter(e.filters.ProfileCreated(),-1e5).catch(()=>[]),e.queryFilter(e.filters.ProfileUpdated(),-1e5).catch(()=>[])]);for(const n of t){const i=n.args.user.toLowerCase();m.profiles.set(i,{username:n.args.username,displayName:n.args.displayName||"",bio:n.args.bio||""})}for(const n of a){const i=n.args.user.toLowerCase(),s=m.profiles.get(i);s&&(s.displayName=n.args.displayName||s.displayName,s.bio=n.args.bio||s.bio)}if(c.isConnected&&c.userAddress){const n=c.userAddress.toLowerCase(),i=m.profiles.get(n);i?(m.userProfile={...i,address:c.userAddress},m.hasProfile=!0):(m.hasProfile=!1,m.userProfile=null)}else m.hasProfile=!1;console.log("[Backchat] Profiles loaded:",m.profiles.size,"| hasProfile:",m.hasProfile)}catch(e){console.warn("Failed to load profiles:",e.message),m.hasProfile=!1}ie()}async function Sr(){var e;if(!(!c.isConnected||!c.userAddress))try{const t=Fa();if(!t)return;const[a,n]=await Promise.all([t.queryFilter(t.filters.Followed(),-1e5).catch(()=>[]),t.queryFilter(t.filters.Unfollowed(),-1e5).catch(()=>[])]),i=new Map;for(const r of a){const o=r.args.follower.toLowerCase(),l=r.args.followed.toLowerCase();i.has(o)||i.set(o,new Set),i.get(o).add(l)}for(const r of n){const o=r.args.follower.toLowerCase(),l=r.args.followed.toLowerCase();(e=i.get(o))==null||e.delete(l)}const s=c.userAddress.toLowerCase();m.following=i.get(s)||new Set,m.followers=new Set;for(const[r,o]of i)o.has(s)&&m.followers.add(r);m.followCounts=new Map;for(const[r,o]of i){for(const l of o)m.followCounts.has(l)||m.followCounts.set(l,{followers:0,following:0}),m.followCounts.get(l).followers++;m.followCounts.has(r)||m.followCounts.set(r,{followers:0,following:0}),m.followCounts.get(r).following=o.size}}catch(t){console.warn("Failed to load social graph:",t.message)}}async function Xt(){m.isLoading=!0,ie();try{if(!xd()){m.contractAvailable=!1,m.error="Backchat contract not deployed yet.";return}const t=Fa();if(!t){m.contractAvailable=!1,m.error="Could not connect to Backchat contract";return}m.contractAvailable=!0;const[a,n,i,s,r]=await Promise.all([t.queryFilter(t.filters.PostCreated(),-1e5).catch(()=>[]),t.queryFilter(t.filters.ReplyCreated(),-1e5).catch(()=>[]),t.queryFilter(t.filters.RepostCreated(),-1e5).catch(()=>[]),t.queryFilter(t.filters.Liked(),-1e5).catch(()=>[]),t.queryFilter(t.filters.SuperLiked(),-1e5).catch(()=>[])]);m.likesMap=new Map;for(const u of s){const f=u.args.postId.toString();m.likesMap.has(f)||m.likesMap.set(f,new Set),m.likesMap.get(f).add(u.args.user.toLowerCase())}const o=new Map;for(const u of r){const f=u.args.postId.toString();o.set(f,(o.get(f)||0n)+u.args.ethAmount)}const l=[],d=[];m.postsById=new Map,m.replies=new Map,m.replyCountMap=new Map,m.repostCountMap=new Map;for(const u of a.slice(-80)){const f=await u.getBlock(),p={id:u.args.postId.toString(),type:"post",author:u.args.author,content:u.args.content,mediaCID:u.args.mediaCID,timestamp:f.timestamp,superLikes:o.get(u.args.postId.toString())||0n,txHash:u.transactionHash};l.push(p),d.push(p),m.postsById.set(p.id,p)}for(const u of n.slice(-60)){const f=await u.getBlock(),p={id:u.args.postId.toString(),type:"reply",parentId:u.args.parentId.toString(),author:u.args.author,content:u.args.content,mediaCID:u.args.mediaCID,tipBkc:u.args.tipBkc,timestamp:f.timestamp,superLikes:o.get(u.args.postId.toString())||0n,txHash:u.transactionHash};l.push(p),m.postsById.set(p.id,p);const g=p.parentId;m.replies.has(g)||m.replies.set(g,[]),m.replies.get(g).push(p),m.replyCountMap.set(g,(m.replyCountMap.get(g)||0)+1)}for(const u of i.slice(-30)){const f=await u.getBlock(),p={id:u.args.newPostId.toString(),type:"repost",originalPostId:u.args.originalPostId.toString(),author:u.args.reposter,timestamp:f.timestamp,txHash:u.transactionHash};l.push(p),d.push(p),m.postsById.set(p.id,p);const g=p.originalPostId;m.repostCountMap.set(g,(m.repostCountMap.get(g)||0)+1)}d.sort((u,f)=>f.timestamp-u.timestamp),m.posts=d,m.allItems=l,m.trendingPosts=[...l].filter(u=>u.type!=="repost"&&u.superLikes>0n).sort((u,f)=>{const p=BigInt(u.superLikes||0),g=BigInt(f.superLikes||0);return g>p?1:g<p?-1:0})}catch(e){console.error("Failed to load posts:",e),m.error=e.message}finally{m.isLoading=!1,ie()}}async function lb(){var s;const e=document.getElementById("bc-compose-input"),t=(s=e==null?void 0:e.value)==null?void 0:s.trim();if(!t){x("Please write something","error");return}if(t.length>ct){x(`Post too long (max ${ct} chars)`,"error");return}m.isPosting=!0,ie();let a="";if(m.pendingImage)try{m.isUploadingImage=!0,ie(),a=(await wb(m.pendingImage)).ipfsHash||""}catch(r){x("Image upload failed: "+r.message,"error"),m.isPosting=!1,m.isUploadingImage=!1,ie();return}finally{m.isUploadingImage=!1}const n=t,i=document.getElementById("bc-post-btn");await xe.createPost({content:n,mediaCID:a,operator:Qe(),button:i,onSuccess:async()=>{e&&(e.value=""),m.pendingImage=null,m.pendingImagePreview=null,m.isPosting=!1,x("Post created!","success"),await Xt()},onError:r=>{m.isPosting=!1,ie()}}),m.isPosting=!1,ie()}async function cb(e){var i;const t=document.getElementById("bc-reply-input"),a=(i=t==null?void 0:t.value)==null?void 0:i.trim();if(!a){x("Please write a reply","error");return}const n=document.getElementById("bc-reply-btn");await xe.createReply({parentId:e,content:a,mediaCID:"",tipBkc:0,operator:Qe(),button:n,onSuccess:async()=>{t&&(t.value=""),x("Reply posted!","success"),await Xt(),ie()}})}async function db(e){const t=document.getElementById("bc-repost-confirm-btn");await xe.createRepost({originalPostId:e,tipBkc:0,operator:Qe(),button:t,onSuccess:async()=>{xt("repost"),x("Reposted!","success"),await Xt()}})}async function ub(e){var a;const t=(a=c.userAddress)==null?void 0:a.toLowerCase();t&&(m.likesMap.has(e)||m.likesMap.set(e,new Set),m.likesMap.get(e).add(t),ie()),await xe.like({postId:e,tipBkc:0,operator:Qe(),onSuccess:()=>{x("Liked!","success")},onError:()=>{var n;(n=m.likesMap.get(e))==null||n.delete(t),ie()}})}async function pb(e,t){const a=Nn.parseEther(t);await xe.superLike({postId:e,ethAmount:a,tipBkc:0,operator:Qe(),onSuccess:async()=>{x("Super Liked!","success"),await Xt()}})}async function fb(e){await xe.follow({toFollow:e,tipBkc:0,operator:Qe(),onSuccess:()=>{m.following.add(e.toLowerCase()),x("Followed!","success"),ie()}})}async function mb(e){await xe.unfollow({toUnfollow:e,onSuccess:()=>{m.following.delete(e.toLowerCase()),x("Unfollowed","success"),ie()}})}async function gb(){x("Withdraw not available in V9","warning")}async function bb(){const e=document.getElementById("bc-wizard-confirm-btn");await xe.createProfile({username:m.wizUsername,displayName:m.wizDisplayName,bio:m.wizBio,operator:Qe(),button:e,onSuccess:async()=>{x("Profile created!","success"),m.hasProfile=!0,m.userProfile={username:m.wizUsername,displayName:m.wizDisplayName,bio:m.wizBio,address:c.userAddress},m.profiles.set(c.userAddress.toLowerCase(),{username:m.wizUsername,displayName:m.wizDisplayName,bio:m.wizBio}),m.wizStep=1,m.wizUsername="",m.wizDisplayName="",m.wizBio="",m.view="profile",m.activeTab="profile",ot()}})}async function xb(){var n,i,s,r;const e=((i=(n=document.getElementById("edit-displayname"))==null?void 0:n.value)==null?void 0:i.trim())||"",t=((r=(s=document.getElementById("edit-bio"))==null?void 0:s.value)==null?void 0:r.trim())||"",a=document.getElementById("bc-edit-profile-btn");await xe.updateProfile({displayName:e,bio:t,button:a,onSuccess:()=>{m.userProfile.displayName=e,m.userProfile.bio=t,m.profiles.set(c.userAddress.toLowerCase(),{...m.profiles.get(c.userAddress.toLowerCase()),displayName:e,bio:t}),xt("edit-profile"),x("Profile updated!","success"),ie()}})}async function hb(){await xe.obtainBadge({operator:Qe(),onSuccess:()=>{m.hasBadge=!0,xt("badge"),x("Badge obtained!","success"),ie()}})}async function vb(e){const t=Nn.parseEther(e);await xe.boostProfile({ethAmount:t,operator:Qe(),onSuccess:()=>{m.isBoosted=!0,xt("boost"),x("Profile boosted!","success"),ie()}})}async function wb(e){const t=new FormData;t.append("image",e);const a=new AbortController,n=setTimeout(()=>a.abort(),6e4);try{const i=await fetch("/api/upload-image",{method:"POST",body:t,signal:a.signal});if(clearTimeout(n),!i.ok){const s=await i.json().catch(()=>({}));throw new Error(s.error||`Upload failed (${i.status})`)}return await i.json()}catch(i){throw clearTimeout(n),i}}function yb(e){var n,i;const t=(i=(n=e.target)==null?void 0:n.files)==null?void 0:i[0];if(!t)return;if(t.size>5*1024*1024){x("Image too large. Maximum 5MB.","error");return}if(!["image/jpeg","image/png","image/gif","image/webp"].includes(t.type)){x("Invalid image type. Use JPG, PNG, GIF, or WebP.","error");return}m.pendingImage=t;const a=new FileReader;a.onload=s=>{m.pendingImagePreview=s.target.result,ie()},a.readAsDataURL(t)}function kb(){m.pendingImage=null,m.pendingImagePreview=null;const e=document.getElementById("bc-image-input");e&&(e.value=""),ie()}let $r=null;function Eb(e){m.wizUsername=e.toLowerCase().replace(/[^a-z0-9_]/g,""),m.wizUsernameOk=null,m.wizFee=null,clearTimeout($r);const t=document.getElementById("wiz-username-input");t&&(t.value=m.wizUsername),m.wizUsername.length>=1&&m.wizUsername.length<=15?(m.wizChecking=!0,Qn(),$r=setTimeout(async()=>{try{const[a,n]=await Promise.all([xe.isUsernameAvailable(m.wizUsername),xe.getUsernameFee(m.wizUsername.length)]);m.wizUsernameOk=a,m.wizFee=n.formatted}catch(a){console.warn("Username check failed:",a)}m.wizChecking=!1,Qn()},600)):(m.wizChecking=!1,Qn())}function Qn(){const e=document.getElementById("wiz-username-status");e&&(m.wizChecking?e.innerHTML='<span class="bc-username-checking"><i class="fa-solid fa-spinner fa-spin"></i> Checking...</span>':m.wizUsernameOk===!0?e.innerHTML=`<span class="bc-username-ok"><i class="fa-solid fa-check"></i> Available</span>
                ${m.wizFee&&m.wizFee!=="0.0"?`<span class="bc-username-fee">${m.wizFee} ETH</span>`:'<span class="bc-username-fee">FREE</span>'}`:m.wizUsernameOk===!1?e.innerHTML='<span class="bc-username-taken"><i class="fa-solid fa-xmark"></i> Taken</span>':e.innerHTML="");const t=document.querySelector(".bc-wizard-nav .bc-btn-primary");t&&m.wizStep===1&&(t.disabled=!m.wizUsernameOk)}function Tb(){if(["post-detail","user-profile","profile-setup"].includes(m.view)){let t="Post";return m.view==="user-profile"&&(t=ba(m.selectedProfile)),m.view==="profile-setup"&&(t="Create Profile"),`
            <div class="bc-header">
            ...
            <div class="bc-header-bar">
                ...
                <div class="bc-header-right">
                    ${c.isConnected&&m.pendingEth>0n?`
                        <button class="bc-icon-btn earnings-btn" onclick="BackchatPage.openEarnings()" title="Earnings: ${mt(m.pendingEth)} ETH">
                            <i class="fa-solid fa-coins"></i>
                        </button>
                    `:""}
    ...
    `}function Lr(){var a;if(!c.isConnected)return"";const e=mt(m.fees.post);return`
        ...
        <div class="bc-post" data-post-id="${e.id}" ${p} onclick="BackchatPage.viewPost('${e.id}')">
            <div class="bc-post-top">
                ...
                <div class="bc-post-head">
                    ...
                    ${e.type==="reply"?`<div class="bc-post-context">Replying to ${ba((T=m.postsById.get(e.parentId))==null?void 0:T.author)}</div>`:""}
                </div>
            </div>
    ...
    `}function Rr(){return m.contractAvailable?m.isLoading?`
        ...
        `}function Cb(){return m.trendingPosts.length===0?`
            <div class="bc-empty">
                <div class="bc-empty-glyph accent">
                    <i class="fa-solid fa-fire"></i>
                </div>
        ...
        ${m.trendingPosts.map((e,t)=>$t(e,t)).join("")}
    `}function Ib(){var r,o,l,d,u,f;if(!c.isConnected)return`
            <div class="bc-empty">
        ...
        `;const e=(r=c.userAddress)==null?void 0:r.toLowerCase(),t=m.allItems.filter(p=>{var g;return((g=p.author)==null?void 0:g.toLowerCase())===e&&p.type!=="repost"}),a=m.followers.size,n=m.following.size,i=((o=m.userProfile)==null?void 0:o.displayName)||((l=m.userProfile)==null?void 0:l.username)||Ca(c.userAddress),s=(d=m.userProfile)!=null&&d.username?m.userProfile.username.charAt(0).toUpperCase():Sn(c.userAddress);return`
        <div class="bc-profile-section">
            ...
            <div class="bc-profile-main">
                ...
                <div class="bc-profile-handle">
                    <a href="${bd}${c.userAddress}" target="_blank" rel="noopener">
                ...
                <div class="bc-profile-stats">
                    ...
                    <div class="bc-stat-cell">
                        <div class="bc-stat-value">${mt(m.pendingEth)}</div>
            ...
            ${m.pendingEth>0n?`
                <div class="bc-earnings-card">
                    ...
                    <div class="bc-earnings-value">${mt(m.pendingEth)} <small>ETH</small></div>
            ...
            ${t.length===0?'<div class="bc-empty" style="padding:40px 20px;"><div class="bc-empty-text">No posts yet — share your first thought!</div></div>':t.map((p,g)=>$t(p,g)).join("")}
        </div>
    `}function Ab(){var n,i;if(!c.isConnected)return"";const e=`${window.location.origin}/#backchat?ref=${c.userAddress}`,t=((n=m.referralStats)==null?void 0:n.totalReferred)||0,a=((i=m.referralStats)==null?void 0:i.totalEarnedFormatted)||"0.0";return`
        <div class="bc-referral-card">
            ...
            <div class="bc-referral-info" style="margin-top:12px;">
                ...
                ${m.referredBy?`<br>You were referred by <code style="font-size:11px;color:var(--bc-accent);">${Ca(m.referredBy)}</code>`:""}
            </div>
        </div>
    `}function ie(){const e=document.getElementById("backchat-content");if(!e)return;let t="";switch(m.view){case"feed":t=Lr()+Rr();break;case"trending":t=Cb();break;case"profile":t=!m.hasProfile&&c.isConnected?_r():Ib();break;case"post-detail":t=Pb();break;case"user-profile":t=zb();break;case"profile-setup":t=_r();break;default:t=Lr()+Rr()}e.innerHTML=t}function Pb(){const e=m.selectedPost?m.postsById.get(m.selectedPost):null;if(!e)return'<div class="bc-empty"><div class="bc-empty-title">Post not found</div></div>';const t=m.replies.get(e.id)||[];t.sort((n,i)=>n.timestamp-i.timestamp);const a=ba(e.author);return`
        ...
        ${c.isConnected?`
            <div class="bc-reply-compose">
                ...
                <div style="font-size:11px;color:var(--bc-text-3);margin-top:6px;">Fee: ${mt(m.fees.reply)} ETH</div>
            </div>
        `:""}
    `}function zb(){var f;const e=m.selectedProfile;if(!e)return'<div class="bc-empty"><div class="bc-empty-title">User not found</div></div>';const t=e.toLowerCase(),a=m.profiles.get(t),n=(a==null?void 0:a.displayName)||(a==null?void 0:a.username)||Ca(e),i=a==null?void 0:a.username,s=a==null?void 0:a.bio,r=i?i.charAt(0).toUpperCase():Sn(e),o=t===((f=c.userAddress)==null?void 0:f.toLowerCase()),l=m.following.has(t),d=m.followCounts.get(t)||{followers:0,following:0},u=m.allItems.filter(p=>{var g;return((g=p.author)==null?void 0:g.toLowerCase())===t&&p.type!=="repost"});return`
        <div class="bc-profile-section">
            <div class="bc-profile-banner"></div>
            <div class="bc-profile-main">
                <div class="bc-profile-top-row">
                ...
                <div class="bc-profile-handle">
                    <a href="${bd}${e}" target="_blank" rel="noopener">
                        ${Ca(e)} <i class="fa-solid fa-arrow-up-right-from-square"></i>
                    </a>
                </div>
            ...
            ${u.length===0?'<div class="bc-empty" style="padding:40px 20px;"><div class="bc-empty-text">No posts yet</div></div>':u.sort((p,g)=>g.timestamp-p.timestamp).map((p,g)=>$t(p,g)).join("")}
        </div>
    `}function _r(){if(!c.isConnected)return`
            <div class="bc-empty">
                <div class="bc-empty-glyph"><i class="fa-solid fa-wallet"></i></div>
                <div class="bc-empty-title">Connect Wallet</div>
    ...
    `}function Bb(){var e,t;return`
            ...
            <div class="bc-modal-box">
                ...
                <div class="bc-modal-inner">
                    ...
                    <div class="bc-fee-row">
                        ...
                        <span class="bc-fee-val">${mt(m.fees.badge)} ETH</span>
                    </div>
        ...
        <div class="bc-modal-overlay" id="modal-repost">
            <div class="bc-modal-box">
                ...
                <div class="bc-modal-inner">
                    <p class="bc-modal-desc">Repost this to your followers? Fee: ${mt(m.fees.repost)} ETH</p>
    ...
    `}function ot(){ab();const e=document.getElementById("backchat");e&&(e.innerHTML=`
        <div class="bc-shell">
            ${Tb()}
            <div id="backchat-content"></div>
        </div>
        ${Bb()}
    `,ie())}let $n=null;function Nb(e){var t;$n=e,(t=document.getElementById("modal-superlike"))==null||t.classList.add("active")}async function Sb(){var t;const e=((t=document.getElementById("superlike-amount"))==null?void 0:t.value)||"0.001";xt("superlike"),await pb($n,e)}function $b(){var e;(e=document.getElementById("modal-badge"))==null||e.classList.add("active")}async function Lb(){xt("badge"),await hb()}function Rb(){var e;(e=document.getElementById("modal-boost"))==null||e.classList.add("active")}async function _b(){var t;const e=((t=document.getElementById("boost-amount"))==null?void 0:t.value)||"0.001";xt("boost"),await vb(e)}function Fb(e){var t;$n=e,(t=document.getElementById("modal-repost"))==null||t.classList.add("active")}async function Mb(){await db($n)}function Db(){var e;ot(),(e=document.getElementById("modal-edit-profile"))==null||e.classList.add("active")}async function Ob(){await xb()}function xt(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.remove("active")}function Hb(e){const t=document.getElementById("bc-char-counter");if(!t)return;const a=e.value.length;t.textContent=`${a}/${ct}`,t.className="bc-char-count",a>ct-50?t.classList.add("danger"):a>ct-150&&t.classList.add("warn")}const hd={async render(e){e&&(ot(),await Promise.all([zr(),Br(),Nr(),Xt(),Sr()]))},async refresh(){await Promise.all([zr(),Br(),Nr(),Xt(),Sr()])},setTab(e){m.activeTab=e,m.view=e,ot()},goBack:ob,viewPost(e){Va("post-detail",{post:e})},viewProfile(e){var t;(e==null?void 0:e.toLowerCase())===((t=c.userAddress)==null?void 0:t.toLowerCase())?(m.activeTab="profile",m.view="profile",ot()):Va("user-profile",{profile:e})},openReply(e){Va("post-detail",{post:e})},openProfileSetup(){m.wizStep=1,m.wizUsername="",m.wizDisplayName="",m.wizBio="",m.wizUsernameOk=null,m.wizFee=null,Va("profile-setup")},createPost:lb,submitReply:cb,like:ub,follow:fb,unfollow:mb,withdraw:gb,openSuperLike:Nb,confirmSuperLike:Sb,openRepostConfirm:Fb,confirmRepost:Mb,openBadge:$b,confirmBadge:Lb,openBoost:Rb,confirmBoost:_b,openEditProfile:Db,confirmEditProfile:Ob,closeModal:xt,openEarnings(){m.activeTab="profile",m.view="profile",ot()},handleImageSelect:yb,removeImage:kb,onWizUsernameInput:Eb,wizNext(){var e,t,a,n;m.wizStep===1&&!m.wizUsernameOk||(m.wizStep===1?m.wizStep=2:m.wizStep===2&&(m.wizDisplayName=((t=(e=document.getElementById("wiz-displayname-input"))==null?void 0:e.value)==null?void 0:t.trim())||"",m.wizBio=((n=(a=document.getElementById("wiz-bio-input"))==null?void 0:a.value)==null?void 0:n.trim())||"",m.wizStep=3),ie())},wizBack(){var e,t,a,n;m.wizStep>1&&(m.wizStep===2&&(m.wizDisplayName=((t=(e=document.getElementById("wiz-displayname-input"))==null?void 0:e.value)==null?void 0:t.trim())||"",m.wizBio=((n=(a=document.getElementById("wiz-bio-input"))==null?void 0:a.value)==null?void 0:n.trim())||""),m.wizStep--,ie())},wizConfirm:bb,_wizSave(){},_updateCharCount:Hb,copyReferralLink(){const e=`${window.location.origin}/#backchat?ref=${c.userAddress}`;navigator.clipboard.writeText(e).then(()=>x("Referral link copied!","success"),()=>x("Failed to copy","error"))},shareReferral(){const e=`${window.location.origin}/#backchat?ref=${c.userAddress}`,t="Join Backchat — earn crypto by posting, liking, and referring friends! 30% referral rewards.";navigator.share?navigator.share({title:"Backchat Referral",text:t,url:e}).catch(()=>{}):navigator.clipboard.writeText(`${t}
${e}`).then(()=>x("Referral message copied!","success"),()=>x("Failed to copy","error"))}};window.BackchatPage=hd;const Ub=window.inject||(()=>{console.warn("Dev Mode: Analytics disabled.")});if(window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1")try{Ub()}catch(e){console.error("Analytics Error:",e)}const Ns="".toLowerCase();window.__ADMIN_WALLET__=Ns;Ns&&console.log("✅ Admin access granted");let Pt=null,la=null,ei=!1;const fe={dashboard:xc,mine:ui,store:xf,rewards:ui,actions:qf,charity:gd,backchat:hd,notary:Dc,airdrop:zm,tokenomics:m0,about:rm,admin:a0,rental:qc,socials:og,creditcard:lg,dex:j,dao:cg,tutorials:Zc};function vd(e){return!e||e.length<42?"...":`${e.slice(0,6)}...${e.slice(-4)}`}function jb(e){if(!e)return"0.00";const t=F(e);return t>=1e9?(t/1e9).toFixed(2)+"B":t>=1e6?(t/1e6).toFixed(2)+"M":t>=1e4?t.toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):t.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function sa(e,t=!1){const a=document.querySelector("main > div.container"),n=document.querySelectorAll(".sidebar-link");if(!a){console.error("❌ Page container not found");return}e==="rewards"&&(e="mine",window.location.hash="mine");const i=window.location.hash.includes("/");if(!(Pt!==e||t||i)){fe[e]&&typeof fe[e].update=="function"&&fe[e].update(c.isConnected);return}console.log(`📍 Navigating: ${Pt} → ${e} (force: ${t})`),la&&typeof la=="function"&&(la(),la=null),Array.from(a.children).forEach(l=>{l.tagName==="SECTION"&&(l.classList.add("hidden"),l.classList.remove("active"))});const r=document.getElementById("charity-container");r&&e!=="charity"&&(r.innerHTML=""),n.forEach(l=>{l.classList.remove("active"),l.classList.add("text-zinc-400","hover:text-white","hover:bg-zinc-700")});const o=document.getElementById(e);if(o&&fe[e]){o.classList.remove("hidden"),o.classList.add("active");const l=Pt!==e;Pt=e;const d=document.querySelector(`.sidebar-link[data-target="${e}"]`);d&&(d.classList.remove("text-zinc-400","hover:text-white","hover:bg-zinc-700"),d.classList.add("active")),fe[e]&&typeof fe[e].render=="function"&&fe[e].render(l||t),typeof fe[e].cleanup=="function"&&(la=fe[e].cleanup),l&&window.scrollTo(0,0)}else e!=="dashboard"&&e!=="faucet"&&(console.warn(`Route '${e}' not found, redirecting to dashboard.`),sa("dashboard",!0))}window.navigateTo=sa;const Fr="wallet-btn text-xs font-mono text-center max-w-fit whitespace-nowrap relative font-bold py-2 px-4 rounded-md transition-colors";function Ss(e=!1){ei||(ei=!0,requestAnimationFrame(()=>{Wb(e),ei=!1}))}function Wb(e){const t=document.getElementById("admin-link-container"),a=document.getElementById("statUserBalance"),n=document.getElementById("connectButtonDesktop"),i=document.getElementById("connectButtonMobile"),s=document.getElementById("mobileAppDisplay");let r=c.userAddress;const o=[n,i];if(c.isConnected&&r){const d=jb(c.currentUserBalance),f=`
            <div class="status-dot"></div>
            <span>${vd(r)}</span>
            <div class="balance-pill">
                ${d} BKC
            </div>
        `;if(o.forEach(p=>{p&&(p.innerHTML=f,p.className=Fr+" wallet-btn-connected")}),s&&(s.textContent="Backcoin.org",s.classList.add("text-white"),s.classList.remove("text-amber-400")),t){const p=r.toLowerCase()===Ns;t.style.display=p?"block":"none"}a&&(a.textContent=d)}else{const d='<i class="fa-solid fa-plug"></i> Connect Wallet';o.forEach(u=>{u&&(u.innerHTML=d,u.className=Fr+" wallet-btn-disconnected")}),s&&(s.textContent="Backcoin.org",s.classList.add("text-amber-400"),s.classList.remove("text-white")),t&&(t.style.display="none"),a&&(a.textContent="--")}const l=Pt||"dashboard";e||!Pt?sa(l,!0):fe[l]&&typeof fe[l].update=="function"&&fe[l].update(c.isConnected)}function Gb(e){const{isConnected:t,address:a,isNewConnection:n,wasConnected:i}=e,s=n||t!==i;c.isConnected=t,a&&(c.userAddress=a),Ss(s),t&&n?x(`Connected: ${vd(a)}`,"success"):!t&&i&&x("Wallet disconnected.","info")}function Kb(){const e=document.getElementById("testnet-banner"),t=document.getElementById("close-testnet-banner");if(!(!e||!t)){if(localStorage.getItem("hideTestnetBanner")==="true"){e.remove();return}e.style.transform="translateY(0)",t.addEventListener("click",()=>{e.style.transform="translateY(100%)",setTimeout(()=>e.remove(),500),localStorage.setItem("hideTestnetBanner","true")})}}function Yb(){const e=document.querySelectorAll(".sidebar-link"),t=document.getElementById("menu-btn"),a=document.getElementById("sidebar"),n=document.getElementById("sidebar-backdrop"),i=document.getElementById("connectButtonDesktop"),s=document.getElementById("connectButtonMobile"),r=document.getElementById("shareProjectBtn");Kb(),e.length>0&&e.forEach(l=>{l.addEventListener("click",async d=>{d.preventDefault();const u=l.dataset.target;if(u==="faucet"){x("Accessing Testnet Faucet...","info"),await _i("BKC")&&Ss(!0);return}u&&(window.location.hash=u,sa(u,!0),a&&a.classList.contains("translate-x-0")&&(a.classList.remove("translate-x-0"),a.classList.add("-translate-x-full"),n&&n.classList.add("hidden")))})});const o=()=>{ro()};i&&i.addEventListener("click",o),s&&s.addEventListener("click",o),r&&r.addEventListener("click",()=>Rd(c.userAddress)),t&&a&&n&&(t.addEventListener("click",()=>{a.classList.contains("translate-x-0")?(a.classList.add("-translate-x-full"),a.classList.remove("translate-x-0"),n.classList.add("hidden")):(a.classList.remove("-translate-x-full"),a.classList.add("translate-x-0"),n.classList.remove("hidden"))}),n.addEventListener("click",()=>{a.classList.add("-translate-x-full"),a.classList.remove("translate-x-0"),n.classList.add("hidden")}))}function wd(){const e=window.location.hash.replace("#","");if(!e)return"dashboard";const t=e.split(/[/?]/)[0];return fe[t]?t:"dashboard"}function yd(){try{const e=window.location.hash,t=e.indexOf("?");if(t===-1)return;const n=new URLSearchParams(e.substring(t)).get("ref");n&&/^0x[a-fA-F0-9]{40}$/.test(n)&&(localStorage.getItem("backchain_referrer")||(localStorage.setItem("backchain_referrer",n),console.log("[Referral] Captured referrer from URL:",n)))}catch(e){console.warn("[Referral] Failed to parse referral param:",e.message)}}window.addEventListener("load",async()=>{console.log("🚀 App Initializing..."),Be.earn||(Be.earn=document.getElementById("mine"));try{if(!await Ud())throw new Error("Failed to load contract addresses")}catch(a){console.error("❌ Critical Initialization Error:",a),x("Initialization failed. Please refresh.","error");return}Yb(),await _u(),Fu(Gb),_d();const e=document.getElementById("preloader");e&&(e.style.display="none"),yd();const t=wd();console.log("📍 Initial page from URL:",t,"Hash:",window.location.hash),sa(t,!0),console.log("✅ App Ready.")});window.addEventListener("hashchange",()=>{yd();const e=wd(),t=window.location.hash;console.log("🔄 Hash changed to:",e,"Full hash:",t),e!==Pt?sa(e,!0):e==="charity"&&fe[e]&&typeof fe[e].render=="function"&&fe[e].render(!0)});window.StakingPage=ui;window.openConnectModal=ro;window.disconnectWallet=Mu;window.updateUIState=Ss;export{zt as C,X as E,ep as G,le as N,ap as T,ee as V,Dn as a,On as b,h as c,Hn as d,ae as e,tp as f,Fi as g,fo as h,ip as i,sp as j,Ve as k,rp as l,Ut as n,Q as r,np as s,U as t};
