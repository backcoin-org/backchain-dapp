import{defaultConfig as Wc,createWeb3Modal as Gc}from"https://esm.sh/@web3modal/ethers@5.1.11?bundle";import{initializeApp as Kc}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-app.js";import{getAuth as Yc,onAuthStateChanged as qc,signInAnonymously as Vc}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-auth.js";import{getFirestore as Xc,collection as Xe,query as Et,where as Zn,orderBy as Yt,getDocs as it,doc as te,getDoc as Ae,limit as Jc,serverTimestamp as ot,writeBatch as fa,updateDoc as ba,increment as Me,setDoc as ga,Timestamp as yr,addDoc as Zc,deleteDoc as Qc}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-firestore.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function n(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(s){if(s.ep)return;s.ep=!0;const r=n(s);fetch(s.href,r)}})();const Be={sidebar:document.getElementById("sidebar"),sidebarBackdrop:document.getElementById("sidebar-backdrop"),menuBtn:document.getElementById("menu-btn"),navLinks:document.getElementById("nav-links"),mainContentSections:document.querySelectorAll("main section"),connectButtonDesktop:document.getElementById("connectButtonDesktop"),connectButtonMobile:document.getElementById("connectButtonMobile"),mobileAppDisplay:document.getElementById("mobileAppDisplay"),desktopDisconnected:document.getElementById("desktopDisconnected"),desktopConnectedInfo:document.getElementById("desktopConnectedInfo"),desktopUserAddress:document.getElementById("desktopUserAddress"),desktopUserBalance:document.getElementById("desktopUserBalance"),modalContainer:document.getElementById("modal-container"),toastContainer:document.getElementById("toast-container"),dashboard:document.getElementById("dashboard"),earn:document.getElementById("mine"),store:document.getElementById("store"),rental:document.getElementById("rental"),rewards:document.getElementById("rewards"),actions:document.getElementById("actions"),presale:document.getElementById("presale"),faucet:document.getElementById("faucet"),airdrop:document.getElementById("airdrop"),dao:document.getElementById("dao"),about:document.getElementById("about"),admin:document.getElementById("admin"),tokenomics:document.getElementById("tokenomics"),notary:document.getElementById("notary"),statTotalSupply:document.getElementById("statTotalSupply"),statValidators:document.getElementById("statValidators"),statTotalPStake:document.getElementById("statTotalPStake"),statScarcity:document.getElementById("statScarcity"),statLockedPercentage:document.getElementById("statLockedPercentage"),statUserBalance:document.getElementById("statUserBalance"),statUserPStake:document.getElementById("statUserPStake"),statUserRewards:document.getElementById("statUserRewards")},ed={provider:null,publicProvider:null,web3Provider:null,signer:null,userAddress:null,isConnected:!1,bkcTokenContract:null,delegationManagerContract:null,rewardBoosterContract:null,nftLiquidityPoolContract:null,actionsManagerContract:null,fortunePoolContract:null,faucetContract:null,decentralizedNotaryContract:null,ecosystemManagerContract:null,publicSaleContract:null,rentalManagerContract:null,bkcTokenContractPublic:null,delegationManagerContractPublic:null,faucetContractPublic:null,fortunePoolContractPublic:null,rentalManagerContractPublic:null,ecosystemManagerContractPublic:null,actionsManagerContractPublic:null,currentUserBalance:0n,currentUserNativeBalance:0n,userTotalPStake:0n,userDelegations:[],myBoosters:[],activityHistory:[],totalNetworkPStake:0n,allValidatorsData:[],systemFees:{},systemPStakes:{},boosterDiscounts:{},notaryFee:void 0,notaryMinPStake:void 0},td={set(e,t,n){return e[t]=n,["currentUserBalance","isConnected","userTotalPStake","totalNetworkPStake"].includes(t)&&window.updateUIState&&window.updateUIState(),!0}},c=new Proxy(ed,td);let kr=!1;const x=(e,t="info",n=null)=>{if(!Be.toastContainer)return;const a={success:{icon:"fa-check-circle",color:"bg-green-600",border:"border-green-400"},error:{icon:"fa-exclamation-triangle",color:"bg-red-600",border:"border-red-400"},info:{icon:"fa-info-circle",color:"bg-blue-600",border:"border-blue-400"},warning:{icon:"fa-exclamation-circle",color:"bg-yellow-600",border:"border-yellow-400"}},s=a[t]||a.info,r=document.createElement("div");r.className=`flex items-center w-full max-w-xs p-4 text-white rounded-lg shadow-lg transition-all duration-500 ease-out 
    ...
    `;vn(n,"max-w-md")}const Tr=e=>{window.navigateTo?window.navigateTo(e):console.error("navigateTo function not found."),we()};function sd(){var s,r,i,o,l,d;if(kr)return;kr=!0;const e="https://t.me/BackCoinorg",t="https://github.com/backcoin-org/backchain-dapp";vn(`
    ...
    `}async function up(){try{const e=await fetch(Ju);if(e.ok){const t=await e.json();return S.economicData=t,t}}catch{}return null}async function is(){var e,t,n,a,s,r,i,o,l;try{const d=await up();let u=0n,f=0n,m=0n,b=0n,p=0n,g=0,y=0n;if(d)if(console.log("📊 Firebase economic data:",d.economy),(e=d.economy)!=null&&e.totalSupply&&(u=BigInt(d.economy.totalSupply)),(t=d.economy)!=null&&t.totalPStake&&(f=BigInt(d.economy.totalPStake)),(n=d.economy)!=null&&n.totalTVL&&(m=BigInt(d.economy.totalTVL)),(a=d.economy)!=null&&a.totalFeesCollected&&(p=BigInt(d.economy.totalFeesCollected)),(s=d.economy)!=null&&s.fortunePoolBalance&&(y=BigInt(d.economy.fortunePoolBalance)),(r=d.stats)!=null&&r.notarizedDocuments&&(g=d.stats.notarizedDocuments),(i=d.burn)!=null&&i.totalBurned)b=BigInt(d.burn.totalBurned);else if((o=d.burn)!=null&&o.sources){let D=0n;for(const W of Object.values(d.burn.sources))W!=null&&W.total&&(D+=BigInt(W.total));b=D}else(l=d.rental)!=null&&l.totalBurned&&(b=BigInt(d.rental.totalBurned));if(c.bkcTokenContractPublic&&(u===0n&&(console.log("📊 Fetching totalSupply from blockchain (fallback)..."),u=await ne(c.bkcTokenContractPublic,"totalSupply",[],0n)),f===0n&&c.delegationManagerContractPublic&&(console.log("📊 Fetching totalPStake from blockchain (fallback)..."),f=await ne(c.delegationManagerContractPublic,"totalNetworkPStake",[],0n)),m===0n)){console.log("📊 Calculating TVL from blockchain (fallback)...");const D=[w.delegationManager,w.fortunePool,w.rentalManager,w.miningManager,w.decentralizedNotary,w.nftLiquidityPoolFactory,w.pool_diamond,w.pool_platinum,w.pool_gold,w.pool_silver,w.pool_bronze,w.pool_iron,w.pool_crystal].filter(ae=>ae&&ae!==jt.ZeroAddress),W=D.map(ae=>ne(c.bkcTokenContractPublic,"balanceOf",[ae],0n)),oe=await Promise.all(W);if(oe.forEach(ae=>{m+=ae}),w.fortunePool&&y===0n){const ae=D.indexOf(w.fortunePool);ae>=0&&(y=oe[ae])}}const k=_(u),E=_(b),I=_(p),N=_(y),z=D=>D.toLocaleString("en-US",{minimumFractionDigits:1,maximumFractionDigits:1});let T=0;u>0n&&(T=Number(m*10000n/u)/100),T>100&&(T=100);const F=(D,W,oe="")=>{const ae=document.getElementById(D);ae&&(ae.innerHTML=`${W}${oe?` <span class="text-xs text-zinc-500">${oe}</span>`:""}`)},G=document.getElementById("dash-metric-supply");G&&(G.innerHTML=`${z(k)} <span style="font-size: 10px; color: #71717a">BKC</span>`),F("dash-metric-pstake",Ut(f));const se=document.getElementById("dash-metric-burned");se&&(E>0?se.innerHTML=`<span class="text-red-400">${Oa(E)}</span> <span class="text-xs text-zinc-500">BKC 🔥</span>`:se.innerHTML='<span class="text-zinc-500">0</span> <span class="text-xs text-zinc-500">BKC</span>'),F("dash-metric-fees",Oa(I),"BKC");const de=document.getElementById("dash-metric-tvl");if(de){const D=T>30?"text-green-400":T>10?"text-yellow-400":"text-blue-400";de.innerHTML=`<span class="${D}">${T.toFixed(1)}%</span>`}jl();const xe=document.getElementById("dash-fortune-prize");xe&&(xe.innerText=`${Oa(N)} BKC`);const Q=document.getElementById("dash-notary-count");Q&&(Q.innerText=g>0?`${g} docs`:"--"),S.metricsCache={supply:k,burned:E,fees:I,timestamp:Date.now()}}catch(d){console.error("Metrics Error",d)}}async function pp(){if(c.userAddress)try{const e=await fetch(`https://getuserprofile-4wvdcuoouq-uc.a.run.app/${c.userAddress}`);e.ok&&(S.userProfile=await e.json(),mp(S.userProfile))}catch{}}function mp(e){const t=document.getElementById("dash-presale-stats");if(!t||!e||!e.presale||!e.presale.totalBoosters||e.presale.totalBoosters===0)return;t.classList.remove("hidden");const n=e.presale.totalSpentWei||0,a=parseFloat(jt.formatEther(BigInt(n))).toFixed(4);document.getElementById("stats-total-spent").innerText=`${a} ETH`,document.getElementById("stats-total-boosters").innerText=e.presale.totalBoosters||0;const s=document.getElementById("stats-tier-badges");if(s&&e.presale.tiersOwned){let r="";Object.entries(e.presale.tiersOwned).forEach(([i,o])=>{const l=ge[Number(i)-1],d=l?l.name:`T${i}`;r+=`<span class="text-[9px] bg-zinc-800 text-zinc-400 px-1.5 py-0.5 rounded">${o}x ${d}</span>`}),r&&(s.innerHTML=r)}}function jl(){const e=document.getElementById("dash-metric-balance"),t=document.getElementById("dash-balance-card");if(!e)return;const n=c.currentUserBalance||c.bkcBalance||0n;if(!c.isConnected){e.innerHTML='<span class="text-zinc-500 text-xs">Connect Wallet</span>',t&&(t.style.borderColor="rgba(63,63,70,0.5)");return}if(n===0n)e.innerHTML='0.00 <span style="font-size: 10px; color: #71717a">BKC</span>';else{const s=_(n).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2});e.innerHTML=`${s} <span style="font-size: 10px; color: #71717a">BKC</span>`}t&&(t.style.borderColor="rgba(245,158,11,0.3)")}async function _t(e=!1){var t,n;if(!c.isConnected){const a=document.getElementById("dash-booster-area");a&&(a.innerHTML=`
        ...
        `;return}const d=e.source==="rented",u=d?"bg-cyan-500/20 text-cyan-300":"bg-green-500/20 text-green-300",f=d?"Rented":"Owned",m=ud(a),b=(m==null?void 0:m.name)||((E=e.boostName)==null?void 0:E.replace(" Booster","").replace("Booster","").trim())||"Booster",p=(m==null?void 0:m.color)||"text-amber-400",g=(m==null?void 0:m.emoji)||"💎",y=r*50n/100n,k=i-y;console.log("🎨 V6.8 Booster:",{keepRate:s,netReward:_(i),tierName:b}),n.innerHTML=`
    ...
    `}async function ta(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("activity-title");try{if(c.isConnected){if(S.activities.length===0){e&&(e.innerHTML=`
                    ...
                    `);const n=await fetch(`${Te.getHistory}/${c.userAddress}`);n.ok&&(S.activities=await n.json())}if(S.activities.length>0){t&&(t.textContent="Your Activity"),os();return}}t&&(t.textContent="Network Activity"),await Kr()}catch(n){console.error("Activity fetch error:",n),t&&(t.textContent="Network Activity"),await Kr()}}async function Kr(){const e=document.getElementById("dash-activity-list");if(!e||S.isLoadingNetworkActivity)return;const t=Date.now()-S.networkActivitiesTimestamp;if(S.networkActivities.length>0&&t<3e5){Yr();return}S.isLoadingNetworkActivity=!0,e.innerHTML=`
        <div class="flex flex-col items-center justify-center py-8">
            <div class="relative">
                <div class="absolute inset-0 bg-amber-500/30 blur-xl rounded-full animate-pulse"></div>
                <img src="./assets/bkc_logo_3d.png" class="relative w-12 h-12 object-contain animate-bounce" alt="Loading">
    ...
    `;try{const n=await fetch(`${Xu}?limit=30`);if(n.ok){const a=await n.json();S.networkActivities=Array.isArray(a)?a:a.activities||[],S.networkActivitiesTimestamp=Date.now()}else S.networkActivities=[]}catch(n){console.error("Network activity fetch error:",n),S.networkActivities=[]}finally{S.isLoadingNetworkActivity=!1}Yr()}function Yr(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("dash-pagination-controls");if(e){if(S.networkActivities.length===0){e.innerHTML=`
        ...
        `,t&&t.classList.add("hidden");return}const n=(S.pagination.currentPage-1)*S.pagination.itemsPerPage,a=n+S.pagination.itemsPerPage,s=S.filteredActivities.slice(n,a);if(e.innerHTML=s.map(r=>Wl(r,!1)).join(""),t){const r=Math.ceil(S.filteredActivities.length/S.pagination.itemsPerPage);r>1?(t.classList.remove("hidden"),document.getElementById("page-indicator").innerText=`${S.pagination.currentPage}/${r}`,document.getElementById("page-prev").disabled=S.pagination.currentPage===1,document.getElementById("page-next").disabled=S.pagination.currentPage>=r):t.classList.add("hidden")}}function Wl(e,t=!1){const n=Qu(e.timestamp||e.createdAt),a=ep(e.timestamp||e.createdAt),s=e.user||e.userAddress||e.from||"",r=tp(s),i=ap(e.type,e.details);let o="";const l=(e.type||"").toUpperCase().trim(),d=e.details||{};if(l.includes("GAME")||l.includes("FORTUNE")||l.includes("REQUEST")||l.includes("FULFILLED")||l.includes("RESULT")){const g=d.rolls||e.rolls||[],y=d.guesses||e.guesses||[],k=d.isWin||d.prizeWon&&BigInt(d.prizeWon||0)>0n,E=d.isCumulative!==void 0?d.isCumulative:y.length>1,I=d.wagerAmount||d.amount,N=d.prizeWon,z=E?"Combo":"Jackpot",T=E?"bg-purple-500/20 text-purple-400":"bg-amber-500/20 text-amber-400",F=I?_(BigInt(I)).toFixed(0):"0";let G="No win",se="text-zinc-500";k&&N&&BigInt(N)>0n&&(G=`<span class="text-emerald-400 font-bold">+${_(BigInt(N)).toFixed(0)} BKC</span>`,se="");let de="";return g.length>0&&(de=`<div class="flex gap-1">
            ...
            <a href="${e.txHash?`${Wr}${e.txHash}`:"#"}" target="_blank" class="block p-3 hover:bg-zinc-800/50 border border-zinc-700/30 rounded-lg transition-all group" style="background: rgba(39,39,42,0.4)" title="${a}">
    ...
    `,Np(),c.isConnected?Qt(!0):Qs())}async function Qt(e=!1){var n;if(!c.isConnected){Qs();return}const t=Date.now();if(!(!e&&Dt)&&!(!e&&t-En<1e4)){Dt=!0,En=t;try{await yp();try{const a=await fetch("https://getsystemdata-4wvdcuoouq-uc.a.run.app");if(a.ok){const s=await a.json();(n=s==null?void 0:s.economy)!=null&&n.totalPStake&&(fn=BigInt(s.economy.totalPStake))}}catch{console.log("Firebase unavailable, using blockchain")}if(fn===0n){const a=c.delegationManagerContractPublic||c.delegationManagerContract;a&&(fn=await ne(a,"totalNetworkPStake",[],0n))}await Promise.all([Pt(!0),Bd(!0),As()]),await kp(),Ep(),Xl(),bn(),Ap()}catch(a){console.error("Staking load error:",a)}finally{Dt=!1}}}async function yp(){try{const e=c.delegationManagerContract||c.delegationManagerContractPublic;if(e&&c.userAddress)try{const n=await e.getUserBestBoost(c.userAddress);qe=Number(n)}catch{const n=await Ht();qe=(n==null?void 0:n.boost)||0}else{const n=await Ht();qe=(n==null?void 0:n.boost)||0}Cn=Vl(qe).burnRate,Kl=qe>0?"active":"none",Tp()}catch(e){console.error("Error loading NFT boost:",e),qe=0,Cn=50}}async function kp(){try{const e=c.delegationManagerContract||c.delegationManagerContractPublic;if(e&&c.userAddress)try{const t=await e.previewClaim(c.userAddress);Ft={totalRewards:t.totalRewards||t[0],burnAmount:t.burnAmount||t[1],userReceives:t.userReceives||t[2],burnRateBips:t.burnRateBips||t[3],nftBoost:t.nftBoost||t[4]}}catch{const{stakingRewards:t,minerRewards:n}=await qt(),a=t+n,s=a*BigInt(Cn)/100n;Ft={totalRewards:a,burnAmount:s,userReceives:a-s,burnRateBips:BigInt(Cn*100),nftBoost:BigInt(qe)}}}catch(e){console.error("Error loading claim preview:",e)}}function Tp(){const e=Vl(qe),t=document.getElementById("nft-tier-icon");t&&(t.textContent=e.icon,t.style.background=`${e.color}20`);const n=document.getElementById("nft-tier-badge");n&&(n.className=`nft-tier-badge tier-${e.name.toLowerCase()}`,n.innerHTML=`<span>${e.icon} ${e.name}</span>`);const a=document.getElementById("nft-source");a&&(qe>0?(a.classList.remove("hidden"),a.textContent=Kl):a.classList.add("hidden"));const s=document.getElementById("burn-rate-text");s&&(e.burnRate===0?s.innerHTML='<span class="text-green-400">No burn! You keep 100% of rewards</span>':s.textContent=`${e.burnRate}% of rewards will be burned on claim`);const r=document.getElementById("burn-rate-value"),i=document.getElementById("keep-rate-value");r&&(r.textContent=`${e.burnRate}%`),i&&(i.textContent=`${e.userGets}%`);const o=document.getElementById("burn-fill"),l=document.getElementById("receive-fill");o&&(o.style.width=`${e.burnRate}%`),l&&(l.style.width=`${e.userGets}%`)}function Ep(){var i;const e=(o,l)=>{const d=document.getElementById(o);d&&(d.textContent=l)};e("stat-network",Ut(fn||c.totalNetworkPStake||0n)),e("stat-pstake",Ut(c.userTotalPStake||0n)),e("balance-display",_(c.currentUserBalance||0n).toFixed(2)),e("stat-delegations",(c.userDelegations||[]).length.toString());const t=c.userTotalPStake||0n,n=fn||c.totalNetworkPStake||0n;let a=0;n>0n&&t>0n&&(a=Number(t*10000n/n)/100),e("stat-pstake-percent",a>0?`${a.toFixed(2)}% of network`:"0% of network");const s=((i=c.systemFees)==null?void 0:i.DELEGATION_FEE_BIPS)||50n,r=Number(s)/100;e("fee-info",`${r}% protocol fee`),Cp()}async function Cp(){const e=document.getElementById("claim-section");if(!e)return;const{stakingRewards:t,minerRewards:n}=await qt(),a=t+n,s=(r,i)=>{const o=document.getElementById(r);o&&(o.textContent=i)};if(s("stat-rewards",_(a).toFixed(4)),a>0n){e.classList.remove("hidden");let r,i;Ft&&Ft.totalRewards>0n?(r=Ft.burnAmount,i=Ft.userReceives):(r=a*BigInt(Cn)/100n,i=a-r),s("claim-total",_(a).toFixed(4)),s("claim-burn",_(r).toFixed(4)),s("claim-receive",_(i).toFixed(4)),r>0n?e.classList.add("has-burn"):e.classList.remove("has-burn");const o=document.getElementById("claim-btn");o&&(o.onclick=()=>Pp(t,n,o))}else e.classList.add("hidden")}function Qs(){const e=(s,r)=>{const i=document.getElementById(s);i&&(i.textContent=r)};e("stat-network","--"),e("stat-pstake","--"),e("stat-rewards","--"),e("stat-delegations","0"),e("balance-display","0.00"),e("stat-pstake-percent","--% of network");const t=document.getElementById("delegations-list");t&&(t.innerHTML=`
        ...
        `;return}const s=[...t].sort((r,i)=>Number(r.unlockTime)-Number(i.unlockTime));e.innerHTML=s.map(r=>Ip(r)).join(""),qr(),yt=setInterval(qr,6e4),e.querySelectorAll(".unstake-btn").forEach(r=>{r.addEventListener("click",()=>Vr(r.dataset.index,!1))}),e.querySelectorAll(".force-unstake-btn").forEach(r=>{r.addEventListener("click",()=>{confirm(`⚠️ Force Unstake will apply a 50% penalty!

Are you sure?`)&&Vr(r.dataset.index,!0)})})}function Ip(e){const t=_(e.amount).toFixed(2),n=Ut(ql(e.amount,e.lockDuration)),a=Number(e.unlockTime),s=Math.floor(Date.now()/1e3),r=a>s,i=r?a-s:0,o=Math.floor(Number(e.lockDuration)/86400);return`
    ...
    `}function qr(){const e=document.querySelectorAll(".countdown-timer"),t=Math.floor(Date.now()/1e3);e.forEach(n=>{const a=parseInt(n.dataset.unlockTime);n.textContent=Yl(a-t)})}async function Ap(){if(c.userAddress)try{const e=Te.getHistory||"https://gethistory-4wvdcuoouq-uc.a.run.app",t=await fetch(`${e}/${c.userAddress}`);t.ok&&(cs=(await t.json()||[]).filter(a=>{const s=(a.type||"").toUpperCase();return s.includes("DELEGAT")||s.includes("STAKE")||s.includes("UNDELEGAT")||s.includes("CLAIM")||s.includes("REWARD")||s.includes("FORCE")}),Jl())}catch(e){console.error("History load error:",e)}}function Jl(){const e=document.getElementById("staking-history-list");if(!e)return;let t=cs;if(un!=="ALL"&&(t=cs.filter(n=>{const a=(n.type||"").toUpperCase();switch(un){case"STAKE":return(a.includes("DELEGAT")||a.includes("STAKE"))&&!a.includes("UNSTAKE")&&!a.includes("UNDELEGAT")&&!a.includes("FORCE");case"UNSTAKE":return a.includes("UNSTAKE")||a.includes("UNDELEGAT")||a.includes("FORCE");case"CLAIM":return a.includes("CLAIM")||a.includes("REWARD");default:return!0}})),t.length===0){e.innerHTML=`
            <div class="text-center py-12">
        ...
        `;return}e.innerHTML=t.slice(0,25).map(n=>{const a=(n.type||"").toUpperCase(),s=n.details||{},r=hp(n.timestamp||n.createdAt);let i,o,l,d,u="";a.includes("FORCE")?(i="fa-bolt",o="bg-red-500/15",l="text-red-400",d="Force Unstaked",s.feePaid&&BigInt(s.feePaid)>0n&&(u=`<span class="text-red-400">-${_(BigInt(s.feePaid)).toFixed(2)} penalty</span>`)):(a.includes("DELEGAT")||a.includes("STAKE"))&&!a.includes("UNSTAKE")?(i="fa-lock",o="bg-green-500/15",l="text-green-400",d="Delegated",s.pStakeGenerated&&(u=`<span class="text-purple-400">+${_(BigInt(s.pStakeGenerated)).toFixed(0)} pS</span>`)):a.includes("UNSTAKE")||a.includes("UNDELEGAT")?(i="fa-unlock",o="bg-orange-500/15",l="text-orange-400",d="Unstaked"):a.includes("CLAIM")||a.includes("REWARD")?(i="fa-coins",o="bg-amber-500/15",l="text-amber-400",d="Claimed",s.amountReceived&&BigInt(s.amountReceived)>0n&&(u=`<span class="text-green-400">+${_(BigInt(s.amountReceived)).toFixed(2)}</span>`)):(i="fa-circle",o="bg-zinc-500/15",l="text-zinc-400",d=n.type||"Activity");const f=n.txHash?`${gp}${n.txHash}`:"#",m=n.amount||s.amount||s.amountReceived||"0",b=_(BigInt(m)),p=b>.001?b.toFixed(2):"";return`
        ...
        `}).join("")}function bn(){var a;const e=document.getElementById("amount-input"),t=document.getElementById("stake-btn");if(!e)return;const n=e.value;if(!n||parseFloat(n)<=0){document.getElementById("preview-pstake").textContent="0",document.getElementById("preview-net").textContent="0.00 BKC",t&&(t.disabled=!0);return}try{const s=mn.parseUnits(n,18),r=((a=c.systemFees)==null?void 0:a.DELEGATION_FEE_BIPS)||50n,i=s*BigInt(r)/10000n,o=s-i,l=BigInt(Zs)*86400n,d=ql(o,l);document.getElementById("preview-pstake").textContent=Ut(d),document.getElementById("preview-net").textContent=`${_(o).toFixed(4)} BKC`;const u=c.currentUserBalance||0n;s>u?(e.classList.add("error"),t&&(t.disabled=!0)):(e.classList.remove("error"),t&&(t.disabled=Oe))}catch{t&&(t.disabled=!0)}}async function Bp(){if(Oe)return;const e=document.getElementById("amount-input"),t=document.getElementById("stake-btn");if(document.getElementById("stake-btn-text"),document.getElementById("stake-btn-icon"),!e||!t)return;const n=e.value;if(!n||parseFloat(n)<=0){x("Enter an amount","warning");return}const a=c.currentUserBalance||0n;let s;try{if(s=mn.parseUnits(n,18),s>a){x("Insufficient BKC balance","error");return}}catch{x("Invalid amount","error");return}try{if(await new mn.BrowserProvider(window.ethereum).getBalance(c.userAddress)<mn.parseEther("0.001")){x("Insufficient ETH for gas","error");return}}catch{}Oe=!0;const r=BigInt(Zs)*86400n;try{await It.delegate({amount:s,lockDuration:r,button:t,onSuccess:async()=>{e.value="",x("🔒 Delegation successful!","success"),Dt=!1,En=0,await Qt(!0)},onError:i=>{i.cancelled||x("Delegation failed: "+(i.reason||i.message||"Unknown error"),"error")}})}catch(i){x("Delegation failed: "+(i.reason||i.message||"Unknown error"),"error")}finally{Oe=!1,bn()}}async function Vr(e,t){if(Oe)return;const n=document.querySelector(t?`.force-unstake-btn[data-index='${e}']`:`.unstake-btn[data-index='${e}']`);Oe=!0;try{const a=BigInt(e);await(t?It.forceUnstake:It.unstake)({delegationIndex:a,button:n,onSuccess:async()=>{x(t?"⚡ Force unstaked (50% penalty applied)":"🔓 Unstaked successfully!",t?"warning":"success"),Dt=!1,En=0,await Qt(!0)},onError:r=>{r.cancelled||x("Unstake failed: "+(r.reason||r.message||"Unknown error"),"error")}})}catch(a){x("Unstake failed: "+(a.reason||a.message||"Unknown error"),"error")}finally{Oe=!1,Xl()}}async function Pp(e,t,n){if(!Oe){Oe=!0;try{await It.claimRewards({button:n,onSuccess:async()=>{x("🪙 Rewards claimed!","success"),Dt=!1,En=0,await Qt(!0)},onError:a=>{a.cancelled||x("Claim failed: "+(a.reason||a.message||"Unknown error"),"error")}})}catch(a){x("Claim failed: "+(a.reason||a.message||"Unknown error"),"error")}finally{Oe=!1}}}function Np(){const e=document.getElementById("amount-input"),t=document.getElementById("max-btn"),n=document.getElementById("stake-btn"),a=document.getElementById("refresh-btn"),s=document.querySelectorAll(".duration-chip"),r=document.querySelectorAll(".history-tab");e==null||e.addEventListener("input",bn),t==null||t.addEventListener("click",()=>{const i=c.currentUserBalance||0n;e&&(e.value=mn.formatUnits(i,18),bn())}),s.forEach(i=>{i.addEventListener("click",()=>{s.forEach(o=>o.classList.remove("selected")),i.classList.add("selected"),Zs=parseInt(i.dataset.days),bn()})}),r.forEach(i=>{i.addEventListener("click",()=>{r.forEach(o=>o.classList.remove("active")),i.classList.add("active"),un=i.dataset.filter,Jl()})}),n==null||n.addEventListener("click",Bp),a==null||a.addEventListener("click",()=>{const i=a.querySelector("i");i==null||i.classList.add("fa-spin"),Qt(!0).then(()=>{setTimeout(()=>i==null?void 0:i.classList.remove("fa-spin"),500)})})}function zp(){yt&&(clearInterval(yt),yt=null)}function Lp(e){e?Qt():Qs()}const Zl={render:wp,update:Lp,cleanup:zp},Ie=window.ethers,Sp="https://sepolia.arbiscan.io/tx/",$p=3e4,ds={Diamond:{color:"#22d3ee",gradient:"from-cyan-500/20 to-blue-500/20",border:"border-cyan-500/40",text:"text-cyan-400",glow:"shadow-cyan-500/30",icon:"💎",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeicgip72jcqgsirlrhn3tq5cc226vmko6etnndzl6nlhqrktfikafq",keepRate:100,burnRate:0},Gold:{color:"#fbbf24",gradient:"from-yellow-500/20 to-amber-500/20",border:"border-yellow-500/40",text:"text-yellow-400",glow:"shadow-yellow-500/30",icon:"🥇",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeifponccrbicg2pcjrn2hrfoqgc77xhm2r4ld7hdpw6cxxkbsckf44",keepRate:90,burnRate:10},Silver:{color:"#9ca3af",gradient:"from-gray-400/20 to-slate-400/20",border:"border-gray-400/40",text:"text-gray-300",glow:"shadow-gray-400/30",icon:"🥈",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeihvi2inujm5zpi7tl667g4srq273536pjkglwyrtbwmgnskmu7jg4",keepRate:75,burnRate:25},Bronze:{color:"#f97316",gradient:"from-orange-600/20 to-amber-700/20",border:"border-orange-600/40",text:"text-orange-400",glow:"shadow-orange-500/30",icon:"🥉",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeiclqidb67rt3tchhjpsib62s624li7j2bpxnr6b5w5mfp4tomhu7m",keepRate:60,burnRate:40}};function Ca(e){return ds[e]||ds.Bronze}const L={tradeDirection:"buy",selectedPoolBoostBips:null,buyPrice:0n,sellPrice:0n,netSellPrice:0n,poolNFTCount:0,userBalanceOfSelectedNFT:0,availableToSellCount:0,firstAvailableTokenId:null,firstAvailableTokenIdForBuy:null,bestBoosterTokenId:0n,bestBoosterBips:0,isDataLoading:!1,tradeHistory:[]},na=new Map,er=new Map;let qn=!1,ht=null;const Rp=["function getPoolAddress(uint256 boostBips) view returns (address)","function isPool(address) view returns (bool)"];function _p(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function Fp(e){const t=er.get(e);return t&&Date.now()-t.timestamp<$p?t.data:null}function Ql(e,t){er.set(e,{data:t,timestamp:Date.now()})}function Ua(e){er.delete(e)}function Mp(){if(document.getElementById("swap-styles-v9"))return;const e=document.createElement("style");e.id="swap-styles-v9",e.textContent=`
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <div class="flex items-center gap-3">
                            <div class="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden"
                                 id="trade-mascot">
                                <img src="${ds.Diamond.image}" alt="NFT" class="w-full h-full object-contain" onerror="this.outerHTML='<span class=\\'text-3xl\\'>💎</span>'">
                            </div>
                            <div>
    ...
    `}function Up(e,t,n,a,s=!1){return c.isConnected?e?t?`
        ...
        `}function jp(e){const t=document.getElementById("trade-mascot");t&&(t.className=`w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden ${e?"trade-buy":"trade-sell"}`)}function Zr(){const e=document.getElementById("inventory-grid"),t=document.getElementById("nft-count");if(!e)return;const n=c.myBoosters||[];if(t&&(t.textContent=n.length),!c.isConnected){e.innerHTML='<div class="col-span-4 text-center py-4 text-xs text-zinc-600">Connect wallet</div>';return}if(n.length===0){e.innerHTML=`
    ...
    `}function e0(){return In.length===0?`
            <div class="text-center py-8">
                <i class="fa-solid fa-inbox text-zinc-700 text-2xl mb-3"></i>
                <p class="text-zinc-600 text-xs">No claims yet</p>
            </div>
        `:In.map(e=>{const t=e.amount?(Number(e.amount)/1e18).toFixed(4):"0",n=e.burnedAmount&&Number(e.burnedAmount)>0?(Number(e.burnedAmount)/1e18).toFixed(2):null,a=e.timestamp?Yp(new Date(e.timestamp)):"";return`
        ...
        `}).join("")}async function t0(){if(Jn)return;const e=document.getElementById("claim-btn");if(e){Jn=!0;try{await It.claimRewards({button:e,onSuccess:t=>{x("🎁 Rewards claimed successfully!","success"),setTimeout(()=>{ia.clearCache(),In=[],ia.update(!0)},2500)},onError:t=>{t&&!t.cancelled&&t.type!=="user_rejected"&&x(t.message||"Claim failed","error")}})}catch(t){console.error("Claim error:",t),x(t.message||"Claim failed","error")}finally{Jn=!1}}}window.RewardsPage=ia;const tr="https://sepolia.arbiscan.io/tx/",ps="https://sepolia.arbiscan.io/address/",tc="0x16346f5a45f9615f1c894414989f0891c54ef07b",n0=(w==null?void 0:w.fortunePool)||"0x277dB00d533Bbc0fc267bbD954640aDA38ee6B37",oa="./assets/fortune.png",ms=1e3,ti={pt:{title:"Compartilhe & Ganhe!",subtitle:"+1000 pontos para o Airdrop",later:"Talvez depois"},en:{title:"Share & Earn!",subtitle:"+1000 points for Airdrop",later:"Maybe later"},es:{title:"¡Comparte y Gana!",subtitle:"+1000 puntos para el Airdrop",later:"Quizás después"}},a0={pt:{win:e=>`🎉 Ganhei ${e.toLocaleString()} BKC no Fortune Pool!
...
#Backcoin #Web3 #Arbitrum`}},Ga={pt:"./assets/pt.png",en:"./assets/en.png",es:"./assets/es.png"};let Ge="en";const ue=[{id:1,name:"Easy",emoji:"🍀",range:3,multiplier:2,chance:"33%",color:"emerald",hex:"#10b981",bgFrom:"from-emerald-500/20",bgTo:"to-green-600/10",borderColor:"border-emerald-500/50",textColor:"text-emerald-400"},{id:2,name:"Medium",emoji:"⚡",range:10,multiplier:5,chance:"10%",color:"violet",hex:"#8b5cf6",bgFrom:"from-violet-500/20",bgTo:"to-purple-600/10",borderColor:"border-violet-500/50",textColor:"text-violet-400"},{id:3,name:"Hard",emoji:"👑",range:100,multiplier:50,chance:"1%",color:"amber",hex:"#f59e0b",bgFrom:"from-amber-500/20",bgTo:"to-orange-600/10",borderColor:"border-amber-500/50",textColor:"text-amber-400"}],nc=57,v={mode:null,phase:"select",guess:50,guesses:[2,5,50],comboStep:0,wager:10,gameId:null,result:null,txHash:null,poolStatus:null,history:[],serviceFee:0n,serviceFee1x:0n,serviceFee5x:0n,tiersData:null,commitment:{hash:null,userSecret:null,commitBlock:null,commitTxHash:null,revealDelay:2,waitStartTime:null,canReveal:!1}};let Le=null;const s0=3e3,ac=250;function r0(){if(document.getElementById("fortune-styles-v2"))return;const e=document.createElement("style");e.id="fortune-styles-v2",e.textContent=`
        ...
        <div class="max-w-md mx-auto px-4 py-6">
            ...
            <div class="text-center mb-6">
                ...
                <div class="flex items-center justify-center gap-2 mt-3 flex-wrap">
                    <a href="${ps}${tc}" target="_blank" rel="noopener" 
                    ...
                    <a href="${ps}${n0}" target="_blank" rel="noopener" 
    ...
    `,ar(),le()}function o0(){Le&&(clearInterval(Le),Le=null),v.phase="select",v.result=null,v.commitment={hash:null,userSecret:null,commitBlock:null,commitTxHash:null,revealDelay:v.commitment.revealDelay||2,waitStartTime:null,canReveal:!1}}function le(){const e=document.getElementById("game-area");if(e)switch(l0(v.phase),v.phase){case"select":ni(e);break;case"pick":c0(e);break;case"wager":p0(e);break;case"processing":f0(e);break;case"waiting":b0(e);break;case"result":w0(e);break;default:ni(e)}}function l0(e){var n;const t=document.getElementById("tiger-mascot");if(t)switch(t.className="w-28 h-28 object-contain mx-auto",t.style.filter="",e){case"select":t.classList.add("tiger-float","tiger-pulse");break;case"pick":case"wager":t.classList.add("tiger-float");break;case"processing":t.classList.add("tiger-spin");break;case"waiting":t.classList.add("tiger-float"),t.style.filter="hue-rotate(270deg)";break;case"result":((n=v.result)==null?void 0:n.prizeWon)>0?t.classList.add("tiger-celebrate"):(t.style.filter="grayscale(0.5)",t.classList.add("tiger-float"));break}}function ni(e){var s,r;const t=v.serviceFee1x>0n?(Number(v.serviceFee1x)/1e18).toFixed(6):"0",n=v.serviceFee5x>0n?(Number(v.serviceFee5x)/1e18).toFixed(6):"0",a=v.serviceFee1x>0n||v.serviceFee5x>0n;e.innerHTML=`
        <div class="space-y-4">
            <!-- JACKPOT MODE -->
    ...
    `,a.forEach((s,r)=>{const i=document.getElementById(`spin-${r}`);if(!i)return;setInterval(()=>{i.textContent=Math.floor(Math.random()*s.range)+1},80)})}function b0(e){var l;const t=v.mode==="jackpot",n=t?[v.guess]:v.guesses,a=t?[ue[2]]:ue,s=Date.now()-(v.commitment.waitStartTime||Date.now()),r=v.commitment.revealDelay*ac,i=Math.max(0,r-s),o=Math.ceil(i/1e3);e.innerHTML=`
        <div class="bg-gradient-to-br from-violet-900/30 to-purple-900/20 border border-violet-500/30 rounded-2xl p-6 waiting-glow">
            ...
            ${v.commitment.commitTxHash?`
                <div class="text-center mt-3">
                    <a href="${tr}${v.commitment.commitTxHash}" target="_blank" 
        ...
        <div class="bg-gradient-to-br ${l?"from-emerald-900/30 to-green-900/10 border-emerald-500/30":"from-zinc-900 to-zinc-800/50 border-zinc-700/50"} border rounded-2xl p-4 sm:p-6 relative overflow-hidden" id="result-container">
            ...
            ${v.txHash?`
                <div class="text-center mb-3">
                    <a href="${tr}${v.txHash}" target="_blank" class="inline-flex items-center gap-2 text-xs text-zinc-500 hover:text-zinc-400">
                        <i class="fa-solid fa-external-link"></i>
                        View Transaction
                    </a>
                </div>
            ...
            <div class="bg-gradient-to-r ${l?"from-amber-500/10 to-orange-500/10 border-amber-500/30":"from-zinc-800/50 to-zinc-700/30 border-zinc-600/30"} border rounded-xl p-3 mb-3">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <div>
                        ...
                        <p class="text-amber-400 text-xs font-medium">+${ms} Airdrop Points</p>
                    </div>
                </div>
    ...
    `,l&&(y0(),d>v.wager*10&&k0()),(f=document.getElementById("btn-new-game"))==null||f.addEventListener("click",()=>{v.phase="select",v.result=null,v.txHash=null,v.gameId=null,le(),ar()}),(m=document.getElementById("btn-share"))==null||m.addEventListener("click",()=>{T0(l,d)})}function y0(){const e=document.createElement("div");e.className="confetti-container",document.body.appendChild(e);const t=["#f59e0b","#10b981","#8b5cf6","#ec4899","#06b6d4"],n=["●","■","★","🐯","🎉"];for(let a=0;a<60;a++){const s=document.createElement("div");s.className="confetti",s.style.cssText=`
            left: ${Math.random()*100}%;
            color: ${t[a%t.length]};
            font-size: ${8+Math.random()*12}px;
            animation-delay: ${Math.random()*2}s;
            animation-duration: ${2+Math.random()*2}s;
        `,s.textContent=n[a%n.length],e.appendChild(s)}setTimeout(()=>e.remove(),5e3)}function k0(){const e=["🪙","💰","✨","⭐","🎉"];for(let t=0;t<30;t++)setTimeout(()=>{const n=document.createElement("div");n.className="coin",n.textContent=e[Math.floor(Math.random()*e.length)],n.style.left=`${Math.random()*100}%`,n.style.animationDelay=`${Math.random()*.5}s`,n.style.animationDuration=`${2+Math.random()*2}s`,document.body.appendChild(n),setTimeout(()=>n.remove(),4e3)},t*100)}function T0(e,t){var l,d,u,f,m,b;const n=ti[Ge],a=()=>{const p=a0[Ge];return e?p.win(t):p.lose},s=`
        <div class="text-center">
    ...
    `;vn(s,"max-w-xs");const r=p=>{Ge=p;const g=ti[p],y=document.getElementById("share-modal-title"),k=document.getElementById("share-modal-subtitle"),E=document.getElementById("btn-close-share");y&&(y.textContent=g.title),k&&(k.textContent=g.subtitle),E&&(E.textContent=g.later),document.querySelectorAll(".lang-btn").forEach(I=>{const N=I.dataset.lang,z=I.querySelector("span");N===p?(I.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-amber-500/20 border-amber-500 ring-1 ring-amber-500/50 border",z&&(z.className="text-amber-400")):(I.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-zinc-800 border-zinc-700 hover:border-zinc-500 border",z&&(z.className="text-zinc-400"))})};document.querySelectorAll(".lang-btn").forEach(p=>{p.addEventListener("click",()=>r(p.dataset.lang))});const i=async p=>{if(!c.userAddress)return!1;try{const y=await(await fetch("https://us-central1-backchain-backand.cloudfunctions.net/trackShare",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({address:c.userAddress,gameId:v.gameId||Date.now(),type:"fortune",platform:p})})).json();return y.success?(x(`🎉 +${y.pointsAwarded||ms} Airdrop Points!`,"success"),!0):(y.reason==="already_shared"&&console.log("Already shared this game"),!1)}catch(g){return console.error("Share tracking error:",g),x(`🎉 +${ms} Airdrop Points!`,"success"),!0}},o=async(p,g)=>{await i(p),window.open(g,"_blank"),we()};(l=document.getElementById("share-twitter"))==null||l.addEventListener("click",()=>{const p=a();o("twitter",`https://twitter.com/intent/tweet?text=${encodeURIComponent(p)}`)}),(d=document.getElementById("share-telegram"))==null||d.addEventListener("click",()=>{const p=a();o("telegram",`https://t.me/share/url?url=https://backcoin.org&text=${encodeURIComponent(p)}`)}),(u=document.getElementById("share-whatsapp"))==null||u.addEventListener("click",()=>{const p=a();o("whatsapp",`https://wa.me/?text=${encodeURIComponent(p)}`)}),(f=document.getElementById("share-instagram"))==null||f.addEventListener("click",async()=>{const p=a();try{await navigator.clipboard.writeText(p),await i("instagram");const g=`
            ...
            `)}}catch(t){console.error("loadHistory error:",t)}}function I0(e){const t=document.getElementById("history-list");t&&(t.innerHTML=e.map(n=>{var p;const a=n.isWin||n.prizeWon&&BigInt(n.prizeWon)>0n,s=n.prizeWon?_(BigInt(n.prizeWon)):0,r=n.wagerAmount?_(BigInt(n.wagerAmount)):0,i=n.isCumulative,o=n.rolls||[],l=n.guesses||[],d=n.txHash||n.transactionHash,u=A0(n.timestamp||n.createdAt),f=n.player?`${n.player.slice(0,6)}...${n.player.slice(-4)}`:"???",m=c.userAddress&&((p=n.player)==null?void 0:p.toLowerCase())===c.userAddress.toLowerCase(),b=d?`${tr}${d}`:null;return`
        ...
        `}).join(""))}function A0(e){if(!e)return"N/A";try{const t=Date.now();let n;if(typeof e=="number"?n=e>1e12?e:e*1e3:typeof e=="string"?n=new Date(e).getTime():e._seconds?n=e._seconds*1e3:e.seconds?n=e.seconds*1e3:n=new Date(e).getTime(),isNaN(n))return"N/A";const a=t-n;if(a<0)return"Just now";const s=Math.floor(a/6e4),r=Math.floor(a/36e5),i=Math.floor(a/864e5);return s<1?"Just now":s<60?`${s}m ago`:r<24?`${r}h ago`:i<7?`${i}d ago`:new Date(n).toLocaleDateString("en-US",{month:"short",day:"numeric"})}catch(t){return console.error("getTimeAgo error:",t),"N/A"}}const B0={render:i0,cleanup:o0},P0=()=>{if(document.getElementById("about-styles-v4"))return;const e=document.createElement("style");e.id="about-styles-v4",e.innerHTML=`
        @keyframes pulse-hub {
    ...
    `,document.head.appendChild(e)}async function en(){var e;A.isConnected=c.isConnected,A.user=null,A.userSubmissions=[],A.platformUsage={},A.isBanned=!1;try{const t=await Bs();if(A.systemConfig=t.config,A.leaderboards=t.leaderboards,A.dailyTasks=t.dailyTasks||[],A.platformUsageConfig=t.platformUsageConfig||rc,A.isConnected&&c.userAddress){const[n,a]=await Promise.all([dn(c.userAddress),Dd()]);if(A.user=n,A.userSubmissions=a,n&&n.isBanned){A.isBanned=!0;return}try{typeof Lr=="function"&&(A.platformUsage=await Lr()||{})}catch(s){console.warn("Could not load platform usage:",s),A.platformUsage={}}A.dailyTasks.length>0&&(A.dailyTasks=await Promise.all(A.dailyTasks.map(async s=>{try{if(!s.id)return{...s,eligible:!1,timeLeftMs:0};const r=await Li(s.id,s.cooldownHours);return{...s,eligible:r.eligible,timeLeftMs:r.timeLeft}}catch{return{...s,eligible:!1,timeLeftMs:0}}})))}}catch(t){if(console.error("Airdrop Data Load Error:",t),t.code==="permission-denied"||(e=t.message)!=null&&e.includes("permission")){console.warn("Firebase permissions issue - user may need to connect wallet or sign in"),A.systemConfig=A.systemConfig||{},A.leaderboards=A.leaderboards||{top100ByPoints:[],top100ByPosts:[]},A.dailyTasks=A.dailyTasks||[];return}x("Error loading data. Please refresh.","error")}}function G0(e){if(!A.user||!e||e.length===0)return null;const t=e.findIndex(n=>{var a,s;return((a=n.walletAddress)==null?void 0:a.toLowerCase())===((s=A.user.walletAddress)==null?void 0:s.toLowerCase())});return t>=0?t+1:null}function K0(e){return e?e<=5?st[0]:e<=25?st[1]:e<=75?st[2]:e<=200?st[3]:null:null}function ic(){var l;const{user:e}=A,t=(e==null?void 0:e.totalPoints)||0,n=(e==null?void 0:e.platformUsagePoints)||0,a=(e==null?void 0:e.approvedSubmissionsCount)||0,s=j0(a),r=((l=A.leaderboards)==null?void 0:l.top100ByPosts)||[],i=G0(r),o=K0(i);return`
        <!-- Mobile Header -->
    ...
    `}function qa(){return A.isConnected?`
        <div class="px-4 airdrop-fade-up">
            ...
            <!-- Sub-tab Content -->
            <div id="earn-content">
                ${A.activeEarnTab==="post"?Y0():""}
                ${A.activeEarnTab==="platform"?q0():""}
                ${A.activeEarnTab==="tasks"?V0():""}
            </div>
        </div>
    `:`
        ...
        `}function Y0(){const{user:e}=A,n=`https://backcoin.org/?ref=${(e==null?void 0:e.referralCode)||"CODE"}`;return`
        <div class="space-y-4">
                ...
                <div class="space-y-5">
                    ...
                    <div class="flex gap-3 items-start relative">
                        ...
                        <div class="flex-1 pb-2">
                            ...
                            <div class="bg-black/40 p-2.5 rounded-lg border border-zinc-700/50 mb-2">
                                ...
                                <p class="text-xs font-mono text-zinc-600 mt-1">${gs}</p>
                            </div>
                    ...
                    <div class="flex gap-3 items-start relative">
                        ...
                        <div class="flex-1 pb-2">
                            ...
                            <div class="grid grid-cols-4 gap-2">
                                <a href="https://twitter.com/intent/tweet?text=${encodeURIComponent(n+" "+gs)}" target="_blank" 
    ...
    `}function q0(){var i;const e=A.platformUsageConfig||rc,t=A.platformUsage||{};let n=0,a=0;Object.keys(e).forEach(o=>{var l;e[o].enabled!==!1&&e[o].maxCount&&(n+=e[o].maxCount,a+=Math.min(((l=t[o])==null?void 0:l.count)||0,e[o].maxCount))});const s=n>0?a/n*100:0,r=((i=A.user)==null?void 0:i.platformUsagePoints)||0;return`
        <div class="space-y-4">
            <!-- Info Banner -->
            ...
            <div class="grid grid-cols-2 gap-2" id="platform-actions-grid">
                ${Object.entries(e).filter(([o,l])=>l.enabled!==!1).map(([o,l])=>{const d=t[o]||{count:0},u=d.count>=l.maxCount,f=Math.max(0,l.maxCount-d.count),m=d.count/l.maxCount*100,b=O0[o]||"";return`
    ...
    `}function V0(){const e=A.dailyTasks||[],t=e.filter(a=>a.eligible),n=e.filter(a=>!a.eligible&&a.timeLeftMs>0);return`
        <div class="space-y-4">
            <!-- Info Banner -->
                        ...
                        ${n.map(a=>`
                            <div class="bg-zinc-900/80 border border-zinc-800 rounded-xl p-3 opacity-50">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-zinc-600 text-xs">${H0(a.timeLeftMs)}</span>
                                </div>
                            </div>
                        `).join("")}
                    </div>
    ...
    `}function X0(){const{user:e,userSubmissions:t}=A;if(!A.isConnected)return`
            <div class="text-center px-4 py-12 airdrop-fade-up">
    ...
    `}function J0(){var u,f;const e=((u=A.leaderboards)==null?void 0:u.top100ByPosts)||[],t=((f=A.leaderboards)==null?void 0:f.top100ByPoints)||[],n=A.activeRanking||"posts";function a(m,b,p){var z,T;const g=A.user&&((z=m.walletAddress)==null?void 0:z.toLowerCase())===((T=A.user.walletAddress)==null?void 0:T.toLowerCase()),y=Z0(b+1),k=p==="posts"?"bg-amber-500/10":"bg-green-500/10",E=p==="posts"?"text-amber-400":"text-green-400",I=p==="posts"?"text-white":"text-green-400",N=p==="posts"?"posts":"pts";return`
    ...
    `}function Z0(e){return e<=5?{icon:"💎",bg:"bg-cyan-500/20 text-cyan-300",tierName:"Diamond",tierTextColor:"text-cyan-400/70"}:e<=25?{icon:"🥇",bg:"bg-yellow-500/20 text-yellow-400",tierName:"Gold",tierTextColor:"text-yellow-400/70"}:e<=75?{icon:"🥈",bg:"bg-gray-400/20 text-gray-300",tierName:"Silver",tierTextColor:"text-gray-400/70"}:e<=200?{icon:"🥉",bg:"bg-amber-600/20 text-amber-500",tierName:"Bronze",tierTextColor:"text-amber-500/70"}:{icon:null,bg:"bg-zinc-800 text-zinc-400",tierName:null,tierTextColor:""}}function Re(){const e=document.getElementById("main-content"),t=document.getElementById("airdrop-header");if(e){if(t&&(t.innerHTML=ic()),A.isBanned){e.innerHTML=`
        ...
        `;return}switch(document.querySelectorAll(".nav-pill-btn").forEach(n=>{const a=n.dataset.target;n.closest(".md\\:hidden")?a===A.activeTab?(n.classList.add("airdrop-tab-active","shadow-lg"),n.classList.remove("text-zinc-500")):(n.classList.remove("airdrop-tab-active","shadow-lg"),n.classList.add("text-zinc-500")):a===A.activeTab?(n.classList.remove("text-zinc-400","hover:text-white","hover:bg-zinc-800"),n.classList.add("airdrop-tab-active","shadow-lg","shadow-amber-500/20")):(n.classList.add("text-zinc-400","hover:text-white","hover:bg-zinc-800"),n.classList.remove("airdrop-tab-active","shadow-lg","shadow-amber-500/20"))}),A.activeTab){case"earn":e.innerHTML=qa();break;case"post":e.innerHTML=qa();break;case"history":e.innerHTML=X0();break;case"leaderboard":e.innerHTML=J0();break;default:e.innerHTML=qa()}}}function Q0(){var n;const e=((n=A.user)==null?void 0:n.referralCode)||"CODE",t=`${e!=="CODE"?`https://backcoin.org/?ref=${e}`:"https://backcoin.org"} ${gs}`;navigator.clipboard.writeText(t).then(()=>{x("Copied! Now paste it in your post.","success");const a=document.getElementById("copy-viral-btn");if(a){const s=a.innerHTML;a.innerHTML='<i class="fa-solid fa-check"></i> Copied!',a.classList.remove("cta-mega"),a.classList.add("bg-green-600"),setTimeout(()=>{a.innerHTML=s,a.classList.add("cta-mega"),a.classList.remove("bg-green-600")},2e3)}}).catch(()=>x("Failed to copy.","error"))}function si(e){const t=e.target.closest(".nav-pill-btn");t&&(A.activeTab=t.dataset.target,Re())}function em(e){const t=e.target.closest(".earn-tab-btn");t&&t.dataset.earnTab&&(A.activeEarnTab=t.dataset.earnTab,Re())}function tm(e){const t=e.target.closest(".ranking-tab-btn");t&&t.dataset.ranking&&(A.activeRanking=t.dataset.ranking,Re())}function nm(){A.isGuideOpen=!A.isGuideOpen,Re()}function oc(e){var s;const t=`
        <div class="text-center">
            <!-- Imagem de CAUTION -->
    ...
    `;vn(t,"max-w-md"),(s=document.getElementById("deletePostBtn"))==null||s.addEventListener("click",async r=>{const i=r.currentTarget,o=i.dataset.submissionId;i.disabled=!0,i.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-1"></i> Deleting...';try{await Si(o),x("Post deleted. No penalty applied.","info"),we(),await en(),Re()}catch(l){x(l.message,"error"),i.disabled=!1,i.innerHTML='<i class="fa-solid fa-trash mr-1"></i> Delete Post'}});const n=document.getElementById("confirmCheckbox"),a=document.getElementById("finalConfirmBtn");n==null||n.addEventListener("change",()=>{n.checked?(a.disabled=!1,a.className="flex-1 bg-green-600 hover:bg-green-500 text-white py-3 rounded-xl font-bold text-sm transition-colors cursor-pointer",a.innerHTML='<i class="fa-solid fa-check mr-1"></i> Confirm & Earn ✓'):(a.disabled=!0,a.className="flex-1 bg-green-600/50 text-green-200 py-3 rounded-xl font-bold text-sm cursor-not-allowed transition-colors",a.innerHTML='<i class="fa-solid fa-lock mr-1"></i> Confirm & Earn')}),a==null||a.addEventListener("click",am)}async function am(e){const t=e.currentTarget,n=t.dataset.submissionId;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-2"></i> Verifying...';try{await Od(n),x("Success! Points added.","success"),we(),await en(),Re()}catch{x("Verification failed.","error"),t.disabled=!1,t.innerHTML="Try Again"}}async function sm(e){const t=e.target.closest(".action-btn");if(!t)return;const n=t.dataset.action,a=t.dataset.id;if(n==="confirm"){const s=A.userSubmissions.find(r=>r.submissionId===a);s&&oc(s)}else if(n==="delete"){if(!confirm("Remove this submission?"))return;try{await Si(a),x("Removed.","info"),await en(),Re()}catch(s){x(s.message,"error")}}}async function rm(e){const t=e.target.closest("#submit-content-btn");if(!t)return;const n=document.getElementById("content-url-input"),a=n==null?void 0:n.value.trim();if(!a||!a.startsWith("http"))return x("Enter a valid URL.","warning");const s=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-circle-notch fa-spin"></i>';try{await Md(a),x("📋 Submitted! Your post is now under security audit.","info"),n.value="",await en(),A.activeTab="history",Re()}catch(r){x(r.message,"error")}finally{t.disabled=!1,t.innerHTML=s}}async function im(e){const t=e.target.closest(".task-card");if(!t)return;const n=t.dataset.id,a=t.dataset.url;a&&window.open(a,"_blank");const s=A.dailyTasks.find(r=>r.id===n);if(!(!s||!s.eligible))try{await _d(s,A.user.pointsMultiplier),x(`Task completed! +${s.points} pts`,"success"),await en(),Re()}catch(r){r.message.includes("Cooldown")||x(r.message,"error")}}function om(){const e=Date.now(),t=sc*60*60*1e3,n=A.userSubmissions.filter(a=>["pending","auditing"].includes(a.status)&&a.submittedAt&&e-a.submittedAt.getTime()>=t);n.length>0&&(A.activeTab="history",Re(),setTimeout(()=>{oc(n[0])},500))}const lm={async render(e){const t=document.getElementById("airdrop");if(!t)return;W0();const n=U0();(t.innerHTML.trim()===""||e)&&(t.innerHTML=`
...
(This will reset their rejection count to 0)`;if(!window.confirm(s))return;const r=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await Ri(n,a),x(`User ${a?"BANNED":"UNBANNED"}.`,"success");const i=C.allUsers.findIndex(o=>o.id===n);i>-1&&(C.allUsers[i].isBanned=a,C.allUsers[i].hasPendingAppeal=!1,a===!1&&(C.allUsers[i].rejectedCount=0)),dt()}catch(i){x(`Failed: ${i.message}`,"error"),t.disabled=!1,t.innerHTML=r}},gm=async e=>{const t=e.target.closest(".resolve-appeal-btn");if(!t||t.disabled)return;const n=t.dataset.userId,s=t.dataset.action==="approve";if(!n)return;const r=s?"Are you sure you want to APPROVE this appeal and UNBAN the user?":"Are you sure you want to DENY this appeal? The user will remain banned.";if(!window.confirm(r))return;const i=t.closest("td").querySelectorAll("button"),o=new Map;i.forEach(l=>{o.set(l,l.innerHTML),l.disabled=!0,l.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>'});try{s&&await Ri(n,!1),x(`Appeal ${s?"APPROVED":"DENIED"}.`,"success");const l=C.allUsers.findIndex(d=>d.id===n);l>-1&&(C.allUsers[l].hasPendingAppeal=!1,s&&(C.allUsers[l].isBanned=!1,C.allUsers[l].rejectedCount=0)),dt()}catch(l){x(`Failed: ${l.message}`,"error"),i.forEach(d=>{d.disabled=!1,d.innerHTML=o.get(d)})}},xm=async e=>{const t=e.target.closest(".re-approve-btn");if(!t||t.disabled)return;const n=t.dataset.submissionId,a=t.dataset.userId;if(!n||!a)return;const s=t.closest("tr");s&&(s.style.opacity="0.5"),t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await $i(a,n,"approved"),x("Submission re-approved!","success"),C.selectedUserSubmissions=C.selectedUserSubmissions.filter(i=>i.submissionId!==n),s&&s.remove();const r=C.allUsers.findIndex(i=>i.id===a);if(r>-1){const i=C.allUsers[r];i.rejectedCount=Math.max(0,(i.rejectedCount||0)-1),dt()}if(C.selectedUserSubmissions.length===0){const i=document.querySelector("#admin-user-modal .p-6");i&&(i.innerHTML='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>')}}catch(r){x(`Failed to re-approve: ${r.message}`,"error"),s&&(s.style.opacity="1"),t.disabled=!1,t.innerHTML='<i class="fa-solid fa-check"></i> Re-Approve'}},hm=async e=>{const t=e.target.closest(".view-rejected-btn");if(!t||t.disabled)return;const n=t.dataset.userId,a=t.dataset.wallet;if(n){C.selectedWallet=a,C.isSubmissionsModalOpen=!0,Va(!0,[]);try{const s=await Yd(n,"rejected");C.selectedUserSubmissions=s,Va(!1,s)}catch(s){x(`Error fetching user submissions: ${s.message}`,"error"),Va(!1,[],!0)}}},vm=()=>{C.isSubmissionsModalOpen=!1,C.selectedUserSubmissions=[],C.selectedWallet=null;const e=document.getElementById("admin-user-modal");e&&e.remove(),document.body.style.overflow="auto"},wm=e=>{const t=e.target.closest(".user-profile-link");if(!t)return;e.preventDefault();const n=t.dataset.userId;if(!n)return;const a=C.allUsers.find(s=>s.id===n);if(!a){x("Error: Could not find user data.","error");return}Im(a)},ym=()=>{const e=document.getElementById("admin-user-profile-modal");e&&e.remove(),document.body.style.overflow="auto"},km=async e=>{e.preventDefault();const t=e.target;let n,a;try{if(n=new Date(t.startDate.value+"T00:00:00Z"),a=new Date(t.endDate.value+"T23:59:59Z"),isNaN(n.getTime())||isNaN(a.getTime()))throw new Error("Invalid date format.");if(n>=a)throw new Error("Start Date must be before End Date.")}catch(l){x(l.message,"error");return}const s={title:t.title.value.trim(),url:t.url.value.trim(),description:t.description.value.trim(),points:parseInt(t.points.value,10),cooldownHours:parseInt(t.cooldown.value,10),startDate:n,endDate:a};if(!s.title||!s.description){x("Please fill in Title and Description.","error");return}if(s.points<=0||s.cooldownHours<=0){x("Points and Cooldown must be positive numbers.","error");return}if(s.url&&!s.url.startsWith("http")){x("URL must start with http:// or https://","error");return}C.editingTask&&C.editingTask.id&&(s.id=C.editingTask.id);const r=t.querySelector('button[type="submit"]'),i=r.innerHTML;r.disabled=!0;const o=document.createElement("span");o.classList.add("inline-block"),r.innerHTML="",r.appendChild(o);try{await jd(s),x(`Task ${s.id?"updated":"created"} successfully!`,"success"),t.reset(),C.editingTask=null,gn()}catch(l){x(`Failed to save task: ${l.message}`,"error"),console.error(l),r.disabled=!1,r.innerHTML=i}},Tm=async e=>{e.preventDefault();const t=e.target,n={YouTube:parseInt(t.youtubePoints.value,10),"YouTube Shorts":parseInt(t.youtubeShortsPoints.value,10),Instagram:parseInt(t.instagramPoints.value,10),"X/Twitter":parseInt(t.xTwitterPoints.value,10),Facebook:parseInt(t.facebookPoints.value,10),Telegram:parseInt(t.telegramPoints.value,10),TikTok:parseInt(t.tiktokPoints.value,10),Reddit:parseInt(t.redditPoints.value,10),LinkedIn:parseInt(t.linkedinPoints.value,10),Other:parseInt(t.otherPoints.value,10)};if(Object.values(n).some(i=>isNaN(i)||i<0)){x("All points must be positive numbers (or 0).","error");return}const a=t.querySelector('button[type="submit"]'),s=a.innerHTML;a.disabled=!0;const r=document.createElement("span");r.classList.add("inline-block"),a.innerHTML="",a.appendChild(r);try{await Hd(n),x("UGC Base Points updated successfully!","success"),C.ugcBasePoints=n}catch(i){x(`Failed to update points: ${i.message}`,"error"),console.error(i)}finally{document.body.contains(a)&&(a.disabled=!1,a.innerHTML=s)}},Em=e=>{const t=C.dailyTasks.find(n=>n.id===e);t&&(C.editingTask=t,Bn())},Cm=async e=>{if(window.confirm("Are you sure you want to delete this task permanently?"))try{await Wd(e),x("Task deleted.","success"),C.editingTask=null,gn()}catch(t){x(`Failed to delete task: ${t.message}`,"error"),console.error(t)}};function Va(e,t,n=!1){var i,o;const a=document.getElementById("admin-user-modal");a&&a.remove(),document.body.style.overflow="hidden";let s="";e?s='<div class="p-8"></div>':n?s='<p class="text-red-400 text-center p-8">Failed to load submissions.</p>':t.length===0?s='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>':s=`
     ...
     `;document.body.insertAdjacentHTML("beforeend",r),e&&document.getElementById("admin-user-modal").querySelector(".p-8"),(i=document.getElementById("close-admin-modal-btn"))==null||i.addEventListener("click",vm),(o=document.getElementById("modal-submissions-tbody"))==null||o.addEventListener("click",xm)}function Im(e){var s;const t=document.getElementById("admin-user-profile-modal");t&&t.remove(),document.body.style.overflow="hidden";const n=e.isBanned?'<span class="text-xs font-bold py-1 px-3 rounded-full bg-red-600 text-white">BANNED</span>':e.hasPendingAppeal?'<span class="text-xs font-bold py-1 px-3 rounded-full bg-yellow-600 text-white">APPEALING</span>':'<span class="text-xs font-bold py-1 px-3 rounded-full bg-green-600 text-white">ACTIVE</span>',a=`
    ...
    `;const E=document.getElementById("admin-users-pagination");E&&b>1&&Ns(E,C.usersPage,b,Pm),(N=document.getElementById("admin-users-tbody"))==null||N.addEventListener("click",T=>{T.target.closest(".user-profile-link")&&wm(T),T.target.closest(".ban-user-btn")&&bm(T),T.target.closest(".view-rejected-btn")&&hm(T),T.target.closest(".resolve-appeal-btn")&&gm(T)}),(z=document.getElementById("user-filters-nav"))==null||z.addEventListener("click",Am);const I=document.getElementById("user-search-input");if(I){let T;I.addEventListener("keyup",F=>{clearTimeout(T),T=setTimeout(()=>Bm(F),300)})}},oi=()=>{var a;const e=document.getElementById("manage-ugc-points-content");if(!e)return;const t=C.ugcBasePoints;if(!t)return;const n={YouTube:5e3,"YouTube Shorts":2500,Instagram:3e3,"X/Twitter":1500,Facebook:2e3,Telegram:1e3,TikTok:3500,Reddit:1800,LinkedIn:2200,Other:1e3};e.innerHTML=`
    ...
    `;const b=document.getElementById("admin-tasks-pagination");b&&l>1&&Ns(b,C.tasksPage,l,zm),(p=document.getElementById("taskForm"))==null||p.addEventListener("submit",km),(g=document.getElementById("cancelEditBtn"))==null||g.addEventListener("click",()=>{C.editingTask=null,Bn()}),(y=document.getElementById("existing-tasks-list"))==null||y.addEventListener("click",k=>{const E=k.target.closest("button[data-id]");if(!E)return;const I=E.dataset.id;E.dataset.action==="edit"&&Em(I),E.dataset.action==="delete"&&Cm(I)})},ca=()=>{var f;const e=document.getElementById("submissions-content");if(!e)return;if(!C.allSubmissions||C.allSubmissions.length===0){const m=document.createElement("div");e.innerHTML=m.innerHTML;return}const t=C.submissionsPage,n=C.submissionsPerPage,a=[...C.allSubmissions].sort((m,b)=>{var p,g;return(((p=b.submittedAt)==null?void 0:p.getTime())||0)-(((g=m.submittedAt)==null?void 0:g.getTime())||0)}),s=a.length,r=Math.ceil(s/n),i=(t-1)*n,o=t*n,d=a.slice(i,o).map(m=>{var b,p;return`
        <tr class="border-b border-border-color hover:bg-zinc-800/50">
            ...
            <td class="p-3 text-xs font-semibold ${((b=ii[m.status])==null?void 0:b.color)||"text-gray-500"}">${((p=ii[m.status])==null?void 0:p.text)||m.status}</td>
            <td class="p-3 text-right">
                <div class="flex items-center justify-end gap-2">
    ...
    `;const u=document.getElementById("admin-submissions-pagination");u&&r>1&&Ns(u,C.submissionsPage,r,Nm),(f=document.getElementById("admin-submissions-tbody"))==null||f.addEventListener("click",fm)},da=()=>{var r,i;const e=document.getElementById("platform-usage-content");if(!e)return;const t=C.platformUsageConfig||Ia;let n=0;Object.values(t).forEach(o=>{o.enabled!==!1&&(n+=(o.points||0)*(o.maxCount||1))});const a=Object.entries(t).map(([o,l])=>`
    ...
    `;const s=document.getElementById("platform-usage-tbody");s==null||s.addEventListener("input",li),s==null||s.addEventListener("change",li),(r=document.getElementById("save-platform-config-btn"))==null||r.addEventListener("click",Lm),(i=document.getElementById("reset-platform-config-btn"))==null||i.addEventListener("click",Sm)},li=e=>{const t=e.target;if(!t.classList.contains("platform-input")&&!t.classList.contains("platform-toggle"))return;const n=t.closest("tr"),a=n==null?void 0:n.dataset.actionKey,s=t.dataset.field;if(!a||!s)return;C.platformUsageConfig[a]||(C.platformUsageConfig[a]={...Ia[a]}),s==="enabled"?C.platformUsageConfig[a].enabled=t.checked:C.platformUsageConfig[a][s]=parseInt(t.value)||0;const r=C.platformUsageConfig[a],i=n.querySelector("td:last-child");i&&(i.textContent=((r.points||0)*(r.maxCount||1)).toLocaleString())},Lm=async e=>{const t=e.target.closest("button");if(!t)return;const n=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Saving...';try{await _i(C.platformUsageConfig),x("✅ Platform Usage config saved!","success"),da()}catch(a){console.error("Error saving platform config:",a),x("Failed to save config: "+a.message,"error")}finally{t.disabled=!1,t.innerHTML=n}},Sm=async()=>{if(confirm("Are you sure you want to reset to default values? This will save immediately."))try{C.platformUsageConfig={...Ia},await _i(C.platformUsageConfig),x("✅ Config reset to defaults!","success"),da()}catch(e){console.error("Error resetting platform config:",e),x("Failed to reset config: "+e.message,"error")}},$m=()=>{var n;const e=document.getElementById("admin-content-wrapper");if(!e)return;e.innerHTML=`
    ...
    `,(n=document.getElementById("withdraw-presale-funds-btn"))==null||n.addEventListener("click",a=>mm(a.target)),sr(),C.activeTab==="manage-ugc-points"?oi():C.activeTab==="manage-tasks"?Bn():C.activeTab==="review-submissions"?ca():C.activeTab==="manage-users"?dt():C.activeTab==="platform-usage"&&da();const t=document.getElementById("admin-tabs");t&&!t._listenerAttached&&(t.addEventListener("click",a=>{const s=a.target.closest(".tab-btn");if(!s||s.classList.contains("active"))return;const r=s.dataset.target;C.activeTab=r,r!=="manage-users"&&(C.usersPage=1,C.usersFilter="all",C.usersSearch=""),r!=="review-submissions"&&(C.submissionsPage=1),r!=="manage-tasks"&&(C.tasksPage=1),document.querySelectorAll("#admin-tabs .tab-btn").forEach(o=>o.classList.remove("active")),s.classList.add("active"),e.querySelectorAll(".tab-content").forEach(o=>o.classList.remove("active"));const i=document.getElementById(r.replace(/-/g,"_")+"_tab");i?(i.classList.add("active"),r==="manage-ugc-points"&&oi(),r==="manage-tasks"&&Bn(),r==="review-submissions"&&ca(),r==="manage-users"&&dt(),r==="platform-usage"&&da()):console.warn(`Tab content container not found for target: ${r}`)}),t._listenerAttached=!0)},Rm={render(){const e=document.getElementById("admin");if(e){if(!pm()){e.innerHTML='<div class="text-center text-red-400 p-8 bg-sidebar border border-red-500/50 rounded-lg">Access Denied. This page is restricted to administrators.</div>';return}if(ri()){e.innerHTML='<div id="admin-content-wrapper"></div>',gn();return}e.innerHTML=`
        ...
        `,document.getElementById("admin-login-btn").addEventListener("click",()=>{const t=document.getElementById("admin-key-input"),n=document.getElementById("admin-login-error");t.value===dm?(um(),x("✅ Admin access granted!","success"),e.innerHTML='<div id="admin-content-wrapper"></div>',gn()):(n.classList.remove("hidden"),t.value="",t.focus(),setTimeout(()=>n.classList.add("hidden"),3e3))}),setTimeout(()=>{var t;(t=document.getElementById("admin-key-input"))==null||t.focus()},100)}},refreshData(){const e=document.getElementById("admin");e&&!e.classList.contains("hidden")&&ri()&&(console.log("Refreshing Admin Page data..."),gn(),sr())}},Xa=2e8,ci={airdrop:{amount:7e7},liquidity:{amount:13e7}},_m=()=>{if(document.getElementById("tokenomics-styles-v5"))return;const e=document.createElement("style");e.id="tokenomics-styles-v5",e.innerHTML=`
    ...
    `,document.head.appendChild(e)},xn=e=>e>=1e6?(e/1e6).toFixed(1)+"M":e>=1e3?(e/1e3).toFixed(0)+"K":e.toLocaleString();function Fm(){return`
    ...
    `}function Mm(){const e=c.totalSupply?_(c.totalSupply):4e7,t=(e/Xa*100).toFixed(1);return`
                ...
                <div class="space-y-3">
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-500 text-[10px]">${xn(ci.airdrop.amount)} BKC</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-500 text-[10px]">${xn(ci.liquidity.amount)} BKC</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    `}function Km(){const e=document.getElementById("tokenomics");e&&(_m(),e.innerHTML=`
    ...
    `,e.scrollIntoView({behavior:"smooth",block:"start"}))}const Ym={render:Km,init:()=>{},update:()=>{}},rr=window.ethers,qm=5*1024*1024,Vm="https://sepolia.arbiscan.io/tx/",di="https://gateway.pinata.cloud/ipfs/",Ke={image:{icon:"fa-regular fa-image",color:"text-emerald-400",bg:"bg-emerald-500/15",label:"Image"},pdf:{icon:"fa-regular fa-file-pdf",color:"text-red-400",bg:"bg-red-500/15",label:"PDF"},audio:{icon:"fa-solid fa-music",color:"text-purple-400",bg:"bg-purple-500/15",label:"Audio"},video:{icon:"fa-regular fa-file-video",color:"text-blue-400",bg:"bg-blue-500/15",label:"Video"},document:{icon:"fa-regular fa-file-word",color:"text-blue-400",bg:"bg-blue-500/15",label:"Document"},spreadsheet:{icon:"fa-regular fa-file-excel",color:"text-green-400",bg:"bg-green-500/15",label:"Spreadsheet"},code:{icon:"fa-solid fa-code",color:"text-cyan-400",bg:"bg-cyan-500/15",label:"Code"},archive:{icon:"fa-regular fa-file-zipper",color:"text-yellow-400",bg:"bg-yellow-500/15",label:"Archive"},default:{icon:"fa-regular fa-file",color:"text-amber-400",bg:"bg-amber-500/15",label:"File"}},O={step:1,file:null,description:"",hash:null,isProcessing:!1,certificates:[],lastFetch:0};function Xm(e){if(!e)return"";let t;if(typeof e=="number")t=new Date(e>1e12?e:e*1e3);else if(typeof e=="string")t=new Date(e);else if(e!=null&&e.toDate)t=e.toDate();else if(e!=null&&e.seconds)t=new Date(e.seconds*1e3);else return"";if(isNaN(t.getTime()))return"";const n=new Date,a=n-t,s=Math.floor(a/(1e3*60*60)),r=Math.floor(a/(1e3*60*60*24));if(s<1){const i=Math.floor(a/6e4);return i<1?"Just now":`${i}m ago`}return s<24?`${s}h ago`:r<7?`${r}d ago`:t.toLocaleDateString("en-US",{month:"short",day:"numeric",year:t.getFullYear()!==n.getFullYear()?"numeric":void 0})}function ir(e="",t=""){const n=e.toLowerCase(),a=t.toLowerCase();return n.includes("image")||/\.(jpg|jpeg|png|gif|webp|svg|bmp|ico)$/.test(a)?Ke.image:n.includes("pdf")||a.endsWith(".pdf")?Ke.pdf:n.includes("audio")||/\.(mp3|wav|ogg|flac|aac|m4a)$/.test(a)?Ke.audio:n.includes("video")||/\.(mp4|avi|mov|mkv|webm|wmv)$/.test(a)?Ke.video:n.includes("word")||n.includes("document")||/\.(doc|docx|odt|rtf)$/.test(a)?Ke.document:n.includes("sheet")||n.includes("excel")||/\.(xls|xlsx|csv|ods)$/.test(a)?Ke.spreadsheet:/\.(js|ts|py|java|cpp|c|h|html|css|json|xml|sol|rs|go|php|rb)$/.test(a)?Ke.code:n.includes("zip")||n.includes("archive")||/\.(zip|rar|7z|tar|gz)$/.test(a)?Ke.archive:Ke.default}function Jm(){if(document.getElementById("notary-styles-v6"))return;const e=document.createElement("style");e.id="notary-styles-v6",e.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(e)}function Zm(){const e=document.getElementById("notary");e&&(Jm(),e.innerHTML=`
        <div class="max-w-5xl mx-auto px-4 py-6">
    ...
    `,ua(),He(),or())}function ua(){const e=document.getElementById("status-badge"),t=document.getElementById("fee-amount"),n=document.getElementById("user-balance"),a=c.notaryFee||0n,s=c.currentUserBalance||0n;t&&(t.textContent=`${_(a)} BKC`),n&&(n.textContent=`${_(s)} BKC`,n.className=`font-mono font-bold ${s>=a?"text-emerald-400":"text-red-400"}`),e&&(c.isConnected?s>=a?(e.innerHTML=`
        ...
        `;return}const t=c.notaryFee||rr.parseEther("1"),n=c.currentUserBalance||0n;if(n<t){e.innerHTML=`
            <div class="flex flex-col items-center justify-center h-full py-12">
        ...
        `;return}switch(O.step){case 1:ef(e);break;case 2:nf(e);break;case 3:af(e);break}}function ef(e){e.innerHTML=`
    ...
    `,tf()}function tf(){const e=document.getElementById("dropzone"),t=document.getElementById("file-input");!e||!t||(e.onclick=()=>t.click(),["dragenter","dragover","dragleave","drop"].forEach(n=>{e.addEventListener(n,a=>{a.preventDefault(),a.stopPropagation()})}),e.addEventListener("dragenter",()=>e.classList.add("drag-over")),e.addEventListener("dragover",()=>e.classList.add("drag-over")),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",n=>{var a,s;e.classList.remove("drag-over"),ui((s=(a=n.dataTransfer)==null?void 0:a.files)==null?void 0:s[0])}),t.addEventListener("change",n=>{var a;return ui((a=n.target.files)==null?void 0:a[0])}))}function ui(e){if(e){if(e.size>qm){x("File too large (max 5MB)","error");return}O.file=e,O.step=2,He()}}function nf(e){var s,r,i;const t=O.file,n=t?(t.size/1024).toFixed(1):"0",a=ir((t==null?void 0:t.type)||"",(t==null?void 0:t.name)||"");e.innerHTML=`
    ...
    `,(s=document.getElementById("btn-remove"))==null||s.addEventListener("click",()=>{O.file=null,O.description="",O.step=1,He()}),(r=document.getElementById("btn-back"))==null||r.addEventListener("click",()=>{O.step=1,He()}),(i=document.getElementById("btn-next"))==null||i.addEventListener("click",()=>{var o;O.description=((o=document.getElementById("desc-input"))==null?void 0:o.value)||"",O.step=3,He()})}function af(e){var r,i;const t=O.file,n=O.description||"No description",a=c.notaryFee||rr.parseEther("1"),s=ir((t==null?void 0:t.type)||"",(t==null?void 0:t.name)||"");e.innerHTML=`
    ...
    `;try{const t=Te.getNotarizedDocuments||"https://getnotarizeddocuments-4wvdcuoouq-uc.a.run.app",n=await fetch(`${t}/${c.userAddress}`);if(!n.ok)throw new Error(`API returned ${n.status}`);const a=await n.json();if(!Array.isArray(a)||a.length===0){e.innerHTML=`
            ...
            `;return}const s=a.map(r=>({id:r.tokenId||"?",ipfs:r.ipfsCid||"",description:r.description||"",hash:r.contentHash||"",timestamp:r.createdAt||r.timestamp||"",txHash:r.txHash||""})).sort((r,i)=>parseInt(i.id)-parseInt(r.id));e.innerHTML=s.map(r=>{var f,m;let i="";const o=r.ipfs||"";o.startsWith("ipfs://")?i=`${di}${o.replace("ipfs://","")}`:o.startsWith("https://")?i=o:o.length>0&&(i=`${di}${o}`);let l=((f=r.description)==null?void 0:f.split("---")[0].trim().split(`
`)[0].trim())||"Notarized Document";const d=ir("",l),u=Xm(r.timestamp);return`
                <div class="cert-card">
        ...
        `}}}async function rf(){try{if(await As(),c.isConnected&&c.userAddress)try{if(c.bkcTokenContract||c.bkcTokenContractPublic){const e=c.bkcTokenContract||c.bkcTokenContractPublic,t=await ne(e,"balanceOf",[c.userAddress],0n);t>0n&&(c.currentUserBalance=t)}}catch{}ua()}catch{(!c.notaryFee||c.notaryFee===0n)&&(c.notaryFee=rr.parseEther("1"))}}async function of(e,t){var n,a;try{const s=["https://dweb.link/ipfs/","https://w3s.link/ipfs/","https://gateway.pinata.cloud/ipfs/","https://ipfs.io/ipfs/"],r=u=>u?u.startsWith("ipfs://")?u.replace("ipfs://","").split("?")[0]:u.includes("/ipfs/")?u.split("/ipfs/")[1].split("?")[0]:u.match(/^Qm[a-zA-Z0-9]{44}/)||u.match(/^bafy[a-zA-Z0-9]+/)?u:"":"",i=u=>{if(!u)return"";if(u.startsWith("https://")&&!u.includes("/ipfs/"))return u;const f=r(u);return f?`${s[0]}${f}`:u};let o=i(t||"");if(c.decentralizedNotaryContract)try{const u=await c.decentralizedNotaryContract.tokenURI(e);if(u!=null&&u.startsWith("data:application/json;base64,")){const f=JSON.parse(atob(u.replace("data:application/json;base64,","")));f.image&&(o=i(f.image))}}catch{}const l=((n=c.decentralizedNotaryContract)==null?void 0:n.target)||((a=c.decentralizedNotaryContract)!=null&&a.getAddress?await c.decentralizedNotaryContract.getAddress():null);if(!l){x("Contract address not found","error");return}x(`Adding NFT #${e} to wallet...`,"info"),await window.ethereum.request({method:"wallet_watchAsset",params:{type:"ERC721",options:{address:l,tokenId:String(e),image:o}}})&&x(`📜 NFT #${e} added to wallet!`,"success")}catch(s){if(s.code===4001)return;x("Could not add NFT","error")}}const dc={async render(e){e&&(Zm(),await rf(),c.isConnected&&await Pt(),ua(),He())},reset(){O.file=null,O.description="",O.step=1,He()},update(){ua(),O.isProcessing||He()},refreshHistory(){or()},addToWallet:of};window.NotaryPage=dc;const Aa=window.ethers,pi=24*60*60,xs={Diamond:{emoji:"💎",color:"#22d3ee",bg:"rgba(34,211,238,0.15)",border:"rgba(34,211,238,0.3)",keepRate:100,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeicgip72jcqgsirlrhn3tq5cc226vmko6etnndzl6nlhqrktfikafq"},Gold:{emoji:"🥇",color:"#fbbf24",bg:"rgba(251,191,36,0.15)",border:"rgba(251,191,36,0.3)",keepRate:90,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeifponccrbicg2pcjrn2hrfoqgc77xhm2r4ld7hdpw6cxxkbsckf44"},Silver:{emoji:"🥈",color:"#9ca3af",bg:"rgba(156,163,175,0.15)",border:"rgba(156,163,175,0.3)",keepRate:75,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeihvi2inujm5zpi7tl667g4srq273536pjkglwyrtbwmgnskmu7jg4"},Bronze:{emoji:"🥉",color:"#fb923c",bg:"rgba(251,146,60,0.15)",border:"rgba(251,146,60,0.3)",keepRate:60,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeiclqidb67rt3tchhjpsib62s624li7j2bpxnr6b5w5mfp4tomhu7m"}},R={activeTab:"marketplace",filterTier:"ALL",sortBy:"featured",selectedListing:null,isLoading:!1,isTransactionPending:!1,countdownIntervals:[],promotions:new Map},$e=e=>e==null?"":String(e),lf=(e,t)=>$e(e)===$e(t),Pn=(e,t)=>e&&t&&e.toLowerCase()===t.toLowerCase();function Fn(e){return ge.find(t=>t.boostBips===Number(e))||{name:"Unknown",boostBips:0}}function Ba(e){return xs[e]||{emoji:"💎",color:"#71717a",bg:"rgba(113,113,122,0.15)",border:"rgba(113,113,122,0.3)",keepRate:50}}function uc(e){const t=e-Math.floor(Date.now()/1e3);if(t<=0)return{text:"Expired",expired:!0,seconds:0};const n=Math.floor(t/3600),a=Math.floor(t%3600/60),s=t%60;return n>0?{text:`${n}h ${a}m`,expired:!1,seconds:t}:a>0?{text:`${a}m ${s}s`,expired:!1,seconds:t}:{text:`${s}s`,expired:!1,seconds:t}}function cf(e){const t=Math.floor(Date.now()/1e3),n=e-t;if(n<=0)return null;const a=Math.floor(n/3600),s=Math.floor(n%3600/60);return a>0?`${a}h ${s}m`:`${s}m`}function pc(e){if(e.lastRentalEndTime)return Number(e.lastRentalEndTime)+pi;if(e.rentalEndTime&&!e.isRented){const t=Number(e.rentalEndTime),n=Math.floor(Date.now()/1e3);if(t<n)return t+pi}return null}function mi(e){const t=Math.floor(Date.now()/1e3),n=pc(e);return n&&n>t}function fi(e){const t=Math.floor(Date.now()/1e3);if(!e.lastRentalEndTime&&!e.rentalEndTime)return e.createdAt?t-Number(e.createdAt):Number.MAX_SAFE_INTEGER;const n=e.lastRentalEndTime?Number(e.lastRentalEndTime):e.rentalEndTime?Number(e.rentalEndTime):0;return n>t?0:t-n}function df(){if(document.getElementById("rental-styles-v6"))return;const e=document.createElement("style");e.id="rental-styles-v6",e.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(e)}function hs(){const e=document.getElementById("rental");if(!e)return;df();const t=c.rentalListings||[],n=t.filter(r=>c.isConnected&&Pn(r.owner,c.userAddress)),a=Math.floor(Date.now()/1e3),s=(c.myRentals||[]).filter(r=>Pn(r.tenant,c.userAddress)&&Number(r.endTime)>a);e.innerHTML=`
        ...
        ${xf()}
        ${hf()}
    `,vf(),hn()}function uf(){return c.isConnected?`
    ...
    `:`
        ...
        `}function hn(){const e=document.getElementById("tab-content");if(e){switch(R.activeTab){case"marketplace":e.innerHTML=pf();break;case"my-listings":e.innerHTML=mf();break;case"my-rentals":e.innerHTML=ff();break}document.getElementById("header-stats").innerHTML=uf(),R.activeTab==="my-rentals"&&Cf()}}function pf(){const e=c.rentalListings||[],t=Math.floor(Date.now()/1e3);let n=e.filter(a=>!(a.isRented||a.rentalEndTime&&Number(a.rentalEndTime)>t||R.filterTier!=="ALL"&&Fn(a.boostBips).name!==R.filterTier));return n.sort((a,s)=>{const r=BigInt(a.promotionFee||"0")||R.promotions.get($e(a.tokenId))||0n,i=BigInt(s.promotionFee||"0")||R.promotions.get($e(s.tokenId))||0n,o=mi(a),l=mi(s);if(!o&&l)return-1;if(o&&!l||i>r)return 1;if(i<r)return-1;if(R.sortBy==="featured"){const f=fi(a),m=fi(s);if(m!==f)return m-f}const d=BigInt(a.pricePerHour||0),u=BigInt(s.pricePerHour||0);return R.sortBy==="price-low"?d<u?-1:1:R.sortBy==="price-high"?d>u?-1:1:(s.boostBips||0)-(a.boostBips||0)}),`
        <div>
            <!-- Filters & Sort -->
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
                <div class="flex flex-wrap gap-2">
                    <button class="filter-chip ${R.filterTier==="ALL"?"active":""}" data-filter="ALL">All Tiers</button>
                    ${Object.keys(xs).map(a=>`
    ...
    `}function mc(e,t){const n=Fn(e.boostBips),a=Ba(n.name),s=_(BigInt(e.pricePerHour||0)).toFixed(2),r=$e(e.tokenId),i=c.isConnected&&Pn(e.owner,c.userAddress),o=pc(e),l=Math.floor(Date.now()/1e3),d=o&&o>l,u=d?cf(o):null,f=BigInt(e.promotionFee||"0")||R.promotions.get(r)||0n,m=f>0n,b=m?parseFloat(Aa.formatEther(f)).toFixed(3):"0",p=lt(e.boostBips||0);return`
    ...
    `}function mf(){if(!c.isConnected)return fc("View your listings");const e=c.rentalListings||[],t=e.filter(r=>Pn(r.owner,c.userAddress)),n=new Set(e.map(r=>$e(r.tokenId))),a=(c.myBoosters||[]).filter(r=>!n.has($e(r.tokenId)));return`
        <div>
            <!-- Earnings Card -->
    ...
    `}function ff(){if(!c.isConnected)return fc("View your active rentals");const e=Math.floor(Date.now()/1e3),t=(c.myRentals||[]).filter(n=>Pn(n.tenant,c.userAddress)&&Number(n.endTime)>e);return`
        <div>
            <!-- Info Card -->
            ...
            ${t.length===0?lr("No Active Rentals","Rent an NFT to reduce your claim burn rate!"):`
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    ${t.map((n,a)=>bf(n,a)).join("")}
                </div>
            `}
        </div>
    `}function bf(e,t){const n=Fn(e.boostBips),a=Ba(n.name),s=uc(Number(e.endTime)),r=lt(e.boostBips||0);let i="active";return s.seconds<3600?i="critical":s.seconds<7200&&(i="warning"),`
        <div class="rental-card-base p-5" style="animation: card-in 0.5s ease-out ${t*60}ms forwards; opacity: 0;">
            ...
            <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-zinc-500">Token #${$e(e.tokenId)}</p>
                </div>
            </div>
    ...
    `}function gf(){const e=c.rentalListings||[],t=new Set(e.map(a=>$e(a.tokenId)));return`
                ...
                <div class="p-5 space-y-5">
                    <div>
                        ...
                        <select id="list-select" class="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-4 py-3 text-white outline-none">
                            ...
                            ${(c.myBoosters||[]).filter(a=>!t.has($e(a.tokenId))).map(a=>{const s=Fn(a.boostBips),r=Ba(s.name);return`<option value="${a.tokenId}">${r.emoji} ${s.name} Booster #${a.tokenId}</option>`}).join("")}
                        </select>
                    </div>
                    <div>
    ...
    `}function vf(){document.addEventListener("click",e=>{const t=e.target.closest(".rental-tab");if(t){R.activeTab=t.dataset.tab,document.querySelectorAll(".rental-tab").forEach(i=>i.classList.remove("active")),t.classList.add("active"),hn();return}const n=e.target.closest(".filter-chip");if(n){R.filterTier=n.dataset.filter,hn();return}if(e.target.closest("#btn-open-list")){bc();return}const a=e.target.closest(".rent-btn");if(a&&!a.disabled){wf(a.dataset.id);return}const s=e.target.closest(".withdraw-btn");if(s){vc(s);return}const r=e.target.closest(".promote-btn");if(r){yf(r.dataset.id);return}}),document.addEventListener("change",e=>{e.target.id==="sort-select"&&(R.sortBy=e.target.value,hn())})}function bc(){document.getElementById("modal-list").classList.add("active")}function gc(){document.getElementById("modal-list").classList.remove("active")}function wf(e){const t=(c.rentalListings||[]).find(i=>lf(i.tokenId,e));if(!t)return;R.selectedListing=t;const n=Fn(t.boostBips),a=Ba(n.name),s=_(BigInt(t.pricePerHour||0)),r=lt(t.boostBips||0);document.getElementById("rent-modal-content").innerHTML=`
    ...
    `,document.getElementById("rent-hours").addEventListener("input",i=>{const o=parseInt(i.target.value)||1,l=Number(s)*o;document.querySelector("#rent-total span:last-child").textContent=`${l.toFixed(2)} BKC`}),document.getElementById("modal-rent").classList.add("active")}function xc(){document.getElementById("modal-rent").classList.remove("active"),R.selectedListing=null}function yf(e){document.getElementById("promote-token-id").value=e,document.getElementById("promote-amount").value="",document.getElementById("modal-promote").classList.add("active")}function hc(){document.getElementById("modal-promote").classList.remove("active")}async function kf(){if(R.isTransactionPending||!R.selectedListing)return;const e=parseInt(document.getElementById("rent-hours").value)||1,t=$e(R.selectedListing.tokenId),n=document.getElementById("confirm-rent");R.isTransactionPending=!0;try{await _n.rent({tokenId:t,hours:e,button:n,onSuccess:async()=>{R.isTransactionPending=!1,xc(),x("🎉 NFT Rented Successfully!","success"),await Kt()},onError:a=>{R.isTransactionPending=!1,!a.cancelled&&a.type!=="user_rejected"&&x("Failed: "+(a.message||"Error"),"error")}})}catch(a){R.isTransactionPending=!1,!a.cancelled&&a.type!=="user_rejected"&&x("Failed: "+(a.message||"Error"),"error")}}async function Tf(){var a;if(R.isTransactionPending)return;const e=document.getElementById("list-select").value,t=document.getElementById("list-price").value;if(parseFloat((a=document.getElementById("list-promo-amount"))==null?void 0:a.value),!e){x("Select an NFT","error");return}if(!t||parseFloat(t)<=0){x("Enter valid price","error");return}const n=document.getElementById("confirm-list");R.isTransactionPending=!0;try{await _n.list({tokenId:e,pricePerHour:Aa.parseUnits(t,18),minHours:1,maxHours:168,button:n,onSuccess:async()=>{R.isTransactionPending=!1,gc(),x("🏷️ NFT Listed Successfully!","success"),await Kt()},onError:s=>{R.isTransactionPending=!1,!s.cancelled&&s.type!=="user_rejected"&&x("Failed: "+(s.message||"Error"),"error")}})}catch(s){R.isTransactionPending=!1,!s.cancelled&&s.type!=="user_rejected"&&x("Failed: "+(s.message||"Error"),"error")}}async function vc(e){if(R.isTransactionPending)return;const t=e.dataset.id;if(confirm("Withdraw this NFT from marketplace?")){R.isTransactionPending=!0;try{await _n.withdraw({tokenId:t,button:e,onSuccess:async()=>{R.isTransactionPending=!1,x("↩️ NFT Withdrawn Successfully!","success"),await Kt()},onError:n=>{R.isTransactionPending=!1,!n.cancelled&&n.type!=="user_rejected"&&x("Failed: "+(n.message||"Error"),"error")}})}catch(n){R.isTransactionPending=!1,!n.cancelled&&n.type!=="user_rejected"&&x("Failed: "+(n.message||"Error"),"error")}}}async function Ef(){if(R.isTransactionPending)return;const e=document.getElementById("promote-token-id").value,t=document.getElementById("promote-amount").value;if(!t||parseFloat(t)<=0){x("Enter valid amount","error");return}const n=document.getElementById("confirm-promote");R.isTransactionPending=!0;try{await _n.spotlight({tokenId:e,amount:Aa.parseEther(t),button:n,onSuccess:async()=>{R.isTransactionPending=!1,hc(),x("🚀 Listing Promoted!","success"),await Kt()},onError:a=>{R.isTransactionPending=!1,!a.cancelled&&a.type!=="user_rejected"&&x("Failed: "+(a.message||"Error"),"error")}})}catch(a){R.isTransactionPending=!1,!a.cancelled&&a.type!=="user_rejected"&&x("Failed: "+(a.message||"Error"),"error")}}function Cf(){R.countdownIntervals.forEach(clearInterval),R.countdownIntervals=[],document.querySelectorAll(".rental-timer[data-end]").forEach(e=>{const t=Number(e.dataset.end),n=setInterval(()=>{const a=uc(t);e.innerHTML=`<i class="fa-solid fa-clock mr-1"></i>${a.text}`,a.expired?(clearInterval(n),hn()):a.seconds<3600?e.className="rental-timer critical":a.seconds<7200&&(e.className="rental-timer warning")},1e3);R.countdownIntervals.push(n)})}async function Kt(){R.isLoading=!0;try{await Promise.all([Bi(),c.isConnected?Pd():Promise.resolve(),c.isConnected?vt():Promise.resolve()])}catch(e){console.warn("Refresh error:",e)}R.isLoading=!1,hs()}const wc={async render(e){e&&(hs(),await Kt())},update(){hs()},refresh:Kt,openListModal:bc,closeListModal:gc,closeRentModal:xc,closePromoteModal:hc,handleRent:kf,handleList:Tf,handleWithdraw:vc,handlePromote:Ef};window.RentalPage=wc;const If={render:async e=>{const t=document.getElementById("socials");if(!t||!e&&t.innerHTML.trim()!=="")return;const n=`
            <style>
...
`;document.head.appendChild(yc);const Af={render:async e=>{if(!e)return;const t=document.getElementById("creditcard");t&&(t.innerHTML=`
    ...
    `}function Za(e,t,n,a,s,r,i){const o=cr[At];let l=`
        <div class="mb-10">
    ...
    `,d=i;return a.forEach(u=>{l+=Pf(u,d++)}),l+="</div></div>",{html:l,nextIndex:d}}function Nf(e){var t,n,a,s,r,i,o,l;At=e,localStorage.setItem("backcoin-tutorials-lang",e),(t=document.getElementById("tutorials-btn-en"))==null||t.classList.toggle("bg-amber-500",e==="en"),(n=document.getElementById("tutorials-btn-en"))==null||n.classList.toggle("text-zinc-900",e==="en"),(a=document.getElementById("tutorials-btn-en"))==null||a.classList.toggle("bg-zinc-700",e!=="en"),(s=document.getElementById("tutorials-btn-en"))==null||s.classList.toggle("text-zinc-300",e!=="en"),(r=document.getElementById("tutorials-btn-pt"))==null||r.classList.toggle("bg-amber-500",e==="pt"),(i=document.getElementById("tutorials-btn-pt"))==null||i.classList.toggle("text-zinc-900",e==="pt"),(o=document.getElementById("tutorials-btn-pt"))==null||o.classList.toggle("bg-zinc-700",e!=="pt"),(l=document.getElementById("tutorials-btn-pt"))==null||l.classList.toggle("text-zinc-300",e!=="pt"),kc()}function kc(){const e=document.getElementById("tutorials-content");if(!e)return;const t=cr[At];let n=`
        <!-- Hero -->
        <div class="text-center mb-10">
    ...
    `,a=Za("getting-started","rocket","emerald",Ja.gettingStarted,"catGettingStarted","catGettingStartedDesc",0);n+=a.html,a=Za("ecosystem","cubes","amber",Ja.ecosystem,"catEcosystem","catEcosystemDesc",a.nextIndex),n+=a.html,a=Za("advanced","graduation-cap","cyan",Ja.advanced,"catAdvanced","catAdvancedDesc",a.nextIndex),n+=a.html,e.innerHTML=n}const Tc={render:function(e=!1){const t=document.getElementById("tutorials");t&&(e||t.innerHTML.trim()==="")&&(t.innerHTML=`
            ...
            `,kc())},update:function(e){},cleanup:function(){},setLang:Nf};window.TutorialsPage=Tc;const tn=window.ethers,zf={ACTIVE:0,COMPLETED:1,CANCELLED:2,WITHDRAWN:3},dr=e=>typeof e=="number"?e:typeof e=="string"?isNaN(parseInt(e))?zf[e.toUpperCase()]??0:parseInt(e):0,ur=e=>dr(e.status)===0&&Number(e.deadline)>Math.floor(Date.now()/1e3),pr=["function campaigns(uint256) view returns (address creator, string title, string description, uint256 goalAmount, uint256 raisedAmount, uint256 donationCount, uint256 deadline, uint256 createdAt, uint8 status)","function campaignCounter() view returns (uint256)","function totalRaisedAllTime() view returns (uint256)","function totalBurnedAllTime() view returns (uint256)","function totalCampaignsCreated() view returns (uint256)","function totalSuccessfulWithdrawals() view returns (uint256)"],Pa={getCampaigns:"https://getcharitycampaigns-4wvdcuoouq-uc.a.run.app",saveCampaign:"https://savecharitycampaign-4wvdcuoouq-uc.a.run.app",uploadImage:"https://uploadcharityimage-4wvdcuoouq-uc.a.run.app"},Ec="https://sepolia.arbiscan.io/address/",pa={animal:"https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=800&q=80",humanitarian:"https://images.unsplash.com/photo-1469571486292-0ba58a3f068b?w=800&q=80",default:"https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?w=800&q=80"},De={animal:{name:"Animal Welfare",emoji:"🐾",color:"#10b981",gradient:"from-emerald-500/20 to-green-600/20"},humanitarian:{name:"Humanitarian Aid",emoji:"💗",color:"#ec4899",gradient:"from-pink-500/20 to-rose-600/20"}},bi={0:{label:"Active",color:"#10b981",icon:"fa-circle-play",bg:"bg-emerald-500/15"},1:{label:"Ended",color:"#3b82f6",icon:"fa-circle-check",bg:"bg-blue-500/15"},2:{label:"Cancelled",color:"#ef4444",icon:"fa-circle-xmark",bg:"bg-red-500/15"},3:{label:"Completed",color:"#8b5cf6",icon:"fa-circle-dollar-to-slot",bg:"bg-purple-500/15"}},Lf=5*1024*1024,Sf=["image/jpeg","image/png","image/gif","image/webp"],B={campaigns:[],stats:null,currentView:"main",currentCampaign:null,selectedCategory:null,isLoading:!1,pendingImage:null,pendingImageFile:null,editingCampaign:null};function $f(){if(document.getElementById("charity-styles-v6"))return;const e=document.createElement("style");e.id="charity-styles-v6",e.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(e)}const ke=e=>{try{const t=Number(e)/1e18;return t<1e-4?"0":t<1?t.toFixed(4):t<1e3?t.toFixed(2):t.toLocaleString("en-US",{maximumFractionDigits:2})}catch{return"0"}},Cc=e=>e?`${e.slice(0,6)}...${e.slice(-4)}`:"",Mn=(e,t)=>{const n=Number(e||0),a=Number(t||1);return Math.min(100,Math.round(n/a*100))},Ic=e=>{const t=Math.floor(Date.now()/1e3),n=Number(e)-t;if(n<=0)return{text:"Ended",color:"#ef4444"};const a=Math.floor(n/86400);return a>0?{text:`${a}d left`,color:"#10b981"}:{text:`${Math.floor(n/3600)}h left`,color:"#f59e0b"}},Na=e=>(e==null?void 0:e.imageUrl)||pa[e==null?void 0:e.category]||pa.default,Ac=e=>`${window.location.origin}${window.location.pathname}#charity/${e}`,Bc=()=>{const t=window.location.hash.match(/#charity\/(\d+)/);return t?t[1]:null},Rf=e=>{window.location.hash=`charity/${e}`},_f=()=>{window.location.hash.startsWith("#charity/")&&(window.location.hash="charity")},Pc=e=>{const t=dr(e.status),n=Number(e.deadline)<=Math.floor(Date.now()/1e3);return(t===0||t===1)&&n&&!e.withdrawn&&BigInt(e.raisedAmount||0)>0n};async function Lt(){B.isLoading=!0;try{const[e,t]=await Promise.all([fetch(Pa.getCampaigns).then(s=>s.json()).catch(()=>({campaigns:[]})),Ff()]),n=(e==null?void 0:e.campaigns)||[],a=c==null?void 0:c.publicProvider;if(a){const s=new tn.Contract(w.charityPool,pr,a),r=await s.campaignCounter(),i=Number(r),o=await Promise.all(Array.from({length:i},(l,d)=>d+1).map(async l=>{try{const d=await s.campaigns(l),u=n.find(f=>String(f.id)===String(l));return{id:String(l),creator:d[0],title:(u==null?void 0:u.title)||d[1]||`Campaign #${l}`,description:(u==null?void 0:u.description)||d[2]||"",goalAmount:BigInt(d[3].toString()),raisedAmount:BigInt(d[4].toString()),donationCount:Number(d[5]),deadline:Number(d[6]),createdAt:Number(d[7]),status:Number(d[8]),category:(u==null?void 0:u.category)||"humanitarian",imageUrl:(u==null?void 0:u.imageUrl)||null}}catch{return null}}));B.campaigns=o.filter(Boolean)}B.stats=t}catch(e){console.error("Load data:",e)}finally{B.isLoading=!1}}async function Ff(){try{const e=c==null?void 0:c.publicProvider;if(!e)return null;const t=new tn.Contract(w.charityPool,pr,e),[n,a,s,r]=await Promise.all([t.totalRaisedAllTime(),t.totalBurnedAllTime(),t.totalCampaignsCreated(),t.totalSuccessfulWithdrawals()]);return{raised:n,burned:a,created:Number(s),withdrawals:Number(r)}}catch{return null}}function Mf(e,t="create"){var s;const n=(s=e.target.files)==null?void 0:s[0];if(!n)return;if(!Sf.includes(n.type)){x("Please select a valid image (JPG, PNG, GIF, WebP)","error");return}if(n.size>Lf){x("Image must be less than 5MB","error");return}B.pendingImageFile=n;const a=new FileReader;a.onload=r=>{const i=t==="edit"?"edit-image-preview":"create-image-preview",o=document.getElementById(t==="edit"?"edit-image-upload":"create-image-upload"),l=document.getElementById(i);l&&(l.innerHTML=`
            ...
            `),o&&o.classList.add("has-image")},a.readAsDataURL(n)}function Nc(e="create"){B.pendingImageFile=null,B.pendingImage=null;const t=e==="edit"?"edit-image-preview":"create-image-preview",n=document.getElementById(e==="edit"?"edit-image-upload":"create-image-upload"),a=document.getElementById(t);a&&(a.innerHTML=""),n&&n.classList.remove("has-image");const s=document.getElementById(e==="edit"?"edit-image-file":"create-image-file");s&&(s.value="")}function Df(e,t="create"){document.querySelectorAll(`#${t}-image-tabs .cp-tab`).forEach(r=>r.classList.toggle("active",r.dataset.tab===e));const a=document.getElementById(`${t}-image-upload`),s=document.getElementById(`${t}-image-url-wrap`);a&&(a.style.display=e==="upload"?"block":"none"),s&&(s.style.display=e==="url"?"block":"none")}async function zc(e){const t=new FormData;t.append("image",e);const n=await fetch(Pa.uploadImage,{method:"POST",body:t});if(!n.ok)throw new Error("Upload failed");return(await n.json()).imageUrl}const Lc=e=>{const t=bi[dr(e)]||bi[0];return`<span class="cp-badge" style="background:${t.color}20;color:${t.color}"><i class="fa-solid ${t.icon}"></i> ${t.label}</span>`},Of=()=>'<div class="cp-loading"><div class="cp-spinner"></div><span class="text-zinc-500">Loading campaigns...</span></div>',Sc=e=>`<div class="cp-empty"><i class="fa-solid fa-inbox"></i><h3>${e}</h3><p class="text-zinc-600 text-sm">Be the first to create a campaign!</p></div>`,$c=e=>{var s,r,i,o;const t=Mn(e.raisedAmount,e.goalAmount),n=Ic(e.deadline),a=e.category||"humanitarian";return`
    ...
    `},gi=()=>{var a,s,r,i;const e=B.campaigns.filter(o=>ur(o)),t=e.filter(o=>o.category==="animal"),n=e.filter(o=>o.category==="humanitarian");return`
        <div class="charity-page">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4" id="cp-grid">
                ${e.length?e.filter(o=>!B.selectedCategory||o.category===B.selectedCategory).sort((o,l)=>Number(l.createdAt||0)-Number(o.createdAt||0)).map(o=>$c(o)).join(""):Sc("No active campaigns")}
            </div>
        </div>
    `},xi=e=>{var o,l,d,u,f,m;if(!e)return`
        <div class="charity-page">
    ...
    `;const t=Mn(e.raisedAmount,e.goalAmount),n=Ic(e.deadline),a=e.category||"humanitarian",s=ur(e),r=((o=e.creator)==null?void 0:o.toLowerCase())===((l=c==null?void 0:c.userAddress)==null?void 0:l.toLowerCase()),i=Pc(e);return`
        <div class="charity-page">
            ${Rc()}
            ${_c()}
...
`;function Dn(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.add("active")}function rt(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.remove("active")}function jf(e="humanitarian"){var t;B.pendingImage=null,B.pendingImageFile=null,Nc("create"),document.querySelectorAll("#modal-create .cp-cat-option").forEach(n=>n.classList.remove("selected")),(t=document.getElementById(`opt-${e}`))==null||t.classList.add("selected"),["campaign-title","campaign-desc","campaign-goal","campaign-duration","campaign-image-url"].forEach(n=>{const a=document.getElementById(n);a&&(a.value="")}),Dn("create")}function Wf(e){const t=B.campaigns.find(s=>s.id===e||s.id===String(e));if(!t)return;const n=document.getElementById("donate-campaign-info");n&&(n.innerHTML=`
        ...
        `);const a=document.getElementById("donate-amount");a&&(a.value=""),B.currentCampaign=t,Dn("donate")}function Gf(){var a;const e=(a=c==null?void 0:c.userAddress)==null?void 0:a.toLowerCase(),t=B.campaigns.filter(s=>{var r;return((r=s.creator)==null?void 0:r.toLowerCase())===e}),n=document.getElementById("my-campaigns-list");n&&(t.length===0?n.innerHTML=`
            <div class="cp-empty">
        ...
        `:n.innerHTML=t.map(s=>{const r=Mn(s.raisedAmount,s.goalAmount),i=Pc(s);return`
            ...
            `}).join(""),Dn("my"))}function Kf(e){var a,s,r;const t=B.campaigns.find(i=>i.id===e||i.id===String(e));if(!t)return;if(((a=t.creator)==null?void 0:a.toLowerCase())!==((s=c==null?void 0:c.userAddress)==null?void 0:s.toLowerCase())){x("Not your campaign","error");return}B.editingCampaign=t,B.pendingImageFile=null,document.getElementById("edit-campaign-id").value=t.id,document.getElementById("edit-title").value=t.title||"",document.getElementById("edit-desc").value=t.description||"",document.getElementById("edit-image-url").value=t.imageUrl||"",document.querySelectorAll("#modal-edit .cp-cat-option").forEach(i=>i.classList.remove("selected")),(r=document.getElementById(`edit-opt-${t.category||"humanitarian"}`))==null||r.classList.add("selected");const n=document.getElementById("edit-image-preview");n&&t.imageUrl?n.innerHTML=`<img src="${t.imageUrl}" class="cp-image-preview">`:n&&(n.innerHTML=""),Dn("edit")}function Yf(e,t="create"){var s;const n=t==="edit"?"edit-opt-":"opt-",a=t==="edit"?"#modal-edit":"#modal-create";document.querySelectorAll(`${a} .cp-cat-option`).forEach(r=>r.classList.remove("selected")),(s=document.getElementById(`${n}${e}`))==null||s.classList.add("selected")}function qf(e){const t=document.getElementById("donate-amount")||document.getElementById("detail-amount");t&&(t.value=e)}async function Vf(){var d,u,f,m,b,p,g,y;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=document.querySelector("#modal-create .cp-cat-option.selected input"),t=(e==null?void 0:e.value)||"humanitarian",n=(u=(d=document.getElementById("campaign-title"))==null?void 0:d.value)==null?void 0:u.trim(),a=(m=(f=document.getElementById("campaign-desc"))==null?void 0:f.value)==null?void 0:m.trim(),s=(b=document.getElementById("campaign-goal"))==null?void 0:b.value,r=(p=document.getElementById("campaign-duration"))==null?void 0:p.value;let i=(y=(g=document.getElementById("campaign-image-url"))==null?void 0:g.value)==null?void 0:y.trim();if(!n)return x("Enter a title","error");if(!a)return x("Enter a description","error");if(!s||parseFloat(s)<.01)return x("Goal must be at least 0.01 ETH","error");if(!r||parseInt(r)<1)return x("Duration must be at least 1 day","error");if(B.pendingImageFile)try{x("Uploading image...","info"),i=await zc(B.pendingImageFile)}catch(k){console.error("Image upload failed:",k)}const o=tn.parseEther(s),l=parseInt(r)*86400;await Jt.createCampaign({title:n,description:a,goalAmount:o,duration:l,button:document.getElementById("btn-create"),onSuccess:async(k,E)=>{if(E)try{await fetch(Pa.saveCampaign,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:E,title:n,description:a,category:t,imageUrl:i,creator:c.userAddress})})}catch{}x("🎉 Campaign created!","success"),rt("create"),B.pendingImageFile=null,await Lt(),ut()},onError:k=>{var E;!k.cancelled&&k.type!=="user_rejected"&&x(((E=k.message)==null?void 0:E.slice(0,80))||"Failed","error")}})}async function Xf(){var a;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=B.currentCampaign;if(!e)return;const t=(a=document.getElementById("donate-amount"))==null?void 0:a.value;if(!t||parseFloat(t)<.001)return x("Minimum 0.001 ETH","error");const n=tn.parseEther(t);await Jt.donate({campaignId:e.id,amount:n,button:document.getElementById("btn-donate"),onSuccess:async()=>{x("❤️ Thank you for your donation!","success"),rt("donate"),await Lt(),ut()},onError:s=>{var r;!s.cancelled&&s.type!=="user_rejected"&&x(((r=s.message)==null?void 0:r.slice(0,80))||"Failed","error")}})}async function Jf(e){var a;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const t=(a=document.getElementById("detail-amount"))==null?void 0:a.value;if(!t||parseFloat(t)<.001)return x("Minimum 0.001 ETH","error");const n=tn.parseEther(t);await Jt.donate({campaignId:e,amount:n,button:document.getElementById("btn-donate-detail"),onSuccess:async()=>{x("❤️ Thank you for your donation!","success"),await Lt(),await St(e)},onError:s=>{var r;!s.cancelled&&s.type!=="user_rejected"&&x(((r=s.message)==null?void 0:r.slice(0,80))||"Failed","error")}})}async function Zf(e){if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");confirm("Cancel this campaign? This cannot be undone.")&&await Jt.cancel({campaignId:e,button:document.getElementById("btn-cancel"),onSuccess:async()=>{x("Campaign cancelled","success"),await Lt(),ut()},onError:t=>{var n;!t.cancelled&&t.type!=="user_rejected"&&x(((n=t.message)==null?void 0:n.slice(0,80))||"Failed","error")}})}async function Qf(e){if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const t=B.campaigns.find(s=>s.id===e||s.id===String(e));if(!t)return;const n=Mn(t.raisedAmount,t.goalAmount);let a=`Withdraw ${ke(t.raisedAmount)} ETH?

5% platform fee applies.`;n<100&&(a+=`
Goal not reached - partial withdrawal.`),confirm(a)&&await Jt.withdraw({campaignId:e,button:document.getElementById(`btn-withdraw-${e}`)||document.getElementById("btn-withdraw"),onSuccess:async()=>{var s;x("✅ Funds withdrawn successfully!","success"),rt("my"),await Lt(),ut(),((s=B.currentCampaign)==null?void 0:s.id)===e&&await St(e)},onError:s=>{var r;!s.cancelled&&s.type!=="user_rejected"&&x(((r=s.message)==null?void 0:r.slice(0,80))||"Failed","error")}})}async function eb(){var o,l,d,u,f,m,b,p;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=(o=document.getElementById("edit-campaign-id"))==null?void 0:o.value,t=(d=(l=document.getElementById("edit-title"))==null?void 0:l.value)==null?void 0:d.trim(),n=(f=(u=document.getElementById("edit-desc"))==null?void 0:u.value)==null?void 0:f.trim();let a=(b=(m=document.getElementById("edit-image-url"))==null?void 0:m.value)==null?void 0:b.trim();const s=document.querySelector("#modal-edit .cp-cat-option.selected input"),r=(s==null?void 0:s.value)||"humanitarian";if(!t)return x("Enter title","error");if(B.pendingImageFile)try{x("Uploading image...","info"),a=await zc(B.pendingImageFile)}catch(g){console.error("Image upload failed:",g)}const i=document.getElementById("btn-save-edit");i&&(i.disabled=!0,i.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Saving...');try{await fetch(Pa.saveCampaign,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:e,title:t,description:n,category:r,imageUrl:a,creator:c.userAddress})}),x("✅ Campaign updated!","success"),rt("edit"),B.pendingImageFile=null,await Lt(),((p=B.currentCampaign)==null?void 0:p.id)===e?await St(e):ut()}catch{x("Failed to save","error")}finally{i&&(i.disabled=!1,i.innerHTML='<i class="fa-solid fa-check"></i> Save')}}function tb(e){const t=B.currentCampaign;if(!t)return;const n=Ac(t.id),a=`🙏 Support "${t.title}" on Backcoin Charity!

${ke(t.raisedAmount)} raised of ${ke(t.goalAmount)} goal.

`;let s;e==="twitter"?s=`https://twitter.com/intent/tweet?text=${encodeURIComponent(a)}&url=${encodeURIComponent(n)}`:e==="telegram"?s=`https://t.me/share/url?url=${encodeURIComponent(n)}&text=${encodeURIComponent(a)}`:e==="whatsapp"&&(s=`https://wa.me/?text=${encodeURIComponent(a+n)}`),s&&window.open(s,"_blank","width=600,height=400")}function nb(){const e=B.currentCampaign;e&&navigator.clipboard.writeText(Ac(e.id)).then(()=>x("Link copied!","success")).catch(()=>x("Copy failed","error"))}function Fc(){_f(),B.currentCampaign=null,B.currentView="main",ut()}function ab(e){rt("my"),rt("donate"),rt("edit"),Rf(e),St(e)}function sb(e){B.selectedCategory=B.selectedCategory===e?null:e,mr()}function rb(){B.selectedCategory=null,mr()}function mr(){const e=document.getElementById("cp-grid");if(!e)return;let t=B.campaigns.filter(n=>ur(n));B.selectedCategory&&(t=t.filter(n=>n.category===B.selectedCategory)),t.sort((n,a)=>Number(a.createdAt||0)-Number(n.createdAt||0)),e.innerHTML=t.length?t.map(n=>$c(n)).join(""):Sc("No campaigns")}async function St(e){B.currentView="detail",B.isLoading=!0;const t=vs();t&&(t.innerHTML=Of());try{let n=B.campaigns.find(a=>a.id===e||a.id===String(e));if(!n){const a=c==null?void 0:c.publicProvider;if(a){const r=await new tn.Contract(w.charityPool,pr,a).campaigns(e);n={id:String(e),creator:r[0],title:r[1],description:r[2],goalAmount:BigInt(r[3].toString()),raisedAmount:BigInt(r[4].toString()),donationCount:Number(r[5]),deadline:Number(r[6]),createdAt:Number(r[7]),status:Number(r[8]),category:"humanitarian",imageUrl:null}}}B.currentCampaign=n,t&&(t.innerHTML=xi(n))}catch{t&&(t.innerHTML=xi(null))}finally{B.isLoading=!1}}function vs(){let e=document.getElementById("charity-container");if(e)return e;const t=document.getElementById("charity");return t?(e=document.createElement("div"),e.id="charity-container",t.innerHTML="",t.appendChild(e),e):null}function ut(){$f();const e=vs();if(!e)return;const t=Bc();t?St(t):(B.currentView="main",B.currentCampaign=null,e.innerHTML=gi(),Lt().then(()=>{if(B.currentView==="main"){const n=vs();n&&(n.innerHTML=gi())}}))}async function ib(){B.campaigns=[],B.stats=null,B.currentView==="detail"&&B.currentCampaign?await St(B.currentCampaign.id):ut()}window.addEventListener("hashchange",()=>{var e;if(window.location.hash.startsWith("#charity")){const t=Bc();t?((e=B.currentCampaign)==null?void 0:e.id)!==t&&St(t):B.currentView!=="main"&&Fc()}});const Mc={render(e){e&&ut()},update(){B.currentView==="main"&&mr()},refresh:ib,openModal:Dn,closeModal:rt,openCreate:jf,openDonate:Wf,openMyCampaigns:Gf,openEdit:Kf,create:Vf,donate:Xf,donateDetail:Jf,cancel:Zf,withdraw:Qf,saveEdit:eb,selCatOpt:Yf,setAmt:qf,goBack:Fc,viewCampaign:ab,selectCat:sb,clearCat:rb,share:tb,copyLink:nb,handleImageSelect:Mf,removeImage:Nc,switchImageTab:Df};window.CharityPage=Mc;const he=window.ethers,ob="https://sepolia.arbiscan.io/address/",lb=cd;function fr(){return w.backchat||w.Backchat||null}function nn(){return w.operator||w.treasury||null}const P={activeTab:"feed",view:"feed",posts:[],trendingPosts:[],userProfile:null,profiles:new Map,following:new Set,selectedPost:null,selectedProfile:null,fees:{post:0n,reply:0n,like:0n,follow:0n,repost:0n,superLikeMin:0n,boostMin:0n,badge:0n},pendingEth:0n,hasBadge:!1,isBoosted:!1,boostExpiry:0,badgeExpiry:0,referralStats:null,referredBy:null,isLoading:!1,isPosting:!1,contractAvailable:!0,error:null};function cb(){if(document.getElementById("backchat-styles-v70"))return;const e=document.getElementById("backchat-styles-v69");e&&e.remove();const t=document.createElement("style");t.id="backchat-styles-v70",t.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(t)}function br(e){return e?`${e.slice(0,6)}...${e.slice(-4)}`:""}function db(e){const n=Date.now()/1e3-e;return n<60?"now":n<3600?`${Math.floor(n/60)}m`:n<86400?`${Math.floor(n/3600)}h`:n<604800?`${Math.floor(n/86400)}d`:new Date(e*1e3).toLocaleDateString("en-US",{month:"short",day:"numeric"})}function Bt(e){if(!e||e===0n)return"0";const t=parseFloat(he.formatEther(e));return t<1e-4?"<0.0001":t<.01?t.toFixed(4):t<1?t.toFixed(3):t.toFixed(2)}function gr(e){return e?e.slice(2,4).toUpperCase():"?"}function ub(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}function xr(){if(c.backchatContract)return c.backchatContract;if(c.backchatContractPublic)return c.backchatContractPublic;const e=fr();return e?c.publicProvider?new he.Contract(e,Ei,c.publicProvider):null:(console.warn("Backchat address not found in deployment-addresses.json"),null)}function pt(){if(c.backchatContract)return c.backchatContract;const e=fr();return!e||!c.signer?null:new he.Contract(e,Ei,c.signer)}async function hi(){try{const e=xr();if(!e)return;const t=await e.getCurrentFees();P.fees={post:t.postFee,reply:t.replyFee,like:t.likeFee,follow:t.followFee,repost:t.repostFee,superLikeMin:t.superLikeMin,boostMin:t.boostMin,badge:t.badgeFee_}}catch(e){console.warn("Failed to load fees:",e.message)}}async function vi(){if(!(!c.isConnected||!c.userAddress)){try{const e=xr();if(!e)return;const[t,n,a,s,r,i,o]=await Promise.all([e.getPendingBalance(c.userAddress).catch(()=>0n),e.hasTrustBadge(c.userAddress).catch(()=>!1),e.isProfileBoosted(c.userAddress).catch(()=>!1),e.boostExpiry(c.userAddress).catch(()=>0),e.badgeExpiry(c.userAddress).catch(()=>0),e.referredBy(c.userAddress).catch(()=>he.ZeroAddress),e.getReferralStats(c.userAddress).catch(()=>({totalReferred:0n,totalEarned:0n}))]);P.pendingEth=t,P.hasBadge=n,P.isBoosted=a,P.boostExpiry=Number(s),P.badgeExpiry=Number(r),P.referredBy=i&&i!==he.ZeroAddress?i:null,P.referralStats={totalReferred:Number(o.totalReferred),totalEarned:o.totalEarned,totalEarnedFormatted:he.formatEther(o.totalEarned)}}catch(e){console.warn("Failed to load user status:",e.message)}await pb()}}async function pb(){var e,t;try{if(!c.isConnected||!c.userAddress||P.referredBy)return;const n=localStorage.getItem("backchain_referrer");if(!n)return;if(n.toLowerCase()===c.userAddress.toLowerCase()){localStorage.removeItem("backchain_referrer");return}const a=pt();if(!a)return;console.log("[Referral] Auto-setting referrer:",n);const s=await a.setReferrer(n);x("Setting your referrer...","info"),await s.wait(),P.referredBy=n,localStorage.removeItem("backchain_referrer"),x("Referrer registered! They earn 30% of your fees.","success"),ze()}catch(n){console.warn("[Referral] Auto-set failed:",n.message),((e=n.message)!=null&&e.includes("ReferrerAlreadySet")||(t=n.message)!=null&&t.includes("already set"))&&localStorage.removeItem("backchain_referrer")}}async function ma(){P.isLoading=!0,ze();try{if(!fr()){P.contractAvailable=!1,P.error='Backchat contract not deployed yet. Add "backchat" to deployment-addresses.json',console.warn("⚠️ Backchat address not found in config");return}const t=xr();if(!t){P.contractAvailable=!1,P.error="Could not connect to Backchat contract";return}P.contractAvailable=!0;const n=await t.postCounter();if(Number(n)===0){P.posts=[];return}const s=t.filters.PostCreated(),r=await t.queryFilter(s,-1e4),i=t.filters.ReplyCreated(),o=await t.queryFilter(i,-1e4),l=t.filters.RepostCreated(),d=await t.queryFilter(l,-1e4),u=t.filters.SuperLiked(),f=await t.queryFilter(u,-1e4),m=new Map;for(const p of f){const g=p.args.postId.toString(),y=p.args.ethAmount,k=m.get(g)||0n;m.set(g,k+y)}const b=[];for(const p of r.slice(-50)){const g=await p.getBlock();b.push({id:p.args.postId.toString(),type:"post",author:p.args.author,content:p.args.content,mediaCID:p.args.mediaCID,timestamp:g.timestamp,superLikes:m.get(p.args.postId.toString())||0n,txHash:p.transactionHash})}for(const p of o.slice(-30)){const g=await p.getBlock();b.push({id:p.args.postId.toString(),type:"reply",parentId:p.args.parentId.toString(),author:p.args.author,content:p.args.content,mediaCID:p.args.mediaCID,tipBkc:p.args.tipBkc,timestamp:g.timestamp,superLikes:m.get(p.args.postId.toString())||0n,txHash:p.transactionHash})}for(const p of d.slice(-20)){const g=await p.getBlock();b.push({id:p.args.newPostId.toString(),type:"repost",originalPostId:p.args.originalPostId.toString(),author:p.args.reposter,timestamp:g.timestamp,txHash:p.transactionHash})}b.sort((p,g)=>g.timestamp-p.timestamp),P.posts=b,P.trendingPosts=[...b].filter(p=>p.superLikes>0n).sort((p,g)=>{const y=BigInt(p.superLikes||0),k=BigInt(g.superLikes||0);return k>y?1:k<y?-1:0})}catch(e){console.error("Failed to load posts:",e),P.error=e.message}finally{P.isLoading=!1,ze()}}async function mb(){var a;const e=document.getElementById("bc-compose-input"),t=(a=e==null?void 0:e.value)==null?void 0:a.trim();if(!t){x("Please write something","error");return}if(t.length>500){x("Post too long (max 500 chars)","error");return}const n=pt();if(!n){x("Please connect wallet","error");return}P.isPosting=!0,ze();try{const s=P.fees.post||await n.calculateFee(5e4),r=await n.createPost(t,"",nn()||he.ZeroAddress,{value:s});x("Posting...","info"),await r.wait(),x("Post created! 🎉","success"),e.value="",await ma()}catch(s){console.error("Post error:",s),s.code!=="ACTION_REJECTED"&&x("Failed: "+(s.reason||s.message),"error")}finally{P.isPosting=!1,ze()}}async function fb(e){var n;const t=pt();if(!t){x("Please connect wallet","error");return}try{const a=P.fees.like||await t.calculateFee(55e3),s=await t.like(e,nn()||he.ZeroAddress,0,{value:a});x("Liking...","info"),await s.wait(),x("Liked! ❤️","success")}catch(a){console.error("Like error:",a),a.code!=="ACTION_REJECTED"&&((n=a.message)!=null&&n.includes("AlreadyLiked")?x("Already liked this post","warning"):x("Failed: "+(a.reason||a.message),"error"))}}async function bb(e,t){const n=pt();if(!n){x("Please connect wallet","error");return}const a=he.parseEther(t);try{const s=await n.superLike(e,nn()||he.ZeroAddress,0,{value:a});x("Super liking...","info"),await s.wait(),x("Super Liked! ⭐","success"),await ma()}catch(s){console.error("Super like error:",s),s.code!=="ACTION_REJECTED"&&x("Failed: "+(s.reason||s.message),"error")}}async function gb(e){const t=pt();if(!t){x("Please connect wallet","error");return}try{const n=P.fees.follow||await t.calculateFee(45e3),a=await t.follow(e,nn()||he.ZeroAddress,0,{value:n});x("Following...","info"),await a.wait(),P.following.add(e.toLowerCase()),x("Followed! 👥","success"),ze()}catch(n){console.error("Follow error:",n),n.code!=="ACTION_REJECTED"&&x("Failed: "+(n.reason||n.message),"error")}}async function xb(){const e=pt();if(!e){x("Please connect wallet","error");return}if(P.pendingEth===0n){x("No earnings to withdraw","warning");return}try{const t=await e.withdraw();x("Withdrawing...","info"),await t.wait(),x(`Withdrawn ${Bt(P.pendingEth)} ETH! 💰`,"success"),P.pendingEth=0n,ze()}catch(t){console.error("Withdraw error:",t),t.code!=="ACTION_REJECTED"&&x("Failed: "+(t.reason||t.message),"error")}}function hb(){return`
        <div class="bc-header">
    ...
    `}function vb(){if(!c.isConnected)return"";const e=Bt(P.fees.post);return`
    ...
    `}function hr(e,t=0){const n=Bt(e.superLikes);return`
        <div class="bc-post" data-post-id="${e.id}" style="animation-delay:${Math.min(t*.04,.4)}s">
            <div class="bc-post-top">
                ...
                <div class="bc-post-head">
                    <div class="bc-post-author-row">
                        <span class="bc-author-name" onclick="BackchatPage.viewProfile('${e.author}')">${br(e.author)}</span>
                        
                        <span class="bc-post-time">· ${db(e.timestamp)}</span>
            ...
            ${e.content?`<div class="bc-post-body">${ub(e.content)}</div>`:""}
            
            ${e.mediaCID?`
                <div class="bc-post-media">
                    <img src="${lb}${e.mediaCID}" alt="Media" loading="lazy">
                </div>
            `:""}
    ...
    `}function wb(){return P.contractAvailable?P.isLoading?`
        ...
        `}function yb(){return P.trendingPosts.length===0?`
            <div class="bc-empty">
                <div class="bc-empty-glyph accent">
                    <i class="fa-solid fa-fire"></i>
                </div>
        ...
        ${P.trendingPosts.map((e,t)=>hr(e,t)).join("")}
    `}function kb(){var t;if(!c.isConnected)return`
            <div class="bc-empty">
                <div class="bc-empty-glyph">
                    <i class="fa-solid fa-wallet"></i>
                </div>
        ...
        <div class="bc-profile-section">
            ...
            <div class="bc-profile-main">
                ...
                <div class="bc-profile-name-row">
                    <span class="bc-profile-name">${br(c.userAddress)}</span>
                ...
                <div class="bc-profile-handle">
                    <a href="${ob}${c.userAddress}" target="_blank" rel="noopener">
    ...
    `}function Tb(){var a,s;if(!c.isConnected)return"";const e=`${window.location.origin}/#backchat?ref=${c.userAddress}`,t=((a=P.referralStats)==null?void 0:a.totalReferred)||0,n=((s=P.referralStats)==null?void 0:s.totalEarnedFormatted)||"0.0";return`
        <div class="bc-referral-card">
            ...
            <div class="bc-referral-info" style="margin-top:12px;">
                ...
                ${P.referredBy?`<br>You were referred by <code style="font-size:11px;color:var(--bc-accent);">${br(P.referredBy)}</code>`:""}
            </div>
        </div>
    `}function ze(){const e=document.getElementById("backchat-content");if(!e)return;let t="";switch(P.activeTab){case"feed":t=vb()+wb();break;case"trending":t=yb();break;case"profile":t=kb();break}e.innerHTML=t}function Eb(){return`
        <!-- Super Like Modal -->
    ...
    `}function Cb(){cb();const e=document.getElementById("backchat");e&&(e.innerHTML=`
        <div class="bc-shell">
            ${hb()}
            <div id="backchat-content"></div>
        </div>
        ${Eb()}
    `,ze())}let Dc=null;function Ib(e){Dc=e,document.getElementById("modal-superlike").classList.add("active")}async function Ab(){var t;const e=((t=document.getElementById("superlike-amount"))==null?void 0:t.value)||"0.001";za("superlike"),await bb(Dc,e)}function Bb(){document.getElementById("modal-badge").classList.add("active")}async function Pb(){za("badge");const e=pt();if(!e){x("Please connect wallet","error");return}try{const t=await e.obtainBadge(nn()||he.ZeroAddress,{value:P.fees.badge});x("Getting badge...","info"),await t.wait(),P.hasBadge=!0,x("Badge obtained! ✅","success"),ze()}catch(t){console.error("Badge error:",t),t.code!=="ACTION_REJECTED"&&x("Failed: "+(t.reason||t.message),"error")}}function Nb(){document.getElementById("modal-boost").classList.add("active")}async function zb(){var n;const e=((n=document.getElementById("boost-amount"))==null?void 0:n.value)||"0.001";za("boost");const t=pt();if(!t){x("Please connect wallet","error");return}try{const a=await t.boostProfile(nn()||he.ZeroAddress,{value:he.parseEther(e)});x("Boosting profile...","info"),await a.wait(),P.isBoosted=!0,x("Profile boosted! 🚀","success"),ze()}catch(a){console.error("Boost error:",a),a.code!=="ACTION_REJECTED"&&x("Failed: "+(a.reason||a.message),"error")}}function za(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.remove("active")}function Lb(e){const t=document.getElementById("bc-char-counter");if(!t)return;const n=e.value.length;t.textContent=`${n}/500`,t.className="bc-char-count",n>450?t.classList.add("danger"):n>350&&t.classList.add("warn")}const Oc={async render(e){e&&(Cb(),await Promise.all([hi(),vi(),ma()]))},async refresh(){await Promise.all([hi(),vi(),ma()])},setTab(e){P.activeTab=e,ze()},createPost:mb,like:fb,openSuperLike:Ib,confirmSuperLike:Ab,follow:gb,withdraw:xb,openBadge:Bb,confirmBadge:Pb,openBoost:Nb,confirmBoost:zb,closeModal:za,openEarnings(){P.activeTab="profile",ze()},_updateCharCount:Lb,copyReferralLink(){const e=`${window.location.origin}/#backchat?ref=${c.userAddress}`;navigator.clipboard.writeText(e).then(()=>x("Referral link copied!","success"),()=>x("Failed to copy","error"))},shareReferral(){const e=`${window.location.origin}/#backchat?ref=${c.userAddress}`,t="Join Backchat — earn crypto by posting, liking, and referring friends! 30% referral rewards.";navigator.share?navigator.share({title:"Backchat Referral",text:t,url:e}).catch(()=>{}):navigator.clipboard.writeText(`${t}
${e}`).then(()=>x("Referral message copied!","success"),()=>x("Failed to copy","error"))},viewProfile(e){x("Profile view coming soon!","info")},openReply(e){x("Reply coming soon!","info")},repost(e){x("Repost coming soon!","info")},openTip(e){x("BKC Tips coming soon!","info")}};window.BackchatPage=Oc;const Sb=window.inject||(()=>{console.warn("Dev Mode: Analytics disabled.")});if(window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1")try{Sb()}catch(e){console.error("Analytics Error:",e)}const vr="".toLowerCase();window.__ADMIN_WALLET__=vr;vr&&console.log("✅ Admin access granted");let kt=null,cn=null,Qa=!1;const pe={dashboard:Gl,mine:Zl,store:Op,rewards:ia,actions:B0,charity:Mc,backchat:Oc,notary:dc,airdrop:lm,tokenomics:Ym,about:D0,admin:Rm,rental:wc,socials:If,creditcard:Af,dex:H,dao:Bf,tutorials:Tc};function Hc(e){return!e||e.length<42?"...":`${e.slice(0,6)}...${e.slice(-4)}`}function $b(e){if(!e)return"0.00";const t=_(e);return t>=1e9?(t/1e9).toFixed(2)+"B":t>=1e6?(t/1e6).toFixed(2)+"M":t>=1e4?t.toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):t.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function an(e,t=!1){const n=document.querySelector("main > div.container"),a=document.querySelectorAll(".sidebar-link");if(!n){console.error("❌ Page container not found");return}const s=window.location.hash.includes("/");if(!(kt!==e||t||s)){pe[e]&&typeof pe[e].update=="function"&&pe[e].update(c.isConnected);return}console.log(`📍 Navigating: ${kt} → ${e} (force: ${t})`),cn&&typeof cn=="function"&&(cn(),cn=null),Array.from(n.children).forEach(l=>{l.tagName==="SECTION"&&(l.classList.add("hidden"),l.classList.remove("active"))});const i=document.getElementById("charity-container");i&&e!=="charity"&&(i.innerHTML=""),a.forEach(l=>{l.classList.remove("active"),l.classList.add("text-zinc-400","hover:text-white","hover:bg-zinc-700")});const o=document.getElementById(e);if(o&&pe[e]){o.classList.remove("hidden"),o.classList.add("active");const l=kt!==e;kt=e;const d=document.querySelector(`.sidebar-link[data-target="${e}"]`);d&&(d.classList.remove("text-zinc-400","hover:text-white","hover:bg-zinc-700"),d.classList.add("active")),pe[e]&&typeof pe[e].render=="function"&&pe[e].render(l||t),typeof pe[e].cleanup=="function"&&(cn=pe[e].cleanup),l&&window.scrollTo(0,0)}else e!=="dashboard"&&e!=="faucet"&&(console.warn(`Route '${e}' not found, redirecting to dashboard.`),an("dashboard",!0))}window.navigateTo=an;const wi="wallet-btn text-xs font-mono text-center max-w-fit whitespace-nowrap relative font-bold py-2 px-4 rounded-md transition-colors";function wr(e=!1){Qa||(Qa=!0,requestAnimationFrame(()=>{Rb(e),Qa=!1}))}function Rb(e){const t=document.getElementById("admin-link-container"),n=document.getElementById("statUserBalance"),a=document.getElementById("connectButtonDesktop"),s=document.getElementById("connectButtonMobile"),r=document.getElementById("mobileAppDisplay");let i=c.userAddress;const o=[a,s];if(c.isConnected&&i){const d=$b(c.currentUserBalance),f=`
            <div class="status-dot"></div>
            <span>${Hc(i)}</span>
            <div class="balance-pill">
                ${d} BKC
            </div>
        `;if(o.forEach(m=>{m&&(m.innerHTML=f,m.className=wi+" wallet-btn-connected")}),r&&(r.textContent="Backcoin.org",r.classList.add("text-white"),r.classList.remove("text-amber-400")),t){const m=i.toLowerCase()===vr;t.style.display=m?"block":"none"}n&&(n.textContent=d)}else{const d='<i class="fa-solid fa-plug"></i> Connect Wallet';o.forEach(u=>{u&&(u.innerHTML=d,u.className=wi+" wallet-btn-disconnected")}),r&&(r.textContent="Backcoin.org",r.classList.add("text-amber-400"),r.classList.remove("text-white")),t&&(t.style.display="none"),n&&(n.textContent="--")}const l=kt||"dashboard";e||!kt?an(l,!0):pe[l]&&typeof pe[l].update=="function"&&pe[l].update(c.isConnected)}function _b(e){const{isConnected:t,address:n,isNewConnection:a,wasConnected:s}=e,r=a||t!==s;c.isConnected=t,n&&(c.userAddress=n),wr(r),t&&a?x(`Connected: ${Hc(n)}`,"success"):!t&&s&&x("Wallet disconnected.","info")}function Fb(){const e=document.getElementById("testnet-banner"),t=document.getElementById("close-testnet-banner");if(!(!e||!t)){if(localStorage.getItem("hideTestnetBanner")==="true"){e.remove();return}e.style.transform="translateY(0)",t.addEventListener("click",()=>{e.style.transform="translateY(100%)",setTimeout(()=>e.remove(),500),localStorage.setItem("hideTestnetBanner","true")})}}function Mb(){const e=document.querySelectorAll(".sidebar-link"),t=document.getElementById("menu-btn"),n=document.getElementById("sidebar"),a=document.getElementById("sidebar-backdrop"),s=document.getElementById("connectButtonDesktop"),r=document.getElementById("connectButtonMobile"),i=document.getElementById("shareProjectBtn");Fb(),e.length>0&&e.forEach(l=>{l.addEventListener("click",async d=>{d.preventDefault();const u=l.dataset.target;if(u==="faucet"){x("Accessing Testnet Faucet...","info"),await Ls("BKC")&&wr(!0);return}u&&(window.location.hash=u,an(u,!0),n&&n.classList.contains("translate-x-0")&&(n.classList.remove("translate-x-0"),n.classList.add("-translate-x-full"),a&&a.classList.add("hidden")))})});const o=()=>{Hi()};s&&s.addEventListener("click",o),r&&r.addEventListener("click",o),i&&i.addEventListener("click",()=>ad(c.userAddress)),t&&n&&a&&(t.addEventListener("click",()=>{n.classList.contains("translate-x-0")?(n.classList.add("-translate-x-full"),n.classList.remove("translate-x-0"),a.classList.add("hidden")):(n.classList.remove("-translate-x-full"),n.classList.add("translate-x-0"),a.classList.remove("hidden"))}),a.addEventListener("click",()=>{n.classList.add("-translate-x-full"),n.classList.remove("translate-x-0"),a.classList.add("hidden")}))}function Uc(){const e=window.location.hash.replace("#","");if(!e)return"dashboard";const t=e.split(/[/?]/)[0];return pe[t]?t:"dashboard"}function jc(){try{const e=window.location.hash,t=e.indexOf("?");if(t===-1)return;const a=new URLSearchParams(e.substring(t)).get("ref");a&&/^0x[a-fA-F0-9]{40}$/.test(a)&&(localStorage.getItem("backchain_referrer")||(localStorage.setItem("backchain_referrer",a),console.log("[Referral] Captured referrer from URL:",a)))}catch(e){console.warn("[Referral] Failed to parse referral param:",e.message)}}window.addEventListener("load",async()=>{console.log("🚀 App Initializing..."),Be.earn||(Be.earn=document.getElementById("mine"));try{if(!await dd())throw new Error("Failed to load contract addresses")}catch(n){console.error("❌ Critical Initialization Error:",n),x("Initialization failed. Please refresh.","error");return}Mb(),await ou(),lu(_b),sd();const e=document.getElementById("preloader");e&&(e.style.display="none"),jc();const t=Uc();console.log("📍 Initial page from URL:",t,"Hash:",window.location.hash),an(t,!0),console.log("✅ App Ready.")});window.addEventListener("hashchange",()=>{jc();const e=Uc(),t=window.location.hash;console.log("🔄 Hash changed to:",e,"Full hash:",t),e!==kt?an(e,!0):e==="charity"&&pe[e]&&typeof pe[e].render=="function"&&pe[e].render(!0)});window.EarnPage=Zl;window.openConnectModal=Hi;window.disconnectWallet=cu;window.updateUIState=wr;export{Tt as C,V as E,Iu as G,ie as N,Bu as T,X as V,Y as _,Fa as a,Ma as b,h as c,Da as d,ee as e,Au as f,Ss as g,Yi as h,Nu as i,zu as j,Ve as k,Lu as l,Ei as m,Mt as n,w as o,$ as p,ce as r,Pu as s,Z as t};
