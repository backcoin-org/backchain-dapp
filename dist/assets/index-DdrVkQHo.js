import{defaultConfig as Vd,createWeb3Modal as qd}from"https://esm.sh/@web3modal/ethers@5.1.11?bundle";import{initializeApp as Xd}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-app.js";import{getAuth as Jd,onAuthStateChanged as Zd,signInAnonymously as Qd}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-auth.js";import{getFirestore as eu,collection as et,query as Dt,where as dn,orderBy as sa,getDocs as ht,doc as le,getDoc as Ne,limit as tu,serverTimestamp as vt,writeBatch as Tn,updateDoc as Cn,increment as Ue,setDoc as In,Timestamp as wo,addDoc as au,deleteDoc as nu}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-firestore.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function a(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(r){if(r.ep)return;r.ep=!0;const i=a(r);fetch(r.href,i)}})();const Se={sidebar:document.getElementById("sidebar"),sidebarBackdrop:document.getElementById("sidebar-backdrop"),menuBtn:document.getElementById("menu-btn"),navLinks:document.getElementById("nav-links"),mainContentSections:document.querySelectorAll("main section"),connectButtonDesktop:document.getElementById("connectButtonDesktop"),connectButtonMobile:document.getElementById("connectButtonMobile"),mobileAppDisplay:document.getElementById("mobileAppDisplay"),desktopDisconnected:document.getElementById("desktopDisconnected"),desktopConnectedInfo:document.getElementById("desktopConnectedInfo"),desktopUserAddress:document.getElementById("desktopUserAddress"),desktopUserBalance:document.getElementById("desktopUserBalance"),modalContainer:document.getElementById("modal-container"),toastContainer:document.getElementById("toast-container"),dashboard:document.getElementById("dashboard"),earn:document.getElementById("mine"),store:document.getElementById("store"),rental:document.getElementById("rental"),rewards:document.getElementById("rewards"),actions:document.getElementById("actions"),presale:document.getElementById("presale"),faucet:document.getElementById("faucet"),airdrop:document.getElementById("airdrop"),dao:document.getElementById("dao"),about:document.getElementById("about"),admin:document.getElementById("admin"),tokenomics:document.getElementById("tokenomics"),notary:document.getElementById("notary"),statTotalSupply:document.getElementById("statTotalSupply"),statValidators:document.getElementById("statValidators"),statTotalPStake:document.getElementById("statTotalPStake"),statScarcity:document.getElementById("statScarcity"),statLockedPercentage:document.getElementById("statLockedPercentage"),statUserBalance:document.getElementById("statUserBalance"),statUserPStake:document.getElementById("statUserPStake"),statUserRewards:document.getElementById("statUserRewards")},ru={provider:null,publicProvider:null,web3Provider:null,signer:null,userAddress:null,isConnected:!1,bkcTokenContract:null,ecosystemManagerContract:null,stakingPoolContract:null,buybackMinerContract:null,rewardBoosterContract:null,fortunePoolContract:null,agoraContract:null,notaryContract:null,charityPoolContract:null,rentalManagerContract:null,faucetContract:null,liquidityPoolContract:null,governanceContract:null,bkcTokenContractPublic:null,ecosystemManagerContractPublic:null,stakingPoolContractPublic:null,buybackMinerContractPublic:null,fortunePoolContractPublic:null,agoraContractPublic:null,notaryContractPublic:null,charityPoolContractPublic:null,rentalManagerContractPublic:null,faucetContractPublic:null,currentUserBalance:0n,currentUserNativeBalance:0n,userTotalPStake:0n,userDelegations:[],myBoosters:[],activityHistory:[],totalNetworkPStake:0n,allValidatorsData:[],systemFees:{},systemPStakes:{},boosterDiscounts:{},notaryFee:void 0,notaryMinPStake:void 0},iu={set(e,t,a){const n=e[t];if(e[t]=a,["currentUserBalance","isConnected","userTotalPStake","totalNetworkPStake"].includes(t)){if(n===a)return!0;window.updateUIState&&window.updateUIState()}return!0}},c=new Proxy(ru,iu);let yo=!1;const x=(e,t="info",a=null)=>{if(!Se.toastContainer)return;const n={success:{icon:"fa-check-circle",color:"bg-green-600",border:"border-green-400"},error:{icon:"fa-exclamation-triangle",color:"bg-red-600",border:"border-red-400"},info:{icon:"fa-info-circle",color:"bg-blue-600",border:"border-blue-400"},warning:{icon:"fa-exclamation-circle",color:"bg-yellow-600",border:"border-yellow-400"}},r=n[t]||n.info,i=document.createElement("div");i.className=`flex items-center w-full max-w-xs p-4 text-white rounded-lg shadow-lg transition-all duration-500 ease-out 
    ...
    `;Aa(a,"max-w-md")}const ko=e=>{window.navigateTo?window.navigateTo(e):console.error("navigateTo function not found."),Ie()};function lu(){var r,i,s,o,l,d;if(yo)return;yo=!0;const e="https://t.me/BackCoinorg",t="https://github.com/backcoin-org/backchain-dapp";Aa(`
    ...
    `,"max-w-sm",!1);const n=document.getElementById("modal-content");n&&((r=n.querySelector("#btnAirdrop"))==null||r.addEventListener("click",()=>{ko("airdrop")}),(i=n.querySelector("#btnExplore"))==null||i.addEventListener("click",()=>{Ie()}),(s=n.querySelector("#btnCEO"))==null||s.addEventListener("click",()=>{window.open(t+"/blob/main/docs/BE_YOUR_OWN_CEO.md","_blank")}),(o=n.querySelector("#btnDocs"))==null||o.addEventListener("click",()=>{window.open(t,"_blank")}),(l=n.querySelector("#btnSocials"))==null||l.addEventListener("click",()=>{ko("socials")}),(d=n.querySelector("#btnTelegram"))==null||d.addEventListener("click",()=>{window.open(e,"_blank")}))}const cu=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1";console.log(`Environment: ${cu?"DEVELOPMENT":"PRODUCTION"}`);const ti="ZWla0YY4A0Hw7e_rwyOXB",we={chainId:"0x66eee",chainIdDecimal:421614,chainName:"Arbitrum Sepolia",nativeCurrency:{name:"Ethereum",symbol:"ETH",decimals:18},blockExplorerUrls:["https://sepolia.arbiscan.io"],rpcUrls:[`https://arb-sepolia.g.alchemy.com/v2/${ti}`,"https://arbitrum-sepolia.blockpi.network/v1/rpc/public","https://arbitrum-sepolia-rpc.publicnode.com"]},ut=[{name:"Alchemy",url:`https://arb-sepolia.g.alchemy.com/v2/${ti}`,priority:1,isPublic:!1,corsCompatible:!0},{name:"BlockPI",url:"https://arbitrum-sepolia.blockpi.network/v1/rpc/public",priority:2,isPublic:!0,corsCompatible:!0},{name:"PublicNode",url:"https://arbitrum-sepolia-rpc.publicnode.com",priority:3,isPublic:!0,corsCompatible:!0},{name:"Arbitrum Official",url:"https://sepolia-rollup.arbitrum.io/rpc",priority:4,isPublic:!0,corsCompatible:!1}].filter(e=>e.url!==null),ai=`https://arb-sepolia.g.alchemy.com/v2/${ti}`;let He=0,Pa=new Map;function ea(){var e;return((e=ut[He])==null?void 0:e.url)||ai}function ni(){const e=He;do{He=(He+1)%ut.length;const a=ut[He];if(!a.corsCompatible){console.warn(`⏭️ Skipping ${a.name} (CORS incompatible)`);continue}if(He===e)return console.warn("⚠️ All RPCs have been tried. Resetting to primary."),He=0,ut[0].url}while(Pa.get(ut[He].url)==="unhealthy");const t=ut[He];return console.log(`🔄 Switched to RPC: ${t.name}`),t.url}function Cl(e){Pa.set(e,"unhealthy"),console.warn(`❌ RPC marked unhealthy: ${e}`),setTimeout(()=>{Pa.delete(e),console.log(`♻️ RPC health reset: ${e}`)},6e4)}function Il(e){Pa.set(e,"healthy")}function Al(){He=0,Pa.clear(),console.log(`✅ Reset to primary RPC: ${ut[0].name}`)}const Pl="https://white-defensive-eel-240.mypinata.cloud/ipfs/",un=["https://dweb.link/ipfs/","https://w3s.link/ipfs/","https://nftstorage.link/ipfs/","https://cloudflare-ipfs.com/ipfs/","https://ipfs.io/ipfs/"],v={},M={bkcToken:null,backchainEcosystem:null,stakingPool:null,buybackMiner:null,rewardBooster:null,nftPoolFactory:null,fortunePool:null,agora:null,notary:null,charityPool:null,rentalManager:null,liquidityPool:null,faucet:null,backchainGovernance:null,treasuryWallet:null};async function zl(){try{const e=await fetch(`./deployment-addresses.json?t=${Date.now()}`);if(!e.ok)throw new Error(`Failed to fetch deployment-addresses.json: ${e.status}`);const t=await e.json(),a=["bkcToken","backchainEcosystem","stakingPool","buybackMiner"];if(!a.every(r=>t[r]||t[Eo(r)])){const r=a.filter(i=>!t[i]&&!t[Eo(i)]);throw new Error(`Missing required addresses: ${r.join(", ")}`)}return v.bkcToken=t.bkcToken,v.backchainEcosystem=t.backchainEcosystem||t.ecosystemManager,v.stakingPool=t.stakingPool||t.delegationManager,v.buybackMiner=t.buybackMiner||t.miningManager,v.rewardBooster=t.rewardBooster||t.rewardBoosterNFT,v.nftPoolFactory=t.nftPoolFactory||t.nftLiquidityPoolFactory,v.fortunePool=t.fortunePool||t.fortunePoolV2,v.agora=t.agora||t.backchat,v.notary=t.notary||t.decentralizedNotary,v.charityPool=t.charityPool,v.rentalManager=t.rentalManager,v.liquidityPool=t.liquidityPool,v.faucet=t.faucet||t.simpleBkcFaucet,v.backchainGovernance=t.backchainGovernance,v.treasuryWallet=t.treasuryWallet,v.pool_bronze=t.pool_bronze,v.pool_silver=t.pool_silver,v.pool_gold=t.pool_gold,v.pool_diamond=t.pool_diamond,Object.assign(M,v),console.log("✅ V9 contract addresses loaded"),console.log("   Ecosystem:",v.backchainEcosystem),console.log("   StakingPool:",v.stakingPool),console.log("   Agora:",v.agora),console.log("   FortunePool:",v.fortunePool),!0}catch(e){return console.error("❌ Failed to load contract addresses:",e),!1}}function Eo(e){return{backchainEcosystem:"ecosystemManager",stakingPool:"delegationManager",buybackMiner:"miningManager",rewardBooster:"rewardBoosterNFT",nftPoolFactory:"nftLiquidityPoolFactory",agora:"backchat",notary:"decentralizedNotary"}[e]||e}const be=[{name:"Diamond",boostBips:5e3,burnRate:0,keepRate:100,color:"text-cyan-400",emoji:"💎",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeicgip72jcqgsirlrhn3tq5cc226vmko6etnndzl6nlhqrktfikafq",borderColor:"border-cyan-400/50",glowColor:"bg-cyan-500/10",bgGradient:"from-cyan-500/20 to-blue-500/20"},{name:"Gold",boostBips:4e3,burnRate:10,keepRate:90,color:"text-amber-400",emoji:"🥇",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeifponccrbicg2pcjrn2hrfoqgc77xhm2r4ld7hdpw6cxxkbsckf44",borderColor:"border-amber-400/50",glowColor:"bg-amber-500/10",bgGradient:"from-amber-500/20 to-yellow-500/20"},{name:"Silver",boostBips:2500,burnRate:25,keepRate:75,color:"text-gray-300",emoji:"🥈",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeihvi2inujm5zpi7tl667g4srq273536pjkglwyrtbwmgnskmu7jg4",borderColor:"border-gray-400/50",glowColor:"bg-gray-500/10",bgGradient:"from-gray-400/20 to-zinc-500/20"},{name:"Bronze",boostBips:1e3,burnRate:40,keepRate:60,color:"text-yellow-600",emoji:"🥉",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeiclqidb67rt3tchhjpsib62s624li7j2bpxnr6b5w5mfp4tomhu7m",borderColor:"border-yellow-600/50",glowColor:"bg-yellow-600/10",bgGradient:"from-yellow-600/20 to-orange-600/20"}];function Bl(e){const t=[...be].sort((a,n)=>n.boostBips-a.boostBips);for(const a of t)if(e>=a.boostBips)return a;return null}function Nl(e){return e>=5e3?0:e>=4e3?10:e>=2500?25:e>=1e3?40:50}function tt(e){return 100-Nl(e)}const An=["function name() view returns (string)","function symbol() view returns (string)","function decimals() view returns (uint8)","function totalSupply() view returns (uint256)","function balanceOf(address owner) view returns (uint256)","function transfer(address to, uint256 amount) returns (bool)","function approve(address spender, uint256 amount) returns (bool)","function allowance(address owner, address spender) view returns (uint256)","function transferFrom(address from, address to, uint256 amount) returns (bool)","function MAX_SUPPLY() view returns (uint256)","function TGE_SUPPLY() view returns (uint256)","function totalBurned() view returns (uint256)","function mintableRemaining() view returns (uint256)","function totalMinted() view returns (uint256)","event Transfer(address indexed from, address indexed to, uint256 value)","event Approval(address indexed owner, address indexed spender, uint256 value)"],Pn=["function totalPStake() view returns (uint256)","function totalBkcDelegated() view returns (uint256)","function userTotalPStake(address _user) view returns (uint256)","function pendingRewards(address _user) view returns (uint256)","function savedRewards(address _user) view returns (uint256)","function MIN_LOCK_DAYS() view returns (uint256)","function MAX_LOCK_DAYS() view returns (uint256)","function REFERRER_CUT_BPS() view returns (uint256)","function forceUnstakePenaltyBps() view returns (uint256)","function getDelegationsOf(address _user) view returns (tuple(uint128 amount, uint128 pStake, uint64 lockEnd, uint64 lockDays, uint256 rewardDebt)[])","function getDelegation(address _user, uint256 _index) view returns (uint256 amount, uint256 pStake, uint256 lockEnd, uint256 lockDays, uint256 pendingReward)","function delegationCount(address _user) view returns (uint256)","function delegate(uint256 _amount, uint256 _lockDays, address _operator) external payable","function unstake(uint256 _index) external","function forceUnstake(uint256 _index, address _operator) external payable","function claimRewards(address _operator) external payable","function claimRewards() external","function getUserBestBoost(address _user) view returns (uint256)","function getBurnRateForBoost(uint256 _boostBps) pure returns (uint256)","function getTierName(uint256 _boostBps) pure returns (string)","function previewClaim(address _user) view returns (uint256 totalRewards, uint256 burnAmount, uint256 referrerCut, uint256 userReceives, uint256 burnRateBps, uint256 nftBoost)","function getStakingStats() view returns (uint256 totalPStake, uint256 totalBkcDelegated, uint256 totalRewardsDistributed, uint256 totalBurnedOnClaim, uint256 totalForceUnstakePenalties, uint256 totalEthFeesCollected, uint256 accRewardPerShare)","function getUserSummary(address _user) view returns (uint256 userTotalPStake, uint256 delegationCount, uint256 savedRewards, uint256 totalPending, uint256 nftBoost, uint256 burnRateBps)","event Delegated(address indexed user, uint256 indexed delegationIndex, uint256 amount, uint256 pStake, uint256 lockDays, address operator)","event Unstaked(address indexed user, uint256 indexed delegationIndex, uint256 amountReturned)","event ForceUnstaked(address indexed user, uint256 indexed delegationIndex, uint256 amountReturned, uint256 penaltyBurned, address operator)","event RewardsClaimed(address indexed user, uint256 totalRewards, uint256 burnedAmount, uint256 userReceived, uint256 cutAmount, address cutRecipient, uint256 nftBoostUsed, address operator)","event TokensBurnedOnClaim(address indexed user, uint256 burnedAmount, uint256 burnRateBps, uint256 totalBurnedAllTime)"],oa=["function listNFT(uint256 tokenId, uint96 pricePerHour, uint16 minHours, uint16 maxHours) external","function updateListing(uint256 tokenId, uint96 pricePerHour, uint16 minHours, uint16 maxHours) external","function withdrawNFT(uint256 tokenId) external","function rentNFT(uint256 tokenId, uint256 hours_, address operator) external payable","function withdrawEarnings() external","function getListing(uint256 tokenId) view returns (address owner, uint96 pricePerHour, uint16 minHours, uint16 maxHours, uint96 totalEarnings, uint32 rentalCount, bool currentlyRented, uint48 rentalEndTime)","function getRental(uint256 tokenId) view returns (address tenant, uint48 endTime, bool isActive)","function isRented(uint256 tokenId) view returns (bool)","function getRemainingTime(uint256 tokenId) view returns (uint256)","function hasActiveRental(address user) view returns (bool)","function getUserBestBoost(address user) view returns (uint256)","function pendingEarnings(address owner) view returns (uint256)","function userActiveRental(address user) view returns (uint256)","function getAllListedTokenIds() view returns (uint256[])","function getListingCount() view returns (uint256)","function getRentalCost(uint256 tokenId, uint256 hours_) view returns (uint256 rentalCost, uint256 ethFee, uint256 totalCost)","function getStats() view returns (uint256 activeListings, uint256 volume, uint256 rentals, uint256 ethFees, uint256 earningsWithdrawn)","event NFTListed(uint256 indexed tokenId, address indexed owner, uint96 pricePerHour, uint16 minHours, uint16 maxHours)","event ListingUpdated(uint256 indexed tokenId, uint96 pricePerHour, uint16 minHours, uint16 maxHours)","event NFTRented(uint256 indexed tokenId, address indexed tenant, address indexed owner, uint256 hours_, uint256 rentalCost, uint256 ethFee, uint48 endTime, address operator)","event NFTWithdrawn(uint256 indexed tokenId, address indexed owner)","event EarningsWithdrawn(address indexed owner, uint256 amount)"],ri=["function buyNFT(uint256 maxBkcPrice, address operator) external payable returns (uint256 tokenId)","function buySpecificNFT(uint256 tokenId, uint256 maxBkcPrice, address operator) external payable","function sellNFT(uint256 tokenId, uint256 minPayout, address operator) external payable","function getBuyPrice() view returns (uint256)","function getSellPrice() view returns (uint256)","function getTotalBuyCost() view returns (uint256 bkcCost, uint256 ethCost)","function getTotalSellInfo() view returns (uint256 bkcPayout, uint256 ethCost)","function getEthFees() view returns (uint256 buyFee, uint256 sellFee)","function getSpread() view returns (uint256 spread, uint256 spreadBips)","function getPoolInfo() view returns (uint256 bkcBalance, uint256 nftCount, uint256 k, bool initialized, uint8 tier)","function getAvailableNFTs() view returns (uint256[])","function isNFTInPool(uint256 tokenId) view returns (bool)","function bkcBalance() view returns (uint256)","function nftCount() view returns (uint256)","function tier() view returns (uint8)","function initialized() view returns (bool)","function getTierName() view returns (string)","function getStats() view returns (uint256 volume, uint256 buys, uint256 sells, uint256 ethFees)","function totalVolume() view returns (uint256)","function totalBuys() view returns (uint256)","function totalSells() view returns (uint256)","function totalEthFees() view returns (uint256)","event NFTPurchased(address indexed buyer, uint256 indexed tokenId, uint256 price, uint256 ethFee, uint256 newNftCount, address operator)","event NFTSold(address indexed seller, uint256 indexed tokenId, uint256 payout, uint256 ethFee, uint256 newNftCount, address operator)"],zn=["function commitPlay(bytes32 _commitHash, uint256 _wagerAmount, uint8 _tierMask, address _operator) external payable returns (uint256 gameId)","function revealPlay(uint256 _gameId, uint256[] calldata _guesses, bytes32 _userSecret) external returns (uint256 prizeWon)","function claimExpired(uint256 _gameId) external","function fundPrizePool(uint256 _amount) external","function generateCommitHash(uint256[] calldata _guesses, bytes32 _userSecret) pure returns (bytes32)","function TIER_COUNT() view returns (uint8)","function BKC_FEE_BPS() view returns (uint256)","function MAX_PAYOUT_BPS() view returns (uint256)","function REVEAL_DELAY() view returns (uint256)","function REVEAL_WINDOW() view returns (uint256)","function POOL_CAP() view returns (uint256)","function getTierInfo(uint8 _tier) pure returns (uint256 range, uint256 multiplier, uint256 winChanceBps)","function getAllTiers() pure returns (uint256[3] ranges, uint256[3] multipliers, uint256[3] winChances)","function getGame(uint256 _gameId) view returns (address player, uint48 commitBlock, uint8 tierMask, uint8 status, address operator, uint96 wagerAmount)","function getGameResult(uint256 _gameId) view returns (address player, uint128 grossWager, uint128 prizeWon, uint8 tierMask, uint8 matchCount, uint48 revealBlock)","function getGameStatus(uint256 _gameId) view returns (uint8 status, bool canReveal, uint256 blocksUntilReveal, uint256 blocksUntilExpiry)","function activeGame(address _player) view returns (uint256)","function getRequiredFee(uint8 _tierMask) view returns (uint256 fee)","function calculatePotentialWinnings(uint256 _wagerAmount, uint8 _tierMask) view returns (uint256 netToPool, uint256 bkcFee, uint256 maxPrize, uint256 maxPrizeAfterCap)","function gameCounter() view returns (uint256)","function prizePool() view returns (uint256)","function getPoolStats() view returns (uint256 prizePool, uint256 totalGamesPlayed, uint256 totalBkcWagered, uint256 totalBkcWon, uint256 totalBkcForfeited, uint256 totalBkcBurned, uint256 maxPayoutNow)","event GameCommitted(uint256 indexed gameId, address indexed player, uint256 wagerAmount, uint8 tierMask, address operator)","event GameRevealed(uint256 indexed gameId, address indexed player, uint256 grossWager, uint256 prizeWon, uint8 tierMask, uint8 matchCount, address operator)","event GameDetails(uint256 indexed gameId, uint8 tierMask, uint256[] guesses, uint256[] rolls, bool[] matches)","event GameExpired(uint256 indexed gameId, address indexed player, uint256 forfeitedAmount)","event PrizePoolFunded(address indexed funder, uint256 amount)","event PoolExcessBurned(uint256 amount, uint256 newTotalBurned)"],Sl=["function balanceOf(address _owner) view returns (uint256)","function ownerOf(uint256 _tokenId) view returns (address)","function approve(address _to, uint256 _tokenId) external","function setApprovalForAll(address _operator, bool _approved) external","function transferFrom(address _from, address _to, uint256 _tokenId) external","function safeTransferFrom(address _from, address _to, uint256 _tokenId) external","function totalSupply() view returns (uint256)","function getUserBestBoost(address _user) view returns (uint256)","function getTokenInfo(uint256 _tokenId) view returns (address owner, uint8 tier, uint256 boostBips)","function getUserTokens(address _user) view returns (uint256[] tokenIds, uint8[] tiers)","function getTierBoost(uint8 _tier) pure returns (uint256)","function getTierName(uint8 _tier) pure returns (string)","event Transfer(address indexed from, address indexed to, uint256 indexed tokenId)","event Approval(address indexed owner, address indexed approved, uint256 indexed tokenId)"],Bn=["function certify(bytes32 _documentHash, string _meta, uint8 _docType, address _operator) external payable returns (uint256 certId)","function batchCertify(bytes32[] _documentHashes, string[] _metas, uint8[] _docTypes, address _operator) external payable returns (uint256 startId)","function transferCertificate(bytes32 _documentHash, address _newOwner) external","function verify(bytes32 _documentHash) view returns (bool exists, address owner, uint48 timestamp, uint8 docType, string meta)","function getCertificate(uint256 _certId) view returns (bytes32 documentHash, address owner, uint48 timestamp, uint8 docType, string meta)","function getFee() view returns (uint256)","function getStats() view returns (uint256 certCount, uint256 totalEthCollected)","function certCount() view returns (uint256)","function totalEthCollected() view returns (uint256)","function MAX_BATCH_SIZE() view returns (uint8)","event Certified(uint256 indexed certId, address indexed owner, bytes32 indexed documentHash, uint8 docType, address operator)","event BatchCertified(address indexed owner, uint256 startId, uint256 count, address operator)","event CertificateTransferred(bytes32 indexed documentHash, address indexed from, address indexed to)"],Nn=["function claim() external","function canClaim(address user) view returns (bool)","function getCooldownRemaining(address user) view returns (uint256)","function getUserInfo(address user) view returns (uint256 lastClaim, uint256 claims, bool eligible, uint256 cooldownLeft)","function getFaucetStatus() view returns (uint256 ethBalance, uint256 tokenBalance, uint256 ethPerDrip, uint256 tokensPerDrip, uint256 estimatedEthClaims, uint256 estimatedTokenClaims)","function getStats() view returns (uint256 tokens, uint256 eth, uint256 claims, uint256 users)","function cooldown() view returns (uint256)","function tokensPerClaim() view returns (uint256)","function ethPerClaim() view returns (uint256)","function paused() view returns (bool)","event Claimed(address indexed recipient, uint256 tokens, uint256 eth, address indexed via)"],Sn=["function calculateFee(bytes32 _actionId, uint256 _txValue) view returns (uint256)","function bkcToken() view returns (address)","function treasury() view returns (address)","function buybackAccumulated() view returns (uint256)","function referredBy(address _user) view returns (address)","function referralCount(address _referrer) view returns (uint256)","function setReferrer(address _referrer) external","event ReferrerSet(address indexed user, address indexed referrer)","function totalEthCollected() view returns (uint256)","function totalBkcCollected() view returns (uint256)","function totalFeeEvents() view returns (uint256)","function getStats() view returns (uint256 ethCollected, uint256 bkcCollected, uint256 feeEvents, uint256 buybackEth, uint256 moduleCount)","function isAuthorized(address _contract) view returns (bool)","function moduleCount() view returns (uint256)","event FeeCollected(bytes32 indexed moduleId, address indexed user, address operator, address customRecipient, uint256 ethAmount, uint256 bkcAmount)"],$n=["function executeBuyback() external","function executeBuybackWithSlippage(uint256 _minTotalBkcOut) external","function MAX_SUPPLY() view returns (uint256)","function MAX_MINTABLE() view returns (uint256)","function MIN_BUYBACK() view returns (uint256)","function CALLER_BPS() view returns (uint256)","function BURN_BPS() view returns (uint256)","function currentMiningRate() view returns (uint256 rateBps)","function pendingBuybackETH() view returns (uint256)","function getSupplyInfo() view returns (uint256 currentSupply, uint256 maxSupply, uint256 totalMintedViaMining, uint256 remainingMintable, uint256 miningRateBps, uint256 totalBurnedLifetime)","function previewBuyback() view returns (uint256 ethAvailable, uint256 estimatedBkcPurchased, uint256 estimatedBkcMined, uint256 estimatedBurn, uint256 estimatedToStakers, uint256 estimatedCallerReward, uint256 currentMiningRateBps, bool isReady)","function previewMiningAtSupply(uint256 _supplyLevel, uint256 _purchaseAmount) pure returns (uint256 miningAmount, uint256 rateBps)","function getBuybackStats() view returns (uint256 totalBuybacks, uint256 totalEthSpent, uint256 totalBkcPurchased, uint256 totalBkcMined, uint256 totalBkcBurned, uint256 totalBkcToStakers, uint256 totalCallerRewards, uint256 avgEthPerBuyback, uint256 avgBkcPerBuyback)","function getLastBuyback() view returns (uint256 timestamp, uint256 blockNumber, address caller, uint256 ethSpent, uint256 bkcTotal, uint256 timeSinceLast)","function totalBuybacks() view returns (uint256)","function totalEthSpent() view returns (uint256)","function totalBkcPurchased() view returns (uint256)","function totalBkcMined() view returns (uint256)","function totalBkcBurned() view returns (uint256)","function totalBkcToStakers() view returns (uint256)","function totalCallerRewards() view returns (uint256)","event BuybackExecuted(address indexed caller, uint256 indexed buybackNumber, uint256 callerReward, uint256 ethSpent, uint256 bkcPurchased, uint256 bkcMined, uint256 bkcBurned, uint256 bkcToStakers, uint256 miningRateBps)"],Ln=["function createCampaign(string title, string metadataUri, uint96 goal, uint256 durationDays, address operator) external payable returns (uint256)","function donate(uint256 campaignId, address operator) external payable","function boostCampaign(uint256 campaignId, address operator) external payable","function closeCampaign(uint256 campaignId) external","function withdraw(uint256 campaignId) external","function getCampaign(uint256 campaignId) view returns (address owner, uint48 deadline, uint8 status, uint96 raised, uint96 goal, uint32 donorCount, bool isBoosted, string title, string metadataUri)","function canWithdraw(uint256 campaignId) view returns (bool)","function titles(uint256 campaignId) view returns (string)","function metadataUris(uint256 campaignId) view returns (string)","function campaignCount() view returns (uint256)","function previewDonation(uint256 amount) view returns (uint256 fee, uint256 netToCampaign)","function getStats() view returns (uint256 campaignCount, uint256 totalDonated, uint256 totalWithdrawn, uint256 totalEthFees)","event CampaignCreated(uint256 indexed campaignId, address indexed owner, uint96 goal, uint48 deadline, address operator)","event DonationMade(uint256 indexed campaignId, address indexed donor, uint256 grossAmount, uint256 netAmount, address operator)","event CampaignBoosted(uint256 indexed campaignId, address indexed booster, uint48 boostExpiry, address operator)","event CampaignClosed(uint256 indexed campaignId, address indexed owner, uint96 raised)","event FundsWithdrawn(uint256 indexed campaignId, address indexed owner, uint96 amount)"],la=["function createPost(string contentHash, uint8 tag, uint8 contentType, address operator) external payable","function createReply(uint256 parentId, string contentHash, uint8 contentType, address operator) external payable","function createRepost(uint256 originalId, string contentHash, address operator) external payable","function deletePost(uint256 postId) external","function changeTag(uint256 postId, uint8 newTag) external","function like(uint256 postId, address operator) external payable","function superLike(uint256 postId, address operator) external payable","function downvote(uint256 postId, address operator) external payable","function follow(address user, address operator) external payable","function unfollow(address user) external","function createProfile(string username, string metadataURI, address operator) external payable","function updateProfile(string metadataURI) external","function pinPost(uint256 postId) external","function boostProfile(address operator) external payable","function obtainBadge(address operator) external payable","function VOTE_PRICE() view returns (uint256)","function TAG_COUNT() view returns (uint8)","function postCounter() view returns (uint256)","function totalProfiles() view returns (uint256)","function getPost(uint256 postId) view returns (address author, uint8 tag, uint8 contentType, bool deleted, uint32 createdAt, uint256 replyTo, uint256 repostOf, uint256 likes, uint256 superLikes, uint256 downvotes, uint256 replies, uint256 reposts)","function getUserProfile(address user) view returns (bytes32 usernameHash, string metadataURI, uint256 pinned, bool boosted, bool hasBadge, uint64 boostExp, uint64 badgeExp)","function isProfileBoosted(address user) view returns (bool)","function hasTrustBadge(address user) view returns (bool)","function isUsernameAvailable(string username) view returns (bool)","function getUsernamePrice(uint256 length) pure returns (uint256)","function hasLiked(uint256 postId, address user) view returns (bool)","function getOperatorStats(address operator) view returns (uint256 posts_, uint256 engagement)","function getGlobalStats() view returns (uint256 totalPosts, uint256 totalProfiles, uint256[15] tagCounts)","function version() pure returns (string)","event PostCreated(uint256 indexed postId, address indexed author, uint8 tag, uint8 contentType, string contentHash, address operator)","event ReplyCreated(uint256 indexed postId, uint256 indexed parentId, address indexed author, uint8 tag, uint8 contentType, string contentHash, address operator)","event RepostCreated(uint256 indexed postId, uint256 indexed originalId, address indexed author, uint8 tag, string contentHash, address operator)","event PostDeleted(uint256 indexed postId, address indexed author)","event Liked(uint256 indexed postId, address indexed liker, address indexed author, address operator)","event SuperLiked(uint256 indexed postId, address indexed voter, address indexed author, uint256 count, address operator)","event Downvoted(uint256 indexed postId, address indexed voter, address indexed author, uint256 count, address operator)","event Followed(address indexed follower, address indexed followed, address operator)","event Unfollowed(address indexed follower, address indexed followed)","event ProfileCreated(address indexed user, string username, string metadataURI, address operator)","event ProfileUpdated(address indexed user, string metadataURI)","event ProfileBoosted(address indexed user, uint256 daysAdded, uint64 expiresAt, address operator)","event BadgeObtained(address indexed user, uint64 expiresAt, address operator)"];let To=0;const du=5e3;async function $l(){try{return window.ethereum?await window.ethereum.request({method:"eth_chainId"})===we.chainId:!1}catch(e){return console.warn("Network check failed:",e.message),!1}}async function ta(){if(!window.ethereum)return console.warn("MetaMask not detected"),!1;try{return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:we.chainId,chainName:we.chainName,nativeCurrency:we.nativeCurrency,rpcUrls:we.rpcUrls,blockExplorerUrls:we.blockExplorerUrls}]}),console.log("✅ MetaMask network config updated"),!0}catch(e){return e.code===4001?(console.log("User rejected network update"),!1):(console.warn("Could not update MetaMask network:",e.message),!1)}}async function Ll(){if(!window.ethereum)return console.warn("MetaMask not detected"),!1;try{return await window.ethereum.request({method:"wallet_switchEthereumChain",params:[{chainId:we.chainId}]}),console.log("✅ Switched to Arbitrum Sepolia"),!0}catch(e){return e.code===4902?(console.log("🔄 Network not found, adding..."),await ta()):e.code===4001?(console.log("User rejected network switch"),!1):(console.error("Network switch error:",e),!1)}}async function za(){var e;if(!window.ethereum)return{healthy:!1,reason:"no_provider"};try{const t=new window.ethers.BrowserProvider(window.ethereum),a=new Promise((r,i)=>setTimeout(()=>i(new Error("timeout")),5e3)),n=t.getBlockNumber();return await Promise.race([n,a]),{healthy:!0}}catch(t){const a=((e=t==null?void 0:t.message)==null?void 0:e.toLowerCase())||"";return a.includes("timeout")?{healthy:!1,reason:"timeout"}:a.includes("too many")||a.includes("rate limit")||a.includes("-32002")?{healthy:!1,reason:"rate_limited"}:a.includes("failed to fetch")||a.includes("network")?{healthy:!1,reason:"network_error"}:{healthy:!1,reason:"unknown",error:a}}}async function Rl(){const e=Date.now();if(e-To<du)return{success:!0,skipped:!0};if(To=e,!window.ethereum)return{success:!1,error:"MetaMask not detected"};try{if(!await $l()&&(console.log("🔄 Wrong network detected, switching..."),!await Ll()))return{success:!1,error:"Please switch to Arbitrum Sepolia network"};const a=await za();if(!a.healthy&&(console.log(`⚠️ RPC unhealthy (${a.reason}), updating MetaMask config...`),await ta())){await new Promise(i=>setTimeout(i,1e3));const r=await za();return r.healthy?{success:!0,fixed:!0}:{success:!1,error:"Network is congested. Please try again in a moment.",rpcReason:r.reason}}return{success:!0}}catch(t){return console.error("Network config error:",t),{success:!1,error:t.message}}}function _l(e){window.ethereum&&window.ethereum.on("chainChanged",async t=>{console.log("🔄 Network changed to:",t);const a=t===we.chainId;e&&e({chainId:t,isCorrectNetwork:a,needsSwitch:!a})})}const Fl=Object.freeze(Object.defineProperty({__proto__:null,IPFS_GATEWAYS:un,METAMASK_NETWORK_CONFIG:we,RPC_ENDPOINTS:ut,addresses:v,agoraABI:la,bkcTokenABI:An,boosterTiers:be,buybackMinerABI:$n,charityPoolABI:Ln,checkRpcHealth:za,contractAddresses:M,ecosystemManagerABI:Sn,ensureCorrectNetworkConfig:Rl,faucetABI:Nn,fortunePoolABI:zn,getBurnRateFromBoost:Nl,getCurrentRpcUrl:ea,getKeepRateFromBoost:tt,getTierByBoost:Bl,ipfsGateway:Pl,isCorrectNetwork:$l,loadAddresses:zl,markRpcHealthy:Il,markRpcUnhealthy:Cl,nftPoolABI:ri,notaryABI:Bn,rentalManagerABI:oa,resetToPrimaryRpc:Al,rewardBoosterABI:Sl,sepoliaRpcUrl:ai,setupNetworkChangeListener:_l,stakingPoolABI:Pn,switchToCorrectNetwork:Ll,switchToNextRpc:ni,updateMetaMaskNetwork:ta},Symbol.toStringTag,{value:"Module"})),Ml=window.ethers,uu=5e3,pu=6e4,mu=3e4,fu=3e4,bu=6e4;let xr=null,Co=0;const Io=new Map,hr=new Map,Ao=new Map,Po=e=>new Promise(t=>setTimeout(t,e));async function Rn(e,t){const a=new AbortController,n=setTimeout(()=>a.abort(),t);try{const r=await fetch(e,{signal:a.signal});return clearTimeout(n),r}catch(r){throw clearTimeout(n),r.name==="AbortError"?new Error("API request timed out."):r}}const Ye={getHistory:"https://gethistory-4wvdcuoouq-uc.a.run.app",getBoosters:"https://getboosters-4wvdcuoouq-uc.a.run.app",getSystemData:"https://getsystemdata-4wvdcuoouq-uc.a.run.app",getNotaryHistory:"https://getnotaryhistory-4wvdcuoouq-uc.a.run.app",getRentalListings:"https://getrentallistings-4wvdcuoouq-uc.a.run.app",getUserRentals:"https://getuserrentals-4wvdcuoouq-uc.a.run.app",fortuneGames:"https://getfortunegames-4wvdcuoouq-uc.a.run.app",uploadFileToIPFS:"/api/upload",claimAirdrop:"https://us-central1-airdropbackchainnew.cloudfunctions.net/claimAirdrop"};function Dl(e){var t;return((t=e==null?void 0:e.error)==null?void 0:t.code)===429||(e==null?void 0:e.code)===429||e.message&&(e.message.includes("429")||e.message.includes("Too Many Requests")||e.message.includes("rate limit"))}function Ol(e){var a,n;const t=((a=e==null?void 0:e.error)==null?void 0:a.code)||(e==null?void 0:e.code);return t===-32603||t===-32e3||((n=e.message)==null?void 0:n.includes("Internal JSON-RPC"))}function _n(e,t,a){if(a)return a;if(!e||!c.publicProvider)return null;try{return new Ml.Contract(e,t,c.publicProvider)}catch{return null}}const ae=async(e,t,a=[],n=0n,r=2,i=!1)=>{if(!e)return n;const s=e.target||e.address,o=JSON.stringify(a,(m,p)=>typeof p=="bigint"?p.toString():p),l=`${s}-${t}-${o}`,d=Date.now(),u=["getPoolInfo","getBuyPrice","getSellPrice","getAvailableTokenIds","getAllListedTokenIds","tokenURI","tokenTier","getTokenInfo","getListing","balanceOf","totalSupply","totalPStake","MAX_SUPPLY","TGE_SUPPLY","userTotalPStake","pendingRewards","isRented","getRental","ownerOf","getDelegationsOf","allowance","getPoolStats","getAllTiers","getUserSummary","getUserBestBoost"];if(!i&&u.includes(t)){const m=Io.get(l);if(m&&d-m.timestamp<mu)return m.value}for(let m=0;m<=r;m++)try{const p=await e[t](...a);return u.includes(t)&&Io.set(l,{value:p,timestamp:d}),p}catch(p){if(Dl(p)&&m<r){const b=Math.floor(Math.random()*1e3),f=1e3*Math.pow(2,m)+b;await Po(f);continue}if(Ol(p)&&m<r){await Po(500);continue}break}return n},gu=async(e,t,a=!1)=>{const n=`balance-${(e==null?void 0:e.target)||(e==null?void 0:e.address)}-${t}`,r=Date.now();if(!a){const s=Ao.get(n);if(s&&r-s.timestamp<bu)return s.value}const i=await ae(e,"balanceOf",[t],0n,2,a);return Ao.set(n,{value:i,timestamp:r}),i};async function Hl(){c.systemFees||(c.systemFees={}),c.systemPStakes||(c.systemPStakes={}),c.boosterDiscounts||(c.boosterDiscounts={});const e=Date.now();if(xr&&e-Co<pu)return zo(xr),!0;try{const t=await Rn(Ye.getSystemData,uu);if(!t.ok)throw new Error(`API Status: ${t.status}`);const a=await t.json();return zo(a),xr=a,Co=e,!0}catch{return c.systemFees.NOTARY_SERVICE||(c.systemFees.NOTARY_SERVICE=100n),c.systemFees.CLAIM_REWARD_FEE_BIPS||(c.systemFees.CLAIM_REWARD_FEE_BIPS=500n),!1}}function zo(e){if(e.fees)for(const t in e.fees)try{c.systemFees[t]=BigInt(e.fees[t])}catch{c.systemFees[t]=0n}if(e.pStakeRequirements)for(const t in e.pStakeRequirements)try{c.systemPStakes[t]=BigInt(e.pStakeRequirements[t])}catch{c.systemPStakes[t]=0n}if(e.discounts)for(const t in e.discounts)try{c.boosterDiscounts[t]=BigInt(e.discounts[t])}catch{c.boosterDiscounts[t]=0n}if(e.oracleFeeInWei){c.systemData=c.systemData||{};try{c.systemData.oracleFeeInWei=BigInt(e.oracleFeeInWei)}catch{c.systemData.oracleFeeInWei=0n}}}async function Ul(){!c.publicProvider||!c.bkcTokenContractPublic||await Promise.allSettled([ae(c.bkcTokenContractPublic,"totalSupply",[],0n),Hl()])}async function Fn(e=!1){var t,a,n;if(!(!c.isConnected||!c.userAddress))try{const r=(a=(t=c.bkcTokenContractPublic)==null?void 0:t.runner)==null?void 0:a.provider,[i,s]=await Promise.allSettled([gu(c.bkcTokenContractPublic||c.bkcTokenContract,c.userAddress,e),(n=r||c.provider)==null?void 0:n.getBalance(c.userAddress)]);i.status==="fulfilled"&&(c.currentUserBalance=i.value),s.status==="fulfilled"&&(c.currentUserNativeBalance=s.value),await St(e);const o=c.stakingPoolContractPublic||c.stakingPoolContract;if(o){const l=await ae(o,"userTotalPStake",[c.userAddress],0n,2,e);c.userTotalPStake=l}}catch(r){console.error("Error loading user data:",r)}}async function xu(e=!1){const t=c.stakingPoolContractPublic||c.stakingPoolContract;if(!c.isConnected||!t)return[];try{const a=await ae(t,"getDelegationsOf",[c.userAddress],[],2,e);return c.userDelegations=a.map((n,r)=>({amount:n.amount||n[0]||0n,pStake:n.pStake||n[1]||0n,lockEnd:Number(n.lockEnd||n[2]||0),lockDays:Number(n.lockDays||n[3]||0),rewardDebt:n.rewardDebt||n[4]||0n,unlockTime:BigInt(n.lockEnd||n[2]||0),lockDuration:BigInt(n.lockDays||n[3]||0)*86400n,index:r})),c.userDelegations}catch(a){return console.error("Error loading delegations:",a),[]}}async function jl(e=!1){let t=[];try{const n=await Rn(Ye.getRentalListings,4e3);n.ok&&(t=await n.json())}catch{}if(t&&t.length>0){const n=t.map(r=>{var s,o,l,d,u;const i=be.find(m=>m.boostBips===Number(r.boostBips||0));return{...r,tokenId:((s=r.tokenId)==null?void 0:s.toString())||((o=r.id)==null?void 0:o.toString()),pricePerHour:((l=r.pricePerHour)==null?void 0:l.toString())||((d=r.price)==null?void 0:d.toString())||"0",totalEarnings:((u=r.totalEarnings)==null?void 0:u.toString())||"0",rentalCount:Number(r.rentalCount||0),img:(i==null?void 0:i.img)||"./assets/nft.png",name:(i==null?void 0:i.name)||"Booster NFT"}});return c.rentalListings=n,n}const a=_n(v.rentalManager,oa,c.rentalManagerContractPublic);if(!a)return c.rentalListings=[],[];try{const n=await ae(a,"getAllListedTokenIds",[],[],2,!0);if(!n||n.length===0)return c.rentalListings=[],[];const i=n.slice(0,30).map(async l=>{var d,u,m,p,b,f;try{const w=await ae(a,"getListing",[l],null,1,!0);if(w&&w.owner!==Ml.ZeroAddress){const k=await ae(a,"getRental",[l],null,1,!0),C=await Gl(l),P=Math.floor(Date.now()/1e3),S=k&&BigInt(k.endTime||0)>BigInt(P);return{tokenId:l.toString(),owner:w.owner,pricePerHour:((d=w.pricePerHour)==null?void 0:d.toString())||((u=w.price)==null?void 0:u.toString())||"0",minHours:((m=w.minHours)==null?void 0:m.toString())||"1",maxHours:((p=w.maxHours)==null?void 0:p.toString())||"1",totalEarnings:((b=w.totalEarnings)==null?void 0:b.toString())||"0",rentalCount:Number(w.rentalCount||0),boostBips:C.boostBips,img:C.img||"./assets/nft.png",name:C.name,isRented:S,currentTenant:S?k.tenant:null,rentalEndTime:S?(f=k.endTime)==null?void 0:f.toString():null}}}catch{}return null}),o=(await Promise.all(i)).filter(l=>l!==null);return c.rentalListings=o,o}catch{return c.rentalListings=[],[]}}async function hu(e=!1){var a,n;if(!c.userAddress)return c.myRentals=[],[];try{const r=await Rn(`${Ye.getUserRentals}/${c.userAddress}`,4e3);if(r.ok){const s=(await r.json()).map(o=>{const l=be.find(d=>d.boostBips===Number(o.boostBips||0));return{...o,img:(l==null?void 0:l.img)||"./assets/nft.png",name:(l==null?void 0:l.name)||"Booster NFT"}});return c.myRentals=s,s}}catch{}const t=_n(v.rentalManager,oa,c.rentalManagerContractPublic);if(!t)return c.myRentals=[],[];try{const r=await ae(t,"getAllListedTokenIds",[],[],2,e),i=[],s=Math.floor(Date.now()/1e3);for(const o of r.slice(0,30))try{const l=await ae(t,"getRental",[o],null,1,e);if(l&&((a=l.tenant)==null?void 0:a.toLowerCase())===c.userAddress.toLowerCase()&&(l.isActive||BigInt(l.endTime||0)>BigInt(s))){const d=await Gl(o);i.push({tokenId:o.toString(),tenant:l.tenant,endTime:((n=l.endTime)==null?void 0:n.toString())||"0",isActive:l.isActive,boostBips:d.boostBips,img:d.img,name:d.name})}}catch{}return c.myRentals=i,i}catch{return c.myRentals=[],[]}}let Ya=null,Bo=0;const vu=3e4;async function Wl(e=!1){const t=Date.now();if(!e&&Ya&&t-Bo<vu)return Ya;await St(e);let a=0,n=null,r="none";if(c.myBoosters&&c.myBoosters.length>0){const l=c.myBoosters.reduce((d,u)=>u.boostBips>d.boostBips?u:d,c.myBoosters[0]);l.boostBips>a&&(a=l.boostBips,n=l.tokenId,r="owned")}if(c.myRentals&&c.myRentals.length>0){const l=c.myRentals.reduce((d,u)=>u.boostBips>d.boostBips?u:d,c.myRentals[0]);l.boostBips>a&&(a=l.boostBips,n=l.tokenId,r="rented")}const i=be.find(l=>l.boostBips===a),s=(i==null?void 0:i.image)||(i==null?void 0:i.realImg)||(i==null?void 0:i.img)||"assets/bkc_logo_3d.png",o=i!=null&&i.name?`${i.name} Booster`:r!=="none"?"Booster NFT":"None";return Ya={highestBoost:a,boostName:o,imageUrl:s,tokenId:n?n.toString():null,source:r},Bo=Date.now(),Ya}async function Gl(e){const t=["function getTokenInfo(uint256) view returns (address owner, uint8 tier, uint256 boostBips)","function tokenTier(uint256) view returns (uint8)"],a=_n(v.rewardBooster,t,c.rewardBoosterContractPublic);if(!a)return{boostBips:0,img:"assets/bkc_logo_3d.png",name:"Unknown"};try{const n=await ae(a,"getTokenInfo",[e],null);if(n){const r=Number(n.boostBips||n[2]||0),i=be.find(s=>s.boostBips===r);return{boostBips:r,img:(i==null?void 0:i.image)||(i==null?void 0:i.img)||"./assets/nft.png",name:(i==null?void 0:i.name)||`Booster #${e}`}}return{boostBips:0,img:"assets/bkc_logo_3d.png",name:"Unknown"}}catch{return{boostBips:0,img:"assets/bkc_logo_3d.png",name:"Unknown"}}}async function ii(){const e=c.stakingPoolContractPublic||c.stakingPoolContract;if(!c.isConnected||!e)return{stakingRewards:0n,minerRewards:0n,totalRewards:0n};try{const t=await ae(e,"pendingRewards",[c.userAddress],0n);return{stakingRewards:t,minerRewards:0n,totalRewards:t}}catch{return{stakingRewards:0n,minerRewards:0n,totalRewards:0n}}}async function wu(){const e=c.stakingPoolContractPublic||c.stakingPoolContract;if(!e||!c.userAddress)return{netClaimAmount:0n,feeAmount:0n,discountPercent:0,totalRewards:0n,burnRateBps:0,nftBoost:0};const{totalRewards:t}=await ii();if(t===0n)return{netClaimAmount:0n,feeAmount:0n,discountPercent:0,totalRewards:0n,burnRateBps:0,nftBoost:0};try{const a=await ae(e,"previewClaim",[c.userAddress],null);if(a){const n=a.totalRewards||a[0]||0n,r=a.burnAmount||a[1]||0n,i=a.referrerCut||a[2]||0n,s=a.userReceives||a[3]||0n,o=Number(a.burnRateBps||a[4]||0),l=Number(a.nftBoost||a[5]||0),d=r+i;return console.log("[Data] V9 Claim preview:",{totalRewards:Number(n)/1e18,burnAmount:Number(r)/1e18,referrerCut:Number(i)/1e18,userReceives:Number(s)/1e18,burnRateBps:o,nftBoost:l}),{netClaimAmount:s,feeAmount:d,burnAmount:r,referrerCut:i,discountPercent:l/100,totalRewards:n,burnRateBps:o,nftBoost:l,baseFeeBips:5e3,finalFeeBips:o}}}catch(a){console.error("[Data] previewClaim error:",a)}return{netClaimAmount:t,feeAmount:0n,discountPercent:0,totalRewards:t,burnRateBps:0,nftBoost:0}}let vr=!1,wr=0,Va=0;const yu=3e4,ku=3,Eu=12e4;async function St(e=!1){if(!c.userAddress)return[];const t=Date.now();if(vr)return c.myBoosters||[];if(!e&&t-wr<yu)return c.myBoosters||[];if(Va>=ku){if(t-wr<Eu)return c.myBoosters||[];Va=0}vr=!0,wr=t;try{const a=await Rn(`${Ye.getBoosters}/${c.userAddress}`,5e3);if(!a.ok)throw new Error(`API Error: ${a.status}`);let n=await a.json();const r=["function ownerOf(uint256) view returns (address)","function getTokenInfo(uint256) view returns (address owner, uint8 tier, uint256 boostBips)"],i=_n(v.rewardBooster,r,c.rewardBoosterContractPublic);if(i&&n.length>0){const s=await Promise.all(n.slice(0,50).map(async o=>{const l=BigInt(o.tokenId),d=`ownerOf-${l}`,u=Date.now();let m=Number(o.boostBips||o.boost||0);if(m===0)try{const p=await i.getTokenInfo(l);m=Number(p.boostBips||p[2]||0)}catch{}if(!e&&hr.has(d)){const p=hr.get(d);if(u-p.timestamp<fu)return p.owner.toLowerCase()===c.userAddress.toLowerCase()?{tokenId:l,boostBips:m,imageUrl:o.imageUrl||o.image||null}:null}try{const p=await i.ownerOf(l);return hr.set(d,{owner:p,timestamp:u}),p.toLowerCase()===c.userAddress.toLowerCase()?{tokenId:l,boostBips:m,imageUrl:o.imageUrl||o.image||null}:null}catch(p){return Dl(p)||Ol(p)?{tokenId:l,boostBips:m,imageUrl:o.imageUrl||o.image||null}:null}}));c.myBoosters=s.filter(o=>o!==null)}else c.myBoosters=n.map(s=>({tokenId:BigInt(s.tokenId),boostBips:Number(s.boostBips||s.boost||0),imageUrl:s.imageUrl||s.image||null}));return Va=0,c.myBoosters}catch{return Va++,c.myBoosters||(c.myBoosters=[]),c.myBoosters}finally{vr=!1}}const Tu={apiKey:"AIzaSyDKhF2_--fKtot96YPS8twuD0UoCpS-3T4",authDomain:"airdropbackchainnew.firebaseapp.com",projectId:"airdropbackchainnew",storageBucket:"airdropbackchainnew.appspot.com",messagingSenderId:"108371799661",appId:"1:108371799661:web:d126fcbd0ba56263561964",measurementId:"G-QD9EBZ0Y09"},Kl=Xd(Tu),qa=Jd(Kl),G=eu(Kl);let lt=null,Pe=null,Xa=null;async function Yl(e){if(!e)throw new Error("Wallet address is required for Firebase sign-in.");const t=e.toLowerCase();return Pe=t,lt?(Xa=await ha(t),lt):qa.currentUser?(lt=qa.currentUser,Xa=await ha(t),lt):new Promise((a,n)=>{const r=Zd(qa,async i=>{if(r(),i){lt=i;try{Xa=await ha(t),a(i)}catch(s){console.error("Error linking airdrop user profile:",s),n(s)}}else Qd(qa).then(async s=>{lt=s.user,Xa=await ha(t),a(lt)}).catch(s=>{console.error("Firebase Anonymous sign-in failed:",s),n(s)})},i=>{console.error("Firebase Auth state change error:",i),r(),n(i)})})}function nt(){if(!lt)throw new Error("User not authenticated with Firebase. Please sign-in first.");if(!Pe)throw new Error("Wallet address not set. Please connect wallet first.")}async function si(){const e=le(G,"airdrop_public_data","data_v1"),t=await Ne(e);if(t.exists()){const a=t.data(),n=(a.dailyTasks||[]).map(s=>{var d,u;const o=(d=s.startDate)!=null&&d.toDate?s.startDate.toDate():s.startDate?new Date(s.startDate):null,l=(u=s.endDate)!=null&&u.toDate?s.endDate.toDate():s.endDate?new Date(s.endDate):null;return{...s,id:s.id||null,startDate:o instanceof Date&&!isNaN(o)?o:null,endDate:l instanceof Date&&!isNaN(l)?l:null}}).filter(s=>s.id),r=Date.now(),i=n.filter(s=>{const o=s.startDate?s.startDate.getTime():0,l=s.endDate?s.endDate.getTime():1/0;return o<=r&&r<l});return{config:a.config||{ugcBasePoints:{}},leaderboards:a.leaderboards||{top100ByPoints:[],top100ByPosts:[],lastUpdated:null},dailyTasks:i,platformUsageConfig:a.platformUsageConfig||null}}else return console.warn("Public airdrop data document 'airdrop_public_data/data_v1' not found. Returning defaults."),{config:{isActive:!1,roundName:"Loading...",ugcBasePoints:{}},leaderboards:{top100ByPoints:[],top100ByPosts:[],lastUpdated:null},dailyTasks:[],platformUsageConfig:null}}function No(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";let t="";for(let a=0;a<6;a++)t+=e.charAt(Math.floor(Math.random()*e.length));return t}function pn(e){return e>=100?10:e>=90?9:e>=80?8:e>=70?7:e>=60?6:e>=50?5:e>=40?4:e>=30?3:e>=20?2:1}async function ha(e){nt(),e||(e=Pe);const t=e.toLowerCase(),a=le(G,"airdrop_users",t),n=await Ne(a);if(n.exists()){const r=n.data(),i={};if(r.referralCode||(i.referralCode=No()),typeof r.approvedSubmissionsCount!="number"&&(i.approvedSubmissionsCount=0),typeof r.rejectedCount!="number"&&(i.rejectedCount=0),typeof r.isBanned!="boolean"&&(i.isBanned=!1),typeof r.totalPoints!="number"&&(i.totalPoints=0),typeof r.pointsMultiplier!="number"&&(i.pointsMultiplier=1),r.walletAddress!==t&&(i.walletAddress=t),Object.keys(i).length>0)try{return await Cn(a,i),{id:n.id,...r,...i}}catch(s){return console.error("Error updating user default fields:",s),{id:n.id,...r}}return{id:n.id,...r}}else{const r=No(),i={walletAddress:t,referralCode:r,totalPoints:0,pointsMultiplier:1,approvedSubmissionsCount:0,rejectedCount:0,isBanned:!1,createdAt:vt()};return await In(a,i),{id:a.id,...i,createdAt:new Date}}}async function Vl(e,t){if(nt(),!e||typeof e!="string"||e.trim()==="")return console.warn(`isTaskEligible called with invalid taskId: ${e}`),{eligible:!1,timeLeft:0};const a=le(G,"airdrop_users",Pe,"task_claims",e),n=await Ne(a),r=t*60*60*1e3;if(!n.exists())return{eligible:!0,timeLeft:0};const i=n.data(),s=i==null?void 0:i.timestamp;if(typeof s!="string"||s.trim()==="")return console.warn(`Missing/invalid timestamp for task ${e}. Allowing claim.`),{eligible:!0,timeLeft:0};try{const o=new Date(s);if(isNaN(o.getTime()))return console.warn(`Invalid timestamp format for task ${e}:`,s,". Allowing claim."),{eligible:!0,timeLeft:0};const l=o.getTime(),u=Date.now()-l;return u>=r?{eligible:!0,timeLeft:0}:{eligible:!1,timeLeft:r-u}}catch(o){return console.error(`Error parsing timestamp string for task ${e}:`,s,o),{eligible:!0,timeLeft:0}}}async function Cu(e,t){if(nt(),!e||!e.id)throw new Error("Invalid task data provided.");if(!(await Vl(e.id,e.cooldownHours)).eligible)throw new Error("Cooldown period is still active for this task.");const n=le(G,"airdrop_users",Pe),r=Math.round(e.points);if(isNaN(r)||r<0)throw new Error("Invalid points value for the task.");await Cn(n,{totalPoints:Ue(r)});const i=le(G,"airdrop_users",Pe,"task_claims",e.id);return await In(i,{timestamp:new Date().toISOString(),points:r}),r}async function Iu(e){var o;const t=e.trim().toLowerCase();let a="Other",n=!0;if(t.includes("youtube.com/shorts/")){a="YouTube Shorts";const l=t.match(/\/shorts\/([a-zA-Z0-9_-]+)/);if(!l||!l[1])throw n=!1,new Error("Invalid YouTube Shorts URL: Video ID not found or incorrect format.")}else if(t.includes("youtube.com/watch?v=")||t.includes("youtu.be/")){a="YouTube";const l=t.match(/(?:v=|\/)([a-zA-Z0-9_-]{11})(?:[?&]|$)/);if(!l||l[1].length!==11)throw n=!1,new Error("Invalid YouTube URL: Video ID not found or incorrect format.")}else{if(t.includes("youtube.com/"))throw a="YouTube",n=!1,new Error("Invalid YouTube URL: Only video links (youtube.com/watch?v=... or youtu.be/...) or Shorts links are accepted.");if(t.includes("instagram.com/p/")||t.includes("instagram.com/reel/")){a="Instagram";const l=t.match(/\/(?:p|reel)\/([a-zA-Z0-9_.-]+)/);(!l||!l[1])&&(n=!1)}else t.includes("twitter.com/")||t.includes("x.com/")?t.match(/(\w+)\/(?:status|statuses)\/(\d+)/)&&(a="X/Twitter"):t.includes("facebook.com/")&&t.includes("/posts/")?a="Facebook":t.includes("t.me/")||t.includes("telegram.org/")?a="Telegram":t.includes("tiktok.com/")?a="TikTok":t.includes("reddit.com/r/")?a="Reddit":t.includes("linkedin.com/posts/")&&(a="LinkedIn")}const i=((o=(await si()).config)==null?void 0:o.ugcBasePoints)||{},s=i[a]||i.Other||1e3;if(isNaN(s)||s<0)throw new Error(`Invalid base points configured for platform: ${a}. Please contact admin.`);return{platform:a,basePoints:s,isValid:n,normalizedUrl:t}}async function Au(e){var ne;nt();const t=le(G,"airdrop_users",Pe),a=et(G,"airdrop_users",Pe,"submissions"),n=et(G,"all_submissions_log"),r=e.trim();if(!r||!r.toLowerCase().startsWith("http://")&&!r.toLowerCase().startsWith("https://"))throw new Error("The provided URL must start with http:// or https://.");let i;try{i=await Iu(r)}catch(V){throw V}const{platform:s,basePoints:o,isValid:l,normalizedUrl:d}=i;if(!l)throw new Error(`The provided URL for ${s} does not appear valid for submission.`);const u=Dt(a,sa("submittedAt","desc"),tu(1)),m=await ht(u);if(!m.empty){const he=(ne=m.docs[0].data().submittedAt)==null?void 0:ne.toDate();if(he){const ce=new Date,Y=5*60*1e3,ie=ce.getTime()-he.getTime();if(ie<Y){const $e=Y-ie,It=Math.ceil($e/6e4);throw new Error(`We're building a strong community, and we value quality over quantity. To prevent spam, please wait ${It} more minute(s) before submitting another post. We appreciate your thoughtful contribution!`)}}}const p=Dt(n,dn("normalizedUrl","==",d),dn("status","in",["pending","approved","auditing","flagged_suspicious"]));if(!(await ht(p)).empty)throw new Error("This content link has already been submitted. Repeatedly submitting duplicate or fraudulent content may lead to account suspension.");const f=await Ne(t);if(!f.exists())throw new Error("User profile not found.");const w=f.data(),k=w.approvedSubmissionsCount||0,C=pn(k),P=Math.round(o*C),S=vt(),_={url:r,platform:s,status:"pending",basePoints:o,_pointsCalculated:P,_multiplierApplied:C,pointsAwarded:0,submittedAt:S,resolvedAt:null},B={userId:Pe,walletAddress:w.walletAddress,normalizedUrl:d,platform:s,status:"pending",basePoints:o,submittedAt:S,resolvedAt:null},I=Tn(G),N=le(a);I.set(N,_);const F=le(n,N.id);I.set(F,B),await I.commit()}async function Pu(){nt();const e=et(G,"airdrop_users",Pe,"submissions"),t=Dt(e,sa("submittedAt","desc"));return(await ht(t)).docs.map(n=>{var i,s;const r=n.data();return{submissionId:n.id,...r,submittedAt:(i=r.submittedAt)!=null&&i.toDate?r.submittedAt.toDate():null,resolvedAt:(s=r.resolvedAt)!=null&&s.toDate?r.resolvedAt.toDate():null}})}async function zu(e){nt();const t=Pe,a=le(G,"airdrop_users",t),n=le(G,"airdrop_users",t,"submissions",e),r=le(G,"all_submissions_log",e),i=await Ne(n);if(!i.exists())throw new Error("Cannot confirm submission: Document not found or already processed.");const s=i.data(),o=s.status;if(o==="approved"||o==="rejected")throw new Error(`Submission is already in status: ${o}.`);let l=s._pointsCalculated,d=s._multiplierApplied;if(typeof l!="number"||isNaN(l)||l<=0){console.warn(`[ConfirmSubmission] Legacy/Invalid submission ${e} missing/invalid _pointsCalculated. Recalculating...`);const m=s.basePoints||0,p=await Ne(a);if(!p.exists())throw new Error("User profile not found for recalculation.");const f=p.data().approvedSubmissionsCount||0;d=pn(f),l=Math.round(m*d),(isNaN(l)||l<=0)&&(console.warn(`[ConfirmSubmission] Recalculation failed (basePoints: ${m}). Using fallback 1000.`),l=Math.round(1e3*d))}const u=Tn(G);u.update(a,{totalPoints:Ue(l),approvedSubmissionsCount:Ue(1)}),u.update(n,{status:"approved",pointsAwarded:l,_pointsCalculated:l,_multiplierApplied:d,resolvedAt:vt()}),await Ne(r).then(m=>m.exists())&&u.update(r,{status:"approved",resolvedAt:vt()}),await u.commit()}async function ql(e){nt();const a=le(G,"airdrop_users",Pe,"submissions",e),n=le(G,"all_submissions_log",e),r=await Ne(a);if(!r.exists())return console.warn(`Delete submission skipped: Document ${e} not found.`);const i=r.data().status;if(i==="approved"||i==="rejected")throw new Error(`This submission was already ${i} and cannot be deleted.`);if(i==="flagged_suspicious")throw new Error("Flagged submissions must be resolved, not deleted.");const s=Tn(G);s.update(a,{status:"deleted_by_user",resolvedAt:vt()}),await Ne(n).then(o=>o.exists())&&s.update(n,{status:"deleted_by_user",resolvedAt:vt(),pointsAwarded:0}),await s.commit()}async function Bu(e){const t=le(G,"airdrop_public_data","data_v1");await In(t,{config:{ugcBasePoints:e}},{merge:!0})}async function Nu(){const e=et(G,"daily_tasks"),t=Dt(e,sa("endDate","asc"));return(await ht(t)).docs.map(n=>{var r,i;return{id:n.id,...n.data(),startDate:(r=n.data().startDate)!=null&&r.toDate?n.data().startDate.toDate():null,endDate:(i=n.data().endDate)!=null&&i.toDate?n.data().endDate.toDate():null}})}async function Su(e){const t={...e};t.startDate instanceof Date&&(t.startDate=wo.fromDate(t.startDate)),t.endDate instanceof Date&&(t.endDate=wo.fromDate(t.endDate));const a=e.id;if(!a)delete t.id,await au(et(G,"daily_tasks"),t);else{const n=le(G,"daily_tasks",a);delete t.id,await In(n,t,{merge:!0})}}async function $u(e){if(!e)throw new Error("Task ID is required for deletion.");await nu(le(G,"daily_tasks",e))}async function Lu(){const e=et(G,"all_submissions_log"),t=Dt(e,dn("status","in",["pending","auditing","flagged_suspicious"]),sa("submittedAt","desc"));return(await ht(t)).docs.map(n=>{var i,s;const r=n.data();return{userId:r.userId,walletAddress:r.walletAddress,submissionId:n.id,...r,submittedAt:(i=r.submittedAt)!=null&&i.toDate?r.submittedAt.toDate():null,resolvedAt:(s=r.resolvedAt)!=null&&s.toDate?r.resolvedAt.toDate():null}})}async function Xl(e,t,a){var C,P,S;if(!e)throw new Error("User ID (walletAddress) is required.");const n=e.toLowerCase(),r=le(G,"airdrop_users",n),i=le(G,"airdrop_users",n,"submissions",t),s=le(G,"all_submissions_log",t),[o,l,d]=await Promise.all([Ne(r),Ne(i),Ne(s)]);if(!l.exists())throw new Error("Submission not found in user collection.");if(!o.exists())throw new Error("User profile not found.");d.exists()||console.warn(`Log entry ${t} not found. Log will not be updated.`);const u=l.data(),m=o.data(),p=u.status;if(p===a){console.warn(`Admin action ignored: Submission ${t} already has status ${a}.`);return}const b=Tn(G),f={};let w=0,k=u._multiplierApplied||0;if(a==="approved"){let _=u._pointsCalculated;if(typeof _!="number"||isNaN(_)||_<=0){console.warn(`[Admin] Legacy/Invalid submission ${t} missing/invalid _pointsCalculated. Recalculating...`);const B=u.basePoints||0,I=m.approvedSubmissionsCount||0,N=pn(I);if(_=Math.round(B*N),isNaN(_)||_<=0){console.warn(`[Admin] Recalculation failed (basePoints: ${B}). Using fallback 1000.`);const F=pn(I);_=Math.round(1e3*F)}k=N}w=_,f.totalPoints=Ue(_),f.approvedSubmissionsCount=Ue(1),p==="rejected"&&(f.rejectedCount=Ue(-1))}else if(a==="rejected"){if(p!=="rejected"){const _=m.rejectedCount||0;f.rejectedCount=Ue(1),_+1>=3&&(f.isBanned=!0)}else if(p==="approved"){const _=u.pointsAwarded||0;f.totalPoints=Ue(-_),f.approvedSubmissionsCount=Ue(-1);const B=m.rejectedCount||0;f.rejectedCount=Ue(1),B+1>=3&&(f.isBanned=!0)}w=0}if(((C=f.approvedSubmissionsCount)==null?void 0:C.operand)<0&&(m.approvedSubmissionsCount||0)<=0&&(f.approvedSubmissionsCount=0),((P=f.rejectedCount)==null?void 0:P.operand)<0&&(m.rejectedCount||0)<=0&&(f.rejectedCount=0),((S=f.totalPoints)==null?void 0:S.operand)<0){const _=m.totalPoints||0,B=Math.abs(f.totalPoints.operand);_<B&&(f.totalPoints=0)}Object.keys(f).length>0&&b.update(r,f),b.update(i,{status:a,pointsAwarded:w,_pointsCalculated:a==="approved"?w:u._pointsCalculated||0,_multiplierApplied:k,resolvedAt:vt()}),d.exists()&&b.update(s,{status:a,resolvedAt:vt()}),await b.commit()}async function Ru(){const e=et(G,"airdrop_users"),t=Dt(e,sa("totalPoints","desc"));return(await ht(t)).docs.map(n=>({id:n.id,...n.data()}))}async function _u(e,t){if(!e)throw new Error("User ID is required.");const a=e.toLowerCase(),n=et(G,"airdrop_users",a,"submissions"),r=Dt(n,dn("status","==",t),sa("resolvedAt","desc"));return(await ht(r)).docs.map(s=>{var o,l;return{submissionId:s.id,userId:a,...s.data(),submittedAt:(o=s.data().submittedAt)!=null&&o.toDate?s.data().submittedAt.toDate():null,resolvedAt:(l=s.data().resolvedAt)!=null&&l.toDate?s.data().resolvedAt.toDate():null}})}async function Jl(e,t){if(!e)throw new Error("User ID is required.");const a=e.toLowerCase(),n=le(G,"airdrop_users",a),r={isBanned:t};t===!1&&(r.rejectedCount=0),await Cn(n,r)}async function So(){nt();try{const e=et(G,"airdrop_users",Pe,"platform_usage"),t=await ht(e),a={};return t.forEach(n=>{a[n.id]=n.data()}),a}catch(e){return console.error("Error fetching platform usage:",e),{}}}async function Zl(e){nt();const t=le(G,"airdrop_public_data","data_v1");await Cn(t,{platformUsageConfig:e}),console.log("✅ Platform usage config saved:",e)}const H=window.ethers,Ql=421614,Fu="0x66eee";let _e=null,$o=0,ct=0;const Mu=5e3,Lo=3,Du=6e4;let oi=0;const Ou=3;let ec=null;const Hu="cd4bdedee7a7e909ebd3df8bbc502aed",Uu={chainId:we.chainIdDecimal,name:we.chainName,currency:we.nativeCurrency.symbol,explorerUrl:we.blockExplorerUrls[0],rpcUrl:we.rpcUrls[0]},ju={name:"Backcoin Protocol",description:"DeFi Ecosystem",url:window.location.origin,icons:[window.location.origin+"/assets/bkc_logo_3d.png"]},Wu=Vd({metadata:ju,enableEIP6963:!0,enableInjected:!0,enableCoinbase:!1,rpcUrl:ai,defaultChainId:Ql,enableEmail:!0,enableEns:!1,auth:{email:!0,showWallets:!0,walletFeatures:!0}}),Bt=qd({ethersConfig:Wu,chains:[Uu],projectId:Hu,enableAnalytics:!0,themeMode:"dark",themeVariables:{"--w3m-accent":"#f59e0b","--w3m-border-radius-master":"1px","--w3m-z-index":100}});function Gu(e){var n,r;const t=((n=e==null?void 0:e.message)==null?void 0:n.toLowerCase())||"",a=(e==null?void 0:e.code)||((r=e==null?void 0:e.error)==null?void 0:r.code);return a===-32603||a===-32e3||a===429||t.includes("failed to fetch")||t.includes("network error")||t.includes("timeout")||t.includes("rate limit")||t.includes("too many requests")||t.includes("internal json-rpc")||t.includes("unexpected token")||t.includes("<html")}function Lr(e){return new H.JsonRpcProvider(e||ea())}async function tc(e,t=Ou){var n;let a=null;for(let r=0;r<t;r++)try{const i=await e();return Il(ea()),oi=0,i}catch(i){if(a=i,Gu(i)){console.warn(`⚠️ RPC error (attempt ${r+1}/${t}):`,(n=i.message)==null?void 0:n.slice(0,80)),Cl(ea());const s=ni();console.log(`🔄 Switching to: ${s}`),await Mn(),await new Promise(o=>setTimeout(o,500*(r+1)))}else throw i}throw console.error("❌ All RPC attempts failed"),a}async function Mn(){const e=ea();try{c.publicProvider=Lr(e),ec=c.publicProvider;const t=c.publicProvider;K(v.bkcToken)&&(c.bkcTokenContractPublic=new H.Contract(v.bkcToken,An,t)),K(v.backchainEcosystem)&&(c.ecosystemManagerContractPublic=new H.Contract(v.backchainEcosystem,Sn,t)),K(v.stakingPool)&&(c.stakingPoolContractPublic=new H.Contract(v.stakingPool,Pn,t)),K(v.buybackMiner)&&(c.buybackMinerContractPublic=new H.Contract(v.buybackMiner,$n,t)),K(v.fortunePool)&&(c.fortunePoolContractPublic=new H.Contract(v.fortunePool,zn,t)),K(v.agora)&&(c.agoraContractPublic=new H.Contract(v.agora,la,t)),K(v.notary)&&(c.notaryContractPublic=new H.Contract(v.notary,Bn,t)),K(v.charityPool)&&(c.charityPoolContractPublic=new H.Contract(v.charityPool,Ln,t)),K(v.rentalManager)&&(c.rentalManagerContractPublic=new H.Contract(v.rentalManager,oa,t)),K(v.faucet)&&(c.faucetContractPublic=new H.Contract(v.faucet,Nn,t)),console.log(`✅ Public provider recreated with: ${e.slice(0,50)}...`)}catch(t){console.error("Failed to recreate public provider:",t)}}function Ku(e){if(!e)return!1;try{return H.isAddress(e)}catch{return!1}}function K(e){return e&&e!==H.ZeroAddress&&!e.startsWith("0x...")}function Yu(e){if(!e)return;const t=localStorage.getItem(`balance_${e.toLowerCase()}`);if(t)try{c.currentUserBalance=BigInt(t),window.updateUIState&&window.updateUIState()}catch{}}function Vu(e){try{const t=e;K(v.bkcToken)&&(c.bkcTokenContract=new H.Contract(v.bkcToken,An,t)),K(v.backchainEcosystem)&&(c.ecosystemManagerContract=new H.Contract(v.backchainEcosystem,Sn,t)),K(v.stakingPool)&&(c.stakingPoolContract=new H.Contract(v.stakingPool,Pn,t)),K(v.buybackMiner)&&(c.buybackMinerContract=new H.Contract(v.buybackMiner,$n,t)),K(v.rewardBooster)&&(c.rewardBoosterContract=new H.Contract(v.rewardBooster,Sl,t)),K(v.fortunePool)&&(c.fortunePoolContract=new H.Contract(v.fortunePool,zn,t)),K(v.agora)&&(c.agoraContract=new H.Contract(v.agora,la,t)),K(v.notary)&&(c.notaryContract=new H.Contract(v.notary,Bn,t)),K(v.charityPool)&&(c.charityPoolContract=new H.Contract(v.charityPool,Ln,t)),K(v.rentalManager)&&(c.rentalManagerContract=new H.Contract(v.rentalManager,oa,t)),K(v.faucet)&&(c.faucetContract=new H.Contract(v.faucet,Nn,t))}catch{console.warn("Contract init partial failure")}}function ac(){if(_e&&(clearInterval(_e),_e=null),!c.bkcTokenContractPublic||!c.userAddress){console.warn("Cannot start balance polling: missing contract or address");return}ct=0,oi=0,setTimeout(()=>{Ro()},1e3),_e=setInterval(Ro,Du),console.log("✅ Balance polling started (30s interval)")}async function Ro(){var t;if(document.hidden||!c.isConnected||!c.userAddress||!c.bkcTokenContractPublic)return;const e=Date.now();try{const a=await tc(async()=>await c.bkcTokenContractPublic.balanceOf(c.userAddress),2);ct=0;const n=c.currentUserBalance||0n;a.toString()!==n.toString()&&(c.currentUserBalance=a,localStorage.setItem(`balance_${c.userAddress.toLowerCase()}`,a.toString()),e-$o>Mu&&($o=e,window.updateUIState&&window.updateUIState(!1)))}catch(a){ct++,ct<=3&&console.warn(`⚠️ Balance check failed (${ct}/${Lo}):`,(t=a.message)==null?void 0:t.slice(0,50)),ct>=Lo&&(console.warn("❌ Too many balance check errors. Stopping polling temporarily."),_e&&(clearInterval(_e),_e=null),setTimeout(()=>{console.log("🔄 Attempting to restart balance polling with primary RPC..."),Al(),Mn().then(()=>{ct=0,ac()})},6e4))}}async function qu(e){try{const t=await e.getNetwork();if(Number(t.chainId)===Ql)return!0;try{return await e.send("wallet_switchEthereumChain",[{chainId:Fu}]),!0}catch{return!0}}catch{return!0}}async function _o(e,t){try{if(!Ku(t))return!1;await qu(e),c.provider=e;try{c.signer=await e.getSigner()}catch(a){c.signer=e,console.warn(`Could not get standard Signer. Using Provider as read-only. Warning: ${a.message}`)}c.userAddress=t,c.isConnected=!0,Yu(t),Vu(c.signer);try{Yl(c.userAddress)}catch{}return Fn().then(()=>{window.updateUIState&&window.updateUIState(!1)}).catch(()=>{}),ac(),!0}catch(a){return console.error("Setup warning:",a),!!t}}async function Xu(){try{if(window.ethereum){const a=await Rl();a.fixed?console.log("✅ MetaMask network config was auto-fixed"):!a.success&&!a.skipped&&console.warn("Initial network config check:",a.error)}const e=ea();console.log(`🌐 Initializing public provider with: ${e.slice(0,50)}...`),c.publicProvider=Lr(e),ec=c.publicProvider;const t=c.publicProvider;K(v.bkcToken)&&(c.bkcTokenContractPublic=new H.Contract(v.bkcToken,An,t)),K(v.backchainEcosystem)&&(c.ecosystemManagerContractPublic=new H.Contract(v.backchainEcosystem,Sn,t)),K(v.stakingPool)&&(c.stakingPoolContractPublic=new H.Contract(v.stakingPool,Pn,t)),K(v.buybackMiner)&&(c.buybackMinerContractPublic=new H.Contract(v.buybackMiner,$n,t)),K(v.fortunePool)&&(c.fortunePoolContractPublic=new H.Contract(v.fortunePool,zn,t)),K(v.agora)&&(c.agoraContractPublic=new H.Contract(v.agora,la,t)),K(v.notary)&&(c.notaryContractPublic=new H.Contract(v.notary,Bn,t)),K(v.charityPool)&&(c.charityPoolContractPublic=new H.Contract(v.charityPool,Ln,t)),K(v.rentalManager)&&(c.rentalManagerContractPublic=new H.Contract(v.rentalManager,oa,t)),K(v.faucet)&&(c.faucetContractPublic=new H.Contract(v.faucet,Nn,t));try{await tc(async()=>{await Ul()})}catch{console.warn("Initial public data load failed, will retry on user interaction")}_l(async a=>{a.isCorrectNetwork?(await za()).healthy||(console.log("⚠️ RPC issues after network change, updating..."),await ta(),await Mn()):(console.log("⚠️ User switched to wrong network"),x("Please switch back to Arbitrum Sepolia","warning"))}),Qu(),window.updateUIState&&window.updateUIState(),console.log("✅ Public provider initialized")}catch(e){console.error("Public provider error:",e),window.ethereum&&await ta();const t=ni();console.log(`🔄 Retrying with: ${t}`);try{c.publicProvider=Lr(t),console.log("✅ Public provider initialized with fallback RPC")}catch{console.error("❌ All RPC endpoints failed")}}}function Ju(e){let t=Bt.getAddress();if(Bt.getIsConnected()&&t){const n=Bt.getWalletProvider();if(n){const r=new H.BrowserProvider(n);c.web3Provider=n,e({isConnected:!0,address:t,isNewConnection:!1}),_o(r,t)}}const a=async({provider:n,address:r,chainId:i,isConnected:s})=>{try{if(s){let o=r||Bt.getAddress();if(!o&&n)try{o=await(await new H.BrowserProvider(n).getSigner()).getAddress()}catch{}if(o){const l=new H.BrowserProvider(n);c.web3Provider=n,e({isConnected:!0,address:o,chainId:i,isNewConnection:!0}),await _o(l,o)}else _e&&clearInterval(_e),c.isConnected=!1,c.userAddress=null,c.signer=null,e({isConnected:!1})}else _e&&clearInterval(_e),c.isConnected=!1,c.userAddress=null,c.signer=null,e({isConnected:!1})}catch{}};Bt.subscribeProvider(a)}function nc(){Bt.open()}async function Zu(){await Bt.disconnect()}function Qu(){let e=0;document.addEventListener("visibilitychange",async()=>{if(!document.hidden&&c.isConnected){const t=Date.now();if(t-e<3e5)return;(await za()).healthy||(e=t,console.log("⚠️ RPC unhealthy on tab focus, fixing..."),await ta(),await Mn(),ct=0,oi=0)}}),console.log("✅ RPC health monitoring started (event-driven, no polling)")}const rc=window.ethers,D=(e,t=18)=>{if(e===null||typeof e>"u")return 0;if(typeof e=="number")return e;if(typeof e=="string")return parseFloat(e);try{const a=BigInt(e);return parseFloat(rc.formatUnits(a,t))}catch{return 0}},ca=e=>!e||typeof e!="string"||!e.startsWith("0x")?"...":`${e.substring(0,6)}...${e.substring(e.length-4)}`,aa=e=>{try{if(e==null)return"0";const t=typeof e=="bigint"?e:BigInt(e);if(t===0n)return"0";const a=parseFloat(rc.formatEther(t));if(a===0||!isFinite(a))return"0";if(a<1e3)return a<.01?"<0.01":a%1===0?a.toString():a.toFixed(2);const n=["","k","M","B","T"],r=Math.min(Math.floor(Math.log10(a)/3),n.length-1);return(a/Math.pow(1e3,r)).toFixed(2)+n[r]}catch{return"0"}},ep=(e="An error occurred.")=>`<div class="bg-red-900/20 border border-red-500/30 rounded-lg p-4 text-center text-red-400 text-sm">${e}</div>`,tp=(e="No data available.")=>`<div class="text-center p-8 bg-zinc-900/30 border border-dashed border-zinc-800 rounded-lg col-span-full">
                <i class="fa-regular fa-folder-open text-2xl text-zinc-600 mb-2"></i>
                <p class="text-zinc-500 italic text-sm">${e}</p>
            </div>`;function li(e,t,a,n){if(!e)return;if(a<=1){e.innerHTML="";return}const r=`
    ...
    `;e.innerHTML=r,e.querySelectorAll(".pagination-btn").forEach(i=>{i.addEventListener("click",()=>{i.hasAttribute("disabled")||n(parseInt(i.dataset.page))})})}const ap="modulepreload",np=function(e){return"/"+e},Fo={},O=function(t,a,n){let r=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),o=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));r=Promise.allSettled(a.map(l=>{if(l=np(l),l in Fo)return;Fo[l]=!0;const d=l.endsWith(".css"),u=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${u}`))return;const m=document.createElement("link");if(m.rel=d?"stylesheet":ap,d||(m.as="script"),m.crossOrigin="",m.href=l,o&&m.setAttribute("nonce",o),document.head.appendChild(m),d)return new Promise((p,b)=>{m.addEventListener("load",p),m.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${l}`)))})}))}function i(s){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=s,window.dispatchEvent(o),!o.defaultPrevented)throw s}return r.then(s=>{for(const o of s||[])o.status==="rejected"&&i(o.reason);return t().catch(i)})},ic="/api/faucet";function Dn(){var e;return(v==null?void 0:v.faucet)||(M==null?void 0:M.faucet)||((e=window.contractAddresses)==null?void 0:e.faucet)||null}const mn=["function claim() external","function canClaim(address user) view returns (bool)","function getUserInfo(address user) view returns (uint256 lastClaim, uint256 claims, bool eligible, uint256 cooldownLeft)","function getCooldownRemaining(address user) view returns (uint256)","function cooldown() view returns (uint256)","function tokensPerClaim() view returns (uint256)","function ethPerClaim() view returns (uint256)","function paused() view returns (bool)","function getFaucetStatus() view returns (uint256 ethBalance, uint256 tokenBalance, uint256 ethPerDrip, uint256 tokensPerDrip, uint256 estimatedEthClaims, uint256 estimatedTokenClaims)","function getStats() view returns (uint256 tokens, uint256 eth, uint256 claims, uint256 users)","event Claimed(address indexed recipient, uint256 tokens, uint256 eth, address indexed via)"];function rp(){var e,t;return typeof State<"u"&&(State!=null&&State.userAddress)?State.userAddress:(e=window.State)!=null&&e.userAddress?window.State.userAddress:window.userAddress?window.userAddress:(t=window.ethereum)!=null&&t.selectedAddress?window.ethereum.selectedAddress:null}function $t(e,t="info"){if(typeof window.showToast=="function"){window.showToast(e,t);return}(t==="error"?console.error:console.log)(`[Faucet] ${e}`)}async function sc(){if(typeof window.loadUserData=="function"){await window.loadUserData();return}if(typeof window.refreshBalances=="function"){await window.refreshBalances();return}}async function ci({button:e=null,address:t=null,onSuccess:a=null,onError:n=null}={}){const r=t||rp();if(!r){const o="Please connect wallet first";return $t(o,"error"),n&&n(new Error(o)),{success:!1,error:o}}const i=(e==null?void 0:e.innerHTML)||"Claim",s=(e==null?void 0:e.disabled)||!1;e&&(e.innerHTML='<div class="loader inline-block"></div> Claiming...',e.disabled=!0);try{const o=await fetch(`${ic}?address=${r}`,{method:"GET",headers:{Accept:"application/json"}}),l=await o.json();if(o.ok&&l.success){$t("Tokens received!","success"),await sc();const d={success:!0,txHash:l.txHash,bkcAmount:l.bkcAmount,ethAmount:l.ethAmount};return a&&a(d),d}else{const d=l.error||l.message||"Faucet unavailable";$t(d,"error");const u=new Error(d);return n&&n(u),{success:!1,error:d}}}catch(o){return console.error("Faucet error:",o),$t("Faucet unavailable","error"),n&&n(o),{success:!1,error:o.message}}finally{e&&(e.innerHTML=i,e.disabled=s)}}const On=async e=>await ci({button:e});async function oc({button:e=null,onSuccess:t=null,onError:a=null}={}){const n=Dn();if(!n){const i="Faucet contract address not configured";return $t(i,"error"),a&&a(new Error(i)),{success:!1,error:i}}const{txEngine:r}=await O(async()=>{const{txEngine:i}=await Promise.resolve().then(()=>J);return{txEngine:i}},void 0);return await r.execute({name:"FaucetClaim",button:e,getContract:async i=>{const s=window.ethers;return new s.Contract(n,mn,i)},method:"claim",args:[],validate:async(i,s)=>{const o=window.ethers,{NetworkManager:l}=await O(async()=>{const{NetworkManager:m}=await Promise.resolve().then(()=>J);return{NetworkManager:m}},void 0),d=l.getProvider(),u=new o.Contract(n,mn,d);try{const m=await u.getUserInfo(s),p=m[2],b=Number(m[3]);if(!p){if(b>0){const f=Math.ceil(b/60);throw new Error(`Aguarde ${f} minutos para claimar novamente`)}throw new Error("Faucet indisponível no momento")}}catch(m){if(m.message.includes("Aguarde")||m.message.includes("indisponível"))throw m;if(!await u.canClaim(s))throw new Error("Aguarde o cooldown para claimar novamente.")}},onSuccess:async i=>{$t("Tokens received!","success"),await sc(),t&&t(i)},onError:i=>{$t(i.message||"Claim failed","error"),a&&a(i)}})}async function lc(e){const t=Dn();if(!t)return{canClaim:!1,error:"Faucet not configured"};try{const a=window.ethers,{NetworkManager:n}=await O(async()=>{const{NetworkManager:s}=await Promise.resolve().then(()=>J);return{NetworkManager:s}},void 0),r=n.getProvider(),i=new a.Contract(t,mn,r);try{const s=await i.getUserInfo(e);return{canClaim:s[2],lastClaimTime:Number(s[0]),claimCount:Number(s[1]),cooldownLeft:Number(s[3]),waitSeconds:Number(s[3])}}catch{return{canClaim:await i.canClaim(e),waitSeconds:0}}}catch(a){return console.error("Error checking claim status:",a),{canClaim:!1,error:a.message}}}async function cc(){const e=Dn();if(!e)return{error:"Faucet not configured"};try{const t=window.ethers,{NetworkManager:a}=await O(async()=>{const{NetworkManager:i}=await Promise.resolve().then(()=>J);return{NetworkManager:i}},void 0),n=a.getProvider(),r=new t.Contract(e,mn,n);try{const i=await r.getFaucetStatus(),s=i[0],o=i[1],l=i[2],d=i[3];return{bkcAmount:d,ethAmount:l,bkcAmountFormatted:t.formatEther(d),ethAmountFormatted:t.formatEther(l),bkcBalance:o,ethBalance:s,bkcBalanceFormatted:t.formatEther(o),ethBalanceFormatted:t.formatEther(s),estimatedEthClaims:Number(i[4]),estimatedTokenClaims:Number(i[5]),cooldownSeconds:Number(await r.cooldown()),cooldownMinutes:Number(await r.cooldown())/60,isPaused:await r.paused()}}catch{const[i,s,o]=await Promise.all([r.tokensPerClaim(),r.ethPerClaim(),r.cooldown()]);return{bkcAmount:i,ethAmount:s,cooldownSeconds:Number(o),cooldownMinutes:Number(o)/60,bkcAmountFormatted:t.formatEther(i),ethAmountFormatted:t.formatEther(s)}}}catch(t){return console.error("Error getting faucet info:",t),{error:t.message}}}const dc={claim:ci,claimOnChain:oc,executeFaucetClaim:On,canClaim:lc,getFaucetInfo:cc,getFaucetAddress:Dn,FAUCET_API_URL:ic},ip=Object.freeze(Object.defineProperty({__proto__:null,FaucetTx:dc,canClaim:lc,claim:ci,claimOnChain:oc,executeFaucetClaim:On,getFaucetInfo:cc},Symbol.toStringTag,{value:"Module"})),rn={BALANCE:1e4,ALLOWANCE:3e4},Ce=new Map,de={hits:0,misses:0,sets:0,invalidations:0},bt={get(e){const t=Ce.get(e);if(!t){de.misses++;return}if(Date.now()>t.expiresAt){Ce.delete(e),de.misses++;return}return de.hits++,t.value},set(e,t,a){t!=null&&(Ce.set(e,{value:t,expiresAt:Date.now()+a,createdAt:Date.now()}),de.sets++)},delete(e){Ce.delete(e)},clear(e){if(!e){Ce.clear(),de.invalidations++;return}for(const t of Ce.keys())t.includes(e)&&Ce.delete(t);de.invalidations++},async getOrFetch(e,t,a){const n=this.get(e);if(n!==void 0)return n;try{const r=await t();return r!=null&&this.set(e,r,a),r}catch(r){throw console.warn(`[Cache] Error fetching ${e}:`,r.message),r}},has(e){return this.get(e)!==void 0},getTTL(e){const t=Ce.get(e);if(!t)return 0;const a=t.expiresAt-Date.now();return a>0?a:0},invalidateByTx(e){const a={CreateCampaign:["campaign-","charity-stats","user-campaigns-","campaign-list"],Donate:["campaign-","charity-stats","token-balance-","allowance-"],CancelCampaign:["campaign-","charity-stats","user-campaigns-"],Withdraw:["campaign-","charity-stats","token-balance-"],Delegate:["delegation-","token-balance-","allowance-","user-pstake-","pending-rewards-","network-pstake"],Unstake:["delegation-","token-balance-","user-pstake-","pending-rewards-","network-pstake"],ForceUnstake:["delegation-","token-balance-","user-pstake-","pending-rewards-","network-pstake"],ClaimReward:["pending-rewards-","token-balance-","saved-rewards-"],BuyNFT:["pool-info-","pool-nfts-","token-balance-","allowance-","user-nfts-","buy-price-","sell-price-"],SellNFT:["pool-info-","pool-nfts-","token-balance-","user-nfts-","buy-price-","sell-price-"],PlayGame:["fortune-pool-","fortune-stats-","token-balance-","allowance-","user-fortune-history-"],ListNFT:["rental-listings-","rental-listing-","user-nfts-"],RentNFT:["rental-listing-","rental-active-","token-balance-","allowance-"],WithdrawNFT:["rental-listing-","rental-listings-","user-nfts-"],UpdateListing:["rental-listing-"],Notarize:["notary-","token-balance-","allowance-","user-documents-"],TokenTransfer:["token-balance-","allowance-"],Approval:["allowance-"]}[e];if(!a){console.warn(`[Cache] Unknown transaction type: ${e}`);return}a.forEach(n=>{this.clear(n)}),console.log(`[Cache] Invalidated patterns for ${e}:`,a)},getStats(){const e=Ce.size,t=de.hits+de.misses>0?(de.hits/(de.hits+de.misses)*100).toFixed(1):0;return{entries:e,hits:de.hits,misses:de.misses,sets:de.sets,invalidations:de.invalidations,hitRate:`${t}%`}},keys(){return Array.from(Ce.keys())},size(){return Ce.size},cleanup(){const e=Date.now();let t=0;for(const[a,n]of Ce.entries())e>n.expiresAt&&(Ce.delete(a),t++);return t>0&&console.log(`[Cache] Cleanup removed ${t} expired entries`),t},resetMetrics(){de.hits=0,de.misses=0,de.sets=0,de.invalidations=0}},sn={tokenBalance:(e,t)=>`token-balance-${e.toLowerCase()}-${t.toLowerCase()}`,ethBalance:e=>`eth-balance-${e.toLowerCase()}`,allowance:(e,t,a)=>`allowance-${e.toLowerCase()}-${t.toLowerCase()}-${a.toLowerCase()}`,campaign:e=>`campaign-${e}`,campaignList:()=>"campaign-list",charityStats:()=>"charity-stats",userCampaigns:e=>`user-campaigns-${e.toLowerCase()}`,delegation:(e,t)=>`delegation-${e.toLowerCase()}-${t}`,delegations:e=>`delegation-list-${e.toLowerCase()}`,userPStake:e=>`user-pstake-${e.toLowerCase()}`,pendingRewards:e=>`pending-rewards-${e.toLowerCase()}`,networkPStake:()=>"network-pstake",poolInfo:e=>`pool-info-${e.toLowerCase()}`,poolNfts:e=>`pool-nfts-${e.toLowerCase()}`,buyPrice:e=>`buy-price-${e.toLowerCase()}`,sellPrice:e=>`sell-price-${e.toLowerCase()}`,userNfts:e=>`user-nfts-${e.toLowerCase()}`,fortunePool:()=>"fortune-pool",fortuneTiers:()=>"fortune-tiers",fortuneStats:()=>"fortune-stats",userFortuneHistory:e=>`user-fortune-history-${e.toLowerCase()}`,rentalListings:()=>"rental-listings",rentalListing:e=>`rental-listing-${e}`,rentalActive:e=>`rental-active-${e}`,notaryDocument:e=>`notary-doc-${e}`,userDocuments:e=>`user-documents-${e.toLowerCase()}`,feeConfig:e=>`fee-config-${e}`,protocolConfig:()=>"protocol-config"},h={WRONG_NETWORK:"wrong_network",RPC_UNHEALTHY:"rpc_unhealthy",RPC_RATE_LIMITED:"rpc_rate_limited",NETWORK_ERROR:"network_error",WALLET_NOT_CONNECTED:"wallet_not_connected",WALLET_LOCKED:"wallet_locked",INSUFFICIENT_ETH:"insufficient_eth",INSUFFICIENT_TOKEN:"insufficient_token",INSUFFICIENT_ALLOWANCE:"insufficient_allowance",SIMULATION_REVERTED:"simulation_reverted",GAS_ESTIMATION_FAILED:"gas_estimation_failed",USER_REJECTED:"user_rejected",TX_REVERTED:"tx_reverted",TX_TIMEOUT:"tx_timeout",TX_REPLACED:"tx_replaced",TX_UNDERPRICED:"tx_underpriced",NONCE_ERROR:"nonce_error",CAMPAIGN_NOT_FOUND:"campaign_not_found",CAMPAIGN_NOT_ACTIVE:"campaign_not_active",CAMPAIGN_STILL_ACTIVE:"campaign_still_active",NOT_CAMPAIGN_CREATOR:"not_campaign_creator",DONATION_TOO_SMALL:"donation_too_small",MAX_CAMPAIGNS_REACHED:"max_campaigns_reached",INSUFFICIENT_ETH_FEE:"insufficient_eth_fee",LOCK_PERIOD_ACTIVE:"lock_period_active",LOCK_PERIOD_EXPIRED:"lock_period_expired",NO_REWARDS:"no_rewards",INVALID_DURATION:"invalid_duration",INVALID_DELEGATION_INDEX:"invalid_delegation_index",NFT_NOT_IN_POOL:"nft_not_in_pool",POOL_NOT_INITIALIZED:"pool_not_initialized",INSUFFICIENT_POOL_LIQUIDITY:"insufficient_pool_liquidity",SLIPPAGE_EXCEEDED:"slippage_exceeded",NFT_BOOST_MISMATCH:"nft_boost_mismatch",NOT_NFT_OWNER:"not_nft_owner",NO_ACTIVE_TIERS:"no_active_tiers",INVALID_GUESS_COUNT:"invalid_guess_count",INVALID_GUESS_RANGE:"invalid_guess_range",INSUFFICIENT_SERVICE_FEE:"insufficient_service_fee",RENTAL_STILL_ACTIVE:"rental_still_active",NFT_NOT_LISTED:"nft_not_listed",NFT_ALREADY_LISTED:"nft_already_listed",NOT_LISTING_OWNER:"not_listing_owner",MARKETPLACE_PAUSED:"marketplace_paused",EMPTY_METADATA:"empty_metadata",CONTRACT_ERROR:"contract_error",UNKNOWN:"unknown"},on={[h.WRONG_NETWORK]:"Please switch to Arbitrum Sepolia network",[h.RPC_UNHEALTHY]:"Network connection issue. Retrying...",[h.RPC_RATE_LIMITED]:"Network is busy. Please wait a moment...",[h.NETWORK_ERROR]:"Network error. Please check your connection",[h.WALLET_NOT_CONNECTED]:"Please connect your wallet",[h.WALLET_LOCKED]:"Please unlock your wallet",[h.INSUFFICIENT_ETH]:"Insufficient ETH for gas fees",[h.INSUFFICIENT_TOKEN]:"Insufficient BKC balance",[h.INSUFFICIENT_ALLOWANCE]:"Token approval required",[h.SIMULATION_REVERTED]:"Transaction would fail. Please check your inputs",[h.GAS_ESTIMATION_FAILED]:"Could not estimate gas. Transaction may fail",[h.USER_REJECTED]:"Transaction cancelled",[h.TX_REVERTED]:"Transaction failed on blockchain",[h.TX_TIMEOUT]:"Transaction is taking too long. Please check your wallet",[h.TX_REPLACED]:"Transaction was replaced",[h.TX_UNDERPRICED]:"Gas price too low. Please try again",[h.NONCE_ERROR]:"Transaction sequence error. Please refresh and try again",[h.CAMPAIGN_NOT_FOUND]:"Campaign not found",[h.CAMPAIGN_NOT_ACTIVE]:"This campaign is no longer accepting donations",[h.CAMPAIGN_STILL_ACTIVE]:"Campaign is still active. Please wait until the deadline",[h.NOT_CAMPAIGN_CREATOR]:"Only the campaign creator can perform this action",[h.DONATION_TOO_SMALL]:"Donation amount is below the minimum required",[h.MAX_CAMPAIGNS_REACHED]:"You have reached the maximum number of active campaigns",[h.INSUFFICIENT_ETH_FEE]:"Insufficient ETH for withdrawal fee",[h.LOCK_PERIOD_ACTIVE]:"Your tokens are still locked",[h.LOCK_PERIOD_EXPIRED]:"Lock period has expired. Use normal unstake",[h.NO_REWARDS]:"No rewards available to claim",[h.INVALID_DURATION]:"Lock duration must be between 1 day and 10 years",[h.INVALID_DELEGATION_INDEX]:"Delegation not found",[h.NFT_NOT_IN_POOL]:"This NFT is not available in the pool",[h.POOL_NOT_INITIALIZED]:"Pool is not active yet",[h.INSUFFICIENT_POOL_LIQUIDITY]:"Insufficient liquidity in pool",[h.SLIPPAGE_EXCEEDED]:"Price changed too much. Please try again",[h.NFT_BOOST_MISMATCH]:"NFT tier does not match this pool",[h.NOT_NFT_OWNER]:"You do not own this NFT",[h.NO_ACTIVE_TIERS]:"No active prize tiers available",[h.INVALID_GUESS_COUNT]:"Invalid number of guesses provided",[h.INVALID_GUESS_RANGE]:"Your guess is outside the valid range",[h.INSUFFICIENT_SERVICE_FEE]:"Incorrect service fee amount",[h.RENTAL_STILL_ACTIVE]:"This NFT is currently being rented",[h.NFT_NOT_LISTED]:"This NFT is not listed for rent",[h.NFT_ALREADY_LISTED]:"This NFT is already listed",[h.NOT_LISTING_OWNER]:"Only the listing owner can perform this action",[h.MARKETPLACE_PAUSED]:"Marketplace is temporarily paused",[h.EMPTY_METADATA]:"Document metadata cannot be empty",[h.CONTRACT_ERROR]:"Transaction cannot be completed. Please check your inputs and try again",[h.UNKNOWN]:"An unexpected error occurred. Please try again"},At={[h.WRONG_NETWORK]:{layer:1,retry:!1,action:"switch_network"},[h.RPC_UNHEALTHY]:{layer:1,retry:!0,waitMs:2e3,action:"switch_rpc"},[h.RPC_RATE_LIMITED]:{layer:1,retry:!0,waitMs:"extract",action:"switch_rpc"},[h.NETWORK_ERROR]:{layer:1,retry:!0,waitMs:3e3,action:"switch_rpc"},[h.WALLET_NOT_CONNECTED]:{layer:2,retry:!1,action:"connect_wallet"},[h.WALLET_LOCKED]:{layer:2,retry:!1,action:"unlock_wallet"},[h.INSUFFICIENT_ETH]:{layer:3,retry:!1,action:"show_faucet"},[h.INSUFFICIENT_TOKEN]:{layer:3,retry:!1},[h.INSUFFICIENT_ALLOWANCE]:{layer:3,retry:!1},[h.SIMULATION_REVERTED]:{layer:4,retry:!1},[h.GAS_ESTIMATION_FAILED]:{layer:4,retry:!0,waitMs:2e3},[h.USER_REJECTED]:{layer:5,retry:!1},[h.TX_REVERTED]:{layer:5,retry:!1},[h.TX_TIMEOUT]:{layer:5,retry:!0,waitMs:5e3},[h.TX_REPLACED]:{layer:5,retry:!1},[h.TX_UNDERPRICED]:{layer:5,retry:!0,waitMs:1e3},[h.NONCE_ERROR]:{layer:5,retry:!0,waitMs:2e3},[h.CAMPAIGN_NOT_FOUND]:{layer:4,retry:!1},[h.CAMPAIGN_NOT_ACTIVE]:{layer:4,retry:!1},[h.CAMPAIGN_STILL_ACTIVE]:{layer:4,retry:!1},[h.NOT_CAMPAIGN_CREATOR]:{layer:4,retry:!1},[h.DONATION_TOO_SMALL]:{layer:4,retry:!1},[h.MAX_CAMPAIGNS_REACHED]:{layer:4,retry:!1},[h.INSUFFICIENT_ETH_FEE]:{layer:3,retry:!1},[h.LOCK_PERIOD_ACTIVE]:{layer:4,retry:!1},[h.LOCK_PERIOD_EXPIRED]:{layer:4,retry:!1},[h.NO_REWARDS]:{layer:4,retry:!1},[h.INVALID_DURATION]:{layer:4,retry:!1},[h.INVALID_DELEGATION_INDEX]:{layer:4,retry:!1},[h.NFT_NOT_IN_POOL]:{layer:4,retry:!1},[h.POOL_NOT_INITIALIZED]:{layer:4,retry:!1},[h.INSUFFICIENT_POOL_LIQUIDITY]:{layer:4,retry:!1},[h.SLIPPAGE_EXCEEDED]:{layer:4,retry:!0,waitMs:1e3},[h.NFT_BOOST_MISMATCH]:{layer:4,retry:!1},[h.NOT_NFT_OWNER]:{layer:4,retry:!1},[h.NO_ACTIVE_TIERS]:{layer:4,retry:!1},[h.INVALID_GUESS_COUNT]:{layer:4,retry:!1},[h.INVALID_GUESS_RANGE]:{layer:4,retry:!1},[h.INSUFFICIENT_SERVICE_FEE]:{layer:4,retry:!1},[h.RENTAL_STILL_ACTIVE]:{layer:4,retry:!1},[h.NFT_NOT_LISTED]:{layer:4,retry:!1},[h.NFT_ALREADY_LISTED]:{layer:4,retry:!1},[h.NOT_LISTING_OWNER]:{layer:4,retry:!1},[h.MARKETPLACE_PAUSED]:{layer:4,retry:!1},[h.EMPTY_METADATA]:{layer:4,retry:!1},[h.CONTRACT_ERROR]:{layer:4,retry:!1},[h.UNKNOWN]:{layer:5,retry:!1}},Mo=[{pattern:/user rejected/i,type:h.USER_REJECTED},{pattern:/user denied/i,type:h.USER_REJECTED},{pattern:/user cancel/i,type:h.USER_REJECTED},{pattern:/rejected by user/i,type:h.USER_REJECTED},{pattern:/cancelled/i,type:h.USER_REJECTED},{pattern:/canceled/i,type:h.USER_REJECTED},{pattern:/action_rejected/i,type:h.USER_REJECTED},{pattern:/too many errors/i,type:h.RPC_RATE_LIMITED},{pattern:/rate limit/i,type:h.RPC_RATE_LIMITED},{pattern:/retrying in/i,type:h.RPC_RATE_LIMITED},{pattern:/429/i,type:h.RPC_RATE_LIMITED},{pattern:/internal json-rpc/i,type:h.RPC_UNHEALTHY},{pattern:/-32603/i,type:h.RPC_UNHEALTHY},{pattern:/-32002/i,type:h.RPC_RATE_LIMITED},{pattern:/failed to fetch/i,type:h.NETWORK_ERROR},{pattern:/network error/i,type:h.NETWORK_ERROR},{pattern:/timeout/i,type:h.TX_TIMEOUT},{pattern:/insufficient funds/i,type:h.INSUFFICIENT_ETH},{pattern:/exceeds the balance/i,type:h.INSUFFICIENT_ETH},{pattern:/insufficient balance/i,type:h.INSUFFICIENT_TOKEN},{pattern:/transfer amount exceeds balance/i,type:h.INSUFFICIENT_TOKEN},{pattern:/exceeds balance/i,type:h.INSUFFICIENT_TOKEN},{pattern:/nonce/i,type:h.NONCE_ERROR},{pattern:/replacement.*underpriced/i,type:h.TX_UNDERPRICED},{pattern:/transaction underpriced/i,type:h.TX_UNDERPRICED},{pattern:/gas too low/i,type:h.TX_UNDERPRICED},{pattern:/reverted/i,type:h.TX_REVERTED},{pattern:/revert/i,type:h.TX_REVERTED},{pattern:/campaignnotfound/i,type:h.CAMPAIGN_NOT_FOUND},{pattern:/campaign not found/i,type:h.CAMPAIGN_NOT_FOUND},{pattern:/campaignnotactive/i,type:h.CAMPAIGN_NOT_ACTIVE},{pattern:/campaign.*not.*active/i,type:h.CAMPAIGN_NOT_ACTIVE},{pattern:/campaignstillactive/i,type:h.CAMPAIGN_STILL_ACTIVE},{pattern:/notcampaigncreator/i,type:h.NOT_CAMPAIGN_CREATOR},{pattern:/donationtoosmall/i,type:h.DONATION_TOO_SMALL},{pattern:/maxactivecampaignsreached/i,type:h.MAX_CAMPAIGNS_REACHED},{pattern:/insufficientethfee/i,type:h.INSUFFICIENT_ETH_FEE},{pattern:/lockperiodactive/i,type:h.LOCK_PERIOD_ACTIVE},{pattern:/lock.*period.*active/i,type:h.LOCK_PERIOD_ACTIVE},{pattern:/still.*locked/i,type:h.LOCK_PERIOD_ACTIVE},{pattern:/lockperiodexpired/i,type:h.LOCK_PERIOD_EXPIRED},{pattern:/norewardstoclaim/i,type:h.NO_REWARDS},{pattern:/no.*rewards/i,type:h.NO_REWARDS},{pattern:/invalidduration/i,type:h.INVALID_DURATION},{pattern:/invalidindex/i,type:h.INVALID_DELEGATION_INDEX},{pattern:/nftnotinpool/i,type:h.NFT_NOT_IN_POOL},{pattern:/poolnotinitialized/i,type:h.POOL_NOT_INITIALIZED},{pattern:/insufficientliquidity/i,type:h.INSUFFICIENT_POOL_LIQUIDITY},{pattern:/insufficientnfts/i,type:h.INSUFFICIENT_POOL_LIQUIDITY},{pattern:/slippageexceeded/i,type:h.SLIPPAGE_EXCEEDED},{pattern:/slippage/i,type:h.SLIPPAGE_EXCEEDED},{pattern:/nftboostmismatch/i,type:h.NFT_BOOST_MISMATCH},{pattern:/notnftowner/i,type:h.NOT_NFT_OWNER},{pattern:/noactivetiers/i,type:h.NO_ACTIVE_TIERS},{pattern:/invalidguesscount/i,type:h.INVALID_GUESS_COUNT},{pattern:/invalidguessrange/i,type:h.INVALID_GUESS_RANGE},{pattern:/insufficientservicefee/i,type:h.INSUFFICIENT_SERVICE_FEE},{pattern:/rentalstillactive/i,type:h.RENTAL_STILL_ACTIVE},{pattern:/nftnotlisted/i,type:h.NFT_NOT_LISTED},{pattern:/nftalreadylisted/i,type:h.NFT_ALREADY_LISTED},{pattern:/notlistingowner/i,type:h.NOT_LISTING_OWNER},{pattern:/marketplaceispaused/i,type:h.MARKETPLACE_PAUSED},{pattern:/emptymetadata/i,type:h.EMPTY_METADATA}],X={classify(e){var n;if(e!=null&&e.errorType&&Object.values(h).includes(e.errorType))return e.errorType;const t=this._extractMessage(e),a=(e==null?void 0:e.code)||((n=e==null?void 0:e.error)==null?void 0:n.code);if(a===4001||a==="ACTION_REJECTED")return h.USER_REJECTED;if(a===-32002)return h.RPC_RATE_LIMITED;if(a===-32603||a==="CALL_EXCEPTION"){if(t.includes("base fee")||t.includes("basefee")||t.includes("max fee per gas")||t.includes("maxfeepergas")||t.includes("underpriced")||t.includes("gas too low"))return h.TX_UNDERPRICED;if(t.includes("revert")||t.includes("require")||t.includes("execution failed")||t.includes("call_exception")||(e==null?void 0:e.code)==="CALL_EXCEPTION"){for(const{pattern:r,type:i}of Mo)if(r.test(t))return i;return h.CONTRACT_ERROR}return h.RPC_UNHEALTHY}for(const{pattern:r,type:i}of Mo)if(r.test(t))return i;return h.UNKNOWN},_extractMessage(e){var a,n,r;return e?typeof e=="string"?e:[e.message,e.reason,(a=e.error)==null?void 0:a.message,(n=e.error)==null?void 0:n.reason,(r=e.data)==null?void 0:r.message,e.shortMessage,this._safeStringify(e)].filter(Boolean).join(" ").toLowerCase():""},_safeStringify(e){try{return JSON.stringify(e,(t,a)=>typeof a=="bigint"?a.toString():a)}catch{return""}},isUserRejection(e){return this.classify(e)===h.USER_REJECTED},isRetryable(e){var a;const t=this.classify(e);return((a=At[t])==null?void 0:a.retry)||!1},getWaitTime(e){const t=this.classify(e),a=At[t];return a?a.waitMs==="extract"?this._extractWaitTime(e):a.waitMs||2e3:2e3},_extractWaitTime(e){const t=this._extractMessage(e),a=t.match(/retrying in (\d+[,.]?\d*)\s*minutes?/i);if(a){const r=parseFloat(a[1].replace(",","."));return Math.ceil(r*60*1e3)+5e3}const n=t.match(/wait (\d+)\s*seconds?/i);return n?parseInt(n[1])*1e3+2e3:3e4},getMessage(e){const t=this.classify(e);return on[t]||on[h.UNKNOWN]},getConfig(e){const t=this.classify(e);return At[t]||At[h.UNKNOWN]},getLayer(e){var a;const t=this.classify(e);return((a=At[t])==null?void 0:a.layer)||5},handle(e,t="Transaction"){const a=this.classify(e),n=At[a]||{},r=this.getMessage(e);return console.error(`[${t}] Error:`,{type:a,layer:n.layer,retry:n.retry,message:r,original:e}),{type:a,message:r,retry:n.retry||!1,waitMs:n.retry?this.getWaitTime(e):0,layer:n.layer||5,action:n.action||null,original:e,context:t}},async handleWithRpcSwitch(e,t="Transaction"){const a=this.handle(e,t);if(a.action==="switch_rpc")try{const{NetworkManager:n}=await O(async()=>{const{NetworkManager:i}=await Promise.resolve().then(()=>up);return{NetworkManager:i}},void 0);console.log("[ErrorHandler] Switching RPC due to network error...");const r=n.switchToNextRpc();try{await n.updateMetaMaskRpcs(),console.log("[ErrorHandler] MetaMask RPC updated")}catch(i){console.warn("[ErrorHandler] Could not update MetaMask:",i.message)}a.rpcSwitched=!0,a.newRpc=r,a.waitMs=Math.min(a.waitMs,2e3)}catch(n){console.warn("[ErrorHandler] Could not switch RPC:",n.message),a.rpcSwitched=!1}return a},parseSimulationError(e,t){var s;const a=this.classify(e);let n=this.getMessage(e);const i=(s={donate:{[h.CAMPAIGN_NOT_ACTIVE]:"This campaign has ended and is no longer accepting donations",[h.DONATION_TOO_SMALL]:"Minimum donation is 1 BKC"},delegate:{[h.INVALID_DURATION]:"Lock period must be between 1 day and 10 years"},playGame:{[h.INVALID_GUESS_RANGE]:"Your guess must be within the valid range for this tier"},withdraw:{[h.CAMPAIGN_STILL_ACTIVE]:"You can withdraw after the campaign deadline"},unstake:{[h.LOCK_PERIOD_ACTIVE]:"Your tokens are still locked. Use force unstake to withdraw early (penalty applies)"},claimRewards:{[h.CONTRACT_ERROR]:"No rewards available to claim",[h.NO_REWARDS]:"No rewards available to claim"}}[t])==null?void 0:s[a];return i&&(n=i),{type:a,message:n,original:e,method:t,isSimulation:!0}},create(e,t={}){const a=on[e]||"An error occurred",n=new Error(a);return n.errorType=e,n.extra=t,n},getAction(e){var a;const t=this.classify(e);return((a=At[t])==null?void 0:a.action)||null}},re={chainId:421614,chainIdHex:"0x66eee",name:"Arbitrum Sepolia",nativeCurrency:{name:"Ethereum",symbol:"ETH",decimals:18},blockExplorer:"https://sepolia.arbiscan.io"};function Ze(){const e="ZWla0YY4A0Hw7e_rwyOXB";return e?`https://arb-sepolia.g.alchemy.com/v2/${e}`:null}const sp=[{name:"Alchemy",getUrl:Ze,priority:1,isPublic:!1,isPaid:!0},{name:"Arbitrum Official",getUrl:()=>"https://sepolia-rollup.arbitrum.io/rpc",priority:2,isPublic:!0,isPaid:!1},{name:"PublicNode",getUrl:()=>"https://arbitrum-sepolia-rpc.publicnode.com",priority:3,isPublic:!0,isPaid:!1},{name:"Ankr",getUrl:()=>"https://rpc.ankr.com/arbitrum_sepolia",priority:4,isPublic:!0,isPaid:!1}];let ot=0,qt=null,Pt=null,Ja=0,Za=0,Xt=!0;const op=3,lp=3e4,cp=5e3,Do=6e4,dp=2e3,te={getCurrentRpcUrl(){const e=Ze();if(e&&Xt)return e;const t=this.getAvailableEndpoints();if(t.length===0)throw new Error("No RPC endpoints available");return t[ot%t.length].getUrl()},getPrimaryRpcUrl(){return Ze()},getAvailableEndpoints(){return sp.filter(e=>e.getUrl()!==null).sort((e,t)=>e.priority-t.priority)},getRpcUrlsForMetaMask(){const e=Ze(),t=this.getAvailableEndpoints().filter(a=>a.isPublic).map(a=>a.getUrl()).filter(Boolean);return e?[e,...t]:t},switchToNextRpc(e=!0){const t=this.getAvailableEndpoints();if(Xt&&Ze()){Xt=!1,ot=0;const r=t.find(i=>i.isPublic);if(r)return console.log(`[Network] Alchemy temporarily unavailable, using: ${r.name}`),e&&setTimeout(()=>{console.log("[Network] Retrying Alchemy..."),Xt=!0,ot=0},dp),r.getUrl()}const a=t.filter(r=>r.isPublic);if(a.length<=1)return console.warn("[Network] No alternative RPCs available"),this.getCurrentRpcUrl();ot=(ot+1)%a.length;const n=a[ot];return console.log(`[Network] Switched to RPC: ${n.name}`),n.getUrl()},resetToAlchemy(){Ze()&&(Xt=!0,ot=0,console.log("[Network] Reset to Alchemy RPC"))},isRateLimitError(e){var n;const t=((n=e==null?void 0:e.message)==null?void 0:n.toLowerCase())||"",a=e==null?void 0:e.code;return a===-32002||a===-32005||t.includes("rate limit")||t.includes("too many")||t.includes("exceeded")||t.includes("throttled")||t.includes("429")},async handleRateLimit(e){const t=this.getCurrentRpcUrl(),a=Ze();if(a&&t===a)return console.warn("[Network] Alchemy rate limited (check your plan limits)"),await new Promise(s=>setTimeout(s,1e3)),a;console.warn("[Network] Public RPC rate limited, switching...");const r=this.switchToNextRpc(),i=Date.now();if(i-Za>Do)try{await this.updateMetaMaskRpcs(),Za=i}catch(s){console.warn("[Network] Could not update MetaMask:",s.message)}return r},async getWorkingProvider(){const e=window.ethers,t=Ze();if(t)try{const n=new e.JsonRpcProvider(t);return await Promise.race([n.getBlockNumber(),new Promise((r,i)=>setTimeout(()=>i(new Error("timeout")),3e3))]),Xt=!0,n}catch(n){console.warn("[Network] Alchemy temporarily unavailable:",n.message)}const a=this.getAvailableEndpoints().filter(n=>n.isPublic);for(const n of a)try{const r=n.getUrl(),i=new e.JsonRpcProvider(r);return await Promise.race([i.getBlockNumber(),new Promise((s,o)=>setTimeout(()=>o(new Error("timeout")),3e3))]),console.log(`[Network] Using fallback RPC: ${n.name}`),i}catch{console.warn(`[Network] RPC ${n.name} failed, trying next...`)}if(t)return new e.JsonRpcProvider(t);throw new Error("No working RPC endpoints available")},async isCorrectNetwork(){if(!window.ethereum)return!1;try{const e=await window.ethereum.request({method:"eth_chainId"});return parseInt(e,16)===re.chainId}catch(e){return console.error("[Network] Error checking network:",e),!1}},async getCurrentChainId(){if(!window.ethereum)return null;try{const e=await window.ethereum.request({method:"eth_chainId"});return parseInt(e,16)}catch{return null}},async checkRpcHealth(){const e=Date.now(),t=this.getCurrentRpcUrl();try{const a=new AbortController,n=setTimeout(()=>a.abort(),cp),r=await fetch(t,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({jsonrpc:"2.0",method:"eth_blockNumber",params:[],id:1}),signal:a.signal});if(clearTimeout(n),!r.ok)throw new Error(`HTTP ${r.status}`);const i=await r.json();if(i.error)throw new Error(i.error.message||"RPC error");const s=Date.now()-e;return Ja=0,Pt={healthy:!0,latency:s,blockNumber:parseInt(i.result,16),timestamp:Date.now()},Pt}catch(a){Ja++;const n={healthy:!1,latency:Date.now()-e,error:a.message,timestamp:Date.now()};return Pt=n,Ja>=op&&(console.warn("[Network] Too many RPC failures, switching..."),this.switchToNextRpc(),Ja=0),n}},getLastHealthCheck(){return Pt},async isRpcHealthy(e=1e4){return Pt&&Date.now()-Pt.timestamp<e?Pt.healthy:(await this.checkRpcHealth()).healthy},async switchNetwork(){if(!window.ethereum)throw X.create(h.WALLET_NOT_CONNECTED);try{return await window.ethereum.request({method:"wallet_switchEthereumChain",params:[{chainId:re.chainIdHex}]}),console.log("[Network] Switched to",re.name),!0}catch(e){if(e.code===4902)return await this.addNetwork();throw e.code===4001?X.create(h.USER_REJECTED):e}},async addNetwork(){if(!window.ethereum)throw X.create(h.WALLET_NOT_CONNECTED);const e=this.getRpcUrlsForMetaMask();try{return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:re.chainIdHex,chainName:re.name,nativeCurrency:re.nativeCurrency,rpcUrls:e,blockExplorerUrls:[re.blockExplorer]}]}),console.log("[Network] Added network:",re.name),!0}catch(t){throw t.code===4001?X.create(h.USER_REJECTED):t}},async updateMetaMaskRpcs(){if(!window.ethereum)return!1;const e=Date.now();if(e-Za<Do)return console.log("[Network] MetaMask update on cooldown, skipping..."),!1;if(!await this.isCorrectNetwork())return console.log("[Network] Not on correct network, skipping RPC update"),!1;const a=this.getRpcUrlsForMetaMask();try{return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:re.chainIdHex,chainName:re.name,nativeCurrency:re.nativeCurrency,rpcUrls:a,blockExplorerUrls:[re.blockExplorer]}]}),Za=e,console.log("[Network] MetaMask RPCs updated with:",a[0]),!0}catch(n){return console.warn("[Network] Could not update MetaMask RPCs:",n.message),!1}},async forceResetMetaMaskRpc(){if(!window.ethereum)return!1;const e=Ze();if(!e)return console.warn("[Network] Alchemy not configured"),!1;try{try{await window.ethereum.request({method:"wallet_switchEthereumChain",params:[{chainId:"0x1"}]})}catch{}return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:re.chainIdHex,chainName:re.name+" (Alchemy)",nativeCurrency:re.nativeCurrency,rpcUrls:[e],blockExplorerUrls:[re.blockExplorer]}]}),console.log("[Network] MetaMask reset to Alchemy RPC"),!0}catch(t){return console.error("[Network] Failed to reset MetaMask:",t.message),!1}},getProvider(){const e=window.ethers;if(!e)throw new Error("ethers.js not loaded");return new e.JsonRpcProvider(this.getCurrentRpcUrl())},getBrowserProvider(){const e=window.ethers;if(!e)throw new Error("ethers.js not loaded");if(!window.ethereum)throw X.create(h.WALLET_NOT_CONNECTED);return new e.BrowserProvider(window.ethereum)},async getSigner(){var t,a;const e=this.getBrowserProvider();try{return await e.getSigner()}catch(n){if((t=n.message)!=null&&t.includes("ENS")||n.code==="UNSUPPORTED_OPERATION")try{const r=await window.ethereum.request({method:"eth_accounts"});if(r&&r.length>0)return await e.getSigner(r[0])}catch(r){console.warn("Signer fallback failed:",r)}throw n.code===4001||(a=n.message)!=null&&a.includes("user rejected")?X.create(h.USER_REJECTED):X.create(h.WALLET_NOT_CONNECTED)}},async getConnectedAddress(){if(!window.ethereum)return null;try{return(await window.ethereum.request({method:"eth_accounts"}))[0]||null}catch{return null}},async requestConnection(){if(!window.ethereum)throw X.create(h.WALLET_NOT_CONNECTED);try{const e=await window.ethereum.request({method:"eth_requestAccounts"});if(!e||e.length===0)throw X.create(h.WALLET_NOT_CONNECTED);return e[0]}catch(e){throw e.code===4001?X.create(h.USER_REJECTED):e}},startHealthMonitoring(e=lp){qt&&this.stopHealthMonitoring(),this.checkRpcHealth(),qt=setInterval(()=>{this.checkRpcHealth()},e),console.log("[Network] Health monitoring started")},stopHealthMonitoring(){qt&&(clearInterval(qt),qt=null,console.log("[Network] Health monitoring stopped"))},isMonitoring(){return qt!==null},formatAddress(e,t=4){return e?`${e.slice(0,t+2)}...${e.slice(-t)}`:""},getAddressExplorerUrl(e){return`${re.blockExplorer}/address/${e}`},getTxExplorerUrl(e){return`${re.blockExplorer}/tx/${e}`},isMetaMaskInstalled(){return typeof window.ethereum<"u"&&window.ethereum.isMetaMask},async getStatus(){var n;const[e,t,a]=await Promise.all([this.isCorrectNetwork(),this.getConnectedAddress(),this.checkRpcHealth()]);return{isConnected:!!t,address:t,isCorrectNetwork:e,currentChainId:await this.getCurrentChainId(),targetChainId:re.chainId,rpcHealthy:a.healthy,rpcLatency:a.latency,currentRpc:((n=this.getAvailableEndpoints()[ot])==null?void 0:n.name)||"Unknown"}}},up=Object.freeze(Object.defineProperty({__proto__:null,NETWORK_CONFIG:re,NetworkManager:te},Symbol.toStringTag,{value:"Module"})),qe={SAFETY_MARGIN_PERCENT:20,MIN_GAS_LIMITS:{transfer:21000n,erc20Transfer:65000n,erc20Approve:50000n,contractCall:100000n,complexCall:300000n},MAX_GAS_LIMIT:15000000n,MIN_GAS_PRICE_GWEI:.01,MAX_GAS_PRICE_GWEI:100,GAS_PRICE_CACHE_TTL:15e3},uc={async estimateGas(e,t,a=[],n={}){try{return await e[t].estimateGas(...a,n)}catch(r){throw r}},async estimateGasWithMargin(e,t,a=[],n={}){const r=await this.estimateGas(e,t,a,n);return this.addSafetyMargin(r)},addSafetyMargin(e,t=qe.SAFETY_MARGIN_PERCENT){const a=BigInt(e),n=a*BigInt(t)/100n;let r=a+n;return r>qe.MAX_GAS_LIMIT&&(console.warn("[Gas] Estimate exceeds max limit, capping"),r=qe.MAX_GAS_LIMIT),r},getMinGasLimit(e="contractCall"){return qe.MIN_GAS_LIMITS[e]||qe.MIN_GAS_LIMITS.contractCall},async getGasPrice(){return await bt.getOrFetch("gas-price-current",async()=>(await te.getProvider().getFeeData()).gasPrice||0n,qe.GAS_PRICE_CACHE_TTL)},async getFeeData(){return await bt.getOrFetch("gas-fee-data",async()=>{const a=await te.getProvider().getFeeData();return{gasPrice:a.gasPrice||0n,maxFeePerGas:a.maxFeePerGas||0n,maxPriorityFeePerGas:a.maxPriorityFeePerGas||0n}},qe.GAS_PRICE_CACHE_TTL)},async getGasPriceGwei(){const e=window.ethers,t=await this.getGasPrice();return parseFloat(e.formatUnits(t,"gwei"))},async calculateCost(e,t=null){const a=window.ethers;t||(t=await this.getGasPrice());const n=BigInt(e)*BigInt(t),r=a.formatEther(n);return{wei:n,eth:parseFloat(r),formatted:this.formatEth(r)}},async estimateTransactionCost(e,t,a=[],n={}){const r=await this.estimateGas(e,t,a,n),i=this.addSafetyMargin(r),s=await this.getGasPrice(),o=await this.calculateCost(i,s);return{gasEstimate:r,gasWithMargin:i,gasPrice:s,...o}},async validateGasBalance(e,t,a=null){const n=window.ethers,r=te.getProvider();a||(a=await this.getGasPrice());const i=await r.getBalance(e),s=BigInt(t)*BigInt(a),o=i>=s;return{sufficient:o,balance:i,required:s,shortage:o?0n:s-i,balanceFormatted:n.formatEther(i),requiredFormatted:n.formatEther(s)}},async hasMinimumGas(e,t=null){const a=window.ethers,r=await te.getProvider().getBalance(e),i=t||a.parseEther("0.001");return r>=i},formatEth(e,t=6){const a=parseFloat(e);return a===0?"0 ETH":a<1e-6?"< 0.000001 ETH":`${a.toFixed(t).replace(/\.?0+$/,"")} ETH`},formatGasPrice(e){const t=window.ethers,a=parseFloat(t.formatUnits(e,"gwei"));return a<.01?"< 0.01 gwei":a<1?`${a.toFixed(2)} gwei`:`${a.toFixed(1)} gwei`},formatGasLimit(e){return Number(e).toLocaleString()},formatGasSummary(e){return`~${e.formatted} (${this.formatGasLimit(e.gasWithMargin||0n)} gas)`},compareEstimates(e,t){const a=BigInt(e),n=BigInt(t);if(n===0n)return 0;const r=a>n?a-n:n-a;return Number(r*100n/n)},isGasPriceReasonable(e){const t=window.ethers,a=parseFloat(t.formatUnits(e,"gwei"));return a<qe.MIN_GAS_PRICE_GWEI?{reasonable:!1,warning:"Gas price unusually low, transaction may be slow"}:a>qe.MAX_GAS_PRICE_GWEI?{reasonable:!1,warning:"Gas price unusually high, consider waiting"}:{reasonable:!0,warning:null}},async getRecommendedSettings(e){const t=await this.getFeeData();return{gasLimit:this.addSafetyMargin(e),maxFeePerGas:t.maxFeePerGas,maxPriorityFeePerGas:t.maxPriorityFeePerGas}},async createTxOverrides(e,t={}){return{gasLimit:(await this.getRecommendedSettings(e)).gasLimit,...t}}},Oo=500000000000000n,Ho=["function balanceOf(address owner) view returns (uint256)","function allowance(address owner, address spender) view returns (uint256)","function decimals() view returns (uint8)","function symbol() view returns (string)"],ee={async validateNetwork(){if(!await te.isCorrectNetwork()){const t=await te.getCurrentChainId();throw X.create(h.WRONG_NETWORK,{currentChainId:t,expectedChainId:re.chainId})}},async validateRpcHealth(){const e=await te.checkRpcHealth();if(!e.healthy&&(te.switchToNextRpc(),!(await te.checkRpcHealth()).healthy))throw X.create(h.RPC_UNHEALTHY,{error:e.error})},async validateWalletConnected(e=null){if(!window.ethereum)throw X.create(h.WALLET_NOT_CONNECTED);const t=e||await te.getConnectedAddress();if(!t)throw X.create(h.WALLET_NOT_CONNECTED);return t},async validatePreTransaction(){return await this.validateNetwork(),await this.validateRpcHealth(),await this.validateWalletConnected()},async validateEthForGas(e,t=Oo){const a=window.ethers,n=sn.ethBalance(e),r=await bt.getOrFetch(n,async()=>await te.getProvider().getBalance(e),rn.BALANCE);if(r<t)throw X.create(h.INSUFFICIENT_ETH,{balance:a.formatEther(r),required:a.formatEther(t)});return r},async validateTokenBalance(e,t,a){const n=window.ethers,r=sn.tokenBalance(e,a),i=await bt.getOrFetch(r,async()=>{const s=te.getProvider();return await new n.Contract(e,Ho,s).balanceOf(a)},rn.BALANCE);if(i<t)throw X.create(h.INSUFFICIENT_TOKEN,{balance:n.formatEther(i),required:n.formatEther(t)});return i},async needsApproval(e,t,a,n){const r=window.ethers,i=sn.allowance(e,n,t);return await bt.getOrFetch(i,async()=>{const o=te.getProvider();return await new r.Contract(e,Ho,o).allowance(n,t)},rn.ALLOWANCE)<a},async validateAllowance(e,t,a,n){if(await this.needsApproval(e,t,a,n))throw X.create(h.INSUFFICIENT_ALLOWANCE,{token:e,spender:t,required:a.toString()})},async validateBalances({userAddress:e,tokenAddress:t=null,tokenAmount:a=null,spenderAddress:n=null,ethAmount:r=Oo}){await this.validateEthForGas(e,r),t&&a&&await this.validateTokenBalance(t,a,e)},validatePositive(e,t="Amount"){if(BigInt(e)<=0n)throw new Error(`${t} must be greater than zero`)},validateRange(e,t,a,n="Value"){const r=BigInt(e),i=BigInt(t),s=BigInt(a);if(r<i||r>s)throw new Error(`${n} must be between ${t} and ${a}`)},validateNotEmpty(e,t="Field"){if(!e||e.trim().length===0)throw new Error(`${t} cannot be empty`)},validateAddress(e,t="Address"){const a=window.ethers;if(!e||!a.isAddress(e))throw new Error(`Invalid ${t}`)},charity:{validateCreateCampaign({title:e,description:t,goalAmount:a,durationDays:n}){ee.validateNotEmpty(e,"Title"),ee.validateNotEmpty(t,"Description"),ee.validatePositive(a,"Goal amount"),ee.validateRange(n,1,180,"Duration")},validateDonate({campaignId:e,amount:t}){if(e==null)throw new Error("Campaign ID is required");ee.validatePositive(t,"Donation amount")}},staking:{validateDelegate({amount:e,lockDays:t}){ee.validatePositive(e,"Stake amount"),ee.validateRange(t,1,3650,"Lock duration")},validateUnstake({delegationIndex:e}){if(e==null||e<0)throw new Error("Invalid delegation index")}},nftPool:{validateBuy({maxPrice:e}){e!=null&&ee.validatePositive(e,"Max price")},validateSell({tokenId:e,minPayout:t}){if(e==null)throw new Error("Token ID is required");t!=null&&ee.validatePositive(t,"Min payout")}},fortune:{validatePlay({wagerAmount:e,guesses:t,isCumulative:a}){if(ee.validatePositive(e,"Wager amount"),!Array.isArray(t)||t.length===0)throw new Error("At least one guess is required");t.forEach((n,r)=>{if(typeof n!="number"||n<1)throw new Error(`Invalid guess at position ${r+1}`)})}},rental:{validateList({tokenId:e,pricePerHour:t,minHours:a,maxHours:n}){if(e==null)throw new Error("Token ID is required");ee.validatePositive(t,"Price per hour"),ee.validateRange(a,1,720,"Minimum hours"),ee.validateRange(n,a,720,"Maximum hours")},validateRent({tokenId:e,hours:t}){if(e==null)throw new Error("Token ID is required");ee.validatePositive(t,"Rental hours")}},notary:{validateNotarize({ipfsCid:e,description:t,contentHash:a}){if(ee.validateNotEmpty(e,"IPFS CID"),a&&(a.startsWith("0x")?a.slice(2):a).length!==64)throw new Error("Content hash must be 32 bytes")}}},Qa={DEFAULT_MAX_RETRIES:2,RETRY_BASE_DELAY:2e3,APPROVAL_MULTIPLIER:10n,APPROVAL_WAIT_TIME:1500,CONFIRMATION_TIMEOUT:6e4,CONFIRMATION_RETRY_DELAY:3e3,GAS_SAFETY_MARGIN:20,DEFAULT_GAS_LIMIT:500000n},Uo=["function approve(address spender, uint256 amount) returns (bool)","function allowance(address owner, address spender) view returns (uint256)"];class pc{constructor(t,a,n=!0){this.button=t,this.txName=a,this.showToasts=n,this.originalContent=null,this.originalDisabled=!1,this.button&&(this.originalContent=this.button.innerHTML,this.originalDisabled=this.button.disabled)}setPhase(t){if(!this.button)return;const n={validating:{text:"Validating...",icon:"🔍"},approving:{text:"Approving...",icon:"✅"},simulating:{text:"Simulating...",icon:"🧪"},confirming:{text:"Confirm in Wallet",icon:"👛"},waiting:{text:"Processing...",icon:"⏳"},success:{text:"Success!",icon:"🎉"},error:{text:"Failed",icon:"❌"}}[t]||{text:t,icon:"⏳"};this.button.disabled=!0,this.button.innerHTML=`
        ...
        `)}cleanup(){this.button&&(this.button.innerHTML=this.originalContent,this.button.disabled=this.originalDisabled)}showSuccess(t=2e3){this.setPhase("success"),setTimeout(()=>this.cleanup(),t)}showError(t=2e3){this.setPhase("error"),setTimeout(()=>this.cleanup(),t)}}class mc{constructor(){this.pendingTxIds=new Set}_resolveArgs(t){return typeof t=="function"?t():t||[]}_resolveApproval(t){return t?typeof t=="object"?{token:t.token,spender:t.spender,amount:t.amount}:t:null}_validateContractMethod(t,a){if(!t)throw new Error("Contract instance is null or undefined");if(typeof t[a]!="function"){const n=Object.keys(t).filter(r=>typeof t[r]=="function").filter(r=>!r.startsWith("_")&&!["on","once","emit","removeListener"].includes(r)).slice(0,15);throw console.error(`[TX] Contract method "${a}" not found!`),console.error("[TX] Available methods:",n),new Error(`Contract method "${a}" not found. This usually means the ABI doesn't match the contract. Available methods: ${n.join(", ")}`)}return typeof t[a].estimateGas!="function"&&console.warn(`[TX] Method ${a} exists but estimateGas is not available`),!0}async execute(t){var S,_;const{name:a,txId:n=null,button:r=null,showToasts:i=!0,getContract:s,method:o,args:l=[],approval:d=null,validate:u=null,onSuccess:m=null,onError:p=null,maxRetries:b=Qa.DEFAULT_MAX_RETRIES,invalidateCache:f=!0,skipSimulation:w=!1,fixedGasLimit:k=Qa.DEFAULT_GAS_LIMIT}=t,C=n||`${a}-${Date.now()}-${Math.random().toString(36).substr(2,9)}`;if(this.pendingTxIds.has(C))return console.warn(`[TX] Transaction ${C} already in progress`),{success:!1,reason:"DUPLICATE_TX",message:"Transaction already in progress"};this.pendingTxIds.add(C);const P=new pc(r,a,i);try{P.setPhase("validating"),console.log(`[TX] Starting: ${a}`),await ee.validateNetwork(),await ee.validateRpcHealth();const B=await ee.validateWalletConnected();console.log(`[TX] User address: ${B}`);const I=await te.getSigner();console.log("[TX] Signer obtained");try{await ee.validateEthForGas(B)}catch(Z){console.warn("[TX] ETH gas validation failed, continuing anyway:",Z.message)}const N=this._resolveApproval(d);N&&N.amount>0n&&await ee.validateTokenBalance(N.token,N.amount,B),u&&(console.log("[TX] Running custom validation..."),await u(I,B));const F=this._resolveApproval(t.approval);F&&F.amount>0n&&await ee.needsApproval(F.token,F.spender,F.amount,B)&&(P.setPhase("approving"),console.log("[TX] Requesting token approval..."),await this._executeApproval(F,I,B),bt.clear("allowance-")),console.log("[TX] Getting contract instance...");const ne=await s(I);this._validateContractMethod(ne,o),console.log(`[TX] Contract method "${o}" validated`);const V=t.value;V&&console.log("[TX] Transaction value (ETH):",V.toString());const he=V?{value:V}:{},ce=this._resolveArgs(l);console.log("[TX] Args resolved:",ce.map(Z=>typeof Z=="bigint"?Z.toString():typeof Z=="string"&&Z.length>50?Z.substring(0,50)+"...":Z));let Y;if(w)console.log(`[TX] Skipping simulation, using fixed gas limit: ${k}`),Y=k;else{P.setPhase("simulating"),console.log("[TX] Simulating transaction...");try{const Z=te.getProvider(),Le=await ne.getAddress(),gr=new ethers.Contract(Le,ne.interface,Z);if(!gr[o]||typeof gr[o].estimateGas!="function")throw new Error(`estimateGas not available for method "${o}"`);Y=await gr[o].estimateGas(...ce,{...he,from:B}),console.log(`[TX] Gas estimate: ${Y.toString()}`)}catch(Z){if(console.error("[TX] Simulation failed:",Z.message),(S=Z.message)!=null&&S.includes("not found")||(_=Z.message)!=null&&_.includes("undefined"))throw new Error(`Contract method "${o}" is not callable. Check that the ABI matches the deployed contract.`);const Le=X.parseSimulationError(Z,o);throw X.create(Le.type,{message:Le.message,original:Z})}}P.setPhase("confirming"),console.log("[TX] Requesting signature...");const ie=uc.addSafetyMargin(Y),$e={...he,gasLimit:ie};try{const Le=await te.getProvider().getFeeData();Le.maxFeePerGas&&($e.maxFeePerGas=Le.maxFeePerGas*120n/100n,$e.maxPriorityFeePerGas=Le.maxPriorityFeePerGas||0n)}catch{}const It=this._resolveArgs(l),st=await this._executeWithRetry(()=>ne[o](...It,$e),{maxRetries:b,ui:P,signer:I,name:a});console.log(`[TX] Transaction submitted: ${st.hash}`),P.setPhase("waiting"),console.log("[TX] Waiting for confirmation...");const Oe=await this._waitForConfirmation(st,I.provider);if(console.log(`[TX] Confirmed in block ${Oe.blockNumber}`),P.showSuccess(),f&&bt.invalidateByTx(a),m)try{await m(Oe)}catch(Z){console.warn("[TX] onSuccess callback error:",Z)}return{success:!0,receipt:Oe,txHash:Oe.hash||st.hash,blockNumber:Oe.blockNumber}}catch(B){console.error("[TX] Error:",(B==null?void 0:B.message)||B),r&&(console.log("[TX] Restoring button..."),r.disabled=!1,P.originalContent&&(r.innerHTML=P.originalContent));let I;try{I=await X.handleWithRpcSwitch(B,a),I.rpcSwitched&&console.log(`[TX] RPC switched to: ${I.newRpc}`)}catch(N){console.warn("[TX] Error in handleWithRpcSwitch:",N),I=X.handle(B,a)}if(I.type!==h.USER_REJECTED&&r&&!p){const N=P.originalContent;r.innerHTML='<span style="display:flex;align-items:center;justify-content:center;gap:8px"><span>❌</span><span>Failed</span></span>',setTimeout(()=>{r&&(r.innerHTML=N)},1500)}if(p)try{p(I)}catch(N){console.warn("[TX] onError callback error:",N)}return{success:!1,error:I,message:I.message,cancelled:I.type===h.USER_REJECTED}}finally{this.pendingTxIds.delete(C),setTimeout(()=>{r&&r.disabled&&(console.log("[TX] Safety cleanup triggered"),P.cleanup())},5e3)}}async _executeApproval(t,a,n){const r=window.ethers,{token:i,spender:s,amount:o}=t;console.log(`[TX] Approving ${r.formatEther(o)} tokens...`);const l=new r.Contract(i,Uo,a),d=o*Qa.APPROVAL_MULTIPLIER;try{let u={gasLimit:100000n};try{const C=await te.getProvider().getFeeData();C.maxFeePerGas&&(u.maxFeePerGas=C.maxFeePerGas*120n/100n,u.maxPriorityFeePerGas=C.maxPriorityFeePerGas||0n)}catch{}const m=await l.approve(s,d,u),p=te.getProvider();let b=null;for(let k=0;k<30&&(await new Promise(C=>setTimeout(C,1500)),b=await p.getTransactionReceipt(m.hash),!b);k++);if(b||(b=await m.wait()),b.status===0)throw new Error("Approval transaction reverted");if(console.log("[TX] Approval confirmed"),await new Promise(k=>setTimeout(k,Qa.APPROVAL_WAIT_TIME)),await new r.Contract(i,Uo,p).allowance(n,s)<o)throw new Error("Approval not reflected on-chain")}catch(u){throw X.isUserRejection(u)?X.create(h.USER_REJECTED):u}}async _executeWithRetry(t,{maxRetries:a,ui:n,signer:r,name:i}){let s;for(let o=1;o<=a+1;o++)try{return o>1&&(n.setRetry(o,a+1),console.log(`[TX] Retry ${o}/${a+1}`),(await te.checkRpcHealth()).healthy||(console.log("[TX] RPC unhealthy, switching..."),te.switchToNextRpc(),await new Promise(d=>setTimeout(d,2e3)))),await t()}catch(l){if(s=l,X.isUserRejection(l)||!X.isRetryable(l)||o===a+1)throw l;const d=X.getWaitTime(l);console.log(`[TX] Waiting ${d}ms before retry...`),await new Promise(u=>setTimeout(u,d))}throw s}async _waitForConfirmation(t,a){const n=te.getProvider();for(let r=0;r<30;r++){await new Promise(i=>setTimeout(i,1500));try{const i=await n.getTransactionReceipt(t.hash);if(i&&i.status===1)return console.log("[TX] Confirmed via Alchemy"),i;if(i&&i.status===0)throw new Error("Transaction reverted on-chain")}catch(i){if(i.message==="Transaction reverted on-chain")throw i}}return console.warn("[TX] Could not verify receipt after 45s, assuming success"),{hash:t.hash,status:1,blockNumber:0}}isPending(t){return this.pendingTxIds.has(t)}getPendingCount(){return this.pendingTxIds.size}clearPending(){this.pendingTxIds.clear()}}const j=new mc,Hn="bkc_operator",Gt="0x0000000000000000000000000000000000000000";function Un(){var t;const e=window.ethers;try{const a=localStorage.getItem(Hn);if(a&&We(a))return Mt(a);if(window.BACKCHAIN_OPERATOR&&We(window.BACKCHAIN_OPERATOR))return Mt(window.BACKCHAIN_OPERATOR);if((t=window.addresses)!=null&&t.operator&&We(window.addresses.operator))return Mt(window.addresses.operator)}catch(a){console.warn("[Operator] Error getting operator:",a)}return(e==null?void 0:e.ZeroAddress)||Gt}function Q(e){const t=window.ethers,a=(t==null?void 0:t.ZeroAddress)||Gt;return e===null?a:e&&We(e)?Mt(e):Un()}function fc(e){if(!e)return di(),!0;if(!We(e))return console.warn("[Operator] Invalid address:",e),!1;try{const t=Mt(e);return localStorage.setItem(Hn,t),window.BACKCHAIN_OPERATOR=t,window.dispatchEvent(new CustomEvent("operatorChanged",{detail:{address:t}})),console.log("[Operator] Set to:",t),!0}catch(t){return console.error("[Operator] Error setting:",t),!1}}function di(){try{localStorage.removeItem(Hn),delete window.BACKCHAIN_OPERATOR,window.dispatchEvent(new CustomEvent("operatorChanged",{detail:{address:null}})),console.log("[Operator] Cleared")}catch(e){console.warn("[Operator] Error clearing:",e)}}function bc(){const e=window.ethers,t=(e==null?void 0:e.ZeroAddress)||Gt,a=Un();return a&&a!==t}function gc(){var n;const e=window.ethers,t=(e==null?void 0:e.ZeroAddress)||Gt,a=localStorage.getItem(Hn);return a&&We(a)?{address:a,source:"localStorage",isSet:!0}:window.BACKCHAIN_OPERATOR&&We(window.BACKCHAIN_OPERATOR)?{address:window.BACKCHAIN_OPERATOR,source:"global",isSet:!0}:(n=window.addresses)!=null&&n.operator&&We(window.addresses.operator)?{address:window.addresses.operator,source:"config",isSet:!0}:{address:t,source:"none",isSet:!1}}function We(e){const t=window.ethers;return!e||typeof e!="string"||!e.match(/^0x[a-fA-F0-9]{40}$/)?!1:t!=null&&t.isAddress?t.isAddress(e):!0}function Mt(e){const t=window.ethers;if(!e)return(t==null?void 0:t.ZeroAddress)||Gt;try{if(t!=null&&t.getAddress)return t.getAddress(e)}catch{}return e}function xc(e){const t=window.ethers,a=(t==null?void 0:t.ZeroAddress)||Gt;return!e||e===a?"None":`${e.slice(0,6)}...${e.slice(-4)}`}const pp={get:Un,set:fc,clear:di,has:bc,resolve:Q,info:gc,isValid:We,normalize:Mt,short:xc,ZERO:Gt};window.Operator=pp;const mp=["function getFeeConfig(bytes32 _actionId) view returns (uint8 feeType, uint16 bps, uint16 multiplier, uint32 gasEstimate)"],jo=10000n;async function ye(e,t=0n){try{const a=window.ethers,n=te.getProvider(),r=(v==null?void 0:v.backchainEcosystem)||(M==null?void 0:M.backchainEcosystem);if(!r)return console.warn("[FeeCalc] Ecosystem address not available"),0n;const s=await new a.Contract(r,mp,n).getFeeConfig(e),o=BigInt(s.bps);if(o===0n)return 0n;if(Number(s.feeType)===0){const l=await n.getFeeData(),d=l.gasPrice||l.maxFeePerGas||100000000n,u=d*150n/100n,m=BigInt(s.gasEstimate)*u*o*BigInt(s.multiplier)/jo;return console.log(`[FeeCalc] Gas-based: ${a.formatEther(m)} ETH (gasEst=${s.gasEstimate}, gasPrice=${d}→${u} +50%, bps=${o}, mult=${s.multiplier})`),m}else{const l=t*o/jo;return console.log(`[FeeCalc] Value-based: ${a.formatEther(l)} ETH`),l}}catch(a){return console.error("[FeeCalc] Error:",a.message),0n}}const J=Object.freeze(Object.defineProperty({__proto__:null,CacheKeys:sn,CacheManager:bt,CacheTTL:rn,ErrorHandler:X,ErrorMessages:on,ErrorTypes:h,GasManager:uc,NETWORK_CONFIG:re,NetworkManager:te,TransactionEngine:mc,TransactionUI:pc,ValidationLayer:ee,calculateFeeClientSide:ye,clearOperator:di,getOperator:Un,getOperatorInfo:gc,hasOperator:bc,isValidAddress:We,normalizeAddress:Mt,resolveOperator:Q,setOperator:fc,shortAddress:xc,txEngine:j},Symbol.toStringTag,{value:"Module"}));function hc(){var t;const e=(v==null?void 0:v.charityPool)||(M==null?void 0:M.charityPool)||((t=window.contractAddresses)==null?void 0:t.charityPool);if(!e)throw console.error("❌ CharityPool address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{CHARITY_POOL:e}}const Ra=["function createCampaign(string calldata title, string calldata metadataUri, uint96 goal, uint256 durationDays, address operator) external payable returns (uint256 campaignId)","function donate(uint256 campaignId, address operator) external payable","function boostCampaign(uint256 campaignId, address operator) external payable","function closeCampaign(uint256 campaignId) external","function withdraw(uint256 campaignId) external","function getCampaign(uint256 campaignId) view returns (address owner, uint48 deadline, uint8 status, uint96 raised, uint96 goal, uint32 donorCount, bool isBoosted, string memory title, string memory metadataUri)","function canWithdraw(uint256 campaignId) view returns (bool)","function previewDonation(uint256 amount) view returns (uint256 fee, uint256 netToCampaign)","function campaignCount() view returns (uint256)","function getStats() view returns (uint256 campaignCount, uint256 totalDonated, uint256 totalWithdrawn, uint256 totalEthFees)","function version() view returns (string)","event CampaignCreated(uint256 indexed campaignId, address indexed creator, uint96 goal, uint48 deadline, address operator)","event DonationMade(uint256 indexed campaignId, address indexed donor, uint256 grossAmount, uint256 netDonation, address operator)","event CampaignBoosted(uint256 indexed campaignId, address indexed booster, uint48 boostExpiry, address operator)","event CampaignClosed(uint256 indexed campaignId, address indexed creator, uint96 raised)","event FundsWithdrawn(uint256 indexed campaignId, address indexed creator, uint96 amount)"],da={ACTIVE:0,CLOSED:1,WITHDRAWN:2};function _a(e){const t=window.ethers,a=hc();return new t.Contract(a.CHARITY_POOL,Ra,e)}async function Ve(){const e=window.ethers,{NetworkManager:t}=await O(async()=>{const{NetworkManager:r}=await Promise.resolve().then(()=>J);return{NetworkManager:r}},void 0),a=t.getProvider(),n=hc();return new e.Contract(n.CHARITY_POOL,Ra,a)}async function ui({title:e,metadataUri:t="",description:a,goalAmount:n,durationDays:r,operator:i,button:s=null,onSuccess:o=null,onError:l=null}){const d=window.ethers;if(!e||e.trim().length===0)throw new Error("Title is required");if(e.length>100)throw new Error("Title must be 100 characters or less");if(r<1||r>365)throw new Error("Duration must be between 1 and 365 days");const u=BigInt(n);if(u<=0n)throw new Error("Goal amount must be greater than 0");const m=t||a||"";let p=i,b=0n;return await j.execute({name:"CreateCampaign",button:s,getContract:async f=>_a(f),method:"createCampaign",args:()=>[e,m,u,BigInt(r),Q(p)],get value(){return b},validate:async(f,w)=>{await Ve();try{const{NetworkManager:k}=await O(async()=>{const{NetworkManager:S}=await Promise.resolve().then(()=>J);return{NetworkManager:S}},void 0),C=k.getProvider();if(b=d.parseEther("0.0001"),await C.getBalance(w)<b+d.parseEther("0.001"))throw new Error("Insufficient ETH for creation fee + gas")}catch(k){if(k.message.includes("Insufficient"))throw k}},onSuccess:async f=>{let w=null;try{const k=new d.Interface(Ra);for(const C of f.logs)try{const P=k.parseLog(C);if(P.name==="CampaignCreated"){w=Number(P.args.campaignId);break}}catch{}}catch{}o&&o(f,w)},onError:l})}async function pi({campaignId:e,amount:t,operator:a,button:n=null,onSuccess:r=null,onError:i=null}){const s=window.ethers;if(e==null)throw new Error("Campaign ID is required");const o=BigInt(t);if(o<=0n)throw new Error("Donation amount must be greater than 0");let l=e,d=a;return await j.execute({name:"Donate",button:n,getContract:async u=>_a(u),method:"donate",args:()=>[l,Q(d)],value:o,validate:async(u,m)=>{const b=await(await Ve()).getCampaign(l);if(b.owner===s.ZeroAddress)throw new Error("Campaign not found");if(Number(b.status)!==da.ACTIVE)throw new Error("Campaign is not active");const f=Math.floor(Date.now()/1e3);if(Number(b.deadline)<=f)throw new Error("Campaign has ended")},onSuccess:async u=>{let m=null;try{const p=new s.Interface(Ra);for(const b of u.logs)try{const f=p.parseLog(b);if(f.name==="DonationMade"){m={grossAmount:f.args.grossAmount,netDonation:f.args.netDonation};break}}catch{}}catch{}r&&r(u,m)},onError:i})}async function jn({campaignId:e,button:t=null,onSuccess:a=null,onError:n=null}){const r=window.ethers;if(e==null)throw new Error("Campaign ID is required");return await j.execute({name:"CloseCampaign",button:t,getContract:async i=>_a(i),method:"closeCampaign",args:[e],validate:async(i,s)=>{const l=await(await Ve()).getCampaign(e);if(l.owner===r.ZeroAddress)throw new Error("Campaign not found");if(l.owner.toLowerCase()!==s.toLowerCase())throw new Error("Only the campaign creator can close");if(Number(l.status)!==da.ACTIVE)throw new Error("Campaign is not active")},onSuccess:a,onError:n})}const mi=jn;async function fi({campaignId:e,button:t=null,onSuccess:a=null,onError:n=null}){const r=window.ethers;if(e==null)throw new Error("Campaign ID is required");return await j.execute({name:"Withdraw",button:t,getContract:async i=>_a(i),method:"withdraw",args:[e],validate:async(i,s)=>{const o=await Ve(),l=await o.getCampaign(e);if(l.owner===r.ZeroAddress)throw new Error("Campaign not found");if(l.owner.toLowerCase()!==s.toLowerCase())throw new Error("Only the campaign creator can withdraw");if(Number(l.status)===da.WITHDRAWN)throw new Error("Funds already withdrawn");if(!await o.canWithdraw(e))throw new Error("Cannot withdraw yet — campaign must be closed or past deadline")},onSuccess:async i=>{let s=null;try{const o=new r.Interface(Ra);for(const l of i.logs)try{const d=o.parseLog(l);if(d.name==="FundsWithdrawn"){s={amount:d.args.amount};break}}catch{}}catch{}a&&a(i,s)},onError:n})}async function bi({campaignId:e,operator:t,button:a=null,onSuccess:n=null,onError:r=null}){const i=window.ethers;if(e==null)throw new Error("Campaign ID is required");let s=t,o=i.parseEther("0.0001");return await j.execute({name:"BoostCampaign",button:a,getContract:async l=>_a(l),method:"boostCampaign",args:()=>[e,Q(s)],get value(){return o},validate:async(l,d)=>{const m=await(await Ve()).getCampaign(e);if(m.owner===i.ZeroAddress)throw new Error("Campaign not found");if(Number(m.status)!==da.ACTIVE)throw new Error("Campaign is not active");const p=Math.floor(Date.now()/1e3);if(Number(m.deadline)<=p)throw new Error("Campaign has ended")},onSuccess:n,onError:r})}async function gi(e){const a=await(await Ve()).getCampaign(e),n=Math.floor(Date.now()/1e3);return{id:e,creator:a.owner,title:a.title,metadataUri:a.metadataUri,goalAmount:a.goal,raisedAmount:a.raised,donationCount:Number(a.donorCount),deadline:Number(a.deadline),status:Number(a.status),statusName:["ACTIVE","CLOSED","WITHDRAWN"][Number(a.status)]||"UNKNOWN",isBoosted:a.isBoosted,progress:a.goal>0n?Number(a.raised*100n/a.goal):0,isEnded:Number(a.deadline)<n,isActive:Number(a.status)===da.ACTIVE&&Number(a.deadline)>n}}async function xi(){const e=await Ve();return Number(await e.campaignCount())}async function hi(e){return await(await Ve()).canWithdraw(e)}async function vi(e){const t=window.ethers,n=await(await Ve()).previewDonation(e);return{fee:n.fee||n[0],netToCampaign:n.netToCampaign||n[1],feeFormatted:t.formatEther(n.fee||n[0]),netFormatted:t.formatEther(n.netToCampaign||n[1])}}async function wi(){const e=window.ethers,a=await(await Ve()).getStats();return{totalCampaigns:Number(a.campaignCount||a[0]),totalDonated:a.totalDonated||a[1],totalDonatedFormatted:e.formatEther(a.totalDonated||a[1]),totalWithdrawn:a.totalWithdrawn||a[2],totalWithdrawnFormatted:e.formatEther(a.totalWithdrawn||a[2]),totalEthFees:a.totalEthFees||a[3],totalEthFeesFormatted:e.formatEther(a.totalEthFees||a[3])}}const kt={createCampaign:ui,donate:pi,closeCampaign:jn,cancelCampaign:mi,withdraw:fi,boostCampaign:bi,getCampaign:gi,getCampaignCount:xi,canWithdraw:hi,previewDonation:vi,getStats:wi,CampaignStatus:da},fp=Object.freeze(Object.defineProperty({__proto__:null,CharityTx:kt,boostCampaign:bi,canWithdraw:hi,cancelCampaign:mi,closeCampaign:jn,createCampaign:ui,donate:pi,getCampaign:gi,getCampaignCount:xi,getStats:wi,previewDonation:vi,withdraw:fi},Symbol.toStringTag,{value:"Module"}));function yi(){var a,n;const e=(v==null?void 0:v.stakingPool)||(M==null?void 0:M.stakingPool)||((a=window.contractAddresses)==null?void 0:a.stakingPool),t=(v==null?void 0:v.bkcToken)||(M==null?void 0:M.bkcToken)||((n=window.contractAddresses)==null?void 0:n.bkcToken);if(!e)throw console.error("❌ StakingPool address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");if(!t)throw console.error("❌ BKC Token address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{BKC_TOKEN:t,STAKING_POOL:e}}const vc=["function delegate(uint256 amount, uint256 lockDays, address operator) external payable","function unstake(uint256 index) external","function forceUnstake(uint256 index, address operator) external payable","function claimRewards(address operator) external payable","function pendingRewards(address user) view returns (uint256)","function previewClaim(address user) view returns (uint256 totalRewards, uint256 burnAmount, uint256 referrerCut, uint256 userReceives, uint256 burnRateBps, uint256 nftBoost)","function getDelegationsOf(address user) view returns (tuple(uint128 amount, uint128 pStake, uint64 lockEnd, uint64 lockDays, uint256 rewardDebt)[])","function getDelegation(address user, uint256 index) view returns (uint256 amount, uint256 pStake, uint256 lockEnd, uint256 lockDays, uint256 pendingReward)","function delegationCount(address user) view returns (uint256)","function userTotalPStake(address user) view returns (uint256)","function totalPStake() view returns (uint256)","function MIN_LOCK_DAYS() view returns (uint256)","function MAX_LOCK_DAYS() view returns (uint256)","function forceUnstakePenaltyBps() view returns (uint256)","function getUserBestBoost(address user) view returns (uint256)","function getBurnRateForBoost(uint256 boostBps) view returns (uint256)","function getTierName(uint256 boostBps) view returns (string)","function getUserSummary(address user) view returns (uint256 userTotalPStake, uint256 delegationCount, uint256 savedRewards, uint256 totalPending, uint256 nftBoost, uint256 burnRateBps)","function getStakingStats() view returns (uint256 totalPStake, uint256 totalBkcDelegated, uint256 totalRewardsDistributed, uint256 totalBurnedOnClaim, uint256 totalForceUnstakePenalties, uint256 totalEthFeesCollected, uint256 accRewardPerShare)","event Delegated(address indexed user, uint256 indexed delegationIndex, uint256 amount, uint256 pStake, uint256 lockDays, address operator)","event Unstaked(address indexed user, uint256 indexed delegationIndex, uint256 amountReturned)","event ForceUnstaked(address indexed user, uint256 indexed delegationIndex, uint256 amountReturned, uint256 penaltyBurned, address operator)","event RewardsClaimed(address indexed user, uint256 totalRewards, uint256 burnedAmount, uint256 userReceived, uint256 cutAmount, address cutRecipient, uint256 nftBoostUsed, address operator)"];function Ot(e){const t=window.ethers,a=yi();return new t.Contract(a.STAKING_POOL,vc,e)}async function Et(){const e=window.ethers,{NetworkManager:t}=await O(async()=>{const{NetworkManager:r}=await Promise.resolve().then(()=>J);return{NetworkManager:r}},void 0),a=t.getProvider(),n=yi();return new e.Contract(n.STAKING_POOL,vc,a)}async function ki({amount:e,lockDays:t,operator:a,button:n=null,onSuccess:r=null,onError:i=null}){if(t==null)throw new Error("lockDays must be provided");const s=Number(t);if(s<1||s>3650)throw new Error("Lock duration must be between 1 and 3650 days");const o=BigInt(e);let l=a;return await j.execute({name:"Delegate",button:n,getContract:async d=>Ot(d),method:"delegate",args:()=>[o,BigInt(s),Q(l)],approval:(()=>{const d=yi();return{token:d.BKC_TOKEN,spender:d.STAKING_POOL,amount:o}})(),onSuccess:r,onError:i})}async function Ei({delegationIndex:e,button:t=null,onSuccess:a=null,onError:n=null}){ee.staking.validateUnstake({delegationIndex:e});let r=e;return await j.execute({name:"Unstake",button:t,getContract:async i=>Ot(i),method:"unstake",args:[r],validate:async(i,s)=>{const l=await Ot(i).getDelegationsOf(s);if(r>=l.length)throw new Error("Delegation not found");const d=l[r],u=Math.floor(Date.now()/1e3);if(Number(d.lockEnd)>u){const m=Math.ceil((Number(d.lockEnd)-u)/86400);throw new Error(`Lock period still active. ${m} day(s) remaining. Use Force Unstake if needed.`)}},onSuccess:a,onError:n})}async function Ti({delegationIndex:e,operator:t,button:a=null,onSuccess:n=null,onError:r=null}){ee.staking.validateUnstake({delegationIndex:e});let i=e,s=t;return await j.execute({name:"ForceUnstake",button:a,getContract:async o=>Ot(o),method:"forceUnstake",args:()=>[i,Q(s)],validate:async(o,l)=>{const u=await Ot(o).getDelegationsOf(l);if(i>=u.length)throw new Error("Delegation not found");const m=u[i],p=Math.floor(Date.now()/1e3);if(Number(m.lockEnd)<=p)throw new Error("Lock period has ended. Use normal Unstake to avoid penalty.")},onSuccess:n,onError:r})}async function Ci({operator:e,button:t=null,onSuccess:a=null,onError:n=null}={}){let r=e;return await j.execute({name:"ClaimRewards",button:t,getContract:async i=>Ot(i),method:"claimRewards",args:()=>[Q(r)],validate:async(i,s)=>{if(await Ot(i).pendingRewards(s)<=0n)throw new Error("No rewards available to claim")},onSuccess:a,onError:n})}async function Ii(e){const a=await(await Et()).getDelegationsOf(e),n=Math.floor(Date.now()/1e3);return a.map((r,i)=>({index:i,amount:r.amount,pStake:r.pStake,lockEnd:Number(r.lockEnd),lockDays:Number(r.lockDays),isUnlocked:Number(r.lockEnd)<=n,daysRemaining:Number(r.lockEnd)>n?Math.ceil((Number(r.lockEnd)-n)/86400):0}))}async function Ai(e){return await(await Et()).pendingRewards(e)}async function Pi(e){return await(await Et()).userTotalPStake(e)}async function zi(){return await(await Et()).totalPStake()}async function Bi(){const e=await Et();try{const t=await e.forceUnstakePenaltyBps();return Number(t)/100}catch{return 10}}async function Ni(){const e=await Et(),[t,a,n]=await Promise.all([e.MIN_LOCK_DAYS(),e.MAX_LOCK_DAYS(),e.forceUnstakePenaltyBps().catch(()=>1000n)]);return{minLockDays:Number(t),maxLockDays:Number(a),penaltyPercent:Number(n)/100,penaltyBips:Number(n)}}async function Si(e){const a=await(await Et()).previewClaim(e);return{totalRewards:a.totalRewards,burnAmount:a.burnAmount,referrerCut:a.referrerCut,userReceives:a.userReceives,burnRateBps:Number(a.burnRateBps),nftBoost:Number(a.nftBoost)}}async function $i(e){const a=await(await Et()).getUserSummary(e);return{userTotalPStake:a.userTotalPStake||a[0],delegationCount:Number(a.delegationCount||a[1]),savedRewards:a.savedRewards||a[2],totalPending:a.totalPending||a[3],nftBoost:Number(a.nftBoost||a[4]),burnRateBps:Number(a.burnRateBps||a[5])}}const Ht={delegate:ki,unstake:Ei,forceUnstake:Ti,claimRewards:Ci,getUserDelegations:Ii,getPendingRewards:Ai,getUserPStake:Pi,getTotalPStake:zi,getEarlyUnstakePenalty:Bi,getStakingConfig:Ni,previewClaim:Si,getUserSummary:$i},bp=Object.freeze(Object.defineProperty({__proto__:null,StakingTx:Ht,claimRewards:Ci,delegate:ki,forceUnstake:Ti,getEarlyUnstakePenalty:Bi,getPendingRewards:Ai,getStakingConfig:Ni,getTotalPStake:zi,getUserDelegations:Ii,getUserPStake:Pi,getUserSummary:$i,previewClaim:Si,unstake:Ei},Symbol.toStringTag,{value:"Module"})),wc=["diamond","gold","silver","bronze"];function Wn(e=null){var r,i,s;const t=(v==null?void 0:v.bkcToken)||(M==null?void 0:M.bkcToken)||((r=window.contractAddresses)==null?void 0:r.bkcToken),a=(v==null?void 0:v.rewardBooster)||(M==null?void 0:M.rewardBooster)||((i=window.contractAddresses)==null?void 0:i.rewardBooster);let n=null;if(e){const o=`pool_${e.toLowerCase()}`;n=(v==null?void 0:v[o])||(M==null?void 0:M[o])||((s=window.contractAddresses)==null?void 0:s[o])}if(!t||!a)throw new Error("Contract addresses not loaded");return{BKC_TOKEN:t,NFT_CONTRACT:a,NFT_POOL:n}}function ua(e){var a;const t=`pool_${e.toLowerCase()}`;return(v==null?void 0:v[t])||(M==null?void 0:M[t])||((a=window.contractAddresses)==null?void 0:a[t])||null}function gp(){const e={};for(const t of wc){const a=ua(t);a&&(e[t]=a)}return e}const Li=["function buyNFT(uint256 maxBkcPrice, address operator) external payable returns (uint256 tokenId)","function buySpecificNFT(uint256 tokenId, uint256 maxBkcPrice, address operator) external payable","function sellNFT(uint256 tokenId, uint256 minPayout, address operator) external payable","function getBuyPrice() view returns (uint256)","function getSellPrice() view returns (uint256)","function getTotalBuyCost() view returns (uint256 bkcCost, uint256 ethCost)","function getTotalSellInfo() view returns (uint256 bkcPayout, uint256 ethCost)","function getEthFees() view returns (uint256 buyFee, uint256 sellFee)","function getSpread() view returns (uint256 spread, uint256 spreadBips)","function getPoolInfo() view returns (uint256 bkcBalance, uint256 nftCount, uint256 k, bool initialized, uint8 tier)","function getAvailableNFTs() view returns (uint256[])","function isNFTInPool(uint256 tokenId) view returns (bool)","function tier() view returns (uint8)","function getTierName() view returns (string)","function getStats() view returns (uint256 volume, uint256 buys, uint256 sells, uint256 ethFees)","event NFTPurchased(address indexed buyer, uint256 indexed tokenId, uint256 price, uint256 ethFee, uint256 nftCount, address operator)","event NFTSold(address indexed seller, uint256 indexed tokenId, uint256 payout, uint256 ethFee, uint256 nftCount, address operator)"],yc=["function setApprovalForAll(address operator, bool approved) external","function isApprovedForAll(address owner, address operator) view returns (bool)","function ownerOf(uint256 tokenId) view returns (address)","function balanceOf(address owner) view returns (uint256)","function tokenTier(uint256 tokenId) view returns (uint8)"];function Ri(e,t){return new window.ethers.Contract(t,Li,e)}async function ke(e){const{NetworkManager:t}=await O(async()=>{const{NetworkManager:a}=await Promise.resolve().then(()=>J);return{NetworkManager:a}},void 0);return new window.ethers.Contract(e,Li,t.getProvider())}function Ut(e,t){const a=window.ethers;return a.keccak256(a.AbiCoder.defaultAbiCoder().encode(["string","uint8"],[e,Number(t)]))}function Rr(e){const t=Wn();return new window.ethers.Contract(t.NFT_CONTRACT,yc,e)}async function xp(){const{NetworkManager:e}=await O(async()=>{const{NetworkManager:a}=await Promise.resolve().then(()=>J);return{NetworkManager:a}},void 0),t=Wn();return new window.ethers.Contract(t.NFT_CONTRACT,yc,e.getProvider())}async function Gn({poolAddress:e,poolTier:t,operator:a,button:n=null,onSuccess:r=null,onError:i=null}){const s=window.ethers,o=Wn(),l=e||ua(t);if(!l)throw new Error("Pool address or valid pool tier is required");let d=a,u=0n,m=0n;return await j.execute({name:"BuyNFT",button:n,getContract:async p=>Ri(p,l),method:"buyNFT",args:()=>[u,Q(d)],get value(){return m},get approval(){return u>0n?{token:o.BKC_TOKEN,spender:l,amount:u}:null},validate:async(p,b)=>{const f=await ke(l),[w]=await f.getTotalBuyCost();u=w;const k=await f.tier();m=await ye(Ut("NFT_BUY_T",k)),console.log(`[BuyNFT] Price: ${s.formatEther(u)} BKC, Fee: ${s.formatEther(m)} ETH`);const C=await f.getPoolInfo();if(Number(C[1])<=1)throw new Error("No NFTs available in pool");const{NetworkManager:P}=await O(async()=>{const{NetworkManager:N}=await Promise.resolve().then(()=>J);return{NetworkManager:N}},void 0),S=P.getProvider();if(await new s.Contract(o.BKC_TOKEN,["function balanceOf(address) view returns (uint256)"],S).balanceOf(b)<u)throw new Error(`Insufficient BKC. Need ${s.formatEther(u)} BKC`);if(await S.getBalance(b)<m+s.parseEther("0.001"))throw new Error("Insufficient ETH for fee + gas")},onSuccess:async p=>{let b=null;try{const f=new s.Interface(Li);for(const w of p.logs)try{const k=f.parseLog(w);if((k==null?void 0:k.name)==="NFTPurchased"){b=Number(k.args.tokenId);break}}catch{}}catch{}r&&r(p,b)},onError:i})}async function _i({poolAddress:e,poolTier:t,tokenId:a,operator:n,button:r=null,onSuccess:i=null,onError:s=null}){const o=window.ethers,l=Wn(),d=e||ua(t);if(!d)throw new Error("Pool address or valid pool tier is required");if(a===void 0)throw new Error("Token ID is required");let u=n,m=0n,p=0n;return await j.execute({name:"BuySpecificNFT",button:r,getContract:async b=>Ri(b,d),method:"buySpecificNFT",args:()=>[a,m,Q(u)],get value(){return p},get approval(){return m>0n?{token:l.BKC_TOKEN,spender:d,amount:m}:null},validate:async(b,f)=>{const w=await ke(d);if(!await w.isNFTInPool(a))throw new Error("NFT is not in pool");const[k]=await w.getTotalBuyCost();m=k;const C=await w.tier();p=await ye(Ut("NFT_BUY_T",C));const{NetworkManager:P}=await O(async()=>{const{NetworkManager:B}=await Promise.resolve().then(()=>J);return{NetworkManager:B}},void 0),S=P.getProvider();if(await new o.Contract(l.BKC_TOKEN,["function balanceOf(address) view returns (uint256)"],S).balanceOf(f)<m)throw new Error("Insufficient BKC");if(await S.getBalance(f)<p+o.parseEther("0.001"))throw new Error("Insufficient ETH")},onSuccess:i,onError:s})}async function Kn({poolAddress:e,poolTier:t,tokenId:a,minPayout:n,operator:r,button:i=null,onSuccess:s=null,onError:o=null}){const l=window.ethers,d=e||ua(t);if(!d)throw new Error("Pool address or valid pool tier is required");if(a===void 0)throw new Error("Token ID is required");let u=r,m=0n,p=0n;return await j.execute({name:"SellNFT",button:i,getContract:async b=>Ri(b,d),method:"sellNFT",args:()=>[a,m,Q(u)],get value(){return p},validate:async(b,f)=>{const w=await ke(d),k=Rr(b);if((await k.ownerOf(a)).toLowerCase()!==f.toLowerCase())throw new Error("You do not own this NFT");const P=await w.tier(),S=await k.tokenTier(a);if(P!==S)throw new Error("NFT tier does not match pool tier");const[_]=await w.getTotalSellInfo();m=n?BigInt(n):_*95n/100n;const B=await w.tier();p=await ye(Ut("NFT_SELL_T",B));const{NetworkManager:I}=await O(async()=>{const{NetworkManager:F}=await Promise.resolve().then(()=>J);return{NetworkManager:F}},void 0);if(await I.getProvider().getBalance(f)<p+l.parseEther("0.001"))throw new Error("Insufficient ETH");if(!await k.isApprovedForAll(f,d)){const{NetworkManager:F}=await O(async()=>{const{NetworkManager:ce}=await Promise.resolve().then(()=>J);return{NetworkManager:ce}},void 0),ne=await F.getProvider().getFeeData(),V={gasLimit:100000n};ne.maxFeePerGas&&(V.maxFeePerGas=ne.maxFeePerGas*120n/100n,V.maxPriorityFeePerGas=ne.maxPriorityFeePerGas||0n),await(await k.setApprovalForAll(d,!0,V)).wait()}},onSuccess:s,onError:o})}async function Fi({poolAddress:e,poolTier:t,button:a=null,onSuccess:n=null,onError:r=null}){const i=e||ua(t);if(!i)throw new Error("Pool address or valid pool tier is required");return await j.execute({name:"ApproveAllNFTs",button:a,getContract:async s=>Rr(s),method:"setApprovalForAll",args:[i,!0],validate:async(s,o)=>{if(await Rr(s).isApprovedForAll(o,i))throw new Error("Already approved")},onSuccess:n,onError:r})}async function Mi(e){return await(await ke(e)).getBuyPrice()}async function Di(e){return await(await ke(e)).getSellPrice()}async function Oi(e){const t=window.ethers,a=await ke(e),[n]=await a.getTotalBuyCost(),r=await a.tier(),i=await ye(Ut("NFT_BUY_T",r));return{bkcCost:n,bkcFormatted:t.formatEther(n),ethCost:i,ethFormatted:t.formatEther(i)}}async function Hi(e){const t=window.ethers,a=await ke(e),[n]=await a.getTotalSellInfo(),r=await a.tier(),i=await ye(Ut("NFT_SELL_T",r));return{bkcPayout:n,bkcFormatted:t.formatEther(n),ethCost:i,ethFormatted:t.formatEther(i)}}async function Ui(e){const t=window.ethers,a=await ke(e),[n,r,i]=await Promise.all([a.getPoolInfo(),a.getBuyPrice().catch(()=>0n),a.getSellPrice().catch(()=>0n)]);return{bkcBalance:n[0],nftCount:Number(n[1]),k:n[2],initialized:n[3],tier:Number(n[4]),buyPrice:r,buyPriceFormatted:t.formatEther(r),sellPrice:i,sellPriceFormatted:t.formatEther(i)}}async function ji(e){return(await(await ke(e)).getAvailableNFTs()).map(a=>Number(a))}async function Yn(e){const t=window.ethers,n=await(await ke(e)).tier(),r=await ye(Ut("NFT_BUY_T",n)),i=await ye(Ut("NFT_SELL_T",n));return{buyFee:r,buyFeeFormatted:t.formatEther(r),sellFee:i,sellFeeFormatted:t.formatEther(i)}}const kc=Yn;async function Vn(e){const t=window.ethers,n=await(await ke(e)).getStats();return{volume:n[0],volumeFormatted:t.formatEther(n[0]),buys:Number(n[1]),sells:Number(n[2]),ethFees:n[3],ethFeesFormatted:t.formatEther(n[3])}}const Ec=Vn;async function Wi(e){return await(await ke(e)).getTierName()}async function Gi(e){const t=window.ethers,a=await ke(e);try{const n=await a.getSpread();return{spread:n.spread,spreadFormatted:t.formatEther(n.spread),spreadBips:Number(n.spreadBips),spreadPercent:Number(n.spreadBips)/100}}catch{const[n,r]=await Promise.all([a.getBuyPrice().catch(()=>0n),a.getSellPrice().catch(()=>0n)]),i=n>r?n-r:0n,s=r>0n?Number(i*10000n/r):0;return{spread:i,spreadFormatted:t.formatEther(i),spreadBips:s,spreadPercent:s/100}}}async function Tc(e,t){return await(await ke(e)).isNFTInPool(t)}async function Ki(e,t){return await(await xp()).isApprovedForAll(e,t)}const Cc=Gn,Ic=Kn,fn={buyNft:Gn,buySpecificNft:_i,sellNft:Kn,approveAllNfts:Fi,buyFromPool:Cc,sellToPool:Ic,getBuyPrice:Mi,getSellPrice:Di,getTotalBuyCost:Oi,getTotalSellInfo:Hi,getEthFees:Yn,getEthFeeConfig:kc,getPoolInfo:Ui,getAvailableNfts:ji,isNFTInPool:Tc,isApprovedForAll:Ki,getStats:Vn,getTradingStats:Ec,getTierName:Wi,getSpread:Gi,getPoolAddress:ua,getAllPools:gp,POOL_TIERS:wc},hp=Object.freeze(Object.defineProperty({__proto__:null,NftTx:fn,approveAllNfts:Fi,buyFromPool:Cc,buyNft:Gn,buySpecificNft:_i,getAvailableNfts:ji,getBuyPrice:Mi,getEthFeeConfig:kc,getEthFees:Yn,getPoolInfo:Ui,getSellPrice:Di,getSpread:Gi,getStats:Vn,getTierName:Wi,getTotalBuyCost:Oi,getTotalSellInfo:Hi,getTradingStats:Ec,isApprovedForAll:Ki,isNFTInPool:Tc,sellNft:Kn,sellToPool:Ic},Symbol.toStringTag,{value:"Module"}));function Yi(){var a,n;const e=(v==null?void 0:v.fortunePool)||(M==null?void 0:M.fortunePool)||((a=window.contractAddresses)==null?void 0:a.fortunePool),t=(v==null?void 0:v.bkcToken)||(M==null?void 0:M.bkcToken)||((n=window.contractAddresses)==null?void 0:n.bkcToken);if(!e)throw console.error("❌ FortunePool address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");if(!t)throw console.error("❌ BKC Token address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{BKC_TOKEN:t,FORTUNE_POOL:e}}const qn=["function commitPlay(bytes32 commitHash, uint256 wagerAmount, uint8 tierMask, address operator) external payable returns (uint256 gameId)","function revealPlay(uint256 gameId, uint256[] calldata guesses, bytes32 userSecret) external returns (uint256 prizeWon)","function claimExpired(uint256 gameId) external","function fundPrizePool(uint256 amount) external","function getTierInfo(uint8 tier) view returns (uint256 range, uint256 multiplier, uint256 winChanceBps)","function getAllTiers() view returns (uint256[3] ranges, uint256[3] multipliers, uint256[3] winChances)","function TIER_COUNT() view returns (uint8)","function getGame(uint256 gameId) view returns (address player, uint48 commitBlock, uint8 tierMask, uint8 status, address operator, uint96 wagerAmount)","function getGameResult(uint256 gameId) view returns (address player, uint128 grossWager, uint128 prizeWon, uint8 tierMask, uint8 matchCount, uint48 revealBlock)","function getGameStatus(uint256 gameId) view returns (uint8 status, bool canReveal, uint256 blocksUntilReveal, uint256 blocksUntilExpiry)","function calculatePotentialWinnings(uint256 wagerAmount, uint8 tierMask) view returns (uint256 netToPool, uint256 bkcFee, uint256 maxPrize, uint256 maxPrizeAfterCap)","function getRequiredFee(uint8 tierMask) view returns (uint256 fee)","function generateCommitHash(uint256[] calldata guesses, bytes32 userSecret) pure returns (bytes32)","function gameCounter() view returns (uint256)","function prizePool() view returns (uint256)","function getPoolStats() view returns (uint256 prizePool, uint256 totalGamesPlayed, uint256 totalBkcWagered, uint256 totalBkcWon, uint256 totalBkcForfeited, uint256 totalBkcBurned, uint256 maxPayoutNow)","function REVEAL_DELAY() view returns (uint256)","function REVEAL_WINDOW() view returns (uint256)","function BKC_FEE_BPS() view returns (uint256)","function MAX_PAYOUT_BPS() view returns (uint256)","event GameCommitted(uint256 indexed gameId, address indexed player, uint256 wagerAmount, uint8 tierMask, address operator)","event GameRevealed(uint256 indexed gameId, address indexed player, uint256 grossWager, uint256 prizeWon, uint8 tierMask, uint8 matchCount, address operator)","event GameExpired(uint256 indexed gameId, address indexed player, uint256 forfeitedAmount)"],Vi=[{range:5,multiplierBps:2e4},{range:15,multiplierBps:1e5},{range:150,multiplierBps:1e6}];function Ac(e){const t=window.ethers,a=Yi();return new t.Contract(a.FORTUNE_POOL,qn,e)}async function Kt(){const e=window.ethers,{NetworkManager:t}=await O(async()=>{const{NetworkManager:r}=await Promise.resolve().then(()=>J);return{NetworkManager:r}},void 0),a=t.getProvider(),n=Yi();return new e.Contract(n.FORTUNE_POOL,qn,a)}const qi="fortune_pending_games";function Xn(){try{return JSON.parse(localStorage.getItem(qi)||"{}")}catch{return{}}}function vp(e,t){const a=Xn();a[e]={...t,savedAt:Date.now()},localStorage.setItem(qi,JSON.stringify(a))}function wp(e){const t=Xn();delete t[e],localStorage.setItem(qi,JSON.stringify(t))}function Xi(e,t){const a=window.ethers,r=a.AbiCoder.defaultAbiCoder().encode(["uint256[]","bytes32"],[e.map(i=>BigInt(i)),t]);return a.keccak256(r)}function Pc(){const e=window.ethers;return e.hexlify(e.randomBytes(32))}function yp(e){let t=0;for(;e;)t+=e&1,e>>=1;return t}async function Jn({commitmentHash:e,wagerAmount:t,tierMask:a,operator:n,button:r=null,onSuccess:i=null,onError:s=null}){const o=window.ethers,l=Yi(),d=BigInt(t),u=Number(a);if(u<1||u>7)throw new Error("tierMask must be 1-7");let m=n,p=0n;try{for(let b=0;b<3;b++)u&1<<b&&(p+=await ye(o.id(`FORTUNE_TIER${b}`)));console.log("[FortuneTx] ETH fee:",o.formatEther(p))}catch(b){throw console.error("[FortuneTx] Could not calculate ETH fee:",b.message),new Error("Could not calculate ETH fee")}return await j.execute({name:"CommitPlay",button:r,getContract:async b=>Ac(b),method:"commitPlay",args:()=>[e,d,u,Q(m)],value:p,approval:{token:l.BKC_TOKEN,spender:l.FORTUNE_POOL,amount:d},validate:async(b,f)=>{if(d<=0n)throw new Error("Wager amount must be greater than 0");const{NetworkManager:w}=await O(async()=>{const{NetworkManager:C}=await Promise.resolve().then(()=>J);return{NetworkManager:C}},void 0),k=await w.getProvider().getBalance(f);if(p>0n&&k<p+o.parseEther("0.001"))throw new Error(`Insufficient ETH for fee (${o.formatEther(p)} ETH required)`)},onSuccess:async b=>{let f=null;try{const w=new o.Interface(qn);for(const k of b.logs)try{const C=w.parseLog(k);if(C.name==="GameCommitted"){f=Number(C.args.gameId);break}}catch{}}catch{}i&&i({gameId:f,txHash:b.hash,commitBlock:b.blockNumber})},onError:s})}async function Zn({gameId:e,guesses:t,userSecret:a,button:n=null,onSuccess:r=null,onError:i=null}){const s=window.ethers,o=t.map(l=>BigInt(l));return await j.execute({name:"RevealPlay",button:n,getContract:async l=>Ac(l),method:"revealPlay",args:[e,o,a],validate:async(l,d)=>{const u=await Kt(),m=await u.getGameStatus(e);if(Number(m.status)===3)throw new Error("Game has expired.");if(!m.canReveal)throw Number(m.blocksUntilReveal)>0?new Error(`Must wait ${m.blocksUntilReveal} more blocks before reveal`):new Error("Cannot reveal this game");const p=await u.getGame(e);if(p.player.toLowerCase()!==d.toLowerCase())throw new Error("You are not the owner of this game");const b=Xi(t,a);p[0]&&p[0]},onSuccess:async l=>{let d=null;try{const u=new s.Interface(qn);for(const m of l.logs)try{const p=u.parseLog(m);p.name==="GameRevealed"&&(d={gameId:Number(p.args.gameId),grossWager:p.args.grossWager,prizeWon:p.args.prizeWon,tierMask:Number(p.args.tierMask),matchCount:Number(p.args.matchCount),won:p.args.prizeWon>0n})}catch{}}catch{}wp(e),r&&r(l,d)},onError:i})}async function Ji({wagerAmount:e,guess:t,guesses:a,tierMask:n=1,operator:r,button:i=null,onSuccess:s=null,onError:o=null}){const l=Number(n);if(l<1||l>7)throw new Error("tierMask must be 1-7");const d=yp(l);let u=[];if(a&&Array.isArray(a)&&a.length>0)u=a.map(f=>Number(f));else if(t!==void 0)u=[Number(Array.isArray(t)?t[0]:t)];else throw new Error("Guess(es) required");if(u.length!==d)throw new Error(`tierMask selects ${d} tier(s) but ${u.length} guess(es) provided`);let m=0;for(let f=0;f<3;f++)if(l&1<<f){const w=Vi[f].range;if(u[m]<1||u[m]>w)throw new Error(`Tier ${f} guess must be between 1 and ${w}`);m++}const p=Pc(),b=Xi(u,p);return await Jn({commitmentHash:b,wagerAmount:e,tierMask:l,operator:r,button:i,onSuccess:f=>{vp(f.gameId,{guesses:u,userSecret:p,tierMask:l,wagerAmount:e.toString(),commitmentHash:b}),s&&s({...f,guesses:u,userSecret:p,tierMask:l})},onError:o})}async function Zi(){const e=await Kt();try{const t=await e.getAllTiers(),a=[];for(let n=0;n<3;n++)a.push({tierId:n,maxRange:Number(t.ranges[n]),multiplierBps:Number(t.multipliers[n]),multiplier:Number(t.multipliers[n])/1e4,winChanceBps:Number(t.winChances[n]),active:!0});return a}catch{return Vi.map((t,a)=>({tierId:a,maxRange:t.range,multiplierBps:t.multiplierBps,multiplier:t.multiplierBps/1e4,active:!0}))}}async function zc(e){const t=await Kt();try{const a=await t.getTierInfo(e);return{tierId:e,maxRange:Number(a.range),multiplierBps:Number(a.multiplier),multiplier:Number(a.multiplier)/1e4,winChanceBps:Number(a.winChanceBps)}}catch{return null}}async function Qi(e=1){const t=window.ethers,a=Number(e);try{let n=0n;for(let r=0;r<3;r++)a&1<<r&&(n+=await ye(t.id(`FORTUNE_TIER${r}`)));return n}catch{return 0n}}async function es(){const e=window.ethers,t=await Kt();try{const a=await t.getPoolStats();return{prizePoolBalance:a[0],prizePoolFormatted:e.formatEther(a[0]),gameCounter:Number(a[1]),totalWageredAllTime:a[2],totalWageredFormatted:e.formatEther(a[2]),totalPaidOutAllTime:a[3],totalPaidOutFormatted:e.formatEther(a[3]),totalForfeited:a[4],totalBurned:a[5],maxPayoutNow:a[6],maxPayoutFormatted:e.formatEther(a[6])}}catch{const[a,n]=await Promise.all([t.gameCounter().catch(()=>0n),t.prizePool().catch(()=>0n)]);return{gameCounter:Number(a),prizePoolBalance:n,prizePoolFormatted:e.formatEther(n)}}}async function Bc(){return 3}async function ts(e,t=1){const a=window.ethers,n=await Kt();try{const r=await n.calculatePotentialWinnings(e,Number(t));return{netToPool:r.netToPool||r[0],bkcFee:r.bkcFee||r[1],maxPrize:r.maxPrize||r[2],maxPrizeFormatted:a.formatEther(r.maxPrize||r[2]),maxPrizeAfterCap:r.maxPrizeAfterCap||r[3],maxPrizeAfterCapFormatted:a.formatEther(r.maxPrizeAfterCap||r[3])}}catch{return{netToPool:0n,bkcFee:0n,maxPrize:0n,maxPrizeAfterCap:0n}}}async function as(e){const t=await Kt();try{const a=await t.getGameResult(e);return{player:a.player,grossWager:a.grossWager,prizeWon:a.prizeWon,tierMask:Number(a.tierMask),matchCount:Number(a.matchCount),revealBlock:Number(a.revealBlock),won:a.prizeWon>0n}}catch{return null}}async function ns(e){const t=await Kt();try{const a=await t.getGameStatus(e);return{status:Number(a.status),statusName:["NONE","COMMITTED","REVEALED","EXPIRED"][Number(a.status)]||"UNKNOWN",canReveal:a.canReveal,isExpired:Number(a.status)===3,blocksUntilReveal:Number(a.blocksUntilReveal),blocksUntilExpiry:Number(a.blocksUntilExpiry)}}catch{return null}}function Nc(){return Xn()}function rs(e){return Xn()[e]||null}async function Sc(e,t={}){const a=rs(e);if(!a)throw new Error(`No pending game found with ID ${e}`);return await Zn({gameId:e,guesses:a.guesses,userSecret:a.userSecret,...t})}const Qn={commitPlay:Jn,revealPlay:Zn,playGame:Ji,revealPendingGame:Sc,getPendingGamesForReveal:Nc,getPendingGame:rs,generateCommitmentHashLocal:Xi,generateSecret:Pc,getActiveTiers:Zi,getTierById:zc,getServiceFee:Qi,getPoolStats:es,getActiveTierCount:Bc,calculatePotentialWin:ts,getGameResult:as,getCommitmentStatus:ns,TIERS:Vi},kp=Object.freeze(Object.defineProperty({__proto__:null,FortuneTx:Qn,calculatePotentialWin:ts,commitPlay:Jn,getActiveTierCount:Bc,getActiveTiers:Zi,getCommitmentStatus:ns,getGameResult:as,getPendingGame:rs,getPendingGamesForReveal:Nc,getPoolStats:es,getServiceFee:Qi,getTierById:zc,playGame:Ji,revealPendingGame:Sc,revealPlay:Zn},Symbol.toStringTag,{value:"Module"}));function er(){var a,n;const e=(v==null?void 0:v.rentalManager)||(M==null?void 0:M.rentalManager)||((a=window.contractAddresses)==null?void 0:a.rentalManager),t=(v==null?void 0:v.rewardBooster)||(M==null?void 0:M.rewardBooster)||((n=window.contractAddresses)==null?void 0:n.rewardBooster);if(!e||!t)throw new Error("Contract addresses not loaded. Please refresh the page.");return{RENTAL_MANAGER:e,NFT_CONTRACT:t}}const is=["function listNFT(uint256 tokenId, uint96 pricePerHour, uint16 minHours, uint16 maxHours) external","function updateListing(uint256 tokenId, uint96 pricePerHour, uint16 minHours, uint16 maxHours) external","function withdrawNFT(uint256 tokenId) external","function rentNFT(uint256 tokenId, uint256 hours_, address operator) external payable","function withdrawEarnings() external","function getListing(uint256 tokenId) view returns (address owner, uint96 pricePerHour, uint16 minHours, uint16 maxHours, uint96 totalEarnings, uint32 rentalCount, bool currentlyRented, uint48 rentalEndTime)","function getAllListedTokenIds() view returns (uint256[])","function getListingCount() view returns (uint256)","function getRental(uint256 tokenId) view returns (address tenant, uint48 endTime, bool isActive)","function isRented(uint256 tokenId) view returns (bool)","function getRemainingTime(uint256 tokenId) view returns (uint256)","function hasActiveRental(address user) view returns (bool)","function getRentalCost(uint256 tokenId, uint256 hours_) view returns (uint256 rentalCost, uint256 ethFee, uint256 totalCost)","function pendingEarnings(address user) view returns (uint256)","function getStats() view returns (uint256 activeListings, uint256 volume, uint256 rentals, uint256 ethFees, uint256 earningsWithdrawn)","event NFTListed(uint256 indexed tokenId, address indexed owner, uint96 pricePerHour, uint16 minHours, uint16 maxHours)","event NFTRented(uint256 indexed tokenId, address indexed tenant, address indexed owner, uint256 hours_, uint256 rentalCost, uint256 ethFee, uint48 endTime, address operator)","event NFTWithdrawn(uint256 indexed tokenId, address indexed owner)","event EarningsWithdrawn(address indexed owner, uint256 amount)"],Ep=["function setApprovalForAll(address operator, bool approved) external","function isApprovedForAll(address owner, address operator) view returns (bool)","function ownerOf(uint256 tokenId) view returns (address)"];function Fa(e){const t=er();return new window.ethers.Contract(t.RENTAL_MANAGER,is,e)}async function Ee(){const{NetworkManager:e}=await O(async()=>{const{NetworkManager:a}=await Promise.resolve().then(()=>J);return{NetworkManager:a}},void 0),t=er();return new window.ethers.Contract(t.RENTAL_MANAGER,is,e.getProvider())}function Tp(e){const t=er();return new window.ethers.Contract(t.NFT_CONTRACT,Ep,e)}async function tr({tokenId:e,pricePerHour:t,minHours:a,maxHours:n,button:r=null,onSuccess:i=null,onError:s=null}){const o=er(),l=BigInt(t);return await j.execute({name:"ListNFT",button:r,getContract:async d=>Fa(d),method:"listNFT",args:[e,l,a,n],validate:async(d,u)=>{const m=Tp(d);if((await m.ownerOf(e)).toLowerCase()!==u.toLowerCase())throw new Error("You do not own this NFT");if(!await m.isApprovedForAll(u,o.RENTAL_MANAGER)){const{NetworkManager:f}=await O(async()=>{const{NetworkManager:P}=await Promise.resolve().then(()=>J);return{NetworkManager:P}},void 0),w=await f.getProvider().getFeeData(),k={gasLimit:100000n};w.maxFeePerGas&&(k.maxFeePerGas=w.maxFeePerGas*120n/100n,k.maxPriorityFeePerGas=w.maxPriorityFeePerGas||0n),await(await m.setApprovalForAll(o.RENTAL_MANAGER,!0,k)).wait()}},onSuccess:i,onError:s})}async function ar({tokenId:e,hours:t,operator:a,button:n=null,onSuccess:r=null,onError:i=null}){const s=window.ethers;let o=a,l=0n;return await j.execute({name:"RentNFT",button:n,getContract:async d=>Fa(d),method:"rentNFT",args:()=>[e,t,Q(o)],get value(){return l},validate:async(d,u)=>{const m=await Ee(),p=await m.getListing(e);if(p.owner===s.ZeroAddress)throw new Error("NFT is not listed for rent");if(p.currentlyRented)throw new Error("NFT is currently rented");if(t<Number(p.minHours)||t>Number(p.maxHours))throw new Error(`Hours must be between ${p.minHours} and ${p.maxHours}`);const b=await m.getRentalCost(e,t),f=b.rentalCost||b[0],w=await ye(s.id("RENTAL_RENT"),f);l=f+w;const{NetworkManager:k}=await O(async()=>{const{NetworkManager:P}=await Promise.resolve().then(()=>J);return{NetworkManager:P}},void 0);if(await k.getProvider().getBalance(u)<l+s.parseEther("0.001"))throw new Error(`Insufficient ETH. Need ${s.formatEther(l)} ETH + gas`)},onSuccess:async d=>{let u=null;try{const m=new s.Interface(is);for(const p of d.logs)try{const b=m.parseLog(p);if((b==null?void 0:b.name)==="NFTRented"){u={endTime:Number(b.args.endTime),rentalCost:b.args.rentalCost,ethFee:b.args.ethFee};break}}catch{}}catch{}r&&r(d,u)},onError:i})}async function nr({tokenId:e,button:t=null,onSuccess:a=null,onError:n=null}){const r=window.ethers;return await j.execute({name:"WithdrawNFT",button:t,getContract:async i=>Fa(i),method:"withdrawNFT",args:[e],validate:async(i,s)=>{const l=await(await Ee()).getListing(e);if(l.owner===r.ZeroAddress)throw new Error("NFT is not listed");if(l.owner.toLowerCase()!==s.toLowerCase())throw new Error("Only the owner can withdraw");if(l.currentlyRented)throw new Error("Cannot withdraw while NFT is rented")},onSuccess:a,onError:n})}async function ss({button:e=null,onSuccess:t=null,onError:a=null}={}){const n=window.ethers;return await j.execute({name:"WithdrawEarnings",button:e,getContract:async r=>Fa(r),method:"withdrawEarnings",args:[],validate:async(r,i)=>{const o=await(await Ee()).pendingEarnings(i);if(o===0n)throw new Error("No earnings to withdraw");console.log("[RentalTx] Withdrawing:",n.formatEther(o),"ETH")},onSuccess:t,onError:a})}async function os({tokenId:e,pricePerHour:t,minHours:a,maxHours:n,button:r=null,onSuccess:i=null,onError:s=null}){const o=BigInt(t);return await j.execute({name:"UpdateListing",button:r,getContract:async l=>Fa(l),method:"updateListing",args:[e,o,a,n],validate:async(l,d)=>{const m=await(await Ee()).getListing(e);if(m.owner===window.ethers.ZeroAddress)throw new Error("NFT is not listed");if(m.owner.toLowerCase()!==d.toLowerCase())throw new Error("Only the owner can update")},onSuccess:i,onError:s})}async function ls(e){const t=window.ethers,n=await(await Ee()).getListing(e);return{owner:n.owner,pricePerHour:n.pricePerHour,pricePerHourFormatted:t.formatEther(n.pricePerHour),minHours:Number(n.minHours),maxHours:Number(n.maxHours),totalEarnings:n.totalEarnings,totalEarningsFormatted:t.formatEther(n.totalEarnings),rentalCount:Number(n.rentalCount),isActive:n.owner!==t.ZeroAddress,currentlyRented:n.currentlyRented,rentalEndTime:Number(n.rentalEndTime)}}async function cs(e){const a=await(await Ee()).getRental(e),n=Math.floor(Date.now()/1e3),r=Number(a.endTime);return{tenant:a.tenant,endTime:r,isActive:a.isActive,hoursRemaining:a.isActive?Math.max(0,Math.ceil((r-n)/3600)):0}}async function ds(){return(await(await Ee()).getAllListedTokenIds()).map(a=>Number(a))}async function us(){const e=await Ee();return Number(await e.getListingCount())}async function ps(e,t){const a=window.ethers,r=await(await Ee()).getRentalCost(e,t),i=r.rentalCost||r[0],s=await ye(a.id("RENTAL_RENT"),i),o=i+s;return{rentalCost:i,rentalCostFormatted:a.formatEther(i),ethFee:s,ethFeeFormatted:a.formatEther(s),totalCost:o,totalCostFormatted:a.formatEther(o)}}async function ms(e){return await(await Ee()).isRented(e)}async function fs(e){const t=await Ee();return Number(await t.getRemainingTime(e))}async function bs(e){const t=await Ee();try{return await t.hasActiveRental(e)}catch{return!1}}async function gs(e){const t=window.ethers,n=await(await Ee()).pendingEarnings(e);return{amount:n,formatted:t.formatEther(n)}}async function xs(){const e=window.ethers,t=await Ee();try{const a=await t.getStats();return{activeListings:Number(a.activeListings||a[0]),totalVolume:a.volume||a[1],totalVolumeFormatted:e.formatEther(a.volume||a[1]),totalRentals:Number(a.rentals||a[2]),totalEthFees:a.ethFees||a[3],totalEthFeesFormatted:e.formatEther(a.ethFees||a[3]),totalEarningsWithdrawn:a.earningsWithdrawn||a[4],totalEarningsWithdrawnFormatted:e.formatEther(a.earningsWithdrawn||a[4])}}catch{return{activeListings:0,totalVolume:0n,totalVolumeFormatted:"0",totalRentals:0,totalEthFees:0n,totalEthFeesFormatted:"0"}}}const $c=tr,Lc=ar,Rc=nr,rt={listNft:tr,rentNft:ar,withdrawNft:nr,withdrawEarnings:ss,updateListing:os,list:$c,rent:Lc,withdraw:Rc,getListing:ls,getAllListedTokenIds:ds,getListingCount:us,getRentalCost:ps,getRental:cs,isRented:ms,getRemainingRentalTime:fs,hasActiveRental:bs,getPendingEarnings:gs,getMarketplaceStats:xs},Cp=Object.freeze(Object.defineProperty({__proto__:null,RentalTx:rt,getAllListedTokenIds:ds,getListing:ls,getListingCount:us,getMarketplaceStats:xs,getPendingEarnings:gs,getRemainingRentalTime:fs,getRental:cs,getRentalCost:ps,hasActiveRental:bs,isRented:ms,list:$c,listNft:tr,rent:Lc,rentNft:ar,updateListing:os,withdraw:Rc,withdrawEarnings:ss,withdrawNft:nr},Symbol.toStringTag,{value:"Module"}));function _c(){var t;const e=(v==null?void 0:v.notary)||(M==null?void 0:M.notary)||((t=window.contractAddresses)==null?void 0:t.notary);if(!e)throw console.error("❌ Notary address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{NOTARY:e}}const hs=["function certify(bytes32 documentHash, string calldata meta, uint8 docType, address operator) external payable returns (uint256 certId)","function batchCertify(bytes32[] calldata documentHashes, string[] calldata metas, uint8[] calldata docTypes, address operator) external payable returns (uint256 startId)","function transferCertificate(bytes32 documentHash, address newOwner) external","function verify(bytes32 documentHash) view returns (bool exists, address owner, uint48 timestamp, uint8 docType, string memory meta)","function getCertificate(uint256 certId) view returns (bytes32 documentHash, address owner, uint48 timestamp, uint8 docType, string memory meta)","function getFee() view returns (uint256)","function getStats() view returns (uint256 certCount, uint256 totalEthCollected)","function certCount() view returns (uint256)","function version() view returns (string)","event Certified(uint256 indexed certId, address indexed owner, bytes32 indexed documentHash, uint8 docType, address operator)","event BatchCertified(address indexed owner, uint256 startId, uint256 count, address operator)","event CertificateTransferred(bytes32 indexed documentHash, address indexed from, address indexed to)"],Ip={GENERAL:0,CONTRACT:1,IDENTITY:2,DIPLOMA:3,PROPERTY:4,FINANCIAL:5,LEGAL:6,MEDICAL:7,IP:8,OTHER:9};function Ap(e){const t=window.ethers;if(!t)throw new Error("ethers.js not loaded");if(!e)throw new Error("Signer is required for write operations");const a=_c();return new t.Contract(a.NOTARY,hs,e)}async function Ma(){const e=window.ethers;if(!e)throw new Error("ethers.js not loaded");const{NetworkManager:t}=await O(async()=>{const{NetworkManager:r}=await Promise.resolve().then(()=>J);return{NetworkManager:r}},void 0),a=t.getProvider();if(!a)throw new Error("Provider not available");const n=_c();return new e.Contract(n.NOTARY,hs,a)}function Pp(e){if(!e)return!1;const t=e.startsWith("0x")?e:`0x${e}`;return/^0x[a-fA-F0-9]{64}$/.test(t)}async function rr({documentHash:e,meta:t="",docType:a=0,operator:n,button:r=null,onSuccess:i=null,onError:s=null}){const o=window.ethers;if(!e)throw new Error("Document hash is required");const l=e.startsWith("0x")?e:`0x${e}`;if(!Pp(l))throw new Error("Invalid document hash format. Must be a valid bytes32 (64 hex characters)");if(a<0||a>9)throw new Error("Document type must be between 0 and 9");let d=n,u=0n;return await j.execute({name:"Certify",button:r,getContract:async m=>Ap(m),method:"certify",args:()=>[l,t||"",a,Q(d)],get value(){return u},validate:async(m,p)=>{if((await(await Ma()).verify(l)).exists)throw new Error("This document hash has already been certified");u=await ye(o.id("NOTARY_CERTIFY")),console.log("[NotaryTx] Fee:",o.formatEther(u),"ETH");const{NetworkManager:w}=await O(async()=>{const{NetworkManager:S}=await Promise.resolve().then(()=>J);return{NetworkManager:S}},void 0),C=await w.getProvider().getBalance(p),P=u+o.parseEther("0.001");if(C<P)throw new Error(`Insufficient ETH. Need ~${o.formatEther(P)} ETH for fee + gas`)},onSuccess:async m=>{let p=null;try{const b=new o.Interface(hs);for(const f of m.logs)try{const w=b.parseLog(f);if(w&&w.name==="Certified"){p=Number(w.args.certId);break}}catch{}}catch{}i&&i(m,p)},onError:m=>{console.error("[NotaryTx] Certification failed:",m),s&&s(m)}})}const vs=rr;async function Da(e){const t=await Ma(),a=e.startsWith("0x")?e:`0x${e}`;try{const n=await t.verify(a);return{exists:n.exists,owner:n.exists?n.owner:null,timestamp:n.exists?Number(n.timestamp):null,date:n.exists?new Date(Number(n.timestamp)*1e3):null,docType:n.exists?Number(n.docType):null,meta:n.exists?n.meta:null}}catch(n){return console.error("[NotaryTx] verify error:",n),{exists:!1,owner:null,timestamp:null,date:null,docType:null,meta:null}}}const ws=Da;async function ir(e){const t=await Ma();try{const a=await t.getCertificate(e);return a.documentHash==="0x"+"0".repeat(64)?null:{id:e,documentHash:a.documentHash,owner:a.owner,timestamp:Number(a.timestamp),date:new Date(Number(a.timestamp)*1e3),docType:Number(a.docType),meta:a.meta}}catch{return null}}const ys=ir;async function ks(){const e=window.ethers,t=await ye(e.id("NOTARY_CERTIFY"));return{ethFee:t,ethFormatted:e.formatEther(t)+" ETH"}}async function Es(){const e=await Ma();return Number(await e.certCount())}async function Ts(){const e=window.ethers,a=await(await Ma()).getStats();return{totalCertifications:Number(a.certCount||a[0]),totalETHCollected:a.totalEthCollected||a[1],totalETHFormatted:e.formatEther(a.totalEthCollected||a[1])}}async function Oa(e){let t;if(e instanceof ArrayBuffer)t=e;else if(e instanceof Blob||e instanceof File)t=await e.arrayBuffer();else throw new Error("Invalid file type. Expected File, Blob, or ArrayBuffer");const a=await crypto.subtle.digest("SHA-256",t);return"0x"+Array.from(new Uint8Array(a)).map(r=>r.toString(16).padStart(2,"0")).join("")}async function Cs(e,t){const a=await Oa(e);return Wo(t)===Wo(a)}function Wo(e){return(e.startsWith("0x")?e:`0x${e}`).toLowerCase()}async function Fc(e,t){const a=t||await Oa(e),n=await Da(a);let r=!0;return t&&(r=await Cs(e,t)),{contentHash:a,hashMatches:r,existsOnChain:n.exists,certId:null,owner:n.owner,timestamp:n.timestamp,date:n.date,docType:n.docType,isVerified:r&&n.exists}}const Ke={certify:rr,notarize:vs,verify:Da,verifyByHash:ws,getCertificate:ir,getDocument:ys,getTotalDocuments:Es,getFee:ks,getStats:Ts,calculateFileHash:Oa,verifyDocumentHash:Cs,verifyDocumentOnChain:Fc,DOC_TYPES:Ip},zp=Object.freeze(Object.defineProperty({__proto__:null,NotaryTx:Ke,calculateFileHash:Oa,certify:rr,getCertificate:ir,getDocument:ys,getFee:ks,getStats:Ts,getTotalDocuments:Es,notarize:vs,verify:Da,verifyByHash:ws,verifyDocumentHash:Cs,verifyDocumentOnChain:Fc},Symbol.toStringTag,{value:"Module"}));function Mc(){var t;const e=(v==null?void 0:v.agora)||(M==null?void 0:M.agora)||((t=window.contractAddresses)==null?void 0:t.agora);if(!e)throw new Error("Agora contract address not loaded");return{AGORA:e}}const sr=la;function Te(e){return new window.ethers.Contract(Mc().AGORA,sr,e)}async function xe(){const{NetworkManager:e}=await O(async()=>{const{NetworkManager:t}=await Promise.resolve().then(()=>J);return{NetworkManager:t}},void 0);return new window.ethers.Contract(Mc().AGORA,sr,e.getProvider())}async function Is({username:e,metadataURI:t="",operator:a,button:n=null,onSuccess:r=null,onError:i=null}){const s=window.ethers;let o=a,l=0n;return await j.execute({name:"CreateProfile",button:n,skipSimulation:!0,fixedGasLimit:300000n,getContract:async d=>Te(d),method:"createProfile",args:()=>[e,t||"",Q(o)],get value(){return l},validate:async(d,u)=>{const m=await xe();if(!e||e.length<1||e.length>15)throw new Error("Username must be 1-15 characters");if(!/^[a-z0-9_]+$/.test(e))throw new Error("Username: lowercase letters, numbers, underscores only");if(!await m.isUsernameAvailable(e))throw new Error("Username is already taken");l=await m.getUsernamePrice(e.length),console.log("[Agora] Username fee:",s.formatEther(l),"ETH");const{NetworkManager:b}=await O(async()=>{const{NetworkManager:w}=await Promise.resolve().then(()=>J);return{NetworkManager:w}},void 0);if(await b.getProvider().getBalance(u)<l+s.parseEther("0.001"))throw new Error(`Insufficient ETH. Need ~${s.formatEther(l+s.parseEther("0.001"))} ETH`)},onSuccess:r,onError:i})}async function As({metadataURI:e,button:t=null,onSuccess:a=null,onError:n=null}){return await j.execute({name:"UpdateProfile",button:t,skipSimulation:!0,fixedGasLimit:200000n,getContract:async r=>Te(r),method:"updateProfile",args:[e||""],onSuccess:a,onError:n})}async function Ps({content:e,tag:t=0,contentType:a=0,operator:n,button:r=null,onSuccess:i=null,onError:s=null}){const o=window.ethers;let l=n;return await j.execute({name:"CreatePost",button:r,skipSimulation:!0,fixedGasLimit:300000n,getContract:async d=>Te(d),method:"createPost",args:()=>[e,t,a,Q(l)],validate:async(d,u)=>{if(!e||e.length===0)throw new Error("Content is required");if(t<0||t>14)throw new Error("Tag must be 0-14")},onSuccess:async d=>{let u=null;try{const m=new o.Interface(sr);for(const p of d.logs)try{const b=m.parseLog(p);if((b==null?void 0:b.name)==="PostCreated"){u=Number(b.args[0]);break}}catch{}}catch{}i&&i(d,u)},onError:s})}async function zs({parentId:e,content:t,contentType:a=0,operator:n,button:r=null,onSuccess:i=null,onError:s=null}){const o=window.ethers;let l=n;return await j.execute({name:"CreateReply",button:r,skipSimulation:!0,fixedGasLimit:350000n,getContract:async d=>Te(d),method:"createReply",args:()=>[e,t,a,Q(l)],validate:async(d,u)=>{if(!t)throw new Error("Content is required")},onSuccess:async d=>{let u=null;try{const m=new o.Interface(sr);for(const p of d.logs)try{const b=m.parseLog(p);if((b==null?void 0:b.name)==="ReplyCreated"){u=Number(b.args[0]);break}}catch{}}catch{}i&&i(d,u)},onError:s})}async function Bs({originalPostId:e,quote:t="",operator:a,button:n=null,onSuccess:r=null,onError:i=null}){let s=a;return await j.execute({name:"CreateRepost",button:n,skipSimulation:!0,fixedGasLimit:250000n,getContract:async o=>Te(o),method:"createRepost",args:()=>[e,t||"",Q(s)],onSuccess:r,onError:i})}async function Ns({postId:e,operator:t,button:a=null,onSuccess:n=null,onError:r=null}){let i=t;return await j.execute({name:"Like",button:a,skipSimulation:!0,fixedGasLimit:200000n,getContract:async s=>Te(s),method:"like",args:()=>[e,Q(i)],validate:async(s,o)=>{if(await(await xe()).hasLiked(e,o))throw new Error("Already liked this post")},onSuccess:n,onError:r})}async function Ss({postId:e,ethAmount:t,operator:a,button:n=null,onSuccess:r=null,onError:i=null}){let s=a;const o=BigInt(t);return await j.execute({name:"SuperLike",button:n,skipSimulation:!0,fixedGasLimit:250000n,getContract:async l=>Te(l),method:"superLike",args:()=>[e,Q(s)],value:o,validate:async()=>{if(o<100000000n)throw new Error("Minimum super like is 100 gwei")},onSuccess:r,onError:i})}async function $s({postId:e,ethAmount:t,operator:a,button:n=null,onSuccess:r=null,onError:i=null}){let s=a;const o=BigInt(t);return await j.execute({name:"Downvote",button:n,skipSimulation:!0,fixedGasLimit:250000n,getContract:async l=>Te(l),method:"downvote",args:()=>[e,Q(s)],value:o,validate:async()=>{if(o<100000000n)throw new Error("Minimum downvote is 100 gwei")},onSuccess:r,onError:i})}async function Ls({toFollow:e,operator:t,button:a=null,onSuccess:n=null,onError:r=null}){let i=t;return await j.execute({name:"Follow",button:a,skipSimulation:!0,fixedGasLimit:200000n,getContract:async s=>Te(s),method:"follow",args:()=>[e,Q(i)],validate:async(s,o)=>{if(!e||e==="0x0000000000000000000000000000000000000000")throw new Error("Invalid address");if(e.toLowerCase()===o.toLowerCase())throw new Error("Cannot follow yourself")},onSuccess:n,onError:r})}async function Rs({toUnfollow:e,button:t=null,onSuccess:a=null,onError:n=null}){return await j.execute({name:"Unfollow",button:t,skipSimulation:!0,fixedGasLimit:150000n,getContract:async r=>Te(r),method:"unfollow",args:[e],onSuccess:a,onError:n})}async function _s({postId:e,button:t=null,onSuccess:a=null,onError:n=null}){return await j.execute({name:"DeletePost",button:t,skipSimulation:!0,fixedGasLimit:150000n,getContract:async r=>Te(r),method:"deletePost",args:[e],onSuccess:a,onError:n})}async function Fs({postId:e,button:t=null,onSuccess:a=null,onError:n=null}){return await j.execute({name:"PinPost",button:t,skipSimulation:!0,fixedGasLimit:150000n,getContract:async r=>Te(r),method:"pinPost",args:[e],onSuccess:a,onError:n})}async function Ms({ethAmount:e,operator:t,button:a=null,onSuccess:n=null,onError:r=null}){let i=t;const s=BigInt(e);return await j.execute({name:"BoostProfile",button:a,skipSimulation:!0,fixedGasLimit:200000n,getContract:async o=>Te(o),method:"boostProfile",args:()=>[Q(i)],value:s,validate:async()=>{const o=window.ethers;if(s<o.parseEther("0.0005"))throw new Error("Minimum boost is 0.0005 ETH")},onSuccess:n,onError:r})}async function Ds({operator:e,button:t=null,onSuccess:a=null,onError:n=null}){const r=window.ethers;let i=e;const s=r.parseEther("0.001");return await j.execute({name:"ObtainBadge",button:t,skipSimulation:!0,fixedGasLimit:250000n,getContract:async o=>Te(o),method:"obtainBadge",args:()=>[Q(i)],value:s,onSuccess:a,onError:n})}async function or(e){const t=window.ethers,n=await(await xe()).getUsernamePrice(e);return{fee:n,formatted:t.formatEther(n)}}const Os=or;async function Hs(e){const a=await(await xe()).getPost(e);return{author:a.author,tag:Number(a.tag),contentType:Number(a.contentType),deleted:a.deleted,createdAt:Number(a.createdAt),replyTo:Number(a._replyTo),repostOf:Number(a._repostOf),likes:Number(a.likes),superLikes:Number(a.superLikes),downvotes:Number(a.downvotes),replies:Number(a.replies),reposts:Number(a.reposts)}}async function Us(){const e=await xe();return Number(await e.postCounter())}async function js(e){const a=await(await xe()).getUserProfile(e);return{usernameHash:a.usernameHash,metadataURI:a.metadataURI,pinnedPost:Number(a.pinned),boosted:a.boosted,hasBadge:a.hasBadge,boostExpiry:Number(a.boostExp),badgeExpiry:Number(a.badgeExp)}}async function Ws(e){return await(await xe()).isUsernameAvailable(e)}async function Gs(e,t){return await(await xe()).hasLiked(e,t)}async function Dc(e){return await(await xe()).isProfileBoosted(e)}async function Oc(e){return await(await xe()).hasTrustBadge(e)}async function Hc(e){const a=await(await xe()).getUserProfile(e);return Number(a.boostExp)}async function Uc(e){const a=await(await xe()).getUserProfile(e);return Number(a.badgeExp)}async function Ks(){const t=await(await xe()).getGlobalStats();return{totalPosts:Number(t._totalPosts||t[0]),totalProfiles:Number(t._totalProfiles||t[1]),tagCounts:(t._tagCounts||t[2]).map(a=>Number(a))}}async function jc(e){const a=await(await xe()).getOperatorStats(e);return{posts:Number(a.posts_||a[0]),engagement:Number(a.engagement||a[1])}}async function Ys(){return await(await xe()).version()}const ge={createProfile:Is,updateProfile:As,createPost:Ps,createReply:zs,createRepost:Bs,deletePost:_s,pinPost:Fs,like:Ns,superLike:Ss,downvote:$s,follow:Ls,unfollow:Rs,boostProfile:Ms,obtainBadge:Ds,getUsernamePrice:or,getUsernameFee:Os,getPost:Hs,getPostCount:Us,getUserProfile:js,isUsernameAvailable:Ws,hasUserLiked:Gs,isProfileBoosted:Dc,hasTrustBadge:Oc,getBoostExpiry:Hc,getBadgeExpiry:Uc,getGlobalStats:Ks,getOperatorStats:jc,getVersion:Ys},Bp=Object.freeze(Object.defineProperty({__proto__:null,BackchatTx:ge,boostProfile:Ms,createPost:Ps,createProfile:Is,createReply:zs,createRepost:Bs,deletePost:_s,downvote:$s,follow:Ls,getBadgeExpiry:Uc,getBoostExpiry:Hc,getGlobalStats:Ks,getOperatorStats:jc,getPost:Hs,getPostCount:Us,getUserProfile:js,getUsernameFee:Os,getUsernamePrice:or,getVersion:Ys,hasTrustBadge:Oc,hasUserLiked:Gs,isProfileBoosted:Dc,isUsernameAvailable:Ws,like:Ns,obtainBadge:Ds,pinPost:Fs,superLike:Ss,unfollow:Rs,updateProfile:As},Symbol.toStringTag,{value:"Module"}));(async()=>(await O(async()=>{const{CharityTx:e}=await Promise.resolve().then(()=>fp);return{CharityTx:e}},void 0)).CharityTx)(),(async()=>(await O(async()=>{const{StakingTx:e}=await Promise.resolve().then(()=>bp);return{StakingTx:e}},void 0)).StakingTx)(),(async()=>(await O(async()=>{const{NftTx:e}=await Promise.resolve().then(()=>hp);return{NftTx:e}},void 0)).NftTx)(),(async()=>(await O(async()=>{const{FortuneTx:e}=await Promise.resolve().then(()=>kp);return{FortuneTx:e}},void 0)).FortuneTx)(),(async()=>(await O(async()=>{const{RentalTx:e}=await Promise.resolve().then(()=>Cp);return{RentalTx:e}},void 0)).RentalTx)(),(async()=>(await O(async()=>{const{NotaryTx:e}=await Promise.resolve().then(()=>zp);return{NotaryTx:e}},void 0)).NotaryTx)(),(async()=>(await O(async()=>{const{FaucetTx:e}=await Promise.resolve().then(()=>ip);return{FaucetTx:e}},void 0)).FaucetTx)(),(async()=>(await O(async()=>{const{BackchatTx:e}=await Promise.resolve().then(()=>Bp);return{BackchatTx:e}},void 0)).BackchatTx)();const Wc=Object.freeze(Object.defineProperty({__proto__:null,BackchatTx:ge,CharityTx:kt,FaucetTx:dc,FortuneTx:Qn,NftTx:fn,NotaryTx:Ke,RentalTx:rt,StakingTx:Ht,approveAllNfts:Fi,backchatGetVersion:Ys,boostCampaign:bi,boostProfile:Ms,buyNft:Gn,buySpecificNft:_i,calculateFileHash:Oa,calculatePotentialWin:ts,canWithdraw:hi,cancelCampaign:mi,certify:rr,charityGetStats:wi,claimStakingRewards:Ci,closeCampaign:jn,commitPlay:Jn,createCampaign:ui,createPost:Ps,createProfile:Is,createReply:zs,createRepost:Bs,delegate:ki,deletePost:_s,donate:pi,downvote:$s,executeFaucetClaim:On,follow:Ls,forceUnstake:Ti,fortuneGetPoolStats:es,getActiveTiers:Zi,getAllListedTokenIds:ds,getAvailableNfts:ji,getBuyPrice:Mi,getCampaign:gi,getCampaignCount:xi,getCertificate:ir,getCommitmentStatus:ns,getDocument:ys,getEarlyUnstakePenalty:Bi,getEthFees:Yn,getGameResult:as,getGlobalStats:Ks,getListing:ls,getListingCount:us,getMarketplaceStats:xs,getPendingEarnings:gs,getPendingRewards:Ai,getPoolInfo:Ui,getPost:Hs,getPostCount:Us,getRemainingRentalTime:fs,getRental:cs,getRentalCost:ps,getSellPrice:Di,getServiceFee:Qi,getSpread:Gi,getStakingConfig:Ni,getTierName:Wi,getTotalBuyCost:Oi,getTotalDocuments:Es,getTotalPStake:zi,getTotalSellInfo:Hi,getUserDelegations:Ii,getUserPStake:Pi,getUserProfile:js,getUserSummary:$i,getUsernameFee:Os,getUsernamePrice:or,hasActiveRental:bs,hasUserLiked:Gs,isApprovedForAll:Ki,isRented:ms,isUsernameAvailable:Ws,like:Ns,listNft:tr,nftGetStats:Vn,notarize:vs,notaryGetFee:ks,notaryGetStats:Ts,obtainBadge:Ds,pinPost:Fs,playGame:Ji,previewClaim:Si,previewDonation:vi,rentNft:ar,revealPlay:Zn,sellNft:Kn,superLike:Ss,unfollow:Rs,unstake:Ei,updateListing:os,updateProfile:As,verify:Da,verifyByHash:ws,withdraw:fi,withdrawEarnings:ss,withdrawNft:nr},Symbol.toStringTag,{value:"Module"})),Qe=window.ethers,L={hasRenderedOnce:!1,lastUpdate:0,activities:[],networkActivities:[],filteredActivities:[],userProfile:null,pagination:{currentPage:1,itemsPerPage:8},filters:{type:"ALL",sort:"NEWEST"},metricsCache:{},economicData:null,isLoadingNetworkActivity:!1,networkActivitiesTimestamp:0,faucet:{canClaim:!0,cooldownEnd:null,isLoading:!1,lastCheck:0}},Go="https://sepolia.arbiscan.io/tx/",Np="/api/faucet",Sp="https://getrecentactivity-4wvdcuoouq-uc.a.run.app",$p="https://getsystemdata-4wvdcuoouq-uc.a.run.app",_r="1,000",Fr="0.01",U={STAKING:{icon:"fa-lock",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🔒 Staked",emoji:"🔒"},UNSTAKING:{icon:"fa-unlock",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"🔓 Unstaked",emoji:"🔓"},FORCE_UNSTAKE:{icon:"fa-bolt",color:"#ef4444",bg:"rgba(239,68,68,0.15)",label:"⚡ Force Unstaked",emoji:"⚡"},CLAIM:{icon:"fa-coins",color:"#fbbf24",bg:"rgba(245,158,11,0.15)",label:"🪙 Rewards Claimed",emoji:"🪙"},NFT_BUY:{icon:"fa-bag-shopping",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🛍️ Bought NFT",emoji:"🛍️"},NFT_SELL:{icon:"fa-hand-holding-dollar",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"💰 Sold NFT",emoji:"💰"},NFT_MINT:{icon:"fa-gem",color:"#fde047",bg:"rgba(234,179,8,0.15)",label:"💎 Minted Booster",emoji:"💎"},NFT_TRANSFER:{icon:"fa-arrow-right-arrow-left",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"↔️ Transfer",emoji:"↔️"},RENTAL_LIST:{icon:"fa-tag",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🏷️ Listed NFT",emoji:"🏷️"},RENTAL_RENT:{icon:"fa-clock",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"⏰ Rented NFT",emoji:"⏰"},RENTAL_WITHDRAW:{icon:"fa-rotate-left",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"↩️ Withdrawn",emoji:"↩️"},RENTAL_PROMOTE:{icon:"fa-bullhorn",color:"#fbbf24",bg:"rgba(251,191,36,0.2)",label:"📢 Promoted NFT",emoji:"📢"},FORTUNE_COMMIT:{icon:"fa-lock",color:"#a855f7",bg:"rgba(168,85,247,0.2)",label:"🔐 Game Committed",emoji:"🔐"},FORTUNE_REVEAL:{icon:"fa-dice",color:"#f97316",bg:"rgba(249,115,22,0.2)",label:"🎲 Game Revealed",emoji:"🎲"},FORTUNE_BET:{icon:"fa-paw",color:"#f97316",bg:"rgba(249,115,22,0.2)",label:"🐯 Fortune Bet",emoji:"🐯"},FORTUNE_COMBO:{icon:"fa-rocket",color:"#a855f7",bg:"rgba(168,85,247,0.2)",label:"🚀 Combo Mode",emoji:"🚀"},FORTUNE_WIN:{icon:"fa-trophy",color:"#facc15",bg:"rgba(234,179,8,0.25)",label:"🏆 Winner!",emoji:"🏆"},NOTARY:{icon:"fa-stamp",color:"#818cf8",bg:"rgba(99,102,241,0.15)",label:"📜 Notarized",emoji:"📜"},BACKCHAT_POST:{icon:"fa-comment",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"💬 Posted",emoji:"💬"},BACKCHAT_LIKE:{icon:"fa-heart",color:"#ec4899",bg:"rgba(236,72,153,0.15)",label:"❤️ Liked",emoji:"❤️"},BACKCHAT_REPLY:{icon:"fa-reply",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"↩️ Replied",emoji:"↩️"},BACKCHAT_SUPERLIKE:{icon:"fa-star",color:"#fbbf24",bg:"rgba(251,191,36,0.2)",label:"⭐ Super Liked",emoji:"⭐"},BACKCHAT_REPOST:{icon:"fa-retweet",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🔄 Reposted",emoji:"🔄"},BACKCHAT_FOLLOW:{icon:"fa-user-plus",color:"#a78bfa",bg:"rgba(167,139,250,0.15)",label:"👥 Followed",emoji:"👥"},BACKCHAT_PROFILE:{icon:"fa-user",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"👤 Profile Created",emoji:"👤"},BACKCHAT_BOOST:{icon:"fa-rocket",color:"#f97316",bg:"rgba(249,115,22,0.15)",label:"🚀 Profile Boosted",emoji:"🚀"},BACKCHAT_BADGE:{icon:"fa-circle-check",color:"#10b981",bg:"rgba(16,185,129,0.15)",label:"✅ Badge Activated",emoji:"✅"},BACKCHAT_TIP:{icon:"fa-coins",color:"#fbbf24",bg:"rgba(251,191,36,0.15)",label:"💰 Tipped BKC",emoji:"💰"},BACKCHAT_WITHDRAW:{icon:"fa-wallet",color:"#8b5cf6",bg:"rgba(139,92,246,0.15)",label:"💸 ETH Withdrawn",emoji:"💸"},CHARITY_DONATE:{icon:"fa-heart",color:"#ec4899",bg:"rgba(236,72,153,0.15)",label:"💝 Donated",emoji:"💝"},CHARITY_CREATE:{icon:"fa-hand-holding-heart",color:"#10b981",bg:"rgba(16,185,129,0.15)",label:"🌱 Campaign Created",emoji:"🌱"},CHARITY_CANCEL:{icon:"fa-heart-crack",color:"#ef4444",bg:"rgba(239,68,68,0.15)",label:"💔 Campaign Cancelled",emoji:"💔"},CHARITY_WITHDRAW:{icon:"fa-hand-holding-dollar",color:"#8b5cf6",bg:"rgba(139,92,246,0.15)",label:"💰 Funds Withdrawn",emoji:"💰"},CHARITY_GOAL_REACHED:{icon:"fa-trophy",color:"#fbbf24",bg:"rgba(251,191,36,0.15)",label:"🏆 Goal Reached!",emoji:"🏆"},FAUCET:{icon:"fa-droplet",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"💧 Faucet Claim",emoji:"💧"},DEFAULT:{icon:"fa-circle",color:"#71717a",bg:"rgba(39,39,42,0.5)",label:"Activity",emoji:"📋"}};function Lp(e){if(!e)return"Just now";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3,a=new Date(t*1e3),r=new Date-a,i=Math.floor(r/6e4),s=Math.floor(r/36e5),o=Math.floor(r/864e5);return i<1?"Just now":i<60?`${i}m ago`:s<24?`${s}h ago`:o<7?`${o}d ago`:a.toLocaleDateString()}catch{return"Recent"}}function Rp(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function en(e){return e>=1e6?(e/1e6).toFixed(2)+"M":e>=1e3?(e/1e3).toFixed(1)+"K":e.toFixed(0)}function _p(e){return e?`${e.slice(0,6)}...${e.slice(-4)}`:""}function Fp(e){if(!e)return"";const t=Date.now(),n=new Date(e).getTime()-t;if(n<=0)return"";const r=Math.floor(n/36e5),i=Math.floor(n%36e5/6e4);return r>0?`${r}h ${i}m`:`${i}m`}function Mp(e,t={}){const a=(e||"").toUpperCase().trim();return a==="STAKING"||a==="STAKED"||a==="STAKE"||a==="DELEGATED"||a==="DELEGATION"||a.includes("DELEGAT")?U.STAKING:a==="UNSTAKING"||a==="UNSTAKED"||a==="UNSTAKE"||a==="UNDELEGATED"?U.UNSTAKING:a==="FORCE_UNSTAKE"||a==="FORCEUNSTAKE"||a==="FORCE_UNSTAKED"?U.FORCE_UNSTAKE:a==="CLAIM"||a==="CLAIMED"||a==="REWARD"||a==="REWARDS"||a==="REWARD_CLAIMED"||a==="REWARDCLAIMED"?U.CLAIM:a==="NFT_BUY"||a==="NFTBUY"||a==="BOOSTER_BUY"||a==="BOOSTERBUY"||a==="BOOSTERBOUGHT"||a.includes("BUY")&&(a.includes("NFT")||a.includes("BOOSTER"))?U.NFT_BUY:a==="NFT_SELL"||a==="NFTSELL"||a==="BOOSTER_SELL"||a==="BOOSTERSELL"||a==="BOOSTERSOLD"||a.includes("SELL")&&(a.includes("NFT")||a.includes("BOOSTER"))?U.NFT_SELL:a==="NFT_MINT"||a==="NFTMINT"||a==="BOOSTER_MINT"||a==="BOOSTERMINT"||a==="MINTED"||a==="BOOSTERMINTED"?U.NFT_MINT:a==="NFT_TRANSFER"||a==="NFTTRANSFER"||a==="BOOSTER_TRANSFER"||a==="BOOSTERTRANSFER"||a==="TRANSFER"?U.NFT_TRANSFER:a==="RENTAL_LIST"||a==="RENTALLISTED"||a==="RENTAL_LISTED"||a==="LISTED"||a.includes("LIST")&&a.includes("RENTAL")?U.RENTAL_LIST:a==="RENTAL_RENT"||a==="RENTALRENTED"||a==="RENTAL_RENTED"||a==="RENTED"||a.includes("RENT")&&!a.includes("LIST")?U.RENTAL_RENT:a==="RENTAL_WITHDRAW"||a==="RENTALWITHDRAWN"||a==="RENTAL_WITHDRAWN"?U.RENTAL_WITHDRAW:a==="RENTAL_PROMOTE"||a==="RENTALPROMOTED"||a==="RENTAL_PROMOTED"||a.includes("PROMOT")||a.includes("ADS")||a.includes("ADVERTIS")?U.RENTAL_PROMOTE:a==="FORTUNE_COMMIT"||a==="GAMECOMMITTED"||a==="GAME_COMMITTED"||a==="COMMITTED"?U.FORTUNE_COMMIT:a==="FORTUNE_REVEAL"||a==="GAMEREVEALED"||a==="GAME_REVEALED"||a==="REVEALED"?U.FORTUNE_REVEAL:a.includes("GAME")||a.includes("FORTUNE")||a.includes("REQUEST")||a.includes("FULFILLED")||a.includes("RESULT")?(t==null?void 0:t.isWin)||(t==null?void 0:t.prizeWon)&&BigInt(t.prizeWon||0)>0n?U.FORTUNE_WIN:(t==null?void 0:t.isCumulative)?U.FORTUNE_COMBO:U.FORTUNE_BET:a==="POSTCREATED"||a==="POST_CREATED"||a==="POSTED"||a==="BACKCHAT_POST"||a.includes("POST")&&!a.includes("REPOST")?U.BACKCHAT_POST:a==="SUPERLIKED"||a==="SUPER_LIKED"||a.includes("SUPERLIKE")?U.BACKCHAT_SUPERLIKE:a==="LIKED"||a==="POSTLIKED"||a==="POST_LIKED"||a.includes("LIKE")&&!a.includes("SUPER")?U.BACKCHAT_LIKE:a==="REPLYCREATED"||a==="REPLY_CREATED"||a.includes("REPLY")?U.BACKCHAT_REPLY:a==="REPOSTCREATED"||a==="REPOST_CREATED"||a.includes("REPOST")?U.BACKCHAT_REPOST:a==="FOLLOWED"||a==="USER_FOLLOWED"||a.includes("FOLLOW")?U.BACKCHAT_FOLLOW:a==="PROFILECREATED"||a==="PROFILE_CREATED"||a.includes("PROFILE")&&a.includes("CREAT")?U.BACKCHAT_PROFILE:a==="PROFILEBOOSTED"||a==="PROFILE_BOOSTED"||a==="BOOSTED"||a.includes("BOOST")&&!a.includes("NFT")?U.BACKCHAT_BOOST:a==="BADGEACTIVATED"||a==="BADGE_ACTIVATED"||a.includes("BADGE")?U.BACKCHAT_BADGE:a==="TIPPROCESSED"||a==="TIP_PROCESSED"||a==="TIPPED"||a.includes("TIP")?U.BACKCHAT_TIP:a==="ETHWITHDRAWN"||a==="ETH_WITHDRAWN"||a==="BACKCHAT_WITHDRAW"?U.BACKCHAT_WITHDRAW:a==="CHARITYDONATION"||a==="DONATIONMADE"||a==="CHARITY_DONATE"||a==="DONATED"||a==="DONATION"||a.includes("DONATION")?U.CHARITY_DONATE:a==="CHARITYCAMPAIGNCREATED"||a==="CAMPAIGNCREATED"||a==="CHARITY_CREATE"||a==="CAMPAIGN_CREATED"||a.includes("CAMPAIGNCREATED")?U.CHARITY_CREATE:a==="CHARITYCAMPAIGNCANCELLED"||a==="CAMPAIGNCANCELLED"||a==="CHARITY_CANCEL"||a==="CAMPAIGN_CANCELLED"||a.includes("CANCELLED")?U.CHARITY_CANCEL:a==="CHARITYFUNDSWITHDRAWN"||a==="FUNDSWITHDRAWN"||a==="CHARITY_WITHDRAW"||a==="CAMPAIGN_WITHDRAW"||a.includes("WITHDRAWN")?U.CHARITY_WITHDRAW:a==="CHARITYGOALREACHED"||a==="GOALREACHED"||a==="CHARITY_GOAL"||a==="CAMPAIGN_COMPLETED"?U.CHARITY_GOAL_REACHED:a==="NOTARYREGISTER"||a==="NOTARIZED"||a.includes("NOTARY")||a.includes("DOCUMENT")?U.NOTARY:a==="FAUCETCLAIM"||a.includes("FAUCET")||a.includes("DISTRIBUTED")?U.FAUCET:U.DEFAULT}let yr=null,zt=0n;function Gc(e){const t=document.getElementById("dash-user-rewards");if(!t||!c.isConnected){yr&&cancelAnimationFrame(yr);return}const a=e-zt;a>-1000000000n&&a<1000000000n?zt=e:zt+=a/8n,zt<0n&&(zt=0n),t.innerHTML=`${D(zt).toFixed(4)} <span class="dash-reward-suffix">BKC</span>`,zt!==e&&(yr=requestAnimationFrame(()=>Gc(e)))}async function Ko(e){if(!c.isConnected||!c.userAddress)return x("Conecte a wallet primeiro","error");const t=e.innerHTML;e.disabled=!0,e.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-2"></i> Enviando...',L.faucet.isLoading=!0;let a=!1;try{console.log("[Faucet] Tentando API relayer...");const n=await fetch(`${Np}?address=${c.userAddress}`,{method:"GET",headers:{Accept:"application/json"}}),r=await n.json();if(console.log("[Faucet] API response:",n.status,r),n.ok&&r.success)a=!0,x(`Faucet: ${_r} BKC + ${Fr} ETH enviados!`,"success"),L.faucet.canClaim=!1,L.faucet.cooldownEnd=new Date(Date.now()+24*60*60*1e3).toISOString(),ln(),setTimeout(()=>{Hr.update(!0)},4e3);else{const i=r.error||r.message||"API indisponível";if(console.warn("[Faucet] API falhou:",i),i.toLowerCase().includes("cooldown")||i.toLowerCase().includes("wait")||i.toLowerCase().includes("hour")){x(i,"warning");const s=i.match(/(\d+)\s*hour/i);s&&(L.faucet.canClaim=!1,L.faucet.cooldownEnd=new Date(Date.now()+parseInt(s[1])*36e5).toISOString(),ln()),a=!0}}}catch(n){console.warn("[Faucet] API offline:",n.message)}if(!a)try{console.log("[Faucet] Fallback: claim on-chain direto..."),e.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-2"></i> Claim on-chain...';const{FaucetTx:n}=await O(async()=>{const{FaucetTx:i}=await Promise.resolve().then(()=>Wc);return{FaucetTx:i}},void 0),r=await n.claimOnChain({button:null,onSuccess:()=>{x(`Faucet: ${_r} BKC + ${Fr} ETH recebidos!`,"success"),L.faucet.canClaim=!1,L.faucet.cooldownEnd=new Date(Date.now()+24*60*60*1e3).toISOString(),ln(),setTimeout(()=>{Hr.update(!0)},4e3)},onError:i=>{console.error("[Faucet] On-chain falhou:",i);const s=i.message||"Erro no claim";s.includes("Aguarde")||s.includes("cooldown")?x(s,"warning"):s.includes("InsufficientTokens")||s.includes("InsufficientETH")?x("Faucet sem saldo. Contate o admin.","error"):s.includes("user rejected")||s.includes("denied")?x("Transação cancelada","warning"):x(`Faucet: ${s}`,"error")}})}catch(n){console.error("[Faucet] On-chain erro:",n);const r=n.message||"";r.includes("Aguarde")||r.includes("cooldown")?x(r,"warning"):x("Faucet indisponível. Tente novamente.","error")}L.faucet.isLoading=!1,e.disabled=!1,e.innerHTML=t}function ln(){const e=document.getElementById("dashboard-faucet-widget");if(!e)return;const t=document.getElementById("faucet-title"),a=document.getElementById("faucet-desc"),n=document.getElementById("faucet-status"),r=document.getElementById("faucet-action-btn");if(!c.isConnected){e.style.opacity="0.5",t&&(t.innerText="Get Free Testnet Tokens"),a&&(a.innerText="Connect your wallet to claim BKC + ETH for gas"),n&&n.classList.add("hidden"),r&&(r.className="dash-btn-secondary",r.innerHTML='<i class="fa-solid fa-wallet"></i> Connect Wallet',r.disabled=!0);return}e.style.opacity="1";const i=Fp(L.faucet.cooldownEnd);!(L.faucet.canClaim&&!i)&&i?(t&&(t.innerText="Faucet Cooldown"),a&&(a.innerText="Come back when the timer ends"),n&&(n.classList.remove("hidden"),n.innerHTML=`<i class="fa-solid fa-clock" style="margin-right:4px"></i>${i} remaining`),r&&(r.className="dash-btn-secondary",r.innerHTML='<i class="fa-solid fa-hourglass-half"></i> On Cooldown',r.disabled=!0)):(t&&(t.innerText="Get Free Testnet Tokens"),a&&(a.innerText="Claim BKC tokens and ETH for gas — free every 24h"),n&&n.classList.add("hidden"),r&&(r.className="dash-btn-primary dash-btn-cyan",r.innerHTML='<i class="fa-solid fa-faucet"></i> Claim Free Tokens',r.disabled=!1))}function Dp(){try{const e=window.location.hash||"",t=e.indexOf("?");if(t===-1)return;const n=new URLSearchParams(e.substring(t)).get("ref");if(n&&Qe.isAddress(n)){const r=localStorage.getItem("backchain_referrer");(!r||r.toLowerCase()!==n.toLowerCase())&&(localStorage.setItem("backchain_referrer",n),console.log("[Referral] Saved referrer from URL:",n))}}catch{}}async function Yo(){if(!c.isConnected||!c.userAddress)return;const e=localStorage.getItem("backchain_referrer");if(!(!e||!Qe.isAddress(e))){if(e.toLowerCase()===c.userAddress.toLowerCase()){localStorage.removeItem("backchain_referrer");return}try{const t=v==null?void 0:v.backchainEcosystem;if(!t)return;const{ecosystemManagerABI:a}=await O(async()=>{const{ecosystemManagerABI:u}=await Promise.resolve().then(()=>Fl);return{ecosystemManagerABI:u}},void 0),{NetworkManager:n}=await O(async()=>{const{NetworkManager:u}=await Promise.resolve().then(()=>J);return{NetworkManager:u}},void 0),r=n.getProvider(),s=await new Qe.Contract(t,a,r).referredBy(c.userAddress);if(s&&s!=="0x0000000000000000000000000000000000000000"){localStorage.removeItem("backchain_referrer");return}const o=await c.provider.getSigner(),l=new Qe.Contract(t,a,o);console.log("[Referral] Auto-setting referrer:",e),await(await l.setReferrer(e)).wait(),localStorage.removeItem("backchain_referrer"),x("Referrer set! They will earn 5% of your staking rewards.","success"),va()}catch(t){console.warn("[Referral] Auto-set failed:",t.message)}}}async function Op(){if(!c.isConnected||!c.userAddress)return{count:0,referrer:null};try{const e=v==null?void 0:v.backchainEcosystem;if(!e)return{count:0,referrer:null};const{ecosystemManagerABI:t}=await O(async()=>{const{ecosystemManagerABI:o}=await Promise.resolve().then(()=>Fl);return{ecosystemManagerABI:o}},void 0),{NetworkManager:a}=await O(async()=>{const{NetworkManager:o}=await Promise.resolve().then(()=>J);return{NetworkManager:o}},void 0),n=a.getProvider(),r=new Qe.Contract(e,t,n),[i,s]=await Promise.all([r.referralCount(c.userAddress),r.referredBy(c.userAddress)]);return{count:Number(i),referrer:s!=="0x0000000000000000000000000000000000000000"?s:null}}catch(e){return console.warn("[Referral] Load failed:",e.message),{count:0,referrer:null}}}async function va(){const e=document.getElementById("dashboard-referral-widget");if(!e)return;const t=document.getElementById("referral-title"),a=document.getElementById("referral-desc"),n=document.getElementById("referral-stats"),r=document.getElementById("referral-link-container"),i=document.getElementById("referral-link-text"),s=document.getElementById("referral-share-btn"),o=document.getElementById("referral-count");if(!c.isConnected||!c.userAddress){e.style.opacity="0.5",t&&(t.innerText="Invite & Earn Forever"),a&&(a.innerText="Connect your wallet to get your referral link"),n&&(n.style.display="none"),r&&(r.style.display="none"),s&&(s.style.display="none");return}e.style.opacity="1";const l=`${window.location.origin}/#dashboard?ref=${c.userAddress}`;i&&(i.textContent=l),r&&(r.style.display="flex"),s&&(s.style.display="");const d=await Op();o&&(o.textContent=d.count),n&&(n.style.display="flex"),d.count>0?(t&&(t.innerText=`${d.count} Referral${d.count>1?"s":""} Earning for You`),a&&(a.innerText="You earn 5% of every staking reward they claim. Keep sharing!")):(t&&(t.innerText="Invite & Earn Forever"),a&&(a.innerText="Share your link. Earn 5% of every staking reward your referrals claim — forever."))}function Hp(){if(!c.userAddress)return;const e=`${window.location.origin}/#dashboard?ref=${c.userAddress}`;navigator.clipboard.writeText(e).then(()=>{x("Referral link copied!","success");const t=document.getElementById("referral-copy-btn");t&&(t.innerHTML='<i class="fa-solid fa-check"></i>',setTimeout(()=>{t.innerHTML='<i class="fa-solid fa-copy"></i>'},2e3))}).catch(()=>x("Failed to copy","error"))}function Up(){if(!c.userAddress)return;const e=`${window.location.origin}/#dashboard?ref=${c.userAddress}`,t=`Join Backchain and earn crypto!
...
#Backchain #DeFi #Arbitrum #Web3`;navigator.share?navigator.share({title:"Backchain — Invite & Earn",text:t,url:e}).catch(()=>{}):navigator.clipboard.writeText(t).then(()=>x("Share text copied!","success")).catch(()=>{})}async function jp(){try{if(await c.provider.getBalance(c.userAddress)<Qe.parseEther("0.002")){const t=document.getElementById("no-gas-modal-dash");return t&&(t.classList.remove("hidden"),t.classList.add("flex")),!1}return!0}catch{return!0}}function Wp(){if(document.getElementById("dash-styles-v69"))return;const e=document.createElement("style");e.id="dash-styles-v69",e.textContent=`
        /* ── CSS Variables ── */
        .dash-shell {
            --dash-bg: #0c0c0e;
            --dash-surface: #141417;
    ...
    `,document.head.appendChild(e)}function Gp(){Se.dashboard&&(Wp(),Se.dashboard.innerHTML=`
    ...
    `}async function Vp(){try{const e=await fetch($p);if(e.ok){const t=await e.json();return L.economicData=t,t}}catch{}return null}async function Mr(){var e,t,a,n,r,i,s;try{const o=await Vp();let l=0n,d=0n,u=0n,m=0n,p=0n,b=0,f=0n;if(o&&((e=o.token)!=null&&e.totalSupply&&(l=BigInt(o.token.totalSupply)),(t=o.token)!=null&&t.totalBurned&&(m=BigInt(o.token.totalBurned)),(a=o.staking)!=null&&a.totalPStake&&(d=BigInt(o.staking.totalPStake)),(n=o.ecosystem)!=null&&n.totalEthCollected&&(p=BigInt(o.ecosystem.totalEthCollected)),(r=o.fortunePool)!=null&&r.prizePool&&(f=BigInt(o.fortunePool.prizePool)),(i=o.notary)!=null&&i.certCount&&(b=o.notary.certCount),(s=o.stats)!=null&&s.notarizedDocuments&&(b=Math.max(b,o.stats.notarizedDocuments))),c.bkcTokenContractPublic){l===0n&&(l=await ae(c.bkcTokenContractPublic,"totalSupply",[],0n)),m===0n&&(m=await ae(c.bkcTokenContractPublic,"totalBurned",[],0n)),d===0n&&(c.stakingPoolContractPublic||c.stakingPoolContract)&&(d=await ae(c.stakingPoolContractPublic||c.stakingPoolContract,"totalPStake",[],0n));const F=[v.stakingPool,v.fortunePool,v.rentalManager,v.buybackMiner,v.liquidityPool,v.pool_diamond,v.pool_gold,v.pool_silver,v.pool_bronze].filter(V=>V&&V!==Qe.ZeroAddress),ne=await Promise.all(F.map(V=>ae(c.bkcTokenContractPublic,"balanceOf",[V],0n)));if(ne.forEach(V=>{u+=V}),v.fortunePool&&f===0n){const V=F.indexOf(v.fortunePool);V>=0&&(f=ne[V])}}const w=D(l),k=D(m),C=D(p),P=D(f),S=F=>F.toLocaleString("en-US",{minimumFractionDigits:1,maximumFractionDigits:1}),_=D(u),B=(F,ne)=>{const V=document.getElementById(F);V&&(V.innerHTML=ne)};B("dash-metric-supply",`${S(w)} <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>`),B("dash-metric-pstake",aa(d)),B("dash-metric-burned",k>0?`<span style="color:#ef4444">${en(k)}</span> <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>`:'<span style="color:var(--dash-text-3)">0 BKC</span>'),B("dash-metric-fees",C>0?`${en(C)} <span style="font-size:10px;color:var(--dash-text-3)">ETH</span>`:'<span style="color:var(--dash-text-3)">0 ETH</span>'),B("dash-metric-locked",_>0?`<span style="color:#60a5fa">${en(_)}</span> <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>`:'<span style="color:var(--dash-text-3)">0 BKC</span>'),Kc();const I=document.getElementById("dash-fortune-prize-text");I&&(I.innerText=P>0?`Prize: ${en(P)} BKC`:"Play to win");const N=document.getElementById("dash-notary-count-text");N&&(N.innerText=b>0?`${b} docs certified`:"Certify documents"),L.metricsCache={supply:w,burned:k,fees:C,timestamp:Date.now()}}catch(o){console.error("Metrics Error",o)}}function Kc(){const e=document.getElementById("dash-metric-balance");if(!e)return;const t=c.currentUserBalance||c.bkcBalance||0n;if(!c.isConnected){e.innerHTML='<span style="font-size:11px;color:var(--dash-text-3)">Connect Wallet</span>';return}if(t===0n)e.innerHTML='0.00 <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>';else{const a=D(t);e.innerHTML=`${a.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>`}}async function qp(){if(c.userAddress)try{const e=await fetch(`https://getuserprofile-4wvdcuoouq-uc.a.run.app/${c.userAddress}`);e.ok&&(L.userProfile=await e.json())}catch{}}async function Zt(e=!1){var t,a;if(!c.isConnected){const n=document.getElementById("dash-booster-area");n&&(n.innerHTML=`
                <div style="text-align:center">
                ...
                </div>`);return}try{const n=document.getElementById("dash-user-rewards");e&&n&&(n.style.opacity="0.6");const[,r,i]=await Promise.all([Fn(),wu(),Wl()]),s=(r==null?void 0:r.netClaimAmount)||0n;Gc(s),n&&(n.style.opacity="1");const o=document.getElementById("dashboardClaimBtn");o&&(o.disabled=s<=0n);const l=document.getElementById("dash-user-pstake");if(l){let d=((t=c.userData)==null?void 0:t.pStake)||((a=c.userData)==null?void 0:a.userTotalPStake)||c.userTotalPStake||0n;if(d===0n&&(c.stakingPoolContractPublic||c.stakingPoolContract)&&c.userAddress)try{d=await ae(c.stakingPoolContractPublic||c.stakingPoolContract,"userTotalPStake",[c.userAddress],0n)}catch{}l.innerText=aa(d)}Kc(),Xp(i,r),qp(),ln()}catch(n){console.error("User Hub Error:",n)}}function Xp(e,t){var N;const a=document.getElementById("dash-booster-area");if(!a)return;const n=(e==null?void 0:e.highestBoost)||0,r=tt(n),i=(t==null?void 0:t.totalRewards)||0n,s=i*BigInt(r)/100n,l=i-s,d=Bl(n),u=(e==null?void 0:e.imageUrl)||(d==null?void 0:d.image)||"./assets/bkc_logo_3d.png",m=be.find(F=>F.name==="Diamond");if(m!=null&&m.image,n===0){if(l>0n){const F=document.getElementById("dash-user-gain-area");F&&(F.classList.add("visible"),document.getElementById("dash-user-potential-gain").innerText=D(l).toFixed(2))}a.innerHTML=`
            <div style="text-align:center;width:100%">
                ...
                <p style="font-size:10px;color:var(--dash-text-2);margin:0 0 10px">
                    <i class="fa-solid fa-arrow-up" style="color:var(--dash-green);margin-right:3px"></i>Get up to <span style="color:var(--dash-green);font-weight:700">+${D(l).toFixed(2)} BKC</span> with NFT
                </p>`:`
        ...
        `;return}const p=e.source==="rented",b=(d==null?void 0:d.name)||((N=e.boostName)==null?void 0:N.replace(" Booster","").replace("Booster","").trim())||"Booster",f=(d==null?void 0:d.color)||"color:var(--dash-accent)",w=i*50n/100n,k=s-w,C=p?"fa-clock":"fa-check-circle",P=p?"#22d3ee":"#4ade80",S=p?"rgba(6,182,212,0.12)":"rgba(74,222,128,0.12)",_=p?"rgba(6,182,212,0.3)":"rgba(74,222,128,0.3)",B=p?"RENTED":"OWNED",I=p?"Active rental":"In your wallet";a.innerHTML=`
        <div class="nft-clickable-image" data-address="${v.rewardBooster}" data-tokenid="${e.tokenId}" style="width:100%;cursor:pointer;transition:all 0.2s">
            <div style="display:flex;align-items:center;gap:10px;background:var(--dash-surface-2);border:1px solid ${_};border-radius:12px;padding:10px 12px;margin-bottom:8px">
                <div style="position:relative;width:48px;height:48px;flex-shrink:0">
                    <img src="${u}" style="width:48px;height:48px;border-radius:10px;object-fit:cover;border:2px solid ${_}" alt="${b}" onerror="this.src='./assets/bkc_logo_3d.png'">
            ...
            <div style="display:flex;gap:6px">
                ...
                <div style="flex:1;background:var(--dash-surface-2);border-radius:8px;padding:6px 8px;text-align:center">
                    ...
                    <div style="font-size:12px;font-weight:700;color:#34d399">+${D(k).toFixed(2)} <span style="font-size:9px;color:var(--dash-text-3)">BKC</span></div>
                </div>`:""}
            </div>`:""}
            ${r<100?`
    ...
    `}async function bn(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("activity-title");try{if(c.isConnected){if(L.activities.length===0){e&&(e.innerHTML='<div class="dash-loading"><img src="./assets/bkc_logo_3d.png" class="dash-loading-logo" alt=""><span class="dash-loading-text">Loading your activity...</span></div>');const a=await fetch(`${Ye.getHistory}/${c.userAddress}`);a.ok&&(L.activities=await a.json())}if(L.activities.length>0){t&&(t.textContent="Your Activity"),Dr();return}}t&&(t.textContent="Network Activity"),await Vo()}catch(a){console.error("Activity fetch error:",a),t&&(t.textContent="Network Activity"),await Vo()}}async function Vo(){const e=document.getElementById("dash-activity-list");if(!e||L.isLoadingNetworkActivity)return;const t=Date.now()-L.networkActivitiesTimestamp;if(L.networkActivities.length>0&&t<3e5){qo();return}L.isLoadingNetworkActivity=!0,e.innerHTML='<div class="dash-loading"><img src="./assets/bkc_logo_3d.png" class="dash-loading-logo" alt=""><span class="dash-loading-text">Loading network activity...</span></div>';try{const a=await fetch(`${Sp}?limit=30`);if(a.ok){const n=await a.json();L.networkActivities=Array.isArray(n)?n:n.activities||[],L.networkActivitiesTimestamp=Date.now()}else L.networkActivities=[]}catch{L.networkActivities=[]}finally{L.isLoadingNetworkActivity=!1}qo()}function qo(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("dash-pagination-controls");if(!e)return;if(L.networkActivities.length===0){e.innerHTML=`
            ...
            </div>`,t&&(t.style.display="none");const s=document.getElementById("activity-count");s&&(s.style.display="none");return}const a=document.getElementById("activity-count");a&&(a.style.display="inline",a.textContent=L.filteredActivities.length);const n=(L.pagination.currentPage-1)*L.pagination.itemsPerPage,r=L.filteredActivities.slice(n,n+L.pagination.itemsPerPage);if(e.innerHTML=r.map(i=>Yc(i,!1)).join(""),t){const i=Math.ceil(L.filteredActivities.length/L.pagination.itemsPerPage);i>1?(t.style.display="flex",document.getElementById("page-indicator").innerText=`${L.pagination.currentPage}/${i}`,document.getElementById("page-prev").disabled=L.pagination.currentPage===1,document.getElementById("page-next").disabled=L.pagination.currentPage>=i):t.style.display="none"}}function Yc(e,t=!1){const a=Lp(e.timestamp||e.createdAt),n=Rp(e.timestamp||e.createdAt),r=e.user||e.userAddress||e.from||"",i=_p(r),s=Mp(e.type,e.details);let o="";const l=(e.type||"").toUpperCase().trim(),d=e.details||{};if(l.includes("GAME")||l.includes("FORTUNE")||l.includes("REQUEST")||l.includes("FULFILLED")||l.includes("RESULT")){const w=d.rolls||e.rolls||[],k=d.guesses||e.guesses||[],C=d.isWin||d.prizeWon&&BigInt(d.prizeWon||0)>0n,P=d.isCumulative!==void 0?d.isCumulative:k.length>1,S=P?"Combo":"Jackpot",_=P?"background:rgba(168,85,247,0.15);color:#c084fc":"background:rgba(245,158,11,0.15);color:#fbbf24",B=d.wagerAmount||d.amount,I=d.prizeWon,N=B?D(BigInt(B)).toFixed(0):"0";let F='<span style="color:var(--dash-text-3)">No win</span>';C&&I&&BigInt(I)>0n&&(F=`<span style="color:var(--dash-green);font-weight:700">+${D(BigInt(I)).toFixed(0)} BKC</span>`);let ne="";return w.length>0&&(ne=`<div style="display:flex;gap:3px">${w.map((he,ce)=>{const Y=k[ce],ie=Y!==void 0&&Number(Y)===Number(he);return`<div style="width:24px;height:24px;border-radius:4px;font-size:10px;font-weight:700;display:flex;align-items:center;justify-content:center;border:1px solid ${ie?"rgba(52,211,153,0.4)":"var(--dash-border)"};background:${ie?"rgba(52,211,153,0.1)":"var(--dash-surface-2)"};color:${ie?"#34d399":"var(--dash-text-3)"}">${he}</div>`}).join("")}</div>`),`
            <a href="${e.txHash?`${Go}${e.txHash}`:"#"}" target="_blank" class="dash-fortune-item" title="${n}">
                <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:6px">
                    <div style="display:flex;align-items:center;gap:8px">
                        ...
                        <span style="font-size:9px;font-weight:700;${_};padding:1px 6px;border-radius:4px">${S}</span>
                    </div>
        ...
        `}if(l.includes("NOTARY")){const w=d.ipfsCid;w&&(o=`<span style="margin-left:4px;font-size:9px;color:#818cf8;font-family:monospace">${w.replace("ipfs://","").slice(0,12)}...</span>`)}if(l.includes("STAKING")||l.includes("DELEGAT")){const w=d.pStakeGenerated;w&&(o=`<span style="font-size:10px;color:var(--dash-purple)">+${D(BigInt(w)).toFixed(0)} pStake</span>`)}if(l.includes("DONATION")||l.includes("CHARITY")){const w=d.netAmount||d.amount,k=d.campaignId;w&&BigInt(w)>0n&&(o=`<span style="color:#ec4899;font-weight:700">${D(BigInt(w)).toFixed(2)} BKC</span>`,k&&(o+=`<span style="margin-left:4px;font-size:9px;color:var(--dash-text-3)">Campaign #${k}</span>`))}if(l.includes("CLAIM")||l.includes("REWARD")){const w=d.amount||e.amount;w&&(o=`<span style="color:var(--dash-accent);font-weight:700">+${D(BigInt(w)).toFixed(2)} BKC</span>`);const k=d.feePaid;k&&BigInt(k)>0n&&(o+=`<span style="margin-left:4px;font-size:9px;color:var(--dash-text-3)">(fee: ${D(BigInt(k)).toFixed(2)})</span>`)}const m=l.includes("PROMOT")||l.includes("ADS")||l.includes("ADVERTIS");if(m){const w=d.promotionFee||d.amount||e.amount;w&&BigInt(w)>0n&&(o=`<span style="color:#fbbf24;font-weight:700">${parseFloat(Qe.formatEther(BigInt(w))).toFixed(4)} ETH</span>`);const k=d.tokenId||e.tokenId;k&&(o+=`<span style="margin-left:4px;font-size:9px;color:var(--dash-text-3)">NFT #${k}</span>`)}const p=e.txHash?`${Go}${e.txHash}`:"#";let b="";if(m){const w=d.promotionFee||d.amount||e.amount;w&&BigInt(w)>0n&&(b=parseFloat(Qe.formatEther(BigInt(w))).toFixed(4))}else{let w=e.amount||d.netAmount||d.amount||d.wagerAmount||d.prizeWon||"0";const k=D(BigInt(w));b=k>.001?k.toFixed(2):""}const f=m?"ETH":"BKC";return`
    ...
    `}function Jp(){Se.dashboard&&Se.dashboard.addEventListener("click",async e=>{const t=e.target;if(t.closest("#manual-refresh-btn")){const i=t.closest("#manual-refresh-btn");i.disabled=!0,i.innerHTML='<i class="fa-solid fa-rotate fa-spin"></i>',await Zt(!0),await Mr(),L.activities=[],L.networkActivities=[],L.networkActivitiesTimestamp=0,L.faucet.lastCheck=0,await bn(),setTimeout(()=>{i.innerHTML='<i class="fa-solid fa-rotate"></i>',i.disabled=!1},1e3)}if(t.closest("#faucet-action-btn")){const i=t.closest("#faucet-action-btn");i.disabled||await Ko(i)}if(t.closest("#emergency-faucet-btn")&&await Ko(t.closest("#emergency-faucet-btn")),t.closest("#referral-copy-btn")&&Hp(),t.closest("#referral-share-btn")&&Up(),t.closest(".delegate-link")&&(e.preventDefault(),window.navigateTo("mine")),t.closest(".go-to-store")&&(e.preventDefault(),window.navigateTo("store")),t.closest(".go-to-rental")&&(e.preventDefault(),window.navigateTo("rental")),t.closest(".go-to-fortune")&&(e.preventDefault(),window.navigateTo("actions")),t.closest(".go-to-notary")&&(e.preventDefault(),window.navigateTo("notary")),t.closest(".go-to-charity")&&(e.preventDefault(),window.navigateTo("charity")),t.closest(".go-to-backchat")&&(e.preventDefault(),window.navigateTo("backchat")),t.closest("#open-booster-info")){const i=document.getElementById("booster-info-modal");i&&i.classList.add("visible")}if(t.closest("#close-booster-modal")||t.id==="booster-info-modal"){const i=document.getElementById("booster-info-modal");i&&i.classList.remove("visible")}if(t.closest("#close-gas-modal-dash")||t.id==="no-gas-modal-dash"){const i=document.getElementById("no-gas-modal-dash");i&&i.classList.remove("visible")}const a=t.closest(".nft-clickable-image");if(a){const i=a.dataset.address,s=a.dataset.tokenid;i&&s&&su(i,s)}const n=t.closest("#dashboardClaimBtn");if(n&&!n.disabled)try{if(n.innerHTML='<i class="fa-solid fa-circle-notch fa-spin"></i>',n.disabled=!0,!await jp()){n.innerHTML='<i class="fa-solid fa-coins" style="margin-right:6px"></i> Claim Rewards',n.disabled=!1;return}const{stakingRewards:s,minerRewards:o}=await ii();(s>0n||o>0n)&&await Ht.claimRewards({button:n,onSuccess:async()=>{x("Rewards claimed!","success"),await Zt(!0),L.activities=[],bn()},onError:l=>{l.cancelled||x("Claim failed","error")}})}catch{x("Claim failed","error")}finally{n.innerHTML='<i class="fa-solid fa-coins" style="margin-right:6px"></i> Claim Rewards',n.disabled=!1}if(t.closest("#page-prev")&&L.pagination.currentPage>1&&(L.pagination.currentPage--,Or()),t.closest("#page-next")){const i=Math.ceil(L.filteredActivities.length/L.pagination.itemsPerPage);L.pagination.currentPage<i&&(L.pagination.currentPage++,Or())}t.closest("#activity-sort-toggle")&&(L.filters.sort=L.filters.sort==="NEWEST"?"OLDEST":"NEWEST",Dr());const r=t.closest(".dash-chip");r&&(document.querySelectorAll(".dash-chip").forEach(i=>i.classList.remove("active")),r.classList.add("active"),L.filters.type=r.dataset.filter,Dr())})}const Hr={async render(e){Gp(),Dp(),Mr(),bn(),va(),c.isConnected?(await Zt(!1),Yo()):(setTimeout(async()=>{c.isConnected&&(await Zt(!1),Yo(),va())},500),setTimeout(async()=>{c.isConnected&&(await Zt(!1),va())},1500))},update(e){const t=Date.now();t-L.lastUpdate>1e4&&(L.lastUpdate=t,Mr(),e&&(Zt(!1),va()),bn())}},Ba=window.ethers,Zp="https://sepolia.arbiscan.io/tx/",Jt={NONE:{boost:0,burnRate:50,keepRate:50,color:"#71717a",name:"None",icon:"○",class:"stk-tier-none"},BRONZE:{boost:1e3,burnRate:40,keepRate:60,color:"#cd7f32",name:"Bronze",icon:"🥉",class:"stk-tier-bronze"},SILVER:{boost:2500,burnRate:25,keepRate:75,color:"#c0c0c0",name:"Silver",icon:"🥈",class:"stk-tier-silver"},GOLD:{boost:4e3,burnRate:10,keepRate:90,color:"#ffd700",name:"Gold",icon:"🥇",class:"stk-tier-gold"},DIAMOND:{boost:5e3,burnRate:0,keepRate:100,color:"#b9f2ff",name:"Diamond",icon:"💎",class:"stk-tier-diamond"}};let Qt=!1,Na=0,Vs=3650,Ge=!1,gn=[],cn=0n,Lt=null,wa="ALL",pt=0,Ur=50,Xo="none",ve=null,jr=0n,qs=0n,Xs=0n;function Vc(e){if(e<=0)return"Ready";const t=Math.floor(e/86400),a=Math.floor(e%86400/3600),n=Math.floor(e%3600/60);return t>365?`${Math.floor(t/365)}y ${Math.floor(t%365/30)}mo`:t>30?`${Math.floor(t/30)}mo ${t%30}d`:t>0?`${t}d ${a}h`:a>0?`${a}h ${n}m`:`${n}m`}function Qp(e){if(e>=365){const t=Math.floor(e/365);return t===1?"1 Year":`${t} Years`}return e>=30?`${Math.floor(e/30)} Month(s)`:`${e} Day(s)`}function em(e,t){if(e<=0n||t<=0n)return 0n;const a=t/86400n,n=10000n,r=n+a*5918n/365n;return e*r/n}function tm(e){if(!e)return"Recent";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleDateString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return"Recent"}}function qc(e){const t=Number(e);return t>=5e3?Jt.DIAMOND:t>=4e3?Jt.GOLD:t>=2500?Jt.SILVER:t>=1e3?Jt.BRONZE:Jt.NONE}function am(){if(document.getElementById("stk-styles-v10"))return;const e=document.createElement("style");e.id="stk-styles-v10",e.textContent=`
        .stk-shell {
            --stk-bg: #0c0c0e;
            --stk-surface: #141417;
    ...
    `,document.head.appendChild(e)}function nm(){const e=document.getElementById("mine");e&&(am(),e.innerHTML=`
        <div class="stk-shell">
    ...
    `,gm(),c.isConnected?pa():Xc())}async function pa(e=!1){if(Qt)return;const t=Date.now();if(!(!e&&t-Na<1e4)){Qt=!0,Na=t;try{await rm();const[,,a]=await Promise.all([Fn(),Ul(),xu()]),n=c.stakingPoolContractPublic||c.stakingPoolContract;n&&(cn=await ae(n,"totalPStake",[],0n)),await im();const{stakingRewards:r,minerRewards:i}=await ii();qs=r||0n,Xs=i||0n,sm(),om(),lm(),cm(),pm(),ka()}catch(a){console.error("Staking data load error:",a)}finally{Qt=!1}}}async function rm(){if(c.userAddress)try{const e=c.stakingPoolContractPublic||c.stakingPoolContract;if(e){const a=await ae(e,"getUserBestBoost",[c.userAddress],0n);pt=Number(a)}if(pt===0){const a=await Wl();a&&a.highestBoost>0&&(pt=a.highestBoost,Xo=a.source||"api")}else Xo="active";Ur=qc(pt).burnRate}catch(e){console.error("NFT boost load error:",e)}}async function im(){const e=c.stakingPoolContractPublic||c.stakingPoolContract;if(!(!c.userAddress||!e))try{const t=await ae(e,"previewClaim",[c.userAddress],null);t&&(ve={totalRewards:t.totalRewards||t[0]||0n,burnAmount:t.burnAmount||t[1]||0n,referrerCut:t.referrerCut||t[2]||0n,userReceives:t.userReceives||t[3]||0n,burnRateBips:t.burnRateBps||t[4]||0n,nftBoost:t.nftBoost||t[5]||0n}),jr=0n}catch(t){console.error("Claim preview error:",t);const a=qs+Xs,n=a*BigInt(Ur)/100n;ve={totalRewards:a,burnAmount:n,referrerCut:0n,userReceives:a-n,burnRateBips:BigInt(Ur*100),nftBoost:BigInt(pt)}}}function sm(){const e=document.getElementById("stk-reward-value"),t=document.getElementById("stk-claim-btn"),a=document.getElementById("stk-breakdown"),n=document.getElementById("stk-eth-fee"),r=(ve==null?void 0:ve.userReceives)||0n;ve!=null&&ve.totalRewards;const i=(ve==null?void 0:ve.burnAmount)||0n,s=r>0n;if(e){const o=D(r);e.innerHTML=`${o.toFixed(4)} <span class="stk-reward-suffix">BKC</span>`}if(t){t.disabled=!s;const o=t.querySelector("span");o&&(o.textContent=s?"Claim Rewards":"No Rewards Yet")}if(a&&s){a.style.display="";const o=D(qs).toFixed(4),l=D(Xs).toFixed(4),d=D(i).toFixed(4);document.getElementById("stk-break-staking").textContent=`${o} BKC`,document.getElementById("stk-break-mining").textContent=`${l} BKC`,document.getElementById("stk-break-burned").textContent=i>0n?`-${d} BKC`:"None",document.getElementById("stk-break-burned").style.color=i>0n?"var(--stk-red)":"var(--stk-green)"}else a&&(a.style.display="none");if(n)if(s&&jr>0n){const o=parseFloat(Ba.formatEther(jr)).toFixed(6);n.innerHTML=`<i class="fa-brands fa-ethereum" style="margin-right:3px"></i>Claim fee: ${o} ETH`}else n.textContent=""}function om(){const e=document.getElementById("stk-boost-panel");if(!e)return;const t=qc(pt),a=pt>0;e.innerHTML=`
    ...
    `}function lm(){var u,m,p,b;const e=(f,w)=>{const k=document.getElementById(f);k&&(k.innerHTML=w)};e("stk-stat-network",aa(cn));const t=((u=c.userData)==null?void 0:u.pStake)||((m=c.userData)==null?void 0:m.userTotalPStake)||c.userTotalPStake||0n,a=cn>0n?Number(t*10000n/cn)/100:0;e("stk-stat-power",`${aa(t)} <span style="font-size:10px;color:var(--stk-text-3)">(${a.toFixed(2)}%)</span>`);const n=(ve==null?void 0:ve.userReceives)||0n,r=D(n);e("stk-stat-rewards",r>0?`<span style="color:var(--stk-green)">${r.toFixed(2)}</span> <span style="font-size:10px;color:var(--stk-text-3)">BKC</span>`:'<span style="color:var(--stk-text-3)">0 BKC</span>');const i=((p=c.userDelegations)==null?void 0:p.length)||0;e("stk-stat-locks",`${i}`);const s=c.currentUserBalance||0n,o=document.getElementById("stk-balance-display");o&&(o.textContent=s>0n?`${D(s).toFixed(2)} BKC`:"0.00 BKC");const l=((b=c.systemFees)==null?void 0:b.DELEGATION_FEE_BIPS)||50n,d=document.getElementById("stk-fee-info");d&&(d.textContent=`${Number(l)/100}%`)}function Xc(){const e=(s,o)=>{const l=document.getElementById(s);l&&(l.innerHTML=o)};e("stk-reward-value",'-- <span class="stk-reward-suffix">BKC</span>'),e("stk-stat-network","--"),e("stk-stat-power","--"),e("stk-stat-rewards","--"),e("stk-stat-locks","--"),e("stk-balance-display","-- BKC");const t=document.getElementById("stk-claim-btn");t&&(t.disabled=!0);const a=document.getElementById("stk-breakdown");a&&(a.style.display="none");const n=document.getElementById("stk-deleg-list");n&&(n.innerHTML='<div class="stk-empty"><i class="fa-solid fa-wallet"></i><p>Connect wallet to view</p></div>');const r=document.getElementById("stk-history-list");r&&(r.innerHTML='<div class="stk-empty"><i class="fa-solid fa-wallet"></i><p>Connect wallet to view</p></div>');const i=document.getElementById("stk-boost-panel");i&&(i.innerHTML='<div class="stk-empty"><i class="fa-solid fa-wallet"></i><p>Connect wallet</p></div>')}function cm(){const e=document.getElementById("stk-deleg-list"),t=document.getElementById("stk-deleg-count");if(!e)return;const a=c.userDelegations||[];if(t&&(t.textContent=a.length),a.length===0){e.innerHTML='<div class="stk-empty"><i class="fa-solid fa-inbox"></i><p>No active delegations</p></div>';return}Lt&&(clearInterval(Lt),Lt=null);const n=[...a].sort((r,i)=>Number(r.unlockTime)-Number(i.unlockTime));e.innerHTML=n.map((r,i)=>dm(r,i)).join(""),Lt=setInterval(um,6e4),e.querySelectorAll(".stk-unstake-btn").forEach(r=>{r.addEventListener("click",()=>fm(parseInt(r.dataset.index),r.classList.contains("stk-unstake-force")))})}function dm(e,t){const a=D(e.amount||0n),n=e.lockDays||Number(e.lockDuration||0n)/86400,r=Number(e.unlockTime||e.lockEnd||0n),i=Math.floor(Date.now()/1e3),s=r>i,o=s?r-i:0,l=e.lockDuration||BigInt(e.lockDays||0)*86400n,d=e.pStake||em(e.amount||0n,l);return`
        <div class="stk-deleg-item">
            ...
            <div style="display:flex;align-items:center;gap:8px">
                ${s?`
                    <span class="stk-countdown" data-unlock-time="${r}">${Vc(o)}</span>
    ...
    `}function um(){document.querySelectorAll(".stk-countdown").forEach(e=>{const t=parseInt(e.dataset.unlockTime),a=Math.floor(Date.now()/1e3);e.textContent=Vc(t-a)})}async function pm(){if(c.userAddress)try{const e=Ye.getHistory||"https://gethistory-4wvdcuoouq-uc.a.run.app",t=await fetch(`${e}/${c.userAddress}`);t.ok&&(gn=(await t.json()||[]).filter(n=>{const r=(n.type||"").toUpperCase();return r.includes("DELEGAT")||r.includes("STAKE")||r.includes("UNDELEGAT")||r.includes("CLAIM")||r.includes("REWARD")||r.includes("FORCE")}),Jc())}catch(e){console.error("History load error:",e)}}function Jc(){const e=document.getElementById("stk-history-list");if(!e)return;let t=gn;if(wa!=="ALL"&&(t=gn.filter(a=>{const n=(a.type||"").toUpperCase();switch(wa){case"STAKE":return(n.includes("DELEGAT")||n.includes("STAKE"))&&!n.includes("UNSTAKE")&&!n.includes("UNDELEGAT")&&!n.includes("FORCE");case"UNSTAKE":return n.includes("UNSTAKE")||n.includes("UNDELEGAT")||n.includes("FORCE");case"CLAIM":return n.includes("CLAIM")||n.includes("REWARD");default:return!0}})),t.length===0){e.innerHTML=`<div class="stk-empty"><i class="fa-solid fa-inbox"></i><p>No ${wa==="ALL"?"":wa.toLowerCase()+" "}history yet</p></div>`;return}e.innerHTML=t.slice(0,25).map(a=>{const n=(a.type||"").toUpperCase(),r=a.details||{},i=tm(a.timestamp||a.createdAt);let s,o,l,d,u="";n.includes("FORCE")?(s="fa-bolt",o="rgba(239,68,68,0.12)",l="#ef4444",d="Force Unstaked",r.feePaid&&BigInt(r.feePaid)>0n&&(u=`<span style="color:#ef4444">-${D(BigInt(r.feePaid)).toFixed(2)}</span>`)):(n.includes("DELEGAT")||n.includes("STAKE"))&&!n.includes("UNSTAKE")?(s="fa-lock",o="rgba(74,222,128,0.12)",l="#4ade80",d="Delegated",r.pStakeGenerated&&(u=`<span style="color:var(--stk-purple)">+${D(BigInt(r.pStakeGenerated)).toFixed(0)} pS</span>`)):n.includes("UNSTAKE")||n.includes("UNDELEGAT")?(s="fa-unlock",o="rgba(249,115,22,0.12)",l="#f97316",d="Unstaked"):n.includes("CLAIM")||n.includes("REWARD")?(s="fa-coins",o="rgba(251,191,36,0.12)",l="#fbbf24",d="Claimed",r.amountReceived&&BigInt(r.amountReceived)>0n&&(u=`<span style="color:var(--stk-green)">+${D(BigInt(r.amountReceived)).toFixed(2)}</span>`),r.burnedAmount&&BigInt(r.burnedAmount)>0n&&(u+=` <span style="font-size:9px;color:rgba(239,68,68,0.6)">🔥-${D(BigInt(r.burnedAmount)).toFixed(2)}</span>`)):(s="fa-circle",o="rgba(113,113,122,0.12)",l="#71717a",d=a.type||"Activity");const m=a.txHash?`${Zp}${a.txHash}`:"#",p=a.amount||r.amount||r.amountReceived||"0";let b=0;try{b=D(BigInt(p))}catch{}const f=b>.001?b.toFixed(2):"";return`
        ...
        `}).join("")}function ka(){var n;const e=document.getElementById("stk-amount-input"),t=document.getElementById("stk-delegate-btn");if(!e)return;const a=e.value;if(!a||parseFloat(a)<=0){const r=document.getElementById("stk-preview-pstake");r&&(r.textContent="0");const i=document.getElementById("stk-preview-net");i&&(i.textContent="0.00 BKC"),t&&(t.disabled=!0);return}try{const r=Ba.parseUnits(a,18),i=((n=c.systemFees)==null?void 0:n.DELEGATION_FEE_BIPS)||50n,s=r*BigInt(i)/10000n,o=r-s,l=BigInt(Vs),d=10000n,u=d+l*5918n/365n,m=o*u/d,p=document.getElementById("stk-preview-pstake");p&&(p.textContent=aa(m));const b=document.getElementById("stk-preview-net");b&&(b.textContent=`${D(o).toFixed(4)} BKC`);const f=c.currentUserBalance||0n;r>f?(e.classList.add("error"),t&&(t.disabled=!0)):(e.classList.remove("error"),t&&(t.disabled=Ge))}catch{t&&(t.disabled=!0)}}async function mm(){if(Ge)return;const e=document.getElementById("stk-amount-input"),t=document.getElementById("stk-delegate-btn");if(!e||!t)return;const a=e.value;if(!a||parseFloat(a)<=0)return x("Enter an amount","warning");const n=c.currentUserBalance||0n;let r;try{if(r=Ba.parseUnits(a,18),r>n)return x("Insufficient BKC balance","error")}catch{return x("Invalid amount","error")}try{if(await c.publicProvider.getBalance(c.userAddress)<Ba.parseEther("0.001"))return x("Insufficient ETH for gas","error")}catch{}Ge=!0;try{await Ht.delegate({amount:r,lockDays:Vs,button:t,onSuccess:async()=>{e.value="",x("Delegation successful!","success"),Qt=!1,Na=0,await pa(!0)},onError:i=>{i.cancelled||x("Delegation failed: "+(i.reason||i.message||"Unknown error"),"error")}})}catch(i){x("Delegation failed: "+(i.reason||i.message||"Unknown error"),"error")}finally{Ge=!1,ka()}}async function fm(e,t){if(Ge||t&&!confirm("Force unstake will incur a 50% penalty. Continue?"))return;const a=document.querySelector(`.stk-unstake-btn[data-index='${e}']`);Ge=!0;try{await(t?Ht.forceUnstake:Ht.unstake)({delegationIndex:BigInt(e),button:a,onSuccess:async()=>{x(t?"Force unstaked (50% penalty)":"Unstaked successfully!",t?"warning":"success"),Qt=!1,Na=0,await pa(!0)},onError:r=>{r.cancelled||x("Unstake failed: "+(r.reason||r.message||"Unknown error"),"error")}})}catch(n){x("Unstake failed: "+(n.reason||n.message||"Unknown error"),"error")}finally{Ge=!1}}async function bm(){if(Ge)return;const e=document.getElementById("stk-claim-btn");Ge=!0;try{await Ht.claimRewards({button:e,onSuccess:async()=>{x("Rewards claimed!","success"),Qt=!1,Na=0,gn=[],await pa(!0)},onError:t=>{t.cancelled||x("Claim failed: "+(t.reason||t.message||"Unknown error"),"error")}})}catch(t){x("Claim failed: "+(t.reason||t.message||"Unknown error"),"error")}finally{Ge=!1}}function gm(){var o;const e=document.getElementById("mine");if(!e)return;const t=document.getElementById("stk-amount-input"),a=document.getElementById("stk-max-btn"),n=document.getElementById("stk-delegate-btn"),r=document.getElementById("stk-refresh-btn"),i=document.querySelectorAll(".stk-duration-chip"),s=document.querySelectorAll(".stk-tab");t==null||t.addEventListener("input",ka),a==null||a.addEventListener("click",()=>{const l=c.currentUserBalance||0n;t&&(t.value=Ba.formatUnits(l,18),ka())}),i.forEach(l=>{l.addEventListener("click",()=>{i.forEach(d=>d.classList.remove("selected")),l.classList.add("selected"),Vs=parseInt(l.dataset.days),ka()})}),s.forEach(l=>{l.addEventListener("click",()=>{s.forEach(d=>d.classList.remove("active")),l.classList.add("active"),wa=l.dataset.filter,Jc()})}),n==null||n.addEventListener("click",mm),r==null||r.addEventListener("click",()=>{const l=r.querySelector("i");l==null||l.classList.add("fa-spin"),pa(!0).then(()=>{setTimeout(()=>l==null?void 0:l.classList.remove("fa-spin"),500)})}),(o=document.getElementById("stk-claim-btn"))==null||o.addEventListener("click",bm),e.addEventListener("click",l=>{l.target.closest(".go-to-store")&&(l.preventDefault(),window.navigateTo("store")),l.target.closest(".go-to-rental")&&(l.preventDefault(),window.navigateTo("rental"))})}function xm(){Lt&&(clearInterval(Lt),Lt=null)}function hm(e){e?pa():Xc()}const Wr={render:nm,update:hm,cleanup:xm},ze=window.ethers,vm="https://sepolia.arbiscan.io/tx/",wm=3e4,Gr={Diamond:{color:"#22d3ee",gradient:"from-cyan-500/20 to-blue-500/20",border:"border-cyan-500/40",text:"text-cyan-400",glow:"shadow-cyan-500/30",icon:"💎",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeicgip72jcqgsirlrhn3tq5cc226vmko6etnndzl6nlhqrktfikafq",keepRate:100,burnRate:0},Gold:{color:"#fbbf24",gradient:"from-yellow-500/20 to-amber-500/20",border:"border-yellow-500/40",text:"text-yellow-400",glow:"shadow-yellow-500/30",icon:"🥇",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeifponccrbicg2pcjrn2hrfoqgc77xhm2r4ld7hdpw6cxxkbsckf44",keepRate:90,burnRate:10},Silver:{color:"#9ca3af",gradient:"from-gray-400/20 to-slate-400/20",border:"border-gray-400/40",text:"text-gray-300",glow:"shadow-gray-400/30",icon:"🥈",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeihvi2inujm5zpi7tl667g4srq273536pjkglwyrtbwmgnskmu7jg4",keepRate:75,burnRate:25},Bronze:{color:"#f97316",gradient:"from-orange-600/20 to-amber-700/20",border:"border-orange-600/40",text:"text-orange-400",glow:"shadow-orange-500/30",icon:"🥉",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeiclqidb67rt3tchhjpsib62s624li7j2bpxnr6b5w5mfp4tomhu7m",keepRate:60,burnRate:40}};function lr(e){return Gr[e]||Gr.Bronze}const $={tradeDirection:"buy",selectedPoolBoostBips:null,buyPrice:0n,sellPrice:0n,netSellPrice:0n,poolNFTCount:0,userBalanceOfSelectedNFT:0,availableToSellCount:0,firstAvailableTokenId:null,firstAvailableTokenIdForBuy:null,bestBoosterTokenId:0n,bestBoosterBips:0,isDataLoading:!1,tradeHistory:[]},xn=new Map,Js=new Map;let tn=!1,Nt=null;const ym=["function getPoolAddress(uint256 boostBips) view returns (address)","function isPool(address) view returns (bool)"];function km(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function Em(e){const t=Js.get(e);return t&&Date.now()-t.timestamp<wm?t.data:null}function Zc(e,t){Js.set(e,{data:t,timestamp:Date.now()})}function kr(e){Js.delete(e)}function Tm(){if(document.getElementById("swap-styles-v9"))return;const e=document.createElement("style");e.id="swap-styles-v9",e.textContent=`
    ...
    `,document.head.appendChild(e)}function Cm(){return`
    ...
    `}const Im={async render(e){Tm(),await Hl();const t=document.getElementById("store");t&&((t.innerHTML.trim()===""||e)&&(t.innerHTML=`
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <div class="flex items-center gap-3">
                            <div class="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden"
                                 id="trade-mascot">
                                <img src="${Gr.Diamond.image}" alt="NFT" class="w-full h-full object-contain" onerror="this.outerHTML='<span class=\\'text-3xl\\'>💎</span>'">
                            </div>
                            <div>
            ...
            `,Nm()),$.selectedPoolBoostBips===null&&be.length>0&&($.selectedPoolBoostBips=be[0].boostBips),await dt(),await ya())},async update(){$.selectedPoolBoostBips!==null&&!$.isDataLoading&&document.getElementById("store")&&!document.hidden&&await dt()}};async function ya(){const e=document.getElementById("history-list");if(!c.userAddress){e&&(e.innerHTML='<div class="text-center py-4 text-xs text-zinc-600">Connect wallet to view history</div>');return}try{const t=Ye.getHistory||"https://gethistory-4wvdcuoouq-uc.a.run.app",a=await fetch(`${t}/${c.userAddress}`);if(!a.ok)throw new Error(`HTTP ${a.status}`);const n=await a.json();console.log("All history types:",[...new Set((n||[]).map(i=>i.type))]),$.tradeHistory=(n||[]).filter(i=>{const s=(i.type||"").toUpperCase();return s==="NFTBOUGHT"||s==="NFTSOLD"||s==="NFT_BOUGHT"||s==="NFT_SOLD"||s==="NFTPURCHASED"||s==="NFT_PURCHASED"||s.includes("NFTBOUGHT")||s.includes("NFTSOLD")||s.includes("NFTPURCHASED")}),console.log("NFT trade history:",$.tradeHistory.length,"items");const r=document.getElementById("history-count");r&&(r.textContent=$.tradeHistory.length),Jo()}catch(t){console.error("History load error:",t),$.tradeHistory=[],Jo()}}function Jo(){const e=document.getElementById("history-list");if(e){if(!c.isConnected){e.innerHTML='<div class="text-center py-4 text-xs text-zinc-600">Connect wallet to view history</div>';return}if($.tradeHistory.length===0){e.innerHTML=`
        ...
        `;return}e.innerHTML=$.tradeHistory.slice(0,20).map(t=>{const a=(t.type||"").toUpperCase(),n=t.details||{},r=km(t.timestamp||t.createdAt),i=a.includes("BOUGHT")||a.includes("PURCHASED"),s=i?"fa-cart-plus":"fa-money-bill-transfer",o=i?"#22c55e":"#f59e0b",l=i?"rgba(34,197,94,0.15)":"rgba(245,158,11,0.15)",d=i?"🛒 Bought NFT":"💰 Sold NFT",u=i?"-":"+",m=t.txHash?`${vm}${t.txHash}`:"#";let p="";try{let w=t.amount||n.amount||n.price||n.payout||"0";if(typeof w=="string"&&w!=="0"){const k=D(BigInt(w));k>.001&&(p=k.toFixed(2))}}catch{}const b=n.tokenId||"",f=n.boostBips||n.boost||"";return`
        ...
        `}).join("")}}function Am(){return be.map((e,t)=>{const a=lr(e.name),n=t===0,r=tt(e.boostBips),i=a.icon||e.emoji||"💎";return`
        ...
        <div class="fade-in">
            ...
            <div class="swap-input-box rounded-2xl p-4 mt-1 mb-4">
                ...
                <div class="flex justify-between items-center">
                    <span class="text-2xl font-semibold text-white">${n?"1":D($.netSellPrice).toFixed(2)}</span>
                    <div class="token-selector flex items-center gap-2 px-3 py-2 rounded-xl cursor-default">
    ...
    `}function Pm(e,t,a,n,r=!1){return c.isConnected?e?t?`
        ...
        `;return}const n=c.rentalListings||[],r=new Set(n.map(s=>{var o;return(o=s.tokenId)==null?void 0:o.toString()})),i=Math.floor(Date.now()/1e3);e.innerHTML=a.map(s=>{var P;const o=be.find(S=>S.boostBips===Number(s.boostBips)),l=lr(o==null?void 0:o.name),d=tt(Number(s.boostBips)),u=l.icon||(o==null?void 0:o.emoji)||"💎",m=$.firstAvailableTokenId&&BigInt(s.tokenId)===$.firstAvailableTokenId,p=(P=s.tokenId)==null?void 0:P.toString(),b=r.has(p),f=n.find(S=>{var _;return((_=S.tokenId)==null?void 0:_.toString())===p}),w=f&&f.rentalEndTime&&Number(f.rentalEndTime)>i,k=b||w;let C="";return w?C='<span class="absolute top-1 right-1 bg-blue-500 text-white text-[7px] px-1.5 py-0.5 rounded-full font-bold">🔑</span>':b&&(C='<span class="absolute top-1 right-1 bg-green-500 text-white text-[7px] px-1.5 py-0.5 rounded-full font-bold">📋</span>'),`
            <div class="inventory-item ${k?"opacity-50 cursor-not-allowed":"cursor-pointer"} rounded-xl p-2 border ${m&&!k?"border-amber-500 ring-2 ring-amber-500/50 bg-amber-500/10":"border-zinc-700/50 bg-zinc-800/30"} hover:bg-zinc-800/50 transition-all relative"
                 data-boost="${s.boostBips}" 
                 data-tokenid="${s.tokenId}"
                 data-unavailable="${k}">
                ${C}
                <div class="w-full aspect-square rounded-lg bg-gradient-to-br ${l.gradient} border ${l.border} flex items-center justify-center overflow-hidden ${k?"grayscale":""}">
                ...
                <p class="text-[7px] text-center ${m&&!k?"text-amber-400 font-bold":"text-zinc-600"}">#${s.tokenId}</p>
            </div>
        `}).join("")}async function dt(e=!1){var n,r;if($.selectedPoolBoostBips===null)return;const t=$.selectedPoolBoostBips,a=Date.now();if(Nt=a,!e){const i=Em(t);if(i){Kr(i),hn(),Qo(),Bm(t,a);return}}$.isDataLoading=!0;try{const i=c.myBoosters||[],s=c.rentalListings||[],o=new Set(s.map(Y=>{var ie;return(ie=Y.tokenId)==null?void 0:ie.toString()})),l=Math.floor(Date.now()/1e3),d=i.filter(Y=>Number(Y.boostBips)===t),u=d.filter(Y=>{var Oe;const ie=(Oe=Y.tokenId)==null?void 0:Oe.toString(),$e=s.find(Z=>{var Le;return((Le=Z.tokenId)==null?void 0:Le.toString())===ie}),It=o.has(ie),st=$e&&$e.rentalEndTime&&Number($e.rentalEndTime)>l;return!It&&!st}),m=be.find(Y=>Y.boostBips===t);if(!m){console.warn("Tier not found for boostBips:",t);return}const p=`pool_${m.name.toLowerCase()}`;let b=v[p]||xn.get(t);if(!b){const Y=v.nftPoolFactory||v.nftLiquidityPoolFactory;if(Y&&c.publicProvider)try{b=await new ze.Contract(Y,ym,c.publicProvider).getPoolAddress(t),b&&b!==ze.ZeroAddress&&xn.set(t,b)}catch(ie){console.warn("Factory lookup failed:",ie.message)}}if(Nt!==a)return;if(!b||b===ze.ZeroAddress){const Y=document.getElementById("swap-interface");Y&&(Y.innerHTML=`
                ...
                `);return}const f=new ze.Contract(b,ri,c.publicProvider),[w,k,C]=await Promise.all([ae(f,"getBuyPrice",[],ze.MaxUint256).catch(()=>ze.MaxUint256),ae(f,"getSellPrice",[],0n).catch(()=>0n),f.getAvailableNFTs().catch(()=>[])]);if(Nt!==a)return;const P=Array.isArray(C)?[...C]:[],S=w===ze.MaxUint256?0n:w,_=k;let B=((n=c.systemFees)==null?void 0:n.NFT_POOL_SELL_TAX_BIPS)||1000n,I=BigInt(((r=c.boosterDiscounts)==null?void 0:r[$.bestBoosterBips])||0);const N=typeof B=="bigint"?B:BigInt(B),F=typeof I=="bigint"?I:BigInt(I),ne=N>F?N-F:0n,V=_*ne/10000n,he=_-V,ce={buyPrice:S,sellPrice:_,netSellPrice:he,poolNFTCount:P.length,firstAvailableTokenIdForBuy:P.length>0?BigInt(P[P.length-1]):null,userBalanceOfSelectedNFT:d.length,availableToSellCount:u.length,availableNFTsOfTier:u};Zc(t,ce),Kr(ce,t)}catch(i){if(console.warn("Store Data Warning:",i.message),Nt===a){const s=document.getElementById("swap-interface");s&&(s.innerHTML=`
                    <div class="text-center py-12">
                        <div class="w-12 h-12 bg-zinc-800 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                `)}return}finally{Nt===a&&($.isDataLoading=!1,hn(),Qo())}}async function Bm(e,t){var a,n;try{const r=c.myBoosters||[],i=c.rentalListings||[],s=new Set(i.map(ce=>{var Y;return(Y=ce.tokenId)==null?void 0:Y.toString()})),o=Math.floor(Date.now()/1e3),l=r.filter(ce=>Number(ce.boostBips)===e),d=l.filter(ce=>{var st;const Y=(st=ce.tokenId)==null?void 0:st.toString(),ie=i.find(Oe=>{var Z;return((Z=Oe.tokenId)==null?void 0:Z.toString())===Y}),$e=s.has(Y),It=ie&&ie.rentalEndTime&&Number(ie.rentalEndTime)>o;return!$e&&!It}),u=be.find(ce=>ce.boostBips===e);if(!u)return;const m=`pool_${u.name.toLowerCase()}`;let p=v[m]||xn.get(e);if(!p||p===ze.ZeroAddress)return;const b=new ze.Contract(p,ri,c.publicProvider),[f,w,k]=await Promise.all([ae(b,"getBuyPrice",[],ze.MaxUint256).catch(()=>ze.MaxUint256),ae(b,"getSellPrice",[],0n).catch(()=>0n),b.getAvailableNFTs().catch(()=>[])]);if(Nt!==t)return;const C=Array.isArray(k)?[...k]:[],P=f===ze.MaxUint256?0n:f,S=w;let _=((a=c.systemFees)==null?void 0:a.NFT_POOL_SELL_TAX_BIPS)||1000n,B=BigInt(((n=c.boosterDiscounts)==null?void 0:n[$.bestBoosterBips])||0);const I=typeof _=="bigint"?_:BigInt(_),N=typeof B=="bigint"?B:BigInt(B),F=I>N?I-N:0n,ne=S*F/10000n,V=S-ne,he={buyPrice:P,sellPrice:S,netSellPrice:V,poolNFTCount:C.length,firstAvailableTokenIdForBuy:C.length>0?BigInt(C[C.length-1]):null,userBalanceOfSelectedNFT:l.length,availableToSellCount:d.length,availableNFTsOfTier:d};Zc(e,he),$.selectedPoolBoostBips===e&&Nt===t&&(Kr(he,e),hn())}catch(r){console.warn("Background refresh failed:",r.message)}}function Kr(e,t){var r,i,s;$.buyPrice=e.buyPrice,$.sellPrice=e.sellPrice,$.netSellPrice=e.netSellPrice,$.poolNFTCount=e.poolNFTCount,$.firstAvailableTokenIdForBuy=e.firstAvailableTokenIdForBuy,$.userBalanceOfSelectedNFT=e.userBalanceOfSelectedNFT,$.availableToSellCount=e.availableToSellCount;const a=$.firstAvailableTokenId;!(a&&((r=e.availableNFTsOfTier)==null?void 0:r.some(o=>BigInt(o.tokenId)===a)))&&((i=e.availableNFTsOfTier)==null?void 0:i.length)>0?$.firstAvailableTokenId=BigInt(e.availableNFTsOfTier[0].tokenId):(s=e.availableNFTsOfTier)!=null&&s.length||($.firstAvailableTokenId=null)}function Nm(){const e=document.getElementById("store");e&&e.addEventListener("click",async t=>{if(t.target.closest("#refresh-btn")){const s=t.target.closest("#refresh-btn").querySelector("i");s.classList.add("fa-spin"),kr($.selectedPoolBoostBips),await Promise.all([St(!0),jl()]),await dt(!0),ya(),s.classList.remove("fa-spin");return}const a=t.target.closest(".tier-chip");if(a){const i=Number(a.dataset.boost);$.selectedPoolBoostBips!==i&&($.selectedPoolBoostBips=i,$.firstAvailableTokenId=null,Zo(i),await dt());return}if(t.target.closest("#swap-direction-btn")){$.tradeDirection=$.tradeDirection==="buy"?"sell":"buy",hn();return}if(t.target.closest("#inventory-toggle")){const i=document.getElementById("inventory-panel"),s=document.getElementById("inventory-chevron");i&&s&&(i.classList.toggle("hidden"),s.style.transform=i.classList.contains("hidden")?"":"rotate(180deg)");return}if(t.target.closest("#history-toggle")){const i=document.getElementById("history-panel"),s=document.getElementById("history-chevron");i&&s&&(i.classList.toggle("hidden"),s.style.transform=i.classList.contains("hidden")?"":"rotate(180deg)");return}const n=t.target.closest(".inventory-item");if(n){if(n.dataset.unavailable==="true"){x("This NFT is listed for rental and cannot be sold","warning");return}const s=Number(n.dataset.boost),o=n.dataset.tokenid;$.selectedPoolBoostBips=s,$.tradeDirection="sell",o&&($.firstAvailableTokenId=BigInt(o),console.log("User selected NFT #"+o+" for sale")),Zo(s),await dt();return}const r=t.target.closest("#execute-btn");if(r){if(t.preventDefault(),t.stopPropagation(),tn||r.disabled)return;const i=r.dataset.action,s=document.getElementById("trade-mascot");if(i==="connect"){window.openConnectModal();return}const o=be.find(u=>u.boostBips===$.selectedPoolBoostBips);if(!o)return;const l=`pool_${o.name.toLowerCase()}`,d=v[l]||xn.get(o.boostBips);if(!d){x("Pool address not found","error");return}tn=!0,s&&(s.className="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden trade-spin");try{if($.tradeDirection==="buy")await fn.buyFromPool({poolAddress:d,button:r,onSuccess:async u=>{s&&(s.className="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden trade-success"),x("🟢 NFT Purchased!","success"),kr($.selectedPoolBoostBips),await Promise.all([St(!0),dt(!0)]),ya()},onError:u=>{if(!u.cancelled&&u.type!=="user_rejected"){const m=u.message||u.reason||"Transaction failed";x("Buy failed: "+m,"error")}}});else{if(!$.firstAvailableTokenId){x("No NFT selected for sale","error"),tn=!1;return}await fn.sellToPool({poolAddress:d,tokenId:$.firstAvailableTokenId,button:r,onSuccess:async u=>{s&&(s.className="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden trade-success"),x("🔴 NFT Sold!","success"),kr($.selectedPoolBoostBips),await Promise.all([St(!0),dt(!0)]),ya()},onError:u=>{if(!u.cancelled&&u.type!=="user_rejected"){const m=u.message||u.reason||"Transaction failed";x("Sell failed: "+m,"error")}}})}}finally{tn=!1,setTimeout(async()=>{try{await Promise.all([St(!0),dt(!0)]),ya()}catch(u){console.warn("[Store] Post-transaction refresh failed:",u.message)}},2e3),s&&setTimeout(()=>{const u=$.tradeDirection==="buy";s.className=`w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden ${u?"trade-buy":"trade-sell"}`},800)}}})}const Zs="https://sepolia.arbiscan.io/tx/",Yr="https://sepolia.arbiscan.io/address/",Qc="0x16346f5a45f9615f1c894414989f0891c54ef07b",Sm=(v==null?void 0:v.fortunePool)||"0x277dB00d533Bbc0fc267bbD954640aDA38ee6B37",vn="./assets/fortune.png",Vr=1e3,el={pt:{title:"Compartilhe & Ganhe!",subtitle:"+1000 pontos para o Airdrop",later:"Talvez depois"},en:{title:"Share & Earn!",subtitle:"+1000 points for Airdrop",later:"Maybe later"},es:{title:"¡Comparte y Gana!",subtitle:"+1000 puntos para el Airdrop",later:"Quizás después"}},$m={pt:{win:e=>`🎉 Ganhei ${e.toLocaleString()} BKC no Fortune Pool!
...
#Backcoin #Web3 #Arbitrum`}},Er={pt:"./assets/pt.png",en:"./assets/en.png",es:"./assets/es.png"};let Xe="en";const me=[{id:1,name:"Easy",emoji:"🍀",range:5,multiplier:2,chance:"20%",color:"emerald",hex:"#10b981",bgFrom:"from-emerald-500/20",bgTo:"to-green-600/10",borderColor:"border-emerald-500/50",textColor:"text-emerald-400"},{id:2,name:"Medium",emoji:"⚡",range:15,multiplier:10,chance:"6.7%",color:"violet",hex:"#8b5cf6",bgFrom:"from-violet-500/20",bgTo:"to-purple-600/10",borderColor:"border-violet-500/50",textColor:"text-violet-400"},{id:3,name:"Hard",emoji:"👑",range:150,multiplier:100,chance:"0.67%",color:"amber",hex:"#f59e0b",bgFrom:"from-amber-500/20",bgTo:"to-orange-600/10",borderColor:"border-amber-500/50",textColor:"text-amber-400"}],ed=57,y={mode:null,phase:"select",guess:50,guesses:[2,5,50],comboStep:0,wager:10,gameId:null,result:null,txHash:null,poolStatus:null,history:[],serviceFee:0n,serviceFee1x:0n,serviceFee5x:0n,tiersData:null,commitment:{hash:null,userSecret:null,commitBlock:null,commitTxHash:null,revealDelay:2,waitStartTime:null,canReveal:!1}};let Re=null;const Lm=3e3,td=250;function Rm(){if(document.getElementById("fortune-styles-v2"))return;const e=document.createElement("style");e.id="fortune-styles-v2",e.textContent=`
    ...
    `,document.head.appendChild(e)}function _m(){Rm();const e=document.getElementById("actions");if(!e){console.error("❌ FortunePool: Container #actions not found!");return}e.innerHTML=`
        <div class="max-w-md mx-auto px-4 py-6">
            <!-- Header -->
            <div class="text-center mb-6">
                <div class="relative inline-block">
                    <img id="tiger-mascot" src="${vn}" 
                ...
                <div class="flex items-center justify-center gap-2 mt-3 flex-wrap">
                    <a href="${Yr}${Qc}" target="_blank" rel="noopener" 
                    ...
                    <a href="${Yr}${Sm}" target="_blank" rel="noopener" 
            ...
            <div class="bg-zinc-900/50 border border-zinc-800/50 rounded-2xl overflow-hidden">
                ...
                <div id="history-list" class="max-h-[300px] overflow-y-auto p-2">
                    <div class="p-6 text-center text-zinc-600 text-sm">
                        <img src="${vn}" class="w-12 h-12 mx-auto opacity-30 animate-pulse mb-2" onerror="this.style.display='none'">
                        Loading...
                    </div>
                </div>
            </div>
        </div>
    `,eo(),ue()}function Fm(){Re&&(clearInterval(Re),Re=null),y.phase="select",y.result=null,y.commitment={hash:null,userSecret:null,commitBlock:null,commitTxHash:null,revealDelay:y.commitment.revealDelay||2,waitStartTime:null,canReveal:!1}}function ue(){const e=document.getElementById("game-area");if(e)switch(Mm(y.phase),y.phase){case"select":tl(e);break;case"pick":Dm(e);break;case"wager":Um(e);break;case"processing":Wm(e);break;case"waiting":Gm(e);break;case"result":Xm(e);break;default:tl(e)}}function Mm(e){var a;const t=document.getElementById("tiger-mascot");if(t)switch(t.className="w-28 h-28 object-contain mx-auto",t.style.filter="",e){case"select":t.classList.add("tiger-float","tiger-pulse");break;case"pick":case"wager":t.classList.add("tiger-float");break;case"processing":t.classList.add("tiger-spin");break;case"waiting":t.classList.add("tiger-float"),t.style.filter="hue-rotate(270deg)";break;case"result":((a=y.result)==null?void 0:a.prizeWon)>0?t.classList.add("tiger-celebrate"):(t.style.filter="grayscale(0.5)",t.classList.add("tiger-float"));break}}function tl(e){var r,i;const t=y.serviceFee1x>0n?(Number(y.serviceFee1x)/1e18).toFixed(6):"0",a=y.serviceFee5x>0n?(Number(y.serviceFee5x)/1e18).toFixed(6):"0",n=y.serviceFee1x>0n||y.serviceFee5x>0n;e.innerHTML=`
        <div class="space-y-4">
            <!-- JACKPOT MODE -->
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center gap-3 mb-1">
                            ...
                            <span class="px-2.5 py-1 rounded-full bg-violet-500/20 border border-violet-500/40 text-violet-400 text-sm font-black">${ed}x</span>
                        </div>
    ...
    `,(r=document.getElementById("btn-jackpot"))==null||r.addEventListener("click",()=>{if(!c.isConnected)return x("Connect wallet first","warning");y.mode="jackpot",y.guess=50,y.phase="pick",ue()}),(i=document.getElementById("btn-combo"))==null||i.addEventListener("click",()=>{if(!c.isConnected)return x("Connect wallet first","warning");y.mode="combo",y.guesses=[2,5,50],y.comboStep=0,y.phase="pick",ue()})}function Dm(e){y.mode==="jackpot"?Om(e):Hm(e)}function Om(e){var o,l,d,u,m,p,b;const t=me[2],a=y.guess;e.innerHTML=`
    ...
    `;const n=document.getElementById("number-input"),r=document.getElementById("number-slider"),i=me[2],s=f=>{f=Math.max(1,Math.min(100,f)),y.guess=f,n&&(n.value=f),r&&(r.value=f,r.style.background=`linear-gradient(to right, ${i.hex} 0%, ${i.hex} ${f}%, #27272a ${f}%, #27272a 100%)`)};n==null||n.addEventListener("input",f=>s(parseInt(f.target.value)||1)),n==null||n.addEventListener("blur",f=>s(parseInt(f.target.value)||1)),r==null||r.addEventListener("input",f=>s(parseInt(f.target.value))),(o=document.getElementById("btn-minus"))==null||o.addEventListener("click",()=>s(y.guess-1)),(l=document.getElementById("btn-plus"))==null||l.addEventListener("click",()=>s(y.guess+1)),(d=document.getElementById("btn-minus-10"))==null||d.addEventListener("click",()=>s(y.guess-10)),(u=document.getElementById("btn-plus-10"))==null||u.addEventListener("click",()=>s(y.guess+10)),document.querySelectorAll(".quick-pick").forEach(f=>{f.addEventListener("click",()=>s(parseInt(f.dataset.number)))}),(m=document.getElementById("btn-random"))==null||m.addEventListener("click",()=>{s(Math.floor(Math.random()*100)+1)}),(p=document.getElementById("btn-back"))==null||p.addEventListener("click",()=>{y.phase="select",ue()}),(b=document.getElementById("btn-next"))==null||b.addEventListener("click",()=>{y.phase="wager",ue()})}function Hm(e){var i,s,o,l,d,u,m;const t=me[y.comboStep],a=y.guesses[y.comboStep],n=t.range===100;if(e.innerHTML=`
        <div class="bg-gradient-to-br from-zinc-900 to-zinc-800/50 border border-zinc-700/50 rounded-2xl p-5">
            <!-- Progress Pills -->
            <div class="flex justify-center gap-2 sm:gap-3 mb-5">
                ${me.map((p,b)=>{const f=b===y.comboStep,w=b<y.comboStep;return`
    ...
    `,jm(n,r)}function jm(e,t){var n,r,i,s,o,l,d,u;const a=m=>{y.wager=Math.max(1,Math.min(Math.floor(m),Math.floor(t)));const p=document.getElementById("custom-wager"),b=document.getElementById("potential-win");p&&(p.value=y.wager),b&&(b.textContent=(y.wager*e).toLocaleString()),document.querySelectorAll(".percent-btn").forEach(f=>{const w=parseInt(f.dataset.value);y.wager===w?f.className="percent-btn py-2.5 text-sm font-bold rounded-xl transition-all bg-gradient-to-r from-amber-500/30 to-orange-500/20 border-2 border-amber-500/60 text-amber-400 shadow-lg shadow-amber-500/20":f.className="percent-btn py-2.5 text-sm font-bold rounded-xl transition-all bg-zinc-800/60 border border-zinc-700/50 text-zinc-400 hover:border-amber-500/30 hover:text-amber-300"})};document.querySelectorAll(".percent-btn").forEach(m=>{m.addEventListener("click",()=>{a(parseInt(m.dataset.value)||1)})}),(n=document.getElementById("custom-wager"))==null||n.addEventListener("input",m=>{a(parseInt(m.target.value)||1)}),(r=document.getElementById("wager-minus"))==null||r.addEventListener("click",()=>{a(y.wager-1)}),(i=document.getElementById("wager-plus"))==null||i.addEventListener("click",()=>{a(y.wager+1)}),(s=document.getElementById("wager-minus-10"))==null||s.addEventListener("click",()=>{a(y.wager-10)}),(o=document.getElementById("wager-plus-10"))==null||o.addEventListener("click",()=>{a(y.wager+10)}),(l=document.getElementById("btn-faucet"))==null||l.addEventListener("click",async()=>{x("Solicitando tokens...","info");try{let m=!1;try{const p=await fetch(`/api/faucet?address=${c.userAddress}`),b=await p.json();p.ok&&b.success?m=!0:console.warn("[Faucet] API:",b.error)}catch(p){console.warn("[Faucet] API offline:",p.message)}if(!m){const{FaucetTx:p}=await O(async()=>{const{FaucetTx:b}=await Promise.resolve().then(()=>Wc);return{FaucetTx:b}},void 0);await p.claimOnChain({onSuccess:()=>{m=!0}})}m&&(x("Tokens recebidos!","success"),await Fn(),ue())}catch(m){const p=m.message||"";p.includes("Aguarde")||p.includes("cooldown")?x(p,"warning"):x("Faucet indisponível","error")}}),(d=document.getElementById("btn-back"))==null||d.addEventListener("click",()=>{y.phase="pick",y.mode==="combo"&&(y.comboStep=2),ue()}),(u=document.getElementById("btn-play"))==null||u.addEventListener("click",async()=>{if(y.wager<1)return x("Min: 1 BKC","warning");y.phase="processing",ue();try{const m=y.mode==="jackpot"?[y.guess]:y.guesses,p=y.mode==="combo"?7:4,b=window.ethers.parseEther(y.wager.toString());await Qn.playGame({wagerAmount:b,guesses:m,tierMask:p,button:document.getElementById("btn-play"),onSuccess:f=>{y.gameId=(f==null?void 0:f.gameId)||Date.now(),y.commitment={hash:null,userSecret:(f==null?void 0:f.userSecret)||null,commitBlock:(f==null?void 0:f.commitBlock)||null,commitTxHash:(f==null?void 0:f.txHash)||null,revealDelay:y.commitment.revealDelay||2,waitStartTime:Date.now(),canReveal:!1},y.txHash=(f==null?void 0:f.txHash)||null,console.log("🔐 Game committed:",y.gameId,"Block:",y.commitment.commitBlock),y.phase="waiting",ue(),Km()},onError:f=>{f.cancelled||x(f.message||"Commit failed","error"),y.phase="wager",ue()}})}catch(m){console.error("Commit error:",m);const p=m.message||m.reason||"Transaction failed";x("Error: "+p,"error"),y.phase="wager",ue()}})}function Wm(e){const t=y.mode==="jackpot",a=t?[y.guess]:y.guesses,n=t?[me[2]]:me;e.innerHTML=`
    ...
    `,n.forEach((r,i)=>{const s=document.getElementById(`spin-${i}`);if(!s)return;setInterval(()=>{s.textContent=Math.floor(Math.random()*r.range)+1},80)})}function Gm(e){var l;const t=y.mode==="jackpot",a=t?[y.guess]:y.guesses,n=t?[me[2]]:me,r=Date.now()-(y.commitment.waitStartTime||Date.now()),i=y.commitment.revealDelay*td,s=Math.max(0,i-r),o=Math.ceil(s/1e3);e.innerHTML=`
        <div class="bg-gradient-to-br from-violet-900/30 to-purple-900/20 border border-violet-500/30 rounded-2xl p-6 waiting-glow">
            ...
            ${y.commitment.commitTxHash?`
                <div class="text-center mt-3">
                    <a href="${Zs}${y.commitment.commitTxHash}" target="_blank" 
    ...
    `,(l=document.getElementById("btn-reveal"))==null||l.addEventListener("click",()=>{y.commitment.canReveal&&qr()}),Qs()}function Qs(){if(y.phase!=="waiting")return;const e=document.getElementById("countdown-timer"),t=document.getElementById("progress-bar");if(document.getElementById("btn-reveal"),document.getElementById("reveal-btn-text"),!e)return;const a=Date.now()-(y.commitment.waitStartTime||Date.now()),n=y.commitment.revealDelay*td,r=Math.max(0,n-a),i=Math.ceil(r/1e3);if(i>0?e.textContent=`~${i}s`:y.commitment.canReveal?e.textContent="Ready!":e.textContent="Verifying on chain...",t){const s=Math.min(100,a/n*100);t.style.width=`${s}%`}y.phase==="waiting"&&setTimeout(Qs,1e3)}function Km(){Re&&clearInterval(Re),setTimeout(Qs,100),Re=setInterval(async()=>{if(y.phase!=="waiting"){clearInterval(Re);return}try{await qm()&&!y.commitment.canReveal&&(y.commitment.canReveal=!0,clearInterval(Re),Re=null,console.log("[FortunePool] canReveal=true, starting auto-reveal..."),Ym())}catch(e){console.warn("Reveal check error:",e)}},Lm)}async function Ym(){if(y.phase!=="waiting")return;const e=document.getElementById("countdown-timer"),t=document.getElementById("btn-reveal"),a=document.getElementById("reveal-btn-text");e&&(e.textContent="Revealing..."),t&&(t.disabled=!0,t.classList.remove("bg-zinc-800","text-zinc-500","cursor-not-allowed"),t.classList.add("bg-gradient-to-r","from-amber-500","to-yellow-500","text-white")),a&&(a.textContent="Auto-revealing...");const n=y.mode==="jackpot"?[y.guess]:y.guesses,r=5,i=2e3;await new Promise(s=>setTimeout(s,3e3));for(let s=1;s<=r;s++){if(y.phase!=="waiting")return;try{const o=c.fortunePoolContractPublic;o&&await o.revealPlay.staticCall(y.gameId,n,y.commitment.userSecret,{from:c.userAddress}),console.log(`[FortunePool] Pre-simulation passed (attempt ${s})`),qr();return}catch(o){const l=o.message||"",d=l.includes("0x92555c0e")||l.includes("BlockhashUnavailable");if(d&&s<r)console.log(`[FortunePool] BlockhashUnavailable, retry in ${i}ms (${s}/${r})`),e&&(e.textContent="Syncing block data..."),await new Promise(u=>setTimeout(u,i));else if(d){console.warn("[FortunePool] Pre-sim retries exhausted, enabling manual button"),Vm();return}else{console.log("[FortunePool] Pre-sim error (non-blockhash), trying direct reveal:",l),qr();return}}}}function Vm(){const e=document.getElementById("btn-reveal"),t=document.getElementById("reveal-btn-text"),a=document.getElementById("countdown-timer");a&&(a.textContent="Ready!"),e&&(e.disabled=!1,e.classList.remove("bg-zinc-800","text-zinc-500","cursor-not-allowed","from-amber-500","to-yellow-500"),e.classList.add("bg-gradient-to-r","from-emerald-500","to-green-500","text-white")),t&&(t.textContent="Reveal & Get Result!")}async function qm(){if(!c.fortunePoolContractPublic||!y.gameId)return!1;try{const e=await c.fortunePoolContractPublic.getCommitmentStatus(y.gameId);if(!y.commitment.commitBlock)try{const t=await c.fortunePoolContractPublic.getCommitment(y.gameId),a=Number(t.commitBlock);a>0&&(y.commitment.commitBlock=a)}catch{}return e.canReveal===!0}catch{return Date.now()-(y.commitment.waitStartTime||Date.now())>=3e4}}async function qr(){if(!y.commitment.canReveal){x("Not ready to reveal yet!","warning");return}const e=document.getElementById("btn-reveal");try{const t=y.mode==="jackpot"?[y.guess]:y.guesses;await Qn.revealPlay({gameId:y.gameId,guesses:t,userSecret:y.commitment.userSecret,button:e,onSuccess:(a,n)=>{Re&&clearInterval(Re),y.txHash=a.hash,y.result={rolls:(n==null?void 0:n.rolls)||[],prizeWon:(n==null?void 0:n.prizeWon)||0n,matches:(n==null?void 0:n.matches)||[],matchCount:(n==null?void 0:n.matchCount)||0},console.log("🎲 Game revealed:",y.result),y.phase="result",ue(),eo()},onError:a=>{if(!a.cancelled){const n=a.message||"";n.includes("0x92555c0e")||n.includes("BlockhashUnavailable")?x("Block data not available yet. RPC will retry automatically.","warning"):x(n||"Reveal failed","error")}e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-dice mr-2"></i>Try Again')}})}catch(t){console.error("Reveal error:",t),x("Reveal failed: "+(t.message||"Unknown error"),"error"),e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-dice mr-2"></i>Try Again')}}function Xm(e){var m,p;const t=y.result;if(!t)return ue();const a=y.mode==="jackpot",n=a?[y.guess]:y.guesses,r=t.rolls||[],i=a?[me[2]]:me,s=n.map((b,f)=>{const w=r[f]!==void 0?Number(r[f]):null;return w!==null&&w===b}),o=s.filter(b=>b).length,l=t.prizeWon>0||o>0;let d=0;t.prizeWon&&t.prizeWon>0n?d=D(BigInt(t.prizeWon)):o>0&&s.forEach((b,f)=>{if(b){const w=a?me[2]:me[f];d+=y.wager*w.multiplier}});const u=typeof d=="number"?d.toLocaleString(void 0,{maximumFractionDigits:2}):d.toLocaleString();e.innerHTML=`
        <div class="bg-gradient-to-br ${l?"from-emerald-900/30 to-green-900/10 border-emerald-500/30":"from-zinc-900 to-zinc-800/50 border-zinc-700/50"} border rounded-2xl p-4 sm:p-6 relative overflow-hidden" id="result-container">
            ...
            <div class="grid ${a?"grid-cols-1 max-w-[200px] mx-auto":"grid-cols-3"} gap-2 sm:gap-3 mb-4">
                ${i.map((b,f)=>{const w=a?n[0]:n[f],k=r[f],C=s[f];return`
                            ...
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-lg ${C?"bg-emerald-500/30 border-emerald-500":"bg-zinc-700/50 border-zinc-600"} border flex items-center justify-center">
                                        <span class="text-lg sm:text-xl font-black ${C?"text-emerald-400":"text-zinc-300"}">${k!==void 0?k:"?"}</span>
                                    </div>
                                </div>
                            </div>
            ...
            ${y.txHash?`
                <div class="text-center mb-3">
                    <a href="${Zs}${y.txHash}" target="_blank" class="inline-flex items-center gap-2 text-xs text-zinc-500 hover:text-zinc-400">
                        <i class="fa-solid fa-external-link"></i>
                        View Transaction
                    </a>
                </div>
            ...
            <div class="bg-gradient-to-r ${l?"from-amber-500/10 to-orange-500/10 border-amber-500/30":"from-zinc-800/50 to-zinc-700/30 border-zinc-600/30"} border rounded-xl p-3 mb-3">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <div>
                        ...
                        <p class="text-amber-400 text-xs font-medium">+${Vr} Airdrop Points</p>
                    </div>
                </div>
    ...
    `,l&&(Jm(),d>y.wager*10&&Zm()),(m=document.getElementById("btn-new-game"))==null||m.addEventListener("click",()=>{y.phase="select",y.result=null,y.txHash=null,y.gameId=null,ue(),eo()}),(p=document.getElementById("btn-share"))==null||p.addEventListener("click",()=>{Qm(l,d)})}function Jm(){const e=document.createElement("div");e.className="confetti-container",document.body.appendChild(e);const t=["#f59e0b","#10b981","#8b5cf6","#ec4899","#06b6d4"],a=["●","■","★","🐯","🎉"];for(let n=0;n<60;n++){const r=document.createElement("div");r.className="confetti",r.style.cssText=`
            left: ${Math.random()*100}%;
            color: ${t[n%t.length]};
            font-size: ${8+Math.random()*12}px;
            animation-delay: ${Math.random()*2}s;
            animation-duration: ${2+Math.random()*2}s;
        `,r.textContent=a[n%a.length],e.appendChild(r)}setTimeout(()=>e.remove(),5e3)}function Zm(){const e=["🪙","💰","✨","⭐","🎉"];for(let t=0;t<30;t++)setTimeout(()=>{const a=document.createElement("div");a.className="coin",a.textContent=e[Math.floor(Math.random()*e.length)],a.style.left=`${Math.random()*100}%`,a.style.animationDelay=`${Math.random()*.5}s`,a.style.animationDuration=`${2+Math.random()*2}s`,document.body.appendChild(a),setTimeout(()=>a.remove(),4e3)},t*100)}function Qm(e,t){var l,d,u,m,p,b;const a=el[Xe],n=()=>{const f=$m[Xe];return e?f.win(t):f.lose},r=`
        <div class="text-center">
            <img src="${vn}" class="w-16 h-16 mx-auto mb-2" alt="Fortune Pool" onerror="this.style.display='none'">
            ...
            <div class="flex justify-center gap-2 mb-4">
                <button class="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${Xe==="pt"?"bg-amber-500/20 border-amber-500 ring-1 ring-amber-500/50":"bg-zinc-800 border-zinc-700 hover:border-zinc-500"} border" data-lang="pt">
                    <img src="${Er.pt}" class="w-5 h-5 rounded-full object-cover" alt="PT">
                    <span class="${Xe==="pt"?"text-amber-400":"text-zinc-400"}">PT</span>
                </button>
                <button class="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${Xe==="en"?"bg-amber-500/20 border-amber-500 ring-1 ring-amber-500/50":"bg-zinc-800 border-zinc-700 hover:border-zinc-500"} border" data-lang="en">
                    <img src="${Er.en}" class="w-5 h-5 rounded-full object-cover" alt="EN">
                    <span class="${Xe==="en"?"text-amber-400":"text-zinc-400"}">EN</span>
                </button>
                <button class="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${Xe==="es"?"bg-amber-500/20 border-amber-500 ring-1 ring-amber-500/50":"bg-zinc-800 border-zinc-700 hover:border-zinc-500"} border" data-lang="es">
                    <img src="${Er.es}" class="w-5 h-5 rounded-full object-cover" alt="ES">
                    <span class="${Xe==="es"?"text-amber-400":"text-zinc-400"}">ES</span>
                </button>
            </div>
    ...
    `;Aa(r,"max-w-xs");const i=f=>{Xe=f;const w=el[f],k=document.getElementById("share-modal-title"),C=document.getElementById("share-modal-subtitle"),P=document.getElementById("btn-close-share");k&&(k.textContent=w.title),C&&(C.textContent=w.subtitle),P&&(P.textContent=w.later),document.querySelectorAll(".lang-btn").forEach(S=>{const _=S.dataset.lang,B=S.querySelector("span");_===f?(S.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-amber-500/20 border-amber-500 ring-1 ring-amber-500/50 border",B&&(B.className="text-amber-400")):(S.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-zinc-800 border-zinc-700 hover:border-zinc-500 border",B&&(B.className="text-zinc-400"))})};document.querySelectorAll(".lang-btn").forEach(f=>{f.addEventListener("click",()=>i(f.dataset.lang))});const s=async f=>{if(!c.userAddress)return!1;try{const k=await(await fetch("https://us-central1-backchain-backand.cloudfunctions.net/trackShare",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({address:c.userAddress,gameId:y.gameId||Date.now(),type:"fortune",platform:f})})).json();return k.success?(x(`🎉 +${k.pointsAwarded||Vr} Airdrop Points!`,"success"),!0):(k.reason==="already_shared"&&console.log("Already shared this game"),!1)}catch(w){return console.error("Share tracking error:",w),x(`🎉 +${Vr} Airdrop Points!`,"success"),!0}},o=async(f,w)=>{await s(f),window.open(w,"_blank"),Ie()};(l=document.getElementById("share-twitter"))==null||l.addEventListener("click",()=>{const f=n();o("twitter",`https://twitter.com/intent/tweet?text=${encodeURIComponent(f)}`)}),(d=document.getElementById("share-telegram"))==null||d.addEventListener("click",()=>{const f=n();o("telegram",`https://t.me/share/url?url=https://backcoin.org&text=${encodeURIComponent(f)}`)}),(u=document.getElementById("share-whatsapp"))==null||u.addEventListener("click",()=>{const f=n();o("whatsapp",`https://wa.me/?text=${encodeURIComponent(f)}`)}),(m=document.getElementById("share-instagram"))==null||m.addEventListener("click",async()=>{const f=n();try{await navigator.clipboard.writeText(f),await s("instagram");const w=`
            ...
            `;Ie(),setTimeout(()=>{var k,C;Aa(w,"max-w-xs"),(k=document.getElementById("btn-open-instagram"))==null||k.addEventListener("click",()=>{window.open("https://www.instagram.com/backcoin.bkc/","_blank"),Ie()}),(C=document.getElementById("btn-close-ig-modal"))==null||C.addEventListener("click",Ie)},100)}catch{x("Could not copy text","error"),Ie()}}),(p=document.getElementById("share-copy"))==null||p.addEventListener("click",async()=>{const f=n();try{await navigator.clipboard.writeText(f),x("📋 Copied!","success"),await s("copy")}catch{x("Copy failed","error")}Ie()}),(b=document.getElementById("btn-close-share"))==null||b.addEventListener("click",Ie)}async function ef(){const e=c.fortunePoolContract||c.fortunePoolContractPublic;if(!e)return console.log("No fortune contract available"),null;try{const[t,a,n]=await Promise.all([e.prizePool().catch(()=>0n),e.gameCounter().catch(()=>0),e.TIER_COUNT().catch(()=>3)]);let r=0n,i=0n,s=0n;try{r=await e.getRequiredFee(1),i=await e.getRequiredFee(7),s=r,console.log(`Service fees: single=${Number(r)/1e18} ETH, all=${Number(i)/1e18} ETH`)}catch(o){console.log("getRequiredFee failed:",o.message)}y.serviceFee=s,y.serviceFee1x=r,y.serviceFee5x=i;try{const o=await e.REVEAL_DELAY();y.commitment.revealDelay=Number(o)||2,console.log("REVEAL_DELAY from contract:",y.commitment.revealDelay)}catch{console.log("Using default revealDelay:",y.commitment.revealDelay)}try{const[o,l,d]=await e.getAllTiers();y.tiersData=o.map((u,m)=>({range:Number(u),multiplier:Number(l[m])/1e4,winChance:Number(d[m])/1e4})),console.log("Tiers from contract:",y.tiersData)}catch{console.log("Using default tiers")}return{prizePool:t||0n,gameCounter:Number(a)||0,serviceFee:s,serviceFee1x:r,serviceFee5x:i,tierCount:Number(n)||3}}catch(t){return console.error("getFortunePoolStatus error:",t),{prizePool:0n,gameCounter:0,serviceFee:0n}}}async function eo(){try{const e=await ef();if(e){const a=document.getElementById("prize-pool"),n=document.getElementById("total-games");a&&(a.textContent=D(e.prizePool||0n).toFixed(2)+" BKC"),n&&(n.textContent=(e.gameCounter||0).toLocaleString())}const t=document.getElementById("user-balance");t&&(t.textContent=D(c.currentUserBalance||0n).toFixed(2)+" BKC"),tf()}catch(e){console.error("Pool error:",e)}}async function tf(){var e;try{const t=Ye.fortuneGames||"https://getfortunegames-4wvdcuoouq-uc.a.run.app",a=c.userAddress?`${t}?player=${c.userAddress}&limit=15`:`${t}?limit=15`,r=await(await fetch(a)).json();if(((e=r.games)==null?void 0:e.length)>0){af(r.games);const i=r.games.filter(o=>o.isWin||o.prizeWon&&BigInt(o.prizeWon)>0n).length,s=document.getElementById("win-rate");s&&(s.textContent=`🏆 ${i}/${r.games.length} wins`)}else{const i=document.getElementById("history-list");i&&(i.innerHTML=`
                <div class="p-8 text-center">
                    <img src="${vn}" class="w-16 h-16 mx-auto opacity-20 mb-3" onerror="this.style.display='none'">
                    <p class="text-zinc-500 text-sm">No games yet</p>
                    <p class="text-zinc-600 text-xs mt-1">Be the first to play!</p>
                </div>
            `)}}catch(t){console.error("loadHistory error:",t)}}function af(e){const t=document.getElementById("history-list");t&&(t.innerHTML=e.map(a=>{var f;const n=a.isWin||a.prizeWon&&BigInt(a.prizeWon)>0n,r=a.prizeWon?D(BigInt(a.prizeWon)):0,i=a.wagerAmount?D(BigInt(a.wagerAmount)):0,s=a.isCumulative,o=a.rolls||[],l=a.guesses||[],d=a.txHash||a.transactionHash,u=nf(a.timestamp||a.createdAt),m=a.player?`${a.player.slice(0,6)}...${a.player.slice(-4)}`:"???",p=c.userAddress&&((f=a.player)==null?void 0:f.toLowerCase())===c.userAddress.toLowerCase(),b=d?`${Zs}${d}`:null;return`
               ...
               ${b?"":'onclick="return false;"'}>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex gap-1">
                        ${(s?me:[me[2]]).map((w,k)=>{const C=l[k],P=o[k];return`
        ...
        `}).join(""))}function nf(e){if(!e)return"N/A";try{const t=Date.now();let a;if(typeof e=="number"?a=e>1e12?e:e*1e3:typeof e=="string"?a=new Date(e).getTime():e._seconds?a=e._seconds*1e3:e.seconds?a=e.seconds*1e3:a=new Date(e).getTime(),isNaN(a))return"N/A";const n=t-a;if(n<0)return"Just now";const r=Math.floor(n/6e4),i=Math.floor(n/36e5),s=Math.floor(n/864e5);return r<1?"Just now":r<60?`${r}m ago`:i<24?`${i}h ago`:s<7?`${s}d ago`:new Date(a).toLocaleDateString("en-US",{month:"short",day:"numeric"})}catch(t){return console.error("getTimeAgo error:",t),"N/A"}}const rf={render:_m,cleanup:Fm},sf=()=>{if(document.getElementById("about-styles-v4"))return;const e=document.createElement("style");e.id="about-styles-v4",e.innerHTML=`
        @keyframes pulse-hub {
    ...
    `,document.head.appendChild(e)};function of(){return`
    ...
    `,document.head.appendChild(e)}async function ma(){var e;z.isConnected=c.isConnected,z.user=null,z.userSubmissions=[],z.platformUsage={},z.isBanned=!1;try{const t=await si();if(z.systemConfig=t.config,z.leaderboards=t.leaderboards,z.dailyTasks=t.dailyTasks||[],z.platformUsageConfig=t.platformUsageConfig||nd,z.isConnected&&c.userAddress){const[a,n]=await Promise.all([ha(c.userAddress),Pu()]);if(z.user=a,z.userSubmissions=n,a&&a.isBanned){z.isBanned=!0;return}try{typeof So=="function"&&(z.platformUsage=await So()||{})}catch(r){console.warn("Could not load platform usage:",r),z.platformUsage={}}z.dailyTasks.length>0&&(z.dailyTasks=await Promise.all(z.dailyTasks.map(async r=>{try{if(!r.id)return{...r,eligible:!1,timeLeftMs:0};const i=await Vl(r.id,r.cooldownHours);return{...r,eligible:i.eligible,timeLeftMs:i.timeLeft}}catch{return{...r,eligible:!1,timeLeftMs:0}}})))}}catch(t){if(console.error("Airdrop Data Load Error:",t),t.code==="permission-denied"||(e=t.message)!=null&&e.includes("permission")){console.warn("Firebase permissions issue - user may need to connect wallet or sign in"),z.systemConfig=z.systemConfig||{},z.leaderboards=z.leaderboards||{top100ByPoints:[],top100ByPosts:[]},z.dailyTasks=z.dailyTasks||[];return}x("Error loading data. Please refresh.","error")}}function kf(e){if(!z.user||!e||e.length===0)return null;const t=e.findIndex(a=>{var n,r;return((n=a.walletAddress)==null?void 0:n.toLowerCase())===((r=z.user.walletAddress)==null?void 0:r.toLowerCase())});return t>=0?t+1:null}function Ef(e){return e?e<=5?mt[0]:e<=25?mt[1]:e<=75?mt[2]:e<=200?mt[3]:null:null}function rd(){var l;const{user:e}=z,t=(e==null?void 0:e.totalPoints)||0,a=(e==null?void 0:e.platformUsagePoints)||0,n=(e==null?void 0:e.approvedSubmissionsCount)||0,r=wf(n),i=((l=z.leaderboards)==null?void 0:l.top100ByPosts)||[],s=kf(i),o=Ef(s);return`
        <!-- Mobile Header -->
        <div class="md:hidden px-4 pt-4 pb-2">
            ...
            <div class="flex gap-1 bg-zinc-900/80 p-1 rounded-2xl border border-zinc-800">
                ${Tr("earn","fa-coins","Earn")}
                ${Tr("history","fa-clock-rotate-left","History")}
                ${Tr("leaderboard","fa-trophy","Ranking")}
            </div>
        </div>
        ...
        <div class="hidden md:block px-4 pt-6 pb-4">
            ...
            <div class="flex justify-center">
                <div class="bg-zinc-900/80 p-1.5 rounded-full border border-zinc-800 inline-flex gap-1">
                    ${Cr("earn","fa-coins","Earn Points")}
                    ${Cr("history","fa-clock-rotate-left","My History")}
                    ${Cr("leaderboard","fa-trophy","Ranking")}
                </div>
            </div>
        </div>
    `}function Tr(e,t,a){const n=z.activeTab===e;return`
    ...
    `}function Cr(e,t,a){const n=z.activeTab===e;return`
        <button data-target="${e}" 
    ...
    `}function Ir(){return z.isConnected?`
        <div class="px-4 airdrop-fade-up">
            ...
            <!-- Sub-tab Content -->
            <div id="earn-content">
                ${z.activeEarnTab==="post"?Tf():""}
                ${z.activeEarnTab==="platform"?Cf():""}
                ${z.activeEarnTab==="tasks"?If():""}
            </div>
        </div>
    `:`
        ...
        `}function Tf(){const{user:e}=z,a=`https://backcoin.org/?ref=${(e==null?void 0:e.referralCode)||"CODE"}`;return`
        <div class="space-y-4">
                ...
                <div class="space-y-5">
                    ...
                    <div class="flex gap-3 items-start relative">
                        ...
                        <div class="flex-1 pb-2">
                            ...
                            <div class="bg-black/40 p-2.5 rounded-lg border border-zinc-700/50 mb-2">
                                ...
                                <p class="text-xs font-mono text-zinc-600 mt-1">${Jr}</p>
                            </div>
                    ...
                    <div class="flex gap-3 items-start relative">
                        ...
                        <div class="flex-1 pb-2">
                            ...
                            <div class="grid grid-cols-4 gap-2">
                                <a href="https://twitter.com/intent/tweet?text=${encodeURIComponent(a+" "+Jr)}" target="_blank" 
    ...
    `}function Cf(){var s;const e=z.platformUsageConfig||nd,t=z.platformUsage||{};let a=0,n=0;Object.keys(e).forEach(o=>{var l;e[o].enabled!==!1&&e[o].maxCount&&(a+=e[o].maxCount,n+=Math.min(((l=t[o])==null?void 0:l.count)||0,e[o].maxCount))});const r=a>0?n/a*100:0,i=((s=z.user)==null?void 0:s.platformUsagePoints)||0;return`
        <div class="space-y-4">
            <!-- Info Banner -->
            ...
            <div class="grid grid-cols-2 gap-2" id="platform-actions-grid">
                ${Object.entries(e).filter(([o,l])=>l.enabled!==!1).map(([o,l])=>{const d=t[o]||{count:0},u=d.count>=l.maxCount,m=Math.max(0,l.maxCount-d.count),p=d.count/l.maxCount*100,b=xf[o]||"";return`
    ...
    `}function If(){const e=z.dailyTasks||[],t=e.filter(n=>n.eligible),a=e.filter(n=>!n.eligible&&n.timeLeftMs>0);return`
        <div class="space-y-4">
            <!-- Info Banner -->
                        ...
                        ${a.map(n=>`
                            <div class="bg-zinc-900/80 border border-zinc-800 rounded-xl p-3 opacity-50">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-zinc-600 text-xs">${hf(n.timeLeftMs)}</span>
                                </div>
                            </div>
                        `).join("")}
                    </div>
    ...
    `}function Af(){const{user:e,userSubmissions:t}=z;if(!z.isConnected)return`
            <div class="text-center px-4 py-12 airdrop-fade-up">
        ...
        `;const a=Date.now(),n=ad*60*60*1e3,r=t.filter(l=>["pending","auditing"].includes(l.status)&&l.submittedAt&&a-l.submittedAt.getTime()>=n),i=(e==null?void 0:e.approvedSubmissionsCount)||0,s=t.filter(l=>["pending","auditing"].includes(l.status)).length,o=t.filter(l=>l.status==="rejected").length;return`
                ...
                <div class="bg-zinc-900/80 border border-zinc-800 rounded-xl overflow-hidden">
                    ${t.length===0?`<div class="p-8 text-center">
                            ...
                            <p class="text-zinc-600 text-xs mt-1">Create your first post to get started!</p>
                                ...
                                `);const k=l.pointsAwarded?`+${l.pointsAwarded}`:"-";return`
                                <div class="p-3 ${u?"":"border-b border-zinc-800"} ${f}">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span class="font-mono font-bold ${l.pointsAwarded?"text-green-400":"text-zinc-600"} text-sm shrink-0">${k}</span>
                                    </div>
                                    ${w}
                                </div>
                            `}).join("")}
    ...
    `}function Pf(){var u,m;const e=((u=z.leaderboards)==null?void 0:u.top100ByPosts)||[],t=((m=z.leaderboards)==null?void 0:m.top100ByPoints)||[],a=z.activeRanking||"posts";function n(p,b,f){var B,I;const w=z.user&&((B=p.walletAddress)==null?void 0:B.toLowerCase())===((I=z.user.walletAddress)==null?void 0:I.toLowerCase()),k=zf(b+1),C=f==="posts"?"bg-amber-500/10":"bg-green-500/10",P=f==="posts"?"text-amber-400":"text-green-400",S=f==="posts"?"text-white":"text-green-400",_=f==="posts"?"posts":"pts";return`
            <div class="flex items-center justify-between p-3 ${w?C:"hover:bg-zinc-800/50"} transition-colors">
                <div class="flex items-center gap-3">
                    <span class="w-8 h-8 rounded-full ${k.bg} flex items-center justify-center text-xs font-bold">${k.icon||b+1}</span>
                    <div class="flex flex-col">
                        <span class="font-mono text-xs ${w?P+" font-bold":"text-zinc-400"}">
                            ${ca(p.walletAddress)}${w?" (You)":""}
                        </span>
                        ${k.tierName?`<span class="text-[9px] ${k.tierTextColor}">${k.tierName}</span>`:""}
                    </div>
                </div>
                <span class="font-bold ${S} text-sm">${(p.value||0).toLocaleString()} <span class="text-zinc-500 text-xs">${_}</span></span>
            </div>
    ...
    `}function zf(e){return e<=5?{icon:"💎",bg:"bg-cyan-500/20 text-cyan-300",tierName:"Diamond",tierTextColor:"text-cyan-400/70"}:e<=25?{icon:"🥇",bg:"bg-yellow-500/20 text-yellow-400",tierName:"Gold",tierTextColor:"text-yellow-400/70"}:e<=75?{icon:"🥈",bg:"bg-gray-400/20 text-gray-300",tierName:"Silver",tierTextColor:"text-gray-400/70"}:e<=200?{icon:"🥉",bg:"bg-amber-600/20 text-amber-500",tierName:"Bronze",tierTextColor:"text-amber-500/70"}:{icon:null,bg:"bg-zinc-800 text-zinc-400",tierName:null,tierTextColor:""}}function Me(){const e=document.getElementById("main-content"),t=document.getElementById("airdrop-header");if(e){if(t&&(t.innerHTML=rd()),z.isBanned){e.innerHTML=`
        ...
        `;return}switch(document.querySelectorAll(".nav-pill-btn").forEach(a=>{const n=a.dataset.target;a.closest(".md\\:hidden")?n===z.activeTab?(a.classList.add("airdrop-tab-active","shadow-lg"),a.classList.remove("text-zinc-500")):(a.classList.remove("airdrop-tab-active","shadow-lg"),a.classList.add("text-zinc-500")):n===z.activeTab?(a.classList.remove("text-zinc-400","hover:text-white","hover:bg-zinc-800"),a.classList.add("airdrop-tab-active","shadow-lg","shadow-amber-500/20")):(a.classList.add("text-zinc-400","hover:text-white","hover:bg-zinc-800"),a.classList.remove("airdrop-tab-active","shadow-lg","shadow-amber-500/20"))}),z.activeTab){case"earn":e.innerHTML=Ir();break;case"post":e.innerHTML=Ir();break;case"history":e.innerHTML=Af();break;case"leaderboard":e.innerHTML=Pf();break;default:e.innerHTML=Ir()}}}function Bf(){var a;const e=((a=z.user)==null?void 0:a.referralCode)||"CODE",t=`${e!=="CODE"?`https://backcoin.org/?ref=${e}`:"https://backcoin.org"} ${Jr}`;navigator.clipboard.writeText(t).then(()=>{x("Copied! Now paste it in your post.","success");const n=document.getElementById("copy-viral-btn");if(n){const r=n.innerHTML;n.innerHTML='<i class="fa-solid fa-check"></i> Copied!',n.classList.remove("cta-mega"),n.classList.add("bg-green-600"),setTimeout(()=>{n.innerHTML=r,n.classList.add("cta-mega"),n.classList.remove("bg-green-600")},2e3)}}).catch(()=>x("Failed to copy.","error"))}function nl(e){const t=e.target.closest(".nav-pill-btn");t&&(z.activeTab=t.dataset.target,Me())}function Nf(e){const t=e.target.closest(".earn-tab-btn");t&&t.dataset.earnTab&&(z.activeEarnTab=t.dataset.earnTab,Me())}function Sf(e){const t=e.target.closest(".ranking-tab-btn");t&&t.dataset.ranking&&(z.activeRanking=t.dataset.ranking,Me())}function $f(){z.isGuideOpen=!z.isGuideOpen,Me()}function id(e){var r;const t=`
        <div class="text-center">
            <!-- Imagem de CAUTION -->
    ...
    `;Aa(t,"max-w-md"),(r=document.getElementById("deletePostBtn"))==null||r.addEventListener("click",async i=>{const s=i.currentTarget,o=s.dataset.submissionId;s.disabled=!0,s.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-1"></i> Deleting...';try{await ql(o),x("Post deleted. No penalty applied.","info"),Ie(),await ma(),Me()}catch(l){x(l.message,"error"),s.disabled=!1,s.innerHTML='<i class="fa-solid fa-trash mr-1"></i> Delete Post'}});const a=document.getElementById("confirmCheckbox"),n=document.getElementById("finalConfirmBtn");a==null||a.addEventListener("change",()=>{a.checked?(n.disabled=!1,n.className="flex-1 bg-green-600 hover:bg-green-500 text-white py-3 rounded-xl font-bold text-sm transition-colors cursor-pointer",n.innerHTML='<i class="fa-solid fa-check mr-1"></i> Confirm & Earn ✓'):(n.disabled=!0,n.className="flex-1 bg-green-600/50 text-green-200 py-3 rounded-xl font-bold text-sm cursor-not-allowed transition-colors",n.innerHTML='<i class="fa-solid fa-lock mr-1"></i> Confirm & Earn')}),n==null||n.addEventListener("click",Lf)}async function Lf(e){const t=e.currentTarget,a=t.dataset.submissionId;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-2"></i> Verifying...';try{await zu(a),x("Success! Points added.","success"),Ie(),await ma(),Me()}catch{x("Verification failed.","error"),t.disabled=!1,t.innerHTML="Try Again"}}async function Rf(e){const t=e.target.closest(".action-btn");if(!t)return;const a=t.dataset.action,n=t.dataset.id;if(a==="confirm"){const r=z.userSubmissions.find(i=>i.submissionId===n);r&&id(r)}else if(a==="delete"){if(!confirm("Remove this submission?"))return;try{await ql(n),x("Removed.","info"),await ma(),Me()}catch(r){x(r.message,"error")}}}async function _f(e){const t=e.target.closest("#submit-content-btn");if(!t)return;const a=document.getElementById("content-url-input"),n=a==null?void 0:a.value.trim();if(!n||!n.startsWith("http"))return x("Enter a valid URL.","warning");const r=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-circle-notch fa-spin"></i>';try{await Au(n),x("📋 Submitted! Your post is now under security audit.","info"),a.value="",await ma(),z.activeTab="history",Me()}catch(i){x(i.message,"error")}finally{t.disabled=!1,t.innerHTML=r}}async function Ff(e){const t=e.target.closest(".task-card");if(!t)return;const a=t.dataset.id,n=t.dataset.url;n&&window.open(n,"_blank");const r=z.dailyTasks.find(i=>i.id===a);if(!(!r||!r.eligible))try{await Cu(r,z.user.pointsMultiplier),x(`Task completed! +${r.points} pts`,"success"),await ma(),Me()}catch(i){i.message.includes("Cooldown")||x(i.message,"error")}}function Mf(){const e=Date.now(),t=ad*60*60*1e3,a=z.userSubmissions.filter(n=>["pending","auditing"].includes(n.status)&&n.submittedAt&&e-n.submittedAt.getTime()>=t);a.length>0&&(z.activeTab="history",Me(),setTimeout(()=>{id(a[0])},500))}const Df={async render(e){const t=document.getElementById("airdrop");if(!t)return;yf();const a=vf();(t.innerHTML.trim()===""||e)&&(t.innerHTML=`
            ...
            `,this.attachListeners());try{const n=new Promise(o=>setTimeout(o,4e3));await Promise.all([ma(),n]);const r=document.getElementById("loading-state"),i=document.getElementById("airdrop-main"),s=document.getElementById("main-content");r&&(r.style.transition="opacity 0.5s ease-out",r.style.opacity="0",await new Promise(o=>setTimeout(o,500)),r.classList.add("hidden")),i&&i.classList.remove("hidden"),s&&(s.classList.remove("hidden"),Me()),Mf()}catch(n){console.error(n)}},attachListeners(){const e=document.getElementById("airdrop-body"),t=document.getElementById("airdrop-header");t==null||t.addEventListener("click",nl),e==null||e.addEventListener("click",a=>{a.target.closest("#guide-toggle-btn")&&$f(),a.target.closest("#submit-content-btn")&&_f(a),a.target.closest(".task-card")&&Ff(a),a.target.closest(".action-btn")&&Rf(a),a.target.closest("#copy-viral-btn")&&Bf(),a.target.closest(".ranking-tab-btn")&&Sf(a),a.target.closest(".earn-tab-btn")&&Nf(a),a.target.closest(".nav-pill-btn")&&nl(a);const n=a.target.closest(".platform-action-card");if(n&&!n.classList.contains("completed")){const r=n.dataset.targetPage;r&&(console.log("🎯 Navigating to:",r),Of(r))}})},update(e){z.isConnected!==e&&this.render(!0)}};function Of(e){console.log("🎯 Platform card clicked, navigating to:",e);const t=document.querySelector(`a[data-target="${e}"]`)||document.querySelector(`[data-target="${e}"]`);if(t){console.log("✅ Found menu link, clicking..."),t.click();const r=document.getElementById("sidebar");r&&window.innerWidth<768&&r.classList.add("hidden");return}const a=document.querySelectorAll("main > section"),n=document.getElementById(e);if(n){console.log("✅ Found section, showing directly..."),a.forEach(i=>i.classList.add("hidden")),n.classList.remove("hidden"),document.querySelectorAll(".sidebar-link").forEach(i=>{i.classList.remove("active","bg-zinc-700","text-white"),i.classList.add("text-zinc-400")});const r=document.querySelector(`[data-target="${e}"]`);r&&(r.classList.add("active","bg-zinc-700","text-white"),r.classList.remove("text-zinc-400"));return}console.warn("⚠️ Could not navigate to:",e)}const sd=window.ethers,wn="".toLowerCase(),Hf="",od="bkc_admin_auth_v3";window.__ADMIN_WALLET__=wn;setTimeout(()=>{document.dispatchEvent(new CustomEvent("adminConfigReady")),console.log("✅ Admin config ready, wallet:",wn?"configured":"not set")},100);function rl(){return sessionStorage.getItem(od)==="true"}function Uf(){sessionStorage.setItem(od,"true")}function jf(){return!c.isConnected||!c.userAddress||!wn?!1:c.userAddress.toLowerCase()===wn}const il={pending:{text:"Pending Review",color:"text-amber-400",bgColor:"bg-amber-900/50",icon:"fa-clock"},auditing:{text:"Auditing",color:"text-blue-400",bgColor:"bg-blue-900/50",icon:"fa-magnifying-glass"},approved:{text:"Approved",color:"text-green-400",bgColor:"bg-green-900/50",icon:"fa-check-circle"},rejected:{text:"Rejected",color:"text-red-400",bgColor:"bg-red-900/50",icon:"fa-times-circle"},flagged_suspicious:{text:"Flagged",color:"text-red-300",bgColor:"bg-red-800/60",icon:"fa-flag"}},cr={faucet:{icon:"🚰",label:"Claim Faucet",points:1e3,maxCount:1,cooldownHours:0,enabled:!0},delegation:{icon:"📊",label:"Delegate BKC",points:2e3,maxCount:10,cooldownHours:24,enabled:!0},fortune:{icon:"🎰",label:"Play Fortune",points:1500,maxCount:10,cooldownHours:1,enabled:!0},buyNFT:{icon:"🛒",label:"Buy NFT",points:2500,maxCount:10,cooldownHours:0,enabled:!0},sellNFT:{icon:"💰",label:"Sell NFT",points:1500,maxCount:10,cooldownHours:0,enabled:!0},listRental:{icon:"🏷️",label:"List for Rent",points:1e3,maxCount:10,cooldownHours:0,enabled:!0},rentNFT:{icon:"⏰",label:"Rent NFT",points:2e3,maxCount:10,cooldownHours:0,enabled:!0},notarize:{icon:"📜",label:"Notarize Doc",points:2e3,maxCount:10,cooldownHours:0,enabled:!0},claimReward:{icon:"💸",label:"Claim Rewards",points:1e3,maxCount:10,cooldownHours:24,enabled:!0},unstake:{icon:"↩️",label:"Unstake",points:500,maxCount:10,cooldownHours:0,enabled:!0}};let A={allSubmissions:[],dailyTasks:[],ugcBasePoints:null,platformUsageConfig:null,editingTask:null,activeTab:"review-submissions",allUsers:[],selectedUserSubmissions:[],isSubmissionsModalOpen:!1,selectedWallet:null,usersFilter:"all",usersSearch:"",usersPage:1,usersPerPage:100,submissionsPage:1,submissionsPerPage:100,tasksPage:1,tasksPerPage:100};const Ea=async()=>{var t;const e=document.getElementById("admin-content-wrapper");if(e){const a=document.createElement("div");e.innerHTML=a.innerHTML}try{c.userAddress&&(await Yl(c.userAddress),console.log("✅ Firebase Auth: Admin authenticated"));const[a,n,r,i]=await Promise.all([Lu(),Nu(),si(),Ru()]);A.allSubmissions=a,A.dailyTasks=n,A.allUsers=i,A.ugcBasePoints=((t=r.config)==null?void 0:t.ugcBasePoints)||{YouTube:5e3,"YouTube Shorts":2500,Instagram:3e3,"X/Twitter":1500,Facebook:2e3,Telegram:1e3,TikTok:3500,Reddit:1800,LinkedIn:2200,Other:1e3},A.platformUsageConfig=r.platformUsageConfig||cr,A.editingTask&&(A.editingTask=n.find(s=>s.id===A.editingTask.id)||null),u0()}catch(a){if(console.error("Error loading admin data:",a),e){const n=document.createElement("div");ep(n,`Failed to load admin data: ${a.message}`),e.innerHTML=n.innerHTML}else x("Failed to load admin data.","error")}},to=async()=>{const e=document.getElementById("presale-balance-amount");if(e){e.innerHTML='<span class="loader !w-5 !h-5 inline-block"></span>';try{if(!c.signer||!c.signer.provider)throw new Error("Admin provider not found.");if(!v.publicSale)throw new Error("PublicSale address not configured.");const t=await c.signer.provider.getBalance(v.publicSale),a=sd.formatEther(t);e.textContent=`${parseFloat(a).toFixed(6)} ETH/BNB`}catch(t){console.error("Error loading presale balance:",t),e.textContent="Error"}}},Wf=async e=>{if(!c.signer){x("Por favor, conecte a carteira do Owner primeiro.","error");return}if(!window.confirm("Are you sure you want to withdraw ALL funds from the Presale contract to the Treasury wallet?"))return;const t=["function withdrawFunds() external"],a=v.publicSale,n=new sd.Contract(a,t,c.signer),r=e.innerHTML;e.disabled=!0,e.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i> Withdrawing...';try{console.log(`Calling withdrawFunds() on ${a}...`);const i=await n.withdrawFunds();x("Transaction sent. Awaiting confirmation...","info");const s=await i.wait();console.log("Funds withdrawn successfully!",s.hash),x("Funds withdrawn successfully!","success",s.hash),to()}catch(i){console.error("Error withdrawing funds:",i);const s=i.reason||i.message||"Transaction failed.";x(`Error: ${s}`,"error")}finally{e.disabled=!1,e.innerHTML=r}},Gf=async e=>{const t=e.target.closest("button[data-action]");if(!t||t.disabled)return;const a=t.dataset.action,n=t.dataset.submissionId,r=t.dataset.userId;if(!a||!n||!r){console.warn("Missing data attributes for admin action:",t.dataset);return}const i=t.closest("tr"),s=t.closest("td").querySelectorAll("button");i?(i.style.opacity="0.5",i.style.pointerEvents="none"):s.forEach(o=>o.disabled=!0);try{(a==="approved"||a==="rejected")&&(await Xl(r,n,a),x(`Submission ${a==="approved"?"APPROVED":"REJECTED"}!`,"success"),A.allSubmissions=A.allSubmissions.filter(o=>o.submissionId!==n),yn())}catch(o){x(`Failed to ${a} submission: ${o.message}`,"error"),console.error(o),i&&(i.style.opacity="1",i.style.pointerEvents="auto")}},Kf=async e=>{const t=e.target.closest(".ban-user-btn");if(!t||t.disabled)return;const a=t.dataset.userId,n=t.dataset.action==="ban";if(!a)return;const r=n?`Are you sure you want to PERMANENTLY BAN this user?
(This is reversible)`:`Are you sure you want to UNBAN this user?
(This will reset their rejection count to 0)`;if(!window.confirm(r))return;const i=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await Jl(a,n),x(`User ${n?"BANNED":"UNBANNED"}.`,"success");const s=A.allUsers.findIndex(o=>o.id===a);s>-1&&(A.allUsers[s].isBanned=n,A.allUsers[s].hasPendingAppeal=!1,n===!1&&(A.allUsers[s].rejectedCount=0)),wt()}catch(s){x(`Failed: ${s.message}`,"error"),t.disabled=!1,t.innerHTML=i}},Yf=async e=>{const t=e.target.closest(".resolve-appeal-btn");if(!t||t.disabled)return;const a=t.dataset.userId,r=t.dataset.action==="approve";if(!a)return;const i=r?"Are you sure you want to APPROVE this appeal and UNBAN the user?":"Are you sure you want to DENY this appeal? The user will remain banned.";if(!window.confirm(i))return;const s=t.closest("td").querySelectorAll("button"),o=new Map;s.forEach(l=>{o.set(l,l.innerHTML),l.disabled=!0,l.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>'});try{r&&await Jl(a,!1),x(`Appeal ${r?"APPROVED":"DENIED"}.`,"success");const l=A.allUsers.findIndex(d=>d.id===a);l>-1&&(A.allUsers[l].hasPendingAppeal=!1,r&&(A.allUsers[l].isBanned=!1,A.allUsers[l].rejectedCount=0)),wt()}catch(l){x(`Failed: ${l.message}`,"error"),s.forEach(d=>{d.disabled=!1,d.innerHTML=o.get(d)})}},Vf=async e=>{const t=e.target.closest(".re-approve-btn");if(!t||t.disabled)return;const a=t.dataset.submissionId,n=t.dataset.userId;if(!a||!n)return;const r=t.closest("tr");r&&(r.style.opacity="0.5"),t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await Xl(n,a,"approved"),x("Submission re-approved!","success"),A.selectedUserSubmissions=A.selectedUserSubmissions.filter(s=>s.submissionId!==a),r&&r.remove();const i=A.allUsers.findIndex(s=>s.id===n);if(i>-1){const s=A.allUsers[i];s.rejectedCount=Math.max(0,(s.rejectedCount||0)-1),wt()}if(A.selectedUserSubmissions.length===0){const s=document.querySelector("#admin-user-modal .p-6");s&&(s.innerHTML='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>')}}catch(i){x(`Failed to re-approve: ${i.message}`,"error"),r&&(r.style.opacity="1"),t.disabled=!1,t.innerHTML='<i class="fa-solid fa-check"></i> Re-Approve'}},qf=async e=>{const t=e.target.closest(".view-rejected-btn");if(!t||t.disabled)return;const a=t.dataset.userId,n=t.dataset.wallet;if(a){A.selectedWallet=n,A.isSubmissionsModalOpen=!0,Ar(!0,[]);try{const r=await _u(a,"rejected");A.selectedUserSubmissions=r,Ar(!1,r)}catch(r){x(`Error fetching user submissions: ${r.message}`,"error"),Ar(!1,[],!0)}}},Xf=()=>{A.isSubmissionsModalOpen=!1,A.selectedUserSubmissions=[],A.selectedWallet=null;const e=document.getElementById("admin-user-modal");e&&e.remove(),document.body.style.overflow="auto"},Jf=e=>{const t=e.target.closest(".user-profile-link");if(!t)return;e.preventDefault();const a=t.dataset.userId;if(!a)return;const n=A.allUsers.find(r=>r.id===a);if(!n){x("Error: Could not find user data.","error");return}n0(n)},Zf=()=>{const e=document.getElementById("admin-user-profile-modal");e&&e.remove(),document.body.style.overflow="auto"},Qf=async e=>{e.preventDefault();const t=e.target;let a,n;try{if(a=new Date(t.startDate.value+"T00:00:00Z"),n=new Date(t.endDate.value+"T23:59:59Z"),isNaN(a.getTime())||isNaN(n.getTime()))throw new Error("Invalid date format.");if(a>=n)throw new Error("Start Date must be before End Date.")}catch(l){x(l.message,"error");return}const r={title:t.title.value.trim(),url:t.url.value.trim(),description:t.description.value.trim(),points:parseInt(t.points.value,10),cooldownHours:parseInt(t.cooldown.value,10),startDate:a,endDate:n};if(!r.title||!r.description){x("Please fill in Title and Description.","error");return}if(r.points<=0||r.cooldownHours<=0){x("Points and Cooldown must be positive numbers.","error");return}if(r.url&&!r.url.startsWith("http")){x("URL must start with http:// or https://","error");return}A.editingTask&&A.editingTask.id&&(r.id=A.editingTask.id);const i=t.querySelector('button[type="submit"]'),s=i.innerHTML;i.disabled=!0;const o=document.createElement("span");o.classList.add("inline-block"),i.innerHTML="",i.appendChild(o);try{await Su(r),x(`Task ${r.id?"updated":"created"} successfully!`,"success"),t.reset(),A.editingTask=null,Ea()}catch(l){x(`Failed to save task: ${l.message}`,"error"),console.error(l),i.disabled=!1,i.innerHTML=s}},e0=async e=>{e.preventDefault();const t=e.target,a={YouTube:parseInt(t.youtubePoints.value,10),"YouTube Shorts":parseInt(t.youtubeShortsPoints.value,10),Instagram:parseInt(t.instagramPoints.value,10),"X/Twitter":parseInt(t.xTwitterPoints.value,10),Facebook:parseInt(t.facebookPoints.value,10),Telegram:parseInt(t.telegramPoints.value,10),TikTok:parseInt(t.tiktokPoints.value,10),Reddit:parseInt(t.redditPoints.value,10),LinkedIn:parseInt(t.linkedinPoints.value,10),Other:parseInt(t.otherPoints.value,10)};if(Object.values(a).some(s=>isNaN(s)||s<0)){x("All points must be positive numbers (or 0).","error");return}const n=t.querySelector('button[type="submit"]'),r=n.innerHTML;n.disabled=!0;const i=document.createElement("span");i.classList.add("inline-block"),n.innerHTML="",n.appendChild(i);try{await Bu(a),x("UGC Base Points updated successfully!","success"),A.ugcBasePoints=a}catch(s){x(`Failed to update points: ${s.message}`,"error"),console.error(s)}finally{document.body.contains(n)&&(n.disabled=!1,n.innerHTML=r)}},t0=e=>{const t=A.dailyTasks.find(a=>a.id===e);t&&(A.editingTask=t,Sa())},a0=async e=>{if(window.confirm("Are you sure you want to delete this task permanently?"))try{await $u(e),x("Task deleted.","success"),A.editingTask=null,Ea()}catch(t){x(`Failed to delete task: ${t.message}`,"error"),console.error(t)}};function Ar(e,t,a=!1){var s,o;const n=document.getElementById("admin-user-modal");n&&n.remove(),document.body.style.overflow="hidden";let r="";e?r='<div class="p-8"></div>':a?r='<p class="text-red-400 text-center p-8">Failed to load submissions.</p>':t.length===0?r='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>':r=`
         ...
         <div id="admin-user-modal" class="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4" style="backdrop-filter: blur(5px);">
             <div class="bg-sidebar border border-border-color rounded-xl shadow-lg w-full max-w-3xl max-h-[90vh] flex flex-col">
                 <div class="p-5 border-b border-border-color flex justify-between items-center">
                     <h2 class="text-xl font-bold text-white">Rejected Posts for ${ca(A.selectedWallet)}</h2>
     ...
     `;document.body.insertAdjacentHTML("beforeend",i),e&&document.getElementById("admin-user-modal").querySelector(".p-8"),(s=document.getElementById("close-admin-modal-btn"))==null||s.addEventListener("click",Xf),(o=document.getElementById("modal-submissions-tbody"))==null||o.addEventListener("click",Vf)}function n0(e){var r;const t=document.getElementById("admin-user-profile-modal");t&&t.remove(),document.body.style.overflow="hidden";const a=e.isBanned?'<span class="text-xs font-bold py-1 px-3 rounded-full bg-red-600 text-white">BANNED</span>':e.hasPendingAppeal?'<span class="text-xs font-bold py-1 px-3 rounded-full bg-yellow-600 text-white">APPEALING</span>':'<span class="text-xs font-bold py-1 px-3 rounded-full bg-green-600 text-white">ACTIVE</span>',n=`
     ...
     `;document.body.insertAdjacentHTML("beforeend",n),(r=document.getElementById("close-admin-profile-modal-btn"))==null||r.addEventListener("click",Zf)}const r0=e=>{const t=e.target.closest(".user-filter-btn");!t||t.classList.contains("active")||(A.usersFilter=t.dataset.filter||"all",A.usersPage=1,wt())},i0=e=>{A.usersSearch=e.target.value,A.usersPage=1,wt()},s0=e=>{A.usersPage=e,wt()},o0=e=>{A.submissionsPage=e,yn()},l0=e=>{A.tasksPage=e,Sa()},wt=()=>{var _,B;const e=document.getElementById("manage-users-content");if(!e)return;const t=A.allUsers;if(!t)return;const n=(A.usersSearch||"").toLowerCase().trim().replace(/[^a-z0-9x]/g,""),r=A.usersFilter;let i=t;n&&(i=i.filter(I=>{var N,F;return((N=I.walletAddress)==null?void 0:N.toLowerCase().includes(n))||((F=I.id)==null?void 0:F.toLowerCase().includes(n))})),r==="banned"?i=i.filter(I=>I.isBanned):r==="appealing"&&(i=i.filter(I=>I.hasPendingAppeal===!0));const s=t.length,o=t.filter(I=>I.isBanned).length,l=t.filter(I=>I.hasPendingAppeal===!0).length,d=i.sort((I,N)=>I.hasPendingAppeal!==N.hasPendingAppeal?I.hasPendingAppeal?-1:1:I.isBanned!==N.isBanned?I.isBanned?-1:1:(N.totalPoints||0)-(I.totalPoints||0)),u=A.usersPage,m=A.usersPerPage,p=d.length,b=Math.ceil(p/m),f=(u-1)*m,w=u*m,k=d.slice(f,w),C=k.length>0?k.map(I=>{let N="border-b border-border-color hover:bg-zinc-800/50",F="";return I.hasPendingAppeal?(N+=" bg-yellow-900/40",F='<span class="ml-2 text-xs font-bold text-yellow-300">[APPEALING]</span>'):I.isBanned&&(N+=" bg-red-900/30 opacity-70",F='<span class="ml-2 text-xs font-bold text-red-400">[BANNED]</span>'),`
        <tr class="${N}">
    ...
    `;const P=document.getElementById("admin-users-pagination");P&&b>1&&li(P,A.usersPage,b,s0),(_=document.getElementById("admin-users-tbody"))==null||_.addEventListener("click",I=>{I.target.closest(".user-profile-link")&&Jf(I),I.target.closest(".ban-user-btn")&&Kf(I),I.target.closest(".view-rejected-btn")&&qf(I),I.target.closest(".resolve-appeal-btn")&&Yf(I)}),(B=document.getElementById("user-filters-nav"))==null||B.addEventListener("click",r0);const S=document.getElementById("user-search-input");if(S){let I;S.addEventListener("keyup",N=>{clearTimeout(I),I=setTimeout(()=>i0(N),300)})}},sl=()=>{var n;const e=document.getElementById("manage-ugc-points-content");if(!e)return;const t=A.ugcBasePoints;if(!t)return;const a={YouTube:5e3,"YouTube Shorts":2500,Instagram:3e3,"X/Twitter":1500,Facebook:2e3,Telegram:1e3,TikTok:3500,Reddit:1800,LinkedIn:2200,Other:1e3};e.innerHTML=`
    ...
    `,(n=document.getElementById("ugcPointsForm"))==null||n.addEventListener("submit",e0)},Sa=()=>{var f,w,k;const e=document.getElementById("manage-tasks-content");if(!e)return;const t=A.editingTask,a=!!t,n=C=>{if(!C)return"";try{return(C.toDate?C.toDate():C instanceof Date?C:new Date(C)).toISOString().split("T")[0]}catch{return""}},r=A.tasksPage,i=A.tasksPerPage,s=[...A.dailyTasks].sort((C,P)=>{var B,I;const S=(B=C.startDate)!=null&&B.toDate?C.startDate.toDate():new Date(C.startDate||0);return((I=P.startDate)!=null&&I.toDate?P.startDate.toDate():new Date(P.startDate||0)).getTime()-S.getTime()}),o=s.length,l=Math.ceil(o/i),d=(r-1)*i,u=r*i,m=s.slice(d,u),p=m.length>0?m.map(C=>{var I,N;const P=new Date,S=(I=C.startDate)!=null&&I.toDate?C.startDate.toDate():C.startDate?new Date(C.startDate):null,_=(N=C.endDate)!=null&&N.toDate?C.endDate.toDate():C.endDate?new Date(C.endDate):null;let B="text-zinc-500";return S&&_&&(P>=S&&P<=_?B="text-green-400":P<S&&(B="text-blue-400")),`
    ...
    `;const b=document.getElementById("admin-tasks-pagination");b&&l>1&&li(b,A.tasksPage,l,l0),(f=document.getElementById("taskForm"))==null||f.addEventListener("submit",Qf),(w=document.getElementById("cancelEditBtn"))==null||w.addEventListener("click",()=>{A.editingTask=null,Sa()}),(k=document.getElementById("existing-tasks-list"))==null||k.addEventListener("click",C=>{const P=C.target.closest("button[data-id]");if(!P)return;const S=P.dataset.id;P.dataset.action==="edit"&&t0(S),P.dataset.action==="delete"&&a0(S)})},yn=()=>{var m;const e=document.getElementById("submissions-content");if(!e)return;if(!A.allSubmissions||A.allSubmissions.length===0){const p=document.createElement("div");e.innerHTML=p.innerHTML;return}const t=A.submissionsPage,a=A.submissionsPerPage,n=[...A.allSubmissions].sort((p,b)=>{var f,w;return(((f=b.submittedAt)==null?void 0:f.getTime())||0)-(((w=p.submittedAt)==null?void 0:w.getTime())||0)}),r=n.length,i=Math.ceil(r/a),s=(t-1)*a,o=t*a,d=n.slice(s,o).map(p=>{var b,f;return`
        <tr class="border-b border-border-color hover:bg-zinc-800/50">
            ...
            <td class="p-3 text-xs font-semibold ${((b=il[p.status])==null?void 0:b.color)||"text-gray-500"}">${((f=il[p.status])==null?void 0:f.text)||p.status}</td>
            <td class="p-3 text-right">
                <div class="flex items-center justify-end gap-2">
    ...
    `;const u=document.getElementById("admin-submissions-pagination");u&&i>1&&li(u,A.submissionsPage,i,o0),(m=document.getElementById("admin-submissions-tbody"))==null||m.addEventListener("click",Gf)},kn=()=>{var i,s;const e=document.getElementById("platform-usage-content");if(!e)return;const t=A.platformUsageConfig||cr;let a=0;Object.values(t).forEach(o=>{o.enabled!==!1&&(a+=(o.points||0)*(o.maxCount||1))});const n=Object.entries(t).map(([o,l])=>`
    ...
    `;const r=document.getElementById("platform-usage-tbody");r==null||r.addEventListener("input",ol),r==null||r.addEventListener("change",ol),(i=document.getElementById("save-platform-config-btn"))==null||i.addEventListener("click",c0),(s=document.getElementById("reset-platform-config-btn"))==null||s.addEventListener("click",d0)},ol=e=>{const t=e.target;if(!t.classList.contains("platform-input")&&!t.classList.contains("platform-toggle"))return;const a=t.closest("tr"),n=a==null?void 0:a.dataset.actionKey,r=t.dataset.field;if(!n||!r)return;A.platformUsageConfig[n]||(A.platformUsageConfig[n]={...cr[n]}),r==="enabled"?A.platformUsageConfig[n].enabled=t.checked:A.platformUsageConfig[n][r]=parseInt(t.value)||0;const i=A.platformUsageConfig[n],s=a.querySelector("td:last-child");s&&(s.textContent=((i.points||0)*(i.maxCount||1)).toLocaleString())},c0=async e=>{const t=e.target.closest("button");if(!t)return;const a=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Saving...';try{await Zl(A.platformUsageConfig),x("✅ Platform Usage config saved!","success"),kn()}catch(n){console.error("Error saving platform config:",n),x("Failed to save config: "+n.message,"error")}finally{t.disabled=!1,t.innerHTML=a}},d0=async()=>{if(confirm("Are you sure you want to reset to default values? This will save immediately."))try{A.platformUsageConfig={...cr},await Zl(A.platformUsageConfig),x("✅ Config reset to defaults!","success"),kn()}catch(e){console.error("Error resetting platform config:",e),x("Failed to reset config: "+e.message,"error")}},u0=()=>{var a;const e=document.getElementById("admin-content-wrapper");if(!e)return;e.innerHTML=`
    ...
    `,(a=document.getElementById("withdraw-presale-funds-btn"))==null||a.addEventListener("click",n=>Wf(n.target)),to(),A.activeTab==="manage-ugc-points"?sl():A.activeTab==="manage-tasks"?Sa():A.activeTab==="review-submissions"?yn():A.activeTab==="manage-users"?wt():A.activeTab==="platform-usage"&&kn();const t=document.getElementById("admin-tabs");t&&!t._listenerAttached&&(t.addEventListener("click",n=>{const r=n.target.closest(".tab-btn");if(!r||r.classList.contains("active"))return;const i=r.dataset.target;A.activeTab=i,i!=="manage-users"&&(A.usersPage=1,A.usersFilter="all",A.usersSearch=""),i!=="review-submissions"&&(A.submissionsPage=1),i!=="manage-tasks"&&(A.tasksPage=1),document.querySelectorAll("#admin-tabs .tab-btn").forEach(o=>o.classList.remove("active")),r.classList.add("active"),e.querySelectorAll(".tab-content").forEach(o=>o.classList.remove("active"));const s=document.getElementById(i.replace(/-/g,"_")+"_tab");s?(s.classList.add("active"),i==="manage-ugc-points"&&sl(),i==="manage-tasks"&&Sa(),i==="review-submissions"&&yn(),i==="manage-users"&&wt(),i==="platform-usage"&&kn()):console.warn(`Tab content container not found for target: ${i}`)}),t._listenerAttached=!0)},p0={render(){const e=document.getElementById("admin");if(e){if(!jf()){e.innerHTML='<div class="text-center text-red-400 p-8 bg-sidebar border border-red-500/50 rounded-lg">Access Denied. This page is restricted to administrators.</div>';return}if(rl()){e.innerHTML='<div id="admin-content-wrapper"></div>',Ea();return}e.innerHTML=`
        ...
        `,document.getElementById("admin-login-btn").addEventListener("click",()=>{const t=document.getElementById("admin-key-input"),a=document.getElementById("admin-login-error");t.value===Hf?(Uf(),x("✅ Admin access granted!","success"),e.innerHTML='<div id="admin-content-wrapper"></div>',Ea()):(a.classList.remove("hidden"),t.value="",t.focus(),setTimeout(()=>a.classList.add("hidden"),3e3))}),setTimeout(()=>{var t;(t=document.getElementById("admin-key-input"))==null||t.focus()},100)}},refreshData(){const e=document.getElementById("admin");e&&!e.classList.contains("hidden")&&rl()&&(console.log("Refreshing Admin Page data..."),Ea(),to())}},Pr=2e8,ll={airdrop:{amount:7e7},liquidity:{amount:13e7}},m0=()=>{if(document.getElementById("tokenomics-styles-v5"))return;const e=document.createElement("style");e.id="tokenomics-styles-v5",e.innerHTML=`
    ...
    `,document.head.appendChild(e)},Ta=e=>e>=1e6?(e/1e6).toFixed(1)+"M":e>=1e3?(e/1e3).toFixed(0)+"K":e.toLocaleString();function f0(){return`
    ...
    `}function b0(){const e=c.totalSupply?D(c.totalSupply):4e7,t=(e/Pr*100).toFixed(1);return`
        <div class="tk-section tk-fade-up" style="animation-delay: 0.1s">
            ...
            <p class="text-center text-zinc-600 text-[10px]">
                ...
                Remaining ${Ta(Pr-e)} BKC to be mined through ecosystem activity
            </p>
        </div>
    `}function g0(){return`
                ...
                <div class="space-y-3">
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-500 text-[10px]">${Ta(ll.airdrop.amount)} BKC</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-500 text-[10px]">${Ta(ll.liquidity.amount)} BKC</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    `}function E0(){const e=document.getElementById("tokenomics");e&&(m0(),e.innerHTML=`
    ...
    `,e.scrollIntoView({behavior:"smooth",block:"start"}))}const T0={render:E0,init:()=>{},update:()=>{}},se=window.ethers,C0=5*1024*1024,ld="https://sepolia.arbiscan.io",I0=`${ld}/tx/`,ao=`${ld}/address/`,cd=["event Certified(uint256 indexed certId, address indexed owner, bytes32 documentHash, uint8 docType, address operator)"],Je={image:{icon:"fa-regular fa-image",color:"#34d399",bg:"rgba(52,211,153,0.12)",label:"Image"},pdf:{icon:"fa-regular fa-file-pdf",color:"#f87171",bg:"rgba(248,113,113,0.12)",label:"PDF"},audio:{icon:"fa-solid fa-music",color:"#a78bfa",bg:"rgba(167,139,250,0.12)",label:"Audio"},video:{icon:"fa-regular fa-file-video",color:"#60a5fa",bg:"rgba(96,165,250,0.12)",label:"Video"},document:{icon:"fa-regular fa-file-word",color:"#60a5fa",bg:"rgba(96,165,250,0.12)",label:"Document"},spreadsheet:{icon:"fa-regular fa-file-excel",color:"#4ade80",bg:"rgba(74,222,128,0.12)",label:"Spreadsheet"},code:{icon:"fa-solid fa-code",color:"#22d3ee",bg:"rgba(34,211,238,0.12)",label:"Code"},archive:{icon:"fa-regular fa-file-zipper",color:"#facc15",bg:"rgba(250,204,21,0.12)",label:"Archive"},default:{icon:"fa-regular fa-file",color:"#fbbf24",bg:"rgba(251,191,36,0.12)",label:"File"}},T={view:"documents",activeTab:"documents",viewHistory:[],wizStep:1,wizFile:null,wizFileHash:null,wizDescription:"",wizDuplicateCheck:null,wizIsHashing:!1,wizIpfsCid:null,wizUploadDate:null,bkcFee:0n,ethFee:0n,feesLoaded:!1,certificates:[],certsLoading:!1,selectedCert:null,verifyFile:null,verifyHash:null,verifyResult:null,verifyIsChecking:!1,stats:null,totalSupply:0,recentNotarizations:[],statsLoading:!1,isProcessing:!1,processStep:"",isLoading:!1,contractAvailable:!0};function Ha(e="",t=""){const a=e.toLowerCase(),n=t.toLowerCase();return a.includes("image")||/\.(jpg|jpeg|png|gif|webp|svg|bmp|ico)$/.test(n)?Je.image:a.includes("pdf")||n.endsWith(".pdf")?Je.pdf:a.includes("audio")||/\.(mp3|wav|ogg|flac|aac|m4a)$/.test(n)?Je.audio:a.includes("video")||/\.(mp4|avi|mov|mkv|webm|wmv)$/.test(n)?Je.video:a.includes("word")||a.includes("document")||/\.(doc|docx|odt|rtf)$/.test(n)?Je.document:a.includes("sheet")||a.includes("excel")||/\.(xls|xlsx|csv|ods)$/.test(n)?Je.spreadsheet:/\.(js|ts|py|java|cpp|c|h|html|css|json|xml|sol|rs|go|php|rb)$/.test(n)?Je.code:a.includes("zip")||a.includes("archive")||/\.(zip|rar|7z|tar|gz)$/.test(n)?Je.archive:Je.default}function dd(e){if(!e)return"";let t;if(typeof e=="number")t=new Date(e>1e12?e:e*1e3);else if(typeof e=="string")t=new Date(e);else if(e!=null&&e.toDate)t=e.toDate();else if(e!=null&&e.seconds)t=new Date(e.seconds*1e3);else return"";if(isNaN(t.getTime()))return"";const a=new Date,n=a-t,r=Math.floor(n/6e4),i=Math.floor(n/36e5),s=Math.floor(n/864e5);return r<1?"Just now":r<60?`${r}m`:i<24?`${i}h`:s<7?`${s}d`:t.toLocaleDateString("en-US",{month:"short",day:"numeric",year:t.getFullYear()!==a.getFullYear()?"numeric":void 0})}function no(e){if(!e)return"";const t=typeof e=="number"?new Date(e>1e12?e:e*1e3):new Date(e);return isNaN(t.getTime())?"":t.toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"2-digit",minute:"2-digit"})}function ro(e){return e?`${e.slice(0,6)}...${e.slice(-4)}`:""}function ud(e){return e?e.startsWith("https://")?e:e.startsWith("ipfs://")?`${un[0]}${e.replace("ipfs://","")}`:`${un[0]}${e}`:""}function io(e){return e<1024?`${e} B`:e<1048576?`${(e/1024).toFixed(1)} KB`:`${(e/1048576).toFixed(2)} MB`}function A0(e,t){T.viewHistory.push({view:T.view,data:T.selectedCert}),T.view=e,t&&(T.selectedCert=t),pe(),fa()}function pd(){const e=T.viewHistory.pop();e?(T.view=e.view,T.activeTab=e.view==="cert-detail"?"documents":e.view,T.selectedCert=e.data):(T.view="documents",T.activeTab="documents"),pe(),fa()}function P0(e){T.activeTab===e&&T.view===e||(T.viewHistory=[],T.view=e,T.activeTab=e,pe(),fa())}function z0(){if(document.getElementById("notary-styles-v10"))return;const e=document.createElement("style");e.id="notary-styles-v10",e.textContent=`
        :root {
            --nt-bg:       #0c0c0e;
            --nt-bg2:      #141417;
            --nt-bg3:      #1c1c21;
    ...
    `,document.head.appendChild(e);const t=document.getElementById("notary-styles-v6");t&&t.remove()}function B0(e){const t=document.getElementById("notary");t&&(z0(),t.innerHTML=`
        <div class="nt-shell">
            <div class="nt-header" id="nt-header"></div>
            <div id="nt-content"></div>
            <div id="nt-overlay" class="nt-overlay"></div>
        </div>
    `,fa(),pe(),Promise.all([U0(),so(),W0()]).catch(()=>{}))}function fa(){var t;const e=document.getElementById("nt-header");if(e){if(T.view==="cert-detail"){e.innerHTML=`
    ...
    `}}function pe(){const e=document.getElementById("nt-content");if(e)switch(T.view){case"documents":cl(e);break;case"notarize":S0(e);break;case"verify":M0(e);break;case"stats":O0(e);break;case"cert-detail":H0(e);break;default:cl(e)}}function cl(e){if(!c.isConnected){e.innerHTML=`
        ...
        <div class="nt-cert-grid">
            ${T.certificates.map(t=>N0(t)).join("")}
        </div>
    `}function N0(e){var i,s;const t=ud(e.ipfs),a=Ha(e.mimeType||"",e.description||e.fileName||""),n=dd(e.timestamp),r=((i=e.description)==null?void 0:i.split("---")[0].trim().split(`
`)[0].trim())||"Notarized Document";return`
    ...
    `}function S0(e){if(!c.isConnected){e.innerHTML=`
            <div class="nt-card" style="margin-top:16px;text-align:center;padding:48px 20px">
                <div style="width:56px;height:56px;border-radius:var(--nt-radius);background:var(--nt-bg3);display:inline-flex;align-items:center;justify-content:center;margin-bottom:16px">
                    <i class="fa-solid fa-wallet" style="font-size:24px;color:var(--nt-text-3)"></i>
                </div>
    ...
    `;const t=document.getElementById("nt-wiz-panel");if(t)switch(T.wizStep){case 1:L0(t);break;case 2:md(t);break;case 3:_0(t);break}}function $0(){const e=T.wizStep;return`
        <div class="nt-steps">
    ...
    `}function L0(e){if(T.wizFile&&T.wizFileHash){const t=T.wizFile,a=Ha(t.type,t.name),n=T.wizDuplicateCheck;e.innerHTML=`
            ...
            <div style="background:var(--nt-bg3);border:1px solid var(--nt-border);border-radius:var(--nt-radius);padding:16px;margin-bottom:16px">
                <div style="display:flex;align-items:center;gap:14px">
                    ...
                    <div style="flex:1;min-width:0">
                        ...
                        <div style="font-size:11px;color:var(--nt-text-3)">${io(t.size)} &bull; ${a.label}</div>
                    </div>
    ...
    `,R0()}function R0(){const e=document.getElementById("nt-wiz-dropzone"),t=document.getElementById("nt-wiz-file-input");!e||!t||(e.onclick=()=>t.click(),["dragenter","dragover","dragleave","drop"].forEach(a=>{e.addEventListener(a,n=>{n.preventDefault(),n.stopPropagation()})}),e.addEventListener("dragenter",()=>e.classList.add("drag-over")),e.addEventListener("dragover",()=>e.classList.add("drag-over")),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",a=>{var n,r;e.classList.remove("drag-over"),dl((r=(n=a.dataTransfer)==null?void 0:n.files)==null?void 0:r[0])}),t.addEventListener("change",a=>{var n;return dl((n=a.target.files)==null?void 0:n[0])}))}async function dl(e){if(e){if(e.size>C0){x("File too large (max 5MB)","error");return}T.wizFile=e,T.wizFileHash=null,T.wizDuplicateCheck=null,T.wizIsHashing=!0,pe();try{const t=await Ke.calculateFileHash(e);T.wizFileHash=t,T.wizIsHashing=!1,pe(),T.wizDuplicateCheck=null,pe();const a=await Ke.verifyByHash(t);T.wizDuplicateCheck=a,pe()}catch(t){console.error("[NotaryPage] Hash error:",t),T.wizIsHashing=!1,T.wizFile=null,x("Error computing file hash","error"),pe()}}}function md(e){const t=T.wizFile,a=Ha((t==null?void 0:t.type)||"",(t==null?void 0:t.name)||""),n=T.feesLoaded?se?se.formatEther(T.bkcFee):"1":"...",r=T.feesLoaded?se?se.formatEther(T.ethFee):"0.0001":"...",i=c.currentUserBalance||0n,s=c.currentUserNativeBalance||0n,o=T.feesLoaded?i>=T.bkcFee:!0,l=T.feesLoaded?s>=T.ethFee+((se==null?void 0:se.parseEther("0.001"))||0n):!0,d=o&&l;e.innerHTML=`
        <div style="max-width:420px;margin:0 auto">
            ...
            <div style="background:var(--nt-bg3);border:1px solid var(--nt-border);border-radius:var(--nt-radius);padding:12px;margin-bottom:16px;display:flex;align-items:center;gap:12px">
                ...
                <div style="flex:1;min-width:0">
                    ...
                    <div style="font-size:10px;color:var(--nt-text-3)">${io((t==null?void 0:t.size)||0)}</div>
                </div>
            </div>
            ...
            <div class="nt-fee-box" style="margin-bottom:16px">
                ...
                ${o?"":`<div style="font-size:11px;color:var(--nt-red);margin-top:8px"><i class="fa-solid fa-circle-xmark" style="margin-right:4px"></i>Insufficient BKC balance (${D(i)} BKC)</div>`}
    ...
    `}function _0(e){const t=T.wizFile,a=Ha((t==null?void 0:t.type)||"",(t==null?void 0:t.name)||""),n=T.wizDescription||"No description",r=se?se.formatEther(T.bkcFee):"1",i=se?se.formatEther(T.ethFee):"0.0001";e.innerHTML=`
            ...
            <div style="background:var(--nt-bg3);border:1px solid var(--nt-border);border-radius:var(--nt-radius);padding:16px;text-align:left;margin-bottom:16px">
                <div style="display:flex;align-items:center;gap:12px;padding-bottom:12px;border-bottom:1px solid var(--nt-border);margin-bottom:12px">
                    ...
                    <div style="flex:1;min-width:0">
                        ...
                        <div style="font-size:11px;color:var(--nt-text-3)">${io((t==null?void 0:t.size)||0)}</div>
                    </div>
                </div>
    ...
    `}async function F0(){if(T.isProcessing)return;T.isProcessing=!0,T.processStep="SIGNING";const e=document.getElementById("nt-btn-mint");e&&(e.disabled=!0,e.innerHTML='<i class="fa-solid fa-spinner fa-spin" style="margin-right:6px"></i>Signing...'),document.getElementById("nt-overlay"),an("signing");try{const n=await(await c.provider.getSigner()).signMessage("I am signing to authenticate my file for notarization on Backchain.");T.processStep="UPLOADING",an("uploading");const r=new FormData;r.append("file",T.wizFile),r.append("signature",n),r.append("address",c.userAddress),r.append("description",T.wizDescription||"No description");const i=Ye.uploadFileToIPFS||"/api/upload",s=await fetch(i,{method:"POST",body:r,signal:AbortSignal.timeout(18e4)});if(!s.ok)throw s.status===413?new Error("File too large (max 5MB)"):s.status===401?new Error("Signature verification failed"):new Error(`Upload failed (${s.status})`);const o=await s.json(),l=o.ipfsUri||o.metadataUri,d=o.contentHash||T.wizFileHash;if(!l)throw new Error("No IPFS URI returned");if(!d)throw new Error("No content hash returned");T.processStep="MINTING",an("minting"),await Ke.notarize({ipfsCid:l,contentHash:d,description:T.wizDescription||"No description",operator:Q(),button:e,onSuccess:(u,m,p)=>{T.processStep="SUCCESS",an("success",m),setTimeout(()=>{zr(),T.wizFile=null,T.wizFileHash=null,T.wizDescription="",T.wizDuplicateCheck=null,T.wizStep=1,T.isProcessing=!1,T.view="documents",T.activeTab="documents",fa(),pe(),so(),x("Document notarized successfully!","success")},3e3)},onError:u=>{if(u.cancelled||u.type==="user_rejected"){T.isProcessing=!1,zr(),e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-stamp" style="margin-right:6px"></i>Sign & Mint');return}throw u}})}catch(t){console.error("[NotaryPage] Mint error:",t),zr(),T.isProcessing=!1,e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-stamp" style="margin-right:6px"></i>Sign & Mint'),t.code!==4001&&t.code!=="ACTION_REJECTED"&&x(t.message||"Notarization failed","error")}}function an(e,t){const a=document.getElementById("nt-overlay");if(!a)return;a.classList.add("active");const n={signing:{icon:"fa-solid fa-signature",text:"Signing message...",sub:"Confirm in MetaMask",pct:10},uploading:{icon:"fa-solid fa-cloud-arrow-up",text:"Uploading to IPFS...",sub:"Decentralized storage",pct:35},minting:{icon:"fa-solid fa-stamp",text:"Minting on Blockchain...",sub:"Waiting for confirmation",pct:65,animate:!0},success:{icon:"fa-solid fa-check",text:"Notarized!",sub:t?`Token ID #${t}`:"Certificate created",pct:100,success:!0}},r=n[e]||n.signing;if(a.innerHTML=`
    ...
    `,!document.getElementById("nt-spin-kf")){const i=document.createElement("style");i.id="nt-spin-kf",i.textContent="@keyframes nt-spin { to { transform: rotate(360deg); } }",document.head.appendChild(i)}}function zr(){const e=document.getElementById("nt-overlay");e&&e.classList.remove("active")}function M0(e){e.innerHTML=`
        <div class="nt-card" style="margin-top:16px">
            <div style="text-align:center;margin-bottom:20px">
    ...
    `,D0(),T.verifyResult&&fd()}function D0(){const e=document.getElementById("nt-verify-dropzone"),t=document.getElementById("nt-verify-file-input");!e||!t||(e.onclick=()=>t.click(),["dragenter","dragover","dragleave","drop"].forEach(a=>{e.addEventListener(a,n=>{n.preventDefault(),n.stopPropagation()})}),e.addEventListener("dragenter",()=>e.classList.add("drag-over")),e.addEventListener("dragover",()=>e.classList.add("drag-over")),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",a=>{var n,r;e.classList.remove("drag-over"),ul((r=(n=a.dataTransfer)==null?void 0:n.files)==null?void 0:r[0])}),t.addEventListener("change",a=>{var n;return ul((n=a.target.files)==null?void 0:n[0])}))}async function ul(e){if(!e)return;T.verifyFile=e,T.verifyHash=null,T.verifyResult=null,T.verifyIsChecking=!0;const t=document.getElementById("nt-verify-result");t&&(t.innerHTML=`
        ...
        `);try{const a=await Ke.calculateFileHash(e);T.verifyHash=a;const n=await Ke.verifyByHash(a);T.verifyResult=n,T.verifyIsChecking=!1,fd()}catch(a){console.error("[NotaryPage] Verify error:",a),T.verifyIsChecking=!1,t&&(t.innerHTML=`
            ...
            `)}}function fd(){const e=document.getElementById("nt-verify-result");if(!e||!T.verifyResult)return;const t=T.verifyResult,a=T.verifyFile;t.exists?e.innerHTML=`
            <div class="nt-verified">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:12px">
                    ...
                    <div style="background:rgba(0,0,0,0.2);border-radius:var(--nt-radius-sm);padding:10px">
                        ...
                        <div style="font-size:13px;font-weight:600;color:var(--nt-text)">${no(t.timestamp)}</div>
                    </div>
                </div>
                ...
                <div style="margin-top:12px;display:flex;gap:8px">
                    <a href="${ao}${v==null?void 0:v.notary}?a=${t.tokenId}" target="_blank" class="nt-btn-secondary" style="font-size:12px;padding:8px 14px;text-decoration:none;display:inline-flex;align-items:center;gap:6px">
        ...
        `}function O0(e){if(T.statsLoading&&!T.stats){e.innerHTML=`
        ...
        <div style="margin-top:16px">
                ...
                <div id="nt-recent-feed">
                    ...
                    `:T.recentNotarizations.map(n=>`
                        <div class="nt-recent-item">
                            ...
                            <div style="text-align:right;flex-shrink:0">
                                <div style="font-size:11px;color:var(--nt-text-3)">${dd(n.timestamp)}</div>
                            </div>
                        </div>
                    `).join("")}
                </div>
            ...
            <div style="text-align:center;margin-top:16px">
                <a href="${ao}${v==null?void 0:v.notary}" target="_blank" class="nt-btn-secondary" style="font-size:12px;padding:10px 20px;text-decoration:none;display:inline-flex;align-items:center;gap:6px">
                    <i class="fa-solid fa-arrow-up-right-from-square"></i>View Contract on Arbiscan
                </a>
            </div>
        </div>
    `}function H0(e){var r;const t=T.selectedCert;if(!t){pd();return}const a=ud(t.ipfs),n=Ha(t.mimeType||"",t.description||"");(t.mimeType||"").includes("image")||/\.(jpg|jpeg|png|gif|webp|svg|bmp)$/i.test(t.fileName||t.description||""),e.innerHTML=`
        <div class="nt-detail" style="margin-top:8px">
            ...
            <div class="nt-detail-meta" style="margin-bottom:12px">
                <div class="nt-card" style="padding:14px">
                    ...
                    <div style="font-size:13px;font-weight:600;color:var(--nt-text)">${no(t.timestamp)||"N/A"}</div>
                </div>
                <div class="nt-card" style="padding:14px">
                    <div style="font-size:10px;color:var(--nt-text-3);text-transform:uppercase;letter-spacing:0.05em;margin-bottom:4px">Owner</div>
            ...
            <div style="display:flex;flex-wrap:wrap;gap:8px;margin-top:8px">
                ...
                `:""}
                <a href="${ao}${v==null?void 0:v.notary}?a=${t.id}" target="_blank" class="nt-btn-secondary" style="text-decoration:none;display:inline-flex;align-items:center;gap:6px;font-size:12px">
                    <i class="fa-solid fa-arrow-up-right-from-square"></i>View on Arbiscan
                </a>
                ${t.txHash?`
    ...
    `}async function U0(){try{const e=await Ke.getFee();T.bkcFee=e.bkcFee,T.ethFee=e.ethFee,T.feesLoaded=!0}catch{T.bkcFee=(se==null?void 0:se.parseEther("1"))||0n,T.ethFee=(se==null?void 0:se.parseEther("0.0001"))||0n,T.feesLoaded=!0}}async function so(){if(!c.isConnected||!c.userAddress)return;T.certsLoading=!0,pe();let e=!1;try{const t=Ye.getNotaryHistory;console.log("[NotaryPage] Loading certificates from API:",`${t}/${c.userAddress}`);const a=await fetch(`${t}/${c.userAddress}`);if(!a.ok)throw new Error(`API ${a.status}`);const n=await a.json();console.log("[NotaryPage] API response:",typeof n,Array.isArray(n)?`array(${n.length})`:JSON.stringify(n).substring(0,200));const r=Array.isArray(n)?n:Array.isArray(n==null?void 0:n.documents)?n.documents:Array.isArray(n==null?void 0:n.data)?n.data:Array.isArray(n==null?void 0:n.history)?n.history:null;r&&r.length>0&&(T.certificates=r.map(i=>({id:i.tokenId||i.id||"?",ipfs:i.ipfsCid||i.ipfsUri||"",description:i.description||"",hash:i.contentHash||"",timestamp:i.createdAt||i.timestamp||"",txHash:i.txHash||i.transactionHash||"",owner:i.owner||c.userAddress,mimeType:i.mimeType||"",fileName:i.fileName||""})).sort((i,s)=>parseInt(s.id)-parseInt(i.id)),e=!0,console.log("[NotaryPage] Loaded",T.certificates.length,"certificates from API"))}catch(t){console.warn("[NotaryPage] API failed:",t.message)}if(!e){console.log("[NotaryPage] Trying on-chain event fallback...");try{const t=await j0();T.certificates=t,console.log("[NotaryPage] Loaded",t.length,"certificates from chain events")}catch(t){console.error("[NotaryPage] Chain fallback also failed:",t),T.certificates=[]}}T.certsLoading=!1,pe()}async function j0(){if(!se||!(v!=null&&v.notary))return console.warn("[NotaryPage] Chain fallback: missing ethers or contract address"),[];const{NetworkManager:e}=await O(async()=>{const{NetworkManager:o}=await Promise.resolve().then(()=>J);return{NetworkManager:o}},void 0),t=e.getProvider();if(!t)return console.warn("[NotaryPage] Chain fallback: no provider available"),[];console.log("[NotaryPage] Querying Certified events for:",c.userAddress);const a=new se.Contract(v.notary,cd,t),n=a.filters.Certified(null,c.userAddress),r=await t.getBlockNumber(),i=Math.max(0,r-5e4);console.log("[NotaryPage] Block range:",i,"->",r);const s=await a.queryFilter(n,i,r);return console.log("[NotaryPage] Found",s.length,"events"),s.map(o=>({id:Number(o.args.certId),hash:o.args.documentHash||"",docType:Number(o.args.docType||0),timestamp:null,txHash:o.transactionHash,owner:o.args.owner})).sort((o,l)=>l.id-o.id)}async function W0(){T.statsLoading=!0;try{const[e,t]=await Promise.all([Ke.getStats(),Ke.getTotalDocuments()]);T.stats=e,T.totalSupply=t}catch(e){console.warn("[NotaryPage] Stats load error:",e)}try{await G0()}catch{}T.statsLoading=!1,T.view==="stats"&&pe()}async function G0(){if(!se||!(v!=null&&v.notary))return;const{NetworkManager:e}=await O(async()=>{const{NetworkManager:l}=await Promise.resolve().then(()=>J);return{NetworkManager:l}},void 0),t=e.getProvider();if(!t)return;const a=new se.Contract(v.notary,cd,t),n=a.filters.Certified(),r=await t.getBlockNumber(),i=Math.max(0,r-5e3),o=(await a.queryFilter(n,i,r)).slice(-20).reverse();T.recentNotarizations=o.map(l=>({tokenId:Number(l.args.certId),owner:l.args.owner,hash:l.args.documentHash,docType:Number(l.args.docType||0),timestamp:null,blockNumber:l.blockNumber}));try{const l=[...new Set(o.map(u=>u.blockNumber))],d={};await Promise.all(l.slice(0,10).map(async u=>{const m=await t.getBlock(u);m&&(d[u]=m.timestamp)})),T.recentNotarizations.forEach(u=>{d[u.blockNumber]&&(u.timestamp=d[u.blockNumber])})}catch{}}async function K0(e,t){var a,n;try{const r=l=>{var u;if(!l)return"";if(l.startsWith("https://")&&!l.includes("/ipfs/"))return l;const d=l.startsWith("ipfs://")?l.replace("ipfs://",""):l.includes("/ipfs/")?(u=l.split("/ipfs/")[1])==null?void 0:u.split("?")[0]:"";return d?`${un[0]}${d}`:l};let i=r(t||"");if(c.notaryContract)try{const l=await c.notaryContract.tokenURI(e);if(l!=null&&l.startsWith("data:application/json;base64,")){const d=JSON.parse(atob(l.replace("data:application/json;base64,","")));d.image&&(i=r(d.image))}}catch{}const s=(v==null?void 0:v.notary)||((a=c.notaryContract)==null?void 0:a.target)||((n=c.notaryContract)!=null&&n.getAddress?await c.notaryContract.getAddress():null);if(!s){x("Contract address not found","error");return}x(`Adding NFT #${e} to wallet...`,"info"),await window.ethereum.request({method:"wallet_watchAsset",params:{type:"ERC721",options:{address:s,tokenId:String(e),image:i}}})&&x(`NFT #${e} added to wallet!`,"success")}catch(r){if(r.code===4001)return;x("Could not add NFT","error")}}function Y0(e){e&&navigator.clipboard.writeText(e).then(()=>{x("Hash copied!","success")}).catch(()=>{x("Failed to copy","error")})}function V0(){var e;T.wizStep===1&&T.wizFileHash&&!((e=T.wizDuplicateCheck)!=null&&e.exists)?T.wizStep=2:T.wizStep===2&&(T.wizStep=3),pe()}function q0(){T.wizStep>1&&(T.wizStep--,pe())}function X0(){const e=document.getElementById("nt-wiz-desc");e&&(T.wizDescription=e.value||""),T.wizStep=3,pe()}function J0(){T.wizFile=null,T.wizFileHash=null,T.wizDuplicateCheck=null,T.wizStep=1,pe()}function Z0(e){const t=T.certificates.find(a=>String(a.id)===String(e));t&&A0("cert-detail",t)}const bd={async render(e){e&&B0()},reset(){T.wizFile=null,T.wizFileHash=null,T.wizDescription="",T.wizDuplicateCheck=null,T.wizStep=1,T.view="documents",T.activeTab="documents",T.viewHistory=[],pe(),fa()},update(){if(!T.isProcessing&&T.view==="notarize"){const e=document.getElementById("nt-wiz-panel");e&&T.wizStep===2&&md(e)}},refreshHistory(){so()},setTab:P0,goBack:pd,viewCert:Z0,handleMint:F0,addToWallet:K0,copyHash:Y0,wizNext:V0,wizBack:q0,wizToStep3:X0,wizRemoveFile:J0};window.NotaryPage=bd;const oo=window.ethers,Zr={Diamond:{emoji:"💎",color:"#22d3ee",bg:"rgba(34,211,238,0.15)",border:"rgba(34,211,238,0.3)",keepRate:100,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeicgip72jcqgsirlrhn3tq5cc226vmko6etnndzl6nlhqrktfikafq"},Gold:{emoji:"🥇",color:"#fbbf24",bg:"rgba(251,191,36,0.15)",border:"rgba(251,191,36,0.3)",keepRate:90,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeifponccrbicg2pcjrn2hrfoqgc77xhm2r4ld7hdpw6cxxkbsckf44"},Silver:{emoji:"🥈",color:"#9ca3af",bg:"rgba(156,163,175,0.15)",border:"rgba(156,163,175,0.3)",keepRate:75,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeihvi2inujm5zpi7tl667g4srq273536pjkglwyrtbwmgnskmu7jg4"},Bronze:{emoji:"🥉",color:"#fb923c",bg:"rgba(251,146,60,0.15)",border:"rgba(251,146,60,0.3)",keepRate:60,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeiclqidb67rt3tchhjpsib62s624li7j2bpxnr6b5w5mfp4tomhu7m"}},R={activeTab:"marketplace",filterTier:"ALL",sortBy:"boost-high",selectedListing:null,isLoading:!1,isTransactionPending:!1,countdownIntervals:[],pendingEarningsAmount:0n,marketStats:null},at=e=>e==null?"":String(e),Q0=(e,t)=>at(e)===at(t),$a=(e,t)=>e&&t&&e.toLowerCase()===t.toLowerCase();function Ua(e){return be.find(t=>t.boostBips===Number(e))||{name:"Unknown",boostBips:0}}function dr(e){return Zr[e]||{emoji:"💎",color:"#71717a",bg:"rgba(113,113,122,0.15)",border:"rgba(113,113,122,0.3)",keepRate:50}}function je(e){if(!e)return"0";const t=parseFloat(oo.formatEther(BigInt(e)));return t===0?"0":t<1e-4?"<0.0001":t<.01?t.toFixed(4):t<1?t.toFixed(3):t.toFixed(2)}function gd(e){const t=e-Math.floor(Date.now()/1e3);if(t<=0)return{text:"Expired",expired:!0,seconds:0};const a=Math.floor(t/3600),n=Math.floor(t%3600/60),r=t%60;return a>0?{text:`${a}h ${n}m`,expired:!1,seconds:t}:n>0?{text:`${n}m ${r}s`,expired:!1,seconds:t}:{text:`${r}s`,expired:!1,seconds:t}}function eb(){if(document.getElementById("boost-market-styles"))return;const e=document.createElement("style");e.id="boost-market-styles",e.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(e)}function Qr(){const e=document.getElementById("rental");if(!e)return;eb();const t=c.rentalListings||[],a=t.filter(s=>c.isConnected&&$a(s.owner,c.userAddress)),n=Math.floor(Date.now()/1e3),r=(c.myRentals||[]).filter(s=>$a(s.tenant,c.userAddress)&&Number(s.endTime)>n),i=R.marketStats;e.innerHTML=`
        <div class="max-w-6xl mx-auto px-4 py-6">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6 bm-stats-grid">
                ...
                <div class="bm-card p-4 text-center">
                    <p class="text-2xl font-bold text-purple-400 font-mono"><i class="fa-brands fa-ethereum text-lg mr-1"></i>${i?je(i.totalVolume):"—"}</p>
        ...
        ${ib()}
        ${sb()}
    `,ob(),Ca()}function Ca(){const e=document.getElementById("bm-tab-content");if(e){switch(R.activeTab){case"marketplace":e.innerHTML=tb();break;case"my-listings":e.innerHTML=ab();break;case"my-rentals":e.innerHTML=nb();break}R.activeTab==="my-rentals"&&bb()}}function tb(){const e=c.rentalListings||[],t=Math.floor(Date.now()/1e3);let a=e.filter(n=>!(n.isRented||n.currentlyRented||n.rentalEndTime&&Number(n.rentalEndTime)>t||R.filterTier!=="ALL"&&Ua(n.boostBips).name!==R.filterTier));return a.sort((n,r)=>{const i=BigInt(n.pricePerHour||0),s=BigInt(r.pricePerHour||0);return R.sortBy==="price-low"?i<s?-1:i>s?1:0:R.sortBy==="price-high"?i>s?-1:i<s?1:0:(r.boostBips||0)-(n.boostBips||0)}),`
        <div>
            <!-- Filters & Sort -->
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
                <div class="flex flex-wrap gap-2">
                    <button class="bm-filter ${R.filterTier==="ALL"?"active":""}" data-filter="ALL">All Tiers</button>
                    ${Object.keys(Zr).map(n=>`
            ...
            <!-- NFT Grid -->
            ${a.length===0?lo("No NFTs Available","Be the first to list your NFT booster!"):`
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 bm-nft-grid">
                    ${a.map((n,r)=>xd(n,r,!1)).join("")}
                </div>
            `}
        </div>
    `}function xd(e,t,a=!1){const n=Ua(e.boostBips),r=dr(n.name),i=je(e.pricePerHour),s=at(e.tokenId),o=c.isConnected&&$a(e.owner,c.userAddress),l=e.isRented||e.currentlyRented,d=tt(e.boostBips||0);return`
                ...
                <div class="flex items-end justify-between">
                    ...
                    <div class="flex gap-2">
                        ${o?`
                            ...
                            <button class="bm-withdraw-btn bm-btn-danger px-4 py-2 text-xs" data-id="${s}" ${l?"disabled":""}>
                                <i class="fa-solid fa-arrow-right-from-bracket mr-1"></i>Withdraw
                            </button>
                        `:`
                            <button class="bm-rent-btn bm-btn-primary px-5 py-2.5 text-sm" data-id="${s}" ${l?"disabled":""}>
    ...
    `}function ab(){if(!c.isConnected)return hd("View your listings");const e=c.rentalListings||[],t=e.filter(i=>$a(i.owner,c.userAddress)),a=new Set(e.map(i=>at(i.tokenId))),n=(c.myBoosters||[]).filter(i=>!a.has(at(i.tokenId))),r=t.reduce((i,s)=>i+BigInt(s.totalEarnings||0),0n);return`
        <div>
            <!-- Earnings Card -->
                    ...
                    <div class="flex items-center gap-5">
                        ...
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white">
                                <i class="fa-brands fa-ethereum text-blue-400 text-2xl mr-1"></i>${je(r)} <span class="text-lg text-zinc-500">ETH</span>
                            </p>
                        </div>
                    </div>
                    <div class="flex flex-wrap gap-3 items-center">
                        ...
                        <div class="bm-card p-4 text-center min-w-[120px]" style="border-color: rgba(251,191,36,0.2);">
                            <p class="text-xl font-bold text-amber-400 font-mono" id="bm-pending-amount">
                                ${R.pendingEarningsAmount>0n?je(R.pendingEarningsAmount):"0"}
                            </p>
            ...
            <!-- My Listed NFTs -->
            ${t.length===0?lo("No Listings Yet","List your first NFT to start earning ETH!"):`
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 bm-nft-grid">
                    ${t.map((i,s)=>xd(i,s,!0)).join("")}
                </div>
            `}
        </div>
    `}function nb(){if(!c.isConnected)return hd("View your active rentals");const e=Math.floor(Date.now()/1e3),t=(c.myRentals||[]).filter(a=>$a(a.tenant,c.userAddress)&&Number(a.endTime)>e);return`
        <div>
            <!-- Tier Info -->
            <div class="bm-card p-5 mb-6" style="border-color: rgba(34,197,94,0.15);">
                <div class="flex items-start gap-4">
            ...
            <!-- Active Rentals -->
            ${t.length===0?lo("No Active Rentals","Rent an NFT booster to keep more staking rewards!"):`
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    ${t.map((a,n)=>rb(a,n)).join("")}
                </div>
            `}
        </div>
    `}function rb(e,t){const a=Ua(e.boostBips),n=dr(a.name),r=gd(Number(e.endTime)),i=tt(e.boostBips||0);let s="active";return r.seconds<3600?s="critical":r.seconds<7200&&(s="warning"),`
    ...
    `}function ib(){const e=c.rentalListings||[],t=new Set(e.map(n=>at(n.tokenId)));return`
                ...
                <div class="p-5 space-y-5">
                    <div>
                        ...
                        <select id="bm-list-select" class="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-4 py-3 text-white outline-none">
                            ...
                            ${(c.myBoosters||[]).filter(n=>!t.has(at(n.tokenId))).map(n=>{const r=Ua(n.boostBips),i=dr(r.name);return`<option value="${n.tokenId}">${i.emoji} ${r.name} Booster #${n.tokenId}</option>`}).join("")}
                        </select>
                    </div>
                    <div>
    ...
    `}let Rt=null,_t=null;function ob(){Rt&&document.removeEventListener("click",Rt),_t&&document.removeEventListener("change",_t),Rt=e=>{const t=e.target,a=t.closest(".bm-tab");if(a){R.activeTab=a.dataset.tab,document.querySelectorAll(".bm-tab").forEach(o=>o.classList.remove("active")),a.classList.add("active"),Ca();return}const n=t.closest(".bm-filter");if(n){R.filterTier=n.dataset.filter,Ca();return}if(t.closest("#bm-open-list")){lb();return}if(t.closest(".bm-close-list")){vd();return}if(t.closest(".bm-close-rent")){wd();return}if(t.closest("#bm-confirm-list")){ub();return}if(t.closest("#bm-confirm-rent")){db();return}const r=t.closest(".bm-rent-btn");if(r&&!r.disabled){cb(r.dataset.id);return}const i=t.closest(".bm-withdraw-btn");if(i&&!i.disabled){pb(i);return}const s=t.closest(".bm-share-btn");if(s){fb(s.dataset.id);return}if(t.closest("#bm-withdraw-earnings")){mb();return}if(t.classList.contains("bm-modal")){t.classList.remove("active"),R.selectedListing=null;return}},_t=e=>{e.target.id==="bm-sort"&&(R.sortBy=e.target.value,Ca())},document.addEventListener("click",Rt),document.addEventListener("change",_t)}function lb(){const e=document.getElementById("bm-modal-list");e&&e.classList.add("active")}function vd(){const e=document.getElementById("bm-modal-list");e&&e.classList.remove("active")}function cb(e){const t=(c.rentalListings||[]).find(p=>Q0(p.tokenId,e));if(!t)return;R.selectedListing=t;const a=Ua(t.boostBips),n=dr(a.name),r=je(t.pricePerHour),i=tt(t.boostBips||0),s=document.getElementById("bm-rent-modal-body");if(!s)return;s.innerHTML=`
    ...
    `;const o=document.getElementById("bm-rent-hours"),l=document.getElementById("bm-confirm-rent"),d=document.getElementById("bm-balance-warn"),u=document.getElementById("bm-balance-warn-text"),m=async()=>{const p=parseInt(o.value)||1;let b=0n;try{const f=await rt.getRentalCost(e,p);b=f.totalCost,document.getElementById("bm-cost-rental").innerHTML=`<i class="fa-brands fa-ethereum text-blue-400 mr-1"></i>${f.rentalCostFormatted} ETH`,document.getElementById("bm-cost-fee").innerHTML=`<i class="fa-brands fa-ethereum text-blue-400 mr-1"></i>${f.ethFeeFormatted} ETH`,document.getElementById("bm-cost-total").innerHTML=`<i class="fa-brands fa-ethereum text-blue-400 mr-1"></i>${f.totalCostFormatted} ETH`}catch{const w=BigInt(t.pricePerHour||0)*BigInt(p);b=w,document.getElementById("bm-cost-rental").innerHTML=`<i class="fa-brands fa-ethereum text-blue-400 mr-1"></i>${je(w)} ETH`,document.getElementById("bm-cost-fee").textContent="~fee",document.getElementById("bm-cost-total").innerHTML=`<i class="fa-brands fa-ethereum text-blue-400 mr-1"></i>~${je(w)} ETH`}if(c.isConnected&&b>0n)try{const{NetworkManager:f}=await O(async()=>{const{NetworkManager:C}=await Promise.resolve().then(()=>J);return{NetworkManager:C}},void 0),w=await f.getProvider().getBalance(c.userAddress),k=b+oo.parseEther("0.001");if(w<k){const C=je(k-w);l.disabled=!0,l.className="flex-1 py-3 rounded-xl font-bold text-sm border border-red-500/30 bg-red-500/10 text-red-400 cursor-not-allowed",l.innerHTML=`<i class="fa-brands fa-ethereum mr-1"></i>Need ${je(k)} ETH`,d.classList.remove("hidden"),u.textContent=`Your balance: ${je(w)} ETH — need ${C} more ETH`}else l.disabled=!1,l.className="bm-btn-primary flex-1 py-3",l.innerHTML='<i class="fa-solid fa-bolt mr-2"></i>Rent Now',d.classList.add("hidden")}catch{l.disabled=!1,l.className="bm-btn-primary flex-1 py-3",l.innerHTML='<i class="fa-solid fa-bolt mr-2"></i>Rent Now',d.classList.add("hidden")}};m(),o.addEventListener("input",m),document.getElementById("bm-modal-rent").classList.add("active")}function wd(){const e=document.getElementById("bm-modal-rent");e&&e.classList.remove("active"),R.selectedListing=null}async function db(){if(R.isTransactionPending||!R.selectedListing)return;const e=parseInt(document.getElementById("bm-rent-hours").value)||1,t=at(R.selectedListing.tokenId),a=document.getElementById("bm-confirm-rent");R.isTransactionPending=!0;try{await rt.rent({tokenId:t,hours:e,button:a,onSuccess:async()=>{R.isTransactionPending=!1,wd(),x("NFT Rented Successfully!","success"),await ra()},onError:n=>{R.isTransactionPending=!1,!n.cancelled&&n.type!=="user_rejected"&&x("Failed: "+(n.message||"Error"),"error")}})}catch(n){R.isTransactionPending=!1,!n.cancelled&&n.type!=="user_rejected"&&x("Failed: "+(n.message||"Error"),"error")}}async function ub(){if(R.isTransactionPending)return;const e=document.getElementById("bm-list-select").value,t=document.getElementById("bm-list-price").value,a=parseInt(document.getElementById("bm-list-min").value)||1,n=parseInt(document.getElementById("bm-list-max").value)||168;if(!e){x("Select an NFT","error");return}if(!t||parseFloat(t)<=0){x("Enter valid price","error");return}if(a>n){x("Min hours must be <= max hours","error");return}const r=document.getElementById("bm-confirm-list");R.isTransactionPending=!0;try{await rt.list({tokenId:e,pricePerHour:oo.parseEther(t),minHours:a,maxHours:n,button:r,onSuccess:async()=>{R.isTransactionPending=!1,vd(),x("NFT Listed Successfully!","success"),await ra()},onError:i=>{R.isTransactionPending=!1,!i.cancelled&&i.type!=="user_rejected"&&x("Failed: "+(i.message||"Error"),"error")}})}catch(i){R.isTransactionPending=!1,!i.cancelled&&i.type!=="user_rejected"&&x("Failed: "+(i.message||"Error"),"error")}}async function pb(e){if(R.isTransactionPending)return;const t=e.dataset.id;if(confirm("Withdraw this NFT from the marketplace?")){R.isTransactionPending=!0;try{await rt.withdraw({tokenId:t,button:e,onSuccess:async()=>{R.isTransactionPending=!1,x("NFT Withdrawn Successfully!","success"),await ra()},onError:a=>{R.isTransactionPending=!1,!a.cancelled&&a.type!=="user_rejected"&&x("Failed: "+(a.message||"Error"),"error")}})}catch(a){R.isTransactionPending=!1,!a.cancelled&&a.type!=="user_rejected"&&x("Failed: "+(a.message||"Error"),"error")}}}async function mb(){if(R.isTransactionPending||R.pendingEarningsAmount===0n)return;const e=document.getElementById("bm-withdraw-earnings");R.isTransactionPending=!0;try{await rt.withdrawEarnings({button:e,onSuccess:async()=>{R.isTransactionPending=!1,R.pendingEarningsAmount=0n,x("Earnings Withdrawn!","success"),await ra()},onError:t=>{R.isTransactionPending=!1,!t.cancelled&&t.type!=="user_rejected"&&x("Failed: "+(t.message||"Error"),"error")}})}catch(t){R.isTransactionPending=!1,!t.cancelled&&t.type!=="user_rejected"&&x("Failed: "+(t.message||"Error"),"error")}}function fb(e){const t="https://backcoin.org/#rental",a=`Rent NFT Boosters on Backchain Boost Market!

Keep up to 100% of your staking rewards by renting an NFT booster.

${t}

#Backchain #DeFi #Arbitrum #Web3`;navigator.share?navigator.share({title:"Backchain Boost Market",text:a,url:t}).catch(()=>{}):navigator.clipboard.writeText(a).then(()=>{x("Link copied to clipboard!","success")}).catch(()=>{x("Could not copy link","error")})}function bb(){R.countdownIntervals.forEach(clearInterval),R.countdownIntervals=[],document.querySelectorAll(".bm-timer[data-end]").forEach(e=>{const t=Number(e.dataset.end),a=setInterval(()=>{const n=gd(t);e.innerHTML=`<i class="fa-solid fa-clock mr-1"></i>${n.text}`,n.expired?(clearInterval(a),Ca()):n.seconds<3600?e.className="bm-timer critical":n.seconds<7200&&(e.className="bm-timer warning")},1e3);R.countdownIntervals.push(a)})}async function ra(){R.isLoading=!0;try{const e=[jl()];c.isConnected&&(e.push(hu()),e.push(St()),e.push(gb())),e.push(xb()),await Promise.all(e)}catch(e){console.warn("[BoostMarket] Refresh error:",e)}R.isLoading=!1,Qr()}async function gb(){if(c.userAddress)try{const e=await rt.getPendingEarnings(c.userAddress);R.pendingEarningsAmount=e.amount}catch{R.pendingEarningsAmount=0n}}async function xb(){try{R.marketStats=await rt.getMarketplaceStats()}catch{R.marketStats=null}}function pl(){R.countdownIntervals.forEach(clearInterval),R.countdownIntervals=[],Rt&&(document.removeEventListener("click",Rt),Rt=null),_t&&(document.removeEventListener("change",_t),_t=null)}const yd={async render(e){if(!e){pl();return}Qr(),await ra()},update(){Qr()},refresh:ra,cleanup:pl};window.RentalPage=yd;const hb={render:async e=>{const t=document.getElementById("socials");if(!t||!e&&t.innerHTML.trim()!=="")return;const a=`
            <style>
        ...
        `},cleanup:()=>{}},kd=document.createElement("style");kd.innerHTML=`
...
`;document.head.appendChild(kd);const vb={render:async e=>{if(!e)return;const t=document.getElementById("creditcard");t&&(t.innerHTML=`
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    ...
                    <div class="glass-mockup rounded-2xl p-6 h-full flex flex-col">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="space-y-2">
                                ${ga("Starbucks Coffee","Today, 8:30 AM","- $5.40","+ 15 BKC","fa-mug-hot")}
                                ${ga("Uber Ride","Yesterday, 6:15 PM","- $24.50","+ 82 BKC","fa-car")}
                                ${ga("Netflix Subscription","Oct 24, 2025","- $15.99","+ 53 BKC","fa-film")}
                                ${ga("Amazon Purchase","Oct 22, 2025","- $142.00","+ 475 BKC","fa-box-open")}
                                ${ga("Shell Station","Oct 20, 2025","- $45.00","+ 150 BKC","fa-gas-pump")}
                            </div>
                        </div>
                    </div>
    ...
    `}function Nr(e,t,a,n,r,i,s){const o=co[jt];let l=`
        <div class="mb-10">
    ...
    `,d=s;return n.forEach(u=>{l+=yb(u,d++)}),l+="</div></div>",{html:l,nextIndex:d}}function kb(e){var t,a,n,r,i,s,o,l;jt=e,localStorage.setItem("backcoin-tutorials-lang",e),(t=document.getElementById("tutorials-btn-en"))==null||t.classList.toggle("bg-amber-500",e==="en"),(a=document.getElementById("tutorials-btn-en"))==null||a.classList.toggle("text-zinc-900",e==="en"),(n=document.getElementById("tutorials-btn-en"))==null||n.classList.toggle("bg-zinc-700",e!=="en"),(r=document.getElementById("tutorials-btn-en"))==null||r.classList.toggle("text-zinc-300",e!=="en"),(i=document.getElementById("tutorials-btn-pt"))==null||i.classList.toggle("bg-amber-500",e==="pt"),(s=document.getElementById("tutorials-btn-pt"))==null||s.classList.toggle("text-zinc-900",e==="pt"),(o=document.getElementById("tutorials-btn-pt"))==null||o.classList.toggle("bg-zinc-700",e!=="pt"),(l=document.getElementById("tutorials-btn-pt"))==null||l.classList.toggle("text-zinc-300",e!=="pt"),Ed()}function Ed(){const e=document.getElementById("tutorials-content");if(!e)return;const t=co[jt];let a=`
        <!-- Hero -->
        <div class="text-center mb-10">
    ...
    `,n=Nr("getting-started","rocket","emerald",Br.gettingStarted,"catGettingStarted","catGettingStartedDesc",0);a+=n.html,n=Nr("ecosystem","cubes","amber",Br.ecosystem,"catEcosystem","catEcosystemDesc",n.nextIndex),a+=n.html,n=Nr("advanced","graduation-cap","cyan",Br.advanced,"catAdvanced","catAdvancedDesc",n.nextIndex),a+=n.html,e.innerHTML=a}const Td={render:function(e=!1){const t=document.getElementById("tutorials");t&&(e||t.innerHTML.trim()==="")&&(t.innerHTML=`
            ...
            `,Ed())},update:function(e){},cleanup:function(){},setLang:kb};window.TutorialsPage=Td;const Yt=window.ethers,Eb={ACTIVE:0,COMPLETED:1,CANCELLED:2,WITHDRAWN:3},uo=e=>typeof e=="number"?e:typeof e=="string"?isNaN(parseInt(e))?Eb[e.toUpperCase()]??0:parseInt(e):0,po=e=>uo(e.status)===0&&Number(e.deadline)>Math.floor(Date.now()/1e3),mo=["function getCampaign(uint256 _campaignId) view returns (address creator, string title, string description, uint96 goalAmount, uint96 raisedAmount, uint32 donationCount, uint64 deadline, uint64 createdAt, uint96 boostAmount, uint64 boostTime, uint8 status, bool goalReached)","function campaignCounter() view returns (uint64)","function getStats() view returns (uint64 totalCampaigns, uint256 totalRaised, uint256 totalDonations, uint256 totalFees)"],ja={getCampaigns:"https://getcharitycampaigns-4wvdcuoouq-uc.a.run.app",saveCampaign:"https://savecharitycampaign-4wvdcuoouq-uc.a.run.app",uploadImage:"/api/upload-image"},Cd="https://sepolia.arbiscan.io/address/",En={animal:"https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=800&q=80",humanitarian:"https://images.unsplash.com/photo-1469571486292-0ba58a3f068b?w=800&q=80",default:"https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?w=800&q=80"},Be={animal:{name:"Animal Welfare",emoji:"🐾",color:"#10b981",gradient:"from-emerald-500/20 to-green-600/20"},humanitarian:{name:"Humanitarian Aid",emoji:"💗",color:"#ec4899",gradient:"from-pink-500/20 to-rose-600/20"}},ml={0:{label:"Active",color:"#10b981",icon:"fa-circle-play",bg:"bg-emerald-500/15"},1:{label:"Ended",color:"#3b82f6",icon:"fa-circle-check",bg:"bg-blue-500/15"},2:{label:"Cancelled",color:"#ef4444",icon:"fa-circle-xmark",bg:"bg-red-500/15"},3:{label:"Completed",color:"#8b5cf6",icon:"fa-circle-dollar-to-slot",bg:"bg-purple-500/15"}},Id=5*1024*1024,Ad=["image/jpeg","image/png","image/gif","image/webp"],E={campaigns:[],stats:null,currentView:"main",currentCampaign:null,selectedCategory:null,isLoading:!1,pendingImage:null,pendingImageFile:null,editingCampaign:null,createStep:1,createCategory:null,createTitle:"",createDesc:"",createGoal:"",createDuration:"",createImageFile:null,createImageUrl:"",createImagePreview:null};function Tb(){if(document.getElementById("charity-styles-v6"))return;const e=document.createElement("style");e.id="charity-styles-v6",e.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(e)}const Ae=e=>{try{const t=Number(e)/1e18;return t<1e-4?"0":t<1?t.toFixed(4):t<1e3?t.toFixed(2):t.toLocaleString("en-US",{maximumFractionDigits:2})}catch{return"0"}},Pd=e=>e?`${e.slice(0,6)}...${e.slice(-4)}`:"",Wa=(e,t)=>{const a=Number(e||0),n=Number(t||1);return Math.min(100,Math.round(a/n*100))},zd=e=>{const t=Math.floor(Date.now()/1e3),a=Number(e)-t;if(a<=0)return{text:"Ended",color:"#ef4444"};const n=Math.floor(a/86400);return n>0?{text:`${n}d left`,color:"#10b981"}:{text:`${Math.floor(a/3600)}h left`,color:"#f59e0b"}},ur=e=>(e==null?void 0:e.imageUrl)||En[e==null?void 0:e.category]||En.default,Bd=e=>`${window.location.origin}${window.location.pathname}#charity/${e}`,Nd=()=>{const t=window.location.hash.match(/#charity\/(\d+)/);return t?t[1]:null},Cb=e=>{window.location.hash=`charity/${e}`},Ib=()=>{window.location.hash.startsWith("#charity/")&&(window.location.hash="charity")},Sd=e=>{const t=uo(e.status),a=Number(e.deadline)<=Math.floor(Date.now()/1e3);return(t===0||t===1)&&a&&!e.withdrawn&&BigInt(e.raisedAmount||0)>0n},$d="charity-meta-";function fo(e,t){try{localStorage.setItem(`${$d}${e}`,JSON.stringify(t))}catch{}}function Ld(e){try{return JSON.parse(localStorage.getItem(`${$d}${e}`)||"null")}catch{return null}}async function Tt(){E.isLoading=!0;try{const[e,t]=await Promise.all([fetch(ja.getCampaigns).then(r=>r.json()).catch(()=>({campaigns:[]})),Ab()]),a=(e==null?void 0:e.campaigns)||[],n=c==null?void 0:c.publicProvider;if(n){const r=new Yt.Contract(v.charityPool,mo,n),i=await r.campaignCounter(),s=Number(i),o=await Promise.all(Array.from({length:s},(l,d)=>d+1).map(async l=>{try{const d=await r.getCampaign(l),u=a.find(p=>String(p.id)===String(l)),m=Ld(l);return{id:String(l),creator:d.creator||d[0],title:(u==null?void 0:u.title)||d.title||d[1]||`Campaign #${l}`,description:(u==null?void 0:u.description)||d.description||d[2]||"",goalAmount:BigInt((d.goalAmount||d[3]).toString()),raisedAmount:BigInt((d.raisedAmount||d[4]).toString()),donationCount:Number(d.donationCount||d[5]),deadline:Number(d.deadline||d[6]),createdAt:Number(d.createdAt||d[7]),status:Number(d.status||d[10]),category:(u==null?void 0:u.category)||(m==null?void 0:m.category)||"humanitarian",imageUrl:(u==null?void 0:u.imageUrl)||(m==null?void 0:m.imageUrl)||null}}catch{return null}}));E.campaigns=o.filter(Boolean)}E.stats=t}catch(e){console.error("Load data:",e)}finally{E.isLoading=!1}}async function Ab(){try{const e=c==null?void 0:c.publicProvider;if(!e)return null;const a=await new Yt.Contract(v.charityPool,mo,e).getStats();return{raised:a.totalRaised??a[1],fees:a.totalFees??a[3],created:Number(a.totalCampaigns??a[0]),donations:Number(a.totalDonations??a[2])}}catch{return null}}function Pb(e,t="create"){var r;const a=(r=e.target.files)==null?void 0:r[0];if(!a)return;if(!Ad.includes(a.type)){x("Please select a valid image (JPG, PNG, GIF, WebP)","error");return}if(a.size>Id){x("Image must be less than 5MB","error");return}E.pendingImageFile=a;const n=new FileReader;n.onload=i=>{const s=t==="edit"?"edit-image-preview":"create-image-preview",o=document.getElementById(t==="edit"?"edit-image-upload":"create-image-upload"),l=document.getElementById(s);l&&(l.innerHTML=`
            ...
            `),o&&o.classList.add("has-image")},n.readAsDataURL(a)}function zb(e="create"){E.pendingImageFile=null,E.pendingImage=null;const t=e==="edit"?"edit-image-preview":"create-image-preview",a=document.getElementById(e==="edit"?"edit-image-upload":"create-image-upload"),n=document.getElementById(t);n&&(n.innerHTML=""),a&&a.classList.remove("has-image");const r=document.getElementById(e==="edit"?"edit-image-file":"create-image-file");r&&(r.value="")}function Bb(e,t="create"){document.querySelectorAll(`#${t}-image-tabs .cp-tab`).forEach(i=>i.classList.toggle("active",i.dataset.tab===e));const n=document.getElementById(`${t}-image-upload`),r=document.getElementById(`${t}-image-url-wrap`);n&&(n.style.display=e==="upload"?"block":"none"),r&&(r.style.display=e==="url"?"block":"none")}async function bo(e){const t=new FormData;t.append("image",e);const a=await fetch(ja.uploadImage,{method:"POST",body:t,signal:AbortSignal.timeout(6e4)});if(!a.ok){const r=await a.json().catch(()=>({}));throw new Error(r.error||`Upload failed (${a.status})`)}return(await a.json()).imageUrl}const Rd=e=>{const t=ml[uo(e)]||ml[0];return`<span class="cp-badge" style="background:${t.color}20;color:${t.color}"><i class="fa-solid ${t.icon}"></i> ${t.label}</span>`},Nb=()=>'<div class="cp-loading"><div class="cp-spinner"></div><span class="text-zinc-500">Loading campaigns...</span></div>',_d=e=>`<div class="cp-empty"><i class="fa-solid fa-inbox"></i><h3>${e}</h3><p class="text-zinc-600 text-sm">Be the first to create a campaign!</p></div>`,Fd=e=>{var r,i,s,o;const t=Wa(e.raisedAmount,e.goalAmount),a=zd(e.deadline),n=e.category||"humanitarian";return`
        <div class="cp-campaign-card" onclick="CharityPage.viewCampaign('${e.id}')">
            <img src="${ur(e)}" alt="${e.title}" onerror="this.src='${En.default}'">
            <div class="p-4">
                <div class="flex flex-wrap gap-1.5 mb-2">
                    ${Rd(e.status)}
                    <span class="cp-badge" style="background:${(r=Be[n])==null?void 0:r.color}20;color:${(i=Be[n])==null?void 0:i.color}">
                        ${(s=Be[n])==null?void 0:s.emoji} ${(o=Be[n])==null?void 0:o.name}
                    </span>
                </div>
                <h3 class="text-white font-bold text-sm mb-1 line-clamp-2">${e.title}</h3>
                <p class="text-zinc-500 text-xs mb-3">by <a href="${Cd}${e.creator}" target="_blank" class="text-amber-500 hover:text-amber-400">${Pd(e.creator)}</a></p>
    ...
    `},fl=()=>{var n,r,i,s;const e=E.campaigns.filter(o=>po(o)),t=e.filter(o=>o.category==="animal"),a=e.filter(o=>o.category==="humanitarian");return`
        <div class="charity-page">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6 cp-stats-grid">
                <div class="cp-stat-card">
                    <p class="text-2xl font-bold text-emerald-400 font-mono">
                        <i class="fa-brands fa-ethereum text-lg mr-1"></i>${E.stats?Ae(E.stats.raised):"--"}
                    </p>
                    <p class="text-[10px] text-zinc-500 uppercase mt-1">Total Raised</p>
                </div>
                <div class="cp-stat-card">
                    <p class="text-2xl font-bold text-blue-400 font-mono">${E.stats?Ae(E.stats.fees):"--"}</p>
                ...
                <div class="cp-stat-card">
                    <p class="text-2xl font-bold text-purple-400 font-mono">${((r=E.stats)==null?void 0:r.donations)??"--"}</p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8 cp-cats-grid">
                <div class="cp-category-card animal ${E.selectedCategory==="animal"?"selected":""}" onclick="CharityPage.selectCat('animal')">
                    ...
                    <div class="flex justify-center gap-6 text-sm text-zinc-400 mb-3">
                        ...
                        <span><i class="fa-brands fa-ethereum"></i> <strong class="text-white">${Ae(t.reduce((o,l)=>o+BigInt(l.raisedAmount||0),0n))}</strong></span>
                    </div>
                ...
                <div class="cp-category-card humanitarian ${E.selectedCategory==="humanitarian"?"selected":""}" onclick="CharityPage.selectCat('humanitarian')">
                    ...
                    <div class="flex justify-center gap-6 text-sm text-zinc-400 mb-3">
                        ...
                        <span><i class="fa-brands fa-ethereum"></i> <strong class="text-white">${Ae(a.reduce((o,l)=>o+BigInt(l.raisedAmount||0),0n))}</strong></span>
                    </div>
            ...
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-lg font-bold text-white flex items-center gap-2">
                    ${E.selectedCategory?`
                        ...
                        ${(i=Be[E.selectedCategory])==null?void 0:i.emoji} ${(s=Be[E.selectedCategory])==null?void 0:s.name}
                    `:`
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4" id="cp-grid">
                ${e.length?e.filter(o=>!E.selectedCategory||o.category===E.selectedCategory).sort((o,l)=>Number(l.createdAt||0)-Number(o.createdAt||0)).map(o=>Fd(o)).join(""):_d("No active campaigns")}
            </div>
        </div>
    `},bl=e=>{var o,l,d,u,m,p;if(!e)return`
        <div class="charity-page">
    ...
    `;const t=Wa(e.raisedAmount,e.goalAmount),a=zd(e.deadline),n=e.category||"humanitarian",r=po(e),i=((o=e.creator)==null?void 0:o.toLowerCase())===((l=c==null?void 0:c.userAddress)==null?void 0:l.toLowerCase()),s=Sd(e);return`
        <div class="charity-page">
            ${go()}
            ${Md()}
            ...
            <div class="cp-detail">
                ...
                <img src="${ur(e)}" class="cp-detail-img" onerror="this.src='${En.default}'">
                ...
                <div class="cp-detail-content">
                    ...
                    <div class="cp-card-base p-6">
                        ...
                        <p class="text-sm text-zinc-500 mb-4">
                            Created by <a href="${Cd}${e.creator}" target="_blank" class="text-amber-500 hover:text-amber-400">${Pd(e.creator)}</a>
                        </p>
...
`;function Lb(){[1,2,3,4].forEach(t=>{const a=document.getElementById(`cp-step-${t}`);a&&(t<E.createStep?(a.className="cp-step-dot done",a.innerHTML='<i class="fa-solid fa-check text-sm"></i>'):t===E.createStep?(a.className="cp-step-dot active",a.textContent=t):(a.className="cp-step-dot pending",a.textContent=t))}),[1,2,3].forEach(t=>{const a=document.getElementById(`cp-ln-${t}`);a&&(a.className=`cp-step-line ln-${t} ${E.createStep>t?"done":E.createStep===t?"active":""}`)});const e=document.querySelector(".charity-page .text-sm.text-zinc-500");e&&(e.textContent=`Step ${E.createStep} of 4`)}function Ga(){const e=document.getElementById("cp-wiz-panel");if(e)switch(Lb(),E.createStep){case 1:Rb(e);break;case 2:_b(e);break;case 3:Fb(e);break;case 4:Mb(e);break}}function Rb(e){e.innerHTML=`
    ...
    `}function _b(e){const t=E.createTitle.length,a=E.createDesc.length;e.innerHTML=`
    ...
    `}function Mb(e){const t=Be[E.createCategory]||Be.humanitarian;e.innerHTML=`
    ...
    `}function Db(e){E.createCategory=e,Ga()}function Ob(){var e,t,a,n,r,i;switch(E.createStep){case 1:if(!E.createCategory)return x("Select a category","error");break;case 2:{const s=((t=(e=document.getElementById("wiz-title"))==null?void 0:e.value)==null?void 0:t.trim())||"",o=((n=(a=document.getElementById("wiz-desc"))==null?void 0:a.value)==null?void 0:n.trim())||"";if(E.createTitle=s,E.createDesc=o,!s)return x("Enter a title","error");if(!o)return x("Enter a description","error");break}case 3:{const s=((i=(r=document.getElementById("wiz-image-url"))==null?void 0:r.value)==null?void 0:i.trim())||"";s&&(E.createImageUrl=s);break}}E.createStep=Math.min(4,E.createStep+1),Ga()}function Hb(){jb(),E.createStep=Math.max(1,E.createStep-1),Ga()}function Ub(){E.createImageFile=null,E.createImageUrl="",E.createImagePreview=null,E.pendingImageFile=null,E.createStep=4,Ga()}function Dd(){E.currentView="main",E.createStep=1,E.createCategory=null,E.createTitle="",E.createDesc="",E.createGoal="",E.createDuration="",E.createImageFile=null,E.createImageUrl="",E.createImagePreview=null,E.pendingImageFile=null,De()}function jb(){switch(E.createStep){case 2:{const e=document.getElementById("wiz-title"),t=document.getElementById("wiz-desc");e&&(E.createTitle=e.value),t&&(E.createDesc=t.value);break}case 3:{const e=document.getElementById("wiz-image-url");e&&(E.createImageUrl=e.value.trim());break}case 4:{const e=document.getElementById("wiz-goal"),t=document.getElementById("wiz-duration");e&&(E.createGoal=e.value),t&&(E.createDuration=t.value);break}}}function Wb(e,t){const a=t.value.length,n=e==="title"?100:2e3,r=e==="title"?80:1800,i=e==="title"?95:1950,s=document.getElementById(`wiz-${e}-count`);s&&(s.textContent=`${a}/${n}`,s.className=`cp-wiz-char-count ${a>i?"danger":a>r?"warn":""}`)}function Gb(e){var n;const t=(n=e.target.files)==null?void 0:n[0];if(!t)return;if(!Ad.includes(t.type)){x("Please select a valid image (JPG, PNG, GIF, WebP)","error");return}if(t.size>Id){x("Image must be less than 5MB","error");return}E.createImageFile=t,E.pendingImageFile=t;const a=new FileReader;a.onload=r=>{E.createImagePreview=r.target.result;const i=document.getElementById("wiz-image-preview");i&&(i.innerHTML=`
                <img src="${r.target.result}" class="cp-image-preview">
                <button type="button" class="cp-image-remove" onclick="event.stopPropagation();CharityPage.removeWizardImage()">
                    <i class="fa-solid fa-xmark"></i> Remove
                </button>
            `)},a.readAsDataURL(t)}function Kb(){E.createImageFile=null,E.createImagePreview=null,E.createImageUrl="",E.pendingImageFile=null;const e=document.getElementById("wiz-image-preview");e&&(e.innerHTML=`
            <div class="cp-image-upload-icon"><i class="fa-solid fa-cloud-arrow-up"></i></div>
            <div class="cp-image-upload-text"><span>Click to upload</span> or drag and drop<br><small>PNG, JPG, GIF, WebP — max 5MB</small></div>
        `);const t=document.getElementById("wiz-image-file");t&&(t.value="")}async function Yb(){var l,d;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=(l=document.getElementById("wiz-goal"))==null?void 0:l.value,t=(d=document.getElementById("wiz-duration"))==null?void 0:d.value;if(E.createGoal=e||"",E.createDuration=t||"",!E.createCategory)return x("Select a category","error");if(!E.createTitle)return x("Enter a title","error");if(!E.createDesc)return x("Enter a description","error");if(!e||parseFloat(e)<.01)return x("Goal must be at least 0.01 ETH","error");if(!t||parseInt(t)<1||parseInt(t)>180)return x("Duration must be 1-180 days","error");let a=E.createImageUrl||"";if(E.createImageFile)try{x("Uploading image to IPFS...","info"),a=await bo(E.createImageFile),x("Image uploaded!","success")}catch(u){console.error("Image upload failed:",u),x("Image upload failed — campaign will be created without image","warning")}const n=E.createTitle,r=E.createDesc,i=E.createCategory,s=Yt.parseEther(e),o=parseInt(t);await kt.createCampaign({title:n,description:r,goalAmount:s,durationDays:o,button:document.getElementById("btn-wizard-launch"),onSuccess:async(u,m)=>{if(m){fo(m,{imageUrl:a,category:i,title:n,description:r});try{await fetch(ja.saveCampaign,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:m,title:n,description:r,category:i,imageUrl:a,creator:c.userAddress})})}catch{}}x("Campaign created!","success"),Dd(),await Tt(),De()},onError:u=>{var m;!u.cancelled&&u.type!=="user_rejected"&&x(((m=u.message)==null?void 0:m.slice(0,80))||"Failed","error")}})}function pr(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.add("active")}function gt(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.remove("active")}function Vb(e=null){E.createStep=e?2:1,E.createCategory=e,E.createTitle="",E.createDesc="",E.createGoal="",E.createDuration="",E.createImageFile=null,E.createImageUrl="",E.createImagePreview=null,E.pendingImageFile=null,E.currentView="create",De()}function qb(e){const t=E.campaigns.find(r=>r.id===e||r.id===String(e));if(!t)return;const a=document.getElementById("donate-campaign-info");a&&(a.innerHTML=`
            <div class="flex items-center gap-3 p-3 bg-zinc-800/50 rounded-xl mb-4">
                <img src="${ur(t)}" class="w-12 h-12 rounded-lg object-cover">
        ...
        `);const n=document.getElementById("donate-amount");n&&(n.value=""),E.currentCampaign=t,pr("donate")}function Xb(){var n;const e=(n=c==null?void 0:c.userAddress)==null?void 0:n.toLowerCase(),t=E.campaigns.filter(r=>{var i;return((i=r.creator)==null?void 0:i.toLowerCase())===e}),a=document.getElementById("my-campaigns-list");a&&(t.length===0?a.innerHTML=`
            <div class="cp-empty">
        ...
        `:a.innerHTML=t.map(r=>{const i=Wa(r.raisedAmount,r.goalAmount),s=Sd(r);return`
                <div class="flex items-center gap-3 p-3 bg-zinc-800/30 rounded-xl mb-2 hover:bg-zinc-800/50 transition-colors">
                    <img src="${ur(r)}" class="w-14 h-14 rounded-lg object-cover cursor-pointer" onclick="CharityPage.viewCampaign('${r.id}')">
                    <div class="flex-1 min-w-0">
            ...
            `}).join(""),pr("my"))}function Jb(e){var n,r,i;const t=E.campaigns.find(s=>s.id===e||s.id===String(e));if(!t)return;if(((n=t.creator)==null?void 0:n.toLowerCase())!==((r=c==null?void 0:c.userAddress)==null?void 0:r.toLowerCase())){x("Not your campaign","error");return}E.editingCampaign=t,E.pendingImageFile=null,document.getElementById("edit-campaign-id").value=t.id,document.getElementById("edit-title").value=t.title||"",document.getElementById("edit-desc").value=t.description||"",document.getElementById("edit-image-url").value=t.imageUrl||"",document.querySelectorAll("#modal-edit .cp-cat-option").forEach(s=>s.classList.remove("selected")),(i=document.getElementById(`edit-opt-${t.category||"humanitarian"}`))==null||i.classList.add("selected");const a=document.getElementById("edit-image-preview");a&&t.imageUrl?a.innerHTML=`<img src="${t.imageUrl}" class="cp-image-preview">`:a&&(a.innerHTML=""),pr("edit")}function Zb(e,t="create"){var r;const a=t==="edit"?"edit-opt-":"opt-",n=t==="edit"?"#modal-edit":"#modal-create";document.querySelectorAll(`${n} .cp-cat-option`).forEach(i=>i.classList.remove("selected")),(r=document.getElementById(`${a}${e}`))==null||r.classList.add("selected")}function Qb(e){const t=document.getElementById("donate-amount")||document.getElementById("detail-amount");t&&(t.value=e)}async function eg(){var l,d,u,m,p,b,f,w;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=document.querySelector("#modal-create .cp-cat-option.selected input"),t=(e==null?void 0:e.value)||"humanitarian",a=(d=(l=document.getElementById("campaign-title"))==null?void 0:l.value)==null?void 0:d.trim(),n=(m=(u=document.getElementById("campaign-desc"))==null?void 0:u.value)==null?void 0:m.trim(),r=(p=document.getElementById("campaign-goal"))==null?void 0:p.value,i=(b=document.getElementById("campaign-duration"))==null?void 0:b.value;let s=(w=(f=document.getElementById("campaign-image-url"))==null?void 0:f.value)==null?void 0:w.trim();if(!a)return x("Enter a title","error");if(!n)return x("Enter a description","error");if(!r||parseFloat(r)<.01)return x("Goal must be at least 0.01 ETH","error");if(!i||parseInt(i)<1)return x("Duration must be at least 1 day","error");if(E.pendingImageFile)try{x("Uploading image...","info"),s=await bo(E.pendingImageFile)}catch(k){console.error("Image upload failed:",k)}const o=Yt.parseEther(r);await kt.createCampaign({title:a,description:n,goalAmount:o,durationDays:parseInt(i),button:document.getElementById("btn-create"),onSuccess:async(k,C)=>{if(C){fo(C,{imageUrl:s,category:t,title:a,description:n});try{await fetch(ja.saveCampaign,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:C,title:a,description:n,category:t,imageUrl:s,creator:c.userAddress})})}catch{}}x("Campaign created!","success"),gt("create"),E.pendingImageFile=null,await Tt(),De()},onError:k=>{var C;!k.cancelled&&k.type!=="user_rejected"&&x(((C=k.message)==null?void 0:C.slice(0,80))||"Failed","error")}})}async function tg(){var n;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=E.currentCampaign;if(!e)return;const t=(n=document.getElementById("donate-amount"))==null?void 0:n.value;if(!t||parseFloat(t)<.001)return x("Minimum 0.001 ETH","error");const a=Yt.parseEther(t);await kt.donate({campaignId:e.id,amount:a,button:document.getElementById("btn-donate"),onSuccess:async()=>{x("❤️ Thank you for your donation!","success"),gt("donate"),await Tt(),De()},onError:r=>{var i;!r.cancelled&&r.type!=="user_rejected"&&x(((i=r.message)==null?void 0:i.slice(0,80))||"Failed","error")}})}async function ag(e){var n;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const t=(n=document.getElementById("detail-amount"))==null?void 0:n.value;if(!t||parseFloat(t)<.001)return x("Minimum 0.001 ETH","error");const a=Yt.parseEther(t);await kt.donate({campaignId:e,amount:a,button:document.getElementById("btn-donate-detail"),onSuccess:async()=>{x("❤️ Thank you for your donation!","success"),await Tt(),await Vt(e)},onError:r=>{var i;!r.cancelled&&r.type!=="user_rejected"&&x(((i=r.message)==null?void 0:i.slice(0,80))||"Failed","error")}})}async function ng(e){if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");confirm("Cancel this campaign? This cannot be undone.")&&await kt.cancelCampaign({campaignId:e,button:document.getElementById("btn-cancel"),onSuccess:async()=>{x("Campaign cancelled","success"),await Tt(),De()},onError:t=>{var a;!t.cancelled&&t.type!=="user_rejected"&&x(((a=t.message)==null?void 0:a.slice(0,80))||"Failed","error")}})}async function rg(e){if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const t=E.campaigns.find(r=>r.id===e||r.id===String(e));if(!t)return;const a=Wa(t.raisedAmount,t.goalAmount);let n=`Withdraw ${Ae(t.raisedAmount)} ETH?

5% platform fee applies.`;a<100&&(n+=`
Goal not reached - partial withdrawal.`),confirm(n)&&await kt.withdraw({campaignId:e,button:document.getElementById(`btn-withdraw-${e}`)||document.getElementById("btn-withdraw"),onSuccess:async()=>{var r;x("✅ Funds withdrawn successfully!","success"),gt("my"),await Tt(),De(),((r=E.currentCampaign)==null?void 0:r.id)===e&&await Vt(e)},onError:r=>{var i;!r.cancelled&&r.type!=="user_rejected"&&x(((i=r.message)==null?void 0:i.slice(0,80))||"Failed","error")}})}async function ig(){var o,l,d,u,m,p,b,f;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=(o=document.getElementById("edit-campaign-id"))==null?void 0:o.value,t=(d=(l=document.getElementById("edit-title"))==null?void 0:l.value)==null?void 0:d.trim(),a=(m=(u=document.getElementById("edit-desc"))==null?void 0:u.value)==null?void 0:m.trim();let n=(b=(p=document.getElementById("edit-image-url"))==null?void 0:p.value)==null?void 0:b.trim();const r=document.querySelector("#modal-edit .cp-cat-option.selected input"),i=(r==null?void 0:r.value)||"humanitarian";if(!t)return x("Enter title","error");if(E.pendingImageFile)try{x("Uploading image...","info"),n=await bo(E.pendingImageFile)}catch(w){console.error("Image upload failed:",w)}const s=document.getElementById("btn-save-edit");s&&(s.disabled=!0,s.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Saving...');try{fo(e,{imageUrl:n,category:i,title:t,description:a}),await fetch(ja.saveCampaign,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:e,title:t,description:a,category:i,imageUrl:n,creator:c.userAddress})}),x("Campaign updated!","success"),gt("edit"),E.pendingImageFile=null,await Tt(),((f=E.currentCampaign)==null?void 0:f.id)===e?await Vt(e):De()}catch{x("Failed to save","error")}finally{s&&(s.disabled=!1,s.innerHTML='<i class="fa-solid fa-check"></i> Save')}}function sg(e){const t=E.currentCampaign;if(!t)return;const a=Bd(t.id),n=`🙏 Support "${t.title}" on Backcoin Charity!

${Ae(t.raisedAmount)} raised of ${Ae(t.goalAmount)} goal.

`;let r;e==="twitter"?r=`https://twitter.com/intent/tweet?text=${encodeURIComponent(n)}&url=${encodeURIComponent(a)}`:e==="telegram"?r=`https://t.me/share/url?url=${encodeURIComponent(a)}&text=${encodeURIComponent(n)}`:e==="whatsapp"&&(r=`https://wa.me/?text=${encodeURIComponent(n+a)}`),r&&window.open(r,"_blank","width=600,height=400")}function og(){const e=E.currentCampaign;e&&navigator.clipboard.writeText(Bd(e.id)).then(()=>x("Link copied!","success")).catch(()=>x("Copy failed","error"))}function Od(){Ib(),E.currentCampaign=null,E.currentView="main",De()}function lg(e){gt("my"),gt("donate"),gt("edit"),Cb(e),Vt(e)}function cg(e){E.selectedCategory=E.selectedCategory===e?null:e,xo()}function dg(){E.selectedCategory=null,xo()}function xo(){const e=document.getElementById("cp-grid");if(!e)return;let t=E.campaigns.filter(a=>po(a));E.selectedCategory&&(t=t.filter(a=>a.category===E.selectedCategory)),t.sort((a,n)=>Number(n.createdAt||0)-Number(a.createdAt||0)),e.innerHTML=t.length?t.map(a=>Fd(a)).join(""):_d("No campaigns")}async function Vt(e){E.currentView="detail",E.isLoading=!0;const t=ei();t&&(t.innerHTML=Nb());try{let a=E.campaigns.find(n=>n.id===e||n.id===String(e));if(!a){const n=c==null?void 0:c.publicProvider;if(n){const i=await new Yt.Contract(v.charityPool,mo,n).getCampaign(e),s=Ld(e);a={id:String(e),creator:i.creator||i[0],title:i.title||i[1]||`Campaign #${e}`,description:i.description||i[2]||"",goalAmount:BigInt((i.goalAmount||i[3]).toString()),raisedAmount:BigInt((i.raisedAmount||i[4]).toString()),donationCount:Number(i.donationCount||i[5]),deadline:Number(i.deadline||i[6]),createdAt:Number(i.createdAt||i[7]),status:Number(i.status||i[10]),category:(s==null?void 0:s.category)||"humanitarian",imageUrl:(s==null?void 0:s.imageUrl)||null}}}E.currentCampaign=a,t&&(t.innerHTML=bl(a))}catch{t&&(t.innerHTML=bl(null))}finally{E.isLoading=!1}}function ei(){let e=document.getElementById("charity-container");if(e)return e;const t=document.getElementById("charity");return t?(e=document.createElement("div"),e.id="charity-container",t.innerHTML="",t.appendChild(e),e):null}function De(){Tb();const e=ei();if(!e)return;if(E.currentView==="create"){e.innerHTML=$b(),Ga();return}const t=Nd();t?Vt(t):(E.currentView="main",E.currentCampaign=null,e.innerHTML=fl(),Tt().then(()=>{if(E.currentView==="main"){const a=ei();a&&(a.innerHTML=fl())}}))}async function ug(){E.campaigns=[],E.stats=null,E.currentView==="detail"&&E.currentCampaign?await Vt(E.currentCampaign.id):De()}window.addEventListener("hashchange",()=>{var e;if(window.location.hash.startsWith("#charity")){const t=Nd();t?((e=E.currentCampaign)==null?void 0:e.id)!==t&&Vt(t):E.currentView!=="main"&&Od()}});const Hd={render(e){e&&De()},update(){E.currentView==="main"&&xo()},refresh:ug,openModal:pr,closeModal:gt,openCreate:Vb,openDonate:qb,openMyCampaigns:Xb,openEdit:Jb,create:eg,donate:tg,donateDetail:ag,cancel:ng,withdraw:rg,saveEdit:ig,selCatOpt:Zb,setAmt:Qb,goBack:Od,viewCampaign:lg,selectCat:cg,clearCat:dg,share:sg,copyLink:og,handleImageSelect:Pb,removeImage:zb,switchImageTab:Bb,wizardSelectCategory:Db,wizardNext:Ob,wizardBack:Hb,wizardSkipImage:Ub,cancelCreate:Dd,wizardUpdateCharCount:Wb,handleWizardImageSelect:Gb,removeWizardImage:Kb,wizardLaunch:Yb};window.CharityPage=Hd;const Ka=window.ethers,Ud="https://sepolia.arbiscan.io/address/",pg=Pl,xt=500;function jd(){return v.agora||v.backchat||v.Backchat||null}function it(){return v.operator||v.treasury||null}const g={view:"feed",activeTab:"feed",viewHistory:[],posts:[],trendingPosts:[],allItems:[],replies:new Map,likesMap:new Map,replyCountMap:new Map,repostCountMap:new Map,postsById:new Map,userProfile:null,profiles:new Map,hasProfile:null,following:new Set,followers:new Set,followCounts:new Map,pendingImage:null,pendingImagePreview:null,isUploadingImage:!1,selectedPost:null,selectedProfile:null,wizStep:1,wizUsername:"",wizDisplayName:"",wizBio:"",wizUsernameOk:null,wizFee:null,wizChecking:!1,fees:{post:0n,reply:0n,like:0n,follow:0n,repost:0n,superLikeMin:0n,boostMin:0n,badge:0n},pendingEth:0n,hasBadge:!1,isBoosted:!1,boostExpiry:0,badgeExpiry:0,referralStats:null,referredBy:null,isLoading:!1,isPosting:!1,contractAvailable:!0,error:null};function mg(){if(document.getElementById("backchat-styles-v70"))return;const e=document.getElementById("backchat-styles-v69");e&&e.remove();const t=document.createElement("style");t.id="backchat-styles-v70",t.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(t)}function La(e){return e?`${e.slice(0,6)}...${e.slice(-4)}`:""}function fg(e){const a=Date.now()/1e3-e;return a<60?"now":a<3600?`${Math.floor(a/60)}m`:a<86400?`${Math.floor(a/3600)}h`:a<604800?`${Math.floor(a/86400)}d`:new Date(e*1e3).toLocaleDateString("en-US",{month:"short",day:"numeric"})}function yt(e){if(!e||e===0n)return"0";const t=parseFloat(Ka.formatEther(e));return t<1e-4?"<0.0001":t<.01?t.toFixed(4):t<1?t.toFixed(3):t.toFixed(2)}function mr(e){return e?e.slice(2,4).toUpperCase():"?"}function Fe(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}function Ia(e){if(!e)return"?";const t=g.profiles.get(e.toLowerCase());return t!=null&&t.displayName?t.displayName:t!=null&&t.username?`@${t.username}`:La(e)}function bg(e){if(!e)return null;const t=g.profiles.get(e.toLowerCase());return(t==null?void 0:t.username)||null}function gg(e){var t;return(e==null?void 0:e.toLowerCase())===((t=c.userAddress)==null?void 0:t.toLowerCase())?g.isBoosted:!1}function xg(e){var t;return(e==null?void 0:e.toLowerCase())===((t=c.userAddress)==null?void 0:t.toLowerCase())?g.hasBadge:!1}function nn(e,t){g.viewHistory.push({view:g.view,activeTab:g.activeTab,selectedPost:g.selectedPost,selectedProfile:g.selectedProfile}),g.view=e,t!=null&&t.post&&(g.selectedPost=t.post),t!=null&&t.profile&&(g.selectedProfile=t.profile),ft()}function hg(){if(g.viewHistory.length>0){const e=g.viewHistory.pop();g.view=e.view,g.activeTab=e.activeTab||g.view,g.selectedPost=e.selectedPost,g.selectedProfile=e.selectedProfile}else g.view="feed",g.activeTab="feed";ft()}function fr(){if(c.agoraContract)return c.agoraContract;if(c.agoraContractPublic)return c.agoraContractPublic;const e=jd();return e?c.publicProvider?new Ka.Contract(e,la,c.publicProvider):null:(console.warn("Agora/Backchat address not found in deployment-addresses.json"),null)}async function gl(){try{const e=fr();if(!e)return;let t=100000000n;try{t=await e.VOTE_PRICE()}catch{}const a=window.ethers.parseEther("0.0001");g.fees={post:a,reply:a,like:a,follow:a,repost:a,superLikeMin:t,boostMin:window.ethers.parseEther("0.0005"),badge:window.ethers.parseEther("0.001")}}catch(e){console.warn("Failed to load fees:",e.message)}}async function xl(){if(!(!c.isConnected||!c.userAddress))try{const e=fr();if(!e)return;const[t,a,n]=await Promise.all([e.getUserProfile(c.userAddress).catch(()=>null),e.hasTrustBadge(c.userAddress).catch(()=>!1),e.isProfileBoosted(c.userAddress).catch(()=>!1)]);g.pendingEth=0n,g.hasBadge=a,g.isBoosted=n,g.boostExpiry=t?Number(t.boostExp||t[5]||0):0,g.badgeExpiry=t?Number(t.badgeExp||t[6]||0):0,g.referredBy=null,g.referralStats={totalReferred:0,totalEarned:0n,totalEarnedFormatted:"0.0"}}catch(e){console.warn("Failed to load user status:",e.message)}}async function hl(){try{const e=fr();if(!e){g.hasProfile=!1;return}const t=await e.queryFilter(e.filters.ProfileCreated(),-5e4).catch(()=>[]);for(const a of t){const n=a.args.user.toLowerCase();g.profiles.set(n,{username:a.args.username,metadataURI:a.args.metadataURI||""})}if(c.isConnected&&c.userAddress){const a=c.userAddress.toLowerCase();let n=g.profiles.get(a);if(!n)try{const r=await e.getUserProfile(c.userAddress);r&&r.usernameHash&&r.usernameHash!==Ka.ZeroHash&&(n={username:null,metadataURI:r.metadataURI||r[1]||""},g.profiles.set(a,n))}catch{}n?(g.userProfile={...n,address:c.userAddress},g.hasProfile=!0):(g.hasProfile=!1,g.userProfile=null)}else g.hasProfile=!1;console.log("[Backchat] Profiles loaded:",g.profiles.size,"| hasProfile:",g.hasProfile)}catch(e){console.warn("Failed to load profiles:",e.message),g.hasProfile=!1}oe()}async function vl(){g.following=new Set,g.followers=new Set,g.followCounts=new Map}async function ia(){var e,t;g.isLoading=!0,oe();try{if(!jd()){g.contractAvailable=!1,g.error="Backchat contract not deployed yet.";return}const n=fr();if(!n){g.contractAvailable=!1,g.error="Could not connect to Backchat contract";return}g.contractAvailable=!0;const[r,i,s]=await Promise.all([n.queryFilter(n.filters.PostCreated(),-5e4).catch(()=>[]),n.queryFilter(n.filters.ReplyCreated(),-5e4).catch(()=>[]),n.queryFilter(n.filters.RepostCreated(),-5e4).catch(()=>[])]),o=[];for(const u of r.slice(-80))o.push({ev:u,type:"post"});for(const u of i.slice(-60))o.push({ev:u,type:"reply"});for(const u of s.slice(-30))o.push({ev:u,type:"repost"});const l=[],d=[];g.postsById=new Map,g.replies=new Map,g.replyCountMap=new Map,g.repostCountMap=new Map,g.likesMap=new Map;for(let u=0;u<o.length;u+=10){const m=o.slice(u,u+10),p=await Promise.all(m.map(({ev:b})=>{const f=b.args.postId||b.args.newPostId;return n.getPost(f).catch(()=>null)}));for(let b=0;b<m.length;b++){const{ev:f,type:w}=m[b],k=p[b],C=(f.args.postId||f.args.newPostId).toString();if(k&&k.deleted)continue;const P=k?Number(k.createdAt||k[4]||0):0,S=k?Number(k.likes||k[7]||0):0,_=k?BigInt(k.superLikes||k[8]||0):0n,B=k?Number(k.replies||k[10]||0):0,I=k?Number(k.reposts||k[11]||0):0;if(w==="post"){const N={id:C,type:"post",author:f.args.author,content:f.args.contentHash||f.args.content||"",tag:f.args.tag!=null?Number(f.args.tag):0,timestamp:P,superLikes:_,likesCount:S,repliesCount:B,repostsCount:I,txHash:f.transactionHash};l.push(N),d.push(N),g.postsById.set(C,N)}else if(w==="reply"){const N=f.args.parentId.toString(),F={id:C,type:"reply",parentId:N,author:f.args.author,content:f.args.contentHash||f.args.content||"",tag:f.args.tag!=null?Number(f.args.tag):0,timestamp:P,superLikes:_,likesCount:S,txHash:f.transactionHash};l.push(F),g.postsById.set(C,F),g.replies.has(N)||g.replies.set(N,[]),g.replies.get(N).push(F),g.replyCountMap.set(N,(g.replyCountMap.get(N)||0)+1)}else if(w==="repost"){const N=((e=f.args.originalId)==null?void 0:e.toString())||((t=f.args.originalPostId)==null?void 0:t.toString())||"0",F={id:C,type:"repost",originalPostId:N,author:f.args.author||f.args.reposter,timestamp:P,superLikes:0n,txHash:f.transactionHash};l.push(F),d.push(F),g.postsById.set(C,F),g.repostCountMap.set(N,(g.repostCountMap.get(N)||0)+1)}}}if(c.isConnected&&c.userAddress){const u=l.filter(m=>m.type!=="repost").map(m=>m.id);for(let m=0;m<u.length;m+=10){const p=u.slice(m,m+10),b=await Promise.all(p.map(f=>n.hasLiked(f,c.userAddress).catch(()=>!1)));for(let f=0;f<p.length;f++)b[f]&&(g.likesMap.has(p[f])||g.likesMap.set(p[f],new Set),g.likesMap.get(p[f]).add(c.userAddress.toLowerCase()))}}d.sort((u,m)=>m.timestamp-u.timestamp),g.posts=d,g.allItems=l,g.trendingPosts=[...l].filter(u=>u.type!=="repost"&&u.superLikes>0n).sort((u,m)=>{const p=BigInt(u.superLikes||0),b=BigInt(m.superLikes||0);return b>p?1:b<p?-1:0})}catch(a){console.error("Failed to load posts:",a),g.error=a.message}finally{g.isLoading=!1,oe()}}async function vg(){var i;const e=document.getElementById("bc-compose-input"),t=(i=e==null?void 0:e.value)==null?void 0:i.trim();if(!t){x("Please write something","error");return}if(t.length>xt){x(`Post too long (max ${xt} chars)`,"error");return}g.isPosting=!0,oe();let a="";if(g.pendingImage)try{g.isUploadingImage=!0,oe(),a=(await Ng(g.pendingImage)).ipfsHash||""}catch(s){x("Image upload failed: "+s.message,"error"),g.isPosting=!1,g.isUploadingImage=!1,oe();return}finally{g.isUploadingImage=!1}const n=t,r=document.getElementById("bc-post-btn");await ge.createPost({content:n,mediaCID:a,operator:it(),button:r,onSuccess:async()=>{e&&(e.value=""),g.pendingImage=null,g.pendingImagePreview=null,g.isPosting=!1,x("Post created!","success"),await ia()},onError:s=>{g.isPosting=!1,oe()}}),g.isPosting=!1,oe()}async function wg(e){var r;const t=document.getElementById("bc-reply-input"),a=(r=t==null?void 0:t.value)==null?void 0:r.trim();if(!a){x("Please write a reply","error");return}const n=document.getElementById("bc-reply-btn");await ge.createReply({parentId:e,content:a,mediaCID:"",tipBkc:0,operator:it(),button:n,onSuccess:async()=>{t&&(t.value=""),x("Reply posted!","success"),await ia(),oe()}})}async function yg(e){const t=document.getElementById("bc-repost-confirm-btn");await ge.createRepost({originalPostId:e,tipBkc:0,operator:it(),button:t,onSuccess:async()=>{Ct("repost"),x("Reposted!","success"),await ia()}})}async function kg(e){var a;const t=(a=c.userAddress)==null?void 0:a.toLowerCase();t&&(g.likesMap.has(e)||g.likesMap.set(e,new Set),g.likesMap.get(e).add(t),oe()),await ge.like({postId:e,tipBkc:0,operator:it(),onSuccess:()=>{x("Liked!","success")},onError:()=>{var n;(n=g.likesMap.get(e))==null||n.delete(t),oe()}})}async function Eg(e,t){const a=Ka.parseEther(t);await ge.superLike({postId:e,ethAmount:a,tipBkc:0,operator:it(),onSuccess:async()=>{x("Super Liked!","success"),await ia()}})}async function Tg(e){await ge.follow({toFollow:e,tipBkc:0,operator:it(),onSuccess:()=>{g.following.add(e.toLowerCase()),x("Followed!","success"),oe()}})}async function Cg(e){await ge.unfollow({toUnfollow:e,onSuccess:()=>{g.following.delete(e.toLowerCase()),x("Unfollowed","success"),oe()}})}async function Ig(){x("Withdraw not available in V9","warning")}async function Ag(){const e=document.getElementById("bc-wizard-confirm-btn");await ge.createProfile({username:g.wizUsername,displayName:g.wizDisplayName,bio:g.wizBio,operator:it(),button:e,onSuccess:async()=>{x("Profile created!","success"),g.hasProfile=!0,g.userProfile={username:g.wizUsername,displayName:g.wizDisplayName,bio:g.wizBio,address:c.userAddress},g.profiles.set(c.userAddress.toLowerCase(),{username:g.wizUsername,displayName:g.wizDisplayName,bio:g.wizBio}),g.wizStep=1,g.wizUsername="",g.wizDisplayName="",g.wizBio="",g.view="profile",g.activeTab="profile",ft()}})}async function Pg(){var n,r,i,s;const e=((r=(n=document.getElementById("edit-displayname"))==null?void 0:n.value)==null?void 0:r.trim())||"",t=((s=(i=document.getElementById("edit-bio"))==null?void 0:i.value)==null?void 0:s.trim())||"",a=document.getElementById("bc-edit-profile-btn");await ge.updateProfile({displayName:e,bio:t,button:a,onSuccess:()=>{g.userProfile.displayName=e,g.userProfile.bio=t,g.profiles.set(c.userAddress.toLowerCase(),{...g.profiles.get(c.userAddress.toLowerCase()),displayName:e,bio:t}),Ct("edit-profile"),x("Profile updated!","success"),oe()}})}async function zg(){await ge.obtainBadge({operator:it(),onSuccess:()=>{g.hasBadge=!0,Ct("badge"),x("Badge obtained!","success"),oe()}})}async function Bg(e){const t=Ka.parseEther(e);await ge.boostProfile({ethAmount:t,operator:it(),onSuccess:()=>{g.isBoosted=!0,Ct("boost"),x("Profile boosted!","success"),oe()}})}async function Ng(e){const t=new FormData;t.append("image",e);const a=new AbortController,n=setTimeout(()=>a.abort(),6e4);try{const r=await fetch("/api/upload-image",{method:"POST",body:t,signal:a.signal});if(clearTimeout(n),!r.ok){const i=await r.json().catch(()=>({}));throw new Error(i.error||`Upload failed (${r.status})`)}return await r.json()}catch(r){throw clearTimeout(n),r}}function Sg(e){var n,r;const t=(r=(n=e.target)==null?void 0:n.files)==null?void 0:r[0];if(!t)return;if(t.size>5*1024*1024){x("Image too large. Maximum 5MB.","error");return}if(!["image/jpeg","image/png","image/gif","image/webp"].includes(t.type)){x("Invalid image type. Use JPG, PNG, GIF, or WebP.","error");return}g.pendingImage=t;const a=new FileReader;a.onload=i=>{g.pendingImagePreview=i.target.result,oe()},a.readAsDataURL(t)}function $g(){g.pendingImage=null,g.pendingImagePreview=null;const e=document.getElementById("bc-image-input");e&&(e.value=""),oe()}let wl=null;function Lg(e){g.wizUsername=e.toLowerCase().replace(/[^a-z0-9_]/g,""),g.wizUsernameOk=null,g.wizFee=null,clearTimeout(wl);const t=document.getElementById("wiz-username-input");t&&(t.value=g.wizUsername),g.wizUsername.length>=1&&g.wizUsername.length<=15?(g.wizChecking=!0,Sr(),wl=setTimeout(async()=>{try{const[a,n]=await Promise.all([ge.isUsernameAvailable(g.wizUsername),ge.getUsernameFee(g.wizUsername.length)]);g.wizUsernameOk=a,g.wizFee=n.formatted}catch(a){console.warn("Username check failed:",a)}g.wizChecking=!1,Sr()},600)):(g.wizChecking=!1,Sr())}function Sr(){const e=document.getElementById("wiz-username-status");e&&(g.wizChecking?e.innerHTML='<span class="bc-username-checking"><i class="fa-solid fa-spinner fa-spin"></i> Checking...</span>':g.wizUsernameOk===!0?e.innerHTML=`<span class="bc-username-ok"><i class="fa-solid fa-check"></i> Available</span>
                ${g.wizFee&&g.wizFee!=="0.0"?`<span class="bc-username-fee">${g.wizFee} ETH</span>`:'<span class="bc-username-fee">FREE</span>'}`:g.wizUsernameOk===!1?e.innerHTML='<span class="bc-username-taken"><i class="fa-solid fa-xmark"></i> Taken</span>':e.innerHTML="");const t=document.querySelector(".bc-wizard-nav .bc-btn-primary");t&&g.wizStep===1&&(t.disabled=!g.wizUsernameOk)}function Rg(){if(["post-detail","user-profile","profile-setup"].includes(g.view)){let t="Post";return g.view==="user-profile"&&(t=Ia(g.selectedProfile)),g.view==="profile-setup"&&(t="Create Profile"),`
            <div class="bc-header">
            ...
            <div class="bc-header-bar">
                ...
                <div class="bc-header-right">
                    ${c.isConnected&&g.pendingEth>0n?`
                        <button class="bc-icon-btn earnings-btn" onclick="BackchatPage.openEarnings()" title="Earnings: ${yt(g.pendingEth)} ETH">
                            <i class="fa-solid fa-coins"></i>
                        </button>
                    `:""}
    ...
    `}function yl(){var a;if(!c.isConnected)return"";const e=yt(g.fees.post);return`
        ...
        <div class="bc-compose">
            <div class="bc-compose-row">
                <div class="bc-compose-avatar">
                    ${(a=g.userProfile)!=null&&a.username?g.userProfile.username.charAt(0).toUpperCase():mr(c.userAddress)}
                </div>
    ...
    `}function Wt(e,t=0,a={}){var b,f,w,k;if(e.type==="repost"&&!a.isRepostContent){const C=g.postsById.get(e.originalPostId);return`
            <div class="bc-post" data-post-id="${e.id}" style="animation-delay:${Math.min(t*.04,.4)}s">
                <div class="bc-repost-banner">
                    <i class="fa-solid fa-retweet"></i>
                    <span>${Ia(e.author)} reposted</span>
                </div>
        ...
        <div class="bc-post" data-post-id="${e.id}" ${p} onclick="BackchatPage.viewPost('${e.id}')">
            <div class="bc-post-top">
                <div class="bc-avatar ${i?"boosted":""}" onclick="event.stopPropagation(); BackchatPage.viewProfile('${e.author}')">
                    ${r?r.charAt(0).toUpperCase():mr(e.author)}
                </div>
                <div class="bc-post-head">
                    <div class="bc-post-author-row">
                        ...
                        <span class="bc-post-time">&middot; ${fg(e.timestamp)}</span>
                        ${e.superLikes>0n?`<span class="bc-trending-tag"><i class="fa-solid fa-bolt"></i> ${o}</span>`:""}
                    </div>
                    ${e.type==="reply"?`<div class="bc-post-context">Replying to ${Ia((k=g.postsById.get(e.parentId))==null?void 0:k.author)}</div>`:""}
                </div>
            </div>
            ...
            ${e.mediaCID?`
                <div class="bc-post-media">
                    <img src="${pg}${e.mediaCID}" alt="Media" loading="lazy" onerror="this.style.display='none'">
                </div>
            `:""}
    ...
    `}function kl(){return g.contractAvailable?g.isLoading?`
        ...
        `}function _g(){return g.trendingPosts.length===0?`
            <div class="bc-empty">
                <div class="bc-empty-glyph accent">
                    <i class="fa-solid fa-fire"></i>
                </div>
        ...
        ${g.trendingPosts.map((e,t)=>Wt(e,t)).join("")}
    `}function Fg(){var s,o,l,d,u,m;if(!c.isConnected)return`
            <div class="bc-empty">
        ...
        `;const e=(s=c.userAddress)==null?void 0:s.toLowerCase(),t=g.allItems.filter(p=>{var b;return((b=p.author)==null?void 0:b.toLowerCase())===e&&p.type!=="repost"}),a=g.followers.size,n=g.following.size,r=((o=g.userProfile)==null?void 0:o.displayName)||((l=g.userProfile)==null?void 0:l.username)||La(c.userAddress),i=(d=g.userProfile)!=null&&d.username?g.userProfile.username.charAt(0).toUpperCase():mr(c.userAddress);return`
        <div class="bc-profile-section">
            <div class="bc-profile-banner"></div>
            <div class="bc-profile-main">
                <div class="bc-profile-top-row">
                    <div class="bc-profile-pic ${g.isBoosted?"boosted":""}">${i}</div>
                ...
                <div class="bc-profile-name-row">
                    <span class="bc-profile-name">${Fe(r)}</span>
                ...
                <div class="bc-profile-handle">
                    <a href="${Ud}${c.userAddress}" target="_blank" rel="noopener">
                ...
                <div class="bc-profile-stats">
                    ...
                    <div class="bc-stat-cell">
                        <div class="bc-stat-value">${yt(g.pendingEth)}</div>
            ...
            ${g.pendingEth>0n?`
                <div class="bc-earnings-card">
                    ...
                    <div class="bc-earnings-value">${yt(g.pendingEth)} <small>ETH</small></div>
            ...
            ${t.length===0?'<div class="bc-empty" style="padding:40px 20px;"><div class="bc-empty-text">No posts yet — share your first thought!</div></div>':t.map((p,b)=>Wt(p,b)).join("")}
        </div>
    `}function Mg(){var n,r;if(!c.isConnected)return"";const e=`${window.location.origin}/#backchat?ref=${c.userAddress}`,t=((n=g.referralStats)==null?void 0:n.totalReferred)||0,a=((r=g.referralStats)==null?void 0:r.totalEarnedFormatted)||"0.0";return`
        <div class="bc-referral-card">
            ...
            <div class="bc-referral-info" style="margin-top:12px;">
                ...
                ${g.referredBy?`<br>You were referred by <code style="font-size:11px;color:var(--bc-accent);">${La(g.referredBy)}</code>`:""}
            </div>
        </div>
    `}function oe(){const e=document.getElementById("backchat-content");if(!e)return;let t="";switch(g.view){case"feed":t=yl()+kl();break;case"trending":t=_g();break;case"profile":t=!g.hasProfile&&c.isConnected?El():Fg();break;case"post-detail":t=Dg();break;case"user-profile":t=Og();break;case"profile-setup":t=El();break;default:t=yl()+kl()}e.innerHTML=t}function Dg(){const e=g.selectedPost?g.postsById.get(g.selectedPost):null;if(!e)return'<div class="bc-empty"><div class="bc-empty-title">Post not found</div></div>';const t=g.replies.get(e.id)||[];t.sort((n,r)=>n.timestamp-r.timestamp);const a=Ia(e.author);return`
        ...
        ${c.isConnected?`
            <div class="bc-reply-compose">
                ...
                <div style="font-size:11px;color:var(--bc-text-3);margin-top:6px;">Fee: ${yt(g.fees.reply)} ETH</div>
            </div>
        `:""}
    `}function Og(){var m;const e=g.selectedProfile;if(!e)return'<div class="bc-empty"><div class="bc-empty-title">User not found</div></div>';const t=e.toLowerCase(),a=g.profiles.get(t),n=(a==null?void 0:a.displayName)||(a==null?void 0:a.username)||La(e),r=a==null?void 0:a.username,i=a==null?void 0:a.bio,s=r?r.charAt(0).toUpperCase():mr(e),o=t===((m=c.userAddress)==null?void 0:m.toLowerCase()),l=g.following.has(t),d=g.followCounts.get(t)||{followers:0,following:0},u=g.allItems.filter(p=>{var b;return((b=p.author)==null?void 0:b.toLowerCase())===t&&p.type!=="repost"});return`
        <div class="bc-profile-section">
            <div class="bc-profile-banner"></div>
            <div class="bc-profile-main">
                <div class="bc-profile-top-row">
                ...
                <div class="bc-profile-name-row">
                    <span class="bc-profile-name">${Fe(n)}</span>
                </div>
                ${r?`<div class="bc-profile-username">@${r}</div>`:""}
                ${i?`<div class="bc-profile-bio">${Fe(i)}</div>`:""}

                <div class="bc-profile-handle">
                    <a href="${Ud}${e}" target="_blank" rel="noopener">
                        ${La(e)} <i class="fa-solid fa-arrow-up-right-from-square"></i>
                    </a>
                </div>
            ...
            ${u.length===0?'<div class="bc-empty" style="padding:40px 20px;"><div class="bc-empty-text">No posts yet</div></div>':u.sort((p,b)=>b.timestamp-p.timestamp).map((p,b)=>Wt(p,b)).join("")}
        </div>
    `}function El(){if(!c.isConnected)return`
            <div class="bc-empty">
                <div class="bc-empty-glyph"><i class="fa-solid fa-wallet"></i></div>
                <div class="bc-empty-title">Connect Wallet</div>
    ...
    `}function Hg(){var e,t;return`
            ...
            <div class="bc-modal-box">
                ...
                <div class="bc-modal-inner">
                    ...
                    <div class="bc-fee-row">
                        ...
                        <span class="bc-fee-val">${yt(g.fees.badge)} ETH</span>
                    </div>
        ...
        <div class="bc-modal-overlay" id="modal-repost">
            <div class="bc-modal-box">
                ...
                <div class="bc-modal-inner">
                    <p class="bc-modal-desc">Repost this to your followers? Fee: ${yt(g.fees.repost)} ETH</p>
    ...
    `}function ft(){mg();const e=document.getElementById("backchat");e&&(e.innerHTML=`
        <div class="bc-shell">
            ${Rg()}
            <div id="backchat-content"></div>
        </div>
        ${Hg()}
    `,oe())}let br=null;function Ug(e){var t;br=e,(t=document.getElementById("modal-superlike"))==null||t.classList.add("active")}async function jg(){var t;const e=((t=document.getElementById("superlike-amount"))==null?void 0:t.value)||"0.001";Ct("superlike"),await Eg(br,e)}function Wg(){var e;(e=document.getElementById("modal-badge"))==null||e.classList.add("active")}async function Gg(){Ct("badge"),await zg()}function Kg(){var e;(e=document.getElementById("modal-boost"))==null||e.classList.add("active")}async function Yg(){var t;const e=((t=document.getElementById("boost-amount"))==null?void 0:t.value)||"0.001";Ct("boost"),await Bg(e)}function Vg(e){var t;br=e,(t=document.getElementById("modal-repost"))==null||t.classList.add("active")}async function qg(){await yg(br)}function Xg(){var e;ft(),(e=document.getElementById("modal-edit-profile"))==null||e.classList.add("active")}async function Jg(){await Pg()}function Ct(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.remove("active")}function Zg(e){const t=document.getElementById("bc-char-counter");if(!t)return;const a=e.value.length;t.textContent=`${a}/${xt}`,t.className="bc-char-count",a>xt-50?t.classList.add("danger"):a>xt-150&&t.classList.add("warn")}const Wd={async render(e){e&&(ft(),await Promise.all([gl(),xl(),hl(),ia(),vl()]))},async refresh(){await Promise.all([gl(),xl(),hl(),ia(),vl()])},setTab(e){g.activeTab=e,g.view=e,ft()},goBack:hg,viewPost(e){nn("post-detail",{post:e})},viewProfile(e){var t;(e==null?void 0:e.toLowerCase())===((t=c.userAddress)==null?void 0:t.toLowerCase())?(g.activeTab="profile",g.view="profile",ft()):nn("user-profile",{profile:e})},openReply(e){nn("post-detail",{post:e})},openProfileSetup(){g.wizStep=1,g.wizUsername="",g.wizDisplayName="",g.wizBio="",g.wizUsernameOk=null,g.wizFee=null,nn("profile-setup")},createPost:vg,submitReply:wg,like:kg,follow:Tg,unfollow:Cg,withdraw:Ig,openSuperLike:Ug,confirmSuperLike:jg,openRepostConfirm:Vg,confirmRepost:qg,openBadge:Wg,confirmBadge:Gg,openBoost:Kg,confirmBoost:Yg,openEditProfile:Xg,confirmEditProfile:Jg,closeModal:Ct,openEarnings(){g.activeTab="profile",g.view="profile",ft()},handleImageSelect:Sg,removeImage:$g,onWizUsernameInput:Lg,wizNext(){var e,t,a,n;g.wizStep===1&&!g.wizUsernameOk||(g.wizStep===1?g.wizStep=2:g.wizStep===2&&(g.wizDisplayName=((t=(e=document.getElementById("wiz-displayname-input"))==null?void 0:e.value)==null?void 0:t.trim())||"",g.wizBio=((n=(a=document.getElementById("wiz-bio-input"))==null?void 0:a.value)==null?void 0:n.trim())||"",g.wizStep=3),oe())},wizBack(){var e,t,a,n;g.wizStep>1&&(g.wizStep===2&&(g.wizDisplayName=((t=(e=document.getElementById("wiz-displayname-input"))==null?void 0:e.value)==null?void 0:t.trim())||"",g.wizBio=((n=(a=document.getElementById("wiz-bio-input"))==null?void 0:a.value)==null?void 0:n.trim())||""),g.wizStep--,oe())},wizConfirm:Ag,_wizSave(){},_updateCharCount:Zg,copyReferralLink(){const e=`${window.location.origin}/#backchat?ref=${c.userAddress}`;navigator.clipboard.writeText(e).then(()=>x("Referral link copied!","success"),()=>x("Failed to copy","error"))},shareReferral(){const e=`${window.location.origin}/#backchat?ref=${c.userAddress}`,t="Join Backchat — earn crypto by posting, liking, and referring friends! 30% referral rewards.";navigator.share?navigator.share({title:"Backchat Referral",text:t,url:e}).catch(()=>{}):navigator.clipboard.writeText(`${t}
${e}`).then(()=>x("Referral message copied!","success"),()=>x("Failed to copy","error"))}};window.BackchatPage=Wd;const Qg=window.inject||(()=>{console.warn("Dev Mode: Analytics disabled.")});if(window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1")try{Qg()}catch(e){console.error("Analytics Error:",e)}const ho="".toLowerCase();window.__ADMIN_WALLET__=ho;ho&&console.log("✅ Admin access granted");let Ft=null,xa=null,$r=!1;const fe={dashboard:Hr,mine:Wr,store:Im,rewards:Wr,actions:rf,charity:Hd,backchat:Wd,notary:bd,airdrop:Df,tokenomics:T0,about:gf,admin:p0,rental:yd,socials:hb,creditcard:vb,dex:W,dao:wb,tutorials:Td};function Gd(e){return!e||e.length<42?"...":`${e.slice(0,6)}...${e.slice(-4)}`}function ex(e){if(!e)return"0.00";const t=D(e);return t>=1e9?(t/1e9).toFixed(2)+"B":t>=1e6?(t/1e6).toFixed(2)+"M":t>=1e4?t.toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):t.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function ba(e,t=!1){const a=document.querySelector("main > div.container"),n=document.querySelectorAll(".sidebar-link");if(!a){console.error("❌ Page container not found");return}e==="rewards"&&(e="mine",window.location.hash="mine");const r=window.location.hash.includes("/");if(!(Ft!==e||t||r)){fe[e]&&typeof fe[e].update=="function"&&fe[e].update(c.isConnected);return}console.log(`📍 Navigating: ${Ft} → ${e} (force: ${t})`),xa&&typeof xa=="function"&&(xa(),xa=null),Array.from(a.children).forEach(l=>{l.tagName==="SECTION"&&(l.classList.add("hidden"),l.classList.remove("active"))});const s=document.getElementById("charity-container");s&&e!=="charity"&&(s.innerHTML=""),n.forEach(l=>{l.classList.remove("active"),l.classList.add("text-zinc-400","hover:text-white","hover:bg-zinc-700")});const o=document.getElementById(e);if(o&&fe[e]){o.classList.remove("hidden"),o.classList.add("active");const l=Ft!==e;Ft=e;const d=document.querySelector(`.sidebar-link[data-target="${e}"]`);d&&(d.classList.remove("text-zinc-400","hover:text-white","hover:bg-zinc-700"),d.classList.add("active")),fe[e]&&typeof fe[e].render=="function"&&fe[e].render(l||t),typeof fe[e].cleanup=="function"&&(xa=fe[e].cleanup),l&&window.scrollTo(0,0)}else e!=="dashboard"&&e!=="faucet"&&(console.warn(`Route '${e}' not found, redirecting to dashboard.`),ba("dashboard",!0))}window.navigateTo=ba;const Tl="wallet-btn text-xs font-mono text-center max-w-fit whitespace-nowrap relative font-bold py-2 px-4 rounded-md transition-colors";function vo(e=!1){$r||($r=!0,requestAnimationFrame(()=>{tx(e),$r=!1}))}function tx(e){const t=document.getElementById("admin-link-container"),a=document.getElementById("statUserBalance"),n=document.getElementById("connectButtonDesktop"),r=document.getElementById("connectButtonMobile"),i=document.getElementById("mobileAppDisplay");let s=c.userAddress;const o=[n,r];if(c.isConnected&&s){const d=ex(c.currentUserBalance),m=`
            <div class="status-dot"></div>
            <span>${Gd(s)}</span>
            <div class="balance-pill">
                ${d} BKC
            </div>
        `;if(o.forEach(p=>{p&&(p.innerHTML=m,p.className=Tl+" wallet-btn-connected")}),i&&(i.textContent="Backcoin.org",i.classList.add("text-white"),i.classList.remove("text-amber-400")),t){const p=s.toLowerCase()===ho;t.style.display=p?"block":"none"}a&&(a.textContent=d)}else{const d='<i class="fa-solid fa-plug"></i> Connect Wallet';o.forEach(u=>{u&&(u.innerHTML=d,u.className=Tl+" wallet-btn-disconnected")}),i&&(i.textContent="Backcoin.org",i.classList.add("text-amber-400"),i.classList.remove("text-white")),t&&(t.style.display="none"),a&&(a.textContent="--")}const l=Ft||"dashboard";e||!Ft?ba(l,!0):fe[l]&&typeof fe[l].update=="function"&&fe[l].update(c.isConnected)}function ax(e){const{isConnected:t,address:a,isNewConnection:n,wasConnected:r}=e,i=n||t!==r;c.isConnected=t,a&&(c.userAddress=a),vo(i),t&&n?x(`Connected: ${Gd(a)}`,"success"):!t&&r&&x("Wallet disconnected.","info")}function nx(){const e=document.getElementById("testnet-banner"),t=document.getElementById("close-testnet-banner");if(!(!e||!t)){if(localStorage.getItem("hideTestnetBanner")==="true"){e.remove();return}e.style.transform="translateY(0)",t.addEventListener("click",()=>{e.style.transform="translateY(100%)",setTimeout(()=>e.remove(),500),localStorage.setItem("hideTestnetBanner","true")})}}function rx(){const e=document.querySelectorAll(".sidebar-link"),t=document.getElementById("menu-btn"),a=document.getElementById("sidebar"),n=document.getElementById("sidebar-backdrop"),r=document.getElementById("connectButtonDesktop"),i=document.getElementById("connectButtonMobile"),s=document.getElementById("shareProjectBtn");nx(),e.length>0&&e.forEach(l=>{l.addEventListener("click",async d=>{d.preventDefault();const u=l.dataset.target;if(u==="faucet"){x("Accessing Testnet Faucet...","info"),await On("BKC")&&vo(!0);return}u&&(window.location.hash=u,ba(u,!0),a&&a.classList.contains("translate-x-0")&&(a.classList.remove("translate-x-0"),a.classList.add("-translate-x-full"),n&&n.classList.add("hidden")))})});const o=()=>{nc()};r&&r.addEventListener("click",o),i&&i.addEventListener("click",o),s&&s.addEventListener("click",()=>ou(c.userAddress)),t&&a&&n&&(t.addEventListener("click",()=>{a.classList.contains("translate-x-0")?(a.classList.add("-translate-x-full"),a.classList.remove("translate-x-0"),n.classList.add("hidden")):(a.classList.remove("-translate-x-full"),a.classList.add("translate-x-0"),n.classList.remove("hidden"))}),n.addEventListener("click",()=>{a.classList.add("-translate-x-full"),a.classList.remove("translate-x-0"),n.classList.add("hidden")}))}function Kd(){const e=window.location.hash.replace("#","");if(!e)return"dashboard";const t=e.split(/[/?]/)[0];return fe[t]?t:"dashboard"}function Yd(){try{const e=window.location.hash,t=e.indexOf("?");if(t===-1)return;const n=new URLSearchParams(e.substring(t)).get("ref");n&&/^0x[a-fA-F0-9]{40}$/.test(n)&&(localStorage.getItem("backchain_referrer")||(localStorage.setItem("backchain_referrer",n),console.log("[Referral] Captured referrer from URL:",n)))}catch(e){console.warn("[Referral] Failed to parse referral param:",e.message)}}window.addEventListener("load",async()=>{console.log("🚀 App Initializing..."),Se.earn||(Se.earn=document.getElementById("mine"));try{if(!await zl())throw new Error("Failed to load contract addresses")}catch(a){console.error("❌ Critical Initialization Error:",a),x("Initialization failed. Please refresh.","error");return}rx(),await Xu(),Ju(ax),lu();const e=document.getElementById("preloader");e&&(e.style.display="none"),Yd();const t=Kd();console.log("📍 Initial page from URL:",t,"Hash:",window.location.hash),ba(t,!0),console.log("✅ App Ready.")});window.addEventListener("hashchange",()=>{Yd();const e=Kd(),t=window.location.hash;console.log("🔄 Hash changed to:",e,"Full hash:",t),e!==Ft?ba(e,!0):e==="charity"&&fe[e]&&typeof fe[e].render=="function"&&fe[e].render(!0)});window.StakingPage=Wr;window.openConnectModal=nc;window.disconnectWallet=Zu;window.updateUIState=vo;
