import{defaultConfig as Gc,createWeb3Modal as Kc}from"https://esm.sh/@web3modal/ethers@5.1.11?bundle";import{initializeApp as Yc}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-app.js";import{getAuth as Vc,onAuthStateChanged as qc,signInAnonymously as Xc}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-auth.js";import{getFirestore as Jc,collection as Xe,query as Et,where as Zn,orderBy as Yt,getDocs as it,doc as te,getDoc as Ae,limit as Zc,serverTimestamp as ot,writeBatch as fa,updateDoc as ba,increment as Me,setDoc as ga,Timestamp as wr,addDoc as Qc,deleteDoc as ed}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-firestore.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function n(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(s){if(s.ep)return;s.ep=!0;const r=n(s);fetch(s.href,r)}})();const Be={sidebar:document.getElementById("sidebar"),sidebarBackdrop:document.getElementById("sidebar-backdrop"),menuBtn:document.getElementById("menu-btn"),navLinks:document.getElementById("nav-links"),mainContentSections:document.querySelectorAll("main section"),connectButtonDesktop:document.getElementById("connectButtonDesktop"),connectButtonMobile:document.getElementById("connectButtonMobile"),mobileAppDisplay:document.getElementById("mobileAppDisplay"),desktopDisconnected:document.getElementById("desktopDisconnected"),desktopConnectedInfo:document.getElementById("desktopConnectedInfo"),desktopUserAddress:document.getElementById("desktopUserAddress"),desktopUserBalance:document.getElementById("desktopUserBalance"),modalContainer:document.getElementById("modal-container"),toastContainer:document.getElementById("toast-container"),dashboard:document.getElementById("dashboard"),earn:document.getElementById("mine"),store:document.getElementById("store"),rental:document.getElementById("rental"),rewards:document.getElementById("rewards"),actions:document.getElementById("actions"),presale:document.getElementById("presale"),faucet:document.getElementById("faucet"),airdrop:document.getElementById("airdrop"),dao:document.getElementById("dao"),about:document.getElementById("about"),admin:document.getElementById("admin"),tokenomics:document.getElementById("tokenomics"),notary:document.getElementById("notary"),statTotalSupply:document.getElementById("statTotalSupply"),statValidators:document.getElementById("statValidators"),statTotalPStake:document.getElementById("statTotalPStake"),statScarcity:document.getElementById("statScarcity"),statLockedPercentage:document.getElementById("statLockedPercentage"),statUserBalance:document.getElementById("statUserBalance"),statUserPStake:document.getElementById("statUserPStake"),statUserRewards:document.getElementById("statUserRewards")},td={provider:null,publicProvider:null,web3Provider:null,signer:null,userAddress:null,isConnected:!1,bkcTokenContract:null,delegationManagerContract:null,rewardBoosterContract:null,nftLiquidityPoolContract:null,actionsManagerContract:null,fortunePoolContract:null,faucetContract:null,decentralizedNotaryContract:null,ecosystemManagerContract:null,publicSaleContract:null,rentalManagerContract:null,bkcTokenContractPublic:null,delegationManagerContractPublic:null,faucetContractPublic:null,fortunePoolContractPublic:null,rentalManagerContractPublic:null,ecosystemManagerContractPublic:null,actionsManagerContractPublic:null,currentUserBalance:0n,currentUserNativeBalance:0n,userTotalPStake:0n,userDelegations:[],myBoosters:[],activityHistory:[],totalNetworkPStake:0n,allValidatorsData:[],systemFees:{},systemPStakes:{},boosterDiscounts:{},notaryFee:void 0,notaryMinPStake:void 0},nd={set(e,t,n){return e[t]=n,["currentUserBalance","isConnected","userTotalPStake","totalNetworkPStake"].includes(t)&&window.updateUIState&&window.updateUIState(),!0}},c=new Proxy(td,nd);let yr=!1;const x=(e,t="info",n=null)=>{if(!Be.toastContainer)return;const a={success:{icon:"fa-check-circle",color:"bg-green-600",border:"border-green-400"},error:{icon:"fa-exclamation-triangle",color:"bg-red-600",border:"border-red-400"},info:{icon:"fa-info-circle",color:"bg-blue-600",border:"border-blue-400"},warning:{icon:"fa-exclamation-circle",color:"bg-yellow-600",border:"border-yellow-400"}},s=a[t]||a.info,r=document.createElement("div");r.className=`flex items-center w-full max-w-xs p-4 text-white rounded-lg shadow-lg transition-all duration-500 ease-out 
    ...
    `;vn(n,"max-w-md")}const kr=e=>{window.navigateTo?window.navigateTo(e):console.error("navigateTo function not found."),we()};function rd(){var s,r,i,o,l,d;if(yr)return;yr=!0;const e="https://t.me/BackCoinorg",t="https://github.com/backcoin-org/backchain-dapp";vn(`
    ...
    `;e.innerHTML=s,e.querySelectorAll(".pagination-btn").forEach(r=>{r.addEventListener("click",()=>{r.hasAttribute("disabled")||a(parseInt(r.dataset.page))})})}const gu="modulepreload",xu=function(e){return"/"+e},_r={},Y=function(t,n,a){let s=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),o=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));s=Promise.allSettled(n.map(l=>{if(l=xu(l),l in _r)return;_r[l]=!0;const d=l.endsWith(".css"),p=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${p}`))return;const f=document.createElement("link");if(f.rel=d?"stylesheet":gu,d||(f.as="script"),f.crossOrigin="",f.href=l,o&&f.setAttribute("nonce",o),document.head.appendChild(f),d)return new Promise((m,b)=>{f.addEventListener("load",m),f.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${l}`)))})}))}function r(i){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=i,window.dispatchEvent(o),!o.defaultPrevented)throw i}return s.then(i=>{for(const o of i||[])o.status==="rejected"&&r(o.reason);return t().catch(r)})},ji="https://faucet-4wvdcuoouq-uc.a.run.app";function va(){var e;return(w==null?void 0:w.faucet)||(R==null?void 0:R.faucet)||((e=window.contractAddresses)==null?void 0:e.faucet)||null}const ea=["function claim() external","function canClaim(address user) view returns (bool)","function lastClaimTime(address user) view returns (uint256)","function claimCooldown() view returns (uint256)","function claimAmountBKC() view returns (uint256)","function claimAmountETH() view returns (uint256)","event TokensClaimed(address indexed user, uint256 bkcAmount, uint256 ethAmount)"];function hu(){var e,t;return typeof State<"u"&&(State!=null&&State.userAddress)?State.userAddress:(e=window.State)!=null&&e.userAddress?window.State.userAddress:window.userAddress?window.userAddress:(t=window.ethereum)!=null&&t.selectedAddress?window.ethereum.selectedAddress:null}function wt(e,t="info"){if(typeof window.showToast=="function"){window.showToast(e,t);return}(t==="error"?console.error:console.log)(`[Faucet] ${e}`)}async function Wi(){if(typeof window.loadUserData=="function"){await window.loadUserData();return}if(typeof window.refreshBalances=="function"){await window.refreshBalances();return}console.log("[Faucet] No refresh function available")}async function Ns({button:e=null,address:t=null,onSuccess:n=null,onError:a=null}={}){const s=t||hu();if(!s){const o="Please connect wallet first";return wt(o,"error"),a&&a(new Error(o)),{success:!1,error:o}}const r=(e==null?void 0:e.innerHTML)||"Claim",i=(e==null?void 0:e.disabled)||!1;e&&(e.innerHTML='<div class="loader inline-block"></div> Claiming...',e.disabled=!0);try{const o=await fetch(`${ji}?address=${s}`,{method:"GET",headers:{Accept:"application/json"}}),l=await o.json();if(o.ok&&l.success){wt("✅ Tokens received!","success"),await Wi();const d={success:!0,txHash:l.txHash,bkcAmount:l.bkcAmount,ethAmount:l.ethAmount};return n&&n(d),d}else{const d=l.error||l.message||"Faucet unavailable";wt(d,"error");const p=new Error(d);return a&&a(p),{success:!1,error:d}}}catch(o){return console.error("Faucet error:",o),wt("Faucet unavailable","error"),a&&a(o),{success:!1,error:o.message}}finally{e&&(e.innerHTML=r,e.disabled=i)}}const zs=async e=>await Ns({button:e});async function Gi({button:e=null,onSuccess:t=null,onError:n=null}={}){const a=va();if(!a){const r="Faucet contract address not configured";return wt(r,"error"),n&&n(new Error(r)),{success:!1,error:r}}const{txEngine:s}=await Y(async()=>{const{txEngine:r}=await import("./index-C63_LXPF.js");return{txEngine:r}},[]);return await s.execute({name:"FaucetClaim",button:e,getContract:async r=>{const i=window.ethers;return new i.Contract(a,ea,r)},method:"claim",args:[],validate:async(r,i)=>{const o=window.ethers,l=new o.Contract(a,ea,r);if(!await l.canClaim(i)){const p=await l.lastClaimTime(i),f=await l.claimCooldown(),m=Number(p)+Number(f),b=Math.floor(Date.now()/1e3);if(m>b){const u=Math.ceil((m-b)/60);throw new Error(`Please wait ${u} minutes before claiming again`)}}},onSuccess:async r=>{wt("✅ Tokens received!","success"),await Wi(),t&&t(r)},onError:r=>{wt(r.message||"Claim failed","error"),n&&n(r)}})}async function Ki(e){const t=va();if(!t)return{canClaim:!1,error:"Faucet not configured"};try{const n=window.ethers,{NetworkManager:a}=await Y(async()=>{const{NetworkManager:f}=await import("./index-C63_LXPF.js");return{NetworkManager:f}},[]),s=a.getProvider(),r=new n.Contract(t,ea,s),[i,o,l]=await Promise.all([r.canClaim(e),r.lastClaimTime(e),r.claimCooldown()]),d=Number(o)+Number(l),p=Math.floor(Date.now()/1e3);return{canClaim:i,lastClaimTime:Number(o),cooldownSeconds:Number(l),nextClaimTime:d,waitSeconds:i?0:Math.max(0,d-p)}}catch(n){return console.error("Error checking claim status:",n),{canClaim:!1,error:n.message}}}async function Yi(){const e=va();if(!e)return{error:"Faucet not configured"};try{const t=window.ethers,{NetworkManager:n}=await Y(async()=>{const{NetworkManager:l}=await import("./index-C63_LXPF.js");return{NetworkManager:l}},[]),a=n.getProvider(),s=new t.Contract(e,ea,a),[r,i,o]=await Promise.all([s.claimAmountBKC(),s.claimAmountETH(),s.claimCooldown()]);return{bkcAmount:r,ethAmount:i,cooldownSeconds:Number(o),cooldownMinutes:Number(o)/60,bkcAmountFormatted:t.formatEther(r),ethAmountFormatted:t.formatEther(i)}}catch(t){return console.error("Error getting faucet info:",t),{error:t.message}}}const vu={claim:Ns,claimOnChain:Gi,executeFaucetClaim:zs,canClaim:Ki,getFaucetInfo:Yi,getFaucetAddress:va,FAUCET_API_URL:ji},wu=Object.freeze(Object.defineProperty({__proto__:null,FaucetTx:vu,canClaim:Ki,claim:Ns,claimOnChain:Gi,executeFaucetClaim:zs,getFaucetInfo:Yi},Symbol.toStringTag,{value:"Module"})),Fa={BALANCE:1e4,ALLOWANCE:3e4},ve=new Map,re={hits:0,misses:0,sets:0,invalidations:0},Tt={get(e){const t=ve.get(e);if(!t){re.misses++;return}if(Date.now()>t.expiresAt){ve.delete(e),re.misses++;return}return re.hits++,t.value},set(e,t,n){t!=null&&(ve.set(e,{value:t,expiresAt:Date.now()+n,createdAt:Date.now()}),re.sets++)},delete(e){ve.delete(e)},clear(e){if(!e){ve.clear(),re.invalidations++;return}for(const t of ve.keys())t.includes(e)&&ve.delete(t);re.invalidations++},async getOrFetch(e,t,n){const a=this.get(e);if(a!==void 0)return a;try{const s=await t();return s!=null&&this.set(e,s,n),s}catch(s){throw console.warn(`[Cache] Error fetching ${e}:`,s.message),s}},has(e){return this.get(e)!==void 0},getTTL(e){const t=ve.get(e);if(!t)return 0;const n=t.expiresAt-Date.now();return n>0?n:0},invalidateByTx(e){const n={CreateCampaign:["campaign-","charity-stats","user-campaigns-","campaign-list"],Donate:["campaign-","charity-stats","token-balance-","allowance-"],CancelCampaign:["campaign-","charity-stats","user-campaigns-"],Withdraw:["campaign-","charity-stats","token-balance-"],Delegate:["delegation-","token-balance-","allowance-","user-pstake-","pending-rewards-","network-pstake"],Unstake:["delegation-","token-balance-","user-pstake-","pending-rewards-","network-pstake"],ForceUnstake:["delegation-","token-balance-","user-pstake-","pending-rewards-","network-pstake"],ClaimReward:["pending-rewards-","token-balance-","saved-rewards-"],BuyNFT:["pool-info-","pool-nfts-","token-balance-","allowance-","user-nfts-","buy-price-","sell-price-"],SellNFT:["pool-info-","pool-nfts-","token-balance-","user-nfts-","buy-price-","sell-price-"],PlayGame:["fortune-pool-","fortune-stats-","token-balance-","allowance-","user-fortune-history-"],ListNFT:["rental-listings-","rental-listing-","user-nfts-"],RentNFT:["rental-listing-","rental-active-","token-balance-","allowance-"],WithdrawNFT:["rental-listing-","rental-listings-","user-nfts-"],UpdateListing:["rental-listing-"],Notarize:["notary-","token-balance-","allowance-","user-documents-"],TokenTransfer:["token-balance-","allowance-"],Approval:["allowance-"]}[e];if(!n){console.warn(`[Cache] Unknown transaction type: ${e}`);return}n.forEach(a=>{this.clear(a)}),console.log(`[Cache] Invalidated patterns for ${e}:`,n)},getStats(){const e=ve.size,t=re.hits+re.misses>0?(re.hits/(re.hits+re.misses)*100).toFixed(1):0;return{entries:e,hits:re.hits,misses:re.misses,sets:re.sets,invalidations:re.invalidations,hitRate:`${t}%`}},keys(){return Array.from(ve.keys())},size(){return ve.size},cleanup(){const e=Date.now();let t=0;for(const[n,a]of ve.entries())e>a.expiresAt&&(ve.delete(n),t++);return t>0&&console.log(`[Cache] Cleanup removed ${t} expired entries`),t},resetMetrics(){re.hits=0,re.misses=0,re.sets=0,re.invalidations=0}},Ma={tokenBalance:(e,t)=>`token-balance-${e.toLowerCase()}-${t.toLowerCase()}`,ethBalance:e=>`eth-balance-${e.toLowerCase()}`,allowance:(e,t,n)=>`allowance-${e.toLowerCase()}-${t.toLowerCase()}-${n.toLowerCase()}`,campaign:e=>`campaign-${e}`,campaignList:()=>"campaign-list",charityStats:()=>"charity-stats",userCampaigns:e=>`user-campaigns-${e.toLowerCase()}`,delegation:(e,t)=>`delegation-${e.toLowerCase()}-${t}`,delegations:e=>`delegation-list-${e.toLowerCase()}`,userPStake:e=>`user-pstake-${e.toLowerCase()}`,pendingRewards:e=>`pending-rewards-${e.toLowerCase()}`,networkPStake:()=>"network-pstake",poolInfo:e=>`pool-info-${e.toLowerCase()}`,poolNfts:e=>`pool-nfts-${e.toLowerCase()}`,buyPrice:e=>`buy-price-${e.toLowerCase()}`,sellPrice:e=>`sell-price-${e.toLowerCase()}`,userNfts:e=>`user-nfts-${e.toLowerCase()}`,fortunePool:()=>"fortune-pool",fortuneTiers:()=>"fortune-tiers",fortuneStats:()=>"fortune-stats",userFortuneHistory:e=>`user-fortune-history-${e.toLowerCase()}`,rentalListings:()=>"rental-listings",rentalListing:e=>`rental-listing-${e}`,rentalActive:e=>`rental-active-${e}`,notaryDocument:e=>`notary-doc-${e}`,userDocuments:e=>`user-documents-${e.toLowerCase()}`,feeConfig:e=>`fee-config-${e}`,protocolConfig:()=>"protocol-config"},h={WRONG_NETWORK:"wrong_network",RPC_UNHEALTHY:"rpc_unhealthy",RPC_RATE_LIMITED:"rpc_rate_limited",NETWORK_ERROR:"network_error",WALLET_NOT_CONNECTED:"wallet_not_connected",WALLET_LOCKED:"wallet_locked",INSUFFICIENT_ETH:"insufficient_eth",INSUFFICIENT_TOKEN:"insufficient_token",INSUFFICIENT_ALLOWANCE:"insufficient_allowance",SIMULATION_REVERTED:"simulation_reverted",GAS_ESTIMATION_FAILED:"gas_estimation_failed",USER_REJECTED:"user_rejected",TX_REVERTED:"tx_reverted",TX_TIMEOUT:"tx_timeout",TX_REPLACED:"tx_replaced",TX_UNDERPRICED:"tx_underpriced",NONCE_ERROR:"nonce_error",CAMPAIGN_NOT_FOUND:"campaign_not_found",CAMPAIGN_NOT_ACTIVE:"campaign_not_active",CAMPAIGN_STILL_ACTIVE:"campaign_still_active",NOT_CAMPAIGN_CREATOR:"not_campaign_creator",DONATION_TOO_SMALL:"donation_too_small",MAX_CAMPAIGNS_REACHED:"max_campaigns_reached",INSUFFICIENT_ETH_FEE:"insufficient_eth_fee",LOCK_PERIOD_ACTIVE:"lock_period_active",LOCK_PERIOD_EXPIRED:"lock_period_expired",NO_REWARDS:"no_rewards",INVALID_DURATION:"invalid_duration",INVALID_DELEGATION_INDEX:"invalid_delegation_index",NFT_NOT_IN_POOL:"nft_not_in_pool",POOL_NOT_INITIALIZED:"pool_not_initialized",INSUFFICIENT_POOL_LIQUIDITY:"insufficient_pool_liquidity",SLIPPAGE_EXCEEDED:"slippage_exceeded",NFT_BOOST_MISMATCH:"nft_boost_mismatch",NOT_NFT_OWNER:"not_nft_owner",NO_ACTIVE_TIERS:"no_active_tiers",INVALID_GUESS_COUNT:"invalid_guess_count",INVALID_GUESS_RANGE:"invalid_guess_range",INSUFFICIENT_SERVICE_FEE:"insufficient_service_fee",RENTAL_STILL_ACTIVE:"rental_still_active",NFT_NOT_LISTED:"nft_not_listed",NFT_ALREADY_LISTED:"nft_already_listed",NOT_LISTING_OWNER:"not_listing_owner",MARKETPLACE_PAUSED:"marketplace_paused",EMPTY_METADATA:"empty_metadata",CONTRACT_ERROR:"contract_error",UNKNOWN:"unknown"},Da={[h.WRONG_NETWORK]:"Please switch to Arbitrum Sepolia network",[h.RPC_UNHEALTHY]:"Network connection issue. Retrying...",[h.RPC_RATE_LIMITED]:"Network is busy. Please wait a moment...",[h.NETWORK_ERROR]:"Network error. Please check your connection",[h.WALLET_NOT_CONNECTED]:"Please connect your wallet",[h.WALLET_LOCKED]:"Please unlock your wallet",[h.INSUFFICIENT_ETH]:"Insufficient ETH for gas fees",[h.INSUFFICIENT_TOKEN]:"Insufficient BKC balance",[h.INSUFFICIENT_ALLOWANCE]:"Token approval required",[h.SIMULATION_REVERTED]:"Transaction would fail. Please check your inputs",[h.GAS_ESTIMATION_FAILED]:"Could not estimate gas. Transaction may fail",[h.USER_REJECTED]:"Transaction cancelled",[h.TX_REVERTED]:"Transaction failed on blockchain",[h.TX_TIMEOUT]:"Transaction is taking too long. Please check your wallet",[h.TX_REPLACED]:"Transaction was replaced",[h.TX_UNDERPRICED]:"Gas price too low. Please try again",[h.NONCE_ERROR]:"Transaction sequence error. Please refresh and try again",[h.CAMPAIGN_NOT_FOUND]:"Campaign not found",[h.CAMPAIGN_NOT_ACTIVE]:"This campaign is no longer accepting donations",[h.CAMPAIGN_STILL_ACTIVE]:"Campaign is still active. Please wait until the deadline",[h.NOT_CAMPAIGN_CREATOR]:"Only the campaign creator can perform this action",[h.DONATION_TOO_SMALL]:"Donation amount is below the minimum required",[h.MAX_CAMPAIGNS_REACHED]:"You have reached the maximum number of active campaigns",[h.INSUFFICIENT_ETH_FEE]:"Insufficient ETH for withdrawal fee",[h.LOCK_PERIOD_ACTIVE]:"Your tokens are still locked",[h.LOCK_PERIOD_EXPIRED]:"Lock period has expired. Use normal unstake",[h.NO_REWARDS]:"No rewards available to claim",[h.INVALID_DURATION]:"Lock duration must be between 1 day and 10 years",[h.INVALID_DELEGATION_INDEX]:"Delegation not found",[h.NFT_NOT_IN_POOL]:"This NFT is not available in the pool",[h.POOL_NOT_INITIALIZED]:"Pool is not active yet",[h.INSUFFICIENT_POOL_LIQUIDITY]:"Insufficient liquidity in pool",[h.SLIPPAGE_EXCEEDED]:"Price changed too much. Please try again",[h.NFT_BOOST_MISMATCH]:"NFT tier does not match this pool",[h.NOT_NFT_OWNER]:"You do not own this NFT",[h.NO_ACTIVE_TIERS]:"No active prize tiers available",[h.INVALID_GUESS_COUNT]:"Invalid number of guesses provided",[h.INVALID_GUESS_RANGE]:"Your guess is outside the valid range",[h.INSUFFICIENT_SERVICE_FEE]:"Incorrect service fee amount",[h.RENTAL_STILL_ACTIVE]:"This NFT is currently being rented",[h.NFT_NOT_LISTED]:"This NFT is not listed for rent",[h.NFT_ALREADY_LISTED]:"This NFT is already listed",[h.NOT_LISTING_OWNER]:"Only the listing owner can perform this action",[h.MARKETPLACE_PAUSED]:"Marketplace is temporarily paused",[h.EMPTY_METADATA]:"Document metadata cannot be empty",[h.CONTRACT_ERROR]:"Transaction cannot be completed. Please check your inputs and try again",[h.UNKNOWN]:"An unexpected error occurred. Please try again"},mt={[h.WRONG_NETWORK]:{layer:1,retry:!1,action:"switch_network"},[h.RPC_UNHEALTHY]:{layer:1,retry:!0,waitMs:2e3,action:"switch_rpc"},[h.RPC_RATE_LIMITED]:{layer:1,retry:!0,waitMs:"extract",action:"switch_rpc"},[h.NETWORK_ERROR]:{layer:1,retry:!0,waitMs:3e3,action:"switch_rpc"},[h.WALLET_NOT_CONNECTED]:{layer:2,retry:!1,action:"connect_wallet"},[h.WALLET_LOCKED]:{layer:2,retry:!1,action:"unlock_wallet"},[h.INSUFFICIENT_ETH]:{layer:3,retry:!1,action:"show_faucet"},[h.INSUFFICIENT_TOKEN]:{layer:3,retry:!1},[h.INSUFFICIENT_ALLOWANCE]:{layer:3,retry:!1},[h.SIMULATION_REVERTED]:{layer:4,retry:!1},[h.GAS_ESTIMATION_FAILED]:{layer:4,retry:!0,waitMs:2e3},[h.USER_REJECTED]:{layer:5,retry:!1},[h.TX_REVERTED]:{layer:5,retry:!1},[h.TX_TIMEOUT]:{layer:5,retry:!0,waitMs:5e3},[h.TX_REPLACED]:{layer:5,retry:!1},[h.TX_UNDERPRICED]:{layer:5,retry:!0,waitMs:1e3},[h.NONCE_ERROR]:{layer:5,retry:!0,waitMs:2e3},[h.CAMPAIGN_NOT_FOUND]:{layer:4,retry:!1},[h.CAMPAIGN_NOT_ACTIVE]:{layer:4,retry:!1},[h.CAMPAIGN_STILL_ACTIVE]:{layer:4,retry:!1},[h.NOT_CAMPAIGN_CREATOR]:{layer:4,retry:!1},[h.DONATION_TOO_SMALL]:{layer:4,retry:!1},[h.MAX_CAMPAIGNS_REACHED]:{layer:4,retry:!1},[h.INSUFFICIENT_ETH_FEE]:{layer:3,retry:!1},[h.LOCK_PERIOD_ACTIVE]:{layer:4,retry:!1},[h.LOCK_PERIOD_EXPIRED]:{layer:4,retry:!1},[h.NO_REWARDS]:{layer:4,retry:!1},[h.INVALID_DURATION]:{layer:4,retry:!1},[h.INVALID_DELEGATION_INDEX]:{layer:4,retry:!1},[h.NFT_NOT_IN_POOL]:{layer:4,retry:!1},[h.POOL_NOT_INITIALIZED]:{layer:4,retry:!1},[h.INSUFFICIENT_POOL_LIQUIDITY]:{layer:4,retry:!1},[h.SLIPPAGE_EXCEEDED]:{layer:4,retry:!0,waitMs:1e3},[h.NFT_BOOST_MISMATCH]:{layer:4,retry:!1},[h.NOT_NFT_OWNER]:{layer:4,retry:!1},[h.NO_ACTIVE_TIERS]:{layer:4,retry:!1},[h.INVALID_GUESS_COUNT]:{layer:4,retry:!1},[h.INVALID_GUESS_RANGE]:{layer:4,retry:!1},[h.INSUFFICIENT_SERVICE_FEE]:{layer:4,retry:!1},[h.RENTAL_STILL_ACTIVE]:{layer:4,retry:!1},[h.NFT_NOT_LISTED]:{layer:4,retry:!1},[h.NFT_ALREADY_LISTED]:{layer:4,retry:!1},[h.NOT_LISTING_OWNER]:{layer:4,retry:!1},[h.MARKETPLACE_PAUSED]:{layer:4,retry:!1},[h.EMPTY_METADATA]:{layer:4,retry:!1},[h.CONTRACT_ERROR]:{layer:4,retry:!1},[h.UNKNOWN]:{layer:5,retry:!1}},Fr=[{pattern:/user rejected/i,type:h.USER_REJECTED},{pattern:/user denied/i,type:h.USER_REJECTED},{pattern:/user cancel/i,type:h.USER_REJECTED},{pattern:/rejected by user/i,type:h.USER_REJECTED},{pattern:/cancelled/i,type:h.USER_REJECTED},{pattern:/canceled/i,type:h.USER_REJECTED},{pattern:/action_rejected/i,type:h.USER_REJECTED},{pattern:/too many errors/i,type:h.RPC_RATE_LIMITED},{pattern:/rate limit/i,type:h.RPC_RATE_LIMITED},{pattern:/retrying in/i,type:h.RPC_RATE_LIMITED},{pattern:/429/i,type:h.RPC_RATE_LIMITED},{pattern:/internal json-rpc/i,type:h.RPC_UNHEALTHY},{pattern:/-32603/i,type:h.RPC_UNHEALTHY},{pattern:/-32002/i,type:h.RPC_RATE_LIMITED},{pattern:/failed to fetch/i,type:h.NETWORK_ERROR},{pattern:/network error/i,type:h.NETWORK_ERROR},{pattern:/timeout/i,type:h.TX_TIMEOUT},{pattern:/insufficient funds/i,type:h.INSUFFICIENT_ETH},{pattern:/exceeds the balance/i,type:h.INSUFFICIENT_ETH},{pattern:/insufficient balance/i,type:h.INSUFFICIENT_TOKEN},{pattern:/transfer amount exceeds balance/i,type:h.INSUFFICIENT_TOKEN},{pattern:/exceeds balance/i,type:h.INSUFFICIENT_TOKEN},{pattern:/nonce/i,type:h.NONCE_ERROR},{pattern:/replacement.*underpriced/i,type:h.TX_UNDERPRICED},{pattern:/transaction underpriced/i,type:h.TX_UNDERPRICED},{pattern:/gas too low/i,type:h.TX_UNDERPRICED},{pattern:/reverted/i,type:h.TX_REVERTED},{pattern:/revert/i,type:h.TX_REVERTED},{pattern:/campaignnotfound/i,type:h.CAMPAIGN_NOT_FOUND},{pattern:/campaign not found/i,type:h.CAMPAIGN_NOT_FOUND},{pattern:/campaignnotactive/i,type:h.CAMPAIGN_NOT_ACTIVE},{pattern:/campaign.*not.*active/i,type:h.CAMPAIGN_NOT_ACTIVE},{pattern:/campaignstillactive/i,type:h.CAMPAIGN_STILL_ACTIVE},{pattern:/notcampaigncreator/i,type:h.NOT_CAMPAIGN_CREATOR},{pattern:/donationtoosmall/i,type:h.DONATION_TOO_SMALL},{pattern:/maxactivecampaignsreached/i,type:h.MAX_CAMPAIGNS_REACHED},{pattern:/insufficientethfee/i,type:h.INSUFFICIENT_ETH_FEE},{pattern:/lockperiodactive/i,type:h.LOCK_PERIOD_ACTIVE},{pattern:/lock.*period.*active/i,type:h.LOCK_PERIOD_ACTIVE},{pattern:/still.*locked/i,type:h.LOCK_PERIOD_ACTIVE},{pattern:/lockperiodexpired/i,type:h.LOCK_PERIOD_EXPIRED},{pattern:/norewardstoclaim/i,type:h.NO_REWARDS},{pattern:/no.*rewards/i,type:h.NO_REWARDS},{pattern:/invalidduration/i,type:h.INVALID_DURATION},{pattern:/invalidindex/i,type:h.INVALID_DELEGATION_INDEX},{pattern:/nftnotinpool/i,type:h.NFT_NOT_IN_POOL},{pattern:/poolnotinitialized/i,type:h.POOL_NOT_INITIALIZED},{pattern:/insufficientliquidity/i,type:h.INSUFFICIENT_POOL_LIQUIDITY},{pattern:/insufficientnfts/i,type:h.INSUFFICIENT_POOL_LIQUIDITY},{pattern:/slippageexceeded/i,type:h.SLIPPAGE_EXCEEDED},{pattern:/slippage/i,type:h.SLIPPAGE_EXCEEDED},{pattern:/nftboostmismatch/i,type:h.NFT_BOOST_MISMATCH},{pattern:/notnftowner/i,type:h.NOT_NFT_OWNER},{pattern:/noactivetiers/i,type:h.NO_ACTIVE_TIERS},{pattern:/invalidguesscount/i,type:h.INVALID_GUESS_COUNT},{pattern:/invalidguessrange/i,type:h.INVALID_GUESS_RANGE},{pattern:/insufficientservicefee/i,type:h.INSUFFICIENT_SERVICE_FEE},{pattern:/rentalstillactive/i,type:h.RENTAL_STILL_ACTIVE},{pattern:/nftnotlisted/i,type:h.NFT_NOT_LISTED},{pattern:/nftalreadylisted/i,type:h.NFT_ALREADY_LISTED},{pattern:/notlistingowner/i,type:h.NOT_LISTING_OWNER},{pattern:/marketplaceispaused/i,type:h.MARKETPLACE_PAUSED},{pattern:/emptymetadata/i,type:h.EMPTY_METADATA}],q={classify(e){var a;if(e!=null&&e.errorType&&Object.values(h).includes(e.errorType))return e.errorType;const t=this._extractMessage(e),n=(e==null?void 0:e.code)||((a=e==null?void 0:e.error)==null?void 0:a.code);if(n===4001||n==="ACTION_REJECTED")return h.USER_REJECTED;if(n===-32002)return h.RPC_RATE_LIMITED;if(n===-32603||n==="CALL_EXCEPTION"){if(t.includes("revert")||t.includes("require")||t.includes("execution failed")||t.includes("call_exception")||(e==null?void 0:e.code)==="CALL_EXCEPTION"){for(const{pattern:s,type:r}of Fr)if(s.test(t))return r;return h.CONTRACT_ERROR}return h.RPC_UNHEALTHY}for(const{pattern:s,type:r}of Fr)if(s.test(t))return r;return h.UNKNOWN},_extractMessage(e){var n,a,s;return e?typeof e=="string"?e:[e.message,e.reason,(n=e.error)==null?void 0:n.message,(a=e.error)==null?void 0:a.reason,(s=e.data)==null?void 0:s.message,e.shortMessage,this._safeStringify(e)].filter(Boolean).join(" ").toLowerCase():""},_safeStringify(e){try{return JSON.stringify(e,(t,n)=>typeof n=="bigint"?n.toString():n)}catch{return""}},isUserRejection(e){return this.classify(e)===h.USER_REJECTED},isRetryable(e){var n;const t=this.classify(e);return((n=mt[t])==null?void 0:n.retry)||!1},getWaitTime(e){const t=this.classify(e),n=mt[t];return n?n.waitMs==="extract"?this._extractWaitTime(e):n.waitMs||2e3:2e3},_extractWaitTime(e){const t=this._extractMessage(e),n=t.match(/retrying in (\d+[,.]?\d*)\s*minutes?/i);if(n){const s=parseFloat(n[1].replace(",","."));return Math.ceil(s*60*1e3)+5e3}const a=t.match(/wait (\d+)\s*seconds?/i);return a?parseInt(a[1])*1e3+2e3:3e4},getMessage(e){const t=this.classify(e);return Da[t]||Da[h.UNKNOWN]},getConfig(e){const t=this.classify(e);return mt[t]||mt[h.UNKNOWN]},getLayer(e){var n;const t=this.classify(e);return((n=mt[t])==null?void 0:n.layer)||5},handle(e,t="Transaction"){const n=this.classify(e),a=mt[n]||{},s=this.getMessage(e);return console.error(`[${t}] Error:`,{type:n,layer:a.layer,retry:a.retry,message:s,original:e}),{type:n,message:s,retry:a.retry||!1,waitMs:a.retry?this.getWaitTime(e):0,layer:a.layer||5,action:a.action||null,original:e,context:t}},async handleWithRpcSwitch(e,t="Transaction"){const n=this.handle(e,t);if(n.action==="switch_rpc")try{const{NetworkManager:a}=await Y(async()=>{const{NetworkManager:r}=await Promise.resolve().then(()=>Iu);return{NetworkManager:r}},void 0);console.log("[ErrorHandler] Switching RPC due to network error...");const s=a.switchToNextRpc();try{await a.updateMetaMaskRpcs(),console.log("[ErrorHandler] MetaMask RPC updated")}catch(r){console.warn("[ErrorHandler] Could not update MetaMask:",r.message)}n.rpcSwitched=!0,n.newRpc=s,n.waitMs=Math.min(n.waitMs,2e3)}catch(a){console.warn("[ErrorHandler] Could not switch RPC:",a.message),n.rpcSwitched=!1}return n},parseSimulationError(e,t){var i;const n=this.classify(e);let a=this.getMessage(e);const r=(i={donate:{[h.CAMPAIGN_NOT_ACTIVE]:"This campaign has ended and is no longer accepting donations",[h.DONATION_TOO_SMALL]:"Minimum donation is 1 BKC"},delegate:{[h.INVALID_DURATION]:"Lock period must be between 1 day and 10 years"},playGame:{[h.INVALID_GUESS_RANGE]:"Your guess must be within the valid range for this tier"},withdraw:{[h.CAMPAIGN_STILL_ACTIVE]:"You can withdraw after the campaign deadline"},unstake:{[h.LOCK_PERIOD_ACTIVE]:"Your tokens are still locked. Use force unstake to withdraw early (penalty applies)"},claimRewards:{[h.CONTRACT_ERROR]:"No rewards available to claim",[h.NO_REWARDS]:"No rewards available to claim"}}[t])==null?void 0:i[n];return r&&(a=r),{type:n,message:a,original:e,method:t,isSimulation:!0}},create(e,t={}){const n=Da[e]||"An error occurred",a=new Error(n);return a.errorType=e,a.extra=t,a},getAction(e){var n;const t=this.classify(e);return((n=mt[t])==null?void 0:n.action)||null}},ee={chainId:421614,chainIdHex:"0x66eee",name:"Arbitrum Sepolia",nativeCurrency:{name:"Ethereum",symbol:"ETH",decimals:18},blockExplorer:"https://sepolia.arbiscan.io"};function Ye(){const e="ZWla0YY4A0Hw7e_rwyOXB";return e?`https://arb-sepolia.g.alchemy.com/v2/${e}`:null}const yu=[{name:"Alchemy",getUrl:Ye,priority:1,isPublic:!1,isPaid:!0},{name:"Arbitrum Official",getUrl:()=>"https://sepolia-rollup.arbitrum.io/rpc",priority:2,isPublic:!0,isPaid:!1},{name:"PublicNode",getUrl:()=>"https://arbitrum-sepolia-rpc.publicnode.com",priority:3,isPublic:!0,isPaid:!1},{name:"Ankr",getUrl:()=>"https://rpc.ankr.com/arbitrum_sepolia",priority:4,isPublic:!0,isPaid:!1}];let et=0,Rt=null,ft=null,Wn=0,Gn=0,$t=!0;const ku=3,Tu=3e4,Eu=5e3,Mr=6e4,Cu=2e3,ie={getCurrentRpcUrl(){const e=Ye();if(e&&$t)return e;const t=this.getAvailableEndpoints();if(t.length===0)throw new Error("No RPC endpoints available");return t[et%t.length].getUrl()},getPrimaryRpcUrl(){return Ye()},getAvailableEndpoints(){return yu.filter(e=>e.getUrl()!==null).sort((e,t)=>e.priority-t.priority)},getRpcUrlsForMetaMask(){const e=Ye(),t=this.getAvailableEndpoints().filter(n=>n.isPublic).map(n=>n.getUrl()).filter(Boolean);return e?[e,...t]:t},switchToNextRpc(e=!0){const t=this.getAvailableEndpoints();if($t&&Ye()){$t=!1,et=0;const s=t.find(r=>r.isPublic);if(s)return console.log(`[Network] Alchemy temporarily unavailable, using: ${s.name}`),e&&setTimeout(()=>{console.log("[Network] Retrying Alchemy..."),$t=!0,et=0},Cu),s.getUrl()}const n=t.filter(s=>s.isPublic);if(n.length<=1)return console.warn("[Network] No alternative RPCs available"),this.getCurrentRpcUrl();et=(et+1)%n.length;const a=n[et];return console.log(`[Network] Switched to RPC: ${a.name}`),a.getUrl()},resetToAlchemy(){Ye()&&($t=!0,et=0,console.log("[Network] Reset to Alchemy RPC"))},isRateLimitError(e){var a;const t=((a=e==null?void 0:e.message)==null?void 0:a.toLowerCase())||"",n=e==null?void 0:e.code;return n===-32002||n===-32005||t.includes("rate limit")||t.includes("too many")||t.includes("exceeded")||t.includes("throttled")||t.includes("429")},async handleRateLimit(e){const t=this.getCurrentRpcUrl(),n=Ye();if(n&&t===n)return console.warn("[Network] Alchemy rate limited (check your plan limits)"),await new Promise(i=>setTimeout(i,1e3)),n;console.warn("[Network] Public RPC rate limited, switching...");const s=this.switchToNextRpc(),r=Date.now();if(r-Gn>Mr)try{await this.updateMetaMaskRpcs(),Gn=r}catch(i){console.warn("[Network] Could not update MetaMask:",i.message)}return s},async getWorkingProvider(){const e=window.ethers,t=Ye();if(t)try{const a=new e.JsonRpcProvider(t);return await Promise.race([a.getBlockNumber(),new Promise((s,r)=>setTimeout(()=>r(new Error("timeout")),3e3))]),$t=!0,a}catch(a){console.warn("[Network] Alchemy temporarily unavailable:",a.message)}const n=this.getAvailableEndpoints().filter(a=>a.isPublic);for(const a of n)try{const s=a.getUrl(),r=new e.JsonRpcProvider(s);return await Promise.race([r.getBlockNumber(),new Promise((i,o)=>setTimeout(()=>o(new Error("timeout")),3e3))]),console.log(`[Network] Using fallback RPC: ${a.name}`),r}catch{console.warn(`[Network] RPC ${a.name} failed, trying next...`)}if(t)return new e.JsonRpcProvider(t);throw new Error("No working RPC endpoints available")},async isCorrectNetwork(){if(!window.ethereum)return!1;try{const e=await window.ethereum.request({method:"eth_chainId"});return parseInt(e,16)===ee.chainId}catch(e){return console.error("[Network] Error checking network:",e),!1}},async getCurrentChainId(){if(!window.ethereum)return null;try{const e=await window.ethereum.request({method:"eth_chainId"});return parseInt(e,16)}catch{return null}},async checkRpcHealth(){const e=Date.now(),t=this.getCurrentRpcUrl();try{const n=new AbortController,a=setTimeout(()=>n.abort(),Eu),s=await fetch(t,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({jsonrpc:"2.0",method:"eth_blockNumber",params:[],id:1}),signal:n.signal});if(clearTimeout(a),!s.ok)throw new Error(`HTTP ${s.status}`);const r=await s.json();if(r.error)throw new Error(r.error.message||"RPC error");const i=Date.now()-e;return Wn=0,ft={healthy:!0,latency:i,blockNumber:parseInt(r.result,16),timestamp:Date.now()},ft}catch(n){Wn++;const a={healthy:!1,latency:Date.now()-e,error:n.message,timestamp:Date.now()};return ft=a,Wn>=ku&&(console.warn("[Network] Too many RPC failures, switching..."),this.switchToNextRpc(),Wn=0),a}},getLastHealthCheck(){return ft},async isRpcHealthy(e=1e4){return ft&&Date.now()-ft.timestamp<e?ft.healthy:(await this.checkRpcHealth()).healthy},async switchNetwork(){if(!window.ethereum)throw q.create(h.WALLET_NOT_CONNECTED);try{return await window.ethereum.request({method:"wallet_switchEthereumChain",params:[{chainId:ee.chainIdHex}]}),console.log("[Network] Switched to",ee.name),!0}catch(e){if(e.code===4902)return await this.addNetwork();throw e.code===4001?q.create(h.USER_REJECTED):e}},async addNetwork(){if(!window.ethereum)throw q.create(h.WALLET_NOT_CONNECTED);const e=this.getRpcUrlsForMetaMask();try{return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:ee.chainIdHex,chainName:ee.name,nativeCurrency:ee.nativeCurrency,rpcUrls:e,blockExplorerUrls:[ee.blockExplorer]}]}),console.log("[Network] Added network:",ee.name),!0}catch(t){throw t.code===4001?q.create(h.USER_REJECTED):t}},async updateMetaMaskRpcs(){if(!window.ethereum)return!1;const e=Date.now();if(e-Gn<Mr)return console.log("[Network] MetaMask update on cooldown, skipping..."),!1;if(!await this.isCorrectNetwork())return console.log("[Network] Not on correct network, skipping RPC update"),!1;const n=this.getRpcUrlsForMetaMask();try{return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:ee.chainIdHex,chainName:ee.name,nativeCurrency:ee.nativeCurrency,rpcUrls:n,blockExplorerUrls:[ee.blockExplorer]}]}),Gn=e,console.log("[Network] MetaMask RPCs updated with:",n[0]),!0}catch(a){return console.warn("[Network] Could not update MetaMask RPCs:",a.message),!1}},async forceResetMetaMaskRpc(){if(!window.ethereum)return!1;const e=Ye();if(!e)return console.warn("[Network] Alchemy not configured"),!1;try{try{await window.ethereum.request({method:"wallet_switchEthereumChain",params:[{chainId:"0x1"}]})}catch{}return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:ee.chainIdHex,chainName:ee.name+" (Alchemy)",nativeCurrency:ee.nativeCurrency,rpcUrls:[e],blockExplorerUrls:[ee.blockExplorer]}]}),console.log("[Network] MetaMask reset to Alchemy RPC"),!0}catch(t){return console.error("[Network] Failed to reset MetaMask:",t.message),!1}},getProvider(){const e=window.ethers;if(!e)throw new Error("ethers.js not loaded");return new e.JsonRpcProvider(this.getCurrentRpcUrl())},getBrowserProvider(){const e=window.ethers;if(!e)throw new Error("ethers.js not loaded");if(!window.ethereum)throw q.create(h.WALLET_NOT_CONNECTED);return new e.BrowserProvider(window.ethereum)},async getSigner(){var t,n;const e=this.getBrowserProvider();try{return await e.getSigner()}catch(a){if((t=a.message)!=null&&t.includes("ENS")||a.code==="UNSUPPORTED_OPERATION")try{const s=await window.ethereum.request({method:"eth_accounts"});if(s&&s.length>0)return await e.getSigner(s[0])}catch(s){console.warn("Signer fallback failed:",s)}throw a.code===4001||(n=a.message)!=null&&n.includes("user rejected")?q.create(h.USER_REJECTED):q.create(h.WALLET_NOT_CONNECTED)}},async getConnectedAddress(){if(!window.ethereum)return null;try{return(await window.ethereum.request({method:"eth_accounts"}))[0]||null}catch{return null}},async requestConnection(){if(!window.ethereum)throw q.create(h.WALLET_NOT_CONNECTED);try{const e=await window.ethereum.request({method:"eth_requestAccounts"});if(!e||e.length===0)throw q.create(h.WALLET_NOT_CONNECTED);return e[0]}catch(e){throw e.code===4001?q.create(h.USER_REJECTED):e}},startHealthMonitoring(e=Tu){Rt&&this.stopHealthMonitoring(),this.checkRpcHealth(),Rt=setInterval(()=>{this.checkRpcHealth()},e),console.log("[Network] Health monitoring started")},stopHealthMonitoring(){Rt&&(clearInterval(Rt),Rt=null,console.log("[Network] Health monitoring stopped"))},isMonitoring(){return Rt!==null},formatAddress(e,t=4){return e?`${e.slice(0,t+2)}...${e.slice(-t)}`:""},getAddressExplorerUrl(e){return`${ee.blockExplorer}/address/${e}`},getTxExplorerUrl(e){return`${ee.blockExplorer}/tx/${e}`},isMetaMaskInstalled(){return typeof window.ethereum<"u"&&window.ethereum.isMetaMask},async getStatus(){var a;const[e,t,n]=await Promise.all([this.isCorrectNetwork(),this.getConnectedAddress(),this.checkRpcHealth()]);return{isConnected:!!t,address:t,isCorrectNetwork:e,currentChainId:await this.getCurrentChainId(),targetChainId:ee.chainId,rpcHealthy:n.healthy,rpcLatency:n.latency,currentRpc:((a=this.getAvailableEndpoints()[et])==null?void 0:a.name)||"Unknown"}}},Iu=Object.freeze(Object.defineProperty({__proto__:null,NETWORK_CONFIG:ee,NetworkManager:ie},Symbol.toStringTag,{value:"Module"})),je={SAFETY_MARGIN_PERCENT:20,MIN_GAS_LIMITS:{transfer:21000n,erc20Transfer:65000n,erc20Approve:50000n,contractCall:100000n,complexCall:300000n},MAX_GAS_LIMIT:15000000n,MIN_GAS_PRICE_GWEI:.01,MAX_GAS_PRICE_GWEI:100,GAS_PRICE_CACHE_TTL:15e3},Au={async estimateGas(e,t,n=[],a={}){try{return await e[t].estimateGas(...n,a)}catch(s){throw s}},async estimateGasWithMargin(e,t,n=[],a={}){const s=await this.estimateGas(e,t,n,a);return this.addSafetyMargin(s)},addSafetyMargin(e,t=je.SAFETY_MARGIN_PERCENT){const n=BigInt(e),a=n*BigInt(t)/100n;let s=n+a;return s>je.MAX_GAS_LIMIT&&(console.warn("[Gas] Estimate exceeds max limit, capping"),s=je.MAX_GAS_LIMIT),s},getMinGasLimit(e="contractCall"){return je.MIN_GAS_LIMITS[e]||je.MIN_GAS_LIMITS.contractCall},async getGasPrice(){return await Tt.getOrFetch("gas-price-current",async()=>(await ie.getProvider().getFeeData()).gasPrice||0n,je.GAS_PRICE_CACHE_TTL)},async getFeeData(){return await Tt.getOrFetch("gas-fee-data",async()=>{const n=await ie.getProvider().getFeeData();return{gasPrice:n.gasPrice||0n,maxFeePerGas:n.maxFeePerGas||0n,maxPriorityFeePerGas:n.maxPriorityFeePerGas||0n}},je.GAS_PRICE_CACHE_TTL)},async getGasPriceGwei(){const e=window.ethers,t=await this.getGasPrice();return parseFloat(e.formatUnits(t,"gwei"))},async calculateCost(e,t=null){const n=window.ethers;t||(t=await this.getGasPrice());const a=BigInt(e)*BigInt(t),s=n.formatEther(a);return{wei:a,eth:parseFloat(s),formatted:this.formatEth(s)}},async estimateTransactionCost(e,t,n=[],a={}){const s=await this.estimateGas(e,t,n,a),r=this.addSafetyMargin(s),i=await this.getGasPrice(),o=await this.calculateCost(r,i);return{gasEstimate:s,gasWithMargin:r,gasPrice:i,...o}},async validateGasBalance(e,t,n=null){const a=window.ethers,s=ie.getProvider();n||(n=await this.getGasPrice());const r=await s.getBalance(e),i=BigInt(t)*BigInt(n),o=r>=i;return{sufficient:o,balance:r,required:i,shortage:o?0n:i-r,balanceFormatted:a.formatEther(r),requiredFormatted:a.formatEther(i)}},async hasMinimumGas(e,t=null){const n=window.ethers,s=await ie.getProvider().getBalance(e),r=t||n.parseEther("0.001");return s>=r},formatEth(e,t=6){const n=parseFloat(e);return n===0?"0 ETH":n<1e-6?"< 0.000001 ETH":`${n.toFixed(t).replace(/\.?0+$/,"")} ETH`},formatGasPrice(e){const t=window.ethers,n=parseFloat(t.formatUnits(e,"gwei"));return n<.01?"< 0.01 gwei":n<1?`${n.toFixed(2)} gwei`:`${n.toFixed(1)} gwei`},formatGasLimit(e){return Number(e).toLocaleString()},formatGasSummary(e){return`~${e.formatted} (${this.formatGasLimit(e.gasWithMargin||0n)} gas)`},compareEstimates(e,t){const n=BigInt(e),a=BigInt(t);if(a===0n)return 0;const s=n>a?n-a:a-n;return Number(s*100n/a)},isGasPriceReasonable(e){const t=window.ethers,n=parseFloat(t.formatUnits(e,"gwei"));return n<je.MIN_GAS_PRICE_GWEI?{reasonable:!1,warning:"Gas price unusually low, transaction may be slow"}:n>je.MAX_GAS_PRICE_GWEI?{reasonable:!1,warning:"Gas price unusually high, consider waiting"}:{reasonable:!0,warning:null}},async getRecommendedSettings(e){const t=await this.getFeeData();return{gasLimit:this.addSafetyMargin(e),maxFeePerGas:t.maxFeePerGas,maxPriorityFeePerGas:t.maxPriorityFeePerGas}},async createTxOverrides(e,t={}){return{gasLimit:(await this.getRecommendedSettings(e)).gasLimit,...t}}},Dr=500000000000000n,Or=["function balanceOf(address owner) view returns (uint256)","function allowance(address owner, address spender) view returns (uint256)","function decimals() view returns (uint8)","function symbol() view returns (string)"],X={async validateNetwork(){if(!await ie.isCorrectNetwork()){const t=await ie.getCurrentChainId();throw q.create(h.WRONG_NETWORK,{currentChainId:t,expectedChainId:ee.chainId})}},async validateRpcHealth(){const e=await ie.checkRpcHealth();if(!e.healthy&&(ie.switchToNextRpc(),!(await ie.checkRpcHealth()).healthy))throw q.create(h.RPC_UNHEALTHY,{error:e.error})},async validateWalletConnected(e=null){if(!window.ethereum)throw q.create(h.WALLET_NOT_CONNECTED);const t=e||await ie.getConnectedAddress();if(!t)throw q.create(h.WALLET_NOT_CONNECTED);return t},async validatePreTransaction(){return await this.validateNetwork(),await this.validateRpcHealth(),await this.validateWalletConnected()},async validateEthForGas(e,t=Dr){const n=window.ethers,a=Ma.ethBalance(e),s=await Tt.getOrFetch(a,async()=>await ie.getProvider().getBalance(e),Fa.BALANCE);if(s<t)throw q.create(h.INSUFFICIENT_ETH,{balance:n.formatEther(s),required:n.formatEther(t)});return s},async validateTokenBalance(e,t,n){const a=window.ethers,s=Ma.tokenBalance(e,n),r=await Tt.getOrFetch(s,async()=>{const i=ie.getProvider();return await new a.Contract(e,Or,i).balanceOf(n)},Fa.BALANCE);if(r<t)throw q.create(h.INSUFFICIENT_TOKEN,{balance:a.formatEther(r),required:a.formatEther(t)});return r},async needsApproval(e,t,n,a){const s=window.ethers,r=Ma.allowance(e,a,t);return await Tt.getOrFetch(r,async()=>{const o=ie.getProvider();return await new s.Contract(e,Or,o).allowance(a,t)},Fa.ALLOWANCE)<n},async validateAllowance(e,t,n,a){if(await this.needsApproval(e,t,n,a))throw q.create(h.INSUFFICIENT_ALLOWANCE,{token:e,spender:t,required:n.toString()})},async validateBalances({userAddress:e,tokenAddress:t=null,tokenAmount:n=null,spenderAddress:a=null,ethAmount:s=Dr}){await this.validateEthForGas(e,s),t&&n&&await this.validateTokenBalance(t,n,e)},validatePositive(e,t="Amount"){if(BigInt(e)<=0n)throw new Error(`${t} must be greater than zero`)},validateRange(e,t,n,a="Value"){const s=BigInt(e),r=BigInt(t),i=BigInt(n);if(s<r||s>i)throw new Error(`${a} must be between ${t} and ${n}`)},validateNotEmpty(e,t="Field"){if(!e||e.trim().length===0)throw new Error(`${t} cannot be empty`)},validateAddress(e,t="Address"){const n=window.ethers;if(!e||!n.isAddress(e))throw new Error(`Invalid ${t}`)},charity:{validateCreateCampaign({title:e,description:t,goalAmount:n,durationDays:a}){X.validateNotEmpty(e,"Title"),X.validateNotEmpty(t,"Description"),X.validatePositive(n,"Goal amount"),X.validateRange(a,1,180,"Duration")},validateDonate({campaignId:e,amount:t}){if(e==null)throw new Error("Campaign ID is required");X.validatePositive(t,"Donation amount")}},staking:{validateDelegate({amount:e,lockDays:t}){X.validatePositive(e,"Stake amount"),X.validateRange(t,1,3650,"Lock duration")},validateUnstake({delegationIndex:e}){if(e==null||e<0)throw new Error("Invalid delegation index")}},nftPool:{validateBuy({maxPrice:e}){e!=null&&X.validatePositive(e,"Max price")},validateSell({tokenId:e,minPayout:t}){if(e==null)throw new Error("Token ID is required");t!=null&&X.validatePositive(t,"Min payout")}},fortune:{validatePlay({wagerAmount:e,guesses:t,isCumulative:n}){if(X.validatePositive(e,"Wager amount"),!Array.isArray(t)||t.length===0)throw new Error("At least one guess is required");t.forEach((a,s)=>{if(typeof a!="number"||a<1)throw new Error(`Invalid guess at position ${s+1}`)})}},rental:{validateList({tokenId:e,pricePerHour:t,minHours:n,maxHours:a}){if(e==null)throw new Error("Token ID is required");X.validatePositive(t,"Price per hour"),X.validateRange(n,1,720,"Minimum hours"),X.validateRange(a,n,720,"Maximum hours")},validateRent({tokenId:e,hours:t}){if(e==null)throw new Error("Token ID is required");X.validatePositive(t,"Rental hours")}},notary:{validateNotarize({ipfsCid:e,description:t,contentHash:n}){if(X.validateNotEmpty(e,"IPFS CID"),n&&(n.startsWith("0x")?n.slice(2):n).length!==64)throw new Error("Content hash must be 32 bytes")}}},Kn={DEFAULT_MAX_RETRIES:2,RETRY_BASE_DELAY:2e3,APPROVAL_MULTIPLIER:10n,APPROVAL_WAIT_TIME:1500,CONFIRMATION_TIMEOUT:6e4,CONFIRMATION_RETRY_DELAY:3e3,GAS_SAFETY_MARGIN:20,DEFAULT_GAS_LIMIT:500000n},Hr=["function approve(address spender, uint256 amount) returns (bool)","function allowance(address owner, address spender) view returns (uint256)"];class Bu{constructor(t,n,a=!0){this.button=t,this.txName=n,this.showToasts=a,this.originalContent=null,this.originalDisabled=!1,this.button&&(this.originalContent=this.button.innerHTML,this.originalDisabled=this.button.disabled)}setPhase(t){if(!this.button)return;const a={validating:{text:"Validating...",icon:"🔍"},approving:{text:"Approving...",icon:"✅"},simulating:{text:"Simulating...",icon:"🧪"},confirming:{text:"Confirm in Wallet",icon:"👛"},waiting:{text:"Processing...",icon:"⏳"},success:{text:"Success!",icon:"🎉"},error:{text:"Failed",icon:"❌"}}[t]||{text:t,icon:"⏳"};this.button.disabled=!0,this.button.innerHTML=`
        ...
        `)}cleanup(){this.button&&(this.button.innerHTML=this.originalContent,this.button.disabled=this.originalDisabled)}showSuccess(t=2e3){this.setPhase("success"),setTimeout(()=>this.cleanup(),t)}showError(t=2e3){this.setPhase("error"),setTimeout(()=>this.cleanup(),t)}}class Pu{constructor(){this.pendingTxIds=new Set}_resolveArgs(t){return typeof t=="function"?t():t||[]}_resolveApproval(t){return t?typeof t=="object"?{token:t.token,spender:t.spender,amount:t.amount}:t:null}_validateContractMethod(t,n){if(!t)throw new Error("Contract instance is null or undefined");if(typeof t[n]!="function"){const a=Object.keys(t).filter(s=>typeof t[s]=="function").filter(s=>!s.startsWith("_")&&!["on","once","emit","removeListener"].includes(s)).slice(0,15);throw console.error(`[TX] Contract method "${n}" not found!`),console.error("[TX] Available methods:",a),new Error(`Contract method "${n}" not found. This usually means the ABI doesn't match the contract. Available methods: ${a.join(", ")}`)}return typeof t[n].estimateGas!="function"&&console.warn(`[TX] Method ${n} exists but estimateGas is not available`),!0}async execute(t){var I,N;const{name:n,txId:a=null,button:s=null,showToasts:r=!0,getContract:i,method:o,args:l=[],approval:d=null,validate:p=null,onSuccess:f=null,onError:m=null,maxRetries:b=Kn.DEFAULT_MAX_RETRIES,invalidateCache:u=!0,skipSimulation:g=!1,fixedGasLimit:y=Kn.DEFAULT_GAS_LIMIT}=t,k=a||`${n}-${Date.now()}-${Math.random().toString(36).substr(2,9)}`;if(this.pendingTxIds.has(k))return console.warn(`[TX] Transaction ${k} already in progress`),{success:!1,reason:"DUPLICATE_TX",message:"Transaction already in progress"};this.pendingTxIds.add(k);const E=new Bu(s,n,r);try{E.setPhase("validating"),console.log(`[TX] Starting: ${n}`),await X.validateNetwork(),await X.validateRpcHealth();const z=await X.validateWalletConnected();console.log(`[TX] User address: ${z}`);const T=await ie.getSigner();console.log("[TX] Signer obtained");try{await X.validateEthForGas(z)}catch(V){console.warn("[TX] ETH gas validation failed, continuing anyway:",V.message)}const F=this._resolveApproval(d);F&&F.amount>0n&&await X.validateTokenBalance(F.token,F.amount,z),p&&(console.log("[TX] Running custom validation..."),await p(T,z));const G=this._resolveApproval(d);G&&G.amount>0n&&await X.needsApproval(G.token,G.spender,G.amount,z)&&(E.setPhase("approving"),console.log("[TX] Requesting token approval..."),await this._executeApproval(G,T,z),Tt.clear("allowance-")),console.log("[TX] Getting contract instance...");const se=await i(T);this._validateContractMethod(se,o),console.log(`[TX] Contract method "${o}" validated`);const de=t.value;de&&console.log("[TX] Transaction value (ETH):",de.toString());const xe=de?{value:de}:{},Q=this._resolveArgs(l);console.log("[TX] Args resolved:",Q.map(V=>typeof V=="bigint"?V.toString():typeof V=="string"&&V.length>50?V.substring(0,50)+"...":V));let D;if(g)console.log(`[TX] Skipping simulation, using fixed gas limit: ${y}`),D=y;else{E.setPhase("simulating"),console.log("[TX] Simulating transaction...");try{if(!se[o]||typeof se[o].estimateGas!="function")throw new Error(`estimateGas not available for method "${o}"`);D=await se[o].estimateGas(...Q,xe),console.log(`[TX] Gas estimate: ${D.toString()}`)}catch(V){if(console.error("[TX] Simulation failed:",V.message),(I=V.message)!=null&&I.includes("not found")||(N=V.message)!=null&&N.includes("undefined"))throw new Error(`Contract method "${o}" is not callable. Check that the ABI matches the deployed contract.`);const sn=q.parseSimulationError(V,o);throw q.create(sn.type,{message:sn.message,original:V})}}E.setPhase("confirming"),console.log("[TX] Requesting signature...");const W=Au.addSafetyMargin(D),oe={...xe,gasLimit:W};try{const V=await T.provider.getFeeData();V.maxFeePerGas&&(oe.maxFeePerGas=V.maxFeePerGas*120n/100n,oe.maxPriorityFeePerGas=V.maxPriorityFeePerGas||0n)}catch{}const ae=this._resolveArgs(l),Qe=await this._executeWithRetry(()=>se[o](...ae,oe),{maxRetries:b,ui:E,signer:T,name:n});console.log(`[TX] Transaction submitted: ${Qe.hash}`),E.setPhase("waiting"),console.log("[TX] Waiting for confirmation...");const _e=await this._waitForConfirmation(Qe,T.provider);if(console.log(`[TX] Confirmed in block ${_e.blockNumber}`),E.showSuccess(),u&&Tt.invalidateByTx(n),f)try{await f(_e)}catch(V){console.warn("[TX] onSuccess callback error:",V)}return{success:!0,receipt:_e,txHash:_e.hash||Qe.hash,blockNumber:_e.blockNumber}}catch(z){console.error("[TX] Error:",(z==null?void 0:z.message)||z),s&&(console.log("[TX] Restoring button..."),s.disabled=!1,E.originalContent&&(s.innerHTML=E.originalContent));let T;try{T=await q.handleWithRpcSwitch(z,n),T.rpcSwitched&&console.log(`[TX] RPC switched to: ${T.newRpc}`)}catch(F){console.warn("[TX] Error in handleWithRpcSwitch:",F),T=q.handle(z,n)}if(T.type!==h.USER_REJECTED&&s&&!m){const F=E.originalContent;s.innerHTML='<span style="display:flex;align-items:center;justify-content:center;gap:8px"><span>❌</span><span>Failed</span></span>',setTimeout(()=>{s&&(s.innerHTML=F)},1500)}if(m)try{m(T)}catch(F){console.warn("[TX] onError callback error:",F)}return{success:!1,error:T,message:T.message,cancelled:T.type===h.USER_REJECTED}}finally{this.pendingTxIds.delete(k),setTimeout(()=>{s&&s.disabled&&(console.log("[TX] Safety cleanup triggered"),E.cleanup())},5e3)}}async _executeApproval(t,n,a){const s=window.ethers,{token:r,spender:i,amount:o}=t;console.log(`[TX] Approving ${s.formatEther(o)} tokens...`);const l=new s.Contract(r,Hr,n),d=o*Kn.APPROVAL_MULTIPLIER;try{let p={};try{const y=await n.provider.getFeeData();y.maxFeePerGas&&(p.maxFeePerGas=y.maxFeePerGas*120n/100n,p.maxPriorityFeePerGas=y.maxPriorityFeePerGas||0n)}catch{}const f=await l.approve(i,d,p),m=ie.getProvider();let b=null;for(let y=0;y<30&&(await new Promise(k=>setTimeout(k,1500)),b=await m.getTransactionReceipt(f.hash),!b);y++);if(b||(b=await f.wait()),b.status===0)throw new Error("Approval transaction reverted");if(console.log("[TX] Approval confirmed"),await new Promise(y=>setTimeout(y,Kn.APPROVAL_WAIT_TIME)),await new s.Contract(r,Hr,m).allowance(a,i)<o)throw new Error("Approval not reflected on-chain")}catch(p){throw q.isUserRejection(p)?q.create(h.USER_REJECTED):p}}async _executeWithRetry(t,{maxRetries:n,ui:a,signer:s,name:r}){let i;for(let o=1;o<=n+1;o++)try{return o>1&&(a.setRetry(o,n+1),console.log(`[TX] Retry ${o}/${n+1}`),(await ie.checkRpcHealth()).healthy||(console.log("[TX] RPC unhealthy, switching..."),ie.switchToNextRpc(),await new Promise(d=>setTimeout(d,2e3)))),await t()}catch(l){if(i=l,q.isUserRejection(l)||!q.isRetryable(l)||o===n+1)throw l;const d=q.getWaitTime(l);console.log(`[TX] Waiting ${d}ms before retry...`),await new Promise(p=>setTimeout(p,d))}throw i}async _waitForConfirmation(t,n){const a=ie.getProvider();try{const s=await Promise.race([t.wait(),new Promise((r,i)=>setTimeout(()=>i(new Error("wait_timeout")),1e4))]);if(s.status===1)return s;if(s.status===0)throw new Error("Transaction reverted on-chain");return s}catch(s){console.warn("[TX] tx.wait() issue, using Alchemy to check:",s.message);for(let r=0;r<20;r++){await new Promise(o=>setTimeout(o,1500));const i=await a.getTransactionReceipt(t.hash);if(i&&i.status===1)return console.log("[TX] Confirmed via Alchemy"),i;if(i&&i.status===0)throw new Error("Transaction reverted on-chain")}return console.warn("[TX] Could not verify receipt, assuming success"),{hash:t.hash,status:1,blockNumber:0}}}isPending(t){return this.pendingTxIds.has(t)}getPendingCount(){return this.pendingTxIds.size}clearPending(){this.pendingTxIds.clear()}}const Z=new Pu,wa="bkc_operator",Nt="0x0000000000000000000000000000000000000000";function Ls(){var t;const e=window.ethers;try{const n=localStorage.getItem(wa);if(n&&qe(n))return Mt(n);if(window.BACKCHAIN_OPERATOR&&qe(window.BACKCHAIN_OPERATOR))return Mt(window.BACKCHAIN_OPERATOR);if((t=window.addresses)!=null&&t.operator&&qe(window.addresses.operator))return Mt(window.addresses.operator)}catch(n){console.warn("[Operator] Error getting operator:",n)}return(e==null?void 0:e.ZeroAddress)||Nt}function ce(e){const t=window.ethers,n=(t==null?void 0:t.ZeroAddress)||Nt;return e===null?n:e&&qe(e)?Mt(e):Ls()}function Nu(e){if(!e)return Vi(),!0;if(!qe(e))return console.warn("[Operator] Invalid address:",e),!1;try{const t=Mt(e);return localStorage.setItem(wa,t),window.BACKCHAIN_OPERATOR=t,window.dispatchEvent(new CustomEvent("operatorChanged",{detail:{address:t}})),console.log("[Operator] Set to:",t),!0}catch(t){return console.error("[Operator] Error setting:",t),!1}}function Vi(){try{localStorage.removeItem(wa),delete window.BACKCHAIN_OPERATOR,window.dispatchEvent(new CustomEvent("operatorChanged",{detail:{address:null}})),console.log("[Operator] Cleared")}catch(e){console.warn("[Operator] Error clearing:",e)}}function zu(){const e=window.ethers,t=(e==null?void 0:e.ZeroAddress)||Nt,n=Ls();return n&&n!==t}function Lu(){var a;const e=window.ethers,t=(e==null?void 0:e.ZeroAddress)||Nt,n=localStorage.getItem(wa);return n&&qe(n)?{address:n,source:"localStorage",isSet:!0}:window.BACKCHAIN_OPERATOR&&qe(window.BACKCHAIN_OPERATOR)?{address:window.BACKCHAIN_OPERATOR,source:"global",isSet:!0}:(a=window.addresses)!=null&&a.operator&&qe(window.addresses.operator)?{address:window.addresses.operator,source:"config",isSet:!0}:{address:t,source:"none",isSet:!1}}function qe(e){const t=window.ethers;return!e||typeof e!="string"||!e.match(/^0x[a-fA-F0-9]{40}$/)?!1:t!=null&&t.isAddress?t.isAddress(e):!0}function Mt(e){const t=window.ethers;if(!e)return(t==null?void 0:t.ZeroAddress)||Nt;try{if(t!=null&&t.getAddress)return t.getAddress(e)}catch{}return e}function Su(e){const t=window.ethers,n=(t==null?void 0:t.ZeroAddress)||Nt;return!e||e===n?"None":`${e.slice(0,6)}...${e.slice(-4)}`}const Ru={get:Ls,set:Nu,clear:Vi,has:zu,resolve:ce,info:Lu,isValid:qe,normalize:Mt,short:Su,ZERO:Nt};window.Operator=Ru;function zn(){var n,a;const e=(w==null?void 0:w.charityPool)||(R==null?void 0:R.charityPool)||((n=window.contractAddresses)==null?void 0:n.charityPool),t=(w==null?void 0:w.bkcToken)||(R==null?void 0:R.bkcToken)||((a=window.contractAddresses)==null?void 0:a.bkcToken);if(!e)throw console.error("❌ CharityPool address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{BKC_TOKEN:t,CHARITY_POOL:e}}const Ln=["function createCampaign(string calldata _title, string calldata _description, uint96 _goalAmount, uint256 _durationDays, address _operator) external returns (uint256 campaignId)","function donate(uint256 _campaignId, address _operator) external payable","function cancelCampaign(uint256 _campaignId) external","function withdraw(uint256 _campaignId, address _operator) external","function boostCampaign(uint256 _campaignId, address _operator) external payable","function campaigns(uint256 campaignId) view returns (address creator, uint96 goalAmount, uint96 raisedAmount, uint32 donationCount, uint64 deadline, uint64 createdAt, uint96 boostAmount, uint64 boostTime, uint8 status)","function campaignTitles(uint256 campaignId) view returns (string)","function campaignDescriptions(uint256 campaignId) view returns (string)","function getCampaign(uint256 _campaignId) view returns (address creator, string title, string description, uint96 goalAmount, uint96 raisedAmount, uint32 donationCount, uint64 deadline, uint64 createdAt, uint96 boostAmount, uint64 boostTime, uint8 status, bool goalReached)","function donations(uint256 donationId) view returns (address donor, uint64 campaignId, uint96 grossAmount, uint96 netAmount, uint64 timestamp)","function getDonation(uint256 _donationId) view returns (tuple(address donor, uint64 campaignId, uint96 grossAmount, uint96 netAmount, uint64 timestamp))","function getCampaignDonations(uint256 _campaignId) view returns (uint256[])","function getUserDonations(address _user) view returns (uint256[])","function getUserCampaigns(address _user) view returns (uint256[])","function userActiveCampaigns(address user) view returns (uint8)","function maxActiveCampaigns() view returns (uint8)","function createCostBkc() view returns (uint96)","function withdrawCostBkc() view returns (uint96)","function donationFeeBips() view returns (uint16)","function boostCostBkc() view returns (uint96)","function boostCostEth() view returns (uint96)","function getFeeConfig() view returns (uint96 createBkc, uint96 withdrawBkc, uint16 donationBips, uint96 boostBkc, uint96 boostEth)","function campaignCounter() view returns (uint64)","function donationCounter() view returns (uint64)","function totalRaisedAllTime() view returns (uint256)","function totalDonationsAllTime() view returns (uint256)","function totalFeesCollected() view returns (uint256)","function getStats() view returns (uint64 totalCampaigns, uint256 totalRaised, uint256 totalDonations, uint256 totalFees)","function previewDonation(uint256 _amount) view returns (uint256 netToCampaign, uint256 feeToProtocol)","function canWithdraw(uint256 _campaignId) view returns (bool allowed, string reason)","function isBoosted(uint256 _campaignId) view returns (bool)","function version() view returns (string)","event CampaignCreated(uint256 indexed campaignId, address indexed creator, uint96 goalAmount, uint64 deadline, address operator)","event DonationMade(uint256 indexed campaignId, uint256 indexed donationId, address indexed donor, uint96 grossAmount, uint96 netAmount, uint96 feeAmount, address operator)","event CampaignBoosted(uint256 indexed campaignId, address indexed booster, uint96 bkcAmount, uint96 ethAmount, address operator)","event CampaignCancelled(uint256 indexed campaignId, address indexed creator, uint96 raisedAmount)","event FundsWithdrawn(uint256 indexed campaignId, address indexed creator, uint96 amount, address operator)","event ConfigUpdated()"],Xt={ACTIVE:0,COMPLETED:1,CANCELLED:2,WITHDRAWN:3};function Ue(e){const t=window.ethers,n=zn();return new t.Contract(n.CHARITY_POOL,Ln,e)}async function me(){const e=window.ethers,{NetworkManager:t}=await Y(async()=>{const{NetworkManager:s}=await import("./index-C63_LXPF.js");return{NetworkManager:s}},[]),n=t.getProvider(),a=zn();return new e.Contract(a.CHARITY_POOL,Ln,n)}async function qi({title:e,description:t,goalAmount:n,durationDays:a,operator:s,button:r=null,onSuccess:i=null,onError:o=null}){const l=window.ethers;if(!e||e.trim().length===0)throw new Error("Title is required");if(e.length>100)throw new Error("Title must be 100 characters or less");if(t&&t.length>1e3)throw new Error("Description must be 1000 characters or less");if(a<1||a>180)throw new Error("Duration must be between 1 and 180 days");const d=BigInt(n);if(d<=0n)throw new Error("Goal amount must be greater than 0");let p=e,f=t||"",m=s,b=0n;return await Z.execute({name:"CreateCampaign",button:r,getContract:async u=>Ue(u),method:"createCampaign",args:()=>[p,f,d,BigInt(a),ce(m)],get approval(){if(b>0n){const u=zn();return{token:u.BKC_TOKEN,spender:u.CHARITY_POOL,amount:b}}return null},validate:async(u,g)=>{const y=Ue(u);try{const k=await y.userActiveCampaigns(g),E=await y.maxActiveCampaigns();if(Number(k)>=Number(E))throw new Error(`Maximum active campaigns reached (${E})`)}catch(k){if(k.message.includes("Maximum"))throw k}try{b=await y.createCostBkc()}catch{b=l.parseEther("1")}},onSuccess:async u=>{let g=null;try{const y=new l.Interface(Ln);for(const k of u.logs)try{const E=y.parseLog(k);if(E.name==="CampaignCreated"){g=Number(E.args.campaignId);break}}catch{}}catch{}i&&i(u,g)},onError:o})}async function Xi({campaignId:e,amount:t,operator:n,button:a=null,onSuccess:s=null,onError:r=null}){const i=window.ethers;if(e==null)throw new Error("Campaign ID is required");const o=BigInt(t);if(o<=0n)throw new Error("Donation amount must be greater than 0");let l=e,d=n;return await Z.execute({name:"Donate",button:a,getContract:async p=>Ue(p),method:"donate",args:()=>[l,ce(d)],value:o,validate:async(p,f)=>{const m=Ue(p);try{const b=await m.getCampaign(l);if(b.creator===i.ZeroAddress)throw new Error("Campaign not found");if(Number(b.status)!==Xt.ACTIVE)throw new Error("Campaign is not active");const u=Math.floor(Date.now()/1e3);if(Number(b.deadline)<=u)throw new Error("Campaign has ended")}catch(b){if(b.message.includes("Campaign")||b.message.includes("active")||b.message.includes("ended"))throw b}},onSuccess:async p=>{let f=null;try{const m=new i.Interface(Ln);for(const b of p.logs)try{const u=m.parseLog(b);if(u.name==="DonationMade"){f={donationId:Number(u.args.donationId),grossAmount:u.args.grossAmount,netAmount:u.args.netAmount,feeAmount:u.args.feeAmount};break}}catch{}}catch{}s&&s(p,f)},onError:r})}async function Ji({campaignId:e,button:t=null,onSuccess:n=null,onError:a=null}){const s=window.ethers;if(e==null)throw new Error("Campaign ID is required");let r=e;return await Z.execute({name:"CancelCampaign",button:t,getContract:async i=>Ue(i),method:"cancelCampaign",args:[r],validate:async(i,o)=>{const l=Ue(i);try{const d=await l.getCampaign(r);if(d.creator===s.ZeroAddress)throw new Error("Campaign not found");if(d.creator.toLowerCase()!==o.toLowerCase())throw new Error("Only the campaign creator can cancel");if(Number(d.status)!==Xt.ACTIVE)throw new Error("Campaign is not active")}catch(d){if(d.message.includes("Campaign")||d.message.includes("creator")||d.message.includes("active"))throw d}},onSuccess:n,onError:a})}async function Zi({campaignId:e,operator:t,button:n=null,onSuccess:a=null,onError:s=null}){const r=window.ethers;if(e==null)throw new Error("Campaign ID is required");let i=e,o=t,l=0n;return await Z.execute({name:"Withdraw",button:n,getContract:async d=>Ue(d),method:"withdraw",args:()=>[i,ce(o)],get approval(){if(l>0n){const d=zn();return{token:d.BKC_TOKEN,spender:d.CHARITY_POOL,amount:l}}return null},validate:async(d,p)=>{const f=Ue(d);try{const m=await f.getCampaign(i);if(m.creator===r.ZeroAddress)throw new Error("Campaign not found");if(m.creator.toLowerCase()!==p.toLowerCase())throw new Error("Only the campaign creator can withdraw");if(Number(m.status)===Xt.WITHDRAWN)throw new Error("Funds already withdrawn");const[b,u]=await f.canWithdraw(i);if(!b)throw new Error(u||"Cannot withdraw yet")}catch(m){if(m.message)throw m}try{l=await f.withdrawCostBkc()}catch{l=r.parseEther("0.5")}},onSuccess:async d=>{let p=null;try{const f=new r.Interface(Ln);for(const m of d.logs)try{const b=f.parseLog(m);if(b.name==="FundsWithdrawn"){p={amount:b.args.amount};break}}catch{}}catch{}a&&a(d,p)},onError:s})}async function Qi({campaignId:e,ethAmount:t,operator:n,button:a=null,onSuccess:s=null,onError:r=null}){const i=window.ethers;if(e==null)throw new Error("Campaign ID is required");let o=e,l=n,d=0n,p=t?BigInt(t):0n;return await Z.execute({name:"BoostCampaign",button:a,getContract:async f=>Ue(f),method:"boostCampaign",args:()=>[o,ce(l)],get value(){return p},get approval(){if(d>0n){const f=zn();return{token:f.BKC_TOKEN,spender:f.CHARITY_POOL,amount:d}}return null},validate:async(f,m)=>{const b=Ue(f);try{const u=await b.getCampaign(o);if(u.creator===i.ZeroAddress)throw new Error("Campaign not found");if(Number(u.status)!==Xt.ACTIVE)throw new Error("Campaign is not active")}catch(u){if(u.message.includes("Campaign")||u.message.includes("active"))throw u}try{d=await b.boostCostBkc(),t||(p=await b.boostCostEth())}catch{d=i.parseEther("0.5"),t||(p=i.parseEther("0.001"))}},onSuccess:s,onError:r})}async function eo(e){const n=await(await me()).getCampaign(e),a=Math.floor(Date.now()/1e3);return{id:e,creator:n.creator,title:n.title,description:n.description,goalAmount:n.goalAmount,raisedAmount:n.raisedAmount,donationCount:Number(n.donationCount),deadline:Number(n.deadline),createdAt:Number(n.createdAt),boostAmount:n.boostAmount,boostTime:Number(n.boostTime),status:Number(n.status),statusName:["ACTIVE","COMPLETED","CANCELLED","WITHDRAWN"][Number(n.status)]||"UNKNOWN",goalReached:n.goalReached,progress:n.goalAmount>0n?Number(n.raisedAmount*100n/n.goalAmount):0,isEnded:Number(n.deadline)<a,isActive:Number(n.status)===Xt.ACTIVE&&Number(n.deadline)>a,isBoosted:n.boostTime>0&&a-Number(n.boostTime)<86400}}async function to(e){const t=window.ethers,a=await(await me()).getDonation(e);return{id:e,donor:a.donor,campaignId:Number(a.campaignId),grossAmount:a.grossAmount,netAmount:a.netAmount,timestamp:Number(a.timestamp),grossFormatted:t.formatEther(a.grossAmount),netFormatted:t.formatEther(a.netAmount)}}async function no(){const e=await me();return Number(await e.campaignCounter())}async function ao(){const e=await me();return Number(await e.donationCounter())}async function so(e){const t=await me();return Number(await t.userActiveCampaigns(e))}async function ro(){const e=await me();return Number(await e.maxActiveCampaigns())}async function io(e){return(await(await me()).getUserCampaigns(e)).map(a=>Number(a))}async function oo(e){return(await(await me()).getUserDonations(e)).map(a=>Number(a))}async function lo(e){return(await(await me()).getCampaignDonations(e)).map(a=>Number(a))}async function co(e){const t=window.ethers,a=await(await me()).previewDonation(e);return{netToCampaign:a.netToCampaign,feeToProtocol:a.feeToProtocol,netFormatted:t.formatEther(a.netToCampaign),feeFormatted:t.formatEther(a.feeToProtocol)}}async function uo(e){const t=await me(),[n,a]=await t.canWithdraw(e);return{allowed:n,reason:a}}async function po(e){return await(await me()).isBoosted(e)}async function mo(){const e=window.ethers,n=await(await me()).getFeeConfig();return{createCostBkc:n.createBkc,createCostFormatted:e.formatEther(n.createBkc),withdrawCostBkc:n.withdrawBkc,withdrawCostFormatted:e.formatEther(n.withdrawBkc),donationFeeBips:Number(n.donationBips),donationFeePercent:Number(n.donationBips)/100,boostCostBkc:n.boostBkc,boostCostBkcFormatted:e.formatEther(n.boostBkc),boostCostEth:n.boostEth,boostCostEthFormatted:e.formatEther(n.boostEth)}}async function fo(){const e=window.ethers,n=await(await me()).getStats();return{totalCampaigns:Number(n.totalCampaigns),totalRaised:n.totalRaised,totalRaisedFormatted:e.formatEther(n.totalRaised),totalDonations:Number(n.totalDonations),totalFees:n.totalFees,totalFeesFormatted:e.formatEther(n.totalFees)}}async function bo(){const e=await me();try{return await e.withdrawCostBkc()}catch{return 0n}}async function go(){const e=await me();try{return await e.createCostBkc()}catch{return 0n}}const Jt={createCampaign:qi,donate:Xi,cancelCampaign:Ji,withdraw:Zi,boostCampaign:Qi,getCampaign:eo,getCampaignCount:no,getCampaignDonations:lo,canWithdraw:uo,isBoosted:po,getDonation:to,getDonationCount:ao,previewDonation:co,getUserActiveCampaigns:so,getMaxActiveCampaigns:ro,getUserCampaigns:io,getUserDonations:oo,getFeeConfig:mo,getStats:fo,getWithdrawalFee:bo,getCreateFee:go,CampaignStatus:Xt},$u=Object.freeze(Object.defineProperty({__proto__:null,CharityTx:Jt,boostCampaign:Qi,canWithdraw:uo,cancelCampaign:Ji,createCampaign:qi,donate:Xi,getCampaign:eo,getCampaignCount:no,getCampaignDonations:lo,getCreateFee:go,getDonation:to,getDonationCount:ao,getFeeConfig:mo,getMaxActiveCampaigns:ro,getStats:fo,getUserActiveCampaigns:so,getUserCampaigns:io,getUserDonations:oo,getWithdrawalFee:bo,isBoosted:po,previewDonation:co,withdraw:Zi},Symbol.toStringTag,{value:"Module"}));function Ss(){var n,a;const e=(w==null?void 0:w.delegationManager)||(R==null?void 0:R.delegationManager)||((n=window.contractAddresses)==null?void 0:n.delegationManager),t=(w==null?void 0:w.bkcToken)||(R==null?void 0:R.bkcToken)||((a=window.contractAddresses)==null?void 0:a.bkcToken);if(!e)throw console.error("❌ DelegationManager address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");if(!t)throw console.error("❌ BKC Token address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{BKC_TOKEN:t,DELEGATION_MANAGER:e}}const xo=["function delegate(uint256 amount, uint256 lockDuration, address operator) external","function unstake(uint256 delegationIndex, address operator) external","function forceUnstake(uint256 delegationIndex, address operator) external","function claimReward(address operator) external payable","function getDelegationsOf(address user) view returns (tuple(uint256 amount, uint64 unlockTime, uint64 lockDuration)[])","function pendingRewards(address user) view returns (uint256)","function userTotalPStake(address user) view returns (uint256)","function totalNetworkPStake() view returns (uint256)","function MIN_LOCK_DURATION() view returns (uint256)","function MAX_LOCK_DURATION() view returns (uint256)","function claimEthFee() view returns (uint256)","function getUserBestBoost(address user) view returns (uint256)","function getBurnRateForBoost(uint256 boost) view returns (uint256)","function previewClaim(address user) view returns (uint256 totalRewards, uint256 burnAmount, uint256 userReceives, uint256 burnRateBips, uint256 nftBoost)","event Delegated(address indexed user, uint256 indexed delegationIndex, uint256 amount, uint256 pStake, uint256 feePaid, address operator)","event Unstaked(address indexed user, uint256 indexed delegationIndex, uint256 amountReceived, uint256 feePaid, address operator)","event RewardClaimed(address indexed user, uint256 amountReceived, uint256 burnedAmount, uint256 ethFeePaid, uint256 nftBoostUsed, address operator)"];function Ct(e){const t=window.ethers,n=Ss();return new t.Contract(n.DELEGATION_MANAGER,xo,e)}async function Sn(){const e=window.ethers,{NetworkManager:t}=await Y(async()=>{const{NetworkManager:s}=await import("./index-C63_LXPF.js");return{NetworkManager:s}},[]),n=t.getProvider(),a=Ss();return new e.Contract(a.DELEGATION_MANAGER,xo,n)}function _u(e){return BigInt(e)*24n*60n*60n}async function ho({amount:e,lockDays:t,lockDuration:n,operator:a,button:s=null,onSuccess:r=null,onError:i=null}){let o;if(n!=null){o=BigInt(n);const p=Number(o)/86400;if(p<1||p>3650)throw new Error("Lock duration must be between 1 and 3650 days")}else if(t!=null)X.staking.validateDelegate({amount:e,lockDays:t}),o=_u(t);else throw new Error("Either lockDays or lockDuration must be provided");const l=BigInt(e);let d=a;return await Z.execute({name:"Delegate",button:s,getContract:async p=>Ct(p),method:"delegate",args:()=>[l,o,ce(d)],approval:(()=>{const p=Ss();return{token:p.BKC_TOKEN,spender:p.DELEGATION_MANAGER,amount:l}})(),onSuccess:r,onError:i})}async function vo({delegationIndex:e,operator:t,button:n=null,onSuccess:a=null,onError:s=null}){X.staking.validateUnstake({delegationIndex:e});let r=e,i=t;return await Z.execute({name:"Unstake",button:n,getContract:async o=>Ct(o),method:"unstake",args:()=>[r,ce(i)],validate:async(o,l)=>{const p=await Ct(o).getDelegationsOf(l);if(r>=p.length)throw new Error("Delegation not found");const f=p[r],m=Math.floor(Date.now()/1e3);if(Number(f.unlockTime)>m){const b=Math.ceil((Number(f.unlockTime)-m)/86400);throw new Error(`Lock period still active. ${b} day(s) remaining. Use Force Unstake if needed.`)}},onSuccess:a,onError:s})}async function wo({delegationIndex:e,operator:t,button:n=null,onSuccess:a=null,onError:s=null}){X.staking.validateUnstake({delegationIndex:e});let r=e,i=t;return await Z.execute({name:"ForceUnstake",button:n,getContract:async o=>Ct(o),method:"forceUnstake",args:()=>[r,ce(i)],validate:async(o,l)=>{const p=await Ct(o).getDelegationsOf(l);if(r>=p.length)throw new Error("Delegation not found");const f=p[r],m=Math.floor(Date.now()/1e3);if(Number(f.unlockTime)<=m)throw new Error("Lock period has ended. Use normal Unstake to avoid penalty.")},onSuccess:a,onError:s})}async function yo({operator:e,button:t=null,onSuccess:n=null,onError:a=null}={}){let s=e,r=0n;return await Z.execute({name:"ClaimRewards",button:t,getContract:async i=>Ct(i),method:"claimReward",args:()=>[ce(s)],get value(){return r},validate:async(i,o)=>{const l=Ct(i);if(await l.pendingRewards(o)<=0n)throw new Error("No rewards available to claim");try{r=await l.claimEthFee()}catch{r=0n}},onSuccess:n,onError:a})}async function ko(e){const n=await(await Sn()).getDelegationsOf(e),a=Math.floor(Date.now()/1e3);return n.map((s,r)=>({index:r,amount:s.amount,unlockTime:Number(s.unlockTime),lockDuration:Number(s.lockDuration),isUnlocked:Number(s.unlockTime)<=a,daysRemaining:Number(s.unlockTime)>a?Math.ceil((Number(s.unlockTime)-a)/86400):0}))}async function To(e){return await(await Sn()).pendingRewards(e)}async function Eo(e){return await(await Sn()).userTotalPStake(e)}async function Co(){return await(await Sn()).totalNetworkPStake()}async function Io(){return 50}async function Ao(){const e=await Sn(),[t,n]=await Promise.all([e.MIN_LOCK_DURATION(),e.MAX_LOCK_DURATION()]);return{minLockDays:Number(t)/86400,maxLockDays:Number(n)/86400,minLockSeconds:Number(t),maxLockSeconds:Number(n),penaltyPercent:50,penaltyBips:5e3}}const It={delegate:ho,unstake:vo,forceUnstake:wo,claimRewards:yo,getUserDelegations:ko,getPendingRewards:To,getUserPStake:Eo,getTotalPStake:Co,getEarlyUnstakePenalty:Io,getStakingConfig:Ao},Fu=Object.freeze(Object.defineProperty({__proto__:null,StakingTx:It,claimRewards:yo,delegate:ho,forceUnstake:wo,getEarlyUnstakePenalty:Io,getPendingRewards:To,getStakingConfig:Ao,getTotalPStake:Co,getUserDelegations:ko,getUserPStake:Eo,unstake:vo},Symbol.toStringTag,{value:"Module"})),Bo=["diamond","gold","silver","bronze"];function Rn(e=null){var s,r,i;const t=(w==null?void 0:w.bkcToken)||(R==null?void 0:R.bkcToken)||((s=window.contractAddresses)==null?void 0:s.bkcToken),n=(w==null?void 0:w.rewardBoosterNFT)||(R==null?void 0:R.rewardBoosterNFT)||((r=window.contractAddresses)==null?void 0:r.rewardBoosterNFT);let a=null;if(e){const o=`pool_${e.toLowerCase()}`;a=(w==null?void 0:w[o])||(R==null?void 0:R[o])||((i=window.contractAddresses)==null?void 0:i[o])}if(!t||!n)throw new Error("Contract addresses not loaded");return{BKC_TOKEN:t,NFT_CONTRACT:n,NFT_POOL:a}}function zt(e){var n;const t=`pool_${e.toLowerCase()}`;return(w==null?void 0:w[t])||(R==null?void 0:R[t])||((n=window.contractAddresses)==null?void 0:n[t])||null}function Mu(){const e={};for(const t of Bo){const n=zt(t);n&&(e[t]=n)}return e}const ya=["function buyNFT(address _operator) external payable returns (uint256 tokenId)","function buySpecificNFT(uint256 _tokenId, address _operator) external payable","function buyNFTWithSlippage(uint256 _maxPrice, address _operator) external payable returns (uint256 tokenId)","function sellNFT(uint256 _tokenId, uint256 _minPayout, address _operator) external payable","function getBuyPrice() view returns (uint256)","function getBuyPriceWithTax() view returns (uint256)","function getSellPrice() view returns (uint256)","function getSellPriceAfterTax() view returns (uint256)","function getTotalBuyCost() view returns (uint256 bkcCost, uint256 ethCost)","function getTotalSellInfo() view returns (uint256 bkcPayout, uint256 ethCost)","function getSpread() view returns (uint256 spread, uint256 spreadBips)","function getPoolInfo() view returns (uint256 bkcBalance, uint256 nftCount, uint256 k, bool initialized)","function getAvailableNFTs() view returns (uint256[])","function getNFTBalance() view returns (uint256)","function getBKCBalance() view returns (uint256)","function isNFTInPool(uint256 _tokenId) view returns (bool)","function boostBips() view returns (uint256)","function getTierName() view returns (string)","function buyEthFee() view returns (uint256)","function sellEthFee() view returns (uint256)","function getEthFeeConfig() view returns (uint256 buyFee, uint256 sellFee, uint256 totalCollected)","function totalETHCollected() view returns (uint256)","function getTradingStats() view returns (uint256 volume, uint256 taxes, uint256 buys, uint256 sells)","function totalVolume() view returns (uint256)","function totalTaxesCollected() view returns (uint256)","function totalBuys() view returns (uint256)","function totalSells() view returns (uint256)","event NFTPurchased(address indexed buyer, uint256 indexed tokenId, uint256 price, uint256 tax, uint256 newBkcBalance, uint256 newNftCount, address operator)","event NFTSold(address indexed seller, uint256 indexed tokenId, uint256 payout, uint256 tax, uint256 newBkcBalance, uint256 newNftCount, address operator)"],Po=["function setApprovalForAll(address operator, bool approved) external","function isApprovedForAll(address owner, address operator) view returns (bool)","function ownerOf(uint256 tokenId) view returns (address)","function balanceOf(address owner) view returns (uint256)","function boostBips(uint256 tokenId) view returns (uint256)"];function ct(e,t){return new window.ethers.Contract(t,ya,e)}async function Ce(e){const{NetworkManager:t}=await Y(async()=>{const{NetworkManager:n}=await import("./index-C63_LXPF.js");return{NetworkManager:n}},[]);return new window.ethers.Contract(e,ya,t.getProvider())}function ts(e){const t=Rn();return new window.ethers.Contract(t.NFT_CONTRACT,Po,e)}async function Du(){const{NetworkManager:e}=await Y(async()=>{const{NetworkManager:n}=await import("./index-C63_LXPF.js");return{NetworkManager:n}},[]),t=Rn();return new window.ethers.Contract(t.NFT_CONTRACT,Po,e.getProvider())}async function Rs({poolAddress:e,poolTier:t,operator:n,button:a=null,onSuccess:s=null,onError:r=null}){const i=window.ethers,o=Rn(),l=e||zt(t);if(!l)throw new Error("Pool address or valid pool tier is required");let d=n,p=0n,f=0n;return await Z.execute({name:"BuyNFT",button:a,getContract:async m=>ct(m,l),method:"buyNFT",args:()=>[ce(d)],get value(){return f},get approval(){return p>0n?{token:o.BKC_TOKEN,spender:l,amount:p}:null},validate:async(m,b)=>{const u=ct(m,l);if(await u.getNFTBalance()===0n)throw new Error("No NFTs available in pool");try{const[z,T]=await u.getTotalBuyCost();p=z,f=T}catch{p=await u.getBuyPriceWithTax(),f=await u.buyEthFee().catch(()=>0n)}const{NetworkManager:y}=await Y(async()=>{const{NetworkManager:z}=await import("./index-C63_LXPF.js");return{NetworkManager:z}},[]),k=y.getProvider();if(await new i.Contract(o.BKC_TOKEN,["function balanceOf(address) view returns (uint256)"],k).balanceOf(b)<p)throw new Error(`Insufficient BKC. Need ${i.formatEther(p)} BKC`);if(await k.getBalance(b)<f+i.parseEther("0.001"))throw new Error("Insufficient ETH for fee + gas")},onSuccess:async m=>{let b=null;try{const u=new i.Interface(ya);for(const g of m.logs)try{const y=u.parseLog(g);if((y==null?void 0:y.name)==="NFTPurchased"){b=Number(y.args.tokenId);break}}catch{}}catch{}s&&s(m,b)},onError:r})}async function No({poolAddress:e,poolTier:t,tokenId:n,operator:a,button:s=null,onSuccess:r=null,onError:i=null}){const o=window.ethers,l=Rn(),d=e||zt(t);if(!d)throw new Error("Pool address or valid pool tier is required");if(n===void 0)throw new Error("Token ID is required");let p=a,f=0n,m=0n;return await Z.execute({name:"BuySpecificNFT",button:s,getContract:async b=>ct(b,d),method:"buySpecificNFT",args:()=>[n,ce(p)],get value(){return m},get approval(){return f>0n?{token:l.BKC_TOKEN,spender:d,amount:f}:null},validate:async(b,u)=>{const g=ct(b,d);if(!await g.isNFTInPool(n))throw new Error("NFT is not in pool");try{const[I,N]=await g.getTotalBuyCost();f=I,m=N}catch{f=await g.getBuyPriceWithTax(),m=await g.buyEthFee().catch(()=>0n)}const{NetworkManager:y}=await Y(async()=>{const{NetworkManager:I}=await import("./index-C63_LXPF.js");return{NetworkManager:I}},[]),k=y.getProvider();if(await new o.Contract(l.BKC_TOKEN,["function balanceOf(address) view returns (uint256)"],k).balanceOf(u)<f)throw new Error("Insufficient BKC");if(await k.getBalance(u)<m+o.parseEther("0.001"))throw new Error("Insufficient ETH")},onSuccess:r,onError:i})}async function zo({poolAddress:e,poolTier:t,maxPrice:n,operator:a,button:s=null,onSuccess:r=null,onError:i=null}){const o=window.ethers,l=Rn(),d=e||zt(t);if(!d)throw new Error("Pool address or valid pool tier is required");const p=BigInt(n);let f=a,m=0n;return await Z.execute({name:"BuyNFTWithSlippage",button:s,getContract:async b=>ct(b,d),method:"buyNFTWithSlippage",args:()=>[p,ce(f)],get value(){return m},approval:{token:l.BKC_TOKEN,spender:d,amount:p},validate:async(b,u)=>{const g=ct(b,d);if(await g.getNFTBalance()===0n)throw new Error("No NFTs available");if(await g.getBuyPriceWithTax()>p)throw new Error("Price exceeds max");m=await g.buyEthFee().catch(()=>0n);const{NetworkManager:k}=await Y(async()=>{const{NetworkManager:N}=await import("./index-C63_LXPF.js");return{NetworkManager:N}},[]),E=k.getProvider();if(await new o.Contract(l.BKC_TOKEN,["function balanceOf(address) view returns (uint256)"],E).balanceOf(u)<p)throw new Error("Insufficient BKC");if(await E.getBalance(u)<m+o.parseEther("0.001"))throw new Error("Insufficient ETH")},onSuccess:async b=>{let u=null;try{const g=new o.Interface(ya);for(const y of b.logs)try{const k=g.parseLog(y);if((k==null?void 0:k.name)==="NFTPurchased"){u=Number(k.args.tokenId);break}}catch{}}catch{}r&&r(b,u)},onError:i})}async function $s({poolAddress:e,poolTier:t,tokenId:n,minPayout:a,operator:s,button:r=null,onSuccess:i=null,onError:o=null}){const l=window.ethers,d=e||zt(t);if(!d)throw new Error("Pool address or valid pool tier is required");if(n===void 0)throw new Error("Token ID is required");let p=s,f=0n,m=0n;return await Z.execute({name:"SellNFT",button:r,getContract:async b=>ct(b,d),method:"sellNFT",args:()=>[n,f,ce(p)],get value(){return m},validate:async(b,u)=>{const g=ct(b,d),y=ts(b);if((await y.ownerOf(n)).toLowerCase()!==u.toLowerCase())throw new Error("You do not own this NFT");const E=await g.boostBips(),I=await y.boostBips(n);if(E!==I)throw new Error("NFT tier does not match pool tier");try{const[T,F]=await g.getTotalSellInfo();f=a?BigInt(a):T*95n/100n,m=F}catch{const T=await g.getSellPriceAfterTax();f=a?BigInt(a):T*95n/100n,m=await g.sellEthFee().catch(()=>0n)}const{NetworkManager:N}=await Y(async()=>{const{NetworkManager:T}=await import("./index-C63_LXPF.js");return{NetworkManager:T}},[]);if(await N.getProvider().getBalance(u)<m+l.parseEther("0.001"))throw new Error("Insufficient ETH");await y.isApprovedForAll(u,d)||await(await y.setApprovalForAll(d,!0)).wait()},onSuccess:i,onError:o})}async function Lo({poolAddress:e,poolTier:t,button:n=null,onSuccess:a=null,onError:s=null}){const r=e||zt(t);if(!r)throw new Error("Pool address or valid pool tier is required");return await Z.execute({name:"ApproveAllNFTs",button:n,getContract:async i=>ts(i),method:"setApprovalForAll",args:[r,!0],validate:async(i,o)=>{if(await ts(i).isApprovedForAll(o,r))throw new Error("Already approved")},onSuccess:a,onError:s})}async function So(e){return await(await Ce(e)).getBuyPrice()}async function Ro(e){return await(await Ce(e)).getBuyPriceWithTax()}async function $o(e){return await(await Ce(e)).getSellPrice()}async function _o(e){return await(await Ce(e)).getSellPriceAfterTax()}async function Fo(e){const t=window.ethers,n=await Ce(e);try{const[a,s]=await n.getTotalBuyCost();return{bkcCost:a,bkcFormatted:t.formatEther(a),ethCost:s,ethFormatted:t.formatEther(s)}}catch{const a=await n.getBuyPriceWithTax(),s=await n.buyEthFee().catch(()=>0n);return{bkcCost:a,bkcFormatted:t.formatEther(a),ethCost:s,ethFormatted:t.formatEther(s)}}}async function Mo(e){const t=window.ethers,n=await Ce(e);try{const[a,s]=await n.getTotalSellInfo();return{bkcPayout:a,bkcFormatted:t.formatEther(a),ethCost:s,ethFormatted:t.formatEther(s)}}catch{const a=await n.getSellPriceAfterTax(),s=await n.sellEthFee().catch(()=>0n);return{bkcPayout:a,bkcFormatted:t.formatEther(a),ethCost:s,ethFormatted:t.formatEther(s)}}}async function Do(e){const t=window.ethers,n=await Ce(e),[a,s,r,i]=await Promise.all([n.getPoolInfo(),n.getBuyPrice().catch(()=>0n),n.getSellPrice().catch(()=>0n),n.boostBips()]);return{bkcBalance:a.bkcBalance,nftCount:Number(a.nftCount),k:a.k,initialized:a.initialized,boostBips:Number(i),buyPrice:s,buyPriceFormatted:t.formatEther(s),sellPrice:r,sellPriceFormatted:t.formatEther(r)}}async function Oo(e){return(await(await Ce(e)).getAvailableNFTs()).map(n=>Number(n))}async function Ho(e){const t=window.ethers,n=await Ce(e);try{const a=await n.getEthFeeConfig();return{buyFee:a.buyFee,buyFeeFormatted:t.formatEther(a.buyFee),sellFee:a.sellFee,sellFeeFormatted:t.formatEther(a.sellFee),totalCollected:a.totalCollected,totalCollectedFormatted:t.formatEther(a.totalCollected)}}catch{const[a,s,r]=await Promise.all([n.buyEthFee().catch(()=>0n),n.sellEthFee().catch(()=>0n),n.totalETHCollected().catch(()=>0n)]);return{buyFee:a,buyFeeFormatted:t.formatEther(a),sellFee:s,sellFeeFormatted:t.formatEther(s),totalCollected:r,totalCollectedFormatted:t.formatEther(r)}}}async function Uo(e){const t=window.ethers,n=await Ce(e);try{const a=await n.getTradingStats();return{volume:a.volume,volumeFormatted:t.formatEther(a.volume),taxes:a.taxes,taxesFormatted:t.formatEther(a.taxes),buys:Number(a.buys),sells:Number(a.sells)}}catch{const[a,s,r,i]=await Promise.all([n.totalVolume().catch(()=>0n),n.totalTaxesCollected().catch(()=>0n),n.totalBuys().catch(()=>0n),n.totalSells().catch(()=>0n)]);return{volume:a,volumeFormatted:t.formatEther(a),taxes:s,taxesFormatted:t.formatEther(s),buys:Number(r),sells:Number(i)}}}async function jo(e){const t=await Ce(e);try{return await t.getTierName()}catch{const n=await t.boostBips();return{5e3:"Diamond",4e3:"Gold",2500:"Silver",1e3:"Bronze"}[Number(n)]||"Unknown"}}async function Wo(e){const t=window.ethers,n=await Ce(e);try{const a=await n.getSpread();return{spread:a.spread,spreadFormatted:t.formatEther(a.spread),spreadBips:Number(a.spreadBips),spreadPercent:Number(a.spreadBips)/100}}catch{const[a,s]=await Promise.all([n.getBuyPrice().catch(()=>0n),n.getSellPrice().catch(()=>0n)]),r=a>s?a-s:0n,i=s>0n?Number(r*10000n/s):0;return{spread:r,spreadFormatted:t.formatEther(r),spreadBips:i,spreadPercent:i/100}}}async function Go(e,t){return await(await Ce(e)).isNFTInPool(t)}async function Ko(e,t){return await(await Du()).isApprovedForAll(e,t)}const Yo=Rs,Vo=$s,ns={buyNft:Rs,buySpecificNft:No,buyNftWithSlippage:zo,sellNft:$s,approveAllNfts:Lo,buyFromPool:Yo,sellToPool:Vo,getBuyPrice:So,getBuyPriceWithTax:Ro,getSellPrice:$o,getSellPriceAfterTax:_o,getTotalBuyCost:Fo,getTotalSellInfo:Mo,getEthFeeConfig:Ho,getPoolInfo:Do,getAvailableNfts:Oo,isNFTInPool:Go,isApprovedForAll:Ko,getTradingStats:Uo,getTierName:jo,getSpread:Wo,getPoolAddress:zt,getAllPools:Mu,POOL_TIERS:Bo},Ou=Object.freeze(Object.defineProperty({__proto__:null,NftTx:ns,approveAllNfts:Lo,buyFromPool:Yo,buyNft:Rs,buyNftWithSlippage:zo,buySpecificNft:No,getAvailableNfts:Oo,getBuyPrice:So,getBuyPriceWithTax:Ro,getEthFeeConfig:Ho,getPoolInfo:Do,getSellPrice:$o,getSellPriceAfterTax:_o,getSpread:Wo,getTierName:jo,getTotalBuyCost:Fo,getTotalSellInfo:Mo,getTradingStats:Uo,isApprovedForAll:Ko,isNFTInPool:Go,sellNft:$s,sellToPool:Vo},Symbol.toStringTag,{value:"Module"}));function _s(){var n,a,s;const e=(w==null?void 0:w.fortunePoolV2)||(w==null?void 0:w.fortunePool)||(R==null?void 0:R.fortunePoolV2)||(R==null?void 0:R.fortunePool)||((n=window.contractAddresses)==null?void 0:n.fortunePoolV2)||((a=window.contractAddresses)==null?void 0:a.fortunePool),t=(w==null?void 0:w.bkcToken)||(R==null?void 0:R.bkcToken)||((s=window.contractAddresses)==null?void 0:s.bkcToken);if(!e)throw console.error("❌ FortunePool address not found!",{addresses:w,contractAddresses:R}),new Error("Contract addresses not loaded. Please refresh the page.");if(!t)throw console.error("❌ BKC Token address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{BKC_TOKEN:t,FORTUNE_POOL:e}}const ka=["function commitPlay(bytes32 _commitmentHash, uint256 _wagerAmount, bool _isCumulative, address _operator) external payable returns (uint256 gameId)","function revealPlay(uint256 _gameId, uint256[] calldata _guesses, bytes32 _userSecret) external returns (uint256 prizeWon)","function generateCommitmentHash(uint256[] calldata _guesses, bytes32 _userSecret) external pure returns (bytes32 hash)","function claimExpiredGame(uint256 _gameId) external","function activeTierCount() view returns (uint256)","function prizeTiers(uint256 tierId) view returns (uint128 maxRange, uint64 multiplierBips, bool active)","function getAllTiers() view returns (uint128[] ranges, uint64[] multipliers)","function serviceFee() view returns (uint256)","function getRequiredServiceFee(bool _isCumulative) view returns (uint256)","function gameFeeBips() view returns (uint256)","function gameCounter() view returns (uint256)","function prizePoolBalance() view returns (uint256)","function revealDelay() view returns (uint256)","function revealWindow() view returns (uint256)","function getCommitment(uint256 _gameId) view returns (address player, uint64 commitBlock, bool isCumulative, uint8 status, uint256 wagerAmount, uint256 ethPaid)","function getCommitmentStatus(uint256 _gameId) view returns (uint8 status, bool canReveal, bool isExpired, uint256 blocksUntilReveal, uint256 blocksUntilExpiry)","function commitmentMeta(uint256 _gameId) view returns (bytes32 hash, address operator, uint96 tierNonce)","function getGameResult(uint256 _gameId) view returns (address player, uint256 wagerAmount, uint256 prizeWon, uint256[] guesses, uint256[] rolls, bool isCumulative, uint8 matchCount, uint256 timestamp)","function totalWageredAllTime() view returns (uint256)","function totalPaidOutAllTime() view returns (uint256)","function totalWinsAllTime() view returns (uint256)","function totalETHCollected() view returns (uint256)","function totalBKCFees() view returns (uint256)","function totalExpiredGames() view returns (uint256)","function getPoolStats() view returns (uint256 poolBalance, uint256 gamesPlayed, uint256 wageredAllTime, uint256 paidOutAllTime, uint256 winsAllTime, uint256 ethCollected, uint256 bkcFees, uint256 expiredGames)","function calculatePotentialWinnings(uint256 _wagerAmount, bool _isCumulative) view returns (uint256 maxPrize, uint256 netWager)","function getExpectedGuessCount(bool _isCumulative) view returns (uint256)","event GameCommitted(uint256 indexed gameId, address indexed player, uint256 wagerAmount, bool isCumulative, address operator)","event GameRevealed(uint256 indexed gameId, address indexed player, uint256 wagerAmount, uint256 prizeWon, bool isCumulative, uint8 matchCount, address operator)","event GameDetails(uint256 indexed gameId, uint256[] guesses, uint256[] rolls, bool[] matches)","event JackpotWon(uint256 indexed gameId, address indexed player, uint256 prizeAmount, uint256 tier)","event GameExpired(uint256 indexed gameId, address indexed player, uint256 forfeitedAmount)"];function qo(e){const t=window.ethers,n=_s();return new t.Contract(n.FORTUNE_POOL,ka,e)}async function Pe(){const e=window.ethers,{NetworkManager:t}=await Y(async()=>{const{NetworkManager:s}=await import("./index-C63_LXPF.js");return{NetworkManager:s}},[]),n=t.getProvider(),a=_s();return new e.Contract(a.FORTUNE_POOL,ka,n)}const Fs="fortune_pending_games";function Ta(){try{return JSON.parse(localStorage.getItem(Fs)||"{}")}catch{return{}}}function Hu(e,t){const n=Ta();n[e]={...t,savedAt:Date.now()},localStorage.setItem(Fs,JSON.stringify(n))}function Uu(e){const t=Ta();delete t[e],localStorage.setItem(Fs,JSON.stringify(t))}function Ms(e,t){const n=window.ethers,a=n.solidityPacked(["uint256[]","bytes32"],[e.map(s=>BigInt(s)),t]);return n.keccak256(a)}function Xo(){const e=window.ethers;return e.hexlify(e.randomBytes(32))}async function Ds({commitmentHash:e,wagerAmount:t,isCumulative:n=!1,operator:a,button:s=null,onSuccess:r=null,onError:i=null}){const o=window.ethers,l=_s(),d=BigInt(t);let p=e,f=n,m=a,b=0n;try{b=await(await Pe()).getRequiredServiceFee(n),console.log("[FortuneTx] Service fee:",o.formatEther(b),"ETH")}catch(u){throw console.error("[FortuneTx] Could not fetch service fee:",u.message),new Error("Could not fetch service fee from contract")}return await Z.execute({name:"CommitPlay",button:s,getContract:async u=>qo(u),method:"commitPlay",args:()=>[p,d,f,ce(m)],value:b,approval:{token:l.BKC_TOKEN,spender:l.FORTUNE_POOL,amount:d},validate:async(u,g)=>{const{NetworkManager:y}=await Y(async()=>{const{NetworkManager:z}=await import("./index-C63_LXPF.js");return{NetworkManager:z}},[]),k=y.getProvider(),E=await Pe(),I=await k.getBalance(g);if(b>0n&&I<b)throw new Error(`Insufficient ETH for service fee (${o.formatEther(b)} ETH required)`);if(Number(await E.activeTierCount())===0)throw new Error("No active tiers available");if(d<=0n)throw new Error("Wager amount must be greater than 0")},onSuccess:async u=>{let g=null;try{const y=new o.Interface(ka);for(const k of u.logs)try{const E=y.parseLog(k);if(E.name==="GameCommitted"){g=Number(E.args.gameId);break}}catch{}}catch{}r&&r({gameId:g,txHash:u.hash,commitBlock:u.blockNumber})},onError:i})}async function Os({gameId:e,guesses:t,userSecret:n,button:a=null,onSuccess:s=null,onError:r=null}){const i=window.ethers,o=t.map(l=>BigInt(l));return await Z.execute({name:"RevealPlay",button:a,getContract:async l=>qo(l),method:"revealPlay",args:[e,o,n],validate:async(l,d)=>{const p=await Pe(),f=await p.getCommitmentStatus(e);if(f.isExpired)throw new Error("Game has expired. You can no longer reveal.");if(!f.canReveal)throw f.blocksUntilReveal>0?new Error(`Must wait ${f.blocksUntilReveal} more blocks before reveal`):new Error("Cannot reveal this game");if((await p.getCommitment(e)).player.toLowerCase()!==d.toLowerCase())throw new Error("You are not the owner of this game");const b=await p.commitmentMeta(e),u=Ms(t,n);if(b.hash.toLowerCase()!==u.toLowerCase())throw new Error("Hash mismatch - guesses or secret do not match commitment")},onSuccess:async l=>{let d=null;try{const p=new i.Interface(ka);for(const f of l.logs)try{const m=p.parseLog(f);m.name==="GameRevealed"&&(d={gameId:Number(m.args.gameId),wagerAmount:m.args.wagerAmount,prizeWon:m.args.prizeWon,isCumulative:m.args.isCumulative,matchCount:Number(m.args.matchCount),won:m.args.prizeWon>0n}),m.name==="GameDetails"&&d&&(d.guesses=m.args.guesses.map(b=>Number(b)),d.rolls=m.args.rolls.map(b=>Number(b)),d.matches=m.args.matches),m.name==="JackpotWon"&&d&&(d.jackpot=!0,d.jackpotTier=Number(m.args.tier))}catch{}}catch{}Uu(e),s&&s(l,d)},onError:r})}async function Jo({wagerAmount:e,guess:t,guesses:n,isCumulative:a=!1,operator:s,button:r=null,onSuccess:i=null,onError:o=null}){let l=[];if(a)if(n&&Array.isArray(n)&&n.length>0)l=n.map(b=>Number(b));else if(t!==void 0)l=[Number(Array.isArray(t)?t[0]:t)];else throw new Error("Guesses array is required for cumulative mode");else{let b;if(t!==void 0)b=Array.isArray(t)?t[0]:t;else if(n&&n.length>0)b=n[n.length-1];else throw new Error("Guess is required");l=[Number(b)]}const d=await Pe(),p=Number(await d.activeTierCount());if(p===0)throw new Error("No active tiers available");if(a){if(l.length!==p)throw new Error(`Cumulative mode requires ${p} guesses (one per tier), got ${l.length}`);for(let b=0;b<p;b++){const u=await d.prizeTiers(b+1),g=Number(u.maxRange);if(l[b]<1||l[b]>g)throw new Error(`Tier ${b+1} guess must be between 1 and ${g}`)}}else{if(l.length!==1)throw new Error("Jackpot mode requires exactly 1 guess");const b=await d.prizeTiers(p),u=Number(b.maxRange);if(l[0]<1||l[0]>u)throw new Error(`Jackpot guess must be between 1 and ${u}`)}const f=Xo(),m=Ms(l,f);return console.log("[FortuneTx] Generated commitment:",{guesses:l,userSecret:f.slice(0,10)+"...",commitmentHash:m.slice(0,10)+"..."}),await Ds({commitmentHash:m,wagerAmount:e,isCumulative:a,operator:s,button:r,onSuccess:b=>{Hu(b.gameId,{guesses:l,userSecret:f,isCumulative:a,wagerAmount:e.toString(),commitmentHash:m}),console.log("[FortuneTx] Game committed, stored for reveal:",b.gameId),i&&i({...b,guesses:l,userSecret:f,isCumulative:a})},onError:o})}async function Zo(){const e=await Pe(),t=Number(await e.activeTierCount()),n=[];for(let a=1;a<=t;a++)try{const s=await e.prizeTiers(a);s.active&&n.push({tierId:a,maxRange:Number(s.maxRange),multiplierBips:Number(s.multiplierBips),multiplier:Number(s.multiplierBips)/1e4,active:s.active})}catch{break}return n}async function Qo(e){const t=await Pe();try{const n=await t.prizeTiers(e);if(n.active)return{tierId:e,maxRange:Number(n.maxRange),multiplierBips:Number(n.multiplierBips),multiplier:Number(n.multiplierBips)/1e4,active:n.active}}catch{}return null}async function el(e=!1){const t=await Pe();try{return await t.getRequiredServiceFee(e)}catch{try{const a=await t.serviceFee();return e?a*5n:a}catch{return console.warn("[FortuneTx] Could not fetch service fee"),0n}}}async function tl(){const e=window.ethers,t=await Pe();try{const n=await t.getPoolStats();return{prizePoolBalance:n.poolBalance,prizePoolFormatted:e.formatEther(n.poolBalance),gameCounter:Number(n.gamesPlayed),totalWageredAllTime:n.wageredAllTime,totalWageredFormatted:e.formatEther(n.wageredAllTime),totalPaidOutAllTime:n.paidOutAllTime,totalPaidOutFormatted:e.formatEther(n.paidOutAllTime),totalWinsAllTime:Number(n.winsAllTime),totalETHCollected:n.ethCollected,totalBKCFees:n.bkcFees,totalExpiredGames:Number(n.expiredGames)}}catch{const[n,a,s,r,i]=await Promise.all([t.gameCounter().catch(()=>0n),t.prizePoolBalance().catch(()=>0n),t.totalWageredAllTime().catch(()=>0n),t.totalPaidOutAllTime().catch(()=>0n),t.totalWinsAllTime().catch(()=>0n)]);return{gameCounter:Number(n),prizePoolBalance:a,prizePoolFormatted:e.formatEther(a),totalWageredAllTime:s,totalWageredFormatted:e.formatEther(s),totalPaidOutAllTime:r,totalPaidOutFormatted:e.formatEther(r),totalWinsAllTime:Number(i)}}}async function nl(){const e=await Pe();return Number(await e.activeTierCount())}async function al(e,t=!1){const n=window.ethers,a=await Pe();try{const s=await a.calculatePotentialWinnings(e,t);return{maxPrize:s.maxPrize,maxPrizeFormatted:n.formatEther(s.maxPrize),netWager:s.netWager,netWagerFormatted:n.formatEther(s.netWager)}}catch{return{maxPrize:0n,netWager:0n}}}async function sl(e){const t=await Pe();try{const n=await t.getGameResult(e);return{player:n.player,wagerAmount:n.wagerAmount,prizeWon:n.prizeWon,guesses:n.guesses.map(a=>Number(a)),rolls:n.rolls.map(a=>Number(a)),isCumulative:n.isCumulative,matchCount:Number(n.matchCount),timestamp:Number(n.timestamp),won:n.prizeWon>0n}}catch{return null}}async function rl(e){const t=await Pe();try{const n=await t.getCommitmentStatus(e);return{status:Number(n.status),statusName:["NONE","COMMITTED","REVEALED","EXPIRED"][Number(n.status)]||"UNKNOWN",canReveal:n.canReveal,isExpired:n.isExpired,blocksUntilReveal:Number(n.blocksUntilReveal),blocksUntilExpiry:Number(n.blocksUntilExpiry)}}catch{return null}}function il(){return Ta()}function Hs(e){return Ta()[e]||null}async function ol(e,t={}){const n=Hs(e);if(!n)throw new Error(`No pending game found with ID ${e}`);return await Os({gameId:e,guesses:n.guesses,userSecret:n.userSecret,...t})}const Us={commitPlay:Ds,revealPlay:Os,playGame:Jo,revealPendingGame:ol,getPendingGamesForReveal:il,getPendingGame:Hs,generateCommitmentHashLocal:Ms,generateSecret:Xo,getActiveTiers:Zo,getTierById:Qo,getServiceFee:el,getPoolStats:tl,getActiveTierCount:nl,calculatePotentialWin:al,getGameResult:sl,getCommitmentStatus:rl},ju=Object.freeze(Object.defineProperty({__proto__:null,FortuneTx:Us,calculatePotentialWin:al,commitPlay:Ds,getActiveTierCount:nl,getActiveTiers:Zo,getCommitmentStatus:rl,getGameResult:sl,getPendingGame:Hs,getPendingGamesForReveal:il,getPoolStats:tl,getServiceFee:el,getTierById:Qo,playGame:Jo,revealPendingGame:ol,revealPlay:Os},Symbol.toStringTag,{value:"Module"}));function Zt(){var a,s,r;const e=(w==null?void 0:w.bkcToken)||(R==null?void 0:R.bkcToken)||((a=window.contractAddresses)==null?void 0:a.bkcToken),t=(w==null?void 0:w.rentalManager)||(R==null?void 0:R.rentalManager)||((s=window.contractAddresses)==null?void 0:s.rentalManager),n=(w==null?void 0:w.rewardBoosterNFT)||(R==null?void 0:R.rewardBoosterNFT)||((r=window.contractAddresses)==null?void 0:r.rewardBoosterNFT);if(!e||!t||!n)throw new Error("Contract addresses not loaded. Please refresh the page.");return{BKC_TOKEN:e,RENTAL_MARKETPLACE:t,NFT_CONTRACT:n}}const js=["function listNFT(uint256 _tokenId, uint256 _pricePerHour, uint256 _minHours, uint256 _maxHours) external","function updateListing(uint256 _tokenId, uint256 _pricePerHour, uint256 _minHours, uint256 _maxHours) external","function withdrawNFT(uint256 _tokenId) external","function rentNFT(uint256 _tokenId, uint256 _hours, address _operator) external","function rentNFTSimple(uint256 _tokenId, address _operator) external","function spotlightListing(uint256 _tokenId, address _operator) external payable","function getListing(uint256 _tokenId) view returns (tuple(address owner, uint256 pricePerHour, uint256 minHours, uint256 maxHours, bool isActive, uint256 totalEarnings, uint256 rentalCount))","function getAllListedTokenIds() view returns (uint256[])","function getListingCount() view returns (uint256)","function getRental(uint256 _tokenId) view returns (tuple(address tenant, uint256 startTime, uint256 endTime, uint256 paidAmount))","function isRented(uint256 _tokenId) view returns (bool)","function getRemainingRentalTime(uint256 _tokenId) view returns (uint256)","function hasRentalRights(uint256 _tokenId, address _user) view returns (bool)","function getRentalCost(uint256 _tokenId, uint256 _hours) view returns (uint256 totalCost, uint256 protocolFee, uint256 ownerPayout)","function listingSpotlight(uint256 tokenId) view returns (uint256 totalAmount, uint256 lastSpotlightTime)","function getEffectiveSpotlight(uint256 _tokenId) view returns (uint256 effectiveAmount, uint256 daysPassed)","function getSpotlightedListingsPaginated(uint256 _offset, uint256 _limit) view returns (uint256[] tokenIds, uint256[] effectiveSpotlights, uint256 total)","function getSpotlightConfig() view returns (uint256 decayPerDayBips, uint256 minAmount, uint256 maxDays, uint256 totalSpotlightedListings, uint256 totalCollected)","function minSpotlightAmount() view returns (uint256)","function hasActiveRental(address _user) view returns (bool)","function getUserActiveRentals(address _user) view returns (uint256[] tokenIds, uint256[] endTimes)","function paused() view returns (bool)","function rentalFeeBips() view returns (uint256)","function getFeeConfig() view returns (uint256 miningFeeBips, uint256 burnFeeBips, uint256 totalFeeBips)","function getMarketplaceStats() view returns (uint256 activeListings, uint256 totalVol, uint256 totalFees, uint256 rentals, uint256 spotlightTotal, uint256 ethCollected, uint256 bkcFees)","event NFTListed(uint256 indexed tokenId, address indexed owner, uint256 pricePerHour, uint256 minHours, uint256 maxHours)","event NFTRented(uint256 indexed tokenId, address indexed tenant, address indexed owner, uint256 hours_, uint256 totalCost, uint256 protocolFee, uint256 ownerPayout, uint256 endTime, address operator)","event ListingSpotlighted(uint256 indexed tokenId, address indexed owner, uint256 amount, uint256 newTotal, uint256 timestamp, address operator)"],Wu=["function setApprovalForAll(address operator, bool approved) external","function isApprovedForAll(address owner, address operator) view returns (bool)","function ownerOf(uint256 tokenId) view returns (address)"];function Ne(e){const t=window.ethers,n=Zt();return new t.Contract(n.RENTAL_MARKETPLACE,js,e)}async function fe(){const e=window.ethers,{NetworkManager:t}=await Y(async()=>{const{NetworkManager:s}=await import("./index-C63_LXPF.js");return{NetworkManager:s}},[]),n=t.getProvider(),a=Zt();return new e.Contract(a.RENTAL_MARKETPLACE,js,n)}function Gu(e){const t=window.ethers,n=Zt();return new t.Contract(n.NFT_CONTRACT,Wu,e)}async function Ws({tokenId:e,pricePerHour:t,minHours:n,maxHours:a,button:s=null,onSuccess:r=null,onError:i=null}){const o=Zt(),l=BigInt(t);return await Z.execute({name:"ListNFT",button:s,getContract:async d=>Ne(d),method:"listNFT",args:[e,l,n,a],validate:async(d,p)=>{const f=Gu(d);if((await f.ownerOf(e)).toLowerCase()!==p.toLowerCase())throw new Error("You do not own this NFT");if(await Ne(d).paused())throw new Error("Marketplace is currently paused");await f.isApprovedForAll(p,o.RENTAL_MARKETPLACE)||await(await f.setApprovalForAll(o.RENTAL_MARKETPLACE,!0)).wait()},onSuccess:r,onError:i})}async function Gs({tokenId:e,hours:t,operator:n,button:a=null,onSuccess:s=null,onError:r=null}){const i=window.ethers,o=Zt();let l=n,d=0n;return await Z.execute({name:"RentNFT",button:a,getContract:async p=>Ne(p),method:"rentNFT",args:()=>[e,t,ce(l)],get approval(){return d>0n?{token:o.BKC_TOKEN,spender:o.RENTAL_MARKETPLACE,amount:d}:null},validate:async(p,f)=>{const m=Ne(p);if(await m.paused())throw new Error("Marketplace is currently paused");const b=await m.getListing(e);if(!b.isActive)throw new Error("NFT is not listed for rent");if(t<Number(b.minHours)||t>Number(b.maxHours))throw new Error(`Hours must be between ${b.minHours} and ${b.maxHours}`);if(await m.isRented(e))throw new Error("NFT is currently rented");d=(await m.getRentalCost(e,t)).totalCost;const{NetworkManager:g}=await Y(async()=>{const{NetworkManager:N}=await import("./index-C63_LXPF.js");return{NetworkManager:N}},[]),y=g.getProvider(),k=["function balanceOf(address) view returns (uint256)"];if(await new i.Contract(o.BKC_TOKEN,k,y).balanceOf(f)<d)throw new Error(`Insufficient BKC. Need ${i.formatEther(d)} BKC`)},onSuccess:async p=>{let f=null;try{const m=new i.Interface(js);for(const b of p.logs)try{const u=m.parseLog(b);if((u==null?void 0:u.name)==="NFTRented"){f={endTime:Number(u.args.endTime),totalCost:u.args.totalCost,protocolFee:u.args.protocolFee,ownerPayout:u.args.ownerPayout};break}}catch{}}catch{}s&&s(p,f)},onError:r})}async function ll({tokenId:e,operator:t,button:n=null,onSuccess:a=null,onError:s=null}){const r=window.ethers,i=Zt();let o=t,l=0n;return await Z.execute({name:"RentNFTSimple",button:n,getContract:async d=>Ne(d),method:"rentNFTSimple",args:()=>[e,ce(o)],get approval(){return l>0n?{token:i.BKC_TOKEN,spender:i.RENTAL_MARKETPLACE,amount:l}:null},validate:async(d,p)=>{const f=Ne(d);if(await f.paused())throw new Error("Marketplace is currently paused");const m=await f.getListing(e);if(!m.isActive)throw new Error("NFT is not listed for rent");if(await f.isRented(e))throw new Error("NFT is currently rented");l=m.pricePerHour;const{NetworkManager:b}=await Y(async()=>{const{NetworkManager:E}=await import("./index-C63_LXPF.js");return{NetworkManager:E}},[]),u=b.getProvider(),g=["function balanceOf(address) view returns (uint256)"];if(await new r.Contract(i.BKC_TOKEN,g,u).balanceOf(p)<l)throw new Error(`Insufficient BKC. Need ${r.formatEther(l)} BKC`)},onSuccess:a,onError:s})}async function Ks({tokenId:e,button:t=null,onSuccess:n=null,onError:a=null}){return await Z.execute({name:"WithdrawNFT",button:t,getContract:async s=>Ne(s),method:"withdrawNFT",args:[e],validate:async(s,r)=>{const i=Ne(s),o=await i.getListing(e);if(!o.isActive)throw new Error("NFT is not listed");if(o.owner.toLowerCase()!==r.toLowerCase())throw new Error("Only the owner can withdraw");if(await i.isRented(e))throw new Error("Cannot withdraw while NFT is rented")},onSuccess:n,onError:a})}async function cl({tokenId:e,pricePerHour:t,minHours:n,maxHours:a,button:s=null,onSuccess:r=null,onError:i=null}){const o=BigInt(t);return await Z.execute({name:"UpdateListing",button:s,getContract:async l=>Ne(l),method:"updateListing",args:[e,o,n,a],validate:async(l,d)=>{const f=await Ne(l).getListing(e);if(!f.isActive)throw new Error("NFT is not listed");if(f.owner.toLowerCase()!==d.toLowerCase())throw new Error("Only the owner can update")},onSuccess:r,onError:i})}async function $n({tokenId:e,amount:t,operator:n,button:a=null,onSuccess:s=null,onError:r=null}){const i=window.ethers,o=BigInt(t);let l=n;return await Z.execute({name:"SpotlightListing",button:a,getContract:async d=>Ne(d),method:"spotlightListing",args:()=>[e,ce(l)],value:o,validate:async(d,p)=>{const f=Ne(d);if(await f.paused())throw new Error("Marketplace is currently paused");if(!(await f.getListing(e)).isActive)throw new Error("NFT is not listed");try{const u=await f.minSpotlightAmount();if(o<u)throw new Error(`Minimum spotlight is ${i.formatEther(u)} ETH`)}catch(u){if(u.message.includes("Minimum"))throw u}if(await d.provider.getBalance(p)<o+i.parseEther("0.001"))throw new Error("Insufficient ETH")},onSuccess:s,onError:r})}async function dl(e){const t=window.ethers,a=await(await fe()).getListing(e);return{owner:a.owner,pricePerHour:a.pricePerHour,pricePerHourFormatted:t.formatEther(a.pricePerHour),minHours:Number(a.minHours),maxHours:Number(a.maxHours),isActive:a.isActive,totalEarnings:a.totalEarnings,totalEarningsFormatted:t.formatEther(a.totalEarnings),rentalCount:Number(a.rentalCount)}}async function ul(e){const t=window.ethers,a=await(await fe()).getRental(e),s=Math.floor(Date.now()/1e3),r=Number(a.endTime),i=r>s;return{tenant:a.tenant,startTime:Number(a.startTime),endTime:r,paidAmount:a.paidAmount,paidAmountFormatted:t.formatEther(a.paidAmount),isActive:i,hoursRemaining:i?Math.max(0,Math.ceil((r-s)/3600)):0}}async function pl(){return(await(await fe()).getAllListedTokenIds()).map(n=>Number(n))}async function ml(){const e=await fe();return Number(await e.getListingCount())}async function fl(e,t){const n=window.ethers,s=await(await fe()).getRentalCost(e,t);return{totalCost:s.totalCost,totalCostFormatted:n.formatEther(s.totalCost),protocolFee:s.protocolFee,protocolFeeFormatted:n.formatEther(s.protocolFee),ownerPayout:s.ownerPayout,ownerPayoutFormatted:n.formatEther(s.ownerPayout)}}async function bl(e){return await(await fe()).isRented(e)}async function gl(e){const t=await fe();return Number(await t.getRemainingRentalTime(e))}async function xl(e,t){return await(await fe()).hasRentalRights(e,t)}async function hl(e){const t=window.ethers,n=await fe();try{const a=await n.getEffectiveSpotlight(e);return{effectiveAmount:a.effectiveAmount,effectiveAmountFormatted:t.formatEther(a.effectiveAmount),daysPassed:Number(a.daysPassed)}}catch{return{effectiveAmount:0n,effectiveAmountFormatted:"0",daysPassed:0}}}async function vl(e=0,t=20){const n=window.ethers,a=await fe();try{const s=await a.getSpotlightedListingsPaginated(e,t);return{tokenIds:s.tokenIds.map(r=>Number(r)),effectiveSpotlights:s.effectiveSpotlights.map(r=>({amount:r,formatted:n.formatEther(r)})),total:Number(s.total)}}catch{return{tokenIds:[],effectiveSpotlights:[],total:0}}}async function wl(){const e=window.ethers,t=await fe();try{const n=await t.getSpotlightConfig();return{decayPerDayBips:Number(n.decayPerDayBips),decayPerDayPercent:Number(n.decayPerDayBips)/100,minAmount:n.minAmount,minAmountFormatted:e.formatEther(n.minAmount),maxDays:Number(n.maxDays),totalSpotlightedListings:Number(n.totalSpotlightedListings),totalCollected:n.totalCollected,totalCollectedFormatted:e.formatEther(n.totalCollected)}}catch{return{decayPerDayBips:100,decayPerDayPercent:1,minAmount:0n,minAmountFormatted:"0",maxDays:100,totalSpotlightedListings:0,totalCollected:0n,totalCollectedFormatted:"0"}}}async function yl(){const e=await fe();try{const t=await e.getFeeConfig();return{miningFeeBips:Number(t.miningFeeBips),miningFeePercent:Number(t.miningFeeBips)/100,burnFeeBips:Number(t.burnFeeBips),burnFeePercent:Number(t.burnFeeBips)/100,totalFeeBips:Number(t.totalFeeBips),totalFeePercent:Number(t.totalFeeBips)/100}}catch{const t=await e.rentalFeeBips().catch(()=>1e3);return{miningFeeBips:Number(t),miningFeePercent:Number(t)/100,burnFeeBips:0,burnFeePercent:0,totalFeeBips:Number(t),totalFeePercent:Number(t)/100}}}async function kl(){const e=window.ethers,t=await fe();try{const n=await t.getMarketplaceStats();return{activeListings:Number(n.activeListings),totalVolume:n.totalVol,totalVolumeFormatted:e.formatEther(n.totalVol),totalFees:n.totalFees,totalFeesFormatted:e.formatEther(n.totalFees),totalRentals:Number(n.rentals),totalSpotlight:n.spotlightTotal,totalSpotlightFormatted:e.formatEther(n.spotlightTotal),totalETHCollected:n.ethCollected,totalETHFormatted:e.formatEther(n.ethCollected),totalBKCFees:n.bkcFees,totalBKCFormatted:e.formatEther(n.bkcFees)}}catch{return{activeListings:0,totalVolume:0n,totalVolumeFormatted:"0",totalFees:0n,totalFeesFormatted:"0",totalRentals:0,totalSpotlight:0n,totalSpotlightFormatted:"0",totalETHCollected:0n,totalETHFormatted:"0",totalBKCFees:0n,totalBKCFormatted:"0"}}}async function Tl(){return await(await fe()).paused()}async function El(e){const t=await fe();try{return await t.hasActiveRental(e)}catch{return!1}}async function Cl(e){const t=await fe();try{const n=await t.getUserActiveRentals(e);return n.tokenIds.map((a,s)=>({tokenId:Number(a),endTime:Number(n.endTimes[s]),hoursRemaining:Math.max(0,Math.ceil((Number(n.endTimes[s])-Math.floor(Date.now()/1e3))/3600))}))}catch{return[]}}const Il=Ws,Al=Gs,Bl=Ks,Pl=$n,Nl=$n,zl=$n,_n={listNft:Ws,rentNft:Gs,rentNftSimple:ll,withdrawNft:Ks,updateListing:cl,spotlightListing:$n,list:Il,rent:Al,withdraw:Bl,spotlight:Pl,promote:zl,promoteListing:Nl,getListing:dl,getAllListedTokenIds:pl,getListingCount:ml,getRentalCost:fl,getRental:ul,isRented:bl,getRemainingRentalTime:gl,hasRentalRights:xl,getEffectiveSpotlight:hl,getSpotlightedListings:vl,getSpotlightConfig:wl,hasActiveRental:El,getUserActiveRentals:Cl,getFeeConfig:yl,getMarketplaceStats:kl,isMarketplacePaused:Tl},Ku=Object.freeze(Object.defineProperty({__proto__:null,RentalTx:_n,getAllListedTokenIds:pl,getEffectiveSpotlight:hl,getFeeConfig:yl,getListing:dl,getListingCount:ml,getMarketplaceStats:kl,getRemainingRentalTime:gl,getRental:ul,getRentalCost:fl,getSpotlightConfig:wl,getSpotlightedListings:vl,getUserActiveRentals:Cl,hasActiveRental:El,hasRentalRights:xl,isMarketplacePaused:Tl,isRented:bl,list:Il,listNft:Ws,promote:zl,promoteListing:Nl,rent:Al,rentNft:Gs,rentNftSimple:ll,spotlight:Pl,spotlightListing:$n,updateListing:cl,withdraw:Bl,withdrawNft:Ks},Symbol.toStringTag,{value:"Module"}));function Ys(){var n,a,s;const e=(w==null?void 0:w.decentralizedNotary)||(R==null?void 0:R.decentralizedNotary)||((n=window.contractAddresses)==null?void 0:n.decentralizedNotary)||(w==null?void 0:w.notary)||(R==null?void 0:R.notary)||((a=window.contractAddresses)==null?void 0:a.notary),t=(w==null?void 0:w.bkcToken)||(R==null?void 0:R.bkcToken)||((s=window.contractAddresses)==null?void 0:s.bkcToken);if(!e)throw console.error("❌ Notary address not found!",{addresses:w,contractAddresses:R}),new Error("Contract addresses not loaded. Please refresh the page.");return{NOTARY:e,BKC_TOKEN:t}}const Vs=["function notarize(string calldata _ipfsCid, string calldata _description, bytes32 _contentHash, address _operator) external payable returns (uint256 tokenId)","function documents(uint256 tokenId) view returns (string ipfsCid, string description, bytes32 contentHash, uint256 timestamp)","function getDocument(uint256 _tokenId) view returns (tuple(string ipfsCid, string description, bytes32 contentHash, uint256 timestamp))","function notarizationFeePaid(uint256 tokenId) view returns (uint256)","function verifyByHash(bytes32 _contentHash) view returns (bool exists, uint256 tokenId, address owner, uint256 timestamp)","function hashToTokenId(bytes32 hash) view returns (uint256)","function getFee() view returns (uint256 bkcFee, uint256 ethFee)","function notarizationFeeETH() view returns (uint256)","function SERVICE_KEY() view returns (bytes32)","function totalSupply() view returns (uint256)","function totalNotarizations() view returns (uint256)","function totalBKCCollected() view returns (uint256)","function totalETHCollected() view returns (uint256)","function getStats() view returns (uint256 notarizations, uint256 bkcCollected, uint256 ethCollected)","function ownerOf(uint256 tokenId) view returns (address)","function balanceOf(address owner) view returns (uint256)","function tokenURI(uint256 _tokenId) view returns (string)","function name() view returns (string)","function symbol() view returns (string)","event DocumentNotarized(uint256 indexed tokenId, address indexed owner, string ipfsCid, bytes32 indexed contentHash, uint256 bkcFeePaid, uint256 ethFeePaid, address operator)","event ETHFeeUpdated(uint256 oldFee, uint256 newFee)"];function Ur(e){const t=window.ethers;if(!t)throw new Error("ethers.js not loaded");if(!e)throw new Error("Signer is required for write operations");const n=Ys();return new t.Contract(n.NOTARY,Vs,e)}async function Ze(){const e=window.ethers;if(!e)throw new Error("ethers.js not loaded");const{NetworkManager:t}=await Y(async()=>{const{NetworkManager:s}=await import("./index-C63_LXPF.js");return{NetworkManager:s}},[]),n=t.getProvider();if(!n)throw new Error("Provider not available");const a=Ys();return new e.Contract(a.NOTARY,Vs,n)}function Yu(e){if(!e)return!1;const t=e.startsWith("0x")?e:`0x${e}`;return/^0x[a-fA-F0-9]{64}$/.test(t)}async function Ll({ipfsCid:e,description:t="",contentHash:n,operator:a,button:s=null,onSuccess:r=null,onError:i=null}){const o=window.ethers,l=Ys();if(!e||e.trim().length===0)throw new Error("IPFS CID is required");if(!n)throw new Error("Content hash is required");const d=n.startsWith("0x")?n:`0x${n}`;if(!Yu(d))throw new Error("Invalid content hash format. Must be a valid bytes32 (64 hex characters)");let p=a,f=0n,m=0n;return await Z.execute({name:"Notarize",button:s,getContract:async b=>Ur(b),method:"notarize",args:()=>[e,t||"",d,ce(p)],get value(){return m},get approval(){return f>0n&&l.BKC_TOKEN?{token:l.BKC_TOKEN,spender:l.NOTARY,amount:f}:null},validate:async(b,u)=>{const g=Ur(b);try{const[N,z]=await g.getFee();f=N,m=z,console.log("[NotaryTx] Fees:",{bkcFee:o.formatEther(N)+" BKC",ethFee:o.formatEther(z)+" ETH"})}catch{try{m=await g.notarizationFeeETH()}catch{m=o.parseEther("0.0001")}f=o.parseEther("1")}const{NetworkManager:y}=await Y(async()=>{const{NetworkManager:N}=await import("./index-C63_LXPF.js");return{NetworkManager:N}},[]),k=y.getProvider(),E=await k.getBalance(u),I=m+o.parseEther("0.001");if(E<I)throw new Error(`Insufficient ETH. Need ~${o.formatEther(I)} ETH for fee + gas`);if(f>0n&&l.BKC_TOKEN){const N=["function balanceOf(address) view returns (uint256)"];if(await new o.Contract(l.BKC_TOKEN,N,k).balanceOf(u)<f)throw new Error(`Insufficient BKC. Need ${o.formatEther(f)} BKC`)}},onSuccess:async b=>{let u=null,g={bkc:0n,eth:0n};try{const y=new o.Interface(Vs);for(const k of b.logs)try{const E=y.parseLog(k);if(E&&E.name==="DocumentNotarized"){u=Number(E.args.tokenId),g={bkc:E.args.bkcFeePaid,eth:E.args.ethFeePaid};break}}catch{}}catch{}r&&r(b,u,g)},onError:b=>{console.error("[NotaryTx] Notarization failed:",b),i&&i(b)}})}async function Sl(e){const t=await Ze();try{const n=await t.getDocument(e),a=await t.ownerOf(e),s=await t.notarizationFeePaid(e).catch(()=>0n);return{id:e,owner:a,ipfsCid:n.ipfsCid,description:n.description,contentHash:n.contentHash,timestamp:Number(n.timestamp),date:new Date(Number(n.timestamp)*1e3),feePaid:s}}catch{return null}}async function qs(e){const t=await Ze(),n=e.startsWith("0x")?e:`0x${e}`;try{const a=await t.verifyByHash(n);return{exists:a.exists,tokenId:a.exists?Number(a.tokenId):null,owner:a.exists?a.owner:null,timestamp:a.exists?Number(a.timestamp):null,date:a.exists?new Date(Number(a.timestamp)*1e3):null}}catch(a){return console.error("[NotaryTx] verifyByHash error:",a),{exists:!1,tokenId:null,owner:null,timestamp:null,date:null}}}async function Rl(e){const t=await Ze(),n=e.startsWith("0x")?e:`0x${e}`;try{const a=await t.hashToTokenId(n);return Number(a)>0?Number(a):null}catch{return null}}async function $l(){const e=window.ethers,t=await Ze();try{const[n,a]=await t.getFee();return{bkcFee:n,ethFee:a,bkcFormatted:e.formatEther(n)+" BKC",ethFormatted:e.formatEther(a)+" ETH",totalInEth:a}}catch{const n=await t.notarizationFeeETH().catch(()=>e.parseEther("0.0001"));return{bkcFee:e.parseEther("1"),ethFee:n,bkcFormatted:"1 BKC",ethFormatted:e.formatEther(n)+" ETH",totalInEth:n}}}async function _l(){const e=await Ze();try{return await e.notarizationFeeETH()}catch{return window.ethers.parseEther("0.0001")}}async function Fl(){const e=await Ze();return Number(await e.totalSupply())}async function Ml(){const e=window.ethers,t=await Ze();try{const n=await t.getStats();return{totalNotarizations:Number(n.notarizations),totalBKCCollected:n.bkcCollected,totalBKCFormatted:e.formatEther(n.bkcCollected),totalETHCollected:n.ethCollected,totalETHFormatted:e.formatEther(n.ethCollected)}}catch{const[n,a,s]=await Promise.all([t.totalNotarizations().catch(()=>0n),t.totalBKCCollected().catch(()=>0n),t.totalETHCollected().catch(()=>0n)]);return{totalNotarizations:Number(n),totalBKCCollected:a,totalBKCFormatted:e.formatEther(a),totalETHCollected:s,totalETHFormatted:e.formatEther(s)}}}async function Dl(e){const t=await Ze();return Number(await t.balanceOf(e))}async function Ol(e){return await(await Ze()).tokenURI(e)}async function Ea(e){let t;if(e instanceof ArrayBuffer)t=e;else if(e instanceof Blob||e instanceof File)t=await e.arrayBuffer();else throw new Error("Invalid file type. Expected File, Blob, or ArrayBuffer");const n=await crypto.subtle.digest("SHA-256",t);return"0x"+Array.from(new Uint8Array(n)).map(s=>s.toString(16).padStart(2,"0")).join("")}async function Xs(e,t){const n=await Ea(e),a=t.toLowerCase(),s=n.toLowerCase();return a===s}async function Hl(e,t){const n=t||await Ea(e),a=await qs(n);let s=!0;return t&&(s=await Xs(e,t)),{contentHash:n,hashMatches:s,existsOnChain:a.exists,tokenId:a.tokenId,owner:a.owner,timestamp:a.timestamp,date:a.date,isVerified:s&&a.exists}}const Ul={notarize:Ll,getDocument:Sl,getTotalDocuments:Fl,getUserDocumentCount:Dl,getTokenURI:Ol,verifyByHash:qs,getTokenIdByHash:Rl,getFee:$l,getNotarizationFeeETH:_l,getStats:Ml,calculateFileHash:Ea,verifyDocumentHash:Xs,verifyDocumentOnChain:Hl},Vu=Object.freeze(Object.defineProperty({__proto__:null,NotaryTx:Ul,calculateFileHash:Ea,getDocument:Sl,getFee:$l,getNotarizationFeeETH:_l,getStats:Ml,getTokenIdByHash:Rl,getTokenURI:Ol,getTotalDocuments:Fl,getUserDocumentCount:Dl,notarize:Ll,verifyByHash:qs,verifyDocumentHash:Xs,verifyDocumentOnChain:Hl},Symbol.toStringTag,{value:"Module"}));(async()=>(await Y(async()=>{const{CharityTx:e}=await Promise.resolve().then(()=>$u);return{CharityTx:e}},void 0)).CharityTx)(),(async()=>(await Y(async()=>{const{StakingTx:e}=await Promise.resolve().then(()=>Fu);return{StakingTx:e}},void 0)).StakingTx)(),(async()=>(await Y(async()=>{const{NftTx:e}=await Promise.resolve().then(()=>Ou);return{NftTx:e}},void 0)).NftTx)(),(async()=>(await Y(async()=>{const{FortuneTx:e}=await Promise.resolve().then(()=>ju);return{FortuneTx:e}},void 0)).FortuneTx)(),(async()=>(await Y(async()=>{const{RentalTx:e}=await Promise.resolve().then(()=>Ku);return{RentalTx:e}},void 0)).RentalTx)(),(async()=>(await Y(async()=>{const{NotaryTx:e}=await Promise.resolve().then(()=>Vu);return{NotaryTx:e}},void 0)).NotaryTx)(),(async()=>(await Y(async()=>{const{FaucetTx:e}=await Promise.resolve().then(()=>wu);return{FaucetTx:e}},void 0)).FaucetTx)(),(async()=>(await Y(async()=>{const{BackchatTx:e}=await import("./backchat-tx-Ch7j8pxm.js");return{BackchatTx:e}},[])).BackchatTx)();const jt=window.ethers,S={hasRenderedOnce:!1,lastUpdate:0,activities:[],networkActivities:[],filteredActivities:[],userProfile:null,pagination:{currentPage:1,itemsPerPage:8},filters:{type:"ALL",sort:"NEWEST"},metricsCache:{},economicData:null,isLoadingNetworkActivity:!1,networkActivitiesTimestamp:0,faucet:{canClaim:!0,cooldownEnd:null,isLoading:!1,lastCheck:0}},jr="https://sepolia.arbiscan.io/tx/",qu="https://sepolia.arbiscan.io/address/",Xu="https://faucet-4wvdcuoouq-uc.a.run.app",Ju="https://getrecentactivity-4wvdcuoouq-uc.a.run.app",Zu="https://getsystemdata-4wvdcuoouq-uc.a.run.app",as="1,000",ss="0.01",Qu=jt.parseUnits("100",18),M={STAKING:{icon:"fa-lock",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🔒 Staked",emoji:"🔒"},UNSTAKING:{icon:"fa-unlock",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"🔓 Unstaked",emoji:"🔓"},FORCE_UNSTAKE:{icon:"fa-bolt",color:"#ef4444",bg:"rgba(239,68,68,0.15)",label:"⚡ Force Unstaked",emoji:"⚡"},CLAIM:{icon:"fa-coins",color:"#fbbf24",bg:"rgba(245,158,11,0.15)",label:"🪙 Rewards Claimed",emoji:"🪙"},NFT_BUY:{icon:"fa-bag-shopping",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🛍️ Bought NFT",emoji:"🛍️"},NFT_SELL:{icon:"fa-hand-holding-dollar",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"💰 Sold NFT",emoji:"💰"},NFT_MINT:{icon:"fa-gem",color:"#fde047",bg:"rgba(234,179,8,0.15)",label:"💎 Minted Booster",emoji:"💎"},NFT_TRANSFER:{icon:"fa-arrow-right-arrow-left",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"↔️ Transfer",emoji:"↔️"},RENTAL_LIST:{icon:"fa-tag",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🏷️ Listed NFT",emoji:"🏷️"},RENTAL_RENT:{icon:"fa-clock",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"⏰ Rented NFT",emoji:"⏰"},RENTAL_WITHDRAW:{icon:"fa-rotate-left",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"↩️ Withdrawn",emoji:"↩️"},RENTAL_PROMOTE:{icon:"fa-bullhorn",color:"#fbbf24",bg:"rgba(251,191,36,0.2)",label:"📢 Promoted NFT",emoji:"📢"},FORTUNE_COMMIT:{icon:"fa-lock",color:"#a855f7",bg:"rgba(168,85,247,0.2)",label:"🔐 Game Committed",emoji:"🔐"},FORTUNE_REVEAL:{icon:"fa-dice",color:"#f97316",bg:"rgba(249,115,22,0.2)",label:"🎲 Game Revealed",emoji:"🎲"},FORTUNE_BET:{icon:"fa-paw",color:"#f97316",bg:"rgba(249,115,22,0.2)",label:"🐯 Fortune Bet",emoji:"🐯"},FORTUNE_COMBO:{icon:"fa-rocket",color:"#a855f7",bg:"rgba(168,85,247,0.2)",label:"🚀 Combo Mode",emoji:"🚀"},FORTUNE_JACKPOT:{icon:"fa-crown",color:"#f59e0b",bg:"rgba(245,158,11,0.2)",label:"👑 Jackpot Mode",emoji:"👑"},FORTUNE_WIN:{icon:"fa-trophy",color:"#facc15",bg:"rgba(234,179,8,0.25)",label:"🏆 Winner!",emoji:"🏆"},FORTUNE_LOSE:{icon:"fa-dice",color:"#71717a",bg:"rgba(39,39,42,0.5)",label:"🎲 No Luck",emoji:"🎲"},NOTARY:{icon:"fa-stamp",color:"#818cf8",bg:"rgba(99,102,241,0.15)",label:"📜 Notarized",emoji:"📜"},BACKCHAT_POST:{icon:"fa-comment",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"💬 Posted",emoji:"💬"},BACKCHAT_LIKE:{icon:"fa-heart",color:"#ec4899",bg:"rgba(236,72,153,0.15)",label:"❤️ Liked",emoji:"❤️"},BACKCHAT_REPLY:{icon:"fa-reply",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"↩️ Replied",emoji:"↩️"},BACKCHAT_SUPERLIKE:{icon:"fa-star",color:"#fbbf24",bg:"rgba(251,191,36,0.2)",label:"⭐ Super Liked",emoji:"⭐"},BACKCHAT_REPOST:{icon:"fa-retweet",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🔄 Reposted",emoji:"🔄"},BACKCHAT_FOLLOW:{icon:"fa-user-plus",color:"#a78bfa",bg:"rgba(167,139,250,0.15)",label:"👥 Followed",emoji:"👥"},BACKCHAT_PROFILE:{icon:"fa-user",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"👤 Profile Created",emoji:"👤"},BACKCHAT_BOOST:{icon:"fa-rocket",color:"#f97316",bg:"rgba(249,115,22,0.15)",label:"🚀 Profile Boosted",emoji:"🚀"},BACKCHAT_BADGE:{icon:"fa-circle-check",color:"#10b981",bg:"rgba(16,185,129,0.15)",label:"✅ Badge Activated",emoji:"✅"},BACKCHAT_TIP:{icon:"fa-coins",color:"#fbbf24",bg:"rgba(251,191,36,0.15)",label:"💰 Tipped BKC",emoji:"💰"},BACKCHAT_WITHDRAW:{icon:"fa-wallet",color:"#8b5cf6",bg:"rgba(139,92,246,0.15)",label:"💸 ETH Withdrawn",emoji:"💸"},CHARITY_DONATE:{icon:"fa-heart",color:"#ec4899",bg:"rgba(236,72,153,0.15)",label:"💝 Donated",emoji:"💝"},CHARITY_CREATE:{icon:"fa-hand-holding-heart",color:"#10b981",bg:"rgba(16,185,129,0.15)",label:"🌱 Campaign Created",emoji:"🌱"},CHARITY_CANCEL:{icon:"fa-heart-crack",color:"#ef4444",bg:"rgba(239,68,68,0.15)",label:"💔 Campaign Cancelled",emoji:"💔"},CHARITY_WITHDRAW:{icon:"fa-hand-holding-dollar",color:"#8b5cf6",bg:"rgba(139,92,246,0.15)",label:"💰 Funds Withdrawn",emoji:"💰"},CHARITY_GOAL_REACHED:{icon:"fa-trophy",color:"#fbbf24",bg:"rgba(251,191,36,0.15)",label:"🏆 Goal Reached!",emoji:"🏆"},FAUCET:{icon:"fa-droplet",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"💧 Faucet Claim",emoji:"💧"},DEFAULT:{icon:"fa-circle",color:"#71717a",bg:"rgba(39,39,42,0.5)",label:"Activity",emoji:"📋"}};function ep(e){if(!e)return"Just now";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3,n=new Date(t*1e3),s=new Date-n,r=Math.floor(s/6e4),i=Math.floor(s/36e5),o=Math.floor(s/864e5);return r<1?"Just now":r<60?`${r}m ago`:i<24?`${i}h ago`:o<7?`${o}d ago`:n.toLocaleDateString()}catch{return"Recent"}}function tp(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function Oa(e){return e>=1e6?(e/1e6).toFixed(2)+"M":e>=1e3?(e/1e3).toFixed(1)+"K":e.toFixed(0)}function np(e){return e?`${e.slice(0,6)}...${e.slice(-4)}`:""}function ap(e){if(!e)return"";const t=Date.now(),a=new Date(e).getTime()-t;if(a<=0)return"";const s=Math.floor(a/36e5),r=Math.floor(a%36e5/6e4);return s>0?`${s}h ${r}m`:`${r}m`}function sp(e,t={}){const n=(e||"").toUpperCase().trim();if(n==="STAKING"||n==="STAKED"||n==="STAKE"||n==="DELEGATED"||n==="DELEGATION"||n.includes("DELEGAT"))return M.STAKING;if(n==="UNSTAKE"||n==="UNSTAKED"||n==="UNSTAKING"||n.includes("UNDELEGAT"))return n.includes("FORCE")?M.FORCE_UNSTAKE:M.UNSTAKING;if(n==="CLAIMREWARD"||n==="CLAIM"||n==="CLAIMED"||n.includes("REWARD")||n.includes("CLAIM"))return M.CLAIM;if(n==="NFTBOUGHT"||n.includes("NFTBOUGHT")||n.includes("NFT_BOUGHT"))return M.NFT_BUY;if(n==="NFTSOLD"||n.includes("NFTSOLD")||n.includes("NFT_SOLD"))return M.NFT_SELL;if(n==="BOOSTERBUY"||n.includes("BOOSTER")||n.includes("PRESALE")||n.includes("MINTED"))return M.NFT_MINT;if(n==="TRANSFER"||n.includes("TRANSFER"))return M.NFT_TRANSFER;if(n==="RENTALLISTED"||n==="NFTLISTED"||n.includes("LIST")&&!n.includes("PROMOTE"))return M.RENTAL_LIST;if(n==="RENTALPROMOTED"||n==="PROMOTED"||n==="PROMOTE"||n.includes("PROMOT")||n.includes("ADS")||n.includes("ADVERTIS"))return M.RENTAL_PROMOTE;if(n==="RENTALRENTED"||n==="RENTED"||n.includes("RENTAL")&&n.includes("RENT"))return M.RENTAL_RENT;if(n==="RENTALWITHDRAWN"||n.includes("WITHDRAW"))return M.RENTAL_WITHDRAW;if(n==="GAMECOMMITTED"||n.includes("COMMITTED")||n.includes("COMMIT")){const a=t==null?void 0:t.isCumulative;return a===!0?M.FORTUNE_COMBO:a===!1?M.FORTUNE_JACKPOT:M.FORTUNE_COMMIT}if(n==="GAMEREVEALED"||n.includes("REVEALED")||n.includes("REVEAL"))return(t==null?void 0:t.isWin)||(t==null?void 0:t.prizeWon)>0||(t==null?void 0:t.matchCount)>0?M.FORTUNE_WIN:M.FORTUNE_LOSE;if(n==="GAMEREQUESTED"||n.includes("GAMEREQUESTED")||n.includes("GAME_REQUEST")||n.includes("REQUEST")||n.includes("GAMEPLAYED")||n.includes("FORTUNE")||n.includes("GAME")){const a=t==null?void 0:t.isCumulative,s=(t==null?void 0:t.guesses)||[];return a===!0||s.length>1?M.FORTUNE_COMBO:a===!1||s.length===1?M.FORTUNE_JACKPOT:M.FORTUNE_BET}return n==="GAMEFULFILLED"||n.includes("FULFILLED")||n.includes("ORACLE")?M.FORTUNE_REVEAL:n==="GAMERESULT"||n.includes("RESULT")?(t==null?void 0:t.isWin)||(t==null?void 0:t.prizeWon)>0?M.FORTUNE_WIN:M.FORTUNE_LOSE:n==="POSTCREATED"||n==="POST_CREATED"||n.includes("POST")&&n.includes("CREAT")?M.BACKCHAT_POST:n==="SUPERLIKED"||n==="SUPER_LIKED"||n.includes("SUPERLIKE")?M.BACKCHAT_SUPERLIKE:n==="LIKED"||n==="POSTLIKED"||n==="POST_LIKED"||n.includes("LIKE")&&!n.includes("SUPER")?M.BACKCHAT_LIKE:n==="REPLYCREATED"||n==="REPLY_CREATED"||n.includes("REPLY")?M.BACKCHAT_REPLY:n==="REPOSTCREATED"||n==="REPOST_CREATED"||n.includes("REPOST")?M.BACKCHAT_REPOST:n==="FOLLOWED"||n==="USER_FOLLOWED"||n.includes("FOLLOW")?M.BACKCHAT_FOLLOW:n==="PROFILECREATED"||n==="PROFILE_CREATED"||n.includes("PROFILE")&&n.includes("CREAT")?M.BACKCHAT_PROFILE:n==="PROFILEBOOSTED"||n==="PROFILE_BOOSTED"||n==="BOOSTED"||n.includes("BOOST")&&!n.includes("NFT")?M.BACKCHAT_BOOST:n==="BADGEACTIVATED"||n==="BADGE_ACTIVATED"||n.includes("BADGE")?M.BACKCHAT_BADGE:n==="TIPPROCESSED"||n==="TIP_PROCESSED"||n==="TIPPED"||n.includes("TIP")?M.BACKCHAT_TIP:n==="ETHWITHDRAWN"||n==="ETH_WITHDRAWN"||n==="BACKCHAT_WITHDRAW"?M.BACKCHAT_WITHDRAW:n==="CHARITYDONATION"||n==="DONATIONMADE"||n==="CHARITY_DONATE"||n==="DONATED"||n==="DONATION"||n.includes("DONATION")?M.CHARITY_DONATE:n==="CHARITYCAMPAIGNCREATED"||n==="CAMPAIGNCREATED"||n==="CHARITY_CREATE"||n==="CAMPAIGN_CREATED"||n.includes("CAMPAIGNCREATED")?M.CHARITY_CREATE:n==="CHARITYCAMPAIGNCANCELLED"||n==="CAMPAIGNCANCELLED"||n==="CHARITY_CANCEL"||n==="CAMPAIGN_CANCELLED"||n.includes("CANCELLED")?M.CHARITY_CANCEL:n==="CHARITYFUNDSWITHDRAWN"||n==="FUNDSWITHDRAWN"||n==="CHARITY_WITHDRAW"||n==="CAMPAIGN_WITHDRAW"||n.includes("WITHDRAWN")?M.CHARITY_WITHDRAW:n==="CHARITYGOALREACHED"||n==="GOALREACHED"||n==="CHARITY_GOAL"||n==="CAMPAIGN_COMPLETED"?M.CHARITY_GOAL_REACHED:n==="NOTARYREGISTER"||n==="NOTARIZED"||n.includes("NOTARY")||n.includes("DOCUMENT")?M.NOTARY:n==="FAUCETCLAIM"||n.includes("FAUCET")||n.includes("DISTRIBUTED")?M.FAUCET:M.DEFAULT}let Ha=null,bt=0n;function jl(e){const t=document.getElementById("dash-user-rewards");if(!t||!c.isConnected){Ha&&cancelAnimationFrame(Ha);return}const n=e-bt;n>-1000000000n&&n<1000000000n?bt=e:bt+=n/8n,bt<0n&&(bt=0n),t.innerHTML=`${_(bt).toFixed(4)} <span class="text-sm text-green-500/80">BKC</span>`,bt!==e&&(Ha=requestAnimationFrame(()=>jl(e)))}async function Wr(e){if(!c.isConnected||!c.userAddress)return x("Connect wallet first","error");const t=e.innerHTML;e.disabled=!0,e.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-2"></i> Sending...',S.faucet.isLoading=!0;try{const n=await fetch(`${Xu}?address=${c.userAddress}`,{method:"GET",headers:{Accept:"application/json"}}),a=await n.json();if(n.ok&&a.success)x(`✅ Faucet Sent! ${as} BKC + ${ss} ETH`,"success"),S.faucet.canClaim=!1,S.faucet.cooldownEnd=new Date(Date.now()+24*60*60*1e3).toISOString(),rs(),setTimeout(()=>{Kl.update(!0)},4e3);else{const s=a.error||a.message||"Faucet unavailable";if(s.toLowerCase().includes("cooldown")||s.toLowerCase().includes("wait")||s.toLowerCase().includes("hour")){x(`⏳ ${s}`,"warning");const r=s.match(/(\d+)\s*hour/i);if(r){const i=parseInt(r[1]);S.faucet.canClaim=!1,S.faucet.cooldownEnd=new Date(Date.now()+i*60*60*1e3).toISOString(),rs()}}else x(`❌ ${s}`,"error")}}catch(n){console.error("Faucet error:",n),x("Faucet Offline - Try again later","error")}finally{S.faucet.isLoading=!1,e.disabled=!1,e.innerHTML=t}}function rp(){return c.isConnected?(c.currentUserBalance||c.bkcBalance||0n)<Qu:!1}function rs(){const e=document.getElementById("dashboard-faucet-widget");if(!e)return;if(!rp()){e.classList.add("hidden");return}e.classList.remove("hidden");const t=c.currentUserBalance||c.bkcBalance||0n,n=t===0n,a=ap(S.faucet.cooldownEnd),s=S.faucet.canClaim&&!a,r=document.getElementById("faucet-title"),i=document.getElementById("faucet-desc"),o=document.getElementById("faucet-status"),l=document.getElementById("faucet-action-btn");if(e.className="glass-panel border-l-4 p-4",l&&(l.className="w-full sm:w-auto font-bold py-2.5 px-5 rounded-lg text-sm transition-all"),!s&&a)e.classList.add("border-zinc-500"),r&&(r.innerText="⏳ Faucet Cooldown"),i&&(i.innerText="Come back when the timer ends"),o&&(o.classList.remove("hidden"),o.innerHTML=`<i class="fa-solid fa-clock mr-1"></i> ${a} remaining`),l&&(l.classList.add("bg-zinc-700","text-zinc-400","cursor-not-allowed"),l.innerHTML='<i class="fa-solid fa-hourglass-half mr-2"></i> On Cooldown',l.disabled=!0);else if(n)e.classList.add("border-green-500"),r&&(r.innerText="🎉 Welcome to BackCoin!"),i&&(i.innerText=`Claim your free starter pack: ${as} BKC + ${ss} ETH for gas`),o&&o.classList.add("hidden"),l&&(l.classList.add("bg-green-600","hover:bg-green-500","text-white","hover:scale-105"),l.innerHTML='<i class="fa-solid fa-gift mr-2"></i> Claim Starter Pack',l.disabled=!1);else{const d=_(t).toFixed(2);e.classList.add("border-cyan-500"),r&&(r.innerText="💧 Need More BKC?"),i&&(i.innerText=`Balance: ${d} BKC • Get ${as} BKC + ${ss} ETH`),o&&o.classList.add("hidden"),l&&(l.classList.add("bg-cyan-600","hover:bg-cyan-500","text-white","hover:scale-105"),l.innerHTML='<i class="fa-solid fa-faucet mr-2"></i> Request Tokens',l.disabled=!1)}}async function ip(){try{if(await c.provider.getBalance(c.userAddress)<jt.parseEther("0.002")){const t=document.getElementById("no-gas-modal-dash");return t&&(t.classList.remove("hidden"),t.classList.add("flex")),!1}return!0}catch{return!0}}function op(){if(!Be.dashboard)return;const e=w.ecosystemManager||"",t=e?`${qu}${e}`:"#";Be.dashboard.innerHTML=`
        ...
        ${dp()}
        ${up()}
    `,gp()}function Yn(e,t,n,a,s="zinc"){const r={zinc:"text-zinc-400",purple:"text-purple-400",blue:"text-blue-400",orange:"text-orange-400",green:"text-green-400",red:"text-red-400"},i=r[s]||r.zinc;return`
    ...
    `}function lp(e,t,n,a,s="zinc"){const r={zinc:"text-zinc-400",purple:"text-purple-400",blue:"text-blue-400",orange:"text-orange-400",green:"text-green-400",red:"text-red-400"},i=r[s]||r.zinc;return`
        <div class="glass-panel p-3 sm:p-4 group hover:border-zinc-600 transition-all cursor-default" title="${a}">
            <div class="flex items-center gap-1.5 mb-1">
                <i class="fa-solid ${t} ${i} text-xs"></i>
                <span class="text-[10px] text-zinc-500 uppercase font-bold tracking-wider truncate">${e}</span>
    ...
    `}async function pp(){try{const e=await fetch(Zu);if(e.ok){const t=await e.json();return S.economicData=t,t}}catch{}return null}async function is(){var e,t,n,a,s,r,i,o,l;try{const d=await pp();let p=0n,f=0n,m=0n,b=0n,u=0n,g=0,y=0n;if(d)if(console.log("📊 Firebase economic data:",d.economy),(e=d.economy)!=null&&e.totalSupply&&(p=BigInt(d.economy.totalSupply)),(t=d.economy)!=null&&t.totalPStake&&(f=BigInt(d.economy.totalPStake)),(n=d.economy)!=null&&n.totalTVL&&(m=BigInt(d.economy.totalTVL)),(a=d.economy)!=null&&a.totalFeesCollected&&(u=BigInt(d.economy.totalFeesCollected)),(s=d.economy)!=null&&s.fortunePoolBalance&&(y=BigInt(d.economy.fortunePoolBalance)),(r=d.stats)!=null&&r.notarizedDocuments&&(g=d.stats.notarizedDocuments),(i=d.burn)!=null&&i.totalBurned)b=BigInt(d.burn.totalBurned);else if((o=d.burn)!=null&&o.sources){let D=0n;for(const W of Object.values(d.burn.sources))W!=null&&W.total&&(D+=BigInt(W.total));b=D}else(l=d.rental)!=null&&l.totalBurned&&(b=BigInt(d.rental.totalBurned));if(c.bkcTokenContractPublic&&(p===0n&&(console.log("📊 Fetching totalSupply from blockchain (fallback)..."),p=await ne(c.bkcTokenContractPublic,"totalSupply",[],0n)),f===0n&&c.delegationManagerContractPublic&&(console.log("📊 Fetching totalPStake from blockchain (fallback)..."),f=await ne(c.delegationManagerContractPublic,"totalNetworkPStake",[],0n)),m===0n)){console.log("📊 Calculating TVL from blockchain (fallback)...");const D=[w.delegationManager,w.fortunePool,w.rentalManager,w.miningManager,w.decentralizedNotary,w.nftLiquidityPoolFactory,w.pool_diamond,w.pool_platinum,w.pool_gold,w.pool_silver,w.pool_bronze,w.pool_iron,w.pool_crystal].filter(ae=>ae&&ae!==jt.ZeroAddress),W=D.map(ae=>ne(c.bkcTokenContractPublic,"balanceOf",[ae],0n)),oe=await Promise.all(W);if(oe.forEach(ae=>{m+=ae}),w.fortunePool&&y===0n){const ae=D.indexOf(w.fortunePool);ae>=0&&(y=oe[ae])}}const k=_(p),E=_(b),I=_(u),N=_(y),z=D=>D.toLocaleString("en-US",{minimumFractionDigits:1,maximumFractionDigits:1});let T=0;p>0n&&(T=Number(m*10000n/p)/100),T>100&&(T=100);const F=(D,W,oe="")=>{const ae=document.getElementById(D);ae&&(ae.innerHTML=`${W}${oe?` <span class="text-xs text-zinc-500">${oe}</span>`:""}`)},G=document.getElementById("dash-metric-supply");G&&(G.innerHTML=`${z(k)} <span style="font-size: 10px; color: #71717a">BKC</span>`),F("dash-metric-pstake",Ut(f));const se=document.getElementById("dash-metric-burned");se&&(E>0?se.innerHTML=`<span class="text-red-400">${Oa(E)}</span> <span class="text-xs text-zinc-500">BKC 🔥</span>`:se.innerHTML='<span class="text-zinc-500">0</span> <span class="text-xs text-zinc-500">BKC</span>'),F("dash-metric-fees",Oa(I),"BKC");const de=document.getElementById("dash-metric-tvl");if(de){const D=T>30?"text-green-400":T>10?"text-yellow-400":"text-blue-400";de.innerHTML=`<span class="${D}">${T.toFixed(1)}%</span>`}Wl();const xe=document.getElementById("dash-fortune-prize");xe&&(xe.innerText=`${Oa(N)} BKC`);const Q=document.getElementById("dash-notary-count");Q&&(Q.innerText=g>0?`${g} docs`:"--"),S.metricsCache={supply:k,burned:E,fees:I,timestamp:Date.now()}}catch(d){console.error("Metrics Error",d)}}async function mp(){if(c.userAddress)try{const e=await fetch(`https://getuserprofile-4wvdcuoouq-uc.a.run.app/${c.userAddress}`);e.ok&&(S.userProfile=await e.json(),fp(S.userProfile))}catch{}}function fp(e){const t=document.getElementById("dash-presale-stats");if(!t||!e||!e.presale||!e.presale.totalBoosters||e.presale.totalBoosters===0)return;t.classList.remove("hidden");const n=e.presale.totalSpentWei||0,a=parseFloat(jt.formatEther(BigInt(n))).toFixed(4);document.getElementById("stats-total-spent").innerText=`${a} ETH`,document.getElementById("stats-total-boosters").innerText=e.presale.totalBoosters||0;const s=document.getElementById("stats-tier-badges");if(s&&e.presale.tiersOwned){let r="";Object.entries(e.presale.tiersOwned).forEach(([i,o])=>{const l=ge[Number(i)-1],d=l?l.name:`T${i}`;r+=`<span class="text-[9px] bg-zinc-800 text-zinc-400 px-1.5 py-0.5 rounded">${o}x ${d}</span>`}),r&&(s.innerHTML=r)}}function Wl(){const e=document.getElementById("dash-metric-balance"),t=document.getElementById("dash-balance-card");if(!e)return;const n=c.currentUserBalance||c.bkcBalance||0n;if(!c.isConnected){e.innerHTML='<span class="text-zinc-500 text-xs">Connect Wallet</span>',t&&(t.style.borderColor="rgba(63,63,70,0.5)");return}if(n===0n)e.innerHTML='0.00 <span style="font-size: 10px; color: #71717a">BKC</span>';else{const s=_(n).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2});e.innerHTML=`${s} <span style="font-size: 10px; color: #71717a">BKC</span>`}t&&(t.style.borderColor="rgba(245,158,11,0.3)")}async function _t(e=!1){var t,n;if(!c.isConnected){const a=document.getElementById("dash-booster-area");a&&(a.innerHTML=`
        ...
        `;return}const d=e.source==="rented",p=d?"bg-cyan-500/20 text-cyan-300":"bg-green-500/20 text-green-300",f=d?"Rented":"Owned",m=pd(a),b=(m==null?void 0:m.name)||((E=e.boostName)==null?void 0:E.replace(" Booster","").replace("Booster","").trim())||"Booster",u=(m==null?void 0:m.color)||"text-amber-400",g=(m==null?void 0:m.emoji)||"💎",y=r*50n/100n,k=i-y;console.log("🎨 V6.8 Booster:",{keepRate:s,netReward:_(i),tierName:b}),n.innerHTML=`
        <div class="flex items-center gap-3 bg-zinc-800/40 border ${(m==null?void 0:m.borderColor)||"border-green-500/20"} rounded-lg p-3 nft-clickable-image cursor-pointer" data-address="${w.rewardBoosterNFT}" data-tokenid="${e.tokenId}">
            ...
            <div class="flex-1 min-w-0">
                <div class="flex items-center gap-2 mb-0.5">
                    <span class="text-[9px] font-bold ${p} px-1.5 py-0.5 rounded uppercase">${f}</span>
                    <span class="text-[9px] text-zinc-600">#${e.tokenId}</span>
                </div>
                <h4 class="${u} font-bold text-xs truncate">${b} Booster</h4>
    ...
    `;try{const n=await fetch(`${Ju}?limit=30`);if(n.ok){const a=await n.json();S.networkActivities=Array.isArray(a)?a:a.activities||[],S.networkActivitiesTimestamp=Date.now()}else S.networkActivities=[]}catch(n){console.error("Network activity fetch error:",n),S.networkActivities=[]}finally{S.isLoadingNetworkActivity=!1}Kr()}function Kr(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("dash-pagination-controls");if(e){if(S.networkActivities.length===0){e.innerHTML=`
        ...
        `,t&&t.classList.add("hidden");return}const n=(S.pagination.currentPage-1)*S.pagination.itemsPerPage,a=n+S.pagination.itemsPerPage,s=S.filteredActivities.slice(n,a);if(e.innerHTML=s.map(r=>Gl(r,!1)).join(""),t){const r=Math.ceil(S.filteredActivities.length/S.pagination.itemsPerPage);r>1?(t.classList.remove("hidden"),document.getElementById("page-indicator").innerText=`${S.pagination.currentPage}/${r}`,document.getElementById("page-prev").disabled=S.pagination.currentPage===1,document.getElementById("page-next").disabled=S.pagination.currentPage>=r):t.classList.add("hidden")}}function Gl(e,t=!1){const n=ep(e.timestamp||e.createdAt),a=tp(e.timestamp||e.createdAt),s=e.user||e.userAddress||e.from||"",r=np(s),i=sp(e.type,e.details);let o="";const l=(e.type||"").toUpperCase().trim(),d=e.details||{};if(l.includes("GAME")||l.includes("FORTUNE")||l.includes("REQUEST")||l.includes("FULFILLED")||l.includes("RESULT")){const g=d.rolls||e.rolls||[],y=d.guesses||e.guesses||[],k=d.isWin||d.prizeWon&&BigInt(d.prizeWon||0)>0n,E=d.isCumulative!==void 0?d.isCumulative:y.length>1,I=d.wagerAmount||d.amount,N=d.prizeWon,z=E?"Combo":"Jackpot",T=E?"bg-purple-500/20 text-purple-400":"bg-amber-500/20 text-amber-400",F=I?_(BigInt(I)).toFixed(0):"0";let G="No win",se="text-zinc-500";k&&N&&BigInt(N)>0n&&(G=`<span class="text-emerald-400 font-bold">+${_(BigInt(N)).toFixed(0)} BKC</span>`,se="");let de="";return g.length>0&&(de=`<div class="flex gap-1">
        ...
        `}if(l.includes("NOTARY")){const g=d.ipfsCid;g&&(o=`<span class="ml-2 text-[9px] text-indigo-400 font-mono">${g.replace("ipfs://","").slice(0,12)+"..."}</span>`)}if(l.includes("STAKING")||l.includes("DELEGAT")){const g=d.pStakeGenerated;g&&(o=`<span class="text-[10px] text-purple-400">+${_(BigInt(g)).toFixed(0)} pStake</span>`)}if(l.includes("DONATION")||l.includes("CHARITY")){const g=d.netAmount||d.amount,y=d.campaignId;g&&BigInt(g)>0n&&(o=`<span class="text-pink-400 font-bold">${_(BigInt(g)).toFixed(2)} BKC</span>`,y&&(o+=`<span class="ml-1 text-[9px] text-zinc-500">Campaign #${y}</span>`))}if(l.includes("CLAIM")||l.includes("REWARD")){const g=d.feePaid,y=d.amount||e.amount;if(y&&(o=`<span class="text-amber-400 font-bold">+${_(BigInt(y)).toFixed(2)} BKC</span>`),g&&BigInt(g)>0n){const k=_(BigInt(g)).toFixed(2);o+=`<span class="ml-1 text-[9px] text-zinc-500">(fee: ${k})</span>`}}const f=l.includes("PROMOT")||l.includes("ADS")||l.includes("ADVERTIS");if(f){const g=d.promotionFee||d.amount||e.amount;if(g&&BigInt(g)>0n){const k=jt.formatEther(BigInt(g));o=`<span class="text-yellow-400 font-bold">${parseFloat(k).toFixed(4)} ETH</span>`}const y=d.tokenId||e.tokenId;y&&(o+=`<span class="ml-1 text-[9px] text-zinc-500">NFT #${y}</span>`)}const m=e.txHash?`${jr}${e.txHash}`:"#";let b="";if(f){const g=d.promotionFee||d.amount||e.amount;if(g&&BigInt(g)>0n){const y=jt.formatEther(BigInt(g));b=parseFloat(y).toFixed(4)}}else{let g=e.amount||d.netAmount||d.amount||d.wagerAmount||d.prizeWon||"0";const y=_(BigInt(g));b=y>.001?y.toFixed(2):""}const u=f?"ETH":"BKC";return`
        <a href="${m}" target="_blank" class="flex items-center justify-between p-2.5 hover:bg-zinc-800/60 border border-zinc-700/30 rounded-lg transition-all hover:border-zinc-600/50 group" style="background: rgba(39,39,42,0.3)" title="${a}">
            ...
            <div class="text-right flex items-center gap-2">
                ${b?`<p class="text-white text-xs font-mono">${b} <span class="text-zinc-500">${u}</span></p>`:""}
    ...
    `,zp(),c.isConnected?Qt(!0):Zs())}async function Qt(e=!1){var n;if(!c.isConnected){Zs();return}const t=Date.now();if(!(!e&&Dt)&&!(!e&&t-En<1e4)){Dt=!0,En=t;try{await kp();try{const a=await fetch("https://getsystemdata-4wvdcuoouq-uc.a.run.app");if(a.ok){const s=await a.json();(n=s==null?void 0:s.economy)!=null&&n.totalPStake&&(fn=BigInt(s.economy.totalPStake))}}catch{console.log("Firebase unavailable, using blockchain")}if(fn===0n){const a=c.delegationManagerContractPublic||c.delegationManagerContract;a&&(fn=await ne(a,"totalNetworkPStake",[],0n))}await Promise.all([Pt(!0),Pd(!0),Is()]),await Tp(),Cp(),Jl(),bn(),Bp()}catch(a){console.error("Staking load error:",a)}finally{Dt=!1}}}async function kp(){try{const e=c.delegationManagerContract||c.delegationManagerContractPublic;if(e&&c.userAddress)try{const n=await e.getUserBestBoost(c.userAddress);Ve=Number(n)}catch{const n=await Ht();Ve=(n==null?void 0:n.boost)||0}else{const n=await Ht();Ve=(n==null?void 0:n.boost)||0}Cn=Xl(Ve).burnRate,Yl=Ve>0?"active":"none",Ep()}catch(e){console.error("Error loading NFT boost:",e),Ve=0,Cn=50}}async function Tp(){try{const e=c.delegationManagerContract||c.delegationManagerContractPublic;if(e&&c.userAddress)try{const t=await e.previewClaim(c.userAddress);Ft={totalRewards:t.totalRewards||t[0],burnAmount:t.burnAmount||t[1],userReceives:t.userReceives||t[2],burnRateBips:t.burnRateBips||t[3],nftBoost:t.nftBoost||t[4]}}catch{const{stakingRewards:t,minerRewards:n}=await Vt(),a=t+n,s=a*BigInt(Cn)/100n;Ft={totalRewards:a,burnAmount:s,userReceives:a-s,burnRateBips:BigInt(Cn*100),nftBoost:BigInt(Ve)}}}catch(e){console.error("Error loading claim preview:",e)}}function Ep(){const e=Xl(Ve),t=document.getElementById("nft-tier-icon");t&&(t.textContent=e.icon,t.style.background=`${e.color}20`);const n=document.getElementById("nft-tier-badge");n&&(n.className=`nft-tier-badge tier-${e.name.toLowerCase()}`,n.innerHTML=`<span>${e.icon} ${e.name}</span>`);const a=document.getElementById("nft-source");a&&(Ve>0?(a.classList.remove("hidden"),a.textContent=Yl):a.classList.add("hidden"));const s=document.getElementById("burn-rate-text");s&&(e.burnRate===0?s.innerHTML='<span class="text-green-400">No burn! You keep 100% of rewards</span>':s.textContent=`${e.burnRate}% of rewards will be burned on claim`);const r=document.getElementById("burn-rate-value"),i=document.getElementById("keep-rate-value");r&&(r.textContent=`${e.burnRate}%`),i&&(i.textContent=`${e.userGets}%`);const o=document.getElementById("burn-fill"),l=document.getElementById("receive-fill");o&&(o.style.width=`${e.burnRate}%`),l&&(l.style.width=`${e.userGets}%`)}function Cp(){var i;const e=(o,l)=>{const d=document.getElementById(o);d&&(d.textContent=l)};e("stat-network",Ut(fn||c.totalNetworkPStake||0n)),e("stat-pstake",Ut(c.userTotalPStake||0n)),e("balance-display",_(c.currentUserBalance||0n).toFixed(2)),e("stat-delegations",(c.userDelegations||[]).length.toString());const t=c.userTotalPStake||0n,n=fn||c.totalNetworkPStake||0n;let a=0;n>0n&&t>0n&&(a=Number(t*10000n/n)/100),e("stat-pstake-percent",a>0?`${a.toFixed(2)}% of network`:"0% of network");const s=((i=c.systemFees)==null?void 0:i.DELEGATION_FEE_BIPS)||50n,r=Number(s)/100;e("fee-info",`${r}% protocol fee`),Ip()}async function Ip(){const e=document.getElementById("claim-section");if(!e)return;const{stakingRewards:t,minerRewards:n}=await Vt(),a=t+n,s=(r,i)=>{const o=document.getElementById(r);o&&(o.textContent=i)};if(s("stat-rewards",_(a).toFixed(4)),a>0n){e.classList.remove("hidden");let r,i;Ft&&Ft.totalRewards>0n?(r=Ft.burnAmount,i=Ft.userReceives):(r=a*BigInt(Cn)/100n,i=a-r),s("claim-total",_(a).toFixed(4)),s("claim-burn",_(r).toFixed(4)),s("claim-receive",_(i).toFixed(4)),r>0n?e.classList.add("has-burn"):e.classList.remove("has-burn");const o=document.getElementById("claim-btn");o&&(o.onclick=()=>Np(t,n,o))}else e.classList.add("hidden")}function Zs(){const e=(s,r)=>{const i=document.getElementById(s);i&&(i.textContent=r)};e("stat-network","--"),e("stat-pstake","--"),e("stat-rewards","--"),e("stat-delegations","0"),e("balance-display","0.00"),e("stat-pstake-percent","--% of network");const t=document.getElementById("delegations-list");t&&(t.innerHTML=`
        ...
        `;return}const s=[...t].sort((r,i)=>Number(r.unlockTime)-Number(i.unlockTime));e.innerHTML=s.map(r=>Ap(r)).join(""),Yr(),yt=setInterval(Yr,6e4),e.querySelectorAll(".unstake-btn").forEach(r=>{r.addEventListener("click",()=>Vr(r.dataset.index,!1))}),e.querySelectorAll(".force-unstake-btn").forEach(r=>{r.addEventListener("click",()=>{confirm(`⚠️ Force Unstake will apply a 50% penalty!

Are you sure?`)&&Vr(r.dataset.index,!0)})})}function Ap(e){const t=_(e.amount).toFixed(2),n=Ut(ql(e.amount,e.lockDuration)),a=Number(e.unlockTime),s=Math.floor(Date.now()/1e3),r=a>s,i=r?a-s:0,o=Math.floor(Number(e.lockDuration)/86400);return`
                ...
                <div class="flex items-center gap-3 min-w-0">
                    ...
                    <div class="min-w-0">
                        ...
                        <div class="flex items-center gap-2 mt-0.5">
                            ...
                            <span class="text-zinc-500 text-[10px]">${hp(o)}</span>
                        </div>
                    </div>
                </div>
    ...
    `}function Yr(){const e=document.querySelectorAll(".countdown-timer"),t=Math.floor(Date.now()/1e3);e.forEach(n=>{const a=parseInt(n.dataset.unlockTime);n.textContent=Vl(a-t)})}async function Bp(){if(c.userAddress)try{const e=Te.getHistory||"https://gethistory-4wvdcuoouq-uc.a.run.app",t=await fetch(`${e}/${c.userAddress}`);t.ok&&(cs=(await t.json()||[]).filter(a=>{const s=(a.type||"").toUpperCase();return s.includes("DELEGAT")||s.includes("STAKE")||s.includes("UNDELEGAT")||s.includes("CLAIM")||s.includes("REWARD")||s.includes("FORCE")}),Zl())}catch(e){console.error("History load error:",e)}}function Zl(){const e=document.getElementById("staking-history-list");if(!e)return;let t=cs;if(un!=="ALL"&&(t=cs.filter(n=>{const a=(n.type||"").toUpperCase();switch(un){case"STAKE":return(a.includes("DELEGAT")||a.includes("STAKE"))&&!a.includes("UNSTAKE")&&!a.includes("UNDELEGAT")&&!a.includes("FORCE");case"UNSTAKE":return a.includes("UNSTAKE")||a.includes("UNDELEGAT")||a.includes("FORCE");case"CLAIM":return a.includes("CLAIM")||a.includes("REWARD");default:return!0}})),t.length===0){e.innerHTML=`
        ...
        `;return}e.innerHTML=t.slice(0,25).map(n=>{const a=(n.type||"").toUpperCase(),s=n.details||{},r=vp(n.timestamp||n.createdAt);let i,o,l,d,p="";a.includes("FORCE")?(i="fa-bolt",o="bg-red-500/15",l="text-red-400",d="Force Unstaked",s.feePaid&&BigInt(s.feePaid)>0n&&(p=`<span class="text-red-400">-${_(BigInt(s.feePaid)).toFixed(2)} penalty</span>`)):(a.includes("DELEGAT")||a.includes("STAKE"))&&!a.includes("UNSTAKE")?(i="fa-lock",o="bg-green-500/15",l="text-green-400",d="Delegated",s.pStakeGenerated&&(p=`<span class="text-purple-400">+${_(BigInt(s.pStakeGenerated)).toFixed(0)} pS</span>`)):a.includes("UNSTAKE")||a.includes("UNDELEGAT")?(i="fa-unlock",o="bg-orange-500/15",l="text-orange-400",d="Unstaked"):a.includes("CLAIM")||a.includes("REWARD")?(i="fa-coins",o="bg-amber-500/15",l="text-amber-400",d="Claimed",s.amountReceived&&BigInt(s.amountReceived)>0n&&(p=`<span class="text-green-400">+${_(BigInt(s.amountReceived)).toFixed(2)}</span>`)):(i="fa-circle",o="bg-zinc-500/15",l="text-zinc-400",d=n.type||"Activity");const f=n.txHash?`${xp}${n.txHash}`:"#",m=n.amount||s.amount||s.amountReceived||"0",b=_(BigInt(m)),u=b>.001?b.toFixed(2):"";return`
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <div class="flex items-center gap-2">
                            ...
                            ${p?`<span class="text-[10px]">${p}</span>`:""}
                        </div>
                        <p class="text-zinc-600 text-[10px]">${r}</p>
                    </div>
                </div>
                <div class="flex items-center gap-2">
                    ${u?`<span class="text-xs font-mono font-medium text-white">${u} <span class="text-zinc-500">BKC</span></span>`:""}
                    <i class="fa-solid fa-arrow-up-right-from-square text-zinc-600 group-hover:text-purple-400 text-[10px] transition-colors"></i>
                </div>
            </a>
        `}).join("")}function bn(){var a;const e=document.getElementById("amount-input"),t=document.getElementById("stake-btn");if(!e)return;const n=e.value;if(!n||parseFloat(n)<=0){document.getElementById("preview-pstake").textContent="0",document.getElementById("preview-net").textContent="0.00 BKC",t&&(t.disabled=!0);return}try{const s=mn.parseUnits(n,18),r=((a=c.systemFees)==null?void 0:a.DELEGATION_FEE_BIPS)||50n,i=s*BigInt(r)/10000n,o=s-i,l=BigInt(Js)*86400n,d=ql(o,l);document.getElementById("preview-pstake").textContent=Ut(d),document.getElementById("preview-net").textContent=`${_(o).toFixed(4)} BKC`;const p=c.currentUserBalance||0n;s>p?(e.classList.add("error"),t&&(t.disabled=!0)):(e.classList.remove("error"),t&&(t.disabled=Oe))}catch{t&&(t.disabled=!0)}}async function Pp(){if(Oe)return;const e=document.getElementById("amount-input"),t=document.getElementById("stake-btn"),n=document.getElementById("stake-btn-text"),a=document.getElementById("stake-btn-icon");if(!e||!t)return;const s=e.value;if(!s||parseFloat(s)<=0){x("Enter an amount","warning");return}const r=c.currentUserBalance||0n;let i;try{if(i=mn.parseUnits(s,18),i>r){x("Insufficient BKC balance","error");return}}catch{x("Invalid amount","error");return}try{if(await new mn.BrowserProvider(window.ethereum).getBalance(c.userAddress)<mn.parseEther("0.001")){x("Insufficient ETH for gas","error");return}}catch{}Oe=!0;const o=BigInt(Js)*86400n;t.disabled=!0,n.textContent="Processing...",a.className="fa-solid fa-spinner fa-spin";try{await It.delegate({amount:i,lockDuration:o,button:t,onSuccess:async()=>{e.value="",x("🔒 Delegation successful!","success"),Dt=!1,En=0,await Qt(!0)},onError:l=>{l.cancelled||x("Delegation failed: "+(l.reason||l.message||"Unknown error"),"error")}})}catch(l){x("Delegation failed: "+(l.reason||l.message||"Unknown error"),"error")}finally{Oe=!1,t.disabled=!1,n.textContent="Delegate BKC",a.className="fa-solid fa-lock",bn()}}async function Vr(e,t){if(Oe)return;const n=document.querySelector(t?`.force-unstake-btn[data-index='${e}']`:`.unstake-btn[data-index='${e}']`);n&&(n.disabled=!0,n.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>'),Oe=!0;try{const a=BigInt(e);await(t?It.forceUnstake:It.unstake)({delegationIndex:a,button:n,onSuccess:async()=>{x(t?"⚡ Force unstaked (50% penalty applied)":"🔓 Unstaked successfully!",t?"warning":"success"),Dt=!1,En=0,await Qt(!0)},onError:r=>{r.cancelled||x("Unstake failed: "+(r.reason||r.message||"Unknown error"),"error")}})}catch(a){x("Unstake failed: "+(a.reason||a.message||"Unknown error"),"error")}finally{Oe=!1,Jl()}}async function Np(e,t,n){if(Oe)return;Oe=!0;const a=n.innerHTML;n.disabled=!0,n.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Processing...';try{await It.claimRewards({button:n,onSuccess:async()=>{x("🪙 Rewards claimed!","success"),Dt=!1,En=0,await Qt(!0)},onError:s=>{s.cancelled||x("Claim failed: "+(s.reason||s.message||"Unknown error"),"error")}})}catch(s){x("Claim failed: "+(s.reason||s.message||"Unknown error"),"error")}finally{Oe=!1,n.disabled=!1,n.innerHTML=a}}function zp(){const e=document.getElementById("amount-input"),t=document.getElementById("max-btn"),n=document.getElementById("stake-btn"),a=document.getElementById("refresh-btn"),s=document.querySelectorAll(".duration-chip"),r=document.querySelectorAll(".history-tab");e==null||e.addEventListener("input",bn),t==null||t.addEventListener("click",()=>{const i=c.currentUserBalance||0n;e&&(e.value=mn.formatUnits(i,18),bn())}),s.forEach(i=>{i.addEventListener("click",()=>{s.forEach(o=>o.classList.remove("selected")),i.classList.add("selected"),Js=parseInt(i.dataset.days),bn()})}),r.forEach(i=>{i.addEventListener("click",()=>{r.forEach(o=>o.classList.remove("active")),i.classList.add("active"),un=i.dataset.filter,Zl()})}),n==null||n.addEventListener("click",Pp),a==null||a.addEventListener("click",()=>{const i=a.querySelector("i");i==null||i.classList.add("fa-spin"),Qt(!0).then(()=>{setTimeout(()=>i==null?void 0:i.classList.remove("fa-spin"),500)})})}function Lp(){yt&&(clearInterval(yt),yt=null)}function Sp(e){e?Qt():Zs()}const Ql={render:yp,update:Sp,cleanup:Lp},Ie=window.ethers,Rp="https://sepolia.arbiscan.io/tx/",$p=3e4,qr={Diamond:{color:"#22d3ee",gradient:"from-cyan-500/20 to-blue-500/20",border:"border-cyan-500/40",text:"text-cyan-400",glow:"shadow-cyan-500/30",icon:"💎",keepRate:100,burnRate:0},Gold:{color:"#fbbf24",gradient:"from-yellow-500/20 to-amber-500/20",border:"border-yellow-500/40",text:"text-yellow-400",glow:"shadow-yellow-500/30",icon:"🥇",keepRate:90,burnRate:10},Silver:{color:"#9ca3af",gradient:"from-gray-400/20 to-slate-400/20",border:"border-gray-400/40",text:"text-gray-300",glow:"shadow-gray-400/30",icon:"🥈",keepRate:75,burnRate:25},Bronze:{color:"#f97316",gradient:"from-orange-600/20 to-amber-700/20",border:"border-orange-600/40",text:"text-orange-400",glow:"shadow-orange-500/30",icon:"🥉",keepRate:60,burnRate:40}};function Ca(e){return qr[e]||qr.Bronze}const L={tradeDirection:"buy",selectedPoolBoostBips:null,buyPrice:0n,sellPrice:0n,netSellPrice:0n,poolNFTCount:0,userBalanceOfSelectedNFT:0,availableToSellCount:0,firstAvailableTokenId:null,firstAvailableTokenIdForBuy:null,bestBoosterTokenId:0n,bestBoosterBips:0,isDataLoading:!1,tradeHistory:[]},na=new Map,Qs=new Map;let Vn=!1,ht=null;const _p=["function getPoolAddress(uint256 boostBips) view returns (address)","function isPool(address) view returns (bool)"];function Fp(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function Mp(e){const t=Qs.get(e);return t&&Date.now()-t.timestamp<$p?t.data:null}function ec(e,t){Qs.set(e,{data:t,timestamp:Date.now()})}function Ua(e){Qs.delete(e)}function Dp(){if(document.getElementById("swap-styles-v9"))return;const e=document.createElement("style");e.id="swap-styles-v9",e.textContent=`
    ...
    `}const Hp={async render(e){Dp(),await Bi();const t=document.getElementById("store");t&&((t.innerHTML.trim()===""||e)&&(t.innerHTML=`
            ...
            `,Kp()),L.selectedPoolBoostBips===null&&ge.length>0&&(L.selectedPoolBoostBips=ge[0].boostBips),await at(),await pn())},async update(){L.selectedPoolBoostBips!==null&&!L.isDataLoading&&document.getElementById("store")&&!document.hidden&&await at()}};async function pn(){const e=document.getElementById("history-list");if(!c.userAddress){e&&(e.innerHTML='<div class="text-center py-4 text-xs text-zinc-600">Connect wallet to view history</div>');return}try{const t=Te.getHistory||"https://gethistory-4wvdcuoouq-uc.a.run.app",n=await fetch(`${t}/${c.userAddress}`);if(!n.ok)throw new Error(`HTTP ${n.status}`);const a=await n.json();console.log("All history types:",[...new Set((a||[]).map(r=>r.type))]),L.tradeHistory=(a||[]).filter(r=>{const i=(r.type||"").toUpperCase();return i==="NFTBOUGHT"||i==="NFTSOLD"||i==="NFT_BOUGHT"||i==="NFT_SOLD"||i==="NFTPURCHASED"||i==="NFT_PURCHASED"||i.includes("NFTBOUGHT")||i.includes("NFTSOLD")||i.includes("NFTPURCHASED")}),console.log("NFT trade history:",L.tradeHistory.length,"items");const s=document.getElementById("history-count");s&&(s.textContent=L.tradeHistory.length),Xr()}catch(t){console.error("History load error:",t),L.tradeHistory=[],Xr()}}function Xr(){const e=document.getElementById("history-list");if(e){if(!c.isConnected){e.innerHTML='<div class="text-center py-4 text-xs text-zinc-600">Connect wallet to view history</div>';return}if(L.tradeHistory.length===0){e.innerHTML=`
        ...
        `;return}e.innerHTML=L.tradeHistory.slice(0,20).map(t=>{const n=(t.type||"").toUpperCase(),a=t.details||{},s=Fp(t.timestamp||t.createdAt),r=n.includes("BOUGHT")||n.includes("PURCHASED"),i=r?"fa-cart-plus":"fa-money-bill-transfer",o=r?"#22c55e":"#f59e0b",l=r?"rgba(34,197,94,0.15)":"rgba(245,158,11,0.15)",d=r?"🛒 Bought NFT":"💰 Sold NFT",p=r?"-":"+",f=t.txHash?`${Rp}${t.txHash}`:"#";let m="";try{let g=t.amount||a.amount||a.price||a.payout||"0";if(typeof g=="string"&&g!=="0"){const y=_(BigInt(g));y>.001&&(m=y.toFixed(2))}}catch{}const b=a.tokenId||"",u=a.boostBips||a.boost||"";return`
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-white text-xs font-medium">
                            ...
                            ${u?`<span class="ml-1 text-[9px] text-purple-400">+${Number(u)/100}%</span>`:""}
                        </p>
                        <p class="text-zinc-600 text-[10px]">${s}</p>
                    </div>
                </div>
                <div class="flex items-center gap-2">
                    ${m?`<span class="text-xs font-mono font-bold ${r?"text-white":"text-green-400"}">${p}${m} <span class="text-zinc-500">BKC</span></span>`:""}
            ...
            <div class="swap-input-box rounded-2xl p-4 mb-1">
                <div class="flex justify-between items-center mb-2">
                    ...
                    <span class="text-xs text-zinc-600">
                        ${a?`Balance: <span class="${p?"text-red-400":"text-zinc-400"}">${i}</span>`:`Available: ${f}`}
                    </span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-2xl font-semibold ${p&&a?"text-red-400":"text-white"}">
                        ${a?r:"1"}
    ...
    `}function jp(e,t,n,a,s=!1){return c.isConnected?e?t?`
        ...
        `;return}const a=c.rentalListings||[],s=new Set(a.map(i=>{var o;return(o=i.tokenId)==null?void 0:o.toString()})),r=Math.floor(Date.now()/1e3);e.innerHTML=n.map(i=>{var E;const o=ge.find(I=>I.boostBips===Number(i.boostBips)),l=Ca(o==null?void 0:o.name),d=lt(Number(i.boostBips)),p=l.icon||(o==null?void 0:o.emoji)||"💎",f=L.firstAvailableTokenId&&BigInt(i.tokenId)===L.firstAvailableTokenId,m=(E=i.tokenId)==null?void 0:E.toString(),b=s.has(m),u=a.find(I=>{var N;return((N=I.tokenId)==null?void 0:N.toString())===m}),g=u&&u.rentalEndTime&&Number(u.rentalEndTime)>r,y=b||g;let k="";return g?k='<span class="absolute top-1 right-1 bg-blue-500 text-white text-[7px] px-1.5 py-0.5 rounded-full font-bold">🔑</span>':b&&(k='<span class="absolute top-1 right-1 bg-green-500 text-white text-[7px] px-1.5 py-0.5 rounded-full font-bold">📋</span>'),`
        ...
        `}).join("")}async function at(e=!1){var a,s;if(L.selectedPoolBoostBips===null)return;const t=L.selectedPoolBoostBips,n=Date.now();if(ht=n,!e){const r=Mp(t);if(r){ds(r),aa(),Zr(),Gp(t,n);return}}L.isDataLoading=!0;try{const r=c.myBoosters||[],i=c.rentalListings||[],o=new Set(i.map(D=>{var W;return(W=D.tokenId)==null?void 0:W.toString()})),l=Math.floor(Date.now()/1e3),d=r.filter(D=>Number(D.boostBips)===t),p=d.filter(D=>{var _e;const W=(_e=D.tokenId)==null?void 0:_e.toString(),oe=i.find(V=>{var sn;return((sn=V.tokenId)==null?void 0:sn.toString())===W}),ae=o.has(W),Qe=oe&&oe.rentalEndTime&&Number(oe.rentalEndTime)>l;return!ae&&!Qe}),f=ge.find(D=>D.boostBips===t);if(!f){console.warn("Tier not found for boostBips:",t);return}const m=`pool_${f.name.toLowerCase()}`;let b=w[m]||na.get(t);if(!b){const D=w.nftLiquidityPoolFactory;if(D&&c.publicProvider)try{b=await new Ie.Contract(D,_p,c.publicProvider).getPoolAddress(t),b&&b!==Ie.ZeroAddress&&na.set(t,b)}catch(W){console.warn("Factory lookup failed:",W.message)}}if(ht!==n)return;if(!b||b===Ie.ZeroAddress){const D=document.getElementById("swap-interface");D&&(D.innerHTML=`
                ...
                `);return}const u=new Ie.Contract(b,Ei,c.publicProvider),[g,y,k]=await Promise.all([ne(u,"getBuyPrice",[],Ie.MaxUint256).catch(()=>Ie.MaxUint256),ne(u,"getSellPrice",[],0n).catch(()=>0n),u.getAvailableNFTs().catch(()=>[])]);if(ht!==n)return;const E=Array.isArray(k)?[...k]:[],I=g===Ie.MaxUint256?0n:g,N=y;let z=((a=c.systemFees)==null?void 0:a.NFT_POOL_SELL_TAX_BIPS)||1000n,T=BigInt(((s=c.boosterDiscounts)==null?void 0:s[L.bestBoosterBips])||0);const F=typeof z=="bigint"?z:BigInt(z),G=typeof T=="bigint"?T:BigInt(T),se=F>G?F-G:0n,de=N*se/10000n,xe=N-de,Q={buyPrice:I,sellPrice:N,netSellPrice:xe,poolNFTCount:E.length,firstAvailableTokenIdForBuy:E.length>0?BigInt(E[E.length-1]):null,userBalanceOfSelectedNFT:d.length,availableToSellCount:p.length,availableNFTsOfTier:p};ec(t,Q),ds(Q,t)}catch(r){if(console.warn("Store Data Warning:",r.message),ht===n){const i=document.getElementById("swap-interface");i&&(i.innerHTML=`
                    <div class="text-center py-12">
                        <div class="w-12 h-12 bg-zinc-800 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                `)}return}finally{ht===n&&(L.isDataLoading=!1,aa(),Zr())}}async function Gp(e,t){var n,a;try{const s=c.myBoosters||[],r=c.rentalListings||[],i=new Set(r.map(Q=>{var D;return(D=Q.tokenId)==null?void 0:D.toString()})),o=Math.floor(Date.now()/1e3),l=s.filter(Q=>Number(Q.boostBips)===e),d=l.filter(Q=>{var Qe;const D=(Qe=Q.tokenId)==null?void 0:Qe.toString(),W=r.find(_e=>{var V;return((V=_e.tokenId)==null?void 0:V.toString())===D}),oe=i.has(D),ae=W&&W.rentalEndTime&&Number(W.rentalEndTime)>o;return!oe&&!ae}),p=ge.find(Q=>Q.boostBips===e);if(!p)return;const f=`pool_${p.name.toLowerCase()}`;let m=w[f]||na.get(e);if(!m||m===Ie.ZeroAddress)return;const b=new Ie.Contract(m,Ei,c.publicProvider),[u,g,y]=await Promise.all([ne(b,"getBuyPrice",[],Ie.MaxUint256).catch(()=>Ie.MaxUint256),ne(b,"getSellPrice",[],0n).catch(()=>0n),b.getAvailableNFTs().catch(()=>[])]);if(ht!==t)return;const k=Array.isArray(y)?[...y]:[],E=u===Ie.MaxUint256?0n:u,I=g;let N=((n=c.systemFees)==null?void 0:n.NFT_POOL_SELL_TAX_BIPS)||1000n,z=BigInt(((a=c.boosterDiscounts)==null?void 0:a[L.bestBoosterBips])||0);const T=typeof N=="bigint"?N:BigInt(N),F=typeof z=="bigint"?z:BigInt(z),G=T>F?T-F:0n,se=I*G/10000n,de=I-se,xe={buyPrice:E,sellPrice:I,netSellPrice:de,poolNFTCount:k.length,firstAvailableTokenIdForBuy:k.length>0?BigInt(k[k.length-1]):null,userBalanceOfSelectedNFT:l.length,availableToSellCount:d.length,availableNFTsOfTier:d};ec(e,xe),L.selectedPoolBoostBips===e&&ht===t&&(ds(xe,e),aa())}catch(s){console.warn("Background refresh failed:",s.message)}}function ds(e,t){var s,r,i;L.buyPrice=e.buyPrice,L.sellPrice=e.sellPrice,L.netSellPrice=e.netSellPrice,L.poolNFTCount=e.poolNFTCount,L.firstAvailableTokenIdForBuy=e.firstAvailableTokenIdForBuy,L.userBalanceOfSelectedNFT=e.userBalanceOfSelectedNFT,L.availableToSellCount=e.availableToSellCount;const n=L.firstAvailableTokenId;!(n&&((s=e.availableNFTsOfTier)==null?void 0:s.some(o=>BigInt(o.tokenId)===n)))&&((r=e.availableNFTsOfTier)==null?void 0:r.length)>0?L.firstAvailableTokenId=BigInt(e.availableNFTsOfTier[0].tokenId):(i=e.availableNFTsOfTier)!=null&&i.length||(L.firstAvailableTokenId=null)}function Kp(){const e=document.getElementById("store");e&&e.addEventListener("click",async t=>{if(t.target.closest("#refresh-btn")){const i=t.target.closest("#refresh-btn").querySelector("i");i.classList.add("fa-spin"),Ua(L.selectedPoolBoostBips),await Promise.all([vt(!0),Pi()]),await at(!0),pn(),i.classList.remove("fa-spin");return}const n=t.target.closest(".tier-chip");if(n){const r=Number(n.dataset.boost);L.selectedPoolBoostBips!==r&&(L.selectedPoolBoostBips=r,L.firstAvailableTokenId=null,Jr(r),await at());return}if(t.target.closest("#swap-direction-btn")){L.tradeDirection=L.tradeDirection==="buy"?"sell":"buy",aa();return}if(t.target.closest("#inventory-toggle")){const r=document.getElementById("inventory-panel"),i=document.getElementById("inventory-chevron");r&&i&&(r.classList.toggle("hidden"),i.style.transform=r.classList.contains("hidden")?"":"rotate(180deg)");return}if(t.target.closest("#history-toggle")){const r=document.getElementById("history-panel"),i=document.getElementById("history-chevron");r&&i&&(r.classList.toggle("hidden"),i.style.transform=r.classList.contains("hidden")?"":"rotate(180deg)");return}const a=t.target.closest(".inventory-item");if(a){if(a.dataset.unavailable==="true"){x("This NFT is listed for rental and cannot be sold","warning");return}const i=Number(a.dataset.boost),o=a.dataset.tokenid;L.selectedPoolBoostBips=i,L.tradeDirection="sell",o&&(L.firstAvailableTokenId=BigInt(o),console.log("User selected NFT #"+o+" for sale")),Jr(i),await at();return}const s=t.target.closest("#execute-btn");if(s){if(t.preventDefault(),t.stopPropagation(),Vn||s.disabled)return;const r=s.dataset.action,i=document.getElementById("trade-mascot");if(r==="connect"){window.openConnectModal();return}const o=ge.find(f=>f.boostBips===L.selectedPoolBoostBips);if(!o)return;const l=`pool_${o.name.toLowerCase()}`,d=w[l]||na.get(o.boostBips);if(!d){x("Pool address not found","error");return}Vn=!0,s.disabled=!0;const p=s.innerHTML;s.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Processing...',i&&(i.className="w-14 h-14 object-contain trade-spin");try{if(L.tradeDirection==="buy")await ns.buyFromPool({poolAddress:d,button:s,onSuccess:async f=>{i&&(i.className="w-14 h-14 object-contain trade-success"),x("🟢 NFT Purchased!","success"),Ua(L.selectedPoolBoostBips),await Promise.all([vt(!0),at(!0)]),pn()},onError:f=>{if(!f.cancelled&&f.type!=="user_rejected"){const m=f.message||f.reason||"Transaction failed";x("Buy failed: "+m,"error")}}});else{if(!L.firstAvailableTokenId){x("No NFT selected for sale","error"),Vn=!1,s.disabled=!1,s.innerHTML=p;return}await ns.sellToPool({poolAddress:d,tokenId:L.firstAvailableTokenId,button:s,onSuccess:async f=>{i&&(i.className="w-14 h-14 object-contain trade-success"),x("🔴 NFT Sold!","success"),Ua(L.selectedPoolBoostBips),await Promise.all([vt(!0),at(!0)]),pn()},onError:f=>{if(!f.cancelled&&f.type!=="user_rejected"){const m=f.message||f.reason||"Transaction failed";x("Sell failed: "+m,"error")}}})}}finally{Vn=!1,s.disabled=!1,s.innerHTML=p,setTimeout(async()=>{try{await Promise.all([vt(!0),at(!0)]),pn()}catch(f){console.warn("[Store] Post-transaction refresh failed:",f.message)}},2e3),i&&setTimeout(()=>{const f=L.tradeDirection==="buy";i.className=`w-14 h-14 object-contain ${f?"trade-buy":"trade-sell"}`},800)}}})}const Yp="https://sepolia.arbiscan.io/tx/",on={NONE:{boost:0,burnRate:50,keepRate:50,color:"#71717a",name:"None",icon:"○",emoji:"❌",class:"tier-none"},BRONZE:{boost:1e3,burnRate:40,keepRate:60,color:"#cd7f32",name:"Bronze",icon:"🥉",emoji:"🥉",class:"tier-bronze"},SILVER:{boost:2500,burnRate:25,keepRate:75,color:"#c0c0c0",name:"Silver",icon:"🥈",emoji:"🥈",class:"tier-silver"},GOLD:{boost:4e3,burnRate:10,keepRate:90,color:"#ffd700",name:"Gold",icon:"🥇",emoji:"🥇",class:"tier-gold"},DIAMOND:{boost:5e3,burnRate:0,keepRate:100,color:"#b9f2ff",name:"Diamond",icon:"💎",emoji:"💎",class:"tier-diamond"}};let ja=0,Wa=!1,Jn=!1,In=[],An=null,be=0,Wt=50,sa="none",ra=0n,We=null,qn=0;const Qr=3e4;window.handleRewardsClaim=async function(){Jn||await n0()};function tc(e){return e>=5e3?on.DIAMOND:e>=4e3?on.GOLD:e>=2500?on.SILVER:e>=1e3?on.BRONZE:on.NONE}function Vp(e){const t=Math.floor((new Date-e)/1e3);return t<60?"Just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:t<604800?`${Math.floor(t/86400)}d ago`:e.toLocaleDateString()}function qp(){if(document.getElementById("rewards-styles-v6"))return;const e=document.createElement("style");e.id="rewards-styles-v6",e.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `)}function Xn(e){const t=document.getElementById("rewards-content");if(!t)return;const{grossRewards:n}=e||{},a=(n==null?void 0:n.stakingRewards)||0n,s=(n==null?void 0:n.minerRewards)||0n,r=An||{},i=r.totalRewards||a+s,o=r.burnAmount||i*BigInt(Wt)/100n,l=r.userReceives||i-o,d=Number(i)/1e18,p=Number(o)/1e18,f=Number(l)/1e18,m=Number(a)/1e18,b=Number(s)/1e18,u=Number(ra)/1e18,g=i>0n,y=tc(be),k=d,E=d*(y.keepRate/100),I=k-E;t.innerHTML=`
        <div class="space-y-4">
            ...
            <div class="rewards-card overflow-hidden ${g?"pulse-glow":""}">
                ...
                <div class="px-5 pb-5">
                    ...
                    <p class="text-center text-[10px] text-zinc-600 mt-2">
                        <i class="fa-brands fa-ethereum mr-1"></i>Claim fee: ${u.toFixed(6)} ETH
                    </p>
                    `:""}
                </div>
            </div>
                ...
                <div class="border-t border-zinc-800 pt-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="font-mono text-red-400/70">-${p.toFixed(4)} BKC</span>
                        </div>
                        `:""}
                        <div class="flex items-center justify-between">
    ...
    `}function t0(){return In.length===0?`
        ...
        `}).join("")}async function n0(){if(Jn)return;const e=document.getElementById("claim-btn"),t=document.getElementById("claim-btn-text"),n=document.getElementById("claim-btn-icon");if(e){Jn=!0,e.disabled=!0,e.className="claim-btn w-full py-4 text-base flex items-center justify-center gap-2",e.style.background="rgba(63,63,70,0.8)",t.textContent="Processing...",n.className="fa-solid fa-spinner fa-spin";try{await It.claimRewards({button:e,onSuccess:a=>{e.style.background="linear-gradient(135deg, #22c55e 0%, #16a34a 100%)",e.className="claim-btn w-full py-4 text-base flex items-center justify-center gap-2 celebrate",t.textContent="🎉 Claimed Successfully!",n.className="fa-solid fa-check",x("🎁 Rewards claimed successfully!","success"),setTimeout(()=>{ia.clearCache(),In=[],ia.update(!0)},2500)},onError:a=>{a&&!a.cancelled&&a.type!=="user_rejected"&&x(a.message||"Claim failed","error"),ti()}})}catch(a){console.error("Claim error:",a),x(a.message||"Claim failed","error"),ti()}finally{Jn=!1}}}function ti(){const e=document.getElementById("claim-btn"),t=document.getElementById("claim-btn-text"),n=document.getElementById("claim-btn-icon");e&&(e.disabled=!1,e.style.background="",e.className="claim-btn w-full py-4 text-base flex items-center justify-center gap-2",t&&(t.textContent="Claim Rewards"),n&&(n.className="fa-solid fa-hand-holding-dollar"))}window.RewardsPage=ia;const er="https://sepolia.arbiscan.io/tx/",us="https://sepolia.arbiscan.io/address/",nc="0x16346f5a45f9615f1c894414989f0891c54ef07b",a0=(w==null?void 0:w.fortunePool)||"0x277dB00d533Bbc0fc267bbD954640aDA38ee6B37",oa="./assets/fortune.png",ps=1e3,ni={pt:{title:"Compartilhe & Ganhe!",subtitle:"+1000 pontos para o Airdrop",later:"Talvez depois"},en:{title:"Share & Earn!",subtitle:"+1000 points for Airdrop",later:"Maybe later"},es:{title:"¡Comparte y Gana!",subtitle:"+1000 puntos para el Airdrop",later:"Quizás después"}},s0={pt:{win:e=>`🎉 Ganhei ${e.toLocaleString()} BKC no Fortune Pool!
...
#Backcoin #Web3 #Arbitrum`}},Ga={pt:"./assets/pt.png",en:"./assets/en.png",es:"./assets/es.png"};let Ge="en";const ue=[{id:1,name:"Easy",emoji:"🍀",range:3,multiplier:2,chance:"33%",color:"emerald",hex:"#10b981",bgFrom:"from-emerald-500/20",bgTo:"to-green-600/10",borderColor:"border-emerald-500/50",textColor:"text-emerald-400"},{id:2,name:"Medium",emoji:"⚡",range:10,multiplier:5,chance:"10%",color:"violet",hex:"#8b5cf6",bgFrom:"from-violet-500/20",bgTo:"to-purple-600/10",borderColor:"border-violet-500/50",textColor:"text-violet-400"},{id:3,name:"Hard",emoji:"👑",range:100,multiplier:50,chance:"1%",color:"amber",hex:"#f59e0b",bgFrom:"from-amber-500/20",bgTo:"to-orange-600/10",borderColor:"border-amber-500/50",textColor:"text-amber-400"}],ac=57,v={mode:null,phase:"select",guess:50,guesses:[2,5,50],comboStep:0,wager:10,gameId:null,result:null,txHash:null,poolStatus:null,history:[],serviceFee:0n,serviceFee1x:0n,serviceFee5x:0n,tiersData:null,commitment:{hash:null,userSecret:null,commitBlock:null,commitTxHash:null,revealDelay:2,waitStartTime:null,canReveal:!1}};let Le=null;const r0=3e3,sc=250;function i0(){if(document.getElementById("fortune-styles-v2"))return;const e=document.createElement("style");e.id="fortune-styles-v2",e.textContent=`
    ...
    `,document.head.appendChild(e)}function o0(){i0();const e=document.getElementById("actions");if(!e){console.error("❌ FortunePool: Container #actions not found!");return}e.innerHTML=`
    ...
    `,nr(),le()}function l0(){Le&&(clearInterval(Le),Le=null),v.phase="select",v.result=null,v.commitment={hash:null,userSecret:null,commitBlock:null,commitTxHash:null,revealDelay:v.commitment.revealDelay||2,waitStartTime:null,canReveal:!1}}function le(){const e=document.getElementById("game-area");if(e)switch(c0(v.phase),v.phase){case"select":ai(e);break;case"pick":d0(e);break;case"wager":m0(e);break;case"processing":b0(e);break;case"waiting":g0(e);break;case"result":y0(e);break;default:ai(e)}}function c0(e){var n;const t=document.getElementById("tiger-mascot");if(t)switch(t.className="w-28 h-28 object-contain mx-auto",t.style.filter="",e){case"select":t.classList.add("tiger-float","tiger-pulse");break;case"pick":case"wager":t.classList.add("tiger-float");break;case"processing":t.classList.add("tiger-spin");break;case"waiting":t.classList.add("tiger-float"),t.style.filter="hue-rotate(270deg)";break;case"result":((n=v.result)==null?void 0:n.prizeWon)>0?t.classList.add("tiger-celebrate"):(t.style.filter="grayscale(0.5)",t.classList.add("tiger-float"));break}}function ai(e){var s,r;const t=v.serviceFee1x>0n?(Number(v.serviceFee1x)/1e18).toFixed(6):"0",n=v.serviceFee5x>0n?(Number(v.serviceFee5x)/1e18).toFixed(6):"0",a=v.serviceFee1x>0n||v.serviceFee5x>0n;e.innerHTML=`
        <div class="space-y-4">
            <!-- JACKPOT MODE -->
    ...
    `;const a=document.getElementById("number-input"),s=document.getElementById("number-slider"),r=ue[2],i=u=>{u=Math.max(1,Math.min(100,u)),v.guess=u,a&&(a.value=u),s&&(s.value=u,s.style.background=`linear-gradient(to right, ${r.hex} 0%, ${r.hex} ${u}%, #27272a ${u}%, #27272a 100%)`)};a==null||a.addEventListener("input",u=>i(parseInt(u.target.value)||1)),a==null||a.addEventListener("blur",u=>i(parseInt(u.target.value)||1)),s==null||s.addEventListener("input",u=>i(parseInt(u.target.value))),(o=document.getElementById("btn-minus"))==null||o.addEventListener("click",()=>i(v.guess-1)),(l=document.getElementById("btn-plus"))==null||l.addEventListener("click",()=>i(v.guess+1)),(d=document.getElementById("btn-minus-10"))==null||d.addEventListener("click",()=>i(v.guess-10)),(p=document.getElementById("btn-plus-10"))==null||p.addEventListener("click",()=>i(v.guess+10)),document.querySelectorAll(".quick-pick").forEach(u=>{u.addEventListener("click",()=>i(parseInt(u.dataset.number)))}),(f=document.getElementById("btn-random"))==null||f.addEventListener("click",()=>{i(Math.floor(Math.random()*100)+1)}),(m=document.getElementById("btn-back"))==null||m.addEventListener("click",()=>{v.phase="select",le()}),(b=document.getElementById("btn-next"))==null||b.addEventListener("click",()=>{v.phase="wager",le()})}function p0(e){var r,i,o,l,d,p,f;const t=ue[v.comboStep],n=v.guesses[v.comboStep],a=t.range===100;if(e.innerHTML=`
        <div class="bg-gradient-to-br from-zinc-900 to-zinc-800/50 border border-zinc-700/50 rounded-2xl p-5">
            <!-- Progress Pills -->
            <div class="flex justify-center gap-2 sm:gap-3 mb-5">
                ${ue.map((m,b)=>{const u=b===v.comboStep,g=b<v.comboStep;return`
                        <div class="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 rounded-xl border ${u?`bg-gradient-to-br ${m.bgFrom} ${m.bgTo} ${m.borderColor}`:g?"bg-emerald-500/10 border-emerald-500/50":"bg-zinc-800/50 border-zinc-700/50"}">
                            <span class="text-lg sm:text-xl">${g?"✓":m.emoji}</span>
                            <div class="text-left">
                                <p class="text-[10px] sm:text-xs font-bold ${u?m.textColor:g?"text-emerald-400":"text-zinc-500"}">${m.name}</p>
    ...
    `,t.range===100){const m=document.getElementById("combo-number-input"),b=document.getElementById("combo-slider"),u=g=>{g=Math.max(1,Math.min(100,g)),v.guesses[v.comboStep]=g,m&&(m.value=g),b&&(b.value=g,b.style.background=`linear-gradient(to right, ${t.hex} 0%, ${t.hex} ${g}%, #27272a ${g}%, #27272a 100%)`)};m==null||m.addEventListener("input",g=>u(parseInt(g.target.value)||1)),m==null||m.addEventListener("blur",g=>u(parseInt(g.target.value)||1)),b==null||b.addEventListener("input",g=>u(parseInt(g.target.value))),(r=document.querySelector(".combo-minus"))==null||r.addEventListener("click",()=>u(v.guesses[v.comboStep]-1)),(i=document.querySelector(".combo-plus"))==null||i.addEventListener("click",()=>u(v.guesses[v.comboStep]+1)),(o=document.querySelector(".combo-minus-10"))==null||o.addEventListener("click",()=>u(v.guesses[v.comboStep]-10)),(l=document.querySelector(".combo-plus-10"))==null||l.addEventListener("click",()=>u(v.guesses[v.comboStep]+10)),document.querySelectorAll(".combo-quick").forEach(g=>{g.addEventListener("click",()=>u(parseInt(g.dataset.num)))}),(d=document.querySelector(".combo-random"))==null||d.addEventListener("click",()=>{u(Math.floor(Math.random()*100)+1)})}else document.querySelectorAll(".num-btn").forEach(m=>{m.addEventListener("click",()=>{const b=parseInt(m.dataset.num);v.guesses[v.comboStep]=b,document.querySelectorAll(".num-btn").forEach(u=>{parseInt(u.dataset.num)===b?u.className=`num-btn w-12 h-12 rounded-xl font-bold text-lg transition-all bg-gradient-to-br ${t.bgFrom} ${t.bgTo} border-2 ${t.borderColor} ${t.textColor}`:u.className="num-btn w-12 h-12 rounded-xl font-bold text-lg transition-all bg-zinc-800/60 border border-zinc-700/50 text-zinc-400 hover:border-zinc-600"})})});(p=document.getElementById("btn-back"))==null||p.addEventListener("click",()=>{v.comboStep>0?(v.comboStep--,le()):(v.phase="select",le())}),(f=document.getElementById("btn-next"))==null||f.addEventListener("click",()=>{v.comboStep<2?(v.comboStep++,le()):(v.phase="wager",le())})}function m0(e){const t=v.mode==="jackpot",n=t?[v.guess]:v.guesses,a=t?50:ac,s=_(c.currentUserBalance||0n),r=s>=1,i=t?v.serviceFee1x:v.serviceFee5x,o=i>0n?Number(i)/1e18:0,l=i>0n;e.innerHTML=`
        <div class="bg-gradient-to-br from-zinc-900 to-zinc-800/50 border border-zinc-700/50 rounded-2xl p-5">
            <div class="text-center mb-5">
                <h2 class="text-xl font-bold text-white mb-2">🎰 Your Selection</h2>
                <div class="flex justify-center gap-3">
                    ${(t?[{tier:ue[2],pick:n[0]}]:n.map((d,p)=>({tier:ue[p],pick:d}))).map(({tier:d,pick:p})=>`
                        <div class="flex items-center gap-2 px-4 py-2 bg-gradient-to-r ${d.bgFrom} ${d.bgTo} border ${d.borderColor} rounded-xl">
                            ...
                            <span class="text-2xl font-black ${d.textColor}">${p}</span>
                        </div>
                    `).join("")}
                </div>
            </div>
    ...
    `,f0(a,s)}function f0(e,t){var a,s,r,i,o,l,d,p;const n=f=>{v.wager=Math.max(1,Math.min(Math.floor(f),Math.floor(t)));const m=document.getElementById("custom-wager"),b=document.getElementById("potential-win");m&&(m.value=v.wager),b&&(b.textContent=(v.wager*e).toLocaleString()),document.querySelectorAll(".percent-btn").forEach(u=>{const g=parseInt(u.dataset.value);v.wager===g?u.className="percent-btn py-2.5 text-sm font-bold rounded-xl transition-all bg-gradient-to-r from-amber-500/30 to-orange-500/20 border-2 border-amber-500/60 text-amber-400 shadow-lg shadow-amber-500/20":u.className="percent-btn py-2.5 text-sm font-bold rounded-xl transition-all bg-zinc-800/60 border border-zinc-700/50 text-zinc-400 hover:border-amber-500/30 hover:text-amber-300"})};document.querySelectorAll(".percent-btn").forEach(f=>{f.addEventListener("click",()=>{n(parseInt(f.dataset.value)||1)})}),(a=document.getElementById("custom-wager"))==null||a.addEventListener("input",f=>{n(parseInt(f.target.value)||1)}),(s=document.getElementById("wager-minus"))==null||s.addEventListener("click",()=>{n(v.wager-1)}),(r=document.getElementById("wager-plus"))==null||r.addEventListener("click",()=>{n(v.wager+1)}),(i=document.getElementById("wager-minus-10"))==null||i.addEventListener("click",()=>{n(v.wager-10)}),(o=document.getElementById("wager-plus-10"))==null||o.addEventListener("click",()=>{n(v.wager+10)}),(l=document.getElementById("btn-faucet"))==null||l.addEventListener("click",async()=>{x("Requesting tokens...","info");try{const m=await(await fetch(`https://faucet-4wvdcuoouq-uc.a.run.app?address=${c.userAddress}`)).json();m.success?(x("🎉 Tokens received!","success"),await Pt(),le()):x(m.error||"Error","error")}catch{x("Faucet error","error")}}),(d=document.getElementById("btn-back"))==null||d.addEventListener("click",()=>{v.phase="pick",v.mode==="combo"&&(v.comboStep=2),le()}),(p=document.getElementById("btn-play"))==null||p.addEventListener("click",async()=>{if(v.wager<1)return x("Min: 1 BKC","warning");v.phase="processing",le();try{const f=v.mode==="jackpot"?[v.guess]:v.guesses,m=v.mode==="combo",b=window.ethers.parseEther(v.wager.toString());await Us.playGame({wagerAmount:b,guesses:f,isCumulative:m,button:document.getElementById("btn-play"),onSuccess:u=>{v.gameId=(u==null?void 0:u.gameId)||Date.now(),v.commitment={hash:null,userSecret:(u==null?void 0:u.userSecret)||null,commitBlock:(u==null?void 0:u.commitBlock)||null,commitTxHash:(u==null?void 0:u.txHash)||null,revealDelay:v.commitment.revealDelay||2,waitStartTime:Date.now(),canReveal:!1},v.txHash=(u==null?void 0:u.txHash)||null,console.log("🔐 Game committed:",v.gameId,"Block:",v.commitment.commitBlock),v.phase="waiting",le(),x0()},onError:u=>{u.cancelled||x(u.message||"Commit failed","error"),v.phase="wager",le()}})}catch(f){console.error("Commit error:",f);const m=f.message||f.reason||"Transaction failed";x("Error: "+m,"error"),v.phase="wager",le()}})}function b0(e){const t=v.mode==="jackpot",n=t?[v.guess]:v.guesses,a=t?[ue[2]]:ue;e.innerHTML=`
    ...
    `,a.forEach((s,r)=>{const i=document.getElementById(`spin-${r}`);if(!i)return;setInterval(()=>{i.textContent=Math.floor(Math.random()*s.range)+1},80)})}function g0(e){var l;const t=v.mode==="jackpot",n=t?[v.guess]:v.guesses,a=t?[ue[2]]:ue,s=Date.now()-(v.commitment.waitStartTime||Date.now()),r=v.commitment.revealDelay*sc,i=Math.max(0,r-s),o=Math.ceil(i/1e3);e.innerHTML=`
        <div class="bg-gradient-to-br from-violet-900/30 to-purple-900/20 border border-violet-500/30 rounded-2xl p-6 waiting-glow">
            ...
            <div class="border-t border-violet-500/20 pt-4 mb-4">
                ...
                <div class="flex justify-center gap-4">
                    ${a.map((d,p)=>{const f=t?n[0]:n[p];return`
                            <div class="text-center">
        ...
        <div class="bg-gradient-to-br ${l?"from-emerald-900/30 to-green-900/10 border-emerald-500/30":"from-zinc-900 to-zinc-800/50 border-zinc-700/50"} border rounded-2xl p-4 sm:p-6 relative overflow-hidden" id="result-container">
            ...
            <div class="text-center mb-4">
                ${l?`
                    ...
                    <p class="text-3xl font-black text-white">${p} BKC</p>
                `:`
                    <div class="text-5xl mb-2">😔</div>
            ...
            <div class="grid ${n?"grid-cols-1 max-w-[200px] mx-auto":"grid-cols-3"} gap-2 sm:gap-3 mb-4">
                ${r.map((b,u)=>{const g=n?a[0]:a[u],y=s[u],k=i[u];return`
    ...
    `,l&&(k0(),d>v.wager*10&&T0()),(f=document.getElementById("btn-new-game"))==null||f.addEventListener("click",()=>{v.phase="select",v.result=null,v.txHash=null,v.gameId=null,le(),nr()}),(m=document.getElementById("btn-share"))==null||m.addEventListener("click",()=>{E0(l,d)})}function k0(){const e=document.createElement("div");e.className="confetti-container",document.body.appendChild(e);const t=["#f59e0b","#10b981","#8b5cf6","#ec4899","#06b6d4"],n=["●","■","★","🐯","🎉"];for(let a=0;a<60;a++){const s=document.createElement("div");s.className="confetti",s.style.cssText=`
            left: ${Math.random()*100}%;
            color: ${t[a%t.length]};
            font-size: ${8+Math.random()*12}px;
            animation-delay: ${Math.random()*2}s;
            animation-duration: ${2+Math.random()*2}s;
        `,s.textContent=n[a%n.length],e.appendChild(s)}setTimeout(()=>e.remove(),5e3)}function T0(){const e=["🪙","💰","✨","⭐","🎉"];for(let t=0;t<30;t++)setTimeout(()=>{const n=document.createElement("div");n.className="coin",n.textContent=e[Math.floor(Math.random()*e.length)],n.style.left=`${Math.random()*100}%`,n.style.animationDelay=`${Math.random()*.5}s`,n.style.animationDuration=`${2+Math.random()*2}s`,document.body.appendChild(n),setTimeout(()=>n.remove(),4e3)},t*100)}function E0(e,t){var l,d,p,f,m,b;const n=ni[Ge],a=()=>{const u=s0[Ge];return e?u.win(t):u.lose},s=`
        <div class="text-center">
    ...
    `;vn(s,"max-w-xs");const r=u=>{Ge=u;const g=ni[u],y=document.getElementById("share-modal-title"),k=document.getElementById("share-modal-subtitle"),E=document.getElementById("btn-close-share");y&&(y.textContent=g.title),k&&(k.textContent=g.subtitle),E&&(E.textContent=g.later),document.querySelectorAll(".lang-btn").forEach(I=>{const N=I.dataset.lang,z=I.querySelector("span");N===u?(I.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-amber-500/20 border-amber-500 ring-1 ring-amber-500/50 border",z&&(z.className="text-amber-400")):(I.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-zinc-800 border-zinc-700 hover:border-zinc-500 border",z&&(z.className="text-zinc-400"))})};document.querySelectorAll(".lang-btn").forEach(u=>{u.addEventListener("click",()=>r(u.dataset.lang))});const i=async u=>{if(!c.userAddress)return!1;try{const y=await(await fetch("https://us-central1-backchain-backand.cloudfunctions.net/trackShare",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({address:c.userAddress,gameId:v.gameId||Date.now(),type:"fortune",platform:u})})).json();return y.success?(x(`🎉 +${y.pointsAwarded||ps} Airdrop Points!`,"success"),!0):(y.reason==="already_shared"&&console.log("Already shared this game"),!1)}catch(g){return console.error("Share tracking error:",g),x(`🎉 +${ps} Airdrop Points!`,"success"),!0}},o=async(u,g)=>{await i(u),window.open(g,"_blank"),we()};(l=document.getElementById("share-twitter"))==null||l.addEventListener("click",()=>{const u=a();o("twitter",`https://twitter.com/intent/tweet?text=${encodeURIComponent(u)}`)}),(d=document.getElementById("share-telegram"))==null||d.addEventListener("click",()=>{const u=a();o("telegram",`https://t.me/share/url?url=https://backcoin.org&text=${encodeURIComponent(u)}`)}),(p=document.getElementById("share-whatsapp"))==null||p.addEventListener("click",()=>{const u=a();o("whatsapp",`https://wa.me/?text=${encodeURIComponent(u)}`)}),(f=document.getElementById("share-instagram"))==null||f.addEventListener("click",async()=>{const u=a();try{await navigator.clipboard.writeText(u),await i("instagram");const g=`
                <div class="text-center p-2">
                    ...
                    <div class="bg-zinc-800/50 rounded-xl p-3 mb-4 text-left">
                        ...
                        <p class="text-zinc-300 text-xs break-words">${u.slice(0,100)}...</p>
                    </div>
            ...
            `)}}catch(t){console.error("loadHistory error:",t)}}function A0(e){const t=document.getElementById("history-list");t&&(t.innerHTML=e.map(n=>{var u;const a=n.isWin||n.prizeWon&&BigInt(n.prizeWon)>0n,s=n.prizeWon?_(BigInt(n.prizeWon)):0,r=n.wagerAmount?_(BigInt(n.wagerAmount)):0,i=n.isCumulative,o=n.rolls||[],l=n.guesses||[],d=n.txHash||n.transactionHash,p=B0(n.timestamp||n.createdAt),f=n.player?`${n.player.slice(0,6)}...${n.player.slice(-4)}`:"???",m=c.userAddress&&((u=n.player)==null?void 0:u.toLowerCase())===c.userAddress.toLowerCase(),b=d?`${er}${d}`:null;return`
               ...
               ${b?"":'onclick="return false;"'}>
                <div class="flex items-center justify-between mb-2">
                    ...
                    <div class="flex items-center gap-1.5">
                        <span class="text-[10px] text-zinc-600">${p}</span>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex gap-1">
                        ${(i?ue:[ue[2]]).map((g,y)=>{const k=l[y],E=o[y];return`
    ...
    `,document.head.appendChild(e)}async function en(){var e;A.isConnected=c.isConnected,A.user=null,A.userSubmissions=[],A.platformUsage={},A.isBanned=!1;try{const t=await As();if(A.systemConfig=t.config,A.leaderboards=t.leaderboards,A.dailyTasks=t.dailyTasks||[],A.platformUsageConfig=t.platformUsageConfig||ic,A.isConnected&&c.userAddress){const[n,a]=await Promise.all([dn(c.userAddress),Od()]);if(A.user=n,A.userSubmissions=a,n&&n.isBanned){A.isBanned=!0;return}try{typeof zr=="function"&&(A.platformUsage=await zr()||{})}catch(s){console.warn("Could not load platform usage:",s),A.platformUsage={}}A.dailyTasks.length>0&&(A.dailyTasks=await Promise.all(A.dailyTasks.map(async s=>{try{if(!s.id)return{...s,eligible:!1,timeLeftMs:0};const r=await Si(s.id,s.cooldownHours);return{...s,eligible:r.eligible,timeLeftMs:r.timeLeft}}catch{return{...s,eligible:!1,timeLeftMs:0}}})))}}catch(t){if(console.error("Airdrop Data Load Error:",t),t.code==="permission-denied"||(e=t.message)!=null&&e.includes("permission")){console.warn("Firebase permissions issue - user may need to connect wallet or sign in"),A.systemConfig=A.systemConfig||{},A.leaderboards=A.leaderboards||{top100ByPoints:[],top100ByPosts:[]},A.dailyTasks=A.dailyTasks||[];return}x("Error loading data. Please refresh.","error")}}function K0(e){if(!A.user||!e||e.length===0)return null;const t=e.findIndex(n=>{var a,s;return((a=n.walletAddress)==null?void 0:a.toLowerCase())===((s=A.user.walletAddress)==null?void 0:s.toLowerCase())});return t>=0?t+1:null}function Y0(e){return e?e<=5?st[0]:e<=25?st[1]:e<=75?st[2]:e<=200?st[3]:null:null}function oc(){var l;const{user:e}=A,t=(e==null?void 0:e.totalPoints)||0,n=(e==null?void 0:e.platformUsagePoints)||0,a=(e==null?void 0:e.approvedSubmissionsCount)||0,s=W0(a),r=((l=A.leaderboards)==null?void 0:l.top100ByPosts)||[],i=K0(r),o=Y0(i);return`
        <!-- Mobile Header -->
    ...
    `}function q0(){var i;const e=A.platformUsageConfig||ic,t=A.platformUsage||{};let n=0,a=0;Object.keys(e).forEach(o=>{var l;e[o].enabled!==!1&&e[o].maxCount&&(n+=e[o].maxCount,a+=Math.min(((l=t[o])==null?void 0:l.count)||0,e[o].maxCount))});const s=n>0?a/n*100:0,r=((i=A.user)==null?void 0:i.platformUsagePoints)||0;return`
        <div class="space-y-4">
            <!-- Info Banner -->
            ...
            <div class="grid grid-cols-2 gap-2" id="platform-actions-grid">
                ${Object.entries(e).filter(([o,l])=>l.enabled!==!1).map(([o,l])=>{const d=t[o]||{count:0},p=d.count>=l.maxCount,f=Math.max(0,l.maxCount-d.count),m=d.count/l.maxCount*100,b=H0[o]||"";return`
                        <div class="platform-action-card bg-zinc-900/80 border border-zinc-800 rounded-xl p-3 ${p?"completed opacity-60":"cursor-pointer hover:border-amber-500/50 hover:bg-zinc-800/80"} transition-all" 
                             data-platform-action="${o}"
                             data-target-page="${b}">
                            <div class="flex items-start justify-between mb-1.5">
                                <span class="text-lg">${l.icon}</span>
                                ${p?'<span class="text-green-400 text-xs"><i class="fa-solid fa-check-circle"></i></span>':`<span class="text-amber-400 text-[10px] font-bold">+${l.points}</span>`}
                            </div>
                            ...
                            <div class="flex items-center justify-between mb-1.5">
                                ...
                                ${!p&&f>0?`<span class="text-zinc-600 text-[10px]">${f} left</span>`:""}
                            </div>
    ...
    `}function J0(){const{user:e,userSubmissions:t}=A;if(!A.isConnected)return`
        ...
        `;const n=Date.now(),a=rc*60*60*1e3,s=t.filter(l=>["pending","auditing"].includes(l.status)&&l.submittedAt&&n-l.submittedAt.getTime()>=a),r=(e==null?void 0:e.approvedSubmissionsCount)||0,i=t.filter(l=>["pending","auditing"].includes(l.status)).length,o=t.filter(l=>l.status==="rejected").length;return`
            ...
            <div>
                ...
                <div class="bg-zinc-900/80 border border-zinc-800 rounded-xl overflow-hidden">
                    ${t.length===0?`<div class="p-8 text-center">
                            ...
                            <p class="text-zinc-600 text-xs mt-1">Create your first post to get started!</p>
                        </div>`:t.slice(0,10).map((l,d)=>{const p=d===Math.min(t.length,10)-1;["pending","auditing"].includes(l.status);const f=l.status==="approved",m=l.status==="rejected";let b,u,g;f?(b='<i class="fa-solid fa-check-circle text-green-400"></i>',u="",g=""):m?(b='<i class="fa-solid fa-times-circle text-red-400"></i>',u="",g=""):(b='<i class="fa-solid fa-shield-halved text-amber-400 animate-pulse"></i>',u="bg-amber-900/10",g=`
                                ...
                                <div class="p-3 ${p?"":"border-b border-zinc-800"} ${u}">
                                    <div class="flex items-center justify-between">
    ...
    `}function Z0(){var p,f;const e=((p=A.leaderboards)==null?void 0:p.top100ByPosts)||[],t=((f=A.leaderboards)==null?void 0:f.top100ByPoints)||[],n=A.activeRanking||"posts";function a(m,b,u){var z,T;const g=A.user&&((z=m.walletAddress)==null?void 0:z.toLowerCase())===((T=A.user.walletAddress)==null?void 0:T.toLowerCase()),y=Q0(b+1),k=u==="posts"?"bg-amber-500/10":"bg-green-500/10",E=u==="posts"?"text-amber-400":"text-green-400",I=u==="posts"?"text-white":"text-green-400",N=u==="posts"?"posts":"pts";return`
            <div class="flex items-center justify-between p-3 ${g?k:"hover:bg-zinc-800/50"} transition-colors">
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex flex-col">
                        <span class="font-mono text-xs ${g?E+" font-bold":"text-zinc-400"}">
...
(This will reset their rejection count to 0)`;if(!window.confirm(s))return;const r=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await _i(n,a),x(`User ${a?"BANNED":"UNBANNED"}.`,"success");const i=C.allUsers.findIndex(o=>o.id===n);i>-1&&(C.allUsers[i].isBanned=a,C.allUsers[i].hasPendingAppeal=!1,a===!1&&(C.allUsers[i].rejectedCount=0)),dt()}catch(i){x(`Failed: ${i.message}`,"error"),t.disabled=!1,t.innerHTML=r}},xm=async e=>{const t=e.target.closest(".resolve-appeal-btn");if(!t||t.disabled)return;const n=t.dataset.userId,s=t.dataset.action==="approve";if(!n)return;const r=s?"Are you sure you want to APPROVE this appeal and UNBAN the user?":"Are you sure you want to DENY this appeal? The user will remain banned.";if(!window.confirm(r))return;const i=t.closest("td").querySelectorAll("button"),o=new Map;i.forEach(l=>{o.set(l,l.innerHTML),l.disabled=!0,l.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>'});try{s&&await _i(n,!1),x(`Appeal ${s?"APPROVED":"DENIED"}.`,"success");const l=C.allUsers.findIndex(d=>d.id===n);l>-1&&(C.allUsers[l].hasPendingAppeal=!1,s&&(C.allUsers[l].isBanned=!1,C.allUsers[l].rejectedCount=0)),dt()}catch(l){x(`Failed: ${l.message}`,"error"),i.forEach(d=>{d.disabled=!1,d.innerHTML=o.get(d)})}},hm=async e=>{const t=e.target.closest(".re-approve-btn");if(!t||t.disabled)return;const n=t.dataset.submissionId,a=t.dataset.userId;if(!n||!a)return;const s=t.closest("tr");s&&(s.style.opacity="0.5"),t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await $i(a,n,"approved"),x("Submission re-approved!","success"),C.selectedUserSubmissions=C.selectedUserSubmissions.filter(i=>i.submissionId!==n),s&&s.remove();const r=C.allUsers.findIndex(i=>i.id===a);if(r>-1){const i=C.allUsers[r];i.rejectedCount=Math.max(0,(i.rejectedCount||0)-1),dt()}if(C.selectedUserSubmissions.length===0){const i=document.querySelector("#admin-user-modal .p-6");i&&(i.innerHTML='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>')}}catch(r){x(`Failed to re-approve: ${r.message}`,"error"),s&&(s.style.opacity="1"),t.disabled=!1,t.innerHTML='<i class="fa-solid fa-check"></i> Re-Approve'}},vm=async e=>{const t=e.target.closest(".view-rejected-btn");if(!t||t.disabled)return;const n=t.dataset.userId,a=t.dataset.wallet;if(n){C.selectedWallet=a,C.isSubmissionsModalOpen=!0,qa(!0,[]);try{const s=await Vd(n,"rejected");C.selectedUserSubmissions=s,qa(!1,s)}catch(s){x(`Error fetching user submissions: ${s.message}`,"error"),qa(!1,[],!0)}}},wm=()=>{C.isSubmissionsModalOpen=!1,C.selectedUserSubmissions=[],C.selectedWallet=null;const e=document.getElementById("admin-user-modal");e&&e.remove(),document.body.style.overflow="auto"},ym=e=>{const t=e.target.closest(".user-profile-link");if(!t)return;e.preventDefault();const n=t.dataset.userId;if(!n)return;const a=C.allUsers.find(s=>s.id===n);if(!a){x("Error: Could not find user data.","error");return}Am(a)},km=()=>{const e=document.getElementById("admin-user-profile-modal");e&&e.remove(),document.body.style.overflow="auto"},Tm=async e=>{e.preventDefault();const t=e.target;let n,a;try{if(n=new Date(t.startDate.value+"T00:00:00Z"),a=new Date(t.endDate.value+"T23:59:59Z"),isNaN(n.getTime())||isNaN(a.getTime()))throw new Error("Invalid date format.");if(n>=a)throw new Error("Start Date must be before End Date.")}catch(l){x(l.message,"error");return}const s={title:t.title.value.trim(),url:t.url.value.trim(),description:t.description.value.trim(),points:parseInt(t.points.value,10),cooldownHours:parseInt(t.cooldown.value,10),startDate:n,endDate:a};if(!s.title||!s.description){x("Please fill in Title and Description.","error");return}if(s.points<=0||s.cooldownHours<=0){x("Points and Cooldown must be positive numbers.","error");return}if(s.url&&!s.url.startsWith("http")){x("URL must start with http:// or https://","error");return}C.editingTask&&C.editingTask.id&&(s.id=C.editingTask.id);const r=t.querySelector('button[type="submit"]'),i=r.innerHTML;r.disabled=!0;const o=document.createElement("span");o.classList.add("inline-block"),r.innerHTML="",r.appendChild(o);try{await Wd(s),x(`Task ${s.id?"updated":"created"} successfully!`,"success"),t.reset(),C.editingTask=null,gn()}catch(l){x(`Failed to save task: ${l.message}`,"error"),console.error(l),r.disabled=!1,r.innerHTML=i}},Em=async e=>{e.preventDefault();const t=e.target,n={YouTube:parseInt(t.youtubePoints.value,10),"YouTube Shorts":parseInt(t.youtubeShortsPoints.value,10),Instagram:parseInt(t.instagramPoints.value,10),"X/Twitter":parseInt(t.xTwitterPoints.value,10),Facebook:parseInt(t.facebookPoints.value,10),Telegram:parseInt(t.telegramPoints.value,10),TikTok:parseInt(t.tiktokPoints.value,10),Reddit:parseInt(t.redditPoints.value,10),LinkedIn:parseInt(t.linkedinPoints.value,10),Other:parseInt(t.otherPoints.value,10)};if(Object.values(n).some(i=>isNaN(i)||i<0)){x("All points must be positive numbers (or 0).","error");return}const a=t.querySelector('button[type="submit"]'),s=a.innerHTML;a.disabled=!0;const r=document.createElement("span");r.classList.add("inline-block"),a.innerHTML="",a.appendChild(r);try{await Ud(n),x("UGC Base Points updated successfully!","success"),C.ugcBasePoints=n}catch(i){x(`Failed to update points: ${i.message}`,"error"),console.error(i)}finally{document.body.contains(a)&&(a.disabled=!1,a.innerHTML=s)}},Cm=e=>{const t=C.dailyTasks.find(n=>n.id===e);t&&(C.editingTask=t,Bn())},Im=async e=>{if(window.confirm("Are you sure you want to delete this task permanently?"))try{await Gd(e),x("Task deleted.","success"),C.editingTask=null,gn()}catch(t){x(`Failed to delete task: ${t.message}`,"error"),console.error(t)}};function qa(e,t,n=!1){var i,o;const a=document.getElementById("admin-user-modal");a&&a.remove(),document.body.style.overflow="hidden";let s="";e?s='<div class="p-8"></div>':n?s='<p class="text-red-400 text-center p-8">Failed to load submissions.</p>':t.length===0?s='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>':s=`
    ...
    `;const E=document.getElementById("admin-users-pagination");E&&b>1&&Ps(E,C.usersPage,b,Nm),(N=document.getElementById("admin-users-tbody"))==null||N.addEventListener("click",T=>{T.target.closest(".user-profile-link")&&ym(T),T.target.closest(".ban-user-btn")&&gm(T),T.target.closest(".view-rejected-btn")&&vm(T),T.target.closest(".resolve-appeal-btn")&&xm(T)}),(z=document.getElementById("user-filters-nav"))==null||z.addEventListener("click",Bm);const I=document.getElementById("user-search-input");if(I){let T;I.addEventListener("keyup",F=>{clearTimeout(T),T=setTimeout(()=>Pm(F),300)})}},li=()=>{var a;const e=document.getElementById("manage-ugc-points-content");if(!e)return;const t=C.ugcBasePoints;if(!t)return;const n={YouTube:5e3,"YouTube Shorts":2500,Instagram:3e3,"X/Twitter":1500,Facebook:2e3,Telegram:1e3,TikTok:3500,Reddit:1800,LinkedIn:2200,Other:1e3};e.innerHTML=`
    ...
    `,(a=document.getElementById("ugcPointsForm"))==null||a.addEventListener("submit",Em)},Bn=()=>{var u,g,y;const e=document.getElementById("manage-tasks-content");if(!e)return;const t=C.editingTask,n=!!t,a=k=>{if(!k)return"";try{return(k.toDate?k.toDate():k instanceof Date?k:new Date(k)).toISOString().split("T")[0]}catch{return""}},s=C.tasksPage,r=C.tasksPerPage,i=[...C.dailyTasks].sort((k,E)=>{var z,T;const I=(z=k.startDate)!=null&&z.toDate?k.startDate.toDate():new Date(k.startDate||0);return((T=E.startDate)!=null&&T.toDate?E.startDate.toDate():new Date(E.startDate||0)).getTime()-I.getTime()}),o=i.length,l=Math.ceil(o/r),d=(s-1)*r,p=s*r,f=i.slice(d,p),m=f.length>0?f.map(k=>{var T,F;const E=new Date,I=(T=k.startDate)!=null&&T.toDate?k.startDate.toDate():k.startDate?new Date(k.startDate):null,N=(F=k.endDate)!=null&&F.toDate?k.endDate.toDate():k.endDate?new Date(k.endDate):null;let z="text-zinc-500";return I&&N&&(E>=I&&E<=N?z="text-green-400":E<I&&(z="text-blue-400")),`
    ...
    `;const b=document.getElementById("admin-tasks-pagination");b&&l>1&&Ps(b,C.tasksPage,l,Lm),(u=document.getElementById("taskForm"))==null||u.addEventListener("submit",Tm),(g=document.getElementById("cancelEditBtn"))==null||g.addEventListener("click",()=>{C.editingTask=null,Bn()}),(y=document.getElementById("existing-tasks-list"))==null||y.addEventListener("click",k=>{const E=k.target.closest("button[data-id]");if(!E)return;const I=E.dataset.id;E.dataset.action==="edit"&&Cm(I),E.dataset.action==="delete"&&Im(I)})},ca=()=>{var f;const e=document.getElementById("submissions-content");if(!e)return;if(!C.allSubmissions||C.allSubmissions.length===0){const m=document.createElement("div");e.innerHTML=m.innerHTML;return}const t=C.submissionsPage,n=C.submissionsPerPage,a=[...C.allSubmissions].sort((m,b)=>{var u,g;return(((u=b.submittedAt)==null?void 0:u.getTime())||0)-(((g=m.submittedAt)==null?void 0:g.getTime())||0)}),s=a.length,r=Math.ceil(s/n),i=(t-1)*n,o=t*n,d=a.slice(i,o).map(m=>{var b,u;return`
        <tr class="border-b border-border-color hover:bg-zinc-800/50">
            ...
            <td class="p-3 text-xs font-semibold ${((b=oi[m.status])==null?void 0:b.color)||"text-gray-500"}">${((u=oi[m.status])==null?void 0:u.text)||m.status}</td>
            <td class="p-3 text-right">
                <div class="flex items-center justify-end gap-2">
    ...
    `;const p=document.getElementById("admin-submissions-pagination");p&&r>1&&Ps(p,C.submissionsPage,r,zm),(f=document.getElementById("admin-submissions-tbody"))==null||f.addEventListener("click",bm)},da=()=>{var r,i;const e=document.getElementById("platform-usage-content");if(!e)return;const t=C.platformUsageConfig||Ia;let n=0;Object.values(t).forEach(o=>{o.enabled!==!1&&(n+=(o.points||0)*(o.maxCount||1))});const a=Object.entries(t).map(([o,l])=>`
    ...
    `;const s=document.getElementById("platform-usage-tbody");s==null||s.addEventListener("input",ci),s==null||s.addEventListener("change",ci),(r=document.getElementById("save-platform-config-btn"))==null||r.addEventListener("click",Sm),(i=document.getElementById("reset-platform-config-btn"))==null||i.addEventListener("click",Rm)},ci=e=>{const t=e.target;if(!t.classList.contains("platform-input")&&!t.classList.contains("platform-toggle"))return;const n=t.closest("tr"),a=n==null?void 0:n.dataset.actionKey,s=t.dataset.field;if(!a||!s)return;C.platformUsageConfig[a]||(C.platformUsageConfig[a]={...Ia[a]}),s==="enabled"?C.platformUsageConfig[a].enabled=t.checked:C.platformUsageConfig[a][s]=parseInt(t.value)||0;const r=C.platformUsageConfig[a],i=n.querySelector("td:last-child");i&&(i.textContent=((r.points||0)*(r.maxCount||1)).toLocaleString())},Sm=async e=>{const t=e.target.closest("button");if(!t)return;const n=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Saving...';try{await Fi(C.platformUsageConfig),x("✅ Platform Usage config saved!","success"),da()}catch(a){console.error("Error saving platform config:",a),x("Failed to save config: "+a.message,"error")}finally{t.disabled=!1,t.innerHTML=n}},Rm=async()=>{if(confirm("Are you sure you want to reset to default values? This will save immediately."))try{C.platformUsageConfig={...Ia},await Fi(C.platformUsageConfig),x("✅ Config reset to defaults!","success"),da()}catch(e){console.error("Error resetting platform config:",e),x("Failed to reset config: "+e.message,"error")}},$m=()=>{var n;const e=document.getElementById("admin-content-wrapper");if(!e)return;e.innerHTML=`
                ...
                <div class="space-y-3">
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-500 text-[10px]">${xn(di.airdrop.amount)} BKC</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-500 text-[10px]">${xn(di.liquidity.amount)} BKC</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    `,ua(),He(),ir())}function ua(){const e=document.getElementById("status-badge"),t=document.getElementById("fee-amount"),n=document.getElementById("user-balance"),a=c.notaryFee||0n,s=c.currentUserBalance||0n;t&&(t.textContent=`${_(a)} BKC`),n&&(n.textContent=`${_(s)} BKC`,n.className=`font-mono font-bold ${s>=a?"text-emerald-400":"text-red-400"}`),e&&(c.isConnected?s>=a?(e.innerHTML=`
    ...
    `,(s=document.getElementById("btn-remove"))==null||s.addEventListener("click",()=>{O.file=null,O.description="",O.step=1,He()}),(r=document.getElementById("btn-back"))==null||r.addEventListener("click",()=>{O.step=1,He()}),(i=document.getElementById("btn-next"))==null||i.addEventListener("click",()=>{var o;O.description=((o=document.getElementById("desc-input"))==null?void 0:o.value)||"",O.step=3,He()})}function sf(e){var r,i;const t=O.file,n=O.description||"No description",a=c.notaryFee||sr.parseEther("1"),s=rr((t==null?void 0:t.type)||"",(t==null?void 0:t.name)||"");e.innerHTML=`
    ...
    `,(r=document.getElementById("btn-back"))==null||r.addEventListener("click",()=>{O.step=2,He()}),(i=document.getElementById("btn-mint"))==null||i.addEventListener("click",rf)}async function rf(){if(O.isProcessing)return;O.isProcessing=!0;const e=document.getElementById("btn-mint");e&&(e.disabled=!0,e.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Signing...');const t=document.getElementById("processing-overlay"),n=document.getElementById("process-status"),a=document.getElementById("process-bar"),s=document.getElementById("overlay-icon"),r=(i,o)=>{a&&(a.style.width=`${i}%`),n&&(n.textContent=o)};try{const l=await(await c.provider.getSigner()).signMessage("I am signing to authenticate my file for notarization on Backchain.");t&&t.classList.add("active"),r(10,"UPLOADING TO IPFS...");const d=new FormData;d.append("file",O.file),d.append("signature",l),d.append("address",c.userAddress),d.append("description",O.description||"No description");const p=Te.uploadFileToIPFS||"/api/upload",f=await fetch(p,{method:"POST",body:d,signal:AbortSignal.timeout(18e4)});if(!f.ok)throw f.status===413?new Error("File too large. Maximum size is 5MB."):f.status===401?new Error("Signature verification failed."):new Error(`Upload failed (${f.status})`);const m=await f.json(),b=m.ipfsUri||m.metadataUri,u=m.contentHash;if(!b)throw new Error("No IPFS URI returned");if(!u)throw new Error("No content hash returned");r(50,"MINTING ON BLOCKCHAIN..."),s&&(s.className="fa-solid fa-stamp text-4xl text-amber-400 stamp-animation"),await Ul.notarize({ipfsCid:b,contentHash:u,description:O.description||"No description",button:e,onSuccess:g=>{r(100,"SUCCESS!"),t&&(t.innerHTML=`
                    ...
                    `),setTimeout(()=>{t&&t.classList.remove("active"),O.file=null,O.description="",O.step=1,O.isProcessing=!1,He(),ir(),Pt(!0),x("📜 Document notarized successfully!","success")},3e3)},onError:g=>{if(g.cancelled||g.type==="user_rejected"){O.isProcessing=!1,t&&t.classList.remove("active"),e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-stamp mr-2"></i>Sign & Mint');return}throw g}})}catch(i){console.error("Notary Error:",i),t&&t.classList.remove("active"),e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-stamp mr-2"></i>Sign & Mint'),O.isProcessing=!1,x(i.message||"Notarization failed","error")}}async function ir(){const e=document.getElementById("certificates-grid");if(e){if(!c.isConnected){e.innerHTML=`
    ...
    `;try{const t=Te.getNotarizedDocuments||"https://getnotarizeddocuments-4wvdcuoouq-uc.a.run.app",n=await fetch(`${t}/${c.userAddress}`);if(!n.ok)throw new Error(`API returned ${n.status}`);const a=await n.json();if(!Array.isArray(a)||a.length===0){e.innerHTML=`
            ...
            `;return}const s=a.map(r=>({id:r.tokenId||"?",ipfs:r.ipfsCid||"",description:r.description||"",hash:r.contentHash||"",timestamp:r.createdAt||r.timestamp||"",txHash:r.txHash||""})).sort((r,i)=>parseInt(i.id)-parseInt(r.id));e.innerHTML=s.map(r=>{var f,m;let i="";const o=r.ipfs||"";o.startsWith("ipfs://")?i=`${ui}${o.replace("ipfs://","")}`:o.startsWith("https://")?i=o:o.length>0&&(i=`${ui}${o}`);let l=((f=r.description)==null?void 0:f.split("---")[0].trim().split(`
`)[0].trim())||"Notarized Document";const d=rr("",l),p=Jm(r.timestamp);return`
                <div class="cert-card">
        ...
        `}}}async function of(){try{if(await Is(),c.isConnected&&c.userAddress)try{if(c.bkcTokenContract||c.bkcTokenContractPublic){const e=c.bkcTokenContract||c.bkcTokenContractPublic,t=await ne(e,"balanceOf",[c.userAddress],0n);t>0n&&(c.currentUserBalance=t)}}catch{}ua()}catch{(!c.notaryFee||c.notaryFee===0n)&&(c.notaryFee=sr.parseEther("1"))}}async function lf(e,t){var n,a;try{const s=["https://dweb.link/ipfs/","https://w3s.link/ipfs/","https://gateway.pinata.cloud/ipfs/","https://ipfs.io/ipfs/"],r=p=>p?p.startsWith("ipfs://")?p.replace("ipfs://","").split("?")[0]:p.includes("/ipfs/")?p.split("/ipfs/")[1].split("?")[0]:p.match(/^Qm[a-zA-Z0-9]{44}/)||p.match(/^bafy[a-zA-Z0-9]+/)?p:"":"",i=p=>{if(!p)return"";if(p.startsWith("https://")&&!p.includes("/ipfs/"))return p;const f=r(p);return f?`${s[0]}${f}`:p};let o=i(t||"");if(c.decentralizedNotaryContract)try{const p=await c.decentralizedNotaryContract.tokenURI(e);if(p!=null&&p.startsWith("data:application/json;base64,")){const f=JSON.parse(atob(p.replace("data:application/json;base64,","")));f.image&&(o=i(f.image))}}catch{}const l=((n=c.decentralizedNotaryContract)==null?void 0:n.target)||((a=c.decentralizedNotaryContract)!=null&&a.getAddress?await c.decentralizedNotaryContract.getAddress():null);if(!l){x("Contract address not found","error");return}x(`Adding NFT #${e} to wallet...`,"info"),await window.ethereum.request({method:"wallet_watchAsset",params:{type:"ERC721",options:{address:l,tokenId:String(e),image:o}}})&&x(`📜 NFT #${e} added to wallet!`,"success")}catch(s){if(s.code===4001)return;x("Could not add NFT","error")}}const uc={async render(e){e&&(Qm(),await of(),c.isConnected&&await Pt(),ua(),He())},reset(){O.file=null,O.description="",O.step=1,He()},update(){ua(),O.isProcessing||He()},refreshHistory(){ir()},addToWallet:lf};window.NotaryPage=uc;const Aa=window.ethers,mi=24*60*60,gs={Diamond:{emoji:"💎",color:"#22d3ee",bg:"rgba(34,211,238,0.15)",border:"rgba(34,211,238,0.3)",keepRate:100},Gold:{emoji:"🥇",color:"#fbbf24",bg:"rgba(251,191,36,0.15)",border:"rgba(251,191,36,0.3)",keepRate:90},Silver:{emoji:"🥈",color:"#9ca3af",bg:"rgba(156,163,175,0.15)",border:"rgba(156,163,175,0.3)",keepRate:75},Bronze:{emoji:"🥉",color:"#fb923c",bg:"rgba(251,146,60,0.15)",border:"rgba(251,146,60,0.3)",keepRate:60}},$={activeTab:"marketplace",filterTier:"ALL",sortBy:"featured",selectedListing:null,isLoading:!1,isTransactionPending:!1,countdownIntervals:[],promotions:new Map},Re=e=>e==null?"":String(e),cf=(e,t)=>Re(e)===Re(t),Pn=(e,t)=>e&&t&&e.toLowerCase()===t.toLowerCase();function Fn(e){return ge.find(t=>t.boostBips===Number(e))||{name:"Unknown",boostBips:0}}function Ba(e){return gs[e]||{emoji:"💎",color:"#71717a",bg:"rgba(113,113,122,0.15)",border:"rgba(113,113,122,0.3)",keepRate:50}}function pc(e){const t=e-Math.floor(Date.now()/1e3);if(t<=0)return{text:"Expired",expired:!0,seconds:0};const n=Math.floor(t/3600),a=Math.floor(t%3600/60),s=t%60;return n>0?{text:`${n}h ${a}m`,expired:!1,seconds:t}:a>0?{text:`${a}m ${s}s`,expired:!1,seconds:t}:{text:`${s}s`,expired:!1,seconds:t}}function df(e){const t=Math.floor(Date.now()/1e3),n=e-t;if(n<=0)return null;const a=Math.floor(n/3600),s=Math.floor(n%3600/60);return a>0?`${a}h ${s}m`:`${s}m`}function mc(e){if(e.lastRentalEndTime)return Number(e.lastRentalEndTime)+mi;if(e.rentalEndTime&&!e.isRented){const t=Number(e.rentalEndTime),n=Math.floor(Date.now()/1e3);if(t<n)return t+mi}return null}function fi(e){const t=Math.floor(Date.now()/1e3),n=mc(e);return n&&n>t}function bi(e){const t=Math.floor(Date.now()/1e3);if(!e.lastRentalEndTime&&!e.rentalEndTime)return e.createdAt?t-Number(e.createdAt):Number.MAX_SAFE_INTEGER;const n=e.lastRentalEndTime?Number(e.lastRentalEndTime):e.rentalEndTime?Number(e.rentalEndTime):0;return n>t?0:t-n}function uf(){if(document.getElementById("rental-styles-v6"))return;const e=document.createElement("style");e.id="rental-styles-v6",e.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `:`
        ...
        `}function hn(){const e=document.getElementById("tab-content");if(e){switch($.activeTab){case"marketplace":e.innerHTML=mf();break;case"my-listings":e.innerHTML=ff();break;case"my-rentals":e.innerHTML=bf();break}document.getElementById("header-stats").innerHTML=pf(),$.activeTab==="my-rentals"&&If()}}function mf(){const e=c.rentalListings||[],t=Math.floor(Date.now()/1e3);let n=e.filter(a=>!(a.isRented||a.rentalEndTime&&Number(a.rentalEndTime)>t||$.filterTier!=="ALL"&&Fn(a.boostBips).name!==$.filterTier));return n.sort((a,s)=>{const r=BigInt(a.promotionFee||"0")||$.promotions.get(Re(a.tokenId))||0n,i=BigInt(s.promotionFee||"0")||$.promotions.get(Re(s.tokenId))||0n,o=fi(a),l=fi(s);if(!o&&l)return-1;if(o&&!l||i>r)return 1;if(i<r)return-1;if($.sortBy==="featured"){const f=bi(a),m=bi(s);if(m!==f)return m-f}const d=BigInt(a.pricePerHour||0),p=BigInt(s.pricePerHour||0);return $.sortBy==="price-low"?d<p?-1:1:$.sortBy==="price-high"?d>p?-1:1:(s.boostBips||0)-(a.boostBips||0)}),`
        <div>
            <!-- Filters & Sort -->
            ...
            <!-- NFT Grid -->
            ${n.length===0?or("No NFTs Available","Be the first to list your NFT!"):`
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 nft-grid">
                    ${n.map((a,s)=>fc(a,s)).join("")}
                </div>
            `}
        </div>
    `}function fc(e,t){const n=Fn(e.boostBips),a=Ba(n.name),s=_(BigInt(e.pricePerHour||0)).toFixed(2),r=Re(e.tokenId),i=c.isConnected&&Pn(e.owner,c.userAddress),o=mc(e),l=Math.floor(Date.now()/1e3),d=o&&o>l,p=d?df(o):null,f=BigInt(e.promotionFee||"0")||$.promotions.get(r)||0n,m=f>0n,b=m?parseFloat(Aa.formatEther(f)).toFixed(3):"0",u=lt(e.boostBips||0);return`
        <div class="nft-card ${m?"promoted":""} ${i?"owned":""} ${d?"cooldown":""}" 
            ...
            <div class="relative aspect-square flex items-center justify-center p-6">
                ...
                ${d&&!i?`
                    <div class="absolute inset-0 bg-black/70 rounded-2xl flex flex-col items-center justify-center">
                        ...
                        <span class="text-lg text-indigo-400 font-bold font-mono">${p}</span>
                    </div>
                `:""}
            </div>
            ...
            <div class="p-4 pt-0">
                ...
                <p class="text-xs ${u===100?"text-emerald-400":"text-zinc-500"} mb-4">
                    ${u===100?"✨ Keep 100% of your rewards!":`Save ${u-50}% on claim burns`}
                </p>
    ...
    `}function ff(){if(!c.isConnected)return bc("View your listings");const e=c.rentalListings||[],t=e.filter(r=>Pn(r.owner,c.userAddress)),n=new Set(e.map(r=>Re(r.tokenId))),a=(c.myBoosters||[]).filter(r=>!n.has(Re(r.tokenId)));return`
        <div>
            ...
            <!-- My Listed NFTs -->
            ${t.length===0?or("No Listings Yet","List your first NFT to start earning!"):`
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 nft-grid">
                    ${t.map((r,i)=>fc(r,i)).join("")}
                </div>
            `}
        </div>
    `}function bf(){if(!c.isConnected)return bc("View your active rentals");const e=Math.floor(Date.now()/1e3),t=(c.myRentals||[]).filter(n=>Pn(n.tenant,c.userAddress)&&Number(n.endTime)>e);return`
        <div>
            ...
            <!-- Active Rentals -->
            ${t.length===0?or("No Active Rentals","Rent an NFT to reduce your claim burn rate!"):`
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    ${t.map((n,a)=>gf(n,a)).join("")}
                </div>
            `}
        </div>
    `}function gf(e,t){const n=Fn(e.boostBips),a=Ba(n.name),s=pc(Number(e.endTime)),r=lt(e.boostBips||0);let i="active";return s.seconds<3600?i="critical":s.seconds<7200&&(i="warning"),`
...
`;document.head.appendChild(kc);const Bf={render:async e=>{if(!e)return;const t=document.getElementById("creditcard");t&&(t.innerHTML=`
    ...
    `}function Za(e,t,n,a,s,r,i){const o=lr[At];let l=`
        <div class="mb-10">
    ...
    `,d=i;return a.forEach(p=>{l+=Nf(p,d++)}),l+="</div></div>",{html:l,nextIndex:d}}function zf(e){var t,n,a,s,r,i,o,l;At=e,localStorage.setItem("backcoin-tutorials-lang",e),(t=document.getElementById("tutorials-btn-en"))==null||t.classList.toggle("bg-amber-500",e==="en"),(n=document.getElementById("tutorials-btn-en"))==null||n.classList.toggle("text-zinc-900",e==="en"),(a=document.getElementById("tutorials-btn-en"))==null||a.classList.toggle("bg-zinc-700",e!=="en"),(s=document.getElementById("tutorials-btn-en"))==null||s.classList.toggle("text-zinc-300",e!=="en"),(r=document.getElementById("tutorials-btn-pt"))==null||r.classList.toggle("bg-amber-500",e==="pt"),(i=document.getElementById("tutorials-btn-pt"))==null||i.classList.toggle("text-zinc-900",e==="pt"),(o=document.getElementById("tutorials-btn-pt"))==null||o.classList.toggle("bg-zinc-700",e!=="pt"),(l=document.getElementById("tutorials-btn-pt"))==null||l.classList.toggle("text-zinc-300",e!=="pt"),Tc()}function Tc(){const e=document.getElementById("tutorials-content");if(!e)return;const t=lr[At];let n=`
        <!-- Hero -->
        <div class="text-center mb-10">
    ...
    `,a=Za("getting-started","rocket","emerald",Ja.gettingStarted,"catGettingStarted","catGettingStartedDesc",0);n+=a.html,a=Za("ecosystem","cubes","amber",Ja.ecosystem,"catEcosystem","catEcosystemDesc",a.nextIndex),n+=a.html,a=Za("advanced","graduation-cap","cyan",Ja.advanced,"catAdvanced","catAdvancedDesc",a.nextIndex),n+=a.html,e.innerHTML=n}const Ec={render:function(e=!1){const t=document.getElementById("tutorials");t&&(e||t.innerHTML.trim()==="")&&(t.innerHTML=`
            ...
            <div class="p-4">
                <div class="flex flex-wrap gap-1.5 mb-2">
                    ...
                    <span class="cp-badge" style="background:${(s=De[a])==null?void 0:s.color}20;color:${(r=De[a])==null?void 0:r.color}">
                        ${(i=De[a])==null?void 0:i.emoji} ${(o=De[a])==null?void 0:o.name}
                    </span>
                </div>
    ...
    `},xi=()=>{var a,s,r,i;const e=B.campaigns.filter(o=>dr(o)),t=e.filter(o=>o.category==="animal"),n=e.filter(o=>o.category==="humanitarian");return`
            ...
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-lg font-bold text-white flex items-center gap-2">
                    ${B.selectedCategory?`
                        ...
                        ${(r=De[B.selectedCategory])==null?void 0:r.emoji} ${(i=De[B.selectedCategory])==null?void 0:i.name}
                    `:`
                        <i class="fa-solid fa-fire text-amber-500"></i> Active Campaigns
                    `}
                </h2>
                <span class="text-xs text-zinc-500">${e.filter(o=>!B.selectedCategory||o.category===B.selectedCategory).length} campaigns</span>
            </div>
            
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4" id="cp-grid">
                ${e.length?e.filter(o=>!B.selectedCategory||o.category===B.selectedCategory).sort((o,l)=>Number(l.createdAt||0)-Number(o.createdAt||0)).map(o=>$c(o)).join(""):Rc("No active campaigns")}
            </div>
        </div>
    `},hi=e=>{var o,l,d,p,f,m;if(!e)return`
        <div class="charity-page">
    ...
    `;const t=Mn(e.raisedAmount,e.goalAmount),n=Ac(e.deadline),a=e.category||"humanitarian",s=dr(e),r=((o=e.creator)==null?void 0:o.toLowerCase())===((l=c==null?void 0:c.userAddress)==null?void 0:l.toLowerCase()),i=Nc(e);return`
        <div class="charity-page">
            ${_c()}
            ${Fc()}
            ...
            <div class="cp-detail">
                ...
                <div class="flex flex-wrap items-center gap-2 mb-4">
                    ...
                    ${Sc(e.status)}
                    <span class="cp-badge" style="background:${(d=De[a])==null?void 0:d.color}20;color:${(p=De[a])==null?void 0:p.color}">
...
`;let s;e==="twitter"?s=`https://twitter.com/intent/tweet?text=${encodeURIComponent(a)}&url=${encodeURIComponent(n)}`:e==="telegram"?s=`https://t.me/share/url?url=${encodeURIComponent(n)}&text=${encodeURIComponent(a)}`:e==="whatsapp"&&(s=`https://wa.me/?text=${encodeURIComponent(a+n)}`),s&&window.open(s,"_blank","width=600,height=400")}function ab(){const e=B.currentCampaign;e&&navigator.clipboard.writeText(Bc(e.id)).then(()=>x("Link copied!","success")).catch(()=>x("Copy failed","error"))}function Mc(){Ff(),B.currentCampaign=null,B.currentView="main",ut()}function sb(e){rt("my"),rt("donate"),rt("edit"),_f(e),St(e)}function rb(e){B.selectedCategory=B.selectedCategory===e?null:e,pr()}function ib(){B.selectedCategory=null,pr()}function pr(){const e=document.getElementById("cp-grid");if(!e)return;let t=B.campaigns.filter(n=>dr(n));B.selectedCategory&&(t=t.filter(n=>n.category===B.selectedCategory)),t.sort((n,a)=>Number(a.createdAt||0)-Number(n.createdAt||0)),e.innerHTML=t.length?t.map(n=>$c(n)).join(""):Rc("No campaigns")}async function St(e){B.currentView="detail",B.isLoading=!0;const t=hs();t&&(t.innerHTML=Hf());try{let n=B.campaigns.find(a=>a.id===e||a.id===String(e));if(!n){const a=c==null?void 0:c.publicProvider;if(a){const r=await new tn.Contract(w.charityPool,ur,a).campaigns(e);n={id:String(e),creator:r[0],title:r[1],description:r[2],goalAmount:BigInt(r[3].toString()),raisedAmount:BigInt(r[4].toString()),donationCount:Number(r[5]),deadline:Number(r[6]),createdAt:Number(r[7]),status:Number(r[8]),category:"humanitarian",imageUrl:null}}}B.currentCampaign=n,t&&(t.innerHTML=hi(n))}catch{t&&(t.innerHTML=hi(null))}finally{B.isLoading=!1}}function hs(){let e=document.getElementById("charity-container");if(e)return e;const t=document.getElementById("charity");return t?(e=document.createElement("div"),e.id="charity-container",t.innerHTML="",t.appendChild(e),e):null}function ut(){$f();const e=hs();if(!e)return;const t=Pc();t?St(t):(B.currentView="main",B.currentCampaign=null,e.innerHTML=xi(),Lt().then(()=>{if(B.currentView==="main"){const n=hs();n&&(n.innerHTML=xi())}}))}async function ob(){B.campaigns=[],B.stats=null,B.currentView==="detail"&&B.currentCampaign?await St(B.currentCampaign.id):ut()}window.addEventListener("hashchange",()=>{var e;if(window.location.hash.startsWith("#charity")){const t=Pc();t?((e=B.currentCampaign)==null?void 0:e.id)!==t&&St(t):B.currentView!=="main"&&Mc()}});const Dc={render(e){e&&ut()},update(){B.currentView==="main"&&pr()},refresh:ob,openModal:Dn,closeModal:rt,openCreate:Wf,openDonate:Gf,openMyCampaigns:Kf,openEdit:Yf,create:Xf,donate:Jf,donateDetail:Zf,cancel:Qf,withdraw:eb,saveEdit:tb,selCatOpt:Vf,setAmt:qf,goBack:Mc,viewCampaign:sb,selectCat:rb,clearCat:ib,share:nb,copyLink:ab,handleImageSelect:Df,removeImage:zc,switchImageTab:Of};window.CharityPage=Dc;const he=window.ethers,lb="https://sepolia.arbiscan.io/address/",cb=dd;function mr(){return w.backchat||w.Backchat||null}function nn(){return w.operator||w.treasury||null}const P={activeTab:"feed",view:"feed",posts:[],trendingPosts:[],userProfile:null,profiles:new Map,following:new Set,selectedPost:null,selectedProfile:null,fees:{post:0n,reply:0n,like:0n,follow:0n,repost:0n,superLikeMin:0n,boostMin:0n,badge:0n},pendingEth:0n,hasBadge:!1,isBoosted:!1,boostExpiry:0,badgeExpiry:0,referralStats:null,referredBy:null,isLoading:!1,isPosting:!1,contractAvailable:!0,error:null};function db(){if(document.getElementById("backchat-styles-v70"))return;const e=document.getElementById("backchat-styles-v69");e&&e.remove();const t=document.createElement("style");t.id="backchat-styles-v70",t.textContent=`
    ...
    `}function Tb(){var t;if(!c.isConnected)return`
            <div class="bc-empty">
                <div class="bc-empty-glyph">
                    <i class="fa-solid fa-wallet"></i>
                </div>
    ...
    `}function Eb(){var a,s;if(!c.isConnected)return"";const e=`${window.location.origin}/#backchat?ref=${c.userAddress}`,t=((a=P.referralStats)==null?void 0:a.totalReferred)||0,n=((s=P.referralStats)==null?void 0:s.totalEarnedFormatted)||"0.0";return`
    ...
    `}function ze(){const e=document.getElementById("backchat-content");if(!e)return;let t="";switch(P.activeTab){case"feed":t=wb()+yb();break;case"trending":t=kb();break;case"profile":t=Tb();break}e.innerHTML=t}function Cb(){return`
        <!-- Super Like Modal -->
