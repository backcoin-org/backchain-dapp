import{defaultConfig as Ud,createWeb3Modal as Hd}from"https://esm.sh/@web3modal/ethers@5.1.11?bundle";import{initializeApp as jd}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-app.js";import{getAuth as Wd,onAuthStateChanged as Gd,signInAnonymously as Kd}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-auth.js";import{getFirestore as Yd,collection as et,query as $t,where as pa,orderBy as rn,getDocs as ft,doc as se,getDoc as Ne,limit as Vd,serverTimestamp as bt,writeBatch as Aa,updateDoc as Ba,increment as je,setDoc as Pa,Timestamp as Rr,addDoc as qd,deleteDoc as Xd}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-firestore.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function n(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(s){if(s.ep)return;s.ep=!0;const r=n(s);fetch(s.href,r)}})();const Le={sidebar:document.getElementById("sidebar"),sidebarBackdrop:document.getElementById("sidebar-backdrop"),menuBtn:document.getElementById("menu-btn"),navLinks:document.getElementById("nav-links"),mainContentSections:document.querySelectorAll("main section"),connectButtonDesktop:document.getElementById("connectButtonDesktop"),connectButtonMobile:document.getElementById("connectButtonMobile"),mobileAppDisplay:document.getElementById("mobileAppDisplay"),desktopDisconnected:document.getElementById("desktopDisconnected"),desktopConnectedInfo:document.getElementById("desktopConnectedInfo"),desktopUserAddress:document.getElementById("desktopUserAddress"),desktopUserBalance:document.getElementById("desktopUserBalance"),modalContainer:document.getElementById("modal-container"),toastContainer:document.getElementById("toast-container"),dashboard:document.getElementById("dashboard"),earn:document.getElementById("mine"),store:document.getElementById("store"),rental:document.getElementById("rental"),rewards:document.getElementById("rewards"),actions:document.getElementById("actions"),presale:document.getElementById("presale"),faucet:document.getElementById("faucet"),airdrop:document.getElementById("airdrop"),dao:document.getElementById("dao"),about:document.getElementById("about"),admin:document.getElementById("admin"),tokenomics:document.getElementById("tokenomics"),notary:document.getElementById("notary"),statTotalSupply:document.getElementById("statTotalSupply"),statValidators:document.getElementById("statValidators"),statTotalPStake:document.getElementById("statTotalPStake"),statScarcity:document.getElementById("statScarcity"),statLockedPercentage:document.getElementById("statLockedPercentage"),statUserBalance:document.getElementById("statUserBalance"),statUserPStake:document.getElementById("statUserPStake"),statUserRewards:document.getElementById("statUserRewards")},Jd={provider:null,publicProvider:null,web3Provider:null,signer:null,userAddress:null,isConnected:!1,bkcTokenContract:null,delegationManagerContract:null,rewardBoosterContract:null,nftLiquidityPoolContract:null,actionsManagerContract:null,fortunePoolContract:null,faucetContract:null,decentralizedNotaryContract:null,ecosystemManagerContract:null,publicSaleContract:null,rentalManagerContract:null,bkcTokenContractPublic:null,delegationManagerContractPublic:null,faucetContractPublic:null,fortunePoolContractPublic:null,rentalManagerContractPublic:null,ecosystemManagerContractPublic:null,actionsManagerContractPublic:null,currentUserBalance:0n,currentUserNativeBalance:0n,userTotalPStake:0n,userDelegations:[],myBoosters:[],activityHistory:[],totalNetworkPStake:0n,allValidatorsData:[],systemFees:{},systemPStakes:{},boosterDiscounts:{},notaryFee:void 0,notaryMinPStake:void 0},Zd={set(e,t,n){return e[t]=n,["currentUserBalance","isConnected","userTotalPStake","totalNetworkPStake"].includes(t)&&window.updateUIState&&window.updateUIState(),!0}},d=new Proxy(Jd,Zd);let _r=!1;const h=(e,t="info",n=null)=>{if(!Le.toastContainer)return;const a={success:{icon:"fa-check-circle",color:"bg-green-600",border:"border-green-400"},error:{icon:"fa-exclamation-triangle",color:"bg-red-600",border:"border-red-400"},info:{icon:"fa-info-circle",color:"bg-blue-600",border:"border-blue-400"},warning:{icon:"fa-exclamation-circle",color:"bg-yellow-600",border:"border-yellow-400"}},s=a[t]||a.info,r=document.createElement("div");r.className=`flex items-center w-full max-w-xs p-4 text-white rounded-lg shadow-lg transition-all duration-500 ease-out 
    ...
    `;if(n){const o=`https://sepolia.arbiscan.io/tx/${n}`;i+=`<a href="${o}" target="_blank" title="View on Arbiscan" class="ml-3 flex-shrink-0 text-white/80 hover:text-white transition-colors">
                ...
                </button>`,r.innerHTML=i,Le.toastContainer.appendChild(r),requestAnimationFrame(()=>{r.classList.remove("translate-x-full","opacity-0"),r.classList.add("translate-x-0","opacity-100")}),setTimeout(()=>{r.classList.remove("translate-x-0","opacity-100"),r.classList.add("translate-x-full","opacity-0"),setTimeout(()=>r.remove(),500)},5e3)},Ee=()=>{if(!Le.modalContainer)return;const e=document.getElementById("modal-backdrop");if(e){const t=document.getElementById("modal-content");t&&(t.classList.remove("animate-fade-in-up"),t.classList.add("animate-fade-out-down")),e.classList.remove("opacity-100"),e.classList.add("opacity-0"),setTimeout(()=>{Le.modalContainer.innerHTML=""},300)}},Pn=(e,t="max-w-md",n=!0)=>{var r,i;if(!Le.modalContainer)return;const s=`
    ...
    `;Le.modalContainer.innerHTML=s,requestAnimationFrame(()=>{const o=document.getElementById("modal-backdrop");o&&o.classList.remove("opacity-0"),o&&o.classList.add("opacity-100")}),(r=document.getElementById("modal-backdrop"))==null||r.addEventListener("click",o=>{n&&o.target.id==="modal-backdrop"&&Ee()}),(i=document.getElementById("modal-content"))==null||i.querySelectorAll(".closeModalBtn").forEach(o=>{o.addEventListener("click",Ee)})};async function Qd(e,t){if(!window.ethereum){h("MetaMask not detected","error");return}try{await window.ethereum.request({method:"wallet_watchAsset",params:{type:"ERC721",options:{address:"0xf2EA307686267dC674859da28C58CBb7a5866BCf",tokenId:e.toString()}}})?h(`${t} NFT #${e} added to wallet!`,"success"):h("NFT not added to wallet","info")}catch(n){console.error("Error adding NFT to wallet:",n),h("Failed to add NFT to wallet","error")}}function eu(){const e=window.location.origin,t=encodeURIComponent("Check out Backcoin - The Unstoppable DeFi Protocol on Arbitrum! Build your own business. Be Your Own CEO. 🚀 #Backcoin #DeFi #Arbitrum #BeYourOwnCEO"),n=`
    ...
    `;Pn(n,"max-w-md")}const Fr=e=>{window.navigateTo?window.navigateTo(e):console.error("navigateTo function not found."),Ee()};function tu(){var s,r,i,o,c,l;if(_r)return;_r=!0;const e="https://t.me/BackCoinorg",t="https://github.com/backcoin-org/backchain-dapp";Pn(`
    ...
    `,"max-w-sm",!1);const a=document.getElementById("modal-content");a&&((s=a.querySelector("#btnAirdrop"))==null||s.addEventListener("click",()=>{Fr("airdrop")}),(r=a.querySelector("#btnExplore"))==null||r.addEventListener("click",()=>{Ee()}),(i=a.querySelector("#btnCEO"))==null||i.addEventListener("click",()=>{window.open(t+"/blob/main/docs/BE_YOUR_OWN_CEO.md","_blank")}),(o=a.querySelector("#btnDocs"))==null||o.addEventListener("click",()=>{window.open(t,"_blank")}),(c=a.querySelector("#btnSocials"))==null||c.addEventListener("click",()=>{Fr("socials")}),(l=a.querySelector("#btnTelegram"))==null||l.addEventListener("click",()=>{window.open(e,"_blank")}))}const nu=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1";console.log(`Environment: ${nu?"DEVELOPMENT":"PRODUCTION"}`);const _s="ZWla0YY4A0Hw7e_rwyOXB",Ce={chainId:"0x66eee",chainIdDecimal:421614,chainName:"Arbitrum Sepolia",nativeCurrency:{name:"Ethereum",symbol:"ETH",decimals:18},blockExplorerUrls:["https://sepolia.arbiscan.io"],rpcUrls:[`https://arb-sepolia.g.alchemy.com/v2/${_s}`,"https://arbitrum-sepolia.blockpi.network/v1/rpc/public","https://arbitrum-sepolia-rpc.publicnode.com"]},Ct=[{name:"Alchemy",url:`https://arb-sepolia.g.alchemy.com/v2/${_s}`,priority:1,isPublic:!1,corsCompatible:!0},{name:"BlockPI",url:"https://arbitrum-sepolia.blockpi.network/v1/rpc/public",priority:2,isPublic:!0,corsCompatible:!0},{name:"PublicNode",url:"https://arbitrum-sepolia-rpc.publicnode.com",priority:3,isPublic:!0,corsCompatible:!0},{name:"Arbitrum Official",url:"https://sepolia-rollup.arbitrum.io/rpc",priority:4,isPublic:!0,corsCompatible:!1}].filter(e=>e.url!==null),Ui=`https://arb-sepolia.g.alchemy.com/v2/${_s}`;let He=0,zn=new Map;function Nn(){var e;return((e=Ct[He])==null?void 0:e.url)||Ui}function Hi(){const e=He;do{He=(He+1)%Ct.length;const n=Ct[He];if(!n.corsCompatible){console.warn(`⏭️ Skipping ${n.name} (CORS incompatible)`);continue}if(He===e)return console.warn("⚠️ All RPCs have been tried. Resetting to primary."),He=0,Ct[0].url}while(zn.get(Ct[He].url)==="unhealthy");const t=Ct[He];return console.log(`🔄 Switched to RPC: ${t.name}`),t.url}function au(e){zn.set(e,"unhealthy"),console.warn(`❌ RPC marked unhealthy: ${e}`),setTimeout(()=>{zn.delete(e),console.log(`♻️ RPC health reset: ${e}`)},6e4)}function su(e){zn.set(e,"healthy")}function ru(){He=0,zn.clear(),console.log(`✅ Reset to primary RPC: ${Ct[0].name}`)}const iu="https://white-defensive-eel-240.mypinata.cloud/ipfs/",w={},$={bkcToken:null,ecosystemManager:null,delegationManager:null,rewardBoosterNFT:null,rentalManager:null,nftLiquidityPoolFactory:null,fortunePool:null,fortunePoolV2:null,backchainRandomness:null,publicSale:null,decentralizedNotary:null,faucet:null,miningManager:null,charityPool:null,backchat:null,operator:null};async function ou(){try{const e=await fetch(`./deployment-addresses.json?t=${Date.now()}`);if(!e.ok)throw new Error(`Failed to fetch deployment-addresses.json: ${e.status}`);const t=await e.json(),a=["bkcToken","delegationManager","ecosystemManager","miningManager"].filter(s=>!t[s]);if(a.length>0)throw new Error(`Missing required addresses: ${a.join(", ")}`);return Object.assign(w,t),w.fortunePoolV2=t.fortunePoolV2||t.fortunePool,w.fortunePool=t.fortunePool,w.actionsManager=t.fortunePool,w.rentalManager=t.rentalManager||t.RentalManager||t.rental_manager||null,w.decentralizedNotary=t.decentralizedNotary||t.notary||t.Notary||null,w.bkcDexPoolAddress=t.bkcDexPoolAddress||"#",w.backchainRandomness=t.backchainRandomness||null,w.charityPool=t.charityPool||t.CharityPool||null,w.backchat=t.backchat||t.Backchat||null,w.operator=t.operator||t.treasuryWallet||null,Object.assign($,t),console.log("✅ Contract addresses loaded"),console.log("   FortunePool V2:",w.fortunePoolV2),console.log("   CharityPool:",w.charityPool),console.log("   Backchat:",w.backchat),console.log("   Operator:",w.operator),!0}catch(e){return console.error("❌ Failed to load contract addresses:",e),!1}}const he=[{name:"Diamond",boostBips:5e3,burnRate:0,keepRate:100,color:"text-cyan-400",emoji:"💎",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeicgip72jcqgsirlrhn3tq5cc226vmko6etnndzl6nlhqrktfikafq",borderColor:"border-cyan-400/50",glowColor:"bg-cyan-500/10",bgGradient:"from-cyan-500/20 to-blue-500/20"},{name:"Gold",boostBips:4e3,burnRate:10,keepRate:90,color:"text-amber-400",emoji:"🥇",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeifponccrbicg2pcjrn2hrfoqgc77xhm2r4ld7hdpw6cxxkbsckf44",borderColor:"border-amber-400/50",glowColor:"bg-amber-500/10",bgGradient:"from-amber-500/20 to-yellow-500/20"},{name:"Silver",boostBips:2500,burnRate:25,keepRate:75,color:"text-gray-300",emoji:"🥈",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeihvi2inujm5zpi7tl667g4srq273536pjkglwyrtbwmgnskmu7jg4",borderColor:"border-gray-400/50",glowColor:"bg-gray-500/10",bgGradient:"from-gray-400/20 to-zinc-500/20"},{name:"Bronze",boostBips:1e3,burnRate:40,keepRate:60,color:"text-yellow-600",emoji:"🥉",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeiclqidb67rt3tchhjpsib62s624li7j2bpxnr6b5w5mfp4tomhu7m",borderColor:"border-yellow-600/50",glowColor:"bg-yellow-600/10",bgGradient:"from-yellow-600/20 to-orange-600/20"}];function cu(e){const t=[...he].sort((n,a)=>a.boostBips-n.boostBips);for(const n of t)if(e>=n.boostBips)return n;return null}function lu(e){return e>=5e3?0:e>=4e3?10:e>=2500?25:e>=1e3?40:50}function gt(e){return 100-lu(e)}const Fs=["function name() view returns (string)","function symbol() view returns (string)","function decimals() view returns (uint8)","function totalSupply() view returns (uint256)","function balanceOf(address owner) view returns (uint256)","function transfer(address to, uint256 amount) returns (bool)","function approve(address spender, uint256 amount) returns (bool)","function allowance(address owner, address spender) view returns (uint256)","function transferFrom(address from, address to, uint256 amount) returns (bool)","function MAX_SUPPLY() view returns (uint256)","function TGE_SUPPLY() view returns (uint256)","function remainingMintableSupply() view returns (uint256)","event Transfer(address indexed from, address indexed to, uint256 value)","event Approval(address indexed owner, address indexed spender, uint256 value)"],Ms=["function totalNetworkPStake() view returns (uint256)","function userTotalPStake(address _user) view returns (uint256)","function pendingRewards(address _user) view returns (uint256)","function MIN_LOCK_DURATION() view returns (uint256)","function MAX_LOCK_DURATION() view returns (uint256)","function getDelegationsOf(address _user) view returns (tuple(uint256 amount, uint64 unlockTime, uint64 lockDuration)[])","function delegate(uint256 _amount, uint256 _lockDuration, address _operator) external","function unstake(uint256 _delegationIndex, address _operator) external","function forceUnstake(uint256 _delegationIndex, address _operator) external","function claimReward(address _operator) external payable","function claimEthFee() view returns (uint256)","function getUserBestBoost(address _user) view returns (uint256)","function getBurnRateForBoost(uint256 _boost) view returns (uint256)","function previewClaim(address _user) view returns (uint256 totalRewards, uint256 burnAmount, uint256 userReceives, uint256 burnRateBips, uint256 userBoost)","event Delegated(address indexed user, address indexed operator, uint256 amount, uint256 lockDuration, uint256 pStake)","event Unstaked(address indexed user, address indexed operator, uint256 amount, uint256 pStakeReduced)","event ForceUnstaked(address indexed user, address indexed operator, uint256 amount, uint256 penaltyAmount)","event RewardClaimed(address indexed user, address indexed operator, uint256 grossAmount, uint256 burnedAmount, uint256 userReceived, uint256 boostUsed)"],du=["function balanceOf(address owner) view returns (uint256)","function tokenOfOwnerByIndex(address owner, uint256 index) view returns (uint256)","function ownerOf(uint256 tokenId) view returns (address)","function approve(address to, uint256 tokenId)","function setApprovalForAll(address operator, bool approved)","function safeTransferFrom(address from, address to, uint256 tokenId)","function boostBips(uint256 _tokenId) view returns (uint256)","function tokenURI(uint256 tokenId) view returns (string)","function totalSupply() view returns (uint256)","event Transfer(address indexed from, address indexed to, uint256 indexed tokenId)","event Approval(address indexed owner, address indexed approved, uint256 indexed tokenId)"],Un=["function listNFT(uint256 _tokenId, uint256 _pricePerHour, uint256 _minHours, uint256 _maxHours) external","function updateListing(uint256 _tokenId, uint256 _newPricePerHour, uint256 _newMinHours, uint256 _newMaxHours) external","function withdrawNFT(uint256 _tokenId) external","function rentNFT(uint256 _tokenId, uint256 _hours) external","function getListing(uint256 _tokenId) view returns (tuple(address owner, uint256 pricePerHour, uint256 minHours, uint256 maxHours, bool isActive, uint256 totalEarnings, uint256 rentalCount))","function getRental(uint256 _tokenId) view returns (tuple(address tenant, uint256 startTime, uint256 endTime, uint256 paidAmount))","function isRented(uint256 _tokenId) view returns (bool)","function hasRentalRights(uint256 _tokenId, address _user) view returns (bool)","function getRemainingRentalTime(uint256 _tokenId) view returns (uint256)","function getAllListedTokenIds() view returns (uint256[])","function getListingCount() view returns (uint256)","function getRentalCost(uint256 _tokenId, uint256 _hours) view returns (uint256 totalCost, uint256 protocolFee, uint256 ownerPayout)","function getMarketplaceStats() view returns (uint256 activeListings, uint256 totalVol, uint256 totalFees, uint256 rentals)","event NFTListed(uint256 indexed tokenId, address indexed owner, uint256 pricePerHour, uint256 minHours, uint256 maxHours)","event NFTRented(uint256 indexed tokenId, address indexed tenant, address indexed owner, uint256 hours_, uint256 totalCost, uint256 protocolFee, uint256 ownerPayout, uint256 endTime)","event NFTWithdrawn(uint256 indexed tokenId, address indexed owner)","event RentalExpired(uint256 indexed tokenId, address indexed tenant)"],ji=["function buyNFT(uint256 _maxPrice, address _operator) external payable returns (uint256 tokenId)","function buySpecificNFT(uint256 _tokenId, uint256 _maxPrice, address _operator) external payable","function buyNFTWithSlippage(uint256 _maxPrice, address _operator) external payable returns (uint256 tokenId)","function sellNFT(uint256 _tokenId, uint256 _minPayout, address _operator) external payable","function getBuyPrice() view returns (uint256)","function getBuyPriceWithTax() view returns (uint256)","function getSellPrice() view returns (uint256)","function getSellPriceAfterTax() view returns (uint256)","function getTotalBuyCost() view returns (uint256 bkcCost, uint256 ethCost)","function getTotalSellInfo() view returns (uint256 bkcPayout, uint256 ethCost)","function getSpread() view returns (uint256 spread, uint256 spreadBips)","function getPoolInfo() view returns (uint256 bkcBalance, uint256 nftCount, uint256 k, bool initialized)","function getAvailableNFTs() view returns (uint256[])","function getNFTBalance() view returns (uint256)","function getBKCBalance() view returns (uint256)","function isNFTInPool(uint256 _tokenId) view returns (bool)","function boostBips() view returns (uint256)","function getTierName() view returns (string)","function buyEthFee() view returns (uint256)","function sellEthFee() view returns (uint256)","function getEthFeeConfig() view returns (uint256 buyFee, uint256 sellFee, uint256 totalCollected)","function totalETHCollected() view returns (uint256)","function getTradingStats() view returns (uint256 volume, uint256 taxes, uint256 buys, uint256 sells)","function totalVolume() view returns (uint256)","function totalTaxesCollected() view returns (uint256)","function totalBuys() view returns (uint256)","function totalSells() view returns (uint256)","event NFTPurchased(address indexed buyer, uint256 indexed tokenId, uint256 price, uint256 tax, uint256 newBkcBalance, uint256 newNftCount, address operator)","event NFTSold(address indexed seller, uint256 indexed tokenId, uint256 payout, uint256 tax, uint256 newBkcBalance, uint256 newNftCount, address operator)"],Ds=["function participate(uint256 _wagerAmount, uint256[] calldata _guesses, bool _isCumulative) external payable","function oracleFee() view returns (uint256)","function gameFeeBips() view returns (uint256)","function getRequiredOracleFee(bool _isCumulative) view returns (uint256)","function activeTierCount() view returns (uint256)","function gameCounter() view returns (uint256)","function prizePoolBalance() view returns (uint256)","function getExpectedGuessCount(bool _isCumulative) view returns (uint256)","function isGameFulfilled(uint256 _gameId) view returns (bool)","function getGameResults(uint256 _gameId) view returns (uint256[])","function getJackpotTierId() view returns (uint256)","function getJackpotTier() view returns (uint256 tierId, uint128 maxRange, uint64 multiplierBips, bool active)","function getAllTiers() view returns (uint128[] ranges, uint64[] multipliers)","function prizeTiers(uint256 tierId) view returns (uint128 maxRange, uint64 multiplierBips, bool active)","function calculatePotentialWinnings(uint256 _wagerAmount, bool _isCumulative) view returns (uint256 maxPrize, uint256 netWager)","event GameRequested(uint256 indexed gameId, address indexed player, uint256 wagerAmount, uint256[] guesses, bool isCumulative, uint256 targetTier)","event GameFulfilled(uint256 indexed gameId, address indexed player, uint256 prizeWon, uint256[] rolls, uint256[] guesses, bool isCumulative)"],Os=["function commitPlay(bytes32 _commitmentHash, uint256 _wagerAmount, bool _isCumulative, address _operator) external payable","function revealPlay(uint256 _gameId, uint256[] calldata _guesses, bytes32 _userSecret) external returns (uint256 prizeWon)","function generateCommitmentHash(uint256[] calldata _guesses, bytes32 _userSecret) external pure returns (bytes32 hash)","function claimExpiredGame(uint256 _gameId) external","function getCommitmentStatus(uint256 _gameId) view returns (uint8 status, bool canReveal, bool isExpired, uint256 blocksUntilReveal, uint256 blocksUntilExpiry)","function getCommitment(uint256 _gameId) view returns (address player, uint64 commitBlock, bool isCumulative, uint8 status, uint256 wagerAmount, uint256 ethPaid)","function commitmentMeta(uint256 _gameId) view returns (bytes32 hash, address operator, uint96 tierNonce)","function revealDelay() view returns (uint256)","function revealWindow() view returns (uint256)","function serviceFee() view returns (uint256)","function getRequiredServiceFee(bool _isCumulative) view returns (uint256)","function gameFeeBips() view returns (uint256)","function activeTierCount() view returns (uint256)","function prizeTiers(uint256 tierId) view returns (uint128 maxRange, uint64 multiplierBips, bool active)","function getTier(uint256 _tierId) view returns (uint256 maxRange, uint256 multiplierBips, bool active)","function getAllTiers() view returns (uint128[] ranges, uint64[] multipliers)","function getExpectedGuessCount(bool _isCumulative) view returns (uint256)","function calculatePotentialWinnings(uint256 _wagerAmount, bool _isCumulative) view returns (uint256 maxPrize, uint256 netWager)","function gameCounter() view returns (uint256)","function prizePoolBalance() view returns (uint256)","function getGameResult(uint256 _gameId) view returns (address player, uint256 wagerAmount, uint256 prizeWon, uint256[] guesses, uint256[] rolls, bool isCumulative, uint8 matchCount, uint256 timestamp)","function getPlayerStats(address _player) view returns (uint256 gamesPlayed, uint256 totalWagered, uint256 totalWon, int256 netProfit)","function getPoolStats() view returns (uint256 poolBalance, uint256 gamesPlayed, uint256 wageredAllTime, uint256 paidOutAllTime, uint256 winsAllTime, uint256 ethCollected, uint256 bkcFees, uint256 expiredGames)","function totalWageredAllTime() view returns (uint256)","function totalPaidOutAllTime() view returns (uint256)","function totalWinsAllTime() view returns (uint256)","function totalETHCollected() view returns (uint256)","function totalBKCFees() view returns (uint256)","function totalExpiredGames() view returns (uint256)","event GameCommitted(uint256 indexed gameId, address indexed player, uint256 wagerAmount, bool isCumulative, address operator)","event GameRevealed(uint256 indexed gameId, address indexed player, uint256 wagerAmount, uint256 prizeWon, bool isCumulative, uint8 matchCount, address operator)","event GameDetails(uint256 indexed gameId, uint256[] guesses, uint256[] rolls, bool[] matches)","event JackpotWon(uint256 indexed gameId, address indexed player, uint256 prizeAmount, uint256 tier)","event GameExpired(uint256 indexed gameId, address indexed player, uint256 forfeitedAmount)"],uu=["function tiers(uint256 tierId) view returns (uint256 priceInWei, uint64 maxSupply, uint64 mintedCount, uint16 boostBips, bool isConfigured, bool isActive, string metadataFile, string name)","function buyNFT(uint256 _tierId) external payable","function buyMultipleNFTs(uint256 _tierId, uint256 _quantity) external payable","function getTierPrice(uint256 _tierId) view returns (uint256)","function getTierSupply(uint256 _tierId) view returns (uint64 maxSupply, uint64 mintedCount)","function isTierActive(uint256 _tierId) view returns (bool)","event NFTSold(address indexed buyer, uint256 indexed tierId, uint256 indexed tokenId, uint256 price)"],pu=["function balanceOf(address owner) view returns (uint256)","function tokenURI(uint256 tokenId) view returns (string)","function ownerOf(uint256 tokenId) view returns (address)","function tokenOfOwnerByIndex(address owner, uint256 index) view returns (uint256)","function totalSupply() view returns (uint256)","function getDocument(uint256 tokenId) view returns (tuple(string ipfsCid, string description, bytes32 contentHash, uint256 timestamp))","function documents(uint256 tokenId) view returns (string ipfsCid, string description, bytes32 contentHash, uint256 timestamp)","function bkcFee() view returns (uint256)","function ethFee() view returns (uint256)","function notarize(string _ipfsCid, string _description, bytes32 _contentHash, address _operator) external payable returns (uint256)","event DocumentNotarized(uint256 indexed tokenId, address indexed owner, address indexed operator, string ipfsCid, bytes32 contentHash, uint256 bkcFeePaid, uint256 ethFeePaid)"],Us=["function canClaim(address _user) view returns (bool)","function getCooldownRemaining(address _user) view returns (uint256)","function getUserInfo(address _user) view returns (uint256 lastClaimTime, uint256 totalClaimed)","function getFaucetStatus() view returns (uint256 bkcBalance, uint256 ethBalance, bool isActive)","function COOLDOWN_PERIOD() view returns (uint256)","function TOKEN_AMOUNT() view returns (uint256)","function ETH_AMOUNT() view returns (uint256)","event TokensDistributed(address indexed recipient, uint256 tokenAmount, uint256 ethAmount, address indexed relayer)"],Hs=["function getServiceRequirements(bytes32 _serviceKey) view returns (uint256 fee, uint256 pStake)","function getFee(bytes32 _serviceKey) view returns (uint256)","function getBoosterDiscount(uint256 _boostBips) view returns (uint256)","function getMiningDistributionBips() view returns (uint256 stakingBips, uint256 minerBips, uint256 treasuryBips)","function getFeeDistributionBips() view returns (uint256 burnBips, uint256 treasuryBips, uint256 poolBips)","function getTreasuryAddress() view returns (address)","function getDelegationManagerAddress() view returns (address)","function getBKCTokenAddress() view returns (address)","function getBoosterAddress() view returns (address)","function getNFTLiquidityPoolFactoryAddress() view returns (address)","function getMiningManagerAddress() view returns (address)","function getFortunePoolAddress() view returns (address)","function getNotaryAddress() view returns (address)","function getRentalManagerAddress() view returns (address)","function getPublicSaleAddress() view returns (address)","function isInitialized() view returns (bool)","function owner() view returns (address)"],Wi=["function createProfile(string username, string displayName, string bio, address operator) external payable","function updateProfile(string displayName, string bio) external","function createPost(string content, string mediaCID, address operator) external payable returns (uint256 postId)","function createReply(uint256 parentId, string content, string mediaCID, address operator, uint256 tipBkc) external payable returns (uint256 postId)","function createRepost(uint256 originalPostId, address operator, uint256 tipBkc) external payable returns (uint256 postId)","function like(uint256 postId, address operator, uint256 tipBkc) external payable","function superLike(uint256 postId, address operator, uint256 tipBkc) external payable","function follow(address toFollow, address operator, uint256 tipBkc) external payable","function unfollow(address toUnfollow) external","function boostProfile(address operator) external payable","function obtainBadge(address operator) external payable","function setReferrer(address _referrer) external","function getReferralStats(address referrer) external view returns (uint256 totalReferred, uint256 totalEarned)","function referredBy(address user) external view returns (address)","function referralCount(address referrer) external view returns (uint256)","function referralEarnings(address referrer) external view returns (uint256)","function withdraw() external","function calculateFee(uint256 gasEstimate) view returns (uint256)","function getCurrentFees() view returns (uint256 postFee, uint256 replyFee, uint256 likeFee, uint256 followFee, uint256 repostFee, uint256 superLikeMin, uint256 boostMin, uint256 badgeFee_)","function getUsernameFee(uint256 length) pure returns (uint256)","function postCounter() view returns (uint256)","function postAuthor(uint256 postId) view returns (address)","function pendingEth(address user) view returns (uint256)","function usernameOwner(bytes32 usernameHash) view returns (address)","function hasLiked(uint256 postId, address user) view returns (bool)","function boostExpiry(address user) view returns (uint256)","function badgeExpiry(address user) view returns (uint256)","function isProfileBoosted(address user) view returns (bool)","function hasTrustBadge(address user) view returns (bool)","function hasUserLiked(uint256 postId, address user) view returns (bool)","function getPendingBalance(address user) view returns (uint256)","function isUsernameAvailable(string username) view returns (bool)","function getUsernameOwner(string username) view returns (address)","function version() pure returns (string)","function bkcToken() view returns (address)","function ecosystemManager() view returns (address)","event ProfileCreated(address indexed user, bytes32 indexed usernameHash, string username, string displayName, string bio, uint256 ethPaid, address indexed operator)","event ProfileUpdated(address indexed user, string displayName, string bio)","event PostCreated(uint256 indexed postId, address indexed author, string content, string mediaCID, address indexed operator)","event ReplyCreated(uint256 indexed postId, uint256 indexed parentId, address indexed author, string content, string mediaCID, uint256 tipBkc, address operator)","event RepostCreated(uint256 indexed newPostId, uint256 indexed originalPostId, address indexed reposter, uint256 tipBkc, address operator)","event Liked(uint256 indexed postId, address indexed user, uint256 tipBkc, address indexed operator)","event SuperLiked(uint256 indexed postId, address indexed user, uint256 ethAmount, uint256 tipBkc, address indexed operator)","event Followed(address indexed follower, address indexed followed, uint256 tipBkc, address indexed operator)","event Unfollowed(address indexed follower, address indexed followed)","event ProfileBoosted(address indexed user, uint256 amount, uint256 expiresAt, address indexed operator)","event BadgeObtained(address indexed user, uint256 expiresAt, address indexed operator)","event Withdrawal(address indexed user, uint256 amount)","event TipProcessed(address indexed from, address indexed creator, uint256 totalBkc, uint256 creatorShare, uint256 miningShare, address indexed operator)","event ReferrerSet(address indexed user, address indexed referrer)"];let Mr=0;const mu=5e3;async function fu(){try{return window.ethereum?await window.ethereum.request({method:"eth_chainId"})===Ce.chainId:!1}catch(e){return console.warn("Network check failed:",e.message),!1}}async function Jt(){if(!window.ethereum)return console.warn("MetaMask not detected"),!1;try{return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:Ce.chainId,chainName:Ce.chainName,nativeCurrency:Ce.nativeCurrency,rpcUrls:Ce.rpcUrls,blockExplorerUrls:Ce.blockExplorerUrls}]}),console.log("✅ MetaMask network config updated"),!0}catch(e){return e.code===4001?(console.log("User rejected network update"),!1):(console.warn("Could not update MetaMask network:",e.message),!1)}}async function bu(){if(!window.ethereum)return console.warn("MetaMask not detected"),!1;try{return await window.ethereum.request({method:"wallet_switchEthereumChain",params:[{chainId:Ce.chainId}]}),console.log("✅ Switched to Arbitrum Sepolia"),!0}catch(e){return e.code===4902?(console.log("🔄 Network not found, adding..."),await Jt()):e.code===4001?(console.log("User rejected network switch"),!1):(console.error("Network switch error:",e),!1)}}async function Ln(){var e;if(!window.ethereum)return{healthy:!1,reason:"no_provider"};try{const t=new window.ethers.BrowserProvider(window.ethereum),n=new Promise((s,r)=>setTimeout(()=>r(new Error("timeout")),5e3)),a=t.getBlockNumber();return await Promise.race([a,n]),{healthy:!0}}catch(t){const n=((e=t==null?void 0:t.message)==null?void 0:e.toLowerCase())||"";return n.includes("timeout")?{healthy:!1,reason:"timeout"}:n.includes("too many")||n.includes("rate limit")||n.includes("-32002")?{healthy:!1,reason:"rate_limited"}:n.includes("failed to fetch")||n.includes("network")?{healthy:!1,reason:"network_error"}:{healthy:!1,reason:"unknown",error:n}}}async function gu(){const e=Date.now();if(e-Mr<mu)return{success:!0,skipped:!0};if(Mr=e,!window.ethereum)return{success:!1,error:"MetaMask not detected"};try{if(!await fu()&&(console.log("🔄 Wrong network detected, switching..."),!await bu()))return{success:!1,error:"Please switch to Arbitrum Sepolia network"};const n=await Ln();if(!n.healthy&&(console.log(`⚠️ RPC unhealthy (${n.reason}), updating MetaMask config...`),await Jt())){await new Promise(r=>setTimeout(r,1e3));const s=await Ln();return s.healthy?{success:!0,fixed:!0}:{success:!1,error:"Network is congested. Please try again in a moment.",rpcReason:s.reason}}return{success:!0}}catch(t){return console.error("Network config error:",t),{success:!1,error:t.message}}}function xu(e){window.ethereum&&window.ethereum.on("chainChanged",async t=>{console.log("🔄 Network changed to:",t);const n=t===Ce.chainId;e&&e({chainId:t,isCorrectNetwork:n,needsSwitch:!n})})}const hu=window.ethers,vu=5e3,wu=6e4,yu=15e3,ku=3e4,Eu=1e4;let Ya=null,Dr=0;const Or=new Map,Va=new Map,Ur=new Map,Hr=e=>new Promise(t=>setTimeout(t,e));async function za(e,t){const n=new AbortController,a=setTimeout(()=>n.abort(),t);try{const s=await fetch(e,{signal:n.signal});return clearTimeout(a),s}catch(s){throw clearTimeout(a),s.name==="AbortError"?new Error("API request timed out."):s}}const Ie={getHistory:"https://gethistory-4wvdcuoouq-uc.a.run.app",getBoosters:"https://getboosters-4wvdcuoouq-uc.a.run.app",getSystemData:"https://getsystemdata-4wvdcuoouq-uc.a.run.app",getNotaryHistory:"https://getnotaryhistory-4wvdcuoouq-uc.a.run.app",getRentalListings:"https://getrentallistings-4wvdcuoouq-uc.a.run.app",getUserRentals:"https://getuserrentals-4wvdcuoouq-uc.a.run.app",fortuneGames:"https://getfortunegames-4wvdcuoouq-uc.a.run.app",uploadFileToIPFS:"/api/upload",claimAirdrop:"https://us-central1-airdropbackchainnew.cloudfunctions.net/claimAirdrop"};function Gi(e){var t;return((t=e==null?void 0:e.error)==null?void 0:t.code)===429||(e==null?void 0:e.code)===429||e.message&&(e.message.includes("429")||e.message.includes("Too Many Requests")||e.message.includes("rate limit"))}function Ki(e){var n,a;const t=((n=e==null?void 0:e.error)==null?void 0:n.code)||(e==null?void 0:e.code);return t===-32603||t===-32e3||((a=e.message)==null?void 0:a.includes("Internal JSON-RPC"))}function Na(e,t,n){if(n)return n;if(!e||!d.publicProvider)return null;try{return new hu.Contract(e,t,d.publicProvider)}catch{return null}}const re=async(e,t,n=[],a=0n,s=2,r=!1)=>{if(!e)return a;const i=e.target||e.address,o=JSON.stringify(n,(m,p)=>typeof p=="bigint"?p.toString():p),c=`${i}-${t}-${o}`,l=Date.now(),u=["getPoolInfo","getBuyPrice","getSellPrice","getAvailableTokenIds","getAllListedTokenIds","tokenURI","boostBips","getListing","balanceOf","totalSupply","totalNetworkPStake","MAX_SUPPLY","TGE_SUPPLY","userTotalPStake","pendingRewards","isRented","getRental","ownerOf","getDelegationsOf","allowance","prizeTiers","activeTierCount","prizePoolBalance"];if(!r&&u.includes(t)){const m=Or.get(c);if(m&&l-m.timestamp<yu)return m.value}for(let m=0;m<=s;m++)try{const p=await e[t](...n);return u.includes(t)&&Or.set(c,{value:p,timestamp:l}),p}catch(p){if(Gi(p)&&m<s){const f=Math.floor(Math.random()*1e3),b=1e3*Math.pow(2,m)+f;await Hr(b);continue}if(Ki(p)&&m<s){await Hr(500);continue}break}return a},Cu=async(e,t,n=!1)=>{const a=`balance-${(e==null?void 0:e.target)||(e==null?void 0:e.address)}-${t}`,s=Date.now();if(!n){const i=Ur.get(a);if(i&&s-i.timestamp<Eu)return i.value}const r=await re(e,"balanceOf",[t],0n,2,n);return Ur.set(a,{value:r,timestamp:s}),r};async function Yi(){d.systemFees||(d.systemFees={}),d.systemPStakes||(d.systemPStakes={}),d.boosterDiscounts||(d.boosterDiscounts={});const e=Date.now();if(Ya&&e-Dr<wu)return jr(Ya),!0;try{const t=await za(Ie.getSystemData,vu);if(!t.ok)throw new Error(`API Status: ${t.status}`);const n=await t.json();return jr(n),Ya=n,Dr=e,!0}catch{return d.systemFees.NOTARY_SERVICE||(d.systemFees.NOTARY_SERVICE=100n),d.systemFees.CLAIM_REWARD_FEE_BIPS||(d.systemFees.CLAIM_REWARD_FEE_BIPS=500n),!1}}function jr(e){if(e.fees)for(const t in e.fees)try{d.systemFees[t]=BigInt(e.fees[t])}catch{d.systemFees[t]=0n}if(e.pStakeRequirements)for(const t in e.pStakeRequirements)try{d.systemPStakes[t]=BigInt(e.pStakeRequirements[t])}catch{d.systemPStakes[t]=0n}if(e.discounts)for(const t in e.discounts)try{d.boosterDiscounts[t]=BigInt(e.discounts[t])}catch{d.boosterDiscounts[t]=0n}if(e.oracleFeeInWei){d.systemData=d.systemData||{};try{d.systemData.oracleFeeInWei=BigInt(e.oracleFeeInWei)}catch{d.systemData.oracleFeeInWei=0n}}}async function js(){!d.publicProvider||!d.bkcTokenContractPublic||await Promise.allSettled([re(d.bkcTokenContractPublic,"totalSupply",[],0n),Yi()])}async function Mt(e=!1){var t;if(!(!d.isConnected||!d.userAddress))try{const[n,a]=await Promise.allSettled([Cu(d.bkcTokenContract,d.userAddress,e),(t=d.provider)==null?void 0:t.getBalance(d.userAddress)]);if(n.status==="fulfilled"&&(d.currentUserBalance=n.value),a.status==="fulfilled"&&(d.currentUserNativeBalance=a.value),await At(e),d.delegationManagerContract){const s=await re(d.delegationManagerContract,"userTotalPStake",[d.userAddress],0n,2,e);d.userTotalPStake=s}}catch(n){console.error("Error loading user data:",n)}}async function Tu(e=!1){if(!d.isConnected||!d.delegationManagerContract)return[];try{const t=await re(d.delegationManagerContract,"getDelegationsOf",[d.userAddress],[],2,e);return d.userDelegations=t.map((n,a)=>({amount:n[0]||n.amount||0n,unlockTime:BigInt(n[1]||n.unlockTime||0),lockDuration:BigInt(n[2]||n.lockDuration||0),index:a})),d.userDelegations}catch(t){return console.error("Error loading delegations:",t),[]}}async function Vi(e=!1){let t=[];try{const a=await za(Ie.getRentalListings,4e3);a.ok&&(t=await a.json())}catch{}if(t&&t.length>0){const a=t.map(s=>{var i,o,c,l,u;const r=he.find(m=>m.boostBips===Number(s.boostBips||0));return{...s,tokenId:((i=s.tokenId)==null?void 0:i.toString())||((o=s.id)==null?void 0:o.toString()),pricePerHour:((c=s.pricePerHour)==null?void 0:c.toString())||((l=s.price)==null?void 0:l.toString())||"0",totalEarnings:((u=s.totalEarnings)==null?void 0:u.toString())||"0",rentalCount:Number(s.rentalCount||0),img:(r==null?void 0:r.img)||"./assets/nft.png",name:(r==null?void 0:r.name)||"Booster NFT"}});return d.rentalListings=a,a}const n=Na(w.rentalManager,Un,d.rentalManagerContractPublic);if(!n)return d.rentalListings=[],[];try{const a=await re(n,"getAllListedTokenIds",[],[],2,!0);if(!a||a.length===0)return d.rentalListings=[],[];const r=a.slice(0,30).map(async c=>{var l,u,m,p,f,b;try{const x=await re(n,"getListing",[c],null,1,!0);if(x&&x.isActive){const y=await re(n,"getRental",[c],null,1,!0),C=await qi(c),I=Math.floor(Date.now()/1e3),B=y&&BigInt(y.endTime||0)>BigInt(I);return{tokenId:c.toString(),owner:x.owner,pricePerHour:((l=x.pricePerHour)==null?void 0:l.toString())||((u=x.price)==null?void 0:u.toString())||"0",minHours:((m=x.minHours)==null?void 0:m.toString())||"1",maxHours:((p=x.maxHours)==null?void 0:p.toString())||"1",totalEarnings:((f=x.totalEarnings)==null?void 0:f.toString())||"0",rentalCount:Number(x.rentalCount||0),boostBips:C.boostBips,img:C.img||"./assets/nft.png",name:C.name,isRented:B,currentTenant:B?y.tenant:null,rentalEndTime:B?(b=y.endTime)==null?void 0:b.toString():null}}}catch{}return null}),o=(await Promise.all(r)).filter(c=>c!==null);return d.rentalListings=o,o}catch{return d.rentalListings=[],[]}}async function Iu(e=!1){var n,a,s,r;if(!d.userAddress)return d.myRentals=[],[];try{const i=await za(`${Ie.getUserRentals}/${d.userAddress}`,4e3);if(i.ok){const c=(await i.json()).map(l=>{const u=he.find(m=>m.boostBips===Number(l.boostBips||0));return{...l,img:(u==null?void 0:u.img)||"./assets/nft.png",name:(u==null?void 0:u.name)||"Booster NFT"}});return d.myRentals=c,c}}catch{}const t=Na(w.rentalManager,Un,d.rentalManagerContractPublic);if(!t)return d.myRentals=[],[];try{const i=await re(t,"getAllListedTokenIds",[],[],2,e),o=[],c=Math.floor(Date.now()/1e3);for(const l of i.slice(0,30))try{const u=await re(t,"getRental",[l],null,1,e);if(u&&((n=u.tenant)==null?void 0:n.toLowerCase())===d.userAddress.toLowerCase()&&BigInt(u.endTime||0)>BigInt(c)){const m=await qi(l);o.push({tokenId:l.toString(),tenant:u.tenant,startTime:((a=u.startTime)==null?void 0:a.toString())||"0",endTime:((s=u.endTime)==null?void 0:s.toString())||"0",paidAmount:((r=u.paidAmount)==null?void 0:r.toString())||"0",boostBips:m.boostBips,img:m.img,name:m.name})}}catch{}return d.myRentals=o,o}catch{return d.myRentals=[],[]}}let Qn=null,Wr=0;const Au=3e4;async function Zt(e=!1){const t=Date.now();if(!e&&Qn&&t-Wr<Au)return Qn;await At(e);let n=0,a=null,s="none";if(d.myBoosters&&d.myBoosters.length>0){const c=d.myBoosters.reduce((l,u)=>u.boostBips>l.boostBips?u:l,d.myBoosters[0]);c.boostBips>n&&(n=c.boostBips,a=c.tokenId,s="owned")}if(d.myRentals&&d.myRentals.length>0){const c=d.myRentals.reduce((l,u)=>u.boostBips>l.boostBips?u:l,d.myRentals[0]);c.boostBips>n&&(n=c.boostBips,a=c.tokenId,s="rented")}const r=he.find(c=>c.boostBips===n),i=(r==null?void 0:r.realImg)||(r==null?void 0:r.img)||"assets/bkc_logo_3d.png",o=r!=null&&r.name?`${r.name} Booster`:s!=="none"?"Booster NFT":"None";return Qn={highestBoost:n,boostName:o,imageUrl:i,tokenId:a?a.toString():null,source:s},Wr=Date.now(),Qn}async function qi(e){const t=["function boostBips(uint256) view returns (uint256)"],n=Na(w.rewardBoosterNFT,t,d.rewardBoosterContractPublic);if(!n)return{boostBips:0,img:"assets/bkc_logo_3d.png",name:"Unknown"};try{const a=await re(n,"boostBips",[e],0n),s=Number(a),r=he.find(i=>i.boostBips===s);return{boostBips:s,img:(r==null?void 0:r.img)||"./assets/nft.png",name:(r==null?void 0:r.name)||`Booster #${e}`}}catch{return{boostBips:0,img:"assets/bkc_logo_3d.png",name:"Unknown"}}}async function on(){if(!d.isConnected||!d.delegationManagerContract)return{stakingRewards:0n,minerRewards:0n,totalRewards:0n};try{const e=await re(d.delegationManagerContract,"pendingRewards",[d.userAddress],0n);return{stakingRewards:e,minerRewards:0n,totalRewards:e}}catch{return{stakingRewards:0n,minerRewards:0n,totalRewards:0n}}}async function Bu(){var c,l;if(!d.delegationManagerContract||!d.userAddress)return{netClaimAmount:0n,feeAmount:0n,discountPercent:0,totalRewards:0n,baseFeeBips:0n,finalFeeBips:0n};const{totalRewards:e}=await on();if(e===0n)return{netClaimAmount:0n,feeAmount:0n,discountPercent:0,totalRewards:0n,baseFeeBips:0n,finalFeeBips:0n};let t=((c=d.systemFees)==null?void 0:c.CLAIM_REWARD_FEE_BIPS)||100n;const n=await Zt(),a=BigInt(n.highestBoost||0);let s=((l=d.boosterDiscounts)==null?void 0:l[n.highestBoost])||a;const r=t*s/10000n,i=t>r?t-r:0n,o=e*i/10000n;return console.log("[Data] Claim calculation:",{totalRewards:Number(e)/1e18,baseFeeBips:Number(t),boostBips:Number(a),discountBips:Number(s),discountAmount:Number(r),finalFeeBips:Number(i),feeAmount:Number(o)/1e18,netAmount:Number(e-o)/1e18}),{netClaimAmount:e-o,feeAmount:o,discountPercent:Number(s)/100,totalRewards:e,baseFeeBips:Number(t),finalFeeBips:Number(i)}}let qa=!1,Xa=0,ea=0;const Pu=3e4,zu=3,Nu=12e4;async function At(e=!1){if(!d.userAddress)return[];const t=Date.now();if(qa)return d.myBoosters||[];if(!e&&t-Xa<Pu)return d.myBoosters||[];if(ea>=zu){if(t-Xa<Nu)return d.myBoosters||[];ea=0}qa=!0,Xa=t;try{const n=await za(`${Ie.getBoosters}/${d.userAddress}`,5e3);if(!n.ok)throw new Error(`API Error: ${n.status}`);let a=await n.json();const s=["function ownerOf(uint256) view returns (address)","function boostBips(uint256) view returns (uint256)"],r=Na(w.rewardBoosterNFT,s,d.rewardBoosterContractPublic);if(r&&a.length>0){const i=await Promise.all(a.slice(0,50).map(async o=>{const c=BigInt(o.tokenId),l=`ownerOf-${c}`,u=Date.now();let m=Number(o.boostBips||o.boost||0);if(m===0)try{const p=await r.boostBips(c);m=Number(p)}catch{}if(!e&&Va.has(l)){const p=Va.get(l);if(u-p.timestamp<ku)return p.owner.toLowerCase()===d.userAddress.toLowerCase()?{tokenId:c,boostBips:m,imageUrl:o.imageUrl||o.image||null}:null}try{const p=await r.ownerOf(c);return Va.set(l,{owner:p,timestamp:u}),p.toLowerCase()===d.userAddress.toLowerCase()?{tokenId:c,boostBips:m,imageUrl:o.imageUrl||o.image||null}:null}catch(p){return Gi(p)||Ki(p)?{tokenId:c,boostBips:m,imageUrl:o.imageUrl||o.image||null}:null}}));d.myBoosters=i.filter(o=>o!==null)}else d.myBoosters=a.map(i=>({tokenId:BigInt(i.tokenId),boostBips:Number(i.boostBips||i.boost||0),imageUrl:i.imageUrl||i.image||null}));return ea=0,d.myBoosters}catch{return ea++,d.myBoosters||(d.myBoosters=[]),d.myBoosters}finally{qa=!1}}const Lu={apiKey:"AIzaSyDKhF2_--fKtot96YPS8twuD0UoCpS-3T4",authDomain:"airdropbackchainnew.firebaseapp.com",projectId:"airdropbackchainnew",storageBucket:"airdropbackchainnew.appspot.com",messagingSenderId:"108371799661",appId:"1:108371799661:web:d126fcbd0ba56263561964",measurementId:"G-QD9EBZ0Y09"},Xi=jd(Lu),ta=Wd(Xi),j=Yd(Xi);let ot=null,Ae=null,na=null;async function Ji(e){if(!e)throw new Error("Wallet address is required for Firebase sign-in.");const t=e.toLowerCase();return Ae=t,ot?(na=await vn(t),ot):ta.currentUser?(ot=ta.currentUser,na=await vn(t),ot):new Promise((n,a)=>{const s=Gd(ta,async r=>{if(s(),r){ot=r;try{na=await vn(t),n(r)}catch(i){console.error("Error linking airdrop user profile:",i),a(i)}}else Kd(ta).then(async i=>{ot=i.user,na=await vn(t),n(ot)}).catch(i=>{console.error("Firebase Anonymous sign-in failed:",i),a(i)})},r=>{console.error("Firebase Auth state change error:",r),s(),a(r)})})}function nt(){if(!ot)throw new Error("User not authenticated with Firebase. Please sign-in first.");if(!Ae)throw new Error("Wallet address not set. Please connect wallet first.")}async function Ws(){const e=se(j,"airdrop_public_data","data_v1"),t=await Ne(e);if(t.exists()){const n=t.data(),a=(n.dailyTasks||[]).map(i=>{var l,u;const o=(l=i.startDate)!=null&&l.toDate?i.startDate.toDate():i.startDate?new Date(i.startDate):null,c=(u=i.endDate)!=null&&u.toDate?i.endDate.toDate():i.endDate?new Date(i.endDate):null;return{...i,id:i.id||null,startDate:o instanceof Date&&!isNaN(o)?o:null,endDate:c instanceof Date&&!isNaN(c)?c:null}}).filter(i=>i.id),s=Date.now(),r=a.filter(i=>{const o=i.startDate?i.startDate.getTime():0,c=i.endDate?i.endDate.getTime():1/0;return o<=s&&s<c});return{config:n.config||{ugcBasePoints:{}},leaderboards:n.leaderboards||{top100ByPoints:[],top100ByPosts:[],lastUpdated:null},dailyTasks:r,platformUsageConfig:n.platformUsageConfig||null}}else return console.warn("Public airdrop data document 'airdrop_public_data/data_v1' not found. Returning defaults."),{config:{isActive:!1,roundName:"Loading...",ugcBasePoints:{}},leaderboards:{top100ByPoints:[],top100ByPosts:[],lastUpdated:null},dailyTasks:[],platformUsageConfig:null}}function Gr(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";let t="";for(let n=0;n<6;n++)t+=e.charAt(Math.floor(Math.random()*e.length));return t}function ma(e){return e>=100?10:e>=90?9:e>=80?8:e>=70?7:e>=60?6:e>=50?5:e>=40?4:e>=30?3:e>=20?2:1}async function vn(e){nt(),e||(e=Ae);const t=e.toLowerCase(),n=se(j,"airdrop_users",t),a=await Ne(n);if(a.exists()){const s=a.data(),r={};if(s.referralCode||(r.referralCode=Gr()),typeof s.approvedSubmissionsCount!="number"&&(r.approvedSubmissionsCount=0),typeof s.rejectedCount!="number"&&(r.rejectedCount=0),typeof s.isBanned!="boolean"&&(r.isBanned=!1),typeof s.totalPoints!="number"&&(r.totalPoints=0),typeof s.pointsMultiplier!="number"&&(r.pointsMultiplier=1),s.walletAddress!==t&&(r.walletAddress=t),Object.keys(r).length>0)try{return await Ba(n,r),{id:a.id,...s,...r}}catch(i){return console.error("Error updating user default fields:",i),{id:a.id,...s}}return{id:a.id,...s}}else{const s=Gr(),r={walletAddress:t,referralCode:s,totalPoints:0,pointsMultiplier:1,approvedSubmissionsCount:0,rejectedCount:0,isBanned:!1,createdAt:bt()};return await Pa(n,r),{id:n.id,...r,createdAt:new Date}}}async function Zi(e,t){if(nt(),!e||typeof e!="string"||e.trim()==="")return console.warn(`isTaskEligible called with invalid taskId: ${e}`),{eligible:!1,timeLeft:0};const n=se(j,"airdrop_users",Ae,"task_claims",e),a=await Ne(n),s=t*60*60*1e3;if(!a.exists())return{eligible:!0,timeLeft:0};const r=a.data(),i=r==null?void 0:r.timestamp;if(typeof i!="string"||i.trim()==="")return console.warn(`Missing/invalid timestamp for task ${e}. Allowing claim.`),{eligible:!0,timeLeft:0};try{const o=new Date(i);if(isNaN(o.getTime()))return console.warn(`Invalid timestamp format for task ${e}:`,i,". Allowing claim."),{eligible:!0,timeLeft:0};const c=o.getTime(),u=Date.now()-c;return u>=s?{eligible:!0,timeLeft:0}:{eligible:!1,timeLeft:s-u}}catch(o){return console.error(`Error parsing timestamp string for task ${e}:`,i,o),{eligible:!0,timeLeft:0}}}async function $u(e,t){if(nt(),!e||!e.id)throw new Error("Invalid task data provided.");if(!(await Zi(e.id,e.cooldownHours)).eligible)throw new Error("Cooldown period is still active for this task.");const a=se(j,"airdrop_users",Ae),s=Math.round(e.points);if(isNaN(s)||s<0)throw new Error("Invalid points value for the task.");await Ba(a,{totalPoints:je(s)});const r=se(j,"airdrop_users",Ae,"task_claims",e.id);return await Pa(r,{timestamp:new Date().toISOString(),points:s}),s}async function Su(e){var o;const t=e.trim().toLowerCase();let n="Other",a=!0;if(t.includes("youtube.com/shorts/")){n="YouTube Shorts";const c=t.match(/\/shorts\/([a-zA-Z0-9_-]+)/);if(!c||!c[1])throw a=!1,new Error("Invalid YouTube Shorts URL: Video ID not found or incorrect format.")}else if(t.includes("youtube.com/watch?v=")||t.includes("youtu.be/")){n="YouTube";const c=t.match(/(?:v=|\/)([a-zA-Z0-9_-]{11})(?:[?&]|$)/);if(!c||c[1].length!==11)throw a=!1,new Error("Invalid YouTube URL: Video ID not found or incorrect format.")}else{if(t.includes("youtube.com/"))throw n="YouTube",a=!1,new Error("Invalid YouTube URL: Only video links (youtube.com/watch?v=... or youtu.be/...) or Shorts links are accepted.");if(t.includes("instagram.com/p/")||t.includes("instagram.com/reel/")){n="Instagram";const c=t.match(/\/(?:p|reel)\/([a-zA-Z0-9_.-]+)/);(!c||!c[1])&&(a=!1)}else t.includes("twitter.com/")||t.includes("x.com/")?t.match(/(\w+)\/(?:status|statuses)\/(\d+)/)&&(n="X/Twitter"):t.includes("facebook.com/")&&t.includes("/posts/")?n="Facebook":t.includes("t.me/")||t.includes("telegram.org/")?n="Telegram":t.includes("tiktok.com/")?n="TikTok":t.includes("reddit.com/r/")?n="Reddit":t.includes("linkedin.com/posts/")&&(n="LinkedIn")}const r=((o=(await Ws()).config)==null?void 0:o.ugcBasePoints)||{},i=r[n]||r.Other||1e3;if(isNaN(i)||i<0)throw new Error(`Invalid base points configured for platform: ${n}. Please contact admin.`);return{platform:n,basePoints:i,isValid:a,normalizedUrl:t}}async function Ru(e){var oe;nt();const t=se(j,"airdrop_users",Ae),n=et(j,"airdrop_users",Ae,"submissions"),a=et(j,"all_submissions_log"),s=e.trim();if(!s||!s.toLowerCase().startsWith("http://")&&!s.toLowerCase().startsWith("https://"))throw new Error("The provided URL must start with http:// or https://.");let r;try{r=await Su(s)}catch(pe){throw pe}const{platform:i,basePoints:o,isValid:c,normalizedUrl:l}=r;if(!c)throw new Error(`The provided URL for ${i} does not appear valid for submission.`);const u=$t(n,rn("submittedAt","desc"),Vd(1)),m=await ft(u);if(!m.empty){const ye=(oe=m.docs[0].data().submittedAt)==null?void 0:oe.toDate();if(ye){const te=new Date,D=5*60*1e3,K=te.getTime()-ye.getTime();if(K<D){const de=D-K,ie=Math.ceil(de/6e4);throw new Error(`We're building a strong community, and we value quality over quantity. To prevent spam, please wait ${ie} more minute(s) before submitting another post. We appreciate your thoughtful contribution!`)}}}const p=$t(a,pa("normalizedUrl","==",l),pa("status","in",["pending","approved","auditing","flagged_suspicious"]));if(!(await ft(p)).empty)throw new Error("This content link has already been submitted. Repeatedly submitting duplicate or fraudulent content may lead to account suspension.");const b=await Ne(t);if(!b.exists())throw new Error("User profile not found.");const x=b.data(),y=x.approvedSubmissionsCount||0,C=ma(y),I=Math.round(o*C),B=bt(),z={url:s,platform:i,status:"pending",basePoints:o,_pointsCalculated:I,_multiplierApplied:C,pointsAwarded:0,submittedAt:B,resolvedAt:null},N={userId:Ae,walletAddress:x.walletAddress,normalizedUrl:l,platform:i,status:"pending",basePoints:o,submittedAt:B,resolvedAt:null},T=Aa(j),F=se(n);T.set(F,z);const Y=se(a,F.id);T.set(Y,N),await T.commit()}async function _u(){nt();const e=et(j,"airdrop_users",Ae,"submissions"),t=$t(e,rn("submittedAt","desc"));return(await ft(t)).docs.map(a=>{var r,i;const s=a.data();return{submissionId:a.id,...s,submittedAt:(r=s.submittedAt)!=null&&r.toDate?s.submittedAt.toDate():null,resolvedAt:(i=s.resolvedAt)!=null&&i.toDate?s.resolvedAt.toDate():null}})}async function Fu(e){nt();const t=Ae,n=se(j,"airdrop_users",t),a=se(j,"airdrop_users",t,"submissions",e),s=se(j,"all_submissions_log",e),r=await Ne(a);if(!r.exists())throw new Error("Cannot confirm submission: Document not found or already processed.");const i=r.data(),o=i.status;if(o==="approved"||o==="rejected")throw new Error(`Submission is already in status: ${o}.`);let c=i._pointsCalculated,l=i._multiplierApplied;if(typeof c!="number"||isNaN(c)||c<=0){console.warn(`[ConfirmSubmission] Legacy/Invalid submission ${e} missing/invalid _pointsCalculated. Recalculating...`);const m=i.basePoints||0,p=await Ne(n);if(!p.exists())throw new Error("User profile not found for recalculation.");const b=p.data().approvedSubmissionsCount||0;l=ma(b),c=Math.round(m*l),(isNaN(c)||c<=0)&&(console.warn(`[ConfirmSubmission] Recalculation failed (basePoints: ${m}). Using fallback 1000.`),c=Math.round(1e3*l))}const u=Aa(j);u.update(n,{totalPoints:je(c),approvedSubmissionsCount:je(1)}),u.update(a,{status:"approved",pointsAwarded:c,_pointsCalculated:c,_multiplierApplied:l,resolvedAt:bt()}),await Ne(s).then(m=>m.exists())&&u.update(s,{status:"approved",resolvedAt:bt()}),await u.commit()}async function Qi(e){nt();const n=se(j,"airdrop_users",Ae,"submissions",e),a=se(j,"all_submissions_log",e),s=await Ne(n);if(!s.exists())return console.warn(`Delete submission skipped: Document ${e} not found.`);const r=s.data().status;if(r==="approved"||r==="rejected")throw new Error(`This submission was already ${r} and cannot be deleted.`);if(r==="flagged_suspicious")throw new Error("Flagged submissions must be resolved, not deleted.");const i=Aa(j);i.update(n,{status:"deleted_by_user",resolvedAt:bt()}),await Ne(a).then(o=>o.exists())&&i.update(a,{status:"deleted_by_user",resolvedAt:bt(),pointsAwarded:0}),await i.commit()}async function Mu(e){const t=se(j,"airdrop_public_data","data_v1");await Pa(t,{config:{ugcBasePoints:e}},{merge:!0})}async function Du(){const e=et(j,"daily_tasks"),t=$t(e,rn("endDate","asc"));return(await ft(t)).docs.map(a=>{var s,r;return{id:a.id,...a.data(),startDate:(s=a.data().startDate)!=null&&s.toDate?a.data().startDate.toDate():null,endDate:(r=a.data().endDate)!=null&&r.toDate?a.data().endDate.toDate():null}})}async function Ou(e){const t={...e};t.startDate instanceof Date&&(t.startDate=Rr.fromDate(t.startDate)),t.endDate instanceof Date&&(t.endDate=Rr.fromDate(t.endDate));const n=e.id;if(!n)delete t.id,await qd(et(j,"daily_tasks"),t);else{const a=se(j,"daily_tasks",n);delete t.id,await Pa(a,t,{merge:!0})}}async function Uu(e){if(!e)throw new Error("Task ID is required for deletion.");await Xd(se(j,"daily_tasks",e))}async function Hu(){const e=et(j,"all_submissions_log"),t=$t(e,pa("status","in",["pending","auditing","flagged_suspicious"]),rn("submittedAt","desc"));return(await ft(t)).docs.map(a=>{var r,i;const s=a.data();return{userId:s.userId,walletAddress:s.walletAddress,submissionId:a.id,...s,submittedAt:(r=s.submittedAt)!=null&&r.toDate?s.submittedAt.toDate():null,resolvedAt:(i=s.resolvedAt)!=null&&i.toDate?s.resolvedAt.toDate():null}})}async function eo(e,t,n){var C,I,B;if(!e)throw new Error("User ID (walletAddress) is required.");const a=e.toLowerCase(),s=se(j,"airdrop_users",a),r=se(j,"airdrop_users",a,"submissions",t),i=se(j,"all_submissions_log",t),[o,c,l]=await Promise.all([Ne(s),Ne(r),Ne(i)]);if(!c.exists())throw new Error("Submission not found in user collection.");if(!o.exists())throw new Error("User profile not found.");l.exists()||console.warn(`Log entry ${t} not found. Log will not be updated.`);const u=c.data(),m=o.data(),p=u.status;if(p===n){console.warn(`Admin action ignored: Submission ${t} already has status ${n}.`);return}const f=Aa(j),b={};let x=0,y=u._multiplierApplied||0;if(n==="approved"){let z=u._pointsCalculated;if(typeof z!="number"||isNaN(z)||z<=0){console.warn(`[Admin] Legacy/Invalid submission ${t} missing/invalid _pointsCalculated. Recalculating...`);const N=u.basePoints||0,T=m.approvedSubmissionsCount||0,F=ma(T);if(z=Math.round(N*F),isNaN(z)||z<=0){console.warn(`[Admin] Recalculation failed (basePoints: ${N}). Using fallback 1000.`);const Y=ma(T);z=Math.round(1e3*Y)}y=F}x=z,b.totalPoints=je(z),b.approvedSubmissionsCount=je(1),p==="rejected"&&(b.rejectedCount=je(-1))}else if(n==="rejected"){if(p!=="rejected"){const z=m.rejectedCount||0;b.rejectedCount=je(1),z+1>=3&&(b.isBanned=!0)}else if(p==="approved"){const z=u.pointsAwarded||0;b.totalPoints=je(-z),b.approvedSubmissionsCount=je(-1);const N=m.rejectedCount||0;b.rejectedCount=je(1),N+1>=3&&(b.isBanned=!0)}x=0}if(((C=b.approvedSubmissionsCount)==null?void 0:C.operand)<0&&(m.approvedSubmissionsCount||0)<=0&&(b.approvedSubmissionsCount=0),((I=b.rejectedCount)==null?void 0:I.operand)<0&&(m.rejectedCount||0)<=0&&(b.rejectedCount=0),((B=b.totalPoints)==null?void 0:B.operand)<0){const z=m.totalPoints||0,N=Math.abs(b.totalPoints.operand);z<N&&(b.totalPoints=0)}Object.keys(b).length>0&&f.update(s,b),f.update(r,{status:n,pointsAwarded:x,_pointsCalculated:n==="approved"?x:u._pointsCalculated||0,_multiplierApplied:y,resolvedAt:bt()}),l.exists()&&f.update(i,{status:n,resolvedAt:bt()}),await f.commit()}async function ju(){const e=et(j,"airdrop_users"),t=$t(e,rn("totalPoints","desc"));return(await ft(t)).docs.map(a=>({id:a.id,...a.data()}))}async function Wu(e,t){if(!e)throw new Error("User ID is required.");const n=e.toLowerCase(),a=et(j,"airdrop_users",n,"submissions"),s=$t(a,pa("status","==",t),rn("resolvedAt","desc"));return(await ft(s)).docs.map(i=>{var o,c;return{submissionId:i.id,userId:n,...i.data(),submittedAt:(o=i.data().submittedAt)!=null&&o.toDate?i.data().submittedAt.toDate():null,resolvedAt:(c=i.data().resolvedAt)!=null&&c.toDate?i.data().resolvedAt.toDate():null}})}async function to(e,t){if(!e)throw new Error("User ID is required.");const n=e.toLowerCase(),a=se(j,"airdrop_users",n),s={isBanned:t};t===!1&&(s.rejectedCount=0),await Ba(a,s)}async function Kr(){nt();try{const e=et(j,"airdrop_users",Ae,"platform_usage"),t=await ft(e),n={};return t.forEach(a=>{n[a.id]=a.data()}),n}catch(e){return console.error("Error fetching platform usage:",e),{}}}async function no(e){nt();const t=se(j,"airdrop_public_data","data_v1");await Ba(t,{platformUsageConfig:e}),console.log("✅ Platform usage config saved:",e)}const G=window.ethers,ao=421614,Gu="0x66eee";let _e=null,Yr=0,ct=0;const Ku=5e3,Vr=3,Yu=1e4;let Gs=0;const Vu=3;let so=null;const qu="cd4bdedee7a7e909ebd3df8bbc502aed",Xu={chainId:Ce.chainIdDecimal,name:Ce.chainName,currency:Ce.nativeCurrency.symbol,explorerUrl:Ce.blockExplorerUrls[0],rpcUrl:Ce.rpcUrls[0]},Ju={name:"Backcoin Protocol",description:"DeFi Ecosystem",url:window.location.origin,icons:[window.location.origin+"/assets/bkc_logo_3d.png"]},Zu=Ud({metadata:Ju,enableEIP6963:!0,enableInjected:!0,enableCoinbase:!1,rpcUrl:Ui,defaultChainId:ao,enableEmail:!0,enableEns:!1,auth:{email:!0,showWallets:!0,walletFeatures:!0}}),Tt=Hd({ethersConfig:Zu,chains:[Xu],projectId:qu,enableAnalytics:!0,themeMode:"dark",themeVariables:{"--w3m-accent":"#f59e0b","--w3m-border-radius-master":"1px","--w3m-z-index":100}});function Qu(e){var a,s;const t=((a=e==null?void 0:e.message)==null?void 0:a.toLowerCase())||"",n=(e==null?void 0:e.code)||((s=e==null?void 0:e.error)==null?void 0:s.code);return n===-32603||n===-32e3||n===429||t.includes("failed to fetch")||t.includes("network error")||t.includes("timeout")||t.includes("rate limit")||t.includes("too many requests")||t.includes("internal json-rpc")||t.includes("unexpected token")||t.includes("<html")}function gs(e){return new G.JsonRpcProvider(e||Nn())}async function ro(e,t=Vu){var a;let n=null;for(let s=0;s<t;s++)try{const r=await e();return su(Nn()),Gs=0,r}catch(r){if(n=r,Qu(r)){console.warn(`⚠️ RPC error (attempt ${s+1}/${t}):`,(a=r.message)==null?void 0:a.slice(0,80)),au(Nn());const i=Hi();console.log(`🔄 Switching to: ${i}`),await $n(),await new Promise(o=>setTimeout(o,500*(s+1)))}else throw r}throw console.error("❌ All RPC attempts failed"),n}async function $n(){const e=Nn();try{d.publicProvider=gs(e),so=d.publicProvider,Q(w.bkcToken)&&(d.bkcTokenContractPublic=new G.Contract(w.bkcToken,Fs,d.publicProvider)),Q(w.delegationManager)&&(d.delegationManagerContractPublic=new G.Contract(w.delegationManager,Ms,d.publicProvider)),Q(w.faucet)&&(d.faucetContractPublic=new G.Contract(w.faucet,Us,d.publicProvider)),Q(w.rentalManager)&&(d.rentalManagerContractPublic=new G.Contract(w.rentalManager,Un,d.publicProvider)),Q(w.ecosystemManager)&&(d.ecosystemManagerContractPublic=new G.Contract(w.ecosystemManager,Hs,d.publicProvider)),Q(w.actionsManager)&&(d.actionsManagerContractPublic=new G.Contract(w.actionsManager,Ds,d.publicProvider));const t=w.fortunePoolV2||w.fortunePool;Q(t)&&(d.fortunePoolContractPublic=new G.Contract(t,Os,d.publicProvider)),console.log(`✅ Public provider recreated with: ${e.slice(0,50)}...`)}catch(t){console.error("Failed to recreate public provider:",t)}}function ep(e){if(!e)return!1;try{return G.isAddress(e)}catch{return!1}}function Q(e){return e&&e!==G.ZeroAddress&&!e.startsWith("0x...")}function tp(e){if(!e)return;const t=localStorage.getItem(`balance_${e.toLowerCase()}`);if(t)try{d.currentUserBalance=BigInt(t),window.updateUIState&&window.updateUIState()}catch{}}function np(e){try{Q(w.bkcToken)&&(d.bkcTokenContract=new G.Contract(w.bkcToken,Fs,e)),Q(w.delegationManager)&&(d.delegationManagerContract=new G.Contract(w.delegationManager,Ms,e)),Q(w.rewardBoosterNFT)&&(d.rewardBoosterContract=new G.Contract(w.rewardBoosterNFT,du,e)),Q(w.publicSale)&&(d.publicSaleContract=new G.Contract(w.publicSale,uu,e)),Q(w.faucet)&&(d.faucetContract=new G.Contract(w.faucet,Us,e)),Q(w.rentalManager)&&(d.rentalManagerContract=new G.Contract(w.rentalManager,Un,e)),Q(w.actionsManager)&&(d.actionsManagerContract=new G.Contract(w.actionsManager,Ds,e)),Q(w.decentralizedNotary)&&(d.decentralizedNotaryContract=new G.Contract(w.decentralizedNotary,pu,e)),Q(w.ecosystemManager)&&(d.ecosystemManagerContract=new G.Contract(w.ecosystemManager,Hs,e));const t=w.fortunePoolV2||w.fortunePool;Q(t)&&(d.fortunePoolContract=new G.Contract(t,Os,e))}catch{console.warn("Contract init partial failure")}}function io(){if(_e&&(clearInterval(_e),_e=null),!d.bkcTokenContractPublic||!d.userAddress){console.warn("Cannot start balance polling: missing contract or address");return}ct=0,Gs=0,setTimeout(()=>{qr()},1e3),_e=setInterval(qr,Yu),console.log("✅ Balance polling started (10s interval)")}async function qr(){var t;if(document.hidden||!d.isConnected||!d.userAddress||!d.bkcTokenContractPublic)return;const e=Date.now();try{const n=await ro(async()=>await d.bkcTokenContractPublic.balanceOf(d.userAddress),2);ct=0;const a=d.currentUserBalance||0n;n.toString()!==a.toString()&&(d.currentUserBalance=n,localStorage.setItem(`balance_${d.userAddress.toLowerCase()}`,n.toString()),e-Yr>Ku&&(Yr=e,window.updateUIState&&window.updateUIState(!1)))}catch(n){ct++,ct<=3&&console.warn(`⚠️ Balance check failed (${ct}/${Vr}):`,(t=n.message)==null?void 0:t.slice(0,50)),ct>=Vr&&(console.warn("❌ Too many balance check errors. Stopping polling temporarily."),_e&&(clearInterval(_e),_e=null),setTimeout(()=>{console.log("🔄 Attempting to restart balance polling with primary RPC..."),ru(),$n().then(()=>{ct=0,io()})},6e4))}}async function ap(e){try{const t=await e.getNetwork();if(Number(t.chainId)===ao)return!0;try{return await e.send("wallet_switchEthereumChain",[{chainId:Gu}]),!0}catch{return!0}}catch{return!0}}async function Xr(e,t){try{if(!ep(t))return!1;await ap(e),d.provider=e;try{d.signer=await e.getSigner()}catch(n){d.signer=e,console.warn(`Could not get standard Signer. Using Provider as read-only. Warning: ${n.message}`)}d.userAddress=t,d.isConnected=!0,tp(t),np(d.signer);try{Ji(d.userAddress)}catch{}return Mt().then(()=>{window.updateUIState&&window.updateUIState(!1)}).catch(()=>{}),io(),!0}catch(n){return console.error("Setup warning:",n),!!t}}async function sp(){try{if(window.ethereum){const n=await gu();n.fixed?console.log("✅ MetaMask network config was auto-fixed"):!n.success&&!n.skipped&&console.warn("Initial network config check:",n.error)}const e=Nn();console.log(`🌐 Initializing public provider with: ${e.slice(0,50)}...`),d.publicProvider=gs(e),so=d.publicProvider,Q(w.bkcToken)&&(d.bkcTokenContractPublic=new G.Contract(w.bkcToken,Fs,d.publicProvider)),Q(w.delegationManager)&&(d.delegationManagerContractPublic=new G.Contract(w.delegationManager,Ms,d.publicProvider)),Q(w.faucet)&&(d.faucetContractPublic=new G.Contract(w.faucet,Us,d.publicProvider)),Q(w.rentalManager)&&(d.rentalManagerContractPublic=new G.Contract(w.rentalManager,Un,d.publicProvider)),Q(w.ecosystemManager)&&(d.ecosystemManagerContractPublic=new G.Contract(w.ecosystemManager,Hs,d.publicProvider)),Q(w.actionsManager)&&(d.actionsManagerContractPublic=new G.Contract(w.actionsManager,Ds,d.publicProvider));const t=w.fortunePoolV2||w.fortunePool;Q(t)&&(d.fortunePoolContractPublic=new G.Contract(t,Os,d.publicProvider),console.log("✅ FortunePool V2 contract initialized:",t));try{await ro(async()=>{await js()})}catch{console.warn("Initial public data load failed, will retry on user interaction")}xu(async n=>{n.isCorrectNetwork?(await Ln()).healthy||(console.log("⚠️ RPC issues after network change, updating..."),await Jt(),await $n()):(console.log("⚠️ User switched to wrong network"),h("Please switch back to Arbitrum Sepolia","warning"))}),op(),window.updateUIState&&window.updateUIState(),console.log("✅ Public provider initialized")}catch(e){console.error("Public provider error:",e),window.ethereum&&await Jt();const t=Hi();console.log(`🔄 Retrying with: ${t}`);try{d.publicProvider=gs(t),console.log("✅ Public provider initialized with fallback RPC")}catch{console.error("❌ All RPC endpoints failed")}}}function rp(e){let t=Tt.getAddress();if(Tt.getIsConnected()&&t){const a=Tt.getWalletProvider();if(a){const s=new G.BrowserProvider(a);d.web3Provider=a,e({isConnected:!0,address:t,isNewConnection:!1}),Xr(s,t)}}const n=async({provider:a,address:s,chainId:r,isConnected:i})=>{try{if(i){let o=s||Tt.getAddress();if(!o&&a)try{o=await(await new G.BrowserProvider(a).getSigner()).getAddress()}catch{}if(o){const c=new G.BrowserProvider(a);d.web3Provider=a,e({isConnected:!0,address:o,chainId:r,isNewConnection:!0}),await Xr(c,o)}else _e&&clearInterval(_e),d.isConnected=!1,d.userAddress=null,d.signer=null,e({isConnected:!1})}else _e&&clearInterval(_e),d.isConnected=!1,d.userAddress=null,d.signer=null,e({isConnected:!1})}catch{}};Tt.subscribeProvider(n)}function oo(){Tt.open()}async function ip(){await Tt.disconnect()}let Ja=null;function op(){Ja&&clearInterval(Ja),Ja=setInterval(async()=>{if(document.hidden||!d.isConnected)return;const e=await Ln();e.healthy||(console.log(`⚠️ RPC health check failed (${e.reason}), attempting fix...`),await Jt()&&(console.log("✅ MetaMask RPCs updated via health monitor"),await $n(),ct=0,Gs=0))},3e4),document.addEventListener("visibilitychange",async()=>{!document.hidden&&d.isConnected&&((await Ln()).healthy||(console.log("⚠️ RPC unhealthy on tab focus, fixing..."),await Jt(),await $n()))}),console.log("✅ RPC health monitoring started (30s interval)")}const cp=window.ethers,_=(e,t=18)=>{if(e===null||typeof e>"u")return 0;if(typeof e=="number")return e;if(typeof e=="string")return parseFloat(e);try{const n=BigInt(e);return parseFloat(cp.formatUnits(n,t))}catch{return 0}},cn=e=>!e||typeof e!="string"||!e.startsWith("0x")?"...":`${e.substring(0,6)}...${e.substring(e.length-4)}`,Qt=e=>{try{if(e==null)return"0";const t=typeof e=="bigint"?e:BigInt(e);if(t<1000n)return t.toString();const n=Number(t);if(!isFinite(n))return t.toLocaleString("en-US");const a=["","k","M","B","T"],s=Math.floor((""+Math.floor(n)).length/3);let r=parseFloat((s!==0?n/Math.pow(1e3,s):n).toPrecision(3));return r%1!==0&&(r=r.toFixed(2)),r+a[s]}catch{return"0"}},lp=(e="Loading...")=>`<div class="flex items-center justify-center p-4 text-zinc-400"><div class="loader inline-block mr-2"></div> ${e}</div>`,dp=(e="An error occurred.")=>`<div class="bg-red-900/20 border border-red-500/30 rounded-lg p-4 text-center text-red-400 text-sm">${e}</div>`,up=(e="No data available.")=>`<div class="text-center p-8 bg-zinc-900/30 border border-dashed border-zinc-800 rounded-lg col-span-full">
                <i class="fa-regular fa-folder-open text-2xl text-zinc-600 mb-2"></i>
                <p class="text-zinc-500 italic text-sm">${e}</p>
            </div>`;function Ks(e,t,n,a){if(!e)return;if(n<=1){e.innerHTML="";return}const s=`
    ...
    `;e.innerHTML=s,e.querySelectorAll(".pagination-btn").forEach(r=>{r.addEventListener("click",()=>{r.hasAttribute("disabled")||a(parseInt(r.dataset.page))})})}const pp="modulepreload",mp=function(e){return"/"+e},Jr={},W=function(t,n,a){let s=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),o=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));s=Promise.allSettled(n.map(c=>{if(c=mp(c),c in Jr)return;Jr[c]=!0;const l=c.endsWith(".css"),u=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${u}`))return;const m=document.createElement("link");if(m.rel=l?"stylesheet":pp,l||(m.as="script"),m.crossOrigin="",m.href=c,o&&m.setAttribute("nonce",o),document.head.appendChild(m),l)return new Promise((p,f)=>{m.addEventListener("load",p),m.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(i){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=i,window.dispatchEvent(o),!o.defaultPrevented)throw i}return s.then(i=>{for(const o of i||[])o.status==="rejected"&&r(o.reason);return t().catch(r)})},co="https://faucet-4wvdcuoouq-uc.a.run.app";function La(){var e;return(w==null?void 0:w.faucet)||($==null?void 0:$.faucet)||((e=window.contractAddresses)==null?void 0:e.faucet)||null}const fa=["function claim() external","function canClaim(address user) view returns (bool)","function lastClaimTime(address user) view returns (uint256)","function claimCooldown() view returns (uint256)","function claimAmountBKC() view returns (uint256)","function claimAmountETH() view returns (uint256)","event TokensClaimed(address indexed user, uint256 bkcAmount, uint256 ethAmount)"];function fp(){var e,t;return typeof State<"u"&&(State!=null&&State.userAddress)?State.userAddress:(e=window.State)!=null&&e.userAddress?window.State.userAddress:window.userAddress?window.userAddress:(t=window.ethereum)!=null&&t.selectedAddress?window.ethereum.selectedAddress:null}function Bt(e,t="info"){if(typeof window.showToast=="function"){window.showToast(e,t);return}(t==="error"?console.error:console.log)(`[Faucet] ${e}`)}async function lo(){if(typeof window.loadUserData=="function"){await window.loadUserData();return}if(typeof window.refreshBalances=="function"){await window.refreshBalances();return}console.log("[Faucet] No refresh function available")}async function Ys({button:e=null,address:t=null,onSuccess:n=null,onError:a=null}={}){const s=t||fp();if(!s){const o="Please connect wallet first";return Bt(o,"error"),a&&a(new Error(o)),{success:!1,error:o}}const r=(e==null?void 0:e.innerHTML)||"Claim",i=(e==null?void 0:e.disabled)||!1;e&&(e.innerHTML='<div class="loader inline-block"></div> Claiming...',e.disabled=!0);try{const o=await fetch(`${co}?address=${s}`,{method:"GET",headers:{Accept:"application/json"}}),c=await o.json();if(o.ok&&c.success){Bt("✅ Tokens received!","success"),await lo();const l={success:!0,txHash:c.txHash,bkcAmount:c.bkcAmount,ethAmount:c.ethAmount};return n&&n(l),l}else{const l=c.error||c.message||"Faucet unavailable";Bt(l,"error");const u=new Error(l);return a&&a(u),{success:!1,error:l}}}catch(o){return console.error("Faucet error:",o),Bt("Faucet unavailable","error"),a&&a(o),{success:!1,error:o.message}}finally{e&&(e.innerHTML=r,e.disabled=i)}}const Vs=async e=>await Ys({button:e});async function uo({button:e=null,onSuccess:t=null,onError:n=null}={}){const a=La();if(!a){const r="Faucet contract address not configured";return Bt(r,"error"),n&&n(new Error(r)),{success:!1,error:r}}const{txEngine:s}=await W(async()=>{const{txEngine:r}=await import("./index-DZsKjxq8.js");return{txEngine:r}},[]);return await s.execute({name:"FaucetClaim",button:e,getContract:async r=>{const i=window.ethers;return new i.Contract(a,fa,r)},method:"claim",args:[],validate:async(r,i)=>{const o=window.ethers,c=new o.Contract(a,fa,r);if(!await c.canClaim(i)){const u=await c.lastClaimTime(i),m=await c.claimCooldown(),p=Number(u)+Number(m),f=Math.floor(Date.now()/1e3);if(p>f){const b=Math.ceil((p-f)/60);throw new Error(`Please wait ${b} minutes before claiming again`)}}},onSuccess:async r=>{Bt("✅ Tokens received!","success"),await lo(),t&&t(r)},onError:r=>{Bt(r.message||"Claim failed","error"),n&&n(r)}})}async function po(e){const t=La();if(!t)return{canClaim:!1,error:"Faucet not configured"};try{const n=window.ethers,{NetworkManager:a}=await W(async()=>{const{NetworkManager:m}=await import("./index-DZsKjxq8.js");return{NetworkManager:m}},[]),s=a.getProvider(),r=new n.Contract(t,fa,s),[i,o,c]=await Promise.all([r.canClaim(e),r.lastClaimTime(e),r.claimCooldown()]),l=Number(o)+Number(c),u=Math.floor(Date.now()/1e3);return{canClaim:i,lastClaimTime:Number(o),cooldownSeconds:Number(c),nextClaimTime:l,waitSeconds:i?0:Math.max(0,l-u)}}catch(n){return console.error("Error checking claim status:",n),{canClaim:!1,error:n.message}}}async function mo(){const e=La();if(!e)return{error:"Faucet not configured"};try{const t=window.ethers,{NetworkManager:n}=await W(async()=>{const{NetworkManager:c}=await import("./index-DZsKjxq8.js");return{NetworkManager:c}},[]),a=n.getProvider(),s=new t.Contract(e,fa,a),[r,i,o]=await Promise.all([s.claimAmountBKC(),s.claimAmountETH(),s.claimCooldown()]);return{bkcAmount:r,ethAmount:i,cooldownSeconds:Number(o),cooldownMinutes:Number(o)/60,bkcAmountFormatted:t.formatEther(r),ethAmountFormatted:t.formatEther(i)}}catch(t){return console.error("Error getting faucet info:",t),{error:t.message}}}const bp={claim:Ys,claimOnChain:uo,executeFaucetClaim:Vs,canClaim:po,getFaucetInfo:mo,getFaucetAddress:La,FAUCET_API_URL:co},gp=Object.freeze(Object.defineProperty({__proto__:null,FaucetTx:bp,canClaim:po,claim:Ys,claimOnChain:uo,executeFaucetClaim:Vs,getFaucetInfo:mo},Symbol.toStringTag,{value:"Module"})),Za={BALANCE:1e4,ALLOWANCE:3e4},ke=new Map,ce={hits:0,misses:0,sets:0,invalidations:0},Nt={get(e){const t=ke.get(e);if(!t){ce.misses++;return}if(Date.now()>t.expiresAt){ke.delete(e),ce.misses++;return}return ce.hits++,t.value},set(e,t,n){t!=null&&(ke.set(e,{value:t,expiresAt:Date.now()+n,createdAt:Date.now()}),ce.sets++)},delete(e){ke.delete(e)},clear(e){if(!e){ke.clear(),ce.invalidations++;return}for(const t of ke.keys())t.includes(e)&&ke.delete(t);ce.invalidations++},async getOrFetch(e,t,n){const a=this.get(e);if(a!==void 0)return a;try{const s=await t();return s!=null&&this.set(e,s,n),s}catch(s){throw console.warn(`[Cache] Error fetching ${e}:`,s.message),s}},has(e){return this.get(e)!==void 0},getTTL(e){const t=ke.get(e);if(!t)return 0;const n=t.expiresAt-Date.now();return n>0?n:0},invalidateByTx(e){const n={CreateCampaign:["campaign-","charity-stats","user-campaigns-","campaign-list"],Donate:["campaign-","charity-stats","token-balance-","allowance-"],CancelCampaign:["campaign-","charity-stats","user-campaigns-"],Withdraw:["campaign-","charity-stats","token-balance-"],Delegate:["delegation-","token-balance-","allowance-","user-pstake-","pending-rewards-","network-pstake"],Unstake:["delegation-","token-balance-","user-pstake-","pending-rewards-","network-pstake"],ForceUnstake:["delegation-","token-balance-","user-pstake-","pending-rewards-","network-pstake"],ClaimReward:["pending-rewards-","token-balance-","saved-rewards-"],BuyNFT:["pool-info-","pool-nfts-","token-balance-","allowance-","user-nfts-","buy-price-","sell-price-"],SellNFT:["pool-info-","pool-nfts-","token-balance-","user-nfts-","buy-price-","sell-price-"],PlayGame:["fortune-pool-","fortune-stats-","token-balance-","allowance-","user-fortune-history-"],ListNFT:["rental-listings-","rental-listing-","user-nfts-"],RentNFT:["rental-listing-","rental-active-","token-balance-","allowance-"],WithdrawNFT:["rental-listing-","rental-listings-","user-nfts-"],UpdateListing:["rental-listing-"],Notarize:["notary-","token-balance-","allowance-","user-documents-"],TokenTransfer:["token-balance-","allowance-"],Approval:["allowance-"]}[e];if(!n){console.warn(`[Cache] Unknown transaction type: ${e}`);return}n.forEach(a=>{this.clear(a)}),console.log(`[Cache] Invalidated patterns for ${e}:`,n)},getStats(){const e=ke.size,t=ce.hits+ce.misses>0?(ce.hits/(ce.hits+ce.misses)*100).toFixed(1):0;return{entries:e,hits:ce.hits,misses:ce.misses,sets:ce.sets,invalidations:ce.invalidations,hitRate:`${t}%`}},keys(){return Array.from(ke.keys())},size(){return ke.size},cleanup(){const e=Date.now();let t=0;for(const[n,a]of ke.entries())e>a.expiresAt&&(ke.delete(n),t++);return t>0&&console.log(`[Cache] Cleanup removed ${t} expired entries`),t},resetMetrics(){ce.hits=0,ce.misses=0,ce.sets=0,ce.invalidations=0}},Qa={tokenBalance:(e,t)=>`token-balance-${e.toLowerCase()}-${t.toLowerCase()}`,ethBalance:e=>`eth-balance-${e.toLowerCase()}`,allowance:(e,t,n)=>`allowance-${e.toLowerCase()}-${t.toLowerCase()}-${n.toLowerCase()}`,campaign:e=>`campaign-${e}`,campaignList:()=>"campaign-list",charityStats:()=>"charity-stats",userCampaigns:e=>`user-campaigns-${e.toLowerCase()}`,delegation:(e,t)=>`delegation-${e.toLowerCase()}-${t}`,delegations:e=>`delegation-list-${e.toLowerCase()}`,userPStake:e=>`user-pstake-${e.toLowerCase()}`,pendingRewards:e=>`pending-rewards-${e.toLowerCase()}`,networkPStake:()=>"network-pstake",poolInfo:e=>`pool-info-${e.toLowerCase()}`,poolNfts:e=>`pool-nfts-${e.toLowerCase()}`,buyPrice:e=>`buy-price-${e.toLowerCase()}`,sellPrice:e=>`sell-price-${e.toLowerCase()}`,userNfts:e=>`user-nfts-${e.toLowerCase()}`,fortunePool:()=>"fortune-pool",fortuneTiers:()=>"fortune-tiers",fortuneStats:()=>"fortune-stats",userFortuneHistory:e=>`user-fortune-history-${e.toLowerCase()}`,rentalListings:()=>"rental-listings",rentalListing:e=>`rental-listing-${e}`,rentalActive:e=>`rental-active-${e}`,notaryDocument:e=>`notary-doc-${e}`,userDocuments:e=>`user-documents-${e.toLowerCase()}`,feeConfig:e=>`fee-config-${e}`,protocolConfig:()=>"protocol-config"},v={WRONG_NETWORK:"wrong_network",RPC_UNHEALTHY:"rpc_unhealthy",RPC_RATE_LIMITED:"rpc_rate_limited",NETWORK_ERROR:"network_error",WALLET_NOT_CONNECTED:"wallet_not_connected",WALLET_LOCKED:"wallet_locked",INSUFFICIENT_ETH:"insufficient_eth",INSUFFICIENT_TOKEN:"insufficient_token",INSUFFICIENT_ALLOWANCE:"insufficient_allowance",SIMULATION_REVERTED:"simulation_reverted",GAS_ESTIMATION_FAILED:"gas_estimation_failed",USER_REJECTED:"user_rejected",TX_REVERTED:"tx_reverted",TX_TIMEOUT:"tx_timeout",TX_REPLACED:"tx_replaced",TX_UNDERPRICED:"tx_underpriced",NONCE_ERROR:"nonce_error",CAMPAIGN_NOT_FOUND:"campaign_not_found",CAMPAIGN_NOT_ACTIVE:"campaign_not_active",CAMPAIGN_STILL_ACTIVE:"campaign_still_active",NOT_CAMPAIGN_CREATOR:"not_campaign_creator",DONATION_TOO_SMALL:"donation_too_small",MAX_CAMPAIGNS_REACHED:"max_campaigns_reached",INSUFFICIENT_ETH_FEE:"insufficient_eth_fee",LOCK_PERIOD_ACTIVE:"lock_period_active",LOCK_PERIOD_EXPIRED:"lock_period_expired",NO_REWARDS:"no_rewards",INVALID_DURATION:"invalid_duration",INVALID_DELEGATION_INDEX:"invalid_delegation_index",NFT_NOT_IN_POOL:"nft_not_in_pool",POOL_NOT_INITIALIZED:"pool_not_initialized",INSUFFICIENT_POOL_LIQUIDITY:"insufficient_pool_liquidity",SLIPPAGE_EXCEEDED:"slippage_exceeded",NFT_BOOST_MISMATCH:"nft_boost_mismatch",NOT_NFT_OWNER:"not_nft_owner",NO_ACTIVE_TIERS:"no_active_tiers",INVALID_GUESS_COUNT:"invalid_guess_count",INVALID_GUESS_RANGE:"invalid_guess_range",INSUFFICIENT_SERVICE_FEE:"insufficient_service_fee",RENTAL_STILL_ACTIVE:"rental_still_active",NFT_NOT_LISTED:"nft_not_listed",NFT_ALREADY_LISTED:"nft_already_listed",NOT_LISTING_OWNER:"not_listing_owner",MARKETPLACE_PAUSED:"marketplace_paused",EMPTY_METADATA:"empty_metadata",CONTRACT_ERROR:"contract_error",UNKNOWN:"unknown"},es={[v.WRONG_NETWORK]:"Please switch to Arbitrum Sepolia network",[v.RPC_UNHEALTHY]:"Network connection issue. Retrying...",[v.RPC_RATE_LIMITED]:"Network is busy. Please wait a moment...",[v.NETWORK_ERROR]:"Network error. Please check your connection",[v.WALLET_NOT_CONNECTED]:"Please connect your wallet",[v.WALLET_LOCKED]:"Please unlock your wallet",[v.INSUFFICIENT_ETH]:"Insufficient ETH for gas fees",[v.INSUFFICIENT_TOKEN]:"Insufficient BKC balance",[v.INSUFFICIENT_ALLOWANCE]:"Token approval required",[v.SIMULATION_REVERTED]:"Transaction would fail. Please check your inputs",[v.GAS_ESTIMATION_FAILED]:"Could not estimate gas. Transaction may fail",[v.USER_REJECTED]:"Transaction cancelled",[v.TX_REVERTED]:"Transaction failed on blockchain",[v.TX_TIMEOUT]:"Transaction is taking too long. Please check your wallet",[v.TX_REPLACED]:"Transaction was replaced",[v.TX_UNDERPRICED]:"Gas price too low. Please try again",[v.NONCE_ERROR]:"Transaction sequence error. Please refresh and try again",[v.CAMPAIGN_NOT_FOUND]:"Campaign not found",[v.CAMPAIGN_NOT_ACTIVE]:"This campaign is no longer accepting donations",[v.CAMPAIGN_STILL_ACTIVE]:"Campaign is still active. Please wait until the deadline",[v.NOT_CAMPAIGN_CREATOR]:"Only the campaign creator can perform this action",[v.DONATION_TOO_SMALL]:"Donation amount is below the minimum required",[v.MAX_CAMPAIGNS_REACHED]:"You have reached the maximum number of active campaigns",[v.INSUFFICIENT_ETH_FEE]:"Insufficient ETH for withdrawal fee",[v.LOCK_PERIOD_ACTIVE]:"Your tokens are still locked",[v.LOCK_PERIOD_EXPIRED]:"Lock period has expired. Use normal unstake",[v.NO_REWARDS]:"No rewards available to claim",[v.INVALID_DURATION]:"Lock duration must be between 1 day and 10 years",[v.INVALID_DELEGATION_INDEX]:"Delegation not found",[v.NFT_NOT_IN_POOL]:"This NFT is not available in the pool",[v.POOL_NOT_INITIALIZED]:"Pool is not active yet",[v.INSUFFICIENT_POOL_LIQUIDITY]:"Insufficient liquidity in pool",[v.SLIPPAGE_EXCEEDED]:"Price changed too much. Please try again",[v.NFT_BOOST_MISMATCH]:"NFT tier does not match this pool",[v.NOT_NFT_OWNER]:"You do not own this NFT",[v.NO_ACTIVE_TIERS]:"No active prize tiers available",[v.INVALID_GUESS_COUNT]:"Invalid number of guesses provided",[v.INVALID_GUESS_RANGE]:"Your guess is outside the valid range",[v.INSUFFICIENT_SERVICE_FEE]:"Incorrect service fee amount",[v.RENTAL_STILL_ACTIVE]:"This NFT is currently being rented",[v.NFT_NOT_LISTED]:"This NFT is not listed for rent",[v.NFT_ALREADY_LISTED]:"This NFT is already listed",[v.NOT_LISTING_OWNER]:"Only the listing owner can perform this action",[v.MARKETPLACE_PAUSED]:"Marketplace is temporarily paused",[v.EMPTY_METADATA]:"Document metadata cannot be empty",[v.CONTRACT_ERROR]:"Transaction cannot be completed. Please check your inputs and try again",[v.UNKNOWN]:"An unexpected error occurred. Please try again"},yt={[v.WRONG_NETWORK]:{layer:1,retry:!1,action:"switch_network"},[v.RPC_UNHEALTHY]:{layer:1,retry:!0,waitMs:2e3,action:"switch_rpc"},[v.RPC_RATE_LIMITED]:{layer:1,retry:!0,waitMs:"extract",action:"switch_rpc"},[v.NETWORK_ERROR]:{layer:1,retry:!0,waitMs:3e3,action:"switch_rpc"},[v.WALLET_NOT_CONNECTED]:{layer:2,retry:!1,action:"connect_wallet"},[v.WALLET_LOCKED]:{layer:2,retry:!1,action:"unlock_wallet"},[v.INSUFFICIENT_ETH]:{layer:3,retry:!1,action:"show_faucet"},[v.INSUFFICIENT_TOKEN]:{layer:3,retry:!1},[v.INSUFFICIENT_ALLOWANCE]:{layer:3,retry:!1},[v.SIMULATION_REVERTED]:{layer:4,retry:!1},[v.GAS_ESTIMATION_FAILED]:{layer:4,retry:!0,waitMs:2e3},[v.USER_REJECTED]:{layer:5,retry:!1},[v.TX_REVERTED]:{layer:5,retry:!1},[v.TX_TIMEOUT]:{layer:5,retry:!0,waitMs:5e3},[v.TX_REPLACED]:{layer:5,retry:!1},[v.TX_UNDERPRICED]:{layer:5,retry:!0,waitMs:1e3},[v.NONCE_ERROR]:{layer:5,retry:!0,waitMs:2e3},[v.CAMPAIGN_NOT_FOUND]:{layer:4,retry:!1},[v.CAMPAIGN_NOT_ACTIVE]:{layer:4,retry:!1},[v.CAMPAIGN_STILL_ACTIVE]:{layer:4,retry:!1},[v.NOT_CAMPAIGN_CREATOR]:{layer:4,retry:!1},[v.DONATION_TOO_SMALL]:{layer:4,retry:!1},[v.MAX_CAMPAIGNS_REACHED]:{layer:4,retry:!1},[v.INSUFFICIENT_ETH_FEE]:{layer:3,retry:!1},[v.LOCK_PERIOD_ACTIVE]:{layer:4,retry:!1},[v.LOCK_PERIOD_EXPIRED]:{layer:4,retry:!1},[v.NO_REWARDS]:{layer:4,retry:!1},[v.INVALID_DURATION]:{layer:4,retry:!1},[v.INVALID_DELEGATION_INDEX]:{layer:4,retry:!1},[v.NFT_NOT_IN_POOL]:{layer:4,retry:!1},[v.POOL_NOT_INITIALIZED]:{layer:4,retry:!1},[v.INSUFFICIENT_POOL_LIQUIDITY]:{layer:4,retry:!1},[v.SLIPPAGE_EXCEEDED]:{layer:4,retry:!0,waitMs:1e3},[v.NFT_BOOST_MISMATCH]:{layer:4,retry:!1},[v.NOT_NFT_OWNER]:{layer:4,retry:!1},[v.NO_ACTIVE_TIERS]:{layer:4,retry:!1},[v.INVALID_GUESS_COUNT]:{layer:4,retry:!1},[v.INVALID_GUESS_RANGE]:{layer:4,retry:!1},[v.INSUFFICIENT_SERVICE_FEE]:{layer:4,retry:!1},[v.RENTAL_STILL_ACTIVE]:{layer:4,retry:!1},[v.NFT_NOT_LISTED]:{layer:4,retry:!1},[v.NFT_ALREADY_LISTED]:{layer:4,retry:!1},[v.NOT_LISTING_OWNER]:{layer:4,retry:!1},[v.MARKETPLACE_PAUSED]:{layer:4,retry:!1},[v.EMPTY_METADATA]:{layer:4,retry:!1},[v.CONTRACT_ERROR]:{layer:4,retry:!1},[v.UNKNOWN]:{layer:5,retry:!1}},Zr=[{pattern:/user rejected/i,type:v.USER_REJECTED},{pattern:/user denied/i,type:v.USER_REJECTED},{pattern:/user cancel/i,type:v.USER_REJECTED},{pattern:/rejected by user/i,type:v.USER_REJECTED},{pattern:/cancelled/i,type:v.USER_REJECTED},{pattern:/canceled/i,type:v.USER_REJECTED},{pattern:/action_rejected/i,type:v.USER_REJECTED},{pattern:/too many errors/i,type:v.RPC_RATE_LIMITED},{pattern:/rate limit/i,type:v.RPC_RATE_LIMITED},{pattern:/retrying in/i,type:v.RPC_RATE_LIMITED},{pattern:/429/i,type:v.RPC_RATE_LIMITED},{pattern:/internal json-rpc/i,type:v.RPC_UNHEALTHY},{pattern:/-32603/i,type:v.RPC_UNHEALTHY},{pattern:/-32002/i,type:v.RPC_RATE_LIMITED},{pattern:/failed to fetch/i,type:v.NETWORK_ERROR},{pattern:/network error/i,type:v.NETWORK_ERROR},{pattern:/timeout/i,type:v.TX_TIMEOUT},{pattern:/insufficient funds/i,type:v.INSUFFICIENT_ETH},{pattern:/exceeds the balance/i,type:v.INSUFFICIENT_ETH},{pattern:/insufficient balance/i,type:v.INSUFFICIENT_TOKEN},{pattern:/transfer amount exceeds balance/i,type:v.INSUFFICIENT_TOKEN},{pattern:/exceeds balance/i,type:v.INSUFFICIENT_TOKEN},{pattern:/nonce/i,type:v.NONCE_ERROR},{pattern:/replacement.*underpriced/i,type:v.TX_UNDERPRICED},{pattern:/transaction underpriced/i,type:v.TX_UNDERPRICED},{pattern:/gas too low/i,type:v.TX_UNDERPRICED},{pattern:/reverted/i,type:v.TX_REVERTED},{pattern:/revert/i,type:v.TX_REVERTED},{pattern:/campaignnotfound/i,type:v.CAMPAIGN_NOT_FOUND},{pattern:/campaign not found/i,type:v.CAMPAIGN_NOT_FOUND},{pattern:/campaignnotactive/i,type:v.CAMPAIGN_NOT_ACTIVE},{pattern:/campaign.*not.*active/i,type:v.CAMPAIGN_NOT_ACTIVE},{pattern:/campaignstillactive/i,type:v.CAMPAIGN_STILL_ACTIVE},{pattern:/notcampaigncreator/i,type:v.NOT_CAMPAIGN_CREATOR},{pattern:/donationtoosmall/i,type:v.DONATION_TOO_SMALL},{pattern:/maxactivecampaignsreached/i,type:v.MAX_CAMPAIGNS_REACHED},{pattern:/insufficientethfee/i,type:v.INSUFFICIENT_ETH_FEE},{pattern:/lockperiodactive/i,type:v.LOCK_PERIOD_ACTIVE},{pattern:/lock.*period.*active/i,type:v.LOCK_PERIOD_ACTIVE},{pattern:/still.*locked/i,type:v.LOCK_PERIOD_ACTIVE},{pattern:/lockperiodexpired/i,type:v.LOCK_PERIOD_EXPIRED},{pattern:/norewardstoclaim/i,type:v.NO_REWARDS},{pattern:/no.*rewards/i,type:v.NO_REWARDS},{pattern:/invalidduration/i,type:v.INVALID_DURATION},{pattern:/invalidindex/i,type:v.INVALID_DELEGATION_INDEX},{pattern:/nftnotinpool/i,type:v.NFT_NOT_IN_POOL},{pattern:/poolnotinitialized/i,type:v.POOL_NOT_INITIALIZED},{pattern:/insufficientliquidity/i,type:v.INSUFFICIENT_POOL_LIQUIDITY},{pattern:/insufficientnfts/i,type:v.INSUFFICIENT_POOL_LIQUIDITY},{pattern:/slippageexceeded/i,type:v.SLIPPAGE_EXCEEDED},{pattern:/slippage/i,type:v.SLIPPAGE_EXCEEDED},{pattern:/nftboostmismatch/i,type:v.NFT_BOOST_MISMATCH},{pattern:/notnftowner/i,type:v.NOT_NFT_OWNER},{pattern:/noactivetiers/i,type:v.NO_ACTIVE_TIERS},{pattern:/invalidguesscount/i,type:v.INVALID_GUESS_COUNT},{pattern:/invalidguessrange/i,type:v.INVALID_GUESS_RANGE},{pattern:/insufficientservicefee/i,type:v.INSUFFICIENT_SERVICE_FEE},{pattern:/rentalstillactive/i,type:v.RENTAL_STILL_ACTIVE},{pattern:/nftnotlisted/i,type:v.NFT_NOT_LISTED},{pattern:/nftalreadylisted/i,type:v.NFT_ALREADY_LISTED},{pattern:/notlistingowner/i,type:v.NOT_LISTING_OWNER},{pattern:/marketplaceispaused/i,type:v.MARKETPLACE_PAUSED},{pattern:/emptymetadata/i,type:v.EMPTY_METADATA}],J={classify(e){var a;if(e!=null&&e.errorType&&Object.values(v).includes(e.errorType))return e.errorType;const t=this._extractMessage(e),n=(e==null?void 0:e.code)||((a=e==null?void 0:e.error)==null?void 0:a.code);if(n===4001||n==="ACTION_REJECTED")return v.USER_REJECTED;if(n===-32002)return v.RPC_RATE_LIMITED;if(n===-32603||n==="CALL_EXCEPTION"){if(t.includes("revert")||t.includes("require")||t.includes("execution failed")||t.includes("call_exception")||(e==null?void 0:e.code)==="CALL_EXCEPTION"){for(const{pattern:s,type:r}of Zr)if(s.test(t))return r;return v.CONTRACT_ERROR}return v.RPC_UNHEALTHY}for(const{pattern:s,type:r}of Zr)if(s.test(t))return r;return v.UNKNOWN},_extractMessage(e){var n,a,s;return e?typeof e=="string"?e:[e.message,e.reason,(n=e.error)==null?void 0:n.message,(a=e.error)==null?void 0:a.reason,(s=e.data)==null?void 0:s.message,e.shortMessage,this._safeStringify(e)].filter(Boolean).join(" ").toLowerCase():""},_safeStringify(e){try{return JSON.stringify(e,(t,n)=>typeof n=="bigint"?n.toString():n)}catch{return""}},isUserRejection(e){return this.classify(e)===v.USER_REJECTED},isRetryable(e){var n;const t=this.classify(e);return((n=yt[t])==null?void 0:n.retry)||!1},getWaitTime(e){const t=this.classify(e),n=yt[t];return n?n.waitMs==="extract"?this._extractWaitTime(e):n.waitMs||2e3:2e3},_extractWaitTime(e){const t=this._extractMessage(e),n=t.match(/retrying in (\d+[,.]?\d*)\s*minutes?/i);if(n){const s=parseFloat(n[1].replace(",","."));return Math.ceil(s*60*1e3)+5e3}const a=t.match(/wait (\d+)\s*seconds?/i);return a?parseInt(a[1])*1e3+2e3:3e4},getMessage(e){const t=this.classify(e);return es[t]||es[v.UNKNOWN]},getConfig(e){const t=this.classify(e);return yt[t]||yt[v.UNKNOWN]},getLayer(e){var n;const t=this.classify(e);return((n=yt[t])==null?void 0:n.layer)||5},handle(e,t="Transaction"){const n=this.classify(e),a=yt[n]||{},s=this.getMessage(e);return console.error(`[${t}] Error:`,{type:n,layer:a.layer,retry:a.retry,message:s,original:e}),{type:n,message:s,retry:a.retry||!1,waitMs:a.retry?this.getWaitTime(e):0,layer:a.layer||5,action:a.action||null,original:e,context:t}},async handleWithRpcSwitch(e,t="Transaction"){const n=this.handle(e,t);if(n.action==="switch_rpc")try{const{NetworkManager:a}=await W(async()=>{const{NetworkManager:r}=await Promise.resolve().then(()=>kp);return{NetworkManager:r}},void 0);console.log("[ErrorHandler] Switching RPC due to network error...");const s=a.switchToNextRpc();try{await a.updateMetaMaskRpcs(),console.log("[ErrorHandler] MetaMask RPC updated")}catch(r){console.warn("[ErrorHandler] Could not update MetaMask:",r.message)}n.rpcSwitched=!0,n.newRpc=s,n.waitMs=Math.min(n.waitMs,2e3)}catch(a){console.warn("[ErrorHandler] Could not switch RPC:",a.message),n.rpcSwitched=!1}return n},parseSimulationError(e,t){var i;const n=this.classify(e);let a=this.getMessage(e);const r=(i={donate:{[v.CAMPAIGN_NOT_ACTIVE]:"This campaign has ended and is no longer accepting donations",[v.DONATION_TOO_SMALL]:"Minimum donation is 1 BKC"},delegate:{[v.INVALID_DURATION]:"Lock period must be between 1 day and 10 years"},playGame:{[v.INVALID_GUESS_RANGE]:"Your guess must be within the valid range for this tier"},withdraw:{[v.CAMPAIGN_STILL_ACTIVE]:"You can withdraw after the campaign deadline"},unstake:{[v.LOCK_PERIOD_ACTIVE]:"Your tokens are still locked. Use force unstake to withdraw early (penalty applies)"},claimRewards:{[v.CONTRACT_ERROR]:"No rewards available to claim",[v.NO_REWARDS]:"No rewards available to claim"}}[t])==null?void 0:i[n];return r&&(a=r),{type:n,message:a,original:e,method:t,isSimulation:!0}},create(e,t={}){const n=es[e]||"An error occurred",a=new Error(n);return a.errorType=e,a.extra=t,a},getAction(e){var n;const t=this.classify(e);return((n=yt[t])==null?void 0:n.action)||null}},ae={chainId:421614,chainIdHex:"0x66eee",name:"Arbitrum Sepolia",nativeCurrency:{name:"Ethereum",symbol:"ETH",decimals:18},blockExplorer:"https://sepolia.arbiscan.io"};function Je(){const e="ZWla0YY4A0Hw7e_rwyOXB";return e?`https://arb-sepolia.g.alchemy.com/v2/${e}`:null}const xp=[{name:"Alchemy",getUrl:Je,priority:1,isPublic:!1,isPaid:!0},{name:"Arbitrum Official",getUrl:()=>"https://sepolia-rollup.arbitrum.io/rpc",priority:2,isPublic:!0,isPaid:!1},{name:"PublicNode",getUrl:()=>"https://arbitrum-sepolia-rpc.publicnode.com",priority:3,isPublic:!0,isPaid:!1},{name:"Ankr",getUrl:()=>"https://rpc.ankr.com/arbitrum_sepolia",priority:4,isPublic:!0,isPaid:!1}];let it=0,Gt=null,kt=null,aa=0,sa=0,Kt=!0;const hp=3,vp=3e4,wp=5e3,Qr=6e4,yp=2e3,le={getCurrentRpcUrl(){const e=Je();if(e&&Kt)return e;const t=this.getAvailableEndpoints();if(t.length===0)throw new Error("No RPC endpoints available");return t[it%t.length].getUrl()},getPrimaryRpcUrl(){return Je()},getAvailableEndpoints(){return xp.filter(e=>e.getUrl()!==null).sort((e,t)=>e.priority-t.priority)},getRpcUrlsForMetaMask(){const e=Je(),t=this.getAvailableEndpoints().filter(n=>n.isPublic).map(n=>n.getUrl()).filter(Boolean);return e?[e,...t]:t},switchToNextRpc(e=!0){const t=this.getAvailableEndpoints();if(Kt&&Je()){Kt=!1,it=0;const s=t.find(r=>r.isPublic);if(s)return console.log(`[Network] Alchemy temporarily unavailable, using: ${s.name}`),e&&setTimeout(()=>{console.log("[Network] Retrying Alchemy..."),Kt=!0,it=0},yp),s.getUrl()}const n=t.filter(s=>s.isPublic);if(n.length<=1)return console.warn("[Network] No alternative RPCs available"),this.getCurrentRpcUrl();it=(it+1)%n.length;const a=n[it];return console.log(`[Network] Switched to RPC: ${a.name}`),a.getUrl()},resetToAlchemy(){Je()&&(Kt=!0,it=0,console.log("[Network] Reset to Alchemy RPC"))},isRateLimitError(e){var a;const t=((a=e==null?void 0:e.message)==null?void 0:a.toLowerCase())||"",n=e==null?void 0:e.code;return n===-32002||n===-32005||t.includes("rate limit")||t.includes("too many")||t.includes("exceeded")||t.includes("throttled")||t.includes("429")},async handleRateLimit(e){const t=this.getCurrentRpcUrl(),n=Je();if(n&&t===n)return console.warn("[Network] Alchemy rate limited (check your plan limits)"),await new Promise(i=>setTimeout(i,1e3)),n;console.warn("[Network] Public RPC rate limited, switching...");const s=this.switchToNextRpc(),r=Date.now();if(r-sa>Qr)try{await this.updateMetaMaskRpcs(),sa=r}catch(i){console.warn("[Network] Could not update MetaMask:",i.message)}return s},async getWorkingProvider(){const e=window.ethers,t=Je();if(t)try{const a=new e.JsonRpcProvider(t);return await Promise.race([a.getBlockNumber(),new Promise((s,r)=>setTimeout(()=>r(new Error("timeout")),3e3))]),Kt=!0,a}catch(a){console.warn("[Network] Alchemy temporarily unavailable:",a.message)}const n=this.getAvailableEndpoints().filter(a=>a.isPublic);for(const a of n)try{const s=a.getUrl(),r=new e.JsonRpcProvider(s);return await Promise.race([r.getBlockNumber(),new Promise((i,o)=>setTimeout(()=>o(new Error("timeout")),3e3))]),console.log(`[Network] Using fallback RPC: ${a.name}`),r}catch{console.warn(`[Network] RPC ${a.name} failed, trying next...`)}if(t)return new e.JsonRpcProvider(t);throw new Error("No working RPC endpoints available")},async isCorrectNetwork(){if(!window.ethereum)return!1;try{const e=await window.ethereum.request({method:"eth_chainId"});return parseInt(e,16)===ae.chainId}catch(e){return console.error("[Network] Error checking network:",e),!1}},async getCurrentChainId(){if(!window.ethereum)return null;try{const e=await window.ethereum.request({method:"eth_chainId"});return parseInt(e,16)}catch{return null}},async checkRpcHealth(){const e=Date.now(),t=this.getCurrentRpcUrl();try{const n=new AbortController,a=setTimeout(()=>n.abort(),wp),s=await fetch(t,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({jsonrpc:"2.0",method:"eth_blockNumber",params:[],id:1}),signal:n.signal});if(clearTimeout(a),!s.ok)throw new Error(`HTTP ${s.status}`);const r=await s.json();if(r.error)throw new Error(r.error.message||"RPC error");const i=Date.now()-e;return aa=0,kt={healthy:!0,latency:i,blockNumber:parseInt(r.result,16),timestamp:Date.now()},kt}catch(n){aa++;const a={healthy:!1,latency:Date.now()-e,error:n.message,timestamp:Date.now()};return kt=a,aa>=hp&&(console.warn("[Network] Too many RPC failures, switching..."),this.switchToNextRpc(),aa=0),a}},getLastHealthCheck(){return kt},async isRpcHealthy(e=1e4){return kt&&Date.now()-kt.timestamp<e?kt.healthy:(await this.checkRpcHealth()).healthy},async switchNetwork(){if(!window.ethereum)throw J.create(v.WALLET_NOT_CONNECTED);try{return await window.ethereum.request({method:"wallet_switchEthereumChain",params:[{chainId:ae.chainIdHex}]}),console.log("[Network] Switched to",ae.name),!0}catch(e){if(e.code===4902)return await this.addNetwork();throw e.code===4001?J.create(v.USER_REJECTED):e}},async addNetwork(){if(!window.ethereum)throw J.create(v.WALLET_NOT_CONNECTED);const e=this.getRpcUrlsForMetaMask();try{return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:ae.chainIdHex,chainName:ae.name,nativeCurrency:ae.nativeCurrency,rpcUrls:e,blockExplorerUrls:[ae.blockExplorer]}]}),console.log("[Network] Added network:",ae.name),!0}catch(t){throw t.code===4001?J.create(v.USER_REJECTED):t}},async updateMetaMaskRpcs(){if(!window.ethereum)return!1;const e=Date.now();if(e-sa<Qr)return console.log("[Network] MetaMask update on cooldown, skipping..."),!1;if(!await this.isCorrectNetwork())return console.log("[Network] Not on correct network, skipping RPC update"),!1;const n=this.getRpcUrlsForMetaMask();try{return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:ae.chainIdHex,chainName:ae.name,nativeCurrency:ae.nativeCurrency,rpcUrls:n,blockExplorerUrls:[ae.blockExplorer]}]}),sa=e,console.log("[Network] MetaMask RPCs updated with:",n[0]),!0}catch(a){return console.warn("[Network] Could not update MetaMask RPCs:",a.message),!1}},async forceResetMetaMaskRpc(){if(!window.ethereum)return!1;const e=Je();if(!e)return console.warn("[Network] Alchemy not configured"),!1;try{try{await window.ethereum.request({method:"wallet_switchEthereumChain",params:[{chainId:"0x1"}]})}catch{}return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:ae.chainIdHex,chainName:ae.name+" (Alchemy)",nativeCurrency:ae.nativeCurrency,rpcUrls:[e],blockExplorerUrls:[ae.blockExplorer]}]}),console.log("[Network] MetaMask reset to Alchemy RPC"),!0}catch(t){return console.error("[Network] Failed to reset MetaMask:",t.message),!1}},getProvider(){const e=window.ethers;if(!e)throw new Error("ethers.js not loaded");return new e.JsonRpcProvider(this.getCurrentRpcUrl())},getBrowserProvider(){const e=window.ethers;if(!e)throw new Error("ethers.js not loaded");if(!window.ethereum)throw J.create(v.WALLET_NOT_CONNECTED);return new e.BrowserProvider(window.ethereum)},async getSigner(){var t,n;const e=this.getBrowserProvider();try{return await e.getSigner()}catch(a){if((t=a.message)!=null&&t.includes("ENS")||a.code==="UNSUPPORTED_OPERATION")try{const s=await window.ethereum.request({method:"eth_accounts"});if(s&&s.length>0)return await e.getSigner(s[0])}catch(s){console.warn("Signer fallback failed:",s)}throw a.code===4001||(n=a.message)!=null&&n.includes("user rejected")?J.create(v.USER_REJECTED):J.create(v.WALLET_NOT_CONNECTED)}},async getConnectedAddress(){if(!window.ethereum)return null;try{return(await window.ethereum.request({method:"eth_accounts"}))[0]||null}catch{return null}},async requestConnection(){if(!window.ethereum)throw J.create(v.WALLET_NOT_CONNECTED);try{const e=await window.ethereum.request({method:"eth_requestAccounts"});if(!e||e.length===0)throw J.create(v.WALLET_NOT_CONNECTED);return e[0]}catch(e){throw e.code===4001?J.create(v.USER_REJECTED):e}},startHealthMonitoring(e=vp){Gt&&this.stopHealthMonitoring(),this.checkRpcHealth(),Gt=setInterval(()=>{this.checkRpcHealth()},e),console.log("[Network] Health monitoring started")},stopHealthMonitoring(){Gt&&(clearInterval(Gt),Gt=null,console.log("[Network] Health monitoring stopped"))},isMonitoring(){return Gt!==null},formatAddress(e,t=4){return e?`${e.slice(0,t+2)}...${e.slice(-t)}`:""},getAddressExplorerUrl(e){return`${ae.blockExplorer}/address/${e}`},getTxExplorerUrl(e){return`${ae.blockExplorer}/tx/${e}`},isMetaMaskInstalled(){return typeof window.ethereum<"u"&&window.ethereum.isMetaMask},async getStatus(){var a;const[e,t,n]=await Promise.all([this.isCorrectNetwork(),this.getConnectedAddress(),this.checkRpcHealth()]);return{isConnected:!!t,address:t,isCorrectNetwork:e,currentChainId:await this.getCurrentChainId(),targetChainId:ae.chainId,rpcHealthy:n.healthy,rpcLatency:n.latency,currentRpc:((a=this.getAvailableEndpoints()[it])==null?void 0:a.name)||"Unknown"}}},kp=Object.freeze(Object.defineProperty({__proto__:null,NETWORK_CONFIG:ae,NetworkManager:le},Symbol.toStringTag,{value:"Module"})),Ye={SAFETY_MARGIN_PERCENT:20,MIN_GAS_LIMITS:{transfer:21000n,erc20Transfer:65000n,erc20Approve:50000n,contractCall:100000n,complexCall:300000n},MAX_GAS_LIMIT:15000000n,MIN_GAS_PRICE_GWEI:.01,MAX_GAS_PRICE_GWEI:100,GAS_PRICE_CACHE_TTL:15e3},Ep={async estimateGas(e,t,n=[],a={}){try{return await e[t].estimateGas(...n,a)}catch(s){throw s}},async estimateGasWithMargin(e,t,n=[],a={}){const s=await this.estimateGas(e,t,n,a);return this.addSafetyMargin(s)},addSafetyMargin(e,t=Ye.SAFETY_MARGIN_PERCENT){const n=BigInt(e),a=n*BigInt(t)/100n;let s=n+a;return s>Ye.MAX_GAS_LIMIT&&(console.warn("[Gas] Estimate exceeds max limit, capping"),s=Ye.MAX_GAS_LIMIT),s},getMinGasLimit(e="contractCall"){return Ye.MIN_GAS_LIMITS[e]||Ye.MIN_GAS_LIMITS.contractCall},async getGasPrice(){return await Nt.getOrFetch("gas-price-current",async()=>(await le.getProvider().getFeeData()).gasPrice||0n,Ye.GAS_PRICE_CACHE_TTL)},async getFeeData(){return await Nt.getOrFetch("gas-fee-data",async()=>{const n=await le.getProvider().getFeeData();return{gasPrice:n.gasPrice||0n,maxFeePerGas:n.maxFeePerGas||0n,maxPriorityFeePerGas:n.maxPriorityFeePerGas||0n}},Ye.GAS_PRICE_CACHE_TTL)},async getGasPriceGwei(){const e=window.ethers,t=await this.getGasPrice();return parseFloat(e.formatUnits(t,"gwei"))},async calculateCost(e,t=null){const n=window.ethers;t||(t=await this.getGasPrice());const a=BigInt(e)*BigInt(t),s=n.formatEther(a);return{wei:a,eth:parseFloat(s),formatted:this.formatEth(s)}},async estimateTransactionCost(e,t,n=[],a={}){const s=await this.estimateGas(e,t,n,a),r=this.addSafetyMargin(s),i=await this.getGasPrice(),o=await this.calculateCost(r,i);return{gasEstimate:s,gasWithMargin:r,gasPrice:i,...o}},async validateGasBalance(e,t,n=null){const a=window.ethers,s=le.getProvider();n||(n=await this.getGasPrice());const r=await s.getBalance(e),i=BigInt(t)*BigInt(n),o=r>=i;return{sufficient:o,balance:r,required:i,shortage:o?0n:i-r,balanceFormatted:a.formatEther(r),requiredFormatted:a.formatEther(i)}},async hasMinimumGas(e,t=null){const n=window.ethers,s=await le.getProvider().getBalance(e),r=t||n.parseEther("0.001");return s>=r},formatEth(e,t=6){const n=parseFloat(e);return n===0?"0 ETH":n<1e-6?"< 0.000001 ETH":`${n.toFixed(t).replace(/\.?0+$/,"")} ETH`},formatGasPrice(e){const t=window.ethers,n=parseFloat(t.formatUnits(e,"gwei"));return n<.01?"< 0.01 gwei":n<1?`${n.toFixed(2)} gwei`:`${n.toFixed(1)} gwei`},formatGasLimit(e){return Number(e).toLocaleString()},formatGasSummary(e){return`~${e.formatted} (${this.formatGasLimit(e.gasWithMargin||0n)} gas)`},compareEstimates(e,t){const n=BigInt(e),a=BigInt(t);if(a===0n)return 0;const s=n>a?n-a:a-n;return Number(s*100n/a)},isGasPriceReasonable(e){const t=window.ethers,n=parseFloat(t.formatUnits(e,"gwei"));return n<Ye.MIN_GAS_PRICE_GWEI?{reasonable:!1,warning:"Gas price unusually low, transaction may be slow"}:n>Ye.MAX_GAS_PRICE_GWEI?{reasonable:!1,warning:"Gas price unusually high, consider waiting"}:{reasonable:!0,warning:null}},async getRecommendedSettings(e){const t=await this.getFeeData();return{gasLimit:this.addSafetyMargin(e),maxFeePerGas:t.maxFeePerGas,maxPriorityFeePerGas:t.maxPriorityFeePerGas}},async createTxOverrides(e,t={}){return{gasLimit:(await this.getRecommendedSettings(e)).gasLimit,...t}}},ei=500000000000000n,ti=["function balanceOf(address owner) view returns (uint256)","function allowance(address owner, address spender) view returns (uint256)","function decimals() view returns (uint8)","function symbol() view returns (string)"],Z={async validateNetwork(){if(!await le.isCorrectNetwork()){const t=await le.getCurrentChainId();throw J.create(v.WRONG_NETWORK,{currentChainId:t,expectedChainId:ae.chainId})}},async validateRpcHealth(){const e=await le.checkRpcHealth();if(!e.healthy&&(le.switchToNextRpc(),!(await le.checkRpcHealth()).healthy))throw J.create(v.RPC_UNHEALTHY,{error:e.error})},async validateWalletConnected(e=null){if(!window.ethereum)throw J.create(v.WALLET_NOT_CONNECTED);const t=e||await le.getConnectedAddress();if(!t)throw J.create(v.WALLET_NOT_CONNECTED);return t},async validatePreTransaction(){return await this.validateNetwork(),await this.validateRpcHealth(),await this.validateWalletConnected()},async validateEthForGas(e,t=ei){const n=window.ethers,a=Qa.ethBalance(e),s=await Nt.getOrFetch(a,async()=>await le.getProvider().getBalance(e),Za.BALANCE);if(s<t)throw J.create(v.INSUFFICIENT_ETH,{balance:n.formatEther(s),required:n.formatEther(t)});return s},async validateTokenBalance(e,t,n){const a=window.ethers,s=Qa.tokenBalance(e,n),r=await Nt.getOrFetch(s,async()=>{const i=le.getProvider();return await new a.Contract(e,ti,i).balanceOf(n)},Za.BALANCE);if(r<t)throw J.create(v.INSUFFICIENT_TOKEN,{balance:a.formatEther(r),required:a.formatEther(t)});return r},async needsApproval(e,t,n,a){const s=window.ethers,r=Qa.allowance(e,a,t);return await Nt.getOrFetch(r,async()=>{const o=le.getProvider();return await new s.Contract(e,ti,o).allowance(a,t)},Za.ALLOWANCE)<n},async validateAllowance(e,t,n,a){if(await this.needsApproval(e,t,n,a))throw J.create(v.INSUFFICIENT_ALLOWANCE,{token:e,spender:t,required:n.toString()})},async validateBalances({userAddress:e,tokenAddress:t=null,tokenAmount:n=null,spenderAddress:a=null,ethAmount:s=ei}){await this.validateEthForGas(e,s),t&&n&&await this.validateTokenBalance(t,n,e)},validatePositive(e,t="Amount"){if(BigInt(e)<=0n)throw new Error(`${t} must be greater than zero`)},validateRange(e,t,n,a="Value"){const s=BigInt(e),r=BigInt(t),i=BigInt(n);if(s<r||s>i)throw new Error(`${a} must be between ${t} and ${n}`)},validateNotEmpty(e,t="Field"){if(!e||e.trim().length===0)throw new Error(`${t} cannot be empty`)},validateAddress(e,t="Address"){const n=window.ethers;if(!e||!n.isAddress(e))throw new Error(`Invalid ${t}`)},charity:{validateCreateCampaign({title:e,description:t,goalAmount:n,durationDays:a}){Z.validateNotEmpty(e,"Title"),Z.validateNotEmpty(t,"Description"),Z.validatePositive(n,"Goal amount"),Z.validateRange(a,1,180,"Duration")},validateDonate({campaignId:e,amount:t}){if(e==null)throw new Error("Campaign ID is required");Z.validatePositive(t,"Donation amount")}},staking:{validateDelegate({amount:e,lockDays:t}){Z.validatePositive(e,"Stake amount"),Z.validateRange(t,1,3650,"Lock duration")},validateUnstake({delegationIndex:e}){if(e==null||e<0)throw new Error("Invalid delegation index")}},nftPool:{validateBuy({maxPrice:e}){e!=null&&Z.validatePositive(e,"Max price")},validateSell({tokenId:e,minPayout:t}){if(e==null)throw new Error("Token ID is required");t!=null&&Z.validatePositive(t,"Min payout")}},fortune:{validatePlay({wagerAmount:e,guesses:t,isCumulative:n}){if(Z.validatePositive(e,"Wager amount"),!Array.isArray(t)||t.length===0)throw new Error("At least one guess is required");t.forEach((a,s)=>{if(typeof a!="number"||a<1)throw new Error(`Invalid guess at position ${s+1}`)})}},rental:{validateList({tokenId:e,pricePerHour:t,minHours:n,maxHours:a}){if(e==null)throw new Error("Token ID is required");Z.validatePositive(t,"Price per hour"),Z.validateRange(n,1,720,"Minimum hours"),Z.validateRange(a,n,720,"Maximum hours")},validateRent({tokenId:e,hours:t}){if(e==null)throw new Error("Token ID is required");Z.validatePositive(t,"Rental hours")}},notary:{validateNotarize({ipfsCid:e,description:t,contentHash:n}){if(Z.validateNotEmpty(e,"IPFS CID"),n&&(n.startsWith("0x")?n.slice(2):n).length!==64)throw new Error("Content hash must be 32 bytes")}}},ra={DEFAULT_MAX_RETRIES:2,RETRY_BASE_DELAY:2e3,APPROVAL_MULTIPLIER:10n,APPROVAL_WAIT_TIME:1500,CONFIRMATION_TIMEOUT:6e4,CONFIRMATION_RETRY_DELAY:3e3,GAS_SAFETY_MARGIN:20,DEFAULT_GAS_LIMIT:500000n},ni=["function approve(address spender, uint256 amount) returns (bool)","function allowance(address owner, address spender) view returns (uint256)"];class Cp{constructor(t,n,a=!0){this.button=t,this.txName=n,this.showToasts=a,this.originalContent=null,this.originalDisabled=!1,this.button&&(this.originalContent=this.button.innerHTML,this.originalDisabled=this.button.disabled)}setPhase(t){if(!this.button)return;const a={validating:{text:"Validating...",icon:"🔍"},approving:{text:"Approving...",icon:"✅"},simulating:{text:"Simulating...",icon:"🧪"},confirming:{text:"Confirm in Wallet",icon:"👛"},waiting:{text:"Processing...",icon:"⏳"},success:{text:"Success!",icon:"🎉"},error:{text:"Failed",icon:"❌"}}[t]||{text:t,icon:"⏳"};this.button.disabled=!0,this.button.innerHTML=`
        ...
        `)}cleanup(){this.button&&(this.button.innerHTML=this.originalContent,this.button.disabled=this.originalDisabled)}showSuccess(t=2e3){this.setPhase("success"),setTimeout(()=>this.cleanup(),t)}showError(t=2e3){this.setPhase("error"),setTimeout(()=>this.cleanup(),t)}}class Tp{constructor(){this.pendingTxIds=new Set}_resolveArgs(t){return typeof t=="function"?t():t||[]}_resolveApproval(t){return t?typeof t=="object"?{token:t.token,spender:t.spender,amount:t.amount}:t:null}_validateContractMethod(t,n){if(!t)throw new Error("Contract instance is null or undefined");if(typeof t[n]!="function"){const a=Object.keys(t).filter(s=>typeof t[s]=="function").filter(s=>!s.startsWith("_")&&!["on","once","emit","removeListener"].includes(s)).slice(0,15);throw console.error(`[TX] Contract method "${n}" not found!`),console.error("[TX] Available methods:",a),new Error(`Contract method "${n}" not found. This usually means the ABI doesn't match the contract. Available methods: ${a.join(", ")}`)}return typeof t[n].estimateGas!="function"&&console.warn(`[TX] Method ${n} exists but estimateGas is not available`),!0}async execute(t){var B,z;const{name:n,txId:a=null,button:s=null,showToasts:r=!0,getContract:i,method:o,args:c=[],approval:l=null,validate:u=null,onSuccess:m=null,onError:p=null,maxRetries:f=ra.DEFAULT_MAX_RETRIES,invalidateCache:b=!0,skipSimulation:x=!1,fixedGasLimit:y=ra.DEFAULT_GAS_LIMIT}=t,C=a||`${n}-${Date.now()}-${Math.random().toString(36).substr(2,9)}`;if(this.pendingTxIds.has(C))return console.warn(`[TX] Transaction ${C} already in progress`),{success:!1,reason:"DUPLICATE_TX",message:"Transaction already in progress"};this.pendingTxIds.add(C);const I=new Cp(s,n,r);try{I.setPhase("validating"),console.log(`[TX] Starting: ${n}`),await Z.validateNetwork(),await Z.validateRpcHealth();const N=await Z.validateWalletConnected();console.log(`[TX] User address: ${N}`);const T=await le.getSigner();console.log("[TX] Signer obtained");try{await Z.validateEthForGas(N)}catch(X){console.warn("[TX] ETH gas validation failed, continuing anyway:",X.message)}const F=this._resolveApproval(l);F&&F.amount>0n&&await Z.validateTokenBalance(F.token,F.amount,N),u&&(console.log("[TX] Running custom validation..."),await u(T,N));const Y=this._resolveApproval(t.approval);Y&&Y.amount>0n&&await Z.needsApproval(Y.token,Y.spender,Y.amount,N)&&(I.setPhase("approving"),console.log("[TX] Requesting token approval..."),await this._executeApproval(Y,T,N),Nt.clear("allowance-")),console.log("[TX] Getting contract instance...");const oe=await i(T);this._validateContractMethod(oe,o),console.log(`[TX] Contract method "${o}" validated`);const pe=t.value;pe&&console.log("[TX] Transaction value (ETH):",pe.toString());const ye=pe?{value:pe}:{},te=this._resolveArgs(c);console.log("[TX] Args resolved:",te.map(X=>typeof X=="bigint"?X.toString():typeof X=="string"&&X.length>50?X.substring(0,50)+"...":X));let D;if(x)console.log(`[TX] Skipping simulation, using fixed gas limit: ${y}`),D=y;else{I.setPhase("simulating"),console.log("[TX] Simulating transaction...");try{if(!oe[o]||typeof oe[o].estimateGas!="function")throw new Error(`estimateGas not available for method "${o}"`);D=await oe[o].estimateGas(...te,ye),console.log(`[TX] Gas estimate: ${D.toString()}`)}catch(X){if(console.error("[TX] Simulation failed:",X.message),(B=X.message)!=null&&B.includes("not found")||(z=X.message)!=null&&z.includes("undefined"))throw new Error(`Contract method "${o}" is not callable. Check that the ABI matches the deployed contract.`);const fn=J.parseSimulationError(X,o);throw J.create(fn.type,{message:fn.message,original:X})}}I.setPhase("confirming"),console.log("[TX] Requesting signature...");const K=Ep.addSafetyMargin(D),de={...ye,gasLimit:K};try{const X=await T.provider.getFeeData();X.maxFeePerGas&&(de.maxFeePerGas=X.maxFeePerGas*120n/100n,de.maxPriorityFeePerGas=X.maxPriorityFeePerGas||0n)}catch{}const ie=this._resolveArgs(c),rt=await this._executeWithRetry(()=>oe[o](...ie,de),{maxRetries:f,ui:I,signer:T,name:n});console.log(`[TX] Transaction submitted: ${rt.hash}`),I.setPhase("waiting"),console.log("[TX] Waiting for confirmation...");const Ue=await this._waitForConfirmation(rt,T.provider);if(console.log(`[TX] Confirmed in block ${Ue.blockNumber}`),I.showSuccess(),b&&Nt.invalidateByTx(n),m)try{await m(Ue)}catch(X){console.warn("[TX] onSuccess callback error:",X)}return{success:!0,receipt:Ue,txHash:Ue.hash||rt.hash,blockNumber:Ue.blockNumber}}catch(N){console.error("[TX] Error:",(N==null?void 0:N.message)||N),s&&(console.log("[TX] Restoring button..."),s.disabled=!1,I.originalContent&&(s.innerHTML=I.originalContent));let T;try{T=await J.handleWithRpcSwitch(N,n),T.rpcSwitched&&console.log(`[TX] RPC switched to: ${T.newRpc}`)}catch(F){console.warn("[TX] Error in handleWithRpcSwitch:",F),T=J.handle(N,n)}if(T.type!==v.USER_REJECTED&&s&&!p){const F=I.originalContent;s.innerHTML='<span style="display:flex;align-items:center;justify-content:center;gap:8px"><span>❌</span><span>Failed</span></span>',setTimeout(()=>{s&&(s.innerHTML=F)},1500)}if(p)try{p(T)}catch(F){console.warn("[TX] onError callback error:",F)}return{success:!1,error:T,message:T.message,cancelled:T.type===v.USER_REJECTED}}finally{this.pendingTxIds.delete(C),setTimeout(()=>{s&&s.disabled&&(console.log("[TX] Safety cleanup triggered"),I.cleanup())},5e3)}}async _executeApproval(t,n,a){const s=window.ethers,{token:r,spender:i,amount:o}=t;console.log(`[TX] Approving ${s.formatEther(o)} tokens...`);const c=new s.Contract(r,ni,n),l=o*ra.APPROVAL_MULTIPLIER;try{let u={};try{const y=await n.provider.getFeeData();y.maxFeePerGas&&(u.maxFeePerGas=y.maxFeePerGas*120n/100n,u.maxPriorityFeePerGas=y.maxPriorityFeePerGas||0n)}catch{}const m=await c.approve(i,l,u),p=le.getProvider();let f=null;for(let y=0;y<30&&(await new Promise(C=>setTimeout(C,1500)),f=await p.getTransactionReceipt(m.hash),!f);y++);if(f||(f=await m.wait()),f.status===0)throw new Error("Approval transaction reverted");if(console.log("[TX] Approval confirmed"),await new Promise(y=>setTimeout(y,ra.APPROVAL_WAIT_TIME)),await new s.Contract(r,ni,p).allowance(a,i)<o)throw new Error("Approval not reflected on-chain")}catch(u){throw J.isUserRejection(u)?J.create(v.USER_REJECTED):u}}async _executeWithRetry(t,{maxRetries:n,ui:a,signer:s,name:r}){let i;for(let o=1;o<=n+1;o++)try{return o>1&&(a.setRetry(o,n+1),console.log(`[TX] Retry ${o}/${n+1}`),(await le.checkRpcHealth()).healthy||(console.log("[TX] RPC unhealthy, switching..."),le.switchToNextRpc(),await new Promise(l=>setTimeout(l,2e3)))),await t()}catch(c){if(i=c,J.isUserRejection(c)||!J.isRetryable(c)||o===n+1)throw c;const l=J.getWaitTime(c);console.log(`[TX] Waiting ${l}ms before retry...`),await new Promise(u=>setTimeout(u,l))}throw i}async _waitForConfirmation(t,n){const a=le.getProvider();try{const s=await Promise.race([t.wait(),new Promise((r,i)=>setTimeout(()=>i(new Error("wait_timeout")),1e4))]);if(s.status===1)return s;if(s.status===0)throw new Error("Transaction reverted on-chain");return s}catch(s){console.warn("[TX] tx.wait() issue, using Alchemy to check:",s.message);for(let r=0;r<20;r++){await new Promise(o=>setTimeout(o,1500));const i=await a.getTransactionReceipt(t.hash);if(i&&i.status===1)return console.log("[TX] Confirmed via Alchemy"),i;if(i&&i.status===0)throw new Error("Transaction reverted on-chain")}return console.warn("[TX] Could not verify receipt, assuming success"),{hash:t.hash,status:1,blockNumber:0}}}isPending(t){return this.pendingTxIds.has(t)}getPendingCount(){return this.pendingTxIds.size}clearPending(){this.pendingTxIds.clear()}}const O=new Tp,$a="bkc_operator",Dt="0x0000000000000000000000000000000000000000";function qs(){var t;const e=window.ethers;try{const n=localStorage.getItem($a);if(n&&Qe(n))return qt(n);if(window.BACKCHAIN_OPERATOR&&Qe(window.BACKCHAIN_OPERATOR))return qt(window.BACKCHAIN_OPERATOR);if((t=window.addresses)!=null&&t.operator&&Qe(window.addresses.operator))return qt(window.addresses.operator)}catch(n){console.warn("[Operator] Error getting operator:",n)}return(e==null?void 0:e.ZeroAddress)||Dt}function q(e){const t=window.ethers,n=(t==null?void 0:t.ZeroAddress)||Dt;return e===null?n:e&&Qe(e)?qt(e):qs()}function Ip(e){if(!e)return fo(),!0;if(!Qe(e))return console.warn("[Operator] Invalid address:",e),!1;try{const t=qt(e);return localStorage.setItem($a,t),window.BACKCHAIN_OPERATOR=t,window.dispatchEvent(new CustomEvent("operatorChanged",{detail:{address:t}})),console.log("[Operator] Set to:",t),!0}catch(t){return console.error("[Operator] Error setting:",t),!1}}function fo(){try{localStorage.removeItem($a),delete window.BACKCHAIN_OPERATOR,window.dispatchEvent(new CustomEvent("operatorChanged",{detail:{address:null}})),console.log("[Operator] Cleared")}catch(e){console.warn("[Operator] Error clearing:",e)}}function Ap(){const e=window.ethers,t=(e==null?void 0:e.ZeroAddress)||Dt,n=qs();return n&&n!==t}function Bp(){var a;const e=window.ethers,t=(e==null?void 0:e.ZeroAddress)||Dt,n=localStorage.getItem($a);return n&&Qe(n)?{address:n,source:"localStorage",isSet:!0}:window.BACKCHAIN_OPERATOR&&Qe(window.BACKCHAIN_OPERATOR)?{address:window.BACKCHAIN_OPERATOR,source:"global",isSet:!0}:(a=window.addresses)!=null&&a.operator&&Qe(window.addresses.operator)?{address:window.addresses.operator,source:"config",isSet:!0}:{address:t,source:"none",isSet:!1}}function Qe(e){const t=window.ethers;return!e||typeof e!="string"||!e.match(/^0x[a-fA-F0-9]{40}$/)?!1:t!=null&&t.isAddress?t.isAddress(e):!0}function qt(e){const t=window.ethers;if(!e)return(t==null?void 0:t.ZeroAddress)||Dt;try{if(t!=null&&t.getAddress)return t.getAddress(e)}catch{}return e}function Pp(e){const t=window.ethers,n=(t==null?void 0:t.ZeroAddress)||Dt;return!e||e===n?"None":`${e.slice(0,6)}...${e.slice(-4)}`}const zp={get:qs,set:Ip,clear:fo,has:Ap,resolve:q,info:Bp,isValid:Qe,normalize:qt,short:Pp,ZERO:Dt};window.Operator=zp;function Hn(){var n,a;const e=(w==null?void 0:w.charityPool)||($==null?void 0:$.charityPool)||((n=window.contractAddresses)==null?void 0:n.charityPool),t=(w==null?void 0:w.bkcToken)||($==null?void 0:$.bkcToken)||((a=window.contractAddresses)==null?void 0:a.bkcToken);if(!e)throw console.error("❌ CharityPool address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{BKC_TOKEN:t,CHARITY_POOL:e}}const jn=["function createCampaign(string calldata _title, string calldata _description, uint96 _goalAmount, uint256 _durationDays, address _operator) external returns (uint256 campaignId)","function donate(uint256 _campaignId, address _operator) external payable","function cancelCampaign(uint256 _campaignId) external","function withdraw(uint256 _campaignId, address _operator) external","function boostCampaign(uint256 _campaignId, address _operator) external payable","function campaigns(uint256 campaignId) view returns (address creator, uint96 goalAmount, uint96 raisedAmount, uint32 donationCount, uint64 deadline, uint64 createdAt, uint96 boostAmount, uint64 boostTime, uint8 status)","function campaignTitles(uint256 campaignId) view returns (string)","function campaignDescriptions(uint256 campaignId) view returns (string)","function getCampaign(uint256 _campaignId) view returns (address creator, string title, string description, uint96 goalAmount, uint96 raisedAmount, uint32 donationCount, uint64 deadline, uint64 createdAt, uint96 boostAmount, uint64 boostTime, uint8 status, bool goalReached)","function donations(uint256 donationId) view returns (address donor, uint64 campaignId, uint96 grossAmount, uint96 netAmount, uint64 timestamp)","function getDonation(uint256 _donationId) view returns (tuple(address donor, uint64 campaignId, uint96 grossAmount, uint96 netAmount, uint64 timestamp))","function getCampaignDonations(uint256 _campaignId) view returns (uint256[])","function getUserDonations(address _user) view returns (uint256[])","function getUserCampaigns(address _user) view returns (uint256[])","function userActiveCampaigns(address user) view returns (uint8)","function maxActiveCampaigns() view returns (uint8)","function createCostBkc() view returns (uint96)","function withdrawCostBkc() view returns (uint96)","function donationFeeBips() view returns (uint16)","function boostCostBkc() view returns (uint96)","function boostCostEth() view returns (uint96)","function getFeeConfig() view returns (uint96 createBkc, uint96 withdrawBkc, uint16 donationBips, uint96 boostBkc, uint96 boostEth)","function campaignCounter() view returns (uint64)","function donationCounter() view returns (uint64)","function totalRaisedAllTime() view returns (uint256)","function totalDonationsAllTime() view returns (uint256)","function totalFeesCollected() view returns (uint256)","function getStats() view returns (uint64 totalCampaigns, uint256 totalRaised, uint256 totalDonations, uint256 totalFees)","function previewDonation(uint256 _amount) view returns (uint256 netToCampaign, uint256 feeToProtocol)","function canWithdraw(uint256 _campaignId) view returns (bool allowed, string reason)","function isBoosted(uint256 _campaignId) view returns (bool)","function version() view returns (string)","event CampaignCreated(uint256 indexed campaignId, address indexed creator, uint96 goalAmount, uint64 deadline, address operator)","event DonationMade(uint256 indexed campaignId, uint256 indexed donationId, address indexed donor, uint96 grossAmount, uint96 netAmount, uint96 feeAmount, address operator)","event CampaignBoosted(uint256 indexed campaignId, address indexed booster, uint96 bkcAmount, uint96 ethAmount, address operator)","event CampaignCancelled(uint256 indexed campaignId, address indexed creator, uint96 raisedAmount)","event FundsWithdrawn(uint256 indexed campaignId, address indexed creator, uint96 amount, address operator)","event ConfigUpdated()"],ln={ACTIVE:0,COMPLETED:1,CANCELLED:2,WITHDRAWN:3};function Ke(e){const t=window.ethers,n=Hn();return new t.Contract(n.CHARITY_POOL,jn,e)}async function be(){const e=window.ethers,{NetworkManager:t}=await W(async()=>{const{NetworkManager:s}=await import("./index-DZsKjxq8.js");return{NetworkManager:s}},[]),n=t.getProvider(),a=Hn();return new e.Contract(a.CHARITY_POOL,jn,n)}async function bo({title:e,description:t,goalAmount:n,durationDays:a,operator:s,button:r=null,onSuccess:i=null,onError:o=null}){const c=window.ethers;if(!e||e.trim().length===0)throw new Error("Title is required");if(e.length>100)throw new Error("Title must be 100 characters or less");if(t&&t.length>1e3)throw new Error("Description must be 1000 characters or less");if(a<1||a>180)throw new Error("Duration must be between 1 and 180 days");const l=BigInt(n);if(l<=0n)throw new Error("Goal amount must be greater than 0");let u=e,m=t||"",p=s,f=0n;return await O.execute({name:"CreateCampaign",button:r,getContract:async b=>Ke(b),method:"createCampaign",args:()=>[u,m,l,BigInt(a),q(p)],get approval(){if(f>0n){const b=Hn();return{token:b.BKC_TOKEN,spender:b.CHARITY_POOL,amount:f}}return null},validate:async(b,x)=>{const y=Ke(b);try{const C=await y.userActiveCampaigns(x),I=await y.maxActiveCampaigns();if(Number(C)>=Number(I))throw new Error(`Maximum active campaigns reached (${I})`)}catch(C){if(C.message.includes("Maximum"))throw C}try{f=await y.createCostBkc()}catch{f=c.parseEther("1")}},onSuccess:async b=>{let x=null;try{const y=new c.Interface(jn);for(const C of b.logs)try{const I=y.parseLog(C);if(I.name==="CampaignCreated"){x=Number(I.args.campaignId);break}}catch{}}catch{}i&&i(b,x)},onError:o})}async function go({campaignId:e,amount:t,operator:n,button:a=null,onSuccess:s=null,onError:r=null}){const i=window.ethers;if(e==null)throw new Error("Campaign ID is required");const o=BigInt(t);if(o<=0n)throw new Error("Donation amount must be greater than 0");let c=e,l=n;return await O.execute({name:"Donate",button:a,getContract:async u=>Ke(u),method:"donate",args:()=>[c,q(l)],value:o,validate:async(u,m)=>{const p=Ke(u);try{const f=await p.getCampaign(c);if(f.creator===i.ZeroAddress)throw new Error("Campaign not found");if(Number(f.status)!==ln.ACTIVE)throw new Error("Campaign is not active");const b=Math.floor(Date.now()/1e3);if(Number(f.deadline)<=b)throw new Error("Campaign has ended")}catch(f){if(f.message.includes("Campaign")||f.message.includes("active")||f.message.includes("ended"))throw f}},onSuccess:async u=>{let m=null;try{const p=new i.Interface(jn);for(const f of u.logs)try{const b=p.parseLog(f);if(b.name==="DonationMade"){m={donationId:Number(b.args.donationId),grossAmount:b.args.grossAmount,netAmount:b.args.netAmount,feeAmount:b.args.feeAmount};break}}catch{}}catch{}s&&s(u,m)},onError:r})}async function xo({campaignId:e,button:t=null,onSuccess:n=null,onError:a=null}){const s=window.ethers;if(e==null)throw new Error("Campaign ID is required");let r=e;return await O.execute({name:"CancelCampaign",button:t,getContract:async i=>Ke(i),method:"cancelCampaign",args:[r],validate:async(i,o)=>{const c=Ke(i);try{const l=await c.getCampaign(r);if(l.creator===s.ZeroAddress)throw new Error("Campaign not found");if(l.creator.toLowerCase()!==o.toLowerCase())throw new Error("Only the campaign creator can cancel");if(Number(l.status)!==ln.ACTIVE)throw new Error("Campaign is not active")}catch(l){if(l.message.includes("Campaign")||l.message.includes("creator")||l.message.includes("active"))throw l}},onSuccess:n,onError:a})}async function ho({campaignId:e,operator:t,button:n=null,onSuccess:a=null,onError:s=null}){const r=window.ethers;if(e==null)throw new Error("Campaign ID is required");let i=e,o=t,c=0n;return await O.execute({name:"Withdraw",button:n,getContract:async l=>Ke(l),method:"withdraw",args:()=>[i,q(o)],get approval(){if(c>0n){const l=Hn();return{token:l.BKC_TOKEN,spender:l.CHARITY_POOL,amount:c}}return null},validate:async(l,u)=>{const m=Ke(l);try{const p=await m.getCampaign(i);if(p.creator===r.ZeroAddress)throw new Error("Campaign not found");if(p.creator.toLowerCase()!==u.toLowerCase())throw new Error("Only the campaign creator can withdraw");if(Number(p.status)===ln.WITHDRAWN)throw new Error("Funds already withdrawn");const[f,b]=await m.canWithdraw(i);if(!f)throw new Error(b||"Cannot withdraw yet")}catch(p){if(p.message)throw p}try{c=await m.withdrawCostBkc()}catch{c=r.parseEther("0.5")}},onSuccess:async l=>{let u=null;try{const m=new r.Interface(jn);for(const p of l.logs)try{const f=m.parseLog(p);if(f.name==="FundsWithdrawn"){u={amount:f.args.amount};break}}catch{}}catch{}a&&a(l,u)},onError:s})}async function vo({campaignId:e,ethAmount:t,operator:n,button:a=null,onSuccess:s=null,onError:r=null}){const i=window.ethers;if(e==null)throw new Error("Campaign ID is required");let o=e,c=n,l=0n,u=t?BigInt(t):0n;return await O.execute({name:"BoostCampaign",button:a,getContract:async m=>Ke(m),method:"boostCampaign",args:()=>[o,q(c)],get value(){return u},get approval(){if(l>0n){const m=Hn();return{token:m.BKC_TOKEN,spender:m.CHARITY_POOL,amount:l}}return null},validate:async(m,p)=>{const f=Ke(m);try{const b=await f.getCampaign(o);if(b.creator===i.ZeroAddress)throw new Error("Campaign not found");if(Number(b.status)!==ln.ACTIVE)throw new Error("Campaign is not active")}catch(b){if(b.message.includes("Campaign")||b.message.includes("active"))throw b}try{l=await f.boostCostBkc(),t||(u=await f.boostCostEth())}catch{l=i.parseEther("0.5"),t||(u=i.parseEther("0.001"))}},onSuccess:s,onError:r})}async function wo(e){const n=await(await be()).getCampaign(e),a=Math.floor(Date.now()/1e3);return{id:e,creator:n.creator,title:n.title,description:n.description,goalAmount:n.goalAmount,raisedAmount:n.raisedAmount,donationCount:Number(n.donationCount),deadline:Number(n.deadline),createdAt:Number(n.createdAt),boostAmount:n.boostAmount,boostTime:Number(n.boostTime),status:Number(n.status),statusName:["ACTIVE","COMPLETED","CANCELLED","WITHDRAWN"][Number(n.status)]||"UNKNOWN",goalReached:n.goalReached,progress:n.goalAmount>0n?Number(n.raisedAmount*100n/n.goalAmount):0,isEnded:Number(n.deadline)<a,isActive:Number(n.status)===ln.ACTIVE&&Number(n.deadline)>a,isBoosted:n.boostTime>0&&a-Number(n.boostTime)<86400}}async function yo(e){const t=window.ethers,a=await(await be()).getDonation(e);return{id:e,donor:a.donor,campaignId:Number(a.campaignId),grossAmount:a.grossAmount,netAmount:a.netAmount,timestamp:Number(a.timestamp),grossFormatted:t.formatEther(a.grossAmount),netFormatted:t.formatEther(a.netAmount)}}async function ko(){const e=await be();return Number(await e.campaignCounter())}async function Eo(){const e=await be();return Number(await e.donationCounter())}async function Co(e){const t=await be();return Number(await t.userActiveCampaigns(e))}async function To(){const e=await be();return Number(await e.maxActiveCampaigns())}async function Io(e){return(await(await be()).getUserCampaigns(e)).map(a=>Number(a))}async function Ao(e){return(await(await be()).getUserDonations(e)).map(a=>Number(a))}async function Bo(e){return(await(await be()).getCampaignDonations(e)).map(a=>Number(a))}async function Po(e){const t=window.ethers,a=await(await be()).previewDonation(e);return{netToCampaign:a.netToCampaign,feeToProtocol:a.feeToProtocol,netFormatted:t.formatEther(a.netToCampaign),feeFormatted:t.formatEther(a.feeToProtocol)}}async function zo(e){const t=await be(),[n,a]=await t.canWithdraw(e);return{allowed:n,reason:a}}async function No(e){return await(await be()).isBoosted(e)}async function Lo(){const e=window.ethers,n=await(await be()).getFeeConfig();return{createCostBkc:n.createBkc,createCostFormatted:e.formatEther(n.createBkc),withdrawCostBkc:n.withdrawBkc,withdrawCostFormatted:e.formatEther(n.withdrawBkc),donationFeeBips:Number(n.donationBips),donationFeePercent:Number(n.donationBips)/100,boostCostBkc:n.boostBkc,boostCostBkcFormatted:e.formatEther(n.boostBkc),boostCostEth:n.boostEth,boostCostEthFormatted:e.formatEther(n.boostEth)}}async function $o(){const e=window.ethers,n=await(await be()).getStats();return{totalCampaigns:Number(n.totalCampaigns),totalRaised:n.totalRaised,totalRaisedFormatted:e.formatEther(n.totalRaised),totalDonations:Number(n.totalDonations),totalFees:n.totalFees,totalFeesFormatted:e.formatEther(n.totalFees)}}async function So(){const e=await be();try{return await e.withdrawCostBkc()}catch{return 0n}}async function Ro(){const e=await be();try{return await e.createCostBkc()}catch{return 0n}}const Ot={createCampaign:bo,donate:go,cancelCampaign:xo,withdraw:ho,boostCampaign:vo,getCampaign:wo,getCampaignCount:ko,getCampaignDonations:Bo,canWithdraw:zo,isBoosted:No,getDonation:yo,getDonationCount:Eo,previewDonation:Po,getUserActiveCampaigns:Co,getMaxActiveCampaigns:To,getUserCampaigns:Io,getUserDonations:Ao,getFeeConfig:Lo,getStats:$o,getWithdrawalFee:So,getCreateFee:Ro,CampaignStatus:ln},Np=Object.freeze(Object.defineProperty({__proto__:null,CharityTx:Ot,boostCampaign:vo,canWithdraw:zo,cancelCampaign:xo,createCampaign:bo,donate:go,getCampaign:wo,getCampaignCount:ko,getCampaignDonations:Bo,getCreateFee:Ro,getDonation:yo,getDonationCount:Eo,getFeeConfig:Lo,getMaxActiveCampaigns:To,getStats:$o,getUserActiveCampaigns:Co,getUserCampaigns:Io,getUserDonations:Ao,getWithdrawalFee:So,isBoosted:No,previewDonation:Po,withdraw:ho},Symbol.toStringTag,{value:"Module"}));function Xs(){var n,a;const e=(w==null?void 0:w.delegationManager)||($==null?void 0:$.delegationManager)||((n=window.contractAddresses)==null?void 0:n.delegationManager),t=(w==null?void 0:w.bkcToken)||($==null?void 0:$.bkcToken)||((a=window.contractAddresses)==null?void 0:a.bkcToken);if(!e)throw console.error("❌ DelegationManager address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");if(!t)throw console.error("❌ BKC Token address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{BKC_TOKEN:t,DELEGATION_MANAGER:e}}const _o=["function delegate(uint256 amount, uint256 lockDuration, address operator) external","function unstake(uint256 delegationIndex, address operator) external","function forceUnstake(uint256 delegationIndex, address operator) external","function claimReward(address operator) external payable","function getDelegationsOf(address user) view returns (tuple(uint256 amount, uint64 unlockTime, uint64 lockDuration)[])","function pendingRewards(address user) view returns (uint256)","function userTotalPStake(address user) view returns (uint256)","function totalNetworkPStake() view returns (uint256)","function MIN_LOCK_DURATION() view returns (uint256)","function MAX_LOCK_DURATION() view returns (uint256)","function claimEthFee() view returns (uint256)","function getUserBestBoost(address user) view returns (uint256)","function getBurnRateForBoost(uint256 boost) view returns (uint256)","function previewClaim(address user) view returns (uint256 totalRewards, uint256 burnAmount, uint256 userReceives, uint256 burnRateBips, uint256 nftBoost)","event Delegated(address indexed user, uint256 indexed delegationIndex, uint256 amount, uint256 pStake, uint256 feePaid, address operator)","event Unstaked(address indexed user, uint256 indexed delegationIndex, uint256 amountReceived, uint256 feePaid, address operator)","event RewardClaimed(address indexed user, uint256 amountReceived, uint256 burnedAmount, uint256 ethFeePaid, uint256 nftBoostUsed, address operator)"];function St(e){const t=window.ethers,n=Xs();return new t.Contract(n.DELEGATION_MANAGER,_o,e)}async function Wn(){const e=window.ethers,{NetworkManager:t}=await W(async()=>{const{NetworkManager:s}=await import("./index-DZsKjxq8.js");return{NetworkManager:s}},[]),n=t.getProvider(),a=Xs();return new e.Contract(a.DELEGATION_MANAGER,_o,n)}function Lp(e){return BigInt(e)*24n*60n*60n}async function Fo({amount:e,lockDays:t,lockDuration:n,operator:a,button:s=null,onSuccess:r=null,onError:i=null}){let o;if(n!=null){o=BigInt(n);const u=Number(o)/86400;if(u<1||u>3650)throw new Error("Lock duration must be between 1 and 3650 days")}else if(t!=null)Z.staking.validateDelegate({amount:e,lockDays:t}),o=Lp(t);else throw new Error("Either lockDays or lockDuration must be provided");const c=BigInt(e);let l=a;return await O.execute({name:"Delegate",button:s,getContract:async u=>St(u),method:"delegate",args:()=>[c,o,q(l)],approval:(()=>{const u=Xs();return{token:u.BKC_TOKEN,spender:u.DELEGATION_MANAGER,amount:c}})(),onSuccess:r,onError:i})}async function Mo({delegationIndex:e,operator:t,button:n=null,onSuccess:a=null,onError:s=null}){Z.staking.validateUnstake({delegationIndex:e});let r=e,i=t;return await O.execute({name:"Unstake",button:n,getContract:async o=>St(o),method:"unstake",args:()=>[r,q(i)],validate:async(o,c)=>{const u=await St(o).getDelegationsOf(c);if(r>=u.length)throw new Error("Delegation not found");const m=u[r],p=Math.floor(Date.now()/1e3);if(Number(m.unlockTime)>p){const f=Math.ceil((Number(m.unlockTime)-p)/86400);throw new Error(`Lock period still active. ${f} day(s) remaining. Use Force Unstake if needed.`)}},onSuccess:a,onError:s})}async function Do({delegationIndex:e,operator:t,button:n=null,onSuccess:a=null,onError:s=null}){Z.staking.validateUnstake({delegationIndex:e});let r=e,i=t;return await O.execute({name:"ForceUnstake",button:n,getContract:async o=>St(o),method:"forceUnstake",args:()=>[r,q(i)],validate:async(o,c)=>{const u=await St(o).getDelegationsOf(c);if(r>=u.length)throw new Error("Delegation not found");const m=u[r],p=Math.floor(Date.now()/1e3);if(Number(m.unlockTime)<=p)throw new Error("Lock period has ended. Use normal Unstake to avoid penalty.")},onSuccess:a,onError:s})}async function Oo({operator:e,button:t=null,onSuccess:n=null,onError:a=null}={}){let s=e,r=0n;return await O.execute({name:"ClaimReward",button:t,getContract:async i=>St(i),method:"claimReward",args:()=>[q(s)],get value(){return r},validate:async(i,o)=>{const c=St(i);if(await c.pendingRewards(o)<=0n)throw new Error("No rewards available to claim");try{r=await c.claimEthFee()}catch{r=0n}},onSuccess:n,onError:a})}async function Uo(e){const n=await(await Wn()).getDelegationsOf(e),a=Math.floor(Date.now()/1e3);return n.map((s,r)=>({index:r,amount:s.amount,unlockTime:Number(s.unlockTime),lockDuration:Number(s.lockDuration),isUnlocked:Number(s.unlockTime)<=a,daysRemaining:Number(s.unlockTime)>a?Math.ceil((Number(s.unlockTime)-a)/86400):0}))}async function Ho(e){return await(await Wn()).pendingRewards(e)}async function jo(e){return await(await Wn()).userTotalPStake(e)}async function Wo(){return await(await Wn()).totalNetworkPStake()}async function Go(){return 50}async function Ko(){const e=await Wn(),[t,n]=await Promise.all([e.MIN_LOCK_DURATION(),e.MAX_LOCK_DURATION()]);return{minLockDays:Number(t)/86400,maxLockDays:Number(n)/86400,minLockSeconds:Number(t),maxLockSeconds:Number(n),penaltyPercent:50,penaltyBips:5e3}}const Rt={delegate:Fo,unstake:Mo,forceUnstake:Do,claimRewards:Oo,getUserDelegations:Uo,getPendingRewards:Ho,getUserPStake:jo,getTotalPStake:Wo,getEarlyUnstakePenalty:Go,getStakingConfig:Ko},$p=Object.freeze(Object.defineProperty({__proto__:null,StakingTx:Rt,claimRewards:Oo,delegate:Fo,forceUnstake:Do,getEarlyUnstakePenalty:Go,getPendingRewards:Ho,getStakingConfig:Ko,getTotalPStake:Wo,getUserDelegations:Uo,getUserPStake:jo,unstake:Mo},Symbol.toStringTag,{value:"Module"})),Yo=["diamond","gold","silver","bronze"];function Gn(e=null){var s,r,i;const t=(w==null?void 0:w.bkcToken)||($==null?void 0:$.bkcToken)||((s=window.contractAddresses)==null?void 0:s.bkcToken),n=(w==null?void 0:w.rewardBoosterNFT)||($==null?void 0:$.rewardBoosterNFT)||((r=window.contractAddresses)==null?void 0:r.rewardBoosterNFT);let a=null;if(e){const o=`pool_${e.toLowerCase()}`;a=(w==null?void 0:w[o])||($==null?void 0:$[o])||((i=window.contractAddresses)==null?void 0:i[o])}if(!t||!n)throw new Error("Contract addresses not loaded");return{BKC_TOKEN:t,NFT_CONTRACT:n,NFT_POOL:a}}function Ut(e){var n;const t=`pool_${e.toLowerCase()}`;return(w==null?void 0:w[t])||($==null?void 0:$[t])||((n=window.contractAddresses)==null?void 0:n[t])||null}function Sp(){const e={};for(const t of Yo){const n=Ut(t);n&&(e[t]=n)}return e}const Sa=["function buyNFT(uint256 _maxPrice, address _operator) external payable returns (uint256 tokenId)","function buySpecificNFT(uint256 _tokenId, uint256 _maxPrice, address _operator) external payable","function buyNFTWithSlippage(uint256 _maxPrice, address _operator) external payable returns (uint256 tokenId)","function sellNFT(uint256 _tokenId, uint256 _minPayout, address _operator) external payable","function getBuyPrice() view returns (uint256)","function getBuyPriceWithTax() view returns (uint256)","function getSellPrice() view returns (uint256)","function getSellPriceAfterTax() view returns (uint256)","function getTotalBuyCost() view returns (uint256 bkcCost, uint256 ethCost)","function getTotalSellInfo() view returns (uint256 bkcPayout, uint256 ethCost)","function getSpread() view returns (uint256 spread, uint256 spreadBips)","function getPoolInfo() view returns (uint256 bkcBalance, uint256 nftCount, uint256 k, bool initialized)","function getAvailableNFTs() view returns (uint256[])","function getNFTBalance() view returns (uint256)","function getBKCBalance() view returns (uint256)","function isNFTInPool(uint256 _tokenId) view returns (bool)","function boostBips() view returns (uint256)","function getTierName() view returns (string)","function buyEthFee() view returns (uint256)","function sellEthFee() view returns (uint256)","function getEthFeeConfig() view returns (uint256 buyFee, uint256 sellFee, uint256 totalCollected)","function totalETHCollected() view returns (uint256)","function getTradingStats() view returns (uint256 volume, uint256 taxes, uint256 buys, uint256 sells)","function totalVolume() view returns (uint256)","function totalTaxesCollected() view returns (uint256)","function totalBuys() view returns (uint256)","function totalSells() view returns (uint256)","event NFTPurchased(address indexed buyer, uint256 indexed tokenId, uint256 price, uint256 tax, uint256 newBkcBalance, uint256 newNftCount, address operator)","event NFTSold(address indexed seller, uint256 indexed tokenId, uint256 payout, uint256 tax, uint256 newBkcBalance, uint256 newNftCount, address operator)"],Vo=["function setApprovalForAll(address operator, bool approved) external","function isApprovedForAll(address owner, address operator) view returns (bool)","function ownerOf(uint256 tokenId) view returns (address)","function balanceOf(address owner) view returns (uint256)","function boostBips(uint256 tokenId) view returns (uint256)"];function xt(e,t){return new window.ethers.Contract(t,Sa,e)}async function Be(e){const{NetworkManager:t}=await W(async()=>{const{NetworkManager:n}=await import("./index-DZsKjxq8.js");return{NetworkManager:n}},[]);return new window.ethers.Contract(e,Sa,t.getProvider())}function xs(e){const t=Gn();return new window.ethers.Contract(t.NFT_CONTRACT,Vo,e)}async function Rp(){const{NetworkManager:e}=await W(async()=>{const{NetworkManager:n}=await import("./index-DZsKjxq8.js");return{NetworkManager:n}},[]),t=Gn();return new window.ethers.Contract(t.NFT_CONTRACT,Vo,e.getProvider())}async function Js({poolAddress:e,poolTier:t,operator:n,button:a=null,onSuccess:s=null,onError:r=null}){const i=window.ethers,o=Gn(),c=e||Ut(t);if(!c)throw new Error("Pool address or valid pool tier is required");let l=n,u=0n,m=0n;return await O.execute({name:"BuyNFT",button:a,getContract:async p=>xt(p,c),method:"buyNFT",args:()=>[u,q(l)],get value(){return m},get approval(){return u>0n?{token:o.BKC_TOKEN,spender:c,amount:u}:null},validate:async(p,f)=>{const b=xt(p,c);if(await b.getNFTBalance()===0n)throw new Error("No NFTs available in pool");try{const[N,T]=await b.getTotalBuyCost();u=N,m=T}catch{u=await b.getBuyPriceWithTax(),m=await b.buyEthFee().catch(()=>0n)}const{NetworkManager:y}=await W(async()=>{const{NetworkManager:N}=await import("./index-DZsKjxq8.js");return{NetworkManager:N}},[]),C=y.getProvider();if(await new i.Contract(o.BKC_TOKEN,["function balanceOf(address) view returns (uint256)"],C).balanceOf(f)<u)throw new Error(`Insufficient BKC. Need ${i.formatEther(u)} BKC`);if(await C.getBalance(f)<m+i.parseEther("0.001"))throw new Error("Insufficient ETH for fee + gas")},onSuccess:async p=>{let f=null;try{const b=new i.Interface(Sa);for(const x of p.logs)try{const y=b.parseLog(x);if((y==null?void 0:y.name)==="NFTPurchased"){f=Number(y.args.tokenId);break}}catch{}}catch{}s&&s(p,f)},onError:r})}async function qo({poolAddress:e,poolTier:t,tokenId:n,operator:a,button:s=null,onSuccess:r=null,onError:i=null}){const o=window.ethers,c=Gn(),l=e||Ut(t);if(!l)throw new Error("Pool address or valid pool tier is required");if(n===void 0)throw new Error("Token ID is required");let u=a,m=0n,p=0n;return await O.execute({name:"BuySpecificNFT",button:s,getContract:async f=>xt(f,l),method:"buySpecificNFT",args:()=>[n,m,q(u)],get value(){return p},get approval(){return m>0n?{token:c.BKC_TOKEN,spender:l,amount:m}:null},validate:async(f,b)=>{const x=xt(f,l);if(!await x.isNFTInPool(n))throw new Error("NFT is not in pool");try{const[B,z]=await x.getTotalBuyCost();m=B,p=z}catch{m=await x.getBuyPriceWithTax(),p=await x.buyEthFee().catch(()=>0n)}const{NetworkManager:y}=await W(async()=>{const{NetworkManager:B}=await import("./index-DZsKjxq8.js");return{NetworkManager:B}},[]),C=y.getProvider();if(await new o.Contract(c.BKC_TOKEN,["function balanceOf(address) view returns (uint256)"],C).balanceOf(b)<m)throw new Error("Insufficient BKC");if(await C.getBalance(b)<p+o.parseEther("0.001"))throw new Error("Insufficient ETH")},onSuccess:r,onError:i})}async function Xo({poolAddress:e,poolTier:t,maxPrice:n,operator:a,button:s=null,onSuccess:r=null,onError:i=null}){const o=window.ethers,c=Gn(),l=e||Ut(t);if(!l)throw new Error("Pool address or valid pool tier is required");const u=BigInt(n);let m=a,p=0n;return await O.execute({name:"BuyNFTWithSlippage",button:s,getContract:async f=>xt(f,l),method:"buyNFTWithSlippage",args:()=>[u,q(m)],get value(){return p},approval:{token:c.BKC_TOKEN,spender:l,amount:u},validate:async(f,b)=>{const x=xt(f,l);if(await x.getNFTBalance()===0n)throw new Error("No NFTs available");if(await x.getBuyPriceWithTax()>u)throw new Error("Price exceeds max");p=await x.buyEthFee().catch(()=>0n);const{NetworkManager:C}=await W(async()=>{const{NetworkManager:z}=await import("./index-DZsKjxq8.js");return{NetworkManager:z}},[]),I=C.getProvider();if(await new o.Contract(c.BKC_TOKEN,["function balanceOf(address) view returns (uint256)"],I).balanceOf(b)<u)throw new Error("Insufficient BKC");if(await I.getBalance(b)<p+o.parseEther("0.001"))throw new Error("Insufficient ETH")},onSuccess:async f=>{let b=null;try{const x=new o.Interface(Sa);for(const y of f.logs)try{const C=x.parseLog(y);if((C==null?void 0:C.name)==="NFTPurchased"){b=Number(C.args.tokenId);break}}catch{}}catch{}r&&r(f,b)},onError:i})}async function Zs({poolAddress:e,poolTier:t,tokenId:n,minPayout:a,operator:s,button:r=null,onSuccess:i=null,onError:o=null}){const c=window.ethers,l=e||Ut(t);if(!l)throw new Error("Pool address or valid pool tier is required");if(n===void 0)throw new Error("Token ID is required");let u=s,m=0n,p=0n;return await O.execute({name:"SellNFT",button:r,getContract:async f=>xt(f,l),method:"sellNFT",args:()=>[n,m,q(u)],get value(){return p},validate:async(f,b)=>{const x=xt(f,l),y=xs(f);if((await y.ownerOf(n)).toLowerCase()!==b.toLowerCase())throw new Error("You do not own this NFT");const I=await x.boostBips(),B=await y.boostBips(n);if(I!==B)throw new Error("NFT tier does not match pool tier");try{const[T,F]=await x.getTotalSellInfo();m=a?BigInt(a):T*95n/100n,p=F}catch{const T=await x.getSellPriceAfterTax();m=a?BigInt(a):T*95n/100n,p=await x.sellEthFee().catch(()=>0n)}const{NetworkManager:z}=await W(async()=>{const{NetworkManager:T}=await import("./index-DZsKjxq8.js");return{NetworkManager:T}},[]);if(await z.getProvider().getBalance(b)<p+c.parseEther("0.001"))throw new Error("Insufficient ETH");await y.isApprovedForAll(b,l)||await(await y.setApprovalForAll(l,!0)).wait()},onSuccess:i,onError:o})}async function Jo({poolAddress:e,poolTier:t,button:n=null,onSuccess:a=null,onError:s=null}){const r=e||Ut(t);if(!r)throw new Error("Pool address or valid pool tier is required");return await O.execute({name:"ApproveAllNFTs",button:n,getContract:async i=>xs(i),method:"setApprovalForAll",args:[r,!0],validate:async(i,o)=>{if(await xs(i).isApprovedForAll(o,r))throw new Error("Already approved")},onSuccess:a,onError:s})}async function Zo(e){return await(await Be(e)).getBuyPrice()}async function Qo(e){return await(await Be(e)).getBuyPriceWithTax()}async function ec(e){return await(await Be(e)).getSellPrice()}async function tc(e){return await(await Be(e)).getSellPriceAfterTax()}async function nc(e){const t=window.ethers,n=await Be(e);try{const[a,s]=await n.getTotalBuyCost();return{bkcCost:a,bkcFormatted:t.formatEther(a),ethCost:s,ethFormatted:t.formatEther(s)}}catch{const a=await n.getBuyPriceWithTax(),s=await n.buyEthFee().catch(()=>0n);return{bkcCost:a,bkcFormatted:t.formatEther(a),ethCost:s,ethFormatted:t.formatEther(s)}}}async function ac(e){const t=window.ethers,n=await Be(e);try{const[a,s]=await n.getTotalSellInfo();return{bkcPayout:a,bkcFormatted:t.formatEther(a),ethCost:s,ethFormatted:t.formatEther(s)}}catch{const a=await n.getSellPriceAfterTax(),s=await n.sellEthFee().catch(()=>0n);return{bkcPayout:a,bkcFormatted:t.formatEther(a),ethCost:s,ethFormatted:t.formatEther(s)}}}async function sc(e){const t=window.ethers,n=await Be(e),[a,s,r,i]=await Promise.all([n.getPoolInfo(),n.getBuyPrice().catch(()=>0n),n.getSellPrice().catch(()=>0n),n.boostBips()]);return{bkcBalance:a.bkcBalance,nftCount:Number(a.nftCount),k:a.k,initialized:a.initialized,boostBips:Number(i),buyPrice:s,buyPriceFormatted:t.formatEther(s),sellPrice:r,sellPriceFormatted:t.formatEther(r)}}async function rc(e){return(await(await Be(e)).getAvailableNFTs()).map(n=>Number(n))}async function ic(e){const t=window.ethers,n=await Be(e);try{const a=await n.getEthFeeConfig();return{buyFee:a.buyFee,buyFeeFormatted:t.formatEther(a.buyFee),sellFee:a.sellFee,sellFeeFormatted:t.formatEther(a.sellFee),totalCollected:a.totalCollected,totalCollectedFormatted:t.formatEther(a.totalCollected)}}catch{const[a,s,r]=await Promise.all([n.buyEthFee().catch(()=>0n),n.sellEthFee().catch(()=>0n),n.totalETHCollected().catch(()=>0n)]);return{buyFee:a,buyFeeFormatted:t.formatEther(a),sellFee:s,sellFeeFormatted:t.formatEther(s),totalCollected:r,totalCollectedFormatted:t.formatEther(r)}}}async function oc(e){const t=window.ethers,n=await Be(e);try{const a=await n.getTradingStats();return{volume:a.volume,volumeFormatted:t.formatEther(a.volume),taxes:a.taxes,taxesFormatted:t.formatEther(a.taxes),buys:Number(a.buys),sells:Number(a.sells)}}catch{const[a,s,r,i]=await Promise.all([n.totalVolume().catch(()=>0n),n.totalTaxesCollected().catch(()=>0n),n.totalBuys().catch(()=>0n),n.totalSells().catch(()=>0n)]);return{volume:a,volumeFormatted:t.formatEther(a),taxes:s,taxesFormatted:t.formatEther(s),buys:Number(r),sells:Number(i)}}}async function cc(e){const t=await Be(e);try{return await t.getTierName()}catch{const n=await t.boostBips();return{5e3:"Diamond",4e3:"Gold",2500:"Silver",1e3:"Bronze"}[Number(n)]||"Unknown"}}async function lc(e){const t=window.ethers,n=await Be(e);try{const a=await n.getSpread();return{spread:a.spread,spreadFormatted:t.formatEther(a.spread),spreadBips:Number(a.spreadBips),spreadPercent:Number(a.spreadBips)/100}}catch{const[a,s]=await Promise.all([n.getBuyPrice().catch(()=>0n),n.getSellPrice().catch(()=>0n)]),r=a>s?a-s:0n,i=s>0n?Number(r*10000n/s):0;return{spread:r,spreadFormatted:t.formatEther(r),spreadBips:i,spreadPercent:i/100}}}async function dc(e,t){return await(await Be(e)).isNFTInPool(t)}async function uc(e,t){return await(await Rp()).isApprovedForAll(e,t)}const pc=Js,mc=Zs,hs={buyNft:Js,buySpecificNft:qo,buyNftWithSlippage:Xo,sellNft:Zs,approveAllNfts:Jo,buyFromPool:pc,sellToPool:mc,getBuyPrice:Zo,getBuyPriceWithTax:Qo,getSellPrice:ec,getSellPriceAfterTax:tc,getTotalBuyCost:nc,getTotalSellInfo:ac,getEthFeeConfig:ic,getPoolInfo:sc,getAvailableNfts:rc,isNFTInPool:dc,isApprovedForAll:uc,getTradingStats:oc,getTierName:cc,getSpread:lc,getPoolAddress:Ut,getAllPools:Sp,POOL_TIERS:Yo},_p=Object.freeze(Object.defineProperty({__proto__:null,NftTx:hs,approveAllNfts:Jo,buyFromPool:pc,buyNft:Js,buyNftWithSlippage:Xo,buySpecificNft:qo,getAvailableNfts:rc,getBuyPrice:Zo,getBuyPriceWithTax:Qo,getEthFeeConfig:ic,getPoolInfo:sc,getSellPrice:ec,getSellPriceAfterTax:tc,getSpread:lc,getTierName:cc,getTotalBuyCost:nc,getTotalSellInfo:ac,getTradingStats:oc,isApprovedForAll:uc,isNFTInPool:dc,sellNft:Zs,sellToPool:mc},Symbol.toStringTag,{value:"Module"}));function Qs(){var n,a,s;const e=(w==null?void 0:w.fortunePoolV2)||(w==null?void 0:w.fortunePool)||($==null?void 0:$.fortunePoolV2)||($==null?void 0:$.fortunePool)||((n=window.contractAddresses)==null?void 0:n.fortunePoolV2)||((a=window.contractAddresses)==null?void 0:a.fortunePool),t=(w==null?void 0:w.bkcToken)||($==null?void 0:$.bkcToken)||((s=window.contractAddresses)==null?void 0:s.bkcToken);if(!e)throw console.error("❌ FortunePool address not found!",{addresses:w,contractAddresses:$}),new Error("Contract addresses not loaded. Please refresh the page.");if(!t)throw console.error("❌ BKC Token address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{BKC_TOKEN:t,FORTUNE_POOL:e}}const Ra=["function commitPlay(bytes32 _commitmentHash, uint256 _wagerAmount, bool _isCumulative, address _operator) external payable returns (uint256 gameId)","function revealPlay(uint256 _gameId, uint256[] calldata _guesses, bytes32 _userSecret) external returns (uint256 prizeWon)","function generateCommitmentHash(uint256[] calldata _guesses, bytes32 _userSecret) external pure returns (bytes32 hash)","function claimExpiredGame(uint256 _gameId) external","function activeTierCount() view returns (uint256)","function prizeTiers(uint256 tierId) view returns (uint128 maxRange, uint64 multiplierBips, bool active)","function getAllTiers() view returns (uint128[] ranges, uint64[] multipliers)","function serviceFee() view returns (uint256)","function getRequiredServiceFee(bool _isCumulative) view returns (uint256)","function gameFeeBips() view returns (uint256)","function gameCounter() view returns (uint256)","function prizePoolBalance() view returns (uint256)","function revealDelay() view returns (uint256)","function revealWindow() view returns (uint256)","function getCommitment(uint256 _gameId) view returns (address player, uint64 commitBlock, bool isCumulative, uint8 status, uint256 wagerAmount, uint256 ethPaid)","function getCommitmentStatus(uint256 _gameId) view returns (uint8 status, bool canReveal, bool isExpired, uint256 blocksUntilReveal, uint256 blocksUntilExpiry)","function commitmentMeta(uint256 _gameId) view returns (bytes32 hash, address operator, uint96 tierNonce)","function getGameResult(uint256 _gameId) view returns (address player, uint256 wagerAmount, uint256 prizeWon, uint256[] guesses, uint256[] rolls, bool isCumulative, uint8 matchCount, uint256 timestamp)","function totalWageredAllTime() view returns (uint256)","function totalPaidOutAllTime() view returns (uint256)","function totalWinsAllTime() view returns (uint256)","function totalETHCollected() view returns (uint256)","function totalBKCFees() view returns (uint256)","function totalExpiredGames() view returns (uint256)","function getPoolStats() view returns (uint256 poolBalance, uint256 gamesPlayed, uint256 wageredAllTime, uint256 paidOutAllTime, uint256 winsAllTime, uint256 ethCollected, uint256 bkcFees, uint256 expiredGames)","function calculatePotentialWinnings(uint256 _wagerAmount, bool _isCumulative) view returns (uint256 maxPrize, uint256 netWager)","function getExpectedGuessCount(bool _isCumulative) view returns (uint256)","event GameCommitted(uint256 indexed gameId, address indexed player, uint256 wagerAmount, bool isCumulative, address operator)","event GameRevealed(uint256 indexed gameId, address indexed player, uint256 wagerAmount, uint256 prizeWon, bool isCumulative, uint8 matchCount, address operator)","event GameDetails(uint256 indexed gameId, uint256[] guesses, uint256[] rolls, bool[] matches)","event JackpotWon(uint256 indexed gameId, address indexed player, uint256 prizeAmount, uint256 tier)","event GameExpired(uint256 indexed gameId, address indexed player, uint256 forfeitedAmount)"];function fc(e){const t=window.ethers,n=Qs();return new t.Contract(n.FORTUNE_POOL,Ra,e)}async function $e(){const e=window.ethers,{NetworkManager:t}=await W(async()=>{const{NetworkManager:s}=await import("./index-DZsKjxq8.js");return{NetworkManager:s}},[]),n=t.getProvider(),a=Qs();return new e.Contract(a.FORTUNE_POOL,Ra,n)}const er="fortune_pending_games";function _a(){try{return JSON.parse(localStorage.getItem(er)||"{}")}catch{return{}}}function Fp(e,t){const n=_a();n[e]={...t,savedAt:Date.now()},localStorage.setItem(er,JSON.stringify(n))}function Mp(e){const t=_a();delete t[e],localStorage.setItem(er,JSON.stringify(t))}function tr(e,t){const n=window.ethers,a=n.solidityPacked(["uint256[]","bytes32"],[e.map(s=>BigInt(s)),t]);return n.keccak256(a)}function bc(){const e=window.ethers;return e.hexlify(e.randomBytes(32))}async function nr({commitmentHash:e,wagerAmount:t,isCumulative:n=!1,operator:a,button:s=null,onSuccess:r=null,onError:i=null}){const o=window.ethers,c=Qs(),l=BigInt(t);let u=e,m=n,p=a,f=0n;try{f=await(await $e()).getRequiredServiceFee(n),console.log("[FortuneTx] Service fee:",o.formatEther(f),"ETH")}catch(b){throw console.error("[FortuneTx] Could not fetch service fee:",b.message),new Error("Could not fetch service fee from contract")}return await O.execute({name:"CommitPlay",button:s,getContract:async b=>fc(b),method:"commitPlay",args:()=>[u,l,m,q(p)],value:f,approval:{token:c.BKC_TOKEN,spender:c.FORTUNE_POOL,amount:l},validate:async(b,x)=>{const{NetworkManager:y}=await W(async()=>{const{NetworkManager:N}=await import("./index-DZsKjxq8.js");return{NetworkManager:N}},[]),C=y.getProvider(),I=await $e(),B=await C.getBalance(x);if(f>0n&&B<f)throw new Error(`Insufficient ETH for service fee (${o.formatEther(f)} ETH required)`);if(Number(await I.activeTierCount())===0)throw new Error("No active tiers available");if(l<=0n)throw new Error("Wager amount must be greater than 0")},onSuccess:async b=>{let x=null;try{const y=new o.Interface(Ra);for(const C of b.logs)try{const I=y.parseLog(C);if(I.name==="GameCommitted"){x=Number(I.args.gameId);break}}catch{}}catch{}r&&r({gameId:x,txHash:b.hash,commitBlock:b.blockNumber})},onError:i})}async function ar({gameId:e,guesses:t,userSecret:n,button:a=null,onSuccess:s=null,onError:r=null}){const i=window.ethers,o=t.map(c=>BigInt(c));return await O.execute({name:"RevealPlay",button:a,getContract:async c=>fc(c),method:"revealPlay",args:[e,o,n],validate:async(c,l)=>{const u=await $e(),m=await u.getCommitmentStatus(e);if(m.isExpired)throw new Error("Game has expired. You can no longer reveal.");if(!m.canReveal)throw m.blocksUntilReveal>0?new Error(`Must wait ${m.blocksUntilReveal} more blocks before reveal`):new Error("Cannot reveal this game");if((await u.getCommitment(e)).player.toLowerCase()!==l.toLowerCase())throw new Error("You are not the owner of this game");const f=await u.commitmentMeta(e),b=tr(t,n);if(f.hash.toLowerCase()!==b.toLowerCase())throw new Error("Hash mismatch - guesses or secret do not match commitment")},onSuccess:async c=>{let l=null;try{const u=new i.Interface(Ra);for(const m of c.logs)try{const p=u.parseLog(m);p.name==="GameRevealed"&&(l={gameId:Number(p.args.gameId),wagerAmount:p.args.wagerAmount,prizeWon:p.args.prizeWon,isCumulative:p.args.isCumulative,matchCount:Number(p.args.matchCount),won:p.args.prizeWon>0n}),p.name==="GameDetails"&&l&&(l.guesses=p.args.guesses.map(f=>Number(f)),l.rolls=p.args.rolls.map(f=>Number(f)),l.matches=p.args.matches),p.name==="JackpotWon"&&l&&(l.jackpot=!0,l.jackpotTier=Number(p.args.tier))}catch{}}catch{}Mp(e),s&&s(c,l)},onError:r})}async function gc({wagerAmount:e,guess:t,guesses:n,isCumulative:a=!1,operator:s,button:r=null,onSuccess:i=null,onError:o=null}){let c=[];if(a)if(n&&Array.isArray(n)&&n.length>0)c=n.map(f=>Number(f));else if(t!==void 0)c=[Number(Array.isArray(t)?t[0]:t)];else throw new Error("Guesses array is required for cumulative mode");else{let f;if(t!==void 0)f=Array.isArray(t)?t[0]:t;else if(n&&n.length>0)f=n[n.length-1];else throw new Error("Guess is required");c=[Number(f)]}const l=await $e(),u=Number(await l.activeTierCount());if(u===0)throw new Error("No active tiers available");if(a){if(c.length!==u)throw new Error(`Cumulative mode requires ${u} guesses (one per tier), got ${c.length}`);for(let f=0;f<u;f++){const b=await l.prizeTiers(f+1),x=Number(b.maxRange);if(c[f]<1||c[f]>x)throw new Error(`Tier ${f+1} guess must be between 1 and ${x}`)}}else{if(c.length!==1)throw new Error("Jackpot mode requires exactly 1 guess");const f=await l.prizeTiers(u),b=Number(f.maxRange);if(c[0]<1||c[0]>b)throw new Error(`Jackpot guess must be between 1 and ${b}`)}const m=bc(),p=tr(c,m);return console.log("[FortuneTx] Generated commitment:",{guesses:c,userSecret:m.slice(0,10)+"...",commitmentHash:p.slice(0,10)+"..."}),await nr({commitmentHash:p,wagerAmount:e,isCumulative:a,operator:s,button:r,onSuccess:f=>{Fp(f.gameId,{guesses:c,userSecret:m,isCumulative:a,wagerAmount:e.toString(),commitmentHash:p}),console.log("[FortuneTx] Game committed, stored for reveal:",f.gameId),i&&i({...f,guesses:c,userSecret:m,isCumulative:a})},onError:o})}async function xc(){const e=await $e(),t=Number(await e.activeTierCount()),n=[];for(let a=1;a<=t;a++)try{const s=await e.prizeTiers(a);s.active&&n.push({tierId:a,maxRange:Number(s.maxRange),multiplierBips:Number(s.multiplierBips),multiplier:Number(s.multiplierBips)/1e4,active:s.active})}catch{break}return n}async function hc(e){const t=await $e();try{const n=await t.prizeTiers(e);if(n.active)return{tierId:e,maxRange:Number(n.maxRange),multiplierBips:Number(n.multiplierBips),multiplier:Number(n.multiplierBips)/1e4,active:n.active}}catch{}return null}async function vc(e=!1){const t=await $e();try{return await t.getRequiredServiceFee(e)}catch{try{const a=await t.serviceFee();return e?a*5n:a}catch{return console.warn("[FortuneTx] Could not fetch service fee"),0n}}}async function wc(){const e=window.ethers,t=await $e();try{const n=await t.getPoolStats();return{prizePoolBalance:n.poolBalance,prizePoolFormatted:e.formatEther(n.poolBalance),gameCounter:Number(n.gamesPlayed),totalWageredAllTime:n.wageredAllTime,totalWageredFormatted:e.formatEther(n.wageredAllTime),totalPaidOutAllTime:n.paidOutAllTime,totalPaidOutFormatted:e.formatEther(n.paidOutAllTime),totalWinsAllTime:Number(n.winsAllTime),totalETHCollected:n.ethCollected,totalBKCFees:n.bkcFees,totalExpiredGames:Number(n.expiredGames)}}catch{const[n,a,s,r,i]=await Promise.all([t.gameCounter().catch(()=>0n),t.prizePoolBalance().catch(()=>0n),t.totalWageredAllTime().catch(()=>0n),t.totalPaidOutAllTime().catch(()=>0n),t.totalWinsAllTime().catch(()=>0n)]);return{gameCounter:Number(n),prizePoolBalance:a,prizePoolFormatted:e.formatEther(a),totalWageredAllTime:s,totalWageredFormatted:e.formatEther(s),totalPaidOutAllTime:r,totalPaidOutFormatted:e.formatEther(r),totalWinsAllTime:Number(i)}}}async function yc(){const e=await $e();return Number(await e.activeTierCount())}async function kc(e,t=!1){const n=window.ethers,a=await $e();try{const s=await a.calculatePotentialWinnings(e,t);return{maxPrize:s.maxPrize,maxPrizeFormatted:n.formatEther(s.maxPrize),netWager:s.netWager,netWagerFormatted:n.formatEther(s.netWager)}}catch{return{maxPrize:0n,netWager:0n}}}async function Ec(e){const t=await $e();try{const n=await t.getGameResult(e);return{player:n.player,wagerAmount:n.wagerAmount,prizeWon:n.prizeWon,guesses:n.guesses.map(a=>Number(a)),rolls:n.rolls.map(a=>Number(a)),isCumulative:n.isCumulative,matchCount:Number(n.matchCount),timestamp:Number(n.timestamp),won:n.prizeWon>0n}}catch{return null}}async function Cc(e){const t=await $e();try{const n=await t.getCommitmentStatus(e);return{status:Number(n.status),statusName:["NONE","COMMITTED","REVEALED","EXPIRED"][Number(n.status)]||"UNKNOWN",canReveal:n.canReveal,isExpired:n.isExpired,blocksUntilReveal:Number(n.blocksUntilReveal),blocksUntilExpiry:Number(n.blocksUntilExpiry)}}catch{return null}}function Tc(){return _a()}function sr(e){return _a()[e]||null}async function Ic(e,t={}){const n=sr(e);if(!n)throw new Error(`No pending game found with ID ${e}`);return await ar({gameId:e,guesses:n.guesses,userSecret:n.userSecret,...t})}const rr={commitPlay:nr,revealPlay:ar,playGame:gc,revealPendingGame:Ic,getPendingGamesForReveal:Tc,getPendingGame:sr,generateCommitmentHashLocal:tr,generateSecret:bc,getActiveTiers:xc,getTierById:hc,getServiceFee:vc,getPoolStats:wc,getActiveTierCount:yc,calculatePotentialWin:kc,getGameResult:Ec,getCommitmentStatus:Cc},Dp=Object.freeze(Object.defineProperty({__proto__:null,FortuneTx:rr,calculatePotentialWin:kc,commitPlay:nr,getActiveTierCount:yc,getActiveTiers:xc,getCommitmentStatus:Cc,getGameResult:Ec,getPendingGame:sr,getPendingGamesForReveal:Tc,getPoolStats:wc,getServiceFee:vc,getTierById:hc,playGame:gc,revealPendingGame:Ic,revealPlay:ar},Symbol.toStringTag,{value:"Module"}));function dn(){var a,s,r;const e=(w==null?void 0:w.bkcToken)||($==null?void 0:$.bkcToken)||((a=window.contractAddresses)==null?void 0:a.bkcToken),t=(w==null?void 0:w.rentalManager)||($==null?void 0:$.rentalManager)||((s=window.contractAddresses)==null?void 0:s.rentalManager),n=(w==null?void 0:w.rewardBoosterNFT)||($==null?void 0:$.rewardBoosterNFT)||((r=window.contractAddresses)==null?void 0:r.rewardBoosterNFT);if(!e||!t||!n)throw new Error("Contract addresses not loaded. Please refresh the page.");return{BKC_TOKEN:e,RENTAL_MARKETPLACE:t,NFT_CONTRACT:n}}const ir=["function listNFT(uint256 _tokenId, uint256 _pricePerHour, uint256 _minHours, uint256 _maxHours) external","function updateListing(uint256 _tokenId, uint256 _pricePerHour, uint256 _minHours, uint256 _maxHours) external","function withdrawNFT(uint256 _tokenId) external","function rentNFT(uint256 _tokenId, uint256 _hours, address _operator) external","function rentNFTSimple(uint256 _tokenId, address _operator) external","function spotlightListing(uint256 _tokenId, address _operator) external payable","function getListing(uint256 _tokenId) view returns (tuple(address owner, uint256 pricePerHour, uint256 minHours, uint256 maxHours, bool isActive, uint256 totalEarnings, uint256 rentalCount))","function getAllListedTokenIds() view returns (uint256[])","function getListingCount() view returns (uint256)","function getRental(uint256 _tokenId) view returns (tuple(address tenant, uint256 startTime, uint256 endTime, uint256 paidAmount))","function isRented(uint256 _tokenId) view returns (bool)","function getRemainingRentalTime(uint256 _tokenId) view returns (uint256)","function hasRentalRights(uint256 _tokenId, address _user) view returns (bool)","function getRentalCost(uint256 _tokenId, uint256 _hours) view returns (uint256 totalCost, uint256 protocolFee, uint256 ownerPayout)","function listingSpotlight(uint256 tokenId) view returns (uint256 totalAmount, uint256 lastSpotlightTime)","function getEffectiveSpotlight(uint256 _tokenId) view returns (uint256 effectiveAmount, uint256 daysPassed)","function getSpotlightedListingsPaginated(uint256 _offset, uint256 _limit) view returns (uint256[] tokenIds, uint256[] effectiveSpotlights, uint256 total)","function getSpotlightConfig() view returns (uint256 decayPerDayBips, uint256 minAmount, uint256 maxDays, uint256 totalSpotlightedListings, uint256 totalCollected)","function minSpotlightAmount() view returns (uint256)","function hasActiveRental(address _user) view returns (bool)","function getUserActiveRentals(address _user) view returns (uint256[] tokenIds, uint256[] endTimes)","function paused() view returns (bool)","function rentalFeeBips() view returns (uint256)","function getFeeConfig() view returns (uint256 miningFeeBips, uint256 burnFeeBips, uint256 totalFeeBips)","function getMarketplaceStats() view returns (uint256 activeListings, uint256 totalVol, uint256 totalFees, uint256 rentals, uint256 spotlightTotal, uint256 ethCollected, uint256 bkcFees)","event NFTListed(uint256 indexed tokenId, address indexed owner, uint256 pricePerHour, uint256 minHours, uint256 maxHours)","event NFTRented(uint256 indexed tokenId, address indexed tenant, address indexed owner, uint256 hours_, uint256 totalCost, uint256 protocolFee, uint256 ownerPayout, uint256 endTime, address operator)","event ListingSpotlighted(uint256 indexed tokenId, address indexed owner, uint256 amount, uint256 newTotal, uint256 timestamp, address operator)"],Op=["function setApprovalForAll(address operator, bool approved) external","function isApprovedForAll(address owner, address operator) view returns (bool)","function ownerOf(uint256 tokenId) view returns (address)"];function Se(e){const t=window.ethers,n=dn();return new t.Contract(n.RENTAL_MARKETPLACE,ir,e)}async function ge(){const e=window.ethers,{NetworkManager:t}=await W(async()=>{const{NetworkManager:s}=await import("./index-DZsKjxq8.js");return{NetworkManager:s}},[]),n=t.getProvider(),a=dn();return new e.Contract(a.RENTAL_MARKETPLACE,ir,n)}function Up(e){const t=window.ethers,n=dn();return new t.Contract(n.NFT_CONTRACT,Op,e)}async function or({tokenId:e,pricePerHour:t,minHours:n,maxHours:a,button:s=null,onSuccess:r=null,onError:i=null}){const o=dn(),c=BigInt(t);return await O.execute({name:"ListNFT",button:s,getContract:async l=>Se(l),method:"listNFT",args:[e,c,n,a],validate:async(l,u)=>{const m=Up(l);if((await m.ownerOf(e)).toLowerCase()!==u.toLowerCase())throw new Error("You do not own this NFT");if(await Se(l).paused())throw new Error("Marketplace is currently paused");await m.isApprovedForAll(u,o.RENTAL_MARKETPLACE)||await(await m.setApprovalForAll(o.RENTAL_MARKETPLACE,!0)).wait()},onSuccess:r,onError:i})}async function cr({tokenId:e,hours:t,operator:n,button:a=null,onSuccess:s=null,onError:r=null}){const i=window.ethers,o=dn();let c=n,l=0n;return await O.execute({name:"RentNFT",button:a,getContract:async u=>Se(u),method:"rentNFT",args:()=>[e,t,q(c)],get approval(){return l>0n?{token:o.BKC_TOKEN,spender:o.RENTAL_MARKETPLACE,amount:l}:null},validate:async(u,m)=>{const p=Se(u);if(await p.paused())throw new Error("Marketplace is currently paused");const f=await p.getListing(e);if(!f.isActive)throw new Error("NFT is not listed for rent");if(t<Number(f.minHours)||t>Number(f.maxHours))throw new Error(`Hours must be between ${f.minHours} and ${f.maxHours}`);if(await p.isRented(e))throw new Error("NFT is currently rented");l=(await p.getRentalCost(e,t)).totalCost;const{NetworkManager:x}=await W(async()=>{const{NetworkManager:z}=await import("./index-DZsKjxq8.js");return{NetworkManager:z}},[]),y=x.getProvider(),C=["function balanceOf(address) view returns (uint256)"];if(await new i.Contract(o.BKC_TOKEN,C,y).balanceOf(m)<l)throw new Error(`Insufficient BKC. Need ${i.formatEther(l)} BKC`)},onSuccess:async u=>{let m=null;try{const p=new i.Interface(ir);for(const f of u.logs)try{const b=p.parseLog(f);if((b==null?void 0:b.name)==="NFTRented"){m={endTime:Number(b.args.endTime),totalCost:b.args.totalCost,protocolFee:b.args.protocolFee,ownerPayout:b.args.ownerPayout};break}}catch{}}catch{}s&&s(u,m)},onError:r})}async function Ac({tokenId:e,operator:t,button:n=null,onSuccess:a=null,onError:s=null}){const r=window.ethers,i=dn();let o=t,c=0n;return await O.execute({name:"RentNFTSimple",button:n,getContract:async l=>Se(l),method:"rentNFTSimple",args:()=>[e,q(o)],get approval(){return c>0n?{token:i.BKC_TOKEN,spender:i.RENTAL_MARKETPLACE,amount:c}:null},validate:async(l,u)=>{const m=Se(l);if(await m.paused())throw new Error("Marketplace is currently paused");const p=await m.getListing(e);if(!p.isActive)throw new Error("NFT is not listed for rent");if(await m.isRented(e))throw new Error("NFT is currently rented");c=p.pricePerHour;const{NetworkManager:f}=await W(async()=>{const{NetworkManager:I}=await import("./index-DZsKjxq8.js");return{NetworkManager:I}},[]),b=f.getProvider(),x=["function balanceOf(address) view returns (uint256)"];if(await new r.Contract(i.BKC_TOKEN,x,b).balanceOf(u)<c)throw new Error(`Insufficient BKC. Need ${r.formatEther(c)} BKC`)},onSuccess:a,onError:s})}async function lr({tokenId:e,button:t=null,onSuccess:n=null,onError:a=null}){return await O.execute({name:"WithdrawNFT",button:t,getContract:async s=>Se(s),method:"withdrawNFT",args:[e],validate:async(s,r)=>{const i=Se(s),o=await i.getListing(e);if(!o.isActive)throw new Error("NFT is not listed");if(o.owner.toLowerCase()!==r.toLowerCase())throw new Error("Only the owner can withdraw");if(await i.isRented(e))throw new Error("Cannot withdraw while NFT is rented")},onSuccess:n,onError:a})}async function Bc({tokenId:e,pricePerHour:t,minHours:n,maxHours:a,button:s=null,onSuccess:r=null,onError:i=null}){const o=BigInt(t);return await O.execute({name:"UpdateListing",button:s,getContract:async c=>Se(c),method:"updateListing",args:[e,o,n,a],validate:async(c,l)=>{const m=await Se(c).getListing(e);if(!m.isActive)throw new Error("NFT is not listed");if(m.owner.toLowerCase()!==l.toLowerCase())throw new Error("Only the owner can update")},onSuccess:r,onError:i})}async function Kn({tokenId:e,amount:t,operator:n,button:a=null,onSuccess:s=null,onError:r=null}){const i=window.ethers,o=BigInt(t);let c=n;return await O.execute({name:"SpotlightListing",button:a,getContract:async l=>Se(l),method:"spotlightListing",args:()=>[e,q(c)],value:o,validate:async(l,u)=>{const m=Se(l);if(await m.paused())throw new Error("Marketplace is currently paused");if(!(await m.getListing(e)).isActive)throw new Error("NFT is not listed");try{const b=await m.minSpotlightAmount();if(o<b)throw new Error(`Minimum spotlight is ${i.formatEther(b)} ETH`)}catch(b){if(b.message.includes("Minimum"))throw b}if(await l.provider.getBalance(u)<o+i.parseEther("0.001"))throw new Error("Insufficient ETH")},onSuccess:s,onError:r})}async function Pc(e){const t=window.ethers,a=await(await ge()).getListing(e);return{owner:a.owner,pricePerHour:a.pricePerHour,pricePerHourFormatted:t.formatEther(a.pricePerHour),minHours:Number(a.minHours),maxHours:Number(a.maxHours),isActive:a.isActive,totalEarnings:a.totalEarnings,totalEarningsFormatted:t.formatEther(a.totalEarnings),rentalCount:Number(a.rentalCount)}}async function zc(e){const t=window.ethers,a=await(await ge()).getRental(e),s=Math.floor(Date.now()/1e3),r=Number(a.endTime),i=r>s;return{tenant:a.tenant,startTime:Number(a.startTime),endTime:r,paidAmount:a.paidAmount,paidAmountFormatted:t.formatEther(a.paidAmount),isActive:i,hoursRemaining:i?Math.max(0,Math.ceil((r-s)/3600)):0}}async function Nc(){return(await(await ge()).getAllListedTokenIds()).map(n=>Number(n))}async function Lc(){const e=await ge();return Number(await e.getListingCount())}async function $c(e,t){const n=window.ethers,s=await(await ge()).getRentalCost(e,t);return{totalCost:s.totalCost,totalCostFormatted:n.formatEther(s.totalCost),protocolFee:s.protocolFee,protocolFeeFormatted:n.formatEther(s.protocolFee),ownerPayout:s.ownerPayout,ownerPayoutFormatted:n.formatEther(s.ownerPayout)}}async function Sc(e){return await(await ge()).isRented(e)}async function Rc(e){const t=await ge();return Number(await t.getRemainingRentalTime(e))}async function _c(e,t){return await(await ge()).hasRentalRights(e,t)}async function Fc(e){const t=window.ethers,n=await ge();try{const a=await n.getEffectiveSpotlight(e);return{effectiveAmount:a.effectiveAmount,effectiveAmountFormatted:t.formatEther(a.effectiveAmount),daysPassed:Number(a.daysPassed)}}catch{return{effectiveAmount:0n,effectiveAmountFormatted:"0",daysPassed:0}}}async function Mc(e=0,t=20){const n=window.ethers,a=await ge();try{const s=await a.getSpotlightedListingsPaginated(e,t);return{tokenIds:s.tokenIds.map(r=>Number(r)),effectiveSpotlights:s.effectiveSpotlights.map(r=>({amount:r,formatted:n.formatEther(r)})),total:Number(s.total)}}catch{return{tokenIds:[],effectiveSpotlights:[],total:0}}}async function Dc(){const e=window.ethers,t=await ge();try{const n=await t.getSpotlightConfig();return{decayPerDayBips:Number(n.decayPerDayBips),decayPerDayPercent:Number(n.decayPerDayBips)/100,minAmount:n.minAmount,minAmountFormatted:e.formatEther(n.minAmount),maxDays:Number(n.maxDays),totalSpotlightedListings:Number(n.totalSpotlightedListings),totalCollected:n.totalCollected,totalCollectedFormatted:e.formatEther(n.totalCollected)}}catch{return{decayPerDayBips:100,decayPerDayPercent:1,minAmount:0n,minAmountFormatted:"0",maxDays:100,totalSpotlightedListings:0,totalCollected:0n,totalCollectedFormatted:"0"}}}async function Oc(){const e=await ge();try{const t=await e.getFeeConfig();return{miningFeeBips:Number(t.miningFeeBips),miningFeePercent:Number(t.miningFeeBips)/100,burnFeeBips:Number(t.burnFeeBips),burnFeePercent:Number(t.burnFeeBips)/100,totalFeeBips:Number(t.totalFeeBips),totalFeePercent:Number(t.totalFeeBips)/100}}catch{const t=await e.rentalFeeBips().catch(()=>1e3);return{miningFeeBips:Number(t),miningFeePercent:Number(t)/100,burnFeeBips:0,burnFeePercent:0,totalFeeBips:Number(t),totalFeePercent:Number(t)/100}}}async function Uc(){const e=window.ethers,t=await ge();try{const n=await t.getMarketplaceStats();return{activeListings:Number(n.activeListings),totalVolume:n.totalVol,totalVolumeFormatted:e.formatEther(n.totalVol),totalFees:n.totalFees,totalFeesFormatted:e.formatEther(n.totalFees),totalRentals:Number(n.rentals),totalSpotlight:n.spotlightTotal,totalSpotlightFormatted:e.formatEther(n.spotlightTotal),totalETHCollected:n.ethCollected,totalETHFormatted:e.formatEther(n.ethCollected),totalBKCFees:n.bkcFees,totalBKCFormatted:e.formatEther(n.bkcFees)}}catch{return{activeListings:0,totalVolume:0n,totalVolumeFormatted:"0",totalFees:0n,totalFeesFormatted:"0",totalRentals:0,totalSpotlight:0n,totalSpotlightFormatted:"0",totalETHCollected:0n,totalETHFormatted:"0",totalBKCFees:0n,totalBKCFormatted:"0"}}}async function Hc(){return await(await ge()).paused()}async function jc(e){const t=await ge();try{return await t.hasActiveRental(e)}catch{return!1}}async function Wc(e){const t=await ge();try{const n=await t.getUserActiveRentals(e);return n.tokenIds.map((a,s)=>({tokenId:Number(a),endTime:Number(n.endTimes[s]),hoursRemaining:Math.max(0,Math.ceil((Number(n.endTimes[s])-Math.floor(Date.now()/1e3))/3600))}))}catch{return[]}}const Gc=or,Kc=cr,Yc=lr,Vc=Kn,qc=Kn,Xc=Kn,Yn={listNft:or,rentNft:cr,rentNftSimple:Ac,withdrawNft:lr,updateListing:Bc,spotlightListing:Kn,list:Gc,rent:Kc,withdraw:Yc,spotlight:Vc,promote:Xc,promoteListing:qc,getListing:Pc,getAllListedTokenIds:Nc,getListingCount:Lc,getRentalCost:$c,getRental:zc,isRented:Sc,getRemainingRentalTime:Rc,hasRentalRights:_c,getEffectiveSpotlight:Fc,getSpotlightedListings:Mc,getSpotlightConfig:Dc,hasActiveRental:jc,getUserActiveRentals:Wc,getFeeConfig:Oc,getMarketplaceStats:Uc,isMarketplacePaused:Hc},Hp=Object.freeze(Object.defineProperty({__proto__:null,RentalTx:Yn,getAllListedTokenIds:Nc,getEffectiveSpotlight:Fc,getFeeConfig:Oc,getListing:Pc,getListingCount:Lc,getMarketplaceStats:Uc,getRemainingRentalTime:Rc,getRental:zc,getRentalCost:$c,getSpotlightConfig:Dc,getSpotlightedListings:Mc,getUserActiveRentals:Wc,hasActiveRental:jc,hasRentalRights:_c,isMarketplacePaused:Hc,isRented:Sc,list:Gc,listNft:or,promote:Xc,promoteListing:qc,rent:Kc,rentNft:cr,rentNftSimple:Ac,spotlight:Vc,spotlightListing:Kn,updateListing:Bc,withdraw:Yc,withdrawNft:lr},Symbol.toStringTag,{value:"Module"}));function dr(){var n,a,s;const e=(w==null?void 0:w.decentralizedNotary)||($==null?void 0:$.decentralizedNotary)||((n=window.contractAddresses)==null?void 0:n.decentralizedNotary)||(w==null?void 0:w.notary)||($==null?void 0:$.notary)||((a=window.contractAddresses)==null?void 0:a.notary),t=(w==null?void 0:w.bkcToken)||($==null?void 0:$.bkcToken)||((s=window.contractAddresses)==null?void 0:s.bkcToken);if(!e)throw console.error("❌ Notary address not found!",{addresses:w,contractAddresses:$}),new Error("Contract addresses not loaded. Please refresh the page.");return{NOTARY:e,BKC_TOKEN:t}}const ur=["function notarize(string calldata _ipfsCid, string calldata _description, bytes32 _contentHash, address _operator) external payable returns (uint256 tokenId)","function documents(uint256 tokenId) view returns (string ipfsCid, string description, bytes32 contentHash, uint256 timestamp)","function getDocument(uint256 _tokenId) view returns (tuple(string ipfsCid, string description, bytes32 contentHash, uint256 timestamp))","function notarizationFeePaid(uint256 tokenId) view returns (uint256)","function verifyByHash(bytes32 _contentHash) view returns (bool exists, uint256 tokenId, address owner, uint256 timestamp)","function hashToTokenId(bytes32 hash) view returns (uint256)","function getFee() view returns (uint256 bkcFee, uint256 ethFee)","function notarizationFeeETH() view returns (uint256)","function SERVICE_KEY() view returns (bytes32)","function totalSupply() view returns (uint256)","function totalNotarizations() view returns (uint256)","function totalBKCCollected() view returns (uint256)","function totalETHCollected() view returns (uint256)","function getStats() view returns (uint256 notarizations, uint256 bkcCollected, uint256 ethCollected)","function ownerOf(uint256 tokenId) view returns (address)","function balanceOf(address owner) view returns (uint256)","function tokenURI(uint256 _tokenId) view returns (string)","function name() view returns (string)","function symbol() view returns (string)","event DocumentNotarized(uint256 indexed tokenId, address indexed owner, string ipfsCid, bytes32 indexed contentHash, uint256 bkcFeePaid, uint256 ethFeePaid, address operator)","event ETHFeeUpdated(uint256 oldFee, uint256 newFee)"];function ai(e){const t=window.ethers;if(!t)throw new Error("ethers.js not loaded");if(!e)throw new Error("Signer is required for write operations");const n=dr();return new t.Contract(n.NOTARY,ur,e)}async function at(){const e=window.ethers;if(!e)throw new Error("ethers.js not loaded");const{NetworkManager:t}=await W(async()=>{const{NetworkManager:s}=await import("./index-DZsKjxq8.js");return{NetworkManager:s}},[]),n=t.getProvider();if(!n)throw new Error("Provider not available");const a=dr();return new e.Contract(a.NOTARY,ur,n)}function jp(e){if(!e)return!1;const t=e.startsWith("0x")?e:`0x${e}`;return/^0x[a-fA-F0-9]{64}$/.test(t)}async function Jc({ipfsCid:e,description:t="",contentHash:n,operator:a,button:s=null,onSuccess:r=null,onError:i=null}){const o=window.ethers,c=dr();if(!e||e.trim().length===0)throw new Error("IPFS CID is required");if(!n)throw new Error("Content hash is required");const l=n.startsWith("0x")?n:`0x${n}`;if(!jp(l))throw new Error("Invalid content hash format. Must be a valid bytes32 (64 hex characters)");let u=a,m=0n,p=0n;return await O.execute({name:"Notarize",button:s,getContract:async f=>ai(f),method:"notarize",args:()=>[e,t||"",l,q(u)],get value(){return p},get approval(){return m>0n&&c.BKC_TOKEN?{token:c.BKC_TOKEN,spender:c.NOTARY,amount:m}:null},validate:async(f,b)=>{const x=ai(f);try{const[z,N]=await x.getFee();m=z,p=N,console.log("[NotaryTx] Fees:",{bkcFee:o.formatEther(z)+" BKC",ethFee:o.formatEther(N)+" ETH"})}catch{try{p=await x.notarizationFeeETH()}catch{p=o.parseEther("0.0001")}m=o.parseEther("1")}const{NetworkManager:y}=await W(async()=>{const{NetworkManager:z}=await import("./index-DZsKjxq8.js");return{NetworkManager:z}},[]),C=y.getProvider(),I=await C.getBalance(b),B=p+o.parseEther("0.001");if(I<B)throw new Error(`Insufficient ETH. Need ~${o.formatEther(B)} ETH for fee + gas`);if(m>0n&&c.BKC_TOKEN){const z=["function balanceOf(address) view returns (uint256)"];if(await new o.Contract(c.BKC_TOKEN,z,C).balanceOf(b)<m)throw new Error(`Insufficient BKC. Need ${o.formatEther(m)} BKC`)}},onSuccess:async f=>{let b=null,x={bkc:0n,eth:0n};try{const y=new o.Interface(ur);for(const C of f.logs)try{const I=y.parseLog(C);if(I&&I.name==="DocumentNotarized"){b=Number(I.args.tokenId),x={bkc:I.args.bkcFeePaid,eth:I.args.ethFeePaid};break}}catch{}}catch{}r&&r(f,b,x)},onError:f=>{console.error("[NotaryTx] Notarization failed:",f),i&&i(f)}})}async function Zc(e){const t=await at();try{const n=await t.getDocument(e),a=await t.ownerOf(e),s=await t.notarizationFeePaid(e).catch(()=>0n);return{id:e,owner:a,ipfsCid:n.ipfsCid,description:n.description,contentHash:n.contentHash,timestamp:Number(n.timestamp),date:new Date(Number(n.timestamp)*1e3),feePaid:s}}catch{return null}}async function pr(e){const t=await at(),n=e.startsWith("0x")?e:`0x${e}`;try{const a=await t.verifyByHash(n);return{exists:a.exists,tokenId:a.exists?Number(a.tokenId):null,owner:a.exists?a.owner:null,timestamp:a.exists?Number(a.timestamp):null,date:a.exists?new Date(Number(a.timestamp)*1e3):null}}catch(a){return console.error("[NotaryTx] verifyByHash error:",a),{exists:!1,tokenId:null,owner:null,timestamp:null,date:null}}}async function Qc(e){const t=await at(),n=e.startsWith("0x")?e:`0x${e}`;try{const a=await t.hashToTokenId(n);return Number(a)>0?Number(a):null}catch{return null}}async function el(){const e=window.ethers,t=await at();try{const[n,a]=await t.getFee();return{bkcFee:n,ethFee:a,bkcFormatted:e.formatEther(n)+" BKC",ethFormatted:e.formatEther(a)+" ETH",totalInEth:a}}catch{const n=await t.notarizationFeeETH().catch(()=>e.parseEther("0.0001"));return{bkcFee:e.parseEther("1"),ethFee:n,bkcFormatted:"1 BKC",ethFormatted:e.formatEther(n)+" ETH",totalInEth:n}}}async function tl(){const e=await at();try{return await e.notarizationFeeETH()}catch{return window.ethers.parseEther("0.0001")}}async function nl(){const e=await at();return Number(await e.totalSupply())}async function al(){const e=window.ethers,t=await at();try{const n=await t.getStats();return{totalNotarizations:Number(n.notarizations),totalBKCCollected:n.bkcCollected,totalBKCFormatted:e.formatEther(n.bkcCollected),totalETHCollected:n.ethCollected,totalETHFormatted:e.formatEther(n.ethCollected)}}catch{const[n,a,s]=await Promise.all([t.totalNotarizations().catch(()=>0n),t.totalBKCCollected().catch(()=>0n),t.totalETHCollected().catch(()=>0n)]);return{totalNotarizations:Number(n),totalBKCCollected:a,totalBKCFormatted:e.formatEther(a),totalETHCollected:s,totalETHFormatted:e.formatEther(s)}}}async function sl(e){const t=await at();return Number(await t.balanceOf(e))}async function rl(e){return await(await at()).tokenURI(e)}async function Fa(e){let t;if(e instanceof ArrayBuffer)t=e;else if(e instanceof Blob||e instanceof File)t=await e.arrayBuffer();else throw new Error("Invalid file type. Expected File, Blob, or ArrayBuffer");const n=await crypto.subtle.digest("SHA-256",t);return"0x"+Array.from(new Uint8Array(n)).map(s=>s.toString(16).padStart(2,"0")).join("")}async function mr(e,t){const n=await Fa(e),a=t.toLowerCase(),s=n.toLowerCase();return a===s}async function il(e,t){const n=t||await Fa(e),a=await pr(n);let s=!0;return t&&(s=await mr(e,t)),{contentHash:n,hashMatches:s,existsOnChain:a.exists,tokenId:a.tokenId,owner:a.owner,timestamp:a.timestamp,date:a.date,isVerified:s&&a.exists}}const ol={notarize:Jc,getDocument:Zc,getTotalDocuments:nl,getUserDocumentCount:sl,getTokenURI:rl,verifyByHash:pr,getTokenIdByHash:Qc,getFee:el,getNotarizationFeeETH:tl,getStats:al,calculateFileHash:Fa,verifyDocumentHash:mr,verifyDocumentOnChain:il},Wp=Object.freeze(Object.defineProperty({__proto__:null,NotaryTx:ol,calculateFileHash:Fa,getDocument:Zc,getFee:el,getNotarizationFeeETH:tl,getStats:al,getTokenIdByHash:Qc,getTokenURI:rl,getTotalDocuments:nl,getUserDocumentCount:sl,notarize:Jc,verifyByHash:pr,verifyDocumentHash:mr,verifyDocumentOnChain:il},Symbol.toStringTag,{value:"Module"}));function Ht(){var n,a;const e=(w==null?void 0:w.backchat)||($==null?void 0:$.backchat)||((n=window.contractAddresses)==null?void 0:n.backchat),t=(w==null?void 0:w.bkcToken)||($==null?void 0:$.bkcToken)||((a=window.contractAddresses)==null?void 0:a.bkcToken);if(!e)throw new Error("Backchat contract address not loaded");return{BACKCHAT:e,BKC_TOKEN:t}}const Ma=Wi;function ee(e){return new window.ethers.Contract(Ht().BACKCHAT,Ma,e)}async function we(){const{NetworkManager:e}=await W(async()=>{const{NetworkManager:t}=await import("./index-DZsKjxq8.js");return{NetworkManager:t}},[]);return new window.ethers.Contract(Ht().BACKCHAT,Ma,e.getProvider())}async function cl({username:e,displayName:t,bio:n,operator:a,button:s=null,onSuccess:r=null,onError:i=null}){const o=window.ethers;let c=a,l=0n;return await O.execute({name:"CreateProfile",button:s,getContract:async u=>ee(u),method:"createProfile",args:()=>[e,t||"",n||"",q(c)],get value(){return l},validate:async(u,m)=>{const p=ee(u);if(!await p.isUsernameAvailable(e))throw new Error("Username is already taken");if(!e||e.length<1||e.length>15)throw new Error("Username must be 1-15 characters");if(!/^[a-z0-9_]+$/.test(e))throw new Error("Username can only contain lowercase letters, numbers, and underscores");l=await p.getUsernameFee(e.length),console.log("[Backchat] Username fee:",o.formatEther(l),"ETH");const{NetworkManager:b}=await W(async()=>{const{NetworkManager:y}=await import("./index-DZsKjxq8.js");return{NetworkManager:y}},[]);if(await b.getProvider().getBalance(m)<l+o.parseEther("0.001"))throw new Error(`Insufficient ETH. Need ~${o.formatEther(l+o.parseEther("0.001"))} ETH`)},onSuccess:r,onError:i})}async function ll({displayName:e,bio:t,button:n=null,onSuccess:a=null,onError:s=null}){return await O.execute({name:"UpdateProfile",button:n,getContract:async r=>ee(r),method:"updateProfile",args:[e||"",t||""],validate:async()=>{if(e&&e.length>30)throw new Error("Display name max 30 chars");if(t&&t.length>160)throw new Error("Bio max 160 chars")},onSuccess:a,onError:s})}async function dl({content:e,mediaCID:t,operator:n,button:a=null,onSuccess:s=null,onError:r=null}){const i=window.ethers;let o=n,c=0n;return await O.execute({name:"CreatePost",button:a,getContract:async l=>ee(l),method:"createPost",args:()=>[e,t||"",q(o)],get value(){return c},validate:async(l,u)=>{if(!e||e.length===0)throw new Error("Content is required");if(e.length>500)throw new Error("Content max 500 chars");c=(await ee(l).getCurrentFees()).postFee;const{NetworkManager:f}=await W(async()=>{const{NetworkManager:x}=await import("./index-DZsKjxq8.js");return{NetworkManager:x}},[]);if(await f.getProvider().getBalance(u)<c+i.parseEther("0.001"))throw new Error("Insufficient ETH")},onSuccess:async l=>{let u=null;try{const m=new i.Interface(Ma);for(const p of l.logs)try{const f=m.parseLog(p);if((f==null?void 0:f.name)==="PostCreated"){u=Number(f.args.postId);break}}catch{}}catch{}s&&s(l,u)},onError:r})}async function ul({parentId:e,content:t,mediaCID:n,tipBkc:a,operator:s,button:r=null,onSuccess:i=null,onError:o=null}){const c=window.ethers,l=Ht();let u=s,m=0n;const p=a?BigInt(a):0n;return await O.execute({name:"CreateReply",button:r,getContract:async f=>ee(f),method:"createReply",args:()=>[e,t,n||"",q(u),p],get value(){return m},get approval(){return p>0n?{token:l.BKC_TOKEN,spender:l.BACKCHAT,amount:p}:null},validate:async(f,b)=>{if(!t)throw new Error("Content is required");if(t.length>500)throw new Error("Content max 500 chars");const x=ee(f);if(await x.postAuthor(e)==="0x0000000000000000000000000000000000000000")throw new Error("Post not found");m=(await x.getCurrentFees()).replyFee;const{NetworkManager:I}=await W(async()=>{const{NetworkManager:N}=await import("./index-DZsKjxq8.js");return{NetworkManager:N}},[]),B=I.getProvider();if(await B.getBalance(b)<m+c.parseEther("0.001"))throw new Error("Insufficient ETH");if(p>0n&&await new c.Contract(l.BKC_TOKEN,["function balanceOf(address) view returns (uint256)"],B).balanceOf(b)<p)throw new Error("Insufficient BKC for tip")},onSuccess:async f=>{let b=null;try{const x=new c.Interface(Ma);for(const y of f.logs)try{const C=x.parseLog(y);if((C==null?void 0:C.name)==="ReplyCreated"){b=Number(C.args.postId);break}}catch{}}catch{}i&&i(f,b)},onError:o})}async function pl({originalPostId:e,tipBkc:t,operator:n,button:a=null,onSuccess:s=null,onError:r=null}){const i=Ht();let o=n,c=0n;const l=t?BigInt(t):0n;return await O.execute({name:"CreateRepost",button:a,getContract:async u=>ee(u),method:"createRepost",args:()=>[e,q(o),l],get value(){return c},get approval(){return l>0n?{token:i.BKC_TOKEN,spender:i.BACKCHAT,amount:l}:null},validate:async(u,m)=>{const p=ee(u);if(await p.postAuthor(e)==="0x0000000000000000000000000000000000000000")throw new Error("Post not found");c=(await p.getCurrentFees()).repostFee},onSuccess:s,onError:r})}async function ml({postId:e,tipBkc:t,operator:n,button:a=null,onSuccess:s=null,onError:r=null}){const i=Ht();let o=n,c=0n;const l=t?BigInt(t):0n;return await O.execute({name:"Like",button:a,getContract:async u=>ee(u),method:"like",args:()=>[e,q(o),l],get value(){return c},get approval(){return l>0n?{token:i.BKC_TOKEN,spender:i.BACKCHAT,amount:l}:null},validate:async(u,m)=>{const p=ee(u);if(await p.postAuthor(e)==="0x0000000000000000000000000000000000000000")throw new Error("Post not found");if(await p.hasUserLiked(e,m))throw new Error("Already liked this post");c=(await p.getCurrentFees()).likeFee},onSuccess:s,onError:r})}async function fl({postId:e,ethAmount:t,tipBkc:n,operator:a,button:s=null,onSuccess:r=null,onError:i=null}){const o=window.ethers,c=Ht();let l=a;const u=BigInt(t),m=n?BigInt(n):0n;return await O.execute({name:"SuperLike",button:s,getContract:async p=>ee(p),method:"superLike",args:()=>[e,q(l),m],value:u,get approval(){return m>0n?{token:c.BKC_TOKEN,spender:c.BACKCHAT,amount:m}:null},validate:async(p,f)=>{const b=ee(p);if(await b.postAuthor(e)==="0x0000000000000000000000000000000000000000")throw new Error("Post not found");const y=await b.getCurrentFees();if(u<y.superLikeMin)throw new Error(`Minimum super like is ${o.formatEther(y.superLikeMin)} ETH`)},onSuccess:r,onError:i})}async function bl({toFollow:e,tipBkc:t,operator:n,button:a=null,onSuccess:s=null,onError:r=null}){const i=Ht();let o=n,c=0n;const l=t?BigInt(t):0n;return await O.execute({name:"Follow",button:a,getContract:async u=>ee(u),method:"follow",args:()=>[e,q(o),l],get value(){return c},get approval(){return l>0n?{token:i.BKC_TOKEN,spender:i.BACKCHAT,amount:l}:null},validate:async(u,m)=>{if(!e||e==="0x0000000000000000000000000000000000000000")throw new Error("Invalid address");if(e.toLowerCase()===m.toLowerCase())throw new Error("Cannot follow yourself");c=(await ee(u).getCurrentFees()).followFee},onSuccess:s,onError:r})}async function gl({toUnfollow:e,button:t=null,onSuccess:n=null,onError:a=null}){return await O.execute({name:"Unfollow",button:t,getContract:async s=>ee(s),method:"unfollow",args:[e],onSuccess:n,onError:a})}async function xl({ethAmount:e,operator:t,button:n=null,onSuccess:a=null,onError:s=null}){const r=window.ethers;let i=t;const o=BigInt(e);return await O.execute({name:"BoostProfile",button:n,getContract:async c=>ee(c),method:"boostProfile",args:()=>[q(i)],value:o,validate:async c=>{const u=await ee(c).getCurrentFees();if(o<u.boostMin)throw new Error(`Minimum boost is ${r.formatEther(u.boostMin)} ETH`)},onSuccess:a,onError:s})}async function hl({operator:e,button:t=null,onSuccess:n=null,onError:a=null}){let s=e,r=0n;return await O.execute({name:"ObtainBadge",button:t,getContract:async i=>ee(i),method:"obtainBadge",args:()=>[q(s)],get value(){return r},validate:async i=>{r=(await ee(i).getCurrentFees()).badgeFee_},onSuccess:n,onError:a})}async function vl({button:e=null,onSuccess:t=null,onError:n=null}){const a=window.ethers;return await O.execute({name:"Withdraw",button:e,getContract:async s=>ee(s),method:"withdraw",args:[],validate:async(s,r)=>{const o=await ee(s).getPendingBalance(r);if(o===0n)throw new Error("Nothing to withdraw");console.log("[Backchat] Withdrawing:",a.formatEther(o),"ETH")},onSuccess:t,onError:n})}async function wl({referrer:e,button:t=null,onSuccess:n=null,onError:a=null}){return await O.execute({name:"SetReferrer",button:t,getContract:async s=>ee(s),method:"setReferrer",args:[e],validate:async(s,r)=>{if(!e||e==="0x0000000000000000000000000000000000000000")throw new Error("Invalid referrer address");if(e.toLowerCase()===r.toLowerCase())throw new Error("Cannot refer yourself");if(await ee(s).referredBy(r)!=="0x0000000000000000000000000000000000000000")throw new Error("Referrer already set (immutable)")},onSuccess:n,onError:a})}async function yl(e){const t=window.ethers,a=await(await we()).getReferralStats(e);return{totalReferred:Number(a.totalReferred),totalEarned:a.totalEarned,totalEarnedFormatted:t.formatEther(a.totalEarned)}}async function kl(e){return await(await we()).referredBy(e)}async function El(){const e=window.ethers,n=await(await we()).getCurrentFees();return{postFee:n.postFee,postFeeFormatted:e.formatEther(n.postFee),replyFee:n.replyFee,replyFeeFormatted:e.formatEther(n.replyFee),likeFee:n.likeFee,likeFeeFormatted:e.formatEther(n.likeFee),followFee:n.followFee,followFeeFormatted:e.formatEther(n.followFee),repostFee:n.repostFee,repostFeeFormatted:e.formatEther(n.repostFee),superLikeMin:n.superLikeMin,superLikeMinFormatted:e.formatEther(n.superLikeMin),boostMin:n.boostMin,boostMinFormatted:e.formatEther(n.boostMin),badgeFee:n.badgeFee_,badgeFeeFormatted:e.formatEther(n.badgeFee_)}}async function Cl(e){const t=window.ethers,a=await(await we()).getUsernameFee(e);return{fee:a,formatted:t.formatEther(a)}}async function Tl(e){return await(await we()).postAuthor(e)}async function Il(){const e=await we();return Number(await e.postCounter())}async function Al(e){const t=window.ethers,a=await(await we()).getPendingBalance(e);return{balance:a,formatted:t.formatEther(a)}}async function Bl(e){return await(await we()).isUsernameAvailable(e)}async function Pl(e){return await(await we()).getUsernameOwner(e)}async function zl(e,t){return await(await we()).hasUserLiked(e,t)}async function Nl(e){return await(await we()).isProfileBoosted(e)}async function Ll(e){return await(await we()).hasTrustBadge(e)}async function $l(e){const t=await we();return Number(await t.boostExpiry(e))}async function Sl(e){const t=await we();return Number(await t.badgeExpiry(e))}async function Rl(){return await(await we()).version()}const ve={createProfile:cl,updateProfile:ll,createPost:dl,createReply:ul,createRepost:pl,like:ml,superLike:fl,follow:bl,unfollow:gl,boostProfile:xl,obtainBadge:hl,withdraw:vl,setReferrer:wl,getReferralStats:yl,getReferredBy:kl,getCurrentFees:El,getUsernameFee:Cl,getPostAuthor:Tl,getPostCount:Il,getPendingBalance:Al,isUsernameAvailable:Bl,getUsernameOwner:Pl,hasUserLiked:zl,isProfileBoosted:Nl,hasTrustBadge:Ll,getBoostExpiry:$l,getBadgeExpiry:Sl,getVersion:Rl},Gp=Object.freeze(Object.defineProperty({__proto__:null,BackchatTx:ve,boostProfile:xl,createPost:dl,createProfile:cl,createReply:ul,createRepost:pl,follow:bl,getBadgeExpiry:Sl,getBoostExpiry:$l,getCurrentFees:El,getPendingBalance:Al,getPostAuthor:Tl,getPostCount:Il,getReferralStats:yl,getReferredBy:kl,getUsernameFee:Cl,getUsernameOwner:Pl,getVersion:Rl,hasTrustBadge:Ll,hasUserLiked:zl,isProfileBoosted:Nl,isUsernameAvailable:Bl,like:ml,obtainBadge:hl,setReferrer:wl,superLike:fl,unfollow:gl,updateProfile:ll,withdraw:vl},Symbol.toStringTag,{value:"Module"}));(async()=>(await W(async()=>{const{CharityTx:e}=await Promise.resolve().then(()=>Np);return{CharityTx:e}},void 0)).CharityTx)(),(async()=>(await W(async()=>{const{StakingTx:e}=await Promise.resolve().then(()=>$p);return{StakingTx:e}},void 0)).StakingTx)(),(async()=>(await W(async()=>{const{NftTx:e}=await Promise.resolve().then(()=>_p);return{NftTx:e}},void 0)).NftTx)(),(async()=>(await W(async()=>{const{FortuneTx:e}=await Promise.resolve().then(()=>Dp);return{FortuneTx:e}},void 0)).FortuneTx)(),(async()=>(await W(async()=>{const{RentalTx:e}=await Promise.resolve().then(()=>Hp);return{RentalTx:e}},void 0)).RentalTx)(),(async()=>(await W(async()=>{const{NotaryTx:e}=await Promise.resolve().then(()=>Wp);return{NotaryTx:e}},void 0)).NotaryTx)(),(async()=>(await W(async()=>{const{FaucetTx:e}=await Promise.resolve().then(()=>gp);return{FaucetTx:e}},void 0)).FaucetTx)(),(async()=>(await W(async()=>{const{BackchatTx:e}=await Promise.resolve().then(()=>Gp);return{BackchatTx:e}},void 0)).BackchatTx)();const en=window.ethers,S={hasRenderedOnce:!1,lastUpdate:0,activities:[],networkActivities:[],filteredActivities:[],userProfile:null,pagination:{currentPage:1,itemsPerPage:8},filters:{type:"ALL",sort:"NEWEST"},metricsCache:{},economicData:null,isLoadingNetworkActivity:!1,networkActivitiesTimestamp:0,faucet:{canClaim:!0,cooldownEnd:null,isLoading:!1,lastCheck:0}},si="https://sepolia.arbiscan.io/tx/",Kp="https://sepolia.arbiscan.io/address/",Yp="https://faucet-4wvdcuoouq-uc.a.run.app",Vp="https://getrecentactivity-4wvdcuoouq-uc.a.run.app",qp="https://getsystemdata-4wvdcuoouq-uc.a.run.app",vs="1,000",ws="0.01",Xp=en.parseUnits("100",18),M={STAKING:{icon:"fa-lock",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🔒 Staked",emoji:"🔒"},UNSTAKING:{icon:"fa-unlock",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"🔓 Unstaked",emoji:"🔓"},FORCE_UNSTAKE:{icon:"fa-bolt",color:"#ef4444",bg:"rgba(239,68,68,0.15)",label:"⚡ Force Unstaked",emoji:"⚡"},CLAIM:{icon:"fa-coins",color:"#fbbf24",bg:"rgba(245,158,11,0.15)",label:"🪙 Rewards Claimed",emoji:"🪙"},NFT_BUY:{icon:"fa-bag-shopping",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🛍️ Bought NFT",emoji:"🛍️"},NFT_SELL:{icon:"fa-hand-holding-dollar",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"💰 Sold NFT",emoji:"💰"},NFT_MINT:{icon:"fa-gem",color:"#fde047",bg:"rgba(234,179,8,0.15)",label:"💎 Minted Booster",emoji:"💎"},NFT_TRANSFER:{icon:"fa-arrow-right-arrow-left",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"↔️ Transfer",emoji:"↔️"},RENTAL_LIST:{icon:"fa-tag",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🏷️ Listed NFT",emoji:"🏷️"},RENTAL_RENT:{icon:"fa-clock",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"⏰ Rented NFT",emoji:"⏰"},RENTAL_WITHDRAW:{icon:"fa-rotate-left",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"↩️ Withdrawn",emoji:"↩️"},RENTAL_PROMOTE:{icon:"fa-bullhorn",color:"#fbbf24",bg:"rgba(251,191,36,0.2)",label:"📢 Promoted NFT",emoji:"📢"},FORTUNE_COMMIT:{icon:"fa-lock",color:"#a855f7",bg:"rgba(168,85,247,0.2)",label:"🔐 Game Committed",emoji:"🔐"},FORTUNE_REVEAL:{icon:"fa-dice",color:"#f97316",bg:"rgba(249,115,22,0.2)",label:"🎲 Game Revealed",emoji:"🎲"},FORTUNE_BET:{icon:"fa-paw",color:"#f97316",bg:"rgba(249,115,22,0.2)",label:"🐯 Fortune Bet",emoji:"🐯"},FORTUNE_COMBO:{icon:"fa-rocket",color:"#a855f7",bg:"rgba(168,85,247,0.2)",label:"🚀 Combo Mode",emoji:"🚀"},FORTUNE_JACKPOT:{icon:"fa-crown",color:"#f59e0b",bg:"rgba(245,158,11,0.2)",label:"👑 Jackpot Mode",emoji:"👑"},FORTUNE_WIN:{icon:"fa-trophy",color:"#facc15",bg:"rgba(234,179,8,0.25)",label:"🏆 Winner!",emoji:"🏆"},FORTUNE_LOSE:{icon:"fa-dice",color:"#71717a",bg:"rgba(39,39,42,0.5)",label:"🎲 No Luck",emoji:"🎲"},NOTARY:{icon:"fa-stamp",color:"#818cf8",bg:"rgba(99,102,241,0.15)",label:"📜 Notarized",emoji:"📜"},BACKCHAT_POST:{icon:"fa-comment",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"💬 Posted",emoji:"💬"},BACKCHAT_LIKE:{icon:"fa-heart",color:"#ec4899",bg:"rgba(236,72,153,0.15)",label:"❤️ Liked",emoji:"❤️"},BACKCHAT_REPLY:{icon:"fa-reply",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"↩️ Replied",emoji:"↩️"},BACKCHAT_SUPERLIKE:{icon:"fa-star",color:"#fbbf24",bg:"rgba(251,191,36,0.2)",label:"⭐ Super Liked",emoji:"⭐"},BACKCHAT_REPOST:{icon:"fa-retweet",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🔄 Reposted",emoji:"🔄"},BACKCHAT_FOLLOW:{icon:"fa-user-plus",color:"#a78bfa",bg:"rgba(167,139,250,0.15)",label:"👥 Followed",emoji:"👥"},BACKCHAT_PROFILE:{icon:"fa-user",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"👤 Profile Created",emoji:"👤"},BACKCHAT_BOOST:{icon:"fa-rocket",color:"#f97316",bg:"rgba(249,115,22,0.15)",label:"🚀 Profile Boosted",emoji:"🚀"},BACKCHAT_BADGE:{icon:"fa-circle-check",color:"#10b981",bg:"rgba(16,185,129,0.15)",label:"✅ Badge Activated",emoji:"✅"},BACKCHAT_TIP:{icon:"fa-coins",color:"#fbbf24",bg:"rgba(251,191,36,0.15)",label:"💰 Tipped BKC",emoji:"💰"},BACKCHAT_WITHDRAW:{icon:"fa-wallet",color:"#8b5cf6",bg:"rgba(139,92,246,0.15)",label:"💸 ETH Withdrawn",emoji:"💸"},CHARITY_DONATE:{icon:"fa-heart",color:"#ec4899",bg:"rgba(236,72,153,0.15)",label:"💝 Donated",emoji:"💝"},CHARITY_CREATE:{icon:"fa-hand-holding-heart",color:"#10b981",bg:"rgba(16,185,129,0.15)",label:"🌱 Campaign Created",emoji:"🌱"},CHARITY_CANCEL:{icon:"fa-heart-crack",color:"#ef4444",bg:"rgba(239,68,68,0.15)",label:"💔 Campaign Cancelled",emoji:"💔"},CHARITY_WITHDRAW:{icon:"fa-hand-holding-dollar",color:"#8b5cf6",bg:"rgba(139,92,246,0.15)",label:"💰 Funds Withdrawn",emoji:"💰"},CHARITY_GOAL_REACHED:{icon:"fa-trophy",color:"#fbbf24",bg:"rgba(251,191,36,0.15)",label:"🏆 Goal Reached!",emoji:"🏆"},FAUCET:{icon:"fa-droplet",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"💧 Faucet Claim",emoji:"💧"},DEFAULT:{icon:"fa-circle",color:"#71717a",bg:"rgba(39,39,42,0.5)",label:"Activity",emoji:"📋"}};function Jp(e){if(!e)return"Just now";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3,n=new Date(t*1e3),s=new Date-n,r=Math.floor(s/6e4),i=Math.floor(s/36e5),o=Math.floor(s/864e5);return r<1?"Just now":r<60?`${r}m ago`:i<24?`${i}h ago`:o<7?`${o}d ago`:n.toLocaleDateString()}catch{return"Recent"}}function Zp(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function ts(e){return e>=1e6?(e/1e6).toFixed(2)+"M":e>=1e3?(e/1e3).toFixed(1)+"K":e.toFixed(0)}function Qp(e){return e?`${e.slice(0,6)}...${e.slice(-4)}`:""}function e0(e){if(!e)return"";const t=Date.now(),a=new Date(e).getTime()-t;if(a<=0)return"";const s=Math.floor(a/36e5),r=Math.floor(a%36e5/6e4);return s>0?`${s}h ${r}m`:`${r}m`}function t0(e,t={}){const n=(e||"").toUpperCase().trim();if(n==="STAKING"||n==="STAKED"||n==="STAKE"||n==="DELEGATED"||n==="DELEGATION"||n.includes("DELEGAT"))return M.STAKING;if(n==="UNSTAKE"||n==="UNSTAKED"||n==="UNSTAKING"||n.includes("UNDELEGAT"))return n.includes("FORCE")?M.FORCE_UNSTAKE:M.UNSTAKING;if(n==="CLAIMREWARD"||n==="CLAIM"||n==="CLAIMED"||n.includes("REWARD")||n.includes("CLAIM"))return M.CLAIM;if(n==="NFTBOUGHT"||n.includes("NFTBOUGHT")||n.includes("NFT_BOUGHT"))return M.NFT_BUY;if(n==="NFTSOLD"||n.includes("NFTSOLD")||n.includes("NFT_SOLD"))return M.NFT_SELL;if(n==="BOOSTERBUY"||n.includes("BOOSTER")||n.includes("PRESALE")||n.includes("MINTED"))return M.NFT_MINT;if(n==="TRANSFER"||n.includes("TRANSFER"))return M.NFT_TRANSFER;if(n==="RENTALLISTED"||n==="NFTLISTED"||n.includes("LIST")&&!n.includes("PROMOTE"))return M.RENTAL_LIST;if(n==="RENTALPROMOTED"||n==="PROMOTED"||n==="PROMOTE"||n.includes("PROMOT")||n.includes("ADS")||n.includes("ADVERTIS"))return M.RENTAL_PROMOTE;if(n==="RENTALRENTED"||n==="RENTED"||n.includes("RENTAL")&&n.includes("RENT"))return M.RENTAL_RENT;if(n==="RENTALWITHDRAWN"||n.includes("WITHDRAW"))return M.RENTAL_WITHDRAW;if(n==="GAMECOMMITTED"||n.includes("COMMITTED")||n.includes("COMMIT")){const a=t==null?void 0:t.isCumulative;return a===!0?M.FORTUNE_COMBO:a===!1?M.FORTUNE_JACKPOT:M.FORTUNE_COMMIT}if(n==="GAMEREVEALED"||n.includes("REVEALED")||n.includes("REVEAL"))return(t==null?void 0:t.isWin)||(t==null?void 0:t.prizeWon)>0||(t==null?void 0:t.matchCount)>0?M.FORTUNE_WIN:M.FORTUNE_LOSE;if(n==="GAMEREQUESTED"||n.includes("GAMEREQUESTED")||n.includes("GAME_REQUEST")||n.includes("REQUEST")||n.includes("GAMEPLAYED")||n.includes("FORTUNE")||n.includes("GAME")){const a=t==null?void 0:t.isCumulative,s=(t==null?void 0:t.guesses)||[];return a===!0||s.length>1?M.FORTUNE_COMBO:a===!1||s.length===1?M.FORTUNE_JACKPOT:M.FORTUNE_BET}return n==="GAMEFULFILLED"||n.includes("FULFILLED")||n.includes("ORACLE")?M.FORTUNE_REVEAL:n==="GAMERESULT"||n.includes("RESULT")?(t==null?void 0:t.isWin)||(t==null?void 0:t.prizeWon)>0?M.FORTUNE_WIN:M.FORTUNE_LOSE:n==="POSTCREATED"||n==="POST_CREATED"||n.includes("POST")&&n.includes("CREAT")?M.BACKCHAT_POST:n==="SUPERLIKED"||n==="SUPER_LIKED"||n.includes("SUPERLIKE")?M.BACKCHAT_SUPERLIKE:n==="LIKED"||n==="POSTLIKED"||n==="POST_LIKED"||n.includes("LIKE")&&!n.includes("SUPER")?M.BACKCHAT_LIKE:n==="REPLYCREATED"||n==="REPLY_CREATED"||n.includes("REPLY")?M.BACKCHAT_REPLY:n==="REPOSTCREATED"||n==="REPOST_CREATED"||n.includes("REPOST")?M.BACKCHAT_REPOST:n==="FOLLOWED"||n==="USER_FOLLOWED"||n.includes("FOLLOW")?M.BACKCHAT_FOLLOW:n==="PROFILECREATED"||n==="PROFILE_CREATED"||n.includes("PROFILE")&&n.includes("CREAT")?M.BACKCHAT_PROFILE:n==="PROFILEBOOSTED"||n==="PROFILE_BOOSTED"||n==="BOOSTED"||n.includes("BOOST")&&!n.includes("NFT")?M.BACKCHAT_BOOST:n==="BADGEACTIVATED"||n==="BADGE_ACTIVATED"||n.includes("BADGE")?M.BACKCHAT_BADGE:n==="TIPPROCESSED"||n==="TIP_PROCESSED"||n==="TIPPED"||n.includes("TIP")?M.BACKCHAT_TIP:n==="ETHWITHDRAWN"||n==="ETH_WITHDRAWN"||n==="BACKCHAT_WITHDRAW"?M.BACKCHAT_WITHDRAW:n==="CHARITYDONATION"||n==="DONATIONMADE"||n==="CHARITY_DONATE"||n==="DONATED"||n==="DONATION"||n.includes("DONATION")?M.CHARITY_DONATE:n==="CHARITYCAMPAIGNCREATED"||n==="CAMPAIGNCREATED"||n==="CHARITY_CREATE"||n==="CAMPAIGN_CREATED"||n.includes("CAMPAIGNCREATED")?M.CHARITY_CREATE:n==="CHARITYCAMPAIGNCANCELLED"||n==="CAMPAIGNCANCELLED"||n==="CHARITY_CANCEL"||n==="CAMPAIGN_CANCELLED"||n.includes("CANCELLED")?M.CHARITY_CANCEL:n==="CHARITYFUNDSWITHDRAWN"||n==="FUNDSWITHDRAWN"||n==="CHARITY_WITHDRAW"||n==="CAMPAIGN_WITHDRAW"||n.includes("WITHDRAWN")?M.CHARITY_WITHDRAW:n==="CHARITYGOALREACHED"||n==="GOALREACHED"||n==="CHARITY_GOAL"||n==="CAMPAIGN_COMPLETED"?M.CHARITY_GOAL_REACHED:n==="NOTARYREGISTER"||n==="NOTARIZED"||n.includes("NOTARY")||n.includes("DOCUMENT")?M.NOTARY:n==="FAUCETCLAIM"||n.includes("FAUCET")||n.includes("DISTRIBUTED")?M.FAUCET:M.DEFAULT}let ns=null,Et=0n;function _l(e){const t=document.getElementById("dash-user-rewards");if(!t||!d.isConnected){ns&&cancelAnimationFrame(ns);return}const n=e-Et;n>-1000000000n&&n<1000000000n?Et=e:Et+=n/8n,Et<0n&&(Et=0n),t.innerHTML=`${_(Et).toFixed(4)} <span class="text-sm text-green-500/80">BKC</span>`,Et!==e&&(ns=requestAnimationFrame(()=>_l(e)))}async function ri(e){if(!d.isConnected||!d.userAddress)return h("Connect wallet first","error");const t=e.innerHTML;e.disabled=!0,e.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-2"></i> Sending...',S.faucet.isLoading=!0;try{const n=await fetch(`${Yp}?address=${d.userAddress}`,{method:"GET",headers:{Accept:"application/json"}}),a=await n.json();if(n.ok&&a.success)h(`✅ Faucet Sent! ${vs} BKC + ${ws} ETH`,"success"),S.faucet.canClaim=!1,S.faucet.cooldownEnd=new Date(Date.now()+24*60*60*1e3).toISOString(),ys(),setTimeout(()=>{Dl.update(!0)},4e3);else{const s=a.error||a.message||"Faucet unavailable";if(s.toLowerCase().includes("cooldown")||s.toLowerCase().includes("wait")||s.toLowerCase().includes("hour")){h(`⏳ ${s}`,"warning");const r=s.match(/(\d+)\s*hour/i);if(r){const i=parseInt(r[1]);S.faucet.canClaim=!1,S.faucet.cooldownEnd=new Date(Date.now()+i*60*60*1e3).toISOString(),ys()}}else h(`❌ ${s}`,"error")}}catch(n){console.error("Faucet error:",n),h("Faucet Offline - Try again later","error")}finally{S.faucet.isLoading=!1,e.disabled=!1,e.innerHTML=t}}function n0(){return d.isConnected?(d.currentUserBalance||d.bkcBalance||0n)<Xp:!1}function ys(){const e=document.getElementById("dashboard-faucet-widget");if(!e)return;if(!n0()){e.classList.add("hidden");return}e.classList.remove("hidden");const t=d.currentUserBalance||d.bkcBalance||0n,n=t===0n,a=e0(S.faucet.cooldownEnd),s=S.faucet.canClaim&&!a,r=document.getElementById("faucet-title"),i=document.getElementById("faucet-desc"),o=document.getElementById("faucet-status"),c=document.getElementById("faucet-action-btn");if(e.className="glass-panel border-l-4 p-4",c&&(c.className="w-full sm:w-auto font-bold py-2.5 px-5 rounded-lg text-sm transition-all"),!s&&a)e.classList.add("border-zinc-500"),r&&(r.innerText="⏳ Faucet Cooldown"),i&&(i.innerText="Come back when the timer ends"),o&&(o.classList.remove("hidden"),o.innerHTML=`<i class="fa-solid fa-clock mr-1"></i> ${a} remaining`),c&&(c.classList.add("bg-zinc-700","text-zinc-400","cursor-not-allowed"),c.innerHTML='<i class="fa-solid fa-hourglass-half mr-2"></i> On Cooldown',c.disabled=!0);else if(n)e.classList.add("border-green-500"),r&&(r.innerText="🎉 Welcome to BackCoin!"),i&&(i.innerText=`Claim your free starter pack: ${vs} BKC + ${ws} ETH for gas`),o&&o.classList.add("hidden"),c&&(c.classList.add("bg-green-600","hover:bg-green-500","text-white","hover:scale-105"),c.innerHTML='<i class="fa-solid fa-gift mr-2"></i> Claim Starter Pack',c.disabled=!1);else{const l=_(t).toFixed(2);e.classList.add("border-cyan-500"),r&&(r.innerText="💧 Need More BKC?"),i&&(i.innerText=`Balance: ${l} BKC • Get ${vs} BKC + ${ws} ETH`),o&&o.classList.add("hidden"),c&&(c.classList.add("bg-cyan-600","hover:bg-cyan-500","text-white","hover:scale-105"),c.innerHTML='<i class="fa-solid fa-faucet mr-2"></i> Request Tokens',c.disabled=!1)}}async function a0(){try{if(await d.provider.getBalance(d.userAddress)<en.parseEther("0.002")){const t=document.getElementById("no-gas-modal-dash");return t&&(t.classList.remove("hidden"),t.classList.add("flex")),!1}return!0}catch{return!0}}function s0(){if(!Le.dashboard)return;const e=w.ecosystemManager||"",t=e?`${Kp}${e}`:"#";Le.dashboard.innerHTML=`
        <div class="flex flex-col gap-6 pb-10 max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
                ${r0("Total Supply","fa-coins","dash-metric-supply","Total BKC tokens in circulation")}
                ${ia("Net pStake","fa-layer-group","dash-metric-pstake","Total staking power on network","purple")}
                ${ia("Total Burned","fa-fire","dash-metric-burned","BKC permanently removed from supply","red")}
                ${ia("Fees Collected","fa-receipt","dash-metric-fees","Total fees generated by the ecosystem","orange")}
                ${ia("TVL %","fa-lock","dash-metric-tvl","Percentage of supply locked in contracts","blue")}
                ${i0()}
            </div>
        ...
        ${o0()}
        ${c0()}
    `,m0()}function ia(e,t,n,a,s="zinc"){const r={zinc:"text-zinc-400",purple:"text-purple-400",blue:"text-blue-400",orange:"text-orange-400",green:"text-green-400",red:"text-red-400"},i=r[s]||r.zinc;return`
    ...
    `}function r0(e,t,n,a,s="zinc"){const r={zinc:"text-zinc-400",purple:"text-purple-400",blue:"text-blue-400",orange:"text-orange-400",green:"text-green-400",red:"text-red-400"},i=r[s]||r.zinc;return`
        <div class="glass-panel p-3 sm:p-4 group hover:border-zinc-600 transition-all cursor-default" title="${a}">
            <div class="flex items-center gap-1.5 mb-1">
                <i class="fa-solid ${t} ${i} text-xs"></i>
                <span class="text-[10px] text-zinc-500 uppercase font-bold tracking-wider truncate">${e}</span>
    ...
    `}async function l0(){try{const e=await fetch(qp);if(e.ok){const t=await e.json();return S.economicData=t,t}}catch{}return null}async function ks(){var e,t,n,a,s,r,i,o,c;try{const l=await l0();let u=0n,m=0n,p=0n,f=0n,b=0n,x=0,y=0n;if(l)if(console.log("📊 Firebase economic data:",l.economy),(e=l.economy)!=null&&e.totalSupply&&(u=BigInt(l.economy.totalSupply)),(t=l.economy)!=null&&t.totalPStake&&(m=BigInt(l.economy.totalPStake)),(n=l.economy)!=null&&n.totalTVL&&(p=BigInt(l.economy.totalTVL)),(a=l.economy)!=null&&a.totalFeesCollected&&(b=BigInt(l.economy.totalFeesCollected)),(s=l.economy)!=null&&s.fortunePoolBalance&&(y=BigInt(l.economy.fortunePoolBalance)),(r=l.stats)!=null&&r.notarizedDocuments&&(x=l.stats.notarizedDocuments),(i=l.burn)!=null&&i.totalBurned)f=BigInt(l.burn.totalBurned);else if((o=l.burn)!=null&&o.sources){let D=0n;for(const K of Object.values(l.burn.sources))K!=null&&K.total&&(D+=BigInt(K.total));f=D}else(c=l.rental)!=null&&c.totalBurned&&(f=BigInt(l.rental.totalBurned));if(d.bkcTokenContractPublic&&(u===0n&&(console.log("📊 Fetching totalSupply from blockchain (fallback)..."),u=await re(d.bkcTokenContractPublic,"totalSupply",[],0n)),m===0n&&d.delegationManagerContractPublic&&(console.log("📊 Fetching totalPStake from blockchain (fallback)..."),m=await re(d.delegationManagerContractPublic,"totalNetworkPStake",[],0n)),p===0n)){console.log("📊 Calculating TVL from blockchain (fallback)...");const D=[w.delegationManager,w.fortunePool,w.rentalManager,w.miningManager,w.decentralizedNotary,w.nftLiquidityPoolFactory,w.pool_diamond,w.pool_platinum,w.pool_gold,w.pool_silver,w.pool_bronze,w.pool_iron,w.pool_crystal].filter(ie=>ie&&ie!==en.ZeroAddress),K=D.map(ie=>re(d.bkcTokenContractPublic,"balanceOf",[ie],0n)),de=await Promise.all(K);if(de.forEach(ie=>{p+=ie}),w.fortunePool&&y===0n){const ie=D.indexOf(w.fortunePool);ie>=0&&(y=de[ie])}}const C=_(u),I=_(f),B=_(b),z=_(y),N=D=>D.toLocaleString("en-US",{minimumFractionDigits:1,maximumFractionDigits:1});let T=0;u>0n&&(T=Number(p*10000n/u)/100),T>100&&(T=100);const F=(D,K,de="")=>{const ie=document.getElementById(D);ie&&(ie.innerHTML=`${K}${de?` <span class="text-xs text-zinc-500">${de}</span>`:""}`)},Y=document.getElementById("dash-metric-supply");Y&&(Y.innerHTML=`${N(C)} <span style="font-size: 10px; color: #71717a">BKC</span>`),F("dash-metric-pstake",Qt(m));const oe=document.getElementById("dash-metric-burned");oe&&(I>0?oe.innerHTML=`<span class="text-red-400">${ts(I)}</span> <span class="text-xs text-zinc-500">BKC 🔥</span>`:oe.innerHTML='<span class="text-zinc-500">0</span> <span class="text-xs text-zinc-500">BKC</span>'),F("dash-metric-fees",ts(B),"BKC");const pe=document.getElementById("dash-metric-tvl");if(pe){const D=T>30?"text-green-400":T>10?"text-yellow-400":"text-blue-400";pe.innerHTML=`<span class="${D}">${T.toFixed(1)}%</span>`}Fl();const ye=document.getElementById("dash-fortune-prize");ye&&(ye.innerText=`${ts(z)} BKC`);const te=document.getElementById("dash-notary-count");te&&(te.innerText=x>0?`${x} docs`:"--"),S.metricsCache={supply:C,burned:I,fees:B,timestamp:Date.now()}}catch(l){console.error("Metrics Error",l)}}async function d0(){if(d.userAddress)try{const e=await fetch(`https://getuserprofile-4wvdcuoouq-uc.a.run.app/${d.userAddress}`);e.ok&&(S.userProfile=await e.json(),u0(S.userProfile))}catch{}}function u0(e){const t=document.getElementById("dash-presale-stats");if(!t||!e||!e.presale||!e.presale.totalBoosters||e.presale.totalBoosters===0)return;t.classList.remove("hidden");const n=e.presale.totalSpentWei||0,a=parseFloat(en.formatEther(BigInt(n))).toFixed(4);document.getElementById("stats-total-spent").innerText=`${a} ETH`,document.getElementById("stats-total-boosters").innerText=e.presale.totalBoosters||0;const s=document.getElementById("stats-tier-badges");if(s&&e.presale.tiersOwned){let r="";Object.entries(e.presale.tiersOwned).forEach(([i,o])=>{const c=he[Number(i)-1],l=c?c.name:`T${i}`;r+=`<span class="text-[9px] bg-zinc-800 text-zinc-400 px-1.5 py-0.5 rounded">${o}x ${l}</span>`}),r&&(s.innerHTML=r)}}function Fl(){const e=document.getElementById("dash-metric-balance"),t=document.getElementById("dash-balance-card");if(!e)return;const n=d.currentUserBalance||d.bkcBalance||0n;if(!d.isConnected){e.innerHTML='<span class="text-zinc-500 text-xs">Connect Wallet</span>',t&&(t.style.borderColor="rgba(63,63,70,0.5)");return}if(n===0n)e.innerHTML='0.00 <span style="font-size: 10px; color: #71717a">BKC</span>';else{const s=_(n).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2});e.innerHTML=`${s} <span style="font-size: 10px; color: #71717a">BKC</span>`}t&&(t.style.borderColor="rgba(245,158,11,0.3)")}async function Yt(e=!1){var t,n;if(!d.isConnected){const a=document.getElementById("dash-booster-area");a&&(a.innerHTML=`
        ...
        `;return}const l=e.source==="rented",u=l?"bg-cyan-500/20 text-cyan-300":"bg-green-500/20 text-green-300",m=l?"Rented":"Owned",p=cu(a),f=(p==null?void 0:p.name)||((I=e.boostName)==null?void 0:I.replace(" Booster","").replace("Booster","").trim())||"Booster",b=(p==null?void 0:p.color)||"text-amber-400",x=(p==null?void 0:p.emoji)||"💎",y=r*50n/100n,C=i-y;console.log("🎨 V6.8 Booster:",{keepRate:s,netReward:_(i),tierName:f}),n.innerHTML=`
        <div class="flex items-center gap-3 bg-zinc-800/40 border ${(p==null?void 0:p.borderColor)||"border-green-500/20"} rounded-lg p-3 nft-clickable-image cursor-pointer" data-address="${w.rewardBoosterNFT}" data-tokenid="${e.tokenId}">
    ...
    `}async function ba(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("activity-title");try{if(d.isConnected){if(S.activities.length===0){e&&(e.innerHTML=`
                        <div class="flex flex-col items-center justify-center py-8">
                            <div class="relative">
                                <div class="absolute inset-0 bg-amber-500/30 blur-xl rounded-full animate-pulse"></div>
                                <img src="./assets/bkc_logo_3d.png" class="relative w-12 h-12 object-contain animate-bounce" alt="Loading">
                    ...
                    `);const n=await fetch(`${Ie.getHistory}/${d.userAddress}`);n.ok&&(S.activities=await n.json())}if(S.activities.length>0){t&&(t.textContent="Your Activity"),Es();return}}t&&(t.textContent="Network Activity"),await ii()}catch(n){console.error("Activity fetch error:",n),t&&(t.textContent="Network Activity"),await ii()}}async function ii(){const e=document.getElementById("dash-activity-list");if(!e||S.isLoadingNetworkActivity)return;const t=Date.now()-S.networkActivitiesTimestamp;if(S.networkActivities.length>0&&t<3e5){oi();return}S.isLoadingNetworkActivity=!0,e.innerHTML=`
        <div class="flex flex-col items-center justify-center py-8">
            <div class="relative">
                <div class="absolute inset-0 bg-amber-500/30 blur-xl rounded-full animate-pulse"></div>
                <img src="./assets/bkc_logo_3d.png" class="relative w-12 h-12 object-contain animate-bounce" alt="Loading">
    ...
    `;try{const n=await fetch(`${Vp}?limit=30`);if(n.ok){const a=await n.json();S.networkActivities=Array.isArray(a)?a:a.activities||[],S.networkActivitiesTimestamp=Date.now()}else S.networkActivities=[]}catch(n){console.error("Network activity fetch error:",n),S.networkActivities=[]}finally{S.isLoadingNetworkActivity=!1}oi()}function oi(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("dash-pagination-controls");if(e){if(S.networkActivities.length===0){e.innerHTML=`
        ...
        `,t&&t.classList.add("hidden");return}e.innerHTML=S.networkActivities.slice(0,15).map(n=>Ml(n,!0)).join(""),t&&t.classList.add("hidden")}}function Es(){let e=[...S.activities];const t=S.filters.type,n=a=>(a||"").toUpperCase();t!=="ALL"&&(e=e.filter(a=>{const s=n(a.type);return t==="STAKE"?s.includes("DELEGATION")||s.includes("DELEGAT")||s.includes("STAKE")||s.includes("UNSTAKE"):t==="CLAIM"?s.includes("REWARD")||s.includes("CLAIM"):t==="NFT"?s.includes("BOOSTER")||s.includes("RENT")||s.includes("NFT")||s.includes("TRANSFER"):t==="GAME"?s.includes("FORTUNE")||s.includes("GAME")||s.includes("REQUEST")||s.includes("RESULT")||s.includes("FULFILLED"):t==="CHARITY"?s.includes("CHARITY")||s.includes("CAMPAIGN")||s.includes("DONATION")||s.includes("DONATE"):t==="NOTARY"?s.includes("NOTARY")||s.includes("NOTARIZED")||s.includes("DOCUMENT"):t==="FAUCET"?s.includes("FAUCET"):!0})),e.sort((a,s)=>{const r=i=>i.timestamp&&i.timestamp._seconds?i.timestamp._seconds:i.createdAt&&i.createdAt._seconds?i.createdAt._seconds:i.timestamp?new Date(i.timestamp).getTime()/1e3:0;return S.filters.sort==="NEWEST"?r(s)-r(a):r(a)-r(s)}),S.filteredActivities=e,S.pagination.currentPage=1,Cs()}function Cs(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("dash-pagination-controls");if(!e)return;if(S.filteredActivities.length===0){e.innerHTML=`
            <div class="flex flex-col items-center justify-center py-8 px-4">
                <div class="relative mb-4">
                    <div class="absolute inset-0 bg-amber-500/20 blur-xl rounded-full animate-pulse"></div>
        ...
        `,t&&t.classList.add("hidden");return}const n=(S.pagination.currentPage-1)*S.pagination.itemsPerPage,a=n+S.pagination.itemsPerPage,s=S.filteredActivities.slice(n,a);if(e.innerHTML=s.map(r=>Ml(r,!1)).join(""),t){const r=Math.ceil(S.filteredActivities.length/S.pagination.itemsPerPage);r>1?(t.classList.remove("hidden"),document.getElementById("page-indicator").innerText=`${S.pagination.currentPage}/${r}`,document.getElementById("page-prev").disabled=S.pagination.currentPage===1,document.getElementById("page-next").disabled=S.pagination.currentPage>=r):t.classList.add("hidden")}}function Ml(e,t=!1){const n=Jp(e.timestamp||e.createdAt),a=Zp(e.timestamp||e.createdAt),s=e.user||e.userAddress||e.from||"",r=Qp(s),i=t0(e.type,e.details);let o="";const c=(e.type||"").toUpperCase().trim(),l=e.details||{};if(c.includes("GAME")||c.includes("FORTUNE")||c.includes("REQUEST")||c.includes("FULFILLED")||c.includes("RESULT")){const x=l.rolls||e.rolls||[],y=l.guesses||e.guesses||[],C=l.isWin||l.prizeWon&&BigInt(l.prizeWon||0)>0n,I=l.isCumulative!==void 0?l.isCumulative:y.length>1,B=l.wagerAmount||l.amount,z=l.prizeWon,N=I?"Combo":"Jackpot",T=I?"bg-purple-500/20 text-purple-400":"bg-amber-500/20 text-amber-400",F=B?_(BigInt(B)).toFixed(0):"0";let Y="No win",oe="text-zinc-500";C&&z&&BigInt(z)>0n&&(Y=`<span class="text-emerald-400 font-bold">+${_(BigInt(z)).toFixed(0)} BKC</span>`,oe="");let pe="";return x.length>0&&(pe=`<div class="flex gap-1">
                ${x.map((te,D)=>{const K=y[D];return`<div class="w-7 h-7 rounded text-xs font-bold flex items-center justify-center border ${K!==void 0&&Number(K)===Number(te)?"bg-emerald-500/20 border-emerald-500/50 text-emerald-400":"bg-zinc-800 border-zinc-700 text-zinc-400"}">${te}</div>`}).join("")}
            </div>`),`
            <a href="${e.txHash?`${si}${e.txHash}`:"#"}" target="_blank" class="block p-3 hover:bg-zinc-800/50 border border-zinc-700/30 rounded-lg transition-all group" style="background: rgba(39,39,42,0.4)" title="${a}">
        ...
        `}if(c.includes("NOTARY")){const x=l.ipfsCid;x&&(o=`<span class="ml-2 text-[9px] text-indigo-400 font-mono">${x.replace("ipfs://","").slice(0,12)+"..."}</span>`)}if(c.includes("STAKING")||c.includes("DELEGAT")){const x=l.pStakeGenerated;x&&(o=`<span class="text-[10px] text-purple-400">+${_(BigInt(x)).toFixed(0)} pStake</span>`)}if(c.includes("DONATION")||c.includes("CHARITY")){const x=l.netAmount||l.amount,y=l.campaignId;x&&BigInt(x)>0n&&(o=`<span class="text-pink-400 font-bold">${_(BigInt(x)).toFixed(2)} BKC</span>`,y&&(o+=`<span class="ml-1 text-[9px] text-zinc-500">Campaign #${y}</span>`))}if(c.includes("CLAIM")||c.includes("REWARD")){const x=l.feePaid,y=l.amount||e.amount;if(y&&(o=`<span class="text-amber-400 font-bold">+${_(BigInt(y)).toFixed(2)} BKC</span>`),x&&BigInt(x)>0n){const C=_(BigInt(x)).toFixed(2);o+=`<span class="ml-1 text-[9px] text-zinc-500">(fee: ${C})</span>`}}const m=c.includes("PROMOT")||c.includes("ADS")||c.includes("ADVERTIS");if(m){const x=l.promotionFee||l.amount||e.amount;if(x&&BigInt(x)>0n){const C=en.formatEther(BigInt(x));o=`<span class="text-yellow-400 font-bold">${parseFloat(C).toFixed(4)} ETH</span>`}const y=l.tokenId||e.tokenId;y&&(o+=`<span class="ml-1 text-[9px] text-zinc-500">NFT #${y}</span>`)}const p=e.txHash?`${si}${e.txHash}`:"#";let f="";if(m){const x=l.promotionFee||l.amount||e.amount;if(x&&BigInt(x)>0n){const y=en.formatEther(BigInt(x));f=parseFloat(y).toFixed(4)}}else{let x=e.amount||l.netAmount||l.amount||l.wagerAmount||l.prizeWon||"0";const y=_(BigInt(x));f=y>.001?y.toFixed(2):""}const b=m?"ETH":"BKC";return`
    ...
    `}function m0(){if(!Le.dashboard)return;Le.dashboard.addEventListener("click",async t=>{const n=t.target;if(n.closest("#manual-refresh-btn")){const r=n.closest("#manual-refresh-btn");r.disabled=!0,r.innerHTML='<i class="fa-solid fa-rotate fa-spin"></i>',await Yt(!0),await ks(),S.activities=[],S.networkActivities=[],S.networkActivitiesTimestamp=0,S.faucet.lastCheck=0,await ba(),setTimeout(()=>{r.innerHTML='<i class="fa-solid fa-rotate"></i> <span class="hidden sm:inline">Sync</span>',r.disabled=!1},1e3)}if(n.closest("#faucet-action-btn")){const r=n.closest("#faucet-action-btn");r.disabled||await ri(r)}if(n.closest("#emergency-faucet-btn")&&await ri(n.closest("#emergency-faucet-btn")),n.closest(".delegate-link")&&(t.preventDefault(),window.navigateTo("mine")),n.closest(".go-to-store")&&(t.preventDefault(),window.navigateTo("store")),n.closest(".go-to-rental")&&(t.preventDefault(),window.navigateTo("rental")),n.closest(".go-to-fortune")&&(t.preventDefault(),window.navigateTo("actions")),n.closest(".go-to-notary")&&(t.preventDefault(),window.navigateTo("notary")),n.closest(".go-to-charity")&&(t.preventDefault(),window.navigateTo("charity")),n.closest("#open-booster-info")){const r=document.getElementById("booster-info-modal");r&&(r.classList.remove("hidden"),r.classList.add("flex"),setTimeout(()=>{r.classList.remove("opacity-0"),r.querySelector("div").classList.remove("scale-95")},10))}if(n.closest("#close-booster-modal")||n.id==="booster-info-modal"){const r=document.getElementById("booster-info-modal");r&&(r.classList.add("opacity-0"),r.querySelector("div").classList.add("scale-95"),setTimeout(()=>r.classList.add("hidden"),200))}if(n.closest("#close-gas-modal-dash")||n.id==="no-gas-modal-dash"){const r=document.getElementById("no-gas-modal-dash");r&&(r.classList.remove("flex"),r.classList.add("hidden"))}const a=n.closest(".nft-clickable-image");if(a){const r=a.dataset.address,i=a.dataset.tokenid;r&&i&&Qd(r,i)}const s=n.closest("#dashboardClaimBtn");if(s&&!s.disabled)try{if(s.innerHTML='<i class="fa-solid fa-circle-notch fa-spin"></i>',s.disabled=!0,!await a0()){s.innerHTML='<i class="fa-solid fa-gift mr-2"></i> Claim',s.disabled=!1;return}const{stakingRewards:i,minerRewards:o}=await on();(i>0n||o>0n)&&await Rt.claimRewards({button:s,onSuccess:async()=>{h("Rewards claimed!","success"),await Yt(!0),S.activities=[],ba()},onError:c=>{c.cancelled||h("Claim failed","error")}})}catch{h("Claim failed","error")}finally{s.innerHTML='<i class="fa-solid fa-gift mr-2"></i> Claim',s.disabled=!1}if(n.closest("#page-prev")&&S.pagination.currentPage>1&&(S.pagination.currentPage--,Cs()),n.closest("#page-next")){const r=Math.ceil(S.filteredActivities.length/S.pagination.itemsPerPage);S.pagination.currentPage<r&&(S.pagination.currentPage++,Cs())}n.closest("#activity-sort-toggle")&&(S.filters.sort=S.filters.sort==="NEWEST"?"OLDEST":"NEWEST",Es())});const e=document.getElementById("activity-filter-type");e&&e.addEventListener("change",t=>{S.filters.type=t.target.value,Es()})}const Dl={async render(e){s0(),ks(),ba(),d.isConnected?await Yt(!1):(setTimeout(async()=>{d.isConnected&&await Yt(!1)},500),setTimeout(async()=>{d.isConnected&&await Yt(!1)},1500))},update(e){const t=Date.now();t-S.lastUpdate>1e4&&(S.lastUpdate=t,ks(),e&&Yt(!1),ba())}},kn=window.ethers,f0="https://sepolia.arbiscan.io/tx/",bn={NONE:{boost:0,burnRate:50,userGets:50,color:"#71717a",name:"None",icon:"○"},BRONZE:{boost:1e3,burnRate:40,userGets:60,color:"#cd7f32",name:"Bronze",icon:"🥉"},SILVER:{boost:2500,burnRate:25,userGets:75,color:"#c0c0c0",name:"Silver",icon:"🥈"},GOLD:{boost:4e3,burnRate:10,userGets:90,color:"#ffd700",name:"Gold",icon:"🥇"},DIAMOND:{boost:5e3,burnRate:0,userGets:100,color:"#b9f2ff",name:"Diamond",icon:"💎"}};let Xt=!1,Sn=0,fr=3650,We=!1,Ts=[],En=0n,Pt=null,wn="ALL",Ze=0,Rn=50,Ol="none",Vt=null;function Ul(e){if(e<=0)return"Ready";const t=Math.floor(e/86400),n=Math.floor(e%86400/3600),a=Math.floor(e%3600/60);if(t>365){const s=Math.floor(t/365),r=t%365;return`${s}y ${r}d`}return t>0?`${t}d ${n}h`:n>0?`${n}h ${a}m`:`${a}m`}function b0(e){if(e>=365){const t=e/365;return t>=2?`${Math.floor(t)} Years`:`${t.toFixed(1)} Year`}return e>=30?`${Math.floor(e/30)} Month${e>=60?"s":""}`:`${e} Day${e>1?"s":""}`}function Hl(e,t){try{const n=BigInt(e),a=BigInt(t);return n*(a/86400n)/10n**18n}catch{return 0n}}function g0(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function jl(e){return e>=5e3?bn.DIAMOND:e>=4e3?bn.GOLD:e>=2500?bn.SILVER:e>=1e3?bn.BRONZE:bn.NONE}function x0(){if(document.getElementById("staking-styles-v6"))return;const e=document.createElement("style");e.id="staking-styles-v6",e.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(e)}function h0(){const e=document.getElementById("mine");e&&(x0(),e.innerHTML=`
    ...
    `,B0(),d.isConnected?un(!0):br())}async function un(e=!1){var n;if(!d.isConnected){br();return}const t=Date.now();if(!(!e&&Xt)&&!(!e&&t-Sn<1e4)){Xt=!0,Sn=t;try{await v0();try{const a=await fetch("https://getsystemdata-4wvdcuoouq-uc.a.run.app");if(a.ok){const s=await a.json();(n=s==null?void 0:s.economy)!=null&&n.totalPStake&&(En=BigInt(s.economy.totalPStake))}}catch{console.log("Firebase unavailable, using blockchain")}if(En===0n){const a=d.delegationManagerContractPublic||d.delegationManagerContract;a&&(En=await re(a,"totalNetworkPStake",[],0n))}await Promise.all([Mt(!0),Tu(!0),js()]),await w0(),k0(),Wl(),Cn(),T0()}catch(a){console.error("Staking load error:",a)}finally{Xt=!1}}}async function v0(){try{const e=d.delegationManagerContract||d.delegationManagerContractPublic;if(e&&d.userAddress)try{const n=await e.getUserBestBoost(d.userAddress);Ze=Number(n)}catch{const n=await Zt();Ze=(n==null?void 0:n.boost)||0}else{const n=await Zt();Ze=(n==null?void 0:n.boost)||0}Rn=jl(Ze).burnRate,Ol=Ze>0?"active":"none",y0()}catch(e){console.error("Error loading NFT boost:",e),Ze=0,Rn=50}}async function w0(){try{const e=d.delegationManagerContract||d.delegationManagerContractPublic;if(e&&d.userAddress)try{const t=await e.previewClaim(d.userAddress);Vt={totalRewards:t.totalRewards||t[0],burnAmount:t.burnAmount||t[1],userReceives:t.userReceives||t[2],burnRateBips:t.burnRateBips||t[3],nftBoost:t.nftBoost||t[4]}}catch{const{stakingRewards:t,minerRewards:n}=await on(),a=t+n,s=a*BigInt(Rn)/100n;Vt={totalRewards:a,burnAmount:s,userReceives:a-s,burnRateBips:BigInt(Rn*100),nftBoost:BigInt(Ze)}}}catch(e){console.error("Error loading claim preview:",e)}}function y0(){const e=jl(Ze),t=document.getElementById("nft-tier-icon");t&&(t.textContent=e.icon,t.style.background=`${e.color}20`);const n=document.getElementById("nft-tier-badge");n&&(n.className=`nft-tier-badge tier-${e.name.toLowerCase()}`,n.innerHTML=`<span>${e.icon} ${e.name}</span>`);const a=document.getElementById("nft-source");a&&(Ze>0?(a.classList.remove("hidden"),a.textContent=Ol):a.classList.add("hidden"));const s=document.getElementById("burn-rate-text");s&&(e.burnRate===0?s.innerHTML='<span class="text-green-400">No burn! You keep 100% of rewards</span>':s.textContent=`${e.burnRate}% of rewards will be burned on claim`);const r=document.getElementById("burn-rate-value"),i=document.getElementById("keep-rate-value");r&&(r.textContent=`${e.burnRate}%`),i&&(i.textContent=`${e.userGets}%`);const o=document.getElementById("burn-fill"),c=document.getElementById("receive-fill");o&&(o.style.width=`${e.burnRate}%`),c&&(c.style.width=`${e.userGets}%`)}function k0(){var i;const e=(o,c)=>{const l=document.getElementById(o);l&&(l.textContent=c)};e("stat-network",Qt(En||d.totalNetworkPStake||0n)),e("stat-pstake",Qt(d.userTotalPStake||0n)),e("balance-display",_(d.currentUserBalance||0n).toFixed(2)),e("stat-delegations",(d.userDelegations||[]).length.toString());const t=d.userTotalPStake||0n,n=En||d.totalNetworkPStake||0n;let a=0;n>0n&&t>0n&&(a=Number(t*10000n/n)/100),e("stat-pstake-percent",a>0?`${a.toFixed(2)}% of network`:"0% of network");const s=((i=d.systemFees)==null?void 0:i.DELEGATION_FEE_BIPS)||50n,r=Number(s)/100;e("fee-info",`${r}% protocol fee`),E0()}async function E0(){const e=document.getElementById("claim-section");if(!e)return;const{stakingRewards:t,minerRewards:n}=await on(),a=t+n,s=(r,i)=>{const o=document.getElementById(r);o&&(o.textContent=i)};if(s("stat-rewards",_(a).toFixed(4)),a>0n){e.classList.remove("hidden");let r,i;Vt&&Vt.totalRewards>0n?(r=Vt.burnAmount,i=Vt.userReceives):(r=a*BigInt(Rn)/100n,i=a-r),s("claim-total",_(a).toFixed(4)),s("claim-burn",_(r).toFixed(4)),s("claim-receive",_(i).toFixed(4)),r>0n?e.classList.add("has-burn"):e.classList.remove("has-burn");const o=document.getElementById("claim-btn");o&&(o.onclick=()=>A0(t,n,o))}else e.classList.add("hidden")}function br(){const e=(s,r)=>{const i=document.getElementById(s);i&&(i.textContent=r)};e("stat-network","--"),e("stat-pstake","--"),e("stat-rewards","--"),e("stat-delegations","0"),e("balance-display","0.00"),e("stat-pstake-percent","--% of network");const t=document.getElementById("delegations-list");t&&(t.innerHTML=`
        ...
        `;return}const s=[...t].sort((r,i)=>Number(r.unlockTime)-Number(i.unlockTime));e.innerHTML=s.map(r=>C0(r)).join(""),ci(),Pt=setInterval(ci,6e4),e.querySelectorAll(".unstake-btn").forEach(r=>{r.addEventListener("click",()=>li(r.dataset.index,!1))}),e.querySelectorAll(".force-unstake-btn").forEach(r=>{r.addEventListener("click",()=>{confirm(`⚠️ Force Unstake will apply a 50% penalty!

Are you sure?`)&&li(r.dataset.index,!0)})})}function C0(e){const t=_(e.amount).toFixed(2),n=Qt(Hl(e.amount,e.lockDuration)),a=Number(e.unlockTime),s=Math.floor(Date.now()/1e3),r=a>s,i=r?a-s:0,o=Math.floor(Number(e.lockDuration)/86400);return`
                ...
                <div class="flex items-center gap-3 min-w-0">
                    ...
                    <div class="min-w-0">
                        ...
                        <div class="flex items-center gap-2 mt-0.5">
                            ...
                            <span class="text-zinc-500 text-[10px]">${b0(o)}</span>
                        </div>
                    </div>
                </div>
    ...
    `}function ci(){const e=document.querySelectorAll(".countdown-timer"),t=Math.floor(Date.now()/1e3);e.forEach(n=>{const a=parseInt(n.dataset.unlockTime);n.textContent=Ul(a-t)})}async function T0(){if(d.userAddress)try{const e=Ie.getHistory||"https://gethistory-4wvdcuoouq-uc.a.run.app",t=await fetch(`${e}/${d.userAddress}`);t.ok&&(Ts=(await t.json()||[]).filter(a=>{const s=(a.type||"").toUpperCase();return s.includes("DELEGAT")||s.includes("STAKE")||s.includes("UNDELEGAT")||s.includes("CLAIM")||s.includes("REWARD")||s.includes("FORCE")}),Gl())}catch(e){console.error("History load error:",e)}}function Gl(){const e=document.getElementById("staking-history-list");if(!e)return;let t=Ts;if(wn!=="ALL"&&(t=Ts.filter(n=>{const a=(n.type||"").toUpperCase();switch(wn){case"STAKE":return(a.includes("DELEGAT")||a.includes("STAKE"))&&!a.includes("UNSTAKE")&&!a.includes("UNDELEGAT")&&!a.includes("FORCE");case"UNSTAKE":return a.includes("UNSTAKE")||a.includes("UNDELEGAT")||a.includes("FORCE");case"CLAIM":return a.includes("CLAIM")||a.includes("REWARD");default:return!0}})),t.length===0){e.innerHTML=`
            <div class="text-center py-12">
                <i class="fa-solid fa-inbox text-3xl text-zinc-700 mb-3"></i>
                <p class="text-zinc-500 text-sm">No ${wn==="ALL"?"staking":wn.toLowerCase()} history yet</p>
            </div>
        `;return}e.innerHTML=t.slice(0,25).map(n=>{const a=(n.type||"").toUpperCase(),s=n.details||{},r=g0(n.timestamp||n.createdAt);let i,o,c,l,u="";a.includes("FORCE")?(i="fa-bolt",o="bg-red-500/15",c="text-red-400",l="Force Unstaked",s.feePaid&&BigInt(s.feePaid)>0n&&(u=`<span class="text-red-400">-${_(BigInt(s.feePaid)).toFixed(2)} penalty</span>`)):(a.includes("DELEGAT")||a.includes("STAKE"))&&!a.includes("UNSTAKE")?(i="fa-lock",o="bg-green-500/15",c="text-green-400",l="Delegated",s.pStakeGenerated&&(u=`<span class="text-purple-400">+${_(BigInt(s.pStakeGenerated)).toFixed(0)} pS</span>`)):a.includes("UNSTAKE")||a.includes("UNDELEGAT")?(i="fa-unlock",o="bg-orange-500/15",c="text-orange-400",l="Unstaked"):a.includes("CLAIM")||a.includes("REWARD")?(i="fa-coins",o="bg-amber-500/15",c="text-amber-400",l="Claimed",s.amountReceived&&BigInt(s.amountReceived)>0n&&(u=`<span class="text-green-400">+${_(BigInt(s.amountReceived)).toFixed(2)}</span>`)):(i="fa-circle",o="bg-zinc-500/15",c="text-zinc-400",l=n.type||"Activity");const m=n.txHash?`${f0}${n.txHash}`:"#",p=n.amount||s.amount||s.amountReceived||"0",f=_(BigInt(p)),b=f>.001?f.toFixed(2):"";return`
        ...
        `}).join("")}function Cn(){var a;const e=document.getElementById("amount-input"),t=document.getElementById("stake-btn");if(!e)return;const n=e.value;if(!n||parseFloat(n)<=0){document.getElementById("preview-pstake").textContent="0",document.getElementById("preview-net").textContent="0.00 BKC",t&&(t.disabled=!0);return}try{const s=kn.parseUnits(n,18),r=((a=d.systemFees)==null?void 0:a.DELEGATION_FEE_BIPS)||50n,i=s*BigInt(r)/10000n,o=s-i,c=BigInt(fr)*86400n,l=Hl(o,c);document.getElementById("preview-pstake").textContent=Qt(l),document.getElementById("preview-net").textContent=`${_(o).toFixed(4)} BKC`;const u=d.currentUserBalance||0n;s>u?(e.classList.add("error"),t&&(t.disabled=!0)):(e.classList.remove("error"),t&&(t.disabled=We))}catch{t&&(t.disabled=!0)}}async function I0(){if(We)return;const e=document.getElementById("amount-input"),t=document.getElementById("stake-btn");if(document.getElementById("stake-btn-text"),document.getElementById("stake-btn-icon"),!e||!t)return;const n=e.value;if(!n||parseFloat(n)<=0){h("Enter an amount","warning");return}const a=d.currentUserBalance||0n;let s;try{if(s=kn.parseUnits(n,18),s>a){h("Insufficient BKC balance","error");return}}catch{h("Invalid amount","error");return}try{if(await new kn.BrowserProvider(window.ethereum).getBalance(d.userAddress)<kn.parseEther("0.001")){h("Insufficient ETH for gas","error");return}}catch{}We=!0;const r=BigInt(fr)*86400n;try{await Rt.delegate({amount:s,lockDuration:r,button:t,onSuccess:async()=>{e.value="",h("🔒 Delegation successful!","success"),Xt=!1,Sn=0,await un(!0)},onError:i=>{i.cancelled||h("Delegation failed: "+(i.reason||i.message||"Unknown error"),"error")}})}catch(i){h("Delegation failed: "+(i.reason||i.message||"Unknown error"),"error")}finally{We=!1,Cn()}}async function li(e,t){if(We)return;const n=document.querySelector(t?`.force-unstake-btn[data-index='${e}']`:`.unstake-btn[data-index='${e}']`);We=!0;try{const a=BigInt(e);await(t?Rt.forceUnstake:Rt.unstake)({delegationIndex:a,button:n,onSuccess:async()=>{h(t?"⚡ Force unstaked (50% penalty applied)":"🔓 Unstaked successfully!",t?"warning":"success"),Xt=!1,Sn=0,await un(!0)},onError:r=>{r.cancelled||h("Unstake failed: "+(r.reason||r.message||"Unknown error"),"error")}})}catch(a){h("Unstake failed: "+(a.reason||a.message||"Unknown error"),"error")}finally{We=!1,Wl()}}async function A0(e,t,n){if(!We){We=!0;try{await Rt.claimRewards({button:n,onSuccess:async()=>{h("🪙 Rewards claimed!","success"),Xt=!1,Sn=0,await un(!0)},onError:a=>{a.cancelled||h("Claim failed: "+(a.reason||a.message||"Unknown error"),"error")}})}catch(a){h("Claim failed: "+(a.reason||a.message||"Unknown error"),"error")}finally{We=!1}}}function B0(){const e=document.getElementById("amount-input"),t=document.getElementById("max-btn"),n=document.getElementById("stake-btn"),a=document.getElementById("refresh-btn"),s=document.querySelectorAll(".duration-chip"),r=document.querySelectorAll(".history-tab");e==null||e.addEventListener("input",Cn),t==null||t.addEventListener("click",()=>{const i=d.currentUserBalance||0n;e&&(e.value=kn.formatUnits(i,18),Cn())}),s.forEach(i=>{i.addEventListener("click",()=>{s.forEach(o=>o.classList.remove("selected")),i.classList.add("selected"),fr=parseInt(i.dataset.days),Cn()})}),r.forEach(i=>{i.addEventListener("click",()=>{r.forEach(o=>o.classList.remove("active")),i.classList.add("active"),wn=i.dataset.filter,Gl()})}),n==null||n.addEventListener("click",I0),a==null||a.addEventListener("click",()=>{const i=a.querySelector("i");i==null||i.classList.add("fa-spin"),un(!0).then(()=>{setTimeout(()=>i==null?void 0:i.classList.remove("fa-spin"),500)})})}function P0(){Pt&&(clearInterval(Pt),Pt=null)}function z0(e){e?un():br()}const Kl={render:h0,update:z0,cleanup:P0},Pe=window.ethers,N0="https://sepolia.arbiscan.io/tx/",L0=3e4,Is={Diamond:{color:"#22d3ee",gradient:"from-cyan-500/20 to-blue-500/20",border:"border-cyan-500/40",text:"text-cyan-400",glow:"shadow-cyan-500/30",icon:"💎",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeicgip72jcqgsirlrhn3tq5cc226vmko6etnndzl6nlhqrktfikafq",keepRate:100,burnRate:0},Gold:{color:"#fbbf24",gradient:"from-yellow-500/20 to-amber-500/20",border:"border-yellow-500/40",text:"text-yellow-400",glow:"shadow-yellow-500/30",icon:"🥇",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeifponccrbicg2pcjrn2hrfoqgc77xhm2r4ld7hdpw6cxxkbsckf44",keepRate:90,burnRate:10},Silver:{color:"#9ca3af",gradient:"from-gray-400/20 to-slate-400/20",border:"border-gray-400/40",text:"text-gray-300",glow:"shadow-gray-400/30",icon:"🥈",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeihvi2inujm5zpi7tl667g4srq273536pjkglwyrtbwmgnskmu7jg4",keepRate:75,burnRate:25},Bronze:{color:"#f97316",gradient:"from-orange-600/20 to-amber-700/20",border:"border-orange-600/40",text:"text-orange-400",glow:"shadow-orange-500/30",icon:"🥉",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeiclqidb67rt3tchhjpsib62s624li7j2bpxnr6b5w5mfp4tomhu7m",keepRate:60,burnRate:40}};function Da(e){return Is[e]||Is.Bronze}const L={tradeDirection:"buy",selectedPoolBoostBips:null,buyPrice:0n,sellPrice:0n,netSellPrice:0n,poolNFTCount:0,userBalanceOfSelectedNFT:0,availableToSellCount:0,firstAvailableTokenId:null,firstAvailableTokenIdForBuy:null,bestBoosterTokenId:0n,bestBoosterBips:0,isDataLoading:!1,tradeHistory:[]},ga=new Map,gr=new Map;let oa=!1,It=null;const $0=["function getPoolAddress(uint256 boostBips) view returns (address)","function isPool(address) view returns (bool)"];function S0(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function R0(e){const t=gr.get(e);return t&&Date.now()-t.timestamp<L0?t.data:null}function Yl(e,t){gr.set(e,{data:t,timestamp:Date.now()})}function as(e){gr.delete(e)}function _0(){if(document.getElementById("swap-styles-v9"))return;const e=document.createElement("style");e.id="swap-styles-v9",e.textContent=`
    ...
    `,document.head.appendChild(e)}function F0(){return`
    ...
    `}const M0={async render(e){_0(),await Yi();const t=document.getElementById("store");t&&((t.innerHTML.trim()===""||e)&&(t.innerHTML=`
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <div class="flex items-center gap-3">
                            <div class="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden"
                                 id="trade-mascot">
                                <img src="${Is.Diamond.image}" alt="NFT" class="w-full h-full object-contain" onerror="this.outerHTML='<span class=\\'text-3xl\\'>💎</span>'">
                            </div>
                            <div>
            ...
            `,j0()),L.selectedPoolBoostBips===null&&he.length>0&&(L.selectedPoolBoostBips=he[0].boostBips),await lt(),await yn())},async update(){L.selectedPoolBoostBips!==null&&!L.isDataLoading&&document.getElementById("store")&&!document.hidden&&await lt()}};async function yn(){const e=document.getElementById("history-list");if(!d.userAddress){e&&(e.innerHTML='<div class="text-center py-4 text-xs text-zinc-600">Connect wallet to view history</div>');return}try{const t=Ie.getHistory||"https://gethistory-4wvdcuoouq-uc.a.run.app",n=await fetch(`${t}/${d.userAddress}`);if(!n.ok)throw new Error(`HTTP ${n.status}`);const a=await n.json();console.log("All history types:",[...new Set((a||[]).map(r=>r.type))]),L.tradeHistory=(a||[]).filter(r=>{const i=(r.type||"").toUpperCase();return i==="NFTBOUGHT"||i==="NFTSOLD"||i==="NFT_BOUGHT"||i==="NFT_SOLD"||i==="NFTPURCHASED"||i==="NFT_PURCHASED"||i.includes("NFTBOUGHT")||i.includes("NFTSOLD")||i.includes("NFTPURCHASED")}),console.log("NFT trade history:",L.tradeHistory.length,"items");const s=document.getElementById("history-count");s&&(s.textContent=L.tradeHistory.length),di()}catch(t){console.error("History load error:",t),L.tradeHistory=[],di()}}function di(){const e=document.getElementById("history-list");if(e){if(!d.isConnected){e.innerHTML='<div class="text-center py-4 text-xs text-zinc-600">Connect wallet to view history</div>';return}if(L.tradeHistory.length===0){e.innerHTML=`
        ...
        `;return}e.innerHTML=L.tradeHistory.slice(0,20).map(t=>{const n=(t.type||"").toUpperCase(),a=t.details||{},s=S0(t.timestamp||t.createdAt),r=n.includes("BOUGHT")||n.includes("PURCHASED"),i=r?"fa-cart-plus":"fa-money-bill-transfer",o=r?"#22c55e":"#f59e0b",c=r?"rgba(34,197,94,0.15)":"rgba(245,158,11,0.15)",l=r?"🛒 Bought NFT":"💰 Sold NFT",u=r?"-":"+",m=t.txHash?`${N0}${t.txHash}`:"#";let p="";try{let x=t.amount||a.amount||a.price||a.payout||"0";if(typeof x=="string"&&x!=="0"){const y=_(BigInt(x));y>.001&&(p=y.toFixed(2))}}catch{}const f=a.tokenId||"",b=a.boostBips||a.boost||"";return`
        ...
        `}).join("")}}function D0(){return he.map((e,t)=>{const n=Da(e.name),a=t===0,s=gt(e.boostBips),r=n.icon||e.emoji||"💎";return`
        ...
        `}).join("")}function ui(e){document.querySelectorAll(".tier-chip").forEach(t=>{const n=Number(t.dataset.boost)===e,a=t.dataset.tier,s=Da(a);t.className=`tier-chip flex flex-col items-center gap-1 p-2 rounded-xl border transition-all ${n?`bg-gradient-to-br ${s.gradient} ${s.border} ${s.text} active`:"bg-zinc-800/50 border-zinc-700/50 text-zinc-400 hover:border-zinc-600"}`})}function xa(){const e=document.getElementById("swap-interface");if(!e)return;const t=he.find(b=>b.boostBips===L.selectedPoolBoostBips),n=Da(t==null?void 0:t.name),a=L.tradeDirection==="buy";U0(a);const s=a?L.buyPrice:L.netSellPrice,r=_(s).toFixed(2),i=_(d.currentUserBalance||0n).toFixed(2),o=a&&L.firstAvailableTokenIdForBuy===null,c=!a&&L.availableToSellCount===0,l=!a&&L.userBalanceOfSelectedNFT>L.availableToSellCount,u=a&&L.buyPrice>(d.currentUserBalance||0n),m=a?"":l?`<span class="${c?"text-red-400":"text-zinc-400"}">${L.availableToSellCount}</span>/<span class="text-zinc-500">${L.userBalanceOfSelectedNFT}</span> <span class="text-[9px] text-blue-400">(${L.userBalanceOfSelectedNFT-L.availableToSellCount} rented)</span>`:`<span class="${c?"text-red-400":"text-zinc-400"}">${L.userBalanceOfSelectedNFT}</span>`,p=n.icon||(t==null?void 0:t.emoji)||"💎",f=n.image||"";gt((t==null?void 0:t.boostBips)||0),e.innerHTML=`
        <div class="fade-in">
    ...
    `}function O0(e,t,n,a,s=!1){return d.isConnected?e?t?`
        ...
        `}function U0(e){const t=document.getElementById("trade-mascot");t&&(t.className=`w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden ${e?"trade-buy":"trade-sell"}`)}function pi(){const e=document.getElementById("inventory-grid"),t=document.getElementById("nft-count");if(!e)return;const n=d.myBoosters||[];if(t&&(t.textContent=n.length),!d.isConnected){e.innerHTML='<div class="col-span-4 text-center py-4 text-xs text-zinc-600">Connect wallet</div>';return}if(n.length===0){e.innerHTML=`
        ...
        `;return}const a=d.rentalListings||[],s=new Set(a.map(i=>{var o;return(o=i.tokenId)==null?void 0:o.toString()})),r=Math.floor(Date.now()/1e3);e.innerHTML=n.map(i=>{var I;const o=he.find(B=>B.boostBips===Number(i.boostBips)),c=Da(o==null?void 0:o.name),l=gt(Number(i.boostBips)),u=c.icon||(o==null?void 0:o.emoji)||"💎",m=L.firstAvailableTokenId&&BigInt(i.tokenId)===L.firstAvailableTokenId,p=(I=i.tokenId)==null?void 0:I.toString(),f=s.has(p),b=a.find(B=>{var z;return((z=B.tokenId)==null?void 0:z.toString())===p}),x=b&&b.rentalEndTime&&Number(b.rentalEndTime)>r,y=f||x;let C="";return x?C='<span class="absolute top-1 right-1 bg-blue-500 text-white text-[7px] px-1.5 py-0.5 rounded-full font-bold">🔑</span>':f&&(C='<span class="absolute top-1 right-1 bg-green-500 text-white text-[7px] px-1.5 py-0.5 rounded-full font-bold">📋</span>'),`
            <div class="inventory-item ${y?"opacity-50 cursor-not-allowed":"cursor-pointer"} rounded-xl p-2 border ${m&&!y?"border-amber-500 ring-2 ring-amber-500/50 bg-amber-500/10":"border-zinc-700/50 bg-zinc-800/30"} hover:bg-zinc-800/50 transition-all relative"
                ...
                <p class="text-[7px] text-center ${m&&!y?"text-amber-400 font-bold":"text-zinc-600"}">#${i.tokenId}</p>
            </div>
        `}).join("")}async function lt(e=!1){var a,s;if(L.selectedPoolBoostBips===null)return;const t=L.selectedPoolBoostBips,n=Date.now();if(It=n,!e){const r=R0(t);if(r){As(r),xa(),pi(),H0(t,n);return}}L.isDataLoading=!0;try{const r=d.myBoosters||[],i=d.rentalListings||[],o=new Set(i.map(D=>{var K;return(K=D.tokenId)==null?void 0:K.toString()})),c=Math.floor(Date.now()/1e3),l=r.filter(D=>Number(D.boostBips)===t),u=l.filter(D=>{var Ue;const K=(Ue=D.tokenId)==null?void 0:Ue.toString(),de=i.find(X=>{var fn;return((fn=X.tokenId)==null?void 0:fn.toString())===K}),ie=o.has(K),rt=de&&de.rentalEndTime&&Number(de.rentalEndTime)>c;return!ie&&!rt}),m=he.find(D=>D.boostBips===t);if(!m){console.warn("Tier not found for boostBips:",t);return}const p=`pool_${m.name.toLowerCase()}`;let f=w[p]||ga.get(t);if(!f){const D=w.nftLiquidityPoolFactory;if(D&&d.publicProvider)try{f=await new Pe.Contract(D,$0,d.publicProvider).getPoolAddress(t),f&&f!==Pe.ZeroAddress&&ga.set(t,f)}catch(K){console.warn("Factory lookup failed:",K.message)}}if(It!==n)return;if(!f||f===Pe.ZeroAddress){const D=document.getElementById("swap-interface");D&&(D.innerHTML=`
                    <div class="text-center py-12">
                ...
                `);return}const b=new Pe.Contract(f,ji,d.publicProvider),[x,y,C]=await Promise.all([re(b,"getBuyPrice",[],Pe.MaxUint256).catch(()=>Pe.MaxUint256),re(b,"getSellPrice",[],0n).catch(()=>0n),b.getAvailableNFTs().catch(()=>[])]);if(It!==n)return;const I=Array.isArray(C)?[...C]:[],B=x===Pe.MaxUint256?0n:x,z=y;let N=((a=d.systemFees)==null?void 0:a.NFT_POOL_SELL_TAX_BIPS)||1000n,T=BigInt(((s=d.boosterDiscounts)==null?void 0:s[L.bestBoosterBips])||0);const F=typeof N=="bigint"?N:BigInt(N),Y=typeof T=="bigint"?T:BigInt(T),oe=F>Y?F-Y:0n,pe=z*oe/10000n,ye=z-pe,te={buyPrice:B,sellPrice:z,netSellPrice:ye,poolNFTCount:I.length,firstAvailableTokenIdForBuy:I.length>0?BigInt(I[I.length-1]):null,userBalanceOfSelectedNFT:l.length,availableToSellCount:u.length,availableNFTsOfTier:u};Yl(t,te),As(te,t)}catch(r){if(console.warn("Store Data Warning:",r.message),It===n){const i=document.getElementById("swap-interface");i&&(i.innerHTML=`
                    <div class="text-center py-12">
                        <div class="w-12 h-12 bg-zinc-800 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                `)}return}finally{It===n&&(L.isDataLoading=!1,xa(),pi())}}async function H0(e,t){var n,a;try{const s=d.myBoosters||[],r=d.rentalListings||[],i=new Set(r.map(te=>{var D;return(D=te.tokenId)==null?void 0:D.toString()})),o=Math.floor(Date.now()/1e3),c=s.filter(te=>Number(te.boostBips)===e),l=c.filter(te=>{var rt;const D=(rt=te.tokenId)==null?void 0:rt.toString(),K=r.find(Ue=>{var X;return((X=Ue.tokenId)==null?void 0:X.toString())===D}),de=i.has(D),ie=K&&K.rentalEndTime&&Number(K.rentalEndTime)>o;return!de&&!ie}),u=he.find(te=>te.boostBips===e);if(!u)return;const m=`pool_${u.name.toLowerCase()}`;let p=w[m]||ga.get(e);if(!p||p===Pe.ZeroAddress)return;const f=new Pe.Contract(p,ji,d.publicProvider),[b,x,y]=await Promise.all([re(f,"getBuyPrice",[],Pe.MaxUint256).catch(()=>Pe.MaxUint256),re(f,"getSellPrice",[],0n).catch(()=>0n),f.getAvailableNFTs().catch(()=>[])]);if(It!==t)return;const C=Array.isArray(y)?[...y]:[],I=b===Pe.MaxUint256?0n:b,B=x;let z=((n=d.systemFees)==null?void 0:n.NFT_POOL_SELL_TAX_BIPS)||1000n,N=BigInt(((a=d.boosterDiscounts)==null?void 0:a[L.bestBoosterBips])||0);const T=typeof z=="bigint"?z:BigInt(z),F=typeof N=="bigint"?N:BigInt(N),Y=T>F?T-F:0n,oe=B*Y/10000n,pe=B-oe,ye={buyPrice:I,sellPrice:B,netSellPrice:pe,poolNFTCount:C.length,firstAvailableTokenIdForBuy:C.length>0?BigInt(C[C.length-1]):null,userBalanceOfSelectedNFT:c.length,availableToSellCount:l.length,availableNFTsOfTier:l};Yl(e,ye),L.selectedPoolBoostBips===e&&It===t&&(As(ye,e),xa())}catch(s){console.warn("Background refresh failed:",s.message)}}function As(e,t){var s,r,i;L.buyPrice=e.buyPrice,L.sellPrice=e.sellPrice,L.netSellPrice=e.netSellPrice,L.poolNFTCount=e.poolNFTCount,L.firstAvailableTokenIdForBuy=e.firstAvailableTokenIdForBuy,L.userBalanceOfSelectedNFT=e.userBalanceOfSelectedNFT,L.availableToSellCount=e.availableToSellCount;const n=L.firstAvailableTokenId;!(n&&((s=e.availableNFTsOfTier)==null?void 0:s.some(o=>BigInt(o.tokenId)===n)))&&((r=e.availableNFTsOfTier)==null?void 0:r.length)>0?L.firstAvailableTokenId=BigInt(e.availableNFTsOfTier[0].tokenId):(i=e.availableNFTsOfTier)!=null&&i.length||(L.firstAvailableTokenId=null)}function j0(){const e=document.getElementById("store");e&&e.addEventListener("click",async t=>{if(t.target.closest("#refresh-btn")){const i=t.target.closest("#refresh-btn").querySelector("i");i.classList.add("fa-spin"),as(L.selectedPoolBoostBips),await Promise.all([At(!0),Vi()]),await lt(!0),yn(),i.classList.remove("fa-spin");return}const n=t.target.closest(".tier-chip");if(n){const r=Number(n.dataset.boost);L.selectedPoolBoostBips!==r&&(L.selectedPoolBoostBips=r,L.firstAvailableTokenId=null,ui(r),await lt());return}if(t.target.closest("#swap-direction-btn")){L.tradeDirection=L.tradeDirection==="buy"?"sell":"buy",xa();return}if(t.target.closest("#inventory-toggle")){const r=document.getElementById("inventory-panel"),i=document.getElementById("inventory-chevron");r&&i&&(r.classList.toggle("hidden"),i.style.transform=r.classList.contains("hidden")?"":"rotate(180deg)");return}if(t.target.closest("#history-toggle")){const r=document.getElementById("history-panel"),i=document.getElementById("history-chevron");r&&i&&(r.classList.toggle("hidden"),i.style.transform=r.classList.contains("hidden")?"":"rotate(180deg)");return}const a=t.target.closest(".inventory-item");if(a){if(a.dataset.unavailable==="true"){h("This NFT is listed for rental and cannot be sold","warning");return}const i=Number(a.dataset.boost),o=a.dataset.tokenid;L.selectedPoolBoostBips=i,L.tradeDirection="sell",o&&(L.firstAvailableTokenId=BigInt(o),console.log("User selected NFT #"+o+" for sale")),ui(i),await lt();return}const s=t.target.closest("#execute-btn");if(s){if(t.preventDefault(),t.stopPropagation(),oa||s.disabled)return;const r=s.dataset.action,i=document.getElementById("trade-mascot");if(r==="connect"){window.openConnectModal();return}const o=he.find(u=>u.boostBips===L.selectedPoolBoostBips);if(!o)return;const c=`pool_${o.name.toLowerCase()}`,l=w[c]||ga.get(o.boostBips);if(!l){h("Pool address not found","error");return}oa=!0,i&&(i.className="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden trade-spin");try{if(L.tradeDirection==="buy")await hs.buyFromPool({poolAddress:l,button:s,onSuccess:async u=>{i&&(i.className="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden trade-success"),h("🟢 NFT Purchased!","success"),as(L.selectedPoolBoostBips),await Promise.all([At(!0),lt(!0)]),yn()},onError:u=>{if(!u.cancelled&&u.type!=="user_rejected"){const m=u.message||u.reason||"Transaction failed";h("Buy failed: "+m,"error")}}});else{if(!L.firstAvailableTokenId){h("No NFT selected for sale","error"),oa=!1;return}await hs.sellToPool({poolAddress:l,tokenId:L.firstAvailableTokenId,button:s,onSuccess:async u=>{i&&(i.className="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden trade-success"),h("🔴 NFT Sold!","success"),as(L.selectedPoolBoostBips),await Promise.all([At(!0),lt(!0)]),yn()},onError:u=>{if(!u.cancelled&&u.type!=="user_rejected"){const m=u.message||u.reason||"Transaction failed";h("Sell failed: "+m,"error")}}})}}finally{oa=!1,setTimeout(async()=>{try{await Promise.all([At(!0),lt(!0)]),yn()}catch(u){console.warn("[Store] Post-transaction refresh failed:",u.message)}},2e3),i&&setTimeout(()=>{const u=L.tradeDirection==="buy";i.className=`w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden ${u?"trade-buy":"trade-sell"}`},800)}}})}const W0="https://sepolia.arbiscan.io/tx/",gn={NONE:{boost:0,burnRate:50,keepRate:50,color:"#71717a",name:"None",icon:"○",emoji:"❌",class:"tier-none"},BRONZE:{boost:1e3,burnRate:40,keepRate:60,color:"#cd7f32",name:"Bronze",icon:"🥉",emoji:"🥉",class:"tier-bronze"},SILVER:{boost:2500,burnRate:25,keepRate:75,color:"#c0c0c0",name:"Silver",icon:"🥈",emoji:"🥈",class:"tier-silver"},GOLD:{boost:4e3,burnRate:10,keepRate:90,color:"#ffd700",name:"Gold",icon:"🥇",emoji:"🥇",class:"tier-gold"},DIAMOND:{boost:5e3,burnRate:0,keepRate:100,color:"#b9f2ff",name:"Diamond",icon:"💎",emoji:"💎",class:"tier-diamond"}};let ss=0,rs=!1,ua=!1,_n=[],Fn=null,xe=0,tn=50,ha="none",va=0n,Ve=null,ca=0;const mi=3e4;window.handleRewardsClaim=async function(){ua||await Q0()};function Vl(e){return e>=5e3?gn.DIAMOND:e>=4e3?gn.GOLD:e>=2500?gn.SILVER:e>=1e3?gn.BRONZE:gn.NONE}function G0(e){const t=Math.floor((new Date-e)/1e3);return t<60?"Just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:t<604800?`${Math.floor(t/86400)}d ago`:e.toLocaleDateString()}function K0(){if(document.getElementById("rewards-styles-v6"))return;const e=document.createElement("style");e.id="rewards-styles-v6",e.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(e)}const wa={async render(e){K0();const t=document.getElementById("rewards");t&&((t.innerHTML.trim()===""||e)&&(t.innerHTML=X0()),d.isConnected?(Ve&&Date.now()-ca<mi?la(Ve):J0(),this.update(e)):fi())},async update(e=!1){if(!d.isConnected){fi();return}const t=Date.now();if(!e&&Ve&&t-ca<mi){la(Ve);return}if(!(!e&&rs)){if(!e&&t-ss<6e4){Ve&&la(Ve);return}rs=!0;try{await Mt(),await Y0(),await V0();const n=await on();await q0(),Ve={grossRewards:n,claimPreview:Fn,userNftBoost:xe,userBurnRate:tn,nftSource:ha,claimEthFee:va},ca=t,la(Ve),ss=t}catch(n){console.error("Rewards Error:",n)}finally{rs=!1}}},clearCache(){Ve=null,ca=0,ss=0,Fn=null}};async function Y0(){try{const e=d.delegationManagerContract||d.delegationManagerContractPublic;if(e&&d.userAddress)try{const n=await e.getUserBestBoost(d.userAddress);xe=Number(n)}catch{const n=await Zt();xe=(n==null?void 0:n.highestBoost)||0,ha=(n==null?void 0:n.source)||"none"}else{const n=await Zt();xe=(n==null?void 0:n.highestBoost)||0,ha=(n==null?void 0:n.source)||"none"}tn=Vl(xe).burnRate}catch(e){console.error("Error loading NFT boost:",e),xe=0,tn=50}}async function V0(){try{const e=d.delegationManagerContract||d.delegationManagerContractPublic;if(e&&d.userAddress){try{const t=await e.previewClaim(d.userAddress);Fn={totalRewards:t.totalRewards||t[0]||0n,burnAmount:t.burnAmount||t[1]||0n,userReceives:t.userReceives||t[2]||0n,burnRateBips:t.burnRateBips||t[3]||0n,nftBoost:t.nftBoost||t[4]||0n}}catch{const{stakingRewards:t,minerRewards:n}=await on(),a=(t||0n)+(n||0n),s=a*BigInt(tn)/100n;Fn={totalRewards:a,burnAmount:s,userReceives:a-s,burnRateBips:BigInt(tn*100),nftBoost:BigInt(xe)}}try{va=await e.claimEthFee()}catch{va=0n}}}catch(e){console.error("Error loading claim preview:",e)}}async function q0(){if(d.userAddress)try{const e=(Ie==null?void 0:Ie.getHistory)||"https://gethistory-4wvdcuoouq-uc.a.run.app",t=await fetch(`${e}/${d.userAddress}`);if(!t.ok)return;_n=(await t.json()).filter(a=>a.type==="ClaimReward"||(a.type||"").toUpperCase().includes("CLAIM")).slice(0,10).map(a=>{var s,r,i,o;return{amount:a.amount||((s=a.details)==null?void 0:s.amountReceived)||((r=a.details)==null?void 0:r.amount)||"0",burnedAmount:((i=a.details)==null?void 0:i.burnedAmount)||"0",timestamp:(o=a.timestamp)!=null&&o._seconds?new Date(a.timestamp._seconds*1e3):a.timestamp?new Date(a.timestamp):new Date,txHash:a.txHash||""}})}catch(e){console.warn("Failed to load claim history:",e.message),_n=[]}}function X0(){return`
    ...
    `}function fi(){const e=document.getElementById("rewards-content");e&&(e.innerHTML=`
    ...
    `)}function J0(){const e=document.getElementById("rewards-content");e&&(e.innerHTML=`
    ...
    `)}function la(e){const t=document.getElementById("rewards-content");if(!t)return;const{grossRewards:n}=e||{},a=(n==null?void 0:n.stakingRewards)||0n,s=(n==null?void 0:n.minerRewards)||0n,r=Fn||{},i=r.totalRewards||a+s,o=r.burnAmount||i*BigInt(tn)/100n,c=r.userReceives||i-o,l=Number(i)/1e18,u=Number(o)/1e18,m=Number(c)/1e18,p=Number(a)/1e18,f=Number(s)/1e18,b=Number(va)/1e18,x=i>0n,y=Vl(xe),C=l,I=l*(y.keepRate/100),B=C-I;t.innerHTML=`
        <div class="space-y-4">
            ...
            <div class="rewards-card p-5">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <div class="w-12 h-12 rounded-xl ${xe>0?`bg-gradient-to-br from-${y.class==="tier-diamond"?"cyan":y.class==="tier-gold"?"amber":y.class==="tier-silver"?"gray":y.class==="tier-bronze"?"yellow":"zinc"}-500/20`:"bg-zinc-800"} border border-zinc-700/50 flex items-center justify-center text-2xl">
                            ${y.emoji}
                        </div>
                        <div>
                            <p class="text-white font-semibold">${xe>0?`${y.name} Booster`:"No Booster"}</p>
                            <p class="text-xs text-zinc-500">
                                ${xe>0?`${ha==="rented"?"Rented":"Active"} • Keep ${y.keepRate}%`:"Keep up to 100% with NFT"}
                            </p>
                        </div>
                    </div>
    ...
    `}function Z0(){return _n.length===0?`
            <div class="text-center py-8">
                <i class="fa-solid fa-inbox text-zinc-700 text-2xl mb-3"></i>
                <p class="text-zinc-600 text-xs">No claims yet</p>
            </div>
        `:_n.map(e=>{const t=e.amount?(Number(e.amount)/1e18).toFixed(4):"0",n=e.burnedAmount&&Number(e.burnedAmount)>0?(Number(e.burnedAmount)/1e18).toFixed(2):null,a=e.timestamp?G0(new Date(e.timestamp)):"";return`
            <a href="${W0}${e.txHash}" target="_blank" 
        ...
        `}).join("")}async function Q0(){if(ua)return;const e=document.getElementById("claim-btn");if(e){ua=!0;try{await Rt.claimRewards({button:e,onSuccess:t=>{h("🎁 Rewards claimed successfully!","success"),setTimeout(()=>{wa.clearCache(),_n=[],wa.update(!0)},2500)},onError:t=>{t&&!t.cancelled&&t.type!=="user_rejected"&&h(t.message||"Claim failed","error")}})}catch(t){console.error("Claim error:",t),h(t.message||"Claim failed","error")}finally{ua=!1}}}window.RewardsPage=wa;const xr="https://sepolia.arbiscan.io/tx/",Bs="https://sepolia.arbiscan.io/address/",ql="0x16346f5a45f9615f1c894414989f0891c54ef07b",em=(w==null?void 0:w.fortunePool)||"0x277dB00d533Bbc0fc267bbD954640aDA38ee6B37",ya="./assets/fortune.png",Ps=1e3,bi={pt:{title:"Compartilhe & Ganhe!",subtitle:"+1000 pontos para o Airdrop",later:"Talvez depois"},en:{title:"Share & Earn!",subtitle:"+1000 points for Airdrop",later:"Maybe later"},es:{title:"¡Comparte y Gana!",subtitle:"+1000 puntos para el Airdrop",later:"Quizás después"}},tm={pt:{win:e=>`🎉 Ganhei ${e.toLocaleString()} BKC no Fortune Pool!
...
#Backcoin #Web3 #Arbitrum`}},is={pt:"./assets/pt.png",en:"./assets/en.png",es:"./assets/es.png"};let qe="en";const me=[{id:1,name:"Easy",emoji:"🍀",range:3,multiplier:2,chance:"33%",color:"emerald",hex:"#10b981",bgFrom:"from-emerald-500/20",bgTo:"to-green-600/10",borderColor:"border-emerald-500/50",textColor:"text-emerald-400"},{id:2,name:"Medium",emoji:"⚡",range:10,multiplier:5,chance:"10%",color:"violet",hex:"#8b5cf6",bgFrom:"from-violet-500/20",bgTo:"to-purple-600/10",borderColor:"border-violet-500/50",textColor:"text-violet-400"},{id:3,name:"Hard",emoji:"👑",range:100,multiplier:50,chance:"1%",color:"amber",hex:"#f59e0b",bgFrom:"from-amber-500/20",bgTo:"to-orange-600/10",borderColor:"border-amber-500/50",textColor:"text-amber-400"}],Xl=57,k={mode:null,phase:"select",guess:50,guesses:[2,5,50],comboStep:0,wager:10,gameId:null,result:null,txHash:null,poolStatus:null,history:[],serviceFee:0n,serviceFee1x:0n,serviceFee5x:0n,tiersData:null,commitment:{hash:null,userSecret:null,commitBlock:null,commitTxHash:null,revealDelay:2,waitStartTime:null,canReveal:!1}};let Re=null;const nm=3e3,Jl=250;function am(){if(document.getElementById("fortune-styles-v2"))return;const e=document.createElement("style");e.id="fortune-styles-v2",e.textContent=`
    ...
    `,document.head.appendChild(e)}function sm(){am();const e=document.getElementById("actions");if(!e){console.error("❌ FortunePool: Container #actions not found!");return}e.innerHTML=`
        <div class="max-w-md mx-auto px-4 py-6">
            <!-- Header -->
            <div class="text-center mb-6">
                <div class="relative inline-block">
                    <img id="tiger-mascot" src="${ya}" 
                ...
                <div class="flex items-center justify-center gap-2 mt-3 flex-wrap">
                    <a href="${Bs}${ql}" target="_blank" rel="noopener" 
                    ...
                    <a href="${Bs}${em}" target="_blank" rel="noopener" 
            ...
            <div class="bg-zinc-900/50 border border-zinc-800/50 rounded-2xl overflow-hidden">
                ...
                <div id="history-list" class="max-h-[300px] overflow-y-auto p-2">
                    <div class="p-6 text-center text-zinc-600 text-sm">
                        <img src="${ya}" class="w-12 h-12 mx-auto opacity-30 animate-pulse mb-2" onerror="this.style.display='none'">
                        Loading...
                    </div>
                </div>
            </div>
        </div>
    `,vr(),ue()}function rm(){Re&&(clearInterval(Re),Re=null),k.phase="select",k.result=null,k.commitment={hash:null,userSecret:null,commitBlock:null,commitTxHash:null,revealDelay:k.commitment.revealDelay||2,waitStartTime:null,canReveal:!1}}function ue(){const e=document.getElementById("game-area");if(e)switch(im(k.phase),k.phase){case"select":gi(e);break;case"pick":om(e);break;case"wager":dm(e);break;case"processing":pm(e);break;case"waiting":mm(e);break;case"result":hm(e);break;default:gi(e)}}function im(e){var n;const t=document.getElementById("tiger-mascot");if(t)switch(t.className="w-28 h-28 object-contain mx-auto",t.style.filter="",e){case"select":t.classList.add("tiger-float","tiger-pulse");break;case"pick":case"wager":t.classList.add("tiger-float");break;case"processing":t.classList.add("tiger-spin");break;case"waiting":t.classList.add("tiger-float"),t.style.filter="hue-rotate(270deg)";break;case"result":((n=k.result)==null?void 0:n.prizeWon)>0?t.classList.add("tiger-celebrate"):(t.style.filter="grayscale(0.5)",t.classList.add("tiger-float"));break}}function gi(e){var s,r;const t=k.serviceFee1x>0n?(Number(k.serviceFee1x)/1e18).toFixed(6):"0",n=k.serviceFee5x>0n?(Number(k.serviceFee5x)/1e18).toFixed(6):"0",a=k.serviceFee1x>0n||k.serviceFee5x>0n;e.innerHTML=`
        <div class="space-y-4">
            <!-- JACKPOT MODE -->
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center gap-3 mb-1">
                            ...
                            <span class="px-2.5 py-1 rounded-full bg-violet-500/20 border border-violet-500/40 text-violet-400 text-sm font-black">${Xl}x</span>
                        </div>
    ...
    `,a.forEach((s,r)=>{const i=document.getElementById(`spin-${r}`);if(!i)return;setInterval(()=>{i.textContent=Math.floor(Math.random()*s.range)+1},80)})}function mm(e){var c;const t=k.mode==="jackpot",n=t?[k.guess]:k.guesses,a=t?[me[2]]:me,s=Date.now()-(k.commitment.waitStartTime||Date.now()),r=k.commitment.revealDelay*Jl,i=Math.max(0,r-s),o=Math.ceil(i/1e3);e.innerHTML=`
        <div class="bg-gradient-to-br from-violet-900/30 to-purple-900/20 border border-violet-500/30 rounded-2xl p-6 waiting-glow">
            ...
            ${k.commitment.commitTxHash?`
                <div class="text-center mt-3">
                    <a href="${xr}${k.commitment.commitTxHash}" target="_blank" 
    ...
    `,(c=document.getElementById("btn-reveal"))==null||c.addEventListener("click",()=>{k.commitment.canReveal&&zs()}),hr()}function hr(){if(k.phase!=="waiting")return;const e=document.getElementById("countdown-timer"),t=document.getElementById("progress-bar");if(document.getElementById("btn-reveal"),document.getElementById("reveal-btn-text"),!e)return;const n=Date.now()-(k.commitment.waitStartTime||Date.now()),a=k.commitment.revealDelay*Jl,s=Math.max(0,a-n),r=Math.ceil(s/1e3);if(r>0?e.textContent=`~${r}s`:k.commitment.canReveal?e.textContent="Ready!":e.textContent="Verifying on chain...",t){const i=Math.min(100,n/a*100);t.style.width=`${i}%`}k.phase==="waiting"&&setTimeout(hr,1e3)}function fm(){Re&&clearInterval(Re),setTimeout(hr,100),Re=setInterval(async()=>{if(k.phase!=="waiting"){clearInterval(Re);return}try{await xm()&&!k.commitment.canReveal&&(k.commitment.canReveal=!0,clearInterval(Re),Re=null,console.log("[FortunePool] canReveal=true, starting auto-reveal..."),bm())}catch(e){console.warn("Reveal check error:",e)}},nm)}async function bm(){if(k.phase!=="waiting")return;const e=document.getElementById("countdown-timer"),t=document.getElementById("btn-reveal"),n=document.getElementById("reveal-btn-text");e&&(e.textContent="Revealing..."),t&&(t.disabled=!0,t.classList.remove("bg-zinc-800","text-zinc-500","cursor-not-allowed"),t.classList.add("bg-gradient-to-r","from-amber-500","to-yellow-500","text-white")),n&&(n.textContent="Auto-revealing...");const a=k.mode==="jackpot"?[k.guess]:k.guesses,s=5,r=2e3;await new Promise(i=>setTimeout(i,3e3));for(let i=1;i<=s;i++){if(k.phase!=="waiting")return;try{const o=d.fortunePoolContractPublic;o&&await o.revealPlay.staticCall(k.gameId,a,k.commitment.userSecret,{from:d.userAddress}),console.log(`[FortunePool] Pre-simulation passed (attempt ${i})`),zs();return}catch(o){const c=o.message||"",l=c.includes("0x92555c0e")||c.includes("BlockhashUnavailable");if(l&&i<s)console.log(`[FortunePool] BlockhashUnavailable, retry in ${r}ms (${i}/${s})`),e&&(e.textContent="Syncing block data..."),await new Promise(u=>setTimeout(u,r));else if(l){console.warn("[FortunePool] Pre-sim retries exhausted, enabling manual button"),gm();return}else{console.log("[FortunePool] Pre-sim error (non-blockhash), trying direct reveal:",c),zs();return}}}}function gm(){const e=document.getElementById("btn-reveal"),t=document.getElementById("reveal-btn-text"),n=document.getElementById("countdown-timer");n&&(n.textContent="Ready!"),e&&(e.disabled=!1,e.classList.remove("bg-zinc-800","text-zinc-500","cursor-not-allowed","from-amber-500","to-yellow-500"),e.classList.add("bg-gradient-to-r","from-emerald-500","to-green-500","text-white")),t&&(t.textContent="Reveal & Get Result!")}async function xm(){if(!d.fortunePoolContractPublic||!k.gameId)return!1;try{const e=await d.fortunePoolContractPublic.getCommitmentStatus(k.gameId);if(!k.commitment.commitBlock)try{const t=await d.fortunePoolContractPublic.getCommitment(k.gameId),n=Number(t.commitBlock);n>0&&(k.commitment.commitBlock=n)}catch{}return e.canReveal===!0}catch{return Date.now()-(k.commitment.waitStartTime||Date.now())>=3e4}}async function zs(){if(!k.commitment.canReveal){h("Not ready to reveal yet!","warning");return}const e=document.getElementById("btn-reveal");try{const t=k.mode==="jackpot"?[k.guess]:k.guesses;await rr.revealPlay({gameId:k.gameId,guesses:t,userSecret:k.commitment.userSecret,button:e,onSuccess:(n,a)=>{Re&&clearInterval(Re),k.txHash=n.hash,k.result={rolls:(a==null?void 0:a.rolls)||[],prizeWon:(a==null?void 0:a.prizeWon)||0n,matches:(a==null?void 0:a.matches)||[],matchCount:(a==null?void 0:a.matchCount)||0},console.log("🎲 Game revealed:",k.result),k.phase="result",ue(),vr()},onError:n=>{if(!n.cancelled){const a=n.message||"";a.includes("0x92555c0e")||a.includes("BlockhashUnavailable")?h("Block data not available yet. RPC will retry automatically.","warning"):h(a||"Reveal failed","error")}e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-dice mr-2"></i>Try Again')}})}catch(t){console.error("Reveal error:",t),h("Reveal failed: "+(t.message||"Unknown error"),"error"),e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-dice mr-2"></i>Try Again')}}function hm(e){var m,p;const t=k.result;if(!t)return ue();const n=k.mode==="jackpot",a=n?[k.guess]:k.guesses,s=t.rolls||[],r=n?[me[2]]:me,i=a.map((f,b)=>{const x=s[b]!==void 0?Number(s[b]):null;return x!==null&&x===f}),o=i.filter(f=>f).length,c=t.prizeWon>0||o>0;let l=0;t.prizeWon&&t.prizeWon>0n?l=_(BigInt(t.prizeWon)):o>0&&i.forEach((f,b)=>{if(f){const x=n?me[2]:me[b];l+=k.wager*x.multiplier}});const u=typeof l=="number"?l.toLocaleString(void 0,{maximumFractionDigits:2}):l.toLocaleString();e.innerHTML=`
        <div class="bg-gradient-to-br ${c?"from-emerald-900/30 to-green-900/10 border-emerald-500/30":"from-zinc-900 to-zinc-800/50 border-zinc-700/50"} border rounded-2xl p-4 sm:p-6 relative overflow-hidden" id="result-container">
            ...
            <div class="grid ${n?"grid-cols-1 max-w-[200px] mx-auto":"grid-cols-3"} gap-2 sm:gap-3 mb-4">
                ${r.map((f,b)=>{const x=n?a[0]:a[b],y=s[b],C=i[b];return`
            ...
            ${k.txHash?`
                <div class="text-center mb-3">
                    <a href="${xr}${k.txHash}" target="_blank" class="inline-flex items-center gap-2 text-xs text-zinc-500 hover:text-zinc-400">
                        <i class="fa-solid fa-external-link"></i>
                        View Transaction
                    </a>
                </div>
    ...
    `,c&&(vm(),l>k.wager*10&&wm()),(m=document.getElementById("btn-new-game"))==null||m.addEventListener("click",()=>{k.phase="select",k.result=null,k.txHash=null,k.gameId=null,ue(),vr()}),(p=document.getElementById("btn-share"))==null||p.addEventListener("click",()=>{ym(c,l)})}function vm(){const e=document.createElement("div");e.className="confetti-container",document.body.appendChild(e);const t=["#f59e0b","#10b981","#8b5cf6","#ec4899","#06b6d4"],n=["●","■","★","🐯","🎉"];for(let a=0;a<60;a++){const s=document.createElement("div");s.className="confetti",s.style.cssText=`
            left: ${Math.random()*100}%;
            color: ${t[a%t.length]};
            font-size: ${8+Math.random()*12}px;
            animation-delay: ${Math.random()*2}s;
            animation-duration: ${2+Math.random()*2}s;
        `,s.textContent=n[a%n.length],e.appendChild(s)}setTimeout(()=>e.remove(),5e3)}function wm(){const e=["🪙","💰","✨","⭐","🎉"];for(let t=0;t<30;t++)setTimeout(()=>{const n=document.createElement("div");n.className="coin",n.textContent=e[Math.floor(Math.random()*e.length)],n.style.left=`${Math.random()*100}%`,n.style.animationDelay=`${Math.random()*.5}s`,n.style.animationDuration=`${2+Math.random()*2}s`,document.body.appendChild(n),setTimeout(()=>n.remove(),4e3)},t*100)}function ym(e,t){var c,l,u,m,p,f;const n=bi[qe],a=()=>{const b=tm[qe];return e?b.win(t):b.lose},s=`
        <div class="text-center">
            <img src="${ya}" class="w-16 h-16 mx-auto mb-2" alt="Fortune Pool" onerror="this.style.display='none'">
            ...
            <div class="flex justify-center gap-2 mb-4">
                <button class="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${qe==="pt"?"bg-amber-500/20 border-amber-500 ring-1 ring-amber-500/50":"bg-zinc-800 border-zinc-700 hover:border-zinc-500"} border" data-lang="pt">
                    <img src="${is.pt}" class="w-5 h-5 rounded-full object-cover" alt="PT">
                ...
                <button class="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${qe==="en"?"bg-amber-500/20 border-amber-500 ring-1 ring-amber-500/50":"bg-zinc-800 border-zinc-700 hover:border-zinc-500"} border" data-lang="en">
                    <img src="${is.en}" class="w-5 h-5 rounded-full object-cover" alt="EN">
                ...
                <button class="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${qe==="es"?"bg-amber-500/20 border-amber-500 ring-1 ring-amber-500/50":"bg-zinc-800 border-zinc-700 hover:border-zinc-500"} border" data-lang="es">
                    <img src="${is.es}" class="w-5 h-5 rounded-full object-cover" alt="ES">
    ...
    `;Pn(s,"max-w-xs");const r=b=>{qe=b;const x=bi[b],y=document.getElementById("share-modal-title"),C=document.getElementById("share-modal-subtitle"),I=document.getElementById("btn-close-share");y&&(y.textContent=x.title),C&&(C.textContent=x.subtitle),I&&(I.textContent=x.later),document.querySelectorAll(".lang-btn").forEach(B=>{const z=B.dataset.lang,N=B.querySelector("span");z===b?(B.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-amber-500/20 border-amber-500 ring-1 ring-amber-500/50 border",N&&(N.className="text-amber-400")):(B.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-zinc-800 border-zinc-700 hover:border-zinc-500 border",N&&(N.className="text-zinc-400"))})};document.querySelectorAll(".lang-btn").forEach(b=>{b.addEventListener("click",()=>r(b.dataset.lang))});const i=async b=>{if(!d.userAddress)return!1;try{const y=await(await fetch("https://us-central1-backchain-backand.cloudfunctions.net/trackShare",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({address:d.userAddress,gameId:k.gameId||Date.now(),type:"fortune",platform:b})})).json();return y.success?(h(`🎉 +${y.pointsAwarded||Ps} Airdrop Points!`,"success"),!0):(y.reason==="already_shared"&&console.log("Already shared this game"),!1)}catch(x){return console.error("Share tracking error:",x),h(`🎉 +${Ps} Airdrop Points!`,"success"),!0}},o=async(b,x)=>{await i(b),window.open(x,"_blank"),Ee()};(c=document.getElementById("share-twitter"))==null||c.addEventListener("click",()=>{const b=a();o("twitter",`https://twitter.com/intent/tweet?text=${encodeURIComponent(b)}`)}),(l=document.getElementById("share-telegram"))==null||l.addEventListener("click",()=>{const b=a();o("telegram",`https://t.me/share/url?url=https://backcoin.org&text=${encodeURIComponent(b)}`)}),(u=document.getElementById("share-whatsapp"))==null||u.addEventListener("click",()=>{const b=a();o("whatsapp",`https://wa.me/?text=${encodeURIComponent(b)}`)}),(m=document.getElementById("share-instagram"))==null||m.addEventListener("click",async()=>{const b=a();try{await navigator.clipboard.writeText(b),await i("instagram");const x=`
            ...
            `;Ee(),setTimeout(()=>{var y,C;Pn(x,"max-w-xs"),(y=document.getElementById("btn-open-instagram"))==null||y.addEventListener("click",()=>{window.open("https://www.instagram.com/backcoin.bkc/","_blank"),Ee()}),(C=document.getElementById("btn-close-ig-modal"))==null||C.addEventListener("click",Ee)},100)}catch{h("Could not copy text","error"),Ee()}}),(p=document.getElementById("share-copy"))==null||p.addEventListener("click",async()=>{const b=a();try{await navigator.clipboard.writeText(b),h("📋 Copied!","success"),await i("copy")}catch{h("Copy failed","error")}Ee()}),(f=document.getElementById("btn-close-share"))==null||f.addEventListener("click",Ee)}async function km(){const e=d.fortunePoolContract||d.fortunePoolContractPublic;if(!e)return console.log("No fortune contract available"),null;try{const[t,n,a]=await Promise.all([e.prizePoolBalance().catch(()=>0n),e.gameCounter().catch(()=>0),e.activeTierCount().catch(()=>3)]);let s=0n,r=0n,i=0n;try{s=await e.getRequiredServiceFee(!1),r=await e.getRequiredServiceFee(!0),i=s,console.log(`Service fees: 1x=${Number(s)/1e18} ETH, 5x=${Number(r)/1e18} ETH`)}catch(o){console.log("getRequiredServiceFee failed, using fallback:",o.message);try{i=await e.serviceFee(),s=i,r=i*5n}catch{console.log("Could not fetch service fee")}}k.serviceFee=i,k.serviceFee1x=s,k.serviceFee5x=r;try{const o=await e.revealDelay();k.commitment.revealDelay=Number(o)||2,console.log("revealDelay from contract:",k.commitment.revealDelay)}catch{console.log("Using default revealDelay:",k.commitment.revealDelay)}try{const[o,c]=await e.getAllTiers();k.tiersData=o.map((l,u)=>({range:Number(l),multiplier:Number(c[u])/1e4})),console.log("Tiers from contract:",k.tiersData)}catch{console.log("Using default tiers")}return{prizePool:t||0n,gameCounter:Number(n)||0,serviceFee:i,serviceFee1x:s,serviceFee5x:r,tierCount:Number(a)||3}}catch(t){return console.error("getFortunePoolStatus error:",t),{prizePool:0n,gameCounter:0,serviceFee:0n}}}async function vr(){try{const e=await km();if(e){const n=document.getElementById("prize-pool"),a=document.getElementById("total-games");n&&(n.textContent=_(e.prizePool||0n).toFixed(2)+" BKC"),a&&(a.textContent=(e.gameCounter||0).toLocaleString())}const t=document.getElementById("user-balance");t&&(t.textContent=_(d.currentUserBalance||0n).toFixed(2)+" BKC"),Em()}catch(e){console.error("Pool error:",e)}}async function Em(){var e;try{const t=Ie.fortuneGames||"https://getfortunegames-4wvdcuoouq-uc.a.run.app",n=d.userAddress?`${t}?player=${d.userAddress}&limit=15`:`${t}?limit=15`,s=await(await fetch(n)).json();if(((e=s.games)==null?void 0:e.length)>0){Cm(s.games);const r=s.games.filter(o=>o.isWin||o.prizeWon&&BigInt(o.prizeWon)>0n).length,i=document.getElementById("win-rate");i&&(i.textContent=`🏆 ${r}/${s.games.length} wins`)}else{const r=document.getElementById("history-list");r&&(r.innerHTML=`
                <div class="p-8 text-center">
                    <img src="${ya}" class="w-16 h-16 mx-auto opacity-20 mb-3" onerror="this.style.display='none'">
                    <p class="text-zinc-500 text-sm">No games yet</p>
                    <p class="text-zinc-600 text-xs mt-1">Be the first to play!</p>
                </div>
            `)}}catch(t){console.error("loadHistory error:",t)}}function Cm(e){const t=document.getElementById("history-list");t&&(t.innerHTML=e.map(n=>{var b;const a=n.isWin||n.prizeWon&&BigInt(n.prizeWon)>0n,s=n.prizeWon?_(BigInt(n.prizeWon)):0,r=n.wagerAmount?_(BigInt(n.wagerAmount)):0,i=n.isCumulative,o=n.rolls||[],c=n.guesses||[],l=n.txHash||n.transactionHash,u=Tm(n.timestamp||n.createdAt),m=n.player?`${n.player.slice(0,6)}...${n.player.slice(-4)}`:"???",p=d.userAddress&&((b=n.player)==null?void 0:b.toLowerCase())===d.userAddress.toLowerCase(),f=l?`${xr}${l}`:null;return`
               ...
               ${f?"":'onclick="return false;"'}>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex gap-1">
                        ${(i?me:[me[2]]).map((x,y)=>{const C=c[y],I=o[y];return`
        ...
        `}).join(""))}function Tm(e){if(!e)return"N/A";try{const t=Date.now();let n;if(typeof e=="number"?n=e>1e12?e:e*1e3:typeof e=="string"?n=new Date(e).getTime():e._seconds?n=e._seconds*1e3:e.seconds?n=e.seconds*1e3:n=new Date(e).getTime(),isNaN(n))return"N/A";const a=t-n;if(a<0)return"Just now";const s=Math.floor(a/6e4),r=Math.floor(a/36e5),i=Math.floor(a/864e5);return s<1?"Just now":s<60?`${s}m ago`:r<24?`${r}h ago`:i<7?`${i}d ago`:new Date(n).toLocaleDateString("en-US",{month:"short",day:"numeric"})}catch(t){return console.error("getTimeAgo error:",t),"N/A"}}const Im={render:sm,cleanup:rm},Am=()=>{if(document.getElementById("about-styles-v4"))return;const e=document.createElement("style");e.id="about-styles-v4",e.innerHTML=`
        @keyframes pulse-hub {
    ...
    `,document.head.appendChild(e)};function Bm(){return`
    ...
    `,document.head.appendChild(e)}async function pn(){var e;P.isConnected=d.isConnected,P.user=null,P.userSubmissions=[],P.platformUsage={},P.isBanned=!1;try{const t=await Ws();if(P.systemConfig=t.config,P.leaderboards=t.leaderboards,P.dailyTasks=t.dailyTasks||[],P.platformUsageConfig=t.platformUsageConfig||Ql,P.isConnected&&d.userAddress){const[n,a]=await Promise.all([vn(d.userAddress),_u()]);if(P.user=n,P.userSubmissions=a,n&&n.isBanned){P.isBanned=!0;return}try{typeof Kr=="function"&&(P.platformUsage=await Kr()||{})}catch(s){console.warn("Could not load platform usage:",s),P.platformUsage={}}P.dailyTasks.length>0&&(P.dailyTasks=await Promise.all(P.dailyTasks.map(async s=>{try{if(!s.id)return{...s,eligible:!1,timeLeftMs:0};const r=await Zi(s.id,s.cooldownHours);return{...s,eligible:r.eligible,timeLeftMs:r.timeLeft}}catch{return{...s,eligible:!1,timeLeftMs:0}}})))}}catch(t){if(console.error("Airdrop Data Load Error:",t),t.code==="permission-denied"||(e=t.message)!=null&&e.includes("permission")){console.warn("Firebase permissions issue - user may need to connect wallet or sign in"),P.systemConfig=P.systemConfig||{},P.leaderboards=P.leaderboards||{top100ByPoints:[],top100ByPosts:[]},P.dailyTasks=P.dailyTasks||[];return}h("Error loading data. Please refresh.","error")}}function jm(e){if(!P.user||!e||e.length===0)return null;const t=e.findIndex(n=>{var a,s;return((a=n.walletAddress)==null?void 0:a.toLowerCase())===((s=P.user.walletAddress)==null?void 0:s.toLowerCase())});return t>=0?t+1:null}function Wm(e){return e?e<=5?dt[0]:e<=25?dt[1]:e<=75?dt[2]:e<=200?dt[3]:null:null}function ed(){var c;const{user:e}=P,t=(e==null?void 0:e.totalPoints)||0,n=(e==null?void 0:e.platformUsagePoints)||0,a=(e==null?void 0:e.approvedSubmissionsCount)||0,s=Um(a),r=((c=P.leaderboards)==null?void 0:c.top100ByPosts)||[],i=jm(r),o=Wm(i);return`
        <!-- Mobile Header -->
        <div class="md:hidden px-4 pt-4 pb-2">
            ...
            <div class="flex gap-1 bg-zinc-900/80 p-1 rounded-2xl border border-zinc-800">
                ${os("earn","fa-coins","Earn")}
                ${os("history","fa-clock-rotate-left","History")}
                ${os("leaderboard","fa-trophy","Ranking")}
            </div>
        </div>
        ...
        <div class="hidden md:block px-4 pt-6 pb-4">
            ...
            <div class="flex justify-center">
                <div class="bg-zinc-900/80 p-1.5 rounded-full border border-zinc-800 inline-flex gap-1">
                    ${cs("earn","fa-coins","Earn Points")}
                    ${cs("history","fa-clock-rotate-left","My History")}
                    ${cs("leaderboard","fa-trophy","Ranking")}
                </div>
            </div>
        </div>
    `}function os(e,t,n){const a=P.activeTab===e;return`
    ...
    `}function ls(){return P.isConnected?`
        <div class="px-4 airdrop-fade-up">
            ...
            <!-- Sub-tab Content -->
            <div id="earn-content">
                ${P.activeEarnTab==="post"?Gm():""}
                ${P.activeEarnTab==="platform"?Km():""}
                ${P.activeEarnTab==="tasks"?Ym():""}
            </div>
        </div>
    `:`
        ...
        `}function Gm(){const{user:e}=P,n=`https://backcoin.org/?ref=${(e==null?void 0:e.referralCode)||"CODE"}`;return`
        <div class="space-y-4">
                ...
                <div class="space-y-5">
                    ...
                    <div class="flex gap-3 items-start relative">
                        ...
                        <div class="flex-1 pb-2">
                            ...
                            <div class="grid grid-cols-4 gap-2">
                                <a href="https://twitter.com/intent/tweet?text=${encodeURIComponent(n+" "+Ls)}" target="_blank" 
    ...
    `}function Km(){var i;const e=P.platformUsageConfig||Ql,t=P.platformUsage||{};let n=0,a=0;Object.keys(e).forEach(o=>{var c;e[o].enabled!==!1&&e[o].maxCount&&(n+=e[o].maxCount,a+=Math.min(((c=t[o])==null?void 0:c.count)||0,e[o].maxCount))});const s=n>0?a/n*100:0,r=((i=P.user)==null?void 0:i.platformUsagePoints)||0;return`
        <div class="space-y-4">
            <!-- Info Banner -->
            ...
            <div class="grid grid-cols-2 gap-2" id="platform-actions-grid">
                ${Object.entries(e).filter(([o,c])=>c.enabled!==!1).map(([o,c])=>{const l=t[o]||{count:0},u=l.count>=c.maxCount,m=Math.max(0,c.maxCount-l.count),p=l.count/c.maxCount*100,f=Mm[o]||"";return`
    ...
    `}function Ym(){const e=P.dailyTasks||[],t=e.filter(a=>a.eligible),n=e.filter(a=>!a.eligible&&a.timeLeftMs>0);return`
        <div class="space-y-4">
            <!-- Info Banner -->
                        ...
                        ${n.map(a=>`
                            <div class="bg-zinc-900/80 border border-zinc-800 rounded-xl p-3 opacity-50">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-zinc-600 text-xs">${Dm(a.timeLeftMs)}</span>
                                </div>
                            </div>
                        `).join("")}
                    </div>
    ...
    `}function Vm(){const{user:e,userSubmissions:t}=P;if(!P.isConnected)return`
        ...
        `;const n=Date.now(),a=Zl*60*60*1e3,s=t.filter(c=>["pending","auditing"].includes(c.status)&&c.submittedAt&&n-c.submittedAt.getTime()>=a),r=(e==null?void 0:e.approvedSubmissionsCount)||0,i=t.filter(c=>["pending","auditing"].includes(c.status)).length,o=t.filter(c=>c.status==="rejected").length;return`
    ...
    `}function qm(){var u,m;const e=((u=P.leaderboards)==null?void 0:u.top100ByPosts)||[],t=((m=P.leaderboards)==null?void 0:m.top100ByPoints)||[],n=P.activeRanking||"posts";function a(p,f,b){var N,T;const x=P.user&&((N=p.walletAddress)==null?void 0:N.toLowerCase())===((T=P.user.walletAddress)==null?void 0:T.toLowerCase()),y=Xm(f+1),C=b==="posts"?"bg-amber-500/10":"bg-green-500/10",I=b==="posts"?"text-amber-400":"text-green-400",B=b==="posts"?"text-white":"text-green-400",z=b==="posts"?"posts":"pts";return`
            <div class="flex items-center justify-between p-3 ${x?C:"hover:bg-zinc-800/50"} transition-colors">
                <div class="flex items-center gap-3">
                    <span class="w-8 h-8 rounded-full ${y.bg} flex items-center justify-center text-xs font-bold">${y.icon||f+1}</span>
    ...
    `}function Xm(e){return e<=5?{icon:"💎",bg:"bg-cyan-500/20 text-cyan-300",tierName:"Diamond",tierTextColor:"text-cyan-400/70"}:e<=25?{icon:"🥇",bg:"bg-yellow-500/20 text-yellow-400",tierName:"Gold",tierTextColor:"text-yellow-400/70"}:e<=75?{icon:"🥈",bg:"bg-gray-400/20 text-gray-300",tierName:"Silver",tierTextColor:"text-gray-400/70"}:e<=200?{icon:"🥉",bg:"bg-amber-600/20 text-amber-500",tierName:"Bronze",tierTextColor:"text-amber-500/70"}:{icon:null,bg:"bg-zinc-800 text-zinc-400",tierName:null,tierTextColor:""}}function De(){const e=document.getElementById("main-content"),t=document.getElementById("airdrop-header");if(e){if(t&&(t.innerHTML=ed()),P.isBanned){e.innerHTML=`
        ...
        `;return}switch(document.querySelectorAll(".nav-pill-btn").forEach(n=>{const a=n.dataset.target;n.closest(".md\\:hidden")?a===P.activeTab?(n.classList.add("airdrop-tab-active","shadow-lg"),n.classList.remove("text-zinc-500")):(n.classList.remove("airdrop-tab-active","shadow-lg"),n.classList.add("text-zinc-500")):a===P.activeTab?(n.classList.remove("text-zinc-400","hover:text-white","hover:bg-zinc-800"),n.classList.add("airdrop-tab-active","shadow-lg","shadow-amber-500/20")):(n.classList.add("text-zinc-400","hover:text-white","hover:bg-zinc-800"),n.classList.remove("airdrop-tab-active","shadow-lg","shadow-amber-500/20"))}),P.activeTab){case"earn":e.innerHTML=ls();break;case"post":e.innerHTML=ls();break;case"history":e.innerHTML=Vm();break;case"leaderboard":e.innerHTML=qm();break;default:e.innerHTML=ls()}}}function Jm(){var n;const e=((n=P.user)==null?void 0:n.referralCode)||"CODE",t=`${e!=="CODE"?`https://backcoin.org/?ref=${e}`:"https://backcoin.org"} ${Ls}`;navigator.clipboard.writeText(t).then(()=>{h("Copied! Now paste it in your post.","success");const a=document.getElementById("copy-viral-btn");if(a){const s=a.innerHTML;a.innerHTML='<i class="fa-solid fa-check"></i> Copied!',a.classList.remove("cta-mega"),a.classList.add("bg-green-600"),setTimeout(()=>{a.innerHTML=s,a.classList.add("cta-mega"),a.classList.remove("bg-green-600")},2e3)}}).catch(()=>h("Failed to copy.","error"))}function hi(e){const t=e.target.closest(".nav-pill-btn");t&&(P.activeTab=t.dataset.target,De())}function Zm(e){const t=e.target.closest(".earn-tab-btn");t&&t.dataset.earnTab&&(P.activeEarnTab=t.dataset.earnTab,De())}function Qm(e){const t=e.target.closest(".ranking-tab-btn");t&&t.dataset.ranking&&(P.activeRanking=t.dataset.ranking,De())}function ef(){P.isGuideOpen=!P.isGuideOpen,De()}function td(e){var s;const t=`
        <div class="text-center">
            <!-- Imagem de CAUTION -->
    ...
    `;Pn(t,"max-w-md"),(s=document.getElementById("deletePostBtn"))==null||s.addEventListener("click",async r=>{const i=r.currentTarget,o=i.dataset.submissionId;i.disabled=!0,i.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-1"></i> Deleting...';try{await Qi(o),h("Post deleted. No penalty applied.","info"),Ee(),await pn(),De()}catch(c){h(c.message,"error"),i.disabled=!1,i.innerHTML='<i class="fa-solid fa-trash mr-1"></i> Delete Post'}});const n=document.getElementById("confirmCheckbox"),a=document.getElementById("finalConfirmBtn");n==null||n.addEventListener("change",()=>{n.checked?(a.disabled=!1,a.className="flex-1 bg-green-600 hover:bg-green-500 text-white py-3 rounded-xl font-bold text-sm transition-colors cursor-pointer",a.innerHTML='<i class="fa-solid fa-check mr-1"></i> Confirm & Earn ✓'):(a.disabled=!0,a.className="flex-1 bg-green-600/50 text-green-200 py-3 rounded-xl font-bold text-sm cursor-not-allowed transition-colors",a.innerHTML='<i class="fa-solid fa-lock mr-1"></i> Confirm & Earn')}),a==null||a.addEventListener("click",tf)}async function tf(e){const t=e.currentTarget,n=t.dataset.submissionId;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-2"></i> Verifying...';try{await Fu(n),h("Success! Points added.","success"),Ee(),await pn(),De()}catch{h("Verification failed.","error"),t.disabled=!1,t.innerHTML="Try Again"}}async function nf(e){const t=e.target.closest(".action-btn");if(!t)return;const n=t.dataset.action,a=t.dataset.id;if(n==="confirm"){const s=P.userSubmissions.find(r=>r.submissionId===a);s&&td(s)}else if(n==="delete"){if(!confirm("Remove this submission?"))return;try{await Qi(a),h("Removed.","info"),await pn(),De()}catch(s){h(s.message,"error")}}}async function af(e){const t=e.target.closest("#submit-content-btn");if(!t)return;const n=document.getElementById("content-url-input"),a=n==null?void 0:n.value.trim();if(!a||!a.startsWith("http"))return h("Enter a valid URL.","warning");const s=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-circle-notch fa-spin"></i>';try{await Ru(a),h("📋 Submitted! Your post is now under security audit.","info"),n.value="",await pn(),P.activeTab="history",De()}catch(r){h(r.message,"error")}finally{t.disabled=!1,t.innerHTML=s}}async function sf(e){const t=e.target.closest(".task-card");if(!t)return;const n=t.dataset.id,a=t.dataset.url;a&&window.open(a,"_blank");const s=P.dailyTasks.find(r=>r.id===n);if(!(!s||!s.eligible))try{await $u(s,P.user.pointsMultiplier),h(`Task completed! +${s.points} pts`,"success"),await pn(),De()}catch(r){r.message.includes("Cooldown")||h(r.message,"error")}}function rf(){const e=Date.now(),t=Zl*60*60*1e3,n=P.userSubmissions.filter(a=>["pending","auditing"].includes(a.status)&&a.submittedAt&&e-a.submittedAt.getTime()>=t);n.length>0&&(P.activeTab="history",De(),setTimeout(()=>{td(n[0])},500))}const of={async render(e){const t=document.getElementById("airdrop");if(!t)return;Hm();const n=Om();(t.innerHTML.trim()===""||e)&&(t.innerHTML=`
                ...
                <div id="airdrop-main" class="hidden">
                    <div id="airdrop-header">${ed()}</div>
                    <div id="airdrop-body" class="max-w-2xl mx-auto pb-24">
                        <div id="main-content"></div>
                    </div>
                </div>
            `,this.attachListeners());try{const a=new Promise(o=>setTimeout(o,4e3));await Promise.all([pn(),a]);const s=document.getElementById("loading-state"),r=document.getElementById("airdrop-main"),i=document.getElementById("main-content");s&&(s.style.transition="opacity 0.5s ease-out",s.style.opacity="0",await new Promise(o=>setTimeout(o,500)),s.classList.add("hidden")),r&&r.classList.remove("hidden"),i&&(i.classList.remove("hidden"),De()),rf()}catch(a){console.error(a)}},attachListeners(){const e=document.getElementById("airdrop-body"),t=document.getElementById("airdrop-header");t==null||t.addEventListener("click",hi),e==null||e.addEventListener("click",n=>{n.target.closest("#guide-toggle-btn")&&ef(),n.target.closest("#submit-content-btn")&&af(n),n.target.closest(".task-card")&&sf(n),n.target.closest(".action-btn")&&nf(n),n.target.closest("#copy-viral-btn")&&Jm(),n.target.closest(".ranking-tab-btn")&&Qm(n),n.target.closest(".earn-tab-btn")&&Zm(n),n.target.closest(".nav-pill-btn")&&hi(n);const a=n.target.closest(".platform-action-card");if(a&&!a.classList.contains("completed")){const s=a.dataset.targetPage;s&&(console.log("🎯 Navigating to:",s),cf(s))}})},update(e){P.isConnected!==e&&this.render(!0)}};function cf(e){console.log("🎯 Platform card clicked, navigating to:",e);const t=document.querySelector(`a[data-target="${e}"]`)||document.querySelector(`[data-target="${e}"]`);if(t){console.log("✅ Found menu link, clicking..."),t.click();const s=document.getElementById("sidebar");s&&window.innerWidth<768&&s.classList.add("hidden");return}const n=document.querySelectorAll("main > section"),a=document.getElementById(e);if(a){console.log("✅ Found section, showing directly..."),n.forEach(r=>r.classList.add("hidden")),a.classList.remove("hidden"),document.querySelectorAll(".sidebar-link").forEach(r=>{r.classList.remove("active","bg-zinc-700","text-white"),r.classList.add("text-zinc-400")});const s=document.querySelector(`[data-target="${e}"]`);s&&(s.classList.add("active","bg-zinc-700","text-white"),s.classList.remove("text-zinc-400"));return}console.warn("⚠️ Could not navigate to:",e)}const nd=window.ethers,ka="".toLowerCase(),lf="",ad="bkc_admin_auth_v3";window.__ADMIN_WALLET__=ka;setTimeout(()=>{document.dispatchEvent(new CustomEvent("adminConfigReady")),console.log("✅ Admin config ready, wallet:",ka?"configured":"not set")},100);function vi(){return sessionStorage.getItem(ad)==="true"}function df(){sessionStorage.setItem(ad,"true")}function uf(){return!d.isConnected||!d.userAddress||!ka?!1:d.userAddress.toLowerCase()===ka}const wi={pending:{text:"Pending Review",color:"text-amber-400",bgColor:"bg-amber-900/50",icon:"fa-clock"},auditing:{text:"Auditing",color:"text-blue-400",bgColor:"bg-blue-900/50",icon:"fa-magnifying-glass"},approved:{text:"Approved",color:"text-green-400",bgColor:"bg-green-900/50",icon:"fa-check-circle"},rejected:{text:"Rejected",color:"text-red-400",bgColor:"bg-red-900/50",icon:"fa-times-circle"},flagged_suspicious:{text:"Flagged",color:"text-red-300",bgColor:"bg-red-800/60",icon:"fa-flag"}},Oa={faucet:{icon:"🚰",label:"Claim Faucet",points:1e3,maxCount:1,cooldownHours:0,enabled:!0},delegation:{icon:"📊",label:"Delegate BKC",points:2e3,maxCount:10,cooldownHours:24,enabled:!0},fortune:{icon:"🎰",label:"Play Fortune",points:1500,maxCount:10,cooldownHours:1,enabled:!0},buyNFT:{icon:"🛒",label:"Buy NFT",points:2500,maxCount:10,cooldownHours:0,enabled:!0},sellNFT:{icon:"💰",label:"Sell NFT",points:1500,maxCount:10,cooldownHours:0,enabled:!0},listRental:{icon:"🏷️",label:"List for Rent",points:1e3,maxCount:10,cooldownHours:0,enabled:!0},rentNFT:{icon:"⏰",label:"Rent NFT",points:2e3,maxCount:10,cooldownHours:0,enabled:!0},notarize:{icon:"📜",label:"Notarize Doc",points:2e3,maxCount:10,cooldownHours:0,enabled:!0},claimReward:{icon:"💸",label:"Claim Rewards",points:1e3,maxCount:10,cooldownHours:24,enabled:!0},unstake:{icon:"↩️",label:"Unstake",points:500,maxCount:10,cooldownHours:0,enabled:!0}};let A={allSubmissions:[],dailyTasks:[],ugcBasePoints:null,platformUsageConfig:null,editingTask:null,activeTab:"review-submissions",allUsers:[],selectedUserSubmissions:[],isSubmissionsModalOpen:!1,selectedWallet:null,usersFilter:"all",usersSearch:"",usersPage:1,usersPerPage:100,submissionsPage:1,submissionsPerPage:100,tasksPage:1,tasksPerPage:100};const Tn=async()=>{var t;const e=document.getElementById("admin-content-wrapper");if(e){const n=document.createElement("div");e.innerHTML=n.innerHTML}try{d.userAddress&&(await Ji(d.userAddress),console.log("✅ Firebase Auth: Admin authenticated"));const[n,a,s,r]=await Promise.all([Hu(),Du(),Ws(),ju()]);A.allSubmissions=n,A.dailyTasks=a,A.allUsers=r,A.ugcBasePoints=((t=s.config)==null?void 0:t.ugcBasePoints)||{YouTube:5e3,"YouTube Shorts":2500,Instagram:3e3,"X/Twitter":1500,Facebook:2e3,Telegram:1e3,TikTok:3500,Reddit:1800,LinkedIn:2200,Other:1e3},A.platformUsageConfig=s.platformUsageConfig||Oa,A.editingTask&&(A.editingTask=a.find(i=>i.id===A.editingTask.id)||null),$f()}catch(n){if(console.error("Error loading admin data:",n),e){const a=document.createElement("div");dp(a,`Failed to load admin data: ${n.message}`),e.innerHTML=a.innerHTML}else h("Failed to load admin data.","error")}},wr=async()=>{const e=document.getElementById("presale-balance-amount");if(e){e.innerHTML='<span class="loader !w-5 !h-5 inline-block"></span>';try{if(!d.signer||!d.signer.provider)throw new Error("Admin provider not found.");if(!w.publicSale)throw new Error("PublicSale address not configured.");const t=await d.signer.provider.getBalance(w.publicSale),n=nd.formatEther(t);e.textContent=`${parseFloat(n).toFixed(6)} ETH/BNB`}catch(t){console.error("Error loading presale balance:",t),e.textContent="Error"}}},pf=async e=>{if(!d.signer){h("Por favor, conecte a carteira do Owner primeiro.","error");return}if(!window.confirm("Are you sure you want to withdraw ALL funds from the Presale contract to the Treasury wallet?"))return;const t=["function withdrawFunds() external"],n=w.publicSale,a=new nd.Contract(n,t,d.signer),s=e.innerHTML;e.disabled=!0,e.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i> Withdrawing...';try{console.log(`Calling withdrawFunds() on ${n}...`);const r=await a.withdrawFunds();h("Transaction sent. Awaiting confirmation...","info");const i=await r.wait();console.log("Funds withdrawn successfully!",i.hash),h("Funds withdrawn successfully!","success",i.hash),wr()}catch(r){console.error("Error withdrawing funds:",r);const i=r.reason||r.message||"Transaction failed.";h(`Error: ${i}`,"error")}finally{e.disabled=!1,e.innerHTML=s}},mf=async e=>{const t=e.target.closest("button[data-action]");if(!t||t.disabled)return;const n=t.dataset.action,a=t.dataset.submissionId,s=t.dataset.userId;if(!n||!a||!s){console.warn("Missing data attributes for admin action:",t.dataset);return}const r=t.closest("tr"),i=t.closest("td").querySelectorAll("button");r?(r.style.opacity="0.5",r.style.pointerEvents="none"):i.forEach(o=>o.disabled=!0);try{(n==="approved"||n==="rejected")&&(await eo(s,a,n),h(`Submission ${n==="approved"?"APPROVED":"REJECTED"}!`,"success"),A.allSubmissions=A.allSubmissions.filter(o=>o.submissionId!==a),Ea())}catch(o){h(`Failed to ${n} submission: ${o.message}`,"error"),console.error(o),r&&(r.style.opacity="1",r.style.pointerEvents="auto")}},ff=async e=>{const t=e.target.closest(".ban-user-btn");if(!t||t.disabled)return;const n=t.dataset.userId,a=t.dataset.action==="ban";if(!n)return;const s=a?`Are you sure you want to PERMANENTLY BAN this user?
(This is reversible)`:`Are you sure you want to UNBAN this user?
(This will reset their rejection count to 0)`;if(!window.confirm(s))return;const r=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await to(n,a),h(`User ${a?"BANNED":"UNBANNED"}.`,"success");const i=A.allUsers.findIndex(o=>o.id===n);i>-1&&(A.allUsers[i].isBanned=a,A.allUsers[i].hasPendingAppeal=!1,a===!1&&(A.allUsers[i].rejectedCount=0)),ht()}catch(i){h(`Failed: ${i.message}`,"error"),t.disabled=!1,t.innerHTML=r}},bf=async e=>{const t=e.target.closest(".resolve-appeal-btn");if(!t||t.disabled)return;const n=t.dataset.userId,s=t.dataset.action==="approve";if(!n)return;const r=s?"Are you sure you want to APPROVE this appeal and UNBAN the user?":"Are you sure you want to DENY this appeal? The user will remain banned.";if(!window.confirm(r))return;const i=t.closest("td").querySelectorAll("button"),o=new Map;i.forEach(c=>{o.set(c,c.innerHTML),c.disabled=!0,c.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>'});try{s&&await to(n,!1),h(`Appeal ${s?"APPROVED":"DENIED"}.`,"success");const c=A.allUsers.findIndex(l=>l.id===n);c>-1&&(A.allUsers[c].hasPendingAppeal=!1,s&&(A.allUsers[c].isBanned=!1,A.allUsers[c].rejectedCount=0)),ht()}catch(c){h(`Failed: ${c.message}`,"error"),i.forEach(l=>{l.disabled=!1,l.innerHTML=o.get(l)})}},gf=async e=>{const t=e.target.closest(".re-approve-btn");if(!t||t.disabled)return;const n=t.dataset.submissionId,a=t.dataset.userId;if(!n||!a)return;const s=t.closest("tr");s&&(s.style.opacity="0.5"),t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await eo(a,n,"approved"),h("Submission re-approved!","success"),A.selectedUserSubmissions=A.selectedUserSubmissions.filter(i=>i.submissionId!==n),s&&s.remove();const r=A.allUsers.findIndex(i=>i.id===a);if(r>-1){const i=A.allUsers[r];i.rejectedCount=Math.max(0,(i.rejectedCount||0)-1),ht()}if(A.selectedUserSubmissions.length===0){const i=document.querySelector("#admin-user-modal .p-6");i&&(i.innerHTML='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>')}}catch(r){h(`Failed to re-approve: ${r.message}`,"error"),s&&(s.style.opacity="1"),t.disabled=!1,t.innerHTML='<i class="fa-solid fa-check"></i> Re-Approve'}},xf=async e=>{const t=e.target.closest(".view-rejected-btn");if(!t||t.disabled)return;const n=t.dataset.userId,a=t.dataset.wallet;if(n){A.selectedWallet=a,A.isSubmissionsModalOpen=!0,ds(!0,[]);try{const s=await Wu(n,"rejected");A.selectedUserSubmissions=s,ds(!1,s)}catch(s){h(`Error fetching user submissions: ${s.message}`,"error"),ds(!1,[],!0)}}},hf=()=>{A.isSubmissionsModalOpen=!1,A.selectedUserSubmissions=[],A.selectedWallet=null;const e=document.getElementById("admin-user-modal");e&&e.remove(),document.body.style.overflow="auto"},vf=e=>{const t=e.target.closest(".user-profile-link");if(!t)return;e.preventDefault();const n=t.dataset.userId;if(!n)return;const a=A.allUsers.find(s=>s.id===n);if(!a){h("Error: Could not find user data.","error");return}Tf(a)},wf=()=>{const e=document.getElementById("admin-user-profile-modal");e&&e.remove(),document.body.style.overflow="auto"},yf=async e=>{e.preventDefault();const t=e.target;let n,a;try{if(n=new Date(t.startDate.value+"T00:00:00Z"),a=new Date(t.endDate.value+"T23:59:59Z"),isNaN(n.getTime())||isNaN(a.getTime()))throw new Error("Invalid date format.");if(n>=a)throw new Error("Start Date must be before End Date.")}catch(c){h(c.message,"error");return}const s={title:t.title.value.trim(),url:t.url.value.trim(),description:t.description.value.trim(),points:parseInt(t.points.value,10),cooldownHours:parseInt(t.cooldown.value,10),startDate:n,endDate:a};if(!s.title||!s.description){h("Please fill in Title and Description.","error");return}if(s.points<=0||s.cooldownHours<=0){h("Points and Cooldown must be positive numbers.","error");return}if(s.url&&!s.url.startsWith("http")){h("URL must start with http:// or https://","error");return}A.editingTask&&A.editingTask.id&&(s.id=A.editingTask.id);const r=t.querySelector('button[type="submit"]'),i=r.innerHTML;r.disabled=!0;const o=document.createElement("span");o.classList.add("inline-block"),r.innerHTML="",r.appendChild(o);try{await Ou(s),h(`Task ${s.id?"updated":"created"} successfully!`,"success"),t.reset(),A.editingTask=null,Tn()}catch(c){h(`Failed to save task: ${c.message}`,"error"),console.error(c),r.disabled=!1,r.innerHTML=i}},kf=async e=>{e.preventDefault();const t=e.target,n={YouTube:parseInt(t.youtubePoints.value,10),"YouTube Shorts":parseInt(t.youtubeShortsPoints.value,10),Instagram:parseInt(t.instagramPoints.value,10),"X/Twitter":parseInt(t.xTwitterPoints.value,10),Facebook:parseInt(t.facebookPoints.value,10),Telegram:parseInt(t.telegramPoints.value,10),TikTok:parseInt(t.tiktokPoints.value,10),Reddit:parseInt(t.redditPoints.value,10),LinkedIn:parseInt(t.linkedinPoints.value,10),Other:parseInt(t.otherPoints.value,10)};if(Object.values(n).some(i=>isNaN(i)||i<0)){h("All points must be positive numbers (or 0).","error");return}const a=t.querySelector('button[type="submit"]'),s=a.innerHTML;a.disabled=!0;const r=document.createElement("span");r.classList.add("inline-block"),a.innerHTML="",a.appendChild(r);try{await Mu(n),h("UGC Base Points updated successfully!","success"),A.ugcBasePoints=n}catch(i){h(`Failed to update points: ${i.message}`,"error"),console.error(i)}finally{document.body.contains(a)&&(a.disabled=!1,a.innerHTML=s)}},Ef=e=>{const t=A.dailyTasks.find(n=>n.id===e);t&&(A.editingTask=t,Mn())},Cf=async e=>{if(window.confirm("Are you sure you want to delete this task permanently?"))try{await Uu(e),h("Task deleted.","success"),A.editingTask=null,Tn()}catch(t){h(`Failed to delete task: ${t.message}`,"error"),console.error(t)}};function ds(e,t,n=!1){var i,o;const a=document.getElementById("admin-user-modal");a&&a.remove(),document.body.style.overflow="hidden";let s="";e?s='<div class="p-8"></div>':n?s='<p class="text-red-400 text-center p-8">Failed to load submissions.</p>':t.length===0?s='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>':s=`
     ...
     `;document.body.insertAdjacentHTML("beforeend",r),e&&document.getElementById("admin-user-modal").querySelector(".p-8"),(i=document.getElementById("close-admin-modal-btn"))==null||i.addEventListener("click",hf),(o=document.getElementById("modal-submissions-tbody"))==null||o.addEventListener("click",gf)}function Tf(e){var s;const t=document.getElementById("admin-user-profile-modal");t&&t.remove(),document.body.style.overflow="hidden";const n=e.isBanned?'<span class="text-xs font-bold py-1 px-3 rounded-full bg-red-600 text-white">BANNED</span>':e.hasPendingAppeal?'<span class="text-xs font-bold py-1 px-3 rounded-full bg-yellow-600 text-white">APPEALING</span>':'<span class="text-xs font-bold py-1 px-3 rounded-full bg-green-600 text-white">ACTIVE</span>',a=`
    ...
    `;const I=document.getElementById("admin-users-pagination");I&&f>1&&Ks(I,A.usersPage,f,Bf),(z=document.getElementById("admin-users-tbody"))==null||z.addEventListener("click",T=>{T.target.closest(".user-profile-link")&&vf(T),T.target.closest(".ban-user-btn")&&ff(T),T.target.closest(".view-rejected-btn")&&xf(T),T.target.closest(".resolve-appeal-btn")&&bf(T)}),(N=document.getElementById("user-filters-nav"))==null||N.addEventListener("click",If);const B=document.getElementById("user-search-input");if(B){let T;B.addEventListener("keyup",F=>{clearTimeout(T),T=setTimeout(()=>Af(F),300)})}},yi=()=>{var a;const e=document.getElementById("manage-ugc-points-content");if(!e)return;const t=A.ugcBasePoints;if(!t)return;const n={YouTube:5e3,"YouTube Shorts":2500,Instagram:3e3,"X/Twitter":1500,Facebook:2e3,Telegram:1e3,TikTok:3500,Reddit:1800,LinkedIn:2200,Other:1e3};e.innerHTML=`
    ...
    `;const f=document.getElementById("admin-tasks-pagination");f&&c>1&&Ks(f,A.tasksPage,c,zf),(b=document.getElementById("taskForm"))==null||b.addEventListener("submit",yf),(x=document.getElementById("cancelEditBtn"))==null||x.addEventListener("click",()=>{A.editingTask=null,Mn()}),(y=document.getElementById("existing-tasks-list"))==null||y.addEventListener("click",C=>{const I=C.target.closest("button[data-id]");if(!I)return;const B=I.dataset.id;I.dataset.action==="edit"&&Ef(B),I.dataset.action==="delete"&&Cf(B)})},Ea=()=>{var m;const e=document.getElementById("submissions-content");if(!e)return;if(!A.allSubmissions||A.allSubmissions.length===0){const p=document.createElement("div");e.innerHTML=p.innerHTML;return}const t=A.submissionsPage,n=A.submissionsPerPage,a=[...A.allSubmissions].sort((p,f)=>{var b,x;return(((b=f.submittedAt)==null?void 0:b.getTime())||0)-(((x=p.submittedAt)==null?void 0:x.getTime())||0)}),s=a.length,r=Math.ceil(s/n),i=(t-1)*n,o=t*n,l=a.slice(i,o).map(p=>{var f,b;return`
        <tr class="border-b border-border-color hover:bg-zinc-800/50">
            ...
            <td class="p-3 text-xs font-semibold ${((f=wi[p.status])==null?void 0:f.color)||"text-gray-500"}">${((b=wi[p.status])==null?void 0:b.text)||p.status}</td>
            <td class="p-3 text-right">
                <div class="flex items-center justify-end gap-2">
    ...
    `;const u=document.getElementById("admin-submissions-pagination");u&&r>1&&Ks(u,A.submissionsPage,r,Pf),(m=document.getElementById("admin-submissions-tbody"))==null||m.addEventListener("click",mf)},Ca=()=>{var r,i;const e=document.getElementById("platform-usage-content");if(!e)return;const t=A.platformUsageConfig||Oa;let n=0;Object.values(t).forEach(o=>{o.enabled!==!1&&(n+=(o.points||0)*(o.maxCount||1))});const a=Object.entries(t).map(([o,c])=>`
    ...
    `;const s=document.getElementById("platform-usage-tbody");s==null||s.addEventListener("input",ki),s==null||s.addEventListener("change",ki),(r=document.getElementById("save-platform-config-btn"))==null||r.addEventListener("click",Nf),(i=document.getElementById("reset-platform-config-btn"))==null||i.addEventListener("click",Lf)},ki=e=>{const t=e.target;if(!t.classList.contains("platform-input")&&!t.classList.contains("platform-toggle"))return;const n=t.closest("tr"),a=n==null?void 0:n.dataset.actionKey,s=t.dataset.field;if(!a||!s)return;A.platformUsageConfig[a]||(A.platformUsageConfig[a]={...Oa[a]}),s==="enabled"?A.platformUsageConfig[a].enabled=t.checked:A.platformUsageConfig[a][s]=parseInt(t.value)||0;const r=A.platformUsageConfig[a],i=n.querySelector("td:last-child");i&&(i.textContent=((r.points||0)*(r.maxCount||1)).toLocaleString())},Nf=async e=>{const t=e.target.closest("button");if(!t)return;const n=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Saving...';try{await no(A.platformUsageConfig),h("✅ Platform Usage config saved!","success"),Ca()}catch(a){console.error("Error saving platform config:",a),h("Failed to save config: "+a.message,"error")}finally{t.disabled=!1,t.innerHTML=n}},Lf=async()=>{if(confirm("Are you sure you want to reset to default values? This will save immediately."))try{A.platformUsageConfig={...Oa},await no(A.platformUsageConfig),h("✅ Config reset to defaults!","success"),Ca()}catch(e){console.error("Error resetting platform config:",e),h("Failed to reset config: "+e.message,"error")}},$f=()=>{var n;const e=document.getElementById("admin-content-wrapper");if(!e)return;e.innerHTML=`
    ...
    `,(n=document.getElementById("withdraw-presale-funds-btn"))==null||n.addEventListener("click",a=>pf(a.target)),wr(),A.activeTab==="manage-ugc-points"?yi():A.activeTab==="manage-tasks"?Mn():A.activeTab==="review-submissions"?Ea():A.activeTab==="manage-users"?ht():A.activeTab==="platform-usage"&&Ca();const t=document.getElementById("admin-tabs");t&&!t._listenerAttached&&(t.addEventListener("click",a=>{const s=a.target.closest(".tab-btn");if(!s||s.classList.contains("active"))return;const r=s.dataset.target;A.activeTab=r,r!=="manage-users"&&(A.usersPage=1,A.usersFilter="all",A.usersSearch=""),r!=="review-submissions"&&(A.submissionsPage=1),r!=="manage-tasks"&&(A.tasksPage=1),document.querySelectorAll("#admin-tabs .tab-btn").forEach(o=>o.classList.remove("active")),s.classList.add("active"),e.querySelectorAll(".tab-content").forEach(o=>o.classList.remove("active"));const i=document.getElementById(r.replace(/-/g,"_")+"_tab");i?(i.classList.add("active"),r==="manage-ugc-points"&&yi(),r==="manage-tasks"&&Mn(),r==="review-submissions"&&Ea(),r==="manage-users"&&ht(),r==="platform-usage"&&Ca()):console.warn(`Tab content container not found for target: ${r}`)}),t._listenerAttached=!0)},Sf={render(){const e=document.getElementById("admin");if(e){if(!uf()){e.innerHTML='<div class="text-center text-red-400 p-8 bg-sidebar border border-red-500/50 rounded-lg">Access Denied. This page is restricted to administrators.</div>';return}if(vi()){e.innerHTML='<div id="admin-content-wrapper"></div>',Tn();return}e.innerHTML=`
        ...
        `,document.getElementById("admin-login-btn").addEventListener("click",()=>{const t=document.getElementById("admin-key-input"),n=document.getElementById("admin-login-error");t.value===lf?(df(),h("✅ Admin access granted!","success"),e.innerHTML='<div id="admin-content-wrapper"></div>',Tn()):(n.classList.remove("hidden"),t.value="",t.focus(),setTimeout(()=>n.classList.add("hidden"),3e3))}),setTimeout(()=>{var t;(t=document.getElementById("admin-key-input"))==null||t.focus()},100)}},refreshData(){const e=document.getElementById("admin");e&&!e.classList.contains("hidden")&&vi()&&(console.log("Refreshing Admin Page data..."),Tn(),wr())}},us=2e8,Ei={airdrop:{amount:7e7},liquidity:{amount:13e7}},Rf=()=>{if(document.getElementById("tokenomics-styles-v5"))return;const e=document.createElement("style");e.id="tokenomics-styles-v5",e.innerHTML=`
    ...
    `,document.head.appendChild(e)},In=e=>e>=1e6?(e/1e6).toFixed(1)+"M":e>=1e3?(e/1e3).toFixed(0)+"K":e.toLocaleString();function _f(){return`
    ...
    `}function Ff(){const e=d.totalSupply?_(d.totalSupply):4e7,t=(e/us*100).toFixed(1);return`
        <div class="tk-section tk-fade-up" style="animation-delay: 0.1s">
            ...
            <p class="text-center text-zinc-600 text-[10px]">
                ...
                Remaining ${In(us-e)} BKC to be mined through ecosystem activity
            </p>
        </div>
    `}function Mf(){return`
                ...
                <div class="space-y-3">
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-500 text-[10px]">${In(Ei.airdrop.amount)} BKC</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-500 text-[10px]">${In(Ei.liquidity.amount)} BKC</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    `}function Gf(){const e=document.getElementById("tokenomics");e&&(Rf(),e.innerHTML=`
    ...
    `,e.scrollIntoView({behavior:"smooth",block:"start"}))}const Kf={render:Gf,init:()=>{},update:()=>{}},yr=window.ethers,Yf=5*1024*1024,Vf="https://sepolia.arbiscan.io/tx/",Ci="https://gateway.pinata.cloud/ipfs/",Xe={image:{icon:"fa-regular fa-image",color:"text-emerald-400",bg:"bg-emerald-500/15",label:"Image"},pdf:{icon:"fa-regular fa-file-pdf",color:"text-red-400",bg:"bg-red-500/15",label:"PDF"},audio:{icon:"fa-solid fa-music",color:"text-purple-400",bg:"bg-purple-500/15",label:"Audio"},video:{icon:"fa-regular fa-file-video",color:"text-blue-400",bg:"bg-blue-500/15",label:"Video"},document:{icon:"fa-regular fa-file-word",color:"text-blue-400",bg:"bg-blue-500/15",label:"Document"},spreadsheet:{icon:"fa-regular fa-file-excel",color:"text-green-400",bg:"bg-green-500/15",label:"Spreadsheet"},code:{icon:"fa-solid fa-code",color:"text-cyan-400",bg:"bg-cyan-500/15",label:"Code"},archive:{icon:"fa-regular fa-file-zipper",color:"text-yellow-400",bg:"bg-yellow-500/15",label:"Archive"},default:{icon:"fa-regular fa-file",color:"text-amber-400",bg:"bg-amber-500/15",label:"File"}},U={step:1,file:null,description:"",hash:null,isProcessing:!1,certificates:[],lastFetch:0};function qf(e){if(!e)return"";let t;if(typeof e=="number")t=new Date(e>1e12?e:e*1e3);else if(typeof e=="string")t=new Date(e);else if(e!=null&&e.toDate)t=e.toDate();else if(e!=null&&e.seconds)t=new Date(e.seconds*1e3);else return"";if(isNaN(t.getTime()))return"";const n=new Date,a=n-t,s=Math.floor(a/(1e3*60*60)),r=Math.floor(a/(1e3*60*60*24));if(s<1){const i=Math.floor(a/6e4);return i<1?"Just now":`${i}m ago`}return s<24?`${s}h ago`:r<7?`${r}d ago`:t.toLocaleDateString("en-US",{month:"short",day:"numeric",year:t.getFullYear()!==n.getFullYear()?"numeric":void 0})}function kr(e="",t=""){const n=e.toLowerCase(),a=t.toLowerCase();return n.includes("image")||/\.(jpg|jpeg|png|gif|webp|svg|bmp|ico)$/.test(a)?Xe.image:n.includes("pdf")||a.endsWith(".pdf")?Xe.pdf:n.includes("audio")||/\.(mp3|wav|ogg|flac|aac|m4a)$/.test(a)?Xe.audio:n.includes("video")||/\.(mp4|avi|mov|mkv|webm|wmv)$/.test(a)?Xe.video:n.includes("word")||n.includes("document")||/\.(doc|docx|odt|rtf)$/.test(a)?Xe.document:n.includes("sheet")||n.includes("excel")||/\.(xls|xlsx|csv|ods)$/.test(a)?Xe.spreadsheet:/\.(js|ts|py|java|cpp|c|h|html|css|json|xml|sol|rs|go|php|rb)$/.test(a)?Xe.code:n.includes("zip")||n.includes("archive")||/\.(zip|rar|7z|tar|gz)$/.test(a)?Xe.archive:Xe.default}function Xf(){if(document.getElementById("notary-styles-v6"))return;const e=document.createElement("style");e.id="notary-styles-v6",e.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(e)}function Jf(){const e=document.getElementById("notary");e&&(Xf(),e.innerHTML=`
        <div class="max-w-5xl mx-auto px-4 py-6">
    ...
    `,Ta(),Ge(),Er())}function Ta(){const e=document.getElementById("status-badge"),t=document.getElementById("fee-amount"),n=document.getElementById("user-balance"),a=d.notaryFee||0n,s=d.currentUserBalance||0n;t&&(t.textContent=`${_(a)} BKC`),n&&(n.textContent=`${_(s)} BKC`,n.className=`font-mono font-bold ${s>=a?"text-emerald-400":"text-red-400"}`),e&&(d.isConnected?s>=a?(e.innerHTML=`
        ...
        `;return}const t=d.notaryFee||yr.parseEther("1"),n=d.currentUserBalance||0n;if(n<t){e.innerHTML=`
            <div class="flex flex-col items-center justify-center h-full py-12">
        ...
        `;return}switch(U.step){case 1:Qf(e);break;case 2:tb(e);break;case 3:nb(e);break}}function Qf(e){e.innerHTML=`
    ...
    `,eb()}function eb(){const e=document.getElementById("dropzone"),t=document.getElementById("file-input");!e||!t||(e.onclick=()=>t.click(),["dragenter","dragover","dragleave","drop"].forEach(n=>{e.addEventListener(n,a=>{a.preventDefault(),a.stopPropagation()})}),e.addEventListener("dragenter",()=>e.classList.add("drag-over")),e.addEventListener("dragover",()=>e.classList.add("drag-over")),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",n=>{var a,s;e.classList.remove("drag-over"),Ti((s=(a=n.dataTransfer)==null?void 0:a.files)==null?void 0:s[0])}),t.addEventListener("change",n=>{var a;return Ti((a=n.target.files)==null?void 0:a[0])}))}function Ti(e){if(e){if(e.size>Yf){h("File too large (max 5MB)","error");return}U.file=e,U.step=2,Ge()}}function tb(e){var s,r,i;const t=U.file,n=t?(t.size/1024).toFixed(1):"0",a=kr((t==null?void 0:t.type)||"",(t==null?void 0:t.name)||"");e.innerHTML=`
    ...
    `,(s=document.getElementById("btn-remove"))==null||s.addEventListener("click",()=>{U.file=null,U.description="",U.step=1,Ge()}),(r=document.getElementById("btn-back"))==null||r.addEventListener("click",()=>{U.step=1,Ge()}),(i=document.getElementById("btn-next"))==null||i.addEventListener("click",()=>{var o;U.description=((o=document.getElementById("desc-input"))==null?void 0:o.value)||"",U.step=3,Ge()})}function nb(e){var r,i;const t=U.file,n=U.description||"No description",a=d.notaryFee||yr.parseEther("1"),s=kr((t==null?void 0:t.type)||"",(t==null?void 0:t.name)||"");e.innerHTML=`
    ...
    `;try{const t=Ie.getNotarizedDocuments||"https://getnotarizeddocuments-4wvdcuoouq-uc.a.run.app",n=await fetch(`${t}/${d.userAddress}`);if(!n.ok)throw new Error(`API returned ${n.status}`);const a=await n.json();if(!Array.isArray(a)||a.length===0){e.innerHTML=`
            ...
            `;return}const s=a.map(r=>({id:r.tokenId||"?",ipfs:r.ipfsCid||"",description:r.description||"",hash:r.contentHash||"",timestamp:r.createdAt||r.timestamp||"",txHash:r.txHash||""})).sort((r,i)=>parseInt(i.id)-parseInt(r.id));e.innerHTML=s.map(r=>{var m,p;let i="";const o=r.ipfs||"";o.startsWith("ipfs://")?i=`${Ci}${o.replace("ipfs://","")}`:o.startsWith("https://")?i=o:o.length>0&&(i=`${Ci}${o}`);let c=((m=r.description)==null?void 0:m.split("---")[0].trim().split(`
`)[0].trim())||"Notarized Document";const l=kr("",c),u=qf(r.timestamp);return`
                <div class="cert-card">
        ...
        `}}}async function sb(){try{if(await js(),d.isConnected&&d.userAddress)try{if(d.bkcTokenContract||d.bkcTokenContractPublic){const e=d.bkcTokenContract||d.bkcTokenContractPublic,t=await re(e,"balanceOf",[d.userAddress],0n);t>0n&&(d.currentUserBalance=t)}}catch{}Ta()}catch{(!d.notaryFee||d.notaryFee===0n)&&(d.notaryFee=yr.parseEther("1"))}}async function rb(e,t){var n,a;try{const s=["https://dweb.link/ipfs/","https://w3s.link/ipfs/","https://gateway.pinata.cloud/ipfs/","https://ipfs.io/ipfs/"],r=u=>u?u.startsWith("ipfs://")?u.replace("ipfs://","").split("?")[0]:u.includes("/ipfs/")?u.split("/ipfs/")[1].split("?")[0]:u.match(/^Qm[a-zA-Z0-9]{44}/)||u.match(/^bafy[a-zA-Z0-9]+/)?u:"":"",i=u=>{if(!u)return"";if(u.startsWith("https://")&&!u.includes("/ipfs/"))return u;const m=r(u);return m?`${s[0]}${m}`:u};let o=i(t||"");if(d.decentralizedNotaryContract)try{const u=await d.decentralizedNotaryContract.tokenURI(e);if(u!=null&&u.startsWith("data:application/json;base64,")){const m=JSON.parse(atob(u.replace("data:application/json;base64,","")));m.image&&(o=i(m.image))}}catch{}const c=((n=d.decentralizedNotaryContract)==null?void 0:n.target)||((a=d.decentralizedNotaryContract)!=null&&a.getAddress?await d.decentralizedNotaryContract.getAddress():null);if(!c){h("Contract address not found","error");return}h(`Adding NFT #${e} to wallet...`,"info"),await window.ethereum.request({method:"wallet_watchAsset",params:{type:"ERC721",options:{address:c,tokenId:String(e),image:o}}})&&h(`📜 NFT #${e} added to wallet!`,"success")}catch(s){if(s.code===4001)return;h("Could not add NFT","error")}}const sd={async render(e){e&&(Jf(),await sb(),d.isConnected&&await Mt(),Ta(),Ge())},reset(){U.file=null,U.description="",U.step=1,Ge()},update(){Ta(),U.isProcessing||Ge()},refreshHistory(){Er()},addToWallet:rb};window.NotaryPage=sd;const Ua=window.ethers,Ii=24*60*60,$s={Diamond:{emoji:"💎",color:"#22d3ee",bg:"rgba(34,211,238,0.15)",border:"rgba(34,211,238,0.3)",keepRate:100,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeicgip72jcqgsirlrhn3tq5cc226vmko6etnndzl6nlhqrktfikafq"},Gold:{emoji:"🥇",color:"#fbbf24",bg:"rgba(251,191,36,0.15)",border:"rgba(251,191,36,0.3)",keepRate:90,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeifponccrbicg2pcjrn2hrfoqgc77xhm2r4ld7hdpw6cxxkbsckf44"},Silver:{emoji:"🥈",color:"#9ca3af",bg:"rgba(156,163,175,0.15)",border:"rgba(156,163,175,0.3)",keepRate:75,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeihvi2inujm5zpi7tl667g4srq273536pjkglwyrtbwmgnskmu7jg4"},Bronze:{emoji:"🥉",color:"#fb923c",bg:"rgba(251,146,60,0.15)",border:"rgba(251,146,60,0.3)",keepRate:60,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeiclqidb67rt3tchhjpsib62s624li7j2bpxnr6b5w5mfp4tomhu7m"}},R={activeTab:"marketplace",filterTier:"ALL",sortBy:"featured",selectedListing:null,isLoading:!1,isTransactionPending:!1,countdownIntervals:[],promotions:new Map},Me=e=>e==null?"":String(e),ib=(e,t)=>Me(e)===Me(t),Dn=(e,t)=>e&&t&&e.toLowerCase()===t.toLowerCase();function Vn(e){return he.find(t=>t.boostBips===Number(e))||{name:"Unknown",boostBips:0}}function Ha(e){return $s[e]||{emoji:"💎",color:"#71717a",bg:"rgba(113,113,122,0.15)",border:"rgba(113,113,122,0.3)",keepRate:50}}function rd(e){const t=e-Math.floor(Date.now()/1e3);if(t<=0)return{text:"Expired",expired:!0,seconds:0};const n=Math.floor(t/3600),a=Math.floor(t%3600/60),s=t%60;return n>0?{text:`${n}h ${a}m`,expired:!1,seconds:t}:a>0?{text:`${a}m ${s}s`,expired:!1,seconds:t}:{text:`${s}s`,expired:!1,seconds:t}}function ob(e){const t=Math.floor(Date.now()/1e3),n=e-t;if(n<=0)return null;const a=Math.floor(n/3600),s=Math.floor(n%3600/60);return a>0?`${a}h ${s}m`:`${s}m`}function id(e){if(e.lastRentalEndTime)return Number(e.lastRentalEndTime)+Ii;if(e.rentalEndTime&&!e.isRented){const t=Number(e.rentalEndTime),n=Math.floor(Date.now()/1e3);if(t<n)return t+Ii}return null}function Ai(e){const t=Math.floor(Date.now()/1e3),n=id(e);return n&&n>t}function Bi(e){const t=Math.floor(Date.now()/1e3);if(!e.lastRentalEndTime&&!e.rentalEndTime)return e.createdAt?t-Number(e.createdAt):Number.MAX_SAFE_INTEGER;const n=e.lastRentalEndTime?Number(e.lastRentalEndTime):e.rentalEndTime?Number(e.rentalEndTime):0;return n>t?0:t-n}function cb(){if(document.getElementById("rental-styles-v6"))return;const e=document.createElement("style");e.id="rental-styles-v6",e.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(e)}function Ss(){const e=document.getElementById("rental");if(!e)return;cb();const t=d.rentalListings||[],n=t.filter(r=>d.isConnected&&Dn(r.owner,d.userAddress)),a=Math.floor(Date.now()/1e3),s=(d.myRentals||[]).filter(r=>Dn(r.tenant,d.userAddress)&&Number(r.endTime)>a);e.innerHTML=`
        ...
        ${bb()}
        ${gb()}
    `,xb(),An()}function lb(){return d.isConnected?`
    ...
    `:`
        ...
        `}function An(){const e=document.getElementById("tab-content");if(e){switch(R.activeTab){case"marketplace":e.innerHTML=db();break;case"my-listings":e.innerHTML=ub();break;case"my-rentals":e.innerHTML=pb();break}document.getElementById("header-stats").innerHTML=lb(),R.activeTab==="my-rentals"&&Eb()}}function db(){const e=d.rentalListings||[],t=Math.floor(Date.now()/1e3);let n=e.filter(a=>!(a.isRented||a.rentalEndTime&&Number(a.rentalEndTime)>t||R.filterTier!=="ALL"&&Vn(a.boostBips).name!==R.filterTier));return n.sort((a,s)=>{const r=BigInt(a.promotionFee||"0")||R.promotions.get(Me(a.tokenId))||0n,i=BigInt(s.promotionFee||"0")||R.promotions.get(Me(s.tokenId))||0n,o=Ai(a),c=Ai(s);if(!o&&c)return-1;if(o&&!c||i>r)return 1;if(i<r)return-1;if(R.sortBy==="featured"){const m=Bi(a),p=Bi(s);if(p!==m)return p-m}const l=BigInt(a.pricePerHour||0),u=BigInt(s.pricePerHour||0);return R.sortBy==="price-low"?l<u?-1:1:R.sortBy==="price-high"?l>u?-1:1:(s.boostBips||0)-(a.boostBips||0)}),`
        <div>
            <!-- Filters & Sort -->
            ...
            <!-- NFT Grid -->
            ${n.length===0?Cr("No NFTs Available","Be the first to list your NFT!"):`
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 nft-grid">
                    ${n.map((a,s)=>od(a,s)).join("")}
                </div>
            `}
        </div>
    `}function od(e,t){const n=Vn(e.boostBips),a=Ha(n.name),s=_(BigInt(e.pricePerHour||0)).toFixed(2),r=Me(e.tokenId),i=d.isConnected&&Dn(e.owner,d.userAddress),o=id(e),c=Math.floor(Date.now()/1e3),l=o&&o>c,u=l?ob(o):null,m=BigInt(e.promotionFee||"0")||R.promotions.get(r)||0n,p=m>0n,f=p?parseFloat(Ua.formatEther(m)).toFixed(3):"0",b=gt(e.boostBips||0);return`
    ...
    `}function ub(){if(!d.isConnected)return cd("View your listings");const e=d.rentalListings||[],t=e.filter(r=>Dn(r.owner,d.userAddress)),n=new Set(e.map(r=>Me(r.tokenId))),a=(d.myBoosters||[]).filter(r=>!n.has(Me(r.tokenId)));return`
        <div>
            <!-- Earnings Card -->
                    ...
                    <div class="flex items-center gap-5">
                        ...
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white">
                                ${t.reduce((r,i)=>r+Number(Ua.formatEther(BigInt(i.totalEarnings||0))),0).toFixed(4)} <span class="text-lg text-zinc-500">BKC</span>
                            </p>
                        </div>
                    </div>
                    <div class="flex gap-3">
            ...
            <!-- My Listed NFTs -->
            ${t.length===0?Cr("No Listings Yet","List your first NFT to start earning!"):`
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 nft-grid">
                    ${t.map((r,i)=>od(r,i)).join("")}
                </div>
            `}
        </div>
    `}function pb(){if(!d.isConnected)return cd("View your active rentals");const e=Math.floor(Date.now()/1e3),t=(d.myRentals||[]).filter(n=>Dn(n.tenant,d.userAddress)&&Number(n.endTime)>e);return`
        <div>
            <!-- Info Card -->
            ...
            <!-- Active Rentals -->
            ${t.length===0?Cr("No Active Rentals","Rent an NFT to reduce your claim burn rate!"):`
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    ${t.map((n,a)=>mb(n,a)).join("")}
                </div>
            `}
        </div>
    `}function mb(e,t){const n=Vn(e.boostBips),a=Ha(n.name),s=rd(Number(e.endTime)),r=gt(e.boostBips||0);let i="active";return s.seconds<3600?i="critical":s.seconds<7200&&(i="warning"),`
    ...
    `}function fb(){const e=d.rentalListings||[],t=new Set(e.map(a=>Me(a.tokenId)));return`
                ...
                <div class="p-5 space-y-5">
                    <div>
                        ...
                        <select id="list-select" class="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-4 py-3 text-white outline-none">
                            ...
                            ${(d.myBoosters||[]).filter(a=>!t.has(Me(a.tokenId))).map(a=>{const s=Vn(a.boostBips),r=Ha(s.name);return`<option value="${a.tokenId}">${r.emoji} ${s.name} Booster #${a.tokenId}</option>`}).join("")}
                        </select>
                    </div>
                    <div>
    ...
    `}function xb(){document.addEventListener("click",e=>{const t=e.target.closest(".rental-tab");if(t){R.activeTab=t.dataset.tab,document.querySelectorAll(".rental-tab").forEach(i=>i.classList.remove("active")),t.classList.add("active"),An();return}const n=e.target.closest(".filter-chip");if(n){R.filterTier=n.dataset.filter,An();return}if(e.target.closest("#btn-open-list")){ld();return}const a=e.target.closest(".rent-btn");if(a&&!a.disabled){hb(a.dataset.id);return}const s=e.target.closest(".withdraw-btn");if(s){md(s);return}const r=e.target.closest(".promote-btn");if(r){vb(r.dataset.id);return}}),document.addEventListener("change",e=>{e.target.id==="sort-select"&&(R.sortBy=e.target.value,An())})}function ld(){document.getElementById("modal-list").classList.add("active")}function dd(){document.getElementById("modal-list").classList.remove("active")}function hb(e){const t=(d.rentalListings||[]).find(i=>ib(i.tokenId,e));if(!t)return;R.selectedListing=t;const n=Vn(t.boostBips),a=Ha(n.name),s=_(BigInt(t.pricePerHour||0)),r=gt(t.boostBips||0);document.getElementById("rent-modal-content").innerHTML=`
    ...
    `,document.getElementById("rent-hours").addEventListener("input",i=>{const o=parseInt(i.target.value)||1,c=Number(s)*o;document.querySelector("#rent-total span:last-child").textContent=`${c.toFixed(2)} BKC`}),document.getElementById("modal-rent").classList.add("active")}function ud(){document.getElementById("modal-rent").classList.remove("active"),R.selectedListing=null}function vb(e){document.getElementById("promote-token-id").value=e,document.getElementById("promote-amount").value="",document.getElementById("modal-promote").classList.add("active")}function pd(){document.getElementById("modal-promote").classList.remove("active")}async function wb(){if(R.isTransactionPending||!R.selectedListing)return;const e=parseInt(document.getElementById("rent-hours").value)||1,t=Me(R.selectedListing.tokenId),n=document.getElementById("confirm-rent");R.isTransactionPending=!0;try{await Yn.rent({tokenId:t,hours:e,button:n,onSuccess:async()=>{R.isTransactionPending=!1,ud(),h("🎉 NFT Rented Successfully!","success"),await an()},onError:a=>{R.isTransactionPending=!1,!a.cancelled&&a.type!=="user_rejected"&&h("Failed: "+(a.message||"Error"),"error")}})}catch(a){R.isTransactionPending=!1,!a.cancelled&&a.type!=="user_rejected"&&h("Failed: "+(a.message||"Error"),"error")}}async function yb(){var a;if(R.isTransactionPending)return;const e=document.getElementById("list-select").value,t=document.getElementById("list-price").value;if(parseFloat((a=document.getElementById("list-promo-amount"))==null?void 0:a.value),!e){h("Select an NFT","error");return}if(!t||parseFloat(t)<=0){h("Enter valid price","error");return}const n=document.getElementById("confirm-list");R.isTransactionPending=!0;try{await Yn.list({tokenId:e,pricePerHour:Ua.parseUnits(t,18),minHours:1,maxHours:168,button:n,onSuccess:async()=>{R.isTransactionPending=!1,dd(),h("🏷️ NFT Listed Successfully!","success"),await an()},onError:s=>{R.isTransactionPending=!1,!s.cancelled&&s.type!=="user_rejected"&&h("Failed: "+(s.message||"Error"),"error")}})}catch(s){R.isTransactionPending=!1,!s.cancelled&&s.type!=="user_rejected"&&h("Failed: "+(s.message||"Error"),"error")}}async function md(e){if(R.isTransactionPending)return;const t=e.dataset.id;if(confirm("Withdraw this NFT from marketplace?")){R.isTransactionPending=!0;try{await Yn.withdraw({tokenId:t,button:e,onSuccess:async()=>{R.isTransactionPending=!1,h("↩️ NFT Withdrawn Successfully!","success"),await an()},onError:n=>{R.isTransactionPending=!1,!n.cancelled&&n.type!=="user_rejected"&&h("Failed: "+(n.message||"Error"),"error")}})}catch(n){R.isTransactionPending=!1,!n.cancelled&&n.type!=="user_rejected"&&h("Failed: "+(n.message||"Error"),"error")}}}async function kb(){if(R.isTransactionPending)return;const e=document.getElementById("promote-token-id").value,t=document.getElementById("promote-amount").value;if(!t||parseFloat(t)<=0){h("Enter valid amount","error");return}const n=document.getElementById("confirm-promote");R.isTransactionPending=!0;try{await Yn.spotlight({tokenId:e,amount:Ua.parseEther(t),button:n,onSuccess:async()=>{R.isTransactionPending=!1,pd(),h("🚀 Listing Promoted!","success"),await an()},onError:a=>{R.isTransactionPending=!1,!a.cancelled&&a.type!=="user_rejected"&&h("Failed: "+(a.message||"Error"),"error")}})}catch(a){R.isTransactionPending=!1,!a.cancelled&&a.type!=="user_rejected"&&h("Failed: "+(a.message||"Error"),"error")}}function Eb(){R.countdownIntervals.forEach(clearInterval),R.countdownIntervals=[],document.querySelectorAll(".rental-timer[data-end]").forEach(e=>{const t=Number(e.dataset.end),n=setInterval(()=>{const a=rd(t);e.innerHTML=`<i class="fa-solid fa-clock mr-1"></i>${a.text}`,a.expired?(clearInterval(n),An()):a.seconds<3600?e.className="rental-timer critical":a.seconds<7200&&(e.className="rental-timer warning")},1e3);R.countdownIntervals.push(n)})}async function an(){R.isLoading=!0;try{await Promise.all([Vi(),d.isConnected?Iu():Promise.resolve(),d.isConnected?At():Promise.resolve()])}catch(e){console.warn("Refresh error:",e)}R.isLoading=!1,Ss()}const fd={async render(e){e&&(Ss(),await an())},update(){Ss()},refresh:an,openListModal:ld,closeListModal:dd,closeRentModal:ud,closePromoteModal:pd,handleRent:wb,handleList:yb,handleWithdraw:md,handlePromote:kb};window.RentalPage=fd;const Cb={render:async e=>{const t=document.getElementById("socials");if(!t||!e&&t.innerHTML.trim()!=="")return;const n=`
            <style>
        ...
        `},cleanup:()=>{}},bd=document.createElement("style");bd.innerHTML=`
...
`;document.head.appendChild(bd);const Tb={render:async e=>{if(!e)return;const t=document.getElementById("creditcard");t&&(t.innerHTML=`
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    ...
                    <div class="glass-mockup rounded-2xl p-6 h-full flex flex-col">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="space-y-2">
                                ${xn("Starbucks Coffee","Today, 8:30 AM","- $5.40","+ 15 BKC","fa-mug-hot")}
                                ${xn("Uber Ride","Yesterday, 6:15 PM","- $24.50","+ 82 BKC","fa-car")}
                                ${xn("Netflix Subscription","Oct 24, 2025","- $15.99","+ 53 BKC","fa-film")}
                                ${xn("Amazon Purchase","Oct 22, 2025","- $142.00","+ 475 BKC","fa-box-open")}
                                ${xn("Shell Station","Oct 20, 2025","- $45.00","+ 150 BKC","fa-gas-pump")}
                            </div>
                        </div>
                    </div>
    ...
    `}function ms(e,t,n,a,s,r,i){const o=Tr[_t];let c=`
        <div class="mb-10">
    ...
    `,l=i;return a.forEach(u=>{c+=Ab(u,l++)}),c+="</div></div>",{html:c,nextIndex:l}}function Bb(e){var t,n,a,s,r,i,o,c;_t=e,localStorage.setItem("backcoin-tutorials-lang",e),(t=document.getElementById("tutorials-btn-en"))==null||t.classList.toggle("bg-amber-500",e==="en"),(n=document.getElementById("tutorials-btn-en"))==null||n.classList.toggle("text-zinc-900",e==="en"),(a=document.getElementById("tutorials-btn-en"))==null||a.classList.toggle("bg-zinc-700",e!=="en"),(s=document.getElementById("tutorials-btn-en"))==null||s.classList.toggle("text-zinc-300",e!=="en"),(r=document.getElementById("tutorials-btn-pt"))==null||r.classList.toggle("bg-amber-500",e==="pt"),(i=document.getElementById("tutorials-btn-pt"))==null||i.classList.toggle("text-zinc-900",e==="pt"),(o=document.getElementById("tutorials-btn-pt"))==null||o.classList.toggle("bg-zinc-700",e!=="pt"),(c=document.getElementById("tutorials-btn-pt"))==null||c.classList.toggle("text-zinc-300",e!=="pt"),gd()}function gd(){const e=document.getElementById("tutorials-content");if(!e)return;const t=Tr[_t];let n=`
        <!-- Hero -->
        <div class="text-center mb-10">
    ...
    `,a=ms("getting-started","rocket","emerald",ps.gettingStarted,"catGettingStarted","catGettingStartedDesc",0);n+=a.html,a=ms("ecosystem","cubes","amber",ps.ecosystem,"catEcosystem","catEcosystemDesc",a.nextIndex),n+=a.html,a=ms("advanced","graduation-cap","cyan",ps.advanced,"catAdvanced","catAdvancedDesc",a.nextIndex),n+=a.html,e.innerHTML=n}const xd={render:function(e=!1){const t=document.getElementById("tutorials");t&&(e||t.innerHTML.trim()==="")&&(t.innerHTML=`
            ...
            `,gd())},update:function(e){},cleanup:function(){},setLang:Bb};window.TutorialsPage=xd;const jt=window.ethers,Pb={ACTIVE:0,COMPLETED:1,CANCELLED:2,WITHDRAWN:3},Ir=e=>typeof e=="number"?e:typeof e=="string"?isNaN(parseInt(e))?Pb[e.toUpperCase()]??0:parseInt(e):0,Ar=e=>Ir(e.status)===0&&Number(e.deadline)>Math.floor(Date.now()/1e3),Br=["function getCampaign(uint256 _campaignId) view returns (address creator, string title, string description, uint96 goalAmount, uint96 raisedAmount, uint32 donationCount, uint64 deadline, uint64 createdAt, uint96 boostAmount, uint64 boostTime, uint8 status, bool goalReached)","function campaignCounter() view returns (uint64)","function getStats() view returns (uint64 totalCampaigns, uint256 totalRaised, uint256 totalDonations, uint256 totalFees)"],qn={getCampaigns:"https://getcharitycampaigns-4wvdcuoouq-uc.a.run.app",saveCampaign:"https://savecharitycampaign-4wvdcuoouq-uc.a.run.app",uploadImage:"/api/upload-image"},hd="https://sepolia.arbiscan.io/address/",Ia={animal:"https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=800&q=80",humanitarian:"https://images.unsplash.com/photo-1469571486292-0ba58a3f068b?w=800&q=80",default:"https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?w=800&q=80"},ze={animal:{name:"Animal Welfare",emoji:"🐾",color:"#10b981",gradient:"from-emerald-500/20 to-green-600/20"},humanitarian:{name:"Humanitarian Aid",emoji:"💗",color:"#ec4899",gradient:"from-pink-500/20 to-rose-600/20"}},Pi={0:{label:"Active",color:"#10b981",icon:"fa-circle-play",bg:"bg-emerald-500/15"},1:{label:"Ended",color:"#3b82f6",icon:"fa-circle-check",bg:"bg-blue-500/15"},2:{label:"Cancelled",color:"#ef4444",icon:"fa-circle-xmark",bg:"bg-red-500/15"},3:{label:"Completed",color:"#8b5cf6",icon:"fa-circle-dollar-to-slot",bg:"bg-purple-500/15"}},vd=5*1024*1024,wd=["image/jpeg","image/png","image/gif","image/webp"],E={campaigns:[],stats:null,currentView:"main",currentCampaign:null,selectedCategory:null,isLoading:!1,pendingImage:null,pendingImageFile:null,editingCampaign:null,createStep:1,createCategory:null,createTitle:"",createDesc:"",createGoal:"",createDuration:"",createImageFile:null,createImageUrl:"",createImagePreview:null};function zb(){if(document.getElementById("charity-styles-v6"))return;const e=document.createElement("style");e.id="charity-styles-v6",e.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(e)}const Te=e=>{try{const t=Number(e)/1e18;return t<1e-4?"0":t<1?t.toFixed(4):t<1e3?t.toFixed(2):t.toLocaleString("en-US",{maximumFractionDigits:2})}catch{return"0"}},yd=e=>e?`${e.slice(0,6)}...${e.slice(-4)}`:"",Xn=(e,t)=>{const n=Number(e||0),a=Number(t||1);return Math.min(100,Math.round(n/a*100))},kd=e=>{const t=Math.floor(Date.now()/1e3),n=Number(e)-t;if(n<=0)return{text:"Ended",color:"#ef4444"};const a=Math.floor(n/86400);return a>0?{text:`${a}d left`,color:"#10b981"}:{text:`${Math.floor(n/3600)}h left`,color:"#f59e0b"}},ja=e=>(e==null?void 0:e.imageUrl)||Ia[e==null?void 0:e.category]||Ia.default,Ed=e=>`${window.location.origin}${window.location.pathname}#charity/${e}`,Cd=()=>{const t=window.location.hash.match(/#charity\/(\d+)/);return t?t[1]:null},Nb=e=>{window.location.hash=`charity/${e}`},Lb=()=>{window.location.hash.startsWith("#charity/")&&(window.location.hash="charity")},Td=e=>{const t=Ir(e.status),n=Number(e.deadline)<=Math.floor(Date.now()/1e3);return(t===0||t===1)&&n&&!e.withdrawn&&BigInt(e.raisedAmount||0)>0n},Id="charity-meta-";function Pr(e,t){try{localStorage.setItem(`${Id}${e}`,JSON.stringify(t))}catch{}}function Ad(e){try{return JSON.parse(localStorage.getItem(`${Id}${e}`)||"null")}catch{return null}}async function vt(){E.isLoading=!0;try{const[e,t]=await Promise.all([fetch(qn.getCampaigns).then(s=>s.json()).catch(()=>({campaigns:[]})),$b()]),n=(e==null?void 0:e.campaigns)||[],a=d==null?void 0:d.publicProvider;if(a){const s=new jt.Contract(w.charityPool,Br,a),r=await s.campaignCounter(),i=Number(r),o=await Promise.all(Array.from({length:i},(c,l)=>l+1).map(async c=>{try{const l=await s.getCampaign(c),u=n.find(p=>String(p.id)===String(c)),m=Ad(c);return{id:String(c),creator:l.creator||l[0],title:(u==null?void 0:u.title)||l.title||l[1]||`Campaign #${c}`,description:(u==null?void 0:u.description)||l.description||l[2]||"",goalAmount:BigInt((l.goalAmount||l[3]).toString()),raisedAmount:BigInt((l.raisedAmount||l[4]).toString()),donationCount:Number(l.donationCount||l[5]),deadline:Number(l.deadline||l[6]),createdAt:Number(l.createdAt||l[7]),status:Number(l.status||l[10]),category:(u==null?void 0:u.category)||(m==null?void 0:m.category)||"humanitarian",imageUrl:(u==null?void 0:u.imageUrl)||(m==null?void 0:m.imageUrl)||null}}catch{return null}}));E.campaigns=o.filter(Boolean)}E.stats=t}catch(e){console.error("Load data:",e)}finally{E.isLoading=!1}}async function $b(){try{const e=d==null?void 0:d.publicProvider;if(!e)return null;const n=await new jt.Contract(w.charityPool,Br,e).getStats();return{raised:n.totalRaised??n[1],fees:n.totalFees??n[3],created:Number(n.totalCampaigns??n[0]),donations:Number(n.totalDonations??n[2])}}catch{return null}}function Sb(e,t="create"){var s;const n=(s=e.target.files)==null?void 0:s[0];if(!n)return;if(!wd.includes(n.type)){h("Please select a valid image (JPG, PNG, GIF, WebP)","error");return}if(n.size>vd){h("Image must be less than 5MB","error");return}E.pendingImageFile=n;const a=new FileReader;a.onload=r=>{const i=t==="edit"?"edit-image-preview":"create-image-preview",o=document.getElementById(t==="edit"?"edit-image-upload":"create-image-upload"),c=document.getElementById(i);c&&(c.innerHTML=`
            ...
            `),o&&o.classList.add("has-image")},a.readAsDataURL(n)}function Rb(e="create"){E.pendingImageFile=null,E.pendingImage=null;const t=e==="edit"?"edit-image-preview":"create-image-preview",n=document.getElementById(e==="edit"?"edit-image-upload":"create-image-upload"),a=document.getElementById(t);a&&(a.innerHTML=""),n&&n.classList.remove("has-image");const s=document.getElementById(e==="edit"?"edit-image-file":"create-image-file");s&&(s.value="")}function _b(e,t="create"){document.querySelectorAll(`#${t}-image-tabs .cp-tab`).forEach(r=>r.classList.toggle("active",r.dataset.tab===e));const a=document.getElementById(`${t}-image-upload`),s=document.getElementById(`${t}-image-url-wrap`);a&&(a.style.display=e==="upload"?"block":"none"),s&&(s.style.display=e==="url"?"block":"none")}async function zr(e){const t=new FormData;t.append("image",e);const n=await fetch(qn.uploadImage,{method:"POST",body:t,signal:AbortSignal.timeout(6e4)});if(!n.ok){const s=await n.json().catch(()=>({}));throw new Error(s.error||`Upload failed (${n.status})`)}return(await n.json()).imageUrl}const Bd=e=>{const t=Pi[Ir(e)]||Pi[0];return`<span class="cp-badge" style="background:${t.color}20;color:${t.color}"><i class="fa-solid ${t.icon}"></i> ${t.label}</span>`},Fb=()=>'<div class="cp-loading"><div class="cp-spinner"></div><span class="text-zinc-500">Loading campaigns...</span></div>',Pd=e=>`<div class="cp-empty"><i class="fa-solid fa-inbox"></i><h3>${e}</h3><p class="text-zinc-600 text-sm">Be the first to create a campaign!</p></div>`,zd=e=>{var s,r,i,o;const t=Xn(e.raisedAmount,e.goalAmount),n=kd(e.deadline),a=e.category||"humanitarian";return`
        <div class="cp-campaign-card" onclick="CharityPage.viewCampaign('${e.id}')">
            <img src="${ja(e)}" alt="${e.title}" onerror="this.src='${Ia.default}'">
            <div class="p-4">
                ...
                <p class="text-zinc-500 text-xs mb-3">by <a href="${hd}${e.creator}" target="_blank" class="text-amber-500 hover:text-amber-400">${yd(e.creator)}</a></p>
    ...
    `},zi=()=>{var a,s,r,i;const e=E.campaigns.filter(o=>Ar(o)),t=e.filter(o=>o.category==="animal"),n=e.filter(o=>o.category==="humanitarian");return`
        <div class="charity-page">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6 cp-stats-grid">
                <div class="cp-stat-card">
                    <p class="text-2xl font-bold text-emerald-400 font-mono">
                        <i class="fa-brands fa-ethereum text-lg mr-1"></i>${E.stats?Te(E.stats.raised):"--"}
                    </p>
                    <p class="text-[10px] text-zinc-500 uppercase mt-1">Total Raised</p>
                </div>
                <div class="cp-stat-card">
                    <p class="text-2xl font-bold text-blue-400 font-mono">${E.stats?Te(E.stats.fees):"--"}</p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8 cp-cats-grid">
                <div class="cp-category-card animal ${E.selectedCategory==="animal"?"selected":""}" onclick="CharityPage.selectCat('animal')">
                    ...
                    <div class="flex justify-center gap-6 text-sm text-zinc-400 mb-3">
                        ...
                        <span><i class="fa-brands fa-ethereum"></i> <strong class="text-white">${Te(t.reduce((o,c)=>o+BigInt(c.raisedAmount||0),0n))}</strong></span>
                    </div>
                ...
                <div class="cp-category-card humanitarian ${E.selectedCategory==="humanitarian"?"selected":""}" onclick="CharityPage.selectCat('humanitarian')">
                    ...
                    <div class="flex justify-center gap-6 text-sm text-zinc-400 mb-3">
                        ...
                        <span><i class="fa-brands fa-ethereum"></i> <strong class="text-white">${Te(n.reduce((o,c)=>o+BigInt(c.raisedAmount||0),0n))}</strong></span>
                    </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4" id="cp-grid">
                ${e.length?e.filter(o=>!E.selectedCategory||o.category===E.selectedCategory).sort((o,c)=>Number(c.createdAt||0)-Number(o.createdAt||0)).map(o=>zd(o)).join(""):Pd("No active campaigns")}
            </div>
        </div>
    `},Ni=e=>{var o,c,l,u,m,p;if(!e)return`
        <div class="charity-page">
    ...
    `;const t=Xn(e.raisedAmount,e.goalAmount),n=kd(e.deadline),a=e.category||"humanitarian",s=Ar(e),r=((o=e.creator)==null?void 0:o.toLowerCase())===((c=d==null?void 0:d.userAddress)==null?void 0:c.toLowerCase()),i=Td(e);return`
        <div class="charity-page">
            ${Nr()}
            ${Nd()}
            ...
            <div class="cp-detail">
                ...
                <img src="${ja(e)}" class="cp-detail-img" onerror="this.src='${Ia.default}'">
                ...
                <div class="cp-detail-content">
                    ...
                    <div class="cp-card-base p-6">
                        ...
                        <p class="text-sm text-zinc-500 mb-4">
                            Created by <a href="${hd}${e.creator}" target="_blank" class="text-amber-500 hover:text-amber-400">${yd(e.creator)}</a>
                        </p>
...
`;function Ob(){[1,2,3,4].forEach(t=>{const n=document.getElementById(`cp-step-${t}`);n&&(t<E.createStep?(n.className="cp-step-dot done",n.innerHTML='<i class="fa-solid fa-check text-sm"></i>'):t===E.createStep?(n.className="cp-step-dot active",n.textContent=t):(n.className="cp-step-dot pending",n.textContent=t))}),[1,2,3].forEach(t=>{const n=document.getElementById(`cp-ln-${t}`);n&&(n.className=`cp-step-line ln-${t} ${E.createStep>t?"done":E.createStep===t?"active":""}`)});const e=document.querySelector(".charity-page .text-sm.text-zinc-500");e&&(e.textContent=`Step ${E.createStep} of 4`)}function Jn(){const e=document.getElementById("cp-wiz-panel");if(e)switch(Ob(),E.createStep){case 1:Ub(e);break;case 2:Hb(e);break;case 3:jb(e);break;case 4:Wb(e);break}}function Ub(e){e.innerHTML=`
    ...
    `}function Hb(e){const t=E.createTitle.length,n=E.createDesc.length;e.innerHTML=`
    ...
    `}function Wb(e){const t=ze[E.createCategory]||ze.humanitarian;e.innerHTML=`
    ...
    `}function Gb(e){E.createCategory=e,Jn()}function Kb(){var e,t,n,a,s,r;switch(E.createStep){case 1:if(!E.createCategory)return h("Select a category","error");break;case 2:{const i=((t=(e=document.getElementById("wiz-title"))==null?void 0:e.value)==null?void 0:t.trim())||"",o=((a=(n=document.getElementById("wiz-desc"))==null?void 0:n.value)==null?void 0:a.trim())||"";if(E.createTitle=i,E.createDesc=o,!i)return h("Enter a title","error");if(!o)return h("Enter a description","error");break}case 3:{const i=((r=(s=document.getElementById("wiz-image-url"))==null?void 0:s.value)==null?void 0:r.trim())||"";i&&(E.createImageUrl=i);break}}E.createStep=Math.min(4,E.createStep+1),Jn()}function Yb(){qb(),E.createStep=Math.max(1,E.createStep-1),Jn()}function Vb(){E.createImageFile=null,E.createImageUrl="",E.createImagePreview=null,E.pendingImageFile=null,E.createStep=4,Jn()}function Ld(){E.currentView="main",E.createStep=1,E.createCategory=null,E.createTitle="",E.createDesc="",E.createGoal="",E.createDuration="",E.createImageFile=null,E.createImageUrl="",E.createImagePreview=null,E.pendingImageFile=null,Oe()}function qb(){switch(E.createStep){case 2:{const e=document.getElementById("wiz-title"),t=document.getElementById("wiz-desc");e&&(E.createTitle=e.value),t&&(E.createDesc=t.value);break}case 3:{const e=document.getElementById("wiz-image-url");e&&(E.createImageUrl=e.value.trim());break}case 4:{const e=document.getElementById("wiz-goal"),t=document.getElementById("wiz-duration");e&&(E.createGoal=e.value),t&&(E.createDuration=t.value);break}}}function Xb(e,t){const n=t.value.length,a=e==="title"?100:2e3,s=e==="title"?80:1800,r=e==="title"?95:1950,i=document.getElementById(`wiz-${e}-count`);i&&(i.textContent=`${n}/${a}`,i.className=`cp-wiz-char-count ${n>r?"danger":n>s?"warn":""}`)}function Jb(e){var a;const t=(a=e.target.files)==null?void 0:a[0];if(!t)return;if(!wd.includes(t.type)){h("Please select a valid image (JPG, PNG, GIF, WebP)","error");return}if(t.size>vd){h("Image must be less than 5MB","error");return}E.createImageFile=t,E.pendingImageFile=t;const n=new FileReader;n.onload=s=>{E.createImagePreview=s.target.result;const r=document.getElementById("wiz-image-preview");r&&(r.innerHTML=`
                <img src="${s.target.result}" class="cp-image-preview">
                <button type="button" class="cp-image-remove" onclick="event.stopPropagation();CharityPage.removeWizardImage()">
                    <i class="fa-solid fa-xmark"></i> Remove
                </button>
            `)},n.readAsDataURL(t)}function Zb(){E.createImageFile=null,E.createImagePreview=null,E.createImageUrl="",E.pendingImageFile=null;const e=document.getElementById("wiz-image-preview");e&&(e.innerHTML=`
            <div class="cp-image-upload-icon"><i class="fa-solid fa-cloud-arrow-up"></i></div>
            <div class="cp-image-upload-text"><span>Click to upload</span> or drag and drop<br><small>PNG, JPG, GIF, WebP — max 5MB</small></div>
        `);const t=document.getElementById("wiz-image-file");t&&(t.value="")}async function Qb(){var c,l;if(!(d!=null&&d.isConnected))return h("Connect wallet","warning");const e=(c=document.getElementById("wiz-goal"))==null?void 0:c.value,t=(l=document.getElementById("wiz-duration"))==null?void 0:l.value;if(E.createGoal=e||"",E.createDuration=t||"",!E.createCategory)return h("Select a category","error");if(!E.createTitle)return h("Enter a title","error");if(!E.createDesc)return h("Enter a description","error");if(!e||parseFloat(e)<.01)return h("Goal must be at least 0.01 ETH","error");if(!t||parseInt(t)<1||parseInt(t)>180)return h("Duration must be 1-180 days","error");let n=E.createImageUrl||"";if(E.createImageFile)try{h("Uploading image to IPFS...","info"),n=await zr(E.createImageFile),h("Image uploaded!","success")}catch(u){console.error("Image upload failed:",u),h("Image upload failed — campaign will be created without image","warning")}const a=E.createTitle,s=E.createDesc,r=E.createCategory,i=jt.parseEther(e),o=parseInt(t);await Ot.createCampaign({title:a,description:s,goalAmount:i,durationDays:o,button:document.getElementById("btn-wizard-launch"),onSuccess:async(u,m)=>{if(m){Pr(m,{imageUrl:n,category:r,title:a,description:s});try{await fetch(qn.saveCampaign,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:m,title:a,description:s,category:r,imageUrl:n,creator:d.userAddress})})}catch{}}h("Campaign created!","success"),Ld(),await vt(),Oe()},onError:u=>{var m;!u.cancelled&&u.type!=="user_rejected"&&h(((m=u.message)==null?void 0:m.slice(0,80))||"Failed","error")}})}function Wa(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.add("active")}function pt(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.remove("active")}function eg(e=null){E.createStep=e?2:1,E.createCategory=e,E.createTitle="",E.createDesc="",E.createGoal="",E.createDuration="",E.createImageFile=null,E.createImageUrl="",E.createImagePreview=null,E.pendingImageFile=null,E.currentView="create",Oe()}function tg(e){const t=E.campaigns.find(s=>s.id===e||s.id===String(e));if(!t)return;const n=document.getElementById("donate-campaign-info");n&&(n.innerHTML=`
            <div class="flex items-center gap-3 p-3 bg-zinc-800/50 rounded-xl mb-4">
                <img src="${ja(t)}" class="w-12 h-12 rounded-lg object-cover">
                <div class="flex-1 min-w-0">
                    <p class="text-white font-semibold text-sm truncate">${t.title}</p>
                    <p class="text-zinc-500 text-xs">${Xn(t.raisedAmount,t.goalAmount)}% funded</p>
                </div>
            </div>
        `);const a=document.getElementById("donate-amount");a&&(a.value=""),E.currentCampaign=t,Wa("donate")}function ng(){var a;const e=(a=d==null?void 0:d.userAddress)==null?void 0:a.toLowerCase(),t=E.campaigns.filter(s=>{var r;return((r=s.creator)==null?void 0:r.toLowerCase())===e}),n=document.getElementById("my-campaigns-list");n&&(t.length===0?n.innerHTML=`
            <div class="cp-empty">
        ...
        `:n.innerHTML=t.map(s=>{const r=Xn(s.raisedAmount,s.goalAmount),i=Td(s);return`
                <div class="flex items-center gap-3 p-3 bg-zinc-800/30 rounded-xl mb-2 hover:bg-zinc-800/50 transition-colors">
                    <img src="${ja(s)}" class="w-14 h-14 rounded-lg object-cover cursor-pointer" onclick="CharityPage.viewCampaign('${s.id}')">
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-zinc-500 text-xs"><i class="fa-brands fa-ethereum"></i> ${Te(s.raisedAmount)} / ${Te(s.goalAmount)} ETH (${r}%)</p>
                    </div>
                    <div class="flex gap-2">
            ...
            `}).join(""),Wa("my"))}function ag(e){var a,s,r;const t=E.campaigns.find(i=>i.id===e||i.id===String(e));if(!t)return;if(((a=t.creator)==null?void 0:a.toLowerCase())!==((s=d==null?void 0:d.userAddress)==null?void 0:s.toLowerCase())){h("Not your campaign","error");return}E.editingCampaign=t,E.pendingImageFile=null,document.getElementById("edit-campaign-id").value=t.id,document.getElementById("edit-title").value=t.title||"",document.getElementById("edit-desc").value=t.description||"",document.getElementById("edit-image-url").value=t.imageUrl||"",document.querySelectorAll("#modal-edit .cp-cat-option").forEach(i=>i.classList.remove("selected")),(r=document.getElementById(`edit-opt-${t.category||"humanitarian"}`))==null||r.classList.add("selected");const n=document.getElementById("edit-image-preview");n&&t.imageUrl?n.innerHTML=`<img src="${t.imageUrl}" class="cp-image-preview">`:n&&(n.innerHTML=""),Wa("edit")}function sg(e,t="create"){var s;const n=t==="edit"?"edit-opt-":"opt-",a=t==="edit"?"#modal-edit":"#modal-create";document.querySelectorAll(`${a} .cp-cat-option`).forEach(r=>r.classList.remove("selected")),(s=document.getElementById(`${n}${e}`))==null||s.classList.add("selected")}function rg(e){const t=document.getElementById("donate-amount")||document.getElementById("detail-amount");t&&(t.value=e)}async function ig(){var c,l,u,m,p,f,b,x;if(!(d!=null&&d.isConnected))return h("Connect wallet","warning");const e=document.querySelector("#modal-create .cp-cat-option.selected input"),t=(e==null?void 0:e.value)||"humanitarian",n=(l=(c=document.getElementById("campaign-title"))==null?void 0:c.value)==null?void 0:l.trim(),a=(m=(u=document.getElementById("campaign-desc"))==null?void 0:u.value)==null?void 0:m.trim(),s=(p=document.getElementById("campaign-goal"))==null?void 0:p.value,r=(f=document.getElementById("campaign-duration"))==null?void 0:f.value;let i=(x=(b=document.getElementById("campaign-image-url"))==null?void 0:b.value)==null?void 0:x.trim();if(!n)return h("Enter a title","error");if(!a)return h("Enter a description","error");if(!s||parseFloat(s)<.01)return h("Goal must be at least 0.01 ETH","error");if(!r||parseInt(r)<1)return h("Duration must be at least 1 day","error");if(E.pendingImageFile)try{h("Uploading image...","info"),i=await zr(E.pendingImageFile)}catch(y){console.error("Image upload failed:",y)}const o=jt.parseEther(s);await Ot.createCampaign({title:n,description:a,goalAmount:o,durationDays:parseInt(r),button:document.getElementById("btn-create"),onSuccess:async(y,C)=>{if(C){Pr(C,{imageUrl:i,category:t,title:n,description:a});try{await fetch(qn.saveCampaign,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:C,title:n,description:a,category:t,imageUrl:i,creator:d.userAddress})})}catch{}}h("Campaign created!","success"),pt("create"),E.pendingImageFile=null,await vt(),Oe()},onError:y=>{var C;!y.cancelled&&y.type!=="user_rejected"&&h(((C=y.message)==null?void 0:C.slice(0,80))||"Failed","error")}})}async function og(){var a;if(!(d!=null&&d.isConnected))return h("Connect wallet","warning");const e=E.currentCampaign;if(!e)return;const t=(a=document.getElementById("donate-amount"))==null?void 0:a.value;if(!t||parseFloat(t)<.001)return h("Minimum 0.001 ETH","error");const n=jt.parseEther(t);await Ot.donate({campaignId:e.id,amount:n,button:document.getElementById("btn-donate"),onSuccess:async()=>{h("❤️ Thank you for your donation!","success"),pt("donate"),await vt(),Oe()},onError:s=>{var r;!s.cancelled&&s.type!=="user_rejected"&&h(((r=s.message)==null?void 0:r.slice(0,80))||"Failed","error")}})}async function cg(e){var a;if(!(d!=null&&d.isConnected))return h("Connect wallet","warning");const t=(a=document.getElementById("detail-amount"))==null?void 0:a.value;if(!t||parseFloat(t)<.001)return h("Minimum 0.001 ETH","error");const n=jt.parseEther(t);await Ot.donate({campaignId:e,amount:n,button:document.getElementById("btn-donate-detail"),onSuccess:async()=>{h("❤️ Thank you for your donation!","success"),await vt(),await Wt(e)},onError:s=>{var r;!s.cancelled&&s.type!=="user_rejected"&&h(((r=s.message)==null?void 0:r.slice(0,80))||"Failed","error")}})}async function lg(e){if(!(d!=null&&d.isConnected))return h("Connect wallet","warning");confirm("Cancel this campaign? This cannot be undone.")&&await Ot.cancelCampaign({campaignId:e,button:document.getElementById("btn-cancel"),onSuccess:async()=>{h("Campaign cancelled","success"),await vt(),Oe()},onError:t=>{var n;!t.cancelled&&t.type!=="user_rejected"&&h(((n=t.message)==null?void 0:n.slice(0,80))||"Failed","error")}})}async function dg(e){if(!(d!=null&&d.isConnected))return h("Connect wallet","warning");const t=E.campaigns.find(s=>s.id===e||s.id===String(e));if(!t)return;const n=Xn(t.raisedAmount,t.goalAmount);let a=`Withdraw ${Te(t.raisedAmount)} ETH?

5% platform fee applies.`;n<100&&(a+=`
Goal not reached - partial withdrawal.`),confirm(a)&&await Ot.withdraw({campaignId:e,button:document.getElementById(`btn-withdraw-${e}`)||document.getElementById("btn-withdraw"),onSuccess:async()=>{var s;h("✅ Funds withdrawn successfully!","success"),pt("my"),await vt(),Oe(),((s=E.currentCampaign)==null?void 0:s.id)===e&&await Wt(e)},onError:s=>{var r;!s.cancelled&&s.type!=="user_rejected"&&h(((r=s.message)==null?void 0:r.slice(0,80))||"Failed","error")}})}async function ug(){var o,c,l,u,m,p,f,b;if(!(d!=null&&d.isConnected))return h("Connect wallet","warning");const e=(o=document.getElementById("edit-campaign-id"))==null?void 0:o.value,t=(l=(c=document.getElementById("edit-title"))==null?void 0:c.value)==null?void 0:l.trim(),n=(m=(u=document.getElementById("edit-desc"))==null?void 0:u.value)==null?void 0:m.trim();let a=(f=(p=document.getElementById("edit-image-url"))==null?void 0:p.value)==null?void 0:f.trim();const s=document.querySelector("#modal-edit .cp-cat-option.selected input"),r=(s==null?void 0:s.value)||"humanitarian";if(!t)return h("Enter title","error");if(E.pendingImageFile)try{h("Uploading image...","info"),a=await zr(E.pendingImageFile)}catch(x){console.error("Image upload failed:",x)}const i=document.getElementById("btn-save-edit");i&&(i.disabled=!0,i.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Saving...');try{Pr(e,{imageUrl:a,category:r,title:t,description:n}),await fetch(qn.saveCampaign,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:e,title:t,description:n,category:r,imageUrl:a,creator:d.userAddress})}),h("Campaign updated!","success"),pt("edit"),E.pendingImageFile=null,await vt(),((b=E.currentCampaign)==null?void 0:b.id)===e?await Wt(e):Oe()}catch{h("Failed to save","error")}finally{i&&(i.disabled=!1,i.innerHTML='<i class="fa-solid fa-check"></i> Save')}}function pg(e){const t=E.currentCampaign;if(!t)return;const n=Ed(t.id),a=`🙏 Support "${t.title}" on Backcoin Charity!

${Te(t.raisedAmount)} raised of ${Te(t.goalAmount)} goal.

`;let s;e==="twitter"?s=`https://twitter.com/intent/tweet?text=${encodeURIComponent(a)}&url=${encodeURIComponent(n)}`:e==="telegram"?s=`https://t.me/share/url?url=${encodeURIComponent(n)}&text=${encodeURIComponent(a)}`:e==="whatsapp"&&(s=`https://wa.me/?text=${encodeURIComponent(a+n)}`),s&&window.open(s,"_blank","width=600,height=400")}function mg(){const e=E.currentCampaign;e&&navigator.clipboard.writeText(Ed(e.id)).then(()=>h("Link copied!","success")).catch(()=>h("Copy failed","error"))}function $d(){Lb(),E.currentCampaign=null,E.currentView="main",Oe()}function fg(e){pt("my"),pt("donate"),pt("edit"),Nb(e),Wt(e)}function bg(e){E.selectedCategory=E.selectedCategory===e?null:e,Lr()}function gg(){E.selectedCategory=null,Lr()}function Lr(){const e=document.getElementById("cp-grid");if(!e)return;let t=E.campaigns.filter(n=>Ar(n));E.selectedCategory&&(t=t.filter(n=>n.category===E.selectedCategory)),t.sort((n,a)=>Number(a.createdAt||0)-Number(n.createdAt||0)),e.innerHTML=t.length?t.map(n=>zd(n)).join(""):Pd("No campaigns")}async function Wt(e){E.currentView="detail",E.isLoading=!0;const t=Rs();t&&(t.innerHTML=Fb());try{let n=E.campaigns.find(a=>a.id===e||a.id===String(e));if(!n){const a=d==null?void 0:d.publicProvider;if(a){const r=await new jt.Contract(w.charityPool,Br,a).getCampaign(e),i=Ad(e);n={id:String(e),creator:r.creator||r[0],title:r.title||r[1]||`Campaign #${e}`,description:r.description||r[2]||"",goalAmount:BigInt((r.goalAmount||r[3]).toString()),raisedAmount:BigInt((r.raisedAmount||r[4]).toString()),donationCount:Number(r.donationCount||r[5]),deadline:Number(r.deadline||r[6]),createdAt:Number(r.createdAt||r[7]),status:Number(r.status||r[10]),category:(i==null?void 0:i.category)||"humanitarian",imageUrl:(i==null?void 0:i.imageUrl)||null}}}E.currentCampaign=n,t&&(t.innerHTML=Ni(n))}catch{t&&(t.innerHTML=Ni(null))}finally{E.isLoading=!1}}function Rs(){let e=document.getElementById("charity-container");if(e)return e;const t=document.getElementById("charity");return t?(e=document.createElement("div"),e.id="charity-container",t.innerHTML="",t.appendChild(e),e):null}function Oe(){zb();const e=Rs();if(!e)return;if(E.currentView==="create"){e.innerHTML=Db(),Jn();return}const t=Cd();t?Wt(t):(E.currentView="main",E.currentCampaign=null,e.innerHTML=zi(),vt().then(()=>{if(E.currentView==="main"){const n=Rs();n&&(n.innerHTML=zi())}}))}async function xg(){E.campaigns=[],E.stats=null,E.currentView==="detail"&&E.currentCampaign?await Wt(E.currentCampaign.id):Oe()}window.addEventListener("hashchange",()=>{var e;if(window.location.hash.startsWith("#charity")){const t=Cd();t?((e=E.currentCampaign)==null?void 0:e.id)!==t&&Wt(t):E.currentView!=="main"&&$d()}});const Sd={render(e){e&&Oe()},update(){E.currentView==="main"&&Lr()},refresh:xg,openModal:Wa,closeModal:pt,openCreate:eg,openDonate:tg,openMyCampaigns:ng,openEdit:ag,create:ig,donate:og,donateDetail:cg,cancel:lg,withdraw:dg,saveEdit:ug,selCatOpt:sg,setAmt:rg,goBack:$d,viewCampaign:fg,selectCat:bg,clearCat:gg,share:pg,copyLink:mg,handleImageSelect:Sb,removeImage:Rb,switchImageTab:_b,wizardSelectCategory:Gb,wizardNext:Kb,wizardBack:Yb,wizardSkipImage:Vb,cancelCreate:Ld,wizardUpdateCharCount:Xb,handleWizardImageSelect:Jb,removeWizardImage:Zb,wizardLaunch:Qb};window.CharityPage=Sd;const Lt=window.ethers,Rd="https://sepolia.arbiscan.io/address/",hg=iu,mt=500;function _d(){return w.backchat||w.Backchat||null}function st(){return w.operator||w.treasury||null}const g={view:"feed",activeTab:"feed",viewHistory:[],posts:[],trendingPosts:[],allItems:[],replies:new Map,likesMap:new Map,replyCountMap:new Map,repostCountMap:new Map,postsById:new Map,userProfile:null,profiles:new Map,hasProfile:null,following:new Set,followers:new Set,followCounts:new Map,pendingImage:null,pendingImagePreview:null,isUploadingImage:!1,selectedPost:null,selectedProfile:null,wizStep:1,wizUsername:"",wizDisplayName:"",wizBio:"",wizUsernameOk:null,wizFee:null,wizChecking:!1,fees:{post:0n,reply:0n,like:0n,follow:0n,repost:0n,superLikeMin:0n,boostMin:0n,badge:0n},pendingEth:0n,hasBadge:!1,isBoosted:!1,boostExpiry:0,badgeExpiry:0,referralStats:null,referredBy:null,isLoading:!1,isPosting:!1,contractAvailable:!0,error:null};function vg(){if(document.getElementById("backchat-styles-v70"))return;const e=document.getElementById("backchat-styles-v69");e&&e.remove();const t=document.createElement("style");t.id="backchat-styles-v70",t.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(t)}function On(e){return e?`${e.slice(0,6)}...${e.slice(-4)}`:""}function wg(e){const n=Date.now()/1e3-e;return n<60?"now":n<3600?`${Math.floor(n/60)}m`:n<86400?`${Math.floor(n/3600)}h`:n<604800?`${Math.floor(n/86400)}d`:new Date(e*1e3).toLocaleDateString("en-US",{month:"short",day:"numeric"})}function tt(e){if(!e||e===0n)return"0";const t=parseFloat(Lt.formatEther(e));return t<1e-4?"<0.0001":t<.01?t.toFixed(4):t<1?t.toFixed(3):t.toFixed(2)}function Ga(e){return e?e.slice(2,4).toUpperCase():"?"}function Fe(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}function Bn(e){if(!e)return"?";const t=g.profiles.get(e.toLowerCase());return t!=null&&t.displayName?t.displayName:t!=null&&t.username?`@${t.username}`:On(e)}function yg(e){if(!e)return null;const t=g.profiles.get(e.toLowerCase());return(t==null?void 0:t.username)||null}function kg(e){var t;return(e==null?void 0:e.toLowerCase())===((t=d.userAddress)==null?void 0:t.toLowerCase())?g.isBoosted:!1}function Eg(e){var t;return(e==null?void 0:e.toLowerCase())===((t=d.userAddress)==null?void 0:t.toLowerCase())?g.hasBadge:!1}function da(e,t){g.viewHistory.push({view:g.view,activeTab:g.activeTab,selectedPost:g.selectedPost,selectedProfile:g.selectedProfile}),g.view=e,t!=null&&t.post&&(g.selectedPost=t.post),t!=null&&t.profile&&(g.selectedProfile=t.profile),ut()}function Cg(){if(g.viewHistory.length>0){const e=g.viewHistory.pop();g.view=e.view,g.activeTab=e.activeTab||g.view,g.selectedPost=e.selectedPost,g.selectedProfile=e.selectedProfile}else g.view="feed",g.activeTab="feed";ut()}function Zn(){if(d.backchatContract)return d.backchatContract;if(d.backchatContractPublic)return d.backchatContractPublic;const e=_d();return e?d.publicProvider?new Lt.Contract(e,Wi,d.publicProvider):null:(console.warn("Backchat address not found in deployment-addresses.json"),null)}async function Li(){try{const e=Zn();if(!e)return;const t=await e.getCurrentFees();g.fees={post:t.postFee,reply:t.replyFee,like:t.likeFee,follow:t.followFee,repost:t.repostFee,superLikeMin:t.superLikeMin,boostMin:t.boostMin,badge:t.badgeFee_}}catch(e){console.warn("Failed to load fees:",e.message)}}async function $i(){if(!(!d.isConnected||!d.userAddress)){try{const e=Zn();if(!e)return;const[t,n,a,s,r,i,o]=await Promise.all([e.getPendingBalance(d.userAddress).catch(()=>0n),e.hasTrustBadge(d.userAddress).catch(()=>!1),e.isProfileBoosted(d.userAddress).catch(()=>!1),e.boostExpiry(d.userAddress).catch(()=>0),e.badgeExpiry(d.userAddress).catch(()=>0),e.referredBy(d.userAddress).catch(()=>Lt.ZeroAddress),e.getReferralStats(d.userAddress).catch(()=>({totalReferred:0n,totalEarned:0n}))]);g.pendingEth=t,g.hasBadge=n,g.isBoosted=a,g.boostExpiry=Number(s),g.badgeExpiry=Number(r),g.referredBy=i&&i!==Lt.ZeroAddress?i:null,g.referralStats={totalReferred:Number(o.totalReferred),totalEarned:o.totalEarned,totalEarnedFormatted:Lt.formatEther(o.totalEarned)}}catch(e){console.warn("Failed to load user status:",e.message)}await Tg()}}async function Si(){try{const e=Zn();if(!e)return;const[t,n]=await Promise.all([e.queryFilter(e.filters.ProfileCreated(),-5e5).catch(()=>[]),e.queryFilter(e.filters.ProfileUpdated(),-5e5).catch(()=>[])]);for(const a of t){const s=a.args.user.toLowerCase();g.profiles.set(s,{username:a.args.username,displayName:a.args.displayName||"",bio:a.args.bio||""})}for(const a of n){const s=a.args.user.toLowerCase(),r=g.profiles.get(s);r&&(r.displayName=a.args.displayName||r.displayName,r.bio=a.args.bio||r.bio)}if(d.isConnected&&d.userAddress){const a=d.userAddress.toLowerCase(),s=g.profiles.get(a);s?(g.userProfile={...s,address:d.userAddress},g.hasProfile=!0):(g.hasProfile=!1,g.userProfile=null)}}catch(e){console.warn("Failed to load profiles:",e.message)}}async function Ri(){var e;if(!(!d.isConnected||!d.userAddress))try{const t=Zn();if(!t)return;const[n,a]=await Promise.all([t.queryFilter(t.filters.Followed(),-5e5).catch(()=>[]),t.queryFilter(t.filters.Unfollowed(),-5e5).catch(()=>[])]),s=new Map;for(const i of n){const o=i.args.follower.toLowerCase(),c=i.args.followed.toLowerCase();s.has(o)||s.set(o,new Set),s.get(o).add(c)}for(const i of a){const o=i.args.follower.toLowerCase(),c=i.args.followed.toLowerCase();(e=s.get(o))==null||e.delete(c)}const r=d.userAddress.toLowerCase();g.following=s.get(r)||new Set,g.followers=new Set;for(const[i,o]of s)o.has(r)&&g.followers.add(i);g.followCounts=new Map;for(const[i,o]of s){for(const c of o)g.followCounts.has(c)||g.followCounts.set(c,{followers:0,following:0}),g.followCounts.get(c).followers++;g.followCounts.has(i)||g.followCounts.set(i,{followers:0,following:0}),g.followCounts.get(i).following=o.size}}catch(t){console.warn("Failed to load social graph:",t.message)}}async function Tg(){var e,t;try{if(!d.isConnected||!d.userAddress||g.referredBy)return;const n=localStorage.getItem("backchain_referrer");if(!n)return;if(n.toLowerCase()===d.userAddress.toLowerCase()){localStorage.removeItem("backchain_referrer");return}const a=getSignedContract();if(!a)return;console.log("[Referral] Auto-setting referrer:",n);const s=await a.setReferrer(n);h("Setting your referrer...","info"),await s.wait(),g.referredBy=n,localStorage.removeItem("backchain_referrer"),h("Referrer registered! They earn 30% of your fees.","success"),ne()}catch(n){console.warn("[Referral] Auto-set failed:",n.message),((e=n.message)!=null&&e.includes("ReferrerAlreadySet")||(t=n.message)!=null&&t.includes("already set"))&&localStorage.removeItem("backchain_referrer")}}async function sn(){g.isLoading=!0,ne();try{if(!_d()){g.contractAvailable=!1,g.error="Backchat contract not deployed yet.";return}const t=Zn();if(!t){g.contractAvailable=!1,g.error="Could not connect to Backchat contract";return}g.contractAvailable=!0;const[n,a,s,r,i]=await Promise.all([t.queryFilter(t.filters.PostCreated(),-1e5).catch(()=>[]),t.queryFilter(t.filters.ReplyCreated(),-1e5).catch(()=>[]),t.queryFilter(t.filters.RepostCreated(),-1e5).catch(()=>[]),t.queryFilter(t.filters.Liked(),-1e5).catch(()=>[]),t.queryFilter(t.filters.SuperLiked(),-1e5).catch(()=>[])]);g.likesMap=new Map;for(const u of r){const m=u.args.postId.toString();g.likesMap.has(m)||g.likesMap.set(m,new Set),g.likesMap.get(m).add(u.args.user.toLowerCase())}const o=new Map;for(const u of i){const m=u.args.postId.toString();o.set(m,(o.get(m)||0n)+u.args.ethAmount)}const c=[],l=[];g.postsById=new Map,g.replies=new Map,g.replyCountMap=new Map,g.repostCountMap=new Map;for(const u of n.slice(-80)){const m=await u.getBlock(),p={id:u.args.postId.toString(),type:"post",author:u.args.author,content:u.args.content,mediaCID:u.args.mediaCID,timestamp:m.timestamp,superLikes:o.get(u.args.postId.toString())||0n,txHash:u.transactionHash};c.push(p),l.push(p),g.postsById.set(p.id,p)}for(const u of a.slice(-60)){const m=await u.getBlock(),p={id:u.args.postId.toString(),type:"reply",parentId:u.args.parentId.toString(),author:u.args.author,content:u.args.content,mediaCID:u.args.mediaCID,tipBkc:u.args.tipBkc,timestamp:m.timestamp,superLikes:o.get(u.args.postId.toString())||0n,txHash:u.transactionHash};c.push(p),g.postsById.set(p.id,p);const f=p.parentId;g.replies.has(f)||g.replies.set(f,[]),g.replies.get(f).push(p),g.replyCountMap.set(f,(g.replyCountMap.get(f)||0)+1)}for(const u of s.slice(-30)){const m=await u.getBlock(),p={id:u.args.newPostId.toString(),type:"repost",originalPostId:u.args.originalPostId.toString(),author:u.args.reposter,timestamp:m.timestamp,txHash:u.transactionHash};c.push(p),l.push(p),g.postsById.set(p.id,p);const f=p.originalPostId;g.repostCountMap.set(f,(g.repostCountMap.get(f)||0)+1)}l.sort((u,m)=>m.timestamp-u.timestamp),g.posts=l,g.allItems=c,g.trendingPosts=[...c].filter(u=>u.type!=="repost"&&u.superLikes>0n).sort((u,m)=>{const p=BigInt(u.superLikes||0),f=BigInt(m.superLikes||0);return f>p?1:f<p?-1:0})}catch(e){console.error("Failed to load posts:",e),g.error=e.message}finally{g.isLoading=!1,ne()}}async function Ig(){var r;const e=document.getElementById("bc-compose-input"),t=(r=e==null?void 0:e.value)==null?void 0:r.trim();if(!t){h("Please write something","error");return}if(t.length>mt){h(`Post too long (max ${mt} chars)`,"error");return}g.isPosting=!0,ne();let n="";if(g.pendingImage)try{g.isUploadingImage=!0,ne(),n=(await Mg(g.pendingImage)).ipfsHash||""}catch(i){h("Image upload failed: "+i.message,"error"),g.isPosting=!1,g.isUploadingImage=!1,ne();return}finally{g.isUploadingImage=!1}const a=t,s=document.getElementById("bc-post-btn");await ve.createPost({content:a,mediaCID:n,operator:st(),button:s,onSuccess:async()=>{e&&(e.value=""),g.pendingImage=null,g.pendingImagePreview=null,g.isPosting=!1,h("Post created!","success"),await sn()},onError:i=>{g.isPosting=!1,ne()}}),g.isPosting=!1,ne()}async function Ag(e){var s;const t=document.getElementById("bc-reply-input"),n=(s=t==null?void 0:t.value)==null?void 0:s.trim();if(!n){h("Please write a reply","error");return}const a=document.getElementById("bc-reply-btn");await ve.createReply({parentId:e,content:n,mediaCID:"",tipBkc:0,operator:st(),button:a,onSuccess:async()=>{t&&(t.value=""),h("Reply posted!","success"),await sn(),ne()}})}async function Bg(e){const t=document.getElementById("bc-repost-confirm-btn");await ve.createRepost({originalPostId:e,tipBkc:0,operator:st(),button:t,onSuccess:async()=>{wt("repost"),h("Reposted!","success"),await sn()}})}async function Pg(e){var n;const t=(n=d.userAddress)==null?void 0:n.toLowerCase();t&&(g.likesMap.has(e)||g.likesMap.set(e,new Set),g.likesMap.get(e).add(t),ne()),await ve.like({postId:e,tipBkc:0,operator:st(),onSuccess:()=>{h("Liked!","success")},onError:()=>{var a;(a=g.likesMap.get(e))==null||a.delete(t),ne()}})}async function zg(e,t){const n=Lt.parseEther(t);await ve.superLike({postId:e,ethAmount:n,tipBkc:0,operator:st(),onSuccess:async()=>{h("Super Liked!","success"),await sn()}})}async function Ng(e){await ve.follow({toFollow:e,tipBkc:0,operator:st(),onSuccess:()=>{g.following.add(e.toLowerCase()),h("Followed!","success"),ne()}})}async function Lg(e){await ve.unfollow({toUnfollow:e,onSuccess:()=>{g.following.delete(e.toLowerCase()),h("Unfollowed","success"),ne()}})}async function $g(){if(g.pendingEth===0n){h("No earnings to withdraw","warning");return}await ve.withdraw({onSuccess:()=>{h(`Withdrawn ${tt(g.pendingEth)} ETH!`,"success"),g.pendingEth=0n,ne()}})}async function Sg(){const e=document.getElementById("bc-wizard-confirm-btn");await ve.createProfile({username:g.wizUsername,displayName:g.wizDisplayName,bio:g.wizBio,operator:st(),button:e,onSuccess:async()=>{h("Profile created!","success"),g.hasProfile=!0,g.userProfile={username:g.wizUsername,displayName:g.wizDisplayName,bio:g.wizBio,address:d.userAddress},g.profiles.set(d.userAddress.toLowerCase(),{username:g.wizUsername,displayName:g.wizDisplayName,bio:g.wizBio}),g.wizStep=1,g.wizUsername="",g.wizDisplayName="",g.wizBio="",g.view="profile",g.activeTab="profile",ut()}})}async function Rg(){var a,s,r,i;const e=((s=(a=document.getElementById("edit-displayname"))==null?void 0:a.value)==null?void 0:s.trim())||"",t=((i=(r=document.getElementById("edit-bio"))==null?void 0:r.value)==null?void 0:i.trim())||"",n=document.getElementById("bc-edit-profile-btn");await ve.updateProfile({displayName:e,bio:t,button:n,onSuccess:()=>{g.userProfile.displayName=e,g.userProfile.bio=t,g.profiles.set(d.userAddress.toLowerCase(),{...g.profiles.get(d.userAddress.toLowerCase()),displayName:e,bio:t}),wt("edit-profile"),h("Profile updated!","success"),ne()}})}async function _g(){await ve.obtainBadge({operator:st(),onSuccess:()=>{g.hasBadge=!0,wt("badge"),h("Badge obtained!","success"),ne()}})}async function Fg(e){const t=Lt.parseEther(e);await ve.boostProfile({ethAmount:t,operator:st(),onSuccess:()=>{g.isBoosted=!0,wt("boost"),h("Profile boosted!","success"),ne()}})}async function Mg(e){const t=new FormData;t.append("image",e);const n=new AbortController,a=setTimeout(()=>n.abort(),6e4);try{const s=await fetch("/api/upload-image",{method:"POST",body:t,signal:n.signal});if(clearTimeout(a),!s.ok){const r=await s.json().catch(()=>({}));throw new Error(r.error||`Upload failed (${s.status})`)}return await s.json()}catch(s){throw clearTimeout(a),s}}function Dg(e){var a,s;const t=(s=(a=e.target)==null?void 0:a.files)==null?void 0:s[0];if(!t)return;if(t.size>5*1024*1024){h("Image too large. Maximum 5MB.","error");return}if(!["image/jpeg","image/png","image/gif","image/webp"].includes(t.type)){h("Invalid image type. Use JPG, PNG, GIF, or WebP.","error");return}g.pendingImage=t;const n=new FileReader;n.onload=r=>{g.pendingImagePreview=r.target.result,ne()},n.readAsDataURL(t)}function Og(){g.pendingImage=null,g.pendingImagePreview=null;const e=document.getElementById("bc-image-input");e&&(e.value=""),ne()}let _i=null;function Ug(e){g.wizUsername=e.toLowerCase().replace(/[^a-z0-9_]/g,""),g.wizUsernameOk=null,g.wizFee=null,clearTimeout(_i);const t=document.getElementById("wiz-username-input");t&&(t.value=g.wizUsername),g.wizUsername.length>=1&&g.wizUsername.length<=15?(g.wizChecking=!0,fs(),_i=setTimeout(async()=>{try{const[n,a]=await Promise.all([ve.isUsernameAvailable(g.wizUsername),ve.getUsernameFee(g.wizUsername.length)]);g.wizUsernameOk=n,g.wizFee=a.formatted}catch(n){console.warn("Username check failed:",n)}g.wizChecking=!1,fs()},600)):(g.wizChecking=!1,fs())}function fs(){const e=document.getElementById("wiz-username-status");e&&(g.wizChecking?e.innerHTML='<span class="bc-username-checking"><i class="fa-solid fa-spinner fa-spin"></i> Checking...</span>':g.wizUsernameOk===!0?e.innerHTML=`<span class="bc-username-ok"><i class="fa-solid fa-check"></i> Available</span>
            ${g.wizFee&&g.wizFee!=="0.0"?`<span class="bc-username-fee">${g.wizFee} ETH</span>`:'<span class="bc-username-fee">FREE</span>'}`:g.wizUsernameOk===!1?e.innerHTML='<span class="bc-username-taken"><i class="fa-solid fa-xmark"></i> Taken</span>':e.innerHTML="")}function Hg(){if(["post-detail","user-profile","profile-setup"].includes(g.view)){let t="Post";return g.view==="user-profile"&&(t=Bn(g.selectedProfile)),g.view==="profile-setup"&&(t="Create Profile"),`
            <div class="bc-header">
    ...
    `}function Fi(){var n;if(!d.isConnected)return"";const e=tt(g.fees.post);return`
        ${g.hasProfile===!1?`
        ...
        <div class="bc-compose">
            <div class="bc-compose-row">
                <div class="bc-compose-avatar">
                    ${(n=g.userProfile)!=null&&n.username?g.userProfile.username.charAt(0).toUpperCase():Ga(d.userAddress)}
                </div>
    ...
    `}function Ft(e,t=0,n={}){var f,b,x,y;if(e.type==="repost"&&!n.isRepostContent){const C=g.postsById.get(e.originalPostId);return`
            <div class="bc-post" data-post-id="${e.id}" style="animation-delay:${Math.min(t*.04,.4)}s">
                <div class="bc-repost-banner">
                    <i class="fa-solid fa-retweet"></i>
                    <span>${Bn(e.author)} reposted</span>
                </div>
        ...
        <div class="bc-post" data-post-id="${e.id}" ${p} onclick="BackchatPage.viewPost('${e.id}')">
            <div class="bc-post-top">
                <div class="bc-avatar ${r?"boosted":""}" onclick="event.stopPropagation(); BackchatPage.viewProfile('${e.author}')">
                    ${s?s.charAt(0).toUpperCase():Ga(e.author)}
                </div>
                <div class="bc-post-head">
                    ...
                    ${e.type==="reply"?`<div class="bc-post-context">Replying to ${Bn((y=g.postsById.get(e.parentId))==null?void 0:y.author)}</div>`:""}
                </div>
            </div>
            ...
            ${e.mediaCID?`
                <div class="bc-post-media">
                    <img src="${hg}${e.mediaCID}" alt="Media" loading="lazy" onerror="this.style.display='none'">
                </div>
            `:""}
    ...
    `}function Mi(){return g.contractAvailable?g.isLoading?`
        ...
        `}function jg(){return g.trendingPosts.length===0?`
            <div class="bc-empty">
                <div class="bc-empty-glyph accent">
                    <i class="fa-solid fa-fire"></i>
                </div>
    ...
    `}function Wg(){var i,o,c,l,u,m;if(!d.isConnected)return`
            <div class="bc-empty">
        ...
        `;const e=(i=d.userAddress)==null?void 0:i.toLowerCase(),t=g.allItems.filter(p=>{var f;return((f=p.author)==null?void 0:f.toLowerCase())===e&&p.type!=="repost"}),n=g.followers.size,a=g.following.size,s=((o=g.userProfile)==null?void 0:o.displayName)||((c=g.userProfile)==null?void 0:c.username)||On(d.userAddress),r=(l=g.userProfile)!=null&&l.username?g.userProfile.username.charAt(0).toUpperCase():Ga(d.userAddress);return`
        <div class="bc-profile-section">
            ...
            <div class="bc-profile-main">
                ...
                <div class="bc-profile-handle">
                    <a href="${Rd}${d.userAddress}" target="_blank" rel="noopener">
    ...
    `}function Gg(){var a,s;if(!d.isConnected)return"";const e=`${window.location.origin}/#backchat?ref=${d.userAddress}`,t=((a=g.referralStats)==null?void 0:a.totalReferred)||0,n=((s=g.referralStats)==null?void 0:s.totalEarnedFormatted)||"0.0";return`
        <div class="bc-referral-card">
            ...
            <div class="bc-referral-info" style="margin-top:12px;">
                ...
                ${g.referredBy?`<br>You were referred by <code style="font-size:11px;color:var(--bc-accent);">${On(g.referredBy)}</code>`:""}
            </div>
        </div>
    `}function ne(){const e=document.getElementById("backchat-content");if(!e)return;let t="";switch(g.view){case"feed":t=Fi()+Mi();break;case"trending":t=jg();break;case"profile":t=g.hasProfile===!1&&d.isConnected?Di():Wg();break;case"post-detail":t=Kg();break;case"user-profile":t=Yg();break;case"profile-setup":t=Di();break;default:t=Fi()+Mi()}e.innerHTML=t}function Kg(){const e=g.selectedPost?g.postsById.get(g.selectedPost):null;if(!e)return'<div class="bc-empty"><div class="bc-empty-title">Post not found</div></div>';const t=g.replies.get(e.id)||[];t.sort((a,s)=>a.timestamp-s.timestamp);const n=Bn(e.author);return`
    ...
    `}function Yg(){var m;const e=g.selectedProfile;if(!e)return'<div class="bc-empty"><div class="bc-empty-title">User not found</div></div>';const t=e.toLowerCase(),n=g.profiles.get(t),a=(n==null?void 0:n.displayName)||(n==null?void 0:n.username)||On(e),s=n==null?void 0:n.username,r=n==null?void 0:n.bio,i=s?s.charAt(0).toUpperCase():Ga(e),o=t===((m=d.userAddress)==null?void 0:m.toLowerCase()),c=g.following.has(t),l=g.followCounts.get(t)||{followers:0,following:0},u=g.allItems.filter(p=>{var f;return((f=p.author)==null?void 0:f.toLowerCase())===t&&p.type!=="repost"});return`
        <div class="bc-profile-section">
            ...
            <div class="bc-profile-main">
                ...
                <div class="bc-profile-handle">
                    <a href="${Rd}${e}" target="_blank" rel="noopener">
                        ${On(e)} <i class="fa-solid fa-arrow-up-right-from-square"></i>
                    </a>
                </div>
    ...
    `}function Di(){if(!d.isConnected)return`
            <div class="bc-empty">
                <div class="bc-empty-glyph"><i class="fa-solid fa-wallet"></i></div>
                <div class="bc-empty-title">Connect Wallet</div>
    ...
    `}function ut(){vg();const e=document.getElementById("backchat");e&&(e.innerHTML=`
        <div class="bc-shell">
            ${Hg()}
            <div id="backchat-content"></div>
        </div>
        ${Vg()}
    `,ne())}let Ka=null;function qg(e){var t;Ka=e,(t=document.getElementById("modal-superlike"))==null||t.classList.add("active")}async function Xg(){var t;const e=((t=document.getElementById("superlike-amount"))==null?void 0:t.value)||"0.001";wt("superlike"),await zg(Ka,e)}function Jg(){var e;(e=document.getElementById("modal-badge"))==null||e.classList.add("active")}async function Zg(){wt("badge"),await _g()}function Qg(){var e;(e=document.getElementById("modal-boost"))==null||e.classList.add("active")}async function ex(){var t;const e=((t=document.getElementById("boost-amount"))==null?void 0:t.value)||"0.001";wt("boost"),await Fg(e)}function tx(e){var t;Ka=e,(t=document.getElementById("modal-repost"))==null||t.classList.add("active")}async function nx(){await Bg(Ka)}function ax(){var e;ut(),(e=document.getElementById("modal-edit-profile"))==null||e.classList.add("active")}async function sx(){await Rg()}function wt(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.remove("active")}function rx(e){const t=document.getElementById("bc-char-counter");if(!t)return;const n=e.value.length;t.textContent=`${n}/${mt}`,t.className="bc-char-count",n>mt-50?t.classList.add("danger"):n>mt-150&&t.classList.add("warn")}const Fd={async render(e){e&&(ut(),await Promise.all([Li(),$i(),Si(),sn(),Ri()]))},async refresh(){await Promise.all([Li(),$i(),Si(),sn(),Ri()])},setTab(e){g.activeTab=e,g.view=e,ut()},goBack:Cg,viewPost(e){da("post-detail",{post:e})},viewProfile(e){var t;(e==null?void 0:e.toLowerCase())===((t=d.userAddress)==null?void 0:t.toLowerCase())?(g.activeTab="profile",g.view="profile",ut()):da("user-profile",{profile:e})},openReply(e){da("post-detail",{post:e})},openProfileSetup(){g.wizStep=1,g.wizUsername="",g.wizDisplayName="",g.wizBio="",g.wizUsernameOk=null,g.wizFee=null,da("profile-setup")},createPost:Ig,submitReply:Ag,like:Pg,follow:Ng,unfollow:Lg,withdraw:$g,openSuperLike:qg,confirmSuperLike:Xg,openRepostConfirm:tx,confirmRepost:nx,openBadge:Jg,confirmBadge:Zg,openBoost:Qg,confirmBoost:ex,openEditProfile:ax,confirmEditProfile:sx,closeModal:wt,openEarnings(){g.activeTab="profile",g.view="profile",ut()},handleImageSelect:Dg,removeImage:Og,onWizUsernameInput:Ug,wizNext(){var e,t,n,a;g.wizStep===1&&!g.wizUsernameOk||(g.wizStep===1?g.wizStep=2:g.wizStep===2&&(g.wizDisplayName=((t=(e=document.getElementById("wiz-displayname-input"))==null?void 0:e.value)==null?void 0:t.trim())||"",g.wizBio=((a=(n=document.getElementById("wiz-bio-input"))==null?void 0:n.value)==null?void 0:a.trim())||"",g.wizStep=3),ne())},wizBack(){var e,t,n,a;g.wizStep>1&&(g.wizStep===2&&(g.wizDisplayName=((t=(e=document.getElementById("wiz-displayname-input"))==null?void 0:e.value)==null?void 0:t.trim())||"",g.wizBio=((a=(n=document.getElementById("wiz-bio-input"))==null?void 0:n.value)==null?void 0:a.trim())||""),g.wizStep--,ne())},wizConfirm:Sg,_wizSave(){},_updateCharCount:rx,copyReferralLink(){const e=`${window.location.origin}/#backchat?ref=${d.userAddress}`;navigator.clipboard.writeText(e).then(()=>h("Referral link copied!","success"),()=>h("Failed to copy","error"))},shareReferral(){const e=`${window.location.origin}/#backchat?ref=${d.userAddress}`,t="Join Backchat — earn crypto by posting, liking, and referring friends! 30% referral rewards.";navigator.share?navigator.share({title:"Backchat Referral",text:t,url:e}).catch(()=>{}):navigator.clipboard.writeText(`${t}
${e}`).then(()=>h("Referral message copied!","success"),()=>h("Failed to copy","error"))}};window.BackchatPage=Fd;const ix=window.inject||(()=>{console.warn("Dev Mode: Analytics disabled.")});if(window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1")try{ix()}catch(e){console.error("Analytics Error:",e)}const $r="".toLowerCase();window.__ADMIN_WALLET__=$r;$r&&console.log("✅ Admin access granted");let zt=null,hn=null,bs=!1;const fe={dashboard:Dl,mine:Kl,store:M0,rewards:wa,actions:Im,charity:Sd,backchat:Fd,notary:sd,airdrop:of,tokenomics:Kf,about:Fm,admin:Sf,rental:fd,socials:Cb,creditcard:Tb,dex:H,dao:Ib,tutorials:xd};function Md(e){return!e||e.length<42?"...":`${e.slice(0,6)}...${e.slice(-4)}`}function ox(e){if(!e)return"0.00";const t=_(e);return t>=1e9?(t/1e9).toFixed(2)+"B":t>=1e6?(t/1e6).toFixed(2)+"M":t>=1e4?t.toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):t.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function mn(e,t=!1){const n=document.querySelector("main > div.container"),a=document.querySelectorAll(".sidebar-link");if(!n){console.error("❌ Page container not found");return}const s=window.location.hash.includes("/");if(!(zt!==e||t||s)){fe[e]&&typeof fe[e].update=="function"&&fe[e].update(d.isConnected);return}console.log(`📍 Navigating: ${zt} → ${e} (force: ${t})`),hn&&typeof hn=="function"&&(hn(),hn=null),Array.from(n.children).forEach(c=>{c.tagName==="SECTION"&&(c.classList.add("hidden"),c.classList.remove("active"))});const i=document.getElementById("charity-container");i&&e!=="charity"&&(i.innerHTML=""),a.forEach(c=>{c.classList.remove("active"),c.classList.add("text-zinc-400","hover:text-white","hover:bg-zinc-700")});const o=document.getElementById(e);if(o&&fe[e]){o.classList.remove("hidden"),o.classList.add("active");const c=zt!==e;zt=e;const l=document.querySelector(`.sidebar-link[data-target="${e}"]`);l&&(l.classList.remove("text-zinc-400","hover:text-white","hover:bg-zinc-700"),l.classList.add("active")),fe[e]&&typeof fe[e].render=="function"&&fe[e].render(c||t),typeof fe[e].cleanup=="function"&&(hn=fe[e].cleanup),c&&window.scrollTo(0,0)}else e!=="dashboard"&&e!=="faucet"&&(console.warn(`Route '${e}' not found, redirecting to dashboard.`),mn("dashboard",!0))}window.navigateTo=mn;const Oi="wallet-btn text-xs font-mono text-center max-w-fit whitespace-nowrap relative font-bold py-2 px-4 rounded-md transition-colors";function Sr(e=!1){bs||(bs=!0,requestAnimationFrame(()=>{cx(e),bs=!1}))}function cx(e){const t=document.getElementById("admin-link-container"),n=document.getElementById("statUserBalance"),a=document.getElementById("connectButtonDesktop"),s=document.getElementById("connectButtonMobile"),r=document.getElementById("mobileAppDisplay");let i=d.userAddress;const o=[a,s];if(d.isConnected&&i){const l=ox(d.currentUserBalance),m=`
            <div class="status-dot"></div>
            <span>${Md(i)}</span>
            <div class="balance-pill">
                ${l} BKC
            </div>
        `;if(o.forEach(p=>{p&&(p.innerHTML=m,p.className=Oi+" wallet-btn-connected")}),r&&(r.textContent="Backcoin.org",r.classList.add("text-white"),r.classList.remove("text-amber-400")),t){const p=i.toLowerCase()===$r;t.style.display=p?"block":"none"}n&&(n.textContent=l)}else{const l='<i class="fa-solid fa-plug"></i> Connect Wallet';o.forEach(u=>{u&&(u.innerHTML=l,u.className=Oi+" wallet-btn-disconnected")}),r&&(r.textContent="Backcoin.org",r.classList.add("text-amber-400"),r.classList.remove("text-white")),t&&(t.style.display="none"),n&&(n.textContent="--")}const c=zt||"dashboard";e||!zt?mn(c,!0):fe[c]&&typeof fe[c].update=="function"&&fe[c].update(d.isConnected)}function lx(e){const{isConnected:t,address:n,isNewConnection:a,wasConnected:s}=e,r=a||t!==s;d.isConnected=t,n&&(d.userAddress=n),Sr(r),t&&a?h(`Connected: ${Md(n)}`,"success"):!t&&s&&h("Wallet disconnected.","info")}function dx(){const e=document.getElementById("testnet-banner"),t=document.getElementById("close-testnet-banner");if(!(!e||!t)){if(localStorage.getItem("hideTestnetBanner")==="true"){e.remove();return}e.style.transform="translateY(0)",t.addEventListener("click",()=>{e.style.transform="translateY(100%)",setTimeout(()=>e.remove(),500),localStorage.setItem("hideTestnetBanner","true")})}}function ux(){const e=document.querySelectorAll(".sidebar-link"),t=document.getElementById("menu-btn"),n=document.getElementById("sidebar"),a=document.getElementById("sidebar-backdrop"),s=document.getElementById("connectButtonDesktop"),r=document.getElementById("connectButtonMobile"),i=document.getElementById("shareProjectBtn");dx(),e.length>0&&e.forEach(c=>{c.addEventListener("click",async l=>{l.preventDefault();const u=c.dataset.target;if(u==="faucet"){h("Accessing Testnet Faucet...","info"),await Vs("BKC")&&Sr(!0);return}u&&(window.location.hash=u,mn(u,!0),n&&n.classList.contains("translate-x-0")&&(n.classList.remove("translate-x-0"),n.classList.add("-translate-x-full"),a&&a.classList.add("hidden")))})});const o=()=>{oo()};s&&s.addEventListener("click",o),r&&r.addEventListener("click",o),i&&i.addEventListener("click",()=>eu(d.userAddress)),t&&n&&a&&(t.addEventListener("click",()=>{n.classList.contains("translate-x-0")?(n.classList.add("-translate-x-full"),n.classList.remove("translate-x-0"),a.classList.add("hidden")):(n.classList.remove("-translate-x-full"),n.classList.add("translate-x-0"),a.classList.remove("hidden"))}),a.addEventListener("click",()=>{n.classList.add("-translate-x-full"),n.classList.remove("translate-x-0"),a.classList.add("hidden")}))}function Dd(){const e=window.location.hash.replace("#","");if(!e)return"dashboard";const t=e.split(/[/?]/)[0];return fe[t]?t:"dashboard"}function Od(){try{const e=window.location.hash,t=e.indexOf("?");if(t===-1)return;const a=new URLSearchParams(e.substring(t)).get("ref");a&&/^0x[a-fA-F0-9]{40}$/.test(a)&&(localStorage.getItem("backchain_referrer")||(localStorage.setItem("backchain_referrer",a),console.log("[Referral] Captured referrer from URL:",a)))}catch(e){console.warn("[Referral] Failed to parse referral param:",e.message)}}window.addEventListener("load",async()=>{console.log("🚀 App Initializing..."),Le.earn||(Le.earn=document.getElementById("mine"));try{if(!await ou())throw new Error("Failed to load contract addresses")}catch(n){console.error("❌ Critical Initialization Error:",n),h("Initialization failed. Please refresh.","error");return}ux(),await sp(),rp(lx),tu();const e=document.getElementById("preloader");e&&(e.style.display="none"),Od();const t=Dd();console.log("📍 Initial page from URL:",t,"Hash:",window.location.hash),mn(t,!0),console.log("✅ App Ready.")});window.addEventListener("hashchange",()=>{Od();const e=Dd(),t=window.location.hash;console.log("🔄 Hash changed to:",e,"Full hash:",t),e!==zt?mn(e,!0):e==="charity"&&fe[e]&&typeof fe[e].render=="function"&&fe[e].render(!0)});window.EarnPage=Kl;window.openConnectModal=oo;window.disconnectWallet=ip;window.updateUIState=Sr;export{Nt as C,J as E,Ep as G,le as N,Tp as T,Z as V,Za as a,Qa as b,v as c,es as d,ae as e,Cp as f,qs as g,fo as h,Ap as i,Bp as j,Qe as k,Pp as l,qt as n,q as r,Ip as s,O as t};
