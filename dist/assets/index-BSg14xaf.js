import{defaultConfig as Vd,createWeb3Modal as qd}from"https://esm.sh/@web3modal/ethers@5.1.11?bundle";import{initializeApp as Xd}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-app.js";import{getAuth as Jd,onAuthStateChanged as Zd,signInAnonymously as Qd}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-auth.js";import{getFirestore as eu,collection as Qe,query as Dt,where as dn,orderBy as sa,getDocs as xt,doc as le,getDoc as Ne,limit as tu,serverTimestamp as ht,writeBatch as Tn,updateDoc as Cn,increment as Ue,setDoc as In,Timestamp as vo,addDoc as au,deleteDoc as nu}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-firestore.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function a(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(r){if(r.ep)return;r.ep=!0;const i=a(r);fetch(r.href,i)}})();const Se={sidebar:document.getElementById("sidebar"),sidebarBackdrop:document.getElementById("sidebar-backdrop"),menuBtn:document.getElementById("menu-btn"),navLinks:document.getElementById("nav-links"),mainContentSections:document.querySelectorAll("main section"),connectButtonDesktop:document.getElementById("connectButtonDesktop"),connectButtonMobile:document.getElementById("connectButtonMobile"),mobileAppDisplay:document.getElementById("mobileAppDisplay"),desktopDisconnected:document.getElementById("desktopDisconnected"),desktopConnectedInfo:document.getElementById("desktopConnectedInfo"),desktopUserAddress:document.getElementById("desktopUserAddress"),desktopUserBalance:document.getElementById("desktopUserBalance"),modalContainer:document.getElementById("modal-container"),toastContainer:document.getElementById("toast-container"),dashboard:document.getElementById("dashboard"),earn:document.getElementById("mine"),store:document.getElementById("store"),rental:document.getElementById("rental"),rewards:document.getElementById("rewards"),actions:document.getElementById("actions"),presale:document.getElementById("presale"),faucet:document.getElementById("faucet"),airdrop:document.getElementById("airdrop"),dao:document.getElementById("dao"),about:document.getElementById("about"),admin:document.getElementById("admin"),tokenomics:document.getElementById("tokenomics"),notary:document.getElementById("notary"),statTotalSupply:document.getElementById("statTotalSupply"),statValidators:document.getElementById("statValidators"),statTotalPStake:document.getElementById("statTotalPStake"),statScarcity:document.getElementById("statScarcity"),statLockedPercentage:document.getElementById("statLockedPercentage"),statUserBalance:document.getElementById("statUserBalance"),statUserPStake:document.getElementById("statUserPStake"),statUserRewards:document.getElementById("statUserRewards")},ru={provider:null,publicProvider:null,web3Provider:null,signer:null,userAddress:null,isConnected:!1,bkcTokenContract:null,ecosystemManagerContract:null,stakingPoolContract:null,buybackMinerContract:null,rewardBoosterContract:null,fortunePoolContract:null,agoraContract:null,notaryContract:null,charityPoolContract:null,rentalManagerContract:null,faucetContract:null,liquidityPoolContract:null,governanceContract:null,bkcTokenContractPublic:null,ecosystemManagerContractPublic:null,stakingPoolContractPublic:null,buybackMinerContractPublic:null,fortunePoolContractPublic:null,agoraContractPublic:null,notaryContractPublic:null,charityPoolContractPublic:null,rentalManagerContractPublic:null,faucetContractPublic:null,currentUserBalance:0n,currentUserNativeBalance:0n,userTotalPStake:0n,userDelegations:[],myBoosters:[],activityHistory:[],totalNetworkPStake:0n,allValidatorsData:[],systemFees:{},systemPStakes:{},boosterDiscounts:{},notaryFee:void 0,notaryMinPStake:void 0},iu={set(e,t,a){const n=e[t];if(e[t]=a,["currentUserBalance","isConnected","userTotalPStake","totalNetworkPStake"].includes(t)){if(n===a)return!0;window.updateUIState&&window.updateUIState()}return!0}},c=new Proxy(ru,iu);let wo=!1;const x=(e,t="info",a=null)=>{if(!Se.toastContainer)return;const n={success:{icon:"fa-check-circle",color:"bg-green-600",border:"border-green-400"},error:{icon:"fa-exclamation-triangle",color:"bg-red-600",border:"border-red-400"},info:{icon:"fa-info-circle",color:"bg-blue-600",border:"border-blue-400"},warning:{icon:"fa-exclamation-circle",color:"bg-yellow-600",border:"border-yellow-400"}},r=n[t]||n.info,i=document.createElement("div");i.className=`flex items-center w-full max-w-xs p-4 text-white rounded-lg shadow-lg transition-all duration-500 ease-out 
    ...
    `;Aa(a,"max-w-md")}const yo=e=>{window.navigateTo?window.navigateTo(e):console.error("navigateTo function not found."),Ie()};function lu(){var r,i,s,o,l,d;if(wo)return;wo=!0;const e="https://t.me/BackCoinorg",t="https://github.com/backcoin-org/backchain-dapp";Aa(`
...
#Backchain #DeFi #Arbitrum #Web3`;navigator.share?navigator.share({title:"Backchain — Invite & Earn",text:t,url:e}).catch(()=>{}):navigator.clipboard.writeText(t).then(()=>x("Share text copied!","success")).catch(()=>{})}async function jp(){try{if(await c.provider.getBalance(c.userAddress)<Ze.parseEther("0.002")){const t=document.getElementById("no-gas-modal-dash");return t&&(t.classList.remove("hidden"),t.classList.add("flex")),!1}return!0}catch{return!0}}function Wp(){if(document.getElementById("dash-styles-v69"))return;const e=document.createElement("style");e.id="dash-styles-v69",e.textContent=`
        /* ── CSS Variables ── */
        .dash-shell {
            --dash-bg: #0c0c0e;
            --dash-surface: #141417;
    ...
    `}async function Vp(){try{const e=await fetch($p);if(e.ok){const t=await e.json();return L.economicData=t,t}}catch{}return null}async function Mr(){var e,t,a,n,r,i,s;try{const o=await Vp();let l=0n,d=0n,u=0n,m=0n,p=0n,b=0,f=0n;if(o&&((e=o.token)!=null&&e.totalSupply&&(l=BigInt(o.token.totalSupply)),(t=o.token)!=null&&t.totalBurned&&(m=BigInt(o.token.totalBurned)),(a=o.staking)!=null&&a.totalPStake&&(d=BigInt(o.staking.totalPStake)),(n=o.ecosystem)!=null&&n.totalEthCollected&&(p=BigInt(o.ecosystem.totalEthCollected)),(r=o.fortunePool)!=null&&r.prizePool&&(f=BigInt(o.fortunePool.prizePool)),(i=o.notary)!=null&&i.certCount&&(b=o.notary.certCount),(s=o.stats)!=null&&s.notarizedDocuments&&(b=Math.max(b,o.stats.notarizedDocuments))),c.bkcTokenContractPublic){l===0n&&(l=await ae(c.bkcTokenContractPublic,"totalSupply",[],0n)),m===0n&&(m=await ae(c.bkcTokenContractPublic,"totalBurned",[],0n)),d===0n&&(c.stakingPoolContractPublic||c.stakingPoolContract)&&(d=await ae(c.stakingPoolContractPublic||c.stakingPoolContract,"totalPStake",[],0n));const F=[v.stakingPool,v.fortunePool,v.rentalManager,v.buybackMiner,v.liquidityPool,v.pool_diamond,v.pool_gold,v.pool_silver,v.pool_bronze].filter(V=>V&&V!==Ze.ZeroAddress),ne=await Promise.all(F.map(V=>ae(c.bkcTokenContractPublic,"balanceOf",[V],0n)));if(ne.forEach(V=>{u+=V}),v.fortunePool&&f===0n){const V=F.indexOf(v.fortunePool);V>=0&&(f=ne[V])}}const w=D(l),T=D(m),C=D(p),P=D(f),N=F=>F.toLocaleString("en-US",{minimumFractionDigits:1,maximumFractionDigits:1}),_=D(u),B=(F,ne)=>{const V=document.getElementById(F);V&&(V.innerHTML=ne)};B("dash-metric-supply",`${N(w)} <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>`),B("dash-metric-pstake",aa(d)),B("dash-metric-burned",T>0?`<span style="color:#ef4444">${en(T)}</span> <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>`:'<span style="color:var(--dash-text-3)">0 BKC</span>'),B("dash-metric-fees",C>0?`${en(C)} <span style="font-size:10px;color:var(--dash-text-3)">ETH</span>`:'<span style="color:var(--dash-text-3)">0 ETH</span>'),B("dash-metric-locked",_>0?`<span style="color:#60a5fa">${en(_)}</span> <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>`:'<span style="color:var(--dash-text-3)">0 BKC</span>'),Gc();const I=document.getElementById("dash-fortune-prize-text");I&&(I.innerText=P>0?`Prize: ${en(P)} BKC`:"Play to win");const S=document.getElementById("dash-notary-count-text");S&&(S.innerText=b>0?`${b} docs certified`:"Certify documents"),L.metricsCache={supply:w,burned:T,fees:C,timestamp:Date.now()}}catch(o){console.error("Metrics Error",o)}}function Gc(){const e=document.getElementById("dash-metric-balance");if(!e)return;const t=c.currentUserBalance||c.bkcBalance||0n;if(!c.isConnected){e.innerHTML='<span style="font-size:11px;color:var(--dash-text-3)">Connect Wallet</span>';return}if(t===0n)e.innerHTML='0.00 <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>';else{const a=D(t);e.innerHTML=`${a.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>`}}async function qp(){if(c.userAddress)try{const e=await fetch(`https://getuserprofile-4wvdcuoouq-uc.a.run.app/${c.userAddress}`);e.ok&&(L.userProfile=await e.json())}catch{}}async function Zt(e=!1){var t,a;if(!c.isConnected){const n=document.getElementById("dash-booster-area");n&&(n.innerHTML=`
        ...
        `;return}const p=e.source==="rented",b=(d==null?void 0:d.name)||((S=e.boostName)==null?void 0:S.replace(" Booster","").replace("Booster","").trim())||"Booster",f=(d==null?void 0:d.color)||"color:var(--dash-accent)",w=i*50n/100n,T=s-w,C=p?"fa-clock":"fa-check-circle",P=p?"#22d3ee":"#4ade80",N=p?"rgba(6,182,212,0.12)":"rgba(74,222,128,0.12)",_=p?"rgba(6,182,212,0.3)":"rgba(74,222,128,0.3)",B=p?"RENTED":"OWNED",I=p?"Active rental":"In your wallet";a.innerHTML=`
        <div class="nft-clickable-image" data-address="${v.rewardBooster}" data-tokenid="${e.tokenId}" style="width:100%;cursor:pointer;transition:all 0.2s">
            <div style="display:flex;align-items:center;gap:10px;background:var(--dash-surface-2);border:1px solid ${_};border-radius:12px;padding:10px 12px;margin-bottom:8px">
                ...
                <div style="flex:1;min-width:0">
                    <div style="display:flex;align-items:center;gap:6px">
                        ...
                        <span style="font-size:8px;font-weight:800;color:${P};background:${N};padding:2px 6px;border-radius:4px;letter-spacing:0.05em">${B}</span>
            ...
            <div style="display:flex;gap:6px">
                ...
                <div style="flex:1;background:var(--dash-surface-2);border-radius:8px;padding:6px 8px;text-align:center">
                    ...
                    <div style="font-size:12px;font-weight:700;color:#34d399">+${D(T).toFixed(2)} <span style="font-size:9px;color:var(--dash-text-3)">BKC</span></div>
                </div>`:""}
            </div>`:""}
            ${r<100?`
    ...
    `}async function bn(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("activity-title");try{if(c.isConnected){if(L.activities.length===0){e&&(e.innerHTML='<div class="dash-loading"><img src="./assets/bkc_logo_3d.png" class="dash-loading-logo" alt=""><span class="dash-loading-text">Loading your activity...</span></div>');const a=await fetch(`${Ke.getHistory}/${c.userAddress}`);a.ok&&(L.activities=await a.json())}if(L.activities.length>0){t&&(t.textContent="Your Activity"),Dr();return}}t&&(t.textContent="Network Activity"),await Yo()}catch(a){console.error("Activity fetch error:",a),t&&(t.textContent="Network Activity"),await Yo()}}async function Yo(){const e=document.getElementById("dash-activity-list");if(!e||L.isLoadingNetworkActivity)return;const t=Date.now()-L.networkActivitiesTimestamp;if(L.networkActivities.length>0&&t<3e5){Vo();return}L.isLoadingNetworkActivity=!0,e.innerHTML='<div class="dash-loading"><img src="./assets/bkc_logo_3d.png" class="dash-loading-logo" alt=""><span class="dash-loading-text">Loading network activity...</span></div>';try{const a=await fetch(`${Sp}?limit=30`);if(a.ok){const n=await a.json();L.networkActivities=Array.isArray(n)?n:n.activities||[],L.networkActivitiesTimestamp=Date.now()}else L.networkActivities=[]}catch{L.networkActivities=[]}finally{L.isLoadingNetworkActivity=!1}Vo()}function Vo(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("dash-pagination-controls");if(!e)return;if(L.networkActivities.length===0){e.innerHTML=`
            ...
            </div>`,t&&(t.style.display="none");const s=document.getElementById("activity-count");s&&(s.style.display="none");return}const a=document.getElementById("activity-count");a&&(a.style.display="inline",a.textContent=L.filteredActivities.length);const n=(L.pagination.currentPage-1)*L.pagination.itemsPerPage,r=L.filteredActivities.slice(n,n+L.pagination.itemsPerPage);if(e.innerHTML=r.map(i=>Kc(i,!1)).join(""),t){const i=Math.ceil(L.filteredActivities.length/L.pagination.itemsPerPage);i>1?(t.style.display="flex",document.getElementById("page-indicator").innerText=`${L.pagination.currentPage}/${i}`,document.getElementById("page-prev").disabled=L.pagination.currentPage===1,document.getElementById("page-next").disabled=L.pagination.currentPage>=i):t.style.display="none"}}function Kc(e,t=!1){const a=Lp(e.timestamp||e.createdAt),n=Rp(e.timestamp||e.createdAt),r=e.user||e.userAddress||e.from||"",i=_p(r),s=Mp(e.type,e.details);let o="";const l=(e.type||"").toUpperCase().trim(),d=e.details||{};if(l.includes("GAME")||l.includes("FORTUNE")||l.includes("REQUEST")||l.includes("FULFILLED")||l.includes("RESULT")){const w=d.rolls||e.rolls||[],T=d.guesses||e.guesses||[],C=d.isWin||d.prizeWon&&BigInt(d.prizeWon||0)>0n,P=d.isCumulative!==void 0?d.isCumulative:T.length>1,N=P?"Combo":"Jackpot",_=P?"background:rgba(168,85,247,0.15);color:#c084fc":"background:rgba(245,158,11,0.15);color:#fbbf24",B=d.wagerAmount||d.amount,I=d.prizeWon,S=B?D(BigInt(B)).toFixed(0):"0";let F='<span style="color:var(--dash-text-3)">No win</span>';C&&I&&BigInt(I)>0n&&(F=`<span style="color:var(--dash-green);font-weight:700">+${D(BigInt(I)).toFixed(0)} BKC</span>`);let ne="";return w.length>0&&(ne=`<div style="display:flex;gap:3px">${w.map((he,ce)=>{const Y=T[ce],ie=Y!==void 0&&Number(Y)===Number(he);return`<div style="width:24px;height:24px;border-radius:4px;font-size:10px;font-weight:700;display:flex;align-items:center;justify-content:center;border:1px solid ${ie?"rgba(52,211,153,0.4)":"var(--dash-border)"};background:${ie?"rgba(52,211,153,0.1)":"var(--dash-surface-2)"};color:${ie?"#34d399":"var(--dash-text-3)"}">${he}</div>`}).join("")}</div>`),`
            <a href="${e.txHash?`${Wo}${e.txHash}`:"#"}" target="_blank" class="dash-fortune-item" title="${n}">
                <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:6px">
                    <div style="display:flex;align-items:center;gap:8px">
                        ...
                        <span style="font-size:9px;font-weight:700;${_};padding:1px 6px;border-radius:4px">${N}</span>
                    </div>
                ...
                <div style="display:flex;align-items:center;justify-content:space-between">
                    <div style="font-size:11px"><span style="color:var(--dash-text-3)">Bet: ${S}</span><span style="margin:0 6px;color:var(--dash-text-3)">→</span>${F}</div>
                    ${ne}
                </div>
            </a>
        `}if(l.includes("NOTARY")){const w=d.ipfsCid;w&&(o=`<span style="margin-left:4px;font-size:9px;color:#818cf8;font-family:monospace">${w.replace("ipfs://","").slice(0,12)}...</span>`)}if(l.includes("STAKING")||l.includes("DELEGAT")){const w=d.pStakeGenerated;w&&(o=`<span style="font-size:10px;color:var(--dash-purple)">+${D(BigInt(w)).toFixed(0)} pStake</span>`)}if(l.includes("DONATION")||l.includes("CHARITY")){const w=d.netAmount||d.amount,T=d.campaignId;w&&BigInt(w)>0n&&(o=`<span style="color:#ec4899;font-weight:700">${D(BigInt(w)).toFixed(2)} BKC</span>`,T&&(o+=`<span style="margin-left:4px;font-size:9px;color:var(--dash-text-3)">Campaign #${T}</span>`))}if(l.includes("CLAIM")||l.includes("REWARD")){const w=d.amount||e.amount;w&&(o=`<span style="color:var(--dash-accent);font-weight:700">+${D(BigInt(w)).toFixed(2)} BKC</span>`);const T=d.feePaid;T&&BigInt(T)>0n&&(o+=`<span style="margin-left:4px;font-size:9px;color:var(--dash-text-3)">(fee: ${D(BigInt(T)).toFixed(2)})</span>`)}const m=l.includes("PROMOT")||l.includes("ADS")||l.includes("ADVERTIS");if(m){const w=d.promotionFee||d.amount||e.amount;w&&BigInt(w)>0n&&(o=`<span style="color:#fbbf24;font-weight:700">${parseFloat(Ze.formatEther(BigInt(w))).toFixed(4)} ETH</span>`);const T=d.tokenId||e.tokenId;T&&(o+=`<span style="margin-left:4px;font-size:9px;color:var(--dash-text-3)">NFT #${T}</span>`)}const p=e.txHash?`${Wo}${e.txHash}`:"#";let b="";if(m){const w=d.promotionFee||d.amount||e.amount;w&&BigInt(w)>0n&&(b=parseFloat(Ze.formatEther(BigInt(w))).toFixed(4))}else{let w=e.amount||d.netAmount||d.amount||d.wagerAmount||d.prizeWon||"0";const T=D(BigInt(w));b=T>.001?T.toFixed(2):""}const f=m?"ETH":"BKC";return`
    ...
    `}function lm(){var u,m,p,b;const e=(f,w)=>{const T=document.getElementById(f);T&&(T.innerHTML=w)};e("stk-stat-network",aa(cn));const t=((u=c.userData)==null?void 0:u.pStake)||((m=c.userData)==null?void 0:m.userTotalPStake)||c.userTotalPStake||0n,a=cn>0n?Number(t*10000n/cn)/100:0;e("stk-stat-power",`${aa(t)} <span style="font-size:10px;color:var(--stk-text-3)">(${a.toFixed(2)}%)</span>`);const n=(ve==null?void 0:ve.userReceives)||0n,r=D(n);e("stk-stat-rewards",r>0?`<span style="color:var(--stk-green)">${r.toFixed(2)}</span> <span style="font-size:10px;color:var(--stk-text-3)">BKC</span>`:'<span style="color:var(--stk-text-3)">0 BKC</span>');const i=((p=c.userDelegations)==null?void 0:p.length)||0;e("stk-stat-locks",`${i}`);const s=c.currentUserBalance||0n,o=document.getElementById("stk-balance-display");o&&(o.textContent=s>0n?`${D(s).toFixed(2)} BKC`:"0.00 BKC");const l=((b=c.systemFees)==null?void 0:b.DELEGATION_FEE_BIPS)||50n,d=document.getElementById("stk-fee-info");d&&(d.textContent=`${Number(l)/100}%`)}function qc(){const e=(s,o)=>{const l=document.getElementById(s);l&&(l.innerHTML=o)};e("stk-reward-value",'-- <span class="stk-reward-suffix">BKC</span>'),e("stk-stat-network","--"),e("stk-stat-power","--"),e("stk-stat-rewards","--"),e("stk-stat-locks","--"),e("stk-balance-display","-- BKC");const t=document.getElementById("stk-claim-btn");t&&(t.disabled=!0);const a=document.getElementById("stk-breakdown");a&&(a.style.display="none");const n=document.getElementById("stk-deleg-list");n&&(n.innerHTML='<div class="stk-empty"><i class="fa-solid fa-wallet"></i><p>Connect wallet to view</p></div>');const r=document.getElementById("stk-history-list");r&&(r.innerHTML='<div class="stk-empty"><i class="fa-solid fa-wallet"></i><p>Connect wallet to view</p></div>');const i=document.getElementById("stk-boost-panel");i&&(i.innerHTML='<div class="stk-empty"><i class="fa-solid fa-wallet"></i><p>Connect wallet</p></div>')}function cm(){const e=document.getElementById("stk-deleg-list"),t=document.getElementById("stk-deleg-count");if(!e)return;const a=c.userDelegations||[];if(t&&(t.textContent=a.length),a.length===0){e.innerHTML='<div class="stk-empty"><i class="fa-solid fa-inbox"></i><p>No active delegations</p></div>';return}$t&&(clearInterval($t),$t=null);const n=[...a].sort((r,i)=>Number(r.unlockTime)-Number(i.unlockTime));e.innerHTML=n.map((r,i)=>dm(r,i)).join(""),$t=setInterval(um,6e4),e.querySelectorAll(".stk-unstake-btn").forEach(r=>{r.addEventListener("click",()=>fm(parseInt(r.dataset.index),r.classList.contains("stk-unstake-force")))})}function dm(e,t){const a=D(e.amount||0n),n=e.lockDays||Number(e.lockDuration||0n)/86400,r=Number(e.unlockTime||e.lockEnd||0n),i=Math.floor(Date.now()/1e3),s=r>i,o=s?r-i:0,l=e.lockDuration||BigInt(e.lockDays||0)*86400n,d=e.pStake||em(e.amount||0n,l);return`
        <div class="stk-deleg-item">
            ...
            <div style="display:flex;align-items:center;gap:8px">
                ${s?`
                    <span class="stk-countdown" data-unlock-time="${r}">${Yc(o)}</span>
    ...
    `}const Im={async render(e){Tm(),await Ol();const t=document.getElementById("store");t&&((t.innerHTML.trim()===""||e)&&(t.innerHTML=`
            ...
            `,Nm()),$.selectedPoolBoostBips===null&&be.length>0&&($.selectedPoolBoostBips=be[0].boostBips),await ct(),await ya())},async update(){$.selectedPoolBoostBips!==null&&!$.isDataLoading&&document.getElementById("store")&&!document.hidden&&await ct()}};async function ya(){const e=document.getElementById("history-list");if(!c.userAddress){e&&(e.innerHTML='<div class="text-center py-4 text-xs text-zinc-600">Connect wallet to view history</div>');return}try{const t=Ke.getHistory||"https://gethistory-4wvdcuoouq-uc.a.run.app",a=await fetch(`${t}/${c.userAddress}`);if(!a.ok)throw new Error(`HTTP ${a.status}`);const n=await a.json();console.log("All history types:",[...new Set((n||[]).map(i=>i.type))]),$.tradeHistory=(n||[]).filter(i=>{const s=(i.type||"").toUpperCase();return s==="NFTBOUGHT"||s==="NFTSOLD"||s==="NFT_BOUGHT"||s==="NFT_SOLD"||s==="NFTPURCHASED"||s==="NFT_PURCHASED"||s.includes("NFTBOUGHT")||s.includes("NFTSOLD")||s.includes("NFTPURCHASED")}),console.log("NFT trade history:",$.tradeHistory.length,"items");const r=document.getElementById("history-count");r&&(r.textContent=$.tradeHistory.length),Xo()}catch(t){console.error("History load error:",t),$.tradeHistory=[],Xo()}}function Xo(){const e=document.getElementById("history-list");if(e){if(!c.isConnected){e.innerHTML='<div class="text-center py-4 text-xs text-zinc-600">Connect wallet to view history</div>';return}if($.tradeHistory.length===0){e.innerHTML=`
        ...
        `}).join("")}}function Am(){return be.map((e,t)=>{const a=lr(e.name),n=t===0,r=et(e.boostBips),i=a.icon||e.emoji||"💎";return`
        ...
        <div class="fade-in">
            ...
            <div class="flex justify-between items-center text-[10px] text-zinc-600 mb-4 px-1">
                ...
                <span class="text-green-400">Keep ${et((t==null?void 0:t.boostBips)||0)}% of rewards</span>
            </div>
    ...
    `}function Pm(e,t,a,n,r=!1){return c.isConnected?e?t?`
        ...
        `}).join("")}async function ct(e=!1){var n,r;if($.selectedPoolBoostBips===null)return;const t=$.selectedPoolBoostBips,a=Date.now();if(Bt=a,!e){const i=Em(t);if(i){Kr(i),hn(),Zo(),Bm(t,a);return}}$.isDataLoading=!0;try{const i=c.myBoosters||[],s=c.rentalListings||[],o=new Set(s.map(Y=>{var ie;return(ie=Y.tokenId)==null?void 0:ie.toString()})),l=Math.floor(Date.now()/1e3),d=i.filter(Y=>Number(Y.boostBips)===t),u=d.filter(Y=>{var Oe;const ie=(Oe=Y.tokenId)==null?void 0:Oe.toString(),$e=s.find(Z=>{var Le;return((Le=Z.tokenId)==null?void 0:Le.toString())===ie}),Ct=o.has(ie),it=$e&&$e.rentalEndTime&&Number($e.rentalEndTime)>l;return!Ct&&!it}),m=be.find(Y=>Y.boostBips===t);if(!m){console.warn("Tier not found for boostBips:",t);return}const p=`pool_${m.name.toLowerCase()}`;let b=v[p]||xn.get(t);if(!b){const Y=v.nftPoolFactory||v.nftLiquidityPoolFactory;if(Y&&c.publicProvider)try{b=await new ze.Contract(Y,ym,c.publicProvider).getPoolAddress(t),b&&b!==ze.ZeroAddress&&xn.set(t,b)}catch(ie){console.warn("Factory lookup failed:",ie.message)}}if(Bt!==a)return;if(!b||b===ze.ZeroAddress){const Y=document.getElementById("swap-interface");Y&&(Y.innerHTML=`
                ...
                `);return}const f=new ze.Contract(b,ri,c.publicProvider),[w,T,C]=await Promise.all([ae(f,"getBuyPrice",[],ze.MaxUint256).catch(()=>ze.MaxUint256),ae(f,"getSellPrice",[],0n).catch(()=>0n),f.getAvailableNFTs().catch(()=>[])]);if(Bt!==a)return;const P=Array.isArray(C)?[...C]:[],N=w===ze.MaxUint256?0n:w,_=T;let B=((n=c.systemFees)==null?void 0:n.NFT_POOL_SELL_TAX_BIPS)||1000n,I=BigInt(((r=c.boosterDiscounts)==null?void 0:r[$.bestBoosterBips])||0);const S=typeof B=="bigint"?B:BigInt(B),F=typeof I=="bigint"?I:BigInt(I),ne=S>F?S-F:0n,V=_*ne/10000n,he=_-V,ce={buyPrice:N,sellPrice:_,netSellPrice:he,poolNFTCount:P.length,firstAvailableTokenIdForBuy:P.length>0?BigInt(P[P.length-1]):null,userBalanceOfSelectedNFT:d.length,availableToSellCount:u.length,availableNFTsOfTier:u};Jc(t,ce),Kr(ce,t)}catch(i){if(console.warn("Store Data Warning:",i.message),Bt===a){const s=document.getElementById("swap-interface");s&&(s.innerHTML=`
                    <div class="text-center py-12">
                        <div class="w-12 h-12 bg-zinc-800 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                `)}return}finally{Bt===a&&($.isDataLoading=!1,hn(),Zo())}}async function Bm(e,t){var a,n;try{const r=c.myBoosters||[],i=c.rentalListings||[],s=new Set(i.map(ce=>{var Y;return(Y=ce.tokenId)==null?void 0:Y.toString()})),o=Math.floor(Date.now()/1e3),l=r.filter(ce=>Number(ce.boostBips)===e),d=l.filter(ce=>{var it;const Y=(it=ce.tokenId)==null?void 0:it.toString(),ie=i.find(Oe=>{var Z;return((Z=Oe.tokenId)==null?void 0:Z.toString())===Y}),$e=s.has(Y),Ct=ie&&ie.rentalEndTime&&Number(ie.rentalEndTime)>o;return!$e&&!Ct}),u=be.find(ce=>ce.boostBips===e);if(!u)return;const m=`pool_${u.name.toLowerCase()}`;let p=v[m]||xn.get(e);if(!p||p===ze.ZeroAddress)return;const b=new ze.Contract(p,ri,c.publicProvider),[f,w,T]=await Promise.all([ae(b,"getBuyPrice",[],ze.MaxUint256).catch(()=>ze.MaxUint256),ae(b,"getSellPrice",[],0n).catch(()=>0n),b.getAvailableNFTs().catch(()=>[])]);if(Bt!==t)return;const C=Array.isArray(T)?[...T]:[],P=f===ze.MaxUint256?0n:f,N=w;let _=((a=c.systemFees)==null?void 0:a.NFT_POOL_SELL_TAX_BIPS)||1000n,B=BigInt(((n=c.boosterDiscounts)==null?void 0:n[$.bestBoosterBips])||0);const I=typeof _=="bigint"?_:BigInt(_),S=typeof B=="bigint"?B:BigInt(B),F=I>S?I-S:0n,ne=N*F/10000n,V=N-ne,he={buyPrice:P,sellPrice:N,netSellPrice:V,poolNFTCount:C.length,firstAvailableTokenIdForBuy:C.length>0?BigInt(C[C.length-1]):null,userBalanceOfSelectedNFT:l.length,availableToSellCount:d.length,availableNFTsOfTier:d};Jc(e,he),$.selectedPoolBoostBips===e&&Bt===t&&(Kr(he,e),hn())}catch(r){console.warn("Background refresh failed:",r.message)}}function Kr(e,t){var r,i,s;$.buyPrice=e.buyPrice,$.sellPrice=e.sellPrice,$.netSellPrice=e.netSellPrice,$.poolNFTCount=e.poolNFTCount,$.firstAvailableTokenIdForBuy=e.firstAvailableTokenIdForBuy,$.userBalanceOfSelectedNFT=e.userBalanceOfSelectedNFT,$.availableToSellCount=e.availableToSellCount;const a=$.firstAvailableTokenId;!(a&&((r=e.availableNFTsOfTier)==null?void 0:r.some(o=>BigInt(o.tokenId)===a)))&&((i=e.availableNFTsOfTier)==null?void 0:i.length)>0?$.firstAvailableTokenId=BigInt(e.availableNFTsOfTier[0].tokenId):(s=e.availableNFTsOfTier)!=null&&s.length||($.firstAvailableTokenId=null)}function Nm(){const e=document.getElementById("store");e&&e.addEventListener("click",async t=>{if(t.target.closest("#refresh-btn")){const s=t.target.closest("#refresh-btn").querySelector("i");s.classList.add("fa-spin"),kr($.selectedPoolBoostBips),await Promise.all([Nt(!0),Ul()]),await ct(!0),ya(),s.classList.remove("fa-spin");return}const a=t.target.closest(".tier-chip");if(a){const i=Number(a.dataset.boost);$.selectedPoolBoostBips!==i&&($.selectedPoolBoostBips=i,$.firstAvailableTokenId=null,Jo(i),await ct());return}if(t.target.closest("#swap-direction-btn")){$.tradeDirection=$.tradeDirection==="buy"?"sell":"buy",hn();return}if(t.target.closest("#inventory-toggle")){const i=document.getElementById("inventory-panel"),s=document.getElementById("inventory-chevron");i&&s&&(i.classList.toggle("hidden"),s.style.transform=i.classList.contains("hidden")?"":"rotate(180deg)");return}if(t.target.closest("#history-toggle")){const i=document.getElementById("history-panel"),s=document.getElementById("history-chevron");i&&s&&(i.classList.toggle("hidden"),s.style.transform=i.classList.contains("hidden")?"":"rotate(180deg)");return}const n=t.target.closest(".inventory-item");if(n){if(n.dataset.unavailable==="true"){x("This NFT is listed for rental and cannot be sold","warning");return}const s=Number(n.dataset.boost),o=n.dataset.tokenid;$.selectedPoolBoostBips=s,$.tradeDirection="sell",o&&($.firstAvailableTokenId=BigInt(o),console.log("User selected NFT #"+o+" for sale")),Jo(s),await ct();return}const r=t.target.closest("#execute-btn");if(r){if(t.preventDefault(),t.stopPropagation(),tn||r.disabled)return;const i=r.dataset.action,s=document.getElementById("trade-mascot");if(i==="connect"){window.openConnectModal();return}const o=be.find(u=>u.boostBips===$.selectedPoolBoostBips);if(!o)return;const l=`pool_${o.name.toLowerCase()}`,d=v[l]||xn.get(o.boostBips);if(!d){x("Pool address not found","error");return}tn=!0,s&&(s.className="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden trade-spin");try{if($.tradeDirection==="buy")await fn.buyFromPool({poolAddress:d,button:r,onSuccess:async u=>{s&&(s.className="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden trade-success"),x("🟢 NFT Purchased!","success"),kr($.selectedPoolBoostBips),await Promise.all([Nt(!0),ct(!0)]),ya()},onError:u=>{if(!u.cancelled&&u.type!=="user_rejected"){const m=u.message||u.reason||"Transaction failed";x("Buy failed: "+m,"error")}}});else{if(!$.firstAvailableTokenId){x("No NFT selected for sale","error"),tn=!1;return}await fn.sellToPool({poolAddress:d,tokenId:$.firstAvailableTokenId,button:r,onSuccess:async u=>{s&&(s.className="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden trade-success"),x("🔴 NFT Sold!","success"),kr($.selectedPoolBoostBips),await Promise.all([Nt(!0),ct(!0)]),ya()},onError:u=>{if(!u.cancelled&&u.type!=="user_rejected"){const m=u.message||u.reason||"Transaction failed";x("Sell failed: "+m,"error")}}})}}finally{tn=!1,setTimeout(async()=>{try{await Promise.all([Nt(!0),ct(!0)]),ya()}catch(u){console.warn("[Store] Post-transaction refresh failed:",u.message)}},2e3),s&&setTimeout(()=>{const u=$.tradeDirection==="buy";s.className=`w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden ${u?"trade-buy":"trade-sell"}`},800)}}})}const Zs="https://sepolia.arbiscan.io/tx/",Yr="https://sepolia.arbiscan.io/address/",Zc="0x16346f5a45f9615f1c894414989f0891c54ef07b",Sm=(v==null?void 0:v.fortunePool)||"0x277dB00d533Bbc0fc267bbD954640aDA38ee6B37",vn="./assets/fortune.png",Vr=1e3,Qo={pt:{title:"Compartilhe & Ganhe!",subtitle:"+1000 pontos para o Airdrop",later:"Talvez depois"},en:{title:"Share & Earn!",subtitle:"+1000 points for Airdrop",later:"Maybe later"},es:{title:"¡Comparte y Gana!",subtitle:"+1000 puntos para el Airdrop",later:"Quizás después"}},$m={pt:{win:e=>`🎉 Ganhei ${e.toLocaleString()} BKC no Fortune Pool!
...
#Backcoin #Web3 #Arbitrum`}},Er={pt:"./assets/pt.png",en:"./assets/en.png",es:"./assets/es.png"};let qe="en";const me=[{id:1,name:"Easy",emoji:"🍀",range:5,multiplier:2,chance:"20%",color:"emerald",hex:"#10b981",bgFrom:"from-emerald-500/20",bgTo:"to-green-600/10",borderColor:"border-emerald-500/50",textColor:"text-emerald-400"},{id:2,name:"Medium",emoji:"⚡",range:15,multiplier:10,chance:"6.7%",color:"violet",hex:"#8b5cf6",bgFrom:"from-violet-500/20",bgTo:"to-purple-600/10",borderColor:"border-violet-500/50",textColor:"text-violet-400"},{id:3,name:"Hard",emoji:"👑",range:150,multiplier:100,chance:"0.67%",color:"amber",hex:"#f59e0b",bgFrom:"from-amber-500/20",bgTo:"to-orange-600/10",borderColor:"border-amber-500/50",textColor:"text-amber-400"}],Qc=57,y={mode:null,phase:"select",guess:50,guesses:[2,5,50],comboStep:0,wager:10,gameId:null,result:null,txHash:null,poolStatus:null,history:[],serviceFee:0n,serviceFee1x:0n,serviceFee5x:0n,tiersData:null,commitment:{hash:null,userSecret:null,commitBlock:null,commitTxHash:null,revealDelay:2,waitStartTime:null,canReveal:!1}};let Re=null;const Lm=3e3,ed=250;function Rm(){if(document.getElementById("fortune-styles-v2"))return;const e=document.createElement("style");e.id="fortune-styles-v2",e.textContent=`
        ...
        <div class="max-w-md mx-auto px-4 py-6">
            ...
            <div class="text-center mb-6">
                ...
                <div class="flex items-center justify-center gap-2 mt-3 flex-wrap">
                    <a href="${Yr}${Zc}" target="_blank" rel="noopener" 
    ...
    `,eo(),ue()}function Fm(){Re&&(clearInterval(Re),Re=null),y.phase="select",y.result=null,y.commitment={hash:null,userSecret:null,commitBlock:null,commitTxHash:null,revealDelay:y.commitment.revealDelay||2,waitStartTime:null,canReveal:!1}}function ue(){const e=document.getElementById("game-area");if(e)switch(Mm(y.phase),y.phase){case"select":el(e);break;case"pick":Dm(e);break;case"wager":Um(e);break;case"processing":Wm(e);break;case"waiting":Gm(e);break;case"result":Xm(e);break;default:el(e)}}function Mm(e){var a;const t=document.getElementById("tiger-mascot");if(t)switch(t.className="w-28 h-28 object-contain mx-auto",t.style.filter="",e){case"select":t.classList.add("tiger-float","tiger-pulse");break;case"pick":case"wager":t.classList.add("tiger-float");break;case"processing":t.classList.add("tiger-spin");break;case"waiting":t.classList.add("tiger-float"),t.style.filter="hue-rotate(270deg)";break;case"result":((a=y.result)==null?void 0:a.prizeWon)>0?t.classList.add("tiger-celebrate"):(t.style.filter="grayscale(0.5)",t.classList.add("tiger-float"));break}}function el(e){var r,i;const t=y.serviceFee1x>0n?(Number(y.serviceFee1x)/1e18).toFixed(6):"0",a=y.serviceFee5x>0n?(Number(y.serviceFee5x)/1e18).toFixed(6):"0",n=y.serviceFee1x>0n||y.serviceFee5x>0n;e.innerHTML=`
        <div class="space-y-4">
            <!-- JACKPOT MODE -->
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center gap-3 mb-1">
                            ...
                            <span class="px-2.5 py-1 rounded-full bg-violet-500/20 border border-violet-500/40 text-violet-400 text-sm font-black">${Qc}x</span>
                        </div>
    ...
    `,(l=document.getElementById("btn-reveal"))==null||l.addEventListener("click",()=>{y.commitment.canReveal&&qr()}),Qs()}function Qs(){if(y.phase!=="waiting")return;const e=document.getElementById("countdown-timer"),t=document.getElementById("progress-bar");if(document.getElementById("btn-reveal"),document.getElementById("reveal-btn-text"),!e)return;const a=Date.now()-(y.commitment.waitStartTime||Date.now()),n=y.commitment.revealDelay*ed,r=Math.max(0,n-a),i=Math.ceil(r/1e3);if(i>0?e.textContent=`~${i}s`:y.commitment.canReveal?e.textContent="Ready!":e.textContent="Verifying on chain...",t){const s=Math.min(100,a/n*100);t.style.width=`${s}%`}y.phase==="waiting"&&setTimeout(Qs,1e3)}function Km(){Re&&clearInterval(Re),setTimeout(Qs,100),Re=setInterval(async()=>{if(y.phase!=="waiting"){clearInterval(Re);return}try{await qm()&&!y.commitment.canReveal&&(y.commitment.canReveal=!0,clearInterval(Re),Re=null,console.log("[FortunePool] canReveal=true, starting auto-reveal..."),Ym())}catch(e){console.warn("Reveal check error:",e)}},Lm)}async function Ym(){if(y.phase!=="waiting")return;const e=document.getElementById("countdown-timer"),t=document.getElementById("btn-reveal"),a=document.getElementById("reveal-btn-text");e&&(e.textContent="Revealing..."),t&&(t.disabled=!0,t.classList.remove("bg-zinc-800","text-zinc-500","cursor-not-allowed"),t.classList.add("bg-gradient-to-r","from-amber-500","to-yellow-500","text-white")),a&&(a.textContent="Auto-revealing...");const n=y.mode==="jackpot"?[y.guess]:y.guesses,r=5,i=2e3;await new Promise(s=>setTimeout(s,3e3));for(let s=1;s<=r;s++){if(y.phase!=="waiting")return;try{const o=c.fortunePoolContractPublic;o&&await o.revealPlay.staticCall(y.gameId,n,y.commitment.userSecret,{from:c.userAddress}),console.log(`[FortunePool] Pre-simulation passed (attempt ${s})`),qr();return}catch(o){const l=o.message||"",d=l.includes("0x92555c0e")||l.includes("BlockhashUnavailable");if(d&&s<r)console.log(`[FortunePool] BlockhashUnavailable, retry in ${i}ms (${s}/${r})`),e&&(e.textContent="Syncing block data..."),await new Promise(u=>setTimeout(u,i));else if(d){console.warn("[FortunePool] Pre-sim retries exhausted, enabling manual button"),Vm();return}else{console.log("[FortunePool] Pre-sim error (non-blockhash), trying direct reveal:",l),qr();return}}}}function Vm(){const e=document.getElementById("btn-reveal"),t=document.getElementById("reveal-btn-text"),a=document.getElementById("countdown-timer");a&&(a.textContent="Ready!"),e&&(e.disabled=!1,e.classList.remove("bg-zinc-800","text-zinc-500","cursor-not-allowed","from-amber-500","to-yellow-500"),e.classList.add("bg-gradient-to-r","from-emerald-500","to-green-500","text-white")),t&&(t.textContent="Reveal & Get Result!")}async function qm(){if(!c.fortunePoolContractPublic||!y.gameId)return!1;try{const e=await c.fortunePoolContractPublic.getCommitmentStatus(y.gameId);if(!y.commitment.commitBlock)try{const t=await c.fortunePoolContractPublic.getCommitment(y.gameId),a=Number(t.commitBlock);a>0&&(y.commitment.commitBlock=a)}catch{}return e.canReveal===!0}catch{return Date.now()-(y.commitment.waitStartTime||Date.now())>=3e4}}async function qr(){if(!y.commitment.canReveal){x("Not ready to reveal yet!","warning");return}const e=document.getElementById("btn-reveal");try{const t=y.mode==="jackpot"?[y.guess]:y.guesses;await Qn.revealPlay({gameId:y.gameId,guesses:t,userSecret:y.commitment.userSecret,button:e,onSuccess:(a,n)=>{Re&&clearInterval(Re),y.txHash=a.hash,y.result={rolls:(n==null?void 0:n.rolls)||[],prizeWon:(n==null?void 0:n.prizeWon)||0n,matches:(n==null?void 0:n.matches)||[],matchCount:(n==null?void 0:n.matchCount)||0},console.log("🎲 Game revealed:",y.result),y.phase="result",ue(),eo()},onError:a=>{if(!a.cancelled){const n=a.message||"";n.includes("0x92555c0e")||n.includes("BlockhashUnavailable")?x("Block data not available yet. RPC will retry automatically.","warning"):x(n||"Reveal failed","error")}e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-dice mr-2"></i>Try Again')}})}catch(t){console.error("Reveal error:",t),x("Reveal failed: "+(t.message||"Unknown error"),"error"),e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-dice mr-2"></i>Try Again')}}function Xm(e){var m,p;const t=y.result;if(!t)return ue();const a=y.mode==="jackpot",n=a?[y.guess]:y.guesses,r=t.rolls||[],i=a?[me[2]]:me,s=n.map((b,f)=>{const w=r[f]!==void 0?Number(r[f]):null;return w!==null&&w===b}),o=s.filter(b=>b).length,l=t.prizeWon>0||o>0;let d=0;t.prizeWon&&t.prizeWon>0n?d=D(BigInt(t.prizeWon)):o>0&&s.forEach((b,f)=>{if(b){const w=a?me[2]:me[f];d+=y.wager*w.multiplier}});const u=typeof d=="number"?d.toLocaleString(void 0,{maximumFractionDigits:2}):d.toLocaleString();e.innerHTML=`
        <div class="bg-gradient-to-br ${l?"from-emerald-900/30 to-green-900/10 border-emerald-500/30":"from-zinc-900 to-zinc-800/50 border-zinc-700/50"} border rounded-2xl p-4 sm:p-6 relative overflow-hidden" id="result-container">
            ...
            <div class="grid ${a?"grid-cols-1 max-w-[200px] mx-auto":"grid-cols-3"} gap-2 sm:gap-3 mb-4">
                ${i.map((b,f)=>{const w=a?n[0]:n[f],T=r[f],C=s[f];return`
    ...
    `,l&&(Jm(),d>y.wager*10&&Zm()),(m=document.getElementById("btn-new-game"))==null||m.addEventListener("click",()=>{y.phase="select",y.result=null,y.txHash=null,y.gameId=null,ue(),eo()}),(p=document.getElementById("btn-share"))==null||p.addEventListener("click",()=>{Qm(l,d)})}function Jm(){const e=document.createElement("div");e.className="confetti-container",document.body.appendChild(e);const t=["#f59e0b","#10b981","#8b5cf6","#ec4899","#06b6d4"],a=["●","■","★","🐯","🎉"];for(let n=0;n<60;n++){const r=document.createElement("div");r.className="confetti",r.style.cssText=`
        ...
        `,r.textContent=a[n%a.length],e.appendChild(r)}setTimeout(()=>e.remove(),5e3)}function Zm(){const e=["🪙","💰","✨","⭐","🎉"];for(let t=0;t<30;t++)setTimeout(()=>{const a=document.createElement("div");a.className="coin",a.textContent=e[Math.floor(Math.random()*e.length)],a.style.left=`${Math.random()*100}%`,a.style.animationDelay=`${Math.random()*.5}s`,a.style.animationDuration=`${2+Math.random()*2}s`,document.body.appendChild(a),setTimeout(()=>a.remove(),4e3)},t*100)}function Qm(e,t){var l,d,u,m,p,b;const a=Qo[qe],n=()=>{const f=$m[qe];return e?f.win(t):f.lose},r=`
        <div class="text-center">
            ...
            <div class="flex justify-center gap-2 mb-4">
                <button class="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${qe==="pt"?"bg-amber-500/20 border-amber-500 ring-1 ring-amber-500/50":"bg-zinc-800 border-zinc-700 hover:border-zinc-500"} border" data-lang="pt">
                    <img src="${Er.pt}" class="w-5 h-5 rounded-full object-cover" alt="PT">
                    <span class="${qe==="pt"?"text-amber-400":"text-zinc-400"}">PT</span>
                </button>
                <button class="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${qe==="en"?"bg-amber-500/20 border-amber-500 ring-1 ring-amber-500/50":"bg-zinc-800 border-zinc-700 hover:border-zinc-500"} border" data-lang="en">
                    <img src="${Er.en}" class="w-5 h-5 rounded-full object-cover" alt="EN">
                    <span class="${qe==="en"?"text-amber-400":"text-zinc-400"}">EN</span>
                </button>
                <button class="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${qe==="es"?"bg-amber-500/20 border-amber-500 ring-1 ring-amber-500/50":"bg-zinc-800 border-zinc-700 hover:border-zinc-500"} border" data-lang="es">
                    <img src="${Er.es}" class="w-5 h-5 rounded-full object-cover" alt="ES">
                    <span class="${qe==="es"?"text-amber-400":"text-zinc-400"}">ES</span>
                </button>
            </div>
    ...
    `;Aa(r,"max-w-xs");const i=f=>{qe=f;const w=Qo[f],T=document.getElementById("share-modal-title"),C=document.getElementById("share-modal-subtitle"),P=document.getElementById("btn-close-share");T&&(T.textContent=w.title),C&&(C.textContent=w.subtitle),P&&(P.textContent=w.later),document.querySelectorAll(".lang-btn").forEach(N=>{const _=N.dataset.lang,B=N.querySelector("span");_===f?(N.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-amber-500/20 border-amber-500 ring-1 ring-amber-500/50 border",B&&(B.className="text-amber-400")):(N.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-zinc-800 border-zinc-700 hover:border-zinc-500 border",B&&(B.className="text-zinc-400"))})};document.querySelectorAll(".lang-btn").forEach(f=>{f.addEventListener("click",()=>i(f.dataset.lang))});const s=async f=>{if(!c.userAddress)return!1;try{const T=await(await fetch("https://us-central1-backchain-backand.cloudfunctions.net/trackShare",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({address:c.userAddress,gameId:y.gameId||Date.now(),type:"fortune",platform:f})})).json();return T.success?(x(`🎉 +${T.pointsAwarded||Vr} Airdrop Points!`,"success"),!0):(T.reason==="already_shared"&&console.log("Already shared this game"),!1)}catch(w){return console.error("Share tracking error:",w),x(`🎉 +${Vr} Airdrop Points!`,"success"),!0}},o=async(f,w)=>{await s(f),window.open(w,"_blank"),Ie()};(l=document.getElementById("share-twitter"))==null||l.addEventListener("click",()=>{const f=n();o("twitter",`https://twitter.com/intent/tweet?text=${encodeURIComponent(f)}`)}),(d=document.getElementById("share-telegram"))==null||d.addEventListener("click",()=>{const f=n();o("telegram",`https://t.me/share/url?url=https://backcoin.org&text=${encodeURIComponent(f)}`)}),(u=document.getElementById("share-whatsapp"))==null||u.addEventListener("click",()=>{const f=n();o("whatsapp",`https://wa.me/?text=${encodeURIComponent(f)}`)}),(m=document.getElementById("share-instagram"))==null||m.addEventListener("click",async()=>{const f=n();try{await navigator.clipboard.writeText(f),await s("instagram");const w=`
               ...
               ${b?"":'onclick="return false;"'}>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex gap-1">
                        ${(s?me:[me[2]]).map((w,T)=>{const C=l[T],P=o[T];return`
    ...
    `,document.head.appendChild(e)}async function ma(){var e;z.isConnected=c.isConnected,z.user=null,z.userSubmissions=[],z.platformUsage={},z.isBanned=!1;try{const t=await si();if(z.systemConfig=t.config,z.leaderboards=t.leaderboards,z.dailyTasks=t.dailyTasks||[],z.platformUsageConfig=t.platformUsageConfig||ad,z.isConnected&&c.userAddress){const[a,n]=await Promise.all([ha(c.userAddress),Pu()]);if(z.user=a,z.userSubmissions=n,a&&a.isBanned){z.isBanned=!0;return}try{typeof No=="function"&&(z.platformUsage=await No()||{})}catch(r){console.warn("Could not load platform usage:",r),z.platformUsage={}}z.dailyTasks.length>0&&(z.dailyTasks=await Promise.all(z.dailyTasks.map(async r=>{try{if(!r.id)return{...r,eligible:!1,timeLeftMs:0};const i=await Yl(r.id,r.cooldownHours);return{...r,eligible:i.eligible,timeLeftMs:i.timeLeft}}catch{return{...r,eligible:!1,timeLeftMs:0}}})))}}catch(t){if(console.error("Airdrop Data Load Error:",t),t.code==="permission-denied"||(e=t.message)!=null&&e.includes("permission")){console.warn("Firebase permissions issue - user may need to connect wallet or sign in"),z.systemConfig=z.systemConfig||{},z.leaderboards=z.leaderboards||{top100ByPoints:[],top100ByPosts:[]},z.dailyTasks=z.dailyTasks||[];return}x("Error loading data. Please refresh.","error")}}function kf(e){if(!z.user||!e||e.length===0)return null;const t=e.findIndex(a=>{var n,r;return((n=a.walletAddress)==null?void 0:n.toLowerCase())===((r=z.user.walletAddress)==null?void 0:r.toLowerCase())});return t>=0?t+1:null}function Ef(e){return e?e<=5?pt[0]:e<=25?pt[1]:e<=75?pt[2]:e<=200?pt[3]:null:null}function nd(){var l;const{user:e}=z,t=(e==null?void 0:e.totalPoints)||0,a=(e==null?void 0:e.platformUsagePoints)||0,n=(e==null?void 0:e.approvedSubmissionsCount)||0,r=wf(n),i=((l=z.leaderboards)==null?void 0:l.top100ByPosts)||[],s=kf(i),o=Ef(s);return`
        <!-- Mobile Header -->
    ...
    `}function Cf(){var s;const e=z.platformUsageConfig||ad,t=z.platformUsage||{};let a=0,n=0;Object.keys(e).forEach(o=>{var l;e[o].enabled!==!1&&e[o].maxCount&&(a+=e[o].maxCount,n+=Math.min(((l=t[o])==null?void 0:l.count)||0,e[o].maxCount))});const r=a>0?n/a*100:0,i=((s=z.user)==null?void 0:s.platformUsagePoints)||0;return`
        <div class="space-y-4">
            <!-- Info Banner -->
    ...
    `}function Af(){const{user:e,userSubmissions:t}=z;if(!z.isConnected)return`
        ...
        `;const a=Date.now(),n=td*60*60*1e3,r=t.filter(l=>["pending","auditing"].includes(l.status)&&l.submittedAt&&a-l.submittedAt.getTime()>=n),i=(e==null?void 0:e.approvedSubmissionsCount)||0,s=t.filter(l=>["pending","auditing"].includes(l.status)).length,o=t.filter(l=>l.status==="rejected").length;return`
    ...
    `}function Pf(){var u,m;const e=((u=z.leaderboards)==null?void 0:u.top100ByPosts)||[],t=((m=z.leaderboards)==null?void 0:m.top100ByPoints)||[],a=z.activeRanking||"posts";function n(p,b,f){var B,I;const w=z.user&&((B=p.walletAddress)==null?void 0:B.toLowerCase())===((I=z.user.walletAddress)==null?void 0:I.toLowerCase()),T=zf(b+1),C=f==="posts"?"bg-amber-500/10":"bg-green-500/10",P=f==="posts"?"text-amber-400":"text-green-400",N=f==="posts"?"text-white":"text-green-400",_=f==="posts"?"posts":"pts";return`
            <div class="flex items-center justify-between p-3 ${w?C:"hover:bg-zinc-800/50"} transition-colors">
                ...
                <span class="font-bold ${N} text-sm">${(p.value||0).toLocaleString()} <span class="text-zinc-500 text-xs">${_}</span></span>
            </div>
...
(This will reset their rejection count to 0)`;if(!window.confirm(r))return;const i=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await Xl(a,n),x(`User ${n?"BANNED":"UNBANNED"}.`,"success");const s=A.allUsers.findIndex(o=>o.id===a);s>-1&&(A.allUsers[s].isBanned=n,A.allUsers[s].hasPendingAppeal=!1,n===!1&&(A.allUsers[s].rejectedCount=0)),vt()}catch(s){x(`Failed: ${s.message}`,"error"),t.disabled=!1,t.innerHTML=i}},Yf=async e=>{const t=e.target.closest(".resolve-appeal-btn");if(!t||t.disabled)return;const a=t.dataset.userId,r=t.dataset.action==="approve";if(!a)return;const i=r?"Are you sure you want to APPROVE this appeal and UNBAN the user?":"Are you sure you want to DENY this appeal? The user will remain banned.";if(!window.confirm(i))return;const s=t.closest("td").querySelectorAll("button"),o=new Map;s.forEach(l=>{o.set(l,l.innerHTML),l.disabled=!0,l.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>'});try{r&&await Xl(a,!1),x(`Appeal ${r?"APPROVED":"DENIED"}.`,"success");const l=A.allUsers.findIndex(d=>d.id===a);l>-1&&(A.allUsers[l].hasPendingAppeal=!1,r&&(A.allUsers[l].isBanned=!1,A.allUsers[l].rejectedCount=0)),vt()}catch(l){x(`Failed: ${l.message}`,"error"),s.forEach(d=>{d.disabled=!1,d.innerHTML=o.get(d)})}},Vf=async e=>{const t=e.target.closest(".re-approve-btn");if(!t||t.disabled)return;const a=t.dataset.submissionId,n=t.dataset.userId;if(!a||!n)return;const r=t.closest("tr");r&&(r.style.opacity="0.5"),t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await ql(n,a,"approved"),x("Submission re-approved!","success"),A.selectedUserSubmissions=A.selectedUserSubmissions.filter(s=>s.submissionId!==a),r&&r.remove();const i=A.allUsers.findIndex(s=>s.id===n);if(i>-1){const s=A.allUsers[i];s.rejectedCount=Math.max(0,(s.rejectedCount||0)-1),vt()}if(A.selectedUserSubmissions.length===0){const s=document.querySelector("#admin-user-modal .p-6");s&&(s.innerHTML='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>')}}catch(i){x(`Failed to re-approve: ${i.message}`,"error"),r&&(r.style.opacity="1"),t.disabled=!1,t.innerHTML='<i class="fa-solid fa-check"></i> Re-Approve'}},qf=async e=>{const t=e.target.closest(".view-rejected-btn");if(!t||t.disabled)return;const a=t.dataset.userId,n=t.dataset.wallet;if(a){A.selectedWallet=n,A.isSubmissionsModalOpen=!0,Ar(!0,[]);try{const r=await _u(a,"rejected");A.selectedUserSubmissions=r,Ar(!1,r)}catch(r){x(`Error fetching user submissions: ${r.message}`,"error"),Ar(!1,[],!0)}}},Xf=()=>{A.isSubmissionsModalOpen=!1,A.selectedUserSubmissions=[],A.selectedWallet=null;const e=document.getElementById("admin-user-modal");e&&e.remove(),document.body.style.overflow="auto"},Jf=e=>{const t=e.target.closest(".user-profile-link");if(!t)return;e.preventDefault();const a=t.dataset.userId;if(!a)return;const n=A.allUsers.find(r=>r.id===a);if(!n){x("Error: Could not find user data.","error");return}n0(n)},Zf=()=>{const e=document.getElementById("admin-user-profile-modal");e&&e.remove(),document.body.style.overflow="auto"},Qf=async e=>{e.preventDefault();const t=e.target;let a,n;try{if(a=new Date(t.startDate.value+"T00:00:00Z"),n=new Date(t.endDate.value+"T23:59:59Z"),isNaN(a.getTime())||isNaN(n.getTime()))throw new Error("Invalid date format.");if(a>=n)throw new Error("Start Date must be before End Date.")}catch(l){x(l.message,"error");return}const r={title:t.title.value.trim(),url:t.url.value.trim(),description:t.description.value.trim(),points:parseInt(t.points.value,10),cooldownHours:parseInt(t.cooldown.value,10),startDate:a,endDate:n};if(!r.title||!r.description){x("Please fill in Title and Description.","error");return}if(r.points<=0||r.cooldownHours<=0){x("Points and Cooldown must be positive numbers.","error");return}if(r.url&&!r.url.startsWith("http")){x("URL must start with http:// or https://","error");return}A.editingTask&&A.editingTask.id&&(r.id=A.editingTask.id);const i=t.querySelector('button[type="submit"]'),s=i.innerHTML;i.disabled=!0;const o=document.createElement("span");o.classList.add("inline-block"),i.innerHTML="",i.appendChild(o);try{await Su(r),x(`Task ${r.id?"updated":"created"} successfully!`,"success"),t.reset(),A.editingTask=null,Ea()}catch(l){x(`Failed to save task: ${l.message}`,"error"),console.error(l),i.disabled=!1,i.innerHTML=s}},e0=async e=>{e.preventDefault();const t=e.target,a={YouTube:parseInt(t.youtubePoints.value,10),"YouTube Shorts":parseInt(t.youtubeShortsPoints.value,10),Instagram:parseInt(t.instagramPoints.value,10),"X/Twitter":parseInt(t.xTwitterPoints.value,10),Facebook:parseInt(t.facebookPoints.value,10),Telegram:parseInt(t.telegramPoints.value,10),TikTok:parseInt(t.tiktokPoints.value,10),Reddit:parseInt(t.redditPoints.value,10),LinkedIn:parseInt(t.linkedinPoints.value,10),Other:parseInt(t.otherPoints.value,10)};if(Object.values(a).some(s=>isNaN(s)||s<0)){x("All points must be positive numbers (or 0).","error");return}const n=t.querySelector('button[type="submit"]'),r=n.innerHTML;n.disabled=!0;const i=document.createElement("span");i.classList.add("inline-block"),n.innerHTML="",n.appendChild(i);try{await Bu(a),x("UGC Base Points updated successfully!","success"),A.ugcBasePoints=a}catch(s){x(`Failed to update points: ${s.message}`,"error"),console.error(s)}finally{document.body.contains(n)&&(n.disabled=!1,n.innerHTML=r)}},t0=e=>{const t=A.dailyTasks.find(a=>a.id===e);t&&(A.editingTask=t,Sa())},a0=async e=>{if(window.confirm("Are you sure you want to delete this task permanently?"))try{await $u(e),x("Task deleted.","success"),A.editingTask=null,Ea()}catch(t){x(`Failed to delete task: ${t.message}`,"error"),console.error(t)}};function Ar(e,t,a=!1){var s,o;const n=document.getElementById("admin-user-modal");n&&n.remove(),document.body.style.overflow="hidden";let r="";e?r='<div class="p-8"></div>':a?r='<p class="text-red-400 text-center p-8">Failed to load submissions.</p>':t.length===0?r='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>':r=`
     ...
     `;document.body.insertAdjacentHTML("beforeend",n),(r=document.getElementById("close-admin-profile-modal-btn"))==null||r.addEventListener("click",Zf)}const r0=e=>{const t=e.target.closest(".user-filter-btn");!t||t.classList.contains("active")||(A.usersFilter=t.dataset.filter||"all",A.usersPage=1,vt())},i0=e=>{A.usersSearch=e.target.value,A.usersPage=1,vt()},s0=e=>{A.usersPage=e,vt()},o0=e=>{A.submissionsPage=e,yn()},l0=e=>{A.tasksPage=e,Sa()},vt=()=>{var _,B;const e=document.getElementById("manage-users-content");if(!e)return;const t=A.allUsers;if(!t)return;const n=(A.usersSearch||"").toLowerCase().trim().replace(/[^a-z0-9x]/g,""),r=A.usersFilter;let i=t;n&&(i=i.filter(I=>{var S,F;return((S=I.walletAddress)==null?void 0:S.toLowerCase().includes(n))||((F=I.id)==null?void 0:F.toLowerCase().includes(n))})),r==="banned"?i=i.filter(I=>I.isBanned):r==="appealing"&&(i=i.filter(I=>I.hasPendingAppeal===!0));const s=t.length,o=t.filter(I=>I.isBanned).length,l=t.filter(I=>I.hasPendingAppeal===!0).length,d=i.sort((I,S)=>I.hasPendingAppeal!==S.hasPendingAppeal?I.hasPendingAppeal?-1:1:I.isBanned!==S.isBanned?I.isBanned?-1:1:(S.totalPoints||0)-(I.totalPoints||0)),u=A.usersPage,m=A.usersPerPage,p=d.length,b=Math.ceil(p/m),f=(u-1)*m,w=u*m,T=d.slice(f,w),C=T.length>0?T.map(I=>{let S="border-b border-border-color hover:bg-zinc-800/50",F="";return I.hasPendingAppeal?(S+=" bg-yellow-900/40",F='<span class="ml-2 text-xs font-bold text-yellow-300">[APPEALING]</span>'):I.isBanned&&(S+=" bg-red-900/30 opacity-70",F='<span class="ml-2 text-xs font-bold text-red-400">[BANNED]</span>'),`
        <tr class="${S}">
    ...
    `,(n=document.getElementById("ugcPointsForm"))==null||n.addEventListener("submit",e0)},Sa=()=>{var f,w,T;const e=document.getElementById("manage-tasks-content");if(!e)return;const t=A.editingTask,a=!!t,n=C=>{if(!C)return"";try{return(C.toDate?C.toDate():C instanceof Date?C:new Date(C)).toISOString().split("T")[0]}catch{return""}},r=A.tasksPage,i=A.tasksPerPage,s=[...A.dailyTasks].sort((C,P)=>{var B,I;const N=(B=C.startDate)!=null&&B.toDate?C.startDate.toDate():new Date(C.startDate||0);return((I=P.startDate)!=null&&I.toDate?P.startDate.toDate():new Date(P.startDate||0)).getTime()-N.getTime()}),o=s.length,l=Math.ceil(o/i),d=(r-1)*i,u=r*i,m=s.slice(d,u),p=m.length>0?m.map(C=>{var I,S;const P=new Date,N=(I=C.startDate)!=null&&I.toDate?C.startDate.toDate():C.startDate?new Date(C.startDate):null,_=(S=C.endDate)!=null&&S.toDate?C.endDate.toDate():C.endDate?new Date(C.endDate):null;let B="text-zinc-500";return N&&_&&(P>=N&&P<=_?B="text-green-400":P<N&&(B="text-blue-400")),`
    ...
    `;const b=document.getElementById("admin-tasks-pagination");b&&l>1&&li(b,A.tasksPage,l,l0),(f=document.getElementById("taskForm"))==null||f.addEventListener("submit",Qf),(w=document.getElementById("cancelEditBtn"))==null||w.addEventListener("click",()=>{A.editingTask=null,Sa()}),(T=document.getElementById("existing-tasks-list"))==null||T.addEventListener("click",C=>{const P=C.target.closest("button[data-id]");if(!P)return;const N=P.dataset.id;P.dataset.action==="edit"&&t0(N),P.dataset.action==="delete"&&a0(N)})},yn=()=>{var m;const e=document.getElementById("submissions-content");if(!e)return;if(!A.allSubmissions||A.allSubmissions.length===0){const p=document.createElement("div");e.innerHTML=p.innerHTML;return}const t=A.submissionsPage,a=A.submissionsPerPage,n=[...A.allSubmissions].sort((p,b)=>{var f,w;return(((f=b.submittedAt)==null?void 0:f.getTime())||0)-(((w=p.submittedAt)==null?void 0:w.getTime())||0)}),r=n.length,i=Math.ceil(r/a),s=(t-1)*a,o=t*a,d=n.slice(s,o).map(p=>{var b,f;return`
        <tr class="border-b border-border-color hover:bg-zinc-800/50">
            ...
            <td class="p-3 text-xs font-semibold ${((b=rl[p.status])==null?void 0:b.color)||"text-gray-500"}">${((f=rl[p.status])==null?void 0:f.text)||p.status}</td>
            <td class="p-3 text-right">
                <div class="flex items-center justify-end gap-2">
    ...
    `;const r=document.getElementById("platform-usage-tbody");r==null||r.addEventListener("input",sl),r==null||r.addEventListener("change",sl),(i=document.getElementById("save-platform-config-btn"))==null||i.addEventListener("click",c0),(s=document.getElementById("reset-platform-config-btn"))==null||s.addEventListener("click",d0)},sl=e=>{const t=e.target;if(!t.classList.contains("platform-input")&&!t.classList.contains("platform-toggle"))return;const a=t.closest("tr"),n=a==null?void 0:a.dataset.actionKey,r=t.dataset.field;if(!n||!r)return;A.platformUsageConfig[n]||(A.platformUsageConfig[n]={...cr[n]}),r==="enabled"?A.platformUsageConfig[n].enabled=t.checked:A.platformUsageConfig[n][r]=parseInt(t.value)||0;const i=A.platformUsageConfig[n],s=a.querySelector("td:last-child");s&&(s.textContent=((i.points||0)*(i.maxCount||1)).toLocaleString())},c0=async e=>{const t=e.target.closest("button");if(!t)return;const a=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Saving...';try{await Jl(A.platformUsageConfig),x("✅ Platform Usage config saved!","success"),kn()}catch(n){console.error("Error saving platform config:",n),x("Failed to save config: "+n.message,"error")}finally{t.disabled=!1,t.innerHTML=a}},d0=async()=>{if(confirm("Are you sure you want to reset to default values? This will save immediately."))try{A.platformUsageConfig={...cr},await Jl(A.platformUsageConfig),x("✅ Config reset to defaults!","success"),kn()}catch(e){console.error("Error resetting platform config:",e),x("Failed to reset config: "+e.message,"error")}},u0=()=>{var a;const e=document.getElementById("admin-content-wrapper");if(!e)return;e.innerHTML=`
                ...
                <div class="space-y-3">
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-500 text-[10px]">${Ta(ol.airdrop.amount)} BKC</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-500 text-[10px]">${Ta(ol.liquidity.amount)} BKC</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    `,e.scrollIntoView({behavior:"smooth",block:"start"}))}const T0={render:E0,init:()=>{},update:()=>{}},se=window.ethers,C0=5*1024*1024,od="https://sepolia.arbiscan.io",I0=`${od}/tx/`,ao=`${od}/address/`,ld=["event Certified(uint256 indexed certId, address indexed owner, bytes32 documentHash, uint8 docType, address operator)"],Xe={image:{icon:"fa-regular fa-image",color:"#34d399",bg:"rgba(52,211,153,0.12)",label:"Image"},pdf:{icon:"fa-regular fa-file-pdf",color:"#f87171",bg:"rgba(248,113,113,0.12)",label:"PDF"},audio:{icon:"fa-solid fa-music",color:"#a78bfa",bg:"rgba(167,139,250,0.12)",label:"Audio"},video:{icon:"fa-regular fa-file-video",color:"#60a5fa",bg:"rgba(96,165,250,0.12)",label:"Video"},document:{icon:"fa-regular fa-file-word",color:"#60a5fa",bg:"rgba(96,165,250,0.12)",label:"Document"},spreadsheet:{icon:"fa-regular fa-file-excel",color:"#4ade80",bg:"rgba(74,222,128,0.12)",label:"Spreadsheet"},code:{icon:"fa-solid fa-code",color:"#22d3ee",bg:"rgba(34,211,238,0.12)",label:"Code"},archive:{icon:"fa-regular fa-file-zipper",color:"#facc15",bg:"rgba(250,204,21,0.12)",label:"Archive"},default:{icon:"fa-regular fa-file",color:"#fbbf24",bg:"rgba(251,191,36,0.12)",label:"File"}},E={view:"documents",activeTab:"documents",viewHistory:[],wizStep:1,wizFile:null,wizFileHash:null,wizDescription:"",wizDuplicateCheck:null,wizIsHashing:!1,wizIpfsCid:null,wizUploadDate:null,bkcFee:0n,ethFee:0n,feesLoaded:!1,certificates:[],certsLoading:!1,selectedCert:null,verifyFile:null,verifyHash:null,verifyResult:null,verifyIsChecking:!1,stats:null,totalSupply:0,recentNotarizations:[],statsLoading:!1,isProcessing:!1,processStep:"",isLoading:!1,contractAvailable:!0};function Ha(e="",t=""){const a=e.toLowerCase(),n=t.toLowerCase();return a.includes("image")||/\.(jpg|jpeg|png|gif|webp|svg|bmp|ico)$/.test(n)?Xe.image:a.includes("pdf")||n.endsWith(".pdf")?Xe.pdf:a.includes("audio")||/\.(mp3|wav|ogg|flac|aac|m4a)$/.test(n)?Xe.audio:a.includes("video")||/\.(mp4|avi|mov|mkv|webm|wmv)$/.test(n)?Xe.video:a.includes("word")||a.includes("document")||/\.(doc|docx|odt|rtf)$/.test(n)?Xe.document:a.includes("sheet")||a.includes("excel")||/\.(xls|xlsx|csv|ods)$/.test(n)?Xe.spreadsheet:/\.(js|ts|py|java|cpp|c|h|html|css|json|xml|sol|rs|go|php|rb)$/.test(n)?Xe.code:a.includes("zip")||a.includes("archive")||/\.(zip|rar|7z|tar|gz)$/.test(n)?Xe.archive:Xe.default}function cd(e){if(!e)return"";let t;if(typeof e=="number")t=new Date(e>1e12?e:e*1e3);else if(typeof e=="string")t=new Date(e);else if(e!=null&&e.toDate)t=e.toDate();else if(e!=null&&e.seconds)t=new Date(e.seconds*1e3);else return"";if(isNaN(t.getTime()))return"";const a=new Date,n=a-t,r=Math.floor(n/6e4),i=Math.floor(n/36e5),s=Math.floor(n/864e5);return r<1?"Just now":r<60?`${r}m`:i<24?`${i}h`:s<7?`${s}d`:t.toLocaleDateString("en-US",{month:"short",day:"numeric",year:t.getFullYear()!==a.getFullYear()?"numeric":void 0})}function no(e){if(!e)return"";const t=typeof e=="number"?new Date(e>1e12?e:e*1e3):new Date(e);return isNaN(t.getTime())?"":t.toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"2-digit",minute:"2-digit"})}function ro(e){return e?`${e.slice(0,6)}...${e.slice(-4)}`:""}function dd(e){return e?e.startsWith("https://")?e:e.startsWith("ipfs://")?`${un[0]}${e.replace("ipfs://","")}`:`${un[0]}${e}`:""}function io(e){return e<1024?`${e} B`:e<1048576?`${(e/1024).toFixed(1)} KB`:`${(e/1048576).toFixed(2)} MB`}function A0(e,t){E.viewHistory.push({view:E.view,data:E.selectedCert}),E.view=e,t&&(E.selectedCert=t),pe(),fa()}function ud(){const e=E.viewHistory.pop();e?(E.view=e.view,E.activeTab=e.view==="cert-detail"?"documents":e.view,E.selectedCert=e.data):(E.view="documents",E.activeTab="documents"),pe(),fa()}function P0(e){E.activeTab===e&&E.view===e||(E.viewHistory=[],E.view=e,E.activeTab=e,pe(),fa())}function z0(){if(document.getElementById("notary-styles-v10"))return;const e=document.createElement("style");e.id="notary-styles-v10",e.textContent=`
        :root {
            --nt-bg:       #0c0c0e;
            --nt-bg2:      #141417;
            --nt-bg3:      #1c1c21;
    ...
    `,fa(),pe(),Promise.all([U0(),so(),W0()]).catch(()=>{}))}function fa(){var t;const e=document.getElementById("nt-header");if(e){if(E.view==="cert-detail"){e.innerHTML=`
    ...
    `}}function pe(){const e=document.getElementById("nt-content");if(e)switch(E.view){case"documents":ll(e);break;case"notarize":S0(e);break;case"verify":M0(e);break;case"stats":O0(e);break;case"cert-detail":H0(e);break;default:ll(e)}}function ll(e){if(!c.isConnected){e.innerHTML=`
        ...
        <div class="nt-cert-grid">
            ${E.certificates.map(t=>N0(t)).join("")}
        </div>
    `}function N0(e){var i,s;const t=dd(e.ipfs),a=Ha(e.mimeType||"",e.description||e.fileName||""),n=cd(e.timestamp),r=((i=e.description)==null?void 0:i.split("---")[0].trim().split(`
`)[0].trim())||"Notarized Document";return`
    ...
    `;const t=document.getElementById("nt-wiz-panel");if(t)switch(E.wizStep){case 1:L0(t);break;case 2:pd(t);break;case 3:_0(t);break}}function $0(){const e=E.wizStep;return`
        <div class="nt-steps">
    ...
    `}function L0(e){if(E.wizFile&&E.wizFileHash){const t=E.wizFile,a=Ha(t.type,t.name),n=E.wizDuplicateCheck;e.innerHTML=`
    ...
    `,R0()}function R0(){const e=document.getElementById("nt-wiz-dropzone"),t=document.getElementById("nt-wiz-file-input");!e||!t||(e.onclick=()=>t.click(),["dragenter","dragover","dragleave","drop"].forEach(a=>{e.addEventListener(a,n=>{n.preventDefault(),n.stopPropagation()})}),e.addEventListener("dragenter",()=>e.classList.add("drag-over")),e.addEventListener("dragover",()=>e.classList.add("drag-over")),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",a=>{var n,r;e.classList.remove("drag-over"),cl((r=(n=a.dataTransfer)==null?void 0:n.files)==null?void 0:r[0])}),t.addEventListener("change",a=>{var n;return cl((n=a.target.files)==null?void 0:n[0])}))}async function cl(e){if(e){if(e.size>C0){x("File too large (max 5MB)","error");return}E.wizFile=e,E.wizFileHash=null,E.wizDuplicateCheck=null,E.wizIsHashing=!0,pe();try{const t=await Ge.calculateFileHash(e);E.wizFileHash=t,E.wizIsHashing=!1,pe(),E.wizDuplicateCheck=null,pe();const a=await Ge.verifyByHash(t);E.wizDuplicateCheck=a,pe()}catch(t){console.error("[NotaryPage] Hash error:",t),E.wizIsHashing=!1,E.wizFile=null,x("Error computing file hash","error"),pe()}}}function pd(e){const t=E.wizFile,a=Ha((t==null?void 0:t.type)||"",(t==null?void 0:t.name)||""),n=E.feesLoaded?se?se.formatEther(E.bkcFee):"1":"...",r=E.feesLoaded?se?se.formatEther(E.ethFee):"0.0001":"...",i=c.currentUserBalance||0n,s=c.currentUserNativeBalance||0n,o=E.feesLoaded?i>=E.bkcFee:!0,l=E.feesLoaded?s>=E.ethFee+((se==null?void 0:se.parseEther("0.001"))||0n):!0,d=o&&l;e.innerHTML=`
    ...
    `}function _0(e){const t=E.wizFile,a=Ha((t==null?void 0:t.type)||"",(t==null?void 0:t.name)||""),n=E.wizDescription||"No description",r=se?se.formatEther(E.bkcFee):"1",i=se?se.formatEther(E.ethFee):"0.0001";e.innerHTML=`
    ...
    `}async function F0(){if(E.isProcessing)return;E.isProcessing=!0,E.processStep="SIGNING";const e=document.getElementById("nt-btn-mint");e&&(e.disabled=!0,e.innerHTML='<i class="fa-solid fa-spinner fa-spin" style="margin-right:6px"></i>Signing...'),document.getElementById("nt-overlay"),an("signing");try{const n=await(await c.provider.getSigner()).signMessage("I am signing to authenticate my file for notarization on Backchain.");E.processStep="UPLOADING",an("uploading");const r=new FormData;r.append("file",E.wizFile),r.append("signature",n),r.append("address",c.userAddress),r.append("description",E.wizDescription||"No description");const i=Ke.uploadFileToIPFS||"/api/upload",s=await fetch(i,{method:"POST",body:r,signal:AbortSignal.timeout(18e4)});if(!s.ok)throw s.status===413?new Error("File too large (max 5MB)"):s.status===401?new Error("Signature verification failed"):new Error(`Upload failed (${s.status})`);const o=await s.json(),l=o.ipfsUri||o.metadataUri,d=o.contentHash||E.wizFileHash;if(!l)throw new Error("No IPFS URI returned");if(!d)throw new Error("No content hash returned");E.processStep="MINTING",an("minting"),await Ge.notarize({ipfsCid:l,contentHash:d,description:E.wizDescription||"No description",operator:Q(),button:e,onSuccess:(u,m,p)=>{E.processStep="SUCCESS",an("success",m),setTimeout(()=>{zr(),E.wizFile=null,E.wizFileHash=null,E.wizDescription="",E.wizDuplicateCheck=null,E.wizStep=1,E.isProcessing=!1,E.view="documents",E.activeTab="documents",fa(),pe(),so(),x("Document notarized successfully!","success")},3e3)},onError:u=>{if(u.cancelled||u.type==="user_rejected"){E.isProcessing=!1,zr(),e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-stamp" style="margin-right:6px"></i>Sign & Mint');return}throw u}})}catch(t){console.error("[NotaryPage] Mint error:",t),zr(),E.isProcessing=!1,e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-stamp" style="margin-right:6px"></i>Sign & Mint'),t.code!==4001&&t.code!=="ACTION_REJECTED"&&x(t.message||"Notarization failed","error")}}function an(e,t){const a=document.getElementById("nt-overlay");if(!a)return;a.classList.add("active");const n={signing:{icon:"fa-solid fa-signature",text:"Signing message...",sub:"Confirm in MetaMask",pct:10},uploading:{icon:"fa-solid fa-cloud-arrow-up",text:"Uploading to IPFS...",sub:"Decentralized storage",pct:35},minting:{icon:"fa-solid fa-stamp",text:"Minting on Blockchain...",sub:"Waiting for confirmation",pct:65,animate:!0},success:{icon:"fa-solid fa-check",text:"Notarized!",sub:t?`Token ID #${t}`:"Certificate created",pct:100,success:!0}},r=n[e]||n.signing;if(a.innerHTML=`
    ...
    `,D0(),E.verifyResult&&md()}function D0(){const e=document.getElementById("nt-verify-dropzone"),t=document.getElementById("nt-verify-file-input");!e||!t||(e.onclick=()=>t.click(),["dragenter","dragover","dragleave","drop"].forEach(a=>{e.addEventListener(a,n=>{n.preventDefault(),n.stopPropagation()})}),e.addEventListener("dragenter",()=>e.classList.add("drag-over")),e.addEventListener("dragover",()=>e.classList.add("drag-over")),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",a=>{var n,r;e.classList.remove("drag-over"),dl((r=(n=a.dataTransfer)==null?void 0:n.files)==null?void 0:r[0])}),t.addEventListener("change",a=>{var n;return dl((n=a.target.files)==null?void 0:n[0])}))}async function dl(e){if(!e)return;E.verifyFile=e,E.verifyHash=null,E.verifyResult=null,E.verifyIsChecking=!0;const t=document.getElementById("nt-verify-result");t&&(t.innerHTML=`
        ...
        `);try{const a=await Ge.calculateFileHash(e);E.verifyHash=a;const n=await Ge.verifyByHash(a);E.verifyResult=n,E.verifyIsChecking=!1,md()}catch(a){console.error("[NotaryPage] Verify error:",a),E.verifyIsChecking=!1,t&&(t.innerHTML=`
            ...
            `)}}function md(){const e=document.getElementById("nt-verify-result");if(!e||!E.verifyResult)return;const t=E.verifyResult,a=E.verifyFile;t.exists?e.innerHTML=`
        ...
        `}function O0(e){if(E.statsLoading&&!E.stats){e.innerHTML=`
                ...
                <div id="nt-recent-feed">
                    ...
                    `:E.recentNotarizations.map(n=>`
                        <div class="nt-recent-item">
                            ...
                            <div style="text-align:right;flex-shrink:0">
                                <div style="font-size:11px;color:var(--nt-text-3)">${cd(n.timestamp)}</div>
                            </div>
                        </div>
                    `).join("")}
                </div>
    ...
    `}function H0(e){var r;const t=E.selectedCert;if(!t){ud();return}const a=dd(t.ipfs),n=Ha(t.mimeType||"",t.description||"");(t.mimeType||"").includes("image")||/\.(jpg|jpeg|png|gif|webp|svg|bmp)$/i.test(t.fileName||t.description||""),e.innerHTML=`
    ...
    `}async function U0(){try{const e=await Ge.getFee();E.bkcFee=e.bkcFee,E.ethFee=e.ethFee,E.feesLoaded=!0}catch{E.bkcFee=(se==null?void 0:se.parseEther("1"))||0n,E.ethFee=(se==null?void 0:se.parseEther("0.0001"))||0n,E.feesLoaded=!0}}async function so(){if(!c.isConnected||!c.userAddress)return;E.certsLoading=!0,pe();let e=!1;try{const t=Ke.getNotaryHistory;console.log("[NotaryPage] Loading certificates from API:",`${t}/${c.userAddress}`);const a=await fetch(`${t}/${c.userAddress}`);if(!a.ok)throw new Error(`API ${a.status}`);const n=await a.json();console.log("[NotaryPage] API response:",typeof n,Array.isArray(n)?`array(${n.length})`:JSON.stringify(n).substring(0,200));const r=Array.isArray(n)?n:Array.isArray(n==null?void 0:n.documents)?n.documents:Array.isArray(n==null?void 0:n.data)?n.data:Array.isArray(n==null?void 0:n.history)?n.history:null;r&&r.length>0&&(E.certificates=r.map(i=>({id:i.tokenId||i.id||"?",ipfs:i.ipfsCid||i.ipfsUri||"",description:i.description||"",hash:i.contentHash||"",timestamp:i.createdAt||i.timestamp||"",txHash:i.txHash||i.transactionHash||"",owner:i.owner||c.userAddress,mimeType:i.mimeType||"",fileName:i.fileName||""})).sort((i,s)=>parseInt(s.id)-parseInt(i.id)),e=!0,console.log("[NotaryPage] Loaded",E.certificates.length,"certificates from API"))}catch(t){console.warn("[NotaryPage] API failed:",t.message)}if(!e){console.log("[NotaryPage] Trying on-chain event fallback...");try{const t=await j0();E.certificates=t,console.log("[NotaryPage] Loaded",t.length,"certificates from chain events")}catch(t){console.error("[NotaryPage] Chain fallback also failed:",t),E.certificates=[]}}E.certsLoading=!1,pe()}async function j0(){if(!se||!(v!=null&&v.notary))return console.warn("[NotaryPage] Chain fallback: missing ethers or contract address"),[];const{NetworkManager:e}=await O(async()=>{const{NetworkManager:o}=await Promise.resolve().then(()=>J);return{NetworkManager:o}},void 0),t=e.getProvider();if(!t)return console.warn("[NotaryPage] Chain fallback: no provider available"),[];console.log("[NotaryPage] Querying Certified events for:",c.userAddress);const a=new se.Contract(v.notary,ld,t),n=a.filters.Certified(null,c.userAddress),r=await t.getBlockNumber(),i=Math.max(0,r-5e4);console.log("[NotaryPage] Block range:",i,"->",r);const s=await a.queryFilter(n,i,r);return console.log("[NotaryPage] Found",s.length,"events"),s.map(o=>({id:Number(o.args.certId),hash:o.args.documentHash||"",docType:Number(o.args.docType||0),timestamp:null,txHash:o.transactionHash,owner:o.args.owner})).sort((o,l)=>l.id-o.id)}async function W0(){E.statsLoading=!0;try{const[e,t]=await Promise.all([Ge.getStats(),Ge.getTotalDocuments()]);E.stats=e,E.totalSupply=t}catch(e){console.warn("[NotaryPage] Stats load error:",e)}try{await G0()}catch{}E.statsLoading=!1,E.view==="stats"&&pe()}async function G0(){if(!se||!(v!=null&&v.notary))return;const{NetworkManager:e}=await O(async()=>{const{NetworkManager:l}=await Promise.resolve().then(()=>J);return{NetworkManager:l}},void 0),t=e.getProvider();if(!t)return;const a=new se.Contract(v.notary,ld,t),n=a.filters.Certified(),r=await t.getBlockNumber(),i=Math.max(0,r-5e3),o=(await a.queryFilter(n,i,r)).slice(-20).reverse();E.recentNotarizations=o.map(l=>({tokenId:Number(l.args.certId),owner:l.args.owner,hash:l.args.documentHash,docType:Number(l.args.docType||0),timestamp:null,blockNumber:l.blockNumber}));try{const l=[...new Set(o.map(u=>u.blockNumber))],d={};await Promise.all(l.slice(0,10).map(async u=>{const m=await t.getBlock(u);m&&(d[u]=m.timestamp)})),E.recentNotarizations.forEach(u=>{d[u.blockNumber]&&(u.timestamp=d[u.blockNumber])})}catch{}}async function K0(e,t){var a,n;try{const r=l=>{var u;if(!l)return"";if(l.startsWith("https://")&&!l.includes("/ipfs/"))return l;const d=l.startsWith("ipfs://")?l.replace("ipfs://",""):l.includes("/ipfs/")?(u=l.split("/ipfs/")[1])==null?void 0:u.split("?")[0]:"";return d?`${un[0]}${d}`:l};let i=r(t||"");if(c.notaryContract)try{const l=await c.notaryContract.tokenURI(e);if(l!=null&&l.startsWith("data:application/json;base64,")){const d=JSON.parse(atob(l.replace("data:application/json;base64,","")));d.image&&(i=r(d.image))}}catch{}const s=(v==null?void 0:v.notary)||((a=c.notaryContract)==null?void 0:a.target)||((n=c.notaryContract)!=null&&n.getAddress?await c.notaryContract.getAddress():null);if(!s){x("Contract address not found","error");return}x(`Adding NFT #${e} to wallet...`,"info"),await window.ethereum.request({method:"wallet_watchAsset",params:{type:"ERC721",options:{address:s,tokenId:String(e),image:i}}})&&x(`NFT #${e} added to wallet!`,"success")}catch(r){if(r.code===4001)return;x("Could not add NFT","error")}}function Y0(e){e&&navigator.clipboard.writeText(e).then(()=>{x("Hash copied!","success")}).catch(()=>{x("Failed to copy","error")})}function V0(){var e;E.wizStep===1&&E.wizFileHash&&!((e=E.wizDuplicateCheck)!=null&&e.exists)?E.wizStep=2:E.wizStep===2&&(E.wizStep=3),pe()}function q0(){E.wizStep>1&&(E.wizStep--,pe())}function X0(){const e=document.getElementById("nt-wiz-desc");e&&(E.wizDescription=e.value||""),E.wizStep=3,pe()}function J0(){E.wizFile=null,E.wizFileHash=null,E.wizDuplicateCheck=null,E.wizStep=1,pe()}function Z0(e){const t=E.certificates.find(a=>String(a.id)===String(e));t&&A0("cert-detail",t)}const fd={async render(e){e&&B0()},reset(){E.wizFile=null,E.wizFileHash=null,E.wizDescription="",E.wizDuplicateCheck=null,E.wizStep=1,E.view="documents",E.activeTab="documents",E.viewHistory=[],pe(),fa()},update(){if(!E.isProcessing&&E.view==="notarize"){const e=document.getElementById("nt-wiz-panel");e&&E.wizStep===2&&pd(e)}},refreshHistory(){so()},setTab:P0,goBack:ud,viewCert:Z0,handleMint:F0,addToWallet:K0,copyHash:Y0,wizNext:V0,wizBack:q0,wizToStep3:X0,wizRemoveFile:J0};window.NotaryPage=fd;const bd=window.ethers,Zr={Diamond:{emoji:"💎",color:"#22d3ee",bg:"rgba(34,211,238,0.15)",border:"rgba(34,211,238,0.3)",keepRate:100,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeicgip72jcqgsirlrhn3tq5cc226vmko6etnndzl6nlhqrktfikafq"},Gold:{emoji:"🥇",color:"#fbbf24",bg:"rgba(251,191,36,0.15)",border:"rgba(251,191,36,0.3)",keepRate:90,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeifponccrbicg2pcjrn2hrfoqgc77xhm2r4ld7hdpw6cxxkbsckf44"},Silver:{emoji:"🥈",color:"#9ca3af",bg:"rgba(156,163,175,0.15)",border:"rgba(156,163,175,0.3)",keepRate:75,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeihvi2inujm5zpi7tl667g4srq273536pjkglwyrtbwmgnskmu7jg4"},Bronze:{emoji:"🥉",color:"#fb923c",bg:"rgba(251,146,60,0.15)",border:"rgba(251,146,60,0.3)",keepRate:60,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeiclqidb67rt3tchhjpsib62s624li7j2bpxnr6b5w5mfp4tomhu7m"}},R={activeTab:"marketplace",filterTier:"ALL",sortBy:"boost-high",selectedListing:null,isLoading:!1,isTransactionPending:!1,countdownIntervals:[],pendingEarningsAmount:0n,marketStats:null},tt=e=>e==null?"":String(e),Q0=(e,t)=>tt(e)===tt(t),$a=(e,t)=>e&&t&&e.toLowerCase()===t.toLowerCase();function Ua(e){return be.find(t=>t.boostBips===Number(e))||{name:"Unknown",boostBips:0}}function dr(e){return Zr[e]||{emoji:"💎",color:"#71717a",bg:"rgba(113,113,122,0.15)",border:"rgba(113,113,122,0.3)",keepRate:50}}function Mt(e){if(!e)return"0";const t=parseFloat(bd.formatEther(BigInt(e)));return t===0?"0":t<1e-4?"<0.0001":t<.01?t.toFixed(4):t<1?t.toFixed(3):t.toFixed(2)}function gd(e){const t=e-Math.floor(Date.now()/1e3);if(t<=0)return{text:"Expired",expired:!0,seconds:0};const a=Math.floor(t/3600),n=Math.floor(t%3600/60),r=t%60;return a>0?{text:`${a}h ${n}m`,expired:!1,seconds:t}:n>0?{text:`${n}m ${r}s`,expired:!1,seconds:t}:{text:`${r}s`,expired:!1,seconds:t}}function eb(){if(document.getElementById("boost-market-styles"))return;const e=document.createElement("style");e.id="boost-market-styles",e.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(e)}function Qr(){const e=document.getElementById("rental");if(!e)return;eb();const t=c.rentalListings||[],a=t.filter(s=>c.isConnected&&$a(s.owner,c.userAddress)),n=Math.floor(Date.now()/1e3),r=(c.myRentals||[]).filter(s=>$a(s.tenant,c.userAddress)&&Number(s.endTime)>n),i=R.marketStats;e.innerHTML=`
        <div class="max-w-6xl mx-auto px-4 py-6">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6 bm-stats-grid">
                ...
                <div class="bm-card p-4 text-center">
                    <p class="text-2xl font-bold text-purple-400 font-mono">${i?Mt(i.totalVolume):"—"}</p>
    ...
    `,ob(),Ca()}function Ca(){const e=document.getElementById("bm-tab-content");if(e){switch(R.activeTab){case"marketplace":e.innerHTML=tb();break;case"my-listings":e.innerHTML=ab();break;case"my-rentals":e.innerHTML=nb();break}R.activeTab==="my-rentals"&&bb()}}function tb(){const e=c.rentalListings||[],t=Math.floor(Date.now()/1e3);let a=e.filter(n=>!(n.isRented||n.currentlyRented||n.rentalEndTime&&Number(n.rentalEndTime)>t||R.filterTier!=="ALL"&&Ua(n.boostBips).name!==R.filterTier));return a.sort((n,r)=>{const i=BigInt(n.pricePerHour||0),s=BigInt(r.pricePerHour||0);return R.sortBy==="price-low"?i<s?-1:i>s?1:0:R.sortBy==="price-high"?i>s?-1:i<s?1:0:(r.boostBips||0)-(n.boostBips||0)}),`
        <div>
            ...
            <!-- NFT Grid -->
            ${a.length===0?oo("No NFTs Available","Be the first to list your NFT booster!"):`
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 bm-nft-grid">
                    ${a.map((n,r)=>xd(n,r,!1)).join("")}
                </div>
            `}
        </div>
    `}function xd(e,t,a=!1){const n=Ua(e.boostBips),r=dr(n.name),i=Mt(e.pricePerHour),s=tt(e.tokenId),o=c.isConnected&&$a(e.owner,c.userAddress),l=e.isRented||e.currentlyRented,d=et(e.boostBips||0);return`
    ...
    `}function ab(){if(!c.isConnected)return hd("View your listings");const e=c.rentalListings||[],t=e.filter(i=>$a(i.owner,c.userAddress)),a=new Set(e.map(i=>tt(i.tokenId))),n=(c.myBoosters||[]).filter(i=>!a.has(tt(i.tokenId))),r=t.reduce((i,s)=>i+BigInt(s.totalEarnings||0),0n);return`
        <div>
            <!-- Earnings Card -->
                    ...
                    <div class="flex items-center gap-5">
                        ...
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white">
                                ${Mt(r)} <span class="text-lg text-zinc-500">ETH</span>
                            </p>
                        </div>
                    </div>
                    <div class="flex flex-wrap gap-3 items-center">
                        ...
                        <div class="bm-card p-4 text-center min-w-[120px]" style="border-color: rgba(251,191,36,0.2);">
                            <p class="text-xl font-bold text-amber-400 font-mono" id="bm-pending-amount">
                                ${R.pendingEarningsAmount>0n?Mt(R.pendingEarningsAmount):"0"}
                            </p>
            ...
            <!-- My Listed NFTs -->
            ${t.length===0?oo("No Listings Yet","List your first NFT to start earning ETH!"):`
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 bm-nft-grid">
    ...
    `}function nb(){if(!c.isConnected)return hd("View your active rentals");const e=Math.floor(Date.now()/1e3),t=(c.myRentals||[]).filter(a=>$a(a.tenant,c.userAddress)&&Number(a.endTime)>e);return`
        <div>
            ...
            <!-- Active Rentals -->
            ${t.length===0?oo("No Active Rentals","Rent an NFT booster to keep more staking rewards!"):`
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    ${t.map((a,n)=>rb(a,n)).join("")}
                </div>
            `}
        </div>
    `}function rb(e,t){const a=Ua(e.boostBips),n=dr(a.name),r=gd(Number(e.endTime)),i=et(e.boostBips||0);let s="active";return r.seconds<3600?s="critical":r.seconds<7200&&(s="warning"),`
        <div class="bm-card p-5" style="animation: bm-card-in 0.5s ease-out ${t*60}ms forwards; opacity: 0;">
            ...
            <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-zinc-500">Token #${tt(e.tokenId)}</p>
                </div>
            </div>
    ...
    `}function ib(){const e=c.rentalListings||[],t=new Set(e.map(n=>tt(n.tokenId)));return`
                ...
                <div class="p-5 space-y-5">
                    <div>
                        ...
                        <select id="bm-list-select" class="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-4 py-3 text-white outline-none">
                            ...
                            ${(c.myBoosters||[]).filter(n=>!t.has(tt(n.tokenId))).map(n=>{const r=Ua(n.boostBips),i=dr(r.name);return`<option value="${n.tokenId}">${i.emoji} ${r.name} Booster #${n.tokenId}</option>`}).join("")}
                        </select>
                    </div>
                    <div>
    ...
    `}let Lt=null,Rt=null;function ob(){Lt&&document.removeEventListener("click",Lt),Rt&&document.removeEventListener("change",Rt),Lt=e=>{const t=e.target,a=t.closest(".bm-tab");if(a){R.activeTab=a.dataset.tab,document.querySelectorAll(".bm-tab").forEach(o=>o.classList.remove("active")),a.classList.add("active"),Ca();return}const n=t.closest(".bm-filter");if(n){R.filterTier=n.dataset.filter,Ca();return}if(t.closest("#bm-open-list")){lb();return}if(t.closest(".bm-close-list")){vd();return}if(t.closest(".bm-close-rent")){wd();return}if(t.closest("#bm-confirm-list")){ub();return}if(t.closest("#bm-confirm-rent")){db();return}const r=t.closest(".bm-rent-btn");if(r&&!r.disabled){cb(r.dataset.id);return}const i=t.closest(".bm-withdraw-btn");if(i&&!i.disabled){pb(i);return}const s=t.closest(".bm-share-btn");if(s){fb(s.dataset.id);return}if(t.closest("#bm-withdraw-earnings")){mb();return}if(t.classList.contains("bm-modal")){t.classList.remove("active"),R.selectedListing=null;return}},Rt=e=>{e.target.id==="bm-sort"&&(R.sortBy=e.target.value,Ca())},document.addEventListener("click",Lt),document.addEventListener("change",Rt)}function lb(){const e=document.getElementById("bm-modal-list");e&&e.classList.add("active")}function vd(){const e=document.getElementById("bm-modal-list");e&&e.classList.remove("active")}function cb(e){const t=(c.rentalListings||[]).find(d=>Q0(d.tokenId,e));if(!t)return;R.selectedListing=t;const a=Ua(t.boostBips),n=dr(a.name),r=Mt(t.pricePerHour),i=et(t.boostBips||0),s=document.getElementById("bm-rent-modal-body");if(!s)return;s.innerHTML=`
        ...
        <div class="space-y-4 mb-5">
            <div class="flex justify-between text-sm">
                ...
                <span class="text-white font-bold">${r} ETH</span>
            </div>
            <div class="flex justify-between text-sm">
    ...
    `;const o=document.getElementById("bm-rent-hours"),l=async()=>{const d=parseInt(o.value)||1;try{const u=await nt.getRentalCost(e,d);document.getElementById("bm-cost-rental").textContent=`${u.rentalCostFormatted} ETH`,document.getElementById("bm-cost-fee").textContent=`${u.ethFeeFormatted} ETH`,document.getElementById("bm-cost-total").textContent=`${u.totalCostFormatted} ETH`}catch{const m=BigInt(t.pricePerHour||0)*BigInt(d);document.getElementById("bm-cost-rental").textContent=`${Mt(m)} ETH`,document.getElementById("bm-cost-fee").textContent="~fee",document.getElementById("bm-cost-total").textContent=`~${Mt(m)} ETH`}};l(),o.addEventListener("input",l),document.getElementById("bm-modal-rent").classList.add("active")}function wd(){const e=document.getElementById("bm-modal-rent");e&&e.classList.remove("active"),R.selectedListing=null}async function db(){if(R.isTransactionPending||!R.selectedListing)return;const e=parseInt(document.getElementById("bm-rent-hours").value)||1,t=tt(R.selectedListing.tokenId),a=document.getElementById("bm-confirm-rent");R.isTransactionPending=!0;try{await nt.rent({tokenId:t,hours:e,button:a,onSuccess:async()=>{R.isTransactionPending=!1,wd(),x("NFT Rented Successfully!","success"),await ra()},onError:n=>{R.isTransactionPending=!1,!n.cancelled&&n.type!=="user_rejected"&&x("Failed: "+(n.message||"Error"),"error")}})}catch(n){R.isTransactionPending=!1,!n.cancelled&&n.type!=="user_rejected"&&x("Failed: "+(n.message||"Error"),"error")}}async function ub(){if(R.isTransactionPending)return;const e=document.getElementById("bm-list-select").value,t=document.getElementById("bm-list-price").value,a=parseInt(document.getElementById("bm-list-min").value)||1,n=parseInt(document.getElementById("bm-list-max").value)||168;if(!e){x("Select an NFT","error");return}if(!t||parseFloat(t)<=0){x("Enter valid price","error");return}if(a>n){x("Min hours must be <= max hours","error");return}const r=document.getElementById("bm-confirm-list");R.isTransactionPending=!0;try{await nt.list({tokenId:e,pricePerHour:bd.parseEther(t),minHours:a,maxHours:n,button:r,onSuccess:async()=>{R.isTransactionPending=!1,vd(),x("NFT Listed Successfully!","success"),await ra()},onError:i=>{R.isTransactionPending=!1,!i.cancelled&&i.type!=="user_rejected"&&x("Failed: "+(i.message||"Error"),"error")}})}catch(i){R.isTransactionPending=!1,!i.cancelled&&i.type!=="user_rejected"&&x("Failed: "+(i.message||"Error"),"error")}}async function pb(e){if(R.isTransactionPending)return;const t=e.dataset.id;if(confirm("Withdraw this NFT from the marketplace?")){R.isTransactionPending=!0;try{await nt.withdraw({tokenId:t,button:e,onSuccess:async()=>{R.isTransactionPending=!1,x("NFT Withdrawn Successfully!","success"),await ra()},onError:a=>{R.isTransactionPending=!1,!a.cancelled&&a.type!=="user_rejected"&&x("Failed: "+(a.message||"Error"),"error")}})}catch(a){R.isTransactionPending=!1,!a.cancelled&&a.type!=="user_rejected"&&x("Failed: "+(a.message||"Error"),"error")}}}async function mb(){if(R.isTransactionPending||R.pendingEarningsAmount===0n)return;const e=document.getElementById("bm-withdraw-earnings");R.isTransactionPending=!0;try{await nt.withdrawEarnings({button:e,onSuccess:async()=>{R.isTransactionPending=!1,R.pendingEarningsAmount=0n,x("Earnings Withdrawn!","success"),await ra()},onError:t=>{R.isTransactionPending=!1,!t.cancelled&&t.type!=="user_rejected"&&x("Failed: "+(t.message||"Error"),"error")}})}catch(t){R.isTransactionPending=!1,!t.cancelled&&t.type!=="user_rejected"&&x("Failed: "+(t.message||"Error"),"error")}}function fb(e){const t="https://backcoin.org/#rental",a=`Rent NFT Boosters on Backchain Boost Market!

Keep up to 100% of your staking rewards by renting an NFT booster.

${t}

#Backchain #DeFi #Arbitrum #Web3`;navigator.share?navigator.share({title:"Backchain Boost Market",text:a,url:t}).catch(()=>{}):navigator.clipboard.writeText(a).then(()=>{x("Link copied to clipboard!","success")}).catch(()=>{x("Could not copy link","error")})}function bb(){R.countdownIntervals.forEach(clearInterval),R.countdownIntervals=[],document.querySelectorAll(".bm-timer[data-end]").forEach(e=>{const t=Number(e.dataset.end),a=setInterval(()=>{const n=gd(t);e.innerHTML=`<i class="fa-solid fa-clock mr-1"></i>${n.text}`,n.expired?(clearInterval(a),Ca()):n.seconds<3600?e.className="bm-timer critical":n.seconds<7200&&(e.className="bm-timer warning")},1e3);R.countdownIntervals.push(a)})}async function ra(){R.isLoading=!0;try{const e=[Ul()];c.isConnected&&(e.push(hu()),e.push(Nt()),e.push(gb())),e.push(xb()),await Promise.all(e)}catch(e){console.warn("[BoostMarket] Refresh error:",e)}R.isLoading=!1,Qr()}async function gb(){if(c.userAddress)try{const e=await nt.getPendingEarnings(c.userAddress);R.pendingEarningsAmount=e.amount}catch{R.pendingEarningsAmount=0n}}async function xb(){try{R.marketStats=await nt.getMarketplaceStats()}catch{R.marketStats=null}}function ul(){R.countdownIntervals.forEach(clearInterval),R.countdownIntervals=[],Lt&&(document.removeEventListener("click",Lt),Lt=null),Rt&&(document.removeEventListener("change",Rt),Rt=null)}const yd={async render(e){if(!e){ul();return}Qr(),await ra()},update(){Qr()},refresh:ra,cleanup:ul};window.RentalPage=yd;const hb={render:async e=>{const t=document.getElementById("socials");if(!t||!e&&t.innerHTML.trim()!=="")return;const a=`
            <style>
...
`;document.head.appendChild(kd);const vb={render:async e=>{if(!e)return;const t=document.getElementById("creditcard");t&&(t.innerHTML=`
    ...
    `}function Nr(e,t,a,n,r,i,s){const o=lo[jt];let l=`
        <div class="mb-10">
    ...
    `},ml=()=>{var n,r,i,s;const e=k.campaigns.filter(o=>uo(o)),t=e.filter(o=>o.category==="animal"),a=e.filter(o=>o.category==="humanitarian");return`
        <div class="charity-page">
            ...
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-lg font-bold text-white flex items-center gap-2">
                    ${k.selectedCategory?`
                        ...
                        ${(i=Be[k.selectedCategory])==null?void 0:i.emoji} ${(s=Be[k.selectedCategory])==null?void 0:s.name}
                    `:`
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4" id="cp-grid">
                ${e.length?e.filter(o=>!k.selectedCategory||o.category===k.selectedCategory).sort((o,l)=>Number(l.createdAt||0)-Number(o.createdAt||0)).map(o=>Fd(o)).join(""):_d("No active campaigns")}
            </div>
        </div>
    `},fl=e=>{var o,l,d,u,m,p;if(!e)return`
        <div class="charity-page">
    ...
    `;const t=Wa(e.raisedAmount,e.goalAmount),a=zd(e.deadline),n=e.category||"humanitarian",r=uo(e),i=((o=e.creator)==null?void 0:o.toLowerCase())===((l=c==null?void 0:c.userAddress)==null?void 0:l.toLowerCase()),s=Sd(e);return`
        <div class="charity-page">
            ${bo()}
            ${Md()}
...
`;function Lb(){[1,2,3,4].forEach(t=>{const a=document.getElementById(`cp-step-${t}`);a&&(t<k.createStep?(a.className="cp-step-dot done",a.innerHTML='<i class="fa-solid fa-check text-sm"></i>'):t===k.createStep?(a.className="cp-step-dot active",a.textContent=t):(a.className="cp-step-dot pending",a.textContent=t))}),[1,2,3].forEach(t=>{const a=document.getElementById(`cp-ln-${t}`);a&&(a.className=`cp-step-line ln-${t} ${k.createStep>t?"done":k.createStep===t?"active":""}`)});const e=document.querySelector(".charity-page .text-sm.text-zinc-500");e&&(e.textContent=`Step ${k.createStep} of 4`)}function Ga(){const e=document.getElementById("cp-wiz-panel");if(e)switch(Lb(),k.createStep){case 1:Rb(e);break;case 2:_b(e);break;case 3:Fb(e);break;case 4:Mb(e);break}}function Rb(e){e.innerHTML=`
    ...
    `}function _b(e){const t=k.createTitle.length,a=k.createDesc.length;e.innerHTML=`
    ...
    `}function Mb(e){const t=Be[k.createCategory]||Be.humanitarian;e.innerHTML=`
    ...
    `}function Db(e){k.createCategory=e,Ga()}function Ob(){var e,t,a,n,r,i;switch(k.createStep){case 1:if(!k.createCategory)return x("Select a category","error");break;case 2:{const s=((t=(e=document.getElementById("wiz-title"))==null?void 0:e.value)==null?void 0:t.trim())||"",o=((n=(a=document.getElementById("wiz-desc"))==null?void 0:a.value)==null?void 0:n.trim())||"";if(k.createTitle=s,k.createDesc=o,!s)return x("Enter a title","error");if(!o)return x("Enter a description","error");break}case 3:{const s=((i=(r=document.getElementById("wiz-image-url"))==null?void 0:r.value)==null?void 0:i.trim())||"";s&&(k.createImageUrl=s);break}}k.createStep=Math.min(4,k.createStep+1),Ga()}function Hb(){jb(),k.createStep=Math.max(1,k.createStep-1),Ga()}function Ub(){k.createImageFile=null,k.createImageUrl="",k.createImagePreview=null,k.pendingImageFile=null,k.createStep=4,Ga()}function Dd(){k.currentView="main",k.createStep=1,k.createCategory=null,k.createTitle="",k.createDesc="",k.createGoal="",k.createDuration="",k.createImageFile=null,k.createImageUrl="",k.createImagePreview=null,k.pendingImageFile=null,De()}function jb(){switch(k.createStep){case 2:{const e=document.getElementById("wiz-title"),t=document.getElementById("wiz-desc");e&&(k.createTitle=e.value),t&&(k.createDesc=t.value);break}case 3:{const e=document.getElementById("wiz-image-url");e&&(k.createImageUrl=e.value.trim());break}case 4:{const e=document.getElementById("wiz-goal"),t=document.getElementById("wiz-duration");e&&(k.createGoal=e.value),t&&(k.createDuration=t.value);break}}}function Wb(e,t){const a=t.value.length,n=e==="title"?100:2e3,r=e==="title"?80:1800,i=e==="title"?95:1950,s=document.getElementById(`wiz-${e}-count`);s&&(s.textContent=`${a}/${n}`,s.className=`cp-wiz-char-count ${a>i?"danger":a>r?"warn":""}`)}function Gb(e){var n;const t=(n=e.target.files)==null?void 0:n[0];if(!t)return;if(!Ad.includes(t.type)){x("Please select a valid image (JPG, PNG, GIF, WebP)","error");return}if(t.size>Id){x("Image must be less than 5MB","error");return}k.createImageFile=t,k.pendingImageFile=t;const a=new FileReader;a.onload=r=>{k.createImagePreview=r.target.result;const i=document.getElementById("wiz-image-preview");i&&(i.innerHTML=`
                <img src="${r.target.result}" class="cp-image-preview">
                <button type="button" class="cp-image-remove" onclick="event.stopPropagation();CharityPage.removeWizardImage()">
                    <i class="fa-solid fa-xmark"></i> Remove
                </button>
            `)},a.readAsDataURL(t)}function Kb(){k.createImageFile=null,k.createImagePreview=null,k.createImageUrl="",k.pendingImageFile=null;const e=document.getElementById("wiz-image-preview");e&&(e.innerHTML=`
            <div class="cp-image-upload-icon"><i class="fa-solid fa-cloud-arrow-up"></i></div>
            <div class="cp-image-upload-text"><span>Click to upload</span> or drag and drop<br><small>PNG, JPG, GIF, WebP — max 5MB</small></div>
        `);const t=document.getElementById("wiz-image-file");t&&(t.value="")}async function Yb(){var l,d;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=(l=document.getElementById("wiz-goal"))==null?void 0:l.value,t=(d=document.getElementById("wiz-duration"))==null?void 0:d.value;if(k.createGoal=e||"",k.createDuration=t||"",!k.createCategory)return x("Select a category","error");if(!k.createTitle)return x("Enter a title","error");if(!k.createDesc)return x("Enter a description","error");if(!e||parseFloat(e)<.01)return x("Goal must be at least 0.01 ETH","error");if(!t||parseInt(t)<1||parseInt(t)>180)return x("Duration must be 1-180 days","error");let a=k.createImageUrl||"";if(k.createImageFile)try{x("Uploading image to IPFS...","info"),a=await fo(k.createImageFile),x("Image uploaded!","success")}catch(u){console.error("Image upload failed:",u),x("Image upload failed — campaign will be created without image","warning")}const n=k.createTitle,r=k.createDesc,i=k.createCategory,s=Yt.parseEther(e),o=parseInt(t);await yt.createCampaign({title:n,description:r,goalAmount:s,durationDays:o,button:document.getElementById("btn-wizard-launch"),onSuccess:async(u,m)=>{if(m){mo(m,{imageUrl:a,category:i,title:n,description:r});try{await fetch(ja.saveCampaign,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:m,title:n,description:r,category:i,imageUrl:a,creator:c.userAddress})})}catch{}}x("Campaign created!","success"),Dd(),await Et(),De()},onError:u=>{var m;!u.cancelled&&u.type!=="user_rejected"&&x(((m=u.message)==null?void 0:m.slice(0,80))||"Failed","error")}})}function pr(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.add("active")}function bt(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.remove("active")}function Vb(e=null){k.createStep=e?2:1,k.createCategory=e,k.createTitle="",k.createDesc="",k.createGoal="",k.createDuration="",k.createImageFile=null,k.createImageUrl="",k.createImagePreview=null,k.pendingImageFile=null,k.currentView="create",De()}function qb(e){const t=k.campaigns.find(r=>r.id===e||r.id===String(e));if(!t)return;const a=document.getElementById("donate-campaign-info");a&&(a.innerHTML=`
        ...
        `);const n=document.getElementById("donate-amount");n&&(n.value=""),k.currentCampaign=t,pr("donate")}function Xb(){var n;const e=(n=c==null?void 0:c.userAddress)==null?void 0:n.toLowerCase(),t=k.campaigns.filter(r=>{var i;return((i=r.creator)==null?void 0:i.toLowerCase())===e}),a=document.getElementById("my-campaigns-list");a&&(t.length===0?a.innerHTML=`
            <div class="cp-empty">
        ...
        `:a.innerHTML=t.map(r=>{const i=Wa(r.raisedAmount,r.goalAmount),s=Sd(r);return`
            ...
            `}).join(""),pr("my"))}function Jb(e){var n,r,i;const t=k.campaigns.find(s=>s.id===e||s.id===String(e));if(!t)return;if(((n=t.creator)==null?void 0:n.toLowerCase())!==((r=c==null?void 0:c.userAddress)==null?void 0:r.toLowerCase())){x("Not your campaign","error");return}k.editingCampaign=t,k.pendingImageFile=null,document.getElementById("edit-campaign-id").value=t.id,document.getElementById("edit-title").value=t.title||"",document.getElementById("edit-desc").value=t.description||"",document.getElementById("edit-image-url").value=t.imageUrl||"",document.querySelectorAll("#modal-edit .cp-cat-option").forEach(s=>s.classList.remove("selected")),(i=document.getElementById(`edit-opt-${t.category||"humanitarian"}`))==null||i.classList.add("selected");const a=document.getElementById("edit-image-preview");a&&t.imageUrl?a.innerHTML=`<img src="${t.imageUrl}" class="cp-image-preview">`:a&&(a.innerHTML=""),pr("edit")}function Zb(e,t="create"){var r;const a=t==="edit"?"edit-opt-":"opt-",n=t==="edit"?"#modal-edit":"#modal-create";document.querySelectorAll(`${n} .cp-cat-option`).forEach(i=>i.classList.remove("selected")),(r=document.getElementById(`${a}${e}`))==null||r.classList.add("selected")}function Qb(e){const t=document.getElementById("donate-amount")||document.getElementById("detail-amount");t&&(t.value=e)}async function eg(){var l,d,u,m,p,b,f,w;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=document.querySelector("#modal-create .cp-cat-option.selected input"),t=(e==null?void 0:e.value)||"humanitarian",a=(d=(l=document.getElementById("campaign-title"))==null?void 0:l.value)==null?void 0:d.trim(),n=(m=(u=document.getElementById("campaign-desc"))==null?void 0:u.value)==null?void 0:m.trim(),r=(p=document.getElementById("campaign-goal"))==null?void 0:p.value,i=(b=document.getElementById("campaign-duration"))==null?void 0:b.value;let s=(w=(f=document.getElementById("campaign-image-url"))==null?void 0:f.value)==null?void 0:w.trim();if(!a)return x("Enter a title","error");if(!n)return x("Enter a description","error");if(!r||parseFloat(r)<.01)return x("Goal must be at least 0.01 ETH","error");if(!i||parseInt(i)<1)return x("Duration must be at least 1 day","error");if(k.pendingImageFile)try{x("Uploading image...","info"),s=await fo(k.pendingImageFile)}catch(T){console.error("Image upload failed:",T)}const o=Yt.parseEther(r);await yt.createCampaign({title:a,description:n,goalAmount:o,durationDays:parseInt(i),button:document.getElementById("btn-create"),onSuccess:async(T,C)=>{if(C){mo(C,{imageUrl:s,category:t,title:a,description:n});try{await fetch(ja.saveCampaign,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:C,title:a,description:n,category:t,imageUrl:s,creator:c.userAddress})})}catch{}}x("Campaign created!","success"),bt("create"),k.pendingImageFile=null,await Et(),De()},onError:T=>{var C;!T.cancelled&&T.type!=="user_rejected"&&x(((C=T.message)==null?void 0:C.slice(0,80))||"Failed","error")}})}async function tg(){var n;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=k.currentCampaign;if(!e)return;const t=(n=document.getElementById("donate-amount"))==null?void 0:n.value;if(!t||parseFloat(t)<.001)return x("Minimum 0.001 ETH","error");const a=Yt.parseEther(t);await yt.donate({campaignId:e.id,amount:a,button:document.getElementById("btn-donate"),onSuccess:async()=>{x("❤️ Thank you for your donation!","success"),bt("donate"),await Et(),De()},onError:r=>{var i;!r.cancelled&&r.type!=="user_rejected"&&x(((i=r.message)==null?void 0:i.slice(0,80))||"Failed","error")}})}async function ag(e){var n;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const t=(n=document.getElementById("detail-amount"))==null?void 0:n.value;if(!t||parseFloat(t)<.001)return x("Minimum 0.001 ETH","error");const a=Yt.parseEther(t);await yt.donate({campaignId:e,amount:a,button:document.getElementById("btn-donate-detail"),onSuccess:async()=>{x("❤️ Thank you for your donation!","success"),await Et(),await Vt(e)},onError:r=>{var i;!r.cancelled&&r.type!=="user_rejected"&&x(((i=r.message)==null?void 0:i.slice(0,80))||"Failed","error")}})}async function ng(e){if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");confirm("Cancel this campaign? This cannot be undone.")&&await yt.cancelCampaign({campaignId:e,button:document.getElementById("btn-cancel"),onSuccess:async()=>{x("Campaign cancelled","success"),await Et(),De()},onError:t=>{var a;!t.cancelled&&t.type!=="user_rejected"&&x(((a=t.message)==null?void 0:a.slice(0,80))||"Failed","error")}})}async function rg(e){if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const t=k.campaigns.find(r=>r.id===e||r.id===String(e));if(!t)return;const a=Wa(t.raisedAmount,t.goalAmount);let n=`Withdraw ${Ae(t.raisedAmount)} ETH?

5% platform fee applies.`;a<100&&(n+=`
Goal not reached - partial withdrawal.`),confirm(n)&&await yt.withdraw({campaignId:e,button:document.getElementById(`btn-withdraw-${e}`)||document.getElementById("btn-withdraw"),onSuccess:async()=>{var r;x("✅ Funds withdrawn successfully!","success"),bt("my"),await Et(),De(),((r=k.currentCampaign)==null?void 0:r.id)===e&&await Vt(e)},onError:r=>{var i;!r.cancelled&&r.type!=="user_rejected"&&x(((i=r.message)==null?void 0:i.slice(0,80))||"Failed","error")}})}async function ig(){var o,l,d,u,m,p,b,f;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=(o=document.getElementById("edit-campaign-id"))==null?void 0:o.value,t=(d=(l=document.getElementById("edit-title"))==null?void 0:l.value)==null?void 0:d.trim(),a=(m=(u=document.getElementById("edit-desc"))==null?void 0:u.value)==null?void 0:m.trim();let n=(b=(p=document.getElementById("edit-image-url"))==null?void 0:p.value)==null?void 0:b.trim();const r=document.querySelector("#modal-edit .cp-cat-option.selected input"),i=(r==null?void 0:r.value)||"humanitarian";if(!t)return x("Enter title","error");if(k.pendingImageFile)try{x("Uploading image...","info"),n=await fo(k.pendingImageFile)}catch(w){console.error("Image upload failed:",w)}const s=document.getElementById("btn-save-edit");s&&(s.disabled=!0,s.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Saving...');try{mo(e,{imageUrl:n,category:i,title:t,description:a}),await fetch(ja.saveCampaign,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:e,title:t,description:a,category:i,imageUrl:n,creator:c.userAddress})}),x("Campaign updated!","success"),bt("edit"),k.pendingImageFile=null,await Et(),((f=k.currentCampaign)==null?void 0:f.id)===e?await Vt(e):De()}catch{x("Failed to save","error")}finally{s&&(s.disabled=!1,s.innerHTML='<i class="fa-solid fa-check"></i> Save')}}function sg(e){const t=k.currentCampaign;if(!t)return;const a=Bd(t.id),n=`🙏 Support "${t.title}" on Backcoin Charity!

${Ae(t.raisedAmount)} raised of ${Ae(t.goalAmount)} goal.

`;let r;e==="twitter"?r=`https://twitter.com/intent/tweet?text=${encodeURIComponent(n)}&url=${encodeURIComponent(a)}`:e==="telegram"?r=`https://t.me/share/url?url=${encodeURIComponent(a)}&text=${encodeURIComponent(n)}`:e==="whatsapp"&&(r=`https://wa.me/?text=${encodeURIComponent(n+a)}`),r&&window.open(r,"_blank","width=600,height=400")}function og(){const e=k.currentCampaign;e&&navigator.clipboard.writeText(Bd(e.id)).then(()=>x("Link copied!","success")).catch(()=>x("Copy failed","error"))}function Od(){Ib(),k.currentCampaign=null,k.currentView="main",De()}function lg(e){bt("my"),bt("donate"),bt("edit"),Cb(e),Vt(e)}function cg(e){k.selectedCategory=k.selectedCategory===e?null:e,go()}function dg(){k.selectedCategory=null,go()}function go(){const e=document.getElementById("cp-grid");if(!e)return;let t=k.campaigns.filter(a=>uo(a));k.selectedCategory&&(t=t.filter(a=>a.category===k.selectedCategory)),t.sort((a,n)=>Number(n.createdAt||0)-Number(a.createdAt||0)),e.innerHTML=t.length?t.map(a=>Fd(a)).join(""):_d("No campaigns")}async function Vt(e){k.currentView="detail",k.isLoading=!0;const t=ei();t&&(t.innerHTML=Nb());try{let a=k.campaigns.find(n=>n.id===e||n.id===String(e));if(!a){const n=c==null?void 0:c.publicProvider;if(n){const i=await new Yt.Contract(v.charityPool,po,n).getCampaign(e),s=Ld(e);a={id:String(e),creator:i.creator||i[0],title:i.title||i[1]||`Campaign #${e}`,description:i.description||i[2]||"",goalAmount:BigInt((i.goalAmount||i[3]).toString()),raisedAmount:BigInt((i.raisedAmount||i[4]).toString()),donationCount:Number(i.donationCount||i[5]),deadline:Number(i.deadline||i[6]),createdAt:Number(i.createdAt||i[7]),status:Number(i.status||i[10]),category:(s==null?void 0:s.category)||"humanitarian",imageUrl:(s==null?void 0:s.imageUrl)||null}}}k.currentCampaign=a,t&&(t.innerHTML=fl(a))}catch{t&&(t.innerHTML=fl(null))}finally{k.isLoading=!1}}function ei(){let e=document.getElementById("charity-container");if(e)return e;const t=document.getElementById("charity");return t?(e=document.createElement("div"),e.id="charity-container",t.innerHTML="",t.appendChild(e),e):null}function De(){Tb();const e=ei();if(!e)return;if(k.currentView==="create"){e.innerHTML=$b(),Ga();return}const t=Nd();t?Vt(t):(k.currentView="main",k.currentCampaign=null,e.innerHTML=ml(),Et().then(()=>{if(k.currentView==="main"){const a=ei();a&&(a.innerHTML=ml())}}))}async function ug(){k.campaigns=[],k.stats=null,k.currentView==="detail"&&k.currentCampaign?await Vt(k.currentCampaign.id):De()}window.addEventListener("hashchange",()=>{var e;if(window.location.hash.startsWith("#charity")){const t=Nd();t?((e=k.currentCampaign)==null?void 0:e.id)!==t&&Vt(t):k.currentView!=="main"&&Od()}});const Hd={render(e){e&&De()},update(){k.currentView==="main"&&go()},refresh:ug,openModal:pr,closeModal:bt,openCreate:Vb,openDonate:qb,openMyCampaigns:Xb,openEdit:Jb,create:eg,donate:tg,donateDetail:ag,cancel:ng,withdraw:rg,saveEdit:ig,selCatOpt:Zb,setAmt:Qb,goBack:Od,viewCampaign:lg,selectCat:cg,clearCat:dg,share:sg,copyLink:og,handleImageSelect:Pb,removeImage:zb,switchImageTab:Bb,wizardSelectCategory:Db,wizardNext:Ob,wizardBack:Hb,wizardSkipImage:Ub,cancelCreate:Dd,wizardUpdateCharCount:Wb,handleWizardImageSelect:Gb,removeWizardImage:Kb,wizardLaunch:Yb};window.CharityPage=Hd;const Ka=window.ethers,Ud="https://sepolia.arbiscan.io/address/",pg=Al,gt=500;function jd(){return v.agora||v.backchat||v.Backchat||null}function rt(){return v.operator||v.treasury||null}const g={view:"feed",activeTab:"feed",viewHistory:[],posts:[],trendingPosts:[],allItems:[],replies:new Map,likesMap:new Map,replyCountMap:new Map,repostCountMap:new Map,postsById:new Map,userProfile:null,profiles:new Map,hasProfile:null,following:new Set,followers:new Set,followCounts:new Map,pendingImage:null,pendingImagePreview:null,isUploadingImage:!1,selectedPost:null,selectedProfile:null,wizStep:1,wizUsername:"",wizDisplayName:"",wizBio:"",wizUsernameOk:null,wizFee:null,wizChecking:!1,fees:{post:0n,reply:0n,like:0n,follow:0n,repost:0n,superLikeMin:0n,boostMin:0n,badge:0n},pendingEth:0n,hasBadge:!1,isBoosted:!1,boostExpiry:0,badgeExpiry:0,referralStats:null,referredBy:null,isLoading:!1,isPosting:!1,contractAvailable:!0,error:null};function mg(){if(document.getElementById("backchat-styles-v70"))return;const e=document.getElementById("backchat-styles-v69");e&&e.remove();const t=document.createElement("style");t.id="backchat-styles-v70",t.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(t)}function La(e){return e?`${e.slice(0,6)}...${e.slice(-4)}`:""}function fg(e){const a=Date.now()/1e3-e;return a<60?"now":a<3600?`${Math.floor(a/60)}m`:a<86400?`${Math.floor(a/3600)}h`:a<604800?`${Math.floor(a/86400)}d`:new Date(e*1e3).toLocaleDateString("en-US",{month:"short",day:"numeric"})}function wt(e){if(!e||e===0n)return"0";const t=parseFloat(Ka.formatEther(e));return t<1e-4?"<0.0001":t<.01?t.toFixed(4):t<1?t.toFixed(3):t.toFixed(2)}function mr(e){return e?e.slice(2,4).toUpperCase():"?"}function Fe(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}function Ia(e){if(!e)return"?";const t=g.profiles.get(e.toLowerCase());return t!=null&&t.displayName?t.displayName:t!=null&&t.username?`@${t.username}`:La(e)}function bg(e){if(!e)return null;const t=g.profiles.get(e.toLowerCase());return(t==null?void 0:t.username)||null}function gg(e){var t;return(e==null?void 0:e.toLowerCase())===((t=c.userAddress)==null?void 0:t.toLowerCase())?g.isBoosted:!1}function xg(e){var t;return(e==null?void 0:e.toLowerCase())===((t=c.userAddress)==null?void 0:t.toLowerCase())?g.hasBadge:!1}function nn(e,t){g.viewHistory.push({view:g.view,activeTab:g.activeTab,selectedPost:g.selectedPost,selectedProfile:g.selectedProfile}),g.view=e,t!=null&&t.post&&(g.selectedPost=t.post),t!=null&&t.profile&&(g.selectedProfile=t.profile),mt()}function hg(){if(g.viewHistory.length>0){const e=g.viewHistory.pop();g.view=e.view,g.activeTab=e.activeTab||g.view,g.selectedPost=e.selectedPost,g.selectedProfile=e.selectedProfile}else g.view="feed",g.activeTab="feed";mt()}function fr(){if(c.agoraContract)return c.agoraContract;if(c.agoraContractPublic)return c.agoraContractPublic;const e=jd();return e?c.publicProvider?new Ka.Contract(e,la,c.publicProvider):null:(console.warn("Agora/Backchat address not found in deployment-addresses.json"),null)}async function bl(){try{const e=fr();if(!e)return;let t=100000000n;try{t=await e.VOTE_PRICE()}catch{}const a=window.ethers.parseEther("0.0001");g.fees={post:a,reply:a,like:a,follow:a,repost:a,superLikeMin:t,boostMin:window.ethers.parseEther("0.0005"),badge:window.ethers.parseEther("0.001")}}catch(e){console.warn("Failed to load fees:",e.message)}}async function gl(){if(!(!c.isConnected||!c.userAddress))try{const e=fr();if(!e)return;const[t,a,n]=await Promise.all([e.getUserProfile(c.userAddress).catch(()=>null),e.hasTrustBadge(c.userAddress).catch(()=>!1),e.isProfileBoosted(c.userAddress).catch(()=>!1)]);g.pendingEth=0n,g.hasBadge=a,g.isBoosted=n,g.boostExpiry=t?Number(t.boostExp||t[5]||0):0,g.badgeExpiry=t?Number(t.badgeExp||t[6]||0):0,g.referredBy=null,g.referralStats={totalReferred:0,totalEarned:0n,totalEarnedFormatted:"0.0"}}catch(e){console.warn("Failed to load user status:",e.message)}}async function xl(){try{const e=fr();if(!e){g.hasProfile=!1;return}const t=await e.queryFilter(e.filters.ProfileCreated(),-5e4).catch(()=>[]);for(const a of t){const n=a.args.user.toLowerCase();g.profiles.set(n,{username:a.args.username,metadataURI:a.args.metadataURI||""})}if(c.isConnected&&c.userAddress){const a=c.userAddress.toLowerCase();let n=g.profiles.get(a);if(!n)try{const r=await e.getUserProfile(c.userAddress);r&&r.usernameHash&&r.usernameHash!==Ka.ZeroHash&&(n={username:null,metadataURI:r.metadataURI||r[1]||""},g.profiles.set(a,n))}catch{}n?(g.userProfile={...n,address:c.userAddress},g.hasProfile=!0):(g.hasProfile=!1,g.userProfile=null)}else g.hasProfile=!1;console.log("[Backchat] Profiles loaded:",g.profiles.size,"| hasProfile:",g.hasProfile)}catch(e){console.warn("Failed to load profiles:",e.message),g.hasProfile=!1}oe()}async function hl(){g.following=new Set,g.followers=new Set,g.followCounts=new Map}async function ia(){var e,t;g.isLoading=!0,oe();try{if(!jd()){g.contractAvailable=!1,g.error="Backchat contract not deployed yet.";return}const n=fr();if(!n){g.contractAvailable=!1,g.error="Could not connect to Backchat contract";return}g.contractAvailable=!0;const[r,i,s]=await Promise.all([n.queryFilter(n.filters.PostCreated(),-5e4).catch(()=>[]),n.queryFilter(n.filters.ReplyCreated(),-5e4).catch(()=>[]),n.queryFilter(n.filters.RepostCreated(),-5e4).catch(()=>[])]),o=[];for(const u of r.slice(-80))o.push({ev:u,type:"post"});for(const u of i.slice(-60))o.push({ev:u,type:"reply"});for(const u of s.slice(-30))o.push({ev:u,type:"repost"});const l=[],d=[];g.postsById=new Map,g.replies=new Map,g.replyCountMap=new Map,g.repostCountMap=new Map,g.likesMap=new Map;for(let u=0;u<o.length;u+=10){const m=o.slice(u,u+10),p=await Promise.all(m.map(({ev:b})=>{const f=b.args.postId||b.args.newPostId;return n.getPost(f).catch(()=>null)}));for(let b=0;b<m.length;b++){const{ev:f,type:w}=m[b],T=p[b],C=(f.args.postId||f.args.newPostId).toString();if(T&&T.deleted)continue;const P=T?Number(T.createdAt||T[4]||0):0,N=T?Number(T.likes||T[7]||0):0,_=T?BigInt(T.superLikes||T[8]||0):0n,B=T?Number(T.replies||T[10]||0):0,I=T?Number(T.reposts||T[11]||0):0;if(w==="post"){const S={id:C,type:"post",author:f.args.author,content:f.args.contentHash||f.args.content||"",tag:f.args.tag!=null?Number(f.args.tag):0,timestamp:P,superLikes:_,likesCount:N,repliesCount:B,repostsCount:I,txHash:f.transactionHash};l.push(S),d.push(S),g.postsById.set(C,S)}else if(w==="reply"){const S=f.args.parentId.toString(),F={id:C,type:"reply",parentId:S,author:f.args.author,content:f.args.contentHash||f.args.content||"",tag:f.args.tag!=null?Number(f.args.tag):0,timestamp:P,superLikes:_,likesCount:N,txHash:f.transactionHash};l.push(F),g.postsById.set(C,F),g.replies.has(S)||g.replies.set(S,[]),g.replies.get(S).push(F),g.replyCountMap.set(S,(g.replyCountMap.get(S)||0)+1)}else if(w==="repost"){const S=((e=f.args.originalId)==null?void 0:e.toString())||((t=f.args.originalPostId)==null?void 0:t.toString())||"0",F={id:C,type:"repost",originalPostId:S,author:f.args.author||f.args.reposter,timestamp:P,superLikes:0n,txHash:f.transactionHash};l.push(F),d.push(F),g.postsById.set(C,F),g.repostCountMap.set(S,(g.repostCountMap.get(S)||0)+1)}}}if(c.isConnected&&c.userAddress){const u=l.filter(m=>m.type!=="repost").map(m=>m.id);for(let m=0;m<u.length;m+=10){const p=u.slice(m,m+10),b=await Promise.all(p.map(f=>n.hasLiked(f,c.userAddress).catch(()=>!1)));for(let f=0;f<p.length;f++)b[f]&&(g.likesMap.has(p[f])||g.likesMap.set(p[f],new Set),g.likesMap.get(p[f]).add(c.userAddress.toLowerCase()))}}d.sort((u,m)=>m.timestamp-u.timestamp),g.posts=d,g.allItems=l,g.trendingPosts=[...l].filter(u=>u.type!=="repost"&&u.superLikes>0n).sort((u,m)=>{const p=BigInt(u.superLikes||0),b=BigInt(m.superLikes||0);return b>p?1:b<p?-1:0})}catch(a){console.error("Failed to load posts:",a),g.error=a.message}finally{g.isLoading=!1,oe()}}async function vg(){var i;const e=document.getElementById("bc-compose-input"),t=(i=e==null?void 0:e.value)==null?void 0:i.trim();if(!t){x("Please write something","error");return}if(t.length>gt){x(`Post too long (max ${gt} chars)`,"error");return}g.isPosting=!0,oe();let a="";if(g.pendingImage)try{g.isUploadingImage=!0,oe(),a=(await Ng(g.pendingImage)).ipfsHash||""}catch(s){x("Image upload failed: "+s.message,"error"),g.isPosting=!1,g.isUploadingImage=!1,oe();return}finally{g.isUploadingImage=!1}const n=t,r=document.getElementById("bc-post-btn");await ge.createPost({content:n,mediaCID:a,operator:rt(),button:r,onSuccess:async()=>{e&&(e.value=""),g.pendingImage=null,g.pendingImagePreview=null,g.isPosting=!1,x("Post created!","success"),await ia()},onError:s=>{g.isPosting=!1,oe()}}),g.isPosting=!1,oe()}async function wg(e){var r;const t=document.getElementById("bc-reply-input"),a=(r=t==null?void 0:t.value)==null?void 0:r.trim();if(!a){x("Please write a reply","error");return}const n=document.getElementById("bc-reply-btn");await ge.createReply({parentId:e,content:a,mediaCID:"",tipBkc:0,operator:rt(),button:n,onSuccess:async()=>{t&&(t.value=""),x("Reply posted!","success"),await ia(),oe()}})}async function yg(e){const t=document.getElementById("bc-repost-confirm-btn");await ge.createRepost({originalPostId:e,tipBkc:0,operator:rt(),button:t,onSuccess:async()=>{Tt("repost"),x("Reposted!","success"),await ia()}})}async function kg(e){var a;const t=(a=c.userAddress)==null?void 0:a.toLowerCase();t&&(g.likesMap.has(e)||g.likesMap.set(e,new Set),g.likesMap.get(e).add(t),oe()),await ge.like({postId:e,tipBkc:0,operator:rt(),onSuccess:()=>{x("Liked!","success")},onError:()=>{var n;(n=g.likesMap.get(e))==null||n.delete(t),oe()}})}async function Eg(e,t){const a=Ka.parseEther(t);await ge.superLike({postId:e,ethAmount:a,tipBkc:0,operator:rt(),onSuccess:async()=>{x("Super Liked!","success"),await ia()}})}async function Tg(e){await ge.follow({toFollow:e,tipBkc:0,operator:rt(),onSuccess:()=>{g.following.add(e.toLowerCase()),x("Followed!","success"),oe()}})}async function Cg(e){await ge.unfollow({toUnfollow:e,onSuccess:()=>{g.following.delete(e.toLowerCase()),x("Unfollowed","success"),oe()}})}async function Ig(){x("Withdraw not available in V9","warning")}async function Ag(){const e=document.getElementById("bc-wizard-confirm-btn");await ge.createProfile({username:g.wizUsername,displayName:g.wizDisplayName,bio:g.wizBio,operator:rt(),button:e,onSuccess:async()=>{x("Profile created!","success"),g.hasProfile=!0,g.userProfile={username:g.wizUsername,displayName:g.wizDisplayName,bio:g.wizBio,address:c.userAddress},g.profiles.set(c.userAddress.toLowerCase(),{username:g.wizUsername,displayName:g.wizDisplayName,bio:g.wizBio}),g.wizStep=1,g.wizUsername="",g.wizDisplayName="",g.wizBio="",g.view="profile",g.activeTab="profile",mt()}})}async function Pg(){var n,r,i,s;const e=((r=(n=document.getElementById("edit-displayname"))==null?void 0:n.value)==null?void 0:r.trim())||"",t=((s=(i=document.getElementById("edit-bio"))==null?void 0:i.value)==null?void 0:s.trim())||"",a=document.getElementById("bc-edit-profile-btn");await ge.updateProfile({displayName:e,bio:t,button:a,onSuccess:()=>{g.userProfile.displayName=e,g.userProfile.bio=t,g.profiles.set(c.userAddress.toLowerCase(),{...g.profiles.get(c.userAddress.toLowerCase()),displayName:e,bio:t}),Tt("edit-profile"),x("Profile updated!","success"),oe()}})}async function zg(){await ge.obtainBadge({operator:rt(),onSuccess:()=>{g.hasBadge=!0,Tt("badge"),x("Badge obtained!","success"),oe()}})}async function Bg(e){const t=Ka.parseEther(e);await ge.boostProfile({ethAmount:t,operator:rt(),onSuccess:()=>{g.isBoosted=!0,Tt("boost"),x("Profile boosted!","success"),oe()}})}async function Ng(e){const t=new FormData;t.append("image",e);const a=new AbortController,n=setTimeout(()=>a.abort(),6e4);try{const r=await fetch("/api/upload-image",{method:"POST",body:t,signal:a.signal});if(clearTimeout(n),!r.ok){const i=await r.json().catch(()=>({}));throw new Error(i.error||`Upload failed (${r.status})`)}return await r.json()}catch(r){throw clearTimeout(n),r}}function Sg(e){var n,r;const t=(r=(n=e.target)==null?void 0:n.files)==null?void 0:r[0];if(!t)return;if(t.size>5*1024*1024){x("Image too large. Maximum 5MB.","error");return}if(!["image/jpeg","image/png","image/gif","image/webp"].includes(t.type)){x("Invalid image type. Use JPG, PNG, GIF, or WebP.","error");return}g.pendingImage=t;const a=new FileReader;a.onload=i=>{g.pendingImagePreview=i.target.result,oe()},a.readAsDataURL(t)}function $g(){g.pendingImage=null,g.pendingImagePreview=null;const e=document.getElementById("bc-image-input");e&&(e.value=""),oe()}let vl=null;function Lg(e){g.wizUsername=e.toLowerCase().replace(/[^a-z0-9_]/g,""),g.wizUsernameOk=null,g.wizFee=null,clearTimeout(vl);const t=document.getElementById("wiz-username-input");t&&(t.value=g.wizUsername),g.wizUsername.length>=1&&g.wizUsername.length<=15?(g.wizChecking=!0,Sr(),vl=setTimeout(async()=>{try{const[a,n]=await Promise.all([ge.isUsernameAvailable(g.wizUsername),ge.getUsernameFee(g.wizUsername.length)]);g.wizUsernameOk=a,g.wizFee=n.formatted}catch(a){console.warn("Username check failed:",a)}g.wizChecking=!1,Sr()},600)):(g.wizChecking=!1,Sr())}function Sr(){const e=document.getElementById("wiz-username-status");e&&(g.wizChecking?e.innerHTML='<span class="bc-username-checking"><i class="fa-solid fa-spinner fa-spin"></i> Checking...</span>':g.wizUsernameOk===!0?e.innerHTML=`<span class="bc-username-ok"><i class="fa-solid fa-check"></i> Available</span>
            ...
            <div class="bc-header-bar">
                ...
                <div class="bc-header-right">
                    ${c.isConnected&&g.pendingEth>0n?`
                        <button class="bc-icon-btn earnings-btn" onclick="BackchatPage.openEarnings()" title="Earnings: ${wt(g.pendingEth)} ETH">
                            <i class="fa-solid fa-coins"></i>
                        </button>
                    `:""}
    ...
    `}function wl(){var a;if(!c.isConnected)return"";const e=wt(g.fees.post);return`
        ...
        <div class="bc-compose">
            ...
            <div class="bc-compose-bottom">
                ...
                <div class="bc-compose-right">
                    <span class="bc-char-count" id="bc-char-counter">0/${gt}</span>
    ...
    `}function Wt(e,t=0,a={}){var b,f,w,T;if(e.type==="repost"&&!a.isRepostContent){const C=g.postsById.get(e.originalPostId);return`
        ...
        <div class="bc-post" data-post-id="${e.id}" ${p} onclick="BackchatPage.viewPost('${e.id}')">
            <div class="bc-post-top">
                ...
                <div class="bc-post-head">
                    ...
                    ${e.type==="reply"?`<div class="bc-post-context">Replying to ${Ia((T=g.postsById.get(e.parentId))==null?void 0:T.author)}</div>`:""}
                </div>
            </div>
    ...
    `}function yl(){return g.contractAvailable?g.isLoading?`
        ...
        <div class="bc-profile-section">
            ...
            <div class="bc-profile-main">
                ...
                <div class="bc-profile-stats">
                    ...
                    <div class="bc-stat-cell">
                        <div class="bc-stat-value">${wt(g.pendingEth)}</div>
            ...
            ${g.pendingEth>0n?`
                <div class="bc-earnings-card">
                    ...
                    <div class="bc-earnings-value">${wt(g.pendingEth)} <small>ETH</small></div>
    ...
    `}function oe(){const e=document.getElementById("backchat-content");if(!e)return;let t="";switch(g.view){case"feed":t=wl()+yl();break;case"trending":t=_g();break;case"profile":t=!g.hasProfile&&c.isConnected?kl():Fg();break;case"post-detail":t=Dg();break;case"user-profile":t=Og();break;case"profile-setup":t=kl();break;default:t=wl()+yl()}e.innerHTML=t}function Dg(){const e=g.selectedPost?g.postsById.get(g.selectedPost):null;if(!e)return'<div class="bc-empty"><div class="bc-empty-title">Post not found</div></div>';const t=g.replies.get(e.id)||[];t.sort((n,r)=>n.timestamp-r.timestamp);const a=Ia(e.author);return`
        ...
        ${c.isConnected?`
            <div class="bc-reply-compose">
                ...
                <div class="bc-reply-row">
                    <textarea id="bc-reply-input" class="bc-reply-input" placeholder="Write a reply..." maxlength="${gt}"></textarea>
                    <button id="bc-reply-btn" class="bc-btn bc-btn-primary bc-reply-send" onclick="BackchatPage.submitReply('${e.id}')">
                        Reply
                    </button>
                </div>
                <div style="font-size:11px;color:var(--bc-text-3);margin-top:6px;">Fee: ${wt(g.fees.reply)} ETH</div>
            </div>
        `:""}
    ...
    `}function kl(){if(!c.isConnected)return`
            <div class="bc-empty">
                <div class="bc-empty-glyph"><i class="fa-solid fa-wallet"></i></div>
                <div class="bc-empty-title">Connect Wallet</div>
    ...
    `}function Hg(){var e,t;return`
            ...
            <div class="bc-modal-box">
                ...
                <div class="bc-modal-inner">
                    ...
                    <div class="bc-fee-row">
                        ...
                        <span class="bc-fee-val">${wt(g.fees.badge)} ETH</span>
                    </div>
        ...
        <div class="bc-modal-overlay" id="modal-repost">
            <div class="bc-modal-box">
                ...
                <div class="bc-modal-inner">
                    <p class="bc-modal-desc">Repost this to your followers? Fee: ${wt(g.fees.repost)} ETH</p>
