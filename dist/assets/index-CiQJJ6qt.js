import{defaultConfig as tu,createWeb3Modal as au}from"https://esm.sh/@web3modal/ethers@5.1.11?bundle";import{initializeApp as nu}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-app.js";import{getAuth as su,onAuthStateChanged as iu,signInAnonymously as ru}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-auth.js";import{getFirestore as ou,collection as nt,query as Ht,where as bn,orderBy as ra,getDocs as wt,doc as ce,getDoc as $e,limit as lu,serverTimestamp as yt,writeBatch as Bn,updateDoc as Nn,increment as Ge,setDoc as $n,Timestamp as wo,addDoc as cu,deleteDoc as du}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-firestore.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function a(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(s){if(s.ep)return;s.ep=!0;const i=a(s);fetch(s.href,i)}})();const Se={sidebar:document.getElementById("sidebar"),sidebarBackdrop:document.getElementById("sidebar-backdrop"),menuBtn:document.getElementById("menu-btn"),navLinks:document.getElementById("nav-links"),mainContentSections:document.querySelectorAll("main section"),connectButtonDesktop:document.getElementById("connectButtonDesktop"),connectButtonMobile:document.getElementById("connectButtonMobile"),mobileAppDisplay:document.getElementById("mobileAppDisplay"),desktopDisconnected:document.getElementById("desktopDisconnected"),desktopConnectedInfo:document.getElementById("desktopConnectedInfo"),desktopUserAddress:document.getElementById("desktopUserAddress"),desktopUserBalance:document.getElementById("desktopUserBalance"),modalContainer:document.getElementById("modal-container"),toastContainer:document.getElementById("toast-container"),dashboard:document.getElementById("dashboard"),earn:document.getElementById("mine"),store:document.getElementById("store"),rental:document.getElementById("rental"),rewards:document.getElementById("rewards"),actions:document.getElementById("actions"),presale:document.getElementById("presale"),faucet:document.getElementById("faucet"),airdrop:document.getElementById("airdrop"),dao:document.getElementById("dao"),about:document.getElementById("about"),admin:document.getElementById("admin"),tokenomics:document.getElementById("tokenomics"),notary:document.getElementById("notary"),statTotalSupply:document.getElementById("statTotalSupply"),statValidators:document.getElementById("statValidators"),statTotalPStake:document.getElementById("statTotalPStake"),statScarcity:document.getElementById("statScarcity"),statLockedPercentage:document.getElementById("statLockedPercentage"),statUserBalance:document.getElementById("statUserBalance"),statUserPStake:document.getElementById("statUserPStake"),statUserRewards:document.getElementById("statUserRewards")},uu={provider:null,publicProvider:null,web3Provider:null,signer:null,userAddress:null,isConnected:!1,bkcTokenContract:null,ecosystemManagerContract:null,stakingPoolContract:null,buybackMinerContract:null,rewardBoosterContract:null,fortunePoolContract:null,agoraContract:null,notaryContract:null,charityPoolContract:null,rentalManagerContract:null,faucetContract:null,liquidityPoolContract:null,governanceContract:null,bkcTokenContractPublic:null,ecosystemManagerContractPublic:null,stakingPoolContractPublic:null,buybackMinerContractPublic:null,fortunePoolContractPublic:null,agoraContractPublic:null,notaryContractPublic:null,charityPoolContractPublic:null,rentalManagerContractPublic:null,faucetContractPublic:null,currentUserBalance:0n,currentUserNativeBalance:0n,userTotalPStake:0n,userDelegations:[],myBoosters:[],activityHistory:[],totalNetworkPStake:0n,allValidatorsData:[],systemFees:{},systemPStakes:{},boosterDiscounts:{},notaryFee:void 0,notaryMinPStake:void 0},pu={set(e,t,a){const n=e[t];if(e[t]=a,["currentUserBalance","isConnected","userTotalPStake","totalNetworkPStake"].includes(t)){if(n===a)return!0;window.updateUIState&&window.updateUIState()}return!0}},c=new Proxy(uu,pu);let yo=!1;const x=(e,t="info",a=null)=>{if(!Se.toastContainer)return;const n={success:{icon:"fa-check-circle",color:"bg-green-600",border:"border-green-400"},error:{icon:"fa-exclamation-triangle",color:"bg-red-600",border:"border-red-400"},info:{icon:"fa-info-circle",color:"bg-blue-600",border:"border-blue-400"},warning:{icon:"fa-exclamation-circle",color:"bg-yellow-600",border:"border-yellow-400"}},s=n[t]||n.info,i=document.createElement("div");i.className=`flex items-center w-full max-w-xs p-4 text-white rounded-lg shadow-lg transition-all duration-500 ease-out 
    ...
    `;if(a){const o=`https://sepolia.arbiscan.io/tx/${a}`;r+=`<a href="${o}" target="_blank" title="View on Arbiscan" class="ml-3 flex-shrink-0 text-white/80 hover:text-white transition-colors">
                ...
                </button>`,i.innerHTML=r,Se.toastContainer.appendChild(i),requestAnimationFrame(()=>{i.classList.remove("translate-x-full","opacity-0"),i.classList.add("translate-x-0","opacity-100")}),setTimeout(()=>{i.classList.remove("translate-x-0","opacity-100"),i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),500)},5e3)},Pe=()=>{if(!Se.modalContainer)return;const e=document.getElementById("modal-backdrop");if(e){const t=document.getElementById("modal-content");t&&(t.classList.remove("animate-fade-in-up"),t.classList.add("animate-fade-out-down")),e.classList.remove("opacity-100"),e.classList.add("opacity-0"),setTimeout(()=>{Se.modalContainer.innerHTML=""},300)}},za=(e,t="max-w-md",a=!0)=>{var i,r;if(!Se.modalContainer)return;const s=`
    ...
    `;Se.modalContainer.innerHTML=s,requestAnimationFrame(()=>{const o=document.getElementById("modal-backdrop");o&&o.classList.remove("opacity-0"),o&&o.classList.add("opacity-100")}),(i=document.getElementById("modal-backdrop"))==null||i.addEventListener("click",o=>{a&&o.target.id==="modal-backdrop"&&Pe()}),(r=document.getElementById("modal-content"))==null||r.querySelectorAll(".closeModalBtn").forEach(o=>{o.addEventListener("click",Pe)})};async function mu(e,t){if(!window.ethereum){x("MetaMask not detected","error");return}try{await window.ethereum.request({method:"wallet_watchAsset",params:{type:"ERC721",options:{address:"0xf2EA307686267dC674859da28C58CBb7a5866BCf",tokenId:e.toString()}}})?x(`${t} NFT #${e} added to wallet!`,"success"):x("NFT not added to wallet","info")}catch(a){console.error("Error adding NFT to wallet:",a),x("Failed to add NFT to wallet","error")}}function fu(){const e=window.location.origin,t=encodeURIComponent("Check out Backcoin - The Unstoppable DeFi Protocol on Arbitrum! Build your own business. Be Your Own CEO. 🚀 #Backcoin #DeFi #Arbitrum #BeYourOwnCEO"),a=`
    ...
    `;za(a,"max-w-md")}const ko=e=>{window.navigateTo?window.navigateTo(e):console.error("navigateTo function not found."),Pe()};function bu(){var s,i,r,o,l,d;if(yo)return;yo=!0;const e="https://t.me/BackCoinorg",t="https://github.com/backcoin-org/backchain-dapp";za(`
    ...
    `,"max-w-sm",!1);const n=document.getElementById("modal-content");n&&((s=n.querySelector("#btnAirdrop"))==null||s.addEventListener("click",()=>{ko("airdrop")}),(i=n.querySelector("#btnExplore"))==null||i.addEventListener("click",()=>{Pe()}),(r=n.querySelector("#btnCEO"))==null||r.addEventListener("click",()=>{window.open(t+"/blob/main/docs/BE_YOUR_OWN_CEO.md","_blank")}),(o=n.querySelector("#btnDocs"))==null||o.addEventListener("click",()=>{window.open(t,"_blank")}),(l=n.querySelector("#btnSocials"))==null||l.addEventListener("click",()=>{ko("socials")}),(d=n.querySelector("#btnTelegram"))==null||d.addEventListener("click",()=>{window.open(e,"_blank")}))}const gu=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1";console.log(`Environment: ${gu?"DEVELOPMENT":"PRODUCTION"}`);const si="ZWla0YY4A0Hw7e_rwyOXB",we={chainId:"0x66eee",chainIdDecimal:421614,chainName:"Arbitrum Sepolia",nativeCurrency:{name:"Ethereum",symbol:"ETH",decimals:18},blockExplorerUrls:["https://sepolia.arbiscan.io"],rpcUrls:[`https://arb-sepolia.g.alchemy.com/v2/${si}`,"https://arbitrum-sepolia.blockpi.network/v1/rpc/public","https://arbitrum-sepolia-rpc.publicnode.com"]},bt=[{name:"Alchemy",url:`https://arb-sepolia.g.alchemy.com/v2/${si}`,priority:1,isPublic:!1,corsCompatible:!0},{name:"BlockPI",url:"https://arbitrum-sepolia.blockpi.network/v1/rpc/public",priority:2,isPublic:!0,corsCompatible:!0},{name:"PublicNode",url:"https://arbitrum-sepolia-rpc.publicnode.com",priority:3,isPublic:!0,corsCompatible:!0},{name:"Arbitrum Official",url:"https://sepolia-rollup.arbitrum.io/rpc",priority:4,isPublic:!0,corsCompatible:!1}].filter(e=>e.url!==null),ii=`https://arb-sepolia.g.alchemy.com/v2/${si}`;let je=0,Ba=new Map;function ta(){var e;return((e=bt[je])==null?void 0:e.url)||ii}function ri(){const e=je;do{je=(je+1)%bt.length;const a=bt[je];if(!a.corsCompatible){console.warn(`⏭️ Skipping ${a.name} (CORS incompatible)`);continue}if(je===e)return console.warn("⚠️ All RPCs have been tried. Resetting to primary."),je=0,bt[0].url}while(Ba.get(bt[je].url)==="unhealthy");const t=bt[je];return console.log(`🔄 Switched to RPC: ${t.name}`),t.url}function $l(e){Ba.set(e,"unhealthy"),console.warn(`❌ RPC marked unhealthy: ${e}`),setTimeout(()=>{Ba.delete(e),console.log(`♻️ RPC health reset: ${e}`)},6e4)}function Sl(e){Ba.set(e,"healthy")}function Ll(){je=0,Ba.clear(),console.log(`✅ Reset to primary RPC: ${bt[0].name}`)}const Rl="https://white-defensive-eel-240.mypinata.cloud/ipfs/",gn=["https://dweb.link/ipfs/","https://w3s.link/ipfs/","https://nftstorage.link/ipfs/","https://cloudflare-ipfs.com/ipfs/","https://ipfs.io/ipfs/"],v={},F={bkcToken:null,backchainEcosystem:null,stakingPool:null,buybackMiner:null,rewardBooster:null,nftPoolFactory:null,fortunePool:null,agora:null,notary:null,charityPool:null,rentalManager:null,liquidityPool:null,faucet:null,backchainGovernance:null,treasuryWallet:null};async function _l(){try{const e=await fetch(`./deployment-addresses.json?t=${Date.now()}`);if(!e.ok)throw new Error(`Failed to fetch deployment-addresses.json: ${e.status}`);const t=await e.json(),a=["bkcToken","backchainEcosystem","stakingPool","buybackMiner"];if(!a.every(s=>t[s]||t[Eo(s)])){const s=a.filter(i=>!t[i]&&!t[Eo(i)]);throw new Error(`Missing required addresses: ${s.join(", ")}`)}return v.bkcToken=t.bkcToken,v.backchainEcosystem=t.backchainEcosystem||t.ecosystemManager,v.stakingPool=t.stakingPool||t.delegationManager,v.buybackMiner=t.buybackMiner||t.miningManager,v.rewardBooster=t.rewardBooster||t.rewardBoosterNFT,v.nftPoolFactory=t.nftPoolFactory||t.nftLiquidityPoolFactory,v.fortunePool=t.fortunePool||t.fortunePoolV2,v.agora=t.agora||t.backchat,v.notary=t.notary||t.decentralizedNotary,v.charityPool=t.charityPool,v.rentalManager=t.rentalManager,v.liquidityPool=t.liquidityPool,v.faucet=t.faucet||t.simpleBkcFaucet,v.backchainGovernance=t.backchainGovernance,v.treasuryWallet=t.treasuryWallet,v.pool_bronze=t.pool_bronze,v.pool_silver=t.pool_silver,v.pool_gold=t.pool_gold,v.pool_diamond=t.pool_diamond,Object.assign(F,v),console.log("✅ V9 contract addresses loaded"),console.log("   Ecosystem:",v.backchainEcosystem),console.log("   StakingPool:",v.stakingPool),console.log("   Agora:",v.agora),console.log("   FortunePool:",v.fortunePool),!0}catch(e){return console.error("❌ Failed to load contract addresses:",e),!1}}function Eo(e){return{backchainEcosystem:"ecosystemManager",stakingPool:"delegationManager",buybackMiner:"miningManager",rewardBooster:"rewardBoosterNFT",nftPoolFactory:"nftLiquidityPoolFactory",agora:"backchat",notary:"decentralizedNotary"}[e]||e}const xe=[{name:"Diamond",boostBips:5e3,burnRate:0,keepRate:100,color:"text-cyan-400",emoji:"💎",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeicgip72jcqgsirlrhn3tq5cc226vmko6etnndzl6nlhqrktfikafq",borderColor:"border-cyan-400/50",glowColor:"bg-cyan-500/10",bgGradient:"from-cyan-500/20 to-blue-500/20"},{name:"Gold",boostBips:4e3,burnRate:10,keepRate:90,color:"text-amber-400",emoji:"🥇",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeifponccrbicg2pcjrn2hrfoqgc77xhm2r4ld7hdpw6cxxkbsckf44",borderColor:"border-amber-400/50",glowColor:"bg-amber-500/10",bgGradient:"from-amber-500/20 to-yellow-500/20"},{name:"Silver",boostBips:2500,burnRate:25,keepRate:75,color:"text-gray-300",emoji:"🥈",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeihvi2inujm5zpi7tl667g4srq273536pjkglwyrtbwmgnskmu7jg4",borderColor:"border-gray-400/50",glowColor:"bg-gray-500/10",bgGradient:"from-gray-400/20 to-zinc-500/20"},{name:"Bronze",boostBips:1e3,burnRate:40,keepRate:60,color:"text-yellow-600",emoji:"🥉",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeiclqidb67rt3tchhjpsib62s624li7j2bpxnr6b5w5mfp4tomhu7m",borderColor:"border-yellow-600/50",glowColor:"bg-yellow-600/10",bgGradient:"from-yellow-600/20 to-orange-600/20"}];function Fl(e){const t=[...xe].sort((a,n)=>n.boostBips-a.boostBips);for(const a of t)if(e>=a.boostBips)return a;return null}function Ml(e){return e>=5e3?0:e>=4e3?10:e>=2500?25:e>=1e3?40:50}function st(e){return 100-Ml(e)}const Sn=["function name() view returns (string)","function symbol() view returns (string)","function decimals() view returns (uint8)","function totalSupply() view returns (uint256)","function balanceOf(address owner) view returns (uint256)","function transfer(address to, uint256 amount) returns (bool)","function approve(address spender, uint256 amount) returns (bool)","function allowance(address owner, address spender) view returns (uint256)","function transferFrom(address from, address to, uint256 amount) returns (bool)","function MAX_SUPPLY() view returns (uint256)","function TGE_SUPPLY() view returns (uint256)","function totalBurned() view returns (uint256)","function mintableRemaining() view returns (uint256)","function totalMinted() view returns (uint256)","event Transfer(address indexed from, address indexed to, uint256 value)","event Approval(address indexed owner, address indexed spender, uint256 value)"],Ln=["function totalPStake() view returns (uint256)","function totalBkcDelegated() view returns (uint256)","function userTotalPStake(address _user) view returns (uint256)","function pendingRewards(address _user) view returns (uint256)","function savedRewards(address _user) view returns (uint256)","function MIN_LOCK_DAYS() view returns (uint256)","function MAX_LOCK_DAYS() view returns (uint256)","function REFERRER_CUT_BPS() view returns (uint256)","function forceUnstakePenaltyBps() view returns (uint256)","function getDelegationsOf(address _user) view returns (tuple(uint128 amount, uint128 pStake, uint64 lockEnd, uint64 lockDays, uint256 rewardDebt)[])","function getDelegation(address _user, uint256 _index) view returns (uint256 amount, uint256 pStake, uint256 lockEnd, uint256 lockDays, uint256 pendingReward)","function delegationCount(address _user) view returns (uint256)","function delegate(uint256 _amount, uint256 _lockDays, address _operator) external payable","function unstake(uint256 _index) external","function forceUnstake(uint256 _index, address _operator) external payable","function claimRewards(address _operator) external payable","function claimRewards() external","function getUserBestBoost(address _user) view returns (uint256)","function getBurnRateForBoost(uint256 _boostBps) pure returns (uint256)","function getTierName(uint256 _boostBps) pure returns (string)","function previewClaim(address _user) view returns (uint256 totalRewards, uint256 burnAmount, uint256 referrerCut, uint256 userReceives, uint256 burnRateBps, uint256 nftBoost)","function getStakingStats() view returns (uint256 totalPStake, uint256 totalBkcDelegated, uint256 totalRewardsDistributed, uint256 totalBurnedOnClaim, uint256 totalForceUnstakePenalties, uint256 totalEthFeesCollected, uint256 accRewardPerShare)","function getUserSummary(address _user) view returns (uint256 userTotalPStake, uint256 delegationCount, uint256 savedRewards, uint256 totalPending, uint256 nftBoost, uint256 burnRateBps)","event Delegated(address indexed user, uint256 indexed delegationIndex, uint256 amount, uint256 pStake, uint256 lockDays, address operator)","event Unstaked(address indexed user, uint256 indexed delegationIndex, uint256 amountReturned)","event ForceUnstaked(address indexed user, uint256 indexed delegationIndex, uint256 amountReturned, uint256 penaltyBurned, address operator)","event RewardsClaimed(address indexed user, uint256 totalRewards, uint256 burnedAmount, uint256 userReceived, uint256 cutAmount, address cutRecipient, uint256 nftBoostUsed, address operator)","event TokensBurnedOnClaim(address indexed user, uint256 burnedAmount, uint256 burnRateBps, uint256 totalBurnedAllTime)"],oa=["function listNFT(uint256 tokenId, uint96 pricePerHour, uint16 minHours, uint16 maxHours) external","function updateListing(uint256 tokenId, uint96 pricePerHour, uint16 minHours, uint16 maxHours) external","function withdrawNFT(uint256 tokenId) external","function rentNFT(uint256 tokenId, uint256 hours_, address operator) external payable","function withdrawEarnings() external","function getListing(uint256 tokenId) view returns (address owner, uint96 pricePerHour, uint16 minHours, uint16 maxHours, uint96 totalEarnings, uint32 rentalCount, bool currentlyRented, uint48 rentalEndTime)","function getRental(uint256 tokenId) view returns (address tenant, uint48 endTime, bool isActive)","function isRented(uint256 tokenId) view returns (bool)","function getRemainingTime(uint256 tokenId) view returns (uint256)","function hasActiveRental(address user) view returns (bool)","function getUserBestBoost(address user) view returns (uint256)","function pendingEarnings(address owner) view returns (uint256)","function userActiveRental(address user) view returns (uint256)","function getAllListedTokenIds() view returns (uint256[])","function getListingCount() view returns (uint256)","function getRentalCost(uint256 tokenId, uint256 hours_) view returns (uint256 rentalCost, uint256 ethFee, uint256 totalCost)","function getStats() view returns (uint256 activeListings, uint256 volume, uint256 rentals, uint256 ethFees, uint256 earningsWithdrawn)","event NFTListed(uint256 indexed tokenId, address indexed owner, uint96 pricePerHour, uint16 minHours, uint16 maxHours)","event ListingUpdated(uint256 indexed tokenId, uint96 pricePerHour, uint16 minHours, uint16 maxHours)","event NFTRented(uint256 indexed tokenId, address indexed tenant, address indexed owner, uint256 hours_, uint256 rentalCost, uint256 ethFee, uint48 endTime, address operator)","event NFTWithdrawn(uint256 indexed tokenId, address indexed owner)","event EarningsWithdrawn(address indexed owner, uint256 amount)"],oi=["function buyNFT(uint256 maxBkcPrice, address operator) external payable returns (uint256 tokenId)","function buySpecificNFT(uint256 tokenId, uint256 maxBkcPrice, address operator) external payable","function sellNFT(uint256 tokenId, uint256 minPayout, address operator) external payable","function getBuyPrice() view returns (uint256)","function getSellPrice() view returns (uint256)","function getTotalBuyCost() view returns (uint256 bkcCost, uint256 ethCost)","function getTotalSellInfo() view returns (uint256 bkcPayout, uint256 ethCost)","function getEthFees() view returns (uint256 buyFee, uint256 sellFee)","function getSpread() view returns (uint256 spread, uint256 spreadBips)","function getPoolInfo() view returns (uint256 bkcBalance, uint256 nftCount, uint256 k, bool initialized, uint8 tier)","function getAvailableNFTs() view returns (uint256[])","function isNFTInPool(uint256 tokenId) view returns (bool)","function bkcBalance() view returns (uint256)","function nftCount() view returns (uint256)","function tier() view returns (uint8)","function initialized() view returns (bool)","function getTierName() view returns (string)","function getStats() view returns (uint256 volume, uint256 buys, uint256 sells, uint256 ethFees)","function totalVolume() view returns (uint256)","function totalBuys() view returns (uint256)","function totalSells() view returns (uint256)","function totalEthFees() view returns (uint256)","event NFTPurchased(address indexed buyer, uint256 indexed tokenId, uint256 price, uint256 ethFee, uint256 newNftCount, address operator)","event NFTSold(address indexed seller, uint256 indexed tokenId, uint256 payout, uint256 ethFee, uint256 newNftCount, address operator)"],Rn=["function commitPlay(bytes32 _commitHash, uint256 _wagerAmount, uint8 _tierMask, address _operator) external payable returns (uint256 gameId)","function revealPlay(uint256 _gameId, uint256[] calldata _guesses, bytes32 _userSecret) external returns (uint256 prizeWon)","function claimExpired(uint256 _gameId) external","function fundPrizePool(uint256 _amount) external","function generateCommitHash(uint256[] calldata _guesses, bytes32 _userSecret) pure returns (bytes32)","function TIER_COUNT() view returns (uint8)","function BKC_FEE_BPS() view returns (uint256)","function MAX_PAYOUT_BPS() view returns (uint256)","function REVEAL_DELAY() view returns (uint256)","function REVEAL_WINDOW() view returns (uint256)","function POOL_CAP() view returns (uint256)","function getTierInfo(uint8 _tier) pure returns (uint256 range, uint256 multiplier, uint256 winChanceBps)","function getAllTiers() pure returns (uint256[3] ranges, uint256[3] multipliers, uint256[3] winChances)","function getGame(uint256 _gameId) view returns (address player, uint48 commitBlock, uint8 tierMask, uint8 status, address operator, uint96 wagerAmount)","function getGameResult(uint256 _gameId) view returns (address player, uint128 grossWager, uint128 prizeWon, uint8 tierMask, uint8 matchCount, uint48 revealBlock)","function getGameStatus(uint256 _gameId) view returns (uint8 status, bool canReveal, uint256 blocksUntilReveal, uint256 blocksUntilExpiry)","function activeGame(address _player) view returns (uint256)","function getRequiredFee(uint8 _tierMask) view returns (uint256 fee)","function calculatePotentialWinnings(uint256 _wagerAmount, uint8 _tierMask) view returns (uint256 netToPool, uint256 bkcFee, uint256 maxPrize, uint256 maxPrizeAfterCap)","function gameCounter() view returns (uint256)","function prizePool() view returns (uint256)","function getPoolStats() view returns (uint256 prizePool, uint256 totalGamesPlayed, uint256 totalBkcWagered, uint256 totalBkcWon, uint256 totalBkcForfeited, uint256 totalBkcBurned, uint256 maxPayoutNow)","event GameCommitted(uint256 indexed gameId, address indexed player, uint256 wagerAmount, uint8 tierMask, address operator)","event GameRevealed(uint256 indexed gameId, address indexed player, uint256 grossWager, uint256 prizeWon, uint8 tierMask, uint8 matchCount, address operator)","event GameDetails(uint256 indexed gameId, uint8 tierMask, uint256[] guesses, uint256[] rolls, bool[] matches)","event GameExpired(uint256 indexed gameId, address indexed player, uint256 forfeitedAmount)","event PrizePoolFunded(address indexed funder, uint256 amount)","event PoolExcessBurned(uint256 amount, uint256 newTotalBurned)"],Dl=["function balanceOf(address _owner) view returns (uint256)","function ownerOf(uint256 _tokenId) view returns (address)","function approve(address _to, uint256 _tokenId) external","function setApprovalForAll(address _operator, bool _approved) external","function transferFrom(address _from, address _to, uint256 _tokenId) external","function safeTransferFrom(address _from, address _to, uint256 _tokenId) external","function totalSupply() view returns (uint256)","function getUserBestBoost(address _user) view returns (uint256)","function getTokenInfo(uint256 _tokenId) view returns (address owner, uint8 tier, uint256 boostBips)","function getUserTokens(address _user) view returns (uint256[] tokenIds, uint8[] tiers)","function getTierBoost(uint8 _tier) pure returns (uint256)","function getTierName(uint8 _tier) pure returns (string)","event Transfer(address indexed from, address indexed to, uint256 indexed tokenId)","event Approval(address indexed owner, address indexed approved, uint256 indexed tokenId)"],_n=["function certify(bytes32 _documentHash, string _meta, uint8 _docType, address _operator) external payable returns (uint256 certId)","function batchCertify(bytes32[] _documentHashes, string[] _metas, uint8[] _docTypes, address _operator) external payable returns (uint256 startId)","function transferCertificate(bytes32 _documentHash, address _newOwner) external","function verify(bytes32 _documentHash) view returns (bool exists, address owner, uint48 timestamp, uint8 docType, string meta)","function getCertificate(uint256 _certId) view returns (bytes32 documentHash, address owner, uint48 timestamp, uint8 docType, string meta)","function getFee() view returns (uint256)","function getStats() view returns (uint256 certCount, uint256 totalEthCollected)","function certCount() view returns (uint256)","function totalEthCollected() view returns (uint256)","function MAX_BATCH_SIZE() view returns (uint8)","event Certified(uint256 indexed certId, address indexed owner, bytes32 indexed documentHash, uint8 docType, address operator)","event BatchCertified(address indexed owner, uint256 startId, uint256 count, address operator)","event CertificateTransferred(bytes32 indexed documentHash, address indexed from, address indexed to)"],Fn=["function claim() external","function canClaim(address user) view returns (bool)","function getCooldownRemaining(address user) view returns (uint256)","function getUserInfo(address user) view returns (uint256 lastClaim, uint256 claims, bool eligible, uint256 cooldownLeft)","function getFaucetStatus() view returns (uint256 ethBalance, uint256 tokenBalance, uint256 ethPerDrip, uint256 tokensPerDrip, uint256 estimatedEthClaims, uint256 estimatedTokenClaims)","function getStats() view returns (uint256 tokens, uint256 eth, uint256 claims, uint256 users)","function cooldown() view returns (uint256)","function tokensPerClaim() view returns (uint256)","function ethPerClaim() view returns (uint256)","function paused() view returns (bool)","event Claimed(address indexed recipient, uint256 tokens, uint256 eth, address indexed via)"],Mn=["function calculateFee(bytes32 _actionId, uint256 _txValue) view returns (uint256)","function bkcToken() view returns (address)","function treasury() view returns (address)","function buybackAccumulated() view returns (uint256)","function referredBy(address _user) view returns (address)","function referralCount(address _referrer) view returns (uint256)","function setReferrer(address _referrer) external","event ReferrerSet(address indexed user, address indexed referrer)","function totalEthCollected() view returns (uint256)","function totalBkcCollected() view returns (uint256)","function totalFeeEvents() view returns (uint256)","function getStats() view returns (uint256 ethCollected, uint256 bkcCollected, uint256 feeEvents, uint256 buybackEth, uint256 moduleCount)","function isAuthorized(address _contract) view returns (bool)","function moduleCount() view returns (uint256)","event FeeCollected(bytes32 indexed moduleId, address indexed user, address operator, address customRecipient, uint256 ethAmount, uint256 bkcAmount)"],Dn=["function executeBuyback() external","function executeBuybackWithSlippage(uint256 _minTotalBkcOut) external","function MAX_SUPPLY() view returns (uint256)","function MAX_MINTABLE() view returns (uint256)","function MIN_BUYBACK() view returns (uint256)","function CALLER_BPS() view returns (uint256)","function BURN_BPS() view returns (uint256)","function currentMiningRate() view returns (uint256 rateBps)","function pendingBuybackETH() view returns (uint256)","function getSupplyInfo() view returns (uint256 currentSupply, uint256 maxSupply, uint256 totalMintedViaMining, uint256 remainingMintable, uint256 miningRateBps, uint256 totalBurnedLifetime)","function previewBuyback() view returns (uint256 ethAvailable, uint256 estimatedBkcPurchased, uint256 estimatedBkcMined, uint256 estimatedBurn, uint256 estimatedToStakers, uint256 estimatedCallerReward, uint256 currentMiningRateBps, bool isReady)","function previewMiningAtSupply(uint256 _supplyLevel, uint256 _purchaseAmount) pure returns (uint256 miningAmount, uint256 rateBps)","function getBuybackStats() view returns (uint256 totalBuybacks, uint256 totalEthSpent, uint256 totalBkcPurchased, uint256 totalBkcMined, uint256 totalBkcBurned, uint256 totalBkcToStakers, uint256 totalCallerRewards, uint256 avgEthPerBuyback, uint256 avgBkcPerBuyback)","function getLastBuyback() view returns (uint256 timestamp, uint256 blockNumber, address caller, uint256 ethSpent, uint256 bkcTotal, uint256 timeSinceLast)","function totalBuybacks() view returns (uint256)","function totalEthSpent() view returns (uint256)","function totalBkcPurchased() view returns (uint256)","function totalBkcMined() view returns (uint256)","function totalBkcBurned() view returns (uint256)","function totalBkcToStakers() view returns (uint256)","function totalCallerRewards() view returns (uint256)","event BuybackExecuted(address indexed caller, uint256 indexed buybackNumber, uint256 callerReward, uint256 ethSpent, uint256 bkcPurchased, uint256 bkcMined, uint256 bkcBurned, uint256 bkcToStakers, uint256 miningRateBps)"],On=["function createCampaign(string title, string metadataUri, uint96 goal, uint256 durationDays, address operator) external payable returns (uint256)","function donate(uint256 campaignId, address operator) external payable","function boostCampaign(uint256 campaignId, address operator) external payable","function closeCampaign(uint256 campaignId) external","function withdraw(uint256 campaignId) external","function getCampaign(uint256 campaignId) view returns (address owner, uint48 deadline, uint8 status, uint96 raised, uint96 goal, uint32 donorCount, bool isBoosted, string title, string metadataUri)","function canWithdraw(uint256 campaignId) view returns (bool)","function titles(uint256 campaignId) view returns (string)","function metadataUris(uint256 campaignId) view returns (string)","function campaignCount() view returns (uint256)","function previewDonation(uint256 amount) view returns (uint256 fee, uint256 netToCampaign)","function getStats() view returns (uint256 campaignCount, uint256 totalDonated, uint256 totalWithdrawn, uint256 totalEthFees)","event CampaignCreated(uint256 indexed campaignId, address indexed owner, uint96 goal, uint48 deadline, address operator)","event DonationMade(uint256 indexed campaignId, address indexed donor, uint256 grossAmount, uint256 netAmount, address operator)","event CampaignBoosted(uint256 indexed campaignId, address indexed booster, uint48 boostExpiry, address operator)","event CampaignClosed(uint256 indexed campaignId, address indexed owner, uint96 raised)","event FundsWithdrawn(uint256 indexed campaignId, address indexed owner, uint96 amount)"],la=["function createPost(string contentHash, uint8 tag, uint8 contentType, address operator) external payable","function createReply(uint256 parentId, string contentHash, uint8 contentType, address operator) external payable","function createRepost(uint256 originalId, string contentHash, address operator) external payable","function deletePost(uint256 postId) external","function changeTag(uint256 postId, uint8 newTag) external","function like(uint256 postId, address operator) external payable","function superLike(uint256 postId, address operator) external payable","function downvote(uint256 postId, address operator) external payable","function follow(address user, address operator) external payable","function unfollow(address user) external","function createProfile(string username, string metadataURI, address operator) external payable","function updateProfile(string metadataURI) external","function pinPost(uint256 postId) external","function boostProfile(address operator) external payable","function obtainBadge(address operator) external payable","function VOTE_PRICE() view returns (uint256)","function TAG_COUNT() view returns (uint8)","function postCounter() view returns (uint256)","function totalProfiles() view returns (uint256)","function getPost(uint256 postId) view returns (address author, uint8 tag, uint8 contentType, bool deleted, uint32 createdAt, uint256 replyTo, uint256 repostOf, uint256 likes, uint256 superLikes, uint256 downvotes, uint256 replies, uint256 reposts)","function getUserProfile(address user) view returns (bytes32 usernameHash, string metadataURI, uint256 pinned, bool boosted, bool hasBadge, uint64 boostExp, uint64 badgeExp)","function isProfileBoosted(address user) view returns (bool)","function hasTrustBadge(address user) view returns (bool)","function isUsernameAvailable(string username) view returns (bool)","function getUsernamePrice(uint256 length) pure returns (uint256)","function hasLiked(uint256 postId, address user) view returns (bool)","function getOperatorStats(address operator) view returns (uint256 posts_, uint256 engagement)","function getGlobalStats() view returns (uint256 totalPosts, uint256 totalProfiles, uint256[15] tagCounts)","function version() pure returns (string)","event PostCreated(uint256 indexed postId, address indexed author, uint8 tag, uint8 contentType, string contentHash, address operator)","event ReplyCreated(uint256 indexed postId, uint256 indexed parentId, address indexed author, uint8 tag, uint8 contentType, string contentHash, address operator)","event RepostCreated(uint256 indexed postId, uint256 indexed originalId, address indexed author, uint8 tag, string contentHash, address operator)","event PostDeleted(uint256 indexed postId, address indexed author)","event Liked(uint256 indexed postId, address indexed liker, address indexed author, address operator)","event SuperLiked(uint256 indexed postId, address indexed voter, address indexed author, uint256 count, address operator)","event Downvoted(uint256 indexed postId, address indexed voter, address indexed author, uint256 count, address operator)","event Followed(address indexed follower, address indexed followed, address operator)","event Unfollowed(address indexed follower, address indexed followed)","event ProfileCreated(address indexed user, string username, string metadataURI, address operator)","event ProfileUpdated(address indexed user, string metadataURI)","event ProfileBoosted(address indexed user, uint256 daysAdded, uint64 expiresAt, address operator)","event BadgeObtained(address indexed user, uint64 expiresAt, address operator)"];let To=0;const xu=5e3;async function Ol(){try{return window.ethereum?await window.ethereum.request({method:"eth_chainId"})===we.chainId:!1}catch(e){return console.warn("Network check failed:",e.message),!1}}async function aa(){if(!window.ethereum)return console.warn("MetaMask not detected"),!1;try{return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:we.chainId,chainName:we.chainName,nativeCurrency:we.nativeCurrency,rpcUrls:we.rpcUrls,blockExplorerUrls:we.blockExplorerUrls}]}),console.log("✅ MetaMask network config updated"),!0}catch(e){return e.code===4001?(console.log("User rejected network update"),!1):(console.warn("Could not update MetaMask network:",e.message),!1)}}async function Hl(){if(!window.ethereum)return console.warn("MetaMask not detected"),!1;try{return await window.ethereum.request({method:"wallet_switchEthereumChain",params:[{chainId:we.chainId}]}),console.log("✅ Switched to Arbitrum Sepolia"),!0}catch(e){return e.code===4902?(console.log("🔄 Network not found, adding..."),await aa()):e.code===4001?(console.log("User rejected network switch"),!1):(console.error("Network switch error:",e),!1)}}async function Na(){var e;if(!window.ethereum)return{healthy:!1,reason:"no_provider"};try{const t=new window.ethers.BrowserProvider(window.ethereum),a=new Promise((s,i)=>setTimeout(()=>i(new Error("timeout")),5e3)),n=t.getBlockNumber();return await Promise.race([n,a]),{healthy:!0}}catch(t){const a=((e=t==null?void 0:t.message)==null?void 0:e.toLowerCase())||"";return a.includes("timeout")?{healthy:!1,reason:"timeout"}:a.includes("too many")||a.includes("rate limit")||a.includes("-32002")?{healthy:!1,reason:"rate_limited"}:a.includes("failed to fetch")||a.includes("network")?{healthy:!1,reason:"network_error"}:{healthy:!1,reason:"unknown",error:a}}}async function Ul(){const e=Date.now();if(e-To<xu)return{success:!0,skipped:!0};if(To=e,!window.ethereum)return{success:!1,error:"MetaMask not detected"};try{if(!await Ol()&&(console.log("🔄 Wrong network detected, switching..."),!await Hl()))return{success:!1,error:"Please switch to Arbitrum Sepolia network"};const a=await Na();if(!a.healthy&&(console.log(`⚠️ RPC unhealthy (${a.reason}), updating MetaMask config...`),await aa())){await new Promise(i=>setTimeout(i,1e3));const s=await Na();return s.healthy?{success:!0,fixed:!0}:{success:!1,error:"Network is congested. Please try again in a moment.",rpcReason:s.reason}}return{success:!0}}catch(t){return console.error("Network config error:",t),{success:!1,error:t.message}}}function jl(e){window.ethereum&&window.ethereum.on("chainChanged",async t=>{console.log("🔄 Network changed to:",t);const a=t===we.chainId;e&&e({chainId:t,isCorrectNetwork:a,needsSwitch:!a})})}const Gl=Object.freeze(Object.defineProperty({__proto__:null,IPFS_GATEWAYS:gn,METAMASK_NETWORK_CONFIG:we,RPC_ENDPOINTS:bt,addresses:v,agoraABI:la,bkcTokenABI:Sn,boosterTiers:xe,buybackMinerABI:Dn,charityPoolABI:On,checkRpcHealth:Na,contractAddresses:F,ecosystemManagerABI:Mn,ensureCorrectNetworkConfig:Ul,faucetABI:Fn,fortunePoolABI:Rn,getBurnRateFromBoost:Ml,getCurrentRpcUrl:ta,getKeepRateFromBoost:st,getTierByBoost:Fl,ipfsGateway:Rl,isCorrectNetwork:Ol,loadAddresses:_l,markRpcHealthy:Sl,markRpcUnhealthy:$l,nftPoolABI:oi,notaryABI:_n,rentalManagerABI:oa,resetToPrimaryRpc:Ll,rewardBoosterABI:Dl,sepoliaRpcUrl:ii,setupNetworkChangeListener:jl,stakingPoolABI:Ln,switchToCorrectNetwork:Hl,switchToNextRpc:ri,updateMetaMaskNetwork:aa},Symbol.toStringTag,{value:"Module"})),Wl=window.ethers,hu=5e3,vu=6e4,wu=3e4,yu=3e4,ku=6e4;let Es=null,Co=0;const Io=new Map,Ts=new Map,Ao=new Map,Po=e=>new Promise(t=>setTimeout(t,e));async function Hn(e,t){const a=new AbortController,n=setTimeout(()=>a.abort(),t);try{const s=await fetch(e,{signal:a.signal});return clearTimeout(n),s}catch(s){throw clearTimeout(n),s.name==="AbortError"?new Error("API request timed out."):s}}const qe={getHistory:"https://gethistory-4wvdcuoouq-uc.a.run.app",getBoosters:"https://getboosters-4wvdcuoouq-uc.a.run.app",getSystemData:"https://getsystemdata-4wvdcuoouq-uc.a.run.app",getNotaryHistory:"https://getnotaryhistory-4wvdcuoouq-uc.a.run.app",getRentalListings:"https://getrentallistings-4wvdcuoouq-uc.a.run.app",getUserRentals:"https://getuserrentals-4wvdcuoouq-uc.a.run.app",fortuneGames:"https://getfortunegames-4wvdcuoouq-uc.a.run.app",uploadFileToIPFS:"/api/upload",claimAirdrop:"https://us-central1-airdropbackchainnew.cloudfunctions.net/claimAirdrop"};function Kl(e){var t;return((t=e==null?void 0:e.error)==null?void 0:t.code)===429||(e==null?void 0:e.code)===429||e.message&&(e.message.includes("429")||e.message.includes("Too Many Requests")||e.message.includes("rate limit"))}function Yl(e){var a,n;const t=((a=e==null?void 0:e.error)==null?void 0:a.code)||(e==null?void 0:e.code);return t===-32603||t===-32e3||((n=e.message)==null?void 0:n.includes("Internal JSON-RPC"))}function Un(e,t,a){if(a)return a;if(!e||!c.publicProvider)return null;try{return new Wl.Contract(e,t,c.publicProvider)}catch{return null}}const ne=async(e,t,a=[],n=0n,s=2,i=!1)=>{if(!e)return n;const r=e.target||e.address,o=JSON.stringify(a,(m,p)=>typeof p=="bigint"?p.toString():p),l=`${r}-${t}-${o}`,d=Date.now(),u=["getPoolInfo","getBuyPrice","getSellPrice","getAvailableTokenIds","getAllListedTokenIds","tokenURI","tokenTier","getTokenInfo","getListing","balanceOf","totalSupply","totalPStake","MAX_SUPPLY","TGE_SUPPLY","userTotalPStake","pendingRewards","isRented","getRental","ownerOf","getDelegationsOf","allowance","getPoolStats","getAllTiers","getUserSummary","getUserBestBoost"];if(!i&&u.includes(t)){const m=Io.get(l);if(m&&d-m.timestamp<wu)return m.value}for(let m=0;m<=s;m++)try{const p=await e[t](...a);return u.includes(t)&&Io.set(l,{value:p,timestamp:d}),p}catch(p){if(Kl(p)&&m<s){const g=Math.floor(Math.random()*1e3),b=1e3*Math.pow(2,m)+g;await Po(b);continue}if(Yl(p)&&m<s){await Po(500);continue}break}return n},Eu=async(e,t,a=!1)=>{const n=`balance-${(e==null?void 0:e.target)||(e==null?void 0:e.address)}-${t}`,s=Date.now();if(!a){const r=Ao.get(n);if(r&&s-r.timestamp<ku)return r.value}const i=await ne(e,"balanceOf",[t],0n,2,a);return Ao.set(n,{value:i,timestamp:s}),i};async function Vl(){c.systemFees||(c.systemFees={}),c.systemPStakes||(c.systemPStakes={}),c.boosterDiscounts||(c.boosterDiscounts={});const e=Date.now();if(Es&&e-Co<vu)return zo(Es),!0;try{const t=await Hn(qe.getSystemData,hu);if(!t.ok)throw new Error(`API Status: ${t.status}`);const a=await t.json();return zo(a),Es=a,Co=e,!0}catch{return c.systemFees.NOTARY_SERVICE||(c.systemFees.NOTARY_SERVICE=100n),c.systemFees.CLAIM_REWARD_FEE_BIPS||(c.systemFees.CLAIM_REWARD_FEE_BIPS=500n),!1}}function zo(e){if(e.fees)for(const t in e.fees)try{c.systemFees[t]=BigInt(e.fees[t])}catch{c.systemFees[t]=0n}if(e.pStakeRequirements)for(const t in e.pStakeRequirements)try{c.systemPStakes[t]=BigInt(e.pStakeRequirements[t])}catch{c.systemPStakes[t]=0n}if(e.discounts)for(const t in e.discounts)try{c.boosterDiscounts[t]=BigInt(e.discounts[t])}catch{c.boosterDiscounts[t]=0n}if(e.oracleFeeInWei){c.systemData=c.systemData||{};try{c.systemData.oracleFeeInWei=BigInt(e.oracleFeeInWei)}catch{c.systemData.oracleFeeInWei=0n}}}async function ql(){!c.publicProvider||!c.bkcTokenContractPublic||await Promise.allSettled([ne(c.bkcTokenContractPublic,"totalSupply",[],0n),Vl()])}async function jn(e=!1){var t,a,n;if(!(!c.isConnected||!c.userAddress))try{const s=(a=(t=c.bkcTokenContractPublic)==null?void 0:t.runner)==null?void 0:a.provider,[i,r]=await Promise.allSettled([Eu(c.bkcTokenContractPublic||c.bkcTokenContract,c.userAddress,e),(n=s||c.provider)==null?void 0:n.getBalance(c.userAddress)]);i.status==="fulfilled"&&(c.currentUserBalance=i.value),r.status==="fulfilled"&&(c.currentUserNativeBalance=r.value),await $t(e);const o=c.stakingPoolContractPublic||c.stakingPoolContract;if(o){const l=await ne(o,"userTotalPStake",[c.userAddress],0n,2,e);c.userTotalPStake=l}}catch(s){console.error("Error loading user data:",s)}}async function Tu(e=!1){const t=c.stakingPoolContractPublic||c.stakingPoolContract;if(!c.isConnected||!t)return[];try{const a=await ne(t,"getDelegationsOf",[c.userAddress],[],2,e);return c.userDelegations=a.map((n,s)=>({amount:n.amount||n[0]||0n,pStake:n.pStake||n[1]||0n,lockEnd:Number(n.lockEnd||n[2]||0),lockDays:Number(n.lockDays||n[3]||0),rewardDebt:n.rewardDebt||n[4]||0n,unlockTime:BigInt(n.lockEnd||n[2]||0),lockDuration:BigInt(n.lockDays||n[3]||0)*86400n,index:s})),c.userDelegations}catch(a){return console.error("Error loading delegations:",a),[]}}async function Xl(e=!1){let t=[];try{const n=await Hn(qe.getRentalListings,4e3);n.ok&&(t=await n.json())}catch{}if(t&&t.length>0){const n=t.map(s=>{var r,o,l,d,u;const i=xe.find(m=>m.boostBips===Number(s.boostBips||0));return{...s,tokenId:((r=s.tokenId)==null?void 0:r.toString())||((o=s.id)==null?void 0:o.toString()),pricePerHour:((l=s.pricePerHour)==null?void 0:l.toString())||((d=s.price)==null?void 0:d.toString())||"0",totalEarnings:((u=s.totalEarnings)==null?void 0:u.toString())||"0",rentalCount:Number(s.rentalCount||0),img:(i==null?void 0:i.img)||"./assets/nft.png",name:(i==null?void 0:i.name)||"Booster NFT"}});return c.rentalListings=n,n}const a=Un(v.rentalManager,oa,c.rentalManagerContractPublic);if(!a)return c.rentalListings=[],[];try{const n=await ne(a,"getAllListedTokenIds",[],[],2,!0);if(!n||n.length===0)return c.rentalListings=[],[];const i=n.slice(0,30).map(async l=>{var d,u,m,p,g,b;try{const w=await ne(a,"getListing",[l],null,1,!0);if(w&&w.owner!==Wl.ZeroAddress){const y=await ne(a,"getRental",[l],null,1,!0),C=await Zl(l),I=Math.floor(Date.now()/1e3),z=y&&BigInt(y.endTime||0)>BigInt(I);return{tokenId:l.toString(),owner:w.owner,pricePerHour:((d=w.pricePerHour)==null?void 0:d.toString())||((u=w.price)==null?void 0:u.toString())||"0",minHours:((m=w.minHours)==null?void 0:m.toString())||"1",maxHours:((p=w.maxHours)==null?void 0:p.toString())||"1",totalEarnings:((g=w.totalEarnings)==null?void 0:g.toString())||"0",rentalCount:Number(w.rentalCount||0),boostBips:C.boostBips,img:C.img||"./assets/nft.png",name:C.name,isRented:z,currentTenant:z?y.tenant:null,rentalEndTime:z?(b=y.endTime)==null?void 0:b.toString():null}}}catch{}return null}),o=(await Promise.all(i)).filter(l=>l!==null);return c.rentalListings=o,o}catch{return c.rentalListings=[],[]}}async function Cu(e=!1){var a,n;if(!c.userAddress)return c.myRentals=[],[];try{const s=await Hn(`${qe.getUserRentals}/${c.userAddress}`,4e3);if(s.ok){const r=(await s.json()).map(o=>{const l=xe.find(d=>d.boostBips===Number(o.boostBips||0));return{...o,img:(l==null?void 0:l.img)||"./assets/nft.png",name:(l==null?void 0:l.name)||"Booster NFT"}});return c.myRentals=r,r}}catch{}const t=Un(v.rentalManager,oa,c.rentalManagerContractPublic);if(!t)return c.myRentals=[],[];try{const s=await ne(t,"getAllListedTokenIds",[],[],2,e),i=[],r=Math.floor(Date.now()/1e3);for(const o of s.slice(0,30))try{const l=await ne(t,"getRental",[o],null,1,e);if(l&&((a=l.tenant)==null?void 0:a.toLowerCase())===c.userAddress.toLowerCase()&&(l.isActive||BigInt(l.endTime||0)>BigInt(r))){const d=await Zl(o);i.push({tokenId:o.toString(),tenant:l.tenant,endTime:((n=l.endTime)==null?void 0:n.toString())||"0",isActive:l.isActive,boostBips:d.boostBips,img:d.img,name:d.name})}}catch{}return c.myRentals=i,i}catch{return c.myRentals=[],[]}}let Va=null,Bo=0;const Iu=3e4;async function Jl(e=!1){const t=Date.now();if(!e&&Va&&t-Bo<Iu)return Va;await $t(e);let a=0,n=null,s="none";if(c.myBoosters&&c.myBoosters.length>0){const l=c.myBoosters.reduce((d,u)=>u.boostBips>d.boostBips?u:d,c.myBoosters[0]);l.boostBips>a&&(a=l.boostBips,n=l.tokenId,s="owned")}if(c.myRentals&&c.myRentals.length>0){const l=c.myRentals.reduce((d,u)=>u.boostBips>d.boostBips?u:d,c.myRentals[0]);l.boostBips>a&&(a=l.boostBips,n=l.tokenId,s="rented")}const i=xe.find(l=>l.boostBips===a),r=(i==null?void 0:i.image)||(i==null?void 0:i.realImg)||(i==null?void 0:i.img)||"assets/bkc_logo_3d.png",o=i!=null&&i.name?`${i.name} Booster`:s!=="none"?"Booster NFT":"None";return Va={highestBoost:a,boostName:o,imageUrl:r,tokenId:n?n.toString():null,source:s},Bo=Date.now(),Va}async function Zl(e){const t=["function getTokenInfo(uint256) view returns (address owner, uint8 tier, uint256 boostBips)","function tokenTier(uint256) view returns (uint8)"],a=Un(v.rewardBooster,t,c.rewardBoosterContractPublic);if(!a)return{boostBips:0,img:"assets/bkc_logo_3d.png",name:"Unknown"};try{const n=await ne(a,"getTokenInfo",[e],null);if(n){const s=Number(n.boostBips||n[2]||0),i=xe.find(r=>r.boostBips===s);return{boostBips:s,img:(i==null?void 0:i.image)||(i==null?void 0:i.img)||"./assets/nft.png",name:(i==null?void 0:i.name)||`Booster #${e}`}}return{boostBips:0,img:"assets/bkc_logo_3d.png",name:"Unknown"}}catch{return{boostBips:0,img:"assets/bkc_logo_3d.png",name:"Unknown"}}}async function li(){const e=c.stakingPoolContractPublic||c.stakingPoolContract;if(!c.isConnected||!e)return{stakingRewards:0n,minerRewards:0n,totalRewards:0n};try{const t=await ne(e,"pendingRewards",[c.userAddress],0n);return{stakingRewards:t,minerRewards:0n,totalRewards:t}}catch{return{stakingRewards:0n,minerRewards:0n,totalRewards:0n}}}async function Au(){const e=c.stakingPoolContractPublic||c.stakingPoolContract;if(!e||!c.userAddress)return{netClaimAmount:0n,feeAmount:0n,discountPercent:0,totalRewards:0n,burnRateBps:0,nftBoost:0};const{totalRewards:t}=await li();if(t===0n)return{netClaimAmount:0n,feeAmount:0n,discountPercent:0,totalRewards:0n,burnRateBps:0,nftBoost:0};try{const a=await ne(e,"previewClaim",[c.userAddress],null);if(a){const n=a.totalRewards||a[0]||0n,s=a.burnAmount||a[1]||0n,i=a.referrerCut||a[2]||0n,r=a.userReceives||a[3]||0n,o=Number(a.burnRateBps||a[4]||0),l=Number(a.nftBoost||a[5]||0),d=s+i;return console.log("[Data] V9 Claim preview:",{totalRewards:Number(n)/1e18,burnAmount:Number(s)/1e18,referrerCut:Number(i)/1e18,userReceives:Number(r)/1e18,burnRateBps:o,nftBoost:l}),{netClaimAmount:r,feeAmount:d,burnAmount:s,referrerCut:i,discountPercent:l/100,totalRewards:n,burnRateBps:o,nftBoost:l,baseFeeBips:5e3,finalFeeBips:o}}}catch(a){console.error("[Data] previewClaim error:",a)}return{netClaimAmount:t,feeAmount:0n,discountPercent:0,totalRewards:t,burnRateBps:0,nftBoost:0}}let Cs=!1,Is=0,qa=0;const Pu=3e4,zu=3,Bu=12e4;async function $t(e=!1){if(!c.userAddress)return[];const t=Date.now();if(Cs)return c.myBoosters||[];if(!e&&t-Is<Pu)return c.myBoosters||[];if(qa>=zu){if(t-Is<Bu)return c.myBoosters||[];qa=0}Cs=!0,Is=t;try{const a=await Hn(`${qe.getBoosters}/${c.userAddress}`,5e3);if(!a.ok)throw new Error(`API Error: ${a.status}`);let n=await a.json();const s=["function ownerOf(uint256) view returns (address)","function getTokenInfo(uint256) view returns (address owner, uint8 tier, uint256 boostBips)"],i=Un(v.rewardBooster,s,c.rewardBoosterContractPublic);if(i&&n.length>0){const r=await Promise.all(n.slice(0,50).map(async o=>{const l=BigInt(o.tokenId),d=`ownerOf-${l}`,u=Date.now();let m=Number(o.boostBips||o.boost||0);if(m===0)try{const p=await i.getTokenInfo(l);m=Number(p.boostBips||p[2]||0)}catch{}if(!e&&Ts.has(d)){const p=Ts.get(d);if(u-p.timestamp<yu)return p.owner.toLowerCase()===c.userAddress.toLowerCase()?{tokenId:l,boostBips:m,imageUrl:o.imageUrl||o.image||null}:null}try{const p=await i.ownerOf(l);return Ts.set(d,{owner:p,timestamp:u}),p.toLowerCase()===c.userAddress.toLowerCase()?{tokenId:l,boostBips:m,imageUrl:o.imageUrl||o.image||null}:null}catch(p){return Kl(p)||Yl(p)?{tokenId:l,boostBips:m,imageUrl:o.imageUrl||o.image||null}:null}}));c.myBoosters=r.filter(o=>o!==null)}else c.myBoosters=n.map(r=>({tokenId:BigInt(r.tokenId),boostBips:Number(r.boostBips||r.boost||0),imageUrl:r.imageUrl||r.image||null}));return qa=0,c.myBoosters}catch{return qa++,c.myBoosters||(c.myBoosters=[]),c.myBoosters}finally{Cs=!1}}const Nu={apiKey:"AIzaSyDKhF2_--fKtot96YPS8twuD0UoCpS-3T4",authDomain:"airdropbackchainnew.firebaseapp.com",projectId:"airdropbackchainnew",storageBucket:"airdropbackchainnew.appspot.com",messagingSenderId:"108371799661",appId:"1:108371799661:web:d126fcbd0ba56263561964",measurementId:"G-QD9EBZ0Y09"},Ql=nu(Nu),Xa=su(Ql),Y=ou(Ql);let pt=null,ze=null,Ja=null;async function ec(e){if(!e)throw new Error("Wallet address is required for Firebase sign-in.");const t=e.toLowerCase();return ze=t,pt?(Ja=await wa(t),pt):Xa.currentUser?(pt=Xa.currentUser,Ja=await wa(t),pt):new Promise((a,n)=>{const s=iu(Xa,async i=>{if(s(),i){pt=i;try{Ja=await wa(t),a(i)}catch(r){console.error("Error linking airdrop user profile:",r),n(r)}}else ru(Xa).then(async r=>{pt=r.user,Ja=await wa(t),a(pt)}).catch(r=>{console.error("Firebase Anonymous sign-in failed:",r),n(r)})},i=>{console.error("Firebase Auth state change error:",i),s(),n(i)})})}function ot(){if(!pt)throw new Error("User not authenticated with Firebase. Please sign-in first.");if(!ze)throw new Error("Wallet address not set. Please connect wallet first.")}async function ci(){const e=ce(Y,"airdrop_public_data","data_v1"),t=await $e(e);if(t.exists()){const a=t.data(),n=(a.dailyTasks||[]).map(r=>{var d,u;const o=(d=r.startDate)!=null&&d.toDate?r.startDate.toDate():r.startDate?new Date(r.startDate):null,l=(u=r.endDate)!=null&&u.toDate?r.endDate.toDate():r.endDate?new Date(r.endDate):null;return{...r,id:r.id||null,startDate:o instanceof Date&&!isNaN(o)?o:null,endDate:l instanceof Date&&!isNaN(l)?l:null}}).filter(r=>r.id),s=Date.now(),i=n.filter(r=>{const o=r.startDate?r.startDate.getTime():0,l=r.endDate?r.endDate.getTime():1/0;return o<=s&&s<l});return{config:a.config||{ugcBasePoints:{}},leaderboards:a.leaderboards||{top100ByPoints:[],top100ByPosts:[],lastUpdated:null},dailyTasks:i,platformUsageConfig:a.platformUsageConfig||null}}else return console.warn("Public airdrop data document 'airdrop_public_data/data_v1' not found. Returning defaults."),{config:{isActive:!1,roundName:"Loading...",ugcBasePoints:{}},leaderboards:{top100ByPoints:[],top100ByPosts:[],lastUpdated:null},dailyTasks:[],platformUsageConfig:null}}function No(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";let t="";for(let a=0;a<6;a++)t+=e.charAt(Math.floor(Math.random()*e.length));return t}function xn(e){return e>=100?10:e>=90?9:e>=80?8:e>=70?7:e>=60?6:e>=50?5:e>=40?4:e>=30?3:e>=20?2:1}async function wa(e){ot(),e||(e=ze);const t=e.toLowerCase(),a=ce(Y,"airdrop_users",t),n=await $e(a);if(n.exists()){const s=n.data(),i={};if(s.referralCode||(i.referralCode=No()),typeof s.approvedSubmissionsCount!="number"&&(i.approvedSubmissionsCount=0),typeof s.rejectedCount!="number"&&(i.rejectedCount=0),typeof s.isBanned!="boolean"&&(i.isBanned=!1),typeof s.totalPoints!="number"&&(i.totalPoints=0),typeof s.pointsMultiplier!="number"&&(i.pointsMultiplier=1),s.walletAddress!==t&&(i.walletAddress=t),Object.keys(i).length>0)try{return await Nn(a,i),{id:n.id,...s,...i}}catch(r){return console.error("Error updating user default fields:",r),{id:n.id,...s}}return{id:n.id,...s}}else{const s=No(),i={walletAddress:t,referralCode:s,totalPoints:0,pointsMultiplier:1,approvedSubmissionsCount:0,rejectedCount:0,isBanned:!1,createdAt:yt()};return await $n(a,i),{id:a.id,...i,createdAt:new Date}}}async function tc(e,t){if(ot(),!e||typeof e!="string"||e.trim()==="")return console.warn(`isTaskEligible called with invalid taskId: ${e}`),{eligible:!1,timeLeft:0};const a=ce(Y,"airdrop_users",ze,"task_claims",e),n=await $e(a),s=t*60*60*1e3;if(!n.exists())return{eligible:!0,timeLeft:0};const i=n.data(),r=i==null?void 0:i.timestamp;if(typeof r!="string"||r.trim()==="")return console.warn(`Missing/invalid timestamp for task ${e}. Allowing claim.`),{eligible:!0,timeLeft:0};try{const o=new Date(r);if(isNaN(o.getTime()))return console.warn(`Invalid timestamp format for task ${e}:`,r,". Allowing claim."),{eligible:!0,timeLeft:0};const l=o.getTime(),u=Date.now()-l;return u>=s?{eligible:!0,timeLeft:0}:{eligible:!1,timeLeft:s-u}}catch(o){return console.error(`Error parsing timestamp string for task ${e}:`,r,o),{eligible:!0,timeLeft:0}}}async function $u(e,t){if(ot(),!e||!e.id)throw new Error("Invalid task data provided.");if(!(await tc(e.id,e.cooldownHours)).eligible)throw new Error("Cooldown period is still active for this task.");const n=ce(Y,"airdrop_users",ze),s=Math.round(e.points);if(isNaN(s)||s<0)throw new Error("Invalid points value for the task.");await Nn(n,{totalPoints:Ge(s)});const i=ce(Y,"airdrop_users",ze,"task_claims",e.id);return await $n(i,{timestamp:new Date().toISOString(),points:s}),s}async function Su(e){var o;const t=e.trim().toLowerCase();let a="Other",n=!0;if(t.includes("youtube.com/shorts/")){a="YouTube Shorts";const l=t.match(/\/shorts\/([a-zA-Z0-9_-]+)/);if(!l||!l[1])throw n=!1,new Error("Invalid YouTube Shorts URL: Video ID not found or incorrect format.")}else if(t.includes("youtube.com/watch?v=")||t.includes("youtu.be/")){a="YouTube";const l=t.match(/(?:v=|\/)([a-zA-Z0-9_-]{11})(?:[?&]|$)/);if(!l||l[1].length!==11)throw n=!1,new Error("Invalid YouTube URL: Video ID not found or incorrect format.")}else{if(t.includes("youtube.com/"))throw a="YouTube",n=!1,new Error("Invalid YouTube URL: Only video links (youtube.com/watch?v=... or youtu.be/...) or Shorts links are accepted.");if(t.includes("instagram.com/p/")||t.includes("instagram.com/reel/")){a="Instagram";const l=t.match(/\/(?:p|reel)\/([a-zA-Z0-9_.-]+)/);(!l||!l[1])&&(n=!1)}else t.includes("twitter.com/")||t.includes("x.com/")?t.match(/(\w+)\/(?:status|statuses)\/(\d+)/)&&(a="X/Twitter"):t.includes("facebook.com/")&&t.includes("/posts/")?a="Facebook":t.includes("t.me/")||t.includes("telegram.org/")?a="Telegram":t.includes("tiktok.com/")?a="TikTok":t.includes("reddit.com/r/")?a="Reddit":t.includes("linkedin.com/posts/")&&(a="LinkedIn")}const i=((o=(await ci()).config)==null?void 0:o.ugcBasePoints)||{},r=i[a]||i.Other||1e3;if(isNaN(r)||r<0)throw new Error(`Invalid base points configured for platform: ${a}. Please contact admin.`);return{platform:a,basePoints:r,isValid:n,normalizedUrl:t}}async function Lu(e){var j;ot();const t=ce(Y,"airdrop_users",ze),a=nt(Y,"airdrop_users",ze,"submissions"),n=nt(Y,"all_submissions_log"),s=e.trim();if(!s||!s.toLowerCase().startsWith("http://")&&!s.toLowerCase().startsWith("https://"))throw new Error("The provided URL must start with http:// or https://.");let i;try{i=await Su(s)}catch(H){throw H}const{platform:r,basePoints:o,isValid:l,normalizedUrl:d}=i;if(!l)throw new Error(`The provided URL for ${r} does not appear valid for submission.`);const u=Ht(a,ra("submittedAt","desc"),lu(1)),m=await wt(u);if(!m.empty){const de=(j=m.docs[0].data().submittedAt)==null?void 0:j.toDate();if(de){const se=new Date,q=5*60*1e3,oe=se.getTime()-de.getTime();if(oe<q){const Re=q-oe,It=Math.ceil(Re/6e4);throw new Error(`We're building a strong community, and we value quality over quantity. To prevent spam, please wait ${It} more minute(s) before submitting another post. We appreciate your thoughtful contribution!`)}}}const p=Ht(n,bn("normalizedUrl","==",d),bn("status","in",["pending","approved","auditing","flagged_suspicious"]));if(!(await wt(p)).empty)throw new Error("This content link has already been submitted. Repeatedly submitting duplicate or fraudulent content may lead to account suspension.");const b=await $e(t);if(!b.exists())throw new Error("User profile not found.");const w=b.data(),y=w.approvedSubmissionsCount||0,C=xn(y),I=Math.round(o*C),z=yt(),L={url:s,platform:r,status:"pending",basePoints:o,_pointsCalculated:I,_multiplierApplied:C,pointsAwarded:0,submittedAt:z,resolvedAt:null},B={userId:ze,walletAddress:w.walletAddress,normalizedUrl:d,platform:r,status:"pending",basePoints:o,submittedAt:z,resolvedAt:null},A=Bn(Y),_=ce(a);A.set(_,L);const D=ce(n,_.id);A.set(D,B),await A.commit()}async function Ru(){ot();const e=nt(Y,"airdrop_users",ze,"submissions"),t=Ht(e,ra("submittedAt","desc"));return(await wt(t)).docs.map(n=>{var i,r;const s=n.data();return{submissionId:n.id,...s,submittedAt:(i=s.submittedAt)!=null&&i.toDate?s.submittedAt.toDate():null,resolvedAt:(r=s.resolvedAt)!=null&&r.toDate?s.resolvedAt.toDate():null}})}async function _u(e){ot();const t=ze,a=ce(Y,"airdrop_users",t),n=ce(Y,"airdrop_users",t,"submissions",e),s=ce(Y,"all_submissions_log",e),i=await $e(n);if(!i.exists())throw new Error("Cannot confirm submission: Document not found or already processed.");const r=i.data(),o=r.status;if(o==="approved"||o==="rejected")throw new Error(`Submission is already in status: ${o}.`);let l=r._pointsCalculated,d=r._multiplierApplied;if(typeof l!="number"||isNaN(l)||l<=0){console.warn(`[ConfirmSubmission] Legacy/Invalid submission ${e} missing/invalid _pointsCalculated. Recalculating...`);const m=r.basePoints||0,p=await $e(a);if(!p.exists())throw new Error("User profile not found for recalculation.");const b=p.data().approvedSubmissionsCount||0;d=xn(b),l=Math.round(m*d),(isNaN(l)||l<=0)&&(console.warn(`[ConfirmSubmission] Recalculation failed (basePoints: ${m}). Using fallback 1000.`),l=Math.round(1e3*d))}const u=Bn(Y);u.update(a,{totalPoints:Ge(l),approvedSubmissionsCount:Ge(1)}),u.update(n,{status:"approved",pointsAwarded:l,_pointsCalculated:l,_multiplierApplied:d,resolvedAt:yt()}),await $e(s).then(m=>m.exists())&&u.update(s,{status:"approved",resolvedAt:yt()}),await u.commit()}async function ac(e){ot();const a=ce(Y,"airdrop_users",ze,"submissions",e),n=ce(Y,"all_submissions_log",e),s=await $e(a);if(!s.exists())return console.warn(`Delete submission skipped: Document ${e} not found.`);const i=s.data().status;if(i==="approved"||i==="rejected")throw new Error(`This submission was already ${i} and cannot be deleted.`);if(i==="flagged_suspicious")throw new Error("Flagged submissions must be resolved, not deleted.");const r=Bn(Y);r.update(a,{status:"deleted_by_user",resolvedAt:yt()}),await $e(n).then(o=>o.exists())&&r.update(n,{status:"deleted_by_user",resolvedAt:yt(),pointsAwarded:0}),await r.commit()}async function Fu(e){const t=ce(Y,"airdrop_public_data","data_v1");await $n(t,{config:{ugcBasePoints:e}},{merge:!0})}async function Mu(){const e=nt(Y,"daily_tasks"),t=Ht(e,ra("endDate","asc"));return(await wt(t)).docs.map(n=>{var s,i;return{id:n.id,...n.data(),startDate:(s=n.data().startDate)!=null&&s.toDate?n.data().startDate.toDate():null,endDate:(i=n.data().endDate)!=null&&i.toDate?n.data().endDate.toDate():null}})}async function Du(e){const t={...e};t.startDate instanceof Date&&(t.startDate=wo.fromDate(t.startDate)),t.endDate instanceof Date&&(t.endDate=wo.fromDate(t.endDate));const a=e.id;if(!a)delete t.id,await cu(nt(Y,"daily_tasks"),t);else{const n=ce(Y,"daily_tasks",a);delete t.id,await $n(n,t,{merge:!0})}}async function Ou(e){if(!e)throw new Error("Task ID is required for deletion.");await du(ce(Y,"daily_tasks",e))}async function Hu(){const e=nt(Y,"all_submissions_log"),t=Ht(e,bn("status","in",["pending","auditing","flagged_suspicious"]),ra("submittedAt","desc"));return(await wt(t)).docs.map(n=>{var i,r;const s=n.data();return{userId:s.userId,walletAddress:s.walletAddress,submissionId:n.id,...s,submittedAt:(i=s.submittedAt)!=null&&i.toDate?s.submittedAt.toDate():null,resolvedAt:(r=s.resolvedAt)!=null&&r.toDate?s.resolvedAt.toDate():null}})}async function nc(e,t,a){var C,I,z;if(!e)throw new Error("User ID (walletAddress) is required.");const n=e.toLowerCase(),s=ce(Y,"airdrop_users",n),i=ce(Y,"airdrop_users",n,"submissions",t),r=ce(Y,"all_submissions_log",t),[o,l,d]=await Promise.all([$e(s),$e(i),$e(r)]);if(!l.exists())throw new Error("Submission not found in user collection.");if(!o.exists())throw new Error("User profile not found.");d.exists()||console.warn(`Log entry ${t} not found. Log will not be updated.`);const u=l.data(),m=o.data(),p=u.status;if(p===a){console.warn(`Admin action ignored: Submission ${t} already has status ${a}.`);return}const g=Bn(Y),b={};let w=0,y=u._multiplierApplied||0;if(a==="approved"){let L=u._pointsCalculated;if(typeof L!="number"||isNaN(L)||L<=0){console.warn(`[Admin] Legacy/Invalid submission ${t} missing/invalid _pointsCalculated. Recalculating...`);const B=u.basePoints||0,A=m.approvedSubmissionsCount||0,_=xn(A);if(L=Math.round(B*_),isNaN(L)||L<=0){console.warn(`[Admin] Recalculation failed (basePoints: ${B}). Using fallback 1000.`);const D=xn(A);L=Math.round(1e3*D)}y=_}w=L,b.totalPoints=Ge(L),b.approvedSubmissionsCount=Ge(1),p==="rejected"&&(b.rejectedCount=Ge(-1))}else if(a==="rejected"){if(p!=="rejected"){const L=m.rejectedCount||0;b.rejectedCount=Ge(1),L+1>=3&&(b.isBanned=!0)}else if(p==="approved"){const L=u.pointsAwarded||0;b.totalPoints=Ge(-L),b.approvedSubmissionsCount=Ge(-1);const B=m.rejectedCount||0;b.rejectedCount=Ge(1),B+1>=3&&(b.isBanned=!0)}w=0}if(((C=b.approvedSubmissionsCount)==null?void 0:C.operand)<0&&(m.approvedSubmissionsCount||0)<=0&&(b.approvedSubmissionsCount=0),((I=b.rejectedCount)==null?void 0:I.operand)<0&&(m.rejectedCount||0)<=0&&(b.rejectedCount=0),((z=b.totalPoints)==null?void 0:z.operand)<0){const L=m.totalPoints||0,B=Math.abs(b.totalPoints.operand);L<B&&(b.totalPoints=0)}Object.keys(b).length>0&&g.update(s,b),g.update(i,{status:a,pointsAwarded:w,_pointsCalculated:a==="approved"?w:u._pointsCalculated||0,_multiplierApplied:y,resolvedAt:yt()}),d.exists()&&g.update(r,{status:a,resolvedAt:yt()}),await g.commit()}async function Uu(){const e=nt(Y,"airdrop_users"),t=Ht(e,ra("totalPoints","desc"));return(await wt(t)).docs.map(n=>({id:n.id,...n.data()}))}async function ju(e,t){if(!e)throw new Error("User ID is required.");const a=e.toLowerCase(),n=nt(Y,"airdrop_users",a,"submissions"),s=Ht(n,bn("status","==",t),ra("resolvedAt","desc"));return(await wt(s)).docs.map(r=>{var o,l;return{submissionId:r.id,userId:a,...r.data(),submittedAt:(o=r.data().submittedAt)!=null&&o.toDate?r.data().submittedAt.toDate():null,resolvedAt:(l=r.data().resolvedAt)!=null&&l.toDate?r.data().resolvedAt.toDate():null}})}async function sc(e,t){if(!e)throw new Error("User ID is required.");const a=e.toLowerCase(),n=ce(Y,"airdrop_users",a),s={isBanned:t};t===!1&&(s.rejectedCount=0),await Nn(n,s)}async function $o(){ot();try{const e=nt(Y,"airdrop_users",ze,"platform_usage"),t=await wt(e),a={};return t.forEach(n=>{a[n.id]=n.data()}),a}catch(e){return console.error("Error fetching platform usage:",e),{}}}async function ic(e){ot();const t=ce(Y,"airdrop_public_data","data_v1");await Nn(t,{platformUsageConfig:e}),console.log("✅ Platform usage config saved:",e)}const U=window.ethers,rc=421614,Gu="0x66eee";let Me=null,So=0,mt=0;const Wu=5e3,Lo=3,Ku=6e4;let di=0;const Yu=3;let oc=null;const Vu="cd4bdedee7a7e909ebd3df8bbc502aed",qu={chainId:we.chainIdDecimal,name:we.chainName,currency:we.nativeCurrency.symbol,explorerUrl:we.blockExplorerUrls[0],rpcUrl:we.rpcUrls[0]},Xu={name:"Backcoin Protocol",description:"DeFi Ecosystem",url:window.location.origin,icons:[window.location.origin+"/assets/bkc_logo_3d.png"]},Ju=tu({metadata:Xu,enableEIP6963:!0,enableInjected:!0,enableCoinbase:!1,rpcUrl:ii,defaultChainId:rc,enableEmail:!0,enableEns:!1,auth:{email:!0,showWallets:!0,walletFeatures:!0}}),Bt=au({ethersConfig:Ju,chains:[qu],projectId:Vu,enableAnalytics:!0,themeMode:"dark",themeVariables:{"--w3m-accent":"#f59e0b","--w3m-border-radius-master":"1px","--w3m-z-index":100}});function Zu(e){var n,s;const t=((n=e==null?void 0:e.message)==null?void 0:n.toLowerCase())||"",a=(e==null?void 0:e.code)||((s=e==null?void 0:e.error)==null?void 0:s.code);return a===-32603||a===-32e3||a===429||t.includes("failed to fetch")||t.includes("network error")||t.includes("timeout")||t.includes("rate limit")||t.includes("too many requests")||t.includes("internal json-rpc")||t.includes("unexpected token")||t.includes("<html")}function Ds(e){return new U.JsonRpcProvider(e||ta())}async function lc(e,t=Yu){var n;let a=null;for(let s=0;s<t;s++)try{const i=await e();return Sl(ta()),di=0,i}catch(i){if(a=i,Zu(i)){console.warn(`⚠️ RPC error (attempt ${s+1}/${t}):`,(n=i.message)==null?void 0:n.slice(0,80)),$l(ta());const r=ri();console.log(`🔄 Switching to: ${r}`),await Gn(),await new Promise(o=>setTimeout(o,500*(s+1)))}else throw i}throw console.error("❌ All RPC attempts failed"),a}async function Gn(){const e=ta();try{c.publicProvider=Ds(e),oc=c.publicProvider;const t=c.publicProvider;V(v.bkcToken)&&(c.bkcTokenContractPublic=new U.Contract(v.bkcToken,Sn,t)),V(v.backchainEcosystem)&&(c.ecosystemManagerContractPublic=new U.Contract(v.backchainEcosystem,Mn,t)),V(v.stakingPool)&&(c.stakingPoolContractPublic=new U.Contract(v.stakingPool,Ln,t)),V(v.buybackMiner)&&(c.buybackMinerContractPublic=new U.Contract(v.buybackMiner,Dn,t)),V(v.fortunePool)&&(c.fortunePoolContractPublic=new U.Contract(v.fortunePool,Rn,t)),V(v.agora)&&(c.agoraContractPublic=new U.Contract(v.agora,la,t)),V(v.notary)&&(c.notaryContractPublic=new U.Contract(v.notary,_n,t)),V(v.charityPool)&&(c.charityPoolContractPublic=new U.Contract(v.charityPool,On,t)),V(v.rentalManager)&&(c.rentalManagerContractPublic=new U.Contract(v.rentalManager,oa,t)),V(v.faucet)&&(c.faucetContractPublic=new U.Contract(v.faucet,Fn,t)),console.log(`✅ Public provider recreated with: ${e.slice(0,50)}...`)}catch(t){console.error("Failed to recreate public provider:",t)}}function Qu(e){if(!e)return!1;try{return U.isAddress(e)}catch{return!1}}function V(e){return e&&e!==U.ZeroAddress&&!e.startsWith("0x...")}function ep(e){if(!e)return;const t=localStorage.getItem(`balance_${e.toLowerCase()}`);if(t)try{c.currentUserBalance=BigInt(t),window.updateUIState&&window.updateUIState()}catch{}}function tp(e){try{const t=e;V(v.bkcToken)&&(c.bkcTokenContract=new U.Contract(v.bkcToken,Sn,t)),V(v.backchainEcosystem)&&(c.ecosystemManagerContract=new U.Contract(v.backchainEcosystem,Mn,t)),V(v.stakingPool)&&(c.stakingPoolContract=new U.Contract(v.stakingPool,Ln,t)),V(v.buybackMiner)&&(c.buybackMinerContract=new U.Contract(v.buybackMiner,Dn,t)),V(v.rewardBooster)&&(c.rewardBoosterContract=new U.Contract(v.rewardBooster,Dl,t)),V(v.fortunePool)&&(c.fortunePoolContract=new U.Contract(v.fortunePool,Rn,t)),V(v.agora)&&(c.agoraContract=new U.Contract(v.agora,la,t)),V(v.notary)&&(c.notaryContract=new U.Contract(v.notary,_n,t)),V(v.charityPool)&&(c.charityPoolContract=new U.Contract(v.charityPool,On,t)),V(v.rentalManager)&&(c.rentalManagerContract=new U.Contract(v.rentalManager,oa,t)),V(v.faucet)&&(c.faucetContract=new U.Contract(v.faucet,Fn,t))}catch{console.warn("Contract init partial failure")}}function cc(){if(Me&&(clearInterval(Me),Me=null),!c.bkcTokenContractPublic||!c.userAddress){console.warn("Cannot start balance polling: missing contract or address");return}mt=0,di=0,setTimeout(()=>{Ro()},1e3),Me=setInterval(Ro,Ku),console.log("✅ Balance polling started (30s interval)")}async function Ro(){var t;if(document.hidden||!c.isConnected||!c.userAddress||!c.bkcTokenContractPublic)return;const e=Date.now();try{const a=await lc(async()=>await c.bkcTokenContractPublic.balanceOf(c.userAddress),2);mt=0;const n=c.currentUserBalance||0n;a.toString()!==n.toString()&&(c.currentUserBalance=a,localStorage.setItem(`balance_${c.userAddress.toLowerCase()}`,a.toString()),e-So>Wu&&(So=e,window.updateUIState&&window.updateUIState(!1)))}catch(a){mt++,mt<=3&&console.warn(`⚠️ Balance check failed (${mt}/${Lo}):`,(t=a.message)==null?void 0:t.slice(0,50)),mt>=Lo&&(console.warn("❌ Too many balance check errors. Stopping polling temporarily."),Me&&(clearInterval(Me),Me=null),setTimeout(()=>{console.log("🔄 Attempting to restart balance polling with primary RPC..."),Ll(),Gn().then(()=>{mt=0,cc()})},6e4))}}async function ap(e){try{const t=await e.getNetwork();if(Number(t.chainId)===rc)return!0;try{return await e.send("wallet_switchEthereumChain",[{chainId:Gu}]),!0}catch{return!0}}catch{return!0}}async function _o(e,t){try{if(!Qu(t))return!1;await ap(e),c.provider=e;try{c.signer=await e.getSigner()}catch(a){c.signer=e,console.warn(`Could not get standard Signer. Using Provider as read-only. Warning: ${a.message}`)}c.userAddress=t,c.isConnected=!0,ep(t),tp(c.signer);try{ec(c.userAddress)}catch{}return jn().then(()=>{window.updateUIState&&window.updateUIState(!1)}).catch(()=>{}),cc(),!0}catch(a){return console.error("Setup warning:",a),!!t}}async function np(){try{if(window.ethereum){const a=await Ul();a.fixed?console.log("✅ MetaMask network config was auto-fixed"):!a.success&&!a.skipped&&console.warn("Initial network config check:",a.error)}const e=ta();console.log(`🌐 Initializing public provider with: ${e.slice(0,50)}...`),c.publicProvider=Ds(e),oc=c.publicProvider;const t=c.publicProvider;V(v.bkcToken)&&(c.bkcTokenContractPublic=new U.Contract(v.bkcToken,Sn,t)),V(v.backchainEcosystem)&&(c.ecosystemManagerContractPublic=new U.Contract(v.backchainEcosystem,Mn,t)),V(v.stakingPool)&&(c.stakingPoolContractPublic=new U.Contract(v.stakingPool,Ln,t)),V(v.buybackMiner)&&(c.buybackMinerContractPublic=new U.Contract(v.buybackMiner,Dn,t)),V(v.fortunePool)&&(c.fortunePoolContractPublic=new U.Contract(v.fortunePool,Rn,t)),V(v.agora)&&(c.agoraContractPublic=new U.Contract(v.agora,la,t)),V(v.notary)&&(c.notaryContractPublic=new U.Contract(v.notary,_n,t)),V(v.charityPool)&&(c.charityPoolContractPublic=new U.Contract(v.charityPool,On,t)),V(v.rentalManager)&&(c.rentalManagerContractPublic=new U.Contract(v.rentalManager,oa,t)),V(v.faucet)&&(c.faucetContractPublic=new U.Contract(v.faucet,Fn,t));try{await lc(async()=>{await ql()})}catch{console.warn("Initial public data load failed, will retry on user interaction")}jl(async a=>{a.isCorrectNetwork?(await Na()).healthy||(console.log("⚠️ RPC issues after network change, updating..."),await aa(),await Gn()):(console.log("⚠️ User switched to wrong network"),x("Please switch back to Arbitrum Sepolia","warning"))}),rp(),window.updateUIState&&window.updateUIState(),console.log("✅ Public provider initialized")}catch(e){console.error("Public provider error:",e),window.ethereum&&await aa();const t=ri();console.log(`🔄 Retrying with: ${t}`);try{c.publicProvider=Ds(t),console.log("✅ Public provider initialized with fallback RPC")}catch{console.error("❌ All RPC endpoints failed")}}}function sp(e){let t=Bt.getAddress();if(Bt.getIsConnected()&&t){const n=Bt.getWalletProvider();if(n){const s=new U.BrowserProvider(n);c.web3Provider=n,e({isConnected:!0,address:t,isNewConnection:!1}),_o(s,t)}}const a=async({provider:n,address:s,chainId:i,isConnected:r})=>{try{if(r){let o=s||Bt.getAddress();if(!o&&n)try{o=await(await new U.BrowserProvider(n).getSigner()).getAddress()}catch{}if(o){const l=new U.BrowserProvider(n);c.web3Provider=n,e({isConnected:!0,address:o,chainId:i,isNewConnection:!0}),await _o(l,o)}else Me&&clearInterval(Me),c.isConnected=!1,c.userAddress=null,c.signer=null,e({isConnected:!1})}else Me&&clearInterval(Me),c.isConnected=!1,c.userAddress=null,c.signer=null,e({isConnected:!1})}catch{}};Bt.subscribeProvider(a)}function dc(){Bt.open()}async function ip(){await Bt.disconnect()}function rp(){let e=0;document.addEventListener("visibilitychange",async()=>{if(!document.hidden&&c.isConnected){const t=Date.now();if(t-e<3e5)return;(await Na()).healthy||(e=t,console.log("⚠️ RPC unhealthy on tab focus, fixing..."),await aa(),await Gn(),mt=0,di=0)}}),console.log("✅ RPC health monitoring started (event-driven, no polling)")}const uc=window.ethers,M=(e,t=18)=>{if(e===null||typeof e>"u")return 0;if(typeof e=="number")return e;if(typeof e=="string")return parseFloat(e);try{const a=BigInt(e);return parseFloat(uc.formatUnits(a,t))}catch{return 0}},ca=e=>!e||typeof e!="string"||!e.startsWith("0x")?"...":`${e.substring(0,6)}...${e.substring(e.length-4)}`,na=e=>{try{if(e==null)return"0";const t=typeof e=="bigint"?e:BigInt(e);if(t===0n)return"0";const a=parseFloat(uc.formatEther(t));if(a===0||!isFinite(a))return"0";if(a<1e3)return a<.01?"<0.01":a%1===0?a.toString():a.toFixed(2);const n=["","k","M","B","T"],s=Math.min(Math.floor(Math.log10(a)/3),n.length-1);return(a/Math.pow(1e3,s)).toFixed(2)+n[s]}catch{return"0"}},op=(e="An error occurred.")=>`<div class="bg-red-900/20 border border-red-500/30 rounded-lg p-4 text-center text-red-400 text-sm">${e}</div>`,lp=(e="No data available.")=>`<div class="text-center p-8 bg-zinc-900/30 border border-dashed border-zinc-800 rounded-lg col-span-full">
                <i class="fa-regular fa-folder-open text-2xl text-zinc-600 mb-2"></i>
                <p class="text-zinc-500 italic text-sm">${e}</p>
            </div>`;function ui(e,t,a,n){if(!e)return;if(a<=1){e.innerHTML="";return}const s=`
    ...
    `;e.innerHTML=s,e.querySelectorAll(".pagination-btn").forEach(i=>{i.addEventListener("click",()=>{i.hasAttribute("disabled")||n(parseInt(i.dataset.page))})})}const cp="modulepreload",dp=function(e){return"/"+e},Fo={},O=function(t,a,n){let s=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),o=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));s=Promise.allSettled(a.map(l=>{if(l=dp(l),l in Fo)return;Fo[l]=!0;const d=l.endsWith(".css"),u=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${u}`))return;const m=document.createElement("link");if(m.rel=d?"stylesheet":cp,d||(m.as="script"),m.crossOrigin="",m.href=l,o&&m.setAttribute("nonce",o),document.head.appendChild(m),d)return new Promise((p,g)=>{m.addEventListener("load",p),m.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${l}`)))})}))}function i(r){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=r,window.dispatchEvent(o),!o.defaultPrevented)throw r}return s.then(r=>{for(const o of r||[])o.status==="rejected"&&i(o.reason);return t().catch(i)})},pc="/api/faucet";function Wn(){var e;return(v==null?void 0:v.faucet)||(F==null?void 0:F.faucet)||((e=window.contractAddresses)==null?void 0:e.faucet)||null}const hn=["function claim() external","function canClaim(address user) view returns (bool)","function getUserInfo(address user) view returns (uint256 lastClaim, uint256 claims, bool eligible, uint256 cooldownLeft)","function getCooldownRemaining(address user) view returns (uint256)","function cooldown() view returns (uint256)","function tokensPerClaim() view returns (uint256)","function ethPerClaim() view returns (uint256)","function paused() view returns (bool)","function getFaucetStatus() view returns (uint256 ethBalance, uint256 tokenBalance, uint256 ethPerDrip, uint256 tokensPerDrip, uint256 estimatedEthClaims, uint256 estimatedTokenClaims)","function getStats() view returns (uint256 tokens, uint256 eth, uint256 claims, uint256 users)","event Claimed(address indexed recipient, uint256 tokens, uint256 eth, address indexed via)"];function up(){var e,t;return typeof State<"u"&&(State!=null&&State.userAddress)?State.userAddress:(e=window.State)!=null&&e.userAddress?window.State.userAddress:window.userAddress?window.userAddress:(t=window.ethereum)!=null&&t.selectedAddress?window.ethereum.selectedAddress:null}function St(e,t="info"){if(typeof window.showToast=="function"){window.showToast(e,t);return}(t==="error"?console.error:console.log)(`[Faucet] ${e}`)}async function mc(){if(typeof window.loadUserData=="function"){await window.loadUserData();return}if(typeof window.refreshBalances=="function"){await window.refreshBalances();return}}async function pi({button:e=null,address:t=null,onSuccess:a=null,onError:n=null}={}){const s=t||up();if(!s){const o="Please connect wallet first";return St(o,"error"),n&&n(new Error(o)),{success:!1,error:o}}const i=(e==null?void 0:e.innerHTML)||"Claim",r=(e==null?void 0:e.disabled)||!1;e&&(e.innerHTML='<div class="loader inline-block"></div> Claiming...',e.disabled=!0);try{const o=await fetch(`${pc}?address=${s}`,{method:"GET",headers:{Accept:"application/json"}}),l=await o.json();if(o.ok&&l.success){St("Tokens received!","success"),await mc();const d={success:!0,txHash:l.txHash,bkcAmount:l.bkcAmount,ethAmount:l.ethAmount};return a&&a(d),d}else{const d=l.error||l.message||"Faucet unavailable";St(d,"error");const u=new Error(d);return n&&n(u),{success:!1,error:d}}}catch(o){return console.error("Faucet error:",o),St("Faucet unavailable","error"),n&&n(o),{success:!1,error:o.message}}finally{e&&(e.innerHTML=i,e.disabled=r)}}const Kn=async e=>await pi({button:e});async function fc({button:e=null,onSuccess:t=null,onError:a=null}={}){const n=Wn();if(!n){const i="Faucet contract address not configured";return St(i,"error"),a&&a(new Error(i)),{success:!1,error:i}}const{txEngine:s}=await O(async()=>{const{txEngine:i}=await Promise.resolve().then(()=>Z);return{txEngine:i}},void 0);return await s.execute({name:"FaucetClaim",button:e,getContract:async i=>{const r=window.ethers;return new r.Contract(n,hn,i)},method:"claim",args:[],validate:async(i,r)=>{const o=window.ethers,{NetworkManager:l}=await O(async()=>{const{NetworkManager:m}=await Promise.resolve().then(()=>Z);return{NetworkManager:m}},void 0),d=l.getProvider(),u=new o.Contract(n,hn,d);try{const m=await u.getUserInfo(r),p=m[2],g=Number(m[3]);if(!p){if(g>0){const b=Math.ceil(g/60);throw new Error(`Aguarde ${b} minutos para claimar novamente`)}throw new Error("Faucet indisponível no momento")}}catch(m){if(m.message.includes("Aguarde")||m.message.includes("indisponível"))throw m;if(!await u.canClaim(r))throw new Error("Aguarde o cooldown para claimar novamente.")}},onSuccess:async i=>{St("Tokens received!","success"),await mc(),t&&t(i)},onError:i=>{St(i.message||"Claim failed","error"),a&&a(i)}})}async function bc(e){const t=Wn();if(!t)return{canClaim:!1,error:"Faucet not configured"};try{const a=window.ethers,{NetworkManager:n}=await O(async()=>{const{NetworkManager:r}=await Promise.resolve().then(()=>Z);return{NetworkManager:r}},void 0),s=n.getProvider(),i=new a.Contract(t,hn,s);try{const r=await i.getUserInfo(e);return{canClaim:r[2],lastClaimTime:Number(r[0]),claimCount:Number(r[1]),cooldownLeft:Number(r[3]),waitSeconds:Number(r[3])}}catch{return{canClaim:await i.canClaim(e),waitSeconds:0}}}catch(a){return console.error("Error checking claim status:",a),{canClaim:!1,error:a.message}}}async function gc(){const e=Wn();if(!e)return{error:"Faucet not configured"};try{const t=window.ethers,{NetworkManager:a}=await O(async()=>{const{NetworkManager:i}=await Promise.resolve().then(()=>Z);return{NetworkManager:i}},void 0),n=a.getProvider(),s=new t.Contract(e,hn,n);try{const i=await s.getFaucetStatus(),r=i[0],o=i[1],l=i[2],d=i[3];return{bkcAmount:d,ethAmount:l,bkcAmountFormatted:t.formatEther(d),ethAmountFormatted:t.formatEther(l),bkcBalance:o,ethBalance:r,bkcBalanceFormatted:t.formatEther(o),ethBalanceFormatted:t.formatEther(r),estimatedEthClaims:Number(i[4]),estimatedTokenClaims:Number(i[5]),cooldownSeconds:Number(await s.cooldown()),cooldownMinutes:Number(await s.cooldown())/60,isPaused:await s.paused()}}catch{const[i,r,o]=await Promise.all([s.tokensPerClaim(),s.ethPerClaim(),s.cooldown()]);return{bkcAmount:i,ethAmount:r,cooldownSeconds:Number(o),cooldownMinutes:Number(o)/60,bkcAmountFormatted:t.formatEther(i),ethAmountFormatted:t.formatEther(r)}}}catch(t){return console.error("Error getting faucet info:",t),{error:t.message}}}const xc={claim:pi,claimOnChain:fc,executeFaucetClaim:Kn,canClaim:bc,getFaucetInfo:gc,getFaucetAddress:Wn,FAUCET_API_URL:pc},pp=Object.freeze(Object.defineProperty({__proto__:null,FaucetTx:xc,canClaim:bc,claim:pi,claimOnChain:fc,executeFaucetClaim:Kn,getFaucetInfo:gc},Symbol.toStringTag,{value:"Module"})),rn={BALANCE:1e4,ALLOWANCE:3e4},Ie=new Map,pe={hits:0,misses:0,sets:0,invalidations:0},ht={get(e){const t=Ie.get(e);if(!t){pe.misses++;return}if(Date.now()>t.expiresAt){Ie.delete(e),pe.misses++;return}return pe.hits++,t.value},set(e,t,a){t!=null&&(Ie.set(e,{value:t,expiresAt:Date.now()+a,createdAt:Date.now()}),pe.sets++)},delete(e){Ie.delete(e)},clear(e){if(!e){Ie.clear(),pe.invalidations++;return}for(const t of Ie.keys())t.includes(e)&&Ie.delete(t);pe.invalidations++},async getOrFetch(e,t,a){const n=this.get(e);if(n!==void 0)return n;try{const s=await t();return s!=null&&this.set(e,s,a),s}catch(s){throw console.warn(`[Cache] Error fetching ${e}:`,s.message),s}},has(e){return this.get(e)!==void 0},getTTL(e){const t=Ie.get(e);if(!t)return 0;const a=t.expiresAt-Date.now();return a>0?a:0},invalidateByTx(e){const a={CreateCampaign:["campaign-","charity-stats","user-campaigns-","campaign-list"],Donate:["campaign-","charity-stats","token-balance-","allowance-"],CancelCampaign:["campaign-","charity-stats","user-campaigns-"],Withdraw:["campaign-","charity-stats","token-balance-"],Delegate:["delegation-","token-balance-","allowance-","user-pstake-","pending-rewards-","network-pstake"],Unstake:["delegation-","token-balance-","user-pstake-","pending-rewards-","network-pstake"],ForceUnstake:["delegation-","token-balance-","user-pstake-","pending-rewards-","network-pstake"],ClaimReward:["pending-rewards-","token-balance-","saved-rewards-"],BuyNFT:["pool-info-","pool-nfts-","token-balance-","allowance-","user-nfts-","buy-price-","sell-price-"],SellNFT:["pool-info-","pool-nfts-","token-balance-","user-nfts-","buy-price-","sell-price-"],PlayGame:["fortune-pool-","fortune-stats-","token-balance-","allowance-","user-fortune-history-"],ListNFT:["rental-listings-","rental-listing-","user-nfts-"],RentNFT:["rental-listing-","rental-active-","token-balance-","allowance-"],WithdrawNFT:["rental-listing-","rental-listings-","user-nfts-"],UpdateListing:["rental-listing-"],Notarize:["notary-","token-balance-","allowance-","user-documents-"],TokenTransfer:["token-balance-","allowance-"],Approval:["allowance-"]}[e];if(!a){console.warn(`[Cache] Unknown transaction type: ${e}`);return}a.forEach(n=>{this.clear(n)}),console.log(`[Cache] Invalidated patterns for ${e}:`,a)},getStats(){const e=Ie.size,t=pe.hits+pe.misses>0?(pe.hits/(pe.hits+pe.misses)*100).toFixed(1):0;return{entries:e,hits:pe.hits,misses:pe.misses,sets:pe.sets,invalidations:pe.invalidations,hitRate:`${t}%`}},keys(){return Array.from(Ie.keys())},size(){return Ie.size},cleanup(){const e=Date.now();let t=0;for(const[a,n]of Ie.entries())e>n.expiresAt&&(Ie.delete(a),t++);return t>0&&console.log(`[Cache] Cleanup removed ${t} expired entries`),t},resetMetrics(){pe.hits=0,pe.misses=0,pe.sets=0,pe.invalidations=0}},on={tokenBalance:(e,t)=>`token-balance-${e.toLowerCase()}-${t.toLowerCase()}`,ethBalance:e=>`eth-balance-${e.toLowerCase()}`,allowance:(e,t,a)=>`allowance-${e.toLowerCase()}-${t.toLowerCase()}-${a.toLowerCase()}`,campaign:e=>`campaign-${e}`,campaignList:()=>"campaign-list",charityStats:()=>"charity-stats",userCampaigns:e=>`user-campaigns-${e.toLowerCase()}`,delegation:(e,t)=>`delegation-${e.toLowerCase()}-${t}`,delegations:e=>`delegation-list-${e.toLowerCase()}`,userPStake:e=>`user-pstake-${e.toLowerCase()}`,pendingRewards:e=>`pending-rewards-${e.toLowerCase()}`,networkPStake:()=>"network-pstake",poolInfo:e=>`pool-info-${e.toLowerCase()}`,poolNfts:e=>`pool-nfts-${e.toLowerCase()}`,buyPrice:e=>`buy-price-${e.toLowerCase()}`,sellPrice:e=>`sell-price-${e.toLowerCase()}`,userNfts:e=>`user-nfts-${e.toLowerCase()}`,fortunePool:()=>"fortune-pool",fortuneTiers:()=>"fortune-tiers",fortuneStats:()=>"fortune-stats",userFortuneHistory:e=>`user-fortune-history-${e.toLowerCase()}`,rentalListings:()=>"rental-listings",rentalListing:e=>`rental-listing-${e}`,rentalActive:e=>`rental-active-${e}`,notaryDocument:e=>`notary-doc-${e}`,userDocuments:e=>`user-documents-${e.toLowerCase()}`,feeConfig:e=>`fee-config-${e}`,protocolConfig:()=>"protocol-config"},h={WRONG_NETWORK:"wrong_network",RPC_UNHEALTHY:"rpc_unhealthy",RPC_RATE_LIMITED:"rpc_rate_limited",NETWORK_ERROR:"network_error",WALLET_NOT_CONNECTED:"wallet_not_connected",WALLET_LOCKED:"wallet_locked",INSUFFICIENT_ETH:"insufficient_eth",INSUFFICIENT_TOKEN:"insufficient_token",INSUFFICIENT_ALLOWANCE:"insufficient_allowance",SIMULATION_REVERTED:"simulation_reverted",GAS_ESTIMATION_FAILED:"gas_estimation_failed",USER_REJECTED:"user_rejected",TX_REVERTED:"tx_reverted",TX_TIMEOUT:"tx_timeout",TX_REPLACED:"tx_replaced",TX_UNDERPRICED:"tx_underpriced",NONCE_ERROR:"nonce_error",CAMPAIGN_NOT_FOUND:"campaign_not_found",CAMPAIGN_NOT_ACTIVE:"campaign_not_active",CAMPAIGN_STILL_ACTIVE:"campaign_still_active",NOT_CAMPAIGN_CREATOR:"not_campaign_creator",DONATION_TOO_SMALL:"donation_too_small",MAX_CAMPAIGNS_REACHED:"max_campaigns_reached",INSUFFICIENT_ETH_FEE:"insufficient_eth_fee",LOCK_PERIOD_ACTIVE:"lock_period_active",LOCK_PERIOD_EXPIRED:"lock_period_expired",NO_REWARDS:"no_rewards",INVALID_DURATION:"invalid_duration",INVALID_DELEGATION_INDEX:"invalid_delegation_index",NFT_NOT_IN_POOL:"nft_not_in_pool",POOL_NOT_INITIALIZED:"pool_not_initialized",INSUFFICIENT_POOL_LIQUIDITY:"insufficient_pool_liquidity",SLIPPAGE_EXCEEDED:"slippage_exceeded",NFT_BOOST_MISMATCH:"nft_boost_mismatch",NOT_NFT_OWNER:"not_nft_owner",NO_ACTIVE_TIERS:"no_active_tiers",INVALID_GUESS_COUNT:"invalid_guess_count",INVALID_GUESS_RANGE:"invalid_guess_range",INSUFFICIENT_SERVICE_FEE:"insufficient_service_fee",RENTAL_STILL_ACTIVE:"rental_still_active",NFT_NOT_LISTED:"nft_not_listed",NFT_ALREADY_LISTED:"nft_already_listed",NOT_LISTING_OWNER:"not_listing_owner",MARKETPLACE_PAUSED:"marketplace_paused",EMPTY_METADATA:"empty_metadata",CONTRACT_ERROR:"contract_error",UNKNOWN:"unknown"},ln={[h.WRONG_NETWORK]:"Please switch to Arbitrum Sepolia network",[h.RPC_UNHEALTHY]:"Network connection issue. Retrying...",[h.RPC_RATE_LIMITED]:"Network is busy. Please wait a moment...",[h.NETWORK_ERROR]:"Network error. Please check your connection",[h.WALLET_NOT_CONNECTED]:"Please connect your wallet",[h.WALLET_LOCKED]:"Please unlock your wallet",[h.INSUFFICIENT_ETH]:"Insufficient ETH for gas fees",[h.INSUFFICIENT_TOKEN]:"Insufficient BKC balance",[h.INSUFFICIENT_ALLOWANCE]:"Token approval required",[h.SIMULATION_REVERTED]:"Transaction would fail. Please check your inputs",[h.GAS_ESTIMATION_FAILED]:"Could not estimate gas. Transaction may fail",[h.USER_REJECTED]:"Transaction cancelled",[h.TX_REVERTED]:"Transaction failed on blockchain",[h.TX_TIMEOUT]:"Transaction is taking too long. Please check your wallet",[h.TX_REPLACED]:"Transaction was replaced",[h.TX_UNDERPRICED]:"Gas price too low. Please try again",[h.NONCE_ERROR]:"Transaction sequence error. Please refresh and try again",[h.CAMPAIGN_NOT_FOUND]:"Campaign not found",[h.CAMPAIGN_NOT_ACTIVE]:"This campaign is no longer accepting donations",[h.CAMPAIGN_STILL_ACTIVE]:"Campaign is still active. Please wait until the deadline",[h.NOT_CAMPAIGN_CREATOR]:"Only the campaign creator can perform this action",[h.DONATION_TOO_SMALL]:"Donation amount is below the minimum required",[h.MAX_CAMPAIGNS_REACHED]:"You have reached the maximum number of active campaigns",[h.INSUFFICIENT_ETH_FEE]:"Insufficient ETH for withdrawal fee",[h.LOCK_PERIOD_ACTIVE]:"Your tokens are still locked",[h.LOCK_PERIOD_EXPIRED]:"Lock period has expired. Use normal unstake",[h.NO_REWARDS]:"No rewards available to claim",[h.INVALID_DURATION]:"Lock duration must be between 1 day and 10 years",[h.INVALID_DELEGATION_INDEX]:"Delegation not found",[h.NFT_NOT_IN_POOL]:"This NFT is not available in the pool",[h.POOL_NOT_INITIALIZED]:"Pool is not active yet",[h.INSUFFICIENT_POOL_LIQUIDITY]:"Insufficient liquidity in pool",[h.SLIPPAGE_EXCEEDED]:"Price changed too much. Please try again",[h.NFT_BOOST_MISMATCH]:"NFT tier does not match this pool",[h.NOT_NFT_OWNER]:"You do not own this NFT",[h.NO_ACTIVE_TIERS]:"No active prize tiers available",[h.INVALID_GUESS_COUNT]:"Invalid number of guesses provided",[h.INVALID_GUESS_RANGE]:"Your guess is outside the valid range",[h.INSUFFICIENT_SERVICE_FEE]:"Incorrect service fee amount",[h.RENTAL_STILL_ACTIVE]:"This NFT is currently being rented",[h.NFT_NOT_LISTED]:"This NFT is not listed for rent",[h.NFT_ALREADY_LISTED]:"This NFT is already listed",[h.NOT_LISTING_OWNER]:"Only the listing owner can perform this action",[h.MARKETPLACE_PAUSED]:"Marketplace is temporarily paused",[h.EMPTY_METADATA]:"Document metadata cannot be empty",[h.CONTRACT_ERROR]:"Transaction cannot be completed. Please check your inputs and try again",[h.UNKNOWN]:"An unexpected error occurred. Please try again"},At={[h.WRONG_NETWORK]:{layer:1,retry:!1,action:"switch_network"},[h.RPC_UNHEALTHY]:{layer:1,retry:!0,waitMs:2e3,action:"switch_rpc"},[h.RPC_RATE_LIMITED]:{layer:1,retry:!0,waitMs:"extract",action:"switch_rpc"},[h.NETWORK_ERROR]:{layer:1,retry:!0,waitMs:3e3,action:"switch_rpc"},[h.WALLET_NOT_CONNECTED]:{layer:2,retry:!1,action:"connect_wallet"},[h.WALLET_LOCKED]:{layer:2,retry:!1,action:"unlock_wallet"},[h.INSUFFICIENT_ETH]:{layer:3,retry:!1,action:"show_faucet"},[h.INSUFFICIENT_TOKEN]:{layer:3,retry:!1},[h.INSUFFICIENT_ALLOWANCE]:{layer:3,retry:!1},[h.SIMULATION_REVERTED]:{layer:4,retry:!1},[h.GAS_ESTIMATION_FAILED]:{layer:4,retry:!0,waitMs:2e3},[h.USER_REJECTED]:{layer:5,retry:!1},[h.TX_REVERTED]:{layer:5,retry:!1},[h.TX_TIMEOUT]:{layer:5,retry:!0,waitMs:5e3},[h.TX_REPLACED]:{layer:5,retry:!1},[h.TX_UNDERPRICED]:{layer:5,retry:!0,waitMs:1e3},[h.NONCE_ERROR]:{layer:5,retry:!0,waitMs:2e3},[h.CAMPAIGN_NOT_FOUND]:{layer:4,retry:!1},[h.CAMPAIGN_NOT_ACTIVE]:{layer:4,retry:!1},[h.CAMPAIGN_STILL_ACTIVE]:{layer:4,retry:!1},[h.NOT_CAMPAIGN_CREATOR]:{layer:4,retry:!1},[h.DONATION_TOO_SMALL]:{layer:4,retry:!1},[h.MAX_CAMPAIGNS_REACHED]:{layer:4,retry:!1},[h.INSUFFICIENT_ETH_FEE]:{layer:3,retry:!1},[h.LOCK_PERIOD_ACTIVE]:{layer:4,retry:!1},[h.LOCK_PERIOD_EXPIRED]:{layer:4,retry:!1},[h.NO_REWARDS]:{layer:4,retry:!1},[h.INVALID_DURATION]:{layer:4,retry:!1},[h.INVALID_DELEGATION_INDEX]:{layer:4,retry:!1},[h.NFT_NOT_IN_POOL]:{layer:4,retry:!1},[h.POOL_NOT_INITIALIZED]:{layer:4,retry:!1},[h.INSUFFICIENT_POOL_LIQUIDITY]:{layer:4,retry:!1},[h.SLIPPAGE_EXCEEDED]:{layer:4,retry:!0,waitMs:1e3},[h.NFT_BOOST_MISMATCH]:{layer:4,retry:!1},[h.NOT_NFT_OWNER]:{layer:4,retry:!1},[h.NO_ACTIVE_TIERS]:{layer:4,retry:!1},[h.INVALID_GUESS_COUNT]:{layer:4,retry:!1},[h.INVALID_GUESS_RANGE]:{layer:4,retry:!1},[h.INSUFFICIENT_SERVICE_FEE]:{layer:4,retry:!1},[h.RENTAL_STILL_ACTIVE]:{layer:4,retry:!1},[h.NFT_NOT_LISTED]:{layer:4,retry:!1},[h.NFT_ALREADY_LISTED]:{layer:4,retry:!1},[h.NOT_LISTING_OWNER]:{layer:4,retry:!1},[h.MARKETPLACE_PAUSED]:{layer:4,retry:!1},[h.EMPTY_METADATA]:{layer:4,retry:!1},[h.CONTRACT_ERROR]:{layer:4,retry:!1},[h.UNKNOWN]:{layer:5,retry:!1}},Mo=[{pattern:/user rejected/i,type:h.USER_REJECTED},{pattern:/user denied/i,type:h.USER_REJECTED},{pattern:/user cancel/i,type:h.USER_REJECTED},{pattern:/rejected by user/i,type:h.USER_REJECTED},{pattern:/cancelled/i,type:h.USER_REJECTED},{pattern:/canceled/i,type:h.USER_REJECTED},{pattern:/action_rejected/i,type:h.USER_REJECTED},{pattern:/too many errors/i,type:h.RPC_RATE_LIMITED},{pattern:/rate limit/i,type:h.RPC_RATE_LIMITED},{pattern:/retrying in/i,type:h.RPC_RATE_LIMITED},{pattern:/429/i,type:h.RPC_RATE_LIMITED},{pattern:/internal json-rpc/i,type:h.RPC_UNHEALTHY},{pattern:/-32603/i,type:h.RPC_UNHEALTHY},{pattern:/-32002/i,type:h.RPC_RATE_LIMITED},{pattern:/failed to fetch/i,type:h.NETWORK_ERROR},{pattern:/network error/i,type:h.NETWORK_ERROR},{pattern:/timeout/i,type:h.TX_TIMEOUT},{pattern:/insufficient funds/i,type:h.INSUFFICIENT_ETH},{pattern:/exceeds the balance/i,type:h.INSUFFICIENT_ETH},{pattern:/insufficient balance/i,type:h.INSUFFICIENT_TOKEN},{pattern:/transfer amount exceeds balance/i,type:h.INSUFFICIENT_TOKEN},{pattern:/exceeds balance/i,type:h.INSUFFICIENT_TOKEN},{pattern:/nonce/i,type:h.NONCE_ERROR},{pattern:/replacement.*underpriced/i,type:h.TX_UNDERPRICED},{pattern:/transaction underpriced/i,type:h.TX_UNDERPRICED},{pattern:/gas too low/i,type:h.TX_UNDERPRICED},{pattern:/reverted/i,type:h.TX_REVERTED},{pattern:/revert/i,type:h.TX_REVERTED},{pattern:/campaignnotfound/i,type:h.CAMPAIGN_NOT_FOUND},{pattern:/campaign not found/i,type:h.CAMPAIGN_NOT_FOUND},{pattern:/campaignnotactive/i,type:h.CAMPAIGN_NOT_ACTIVE},{pattern:/campaign.*not.*active/i,type:h.CAMPAIGN_NOT_ACTIVE},{pattern:/campaignstillactive/i,type:h.CAMPAIGN_STILL_ACTIVE},{pattern:/notcampaigncreator/i,type:h.NOT_CAMPAIGN_CREATOR},{pattern:/donationtoosmall/i,type:h.DONATION_TOO_SMALL},{pattern:/maxactivecampaignsreached/i,type:h.MAX_CAMPAIGNS_REACHED},{pattern:/insufficientethfee/i,type:h.INSUFFICIENT_ETH_FEE},{pattern:/lockperiodactive/i,type:h.LOCK_PERIOD_ACTIVE},{pattern:/lock.*period.*active/i,type:h.LOCK_PERIOD_ACTIVE},{pattern:/still.*locked/i,type:h.LOCK_PERIOD_ACTIVE},{pattern:/lockperiodexpired/i,type:h.LOCK_PERIOD_EXPIRED},{pattern:/norewardstoclaim/i,type:h.NO_REWARDS},{pattern:/no.*rewards/i,type:h.NO_REWARDS},{pattern:/invalidduration/i,type:h.INVALID_DURATION},{pattern:/invalidindex/i,type:h.INVALID_DELEGATION_INDEX},{pattern:/nftnotinpool/i,type:h.NFT_NOT_IN_POOL},{pattern:/poolnotinitialized/i,type:h.POOL_NOT_INITIALIZED},{pattern:/insufficientliquidity/i,type:h.INSUFFICIENT_POOL_LIQUIDITY},{pattern:/insufficientnfts/i,type:h.INSUFFICIENT_POOL_LIQUIDITY},{pattern:/slippageexceeded/i,type:h.SLIPPAGE_EXCEEDED},{pattern:/slippage/i,type:h.SLIPPAGE_EXCEEDED},{pattern:/nftboostmismatch/i,type:h.NFT_BOOST_MISMATCH},{pattern:/notnftowner/i,type:h.NOT_NFT_OWNER},{pattern:/noactivetiers/i,type:h.NO_ACTIVE_TIERS},{pattern:/invalidguesscount/i,type:h.INVALID_GUESS_COUNT},{pattern:/invalidguessrange/i,type:h.INVALID_GUESS_RANGE},{pattern:/insufficientservicefee/i,type:h.INSUFFICIENT_SERVICE_FEE},{pattern:/rentalstillactive/i,type:h.RENTAL_STILL_ACTIVE},{pattern:/nftnotlisted/i,type:h.NFT_NOT_LISTED},{pattern:/nftalreadylisted/i,type:h.NFT_ALREADY_LISTED},{pattern:/notlistingowner/i,type:h.NOT_LISTING_OWNER},{pattern:/marketplaceispaused/i,type:h.MARKETPLACE_PAUSED},{pattern:/emptymetadata/i,type:h.EMPTY_METADATA}],J={classify(e){var n;if(e!=null&&e.errorType&&Object.values(h).includes(e.errorType))return e.errorType;const t=this._extractMessage(e),a=(e==null?void 0:e.code)||((n=e==null?void 0:e.error)==null?void 0:n.code);if(a===4001||a==="ACTION_REJECTED")return h.USER_REJECTED;if(a===-32002)return h.RPC_RATE_LIMITED;if(a===-32603||a==="CALL_EXCEPTION"){if(t.includes("base fee")||t.includes("basefee")||t.includes("max fee per gas")||t.includes("maxfeepergas")||t.includes("underpriced")||t.includes("gas too low"))return h.TX_UNDERPRICED;if(t.includes("revert")||t.includes("require")||t.includes("execution failed")||t.includes("call_exception")||(e==null?void 0:e.code)==="CALL_EXCEPTION"){for(const{pattern:s,type:i}of Mo)if(s.test(t))return i;return h.CONTRACT_ERROR}return h.RPC_UNHEALTHY}for(const{pattern:s,type:i}of Mo)if(s.test(t))return i;return h.UNKNOWN},_extractMessage(e){var a,n,s;return e?typeof e=="string"?e:[e.message,e.reason,(a=e.error)==null?void 0:a.message,(n=e.error)==null?void 0:n.reason,(s=e.data)==null?void 0:s.message,e.shortMessage,this._safeStringify(e)].filter(Boolean).join(" ").toLowerCase():""},_safeStringify(e){try{return JSON.stringify(e,(t,a)=>typeof a=="bigint"?a.toString():a)}catch{return""}},isUserRejection(e){return this.classify(e)===h.USER_REJECTED},isRetryable(e){var a;const t=this.classify(e);return((a=At[t])==null?void 0:a.retry)||!1},getWaitTime(e){const t=this.classify(e),a=At[t];return a?a.waitMs==="extract"?this._extractWaitTime(e):a.waitMs||2e3:2e3},_extractWaitTime(e){const t=this._extractMessage(e),a=t.match(/retrying in (\d+[,.]?\d*)\s*minutes?/i);if(a){const s=parseFloat(a[1].replace(",","."));return Math.ceil(s*60*1e3)+5e3}const n=t.match(/wait (\d+)\s*seconds?/i);return n?parseInt(n[1])*1e3+2e3:3e4},getMessage(e){const t=this.classify(e);return ln[t]||ln[h.UNKNOWN]},getConfig(e){const t=this.classify(e);return At[t]||At[h.UNKNOWN]},getLayer(e){var a;const t=this.classify(e);return((a=At[t])==null?void 0:a.layer)||5},handle(e,t="Transaction"){const a=this.classify(e),n=At[a]||{},s=this.getMessage(e);return console.error(`[${t}] Error:`,{type:a,layer:n.layer,retry:n.retry,message:s,original:e}),{type:a,message:s,retry:n.retry||!1,waitMs:n.retry?this.getWaitTime(e):0,layer:n.layer||5,action:n.action||null,original:e,context:t}},async handleWithRpcSwitch(e,t="Transaction"){const a=this.handle(e,t);if(a.action==="switch_rpc")try{const{NetworkManager:n}=await O(async()=>{const{NetworkManager:i}=await Promise.resolve().then(()=>hp);return{NetworkManager:i}},void 0);console.log("[ErrorHandler] Switching RPC due to network error...");const s=n.switchToNextRpc();try{await n.updateMetaMaskRpcs(),console.log("[ErrorHandler] MetaMask RPC updated")}catch(i){console.warn("[ErrorHandler] Could not update MetaMask:",i.message)}a.rpcSwitched=!0,a.newRpc=s,a.waitMs=Math.min(a.waitMs,2e3)}catch(n){console.warn("[ErrorHandler] Could not switch RPC:",n.message),a.rpcSwitched=!1}return a},parseSimulationError(e,t){var r;const a=this.classify(e);let n=this.getMessage(e);const i=(r={donate:{[h.CAMPAIGN_NOT_ACTIVE]:"This campaign has ended and is no longer accepting donations",[h.DONATION_TOO_SMALL]:"Minimum donation is 1 BKC"},delegate:{[h.INVALID_DURATION]:"Lock period must be between 1 day and 10 years"},playGame:{[h.INVALID_GUESS_RANGE]:"Your guess must be within the valid range for this tier"},withdraw:{[h.CAMPAIGN_STILL_ACTIVE]:"You can withdraw after the campaign deadline"},unstake:{[h.LOCK_PERIOD_ACTIVE]:"Your tokens are still locked. Use force unstake to withdraw early (penalty applies)"},claimRewards:{[h.CONTRACT_ERROR]:"No rewards available to claim",[h.NO_REWARDS]:"No rewards available to claim"}}[t])==null?void 0:r[a];return i&&(n=i),{type:a,message:n,original:e,method:t,isSimulation:!0}},create(e,t={}){const a=ln[e]||"An error occurred",n=new Error(a);return n.errorType=e,n.extra=t,n},getAction(e){var a;const t=this.classify(e);return((a=At[t])==null?void 0:a.action)||null}},re={chainId:421614,chainIdHex:"0x66eee",name:"Arbitrum Sepolia",nativeCurrency:{name:"Ethereum",symbol:"ETH",decimals:18},blockExplorer:"https://sepolia.arbiscan.io"};function et(){const e="ZWla0YY4A0Hw7e_rwyOXB";return e?`https://arb-sepolia.g.alchemy.com/v2/${e}`:null}const mp=[{name:"Alchemy",getUrl:et,priority:1,isPublic:!1,isPaid:!0},{name:"Arbitrum Official",getUrl:()=>"https://sepolia-rollup.arbitrum.io/rpc",priority:2,isPublic:!0,isPaid:!1},{name:"PublicNode",getUrl:()=>"https://arbitrum-sepolia-rpc.publicnode.com",priority:3,isPublic:!0,isPaid:!1},{name:"Ankr",getUrl:()=>"https://rpc.ankr.com/arbitrum_sepolia",priority:4,isPublic:!0,isPaid:!1}];let ut=0,qt=null,Pt=null,Za=0,Qa=0,Xt=!0;const fp=3,bp=3e4,gp=5e3,Do=6e4,xp=2e3,ae={getCurrentRpcUrl(){const e=et();if(e&&Xt)return e;const t=this.getAvailableEndpoints();if(t.length===0)throw new Error("No RPC endpoints available");return t[ut%t.length].getUrl()},getPrimaryRpcUrl(){return et()},getAvailableEndpoints(){return mp.filter(e=>e.getUrl()!==null).sort((e,t)=>e.priority-t.priority)},getRpcUrlsForMetaMask(){const e=et(),t=this.getAvailableEndpoints().filter(a=>a.isPublic).map(a=>a.getUrl()).filter(Boolean);return e?[e,...t]:t},switchToNextRpc(e=!0){const t=this.getAvailableEndpoints();if(Xt&&et()){Xt=!1,ut=0;const s=t.find(i=>i.isPublic);if(s)return console.log(`[Network] Alchemy temporarily unavailable, using: ${s.name}`),e&&setTimeout(()=>{console.log("[Network] Retrying Alchemy..."),Xt=!0,ut=0},xp),s.getUrl()}const a=t.filter(s=>s.isPublic);if(a.length<=1)return console.warn("[Network] No alternative RPCs available"),this.getCurrentRpcUrl();ut=(ut+1)%a.length;const n=a[ut];return console.log(`[Network] Switched to RPC: ${n.name}`),n.getUrl()},resetToAlchemy(){et()&&(Xt=!0,ut=0,console.log("[Network] Reset to Alchemy RPC"))},isRateLimitError(e){var n;const t=((n=e==null?void 0:e.message)==null?void 0:n.toLowerCase())||"",a=e==null?void 0:e.code;return a===-32002||a===-32005||t.includes("rate limit")||t.includes("too many")||t.includes("exceeded")||t.includes("throttled")||t.includes("429")},async handleRateLimit(e){const t=this.getCurrentRpcUrl(),a=et();if(a&&t===a)return console.warn("[Network] Alchemy rate limited (check your plan limits)"),await new Promise(r=>setTimeout(r,1e3)),a;console.warn("[Network] Public RPC rate limited, switching...");const s=this.switchToNextRpc(),i=Date.now();if(i-Qa>Do)try{await this.updateMetaMaskRpcs(),Qa=i}catch(r){console.warn("[Network] Could not update MetaMask:",r.message)}return s},async getWorkingProvider(){const e=window.ethers,t=et();if(t)try{const n=new e.JsonRpcProvider(t);return await Promise.race([n.getBlockNumber(),new Promise((s,i)=>setTimeout(()=>i(new Error("timeout")),3e3))]),Xt=!0,n}catch(n){console.warn("[Network] Alchemy temporarily unavailable:",n.message)}const a=this.getAvailableEndpoints().filter(n=>n.isPublic);for(const n of a)try{const s=n.getUrl(),i=new e.JsonRpcProvider(s);return await Promise.race([i.getBlockNumber(),new Promise((r,o)=>setTimeout(()=>o(new Error("timeout")),3e3))]),console.log(`[Network] Using fallback RPC: ${n.name}`),i}catch{console.warn(`[Network] RPC ${n.name} failed, trying next...`)}if(t)return new e.JsonRpcProvider(t);throw new Error("No working RPC endpoints available")},async isCorrectNetwork(){if(!window.ethereum)return!1;try{const e=await window.ethereum.request({method:"eth_chainId"});return parseInt(e,16)===re.chainId}catch(e){return console.error("[Network] Error checking network:",e),!1}},async getCurrentChainId(){if(!window.ethereum)return null;try{const e=await window.ethereum.request({method:"eth_chainId"});return parseInt(e,16)}catch{return null}},async checkRpcHealth(){const e=Date.now(),t=this.getCurrentRpcUrl();try{const a=new AbortController,n=setTimeout(()=>a.abort(),gp),s=await fetch(t,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({jsonrpc:"2.0",method:"eth_blockNumber",params:[],id:1}),signal:a.signal});if(clearTimeout(n),!s.ok)throw new Error(`HTTP ${s.status}`);const i=await s.json();if(i.error)throw new Error(i.error.message||"RPC error");const r=Date.now()-e;return Za=0,Pt={healthy:!0,latency:r,blockNumber:parseInt(i.result,16),timestamp:Date.now()},Pt}catch(a){Za++;const n={healthy:!1,latency:Date.now()-e,error:a.message,timestamp:Date.now()};return Pt=n,Za>=fp&&(console.warn("[Network] Too many RPC failures, switching..."),this.switchToNextRpc(),Za=0),n}},getLastHealthCheck(){return Pt},async isRpcHealthy(e=1e4){return Pt&&Date.now()-Pt.timestamp<e?Pt.healthy:(await this.checkRpcHealth()).healthy},async switchNetwork(){if(!window.ethereum)throw J.create(h.WALLET_NOT_CONNECTED);try{return await window.ethereum.request({method:"wallet_switchEthereumChain",params:[{chainId:re.chainIdHex}]}),console.log("[Network] Switched to",re.name),!0}catch(e){if(e.code===4902)return await this.addNetwork();throw e.code===4001?J.create(h.USER_REJECTED):e}},async addNetwork(){if(!window.ethereum)throw J.create(h.WALLET_NOT_CONNECTED);const e=this.getRpcUrlsForMetaMask();try{return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:re.chainIdHex,chainName:re.name,nativeCurrency:re.nativeCurrency,rpcUrls:e,blockExplorerUrls:[re.blockExplorer]}]}),console.log("[Network] Added network:",re.name),!0}catch(t){throw t.code===4001?J.create(h.USER_REJECTED):t}},async updateMetaMaskRpcs(){if(!window.ethereum)return!1;const e=Date.now();if(e-Qa<Do)return console.log("[Network] MetaMask update on cooldown, skipping..."),!1;if(!await this.isCorrectNetwork())return console.log("[Network] Not on correct network, skipping RPC update"),!1;const a=this.getRpcUrlsForMetaMask();try{return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:re.chainIdHex,chainName:re.name,nativeCurrency:re.nativeCurrency,rpcUrls:a,blockExplorerUrls:[re.blockExplorer]}]}),Qa=e,console.log("[Network] MetaMask RPCs updated with:",a[0]),!0}catch(n){return console.warn("[Network] Could not update MetaMask RPCs:",n.message),!1}},async forceResetMetaMaskRpc(){if(!window.ethereum)return!1;const e=et();if(!e)return console.warn("[Network] Alchemy not configured"),!1;try{try{await window.ethereum.request({method:"wallet_switchEthereumChain",params:[{chainId:"0x1"}]})}catch{}return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:re.chainIdHex,chainName:re.name+" (Alchemy)",nativeCurrency:re.nativeCurrency,rpcUrls:[e],blockExplorerUrls:[re.blockExplorer]}]}),console.log("[Network] MetaMask reset to Alchemy RPC"),!0}catch(t){return console.error("[Network] Failed to reset MetaMask:",t.message),!1}},getProvider(){const e=window.ethers;if(!e)throw new Error("ethers.js not loaded");return new e.JsonRpcProvider(this.getCurrentRpcUrl())},getBrowserProvider(){const e=window.ethers;if(!e)throw new Error("ethers.js not loaded");if(!window.ethereum)throw J.create(h.WALLET_NOT_CONNECTED);return new e.BrowserProvider(window.ethereum)},async getSigner(){var t,a;const e=this.getBrowserProvider();try{return await e.getSigner()}catch(n){if((t=n.message)!=null&&t.includes("ENS")||n.code==="UNSUPPORTED_OPERATION")try{const s=await window.ethereum.request({method:"eth_accounts"});if(s&&s.length>0)return await e.getSigner(s[0])}catch(s){console.warn("Signer fallback failed:",s)}throw n.code===4001||(a=n.message)!=null&&a.includes("user rejected")?J.create(h.USER_REJECTED):J.create(h.WALLET_NOT_CONNECTED)}},async getConnectedAddress(){if(!window.ethereum)return null;try{return(await window.ethereum.request({method:"eth_accounts"}))[0]||null}catch{return null}},async requestConnection(){if(!window.ethereum)throw J.create(h.WALLET_NOT_CONNECTED);try{const e=await window.ethereum.request({method:"eth_requestAccounts"});if(!e||e.length===0)throw J.create(h.WALLET_NOT_CONNECTED);return e[0]}catch(e){throw e.code===4001?J.create(h.USER_REJECTED):e}},startHealthMonitoring(e=bp){qt&&this.stopHealthMonitoring(),this.checkRpcHealth(),qt=setInterval(()=>{this.checkRpcHealth()},e),console.log("[Network] Health monitoring started")},stopHealthMonitoring(){qt&&(clearInterval(qt),qt=null,console.log("[Network] Health monitoring stopped"))},isMonitoring(){return qt!==null},formatAddress(e,t=4){return e?`${e.slice(0,t+2)}...${e.slice(-t)}`:""},getAddressExplorerUrl(e){return`${re.blockExplorer}/address/${e}`},getTxExplorerUrl(e){return`${re.blockExplorer}/tx/${e}`},isMetaMaskInstalled(){return typeof window.ethereum<"u"&&window.ethereum.isMetaMask},async getStatus(){var n;const[e,t,a]=await Promise.all([this.isCorrectNetwork(),this.getConnectedAddress(),this.checkRpcHealth()]);return{isConnected:!!t,address:t,isCorrectNetwork:e,currentChainId:await this.getCurrentChainId(),targetChainId:re.chainId,rpcHealthy:a.healthy,rpcLatency:a.latency,currentRpc:((n=this.getAvailableEndpoints()[ut])==null?void 0:n.name)||"Unknown"}}},hp=Object.freeze(Object.defineProperty({__proto__:null,NETWORK_CONFIG:re,NetworkManager:ae},Symbol.toStringTag,{value:"Module"})),Ze={SAFETY_MARGIN_PERCENT:20,MIN_GAS_LIMITS:{transfer:21000n,erc20Transfer:65000n,erc20Approve:50000n,contractCall:100000n,complexCall:300000n},MAX_GAS_LIMIT:15000000n,MIN_GAS_PRICE_GWEI:.01,MAX_GAS_PRICE_GWEI:100,GAS_PRICE_CACHE_TTL:15e3},hc={async estimateGas(e,t,a=[],n={}){try{return await e[t].estimateGas(...a,n)}catch(s){throw s}},async estimateGasWithMargin(e,t,a=[],n={}){const s=await this.estimateGas(e,t,a,n);return this.addSafetyMargin(s)},addSafetyMargin(e,t=Ze.SAFETY_MARGIN_PERCENT){const a=BigInt(e),n=a*BigInt(t)/100n;let s=a+n;return s>Ze.MAX_GAS_LIMIT&&(console.warn("[Gas] Estimate exceeds max limit, capping"),s=Ze.MAX_GAS_LIMIT),s},getMinGasLimit(e="contractCall"){return Ze.MIN_GAS_LIMITS[e]||Ze.MIN_GAS_LIMITS.contractCall},async getGasPrice(){return await ht.getOrFetch("gas-price-current",async()=>(await ae.getProvider().getFeeData()).gasPrice||0n,Ze.GAS_PRICE_CACHE_TTL)},async getFeeData(){return await ht.getOrFetch("gas-fee-data",async()=>{const a=await ae.getProvider().getFeeData();return{gasPrice:a.gasPrice||0n,maxFeePerGas:a.maxFeePerGas||0n,maxPriorityFeePerGas:a.maxPriorityFeePerGas||0n}},Ze.GAS_PRICE_CACHE_TTL)},async getGasPriceGwei(){const e=window.ethers,t=await this.getGasPrice();return parseFloat(e.formatUnits(t,"gwei"))},async calculateCost(e,t=null){const a=window.ethers;t||(t=await this.getGasPrice());const n=BigInt(e)*BigInt(t),s=a.formatEther(n);return{wei:n,eth:parseFloat(s),formatted:this.formatEth(s)}},async estimateTransactionCost(e,t,a=[],n={}){const s=await this.estimateGas(e,t,a,n),i=this.addSafetyMargin(s),r=await this.getGasPrice(),o=await this.calculateCost(i,r);return{gasEstimate:s,gasWithMargin:i,gasPrice:r,...o}},async validateGasBalance(e,t,a=null){const n=window.ethers,s=ae.getProvider();a||(a=await this.getGasPrice());const i=await s.getBalance(e),r=BigInt(t)*BigInt(a),o=i>=r;return{sufficient:o,balance:i,required:r,shortage:o?0n:r-i,balanceFormatted:n.formatEther(i),requiredFormatted:n.formatEther(r)}},async hasMinimumGas(e,t=null){const a=window.ethers,s=await ae.getProvider().getBalance(e),i=t||a.parseEther("0.001");return s>=i},formatEth(e,t=6){const a=parseFloat(e);return a===0?"0 ETH":a<1e-6?"< 0.000001 ETH":`${a.toFixed(t).replace(/\.?0+$/,"")} ETH`},formatGasPrice(e){const t=window.ethers,a=parseFloat(t.formatUnits(e,"gwei"));return a<.01?"< 0.01 gwei":a<1?`${a.toFixed(2)} gwei`:`${a.toFixed(1)} gwei`},formatGasLimit(e){return Number(e).toLocaleString()},formatGasSummary(e){return`~${e.formatted} (${this.formatGasLimit(e.gasWithMargin||0n)} gas)`},compareEstimates(e,t){const a=BigInt(e),n=BigInt(t);if(n===0n)return 0;const s=a>n?a-n:n-a;return Number(s*100n/n)},isGasPriceReasonable(e){const t=window.ethers,a=parseFloat(t.formatUnits(e,"gwei"));return a<Ze.MIN_GAS_PRICE_GWEI?{reasonable:!1,warning:"Gas price unusually low, transaction may be slow"}:a>Ze.MAX_GAS_PRICE_GWEI?{reasonable:!1,warning:"Gas price unusually high, consider waiting"}:{reasonable:!0,warning:null}},async getRecommendedSettings(e){const t=await this.getFeeData();return{gasLimit:this.addSafetyMargin(e),maxFeePerGas:t.maxFeePerGas,maxPriorityFeePerGas:t.maxPriorityFeePerGas}},async createTxOverrides(e,t={}){return{gasLimit:(await this.getRecommendedSettings(e)).gasLimit,...t}}},Oo=500000000000000n,Ho=["function balanceOf(address owner) view returns (uint256)","function allowance(address owner, address spender) view returns (uint256)","function decimals() view returns (uint8)","function symbol() view returns (string)"],te={async validateNetwork(){if(!await ae.isCorrectNetwork()){const t=await ae.getCurrentChainId();throw J.create(h.WRONG_NETWORK,{currentChainId:t,expectedChainId:re.chainId})}},async validateRpcHealth(){const e=await ae.checkRpcHealth();if(!e.healthy&&(ae.switchToNextRpc(),!(await ae.checkRpcHealth()).healthy))throw J.create(h.RPC_UNHEALTHY,{error:e.error})},async validateWalletConnected(e=null){if(!window.ethereum)throw J.create(h.WALLET_NOT_CONNECTED);const t=e||await ae.getConnectedAddress();if(!t)throw J.create(h.WALLET_NOT_CONNECTED);return t},async validatePreTransaction(){return await this.validateNetwork(),await this.validateRpcHealth(),await this.validateWalletConnected()},async validateEthForGas(e,t=Oo){const a=window.ethers,n=on.ethBalance(e),s=await ht.getOrFetch(n,async()=>await ae.getProvider().getBalance(e),rn.BALANCE);if(s<t)throw J.create(h.INSUFFICIENT_ETH,{balance:a.formatEther(s),required:a.formatEther(t)});return s},async validateTokenBalance(e,t,a){const n=window.ethers,s=on.tokenBalance(e,a),i=await ht.getOrFetch(s,async()=>{const r=ae.getProvider();return await new n.Contract(e,Ho,r).balanceOf(a)},rn.BALANCE);if(i<t)throw J.create(h.INSUFFICIENT_TOKEN,{balance:n.formatEther(i),required:n.formatEther(t)});return i},async needsApproval(e,t,a,n){const s=window.ethers,i=on.allowance(e,n,t);return await ht.getOrFetch(i,async()=>{const o=ae.getProvider();return await new s.Contract(e,Ho,o).allowance(n,t)},rn.ALLOWANCE)<a},async validateAllowance(e,t,a,n){if(await this.needsApproval(e,t,a,n))throw J.create(h.INSUFFICIENT_ALLOWANCE,{token:e,spender:t,required:a.toString()})},async validateBalances({userAddress:e,tokenAddress:t=null,tokenAmount:a=null,spenderAddress:n=null,ethAmount:s=Oo}){await this.validateEthForGas(e,s),t&&a&&await this.validateTokenBalance(t,a,e)},validatePositive(e,t="Amount"){if(BigInt(e)<=0n)throw new Error(`${t} must be greater than zero`)},validateRange(e,t,a,n="Value"){const s=BigInt(e),i=BigInt(t),r=BigInt(a);if(s<i||s>r)throw new Error(`${n} must be between ${t} and ${a}`)},validateNotEmpty(e,t="Field"){if(!e||e.trim().length===0)throw new Error(`${t} cannot be empty`)},validateAddress(e,t="Address"){const a=window.ethers;if(!e||!a.isAddress(e))throw new Error(`Invalid ${t}`)},charity:{validateCreateCampaign({title:e,description:t,goalAmount:a,durationDays:n}){te.validateNotEmpty(e,"Title"),te.validateNotEmpty(t,"Description"),te.validatePositive(a,"Goal amount"),te.validateRange(n,1,180,"Duration")},validateDonate({campaignId:e,amount:t}){if(e==null)throw new Error("Campaign ID is required");te.validatePositive(t,"Donation amount")}},staking:{validateDelegate({amount:e,lockDays:t}){te.validatePositive(e,"Stake amount"),te.validateRange(t,1,3650,"Lock duration")},validateUnstake({delegationIndex:e}){if(e==null||e<0)throw new Error("Invalid delegation index")}},nftPool:{validateBuy({maxPrice:e}){e!=null&&te.validatePositive(e,"Max price")},validateSell({tokenId:e,minPayout:t}){if(e==null)throw new Error("Token ID is required");t!=null&&te.validatePositive(t,"Min payout")}},fortune:{validatePlay({wagerAmount:e,guesses:t,isCumulative:a}){if(te.validatePositive(e,"Wager amount"),!Array.isArray(t)||t.length===0)throw new Error("At least one guess is required");t.forEach((n,s)=>{if(typeof n!="number"||n<1)throw new Error(`Invalid guess at position ${s+1}`)})}},rental:{validateList({tokenId:e,pricePerHour:t,minHours:a,maxHours:n}){if(e==null)throw new Error("Token ID is required");te.validatePositive(t,"Price per hour"),te.validateRange(a,1,720,"Minimum hours"),te.validateRange(n,a,720,"Maximum hours")},validateRent({tokenId:e,hours:t}){if(e==null)throw new Error("Token ID is required");te.validatePositive(t,"Rental hours")}},notary:{validateNotarize({ipfsCid:e,description:t,contentHash:a}){if(te.validateNotEmpty(e,"IPFS CID"),a&&(a.startsWith("0x")?a.slice(2):a).length!==64)throw new Error("Content hash must be 32 bytes")}}},en={DEFAULT_MAX_RETRIES:2,RETRY_BASE_DELAY:2e3,APPROVAL_MULTIPLIER:10n,APPROVAL_WAIT_TIME:1500,CONFIRMATION_TIMEOUT:6e4,CONFIRMATION_RETRY_DELAY:3e3,GAS_SAFETY_MARGIN:20,DEFAULT_GAS_LIMIT:500000n},Uo=["function approve(address spender, uint256 amount) returns (bool)","function allowance(address owner, address spender) view returns (uint256)"];class vc{constructor(t,a,n=!0){this.button=t,this.txName=a,this.showToasts=n,this.originalContent=null,this.originalDisabled=!1,this.button&&(this.originalContent=this.button.innerHTML,this.originalDisabled=this.button.disabled)}setPhase(t){if(!this.button)return;const n={validating:{text:"Validating...",icon:"🔍"},approving:{text:"Approving...",icon:"✅"},simulating:{text:"Simulating...",icon:"🧪"},confirming:{text:"Confirm in Wallet",icon:"👛"},waiting:{text:"Processing...",icon:"⏳"},success:{text:"Success!",icon:"🎉"},error:{text:"Failed",icon:"❌"}}[t]||{text:t,icon:"⏳"};this.button.disabled=!0,this.button.innerHTML=`
        ...
        `)}cleanup(){this.button&&(this.button.innerHTML=this.originalContent,this.button.disabled=this.originalDisabled)}showSuccess(t=2e3){this.setPhase("success"),setTimeout(()=>this.cleanup(),t)}showError(t=2e3){this.setPhase("error"),setTimeout(()=>this.cleanup(),t)}}class wc{constructor(){this.pendingTxIds=new Set}_resolveArgs(t){return typeof t=="function"?t():t||[]}_resolveApproval(t){return t?typeof t=="object"?{token:t.token,spender:t.spender,amount:t.amount}:t:null}_validateContractMethod(t,a){if(!t)throw new Error("Contract instance is null or undefined");if(typeof t[a]!="function"){const n=Object.keys(t).filter(s=>typeof t[s]=="function").filter(s=>!s.startsWith("_")&&!["on","once","emit","removeListener"].includes(s)).slice(0,15);throw console.error(`[TX] Contract method "${a}" not found!`),console.error("[TX] Available methods:",n),new Error(`Contract method "${a}" not found. This usually means the ABI doesn't match the contract. Available methods: ${n.join(", ")}`)}return typeof t[a].estimateGas!="function"&&console.warn(`[TX] Method ${a} exists but estimateGas is not available`),!0}async execute(t){var z,L;const{name:a,txId:n=null,button:s=null,showToasts:i=!0,getContract:r,method:o,args:l=[],approval:d=null,validate:u=null,onSuccess:m=null,onError:p=null,maxRetries:g=en.DEFAULT_MAX_RETRIES,invalidateCache:b=!0,skipSimulation:w=!1,fixedGasLimit:y=en.DEFAULT_GAS_LIMIT}=t,C=n||`${a}-${Date.now()}-${Math.random().toString(36).substr(2,9)}`;if(this.pendingTxIds.has(C))return console.warn(`[TX] Transaction ${C} already in progress`),{success:!1,reason:"DUPLICATE_TX",message:"Transaction already in progress"};this.pendingTxIds.add(C);const I=new vc(s,a,i);try{I.setPhase("validating"),console.log(`[TX] Starting: ${a}`),await te.validateNetwork(),await te.validateRpcHealth();const B=await te.validateWalletConnected();console.log(`[TX] User address: ${B}`);const A=await ae.getSigner();console.log("[TX] Signer obtained");try{await te.validateEthForGas(B)}catch(Q){console.warn("[TX] ETH gas validation failed, continuing anyway:",Q.message)}const _=this._resolveApproval(d);_&&_.amount>0n&&await te.validateTokenBalance(_.token,_.amount,B),u&&(console.log("[TX] Running custom validation..."),await u(A,B));const D=this._resolveApproval(t.approval);D&&D.amount>0n&&await te.needsApproval(D.token,D.spender,D.amount,B)&&(I.setPhase("approving"),console.log("[TX] Requesting token approval..."),await this._executeApproval(D,A,B),ht.clear("allowance-")),console.log("[TX] Getting contract instance...");const j=await r(A);this._validateContractMethod(j,o),console.log(`[TX] Contract method "${o}" validated`);const H=t.value;H&&console.log("[TX] Transaction value (ETH):",H.toString());const de=H?{value:H}:{},se=this._resolveArgs(l);console.log("[TX] Args resolved:",se.map(Q=>typeof Q=="bigint"?Q.toString():typeof Q=="string"&&Q.length>50?Q.substring(0,50)+"...":Q));let q;if(w)console.log(`[TX] Skipping simulation, using fixed gas limit: ${y}`),q=y;else{I.setPhase("simulating"),console.log("[TX] Simulating transaction...");try{const Q=ae.getProvider(),_e=await j.getAddress(),ks=new ethers.Contract(_e,j.interface,Q);if(!ks[o]||typeof ks[o].estimateGas!="function")throw new Error(`estimateGas not available for method "${o}"`);q=await ks[o].estimateGas(...se,{...de,from:B}),console.log(`[TX] Gas estimate: ${q.toString()}`)}catch(Q){if(console.error("[TX] Simulation failed:",Q.message),(z=Q.message)!=null&&z.includes("not found")||(L=Q.message)!=null&&L.includes("undefined"))throw new Error(`Contract method "${o}" is not callable. Check that the ABI matches the deployed contract.`);const _e=J.parseSimulationError(Q,o);throw J.create(_e.type,{message:_e.message,original:Q})}}I.setPhase("confirming"),console.log("[TX] Requesting signature...");const oe=hc.addSafetyMargin(q),Re={...de,gasLimit:oe};try{const _e=await ae.getProvider().getFeeData();_e.maxFeePerGas&&(Re.maxFeePerGas=_e.maxFeePerGas*120n/100n,Re.maxPriorityFeePerGas=_e.maxPriorityFeePerGas||0n)}catch{}const It=this._resolveArgs(l),dt=await this._executeWithRetry(()=>j[o](...It,Re),{maxRetries:g,ui:I,signer:A,name:a});console.log(`[TX] Transaction submitted: ${dt.hash}`),I.setPhase("waiting"),console.log("[TX] Waiting for confirmation...");const Ue=await this._waitForConfirmation(dt,A.provider);if(console.log(`[TX] Confirmed in block ${Ue.blockNumber}`),I.showSuccess(),b&&ht.invalidateByTx(a),m)try{await m(Ue)}catch(Q){console.warn("[TX] onSuccess callback error:",Q)}return{success:!0,receipt:Ue,txHash:Ue.hash||dt.hash,blockNumber:Ue.blockNumber}}catch(B){console.error("[TX] Error:",(B==null?void 0:B.message)||B),s&&(console.log("[TX] Restoring button..."),s.disabled=!1,I.originalContent&&(s.innerHTML=I.originalContent));let A;try{A=await J.handleWithRpcSwitch(B,a),A.rpcSwitched&&console.log(`[TX] RPC switched to: ${A.newRpc}`)}catch(_){console.warn("[TX] Error in handleWithRpcSwitch:",_),A=J.handle(B,a)}if(A.type!==h.USER_REJECTED&&s&&!p){const _=I.originalContent;s.innerHTML='<span style="display:flex;align-items:center;justify-content:center;gap:8px"><span>❌</span><span>Failed</span></span>',setTimeout(()=>{s&&(s.innerHTML=_)},1500)}if(p)try{p(A)}catch(_){console.warn("[TX] onError callback error:",_)}return{success:!1,error:A,message:A.message,cancelled:A.type===h.USER_REJECTED}}finally{this.pendingTxIds.delete(C),setTimeout(()=>{s&&s.disabled&&(console.log("[TX] Safety cleanup triggered"),I.cleanup())},5e3)}}async _executeApproval(t,a,n){const s=window.ethers,{token:i,spender:r,amount:o}=t;console.log(`[TX] Approving ${s.formatEther(o)} tokens...`);const l=new s.Contract(i,Uo,a),d=o*en.APPROVAL_MULTIPLIER;try{let u={gasLimit:100000n};try{const C=await ae.getProvider().getFeeData();C.maxFeePerGas&&(u.maxFeePerGas=C.maxFeePerGas*120n/100n,u.maxPriorityFeePerGas=C.maxPriorityFeePerGas||0n)}catch{}const m=await l.approve(r,d,u),p=ae.getProvider();let g=null;for(let y=0;y<30&&(await new Promise(C=>setTimeout(C,1500)),g=await p.getTransactionReceipt(m.hash),!g);y++);if(g||(g=await m.wait()),g.status===0)throw new Error("Approval transaction reverted");if(console.log("[TX] Approval confirmed"),await new Promise(y=>setTimeout(y,en.APPROVAL_WAIT_TIME)),await new s.Contract(i,Uo,p).allowance(n,r)<o)throw new Error("Approval not reflected on-chain")}catch(u){throw J.isUserRejection(u)?J.create(h.USER_REJECTED):u}}async _executeWithRetry(t,{maxRetries:a,ui:n,signer:s,name:i}){let r;for(let o=1;o<=a+1;o++)try{return o>1&&(n.setRetry(o,a+1),console.log(`[TX] Retry ${o}/${a+1}`),(await ae.checkRpcHealth()).healthy||(console.log("[TX] RPC unhealthy, switching..."),ae.switchToNextRpc(),await new Promise(d=>setTimeout(d,2e3)))),await t()}catch(l){if(r=l,J.isUserRejection(l)||!J.isRetryable(l)||o===a+1)throw l;const d=J.getWaitTime(l);console.log(`[TX] Waiting ${d}ms before retry...`),await new Promise(u=>setTimeout(u,d))}throw r}async _waitForConfirmation(t,a){const n=ae.getProvider();for(let s=0;s<30;s++){await new Promise(i=>setTimeout(i,1500));try{const i=await n.getTransactionReceipt(t.hash);if(i&&i.status===1)return console.log("[TX] Confirmed via Alchemy"),i;if(i&&i.status===0)throw new Error("Transaction reverted on-chain")}catch(i){if(i.message==="Transaction reverted on-chain")throw i}}return console.warn("[TX] Could not verify receipt after 45s, assuming success"),{hash:t.hash,status:1,blockNumber:0}}isPending(t){return this.pendingTxIds.has(t)}getPendingCount(){return this.pendingTxIds.size}clearPending(){this.pendingTxIds.clear()}}const W=new wc,Yn="bkc_operator",Yt="0x0000000000000000000000000000000000000000";function Vn(){var t;const e=window.ethers;try{const a=localStorage.getItem(Yn);if(a&&Ke(a))return Mt(a);if(window.BACKCHAIN_OPERATOR&&Ke(window.BACKCHAIN_OPERATOR))return Mt(window.BACKCHAIN_OPERATOR);if((t=window.addresses)!=null&&t.operator&&Ke(window.addresses.operator))return Mt(window.addresses.operator)}catch(a){console.warn("[Operator] Error getting operator:",a)}return(e==null?void 0:e.ZeroAddress)||Yt}function ee(e){const t=window.ethers,a=(t==null?void 0:t.ZeroAddress)||Yt;return e===null?a:e&&Ke(e)?Mt(e):Vn()}function yc(e){if(!e)return mi(),!0;if(!Ke(e))return console.warn("[Operator] Invalid address:",e),!1;try{const t=Mt(e);return localStorage.setItem(Yn,t),window.BACKCHAIN_OPERATOR=t,window.dispatchEvent(new CustomEvent("operatorChanged",{detail:{address:t}})),console.log("[Operator] Set to:",t),!0}catch(t){return console.error("[Operator] Error setting:",t),!1}}function mi(){try{localStorage.removeItem(Yn),delete window.BACKCHAIN_OPERATOR,window.dispatchEvent(new CustomEvent("operatorChanged",{detail:{address:null}})),console.log("[Operator] Cleared")}catch(e){console.warn("[Operator] Error clearing:",e)}}function kc(){const e=window.ethers,t=(e==null?void 0:e.ZeroAddress)||Yt,a=Vn();return a&&a!==t}function Ec(){var n;const e=window.ethers,t=(e==null?void 0:e.ZeroAddress)||Yt,a=localStorage.getItem(Yn);return a&&Ke(a)?{address:a,source:"localStorage",isSet:!0}:window.BACKCHAIN_OPERATOR&&Ke(window.BACKCHAIN_OPERATOR)?{address:window.BACKCHAIN_OPERATOR,source:"global",isSet:!0}:(n=window.addresses)!=null&&n.operator&&Ke(window.addresses.operator)?{address:window.addresses.operator,source:"config",isSet:!0}:{address:t,source:"none",isSet:!1}}function Ke(e){const t=window.ethers;return!e||typeof e!="string"||!e.match(/^0x[a-fA-F0-9]{40}$/)?!1:t!=null&&t.isAddress?t.isAddress(e):!0}function Mt(e){const t=window.ethers;if(!e)return(t==null?void 0:t.ZeroAddress)||Yt;try{if(t!=null&&t.getAddress)return t.getAddress(e)}catch{}return e}function Tc(e){const t=window.ethers,a=(t==null?void 0:t.ZeroAddress)||Yt;return!e||e===a?"None":`${e.slice(0,6)}...${e.slice(-4)}`}const vp={get:Vn,set:yc,clear:mi,has:kc,resolve:ee,info:Ec,isValid:Ke,normalize:Mt,short:Tc,ZERO:Yt};window.Operator=vp;const wp=["function getFeeConfig(bytes32 _actionId) view returns (uint8 feeType, uint16 bps, uint16 multiplier, uint32 gasEstimate)"],jo=10000n;async function ke(e,t=0n){try{const a=window.ethers,n=ae.getProvider(),s=(v==null?void 0:v.backchainEcosystem)||(F==null?void 0:F.backchainEcosystem);if(!s)return console.warn("[FeeCalc] Ecosystem address not available"),0n;const r=await new a.Contract(s,wp,n).getFeeConfig(e),o=BigInt(r.bps);if(o===0n)return 0n;if(Number(r.feeType)===0){const l=await n.getFeeData(),d=l.gasPrice||l.maxFeePerGas||100000000n,u=d*150n/100n,m=BigInt(r.gasEstimate)*u*o*BigInt(r.multiplier)/jo;return console.log(`[FeeCalc] Gas-based: ${a.formatEther(m)} ETH (gasEst=${r.gasEstimate}, gasPrice=${d}→${u} +50%, bps=${o}, mult=${r.multiplier})`),m}else{const l=t*o/jo;return console.log(`[FeeCalc] Value-based: ${a.formatEther(l)} ETH`),l}}catch(a){return console.error("[FeeCalc] Error:",a.message),0n}}const Z=Object.freeze(Object.defineProperty({__proto__:null,CacheKeys:on,CacheManager:ht,CacheTTL:rn,ErrorHandler:J,ErrorMessages:ln,ErrorTypes:h,GasManager:hc,NETWORK_CONFIG:re,NetworkManager:ae,TransactionEngine:wc,TransactionUI:vc,ValidationLayer:te,calculateFeeClientSide:ke,clearOperator:mi,getOperator:Vn,getOperatorInfo:Ec,hasOperator:kc,isValidAddress:Ke,normalizeAddress:Mt,resolveOperator:ee,setOperator:yc,shortAddress:Tc,txEngine:W},Symbol.toStringTag,{value:"Module"}));function Cc(){var t;const e=(v==null?void 0:v.charityPool)||(F==null?void 0:F.charityPool)||((t=window.contractAddresses)==null?void 0:t.charityPool);if(!e)throw console.error("❌ CharityPool address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{CHARITY_POOL:e}}const Ma=["function createCampaign(string calldata title, string calldata metadataUri, uint96 goal, uint256 durationDays, address operator) external payable returns (uint256 campaignId)","function donate(uint256 campaignId, address operator) external payable","function boostCampaign(uint256 campaignId, address operator) external payable","function closeCampaign(uint256 campaignId) external","function withdraw(uint256 campaignId) external","function getCampaign(uint256 campaignId) view returns (address owner, uint48 deadline, uint8 status, uint96 raised, uint96 goal, uint32 donorCount, bool isBoosted, string memory title, string memory metadataUri)","function canWithdraw(uint256 campaignId) view returns (bool)","function previewDonation(uint256 amount) view returns (uint256 fee, uint256 netToCampaign)","function campaignCount() view returns (uint256)","function getStats() view returns (uint256 campaignCount, uint256 totalDonated, uint256 totalWithdrawn, uint256 totalEthFees)","function version() view returns (string)","event CampaignCreated(uint256 indexed campaignId, address indexed creator, uint96 goal, uint48 deadline, address operator)","event DonationMade(uint256 indexed campaignId, address indexed donor, uint256 grossAmount, uint256 netDonation, address operator)","event CampaignBoosted(uint256 indexed campaignId, address indexed booster, uint48 boostExpiry, address operator)","event CampaignClosed(uint256 indexed campaignId, address indexed creator, uint96 raised)","event FundsWithdrawn(uint256 indexed campaignId, address indexed creator, uint96 amount)"],da={ACTIVE:0,CLOSED:1,WITHDRAWN:2};function Da(e){const t=window.ethers,a=Cc();return new t.Contract(a.CHARITY_POOL,Ma,e)}async function Xe(){const e=window.ethers,{NetworkManager:t}=await O(async()=>{const{NetworkManager:s}=await Promise.resolve().then(()=>Z);return{NetworkManager:s}},void 0),a=t.getProvider(),n=Cc();return new e.Contract(n.CHARITY_POOL,Ma,a)}async function fi({title:e,metadataUri:t="",description:a,goalAmount:n,durationDays:s,operator:i,button:r=null,onSuccess:o=null,onError:l=null}){const d=window.ethers;if(!e||e.trim().length===0)throw new Error("Title is required");if(e.length>100)throw new Error("Title must be 100 characters or less");if(s<1||s>365)throw new Error("Duration must be between 1 and 365 days");const u=BigInt(n);if(u<=0n)throw new Error("Goal amount must be greater than 0");const m=t||a||"";let p=i,g=0n;return await W.execute({name:"CreateCampaign",button:r,getContract:async b=>Da(b),method:"createCampaign",args:()=>[e,m,u,BigInt(s),ee(p)],get value(){return g},validate:async(b,w)=>{await Xe();try{const{NetworkManager:y}=await O(async()=>{const{NetworkManager:z}=await Promise.resolve().then(()=>Z);return{NetworkManager:z}},void 0),C=y.getProvider();if(g=d.parseEther("0.0001"),await C.getBalance(w)<g+d.parseEther("0.001"))throw new Error("Insufficient ETH for creation fee + gas")}catch(y){if(y.message.includes("Insufficient"))throw y}},onSuccess:async b=>{let w=null;try{const y=new d.Interface(Ma);for(const C of b.logs)try{const I=y.parseLog(C);if(I.name==="CampaignCreated"){w=Number(I.args.campaignId);break}}catch{}}catch{}o&&o(b,w)},onError:l})}async function bi({campaignId:e,amount:t,operator:a,button:n=null,onSuccess:s=null,onError:i=null}){const r=window.ethers;if(e==null)throw new Error("Campaign ID is required");const o=BigInt(t);if(o<=0n)throw new Error("Donation amount must be greater than 0");let l=e,d=a;return await W.execute({name:"Donate",button:n,getContract:async u=>Da(u),method:"donate",args:()=>[l,ee(d)],value:o,validate:async(u,m)=>{const g=await(await Xe()).getCampaign(l);if(g.owner===r.ZeroAddress)throw new Error("Campaign not found");if(Number(g.status)!==da.ACTIVE)throw new Error("Campaign is not active");const b=Math.floor(Date.now()/1e3);if(Number(g.deadline)<=b)throw new Error("Campaign has ended")},onSuccess:async u=>{let m=null;try{const p=new r.Interface(Ma);for(const g of u.logs)try{const b=p.parseLog(g);if(b.name==="DonationMade"){m={grossAmount:b.args.grossAmount,netDonation:b.args.netDonation};break}}catch{}}catch{}s&&s(u,m)},onError:i})}async function qn({campaignId:e,button:t=null,onSuccess:a=null,onError:n=null}){const s=window.ethers;if(e==null)throw new Error("Campaign ID is required");return await W.execute({name:"CloseCampaign",button:t,getContract:async i=>Da(i),method:"closeCampaign",args:[e],validate:async(i,r)=>{const l=await(await Xe()).getCampaign(e);if(l.owner===s.ZeroAddress)throw new Error("Campaign not found");if(l.owner.toLowerCase()!==r.toLowerCase())throw new Error("Only the campaign creator can close");if(Number(l.status)!==da.ACTIVE)throw new Error("Campaign is not active")},onSuccess:a,onError:n})}const gi=qn;async function xi({campaignId:e,button:t=null,onSuccess:a=null,onError:n=null}){const s=window.ethers;if(e==null)throw new Error("Campaign ID is required");return await W.execute({name:"Withdraw",button:t,getContract:async i=>Da(i),method:"withdraw",args:[e],validate:async(i,r)=>{const o=await Xe(),l=await o.getCampaign(e);if(l.owner===s.ZeroAddress)throw new Error("Campaign not found");if(l.owner.toLowerCase()!==r.toLowerCase())throw new Error("Only the campaign creator can withdraw");if(Number(l.status)===da.WITHDRAWN)throw new Error("Funds already withdrawn");if(!await o.canWithdraw(e))throw new Error("Cannot withdraw yet — campaign must be closed or past deadline")},onSuccess:async i=>{let r=null;try{const o=new s.Interface(Ma);for(const l of i.logs)try{const d=o.parseLog(l);if(d.name==="FundsWithdrawn"){r={amount:d.args.amount};break}}catch{}}catch{}a&&a(i,r)},onError:n})}async function hi({campaignId:e,operator:t,button:a=null,onSuccess:n=null,onError:s=null}){const i=window.ethers;if(e==null)throw new Error("Campaign ID is required");let r=t,o=i.parseEther("0.0001");return await W.execute({name:"BoostCampaign",button:a,getContract:async l=>Da(l),method:"boostCampaign",args:()=>[e,ee(r)],get value(){return o},validate:async(l,d)=>{const m=await(await Xe()).getCampaign(e);if(m.owner===i.ZeroAddress)throw new Error("Campaign not found");if(Number(m.status)!==da.ACTIVE)throw new Error("Campaign is not active");const p=Math.floor(Date.now()/1e3);if(Number(m.deadline)<=p)throw new Error("Campaign has ended")},onSuccess:n,onError:s})}async function vi(e){const a=await(await Xe()).getCampaign(e),n=Math.floor(Date.now()/1e3);return{id:e,creator:a.owner,title:a.title,metadataUri:a.metadataUri,goalAmount:a.goal,raisedAmount:a.raised,donationCount:Number(a.donorCount),deadline:Number(a.deadline),status:Number(a.status),statusName:["ACTIVE","CLOSED","WITHDRAWN"][Number(a.status)]||"UNKNOWN",isBoosted:a.isBoosted,progress:a.goal>0n?Number(a.raised*100n/a.goal):0,isEnded:Number(a.deadline)<n,isActive:Number(a.status)===da.ACTIVE&&Number(a.deadline)>n}}async function wi(){const e=await Xe();return Number(await e.campaignCount())}async function yi(e){return await(await Xe()).canWithdraw(e)}async function ki(e){const t=window.ethers,n=await(await Xe()).previewDonation(e);return{fee:n.fee||n[0],netToCampaign:n.netToCampaign||n[1],feeFormatted:t.formatEther(n.fee||n[0]),netFormatted:t.formatEther(n.netToCampaign||n[1])}}async function Ei(){const e=window.ethers,a=await(await Xe()).getStats();return{totalCampaigns:Number(a.campaignCount||a[0]),totalDonated:a.totalDonated||a[1],totalDonatedFormatted:e.formatEther(a.totalDonated||a[1]),totalWithdrawn:a.totalWithdrawn||a[2],totalWithdrawnFormatted:e.formatEther(a.totalWithdrawn||a[2]),totalEthFees:a.totalEthFees||a[3],totalEthFeesFormatted:e.formatEther(a.totalEthFees||a[3])}}const Le={createCampaign:fi,donate:bi,closeCampaign:qn,cancelCampaign:gi,withdraw:xi,boostCampaign:hi,getCampaign:vi,getCampaignCount:wi,canWithdraw:yi,previewDonation:ki,getStats:Ei,CampaignStatus:da},yp=Object.freeze(Object.defineProperty({__proto__:null,CharityTx:Le,boostCampaign:hi,canWithdraw:yi,cancelCampaign:gi,closeCampaign:qn,createCampaign:fi,donate:bi,getCampaign:vi,getCampaignCount:wi,getStats:Ei,previewDonation:ki,withdraw:xi},Symbol.toStringTag,{value:"Module"}));function Ti(){var a,n;const e=(v==null?void 0:v.stakingPool)||(F==null?void 0:F.stakingPool)||((a=window.contractAddresses)==null?void 0:a.stakingPool),t=(v==null?void 0:v.bkcToken)||(F==null?void 0:F.bkcToken)||((n=window.contractAddresses)==null?void 0:n.bkcToken);if(!e)throw console.error("❌ StakingPool address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");if(!t)throw console.error("❌ BKC Token address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{BKC_TOKEN:t,STAKING_POOL:e}}const Ic=["function delegate(uint256 amount, uint256 lockDays, address operator) external payable","function unstake(uint256 index) external","function forceUnstake(uint256 index, address operator) external payable","function claimRewards(address operator) external payable","function pendingRewards(address user) view returns (uint256)","function previewClaim(address user) view returns (uint256 totalRewards, uint256 burnAmount, uint256 referrerCut, uint256 userReceives, uint256 burnRateBps, uint256 nftBoost)","function getDelegationsOf(address user) view returns (tuple(uint128 amount, uint128 pStake, uint64 lockEnd, uint64 lockDays, uint256 rewardDebt)[])","function getDelegation(address user, uint256 index) view returns (uint256 amount, uint256 pStake, uint256 lockEnd, uint256 lockDays, uint256 pendingReward)","function delegationCount(address user) view returns (uint256)","function userTotalPStake(address user) view returns (uint256)","function totalPStake() view returns (uint256)","function MIN_LOCK_DAYS() view returns (uint256)","function MAX_LOCK_DAYS() view returns (uint256)","function forceUnstakePenaltyBps() view returns (uint256)","function getUserBestBoost(address user) view returns (uint256)","function getBurnRateForBoost(uint256 boostBps) view returns (uint256)","function getTierName(uint256 boostBps) view returns (string)","function getUserSummary(address user) view returns (uint256 userTotalPStake, uint256 delegationCount, uint256 savedRewards, uint256 totalPending, uint256 nftBoost, uint256 burnRateBps)","function getStakingStats() view returns (uint256 totalPStake, uint256 totalBkcDelegated, uint256 totalRewardsDistributed, uint256 totalBurnedOnClaim, uint256 totalForceUnstakePenalties, uint256 totalEthFeesCollected, uint256 accRewardPerShare)","event Delegated(address indexed user, uint256 indexed delegationIndex, uint256 amount, uint256 pStake, uint256 lockDays, address operator)","event Unstaked(address indexed user, uint256 indexed delegationIndex, uint256 amountReturned)","event ForceUnstaked(address indexed user, uint256 indexed delegationIndex, uint256 amountReturned, uint256 penaltyBurned, address operator)","event RewardsClaimed(address indexed user, uint256 totalRewards, uint256 burnedAmount, uint256 userReceived, uint256 cutAmount, address cutRecipient, uint256 nftBoostUsed, address operator)"];function Ut(e){const t=window.ethers,a=Ti();return new t.Contract(a.STAKING_POOL,Ic,e)}async function Et(){const e=window.ethers,{NetworkManager:t}=await O(async()=>{const{NetworkManager:s}=await Promise.resolve().then(()=>Z);return{NetworkManager:s}},void 0),a=t.getProvider(),n=Ti();return new e.Contract(n.STAKING_POOL,Ic,a)}async function Ci({amount:e,lockDays:t,operator:a,button:n=null,onSuccess:s=null,onError:i=null}){if(t==null)throw new Error("lockDays must be provided");const r=Number(t);if(r<1||r>3650)throw new Error("Lock duration must be between 1 and 3650 days");const o=BigInt(e);let l=a;return await W.execute({name:"Delegate",button:n,getContract:async d=>Ut(d),method:"delegate",args:()=>[o,BigInt(r),ee(l)],approval:(()=>{const d=Ti();return{token:d.BKC_TOKEN,spender:d.STAKING_POOL,amount:o}})(),onSuccess:s,onError:i})}async function Ii({delegationIndex:e,button:t=null,onSuccess:a=null,onError:n=null}){te.staking.validateUnstake({delegationIndex:e});let s=e;return await W.execute({name:"Unstake",button:t,getContract:async i=>Ut(i),method:"unstake",args:[s],validate:async(i,r)=>{const l=await Ut(i).getDelegationsOf(r);if(s>=l.length)throw new Error("Delegation not found");const d=l[s],u=Math.floor(Date.now()/1e3);if(Number(d.lockEnd)>u){const m=Math.ceil((Number(d.lockEnd)-u)/86400);throw new Error(`Lock period still active. ${m} day(s) remaining. Use Force Unstake if needed.`)}},onSuccess:a,onError:n})}async function Ai({delegationIndex:e,operator:t,button:a=null,onSuccess:n=null,onError:s=null}){te.staking.validateUnstake({delegationIndex:e});let i=e,r=t;return await W.execute({name:"ForceUnstake",button:a,getContract:async o=>Ut(o),method:"forceUnstake",args:()=>[i,ee(r)],validate:async(o,l)=>{const u=await Ut(o).getDelegationsOf(l);if(i>=u.length)throw new Error("Delegation not found");const m=u[i],p=Math.floor(Date.now()/1e3);if(Number(m.lockEnd)<=p)throw new Error("Lock period has ended. Use normal Unstake to avoid penalty.")},onSuccess:n,onError:s})}async function Pi({operator:e,button:t=null,onSuccess:a=null,onError:n=null}={}){let s=e;return await W.execute({name:"ClaimRewards",button:t,getContract:async i=>Ut(i),method:"claimRewards",args:()=>[ee(s)],validate:async(i,r)=>{if(await Ut(i).pendingRewards(r)<=0n)throw new Error("No rewards available to claim")},onSuccess:a,onError:n})}async function zi(e){const a=await(await Et()).getDelegationsOf(e),n=Math.floor(Date.now()/1e3);return a.map((s,i)=>({index:i,amount:s.amount,pStake:s.pStake,lockEnd:Number(s.lockEnd),lockDays:Number(s.lockDays),isUnlocked:Number(s.lockEnd)<=n,daysRemaining:Number(s.lockEnd)>n?Math.ceil((Number(s.lockEnd)-n)/86400):0}))}async function Bi(e){return await(await Et()).pendingRewards(e)}async function Ni(e){return await(await Et()).userTotalPStake(e)}async function $i(){return await(await Et()).totalPStake()}async function Si(){const e=await Et();try{const t=await e.forceUnstakePenaltyBps();return Number(t)/100}catch{return 10}}async function Li(){const e=await Et(),[t,a,n]=await Promise.all([e.MIN_LOCK_DAYS(),e.MAX_LOCK_DAYS(),e.forceUnstakePenaltyBps().catch(()=>1000n)]);return{minLockDays:Number(t),maxLockDays:Number(a),penaltyPercent:Number(n)/100,penaltyBips:Number(n)}}async function Ri(e){const a=await(await Et()).previewClaim(e);return{totalRewards:a.totalRewards,burnAmount:a.burnAmount,referrerCut:a.referrerCut,userReceives:a.userReceives,burnRateBps:Number(a.burnRateBps),nftBoost:Number(a.nftBoost)}}async function _i(e){const a=await(await Et()).getUserSummary(e);return{userTotalPStake:a.userTotalPStake||a[0],delegationCount:Number(a.delegationCount||a[1]),savedRewards:a.savedRewards||a[2],totalPending:a.totalPending||a[3],nftBoost:Number(a.nftBoost||a[4]),burnRateBps:Number(a.burnRateBps||a[5])}}const jt={delegate:Ci,unstake:Ii,forceUnstake:Ai,claimRewards:Pi,getUserDelegations:zi,getPendingRewards:Bi,getUserPStake:Ni,getTotalPStake:$i,getEarlyUnstakePenalty:Si,getStakingConfig:Li,previewClaim:Ri,getUserSummary:_i},kp=Object.freeze(Object.defineProperty({__proto__:null,StakingTx:jt,claimRewards:Pi,delegate:Ci,forceUnstake:Ai,getEarlyUnstakePenalty:Si,getPendingRewards:Bi,getStakingConfig:Li,getTotalPStake:$i,getUserDelegations:zi,getUserPStake:Ni,getUserSummary:_i,previewClaim:Ri,unstake:Ii},Symbol.toStringTag,{value:"Module"})),Ac=["diamond","gold","silver","bronze"];function Xn(e=null){var s,i,r;const t=(v==null?void 0:v.bkcToken)||(F==null?void 0:F.bkcToken)||((s=window.contractAddresses)==null?void 0:s.bkcToken),a=(v==null?void 0:v.rewardBooster)||(F==null?void 0:F.rewardBooster)||((i=window.contractAddresses)==null?void 0:i.rewardBooster);let n=null;if(e){const o=`pool_${e.toLowerCase()}`;n=(v==null?void 0:v[o])||(F==null?void 0:F[o])||((r=window.contractAddresses)==null?void 0:r[o])}if(!t||!a)throw new Error("Contract addresses not loaded");return{BKC_TOKEN:t,NFT_CONTRACT:a,NFT_POOL:n}}function ua(e){var a;const t=`pool_${e.toLowerCase()}`;return(v==null?void 0:v[t])||(F==null?void 0:F[t])||((a=window.contractAddresses)==null?void 0:a[t])||null}function Ep(){const e={};for(const t of Ac){const a=ua(t);a&&(e[t]=a)}return e}const Fi=["function buyNFT(uint256 maxBkcPrice, address operator) external payable returns (uint256 tokenId)","function buySpecificNFT(uint256 tokenId, uint256 maxBkcPrice, address operator) external payable","function sellNFT(uint256 tokenId, uint256 minPayout, address operator) external payable","function getBuyPrice() view returns (uint256)","function getSellPrice() view returns (uint256)","function getTotalBuyCost() view returns (uint256 bkcCost, uint256 ethCost)","function getTotalSellInfo() view returns (uint256 bkcPayout, uint256 ethCost)","function getEthFees() view returns (uint256 buyFee, uint256 sellFee)","function getSpread() view returns (uint256 spread, uint256 spreadBips)","function getPoolInfo() view returns (uint256 bkcBalance, uint256 nftCount, uint256 k, bool initialized, uint8 tier)","function getAvailableNFTs() view returns (uint256[])","function isNFTInPool(uint256 tokenId) view returns (bool)","function tier() view returns (uint8)","function getTierName() view returns (string)","function getStats() view returns (uint256 volume, uint256 buys, uint256 sells, uint256 ethFees)","event NFTPurchased(address indexed buyer, uint256 indexed tokenId, uint256 price, uint256 ethFee, uint256 nftCount, address operator)","event NFTSold(address indexed seller, uint256 indexed tokenId, uint256 payout, uint256 ethFee, uint256 nftCount, address operator)"],Pc=["function setApprovalForAll(address operator, bool approved) external","function isApprovedForAll(address owner, address operator) view returns (bool)","function ownerOf(uint256 tokenId) view returns (address)","function balanceOf(address owner) view returns (uint256)","function tokenTier(uint256 tokenId) view returns (uint8)"];function Mi(e,t){return new window.ethers.Contract(t,Fi,e)}async function Ee(e){const{NetworkManager:t}=await O(async()=>{const{NetworkManager:a}=await Promise.resolve().then(()=>Z);return{NetworkManager:a}},void 0);return new window.ethers.Contract(e,Fi,t.getProvider())}function Gt(e,t){const a=window.ethers;return a.keccak256(a.AbiCoder.defaultAbiCoder().encode(["string","uint8"],[e,Number(t)]))}function Os(e){const t=Xn();return new window.ethers.Contract(t.NFT_CONTRACT,Pc,e)}async function Tp(){const{NetworkManager:e}=await O(async()=>{const{NetworkManager:a}=await Promise.resolve().then(()=>Z);return{NetworkManager:a}},void 0),t=Xn();return new window.ethers.Contract(t.NFT_CONTRACT,Pc,e.getProvider())}async function Jn({poolAddress:e,poolTier:t,operator:a,button:n=null,onSuccess:s=null,onError:i=null}){const r=window.ethers,o=Xn(),l=e||ua(t);if(!l)throw new Error("Pool address or valid pool tier is required");let d=a,u=0n,m=0n;return await W.execute({name:"BuyNFT",button:n,getContract:async p=>Mi(p,l),method:"buyNFT",args:()=>[u,ee(d)],get value(){return m},get approval(){return u>0n?{token:o.BKC_TOKEN,spender:l,amount:u}:null},validate:async(p,g)=>{const b=await Ee(l),[w]=await b.getTotalBuyCost();u=w;const y=await b.tier();m=await ke(Gt("NFT_BUY_T",y)),console.log(`[BuyNFT] Price: ${r.formatEther(u)} BKC, Fee: ${r.formatEther(m)} ETH`);const C=await b.getPoolInfo();if(Number(C[1])<=1)throw new Error("No NFTs available in pool");const{NetworkManager:I}=await O(async()=>{const{NetworkManager:_}=await Promise.resolve().then(()=>Z);return{NetworkManager:_}},void 0),z=I.getProvider();if(await new r.Contract(o.BKC_TOKEN,["function balanceOf(address) view returns (uint256)"],z).balanceOf(g)<u)throw new Error(`Insufficient BKC. Need ${r.formatEther(u)} BKC`);if(await z.getBalance(g)<m+r.parseEther("0.001"))throw new Error("Insufficient ETH for fee + gas")},onSuccess:async p=>{let g=null;try{const b=new r.Interface(Fi);for(const w of p.logs)try{const y=b.parseLog(w);if((y==null?void 0:y.name)==="NFTPurchased"){g=Number(y.args.tokenId);break}}catch{}}catch{}s&&s(p,g)},onError:i})}async function Di({poolAddress:e,poolTier:t,tokenId:a,operator:n,button:s=null,onSuccess:i=null,onError:r=null}){const o=window.ethers,l=Xn(),d=e||ua(t);if(!d)throw new Error("Pool address or valid pool tier is required");if(a===void 0)throw new Error("Token ID is required");let u=n,m=0n,p=0n;return await W.execute({name:"BuySpecificNFT",button:s,getContract:async g=>Mi(g,d),method:"buySpecificNFT",args:()=>[a,m,ee(u)],get value(){return p},get approval(){return m>0n?{token:l.BKC_TOKEN,spender:d,amount:m}:null},validate:async(g,b)=>{const w=await Ee(d);if(!await w.isNFTInPool(a))throw new Error("NFT is not in pool");const[y]=await w.getTotalBuyCost();m=y;const C=await w.tier();p=await ke(Gt("NFT_BUY_T",C));const{NetworkManager:I}=await O(async()=>{const{NetworkManager:B}=await Promise.resolve().then(()=>Z);return{NetworkManager:B}},void 0),z=I.getProvider();if(await new o.Contract(l.BKC_TOKEN,["function balanceOf(address) view returns (uint256)"],z).balanceOf(b)<m)throw new Error("Insufficient BKC");if(await z.getBalance(b)<p+o.parseEther("0.001"))throw new Error("Insufficient ETH")},onSuccess:i,onError:r})}async function Zn({poolAddress:e,poolTier:t,tokenId:a,minPayout:n,operator:s,button:i=null,onSuccess:r=null,onError:o=null}){const l=window.ethers,d=e||ua(t);if(!d)throw new Error("Pool address or valid pool tier is required");if(a===void 0)throw new Error("Token ID is required");let u=s,m=0n,p=0n;return await W.execute({name:"SellNFT",button:i,getContract:async g=>Mi(g,d),method:"sellNFT",args:()=>[a,m,ee(u)],get value(){return p},validate:async(g,b)=>{const w=await Ee(d),y=Os(g);if((await y.ownerOf(a)).toLowerCase()!==b.toLowerCase())throw new Error("You do not own this NFT");const I=await w.tier(),z=await y.tokenTier(a);if(I!==z)throw new Error("NFT tier does not match pool tier");const[L]=await w.getTotalSellInfo();m=n?BigInt(n):L*95n/100n;const B=await w.tier();p=await ke(Gt("NFT_SELL_T",B));const{NetworkManager:A}=await O(async()=>{const{NetworkManager:D}=await Promise.resolve().then(()=>Z);return{NetworkManager:D}},void 0);if(await A.getProvider().getBalance(b)<p+l.parseEther("0.001"))throw new Error("Insufficient ETH");if(!await y.isApprovedForAll(b,d)){const{NetworkManager:D}=await O(async()=>{const{NetworkManager:se}=await Promise.resolve().then(()=>Z);return{NetworkManager:se}},void 0),j=await D.getProvider().getFeeData(),H={gasLimit:100000n};j.maxFeePerGas&&(H.maxFeePerGas=j.maxFeePerGas*120n/100n,H.maxPriorityFeePerGas=j.maxPriorityFeePerGas||0n),await(await y.setApprovalForAll(d,!0,H)).wait()}},onSuccess:r,onError:o})}async function Oi({poolAddress:e,poolTier:t,button:a=null,onSuccess:n=null,onError:s=null}){const i=e||ua(t);if(!i)throw new Error("Pool address or valid pool tier is required");return await W.execute({name:"ApproveAllNFTs",button:a,getContract:async r=>Os(r),method:"setApprovalForAll",args:[i,!0],validate:async(r,o)=>{if(await Os(r).isApprovedForAll(o,i))throw new Error("Already approved")},onSuccess:n,onError:s})}async function Hi(e){return await(await Ee(e)).getBuyPrice()}async function Ui(e){return await(await Ee(e)).getSellPrice()}async function ji(e){const t=window.ethers,a=await Ee(e),[n]=await a.getTotalBuyCost(),s=await a.tier(),i=await ke(Gt("NFT_BUY_T",s));return{bkcCost:n,bkcFormatted:t.formatEther(n),ethCost:i,ethFormatted:t.formatEther(i)}}async function Gi(e){const t=window.ethers,a=await Ee(e),[n]=await a.getTotalSellInfo(),s=await a.tier(),i=await ke(Gt("NFT_SELL_T",s));return{bkcPayout:n,bkcFormatted:t.formatEther(n),ethCost:i,ethFormatted:t.formatEther(i)}}async function Wi(e){const t=window.ethers,a=await Ee(e),[n,s,i]=await Promise.all([a.getPoolInfo(),a.getBuyPrice().catch(()=>0n),a.getSellPrice().catch(()=>0n)]);return{bkcBalance:n[0],nftCount:Number(n[1]),k:n[2],initialized:n[3],tier:Number(n[4]),buyPrice:s,buyPriceFormatted:t.formatEther(s),sellPrice:i,sellPriceFormatted:t.formatEther(i)}}async function Ki(e){return(await(await Ee(e)).getAvailableNFTs()).map(a=>Number(a))}async function Qn(e){const t=window.ethers,n=await(await Ee(e)).tier(),s=await ke(Gt("NFT_BUY_T",n)),i=await ke(Gt("NFT_SELL_T",n));return{buyFee:s,buyFeeFormatted:t.formatEther(s),sellFee:i,sellFeeFormatted:t.formatEther(i)}}const zc=Qn;async function es(e){const t=window.ethers,n=await(await Ee(e)).getStats();return{volume:n[0],volumeFormatted:t.formatEther(n[0]),buys:Number(n[1]),sells:Number(n[2]),ethFees:n[3],ethFeesFormatted:t.formatEther(n[3])}}const Bc=es;async function Yi(e){return await(await Ee(e)).getTierName()}async function Vi(e){const t=window.ethers,a=await Ee(e);try{const n=await a.getSpread();return{spread:n.spread,spreadFormatted:t.formatEther(n.spread),spreadBips:Number(n.spreadBips),spreadPercent:Number(n.spreadBips)/100}}catch{const[n,s]=await Promise.all([a.getBuyPrice().catch(()=>0n),a.getSellPrice().catch(()=>0n)]),i=n>s?n-s:0n,r=s>0n?Number(i*10000n/s):0;return{spread:i,spreadFormatted:t.formatEther(i),spreadBips:r,spreadPercent:r/100}}}async function Nc(e,t){return await(await Ee(e)).isNFTInPool(t)}async function qi(e,t){return await(await Tp()).isApprovedForAll(e,t)}const $c=Jn,Sc=Zn,vn={buyNft:Jn,buySpecificNft:Di,sellNft:Zn,approveAllNfts:Oi,buyFromPool:$c,sellToPool:Sc,getBuyPrice:Hi,getSellPrice:Ui,getTotalBuyCost:ji,getTotalSellInfo:Gi,getEthFees:Qn,getEthFeeConfig:zc,getPoolInfo:Wi,getAvailableNfts:Ki,isNFTInPool:Nc,isApprovedForAll:qi,getStats:es,getTradingStats:Bc,getTierName:Yi,getSpread:Vi,getPoolAddress:ua,getAllPools:Ep,POOL_TIERS:Ac},Cp=Object.freeze(Object.defineProperty({__proto__:null,NftTx:vn,approveAllNfts:Oi,buyFromPool:$c,buyNft:Jn,buySpecificNft:Di,getAvailableNfts:Ki,getBuyPrice:Hi,getEthFeeConfig:zc,getEthFees:Qn,getPoolInfo:Wi,getSellPrice:Ui,getSpread:Vi,getStats:es,getTierName:Yi,getTotalBuyCost:ji,getTotalSellInfo:Gi,getTradingStats:Bc,isApprovedForAll:qi,isNFTInPool:Nc,sellNft:Zn,sellToPool:Sc},Symbol.toStringTag,{value:"Module"}));function Xi(){var a,n;const e=(v==null?void 0:v.fortunePool)||(F==null?void 0:F.fortunePool)||((a=window.contractAddresses)==null?void 0:a.fortunePool),t=(v==null?void 0:v.bkcToken)||(F==null?void 0:F.bkcToken)||((n=window.contractAddresses)==null?void 0:n.bkcToken);if(!e)throw console.error("❌ FortunePool address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");if(!t)throw console.error("❌ BKC Token address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{BKC_TOKEN:t,FORTUNE_POOL:e}}const ts=["function commitPlay(bytes32 commitHash, uint256 wagerAmount, uint8 tierMask, address operator) external payable returns (uint256 gameId)","function revealPlay(uint256 gameId, uint256[] calldata guesses, bytes32 userSecret) external returns (uint256 prizeWon)","function claimExpired(uint256 gameId) external","function fundPrizePool(uint256 amount) external","function getTierInfo(uint8 tier) view returns (uint256 range, uint256 multiplier, uint256 winChanceBps)","function getAllTiers() view returns (uint256[3] ranges, uint256[3] multipliers, uint256[3] winChances)","function TIER_COUNT() view returns (uint8)","function getGame(uint256 gameId) view returns (address player, uint48 commitBlock, uint8 tierMask, uint8 status, address operator, uint96 wagerAmount)","function getGameResult(uint256 gameId) view returns (address player, uint128 grossWager, uint128 prizeWon, uint8 tierMask, uint8 matchCount, uint48 revealBlock)","function getGameStatus(uint256 gameId) view returns (uint8 status, bool canReveal, uint256 blocksUntilReveal, uint256 blocksUntilExpiry)","function calculatePotentialWinnings(uint256 wagerAmount, uint8 tierMask) view returns (uint256 netToPool, uint256 bkcFee, uint256 maxPrize, uint256 maxPrizeAfterCap)","function getRequiredFee(uint8 tierMask) view returns (uint256 fee)","function generateCommitHash(uint256[] calldata guesses, bytes32 userSecret) pure returns (bytes32)","function gameCounter() view returns (uint256)","function prizePool() view returns (uint256)","function getPoolStats() view returns (uint256 prizePool, uint256 totalGamesPlayed, uint256 totalBkcWagered, uint256 totalBkcWon, uint256 totalBkcForfeited, uint256 totalBkcBurned, uint256 maxPayoutNow)","function REVEAL_DELAY() view returns (uint256)","function REVEAL_WINDOW() view returns (uint256)","function BKC_FEE_BPS() view returns (uint256)","function MAX_PAYOUT_BPS() view returns (uint256)","event GameCommitted(uint256 indexed gameId, address indexed player, uint256 wagerAmount, uint8 tierMask, address operator)","event GameRevealed(uint256 indexed gameId, address indexed player, uint256 grossWager, uint256 prizeWon, uint8 tierMask, uint8 matchCount, address operator)","event GameExpired(uint256 indexed gameId, address indexed player, uint256 forfeitedAmount)"],Ji=[{range:5,multiplierBps:2e4},{range:15,multiplierBps:1e5},{range:150,multiplierBps:1e6}];function Lc(e){const t=window.ethers,a=Xi();return new t.Contract(a.FORTUNE_POOL,ts,e)}async function Vt(){const e=window.ethers,{NetworkManager:t}=await O(async()=>{const{NetworkManager:s}=await Promise.resolve().then(()=>Z);return{NetworkManager:s}},void 0),a=t.getProvider(),n=Xi();return new e.Contract(n.FORTUNE_POOL,ts,a)}const Zi="fortune_pending_games";function as(){try{return JSON.parse(localStorage.getItem(Zi)||"{}")}catch{return{}}}function Ip(e,t){const a=as();a[e]={...t,savedAt:Date.now()},localStorage.setItem(Zi,JSON.stringify(a))}function Ap(e){const t=as();delete t[e],localStorage.setItem(Zi,JSON.stringify(t))}function Qi(e,t){const a=window.ethers,s=a.AbiCoder.defaultAbiCoder().encode(["uint256[]","bytes32"],[e.map(i=>BigInt(i)),t]);return a.keccak256(s)}function Rc(){const e=window.ethers;return e.hexlify(e.randomBytes(32))}function Pp(e){let t=0;for(;e;)t+=e&1,e>>=1;return t}async function ns({commitmentHash:e,wagerAmount:t,tierMask:a,operator:n,button:s=null,onSuccess:i=null,onError:r=null}){const o=window.ethers,l=Xi(),d=BigInt(t),u=Number(a);if(u<1||u>7)throw new Error("tierMask must be 1-7");let m=n,p=0n;try{for(let g=0;g<3;g++)u&1<<g&&(p+=await ke(o.id(`FORTUNE_TIER${g}`)));console.log("[FortuneTx] ETH fee:",o.formatEther(p))}catch(g){throw console.error("[FortuneTx] Could not calculate ETH fee:",g.message),new Error("Could not calculate ETH fee")}return await W.execute({name:"CommitPlay",button:s,getContract:async g=>Lc(g),method:"commitPlay",args:()=>[e,d,u,ee(m)],value:p,approval:{token:l.BKC_TOKEN,spender:l.FORTUNE_POOL,amount:d},validate:async(g,b)=>{if(d<=0n)throw new Error("Wager amount must be greater than 0");const{NetworkManager:w}=await O(async()=>{const{NetworkManager:C}=await Promise.resolve().then(()=>Z);return{NetworkManager:C}},void 0),y=await w.getProvider().getBalance(b);if(p>0n&&y<p+o.parseEther("0.001"))throw new Error(`Insufficient ETH for fee (${o.formatEther(p)} ETH required)`)},onSuccess:async g=>{let b=null;try{const w=new o.Interface(ts);for(const y of g.logs)try{const C=w.parseLog(y);if(C.name==="GameCommitted"){b=Number(C.args.gameId);break}}catch{}}catch{}i&&i({gameId:b,txHash:g.hash,commitBlock:g.blockNumber})},onError:r})}async function ss({gameId:e,guesses:t,userSecret:a,button:n=null,onSuccess:s=null,onError:i=null}){const r=window.ethers,o=t.map(l=>BigInt(l));return await W.execute({name:"RevealPlay",button:n,getContract:async l=>Lc(l),method:"revealPlay",args:[e,o,a],validate:async(l,d)=>{const u=await Vt(),m=await u.getGameStatus(e);if(Number(m.status)===3)throw new Error("Game has expired.");if(!m.canReveal)throw Number(m.blocksUntilReveal)>0?new Error(`Must wait ${m.blocksUntilReveal} more blocks before reveal`):new Error("Cannot reveal this game");const p=await u.getGame(e);if(p.player.toLowerCase()!==d.toLowerCase())throw new Error("You are not the owner of this game");const g=Qi(t,a);p[0]&&p[0]},onSuccess:async l=>{let d=null;try{const u=new r.Interface(ts);for(const m of l.logs)try{const p=u.parseLog(m);p.name==="GameRevealed"&&(d={gameId:Number(p.args.gameId),grossWager:p.args.grossWager,prizeWon:p.args.prizeWon,tierMask:Number(p.args.tierMask),matchCount:Number(p.args.matchCount),won:p.args.prizeWon>0n})}catch{}}catch{}Ap(e),s&&s(l,d)},onError:i})}async function er({wagerAmount:e,guess:t,guesses:a,tierMask:n=1,operator:s,button:i=null,onSuccess:r=null,onError:o=null}){const l=Number(n);if(l<1||l>7)throw new Error("tierMask must be 1-7");const d=Pp(l);let u=[];if(a&&Array.isArray(a)&&a.length>0)u=a.map(b=>Number(b));else if(t!==void 0)u=[Number(Array.isArray(t)?t[0]:t)];else throw new Error("Guess(es) required");if(u.length!==d)throw new Error(`tierMask selects ${d} tier(s) but ${u.length} guess(es) provided`);let m=0;for(let b=0;b<3;b++)if(l&1<<b){const w=Ji[b].range;if(u[m]<1||u[m]>w)throw new Error(`Tier ${b} guess must be between 1 and ${w}`);m++}const p=Rc(),g=Qi(u,p);return await ns({commitmentHash:g,wagerAmount:e,tierMask:l,operator:s,button:i,onSuccess:b=>{Ip(b.gameId,{guesses:u,userSecret:p,tierMask:l,wagerAmount:e.toString(),commitmentHash:g}),r&&r({...b,guesses:u,userSecret:p,tierMask:l})},onError:o})}async function tr(){const e=await Vt();try{const t=await e.getAllTiers(),a=[];for(let n=0;n<3;n++)a.push({tierId:n,maxRange:Number(t.ranges[n]),multiplierBps:Number(t.multipliers[n]),multiplier:Number(t.multipliers[n])/1e4,winChanceBps:Number(t.winChances[n]),active:!0});return a}catch{return Ji.map((t,a)=>({tierId:a,maxRange:t.range,multiplierBps:t.multiplierBps,multiplier:t.multiplierBps/1e4,active:!0}))}}async function _c(e){const t=await Vt();try{const a=await t.getTierInfo(e);return{tierId:e,maxRange:Number(a.range),multiplierBps:Number(a.multiplier),multiplier:Number(a.multiplier)/1e4,winChanceBps:Number(a.winChanceBps)}}catch{return null}}async function ar(e=1){const t=window.ethers,a=Number(e);try{let n=0n;for(let s=0;s<3;s++)a&1<<s&&(n+=await ke(t.id(`FORTUNE_TIER${s}`)));return n}catch{return 0n}}async function nr(){const e=window.ethers,t=await Vt();try{const a=await t.getPoolStats();return{prizePoolBalance:a[0],prizePoolFormatted:e.formatEther(a[0]),gameCounter:Number(a[1]),totalWageredAllTime:a[2],totalWageredFormatted:e.formatEther(a[2]),totalPaidOutAllTime:a[3],totalPaidOutFormatted:e.formatEther(a[3]),totalForfeited:a[4],totalBurned:a[5],maxPayoutNow:a[6],maxPayoutFormatted:e.formatEther(a[6])}}catch{const[a,n]=await Promise.all([t.gameCounter().catch(()=>0n),t.prizePool().catch(()=>0n)]);return{gameCounter:Number(a),prizePoolBalance:n,prizePoolFormatted:e.formatEther(n)}}}async function Fc(){return 3}async function sr(e,t=1){const a=window.ethers,n=await Vt();try{const s=await n.calculatePotentialWinnings(e,Number(t));return{netToPool:s.netToPool||s[0],bkcFee:s.bkcFee||s[1],maxPrize:s.maxPrize||s[2],maxPrizeFormatted:a.formatEther(s.maxPrize||s[2]),maxPrizeAfterCap:s.maxPrizeAfterCap||s[3],maxPrizeAfterCapFormatted:a.formatEther(s.maxPrizeAfterCap||s[3])}}catch{return{netToPool:0n,bkcFee:0n,maxPrize:0n,maxPrizeAfterCap:0n}}}async function ir(e){const t=await Vt();try{const a=await t.getGameResult(e);return{player:a.player,grossWager:a.grossWager,prizeWon:a.prizeWon,tierMask:Number(a.tierMask),matchCount:Number(a.matchCount),revealBlock:Number(a.revealBlock),won:a.prizeWon>0n}}catch{return null}}async function rr(e){const t=await Vt();try{const a=await t.getGameStatus(e);return{status:Number(a.status),statusName:["NONE","COMMITTED","REVEALED","EXPIRED"][Number(a.status)]||"UNKNOWN",canReveal:a.canReveal,isExpired:Number(a.status)===3,blocksUntilReveal:Number(a.blocksUntilReveal),blocksUntilExpiry:Number(a.blocksUntilExpiry)}}catch{return null}}function Mc(){return as()}function or(e){return as()[e]||null}async function Dc(e,t={}){const a=or(e);if(!a)throw new Error(`No pending game found with ID ${e}`);return await ss({gameId:e,guesses:a.guesses,userSecret:a.userSecret,...t})}const is={commitPlay:ns,revealPlay:ss,playGame:er,revealPendingGame:Dc,getPendingGamesForReveal:Mc,getPendingGame:or,generateCommitmentHashLocal:Qi,generateSecret:Rc,getActiveTiers:tr,getTierById:_c,getServiceFee:ar,getPoolStats:nr,getActiveTierCount:Fc,calculatePotentialWin:sr,getGameResult:ir,getCommitmentStatus:rr,TIERS:Ji},zp=Object.freeze(Object.defineProperty({__proto__:null,FortuneTx:is,calculatePotentialWin:sr,commitPlay:ns,getActiveTierCount:Fc,getActiveTiers:tr,getCommitmentStatus:rr,getGameResult:ir,getPendingGame:or,getPendingGamesForReveal:Mc,getPoolStats:nr,getServiceFee:ar,getTierById:_c,playGame:er,revealPendingGame:Dc,revealPlay:ss},Symbol.toStringTag,{value:"Module"}));function rs(){var a,n;const e=(v==null?void 0:v.rentalManager)||(F==null?void 0:F.rentalManager)||((a=window.contractAddresses)==null?void 0:a.rentalManager),t=(v==null?void 0:v.rewardBooster)||(F==null?void 0:F.rewardBooster)||((n=window.contractAddresses)==null?void 0:n.rewardBooster);if(!e||!t)throw new Error("Contract addresses not loaded. Please refresh the page.");return{RENTAL_MANAGER:e,NFT_CONTRACT:t}}const lr=["function listNFT(uint256 tokenId, uint96 pricePerHour, uint16 minHours, uint16 maxHours) external","function updateListing(uint256 tokenId, uint96 pricePerHour, uint16 minHours, uint16 maxHours) external","function withdrawNFT(uint256 tokenId) external","function rentNFT(uint256 tokenId, uint256 hours_, address operator) external payable","function withdrawEarnings() external","function getListing(uint256 tokenId) view returns (address owner, uint96 pricePerHour, uint16 minHours, uint16 maxHours, uint96 totalEarnings, uint32 rentalCount, bool currentlyRented, uint48 rentalEndTime)","function getAllListedTokenIds() view returns (uint256[])","function getListingCount() view returns (uint256)","function getRental(uint256 tokenId) view returns (address tenant, uint48 endTime, bool isActive)","function isRented(uint256 tokenId) view returns (bool)","function getRemainingTime(uint256 tokenId) view returns (uint256)","function hasActiveRental(address user) view returns (bool)","function getRentalCost(uint256 tokenId, uint256 hours_) view returns (uint256 rentalCost, uint256 ethFee, uint256 totalCost)","function pendingEarnings(address user) view returns (uint256)","function getStats() view returns (uint256 activeListings, uint256 volume, uint256 rentals, uint256 ethFees, uint256 earningsWithdrawn)","event NFTListed(uint256 indexed tokenId, address indexed owner, uint96 pricePerHour, uint16 minHours, uint16 maxHours)","event NFTRented(uint256 indexed tokenId, address indexed tenant, address indexed owner, uint256 hours_, uint256 rentalCost, uint256 ethFee, uint48 endTime, address operator)","event NFTWithdrawn(uint256 indexed tokenId, address indexed owner)","event EarningsWithdrawn(address indexed owner, uint256 amount)"],Bp=["function setApprovalForAll(address operator, bool approved) external","function isApprovedForAll(address owner, address operator) view returns (bool)","function ownerOf(uint256 tokenId) view returns (address)"];function Oa(e){const t=rs();return new window.ethers.Contract(t.RENTAL_MANAGER,lr,e)}async function Te(){const{NetworkManager:e}=await O(async()=>{const{NetworkManager:a}=await Promise.resolve().then(()=>Z);return{NetworkManager:a}},void 0),t=rs();return new window.ethers.Contract(t.RENTAL_MANAGER,lr,e.getProvider())}function Np(e){const t=rs();return new window.ethers.Contract(t.NFT_CONTRACT,Bp,e)}async function os({tokenId:e,pricePerHour:t,minHours:a,maxHours:n,button:s=null,onSuccess:i=null,onError:r=null}){const o=rs(),l=BigInt(t);return await W.execute({name:"ListNFT",button:s,getContract:async d=>Oa(d),method:"listNFT",args:[e,l,a,n],validate:async(d,u)=>{const m=Np(d);if((await m.ownerOf(e)).toLowerCase()!==u.toLowerCase())throw new Error("You do not own this NFT");if(!await m.isApprovedForAll(u,o.RENTAL_MANAGER)){const{NetworkManager:b}=await O(async()=>{const{NetworkManager:I}=await Promise.resolve().then(()=>Z);return{NetworkManager:I}},void 0),w=await b.getProvider().getFeeData(),y={gasLimit:100000n};w.maxFeePerGas&&(y.maxFeePerGas=w.maxFeePerGas*120n/100n,y.maxPriorityFeePerGas=w.maxPriorityFeePerGas||0n),await(await m.setApprovalForAll(o.RENTAL_MANAGER,!0,y)).wait()}},onSuccess:i,onError:r})}async function ls({tokenId:e,hours:t,operator:a,button:n=null,onSuccess:s=null,onError:i=null}){const r=window.ethers;let o=a,l=0n;return await W.execute({name:"RentNFT",button:n,getContract:async d=>Oa(d),method:"rentNFT",args:()=>[e,t,ee(o)],get value(){return l},validate:async(d,u)=>{const m=await Te(),p=await m.getListing(e);if(p.owner===r.ZeroAddress)throw new Error("NFT is not listed for rent");if(p.currentlyRented)throw new Error("NFT is currently rented");if(t<Number(p.minHours)||t>Number(p.maxHours))throw new Error(`Hours must be between ${p.minHours} and ${p.maxHours}`);const g=await m.getRentalCost(e,t),b=g.rentalCost||g[0],w=await ke(r.id("RENTAL_RENT"),b);l=b+w;const{NetworkManager:y}=await O(async()=>{const{NetworkManager:I}=await Promise.resolve().then(()=>Z);return{NetworkManager:I}},void 0);if(await y.getProvider().getBalance(u)<l+r.parseEther("0.001"))throw new Error(`Insufficient ETH. Need ${r.formatEther(l)} ETH + gas`)},onSuccess:async d=>{let u=null;try{const m=new r.Interface(lr);for(const p of d.logs)try{const g=m.parseLog(p);if((g==null?void 0:g.name)==="NFTRented"){u={endTime:Number(g.args.endTime),rentalCost:g.args.rentalCost,ethFee:g.args.ethFee};break}}catch{}}catch{}s&&s(d,u)},onError:i})}async function cs({tokenId:e,button:t=null,onSuccess:a=null,onError:n=null}){const s=window.ethers;return await W.execute({name:"WithdrawNFT",button:t,getContract:async i=>Oa(i),method:"withdrawNFT",args:[e],validate:async(i,r)=>{const l=await(await Te()).getListing(e);if(l.owner===s.ZeroAddress)throw new Error("NFT is not listed");if(l.owner.toLowerCase()!==r.toLowerCase())throw new Error("Only the owner can withdraw");if(l.currentlyRented)throw new Error("Cannot withdraw while NFT is rented")},onSuccess:a,onError:n})}async function cr({button:e=null,onSuccess:t=null,onError:a=null}={}){const n=window.ethers;return await W.execute({name:"WithdrawEarnings",button:e,getContract:async s=>Oa(s),method:"withdrawEarnings",args:[],validate:async(s,i)=>{const o=await(await Te()).pendingEarnings(i);if(o===0n)throw new Error("No earnings to withdraw");console.log("[RentalTx] Withdrawing:",n.formatEther(o),"ETH")},onSuccess:t,onError:a})}async function dr({tokenId:e,pricePerHour:t,minHours:a,maxHours:n,button:s=null,onSuccess:i=null,onError:r=null}){const o=BigInt(t);return await W.execute({name:"UpdateListing",button:s,getContract:async l=>Oa(l),method:"updateListing",args:[e,o,a,n],validate:async(l,d)=>{const m=await(await Te()).getListing(e);if(m.owner===window.ethers.ZeroAddress)throw new Error("NFT is not listed");if(m.owner.toLowerCase()!==d.toLowerCase())throw new Error("Only the owner can update")},onSuccess:i,onError:r})}async function ur(e){const t=window.ethers,n=await(await Te()).getListing(e);return{owner:n.owner,pricePerHour:n.pricePerHour,pricePerHourFormatted:t.formatEther(n.pricePerHour),minHours:Number(n.minHours),maxHours:Number(n.maxHours),totalEarnings:n.totalEarnings,totalEarningsFormatted:t.formatEther(n.totalEarnings),rentalCount:Number(n.rentalCount),isActive:n.owner!==t.ZeroAddress,currentlyRented:n.currentlyRented,rentalEndTime:Number(n.rentalEndTime)}}async function pr(e){const a=await(await Te()).getRental(e),n=Math.floor(Date.now()/1e3),s=Number(a.endTime);return{tenant:a.tenant,endTime:s,isActive:a.isActive,hoursRemaining:a.isActive?Math.max(0,Math.ceil((s-n)/3600)):0}}async function mr(){return(await(await Te()).getAllListedTokenIds()).map(a=>Number(a))}async function fr(){const e=await Te();return Number(await e.getListingCount())}async function br(e,t){const a=window.ethers,s=await(await Te()).getRentalCost(e,t),i=s.rentalCost||s[0],r=await ke(a.id("RENTAL_RENT"),i),o=i+r;return{rentalCost:i,rentalCostFormatted:a.formatEther(i),ethFee:r,ethFeeFormatted:a.formatEther(r),totalCost:o,totalCostFormatted:a.formatEther(o)}}async function gr(e){return await(await Te()).isRented(e)}async function xr(e){const t=await Te();return Number(await t.getRemainingTime(e))}async function hr(e){const t=await Te();try{return await t.hasActiveRental(e)}catch{return!1}}async function vr(e){const t=window.ethers,n=await(await Te()).pendingEarnings(e);return{amount:n,formatted:t.formatEther(n)}}async function wr(){const e=window.ethers,t=await Te();try{const a=await t.getStats();return{activeListings:Number(a.activeListings||a[0]),totalVolume:a.volume||a[1],totalVolumeFormatted:e.formatEther(a.volume||a[1]),totalRentals:Number(a.rentals||a[2]),totalEthFees:a.ethFees||a[3],totalEthFeesFormatted:e.formatEther(a.ethFees||a[3]),totalEarningsWithdrawn:a.earningsWithdrawn||a[4],totalEarningsWithdrawnFormatted:e.formatEther(a.earningsWithdrawn||a[4])}}catch{return{activeListings:0,totalVolume:0n,totalVolumeFormatted:"0",totalRentals:0,totalEthFees:0n,totalEthFeesFormatted:"0"}}}const Oc=os,Hc=ls,Uc=cs,lt={listNft:os,rentNft:ls,withdrawNft:cs,withdrawEarnings:cr,updateListing:dr,list:Oc,rent:Hc,withdraw:Uc,getListing:ur,getAllListedTokenIds:mr,getListingCount:fr,getRentalCost:br,getRental:pr,isRented:gr,getRemainingRentalTime:xr,hasActiveRental:hr,getPendingEarnings:vr,getMarketplaceStats:wr},$p=Object.freeze(Object.defineProperty({__proto__:null,RentalTx:lt,getAllListedTokenIds:mr,getListing:ur,getListingCount:fr,getMarketplaceStats:wr,getPendingEarnings:vr,getRemainingRentalTime:xr,getRental:pr,getRentalCost:br,hasActiveRental:hr,isRented:gr,list:Oc,listNft:os,rent:Hc,rentNft:ls,updateListing:dr,withdraw:Uc,withdrawEarnings:cr,withdrawNft:cs},Symbol.toStringTag,{value:"Module"}));function jc(){var t;const e=(v==null?void 0:v.notary)||(F==null?void 0:F.notary)||((t=window.contractAddresses)==null?void 0:t.notary);if(!e)throw console.error("❌ Notary address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{NOTARY:e}}const yr=["function certify(bytes32 documentHash, string calldata meta, uint8 docType, address operator) external payable returns (uint256 certId)","function batchCertify(bytes32[] calldata documentHashes, string[] calldata metas, uint8[] calldata docTypes, address operator) external payable returns (uint256 startId)","function transferCertificate(bytes32 documentHash, address newOwner) external","function verify(bytes32 documentHash) view returns (bool exists, address owner, uint48 timestamp, uint8 docType, string memory meta)","function getCertificate(uint256 certId) view returns (bytes32 documentHash, address owner, uint48 timestamp, uint8 docType, string memory meta)","function getFee() view returns (uint256)","function getStats() view returns (uint256 certCount, uint256 totalEthCollected)","function certCount() view returns (uint256)","function version() view returns (string)","event Certified(uint256 indexed certId, address indexed owner, bytes32 indexed documentHash, uint8 docType, address operator)","event BatchCertified(address indexed owner, uint256 startId, uint256 count, address operator)","event CertificateTransferred(bytes32 indexed documentHash, address indexed from, address indexed to)"],Sp={GENERAL:0,CONTRACT:1,IDENTITY:2,DIPLOMA:3,PROPERTY:4,FINANCIAL:5,LEGAL:6,MEDICAL:7,IP:8,OTHER:9};function Lp(e){const t=window.ethers;if(!t)throw new Error("ethers.js not loaded");if(!e)throw new Error("Signer is required for write operations");const a=jc();return new t.Contract(a.NOTARY,yr,e)}async function Ha(){const e=window.ethers;if(!e)throw new Error("ethers.js not loaded");const{NetworkManager:t}=await O(async()=>{const{NetworkManager:s}=await Promise.resolve().then(()=>Z);return{NetworkManager:s}},void 0),a=t.getProvider();if(!a)throw new Error("Provider not available");const n=jc();return new e.Contract(n.NOTARY,yr,a)}function Rp(e){if(!e)return!1;const t=e.startsWith("0x")?e:`0x${e}`;return/^0x[a-fA-F0-9]{64}$/.test(t)}async function ds({documentHash:e,meta:t="",docType:a=0,operator:n,button:s=null,onSuccess:i=null,onError:r=null}){const o=window.ethers;if(!e)throw new Error("Document hash is required");const l=e.startsWith("0x")?e:`0x${e}`;if(!Rp(l))throw new Error("Invalid document hash format. Must be a valid bytes32 (64 hex characters)");if(a<0||a>9)throw new Error("Document type must be between 0 and 9");let d=n,u=0n;return await W.execute({name:"Certify",button:s,getContract:async m=>Lp(m),method:"certify",args:()=>[l,t||"",a,ee(d)],get value(){return u},validate:async(m,p)=>{if((await(await Ha()).verify(l)).exists)throw new Error("This document hash has already been certified");u=await ke(o.id("NOTARY_CERTIFY")),console.log("[NotaryTx] Fee:",o.formatEther(u),"ETH");const{NetworkManager:w}=await O(async()=>{const{NetworkManager:z}=await Promise.resolve().then(()=>Z);return{NetworkManager:z}},void 0),C=await w.getProvider().getBalance(p),I=u+o.parseEther("0.001");if(C<I)throw new Error(`Insufficient ETH. Need ~${o.formatEther(I)} ETH for fee + gas`)},onSuccess:async m=>{let p=null;try{const g=new o.Interface(yr);for(const b of m.logs)try{const w=g.parseLog(b);if(w&&w.name==="Certified"){p=Number(w.args.certId);break}}catch{}}catch{}i&&i(m,p)},onError:m=>{console.error("[NotaryTx] Certification failed:",m),r&&r(m)}})}const kr=ds;async function Ua(e){const t=await Ha(),a=e.startsWith("0x")?e:`0x${e}`;try{const n=await t.verify(a);return{exists:n.exists,owner:n.exists?n.owner:null,timestamp:n.exists?Number(n.timestamp):null,date:n.exists?new Date(Number(n.timestamp)*1e3):null,docType:n.exists?Number(n.docType):null,meta:n.exists?n.meta:null}}catch(n){return console.error("[NotaryTx] verify error:",n),{exists:!1,owner:null,timestamp:null,date:null,docType:null,meta:null}}}const Er=Ua;async function us(e){const t=await Ha();try{const a=await t.getCertificate(e);return a.documentHash==="0x"+"0".repeat(64)?null:{id:e,documentHash:a.documentHash,owner:a.owner,timestamp:Number(a.timestamp),date:new Date(Number(a.timestamp)*1e3),docType:Number(a.docType),meta:a.meta}}catch{return null}}const Tr=us;async function Cr(){const e=window.ethers,t=await ke(e.id("NOTARY_CERTIFY"));return{ethFee:t,ethFormatted:e.formatEther(t)+" ETH"}}async function Ir(){const e=await Ha();return Number(await e.certCount())}async function Ar(){const e=window.ethers,a=await(await Ha()).getStats();return{totalCertifications:Number(a.certCount||a[0]),totalETHCollected:a.totalEthCollected||a[1],totalETHFormatted:e.formatEther(a.totalEthCollected||a[1])}}async function ja(e){let t;if(e instanceof ArrayBuffer)t=e;else if(e instanceof Blob||e instanceof File)t=await e.arrayBuffer();else throw new Error("Invalid file type. Expected File, Blob, or ArrayBuffer");const a=await crypto.subtle.digest("SHA-256",t);return"0x"+Array.from(new Uint8Array(a)).map(s=>s.toString(16).padStart(2,"0")).join("")}async function Pr(e,t){const a=await ja(e);return Go(t)===Go(a)}function Go(e){return(e.startsWith("0x")?e:`0x${e}`).toLowerCase()}async function Gc(e,t){const a=t||await ja(e),n=await Ua(a);let s=!0;return t&&(s=await Pr(e,t)),{contentHash:a,hashMatches:s,existsOnChain:n.exists,certId:null,owner:n.owner,timestamp:n.timestamp,date:n.date,docType:n.docType,isVerified:s&&n.exists}}const Ve={certify:ds,notarize:kr,verify:Ua,verifyByHash:Er,getCertificate:us,getDocument:Tr,getTotalDocuments:Ir,getFee:Cr,getStats:Ar,calculateFileHash:ja,verifyDocumentHash:Pr,verifyDocumentOnChain:Gc,DOC_TYPES:Sp},_p=Object.freeze(Object.defineProperty({__proto__:null,NotaryTx:Ve,calculateFileHash:ja,certify:ds,getCertificate:us,getDocument:Tr,getFee:Cr,getStats:Ar,getTotalDocuments:Ir,notarize:kr,verify:Ua,verifyByHash:Er,verifyDocumentHash:Pr,verifyDocumentOnChain:Gc},Symbol.toStringTag,{value:"Module"}));function Wc(){var t;const e=(v==null?void 0:v.agora)||(F==null?void 0:F.agora)||((t=window.contractAddresses)==null?void 0:t.agora);if(!e)throw new Error("Agora contract address not loaded");return{AGORA:e}}const ps=la;function Ce(e){return new window.ethers.Contract(Wc().AGORA,ps,e)}async function he(){const{NetworkManager:e}=await O(async()=>{const{NetworkManager:t}=await Promise.resolve().then(()=>Z);return{NetworkManager:t}},void 0);return new window.ethers.Contract(Wc().AGORA,ps,e.getProvider())}async function zr({username:e,metadataURI:t="",operator:a,button:n=null,onSuccess:s=null,onError:i=null}){const r=window.ethers;let o=a,l=0n;return await W.execute({name:"CreateProfile",button:n,skipSimulation:!0,fixedGasLimit:300000n,getContract:async d=>Ce(d),method:"createProfile",args:()=>[e,t||"",ee(o)],get value(){return l},validate:async(d,u)=>{const m=await he();if(!e||e.length<1||e.length>15)throw new Error("Username must be 1-15 characters");if(!/^[a-z0-9_]+$/.test(e))throw new Error("Username: lowercase letters, numbers, underscores only");if(!await m.isUsernameAvailable(e))throw new Error("Username is already taken");l=await m.getUsernamePrice(e.length),console.log("[Agora] Username fee:",r.formatEther(l),"ETH");const{NetworkManager:g}=await O(async()=>{const{NetworkManager:w}=await Promise.resolve().then(()=>Z);return{NetworkManager:w}},void 0);if(await g.getProvider().getBalance(u)<l+r.parseEther("0.001"))throw new Error(`Insufficient ETH. Need ~${r.formatEther(l+r.parseEther("0.001"))} ETH`)},onSuccess:s,onError:i})}async function Br({metadataURI:e,button:t=null,onSuccess:a=null,onError:n=null}){return await W.execute({name:"UpdateProfile",button:t,skipSimulation:!0,fixedGasLimit:200000n,getContract:async s=>Ce(s),method:"updateProfile",args:[e||""],onSuccess:a,onError:n})}async function Nr({content:e,tag:t=0,contentType:a=0,operator:n,button:s=null,onSuccess:i=null,onError:r=null}){const o=window.ethers;let l=n;return await W.execute({name:"CreatePost",button:s,skipSimulation:!0,fixedGasLimit:300000n,getContract:async d=>Ce(d),method:"createPost",args:()=>[e,t,a,ee(l)],validate:async(d,u)=>{if(!e||e.length===0)throw new Error("Content is required");if(t<0||t>14)throw new Error("Tag must be 0-14")},onSuccess:async d=>{let u=null;try{const m=new o.Interface(ps);for(const p of d.logs)try{const g=m.parseLog(p);if((g==null?void 0:g.name)==="PostCreated"){u=Number(g.args[0]);break}}catch{}}catch{}i&&i(d,u)},onError:r})}async function $r({parentId:e,content:t,contentType:a=0,operator:n,button:s=null,onSuccess:i=null,onError:r=null}){const o=window.ethers;let l=n;return await W.execute({name:"CreateReply",button:s,skipSimulation:!0,fixedGasLimit:350000n,getContract:async d=>Ce(d),method:"createReply",args:()=>[e,t,a,ee(l)],validate:async(d,u)=>{if(!t)throw new Error("Content is required")},onSuccess:async d=>{let u=null;try{const m=new o.Interface(ps);for(const p of d.logs)try{const g=m.parseLog(p);if((g==null?void 0:g.name)==="ReplyCreated"){u=Number(g.args[0]);break}}catch{}}catch{}i&&i(d,u)},onError:r})}async function Sr({originalPostId:e,quote:t="",operator:a,button:n=null,onSuccess:s=null,onError:i=null}){let r=a;return await W.execute({name:"CreateRepost",button:n,skipSimulation:!0,fixedGasLimit:250000n,getContract:async o=>Ce(o),method:"createRepost",args:()=>[e,t||"",ee(r)],onSuccess:s,onError:i})}async function Lr({postId:e,operator:t,button:a=null,onSuccess:n=null,onError:s=null}){let i=t;return await W.execute({name:"Like",button:a,skipSimulation:!0,fixedGasLimit:200000n,getContract:async r=>Ce(r),method:"like",args:()=>[e,ee(i)],validate:async(r,o)=>{if(await(await he()).hasLiked(e,o))throw new Error("Already liked this post")},onSuccess:n,onError:s})}async function Rr({postId:e,ethAmount:t,operator:a,button:n=null,onSuccess:s=null,onError:i=null}){let r=a;const o=BigInt(t);return await W.execute({name:"SuperLike",button:n,skipSimulation:!0,fixedGasLimit:250000n,getContract:async l=>Ce(l),method:"superLike",args:()=>[e,ee(r)],value:o,validate:async()=>{if(o<100000000n)throw new Error("Minimum super like is 100 gwei")},onSuccess:s,onError:i})}async function _r({postId:e,ethAmount:t,operator:a,button:n=null,onSuccess:s=null,onError:i=null}){let r=a;const o=BigInt(t);return await W.execute({name:"Downvote",button:n,skipSimulation:!0,fixedGasLimit:250000n,getContract:async l=>Ce(l),method:"downvote",args:()=>[e,ee(r)],value:o,validate:async()=>{if(o<100000000n)throw new Error("Minimum downvote is 100 gwei")},onSuccess:s,onError:i})}async function Fr({toFollow:e,operator:t,button:a=null,onSuccess:n=null,onError:s=null}){let i=t;return await W.execute({name:"Follow",button:a,skipSimulation:!0,fixedGasLimit:200000n,getContract:async r=>Ce(r),method:"follow",args:()=>[e,ee(i)],validate:async(r,o)=>{if(!e||e==="0x0000000000000000000000000000000000000000")throw new Error("Invalid address");if(e.toLowerCase()===o.toLowerCase())throw new Error("Cannot follow yourself")},onSuccess:n,onError:s})}async function Mr({toUnfollow:e,button:t=null,onSuccess:a=null,onError:n=null}){return await W.execute({name:"Unfollow",button:t,skipSimulation:!0,fixedGasLimit:150000n,getContract:async s=>Ce(s),method:"unfollow",args:[e],onSuccess:a,onError:n})}async function Dr({postId:e,button:t=null,onSuccess:a=null,onError:n=null}){return await W.execute({name:"DeletePost",button:t,skipSimulation:!0,fixedGasLimit:150000n,getContract:async s=>Ce(s),method:"deletePost",args:[e],onSuccess:a,onError:n})}async function Or({postId:e,button:t=null,onSuccess:a=null,onError:n=null}){return await W.execute({name:"PinPost",button:t,skipSimulation:!0,fixedGasLimit:150000n,getContract:async s=>Ce(s),method:"pinPost",args:[e],onSuccess:a,onError:n})}async function Hr({ethAmount:e,operator:t,button:a=null,onSuccess:n=null,onError:s=null}){let i=t;const r=BigInt(e);return await W.execute({name:"BoostProfile",button:a,skipSimulation:!0,fixedGasLimit:200000n,getContract:async o=>Ce(o),method:"boostProfile",args:()=>[ee(i)],value:r,validate:async()=>{const o=window.ethers;if(r<o.parseEther("0.0005"))throw new Error("Minimum boost is 0.0005 ETH")},onSuccess:n,onError:s})}async function Ur({operator:e,button:t=null,onSuccess:a=null,onError:n=null}){const s=window.ethers;let i=e;const r=s.parseEther("0.001");return await W.execute({name:"ObtainBadge",button:t,skipSimulation:!0,fixedGasLimit:250000n,getContract:async o=>Ce(o),method:"obtainBadge",args:()=>[ee(i)],value:r,onSuccess:a,onError:n})}async function ms(e){const t=window.ethers,n=await(await he()).getUsernamePrice(e);return{fee:n,formatted:t.formatEther(n)}}const jr=ms;async function Gr(e){const a=await(await he()).getPost(e);return{author:a.author,tag:Number(a.tag),contentType:Number(a.contentType),deleted:a.deleted,createdAt:Number(a.createdAt),replyTo:Number(a._replyTo),repostOf:Number(a._repostOf),likes:Number(a.likes),superLikes:Number(a.superLikes),downvotes:Number(a.downvotes),replies:Number(a.replies),reposts:Number(a.reposts)}}async function Wr(){const e=await he();return Number(await e.postCounter())}async function Kr(e){const a=await(await he()).getUserProfile(e);return{usernameHash:a.usernameHash,metadataURI:a.metadataURI,pinnedPost:Number(a.pinned),boosted:a.boosted,hasBadge:a.hasBadge,boostExpiry:Number(a.boostExp),badgeExpiry:Number(a.badgeExp)}}async function Yr(e){return await(await he()).isUsernameAvailable(e)}async function Vr(e,t){return await(await he()).hasLiked(e,t)}async function Kc(e){return await(await he()).isProfileBoosted(e)}async function Yc(e){return await(await he()).hasTrustBadge(e)}async function Vc(e){const a=await(await he()).getUserProfile(e);return Number(a.boostExp)}async function qc(e){const a=await(await he()).getUserProfile(e);return Number(a.badgeExp)}async function qr(){const t=await(await he()).getGlobalStats();return{totalPosts:Number(t._totalPosts||t[0]),totalProfiles:Number(t._totalProfiles||t[1]),tagCounts:(t._tagCounts||t[2]).map(a=>Number(a))}}async function Xc(e){const a=await(await he()).getOperatorStats(e);return{posts:Number(a.posts_||a[0]),engagement:Number(a.engagement||a[1])}}async function Xr(){return await(await he()).version()}const me={createProfile:zr,updateProfile:Br,createPost:Nr,createReply:$r,createRepost:Sr,deletePost:Dr,pinPost:Or,like:Lr,superLike:Rr,downvote:_r,follow:Fr,unfollow:Mr,boostProfile:Hr,obtainBadge:Ur,getUsernamePrice:ms,getUsernameFee:jr,getPost:Gr,getPostCount:Wr,getUserProfile:Kr,isUsernameAvailable:Yr,hasUserLiked:Vr,isProfileBoosted:Kc,hasTrustBadge:Yc,getBoostExpiry:Vc,getBadgeExpiry:qc,getGlobalStats:qr,getOperatorStats:Xc,getVersion:Xr},Fp=Object.freeze(Object.defineProperty({__proto__:null,BackchatTx:me,boostProfile:Hr,createPost:Nr,createProfile:zr,createReply:$r,createRepost:Sr,deletePost:Dr,downvote:_r,follow:Fr,getBadgeExpiry:qc,getBoostExpiry:Vc,getGlobalStats:qr,getOperatorStats:Xc,getPost:Gr,getPostCount:Wr,getUserProfile:Kr,getUsernameFee:jr,getUsernamePrice:ms,getVersion:Xr,hasTrustBadge:Yc,hasUserLiked:Vr,isProfileBoosted:Kc,isUsernameAvailable:Yr,like:Lr,obtainBadge:Ur,pinPost:Or,superLike:Rr,unfollow:Mr,updateProfile:Br},Symbol.toStringTag,{value:"Module"}));(async()=>(await O(async()=>{const{CharityTx:e}=await Promise.resolve().then(()=>yp);return{CharityTx:e}},void 0)).CharityTx)(),(async()=>(await O(async()=>{const{StakingTx:e}=await Promise.resolve().then(()=>kp);return{StakingTx:e}},void 0)).StakingTx)(),(async()=>(await O(async()=>{const{NftTx:e}=await Promise.resolve().then(()=>Cp);return{NftTx:e}},void 0)).NftTx)(),(async()=>(await O(async()=>{const{FortuneTx:e}=await Promise.resolve().then(()=>zp);return{FortuneTx:e}},void 0)).FortuneTx)(),(async()=>(await O(async()=>{const{RentalTx:e}=await Promise.resolve().then(()=>$p);return{RentalTx:e}},void 0)).RentalTx)(),(async()=>(await O(async()=>{const{NotaryTx:e}=await Promise.resolve().then(()=>_p);return{NotaryTx:e}},void 0)).NotaryTx)(),(async()=>(await O(async()=>{const{FaucetTx:e}=await Promise.resolve().then(()=>pp);return{FaucetTx:e}},void 0)).FaucetTx)(),(async()=>(await O(async()=>{const{BackchatTx:e}=await Promise.resolve().then(()=>Fp);return{BackchatTx:e}},void 0)).BackchatTx)();const Jc=Object.freeze(Object.defineProperty({__proto__:null,BackchatTx:me,CharityTx:Le,FaucetTx:xc,FortuneTx:is,NftTx:vn,NotaryTx:Ve,RentalTx:lt,StakingTx:jt,approveAllNfts:Oi,backchatGetVersion:Xr,boostCampaign:hi,boostProfile:Hr,buyNft:Jn,buySpecificNft:Di,calculateFileHash:ja,calculatePotentialWin:sr,canWithdraw:yi,cancelCampaign:gi,certify:ds,charityGetStats:Ei,claimStakingRewards:Pi,closeCampaign:qn,commitPlay:ns,createCampaign:fi,createPost:Nr,createProfile:zr,createReply:$r,createRepost:Sr,delegate:Ci,deletePost:Dr,donate:bi,downvote:_r,executeFaucetClaim:Kn,follow:Fr,forceUnstake:Ai,fortuneGetPoolStats:nr,getActiveTiers:tr,getAllListedTokenIds:mr,getAvailableNfts:Ki,getBuyPrice:Hi,getCampaign:vi,getCampaignCount:wi,getCertificate:us,getCommitmentStatus:rr,getDocument:Tr,getEarlyUnstakePenalty:Si,getEthFees:Qn,getGameResult:ir,getGlobalStats:qr,getListing:ur,getListingCount:fr,getMarketplaceStats:wr,getPendingEarnings:vr,getPendingRewards:Bi,getPoolInfo:Wi,getPost:Gr,getPostCount:Wr,getRemainingRentalTime:xr,getRental:pr,getRentalCost:br,getSellPrice:Ui,getServiceFee:ar,getSpread:Vi,getStakingConfig:Li,getTierName:Yi,getTotalBuyCost:ji,getTotalDocuments:Ir,getTotalPStake:$i,getTotalSellInfo:Gi,getUserDelegations:zi,getUserPStake:Ni,getUserProfile:Kr,getUserSummary:_i,getUsernameFee:jr,getUsernamePrice:ms,hasActiveRental:hr,hasUserLiked:Vr,isApprovedForAll:qi,isRented:gr,isUsernameAvailable:Yr,like:Lr,listNft:os,nftGetStats:es,notarize:kr,notaryGetFee:Cr,notaryGetStats:Ar,obtainBadge:Ur,pinPost:Or,playGame:er,previewClaim:Ri,previewDonation:ki,rentNft:ls,revealPlay:ss,sellNft:Zn,superLike:Rr,unfollow:Mr,unstake:Ii,updateListing:dr,updateProfile:Br,verify:Ua,verifyByHash:Er,withdraw:xi,withdrawEarnings:cr,withdrawNft:cs},Symbol.toStringTag,{value:"Module"})),tt=window.ethers,S={hasRenderedOnce:!1,lastUpdate:0,activities:[],networkActivities:[],filteredActivities:[],userProfile:null,pagination:{currentPage:1,itemsPerPage:8},filters:{type:"ALL",sort:"NEWEST"},metricsCache:{},economicData:null,isLoadingNetworkActivity:!1,networkActivitiesTimestamp:0,faucet:{canClaim:!0,cooldownEnd:null,isLoading:!1,lastCheck:0}},Wo="https://sepolia.arbiscan.io/tx/",Mp="/api/faucet",Dp="https://getrecentactivity-4wvdcuoouq-uc.a.run.app",Op="https://getsystemdata-4wvdcuoouq-uc.a.run.app",Hs="1,000",Us="0.01",G={STAKING:{icon:"fa-lock",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🔒 Staked",emoji:"🔒"},UNSTAKING:{icon:"fa-unlock",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"🔓 Unstaked",emoji:"🔓"},FORCE_UNSTAKE:{icon:"fa-bolt",color:"#ef4444",bg:"rgba(239,68,68,0.15)",label:"⚡ Force Unstaked",emoji:"⚡"},CLAIM:{icon:"fa-coins",color:"#fbbf24",bg:"rgba(245,158,11,0.15)",label:"🪙 Rewards Claimed",emoji:"🪙"},NFT_BUY:{icon:"fa-bag-shopping",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🛍️ Bought NFT",emoji:"🛍️"},NFT_SELL:{icon:"fa-hand-holding-dollar",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"💰 Sold NFT",emoji:"💰"},NFT_MINT:{icon:"fa-gem",color:"#fde047",bg:"rgba(234,179,8,0.15)",label:"💎 Minted Booster",emoji:"💎"},NFT_TRANSFER:{icon:"fa-arrow-right-arrow-left",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"↔️ Transfer",emoji:"↔️"},RENTAL_LIST:{icon:"fa-tag",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🏷️ Listed NFT",emoji:"🏷️"},RENTAL_RENT:{icon:"fa-clock",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"⏰ Rented NFT",emoji:"⏰"},RENTAL_WITHDRAW:{icon:"fa-rotate-left",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"↩️ Withdrawn",emoji:"↩️"},RENTAL_PROMOTE:{icon:"fa-bullhorn",color:"#fbbf24",bg:"rgba(251,191,36,0.2)",label:"📢 Promoted NFT",emoji:"📢"},FORTUNE_COMMIT:{icon:"fa-lock",color:"#a855f7",bg:"rgba(168,85,247,0.2)",label:"🔐 Game Committed",emoji:"🔐"},FORTUNE_REVEAL:{icon:"fa-dice",color:"#f97316",bg:"rgba(249,115,22,0.2)",label:"🎲 Game Revealed",emoji:"🎲"},FORTUNE_BET:{icon:"fa-paw",color:"#f97316",bg:"rgba(249,115,22,0.2)",label:"🐯 Fortune Bet",emoji:"🐯"},FORTUNE_COMBO:{icon:"fa-rocket",color:"#a855f7",bg:"rgba(168,85,247,0.2)",label:"🚀 Combo Mode",emoji:"🚀"},FORTUNE_WIN:{icon:"fa-trophy",color:"#facc15",bg:"rgba(234,179,8,0.25)",label:"🏆 Winner!",emoji:"🏆"},NOTARY:{icon:"fa-stamp",color:"#818cf8",bg:"rgba(99,102,241,0.15)",label:"📜 Notarized",emoji:"📜"},BACKCHAT_POST:{icon:"fa-comment",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"💬 Posted",emoji:"💬"},BACKCHAT_LIKE:{icon:"fa-heart",color:"#ec4899",bg:"rgba(236,72,153,0.15)",label:"❤️ Liked",emoji:"❤️"},BACKCHAT_REPLY:{icon:"fa-reply",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"↩️ Replied",emoji:"↩️"},BACKCHAT_SUPERLIKE:{icon:"fa-star",color:"#fbbf24",bg:"rgba(251,191,36,0.2)",label:"⭐ Super Liked",emoji:"⭐"},BACKCHAT_REPOST:{icon:"fa-retweet",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🔄 Reposted",emoji:"🔄"},BACKCHAT_FOLLOW:{icon:"fa-user-plus",color:"#a78bfa",bg:"rgba(167,139,250,0.15)",label:"👥 Followed",emoji:"👥"},BACKCHAT_PROFILE:{icon:"fa-user",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"👤 Profile Created",emoji:"👤"},BACKCHAT_BOOST:{icon:"fa-rocket",color:"#f97316",bg:"rgba(249,115,22,0.15)",label:"🚀 Profile Boosted",emoji:"🚀"},BACKCHAT_BADGE:{icon:"fa-circle-check",color:"#10b981",bg:"rgba(16,185,129,0.15)",label:"✅ Badge Activated",emoji:"✅"},BACKCHAT_TIP:{icon:"fa-coins",color:"#fbbf24",bg:"rgba(251,191,36,0.15)",label:"💰 Tipped BKC",emoji:"💰"},BACKCHAT_WITHDRAW:{icon:"fa-wallet",color:"#8b5cf6",bg:"rgba(139,92,246,0.15)",label:"💸 ETH Withdrawn",emoji:"💸"},CHARITY_DONATE:{icon:"fa-heart",color:"#ec4899",bg:"rgba(236,72,153,0.15)",label:"💝 Donated",emoji:"💝"},CHARITY_CREATE:{icon:"fa-hand-holding-heart",color:"#10b981",bg:"rgba(16,185,129,0.15)",label:"🌱 Campaign Created",emoji:"🌱"},CHARITY_CANCEL:{icon:"fa-heart-crack",color:"#ef4444",bg:"rgba(239,68,68,0.15)",label:"💔 Campaign Cancelled",emoji:"💔"},CHARITY_WITHDRAW:{icon:"fa-hand-holding-dollar",color:"#8b5cf6",bg:"rgba(139,92,246,0.15)",label:"💰 Funds Withdrawn",emoji:"💰"},CHARITY_GOAL_REACHED:{icon:"fa-trophy",color:"#fbbf24",bg:"rgba(251,191,36,0.15)",label:"🏆 Goal Reached!",emoji:"🏆"},FAUCET:{icon:"fa-droplet",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"💧 Faucet Claim",emoji:"💧"},DEFAULT:{icon:"fa-circle",color:"#71717a",bg:"rgba(39,39,42,0.5)",label:"Activity",emoji:"📋"}};function Hp(e){if(!e)return"Just now";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3,a=new Date(t*1e3),s=new Date-a,i=Math.floor(s/6e4),r=Math.floor(s/36e5),o=Math.floor(s/864e5);return i<1?"Just now":i<60?`${i}m ago`:r<24?`${r}h ago`:o<7?`${o}d ago`:a.toLocaleDateString()}catch{return"Recent"}}function Up(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function tn(e){return e>=1e6?(e/1e6).toFixed(2)+"M":e>=1e3?(e/1e3).toFixed(1)+"K":e.toFixed(0)}function jp(e){return e?`${e.slice(0,6)}...${e.slice(-4)}`:""}function Gp(e){if(!e)return"";const t=Date.now(),n=new Date(e).getTime()-t;if(n<=0)return"";const s=Math.floor(n/36e5),i=Math.floor(n%36e5/6e4);return s>0?`${s}h ${i}m`:`${i}m`}function Wp(e,t={}){const a=(e||"").toUpperCase().trim();return a==="STAKING"||a==="STAKED"||a==="STAKE"||a==="DELEGATED"||a==="DELEGATION"||a.includes("DELEGAT")?G.STAKING:a==="UNSTAKING"||a==="UNSTAKED"||a==="UNSTAKE"||a==="UNDELEGATED"?G.UNSTAKING:a==="FORCE_UNSTAKE"||a==="FORCEUNSTAKE"||a==="FORCE_UNSTAKED"?G.FORCE_UNSTAKE:a==="CLAIM"||a==="CLAIMED"||a==="REWARD"||a==="REWARDS"||a==="REWARD_CLAIMED"||a==="REWARDCLAIMED"?G.CLAIM:a==="NFT_BUY"||a==="NFTBUY"||a==="BOOSTER_BUY"||a==="BOOSTERBUY"||a==="BOOSTERBOUGHT"||a.includes("BUY")&&(a.includes("NFT")||a.includes("BOOSTER"))?G.NFT_BUY:a==="NFT_SELL"||a==="NFTSELL"||a==="BOOSTER_SELL"||a==="BOOSTERSELL"||a==="BOOSTERSOLD"||a.includes("SELL")&&(a.includes("NFT")||a.includes("BOOSTER"))?G.NFT_SELL:a==="NFT_MINT"||a==="NFTMINT"||a==="BOOSTER_MINT"||a==="BOOSTERMINT"||a==="MINTED"||a==="BOOSTERMINTED"?G.NFT_MINT:a==="NFT_TRANSFER"||a==="NFTTRANSFER"||a==="BOOSTER_TRANSFER"||a==="BOOSTERTRANSFER"||a==="TRANSFER"?G.NFT_TRANSFER:a==="RENTAL_LIST"||a==="RENTALLISTED"||a==="RENTAL_LISTED"||a==="LISTED"||a.includes("LIST")&&a.includes("RENTAL")?G.RENTAL_LIST:a==="RENTAL_RENT"||a==="RENTALRENTED"||a==="RENTAL_RENTED"||a==="RENTED"||a.includes("RENT")&&!a.includes("LIST")?G.RENTAL_RENT:a==="RENTAL_WITHDRAW"||a==="RENTALWITHDRAWN"||a==="RENTAL_WITHDRAWN"?G.RENTAL_WITHDRAW:a==="RENTAL_PROMOTE"||a==="RENTALPROMOTED"||a==="RENTAL_PROMOTED"||a.includes("PROMOT")||a.includes("ADS")||a.includes("ADVERTIS")?G.RENTAL_PROMOTE:a==="FORTUNE_COMMIT"||a==="GAMECOMMITTED"||a==="GAME_COMMITTED"||a==="COMMITTED"?G.FORTUNE_COMMIT:a==="FORTUNE_REVEAL"||a==="GAMEREVEALED"||a==="GAME_REVEALED"||a==="REVEALED"?G.FORTUNE_REVEAL:a.includes("GAME")||a.includes("FORTUNE")||a.includes("REQUEST")||a.includes("FULFILLED")||a.includes("RESULT")?(t==null?void 0:t.isWin)||(t==null?void 0:t.prizeWon)&&BigInt(t.prizeWon||0)>0n?G.FORTUNE_WIN:(t==null?void 0:t.isCumulative)?G.FORTUNE_COMBO:G.FORTUNE_BET:a==="POSTCREATED"||a==="POST_CREATED"||a==="POSTED"||a==="BACKCHAT_POST"||a.includes("POST")&&!a.includes("REPOST")?G.BACKCHAT_POST:a==="SUPERLIKED"||a==="SUPER_LIKED"||a.includes("SUPERLIKE")?G.BACKCHAT_SUPERLIKE:a==="LIKED"||a==="POSTLIKED"||a==="POST_LIKED"||a.includes("LIKE")&&!a.includes("SUPER")?G.BACKCHAT_LIKE:a==="REPLYCREATED"||a==="REPLY_CREATED"||a.includes("REPLY")?G.BACKCHAT_REPLY:a==="REPOSTCREATED"||a==="REPOST_CREATED"||a.includes("REPOST")?G.BACKCHAT_REPOST:a==="FOLLOWED"||a==="USER_FOLLOWED"||a.includes("FOLLOW")?G.BACKCHAT_FOLLOW:a==="PROFILECREATED"||a==="PROFILE_CREATED"||a.includes("PROFILE")&&a.includes("CREAT")?G.BACKCHAT_PROFILE:a==="PROFILEBOOSTED"||a==="PROFILE_BOOSTED"||a==="BOOSTED"||a.includes("BOOST")&&!a.includes("NFT")?G.BACKCHAT_BOOST:a==="BADGEACTIVATED"||a==="BADGE_ACTIVATED"||a.includes("BADGE")?G.BACKCHAT_BADGE:a==="TIPPROCESSED"||a==="TIP_PROCESSED"||a==="TIPPED"||a.includes("TIP")?G.BACKCHAT_TIP:a==="ETHWITHDRAWN"||a==="ETH_WITHDRAWN"||a==="BACKCHAT_WITHDRAW"?G.BACKCHAT_WITHDRAW:a==="CHARITYDONATION"||a==="DONATIONMADE"||a==="CHARITY_DONATE"||a==="DONATED"||a==="DONATION"||a.includes("DONATION")?G.CHARITY_DONATE:a==="CHARITYCAMPAIGNCREATED"||a==="CAMPAIGNCREATED"||a==="CHARITY_CREATE"||a==="CAMPAIGN_CREATED"||a.includes("CAMPAIGNCREATED")?G.CHARITY_CREATE:a==="CHARITYCAMPAIGNCANCELLED"||a==="CAMPAIGNCANCELLED"||a==="CHARITY_CANCEL"||a==="CAMPAIGN_CANCELLED"||a.includes("CANCELLED")?G.CHARITY_CANCEL:a==="CHARITYFUNDSWITHDRAWN"||a==="FUNDSWITHDRAWN"||a==="CHARITY_WITHDRAW"||a==="CAMPAIGN_WITHDRAW"||a.includes("WITHDRAWN")?G.CHARITY_WITHDRAW:a==="CHARITYGOALREACHED"||a==="GOALREACHED"||a==="CHARITY_GOAL"||a==="CAMPAIGN_COMPLETED"?G.CHARITY_GOAL_REACHED:a==="NOTARYREGISTER"||a==="NOTARIZED"||a.includes("NOTARY")||a.includes("DOCUMENT")?G.NOTARY:a==="FAUCETCLAIM"||a.includes("FAUCET")||a.includes("DISTRIBUTED")?G.FAUCET:G.DEFAULT}let As=null,zt=0n;function Zc(e){const t=document.getElementById("dash-user-rewards");if(!t||!c.isConnected){As&&cancelAnimationFrame(As);return}const a=e-zt;a>-1000000000n&&a<1000000000n?zt=e:zt+=a/8n,zt<0n&&(zt=0n),t.innerHTML=`${M(zt).toFixed(4)} <span class="dash-reward-suffix">BKC</span>`,zt!==e&&(As=requestAnimationFrame(()=>Zc(e)))}async function Ko(e){if(!c.isConnected||!c.userAddress)return x("Conecte a wallet primeiro","error");const t=e.innerHTML;e.disabled=!0,e.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-2"></i> Enviando...',S.faucet.isLoading=!0;let a=!1;try{console.log("[Faucet] Tentando API relayer...");const n=await fetch(`${Mp}?address=${c.userAddress}`,{method:"GET",headers:{Accept:"application/json"}}),s=await n.json();if(console.log("[Faucet] API response:",n.status,s),n.ok&&s.success)a=!0,x(`Faucet: ${Hs} BKC + ${Us} ETH enviados!`,"success"),S.faucet.canClaim=!1,S.faucet.cooldownEnd=new Date(Date.now()+24*60*60*1e3).toISOString(),cn(),setTimeout(()=>{Ks.update(!0)},4e3);else{const i=s.error||s.message||"API indisponível";if(console.warn("[Faucet] API falhou:",i),i.toLowerCase().includes("cooldown")||i.toLowerCase().includes("wait")||i.toLowerCase().includes("hour")){x(i,"warning");const r=i.match(/(\d+)\s*hour/i);r&&(S.faucet.canClaim=!1,S.faucet.cooldownEnd=new Date(Date.now()+parseInt(r[1])*36e5).toISOString(),cn()),a=!0}}}catch(n){console.warn("[Faucet] API offline:",n.message)}if(!a)try{console.log("[Faucet] Fallback: claim on-chain direto..."),e.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-2"></i> Claim on-chain...';const{FaucetTx:n}=await O(async()=>{const{FaucetTx:i}=await Promise.resolve().then(()=>Jc);return{FaucetTx:i}},void 0),s=await n.claimOnChain({button:null,onSuccess:()=>{x(`Faucet: ${Hs} BKC + ${Us} ETH recebidos!`,"success"),S.faucet.canClaim=!1,S.faucet.cooldownEnd=new Date(Date.now()+24*60*60*1e3).toISOString(),cn(),setTimeout(()=>{Ks.update(!0)},4e3)},onError:i=>{console.error("[Faucet] On-chain falhou:",i);const r=i.message||"Erro no claim";r.includes("Aguarde")||r.includes("cooldown")?x(r,"warning"):r.includes("InsufficientTokens")||r.includes("InsufficientETH")?x("Faucet sem saldo. Contate o admin.","error"):r.includes("user rejected")||r.includes("denied")?x("Transação cancelada","warning"):x(`Faucet: ${r}`,"error")}})}catch(n){console.error("[Faucet] On-chain erro:",n);const s=n.message||"";s.includes("Aguarde")||s.includes("cooldown")?x(s,"warning"):x("Faucet indisponível. Tente novamente.","error")}S.faucet.isLoading=!1,e.disabled=!1,e.innerHTML=t}function cn(){const e=document.getElementById("dashboard-faucet-widget");if(!e)return;const t=document.getElementById("faucet-title"),a=document.getElementById("faucet-desc"),n=document.getElementById("faucet-status"),s=document.getElementById("faucet-action-btn");if(!c.isConnected){e.style.opacity="0.5",t&&(t.innerText="Get Free Testnet Tokens"),a&&(a.innerText="Connect your wallet to claim BKC + ETH for gas"),n&&n.classList.add("hidden"),s&&(s.className="dash-btn-secondary",s.innerHTML='<i class="fa-solid fa-wallet"></i> Connect Wallet',s.disabled=!0);return}e.style.opacity="1";const i=Gp(S.faucet.cooldownEnd);!(S.faucet.canClaim&&!i)&&i?(t&&(t.innerText="Faucet Cooldown"),a&&(a.innerText="Come back when the timer ends"),n&&(n.classList.remove("hidden"),n.innerHTML=`<i class="fa-solid fa-clock" style="margin-right:4px"></i>${i} remaining`),s&&(s.className="dash-btn-secondary",s.innerHTML='<i class="fa-solid fa-hourglass-half"></i> On Cooldown',s.disabled=!0)):(t&&(t.innerText="Get Free Testnet Tokens"),a&&(a.innerText="Claim BKC tokens and ETH for gas — free every 24h"),n&&n.classList.add("hidden"),s&&(s.className="dash-btn-primary dash-btn-cyan",s.innerHTML='<i class="fa-solid fa-faucet"></i> Claim Free Tokens',s.disabled=!1))}function Kp(){try{const e=window.location.hash||"",t=e.indexOf("?");if(t===-1)return;const n=new URLSearchParams(e.substring(t)).get("ref");if(n&&tt.isAddress(n)){const s=localStorage.getItem("backchain_referrer");(!s||s.toLowerCase()!==n.toLowerCase())&&(localStorage.setItem("backchain_referrer",n),console.log("[Referral] Saved referrer from URL:",n))}}catch{}}async function Yo(){if(!c.isConnected||!c.userAddress)return;const e=localStorage.getItem("backchain_referrer");if(!(!e||!tt.isAddress(e))){if(e.toLowerCase()===c.userAddress.toLowerCase()){localStorage.removeItem("backchain_referrer");return}try{const t=v==null?void 0:v.backchainEcosystem;if(!t)return;const{ecosystemManagerABI:a}=await O(async()=>{const{ecosystemManagerABI:u}=await Promise.resolve().then(()=>Gl);return{ecosystemManagerABI:u}},void 0),{NetworkManager:n}=await O(async()=>{const{NetworkManager:u}=await Promise.resolve().then(()=>Z);return{NetworkManager:u}},void 0),s=n.getProvider(),r=await new tt.Contract(t,a,s).referredBy(c.userAddress);if(r&&r!=="0x0000000000000000000000000000000000000000"){localStorage.removeItem("backchain_referrer");return}const o=await c.provider.getSigner(),l=new tt.Contract(t,a,o);console.log("[Referral] Auto-setting referrer:",e),await(await l.setReferrer(e)).wait(),localStorage.removeItem("backchain_referrer"),x("Referrer set! They will earn 5% of your staking rewards.","success"),ya()}catch(t){console.warn("[Referral] Auto-set failed:",t.message)}}}async function Yp(){if(!c.isConnected||!c.userAddress)return{count:0,referrer:null};try{const e=v==null?void 0:v.backchainEcosystem;if(!e)return{count:0,referrer:null};const{ecosystemManagerABI:t}=await O(async()=>{const{ecosystemManagerABI:o}=await Promise.resolve().then(()=>Gl);return{ecosystemManagerABI:o}},void 0),{NetworkManager:a}=await O(async()=>{const{NetworkManager:o}=await Promise.resolve().then(()=>Z);return{NetworkManager:o}},void 0),n=a.getProvider(),s=new tt.Contract(e,t,n),[i,r]=await Promise.all([s.referralCount(c.userAddress),s.referredBy(c.userAddress)]);return{count:Number(i),referrer:r!=="0x0000000000000000000000000000000000000000"?r:null}}catch(e){return console.warn("[Referral] Load failed:",e.message),{count:0,referrer:null}}}async function ya(){const e=document.getElementById("dashboard-referral-widget");if(!e)return;const t=document.getElementById("referral-title"),a=document.getElementById("referral-desc"),n=document.getElementById("referral-stats"),s=document.getElementById("referral-link-container"),i=document.getElementById("referral-link-text"),r=document.getElementById("referral-share-btn"),o=document.getElementById("referral-count");if(!c.isConnected||!c.userAddress){e.style.opacity="0.5",t&&(t.innerText="Invite & Earn Forever"),a&&(a.innerText="Connect your wallet to get your referral link"),n&&(n.style.display="none"),s&&(s.style.display="none"),r&&(r.style.display="none");return}e.style.opacity="1";const l=`${window.location.origin}/#dashboard?ref=${c.userAddress}`;i&&(i.textContent=l),s&&(s.style.display="flex"),r&&(r.style.display="");const d=await Yp();o&&(o.textContent=d.count),n&&(n.style.display="flex"),d.count>0?(t&&(t.innerText=`${d.count} Referral${d.count>1?"s":""} Earning for You`),a&&(a.innerText="You earn 5% of every staking reward they claim. Keep sharing!")):(t&&(t.innerText="Invite & Earn Forever"),a&&(a.innerText="Share your link. Earn 5% of every staking reward your referrals claim — forever."))}function Vp(){if(!c.userAddress)return;const e=`${window.location.origin}/#dashboard?ref=${c.userAddress}`;navigator.clipboard.writeText(e).then(()=>{x("Referral link copied!","success");const t=document.getElementById("referral-copy-btn");t&&(t.innerHTML='<i class="fa-solid fa-check"></i>',setTimeout(()=>{t.innerHTML='<i class="fa-solid fa-copy"></i>'},2e3))}).catch(()=>x("Failed to copy","error"))}function qp(){if(!c.userAddress)return;const e=`${window.location.origin}/#dashboard?ref=${c.userAddress}`,t=`Join Backchain and earn crypto!
...
#Backchain #DeFi #Arbitrum #Web3`;navigator.share?navigator.share({title:"Backchain — Invite & Earn",text:t,url:e}).catch(()=>{}):navigator.clipboard.writeText(t).then(()=>x("Share text copied!","success")).catch(()=>{})}async function Xp(){try{if(await c.provider.getBalance(c.userAddress)<tt.parseEther("0.002")){const t=document.getElementById("no-gas-modal-dash");return t&&(t.classList.remove("hidden"),t.classList.add("flex")),!1}return!0}catch{return!0}}function Jp(){if(document.getElementById("dash-styles-v69"))return;const e=document.createElement("style");e.id="dash-styles-v69",e.textContent=`
        /* ── CSS Variables ── */
        .dash-shell {
            --dash-bg: #0c0c0e;
            --dash-surface: #141417;
    ...
    `,document.head.appendChild(e)}function Zp(){Se.dashboard&&(Jp(),Se.dashboard.innerHTML=`
                ...
                <div class="dash-faucet-info">
                    ...
                    <div class="dash-faucet-amounts">
                        <span class="dash-faucet-badge" style="color:#22d3ee">
                            <i class="fa-solid fa-coins" style="font-size:10px"></i>${Hs} BKC
                        </span>
                        <span class="dash-faucet-badge" style="color:#4ade80">
                            <i class="fa-brands fa-ethereum" style="font-size:10px"></i>${Us} ETH
                        </span>
                    </div>
    ...
    `}async function tm(){try{const e=await fetch(Op);if(e.ok){const t=await e.json();return S.economicData=t,t}}catch{}return null}async function js(){var e,t,a,n,s,i,r;try{const o=await tm();let l=0n,d=0n,u=0n,m=0n,p=0n,g=0,b=0n;if(o&&((e=o.token)!=null&&e.totalSupply&&(l=BigInt(o.token.totalSupply)),(t=o.token)!=null&&t.totalBurned&&(m=BigInt(o.token.totalBurned)),(a=o.staking)!=null&&a.totalPStake&&(d=BigInt(o.staking.totalPStake)),(n=o.ecosystem)!=null&&n.totalEthCollected&&(p=BigInt(o.ecosystem.totalEthCollected)),(s=o.fortunePool)!=null&&s.prizePool&&(b=BigInt(o.fortunePool.prizePool)),(i=o.notary)!=null&&i.certCount&&(g=o.notary.certCount),(r=o.stats)!=null&&r.notarizedDocuments&&(g=Math.max(g,o.stats.notarizedDocuments))),c.bkcTokenContractPublic){l===0n&&(l=await ne(c.bkcTokenContractPublic,"totalSupply",[],0n)),m===0n&&(m=await ne(c.bkcTokenContractPublic,"totalBurned",[],0n)),d===0n&&(c.stakingPoolContractPublic||c.stakingPoolContract)&&(d=await ne(c.stakingPoolContractPublic||c.stakingPoolContract,"totalPStake",[],0n));const D=[v.stakingPool,v.fortunePool,v.rentalManager,v.buybackMiner,v.liquidityPool,v.pool_diamond,v.pool_gold,v.pool_silver,v.pool_bronze].filter(H=>H&&H!==tt.ZeroAddress),j=await Promise.all(D.map(H=>ne(c.bkcTokenContractPublic,"balanceOf",[H],0n)));if(j.forEach(H=>{u+=H}),v.fortunePool&&b===0n){const H=D.indexOf(v.fortunePool);H>=0&&(b=j[H])}}const w=M(l),y=M(m),C=M(p),I=M(b),z=D=>D.toLocaleString("en-US",{minimumFractionDigits:1,maximumFractionDigits:1}),L=M(u),B=(D,j)=>{const H=document.getElementById(D);H&&(H.innerHTML=j)};B("dash-metric-supply",`${z(w)} <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>`),B("dash-metric-pstake",na(d)),B("dash-metric-burned",y>0?`<span style="color:#ef4444">${tn(y)}</span> <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>`:'<span style="color:var(--dash-text-3)">0 BKC</span>'),B("dash-metric-fees",C>0?`${tn(C)} <span style="font-size:10px;color:var(--dash-text-3)">ETH</span>`:'<span style="color:var(--dash-text-3)">0 ETH</span>'),B("dash-metric-locked",L>0?`<span style="color:#60a5fa">${tn(L)}</span> <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>`:'<span style="color:var(--dash-text-3)">0 BKC</span>'),Qc();const A=document.getElementById("dash-fortune-prize-text");A&&(A.innerText=I>0?`Prize: ${tn(I)} BKC`:"Play to win");const _=document.getElementById("dash-notary-count-text");_&&(_.innerText=g>0?`${g} docs certified`:"Certify documents"),S.metricsCache={supply:w,burned:y,fees:C,timestamp:Date.now()}}catch(o){console.error("Metrics Error",o)}}function Qc(){const e=document.getElementById("dash-metric-balance");if(!e)return;const t=c.currentUserBalance||c.bkcBalance||0n;if(!c.isConnected){e.innerHTML='<span style="font-size:11px;color:var(--dash-text-3)">Connect Wallet</span>';return}if(t===0n)e.innerHTML='0.00 <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>';else{const a=M(t);e.innerHTML=`${a.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})} <span style="font-size:10px;color:var(--dash-text-3)">BKC</span>`}}async function am(){if(c.userAddress)try{const e=await fetch(`https://getuserprofile-4wvdcuoouq-uc.a.run.app/${c.userAddress}`);e.ok&&(S.userProfile=await e.json())}catch{}}async function Zt(e=!1){var t,a;if(!c.isConnected){const n=document.getElementById("dash-booster-area");n&&(n.innerHTML=`
                <div style="text-align:center">
                ...
                </div>`);return}try{const n=document.getElementById("dash-user-rewards");e&&n&&(n.style.opacity="0.6");const[,s,i]=await Promise.all([jn(),Au(),Jl()]),r=(s==null?void 0:s.netClaimAmount)||0n;Zc(r),n&&(n.style.opacity="1");const o=document.getElementById("dashboardClaimBtn");o&&(o.disabled=r<=0n);const l=document.getElementById("dash-user-pstake");if(l){let d=((t=c.userData)==null?void 0:t.pStake)||((a=c.userData)==null?void 0:a.userTotalPStake)||c.userTotalPStake||0n;if(d===0n&&(c.stakingPoolContractPublic||c.stakingPoolContract)&&c.userAddress)try{d=await ne(c.stakingPoolContractPublic||c.stakingPoolContract,"userTotalPStake",[c.userAddress],0n)}catch{}l.innerText=na(d)}Qc(),nm(i,s),am(),cn()}catch(n){console.error("User Hub Error:",n)}}function nm(e,t){var _;const a=document.getElementById("dash-booster-area");if(!a)return;const n=(e==null?void 0:e.highestBoost)||0,s=st(n),i=(t==null?void 0:t.totalRewards)||0n,r=i*BigInt(s)/100n,l=i-r,d=Fl(n),u=(e==null?void 0:e.imageUrl)||(d==null?void 0:d.image)||"./assets/bkc_logo_3d.png",m=xe.find(D=>D.name==="Diamond");if(m!=null&&m.image,n===0){if(l>0n){const D=document.getElementById("dash-user-gain-area");D&&(D.classList.add("visible"),document.getElementById("dash-user-potential-gain").innerText=M(l).toFixed(2))}a.innerHTML=`
        ...
        `;return}const p=e.source==="rented",g=(d==null?void 0:d.name)||((_=e.boostName)==null?void 0:_.replace(" Booster","").replace("Booster","").trim())||"Booster",b=(d==null?void 0:d.color)||"color:var(--dash-accent)",w=i*50n/100n,y=r-w,C=p?"fa-clock":"fa-check-circle",I=p?"#22d3ee":"#4ade80",z=p?"rgba(6,182,212,0.12)":"rgba(74,222,128,0.12)",L=p?"rgba(6,182,212,0.3)":"rgba(74,222,128,0.3)",B=p?"RENTED":"OWNED",A=p?"Active rental":"In your wallet";a.innerHTML=`
        <div class="nft-clickable-image" data-address="${v.rewardBooster}" data-tokenid="${e.tokenId}" style="width:100%;cursor:pointer;transition:all 0.2s">
            <div style="display:flex;align-items:center;gap:10px;background:var(--dash-surface-2);border:1px solid ${L};border-radius:12px;padding:10px 12px;margin-bottom:8px">
                ...
                <div style="flex:1;min-width:0">
                    <div style="display:flex;align-items:center;gap:6px">
                        ...
                        <span style="font-size:8px;font-weight:800;color:${I};background:${z};padding:2px 6px;border-radius:4px;letter-spacing:0.05em">${B}</span>
                        <span style="font-size:9px;color:var(--dash-text-3)">#${e.tokenId}</span>
                    </div>
                    <p style="font-size:10px;color:var(--dash-text-3);margin:2px 0 0"><i class="fa-solid ${C}" style="color:${I};margin-right:3px;font-size:9px"></i>${A}</p>
                </div>
            ...
            <div style="display:flex;gap:6px">
                ...
                <div style="flex:1;background:var(--dash-surface-2);border-radius:8px;padding:6px 8px;text-align:center">
                    ...
                    <div style="font-size:12px;font-weight:700;color:#34d399">+${M(y).toFixed(2)} <span style="font-size:9px;color:var(--dash-text-3)">BKC</span></div>
                </div>`:""}
            </div>`:""}
            ${s<100?`
    ...
    `}async function wn(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("activity-title");try{if(c.isConnected){if(S.activities.length===0){e&&(e.innerHTML='<div class="dash-loading"><img src="./assets/bkc_logo_3d.png" class="dash-loading-logo" alt=""><span class="dash-loading-text">Loading your activity...</span></div>');const a=await fetch(`${qe.getHistory}/${c.userAddress}`);a.ok&&(S.activities=await a.json())}if(S.activities.length>0){t&&(t.textContent="Your Activity"),Gs();return}}t&&(t.textContent="Network Activity"),await Vo()}catch(a){console.error("Activity fetch error:",a),t&&(t.textContent="Network Activity"),await Vo()}}async function Vo(){const e=document.getElementById("dash-activity-list");if(!e||S.isLoadingNetworkActivity)return;const t=Date.now()-S.networkActivitiesTimestamp;if(S.networkActivities.length>0&&t<3e5){qo();return}S.isLoadingNetworkActivity=!0,e.innerHTML='<div class="dash-loading"><img src="./assets/bkc_logo_3d.png" class="dash-loading-logo" alt=""><span class="dash-loading-text">Loading network activity...</span></div>';try{const a=await fetch(`${Dp}?limit=30`);if(a.ok){const n=await a.json();S.networkActivities=Array.isArray(n)?n:n.activities||[],S.networkActivitiesTimestamp=Date.now()}else S.networkActivities=[]}catch{S.networkActivities=[]}finally{S.isLoadingNetworkActivity=!1}qo()}function qo(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("dash-pagination-controls");if(!e)return;if(S.networkActivities.length===0){e.innerHTML=`
            ...
            </div>`,t&&(t.style.display="none");const r=document.getElementById("activity-count");r&&(r.style.display="none");return}const a=document.getElementById("activity-count");a&&(a.style.display="inline",a.textContent=S.filteredActivities.length);const n=(S.pagination.currentPage-1)*S.pagination.itemsPerPage,s=S.filteredActivities.slice(n,n+S.pagination.itemsPerPage);if(e.innerHTML=s.map(i=>ed(i,!1)).join(""),t){const i=Math.ceil(S.filteredActivities.length/S.pagination.itemsPerPage);i>1?(t.style.display="flex",document.getElementById("page-indicator").innerText=`${S.pagination.currentPage}/${i}`,document.getElementById("page-prev").disabled=S.pagination.currentPage===1,document.getElementById("page-next").disabled=S.pagination.currentPage>=i):t.style.display="none"}}function ed(e,t=!1){const a=Hp(e.timestamp||e.createdAt),n=Up(e.timestamp||e.createdAt),s=e.user||e.userAddress||e.from||"",i=jp(s),r=Wp(e.type,e.details);let o="";const l=(e.type||"").toUpperCase().trim(),d=e.details||{};if(l.includes("GAME")||l.includes("FORTUNE")||l.includes("REQUEST")||l.includes("FULFILLED")||l.includes("RESULT")){const w=d.rolls||e.rolls||[],y=d.guesses||e.guesses||[],C=d.isWin||d.prizeWon&&BigInt(d.prizeWon||0)>0n,I=d.isCumulative!==void 0?d.isCumulative:y.length>1,z=I?"Combo":"Jackpot",L=I?"background:rgba(168,85,247,0.15);color:#c084fc":"background:rgba(245,158,11,0.15);color:#fbbf24",B=d.wagerAmount||d.amount,A=d.prizeWon,_=B?M(BigInt(B)).toFixed(0):"0";let D='<span style="color:var(--dash-text-3)">No win</span>';C&&A&&BigInt(A)>0n&&(D=`<span style="color:var(--dash-green);font-weight:700">+${M(BigInt(A)).toFixed(0)} BKC</span>`);let j="";return w.length>0&&(j=`<div style="display:flex;gap:3px">${w.map((de,se)=>{const q=y[se],oe=q!==void 0&&Number(q)===Number(de);return`<div style="width:24px;height:24px;border-radius:4px;font-size:10px;font-weight:700;display:flex;align-items:center;justify-content:center;border:1px solid ${oe?"rgba(52,211,153,0.4)":"var(--dash-border)"};background:${oe?"rgba(52,211,153,0.1)":"var(--dash-surface-2)"};color:${oe?"#34d399":"var(--dash-text-3)"}">${de}</div>`}).join("")}</div>`),`
            <a href="${e.txHash?`${Wo}${e.txHash}`:"#"}" target="_blank" class="dash-fortune-item" title="${n}">
                <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:6px">
                    <div style="display:flex;align-items:center;gap:8px">
                        ...
                        <span style="font-size:9px;font-weight:700;${L};padding:1px 6px;border-radius:4px">${z}</span>
                    </div>
        ...
        `}if(l.includes("NOTARY")){const w=d.ipfsCid;w&&(o=`<span style="margin-left:4px;font-size:9px;color:#818cf8;font-family:monospace">${w.replace("ipfs://","").slice(0,12)}...</span>`)}if(l.includes("STAKING")||l.includes("DELEGAT")){const w=d.pStakeGenerated;w&&(o=`<span style="font-size:10px;color:var(--dash-purple)">+${M(BigInt(w)).toFixed(0)} pStake</span>`)}if(l.includes("DONATION")||l.includes("CHARITY")){const w=d.netAmount||d.amount,y=d.campaignId;w&&BigInt(w)>0n&&(o=`<span style="color:#ec4899;font-weight:700">${M(BigInt(w)).toFixed(2)} BKC</span>`,y&&(o+=`<span style="margin-left:4px;font-size:9px;color:var(--dash-text-3)">Campaign #${y}</span>`))}if(l.includes("CLAIM")||l.includes("REWARD")){const w=d.amount||e.amount;w&&(o=`<span style="color:var(--dash-accent);font-weight:700">+${M(BigInt(w)).toFixed(2)} BKC</span>`);const y=d.feePaid;y&&BigInt(y)>0n&&(o+=`<span style="margin-left:4px;font-size:9px;color:var(--dash-text-3)">(fee: ${M(BigInt(y)).toFixed(2)})</span>`)}const m=l.includes("PROMOT")||l.includes("ADS")||l.includes("ADVERTIS");if(m){const w=d.promotionFee||d.amount||e.amount;w&&BigInt(w)>0n&&(o=`<span style="color:#fbbf24;font-weight:700">${parseFloat(tt.formatEther(BigInt(w))).toFixed(4)} ETH</span>`);const y=d.tokenId||e.tokenId;y&&(o+=`<span style="margin-left:4px;font-size:9px;color:var(--dash-text-3)">NFT #${y}</span>`)}const p=e.txHash?`${Wo}${e.txHash}`:"#";let g="";if(m){const w=d.promotionFee||d.amount||e.amount;w&&BigInt(w)>0n&&(g=parseFloat(tt.formatEther(BigInt(w))).toFixed(4))}else{let w=e.amount||d.netAmount||d.amount||d.wagerAmount||d.prizeWon||"0";const y=M(BigInt(w));g=y>.001?y.toFixed(2):""}const b=m?"ETH":"BKC";return`
    ...
    `}function sm(){Se.dashboard&&Se.dashboard.addEventListener("click",async e=>{const t=e.target;if(t.closest("#manual-refresh-btn")){const i=t.closest("#manual-refresh-btn");i.disabled=!0,i.innerHTML='<i class="fa-solid fa-rotate fa-spin"></i>',await Zt(!0),await js(),S.activities=[],S.networkActivities=[],S.networkActivitiesTimestamp=0,S.faucet.lastCheck=0,await wn(),setTimeout(()=>{i.innerHTML='<i class="fa-solid fa-rotate"></i>',i.disabled=!1},1e3)}if(t.closest("#faucet-action-btn")){const i=t.closest("#faucet-action-btn");i.disabled||await Ko(i)}if(t.closest("#emergency-faucet-btn")&&await Ko(t.closest("#emergency-faucet-btn")),t.closest("#referral-copy-btn")&&Vp(),t.closest("#referral-share-btn")&&qp(),t.closest(".delegate-link")&&(e.preventDefault(),window.navigateTo("mine")),t.closest(".go-to-store")&&(e.preventDefault(),window.navigateTo("store")),t.closest(".go-to-rental")&&(e.preventDefault(),window.navigateTo("rental")),t.closest(".go-to-fortune")&&(e.preventDefault(),window.navigateTo("actions")),t.closest(".go-to-notary")&&(e.preventDefault(),window.navigateTo("notary")),t.closest(".go-to-charity")&&(e.preventDefault(),window.navigateTo("charity")),t.closest(".go-to-backchat")&&(e.preventDefault(),window.navigateTo("backchat")),t.closest("#open-booster-info")){const i=document.getElementById("booster-info-modal");i&&i.classList.add("visible")}if(t.closest("#close-booster-modal")||t.id==="booster-info-modal"){const i=document.getElementById("booster-info-modal");i&&i.classList.remove("visible")}if(t.closest("#close-gas-modal-dash")||t.id==="no-gas-modal-dash"){const i=document.getElementById("no-gas-modal-dash");i&&i.classList.remove("visible")}const a=t.closest(".nft-clickable-image");if(a){const i=a.dataset.address,r=a.dataset.tokenid;i&&r&&mu(i,r)}const n=t.closest("#dashboardClaimBtn");if(n&&!n.disabled)try{if(n.innerHTML='<i class="fa-solid fa-circle-notch fa-spin"></i>',n.disabled=!0,!await Xp()){n.innerHTML='<i class="fa-solid fa-coins" style="margin-right:6px"></i> Claim Rewards',n.disabled=!1;return}const{stakingRewards:r,minerRewards:o}=await li();(r>0n||o>0n)&&await jt.claimRewards({button:n,onSuccess:async()=>{x("Rewards claimed!","success"),await Zt(!0),S.activities=[],wn()},onError:l=>{l.cancelled||x("Claim failed","error")}})}catch{x("Claim failed","error")}finally{n.innerHTML='<i class="fa-solid fa-coins" style="margin-right:6px"></i> Claim Rewards',n.disabled=!1}if(t.closest("#page-prev")&&S.pagination.currentPage>1&&(S.pagination.currentPage--,Ws()),t.closest("#page-next")){const i=Math.ceil(S.filteredActivities.length/S.pagination.itemsPerPage);S.pagination.currentPage<i&&(S.pagination.currentPage++,Ws())}t.closest("#activity-sort-toggle")&&(S.filters.sort=S.filters.sort==="NEWEST"?"OLDEST":"NEWEST",Gs());const s=t.closest(".dash-chip");s&&(document.querySelectorAll(".dash-chip").forEach(i=>i.classList.remove("active")),s.classList.add("active"),S.filters.type=s.dataset.filter,Gs())})}const Ks={async render(e){Zp(),Kp(),js(),wn(),ya(),c.isConnected?(await Zt(!1),Yo()):(setTimeout(async()=>{c.isConnected&&(await Zt(!1),Yo(),ya())},500),setTimeout(async()=>{c.isConnected&&(await Zt(!1),ya())},1500))},update(e){const t=Date.now();t-S.lastUpdate>1e4&&(S.lastUpdate=t,js(),e&&(Zt(!1),ya()),wn())}},$a=window.ethers,im="https://sepolia.arbiscan.io/tx/",Jt={NONE:{boost:0,burnRate:50,keepRate:50,color:"#71717a",name:"None",icon:"○",class:"stk-tier-none"},BRONZE:{boost:1e3,burnRate:40,keepRate:60,color:"#cd7f32",name:"Bronze",icon:"🥉",class:"stk-tier-bronze"},SILVER:{boost:2500,burnRate:25,keepRate:75,color:"#c0c0c0",name:"Silver",icon:"🥈",class:"stk-tier-silver"},GOLD:{boost:4e3,burnRate:10,keepRate:90,color:"#ffd700",name:"Gold",icon:"🥇",class:"stk-tier-gold"},DIAMOND:{boost:5e3,burnRate:0,keepRate:100,color:"#b9f2ff",name:"Diamond",icon:"💎",class:"stk-tier-diamond"}};let Qt=!1,Sa=0,Jr=3650,Ye=!1,yn=[],dn=0n,Lt=null,ka="ALL",gt=0,Ys=50,Xo="none",ve=null,Vs=0n,Zr=0n,Qr=0n;function td(e){if(e<=0)return"Ready";const t=Math.floor(e/86400),a=Math.floor(e%86400/3600),n=Math.floor(e%3600/60);return t>365?`${Math.floor(t/365)}y ${Math.floor(t%365/30)}mo`:t>30?`${Math.floor(t/30)}mo ${t%30}d`:t>0?`${t}d ${a}h`:a>0?`${a}h ${n}m`:`${n}m`}function rm(e){if(e>=365){const t=Math.floor(e/365);return t===1?"1 Year":`${t} Years`}return e>=30?`${Math.floor(e/30)} Month(s)`:`${e} Day(s)`}function om(e,t){if(e<=0n||t<=0n)return 0n;const a=t/86400n,n=10000n,s=n+a*5918n/365n;return e*s/n}function lm(e){if(!e)return"Recent";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleDateString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return"Recent"}}function ad(e){const t=Number(e);return t>=5e3?Jt.DIAMOND:t>=4e3?Jt.GOLD:t>=2500?Jt.SILVER:t>=1e3?Jt.BRONZE:Jt.NONE}function cm(){if(document.getElementById("stk-styles-v10"))return;const e=document.createElement("style");e.id="stk-styles-v10",e.textContent=`
        .stk-shell {
            --stk-bg: #0c0c0e;
            --stk-surface: #141417;
    ...
    `,Em(),c.isConnected?pa():nd())}async function pa(e=!1){if(Qt)return;const t=Date.now();if(!(!e&&t-Sa<1e4)){Qt=!0,Sa=t;try{await um();const[,,a]=await Promise.all([jn(),ql(),Tu()]),n=c.stakingPoolContractPublic||c.stakingPoolContract;n&&(dn=await ne(n,"totalPStake",[],0n)),await pm();const{stakingRewards:s,minerRewards:i}=await li();Zr=s||0n,Qr=i||0n,mm(),fm(),bm(),gm(),vm(),Ta()}catch(a){console.error("Staking data load error:",a)}finally{Qt=!1}}}async function um(){if(c.userAddress)try{const e=c.stakingPoolContractPublic||c.stakingPoolContract;if(e){const a=await ne(e,"getUserBestBoost",[c.userAddress],0n);gt=Number(a)}if(gt===0){const a=await Jl();a&&a.highestBoost>0&&(gt=a.highestBoost,Xo=a.source||"api")}else Xo="active";Ys=ad(gt).burnRate}catch(e){console.error("NFT boost load error:",e)}}async function pm(){const e=c.stakingPoolContractPublic||c.stakingPoolContract;if(!(!c.userAddress||!e))try{const t=await ne(e,"previewClaim",[c.userAddress],null);t&&(ve={totalRewards:t.totalRewards||t[0]||0n,burnAmount:t.burnAmount||t[1]||0n,referrerCut:t.referrerCut||t[2]||0n,userReceives:t.userReceives||t[3]||0n,burnRateBips:t.burnRateBps||t[4]||0n,nftBoost:t.nftBoost||t[5]||0n}),Vs=0n}catch(t){console.error("Claim preview error:",t);const a=Zr+Qr,n=a*BigInt(Ys)/100n;ve={totalRewards:a,burnAmount:n,referrerCut:0n,userReceives:a-n,burnRateBips:BigInt(Ys*100),nftBoost:BigInt(gt)}}}function mm(){const e=document.getElementById("stk-reward-value"),t=document.getElementById("stk-claim-btn"),a=document.getElementById("stk-breakdown"),n=document.getElementById("stk-eth-fee"),s=(ve==null?void 0:ve.userReceives)||0n;ve!=null&&ve.totalRewards;const i=(ve==null?void 0:ve.burnAmount)||0n,r=s>0n;if(e){const o=M(s);e.innerHTML=`${o.toFixed(4)} <span class="stk-reward-suffix">BKC</span>`}if(t){t.disabled=!r;const o=t.querySelector("span");o&&(o.textContent=r?"Claim Rewards":"No Rewards Yet")}if(a&&r){a.style.display="";const o=M(Zr).toFixed(4),l=M(Qr).toFixed(4),d=M(i).toFixed(4);document.getElementById("stk-break-staking").textContent=`${o} BKC`,document.getElementById("stk-break-mining").textContent=`${l} BKC`,document.getElementById("stk-break-burned").textContent=i>0n?`-${d} BKC`:"None",document.getElementById("stk-break-burned").style.color=i>0n?"var(--stk-red)":"var(--stk-green)"}else a&&(a.style.display="none");if(n)if(r&&Vs>0n){const o=parseFloat($a.formatEther(Vs)).toFixed(6);n.innerHTML=`<i class="fa-brands fa-ethereum" style="margin-right:3px"></i>Claim fee: ${o} ETH`}else n.textContent=""}function fm(){const e=document.getElementById("stk-boost-panel");if(!e)return;const t=ad(gt),a=gt>0;e.innerHTML=`
    ...
    `}function bm(){var u,m,p,g;const e=(b,w)=>{const y=document.getElementById(b);y&&(y.innerHTML=w)};e("stk-stat-network",na(dn));const t=((u=c.userData)==null?void 0:u.pStake)||((m=c.userData)==null?void 0:m.userTotalPStake)||c.userTotalPStake||0n,a=dn>0n?Number(t*10000n/dn)/100:0;e("stk-stat-power",`${na(t)} <span style="font-size:10px;color:var(--stk-text-3)">(${a.toFixed(2)}%)</span>`);const n=(ve==null?void 0:ve.userReceives)||0n,s=M(n);e("stk-stat-rewards",s>0?`<span style="color:var(--stk-green)">${s.toFixed(2)}</span> <span style="font-size:10px;color:var(--stk-text-3)">BKC</span>`:'<span style="color:var(--stk-text-3)">0 BKC</span>');const i=((p=c.userDelegations)==null?void 0:p.length)||0;e("stk-stat-locks",`${i}`);const r=c.currentUserBalance||0n,o=document.getElementById("stk-balance-display");o&&(o.textContent=r>0n?`${M(r).toFixed(2)} BKC`:"0.00 BKC");const l=((g=c.systemFees)==null?void 0:g.DELEGATION_FEE_BIPS)||50n,d=document.getElementById("stk-fee-info");d&&(d.textContent=`${Number(l)/100}%`)}function nd(){const e=(r,o)=>{const l=document.getElementById(r);l&&(l.innerHTML=o)};e("stk-reward-value",'-- <span class="stk-reward-suffix">BKC</span>'),e("stk-stat-network","--"),e("stk-stat-power","--"),e("stk-stat-rewards","--"),e("stk-stat-locks","--"),e("stk-balance-display","-- BKC");const t=document.getElementById("stk-claim-btn");t&&(t.disabled=!0);const a=document.getElementById("stk-breakdown");a&&(a.style.display="none");const n=document.getElementById("stk-deleg-list");n&&(n.innerHTML='<div class="stk-empty"><i class="fa-solid fa-wallet"></i><p>Connect wallet to view</p></div>');const s=document.getElementById("stk-history-list");s&&(s.innerHTML='<div class="stk-empty"><i class="fa-solid fa-wallet"></i><p>Connect wallet to view</p></div>');const i=document.getElementById("stk-boost-panel");i&&(i.innerHTML='<div class="stk-empty"><i class="fa-solid fa-wallet"></i><p>Connect wallet</p></div>')}function gm(){const e=document.getElementById("stk-deleg-list"),t=document.getElementById("stk-deleg-count");if(!e)return;const a=c.userDelegations||[];if(t&&(t.textContent=a.length),a.length===0){e.innerHTML='<div class="stk-empty"><i class="fa-solid fa-inbox"></i><p>No active delegations</p></div>';return}Lt&&(clearInterval(Lt),Lt=null);const n=[...a].sort((s,i)=>Number(s.unlockTime)-Number(i.unlockTime));e.innerHTML=n.map((s,i)=>xm(s,i)).join(""),Lt=setInterval(hm,6e4),e.querySelectorAll(".stk-unstake-btn").forEach(s=>{s.addEventListener("click",()=>ym(parseInt(s.dataset.index),s.classList.contains("stk-unstake-force")))})}function xm(e,t){const a=M(e.amount||0n),n=e.lockDays||Number(e.lockDuration||0n)/86400,s=Number(e.unlockTime||e.lockEnd||0n),i=Math.floor(Date.now()/1e3),r=s>i,o=r?s-i:0,l=e.lockDuration||BigInt(e.lockDays||0)*86400n,d=e.pStake||om(e.amount||0n,l);return`
        <div class="stk-deleg-item">
            ...
            <div style="display:flex;align-items:center;gap:8px">
                ${r?`
                    <span class="stk-countdown" data-unlock-time="${s}">${td(o)}</span>
    ...
    `}function hm(){document.querySelectorAll(".stk-countdown").forEach(e=>{const t=parseInt(e.dataset.unlockTime),a=Math.floor(Date.now()/1e3);e.textContent=td(t-a)})}async function vm(){if(c.userAddress)try{const e=qe.getHistory||"https://gethistory-4wvdcuoouq-uc.a.run.app",t=await fetch(`${e}/${c.userAddress}`);t.ok&&(yn=(await t.json()||[]).filter(n=>{const s=(n.type||"").toUpperCase();return s.includes("DELEGAT")||s.includes("STAKE")||s.includes("UNDELEGAT")||s.includes("CLAIM")||s.includes("REWARD")||s.includes("FORCE")}),sd())}catch(e){console.error("History load error:",e)}}function sd(){const e=document.getElementById("stk-history-list");if(!e)return;let t=yn;if(ka!=="ALL"&&(t=yn.filter(a=>{const n=(a.type||"").toUpperCase();switch(ka){case"STAKE":return(n.includes("DELEGAT")||n.includes("STAKE"))&&!n.includes("UNSTAKE")&&!n.includes("UNDELEGAT")&&!n.includes("FORCE");case"UNSTAKE":return n.includes("UNSTAKE")||n.includes("UNDELEGAT")||n.includes("FORCE");case"CLAIM":return n.includes("CLAIM")||n.includes("REWARD");default:return!0}})),t.length===0){e.innerHTML=`<div class="stk-empty"><i class="fa-solid fa-inbox"></i><p>No ${ka==="ALL"?"":ka.toLowerCase()+" "}history yet</p></div>`;return}e.innerHTML=t.slice(0,25).map(a=>{const n=(a.type||"").toUpperCase(),s=a.details||{},i=lm(a.timestamp||a.createdAt);let r,o,l,d,u="";n.includes("FORCE")?(r="fa-bolt",o="rgba(239,68,68,0.12)",l="#ef4444",d="Force Unstaked",s.feePaid&&BigInt(s.feePaid)>0n&&(u=`<span style="color:#ef4444">-${M(BigInt(s.feePaid)).toFixed(2)}</span>`)):(n.includes("DELEGAT")||n.includes("STAKE"))&&!n.includes("UNSTAKE")?(r="fa-lock",o="rgba(74,222,128,0.12)",l="#4ade80",d="Delegated",s.pStakeGenerated&&(u=`<span style="color:var(--stk-purple)">+${M(BigInt(s.pStakeGenerated)).toFixed(0)} pS</span>`)):n.includes("UNSTAKE")||n.includes("UNDELEGAT")?(r="fa-unlock",o="rgba(249,115,22,0.12)",l="#f97316",d="Unstaked"):n.includes("CLAIM")||n.includes("REWARD")?(r="fa-coins",o="rgba(251,191,36,0.12)",l="#fbbf24",d="Claimed",s.amountReceived&&BigInt(s.amountReceived)>0n&&(u=`<span style="color:var(--stk-green)">+${M(BigInt(s.amountReceived)).toFixed(2)}</span>`),s.burnedAmount&&BigInt(s.burnedAmount)>0n&&(u+=` <span style="font-size:9px;color:rgba(239,68,68,0.6)">🔥-${M(BigInt(s.burnedAmount)).toFixed(2)}</span>`)):(r="fa-circle",o="rgba(113,113,122,0.12)",l="#71717a",d=a.type||"Activity");const m=a.txHash?`${im}${a.txHash}`:"#",p=a.amount||s.amount||s.amountReceived||"0";let g=0;try{g=M(BigInt(p))}catch{}const b=g>.001?g.toFixed(2):"";return`
        ...
        `}).join("")}function Ta(){var n;const e=document.getElementById("stk-amount-input"),t=document.getElementById("stk-delegate-btn");if(!e)return;const a=e.value;if(!a||parseFloat(a)<=0){const s=document.getElementById("stk-preview-pstake");s&&(s.textContent="0");const i=document.getElementById("stk-preview-net");i&&(i.textContent="0.00 BKC"),t&&(t.disabled=!0);return}try{const s=$a.parseUnits(a,18),i=((n=c.systemFees)==null?void 0:n.DELEGATION_FEE_BIPS)||50n,r=s*BigInt(i)/10000n,o=s-r,l=BigInt(Jr),d=10000n,u=d+l*5918n/365n,m=o*u/d,p=document.getElementById("stk-preview-pstake");p&&(p.textContent=na(m));const g=document.getElementById("stk-preview-net");g&&(g.textContent=`${M(o).toFixed(4)} BKC`);const b=c.currentUserBalance||0n;s>b?(e.classList.add("error"),t&&(t.disabled=!0)):(e.classList.remove("error"),t&&(t.disabled=Ye))}catch{t&&(t.disabled=!0)}}async function wm(){if(Ye)return;const e=document.getElementById("stk-amount-input"),t=document.getElementById("stk-delegate-btn");if(!e||!t)return;const a=e.value;if(!a||parseFloat(a)<=0)return x("Enter an amount","warning");const n=c.currentUserBalance||0n;let s;try{if(s=$a.parseUnits(a,18),s>n)return x("Insufficient BKC balance","error")}catch{return x("Invalid amount","error")}try{if(await c.publicProvider.getBalance(c.userAddress)<$a.parseEther("0.001"))return x("Insufficient ETH for gas","error")}catch{}Ye=!0;try{await jt.delegate({amount:s,lockDays:Jr,button:t,onSuccess:async()=>{e.value="",x("Delegation successful!","success"),Qt=!1,Sa=0,await pa(!0)},onError:i=>{i.cancelled||x("Delegation failed: "+(i.reason||i.message||"Unknown error"),"error")}})}catch(i){x("Delegation failed: "+(i.reason||i.message||"Unknown error"),"error")}finally{Ye=!1,Ta()}}async function ym(e,t){if(Ye||t&&!confirm("Force unstake will incur a 50% penalty. Continue?"))return;const a=document.querySelector(`.stk-unstake-btn[data-index='${e}']`);Ye=!0;try{await(t?jt.forceUnstake:jt.unstake)({delegationIndex:BigInt(e),button:a,onSuccess:async()=>{x(t?"Force unstaked (50% penalty)":"Unstaked successfully!",t?"warning":"success"),Qt=!1,Sa=0,await pa(!0)},onError:s=>{s.cancelled||x("Unstake failed: "+(s.reason||s.message||"Unknown error"),"error")}})}catch(n){x("Unstake failed: "+(n.reason||n.message||"Unknown error"),"error")}finally{Ye=!1}}async function km(){if(Ye)return;const e=document.getElementById("stk-claim-btn");Ye=!0;try{await jt.claimRewards({button:e,onSuccess:async()=>{x("Rewards claimed!","success"),Qt=!1,Sa=0,yn=[],await pa(!0)},onError:t=>{t.cancelled||x("Claim failed: "+(t.reason||t.message||"Unknown error"),"error")}})}catch(t){x("Claim failed: "+(t.reason||t.message||"Unknown error"),"error")}finally{Ye=!1}}function Em(){var o;const e=document.getElementById("mine");if(!e)return;const t=document.getElementById("stk-amount-input"),a=document.getElementById("stk-max-btn"),n=document.getElementById("stk-delegate-btn"),s=document.getElementById("stk-refresh-btn"),i=document.querySelectorAll(".stk-duration-chip"),r=document.querySelectorAll(".stk-tab");t==null||t.addEventListener("input",Ta),a==null||a.addEventListener("click",()=>{const l=c.currentUserBalance||0n;t&&(t.value=$a.formatUnits(l,18),Ta())}),i.forEach(l=>{l.addEventListener("click",()=>{i.forEach(d=>d.classList.remove("selected")),l.classList.add("selected"),Jr=parseInt(l.dataset.days),Ta()})}),r.forEach(l=>{l.addEventListener("click",()=>{r.forEach(d=>d.classList.remove("active")),l.classList.add("active"),ka=l.dataset.filter,sd()})}),n==null||n.addEventListener("click",wm),s==null||s.addEventListener("click",()=>{const l=s.querySelector("i");l==null||l.classList.add("fa-spin"),pa(!0).then(()=>{setTimeout(()=>l==null?void 0:l.classList.remove("fa-spin"),500)})}),(o=document.getElementById("stk-claim-btn"))==null||o.addEventListener("click",km),e.addEventListener("click",l=>{l.target.closest(".go-to-store")&&(l.preventDefault(),window.navigateTo("store")),l.target.closest(".go-to-rental")&&(l.preventDefault(),window.navigateTo("rental"))})}function Tm(){Lt&&(clearInterval(Lt),Lt=null)}function Cm(e){e?pa():nd()}const qs={render:dm,update:Cm,cleanup:Tm},Be=window.ethers,Im="https://sepolia.arbiscan.io/tx/",Am=3e4,Xs={Diamond:{color:"#22d3ee",gradient:"from-cyan-500/20 to-blue-500/20",border:"border-cyan-500/40",text:"text-cyan-400",glow:"shadow-cyan-500/30",icon:"💎",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeicgip72jcqgsirlrhn3tq5cc226vmko6etnndzl6nlhqrktfikafq",keepRate:100,burnRate:0},Gold:{color:"#fbbf24",gradient:"from-yellow-500/20 to-amber-500/20",border:"border-yellow-500/40",text:"text-yellow-400",glow:"shadow-yellow-500/30",icon:"🥇",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeifponccrbicg2pcjrn2hrfoqgc77xhm2r4ld7hdpw6cxxkbsckf44",keepRate:90,burnRate:10},Silver:{color:"#9ca3af",gradient:"from-gray-400/20 to-slate-400/20",border:"border-gray-400/40",text:"text-gray-300",glow:"shadow-gray-400/30",icon:"🥈",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeihvi2inujm5zpi7tl667g4srq273536pjkglwyrtbwmgnskmu7jg4",keepRate:75,burnRate:25},Bronze:{color:"#f97316",gradient:"from-orange-600/20 to-amber-700/20",border:"border-orange-600/40",text:"text-orange-400",glow:"shadow-orange-500/30",icon:"🥉",image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeiclqidb67rt3tchhjpsib62s624li7j2bpxnr6b5w5mfp4tomhu7m",keepRate:60,burnRate:40}};function fs(e){return Xs[e]||Xs.Bronze}const $={tradeDirection:"buy",selectedPoolBoostBips:null,buyPrice:0n,sellPrice:0n,netSellPrice:0n,poolNFTCount:0,userBalanceOfSelectedNFT:0,availableToSellCount:0,firstAvailableTokenId:null,firstAvailableTokenIdForBuy:null,bestBoosterTokenId:0n,bestBoosterBips:0,isDataLoading:!1,tradeHistory:[]},kn=new Map,eo=new Map;let an=!1,Nt=null;const Pm=["function getPoolAddress(uint256 boostBips) view returns (address)","function isPool(address) view returns (bool)"];function zm(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function Bm(e){const t=eo.get(e);return t&&Date.now()-t.timestamp<Am?t.data:null}function id(e,t){eo.set(e,{data:t,timestamp:Date.now()})}function Ps(e){eo.delete(e)}function Nm(){if(document.getElementById("swap-styles-v9"))return;const e=document.createElement("style");e.id="swap-styles-v9",e.textContent=`
    ...
    `,document.head.appendChild(e)}function $m(){return`
    ...
    `}const Sm={async render(e){Nm(),await Vl();const t=document.getElementById("store");t&&((t.innerHTML.trim()===""||e)&&(t.innerHTML=`
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <div class="flex items-center gap-3">
                            <div class="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden"
                                 id="trade-mascot">
                                <img src="${Xs.Diamond.image}" alt="NFT" class="w-full h-full object-contain" onerror="this.outerHTML='<span class=\\'text-3xl\\'>💎</span>'">
                            </div>
                            <div>
            ...
            `,Mm()),$.selectedPoolBoostBips===null&&xe.length>0&&($.selectedPoolBoostBips=xe[0].boostBips),await ft(),await Ea())},async update(){$.selectedPoolBoostBips!==null&&!$.isDataLoading&&document.getElementById("store")&&!document.hidden&&await ft()}};async function Ea(){const e=document.getElementById("history-list");if(!c.userAddress){e&&(e.innerHTML='<div class="text-center py-4 text-xs text-zinc-600">Connect wallet to view history</div>');return}try{const t=qe.getHistory||"https://gethistory-4wvdcuoouq-uc.a.run.app",a=await fetch(`${t}/${c.userAddress}`);if(!a.ok)throw new Error(`HTTP ${a.status}`);const n=await a.json();console.log("All history types:",[...new Set((n||[]).map(i=>i.type))]),$.tradeHistory=(n||[]).filter(i=>{const r=(i.type||"").toUpperCase();return r==="NFTBOUGHT"||r==="NFTSOLD"||r==="NFT_BOUGHT"||r==="NFT_SOLD"||r==="NFTPURCHASED"||r==="NFT_PURCHASED"||r.includes("NFTBOUGHT")||r.includes("NFTSOLD")||r.includes("NFTPURCHASED")}),console.log("NFT trade history:",$.tradeHistory.length,"items");const s=document.getElementById("history-count");s&&(s.textContent=$.tradeHistory.length),Jo()}catch(t){console.error("History load error:",t),$.tradeHistory=[],Jo()}}function Jo(){const e=document.getElementById("history-list");if(e){if(!c.isConnected){e.innerHTML='<div class="text-center py-4 text-xs text-zinc-600">Connect wallet to view history</div>';return}if($.tradeHistory.length===0){e.innerHTML=`
        ...
        `;return}e.innerHTML=$.tradeHistory.slice(0,20).map(t=>{const a=(t.type||"").toUpperCase(),n=t.details||{},s=zm(t.timestamp||t.createdAt),i=a.includes("BOUGHT")||a.includes("PURCHASED"),r=i?"fa-cart-plus":"fa-money-bill-transfer",o=i?"#22c55e":"#f59e0b",l=i?"rgba(34,197,94,0.15)":"rgba(245,158,11,0.15)",d=i?"🛒 Bought NFT":"💰 Sold NFT",u=i?"-":"+",m=t.txHash?`${Im}${t.txHash}`:"#";let p="";try{let w=t.amount||n.amount||n.price||n.payout||"0";if(typeof w=="string"&&w!=="0"){const y=M(BigInt(w));y>.001&&(p=y.toFixed(2))}}catch{}const g=n.tokenId||"",b=n.boostBips||n.boost||"";return`
        ...
        `}).join("")}}function Lm(){return xe.map((e,t)=>{const a=fs(e.name),n=t===0,s=st(e.boostBips),i=a.icon||e.emoji||"💎";return`
        ...
        `}).join("")}function Zo(e){document.querySelectorAll(".tier-chip").forEach(t=>{const a=Number(t.dataset.boost)===e,n=t.dataset.tier,s=fs(n);t.className=`tier-chip flex flex-col items-center gap-1 p-2 rounded-xl border transition-all ${a?`bg-gradient-to-br ${s.gradient} ${s.border} ${s.text} active`:"bg-zinc-800/50 border-zinc-700/50 text-zinc-400 hover:border-zinc-600"}`})}function En(){const e=document.getElementById("swap-interface");if(!e)return;const t=xe.find(b=>b.boostBips===$.selectedPoolBoostBips),a=fs(t==null?void 0:t.name),n=$.tradeDirection==="buy";_m(n);const s=n?$.buyPrice:$.netSellPrice,i=M(s).toFixed(2),r=M(c.currentUserBalance||0n).toFixed(2),o=n&&$.firstAvailableTokenIdForBuy===null,l=!n&&$.availableToSellCount===0,d=!n&&$.userBalanceOfSelectedNFT>$.availableToSellCount,u=n&&$.buyPrice>(c.currentUserBalance||0n),m=n?"":d?`<span class="${l?"text-red-400":"text-zinc-400"}">${$.availableToSellCount}</span>/<span class="text-zinc-500">${$.userBalanceOfSelectedNFT}</span> <span class="text-[9px] text-blue-400">(${$.userBalanceOfSelectedNFT-$.availableToSellCount} rented)</span>`:`<span class="${l?"text-red-400":"text-zinc-400"}">${$.userBalanceOfSelectedNFT}</span>`,p=a.icon||(t==null?void 0:t.emoji)||"💎",g=a.image||"";st((t==null?void 0:t.boostBips)||0),e.innerHTML=`
        <div class="fade-in">
            ...
            <div class="flex justify-between items-center text-[10px] text-zinc-600 mb-4 px-1">
                ...
                <span class="text-green-400">Keep ${st((t==null?void 0:t.boostBips)||0)}% of rewards</span>
            </div>
            
            <!-- Execute Button -->
            ${Rm(n,o,l,u,d)}
        </div>
    `}function Rm(e,t,a,n,s=!1){return c.isConnected?e?t?`
        ...
        `}function _m(e){const t=document.getElementById("trade-mascot");t&&(t.className=`w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden ${e?"trade-buy":"trade-sell"}`)}function Qo(){const e=document.getElementById("inventory-grid"),t=document.getElementById("nft-count");if(!e)return;const a=c.myBoosters||[];if(t&&(t.textContent=a.length),!c.isConnected){e.innerHTML='<div class="col-span-4 text-center py-4 text-xs text-zinc-600">Connect wallet</div>';return}if(a.length===0){e.innerHTML=`
        ...
        `;return}const n=c.rentalListings||[],s=new Set(n.map(r=>{var o;return(o=r.tokenId)==null?void 0:o.toString()})),i=Math.floor(Date.now()/1e3);e.innerHTML=a.map(r=>{var I;const o=xe.find(z=>z.boostBips===Number(r.boostBips)),l=fs(o==null?void 0:o.name),d=st(Number(r.boostBips)),u=l.icon||(o==null?void 0:o.emoji)||"💎",m=$.firstAvailableTokenId&&BigInt(r.tokenId)===$.firstAvailableTokenId,p=(I=r.tokenId)==null?void 0:I.toString(),g=s.has(p),b=n.find(z=>{var L;return((L=z.tokenId)==null?void 0:L.toString())===p}),w=b&&b.rentalEndTime&&Number(b.rentalEndTime)>i,y=g||w;let C="";return w?C='<span class="absolute top-1 right-1 bg-blue-500 text-white text-[7px] px-1.5 py-0.5 rounded-full font-bold">🔑</span>':g&&(C='<span class="absolute top-1 right-1 bg-green-500 text-white text-[7px] px-1.5 py-0.5 rounded-full font-bold">📋</span>'),`
            <div class="inventory-item ${y?"opacity-50 cursor-not-allowed":"cursor-pointer"} rounded-xl p-2 border ${m&&!y?"border-amber-500 ring-2 ring-amber-500/50 bg-amber-500/10":"border-zinc-700/50 bg-zinc-800/30"} hover:bg-zinc-800/50 transition-all relative"
                ...
                <p class="text-[7px] text-center ${m&&!y?"text-amber-400 font-bold":"text-zinc-600"}">#${r.tokenId}</p>
            </div>
        `}).join("")}async function ft(e=!1){var n,s;if($.selectedPoolBoostBips===null)return;const t=$.selectedPoolBoostBips,a=Date.now();if(Nt=a,!e){const i=Bm(t);if(i){Js(i),En(),Qo(),Fm(t,a);return}}$.isDataLoading=!0;try{const i=c.myBoosters||[],r=c.rentalListings||[],o=new Set(r.map(q=>{var oe;return(oe=q.tokenId)==null?void 0:oe.toString()})),l=Math.floor(Date.now()/1e3),d=i.filter(q=>Number(q.boostBips)===t),u=d.filter(q=>{var Ue;const oe=(Ue=q.tokenId)==null?void 0:Ue.toString(),Re=r.find(Q=>{var _e;return((_e=Q.tokenId)==null?void 0:_e.toString())===oe}),It=o.has(oe),dt=Re&&Re.rentalEndTime&&Number(Re.rentalEndTime)>l;return!It&&!dt}),m=xe.find(q=>q.boostBips===t);if(!m){console.warn("Tier not found for boostBips:",t);return}const p=`pool_${m.name.toLowerCase()}`;let g=v[p]||kn.get(t);if(!g){const q=v.nftPoolFactory||v.nftLiquidityPoolFactory;if(q&&c.publicProvider)try{g=await new Be.Contract(q,Pm,c.publicProvider).getPoolAddress(t),g&&g!==Be.ZeroAddress&&kn.set(t,g)}catch(oe){console.warn("Factory lookup failed:",oe.message)}}if(Nt!==a)return;if(!g||g===Be.ZeroAddress){const q=document.getElementById("swap-interface");q&&(q.innerHTML=`
                ...
                `);return}const b=new Be.Contract(g,oi,c.publicProvider),[w,y,C]=await Promise.all([ne(b,"getBuyPrice",[],Be.MaxUint256).catch(()=>Be.MaxUint256),ne(b,"getSellPrice",[],0n).catch(()=>0n),b.getAvailableNFTs().catch(()=>[])]);if(Nt!==a)return;const I=Array.isArray(C)?[...C]:[],z=w===Be.MaxUint256?0n:w,L=y;let B=((n=c.systemFees)==null?void 0:n.NFT_POOL_SELL_TAX_BIPS)||1000n,A=BigInt(((s=c.boosterDiscounts)==null?void 0:s[$.bestBoosterBips])||0);const _=typeof B=="bigint"?B:BigInt(B),D=typeof A=="bigint"?A:BigInt(A),j=_>D?_-D:0n,H=L*j/10000n,de=L-H,se={buyPrice:z,sellPrice:L,netSellPrice:de,poolNFTCount:I.length,firstAvailableTokenIdForBuy:I.length>0?BigInt(I[I.length-1]):null,userBalanceOfSelectedNFT:d.length,availableToSellCount:u.length,availableNFTsOfTier:u};id(t,se),Js(se,t)}catch(i){if(console.warn("Store Data Warning:",i.message),Nt===a){const r=document.getElementById("swap-interface");r&&(r.innerHTML=`
                    <div class="text-center py-12">
                        <div class="w-12 h-12 bg-zinc-800 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                `)}return}finally{Nt===a&&($.isDataLoading=!1,En(),Qo())}}async function Fm(e,t){var a,n;try{const s=c.myBoosters||[],i=c.rentalListings||[],r=new Set(i.map(se=>{var q;return(q=se.tokenId)==null?void 0:q.toString()})),o=Math.floor(Date.now()/1e3),l=s.filter(se=>Number(se.boostBips)===e),d=l.filter(se=>{var dt;const q=(dt=se.tokenId)==null?void 0:dt.toString(),oe=i.find(Ue=>{var Q;return((Q=Ue.tokenId)==null?void 0:Q.toString())===q}),Re=r.has(q),It=oe&&oe.rentalEndTime&&Number(oe.rentalEndTime)>o;return!Re&&!It}),u=xe.find(se=>se.boostBips===e);if(!u)return;const m=`pool_${u.name.toLowerCase()}`;let p=v[m]||kn.get(e);if(!p||p===Be.ZeroAddress)return;const g=new Be.Contract(p,oi,c.publicProvider),[b,w,y]=await Promise.all([ne(g,"getBuyPrice",[],Be.MaxUint256).catch(()=>Be.MaxUint256),ne(g,"getSellPrice",[],0n).catch(()=>0n),g.getAvailableNFTs().catch(()=>[])]);if(Nt!==t)return;const C=Array.isArray(y)?[...y]:[],I=b===Be.MaxUint256?0n:b,z=w;let L=((a=c.systemFees)==null?void 0:a.NFT_POOL_SELL_TAX_BIPS)||1000n,B=BigInt(((n=c.boosterDiscounts)==null?void 0:n[$.bestBoosterBips])||0);const A=typeof L=="bigint"?L:BigInt(L),_=typeof B=="bigint"?B:BigInt(B),D=A>_?A-_:0n,j=z*D/10000n,H=z-j,de={buyPrice:I,sellPrice:z,netSellPrice:H,poolNFTCount:C.length,firstAvailableTokenIdForBuy:C.length>0?BigInt(C[C.length-1]):null,userBalanceOfSelectedNFT:l.length,availableToSellCount:d.length,availableNFTsOfTier:d};id(e,de),$.selectedPoolBoostBips===e&&Nt===t&&(Js(de,e),En())}catch(s){console.warn("Background refresh failed:",s.message)}}function Js(e,t){var s,i,r;$.buyPrice=e.buyPrice,$.sellPrice=e.sellPrice,$.netSellPrice=e.netSellPrice,$.poolNFTCount=e.poolNFTCount,$.firstAvailableTokenIdForBuy=e.firstAvailableTokenIdForBuy,$.userBalanceOfSelectedNFT=e.userBalanceOfSelectedNFT,$.availableToSellCount=e.availableToSellCount;const a=$.firstAvailableTokenId;!(a&&((s=e.availableNFTsOfTier)==null?void 0:s.some(o=>BigInt(o.tokenId)===a)))&&((i=e.availableNFTsOfTier)==null?void 0:i.length)>0?$.firstAvailableTokenId=BigInt(e.availableNFTsOfTier[0].tokenId):(r=e.availableNFTsOfTier)!=null&&r.length||($.firstAvailableTokenId=null)}function Mm(){const e=document.getElementById("store");e&&e.addEventListener("click",async t=>{if(t.target.closest("#refresh-btn")){const r=t.target.closest("#refresh-btn").querySelector("i");r.classList.add("fa-spin"),Ps($.selectedPoolBoostBips),await Promise.all([$t(!0),Xl()]),await ft(!0),Ea(),r.classList.remove("fa-spin");return}const a=t.target.closest(".tier-chip");if(a){const i=Number(a.dataset.boost);$.selectedPoolBoostBips!==i&&($.selectedPoolBoostBips=i,$.firstAvailableTokenId=null,Zo(i),await ft());return}if(t.target.closest("#swap-direction-btn")){$.tradeDirection=$.tradeDirection==="buy"?"sell":"buy",En();return}if(t.target.closest("#inventory-toggle")){const i=document.getElementById("inventory-panel"),r=document.getElementById("inventory-chevron");i&&r&&(i.classList.toggle("hidden"),r.style.transform=i.classList.contains("hidden")?"":"rotate(180deg)");return}if(t.target.closest("#history-toggle")){const i=document.getElementById("history-panel"),r=document.getElementById("history-chevron");i&&r&&(i.classList.toggle("hidden"),r.style.transform=i.classList.contains("hidden")?"":"rotate(180deg)");return}const n=t.target.closest(".inventory-item");if(n){if(n.dataset.unavailable==="true"){x("This NFT is listed for rental and cannot be sold","warning");return}const r=Number(n.dataset.boost),o=n.dataset.tokenid;$.selectedPoolBoostBips=r,$.tradeDirection="sell",o&&($.firstAvailableTokenId=BigInt(o),console.log("User selected NFT #"+o+" for sale")),Zo(r),await ft();return}const s=t.target.closest("#execute-btn");if(s){if(t.preventDefault(),t.stopPropagation(),an||s.disabled)return;const i=s.dataset.action,r=document.getElementById("trade-mascot");if(i==="connect"){window.openConnectModal();return}const o=xe.find(u=>u.boostBips===$.selectedPoolBoostBips);if(!o)return;const l=`pool_${o.name.toLowerCase()}`,d=v[l]||kn.get(o.boostBips);if(!d){x("Pool address not found","error");return}an=!0,r&&(r.className="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden trade-spin");try{if($.tradeDirection==="buy")await vn.buyFromPool({poolAddress:d,button:s,onSuccess:async u=>{r&&(r.className="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden trade-success"),x("🟢 NFT Purchased!","success"),Ps($.selectedPoolBoostBips),await Promise.all([$t(!0),ft(!0)]),Ea()},onError:u=>{if(!u.cancelled&&u.type!=="user_rejected"){const m=u.message||u.reason||"Transaction failed";x("Buy failed: "+m,"error")}}});else{if(!$.firstAvailableTokenId){x("No NFT selected for sale","error"),an=!1;return}await vn.sellToPool({poolAddress:d,tokenId:$.firstAvailableTokenId,button:s,onSuccess:async u=>{r&&(r.className="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden trade-success"),x("🔴 NFT Sold!","success"),Ps($.selectedPoolBoostBips),await Promise.all([$t(!0),ft(!0)]),Ea()},onError:u=>{if(!u.cancelled&&u.type!=="user_rejected"){const m=u.message||u.reason||"Transaction failed";x("Sell failed: "+m,"error")}}})}}finally{an=!1,setTimeout(async()=>{try{await Promise.all([$t(!0),ft(!0)]),Ea()}catch(u){console.warn("[Store] Post-transaction refresh failed:",u.message)}},2e3),r&&setTimeout(()=>{const u=$.tradeDirection==="buy";r.className=`w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden ${u?"trade-buy":"trade-sell"}`},800)}}})}const to="https://sepolia.arbiscan.io/tx/",el="https://sepolia.arbiscan.io/address/",Dm="0x16346f5a45f9615f1c894414989f0891c54ef07b",Om=(v==null?void 0:v.fortunePool)||"0x277dB00d533Bbc0fc267bbD954640aDA38ee6B37",Tn="./assets/fortune.png",ea=1e3,rd=250,Hm=3e3,tl={pt:{title:"Compartilhe & Ganhe!",subtitle:`+${ea} pontos para o Airdrop`,later:"Talvez depois"},en:{title:"Share & Earn!",subtitle:`+${ea} points for Airdrop`,later:"Maybe later"},es:{title:"¡Comparte y Gana!",subtitle:`+${ea} puntos para el Airdrop`,later:"Quizás después"}},Um={pt:{win:e=>`🎉 Ganhei ${e.toLocaleString()} BKC no Fortune Pool!
...
#Backcoin #Web3 #Arbitrum`}},jm={pt:"./assets/pt.png",en:"./assets/en.png",es:"./assets/es.png"};let xa="en";const ue=[{id:0,name:"Easy",emoji:"🍀",range:5,multiplier:2,chance:"20%",color:"emerald",hex:"#10b981",bgFrom:"from-emerald-500/20",bgTo:"to-green-600/10",borderColor:"border-emerald-500/50",textColor:"text-emerald-400"},{id:1,name:"Medium",emoji:"⚡",range:15,multiplier:10,chance:"6.7%",color:"violet",hex:"#8b5cf6",bgFrom:"from-violet-500/20",bgTo:"to-purple-600/10",borderColor:"border-violet-500/50",textColor:"text-violet-400"},{id:2,name:"Hard",emoji:"👑",range:150,multiplier:100,chance:"0.67%",color:"amber",hex:"#f59e0b",bgFrom:"from-amber-500/20",bgTo:"to-orange-600/10",borderColor:"border-amber-500/50",textColor:"text-amber-400"}],un=ue.reduce((e,t)=>e+t.multiplier,0),pn=ue[2].multiplier,Ae=ue[2].range,E={mode:"jackpot",phase:"play",guess:50,guesses:[2,5,50],comboStep:0,wager:10,gameId:null,result:null,txHash:null,poolStatus:null,history:[],serviceFee:0n,serviceFee1x:0n,serviceFee5x:0n,tiersData:null,commitment:{hash:null,userSecret:null,commitBlock:null,commitTxHash:null,revealDelay:5,waitStartTime:null,canReveal:!1}};let Fe=null;function Gm(){if(document.getElementById("fortune-styles-v11"))return;const e=document.createElement("style");e.id="fortune-styles-v11",e.textContent=`
    ...
    `,document.head.appendChild(e)}function Wm(){Gm();const e=document.getElementById("actions");if(!e){console.error("[FortunePool] Container #actions not found!");return}e.innerHTML=`
        <div class="max-w-md mx-auto px-4 py-6">
            ...
            <div class="text-center mb-5">
                ...
                <div class="flex items-center justify-center gap-2 mt-3 flex-wrap">
                    <a href="${el}${Dm}" target="_blank" rel="noopener"
                    ...
                    <a href="${el}${Om}" target="_blank" rel="noopener"
    ...
    `,no(),Ym(),E.phase==="play"&&Ne()}function Km(){Fe&&(clearInterval(Fe),Fe=null),E.phase="play",E.result=null,E.commitment={hash:null,userSecret:null,commitBlock:null,commitTxHash:null,revealDelay:E.commitment.revealDelay||5,waitStartTime:null,canReveal:!1}}function Ym(){var e,t;if(c.userAddress)try{const a=JSON.parse(localStorage.getItem("fortune_pending_games")||"{}"),n=Object.values(a).find(s=>{var i,r;return((i=s.player)==null?void 0:i.toLowerCase())===((r=c.userAddress)==null?void 0:r.toLowerCase())&&!s.revealed});n&&(console.log("[FortunePool] Recovering pending game:",n.gameId),E.gameId=n.gameId,E.commitment.userSecret=n.userSecret,E.mode=n.tierMask===4?"jackpot":"combo",E.guesses=n.guesses||[2,5,50],E.guess=E.mode==="jackpot"&&((e=n.guesses)==null?void 0:e[0])||50,E.wager=n.wagerAmount?Number(((t=window.ethers)==null?void 0:t.formatEther(BigInt(n.wagerAmount)))||10):10,E.commitment.waitStartTime=n.commitTimestamp||Date.now(),E.commitment.canReveal=!1,E.phase="waiting",Ne(),od())}catch(a){console.warn("[FortunePool] Pending game recovery failed:",a)}}function Ne(){const e=document.getElementById("game-area");if(e)switch(Vm(E.phase),E.phase){case"play":al(e);break;case"processing":Zm(e);break;case"waiting":Qm(e);break;case"result":nf(e);break;default:al(e)}}function Vm(e){var a;const t=document.getElementById("tiger-mascot");if(t)switch(t.className="w-24 h-24 object-contain mx-auto",t.style.filter="",e){case"play":t.classList.add("tiger-float","tiger-pulse");break;case"processing":t.classList.add("tiger-spin");break;case"waiting":t.classList.add("tiger-float"),t.style.filter="hue-rotate(270deg)";break;case"result":((a=E.result)==null?void 0:a.prizeWon)>0?t.classList.add("tiger-celebrate"):(t.style.filter="grayscale(0.5)",t.classList.add("tiger-float"));break}}function al(e){const t=E.mode==="jackpot",a=t?pn:un,n=M(c.currentUserBalance||0n),s=n>=1,i=t?E.serviceFee1x:E.serviceFee5x,r=i>0n?Number(i)/1e18:0,o=i>0n;e.innerHTML=`
        <div class="space-y-4">
            <!-- Mode Tabs -->
            <div class="flex bg-zinc-900/60 border border-zinc-800/50 rounded-xl overflow-hidden">
                <button id="tab-jackpot" class="flex-1 py-3 text-center font-bold text-sm transition-all ${t?"bg-amber-500/15 text-amber-400 border-b-2 border-amber-500":"text-zinc-500 hover:text-zinc-300"}">
                    ...
                    <span class="ml-1 px-1.5 py-0.5 rounded text-[10px] font-black ${t?"bg-amber-500/30 text-amber-400":"bg-zinc-800 text-zinc-500"}">${pn}x</span>
                </button>
                <button id="tab-combo" class="flex-1 py-3 text-center font-bold text-sm transition-all ${t?"text-zinc-500 hover:text-zinc-300":"bg-violet-500/15 text-violet-400 border-b-2 border-violet-500"}">
                    ...
                    <span class="ml-1 px-1.5 py-0.5 rounded text-[10px] font-black ${t?"bg-zinc-800 text-zinc-500":"bg-violet-500/30 text-violet-400"}">${un}x</span>
                </button>
            </div>
            ...
            <div class="bg-zinc-900/40 border border-zinc-800/40 rounded-xl px-4 py-2.5 text-center">
                ${t?`
                    <p class="text-zinc-400 text-xs">Pick <span class="text-white font-bold">1 number</span> from <span class="text-amber-400 font-bold">1-${Ae}</span> &bull; <span class="text-emerald-400">${ue[2].chance}</span> chance &bull; Win <span class="text-amber-400 font-bold">${pn}x</span></p>
                `:`
                    <p class="text-zinc-400 text-xs">Pick <span class="text-white font-bold">3 numbers</span> across 3 tiers &bull; Max <span class="text-violet-400 font-bold">${un}x</span> if all match</p>
                `}
            </div>
            ...
            <div class="bg-gradient-to-br from-zinc-900 to-zinc-800/50 border border-zinc-700/50 rounded-2xl p-4">
                ...
                <div class="grid grid-cols-5 gap-1.5 mb-3">
                    ${[10,25,50,100,Math.floor(n)].map(l=>`
                        <button class="wager-btn py-2 text-xs font-bold rounded-lg transition-all ${E.wager===l?"bg-amber-500/25 border border-amber-500/60 text-amber-400":"bg-zinc-800/60 border border-zinc-700/50 text-zinc-400 hover:border-amber-500/30"}" data-value="${l}">
                            ${l===Math.floor(n)?"MAX":l}
                        </button>
                    `).join("")}
                </div>
            ...
            <div class="flex gap-3">
                <button id="btn-quick-play" class="flex-1 py-3.5 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 font-bold rounded-xl transition-colors border border-zinc-700 ${!s||!c.isConnected?"opacity-40 cursor-not-allowed":""}" ${!s||!c.isConnected?"disabled":""}>
                    <i class="fa-solid fa-bolt text-amber-400 mr-2"></i>Lucky Pick
                </button>
                <button id="btn-play" class="flex-1 py-3.5 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-black font-bold rounded-xl transition-all ${!s||!c.isConnected?"opacity-40 cursor-not-allowed":""}" ${!s||!c.isConnected?"disabled":""}>
    ...
    `,mn(),Jm(a,n)}function mn(){const e=document.getElementById("picker-area");e&&(E.mode==="jackpot"?qm(e):Xm(e))}function qm(e){var r,o,l,d,u;const t=ue[2],a=E.guess;e.innerHTML=`
        ...
        <div class="flex justify-center gap-1.5 flex-wrap">
            ${[7,13,21,50,77,99,137].map(m=>`
                <button class="jp-quick px-2 py-1.5 bg-zinc-800 hover:bg-zinc-700 text-zinc-400 hover:text-white text-xs rounded-lg transition-all" data-num="${m}">${m}</button>
            `).join("")}
    ...
    `;const n=document.getElementById("jp-number"),s=document.getElementById("jp-slider"),i=m=>{if(m=Math.max(1,Math.min(Ae,m)),E.guess=m,n&&(n.value=m),s){s.value=m;const p=m/Ae*100;s.style.background=`linear-gradient(to right, ${ue[2].hex} 0%, ${ue[2].hex} ${p}%, #27272a ${p}%, #27272a 100%)`}};n==null||n.addEventListener("input",m=>i(parseInt(m.target.value)||1)),n==null||n.addEventListener("blur",m=>i(parseInt(m.target.value)||1)),s==null||s.addEventListener("input",m=>i(parseInt(m.target.value))),(r=e.querySelector(".jp-minus"))==null||r.addEventListener("click",()=>i(E.guess-1)),(o=e.querySelector(".jp-plus"))==null||o.addEventListener("click",()=>i(E.guess+1)),(l=e.querySelector(".jp-minus-10"))==null||l.addEventListener("click",()=>i(E.guess-10)),(d=e.querySelector(".jp-plus-10"))==null||d.addEventListener("click",()=>i(E.guess+10)),e.querySelectorAll(".jp-quick").forEach(m=>{m.addEventListener("click",()=>i(parseInt(m.dataset.num)))}),(u=document.getElementById("jp-random"))==null||u.addEventListener("click",()=>{i(Math.floor(Math.random()*Ae)+1)})}function Xm(e){var s,i,r,o,l;const t=ue[E.comboStep],a=E.guesses[E.comboStep];e.innerHTML=`
        <!-- Step Progress -->
        <div class="flex justify-center gap-2 mb-4">
            ${ue.map((d,u)=>{const m=u===E.comboStep,p=u<E.comboStep;return`
                    <button class="combo-step-btn flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl border transition-all ${m?`bg-gradient-to-br ${d.bgFrom} ${d.bgTo} ${d.borderColor}`:p?"bg-emerald-500/10 border-emerald-500/50 cursor-pointer hover:bg-emerald-500/20":"bg-zinc-800/50 border-zinc-700/50"}" data-step="${u}">
                        <span class="text-lg">${p?"✓":d.emoji}</span>
                        <div class="text-left">
                            <p class="text-[10px] font-bold ${m?d.textColor:p?"text-emerald-400":"text-zinc-500"}">${d.name}</p>
    ...
    `;const n=document.getElementById("combo-picker-content");if(n){if(t.range<=15)n.innerHTML=`
        ...
        `,n.querySelectorAll(".num-btn").forEach(d=>{d.addEventListener("click",()=>{const u=parseInt(d.dataset.num);E.guesses[E.comboStep]=u,n.querySelectorAll(".num-btn").forEach(m=>{const p=parseInt(m.dataset.num);m.className=`num-btn w-11 h-11 rounded-xl font-bold text-base transition-all ${p===u?`bg-gradient-to-br ${t.bgFrom} ${t.bgTo} border-2 ${t.borderColor} ${t.textColor}`:"bg-zinc-800/60 border border-zinc-700/50 text-zinc-400 hover:border-zinc-600"}`})})});else{n.innerHTML=`
            <div class="flex items-center justify-center gap-3 mb-3">
        ...
        `;const d=document.getElementById("combo-input"),u=document.getElementById("combo-slider"),m=p=>{if(p=Math.max(1,Math.min(t.range,p)),E.guesses[E.comboStep]=p,d&&(d.value=p),u){u.value=p;const g=p/t.range*100;u.style.background=`linear-gradient(to right, ${t.hex} 0%, ${t.hex} ${g}%, #27272a ${g}%, #27272a 100%)`}};d==null||d.addEventListener("input",p=>m(parseInt(p.target.value)||1)),d==null||d.addEventListener("blur",p=>m(parseInt(p.target.value)||1)),u==null||u.addEventListener("input",p=>m(parseInt(p.target.value))),(s=n.querySelector(".ch-minus"))==null||s.addEventListener("click",()=>m(E.guesses[E.comboStep]-1)),(i=n.querySelector(".ch-plus"))==null||i.addEventListener("click",()=>m(E.guesses[E.comboStep]+1)),n.querySelectorAll(".ch-quick").forEach(p=>{p.addEventListener("click",()=>m(parseInt(p.dataset.num)))}),(r=n.querySelector(".ch-random"))==null||r.addEventListener("click",()=>{m(Math.floor(Math.random()*t.range)+1)})}e.querySelectorAll(".combo-step-btn").forEach(d=>{d.addEventListener("click",()=>{const u=parseInt(d.dataset.step);u<E.comboStep&&(E.comboStep=u,mn())})}),(o=document.getElementById("combo-prev"))==null||o.addEventListener("click",()=>{E.comboStep>0&&(E.comboStep--,mn())}),(l=document.getElementById("combo-next"))==null||l.addEventListener("click",()=>{E.comboStep<2&&(E.comboStep++,mn())})}}function Jm(e,t){var n,s,i,r,o,l,d,u;(n=document.getElementById("tab-jackpot"))==null||n.addEventListener("click",()=>{E.mode!=="jackpot"&&(E.mode="jackpot",Ne())}),(s=document.getElementById("tab-combo"))==null||s.addEventListener("click",()=>{E.mode!=="combo"&&(E.mode="combo",E.comboStep=0,Ne())});const a=m=>{const g=E.mode==="jackpot"?pn:un;E.wager=Math.max(1,Math.min(Math.floor(m),Math.floor(t)));const b=document.getElementById("custom-wager"),w=document.getElementById("potential-win");b&&(b.value=E.wager),w&&(w.textContent=(E.wager*g).toLocaleString()+" BKC"),document.querySelectorAll(".wager-btn").forEach(y=>{const C=parseInt(y.dataset.value);y.className=`wager-btn py-2 text-xs font-bold rounded-lg transition-all ${E.wager===C?"bg-amber-500/25 border border-amber-500/60 text-amber-400":"bg-zinc-800/60 border border-zinc-700/50 text-zinc-400 hover:border-amber-500/30"}`})};document.querySelectorAll(".wager-btn").forEach(m=>{m.addEventListener("click",()=>a(parseInt(m.dataset.value)||1))}),(i=document.getElementById("custom-wager"))==null||i.addEventListener("input",m=>a(parseInt(m.target.value)||1)),(r=document.getElementById("wager-minus"))==null||r.addEventListener("click",()=>a(E.wager-1)),(o=document.getElementById("wager-plus"))==null||o.addEventListener("click",()=>a(E.wager+1)),(l=document.getElementById("btn-faucet"))==null||l.addEventListener("click",async()=>{var m;x("Requesting tokens...","info");try{let p=!1;try{const g=await fetch(`/api/faucet?address=${c.userAddress}`),b=await g.json();g.ok&&b.success&&(p=!0)}catch{}if(!p){const{FaucetTx:g}=await O(async()=>{const{FaucetTx:b}=await Promise.resolve().then(()=>Jc);return{FaucetTx:b}},void 0);await g.claimOnChain({onSuccess:()=>{p=!0}})}p&&(x("Tokens received!","success"),await jn(),Ne())}catch(p){x((m=p.message)!=null&&m.includes("cooldown")?p.message:"Faucet unavailable","error")}}),(d=document.getElementById("btn-quick-play"))==null||d.addEventListener("click",()=>{if(!c.isConnected)return x("Connect wallet first","warning");if(E.wager<1)return x("Min: 1 BKC","warning");E.mode==="jackpot"?E.guess=Math.floor(Math.random()*Ae)+1:E.guesses=ue.map(m=>Math.floor(Math.random()*m.range)+1),nl()}),(u=document.getElementById("btn-play"))==null||u.addEventListener("click",()=>{if(!c.isConnected)return x("Connect wallet first","warning");if(E.wager<1)return x("Min: 1 BKC","warning");nl()})}async function nl(){E.phase="processing",Ne();try{const e=E.mode==="jackpot"?[E.guess]:E.guesses,t=E.mode==="combo"?7:4,a=window.ethers.parseEther(E.wager.toString());await is.playGame({wagerAmount:a,guesses:e,tierMask:t,button:document.getElementById("btn-play"),onSuccess:n=>{E.gameId=(n==null?void 0:n.gameId)||Date.now(),E.commitment={hash:null,userSecret:(n==null?void 0:n.userSecret)||null,commitBlock:(n==null?void 0:n.commitBlock)||null,commitTxHash:(n==null?void 0:n.txHash)||null,revealDelay:E.commitment.revealDelay||5,waitStartTime:Date.now(),canReveal:!1},E.txHash=(n==null?void 0:n.txHash)||null,console.log("[FortunePool] Game committed:",E.gameId,"Block:",E.commitment.commitBlock),E.phase="waiting",Ne(),od()},onError:n=>{n.cancelled||x(n.message||"Commit failed","error"),E.phase="play",Ne()}})}catch(e){console.error("Commit error:",e),x("Error: "+(e.message||"Transaction failed"),"error"),E.phase="play",Ne()}}function Zm(e){const t=E.mode==="jackpot",a=t?[E.guess]:E.guesses,n=t?[ue[2]]:ue;e.innerHTML=`
        <div class="bg-gradient-to-br from-zinc-900 to-zinc-800/50 border border-zinc-700/50 rounded-2xl p-6 processing-pulse">
            ...
            <div class="border-t border-zinc-700/50 pt-4">
                ...
                <div class="flex justify-center gap-4">
                    ${n.map((s,i)=>{const r=t?a[0]:a[i];return`
                            <div class="w-14 h-14 rounded-xl bg-gradient-to-br ${s.bgFrom} ${s.bgTo} border-2 ${s.borderColor} flex items-center justify-center">
                                <span class="text-xl font-black ${s.textColor}">${r}</span>
                            </div>
                        `}).join("")}
                </div>
            </div>
        </div>
    `,n.forEach((s,i)=>{const r=document.getElementById(`spin-${i}`);r&&setInterval(()=>{r.textContent=Math.floor(Math.random()*s.range)+1},80)})}function Qm(e){var l;const t=E.mode==="jackpot",a=t?[E.guess]:E.guesses,n=t?[ue[2]]:ue,s=Date.now()-(E.commitment.waitStartTime||Date.now()),i=E.commitment.revealDelay*rd,r=Math.max(0,i-s),o=Math.ceil(r/1e3);e.innerHTML=`
        <div class="bg-gradient-to-br from-violet-900/30 to-purple-900/20 border border-violet-500/30 rounded-2xl p-6 waiting-glow">
            ...
            ${E.commitment.commitTxHash?`
                <div class="text-center mt-3">
                    <a href="${to}${E.commitment.commitTxHash}" target="_blank"
    ...
    `,(l=document.getElementById("btn-reveal"))==null||l.addEventListener("click",()=>{E.commitment.canReveal&&Zs()}),ao()}function ao(){if(E.phase!=="waiting")return;const e=document.getElementById("countdown-timer"),t=document.getElementById("progress-bar");if(!e)return;const a=Date.now()-(E.commitment.waitStartTime||Date.now()),n=E.commitment.revealDelay*rd,s=Math.max(0,n-a),i=Math.ceil(s/1e3);i>0?e.textContent=`~${i}s`:E.commitment.canReveal?e.textContent="Ready!":e.textContent="Verifying on chain...",t&&(t.style.width=`${Math.min(100,a/n*100)}%`),E.phase==="waiting"&&setTimeout(ao,1e3)}function od(){Fe&&clearInterval(Fe),setTimeout(ao,100),Fe=setInterval(async()=>{if(E.phase!=="waiting"){clearInterval(Fe);return}try{await ef()&&!E.commitment.canReveal&&(E.commitment.canReveal=!0,clearInterval(Fe),Fe=null,console.log("[FortunePool] canReveal=true, starting auto-reveal..."),tf())}catch(e){console.warn("Reveal check error:",e)}},Hm)}async function ef(){if(!c.fortunePoolContractPublic||!E.gameId)return!1;try{const e=await c.fortunePoolContractPublic.getGameStatus(E.gameId);if(!E.commitment.commitBlock)try{const t=await c.fortunePoolContractPublic.getGame(E.gameId),a=Number(t.commitBlock);a>0&&(E.commitment.commitBlock=a)}catch{}return e.canReveal===!0}catch{return Date.now()-(E.commitment.waitStartTime||Date.now())>=1e4}}async function tf(){if(E.phase!=="waiting")return;const e=document.getElementById("countdown-timer"),t=document.getElementById("btn-reveal"),a=document.getElementById("reveal-btn-text");e&&(e.textContent="Revealing..."),t&&(t.disabled=!0,t.classList.remove("bg-zinc-800","text-zinc-500","cursor-not-allowed"),t.classList.add("bg-gradient-to-r","from-amber-500","to-yellow-500","text-white")),a&&(a.textContent="Auto-revealing...");const n=E.mode==="jackpot"?[E.guess]:E.guesses,s=5,i=2e3;await new Promise(r=>setTimeout(r,3e3));for(let r=1;r<=s;r++){if(E.phase!=="waiting")return;try{const o=c.fortunePoolContractPublic;o&&await o.revealPlay.staticCall(E.gameId,n,E.commitment.userSecret,{from:c.userAddress}),console.log(`[FortunePool] Pre-simulation passed (attempt ${r})`),Zs();return}catch(o){const l=o.message||"",d=l.includes("0x92555c0e")||l.includes("BlockhashUnavailable");if(d&&r<s)console.log(`[FortunePool] BlockhashUnavailable, retry in ${i}ms (${r}/${s})`),e&&(e.textContent="Syncing block data..."),await new Promise(u=>setTimeout(u,i));else if(d){console.warn("[FortunePool] Pre-sim retries exhausted, enabling manual button"),af();return}else{console.log("[FortunePool] Pre-sim error (non-blockhash), trying direct reveal:",l),Zs();return}}}}function af(){const e=document.getElementById("btn-reveal"),t=document.getElementById("reveal-btn-text"),a=document.getElementById("countdown-timer");a&&(a.textContent="Ready!"),e&&(e.disabled=!1,e.classList.remove("bg-zinc-800","text-zinc-500","cursor-not-allowed","from-amber-500","to-yellow-500"),e.classList.add("bg-gradient-to-r","from-emerald-500","to-green-500","text-white")),t&&(t.textContent="Reveal & Get Result!")}async function Zs(){if(!E.commitment.canReveal){x("Not ready to reveal yet!","warning");return}const e=document.getElementById("btn-reveal");try{const t=E.mode==="jackpot"?[E.guess]:E.guesses;await is.revealPlay({gameId:E.gameId,guesses:t,userSecret:E.commitment.userSecret,button:e,onSuccess:(a,n)=>{Fe&&clearInterval(Fe),E.txHash=a.hash,E.result={rolls:(n==null?void 0:n.rolls)||[],prizeWon:(n==null?void 0:n.prizeWon)||0n,matches:(n==null?void 0:n.matches)||[],matchCount:(n==null?void 0:n.matchCount)||0},console.log("[FortunePool] Game revealed:",E.result),E.phase="result",Ne(),no()},onError:a=>{if(!a.cancelled){const n=a.message||"";n.includes("0x92555c0e")||n.includes("BlockhashUnavailable")?x("Block data not available yet. Will retry automatically.","warning"):x(n||"Reveal failed","error")}e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-dice mr-2"></i>Try Again')}})}catch(t){console.error("Reveal error:",t),x("Reveal failed: "+(t.message||"Unknown error"),"error"),e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-dice mr-2"></i>Try Again')}}function nf(e){var p,g;const t=E.result;if(!t)return Ne();const a=E.mode==="jackpot",n=a?[E.guess]:E.guesses,s=t.rolls||[],i=a?[ue[2]]:ue,r=n.map((b,w)=>{const y=s[w]!==void 0?Number(s[w]):null;return y!==null&&y===b}),o=r.filter(b=>b).length,l=t.prizeWon>0||o>0;let d=0;t.prizeWon&&t.prizeWon>0n?d=M(BigInt(t.prizeWon)):o>0&&r.forEach((b,w)=>{if(b){const y=a?ue[2]:ue[w];d+=E.wager*y.multiplier}});const u=typeof d=="number"?d.toLocaleString(void 0,{maximumFractionDigits:2}):d.toLocaleString();e.innerHTML=`
        <div class="bg-gradient-to-br ${l?"from-emerald-900/30 to-green-900/10 border-emerald-500/30":"from-zinc-900 to-zinc-800/50 border-zinc-700/50"} border rounded-2xl p-5 relative overflow-hidden" id="result-container">
            ...
            <div class="grid ${a?"grid-cols-1 max-w-[220px] mx-auto":"grid-cols-3"} gap-3 mb-4">
                ${i.map((b,w)=>{const y=a?n[0]:n[w],C=s[w],I=r[w];return`
                        <div class="text-center p-3 rounded-xl ${I?"bg-emerald-500/20 border border-emerald-500/50":"bg-zinc-800/50 border border-zinc-700/50"}" id="result-tier-${w}">
                            ...
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="w-12 h-12 rounded-lg ${I?"bg-emerald-500/30 border-emerald-500":"bg-zinc-700/50 border-zinc-600"} border flex items-center justify-center overflow-hidden">
                                        <span class="text-xl font-black ${I?"text-emerald-400":"text-zinc-300"}" id="roll-num-${w}" style="opacity: 0">${C!==void 0?C:"?"}</span>
                                    </div>
                                </div>
                            </div>
                            ${I?`<p class="text-emerald-400 text-xs font-bold mt-1" id="match-label-${w}" style="opacity: 0">+${b.multiplier}x</p>`:""}
                        </div>
                    `}).join("")}
            </div>
            ...
            ${E.txHash?`
                <div class="text-center mb-3">
                    <a href="${to}${E.txHash}" target="_blank" class="inline-flex items-center gap-2 text-xs text-zinc-500 hover:text-zinc-400">
    ...
    `,i.forEach((b,w)=>{const y=600+w*800;setTimeout(()=>{const C=document.getElementById(`roll-num-${w}`),I=document.getElementById(`match-icon-${w}`),z=document.getElementById(`match-label-${w}`),L=document.getElementById(`result-tier-${w}`);C&&(C.style.opacity="1",C.classList.add("reel-land")),I&&(I.style.opacity="1",I.className=`text-xl ${r[w]?"text-emerald-400":"text-red-400"}`),setTimeout(()=>{L&&L.classList.add(r[w]?"match-pulse":"miss-shake"),z&&(z.style.opacity="1")},400)},y)});const m=600+i.length*800+500;l&&setTimeout(()=>{sf(),d>E.wager*10&&rf()},m),(p=document.getElementById("btn-new-game"))==null||p.addEventListener("click",()=>{E.phase="play",E.result=null,E.txHash=null,E.gameId=null,Ne(),no()}),(g=document.getElementById("btn-share"))==null||g.addEventListener("click",()=>{of(l,d)})}function sf(){const e=document.createElement("div");e.className="confetti-container",document.body.appendChild(e);const t=["#f59e0b","#10b981","#8b5cf6","#ec4899","#06b6d4"],a=["●","■","★","🐯","🎉"];for(let n=0;n<60;n++){const s=document.createElement("div");s.className="confetti",s.style.cssText=`
            left: ${Math.random()*100}%;
            color: ${t[n%t.length]};
            font-size: ${8+Math.random()*12}px;
            animation-delay: ${Math.random()*2}s;
            animation-duration: ${2+Math.random()*2}s;
        `,s.textContent=a[n%a.length],e.appendChild(s)}setTimeout(()=>e.remove(),5e3)}function rf(){const e=["🪙","💰","✨","⭐","🎉"];for(let t=0;t<30;t++)setTimeout(()=>{const a=document.createElement("div");a.className="coin",a.textContent=e[Math.floor(Math.random()*e.length)],a.style.left=`${Math.random()*100}%`,a.style.animationDelay=`${Math.random()*.5}s`,a.style.animationDuration=`${2+Math.random()*2}s`,document.body.appendChild(a),setTimeout(()=>a.remove(),4e3)},t*100)}function of(e,t){var l,d,u,m,p,g;const a=tl[xa],n=()=>{const b=Um[xa];return e?b.win(t):b.lose},s=`
        <div class="text-center">
            ...
            <div class="flex justify-center gap-2 mb-4">
                ${["pt","en","es"].map(b=>`
                    <button class="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${xa===b?"bg-amber-500/20 border-amber-500 ring-1 ring-amber-500/50":"bg-zinc-800 border-zinc-700 hover:border-zinc-500"} border" data-lang="${b}">
                        <img src="${jm[b]}" class="w-5 h-5 rounded-full object-cover" alt="${b.toUpperCase()}">
                        <span class="${xa===b?"text-amber-400":"text-zinc-400"}">${b.toUpperCase()}</span>
                    </button>
                `).join("")}
            </div>
    ...
    `;za(s,"max-w-xs");const i=b=>{xa=b;const w=tl[b],y=document.getElementById("share-modal-title"),C=document.getElementById("share-modal-subtitle"),I=document.getElementById("btn-close-share");y&&(y.textContent=w.title),C&&(C.textContent=w.subtitle),I&&(I.textContent=w.later),document.querySelectorAll(".lang-btn").forEach(z=>{const L=z.dataset.lang,B=z.querySelector("span");L===b?(z.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-amber-500/20 border-amber-500 ring-1 ring-amber-500/50 border",B&&(B.className="text-amber-400")):(z.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-zinc-800 border-zinc-700 hover:border-zinc-500 border",B&&(B.className="text-zinc-400"))})};document.querySelectorAll(".lang-btn").forEach(b=>{b.addEventListener("click",()=>i(b.dataset.lang))});const r=async b=>{if(!c.userAddress)return!1;try{const y=await(await fetch("https://us-central1-backchain-backand.cloudfunctions.net/trackShare",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({address:c.userAddress,gameId:E.gameId||Date.now(),type:"fortune",platform:b})})).json();return y.success?(x(`+${y.pointsAwarded||ea} Airdrop Points!`,"success"),!0):!1}catch{return x(`+${ea} Airdrop Points!`,"success"),!0}},o=async(b,w)=>{await r(b),window.open(w,"_blank"),Pe()};(l=document.getElementById("share-twitter"))==null||l.addEventListener("click",()=>{o("twitter",`https://twitter.com/intent/tweet?text=${encodeURIComponent(n())}`)}),(d=document.getElementById("share-telegram"))==null||d.addEventListener("click",()=>{o("telegram",`https://t.me/share/url?url=https://backcoin.org&text=${encodeURIComponent(n())}`)}),(u=document.getElementById("share-whatsapp"))==null||u.addEventListener("click",()=>{o("whatsapp",`https://wa.me/?text=${encodeURIComponent(n())}`)}),(m=document.getElementById("share-instagram"))==null||m.addEventListener("click",async()=>{const b=n();try{await navigator.clipboard.writeText(b),await r("instagram"),Pe(),setTimeout(()=>{var y,C;za(`
                ...
                `,"max-w-xs"),(y=document.getElementById("btn-open-ig"))==null||y.addEventListener("click",()=>{window.open("https://www.instagram.com/backcoin.bkc/","_blank"),Pe()}),(C=document.getElementById("btn-close-ig"))==null||C.addEventListener("click",Pe)},100)}catch{x("Could not copy text","error"),Pe()}}),(p=document.getElementById("share-copy"))==null||p.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(n()),x("Copied!","success"),await r("copy")}catch{x("Copy failed","error")}Pe()}),(g=document.getElementById("btn-close-share"))==null||g.addEventListener("click",Pe)}async function lf(){const e=c.fortunePoolContract||c.fortunePoolContractPublic;if(!e)return null;try{const[t,a,n]=await Promise.all([e.prizePool().catch(()=>0n),e.gameCounter().catch(()=>0),e.TIER_COUNT().catch(()=>3)]);let s=0n,i=0n,r=0n;try{s=await e.getRequiredFee(1),i=await e.getRequiredFee(7),r=s,console.log(`Service fees: single=${Number(s)/1e18} ETH, all=${Number(i)/1e18} ETH`)}catch(l){console.log("getRequiredFee failed:",l.message)}E.serviceFee=r,E.serviceFee1x=s,E.serviceFee5x=i;try{const l=await e.REVEAL_DELAY();E.commitment.revealDelay=Number(l)||5}catch{}try{const[l,d,u]=await e.getAllTiers();E.tiersData=l.map((m,p)=>({range:Number(m),multiplier:Number(d[p])/1e4,winChance:Number(u[p])/1e4}))}catch{}let o=0n;try{const l=await e.getPoolStats();o=l.maxPayoutNow||l[6]||0n}catch{}return{prizePool:t||0n,gameCounter:Number(a)||0,serviceFee:r,serviceFee1x:s,serviceFee5x:i,tierCount:Number(n)||3,maxPayout:o}}catch(t){return console.error("getFortunePoolStatus error:",t),{prizePool:0n,gameCounter:0,serviceFee:0n,maxPayout:0n}}}async function no(){try{const e=await lf();if(e){const a=document.getElementById("prize-pool"),n=document.getElementById("total-games"),s=document.getElementById("max-payout");a&&(a.textContent=M(e.prizePool||0n).toFixed(2)+" BKC"),n&&(n.textContent=(e.gameCounter||0).toLocaleString()),s&&e.maxPayout&&(s.textContent=M(e.maxPayout).toFixed(2)+" BKC")}const t=document.getElementById("user-balance");t&&(t.textContent=M(c.currentUserBalance||0n).toFixed(2)+" BKC"),cf()}catch(e){console.error("Pool error:",e)}}async function cf(){var e;try{const t=qe.fortuneGames||"https://getfortunegames-4wvdcuoouq-uc.a.run.app",a=c.userAddress?`${t}?player=${c.userAddress}&limit=15`:`${t}?limit=15`,s=await(await fetch(a)).json();if(((e=s.games)==null?void 0:e.length)>0){df(s.games);const i=s.games.filter(o=>o.isWin||o.prizeWon&&BigInt(o.prizeWon)>0n).length,r=document.getElementById("win-rate");r&&(r.textContent=`${i}/${s.games.length} wins`)}else{const i=document.getElementById("history-list");i&&(i.innerHTML=`
            ...
            `)}}catch(t){console.error("loadHistory error:",t)}}function df(e){const t=document.getElementById("history-list");t&&(t.innerHTML=e.map(a=>{var b;const n=a.isWin||a.prizeWon&&BigInt(a.prizeWon)>0n,s=a.prizeWon?M(BigInt(a.prizeWon)):0,i=a.wagerAmount?M(BigInt(a.wagerAmount)):0,r=a.isCumulative,o=a.rolls||[],l=a.guesses||[],d=a.txHash||a.transactionHash,u=uf(a.timestamp||a.createdAt),m=a.player?`${a.player.slice(0,6)}...${a.player.slice(-4)}`:"???",p=c.userAddress&&((b=a.player)==null?void 0:b.toLowerCase())===c.userAddress.toLowerCase(),g=d?`${to}${d}`:null;return`
               ...
               ${g?"":'onclick="return false;"'}>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex gap-1">
                        ${(r?ue:[ue[2]]).map((w,y)=>{const C=l[y],I=o[y];return`
    ...
    `,document.head.appendChild(e)}async function ma(){var e;N.isConnected=c.isConnected,N.user=null,N.userSubmissions=[],N.platformUsage={},N.isBanned=!1;try{const t=await ci();if(N.systemConfig=t.config,N.leaderboards=t.leaderboards,N.dailyTasks=t.dailyTasks||[],N.platformUsageConfig=t.platformUsageConfig||cd,N.isConnected&&c.userAddress){const[a,n]=await Promise.all([wa(c.userAddress),Ru()]);if(N.user=a,N.userSubmissions=n,a&&a.isBanned){N.isBanned=!0;return}try{typeof $o=="function"&&(N.platformUsage=await $o()||{})}catch(s){console.warn("Could not load platform usage:",s),N.platformUsage={}}N.dailyTasks.length>0&&(N.dailyTasks=await Promise.all(N.dailyTasks.map(async s=>{try{if(!s.id)return{...s,eligible:!1,timeLeftMs:0};const i=await tc(s.id,s.cooldownHours);return{...s,eligible:i.eligible,timeLeftMs:i.timeLeft}}catch{return{...s,eligible:!1,timeLeftMs:0}}})))}}catch(t){if(console.error("Airdrop Data Load Error:",t),t.code==="permission-denied"||(e=t.message)!=null&&e.includes("permission")){console.warn("Firebase permissions issue - user may need to connect wallet or sign in"),N.systemConfig=N.systemConfig||{},N.leaderboards=N.leaderboards||{top100ByPoints:[],top100ByPosts:[]},N.dailyTasks=N.dailyTasks||[];return}x("Error loading data. Please refresh.","error")}}function zf(e){if(!N.user||!e||e.length===0)return null;const t=e.findIndex(a=>{var n,s;return((n=a.walletAddress)==null?void 0:n.toLowerCase())===((s=N.user.walletAddress)==null?void 0:s.toLowerCase())});return t>=0?t+1:null}function Bf(e){return e?e<=5?xt[0]:e<=25?xt[1]:e<=75?xt[2]:e<=200?xt[3]:null:null}function dd(){var l;const{user:e}=N,t=(e==null?void 0:e.totalPoints)||0,a=(e==null?void 0:e.platformUsagePoints)||0,n=(e==null?void 0:e.approvedSubmissionsCount)||0,s=Af(n),i=((l=N.leaderboards)==null?void 0:l.top100ByPosts)||[],r=zf(i),o=Bf(r);return`
        <!-- Mobile Header -->
        <div class="md:hidden px-4 pt-4 pb-2">
            <div class="flex items-center justify-between mb-3">
                <div class="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <span class="text-[9px] text-zinc-500">${sa} NFTs • 4 Tiers</span>
                    </div>
                </div>
            ...
            <div class="flex gap-1 bg-zinc-900/80 p-1 rounded-2xl border border-zinc-800">
                ${zs("earn","fa-coins","Earn")}
                ${zs("history","fa-clock-rotate-left","History")}
                ${zs("leaderboard","fa-trophy","Ranking")}
            </div>
        </div>
        ...
        <div class="hidden md:block px-4 pt-6 pb-4">
            <div class="flex items-center justify-between mb-5">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-zinc-500 text-sm">${sa} NFT Boosters • 4 Reward Tiers</p>
                    </div>
                </div>
            ...
            <div class="flex justify-center">
                <div class="bg-zinc-900/80 p-1.5 rounded-full border border-zinc-800 inline-flex gap-1">
                    ${Bs("earn","fa-coins","Earn Points")}
                    ${Bs("history","fa-clock-rotate-left","My History")}
                    ${Bs("leaderboard","fa-trophy","Ranking")}
                </div>
            </div>
        </div>
    `}function zs(e,t,a){const n=N.activeTab===e;return`
    ...
    `}function Bs(e,t,a){const n=N.activeTab===e;return`
        <button data-target="${e}" 
    ...
    `}function Ns(){return N.isConnected?`
        <div class="px-4 airdrop-fade-up">
            <!-- Earn Sub-Navigation -->
            <div class="flex gap-2 mb-4">
                <button data-earn-tab="post" class="earn-tab-btn flex-1 py-2 px-3 rounded-lg text-xs font-medium border border-zinc-700 flex items-center justify-center gap-1.5 ${N.activeEarnTab==="post"?"active":"text-zinc-400"}">
                    <i class="fa-solid fa-share-nodes"></i> Post & Share
                </button>
                <button data-earn-tab="platform" class="earn-tab-btn flex-1 py-2 px-3 rounded-lg text-xs font-medium border border-zinc-700 flex items-center justify-center gap-1.5 ${N.activeEarnTab==="platform"?"active":"text-zinc-400"}">
                    <i class="fa-solid fa-gamepad"></i> Use Platform
                </button>
                <button data-earn-tab="tasks" class="earn-tab-btn flex-1 py-2 px-3 rounded-lg text-xs font-medium border border-zinc-700 flex items-center justify-center gap-1.5 ${N.activeEarnTab==="tasks"?"active":"text-zinc-400"}">
            ...
            <!-- Sub-tab Content -->
            <div id="earn-content">
                ${N.activeEarnTab==="post"?Nf():""}
                ${N.activeEarnTab==="platform"?$f():""}
                ${N.activeEarnTab==="tasks"?Sf():""}
            </div>
        </div>
    `:`
            <div class="text-center px-4 py-12 airdrop-fade-up">
                ...
                <div class="max-w-xs mx-auto bg-zinc-900/60 border border-zinc-800 rounded-xl p-3">
                    <p class="text-zinc-500 text-[10px] uppercase tracking-wider mb-2">Win 1 of ${sa} NFT Boosters</p>
                    <div class="flex justify-center gap-3 text-lg">
                        ${xt.map(e=>`<span title="${e.name}">${e.icon}</span>`).join("")}
                    </div>
                </div>
            </div>
        `}function Nf(){const{user:e}=N,a=`https://backcoin.org/?ref=${(e==null?void 0:e.referralCode)||"CODE"}`;return`
        <div class="space-y-4">
                ...
                <div class="space-y-5">
                    ...
                    <div class="flex gap-3 items-start relative">
                        ...
                        <div class="flex-1 pb-2">
                            ...
                            <div class="bg-black/40 p-2.5 rounded-lg border border-zinc-700/50 mb-2">
                                ...
                                <p class="text-xs font-mono text-zinc-600 mt-1">${ei}</p>
                            </div>
                    ...
                    <div class="flex gap-3 items-start relative">
                        ...
                        <div class="flex-1 pb-2">
                            ...
                            <div class="grid grid-cols-4 gap-2">
                                <a href="https://twitter.com/intent/tweet?text=${encodeURIComponent(a+" "+ei)}" target="_blank" 
            ...
            <div class="bg-zinc-900/60 border border-zinc-800 rounded-xl p-4">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <span class="text-[10px] text-zinc-600">${sa} total</span>
                </div>
    ...
    `}function $f(){var r;const e=N.platformUsageConfig||cd,t=N.platformUsage||{};let a=0,n=0;Object.keys(e).forEach(o=>{var l;e[o].enabled!==!1&&e[o].maxCount&&(a+=e[o].maxCount,n+=Math.min(((l=t[o])==null?void 0:l.count)||0,e[o].maxCount))});const s=a>0?n/a*100:0,i=((r=N.user)==null?void 0:r.platformUsagePoints)||0;return`
        <div class="space-y-4">
            <!-- Info Banner -->
            ...
            <div class="grid grid-cols-2 gap-2" id="platform-actions-grid">
                ${Object.entries(e).filter(([o,l])=>l.enabled!==!1).map(([o,l])=>{const d=t[o]||{count:0},u=d.count>=l.maxCount,m=Math.max(0,l.maxCount-d.count),p=d.count/l.maxCount*100,g=Tf[o]||"";return`
    ...
    `}function Sf(){const e=N.dailyTasks||[],t=e.filter(n=>n.eligible),a=e.filter(n=>!n.eligible&&n.timeLeftMs>0);return`
        <div class="space-y-4">
            <!-- Info Banner -->
    ...
    `}function Lf(){const{user:e,userSubmissions:t}=N;if(!N.isConnected)return`
            <div class="text-center px-4 py-12 airdrop-fade-up">
        ...
        `;const a=Date.now(),n=ld*60*60*1e3,s=t.filter(l=>["pending","auditing"].includes(l.status)&&l.submittedAt&&a-l.submittedAt.getTime()>=n),i=(e==null?void 0:e.approvedSubmissionsCount)||0,r=t.filter(l=>["pending","auditing"].includes(l.status)).length,o=t.filter(l=>l.status==="rejected").length;return`
    ...
    `}function Rf(){var u,m;const e=((u=N.leaderboards)==null?void 0:u.top100ByPosts)||[],t=((m=N.leaderboards)==null?void 0:m.top100ByPoints)||[],a=N.activeRanking||"posts";function n(p,g,b){var B,A;const w=N.user&&((B=p.walletAddress)==null?void 0:B.toLowerCase())===((A=N.user.walletAddress)==null?void 0:A.toLowerCase()),y=_f(g+1),C=b==="posts"?"bg-amber-500/10":"bg-green-500/10",I=b==="posts"?"text-amber-400":"text-green-400",z=b==="posts"?"text-white":"text-green-400",L=b==="posts"?"posts":"pts";return`
        ...
        <div class="px-4 airdrop-fade-up">
            ...
            <div class="bg-gradient-to-br from-zinc-900 to-zinc-900 border border-amber-500/20 rounded-xl p-4 mb-5 relative overflow-hidden">
                ...
                <div class="flex items-center justify-between mb-3">
                    ...
                    <span class="text-[10px] text-zinc-500 bg-zinc-800 px-2 py-0.5 rounded-full">${sa} NFTs</span>
                </div>
    ...
    `}function _f(e){return e<=5?{icon:"💎",bg:"bg-cyan-500/20 text-cyan-300",tierName:"Diamond",tierTextColor:"text-cyan-400/70"}:e<=25?{icon:"🥇",bg:"bg-yellow-500/20 text-yellow-400",tierName:"Gold",tierTextColor:"text-yellow-400/70"}:e<=75?{icon:"🥈",bg:"bg-gray-400/20 text-gray-300",tierName:"Silver",tierTextColor:"text-gray-400/70"}:e<=200?{icon:"🥉",bg:"bg-amber-600/20 text-amber-500",tierName:"Bronze",tierTextColor:"text-amber-500/70"}:{icon:null,bg:"bg-zinc-800 text-zinc-400",tierName:null,tierTextColor:""}}function Oe(){const e=document.getElementById("main-content"),t=document.getElementById("airdrop-header");if(e){if(t&&(t.innerHTML=dd()),N.isBanned){e.innerHTML=`
        ...
        `;return}switch(document.querySelectorAll(".nav-pill-btn").forEach(a=>{const n=a.dataset.target;a.closest(".md\\:hidden")?n===N.activeTab?(a.classList.add("airdrop-tab-active","shadow-lg"),a.classList.remove("text-zinc-500")):(a.classList.remove("airdrop-tab-active","shadow-lg"),a.classList.add("text-zinc-500")):n===N.activeTab?(a.classList.remove("text-zinc-400","hover:text-white","hover:bg-zinc-800"),a.classList.add("airdrop-tab-active","shadow-lg","shadow-amber-500/20")):(a.classList.add("text-zinc-400","hover:text-white","hover:bg-zinc-800"),a.classList.remove("airdrop-tab-active","shadow-lg","shadow-amber-500/20"))}),N.activeTab){case"earn":e.innerHTML=Ns();break;case"post":e.innerHTML=Ns();break;case"history":e.innerHTML=Lf();break;case"leaderboard":e.innerHTML=Rf();break;default:e.innerHTML=Ns()}}}function Ff(){var a;const e=((a=N.user)==null?void 0:a.referralCode)||"CODE",t=`${e!=="CODE"?`https://backcoin.org/?ref=${e}`:"https://backcoin.org"} ${ei}`;navigator.clipboard.writeText(t).then(()=>{x("Copied! Now paste it in your post.","success");const n=document.getElementById("copy-viral-btn");if(n){const s=n.innerHTML;n.innerHTML='<i class="fa-solid fa-check"></i> Copied!',n.classList.remove("cta-mega"),n.classList.add("bg-green-600"),setTimeout(()=>{n.innerHTML=s,n.classList.add("cta-mega"),n.classList.remove("bg-green-600")},2e3)}}).catch(()=>x("Failed to copy.","error"))}function il(e){const t=e.target.closest(".nav-pill-btn");t&&(N.activeTab=t.dataset.target,Oe())}function Mf(e){const t=e.target.closest(".earn-tab-btn");t&&t.dataset.earnTab&&(N.activeEarnTab=t.dataset.earnTab,Oe())}function Df(e){const t=e.target.closest(".ranking-tab-btn");t&&t.dataset.ranking&&(N.activeRanking=t.dataset.ranking,Oe())}function Of(){N.isGuideOpen=!N.isGuideOpen,Oe()}function ud(e){var s;const t=`
        <div class="text-center">
            <!-- Imagem de CAUTION -->
    ...
    `;za(t,"max-w-md"),(s=document.getElementById("deletePostBtn"))==null||s.addEventListener("click",async i=>{const r=i.currentTarget,o=r.dataset.submissionId;r.disabled=!0,r.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-1"></i> Deleting...';try{await ac(o),x("Post deleted. No penalty applied.","info"),Pe(),await ma(),Oe()}catch(l){x(l.message,"error"),r.disabled=!1,r.innerHTML='<i class="fa-solid fa-trash mr-1"></i> Delete Post'}});const a=document.getElementById("confirmCheckbox"),n=document.getElementById("finalConfirmBtn");a==null||a.addEventListener("change",()=>{a.checked?(n.disabled=!1,n.className="flex-1 bg-green-600 hover:bg-green-500 text-white py-3 rounded-xl font-bold text-sm transition-colors cursor-pointer",n.innerHTML='<i class="fa-solid fa-check mr-1"></i> Confirm & Earn ✓'):(n.disabled=!0,n.className="flex-1 bg-green-600/50 text-green-200 py-3 rounded-xl font-bold text-sm cursor-not-allowed transition-colors",n.innerHTML='<i class="fa-solid fa-lock mr-1"></i> Confirm & Earn')}),n==null||n.addEventListener("click",Hf)}async function Hf(e){const t=e.currentTarget,a=t.dataset.submissionId;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-2"></i> Verifying...';try{await _u(a),x("Success! Points added.","success"),Pe(),await ma(),Oe()}catch{x("Verification failed.","error"),t.disabled=!1,t.innerHTML="Try Again"}}async function Uf(e){const t=e.target.closest(".action-btn");if(!t)return;const a=t.dataset.action,n=t.dataset.id;if(a==="confirm"){const s=N.userSubmissions.find(i=>i.submissionId===n);s&&ud(s)}else if(a==="delete"){if(!confirm("Remove this submission?"))return;try{await ac(n),x("Removed.","info"),await ma(),Oe()}catch(s){x(s.message,"error")}}}async function jf(e){const t=e.target.closest("#submit-content-btn");if(!t)return;const a=document.getElementById("content-url-input"),n=a==null?void 0:a.value.trim();if(!n||!n.startsWith("http"))return x("Enter a valid URL.","warning");const s=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-circle-notch fa-spin"></i>';try{await Lu(n),x("📋 Submitted! Your post is now under security audit.","info"),a.value="",await ma(),N.activeTab="history",Oe()}catch(i){x(i.message,"error")}finally{t.disabled=!1,t.innerHTML=s}}async function Gf(e){const t=e.target.closest(".task-card");if(!t)return;const a=t.dataset.id,n=t.dataset.url;n&&window.open(n,"_blank");const s=N.dailyTasks.find(i=>i.id===a);if(!(!s||!s.eligible))try{await $u(s,N.user.pointsMultiplier),x(`Task completed! +${s.points} pts`,"success"),await ma(),Oe()}catch(i){i.message.includes("Cooldown")||x(i.message,"error")}}function Wf(){const e=Date.now(),t=ld*60*60*1e3,a=N.userSubmissions.filter(n=>["pending","auditing"].includes(n.status)&&n.submittedAt&&e-n.submittedAt.getTime()>=t);a.length>0&&(N.activeTab="history",Oe(),setTimeout(()=>{ud(a[0])},500))}const Kf={async render(e){const t=document.getElementById("airdrop");if(!t)return;Pf();const a=If();(t.innerHTML.trim()===""||e)&&(t.innerHTML=`
                    ...
                    <div class="relative z-10 text-center max-w-sm w-full">
                        ...
                        <div class="bg-zinc-900/50 border border-zinc-800 rounded-xl p-4 mb-6 text-left">
                            <p class="text-zinc-500 text-[10px] uppercase tracking-wider mb-3 text-center">
                                ${sa} NFT Booster Rewards • 4 Tiers
                            </p>
                ...
                <div id="airdrop-main" class="hidden">
                    <div id="airdrop-header">${dd()}</div>
                    <div id="airdrop-body" class="max-w-2xl mx-auto pb-24">
                        <div id="main-content"></div>
                    </div>
                </div>
            `,this.attachListeners());try{const n=new Promise(o=>setTimeout(o,4e3));await Promise.all([ma(),n]);const s=document.getElementById("loading-state"),i=document.getElementById("airdrop-main"),r=document.getElementById("main-content");s&&(s.style.transition="opacity 0.5s ease-out",s.style.opacity="0",await new Promise(o=>setTimeout(o,500)),s.classList.add("hidden")),i&&i.classList.remove("hidden"),r&&(r.classList.remove("hidden"),Oe()),Wf()}catch(n){console.error(n)}},attachListeners(){const e=document.getElementById("airdrop-body"),t=document.getElementById("airdrop-header");t==null||t.addEventListener("click",il),e==null||e.addEventListener("click",a=>{a.target.closest("#guide-toggle-btn")&&Of(),a.target.closest("#submit-content-btn")&&jf(a),a.target.closest(".task-card")&&Gf(a),a.target.closest(".action-btn")&&Uf(a),a.target.closest("#copy-viral-btn")&&Ff(),a.target.closest(".ranking-tab-btn")&&Df(a),a.target.closest(".earn-tab-btn")&&Mf(a),a.target.closest(".nav-pill-btn")&&il(a);const n=a.target.closest(".platform-action-card");if(n&&!n.classList.contains("completed")){const s=n.dataset.targetPage;s&&(console.log("🎯 Navigating to:",s),Yf(s))}})},update(e){N.isConnected!==e&&this.render(!0)}};function Yf(e){console.log("🎯 Platform card clicked, navigating to:",e);const t=document.querySelector(`a[data-target="${e}"]`)||document.querySelector(`[data-target="${e}"]`);if(t){console.log("✅ Found menu link, clicking..."),t.click();const s=document.getElementById("sidebar");s&&window.innerWidth<768&&s.classList.add("hidden");return}const a=document.querySelectorAll("main > section"),n=document.getElementById(e);if(n){console.log("✅ Found section, showing directly..."),a.forEach(i=>i.classList.add("hidden")),n.classList.remove("hidden"),document.querySelectorAll(".sidebar-link").forEach(i=>{i.classList.remove("active","bg-zinc-700","text-white"),i.classList.add("text-zinc-400")});const s=document.querySelector(`[data-target="${e}"]`);s&&(s.classList.add("active","bg-zinc-700","text-white"),s.classList.remove("text-zinc-400"));return}console.warn("⚠️ Could not navigate to:",e)}const pd=window.ethers,Cn="".toLowerCase(),Vf="",md="bkc_admin_auth_v3";window.__ADMIN_WALLET__=Cn;setTimeout(()=>{document.dispatchEvent(new CustomEvent("adminConfigReady")),console.log("✅ Admin config ready, wallet:",Cn?"configured":"not set")},100);function rl(){return sessionStorage.getItem(md)==="true"}function qf(){sessionStorage.setItem(md,"true")}function Xf(){return!c.isConnected||!c.userAddress||!Cn?!1:c.userAddress.toLowerCase()===Cn}const ol={pending:{text:"Pending Review",color:"text-amber-400",bgColor:"bg-amber-900/50",icon:"fa-clock"},auditing:{text:"Auditing",color:"text-blue-400",bgColor:"bg-blue-900/50",icon:"fa-magnifying-glass"},approved:{text:"Approved",color:"text-green-400",bgColor:"bg-green-900/50",icon:"fa-check-circle"},rejected:{text:"Rejected",color:"text-red-400",bgColor:"bg-red-900/50",icon:"fa-times-circle"},flagged_suspicious:{text:"Flagged",color:"text-red-300",bgColor:"bg-red-800/60",icon:"fa-flag"}},bs={faucet:{icon:"🚰",label:"Claim Faucet",points:1e3,maxCount:1,cooldownHours:0,enabled:!0},delegation:{icon:"📊",label:"Delegate BKC",points:2e3,maxCount:10,cooldownHours:24,enabled:!0},fortune:{icon:"🎰",label:"Play Fortune",points:1500,maxCount:10,cooldownHours:1,enabled:!0},buyNFT:{icon:"🛒",label:"Buy NFT",points:2500,maxCount:10,cooldownHours:0,enabled:!0},sellNFT:{icon:"💰",label:"Sell NFT",points:1500,maxCount:10,cooldownHours:0,enabled:!0},listRental:{icon:"🏷️",label:"List for Rent",points:1e3,maxCount:10,cooldownHours:0,enabled:!0},rentNFT:{icon:"⏰",label:"Rent NFT",points:2e3,maxCount:10,cooldownHours:0,enabled:!0},notarize:{icon:"📜",label:"Notarize Doc",points:2e3,maxCount:10,cooldownHours:0,enabled:!0},claimReward:{icon:"💸",label:"Claim Rewards",points:1e3,maxCount:10,cooldownHours:24,enabled:!0},unstake:{icon:"↩️",label:"Unstake",points:500,maxCount:10,cooldownHours:0,enabled:!0}};let P={allSubmissions:[],dailyTasks:[],ugcBasePoints:null,platformUsageConfig:null,editingTask:null,activeTab:"review-submissions",allUsers:[],selectedUserSubmissions:[],isSubmissionsModalOpen:!1,selectedWallet:null,usersFilter:"all",usersSearch:"",usersPage:1,usersPerPage:100,submissionsPage:1,submissionsPerPage:100,tasksPage:1,tasksPerPage:100};const Ca=async()=>{var t;const e=document.getElementById("admin-content-wrapper");if(e){const a=document.createElement("div");e.innerHTML=a.innerHTML}try{c.userAddress&&(await ec(c.userAddress),console.log("✅ Firebase Auth: Admin authenticated"));const[a,n,s,i]=await Promise.all([Hu(),Mu(),ci(),Uu()]);P.allSubmissions=a,P.dailyTasks=n,P.allUsers=i,P.ugcBasePoints=((t=s.config)==null?void 0:t.ugcBasePoints)||{YouTube:5e3,"YouTube Shorts":2500,Instagram:3e3,"X/Twitter":1500,Facebook:2e3,Telegram:1e3,TikTok:3500,Reddit:1800,LinkedIn:2200,Other:1e3},P.platformUsageConfig=s.platformUsageConfig||bs,P.editingTask&&(P.editingTask=n.find(r=>r.id===P.editingTask.id)||null),h0()}catch(a){if(console.error("Error loading admin data:",a),e){const n=document.createElement("div");op(n,`Failed to load admin data: ${a.message}`),e.innerHTML=n.innerHTML}else x("Failed to load admin data.","error")}},so=async()=>{const e=document.getElementById("presale-balance-amount");if(e){e.innerHTML='<span class="loader !w-5 !h-5 inline-block"></span>';try{if(!c.signer||!c.signer.provider)throw new Error("Admin provider not found.");if(!v.publicSale)throw new Error("PublicSale address not configured.");const t=await c.signer.provider.getBalance(v.publicSale),a=pd.formatEther(t);e.textContent=`${parseFloat(a).toFixed(6)} ETH/BNB`}catch(t){console.error("Error loading presale balance:",t),e.textContent="Error"}}},Jf=async e=>{if(!c.signer){x("Por favor, conecte a carteira do Owner primeiro.","error");return}if(!window.confirm("Are you sure you want to withdraw ALL funds from the Presale contract to the Treasury wallet?"))return;const t=["function withdrawFunds() external"],a=v.publicSale,n=new pd.Contract(a,t,c.signer),s=e.innerHTML;e.disabled=!0,e.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i> Withdrawing...';try{console.log(`Calling withdrawFunds() on ${a}...`);const i=await n.withdrawFunds();x("Transaction sent. Awaiting confirmation...","info");const r=await i.wait();console.log("Funds withdrawn successfully!",r.hash),x("Funds withdrawn successfully!","success",r.hash),so()}catch(i){console.error("Error withdrawing funds:",i);const r=i.reason||i.message||"Transaction failed.";x(`Error: ${r}`,"error")}finally{e.disabled=!1,e.innerHTML=s}},Zf=async e=>{const t=e.target.closest("button[data-action]");if(!t||t.disabled)return;const a=t.dataset.action,n=t.dataset.submissionId,s=t.dataset.userId;if(!a||!n||!s){console.warn("Missing data attributes for admin action:",t.dataset);return}const i=t.closest("tr"),r=t.closest("td").querySelectorAll("button");i?(i.style.opacity="0.5",i.style.pointerEvents="none"):r.forEach(o=>o.disabled=!0);try{(a==="approved"||a==="rejected")&&(await nc(s,n,a),x(`Submission ${a==="approved"?"APPROVED":"REJECTED"}!`,"success"),P.allSubmissions=P.allSubmissions.filter(o=>o.submissionId!==n),In())}catch(o){x(`Failed to ${a} submission: ${o.message}`,"error"),console.error(o),i&&(i.style.opacity="1",i.style.pointerEvents="auto")}},Qf=async e=>{const t=e.target.closest(".ban-user-btn");if(!t||t.disabled)return;const a=t.dataset.userId,n=t.dataset.action==="ban";if(!a)return;const s=n?`Are you sure you want to PERMANENTLY BAN this user?
(This is reversible)`:`Are you sure you want to UNBAN this user?
(This will reset their rejection count to 0)`;if(!window.confirm(s))return;const i=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await sc(a,n),x(`User ${n?"BANNED":"UNBANNED"}.`,"success");const r=P.allUsers.findIndex(o=>o.id===a);r>-1&&(P.allUsers[r].isBanned=n,P.allUsers[r].hasPendingAppeal=!1,n===!1&&(P.allUsers[r].rejectedCount=0)),kt()}catch(r){x(`Failed: ${r.message}`,"error"),t.disabled=!1,t.innerHTML=i}},e0=async e=>{const t=e.target.closest(".resolve-appeal-btn");if(!t||t.disabled)return;const a=t.dataset.userId,s=t.dataset.action==="approve";if(!a)return;const i=s?"Are you sure you want to APPROVE this appeal and UNBAN the user?":"Are you sure you want to DENY this appeal? The user will remain banned.";if(!window.confirm(i))return;const r=t.closest("td").querySelectorAll("button"),o=new Map;r.forEach(l=>{o.set(l,l.innerHTML),l.disabled=!0,l.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>'});try{s&&await sc(a,!1),x(`Appeal ${s?"APPROVED":"DENIED"}.`,"success");const l=P.allUsers.findIndex(d=>d.id===a);l>-1&&(P.allUsers[l].hasPendingAppeal=!1,s&&(P.allUsers[l].isBanned=!1,P.allUsers[l].rejectedCount=0)),kt()}catch(l){x(`Failed: ${l.message}`,"error"),r.forEach(d=>{d.disabled=!1,d.innerHTML=o.get(d)})}},t0=async e=>{const t=e.target.closest(".re-approve-btn");if(!t||t.disabled)return;const a=t.dataset.submissionId,n=t.dataset.userId;if(!a||!n)return;const s=t.closest("tr");s&&(s.style.opacity="0.5"),t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await nc(n,a,"approved"),x("Submission re-approved!","success"),P.selectedUserSubmissions=P.selectedUserSubmissions.filter(r=>r.submissionId!==a),s&&s.remove();const i=P.allUsers.findIndex(r=>r.id===n);if(i>-1){const r=P.allUsers[i];r.rejectedCount=Math.max(0,(r.rejectedCount||0)-1),kt()}if(P.selectedUserSubmissions.length===0){const r=document.querySelector("#admin-user-modal .p-6");r&&(r.innerHTML='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>')}}catch(i){x(`Failed to re-approve: ${i.message}`,"error"),s&&(s.style.opacity="1"),t.disabled=!1,t.innerHTML='<i class="fa-solid fa-check"></i> Re-Approve'}},a0=async e=>{const t=e.target.closest(".view-rejected-btn");if(!t||t.disabled)return;const a=t.dataset.userId,n=t.dataset.wallet;if(a){P.selectedWallet=n,P.isSubmissionsModalOpen=!0,$s(!0,[]);try{const s=await ju(a,"rejected");P.selectedUserSubmissions=s,$s(!1,s)}catch(s){x(`Error fetching user submissions: ${s.message}`,"error"),$s(!1,[],!0)}}},n0=()=>{P.isSubmissionsModalOpen=!1,P.selectedUserSubmissions=[],P.selectedWallet=null;const e=document.getElementById("admin-user-modal");e&&e.remove(),document.body.style.overflow="auto"},s0=e=>{const t=e.target.closest(".user-profile-link");if(!t)return;e.preventDefault();const a=t.dataset.userId;if(!a)return;const n=P.allUsers.find(s=>s.id===a);if(!n){x("Error: Could not find user data.","error");return}d0(n)},i0=()=>{const e=document.getElementById("admin-user-profile-modal");e&&e.remove(),document.body.style.overflow="auto"},r0=async e=>{e.preventDefault();const t=e.target;let a,n;try{if(a=new Date(t.startDate.value+"T00:00:00Z"),n=new Date(t.endDate.value+"T23:59:59Z"),isNaN(a.getTime())||isNaN(n.getTime()))throw new Error("Invalid date format.");if(a>=n)throw new Error("Start Date must be before End Date.")}catch(l){x(l.message,"error");return}const s={title:t.title.value.trim(),url:t.url.value.trim(),description:t.description.value.trim(),points:parseInt(t.points.value,10),cooldownHours:parseInt(t.cooldown.value,10),startDate:a,endDate:n};if(!s.title||!s.description){x("Please fill in Title and Description.","error");return}if(s.points<=0||s.cooldownHours<=0){x("Points and Cooldown must be positive numbers.","error");return}if(s.url&&!s.url.startsWith("http")){x("URL must start with http:// or https://","error");return}P.editingTask&&P.editingTask.id&&(s.id=P.editingTask.id);const i=t.querySelector('button[type="submit"]'),r=i.innerHTML;i.disabled=!0;const o=document.createElement("span");o.classList.add("inline-block"),i.innerHTML="",i.appendChild(o);try{await Du(s),x(`Task ${s.id?"updated":"created"} successfully!`,"success"),t.reset(),P.editingTask=null,Ca()}catch(l){x(`Failed to save task: ${l.message}`,"error"),console.error(l),i.disabled=!1,i.innerHTML=r}},o0=async e=>{e.preventDefault();const t=e.target,a={YouTube:parseInt(t.youtubePoints.value,10),"YouTube Shorts":parseInt(t.youtubeShortsPoints.value,10),Instagram:parseInt(t.instagramPoints.value,10),"X/Twitter":parseInt(t.xTwitterPoints.value,10),Facebook:parseInt(t.facebookPoints.value,10),Telegram:parseInt(t.telegramPoints.value,10),TikTok:parseInt(t.tiktokPoints.value,10),Reddit:parseInt(t.redditPoints.value,10),LinkedIn:parseInt(t.linkedinPoints.value,10),Other:parseInt(t.otherPoints.value,10)};if(Object.values(a).some(r=>isNaN(r)||r<0)){x("All points must be positive numbers (or 0).","error");return}const n=t.querySelector('button[type="submit"]'),s=n.innerHTML;n.disabled=!0;const i=document.createElement("span");i.classList.add("inline-block"),n.innerHTML="",n.appendChild(i);try{await Fu(a),x("UGC Base Points updated successfully!","success"),P.ugcBasePoints=a}catch(r){x(`Failed to update points: ${r.message}`,"error"),console.error(r)}finally{document.body.contains(n)&&(n.disabled=!1,n.innerHTML=s)}},l0=e=>{const t=P.dailyTasks.find(a=>a.id===e);t&&(P.editingTask=t,La())},c0=async e=>{if(window.confirm("Are you sure you want to delete this task permanently?"))try{await Ou(e),x("Task deleted.","success"),P.editingTask=null,Ca()}catch(t){x(`Failed to delete task: ${t.message}`,"error"),console.error(t)}};function $s(e,t,a=!1){var r,o;const n=document.getElementById("admin-user-modal");n&&n.remove(),document.body.style.overflow="hidden";let s="";e?s='<div class="p-8"></div>':a?s='<p class="text-red-400 text-center p-8">Failed to load submissions.</p>':t.length===0?s='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>':s=`
     ...
     `;document.body.insertAdjacentHTML("beforeend",i),e&&document.getElementById("admin-user-modal").querySelector(".p-8"),(r=document.getElementById("close-admin-modal-btn"))==null||r.addEventListener("click",n0),(o=document.getElementById("modal-submissions-tbody"))==null||o.addEventListener("click",t0)}function d0(e){var s;const t=document.getElementById("admin-user-profile-modal");t&&t.remove(),document.body.style.overflow="hidden";const a=e.isBanned?'<span class="text-xs font-bold py-1 px-3 rounded-full bg-red-600 text-white">BANNED</span>':e.hasPendingAppeal?'<span class="text-xs font-bold py-1 px-3 rounded-full bg-yellow-600 text-white">APPEALING</span>':'<span class="text-xs font-bold py-1 px-3 rounded-full bg-green-600 text-white">ACTIVE</span>',n=`
     ...
     `;document.body.insertAdjacentHTML("beforeend",n),(s=document.getElementById("close-admin-profile-modal-btn"))==null||s.addEventListener("click",i0)}const u0=e=>{const t=e.target.closest(".user-filter-btn");!t||t.classList.contains("active")||(P.usersFilter=t.dataset.filter||"all",P.usersPage=1,kt())},p0=e=>{P.usersSearch=e.target.value,P.usersPage=1,kt()},m0=e=>{P.usersPage=e,kt()},f0=e=>{P.submissionsPage=e,In()},b0=e=>{P.tasksPage=e,La()},kt=()=>{var L,B;const e=document.getElementById("manage-users-content");if(!e)return;const t=P.allUsers;if(!t)return;const n=(P.usersSearch||"").toLowerCase().trim().replace(/[^a-z0-9x]/g,""),s=P.usersFilter;let i=t;n&&(i=i.filter(A=>{var _,D;return((_=A.walletAddress)==null?void 0:_.toLowerCase().includes(n))||((D=A.id)==null?void 0:D.toLowerCase().includes(n))})),s==="banned"?i=i.filter(A=>A.isBanned):s==="appealing"&&(i=i.filter(A=>A.hasPendingAppeal===!0));const r=t.length,o=t.filter(A=>A.isBanned).length,l=t.filter(A=>A.hasPendingAppeal===!0).length,d=i.sort((A,_)=>A.hasPendingAppeal!==_.hasPendingAppeal?A.hasPendingAppeal?-1:1:A.isBanned!==_.isBanned?A.isBanned?-1:1:(_.totalPoints||0)-(A.totalPoints||0)),u=P.usersPage,m=P.usersPerPage,p=d.length,g=Math.ceil(p/m),b=(u-1)*m,w=u*m,y=d.slice(b,w),C=y.length>0?y.map(A=>{let _="border-b border-border-color hover:bg-zinc-800/50",D="";return A.hasPendingAppeal?(_+=" bg-yellow-900/40",D='<span class="ml-2 text-xs font-bold text-yellow-300">[APPEALING]</span>'):A.isBanned&&(_+=" bg-red-900/30 opacity-70",D='<span class="ml-2 text-xs font-bold text-red-400">[BANNED]</span>'),`
        <tr class="${_}">
            <td class="p-3 text-xs text-zinc-300 font-mono" title="User ID: ${A.id}">
                <a href="#" class="user-profile-link font-bold text-blue-400 hover:underline" 
                   data-user-id="${A.id}" 
                   title="Click to view profile. Full Wallet: ${A.walletAddress||"N/A"}">
                    ${ca(A.walletAddress)}
                </a>
                ${D}
            </td>
            <td class="p-3 text-sm font-bold text-yellow-400">${(A.totalPoints||0).toLocaleString("en-US")}</td>
            <td class="p-3 text-sm font-bold ${A.rejectedCount>0?"text-red-400":"text-zinc-400"}">${A.rejectedCount||0}</td>
            <td class="p-3 text-right">
                <div class="flex items-center justify-end gap-2">
                    ${A.hasPendingAppeal?`<button data-user-id="${A.id}" data-action="approve" 
                                   class="resolve-appeal-btn bg-green-600 hover:bg-green-700 text-white text-xs font-bold py-1 px-2 rounded">
                               <i class="fa-solid fa-check"></i> Approve
                           </button>
                           <button data-user-id="${A.id}" data-action="deny" 
                           ...
                           </button>`:`<button data-user-id="${A.id}" data-wallet="${A.walletAddress}" 
                           ...
                           ${A.isBanned?`<button data-user-id="${A.id}" data-action="unban" 
                                   ...
                                   </button>`:`<button data-user-id="${A.id}" data-action="ban" 
    ...
    `;const I=document.getElementById("admin-users-pagination");I&&g>1&&ui(I,P.usersPage,g,m0),(L=document.getElementById("admin-users-tbody"))==null||L.addEventListener("click",A=>{A.target.closest(".user-profile-link")&&s0(A),A.target.closest(".ban-user-btn")&&Qf(A),A.target.closest(".view-rejected-btn")&&a0(A),A.target.closest(".resolve-appeal-btn")&&e0(A)}),(B=document.getElementById("user-filters-nav"))==null||B.addEventListener("click",u0);const z=document.getElementById("user-search-input");if(z){let A;z.addEventListener("keyup",_=>{clearTimeout(A),A=setTimeout(()=>p0(_),300)})}},ll=()=>{var n;const e=document.getElementById("manage-ugc-points-content");if(!e)return;const t=P.ugcBasePoints;if(!t)return;const a={YouTube:5e3,"YouTube Shorts":2500,Instagram:3e3,"X/Twitter":1500,Facebook:2e3,Telegram:1e3,TikTok:3500,Reddit:1800,LinkedIn:2200,Other:1e3};e.innerHTML=`
    ...
    `,(n=document.getElementById("ugcPointsForm"))==null||n.addEventListener("submit",o0)},La=()=>{var b,w,y;const e=document.getElementById("manage-tasks-content");if(!e)return;const t=P.editingTask,a=!!t,n=C=>{if(!C)return"";try{return(C.toDate?C.toDate():C instanceof Date?C:new Date(C)).toISOString().split("T")[0]}catch{return""}},s=P.tasksPage,i=P.tasksPerPage,r=[...P.dailyTasks].sort((C,I)=>{var B,A;const z=(B=C.startDate)!=null&&B.toDate?C.startDate.toDate():new Date(C.startDate||0);return((A=I.startDate)!=null&&A.toDate?I.startDate.toDate():new Date(I.startDate||0)).getTime()-z.getTime()}),o=r.length,l=Math.ceil(o/i),d=(s-1)*i,u=s*i,m=r.slice(d,u),p=m.length>0?m.map(C=>{var A,_;const I=new Date,z=(A=C.startDate)!=null&&A.toDate?C.startDate.toDate():C.startDate?new Date(C.startDate):null,L=(_=C.endDate)!=null&&_.toDate?C.endDate.toDate():C.endDate?new Date(C.endDate):null;let B="text-zinc-500";return z&&L&&(I>=z&&I<=L?B="text-green-400":I<z&&(B="text-blue-400")),`
    ...
    `;const g=document.getElementById("admin-tasks-pagination");g&&l>1&&ui(g,P.tasksPage,l,b0),(b=document.getElementById("taskForm"))==null||b.addEventListener("submit",r0),(w=document.getElementById("cancelEditBtn"))==null||w.addEventListener("click",()=>{P.editingTask=null,La()}),(y=document.getElementById("existing-tasks-list"))==null||y.addEventListener("click",C=>{const I=C.target.closest("button[data-id]");if(!I)return;const z=I.dataset.id;I.dataset.action==="edit"&&l0(z),I.dataset.action==="delete"&&c0(z)})},In=()=>{var m;const e=document.getElementById("submissions-content");if(!e)return;if(!P.allSubmissions||P.allSubmissions.length===0){const p=document.createElement("div");e.innerHTML=p.innerHTML;return}const t=P.submissionsPage,a=P.submissionsPerPage,n=[...P.allSubmissions].sort((p,g)=>{var b,w;return(((b=g.submittedAt)==null?void 0:b.getTime())||0)-(((w=p.submittedAt)==null?void 0:w.getTime())||0)}),s=n.length,i=Math.ceil(s/a),r=(t-1)*a,o=t*a,d=n.slice(r,o).map(p=>{var g,b;return`
        <tr class="border-b border-border-color hover:bg-zinc-800/50">
            ...
            <td class="p-3 text-xs font-semibold ${((g=ol[p.status])==null?void 0:g.color)||"text-gray-500"}">${((b=ol[p.status])==null?void 0:b.text)||p.status}</td>
            <td class="p-3 text-right">
                <div class="flex items-center justify-end gap-2">
    ...
    `;const u=document.getElementById("admin-submissions-pagination");u&&i>1&&ui(u,P.submissionsPage,i,f0),(m=document.getElementById("admin-submissions-tbody"))==null||m.addEventListener("click",Zf)},An=()=>{var i,r;const e=document.getElementById("platform-usage-content");if(!e)return;const t=P.platformUsageConfig||bs;let a=0;Object.values(t).forEach(o=>{o.enabled!==!1&&(a+=(o.points||0)*(o.maxCount||1))});const n=Object.entries(t).map(([o,l])=>`
    ...
    `;const s=document.getElementById("platform-usage-tbody");s==null||s.addEventListener("input",cl),s==null||s.addEventListener("change",cl),(i=document.getElementById("save-platform-config-btn"))==null||i.addEventListener("click",g0),(r=document.getElementById("reset-platform-config-btn"))==null||r.addEventListener("click",x0)},cl=e=>{const t=e.target;if(!t.classList.contains("platform-input")&&!t.classList.contains("platform-toggle"))return;const a=t.closest("tr"),n=a==null?void 0:a.dataset.actionKey,s=t.dataset.field;if(!n||!s)return;P.platformUsageConfig[n]||(P.platformUsageConfig[n]={...bs[n]}),s==="enabled"?P.platformUsageConfig[n].enabled=t.checked:P.platformUsageConfig[n][s]=parseInt(t.value)||0;const i=P.platformUsageConfig[n],r=a.querySelector("td:last-child");r&&(r.textContent=((i.points||0)*(i.maxCount||1)).toLocaleString())},g0=async e=>{const t=e.target.closest("button");if(!t)return;const a=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Saving...';try{await ic(P.platformUsageConfig),x("✅ Platform Usage config saved!","success"),An()}catch(n){console.error("Error saving platform config:",n),x("Failed to save config: "+n.message,"error")}finally{t.disabled=!1,t.innerHTML=a}},x0=async()=>{if(confirm("Are you sure you want to reset to default values? This will save immediately."))try{P.platformUsageConfig={...bs},await ic(P.platformUsageConfig),x("✅ Config reset to defaults!","success"),An()}catch(e){console.error("Error resetting platform config:",e),x("Failed to reset config: "+e.message,"error")}},h0=()=>{var a;const e=document.getElementById("admin-content-wrapper");if(!e)return;e.innerHTML=`
    ...
    `,(a=document.getElementById("withdraw-presale-funds-btn"))==null||a.addEventListener("click",n=>Jf(n.target)),so(),P.activeTab==="manage-ugc-points"?ll():P.activeTab==="manage-tasks"?La():P.activeTab==="review-submissions"?In():P.activeTab==="manage-users"?kt():P.activeTab==="platform-usage"&&An();const t=document.getElementById("admin-tabs");t&&!t._listenerAttached&&(t.addEventListener("click",n=>{const s=n.target.closest(".tab-btn");if(!s||s.classList.contains("active"))return;const i=s.dataset.target;P.activeTab=i,i!=="manage-users"&&(P.usersPage=1,P.usersFilter="all",P.usersSearch=""),i!=="review-submissions"&&(P.submissionsPage=1),i!=="manage-tasks"&&(P.tasksPage=1),document.querySelectorAll("#admin-tabs .tab-btn").forEach(o=>o.classList.remove("active")),s.classList.add("active"),e.querySelectorAll(".tab-content").forEach(o=>o.classList.remove("active"));const r=document.getElementById(i.replace(/-/g,"_")+"_tab");r?(r.classList.add("active"),i==="manage-ugc-points"&&ll(),i==="manage-tasks"&&La(),i==="review-submissions"&&In(),i==="manage-users"&&kt(),i==="platform-usage"&&An()):console.warn(`Tab content container not found for target: ${i}`)}),t._listenerAttached=!0)},v0={render(){const e=document.getElementById("admin");if(e){if(!Xf()){e.innerHTML='<div class="text-center text-red-400 p-8 bg-sidebar border border-red-500/50 rounded-lg">Access Denied. This page is restricted to administrators.</div>';return}if(rl()){e.innerHTML='<div id="admin-content-wrapper"></div>',Ca();return}e.innerHTML=`
        ...
        `,document.getElementById("admin-login-btn").addEventListener("click",()=>{const t=document.getElementById("admin-key-input"),a=document.getElementById("admin-login-error");t.value===Vf?(qf(),x("✅ Admin access granted!","success"),e.innerHTML='<div id="admin-content-wrapper"></div>',Ca()):(a.classList.remove("hidden"),t.value="",t.focus(),setTimeout(()=>a.classList.add("hidden"),3e3))}),setTimeout(()=>{var t;(t=document.getElementById("admin-key-input"))==null||t.focus()},100)}},refreshData(){const e=document.getElementById("admin");e&&!e.classList.contains("hidden")&&rl()&&(console.log("Refreshing Admin Page data..."),Ca(),so())}},Ss=2e8,dl={airdrop:{amount:7e7},liquidity:{amount:13e7}},w0=()=>{if(document.getElementById("tokenomics-styles-v5"))return;const e=document.createElement("style");e.id="tokenomics-styles-v5",e.innerHTML=`
    ...
    `,document.head.appendChild(e)},Ia=e=>e>=1e6?(e/1e6).toFixed(1)+"M":e>=1e3?(e/1e3).toFixed(0)+"K":e.toLocaleString();function y0(){return`
    ...
    `}function k0(){const e=c.totalSupply?M(c.totalSupply):4e7,t=(e/Ss*100).toFixed(1);return`
        <div class="tk-section tk-fade-up" style="animation-delay: 0.1s">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div class="tk-card text-center">
                    ...
                    <p class="text-xl font-black text-white">${Ia(Ss)}</p>
            ...
            <p class="text-center text-zinc-600 text-[10px]">
                ...
                Remaining ${Ia(Ss-e)} BKC to be mined through ecosystem activity
            </p>
        </div>
    `}function E0(){return`
                ...
                <div class="space-y-3">
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-500 text-[10px]">${Ia(dl.airdrop.amount)} BKC</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-500 text-[10px]">${Ia(dl.liquidity.amount)} BKC</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="tk-timeline-item">
                            ...
                            <div class="tk-card">
                                <div class="flex items-center justify-between mb-2">
                                    ...
                                    <i class="fa-solid fa-${s} text-${n}-400"></i>
                                </div>
    ...
    `}function B0(){const e=document.getElementById("tokenomics");e&&(w0(),e.innerHTML=`
    ...
    `,e.scrollIntoView({behavior:"smooth",block:"start"}))}const N0={render:B0,init:()=>{},update:()=>{}},le=window.ethers,$0=5*1024*1024,fd="https://sepolia.arbiscan.io",S0=`${fd}/tx/`,io=`${fd}/address/`,bd=["event Certified(uint256 indexed certId, address indexed owner, bytes32 documentHash, uint8 docType, address operator)"],Qe={image:{icon:"fa-regular fa-image",color:"#34d399",bg:"rgba(52,211,153,0.12)",label:"Image"},pdf:{icon:"fa-regular fa-file-pdf",color:"#f87171",bg:"rgba(248,113,113,0.12)",label:"PDF"},audio:{icon:"fa-solid fa-music",color:"#a78bfa",bg:"rgba(167,139,250,0.12)",label:"Audio"},video:{icon:"fa-regular fa-file-video",color:"#60a5fa",bg:"rgba(96,165,250,0.12)",label:"Video"},document:{icon:"fa-regular fa-file-word",color:"#60a5fa",bg:"rgba(96,165,250,0.12)",label:"Document"},spreadsheet:{icon:"fa-regular fa-file-excel",color:"#4ade80",bg:"rgba(74,222,128,0.12)",label:"Spreadsheet"},code:{icon:"fa-solid fa-code",color:"#22d3ee",bg:"rgba(34,211,238,0.12)",label:"Code"},archive:{icon:"fa-regular fa-file-zipper",color:"#facc15",bg:"rgba(250,204,21,0.12)",label:"Archive"},default:{icon:"fa-regular fa-file",color:"#fbbf24",bg:"rgba(251,191,36,0.12)",label:"File"}},T={view:"documents",activeTab:"documents",viewHistory:[],wizStep:1,wizFile:null,wizFileHash:null,wizDescription:"",wizDuplicateCheck:null,wizIsHashing:!1,wizIpfsCid:null,wizUploadDate:null,bkcFee:0n,ethFee:0n,feesLoaded:!1,certificates:[],certsLoading:!1,selectedCert:null,verifyFile:null,verifyHash:null,verifyResult:null,verifyIsChecking:!1,stats:null,totalSupply:0,recentNotarizations:[],statsLoading:!1,isProcessing:!1,processStep:"",isLoading:!1,contractAvailable:!0};function Ga(e="",t=""){const a=e.toLowerCase(),n=t.toLowerCase();return a.includes("image")||/\.(jpg|jpeg|png|gif|webp|svg|bmp|ico)$/.test(n)?Qe.image:a.includes("pdf")||n.endsWith(".pdf")?Qe.pdf:a.includes("audio")||/\.(mp3|wav|ogg|flac|aac|m4a)$/.test(n)?Qe.audio:a.includes("video")||/\.(mp4|avi|mov|mkv|webm|wmv)$/.test(n)?Qe.video:a.includes("word")||a.includes("document")||/\.(doc|docx|odt|rtf)$/.test(n)?Qe.document:a.includes("sheet")||a.includes("excel")||/\.(xls|xlsx|csv|ods)$/.test(n)?Qe.spreadsheet:/\.(js|ts|py|java|cpp|c|h|html|css|json|xml|sol|rs|go|php|rb)$/.test(n)?Qe.code:a.includes("zip")||a.includes("archive")||/\.(zip|rar|7z|tar|gz)$/.test(n)?Qe.archive:Qe.default}function gd(e){if(!e)return"";let t;if(typeof e=="number")t=new Date(e>1e12?e:e*1e3);else if(typeof e=="string")t=new Date(e);else if(e!=null&&e.toDate)t=e.toDate();else if(e!=null&&e.seconds)t=new Date(e.seconds*1e3);else return"";if(isNaN(t.getTime()))return"";const a=new Date,n=a-t,s=Math.floor(n/6e4),i=Math.floor(n/36e5),r=Math.floor(n/864e5);return s<1?"Just now":s<60?`${s}m`:i<24?`${i}h`:r<7?`${r}d`:t.toLocaleDateString("en-US",{month:"short",day:"numeric",year:t.getFullYear()!==a.getFullYear()?"numeric":void 0})}function ro(e){if(!e)return"";const t=typeof e=="number"?new Date(e>1e12?e:e*1e3):new Date(e);return isNaN(t.getTime())?"":t.toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"2-digit",minute:"2-digit"})}function oo(e){return e?`${e.slice(0,6)}...${e.slice(-4)}`:""}function xd(e){return e?e.startsWith("https://")?e:e.startsWith("ipfs://")?`${gn[0]}${e.replace("ipfs://","")}`:`${gn[0]}${e}`:""}function lo(e){return e<1024?`${e} B`:e<1048576?`${(e/1024).toFixed(1)} KB`:`${(e/1048576).toFixed(2)} MB`}function L0(e,t){T.viewHistory.push({view:T.view,data:T.selectedCert}),T.view=e,t&&(T.selectedCert=t),fe(),fa()}function hd(){const e=T.viewHistory.pop();e?(T.view=e.view,T.activeTab=e.view==="cert-detail"?"documents":e.view,T.selectedCert=e.data):(T.view="documents",T.activeTab="documents"),fe(),fa()}function R0(e){T.activeTab===e&&T.view===e||(T.viewHistory=[],T.view=e,T.activeTab=e,fe(),fa())}function _0(){if(document.getElementById("notary-styles-v10"))return;const e=document.createElement("style");e.id="notary-styles-v10",e.textContent=`
        :root {
            --nt-bg:       #0c0c0e;
            --nt-bg2:      #141417;
            --nt-bg3:      #1c1c21;
    ...
    `,document.head.appendChild(e);const t=document.getElementById("notary-styles-v6");t&&t.remove()}function F0(e){const t=document.getElementById("notary");t&&(_0(),t.innerHTML=`
        <div class="nt-shell">
            <div class="nt-header" id="nt-header"></div>
            <div id="nt-content"></div>
            <div id="nt-overlay" class="nt-overlay"></div>
        </div>
    `,fa(),fe(),Promise.all([q0(),co(),J0()]).catch(()=>{}))}function fa(){var t;const e=document.getElementById("nt-header");if(e){if(T.view==="cert-detail"){e.innerHTML=`
    ...
    `}}function fe(){const e=document.getElementById("nt-content");if(e)switch(T.view){case"documents":ul(e);break;case"notarize":D0(e);break;case"verify":W0(e);break;case"stats":Y0(e);break;case"cert-detail":V0(e);break;default:ul(e)}}function ul(e){if(!c.isConnected){e.innerHTML=`
        ...
        <div class="nt-cert-grid">
            ${T.certificates.map(t=>M0(t)).join("")}
        </div>
    `}function M0(e){var i,r;const t=xd(e.ipfs),a=Ga(e.mimeType||"",e.description||e.fileName||""),n=gd(e.timestamp),s=((i=e.description)==null?void 0:i.split("---")[0].trim().split(`
`)[0].trim())||"Notarized Document";return`
    ...
    `}function D0(e){if(!c.isConnected){e.innerHTML=`
            <div class="nt-card" style="margin-top:16px;text-align:center;padding:48px 20px">
                <div style="width:56px;height:56px;border-radius:var(--nt-radius);background:var(--nt-bg3);display:inline-flex;align-items:center;justify-content:center;margin-bottom:16px">
                    <i class="fa-solid fa-wallet" style="font-size:24px;color:var(--nt-text-3)"></i>
                </div>
    ...
    `;const t=document.getElementById("nt-wiz-panel");if(t)switch(T.wizStep){case 1:H0(t);break;case 2:vd(t);break;case 3:j0(t);break}}function O0(){const e=T.wizStep;return`
        <div class="nt-steps">
    ...
    `}function H0(e){if(T.wizFile&&T.wizFileHash){const t=T.wizFile,a=Ga(t.type,t.name),n=T.wizDuplicateCheck;e.innerHTML=`
            ...
            <div style="background:var(--nt-bg3);border:1px solid var(--nt-border);border-radius:var(--nt-radius);padding:16px;margin-bottom:16px">
                <div style="display:flex;align-items:center;gap:14px">
                    ...
                    <div style="flex:1;min-width:0">
                        ...
                        <div style="font-size:11px;color:var(--nt-text-3)">${lo(t.size)} &bull; ${a.label}</div>
                    </div>
            ...
            `:n!=null&&n.exists?`
                <div class="nt-duplicate-warn" style="margin-bottom:16px">
                    ...
                    <div style="font-size:12px;color:var(--nt-text-2);line-height:1.5">
                        ...
                        Owner: <span style="font-family:monospace;font-size:11px">${oo(n.owner)}</span><br>
                        Date: ${ro(n.timestamp)}
                    </div>
                </div>
            `:`
    ...
    `,U0()}function U0(){const e=document.getElementById("nt-wiz-dropzone"),t=document.getElementById("nt-wiz-file-input");!e||!t||(e.onclick=()=>t.click(),["dragenter","dragover","dragleave","drop"].forEach(a=>{e.addEventListener(a,n=>{n.preventDefault(),n.stopPropagation()})}),e.addEventListener("dragenter",()=>e.classList.add("drag-over")),e.addEventListener("dragover",()=>e.classList.add("drag-over")),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",a=>{var n,s;e.classList.remove("drag-over"),pl((s=(n=a.dataTransfer)==null?void 0:n.files)==null?void 0:s[0])}),t.addEventListener("change",a=>{var n;return pl((n=a.target.files)==null?void 0:n[0])}))}async function pl(e){if(e){if(e.size>$0){x("File too large (max 5MB)","error");return}T.wizFile=e,T.wizFileHash=null,T.wizDuplicateCheck=null,T.wizIsHashing=!0,fe();try{const t=await Ve.calculateFileHash(e);T.wizFileHash=t,T.wizIsHashing=!1,fe(),T.wizDuplicateCheck=null,fe();const a=await Ve.verifyByHash(t);T.wizDuplicateCheck=a,fe()}catch(t){console.error("[NotaryPage] Hash error:",t),T.wizIsHashing=!1,T.wizFile=null,x("Error computing file hash","error"),fe()}}}function vd(e){const t=T.wizFile,a=Ga((t==null?void 0:t.type)||"",(t==null?void 0:t.name)||""),n=T.feesLoaded?le?le.formatEther(T.bkcFee):"1":"...",s=T.feesLoaded?le?le.formatEther(T.ethFee):"0.0001":"...",i=c.currentUserBalance||0n,r=c.currentUserNativeBalance||0n,o=T.feesLoaded?i>=T.bkcFee:!0,l=T.feesLoaded?r>=T.ethFee+((le==null?void 0:le.parseEther("0.001"))||0n):!0,d=o&&l;e.innerHTML=`
        <div style="max-width:420px;margin:0 auto">
            ...
            <div style="background:var(--nt-bg3);border:1px solid var(--nt-border);border-radius:var(--nt-radius);padding:12px;margin-bottom:16px;display:flex;align-items:center;gap:12px">
                ...
                <div style="flex:1;min-width:0">
                    ...
                    <div style="font-size:10px;color:var(--nt-text-3)">${lo((t==null?void 0:t.size)||0)}</div>
                </div>
            </div>
    ...
    `}function j0(e){const t=T.wizFile,a=Ga((t==null?void 0:t.type)||"",(t==null?void 0:t.name)||""),n=T.wizDescription||"No description",s=le?le.formatEther(T.bkcFee):"1",i=le?le.formatEther(T.ethFee):"0.0001";e.innerHTML=`
            ...
            <div style="background:var(--nt-bg3);border:1px solid var(--nt-border);border-radius:var(--nt-radius);padding:16px;text-align:left;margin-bottom:16px">
                <div style="display:flex;align-items:center;gap:12px;padding-bottom:12px;border-bottom:1px solid var(--nt-border);margin-bottom:12px">
                    ...
                    <div style="flex:1;min-width:0">
                        ...
                        <div style="font-size:11px;color:var(--nt-text-3)">${lo((t==null?void 0:t.size)||0)}</div>
                    </div>
                </div>
    ...
    `}async function G0(){if(T.isProcessing)return;T.isProcessing=!0,T.processStep="SIGNING";const e=document.getElementById("nt-btn-mint");e&&(e.disabled=!0,e.innerHTML='<i class="fa-solid fa-spinner fa-spin" style="margin-right:6px"></i>Signing...'),document.getElementById("nt-overlay"),nn("signing");try{const n=await(await c.provider.getSigner()).signMessage("I am signing to authenticate my file for notarization on Backchain.");T.processStep="UPLOADING",nn("uploading");const s=new FormData;s.append("file",T.wizFile),s.append("signature",n),s.append("address",c.userAddress),s.append("description",T.wizDescription||"No description");const i=qe.uploadFileToIPFS||"/api/upload",r=await fetch(i,{method:"POST",body:s,signal:AbortSignal.timeout(18e4)});if(!r.ok)throw r.status===413?new Error("File too large (max 5MB)"):r.status===401?new Error("Signature verification failed"):new Error(`Upload failed (${r.status})`);const o=await r.json(),l=o.ipfsUri||o.metadataUri,d=o.contentHash||T.wizFileHash;if(!l)throw new Error("No IPFS URI returned");if(!d)throw new Error("No content hash returned");T.processStep="MINTING",nn("minting"),await Ve.notarize({ipfsCid:l,contentHash:d,description:T.wizDescription||"No description",operator:ee(),button:e,onSuccess:(u,m,p)=>{T.processStep="SUCCESS",nn("success",m),setTimeout(()=>{Ls(),T.wizFile=null,T.wizFileHash=null,T.wizDescription="",T.wizDuplicateCheck=null,T.wizStep=1,T.isProcessing=!1,T.view="documents",T.activeTab="documents",fa(),fe(),co(),x("Document notarized successfully!","success")},3e3)},onError:u=>{if(u.cancelled||u.type==="user_rejected"){T.isProcessing=!1,Ls(),e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-stamp" style="margin-right:6px"></i>Sign & Mint');return}throw u}})}catch(t){console.error("[NotaryPage] Mint error:",t),Ls(),T.isProcessing=!1,e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-stamp" style="margin-right:6px"></i>Sign & Mint'),t.code!==4001&&t.code!=="ACTION_REJECTED"&&x(t.message||"Notarization failed","error")}}function nn(e,t){const a=document.getElementById("nt-overlay");if(!a)return;a.classList.add("active");const n={signing:{icon:"fa-solid fa-signature",text:"Signing message...",sub:"Confirm in MetaMask",pct:10},uploading:{icon:"fa-solid fa-cloud-arrow-up",text:"Uploading to IPFS...",sub:"Decentralized storage",pct:35},minting:{icon:"fa-solid fa-stamp",text:"Minting on Blockchain...",sub:"Waiting for confirmation",pct:65,animate:!0},success:{icon:"fa-solid fa-check",text:"Notarized!",sub:t?`Token ID #${t}`:"Certificate created",pct:100,success:!0}},s=n[e]||n.signing;if(a.innerHTML=`
    ...
    `,!document.getElementById("nt-spin-kf")){const i=document.createElement("style");i.id="nt-spin-kf",i.textContent="@keyframes nt-spin { to { transform: rotate(360deg); } }",document.head.appendChild(i)}}function Ls(){const e=document.getElementById("nt-overlay");e&&e.classList.remove("active")}function W0(e){e.innerHTML=`
        <div class="nt-card" style="margin-top:16px">
            <div style="text-align:center;margin-bottom:20px">
    ...
    `,K0(),T.verifyResult&&wd()}function K0(){const e=document.getElementById("nt-verify-dropzone"),t=document.getElementById("nt-verify-file-input");!e||!t||(e.onclick=()=>t.click(),["dragenter","dragover","dragleave","drop"].forEach(a=>{e.addEventListener(a,n=>{n.preventDefault(),n.stopPropagation()})}),e.addEventListener("dragenter",()=>e.classList.add("drag-over")),e.addEventListener("dragover",()=>e.classList.add("drag-over")),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",a=>{var n,s;e.classList.remove("drag-over"),ml((s=(n=a.dataTransfer)==null?void 0:n.files)==null?void 0:s[0])}),t.addEventListener("change",a=>{var n;return ml((n=a.target.files)==null?void 0:n[0])}))}async function ml(e){if(!e)return;T.verifyFile=e,T.verifyHash=null,T.verifyResult=null,T.verifyIsChecking=!0;const t=document.getElementById("nt-verify-result");t&&(t.innerHTML=`
        ...
        `);try{const a=await Ve.calculateFileHash(e);T.verifyHash=a;const n=await Ve.verifyByHash(a);T.verifyResult=n,T.verifyIsChecking=!1,wd()}catch(a){console.error("[NotaryPage] Verify error:",a),T.verifyIsChecking=!1,t&&(t.innerHTML=`
            ...
            `)}}function wd(){const e=document.getElementById("nt-verify-result");if(!e||!T.verifyResult)return;const t=T.verifyResult,a=T.verifyFile;t.exists?e.innerHTML=`
        ...
        `}function Y0(e){if(T.statsLoading&&!T.stats){e.innerHTML=`
                    ...
                    `:T.recentNotarizations.map(n=>`
                        <div class="nt-recent-item">
                            ...
                            <div style="flex:1;min-width:0">
                                ...
                                <div style="font-size:11px;color:var(--nt-text-3)">${oo(n.owner)}</div>
                            </div>
                            <div style="text-align:right;flex-shrink:0">
                                <div style="font-size:11px;color:var(--nt-text-3)">${gd(n.timestamp)}</div>
                            </div>
                        </div>
                    `).join("")}
                </div>
    ...
    `}function V0(e){var s;const t=T.selectedCert;if(!t){hd();return}const a=xd(t.ipfs),n=Ga(t.mimeType||"",t.description||"");(t.mimeType||"").includes("image")||/\.(jpg|jpeg|png|gif|webp|svg|bmp)$/i.test(t.fileName||t.description||""),e.innerHTML=`
        <div class="nt-detail" style="margin-top:8px">
            ...
            <div class="nt-detail-meta" style="margin-bottom:12px">
                ...
                <div class="nt-card" style="padding:14px">
                    <div style="font-size:10px;color:var(--nt-text-3);text-transform:uppercase;letter-spacing:0.05em;margin-bottom:4px">Owner</div>
                    <div style="font-size:12px;font-family:monospace;color:var(--nt-text-2)">${oo(t.owner||c.userAddress)}</div>
                </div>
            </div>
            ...
            <div style="display:flex;flex-wrap:wrap;gap:8px;margin-top:8px">
                ...
                ${t.txHash?`
                    <a href="${S0}${t.txHash}" target="_blank" class="nt-btn-secondary" style="text-decoration:none;display:inline-flex;align-items:center;gap:6px;font-size:12px">
                        <i class="fa-solid fa-receipt"></i>Transaction
                    </a>
                `:""}
            </div>
        </div>
    `}async function q0(){try{const e=await Ve.getFee();T.bkcFee=e.bkcFee,T.ethFee=e.ethFee,T.feesLoaded=!0}catch{T.bkcFee=(le==null?void 0:le.parseEther("1"))||0n,T.ethFee=(le==null?void 0:le.parseEther("0.0001"))||0n,T.feesLoaded=!0}}async function co(){if(!c.isConnected||!c.userAddress)return;T.certsLoading=!0,fe();let e=!1;try{const t=qe.getNotaryHistory;console.log("[NotaryPage] Loading certificates from API:",`${t}/${c.userAddress}`);const a=await fetch(`${t}/${c.userAddress}`);if(!a.ok)throw new Error(`API ${a.status}`);const n=await a.json();console.log("[NotaryPage] API response:",typeof n,Array.isArray(n)?`array(${n.length})`:JSON.stringify(n).substring(0,200));const s=Array.isArray(n)?n:Array.isArray(n==null?void 0:n.documents)?n.documents:Array.isArray(n==null?void 0:n.data)?n.data:Array.isArray(n==null?void 0:n.history)?n.history:null;s&&s.length>0&&(T.certificates=s.map(i=>({id:i.tokenId||i.id||"?",ipfs:i.ipfsCid||i.ipfsUri||"",description:i.description||"",hash:i.contentHash||"",timestamp:i.createdAt||i.timestamp||"",txHash:i.txHash||i.transactionHash||"",owner:i.owner||c.userAddress,mimeType:i.mimeType||"",fileName:i.fileName||""})).sort((i,r)=>parseInt(r.id)-parseInt(i.id)),e=!0,console.log("[NotaryPage] Loaded",T.certificates.length,"certificates from API"))}catch(t){console.warn("[NotaryPage] API failed:",t.message)}if(!e){console.log("[NotaryPage] Trying on-chain event fallback...");try{const t=await X0();T.certificates=t,console.log("[NotaryPage] Loaded",t.length,"certificates from chain events")}catch(t){console.error("[NotaryPage] Chain fallback also failed:",t),T.certificates=[]}}T.certsLoading=!1,fe()}async function X0(){if(!le||!(v!=null&&v.notary))return console.warn("[NotaryPage] Chain fallback: missing ethers or contract address"),[];const{NetworkManager:e}=await O(async()=>{const{NetworkManager:o}=await Promise.resolve().then(()=>Z);return{NetworkManager:o}},void 0),t=e.getProvider();if(!t)return console.warn("[NotaryPage] Chain fallback: no provider available"),[];console.log("[NotaryPage] Querying Certified events for:",c.userAddress);const a=new le.Contract(v.notary,bd,t),n=a.filters.Certified(null,c.userAddress),s=await t.getBlockNumber(),i=Math.max(0,s-5e4);console.log("[NotaryPage] Block range:",i,"->",s);const r=await a.queryFilter(n,i,s);return console.log("[NotaryPage] Found",r.length,"events"),r.map(o=>({id:Number(o.args.certId),hash:o.args.documentHash||"",docType:Number(o.args.docType||0),timestamp:null,txHash:o.transactionHash,owner:o.args.owner})).sort((o,l)=>l.id-o.id)}async function J0(){T.statsLoading=!0;try{const[e,t]=await Promise.all([Ve.getStats(),Ve.getTotalDocuments()]);T.stats=e,T.totalSupply=t}catch(e){console.warn("[NotaryPage] Stats load error:",e)}try{await Z0()}catch{}T.statsLoading=!1,T.view==="stats"&&fe()}async function Z0(){if(!le||!(v!=null&&v.notary))return;const{NetworkManager:e}=await O(async()=>{const{NetworkManager:l}=await Promise.resolve().then(()=>Z);return{NetworkManager:l}},void 0),t=e.getProvider();if(!t)return;const a=new le.Contract(v.notary,bd,t),n=a.filters.Certified(),s=await t.getBlockNumber(),i=Math.max(0,s-5e3),o=(await a.queryFilter(n,i,s)).slice(-20).reverse();T.recentNotarizations=o.map(l=>({tokenId:Number(l.args.certId),owner:l.args.owner,hash:l.args.documentHash,docType:Number(l.args.docType||0),timestamp:null,blockNumber:l.blockNumber}));try{const l=[...new Set(o.map(u=>u.blockNumber))],d={};await Promise.all(l.slice(0,10).map(async u=>{const m=await t.getBlock(u);m&&(d[u]=m.timestamp)})),T.recentNotarizations.forEach(u=>{d[u.blockNumber]&&(u.timestamp=d[u.blockNumber])})}catch{}}async function Q0(e,t){var a,n;try{const s=l=>{var u;if(!l)return"";if(l.startsWith("https://")&&!l.includes("/ipfs/"))return l;const d=l.startsWith("ipfs://")?l.replace("ipfs://",""):l.includes("/ipfs/")?(u=l.split("/ipfs/")[1])==null?void 0:u.split("?")[0]:"";return d?`${gn[0]}${d}`:l};let i=s(t||"");if(c.notaryContract)try{const l=await c.notaryContract.tokenURI(e);if(l!=null&&l.startsWith("data:application/json;base64,")){const d=JSON.parse(atob(l.replace("data:application/json;base64,","")));d.image&&(i=s(d.image))}}catch{}const r=(v==null?void 0:v.notary)||((a=c.notaryContract)==null?void 0:a.target)||((n=c.notaryContract)!=null&&n.getAddress?await c.notaryContract.getAddress():null);if(!r){x("Contract address not found","error");return}x(`Adding NFT #${e} to wallet...`,"info"),await window.ethereum.request({method:"wallet_watchAsset",params:{type:"ERC721",options:{address:r,tokenId:String(e),image:i}}})&&x(`NFT #${e} added to wallet!`,"success")}catch(s){if(s.code===4001)return;x("Could not add NFT","error")}}function eb(e){e&&navigator.clipboard.writeText(e).then(()=>{x("Hash copied!","success")}).catch(()=>{x("Failed to copy","error")})}function tb(){var e;T.wizStep===1&&T.wizFileHash&&!((e=T.wizDuplicateCheck)!=null&&e.exists)?T.wizStep=2:T.wizStep===2&&(T.wizStep=3),fe()}function ab(){T.wizStep>1&&(T.wizStep--,fe())}function nb(){const e=document.getElementById("nt-wiz-desc");e&&(T.wizDescription=e.value||""),T.wizStep=3,fe()}function sb(){T.wizFile=null,T.wizFileHash=null,T.wizDuplicateCheck=null,T.wizStep=1,fe()}function ib(e){const t=T.certificates.find(a=>String(a.id)===String(e));t&&L0("cert-detail",t)}const yd={async render(e){e&&F0()},reset(){T.wizFile=null,T.wizFileHash=null,T.wizDescription="",T.wizDuplicateCheck=null,T.wizStep=1,T.view="documents",T.activeTab="documents",T.viewHistory=[],fe(),fa()},update(){if(!T.isProcessing&&T.view==="notarize"){const e=document.getElementById("nt-wiz-panel");e&&T.wizStep===2&&vd(e)}},refreshHistory(){co()},setTab:R0,goBack:hd,viewCert:ib,handleMint:G0,addToWallet:Q0,copyHash:eb,wizNext:tb,wizBack:ab,wizToStep3:nb,wizRemoveFile:sb};window.NotaryPage=yd;const uo=window.ethers,ti={Diamond:{emoji:"💎",color:"#22d3ee",bg:"rgba(34,211,238,0.15)",border:"rgba(34,211,238,0.3)",keepRate:100,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeicgip72jcqgsirlrhn3tq5cc226vmko6etnndzl6nlhqrktfikafq"},Gold:{emoji:"🥇",color:"#fbbf24",bg:"rgba(251,191,36,0.15)",border:"rgba(251,191,36,0.3)",keepRate:90,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeifponccrbicg2pcjrn2hrfoqgc77xhm2r4ld7hdpw6cxxkbsckf44"},Silver:{emoji:"🥈",color:"#9ca3af",bg:"rgba(156,163,175,0.15)",border:"rgba(156,163,175,0.3)",keepRate:75,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeihvi2inujm5zpi7tl667g4srq273536pjkglwyrtbwmgnskmu7jg4"},Bronze:{emoji:"🥉",color:"#fb923c",bg:"rgba(251,146,60,0.15)",border:"rgba(251,146,60,0.3)",keepRate:60,image:"https://white-defensive-eel-240.mypinata.cloud/ipfs/bafybeiclqidb67rt3tchhjpsib62s624li7j2bpxnr6b5w5mfp4tomhu7m"}},R={activeTab:"marketplace",filterTier:"ALL",sortBy:"boost-high",selectedListing:null,isLoading:!1,isTransactionPending:!1,countdownIntervals:[],pendingEarningsAmount:0n,marketStats:null},it=e=>e==null?"":String(e),rb=(e,t)=>it(e)===it(t),Ra=(e,t)=>e&&t&&e.toLowerCase()===t.toLowerCase();function Wa(e){return xe.find(t=>t.boostBips===Number(e))||{name:"Unknown",boostBips:0}}function gs(e){return ti[e]||{emoji:"💎",color:"#71717a",bg:"rgba(113,113,122,0.15)",border:"rgba(113,113,122,0.3)",keepRate:50}}function We(e){if(!e)return"0";const t=parseFloat(uo.formatEther(BigInt(e)));return t===0?"0":t<1e-4?"<0.0001":t<.01?t.toFixed(4):t<1?t.toFixed(3):t.toFixed(2)}function kd(e){const t=e-Math.floor(Date.now()/1e3);if(t<=0)return{text:"Expired",expired:!0,seconds:0};const a=Math.floor(t/3600),n=Math.floor(t%3600/60),s=t%60;return a>0?{text:`${a}h ${n}m`,expired:!1,seconds:t}:n>0?{text:`${n}m ${s}s`,expired:!1,seconds:t}:{text:`${s}s`,expired:!1,seconds:t}}function ob(){if(document.getElementById("boost-market-styles"))return;const e=document.createElement("style");e.id="boost-market-styles",e.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(e)}function ai(){const e=document.getElementById("rental");if(!e)return;ob();const t=c.rentalListings||[],a=t.filter(r=>c.isConnected&&Ra(r.owner,c.userAddress)),n=Math.floor(Date.now()/1e3),s=(c.myRentals||[]).filter(r=>Ra(r.tenant,c.userAddress)&&Number(r.endTime)>n),i=R.marketStats;e.innerHTML=`
        ...
        ${pb()}
        ${mb()}
    `,fb(),Aa()}function Aa(){const e=document.getElementById("bm-tab-content");if(e){switch(R.activeTab){case"marketplace":e.innerHTML=lb();break;case"my-listings":e.innerHTML=cb();break;case"my-rentals":e.innerHTML=db();break}R.activeTab==="my-rentals"&&kb()}}function lb(){const e=c.rentalListings||[],t=Math.floor(Date.now()/1e3);let a=e.filter(n=>!(n.isRented||n.currentlyRented||n.rentalEndTime&&Number(n.rentalEndTime)>t||R.filterTier!=="ALL"&&Wa(n.boostBips).name!==R.filterTier));return a.sort((n,s)=>{const i=BigInt(n.pricePerHour||0),r=BigInt(s.pricePerHour||0);return R.sortBy==="price-low"?i<r?-1:i>r?1:0:R.sortBy==="price-high"?i>r?-1:i<r?1:0:(s.boostBips||0)-(n.boostBips||0)}),`
        <div>
            <!-- Filters & Sort -->
            ...
            <!-- NFT Grid -->
            ${a.length===0?po("No NFTs Available","Be the first to list your NFT booster!"):`
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 bm-nft-grid">
                    ${a.map((n,s)=>Ed(n,s,!1)).join("")}
                </div>
            `}
        </div>
    `}function Ed(e,t,a=!1){const n=Wa(e.boostBips),s=gs(n.name),i=We(e.pricePerHour),r=it(e.tokenId),o=c.isConnected&&Ra(e.owner,c.userAddress),l=e.isRented||e.currentlyRented,d=st(e.boostBips||0);return`
        <div class="bm-nft-card ${o?"owned":""} ${l?"rented-out":""}"
            ...
            <div class="p-4 pt-0">
                <div class="flex items-baseline justify-between mb-2">
                    ...
                    <span class="text-xs font-mono" style="color:${s.color}">#${r}</span>
                </div>
                ...
                <div class="flex items-end justify-between">
                    ...
                    <div class="flex gap-2">
                        ${o?`
                            ...
                            <button class="bm-withdraw-btn bm-btn-danger px-4 py-2 text-xs" data-id="${r}" ${l?"disabled":""}>
                                <i class="fa-solid fa-arrow-right-from-bracket mr-1"></i>Withdraw
                            </button>
                        `:`
                            <button class="bm-rent-btn bm-btn-primary px-5 py-2.5 text-sm" data-id="${r}" ${l?"disabled":""}>
    ...
    `}function cb(){if(!c.isConnected)return Td("View your listings");const e=c.rentalListings||[],t=e.filter(i=>Ra(i.owner,c.userAddress)),a=new Set(e.map(i=>it(i.tokenId))),n=(c.myBoosters||[]).filter(i=>!a.has(it(i.tokenId))),s=t.reduce((i,r)=>i+BigInt(r.totalEarnings||0),0n);return`
        <div>
            <!-- Earnings Card -->
                    ...
                    <div class="flex items-center gap-5">
                        ...
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white">
                                <i class="fa-brands fa-ethereum text-blue-400 text-2xl mr-1"></i>${We(s)} <span class="text-lg text-zinc-500">ETH</span>
                            </p>
                        </div>
                    </div>
                    <div class="flex flex-wrap gap-3 items-center">
                        ...
                        <div class="bm-card p-4 text-center min-w-[120px]" style="border-color: rgba(251,191,36,0.2);">
                            <p class="text-xl font-bold text-amber-400 font-mono" id="bm-pending-amount">
                                ${R.pendingEarningsAmount>0n?We(R.pendingEarningsAmount):"0"}
                            </p>
            ...
            <!-- My Listed NFTs -->
            ${t.length===0?po("No Listings Yet","List your first NFT to start earning ETH!"):`
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 bm-nft-grid">
                    ${t.map((i,r)=>Ed(i,r,!0)).join("")}
                </div>
            `}
        </div>
    `}function db(){if(!c.isConnected)return Td("View your active rentals");const e=Math.floor(Date.now()/1e3),t=(c.myRentals||[]).filter(a=>Ra(a.tenant,c.userAddress)&&Number(a.endTime)>e);return`
        <div>
            <!-- Tier Info -->
            <div class="bm-card p-5 mb-6" style="border-color: rgba(34,197,94,0.15);">
                <div class="flex items-start gap-4">
            ...
            <!-- Active Rentals -->
            ${t.length===0?po("No Active Rentals","Rent an NFT booster to keep more staking rewards!"):`
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    ${t.map((a,n)=>ub(a,n)).join("")}
                </div>
            `}
        </div>
    `}function ub(e,t){const a=Wa(e.boostBips),n=gs(a.name),s=kd(Number(e.endTime)),i=st(e.boostBips||0);let r="active";return s.seconds<3600?r="critical":s.seconds<7200&&(r="warning"),`
        <div class="bm-card p-5" style="animation: bm-card-in 0.5s ease-out ${t*60}ms forwards; opacity: 0;">
            ...
            <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-zinc-500">Token #${it(e.tokenId)}</p>
                </div>
            </div>
    ...
    `}function pb(){const e=c.rentalListings||[],t=new Set(e.map(n=>it(n.tokenId)));return`
                ...
                <div class="p-5 space-y-5">
                    <div>
                        ...
                        <select id="bm-list-select" class="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-4 py-3 text-white outline-none">
                            ...
                            ${(c.myBoosters||[]).filter(n=>!t.has(it(n.tokenId))).map(n=>{const s=Wa(n.boostBips),i=gs(s.name);return`<option value="${n.tokenId}">${i.emoji} ${s.name} Booster #${n.tokenId}</option>`}).join("")}
                        </select>
                    </div>
                    <div>
    ...
    `}let Rt=null,_t=null;function fb(){Rt&&document.removeEventListener("click",Rt),_t&&document.removeEventListener("change",_t),Rt=e=>{const t=e.target,a=t.closest(".bm-tab");if(a){R.activeTab=a.dataset.tab,document.querySelectorAll(".bm-tab").forEach(o=>o.classList.remove("active")),a.classList.add("active"),Aa();return}const n=t.closest(".bm-filter");if(n){R.filterTier=n.dataset.filter,Aa();return}if(t.closest("#bm-open-list")){bb();return}if(t.closest(".bm-close-list")){Cd();return}if(t.closest(".bm-close-rent")){Id();return}if(t.closest("#bm-confirm-list")){hb();return}if(t.closest("#bm-confirm-rent")){xb();return}const s=t.closest(".bm-rent-btn");if(s&&!s.disabled){gb(s.dataset.id);return}const i=t.closest(".bm-withdraw-btn");if(i&&!i.disabled){vb(i);return}const r=t.closest(".bm-share-btn");if(r){yb(r.dataset.id);return}if(t.closest("#bm-withdraw-earnings")){wb();return}if(t.classList.contains("bm-modal")){t.classList.remove("active"),R.selectedListing=null;return}},_t=e=>{e.target.id==="bm-sort"&&(R.sortBy=e.target.value,Aa())},document.addEventListener("click",Rt),document.addEventListener("change",_t)}function bb(){const e=document.getElementById("bm-modal-list");e&&e.classList.add("active")}function Cd(){const e=document.getElementById("bm-modal-list");e&&e.classList.remove("active")}function gb(e){const t=(c.rentalListings||[]).find(p=>rb(p.tokenId,e));if(!t)return;R.selectedListing=t;const a=Wa(t.boostBips),n=gs(a.name),s=We(t.pricePerHour),i=st(t.boostBips||0),r=document.getElementById("bm-rent-modal-body");if(!r)return;r.innerHTML=`
    ...
    `;const o=document.getElementById("bm-rent-hours"),l=document.getElementById("bm-confirm-rent"),d=document.getElementById("bm-balance-warn"),u=document.getElementById("bm-balance-warn-text"),m=async()=>{const p=parseInt(o.value)||1;let g=0n;try{const b=await lt.getRentalCost(e,p);g=b.totalCost,document.getElementById("bm-cost-rental").innerHTML=`<i class="fa-brands fa-ethereum text-blue-400 mr-1"></i>${b.rentalCostFormatted} ETH`,document.getElementById("bm-cost-fee").innerHTML=`<i class="fa-brands fa-ethereum text-blue-400 mr-1"></i>${b.ethFeeFormatted} ETH`,document.getElementById("bm-cost-total").innerHTML=`<i class="fa-brands fa-ethereum text-blue-400 mr-1"></i>${b.totalCostFormatted} ETH`}catch{const w=BigInt(t.pricePerHour||0)*BigInt(p);g=w,document.getElementById("bm-cost-rental").innerHTML=`<i class="fa-brands fa-ethereum text-blue-400 mr-1"></i>${We(w)} ETH`,document.getElementById("bm-cost-fee").textContent="~fee",document.getElementById("bm-cost-total").innerHTML=`<i class="fa-brands fa-ethereum text-blue-400 mr-1"></i>~${We(w)} ETH`}if(c.isConnected&&g>0n)try{const{NetworkManager:b}=await O(async()=>{const{NetworkManager:C}=await Promise.resolve().then(()=>Z);return{NetworkManager:C}},void 0),w=await b.getProvider().getBalance(c.userAddress),y=g+uo.parseEther("0.001");if(w<y){const C=We(y-w);l.disabled=!0,l.className="flex-1 py-3 rounded-xl font-bold text-sm border border-red-500/30 bg-red-500/10 text-red-400 cursor-not-allowed",l.innerHTML=`<i class="fa-brands fa-ethereum mr-1"></i>Need ${We(y)} ETH`,d.classList.remove("hidden"),u.textContent=`Your balance: ${We(w)} ETH — need ${C} more ETH`}else l.disabled=!1,l.className="bm-btn-primary flex-1 py-3",l.innerHTML='<i class="fa-solid fa-bolt mr-2"></i>Rent Now',d.classList.add("hidden")}catch{l.disabled=!1,l.className="bm-btn-primary flex-1 py-3",l.innerHTML='<i class="fa-solid fa-bolt mr-2"></i>Rent Now',d.classList.add("hidden")}};m(),o.addEventListener("input",m),document.getElementById("bm-modal-rent").classList.add("active")}function Id(){const e=document.getElementById("bm-modal-rent");e&&e.classList.remove("active"),R.selectedListing=null}async function xb(){if(R.isTransactionPending||!R.selectedListing)return;const e=parseInt(document.getElementById("bm-rent-hours").value)||1,t=it(R.selectedListing.tokenId),a=document.getElementById("bm-confirm-rent");R.isTransactionPending=!0;try{await lt.rent({tokenId:t,hours:e,button:a,onSuccess:async()=>{R.isTransactionPending=!1,Id(),x("NFT Rented Successfully!","success"),await ia()},onError:n=>{R.isTransactionPending=!1,!n.cancelled&&n.type!=="user_rejected"&&x("Failed: "+(n.message||"Error"),"error")}})}catch(n){R.isTransactionPending=!1,!n.cancelled&&n.type!=="user_rejected"&&x("Failed: "+(n.message||"Error"),"error")}}async function hb(){if(R.isTransactionPending)return;const e=document.getElementById("bm-list-select").value,t=document.getElementById("bm-list-price").value,a=parseInt(document.getElementById("bm-list-min").value)||1,n=parseInt(document.getElementById("bm-list-max").value)||168;if(!e){x("Select an NFT","error");return}if(!t||parseFloat(t)<=0){x("Enter valid price","error");return}if(a>n){x("Min hours must be <= max hours","error");return}const s=document.getElementById("bm-confirm-list");R.isTransactionPending=!0;try{await lt.list({tokenId:e,pricePerHour:uo.parseEther(t),minHours:a,maxHours:n,button:s,onSuccess:async()=>{R.isTransactionPending=!1,Cd(),x("NFT Listed Successfully!","success"),await ia()},onError:i=>{R.isTransactionPending=!1,!i.cancelled&&i.type!=="user_rejected"&&x("Failed: "+(i.message||"Error"),"error")}})}catch(i){R.isTransactionPending=!1,!i.cancelled&&i.type!=="user_rejected"&&x("Failed: "+(i.message||"Error"),"error")}}async function vb(e){if(R.isTransactionPending)return;const t=e.dataset.id;if(confirm("Withdraw this NFT from the marketplace?")){R.isTransactionPending=!0;try{await lt.withdraw({tokenId:t,button:e,onSuccess:async()=>{R.isTransactionPending=!1,x("NFT Withdrawn Successfully!","success"),await ia()},onError:a=>{R.isTransactionPending=!1,!a.cancelled&&a.type!=="user_rejected"&&x("Failed: "+(a.message||"Error"),"error")}})}catch(a){R.isTransactionPending=!1,!a.cancelled&&a.type!=="user_rejected"&&x("Failed: "+(a.message||"Error"),"error")}}}async function wb(){if(R.isTransactionPending||R.pendingEarningsAmount===0n)return;const e=document.getElementById("bm-withdraw-earnings");R.isTransactionPending=!0;try{await lt.withdrawEarnings({button:e,onSuccess:async()=>{R.isTransactionPending=!1,R.pendingEarningsAmount=0n,x("Earnings Withdrawn!","success"),await ia()},onError:t=>{R.isTransactionPending=!1,!t.cancelled&&t.type!=="user_rejected"&&x("Failed: "+(t.message||"Error"),"error")}})}catch(t){R.isTransactionPending=!1,!t.cancelled&&t.type!=="user_rejected"&&x("Failed: "+(t.message||"Error"),"error")}}function yb(e){const t="https://backcoin.org/#rental",a=`Rent NFT Boosters on Backchain Boost Market!

Keep up to 100% of your staking rewards by renting an NFT booster.

${t}

#Backchain #DeFi #Arbitrum #Web3`;navigator.share?navigator.share({title:"Backchain Boost Market",text:a,url:t}).catch(()=>{}):navigator.clipboard.writeText(a).then(()=>{x("Link copied to clipboard!","success")}).catch(()=>{x("Could not copy link","error")})}function kb(){R.countdownIntervals.forEach(clearInterval),R.countdownIntervals=[],document.querySelectorAll(".bm-timer[data-end]").forEach(e=>{const t=Number(e.dataset.end),a=setInterval(()=>{const n=kd(t);e.innerHTML=`<i class="fa-solid fa-clock mr-1"></i>${n.text}`,n.expired?(clearInterval(a),Aa()):n.seconds<3600?e.className="bm-timer critical":n.seconds<7200&&(e.className="bm-timer warning")},1e3);R.countdownIntervals.push(a)})}async function ia(){R.isLoading=!0;try{const e=[Xl()];c.isConnected&&(e.push(Cu()),e.push($t()),e.push(Eb())),e.push(Tb()),await Promise.all(e)}catch(e){console.warn("[BoostMarket] Refresh error:",e)}R.isLoading=!1,ai()}async function Eb(){if(c.userAddress)try{const e=await lt.getPendingEarnings(c.userAddress);R.pendingEarningsAmount=e.amount}catch{R.pendingEarningsAmount=0n}}async function Tb(){try{R.marketStats=await lt.getMarketplaceStats()}catch{R.marketStats=null}}function fl(){R.countdownIntervals.forEach(clearInterval),R.countdownIntervals=[],Rt&&(document.removeEventListener("click",Rt),Rt=null),_t&&(document.removeEventListener("change",_t),_t=null)}const Ad={async render(e){if(!e){fl();return}ai(),await ia()},update(){ai()},refresh:ia,cleanup:fl};window.RentalPage=Ad;const Cb={render:async e=>{const t=document.getElementById("socials");if(!t||!e&&t.innerHTML.trim()!=="")return;const a=`
            <style>
...
`;document.head.appendChild(Pd);const Ib={render:async e=>{if(!e)return;const t=document.getElementById("creditcard");t&&(t.innerHTML=`
    ...
    `}const K={state:{tokens:{ETH:{name:"Ethereum",symbol:"ETH",balance:5.45,price:3050,logo:"https://cryptologos.cc/logos/ethereum-eth-logo.png?v=026"},USDT:{name:"Tether USD",symbol:"USDT",balance:12500,price:1,logo:"https://cryptologos.cc/logos/tether-usdt-logo.png?v=026"},ARB:{name:"Arbitrum",symbol:"ARB",balance:2450,price:1.1,logo:"https://cryptologos.cc/logos/arbitrum-arb-logo.png?v=026"},WBTC:{name:"Wrapped BTC",symbol:"WBTC",balance:.15,price:62e3,logo:"https://cryptologos.cc/logos/wrapped-bitcoin-wbtc-logo.png?v=026"},MATIC:{name:"Polygon",symbol:"MATIC",balance:5e3,price:.85,logo:"https://cryptologos.cc/logos/polygon-matic-logo.png?v=026"},BNB:{name:"BNB Chain",symbol:"BNB",balance:12.5,price:580,logo:"https://cryptologos.cc/logos/bnb-bnb-logo.png?v=026"},BKC:{name:"Backcoin",symbol:"BKC",balance:1500,price:.12,logo:"assets/bkc_logo_3d.png",isNative:!0}},settings:{slippage:.5,deadline:20},swap:{tokenIn:"ETH",tokenOut:"BKC",amountIn:"",loading:!1},mining:{rate:.05}},calculate:()=>{const{tokens:e,swap:t,mining:a}=K.state;if(!t.amountIn||parseFloat(t.amountIn)===0)return null;const n=e[t.tokenIn],s=e[t.tokenOut],r=parseFloat(t.amountIn)*n.price,o=r*.003,l=r-o,d=e.BKC.price,u=o*a.rate/d,m=l/s.price,p=Math.min(r/1e5*100,5).toFixed(2);return{amountOut:m,usdValue:r,feeUsd:o,miningReward:u,priceImpact:p,rate:n.price/s.price}},render:async e=>{if(!e)return;const t=document.getElementById("dex");t&&(t.innerHTML=`
        ...
        `,K.updateUI(),K.bindEvents())},updateUI:()=>{const{tokens:e,swap:t}=K.state,a=e[t.tokenIn],n=e[t.tokenOut],s=(l,d)=>{document.getElementById(`symbol-${l}`).innerText=d.symbol;const u=document.getElementById(`img-${l}-container`);d.logo?u.innerHTML=`<img src="${d.logo}" class="w-6 h-6 rounded-full" onerror="this.style.display='none'">`:u.innerHTML=`<div class="w-6 h-6 rounded-full bg-zinc-700 flex items-center justify-center text-[10px]">${d.symbol[0]}</div>`};s("in",a),s("out",n),document.getElementById("bal-in").innerText=a.balance.toFixed(4),document.getElementById("bal-out").innerText=n.balance.toFixed(4);const i=K.calculate(),r=document.getElementById("btn-swap"),o=document.getElementById("swap-details");if(!t.amountIn)document.getElementById("input-out").value="",document.getElementById("usd-in").innerText="$0.00",document.getElementById("usd-out").innerText="$0.00",o.classList.add("hidden"),r.innerText="Enter an amount",r.className="w-full mt-4 bg-zinc-800 text-zinc-500 font-bold text-lg py-4 rounded-2xl cursor-not-allowed",r.disabled=!0;else if(parseFloat(t.amountIn)>a.balance)r.innerText=`Insufficient ${a.symbol} balance`,r.className="w-full mt-4 bg-[#3d1818] text-red-500 font-bold text-lg py-4 rounded-2xl cursor-not-allowed border border-red-900/30",r.disabled=!0,o.classList.add("hidden");else if(i){document.getElementById("input-out").value=i.amountOut.toFixed(6),document.getElementById("usd-in").innerText=`~$${i.usdValue.toFixed(2)}`,document.getElementById("usd-out").innerText=`~$${(i.usdValue-i.feeUsd).toFixed(2)}`,o.classList.remove("hidden"),document.getElementById("fee-display").innerText=`$${i.feeUsd.toFixed(2)}`,document.getElementById("mining-reward-display").innerText=`+${i.miningReward.toFixed(4)} BKC`;const l=document.getElementById("price-impact");parseFloat(i.priceImpact)>2?(l.classList.remove("hidden"),l.innerText=`Price Impact: -${i.priceImpact}%`):l.classList.add("hidden"),r.innerHTML=t.loading?'<i class="fa-solid fa-circle-notch fa-spin"></i> Swapping...':"Swap",r.className="w-full mt-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-bold text-lg py-4 rounded-2xl shadow-lg shadow-blue-900/20 cursor-pointer border border-blue-500/20",r.disabled=t.loading}},bindEvents:()=>{document.getElementById("input-in").addEventListener("input",t=>{K.state.swap.amountIn=t.target.value,K.updateUI()}),document.getElementById("btn-max-in").addEventListener("click",()=>{const t=K.state.tokens[K.state.swap.tokenIn].balance;K.state.swap.amountIn=t.toString(),document.getElementById("input-in").value=t,K.updateUI()}),document.getElementById("btn-switch").addEventListener("click",()=>{const t=K.state.swap.tokenIn;K.state.swap.tokenIn=K.state.swap.tokenOut,K.state.swap.tokenOut=t,K.state.swap.amountIn="",document.getElementById("input-in").value="",K.updateUI()}),document.getElementById("btn-swap").addEventListener("click",async()=>{const t=document.getElementById("btn-swap");if(t.disabled)return;K.state.swap.loading=!0,K.updateUI(),await new Promise(i=>setTimeout(i,1500));const a=K.calculate(),{tokens:n,swap:s}=K.state;n[s.tokenIn].balance-=parseFloat(s.amountIn),n[s.tokenOut].balance+=a.amountOut,n.BKC.balance+=a.miningReward,K.state.swap.loading=!1,K.state.swap.amountIn="",document.getElementById("input-in").value="",t.className="w-full mt-4 bg-green-600 text-white font-bold text-lg py-4 rounded-2xl shadow-[0_0_20px_rgba(22,163,74,0.4)]",t.innerHTML=`<i class="fa-solid fa-check"></i> Swap Success! +${a.miningReward.toFixed(2)} BKC Mined!`,setTimeout(()=>{K.updateUI()},3e3)});const e=t=>{const a=document.getElementById("token-modal"),n=document.getElementById("token-list");a.classList.remove("hidden"),(()=>{n.innerHTML=Object.values(K.state.tokens).map(i=>{const r=K.state.swap[`token${t==="in"?"In":"Out"}`]===i.symbol;return K.state.swap[`token${t==="in"?"Out":"In"}`]===i.symbol?"":`
                        <div class="token-item flex justify-between items-center p-3 hover:bg-[#2c2c2c] rounded-xl cursor-pointer transition-colors ${r?"opacity-50 pointer-events-none":""}" data-symbol="${i.symbol}">
                            <div class="flex items-center gap-3">
                    ...
                    `}).join(""),document.querySelectorAll(".token-item").forEach(i=>{i.addEventListener("click",()=>{K.state.swap[`token${t==="in"?"In":"Out"}`]=i.dataset.symbol,a.classList.add("hidden"),K.updateUI()})})})(),document.querySelectorAll(".quick-token").forEach(i=>{i.onclick=()=>{K.state.swap[`token${t==="in"?"In":"Out"}`]=i.dataset.symbol,a.classList.add("hidden"),K.updateUI()}})};document.getElementById("btn-token-in").addEventListener("click",()=>e("in")),document.getElementById("btn-token-out").addEventListener("click",()=>e("out")),document.getElementById("close-modal").addEventListener("click",()=>document.getElementById("token-modal").classList.add("hidden")),document.getElementById("token-modal").addEventListener("click",t=>{t.target.id==="token-modal"&&t.target.classList.add("hidden")})}},Ab={render:async e=>{if(!e)return;const t=document.getElementById("dao");t&&(t.innerHTML=`
        ...
        `)}},X="https://www.youtube.com/@Backcoin",Rs={gettingStarted:[{id:"v1",thumbnail:"https://img.youtube.com/vi/VIDEO_ID_HERE/maxresdefault.jpg",duration:"3:42",tag:"beginner",en:{title:"MetaMask Setup (PC & Mobile)",description:"Your passport to the Backcoin universe. Learn how to install and configure MetaMask for Web3.",url:X},pt:{title:"Configurando MetaMask (PC & Mobile)",description:"Seu passaporte para o universo Backcoin. Aprenda a instalar e configurar a MetaMask para Web3.",url:X}},{id:"v2",thumbnail:"https://img.youtube.com/vi/VIDEO_ID_HERE/maxresdefault.jpg",duration:"0:53",tag:"beginner",en:{title:"Connect & Claim Starter Pack",description:"Fill your tank! Connect your wallet and claim free BKC tokens plus ETH for gas fees.",url:X},pt:{title:"Conectar e Receber Starter Pack",description:"Encha o tanque! Conecte sua carteira e receba BKC grátis mais ETH para taxas de gás.",url:X}},{id:"v10",thumbnail:"https://img.youtube.com/vi/VIDEO_ID_HERE/maxresdefault.jpg",duration:"1:40",tag:"beginner",en:{title:"Airdrop Ambassador Campaign",description:"35% of TGE for the community! Learn how to earn points by promoting Backcoin.",url:X},pt:{title:"Campanha de Airdrop - Embaixador",description:"35% do TGE para a comunidade! Aprenda a ganhar pontos promovendo o Backcoin.",url:X}}],ecosystem:[{id:"v4",thumbnail:"https://img.youtube.com/vi/VIDEO_ID_HERE/maxresdefault.jpg",duration:"0:48",tag:"intermediate",en:{title:"Staking Pool - Passive Income",description:"Lock your tokens and earn a share of all protocol fees. Up to 10x multiplier for loyalty!",url:X},pt:{title:"Staking Pool - Renda Passiva",description:"Trave seus tokens e ganhe parte das taxas do protocolo. Até 10x multiplicador por lealdade!",url:X}},{id:"v5",thumbnail:"https://img.youtube.com/vi/VIDEO_ID_HERE/maxresdefault.jpg",duration:"0:50",tag:"intermediate",en:{title:"NFT Market - Boost Your Account",description:"Buy NFT Boosters to reduce fees and increase mining efficiency. Prices set by math, not sellers.",url:X},pt:{title:"NFT Market - Turbine sua Conta",description:"Compre NFT Boosters para reduzir taxas e aumentar eficiência. Preços definidos por matemática.",url:X}},{id:"v6",thumbnail:"https://img.youtube.com/vi/VIDEO_ID_HERE/maxresdefault.jpg",duration:"0:53",tag:"intermediate",en:{title:"AirBNFT - Rent NFT Power",description:"Need a boost but don't want to buy? Rent NFT power from other players for a fraction of the cost.",url:X},pt:{title:"AirBNFT - Aluguel de Poder",description:"Precisa de boost mas não quer comprar? Alugue poder de NFT de outros jogadores.",url:X}},{id:"v7a",thumbnail:"https://img.youtube.com/vi/VIDEO_ID_HERE/maxresdefault.jpg",duration:"1:05",tag:"intermediate",en:{title:"List Your NFT for Rent",description:"Turn your idle NFTs into passive income. List on AirBNFT and earn while you sleep.",url:X},pt:{title:"Liste seu NFT para Aluguel",description:"Transforme NFTs parados em renda passiva. Liste no AirBNFT e ganhe dormindo.",url:X}},{id:"v7b",thumbnail:"https://img.youtube.com/vi/VIDEO_ID_HERE/maxresdefault.jpg",duration:"1:31",tag:"intermediate",en:{title:"Decentralized Notary",description:"Register documents on the blockchain forever. Immutable proof of ownership for just 1 BKC.",url:X},pt:{title:"Cartório Descentralizado",description:"Registre documentos na blockchain para sempre. Prova imutável de autoria por apenas 1 BKC.",url:X}},{id:"v8",thumbnail:"https://img.youtube.com/vi/VIDEO_ID_HERE/maxresdefault.jpg",duration:"1:34",tag:"intermediate",en:{title:"Fortune Pool - The Big Jackpot",description:"Test your luck with decentralized oracle results. Up to 100x multipliers!",url:X},pt:{title:"Fortune Pool - O Grande Jackpot",description:"Teste sua sorte com resultados de oráculo descentralizado. Multiplicadores até 100x!",url:X}},{id:"v9",thumbnail:"https://img.youtube.com/vi/VIDEO_ID_HERE/maxresdefault.jpg",duration:"1:20",tag:"beginner",en:{title:"The Backcoin Manifesto (Promo)",description:"Economy, Games, Passive Income, Utility. This is not just a token - it's a new digital economy.",url:X},pt:{title:"O Manifesto Backcoin (Promo)",description:"Economia, Jogos, Renda Passiva, Utilidade. Não é apenas um token - é uma nova economia digital.",url:X}}],advanced:[{id:"v11",thumbnail:"https://img.youtube.com/vi/VIDEO_ID_HERE/maxresdefault.jpg",duration:"1:25",tag:"advanced",en:{title:"Hub & Spoke Architecture",description:"Deep dive into Backcoin's technical architecture. How the ecosystem manager connects all services.",url:X},pt:{title:"Arquitetura Hub & Spoke",description:"Mergulho técnico na arquitetura do Backcoin. Como o gerenciador conecta todos os serviços.",url:X}},{id:"v12",thumbnail:"https://img.youtube.com/vi/VIDEO_ID_HERE/maxresdefault.jpg",duration:"1:25",tag:"advanced",en:{title:"Mining Evolution: PoW vs PoS vs Backcoin",description:"From Proof of Work to Proof of Stake to Proof of Purchase. The third generation of crypto mining.",url:X},pt:{title:"Evolução da Mineração: PoW vs PoS vs Backcoin",description:"Do Proof of Work ao Proof of Stake ao Proof of Purchase. A terceira geração de mineração.",url:X}},{id:"v13",thumbnail:"https://img.youtube.com/vi/VIDEO_ID_HERE/maxresdefault.jpg",duration:"1:25",tag:"advanced",en:{title:"The Infinite Future (Roadmap)",description:"Credit cards, insurance, DEX, lending... What's coming next in the Backcoin Super App.",url:X},pt:{title:"O Futuro Infinito (Roadmap)",description:"Cartões de crédito, seguros, DEX, empréstimos... O que vem no Super App Backcoin.",url:X}},{id:"v14",thumbnail:"https://img.youtube.com/vi/VIDEO_ID_HERE/maxresdefault.jpg",duration:"1:35",tag:"advanced",en:{title:"The New Wave of Millionaires",description:"Mathematical scarcity, revenue sharing, early adopter advantage. The wealth transfer is happening.",url:X},pt:{title:"A Nova Leva de Milionários",description:"Escassez matemática, dividendos, vantagem do early adopter. A transferência de riqueza está acontecendo.",url:X}}]},mo={en:{heroTitle:"Master the Backcoin Ecosystem",heroSubtitle:"Complete video tutorials to help you navigate staking, NFTs, Fortune Pool and more",videos:"Videos",languages:"2 Languages",catGettingStarted:"Getting Started",catGettingStartedDesc:"3 videos • Setup & First Steps",catEcosystem:"Ecosystem Features",catEcosystemDesc:"7 videos • Core Features & Tools",catAdvanced:"Advanced & Vision",catAdvancedDesc:"4 videos • Deep Dives & Future",tagBeginner:"Beginner",tagIntermediate:"Intermediate",tagAdvanced:"Advanced"},pt:{heroTitle:"Domine o Ecossistema Backcoin",heroSubtitle:"Tutoriais completos em vídeo para ajudá-lo a navegar staking, NFTs, Fortune Pool e mais",videos:"Vídeos",languages:"2 Idiomas",catGettingStarted:"Primeiros Passos",catGettingStartedDesc:"3 vídeos • Configuração Inicial",catEcosystem:"Recursos do Ecossistema",catEcosystemDesc:"7 vídeos • Ferramentas Principais",catAdvanced:"Avançado & Visão",catAdvancedDesc:"4 vídeos • Aprofundamento & Futuro",tagBeginner:"Iniciante",tagIntermediate:"Intermediário",tagAdvanced:"Avançado"}};let Wt=localStorage.getItem("backcoin-tutorials-lang")||"en";function Pb(e,t){const a=e[Wt],n=e.tag==="beginner"?"bg-emerald-500/20 text-emerald-400":e.tag==="intermediate"?"bg-amber-500/20 text-amber-400":"bg-red-500/20 text-red-400",s=mo[Wt][`tag${e.tag.charAt(0).toUpperCase()+e.tag.slice(1)}`];return`
    ...
    `}function _s(e,t,a,n,s,i,r){const o=mo[Wt];let l=`
        <div class="mb-10">
    ...
    `,d=r;return n.forEach(u=>{l+=Pb(u,d++)}),l+="</div></div>",{html:l,nextIndex:d}}function zb(e){var t,a,n,s,i,r,o,l;Wt=e,localStorage.setItem("backcoin-tutorials-lang",e),(t=document.getElementById("tutorials-btn-en"))==null||t.classList.toggle("bg-amber-500",e==="en"),(a=document.getElementById("tutorials-btn-en"))==null||a.classList.toggle("text-zinc-900",e==="en"),(n=document.getElementById("tutorials-btn-en"))==null||n.classList.toggle("bg-zinc-700",e!=="en"),(s=document.getElementById("tutorials-btn-en"))==null||s.classList.toggle("text-zinc-300",e!=="en"),(i=document.getElementById("tutorials-btn-pt"))==null||i.classList.toggle("bg-amber-500",e==="pt"),(r=document.getElementById("tutorials-btn-pt"))==null||r.classList.toggle("text-zinc-900",e==="pt"),(o=document.getElementById("tutorials-btn-pt"))==null||o.classList.toggle("bg-zinc-700",e!=="pt"),(l=document.getElementById("tutorials-btn-pt"))==null||l.classList.toggle("text-zinc-300",e!=="pt"),zd()}function zd(){const e=document.getElementById("tutorials-content");if(!e)return;const t=mo[Wt];let a=`
        <!-- Hero -->
        <div class="text-center mb-10">
    ...
    `,n=_s("getting-started","rocket","emerald",Rs.gettingStarted,"catGettingStarted","catGettingStartedDesc",0);a+=n.html,n=_s("ecosystem","cubes","amber",Rs.ecosystem,"catEcosystem","catEcosystemDesc",n.nextIndex),a+=n.html,n=_s("advanced","graduation-cap","cyan",Rs.advanced,"catAdvanced","catAdvancedDesc",n.nextIndex),a+=n.html,e.innerHTML=a}const Bd={render:function(e=!1){const t=document.getElementById("tutorials");t&&(e||t.innerHTML.trim()==="")&&(t.innerHTML=`
            ...
            `,zd())},update:function(e){},cleanup:function(){},setLang:zb};window.TutorialsPage=Bd;const fo=window.ethers,fn={ACTIVE:0,CLOSED:1},bl={0:{label:"Active",color:"#10b981",icon:"fa-circle-play",bg:"bg-emerald-500/15"},1:{label:"Closed",color:"#3b82f6",icon:"fa-circle-check",bg:"bg-blue-500/15"},2:{label:"Withdrawn",color:"#8b5cf6",icon:"fa-circle-dollar-to-slot",bg:"bg-purple-500/15"}},xs={getCampaigns:"https://getcharitycampaigns-4wvdcuoouq-uc.a.run.app",saveCampaign:"https://savecharitycampaign-4wvdcuoouq-uc.a.run.app",uploadImage:"/api/upload-image"},Nd="https://sepolia.arbiscan.io/address/",Pn={animal:"https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=800&q=80",humanitarian:"https://images.unsplash.com/photo-1469571486292-0ba58a3f068b?w=800&q=80",default:"https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?w=800&q=80"},be={animal:{name:"Animal Welfare",emoji:"🐾",color:"#10b981",gradient:"from-emerald-500/20 to-green-600/20"},humanitarian:{name:"Humanitarian Aid",emoji:"💗",color:"#ec4899",gradient:"from-pink-500/20 to-rose-600/20"}},$d=5*1024*1024,Sd=["image/jpeg","image/png","image/gif","image/webp"],k={campaigns:[],stats:null,currentView:"main",currentCampaign:null,selectedCategory:null,isLoading:!1,pendingImage:null,pendingImageFile:null,editingCampaign:null,createStep:1,createCategory:null,createTitle:"",createDesc:"",createGoal:"",createDuration:"",createImageFile:null,createImageUrl:"",createImagePreview:null};function Bb(){if(document.getElementById("charity-styles-v9"))return;const e=document.createElement("style");e.id="charity-styles-v9",e.textContent=`
        @keyframes float {
            0%, 100% { transform: translateY(0); }
    ...
    `,document.head.appendChild(e)}const ye=e=>{try{const t=Number(e)/1e18;return t<1e-4?"0":t<1?t.toFixed(4):t<1e3?t.toFixed(2):t.toLocaleString("en-US",{maximumFractionDigits:2})}catch{return"0"}},Ld=e=>e?`${e.slice(0,6)}...${e.slice(-4)}`:"",Ka=(e,t)=>{const a=typeof e=="bigint"?e:BigInt(e||0),n=typeof t=="bigint"?t:BigInt(t||1);return n===0n?0:Math.min(100,Number(a*100n/n))},Rd=e=>{const t=Math.floor(Date.now()/1e3),a=Number(e)-t;if(a<=0)return{text:"Ended",color:"#ef4444"};const n=Math.floor(a/86400);return n>0?{text:`${n}d left`,color:"#10b981"}:{text:`${Math.floor(a/3600)}h left`,color:"#f59e0b"}},hs=e=>(e==null?void 0:e.imageUrl)||Pn[e==null?void 0:e.category]||Pn.default,_d=e=>`${window.location.origin}${window.location.pathname}#charity/${e}`,Fd=()=>{const t=window.location.hash.match(/#charity\/(\d+)/);return t?t[1]:null},Nb=e=>{window.location.hash=`charity/${e}`},$b=()=>{window.location.hash.startsWith("#charity/")&&(window.location.hash="charity")},bo=e=>Number(e.status)===fn.ACTIVE&&Number(e.deadline)>Math.floor(Date.now()/1e3),Md=e=>{const t=Number(e.status),a=Number(e.deadline)<=Math.floor(Date.now()/1e3);return(t===fn.ACTIVE||t===fn.CLOSED)&&(a||t===fn.CLOSED)&&BigInt(e.raisedAmount||e.raised||0)>0n},Dd="charity-meta-";function Od(e,t){try{localStorage.setItem(`${Dd}${e}`,JSON.stringify(t))}catch{}}function Hd(e){try{return JSON.parse(localStorage.getItem(`${Dd}${e}`)||"null")}catch{return null}}async function Tt(){k.isLoading=!0;try{const[e,t]=await Promise.all([fetch(xs.getCampaigns).then(s=>s.json()).catch(()=>({campaigns:[]})),Sb()]),a=(e==null?void 0:e.campaigns)||[];let n=0;try{n=await Le.getCampaignCount()}catch(s){console.error("[CharityPage] getCampaignCount failed:",s)}if(n>0){const s=await Promise.all(Array.from({length:n},(i,r)=>r+1).map(async i=>{try{const r=await Le.getCampaign(i),o=a.find(d=>String(d.id)===String(i)),l=Hd(i);return{id:String(i),creator:r.creator,title:(o==null?void 0:o.title)||r.title||`Campaign #${i}`,description:(o==null?void 0:o.description)||(l==null?void 0:l.description)||r.metadataUri||"",metadataUri:r.metadataUri,goalAmount:r.goalAmount,raisedAmount:r.raisedAmount,raised:r.raisedAmount,donationCount:r.donationCount,deadline:r.deadline,status:r.status,isBoosted:r.isBoosted,isActive:r.isActive,progress:r.progress,category:(o==null?void 0:o.category)||(l==null?void 0:l.category)||"humanitarian",imageUrl:(o==null?void 0:o.imageUrl)||(l==null?void 0:l.imageUrl)||null}}catch(r){return console.warn(`[CharityPage] getCampaign(${i}) failed:`,r.message),null}}));k.campaigns=s.filter(Boolean)}else k.campaigns=[];k.stats=t}catch(e){console.error("[CharityPage] loadData error:",e)}finally{k.isLoading=!1}}async function Sb(){try{const e=await Le.getStats();return{raised:e.totalDonated,fees:e.totalEthFees,created:e.totalCampaigns,withdrawn:e.totalWithdrawn}}catch(e){return console.error("[CharityPage] loadStats error:",e),null}}function Lb(e,t="create"){var s;const a=(s=e.target.files)==null?void 0:s[0];if(!a)return;if(!Sd.includes(a.type)){x("Please select a valid image (JPG, PNG, GIF, WebP)","error");return}if(a.size>$d){x("Image must be less than 5MB","error");return}k.pendingImageFile=a;const n=new FileReader;n.onload=i=>{const r=t==="edit"?"edit-image-preview":"create-image-preview",o=document.getElementById(t==="edit"?"edit-image-upload":"create-image-upload"),l=document.getElementById(r);l&&(l.innerHTML=`
            ...
            `),o&&o.classList.add("has-image")},n.readAsDataURL(a)}function Rb(e="create"){k.pendingImageFile=null,k.pendingImage=null;const t=e==="edit"?"edit-image-preview":"create-image-preview",a=document.getElementById(e==="edit"?"edit-image-upload":"create-image-upload"),n=document.getElementById(t);n&&(n.innerHTML=""),a&&a.classList.remove("has-image");const s=document.getElementById(e==="edit"?"edit-image-file":"create-image-file");s&&(s.value="")}function _b(e,t="create"){document.querySelectorAll(`#${t}-image-tabs .cp-tab`).forEach(i=>i.classList.toggle("active",i.dataset.tab===e));const n=document.getElementById(`${t}-image-upload`),s=document.getElementById(`${t}-image-url-wrap`);n&&(n.style.display=e==="upload"?"block":"none"),s&&(s.style.display=e==="url"?"block":"none")}async function Ud(e){const t=new FormData;t.append("image",e);const a=await fetch(xs.uploadImage,{method:"POST",body:t,signal:AbortSignal.timeout(6e4)});if(!a.ok){const s=await a.json().catch(()=>({}));throw new Error(s.error||`Upload failed (${a.status})`)}return(await a.json()).imageUrl}const jd=e=>{const t=bl[Number(e)]||bl[0];return`<span class="cp-badge" style="background:${t.color}20;color:${t.color}"><i class="fa-solid ${t.icon}"></i> ${t.label}</span>`},Gd=()=>'<span class="cp-badge cp-boosted-badge"><i class="fa-solid fa-rocket"></i> Boosted</span>',Fb=()=>'<div class="cp-loading"><div class="cp-spinner"></div><span class="text-zinc-500">Loading campaigns...</span></div>',Wd=e=>`<div class="cp-empty"><i class="fa-solid fa-inbox"></i><h3>${e}</h3><p class="text-zinc-600 text-sm">Be the first to create a campaign!</p></div>`,Kd=e=>{var s,i,r,o;const t=Ka(e.raisedAmount,e.goalAmount),a=Rd(e.deadline),n=e.category||"humanitarian";return`
        <div class="cp-campaign-card" onclick="CharityPage.viewCampaign('${e.id}')">
            <img src="${hs(e)}" alt="${e.title}" onerror="this.src='${Pn.default}'">
            <div class="p-4">
                <div class="flex flex-wrap gap-1.5 mb-2">
                    ${jd(e.status)}
                    <span class="cp-badge" style="background:${(s=be[n])==null?void 0:s.color}20;color:${(i=be[n])==null?void 0:i.color}">
                        ${(r=be[n])==null?void 0:r.emoji} ${(o=be[n])==null?void 0:o.name}
                    </span>
                    ${e.isBoosted?Gd():""}
                </div>
                <h3 class="text-white font-bold text-sm mb-1 line-clamp-2">${e.title}</h3>
                <p class="text-zinc-500 text-xs mb-3">by <a href="${Nd}${e.creator}" target="_blank" class="text-amber-500 hover:text-amber-400">${Ld(e.creator)}</a></p>
    ...
    `},gl=()=>{var n,s,i;const e=k.campaigns.filter(r=>bo(r)),t=e.filter(r=>r.category==="animal"),a=e.filter(r=>r.category==="humanitarian");return`
        <div class="charity-page">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8 cp-cats-grid">
                <div class="cp-category-card animal ${k.selectedCategory==="animal"?"selected":""}" onclick="CharityPage.selectCat('animal')">
                    <div class="w-16 h-16 rounded-full bg-emerald-500/15 flex items-center justify-center mx-auto mb-3">
                        <span class="text-3xl">${be.animal.emoji}</span>
                    </div>
                    ...
                    <div class="flex justify-center gap-6 text-sm text-zinc-400 mb-3">
                        ...
                        <span><i class="fa-brands fa-ethereum"></i> <strong class="text-white">${ye(t.reduce((r,o)=>r+BigInt(o.raisedAmount||0),0n))}</strong></span>
                    </div>
                ...
                <div class="cp-category-card humanitarian ${k.selectedCategory==="humanitarian"?"selected":""}" onclick="CharityPage.selectCat('humanitarian')">
                    <div class="w-16 h-16 rounded-full bg-pink-500/15 flex items-center justify-center mx-auto mb-3">
                        <span class="text-3xl">${be.humanitarian.emoji}</span>
                    </div>
                    <h3 class="text-lg font-bold text-white mb-2">Humanitarian Aid</h3>
                    <div class="flex justify-center gap-6 text-sm text-zinc-400 mb-3">
                        <span><strong class="text-white">${a.length}</strong> active</span>
                        <span><i class="fa-brands fa-ethereum"></i> <strong class="text-white">${ye(a.reduce((r,o)=>r+BigInt(o.raisedAmount||0),0n))}</strong></span>
                    </div>
            ...
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-lg font-bold text-white flex items-center gap-2">
                    ${k.selectedCategory?`
                        ...
                        ${(s=be[k.selectedCategory])==null?void 0:s.emoji} ${(i=be[k.selectedCategory])==null?void 0:i.name}
                    `:`
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4" id="cp-grid">
                ${e.length?e.filter(r=>!k.selectedCategory||r.category===k.selectedCategory).sort((r,o)=>Number(o.deadline||0)-Number(r.deadline||0)).map(r=>Kd(r)).join(""):Wd("No active campaigns")}
            </div>
        </div>
    `},xl=e=>{var o,l,d,u,m,p;if(!e)return`
        <div class="charity-page">
    ...
    `;const t=Ka(e.raisedAmount,e.goalAmount),a=Rd(e.deadline),n=e.category||"humanitarian",s=bo(e),i=((o=e.creator)==null?void 0:o.toLowerCase())===((l=c==null?void 0:c.userAddress)==null?void 0:l.toLowerCase()),r=Md(e);return`
        <div class="charity-page">
            ${go()}
            ${Yd()}
            ...
            <div class="cp-detail">
                ...
                <div class="flex flex-wrap items-center gap-2 mb-4">
                    ...
                    ${jd(e.status)}
                    <span class="cp-badge" style="background:${(d=be[n])==null?void 0:d.color}20;color:${(u=be[n])==null?void 0:u.color}">
                ...
                <img src="${hs(e)}" class="cp-detail-img" onerror="this.src='${Pn.default}'">
                ...
                <div class="cp-detail-content">
                    ...
                    <div class="cp-card-base p-6">
                        ...
                        <p class="text-sm text-zinc-500 mb-4">
                            Created by <a href="${Nd}${e.creator}" target="_blank" class="text-amber-500 hover:text-amber-400">${Ld(e.creator)}</a>
                        </p>
                ...
                <div class="cp-form-group">
                    ...
                    <div class="cp-cat-selector">
                        <label class="cp-cat-option" id="edit-opt-animal" onclick="CharityPage.selCatOpt('animal','edit')">
                            ...
                            <div class="cp-cat-option-icon">${be.animal.emoji}</div>
                        ...
                        <label class="cp-cat-option" id="edit-opt-humanitarian" onclick="CharityPage.selCatOpt('humanitarian','edit')">
                            ...
                            <div class="cp-cat-option-icon">${be.humanitarian.emoji}</div>
...
`;function Ob(){[1,2,3,4].forEach(t=>{const a=document.getElementById(`cp-step-${t}`);a&&(t<k.createStep?(a.className="cp-step-dot done",a.innerHTML='<i class="fa-solid fa-check text-sm"></i>'):t===k.createStep?(a.className="cp-step-dot active",a.textContent=t):(a.className="cp-step-dot pending",a.textContent=t))}),[1,2,3].forEach(t=>{const a=document.getElementById(`cp-ln-${t}`);a&&(a.className=`cp-step-line ln-${t} ${k.createStep>t?"done":k.createStep===t?"active":""}`)});const e=document.querySelector(".charity-page .text-sm.text-zinc-500");e&&(e.textContent=`Step ${k.createStep} of 4`)}function Ya(){const e=document.getElementById("cp-wiz-panel");if(e)switch(Ob(),k.createStep){case 1:Hb(e);break;case 2:Ub(e);break;case 3:jb(e);break;case 4:Gb(e);break}}function Hb(e){e.innerHTML=`
    ...
    `}function Ub(e){const t=k.createTitle.length,a=k.createDesc.length;e.innerHTML=`
    ...
    `}function Gb(e){const t=be[k.createCategory]||be.humanitarian;e.innerHTML=`
    ...
    `}function Wb(e){k.createCategory=e,Ya()}function Kb(){var e,t,a,n,s,i;switch(k.createStep){case 1:if(!k.createCategory)return x("Select a category","error");break;case 2:{const r=((t=(e=document.getElementById("wiz-title"))==null?void 0:e.value)==null?void 0:t.trim())||"",o=((n=(a=document.getElementById("wiz-desc"))==null?void 0:a.value)==null?void 0:n.trim())||"";if(k.createTitle=r,k.createDesc=o,!r)return x("Enter a title","error");if(!o)return x("Enter a description","error");break}case 3:{const r=((i=(s=document.getElementById("wiz-image-url"))==null?void 0:s.value)==null?void 0:i.trim())||"";r&&(k.createImageUrl=r);break}}k.createStep=Math.min(4,k.createStep+1),Ya()}function Yb(){qb(),k.createStep=Math.max(1,k.createStep-1),Ya()}function Vb(){k.createImageFile=null,k.createImageUrl="",k.createImagePreview=null,k.pendingImageFile=null,k.createStep=4,Ya()}function Vd(){k.currentView="main",k.createStep=1,k.createCategory=null,k.createTitle="",k.createDesc="",k.createGoal="",k.createDuration="",k.createImageFile=null,k.createImageUrl="",k.createImagePreview=null,k.pendingImageFile=null,He()}function qb(){switch(k.createStep){case 2:{const e=document.getElementById("wiz-title"),t=document.getElementById("wiz-desc");e&&(k.createTitle=e.value),t&&(k.createDesc=t.value);break}case 3:{const e=document.getElementById("wiz-image-url");e&&(k.createImageUrl=e.value.trim());break}case 4:{const e=document.getElementById("wiz-goal"),t=document.getElementById("wiz-duration");e&&(k.createGoal=e.value),t&&(k.createDuration=t.value);break}}}function Xb(e,t){const a=t.value.length,n=e==="title"?100:2e3,s=e==="title"?80:1800,i=e==="title"?95:1950,r=document.getElementById(`wiz-${e}-count`);r&&(r.textContent=`${a}/${n}`,r.className=`cp-wiz-char-count ${a>i?"danger":a>s?"warn":""}`)}function Jb(e){var n;const t=(n=e.target.files)==null?void 0:n[0];if(!t)return;if(!Sd.includes(t.type)){x("Please select a valid image (JPG, PNG, GIF, WebP)","error");return}if(t.size>$d){x("Image must be less than 5MB","error");return}k.createImageFile=t,k.pendingImageFile=t;const a=new FileReader;a.onload=s=>{k.createImagePreview=s.target.result;const i=document.getElementById("wiz-image-preview");i&&(i.innerHTML=`
                <img src="${s.target.result}" class="cp-image-preview">
                <button type="button" class="cp-image-remove" onclick="event.stopPropagation();CharityPage.removeWizardImage()">
                    <i class="fa-solid fa-xmark"></i> Remove
                </button>
            `)},a.readAsDataURL(t)}function Zb(){k.createImageFile=null,k.createImagePreview=null,k.createImageUrl="",k.pendingImageFile=null;const e=document.getElementById("wiz-image-preview");e&&(e.innerHTML=`
            <div class="cp-image-upload-icon"><i class="fa-solid fa-cloud-arrow-up"></i></div>
            <div class="cp-image-upload-text"><span>Click to upload</span> or drag and drop<br><small>PNG, JPG, GIF, WebP &mdash; max 5MB</small></div>
        `);const t=document.getElementById("wiz-image-file");t&&(t.value="")}async function Qb(){var l,d;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=(l=document.getElementById("wiz-goal"))==null?void 0:l.value,t=(d=document.getElementById("wiz-duration"))==null?void 0:d.value;if(k.createGoal=e||"",k.createDuration=t||"",!k.createCategory)return x("Select a category","error");if(!k.createTitle)return x("Enter a title","error");if(!k.createDesc)return x("Enter a description","error");if(!e||parseFloat(e)<.01)return x("Goal must be at least 0.01 ETH","error");if(!t||parseInt(t)<1||parseInt(t)>365)return x("Duration must be 1-365 days","error");let a=k.createImageUrl||"";if(k.createImageFile)try{x("Uploading image to IPFS...","info"),a=await Ud(k.createImageFile),x("Image uploaded!","success")}catch(u){console.error("Image upload failed:",u),x("Image upload failed - campaign will be created without image","warning")}const n=k.createTitle,s=k.createDesc,i=k.createCategory,r=fo.parseEther(e),o=parseInt(t);await Le.createCampaign({title:n,metadataUri:s,goalAmount:r,durationDays:o,button:document.getElementById("btn-wizard-launch"),onSuccess:async(u,m)=>{if(m){Od(m,{imageUrl:a,category:i,title:n,description:s});try{await fetch(xs.saveCampaign,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:m,title:n,description:s,category:i,imageUrl:a,creator:c.userAddress})})}catch{}}x("Campaign created!","success"),Vd(),await Tt(),He()},onError:u=>{var m;!u.cancelled&&u.type!=="user_rejected"&&x(((m=u.message)==null?void 0:m.slice(0,80))||"Failed","error")}})}function vs(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.add("active")}function Dt(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.remove("active")}function eg(e=null){k.createStep=e?2:1,k.createCategory=e,k.createTitle="",k.createDesc="",k.createGoal="",k.createDuration="",k.createImageFile=null,k.createImageUrl="",k.createImagePreview=null,k.pendingImageFile=null,k.currentView="create",He()}function tg(e){const t=k.campaigns.find(s=>s.id===e||s.id===String(e));if(!t)return;const a=document.getElementById("donate-campaign-info");a&&(a.innerHTML=`
            <div class="flex items-center gap-3 p-3 bg-zinc-800/50 rounded-xl mb-4">
                <img src="${hs(t)}" class="w-12 h-12 rounded-lg object-cover">
        ...
        `);const n=document.getElementById("donate-amount");n&&(n.value=""),k.currentCampaign=t,vs("donate")}function ag(){var n;const e=(n=c==null?void 0:c.userAddress)==null?void 0:n.toLowerCase(),t=k.campaigns.filter(s=>{var i;return((i=s.creator)==null?void 0:i.toLowerCase())===e}),a=document.getElementById("my-campaigns-list");a&&(t.length===0?a.innerHTML=`
            <div class="cp-empty">
        ...
        `:a.innerHTML=t.map(s=>{const i=Ka(s.raisedAmount,s.goalAmount),r=Md(s);return`
                <div class="flex items-center gap-3 p-3 bg-zinc-800/30 rounded-xl mb-2 hover:bg-zinc-800/50 transition-colors">
                    <img src="${hs(s)}" class="w-14 h-14 rounded-lg object-cover cursor-pointer" onclick="CharityPage.viewCampaign('${s.id}')">
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-zinc-500 text-xs"><i class="fa-brands fa-ethereum"></i> ${ye(s.raisedAmount)} / ${ye(s.goalAmount)} ETH (${i}%)</p>
                    </div>
                    <div class="flex gap-2">
            ...
            `}).join(""),vs("my"))}function ng(e){var n,s,i;const t=k.campaigns.find(r=>r.id===e||r.id===String(e));if(!t)return;if(((n=t.creator)==null?void 0:n.toLowerCase())!==((s=c==null?void 0:c.userAddress)==null?void 0:s.toLowerCase())){x("Not your campaign","error");return}k.editingCampaign=t,k.pendingImageFile=null,document.getElementById("edit-campaign-id").value=t.id,document.getElementById("edit-title").value=t.title||"",document.getElementById("edit-desc").value=t.description||"",document.getElementById("edit-image-url").value=t.imageUrl||"",document.querySelectorAll("#modal-edit .cp-cat-option").forEach(r=>r.classList.remove("selected")),(i=document.getElementById(`edit-opt-${t.category||"humanitarian"}`))==null||i.classList.add("selected");const a=document.getElementById("edit-image-preview");a&&t.imageUrl?a.innerHTML=`<img src="${t.imageUrl}" class="cp-image-preview">`:a&&(a.innerHTML=""),vs("edit")}function sg(e,t="create"){var s;const a=t==="edit"?"edit-opt-":"opt-",n=t==="edit"?"#modal-edit":"#modal-create";document.querySelectorAll(`${n} .cp-cat-option`).forEach(i=>i.classList.remove("selected")),(s=document.getElementById(`${a}${e}`))==null||s.classList.add("selected")}function ig(e){const t=document.getElementById("donate-amount")||document.getElementById("detail-amount");t&&(t.value=e)}async function rg(){var n;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=k.currentCampaign;if(!e)return;const t=(n=document.getElementById("donate-amount"))==null?void 0:n.value;if(!t||parseFloat(t)<.001)return x("Minimum 0.001 ETH","error");const a=fo.parseEther(t);await Le.donate({campaignId:e.id,amount:a,button:document.getElementById("btn-donate"),onSuccess:async()=>{x("Thank you for your donation!","success"),Dt("donate"),await Tt(),He()},onError:s=>{var i;!s.cancelled&&s.type!=="user_rejected"&&x(((i=s.message)==null?void 0:i.slice(0,80))||"Failed","error")}})}async function og(e){var n;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const t=(n=document.getElementById("detail-amount"))==null?void 0:n.value;if(!t||parseFloat(t)<.001)return x("Minimum 0.001 ETH","error");const a=fo.parseEther(t);await Le.donate({campaignId:e,amount:a,button:document.getElementById("btn-donate-detail"),onSuccess:async()=>{x("Thank you for your donation!","success"),await Tt(),await Ct(e)},onError:s=>{var i;!s.cancelled&&s.type!=="user_rejected"&&x(((i=s.message)==null?void 0:i.slice(0,80))||"Failed","error")}})}async function hl(e){if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");confirm("Close this campaign? You can still withdraw raised funds.")&&await Le.closeCampaign({campaignId:e,button:document.getElementById("btn-close-campaign"),onSuccess:async()=>{x("Campaign closed","success"),await Tt(),He()},onError:t=>{var a;!t.cancelled&&t.type!=="user_rejected"&&x(((a=t.message)==null?void 0:a.slice(0,80))||"Failed","error")}})}async function lg(e){if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const t=k.campaigns.find(s=>s.id===e||s.id===String(e));if(!t)return;const a=Ka(t.raisedAmount,t.goalAmount);let n=`Withdraw ${ye(t.raisedAmount)} ETH?`;a<100&&(n+=`
Goal not reached - partial withdrawal.`),confirm(n)&&await Le.withdraw({campaignId:e,button:document.getElementById(`btn-withdraw-${e}`)||document.getElementById("btn-withdraw"),onSuccess:async()=>{var s;x("Funds withdrawn successfully!","success"),Dt("my"),await Tt(),He(),((s=k.currentCampaign)==null?void 0:s.id)===e&&await Ct(e)},onError:s=>{var i;!s.cancelled&&s.type!=="user_rejected"&&x(((i=s.message)==null?void 0:i.slice(0,80))||"Failed","error")}})}async function cg(e){if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");confirm("Boost this campaign for visibility? A small ETH fee applies.")&&await Le.boostCampaign({campaignId:e,onSuccess:async()=>{var t;x("Campaign boosted!","success"),await Tt(),((t=k.currentCampaign)==null?void 0:t.id)===String(e)?await Ct(e):He()},onError:t=>{var a;!t.cancelled&&t.type!=="user_rejected"&&x(((a=t.message)==null?void 0:a.slice(0,80))||"Failed","error")}})}async function dg(){var o,l,d,u,m,p,g,b;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=(o=document.getElementById("edit-campaign-id"))==null?void 0:o.value,t=(d=(l=document.getElementById("edit-title"))==null?void 0:l.value)==null?void 0:d.trim(),a=(m=(u=document.getElementById("edit-desc"))==null?void 0:u.value)==null?void 0:m.trim();let n=(g=(p=document.getElementById("edit-image-url"))==null?void 0:p.value)==null?void 0:g.trim();const s=document.querySelector("#modal-edit .cp-cat-option.selected input"),i=(s==null?void 0:s.value)||"humanitarian";if(!t)return x("Enter title","error");if(k.pendingImageFile)try{x("Uploading image...","info"),n=await Ud(k.pendingImageFile)}catch(w){console.error("Image upload failed:",w)}const r=document.getElementById("btn-save-edit");r&&(r.disabled=!0,r.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Saving...');try{Od(e,{imageUrl:n,category:i,title:t,description:a}),await fetch(xs.saveCampaign,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:e,title:t,description:a,category:i,imageUrl:n,creator:c.userAddress})}),x("Campaign updated!","success"),Dt("edit"),k.pendingImageFile=null,await Tt(),((b=k.currentCampaign)==null?void 0:b.id)===e?await Ct(e):He()}catch{x("Failed to save","error")}finally{r&&(r.disabled=!1,r.innerHTML='<i class="fa-solid fa-check"></i> Save')}}function ug(e){const t=k.currentCampaign;if(!t)return;const a=_d(t.id),n=`Support "${t.title}" on Backcoin Charity!

${ye(t.raisedAmount)} raised of ${ye(t.goalAmount)} goal.

`;let s;e==="twitter"?s=`https://twitter.com/intent/tweet?text=${encodeURIComponent(n)}&url=${encodeURIComponent(a)}`:e==="telegram"?s=`https://t.me/share/url?url=${encodeURIComponent(a)}&text=${encodeURIComponent(n)}`:e==="whatsapp"&&(s=`https://wa.me/?text=${encodeURIComponent(n+a)}`),s&&window.open(s,"_blank","width=600,height=400")}function pg(){const e=k.currentCampaign;e&&navigator.clipboard.writeText(_d(e.id)).then(()=>x("Link copied!","success")).catch(()=>x("Copy failed","error"))}function qd(){$b(),k.currentCampaign=null,k.currentView="main",He()}function mg(e){Dt("my"),Dt("donate"),Dt("edit"),Nb(e),Ct(e)}function fg(e){k.selectedCategory=k.selectedCategory===e?null:e,xo()}function bg(){k.selectedCategory=null,xo()}function xo(){const e=document.getElementById("cp-grid");if(!e)return;let t=k.campaigns.filter(a=>bo(a));k.selectedCategory&&(t=t.filter(a=>a.category===k.selectedCategory)),t.sort((a,n)=>Number(n.deadline||0)-Number(a.deadline||0)),e.innerHTML=t.length?t.map(a=>Kd(a)).join(""):Wd("No campaigns")}async function Ct(e){k.currentView="detail",k.isLoading=!0;const t=ni();t&&(t.innerHTML=Fb());try{let a=k.campaigns.find(n=>n.id===e||n.id===String(e));if(!a)try{const n=await Le.getCampaign(e),s=Hd(e);a={id:String(e),creator:n.creator,title:n.title||`Campaign #${e}`,description:(s==null?void 0:s.description)||n.metadataUri||"",metadataUri:n.metadataUri,goalAmount:n.goalAmount,raisedAmount:n.raisedAmount,raised:n.raisedAmount,donationCount:n.donationCount,deadline:n.deadline,status:n.status,isBoosted:n.isBoosted,isActive:n.isActive,progress:n.progress,category:(s==null?void 0:s.category)||"humanitarian",imageUrl:(s==null?void 0:s.imageUrl)||null}}catch(n){console.error(`[CharityPage] loadDetail(${e}) failed:`,n)}k.currentCampaign=a,t&&(t.innerHTML=xl(a))}catch{t&&(t.innerHTML=xl(null))}finally{k.isLoading=!1}}function ni(){let e=document.getElementById("charity-container");if(e)return e;const t=document.getElementById("charity");return t?(e=document.createElement("div"),e.id="charity-container",t.innerHTML="",t.appendChild(e),e):null}function He(){Bb();const e=ni();if(!e)return;if(k.currentView==="create"){e.innerHTML=Db(),Ya();return}const t=Fd();t?Ct(t):(k.currentView="main",k.currentCampaign=null,e.innerHTML=gl(),Tt().then(()=>{if(k.currentView==="main"){const a=ni();a&&(a.innerHTML=gl())}}))}async function gg(){k.campaigns=[],k.stats=null,k.currentView==="detail"&&k.currentCampaign?await Ct(k.currentCampaign.id):He()}window.addEventListener("hashchange",()=>{var e;if(window.location.hash.startsWith("#charity")){const t=Fd();t?((e=k.currentCampaign)==null?void 0:e.id)!==t&&Ct(t):k.currentView!=="main"&&qd()}});const xg={render(e){e&&He()},update(){k.currentView==="main"&&xo()},refresh:gg,openModal:vs,closeModal:Dt,openCreate:eg,openDonate:tg,openMyCampaigns:ag,openEdit:ng,donate:rg,donateDetail:og,closeCampaign:hl,cancel:hl,withdraw:lg,boostCampaign:cg,saveEdit:dg,selCatOpt:sg,setAmt:ig,goBack:qd,viewCampaign:mg,selectCat:fg,clearCat:bg,share:ug,copyLink:pg,handleImageSelect:Lb,removeImage:Rb,switchImageTab:_b,wizardSelectCategory:Wb,wizardNext:Kb,wizardBack:Yb,wizardSkipImage:Vb,cancelCreate:Vd,wizardUpdateCharCount:Xb,handleWizardImageSelect:Jb,removeWizardImage:Zb,wizardLaunch:Qb},at=window.ethers,Xd="https://sepolia.arbiscan.io/address/",hg=Rl,vt=500,_a=[{id:0,name:"General",icon:"fa-globe",color:"#8b8b9e"},{id:1,name:"DeFi",icon:"fa-chart-line",color:"#22c55e"},{id:2,name:"NFT",icon:"fa-gem",color:"#8b5cf6"},{id:3,name:"Gaming",icon:"fa-gamepad",color:"#ec4899"},{id:4,name:"Tech",icon:"fa-microchip",color:"#3b82f6"},{id:5,name:"News",icon:"fa-newspaper",color:"#f59e0b"},{id:6,name:"Meme",icon:"fa-face-laugh-squint",color:"#facc15"},{id:7,name:"Alpha",icon:"fa-fire",color:"#ef4444"},{id:8,name:"DAO",icon:"fa-landmark",color:"#06b6d4"},{id:9,name:"Learn",icon:"fa-graduation-cap",color:"#14b8a6"},{id:10,name:"Art",icon:"fa-palette",color:"#f472b6"},{id:11,name:"Music",icon:"fa-music",color:"#a78bfa"},{id:12,name:"Sports",icon:"fa-futbol",color:"#fb923c"},{id:13,name:"Food",icon:"fa-utensils",color:"#fbbf24"},{id:14,name:"Other",icon:"fa-hashtag",color:"#6b7280"}];function Jd(){return v.agora||v.backchat||v.Backchat||null}function Je(){return v.operator||v.treasury||null}const f={view:"feed",activeTab:"feed",viewHistory:[],posts:[],trendingPosts:[],allItems:[],replies:new Map,likesMap:new Map,replyCountMap:new Map,repostCountMap:new Map,postsById:new Map,userProfile:null,profiles:new Map,hasProfile:null,following:new Set,followers:new Set,followCounts:new Map,pendingImage:null,pendingImagePreview:null,isUploadingImage:!1,selectedPost:null,selectedProfile:null,wizStep:1,wizUsername:"",wizDisplayName:"",wizBio:"",wizUsernameOk:null,wizFee:null,wizChecking:!1,fees:{post:0n,reply:0n,like:0n,follow:0n,repost:0n,superLikeMin:0n,downvoteMin:0n,boostMin:0n,badge:0n},hasBadge:!1,isBoosted:!1,boostExpiry:0,badgeExpiry:0,selectedTag:-1,composeTag:0,globalStats:null,isLoading:!1,isPosting:!1,contractAvailable:!0,error:null};function vg(){if(document.getElementById("agora-styles-v11"))return;const e=document.getElementById("backchat-styles-v70");e&&e.remove();const t=document.createElement("style");t.id="agora-styles-v11",t.textContent=`
        :root {
    ...
    `,document.head.appendChild(t)}function zn(e){return e?`${e.slice(0,6)}...${e.slice(-4)}`:""}function wg(e){const a=Date.now()/1e3-e;return a<60?"now":a<3600?`${Math.floor(a/60)}m`:a<86400?`${Math.floor(a/3600)}h`:a<604800?`${Math.floor(a/86400)}d`:new Date(e*1e3).toLocaleDateString("en-US",{month:"short",day:"numeric"})}function Fa(e){if(!e||e===0n)return"0";const t=parseFloat(at.formatEther(e));return t<1e-4?"<0.0001":t<.01?t.toFixed(4):t<1?t.toFixed(3):t.toFixed(2)}function ws(e){return e?e.slice(2,4).toUpperCase():"?"}function De(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}function vl(e){if(!e)return{displayName:"",bio:""};try{const t=JSON.parse(e);return{displayName:t.displayName||"",bio:t.bio||""}}catch{return{displayName:"",bio:""}}}function Pa(e){if(!e)return"?";const t=f.profiles.get(e.toLowerCase());return t!=null&&t.displayName?t.displayName:t!=null&&t.username?`@${t.username}`:zn(e)}function yg(e){var t;return e&&((t=f.profiles.get(e.toLowerCase()))==null?void 0:t.username)||null}function kg(e){var t;return(e==null?void 0:e.toLowerCase())===((t=c.userAddress)==null?void 0:t.toLowerCase())?f.isBoosted:!1}function Eg(e){var t;return(e==null?void 0:e.toLowerCase())===((t=c.userAddress)==null?void 0:t.toLowerCase())?f.hasBadge:!1}function wl(e){if(!e)return{text:"",mediaCID:""};const t=e.indexOf(`
[img]`);return t!==-1?{text:e.slice(0,t),mediaCID:e.slice(t+6).trim()}:{text:e,mediaCID:""}}function Tg(e){return _a[e]||_a[0]}function sn(e,t){f.viewHistory.push({view:f.view,activeTab:f.activeTab,selectedPost:f.selectedPost,selectedProfile:f.selectedProfile}),f.view=e,t!=null&&t.post&&(f.selectedPost=t.post),t!=null&&t.profile&&(f.selectedProfile=t.profile),Ot()}function Cg(){if(f.viewHistory.length>0){const e=f.viewHistory.pop();f.view=e.view,f.activeTab=e.activeTab||f.view,f.selectedPost=e.selectedPost,f.selectedProfile=e.selectedProfile}else f.view="feed",f.activeTab="feed";Ot()}function ys(){if(c.agoraContract)return c.agoraContract;if(c.agoraContractPublic)return c.agoraContractPublic;const e=Jd();return e&&c.publicProvider?new at.Contract(e,la,c.publicProvider):null}async function yl(){try{const e=ys();if(!e)return;let t=100000000n;try{t=await e.VOTE_PRICE()}catch{}const a=at.parseEther("0.0001");f.fees={post:a,reply:a,like:a,follow:a,repost:a,superLikeMin:t,downvoteMin:t,boostMin:at.parseEther("0.0005"),badge:at.parseEther("0.001")}}catch(e){console.warn("[Agora] Failed to load fees:",e.message)}}async function kl(){if(!(!c.isConnected||!c.userAddress))try{const e=ys();if(!e)return;const[t,a,n]=await Promise.all([e.getUserProfile(c.userAddress).catch(()=>null),e.hasTrustBadge(c.userAddress).catch(()=>!1),e.isProfileBoosted(c.userAddress).catch(()=>!1)]);f.hasBadge=a,f.isBoosted=n,f.boostExpiry=t?Number(t.boostExp||t[5]||0):0,f.badgeExpiry=t?Number(t.badgeExp||t[6]||0):0}catch(e){console.warn("[Agora] Failed to load user status:",e.message)}}async function El(){try{const e=await me.getGlobalStats();f.globalStats=e}catch(e){console.warn("[Agora] Failed to load global stats:",e.message)}}async function Tl(){try{const e=ys();if(!e){f.hasProfile=!1;return}const t=await e.queryFilter(e.filters.ProfileCreated(),-5e4).catch(()=>[]);for(const a of t){const n=a.args.user.toLowerCase(),s=vl(a.args.metadataURI);f.profiles.set(n,{username:a.args.username,metadataURI:a.args.metadataURI||"",displayName:s.displayName,bio:s.bio})}if(c.isConnected&&c.userAddress){const a=c.userAddress.toLowerCase();let n=f.profiles.get(a);if(!n)try{const s=await e.getUserProfile(c.userAddress);if(s&&s.usernameHash&&s.usernameHash!==at.ZeroHash){const i=vl(s.metadataURI||s[1]||"");n={username:null,metadataURI:s.metadataURI||s[1]||"",displayName:i.displayName,bio:i.bio},f.profiles.set(a,n)}}catch{}n?(f.userProfile={...n,address:c.userAddress},f.hasProfile=!0):(f.hasProfile=!1,f.userProfile=null)}else f.hasProfile=!1;console.log("[Agora] Profiles loaded:",f.profiles.size,"| hasProfile:",f.hasProfile)}catch(e){console.warn("[Agora] Failed to load profiles:",e.message),f.hasProfile=!1}ie()}async function Cl(){f.following=new Set,f.followers=new Set,f.followCounts=new Map}async function rt(){var e,t;f.isLoading=!0,ie();try{if(!Jd()){f.contractAvailable=!1,f.error="Agora contract not deployed yet.";return}const n=ys();if(!n){f.contractAvailable=!1,f.error="Could not connect to Agora contract";return}f.contractAvailable=!0;const[s,i,r]=await Promise.all([n.queryFilter(n.filters.PostCreated(),-5e4).catch(()=>[]),n.queryFilter(n.filters.ReplyCreated(),-5e4).catch(()=>[]),n.queryFilter(n.filters.RepostCreated(),-5e4).catch(()=>[])]),o=[];for(const u of s.slice(-80))o.push({ev:u,type:"post"});for(const u of i.slice(-60))o.push({ev:u,type:"reply"});for(const u of r.slice(-30))o.push({ev:u,type:"repost"});const l=[],d=[];f.postsById=new Map,f.replies=new Map,f.replyCountMap=new Map,f.repostCountMap=new Map,f.likesMap=new Map;for(let u=0;u<o.length;u+=10){const m=o.slice(u,u+10),p=await Promise.all(m.map(({ev:g})=>{const b=g.args.postId||g.args.newPostId;return n.getPost(b).catch(()=>null)}));for(let g=0;g<m.length;g++){const{ev:b,type:w}=m[g],y=p[g],C=(b.args.postId||b.args.newPostId).toString();if(y&&y.deleted)continue;const I=y?Number(y.createdAt||y[4]||0):0,z=y?Number(y.likes||y[7]||0):0,L=y?BigInt(y.superLikes||y[8]||0):0n,B=y?Number(y.downvotes||y[9]||0):0,A=y?Number(y.replies||y[10]||0):0,_=y?Number(y.reposts||y[11]||0):0,D=y?Number(y.tag||y[1]||0):0;if(w==="post"){const{text:j,mediaCID:H}=wl(b.args.contentHash||b.args.content||""),de={id:C,type:"post",author:b.args.author,content:j,mediaCID:H,tag:b.args.tag!=null?Number(b.args.tag):D,timestamp:I,superLikes:L,likesCount:z,downvotesCount:B,repliesCount:A,repostsCount:_,txHash:b.transactionHash};l.push(de),d.push(de),f.postsById.set(C,de)}else if(w==="reply"){const j=b.args.parentId.toString(),{text:H,mediaCID:de}=wl(b.args.contentHash||b.args.content||""),se={id:C,type:"reply",parentId:j,author:b.args.author,content:H,mediaCID:de,tag:b.args.tag!=null?Number(b.args.tag):D,timestamp:I,superLikes:L,likesCount:z,downvotesCount:B,txHash:b.transactionHash};l.push(se),f.postsById.set(C,se),f.replies.has(j)||f.replies.set(j,[]),f.replies.get(j).push(se),f.replyCountMap.set(j,(f.replyCountMap.get(j)||0)+1)}else if(w==="repost"){const j=((e=b.args.originalId)==null?void 0:e.toString())||((t=b.args.originalPostId)==null?void 0:t.toString())||"0",H={id:C,type:"repost",originalPostId:j,author:b.args.author||b.args.reposter,timestamp:I,superLikes:0n,txHash:b.transactionHash};l.push(H),d.push(H),f.postsById.set(C,H),f.repostCountMap.set(j,(f.repostCountMap.get(j)||0)+1)}}}if(c.isConnected&&c.userAddress){const u=l.filter(m=>m.type!=="repost").map(m=>m.id);for(let m=0;m<u.length;m+=10){const p=u.slice(m,m+10),g=await Promise.all(p.map(b=>n.hasLiked(b,c.userAddress).catch(()=>!1)));for(let b=0;b<p.length;b++)g[b]&&(f.likesMap.has(p[b])||f.likesMap.set(p[b],new Set),f.likesMap.get(p[b]).add(c.userAddress.toLowerCase()))}}d.sort((u,m)=>m.timestamp-u.timestamp),f.posts=d,f.allItems=l,f.trendingPosts=[...l].filter(u=>u.type!=="repost"&&u.superLikes>0n).sort((u,m)=>{const p=BigInt(u.superLikes||0),g=BigInt(m.superLikes||0);return g>p?1:g<p?-1:0})}catch(a){console.error("[Agora] Failed to load posts:",a),f.error=a.message}finally{f.isLoading=!1,ie()}}async function Ig(){var i;const e=document.getElementById("bc-compose-input"),t=(i=e==null?void 0:e.value)==null?void 0:i.trim();if(!t){x("Please write something","error");return}if(t.length>vt){x(`Post too long (max ${vt} chars)`,"error");return}f.isPosting=!0,ie();let a=t,n=0;if(f.pendingImage)try{f.isUploadingImage=!0,ie();const o=(await Og(f.pendingImage)).ipfsHash||"";o&&(a=t+`
[img]`+o,n=1)}catch(r){x("Image upload failed: "+r.message,"error"),f.isPosting=!1,f.isUploadingImage=!1,ie();return}finally{f.isUploadingImage=!1}const s=document.getElementById("bc-post-btn");await me.createPost({content:a,tag:f.composeTag,contentType:n,operator:Je(),button:s,onSuccess:async()=>{e&&(e.value=""),f.pendingImage=null,f.pendingImagePreview=null,f.composeTag=0,f.isPosting=!1,x("Post created!","success"),await rt()},onError:()=>{f.isPosting=!1,ie()}}),f.isPosting=!1,ie()}async function Ag(e){var s;const t=document.getElementById("bc-reply-input"),a=(s=t==null?void 0:t.value)==null?void 0:s.trim();if(!a){x("Please write a reply","error");return}const n=document.getElementById("bc-reply-btn");await me.createReply({parentId:e,content:a,contentType:0,operator:Je(),button:n,onSuccess:async()=>{t&&(t.value=""),x("Reply posted!","success"),await rt(),ie()}})}async function Pg(e){const t=document.getElementById("bc-repost-confirm-btn");await me.createRepost({originalPostId:e,operator:Je(),button:t,onSuccess:async()=>{ct("repost"),x("Reposted!","success"),await rt()}})}async function zg(e){var a;const t=(a=c.userAddress)==null?void 0:a.toLowerCase();t&&(f.likesMap.has(e)||f.likesMap.set(e,new Set),f.likesMap.get(e).add(t),ie()),await me.like({postId:e,operator:Je(),onSuccess:()=>x("Liked!","success"),onError:()=>{var n;(n=f.likesMap.get(e))==null||n.delete(t),ie()}})}async function Bg(e,t){const a=at.parseEther(t);await me.superLike({postId:e,ethAmount:a,operator:Je(),onSuccess:async()=>{x("Super Liked!","success"),await rt()}})}async function Ng(e,t){const a=at.parseEther(t);await me.downvote({postId:e,ethAmount:a,operator:Je(),onSuccess:async()=>{x("Downvoted","success"),await rt()}})}async function $g(e){await me.deletePost({postId:e,onSuccess:async()=>{x("Post deleted","success"),await rt()}})}async function Sg(e){await me.pinPost({postId:e,onSuccess:async()=>{x("Post pinned!","success"),await rt()}})}async function Lg(e){await me.follow({toFollow:e,operator:Je(),onSuccess:()=>{f.following.add(e.toLowerCase()),x("Followed!","success"),ie()}})}async function Rg(e){await me.unfollow({toUnfollow:e,onSuccess:()=>{f.following.delete(e.toLowerCase()),x("Unfollowed","success"),ie()}})}async function _g(){const e=JSON.stringify({displayName:f.wizDisplayName,bio:f.wizBio}),t=document.getElementById("bc-wizard-confirm-btn");await me.createProfile({username:f.wizUsername,metadataURI:e,operator:Je(),button:t,onSuccess:async()=>{x("Profile created!","success"),f.hasProfile=!0,f.userProfile={username:f.wizUsername,displayName:f.wizDisplayName,bio:f.wizBio,address:c.userAddress},f.profiles.set(c.userAddress.toLowerCase(),{username:f.wizUsername,displayName:f.wizDisplayName,bio:f.wizBio}),f.wizStep=1,f.wizUsername="",f.wizDisplayName="",f.wizBio="",f.view="profile",f.activeTab="profile",Ot()}})}async function Fg(){var s,i,r,o;const e=((i=(s=document.getElementById("edit-displayname"))==null?void 0:s.value)==null?void 0:i.trim())||"",t=((o=(r=document.getElementById("edit-bio"))==null?void 0:r.value)==null?void 0:o.trim())||"",a=JSON.stringify({displayName:e,bio:t}),n=document.getElementById("bc-edit-profile-btn");await me.updateProfile({metadataURI:a,button:n,onSuccess:()=>{f.userProfile.displayName=e,f.userProfile.bio=t,f.profiles.set(c.userAddress.toLowerCase(),{...f.profiles.get(c.userAddress.toLowerCase()),displayName:e,bio:t}),ct("edit-profile"),x("Profile updated!","success"),ie()}})}async function Mg(){await me.obtainBadge({operator:Je(),onSuccess:()=>{f.hasBadge=!0,ct("badge"),x("Badge obtained!","success"),ie()}})}async function Dg(e){const t=at.parseEther(e);await me.boostProfile({ethAmount:t,operator:Je(),onSuccess:()=>{f.isBoosted=!0,ct("boost"),x("Profile boosted!","success"),ie()}})}async function Og(e){const t=new FormData;t.append("image",e);const a=new AbortController,n=setTimeout(()=>a.abort(),6e4);try{const s=await fetch("/api/upload-image",{method:"POST",body:t,signal:a.signal});if(clearTimeout(n),!s.ok){const i=await s.json().catch(()=>({}));throw new Error(i.error||`Upload failed (${s.status})`)}return await s.json()}catch(s){throw clearTimeout(n),s}}function Hg(e){var n,s;const t=(s=(n=e.target)==null?void 0:n.files)==null?void 0:s[0];if(!t)return;if(t.size>5*1024*1024){x("Image too large. Maximum 5MB.","error");return}if(!["image/jpeg","image/png","image/gif","image/webp"].includes(t.type)){x("Invalid image type.","error");return}f.pendingImage=t;const a=new FileReader;a.onload=i=>{f.pendingImagePreview=i.target.result,ie()},a.readAsDataURL(t)}function Ug(){f.pendingImage=null,f.pendingImagePreview=null;const e=document.getElementById("bc-image-input");e&&(e.value=""),ie()}let Il=null;function jg(e){f.wizUsername=e.toLowerCase().replace(/[^a-z0-9_]/g,""),f.wizUsernameOk=null,f.wizFee=null,clearTimeout(Il);const t=document.getElementById("wiz-username-input");t&&(t.value=f.wizUsername),f.wizUsername.length>=1&&f.wizUsername.length<=15?(f.wizChecking=!0,Fs(),Il=setTimeout(async()=>{try{const[a,n]=await Promise.all([me.isUsernameAvailable(f.wizUsername),me.getUsernamePrice(f.wizUsername.length)]);f.wizUsernameOk=a,f.wizFee=n.formatted}catch(a){console.warn("Username check failed:",a)}f.wizChecking=!1,Fs()},600)):(f.wizChecking=!1,Fs())}function Fs(){const e=document.getElementById("wiz-username-status");e&&(f.wizChecking?e.innerHTML='<span class="bc-username-checking"><i class="fa-solid fa-spinner fa-spin"></i> Checking...</span>':f.wizUsernameOk===!0?e.innerHTML=`<span class="bc-username-ok"><i class="fa-solid fa-check"></i> Available</span>
                ${f.wizFee&&f.wizFee!=="0.0"?`<span class="bc-username-fee">${f.wizFee} ETH</span>`:'<span class="bc-username-fee">FREE</span>'}`:f.wizUsernameOk===!1?e.innerHTML='<span class="bc-username-taken"><i class="fa-solid fa-xmark"></i> Taken</span>':e.innerHTML="");const t=document.querySelector(".bc-wizard-nav .bc-btn-primary");t&&f.wizStep===1&&(t.disabled=!f.wizUsernameOk)}function Gg(){if(["post-detail","user-profile","profile-setup"].includes(f.view)){let t="Post";return f.view==="user-profile"&&(t=Pa(f.selectedProfile)),f.view==="profile-setup"&&(t="Create Profile"),`
            <div class="bc-header">
        ...
        </div>`}function Al(){let t=`<div class="bc-tag-bar">
        <button class="bc-tag-pill ${f.selectedTag===-1?"active":""}" onclick="BackchatPage.filterTag(-1)"><i class="fa-solid fa-layer-group"></i> All</button>`;for(const a of _a){const n=f.selectedTag===a.id?"active":"";t+=`<button class="bc-tag-pill ${n}" onclick="BackchatPage.filterTag(${a.id})" style="${n?"":`color:${a.color}`}"><i class="fa-solid ${a.icon}"></i> ${a.name}</button>`}return t+="</div>",t}function Wg(){let e='<div class="bc-compose-tags">';for(const t of _a){const a=f.composeTag===t.id?"active":"";e+=`<button class="bc-compose-tag ${a}" onclick="BackchatPage.setComposeTag(${t.id})">${t.name}</button>`}return e+="</div>",e}function Pl(){var a;if(!c.isConnected)return"";const e=Fa(f.fees.post);return`
        ...
        <div class="bc-compose">
            <div class="bc-compose-row">
                <div class="bc-compose-avatar">
                    ${(a=f.userProfile)!=null&&a.username?f.userProfile.username.charAt(0).toUpperCase():ws(c.userAddress)}
                </div>
                <div class="bc-compose-body">
                    <textarea id="bc-compose-input" class="bc-compose-textarea" placeholder="What's happening on-chain?" maxlength="${vt}" oninput="BackchatPage._updateCharCount(this)"></textarea>
            ...
            <div class="bc-compose-bottom">
                ...
                <div class="bc-compose-right">
                    <span class="bc-char-count" id="bc-char-counter">0/${vt}</span>
        ...
        </div>`}function Kg(e){var a,n;return!(((a=e.author)==null?void 0:a.toLowerCase())===((n=c.userAddress)==null?void 0:n.toLowerCase()))||!c.isConnected?"":`
        ...
        </div>`}function Kt(e,t=0,a={}){var w,y,C,I;if(e.type==="repost"&&!a.isRepostContent){const z=f.postsById.get(e.originalPostId);return`
            <div class="bc-post" data-post-id="${e.id}" style="animation-delay:${Math.min(t*.04,.4)}s">
                <div class="bc-repost-banner"><i class="fa-solid fa-retweet"></i> <span>${Pa(e.author)} reposted</span></div>
                ${z?Kt(z,t,{isRepostContent:!0,noAnimation:!0}):'<div class="bc-post-body" style="padding:16px 20px;color:var(--bc-text-3);">Original post not found</div>'}
            </div>`}const n=Pa(e.author),s=yg(e.author),i=kg(e.author),r=Eg(e.author),o=Fa(e.superLikes),l=e.repliesCount||f.replyCountMap.get(e.id)||0,d=e.repostsCount||f.repostCountMap.get(e.id)||0,u=e.likesCount||((w=f.likesMap.get(e.id))==null?void 0:w.size)||0,m=e.downvotesCount||0,p=((C=f.likesMap.get(e.id))==null?void 0:C.has((y=c.userAddress)==null?void 0:y.toLowerCase()))||!1,g=a.noAnimation?"":`style="animation-delay:${Math.min(t*.04,.4)}s"`,b=Tg(e.tag||0);return`
        <div class="bc-post" data-post-id="${e.id}" ${g} onclick="BackchatPage.viewPost('${e.id}')">
            <div class="bc-post-top">
                <div class="bc-avatar ${i?"boosted":""}" onclick="event.stopPropagation(); BackchatPage.viewProfile('${e.author}')">
                    ${s?s.charAt(0).toUpperCase():ws(e.author)}
                </div>
                <div class="bc-post-head">
                    <div class="bc-post-author-row">
                        ...
                        <span class="bc-post-time">&middot; ${wg(e.timestamp)}</span>
                        ${e.tag>0?`<span class="bc-tag-badge" style="color:${b.color};border-color:${b.color}30"><i class="fa-solid ${b.icon}"></i> ${b.name}</span>`:""}
                        ${e.superLikes>0n?`<span class="bc-trending-tag"><i class="fa-solid fa-bolt"></i> ${o}</span>`:""}
                    </div>
                    ${e.type==="reply"?`<div class="bc-post-context">Replying to ${Pa((I=f.postsById.get(e.parentId))==null?void 0:I.author)}</div>`:""}
                </div>
                ${Kg(e)}
            </div>
            ${e.content?`<div class="bc-post-body">${De(e.content)}</div>`:""}
            ${e.mediaCID?`<div class="bc-post-media"><img src="${hg}${e.mediaCID}" alt="Media" loading="lazy" onerror="this.style.display='none'"></div>`:""}
            <div class="bc-actions" onclick="event.stopPropagation()">
                ...
                <button class="bc-action act-like ${p?"liked":""}" onclick="BackchatPage.like('${e.id}')" title="Like">
                    <i class="${p?"fa-solid":"fa-regular"} fa-heart"></i>${u>0?`<span class="count">${u}</span>`:""}
                </button>
                <button class="bc-action act-down" onclick="BackchatPage.openDownvote('${e.id}')" title="Downvote">
                    <i class="fa-solid fa-arrow-down"></i>${m>0?`<span class="count">${m}</span>`:""}
                </button>
                <button class="bc-action act-super" onclick="BackchatPage.openSuperLike('${e.id}')" title="Super Like">
                    <i class="fa-solid fa-star"></i>
                </button>
            </div>
        </div>`}function zl(){var t;if(!f.contractAvailable)return`<div class="bc-empty">
        ...
        </div>`;if(f.isLoading)return'<div class="bc-loading"><div class="bc-spinner"></div><span class="bc-loading-text">Loading feed...</span></div>';let e=f.posts;if(f.selectedTag>=0&&(e=f.posts.filter(a=>{if(a.type==="repost"){const n=f.postsById.get(a.originalPostId);return n&&n.tag===f.selectedTag}return a.tag===f.selectedTag})),e.length===0){const a=f.selectedTag>=0&&((t=_a[f.selectedTag])==null?void 0:t.name)||"";return`<div class="bc-empty">
        ...
        </div>`}return e.map((a,n)=>Kt(a,n)).join("")}function Yg(){const e=f.globalStats,t=e?`
        ...
        ${f.trendingPosts.map((a,n)=>Kt(a,n)).join("")}`}function Vg(){var r,o,l,d,u,m;if(!c.isConnected)return`<div class="bc-empty">
        ...
        </div>`;const e=(r=c.userAddress)==null?void 0:r.toLowerCase(),t=f.allItems.filter(p=>{var g;return((g=p.author)==null?void 0:g.toLowerCase())===e&&p.type!=="repost"}),a=f.followers.size,n=f.following.size,s=((o=f.userProfile)==null?void 0:o.displayName)||((l=f.userProfile)==null?void 0:l.username)||zn(c.userAddress),i=(d=f.userProfile)!=null&&d.username?f.userProfile.username.charAt(0).toUpperCase():ws(c.userAddress);return`
        <div class="bc-profile-section">
            <div class="bc-profile-banner"></div>
            <div class="bc-profile-main">
                <div class="bc-profile-top-row">
                    <div class="bc-profile-pic ${f.isBoosted?"boosted":""}">${i}</div>
                ...
                <div class="bc-profile-name-row">
                    <span class="bc-profile-name">${De(s)}</span>
                    ${f.hasBadge?'<i class="fa-solid fa-circle-check bc-profile-badge"></i>':""}
                    ${f.isBoosted?'<span class="bc-boosted-tag"><i class="fa-solid fa-rocket"></i> Boosted</span>':""}
                </div>
                ${(u=f.userProfile)!=null&&u.username?`<div class="bc-profile-username">@${f.userProfile.username}</div>`:""}
                ${(m=f.userProfile)!=null&&m.bio?`<div class="bc-profile-bio">${De(f.userProfile.bio)}</div>`:""}
                <div class="bc-profile-handle">
                    <a href="${Xd}${c.userAddress}" target="_blank" rel="noopener">View on Explorer <i class="fa-solid fa-arrow-up-right-from-square"></i></a>
                </div>
            ...
            ${t.length===0?'<div class="bc-empty" style="padding:40px 20px;"><div class="bc-empty-text">No posts yet — share your first thought!</div></div>':t.sort((p,g)=>g.timestamp-p.timestamp).map((p,g)=>Kt(p,g)).join("")}
        </div>`}function ie(){const e=document.getElementById("backchat-content");if(!e)return;let t="";switch(f.view){case"feed":t=Pl()+Al()+zl();break;case"discover":t=Yg();break;case"profile":t=!f.hasProfile&&c.isConnected?Bl():Vg();break;case"post-detail":t=qg();break;case"user-profile":t=Xg();break;case"profile-setup":t=Bl();break;default:t=Pl()+Al()+zl()}e.innerHTML=t}function qg(){const e=f.selectedPost?f.postsById.get(f.selectedPost):null;if(!e)return'<div class="bc-empty"><div class="bc-empty-title">Post not found</div></div>';const t=f.replies.get(e.id)||[];t.sort((n,s)=>n.timestamp-s.timestamp);const a=Pa(e.author);return`
        <div class="bc-thread-parent">${Kt(e,0,{noAnimation:!0})}</div>
        <div class="bc-thread-divider">Replies ${t.length>0?`(${t.length})`:""}</div>
        ${t.length===0?'<div class="bc-empty" style="padding:40px 20px;"><div class="bc-empty-text">No replies yet. Be the first!</div></div>':t.map((n,s)=>`<div class="bc-thread-reply">${Kt(n,s,{noAnimation:!0})}</div>`).join("")}
        ${c.isConnected?`
            <div class="bc-reply-compose">
                <div class="bc-reply-label">Replying to ${a}</div>
                <div class="bc-reply-row">
                    <textarea id="bc-reply-input" class="bc-reply-input" placeholder="Write a reply..." maxlength="${vt}"></textarea>
                    <button id="bc-reply-btn" class="bc-btn bc-btn-primary bc-reply-send" onclick="BackchatPage.submitReply('${e.id}')">Reply</button>
                </div>
                <div style="font-size:11px;color:var(--bc-text-3);margin-top:6px;">Fee: ${Fa(f.fees.reply)} ETH</div>
            </div>`:""}`}function Xg(){var m;const e=f.selectedProfile;if(!e)return'<div class="bc-empty"><div class="bc-empty-title">User not found</div></div>';const t=e.toLowerCase(),a=f.profiles.get(t),n=(a==null?void 0:a.displayName)||(a==null?void 0:a.username)||zn(e),s=a==null?void 0:a.username,i=a==null?void 0:a.bio,r=s?s.charAt(0).toUpperCase():ws(e),o=t===((m=c.userAddress)==null?void 0:m.toLowerCase()),l=f.following.has(t),d=f.followCounts.get(t)||{followers:0,following:0},u=f.allItems.filter(p=>{var g;return((g=p.author)==null?void 0:g.toLowerCase())===t&&p.type!=="repost"});return`
        <div class="bc-profile-section">
            <div class="bc-profile-banner"></div>
            <div class="bc-profile-main">
                <div class="bc-profile-top-row">
                ...
                <div class="bc-profile-name-row"><span class="bc-profile-name">${De(n)}</span></div>
                ${s?`<div class="bc-profile-username">@${s}</div>`:""}
                ${i?`<div class="bc-profile-bio">${De(i)}</div>`:""}
                <div class="bc-profile-handle">
                    <a href="${Xd}${e}" target="_blank" rel="noopener">${zn(e)} <i class="fa-solid fa-arrow-up-right-from-square"></i></a>
                </div>
                <div class="bc-profile-stats">
                    <div class="bc-stat-cell"><div class="bc-stat-value">${u.length}</div><div class="bc-stat-label">Posts</div></div>
                    <div class="bc-stat-cell"><div class="bc-stat-value">${d.followers}</div><div class="bc-stat-label">Followers</div></div>
                    <div class="bc-stat-cell"><div class="bc-stat-value">${d.following}</div><div class="bc-stat-label">Following</div></div>
                </div>
            </div>
            <div class="bc-section-head"><span class="bc-section-title"><i class="fa-solid fa-clock-rotate-left"></i> Posts</span><span class="bc-section-subtitle">${u.length}</span></div>
            ${u.length===0?'<div class="bc-empty" style="padding:40px 20px;"><div class="bc-empty-text">No posts yet</div></div>':u.sort((p,g)=>g.timestamp-p.timestamp).map((p,g)=>Kt(p,g)).join("")}
        </div>`}function Bl(){if(!c.isConnected)return`<div class="bc-empty">
            <div class="bc-empty-glyph"><i class="fa-solid fa-wallet"></i></div>
            <div class="bc-empty-title">Connect Wallet</div>
            ...
            <div class="bc-wizard-card">
                ...
                `:e===2?`
                    <div class="bc-field">
                        ...
                        <input type="text" id="wiz-displayname-input" class="bc-input" placeholder="Your public name" value="${De(f.wizDisplayName)}" maxlength="30">
                    </div>
                    <div class="bc-field">
                        <label class="bc-label">Bio</label>
                        <textarea id="wiz-bio-input" class="bc-input" placeholder="Tell the world about yourself..." maxlength="160" rows="3" style="resize:none;">${De(f.wizBio)}</textarea>
                    </div>
                ...
                `:`
                    <div style="text-align:center;">
                        ...
                        ${f.wizDisplayName?`<div style="font-size:14px; color:var(--bc-text-2); margin-top:4px;">${De(f.wizDisplayName)}</div>`:""}
                        ${f.wizBio?`<div style="font-size:13px; color:var(--bc-text-3); margin-top:8px;">${De(f.wizBio)}</div>`:""}
        ...
        </div>`}function Jg(){var e,t;return`
        <!-- Super Like Modal -->
        ...
        <div class="bc-modal-overlay" id="modal-badge">
            <div class="bc-modal-box">
                ...
                <div class="bc-modal-inner">
                    ...
                    <div class="bc-fee-row"><span class="bc-fee-label">Badge Fee</span><span class="bc-fee-val">${Fa(f.fees.badge)} ETH</span></div>
        ...
        <div class="bc-modal-overlay" id="modal-repost">
            <div class="bc-modal-box">
                ...
                <div class="bc-modal-inner">
                    <p class="bc-modal-desc">Repost this to your followers? Fee: ${Fa(f.fees.repost)} ETH</p>
        ...
        <div class="bc-modal-overlay" id="modal-edit-profile">
            <div class="bc-modal-box">
                ...
                <div class="bc-modal-inner">
                    <div class="bc-field"><label class="bc-label">Display Name</label><input type="text" id="edit-displayname" class="bc-input" value="${De(((e=f.userProfile)==null?void 0:e.displayName)||"")}" maxlength="30" placeholder="Your display name"></div>
                    <div class="bc-field"><label class="bc-label">Bio</label><textarea id="edit-bio" class="bc-input" maxlength="160" rows="3" placeholder="About you..." style="resize:none;">${De(((t=f.userProfile)==null?void 0:t.bio)||"")}</textarea></div>
        ...
        </div>`}function Ot(){vg();const e=document.getElementById("backchat");e&&(e.innerHTML=`
        <div class="bc-shell">
            ${Gg()}
            <div id="backchat-content"></div>
        </div>
        ${Jg()}`,ie())}let ba=null;function Zg(e){var t;ba=e,(t=document.getElementById("modal-superlike"))==null||t.classList.add("active")}async function Qg(){var t;const e=((t=document.getElementById("superlike-amount"))==null?void 0:t.value)||"0.001";ct("superlike"),await Bg(ba,e)}function ex(e){var t;ba=e,(t=document.getElementById("modal-downvote"))==null||t.classList.add("active")}async function tx(){var t;const e=((t=document.getElementById("downvote-amount"))==null?void 0:t.value)||"0.001";ct("downvote"),await Ng(ba,e)}function ax(){var e;(e=document.getElementById("modal-badge"))==null||e.classList.add("active")}async function nx(){ct("badge"),await Mg()}function sx(){var e;(e=document.getElementById("modal-boost"))==null||e.classList.add("active")}async function ix(){var t;const e=((t=document.getElementById("boost-amount"))==null?void 0:t.value)||"0.001";ct("boost"),await Dg(e)}function rx(e){var t;ba=e,(t=document.getElementById("modal-repost"))==null||t.classList.add("active")}async function ox(){await Pg(ba)}function lx(){var e;Ot(),(e=document.getElementById("modal-edit-profile"))==null||e.classList.add("active")}async function cx(){await Fg()}function ct(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.remove("active")}function dx(e){const t=document.getElementById(`post-menu-${e}`);if(!t)return;const a=t.style.display!=="none";document.querySelectorAll(".bc-post-dropdown").forEach(n=>n.style.display="none"),t.style.display=a?"none":"block"}function ux(e){const t=document.getElementById("bc-char-counter");if(!t)return;const a=e.value.length;t.textContent=`${a}/${vt}`,t.className="bc-char-count",a>vt-50?t.classList.add("danger"):a>vt-150&&t.classList.add("warn")}document.addEventListener("click",()=>{document.querySelectorAll(".bc-post-dropdown").forEach(e=>e.style.display="none")});const px={async render(e){e&&(Ot(),await Promise.all([yl(),kl(),El(),Tl(),rt(),Cl()]))},async refresh(){await Promise.all([yl(),kl(),El(),Tl(),rt(),Cl()])},setTab(e){f.activeTab=e,f.view=e,f.selectedTag=-1,Ot()},filterTag(e){f.selectedTag=e,ie()},setComposeTag(e){f.composeTag=e,ie()},goBack:Cg,viewPost(e){sn("post-detail",{post:e})},viewProfile(e){var t;(e==null?void 0:e.toLowerCase())===((t=c.userAddress)==null?void 0:t.toLowerCase())?(f.activeTab="profile",f.view="profile",Ot()):sn("user-profile",{profile:e})},openReply(e){sn("post-detail",{post:e})},openProfileSetup(){f.wizStep=1,f.wizUsername="",f.wizDisplayName="",f.wizBio="",f.wizUsernameOk=null,f.wizFee=null,sn("profile-setup")},createPost:Ig,submitReply:Ag,like:zg,follow:Lg,unfollow:Rg,deletePost:$g,pinPost:Sg,openSuperLike:Zg,confirmSuperLike:Qg,openDownvote:ex,confirmDownvote:tx,openRepostConfirm:rx,confirmRepost:ox,openBadge:ax,confirmBadge:nx,openBoost:sx,confirmBoost:ix,openEditProfile:lx,confirmEditProfile:cx,closeModal:ct,togglePostMenu:dx,handleImageSelect:Hg,removeImage:Ug,onWizUsernameInput:jg,wizNext(){var e,t,a,n;f.wizStep===1&&!f.wizUsernameOk||(f.wizStep===1?f.wizStep=2:f.wizStep===2&&(f.wizDisplayName=((t=(e=document.getElementById("wiz-displayname-input"))==null?void 0:e.value)==null?void 0:t.trim())||"",f.wizBio=((n=(a=document.getElementById("wiz-bio-input"))==null?void 0:a.value)==null?void 0:n.trim())||"",f.wizStep=3),ie())},wizBack(){var e,t,a,n;f.wizStep>1&&(f.wizStep===2&&(f.wizDisplayName=((t=(e=document.getElementById("wiz-displayname-input"))==null?void 0:e.value)==null?void 0:t.trim())||"",f.wizBio=((n=(a=document.getElementById("wiz-bio-input"))==null?void 0:a.value)==null?void 0:n.trim())||""),f.wizStep--,ie())},wizConfirm:_g,_updateCharCount:ux},mx=window.inject||(()=>{console.warn("Dev Mode: Analytics disabled.")});if(window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1")try{mx()}catch(e){console.error("Analytics Error:",e)}const ho="".toLowerCase();window.__ADMIN_WALLET__=ho;ho&&console.log("✅ Admin access granted");let Ft=null,va=null,Ms=!1;const ge={dashboard:Ks,mine:qs,store:Sm,rewards:qs,actions:pf,charity:xg,backchat:px,notary:yd,airdrop:Kf,tokenomics:N0,about:Ef,admin:v0,rental:Ad,socials:Cb,creditcard:Ib,dex:K,dao:Ab,tutorials:Bd};function Zd(e){return!e||e.length<42?"...":`${e.slice(0,6)}...${e.slice(-4)}`}function fx(e){if(!e)return"0.00";const t=M(e);return t>=1e9?(t/1e9).toFixed(2)+"B":t>=1e6?(t/1e6).toFixed(2)+"M":t>=1e4?t.toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):t.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function ga(e,t=!1){const a=document.querySelector("main > div.container"),n=document.querySelectorAll(".sidebar-link");if(!a){console.error("❌ Page container not found");return}e==="rewards"&&(e="mine",window.location.hash="mine");const s=window.location.hash.includes("/");if(!(Ft!==e||t||s)){ge[e]&&typeof ge[e].update=="function"&&ge[e].update(c.isConnected);return}console.log(`📍 Navigating: ${Ft} → ${e} (force: ${t})`),va&&typeof va=="function"&&(va(),va=null),Array.from(a.children).forEach(l=>{l.tagName==="SECTION"&&(l.classList.add("hidden"),l.classList.remove("active"))});const r=document.getElementById("charity-container");r&&e!=="charity"&&(r.innerHTML=""),n.forEach(l=>{l.classList.remove("active"),l.classList.add("text-zinc-400","hover:text-white","hover:bg-zinc-700")});const o=document.getElementById(e);if(o&&ge[e]){o.classList.remove("hidden"),o.classList.add("active");const l=Ft!==e;Ft=e;const d=document.querySelector(`.sidebar-link[data-target="${e}"]`);d&&(d.classList.remove("text-zinc-400","hover:text-white","hover:bg-zinc-700"),d.classList.add("active")),ge[e]&&typeof ge[e].render=="function"&&ge[e].render(l||t),typeof ge[e].cleanup=="function"&&(va=ge[e].cleanup),l&&window.scrollTo(0,0)}else e!=="dashboard"&&e!=="faucet"&&(console.warn(`Route '${e}' not found, redirecting to dashboard.`),ga("dashboard",!0))}window.navigateTo=ga;const Nl="wallet-btn text-xs font-mono text-center max-w-fit whitespace-nowrap relative font-bold py-2 px-4 rounded-md transition-colors";function vo(e=!1){Ms||(Ms=!0,requestAnimationFrame(()=>{bx(e),Ms=!1}))}function bx(e){const t=document.getElementById("admin-link-container"),a=document.getElementById("statUserBalance"),n=document.getElementById("connectButtonDesktop"),s=document.getElementById("connectButtonMobile"),i=document.getElementById("mobileAppDisplay");let r=c.userAddress;const o=[n,s];if(c.isConnected&&r){const d=fx(c.currentUserBalance),m=`
            <div class="status-dot"></div>
            <span>${Zd(r)}</span>
            <div class="balance-pill">
                ${d} BKC
            </div>
        `;if(o.forEach(p=>{p&&(p.innerHTML=m,p.className=Nl+" wallet-btn-connected")}),i&&(i.textContent="Backcoin.org",i.classList.add("text-white"),i.classList.remove("text-amber-400")),t){const p=r.toLowerCase()===ho;t.style.display=p?"block":"none"}a&&(a.textContent=d)}else{const d='<i class="fa-solid fa-plug"></i> Connect Wallet';o.forEach(u=>{u&&(u.innerHTML=d,u.className=Nl+" wallet-btn-disconnected")}),i&&(i.textContent="Backcoin.org",i.classList.add("text-amber-400"),i.classList.remove("text-white")),t&&(t.style.display="none"),a&&(a.textContent="--")}const l=Ft||"dashboard";e||!Ft?ga(l,!0):ge[l]&&typeof ge[l].update=="function"&&ge[l].update(c.isConnected)}function gx(e){const{isConnected:t,address:a,isNewConnection:n,wasConnected:s}=e,i=n||t!==s;c.isConnected=t,a&&(c.userAddress=a),vo(i),t&&n?x(`Connected: ${Zd(a)}`,"success"):!t&&s&&x("Wallet disconnected.","info")}function xx(){const e=document.getElementById("testnet-banner"),t=document.getElementById("close-testnet-banner");if(!(!e||!t)){if(localStorage.getItem("hideTestnetBanner")==="true"){e.remove();return}e.style.transform="translateY(0)",t.addEventListener("click",()=>{e.style.transform="translateY(100%)",setTimeout(()=>e.remove(),500),localStorage.setItem("hideTestnetBanner","true")})}}function hx(){const e=document.querySelectorAll(".sidebar-link"),t=document.getElementById("menu-btn"),a=document.getElementById("sidebar"),n=document.getElementById("sidebar-backdrop"),s=document.getElementById("connectButtonDesktop"),i=document.getElementById("connectButtonMobile"),r=document.getElementById("shareProjectBtn");xx(),e.length>0&&e.forEach(l=>{l.addEventListener("click",async d=>{d.preventDefault();const u=l.dataset.target;if(u==="faucet"){x("Accessing Testnet Faucet...","info"),await Kn("BKC")&&vo(!0);return}u&&(window.location.hash=u,ga(u,!0),a&&a.classList.contains("translate-x-0")&&(a.classList.remove("translate-x-0"),a.classList.add("-translate-x-full"),n&&n.classList.add("hidden")))})});const o=()=>{dc()};s&&s.addEventListener("click",o),i&&i.addEventListener("click",o),r&&r.addEventListener("click",()=>fu(c.userAddress)),t&&a&&n&&(t.addEventListener("click",()=>{a.classList.contains("translate-x-0")?(a.classList.add("-translate-x-full"),a.classList.remove("translate-x-0"),n.classList.add("hidden")):(a.classList.remove("-translate-x-full"),a.classList.add("translate-x-0"),n.classList.remove("hidden"))}),n.addEventListener("click",()=>{a.classList.add("-translate-x-full"),a.classList.remove("translate-x-0"),n.classList.add("hidden")}))}function Qd(){const e=window.location.hash.replace("#","");if(!e)return"dashboard";const t=e.split(/[/?]/)[0];return ge[t]?t:"dashboard"}function eu(){try{const e=window.location.hash,t=e.indexOf("?");if(t===-1)return;const n=new URLSearchParams(e.substring(t)).get("ref");n&&/^0x[a-fA-F0-9]{40}$/.test(n)&&(localStorage.getItem("backchain_referrer")||(localStorage.setItem("backchain_referrer",n),console.log("[Referral] Captured referrer from URL:",n)))}catch(e){console.warn("[Referral] Failed to parse referral param:",e.message)}}window.addEventListener("load",async()=>{console.log("🚀 App Initializing..."),Se.earn||(Se.earn=document.getElementById("mine"));try{if(!await _l())throw new Error("Failed to load contract addresses")}catch(a){console.error("❌ Critical Initialization Error:",a),x("Initialization failed. Please refresh.","error");return}hx(),await np(),sp(gx),bu();const e=document.getElementById("preloader");e&&(e.style.display="none"),eu();const t=Qd();console.log("📍 Initial page from URL:",t,"Hash:",window.location.hash),ga(t,!0),console.log("✅ App Ready.")});window.addEventListener("hashchange",()=>{eu();const e=Qd(),t=window.location.hash;console.log("🔄 Hash changed to:",e,"Full hash:",t),e!==Ft?ga(e,!0):e==="charity"&&ge[e]&&typeof ge[e].render=="function"&&ge[e].render(!0)});window.StakingPage=qs;window.openConnectModal=dc;window.disconnectWallet=ip;window.updateUIState=vo;
