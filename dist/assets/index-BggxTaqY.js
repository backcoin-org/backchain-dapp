import{defaultConfig as Wc,createWeb3Modal as Gc}from"https://esm.sh/@web3modal/ethers@5.1.11?bundle";import{initializeApp as Kc}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-app.js";import{getAuth as Yc,onAuthStateChanged as Vc,signInAnonymously as qc}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-auth.js";import{getFirestore as Xc,collection as Xe,query as Et,where as Zn,orderBy as Yt,getDocs as it,doc as te,getDoc as Ae,limit as Jc,serverTimestamp as ot,writeBatch as fa,updateDoc as ba,increment as Fe,setDoc as ga,Timestamp as wr,addDoc as Zc,deleteDoc as Qc}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-firestore.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function n(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(s){if(s.ep)return;s.ep=!0;const r=n(s);fetch(s.href,r)}})();const Be={sidebar:document.getElementById("sidebar"),sidebarBackdrop:document.getElementById("sidebar-backdrop"),menuBtn:document.getElementById("menu-btn"),navLinks:document.getElementById("nav-links"),mainContentSections:document.querySelectorAll("main section"),connectButtonDesktop:document.getElementById("connectButtonDesktop"),connectButtonMobile:document.getElementById("connectButtonMobile"),mobileAppDisplay:document.getElementById("mobileAppDisplay"),desktopDisconnected:document.getElementById("desktopDisconnected"),desktopConnectedInfo:document.getElementById("desktopConnectedInfo"),desktopUserAddress:document.getElementById("desktopUserAddress"),desktopUserBalance:document.getElementById("desktopUserBalance"),modalContainer:document.getElementById("modal-container"),toastContainer:document.getElementById("toast-container"),dashboard:document.getElementById("dashboard"),earn:document.getElementById("mine"),store:document.getElementById("store"),rental:document.getElementById("rental"),rewards:document.getElementById("rewards"),actions:document.getElementById("actions"),presale:document.getElementById("presale"),faucet:document.getElementById("faucet"),airdrop:document.getElementById("airdrop"),dao:document.getElementById("dao"),about:document.getElementById("about"),admin:document.getElementById("admin"),tokenomics:document.getElementById("tokenomics"),notary:document.getElementById("notary"),statTotalSupply:document.getElementById("statTotalSupply"),statValidators:document.getElementById("statValidators"),statTotalPStake:document.getElementById("statTotalPStake"),statScarcity:document.getElementById("statScarcity"),statLockedPercentage:document.getElementById("statLockedPercentage"),statUserBalance:document.getElementById("statUserBalance"),statUserPStake:document.getElementById("statUserPStake"),statUserRewards:document.getElementById("statUserRewards")},ed={provider:null,publicProvider:null,web3Provider:null,signer:null,userAddress:null,isConnected:!1,bkcTokenContract:null,delegationManagerContract:null,rewardBoosterContract:null,nftLiquidityPoolContract:null,actionsManagerContract:null,fortunePoolContract:null,faucetContract:null,decentralizedNotaryContract:null,ecosystemManagerContract:null,publicSaleContract:null,rentalManagerContract:null,bkcTokenContractPublic:null,delegationManagerContractPublic:null,faucetContractPublic:null,fortunePoolContractPublic:null,rentalManagerContractPublic:null,ecosystemManagerContractPublic:null,actionsManagerContractPublic:null,currentUserBalance:0n,currentUserNativeBalance:0n,userTotalPStake:0n,userDelegations:[],myBoosters:[],activityHistory:[],totalNetworkPStake:0n,allValidatorsData:[],systemFees:{},systemPStakes:{},boosterDiscounts:{},notaryFee:void 0,notaryMinPStake:void 0},td={set(e,t,n){return e[t]=n,["currentUserBalance","isConnected","userTotalPStake","totalNetworkPStake"].includes(t)&&window.updateUIState&&window.updateUIState(),!0}},c=new Proxy(ed,td);let yr=!1;const x=(e,t="info",n=null)=>{if(!Be.toastContainer)return;const a={success:{icon:"fa-check-circle",color:"bg-green-600",border:"border-green-400"},error:{icon:"fa-exclamation-triangle",color:"bg-red-600",border:"border-red-400"},info:{icon:"fa-info-circle",color:"bg-blue-600",border:"border-blue-400"},warning:{icon:"fa-exclamation-circle",color:"bg-yellow-600",border:"border-yellow-400"}},s=a[t]||a.info,r=document.createElement("div");r.className=`flex items-center w-full max-w-xs p-4 text-white rounded-lg shadow-lg transition-all duration-500 ease-out 
    ...
    `;wn(n,"max-w-md")}const kr=e=>{window.navigateTo?window.navigateTo(e):console.error("navigateTo function not found."),we()};function sd(){var s,r,i,o,l,d;if(yr)return;yr=!0;const e="https://t.me/BackCoinorg",t="https://github.com/backcoin-org/backchain-dapp";wn(`
    ...
    `}async function up(){try{const e=await fetch(Ju);if(e.ok){const t=await e.json();return S.economicData=t,t}}catch{}return null}async function is(){var e,t,n,a,s,r,i,o,l;try{const d=await up();let p=0n,f=0n,u=0n,b=0n,m=0n,g=0,y=0n;if(d)if(console.log("📊 Firebase economic data:",d.economy),(e=d.economy)!=null&&e.totalSupply&&(p=BigInt(d.economy.totalSupply)),(t=d.economy)!=null&&t.totalPStake&&(f=BigInt(d.economy.totalPStake)),(n=d.economy)!=null&&n.totalTVL&&(u=BigInt(d.economy.totalTVL)),(a=d.economy)!=null&&a.totalFeesCollected&&(m=BigInt(d.economy.totalFeesCollected)),(s=d.economy)!=null&&s.fortunePoolBalance&&(y=BigInt(d.economy.fortunePoolBalance)),(r=d.stats)!=null&&r.notarizedDocuments&&(g=d.stats.notarizedDocuments),(i=d.burn)!=null&&i.totalBurned)b=BigInt(d.burn.totalBurned);else if((o=d.burn)!=null&&o.sources){let D=0n;for(const W of Object.values(d.burn.sources))W!=null&&W.total&&(D+=BigInt(W.total));b=D}else(l=d.rental)!=null&&l.totalBurned&&(b=BigInt(d.rental.totalBurned));if(c.bkcTokenContractPublic&&(p===0n&&(console.log("📊 Fetching totalSupply from blockchain (fallback)..."),p=await ne(c.bkcTokenContractPublic,"totalSupply",[],0n)),f===0n&&c.delegationManagerContractPublic&&(console.log("📊 Fetching totalPStake from blockchain (fallback)..."),f=await ne(c.delegationManagerContractPublic,"totalNetworkPStake",[],0n)),u===0n)){console.log("📊 Calculating TVL from blockchain (fallback)...");const D=[v.delegationManager,v.fortunePool,v.rentalManager,v.miningManager,v.decentralizedNotary,v.nftLiquidityPoolFactory,v.pool_diamond,v.pool_platinum,v.pool_gold,v.pool_silver,v.pool_bronze,v.pool_iron,v.pool_crystal].filter(ae=>ae&&ae!==jt.ZeroAddress),W=D.map(ae=>ne(c.bkcTokenContractPublic,"balanceOf",[ae],0n)),ue=await Promise.all(W);if(ue.forEach(ae=>{u+=ae}),v.fortunePool&&y===0n){const ae=D.indexOf(v.fortunePool);ae>=0&&(y=ue[ae])}}const k=_(p),E=_(b),I=_(m),P=_(y),L=D=>D.toLocaleString("en-US",{minimumFractionDigits:1,maximumFractionDigits:1});let T=0;p>0n&&(T=Number(u*10000n/p)/100),T>100&&(T=100);const F=(D,W,ue="")=>{const ae=document.getElementById(D);ae&&(ae.innerHTML=`${W}${ue?` <span class="text-xs text-zinc-500">${ue}</span>`:""}`)},G=document.getElementById("dash-metric-supply");G&&(G.innerHTML=`${L(k)} <span style="font-size: 10px; color: #71717a">BKC</span>`),F("dash-metric-pstake",Ut(f));const se=document.getElementById("dash-metric-burned");se&&(E>0?se.innerHTML=`<span class="text-red-400">${Oa(E)}</span> <span class="text-xs text-zinc-500">BKC 🔥</span>`:se.innerHTML='<span class="text-zinc-500">0</span> <span class="text-xs text-zinc-500">BKC</span>'),F("dash-metric-fees",Oa(I),"BKC");const ce=document.getElementById("dash-metric-tvl");if(ce){const D=T>30?"text-green-400":T>10?"text-yellow-400":"text-blue-400";ce.innerHTML=`<span class="${D}">${T.toFixed(1)}%</span>`}Wl();const xe=document.getElementById("dash-fortune-prize");xe&&(xe.innerText=`${Oa(P)} BKC`);const Z=document.getElementById("dash-notary-count");Z&&(Z.innerText=g>0?`${g} docs`:"--"),S.metricsCache={supply:k,burned:E,fees:I,timestamp:Date.now()}}catch(d){console.error("Metrics Error",d)}}async function pp(){if(c.userAddress)try{const e=await fetch(`https://getuserprofile-4wvdcuoouq-uc.a.run.app/${c.userAddress}`);e.ok&&(S.userProfile=await e.json(),mp(S.userProfile))}catch{}}function mp(e){const t=document.getElementById("dash-presale-stats");if(!t||!e||!e.presale||!e.presale.totalBoosters||e.presale.totalBoosters===0)return;t.classList.remove("hidden");const n=e.presale.totalSpentWei||0,a=parseFloat(jt.formatEther(BigInt(n))).toFixed(4);document.getElementById("stats-total-spent").innerText=`${a} ETH`,document.getElementById("stats-total-boosters").innerText=e.presale.totalBoosters||0;const s=document.getElementById("stats-tier-badges");if(s&&e.presale.tiersOwned){let r="";Object.entries(e.presale.tiersOwned).forEach(([i,o])=>{const l=ge[Number(i)-1],d=l?l.name:`T${i}`;r+=`<span class="text-[9px] bg-zinc-800 text-zinc-400 px-1.5 py-0.5 rounded">${o}x ${d}</span>`}),r&&(s.innerHTML=r)}}function Wl(){const e=document.getElementById("dash-metric-balance"),t=document.getElementById("dash-balance-card");if(!e)return;const n=c.currentUserBalance||c.bkcBalance||0n;if(!c.isConnected){e.innerHTML='<span class="text-zinc-500 text-xs">Connect Wallet</span>',t&&(t.style.borderColor="rgba(63,63,70,0.5)");return}if(n===0n)e.innerHTML='0.00 <span style="font-size: 10px; color: #71717a">BKC</span>';else{const s=_(n).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2});e.innerHTML=`${s} <span style="font-size: 10px; color: #71717a">BKC</span>`}t&&(t.style.borderColor="rgba(245,158,11,0.3)")}async function _t(e=!1){var t,n;if(!c.isConnected){const a=document.getElementById("dash-booster-area");a&&(a.innerHTML=`
        ...
        `;return}const d=e.source==="rented",p=d?"bg-cyan-500/20 text-cyan-300":"bg-green-500/20 text-green-300",f=d?"Rented":"Owned",u=ud(a),b=(u==null?void 0:u.name)||((E=e.boostName)==null?void 0:E.replace(" Booster","").replace("Booster","").trim())||"Booster",m=(u==null?void 0:u.color)||"text-amber-400",g=(u==null?void 0:u.emoji)||"💎",y=r*50n/100n,k=i-y;console.log("🎨 V6.8 Booster:",{keepRate:s,netReward:_(i),tierName:b}),n.innerHTML=`
        <div class="flex items-center gap-3 bg-zinc-800/40 border ${(u==null?void 0:u.borderColor)||"border-green-500/20"} rounded-lg p-3 nft-clickable-image cursor-pointer" data-address="${v.rewardBoosterNFT}" data-tokenid="${e.tokenId}">
            ...
            <div class="flex-1 min-w-0">
                ...
                <h4 class="${m} font-bold text-xs truncate">${b} Booster</h4>
    ...
    `;try{const n=await fetch(`${Xu}?limit=30`);if(n.ok){const a=await n.json();S.networkActivities=Array.isArray(a)?a:a.activities||[],S.networkActivitiesTimestamp=Date.now()}else S.networkActivities=[]}catch(n){console.error("Network activity fetch error:",n),S.networkActivities=[]}finally{S.isLoadingNetworkActivity=!1}Kr()}function Kr(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("dash-pagination-controls");if(e){if(S.networkActivities.length===0){e.innerHTML=`
        ...
        `,t&&t.classList.add("hidden");return}const n=(S.pagination.currentPage-1)*S.pagination.itemsPerPage,a=n+S.pagination.itemsPerPage,s=S.filteredActivities.slice(n,a);if(e.innerHTML=s.map(r=>Gl(r,!1)).join(""),t){const r=Math.ceil(S.filteredActivities.length/S.pagination.itemsPerPage);r>1?(t.classList.remove("hidden"),document.getElementById("page-indicator").innerText=`${S.pagination.currentPage}/${r}`,document.getElementById("page-prev").disabled=S.pagination.currentPage===1,document.getElementById("page-next").disabled=S.pagination.currentPage>=r):t.classList.add("hidden")}}function Gl(e,t=!1){const n=Qu(e.timestamp||e.createdAt),a=ep(e.timestamp||e.createdAt),s=e.user||e.userAddress||e.from||"",r=tp(s),i=ap(e.type,e.details);let o="";const l=(e.type||"").toUpperCase().trim(),d=e.details||{};if(l.includes("GAME")||l.includes("FORTUNE")||l.includes("REQUEST")||l.includes("FULFILLED")||l.includes("RESULT")){const g=d.rolls||e.rolls||[],y=d.guesses||e.guesses||[],k=d.isWin||d.prizeWon&&BigInt(d.prizeWon||0)>0n,E=d.isCumulative!==void 0?d.isCumulative:y.length>1,I=d.wagerAmount||d.amount,P=d.prizeWon,L=E?"Combo":"Jackpot",T=E?"bg-purple-500/20 text-purple-400":"bg-amber-500/20 text-amber-400",F=I?_(BigInt(I)).toFixed(0):"0";let G="No win",se="text-zinc-500";k&&P&&BigInt(P)>0n&&(G=`<span class="text-emerald-400 font-bold">+${_(BigInt(P)).toFixed(0)} BKC</span>`,se="");let ce="";return g.length>0&&(ce=`<div class="flex gap-1">
                ${g.map((Z,D)=>{const W=y[D];return`<div class="w-7 h-7 rounded text-xs font-bold flex items-center justify-center border ${W!==void 0&&Number(W)===Number(Z)?"bg-emerald-500/20 border-emerald-500/50 text-emerald-400":"bg-zinc-800 border-zinc-700 text-zinc-400"}">${Z}</div>`}).join("")}
            </div>`),`
                ...
                <div class="flex items-center justify-between mb-2">
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <span class="ml-2 text-[10px] font-bold px-2 py-0.5 rounded ${T}">${L}</span>
                        </div>
                    </div>
        ...
        <a href="${u}" target="_blank" class="flex items-center justify-between p-2.5 hover:bg-zinc-800/60 border border-zinc-700/30 rounded-lg transition-all hover:border-zinc-600/50 group" style="background: rgba(39,39,42,0.3)" title="${a}">
            ...
            <div class="text-right flex items-center gap-2">
                ${b?`<p class="text-white text-xs font-mono">${b} <span class="text-zinc-500">${m}</span></p>`:""}
    ...
    `,Pp(),c.isConnected?en(!0):Js())}async function en(e=!1){var n;if(!c.isConnected){Js();return}const t=Date.now();if(!(!e&&Dt)&&!(!e&&t-Cn<1e4)){Dt=!0,Cn=t;try{await yp();try{const a=await fetch("https://getsystemdata-4wvdcuoouq-uc.a.run.app");if(a.ok){const s=await a.json();(n=s==null?void 0:s.economy)!=null&&n.totalPStake&&(bn=BigInt(s.economy.totalPStake))}}catch{console.log("Firebase unavailable, using blockchain")}if(bn===0n){const a=c.delegationManagerContractPublic||c.delegationManagerContract;a&&(bn=await ne(a,"totalNetworkPStake",[],0n))}await Promise.all([Nt(!0),Bd(!0),Cs()]),await kp(),Ep(),Jl(),gn(),Ap()}catch(a){console.error("Staking load error:",a)}finally{Dt=!1}}}async function yp(){try{const e=c.delegationManagerContract||c.delegationManagerContractPublic;if(e&&c.userAddress)try{const n=await e.getUserBestBoost(c.userAddress);Ye=Number(n)}catch{const n=await Ht();Ye=(n==null?void 0:n.boost)||0}else{const n=await Ht();Ye=(n==null?void 0:n.boost)||0}In=Xl(Ye).burnRate,Yl=Ye>0?"active":"none",Tp()}catch(e){console.error("Error loading NFT boost:",e),Ye=0,In=50}}async function kp(){try{const e=c.delegationManagerContract||c.delegationManagerContractPublic;if(e&&c.userAddress)try{const t=await e.previewClaim(c.userAddress);Ft={totalRewards:t.totalRewards||t[0],burnAmount:t.burnAmount||t[1],userReceives:t.userReceives||t[2],burnRateBips:t.burnRateBips||t[3],nftBoost:t.nftBoost||t[4]}}catch{const{stakingRewards:t,minerRewards:n}=await Vt(),a=t+n,s=a*BigInt(In)/100n;Ft={totalRewards:a,burnAmount:s,userReceives:a-s,burnRateBips:BigInt(In*100),nftBoost:BigInt(Ye)}}}catch(e){console.error("Error loading claim preview:",e)}}function Tp(){const e=Xl(Ye),t=document.getElementById("nft-tier-icon");t&&(t.textContent=e.icon,t.style.background=`${e.color}20`);const n=document.getElementById("nft-tier-badge");n&&(n.className=`nft-tier-badge tier-${e.name.toLowerCase()}`,n.innerHTML=`<span>${e.icon} ${e.name}</span>`);const a=document.getElementById("nft-source");a&&(Ye>0?(a.classList.remove("hidden"),a.textContent=Yl):a.classList.add("hidden"));const s=document.getElementById("burn-rate-text");s&&(e.burnRate===0?s.innerHTML='<span class="text-green-400">No burn! You keep 100% of rewards</span>':s.textContent=`${e.burnRate}% of rewards will be burned on claim`);const r=document.getElementById("burn-rate-value"),i=document.getElementById("keep-rate-value");r&&(r.textContent=`${e.burnRate}%`),i&&(i.textContent=`${e.userGets}%`);const o=document.getElementById("burn-fill"),l=document.getElementById("receive-fill");o&&(o.style.width=`${e.burnRate}%`),l&&(l.style.width=`${e.userGets}%`)}function Ep(){var i;const e=(o,l)=>{const d=document.getElementById(o);d&&(d.textContent=l)};e("stat-network",Ut(bn||c.totalNetworkPStake||0n)),e("stat-pstake",Ut(c.userTotalPStake||0n)),e("balance-display",_(c.currentUserBalance||0n).toFixed(2)),e("stat-delegations",(c.userDelegations||[]).length.toString());const t=c.userTotalPStake||0n,n=bn||c.totalNetworkPStake||0n;let a=0;n>0n&&t>0n&&(a=Number(t*10000n/n)/100),e("stat-pstake-percent",a>0?`${a.toFixed(2)}% of network`:"0% of network");const s=((i=c.systemFees)==null?void 0:i.DELEGATION_FEE_BIPS)||50n,r=Number(s)/100;e("fee-info",`${r}% protocol fee`),Cp()}async function Cp(){const e=document.getElementById("claim-section");if(!e)return;const{stakingRewards:t,minerRewards:n}=await Vt(),a=t+n,s=(r,i)=>{const o=document.getElementById(r);o&&(o.textContent=i)};if(s("stat-rewards",_(a).toFixed(4)),a>0n){e.classList.remove("hidden");let r,i;Ft&&Ft.totalRewards>0n?(r=Ft.burnAmount,i=Ft.userReceives):(r=a*BigInt(In)/100n,i=a-r),s("claim-total",_(a).toFixed(4)),s("claim-burn",_(r).toFixed(4)),s("claim-receive",_(i).toFixed(4)),r>0n?e.classList.add("has-burn"):e.classList.remove("has-burn");const o=document.getElementById("claim-btn");o&&(o.onclick=()=>Np(t,n,o))}else e.classList.add("hidden")}function Js(){const e=(s,r)=>{const i=document.getElementById(s);i&&(i.textContent=r)};e("stat-network","--"),e("stat-pstake","--"),e("stat-rewards","--"),e("stat-delegations","0"),e("balance-display","0.00"),e("stat-pstake-percent","--% of network");const t=document.getElementById("delegations-list");t&&(t.innerHTML=`
        ...
        `;return}const s=[...t].sort((r,i)=>Number(r.unlockTime)-Number(i.unlockTime));e.innerHTML=s.map(r=>Ip(r)).join(""),Yr(),yt=setInterval(Yr,6e4),e.querySelectorAll(".unstake-btn").forEach(r=>{r.addEventListener("click",()=>Vr(r.dataset.index,!1))}),e.querySelectorAll(".force-unstake-btn").forEach(r=>{r.addEventListener("click",()=>{confirm(`⚠️ Force Unstake will apply a 50% penalty!
...
Are you sure?`)&&Vr(r.dataset.index,!0)})})}function Ip(e){const t=_(e.amount).toFixed(2),n=Ut(ql(e.amount,e.lockDuration)),a=Number(e.unlockTime),s=Math.floor(Date.now()/1e3),r=a>s,i=r?a-s:0,o=Math.floor(Number(e.lockDuration)/86400);return`
    ...
    `}function Yr(){const e=document.querySelectorAll(".countdown-timer"),t=Math.floor(Date.now()/1e3);e.forEach(n=>{const a=parseInt(n.dataset.unlockTime);n.textContent=Vl(a-t)})}async function Ap(){if(c.userAddress)try{const e=Te.getHistory||"https://gethistory-4wvdcuoouq-uc.a.run.app",t=await fetch(`${e}/${c.userAddress}`);t.ok&&(cs=(await t.json()||[]).filter(a=>{const s=(a.type||"").toUpperCase();return s.includes("DELEGAT")||s.includes("STAKE")||s.includes("UNDELEGAT")||s.includes("CLAIM")||s.includes("REWARD")||s.includes("FORCE")}),Zl())}catch(e){console.error("History load error:",e)}}function Zl(){const e=document.getElementById("staking-history-list");if(!e)return;let t=cs;if(pn!=="ALL"&&(t=cs.filter(n=>{const a=(n.type||"").toUpperCase();switch(pn){case"STAKE":return(a.includes("DELEGAT")||a.includes("STAKE"))&&!a.includes("UNSTAKE")&&!a.includes("UNDELEGAT")&&!a.includes("FORCE");case"UNSTAKE":return a.includes("UNSTAKE")||a.includes("UNDELEGAT")||a.includes("FORCE");case"CLAIM":return a.includes("CLAIM")||a.includes("REWARD");default:return!0}})),t.length===0){e.innerHTML=`
        ...
        `;return}e.innerHTML=t.slice(0,25).map(n=>{const a=(n.type||"").toUpperCase(),s=n.details||{},r=hp(n.timestamp||n.createdAt);let i,o,l,d,p="";a.includes("FORCE")?(i="fa-bolt",o="bg-red-500/15",l="text-red-400",d="Force Unstaked",s.feePaid&&BigInt(s.feePaid)>0n&&(p=`<span class="text-red-400">-${_(BigInt(s.feePaid)).toFixed(2)} penalty</span>`)):(a.includes("DELEGAT")||a.includes("STAKE"))&&!a.includes("UNSTAKE")?(i="fa-lock",o="bg-green-500/15",l="text-green-400",d="Delegated",s.pStakeGenerated&&(p=`<span class="text-purple-400">+${_(BigInt(s.pStakeGenerated)).toFixed(0)} pS</span>`)):a.includes("UNSTAKE")||a.includes("UNDELEGAT")?(i="fa-unlock",o="bg-orange-500/15",l="text-orange-400",d="Unstaked"):a.includes("CLAIM")||a.includes("REWARD")?(i="fa-coins",o="bg-amber-500/15",l="text-amber-400",d="Claimed",s.amountReceived&&BigInt(s.amountReceived)>0n&&(p=`<span class="text-green-400">+${_(BigInt(s.amountReceived)).toFixed(2)}</span>`)):(i="fa-circle",o="bg-zinc-500/15",l="text-zinc-400",d=n.type||"Activity");const f=n.txHash?`${gp}${n.txHash}`:"#",u=n.amount||s.amount||s.amountReceived||"0",b=_(BigInt(u)),m=b>.001?b.toFixed(2):"";return`
    ...
    `}const Op={async render(e){Mp(),await Bi();const t=document.getElementById("store");t&&((t.innerHTML.trim()===""||e)&&(t.innerHTML=`
            ...
            `,Gp()),z.selectedPoolBoostBips===null&&ge.length>0&&(z.selectedPoolBoostBips=ge[0].boostBips),await at(),await mn())},async update(){z.selectedPoolBoostBips!==null&&!z.isDataLoading&&document.getElementById("store")&&!document.hidden&&await at()}};async function mn(){const e=document.getElementById("history-list");if(!c.userAddress){e&&(e.innerHTML='<div class="text-center py-4 text-xs text-zinc-600">Connect wallet to view history</div>');return}try{const t=Te.getHistory||"https://gethistory-4wvdcuoouq-uc.a.run.app",n=await fetch(`${t}/${c.userAddress}`);if(!n.ok)throw new Error(`HTTP ${n.status}`);const a=await n.json();console.log("All history types:",[...new Set((a||[]).map(r=>r.type))]),z.tradeHistory=(a||[]).filter(r=>{const i=(r.type||"").toUpperCase();return i==="NFTBOUGHT"||i==="NFTSOLD"||i==="NFT_BOUGHT"||i==="NFT_SOLD"||i==="NFTPURCHASED"||i==="NFT_PURCHASED"||i.includes("NFTBOUGHT")||i.includes("NFTSOLD")||i.includes("NFTPURCHASED")}),console.log("NFT trade history:",z.tradeHistory.length,"items");const s=document.getElementById("history-count");s&&(s.textContent=z.tradeHistory.length),Xr()}catch(t){console.error("History load error:",t),z.tradeHistory=[],Xr()}}function Xr(){const e=document.getElementById("history-list");if(e){if(!c.isConnected){e.innerHTML='<div class="text-center py-4 text-xs text-zinc-600">Connect wallet to view history</div>';return}if(z.tradeHistory.length===0){e.innerHTML=`
        ...
        `;return}e.innerHTML=z.tradeHistory.slice(0,20).map(t=>{const n=(t.type||"").toUpperCase(),a=t.details||{},s=_p(t.timestamp||t.createdAt),r=n.includes("BOUGHT")||n.includes("PURCHASED"),i=r?"fa-cart-plus":"fa-money-bill-transfer",o=r?"#22c55e":"#f59e0b",l=r?"rgba(34,197,94,0.15)":"rgba(245,158,11,0.15)",d=r?"🛒 Bought NFT":"💰 Sold NFT",p=r?"-":"+",f=t.txHash?`${Sp}${t.txHash}`:"#";let u="";try{let g=t.amount||a.amount||a.price||a.payout||"0";if(typeof g=="string"&&g!=="0"){const y=_(BigInt(g));y>.001&&(u=y.toFixed(2))}}catch{}const b=a.tokenId||"",m=a.boostBips||a.boost||"";return`
            <a href="${f}" target="_blank" class="history-item flex items-center justify-between p-3 hover:bg-zinc-800/60 border border-zinc-700/30 rounded-lg transition-all group bg-zinc-800/20">
                ...
                <div class="flex items-center gap-2">
                    ${u?`<span class="text-xs font-mono font-bold ${r?"text-white":"text-green-400"}">${p}${u} <span class="text-zinc-500">BKC</span></span>`:""}
        ...
        `}).join("")}function Jr(e){document.querySelectorAll(".tier-chip").forEach(t=>{const n=Number(t.dataset.boost)===e,a=t.dataset.tier,s=Ca(a);t.className=`tier-chip flex flex-col items-center gap-1 p-2 rounded-xl border transition-all ${n?`bg-gradient-to-br ${s.gradient} ${s.border} ${s.text} active`:"bg-zinc-800/50 border-zinc-700/50 text-zinc-400 hover:border-zinc-600"}`})}function aa(){const e=document.getElementById("swap-interface");if(!e)return;const t=ge.find(b=>b.boostBips===z.selectedPoolBoostBips),n=Ca(t==null?void 0:t.name),a=z.tradeDirection==="buy";jp(a);const s=a?z.buyPrice:z.netSellPrice,r=_(s).toFixed(2),i=_(c.currentUserBalance||0n).toFixed(2),o=a&&z.firstAvailableTokenIdForBuy===null,l=!a&&z.availableToSellCount===0,d=!a&&z.userBalanceOfSelectedNFT>z.availableToSellCount,p=a&&z.buyPrice>(c.currentUserBalance||0n),f=a?"":d?`<span class="${l?"text-red-400":"text-zinc-400"}">${z.availableToSellCount}</span>/<span class="text-zinc-500">${z.userBalanceOfSelectedNFT}</span> <span class="text-[9px] text-blue-400">(${z.userBalanceOfSelectedNFT-z.availableToSellCount} rented)</span>`:`<span class="${l?"text-red-400":"text-zinc-400"}">${z.userBalanceOfSelectedNFT}</span>`,u=n.icon||(t==null?void 0:t.emoji)||"💎";lt((t==null?void 0:t.boostBips)||0),e.innerHTML=`
        <div class="fade-in">
            ...
            <div class="swap-input-box rounded-2xl p-4 mb-1">
                ...
                <div class="flex justify-between items-center">
                    <span class="text-2xl font-semibold ${p&&a?"text-red-400":"text-white"}">
                        ${a?r:"1"}
                        ${!a&&z.firstAvailableTokenId?`<span class="text-sm text-amber-400 ml-2">#${z.firstAvailableTokenId.toString()}</span>`:""}
                    </span>
            ...
            <div class="swap-input-box rounded-2xl p-4 mt-1 mb-4">
                <div class="flex justify-between items-center mb-2">
                    ...
                    <span class="text-xs text-zinc-600">
                        ${a?`In pool: <span class="${o?"text-red-400":"text-green-400"}">${z.poolNFTCount}</span>`:"Net after fee"}
                    </span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-2xl font-semibold text-white">${a?"1":_(z.netSellPrice).toFixed(2)}</span>
                    <div class="token-selector flex items-center gap-2 px-3 py-2 rounded-xl cursor-default">
    ...
    `}function Up(e,t,n,a,s=!1){return c.isConnected?e?t?`
        ...
        `;return}const a=c.rentalListings||[],s=new Set(a.map(i=>{var o;return(o=i.tokenId)==null?void 0:o.toString()})),r=Math.floor(Date.now()/1e3);e.innerHTML=n.map(i=>{var E;const o=ge.find(I=>I.boostBips===Number(i.boostBips)),l=Ca(o==null?void 0:o.name),d=lt(Number(i.boostBips)),p=l.icon||(o==null?void 0:o.emoji)||"💎",f=z.firstAvailableTokenId&&BigInt(i.tokenId)===z.firstAvailableTokenId,u=(E=i.tokenId)==null?void 0:E.toString(),b=s.has(u),m=a.find(I=>{var P;return((P=I.tokenId)==null?void 0:P.toString())===u}),g=m&&m.rentalEndTime&&Number(m.rentalEndTime)>r,y=b||g;let k="";return g?k='<span class="absolute top-1 right-1 bg-blue-500 text-white text-[7px] px-1.5 py-0.5 rounded-full font-bold">🔑</span>':b&&(k='<span class="absolute top-1 right-1 bg-green-500 text-white text-[7px] px-1.5 py-0.5 rounded-full font-bold">📋</span>'),`
        ...
        `}).join("")}async function at(e=!1){var a,s;if(z.selectedPoolBoostBips===null)return;const t=z.selectedPoolBoostBips,n=Date.now();if(ht=n,!e){const r=Fp(t);if(r){ds(r),aa(),Zr(),Wp(t,n);return}}z.isDataLoading=!0;try{const r=c.myBoosters||[],i=c.rentalListings||[],o=new Set(i.map(D=>{var W;return(W=D.tokenId)==null?void 0:W.toString()})),l=Math.floor(Date.now()/1e3),d=r.filter(D=>Number(D.boostBips)===t),p=d.filter(D=>{var $e;const W=($e=D.tokenId)==null?void 0:$e.toString(),ue=i.find(Q=>{var rn;return((rn=Q.tokenId)==null?void 0:rn.toString())===W}),ae=o.has(W),Qe=ue&&ue.rentalEndTime&&Number(ue.rentalEndTime)>l;return!ae&&!Qe}),f=ge.find(D=>D.boostBips===t);if(!f){console.warn("Tier not found for boostBips:",t);return}const u=`pool_${f.name.toLowerCase()}`;let b=v[u]||na.get(t);if(!b){const D=v.nftLiquidityPoolFactory;if(D&&c.publicProvider)try{b=await new Ie.Contract(D,$p,c.publicProvider).getPoolAddress(t),b&&b!==Ie.ZeroAddress&&na.set(t,b)}catch(W){console.warn("Factory lookup failed:",W.message)}}if(ht!==n)return;if(!b||b===Ie.ZeroAddress){const D=document.getElementById("swap-interface");D&&(D.innerHTML=`
                    <div class="text-center py-12">
                ...
                `);return}const m=new Ie.Contract(b,Ei,c.publicProvider),[g,y,k]=await Promise.all([ne(m,"getBuyPrice",[],Ie.MaxUint256).catch(()=>Ie.MaxUint256),ne(m,"getSellPrice",[],0n).catch(()=>0n),m.getAvailableNFTs().catch(()=>[])]);if(ht!==n)return;const E=Array.isArray(k)?[...k]:[],I=g===Ie.MaxUint256?0n:g,P=y;let L=((a=c.systemFees)==null?void 0:a.NFT_POOL_SELL_TAX_BIPS)||1000n,T=BigInt(((s=c.boosterDiscounts)==null?void 0:s[z.bestBoosterBips])||0);const F=typeof L=="bigint"?L:BigInt(L),G=typeof T=="bigint"?T:BigInt(T),se=F>G?F-G:0n,ce=P*se/10000n,xe=P-ce,Z={buyPrice:I,sellPrice:P,netSellPrice:xe,poolNFTCount:E.length,firstAvailableTokenIdForBuy:E.length>0?BigInt(E[E.length-1]):null,userBalanceOfSelectedNFT:d.length,availableToSellCount:p.length,availableNFTsOfTier:p};ec(t,Z),ds(Z,t)}catch(r){if(console.warn("Store Data Warning:",r.message),ht===n){const i=document.getElementById("swap-interface");i&&(i.innerHTML=`
                    <div class="text-center py-12">
                        <div class="w-12 h-12 bg-zinc-800 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                `)}return}finally{ht===n&&(z.isDataLoading=!1,aa(),Zr())}}async function Wp(e,t){var n,a;try{const s=c.myBoosters||[],r=c.rentalListings||[],i=new Set(r.map(Z=>{var D;return(D=Z.tokenId)==null?void 0:D.toString()})),o=Math.floor(Date.now()/1e3),l=s.filter(Z=>Number(Z.boostBips)===e),d=l.filter(Z=>{var Qe;const D=(Qe=Z.tokenId)==null?void 0:Qe.toString(),W=r.find($e=>{var Q;return((Q=$e.tokenId)==null?void 0:Q.toString())===D}),ue=i.has(D),ae=W&&W.rentalEndTime&&Number(W.rentalEndTime)>o;return!ue&&!ae}),p=ge.find(Z=>Z.boostBips===e);if(!p)return;const f=`pool_${p.name.toLowerCase()}`;let u=v[f]||na.get(e);if(!u||u===Ie.ZeroAddress)return;const b=new Ie.Contract(u,Ei,c.publicProvider),[m,g,y]=await Promise.all([ne(b,"getBuyPrice",[],Ie.MaxUint256).catch(()=>Ie.MaxUint256),ne(b,"getSellPrice",[],0n).catch(()=>0n),b.getAvailableNFTs().catch(()=>[])]);if(ht!==t)return;const k=Array.isArray(y)?[...y]:[],E=m===Ie.MaxUint256?0n:m,I=g;let P=((n=c.systemFees)==null?void 0:n.NFT_POOL_SELL_TAX_BIPS)||1000n,L=BigInt(((a=c.boosterDiscounts)==null?void 0:a[z.bestBoosterBips])||0);const T=typeof P=="bigint"?P:BigInt(P),F=typeof L=="bigint"?L:BigInt(L),G=T>F?T-F:0n,se=I*G/10000n,ce=I-se,xe={buyPrice:E,sellPrice:I,netSellPrice:ce,poolNFTCount:k.length,firstAvailableTokenIdForBuy:k.length>0?BigInt(k[k.length-1]):null,userBalanceOfSelectedNFT:l.length,availableToSellCount:d.length,availableNFTsOfTier:d};ec(e,xe),z.selectedPoolBoostBips===e&&ht===t&&(ds(xe,e),aa())}catch(s){console.warn("Background refresh failed:",s.message)}}function ds(e,t){var s,r,i;z.buyPrice=e.buyPrice,z.sellPrice=e.sellPrice,z.netSellPrice=e.netSellPrice,z.poolNFTCount=e.poolNFTCount,z.firstAvailableTokenIdForBuy=e.firstAvailableTokenIdForBuy,z.userBalanceOfSelectedNFT=e.userBalanceOfSelectedNFT,z.availableToSellCount=e.availableToSellCount;const n=z.firstAvailableTokenId;!(n&&((s=e.availableNFTsOfTier)==null?void 0:s.some(o=>BigInt(o.tokenId)===n)))&&((r=e.availableNFTsOfTier)==null?void 0:r.length)>0?z.firstAvailableTokenId=BigInt(e.availableNFTsOfTier[0].tokenId):(i=e.availableNFTsOfTier)!=null&&i.length||(z.firstAvailableTokenId=null)}function Gp(){const e=document.getElementById("store");e&&e.addEventListener("click",async t=>{if(t.target.closest("#refresh-btn")){const i=t.target.closest("#refresh-btn").querySelector("i");i.classList.add("fa-spin"),Ua(z.selectedPoolBoostBips),await Promise.all([vt(!0),Ni()]),await at(!0),mn(),i.classList.remove("fa-spin");return}const n=t.target.closest(".tier-chip");if(n){const r=Number(n.dataset.boost);z.selectedPoolBoostBips!==r&&(z.selectedPoolBoostBips=r,z.firstAvailableTokenId=null,Jr(r),await at());return}if(t.target.closest("#swap-direction-btn")){z.tradeDirection=z.tradeDirection==="buy"?"sell":"buy",aa();return}if(t.target.closest("#inventory-toggle")){const r=document.getElementById("inventory-panel"),i=document.getElementById("inventory-chevron");r&&i&&(r.classList.toggle("hidden"),i.style.transform=r.classList.contains("hidden")?"":"rotate(180deg)");return}if(t.target.closest("#history-toggle")){const r=document.getElementById("history-panel"),i=document.getElementById("history-chevron");r&&i&&(r.classList.toggle("hidden"),i.style.transform=r.classList.contains("hidden")?"":"rotate(180deg)");return}const a=t.target.closest(".inventory-item");if(a){if(a.dataset.unavailable==="true"){x("This NFT is listed for rental and cannot be sold","warning");return}const i=Number(a.dataset.boost),o=a.dataset.tokenid;z.selectedPoolBoostBips=i,z.tradeDirection="sell",o&&(z.firstAvailableTokenId=BigInt(o),console.log("User selected NFT #"+o+" for sale")),Jr(i),await at();return}const s=t.target.closest("#execute-btn");if(s){if(t.preventDefault(),t.stopPropagation(),Vn||s.disabled)return;const r=s.dataset.action,i=document.getElementById("trade-mascot");if(r==="connect"){window.openConnectModal();return}const o=ge.find(f=>f.boostBips===z.selectedPoolBoostBips);if(!o)return;const l=`pool_${o.name.toLowerCase()}`,d=v[l]||na.get(o.boostBips);if(!d){x("Pool address not found","error");return}Vn=!0,s.disabled=!0;const p=s.innerHTML;s.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Processing...',i&&(i.className="w-14 h-14 object-contain trade-spin");try{if(z.tradeDirection==="buy")await ns.buyFromPool({poolAddress:d,maxPrice:z.buyPrice,button:s,onSuccess:async f=>{i&&(i.className="w-14 h-14 object-contain trade-success"),x("🟢 NFT Purchased!","success"),Ua(z.selectedPoolBoostBips),await Promise.all([vt(!0),at(!0)]),mn()},onError:f=>{if(!f.cancelled&&f.type!=="user_rejected"){const u=f.message||f.reason||"Transaction failed";x("Buy failed: "+u,"error")}}});else{if(!z.firstAvailableTokenId){x("No NFT selected for sale","error"),Vn=!1,s.disabled=!1,s.innerHTML=p;return}await ns.sellToPool({poolAddress:d,tokenId:z.firstAvailableTokenId,button:s,onSuccess:async f=>{i&&(i.className="w-14 h-14 object-contain trade-success"),x("🔴 NFT Sold!","success"),Ua(z.selectedPoolBoostBips),await Promise.all([vt(!0),at(!0)]),mn()},onError:f=>{if(!f.cancelled&&f.type!=="user_rejected"){const u=f.message||f.reason||"Transaction failed";x("Sell failed: "+u,"error")}}})}}finally{Vn=!1,s.disabled=!1,s.innerHTML=p,setTimeout(async()=>{try{await Promise.all([vt(!0),at(!0)]),mn()}catch(f){console.warn("[Store] Post-transaction refresh failed:",f.message)}},2e3),i&&setTimeout(()=>{const f=z.tradeDirection==="buy";i.className=`w-14 h-14 object-contain ${f?"trade-buy":"trade-sell"}`},800)}}})}const Kp="https://sepolia.arbiscan.io/tx/",ln={NONE:{boost:0,burnRate:50,keepRate:50,color:"#71717a",name:"None",icon:"○",emoji:"❌",class:"tier-none"},BRONZE:{boost:1e3,burnRate:40,keepRate:60,color:"#cd7f32",name:"Bronze",icon:"🥉",emoji:"🥉",class:"tier-bronze"},SILVER:{boost:2500,burnRate:25,keepRate:75,color:"#c0c0c0",name:"Silver",icon:"🥈",emoji:"🥈",class:"tier-silver"},GOLD:{boost:4e3,burnRate:10,keepRate:90,color:"#ffd700",name:"Gold",icon:"🥇",emoji:"🥇",class:"tier-gold"},DIAMOND:{boost:5e3,burnRate:0,keepRate:100,color:"#b9f2ff",name:"Diamond",icon:"💎",emoji:"💎",class:"tier-diamond"}};let ja=0,Wa=!1,Jn=!1,An=[],Bn=null,be=0,Wt=50,sa="none",ra=0n,je=null,qn=0;const Qr=3e4;window.handleRewardsClaim=async function(){Jn||await t0()};function tc(e){return e>=5e3?ln.DIAMOND:e>=4e3?ln.GOLD:e>=2500?ln.SILVER:e>=1e3?ln.BRONZE:ln.NONE}function Yp(e){const t=Math.floor((new Date-e)/1e3);return t<60?"Just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:t<604800?`${Math.floor(t/86400)}d ago`:e.toLocaleDateString()}function Vp(){if(document.getElementById("rewards-styles-v6"))return;const e=document.createElement("style");e.id="rewards-styles-v6",e.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
...
#Backcoin #Web3 #Arbitrum`}},Ga={pt:"./assets/pt.png",en:"./assets/en.png",es:"./assets/es.png"};let We="en";const de=[{id:1,name:"Easy",emoji:"🍀",range:3,multiplier:2,chance:"33%",color:"emerald",hex:"#10b981",bgFrom:"from-emerald-500/20",bgTo:"to-green-600/10",borderColor:"border-emerald-500/50",textColor:"text-emerald-400"},{id:2,name:"Medium",emoji:"⚡",range:10,multiplier:5,chance:"10%",color:"violet",hex:"#8b5cf6",bgFrom:"from-violet-500/20",bgTo:"to-purple-600/10",borderColor:"border-violet-500/50",textColor:"text-violet-400"},{id:3,name:"Hard",emoji:"👑",range:100,multiplier:50,chance:"1%",color:"amber",hex:"#f59e0b",bgFrom:"from-amber-500/20",bgTo:"to-orange-600/10",borderColor:"border-amber-500/50",textColor:"text-amber-400"}],ac=57,w={mode:null,phase:"select",guess:50,guesses:[2,5,50],comboStep:0,wager:10,gameId:null,result:null,txHash:null,poolStatus:null,history:[],serviceFee:0n,serviceFee1x:0n,serviceFee5x:0n,tiersData:null,commitment:{hash:null,userSecret:null,commitBlock:null,commitTxHash:null,revealDelay:5,waitStartTime:null,canReveal:!1}};let Ve=null;const s0=3e3,er=250;function r0(){if(document.getElementById("fortune-styles-v2"))return;const e=document.createElement("style");e.id="fortune-styles-v2",e.textContent=`
    ...
    `,nr(),oe()}function o0(){Ve&&(clearInterval(Ve),Ve=null),w.phase="select",w.result=null,w.commitment={hash:null,userSecret:null,commitBlock:null,commitTxHash:null,revealDelay:5,waitStartTime:null,canReveal:!1}}function oe(){const e=document.getElementById("game-area");if(e)switch(l0(w.phase),w.phase){case"select":ai(e);break;case"pick":c0(e);break;case"wager":p0(e);break;case"processing":f0(e);break;case"waiting":b0(e);break;case"result":v0(e);break;default:ai(e)}}function l0(e){var n;const t=document.getElementById("tiger-mascot");if(t)switch(t.className="w-28 h-28 object-contain mx-auto",t.style.filter="",e){case"select":t.classList.add("tiger-float","tiger-pulse");break;case"pick":case"wager":t.classList.add("tiger-float");break;case"processing":t.classList.add("tiger-spin");break;case"waiting":t.classList.add("tiger-float"),t.style.filter="hue-rotate(270deg)";break;case"result":((n=w.result)==null?void 0:n.prizeWon)>0?t.classList.add("tiger-celebrate"):(t.style.filter="grayscale(0.5)",t.classList.add("tiger-float"));break}}function ai(e){var s,r;const t=w.serviceFee1x>0n?(Number(w.serviceFee1x)/1e18).toFixed(6):"0",n=w.serviceFee5x>0n?(Number(w.serviceFee5x)/1e18).toFixed(6):"0",a=w.serviceFee1x>0n||w.serviceFee5x>0n;e.innerHTML=`
        <div class="space-y-4">
            <!-- JACKPOT MODE -->
    ...
    `,(s=document.getElementById("btn-jackpot"))==null||s.addEventListener("click",()=>{if(!c.isConnected)return x("Connect wallet first","warning");w.mode="jackpot",w.guess=50,w.phase="pick",oe()}),(r=document.getElementById("btn-combo"))==null||r.addEventListener("click",()=>{if(!c.isConnected)return x("Connect wallet first","warning");w.mode="combo",w.guesses=[2,5,50],w.comboStep=0,w.phase="pick",oe()})}function c0(e){w.mode==="jackpot"?d0(e):u0(e)}function d0(e){var o,l,d,p,f,u,b;const t=de[2],n=w.guess;e.innerHTML=`
    ...
    `;const a=document.getElementById("number-input"),s=document.getElementById("number-slider"),r=de[2],i=m=>{m=Math.max(1,Math.min(100,m)),w.guess=m,a&&(a.value=m),s&&(s.value=m,s.style.background=`linear-gradient(to right, ${r.hex} 0%, ${r.hex} ${m}%, #27272a ${m}%, #27272a 100%)`)};a==null||a.addEventListener("input",m=>i(parseInt(m.target.value)||1)),a==null||a.addEventListener("blur",m=>i(parseInt(m.target.value)||1)),s==null||s.addEventListener("input",m=>i(parseInt(m.target.value))),(o=document.getElementById("btn-minus"))==null||o.addEventListener("click",()=>i(w.guess-1)),(l=document.getElementById("btn-plus"))==null||l.addEventListener("click",()=>i(w.guess+1)),(d=document.getElementById("btn-minus-10"))==null||d.addEventListener("click",()=>i(w.guess-10)),(p=document.getElementById("btn-plus-10"))==null||p.addEventListener("click",()=>i(w.guess+10)),document.querySelectorAll(".quick-pick").forEach(m=>{m.addEventListener("click",()=>i(parseInt(m.dataset.number)))}),(f=document.getElementById("btn-random"))==null||f.addEventListener("click",()=>{i(Math.floor(Math.random()*100)+1)}),(u=document.getElementById("btn-back"))==null||u.addEventListener("click",()=>{w.phase="select",oe()}),(b=document.getElementById("btn-next"))==null||b.addEventListener("click",()=>{w.phase="wager",oe()})}function u0(e){var r,i,o,l,d,p,f;const t=de[w.comboStep],n=w.guesses[w.comboStep],a=t.range===100;if(e.innerHTML=`
        <div class="bg-gradient-to-br from-zinc-900 to-zinc-800/50 border border-zinc-700/50 rounded-2xl p-5">
            <!-- Progress Pills -->
            <div class="flex justify-center gap-2 sm:gap-3 mb-5">
                ${de.map((u,b)=>{const m=b===w.comboStep,g=b<w.comboStep;return`
                        <div class="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 rounded-xl border ${m?`bg-gradient-to-br ${u.bgFrom} ${u.bgTo} ${u.borderColor}`:g?"bg-emerald-500/10 border-emerald-500/50":"bg-zinc-800/50 border-zinc-700/50"}">
                            <span class="text-lg sm:text-xl">${g?"✓":u.emoji}</span>
                            <div class="text-left">
                                <p class="text-[10px] sm:text-xs font-bold ${m?u.textColor:g?"text-emerald-400":"text-zinc-500"}">${u.name}</p>
                                <p class="text-[8px] sm:text-[10px] ${g?"text-emerald-400 font-bold":"text-zinc-600"}">${g?w.guesses[b]:u.multiplier+"x"}</p>
                            </div>
                        </div>
                    `}).join("")}
            </div>
            ...
            <div class="flex gap-3">
                <button id="btn-back" class="flex-1 py-3.5 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 font-bold rounded-xl transition-colors">
                    <i class="fa-solid fa-arrow-left mr-2"></i>${w.comboStep>0?"Previous":"Back"}
                </button>
                <button id="btn-next" class="flex-1 py-3.5 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-black font-bold rounded-xl transition-all">
                    ${w.comboStep<2?"Next":"Continue"}<i class="fa-solid fa-arrow-right ml-2"></i>
                </button>
            </div>
        </div>
    `,t.range===100){const u=document.getElementById("combo-number-input"),b=document.getElementById("combo-slider"),m=g=>{g=Math.max(1,Math.min(100,g)),w.guesses[w.comboStep]=g,u&&(u.value=g),b&&(b.value=g,b.style.background=`linear-gradient(to right, ${t.hex} 0%, ${t.hex} ${g}%, #27272a ${g}%, #27272a 100%)`)};u==null||u.addEventListener("input",g=>m(parseInt(g.target.value)||1)),u==null||u.addEventListener("blur",g=>m(parseInt(g.target.value)||1)),b==null||b.addEventListener("input",g=>m(parseInt(g.target.value))),(r=document.querySelector(".combo-minus"))==null||r.addEventListener("click",()=>m(w.guesses[w.comboStep]-1)),(i=document.querySelector(".combo-plus"))==null||i.addEventListener("click",()=>m(w.guesses[w.comboStep]+1)),(o=document.querySelector(".combo-minus-10"))==null||o.addEventListener("click",()=>m(w.guesses[w.comboStep]-10)),(l=document.querySelector(".combo-plus-10"))==null||l.addEventListener("click",()=>m(w.guesses[w.comboStep]+10)),document.querySelectorAll(".combo-quick").forEach(g=>{g.addEventListener("click",()=>m(parseInt(g.dataset.num)))}),(d=document.querySelector(".combo-random"))==null||d.addEventListener("click",()=>{m(Math.floor(Math.random()*100)+1)})}else document.querySelectorAll(".num-btn").forEach(u=>{u.addEventListener("click",()=>{const b=parseInt(u.dataset.num);w.guesses[w.comboStep]=b,document.querySelectorAll(".num-btn").forEach(m=>{parseInt(m.dataset.num)===b?m.className=`num-btn w-12 h-12 rounded-xl font-bold text-lg transition-all bg-gradient-to-br ${t.bgFrom} ${t.bgTo} border-2 ${t.borderColor} ${t.textColor}`:m.className="num-btn w-12 h-12 rounded-xl font-bold text-lg transition-all bg-zinc-800/60 border border-zinc-700/50 text-zinc-400 hover:border-zinc-600"})})});(p=document.getElementById("btn-back"))==null||p.addEventListener("click",()=>{w.comboStep>0?(w.comboStep--,oe()):(w.phase="select",oe())}),(f=document.getElementById("btn-next"))==null||f.addEventListener("click",()=>{w.comboStep<2?(w.comboStep++,oe()):(w.phase="wager",oe())})}function p0(e){const t=w.mode==="jackpot",n=t?[w.guess]:w.guesses,a=t?50:ac,s=_(c.currentUserBalance||0n),r=s>=1,i=t?w.serviceFee1x:w.serviceFee5x,o=i>0n?Number(i)/1e18:0,l=i>0n;e.innerHTML=`
        <div class="bg-gradient-to-br from-zinc-900 to-zinc-800/50 border border-zinc-700/50 rounded-2xl p-5">
            <div class="text-center mb-5">
                <h2 class="text-xl font-bold text-white mb-2">🎰 Your Selection</h2>
                <div class="flex justify-center gap-3">
                    ${(t?[{tier:de[2],pick:n[0]}]:n.map((d,p)=>({tier:de[p],pick:d}))).map(({tier:d,pick:p})=>`
            ...
            <div class="mb-5">
                ...
                <div class="relative p-4 bg-gradient-to-br from-amber-500/10 to-orange-500/5 border-2 border-amber-500/40 rounded-2xl mb-3 hover:border-amber-500/60 transition-all group">
                    ...
                    <div class="flex items-center justify-center gap-3">
                        ...
                        <div class="relative">
                            <input type="number" id="custom-wager" value="${w.wager}" min="1" max="${Math.floor(s)}"
            ...
            <div class="p-4 bg-gradient-to-r from-emerald-900/20 to-green-900/10 border border-emerald-500/30 rounded-xl mb-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-black text-emerald-400" id="potential-win">${(w.wager*a).toLocaleString()}</p>
    ...
    `,m0(a,s)}function m0(e,t){var a,s,r,i,o,l,d,p;const n=f=>{w.wager=Math.max(1,Math.min(Math.floor(f),Math.floor(t)));const u=document.getElementById("custom-wager"),b=document.getElementById("potential-win");u&&(u.value=w.wager),b&&(b.textContent=(w.wager*e).toLocaleString()),document.querySelectorAll(".percent-btn").forEach(m=>{const g=parseInt(m.dataset.value);w.wager===g?m.className="percent-btn py-2.5 text-sm font-bold rounded-xl transition-all bg-gradient-to-r from-amber-500/30 to-orange-500/20 border-2 border-amber-500/60 text-amber-400 shadow-lg shadow-amber-500/20":m.className="percent-btn py-2.5 text-sm font-bold rounded-xl transition-all bg-zinc-800/60 border border-zinc-700/50 text-zinc-400 hover:border-amber-500/30 hover:text-amber-300"})};document.querySelectorAll(".percent-btn").forEach(f=>{f.addEventListener("click",()=>{n(parseInt(f.dataset.value)||1)})}),(a=document.getElementById("custom-wager"))==null||a.addEventListener("input",f=>{n(parseInt(f.target.value)||1)}),(s=document.getElementById("wager-minus"))==null||s.addEventListener("click",()=>{n(w.wager-1)}),(r=document.getElementById("wager-plus"))==null||r.addEventListener("click",()=>{n(w.wager+1)}),(i=document.getElementById("wager-minus-10"))==null||i.addEventListener("click",()=>{n(w.wager-10)}),(o=document.getElementById("wager-plus-10"))==null||o.addEventListener("click",()=>{n(w.wager+10)}),(l=document.getElementById("btn-faucet"))==null||l.addEventListener("click",async()=>{x("Requesting tokens...","info");try{const u=await(await fetch(`https://faucet-4wvdcuoouq-uc.a.run.app?address=${c.userAddress}`)).json();u.success?(x("🎉 Tokens received!","success"),await Nt(),oe()):x(u.error||"Error","error")}catch{x("Faucet error","error")}}),(d=document.getElementById("btn-back"))==null||d.addEventListener("click",()=>{w.phase="pick",w.mode==="combo"&&(w.comboStep=2),oe()}),(p=document.getElementById("btn-play"))==null||p.addEventListener("click",async()=>{if(w.wager<1)return x("Min: 1 BKC","warning");w.phase="processing",oe();try{const f=w.mode==="jackpot"?[w.guess]:w.guesses,u=w.mode==="combo",b=window.ethers.parseEther(w.wager.toString());await Hs.commitPlay({wagerAmount:b,guesses:f,isCumulative:u,button:document.getElementById("btn-play"),onSuccess:(m,g)=>{w.gameId=(g==null?void 0:g.gameId)||Date.now(),w.commitment={hash:(g==null?void 0:g.commitHash)||null,userSecret:(g==null?void 0:g.userSecret)||null,commitBlock:(g==null?void 0:g.commitBlock)||null,commitTxHash:m.hash,revealDelay:(g==null?void 0:g.revealDelay)||5,waitStartTime:Date.now(),canReveal:!1},w.txHash=m.hash,console.log("🔐 Game committed:",w.gameId,"Block:",w.commitment.commitBlock),w.phase="waiting",oe(),g0()},onError:m=>{m.cancelled||x(m.message||"Commit failed","error"),w.phase="wager",oe()}})}catch(f){console.error("Commit error:",f);const u=f.message||f.reason||"Transaction failed";x("Error: "+u,"error"),w.phase="wager",oe()}})}function f0(e){const t=w.mode==="jackpot",n=t?[w.guess]:w.guesses,a=t?[de[2]]:de;e.innerHTML=`
    ...
    `,a.forEach((s,r)=>{const i=document.getElementById(`spin-${r}`);if(!i)return;setInterval(()=>{i.textContent=Math.floor(Math.random()*s.range)+1},80)})}function b0(e){var l;const t=w.mode==="jackpot",n=t?[w.guess]:w.guesses,a=t?[de[2]]:de,s=Date.now()-(w.commitment.waitStartTime||Date.now()),r=w.commitment.revealDelay*er,i=Math.max(0,r-s),o=Math.ceil(i/1e3);e.innerHTML=`
        <div class="bg-gradient-to-br from-violet-900/30 to-purple-900/20 border border-violet-500/30 rounded-2xl p-6 waiting-glow">
            ...
            <div class="grid grid-cols-2 gap-3 mb-4">
                <div class="bg-zinc-800/50 rounded-xl p-3 text-center border border-zinc-700/50">
                    ...
                    <p class="text-sm font-mono text-white">#${w.commitment.commitBlock||"..."}</p>
                </div>
                <div class="bg-zinc-800/50 rounded-xl p-3 text-center border border-zinc-700/50">
                    <p class="text-[10px] text-zinc-500 uppercase mb-1">Reveal After</p>
                    <p class="text-sm font-mono text-violet-400">#${(w.commitment.commitBlock||0)+w.commitment.revealDelay}</p>
                </div>
            </div>
            ...
            <button id="btn-reveal" 
                class="w-full py-3 rounded-xl font-bold transition-all ${w.commitment.canReveal?"bg-gradient-to-r from-emerald-500 to-green-500 text-white hover:shadow-lg hover:shadow-emerald-500/30":"bg-zinc-800 text-zinc-500 cursor-not-allowed"}" 
                ${w.commitment.canReveal?"":"disabled"}>
                <i class="fa-solid ${w.commitment.canReveal?"fa-dice":"fa-lock"} mr-2"></i>
                <span id="reveal-btn-text">${w.commitment.canReveal?"Reveal & Get Result!":"Waiting for blocks..."}</span>
            </button>
            ...
            ${w.commitment.commitTxHash?`
                <div class="text-center mt-3">
                    <a href="${Qs}${w.commitment.commitTxHash}" target="_blank" 
    ...
    `,(l=document.getElementById("btn-reveal"))==null||l.addEventListener("click",()=>{w.commitment.canReveal&&h0()}),tr()}function tr(){if(w.phase!=="waiting")return;const e=document.getElementById("countdown-timer"),t=document.getElementById("progress-bar"),n=document.getElementById("btn-reveal"),a=document.getElementById("reveal-btn-text");if(!e)return;const s=Date.now()-(w.commitment.waitStartTime||Date.now()),r=w.commitment.revealDelay*er,i=Math.max(0,r-s),o=Math.ceil(i/1e3);if(e.textContent=o>0?`~${o}s`:"Ready!",t){const l=Math.min(100,s/r*100);t.style.width=`${l}%`}o<=0&&!w.commitment.canReveal&&(w.commitment.canReveal=!0,n&&(n.disabled=!1,n.className="w-full py-3 rounded-xl font-bold transition-all bg-gradient-to-r from-emerald-500 to-green-500 text-white hover:shadow-lg hover:shadow-emerald-500/30 animate-pulse"),a&&(a.textContent="🎲 Reveal & Get Result!"),x("Ready to reveal! Click the button.","success")),w.phase==="waiting"&&setTimeout(tr,1e3)}function g0(){Ve&&clearInterval(Ve),setTimeout(tr,100),Ve=setInterval(async()=>{if(w.phase!=="waiting"){clearInterval(Ve);return}try{await x0()&&!w.commitment.canReveal&&(w.commitment.canReveal=!0,oe())}catch(e){console.warn("Reveal check error:",e)}},s0)}async function x0(){if(!c.fortunePoolContractPublic||!w.gameId)return!1;try{return(await c.fortunePoolContractPublic.getCommitmentStatus(w.gameId)).canReveal===!0}catch{const t=Date.now()-(w.commitment.waitStartTime||Date.now()),n=w.commitment.revealDelay*er;return t>=n}}async function h0(){if(!w.commitment.canReveal){x("Not ready to reveal yet!","warning");return}const e=document.getElementById("btn-reveal");e&&(e.disabled=!0,e.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Revealing...');try{const t=w.mode==="jackpot"?[w.guess]:w.guesses;await Hs.revealPlay({gameId:w.gameId,guesses:t,userSecret:w.commitment.userSecret,button:e,onSuccess:(n,a)=>{Ve&&clearInterval(Ve),w.txHash=n.hash,w.result={rolls:(a==null?void 0:a.rolls)||[],prizeWon:(a==null?void 0:a.prizeWon)||0n,matches:(a==null?void 0:a.matches)||[],matchCount:(a==null?void 0:a.matchCount)||0},console.log("🎲 Game revealed:",w.result),w.phase="result",oe(),nr()},onError:n=>{n.cancelled||x(n.message||"Reveal failed","error"),e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-dice mr-2"></i>Try Again')}})}catch(t){console.error("Reveal error:",t),x("Reveal failed: "+(t.message||"Unknown error"),"error"),e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-dice mr-2"></i>Try Again')}}function v0(e){var f,u;const t=w.result;if(!t)return oe();const n=w.mode==="jackpot",a=n?[w.guess]:w.guesses,s=t.rolls||[],r=n?[de[2]]:de,i=a.map((b,m)=>{const g=s[m]!==void 0?Number(s[m]):null;return g!==null&&g===b}),o=i.filter(b=>b).length,l=t.prizeWon>0||o>0;let d=0;t.prizeWon&&t.prizeWon>0n?d=_(BigInt(t.prizeWon)):o>0&&i.forEach((b,m)=>{if(b){const g=n?de[2]:de[m];d+=w.wager*g.multiplier}});const p=typeof d=="number"?d.toLocaleString(void 0,{maximumFractionDigits:2}):d.toLocaleString();e.innerHTML=`
        <div class="bg-gradient-to-br ${l?"from-emerald-900/30 to-green-900/10 border-emerald-500/30":"from-zinc-900 to-zinc-800/50 border-zinc-700/50"} border rounded-2xl p-4 sm:p-6 relative overflow-hidden" id="result-container">
            ...
            <div class="grid ${n?"grid-cols-1 max-w-[200px] mx-auto":"grid-cols-3"} gap-2 sm:gap-3 mb-4">
                ${r.map((b,m)=>{const g=n?a[0]:a[m],y=s[m],k=i[m];return`
            ...
            ${w.txHash?`
                <div class="text-center mb-3">
                    <a href="${Qs}${w.txHash}" target="_blank" class="inline-flex items-center gap-2 text-xs text-zinc-500 hover:text-zinc-400">
                        <i class="fa-solid fa-external-link"></i>
                        View Transaction
                    </a>
                </div>
    ...
    `,l&&(w0(),d>w.wager*10&&y0()),(f=document.getElementById("btn-new-game"))==null||f.addEventListener("click",()=>{w.phase="select",w.result=null,w.txHash=null,w.gameId=null,oe(),nr()}),(u=document.getElementById("btn-share"))==null||u.addEventListener("click",()=>{k0(l,d)})}function w0(){const e=document.createElement("div");e.className="confetti-container",document.body.appendChild(e);const t=["#f59e0b","#10b981","#8b5cf6","#ec4899","#06b6d4"],n=["●","■","★","🐯","🎉"];for(let a=0;a<60;a++){const s=document.createElement("div");s.className="confetti",s.style.cssText=`
            left: ${Math.random()*100}%;
            color: ${t[a%t.length]};
            font-size: ${8+Math.random()*12}px;
            animation-delay: ${Math.random()*2}s;
            animation-duration: ${2+Math.random()*2}s;
        `,s.textContent=n[a%n.length],e.appendChild(s)}setTimeout(()=>e.remove(),5e3)}function y0(){const e=["🪙","💰","✨","⭐","🎉"];for(let t=0;t<30;t++)setTimeout(()=>{const n=document.createElement("div");n.className="coin",n.textContent=e[Math.floor(Math.random()*e.length)],n.style.left=`${Math.random()*100}%`,n.style.animationDelay=`${Math.random()*.5}s`,n.style.animationDuration=`${2+Math.random()*2}s`,document.body.appendChild(n),setTimeout(()=>n.remove(),4e3)},t*100)}function k0(e,t){var l,d,p,f,u,b;const n=ni[We],a=()=>{const m=a0[We];return e?m.win(t):m.lose},s=`
        <div class="text-center">
    ...
    `;wn(s,"max-w-xs");const r=m=>{We=m;const g=ni[m],y=document.getElementById("share-modal-title"),k=document.getElementById("share-modal-subtitle"),E=document.getElementById("btn-close-share");y&&(y.textContent=g.title),k&&(k.textContent=g.subtitle),E&&(E.textContent=g.later),document.querySelectorAll(".lang-btn").forEach(I=>{const P=I.dataset.lang,L=I.querySelector("span");P===m?(I.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-amber-500/20 border-amber-500 ring-1 ring-amber-500/50 border",L&&(L.className="text-amber-400")):(I.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-zinc-800 border-zinc-700 hover:border-zinc-500 border",L&&(L.className="text-zinc-400"))})};document.querySelectorAll(".lang-btn").forEach(m=>{m.addEventListener("click",()=>r(m.dataset.lang))});const i=async m=>{if(!c.userAddress)return!1;try{const y=await(await fetch("https://us-central1-backchain-backand.cloudfunctions.net/trackShare",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({address:c.userAddress,gameId:w.gameId||Date.now(),type:"fortune",platform:m})})).json();return y.success?(x(`🎉 +${y.pointsAwarded||ps} Airdrop Points!`,"success"),!0):(y.reason==="already_shared"&&console.log("Already shared this game"),!1)}catch(g){return console.error("Share tracking error:",g),x(`🎉 +${ps} Airdrop Points!`,"success"),!0}},o=async(m,g)=>{await i(m),window.open(g,"_blank"),we()};(l=document.getElementById("share-twitter"))==null||l.addEventListener("click",()=>{const m=a();o("twitter",`https://twitter.com/intent/tweet?text=${encodeURIComponent(m)}`)}),(d=document.getElementById("share-telegram"))==null||d.addEventListener("click",()=>{const m=a();o("telegram",`https://t.me/share/url?url=https://backcoin.org&text=${encodeURIComponent(m)}`)}),(p=document.getElementById("share-whatsapp"))==null||p.addEventListener("click",()=>{const m=a();o("whatsapp",`https://wa.me/?text=${encodeURIComponent(m)}`)}),(f=document.getElementById("share-instagram"))==null||f.addEventListener("click",async()=>{const m=a();try{await navigator.clipboard.writeText(m),await i("instagram");const g=`
            ...
            `)}}catch(t){console.error("loadHistory error:",t)}}function C0(e){const t=document.getElementById("history-list");t&&(t.innerHTML=e.map(n=>{var m;const a=n.isWin||n.prizeWon&&BigInt(n.prizeWon)>0n,s=n.prizeWon?_(BigInt(n.prizeWon)):0,r=n.wagerAmount?_(BigInt(n.wagerAmount)):0,i=n.isCumulative,o=n.rolls||[],l=n.guesses||[],d=n.txHash||n.transactionHash,p=I0(n.timestamp||n.createdAt),f=n.player?`${n.player.slice(0,6)}...${n.player.slice(-4)}`:"???",u=c.userAddress&&((m=n.player)==null?void 0:m.toLowerCase())===c.userAddress.toLowerCase(),b=d?`${Qs}${d}`:null;return`
               ...
               ${b?"":'onclick="return false;"'}>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex gap-1">
                        ${(i?de:[de[2]]).map((g,y)=>{const k=l[y],E=o[y];return`
    ...
    `,document.head.appendChild(e)}async function tn(){var e;A.isConnected=c.isConnected,A.user=null,A.userSubmissions=[],A.platformUsage={},A.isBanned=!1;try{const t=await Is();if(A.systemConfig=t.config,A.leaderboards=t.leaderboards,A.dailyTasks=t.dailyTasks||[],A.platformUsageConfig=t.platformUsageConfig||rc,A.isConnected&&c.userAddress){const[n,a]=await Promise.all([un(c.userAddress),Dd()]);if(A.user=n,A.userSubmissions=a,n&&n.isBanned){A.isBanned=!0;return}try{typeof zr=="function"&&(A.platformUsage=await zr()||{})}catch(s){console.warn("Could not load platform usage:",s),A.platformUsage={}}A.dailyTasks.length>0&&(A.dailyTasks=await Promise.all(A.dailyTasks.map(async s=>{try{if(!s.id)return{...s,eligible:!1,timeLeftMs:0};const r=await Si(s.id,s.cooldownHours);return{...s,eligible:r.eligible,timeLeftMs:r.timeLeft}}catch{return{...s,eligible:!1,timeLeftMs:0}}})))}}catch(t){if(console.error("Airdrop Data Load Error:",t),t.code==="permission-denied"||(e=t.message)!=null&&e.includes("permission")){console.warn("Firebase permissions issue - user may need to connect wallet or sign in"),A.systemConfig=A.systemConfig||{},A.leaderboards=A.leaderboards||{top100ByPoints:[],top100ByPosts:[]},A.dailyTasks=A.dailyTasks||[];return}x("Error loading data. Please refresh.","error")}}function W0(e){if(!A.user||!e||e.length===0)return null;const t=e.findIndex(n=>{var a,s;return((a=n.walletAddress)==null?void 0:a.toLowerCase())===((s=A.user.walletAddress)==null?void 0:s.toLowerCase())});return t>=0?t+1:null}function G0(e){return e?e<=5?st[0]:e<=25?st[1]:e<=75?st[2]:e<=200?st[3]:null:null}function ic(){var l;const{user:e}=A,t=(e==null?void 0:e.totalPoints)||0,n=(e==null?void 0:e.platformUsagePoints)||0,a=(e==null?void 0:e.approvedSubmissionsCount)||0,s=U0(a),r=((l=A.leaderboards)==null?void 0:l.top100ByPosts)||[],i=W0(r),o=G0(i);return`
        <!-- Mobile Header -->
    ...
    `}function Va(){return A.isConnected?`
        <div class="px-4 airdrop-fade-up">
            ...
            <!-- Sub-tab Content -->
            <div id="earn-content">
                ${A.activeEarnTab==="post"?K0():""}
                ${A.activeEarnTab==="platform"?Y0():""}
    ...
    `:`
        ...
        `}function K0(){const{user:e}=A,n=`https://backcoin.org/?ref=${(e==null?void 0:e.referralCode)||"CODE"}`;return`
        <div class="space-y-4">
    ...
    `}function Y0(){var i;const e=A.platformUsageConfig||rc,t=A.platformUsage||{};let n=0,a=0;Object.keys(e).forEach(o=>{var l;e[o].enabled!==!1&&e[o].maxCount&&(n+=e[o].maxCount,a+=Math.min(((l=t[o])==null?void 0:l.count)||0,e[o].maxCount))});const s=n>0?a/n*100:0,r=((i=A.user)==null?void 0:i.platformUsagePoints)||0;return`
        <div class="space-y-4">
            <!-- Info Banner -->
            ...
            <div class="grid grid-cols-2 gap-2" id="platform-actions-grid">
                ${Object.entries(e).filter(([o,l])=>l.enabled!==!1).map(([o,l])=>{const d=t[o]||{count:0},p=d.count>=l.maxCount,f=Math.max(0,l.maxCount-d.count),u=d.count/l.maxCount*100,b=D0[o]||"";return`
    ...
    `}function q0(){const{user:e,userSubmissions:t}=A;if(!A.isConnected)return`
            <div class="text-center px-4 py-12 airdrop-fade-up">
            ...
            <div>
                ...
                <div class="bg-zinc-900/80 border border-zinc-800 rounded-xl overflow-hidden">
                    ${t.length===0?`<div class="p-8 text-center">
                            ...
                            <p class="text-zinc-600 text-xs mt-1">Create your first post to get started!</p>
                        </div>`:t.slice(0,10).map((l,d)=>{const p=d===Math.min(t.length,10)-1;["pending","auditing"].includes(l.status);const f=l.status==="approved",u=l.status==="rejected";let b,m,g;f?(b='<i class="fa-solid fa-check-circle text-green-400"></i>',m="",g=""):u?(b='<i class="fa-solid fa-times-circle text-red-400"></i>',m="",g=""):(b='<i class="fa-solid fa-shield-halved text-amber-400 animate-pulse"></i>',m="bg-amber-900/10",g=`
                                ...
                                <div class="p-3 ${p?"":"border-b border-zinc-800"} ${m}">
                                    <div class="flex items-center justify-between">
    ...
    `}function X0(){var p,f;const e=((p=A.leaderboards)==null?void 0:p.top100ByPosts)||[],t=((f=A.leaderboards)==null?void 0:f.top100ByPoints)||[],n=A.activeRanking||"posts";function a(u,b,m){var L,T;const g=A.user&&((L=u.walletAddress)==null?void 0:L.toLowerCase())===((T=A.user.walletAddress)==null?void 0:T.toLowerCase()),y=J0(b+1),k=m==="posts"?"bg-amber-500/10":"bg-green-500/10",E=m==="posts"?"text-amber-400":"text-green-400",I=m==="posts"?"text-white":"text-green-400",P=m==="posts"?"posts":"pts";return`
            <div class="flex items-center justify-between p-3 ${g?k:"hover:bg-zinc-800/50"} transition-colors">
                ...
                <span class="font-bold ${I} text-sm">${(u.value||0).toLocaleString()} <span class="text-zinc-500 text-xs">${P}</span></span>
            </div>
...
(This will reset their rejection count to 0)`;if(!window.confirm(s))return;const r=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await _i(n,a),x(`User ${a?"BANNED":"UNBANNED"}.`,"success");const i=C.allUsers.findIndex(o=>o.id===n);i>-1&&(C.allUsers[i].isBanned=a,C.allUsers[i].hasPendingAppeal=!1,a===!1&&(C.allUsers[i].rejectedCount=0)),dt()}catch(i){x(`Failed: ${i.message}`,"error"),t.disabled=!1,t.innerHTML=r}},bm=async e=>{const t=e.target.closest(".resolve-appeal-btn");if(!t||t.disabled)return;const n=t.dataset.userId,s=t.dataset.action==="approve";if(!n)return;const r=s?"Are you sure you want to APPROVE this appeal and UNBAN the user?":"Are you sure you want to DENY this appeal? The user will remain banned.";if(!window.confirm(r))return;const i=t.closest("td").querySelectorAll("button"),o=new Map;i.forEach(l=>{o.set(l,l.innerHTML),l.disabled=!0,l.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>'});try{s&&await _i(n,!1),x(`Appeal ${s?"APPROVED":"DENIED"}.`,"success");const l=C.allUsers.findIndex(d=>d.id===n);l>-1&&(C.allUsers[l].hasPendingAppeal=!1,s&&(C.allUsers[l].isBanned=!1,C.allUsers[l].rejectedCount=0)),dt()}catch(l){x(`Failed: ${l.message}`,"error"),i.forEach(d=>{d.disabled=!1,d.innerHTML=o.get(d)})}},gm=async e=>{const t=e.target.closest(".re-approve-btn");if(!t||t.disabled)return;const n=t.dataset.submissionId,a=t.dataset.userId;if(!n||!a)return;const s=t.closest("tr");s&&(s.style.opacity="0.5"),t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await $i(a,n,"approved"),x("Submission re-approved!","success"),C.selectedUserSubmissions=C.selectedUserSubmissions.filter(i=>i.submissionId!==n),s&&s.remove();const r=C.allUsers.findIndex(i=>i.id===a);if(r>-1){const i=C.allUsers[r];i.rejectedCount=Math.max(0,(i.rejectedCount||0)-1),dt()}if(C.selectedUserSubmissions.length===0){const i=document.querySelector("#admin-user-modal .p-6");i&&(i.innerHTML='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>')}}catch(r){x(`Failed to re-approve: ${r.message}`,"error"),s&&(s.style.opacity="1"),t.disabled=!1,t.innerHTML='<i class="fa-solid fa-check"></i> Re-Approve'}},xm=async e=>{const t=e.target.closest(".view-rejected-btn");if(!t||t.disabled)return;const n=t.dataset.userId,a=t.dataset.wallet;if(n){C.selectedWallet=a,C.isSubmissionsModalOpen=!0,qa(!0,[]);try{const s=await Yd(n,"rejected");C.selectedUserSubmissions=s,qa(!1,s)}catch(s){x(`Error fetching user submissions: ${s.message}`,"error"),qa(!1,[],!0)}}},hm=()=>{C.isSubmissionsModalOpen=!1,C.selectedUserSubmissions=[],C.selectedWallet=null;const e=document.getElementById("admin-user-modal");e&&e.remove(),document.body.style.overflow="auto"},vm=e=>{const t=e.target.closest(".user-profile-link");if(!t)return;e.preventDefault();const n=t.dataset.userId;if(!n)return;const a=C.allUsers.find(s=>s.id===n);if(!a){x("Error: Could not find user data.","error");return}Cm(a)},wm=()=>{const e=document.getElementById("admin-user-profile-modal");e&&e.remove(),document.body.style.overflow="auto"},ym=async e=>{e.preventDefault();const t=e.target;let n,a;try{if(n=new Date(t.startDate.value+"T00:00:00Z"),a=new Date(t.endDate.value+"T23:59:59Z"),isNaN(n.getTime())||isNaN(a.getTime()))throw new Error("Invalid date format.");if(n>=a)throw new Error("Start Date must be before End Date.")}catch(l){x(l.message,"error");return}const s={title:t.title.value.trim(),url:t.url.value.trim(),description:t.description.value.trim(),points:parseInt(t.points.value,10),cooldownHours:parseInt(t.cooldown.value,10),startDate:n,endDate:a};if(!s.title||!s.description){x("Please fill in Title and Description.","error");return}if(s.points<=0||s.cooldownHours<=0){x("Points and Cooldown must be positive numbers.","error");return}if(s.url&&!s.url.startsWith("http")){x("URL must start with http:// or https://","error");return}C.editingTask&&C.editingTask.id&&(s.id=C.editingTask.id);const r=t.querySelector('button[type="submit"]'),i=r.innerHTML;r.disabled=!0;const o=document.createElement("span");o.classList.add("inline-block"),r.innerHTML="",r.appendChild(o);try{await jd(s),x(`Task ${s.id?"updated":"created"} successfully!`,"success"),t.reset(),C.editingTask=null,xn()}catch(l){x(`Failed to save task: ${l.message}`,"error"),console.error(l),r.disabled=!1,r.innerHTML=i}},km=async e=>{e.preventDefault();const t=e.target,n={YouTube:parseInt(t.youtubePoints.value,10),"YouTube Shorts":parseInt(t.youtubeShortsPoints.value,10),Instagram:parseInt(t.instagramPoints.value,10),"X/Twitter":parseInt(t.xTwitterPoints.value,10),Facebook:parseInt(t.facebookPoints.value,10),Telegram:parseInt(t.telegramPoints.value,10),TikTok:parseInt(t.tiktokPoints.value,10),Reddit:parseInt(t.redditPoints.value,10),LinkedIn:parseInt(t.linkedinPoints.value,10),Other:parseInt(t.otherPoints.value,10)};if(Object.values(n).some(i=>isNaN(i)||i<0)){x("All points must be positive numbers (or 0).","error");return}const a=t.querySelector('button[type="submit"]'),s=a.innerHTML;a.disabled=!0;const r=document.createElement("span");r.classList.add("inline-block"),a.innerHTML="",a.appendChild(r);try{await Hd(n),x("UGC Base Points updated successfully!","success"),C.ugcBasePoints=n}catch(i){x(`Failed to update points: ${i.message}`,"error"),console.error(i)}finally{document.body.contains(a)&&(a.disabled=!1,a.innerHTML=s)}},Tm=e=>{const t=C.dailyTasks.find(n=>n.id===e);t&&(C.editingTask=t,Nn())},Em=async e=>{if(window.confirm("Are you sure you want to delete this task permanently?"))try{await Wd(e),x("Task deleted.","success"),C.editingTask=null,xn()}catch(t){x(`Failed to delete task: ${t.message}`,"error"),console.error(t)}};function qa(e,t,n=!1){var i,o;const a=document.getElementById("admin-user-modal");a&&a.remove(),document.body.style.overflow="hidden";let s="";e?s='<div class="p-8"></div>':n?s='<p class="text-red-400 text-center p-8">Failed to load submissions.</p>':t.length===0?s='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>':s=`
    ...
    `;const E=document.getElementById("admin-users-pagination");E&&b>1&&Bs(E,C.usersPage,b,Bm),(P=document.getElementById("admin-users-tbody"))==null||P.addEventListener("click",T=>{T.target.closest(".user-profile-link")&&vm(T),T.target.closest(".ban-user-btn")&&fm(T),T.target.closest(".view-rejected-btn")&&xm(T),T.target.closest(".resolve-appeal-btn")&&bm(T)}),(L=document.getElementById("user-filters-nav"))==null||L.addEventListener("click",Im);const I=document.getElementById("user-search-input");if(I){let T;I.addEventListener("keyup",F=>{clearTimeout(T),T=setTimeout(()=>Am(F),300)})}},li=()=>{var a;const e=document.getElementById("manage-ugc-points-content");if(!e)return;const t=C.ugcBasePoints;if(!t)return;const n={YouTube:5e3,"YouTube Shorts":2500,Instagram:3e3,"X/Twitter":1500,Facebook:2e3,Telegram:1e3,TikTok:3500,Reddit:1800,LinkedIn:2200,Other:1e3};e.innerHTML=`
    ...
    `,(a=document.getElementById("ugcPointsForm"))==null||a.addEventListener("submit",km)},Nn=()=>{var m,g,y;const e=document.getElementById("manage-tasks-content");if(!e)return;const t=C.editingTask,n=!!t,a=k=>{if(!k)return"";try{return(k.toDate?k.toDate():k instanceof Date?k:new Date(k)).toISOString().split("T")[0]}catch{return""}},s=C.tasksPage,r=C.tasksPerPage,i=[...C.dailyTasks].sort((k,E)=>{var L,T;const I=(L=k.startDate)!=null&&L.toDate?k.startDate.toDate():new Date(k.startDate||0);return((T=E.startDate)!=null&&T.toDate?E.startDate.toDate():new Date(E.startDate||0)).getTime()-I.getTime()}),o=i.length,l=Math.ceil(o/r),d=(s-1)*r,p=s*r,f=i.slice(d,p),u=f.length>0?f.map(k=>{var T,F;const E=new Date,I=(T=k.startDate)!=null&&T.toDate?k.startDate.toDate():k.startDate?new Date(k.startDate):null,P=(F=k.endDate)!=null&&F.toDate?k.endDate.toDate():k.endDate?new Date(k.endDate):null;let L="text-zinc-500";return I&&P&&(E>=I&&E<=P?L="text-green-400":E<I&&(L="text-blue-400")),`
    ...
    `;const b=document.getElementById("admin-tasks-pagination");b&&l>1&&Bs(b,C.tasksPage,l,Pm),(m=document.getElementById("taskForm"))==null||m.addEventListener("submit",ym),(g=document.getElementById("cancelEditBtn"))==null||g.addEventListener("click",()=>{C.editingTask=null,Nn()}),(y=document.getElementById("existing-tasks-list"))==null||y.addEventListener("click",k=>{const E=k.target.closest("button[data-id]");if(!E)return;const I=E.dataset.id;E.dataset.action==="edit"&&Tm(I),E.dataset.action==="delete"&&Em(I)})},ca=()=>{var f;const e=document.getElementById("submissions-content");if(!e)return;if(!C.allSubmissions||C.allSubmissions.length===0){const u=document.createElement("div");e.innerHTML=u.innerHTML;return}const t=C.submissionsPage,n=C.submissionsPerPage,a=[...C.allSubmissions].sort((u,b)=>{var m,g;return(((m=b.submittedAt)==null?void 0:m.getTime())||0)-(((g=u.submittedAt)==null?void 0:g.getTime())||0)}),s=a.length,r=Math.ceil(s/n),i=(t-1)*n,o=t*n,d=a.slice(i,o).map(u=>{var b,m;return`
        <tr class="border-b border-border-color hover:bg-zinc-800/50">
            ...
            <td class="p-3 text-xs font-semibold ${((b=oi[u.status])==null?void 0:b.color)||"text-gray-500"}">${((m=oi[u.status])==null?void 0:m.text)||u.status}</td>
            <td class="p-3 text-right">
                <div class="flex items-center justify-end gap-2">
    ...
    `;const p=document.getElementById("admin-submissions-pagination");p&&r>1&&Bs(p,C.submissionsPage,r,Nm),(f=document.getElementById("admin-submissions-tbody"))==null||f.addEventListener("click",mm)},da=()=>{var r,i;const e=document.getElementById("platform-usage-content");if(!e)return;const t=C.platformUsageConfig||Ia;let n=0;Object.values(t).forEach(o=>{o.enabled!==!1&&(n+=(o.points||0)*(o.maxCount||1))});const a=Object.entries(t).map(([o,l])=>`
    ...
    `,ua(),Oe(),ir())}function ua(){const e=document.getElementById("status-badge"),t=document.getElementById("fee-amount"),n=document.getElementById("user-balance"),a=c.notaryFee||0n,s=c.currentUserBalance||0n;t&&(t.textContent=`${_(a)} BKC`),n&&(n.textContent=`${_(s)} BKC`,n.className=`font-mono font-bold ${s>=a?"text-emerald-400":"text-red-400"}`),e&&(c.isConnected?s>=a?(e.innerHTML=`
...
`)[0].trim())||"Notarized Document";const d=rr("",l),p=qm(r.timestamp);return`
    ...
    `:`
        ...
        `}function vn(){const e=document.getElementById("tab-content");if(e){switch($.activeTab){case"marketplace":e.innerHTML=uf();break;case"my-listings":e.innerHTML=pf();break;case"my-rentals":e.innerHTML=mf();break}document.getElementById("header-stats").innerHTML=df(),$.activeTab==="my-rentals"&&Ef()}}function uf(){const e=c.rentalListings||[],t=Math.floor(Date.now()/1e3);let n=e.filter(a=>!(a.isRented||a.rentalEndTime&&Number(a.rentalEndTime)>t||$.filterTier!=="ALL"&&Fn(a.boostBips).name!==$.filterTier));return n.sort((a,s)=>{const r=BigInt(a.promotionFee||"0")||$.promotions.get(Se(a.tokenId))||0n,i=BigInt(s.promotionFee||"0")||$.promotions.get(Se(s.tokenId))||0n,o=fi(a),l=fi(s);if(!o&&l)return-1;if(o&&!l||i>r)return 1;if(i<r)return-1;if($.sortBy==="featured"){const f=bi(a),u=bi(s);if(u!==f)return u-f}const d=BigInt(a.pricePerHour||0),p=BigInt(s.pricePerHour||0);return $.sortBy==="price-low"?d<p?-1:1:$.sortBy==="price-high"?d>p?-1:1:(s.boostBips||0)-(a.boostBips||0)}),`
        <div>
            <!-- Filters & Sort -->
    ...
    `}function mc(e,t){const n=Fn(e.boostBips),a=Ba(n.name),s=_(BigInt(e.pricePerHour||0)).toFixed(2),r=Se(e.tokenId),i=c.isConnected&&Pn(e.owner,c.userAddress),o=pc(e),l=Math.floor(Date.now()/1e3),d=o&&o>l,p=d?lf(o):null,f=BigInt(e.promotionFee||"0")||$.promotions.get(r)||0n,u=f>0n,b=u?parseFloat(Aa.formatEther(f)).toFixed(3):"0",m=lt(e.boostBips||0);return`
...
`;document.head.appendChild(yc);const If={render:async e=>{if(!e)return;const t=document.getElementById("creditcard");t&&(t.innerHTML=`
    ...
    `,d=i;return a.forEach(p=>{l+=Bf(p,d++)}),l+="</div></div>",{html:l,nextIndex:d}}function Nf(e){var t,n,a,s,r,i,o,l;At=e,localStorage.setItem("backcoin-tutorials-lang",e),(t=document.getElementById("tutorials-btn-en"))==null||t.classList.toggle("bg-amber-500",e==="en"),(n=document.getElementById("tutorials-btn-en"))==null||n.classList.toggle("text-zinc-900",e==="en"),(a=document.getElementById("tutorials-btn-en"))==null||a.classList.toggle("bg-zinc-700",e!=="en"),(s=document.getElementById("tutorials-btn-en"))==null||s.classList.toggle("text-zinc-300",e!=="en"),(r=document.getElementById("tutorials-btn-pt"))==null||r.classList.toggle("bg-amber-500",e==="pt"),(i=document.getElementById("tutorials-btn-pt"))==null||i.classList.toggle("text-zinc-900",e==="pt"),(o=document.getElementById("tutorials-btn-pt"))==null||o.classList.toggle("bg-zinc-700",e!=="pt"),(l=document.getElementById("tutorials-btn-pt"))==null||l.classList.toggle("text-zinc-300",e!=="pt"),kc()}function kc(){const e=document.getElementById("tutorials-content");if(!e)return;const t=lr[At];let n=`
        <!-- Hero -->
        <div class="text-center mb-10">
            ...
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-lg font-bold text-white flex items-center gap-2">
                    ${B.selectedCategory?`
                        ...
                        ${(r=Me[B.selectedCategory])==null?void 0:r.emoji} ${(i=Me[B.selectedCategory])==null?void 0:i.name}
                    `:`
    ...
    `},hi=e=>{var o,l,d,p,f,u;if(!e)return`
        <div class="charity-page">
    ...
    `;const t=Mn(e.raisedAmount,e.goalAmount),n=Ic(e.deadline),a=e.category||"humanitarian",s=dr(e),r=((o=e.creator)==null?void 0:o.toLowerCase())===((l=c==null?void 0:c.userAddress)==null?void 0:l.toLowerCase()),i=Nc(e);return`
        <div class="charity-page">
            ${$c()}
            ${_c()}
            ...
            <div class="cp-detail">
                ...
                <div class="flex flex-wrap items-center gap-2 mb-4">
                    ...
                    ${Lc(e.status)}
                    <span class="cp-badge" style="background:${(d=Me[a])==null?void 0:d.color}20;color:${(p=Me[a])==null?void 0:p.color}">
...
`;function Dn(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.add("active")}function rt(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.remove("active")}function Uf(e="humanitarian"){var t;B.pendingImage=null,B.pendingImageFile=null,Pc("create"),document.querySelectorAll("#modal-create .cp-cat-option").forEach(n=>n.classList.remove("selected")),(t=document.getElementById(`opt-${e}`))==null||t.classList.add("selected"),["campaign-title","campaign-desc","campaign-goal","campaign-duration","campaign-image-url"].forEach(n=>{const a=document.getElementById(n);a&&(a.value="")}),Dn("create")}function jf(e){const t=B.campaigns.find(s=>s.id===e||s.id===String(e));if(!t)return;const n=document.getElementById("donate-campaign-info");n&&(n.innerHTML=`
        ...
        `);const a=document.getElementById("donate-amount");a&&(a.value=""),B.currentCampaign=t,Dn("donate")}function Wf(){var a;const e=(a=c==null?void 0:c.userAddress)==null?void 0:a.toLowerCase(),t=B.campaigns.filter(s=>{var r;return((r=s.creator)==null?void 0:r.toLowerCase())===e}),n=document.getElementById("my-campaigns-list");n&&(t.length===0?n.innerHTML=`
            <div class="cp-empty">
        ...
        `:n.innerHTML=t.map(s=>{const r=Mn(s.raisedAmount,s.goalAmount),i=Nc(s);return`
            ...
            `}).join(""),Dn("my"))}function Gf(e){var a,s,r;const t=B.campaigns.find(i=>i.id===e||i.id===String(e));if(!t)return;if(((a=t.creator)==null?void 0:a.toLowerCase())!==((s=c==null?void 0:c.userAddress)==null?void 0:s.toLowerCase())){x("Not your campaign","error");return}B.editingCampaign=t,B.pendingImageFile=null,document.getElementById("edit-campaign-id").value=t.id,document.getElementById("edit-title").value=t.title||"",document.getElementById("edit-desc").value=t.description||"",document.getElementById("edit-image-url").value=t.imageUrl||"",document.querySelectorAll("#modal-edit .cp-cat-option").forEach(i=>i.classList.remove("selected")),(r=document.getElementById(`edit-opt-${t.category||"humanitarian"}`))==null||r.classList.add("selected");const n=document.getElementById("edit-image-preview");n&&t.imageUrl?n.innerHTML=`<img src="${t.imageUrl}" class="cp-image-preview">`:n&&(n.innerHTML=""),Dn("edit")}function Kf(e,t="create"){var s;const n=t==="edit"?"edit-opt-":"opt-",a=t==="edit"?"#modal-edit":"#modal-create";document.querySelectorAll(`${a} .cp-cat-option`).forEach(r=>r.classList.remove("selected")),(s=document.getElementById(`${n}${e}`))==null||s.classList.add("selected")}function Yf(e){const t=document.getElementById("donate-amount")||document.getElementById("detail-amount");t&&(t.value=e)}async function Vf(){var d,p,f,u,b,m,g,y;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=document.querySelector("#modal-create .cp-cat-option.selected input"),t=(e==null?void 0:e.value)||"humanitarian",n=(p=(d=document.getElementById("campaign-title"))==null?void 0:d.value)==null?void 0:p.trim(),a=(u=(f=document.getElementById("campaign-desc"))==null?void 0:f.value)==null?void 0:u.trim(),s=(b=document.getElementById("campaign-goal"))==null?void 0:b.value,r=(m=document.getElementById("campaign-duration"))==null?void 0:m.value;let i=(y=(g=document.getElementById("campaign-image-url"))==null?void 0:g.value)==null?void 0:y.trim();if(!n)return x("Enter a title","error");if(!a)return x("Enter a description","error");if(!s||parseFloat(s)<.01)return x("Goal must be at least 0.01 ETH","error");if(!r||parseInt(r)<1)return x("Duration must be at least 1 day","error");if(B.pendingImageFile)try{x("Uploading image...","info"),i=await zc(B.pendingImageFile)}catch(k){console.error("Image upload failed:",k)}const o=nn.parseEther(s),l=parseInt(r)*86400;await Jt.createCampaign({title:n,description:a,goalAmount:o,duration:l,button:document.getElementById("btn-create"),onSuccess:async(k,E)=>{if(E)try{await fetch(Na.saveCampaign,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:E,title:n,description:a,category:t,imageUrl:i,creator:c.userAddress})})}catch{}x("🎉 Campaign created!","success"),rt("create"),B.pendingImageFile=null,await Lt(),ut()},onError:k=>{var E;!k.cancelled&&k.type!=="user_rejected"&&x(((E=k.message)==null?void 0:E.slice(0,80))||"Failed","error")}})}async function qf(){var a;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=B.currentCampaign;if(!e)return;const t=(a=document.getElementById("donate-amount"))==null?void 0:a.value;if(!t||parseFloat(t)<.001)return x("Minimum 0.001 ETH","error");const n=nn.parseEther(t);await Jt.donate({campaignId:e.id,amount:n,button:document.getElementById("btn-donate"),onSuccess:async()=>{x("❤️ Thank you for your donation!","success"),rt("donate"),await Lt(),ut()},onError:s=>{var r;!s.cancelled&&s.type!=="user_rejected"&&x(((r=s.message)==null?void 0:r.slice(0,80))||"Failed","error")}})}async function Xf(e){var a;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const t=(a=document.getElementById("detail-amount"))==null?void 0:a.value;if(!t||parseFloat(t)<.001)return x("Minimum 0.001 ETH","error");const n=nn.parseEther(t);await Jt.donate({campaignId:e,amount:n,button:document.getElementById("btn-donate-detail"),onSuccess:async()=>{x("❤️ Thank you for your donation!","success"),await Lt(),await St(e)},onError:s=>{var r;!s.cancelled&&s.type!=="user_rejected"&&x(((r=s.message)==null?void 0:r.slice(0,80))||"Failed","error")}})}async function Jf(e){if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");confirm("Cancel this campaign? This cannot be undone.")&&await Jt.cancel({campaignId:e,button:document.getElementById("btn-cancel"),onSuccess:async()=>{x("Campaign cancelled","success"),await Lt(),ut()},onError:t=>{var n;!t.cancelled&&t.type!=="user_rejected"&&x(((n=t.message)==null?void 0:n.slice(0,80))||"Failed","error")}})}async function Zf(e){if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const t=B.campaigns.find(s=>s.id===e||s.id===String(e));if(!t)return;const n=Mn(t.raisedAmount,t.goalAmount);let a=`Withdraw ${ke(t.raisedAmount)} ETH?

5% platform fee applies.`;n<100&&(a+=`
Goal not reached - partial withdrawal.`),confirm(a)&&await Jt.withdraw({campaignId:e,button:document.getElementById(`btn-withdraw-${e}`)||document.getElementById("btn-withdraw"),onSuccess:async()=>{var s;x("✅ Funds withdrawn successfully!","success"),rt("my"),await Lt(),ut(),((s=B.currentCampaign)==null?void 0:s.id)===e&&await St(e)},onError:s=>{var r;!s.cancelled&&s.type!=="user_rejected"&&x(((r=s.message)==null?void 0:r.slice(0,80))||"Failed","error")}})}async function Qf(){var o,l,d,p,f,u,b,m;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=(o=document.getElementById("edit-campaign-id"))==null?void 0:o.value,t=(d=(l=document.getElementById("edit-title"))==null?void 0:l.value)==null?void 0:d.trim(),n=(f=(p=document.getElementById("edit-desc"))==null?void 0:p.value)==null?void 0:f.trim();let a=(b=(u=document.getElementById("edit-image-url"))==null?void 0:u.value)==null?void 0:b.trim();const s=document.querySelector("#modal-edit .cp-cat-option.selected input"),r=(s==null?void 0:s.value)||"humanitarian";if(!t)return x("Enter title","error");if(B.pendingImageFile)try{x("Uploading image...","info"),a=await zc(B.pendingImageFile)}catch(g){console.error("Image upload failed:",g)}const i=document.getElementById("btn-save-edit");i&&(i.disabled=!0,i.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Saving...');try{await fetch(Na.saveCampaign,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:e,title:t,description:n,category:r,imageUrl:a,creator:c.userAddress})}),x("✅ Campaign updated!","success"),rt("edit"),B.pendingImageFile=null,await Lt(),((m=B.currentCampaign)==null?void 0:m.id)===e?await St(e):ut()}catch{x("Failed to save","error")}finally{i&&(i.disabled=!1,i.innerHTML='<i class="fa-solid fa-check"></i> Save')}}function eb(e){const t=B.currentCampaign;if(!t)return;const n=Ac(t.id),a=`🙏 Support "${t.title}" on Backcoin Charity!

${ke(t.raisedAmount)} raised of ${ke(t.goalAmount)} goal.

`;let s;e==="twitter"?s=`https://twitter.com/intent/tweet?text=${encodeURIComponent(a)}&url=${encodeURIComponent(n)}`:e==="telegram"?s=`https://t.me/share/url?url=${encodeURIComponent(n)}&text=${encodeURIComponent(a)}`:e==="whatsapp"&&(s=`https://wa.me/?text=${encodeURIComponent(a+n)}`),s&&window.open(s,"_blank","width=600,height=400")}function tb(){const e=B.currentCampaign;e&&navigator.clipboard.writeText(Ac(e.id)).then(()=>x("Link copied!","success")).catch(()=>x("Copy failed","error"))}function Fc(){$f(),B.currentCampaign=null,B.currentView="main",ut()}function nb(e){rt("my"),rt("donate"),rt("edit"),Rf(e),St(e)}function ab(e){B.selectedCategory=B.selectedCategory===e?null:e,pr()}function sb(){B.selectedCategory=null,pr()}function pr(){const e=document.getElementById("cp-grid");if(!e)return;let t=B.campaigns.filter(n=>dr(n));B.selectedCategory&&(t=t.filter(n=>n.category===B.selectedCategory)),t.sort((n,a)=>Number(a.createdAt||0)-Number(n.createdAt||0)),e.innerHTML=t.length?t.map(n=>Rc(n)).join(""):Sc("No campaigns")}async function St(e){B.currentView="detail",B.isLoading=!0;const t=xs();t&&(t.innerHTML=Df());try{let n=B.campaigns.find(a=>a.id===e||a.id===String(e));if(!n){const a=c==null?void 0:c.publicProvider;if(a){const r=await new nn.Contract(v.charityPool,ur,a).campaigns(e);n={id:String(e),creator:r[0],title:r[1],description:r[2],goalAmount:BigInt(r[3].toString()),raisedAmount:BigInt(r[4].toString()),donationCount:Number(r[5]),deadline:Number(r[6]),createdAt:Number(r[7]),status:Number(r[8]),category:"humanitarian",imageUrl:null}}}B.currentCampaign=n,t&&(t.innerHTML=hi(n))}catch{t&&(t.innerHTML=hi(null))}finally{B.isLoading=!1}}function xs(){let e=document.getElementById("charity-container");if(e)return e;const t=document.getElementById("charity");return t?(e=document.createElement("div"),e.id="charity-container",t.innerHTML="",t.appendChild(e),e):null}function ut(){Sf();const e=xs();if(!e)return;const t=Bc();t?St(t):(B.currentView="main",B.currentCampaign=null,e.innerHTML=xi(),Lt().then(()=>{if(B.currentView==="main"){const n=xs();n&&(n.innerHTML=xi())}}))}async function rb(){B.campaigns=[],B.stats=null,B.currentView==="detail"&&B.currentCampaign?await St(B.currentCampaign.id):ut()}window.addEventListener("hashchange",()=>{var e;if(window.location.hash.startsWith("#charity")){const t=Bc();t?((e=B.currentCampaign)==null?void 0:e.id)!==t&&St(t):B.currentView!=="main"&&Fc()}});const Mc={render(e){e&&ut()},update(){B.currentView==="main"&&pr()},refresh:rb,openModal:Dn,closeModal:rt,openCreate:Uf,openDonate:jf,openMyCampaigns:Wf,openEdit:Gf,create:Vf,donate:qf,donateDetail:Xf,cancel:Jf,withdraw:Zf,saveEdit:Qf,selCatOpt:Kf,setAmt:Yf,goBack:Fc,viewCampaign:nb,selectCat:ab,clearCat:sb,share:eb,copyLink:tb,handleImageSelect:Ff,removeImage:Pc,switchImageTab:Mf};window.CharityPage=Mc;const he=window.ethers,ib="https://sepolia.arbiscan.io/address/",ob=cd;function mr(){return v.backchat||v.Backchat||null}function an(){return v.operator||v.treasury||null}const N={activeTab:"feed",view:"feed",posts:[],trendingPosts:[],userProfile:null,profiles:new Map,following:new Set,selectedPost:null,selectedProfile:null,fees:{post:0n,reply:0n,like:0n,follow:0n,repost:0n,superLikeMin:0n,boostMin:0n,badge:0n},pendingEth:0n,hasBadge:!1,isBoosted:!1,boostExpiry:0,badgeExpiry:0,referralStats:null,referredBy:null,isLoading:!1,isPosting:!1,contractAvailable:!0,error:null};function lb(){if(document.getElementById("backchat-styles-v70"))return;const e=document.getElementById("backchat-styles-v69");e&&e.remove();const t=document.createElement("style");t.id="backchat-styles-v70",t.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(t)}function fr(e){return e?`${e.slice(0,6)}...${e.slice(-4)}`:""}function cb(e){const n=Date.now()/1e3-e;return n<60?"now":n<3600?`${Math.floor(n/60)}m`:n<86400?`${Math.floor(n/3600)}h`:n<604800?`${Math.floor(n/86400)}d`:new Date(e*1e3).toLocaleDateString("en-US",{month:"short",day:"numeric"})}function Bt(e){if(!e||e===0n)return"0";const t=parseFloat(he.formatEther(e));return t<1e-4?"<0.0001":t<.01?t.toFixed(4):t<1?t.toFixed(3):t.toFixed(2)}function br(e){return e?e.slice(2,4).toUpperCase():"?"}function db(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}function gr(){if(c.backchatContract)return c.backchatContract;if(c.backchatContractPublic)return c.backchatContractPublic;const e=mr();return e?c.publicProvider?new he.Contract(e,Ci,c.publicProvider):null:(console.warn("Backchat address not found in deployment-addresses.json"),null)}function pt(){if(c.backchatContract)return c.backchatContract;const e=mr();return!e||!c.signer?null:new he.Contract(e,Ci,c.signer)}async function vi(){try{const e=gr();if(!e)return;const t=await e.getCurrentFees();N.fees={post:t.postFee,reply:t.replyFee,like:t.likeFee,follow:t.followFee,repost:t.repostFee,superLikeMin:t.superLikeMin,boostMin:t.boostMin,badge:t.badgeFee_}}catch(e){console.warn("Failed to load fees:",e.message)}}async function wi(){if(!(!c.isConnected||!c.userAddress)){try{const e=gr();if(!e)return;const[t,n,a,s,r,i,o]=await Promise.all([e.getPendingBalance(c.userAddress).catch(()=>0n),e.hasTrustBadge(c.userAddress).catch(()=>!1),e.isProfileBoosted(c.userAddress).catch(()=>!1),e.boostExpiry(c.userAddress).catch(()=>0),e.badgeExpiry(c.userAddress).catch(()=>0),e.referredBy(c.userAddress).catch(()=>he.ZeroAddress),e.getReferralStats(c.userAddress).catch(()=>({totalReferred:0n,totalEarned:0n}))]);N.pendingEth=t,N.hasBadge=n,N.isBoosted=a,N.boostExpiry=Number(s),N.badgeExpiry=Number(r),N.referredBy=i&&i!==he.ZeroAddress?i:null,N.referralStats={totalReferred:Number(o.totalReferred),totalEarned:o.totalEarned,totalEarnedFormatted:he.formatEther(o.totalEarned)}}catch(e){console.warn("Failed to load user status:",e.message)}await ub()}}async function ub(){var e,t;try{if(!c.isConnected||!c.userAddress||N.referredBy)return;const n=localStorage.getItem("backchain_referrer");if(!n)return;if(n.toLowerCase()===c.userAddress.toLowerCase()){localStorage.removeItem("backchain_referrer");return}const a=pt();if(!a)return;console.log("[Referral] Auto-setting referrer:",n);const s=await a.setReferrer(n);x("Setting your referrer...","info"),await s.wait(),N.referredBy=n,localStorage.removeItem("backchain_referrer"),x("Referrer registered! They earn 30% of your fees.","success"),ze()}catch(n){console.warn("[Referral] Auto-set failed:",n.message),((e=n.message)!=null&&e.includes("ReferrerAlreadySet")||(t=n.message)!=null&&t.includes("already set"))&&localStorage.removeItem("backchain_referrer")}}async function ma(){N.isLoading=!0,ze();try{if(!mr()){N.contractAvailable=!1,N.error='Backchat contract not deployed yet. Add "backchat" to deployment-addresses.json',console.warn("⚠️ Backchat address not found in config");return}const t=gr();if(!t){N.contractAvailable=!1,N.error="Could not connect to Backchat contract";return}N.contractAvailable=!0;const n=await t.postCounter();if(Number(n)===0){N.posts=[];return}const s=t.filters.PostCreated(),r=await t.queryFilter(s,-1e4),i=t.filters.ReplyCreated(),o=await t.queryFilter(i,-1e4),l=t.filters.RepostCreated(),d=await t.queryFilter(l,-1e4),p=t.filters.SuperLiked(),f=await t.queryFilter(p,-1e4),u=new Map;for(const m of f){const g=m.args.postId.toString(),y=m.args.ethAmount,k=u.get(g)||0n;u.set(g,k+y)}const b=[];for(const m of r.slice(-50)){const g=await m.getBlock();b.push({id:m.args.postId.toString(),type:"post",author:m.args.author,content:m.args.content,mediaCID:m.args.mediaCID,timestamp:g.timestamp,superLikes:u.get(m.args.postId.toString())||0n,txHash:m.transactionHash})}for(const m of o.slice(-30)){const g=await m.getBlock();b.push({id:m.args.postId.toString(),type:"reply",parentId:m.args.parentId.toString(),author:m.args.author,content:m.args.content,mediaCID:m.args.mediaCID,tipBkc:m.args.tipBkc,timestamp:g.timestamp,superLikes:u.get(m.args.postId.toString())||0n,txHash:m.transactionHash})}for(const m of d.slice(-20)){const g=await m.getBlock();b.push({id:m.args.newPostId.toString(),type:"repost",originalPostId:m.args.originalPostId.toString(),author:m.args.reposter,timestamp:g.timestamp,txHash:m.transactionHash})}b.sort((m,g)=>g.timestamp-m.timestamp),N.posts=b,N.trendingPosts=[...b].filter(m=>m.superLikes>0n).sort((m,g)=>{const y=BigInt(m.superLikes||0),k=BigInt(g.superLikes||0);return k>y?1:k<y?-1:0})}catch(e){console.error("Failed to load posts:",e),N.error=e.message}finally{N.isLoading=!1,ze()}}async function pb(){var a;const e=document.getElementById("bc-compose-input"),t=(a=e==null?void 0:e.value)==null?void 0:a.trim();if(!t){x("Please write something","error");return}if(t.length>500){x("Post too long (max 500 chars)","error");return}const n=pt();if(!n){x("Please connect wallet","error");return}N.isPosting=!0,ze();try{const s=N.fees.post||await n.calculateFee(5e4),r=await n.createPost(t,"",an()||he.ZeroAddress,{value:s});x("Posting...","info"),await r.wait(),x("Post created! 🎉","success"),e.value="",await ma()}catch(s){console.error("Post error:",s),s.code!=="ACTION_REJECTED"&&x("Failed: "+(s.reason||s.message),"error")}finally{N.isPosting=!1,ze()}}async function mb(e){var n;const t=pt();if(!t){x("Please connect wallet","error");return}try{const a=N.fees.like||await t.calculateFee(55e3),s=await t.like(e,an()||he.ZeroAddress,0,{value:a});x("Liking...","info"),await s.wait(),x("Liked! ❤️","success")}catch(a){console.error("Like error:",a),a.code!=="ACTION_REJECTED"&&((n=a.message)!=null&&n.includes("AlreadyLiked")?x("Already liked this post","warning"):x("Failed: "+(a.reason||a.message),"error"))}}async function fb(e,t){const n=pt();if(!n){x("Please connect wallet","error");return}const a=he.parseEther(t);try{const s=await n.superLike(e,an()||he.ZeroAddress,0,{value:a});x("Super liking...","info"),await s.wait(),x("Super Liked! ⭐","success"),await ma()}catch(s){console.error("Super like error:",s),s.code!=="ACTION_REJECTED"&&x("Failed: "+(s.reason||s.message),"error")}}async function bb(e){const t=pt();if(!t){x("Please connect wallet","error");return}try{const n=N.fees.follow||await t.calculateFee(45e3),a=await t.follow(e,an()||he.ZeroAddress,0,{value:n});x("Following...","info"),await a.wait(),N.following.add(e.toLowerCase()),x("Followed! 👥","success"),ze()}catch(n){console.error("Follow error:",n),n.code!=="ACTION_REJECTED"&&x("Failed: "+(n.reason||n.message),"error")}}async function gb(){const e=pt();if(!e){x("Please connect wallet","error");return}if(N.pendingEth===0n){x("No earnings to withdraw","warning");return}try{const t=await e.withdraw();x("Withdrawing...","info"),await t.wait(),x(`Withdrawn ${Bt(N.pendingEth)} ETH! 💰`,"success"),N.pendingEth=0n,ze()}catch(t){console.error("Withdraw error:",t),t.code!=="ACTION_REJECTED"&&x("Failed: "+(t.reason||t.message),"error")}}function xb(){return`
        <div class="bc-header">
            <div class="bc-header-bar">
                ...
                <div class="bc-header-right">
                    ${c.isConnected&&N.pendingEth>0n?`
                        <button class="bc-icon-btn earnings-btn" onclick="BackchatPage.openEarnings()" title="Earnings: ${Bt(N.pendingEth)} ETH">
                            <i class="fa-solid fa-coins"></i>
                        </button>
                    `:""}
            ...
            <div class="bc-nav">
                <button class="bc-nav-item ${N.activeTab==="feed"?"active":""}" onclick="BackchatPage.setTab('feed')">
                    <i class="fa-solid fa-house"></i> Feed
                </button>
                <button class="bc-nav-item ${N.activeTab==="trending"?"active":""}" onclick="BackchatPage.setTab('trending')">
                    <i class="fa-solid fa-fire"></i> Trending
                </button>
                <button class="bc-nav-item ${N.activeTab==="profile"?"active":""}" onclick="BackchatPage.setTab('profile')">
                    <i class="fa-solid fa-user"></i> Profile
                </button>
            </div>
        </div>
    `}function hb(){if(!c.isConnected)return"";const e=Bt(N.fees.post);return`
        <div class="bc-compose">
            ...
            <div class="bc-compose-bottom">
                ...
                <div class="bc-compose-right">
                    ...
                    <button class="bc-post-btn" onclick="BackchatPage.createPost()" ${N.isPosting?"disabled":""}>
                        ${N.isPosting?'<i class="fa-solid fa-spinner fa-spin"></i> Posting':"Post"}
                    </button>
                </div>
            </div>
        </div>
    ...
    `}function vb(){return N.contractAvailable?N.isLoading?`
        ...
        `:N.posts.map((e,t)=>xr(e,t)).join(""):`
            <div class="bc-empty">
                ...
                <div class="bc-empty-text">
                    ${N.error||"Backchat is being deployed. The unstoppable social network will be live soon!"}
                </div>
                <button class="bc-btn bc-btn-outline" style="margin-top:24px;" onclick="BackchatPage.refresh()">
                    <i class="fa-solid fa-arrows-rotate"></i> Retry
                </button>
            </div>
        `}function wb(){return N.trendingPosts.length===0?`
            <div class="bc-empty">
                <div class="bc-empty-glyph accent">
                    <i class="fa-solid fa-fire"></i>
                </div>
        ...
        ${N.trendingPosts.map((e,t)=>xr(e,t)).join("")}
    `}function yb(){var t;if(!c.isConnected)return`
        ...
        `;const e=N.posts.filter(n=>{var a;return n.author.toLowerCase()===((a=c.userAddress)==null?void 0:a.toLowerCase())});return`
        <div class="bc-profile-section">
            <div class="bc-profile-banner"></div>
            <div class="bc-profile-main">
                <div class="bc-profile-top-row">
                    <div class="bc-profile-pic ${N.isBoosted?"boosted":""}">
                        ${br(c.userAddress)}
                    </div>
                ...
                <div class="bc-profile-name-row">
                    ...
                    ${N.hasBadge?'<i class="fa-solid fa-circle-check bc-profile-badge"></i>':""}
                    ${N.isBoosted?'<span class="bc-boosted-tag"><i class="fa-solid fa-rocket"></i> Boosted</span>':""}
                </div>
                ...
                <div class="bc-profile-stats">
                    ...
                    <div class="bc-stat-cell">
                        <div class="bc-stat-value">${N.following.size}</div>
                        <div class="bc-stat-label">Following</div>
                    </div>
                    <div class="bc-stat-cell">
                        <div class="bc-stat-value">${Bt(N.pendingEth)}</div>
                        <div class="bc-stat-label">Earned (ETH)</div>
                    </div>
                    <div class="bc-stat-cell">
                        <div class="bc-stat-value">${((t=N.referralStats)==null?void 0:t.totalReferred)||0}</div>
            ...
            ${N.pendingEth>0n?`
                <div class="bc-earnings-card">
                    ...
                    <div class="bc-earnings-value">
                        ${Bt(N.pendingEth)} <small>ETH</small>
                    </div>
    ...
    `}function kb(){var a,s;if(!c.isConnected)return"";const e=`${window.location.origin}/#backchat?ref=${c.userAddress}`,t=((a=N.referralStats)==null?void 0:a.totalReferred)||0,n=((s=N.referralStats)==null?void 0:s.totalEarnedFormatted)||"0.0";return`
        <div class="bc-referral-card">
            ...
            <div class="bc-referral-info" style="margin-top:12px;">
                ...
                ${N.referredBy?`<br>You were referred by <code style="font-size:11px;color:var(--bc-accent);">${fr(N.referredBy)}</code>`:""}
            </div>
        </div>
    `}function ze(){const e=document.getElementById("backchat-content");if(!e)return;let t="";switch(N.activeTab){case"feed":t=hb()+vb();break;case"trending":t=wb();break;case"profile":t=yb();break}e.innerHTML=t}function Tb(){return`
        <!-- Super Like Modal -->
            ...
            <div class="bc-modal-box">
                ...
                <div class="bc-modal-inner">
                    ...
                    <div class="bc-fee-row">
                        ...
                        <span class="bc-fee-val">${Bt(N.fees.badge)} ETH</span>
                    </div>
