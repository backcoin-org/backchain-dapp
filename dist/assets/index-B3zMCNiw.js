...
#Backchain #DeFi #Arbitrum #Web3`;navigator.share?navigator.share({title:"Backchain — Invite & Earn",text:t,url:e}).catch(()=>{}):navigator.clipboard.writeText(t).then(()=>x("Share text copied!","success")).catch(()=>{})}async function Kp(){try{if(await c.provider.getBalance(c.userAddress)<Qe.parseEther("0.002")){const t=document.getElementById("no-gas-modal-dash");return t&&(t.classList.remove("hidden"),t.classList.add("flex")),!1}return!0}catch{return!0}}function Yp(){if(document.getElementById("dash-styles-v69"))return;const e=document.createElement("style");e.id="dash-styles-v69",e.textContent=`
    ...
    `}function Sf(e,t,a,n,r=!1){return c.isConnected?e?t?`
        ...
        `}).join("")}async function lt(e=!1){var n,r;if($.selectedPoolBoostBips===null)return;const t=$.selectedPoolBoostBips,a=Date.now();if(zt=a,!e){const i=Af(t);if(i){Wr(i),gn(),Xo(),Lf(t,a);return}}$.isDataLoading=!0;try{const i=c.myBoosters||[],s=c.rentalListings||[],o=new Set(s.map(Y=>{var ie;return(ie=Y.tokenId)==null?void 0:ie.toString()})),l=Math.floor(Date.now()/1e3),d=i.filter(Y=>Number(Y.boostBips)===t),u=d.filter(Y=>{var He;const ie=(He=Y.tokenId)==null?void 0:He.toString(),$e=s.find(Z=>{var Le;return((Le=Z.tokenId)==null?void 0:Le.toString())===ie}),Tt=o.has(ie),rt=$e&&$e.rentalEndTime&&Number($e.rentalEndTime)>l;return!Tt&&!rt}),f=ge.find(Y=>Y.boostBips===t);if(!f){console.warn("Tier not found for boostBips:",t);return}const p=`pool_${f.name.toLowerCase()}`;let g=v[p]||mn.get(t);if(!g){const Y=v.nftPoolFactory||v.nftLiquidityPoolFactory;if(Y&&c.publicProvider)try{g=await new ze.Contract(Y,Cf,c.publicProvider).getPoolAddress(t),g&&g!==ze.ZeroAddress&&mn.set(t,g)}catch(ie){console.warn("Factory lookup failed:",ie.message)}}if(zt!==a)return;if(!g||g===ze.ZeroAddress){const Y=document.getElementById("swap-interface");Y&&(Y.innerHTML=`
                ...
                `);return}const m=new ze.Contract(g,ai,c.publicProvider),[w,T,C]=await Promise.all([ae(m,"getBuyPrice",[],ze.MaxUint256).catch(()=>ze.MaxUint256),ae(m,"getSellPrice",[],0n).catch(()=>0n),m.getAvailableNFTs().catch(()=>[])]);if(zt!==a)return;const P=Array.isArray(C)?[...C]:[],N=w===ze.MaxUint256?0n:w,R=T;let B=((n=c.systemFees)==null?void 0:n.NFT_POOL_SELL_TAX_BIPS)||1000n,I=BigInt(((r=c.boosterDiscounts)==null?void 0:r[$.bestBoosterBips])||0);const S=typeof B=="bigint"?B:BigInt(B),F=typeof I=="bigint"?I:BigInt(I),ne=S>F?S-F:0n,V=R*ne/10000n,he=R-V,ce={buyPrice:N,sellPrice:R,netSellPrice:he,poolNFTCount:P.length,firstAvailableTokenIdForBuy:P.length>0?BigInt(P[P.length-1]):null,userBalanceOfSelectedNFT:d.length,availableToSellCount:u.length,availableNFTsOfTier:u};Jc(t,ce),Wr(ce,t)}catch(i){if(console.warn("Store Data Warning:",i.message),zt===a){const s=document.getElementById("swap-interface");s&&(s.innerHTML=`
                    <div class="text-center py-12">
                        <div class="w-12 h-12 bg-zinc-800 rounded-full flex items-center justify-center mx-auto mb-3">
...
#Backcoin #Web3 #Arbitrum`}},yr={pt:"./assets/pt.png",en:"./assets/en.png",es:"./assets/es.png"};let Xe="en";const fe=[{id:1,name:"Easy",emoji:"🍀",range:5,multiplier:2,chance:"20%",color:"emerald",hex:"#10b981",bgFrom:"from-emerald-500/20",bgTo:"to-green-600/10",borderColor:"border-emerald-500/50",textColor:"text-emerald-400"},{id:2,name:"Medium",emoji:"⚡",range:15,multiplier:10,chance:"6.7%",color:"violet",hex:"#8b5cf6",bgFrom:"from-violet-500/20",bgTo:"to-purple-600/10",borderColor:"border-violet-500/50",textColor:"text-violet-400"},{id:3,name:"Hard",emoji:"👑",range:150,multiplier:100,chance:"0.67%",color:"amber",hex:"#f59e0b",bgFrom:"from-amber-500/20",bgTo:"to-orange-600/10",borderColor:"border-amber-500/50",textColor:"text-amber-400"}],Qc=57,y={mode:null,phase:"select",guess:50,guesses:[2,5,50],comboStep:0,wager:10,gameId:null,result:null,txHash:null,poolStatus:null,history:[],serviceFee:0n,serviceFee1x:0n,serviceFee5x:0n,tiersData:null,commitment:{hash:null,userSecret:null,commitBlock:null,commitTxHash:null,revealDelay:2,waitStartTime:null,canReveal:!1}};let Re=null;const Mf=3e3,ed=250;function Df(){if(document.getElementById("fortune-styles-v2"))return;const e=document.createElement("style");e.id="fortune-styles-v2",e.textContent=`
    ...
    `,l&&(tm(),d>y.wager*10&&am()),(f=document.getElementById("btn-new-game"))==null||f.addEventListener("click",()=>{y.phase="select",y.result=null,y.txHash=null,y.gameId=null,ue(),Zs()}),(p=document.getElementById("btn-share"))==null||p.addEventListener("click",()=>{nm(l,d)})}function tm(){const e=document.createElement("div");e.className="confetti-container",document.body.appendChild(e);const t=["#f59e0b","#10b981","#8b5cf6","#ec4899","#06b6d4"],a=["●","■","★","🐯","🎉"];for(let n=0;n<60;n++){const r=document.createElement("div");r.className="confetti",r.style.cssText=`
...
(This will reset their rejection count to 0)`;if(!window.confirm(r))return;const i=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await Xl(a,n),x(`User ${n?"BANNED":"UNBANNED"}.`,"success");const s=A.allUsers.findIndex(o=>o.id===a);s>-1&&(A.allUsers[s].isBanned=n,A.allUsers[s].hasPendingAppeal=!1,n===!1&&(A.allUsers[s].rejectedCount=0)),ht()}catch(s){x(`Failed: ${s.message}`,"error"),t.disabled=!1,t.innerHTML=i}},Xm=async e=>{const t=e.target.closest(".resolve-appeal-btn");if(!t||t.disabled)return;const a=t.dataset.userId,r=t.dataset.action==="approve";if(!a)return;const i=r?"Are you sure you want to APPROVE this appeal and UNBAN the user?":"Are you sure you want to DENY this appeal? The user will remain banned.";if(!window.confirm(i))return;const s=t.closest("td").querySelectorAll("button"),o=new Map;s.forEach(l=>{o.set(l,l.innerHTML),l.disabled=!0,l.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>'});try{r&&await Xl(a,!1),x(`Appeal ${r?"APPROVED":"DENIED"}.`,"success");const l=A.allUsers.findIndex(d=>d.id===a);l>-1&&(A.allUsers[l].hasPendingAppeal=!1,r&&(A.allUsers[l].isBanned=!1,A.allUsers[l].rejectedCount=0)),ht()}catch(l){x(`Failed: ${l.message}`,"error"),s.forEach(d=>{d.disabled=!1,d.innerHTML=o.get(d)})}},Jm=async e=>{const t=e.target.closest(".re-approve-btn");if(!t||t.disabled)return;const a=t.dataset.submissionId,n=t.dataset.userId;if(!a||!n)return;const r=t.closest("tr");r&&(r.style.opacity="0.5"),t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await ql(n,a,"approved"),x("Submission re-approved!","success"),A.selectedUserSubmissions=A.selectedUserSubmissions.filter(s=>s.submissionId!==a),r&&r.remove();const i=A.allUsers.findIndex(s=>s.id===n);if(i>-1){const s=A.allUsers[i];s.rejectedCount=Math.max(0,(s.rejectedCount||0)-1),ht()}if(A.selectedUserSubmissions.length===0){const s=document.querySelector("#admin-user-modal .p-6");s&&(s.innerHTML='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>')}}catch(i){x(`Failed to re-approve: ${i.message}`,"error"),r&&(r.style.opacity="1"),t.disabled=!1,t.innerHTML='<i class="fa-solid fa-check"></i> Re-Approve'}},Zm=async e=>{const t=e.target.closest(".view-rejected-btn");if(!t||t.disabled)return;const a=t.dataset.userId,n=t.dataset.wallet;if(a){A.selectedWallet=n,A.isSubmissionsModalOpen=!0,Cr(!0,[]);try{const r=await Du(a,"rejected");A.selectedUserSubmissions=r,Cr(!1,r)}catch(r){x(`Error fetching user submissions: ${r.message}`,"error"),Cr(!1,[],!0)}}},Qm=()=>{A.isSubmissionsModalOpen=!1,A.selectedUserSubmissions=[],A.selectedWallet=null;const e=document.getElementById("admin-user-modal");e&&e.remove(),document.body.style.overflow="auto"},e0=e=>{const t=e.target.closest(".user-profile-link");if(!t)return;e.preventDefault();const a=t.dataset.userId;if(!a)return;const n=A.allUsers.find(r=>r.id===a);if(!n){x("Error: Could not find user data.","error");return}s0(n)},t0=()=>{const e=document.getElementById("admin-user-profile-modal");e&&e.remove(),document.body.style.overflow="auto"},a0=async e=>{e.preventDefault();const t=e.target;let a,n;try{if(a=new Date(t.startDate.value+"T00:00:00Z"),n=new Date(t.endDate.value+"T23:59:59Z"),isNaN(a.getTime())||isNaN(n.getTime()))throw new Error("Invalid date format.");if(a>=n)throw new Error("Start Date must be before End Date.")}catch(l){x(l.message,"error");return}const r={title:t.title.value.trim(),url:t.url.value.trim(),description:t.description.value.trim(),points:parseInt(t.points.value,10),cooldownHours:parseInt(t.cooldown.value,10),startDate:a,endDate:n};if(!r.title||!r.description){x("Please fill in Title and Description.","error");return}if(r.points<=0||r.cooldownHours<=0){x("Points and Cooldown must be positive numbers.","error");return}if(r.url&&!r.url.startsWith("http")){x("URL must start with http:// or https://","error");return}A.editingTask&&A.editingTask.id&&(r.id=A.editingTask.id);const i=t.querySelector('button[type="submit"]'),s=i.innerHTML;i.disabled=!0;const o=document.createElement("span");o.classList.add("inline-block"),i.innerHTML="",i.appendChild(o);try{await Ru(r),x(`Task ${r.id?"updated":"created"} successfully!`,"success"),t.reset(),A.editingTask=null,wa()}catch(l){x(`Failed to save task: ${l.message}`,"error"),console.error(l),i.disabled=!1,i.innerHTML=s}},n0=async e=>{e.preventDefault();const t=e.target,a={YouTube:parseInt(t.youtubePoints.value,10),"YouTube Shorts":parseInt(t.youtubeShortsPoints.value,10),Instagram:parseInt(t.instagramPoints.value,10),"X/Twitter":parseInt(t.xTwitterPoints.value,10),Facebook:parseInt(t.facebookPoints.value,10),Telegram:parseInt(t.telegramPoints.value,10),TikTok:parseInt(t.tiktokPoints.value,10),Reddit:parseInt(t.redditPoints.value,10),LinkedIn:parseInt(t.linkedinPoints.value,10),Other:parseInt(t.otherPoints.value,10)};if(Object.values(a).some(s=>isNaN(s)||s<0)){x("All points must be positive numbers (or 0).","error");return}const n=t.querySelector('button[type="submit"]'),r=n.innerHTML;n.disabled=!0;const i=document.createElement("span");i.classList.add("inline-block"),n.innerHTML="",n.appendChild(i);try{await $u(a),x("UGC Base Points updated successfully!","success"),A.ugcBasePoints=a}catch(s){x(`Failed to update points: ${s.message}`,"error"),console.error(s)}finally{document.body.contains(n)&&(n.disabled=!1,n.innerHTML=r)}},r0=e=>{const t=A.dailyTasks.find(a=>a.id===e);t&&(A.editingTask=t,za())},i0=async e=>{if(window.confirm("Are you sure you want to delete this task permanently?"))try{await _u(e),x("Task deleted.","success"),A.editingTask=null,wa()}catch(t){x(`Failed to delete task: ${t.message}`,"error"),console.error(t)}};function Cr(e,t,a=!1){var s,o;const n=document.getElementById("admin-user-modal");n&&n.remove(),document.body.style.overflow="hidden";let r="";e?r='<div class="p-8"></div>':a?r='<p class="text-red-400 text-center p-8">Failed to load submissions.</p>':t.length===0?r='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>':r=`
    ...
    `,ua(),pe(),Promise.all([G0(),ro(),Y0()]).catch(()=>{}))}function ua(){var t;const e=document.getElementById("nt-header");if(e){if(E.view==="cert-detail"){e.innerHTML=`
    ...
    `}}function pe(){const e=document.getElementById("nt-content");if(e)switch(E.view){case"documents":sl(e);break;case"notarize":R0(e);break;case"verify":H0(e);break;case"stats":j0(e);break;case"cert-detail":W0(e);break;default:sl(e)}}function sl(e){if(!c.isConnected){e.innerHTML=`
...
`)[0].trim())||"Notarized Document";return`
    ...
    `}function D0(e){const t=E.wizFile,a=Ma((t==null?void 0:t.type)||"",(t==null?void 0:t.name)||""),n=E.wizDescription||"No description",r=se?se.formatEther(E.bkcFee):"1",i=se?se.formatEther(E.ethFee):"0.0001";e.innerHTML=`
...
`;let r;e==="twitter"?r=`https://twitter.com/intent/tweet?text=${encodeURIComponent(n)}&url=${encodeURIComponent(a)}`:e==="telegram"?r=`https://t.me/share/url?url=${encodeURIComponent(a)}&text=${encodeURIComponent(n)}`:e==="whatsapp"&&(r=`https://wa.me/?text=${encodeURIComponent(n+a)}`),r&&window.open(r,"_blank","width=600,height=400")}function cb(){const e=k.currentCampaign;e&&navigator.clipboard.writeText($d(e.id)).then(()=>x("Link copied!","success")).catch(()=>x("Copy failed","error"))}function jd(){Pg(),k.currentCampaign=null,k.currentView="main",Oe()}function db(e){mt("my"),mt("donate"),mt("edit"),Ag(e),Wt(e)}function ub(e){k.selectedCategory=k.selectedCategory===e?null:e,mo()}function pb(){k.selectedCategory=null,mo()}function mo(){const e=document.getElementById("cp-grid");if(!e)return;let t=k.campaigns.filter(a=>lo(a));k.selectedCategory&&(t=t.filter(a=>a.category===k.selectedCategory)),t.sort((a,n)=>Number(n.createdAt||0)-Number(a.createdAt||0)),e.innerHTML=t.length?t.map(a=>Od(a)).join(""):Dd("No campaigns")}async function Wt(e){k.currentView="detail",k.isLoading=!0;const t=Zr();t&&(t.innerHTML=$g());try{let a=k.campaigns.find(n=>n.id===e||n.id===String(e));if(!a){const n=c==null?void 0:c.publicProvider;if(n){const i=await new jt.Contract(v.charityPool,co,n).getCampaign(e),s=Fd(e);a={id:String(e),creator:i.creator||i[0],title:i.title||i[1]||`Campaign #${e}`,description:i.description||i[2]||"",goalAmount:BigInt((i.goalAmount||i[3]).toString()),raisedAmount:BigInt((i.raisedAmount||i[4]).toString()),donationCount:Number(i.donationCount||i[5]),deadline:Number(i.deadline||i[6]),createdAt:Number(i.createdAt||i[7]),status:Number(i.status||i[10]),category:(s==null?void 0:s.category)||"humanitarian",imageUrl:(s==null?void 0:s.imageUrl)||null}}}k.currentCampaign=a,t&&(t.innerHTML=ml(a))}catch{t&&(t.innerHTML=ml(null))}finally{k.isLoading=!1}}function Zr(){let e=document.getElementById("charity-container");if(e)return e;const t=document.getElementById("charity");return t?(e=document.createElement("div"),e.id="charity-container",t.innerHTML="",t.appendChild(e),e):null}function Oe(){Ig();const e=Zr();if(!e)return;if(k.currentView==="create"){e.innerHTML=Rg(),Ua();return}const t=Ld();t?Wt(t):(k.currentView="main",k.currentCampaign=null,e.innerHTML=fl(),kt().then(()=>{if(k.currentView==="main"){const a=Zr();a&&(a.innerHTML=fl())}}))}async function fb(){k.campaigns=[],k.stats=null,k.currentView==="detail"&&k.currentCampaign?await Wt(k.currentCampaign.id):Oe()}window.addEventListener("hashchange",()=>{var e;if(window.location.hash.startsWith("#charity")){const t=Ld();t?((e=k.currentCampaign)==null?void 0:e.id)!==t&&Wt(t):k.currentView!=="main"&&jd()}});const Wd={render(e){e&&Oe()},update(){k.currentView==="main"&&mo()},refresh:fb,openModal:dr,closeModal:mt,openCreate:Xg,openDonate:Jg,openMyCampaigns:Zg,openEdit:Qg,create:ab,donate:nb,donateDetail:rb,cancel:ib,withdraw:sb,saveEdit:ob,selCatOpt:eb,setAmt:tb,goBack:jd,viewCampaign:db,selectCat:ub,clearCat:pb,share:lb,copyLink:cb,handleImageSelect:Bg,removeImage:Ng,switchImageTab:Sg,wizardSelectCategory:Hg,wizardNext:Ug,wizardBack:jg,wizardSkipImage:Wg,cancelCreate:Ud,wizardUpdateCharCount:Kg,handleWizardImageSelect:Yg,removeWizardImage:Vg,wizardLaunch:qg};window.CharityPage=Wd;const ja=window.ethers,Gd="https://sepolia.arbiscan.io/address/",mb=Al,gt=500;function Kd(){return v.agora||v.backchat||v.Backchat||null}function nt(){return v.operator||v.treasury||null}const b={view:"feed",activeTab:"feed",viewHistory:[],posts:[],trendingPosts:[],allItems:[],replies:new Map,likesMap:new Map,replyCountMap:new Map,repostCountMap:new Map,postsById:new Map,userProfile:null,profiles:new Map,hasProfile:null,following:new Set,followers:new Set,followCounts:new Map,pendingImage:null,pendingImagePreview:null,isUploadingImage:!1,selectedPost:null,selectedProfile:null,wizStep:1,wizUsername:"",wizDisplayName:"",wizBio:"",wizUsernameOk:null,wizFee:null,wizChecking:!1,fees:{post:0n,reply:0n,like:0n,follow:0n,repost:0n,superLikeMin:0n,boostMin:0n,badge:0n},pendingEth:0n,hasBadge:!1,isBoosted:!1,boostExpiry:0,badgeExpiry:0,referralStats:null,referredBy:null,isLoading:!1,isPosting:!1,contractAvailable:!0,error:null};function gb(){if(document.getElementById("backchat-styles-v70"))return;const e=document.getElementById("backchat-styles-v69");e&&e.remove();const t=document.createElement("style");t.id="backchat-styles-v70",t.textContent=`
    ...
    `}function oe(){const e=document.getElementById("backchat-content");if(!e)return;let t="";switch(b.view){case"feed":t=wl()+yl();break;case"trending":t=Mb();break;case"profile":t=!b.hasProfile&&c.isConnected?kl():Db();break;case"post-detail":t=Hb();break;case"user-profile":t=Ub();break;case"profile-setup":t=kl();break;default:t=wl()+yl()}e.innerHTML=t}function Hb(){const e=b.selectedPost?b.postsById.get(b.selectedPost):null;if(!e)return'<div class="bc-empty"><div class="bc-empty-title">Post not found</div></div>';const t=b.replies.get(e.id)||[];t.sort((n,r)=>n.timestamp-r.timestamp);const a=Ea(e.author);return`
