    ...
    `},gi=()=>{var a,s,r,i;const e=B.campaigns.filter(o=>ur(o)),t=e.filter(o=>o.category==="animal"),n=e.filter(o=>o.category==="humanitarian");return`
        <div class="charity-page">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6 cp-stats-grid">
                ...
                <div class="cp-stat-card">
                    <p class="text-2xl font-bold text-blue-400 font-mono">${B.stats?ke(B.stats.fees):"--"}</p>
                ...
                <div class="cp-stat-card">
                    <p class="text-2xl font-bold text-purple-400 font-mono">${((s=B.stats)==null?void 0:s.donations)??"--"}</p>
