import{defaultConfig as Wc,createWeb3Modal as Gc}from"https://esm.sh/@web3modal/ethers@5.1.11?bundle";import{initializeApp as Kc}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-app.js";import{getAuth as Yc,onAuthStateChanged as qc,signInAnonymously as Vc}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-auth.js";import{getFirestore as Xc,collection as Xe,query as Tt,where as Zn,orderBy as Yt,getDocs as it,doc as te,getDoc as Ae,limit as Jc,serverTimestamp as ot,writeBatch as fa,updateDoc as ba,increment as Me,setDoc as ga,Timestamp as wr,addDoc as Zc,deleteDoc as Qc}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-firestore.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function n(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(s){if(s.ep)return;s.ep=!0;const r=n(s);fetch(s.href,r)}})();const Be={sidebar:document.getElementById("sidebar"),sidebarBackdrop:document.getElementById("sidebar-backdrop"),menuBtn:document.getElementById("menu-btn"),navLinks:document.getElementById("nav-links"),mainContentSections:document.querySelectorAll("main section"),connectButtonDesktop:document.getElementById("connectButtonDesktop"),connectButtonMobile:document.getElementById("connectButtonMobile"),mobileAppDisplay:document.getElementById("mobileAppDisplay"),desktopDisconnected:document.getElementById("desktopDisconnected"),desktopConnectedInfo:document.getElementById("desktopConnectedInfo"),desktopUserAddress:document.getElementById("desktopUserAddress"),desktopUserBalance:document.getElementById("desktopUserBalance"),modalContainer:document.getElementById("modal-container"),toastContainer:document.getElementById("toast-container"),dashboard:document.getElementById("dashboard"),earn:document.getElementById("mine"),store:document.getElementById("store"),rental:document.getElementById("rental"),rewards:document.getElementById("rewards"),actions:document.getElementById("actions"),presale:document.getElementById("presale"),faucet:document.getElementById("faucet"),airdrop:document.getElementById("airdrop"),dao:document.getElementById("dao"),about:document.getElementById("about"),admin:document.getElementById("admin"),tokenomics:document.getElementById("tokenomics"),notary:document.getElementById("notary"),statTotalSupply:document.getElementById("statTotalSupply"),statValidators:document.getElementById("statValidators"),statTotalPStake:document.getElementById("statTotalPStake"),statScarcity:document.getElementById("statScarcity"),statLockedPercentage:document.getElementById("statLockedPercentage"),statUserBalance:document.getElementById("statUserBalance"),statUserPStake:document.getElementById("statUserPStake"),statUserRewards:document.getElementById("statUserRewards")},ed={provider:null,publicProvider:null,web3Provider:null,signer:null,userAddress:null,isConnected:!1,bkcTokenContract:null,delegationManagerContract:null,rewardBoosterContract:null,nftLiquidityPoolContract:null,actionsManagerContract:null,fortunePoolContract:null,faucetContract:null,decentralizedNotaryContract:null,ecosystemManagerContract:null,publicSaleContract:null,rentalManagerContract:null,bkcTokenContractPublic:null,delegationManagerContractPublic:null,faucetContractPublic:null,fortunePoolContractPublic:null,rentalManagerContractPublic:null,ecosystemManagerContractPublic:null,actionsManagerContractPublic:null,currentUserBalance:0n,currentUserNativeBalance:0n,userTotalPStake:0n,userDelegations:[],myBoosters:[],activityHistory:[],totalNetworkPStake:0n,allValidatorsData:[],systemFees:{},systemPStakes:{},boosterDiscounts:{},notaryFee:void 0,notaryMinPStake:void 0},td={set(e,t,n){return e[t]=n,["currentUserBalance","isConnected","userTotalPStake","totalNetworkPStake"].includes(t)&&window.updateUIState&&window.updateUIState(),!0}},c=new Proxy(ed,td);let yr=!1;const x=(e,t="info",n=null)=>{if(!Be.toastContainer)return;const a={success:{icon:"fa-check-circle",color:"bg-green-600",border:"border-green-400"},error:{icon:"fa-exclamation-triangle",color:"bg-red-600",border:"border-red-400"},info:{icon:"fa-info-circle",color:"bg-blue-600",border:"border-blue-400"},warning:{icon:"fa-exclamation-circle",color:"bg-yellow-600",border:"border-yellow-400"}},s=a[t]||a.info,r=document.createElement("div");r.className=`flex items-center w-full max-w-xs p-4 text-white rounded-lg shadow-lg transition-all duration-500 ease-out 
    ...
    `;vn(n,"max-w-md")}const kr=e=>{window.navigateTo?window.navigateTo(e):console.error("navigateTo function not found."),we()};function sd(){var s,r,i,o,l,d;if(yr)return;yr=!0;const e="https://t.me/BackCoinorg",t="https://github.com/backcoin-org/backchain-dapp";vn(`
    ...
    `}async function up(){try{const e=await fetch(Ju);if(e.ok){const t=await e.json();return S.economicData=t,t}}catch{}return null}async function is(){var e,t,n,a,s,r,i,o,l;try{const d=await up();let u=0n,f=0n,m=0n,b=0n,p=0n,g=0,y=0n;if(d)if(console.log("📊 Firebase economic data:",d.economy),(e=d.economy)!=null&&e.totalSupply&&(u=BigInt(d.economy.totalSupply)),(t=d.economy)!=null&&t.totalPStake&&(f=BigInt(d.economy.totalPStake)),(n=d.economy)!=null&&n.totalTVL&&(m=BigInt(d.economy.totalTVL)),(a=d.economy)!=null&&a.totalFeesCollected&&(p=BigInt(d.economy.totalFeesCollected)),(s=d.economy)!=null&&s.fortunePoolBalance&&(y=BigInt(d.economy.fortunePoolBalance)),(r=d.stats)!=null&&r.notarizedDocuments&&(g=d.stats.notarizedDocuments),(i=d.burn)!=null&&i.totalBurned)b=BigInt(d.burn.totalBurned);else if((o=d.burn)!=null&&o.sources){let D=0n;for(const W of Object.values(d.burn.sources))W!=null&&W.total&&(D+=BigInt(W.total));b=D}else(l=d.rental)!=null&&l.totalBurned&&(b=BigInt(d.rental.totalBurned));if(c.bkcTokenContractPublic&&(u===0n&&(console.log("📊 Fetching totalSupply from blockchain (fallback)..."),u=await ne(c.bkcTokenContractPublic,"totalSupply",[],0n)),f===0n&&c.delegationManagerContractPublic&&(console.log("📊 Fetching totalPStake from blockchain (fallback)..."),f=await ne(c.delegationManagerContractPublic,"totalNetworkPStake",[],0n)),m===0n)){console.log("📊 Calculating TVL from blockchain (fallback)...");const D=[w.delegationManager,w.fortunePool,w.rentalManager,w.miningManager,w.decentralizedNotary,w.nftLiquidityPoolFactory,w.pool_diamond,w.pool_platinum,w.pool_gold,w.pool_silver,w.pool_bronze,w.pool_iron,w.pool_crystal].filter(ae=>ae&&ae!==jt.ZeroAddress),W=D.map(ae=>ne(c.bkcTokenContractPublic,"balanceOf",[ae],0n)),oe=await Promise.all(W);if(oe.forEach(ae=>{m+=ae}),w.fortunePool&&y===0n){const ae=D.indexOf(w.fortunePool);ae>=0&&(y=oe[ae])}}const k=_(u),T=_(b),I=_(p),N=_(y),z=D=>D.toLocaleString("en-US",{minimumFractionDigits:1,maximumFractionDigits:1});let E=0;u>0n&&(E=Number(m*10000n/u)/100),E>100&&(E=100);const F=(D,W,oe="")=>{const ae=document.getElementById(D);ae&&(ae.innerHTML=`${W}${oe?` <span class="text-xs text-zinc-500">${oe}</span>`:""}`)},G=document.getElementById("dash-metric-supply");G&&(G.innerHTML=`${z(k)} <span style="font-size: 10px; color: #71717a">BKC</span>`),F("dash-metric-pstake",Ut(f));const se=document.getElementById("dash-metric-burned");se&&(T>0?se.innerHTML=`<span class="text-red-400">${Oa(T)}</span> <span class="text-xs text-zinc-500">BKC 🔥</span>`:se.innerHTML='<span class="text-zinc-500">0</span> <span class="text-xs text-zinc-500">BKC</span>'),F("dash-metric-fees",Oa(I),"BKC");const de=document.getElementById("dash-metric-tvl");if(de){const D=E>30?"text-green-400":E>10?"text-yellow-400":"text-blue-400";de.innerHTML=`<span class="${D}">${E.toFixed(1)}%</span>`}jl();const xe=document.getElementById("dash-fortune-prize");xe&&(xe.innerText=`${Oa(N)} BKC`);const Q=document.getElementById("dash-notary-count");Q&&(Q.innerText=g>0?`${g} docs`:"--"),S.metricsCache={supply:k,burned:T,fees:I,timestamp:Date.now()}}catch(d){console.error("Metrics Error",d)}}async function pp(){if(c.userAddress)try{const e=await fetch(`https://getuserprofile-4wvdcuoouq-uc.a.run.app/${c.userAddress}`);e.ok&&(S.userProfile=await e.json(),mp(S.userProfile))}catch{}}function mp(e){const t=document.getElementById("dash-presale-stats");if(!t||!e||!e.presale||!e.presale.totalBoosters||e.presale.totalBoosters===0)return;t.classList.remove("hidden");const n=e.presale.totalSpentWei||0,a=parseFloat(jt.formatEther(BigInt(n))).toFixed(4);document.getElementById("stats-total-spent").innerText=`${a} ETH`,document.getElementById("stats-total-boosters").innerText=e.presale.totalBoosters||0;const s=document.getElementById("stats-tier-badges");if(s&&e.presale.tiersOwned){let r="";Object.entries(e.presale.tiersOwned).forEach(([i,o])=>{const l=ge[Number(i)-1],d=l?l.name:`T${i}`;r+=`<span class="text-[9px] bg-zinc-800 text-zinc-400 px-1.5 py-0.5 rounded">${o}x ${d}</span>`}),r&&(s.innerHTML=r)}}function jl(){const e=document.getElementById("dash-metric-balance"),t=document.getElementById("dash-balance-card");if(!e)return;const n=c.currentUserBalance||c.bkcBalance||0n;if(!c.isConnected){e.innerHTML='<span class="text-zinc-500 text-xs">Connect Wallet</span>',t&&(t.style.borderColor="rgba(63,63,70,0.5)");return}if(n===0n)e.innerHTML='0.00 <span style="font-size: 10px; color: #71717a">BKC</span>';else{const s=_(n).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2});e.innerHTML=`${s} <span style="font-size: 10px; color: #71717a">BKC</span>`}t&&(t.style.borderColor="rgba(245,158,11,0.3)")}async function _t(e=!1){var t,n;if(!c.isConnected){const a=document.getElementById("dash-booster-area");a&&(a.innerHTML=`
        ...
        `;return}const d=e.source==="rented",u=d?"bg-cyan-500/20 text-cyan-300":"bg-green-500/20 text-green-300",f=d?"Rented":"Owned",m=ud(a),b=(m==null?void 0:m.name)||((T=e.boostName)==null?void 0:T.replace(" Booster","").replace("Booster","").trim())||"Booster",p=(m==null?void 0:m.color)||"text-amber-400",g=(m==null?void 0:m.emoji)||"💎",y=r*50n/100n,k=i-y;console.log("🎨 V6.8 Booster:",{keepRate:s,netReward:_(i),tierName:b}),n.innerHTML=`
    ...
    `;try{const n=await fetch(`${Xu}?limit=30`);if(n.ok){const a=await n.json();S.networkActivities=Array.isArray(a)?a:a.activities||[],S.networkActivitiesTimestamp=Date.now()}else S.networkActivities=[]}catch(n){console.error("Network activity fetch error:",n),S.networkActivities=[]}finally{S.isLoadingNetworkActivity=!1}Kr()}function Kr(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("dash-pagination-controls");if(e){if(S.networkActivities.length===0){e.innerHTML=`
    ...
    `,Np(),c.isConnected?Qt(!0):Zs())}async function Qt(e=!1){var n;if(!c.isConnected){Zs();return}const t=Date.now();if(!(!e&&Dt)&&!(!e&&t-Tn<1e4)){Dt=!0,Tn=t;try{await yp();try{const a=await fetch("https://getsystemdata-4wvdcuoouq-uc.a.run.app");if(a.ok){const s=await a.json();(n=s==null?void 0:s.economy)!=null&&n.totalPStake&&(fn=BigInt(s.economy.totalPStake))}}catch{console.log("Firebase unavailable, using blockchain")}if(fn===0n){const a=c.delegationManagerContractPublic||c.delegationManagerContract;a&&(fn=await ne(a,"totalNetworkPStake",[],0n))}await Promise.all([Pt(!0),Bd(!0),Is()]),await kp(),Tp(),Xl(),bn(),Ap()}catch(a){console.error("Staking load error:",a)}finally{Dt=!1}}}async function yp(){try{const e=c.delegationManagerContract||c.delegationManagerContractPublic;if(e&&c.userAddress)try{const n=await e.getUserBestBoost(c.userAddress);qe=Number(n)}catch{const n=await Ht();qe=(n==null?void 0:n.boost)||0}else{const n=await Ht();qe=(n==null?void 0:n.boost)||0}Cn=Vl(qe).burnRate,Kl=qe>0?"active":"none",Ep()}catch(e){console.error("Error loading NFT boost:",e),qe=0,Cn=50}}async function kp(){try{const e=c.delegationManagerContract||c.delegationManagerContractPublic;if(e&&c.userAddress)try{const t=await e.previewClaim(c.userAddress);Ft={totalRewards:t.totalRewards||t[0],burnAmount:t.burnAmount||t[1],userReceives:t.userReceives||t[2],burnRateBips:t.burnRateBips||t[3],nftBoost:t.nftBoost||t[4]}}catch{const{stakingRewards:t,minerRewards:n}=await qt(),a=t+n,s=a*BigInt(Cn)/100n;Ft={totalRewards:a,burnAmount:s,userReceives:a-s,burnRateBips:BigInt(Cn*100),nftBoost:BigInt(qe)}}}catch(e){console.error("Error loading claim preview:",e)}}function Ep(){const e=Vl(qe),t=document.getElementById("nft-tier-icon");t&&(t.textContent=e.icon,t.style.background=`${e.color}20`);const n=document.getElementById("nft-tier-badge");n&&(n.className=`nft-tier-badge tier-${e.name.toLowerCase()}`,n.innerHTML=`<span>${e.icon} ${e.name}</span>`);const a=document.getElementById("nft-source");a&&(qe>0?(a.classList.remove("hidden"),a.textContent=Kl):a.classList.add("hidden"));const s=document.getElementById("burn-rate-text");s&&(e.burnRate===0?s.innerHTML='<span class="text-green-400">No burn! You keep 100% of rewards</span>':s.textContent=`${e.burnRate}% of rewards will be burned on claim`);const r=document.getElementById("burn-rate-value"),i=document.getElementById("keep-rate-value");r&&(r.textContent=`${e.burnRate}%`),i&&(i.textContent=`${e.userGets}%`);const o=document.getElementById("burn-fill"),l=document.getElementById("receive-fill");o&&(o.style.width=`${e.burnRate}%`),l&&(l.style.width=`${e.userGets}%`)}function Tp(){var i;const e=(o,l)=>{const d=document.getElementById(o);d&&(d.textContent=l)};e("stat-network",Ut(fn||c.totalNetworkPStake||0n)),e("stat-pstake",Ut(c.userTotalPStake||0n)),e("balance-display",_(c.currentUserBalance||0n).toFixed(2)),e("stat-delegations",(c.userDelegations||[]).length.toString());const t=c.userTotalPStake||0n,n=fn||c.totalNetworkPStake||0n;let a=0;n>0n&&t>0n&&(a=Number(t*10000n/n)/100),e("stat-pstake-percent",a>0?`${a.toFixed(2)}% of network`:"0% of network");const s=((i=c.systemFees)==null?void 0:i.DELEGATION_FEE_BIPS)||50n,r=Number(s)/100;e("fee-info",`${r}% protocol fee`),Cp()}async function Cp(){const e=document.getElementById("claim-section");if(!e)return;const{stakingRewards:t,minerRewards:n}=await qt(),a=t+n,s=(r,i)=>{const o=document.getElementById(r);o&&(o.textContent=i)};if(s("stat-rewards",_(a).toFixed(4)),a>0n){e.classList.remove("hidden");let r,i;Ft&&Ft.totalRewards>0n?(r=Ft.burnAmount,i=Ft.userReceives):(r=a*BigInt(Cn)/100n,i=a-r),s("claim-total",_(a).toFixed(4)),s("claim-burn",_(r).toFixed(4)),s("claim-receive",_(i).toFixed(4)),r>0n?e.classList.add("has-burn"):e.classList.remove("has-burn");const o=document.getElementById("claim-btn");o&&(o.onclick=()=>Pp(t,n,o))}else e.classList.add("hidden")}function Zs(){const e=(s,r)=>{const i=document.getElementById(s);i&&(i.textContent=r)};e("stat-network","--"),e("stat-pstake","--"),e("stat-rewards","--"),e("stat-delegations","0"),e("balance-display","0.00"),e("stat-pstake-percent","--% of network");const t=document.getElementById("delegations-list");t&&(t.innerHTML=`
        ...
        `;return}const s=[...t].sort((r,i)=>Number(r.unlockTime)-Number(i.unlockTime));e.innerHTML=s.map(r=>Ip(r)).join(""),Yr(),yt=setInterval(Yr,6e4),e.querySelectorAll(".unstake-btn").forEach(r=>{r.addEventListener("click",()=>qr(r.dataset.index,!1))}),e.querySelectorAll(".force-unstake-btn").forEach(r=>{r.addEventListener("click",()=>{confirm(`⚠️ Force Unstake will apply a 50% penalty!

Are you sure?`)&&qr(r.dataset.index,!0)})})}function Ip(e){const t=_(e.amount).toFixed(2),n=Ut(ql(e.amount,e.lockDuration)),a=Number(e.unlockTime),s=Math.floor(Date.now()/1e3),r=a>s,i=r?a-s:0,o=Math.floor(Number(e.lockDuration)/86400);return`
    ...
    `}function e0(){return In.length===0?`
        ...
        `}).join("")}async function t0(){if(Jn)return;const e=document.getElementById("claim-btn");if(e){Jn=!0;try{await It.claimRewards({button:e,onSuccess:t=>{x("🎁 Rewards claimed successfully!","success"),setTimeout(()=>{ia.clearCache(),In=[],ia.update(!0)},2500)},onError:t=>{t&&!t.cancelled&&t.type!=="user_rejected"&&x(t.message||"Claim failed","error")}})}catch(t){console.error("Claim error:",t),x(t.message||"Claim failed","error")}finally{Jn=!1}}}window.RewardsPage=ia;const er="https://sepolia.arbiscan.io/tx/",us="https://sepolia.arbiscan.io/address/",tc="0x16346f5a45f9615f1c894414989f0891c54ef07b",n0=(w==null?void 0:w.fortunePool)||"0x277dB00d533Bbc0fc267bbD954640aDA38ee6B37",oa="./assets/fortune.png",ps=1e3,ti={pt:{title:"Compartilhe & Ganhe!",subtitle:"+1000 pontos para o Airdrop",later:"Talvez depois"},en:{title:"Share & Earn!",subtitle:"+1000 points for Airdrop",later:"Maybe later"},es:{title:"¡Comparte y Gana!",subtitle:"+1000 puntos para el Airdrop",later:"Quizás después"}},a0={pt:{win:e=>`🎉 Ganhei ${e.toLocaleString()} BKC no Fortune Pool!
...
#Backcoin #Web3 #Arbitrum`}},Ga={pt:"./assets/pt.png",en:"./assets/en.png",es:"./assets/es.png"};let Ge="en";const ue=[{id:1,name:"Easy",emoji:"🍀",range:3,multiplier:2,chance:"33%",color:"emerald",hex:"#10b981",bgFrom:"from-emerald-500/20",bgTo:"to-green-600/10",borderColor:"border-emerald-500/50",textColor:"text-emerald-400"},{id:2,name:"Medium",emoji:"⚡",range:10,multiplier:5,chance:"10%",color:"violet",hex:"#8b5cf6",bgFrom:"from-violet-500/20",bgTo:"to-purple-600/10",borderColor:"border-violet-500/50",textColor:"text-violet-400"},{id:3,name:"Hard",emoji:"👑",range:100,multiplier:50,chance:"1%",color:"amber",hex:"#f59e0b",bgFrom:"from-amber-500/20",bgTo:"to-orange-600/10",borderColor:"border-amber-500/50",textColor:"text-amber-400"}],nc=57,v={mode:null,phase:"select",guess:50,guesses:[2,5,50],comboStep:0,wager:10,gameId:null,result:null,txHash:null,poolStatus:null,history:[],serviceFee:0n,serviceFee1x:0n,serviceFee5x:0n,tiersData:null,commitment:{hash:null,userSecret:null,commitBlock:null,commitTxHash:null,revealDelay:2,waitStartTime:null,canReveal:!1}};let Le=null;const s0=3e3,ac=250;function r0(){if(document.getElementById("fortune-styles-v2"))return;const e=document.createElement("style");e.id="fortune-styles-v2",e.textContent=`
    ...
    `;vn(s,"max-w-xs");const r=p=>{Ge=p;const g=ti[p],y=document.getElementById("share-modal-title"),k=document.getElementById("share-modal-subtitle"),T=document.getElementById("btn-close-share");y&&(y.textContent=g.title),k&&(k.textContent=g.subtitle),T&&(T.textContent=g.later),document.querySelectorAll(".lang-btn").forEach(I=>{const N=I.dataset.lang,z=I.querySelector("span");N===p?(I.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-amber-500/20 border-amber-500 ring-1 ring-amber-500/50 border",z&&(z.className="text-amber-400")):(I.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-zinc-800 border-zinc-700 hover:border-zinc-500 border",z&&(z.className="text-zinc-400"))})};document.querySelectorAll(".lang-btn").forEach(p=>{p.addEventListener("click",()=>r(p.dataset.lang))});const i=async p=>{if(!c.userAddress)return!1;try{const y=await(await fetch("https://us-central1-backchain-backand.cloudfunctions.net/trackShare",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({address:c.userAddress,gameId:v.gameId||Date.now(),type:"fortune",platform:p})})).json();return y.success?(x(`🎉 +${y.pointsAwarded||ps} Airdrop Points!`,"success"),!0):(y.reason==="already_shared"&&console.log("Already shared this game"),!1)}catch(g){return console.error("Share tracking error:",g),x(`🎉 +${ps} Airdrop Points!`,"success"),!0}},o=async(p,g)=>{await i(p),window.open(g,"_blank"),we()};(l=document.getElementById("share-twitter"))==null||l.addEventListener("click",()=>{const p=a();o("twitter",`https://twitter.com/intent/tweet?text=${encodeURIComponent(p)}`)}),(d=document.getElementById("share-telegram"))==null||d.addEventListener("click",()=>{const p=a();o("telegram",`https://t.me/share/url?url=https://backcoin.org&text=${encodeURIComponent(p)}`)}),(u=document.getElementById("share-whatsapp"))==null||u.addEventListener("click",()=>{const p=a();o("whatsapp",`https://wa.me/?text=${encodeURIComponent(p)}`)}),(f=document.getElementById("share-instagram"))==null||f.addEventListener("click",async()=>{const p=a();try{await navigator.clipboard.writeText(p),await i("instagram");const g=`
            ...
            `)}}catch(t){console.error("loadHistory error:",t)}}function I0(e){const t=document.getElementById("history-list");t&&(t.innerHTML=e.map(n=>{var p;const a=n.isWin||n.prizeWon&&BigInt(n.prizeWon)>0n,s=n.prizeWon?_(BigInt(n.prizeWon)):0,r=n.wagerAmount?_(BigInt(n.wagerAmount)):0,i=n.isCumulative,o=n.rolls||[],l=n.guesses||[],d=n.txHash||n.transactionHash,u=A0(n.timestamp||n.createdAt),f=n.player?`${n.player.slice(0,6)}...${n.player.slice(-4)}`:"???",m=c.userAddress&&((p=n.player)==null?void 0:p.toLowerCase())===c.userAddress.toLowerCase(),b=d?`${er}${d}`:null;return`
    ...
    `}function J0(){var u,f;const e=((u=A.leaderboards)==null?void 0:u.top100ByPosts)||[],t=((f=A.leaderboards)==null?void 0:f.top100ByPoints)||[],n=A.activeRanking||"posts";function a(m,b,p){var z,E;const g=A.user&&((z=m.walletAddress)==null?void 0:z.toLowerCase())===((E=A.user.walletAddress)==null?void 0:E.toLowerCase()),y=Z0(b+1),k=p==="posts"?"bg-amber-500/10":"bg-green-500/10",T=p==="posts"?"text-amber-400":"text-green-400",I=p==="posts"?"text-white":"text-green-400",N=p==="posts"?"posts":"pts";return`
    ...
    `;vn(t,"max-w-md"),(s=document.getElementById("deletePostBtn"))==null||s.addEventListener("click",async r=>{const i=r.currentTarget,o=i.dataset.submissionId;i.disabled=!0,i.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-1"></i> Deleting...';try{await Si(o),x("Post deleted. No penalty applied.","info"),we(),await en(),$e()}catch(l){x(l.message,"error"),i.disabled=!1,i.innerHTML='<i class="fa-solid fa-trash mr-1"></i> Delete Post'}});const n=document.getElementById("confirmCheckbox"),a=document.getElementById("finalConfirmBtn");n==null||n.addEventListener("change",()=>{n.checked?(a.disabled=!1,a.className="flex-1 bg-green-600 hover:bg-green-500 text-white py-3 rounded-xl font-bold text-sm transition-colors cursor-pointer",a.innerHTML='<i class="fa-solid fa-check mr-1"></i> Confirm & Earn ✓'):(a.disabled=!0,a.className="flex-1 bg-green-600/50 text-green-200 py-3 rounded-xl font-bold text-sm cursor-not-allowed transition-colors",a.innerHTML='<i class="fa-solid fa-lock mr-1"></i> Confirm & Earn')}),a==null||a.addEventListener("click",am)}async function am(e){const t=e.currentTarget,n=t.dataset.submissionId;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-2"></i> Verifying...';try{await Od(n),x("Success! Points added.","success"),we(),await en(),$e()}catch{x("Verification failed.","error"),t.disabled=!1,t.innerHTML="Try Again"}}async function sm(e){const t=e.target.closest(".action-btn");if(!t)return;const n=t.dataset.action,a=t.dataset.id;if(n==="confirm"){const s=A.userSubmissions.find(r=>r.submissionId===a);s&&oc(s)}else if(n==="delete"){if(!confirm("Remove this submission?"))return;try{await Si(a),x("Removed.","info"),await en(),$e()}catch(s){x(s.message,"error")}}}async function rm(e){const t=e.target.closest("#submit-content-btn");if(!t)return;const n=document.getElementById("content-url-input"),a=n==null?void 0:n.value.trim();if(!a||!a.startsWith("http"))return x("Enter a valid URL.","warning");const s=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-circle-notch fa-spin"></i>';try{await Md(a),x("📋 Submitted! Your post is now under security audit.","info"),n.value="",await en(),A.activeTab="history",$e()}catch(r){x(r.message,"error")}finally{t.disabled=!1,t.innerHTML=s}}async function im(e){const t=e.target.closest(".task-card");if(!t)return;const n=t.dataset.id,a=t.dataset.url;a&&window.open(a,"_blank");const s=A.dailyTasks.find(r=>r.id===n);if(!(!s||!s.eligible))try{await _d(s,A.user.pointsMultiplier),x(`Task completed! +${s.points} pts`,"success"),await en(),$e()}catch(r){r.message.includes("Cooldown")||x(r.message,"error")}}function om(){const e=Date.now(),t=sc*60*60*1e3,n=A.userSubmissions.filter(a=>["pending","auditing"].includes(a.status)&&a.submittedAt&&e-a.submittedAt.getTime()>=t);n.length>0&&(A.activeTab="history",$e(),setTimeout(()=>{oc(n[0])},500))}const lm={async render(e){const t=document.getElementById("airdrop");if(!t)return;W0();const n=U0();(t.innerHTML.trim()===""||e)&&(t.innerHTML=`
...
(This will reset their rejection count to 0)`;if(!window.confirm(s))return;const r=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await $i(n,a),x(`User ${a?"BANNED":"UNBANNED"}.`,"success");const i=C.allUsers.findIndex(o=>o.id===n);i>-1&&(C.allUsers[i].isBanned=a,C.allUsers[i].hasPendingAppeal=!1,a===!1&&(C.allUsers[i].rejectedCount=0)),dt()}catch(i){x(`Failed: ${i.message}`,"error"),t.disabled=!1,t.innerHTML=r}},gm=async e=>{const t=e.target.closest(".resolve-appeal-btn");if(!t||t.disabled)return;const n=t.dataset.userId,s=t.dataset.action==="approve";if(!n)return;const r=s?"Are you sure you want to APPROVE this appeal and UNBAN the user?":"Are you sure you want to DENY this appeal? The user will remain banned.";if(!window.confirm(r))return;const i=t.closest("td").querySelectorAll("button"),o=new Map;i.forEach(l=>{o.set(l,l.innerHTML),l.disabled=!0,l.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>'});try{s&&await $i(n,!1),x(`Appeal ${s?"APPROVED":"DENIED"}.`,"success");const l=C.allUsers.findIndex(d=>d.id===n);l>-1&&(C.allUsers[l].hasPendingAppeal=!1,s&&(C.allUsers[l].isBanned=!1,C.allUsers[l].rejectedCount=0)),dt()}catch(l){x(`Failed: ${l.message}`,"error"),i.forEach(d=>{d.disabled=!1,d.innerHTML=o.get(d)})}},xm=async e=>{const t=e.target.closest(".re-approve-btn");if(!t||t.disabled)return;const n=t.dataset.submissionId,a=t.dataset.userId;if(!n||!a)return;const s=t.closest("tr");s&&(s.style.opacity="0.5"),t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await Ri(a,n,"approved"),x("Submission re-approved!","success"),C.selectedUserSubmissions=C.selectedUserSubmissions.filter(i=>i.submissionId!==n),s&&s.remove();const r=C.allUsers.findIndex(i=>i.id===a);if(r>-1){const i=C.allUsers[r];i.rejectedCount=Math.max(0,(i.rejectedCount||0)-1),dt()}if(C.selectedUserSubmissions.length===0){const i=document.querySelector("#admin-user-modal .p-6");i&&(i.innerHTML='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>')}}catch(r){x(`Failed to re-approve: ${r.message}`,"error"),s&&(s.style.opacity="1"),t.disabled=!1,t.innerHTML='<i class="fa-solid fa-check"></i> Re-Approve'}},hm=async e=>{const t=e.target.closest(".view-rejected-btn");if(!t||t.disabled)return;const n=t.dataset.userId,a=t.dataset.wallet;if(n){C.selectedWallet=a,C.isSubmissionsModalOpen=!0,Va(!0,[]);try{const s=await Yd(n,"rejected");C.selectedUserSubmissions=s,Va(!1,s)}catch(s){x(`Error fetching user submissions: ${s.message}`,"error"),Va(!1,[],!0)}}},vm=()=>{C.isSubmissionsModalOpen=!1,C.selectedUserSubmissions=[],C.selectedWallet=null;const e=document.getElementById("admin-user-modal");e&&e.remove(),document.body.style.overflow="auto"},wm=e=>{const t=e.target.closest(".user-profile-link");if(!t)return;e.preventDefault();const n=t.dataset.userId;if(!n)return;const a=C.allUsers.find(s=>s.id===n);if(!a){x("Error: Could not find user data.","error");return}Im(a)},ym=()=>{const e=document.getElementById("admin-user-profile-modal");e&&e.remove(),document.body.style.overflow="auto"},km=async e=>{e.preventDefault();const t=e.target;let n,a;try{if(n=new Date(t.startDate.value+"T00:00:00Z"),a=new Date(t.endDate.value+"T23:59:59Z"),isNaN(n.getTime())||isNaN(a.getTime()))throw new Error("Invalid date format.");if(n>=a)throw new Error("Start Date must be before End Date.")}catch(l){x(l.message,"error");return}const s={title:t.title.value.trim(),url:t.url.value.trim(),description:t.description.value.trim(),points:parseInt(t.points.value,10),cooldownHours:parseInt(t.cooldown.value,10),startDate:n,endDate:a};if(!s.title||!s.description){x("Please fill in Title and Description.","error");return}if(s.points<=0||s.cooldownHours<=0){x("Points and Cooldown must be positive numbers.","error");return}if(s.url&&!s.url.startsWith("http")){x("URL must start with http:// or https://","error");return}C.editingTask&&C.editingTask.id&&(s.id=C.editingTask.id);const r=t.querySelector('button[type="submit"]'),i=r.innerHTML;r.disabled=!0;const o=document.createElement("span");o.classList.add("inline-block"),r.innerHTML="",r.appendChild(o);try{await jd(s),x(`Task ${s.id?"updated":"created"} successfully!`,"success"),t.reset(),C.editingTask=null,gn()}catch(l){x(`Failed to save task: ${l.message}`,"error"),console.error(l),r.disabled=!1,r.innerHTML=i}},Em=async e=>{e.preventDefault();const t=e.target,n={YouTube:parseInt(t.youtubePoints.value,10),"YouTube Shorts":parseInt(t.youtubeShortsPoints.value,10),Instagram:parseInt(t.instagramPoints.value,10),"X/Twitter":parseInt(t.xTwitterPoints.value,10),Facebook:parseInt(t.facebookPoints.value,10),Telegram:parseInt(t.telegramPoints.value,10),TikTok:parseInt(t.tiktokPoints.value,10),Reddit:parseInt(t.redditPoints.value,10),LinkedIn:parseInt(t.linkedinPoints.value,10),Other:parseInt(t.otherPoints.value,10)};if(Object.values(n).some(i=>isNaN(i)||i<0)){x("All points must be positive numbers (or 0).","error");return}const a=t.querySelector('button[type="submit"]'),s=a.innerHTML;a.disabled=!0;const r=document.createElement("span");r.classList.add("inline-block"),a.innerHTML="",a.appendChild(r);try{await Hd(n),x("UGC Base Points updated successfully!","success"),C.ugcBasePoints=n}catch(i){x(`Failed to update points: ${i.message}`,"error"),console.error(i)}finally{document.body.contains(a)&&(a.disabled=!1,a.innerHTML=s)}},Tm=e=>{const t=C.dailyTasks.find(n=>n.id===e);t&&(C.editingTask=t,Bn())},Cm=async e=>{if(window.confirm("Are you sure you want to delete this task permanently?"))try{await Wd(e),x("Task deleted.","success"),C.editingTask=null,gn()}catch(t){x(`Failed to delete task: ${t.message}`,"error"),console.error(t)}};function Va(e,t,n=!1){var i,o;const a=document.getElementById("admin-user-modal");a&&a.remove(),document.body.style.overflow="hidden";let s="";e?s='<div class="p-8"></div>':n?s='<p class="text-red-400 text-center p-8">Failed to load submissions.</p>':t.length===0?s='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>':s=`
    ...
    `;const T=document.getElementById("admin-users-pagination");T&&b>1&&Ps(T,C.usersPage,b,Pm),(N=document.getElementById("admin-users-tbody"))==null||N.addEventListener("click",E=>{E.target.closest(".user-profile-link")&&wm(E),E.target.closest(".ban-user-btn")&&bm(E),E.target.closest(".view-rejected-btn")&&hm(E),E.target.closest(".resolve-appeal-btn")&&gm(E)}),(z=document.getElementById("user-filters-nav"))==null||z.addEventListener("click",Am);const I=document.getElementById("user-search-input");if(I){let E;I.addEventListener("keyup",F=>{clearTimeout(E),E=setTimeout(()=>Bm(F),300)})}},oi=()=>{var a;const e=document.getElementById("manage-ugc-points-content");if(!e)return;const t=C.ugcBasePoints;if(!t)return;const n={YouTube:5e3,"YouTube Shorts":2500,Instagram:3e3,"X/Twitter":1500,Facebook:2e3,Telegram:1e3,TikTok:3500,Reddit:1800,LinkedIn:2200,Other:1e3};e.innerHTML=`
    ...
    `;const b=document.getElementById("admin-tasks-pagination");b&&l>1&&Ps(b,C.tasksPage,l,zm),(p=document.getElementById("taskForm"))==null||p.addEventListener("submit",km),(g=document.getElementById("cancelEditBtn"))==null||g.addEventListener("click",()=>{C.editingTask=null,Bn()}),(y=document.getElementById("existing-tasks-list"))==null||y.addEventListener("click",k=>{const T=k.target.closest("button[data-id]");if(!T)return;const I=T.dataset.id;T.dataset.action==="edit"&&Tm(I),T.dataset.action==="delete"&&Cm(I)})},ca=()=>{var f;const e=document.getElementById("submissions-content");if(!e)return;if(!C.allSubmissions||C.allSubmissions.length===0){const m=document.createElement("div");e.innerHTML=m.innerHTML;return}const t=C.submissionsPage,n=C.submissionsPerPage,a=[...C.allSubmissions].sort((m,b)=>{var p,g;return(((p=b.submittedAt)==null?void 0:p.getTime())||0)-(((g=m.submittedAt)==null?void 0:g.getTime())||0)}),s=a.length,r=Math.ceil(s/n),i=(t-1)*n,o=t*n,d=a.slice(i,o).map(m=>{var b,p;return`
        <tr class="border-b border-border-color hover:bg-zinc-800/50">
    ...
    `;const u=document.getElementById("admin-submissions-pagination");u&&r>1&&Ps(u,C.submissionsPage,r,Nm),(f=document.getElementById("admin-submissions-tbody"))==null||f.addEventListener("click",fm)},da=()=>{var r,i;const e=document.getElementById("platform-usage-content");if(!e)return;const t=C.platformUsageConfig||Ia;let n=0;Object.values(t).forEach(o=>{o.enabled!==!1&&(n+=(o.points||0)*(o.maxCount||1))});const a=Object.entries(t).map(([o,l])=>`
...
`)[0].trim())||"Notarized Document";const d=rr("",l),u=Xm(r.timestamp);return`
                <div class="cert-card">
    ...
    `,document.head.appendChild(e)}function xs(){const e=document.getElementById("rental");if(!e)return;df();const t=c.rentalListings||[],n=t.filter(r=>c.isConnected&&Pn(r.owner,c.userAddress)),a=Math.floor(Date.now()/1e3),s=(c.myRentals||[]).filter(r=>Pn(r.tenant,c.userAddress)&&Number(r.endTime)>a);e.innerHTML=`
    ...
    `:`
        ...
        `}function hn(){const e=document.getElementById("tab-content");if(e){switch($.activeTab){case"marketplace":e.innerHTML=pf();break;case"my-listings":e.innerHTML=mf();break;case"my-rentals":e.innerHTML=ff();break}document.getElementById("header-stats").innerHTML=uf(),$.activeTab==="my-rentals"&&Cf()}}function pf(){const e=c.rentalListings||[],t=Math.floor(Date.now()/1e3);let n=e.filter(a=>!(a.isRented||a.rentalEndTime&&Number(a.rentalEndTime)>t||$.filterTier!=="ALL"&&Fn(a.boostBips).name!==$.filterTier));return n.sort((a,s)=>{const r=BigInt(a.promotionFee||"0")||$.promotions.get(Re(a.tokenId))||0n,i=BigInt(s.promotionFee||"0")||$.promotions.get(Re(s.tokenId))||0n,o=mi(a),l=mi(s);if(!o&&l)return-1;if(o&&!l||i>r)return 1;if(i<r)return-1;if($.sortBy==="featured"){const f=fi(a),m=fi(s);if(m!==f)return m-f}const d=BigInt(a.pricePerHour||0),u=BigInt(s.pricePerHour||0);return $.sortBy==="price-low"?d<u?-1:1:$.sortBy==="price-high"?d>u?-1:1:(s.boostBips||0)-(a.boostBips||0)}),`
        <div>
            <!-- Filters & Sort -->
    ...
    `}function mc(e,t){const n=Fn(e.boostBips),a=Ba(n.name),s=_(BigInt(e.pricePerHour||0)).toFixed(2),r=Re(e.tokenId),i=c.isConnected&&Pn(e.owner,c.userAddress),o=pc(e),l=Math.floor(Date.now()/1e3),d=o&&o>l,u=d?cf(o):null,f=BigInt(e.promotionFee||"0")||$.promotions.get(r)||0n,m=f>0n,b=m?parseFloat(Aa.formatEther(f)).toFixed(3):"0",p=lt(e.boostBips||0);return`
    ...
    `}function mf(){if(!c.isConnected)return fc("View your listings");const e=c.rentalListings||[],t=e.filter(r=>Pn(r.owner,c.userAddress)),n=new Set(e.map(r=>Re(r.tokenId))),a=(c.myBoosters||[]).filter(r=>!n.has(Re(r.tokenId)));return`
        <div>
            <!-- Earnings Card -->
    ...
    `}function gf(){const e=c.rentalListings||[],t=new Set(e.map(a=>Re(a.tokenId)));return`
    ...
    `}function vf(){document.addEventListener("click",e=>{const t=e.target.closest(".rental-tab");if(t){$.activeTab=t.dataset.tab,document.querySelectorAll(".rental-tab").forEach(i=>i.classList.remove("active")),t.classList.add("active"),hn();return}const n=e.target.closest(".filter-chip");if(n){$.filterTier=n.dataset.filter,hn();return}if(e.target.closest("#btn-open-list")){bc();return}const a=e.target.closest(".rent-btn");if(a&&!a.disabled){wf(a.dataset.id);return}const s=e.target.closest(".withdraw-btn");if(s){vc(s);return}const r=e.target.closest(".promote-btn");if(r){yf(r.dataset.id);return}}),document.addEventListener("change",e=>{e.target.id==="sort-select"&&($.sortBy=e.target.value,hn())})}function bc(){document.getElementById("modal-list").classList.add("active")}function gc(){document.getElementById("modal-list").classList.remove("active")}function wf(e){const t=(c.rentalListings||[]).find(i=>lf(i.tokenId,e));if(!t)return;$.selectedListing=t;const n=Fn(t.boostBips),a=Ba(n.name),s=_(BigInt(t.pricePerHour||0)),r=lt(t.boostBips||0);document.getElementById("rent-modal-content").innerHTML=`
...
`;document.head.appendChild(yc);const Af={render:async e=>{if(!e)return;const t=document.getElementById("creditcard");t&&(t.innerHTML=`
    ...
    `,document.head.appendChild(e)}const ke=e=>{try{const t=Number(e)/1e18;return t<1e-4?"0":t<1?t.toFixed(4):t<1e3?t.toFixed(2):t.toLocaleString("en-US",{maximumFractionDigits:2})}catch{return"0"}},Cc=e=>e?`${e.slice(0,6)}...${e.slice(-4)}`:"",Mn=(e,t)=>{const n=Number(e||0),a=Number(t||1);return Math.min(100,Math.round(n/a*100))},Ic=e=>{const t=Math.floor(Date.now()/1e3),n=Number(e)-t;if(n<=0)return{text:"Ended",color:"#ef4444"};const a=Math.floor(n/86400);return a>0?{text:`${a}d left`,color:"#10b981"}:{text:`${Math.floor(n/3600)}h left`,color:"#f59e0b"}},Na=e=>(e==null?void 0:e.imageUrl)||pa[e==null?void 0:e.category]||pa.default,Ac=e=>`${window.location.origin}${window.location.pathname}#charity/${e}`,Bc=()=>{const t=window.location.hash.match(/#charity\/(\d+)/);return t?t[1]:null},$f=e=>{window.location.hash=`charity/${e}`},_f=()=>{window.location.hash.startsWith("#charity/")&&(window.location.hash="charity")},Pc=e=>{const t=cr(e.status),n=Number(e.deadline)<=Math.floor(Date.now()/1e3);return(t===0||t===1)&&n&&!e.withdrawn&&BigInt(e.raisedAmount||0)>0n};async function Lt(){B.isLoading=!0;try{const[e,t]=await Promise.all([fetch(Pa.getCampaigns).then(s=>s.json()).catch(()=>({campaigns:[]})),Ff()]),n=(e==null?void 0:e.campaigns)||[],a=c==null?void 0:c.publicProvider;if(a){const s=new tn.Contract(w.charityPool,ur,a),r=await s.campaignCounter(),i=Number(r),o=await Promise.all(Array.from({length:i},(l,d)=>d+1).map(async l=>{try{const d=await s.campaigns(l),u=n.find(f=>String(f.id)===String(l));return{id:String(l),creator:d[0],title:(u==null?void 0:u.title)||d[1]||`Campaign #${l}`,description:(u==null?void 0:u.description)||d[2]||"",goalAmount:BigInt(d[3].toString()),raisedAmount:BigInt(d[4].toString()),donationCount:Number(d[5]),deadline:Number(d[6]),createdAt:Number(d[7]),status:Number(d[8]),category:(u==null?void 0:u.category)||"humanitarian",imageUrl:(u==null?void 0:u.imageUrl)||null}}catch{return null}}));B.campaigns=o.filter(Boolean)}B.stats=t}catch(e){console.error("Load data:",e)}finally{B.isLoading=!1}}async function Ff(){try{const e=c==null?void 0:c.publicProvider;if(!e)return null;const t=new tn.Contract(w.charityPool,ur,e),[n,a,s,r]=await Promise.all([t.totalRaisedAllTime(),t.totalBurnedAllTime(),t.totalCampaignsCreated(),t.totalSuccessfulWithdrawals()]);return{raised:n,burned:a,created:Number(s),withdrawals:Number(r)}}catch{return null}}function Mf(e,t="create"){var s;const n=(s=e.target.files)==null?void 0:s[0];if(!n)return;if(!Sf.includes(n.type)){x("Please select a valid image (JPG, PNG, GIF, WebP)","error");return}if(n.size>Lf){x("Image must be less than 5MB","error");return}B.pendingImageFile=n;const a=new FileReader;a.onload=r=>{const i=t==="edit"?"edit-image-preview":"create-image-preview",o=document.getElementById(t==="edit"?"edit-image-upload":"create-image-upload"),l=document.getElementById(i);l&&(l.innerHTML=`
        ...
        <div class="cp-campaign-card" onclick="CharityPage.viewCampaign('${e.id}')">
            ...
            <div class="p-4">
                ...
                <p class="text-zinc-500 text-xs mb-3">by <a href="${Tc}${e.creator}" target="_blank" class="text-amber-500 hover:text-amber-400">${Cc(e.creator)}</a></p>
    ...
    `},gi=()=>{var a,s,r,i;const e=B.campaigns.filter(o=>dr(o)),t=e.filter(o=>o.category==="animal"),n=e.filter(o=>o.category==="humanitarian");return`
        <div class="charity-page">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4" id="cp-grid">
                ${e.length?e.filter(o=>!B.selectedCategory||o.category===B.selectedCategory).sort((o,l)=>Number(l.createdAt||0)-Number(o.createdAt||0)).map(o=>Rc(o)).join(""):Sc("No active campaigns")}
            </div>
        </div>
    ...
    `;const t=Mn(e.raisedAmount,e.goalAmount),n=Ic(e.deadline),a=e.category||"humanitarian",s=dr(e),r=((o=e.creator)==null?void 0:o.toLowerCase())===((l=c==null?void 0:c.userAddress)==null?void 0:l.toLowerCase()),i=Pc(e);return`
        <div class="charity-page">
            ${$c()}
            ${_c()}
                ...
                <div class="cp-detail-content">
                    ...
                    <div class="cp-card-base p-6">
                        ...
                        <p class="text-sm text-zinc-500 mb-4">
                            Created by <a href="${Tc}${e.creator}" target="_blank" class="text-amber-500 hover:text-amber-400">${Cc(e.creator)}</a>
                        </p>
...
`;let s;e==="twitter"?s=`https://twitter.com/intent/tweet?text=${encodeURIComponent(a)}&url=${encodeURIComponent(n)}`:e==="telegram"?s=`https://t.me/share/url?url=${encodeURIComponent(n)}&text=${encodeURIComponent(a)}`:e==="whatsapp"&&(s=`https://wa.me/?text=${encodeURIComponent(a+n)}`),s&&window.open(s,"_blank","width=600,height=400")}function nb(){const e=B.currentCampaign;e&&navigator.clipboard.writeText(Ac(e.id)).then(()=>x("Link copied!","success")).catch(()=>x("Copy failed","error"))}function Fc(){_f(),B.currentCampaign=null,B.currentView="main",ut()}function ab(e){rt("my"),rt("donate"),rt("edit"),$f(e),St(e)}function sb(e){B.selectedCategory=B.selectedCategory===e?null:e,pr()}function rb(){B.selectedCategory=null,pr()}function pr(){const e=document.getElementById("cp-grid");if(!e)return;let t=B.campaigns.filter(n=>dr(n));B.selectedCategory&&(t=t.filter(n=>n.category===B.selectedCategory)),t.sort((n,a)=>Number(a.createdAt||0)-Number(n.createdAt||0)),e.innerHTML=t.length?t.map(n=>Rc(n)).join(""):Sc("No campaigns")}async function St(e){B.currentView="detail",B.isLoading=!0;const t=hs();t&&(t.innerHTML=Of());try{let n=B.campaigns.find(a=>a.id===e||a.id===String(e));if(!n){const a=c==null?void 0:c.publicProvider;if(a){const r=await new tn.Contract(w.charityPool,ur,a).campaigns(e);n={id:String(e),creator:r[0],title:r[1],description:r[2],goalAmount:BigInt(r[3].toString()),raisedAmount:BigInt(r[4].toString()),donationCount:Number(r[5]),deadline:Number(r[6]),createdAt:Number(r[7]),status:Number(r[8]),category:"humanitarian",imageUrl:null}}}B.currentCampaign=n,t&&(t.innerHTML=xi(n))}catch{t&&(t.innerHTML=xi(null))}finally{B.isLoading=!1}}function hs(){let e=document.getElementById("charity-container");if(e)return e;const t=document.getElementById("charity");return t?(e=document.createElement("div"),e.id="charity-container",t.innerHTML="",t.appendChild(e),e):null}function ut(){Rf();const e=hs();if(!e)return;const t=Bc();t?St(t):(B.currentView="main",B.currentCampaign=null,e.innerHTML=gi(),Lt().then(()=>{if(B.currentView==="main"){const n=hs();n&&(n.innerHTML=gi())}}))}async function ib(){B.campaigns=[],B.stats=null,B.currentView==="detail"&&B.currentCampaign?await St(B.currentCampaign.id):ut()}window.addEventListener("hashchange",()=>{var e;if(window.location.hash.startsWith("#charity")){const t=Bc();t?((e=B.currentCampaign)==null?void 0:e.id)!==t&&St(t):B.currentView!=="main"&&Fc()}});const Mc={render(e){e&&ut()},update(){B.currentView==="main"&&pr()},refresh:ib,openModal:Dn,closeModal:rt,openCreate:jf,openDonate:Wf,openMyCampaigns:Gf,openEdit:Kf,create:Vf,donate:Xf,donateDetail:Jf,cancel:Zf,withdraw:Qf,saveEdit:eb,selCatOpt:Yf,setAmt:qf,goBack:Fc,viewCampaign:ab,selectCat:sb,clearCat:rb,share:tb,copyLink:nb,handleImageSelect:Mf,removeImage:Nc,switchImageTab:Df};window.CharityPage=Mc;const he=window.ethers,ob="https://sepolia.arbiscan.io/address/",lb=cd;function mr(){return w.backchat||w.Backchat||null}function nn(){return w.operator||w.treasury||null}const P={activeTab:"feed",view:"feed",posts:[],trendingPosts:[],userProfile:null,profiles:new Map,following:new Set,selectedPost:null,selectedProfile:null,fees:{post:0n,reply:0n,like:0n,follow:0n,repost:0n,superLikeMin:0n,boostMin:0n,badge:0n},pendingEth:0n,hasBadge:!1,isBoosted:!1,boostExpiry:0,badgeExpiry:0,referralStats:null,referredBy:null,isLoading:!1,isPosting:!1,contractAvailable:!0,error:null};function cb(){if(document.getElementById("backchat-styles-v70"))return;const e=document.getElementById("backchat-styles-v69");e&&e.remove();const t=document.createElement("style");t.id="backchat-styles-v70",t.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `}function ze(){const e=document.getElementById("backchat-content");if(!e)return;let t="";switch(P.activeTab){case"feed":t=vb()+wb();break;case"trending":t=yb();break;case"profile":t=kb();break}e.innerHTML=t}function Tb(){return`
        <!-- Super Like Modal -->
