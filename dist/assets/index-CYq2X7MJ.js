import{defaultConfig as Gc,createWeb3Modal as Kc}from"https://esm.sh/@web3modal/ethers@5.1.11?bundle";import{initializeApp as Yc}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-app.js";import{getAuth as Vc,onAuthStateChanged as qc,signInAnonymously as Xc}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-auth.js";import{getFirestore as Jc,collection as Xe,query as Tt,where as Zn,orderBy as Yt,getDocs as ot,doc as te,getDoc as Ae,limit as Zc,serverTimestamp as it,writeBatch as fa,updateDoc as ba,increment as Me,setDoc as ga,Timestamp as wr,addDoc as Qc,deleteDoc as ed}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-firestore.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function n(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(s){if(s.ep)return;s.ep=!0;const r=n(s);fetch(s.href,r)}})();const Be={sidebar:document.getElementById("sidebar"),sidebarBackdrop:document.getElementById("sidebar-backdrop"),menuBtn:document.getElementById("menu-btn"),navLinks:document.getElementById("nav-links"),mainContentSections:document.querySelectorAll("main section"),connectButtonDesktop:document.getElementById("connectButtonDesktop"),connectButtonMobile:document.getElementById("connectButtonMobile"),mobileAppDisplay:document.getElementById("mobileAppDisplay"),desktopDisconnected:document.getElementById("desktopDisconnected"),desktopConnectedInfo:document.getElementById("desktopConnectedInfo"),desktopUserAddress:document.getElementById("desktopUserAddress"),desktopUserBalance:document.getElementById("desktopUserBalance"),modalContainer:document.getElementById("modal-container"),toastContainer:document.getElementById("toast-container"),dashboard:document.getElementById("dashboard"),earn:document.getElementById("mine"),store:document.getElementById("store"),rental:document.getElementById("rental"),rewards:document.getElementById("rewards"),actions:document.getElementById("actions"),presale:document.getElementById("presale"),faucet:document.getElementById("faucet"),airdrop:document.getElementById("airdrop"),dao:document.getElementById("dao"),about:document.getElementById("about"),admin:document.getElementById("admin"),tokenomics:document.getElementById("tokenomics"),notary:document.getElementById("notary"),statTotalSupply:document.getElementById("statTotalSupply"),statValidators:document.getElementById("statValidators"),statTotalPStake:document.getElementById("statTotalPStake"),statScarcity:document.getElementById("statScarcity"),statLockedPercentage:document.getElementById("statLockedPercentage"),statUserBalance:document.getElementById("statUserBalance"),statUserPStake:document.getElementById("statUserPStake"),statUserRewards:document.getElementById("statUserRewards")},td={provider:null,publicProvider:null,web3Provider:null,signer:null,userAddress:null,isConnected:!1,bkcTokenContract:null,delegationManagerContract:null,rewardBoosterContract:null,nftLiquidityPoolContract:null,actionsManagerContract:null,fortunePoolContract:null,faucetContract:null,decentralizedNotaryContract:null,ecosystemManagerContract:null,publicSaleContract:null,rentalManagerContract:null,bkcTokenContractPublic:null,delegationManagerContractPublic:null,faucetContractPublic:null,fortunePoolContractPublic:null,rentalManagerContractPublic:null,ecosystemManagerContractPublic:null,actionsManagerContractPublic:null,currentUserBalance:0n,currentUserNativeBalance:0n,userTotalPStake:0n,userDelegations:[],myBoosters:[],activityHistory:[],totalNetworkPStake:0n,allValidatorsData:[],systemFees:{},systemPStakes:{},boosterDiscounts:{},notaryFee:void 0,notaryMinPStake:void 0},nd={set(e,t,n){return e[t]=n,["currentUserBalance","isConnected","userTotalPStake","totalNetworkPStake"].includes(t)&&window.updateUIState&&window.updateUIState(),!0}},c=new Proxy(td,nd);let yr=!1;const x=(e,t="info",n=null)=>{if(!Be.toastContainer)return;const a={success:{icon:"fa-check-circle",color:"bg-green-600",border:"border-green-400"},error:{icon:"fa-exclamation-triangle",color:"bg-red-600",border:"border-red-400"},info:{icon:"fa-info-circle",color:"bg-blue-600",border:"border-blue-400"},warning:{icon:"fa-exclamation-circle",color:"bg-yellow-600",border:"border-yellow-400"}},s=a[t]||a.info,r=document.createElement("div");r.className=`flex items-center w-full max-w-xs p-4 text-white rounded-lg shadow-lg transition-all duration-500 ease-out 
    ...
    `;if(n){const i=`https://sepolia.arbiscan.io/tx/${n}`;o+=`<a href="${i}" target="_blank" title="View on Arbiscan" class="ml-3 flex-shrink-0 text-white/80 hover:text-white transition-colors">
    ...
    `;Be.modalContainer.innerHTML=s,requestAnimationFrame(()=>{const i=document.getElementById("modal-backdrop");i&&i.classList.remove("opacity-0"),i&&i.classList.add("opacity-100")}),(r=document.getElementById("modal-backdrop"))==null||r.addEventListener("click",i=>{n&&i.target.id==="modal-backdrop"&&we()}),(o=document.getElementById("modal-content"))==null||o.querySelectorAll(".closeModalBtn").forEach(i=>{i.addEventListener("click",we)})};async function ad(e,t){if(!window.ethereum){x("MetaMask not detected","error");return}try{await window.ethereum.request({method:"wallet_watchAsset",params:{type:"ERC721",options:{address:"0xf2EA307686267dC674859da28C58CBb7a5866BCf",tokenId:e.toString()}}})?x(`${t} NFT #${e} added to wallet!`,"success"):x("NFT not added to wallet","info")}catch(n){console.error("Error adding NFT to wallet:",n),x("Failed to add NFT to wallet","error")}}function sd(){const e=window.location.origin,t=encodeURIComponent("Check out Backcoin - The Unstoppable DeFi Protocol on Arbitrum! Build your own business. Be Your Own CEO. 🚀 #Backcoin #DeFi #Arbitrum #BeYourOwnCEO"),n=`
    ...
    `;vn(n,"max-w-md")}const kr=e=>{window.navigateTo?window.navigateTo(e):console.error("navigateTo function not found."),we()};function rd(){var s,r,o,i,l,d;if(yr)return;yr=!0;const e="https://t.me/BackCoinorg",t="https://github.com/backcoin-org/backchain-dapp";vn(`
    ...
    `,"max-w-sm",!1);const a=document.getElementById("modal-content");a&&((s=a.querySelector("#btnAirdrop"))==null||s.addEventListener("click",()=>{kr("airdrop")}),(r=a.querySelector("#btnExplore"))==null||r.addEventListener("click",()=>{we()}),(o=a.querySelector("#btnCEO"))==null||o.addEventListener("click",()=>{window.open(t+"/blob/main/docs/BE_YOUR_OWN_CEO.md","_blank")}),(i=a.querySelector("#btnDocs"))==null||i.addEventListener("click",()=>{window.open(t,"_blank")}),(l=a.querySelector("#btnSocials"))==null||l.addEventListener("click",()=>{kr("socials")}),(d=a.querySelector("#btnTelegram"))==null||d.addEventListener("click",()=>{window.open(e,"_blank")}))}const od=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1";console.log(`Environment: ${od?"DEVELOPMENT":"PRODUCTION"}`);const vs="ZWla0YY4A0Hw7e_rwyOXB",ye={chainId:"0x66eee",chainIdDecimal:421614,chainName:"Arbitrum Sepolia",nativeCurrency:{name:"Ethereum",symbol:"ETH",decimals:18},blockExplorerUrls:["https://sepolia.arbiscan.io"],rpcUrls:[`https://arb-sepolia.g.alchemy.com/v2/${vs}`,"https://arbitrum-sepolia.blockpi.network/v1/rpc/public","https://arbitrum-sepolia-rpc.publicnode.com"]},gt=[{name:"Alchemy",url:`https://arb-sepolia.g.alchemy.com/v2/${vs}`,priority:1,isPublic:!1,corsCompatible:!0},{name:"BlockPI",url:"https://arbitrum-sepolia.blockpi.network/v1/rpc/public",priority:2,isPublic:!0,corsCompatible:!0},{name:"PublicNode",url:"https://arbitrum-sepolia-rpc.publicnode.com",priority:3,isPublic:!0,corsCompatible:!0},{name:"Arbitrum Official",url:"https://sepolia-rollup.arbitrum.io/rpc",priority:4,isPublic:!0,corsCompatible:!1}].filter(e=>e.url!==null),Eo=`https://arb-sepolia.g.alchemy.com/v2/${vs}`;let Fe=0,wn=new Map;function yn(){var e;return((e=gt[Fe])==null?void 0:e.url)||Eo}function To(){const e=Fe;do{Fe=(Fe+1)%gt.length;const n=gt[Fe];if(!n.corsCompatible){console.warn(`⏭️ Skipping ${n.name} (CORS incompatible)`);continue}if(Fe===e)return console.warn("⚠️ All RPCs have been tried. Resetting to primary."),Fe=0,gt[0].url}while(wn.get(gt[Fe].url)==="unhealthy");const t=gt[Fe];return console.log(`🔄 Switched to RPC: ${t.name}`),t.url}function id(e){wn.set(e,"unhealthy"),console.warn(`❌ RPC marked unhealthy: ${e}`),setTimeout(()=>{wn.delete(e),console.log(`♻️ RPC health reset: ${e}`)},6e4)}function ld(e){wn.set(e,"healthy")}function cd(){Fe=0,wn.clear(),console.log(`✅ Reset to primary RPC: ${gt[0].name}`)}const dd="https://white-defensive-eel-240.mypinata.cloud/ipfs/",w={},R={bkcToken:null,ecosystemManager:null,delegationManager:null,rewardBoosterNFT:null,rentalManager:null,nftLiquidityPoolFactory:null,fortunePool:null,fortunePoolV2:null,backchainRandomness:null,publicSale:null,decentralizedNotary:null,faucet:null,miningManager:null,charityPool:null,backchat:null,operator:null};async function ud(){try{const e=await fetch(`./deployment-addresses.json?t=${Date.now()}`);if(!e.ok)throw new Error(`Failed to fetch deployment-addresses.json: ${e.status}`);const t=await e.json(),a=["bkcToken","delegationManager","ecosystemManager","miningManager"].filter(s=>!t[s]);if(a.length>0)throw new Error(`Missing required addresses: ${a.join(", ")}`);return Object.assign(w,t),w.fortunePoolV2=t.fortunePoolV2||t.fortunePool,w.fortunePool=t.fortunePool,w.actionsManager=t.fortunePool,w.rentalManager=t.rentalManager||t.RentalManager||t.rental_manager||null,w.decentralizedNotary=t.decentralizedNotary||t.notary||t.Notary||null,w.bkcDexPoolAddress=t.bkcDexPoolAddress||"#",w.backchainRandomness=t.backchainRandomness||null,w.charityPool=t.charityPool||t.CharityPool||null,w.backchat=t.backchat||t.Backchat||null,w.operator=t.operator||t.treasuryWallet||null,Object.assign(R,t),console.log("✅ Contract addresses loaded"),console.log("   FortunePool V2:",w.fortunePoolV2),console.log("   CharityPool:",w.charityPool),console.log("   Backchat:",w.backchat),console.log("   Operator:",w.operator),!0}catch(e){return console.error("❌ Failed to load contract addresses:",e),!1}}const ge=[{name:"Diamond",boostBips:5e3,burnRate:0,keepRate:100,color:"text-cyan-400",emoji:"💎",borderColor:"border-cyan-400/50",glowColor:"bg-cyan-500/10",bgGradient:"from-cyan-500/20 to-blue-500/20"},{name:"Gold",boostBips:4e3,burnRate:10,keepRate:90,color:"text-amber-400",emoji:"🥇",borderColor:"border-amber-400/50",glowColor:"bg-amber-500/10",bgGradient:"from-amber-500/20 to-yellow-500/20"},{name:"Silver",boostBips:2500,burnRate:25,keepRate:75,color:"text-gray-300",emoji:"🥈",borderColor:"border-gray-400/50",glowColor:"bg-gray-500/10",bgGradient:"from-gray-400/20 to-zinc-500/20"},{name:"Bronze",boostBips:1e3,burnRate:40,keepRate:60,color:"text-yellow-600",emoji:"🥉",borderColor:"border-yellow-600/50",glowColor:"bg-yellow-600/10",bgGradient:"from-yellow-600/20 to-orange-600/20"}];function pd(e){const t=[...ge].sort((n,a)=>a.boostBips-n.boostBips);for(const n of t)if(e>=n.boostBips)return n;return null}function md(e){return e>=5e3?0:e>=4e3?10:e>=2500?25:e>=1e3?40:50}function lt(e){return 100-md(e)}const ws=["function name() view returns (string)","function symbol() view returns (string)","function decimals() view returns (uint8)","function totalSupply() view returns (uint256)","function balanceOf(address owner) view returns (uint256)","function transfer(address to, uint256 amount) returns (bool)","function approve(address spender, uint256 amount) returns (bool)","function allowance(address owner, address spender) view returns (uint256)","function transferFrom(address from, address to, uint256 amount) returns (bool)","function MAX_SUPPLY() view returns (uint256)","function TGE_SUPPLY() view returns (uint256)","function remainingMintableSupply() view returns (uint256)","event Transfer(address indexed from, address indexed to, uint256 value)","event Approval(address indexed owner, address indexed spender, uint256 value)"],ys=["function totalNetworkPStake() view returns (uint256)","function userTotalPStake(address _user) view returns (uint256)","function pendingRewards(address _user) view returns (uint256)","function MIN_LOCK_DURATION() view returns (uint256)","function MAX_LOCK_DURATION() view returns (uint256)","function getDelegationsOf(address _user) view returns (tuple(uint256 amount, uint64 unlockTime, uint64 lockDuration)[])","function delegate(uint256 _amount, uint256 _lockDuration, address _operator) external","function unstake(uint256 _delegationIndex, address _operator) external","function forceUnstake(uint256 _delegationIndex, address _operator) external","function claimReward(address _operator) external payable","function claimEthFee() view returns (uint256)","function getUserBestBoost(address _user) view returns (uint256)","function getBurnRateForBoost(uint256 _boost) view returns (uint256)","function previewClaim(address _user) view returns (uint256 totalRewards, uint256 burnAmount, uint256 userReceives, uint256 burnRateBips, uint256 userBoost)","event Delegated(address indexed user, address indexed operator, uint256 amount, uint256 lockDuration, uint256 pStake)","event Unstaked(address indexed user, address indexed operator, uint256 amount, uint256 pStakeReduced)","event ForceUnstaked(address indexed user, address indexed operator, uint256 amount, uint256 penaltyAmount)","event RewardClaimed(address indexed user, address indexed operator, uint256 grossAmount, uint256 burnedAmount, uint256 userReceived, uint256 boostUsed)"],fd=["function balanceOf(address owner) view returns (uint256)","function tokenOfOwnerByIndex(address owner, uint256 index) view returns (uint256)","function ownerOf(uint256 tokenId) view returns (address)","function approve(address to, uint256 tokenId)","function setApprovalForAll(address operator, bool approved)","function safeTransferFrom(address from, address to, uint256 tokenId)","function boostBips(uint256 _tokenId) view returns (uint256)","function tokenURI(uint256 tokenId) view returns (string)","function totalSupply() view returns (uint256)","event Transfer(address indexed from, address indexed to, uint256 indexed tokenId)","event Approval(address indexed owner, address indexed approved, uint256 indexed tokenId)"],Nn=["function listNFT(uint256 _tokenId, uint256 _pricePerHour, uint256 _minHours, uint256 _maxHours) external","function updateListing(uint256 _tokenId, uint256 _newPricePerHour, uint256 _newMinHours, uint256 _newMaxHours) external","function withdrawNFT(uint256 _tokenId) external","function rentNFT(uint256 _tokenId, uint256 _hours) external","function getListing(uint256 _tokenId) view returns (tuple(address owner, uint256 pricePerHour, uint256 minHours, uint256 maxHours, bool isActive, uint256 totalEarnings, uint256 rentalCount))","function getRental(uint256 _tokenId) view returns (tuple(address tenant, uint256 startTime, uint256 endTime, uint256 paidAmount))","function isRented(uint256 _tokenId) view returns (bool)","function hasRentalRights(uint256 _tokenId, address _user) view returns (bool)","function getRemainingRentalTime(uint256 _tokenId) view returns (uint256)","function getAllListedTokenIds() view returns (uint256[])","function getListingCount() view returns (uint256)","function getRentalCost(uint256 _tokenId, uint256 _hours) view returns (uint256 totalCost, uint256 protocolFee, uint256 ownerPayout)","function getMarketplaceStats() view returns (uint256 activeListings, uint256 totalVol, uint256 totalFees, uint256 rentals)","event NFTListed(uint256 indexed tokenId, address indexed owner, uint256 pricePerHour, uint256 minHours, uint256 maxHours)","event NFTRented(uint256 indexed tokenId, address indexed tenant, address indexed owner, uint256 hours_, uint256 totalCost, uint256 protocolFee, uint256 ownerPayout, uint256 endTime)","event NFTWithdrawn(uint256 indexed tokenId, address indexed owner)","event RentalExpired(uint256 indexed tokenId, address indexed tenant)"],Co=["function buyNFT(uint256 _maxPrice, address _operator) external payable returns (uint256 tokenId)","function buySpecificNFT(uint256 _tokenId, uint256 _maxPrice, address _operator) external payable","function buyNFTWithSlippage(uint256 _maxPrice, address _operator) external payable returns (uint256 tokenId)","function sellNFT(uint256 _tokenId, uint256 _minPayout, address _operator) external payable","function getBuyPrice() view returns (uint256)","function getBuyPriceWithTax() view returns (uint256)","function getSellPrice() view returns (uint256)","function getSellPriceAfterTax() view returns (uint256)","function getTotalBuyCost() view returns (uint256 bkcCost, uint256 ethCost)","function getTotalSellInfo() view returns (uint256 bkcPayout, uint256 ethCost)","function getSpread() view returns (uint256 spread, uint256 spreadBips)","function getPoolInfo() view returns (uint256 bkcBalance, uint256 nftCount, uint256 k, bool initialized)","function getAvailableNFTs() view returns (uint256[])","function getNFTBalance() view returns (uint256)","function getBKCBalance() view returns (uint256)","function isNFTInPool(uint256 _tokenId) view returns (bool)","function boostBips() view returns (uint256)","function getTierName() view returns (string)","function buyEthFee() view returns (uint256)","function sellEthFee() view returns (uint256)","function getEthFeeConfig() view returns (uint256 buyFee, uint256 sellFee, uint256 totalCollected)","function totalETHCollected() view returns (uint256)","function getTradingStats() view returns (uint256 volume, uint256 taxes, uint256 buys, uint256 sells)","function totalVolume() view returns (uint256)","function totalTaxesCollected() view returns (uint256)","function totalBuys() view returns (uint256)","function totalSells() view returns (uint256)","event NFTPurchased(address indexed buyer, uint256 indexed tokenId, uint256 price, uint256 tax, uint256 newBkcBalance, uint256 newNftCount, address operator)","event NFTSold(address indexed seller, uint256 indexed tokenId, uint256 payout, uint256 tax, uint256 newBkcBalance, uint256 newNftCount, address operator)"],ks=["function participate(uint256 _wagerAmount, uint256[] calldata _guesses, bool _isCumulative) external payable","function oracleFee() view returns (uint256)","function gameFeeBips() view returns (uint256)","function getRequiredOracleFee(bool _isCumulative) view returns (uint256)","function activeTierCount() view returns (uint256)","function gameCounter() view returns (uint256)","function prizePoolBalance() view returns (uint256)","function getExpectedGuessCount(bool _isCumulative) view returns (uint256)","function isGameFulfilled(uint256 _gameId) view returns (bool)","function getGameResults(uint256 _gameId) view returns (uint256[])","function getJackpotTierId() view returns (uint256)","function getJackpotTier() view returns (uint256 tierId, uint128 maxRange, uint64 multiplierBips, bool active)","function getAllTiers() view returns (uint128[] ranges, uint64[] multipliers)","function prizeTiers(uint256 tierId) view returns (uint128 maxRange, uint64 multiplierBips, bool active)","function calculatePotentialWinnings(uint256 _wagerAmount, bool _isCumulative) view returns (uint256 maxPrize, uint256 netWager)","event GameRequested(uint256 indexed gameId, address indexed player, uint256 wagerAmount, uint256[] guesses, bool isCumulative, uint256 targetTier)","event GameFulfilled(uint256 indexed gameId, address indexed player, uint256 prizeWon, uint256[] rolls, uint256[] guesses, bool isCumulative)"],Es=["function commitPlay(bytes32 _commitmentHash, uint256 _wagerAmount, bool _isCumulative, address _operator) external payable","function revealPlay(uint256 _gameId, uint256[] calldata _guesses, bytes32 _userSecret) external returns (uint256 prizeWon)","function generateCommitmentHash(uint256[] calldata _guesses, bytes32 _userSecret) external pure returns (bytes32 hash)","function claimExpiredGame(uint256 _gameId) external","function getCommitmentStatus(uint256 _gameId) view returns (uint8 status, bool canReveal, bool isExpired, uint256 blocksUntilReveal, uint256 blocksUntilExpiry)","function getCommitment(uint256 _gameId) view returns (address player, uint64 commitBlock, bool isCumulative, uint8 status, uint256 wagerAmount, uint256 ethPaid)","function commitmentMeta(uint256 _gameId) view returns (bytes32 hash, address operator, uint96 tierNonce)","function revealDelay() view returns (uint256)","function revealWindow() view returns (uint256)","function serviceFee() view returns (uint256)","function getRequiredServiceFee(bool _isCumulative) view returns (uint256)","function gameFeeBips() view returns (uint256)","function activeTierCount() view returns (uint256)","function prizeTiers(uint256 tierId) view returns (uint128 maxRange, uint64 multiplierBips, bool active)","function getTier(uint256 _tierId) view returns (uint256 maxRange, uint256 multiplierBips, bool active)","function getAllTiers() view returns (uint128[] ranges, uint64[] multipliers)","function getExpectedGuessCount(bool _isCumulative) view returns (uint256)","function calculatePotentialWinnings(uint256 _wagerAmount, bool _isCumulative) view returns (uint256 maxPrize, uint256 netWager)","function gameCounter() view returns (uint256)","function prizePoolBalance() view returns (uint256)","function getGameResult(uint256 _gameId) view returns (address player, uint256 wagerAmount, uint256 prizeWon, uint256[] guesses, uint256[] rolls, bool isCumulative, uint8 matchCount, uint256 timestamp)","function getPlayerStats(address _player) view returns (uint256 gamesPlayed, uint256 totalWagered, uint256 totalWon, int256 netProfit)","function getPoolStats() view returns (uint256 poolBalance, uint256 gamesPlayed, uint256 wageredAllTime, uint256 paidOutAllTime, uint256 winsAllTime, uint256 ethCollected, uint256 bkcFees, uint256 expiredGames)","function totalWageredAllTime() view returns (uint256)","function totalPaidOutAllTime() view returns (uint256)","function totalWinsAllTime() view returns (uint256)","function totalETHCollected() view returns (uint256)","function totalBKCFees() view returns (uint256)","function totalExpiredGames() view returns (uint256)","event GameCommitted(uint256 indexed gameId, address indexed player, uint256 wagerAmount, bool isCumulative, address operator)","event GameRevealed(uint256 indexed gameId, address indexed player, uint256 wagerAmount, uint256 prizeWon, bool isCumulative, uint8 matchCount, address operator)","event GameDetails(uint256 indexed gameId, uint256[] guesses, uint256[] rolls, bool[] matches)","event JackpotWon(uint256 indexed gameId, address indexed player, uint256 prizeAmount, uint256 tier)","event GameExpired(uint256 indexed gameId, address indexed player, uint256 forfeitedAmount)"],bd=["function tiers(uint256 tierId) view returns (uint256 priceInWei, uint64 maxSupply, uint64 mintedCount, uint16 boostBips, bool isConfigured, bool isActive, string metadataFile, string name)","function buyNFT(uint256 _tierId) external payable","function buyMultipleNFTs(uint256 _tierId, uint256 _quantity) external payable","function getTierPrice(uint256 _tierId) view returns (uint256)","function getTierSupply(uint256 _tierId) view returns (uint64 maxSupply, uint64 mintedCount)","function isTierActive(uint256 _tierId) view returns (bool)","event NFTSold(address indexed buyer, uint256 indexed tierId, uint256 indexed tokenId, uint256 price)"],gd=["function balanceOf(address owner) view returns (uint256)","function tokenURI(uint256 tokenId) view returns (string)","function ownerOf(uint256 tokenId) view returns (address)","function tokenOfOwnerByIndex(address owner, uint256 index) view returns (uint256)","function totalSupply() view returns (uint256)","function getDocument(uint256 tokenId) view returns (tuple(string ipfsCid, string description, bytes32 contentHash, uint256 timestamp))","function documents(uint256 tokenId) view returns (string ipfsCid, string description, bytes32 contentHash, uint256 timestamp)","function bkcFee() view returns (uint256)","function ethFee() view returns (uint256)","function notarize(string _ipfsCid, string _description, bytes32 _contentHash, address _operator) external payable returns (uint256)","event DocumentNotarized(uint256 indexed tokenId, address indexed owner, address indexed operator, string ipfsCid, bytes32 contentHash, uint256 bkcFeePaid, uint256 ethFeePaid)"],Ts=["function canClaim(address _user) view returns (bool)","function getCooldownRemaining(address _user) view returns (uint256)","function getUserInfo(address _user) view returns (uint256 lastClaimTime, uint256 totalClaimed)","function getFaucetStatus() view returns (uint256 bkcBalance, uint256 ethBalance, bool isActive)","function COOLDOWN_PERIOD() view returns (uint256)","function TOKEN_AMOUNT() view returns (uint256)","function ETH_AMOUNT() view returns (uint256)","event TokensDistributed(address indexed recipient, uint256 tokenAmount, uint256 ethAmount, address indexed relayer)"],Cs=["function getServiceRequirements(bytes32 _serviceKey) view returns (uint256 fee, uint256 pStake)","function getFee(bytes32 _serviceKey) view returns (uint256)","function getBoosterDiscount(uint256 _boostBips) view returns (uint256)","function getMiningDistributionBips() view returns (uint256 stakingBips, uint256 minerBips, uint256 treasuryBips)","function getFeeDistributionBips() view returns (uint256 burnBips, uint256 treasuryBips, uint256 poolBips)","function getTreasuryAddress() view returns (address)","function getDelegationManagerAddress() view returns (address)","function getBKCTokenAddress() view returns (address)","function getBoosterAddress() view returns (address)","function getNFTLiquidityPoolFactoryAddress() view returns (address)","function getMiningManagerAddress() view returns (address)","function getFortunePoolAddress() view returns (address)","function getNotaryAddress() view returns (address)","function getRentalManagerAddress() view returns (address)","function getPublicSaleAddress() view returns (address)","function isInitialized() view returns (bool)","function owner() view returns (address)"],Io=["function createProfile(string username, string displayName, string bio, address operator) external payable","function updateProfile(string displayName, string bio) external","function createPost(string content, string mediaCID, address operator) external payable returns (uint256 postId)","function createReply(uint256 parentId, string content, string mediaCID, address operator, uint256 tipBkc) external payable returns (uint256 postId)","function createRepost(uint256 originalPostId, address operator, uint256 tipBkc) external payable returns (uint256 postId)","function like(uint256 postId, address operator, uint256 tipBkc) external payable","function superLike(uint256 postId, address operator, uint256 tipBkc) external payable","function follow(address toFollow, address operator, uint256 tipBkc) external payable","function unfollow(address toUnfollow) external","function boostProfile(address operator) external payable","function obtainBadge(address operator) external payable","function setReferrer(address _referrer) external","function getReferralStats(address referrer) external view returns (uint256 totalReferred, uint256 totalEarned)","function referredBy(address user) external view returns (address)","function referralCount(address referrer) external view returns (uint256)","function referralEarnings(address referrer) external view returns (uint256)","function withdraw() external","function calculateFee(uint256 gasEstimate) view returns (uint256)","function getCurrentFees() view returns (uint256 postFee, uint256 replyFee, uint256 likeFee, uint256 followFee, uint256 repostFee, uint256 superLikeMin, uint256 boostMin, uint256 badgeFee_)","function getUsernameFee(uint256 length) pure returns (uint256)","function postCounter() view returns (uint256)","function postAuthor(uint256 postId) view returns (address)","function pendingEth(address user) view returns (uint256)","function usernameOwner(bytes32 usernameHash) view returns (address)","function hasLiked(uint256 postId, address user) view returns (bool)","function boostExpiry(address user) view returns (uint256)","function badgeExpiry(address user) view returns (uint256)","function isProfileBoosted(address user) view returns (bool)","function hasTrustBadge(address user) view returns (bool)","function hasUserLiked(uint256 postId, address user) view returns (bool)","function getPendingBalance(address user) view returns (uint256)","function isUsernameAvailable(string username) view returns (bool)","function getUsernameOwner(string username) view returns (address)","function version() pure returns (string)","function bkcToken() view returns (address)","function ecosystemManager() view returns (address)","event ProfileCreated(address indexed user, bytes32 indexed usernameHash, string username, string displayName, string bio, uint256 ethPaid, address indexed operator)","event ProfileUpdated(address indexed user, string displayName, string bio)","event PostCreated(uint256 indexed postId, address indexed author, string content, string mediaCID, address indexed operator)","event ReplyCreated(uint256 indexed postId, uint256 indexed parentId, address indexed author, string content, string mediaCID, uint256 tipBkc, address operator)","event RepostCreated(uint256 indexed newPostId, uint256 indexed originalPostId, address indexed reposter, uint256 tipBkc, address operator)","event Liked(uint256 indexed postId, address indexed user, uint256 tipBkc, address indexed operator)","event SuperLiked(uint256 indexed postId, address indexed user, uint256 ethAmount, uint256 tipBkc, address indexed operator)","event Followed(address indexed follower, address indexed followed, uint256 tipBkc, address indexed operator)","event Unfollowed(address indexed follower, address indexed followed)","event ProfileBoosted(address indexed user, uint256 amount, uint256 expiresAt, address indexed operator)","event BadgeObtained(address indexed user, uint256 expiresAt, address indexed operator)","event Withdrawal(address indexed user, uint256 amount)","event TipProcessed(address indexed from, address indexed creator, uint256 totalBkc, uint256 creatorShare, uint256 miningShare, address indexed operator)","event ReferrerSet(address indexed user, address indexed referrer)"];let Er=0;const xd=5e3;async function hd(){try{return window.ethereum?await window.ethereum.request({method:"eth_chainId"})===ye.chainId:!1}catch(e){return console.warn("Network check failed:",e.message),!1}}async function Ot(){if(!window.ethereum)return console.warn("MetaMask not detected"),!1;try{return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:ye.chainId,chainName:ye.chainName,nativeCurrency:ye.nativeCurrency,rpcUrls:ye.rpcUrls,blockExplorerUrls:ye.blockExplorerUrls}]}),console.log("✅ MetaMask network config updated"),!0}catch(e){return e.code===4001?(console.log("User rejected network update"),!1):(console.warn("Could not update MetaMask network:",e.message),!1)}}async function vd(){if(!window.ethereum)return console.warn("MetaMask not detected"),!1;try{return await window.ethereum.request({method:"wallet_switchEthereumChain",params:[{chainId:ye.chainId}]}),console.log("✅ Switched to Arbitrum Sepolia"),!0}catch(e){return e.code===4902?(console.log("🔄 Network not found, adding..."),await Ot()):e.code===4001?(console.log("User rejected network switch"),!1):(console.error("Network switch error:",e),!1)}}async function kn(){var e;if(!window.ethereum)return{healthy:!1,reason:"no_provider"};try{const t=new window.ethers.BrowserProvider(window.ethereum),n=new Promise((s,r)=>setTimeout(()=>r(new Error("timeout")),5e3)),a=t.getBlockNumber();return await Promise.race([a,n]),{healthy:!0}}catch(t){const n=((e=t==null?void 0:t.message)==null?void 0:e.toLowerCase())||"";return n.includes("timeout")?{healthy:!1,reason:"timeout"}:n.includes("too many")||n.includes("rate limit")||n.includes("-32002")?{healthy:!1,reason:"rate_limited"}:n.includes("failed to fetch")||n.includes("network")?{healthy:!1,reason:"network_error"}:{healthy:!1,reason:"unknown",error:n}}}async function wd(){const e=Date.now();if(e-Er<xd)return{success:!0,skipped:!0};if(Er=e,!window.ethereum)return{success:!1,error:"MetaMask not detected"};try{if(!await hd()&&(console.log("🔄 Wrong network detected, switching..."),!await vd()))return{success:!1,error:"Please switch to Arbitrum Sepolia network"};const n=await kn();if(!n.healthy&&(console.log(`⚠️ RPC unhealthy (${n.reason}), updating MetaMask config...`),await Ot())){await new Promise(r=>setTimeout(r,1e3));const s=await kn();return s.healthy?{success:!0,fixed:!0}:{success:!1,error:"Network is congested. Please try again in a moment.",rpcReason:s.reason}}return{success:!0}}catch(t){return console.error("Network config error:",t),{success:!1,error:t.message}}}function yd(e){window.ethereum&&window.ethereum.on("chainChanged",async t=>{console.log("🔄 Network changed to:",t);const n=t===ye.chainId;e&&e({chainId:t,isCorrectNetwork:n,needsSwitch:!n})})}const kd=window.ethers,Ed=5e3,Td=6e4,Cd=15e3,Id=3e4,Ad=1e4;let La=null,Tr=0;const Cr=new Map,Sa=new Map,Ir=new Map,Ar=e=>new Promise(t=>setTimeout(t,e));async function xa(e,t){const n=new AbortController,a=setTimeout(()=>n.abort(),t);try{const s=await fetch(e,{signal:n.signal});return clearTimeout(a),s}catch(s){throw clearTimeout(a),s.name==="AbortError"?new Error("API request timed out."):s}}const Ee={getHistory:"https://gethistory-4wvdcuoouq-uc.a.run.app",getBoosters:"https://getboosters-4wvdcuoouq-uc.a.run.app",getSystemData:"https://getsystemdata-4wvdcuoouq-uc.a.run.app",getNotaryHistory:"https://getnotaryhistory-4wvdcuoouq-uc.a.run.app",getRentalListings:"https://getrentallistings-4wvdcuoouq-uc.a.run.app",getUserRentals:"https://getuserrentals-4wvdcuoouq-uc.a.run.app",fortuneGames:"https://getfortunegames-4wvdcuoouq-uc.a.run.app",uploadFileToIPFS:"/api/upload",claimAirdrop:"https://us-central1-airdropbackchainnew.cloudfunctions.net/claimAirdrop"};function Ao(e){var t;return((t=e==null?void 0:e.error)==null?void 0:t.code)===429||(e==null?void 0:e.code)===429||e.message&&(e.message.includes("429")||e.message.includes("Too Many Requests")||e.message.includes("rate limit"))}function Bo(e){var n,a;const t=((n=e==null?void 0:e.error)==null?void 0:n.code)||(e==null?void 0:e.code);return t===-32603||t===-32e3||((a=e.message)==null?void 0:a.includes("Internal JSON-RPC"))}function ha(e,t,n){if(n)return n;if(!e||!c.publicProvider)return null;try{return new kd.Contract(e,t,c.publicProvider)}catch{return null}}const ne=async(e,t,n=[],a=0n,s=2,r=!1)=>{if(!e)return a;const o=e.target||e.address,i=JSON.stringify(n,(f,m)=>typeof m=="bigint"?m.toString():m),l=`${o}-${t}-${i}`,d=Date.now(),u=["getPoolInfo","getBuyPrice","getSellPrice","getAvailableTokenIds","getAllListedTokenIds","tokenURI","boostBips","getListing","balanceOf","totalSupply","totalNetworkPStake","MAX_SUPPLY","TGE_SUPPLY","userTotalPStake","pendingRewards","isRented","getRental","ownerOf","getDelegationsOf","allowance","prizeTiers","activeTierCount","prizePoolBalance"];if(!r&&u.includes(t)){const f=Cr.get(l);if(f&&d-f.timestamp<Cd)return f.value}for(let f=0;f<=s;f++)try{const m=await e[t](...n);return u.includes(t)&&Cr.set(l,{value:m,timestamp:d}),m}catch(m){if(Ao(m)&&f<s){const b=Math.floor(Math.random()*1e3),p=1e3*Math.pow(2,f)+b;await Ar(p);continue}if(Bo(m)&&f<s){await Ar(500);continue}break}return a},Bd=async(e,t,n=!1)=>{const a=`balance-${(e==null?void 0:e.target)||(e==null?void 0:e.address)}-${t}`,s=Date.now();if(!n){const o=Ir.get(a);if(o&&s-o.timestamp<Ad)return o.value}const r=await ne(e,"balanceOf",[t],0n,2,n);return Ir.set(a,{value:r,timestamp:s}),r};async function Po(){c.systemFees||(c.systemFees={}),c.systemPStakes||(c.systemPStakes={}),c.boosterDiscounts||(c.boosterDiscounts={});const e=Date.now();if(La&&e-Tr<Td)return Br(La),!0;try{const t=await xa(Ee.getSystemData,Ed);if(!t.ok)throw new Error(`API Status: ${t.status}`);const n=await t.json();return Br(n),La=n,Tr=e,!0}catch{return c.systemFees.NOTARY_SERVICE||(c.systemFees.NOTARY_SERVICE=100n),c.systemFees.CLAIM_REWARD_FEE_BIPS||(c.systemFees.CLAIM_REWARD_FEE_BIPS=500n),!1}}function Br(e){if(e.fees)for(const t in e.fees)try{c.systemFees[t]=BigInt(e.fees[t])}catch{c.systemFees[t]=0n}if(e.pStakeRequirements)for(const t in e.pStakeRequirements)try{c.systemPStakes[t]=BigInt(e.pStakeRequirements[t])}catch{c.systemPStakes[t]=0n}if(e.discounts)for(const t in e.discounts)try{c.boosterDiscounts[t]=BigInt(e.discounts[t])}catch{c.boosterDiscounts[t]=0n}if(e.oracleFeeInWei){c.systemData=c.systemData||{};try{c.systemData.oracleFeeInWei=BigInt(e.oracleFeeInWei)}catch{c.systemData.oracleFeeInWei=0n}}}async function Is(){!c.publicProvider||!c.bkcTokenContractPublic||await Promise.allSettled([ne(c.bkcTokenContractPublic,"totalSupply",[],0n),Po()])}async function Pt(e=!1){var t;if(!(!c.isConnected||!c.userAddress))try{const[n,a]=await Promise.allSettled([Bd(c.bkcTokenContract,c.userAddress,e),(t=c.provider)==null?void 0:t.getBalance(c.userAddress)]);if(n.status==="fulfilled"&&(c.currentUserBalance=n.value),a.status==="fulfilled"&&(c.currentUserNativeBalance=a.value),await vt(e),c.delegationManagerContract){const s=await ne(c.delegationManagerContract,"userTotalPStake",[c.userAddress],0n,2,e);c.userTotalPStake=s}}catch(n){console.error("Error loading user data:",n)}}async function Pd(e=!1){if(!c.isConnected||!c.delegationManagerContract)return[];try{const t=await ne(c.delegationManagerContract,"getDelegationsOf",[c.userAddress],[],2,e);return c.userDelegations=t.map((n,a)=>({amount:n[0]||n.amount||0n,unlockTime:BigInt(n[1]||n.unlockTime||0),lockDuration:BigInt(n[2]||n.lockDuration||0),index:a})),c.userDelegations}catch(t){return console.error("Error loading delegations:",t),[]}}async function No(e=!1){let t=[];try{const a=await xa(Ee.getRentalListings,4e3);a.ok&&(t=await a.json())}catch{}if(t&&t.length>0){const a=t.map(s=>{var o,i,l,d,u;const r=ge.find(f=>f.boostBips===Number(s.boostBips||0));return{...s,tokenId:((o=s.tokenId)==null?void 0:o.toString())||((i=s.id)==null?void 0:i.toString()),pricePerHour:((l=s.pricePerHour)==null?void 0:l.toString())||((d=s.price)==null?void 0:d.toString())||"0",totalEarnings:((u=s.totalEarnings)==null?void 0:u.toString())||"0",rentalCount:Number(s.rentalCount||0),img:(r==null?void 0:r.img)||"./assets/nft.png",name:(r==null?void 0:r.name)||"Booster NFT"}});return c.rentalListings=a,a}const n=ha(w.rentalManager,Nn,c.rentalManagerContractPublic);if(!n)return c.rentalListings=[],[];try{const a=await ne(n,"getAllListedTokenIds",[],[],2,!0);if(!a||a.length===0)return c.rentalListings=[],[];const r=a.slice(0,30).map(async l=>{var d,u,f,m,b,p;try{const g=await ne(n,"getListing",[l],null,1,!0);if(g&&g.isActive){const y=await ne(n,"getRental",[l],null,1,!0),k=await zo(l),T=Math.floor(Date.now()/1e3),I=y&&BigInt(y.endTime||0)>BigInt(T);return{tokenId:l.toString(),owner:g.owner,pricePerHour:((d=g.pricePerHour)==null?void 0:d.toString())||((u=g.price)==null?void 0:u.toString())||"0",minHours:((f=g.minHours)==null?void 0:f.toString())||"1",maxHours:((m=g.maxHours)==null?void 0:m.toString())||"1",totalEarnings:((b=g.totalEarnings)==null?void 0:b.toString())||"0",rentalCount:Number(g.rentalCount||0),boostBips:k.boostBips,img:k.img||"./assets/nft.png",name:k.name,isRented:I,currentTenant:I?y.tenant:null,rentalEndTime:I?(p=y.endTime)==null?void 0:p.toString():null}}}catch{}return null}),i=(await Promise.all(r)).filter(l=>l!==null);return c.rentalListings=i,i}catch{return c.rentalListings=[],[]}}async function Nd(e=!1){var n,a,s,r;if(!c.userAddress)return c.myRentals=[],[];try{const o=await xa(`${Ee.getUserRentals}/${c.userAddress}`,4e3);if(o.ok){const l=(await o.json()).map(d=>{const u=ge.find(f=>f.boostBips===Number(d.boostBips||0));return{...d,img:(u==null?void 0:u.img)||"./assets/nft.png",name:(u==null?void 0:u.name)||"Booster NFT"}});return c.myRentals=l,l}}catch{}const t=ha(w.rentalManager,Nn,c.rentalManagerContractPublic);if(!t)return c.myRentals=[],[];try{const o=await ne(t,"getAllListedTokenIds",[],[],2,e),i=[],l=Math.floor(Date.now()/1e3);for(const d of o.slice(0,30))try{const u=await ne(t,"getRental",[d],null,1,e);if(u&&((n=u.tenant)==null?void 0:n.toLowerCase())===c.userAddress.toLowerCase()&&BigInt(u.endTime||0)>BigInt(l)){const f=await zo(d);i.push({tokenId:d.toString(),tenant:u.tenant,startTime:((a=u.startTime)==null?void 0:a.toString())||"0",endTime:((s=u.endTime)==null?void 0:s.toString())||"0",paidAmount:((r=u.paidAmount)==null?void 0:r.toString())||"0",boostBips:f.boostBips,img:f.img,name:f.name})}}catch{}return c.myRentals=i,i}catch{return c.myRentals=[],[]}}let On=null,Pr=0;const zd=3e4;async function Ht(e=!1){const t=Date.now();if(!e&&On&&t-Pr<zd)return On;await vt(e);let n=0,a=null,s="none";if(c.myBoosters&&c.myBoosters.length>0){const l=c.myBoosters.reduce((d,u)=>u.boostBips>d.boostBips?u:d,c.myBoosters[0]);l.boostBips>n&&(n=l.boostBips,a=l.tokenId,s="owned")}if(c.myRentals&&c.myRentals.length>0){const l=c.myRentals.reduce((d,u)=>u.boostBips>d.boostBips?u:d,c.myRentals[0]);l.boostBips>n&&(n=l.boostBips,a=l.tokenId,s="rented")}const r=ge.find(l=>l.boostBips===n),o=(r==null?void 0:r.realImg)||(r==null?void 0:r.img)||"assets/bkc_logo_3d.png",i=r!=null&&r.name?`${r.name} Booster`:s!=="none"?"Booster NFT":"None";return On={highestBoost:n,boostName:i,imageUrl:o,tokenId:a?a.toString():null,source:s},Pr=Date.now(),On}async function zo(e){const t=["function boostBips(uint256) view returns (uint256)"],n=ha(w.rewardBoosterNFT,t,c.rewardBoosterContractPublic);if(!n)return{boostBips:0,img:"assets/bkc_logo_3d.png",name:"Unknown"};try{const a=await ne(n,"boostBips",[e],0n),s=Number(a),r=ge.find(o=>o.boostBips===s);return{boostBips:s,img:(r==null?void 0:r.img)||"./assets/nft.png",name:(r==null?void 0:r.name)||`Booster #${e}`}}catch{return{boostBips:0,img:"assets/bkc_logo_3d.png",name:"Unknown"}}}async function Vt(){if(!c.isConnected||!c.delegationManagerContract)return{stakingRewards:0n,minerRewards:0n,totalRewards:0n};try{const e=await ne(c.delegationManagerContract,"pendingRewards",[c.userAddress],0n);return{stakingRewards:e,minerRewards:0n,totalRewards:e}}catch{return{stakingRewards:0n,minerRewards:0n,totalRewards:0n}}}async function Ld(){var l,d;if(!c.delegationManagerContract||!c.userAddress)return{netClaimAmount:0n,feeAmount:0n,discountPercent:0,totalRewards:0n,baseFeeBips:0n,finalFeeBips:0n};const{totalRewards:e}=await Vt();if(e===0n)return{netClaimAmount:0n,feeAmount:0n,discountPercent:0,totalRewards:0n,baseFeeBips:0n,finalFeeBips:0n};let t=((l=c.systemFees)==null?void 0:l.CLAIM_REWARD_FEE_BIPS)||100n;const n=await Ht(),a=BigInt(n.highestBoost||0);let s=((d=c.boosterDiscounts)==null?void 0:d[n.highestBoost])||a;const r=t*s/10000n,o=t>r?t-r:0n,i=e*o/10000n;return console.log("[Data] Claim calculation:",{totalRewards:Number(e)/1e18,baseFeeBips:Number(t),boostBips:Number(a),discountBips:Number(s),discountAmount:Number(r),finalFeeBips:Number(o),feeAmount:Number(i)/1e18,netAmount:Number(e-i)/1e18}),{netClaimAmount:e-i,feeAmount:i,discountPercent:Number(s)/100,totalRewards:e,baseFeeBips:Number(t),finalFeeBips:Number(o)}}let Ra=!1,$a=0,Hn=0;const Sd=3e4,Rd=3,$d=12e4;async function vt(e=!1){if(!c.userAddress)return[];const t=Date.now();if(Ra)return c.myBoosters||[];if(!e&&t-$a<Sd)return c.myBoosters||[];if(Hn>=Rd){if(t-$a<$d)return c.myBoosters||[];Hn=0}Ra=!0,$a=t;try{const n=await xa(`${Ee.getBoosters}/${c.userAddress}`,5e3);if(!n.ok)throw new Error(`API Error: ${n.status}`);let a=await n.json();const s=["function ownerOf(uint256) view returns (address)","function boostBips(uint256) view returns (uint256)"],r=ha(w.rewardBoosterNFT,s,c.rewardBoosterContractPublic);if(r&&a.length>0){const o=await Promise.all(a.slice(0,50).map(async i=>{const l=BigInt(i.tokenId),d=`ownerOf-${l}`,u=Date.now();let f=Number(i.boostBips||i.boost||0);if(f===0)try{const m=await r.boostBips(l);f=Number(m)}catch{}if(!e&&Sa.has(d)){const m=Sa.get(d);if(u-m.timestamp<Id)return m.owner.toLowerCase()===c.userAddress.toLowerCase()?{tokenId:l,boostBips:f,imageUrl:i.imageUrl||i.image||null}:null}try{const m=await r.ownerOf(l);return Sa.set(d,{owner:m,timestamp:u}),m.toLowerCase()===c.userAddress.toLowerCase()?{tokenId:l,boostBips:f,imageUrl:i.imageUrl||i.image||null}:null}catch(m){return Ao(m)||Bo(m)?{tokenId:l,boostBips:f,imageUrl:i.imageUrl||i.image||null}:null}}));c.myBoosters=o.filter(i=>i!==null)}else c.myBoosters=a.map(o=>({tokenId:BigInt(o.tokenId),boostBips:Number(o.boostBips||o.boost||0),imageUrl:o.imageUrl||o.image||null}));return Hn=0,c.myBoosters}catch{return Hn++,c.myBoosters||(c.myBoosters=[]),c.myBoosters}finally{Ra=!1}}const _d={apiKey:"AIzaSyDKhF2_--fKtot96YPS8twuD0UoCpS-3T4",authDomain:"airdropbackchainnew.firebaseapp.com",projectId:"airdropbackchainnew",storageBucket:"airdropbackchainnew.appspot.com",messagingSenderId:"108371799661",appId:"1:108371799661:web:d126fcbd0ba56263561964",measurementId:"G-QD9EBZ0Y09"},Lo=Yc(_d),Un=Vc(Lo),U=Jc(Lo);let tt=null,Te=null,jn=null;async function So(e){if(!e)throw new Error("Wallet address is required for Firebase sign-in.");const t=e.toLowerCase();return Te=t,tt?(jn=await dn(t),tt):Un.currentUser?(tt=Un.currentUser,jn=await dn(t),tt):new Promise((n,a)=>{const s=qc(Un,async r=>{if(s(),r){tt=r;try{jn=await dn(t),n(r)}catch(o){console.error("Error linking airdrop user profile:",o),a(o)}}else Xc(Un).then(async o=>{tt=o.user,jn=await dn(t),n(tt)}).catch(o=>{console.error("Firebase Anonymous sign-in failed:",o),a(o)})},r=>{console.error("Firebase Auth state change error:",r),s(),a(r)})})}function Je(){if(!tt)throw new Error("User not authenticated with Firebase. Please sign-in first.");if(!Te)throw new Error("Wallet address not set. Please connect wallet first.")}async function As(){const e=te(U,"airdrop_public_data","data_v1"),t=await Ae(e);if(t.exists()){const n=t.data(),a=(n.dailyTasks||[]).map(o=>{var d,u;const i=(d=o.startDate)!=null&&d.toDate?o.startDate.toDate():o.startDate?new Date(o.startDate):null,l=(u=o.endDate)!=null&&u.toDate?o.endDate.toDate():o.endDate?new Date(o.endDate):null;return{...o,id:o.id||null,startDate:i instanceof Date&&!isNaN(i)?i:null,endDate:l instanceof Date&&!isNaN(l)?l:null}}).filter(o=>o.id),s=Date.now(),r=a.filter(o=>{const i=o.startDate?o.startDate.getTime():0,l=o.endDate?o.endDate.getTime():1/0;return i<=s&&s<l});return{config:n.config||{ugcBasePoints:{}},leaderboards:n.leaderboards||{top100ByPoints:[],top100ByPosts:[],lastUpdated:null},dailyTasks:r,platformUsageConfig:n.platformUsageConfig||null}}else return console.warn("Public airdrop data document 'airdrop_public_data/data_v1' not found. Returning defaults."),{config:{isActive:!1,roundName:"Loading...",ugcBasePoints:{}},leaderboards:{top100ByPoints:[],top100ByPosts:[],lastUpdated:null},dailyTasks:[],platformUsageConfig:null}}function Nr(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";let t="";for(let n=0;n<6;n++)t+=e.charAt(Math.floor(Math.random()*e.length));return t}function Qn(e){return e>=100?10:e>=90?9:e>=80?8:e>=70?7:e>=60?6:e>=50?5:e>=40?4:e>=30?3:e>=20?2:1}async function dn(e){Je(),e||(e=Te);const t=e.toLowerCase(),n=te(U,"airdrop_users",t),a=await Ae(n);if(a.exists()){const s=a.data(),r={};if(s.referralCode||(r.referralCode=Nr()),typeof s.approvedSubmissionsCount!="number"&&(r.approvedSubmissionsCount=0),typeof s.rejectedCount!="number"&&(r.rejectedCount=0),typeof s.isBanned!="boolean"&&(r.isBanned=!1),typeof s.totalPoints!="number"&&(r.totalPoints=0),typeof s.pointsMultiplier!="number"&&(r.pointsMultiplier=1),s.walletAddress!==t&&(r.walletAddress=t),Object.keys(r).length>0)try{return await ba(n,r),{id:a.id,...s,...r}}catch(o){return console.error("Error updating user default fields:",o),{id:a.id,...s}}return{id:a.id,...s}}else{const s=Nr(),r={walletAddress:t,referralCode:s,totalPoints:0,pointsMultiplier:1,approvedSubmissionsCount:0,rejectedCount:0,isBanned:!1,createdAt:it()};return await ga(n,r),{id:n.id,...r,createdAt:new Date}}}async function Ro(e,t){if(Je(),!e||typeof e!="string"||e.trim()==="")return console.warn(`isTaskEligible called with invalid taskId: ${e}`),{eligible:!1,timeLeft:0};const n=te(U,"airdrop_users",Te,"task_claims",e),a=await Ae(n),s=t*60*60*1e3;if(!a.exists())return{eligible:!0,timeLeft:0};const r=a.data(),o=r==null?void 0:r.timestamp;if(typeof o!="string"||o.trim()==="")return console.warn(`Missing/invalid timestamp for task ${e}. Allowing claim.`),{eligible:!0,timeLeft:0};try{const i=new Date(o);if(isNaN(i.getTime()))return console.warn(`Invalid timestamp format for task ${e}:`,o,". Allowing claim."),{eligible:!0,timeLeft:0};const l=i.getTime(),u=Date.now()-l;return u>=s?{eligible:!0,timeLeft:0}:{eligible:!1,timeLeft:s-u}}catch(i){return console.error(`Error parsing timestamp string for task ${e}:`,o,i),{eligible:!0,timeLeft:0}}}async function Fd(e,t){if(Je(),!e||!e.id)throw new Error("Invalid task data provided.");if(!(await Ro(e.id,e.cooldownHours)).eligible)throw new Error("Cooldown period is still active for this task.");const a=te(U,"airdrop_users",Te),s=Math.round(e.points);if(isNaN(s)||s<0)throw new Error("Invalid points value for the task.");await ba(a,{totalPoints:Me(s)});const r=te(U,"airdrop_users",Te,"task_claims",e.id);return await ga(r,{timestamp:new Date().toISOString(),points:s}),s}async function Md(e){var i;const t=e.trim().toLowerCase();let n="Other",a=!0;if(t.includes("youtube.com/shorts/")){n="YouTube Shorts";const l=t.match(/\/shorts\/([a-zA-Z0-9_-]+)/);if(!l||!l[1])throw a=!1,new Error("Invalid YouTube Shorts URL: Video ID not found or incorrect format.")}else if(t.includes("youtube.com/watch?v=")||t.includes("youtu.be/")){n="YouTube";const l=t.match(/(?:v=|\/)([a-zA-Z0-9_-]{11})(?:[?&]|$)/);if(!l||l[1].length!==11)throw a=!1,new Error("Invalid YouTube URL: Video ID not found or incorrect format.")}else{if(t.includes("youtube.com/"))throw n="YouTube",a=!1,new Error("Invalid YouTube URL: Only video links (youtube.com/watch?v=... or youtu.be/...) or Shorts links are accepted.");if(t.includes("instagram.com/p/")||t.includes("instagram.com/reel/")){n="Instagram";const l=t.match(/\/(?:p|reel)\/([a-zA-Z0-9_.-]+)/);(!l||!l[1])&&(a=!1)}else t.includes("twitter.com/")||t.includes("x.com/")?t.match(/(\w+)\/(?:status|statuses)\/(\d+)/)&&(n="X/Twitter"):t.includes("facebook.com/")&&t.includes("/posts/")?n="Facebook":t.includes("t.me/")||t.includes("telegram.org/")?n="Telegram":t.includes("tiktok.com/")?n="TikTok":t.includes("reddit.com/r/")?n="Reddit":t.includes("linkedin.com/posts/")&&(n="LinkedIn")}const r=((i=(await As()).config)==null?void 0:i.ugcBasePoints)||{},o=r[n]||r.Other||1e3;if(isNaN(o)||o<0)throw new Error(`Invalid base points configured for platform: ${n}. Please contact admin.`);return{platform:n,basePoints:o,isValid:a,normalizedUrl:t}}async function Dd(e){var se;Je();const t=te(U,"airdrop_users",Te),n=Xe(U,"airdrop_users",Te,"submissions"),a=Xe(U,"all_submissions_log"),s=e.trim();if(!s||!s.toLowerCase().startsWith("http://")&&!s.toLowerCase().startsWith("https://"))throw new Error("The provided URL must start with http:// or https://.");let r;try{r=await Md(s)}catch(de){throw de}const{platform:o,basePoints:i,isValid:l,normalizedUrl:d}=r;if(!l)throw new Error(`The provided URL for ${o} does not appear valid for submission.`);const u=Tt(n,Yt("submittedAt","desc"),Zc(1)),f=await ot(u);if(!f.empty){const xe=(se=f.docs[0].data().submittedAt)==null?void 0:se.toDate();if(xe){const Q=new Date,D=5*60*1e3,W=Q.getTime()-xe.getTime();if(W<D){const ie=D-W,ae=Math.ceil(ie/6e4);throw new Error(`We're building a strong community, and we value quality over quantity. To prevent spam, please wait ${ae} more minute(s) before submitting another post. We appreciate your thoughtful contribution!`)}}}const m=Tt(a,Zn("normalizedUrl","==",d),Zn("status","in",["pending","approved","auditing","flagged_suspicious"]));if(!(await ot(m)).empty)throw new Error("This content link has already been submitted. Repeatedly submitting duplicate or fraudulent content may lead to account suspension.");const p=await Ae(t);if(!p.exists())throw new Error("User profile not found.");const g=p.data(),y=g.approvedSubmissionsCount||0,k=Qn(y),T=Math.round(i*k),I=it(),N={url:s,platform:o,status:"pending",basePoints:i,_pointsCalculated:T,_multiplierApplied:k,pointsAwarded:0,submittedAt:I,resolvedAt:null},z={userId:Te,walletAddress:g.walletAddress,normalizedUrl:d,platform:o,status:"pending",basePoints:i,submittedAt:I,resolvedAt:null},E=fa(U),F=te(n);E.set(F,N);const G=te(a,F.id);E.set(G,z),await E.commit()}async function Od(){Je();const e=Xe(U,"airdrop_users",Te,"submissions"),t=Tt(e,Yt("submittedAt","desc"));return(await ot(t)).docs.map(a=>{var r,o;const s=a.data();return{submissionId:a.id,...s,submittedAt:(r=s.submittedAt)!=null&&r.toDate?s.submittedAt.toDate():null,resolvedAt:(o=s.resolvedAt)!=null&&o.toDate?s.resolvedAt.toDate():null}})}async function Hd(e){Je();const t=Te,n=te(U,"airdrop_users",t),a=te(U,"airdrop_users",t,"submissions",e),s=te(U,"all_submissions_log",e),r=await Ae(a);if(!r.exists())throw new Error("Cannot confirm submission: Document not found or already processed.");const o=r.data(),i=o.status;if(i==="approved"||i==="rejected")throw new Error(`Submission is already in status: ${i}.`);let l=o._pointsCalculated,d=o._multiplierApplied;if(typeof l!="number"||isNaN(l)||l<=0){console.warn(`[ConfirmSubmission] Legacy/Invalid submission ${e} missing/invalid _pointsCalculated. Recalculating...`);const f=o.basePoints||0,m=await Ae(n);if(!m.exists())throw new Error("User profile not found for recalculation.");const p=m.data().approvedSubmissionsCount||0;d=Qn(p),l=Math.round(f*d),(isNaN(l)||l<=0)&&(console.warn(`[ConfirmSubmission] Recalculation failed (basePoints: ${f}). Using fallback 1000.`),l=Math.round(1e3*d))}const u=fa(U);u.update(n,{totalPoints:Me(l),approvedSubmissionsCount:Me(1)}),u.update(a,{status:"approved",pointsAwarded:l,_pointsCalculated:l,_multiplierApplied:d,resolvedAt:it()}),await Ae(s).then(f=>f.exists())&&u.update(s,{status:"approved",resolvedAt:it()}),await u.commit()}async function $o(e){Je();const n=te(U,"airdrop_users",Te,"submissions",e),a=te(U,"all_submissions_log",e),s=await Ae(n);if(!s.exists())return console.warn(`Delete submission skipped: Document ${e} not found.`);const r=s.data().status;if(r==="approved"||r==="rejected")throw new Error(`This submission was already ${r} and cannot be deleted.`);if(r==="flagged_suspicious")throw new Error("Flagged submissions must be resolved, not deleted.");const o=fa(U);o.update(n,{status:"deleted_by_user",resolvedAt:it()}),await Ae(a).then(i=>i.exists())&&o.update(a,{status:"deleted_by_user",resolvedAt:it(),pointsAwarded:0}),await o.commit()}async function Ud(e){const t=te(U,"airdrop_public_data","data_v1");await ga(t,{config:{ugcBasePoints:e}},{merge:!0})}async function jd(){const e=Xe(U,"daily_tasks"),t=Tt(e,Yt("endDate","asc"));return(await ot(t)).docs.map(a=>{var s,r;return{id:a.id,...a.data(),startDate:(s=a.data().startDate)!=null&&s.toDate?a.data().startDate.toDate():null,endDate:(r=a.data().endDate)!=null&&r.toDate?a.data().endDate.toDate():null}})}async function Wd(e){const t={...e};t.startDate instanceof Date&&(t.startDate=wr.fromDate(t.startDate)),t.endDate instanceof Date&&(t.endDate=wr.fromDate(t.endDate));const n=e.id;if(!n)delete t.id,await Qc(Xe(U,"daily_tasks"),t);else{const a=te(U,"daily_tasks",n);delete t.id,await ga(a,t,{merge:!0})}}async function Gd(e){if(!e)throw new Error("Task ID is required for deletion.");await ed(te(U,"daily_tasks",e))}async function Kd(){const e=Xe(U,"all_submissions_log"),t=Tt(e,Zn("status","in",["pending","auditing","flagged_suspicious"]),Yt("submittedAt","desc"));return(await ot(t)).docs.map(a=>{var r,o;const s=a.data();return{userId:s.userId,walletAddress:s.walletAddress,submissionId:a.id,...s,submittedAt:(r=s.submittedAt)!=null&&r.toDate?s.submittedAt.toDate():null,resolvedAt:(o=s.resolvedAt)!=null&&o.toDate?s.resolvedAt.toDate():null}})}async function _o(e,t,n){var k,T,I;if(!e)throw new Error("User ID (walletAddress) is required.");const a=e.toLowerCase(),s=te(U,"airdrop_users",a),r=te(U,"airdrop_users",a,"submissions",t),o=te(U,"all_submissions_log",t),[i,l,d]=await Promise.all([Ae(s),Ae(r),Ae(o)]);if(!l.exists())throw new Error("Submission not found in user collection.");if(!i.exists())throw new Error("User profile not found.");d.exists()||console.warn(`Log entry ${t} not found. Log will not be updated.`);const u=l.data(),f=i.data(),m=u.status;if(m===n){console.warn(`Admin action ignored: Submission ${t} already has status ${n}.`);return}const b=fa(U),p={};let g=0,y=u._multiplierApplied||0;if(n==="approved"){let N=u._pointsCalculated;if(typeof N!="number"||isNaN(N)||N<=0){console.warn(`[Admin] Legacy/Invalid submission ${t} missing/invalid _pointsCalculated. Recalculating...`);const z=u.basePoints||0,E=f.approvedSubmissionsCount||0,F=Qn(E);if(N=Math.round(z*F),isNaN(N)||N<=0){console.warn(`[Admin] Recalculation failed (basePoints: ${z}). Using fallback 1000.`);const G=Qn(E);N=Math.round(1e3*G)}y=F}g=N,p.totalPoints=Me(N),p.approvedSubmissionsCount=Me(1),m==="rejected"&&(p.rejectedCount=Me(-1))}else if(n==="rejected"){if(m!=="rejected"){const N=f.rejectedCount||0;p.rejectedCount=Me(1),N+1>=3&&(p.isBanned=!0)}else if(m==="approved"){const N=u.pointsAwarded||0;p.totalPoints=Me(-N),p.approvedSubmissionsCount=Me(-1);const z=f.rejectedCount||0;p.rejectedCount=Me(1),z+1>=3&&(p.isBanned=!0)}g=0}if(((k=p.approvedSubmissionsCount)==null?void 0:k.operand)<0&&(f.approvedSubmissionsCount||0)<=0&&(p.approvedSubmissionsCount=0),((T=p.rejectedCount)==null?void 0:T.operand)<0&&(f.rejectedCount||0)<=0&&(p.rejectedCount=0),((I=p.totalPoints)==null?void 0:I.operand)<0){const N=f.totalPoints||0,z=Math.abs(p.totalPoints.operand);N<z&&(p.totalPoints=0)}Object.keys(p).length>0&&b.update(s,p),b.update(r,{status:n,pointsAwarded:g,_pointsCalculated:n==="approved"?g:u._pointsCalculated||0,_multiplierApplied:y,resolvedAt:it()}),d.exists()&&b.update(o,{status:n,resolvedAt:it()}),await b.commit()}async function Yd(){const e=Xe(U,"airdrop_users"),t=Tt(e,Yt("totalPoints","desc"));return(await ot(t)).docs.map(a=>({id:a.id,...a.data()}))}async function Vd(e,t){if(!e)throw new Error("User ID is required.");const n=e.toLowerCase(),a=Xe(U,"airdrop_users",n,"submissions"),s=Tt(a,Zn("status","==",t),Yt("resolvedAt","desc"));return(await ot(s)).docs.map(o=>{var i,l;return{submissionId:o.id,userId:n,...o.data(),submittedAt:(i=o.data().submittedAt)!=null&&i.toDate?o.data().submittedAt.toDate():null,resolvedAt:(l=o.data().resolvedAt)!=null&&l.toDate?o.data().resolvedAt.toDate():null}})}async function Fo(e,t){if(!e)throw new Error("User ID is required.");const n=e.toLowerCase(),a=te(U,"airdrop_users",n),s={isBanned:t};t===!1&&(s.rejectedCount=0),await ba(a,s)}async function zr(){Je();try{const e=Xe(U,"airdrop_users",Te,"platform_usage"),t=await ot(e),n={};return t.forEach(a=>{n[a.id]=a.data()}),n}catch(e){return console.error("Error fetching platform usage:",e),{}}}async function Mo(e){Je();const t=te(U,"airdrop_public_data","data_v1");await ba(t,{platformUsageConfig:e}),console.log("✅ Platform usage config saved:",e)}const j=window.ethers,Do=421614,qd="0x66eee";let Se=null,Lr=0,nt=0;const Xd=5e3,Sr=3,Jd=1e4;let Bs=0;const Zd=3;let Oo=null;const Qd="cd4bdedee7a7e909ebd3df8bbc502aed",eu={chainId:ye.chainIdDecimal,name:ye.chainName,currency:ye.nativeCurrency.symbol,explorerUrl:ye.blockExplorerUrls[0],rpcUrl:ye.rpcUrls[0]},tu={name:"Backcoin Protocol",description:"DeFi Ecosystem",url:window.location.origin,icons:[window.location.origin+"/assets/bkc_logo_3d.png"]},nu=Gc({metadata:tu,enableEIP6963:!0,enableInjected:!0,enableCoinbase:!1,rpcUrl:Eo,defaultChainId:Do,enableEmail:!0,enableEns:!1,auth:{email:!0,showWallets:!0,walletFeatures:!0}}),xt=Kc({ethersConfig:nu,chains:[eu],projectId:Qd,enableAnalytics:!0,themeMode:"dark",themeVariables:{"--w3m-accent":"#f59e0b","--w3m-border-radius-master":"1px","--w3m-z-index":100}});function au(e){var a,s;const t=((a=e==null?void 0:e.message)==null?void 0:a.toLowerCase())||"",n=(e==null?void 0:e.code)||((s=e==null?void 0:e.error)==null?void 0:s.code);return n===-32603||n===-32e3||n===429||t.includes("failed to fetch")||t.includes("network error")||t.includes("timeout")||t.includes("rate limit")||t.includes("too many requests")||t.includes("internal json-rpc")||t.includes("unexpected token")||t.includes("<html")}function es(e){return new j.JsonRpcProvider(e||yn())}async function Ho(e,t=Zd){var a;let n=null;for(let s=0;s<t;s++)try{const r=await e();return ld(yn()),Bs=0,r}catch(r){if(n=r,au(r)){console.warn(`⚠️ RPC error (attempt ${s+1}/${t}):`,(a=r.message)==null?void 0:a.slice(0,80)),id(yn());const o=To();console.log(`🔄 Switching to: ${o}`),await En(),await new Promise(i=>setTimeout(i,500*(s+1)))}else throw r}throw console.error("❌ All RPC attempts failed"),n}async function En(){const e=yn();try{c.publicProvider=es(e),Oo=c.publicProvider,J(w.bkcToken)&&(c.bkcTokenContractPublic=new j.Contract(w.bkcToken,ws,c.publicProvider)),J(w.delegationManager)&&(c.delegationManagerContractPublic=new j.Contract(w.delegationManager,ys,c.publicProvider)),J(w.faucet)&&(c.faucetContractPublic=new j.Contract(w.faucet,Ts,c.publicProvider)),J(w.rentalManager)&&(c.rentalManagerContractPublic=new j.Contract(w.rentalManager,Nn,c.publicProvider)),J(w.ecosystemManager)&&(c.ecosystemManagerContractPublic=new j.Contract(w.ecosystemManager,Cs,c.publicProvider)),J(w.actionsManager)&&(c.actionsManagerContractPublic=new j.Contract(w.actionsManager,ks,c.publicProvider));const t=w.fortunePoolV2||w.fortunePool;J(t)&&(c.fortunePoolContractPublic=new j.Contract(t,Es,c.publicProvider)),console.log(`✅ Public provider recreated with: ${e.slice(0,50)}...`)}catch(t){console.error("Failed to recreate public provider:",t)}}function su(e){if(!e)return!1;try{return j.isAddress(e)}catch{return!1}}function J(e){return e&&e!==j.ZeroAddress&&!e.startsWith("0x...")}function ru(e){if(!e)return;const t=localStorage.getItem(`balance_${e.toLowerCase()}`);if(t)try{c.currentUserBalance=BigInt(t),window.updateUIState&&window.updateUIState()}catch{}}function ou(e){try{J(w.bkcToken)&&(c.bkcTokenContract=new j.Contract(w.bkcToken,ws,e)),J(w.delegationManager)&&(c.delegationManagerContract=new j.Contract(w.delegationManager,ys,e)),J(w.rewardBoosterNFT)&&(c.rewardBoosterContract=new j.Contract(w.rewardBoosterNFT,fd,e)),J(w.publicSale)&&(c.publicSaleContract=new j.Contract(w.publicSale,bd,e)),J(w.faucet)&&(c.faucetContract=new j.Contract(w.faucet,Ts,e)),J(w.rentalManager)&&(c.rentalManagerContract=new j.Contract(w.rentalManager,Nn,e)),J(w.actionsManager)&&(c.actionsManagerContract=new j.Contract(w.actionsManager,ks,e)),J(w.decentralizedNotary)&&(c.decentralizedNotaryContract=new j.Contract(w.decentralizedNotary,gd,e)),J(w.ecosystemManager)&&(c.ecosystemManagerContract=new j.Contract(w.ecosystemManager,Cs,e));const t=w.fortunePoolV2||w.fortunePool;J(t)&&(c.fortunePoolContract=new j.Contract(t,Es,e))}catch{console.warn("Contract init partial failure")}}function Uo(){if(Se&&(clearInterval(Se),Se=null),!c.bkcTokenContractPublic||!c.userAddress){console.warn("Cannot start balance polling: missing contract or address");return}nt=0,Bs=0,setTimeout(()=>{Rr()},1e3),Se=setInterval(Rr,Jd),console.log("✅ Balance polling started (10s interval)")}async function Rr(){var t;if(document.hidden||!c.isConnected||!c.userAddress||!c.bkcTokenContractPublic)return;const e=Date.now();try{const n=await Ho(async()=>await c.bkcTokenContractPublic.balanceOf(c.userAddress),2);nt=0;const a=c.currentUserBalance||0n;n.toString()!==a.toString()&&(c.currentUserBalance=n,localStorage.setItem(`balance_${c.userAddress.toLowerCase()}`,n.toString()),e-Lr>Xd&&(Lr=e,window.updateUIState&&window.updateUIState(!1)))}catch(n){nt++,nt<=3&&console.warn(`⚠️ Balance check failed (${nt}/${Sr}):`,(t=n.message)==null?void 0:t.slice(0,50)),nt>=Sr&&(console.warn("❌ Too many balance check errors. Stopping polling temporarily."),Se&&(clearInterval(Se),Se=null),setTimeout(()=>{console.log("🔄 Attempting to restart balance polling with primary RPC..."),cd(),En().then(()=>{nt=0,Uo()})},6e4))}}async function iu(e){try{const t=await e.getNetwork();if(Number(t.chainId)===Do)return!0;try{return await e.send("wallet_switchEthereumChain",[{chainId:qd}]),!0}catch{return!0}}catch{return!0}}async function $r(e,t){try{if(!su(t))return!1;await iu(e),c.provider=e;try{c.signer=await e.getSigner()}catch(n){c.signer=e,console.warn(`Could not get standard Signer. Using Provider as read-only. Warning: ${n.message}`)}c.userAddress=t,c.isConnected=!0,ru(t),ou(c.signer);try{So(c.userAddress)}catch{}return Pt().then(()=>{window.updateUIState&&window.updateUIState(!1)}).catch(()=>{}),Uo(),!0}catch(n){return console.error("Setup warning:",n),!!t}}async function lu(){try{if(window.ethereum){const n=await wd();n.fixed?console.log("✅ MetaMask network config was auto-fixed"):!n.success&&!n.skipped&&console.warn("Initial network config check:",n.error)}const e=yn();console.log(`🌐 Initializing public provider with: ${e.slice(0,50)}...`),c.publicProvider=es(e),Oo=c.publicProvider,J(w.bkcToken)&&(c.bkcTokenContractPublic=new j.Contract(w.bkcToken,ws,c.publicProvider)),J(w.delegationManager)&&(c.delegationManagerContractPublic=new j.Contract(w.delegationManager,ys,c.publicProvider)),J(w.faucet)&&(c.faucetContractPublic=new j.Contract(w.faucet,Ts,c.publicProvider)),J(w.rentalManager)&&(c.rentalManagerContractPublic=new j.Contract(w.rentalManager,Nn,c.publicProvider)),J(w.ecosystemManager)&&(c.ecosystemManagerContractPublic=new j.Contract(w.ecosystemManager,Cs,c.publicProvider)),J(w.actionsManager)&&(c.actionsManagerContractPublic=new j.Contract(w.actionsManager,ks,c.publicProvider));const t=w.fortunePoolV2||w.fortunePool;J(t)&&(c.fortunePoolContractPublic=new j.Contract(t,Es,c.publicProvider),console.log("✅ FortunePool V2 contract initialized:",t));try{await Ho(async()=>{await Is()})}catch{console.warn("Initial public data load failed, will retry on user interaction")}yd(async n=>{n.isCorrectNetwork?(await kn()).healthy||(console.log("⚠️ RPC issues after network change, updating..."),await Ot(),await En()):(console.log("⚠️ User switched to wrong network"),x("Please switch back to Arbitrum Sepolia","warning"))}),uu(),window.updateUIState&&window.updateUIState(),console.log("✅ Public provider initialized")}catch(e){console.error("Public provider error:",e),window.ethereum&&await Ot();const t=To();console.log(`🔄 Retrying with: ${t}`);try{c.publicProvider=es(t),console.log("✅ Public provider initialized with fallback RPC")}catch{console.error("❌ All RPC endpoints failed")}}}function cu(e){let t=xt.getAddress();if(xt.getIsConnected()&&t){const a=xt.getWalletProvider();if(a){const s=new j.BrowserProvider(a);c.web3Provider=a,e({isConnected:!0,address:t,isNewConnection:!1}),$r(s,t)}}const n=async({provider:a,address:s,chainId:r,isConnected:o})=>{try{if(o){let i=s||xt.getAddress();if(!i&&a)try{i=await(await new j.BrowserProvider(a).getSigner()).getAddress()}catch{}if(i){const l=new j.BrowserProvider(a);c.web3Provider=a,e({isConnected:!0,address:i,chainId:r,isNewConnection:!0}),await $r(l,i)}else Se&&clearInterval(Se),c.isConnected=!1,c.userAddress=null,c.signer=null,e({isConnected:!1})}else Se&&clearInterval(Se),c.isConnected=!1,c.userAddress=null,c.signer=null,e({isConnected:!1})}catch{}};xt.subscribeProvider(n)}function jo(){xt.open()}async function du(){await xt.disconnect()}let _a=null;function uu(){_a&&clearInterval(_a),_a=setInterval(async()=>{if(document.hidden||!c.isConnected)return;const e=await kn();e.healthy||(console.log(`⚠️ RPC health check failed (${e.reason}), attempting fix...`),await Ot()&&(console.log("✅ MetaMask RPCs updated via health monitor"),await En(),nt=0,Bs=0))},3e4),document.addEventListener("visibilitychange",async()=>{!document.hidden&&c.isConnected&&((await kn()).healthy||(console.log("⚠️ RPC unhealthy on tab focus, fixing..."),await Ot(),await En()))}),console.log("✅ RPC health monitoring started (30s interval)")}const pu=window.ethers,_=(e,t=18)=>{if(e===null||typeof e>"u")return 0;if(typeof e=="number")return e;if(typeof e=="string")return parseFloat(e);try{const n=BigInt(e);return parseFloat(pu.formatUnits(n,t))}catch{return 0}},qt=e=>!e||typeof e!="string"||!e.startsWith("0x")?"...":`${e.substring(0,6)}...${e.substring(e.length-4)}`,Ut=e=>{try{if(e==null)return"0";const t=typeof e=="bigint"?e:BigInt(e);if(t<1000n)return t.toString();const n=Number(t);if(!isFinite(n))return t.toLocaleString("en-US");const a=["","k","M","B","T"],s=Math.floor((""+Math.floor(n)).length/3);let r=parseFloat((s!==0?n/Math.pow(1e3,s):n).toPrecision(3));return r%1!==0&&(r=r.toFixed(2)),r+a[s]}catch{return"0"}},mu=(e="Loading...")=>`<div class="flex items-center justify-center p-4 text-zinc-400"><div class="loader inline-block mr-2"></div> ${e}</div>`,fu=(e="An error occurred.")=>`<div class="bg-red-900/20 border border-red-500/30 rounded-lg p-4 text-center text-red-400 text-sm">${e}</div>`,bu=(e="No data available.")=>`<div class="text-center p-8 bg-zinc-900/30 border border-dashed border-zinc-800 rounded-lg col-span-full">
                <i class="fa-regular fa-folder-open text-2xl text-zinc-600 mb-2"></i>
                <p class="text-zinc-500 italic text-sm">${e}</p>
            </div>`;function Ps(e,t,n,a){if(!e)return;if(n<=1){e.innerHTML="";return}const s=`
    ...
    `;e.innerHTML=s,e.querySelectorAll(".pagination-btn").forEach(r=>{r.addEventListener("click",()=>{r.hasAttribute("disabled")||a(parseInt(r.dataset.page))})})}const gu="modulepreload",xu=function(e){return"/"+e},_r={},Y=function(t,n,a){let s=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),i=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));s=Promise.allSettled(n.map(l=>{if(l=xu(l),l in _r)return;_r[l]=!0;const d=l.endsWith(".css"),u=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${u}`))return;const f=document.createElement("link");if(f.rel=d?"stylesheet":gu,d||(f.as="script"),f.crossOrigin="",f.href=l,i&&f.setAttribute("nonce",i),document.head.appendChild(f),d)return new Promise((m,b)=>{f.addEventListener("load",m),f.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${l}`)))})}))}function r(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return s.then(o=>{for(const i of o||[])i.status==="rejected"&&r(i.reason);return t().catch(r)})},Wo="https://faucet-4wvdcuoouq-uc.a.run.app";function va(){var e;return(w==null?void 0:w.faucet)||(R==null?void 0:R.faucet)||((e=window.contractAddresses)==null?void 0:e.faucet)||null}const ea=["function claim() external","function canClaim(address user) view returns (bool)","function lastClaimTime(address user) view returns (uint256)","function claimCooldown() view returns (uint256)","function claimAmountBKC() view returns (uint256)","function claimAmountETH() view returns (uint256)","event TokensClaimed(address indexed user, uint256 bkcAmount, uint256 ethAmount)"];function hu(){var e,t;return typeof State<"u"&&(State!=null&&State.userAddress)?State.userAddress:(e=window.State)!=null&&e.userAddress?window.State.userAddress:window.userAddress?window.userAddress:(t=window.ethereum)!=null&&t.selectedAddress?window.ethereum.selectedAddress:null}function wt(e,t="info"){if(typeof window.showToast=="function"){window.showToast(e,t);return}(t==="error"?console.error:console.log)(`[Faucet] ${e}`)}async function Go(){if(typeof window.loadUserData=="function"){await window.loadUserData();return}if(typeof window.refreshBalances=="function"){await window.refreshBalances();return}console.log("[Faucet] No refresh function available")}async function Ns({button:e=null,address:t=null,onSuccess:n=null,onError:a=null}={}){const s=t||hu();if(!s){const i="Please connect wallet first";return wt(i,"error"),a&&a(new Error(i)),{success:!1,error:i}}const r=(e==null?void 0:e.innerHTML)||"Claim",o=(e==null?void 0:e.disabled)||!1;e&&(e.innerHTML='<div class="loader inline-block"></div> Claiming...',e.disabled=!0);try{const i=await fetch(`${Wo}?address=${s}`,{method:"GET",headers:{Accept:"application/json"}}),l=await i.json();if(i.ok&&l.success){wt("✅ Tokens received!","success"),await Go();const d={success:!0,txHash:l.txHash,bkcAmount:l.bkcAmount,ethAmount:l.ethAmount};return n&&n(d),d}else{const d=l.error||l.message||"Faucet unavailable";wt(d,"error");const u=new Error(d);return a&&a(u),{success:!1,error:d}}}catch(i){return console.error("Faucet error:",i),wt("Faucet unavailable","error"),a&&a(i),{success:!1,error:i.message}}finally{e&&(e.innerHTML=r,e.disabled=o)}}const zs=async e=>await Ns({button:e});async function Ko({button:e=null,onSuccess:t=null,onError:n=null}={}){const a=va();if(!a){const r="Faucet contract address not configured";return wt(r,"error"),n&&n(new Error(r)),{success:!1,error:r}}const{txEngine:s}=await Y(async()=>{const{txEngine:r}=await import("./index-DxBdDQU9.js");return{txEngine:r}},[]);return await s.execute({name:"FaucetClaim",button:e,getContract:async r=>{const o=window.ethers;return new o.Contract(a,ea,r)},method:"claim",args:[],validate:async(r,o)=>{const i=window.ethers,l=new i.Contract(a,ea,r);if(!await l.canClaim(o)){const u=await l.lastClaimTime(o),f=await l.claimCooldown(),m=Number(u)+Number(f),b=Math.floor(Date.now()/1e3);if(m>b){const p=Math.ceil((m-b)/60);throw new Error(`Please wait ${p} minutes before claiming again`)}}},onSuccess:async r=>{wt("✅ Tokens received!","success"),await Go(),t&&t(r)},onError:r=>{wt(r.message||"Claim failed","error"),n&&n(r)}})}async function Yo(e){const t=va();if(!t)return{canClaim:!1,error:"Faucet not configured"};try{const n=window.ethers,{NetworkManager:a}=await Y(async()=>{const{NetworkManager:f}=await import("./index-DxBdDQU9.js");return{NetworkManager:f}},[]),s=a.getProvider(),r=new n.Contract(t,ea,s),[o,i,l]=await Promise.all([r.canClaim(e),r.lastClaimTime(e),r.claimCooldown()]),d=Number(i)+Number(l),u=Math.floor(Date.now()/1e3);return{canClaim:o,lastClaimTime:Number(i),cooldownSeconds:Number(l),nextClaimTime:d,waitSeconds:o?0:Math.max(0,d-u)}}catch(n){return console.error("Error checking claim status:",n),{canClaim:!1,error:n.message}}}async function Vo(){const e=va();if(!e)return{error:"Faucet not configured"};try{const t=window.ethers,{NetworkManager:n}=await Y(async()=>{const{NetworkManager:l}=await import("./index-DxBdDQU9.js");return{NetworkManager:l}},[]),a=n.getProvider(),s=new t.Contract(e,ea,a),[r,o,i]=await Promise.all([s.claimAmountBKC(),s.claimAmountETH(),s.claimCooldown()]);return{bkcAmount:r,ethAmount:o,cooldownSeconds:Number(i),cooldownMinutes:Number(i)/60,bkcAmountFormatted:t.formatEther(r),ethAmountFormatted:t.formatEther(o)}}catch(t){return console.error("Error getting faucet info:",t),{error:t.message}}}const vu={claim:Ns,claimOnChain:Ko,executeFaucetClaim:zs,canClaim:Yo,getFaucetInfo:Vo,getFaucetAddress:va,FAUCET_API_URL:Wo},wu=Object.freeze(Object.defineProperty({__proto__:null,FaucetTx:vu,canClaim:Yo,claim:Ns,claimOnChain:Ko,executeFaucetClaim:zs,getFaucetInfo:Vo},Symbol.toStringTag,{value:"Module"})),Fa={BALANCE:1e4,ALLOWANCE:3e4},ve=new Map,re={hits:0,misses:0,sets:0,invalidations:0},Et={get(e){const t=ve.get(e);if(!t){re.misses++;return}if(Date.now()>t.expiresAt){ve.delete(e),re.misses++;return}return re.hits++,t.value},set(e,t,n){t!=null&&(ve.set(e,{value:t,expiresAt:Date.now()+n,createdAt:Date.now()}),re.sets++)},delete(e){ve.delete(e)},clear(e){if(!e){ve.clear(),re.invalidations++;return}for(const t of ve.keys())t.includes(e)&&ve.delete(t);re.invalidations++},async getOrFetch(e,t,n){const a=this.get(e);if(a!==void 0)return a;try{const s=await t();return s!=null&&this.set(e,s,n),s}catch(s){throw console.warn(`[Cache] Error fetching ${e}:`,s.message),s}},has(e){return this.get(e)!==void 0},getTTL(e){const t=ve.get(e);if(!t)return 0;const n=t.expiresAt-Date.now();return n>0?n:0},invalidateByTx(e){const n={CreateCampaign:["campaign-","charity-stats","user-campaigns-","campaign-list"],Donate:["campaign-","charity-stats","token-balance-","allowance-"],CancelCampaign:["campaign-","charity-stats","user-campaigns-"],Withdraw:["campaign-","charity-stats","token-balance-"],Delegate:["delegation-","token-balance-","allowance-","user-pstake-","pending-rewards-","network-pstake"],Unstake:["delegation-","token-balance-","user-pstake-","pending-rewards-","network-pstake"],ForceUnstake:["delegation-","token-balance-","user-pstake-","pending-rewards-","network-pstake"],ClaimReward:["pending-rewards-","token-balance-","saved-rewards-"],BuyNFT:["pool-info-","pool-nfts-","token-balance-","allowance-","user-nfts-","buy-price-","sell-price-"],SellNFT:["pool-info-","pool-nfts-","token-balance-","user-nfts-","buy-price-","sell-price-"],PlayGame:["fortune-pool-","fortune-stats-","token-balance-","allowance-","user-fortune-history-"],ListNFT:["rental-listings-","rental-listing-","user-nfts-"],RentNFT:["rental-listing-","rental-active-","token-balance-","allowance-"],WithdrawNFT:["rental-listing-","rental-listings-","user-nfts-"],UpdateListing:["rental-listing-"],Notarize:["notary-","token-balance-","allowance-","user-documents-"],TokenTransfer:["token-balance-","allowance-"],Approval:["allowance-"]}[e];if(!n){console.warn(`[Cache] Unknown transaction type: ${e}`);return}n.forEach(a=>{this.clear(a)}),console.log(`[Cache] Invalidated patterns for ${e}:`,n)},getStats(){const e=ve.size,t=re.hits+re.misses>0?(re.hits/(re.hits+re.misses)*100).toFixed(1):0;return{entries:e,hits:re.hits,misses:re.misses,sets:re.sets,invalidations:re.invalidations,hitRate:`${t}%`}},keys(){return Array.from(ve.keys())},size(){return ve.size},cleanup(){const e=Date.now();let t=0;for(const[n,a]of ve.entries())e>a.expiresAt&&(ve.delete(n),t++);return t>0&&console.log(`[Cache] Cleanup removed ${t} expired entries`),t},resetMetrics(){re.hits=0,re.misses=0,re.sets=0,re.invalidations=0}},Ma={tokenBalance:(e,t)=>`token-balance-${e.toLowerCase()}-${t.toLowerCase()}`,ethBalance:e=>`eth-balance-${e.toLowerCase()}`,allowance:(e,t,n)=>`allowance-${e.toLowerCase()}-${t.toLowerCase()}-${n.toLowerCase()}`,campaign:e=>`campaign-${e}`,campaignList:()=>"campaign-list",charityStats:()=>"charity-stats",userCampaigns:e=>`user-campaigns-${e.toLowerCase()}`,delegation:(e,t)=>`delegation-${e.toLowerCase()}-${t}`,delegations:e=>`delegation-list-${e.toLowerCase()}`,userPStake:e=>`user-pstake-${e.toLowerCase()}`,pendingRewards:e=>`pending-rewards-${e.toLowerCase()}`,networkPStake:()=>"network-pstake",poolInfo:e=>`pool-info-${e.toLowerCase()}`,poolNfts:e=>`pool-nfts-${e.toLowerCase()}`,buyPrice:e=>`buy-price-${e.toLowerCase()}`,sellPrice:e=>`sell-price-${e.toLowerCase()}`,userNfts:e=>`user-nfts-${e.toLowerCase()}`,fortunePool:()=>"fortune-pool",fortuneTiers:()=>"fortune-tiers",fortuneStats:()=>"fortune-stats",userFortuneHistory:e=>`user-fortune-history-${e.toLowerCase()}`,rentalListings:()=>"rental-listings",rentalListing:e=>`rental-listing-${e}`,rentalActive:e=>`rental-active-${e}`,notaryDocument:e=>`notary-doc-${e}`,userDocuments:e=>`user-documents-${e.toLowerCase()}`,feeConfig:e=>`fee-config-${e}`,protocolConfig:()=>"protocol-config"},h={WRONG_NETWORK:"wrong_network",RPC_UNHEALTHY:"rpc_unhealthy",RPC_RATE_LIMITED:"rpc_rate_limited",NETWORK_ERROR:"network_error",WALLET_NOT_CONNECTED:"wallet_not_connected",WALLET_LOCKED:"wallet_locked",INSUFFICIENT_ETH:"insufficient_eth",INSUFFICIENT_TOKEN:"insufficient_token",INSUFFICIENT_ALLOWANCE:"insufficient_allowance",SIMULATION_REVERTED:"simulation_reverted",GAS_ESTIMATION_FAILED:"gas_estimation_failed",USER_REJECTED:"user_rejected",TX_REVERTED:"tx_reverted",TX_TIMEOUT:"tx_timeout",TX_REPLACED:"tx_replaced",TX_UNDERPRICED:"tx_underpriced",NONCE_ERROR:"nonce_error",CAMPAIGN_NOT_FOUND:"campaign_not_found",CAMPAIGN_NOT_ACTIVE:"campaign_not_active",CAMPAIGN_STILL_ACTIVE:"campaign_still_active",NOT_CAMPAIGN_CREATOR:"not_campaign_creator",DONATION_TOO_SMALL:"donation_too_small",MAX_CAMPAIGNS_REACHED:"max_campaigns_reached",INSUFFICIENT_ETH_FEE:"insufficient_eth_fee",LOCK_PERIOD_ACTIVE:"lock_period_active",LOCK_PERIOD_EXPIRED:"lock_period_expired",NO_REWARDS:"no_rewards",INVALID_DURATION:"invalid_duration",INVALID_DELEGATION_INDEX:"invalid_delegation_index",NFT_NOT_IN_POOL:"nft_not_in_pool",POOL_NOT_INITIALIZED:"pool_not_initialized",INSUFFICIENT_POOL_LIQUIDITY:"insufficient_pool_liquidity",SLIPPAGE_EXCEEDED:"slippage_exceeded",NFT_BOOST_MISMATCH:"nft_boost_mismatch",NOT_NFT_OWNER:"not_nft_owner",NO_ACTIVE_TIERS:"no_active_tiers",INVALID_GUESS_COUNT:"invalid_guess_count",INVALID_GUESS_RANGE:"invalid_guess_range",INSUFFICIENT_SERVICE_FEE:"insufficient_service_fee",RENTAL_STILL_ACTIVE:"rental_still_active",NFT_NOT_LISTED:"nft_not_listed",NFT_ALREADY_LISTED:"nft_already_listed",NOT_LISTING_OWNER:"not_listing_owner",MARKETPLACE_PAUSED:"marketplace_paused",EMPTY_METADATA:"empty_metadata",CONTRACT_ERROR:"contract_error",UNKNOWN:"unknown"},Da={[h.WRONG_NETWORK]:"Please switch to Arbitrum Sepolia network",[h.RPC_UNHEALTHY]:"Network connection issue. Retrying...",[h.RPC_RATE_LIMITED]:"Network is busy. Please wait a moment...",[h.NETWORK_ERROR]:"Network error. Please check your connection",[h.WALLET_NOT_CONNECTED]:"Please connect your wallet",[h.WALLET_LOCKED]:"Please unlock your wallet",[h.INSUFFICIENT_ETH]:"Insufficient ETH for gas fees",[h.INSUFFICIENT_TOKEN]:"Insufficient BKC balance",[h.INSUFFICIENT_ALLOWANCE]:"Token approval required",[h.SIMULATION_REVERTED]:"Transaction would fail. Please check your inputs",[h.GAS_ESTIMATION_FAILED]:"Could not estimate gas. Transaction may fail",[h.USER_REJECTED]:"Transaction cancelled",[h.TX_REVERTED]:"Transaction failed on blockchain",[h.TX_TIMEOUT]:"Transaction is taking too long. Please check your wallet",[h.TX_REPLACED]:"Transaction was replaced",[h.TX_UNDERPRICED]:"Gas price too low. Please try again",[h.NONCE_ERROR]:"Transaction sequence error. Please refresh and try again",[h.CAMPAIGN_NOT_FOUND]:"Campaign not found",[h.CAMPAIGN_NOT_ACTIVE]:"This campaign is no longer accepting donations",[h.CAMPAIGN_STILL_ACTIVE]:"Campaign is still active. Please wait until the deadline",[h.NOT_CAMPAIGN_CREATOR]:"Only the campaign creator can perform this action",[h.DONATION_TOO_SMALL]:"Donation amount is below the minimum required",[h.MAX_CAMPAIGNS_REACHED]:"You have reached the maximum number of active campaigns",[h.INSUFFICIENT_ETH_FEE]:"Insufficient ETH for withdrawal fee",[h.LOCK_PERIOD_ACTIVE]:"Your tokens are still locked",[h.LOCK_PERIOD_EXPIRED]:"Lock period has expired. Use normal unstake",[h.NO_REWARDS]:"No rewards available to claim",[h.INVALID_DURATION]:"Lock duration must be between 1 day and 10 years",[h.INVALID_DELEGATION_INDEX]:"Delegation not found",[h.NFT_NOT_IN_POOL]:"This NFT is not available in the pool",[h.POOL_NOT_INITIALIZED]:"Pool is not active yet",[h.INSUFFICIENT_POOL_LIQUIDITY]:"Insufficient liquidity in pool",[h.SLIPPAGE_EXCEEDED]:"Price changed too much. Please try again",[h.NFT_BOOST_MISMATCH]:"NFT tier does not match this pool",[h.NOT_NFT_OWNER]:"You do not own this NFT",[h.NO_ACTIVE_TIERS]:"No active prize tiers available",[h.INVALID_GUESS_COUNT]:"Invalid number of guesses provided",[h.INVALID_GUESS_RANGE]:"Your guess is outside the valid range",[h.INSUFFICIENT_SERVICE_FEE]:"Incorrect service fee amount",[h.RENTAL_STILL_ACTIVE]:"This NFT is currently being rented",[h.NFT_NOT_LISTED]:"This NFT is not listed for rent",[h.NFT_ALREADY_LISTED]:"This NFT is already listed",[h.NOT_LISTING_OWNER]:"Only the listing owner can perform this action",[h.MARKETPLACE_PAUSED]:"Marketplace is temporarily paused",[h.EMPTY_METADATA]:"Document metadata cannot be empty",[h.CONTRACT_ERROR]:"Transaction cannot be completed. Please check your inputs and try again",[h.UNKNOWN]:"An unexpected error occurred. Please try again"},mt={[h.WRONG_NETWORK]:{layer:1,retry:!1,action:"switch_network"},[h.RPC_UNHEALTHY]:{layer:1,retry:!0,waitMs:2e3,action:"switch_rpc"},[h.RPC_RATE_LIMITED]:{layer:1,retry:!0,waitMs:"extract",action:"switch_rpc"},[h.NETWORK_ERROR]:{layer:1,retry:!0,waitMs:3e3,action:"switch_rpc"},[h.WALLET_NOT_CONNECTED]:{layer:2,retry:!1,action:"connect_wallet"},[h.WALLET_LOCKED]:{layer:2,retry:!1,action:"unlock_wallet"},[h.INSUFFICIENT_ETH]:{layer:3,retry:!1,action:"show_faucet"},[h.INSUFFICIENT_TOKEN]:{layer:3,retry:!1},[h.INSUFFICIENT_ALLOWANCE]:{layer:3,retry:!1},[h.SIMULATION_REVERTED]:{layer:4,retry:!1},[h.GAS_ESTIMATION_FAILED]:{layer:4,retry:!0,waitMs:2e3},[h.USER_REJECTED]:{layer:5,retry:!1},[h.TX_REVERTED]:{layer:5,retry:!1},[h.TX_TIMEOUT]:{layer:5,retry:!0,waitMs:5e3},[h.TX_REPLACED]:{layer:5,retry:!1},[h.TX_UNDERPRICED]:{layer:5,retry:!0,waitMs:1e3},[h.NONCE_ERROR]:{layer:5,retry:!0,waitMs:2e3},[h.CAMPAIGN_NOT_FOUND]:{layer:4,retry:!1},[h.CAMPAIGN_NOT_ACTIVE]:{layer:4,retry:!1},[h.CAMPAIGN_STILL_ACTIVE]:{layer:4,retry:!1},[h.NOT_CAMPAIGN_CREATOR]:{layer:4,retry:!1},[h.DONATION_TOO_SMALL]:{layer:4,retry:!1},[h.MAX_CAMPAIGNS_REACHED]:{layer:4,retry:!1},[h.INSUFFICIENT_ETH_FEE]:{layer:3,retry:!1},[h.LOCK_PERIOD_ACTIVE]:{layer:4,retry:!1},[h.LOCK_PERIOD_EXPIRED]:{layer:4,retry:!1},[h.NO_REWARDS]:{layer:4,retry:!1},[h.INVALID_DURATION]:{layer:4,retry:!1},[h.INVALID_DELEGATION_INDEX]:{layer:4,retry:!1},[h.NFT_NOT_IN_POOL]:{layer:4,retry:!1},[h.POOL_NOT_INITIALIZED]:{layer:4,retry:!1},[h.INSUFFICIENT_POOL_LIQUIDITY]:{layer:4,retry:!1},[h.SLIPPAGE_EXCEEDED]:{layer:4,retry:!0,waitMs:1e3},[h.NFT_BOOST_MISMATCH]:{layer:4,retry:!1},[h.NOT_NFT_OWNER]:{layer:4,retry:!1},[h.NO_ACTIVE_TIERS]:{layer:4,retry:!1},[h.INVALID_GUESS_COUNT]:{layer:4,retry:!1},[h.INVALID_GUESS_RANGE]:{layer:4,retry:!1},[h.INSUFFICIENT_SERVICE_FEE]:{layer:4,retry:!1},[h.RENTAL_STILL_ACTIVE]:{layer:4,retry:!1},[h.NFT_NOT_LISTED]:{layer:4,retry:!1},[h.NFT_ALREADY_LISTED]:{layer:4,retry:!1},[h.NOT_LISTING_OWNER]:{layer:4,retry:!1},[h.MARKETPLACE_PAUSED]:{layer:4,retry:!1},[h.EMPTY_METADATA]:{layer:4,retry:!1},[h.CONTRACT_ERROR]:{layer:4,retry:!1},[h.UNKNOWN]:{layer:5,retry:!1}},Fr=[{pattern:/user rejected/i,type:h.USER_REJECTED},{pattern:/user denied/i,type:h.USER_REJECTED},{pattern:/user cancel/i,type:h.USER_REJECTED},{pattern:/rejected by user/i,type:h.USER_REJECTED},{pattern:/cancelled/i,type:h.USER_REJECTED},{pattern:/canceled/i,type:h.USER_REJECTED},{pattern:/action_rejected/i,type:h.USER_REJECTED},{pattern:/too many errors/i,type:h.RPC_RATE_LIMITED},{pattern:/rate limit/i,type:h.RPC_RATE_LIMITED},{pattern:/retrying in/i,type:h.RPC_RATE_LIMITED},{pattern:/429/i,type:h.RPC_RATE_LIMITED},{pattern:/internal json-rpc/i,type:h.RPC_UNHEALTHY},{pattern:/-32603/i,type:h.RPC_UNHEALTHY},{pattern:/-32002/i,type:h.RPC_RATE_LIMITED},{pattern:/failed to fetch/i,type:h.NETWORK_ERROR},{pattern:/network error/i,type:h.NETWORK_ERROR},{pattern:/timeout/i,type:h.TX_TIMEOUT},{pattern:/insufficient funds/i,type:h.INSUFFICIENT_ETH},{pattern:/exceeds the balance/i,type:h.INSUFFICIENT_ETH},{pattern:/insufficient balance/i,type:h.INSUFFICIENT_TOKEN},{pattern:/transfer amount exceeds balance/i,type:h.INSUFFICIENT_TOKEN},{pattern:/exceeds balance/i,type:h.INSUFFICIENT_TOKEN},{pattern:/nonce/i,type:h.NONCE_ERROR},{pattern:/replacement.*underpriced/i,type:h.TX_UNDERPRICED},{pattern:/transaction underpriced/i,type:h.TX_UNDERPRICED},{pattern:/gas too low/i,type:h.TX_UNDERPRICED},{pattern:/reverted/i,type:h.TX_REVERTED},{pattern:/revert/i,type:h.TX_REVERTED},{pattern:/campaignnotfound/i,type:h.CAMPAIGN_NOT_FOUND},{pattern:/campaign not found/i,type:h.CAMPAIGN_NOT_FOUND},{pattern:/campaignnotactive/i,type:h.CAMPAIGN_NOT_ACTIVE},{pattern:/campaign.*not.*active/i,type:h.CAMPAIGN_NOT_ACTIVE},{pattern:/campaignstillactive/i,type:h.CAMPAIGN_STILL_ACTIVE},{pattern:/notcampaigncreator/i,type:h.NOT_CAMPAIGN_CREATOR},{pattern:/donationtoosmall/i,type:h.DONATION_TOO_SMALL},{pattern:/maxactivecampaignsreached/i,type:h.MAX_CAMPAIGNS_REACHED},{pattern:/insufficientethfee/i,type:h.INSUFFICIENT_ETH_FEE},{pattern:/lockperiodactive/i,type:h.LOCK_PERIOD_ACTIVE},{pattern:/lock.*period.*active/i,type:h.LOCK_PERIOD_ACTIVE},{pattern:/still.*locked/i,type:h.LOCK_PERIOD_ACTIVE},{pattern:/lockperiodexpired/i,type:h.LOCK_PERIOD_EXPIRED},{pattern:/norewardstoclaim/i,type:h.NO_REWARDS},{pattern:/no.*rewards/i,type:h.NO_REWARDS},{pattern:/invalidduration/i,type:h.INVALID_DURATION},{pattern:/invalidindex/i,type:h.INVALID_DELEGATION_INDEX},{pattern:/nftnotinpool/i,type:h.NFT_NOT_IN_POOL},{pattern:/poolnotinitialized/i,type:h.POOL_NOT_INITIALIZED},{pattern:/insufficientliquidity/i,type:h.INSUFFICIENT_POOL_LIQUIDITY},{pattern:/insufficientnfts/i,type:h.INSUFFICIENT_POOL_LIQUIDITY},{pattern:/slippageexceeded/i,type:h.SLIPPAGE_EXCEEDED},{pattern:/slippage/i,type:h.SLIPPAGE_EXCEEDED},{pattern:/nftboostmismatch/i,type:h.NFT_BOOST_MISMATCH},{pattern:/notnftowner/i,type:h.NOT_NFT_OWNER},{pattern:/noactivetiers/i,type:h.NO_ACTIVE_TIERS},{pattern:/invalidguesscount/i,type:h.INVALID_GUESS_COUNT},{pattern:/invalidguessrange/i,type:h.INVALID_GUESS_RANGE},{pattern:/insufficientservicefee/i,type:h.INSUFFICIENT_SERVICE_FEE},{pattern:/rentalstillactive/i,type:h.RENTAL_STILL_ACTIVE},{pattern:/nftnotlisted/i,type:h.NFT_NOT_LISTED},{pattern:/nftalreadylisted/i,type:h.NFT_ALREADY_LISTED},{pattern:/notlistingowner/i,type:h.NOT_LISTING_OWNER},{pattern:/marketplaceispaused/i,type:h.MARKETPLACE_PAUSED},{pattern:/emptymetadata/i,type:h.EMPTY_METADATA}],q={classify(e){var a;if(e!=null&&e.errorType&&Object.values(h).includes(e.errorType))return e.errorType;const t=this._extractMessage(e),n=(e==null?void 0:e.code)||((a=e==null?void 0:e.error)==null?void 0:a.code);if(n===4001||n==="ACTION_REJECTED")return h.USER_REJECTED;if(n===-32002)return h.RPC_RATE_LIMITED;if(n===-32603||n==="CALL_EXCEPTION"){if(t.includes("revert")||t.includes("require")||t.includes("execution failed")||t.includes("call_exception")||(e==null?void 0:e.code)==="CALL_EXCEPTION"){for(const{pattern:s,type:r}of Fr)if(s.test(t))return r;return h.CONTRACT_ERROR}return h.RPC_UNHEALTHY}for(const{pattern:s,type:r}of Fr)if(s.test(t))return r;return h.UNKNOWN},_extractMessage(e){var n,a,s;return e?typeof e=="string"?e:[e.message,e.reason,(n=e.error)==null?void 0:n.message,(a=e.error)==null?void 0:a.reason,(s=e.data)==null?void 0:s.message,e.shortMessage,this._safeStringify(e)].filter(Boolean).join(" ").toLowerCase():""},_safeStringify(e){try{return JSON.stringify(e,(t,n)=>typeof n=="bigint"?n.toString():n)}catch{return""}},isUserRejection(e){return this.classify(e)===h.USER_REJECTED},isRetryable(e){var n;const t=this.classify(e);return((n=mt[t])==null?void 0:n.retry)||!1},getWaitTime(e){const t=this.classify(e),n=mt[t];return n?n.waitMs==="extract"?this._extractWaitTime(e):n.waitMs||2e3:2e3},_extractWaitTime(e){const t=this._extractMessage(e),n=t.match(/retrying in (\d+[,.]?\d*)\s*minutes?/i);if(n){const s=parseFloat(n[1].replace(",","."));return Math.ceil(s*60*1e3)+5e3}const a=t.match(/wait (\d+)\s*seconds?/i);return a?parseInt(a[1])*1e3+2e3:3e4},getMessage(e){const t=this.classify(e);return Da[t]||Da[h.UNKNOWN]},getConfig(e){const t=this.classify(e);return mt[t]||mt[h.UNKNOWN]},getLayer(e){var n;const t=this.classify(e);return((n=mt[t])==null?void 0:n.layer)||5},handle(e,t="Transaction"){const n=this.classify(e),a=mt[n]||{},s=this.getMessage(e);return console.error(`[${t}] Error:`,{type:n,layer:a.layer,retry:a.retry,message:s,original:e}),{type:n,message:s,retry:a.retry||!1,waitMs:a.retry?this.getWaitTime(e):0,layer:a.layer||5,action:a.action||null,original:e,context:t}},async handleWithRpcSwitch(e,t="Transaction"){const n=this.handle(e,t);if(n.action==="switch_rpc")try{const{NetworkManager:a}=await Y(async()=>{const{NetworkManager:r}=await Promise.resolve().then(()=>Iu);return{NetworkManager:r}},void 0);console.log("[ErrorHandler] Switching RPC due to network error...");const s=a.switchToNextRpc();try{await a.updateMetaMaskRpcs(),console.log("[ErrorHandler] MetaMask RPC updated")}catch(r){console.warn("[ErrorHandler] Could not update MetaMask:",r.message)}n.rpcSwitched=!0,n.newRpc=s,n.waitMs=Math.min(n.waitMs,2e3)}catch(a){console.warn("[ErrorHandler] Could not switch RPC:",a.message),n.rpcSwitched=!1}return n},parseSimulationError(e,t){var o;const n=this.classify(e);let a=this.getMessage(e);const r=(o={donate:{[h.CAMPAIGN_NOT_ACTIVE]:"This campaign has ended and is no longer accepting donations",[h.DONATION_TOO_SMALL]:"Minimum donation is 1 BKC"},delegate:{[h.INVALID_DURATION]:"Lock period must be between 1 day and 10 years"},playGame:{[h.INVALID_GUESS_RANGE]:"Your guess must be within the valid range for this tier"},withdraw:{[h.CAMPAIGN_STILL_ACTIVE]:"You can withdraw after the campaign deadline"},unstake:{[h.LOCK_PERIOD_ACTIVE]:"Your tokens are still locked. Use force unstake to withdraw early (penalty applies)"},claimRewards:{[h.CONTRACT_ERROR]:"No rewards available to claim",[h.NO_REWARDS]:"No rewards available to claim"}}[t])==null?void 0:o[n];return r&&(a=r),{type:n,message:a,original:e,method:t,isSimulation:!0}},create(e,t={}){const n=Da[e]||"An error occurred",a=new Error(n);return a.errorType=e,a.extra=t,a},getAction(e){var n;const t=this.classify(e);return((n=mt[t])==null?void 0:n.action)||null}},ee={chainId:421614,chainIdHex:"0x66eee",name:"Arbitrum Sepolia",nativeCurrency:{name:"Ethereum",symbol:"ETH",decimals:18},blockExplorer:"https://sepolia.arbiscan.io"};function Ye(){const e="ZWla0YY4A0Hw7e_rwyOXB";return e?`https://arb-sepolia.g.alchemy.com/v2/${e}`:null}const yu=[{name:"Alchemy",getUrl:Ye,priority:1,isPublic:!1,isPaid:!0},{name:"Arbitrum Official",getUrl:()=>"https://sepolia-rollup.arbitrum.io/rpc",priority:2,isPublic:!0,isPaid:!1},{name:"PublicNode",getUrl:()=>"https://arbitrum-sepolia-rpc.publicnode.com",priority:3,isPublic:!0,isPaid:!1},{name:"Ankr",getUrl:()=>"https://rpc.ankr.com/arbitrum_sepolia",priority:4,isPublic:!0,isPaid:!1}];let et=0,Rt=null,ft=null,Wn=0,Gn=0,$t=!0;const ku=3,Eu=3e4,Tu=5e3,Mr=6e4,Cu=2e3,oe={getCurrentRpcUrl(){const e=Ye();if(e&&$t)return e;const t=this.getAvailableEndpoints();if(t.length===0)throw new Error("No RPC endpoints available");return t[et%t.length].getUrl()},getPrimaryRpcUrl(){return Ye()},getAvailableEndpoints(){return yu.filter(e=>e.getUrl()!==null).sort((e,t)=>e.priority-t.priority)},getRpcUrlsForMetaMask(){const e=Ye(),t=this.getAvailableEndpoints().filter(n=>n.isPublic).map(n=>n.getUrl()).filter(Boolean);return e?[e,...t]:t},switchToNextRpc(e=!0){const t=this.getAvailableEndpoints();if($t&&Ye()){$t=!1,et=0;const s=t.find(r=>r.isPublic);if(s)return console.log(`[Network] Alchemy temporarily unavailable, using: ${s.name}`),e&&setTimeout(()=>{console.log("[Network] Retrying Alchemy..."),$t=!0,et=0},Cu),s.getUrl()}const n=t.filter(s=>s.isPublic);if(n.length<=1)return console.warn("[Network] No alternative RPCs available"),this.getCurrentRpcUrl();et=(et+1)%n.length;const a=n[et];return console.log(`[Network] Switched to RPC: ${a.name}`),a.getUrl()},resetToAlchemy(){Ye()&&($t=!0,et=0,console.log("[Network] Reset to Alchemy RPC"))},isRateLimitError(e){var a;const t=((a=e==null?void 0:e.message)==null?void 0:a.toLowerCase())||"",n=e==null?void 0:e.code;return n===-32002||n===-32005||t.includes("rate limit")||t.includes("too many")||t.includes("exceeded")||t.includes("throttled")||t.includes("429")},async handleRateLimit(e){const t=this.getCurrentRpcUrl(),n=Ye();if(n&&t===n)return console.warn("[Network] Alchemy rate limited (check your plan limits)"),await new Promise(o=>setTimeout(o,1e3)),n;console.warn("[Network] Public RPC rate limited, switching...");const s=this.switchToNextRpc(),r=Date.now();if(r-Gn>Mr)try{await this.updateMetaMaskRpcs(),Gn=r}catch(o){console.warn("[Network] Could not update MetaMask:",o.message)}return s},async getWorkingProvider(){const e=window.ethers,t=Ye();if(t)try{const a=new e.JsonRpcProvider(t);return await Promise.race([a.getBlockNumber(),new Promise((s,r)=>setTimeout(()=>r(new Error("timeout")),3e3))]),$t=!0,a}catch(a){console.warn("[Network] Alchemy temporarily unavailable:",a.message)}const n=this.getAvailableEndpoints().filter(a=>a.isPublic);for(const a of n)try{const s=a.getUrl(),r=new e.JsonRpcProvider(s);return await Promise.race([r.getBlockNumber(),new Promise((o,i)=>setTimeout(()=>i(new Error("timeout")),3e3))]),console.log(`[Network] Using fallback RPC: ${a.name}`),r}catch{console.warn(`[Network] RPC ${a.name} failed, trying next...`)}if(t)return new e.JsonRpcProvider(t);throw new Error("No working RPC endpoints available")},async isCorrectNetwork(){if(!window.ethereum)return!1;try{const e=await window.ethereum.request({method:"eth_chainId"});return parseInt(e,16)===ee.chainId}catch(e){return console.error("[Network] Error checking network:",e),!1}},async getCurrentChainId(){if(!window.ethereum)return null;try{const e=await window.ethereum.request({method:"eth_chainId"});return parseInt(e,16)}catch{return null}},async checkRpcHealth(){const e=Date.now(),t=this.getCurrentRpcUrl();try{const n=new AbortController,a=setTimeout(()=>n.abort(),Tu),s=await fetch(t,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({jsonrpc:"2.0",method:"eth_blockNumber",params:[],id:1}),signal:n.signal});if(clearTimeout(a),!s.ok)throw new Error(`HTTP ${s.status}`);const r=await s.json();if(r.error)throw new Error(r.error.message||"RPC error");const o=Date.now()-e;return Wn=0,ft={healthy:!0,latency:o,blockNumber:parseInt(r.result,16),timestamp:Date.now()},ft}catch(n){Wn++;const a={healthy:!1,latency:Date.now()-e,error:n.message,timestamp:Date.now()};return ft=a,Wn>=ku&&(console.warn("[Network] Too many RPC failures, switching..."),this.switchToNextRpc(),Wn=0),a}},getLastHealthCheck(){return ft},async isRpcHealthy(e=1e4){return ft&&Date.now()-ft.timestamp<e?ft.healthy:(await this.checkRpcHealth()).healthy},async switchNetwork(){if(!window.ethereum)throw q.create(h.WALLET_NOT_CONNECTED);try{return await window.ethereum.request({method:"wallet_switchEthereumChain",params:[{chainId:ee.chainIdHex}]}),console.log("[Network] Switched to",ee.name),!0}catch(e){if(e.code===4902)return await this.addNetwork();throw e.code===4001?q.create(h.USER_REJECTED):e}},async addNetwork(){if(!window.ethereum)throw q.create(h.WALLET_NOT_CONNECTED);const e=this.getRpcUrlsForMetaMask();try{return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:ee.chainIdHex,chainName:ee.name,nativeCurrency:ee.nativeCurrency,rpcUrls:e,blockExplorerUrls:[ee.blockExplorer]}]}),console.log("[Network] Added network:",ee.name),!0}catch(t){throw t.code===4001?q.create(h.USER_REJECTED):t}},async updateMetaMaskRpcs(){if(!window.ethereum)return!1;const e=Date.now();if(e-Gn<Mr)return console.log("[Network] MetaMask update on cooldown, skipping..."),!1;if(!await this.isCorrectNetwork())return console.log("[Network] Not on correct network, skipping RPC update"),!1;const n=this.getRpcUrlsForMetaMask();try{return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:ee.chainIdHex,chainName:ee.name,nativeCurrency:ee.nativeCurrency,rpcUrls:n,blockExplorerUrls:[ee.blockExplorer]}]}),Gn=e,console.log("[Network] MetaMask RPCs updated with:",n[0]),!0}catch(a){return console.warn("[Network] Could not update MetaMask RPCs:",a.message),!1}},async forceResetMetaMaskRpc(){if(!window.ethereum)return!1;const e=Ye();if(!e)return console.warn("[Network] Alchemy not configured"),!1;try{try{await window.ethereum.request({method:"wallet_switchEthereumChain",params:[{chainId:"0x1"}]})}catch{}return await window.ethereum.request({method:"wallet_addEthereumChain",params:[{chainId:ee.chainIdHex,chainName:ee.name+" (Alchemy)",nativeCurrency:ee.nativeCurrency,rpcUrls:[e],blockExplorerUrls:[ee.blockExplorer]}]}),console.log("[Network] MetaMask reset to Alchemy RPC"),!0}catch(t){return console.error("[Network] Failed to reset MetaMask:",t.message),!1}},getProvider(){const e=window.ethers;if(!e)throw new Error("ethers.js not loaded");return new e.JsonRpcProvider(this.getCurrentRpcUrl())},getBrowserProvider(){const e=window.ethers;if(!e)throw new Error("ethers.js not loaded");if(!window.ethereum)throw q.create(h.WALLET_NOT_CONNECTED);return new e.BrowserProvider(window.ethereum)},async getSigner(){var t,n;const e=this.getBrowserProvider();try{return await e.getSigner()}catch(a){if((t=a.message)!=null&&t.includes("ENS")||a.code==="UNSUPPORTED_OPERATION")try{const s=await window.ethereum.request({method:"eth_accounts"});if(s&&s.length>0)return await e.getSigner(s[0])}catch(s){console.warn("Signer fallback failed:",s)}throw a.code===4001||(n=a.message)!=null&&n.includes("user rejected")?q.create(h.USER_REJECTED):q.create(h.WALLET_NOT_CONNECTED)}},async getConnectedAddress(){if(!window.ethereum)return null;try{return(await window.ethereum.request({method:"eth_accounts"}))[0]||null}catch{return null}},async requestConnection(){if(!window.ethereum)throw q.create(h.WALLET_NOT_CONNECTED);try{const e=await window.ethereum.request({method:"eth_requestAccounts"});if(!e||e.length===0)throw q.create(h.WALLET_NOT_CONNECTED);return e[0]}catch(e){throw e.code===4001?q.create(h.USER_REJECTED):e}},startHealthMonitoring(e=Eu){Rt&&this.stopHealthMonitoring(),this.checkRpcHealth(),Rt=setInterval(()=>{this.checkRpcHealth()},e),console.log("[Network] Health monitoring started")},stopHealthMonitoring(){Rt&&(clearInterval(Rt),Rt=null,console.log("[Network] Health monitoring stopped"))},isMonitoring(){return Rt!==null},formatAddress(e,t=4){return e?`${e.slice(0,t+2)}...${e.slice(-t)}`:""},getAddressExplorerUrl(e){return`${ee.blockExplorer}/address/${e}`},getTxExplorerUrl(e){return`${ee.blockExplorer}/tx/${e}`},isMetaMaskInstalled(){return typeof window.ethereum<"u"&&window.ethereum.isMetaMask},async getStatus(){var a;const[e,t,n]=await Promise.all([this.isCorrectNetwork(),this.getConnectedAddress(),this.checkRpcHealth()]);return{isConnected:!!t,address:t,isCorrectNetwork:e,currentChainId:await this.getCurrentChainId(),targetChainId:ee.chainId,rpcHealthy:n.healthy,rpcLatency:n.latency,currentRpc:((a=this.getAvailableEndpoints()[et])==null?void 0:a.name)||"Unknown"}}},Iu=Object.freeze(Object.defineProperty({__proto__:null,NETWORK_CONFIG:ee,NetworkManager:oe},Symbol.toStringTag,{value:"Module"})),je={SAFETY_MARGIN_PERCENT:20,MIN_GAS_LIMITS:{transfer:21000n,erc20Transfer:65000n,erc20Approve:50000n,contractCall:100000n,complexCall:300000n},MAX_GAS_LIMIT:15000000n,MIN_GAS_PRICE_GWEI:.01,MAX_GAS_PRICE_GWEI:100,GAS_PRICE_CACHE_TTL:15e3},Au={async estimateGas(e,t,n=[],a={}){try{return await e[t].estimateGas(...n,a)}catch(s){throw s}},async estimateGasWithMargin(e,t,n=[],a={}){const s=await this.estimateGas(e,t,n,a);return this.addSafetyMargin(s)},addSafetyMargin(e,t=je.SAFETY_MARGIN_PERCENT){const n=BigInt(e),a=n*BigInt(t)/100n;let s=n+a;return s>je.MAX_GAS_LIMIT&&(console.warn("[Gas] Estimate exceeds max limit, capping"),s=je.MAX_GAS_LIMIT),s},getMinGasLimit(e="contractCall"){return je.MIN_GAS_LIMITS[e]||je.MIN_GAS_LIMITS.contractCall},async getGasPrice(){return await Et.getOrFetch("gas-price-current",async()=>(await oe.getProvider().getFeeData()).gasPrice||0n,je.GAS_PRICE_CACHE_TTL)},async getFeeData(){return await Et.getOrFetch("gas-fee-data",async()=>{const n=await oe.getProvider().getFeeData();return{gasPrice:n.gasPrice||0n,maxFeePerGas:n.maxFeePerGas||0n,maxPriorityFeePerGas:n.maxPriorityFeePerGas||0n}},je.GAS_PRICE_CACHE_TTL)},async getGasPriceGwei(){const e=window.ethers,t=await this.getGasPrice();return parseFloat(e.formatUnits(t,"gwei"))},async calculateCost(e,t=null){const n=window.ethers;t||(t=await this.getGasPrice());const a=BigInt(e)*BigInt(t),s=n.formatEther(a);return{wei:a,eth:parseFloat(s),formatted:this.formatEth(s)}},async estimateTransactionCost(e,t,n=[],a={}){const s=await this.estimateGas(e,t,n,a),r=this.addSafetyMargin(s),o=await this.getGasPrice(),i=await this.calculateCost(r,o);return{gasEstimate:s,gasWithMargin:r,gasPrice:o,...i}},async validateGasBalance(e,t,n=null){const a=window.ethers,s=oe.getProvider();n||(n=await this.getGasPrice());const r=await s.getBalance(e),o=BigInt(t)*BigInt(n),i=r>=o;return{sufficient:i,balance:r,required:o,shortage:i?0n:o-r,balanceFormatted:a.formatEther(r),requiredFormatted:a.formatEther(o)}},async hasMinimumGas(e,t=null){const n=window.ethers,s=await oe.getProvider().getBalance(e),r=t||n.parseEther("0.001");return s>=r},formatEth(e,t=6){const n=parseFloat(e);return n===0?"0 ETH":n<1e-6?"< 0.000001 ETH":`${n.toFixed(t).replace(/\.?0+$/,"")} ETH`},formatGasPrice(e){const t=window.ethers,n=parseFloat(t.formatUnits(e,"gwei"));return n<.01?"< 0.01 gwei":n<1?`${n.toFixed(2)} gwei`:`${n.toFixed(1)} gwei`},formatGasLimit(e){return Number(e).toLocaleString()},formatGasSummary(e){return`~${e.formatted} (${this.formatGasLimit(e.gasWithMargin||0n)} gas)`},compareEstimates(e,t){const n=BigInt(e),a=BigInt(t);if(a===0n)return 0;const s=n>a?n-a:a-n;return Number(s*100n/a)},isGasPriceReasonable(e){const t=window.ethers,n=parseFloat(t.formatUnits(e,"gwei"));return n<je.MIN_GAS_PRICE_GWEI?{reasonable:!1,warning:"Gas price unusually low, transaction may be slow"}:n>je.MAX_GAS_PRICE_GWEI?{reasonable:!1,warning:"Gas price unusually high, consider waiting"}:{reasonable:!0,warning:null}},async getRecommendedSettings(e){const t=await this.getFeeData();return{gasLimit:this.addSafetyMargin(e),maxFeePerGas:t.maxFeePerGas,maxPriorityFeePerGas:t.maxPriorityFeePerGas}},async createTxOverrides(e,t={}){return{gasLimit:(await this.getRecommendedSettings(e)).gasLimit,...t}}},Dr=500000000000000n,Or=["function balanceOf(address owner) view returns (uint256)","function allowance(address owner, address spender) view returns (uint256)","function decimals() view returns (uint8)","function symbol() view returns (string)"],X={async validateNetwork(){if(!await oe.isCorrectNetwork()){const t=await oe.getCurrentChainId();throw q.create(h.WRONG_NETWORK,{currentChainId:t,expectedChainId:ee.chainId})}},async validateRpcHealth(){const e=await oe.checkRpcHealth();if(!e.healthy&&(oe.switchToNextRpc(),!(await oe.checkRpcHealth()).healthy))throw q.create(h.RPC_UNHEALTHY,{error:e.error})},async validateWalletConnected(e=null){if(!window.ethereum)throw q.create(h.WALLET_NOT_CONNECTED);const t=e||await oe.getConnectedAddress();if(!t)throw q.create(h.WALLET_NOT_CONNECTED);return t},async validatePreTransaction(){return await this.validateNetwork(),await this.validateRpcHealth(),await this.validateWalletConnected()},async validateEthForGas(e,t=Dr){const n=window.ethers,a=Ma.ethBalance(e),s=await Et.getOrFetch(a,async()=>await oe.getProvider().getBalance(e),Fa.BALANCE);if(s<t)throw q.create(h.INSUFFICIENT_ETH,{balance:n.formatEther(s),required:n.formatEther(t)});return s},async validateTokenBalance(e,t,n){const a=window.ethers,s=Ma.tokenBalance(e,n),r=await Et.getOrFetch(s,async()=>{const o=oe.getProvider();return await new a.Contract(e,Or,o).balanceOf(n)},Fa.BALANCE);if(r<t)throw q.create(h.INSUFFICIENT_TOKEN,{balance:a.formatEther(r),required:a.formatEther(t)});return r},async needsApproval(e,t,n,a){const s=window.ethers,r=Ma.allowance(e,a,t);return await Et.getOrFetch(r,async()=>{const i=oe.getProvider();return await new s.Contract(e,Or,i).allowance(a,t)},Fa.ALLOWANCE)<n},async validateAllowance(e,t,n,a){if(await this.needsApproval(e,t,n,a))throw q.create(h.INSUFFICIENT_ALLOWANCE,{token:e,spender:t,required:n.toString()})},async validateBalances({userAddress:e,tokenAddress:t=null,tokenAmount:n=null,spenderAddress:a=null,ethAmount:s=Dr}){await this.validateEthForGas(e,s),t&&n&&await this.validateTokenBalance(t,n,e)},validatePositive(e,t="Amount"){if(BigInt(e)<=0n)throw new Error(`${t} must be greater than zero`)},validateRange(e,t,n,a="Value"){const s=BigInt(e),r=BigInt(t),o=BigInt(n);if(s<r||s>o)throw new Error(`${a} must be between ${t} and ${n}`)},validateNotEmpty(e,t="Field"){if(!e||e.trim().length===0)throw new Error(`${t} cannot be empty`)},validateAddress(e,t="Address"){const n=window.ethers;if(!e||!n.isAddress(e))throw new Error(`Invalid ${t}`)},charity:{validateCreateCampaign({title:e,description:t,goalAmount:n,durationDays:a}){X.validateNotEmpty(e,"Title"),X.validateNotEmpty(t,"Description"),X.validatePositive(n,"Goal amount"),X.validateRange(a,1,180,"Duration")},validateDonate({campaignId:e,amount:t}){if(e==null)throw new Error("Campaign ID is required");X.validatePositive(t,"Donation amount")}},staking:{validateDelegate({amount:e,lockDays:t}){X.validatePositive(e,"Stake amount"),X.validateRange(t,1,3650,"Lock duration")},validateUnstake({delegationIndex:e}){if(e==null||e<0)throw new Error("Invalid delegation index")}},nftPool:{validateBuy({maxPrice:e}){e!=null&&X.validatePositive(e,"Max price")},validateSell({tokenId:e,minPayout:t}){if(e==null)throw new Error("Token ID is required");t!=null&&X.validatePositive(t,"Min payout")}},fortune:{validatePlay({wagerAmount:e,guesses:t,isCumulative:n}){if(X.validatePositive(e,"Wager amount"),!Array.isArray(t)||t.length===0)throw new Error("At least one guess is required");t.forEach((a,s)=>{if(typeof a!="number"||a<1)throw new Error(`Invalid guess at position ${s+1}`)})}},rental:{validateList({tokenId:e,pricePerHour:t,minHours:n,maxHours:a}){if(e==null)throw new Error("Token ID is required");X.validatePositive(t,"Price per hour"),X.validateRange(n,1,720,"Minimum hours"),X.validateRange(a,n,720,"Maximum hours")},validateRent({tokenId:e,hours:t}){if(e==null)throw new Error("Token ID is required");X.validatePositive(t,"Rental hours")}},notary:{validateNotarize({ipfsCid:e,description:t,contentHash:n}){if(X.validateNotEmpty(e,"IPFS CID"),n&&(n.startsWith("0x")?n.slice(2):n).length!==64)throw new Error("Content hash must be 32 bytes")}}},Kn={DEFAULT_MAX_RETRIES:2,RETRY_BASE_DELAY:2e3,APPROVAL_MULTIPLIER:10n,APPROVAL_WAIT_TIME:1500,CONFIRMATION_TIMEOUT:6e4,CONFIRMATION_RETRY_DELAY:3e3,GAS_SAFETY_MARGIN:20,DEFAULT_GAS_LIMIT:500000n},Hr=["function approve(address spender, uint256 amount) returns (bool)","function allowance(address owner, address spender) view returns (uint256)"];class Bu{constructor(t,n,a=!0){this.button=t,this.txName=n,this.showToasts=a,this.originalContent=null,this.originalDisabled=!1,this.button&&(this.originalContent=this.button.innerHTML,this.originalDisabled=this.button.disabled)}setPhase(t){if(!this.button)return;const a={validating:{text:"Validating...",icon:"🔍"},approving:{text:"Approving...",icon:"✅"},simulating:{text:"Simulating...",icon:"🧪"},confirming:{text:"Confirm in Wallet",icon:"👛"},waiting:{text:"Processing...",icon:"⏳"},success:{text:"Success!",icon:"🎉"},error:{text:"Failed",icon:"❌"}}[t]||{text:t,icon:"⏳"};this.button.disabled=!0,this.button.innerHTML=`
        ...
        `)}cleanup(){this.button&&(this.button.innerHTML=this.originalContent,this.button.disabled=this.originalDisabled)}showSuccess(t=2e3){this.setPhase("success"),setTimeout(()=>this.cleanup(),t)}showError(t=2e3){this.setPhase("error"),setTimeout(()=>this.cleanup(),t)}}class Pu{constructor(){this.pendingTxIds=new Set}_resolveArgs(t){return typeof t=="function"?t():t||[]}_resolveApproval(t){return t?typeof t=="object"?{token:t.token,spender:t.spender,amount:t.amount}:t:null}_validateContractMethod(t,n){if(!t)throw new Error("Contract instance is null or undefined");if(typeof t[n]!="function"){const a=Object.keys(t).filter(s=>typeof t[s]=="function").filter(s=>!s.startsWith("_")&&!["on","once","emit","removeListener"].includes(s)).slice(0,15);throw console.error(`[TX] Contract method "${n}" not found!`),console.error("[TX] Available methods:",a),new Error(`Contract method "${n}" not found. This usually means the ABI doesn't match the contract. Available methods: ${a.join(", ")}`)}return typeof t[n].estimateGas!="function"&&console.warn(`[TX] Method ${n} exists but estimateGas is not available`),!0}async execute(t){var I,N;const{name:n,txId:a=null,button:s=null,showToasts:r=!0,getContract:o,method:i,args:l=[],approval:d=null,validate:u=null,onSuccess:f=null,onError:m=null,maxRetries:b=Kn.DEFAULT_MAX_RETRIES,invalidateCache:p=!0,skipSimulation:g=!1,fixedGasLimit:y=Kn.DEFAULT_GAS_LIMIT}=t,k=a||`${n}-${Date.now()}-${Math.random().toString(36).substr(2,9)}`;if(this.pendingTxIds.has(k))return console.warn(`[TX] Transaction ${k} already in progress`),{success:!1,reason:"DUPLICATE_TX",message:"Transaction already in progress"};this.pendingTxIds.add(k);const T=new Bu(s,n,r);try{T.setPhase("validating"),console.log(`[TX] Starting: ${n}`),await X.validateNetwork(),await X.validateRpcHealth();const z=await X.validateWalletConnected();console.log(`[TX] User address: ${z}`);const E=await oe.getSigner();console.log("[TX] Signer obtained");try{await X.validateEthForGas(z)}catch(V){console.warn("[TX] ETH gas validation failed, continuing anyway:",V.message)}const F=this._resolveApproval(d);F&&F.amount>0n&&await X.validateTokenBalance(F.token,F.amount,z),u&&(console.log("[TX] Running custom validation..."),await u(E,z));const G=this._resolveApproval(t.approval);G&&G.amount>0n&&await X.needsApproval(G.token,G.spender,G.amount,z)&&(T.setPhase("approving"),console.log("[TX] Requesting token approval..."),await this._executeApproval(G,E,z),Et.clear("allowance-")),console.log("[TX] Getting contract instance...");const se=await o(E);this._validateContractMethod(se,i),console.log(`[TX] Contract method "${i}" validated`);const de=t.value;de&&console.log("[TX] Transaction value (ETH):",de.toString());const xe=de?{value:de}:{},Q=this._resolveArgs(l);console.log("[TX] Args resolved:",Q.map(V=>typeof V=="bigint"?V.toString():typeof V=="string"&&V.length>50?V.substring(0,50)+"...":V));let D;if(g)console.log(`[TX] Skipping simulation, using fixed gas limit: ${y}`),D=y;else{T.setPhase("simulating"),console.log("[TX] Simulating transaction...");try{if(!se[i]||typeof se[i].estimateGas!="function")throw new Error(`estimateGas not available for method "${i}"`);D=await se[i].estimateGas(...Q,xe),console.log(`[TX] Gas estimate: ${D.toString()}`)}catch(V){if(console.error("[TX] Simulation failed:",V.message),(I=V.message)!=null&&I.includes("not found")||(N=V.message)!=null&&N.includes("undefined"))throw new Error(`Contract method "${i}" is not callable. Check that the ABI matches the deployed contract.`);const sn=q.parseSimulationError(V,i);throw q.create(sn.type,{message:sn.message,original:V})}}T.setPhase("confirming"),console.log("[TX] Requesting signature...");const W=Au.addSafetyMargin(D),ie={...xe,gasLimit:W};try{const V=await E.provider.getFeeData();V.maxFeePerGas&&(ie.maxFeePerGas=V.maxFeePerGas*120n/100n,ie.maxPriorityFeePerGas=V.maxPriorityFeePerGas||0n)}catch{}const ae=this._resolveArgs(l),Qe=await this._executeWithRetry(()=>se[i](...ae,ie),{maxRetries:b,ui:T,signer:E,name:n});console.log(`[TX] Transaction submitted: ${Qe.hash}`),T.setPhase("waiting"),console.log("[TX] Waiting for confirmation...");const _e=await this._waitForConfirmation(Qe,E.provider);if(console.log(`[TX] Confirmed in block ${_e.blockNumber}`),T.showSuccess(),p&&Et.invalidateByTx(n),f)try{await f(_e)}catch(V){console.warn("[TX] onSuccess callback error:",V)}return{success:!0,receipt:_e,txHash:_e.hash||Qe.hash,blockNumber:_e.blockNumber}}catch(z){console.error("[TX] Error:",(z==null?void 0:z.message)||z),s&&(console.log("[TX] Restoring button..."),s.disabled=!1,T.originalContent&&(s.innerHTML=T.originalContent));let E;try{E=await q.handleWithRpcSwitch(z,n),E.rpcSwitched&&console.log(`[TX] RPC switched to: ${E.newRpc}`)}catch(F){console.warn("[TX] Error in handleWithRpcSwitch:",F),E=q.handle(z,n)}if(E.type!==h.USER_REJECTED&&s&&!m){const F=T.originalContent;s.innerHTML='<span style="display:flex;align-items:center;justify-content:center;gap:8px"><span>❌</span><span>Failed</span></span>',setTimeout(()=>{s&&(s.innerHTML=F)},1500)}if(m)try{m(E)}catch(F){console.warn("[TX] onError callback error:",F)}return{success:!1,error:E,message:E.message,cancelled:E.type===h.USER_REJECTED}}finally{this.pendingTxIds.delete(k),setTimeout(()=>{s&&s.disabled&&(console.log("[TX] Safety cleanup triggered"),T.cleanup())},5e3)}}async _executeApproval(t,n,a){const s=window.ethers,{token:r,spender:o,amount:i}=t;console.log(`[TX] Approving ${s.formatEther(i)} tokens...`);const l=new s.Contract(r,Hr,n),d=i*Kn.APPROVAL_MULTIPLIER;try{let u={};try{const y=await n.provider.getFeeData();y.maxFeePerGas&&(u.maxFeePerGas=y.maxFeePerGas*120n/100n,u.maxPriorityFeePerGas=y.maxPriorityFeePerGas||0n)}catch{}const f=await l.approve(o,d,u),m=oe.getProvider();let b=null;for(let y=0;y<30&&(await new Promise(k=>setTimeout(k,1500)),b=await m.getTransactionReceipt(f.hash),!b);y++);if(b||(b=await f.wait()),b.status===0)throw new Error("Approval transaction reverted");if(console.log("[TX] Approval confirmed"),await new Promise(y=>setTimeout(y,Kn.APPROVAL_WAIT_TIME)),await new s.Contract(r,Hr,m).allowance(a,o)<i)throw new Error("Approval not reflected on-chain")}catch(u){throw q.isUserRejection(u)?q.create(h.USER_REJECTED):u}}async _executeWithRetry(t,{maxRetries:n,ui:a,signer:s,name:r}){let o;for(let i=1;i<=n+1;i++)try{return i>1&&(a.setRetry(i,n+1),console.log(`[TX] Retry ${i}/${n+1}`),(await oe.checkRpcHealth()).healthy||(console.log("[TX] RPC unhealthy, switching..."),oe.switchToNextRpc(),await new Promise(d=>setTimeout(d,2e3)))),await t()}catch(l){if(o=l,q.isUserRejection(l)||!q.isRetryable(l)||i===n+1)throw l;const d=q.getWaitTime(l);console.log(`[TX] Waiting ${d}ms before retry...`),await new Promise(u=>setTimeout(u,d))}throw o}async _waitForConfirmation(t,n){const a=oe.getProvider();try{const s=await Promise.race([t.wait(),new Promise((r,o)=>setTimeout(()=>o(new Error("wait_timeout")),1e4))]);if(s.status===1)return s;if(s.status===0)throw new Error("Transaction reverted on-chain");return s}catch(s){console.warn("[TX] tx.wait() issue, using Alchemy to check:",s.message);for(let r=0;r<20;r++){await new Promise(i=>setTimeout(i,1500));const o=await a.getTransactionReceipt(t.hash);if(o&&o.status===1)return console.log("[TX] Confirmed via Alchemy"),o;if(o&&o.status===0)throw new Error("Transaction reverted on-chain")}return console.warn("[TX] Could not verify receipt, assuming success"),{hash:t.hash,status:1,blockNumber:0}}}isPending(t){return this.pendingTxIds.has(t)}getPendingCount(){return this.pendingTxIds.size}clearPending(){this.pendingTxIds.clear()}}const Z=new Pu,wa="bkc_operator",Nt="0x0000000000000000000000000000000000000000";function Ls(){var t;const e=window.ethers;try{const n=localStorage.getItem(wa);if(n&&qe(n))return Mt(n);if(window.BACKCHAIN_OPERATOR&&qe(window.BACKCHAIN_OPERATOR))return Mt(window.BACKCHAIN_OPERATOR);if((t=window.addresses)!=null&&t.operator&&qe(window.addresses.operator))return Mt(window.addresses.operator)}catch(n){console.warn("[Operator] Error getting operator:",n)}return(e==null?void 0:e.ZeroAddress)||Nt}function ce(e){const t=window.ethers,n=(t==null?void 0:t.ZeroAddress)||Nt;return e===null?n:e&&qe(e)?Mt(e):Ls()}function Nu(e){if(!e)return qo(),!0;if(!qe(e))return console.warn("[Operator] Invalid address:",e),!1;try{const t=Mt(e);return localStorage.setItem(wa,t),window.BACKCHAIN_OPERATOR=t,window.dispatchEvent(new CustomEvent("operatorChanged",{detail:{address:t}})),console.log("[Operator] Set to:",t),!0}catch(t){return console.error("[Operator] Error setting:",t),!1}}function qo(){try{localStorage.removeItem(wa),delete window.BACKCHAIN_OPERATOR,window.dispatchEvent(new CustomEvent("operatorChanged",{detail:{address:null}})),console.log("[Operator] Cleared")}catch(e){console.warn("[Operator] Error clearing:",e)}}function zu(){const e=window.ethers,t=(e==null?void 0:e.ZeroAddress)||Nt,n=Ls();return n&&n!==t}function Lu(){var a;const e=window.ethers,t=(e==null?void 0:e.ZeroAddress)||Nt,n=localStorage.getItem(wa);return n&&qe(n)?{address:n,source:"localStorage",isSet:!0}:window.BACKCHAIN_OPERATOR&&qe(window.BACKCHAIN_OPERATOR)?{address:window.BACKCHAIN_OPERATOR,source:"global",isSet:!0}:(a=window.addresses)!=null&&a.operator&&qe(window.addresses.operator)?{address:window.addresses.operator,source:"config",isSet:!0}:{address:t,source:"none",isSet:!1}}function qe(e){const t=window.ethers;return!e||typeof e!="string"||!e.match(/^0x[a-fA-F0-9]{40}$/)?!1:t!=null&&t.isAddress?t.isAddress(e):!0}function Mt(e){const t=window.ethers;if(!e)return(t==null?void 0:t.ZeroAddress)||Nt;try{if(t!=null&&t.getAddress)return t.getAddress(e)}catch{}return e}function Su(e){const t=window.ethers,n=(t==null?void 0:t.ZeroAddress)||Nt;return!e||e===n?"None":`${e.slice(0,6)}...${e.slice(-4)}`}const Ru={get:Ls,set:Nu,clear:qo,has:zu,resolve:ce,info:Lu,isValid:qe,normalize:Mt,short:Su,ZERO:Nt};window.Operator=Ru;function zn(){var n,a;const e=(w==null?void 0:w.charityPool)||(R==null?void 0:R.charityPool)||((n=window.contractAddresses)==null?void 0:n.charityPool),t=(w==null?void 0:w.bkcToken)||(R==null?void 0:R.bkcToken)||((a=window.contractAddresses)==null?void 0:a.bkcToken);if(!e)throw console.error("❌ CharityPool address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{BKC_TOKEN:t,CHARITY_POOL:e}}const Ln=["function createCampaign(string calldata _title, string calldata _description, uint96 _goalAmount, uint256 _durationDays, address _operator) external returns (uint256 campaignId)","function donate(uint256 _campaignId, address _operator) external payable","function cancelCampaign(uint256 _campaignId) external","function withdraw(uint256 _campaignId, address _operator) external","function boostCampaign(uint256 _campaignId, address _operator) external payable","function campaigns(uint256 campaignId) view returns (address creator, uint96 goalAmount, uint96 raisedAmount, uint32 donationCount, uint64 deadline, uint64 createdAt, uint96 boostAmount, uint64 boostTime, uint8 status)","function campaignTitles(uint256 campaignId) view returns (string)","function campaignDescriptions(uint256 campaignId) view returns (string)","function getCampaign(uint256 _campaignId) view returns (address creator, string title, string description, uint96 goalAmount, uint96 raisedAmount, uint32 donationCount, uint64 deadline, uint64 createdAt, uint96 boostAmount, uint64 boostTime, uint8 status, bool goalReached)","function donations(uint256 donationId) view returns (address donor, uint64 campaignId, uint96 grossAmount, uint96 netAmount, uint64 timestamp)","function getDonation(uint256 _donationId) view returns (tuple(address donor, uint64 campaignId, uint96 grossAmount, uint96 netAmount, uint64 timestamp))","function getCampaignDonations(uint256 _campaignId) view returns (uint256[])","function getUserDonations(address _user) view returns (uint256[])","function getUserCampaigns(address _user) view returns (uint256[])","function userActiveCampaigns(address user) view returns (uint8)","function maxActiveCampaigns() view returns (uint8)","function createCostBkc() view returns (uint96)","function withdrawCostBkc() view returns (uint96)","function donationFeeBips() view returns (uint16)","function boostCostBkc() view returns (uint96)","function boostCostEth() view returns (uint96)","function getFeeConfig() view returns (uint96 createBkc, uint96 withdrawBkc, uint16 donationBips, uint96 boostBkc, uint96 boostEth)","function campaignCounter() view returns (uint64)","function donationCounter() view returns (uint64)","function totalRaisedAllTime() view returns (uint256)","function totalDonationsAllTime() view returns (uint256)","function totalFeesCollected() view returns (uint256)","function getStats() view returns (uint64 totalCampaigns, uint256 totalRaised, uint256 totalDonations, uint256 totalFees)","function previewDonation(uint256 _amount) view returns (uint256 netToCampaign, uint256 feeToProtocol)","function canWithdraw(uint256 _campaignId) view returns (bool allowed, string reason)","function isBoosted(uint256 _campaignId) view returns (bool)","function version() view returns (string)","event CampaignCreated(uint256 indexed campaignId, address indexed creator, uint96 goalAmount, uint64 deadline, address operator)","event DonationMade(uint256 indexed campaignId, uint256 indexed donationId, address indexed donor, uint96 grossAmount, uint96 netAmount, uint96 feeAmount, address operator)","event CampaignBoosted(uint256 indexed campaignId, address indexed booster, uint96 bkcAmount, uint96 ethAmount, address operator)","event CampaignCancelled(uint256 indexed campaignId, address indexed creator, uint96 raisedAmount)","event FundsWithdrawn(uint256 indexed campaignId, address indexed creator, uint96 amount, address operator)","event ConfigUpdated()"],Xt={ACTIVE:0,COMPLETED:1,CANCELLED:2,WITHDRAWN:3};function Ue(e){const t=window.ethers,n=zn();return new t.Contract(n.CHARITY_POOL,Ln,e)}async function me(){const e=window.ethers,{NetworkManager:t}=await Y(async()=>{const{NetworkManager:s}=await import("./index-DxBdDQU9.js");return{NetworkManager:s}},[]),n=t.getProvider(),a=zn();return new e.Contract(a.CHARITY_POOL,Ln,n)}async function Xo({title:e,description:t,goalAmount:n,durationDays:a,operator:s,button:r=null,onSuccess:o=null,onError:i=null}){const l=window.ethers;if(!e||e.trim().length===0)throw new Error("Title is required");if(e.length>100)throw new Error("Title must be 100 characters or less");if(t&&t.length>1e3)throw new Error("Description must be 1000 characters or less");if(a<1||a>180)throw new Error("Duration must be between 1 and 180 days");const d=BigInt(n);if(d<=0n)throw new Error("Goal amount must be greater than 0");let u=e,f=t||"",m=s,b=0n;return await Z.execute({name:"CreateCampaign",button:r,getContract:async p=>Ue(p),method:"createCampaign",args:()=>[u,f,d,BigInt(a),ce(m)],get approval(){if(b>0n){const p=zn();return{token:p.BKC_TOKEN,spender:p.CHARITY_POOL,amount:b}}return null},validate:async(p,g)=>{const y=Ue(p);try{const k=await y.userActiveCampaigns(g),T=await y.maxActiveCampaigns();if(Number(k)>=Number(T))throw new Error(`Maximum active campaigns reached (${T})`)}catch(k){if(k.message.includes("Maximum"))throw k}try{b=await y.createCostBkc()}catch{b=l.parseEther("1")}},onSuccess:async p=>{let g=null;try{const y=new l.Interface(Ln);for(const k of p.logs)try{const T=y.parseLog(k);if(T.name==="CampaignCreated"){g=Number(T.args.campaignId);break}}catch{}}catch{}o&&o(p,g)},onError:i})}async function Jo({campaignId:e,amount:t,operator:n,button:a=null,onSuccess:s=null,onError:r=null}){const o=window.ethers;if(e==null)throw new Error("Campaign ID is required");const i=BigInt(t);if(i<=0n)throw new Error("Donation amount must be greater than 0");let l=e,d=n;return await Z.execute({name:"Donate",button:a,getContract:async u=>Ue(u),method:"donate",args:()=>[l,ce(d)],value:i,validate:async(u,f)=>{const m=Ue(u);try{const b=await m.getCampaign(l);if(b.creator===o.ZeroAddress)throw new Error("Campaign not found");if(Number(b.status)!==Xt.ACTIVE)throw new Error("Campaign is not active");const p=Math.floor(Date.now()/1e3);if(Number(b.deadline)<=p)throw new Error("Campaign has ended")}catch(b){if(b.message.includes("Campaign")||b.message.includes("active")||b.message.includes("ended"))throw b}},onSuccess:async u=>{let f=null;try{const m=new o.Interface(Ln);for(const b of u.logs)try{const p=m.parseLog(b);if(p.name==="DonationMade"){f={donationId:Number(p.args.donationId),grossAmount:p.args.grossAmount,netAmount:p.args.netAmount,feeAmount:p.args.feeAmount};break}}catch{}}catch{}s&&s(u,f)},onError:r})}async function Zo({campaignId:e,button:t=null,onSuccess:n=null,onError:a=null}){const s=window.ethers;if(e==null)throw new Error("Campaign ID is required");let r=e;return await Z.execute({name:"CancelCampaign",button:t,getContract:async o=>Ue(o),method:"cancelCampaign",args:[r],validate:async(o,i)=>{const l=Ue(o);try{const d=await l.getCampaign(r);if(d.creator===s.ZeroAddress)throw new Error("Campaign not found");if(d.creator.toLowerCase()!==i.toLowerCase())throw new Error("Only the campaign creator can cancel");if(Number(d.status)!==Xt.ACTIVE)throw new Error("Campaign is not active")}catch(d){if(d.message.includes("Campaign")||d.message.includes("creator")||d.message.includes("active"))throw d}},onSuccess:n,onError:a})}async function Qo({campaignId:e,operator:t,button:n=null,onSuccess:a=null,onError:s=null}){const r=window.ethers;if(e==null)throw new Error("Campaign ID is required");let o=e,i=t,l=0n;return await Z.execute({name:"Withdraw",button:n,getContract:async d=>Ue(d),method:"withdraw",args:()=>[o,ce(i)],get approval(){if(l>0n){const d=zn();return{token:d.BKC_TOKEN,spender:d.CHARITY_POOL,amount:l}}return null},validate:async(d,u)=>{const f=Ue(d);try{const m=await f.getCampaign(o);if(m.creator===r.ZeroAddress)throw new Error("Campaign not found");if(m.creator.toLowerCase()!==u.toLowerCase())throw new Error("Only the campaign creator can withdraw");if(Number(m.status)===Xt.WITHDRAWN)throw new Error("Funds already withdrawn");const[b,p]=await f.canWithdraw(o);if(!b)throw new Error(p||"Cannot withdraw yet")}catch(m){if(m.message)throw m}try{l=await f.withdrawCostBkc()}catch{l=r.parseEther("0.5")}},onSuccess:async d=>{let u=null;try{const f=new r.Interface(Ln);for(const m of d.logs)try{const b=f.parseLog(m);if(b.name==="FundsWithdrawn"){u={amount:b.args.amount};break}}catch{}}catch{}a&&a(d,u)},onError:s})}async function ei({campaignId:e,ethAmount:t,operator:n,button:a=null,onSuccess:s=null,onError:r=null}){const o=window.ethers;if(e==null)throw new Error("Campaign ID is required");let i=e,l=n,d=0n,u=t?BigInt(t):0n;return await Z.execute({name:"BoostCampaign",button:a,getContract:async f=>Ue(f),method:"boostCampaign",args:()=>[i,ce(l)],get value(){return u},get approval(){if(d>0n){const f=zn();return{token:f.BKC_TOKEN,spender:f.CHARITY_POOL,amount:d}}return null},validate:async(f,m)=>{const b=Ue(f);try{const p=await b.getCampaign(i);if(p.creator===o.ZeroAddress)throw new Error("Campaign not found");if(Number(p.status)!==Xt.ACTIVE)throw new Error("Campaign is not active")}catch(p){if(p.message.includes("Campaign")||p.message.includes("active"))throw p}try{d=await b.boostCostBkc(),t||(u=await b.boostCostEth())}catch{d=o.parseEther("0.5"),t||(u=o.parseEther("0.001"))}},onSuccess:s,onError:r})}async function ti(e){const n=await(await me()).getCampaign(e),a=Math.floor(Date.now()/1e3);return{id:e,creator:n.creator,title:n.title,description:n.description,goalAmount:n.goalAmount,raisedAmount:n.raisedAmount,donationCount:Number(n.donationCount),deadline:Number(n.deadline),createdAt:Number(n.createdAt),boostAmount:n.boostAmount,boostTime:Number(n.boostTime),status:Number(n.status),statusName:["ACTIVE","COMPLETED","CANCELLED","WITHDRAWN"][Number(n.status)]||"UNKNOWN",goalReached:n.goalReached,progress:n.goalAmount>0n?Number(n.raisedAmount*100n/n.goalAmount):0,isEnded:Number(n.deadline)<a,isActive:Number(n.status)===Xt.ACTIVE&&Number(n.deadline)>a,isBoosted:n.boostTime>0&&a-Number(n.boostTime)<86400}}async function ni(e){const t=window.ethers,a=await(await me()).getDonation(e);return{id:e,donor:a.donor,campaignId:Number(a.campaignId),grossAmount:a.grossAmount,netAmount:a.netAmount,timestamp:Number(a.timestamp),grossFormatted:t.formatEther(a.grossAmount),netFormatted:t.formatEther(a.netAmount)}}async function ai(){const e=await me();return Number(await e.campaignCounter())}async function si(){const e=await me();return Number(await e.donationCounter())}async function ri(e){const t=await me();return Number(await t.userActiveCampaigns(e))}async function oi(){const e=await me();return Number(await e.maxActiveCampaigns())}async function ii(e){return(await(await me()).getUserCampaigns(e)).map(a=>Number(a))}async function li(e){return(await(await me()).getUserDonations(e)).map(a=>Number(a))}async function ci(e){return(await(await me()).getCampaignDonations(e)).map(a=>Number(a))}async function di(e){const t=window.ethers,a=await(await me()).previewDonation(e);return{netToCampaign:a.netToCampaign,feeToProtocol:a.feeToProtocol,netFormatted:t.formatEther(a.netToCampaign),feeFormatted:t.formatEther(a.feeToProtocol)}}async function ui(e){const t=await me(),[n,a]=await t.canWithdraw(e);return{allowed:n,reason:a}}async function pi(e){return await(await me()).isBoosted(e)}async function mi(){const e=window.ethers,n=await(await me()).getFeeConfig();return{createCostBkc:n.createBkc,createCostFormatted:e.formatEther(n.createBkc),withdrawCostBkc:n.withdrawBkc,withdrawCostFormatted:e.formatEther(n.withdrawBkc),donationFeeBips:Number(n.donationBips),donationFeePercent:Number(n.donationBips)/100,boostCostBkc:n.boostBkc,boostCostBkcFormatted:e.formatEther(n.boostBkc),boostCostEth:n.boostEth,boostCostEthFormatted:e.formatEther(n.boostEth)}}async function fi(){const e=window.ethers,n=await(await me()).getStats();return{totalCampaigns:Number(n.totalCampaigns),totalRaised:n.totalRaised,totalRaisedFormatted:e.formatEther(n.totalRaised),totalDonations:Number(n.totalDonations),totalFees:n.totalFees,totalFeesFormatted:e.formatEther(n.totalFees)}}async function bi(){const e=await me();try{return await e.withdrawCostBkc()}catch{return 0n}}async function gi(){const e=await me();try{return await e.createCostBkc()}catch{return 0n}}const Jt={createCampaign:Xo,donate:Jo,cancelCampaign:Zo,withdraw:Qo,boostCampaign:ei,getCampaign:ti,getCampaignCount:ai,getCampaignDonations:ci,canWithdraw:ui,isBoosted:pi,getDonation:ni,getDonationCount:si,previewDonation:di,getUserActiveCampaigns:ri,getMaxActiveCampaigns:oi,getUserCampaigns:ii,getUserDonations:li,getFeeConfig:mi,getStats:fi,getWithdrawalFee:bi,getCreateFee:gi,CampaignStatus:Xt},$u=Object.freeze(Object.defineProperty({__proto__:null,CharityTx:Jt,boostCampaign:ei,canWithdraw:ui,cancelCampaign:Zo,createCampaign:Xo,donate:Jo,getCampaign:ti,getCampaignCount:ai,getCampaignDonations:ci,getCreateFee:gi,getDonation:ni,getDonationCount:si,getFeeConfig:mi,getMaxActiveCampaigns:oi,getStats:fi,getUserActiveCampaigns:ri,getUserCampaigns:ii,getUserDonations:li,getWithdrawalFee:bi,isBoosted:pi,previewDonation:di,withdraw:Qo},Symbol.toStringTag,{value:"Module"}));function Ss(){var n,a;const e=(w==null?void 0:w.delegationManager)||(R==null?void 0:R.delegationManager)||((n=window.contractAddresses)==null?void 0:n.delegationManager),t=(w==null?void 0:w.bkcToken)||(R==null?void 0:R.bkcToken)||((a=window.contractAddresses)==null?void 0:a.bkcToken);if(!e)throw console.error("❌ DelegationManager address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");if(!t)throw console.error("❌ BKC Token address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{BKC_TOKEN:t,DELEGATION_MANAGER:e}}const xi=["function delegate(uint256 amount, uint256 lockDuration, address operator) external","function unstake(uint256 delegationIndex, address operator) external","function forceUnstake(uint256 delegationIndex, address operator) external","function claimReward(address operator) external payable","function getDelegationsOf(address user) view returns (tuple(uint256 amount, uint64 unlockTime, uint64 lockDuration)[])","function pendingRewards(address user) view returns (uint256)","function userTotalPStake(address user) view returns (uint256)","function totalNetworkPStake() view returns (uint256)","function MIN_LOCK_DURATION() view returns (uint256)","function MAX_LOCK_DURATION() view returns (uint256)","function claimEthFee() view returns (uint256)","function getUserBestBoost(address user) view returns (uint256)","function getBurnRateForBoost(uint256 boost) view returns (uint256)","function previewClaim(address user) view returns (uint256 totalRewards, uint256 burnAmount, uint256 userReceives, uint256 burnRateBips, uint256 nftBoost)","event Delegated(address indexed user, uint256 indexed delegationIndex, uint256 amount, uint256 pStake, uint256 feePaid, address operator)","event Unstaked(address indexed user, uint256 indexed delegationIndex, uint256 amountReceived, uint256 feePaid, address operator)","event RewardClaimed(address indexed user, uint256 amountReceived, uint256 burnedAmount, uint256 ethFeePaid, uint256 nftBoostUsed, address operator)"];function Ct(e){const t=window.ethers,n=Ss();return new t.Contract(n.DELEGATION_MANAGER,xi,e)}async function Sn(){const e=window.ethers,{NetworkManager:t}=await Y(async()=>{const{NetworkManager:s}=await import("./index-DxBdDQU9.js");return{NetworkManager:s}},[]),n=t.getProvider(),a=Ss();return new e.Contract(a.DELEGATION_MANAGER,xi,n)}function _u(e){return BigInt(e)*24n*60n*60n}async function hi({amount:e,lockDays:t,lockDuration:n,operator:a,button:s=null,onSuccess:r=null,onError:o=null}){let i;if(n!=null){i=BigInt(n);const u=Number(i)/86400;if(u<1||u>3650)throw new Error("Lock duration must be between 1 and 3650 days")}else if(t!=null)X.staking.validateDelegate({amount:e,lockDays:t}),i=_u(t);else throw new Error("Either lockDays or lockDuration must be provided");const l=BigInt(e);let d=a;return await Z.execute({name:"Delegate",button:s,getContract:async u=>Ct(u),method:"delegate",args:()=>[l,i,ce(d)],approval:(()=>{const u=Ss();return{token:u.BKC_TOKEN,spender:u.DELEGATION_MANAGER,amount:l}})(),onSuccess:r,onError:o})}async function vi({delegationIndex:e,operator:t,button:n=null,onSuccess:a=null,onError:s=null}){X.staking.validateUnstake({delegationIndex:e});let r=e,o=t;return await Z.execute({name:"Unstake",button:n,getContract:async i=>Ct(i),method:"unstake",args:()=>[r,ce(o)],validate:async(i,l)=>{const u=await Ct(i).getDelegationsOf(l);if(r>=u.length)throw new Error("Delegation not found");const f=u[r],m=Math.floor(Date.now()/1e3);if(Number(f.unlockTime)>m){const b=Math.ceil((Number(f.unlockTime)-m)/86400);throw new Error(`Lock period still active. ${b} day(s) remaining. Use Force Unstake if needed.`)}},onSuccess:a,onError:s})}async function wi({delegationIndex:e,operator:t,button:n=null,onSuccess:a=null,onError:s=null}){X.staking.validateUnstake({delegationIndex:e});let r=e,o=t;return await Z.execute({name:"ForceUnstake",button:n,getContract:async i=>Ct(i),method:"forceUnstake",args:()=>[r,ce(o)],validate:async(i,l)=>{const u=await Ct(i).getDelegationsOf(l);if(r>=u.length)throw new Error("Delegation not found");const f=u[r],m=Math.floor(Date.now()/1e3);if(Number(f.unlockTime)<=m)throw new Error("Lock period has ended. Use normal Unstake to avoid penalty.")},onSuccess:a,onError:s})}async function yi({operator:e,button:t=null,onSuccess:n=null,onError:a=null}={}){let s=e,r=0n;return await Z.execute({name:"ClaimRewards",button:t,getContract:async o=>Ct(o),method:"claimReward",args:()=>[ce(s)],get value(){return r},validate:async(o,i)=>{const l=Ct(o);if(await l.pendingRewards(i)<=0n)throw new Error("No rewards available to claim");try{r=await l.claimEthFee()}catch{r=0n}},onSuccess:n,onError:a})}async function ki(e){const n=await(await Sn()).getDelegationsOf(e),a=Math.floor(Date.now()/1e3);return n.map((s,r)=>({index:r,amount:s.amount,unlockTime:Number(s.unlockTime),lockDuration:Number(s.lockDuration),isUnlocked:Number(s.unlockTime)<=a,daysRemaining:Number(s.unlockTime)>a?Math.ceil((Number(s.unlockTime)-a)/86400):0}))}async function Ei(e){return await(await Sn()).pendingRewards(e)}async function Ti(e){return await(await Sn()).userTotalPStake(e)}async function Ci(){return await(await Sn()).totalNetworkPStake()}async function Ii(){return 50}async function Ai(){const e=await Sn(),[t,n]=await Promise.all([e.MIN_LOCK_DURATION(),e.MAX_LOCK_DURATION()]);return{minLockDays:Number(t)/86400,maxLockDays:Number(n)/86400,minLockSeconds:Number(t),maxLockSeconds:Number(n),penaltyPercent:50,penaltyBips:5e3}}const It={delegate:hi,unstake:vi,forceUnstake:wi,claimRewards:yi,getUserDelegations:ki,getPendingRewards:Ei,getUserPStake:Ti,getTotalPStake:Ci,getEarlyUnstakePenalty:Ii,getStakingConfig:Ai},Fu=Object.freeze(Object.defineProperty({__proto__:null,StakingTx:It,claimRewards:yi,delegate:hi,forceUnstake:wi,getEarlyUnstakePenalty:Ii,getPendingRewards:Ei,getStakingConfig:Ai,getTotalPStake:Ci,getUserDelegations:ki,getUserPStake:Ti,unstake:vi},Symbol.toStringTag,{value:"Module"})),Bi=["diamond","gold","silver","bronze"];function Rn(e=null){var s,r,o;const t=(w==null?void 0:w.bkcToken)||(R==null?void 0:R.bkcToken)||((s=window.contractAddresses)==null?void 0:s.bkcToken),n=(w==null?void 0:w.rewardBoosterNFT)||(R==null?void 0:R.rewardBoosterNFT)||((r=window.contractAddresses)==null?void 0:r.rewardBoosterNFT);let a=null;if(e){const i=`pool_${e.toLowerCase()}`;a=(w==null?void 0:w[i])||(R==null?void 0:R[i])||((o=window.contractAddresses)==null?void 0:o[i])}if(!t||!n)throw new Error("Contract addresses not loaded");return{BKC_TOKEN:t,NFT_CONTRACT:n,NFT_POOL:a}}function zt(e){var n;const t=`pool_${e.toLowerCase()}`;return(w==null?void 0:w[t])||(R==null?void 0:R[t])||((n=window.contractAddresses)==null?void 0:n[t])||null}function Mu(){const e={};for(const t of Bi){const n=zt(t);n&&(e[t]=n)}return e}const ya=["function buyNFT(uint256 _maxPrice, address _operator) external payable returns (uint256 tokenId)","function buySpecificNFT(uint256 _tokenId, uint256 _maxPrice, address _operator) external payable","function buyNFTWithSlippage(uint256 _maxPrice, address _operator) external payable returns (uint256 tokenId)","function sellNFT(uint256 _tokenId, uint256 _minPayout, address _operator) external payable","function getBuyPrice() view returns (uint256)","function getBuyPriceWithTax() view returns (uint256)","function getSellPrice() view returns (uint256)","function getSellPriceAfterTax() view returns (uint256)","function getTotalBuyCost() view returns (uint256 bkcCost, uint256 ethCost)","function getTotalSellInfo() view returns (uint256 bkcPayout, uint256 ethCost)","function getSpread() view returns (uint256 spread, uint256 spreadBips)","function getPoolInfo() view returns (uint256 bkcBalance, uint256 nftCount, uint256 k, bool initialized)","function getAvailableNFTs() view returns (uint256[])","function getNFTBalance() view returns (uint256)","function getBKCBalance() view returns (uint256)","function isNFTInPool(uint256 _tokenId) view returns (bool)","function boostBips() view returns (uint256)","function getTierName() view returns (string)","function buyEthFee() view returns (uint256)","function sellEthFee() view returns (uint256)","function getEthFeeConfig() view returns (uint256 buyFee, uint256 sellFee, uint256 totalCollected)","function totalETHCollected() view returns (uint256)","function getTradingStats() view returns (uint256 volume, uint256 taxes, uint256 buys, uint256 sells)","function totalVolume() view returns (uint256)","function totalTaxesCollected() view returns (uint256)","function totalBuys() view returns (uint256)","function totalSells() view returns (uint256)","event NFTPurchased(address indexed buyer, uint256 indexed tokenId, uint256 price, uint256 tax, uint256 newBkcBalance, uint256 newNftCount, address operator)","event NFTSold(address indexed seller, uint256 indexed tokenId, uint256 payout, uint256 tax, uint256 newBkcBalance, uint256 newNftCount, address operator)"],Pi=["function setApprovalForAll(address operator, bool approved) external","function isApprovedForAll(address owner, address operator) view returns (bool)","function ownerOf(uint256 tokenId) view returns (address)","function balanceOf(address owner) view returns (uint256)","function boostBips(uint256 tokenId) view returns (uint256)"];function ct(e,t){return new window.ethers.Contract(t,ya,e)}async function Ce(e){const{NetworkManager:t}=await Y(async()=>{const{NetworkManager:n}=await import("./index-DxBdDQU9.js");return{NetworkManager:n}},[]);return new window.ethers.Contract(e,ya,t.getProvider())}function ts(e){const t=Rn();return new window.ethers.Contract(t.NFT_CONTRACT,Pi,e)}async function Du(){const{NetworkManager:e}=await Y(async()=>{const{NetworkManager:n}=await import("./index-DxBdDQU9.js");return{NetworkManager:n}},[]),t=Rn();return new window.ethers.Contract(t.NFT_CONTRACT,Pi,e.getProvider())}async function Rs({poolAddress:e,poolTier:t,operator:n,button:a=null,onSuccess:s=null,onError:r=null}){const o=window.ethers,i=Rn(),l=e||zt(t);if(!l)throw new Error("Pool address or valid pool tier is required");let d=n,u=0n,f=0n;return await Z.execute({name:"BuyNFT",button:a,getContract:async m=>ct(m,l),method:"buyNFT",args:()=>[u,ce(d)],get value(){return f},get approval(){return u>0n?{token:i.BKC_TOKEN,spender:l,amount:u}:null},validate:async(m,b)=>{const p=ct(m,l);if(await p.getNFTBalance()===0n)throw new Error("No NFTs available in pool");try{const[z,E]=await p.getTotalBuyCost();u=z,f=E}catch{u=await p.getBuyPriceWithTax(),f=await p.buyEthFee().catch(()=>0n)}const{NetworkManager:y}=await Y(async()=>{const{NetworkManager:z}=await import("./index-DxBdDQU9.js");return{NetworkManager:z}},[]),k=y.getProvider();if(await new o.Contract(i.BKC_TOKEN,["function balanceOf(address) view returns (uint256)"],k).balanceOf(b)<u)throw new Error(`Insufficient BKC. Need ${o.formatEther(u)} BKC`);if(await k.getBalance(b)<f+o.parseEther("0.001"))throw new Error("Insufficient ETH for fee + gas")},onSuccess:async m=>{let b=null;try{const p=new o.Interface(ya);for(const g of m.logs)try{const y=p.parseLog(g);if((y==null?void 0:y.name)==="NFTPurchased"){b=Number(y.args.tokenId);break}}catch{}}catch{}s&&s(m,b)},onError:r})}async function Ni({poolAddress:e,poolTier:t,tokenId:n,operator:a,button:s=null,onSuccess:r=null,onError:o=null}){const i=window.ethers,l=Rn(),d=e||zt(t);if(!d)throw new Error("Pool address or valid pool tier is required");if(n===void 0)throw new Error("Token ID is required");let u=a,f=0n,m=0n;return await Z.execute({name:"BuySpecificNFT",button:s,getContract:async b=>ct(b,d),method:"buySpecificNFT",args:()=>[n,f,ce(u)],get value(){return m},get approval(){return f>0n?{token:l.BKC_TOKEN,spender:d,amount:f}:null},validate:async(b,p)=>{const g=ct(b,d);if(!await g.isNFTInPool(n))throw new Error("NFT is not in pool");try{const[I,N]=await g.getTotalBuyCost();f=I,m=N}catch{f=await g.getBuyPriceWithTax(),m=await g.buyEthFee().catch(()=>0n)}const{NetworkManager:y}=await Y(async()=>{const{NetworkManager:I}=await import("./index-DxBdDQU9.js");return{NetworkManager:I}},[]),k=y.getProvider();if(await new i.Contract(l.BKC_TOKEN,["function balanceOf(address) view returns (uint256)"],k).balanceOf(p)<f)throw new Error("Insufficient BKC");if(await k.getBalance(p)<m+i.parseEther("0.001"))throw new Error("Insufficient ETH")},onSuccess:r,onError:o})}async function zi({poolAddress:e,poolTier:t,maxPrice:n,operator:a,button:s=null,onSuccess:r=null,onError:o=null}){const i=window.ethers,l=Rn(),d=e||zt(t);if(!d)throw new Error("Pool address or valid pool tier is required");const u=BigInt(n);let f=a,m=0n;return await Z.execute({name:"BuyNFTWithSlippage",button:s,getContract:async b=>ct(b,d),method:"buyNFTWithSlippage",args:()=>[u,ce(f)],get value(){return m},approval:{token:l.BKC_TOKEN,spender:d,amount:u},validate:async(b,p)=>{const g=ct(b,d);if(await g.getNFTBalance()===0n)throw new Error("No NFTs available");if(await g.getBuyPriceWithTax()>u)throw new Error("Price exceeds max");m=await g.buyEthFee().catch(()=>0n);const{NetworkManager:k}=await Y(async()=>{const{NetworkManager:N}=await import("./index-DxBdDQU9.js");return{NetworkManager:N}},[]),T=k.getProvider();if(await new i.Contract(l.BKC_TOKEN,["function balanceOf(address) view returns (uint256)"],T).balanceOf(p)<u)throw new Error("Insufficient BKC");if(await T.getBalance(p)<m+i.parseEther("0.001"))throw new Error("Insufficient ETH")},onSuccess:async b=>{let p=null;try{const g=new i.Interface(ya);for(const y of b.logs)try{const k=g.parseLog(y);if((k==null?void 0:k.name)==="NFTPurchased"){p=Number(k.args.tokenId);break}}catch{}}catch{}r&&r(b,p)},onError:o})}async function $s({poolAddress:e,poolTier:t,tokenId:n,minPayout:a,operator:s,button:r=null,onSuccess:o=null,onError:i=null}){const l=window.ethers,d=e||zt(t);if(!d)throw new Error("Pool address or valid pool tier is required");if(n===void 0)throw new Error("Token ID is required");let u=s,f=0n,m=0n;return await Z.execute({name:"SellNFT",button:r,getContract:async b=>ct(b,d),method:"sellNFT",args:()=>[n,f,ce(u)],get value(){return m},validate:async(b,p)=>{const g=ct(b,d),y=ts(b);if((await y.ownerOf(n)).toLowerCase()!==p.toLowerCase())throw new Error("You do not own this NFT");const T=await g.boostBips(),I=await y.boostBips(n);if(T!==I)throw new Error("NFT tier does not match pool tier");try{const[E,F]=await g.getTotalSellInfo();f=a?BigInt(a):E*95n/100n,m=F}catch{const E=await g.getSellPriceAfterTax();f=a?BigInt(a):E*95n/100n,m=await g.sellEthFee().catch(()=>0n)}const{NetworkManager:N}=await Y(async()=>{const{NetworkManager:E}=await import("./index-DxBdDQU9.js");return{NetworkManager:E}},[]);if(await N.getProvider().getBalance(p)<m+l.parseEther("0.001"))throw new Error("Insufficient ETH");await y.isApprovedForAll(p,d)||await(await y.setApprovalForAll(d,!0)).wait()},onSuccess:o,onError:i})}async function Li({poolAddress:e,poolTier:t,button:n=null,onSuccess:a=null,onError:s=null}){const r=e||zt(t);if(!r)throw new Error("Pool address or valid pool tier is required");return await Z.execute({name:"ApproveAllNFTs",button:n,getContract:async o=>ts(o),method:"setApprovalForAll",args:[r,!0],validate:async(o,i)=>{if(await ts(o).isApprovedForAll(i,r))throw new Error("Already approved")},onSuccess:a,onError:s})}async function Si(e){return await(await Ce(e)).getBuyPrice()}async function Ri(e){return await(await Ce(e)).getBuyPriceWithTax()}async function $i(e){return await(await Ce(e)).getSellPrice()}async function _i(e){return await(await Ce(e)).getSellPriceAfterTax()}async function Fi(e){const t=window.ethers,n=await Ce(e);try{const[a,s]=await n.getTotalBuyCost();return{bkcCost:a,bkcFormatted:t.formatEther(a),ethCost:s,ethFormatted:t.formatEther(s)}}catch{const a=await n.getBuyPriceWithTax(),s=await n.buyEthFee().catch(()=>0n);return{bkcCost:a,bkcFormatted:t.formatEther(a),ethCost:s,ethFormatted:t.formatEther(s)}}}async function Mi(e){const t=window.ethers,n=await Ce(e);try{const[a,s]=await n.getTotalSellInfo();return{bkcPayout:a,bkcFormatted:t.formatEther(a),ethCost:s,ethFormatted:t.formatEther(s)}}catch{const a=await n.getSellPriceAfterTax(),s=await n.sellEthFee().catch(()=>0n);return{bkcPayout:a,bkcFormatted:t.formatEther(a),ethCost:s,ethFormatted:t.formatEther(s)}}}async function Di(e){const t=window.ethers,n=await Ce(e),[a,s,r,o]=await Promise.all([n.getPoolInfo(),n.getBuyPrice().catch(()=>0n),n.getSellPrice().catch(()=>0n),n.boostBips()]);return{bkcBalance:a.bkcBalance,nftCount:Number(a.nftCount),k:a.k,initialized:a.initialized,boostBips:Number(o),buyPrice:s,buyPriceFormatted:t.formatEther(s),sellPrice:r,sellPriceFormatted:t.formatEther(r)}}async function Oi(e){return(await(await Ce(e)).getAvailableNFTs()).map(n=>Number(n))}async function Hi(e){const t=window.ethers,n=await Ce(e);try{const a=await n.getEthFeeConfig();return{buyFee:a.buyFee,buyFeeFormatted:t.formatEther(a.buyFee),sellFee:a.sellFee,sellFeeFormatted:t.formatEther(a.sellFee),totalCollected:a.totalCollected,totalCollectedFormatted:t.formatEther(a.totalCollected)}}catch{const[a,s,r]=await Promise.all([n.buyEthFee().catch(()=>0n),n.sellEthFee().catch(()=>0n),n.totalETHCollected().catch(()=>0n)]);return{buyFee:a,buyFeeFormatted:t.formatEther(a),sellFee:s,sellFeeFormatted:t.formatEther(s),totalCollected:r,totalCollectedFormatted:t.formatEther(r)}}}async function Ui(e){const t=window.ethers,n=await Ce(e);try{const a=await n.getTradingStats();return{volume:a.volume,volumeFormatted:t.formatEther(a.volume),taxes:a.taxes,taxesFormatted:t.formatEther(a.taxes),buys:Number(a.buys),sells:Number(a.sells)}}catch{const[a,s,r,o]=await Promise.all([n.totalVolume().catch(()=>0n),n.totalTaxesCollected().catch(()=>0n),n.totalBuys().catch(()=>0n),n.totalSells().catch(()=>0n)]);return{volume:a,volumeFormatted:t.formatEther(a),taxes:s,taxesFormatted:t.formatEther(s),buys:Number(r),sells:Number(o)}}}async function ji(e){const t=await Ce(e);try{return await t.getTierName()}catch{const n=await t.boostBips();return{5e3:"Diamond",4e3:"Gold",2500:"Silver",1e3:"Bronze"}[Number(n)]||"Unknown"}}async function Wi(e){const t=window.ethers,n=await Ce(e);try{const a=await n.getSpread();return{spread:a.spread,spreadFormatted:t.formatEther(a.spread),spreadBips:Number(a.spreadBips),spreadPercent:Number(a.spreadBips)/100}}catch{const[a,s]=await Promise.all([n.getBuyPrice().catch(()=>0n),n.getSellPrice().catch(()=>0n)]),r=a>s?a-s:0n,o=s>0n?Number(r*10000n/s):0;return{spread:r,spreadFormatted:t.formatEther(r),spreadBips:o,spreadPercent:o/100}}}async function Gi(e,t){return await(await Ce(e)).isNFTInPool(t)}async function Ki(e,t){return await(await Du()).isApprovedForAll(e,t)}const Yi=Rs,Vi=$s,ns={buyNft:Rs,buySpecificNft:Ni,buyNftWithSlippage:zi,sellNft:$s,approveAllNfts:Li,buyFromPool:Yi,sellToPool:Vi,getBuyPrice:Si,getBuyPriceWithTax:Ri,getSellPrice:$i,getSellPriceAfterTax:_i,getTotalBuyCost:Fi,getTotalSellInfo:Mi,getEthFeeConfig:Hi,getPoolInfo:Di,getAvailableNfts:Oi,isNFTInPool:Gi,isApprovedForAll:Ki,getTradingStats:Ui,getTierName:ji,getSpread:Wi,getPoolAddress:zt,getAllPools:Mu,POOL_TIERS:Bi},Ou=Object.freeze(Object.defineProperty({__proto__:null,NftTx:ns,approveAllNfts:Li,buyFromPool:Yi,buyNft:Rs,buyNftWithSlippage:zi,buySpecificNft:Ni,getAvailableNfts:Oi,getBuyPrice:Si,getBuyPriceWithTax:Ri,getEthFeeConfig:Hi,getPoolInfo:Di,getSellPrice:$i,getSellPriceAfterTax:_i,getSpread:Wi,getTierName:ji,getTotalBuyCost:Fi,getTotalSellInfo:Mi,getTradingStats:Ui,isApprovedForAll:Ki,isNFTInPool:Gi,sellNft:$s,sellToPool:Vi},Symbol.toStringTag,{value:"Module"}));function _s(){var n,a,s;const e=(w==null?void 0:w.fortunePoolV2)||(w==null?void 0:w.fortunePool)||(R==null?void 0:R.fortunePoolV2)||(R==null?void 0:R.fortunePool)||((n=window.contractAddresses)==null?void 0:n.fortunePoolV2)||((a=window.contractAddresses)==null?void 0:a.fortunePool),t=(w==null?void 0:w.bkcToken)||(R==null?void 0:R.bkcToken)||((s=window.contractAddresses)==null?void 0:s.bkcToken);if(!e)throw console.error("❌ FortunePool address not found!",{addresses:w,contractAddresses:R}),new Error("Contract addresses not loaded. Please refresh the page.");if(!t)throw console.error("❌ BKC Token address not found!"),new Error("Contract addresses not loaded. Please refresh the page.");return{BKC_TOKEN:t,FORTUNE_POOL:e}}const ka=["function commitPlay(bytes32 _commitmentHash, uint256 _wagerAmount, bool _isCumulative, address _operator) external payable returns (uint256 gameId)","function revealPlay(uint256 _gameId, uint256[] calldata _guesses, bytes32 _userSecret) external returns (uint256 prizeWon)","function generateCommitmentHash(uint256[] calldata _guesses, bytes32 _userSecret) external pure returns (bytes32 hash)","function claimExpiredGame(uint256 _gameId) external","function activeTierCount() view returns (uint256)","function prizeTiers(uint256 tierId) view returns (uint128 maxRange, uint64 multiplierBips, bool active)","function getAllTiers() view returns (uint128[] ranges, uint64[] multipliers)","function serviceFee() view returns (uint256)","function getRequiredServiceFee(bool _isCumulative) view returns (uint256)","function gameFeeBips() view returns (uint256)","function gameCounter() view returns (uint256)","function prizePoolBalance() view returns (uint256)","function revealDelay() view returns (uint256)","function revealWindow() view returns (uint256)","function getCommitment(uint256 _gameId) view returns (address player, uint64 commitBlock, bool isCumulative, uint8 status, uint256 wagerAmount, uint256 ethPaid)","function getCommitmentStatus(uint256 _gameId) view returns (uint8 status, bool canReveal, bool isExpired, uint256 blocksUntilReveal, uint256 blocksUntilExpiry)","function commitmentMeta(uint256 _gameId) view returns (bytes32 hash, address operator, uint96 tierNonce)","function getGameResult(uint256 _gameId) view returns (address player, uint256 wagerAmount, uint256 prizeWon, uint256[] guesses, uint256[] rolls, bool isCumulative, uint8 matchCount, uint256 timestamp)","function totalWageredAllTime() view returns (uint256)","function totalPaidOutAllTime() view returns (uint256)","function totalWinsAllTime() view returns (uint256)","function totalETHCollected() view returns (uint256)","function totalBKCFees() view returns (uint256)","function totalExpiredGames() view returns (uint256)","function getPoolStats() view returns (uint256 poolBalance, uint256 gamesPlayed, uint256 wageredAllTime, uint256 paidOutAllTime, uint256 winsAllTime, uint256 ethCollected, uint256 bkcFees, uint256 expiredGames)","function calculatePotentialWinnings(uint256 _wagerAmount, bool _isCumulative) view returns (uint256 maxPrize, uint256 netWager)","function getExpectedGuessCount(bool _isCumulative) view returns (uint256)","event GameCommitted(uint256 indexed gameId, address indexed player, uint256 wagerAmount, bool isCumulative, address operator)","event GameRevealed(uint256 indexed gameId, address indexed player, uint256 wagerAmount, uint256 prizeWon, bool isCumulative, uint8 matchCount, address operator)","event GameDetails(uint256 indexed gameId, uint256[] guesses, uint256[] rolls, bool[] matches)","event JackpotWon(uint256 indexed gameId, address indexed player, uint256 prizeAmount, uint256 tier)","event GameExpired(uint256 indexed gameId, address indexed player, uint256 forfeitedAmount)"];function qi(e){const t=window.ethers,n=_s();return new t.Contract(n.FORTUNE_POOL,ka,e)}async function Pe(){const e=window.ethers,{NetworkManager:t}=await Y(async()=>{const{NetworkManager:s}=await import("./index-DxBdDQU9.js");return{NetworkManager:s}},[]),n=t.getProvider(),a=_s();return new e.Contract(a.FORTUNE_POOL,ka,n)}const Fs="fortune_pending_games";function Ea(){try{return JSON.parse(localStorage.getItem(Fs)||"{}")}catch{return{}}}function Hu(e,t){const n=Ea();n[e]={...t,savedAt:Date.now()},localStorage.setItem(Fs,JSON.stringify(n))}function Uu(e){const t=Ea();delete t[e],localStorage.setItem(Fs,JSON.stringify(t))}function Ms(e,t){const n=window.ethers,a=n.solidityPacked(["uint256[]","bytes32"],[e.map(s=>BigInt(s)),t]);return n.keccak256(a)}function Xi(){const e=window.ethers;return e.hexlify(e.randomBytes(32))}async function Ds({commitmentHash:e,wagerAmount:t,isCumulative:n=!1,operator:a,button:s=null,onSuccess:r=null,onError:o=null}){const i=window.ethers,l=_s(),d=BigInt(t);let u=e,f=n,m=a,b=0n;try{b=await(await Pe()).getRequiredServiceFee(n),console.log("[FortuneTx] Service fee:",i.formatEther(b),"ETH")}catch(p){throw console.error("[FortuneTx] Could not fetch service fee:",p.message),new Error("Could not fetch service fee from contract")}return await Z.execute({name:"CommitPlay",button:s,getContract:async p=>qi(p),method:"commitPlay",args:()=>[u,d,f,ce(m)],value:b,approval:{token:l.BKC_TOKEN,spender:l.FORTUNE_POOL,amount:d},validate:async(p,g)=>{const{NetworkManager:y}=await Y(async()=>{const{NetworkManager:z}=await import("./index-DxBdDQU9.js");return{NetworkManager:z}},[]),k=y.getProvider(),T=await Pe(),I=await k.getBalance(g);if(b>0n&&I<b)throw new Error(`Insufficient ETH for service fee (${i.formatEther(b)} ETH required)`);if(Number(await T.activeTierCount())===0)throw new Error("No active tiers available");if(d<=0n)throw new Error("Wager amount must be greater than 0")},onSuccess:async p=>{let g=null;try{const y=new i.Interface(ka);for(const k of p.logs)try{const T=y.parseLog(k);if(T.name==="GameCommitted"){g=Number(T.args.gameId);break}}catch{}}catch{}r&&r({gameId:g,txHash:p.hash,commitBlock:p.blockNumber})},onError:o})}async function Os({gameId:e,guesses:t,userSecret:n,button:a=null,onSuccess:s=null,onError:r=null}){const o=window.ethers,i=t.map(l=>BigInt(l));return await Z.execute({name:"RevealPlay",button:a,getContract:async l=>qi(l),method:"revealPlay",args:[e,i,n],validate:async(l,d)=>{const u=await Pe(),f=await u.getCommitmentStatus(e);if(f.isExpired)throw new Error("Game has expired. You can no longer reveal.");if(!f.canReveal)throw f.blocksUntilReveal>0?new Error(`Must wait ${f.blocksUntilReveal} more blocks before reveal`):new Error("Cannot reveal this game");if((await u.getCommitment(e)).player.toLowerCase()!==d.toLowerCase())throw new Error("You are not the owner of this game");const b=await u.commitmentMeta(e),p=Ms(t,n);if(b.hash.toLowerCase()!==p.toLowerCase())throw new Error("Hash mismatch - guesses or secret do not match commitment")},onSuccess:async l=>{let d=null;try{const u=new o.Interface(ka);for(const f of l.logs)try{const m=u.parseLog(f);m.name==="GameRevealed"&&(d={gameId:Number(m.args.gameId),wagerAmount:m.args.wagerAmount,prizeWon:m.args.prizeWon,isCumulative:m.args.isCumulative,matchCount:Number(m.args.matchCount),won:m.args.prizeWon>0n}),m.name==="GameDetails"&&d&&(d.guesses=m.args.guesses.map(b=>Number(b)),d.rolls=m.args.rolls.map(b=>Number(b)),d.matches=m.args.matches),m.name==="JackpotWon"&&d&&(d.jackpot=!0,d.jackpotTier=Number(m.args.tier))}catch{}}catch{}Uu(e),s&&s(l,d)},onError:r})}async function Ji({wagerAmount:e,guess:t,guesses:n,isCumulative:a=!1,operator:s,button:r=null,onSuccess:o=null,onError:i=null}){let l=[];if(a)if(n&&Array.isArray(n)&&n.length>0)l=n.map(b=>Number(b));else if(t!==void 0)l=[Number(Array.isArray(t)?t[0]:t)];else throw new Error("Guesses array is required for cumulative mode");else{let b;if(t!==void 0)b=Array.isArray(t)?t[0]:t;else if(n&&n.length>0)b=n[n.length-1];else throw new Error("Guess is required");l=[Number(b)]}const d=await Pe(),u=Number(await d.activeTierCount());if(u===0)throw new Error("No active tiers available");if(a){if(l.length!==u)throw new Error(`Cumulative mode requires ${u} guesses (one per tier), got ${l.length}`);for(let b=0;b<u;b++){const p=await d.prizeTiers(b+1),g=Number(p.maxRange);if(l[b]<1||l[b]>g)throw new Error(`Tier ${b+1} guess must be between 1 and ${g}`)}}else{if(l.length!==1)throw new Error("Jackpot mode requires exactly 1 guess");const b=await d.prizeTiers(u),p=Number(b.maxRange);if(l[0]<1||l[0]>p)throw new Error(`Jackpot guess must be between 1 and ${p}`)}const f=Xi(),m=Ms(l,f);return console.log("[FortuneTx] Generated commitment:",{guesses:l,userSecret:f.slice(0,10)+"...",commitmentHash:m.slice(0,10)+"..."}),await Ds({commitmentHash:m,wagerAmount:e,isCumulative:a,operator:s,button:r,onSuccess:b=>{Hu(b.gameId,{guesses:l,userSecret:f,isCumulative:a,wagerAmount:e.toString(),commitmentHash:m}),console.log("[FortuneTx] Game committed, stored for reveal:",b.gameId),o&&o({...b,guesses:l,userSecret:f,isCumulative:a})},onError:i})}async function Zi(){const e=await Pe(),t=Number(await e.activeTierCount()),n=[];for(let a=1;a<=t;a++)try{const s=await e.prizeTiers(a);s.active&&n.push({tierId:a,maxRange:Number(s.maxRange),multiplierBips:Number(s.multiplierBips),multiplier:Number(s.multiplierBips)/1e4,active:s.active})}catch{break}return n}async function Qi(e){const t=await Pe();try{const n=await t.prizeTiers(e);if(n.active)return{tierId:e,maxRange:Number(n.maxRange),multiplierBips:Number(n.multiplierBips),multiplier:Number(n.multiplierBips)/1e4,active:n.active}}catch{}return null}async function el(e=!1){const t=await Pe();try{return await t.getRequiredServiceFee(e)}catch{try{const a=await t.serviceFee();return e?a*5n:a}catch{return console.warn("[FortuneTx] Could not fetch service fee"),0n}}}async function tl(){const e=window.ethers,t=await Pe();try{const n=await t.getPoolStats();return{prizePoolBalance:n.poolBalance,prizePoolFormatted:e.formatEther(n.poolBalance),gameCounter:Number(n.gamesPlayed),totalWageredAllTime:n.wageredAllTime,totalWageredFormatted:e.formatEther(n.wageredAllTime),totalPaidOutAllTime:n.paidOutAllTime,totalPaidOutFormatted:e.formatEther(n.paidOutAllTime),totalWinsAllTime:Number(n.winsAllTime),totalETHCollected:n.ethCollected,totalBKCFees:n.bkcFees,totalExpiredGames:Number(n.expiredGames)}}catch{const[n,a,s,r,o]=await Promise.all([t.gameCounter().catch(()=>0n),t.prizePoolBalance().catch(()=>0n),t.totalWageredAllTime().catch(()=>0n),t.totalPaidOutAllTime().catch(()=>0n),t.totalWinsAllTime().catch(()=>0n)]);return{gameCounter:Number(n),prizePoolBalance:a,prizePoolFormatted:e.formatEther(a),totalWageredAllTime:s,totalWageredFormatted:e.formatEther(s),totalPaidOutAllTime:r,totalPaidOutFormatted:e.formatEther(r),totalWinsAllTime:Number(o)}}}async function nl(){const e=await Pe();return Number(await e.activeTierCount())}async function al(e,t=!1){const n=window.ethers,a=await Pe();try{const s=await a.calculatePotentialWinnings(e,t);return{maxPrize:s.maxPrize,maxPrizeFormatted:n.formatEther(s.maxPrize),netWager:s.netWager,netWagerFormatted:n.formatEther(s.netWager)}}catch{return{maxPrize:0n,netWager:0n}}}async function sl(e){const t=await Pe();try{const n=await t.getGameResult(e);return{player:n.player,wagerAmount:n.wagerAmount,prizeWon:n.prizeWon,guesses:n.guesses.map(a=>Number(a)),rolls:n.rolls.map(a=>Number(a)),isCumulative:n.isCumulative,matchCount:Number(n.matchCount),timestamp:Number(n.timestamp),won:n.prizeWon>0n}}catch{return null}}async function rl(e){const t=await Pe();try{const n=await t.getCommitmentStatus(e);return{status:Number(n.status),statusName:["NONE","COMMITTED","REVEALED","EXPIRED"][Number(n.status)]||"UNKNOWN",canReveal:n.canReveal,isExpired:n.isExpired,blocksUntilReveal:Number(n.blocksUntilReveal),blocksUntilExpiry:Number(n.blocksUntilExpiry)}}catch{return null}}function ol(){return Ea()}function Hs(e){return Ea()[e]||null}async function il(e,t={}){const n=Hs(e);if(!n)throw new Error(`No pending game found with ID ${e}`);return await Os({gameId:e,guesses:n.guesses,userSecret:n.userSecret,...t})}const Us={commitPlay:Ds,revealPlay:Os,playGame:Ji,revealPendingGame:il,getPendingGamesForReveal:ol,getPendingGame:Hs,generateCommitmentHashLocal:Ms,generateSecret:Xi,getActiveTiers:Zi,getTierById:Qi,getServiceFee:el,getPoolStats:tl,getActiveTierCount:nl,calculatePotentialWin:al,getGameResult:sl,getCommitmentStatus:rl},ju=Object.freeze(Object.defineProperty({__proto__:null,FortuneTx:Us,calculatePotentialWin:al,commitPlay:Ds,getActiveTierCount:nl,getActiveTiers:Zi,getCommitmentStatus:rl,getGameResult:sl,getPendingGame:Hs,getPendingGamesForReveal:ol,getPoolStats:tl,getServiceFee:el,getTierById:Qi,playGame:Ji,revealPendingGame:il,revealPlay:Os},Symbol.toStringTag,{value:"Module"}));function Zt(){var a,s,r;const e=(w==null?void 0:w.bkcToken)||(R==null?void 0:R.bkcToken)||((a=window.contractAddresses)==null?void 0:a.bkcToken),t=(w==null?void 0:w.rentalManager)||(R==null?void 0:R.rentalManager)||((s=window.contractAddresses)==null?void 0:s.rentalManager),n=(w==null?void 0:w.rewardBoosterNFT)||(R==null?void 0:R.rewardBoosterNFT)||((r=window.contractAddresses)==null?void 0:r.rewardBoosterNFT);if(!e||!t||!n)throw new Error("Contract addresses not loaded. Please refresh the page.");return{BKC_TOKEN:e,RENTAL_MARKETPLACE:t,NFT_CONTRACT:n}}const js=["function listNFT(uint256 _tokenId, uint256 _pricePerHour, uint256 _minHours, uint256 _maxHours) external","function updateListing(uint256 _tokenId, uint256 _pricePerHour, uint256 _minHours, uint256 _maxHours) external","function withdrawNFT(uint256 _tokenId) external","function rentNFT(uint256 _tokenId, uint256 _hours, address _operator) external","function rentNFTSimple(uint256 _tokenId, address _operator) external","function spotlightListing(uint256 _tokenId, address _operator) external payable","function getListing(uint256 _tokenId) view returns (tuple(address owner, uint256 pricePerHour, uint256 minHours, uint256 maxHours, bool isActive, uint256 totalEarnings, uint256 rentalCount))","function getAllListedTokenIds() view returns (uint256[])","function getListingCount() view returns (uint256)","function getRental(uint256 _tokenId) view returns (tuple(address tenant, uint256 startTime, uint256 endTime, uint256 paidAmount))","function isRented(uint256 _tokenId) view returns (bool)","function getRemainingRentalTime(uint256 _tokenId) view returns (uint256)","function hasRentalRights(uint256 _tokenId, address _user) view returns (bool)","function getRentalCost(uint256 _tokenId, uint256 _hours) view returns (uint256 totalCost, uint256 protocolFee, uint256 ownerPayout)","function listingSpotlight(uint256 tokenId) view returns (uint256 totalAmount, uint256 lastSpotlightTime)","function getEffectiveSpotlight(uint256 _tokenId) view returns (uint256 effectiveAmount, uint256 daysPassed)","function getSpotlightedListingsPaginated(uint256 _offset, uint256 _limit) view returns (uint256[] tokenIds, uint256[] effectiveSpotlights, uint256 total)","function getSpotlightConfig() view returns (uint256 decayPerDayBips, uint256 minAmount, uint256 maxDays, uint256 totalSpotlightedListings, uint256 totalCollected)","function minSpotlightAmount() view returns (uint256)","function hasActiveRental(address _user) view returns (bool)","function getUserActiveRentals(address _user) view returns (uint256[] tokenIds, uint256[] endTimes)","function paused() view returns (bool)","function rentalFeeBips() view returns (uint256)","function getFeeConfig() view returns (uint256 miningFeeBips, uint256 burnFeeBips, uint256 totalFeeBips)","function getMarketplaceStats() view returns (uint256 activeListings, uint256 totalVol, uint256 totalFees, uint256 rentals, uint256 spotlightTotal, uint256 ethCollected, uint256 bkcFees)","event NFTListed(uint256 indexed tokenId, address indexed owner, uint256 pricePerHour, uint256 minHours, uint256 maxHours)","event NFTRented(uint256 indexed tokenId, address indexed tenant, address indexed owner, uint256 hours_, uint256 totalCost, uint256 protocolFee, uint256 ownerPayout, uint256 endTime, address operator)","event ListingSpotlighted(uint256 indexed tokenId, address indexed owner, uint256 amount, uint256 newTotal, uint256 timestamp, address operator)"],Wu=["function setApprovalForAll(address operator, bool approved) external","function isApprovedForAll(address owner, address operator) view returns (bool)","function ownerOf(uint256 tokenId) view returns (address)"];function Ne(e){const t=window.ethers,n=Zt();return new t.Contract(n.RENTAL_MARKETPLACE,js,e)}async function fe(){const e=window.ethers,{NetworkManager:t}=await Y(async()=>{const{NetworkManager:s}=await import("./index-DxBdDQU9.js");return{NetworkManager:s}},[]),n=t.getProvider(),a=Zt();return new e.Contract(a.RENTAL_MARKETPLACE,js,n)}function Gu(e){const t=window.ethers,n=Zt();return new t.Contract(n.NFT_CONTRACT,Wu,e)}async function Ws({tokenId:e,pricePerHour:t,minHours:n,maxHours:a,button:s=null,onSuccess:r=null,onError:o=null}){const i=Zt(),l=BigInt(t);return await Z.execute({name:"ListNFT",button:s,getContract:async d=>Ne(d),method:"listNFT",args:[e,l,n,a],validate:async(d,u)=>{const f=Gu(d);if((await f.ownerOf(e)).toLowerCase()!==u.toLowerCase())throw new Error("You do not own this NFT");if(await Ne(d).paused())throw new Error("Marketplace is currently paused");await f.isApprovedForAll(u,i.RENTAL_MARKETPLACE)||await(await f.setApprovalForAll(i.RENTAL_MARKETPLACE,!0)).wait()},onSuccess:r,onError:o})}async function Gs({tokenId:e,hours:t,operator:n,button:a=null,onSuccess:s=null,onError:r=null}){const o=window.ethers,i=Zt();let l=n,d=0n;return await Z.execute({name:"RentNFT",button:a,getContract:async u=>Ne(u),method:"rentNFT",args:()=>[e,t,ce(l)],get approval(){return d>0n?{token:i.BKC_TOKEN,spender:i.RENTAL_MARKETPLACE,amount:d}:null},validate:async(u,f)=>{const m=Ne(u);if(await m.paused())throw new Error("Marketplace is currently paused");const b=await m.getListing(e);if(!b.isActive)throw new Error("NFT is not listed for rent");if(t<Number(b.minHours)||t>Number(b.maxHours))throw new Error(`Hours must be between ${b.minHours} and ${b.maxHours}`);if(await m.isRented(e))throw new Error("NFT is currently rented");d=(await m.getRentalCost(e,t)).totalCost;const{NetworkManager:g}=await Y(async()=>{const{NetworkManager:N}=await import("./index-DxBdDQU9.js");return{NetworkManager:N}},[]),y=g.getProvider(),k=["function balanceOf(address) view returns (uint256)"];if(await new o.Contract(i.BKC_TOKEN,k,y).balanceOf(f)<d)throw new Error(`Insufficient BKC. Need ${o.formatEther(d)} BKC`)},onSuccess:async u=>{let f=null;try{const m=new o.Interface(js);for(const b of u.logs)try{const p=m.parseLog(b);if((p==null?void 0:p.name)==="NFTRented"){f={endTime:Number(p.args.endTime),totalCost:p.args.totalCost,protocolFee:p.args.protocolFee,ownerPayout:p.args.ownerPayout};break}}catch{}}catch{}s&&s(u,f)},onError:r})}async function ll({tokenId:e,operator:t,button:n=null,onSuccess:a=null,onError:s=null}){const r=window.ethers,o=Zt();let i=t,l=0n;return await Z.execute({name:"RentNFTSimple",button:n,getContract:async d=>Ne(d),method:"rentNFTSimple",args:()=>[e,ce(i)],get approval(){return l>0n?{token:o.BKC_TOKEN,spender:o.RENTAL_MARKETPLACE,amount:l}:null},validate:async(d,u)=>{const f=Ne(d);if(await f.paused())throw new Error("Marketplace is currently paused");const m=await f.getListing(e);if(!m.isActive)throw new Error("NFT is not listed for rent");if(await f.isRented(e))throw new Error("NFT is currently rented");l=m.pricePerHour;const{NetworkManager:b}=await Y(async()=>{const{NetworkManager:T}=await import("./index-DxBdDQU9.js");return{NetworkManager:T}},[]),p=b.getProvider(),g=["function balanceOf(address) view returns (uint256)"];if(await new r.Contract(o.BKC_TOKEN,g,p).balanceOf(u)<l)throw new Error(`Insufficient BKC. Need ${r.formatEther(l)} BKC`)},onSuccess:a,onError:s})}async function Ks({tokenId:e,button:t=null,onSuccess:n=null,onError:a=null}){return await Z.execute({name:"WithdrawNFT",button:t,getContract:async s=>Ne(s),method:"withdrawNFT",args:[e],validate:async(s,r)=>{const o=Ne(s),i=await o.getListing(e);if(!i.isActive)throw new Error("NFT is not listed");if(i.owner.toLowerCase()!==r.toLowerCase())throw new Error("Only the owner can withdraw");if(await o.isRented(e))throw new Error("Cannot withdraw while NFT is rented")},onSuccess:n,onError:a})}async function cl({tokenId:e,pricePerHour:t,minHours:n,maxHours:a,button:s=null,onSuccess:r=null,onError:o=null}){const i=BigInt(t);return await Z.execute({name:"UpdateListing",button:s,getContract:async l=>Ne(l),method:"updateListing",args:[e,i,n,a],validate:async(l,d)=>{const f=await Ne(l).getListing(e);if(!f.isActive)throw new Error("NFT is not listed");if(f.owner.toLowerCase()!==d.toLowerCase())throw new Error("Only the owner can update")},onSuccess:r,onError:o})}async function $n({tokenId:e,amount:t,operator:n,button:a=null,onSuccess:s=null,onError:r=null}){const o=window.ethers,i=BigInt(t);let l=n;return await Z.execute({name:"SpotlightListing",button:a,getContract:async d=>Ne(d),method:"spotlightListing",args:()=>[e,ce(l)],value:i,validate:async(d,u)=>{const f=Ne(d);if(await f.paused())throw new Error("Marketplace is currently paused");if(!(await f.getListing(e)).isActive)throw new Error("NFT is not listed");try{const p=await f.minSpotlightAmount();if(i<p)throw new Error(`Minimum spotlight is ${o.formatEther(p)} ETH`)}catch(p){if(p.message.includes("Minimum"))throw p}if(await d.provider.getBalance(u)<i+o.parseEther("0.001"))throw new Error("Insufficient ETH")},onSuccess:s,onError:r})}async function dl(e){const t=window.ethers,a=await(await fe()).getListing(e);return{owner:a.owner,pricePerHour:a.pricePerHour,pricePerHourFormatted:t.formatEther(a.pricePerHour),minHours:Number(a.minHours),maxHours:Number(a.maxHours),isActive:a.isActive,totalEarnings:a.totalEarnings,totalEarningsFormatted:t.formatEther(a.totalEarnings),rentalCount:Number(a.rentalCount)}}async function ul(e){const t=window.ethers,a=await(await fe()).getRental(e),s=Math.floor(Date.now()/1e3),r=Number(a.endTime),o=r>s;return{tenant:a.tenant,startTime:Number(a.startTime),endTime:r,paidAmount:a.paidAmount,paidAmountFormatted:t.formatEther(a.paidAmount),isActive:o,hoursRemaining:o?Math.max(0,Math.ceil((r-s)/3600)):0}}async function pl(){return(await(await fe()).getAllListedTokenIds()).map(n=>Number(n))}async function ml(){const e=await fe();return Number(await e.getListingCount())}async function fl(e,t){const n=window.ethers,s=await(await fe()).getRentalCost(e,t);return{totalCost:s.totalCost,totalCostFormatted:n.formatEther(s.totalCost),protocolFee:s.protocolFee,protocolFeeFormatted:n.formatEther(s.protocolFee),ownerPayout:s.ownerPayout,ownerPayoutFormatted:n.formatEther(s.ownerPayout)}}async function bl(e){return await(await fe()).isRented(e)}async function gl(e){const t=await fe();return Number(await t.getRemainingRentalTime(e))}async function xl(e,t){return await(await fe()).hasRentalRights(e,t)}async function hl(e){const t=window.ethers,n=await fe();try{const a=await n.getEffectiveSpotlight(e);return{effectiveAmount:a.effectiveAmount,effectiveAmountFormatted:t.formatEther(a.effectiveAmount),daysPassed:Number(a.daysPassed)}}catch{return{effectiveAmount:0n,effectiveAmountFormatted:"0",daysPassed:0}}}async function vl(e=0,t=20){const n=window.ethers,a=await fe();try{const s=await a.getSpotlightedListingsPaginated(e,t);return{tokenIds:s.tokenIds.map(r=>Number(r)),effectiveSpotlights:s.effectiveSpotlights.map(r=>({amount:r,formatted:n.formatEther(r)})),total:Number(s.total)}}catch{return{tokenIds:[],effectiveSpotlights:[],total:0}}}async function wl(){const e=window.ethers,t=await fe();try{const n=await t.getSpotlightConfig();return{decayPerDayBips:Number(n.decayPerDayBips),decayPerDayPercent:Number(n.decayPerDayBips)/100,minAmount:n.minAmount,minAmountFormatted:e.formatEther(n.minAmount),maxDays:Number(n.maxDays),totalSpotlightedListings:Number(n.totalSpotlightedListings),totalCollected:n.totalCollected,totalCollectedFormatted:e.formatEther(n.totalCollected)}}catch{return{decayPerDayBips:100,decayPerDayPercent:1,minAmount:0n,minAmountFormatted:"0",maxDays:100,totalSpotlightedListings:0,totalCollected:0n,totalCollectedFormatted:"0"}}}async function yl(){const e=await fe();try{const t=await e.getFeeConfig();return{miningFeeBips:Number(t.miningFeeBips),miningFeePercent:Number(t.miningFeeBips)/100,burnFeeBips:Number(t.burnFeeBips),burnFeePercent:Number(t.burnFeeBips)/100,totalFeeBips:Number(t.totalFeeBips),totalFeePercent:Number(t.totalFeeBips)/100}}catch{const t=await e.rentalFeeBips().catch(()=>1e3);return{miningFeeBips:Number(t),miningFeePercent:Number(t)/100,burnFeeBips:0,burnFeePercent:0,totalFeeBips:Number(t),totalFeePercent:Number(t)/100}}}async function kl(){const e=window.ethers,t=await fe();try{const n=await t.getMarketplaceStats();return{activeListings:Number(n.activeListings),totalVolume:n.totalVol,totalVolumeFormatted:e.formatEther(n.totalVol),totalFees:n.totalFees,totalFeesFormatted:e.formatEther(n.totalFees),totalRentals:Number(n.rentals),totalSpotlight:n.spotlightTotal,totalSpotlightFormatted:e.formatEther(n.spotlightTotal),totalETHCollected:n.ethCollected,totalETHFormatted:e.formatEther(n.ethCollected),totalBKCFees:n.bkcFees,totalBKCFormatted:e.formatEther(n.bkcFees)}}catch{return{activeListings:0,totalVolume:0n,totalVolumeFormatted:"0",totalFees:0n,totalFeesFormatted:"0",totalRentals:0,totalSpotlight:0n,totalSpotlightFormatted:"0",totalETHCollected:0n,totalETHFormatted:"0",totalBKCFees:0n,totalBKCFormatted:"0"}}}async function El(){return await(await fe()).paused()}async function Tl(e){const t=await fe();try{return await t.hasActiveRental(e)}catch{return!1}}async function Cl(e){const t=await fe();try{const n=await t.getUserActiveRentals(e);return n.tokenIds.map((a,s)=>({tokenId:Number(a),endTime:Number(n.endTimes[s]),hoursRemaining:Math.max(0,Math.ceil((Number(n.endTimes[s])-Math.floor(Date.now()/1e3))/3600))}))}catch{return[]}}const Il=Ws,Al=Gs,Bl=Ks,Pl=$n,Nl=$n,zl=$n,_n={listNft:Ws,rentNft:Gs,rentNftSimple:ll,withdrawNft:Ks,updateListing:cl,spotlightListing:$n,list:Il,rent:Al,withdraw:Bl,spotlight:Pl,promote:zl,promoteListing:Nl,getListing:dl,getAllListedTokenIds:pl,getListingCount:ml,getRentalCost:fl,getRental:ul,isRented:bl,getRemainingRentalTime:gl,hasRentalRights:xl,getEffectiveSpotlight:hl,getSpotlightedListings:vl,getSpotlightConfig:wl,hasActiveRental:Tl,getUserActiveRentals:Cl,getFeeConfig:yl,getMarketplaceStats:kl,isMarketplacePaused:El},Ku=Object.freeze(Object.defineProperty({__proto__:null,RentalTx:_n,getAllListedTokenIds:pl,getEffectiveSpotlight:hl,getFeeConfig:yl,getListing:dl,getListingCount:ml,getMarketplaceStats:kl,getRemainingRentalTime:gl,getRental:ul,getRentalCost:fl,getSpotlightConfig:wl,getSpotlightedListings:vl,getUserActiveRentals:Cl,hasActiveRental:Tl,hasRentalRights:xl,isMarketplacePaused:El,isRented:bl,list:Il,listNft:Ws,promote:zl,promoteListing:Nl,rent:Al,rentNft:Gs,rentNftSimple:ll,spotlight:Pl,spotlightListing:$n,updateListing:cl,withdraw:Bl,withdrawNft:Ks},Symbol.toStringTag,{value:"Module"}));function Ys(){var n,a,s;const e=(w==null?void 0:w.decentralizedNotary)||(R==null?void 0:R.decentralizedNotary)||((n=window.contractAddresses)==null?void 0:n.decentralizedNotary)||(w==null?void 0:w.notary)||(R==null?void 0:R.notary)||((a=window.contractAddresses)==null?void 0:a.notary),t=(w==null?void 0:w.bkcToken)||(R==null?void 0:R.bkcToken)||((s=window.contractAddresses)==null?void 0:s.bkcToken);if(!e)throw console.error("❌ Notary address not found!",{addresses:w,contractAddresses:R}),new Error("Contract addresses not loaded. Please refresh the page.");return{NOTARY:e,BKC_TOKEN:t}}const Vs=["function notarize(string calldata _ipfsCid, string calldata _description, bytes32 _contentHash, address _operator) external payable returns (uint256 tokenId)","function documents(uint256 tokenId) view returns (string ipfsCid, string description, bytes32 contentHash, uint256 timestamp)","function getDocument(uint256 _tokenId) view returns (tuple(string ipfsCid, string description, bytes32 contentHash, uint256 timestamp))","function notarizationFeePaid(uint256 tokenId) view returns (uint256)","function verifyByHash(bytes32 _contentHash) view returns (bool exists, uint256 tokenId, address owner, uint256 timestamp)","function hashToTokenId(bytes32 hash) view returns (uint256)","function getFee() view returns (uint256 bkcFee, uint256 ethFee)","function notarizationFeeETH() view returns (uint256)","function SERVICE_KEY() view returns (bytes32)","function totalSupply() view returns (uint256)","function totalNotarizations() view returns (uint256)","function totalBKCCollected() view returns (uint256)","function totalETHCollected() view returns (uint256)","function getStats() view returns (uint256 notarizations, uint256 bkcCollected, uint256 ethCollected)","function ownerOf(uint256 tokenId) view returns (address)","function balanceOf(address owner) view returns (uint256)","function tokenURI(uint256 _tokenId) view returns (string)","function name() view returns (string)","function symbol() view returns (string)","event DocumentNotarized(uint256 indexed tokenId, address indexed owner, string ipfsCid, bytes32 indexed contentHash, uint256 bkcFeePaid, uint256 ethFeePaid, address operator)","event ETHFeeUpdated(uint256 oldFee, uint256 newFee)"];function Ur(e){const t=window.ethers;if(!t)throw new Error("ethers.js not loaded");if(!e)throw new Error("Signer is required for write operations");const n=Ys();return new t.Contract(n.NOTARY,Vs,e)}async function Ze(){const e=window.ethers;if(!e)throw new Error("ethers.js not loaded");const{NetworkManager:t}=await Y(async()=>{const{NetworkManager:s}=await import("./index-DxBdDQU9.js");return{NetworkManager:s}},[]),n=t.getProvider();if(!n)throw new Error("Provider not available");const a=Ys();return new e.Contract(a.NOTARY,Vs,n)}function Yu(e){if(!e)return!1;const t=e.startsWith("0x")?e:`0x${e}`;return/^0x[a-fA-F0-9]{64}$/.test(t)}async function Ll({ipfsCid:e,description:t="",contentHash:n,operator:a,button:s=null,onSuccess:r=null,onError:o=null}){const i=window.ethers,l=Ys();if(!e||e.trim().length===0)throw new Error("IPFS CID is required");if(!n)throw new Error("Content hash is required");const d=n.startsWith("0x")?n:`0x${n}`;if(!Yu(d))throw new Error("Invalid content hash format. Must be a valid bytes32 (64 hex characters)");let u=a,f=0n,m=0n;return await Z.execute({name:"Notarize",button:s,getContract:async b=>Ur(b),method:"notarize",args:()=>[e,t||"",d,ce(u)],get value(){return m},get approval(){return f>0n&&l.BKC_TOKEN?{token:l.BKC_TOKEN,spender:l.NOTARY,amount:f}:null},validate:async(b,p)=>{const g=Ur(b);try{const[N,z]=await g.getFee();f=N,m=z,console.log("[NotaryTx] Fees:",{bkcFee:i.formatEther(N)+" BKC",ethFee:i.formatEther(z)+" ETH"})}catch{try{m=await g.notarizationFeeETH()}catch{m=i.parseEther("0.0001")}f=i.parseEther("1")}const{NetworkManager:y}=await Y(async()=>{const{NetworkManager:N}=await import("./index-DxBdDQU9.js");return{NetworkManager:N}},[]),k=y.getProvider(),T=await k.getBalance(p),I=m+i.parseEther("0.001");if(T<I)throw new Error(`Insufficient ETH. Need ~${i.formatEther(I)} ETH for fee + gas`);if(f>0n&&l.BKC_TOKEN){const N=["function balanceOf(address) view returns (uint256)"];if(await new i.Contract(l.BKC_TOKEN,N,k).balanceOf(p)<f)throw new Error(`Insufficient BKC. Need ${i.formatEther(f)} BKC`)}},onSuccess:async b=>{let p=null,g={bkc:0n,eth:0n};try{const y=new i.Interface(Vs);for(const k of b.logs)try{const T=y.parseLog(k);if(T&&T.name==="DocumentNotarized"){p=Number(T.args.tokenId),g={bkc:T.args.bkcFeePaid,eth:T.args.ethFeePaid};break}}catch{}}catch{}r&&r(b,p,g)},onError:b=>{console.error("[NotaryTx] Notarization failed:",b),o&&o(b)}})}async function Sl(e){const t=await Ze();try{const n=await t.getDocument(e),a=await t.ownerOf(e),s=await t.notarizationFeePaid(e).catch(()=>0n);return{id:e,owner:a,ipfsCid:n.ipfsCid,description:n.description,contentHash:n.contentHash,timestamp:Number(n.timestamp),date:new Date(Number(n.timestamp)*1e3),feePaid:s}}catch{return null}}async function qs(e){const t=await Ze(),n=e.startsWith("0x")?e:`0x${e}`;try{const a=await t.verifyByHash(n);return{exists:a.exists,tokenId:a.exists?Number(a.tokenId):null,owner:a.exists?a.owner:null,timestamp:a.exists?Number(a.timestamp):null,date:a.exists?new Date(Number(a.timestamp)*1e3):null}}catch(a){return console.error("[NotaryTx] verifyByHash error:",a),{exists:!1,tokenId:null,owner:null,timestamp:null,date:null}}}async function Rl(e){const t=await Ze(),n=e.startsWith("0x")?e:`0x${e}`;try{const a=await t.hashToTokenId(n);return Number(a)>0?Number(a):null}catch{return null}}async function $l(){const e=window.ethers,t=await Ze();try{const[n,a]=await t.getFee();return{bkcFee:n,ethFee:a,bkcFormatted:e.formatEther(n)+" BKC",ethFormatted:e.formatEther(a)+" ETH",totalInEth:a}}catch{const n=await t.notarizationFeeETH().catch(()=>e.parseEther("0.0001"));return{bkcFee:e.parseEther("1"),ethFee:n,bkcFormatted:"1 BKC",ethFormatted:e.formatEther(n)+" ETH",totalInEth:n}}}async function _l(){const e=await Ze();try{return await e.notarizationFeeETH()}catch{return window.ethers.parseEther("0.0001")}}async function Fl(){const e=await Ze();return Number(await e.totalSupply())}async function Ml(){const e=window.ethers,t=await Ze();try{const n=await t.getStats();return{totalNotarizations:Number(n.notarizations),totalBKCCollected:n.bkcCollected,totalBKCFormatted:e.formatEther(n.bkcCollected),totalETHCollected:n.ethCollected,totalETHFormatted:e.formatEther(n.ethCollected)}}catch{const[n,a,s]=await Promise.all([t.totalNotarizations().catch(()=>0n),t.totalBKCCollected().catch(()=>0n),t.totalETHCollected().catch(()=>0n)]);return{totalNotarizations:Number(n),totalBKCCollected:a,totalBKCFormatted:e.formatEther(a),totalETHCollected:s,totalETHFormatted:e.formatEther(s)}}}async function Dl(e){const t=await Ze();return Number(await t.balanceOf(e))}async function Ol(e){return await(await Ze()).tokenURI(e)}async function Ta(e){let t;if(e instanceof ArrayBuffer)t=e;else if(e instanceof Blob||e instanceof File)t=await e.arrayBuffer();else throw new Error("Invalid file type. Expected File, Blob, or ArrayBuffer");const n=await crypto.subtle.digest("SHA-256",t);return"0x"+Array.from(new Uint8Array(n)).map(s=>s.toString(16).padStart(2,"0")).join("")}async function Xs(e,t){const n=await Ta(e),a=t.toLowerCase(),s=n.toLowerCase();return a===s}async function Hl(e,t){const n=t||await Ta(e),a=await qs(n);let s=!0;return t&&(s=await Xs(e,t)),{contentHash:n,hashMatches:s,existsOnChain:a.exists,tokenId:a.tokenId,owner:a.owner,timestamp:a.timestamp,date:a.date,isVerified:s&&a.exists}}const Ul={notarize:Ll,getDocument:Sl,getTotalDocuments:Fl,getUserDocumentCount:Dl,getTokenURI:Ol,verifyByHash:qs,getTokenIdByHash:Rl,getFee:$l,getNotarizationFeeETH:_l,getStats:Ml,calculateFileHash:Ta,verifyDocumentHash:Xs,verifyDocumentOnChain:Hl},Vu=Object.freeze(Object.defineProperty({__proto__:null,NotaryTx:Ul,calculateFileHash:Ta,getDocument:Sl,getFee:$l,getNotarizationFeeETH:_l,getStats:Ml,getTokenIdByHash:Rl,getTokenURI:Ol,getTotalDocuments:Fl,getUserDocumentCount:Dl,notarize:Ll,verifyByHash:qs,verifyDocumentHash:Xs,verifyDocumentOnChain:Hl},Symbol.toStringTag,{value:"Module"}));(async()=>(await Y(async()=>{const{CharityTx:e}=await Promise.resolve().then(()=>$u);return{CharityTx:e}},void 0)).CharityTx)(),(async()=>(await Y(async()=>{const{StakingTx:e}=await Promise.resolve().then(()=>Fu);return{StakingTx:e}},void 0)).StakingTx)(),(async()=>(await Y(async()=>{const{NftTx:e}=await Promise.resolve().then(()=>Ou);return{NftTx:e}},void 0)).NftTx)(),(async()=>(await Y(async()=>{const{FortuneTx:e}=await Promise.resolve().then(()=>ju);return{FortuneTx:e}},void 0)).FortuneTx)(),(async()=>(await Y(async()=>{const{RentalTx:e}=await Promise.resolve().then(()=>Ku);return{RentalTx:e}},void 0)).RentalTx)(),(async()=>(await Y(async()=>{const{NotaryTx:e}=await Promise.resolve().then(()=>Vu);return{NotaryTx:e}},void 0)).NotaryTx)(),(async()=>(await Y(async()=>{const{FaucetTx:e}=await Promise.resolve().then(()=>wu);return{FaucetTx:e}},void 0)).FaucetTx)(),(async()=>(await Y(async()=>{const{BackchatTx:e}=await import("./backchat-tx-xt2Rs6xt.js");return{BackchatTx:e}},[])).BackchatTx)();const jt=window.ethers,S={hasRenderedOnce:!1,lastUpdate:0,activities:[],networkActivities:[],filteredActivities:[],userProfile:null,pagination:{currentPage:1,itemsPerPage:8},filters:{type:"ALL",sort:"NEWEST"},metricsCache:{},economicData:null,isLoadingNetworkActivity:!1,networkActivitiesTimestamp:0,faucet:{canClaim:!0,cooldownEnd:null,isLoading:!1,lastCheck:0}},jr="https://sepolia.arbiscan.io/tx/",qu="https://sepolia.arbiscan.io/address/",Xu="https://faucet-4wvdcuoouq-uc.a.run.app",Ju="https://getrecentactivity-4wvdcuoouq-uc.a.run.app",Zu="https://getsystemdata-4wvdcuoouq-uc.a.run.app",as="1,000",ss="0.01",Qu=jt.parseUnits("100",18),M={STAKING:{icon:"fa-lock",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🔒 Staked",emoji:"🔒"},UNSTAKING:{icon:"fa-unlock",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"🔓 Unstaked",emoji:"🔓"},FORCE_UNSTAKE:{icon:"fa-bolt",color:"#ef4444",bg:"rgba(239,68,68,0.15)",label:"⚡ Force Unstaked",emoji:"⚡"},CLAIM:{icon:"fa-coins",color:"#fbbf24",bg:"rgba(245,158,11,0.15)",label:"🪙 Rewards Claimed",emoji:"🪙"},NFT_BUY:{icon:"fa-bag-shopping",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🛍️ Bought NFT",emoji:"🛍️"},NFT_SELL:{icon:"fa-hand-holding-dollar",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"💰 Sold NFT",emoji:"💰"},NFT_MINT:{icon:"fa-gem",color:"#fde047",bg:"rgba(234,179,8,0.15)",label:"💎 Minted Booster",emoji:"💎"},NFT_TRANSFER:{icon:"fa-arrow-right-arrow-left",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"↔️ Transfer",emoji:"↔️"},RENTAL_LIST:{icon:"fa-tag",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🏷️ Listed NFT",emoji:"🏷️"},RENTAL_RENT:{icon:"fa-clock",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"⏰ Rented NFT",emoji:"⏰"},RENTAL_WITHDRAW:{icon:"fa-rotate-left",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"↩️ Withdrawn",emoji:"↩️"},RENTAL_PROMOTE:{icon:"fa-bullhorn",color:"#fbbf24",bg:"rgba(251,191,36,0.2)",label:"📢 Promoted NFT",emoji:"📢"},FORTUNE_COMMIT:{icon:"fa-lock",color:"#a855f7",bg:"rgba(168,85,247,0.2)",label:"🔐 Game Committed",emoji:"🔐"},FORTUNE_REVEAL:{icon:"fa-dice",color:"#f97316",bg:"rgba(249,115,22,0.2)",label:"🎲 Game Revealed",emoji:"🎲"},FORTUNE_BET:{icon:"fa-paw",color:"#f97316",bg:"rgba(249,115,22,0.2)",label:"🐯 Fortune Bet",emoji:"🐯"},FORTUNE_COMBO:{icon:"fa-rocket",color:"#a855f7",bg:"rgba(168,85,247,0.2)",label:"🚀 Combo Mode",emoji:"🚀"},FORTUNE_JACKPOT:{icon:"fa-crown",color:"#f59e0b",bg:"rgba(245,158,11,0.2)",label:"👑 Jackpot Mode",emoji:"👑"},FORTUNE_WIN:{icon:"fa-trophy",color:"#facc15",bg:"rgba(234,179,8,0.25)",label:"🏆 Winner!",emoji:"🏆"},FORTUNE_LOSE:{icon:"fa-dice",color:"#71717a",bg:"rgba(39,39,42,0.5)",label:"🎲 No Luck",emoji:"🎲"},NOTARY:{icon:"fa-stamp",color:"#818cf8",bg:"rgba(99,102,241,0.15)",label:"📜 Notarized",emoji:"📜"},BACKCHAT_POST:{icon:"fa-comment",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"💬 Posted",emoji:"💬"},BACKCHAT_LIKE:{icon:"fa-heart",color:"#ec4899",bg:"rgba(236,72,153,0.15)",label:"❤️ Liked",emoji:"❤️"},BACKCHAT_REPLY:{icon:"fa-reply",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"↩️ Replied",emoji:"↩️"},BACKCHAT_SUPERLIKE:{icon:"fa-star",color:"#fbbf24",bg:"rgba(251,191,36,0.2)",label:"⭐ Super Liked",emoji:"⭐"},BACKCHAT_REPOST:{icon:"fa-retweet",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🔄 Reposted",emoji:"🔄"},BACKCHAT_FOLLOW:{icon:"fa-user-plus",color:"#a78bfa",bg:"rgba(167,139,250,0.15)",label:"👥 Followed",emoji:"👥"},BACKCHAT_PROFILE:{icon:"fa-user",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"👤 Profile Created",emoji:"👤"},BACKCHAT_BOOST:{icon:"fa-rocket",color:"#f97316",bg:"rgba(249,115,22,0.15)",label:"🚀 Profile Boosted",emoji:"🚀"},BACKCHAT_BADGE:{icon:"fa-circle-check",color:"#10b981",bg:"rgba(16,185,129,0.15)",label:"✅ Badge Activated",emoji:"✅"},BACKCHAT_TIP:{icon:"fa-coins",color:"#fbbf24",bg:"rgba(251,191,36,0.15)",label:"💰 Tipped BKC",emoji:"💰"},BACKCHAT_WITHDRAW:{icon:"fa-wallet",color:"#8b5cf6",bg:"rgba(139,92,246,0.15)",label:"💸 ETH Withdrawn",emoji:"💸"},CHARITY_DONATE:{icon:"fa-heart",color:"#ec4899",bg:"rgba(236,72,153,0.15)",label:"💝 Donated",emoji:"💝"},CHARITY_CREATE:{icon:"fa-hand-holding-heart",color:"#10b981",bg:"rgba(16,185,129,0.15)",label:"🌱 Campaign Created",emoji:"🌱"},CHARITY_CANCEL:{icon:"fa-heart-crack",color:"#ef4444",bg:"rgba(239,68,68,0.15)",label:"💔 Campaign Cancelled",emoji:"💔"},CHARITY_WITHDRAW:{icon:"fa-hand-holding-dollar",color:"#8b5cf6",bg:"rgba(139,92,246,0.15)",label:"💰 Funds Withdrawn",emoji:"💰"},CHARITY_GOAL_REACHED:{icon:"fa-trophy",color:"#fbbf24",bg:"rgba(251,191,36,0.15)",label:"🏆 Goal Reached!",emoji:"🏆"},FAUCET:{icon:"fa-droplet",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"💧 Faucet Claim",emoji:"💧"},DEFAULT:{icon:"fa-circle",color:"#71717a",bg:"rgba(39,39,42,0.5)",label:"Activity",emoji:"📋"}};function ep(e){if(!e)return"Just now";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3,n=new Date(t*1e3),s=new Date-n,r=Math.floor(s/6e4),o=Math.floor(s/36e5),i=Math.floor(s/864e5);return r<1?"Just now":r<60?`${r}m ago`:o<24?`${o}h ago`:i<7?`${i}d ago`:n.toLocaleDateString()}catch{return"Recent"}}function tp(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function Oa(e){return e>=1e6?(e/1e6).toFixed(2)+"M":e>=1e3?(e/1e3).toFixed(1)+"K":e.toFixed(0)}function np(e){return e?`${e.slice(0,6)}...${e.slice(-4)}`:""}function ap(e){if(!e)return"";const t=Date.now(),a=new Date(e).getTime()-t;if(a<=0)return"";const s=Math.floor(a/36e5),r=Math.floor(a%36e5/6e4);return s>0?`${s}h ${r}m`:`${r}m`}function sp(e,t={}){const n=(e||"").toUpperCase().trim();if(n==="STAKING"||n==="STAKED"||n==="STAKE"||n==="DELEGATED"||n==="DELEGATION"||n.includes("DELEGAT"))return M.STAKING;if(n==="UNSTAKE"||n==="UNSTAKED"||n==="UNSTAKING"||n.includes("UNDELEGAT"))return n.includes("FORCE")?M.FORCE_UNSTAKE:M.UNSTAKING;if(n==="CLAIMREWARD"||n==="CLAIM"||n==="CLAIMED"||n.includes("REWARD")||n.includes("CLAIM"))return M.CLAIM;if(n==="NFTBOUGHT"||n.includes("NFTBOUGHT")||n.includes("NFT_BOUGHT"))return M.NFT_BUY;if(n==="NFTSOLD"||n.includes("NFTSOLD")||n.includes("NFT_SOLD"))return M.NFT_SELL;if(n==="BOOSTERBUY"||n.includes("BOOSTER")||n.includes("PRESALE")||n.includes("MINTED"))return M.NFT_MINT;if(n==="TRANSFER"||n.includes("TRANSFER"))return M.NFT_TRANSFER;if(n==="RENTALLISTED"||n==="NFTLISTED"||n.includes("LIST")&&!n.includes("PROMOTE"))return M.RENTAL_LIST;if(n==="RENTALPROMOTED"||n==="PROMOTED"||n==="PROMOTE"||n.includes("PROMOT")||n.includes("ADS")||n.includes("ADVERTIS"))return M.RENTAL_PROMOTE;if(n==="RENTALRENTED"||n==="RENTED"||n.includes("RENTAL")&&n.includes("RENT"))return M.RENTAL_RENT;if(n==="RENTALWITHDRAWN"||n.includes("WITHDRAW"))return M.RENTAL_WITHDRAW;if(n==="GAMECOMMITTED"||n.includes("COMMITTED")||n.includes("COMMIT")){const a=t==null?void 0:t.isCumulative;return a===!0?M.FORTUNE_COMBO:a===!1?M.FORTUNE_JACKPOT:M.FORTUNE_COMMIT}if(n==="GAMEREVEALED"||n.includes("REVEALED")||n.includes("REVEAL"))return(t==null?void 0:t.isWin)||(t==null?void 0:t.prizeWon)>0||(t==null?void 0:t.matchCount)>0?M.FORTUNE_WIN:M.FORTUNE_LOSE;if(n==="GAMEREQUESTED"||n.includes("GAMEREQUESTED")||n.includes("GAME_REQUEST")||n.includes("REQUEST")||n.includes("GAMEPLAYED")||n.includes("FORTUNE")||n.includes("GAME")){const a=t==null?void 0:t.isCumulative,s=(t==null?void 0:t.guesses)||[];return a===!0||s.length>1?M.FORTUNE_COMBO:a===!1||s.length===1?M.FORTUNE_JACKPOT:M.FORTUNE_BET}return n==="GAMEFULFILLED"||n.includes("FULFILLED")||n.includes("ORACLE")?M.FORTUNE_REVEAL:n==="GAMERESULT"||n.includes("RESULT")?(t==null?void 0:t.isWin)||(t==null?void 0:t.prizeWon)>0?M.FORTUNE_WIN:M.FORTUNE_LOSE:n==="POSTCREATED"||n==="POST_CREATED"||n.includes("POST")&&n.includes("CREAT")?M.BACKCHAT_POST:n==="SUPERLIKED"||n==="SUPER_LIKED"||n.includes("SUPERLIKE")?M.BACKCHAT_SUPERLIKE:n==="LIKED"||n==="POSTLIKED"||n==="POST_LIKED"||n.includes("LIKE")&&!n.includes("SUPER")?M.BACKCHAT_LIKE:n==="REPLYCREATED"||n==="REPLY_CREATED"||n.includes("REPLY")?M.BACKCHAT_REPLY:n==="REPOSTCREATED"||n==="REPOST_CREATED"||n.includes("REPOST")?M.BACKCHAT_REPOST:n==="FOLLOWED"||n==="USER_FOLLOWED"||n.includes("FOLLOW")?M.BACKCHAT_FOLLOW:n==="PROFILECREATED"||n==="PROFILE_CREATED"||n.includes("PROFILE")&&n.includes("CREAT")?M.BACKCHAT_PROFILE:n==="PROFILEBOOSTED"||n==="PROFILE_BOOSTED"||n==="BOOSTED"||n.includes("BOOST")&&!n.includes("NFT")?M.BACKCHAT_BOOST:n==="BADGEACTIVATED"||n==="BADGE_ACTIVATED"||n.includes("BADGE")?M.BACKCHAT_BADGE:n==="TIPPROCESSED"||n==="TIP_PROCESSED"||n==="TIPPED"||n.includes("TIP")?M.BACKCHAT_TIP:n==="ETHWITHDRAWN"||n==="ETH_WITHDRAWN"||n==="BACKCHAT_WITHDRAW"?M.BACKCHAT_WITHDRAW:n==="CHARITYDONATION"||n==="DONATIONMADE"||n==="CHARITY_DONATE"||n==="DONATED"||n==="DONATION"||n.includes("DONATION")?M.CHARITY_DONATE:n==="CHARITYCAMPAIGNCREATED"||n==="CAMPAIGNCREATED"||n==="CHARITY_CREATE"||n==="CAMPAIGN_CREATED"||n.includes("CAMPAIGNCREATED")?M.CHARITY_CREATE:n==="CHARITYCAMPAIGNCANCELLED"||n==="CAMPAIGNCANCELLED"||n==="CHARITY_CANCEL"||n==="CAMPAIGN_CANCELLED"||n.includes("CANCELLED")?M.CHARITY_CANCEL:n==="CHARITYFUNDSWITHDRAWN"||n==="FUNDSWITHDRAWN"||n==="CHARITY_WITHDRAW"||n==="CAMPAIGN_WITHDRAW"||n.includes("WITHDRAWN")?M.CHARITY_WITHDRAW:n==="CHARITYGOALREACHED"||n==="GOALREACHED"||n==="CHARITY_GOAL"||n==="CAMPAIGN_COMPLETED"?M.CHARITY_GOAL_REACHED:n==="NOTARYREGISTER"||n==="NOTARIZED"||n.includes("NOTARY")||n.includes("DOCUMENT")?M.NOTARY:n==="FAUCETCLAIM"||n.includes("FAUCET")||n.includes("DISTRIBUTED")?M.FAUCET:M.DEFAULT}let Ha=null,bt=0n;function jl(e){const t=document.getElementById("dash-user-rewards");if(!t||!c.isConnected){Ha&&cancelAnimationFrame(Ha);return}const n=e-bt;n>-1000000000n&&n<1000000000n?bt=e:bt+=n/8n,bt<0n&&(bt=0n),t.innerHTML=`${_(bt).toFixed(4)} <span class="text-sm text-green-500/80">BKC</span>`,bt!==e&&(Ha=requestAnimationFrame(()=>jl(e)))}async function Wr(e){if(!c.isConnected||!c.userAddress)return x("Connect wallet first","error");const t=e.innerHTML;e.disabled=!0,e.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-2"></i> Sending...',S.faucet.isLoading=!0;try{const n=await fetch(`${Xu}?address=${c.userAddress}`,{method:"GET",headers:{Accept:"application/json"}}),a=await n.json();if(n.ok&&a.success)x(`✅ Faucet Sent! ${as} BKC + ${ss} ETH`,"success"),S.faucet.canClaim=!1,S.faucet.cooldownEnd=new Date(Date.now()+24*60*60*1e3).toISOString(),rs(),setTimeout(()=>{Kl.update(!0)},4e3);else{const s=a.error||a.message||"Faucet unavailable";if(s.toLowerCase().includes("cooldown")||s.toLowerCase().includes("wait")||s.toLowerCase().includes("hour")){x(`⏳ ${s}`,"warning");const r=s.match(/(\d+)\s*hour/i);if(r){const o=parseInt(r[1]);S.faucet.canClaim=!1,S.faucet.cooldownEnd=new Date(Date.now()+o*60*60*1e3).toISOString(),rs()}}else x(`❌ ${s}`,"error")}}catch(n){console.error("Faucet error:",n),x("Faucet Offline - Try again later","error")}finally{S.faucet.isLoading=!1,e.disabled=!1,e.innerHTML=t}}function rp(){return c.isConnected?(c.currentUserBalance||c.bkcBalance||0n)<Qu:!1}function rs(){const e=document.getElementById("dashboard-faucet-widget");if(!e)return;if(!rp()){e.classList.add("hidden");return}e.classList.remove("hidden");const t=c.currentUserBalance||c.bkcBalance||0n,n=t===0n,a=ap(S.faucet.cooldownEnd),s=S.faucet.canClaim&&!a,r=document.getElementById("faucet-title"),o=document.getElementById("faucet-desc"),i=document.getElementById("faucet-status"),l=document.getElementById("faucet-action-btn");if(e.className="glass-panel border-l-4 p-4",l&&(l.className="w-full sm:w-auto font-bold py-2.5 px-5 rounded-lg text-sm transition-all"),!s&&a)e.classList.add("border-zinc-500"),r&&(r.innerText="⏳ Faucet Cooldown"),o&&(o.innerText="Come back when the timer ends"),i&&(i.classList.remove("hidden"),i.innerHTML=`<i class="fa-solid fa-clock mr-1"></i> ${a} remaining`),l&&(l.classList.add("bg-zinc-700","text-zinc-400","cursor-not-allowed"),l.innerHTML='<i class="fa-solid fa-hourglass-half mr-2"></i> On Cooldown',l.disabled=!0);else if(n)e.classList.add("border-green-500"),r&&(r.innerText="🎉 Welcome to BackCoin!"),o&&(o.innerText=`Claim your free starter pack: ${as} BKC + ${ss} ETH for gas`),i&&i.classList.add("hidden"),l&&(l.classList.add("bg-green-600","hover:bg-green-500","text-white","hover:scale-105"),l.innerHTML='<i class="fa-solid fa-gift mr-2"></i> Claim Starter Pack',l.disabled=!1);else{const d=_(t).toFixed(2);e.classList.add("border-cyan-500"),r&&(r.innerText="💧 Need More BKC?"),o&&(o.innerText=`Balance: ${d} BKC • Get ${as} BKC + ${ss} ETH`),i&&i.classList.add("hidden"),l&&(l.classList.add("bg-cyan-600","hover:bg-cyan-500","text-white","hover:scale-105"),l.innerHTML='<i class="fa-solid fa-faucet mr-2"></i> Request Tokens',l.disabled=!1)}}async function op(){try{if(await c.provider.getBalance(c.userAddress)<jt.parseEther("0.002")){const t=document.getElementById("no-gas-modal-dash");return t&&(t.classList.remove("hidden"),t.classList.add("flex")),!1}return!0}catch{return!0}}function ip(){if(!Be.dashboard)return;const e=w.ecosystemManager||"",t=e?`${qu}${e}`:"#";Be.dashboard.innerHTML=`
        <div class="flex flex-col gap-6 pb-10 max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
                ${lp("Total Supply","fa-coins","dash-metric-supply","Total BKC tokens in circulation")}
        ...
        ${dp()}
        ${up()}
    `,gp()}function Yn(e,t,n,a,s="zinc"){const r={zinc:"text-zinc-400",purple:"text-purple-400",blue:"text-blue-400",orange:"text-orange-400",green:"text-green-400",red:"text-red-400"},o=r[s]||r.zinc;return`
    ...
    `}function lp(e,t,n,a,s="zinc"){const r={zinc:"text-zinc-400",purple:"text-purple-400",blue:"text-blue-400",orange:"text-orange-400",green:"text-green-400",red:"text-red-400"},o=r[s]||r.zinc;return`
        <div class="glass-panel p-3 sm:p-4 group hover:border-zinc-600 transition-all cursor-default" title="${a}">
            <div class="flex items-center gap-1.5 mb-1">
                <i class="fa-solid ${t} ${o} text-xs"></i>
                <span class="text-[10px] text-zinc-500 uppercase font-bold tracking-wider truncate">${e}</span>
    ...
    `}async function pp(){try{const e=await fetch(Zu);if(e.ok){const t=await e.json();return S.economicData=t,t}}catch{}return null}async function os(){var e,t,n,a,s,r,o,i,l;try{const d=await pp();let u=0n,f=0n,m=0n,b=0n,p=0n,g=0,y=0n;if(d)if(console.log("📊 Firebase economic data:",d.economy),(e=d.economy)!=null&&e.totalSupply&&(u=BigInt(d.economy.totalSupply)),(t=d.economy)!=null&&t.totalPStake&&(f=BigInt(d.economy.totalPStake)),(n=d.economy)!=null&&n.totalTVL&&(m=BigInt(d.economy.totalTVL)),(a=d.economy)!=null&&a.totalFeesCollected&&(p=BigInt(d.economy.totalFeesCollected)),(s=d.economy)!=null&&s.fortunePoolBalance&&(y=BigInt(d.economy.fortunePoolBalance)),(r=d.stats)!=null&&r.notarizedDocuments&&(g=d.stats.notarizedDocuments),(o=d.burn)!=null&&o.totalBurned)b=BigInt(d.burn.totalBurned);else if((i=d.burn)!=null&&i.sources){let D=0n;for(const W of Object.values(d.burn.sources))W!=null&&W.total&&(D+=BigInt(W.total));b=D}else(l=d.rental)!=null&&l.totalBurned&&(b=BigInt(d.rental.totalBurned));if(c.bkcTokenContractPublic&&(u===0n&&(console.log("📊 Fetching totalSupply from blockchain (fallback)..."),u=await ne(c.bkcTokenContractPublic,"totalSupply",[],0n)),f===0n&&c.delegationManagerContractPublic&&(console.log("📊 Fetching totalPStake from blockchain (fallback)..."),f=await ne(c.delegationManagerContractPublic,"totalNetworkPStake",[],0n)),m===0n)){console.log("📊 Calculating TVL from blockchain (fallback)...");const D=[w.delegationManager,w.fortunePool,w.rentalManager,w.miningManager,w.decentralizedNotary,w.nftLiquidityPoolFactory,w.pool_diamond,w.pool_platinum,w.pool_gold,w.pool_silver,w.pool_bronze,w.pool_iron,w.pool_crystal].filter(ae=>ae&&ae!==jt.ZeroAddress),W=D.map(ae=>ne(c.bkcTokenContractPublic,"balanceOf",[ae],0n)),ie=await Promise.all(W);if(ie.forEach(ae=>{m+=ae}),w.fortunePool&&y===0n){const ae=D.indexOf(w.fortunePool);ae>=0&&(y=ie[ae])}}const k=_(u),T=_(b),I=_(p),N=_(y),z=D=>D.toLocaleString("en-US",{minimumFractionDigits:1,maximumFractionDigits:1});let E=0;u>0n&&(E=Number(m*10000n/u)/100),E>100&&(E=100);const F=(D,W,ie="")=>{const ae=document.getElementById(D);ae&&(ae.innerHTML=`${W}${ie?` <span class="text-xs text-zinc-500">${ie}</span>`:""}`)},G=document.getElementById("dash-metric-supply");G&&(G.innerHTML=`${z(k)} <span style="font-size: 10px; color: #71717a">BKC</span>`),F("dash-metric-pstake",Ut(f));const se=document.getElementById("dash-metric-burned");se&&(T>0?se.innerHTML=`<span class="text-red-400">${Oa(T)}</span> <span class="text-xs text-zinc-500">BKC 🔥</span>`:se.innerHTML='<span class="text-zinc-500">0</span> <span class="text-xs text-zinc-500">BKC</span>'),F("dash-metric-fees",Oa(I),"BKC");const de=document.getElementById("dash-metric-tvl");if(de){const D=E>30?"text-green-400":E>10?"text-yellow-400":"text-blue-400";de.innerHTML=`<span class="${D}">${E.toFixed(1)}%</span>`}Wl();const xe=document.getElementById("dash-fortune-prize");xe&&(xe.innerText=`${Oa(N)} BKC`);const Q=document.getElementById("dash-notary-count");Q&&(Q.innerText=g>0?`${g} docs`:"--"),S.metricsCache={supply:k,burned:T,fees:I,timestamp:Date.now()}}catch(d){console.error("Metrics Error",d)}}async function mp(){if(c.userAddress)try{const e=await fetch(`https://getuserprofile-4wvdcuoouq-uc.a.run.app/${c.userAddress}`);e.ok&&(S.userProfile=await e.json(),fp(S.userProfile))}catch{}}function fp(e){const t=document.getElementById("dash-presale-stats");if(!t||!e||!e.presale||!e.presale.totalBoosters||e.presale.totalBoosters===0)return;t.classList.remove("hidden");const n=e.presale.totalSpentWei||0,a=parseFloat(jt.formatEther(BigInt(n))).toFixed(4);document.getElementById("stats-total-spent").innerText=`${a} ETH`,document.getElementById("stats-total-boosters").innerText=e.presale.totalBoosters||0;const s=document.getElementById("stats-tier-badges");if(s&&e.presale.tiersOwned){let r="";Object.entries(e.presale.tiersOwned).forEach(([o,i])=>{const l=ge[Number(o)-1],d=l?l.name:`T${o}`;r+=`<span class="text-[9px] bg-zinc-800 text-zinc-400 px-1.5 py-0.5 rounded">${i}x ${d}</span>`}),r&&(s.innerHTML=r)}}function Wl(){const e=document.getElementById("dash-metric-balance"),t=document.getElementById("dash-balance-card");if(!e)return;const n=c.currentUserBalance||c.bkcBalance||0n;if(!c.isConnected){e.innerHTML='<span class="text-zinc-500 text-xs">Connect Wallet</span>',t&&(t.style.borderColor="rgba(63,63,70,0.5)");return}if(n===0n)e.innerHTML='0.00 <span style="font-size: 10px; color: #71717a">BKC</span>';else{const s=_(n).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2});e.innerHTML=`${s} <span style="font-size: 10px; color: #71717a">BKC</span>`}t&&(t.style.borderColor="rgba(245,158,11,0.3)")}async function _t(e=!1){var t,n;if(!c.isConnected){const a=document.getElementById("dash-booster-area");a&&(a.innerHTML=`
                ...
                </div>`);return}try{const a=document.getElementById("dash-user-rewards");e&&a&&a.classList.add("animate-pulse","opacity-70");const[,s,r]=await Promise.all([Pt(),Ld(),Ht()]),o=(s==null?void 0:s.netClaimAmount)||0n;jl(o),a&&a.classList.remove("animate-pulse","opacity-70");const i=document.getElementById("dashboardClaimBtn");i&&(i.disabled=o<=0n);const l=document.getElementById("dash-user-pstake");if(l){let d=((t=c.userData)==null?void 0:t.pStake)||((n=c.userData)==null?void 0:n.userTotalPStake)||c.userTotalPStake||0n;if(d===0n&&c.delegationManagerContractPublic&&c.userAddress)try{d=await ne(c.delegationManagerContractPublic,"userTotalPStake",[c.userAddress],0n)}catch{}l.innerText=Ut(d)}Wl(),bp(r,s),mp(),rs()}catch(a){console.error("User Hub Error:",a)}}function bp(e,t){var T;const n=document.getElementById("dash-booster-area");if(!n)return;const a=(e==null?void 0:e.highestBoost)||0,s=lt(a),r=(t==null?void 0:t.totalRewards)||0n,o=r*BigInt(s)/100n,l=r-o;if(a===0){if(l>0n){const I=document.getElementById("dash-user-gain-area");I&&(I.classList.remove("hidden"),document.getElementById("dash-user-potential-gain").innerText=_(l).toFixed(2))}n.innerHTML=`
            <div class="text-center space-y-3">
                ...
                <div class="bg-zinc-800/50 rounded-lg p-2 text-left space-y-1">
                    <div class="flex justify-between text-[11px]">
                        ...
                        <span class="text-green-400 font-bold">${_(o).toFixed(4)} BKC</span>
                    </div>
                    ${l>0n?`
                    <div class="flex justify-between text-[11px]">
        ...
        `;return}const d=e.source==="rented",u=d?"bg-cyan-500/20 text-cyan-300":"bg-green-500/20 text-green-300",f=d?"Rented":"Owned",m=pd(a),b=(m==null?void 0:m.name)||((T=e.boostName)==null?void 0:T.replace(" Booster","").replace("Booster","").trim())||"Booster",p=(m==null?void 0:m.color)||"text-amber-400",g=(m==null?void 0:m.emoji)||"💎",y=r*50n/100n,k=o-y;console.log("🎨 V6.8 Booster:",{keepRate:s,netReward:_(o),tierName:b}),n.innerHTML=`
        <div class="flex items-center gap-3 bg-zinc-800/40 border ${(m==null?void 0:m.borderColor)||"border-green-500/20"} rounded-lg p-3 nft-clickable-image cursor-pointer" data-address="${w.rewardBoosterNFT}" data-tokenid="${e.tokenId}">
            ...
            <div class="flex-1 min-w-0">
                ...
                <p class="text-[10px] text-zinc-400 mt-0.5">
                    Net: <span class="text-green-400 font-bold">${_(o).toFixed(4)} BKC</span>
                </p>
                ${k>0n?`
    ...
    `}async function ta(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("activity-title");try{if(c.isConnected){if(S.activities.length===0){e&&(e.innerHTML=`
                    ...
                    `);const n=await fetch(`${Ee.getHistory}/${c.userAddress}`);n.ok&&(S.activities=await n.json())}if(S.activities.length>0){t&&(t.textContent="Your Activity"),is();return}}t&&(t.textContent="Network Activity"),await Gr()}catch(n){console.error("Activity fetch error:",n),t&&(t.textContent="Network Activity"),await Gr()}}async function Gr(){const e=document.getElementById("dash-activity-list");if(!e||S.isLoadingNetworkActivity)return;const t=Date.now()-S.networkActivitiesTimestamp;if(S.networkActivities.length>0&&t<3e5){Kr();return}S.isLoadingNetworkActivity=!0,e.innerHTML=`
        <div class="flex flex-col items-center justify-center py-8">
            <div class="relative">
                <div class="absolute inset-0 bg-amber-500/30 blur-xl rounded-full animate-pulse"></div>
                <img src="./assets/bkc_logo_3d.png" class="relative w-12 h-12 object-contain animate-bounce" alt="Loading">
    ...
    `;try{const n=await fetch(`${Ju}?limit=30`);if(n.ok){const a=await n.json();S.networkActivities=Array.isArray(a)?a:a.activities||[],S.networkActivitiesTimestamp=Date.now()}else S.networkActivities=[]}catch(n){console.error("Network activity fetch error:",n),S.networkActivities=[]}finally{S.isLoadingNetworkActivity=!1}Kr()}function Kr(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("dash-pagination-controls");if(e){if(S.networkActivities.length===0){e.innerHTML=`
        ...
        `,t&&t.classList.add("hidden");return}e.innerHTML=S.networkActivities.slice(0,15).map(n=>Gl(n,!0)).join(""),t&&t.classList.add("hidden")}}function is(){let e=[...S.activities];const t=S.filters.type,n=a=>(a||"").toUpperCase();t!=="ALL"&&(e=e.filter(a=>{const s=n(a.type);return t==="STAKE"?s.includes("DELEGATION")||s.includes("DELEGAT")||s.includes("STAKE")||s.includes("UNSTAKE"):t==="CLAIM"?s.includes("REWARD")||s.includes("CLAIM"):t==="NFT"?s.includes("BOOSTER")||s.includes("RENT")||s.includes("NFT")||s.includes("TRANSFER"):t==="GAME"?s.includes("FORTUNE")||s.includes("GAME")||s.includes("REQUEST")||s.includes("RESULT")||s.includes("FULFILLED"):t==="CHARITY"?s.includes("CHARITY")||s.includes("CAMPAIGN")||s.includes("DONATION")||s.includes("DONATE"):t==="NOTARY"?s.includes("NOTARY")||s.includes("NOTARIZED")||s.includes("DOCUMENT"):t==="FAUCET"?s.includes("FAUCET"):!0})),e.sort((a,s)=>{const r=o=>o.timestamp&&o.timestamp._seconds?o.timestamp._seconds:o.createdAt&&o.createdAt._seconds?o.createdAt._seconds:o.timestamp?new Date(o.timestamp).getTime()/1e3:0;return S.filters.sort==="NEWEST"?r(s)-r(a):r(a)-r(s)}),S.filteredActivities=e,S.pagination.currentPage=1,ls()}function ls(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("dash-pagination-controls");if(!e)return;if(S.filteredActivities.length===0){e.innerHTML=`
            <div class="flex flex-col items-center justify-center py-8 px-4">
                <div class="relative mb-4">
                    <div class="absolute inset-0 bg-amber-500/20 blur-xl rounded-full animate-pulse"></div>
        ...
        `,t&&t.classList.add("hidden");return}const n=(S.pagination.currentPage-1)*S.pagination.itemsPerPage,a=n+S.pagination.itemsPerPage,s=S.filteredActivities.slice(n,a);if(e.innerHTML=s.map(r=>Gl(r,!1)).join(""),t){const r=Math.ceil(S.filteredActivities.length/S.pagination.itemsPerPage);r>1?(t.classList.remove("hidden"),document.getElementById("page-indicator").innerText=`${S.pagination.currentPage}/${r}`,document.getElementById("page-prev").disabled=S.pagination.currentPage===1,document.getElementById("page-next").disabled=S.pagination.currentPage>=r):t.classList.add("hidden")}}function Gl(e,t=!1){const n=ep(e.timestamp||e.createdAt),a=tp(e.timestamp||e.createdAt),s=e.user||e.userAddress||e.from||"",r=np(s),o=sp(e.type,e.details);let i="";const l=(e.type||"").toUpperCase().trim(),d=e.details||{};if(l.includes("GAME")||l.includes("FORTUNE")||l.includes("REQUEST")||l.includes("FULFILLED")||l.includes("RESULT")){const g=d.rolls||e.rolls||[],y=d.guesses||e.guesses||[],k=d.isWin||d.prizeWon&&BigInt(d.prizeWon||0)>0n,T=d.isCumulative!==void 0?d.isCumulative:y.length>1,I=d.wagerAmount||d.amount,N=d.prizeWon,z=T?"Combo":"Jackpot",E=T?"bg-purple-500/20 text-purple-400":"bg-amber-500/20 text-amber-400",F=I?_(BigInt(I)).toFixed(0):"0";let G="No win",se="text-zinc-500";k&&N&&BigInt(N)>0n&&(G=`<span class="text-emerald-400 font-bold">+${_(BigInt(N)).toFixed(0)} BKC</span>`,se="");let de="";return g.length>0&&(de=`<div class="flex gap-1">
                ${g.map((Q,D)=>{const W=y[D];return`<div class="w-7 h-7 rounded text-xs font-bold flex items-center justify-center border ${W!==void 0&&Number(W)===Number(Q)?"bg-emerald-500/20 border-emerald-500/50 text-emerald-400":"bg-zinc-800 border-zinc-700 text-zinc-400"}">${Q}</div>`}).join("")}
            </div>`),`
            <a href="${e.txHash?`${jr}${e.txHash}`:"#"}" target="_blank" class="block p-3 hover:bg-zinc-800/50 border border-zinc-700/30 rounded-lg transition-all group" style="background: rgba(39,39,42,0.4)" title="${a}">
        ...
        `}if(l.includes("NOTARY")){const g=d.ipfsCid;g&&(i=`<span class="ml-2 text-[9px] text-indigo-400 font-mono">${g.replace("ipfs://","").slice(0,12)+"..."}</span>`)}if(l.includes("STAKING")||l.includes("DELEGAT")){const g=d.pStakeGenerated;g&&(i=`<span class="text-[10px] text-purple-400">+${_(BigInt(g)).toFixed(0)} pStake</span>`)}if(l.includes("DONATION")||l.includes("CHARITY")){const g=d.netAmount||d.amount,y=d.campaignId;g&&BigInt(g)>0n&&(i=`<span class="text-pink-400 font-bold">${_(BigInt(g)).toFixed(2)} BKC</span>`,y&&(i+=`<span class="ml-1 text-[9px] text-zinc-500">Campaign #${y}</span>`))}if(l.includes("CLAIM")||l.includes("REWARD")){const g=d.feePaid,y=d.amount||e.amount;if(y&&(i=`<span class="text-amber-400 font-bold">+${_(BigInt(y)).toFixed(2)} BKC</span>`),g&&BigInt(g)>0n){const k=_(BigInt(g)).toFixed(2);i+=`<span class="ml-1 text-[9px] text-zinc-500">(fee: ${k})</span>`}}const f=l.includes("PROMOT")||l.includes("ADS")||l.includes("ADVERTIS");if(f){const g=d.promotionFee||d.amount||e.amount;if(g&&BigInt(g)>0n){const k=jt.formatEther(BigInt(g));i=`<span class="text-yellow-400 font-bold">${parseFloat(k).toFixed(4)} ETH</span>`}const y=d.tokenId||e.tokenId;y&&(i+=`<span class="ml-1 text-[9px] text-zinc-500">NFT #${y}</span>`)}const m=e.txHash?`${jr}${e.txHash}`:"#";let b="";if(f){const g=d.promotionFee||d.amount||e.amount;if(g&&BigInt(g)>0n){const y=jt.formatEther(BigInt(g));b=parseFloat(y).toFixed(4)}}else{let g=e.amount||d.netAmount||d.amount||d.wagerAmount||d.prizeWon||"0";const y=_(BigInt(g));b=y>.001?y.toFixed(2):""}const p=f?"ETH":"BKC";return`
        <a href="${m}" target="_blank" class="flex items-center justify-between p-2.5 hover:bg-zinc-800/60 border border-zinc-700/30 rounded-lg transition-all hover:border-zinc-600/50 group" style="background: rgba(39,39,42,0.3)" title="${a}">
            <div class="flex items-center gap-2.5">
                ...
                <div>
                    <p class="text-white text-xs font-medium">${o.label}${i?` <span class="ml-1">${i}</span>`:""}</p>
    ...
    `}function gp(){if(!Be.dashboard)return;Be.dashboard.addEventListener("click",async t=>{const n=t.target;if(n.closest("#manual-refresh-btn")){const r=n.closest("#manual-refresh-btn");r.disabled=!0,r.innerHTML='<i class="fa-solid fa-rotate fa-spin"></i>',await _t(!0),await os(),S.activities=[],S.networkActivities=[],S.networkActivitiesTimestamp=0,S.faucet.lastCheck=0,await ta(),setTimeout(()=>{r.innerHTML='<i class="fa-solid fa-rotate"></i> <span class="hidden sm:inline">Sync</span>',r.disabled=!1},1e3)}if(n.closest("#faucet-action-btn")){const r=n.closest("#faucet-action-btn");r.disabled||await Wr(r)}if(n.closest("#emergency-faucet-btn")&&await Wr(n.closest("#emergency-faucet-btn")),n.closest(".delegate-link")&&(t.preventDefault(),window.navigateTo("mine")),n.closest(".go-to-store")&&(t.preventDefault(),window.navigateTo("store")),n.closest(".go-to-rental")&&(t.preventDefault(),window.navigateTo("rental")),n.closest(".go-to-fortune")&&(t.preventDefault(),window.navigateTo("actions")),n.closest(".go-to-notary")&&(t.preventDefault(),window.navigateTo("notary")),n.closest(".go-to-charity")&&(t.preventDefault(),window.navigateTo("charity")),n.closest("#open-booster-info")){const r=document.getElementById("booster-info-modal");r&&(r.classList.remove("hidden"),r.classList.add("flex"),setTimeout(()=>{r.classList.remove("opacity-0"),r.querySelector("div").classList.remove("scale-95")},10))}if(n.closest("#close-booster-modal")||n.id==="booster-info-modal"){const r=document.getElementById("booster-info-modal");r&&(r.classList.add("opacity-0"),r.querySelector("div").classList.add("scale-95"),setTimeout(()=>r.classList.add("hidden"),200))}if(n.closest("#close-gas-modal-dash")||n.id==="no-gas-modal-dash"){const r=document.getElementById("no-gas-modal-dash");r&&(r.classList.remove("flex"),r.classList.add("hidden"))}const a=n.closest(".nft-clickable-image");if(a){const r=a.dataset.address,o=a.dataset.tokenid;r&&o&&ad(r,o)}const s=n.closest("#dashboardClaimBtn");if(s&&!s.disabled)try{if(s.innerHTML='<i class="fa-solid fa-circle-notch fa-spin"></i>',s.disabled=!0,!await op()){s.innerHTML='<i class="fa-solid fa-gift mr-2"></i> Claim',s.disabled=!1;return}const{stakingRewards:o,minerRewards:i}=await Vt();(o>0n||i>0n)&&await It.claimRewards({button:s,onSuccess:async()=>{x("Rewards claimed!","success"),await _t(!0),S.activities=[],ta()},onError:l=>{l.cancelled||x("Claim failed","error")}})}catch{x("Claim failed","error")}finally{s.innerHTML='<i class="fa-solid fa-gift mr-2"></i> Claim',s.disabled=!1}if(n.closest("#page-prev")&&S.pagination.currentPage>1&&(S.pagination.currentPage--,ls()),n.closest("#page-next")){const r=Math.ceil(S.filteredActivities.length/S.pagination.itemsPerPage);S.pagination.currentPage<r&&(S.pagination.currentPage++,ls())}n.closest("#activity-sort-toggle")&&(S.filters.sort=S.filters.sort==="NEWEST"?"OLDEST":"NEWEST",is())});const e=document.getElementById("activity-filter-type");e&&e.addEventListener("change",t=>{S.filters.type=t.target.value,is()})}const Kl={async render(e){ip(),os(),ta(),c.isConnected?await _t(!1):(setTimeout(async()=>{c.isConnected&&await _t(!1)},500),setTimeout(async()=>{c.isConnected&&await _t(!1)},1500))},update(e){const t=Date.now();t-S.lastUpdate>1e4&&(S.lastUpdate=t,os(),e&&_t(!1),ta())}},mn=window.ethers,xp="https://sepolia.arbiscan.io/tx/",rn={NONE:{boost:0,burnRate:50,userGets:50,color:"#71717a",name:"None",icon:"○"},BRONZE:{boost:1e3,burnRate:40,userGets:60,color:"#cd7f32",name:"Bronze",icon:"🥉"},SILVER:{boost:2500,burnRate:25,userGets:75,color:"#c0c0c0",name:"Silver",icon:"🥈"},GOLD:{boost:4e3,burnRate:10,userGets:90,color:"#ffd700",name:"Gold",icon:"🥇"},DIAMOND:{boost:5e3,burnRate:0,userGets:100,color:"#b9f2ff",name:"Diamond",icon:"💎"}};let Dt=!1,Tn=0,Js=3650,Oe=!1,cs=[],fn=0n,yt=null,un="ALL",Ve=0,Cn=50,Yl="none",Ft=null;function Vl(e){if(e<=0)return"Ready";const t=Math.floor(e/86400),n=Math.floor(e%86400/3600),a=Math.floor(e%3600/60);if(t>365){const s=Math.floor(t/365),r=t%365;return`${s}y ${r}d`}return t>0?`${t}d ${n}h`:n>0?`${n}h ${a}m`:`${a}m`}function hp(e){if(e>=365){const t=e/365;return t>=2?`${Math.floor(t)} Years`:`${t.toFixed(1)} Year`}return e>=30?`${Math.floor(e/30)} Month${e>=60?"s":""}`:`${e} Day${e>1?"s":""}`}function ql(e,t){try{const n=BigInt(e),a=BigInt(t);return n*(a/86400n)/10n**18n}catch{return 0n}}function vp(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function Xl(e){return e>=5e3?rn.DIAMOND:e>=4e3?rn.GOLD:e>=2500?rn.SILVER:e>=1e3?rn.BRONZE:rn.NONE}function wp(){if(document.getElementById("staking-styles-v6"))return;const e=document.createElement("style");e.id="staking-styles-v6",e.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(e)}function yp(){const e=document.getElementById("mine");e&&(wp(),e.innerHTML=`
    ...
    `,zp(),c.isConnected?Qt(!0):Zs())}async function Qt(e=!1){var n;if(!c.isConnected){Zs();return}const t=Date.now();if(!(!e&&Dt)&&!(!e&&t-Tn<1e4)){Dt=!0,Tn=t;try{await kp();try{const a=await fetch("https://getsystemdata-4wvdcuoouq-uc.a.run.app");if(a.ok){const s=await a.json();(n=s==null?void 0:s.economy)!=null&&n.totalPStake&&(fn=BigInt(s.economy.totalPStake))}}catch{console.log("Firebase unavailable, using blockchain")}if(fn===0n){const a=c.delegationManagerContractPublic||c.delegationManagerContract;a&&(fn=await ne(a,"totalNetworkPStake",[],0n))}await Promise.all([Pt(!0),Pd(!0),Is()]),await Ep(),Cp(),Jl(),bn(),Bp()}catch(a){console.error("Staking load error:",a)}finally{Dt=!1}}}async function kp(){try{const e=c.delegationManagerContract||c.delegationManagerContractPublic;if(e&&c.userAddress)try{const n=await e.getUserBestBoost(c.userAddress);Ve=Number(n)}catch{const n=await Ht();Ve=(n==null?void 0:n.boost)||0}else{const n=await Ht();Ve=(n==null?void 0:n.boost)||0}Cn=Xl(Ve).burnRate,Yl=Ve>0?"active":"none",Tp()}catch(e){console.error("Error loading NFT boost:",e),Ve=0,Cn=50}}async function Ep(){try{const e=c.delegationManagerContract||c.delegationManagerContractPublic;if(e&&c.userAddress)try{const t=await e.previewClaim(c.userAddress);Ft={totalRewards:t.totalRewards||t[0],burnAmount:t.burnAmount||t[1],userReceives:t.userReceives||t[2],burnRateBips:t.burnRateBips||t[3],nftBoost:t.nftBoost||t[4]}}catch{const{stakingRewards:t,minerRewards:n}=await Vt(),a=t+n,s=a*BigInt(Cn)/100n;Ft={totalRewards:a,burnAmount:s,userReceives:a-s,burnRateBips:BigInt(Cn*100),nftBoost:BigInt(Ve)}}}catch(e){console.error("Error loading claim preview:",e)}}function Tp(){const e=Xl(Ve),t=document.getElementById("nft-tier-icon");t&&(t.textContent=e.icon,t.style.background=`${e.color}20`);const n=document.getElementById("nft-tier-badge");n&&(n.className=`nft-tier-badge tier-${e.name.toLowerCase()}`,n.innerHTML=`<span>${e.icon} ${e.name}</span>`);const a=document.getElementById("nft-source");a&&(Ve>0?(a.classList.remove("hidden"),a.textContent=Yl):a.classList.add("hidden"));const s=document.getElementById("burn-rate-text");s&&(e.burnRate===0?s.innerHTML='<span class="text-green-400">No burn! You keep 100% of rewards</span>':s.textContent=`${e.burnRate}% of rewards will be burned on claim`);const r=document.getElementById("burn-rate-value"),o=document.getElementById("keep-rate-value");r&&(r.textContent=`${e.burnRate}%`),o&&(o.textContent=`${e.userGets}%`);const i=document.getElementById("burn-fill"),l=document.getElementById("receive-fill");i&&(i.style.width=`${e.burnRate}%`),l&&(l.style.width=`${e.userGets}%`)}function Cp(){var o;const e=(i,l)=>{const d=document.getElementById(i);d&&(d.textContent=l)};e("stat-network",Ut(fn||c.totalNetworkPStake||0n)),e("stat-pstake",Ut(c.userTotalPStake||0n)),e("balance-display",_(c.currentUserBalance||0n).toFixed(2)),e("stat-delegations",(c.userDelegations||[]).length.toString());const t=c.userTotalPStake||0n,n=fn||c.totalNetworkPStake||0n;let a=0;n>0n&&t>0n&&(a=Number(t*10000n/n)/100),e("stat-pstake-percent",a>0?`${a.toFixed(2)}% of network`:"0% of network");const s=((o=c.systemFees)==null?void 0:o.DELEGATION_FEE_BIPS)||50n,r=Number(s)/100;e("fee-info",`${r}% protocol fee`),Ip()}async function Ip(){const e=document.getElementById("claim-section");if(!e)return;const{stakingRewards:t,minerRewards:n}=await Vt(),a=t+n,s=(r,o)=>{const i=document.getElementById(r);i&&(i.textContent=o)};if(s("stat-rewards",_(a).toFixed(4)),a>0n){e.classList.remove("hidden");let r,o;Ft&&Ft.totalRewards>0n?(r=Ft.burnAmount,o=Ft.userReceives):(r=a*BigInt(Cn)/100n,o=a-r),s("claim-total",_(a).toFixed(4)),s("claim-burn",_(r).toFixed(4)),s("claim-receive",_(o).toFixed(4)),r>0n?e.classList.add("has-burn"):e.classList.remove("has-burn");const i=document.getElementById("claim-btn");i&&(i.onclick=()=>Np(t,n,i))}else e.classList.add("hidden")}function Zs(){const e=(s,r)=>{const o=document.getElementById(s);o&&(o.textContent=r)};e("stat-network","--"),e("stat-pstake","--"),e("stat-rewards","--"),e("stat-delegations","0"),e("balance-display","0.00"),e("stat-pstake-percent","--% of network");const t=document.getElementById("delegations-list");t&&(t.innerHTML=`
        ...
        `);const a=document.getElementById("claim-section");a&&a.classList.add("hidden")}function Jl(){const e=document.getElementById("delegations-list");if(!e)return;yt&&(clearInterval(yt),yt=null);const t=c.userDelegations||[],n=document.getElementById("delegation-count");n&&(n.textContent=t.length.toString());const a=document.getElementById("stat-delegations");if(a&&(a.textContent=t.length.toString()),t.length===0){e.innerHTML=`
            <div class="text-center py-12">
        ...
        `;return}const s=[...t].sort((r,o)=>Number(r.unlockTime)-Number(o.unlockTime));e.innerHTML=s.map(r=>Ap(r)).join(""),Yr(),yt=setInterval(Yr,6e4),e.querySelectorAll(".unstake-btn").forEach(r=>{r.addEventListener("click",()=>Vr(r.dataset.index,!1))}),e.querySelectorAll(".force-unstake-btn").forEach(r=>{r.addEventListener("click",()=>{confirm(`⚠️ Force Unstake will apply a 50% penalty!

Are you sure?`)&&Vr(r.dataset.index,!0)})})}function Ap(e){const t=_(e.amount).toFixed(2),n=Ut(ql(e.amount,e.lockDuration)),a=Number(e.unlockTime),s=Math.floor(Date.now()/1e3),r=a>s,o=r?a-s:0,i=Math.floor(Number(e.lockDuration)/86400);return`
                ...
                <div class="flex items-center gap-3 min-w-0">
                    ...
                    <div class="min-w-0">
                        ...
                        <div class="flex items-center gap-2 mt-0.5">
                            ...
                            <span class="text-zinc-500 text-[10px]">${hp(i)}</span>
                        </div>
                    </div>
                </div>
    ...
    `}function Yr(){const e=document.querySelectorAll(".countdown-timer"),t=Math.floor(Date.now()/1e3);e.forEach(n=>{const a=parseInt(n.dataset.unlockTime);n.textContent=Vl(a-t)})}async function Bp(){if(c.userAddress)try{const e=Ee.getHistory||"https://gethistory-4wvdcuoouq-uc.a.run.app",t=await fetch(`${e}/${c.userAddress}`);t.ok&&(cs=(await t.json()||[]).filter(a=>{const s=(a.type||"").toUpperCase();return s.includes("DELEGAT")||s.includes("STAKE")||s.includes("UNDELEGAT")||s.includes("CLAIM")||s.includes("REWARD")||s.includes("FORCE")}),Zl())}catch(e){console.error("History load error:",e)}}function Zl(){const e=document.getElementById("staking-history-list");if(!e)return;let t=cs;if(un!=="ALL"&&(t=cs.filter(n=>{const a=(n.type||"").toUpperCase();switch(un){case"STAKE":return(a.includes("DELEGAT")||a.includes("STAKE"))&&!a.includes("UNSTAKE")&&!a.includes("UNDELEGAT")&&!a.includes("FORCE");case"UNSTAKE":return a.includes("UNSTAKE")||a.includes("UNDELEGAT")||a.includes("FORCE");case"CLAIM":return a.includes("CLAIM")||a.includes("REWARD");default:return!0}})),t.length===0){e.innerHTML=`
            <div class="text-center py-12">
        ...
        `;return}e.innerHTML=t.slice(0,25).map(n=>{const a=(n.type||"").toUpperCase(),s=n.details||{},r=vp(n.timestamp||n.createdAt);let o,i,l,d,u="";a.includes("FORCE")?(o="fa-bolt",i="bg-red-500/15",l="text-red-400",d="Force Unstaked",s.feePaid&&BigInt(s.feePaid)>0n&&(u=`<span class="text-red-400">-${_(BigInt(s.feePaid)).toFixed(2)} penalty</span>`)):(a.includes("DELEGAT")||a.includes("STAKE"))&&!a.includes("UNSTAKE")?(o="fa-lock",i="bg-green-500/15",l="text-green-400",d="Delegated",s.pStakeGenerated&&(u=`<span class="text-purple-400">+${_(BigInt(s.pStakeGenerated)).toFixed(0)} pS</span>`)):a.includes("UNSTAKE")||a.includes("UNDELEGAT")?(o="fa-unlock",i="bg-orange-500/15",l="text-orange-400",d="Unstaked"):a.includes("CLAIM")||a.includes("REWARD")?(o="fa-coins",i="bg-amber-500/15",l="text-amber-400",d="Claimed",s.amountReceived&&BigInt(s.amountReceived)>0n&&(u=`<span class="text-green-400">+${_(BigInt(s.amountReceived)).toFixed(2)}</span>`)):(o="fa-circle",i="bg-zinc-500/15",l="text-zinc-400",d=n.type||"Activity");const f=n.txHash?`${xp}${n.txHash}`:"#",m=n.amount||s.amount||s.amountReceived||"0",b=_(BigInt(m)),p=b>.001?b.toFixed(2):"";return`
            <a href="${f}" target="_blank" class="delegation-item flex items-center justify-between p-3 group">
                <div class="flex items-center gap-3">
                    <div class="w-9 h-9 rounded-lg ${i} flex items-center justify-center">
                        <i class="fa-solid ${o} text-sm ${l}"></i>
                    </div>
                    <div>
                        <div class="flex items-center gap-2">
        ...
        `}).join("")}function bn(){var a;const e=document.getElementById("amount-input"),t=document.getElementById("stake-btn");if(!e)return;const n=e.value;if(!n||parseFloat(n)<=0){document.getElementById("preview-pstake").textContent="0",document.getElementById("preview-net").textContent="0.00 BKC",t&&(t.disabled=!0);return}try{const s=mn.parseUnits(n,18),r=((a=c.systemFees)==null?void 0:a.DELEGATION_FEE_BIPS)||50n,o=s*BigInt(r)/10000n,i=s-o,l=BigInt(Js)*86400n,d=ql(i,l);document.getElementById("preview-pstake").textContent=Ut(d),document.getElementById("preview-net").textContent=`${_(i).toFixed(4)} BKC`;const u=c.currentUserBalance||0n;s>u?(e.classList.add("error"),t&&(t.disabled=!0)):(e.classList.remove("error"),t&&(t.disabled=Oe))}catch{t&&(t.disabled=!0)}}async function Pp(){if(Oe)return;const e=document.getElementById("amount-input"),t=document.getElementById("stake-btn");if(document.getElementById("stake-btn-text"),document.getElementById("stake-btn-icon"),!e||!t)return;const n=e.value;if(!n||parseFloat(n)<=0){x("Enter an amount","warning");return}const a=c.currentUserBalance||0n;let s;try{if(s=mn.parseUnits(n,18),s>a){x("Insufficient BKC balance","error");return}}catch{x("Invalid amount","error");return}try{if(await new mn.BrowserProvider(window.ethereum).getBalance(c.userAddress)<mn.parseEther("0.001")){x("Insufficient ETH for gas","error");return}}catch{}Oe=!0;const r=BigInt(Js)*86400n;try{await It.delegate({amount:s,lockDuration:r,button:t,onSuccess:async()=>{e.value="",x("🔒 Delegation successful!","success"),Dt=!1,Tn=0,await Qt(!0)},onError:o=>{o.cancelled||x("Delegation failed: "+(o.reason||o.message||"Unknown error"),"error")}})}catch(o){x("Delegation failed: "+(o.reason||o.message||"Unknown error"),"error")}finally{Oe=!1,bn()}}async function Vr(e,t){if(Oe)return;const n=document.querySelector(t?`.force-unstake-btn[data-index='${e}']`:`.unstake-btn[data-index='${e}']`);Oe=!0;try{const a=BigInt(e);await(t?It.forceUnstake:It.unstake)({delegationIndex:a,button:n,onSuccess:async()=>{x(t?"⚡ Force unstaked (50% penalty applied)":"🔓 Unstaked successfully!",t?"warning":"success"),Dt=!1,Tn=0,await Qt(!0)},onError:r=>{r.cancelled||x("Unstake failed: "+(r.reason||r.message||"Unknown error"),"error")}})}catch(a){x("Unstake failed: "+(a.reason||a.message||"Unknown error"),"error")}finally{Oe=!1,Jl()}}async function Np(e,t,n){if(!Oe){Oe=!0;try{await It.claimRewards({button:n,onSuccess:async()=>{x("🪙 Rewards claimed!","success"),Dt=!1,Tn=0,await Qt(!0)},onError:a=>{a.cancelled||x("Claim failed: "+(a.reason||a.message||"Unknown error"),"error")}})}catch(a){x("Claim failed: "+(a.reason||a.message||"Unknown error"),"error")}finally{Oe=!1}}}function zp(){const e=document.getElementById("amount-input"),t=document.getElementById("max-btn"),n=document.getElementById("stake-btn"),a=document.getElementById("refresh-btn"),s=document.querySelectorAll(".duration-chip"),r=document.querySelectorAll(".history-tab");e==null||e.addEventListener("input",bn),t==null||t.addEventListener("click",()=>{const o=c.currentUserBalance||0n;e&&(e.value=mn.formatUnits(o,18),bn())}),s.forEach(o=>{o.addEventListener("click",()=>{s.forEach(i=>i.classList.remove("selected")),o.classList.add("selected"),Js=parseInt(o.dataset.days),bn()})}),r.forEach(o=>{o.addEventListener("click",()=>{r.forEach(i=>i.classList.remove("active")),o.classList.add("active"),un=o.dataset.filter,Zl()})}),n==null||n.addEventListener("click",Pp),a==null||a.addEventListener("click",()=>{const o=a.querySelector("i");o==null||o.classList.add("fa-spin"),Qt(!0).then(()=>{setTimeout(()=>o==null?void 0:o.classList.remove("fa-spin"),500)})})}function Lp(){yt&&(clearInterval(yt),yt=null)}function Sp(e){e?Qt():Zs()}const Ql={render:yp,update:Sp,cleanup:Lp},Ie=window.ethers,Rp="https://sepolia.arbiscan.io/tx/",$p=3e4,qr={Diamond:{color:"#22d3ee",gradient:"from-cyan-500/20 to-blue-500/20",border:"border-cyan-500/40",text:"text-cyan-400",glow:"shadow-cyan-500/30",icon:"💎",keepRate:100,burnRate:0},Gold:{color:"#fbbf24",gradient:"from-yellow-500/20 to-amber-500/20",border:"border-yellow-500/40",text:"text-yellow-400",glow:"shadow-yellow-500/30",icon:"🥇",keepRate:90,burnRate:10},Silver:{color:"#9ca3af",gradient:"from-gray-400/20 to-slate-400/20",border:"border-gray-400/40",text:"text-gray-300",glow:"shadow-gray-400/30",icon:"🥈",keepRate:75,burnRate:25},Bronze:{color:"#f97316",gradient:"from-orange-600/20 to-amber-700/20",border:"border-orange-600/40",text:"text-orange-400",glow:"shadow-orange-500/30",icon:"🥉",keepRate:60,burnRate:40}};function Ca(e){return qr[e]||qr.Bronze}const L={tradeDirection:"buy",selectedPoolBoostBips:null,buyPrice:0n,sellPrice:0n,netSellPrice:0n,poolNFTCount:0,userBalanceOfSelectedNFT:0,availableToSellCount:0,firstAvailableTokenId:null,firstAvailableTokenIdForBuy:null,bestBoosterTokenId:0n,bestBoosterBips:0,isDataLoading:!1,tradeHistory:[]},na=new Map,Qs=new Map;let Vn=!1,ht=null;const _p=["function getPoolAddress(uint256 boostBips) view returns (address)","function isPool(address) view returns (bool)"];function Fp(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function Mp(e){const t=Qs.get(e);return t&&Date.now()-t.timestamp<$p?t.data:null}function ec(e,t){Qs.set(e,{data:t,timestamp:Date.now()})}function Ua(e){Qs.delete(e)}function Dp(){if(document.getElementById("swap-styles-v9"))return;const e=document.createElement("style");e.id="swap-styles-v9",e.textContent=`
    ...
    `,document.head.appendChild(e)}function Op(){return`
    ...
    `}const Hp={async render(e){Dp(),await Po();const t=document.getElementById("store");t&&((t.innerHTML.trim()===""||e)&&(t.innerHTML=`
            ...
            `,Kp()),L.selectedPoolBoostBips===null&&ge.length>0&&(L.selectedPoolBoostBips=ge[0].boostBips),await at(),await pn())},async update(){L.selectedPoolBoostBips!==null&&!L.isDataLoading&&document.getElementById("store")&&!document.hidden&&await at()}};async function pn(){const e=document.getElementById("history-list");if(!c.userAddress){e&&(e.innerHTML='<div class="text-center py-4 text-xs text-zinc-600">Connect wallet to view history</div>');return}try{const t=Ee.getHistory||"https://gethistory-4wvdcuoouq-uc.a.run.app",n=await fetch(`${t}/${c.userAddress}`);if(!n.ok)throw new Error(`HTTP ${n.status}`);const a=await n.json();console.log("All history types:",[...new Set((a||[]).map(r=>r.type))]),L.tradeHistory=(a||[]).filter(r=>{const o=(r.type||"").toUpperCase();return o==="NFTBOUGHT"||o==="NFTSOLD"||o==="NFT_BOUGHT"||o==="NFT_SOLD"||o==="NFTPURCHASED"||o==="NFT_PURCHASED"||o.includes("NFTBOUGHT")||o.includes("NFTSOLD")||o.includes("NFTPURCHASED")}),console.log("NFT trade history:",L.tradeHistory.length,"items");const s=document.getElementById("history-count");s&&(s.textContent=L.tradeHistory.length),Xr()}catch(t){console.error("History load error:",t),L.tradeHistory=[],Xr()}}function Xr(){const e=document.getElementById("history-list");if(e){if(!c.isConnected){e.innerHTML='<div class="text-center py-4 text-xs text-zinc-600">Connect wallet to view history</div>';return}if(L.tradeHistory.length===0){e.innerHTML=`
        ...
        `;return}e.innerHTML=L.tradeHistory.slice(0,20).map(t=>{const n=(t.type||"").toUpperCase(),a=t.details||{},s=Fp(t.timestamp||t.createdAt),r=n.includes("BOUGHT")||n.includes("PURCHASED"),o=r?"fa-cart-plus":"fa-money-bill-transfer",i=r?"#22c55e":"#f59e0b",l=r?"rgba(34,197,94,0.15)":"rgba(245,158,11,0.15)",d=r?"🛒 Bought NFT":"💰 Sold NFT",u=r?"-":"+",f=t.txHash?`${Rp}${t.txHash}`:"#";let m="";try{let g=t.amount||a.amount||a.price||a.payout||"0";if(typeof g=="string"&&g!=="0"){const y=_(BigInt(g));y>.001&&(m=y.toFixed(2))}}catch{}const b=a.tokenId||"",p=a.boostBips||a.boost||"";return`
            <a href="${f}" target="_blank" class="history-item flex items-center justify-between p-3 hover:bg-zinc-800/60 border border-zinc-700/30 rounded-lg transition-all group bg-zinc-800/20">
                <div class="flex items-center gap-3">
                    <div class="w-9 h-9 rounded-lg flex items-center justify-center border border-zinc-700/30" style="background: ${l}">
                        <i class="fa-solid ${o} text-sm" style="color: ${i}"></i>
                    </div>
                    <div>
        ...
        `}).join("")}}function Up(){return ge.map((e,t)=>{const n=Ca(e.name),a=t===0,s=lt(e.boostBips),r=n.icon||e.emoji||"💎";return`
        ...
        <div class="fade-in">
            ...
            <div class="swap-input-box rounded-2xl p-4 mb-1">
                <div class="flex justify-between items-center mb-2">
                    ...
                    <span class="text-xs text-zinc-600">
                        ${a?`Balance: <span class="${u?"text-red-400":"text-zinc-400"}">${o}</span>`:`Available: ${f}`}
                    </span>
                </div>
                <div class="flex justify-between items-center">
                    ...
                    <div class="token-selector flex items-center gap-2 px-3 py-2 rounded-xl cursor-default">
                        ${a?'<img src="./assets/bkc_logo_3d.png" class="w-6 h-6 rounded">':`<span class="text-xl">${m}</span>`}
            ...
            <div class="swap-input-box rounded-2xl p-4 mt-1 mb-4">
                <div class="flex justify-between items-center mb-2">
                    ...
                    <span class="text-xs text-zinc-600">
                        ${a?`In pool: <span class="${i?"text-red-400":"text-green-400"}">${L.poolNFTCount}</span>`:"Net after fee"}
                    </span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-2xl font-semibold text-white">${a?"1":_(L.netSellPrice).toFixed(2)}</span>
                    <div class="token-selector flex items-center gap-2 px-3 py-2 rounded-xl cursor-default">
                        ${a?`<span class="text-xl">${m}</span>`:'<img src="./assets/bkc_logo_3d.png" class="w-6 h-6 rounded">'}
    ...
    `}function jp(e,t,n,a,s=!1){return c.isConnected?e?t?`
        ...
        `}function Wp(e){const t=document.getElementById("trade-mascot");t&&(t.className=`w-14 h-14 rounded-2xl flex items-center justify-center text-3xl ${e?"trade-buy":"trade-sell"}`)}function Zr(){const e=document.getElementById("inventory-grid"),t=document.getElementById("nft-count");if(!e)return;const n=c.myBoosters||[];if(t&&(t.textContent=n.length),!c.isConnected){e.innerHTML='<div class="col-span-4 text-center py-4 text-xs text-zinc-600">Connect wallet</div>';return}if(n.length===0){e.innerHTML=`
        ...
        `;return}const a=c.rentalListings||[],s=new Set(a.map(o=>{var i;return(i=o.tokenId)==null?void 0:i.toString()})),r=Math.floor(Date.now()/1e3);e.innerHTML=n.map(o=>{var T;const i=ge.find(I=>I.boostBips===Number(o.boostBips)),l=Ca(i==null?void 0:i.name),d=lt(Number(o.boostBips)),u=l.icon||(i==null?void 0:i.emoji)||"💎",f=L.firstAvailableTokenId&&BigInt(o.tokenId)===L.firstAvailableTokenId,m=(T=o.tokenId)==null?void 0:T.toString(),b=s.has(m),p=a.find(I=>{var N;return((N=I.tokenId)==null?void 0:N.toString())===m}),g=p&&p.rentalEndTime&&Number(p.rentalEndTime)>r,y=b||g;let k="";return g?k='<span class="absolute top-1 right-1 bg-blue-500 text-white text-[7px] px-1.5 py-0.5 rounded-full font-bold">🔑</span>':b&&(k='<span class="absolute top-1 right-1 bg-green-500 text-white text-[7px] px-1.5 py-0.5 rounded-full font-bold">📋</span>'),`
            <div class="inventory-item ${y?"opacity-50 cursor-not-allowed":"cursor-pointer"} rounded-xl p-2 border ${f&&!y?"border-amber-500 ring-2 ring-amber-500/50 bg-amber-500/10":"border-zinc-700/50 bg-zinc-800/30"} hover:bg-zinc-800/50 transition-all relative"
                 ...
                 data-unavailable="${y}">
                ${k}
                <div class="w-full aspect-square rounded-lg bg-gradient-to-br ${l.gradient} border ${l.border} flex items-center justify-center ${y?"grayscale":""}">
                    <span class="text-3xl">${u}</span>
                </div>
                <p class="text-[9px] text-center mt-1 ${l.text} truncate">${(i==null?void 0:i.name)||"NFT"}</p>
                <p class="text-[8px] text-center ${d===100?"text-green-400":"text-zinc-500"}">Keep ${d}%</p>
                <p class="text-[7px] text-center ${f&&!y?"text-amber-400 font-bold":"text-zinc-600"}">#${o.tokenId}</p>
            </div>
        `}).join("")}async function at(e=!1){var a,s;if(L.selectedPoolBoostBips===null)return;const t=L.selectedPoolBoostBips,n=Date.now();if(ht=n,!e){const r=Mp(t);if(r){ds(r),aa(),Zr(),Gp(t,n);return}}L.isDataLoading=!0;try{const r=c.myBoosters||[],o=c.rentalListings||[],i=new Set(o.map(D=>{var W;return(W=D.tokenId)==null?void 0:W.toString()})),l=Math.floor(Date.now()/1e3),d=r.filter(D=>Number(D.boostBips)===t),u=d.filter(D=>{var _e;const W=(_e=D.tokenId)==null?void 0:_e.toString(),ie=o.find(V=>{var sn;return((sn=V.tokenId)==null?void 0:sn.toString())===W}),ae=i.has(W),Qe=ie&&ie.rentalEndTime&&Number(ie.rentalEndTime)>l;return!ae&&!Qe}),f=ge.find(D=>D.boostBips===t);if(!f){console.warn("Tier not found for boostBips:",t);return}const m=`pool_${f.name.toLowerCase()}`;let b=w[m]||na.get(t);if(!b){const D=w.nftLiquidityPoolFactory;if(D&&c.publicProvider)try{b=await new Ie.Contract(D,_p,c.publicProvider).getPoolAddress(t),b&&b!==Ie.ZeroAddress&&na.set(t,b)}catch(W){console.warn("Factory lookup failed:",W.message)}}if(ht!==n)return;if(!b||b===Ie.ZeroAddress){const D=document.getElementById("swap-interface");D&&(D.innerHTML=`
                    <div class="text-center py-12">
                ...
                `);return}const p=new Ie.Contract(b,Co,c.publicProvider),[g,y,k]=await Promise.all([ne(p,"getBuyPrice",[],Ie.MaxUint256).catch(()=>Ie.MaxUint256),ne(p,"getSellPrice",[],0n).catch(()=>0n),p.getAvailableNFTs().catch(()=>[])]);if(ht!==n)return;const T=Array.isArray(k)?[...k]:[],I=g===Ie.MaxUint256?0n:g,N=y;let z=((a=c.systemFees)==null?void 0:a.NFT_POOL_SELL_TAX_BIPS)||1000n,E=BigInt(((s=c.boosterDiscounts)==null?void 0:s[L.bestBoosterBips])||0);const F=typeof z=="bigint"?z:BigInt(z),G=typeof E=="bigint"?E:BigInt(E),se=F>G?F-G:0n,de=N*se/10000n,xe=N-de,Q={buyPrice:I,sellPrice:N,netSellPrice:xe,poolNFTCount:T.length,firstAvailableTokenIdForBuy:T.length>0?BigInt(T[T.length-1]):null,userBalanceOfSelectedNFT:d.length,availableToSellCount:u.length,availableNFTsOfTier:u};ec(t,Q),ds(Q,t)}catch(r){if(console.warn("Store Data Warning:",r.message),ht===n){const o=document.getElementById("swap-interface");o&&(o.innerHTML=`
                    <div class="text-center py-12">
                        <div class="w-12 h-12 bg-zinc-800 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                `)}return}finally{ht===n&&(L.isDataLoading=!1,aa(),Zr())}}async function Gp(e,t){var n,a;try{const s=c.myBoosters||[],r=c.rentalListings||[],o=new Set(r.map(Q=>{var D;return(D=Q.tokenId)==null?void 0:D.toString()})),i=Math.floor(Date.now()/1e3),l=s.filter(Q=>Number(Q.boostBips)===e),d=l.filter(Q=>{var Qe;const D=(Qe=Q.tokenId)==null?void 0:Qe.toString(),W=r.find(_e=>{var V;return((V=_e.tokenId)==null?void 0:V.toString())===D}),ie=o.has(D),ae=W&&W.rentalEndTime&&Number(W.rentalEndTime)>i;return!ie&&!ae}),u=ge.find(Q=>Q.boostBips===e);if(!u)return;const f=`pool_${u.name.toLowerCase()}`;let m=w[f]||na.get(e);if(!m||m===Ie.ZeroAddress)return;const b=new Ie.Contract(m,Co,c.publicProvider),[p,g,y]=await Promise.all([ne(b,"getBuyPrice",[],Ie.MaxUint256).catch(()=>Ie.MaxUint256),ne(b,"getSellPrice",[],0n).catch(()=>0n),b.getAvailableNFTs().catch(()=>[])]);if(ht!==t)return;const k=Array.isArray(y)?[...y]:[],T=p===Ie.MaxUint256?0n:p,I=g;let N=((n=c.systemFees)==null?void 0:n.NFT_POOL_SELL_TAX_BIPS)||1000n,z=BigInt(((a=c.boosterDiscounts)==null?void 0:a[L.bestBoosterBips])||0);const E=typeof N=="bigint"?N:BigInt(N),F=typeof z=="bigint"?z:BigInt(z),G=E>F?E-F:0n,se=I*G/10000n,de=I-se,xe={buyPrice:T,sellPrice:I,netSellPrice:de,poolNFTCount:k.length,firstAvailableTokenIdForBuy:k.length>0?BigInt(k[k.length-1]):null,userBalanceOfSelectedNFT:l.length,availableToSellCount:d.length,availableNFTsOfTier:d};ec(e,xe),L.selectedPoolBoostBips===e&&ht===t&&(ds(xe,e),aa())}catch(s){console.warn("Background refresh failed:",s.message)}}function ds(e,t){var s,r,o;L.buyPrice=e.buyPrice,L.sellPrice=e.sellPrice,L.netSellPrice=e.netSellPrice,L.poolNFTCount=e.poolNFTCount,L.firstAvailableTokenIdForBuy=e.firstAvailableTokenIdForBuy,L.userBalanceOfSelectedNFT=e.userBalanceOfSelectedNFT,L.availableToSellCount=e.availableToSellCount;const n=L.firstAvailableTokenId;!(n&&((s=e.availableNFTsOfTier)==null?void 0:s.some(i=>BigInt(i.tokenId)===n)))&&((r=e.availableNFTsOfTier)==null?void 0:r.length)>0?L.firstAvailableTokenId=BigInt(e.availableNFTsOfTier[0].tokenId):(o=e.availableNFTsOfTier)!=null&&o.length||(L.firstAvailableTokenId=null)}function Kp(){const e=document.getElementById("store");e&&e.addEventListener("click",async t=>{if(t.target.closest("#refresh-btn")){const o=t.target.closest("#refresh-btn").querySelector("i");o.classList.add("fa-spin"),Ua(L.selectedPoolBoostBips),await Promise.all([vt(!0),No()]),await at(!0),pn(),o.classList.remove("fa-spin");return}const n=t.target.closest(".tier-chip");if(n){const r=Number(n.dataset.boost);L.selectedPoolBoostBips!==r&&(L.selectedPoolBoostBips=r,L.firstAvailableTokenId=null,Jr(r),await at());return}if(t.target.closest("#swap-direction-btn")){L.tradeDirection=L.tradeDirection==="buy"?"sell":"buy",aa();return}if(t.target.closest("#inventory-toggle")){const r=document.getElementById("inventory-panel"),o=document.getElementById("inventory-chevron");r&&o&&(r.classList.toggle("hidden"),o.style.transform=r.classList.contains("hidden")?"":"rotate(180deg)");return}if(t.target.closest("#history-toggle")){const r=document.getElementById("history-panel"),o=document.getElementById("history-chevron");r&&o&&(r.classList.toggle("hidden"),o.style.transform=r.classList.contains("hidden")?"":"rotate(180deg)");return}const a=t.target.closest(".inventory-item");if(a){if(a.dataset.unavailable==="true"){x("This NFT is listed for rental and cannot be sold","warning");return}const o=Number(a.dataset.boost),i=a.dataset.tokenid;L.selectedPoolBoostBips=o,L.tradeDirection="sell",i&&(L.firstAvailableTokenId=BigInt(i),console.log("User selected NFT #"+i+" for sale")),Jr(o),await at();return}const s=t.target.closest("#execute-btn");if(s){if(t.preventDefault(),t.stopPropagation(),Vn||s.disabled)return;const r=s.dataset.action,o=document.getElementById("trade-mascot");if(r==="connect"){window.openConnectModal();return}const i=ge.find(u=>u.boostBips===L.selectedPoolBoostBips);if(!i)return;const l=`pool_${i.name.toLowerCase()}`,d=w[l]||na.get(i.boostBips);if(!d){x("Pool address not found","error");return}Vn=!0,o&&(o.className="w-14 h-14 object-contain trade-spin");try{if(L.tradeDirection==="buy")await ns.buyFromPool({poolAddress:d,button:s,onSuccess:async u=>{o&&(o.className="w-14 h-14 object-contain trade-success"),x("🟢 NFT Purchased!","success"),Ua(L.selectedPoolBoostBips),await Promise.all([vt(!0),at(!0)]),pn()},onError:u=>{if(!u.cancelled&&u.type!=="user_rejected"){const f=u.message||u.reason||"Transaction failed";x("Buy failed: "+f,"error")}}});else{if(!L.firstAvailableTokenId){x("No NFT selected for sale","error"),Vn=!1;return}await ns.sellToPool({poolAddress:d,tokenId:L.firstAvailableTokenId,button:s,onSuccess:async u=>{o&&(o.className="w-14 h-14 object-contain trade-success"),x("🔴 NFT Sold!","success"),Ua(L.selectedPoolBoostBips),await Promise.all([vt(!0),at(!0)]),pn()},onError:u=>{if(!u.cancelled&&u.type!=="user_rejected"){const f=u.message||u.reason||"Transaction failed";x("Sell failed: "+f,"error")}}})}}finally{Vn=!1,setTimeout(async()=>{try{await Promise.all([vt(!0),at(!0)]),pn()}catch(u){console.warn("[Store] Post-transaction refresh failed:",u.message)}},2e3),o&&setTimeout(()=>{const u=L.tradeDirection==="buy";o.className=`w-14 h-14 object-contain ${u?"trade-buy":"trade-sell"}`},800)}}})}const Yp="https://sepolia.arbiscan.io/tx/",on={NONE:{boost:0,burnRate:50,keepRate:50,color:"#71717a",name:"None",icon:"○",emoji:"❌",class:"tier-none"},BRONZE:{boost:1e3,burnRate:40,keepRate:60,color:"#cd7f32",name:"Bronze",icon:"🥉",emoji:"🥉",class:"tier-bronze"},SILVER:{boost:2500,burnRate:25,keepRate:75,color:"#c0c0c0",name:"Silver",icon:"🥈",emoji:"🥈",class:"tier-silver"},GOLD:{boost:4e3,burnRate:10,keepRate:90,color:"#ffd700",name:"Gold",icon:"🥇",emoji:"🥇",class:"tier-gold"},DIAMOND:{boost:5e3,burnRate:0,keepRate:100,color:"#b9f2ff",name:"Diamond",icon:"💎",emoji:"💎",class:"tier-diamond"}};let ja=0,Wa=!1,Jn=!1,In=[],An=null,be=0,Wt=50,sa="none",ra=0n,We=null,qn=0;const Qr=3e4;window.handleRewardsClaim=async function(){Jn||await n0()};function tc(e){return e>=5e3?on.DIAMOND:e>=4e3?on.GOLD:e>=2500?on.SILVER:e>=1e3?on.BRONZE:on.NONE}function Vp(e){const t=Math.floor((new Date-e)/1e3);return t<60?"Just now":t<3600?`${Math.floor(t/60)}m ago`:t<86400?`${Math.floor(t/3600)}h ago`:t<604800?`${Math.floor(t/86400)}d ago`:e.toLocaleDateString()}function qp(){if(document.getElementById("rewards-styles-v6"))return;const e=document.createElement("style");e.id="rewards-styles-v6",e.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(e)}const oa={async render(e){qp();const t=document.getElementById("rewards");t&&((t.innerHTML.trim()===""||e)&&(t.innerHTML=Qp()),c.isConnected?(We&&Date.now()-qn<Qr?Xn(We):e0(),this.update(e)):eo())},async update(e=!1){if(!c.isConnected){eo();return}const t=Date.now();if(!e&&We&&t-qn<Qr){Xn(We);return}if(!(!e&&Wa)){if(!e&&t-ja<6e4){We&&Xn(We);return}Wa=!0;try{await Pt(),await Xp(),await Jp();const n=await Vt();await Zp(),We={grossRewards:n,claimPreview:An,userNftBoost:be,userBurnRate:Wt,nftSource:sa,claimEthFee:ra},qn=t,Xn(We),ja=t}catch(n){console.error("Rewards Error:",n)}finally{Wa=!1}}},clearCache(){We=null,qn=0,ja=0,An=null}};async function Xp(){try{const e=c.delegationManagerContract||c.delegationManagerContractPublic;if(e&&c.userAddress)try{const n=await e.getUserBestBoost(c.userAddress);be=Number(n)}catch{const n=await Ht();be=(n==null?void 0:n.highestBoost)||0,sa=(n==null?void 0:n.source)||"none"}else{const n=await Ht();be=(n==null?void 0:n.highestBoost)||0,sa=(n==null?void 0:n.source)||"none"}Wt=tc(be).burnRate}catch(e){console.error("Error loading NFT boost:",e),be=0,Wt=50}}async function Jp(){try{const e=c.delegationManagerContract||c.delegationManagerContractPublic;if(e&&c.userAddress){try{const t=await e.previewClaim(c.userAddress);An={totalRewards:t.totalRewards||t[0]||0n,burnAmount:t.burnAmount||t[1]||0n,userReceives:t.userReceives||t[2]||0n,burnRateBips:t.burnRateBips||t[3]||0n,nftBoost:t.nftBoost||t[4]||0n}}catch{const{stakingRewards:t,minerRewards:n}=await Vt(),a=(t||0n)+(n||0n),s=a*BigInt(Wt)/100n;An={totalRewards:a,burnAmount:s,userReceives:a-s,burnRateBips:BigInt(Wt*100),nftBoost:BigInt(be)}}try{ra=await e.claimEthFee()}catch{ra=0n}}}catch(e){console.error("Error loading claim preview:",e)}}async function Zp(){if(c.userAddress)try{const e=(Ee==null?void 0:Ee.getHistory)||"https://gethistory-4wvdcuoouq-uc.a.run.app",t=await fetch(`${e}/${c.userAddress}`);if(!t.ok)return;In=(await t.json()).filter(a=>a.type==="ClaimReward"||(a.type||"").toUpperCase().includes("CLAIM")).slice(0,10).map(a=>{var s,r,o,i;return{amount:a.amount||((s=a.details)==null?void 0:s.amountReceived)||((r=a.details)==null?void 0:r.amount)||"0",burnedAmount:((o=a.details)==null?void 0:o.burnedAmount)||"0",timestamp:(i=a.timestamp)!=null&&i._seconds?new Date(a.timestamp._seconds*1e3):a.timestamp?new Date(a.timestamp):new Date,txHash:a.txHash||""}})}catch(e){console.warn("Failed to load claim history:",e.message),In=[]}}function Qp(){return`
    ...
    `}function eo(){const e=document.getElementById("rewards-content");e&&(e.innerHTML=`
    ...
    `)}function e0(){const e=document.getElementById("rewards-content");e&&(e.innerHTML=`
    ...
    `)}function Xn(e){const t=document.getElementById("rewards-content");if(!t)return;const{grossRewards:n}=e||{},a=(n==null?void 0:n.stakingRewards)||0n,s=(n==null?void 0:n.minerRewards)||0n,r=An||{},o=r.totalRewards||a+s,i=r.burnAmount||o*BigInt(Wt)/100n,l=r.userReceives||o-i,d=Number(o)/1e18,u=Number(i)/1e18,f=Number(l)/1e18,m=Number(a)/1e18,b=Number(s)/1e18,p=Number(ra)/1e18,g=o>0n,y=tc(be),k=d,T=d*(y.keepRate/100),I=k-T;t.innerHTML=`
        <div class="space-y-4">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-zinc-500">
                                ${be>0?`${sa==="rented"?"Rented":"Active"} • Keep ${y.keepRate}%`:"Keep up to 100% with NFT"}
                            </p>
                        </div>
                    </div>
    ...
    `}function t0(){return In.length===0?`
            <div class="text-center py-8">
                <i class="fa-solid fa-inbox text-zinc-700 text-2xl mb-3"></i>
                <p class="text-zinc-600 text-xs">No claims yet</p>
            </div>
        `:In.map(e=>{const t=e.amount?(Number(e.amount)/1e18).toFixed(4):"0",n=e.burnedAmount&&Number(e.burnedAmount)>0?(Number(e.burnedAmount)/1e18).toFixed(2):null,a=e.timestamp?Vp(new Date(e.timestamp)):"";return`
            <a href="${Yp}${e.txHash}" target="_blank" 
        ...
        `}).join("")}async function n0(){if(Jn)return;const e=document.getElementById("claim-btn"),t=document.getElementById("claim-btn-text"),n=document.getElementById("claim-btn-icon");if(e){Jn=!0,e.disabled=!0,e.className="claim-btn w-full py-4 text-base flex items-center justify-center gap-2",e.style.background="rgba(63,63,70,0.8)",t.textContent="Processing...",n.className="fa-solid fa-spinner fa-spin";try{await It.claimRewards({button:e,onSuccess:a=>{e.style.background="linear-gradient(135deg, #22c55e 0%, #16a34a 100%)",e.className="claim-btn w-full py-4 text-base flex items-center justify-center gap-2 celebrate",t.textContent="🎉 Claimed Successfully!",n.className="fa-solid fa-check",x("🎁 Rewards claimed successfully!","success"),setTimeout(()=>{oa.clearCache(),In=[],oa.update(!0)},2500)},onError:a=>{a&&!a.cancelled&&a.type!=="user_rejected"&&x(a.message||"Claim failed","error"),to()}})}catch(a){console.error("Claim error:",a),x(a.message||"Claim failed","error"),to()}finally{Jn=!1}}}function to(){const e=document.getElementById("claim-btn"),t=document.getElementById("claim-btn-text"),n=document.getElementById("claim-btn-icon");e&&(e.disabled=!1,e.style.background="",e.className="claim-btn w-full py-4 text-base flex items-center justify-center gap-2",t&&(t.textContent="Claim Rewards"),n&&(n.className="fa-solid fa-hand-holding-dollar"))}window.RewardsPage=oa;const er="https://sepolia.arbiscan.io/tx/",us="https://sepolia.arbiscan.io/address/",nc="0x16346f5a45f9615f1c894414989f0891c54ef07b",a0=(w==null?void 0:w.fortunePool)||"0x277dB00d533Bbc0fc267bbD954640aDA38ee6B37",ia="./assets/fortune.png",ps=1e3,no={pt:{title:"Compartilhe & Ganhe!",subtitle:"+1000 pontos para o Airdrop",later:"Talvez depois"},en:{title:"Share & Earn!",subtitle:"+1000 points for Airdrop",later:"Maybe later"},es:{title:"¡Comparte y Gana!",subtitle:"+1000 puntos para el Airdrop",later:"Quizás después"}},s0={pt:{win:e=>`🎉 Ganhei ${e.toLocaleString()} BKC no Fortune Pool!
...
#Backcoin #Web3 #Arbitrum`}},Ga={pt:"./assets/pt.png",en:"./assets/en.png",es:"./assets/es.png"};let Ge="en";const ue=[{id:1,name:"Easy",emoji:"🍀",range:3,multiplier:2,chance:"33%",color:"emerald",hex:"#10b981",bgFrom:"from-emerald-500/20",bgTo:"to-green-600/10",borderColor:"border-emerald-500/50",textColor:"text-emerald-400"},{id:2,name:"Medium",emoji:"⚡",range:10,multiplier:5,chance:"10%",color:"violet",hex:"#8b5cf6",bgFrom:"from-violet-500/20",bgTo:"to-purple-600/10",borderColor:"border-violet-500/50",textColor:"text-violet-400"},{id:3,name:"Hard",emoji:"👑",range:100,multiplier:50,chance:"1%",color:"amber",hex:"#f59e0b",bgFrom:"from-amber-500/20",bgTo:"to-orange-600/10",borderColor:"border-amber-500/50",textColor:"text-amber-400"}],ac=57,v={mode:null,phase:"select",guess:50,guesses:[2,5,50],comboStep:0,wager:10,gameId:null,result:null,txHash:null,poolStatus:null,history:[],serviceFee:0n,serviceFee1x:0n,serviceFee5x:0n,tiersData:null,commitment:{hash:null,userSecret:null,commitBlock:null,commitTxHash:null,revealDelay:2,waitStartTime:null,canReveal:!1}};let Le=null;const r0=3e3,sc=250;function o0(){if(document.getElementById("fortune-styles-v2"))return;const e=document.createElement("style");e.id="fortune-styles-v2",e.textContent=`
    ...
    `,document.head.appendChild(e)}function i0(){o0();const e=document.getElementById("actions");if(!e){console.error("❌ FortunePool: Container #actions not found!");return}e.innerHTML=`
        <div class="max-w-md mx-auto px-4 py-6">
            <!-- Header -->
            <div class="text-center mb-6">
                <div class="relative inline-block">
                    <img id="tiger-mascot" src="${ia}" 
                ...
                <div class="flex items-center justify-center gap-2 mt-3 flex-wrap">
                    <a href="${us}${nc}" target="_blank" rel="noopener" 
                    ...
                    <a href="${us}${a0}" target="_blank" rel="noopener" 
            ...
            <div class="bg-zinc-900/50 border border-zinc-800/50 rounded-2xl overflow-hidden">
                ...
                <div id="history-list" class="max-h-[300px] overflow-y-auto p-2">
                    <div class="p-6 text-center text-zinc-600 text-sm">
                        <img src="${ia}" class="w-12 h-12 mx-auto opacity-30 animate-pulse mb-2" onerror="this.style.display='none'">
                        Loading...
                    </div>
                </div>
            </div>
        </div>
    `,nr(),le()}function l0(){Le&&(clearInterval(Le),Le=null),v.phase="select",v.result=null,v.commitment={hash:null,userSecret:null,commitBlock:null,commitTxHash:null,revealDelay:v.commitment.revealDelay||2,waitStartTime:null,canReveal:!1}}function le(){const e=document.getElementById("game-area");if(e)switch(c0(v.phase),v.phase){case"select":ao(e);break;case"pick":d0(e);break;case"wager":m0(e);break;case"processing":b0(e);break;case"waiting":g0(e);break;case"result":y0(e);break;default:ao(e)}}function c0(e){var n;const t=document.getElementById("tiger-mascot");if(t)switch(t.className="w-28 h-28 object-contain mx-auto",t.style.filter="",e){case"select":t.classList.add("tiger-float","tiger-pulse");break;case"pick":case"wager":t.classList.add("tiger-float");break;case"processing":t.classList.add("tiger-spin");break;case"waiting":t.classList.add("tiger-float"),t.style.filter="hue-rotate(270deg)";break;case"result":((n=v.result)==null?void 0:n.prizeWon)>0?t.classList.add("tiger-celebrate"):(t.style.filter="grayscale(0.5)",t.classList.add("tiger-float"));break}}function ao(e){var s,r;const t=v.serviceFee1x>0n?(Number(v.serviceFee1x)/1e18).toFixed(6):"0",n=v.serviceFee5x>0n?(Number(v.serviceFee5x)/1e18).toFixed(6):"0",a=v.serviceFee1x>0n||v.serviceFee5x>0n;e.innerHTML=`
        <div class="space-y-4">
            <!-- JACKPOT MODE -->
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center gap-3 mb-1">
                            ...
                            <span class="px-2.5 py-1 rounded-full bg-violet-500/20 border border-violet-500/40 text-violet-400 text-sm font-black">${ac}x</span>
                        </div>
    ...
    `,(s=document.getElementById("btn-jackpot"))==null||s.addEventListener("click",()=>{if(!c.isConnected)return x("Connect wallet first","warning");v.mode="jackpot",v.guess=50,v.phase="pick",le()}),(r=document.getElementById("btn-combo"))==null||r.addEventListener("click",()=>{if(!c.isConnected)return x("Connect wallet first","warning");v.mode="combo",v.guesses=[2,5,50],v.comboStep=0,v.phase="pick",le()})}function d0(e){v.mode==="jackpot"?u0(e):p0(e)}function u0(e){var i,l,d,u,f,m,b;const t=ue[2],n=v.guess;e.innerHTML=`
    ...
    `;const a=document.getElementById("number-input"),s=document.getElementById("number-slider"),r=ue[2],o=p=>{p=Math.max(1,Math.min(100,p)),v.guess=p,a&&(a.value=p),s&&(s.value=p,s.style.background=`linear-gradient(to right, ${r.hex} 0%, ${r.hex} ${p}%, #27272a ${p}%, #27272a 100%)`)};a==null||a.addEventListener("input",p=>o(parseInt(p.target.value)||1)),a==null||a.addEventListener("blur",p=>o(parseInt(p.target.value)||1)),s==null||s.addEventListener("input",p=>o(parseInt(p.target.value))),(i=document.getElementById("btn-minus"))==null||i.addEventListener("click",()=>o(v.guess-1)),(l=document.getElementById("btn-plus"))==null||l.addEventListener("click",()=>o(v.guess+1)),(d=document.getElementById("btn-minus-10"))==null||d.addEventListener("click",()=>o(v.guess-10)),(u=document.getElementById("btn-plus-10"))==null||u.addEventListener("click",()=>o(v.guess+10)),document.querySelectorAll(".quick-pick").forEach(p=>{p.addEventListener("click",()=>o(parseInt(p.dataset.number)))}),(f=document.getElementById("btn-random"))==null||f.addEventListener("click",()=>{o(Math.floor(Math.random()*100)+1)}),(m=document.getElementById("btn-back"))==null||m.addEventListener("click",()=>{v.phase="select",le()}),(b=document.getElementById("btn-next"))==null||b.addEventListener("click",()=>{v.phase="wager",le()})}function p0(e){var r,o,i,l,d,u,f;const t=ue[v.comboStep],n=v.guesses[v.comboStep],a=t.range===100;if(e.innerHTML=`
        <div class="bg-gradient-to-br from-zinc-900 to-zinc-800/50 border border-zinc-700/50 rounded-2xl p-5">
            <!-- Progress Pills -->
            <div class="flex justify-center gap-2 sm:gap-3 mb-5">
                ${ue.map((m,b)=>{const p=b===v.comboStep,g=b<v.comboStep;return`
                        <div class="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 rounded-xl border ${p?`bg-gradient-to-br ${m.bgFrom} ${m.bgTo} ${m.borderColor}`:g?"bg-emerald-500/10 border-emerald-500/50":"bg-zinc-800/50 border-zinc-700/50"}">
                            <span class="text-lg sm:text-xl">${g?"✓":m.emoji}</span>
                            <div class="text-left">
                                <p class="text-[10px] sm:text-xs font-bold ${p?m.textColor:g?"text-emerald-400":"text-zinc-500"}">${m.name}</p>
                                <p class="text-[8px] sm:text-[10px] ${g?"text-emerald-400 font-bold":"text-zinc-600"}">${g?v.guesses[b]:m.multiplier+"x"}</p>
                            </div>
                        </div>
                    `}).join("")}
            </div>
    ...
    `,t.range===100){const m=document.getElementById("combo-number-input"),b=document.getElementById("combo-slider"),p=g=>{g=Math.max(1,Math.min(100,g)),v.guesses[v.comboStep]=g,m&&(m.value=g),b&&(b.value=g,b.style.background=`linear-gradient(to right, ${t.hex} 0%, ${t.hex} ${g}%, #27272a ${g}%, #27272a 100%)`)};m==null||m.addEventListener("input",g=>p(parseInt(g.target.value)||1)),m==null||m.addEventListener("blur",g=>p(parseInt(g.target.value)||1)),b==null||b.addEventListener("input",g=>p(parseInt(g.target.value))),(r=document.querySelector(".combo-minus"))==null||r.addEventListener("click",()=>p(v.guesses[v.comboStep]-1)),(o=document.querySelector(".combo-plus"))==null||o.addEventListener("click",()=>p(v.guesses[v.comboStep]+1)),(i=document.querySelector(".combo-minus-10"))==null||i.addEventListener("click",()=>p(v.guesses[v.comboStep]-10)),(l=document.querySelector(".combo-plus-10"))==null||l.addEventListener("click",()=>p(v.guesses[v.comboStep]+10)),document.querySelectorAll(".combo-quick").forEach(g=>{g.addEventListener("click",()=>p(parseInt(g.dataset.num)))}),(d=document.querySelector(".combo-random"))==null||d.addEventListener("click",()=>{p(Math.floor(Math.random()*100)+1)})}else document.querySelectorAll(".num-btn").forEach(m=>{m.addEventListener("click",()=>{const b=parseInt(m.dataset.num);v.guesses[v.comboStep]=b,document.querySelectorAll(".num-btn").forEach(p=>{parseInt(p.dataset.num)===b?p.className=`num-btn w-12 h-12 rounded-xl font-bold text-lg transition-all bg-gradient-to-br ${t.bgFrom} ${t.bgTo} border-2 ${t.borderColor} ${t.textColor}`:p.className="num-btn w-12 h-12 rounded-xl font-bold text-lg transition-all bg-zinc-800/60 border border-zinc-700/50 text-zinc-400 hover:border-zinc-600"})})});(u=document.getElementById("btn-back"))==null||u.addEventListener("click",()=>{v.comboStep>0?(v.comboStep--,le()):(v.phase="select",le())}),(f=document.getElementById("btn-next"))==null||f.addEventListener("click",()=>{v.comboStep<2?(v.comboStep++,le()):(v.phase="wager",le())})}function m0(e){const t=v.mode==="jackpot",n=t?[v.guess]:v.guesses,a=t?50:ac,s=_(c.currentUserBalance||0n),r=s>=1,o=t?v.serviceFee1x:v.serviceFee5x,i=o>0n?Number(o)/1e18:0,l=o>0n;e.innerHTML=`
        <div class="bg-gradient-to-br from-zinc-900 to-zinc-800/50 border border-zinc-700/50 rounded-2xl p-5">
            ...
            <div class="p-3 bg-blue-500/10 border border-blue-500/30 rounded-xl mb-4">
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-right">
                        <span class="text-blue-400 font-bold">${i.toFixed(6)} ETH</span>
    ...
    `,f0(a,s)}function f0(e,t){var a,s,r,o,i,l,d,u;const n=f=>{v.wager=Math.max(1,Math.min(Math.floor(f),Math.floor(t)));const m=document.getElementById("custom-wager"),b=document.getElementById("potential-win");m&&(m.value=v.wager),b&&(b.textContent=(v.wager*e).toLocaleString()),document.querySelectorAll(".percent-btn").forEach(p=>{const g=parseInt(p.dataset.value);v.wager===g?p.className="percent-btn py-2.5 text-sm font-bold rounded-xl transition-all bg-gradient-to-r from-amber-500/30 to-orange-500/20 border-2 border-amber-500/60 text-amber-400 shadow-lg shadow-amber-500/20":p.className="percent-btn py-2.5 text-sm font-bold rounded-xl transition-all bg-zinc-800/60 border border-zinc-700/50 text-zinc-400 hover:border-amber-500/30 hover:text-amber-300"})};document.querySelectorAll(".percent-btn").forEach(f=>{f.addEventListener("click",()=>{n(parseInt(f.dataset.value)||1)})}),(a=document.getElementById("custom-wager"))==null||a.addEventListener("input",f=>{n(parseInt(f.target.value)||1)}),(s=document.getElementById("wager-minus"))==null||s.addEventListener("click",()=>{n(v.wager-1)}),(r=document.getElementById("wager-plus"))==null||r.addEventListener("click",()=>{n(v.wager+1)}),(o=document.getElementById("wager-minus-10"))==null||o.addEventListener("click",()=>{n(v.wager-10)}),(i=document.getElementById("wager-plus-10"))==null||i.addEventListener("click",()=>{n(v.wager+10)}),(l=document.getElementById("btn-faucet"))==null||l.addEventListener("click",async()=>{x("Requesting tokens...","info");try{const m=await(await fetch(`https://faucet-4wvdcuoouq-uc.a.run.app?address=${c.userAddress}`)).json();m.success?(x("🎉 Tokens received!","success"),await Pt(),le()):x(m.error||"Error","error")}catch{x("Faucet error","error")}}),(d=document.getElementById("btn-back"))==null||d.addEventListener("click",()=>{v.phase="pick",v.mode==="combo"&&(v.comboStep=2),le()}),(u=document.getElementById("btn-play"))==null||u.addEventListener("click",async()=>{if(v.wager<1)return x("Min: 1 BKC","warning");v.phase="processing",le();try{const f=v.mode==="jackpot"?[v.guess]:v.guesses,m=v.mode==="combo",b=window.ethers.parseEther(v.wager.toString());await Us.playGame({wagerAmount:b,guesses:f,isCumulative:m,button:document.getElementById("btn-play"),onSuccess:p=>{v.gameId=(p==null?void 0:p.gameId)||Date.now(),v.commitment={hash:null,userSecret:(p==null?void 0:p.userSecret)||null,commitBlock:(p==null?void 0:p.commitBlock)||null,commitTxHash:(p==null?void 0:p.txHash)||null,revealDelay:v.commitment.revealDelay||2,waitStartTime:Date.now(),canReveal:!1},v.txHash=(p==null?void 0:p.txHash)||null,console.log("🔐 Game committed:",v.gameId,"Block:",v.commitment.commitBlock),v.phase="waiting",le(),x0()},onError:p=>{p.cancelled||x(p.message||"Commit failed","error"),v.phase="wager",le()}})}catch(f){console.error("Commit error:",f);const m=f.message||f.reason||"Transaction failed";x("Error: "+m,"error"),v.phase="wager",le()}})}function b0(e){const t=v.mode==="jackpot",n=t?[v.guess]:v.guesses,a=t?[ue[2]]:ue;e.innerHTML=`
        <div class="bg-gradient-to-br from-zinc-900 to-zinc-800/50 border border-zinc-700/50 rounded-2xl p-6 processing-pulse">
            ...
            <div class="border-t border-zinc-700/50 pt-5">
                ...
                <div class="flex justify-center gap-4">
                    ${a.map((s,r)=>{const o=t?n[0]:n[r];return`
                            <div class="text-center">
    ...
    `,a.forEach((s,r)=>{const o=document.getElementById(`spin-${r}`);if(!o)return;setInterval(()=>{o.textContent=Math.floor(Math.random()*s.range)+1},80)})}function g0(e){var l;const t=v.mode==="jackpot",n=t?[v.guess]:v.guesses,a=t?[ue[2]]:ue,s=Date.now()-(v.commitment.waitStartTime||Date.now()),r=v.commitment.revealDelay*sc,o=Math.max(0,r-s),i=Math.ceil(o/1e3);e.innerHTML=`
        <div class="bg-gradient-to-br from-violet-900/30 to-purple-900/20 border border-violet-500/30 rounded-2xl p-6 waiting-glow">
            ...
            <div class="bg-zinc-900/50 rounded-xl p-4 mb-4 border border-violet-500/20">
                <div class="text-center">
                    ...
                    <div class="flex items-center justify-center gap-2">
                        <span id="countdown-timer" class="text-4xl font-black text-violet-400 countdown-pulse">~${i}s</span>
                    </div>
            ...
            ${v.commitment.commitTxHash?`
                <div class="text-center mt-3">
                    <a href="${er}${v.commitment.commitTxHash}" target="_blank" 
    ...
    `,(l=document.getElementById("btn-reveal"))==null||l.addEventListener("click",()=>{v.commitment.canReveal&&ms()}),tr()}function tr(){if(v.phase!=="waiting")return;const e=document.getElementById("countdown-timer"),t=document.getElementById("progress-bar");if(document.getElementById("btn-reveal"),document.getElementById("reveal-btn-text"),!e)return;const n=Date.now()-(v.commitment.waitStartTime||Date.now()),a=v.commitment.revealDelay*sc,s=Math.max(0,a-n),r=Math.ceil(s/1e3);if(r>0?e.textContent=`~${r}s`:v.commitment.canReveal?e.textContent="Ready!":e.textContent="Verifying on chain...",t){const o=Math.min(100,n/a*100);t.style.width=`${o}%`}v.phase==="waiting"&&setTimeout(tr,1e3)}function x0(){Le&&clearInterval(Le),setTimeout(tr,100),Le=setInterval(async()=>{if(v.phase!=="waiting"){clearInterval(Le);return}try{await w0()&&!v.commitment.canReveal&&(v.commitment.canReveal=!0,clearInterval(Le),Le=null,console.log("[FortunePool] canReveal=true, starting auto-reveal..."),h0())}catch(e){console.warn("Reveal check error:",e)}},r0)}async function h0(){if(v.phase!=="waiting")return;const e=document.getElementById("countdown-timer"),t=document.getElementById("btn-reveal"),n=document.getElementById("reveal-btn-text");e&&(e.textContent="Revealing..."),t&&(t.disabled=!0,t.classList.remove("bg-zinc-800","text-zinc-500","cursor-not-allowed"),t.classList.add("bg-gradient-to-r","from-amber-500","to-yellow-500","text-white")),n&&(n.textContent="Auto-revealing...");const a=v.mode==="jackpot"?[v.guess]:v.guesses,s=5,r=2e3;await new Promise(o=>setTimeout(o,3e3));for(let o=1;o<=s;o++){if(v.phase!=="waiting")return;try{const i=c.fortunePoolContractPublic;i&&await i.revealPlay.staticCall(v.gameId,a,v.commitment.userSecret,{from:c.userAddress}),console.log(`[FortunePool] Pre-simulation passed (attempt ${o})`),ms();return}catch(i){const l=i.message||"",d=l.includes("0x92555c0e")||l.includes("BlockhashUnavailable");if(d&&o<s)console.log(`[FortunePool] BlockhashUnavailable, retry in ${r}ms (${o}/${s})`),e&&(e.textContent="Syncing block data..."),await new Promise(u=>setTimeout(u,r));else if(d){console.warn("[FortunePool] Pre-sim retries exhausted, enabling manual button"),v0();return}else{console.log("[FortunePool] Pre-sim error (non-blockhash), trying direct reveal:",l),ms();return}}}}function v0(){const e=document.getElementById("btn-reveal"),t=document.getElementById("reveal-btn-text"),n=document.getElementById("countdown-timer");n&&(n.textContent="Ready!"),e&&(e.disabled=!1,e.classList.remove("bg-zinc-800","text-zinc-500","cursor-not-allowed","from-amber-500","to-yellow-500"),e.classList.add("bg-gradient-to-r","from-emerald-500","to-green-500","text-white")),t&&(t.textContent="Reveal & Get Result!")}async function w0(){if(!c.fortunePoolContractPublic||!v.gameId)return!1;try{const e=await c.fortunePoolContractPublic.getCommitmentStatus(v.gameId);if(!v.commitment.commitBlock)try{const t=await c.fortunePoolContractPublic.getCommitment(v.gameId),n=Number(t.commitBlock);n>0&&(v.commitment.commitBlock=n)}catch{}return e.canReveal===!0}catch{return Date.now()-(v.commitment.waitStartTime||Date.now())>=3e4}}async function ms(){if(!v.commitment.canReveal){x("Not ready to reveal yet!","warning");return}const e=document.getElementById("btn-reveal");try{const t=v.mode==="jackpot"?[v.guess]:v.guesses;await Us.revealPlay({gameId:v.gameId,guesses:t,userSecret:v.commitment.userSecret,button:e,onSuccess:(n,a)=>{Le&&clearInterval(Le),v.txHash=n.hash,v.result={rolls:(a==null?void 0:a.rolls)||[],prizeWon:(a==null?void 0:a.prizeWon)||0n,matches:(a==null?void 0:a.matches)||[],matchCount:(a==null?void 0:a.matchCount)||0},console.log("🎲 Game revealed:",v.result),v.phase="result",le(),nr()},onError:n=>{if(!n.cancelled){const a=n.message||"";a.includes("0x92555c0e")||a.includes("BlockhashUnavailable")?x("Block data not available yet. RPC will retry automatically.","warning"):x(a||"Reveal failed","error")}e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-dice mr-2"></i>Try Again')}})}catch(t){console.error("Reveal error:",t),x("Reveal failed: "+(t.message||"Unknown error"),"error"),e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-dice mr-2"></i>Try Again')}}function y0(e){var f,m;const t=v.result;if(!t)return le();const n=v.mode==="jackpot",a=n?[v.guess]:v.guesses,s=t.rolls||[],r=n?[ue[2]]:ue,o=a.map((b,p)=>{const g=s[p]!==void 0?Number(s[p]):null;return g!==null&&g===b}),i=o.filter(b=>b).length,l=t.prizeWon>0||i>0;let d=0;t.prizeWon&&t.prizeWon>0n?d=_(BigInt(t.prizeWon)):i>0&&o.forEach((b,p)=>{if(b){const g=n?ue[2]:ue[p];d+=v.wager*g.multiplier}});const u=typeof d=="number"?d.toLocaleString(void 0,{maximumFractionDigits:2}):d.toLocaleString();e.innerHTML=`
        <div class="bg-gradient-to-br ${l?"from-emerald-900/30 to-green-900/10 border-emerald-500/30":"from-zinc-900 to-zinc-800/50 border-zinc-700/50"} border rounded-2xl p-4 sm:p-6 relative overflow-hidden" id="result-container">
            ...
            <div class="grid ${n?"grid-cols-1 max-w-[200px] mx-auto":"grid-cols-3"} gap-2 sm:gap-3 mb-4">
                ${r.map((b,p)=>{const g=n?a[0]:a[p],y=s[p],k=o[p];return`
                            ...
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-lg ${k?"bg-emerald-500/30 border-emerald-500":"bg-zinc-700/50 border-zinc-600"} border flex items-center justify-center">
                                        <span class="text-lg sm:text-xl font-black ${k?"text-emerald-400":"text-zinc-300"}">${y!==void 0?y:"?"}</span>
                                    </div>
                                </div>
                            </div>
            ...
            ${v.txHash?`
                <div class="text-center mb-3">
                    <a href="${er}${v.txHash}" target="_blank" class="inline-flex items-center gap-2 text-xs text-zinc-500 hover:text-zinc-400">
                        <i class="fa-solid fa-external-link"></i>
                        View Transaction
                    </a>
                </div>
    ...
    `,l&&(k0(),d>v.wager*10&&E0()),(f=document.getElementById("btn-new-game"))==null||f.addEventListener("click",()=>{v.phase="select",v.result=null,v.txHash=null,v.gameId=null,le(),nr()}),(m=document.getElementById("btn-share"))==null||m.addEventListener("click",()=>{T0(l,d)})}function k0(){const e=document.createElement("div");e.className="confetti-container",document.body.appendChild(e);const t=["#f59e0b","#10b981","#8b5cf6","#ec4899","#06b6d4"],n=["●","■","★","🐯","🎉"];for(let a=0;a<60;a++){const s=document.createElement("div");s.className="confetti",s.style.cssText=`
            left: ${Math.random()*100}%;
            color: ${t[a%t.length]};
            font-size: ${8+Math.random()*12}px;
            animation-delay: ${Math.random()*2}s;
            animation-duration: ${2+Math.random()*2}s;
        `,s.textContent=n[a%n.length],e.appendChild(s)}setTimeout(()=>e.remove(),5e3)}function E0(){const e=["🪙","💰","✨","⭐","🎉"];for(let t=0;t<30;t++)setTimeout(()=>{const n=document.createElement("div");n.className="coin",n.textContent=e[Math.floor(Math.random()*e.length)],n.style.left=`${Math.random()*100}%`,n.style.animationDelay=`${Math.random()*.5}s`,n.style.animationDuration=`${2+Math.random()*2}s`,document.body.appendChild(n),setTimeout(()=>n.remove(),4e3)},t*100)}function T0(e,t){var l,d,u,f,m,b;const n=no[Ge],a=()=>{const p=s0[Ge];return e?p.win(t):p.lose},s=`
        <div class="text-center">
            <img src="${ia}" class="w-16 h-16 mx-auto mb-2" alt="Fortune Pool" onerror="this.style.display='none'">
    ...
    `;vn(s,"max-w-xs");const r=p=>{Ge=p;const g=no[p],y=document.getElementById("share-modal-title"),k=document.getElementById("share-modal-subtitle"),T=document.getElementById("btn-close-share");y&&(y.textContent=g.title),k&&(k.textContent=g.subtitle),T&&(T.textContent=g.later),document.querySelectorAll(".lang-btn").forEach(I=>{const N=I.dataset.lang,z=I.querySelector("span");N===p?(I.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-amber-500/20 border-amber-500 ring-1 ring-amber-500/50 border",z&&(z.className="text-amber-400")):(I.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-zinc-800 border-zinc-700 hover:border-zinc-500 border",z&&(z.className="text-zinc-400"))})};document.querySelectorAll(".lang-btn").forEach(p=>{p.addEventListener("click",()=>r(p.dataset.lang))});const o=async p=>{if(!c.userAddress)return!1;try{const y=await(await fetch("https://us-central1-backchain-backand.cloudfunctions.net/trackShare",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({address:c.userAddress,gameId:v.gameId||Date.now(),type:"fortune",platform:p})})).json();return y.success?(x(`🎉 +${y.pointsAwarded||ps} Airdrop Points!`,"success"),!0):(y.reason==="already_shared"&&console.log("Already shared this game"),!1)}catch(g){return console.error("Share tracking error:",g),x(`🎉 +${ps} Airdrop Points!`,"success"),!0}},i=async(p,g)=>{await o(p),window.open(g,"_blank"),we()};(l=document.getElementById("share-twitter"))==null||l.addEventListener("click",()=>{const p=a();i("twitter",`https://twitter.com/intent/tweet?text=${encodeURIComponent(p)}`)}),(d=document.getElementById("share-telegram"))==null||d.addEventListener("click",()=>{const p=a();i("telegram",`https://t.me/share/url?url=https://backcoin.org&text=${encodeURIComponent(p)}`)}),(u=document.getElementById("share-whatsapp"))==null||u.addEventListener("click",()=>{const p=a();i("whatsapp",`https://wa.me/?text=${encodeURIComponent(p)}`)}),(f=document.getElementById("share-instagram"))==null||f.addEventListener("click",async()=>{const p=a();try{await navigator.clipboard.writeText(p),await o("instagram");const g=`
            ...
            `;we(),setTimeout(()=>{var y,k;vn(g,"max-w-xs"),(y=document.getElementById("btn-open-instagram"))==null||y.addEventListener("click",()=>{window.open("https://www.instagram.com/backcoin.bkc/","_blank"),we()}),(k=document.getElementById("btn-close-ig-modal"))==null||k.addEventListener("click",we)},100)}catch{x("Could not copy text","error"),we()}}),(m=document.getElementById("share-copy"))==null||m.addEventListener("click",async()=>{const p=a();try{await navigator.clipboard.writeText(p),x("📋 Copied!","success"),await o("copy")}catch{x("Copy failed","error")}we()}),(b=document.getElementById("btn-close-share"))==null||b.addEventListener("click",we)}async function C0(){const e=c.fortunePoolContract||c.fortunePoolContractPublic;if(!e)return console.log("No fortune contract available"),null;try{const[t,n,a]=await Promise.all([e.prizePoolBalance().catch(()=>0n),e.gameCounter().catch(()=>0),e.activeTierCount().catch(()=>3)]);let s=0n,r=0n,o=0n;try{s=await e.getRequiredServiceFee(!1),r=await e.getRequiredServiceFee(!0),o=s,console.log(`Service fees: 1x=${Number(s)/1e18} ETH, 5x=${Number(r)/1e18} ETH`)}catch(i){console.log("getRequiredServiceFee failed, using fallback:",i.message);try{o=await e.serviceFee(),s=o,r=o*5n}catch{console.log("Could not fetch service fee")}}v.serviceFee=o,v.serviceFee1x=s,v.serviceFee5x=r;try{const i=await e.revealDelay();v.commitment.revealDelay=Number(i)||2,console.log("revealDelay from contract:",v.commitment.revealDelay)}catch{console.log("Using default revealDelay:",v.commitment.revealDelay)}try{const[i,l]=await e.getAllTiers();v.tiersData=i.map((d,u)=>({range:Number(d),multiplier:Number(l[u])/1e4})),console.log("Tiers from contract:",v.tiersData)}catch{console.log("Using default tiers")}return{prizePool:t||0n,gameCounter:Number(n)||0,serviceFee:o,serviceFee1x:s,serviceFee5x:r,tierCount:Number(a)||3}}catch(t){return console.error("getFortunePoolStatus error:",t),{prizePool:0n,gameCounter:0,serviceFee:0n}}}async function nr(){try{const e=await C0();if(e){const n=document.getElementById("prize-pool"),a=document.getElementById("total-games");n&&(n.textContent=_(e.prizePool||0n).toFixed(2)+" BKC"),a&&(a.textContent=(e.gameCounter||0).toLocaleString())}const t=document.getElementById("user-balance");t&&(t.textContent=_(c.currentUserBalance||0n).toFixed(2)+" BKC"),I0()}catch(e){console.error("Pool error:",e)}}async function I0(){var e;try{const t=Ee.fortuneGames||"https://getfortunegames-4wvdcuoouq-uc.a.run.app",n=c.userAddress?`${t}?player=${c.userAddress}&limit=15`:`${t}?limit=15`,s=await(await fetch(n)).json();if(((e=s.games)==null?void 0:e.length)>0){A0(s.games);const r=s.games.filter(i=>i.isWin||i.prizeWon&&BigInt(i.prizeWon)>0n).length,o=document.getElementById("win-rate");o&&(o.textContent=`🏆 ${r}/${s.games.length} wins`)}else{const r=document.getElementById("history-list");r&&(r.innerHTML=`
                <div class="p-8 text-center">
                    <img src="${ia}" class="w-16 h-16 mx-auto opacity-20 mb-3" onerror="this.style.display='none'">
                    <p class="text-zinc-500 text-sm">No games yet</p>
                    <p class="text-zinc-600 text-xs mt-1">Be the first to play!</p>
                </div>
            `)}}catch(t){console.error("loadHistory error:",t)}}function A0(e){const t=document.getElementById("history-list");t&&(t.innerHTML=e.map(n=>{var p;const a=n.isWin||n.prizeWon&&BigInt(n.prizeWon)>0n,s=n.prizeWon?_(BigInt(n.prizeWon)):0,r=n.wagerAmount?_(BigInt(n.wagerAmount)):0,o=n.isCumulative,i=n.rolls||[],l=n.guesses||[],d=n.txHash||n.transactionHash,u=B0(n.timestamp||n.createdAt),f=n.player?`${n.player.slice(0,6)}...${n.player.slice(-4)}`:"???",m=c.userAddress&&((p=n.player)==null?void 0:p.toLowerCase())===c.userAddress.toLowerCase(),b=d?`${er}${d}`:null;return`
               ...
               ${b?"":'onclick="return false;"'}>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex gap-1">
                        ${(o?ue:[ue[2]]).map((g,y)=>{const k=l[y],T=i[y];return`
        ...
        `}).join(""))}function B0(e){if(!e)return"N/A";try{const t=Date.now();let n;if(typeof e=="number"?n=e>1e12?e:e*1e3:typeof e=="string"?n=new Date(e).getTime():e._seconds?n=e._seconds*1e3:e.seconds?n=e.seconds*1e3:n=new Date(e).getTime(),isNaN(n))return"N/A";const a=t-n;if(a<0)return"Just now";const s=Math.floor(a/6e4),r=Math.floor(a/36e5),o=Math.floor(a/864e5);return s<1?"Just now":s<60?`${s}m ago`:r<24?`${r}h ago`:o<7?`${o}d ago`:new Date(n).toLocaleDateString("en-US",{month:"short",day:"numeric"})}catch(t){return console.error("getTimeAgo error:",t),"N/A"}}const P0={render:i0,cleanup:l0},N0=()=>{if(document.getElementById("about-styles-v4"))return;const e=document.createElement("style");e.id="about-styles-v4",e.innerHTML=`
        @keyframes pulse-hub {
    ...
    `,document.head.appendChild(e)};function z0(){return`
    ...
    `,document.head.appendChild(e)}async function en(){var e;A.isConnected=c.isConnected,A.user=null,A.userSubmissions=[],A.platformUsage={},A.isBanned=!1;try{const t=await As();if(A.systemConfig=t.config,A.leaderboards=t.leaderboards,A.dailyTasks=t.dailyTasks||[],A.platformUsageConfig=t.platformUsageConfig||oc,A.isConnected&&c.userAddress){const[n,a]=await Promise.all([dn(c.userAddress),Od()]);if(A.user=n,A.userSubmissions=a,n&&n.isBanned){A.isBanned=!0;return}try{typeof zr=="function"&&(A.platformUsage=await zr()||{})}catch(s){console.warn("Could not load platform usage:",s),A.platformUsage={}}A.dailyTasks.length>0&&(A.dailyTasks=await Promise.all(A.dailyTasks.map(async s=>{try{if(!s.id)return{...s,eligible:!1,timeLeftMs:0};const r=await Ro(s.id,s.cooldownHours);return{...s,eligible:r.eligible,timeLeftMs:r.timeLeft}}catch{return{...s,eligible:!1,timeLeftMs:0}}})))}}catch(t){if(console.error("Airdrop Data Load Error:",t),t.code==="permission-denied"||(e=t.message)!=null&&e.includes("permission")){console.warn("Firebase permissions issue - user may need to connect wallet or sign in"),A.systemConfig=A.systemConfig||{},A.leaderboards=A.leaderboards||{top100ByPoints:[],top100ByPosts:[]},A.dailyTasks=A.dailyTasks||[];return}x("Error loading data. Please refresh.","error")}}function K0(e){if(!A.user||!e||e.length===0)return null;const t=e.findIndex(n=>{var a,s;return((a=n.walletAddress)==null?void 0:a.toLowerCase())===((s=A.user.walletAddress)==null?void 0:s.toLowerCase())});return t>=0?t+1:null}function Y0(e){return e?e<=5?st[0]:e<=25?st[1]:e<=75?st[2]:e<=200?st[3]:null:null}function ic(){var l;const{user:e}=A,t=(e==null?void 0:e.totalPoints)||0,n=(e==null?void 0:e.platformUsagePoints)||0,a=(e==null?void 0:e.approvedSubmissionsCount)||0,s=W0(a),r=((l=A.leaderboards)==null?void 0:l.top100ByPosts)||[],o=K0(r),i=Y0(o);return`
        <!-- Mobile Header -->
        <div class="md:hidden px-4 pt-4 pb-2">
            ...
            <div class="bg-zinc-900/80 border border-zinc-800 rounded-xl p-2.5 mb-3">
                <div class="grid grid-cols-4 gap-2">
                    ...
                    <div class="text-center">
                        ${i?`
                            <span class="text-sm font-bold ${i.text} stat-value">${i.icon}</span>
                            <p class="text-[7px] text-zinc-500 uppercase tracking-wider">#${o}</p>
                        `:`
        ...
        <div class="hidden md:block px-4 pt-6 pb-4">
            ...
            <div class="grid grid-cols-5 gap-3 mb-4">
                ...
                <div class="bg-zinc-900/80 border ${i?i.border:"border-zinc-800"} rounded-xl p-3 text-center relative overflow-hidden">
                    ${i?`
                        <div class="absolute inset-0 bg-gradient-to-br ${i.gradient} opacity-30"></div>
                        <span class="text-xl font-bold ${i.text} relative z-10">${i.icon} #${o}</span>
                        <p class="text-[10px] text-zinc-500 uppercase relative z-10">${i.name} Tier</p>
                    `:`
    ...
    `}function Ka(e,t,n){const a=A.activeTab===e;return`
    ...
    `}function Ya(e,t,n){const a=A.activeTab===e;return`
        <button data-target="${e}" 
    ...
    `}function Va(){return A.isConnected?`
        <div class="px-4 airdrop-fade-up">
            <!-- Earn Sub-Navigation -->
            <div class="flex gap-2 mb-4">
                <button data-earn-tab="post" class="earn-tab-btn flex-1 py-2 px-3 rounded-lg text-xs font-medium border border-zinc-700 flex items-center justify-center gap-1.5 ${A.activeEarnTab==="post"?"active":"text-zinc-400"}">
                    <i class="fa-solid fa-share-nodes"></i> Post & Share
                </button>
                <button data-earn-tab="platform" class="earn-tab-btn flex-1 py-2 px-3 rounded-lg text-xs font-medium border border-zinc-700 flex items-center justify-center gap-1.5 ${A.activeEarnTab==="platform"?"active":"text-zinc-400"}">
                    <i class="fa-solid fa-gamepad"></i> Use Platform
                </button>
                <button data-earn-tab="tasks" class="earn-tab-btn flex-1 py-2 px-3 rounded-lg text-xs font-medium border border-zinc-700 flex items-center justify-center gap-1.5 ${A.activeEarnTab==="tasks"?"active":"text-zinc-400"}">
            ...
            <!-- Sub-tab Content -->
            <div id="earn-content">
                ${A.activeEarnTab==="post"?V0():""}
                ${A.activeEarnTab==="platform"?q0():""}
                ${A.activeEarnTab==="tasks"?X0():""}
            </div>
        </div>
    `:`
        ...
        `}function V0(){const{user:e}=A,n=`https://backcoin.org/?ref=${(e==null?void 0:e.referralCode)||"CODE"}`;return`
        <div class="space-y-4">
                ...
                <div class="space-y-5">
                    ...
                    <div class="flex gap-3 items-start relative">
                        ...
                        <div class="flex-1 pb-2">
                            ...
                            <div class="bg-black/40 p-2.5 rounded-lg border border-zinc-700/50 mb-2">
                                ...
                                <p class="text-xs font-mono text-zinc-600 mt-1">${bs}</p>
                            </div>
                    ...
                    <div class="flex gap-3 items-start relative">
                        ...
                        <div class="flex-1 pb-2">
                            ...
                            <div class="grid grid-cols-4 gap-2">
                                <a href="https://twitter.com/intent/tweet?text=${encodeURIComponent(n+" "+bs)}" target="_blank" 
    ...
    `}function q0(){var o;const e=A.platformUsageConfig||oc,t=A.platformUsage||{};let n=0,a=0;Object.keys(e).forEach(i=>{var l;e[i].enabled!==!1&&e[i].maxCount&&(n+=e[i].maxCount,a+=Math.min(((l=t[i])==null?void 0:l.count)||0,e[i].maxCount))});const s=n>0?a/n*100:0,r=((o=A.user)==null?void 0:o.platformUsagePoints)||0;return`
        <div class="space-y-4">
            <!-- Info Banner -->
            ...
            <div class="grid grid-cols-2 gap-2" id="platform-actions-grid">
                ${Object.entries(e).filter(([i,l])=>l.enabled!==!1).map(([i,l])=>{const d=t[i]||{count:0},u=d.count>=l.maxCount,f=Math.max(0,l.maxCount-d.count),m=d.count/l.maxCount*100,b=H0[i]||"";return`
    ...
    `}function X0(){const e=A.dailyTasks||[],t=e.filter(a=>a.eligible),n=e.filter(a=>!a.eligible&&a.timeLeftMs>0);return`
        <div class="space-y-4">
            <!-- Info Banner -->
                        ...
                        ${n.map(a=>`
                            <div class="bg-zinc-900/80 border border-zinc-800 rounded-xl p-3 opacity-50">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-zinc-600 text-xs">${U0(a.timeLeftMs)}</span>
                                </div>
                            </div>
                        `).join("")}
                    </div>
    ...
    `}function J0(){const{user:e,userSubmissions:t}=A;if(!A.isConnected)return`
            <div class="text-center px-4 py-12 airdrop-fade-up">
        ...
        `;const n=Date.now(),a=rc*60*60*1e3,s=t.filter(l=>["pending","auditing"].includes(l.status)&&l.submittedAt&&n-l.submittedAt.getTime()>=a),r=(e==null?void 0:e.approvedSubmissionsCount)||0,o=t.filter(l=>["pending","auditing"].includes(l.status)).length,i=t.filter(l=>l.status==="rejected").length;return`
        <div class="px-4 space-y-4 airdrop-fade-up">
            ...
            <div class="grid grid-cols-3 gap-3">
                ...
                <div class="bg-zinc-900/80 border border-zinc-800 rounded-xl p-3 text-center">
                    <span class="text-2xl font-black text-red-400">${i}</span>
    ...
    `}function Z0(){var u,f;const e=((u=A.leaderboards)==null?void 0:u.top100ByPosts)||[],t=((f=A.leaderboards)==null?void 0:f.top100ByPoints)||[],n=A.activeRanking||"posts";function a(m,b,p){var z,E;const g=A.user&&((z=m.walletAddress)==null?void 0:z.toLowerCase())===((E=A.user.walletAddress)==null?void 0:E.toLowerCase()),y=Q0(b+1),k=p==="posts"?"bg-amber-500/10":"bg-green-500/10",T=p==="posts"?"text-amber-400":"text-green-400",I=p==="posts"?"text-white":"text-green-400",N=p==="posts"?"posts":"pts";return`
    ...
    `}function Q0(e){return e<=5?{icon:"💎",bg:"bg-cyan-500/20 text-cyan-300",tierName:"Diamond",tierTextColor:"text-cyan-400/70"}:e<=25?{icon:"🥇",bg:"bg-yellow-500/20 text-yellow-400",tierName:"Gold",tierTextColor:"text-yellow-400/70"}:e<=75?{icon:"🥈",bg:"bg-gray-400/20 text-gray-300",tierName:"Silver",tierTextColor:"text-gray-400/70"}:e<=200?{icon:"🥉",bg:"bg-amber-600/20 text-amber-500",tierName:"Bronze",tierTextColor:"text-amber-500/70"}:{icon:null,bg:"bg-zinc-800 text-zinc-400",tierName:null,tierTextColor:""}}function $e(){const e=document.getElementById("main-content"),t=document.getElementById("airdrop-header");if(e){if(t&&(t.innerHTML=ic()),A.isBanned){e.innerHTML=`
        ...
        `;return}switch(document.querySelectorAll(".nav-pill-btn").forEach(n=>{const a=n.dataset.target;n.closest(".md\\:hidden")?a===A.activeTab?(n.classList.add("airdrop-tab-active","shadow-lg"),n.classList.remove("text-zinc-500")):(n.classList.remove("airdrop-tab-active","shadow-lg"),n.classList.add("text-zinc-500")):a===A.activeTab?(n.classList.remove("text-zinc-400","hover:text-white","hover:bg-zinc-800"),n.classList.add("airdrop-tab-active","shadow-lg","shadow-amber-500/20")):(n.classList.add("text-zinc-400","hover:text-white","hover:bg-zinc-800"),n.classList.remove("airdrop-tab-active","shadow-lg","shadow-amber-500/20"))}),A.activeTab){case"earn":e.innerHTML=Va();break;case"post":e.innerHTML=Va();break;case"history":e.innerHTML=J0();break;case"leaderboard":e.innerHTML=Z0();break;default:e.innerHTML=Va()}}}function em(){var n;const e=((n=A.user)==null?void 0:n.referralCode)||"CODE",t=`${e!=="CODE"?`https://backcoin.org/?ref=${e}`:"https://backcoin.org"} ${bs}`;navigator.clipboard.writeText(t).then(()=>{x("Copied! Now paste it in your post.","success");const a=document.getElementById("copy-viral-btn");if(a){const s=a.innerHTML;a.innerHTML='<i class="fa-solid fa-check"></i> Copied!',a.classList.remove("cta-mega"),a.classList.add("bg-green-600"),setTimeout(()=>{a.innerHTML=s,a.classList.add("cta-mega"),a.classList.remove("bg-green-600")},2e3)}}).catch(()=>x("Failed to copy.","error"))}function ro(e){const t=e.target.closest(".nav-pill-btn");t&&(A.activeTab=t.dataset.target,$e())}function tm(e){const t=e.target.closest(".earn-tab-btn");t&&t.dataset.earnTab&&(A.activeEarnTab=t.dataset.earnTab,$e())}function nm(e){const t=e.target.closest(".ranking-tab-btn");t&&t.dataset.ranking&&(A.activeRanking=t.dataset.ranking,$e())}function am(){A.isGuideOpen=!A.isGuideOpen,$e()}function lc(e){var s;const t=`
        <div class="text-center">
            <!-- Imagem de CAUTION -->
    ...
    `;vn(t,"max-w-md"),(s=document.getElementById("deletePostBtn"))==null||s.addEventListener("click",async r=>{const o=r.currentTarget,i=o.dataset.submissionId;o.disabled=!0,o.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-1"></i> Deleting...';try{await $o(i),x("Post deleted. No penalty applied.","info"),we(),await en(),$e()}catch(l){x(l.message,"error"),o.disabled=!1,o.innerHTML='<i class="fa-solid fa-trash mr-1"></i> Delete Post'}});const n=document.getElementById("confirmCheckbox"),a=document.getElementById("finalConfirmBtn");n==null||n.addEventListener("change",()=>{n.checked?(a.disabled=!1,a.className="flex-1 bg-green-600 hover:bg-green-500 text-white py-3 rounded-xl font-bold text-sm transition-colors cursor-pointer",a.innerHTML='<i class="fa-solid fa-check mr-1"></i> Confirm & Earn ✓'):(a.disabled=!0,a.className="flex-1 bg-green-600/50 text-green-200 py-3 rounded-xl font-bold text-sm cursor-not-allowed transition-colors",a.innerHTML='<i class="fa-solid fa-lock mr-1"></i> Confirm & Earn')}),a==null||a.addEventListener("click",sm)}async function sm(e){const t=e.currentTarget,n=t.dataset.submissionId;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-2"></i> Verifying...';try{await Hd(n),x("Success! Points added.","success"),we(),await en(),$e()}catch{x("Verification failed.","error"),t.disabled=!1,t.innerHTML="Try Again"}}async function rm(e){const t=e.target.closest(".action-btn");if(!t)return;const n=t.dataset.action,a=t.dataset.id;if(n==="confirm"){const s=A.userSubmissions.find(r=>r.submissionId===a);s&&lc(s)}else if(n==="delete"){if(!confirm("Remove this submission?"))return;try{await $o(a),x("Removed.","info"),await en(),$e()}catch(s){x(s.message,"error")}}}async function om(e){const t=e.target.closest("#submit-content-btn");if(!t)return;const n=document.getElementById("content-url-input"),a=n==null?void 0:n.value.trim();if(!a||!a.startsWith("http"))return x("Enter a valid URL.","warning");const s=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-circle-notch fa-spin"></i>';try{await Dd(a),x("📋 Submitted! Your post is now under security audit.","info"),n.value="",await en(),A.activeTab="history",$e()}catch(r){x(r.message,"error")}finally{t.disabled=!1,t.innerHTML=s}}async function im(e){const t=e.target.closest(".task-card");if(!t)return;const n=t.dataset.id,a=t.dataset.url;a&&window.open(a,"_blank");const s=A.dailyTasks.find(r=>r.id===n);if(!(!s||!s.eligible))try{await Fd(s,A.user.pointsMultiplier),x(`Task completed! +${s.points} pts`,"success"),await en(),$e()}catch(r){r.message.includes("Cooldown")||x(r.message,"error")}}function lm(){const e=Date.now(),t=rc*60*60*1e3,n=A.userSubmissions.filter(a=>["pending","auditing"].includes(a.status)&&a.submittedAt&&e-a.submittedAt.getTime()>=t);n.length>0&&(A.activeTab="history",$e(),setTimeout(()=>{lc(n[0])},500))}const cm={async render(e){const t=document.getElementById("airdrop");if(!t)return;G0();const n=j0();(t.innerHTML.trim()===""||e)&&(t.innerHTML=`
            ...
            `,this.attachListeners());try{const a=new Promise(i=>setTimeout(i,4e3));await Promise.all([en(),a]);const s=document.getElementById("loading-state"),r=document.getElementById("airdrop-main"),o=document.getElementById("main-content");s&&(s.style.transition="opacity 0.5s ease-out",s.style.opacity="0",await new Promise(i=>setTimeout(i,500)),s.classList.add("hidden")),r&&r.classList.remove("hidden"),o&&(o.classList.remove("hidden"),$e()),lm()}catch(a){console.error(a)}},attachListeners(){const e=document.getElementById("airdrop-body"),t=document.getElementById("airdrop-header");t==null||t.addEventListener("click",ro),e==null||e.addEventListener("click",n=>{n.target.closest("#guide-toggle-btn")&&am(),n.target.closest("#submit-content-btn")&&om(n),n.target.closest(".task-card")&&im(n),n.target.closest(".action-btn")&&rm(n),n.target.closest("#copy-viral-btn")&&em(),n.target.closest(".ranking-tab-btn")&&nm(n),n.target.closest(".earn-tab-btn")&&tm(n),n.target.closest(".nav-pill-btn")&&ro(n);const a=n.target.closest(".platform-action-card");if(a&&!a.classList.contains("completed")){const s=a.dataset.targetPage;s&&(console.log("🎯 Navigating to:",s),dm(s))}})},update(e){A.isConnected!==e&&this.render(!0)}};function dm(e){console.log("🎯 Platform card clicked, navigating to:",e);const t=document.querySelector(`a[data-target="${e}"]`)||document.querySelector(`[data-target="${e}"]`);if(t){console.log("✅ Found menu link, clicking..."),t.click();const s=document.getElementById("sidebar");s&&window.innerWidth<768&&s.classList.add("hidden");return}const n=document.querySelectorAll("main > section"),a=document.getElementById(e);if(a){console.log("✅ Found section, showing directly..."),n.forEach(r=>r.classList.add("hidden")),a.classList.remove("hidden"),document.querySelectorAll(".sidebar-link").forEach(r=>{r.classList.remove("active","bg-zinc-700","text-white"),r.classList.add("text-zinc-400")});const s=document.querySelector(`[data-target="${e}"]`);s&&(s.classList.add("active","bg-zinc-700","text-white"),s.classList.remove("text-zinc-400"));return}console.warn("⚠️ Could not navigate to:",e)}const cc=window.ethers,la="".toLowerCase(),um="",dc="bkc_admin_auth_v3";window.__ADMIN_WALLET__=la;setTimeout(()=>{document.dispatchEvent(new CustomEvent("adminConfigReady")),console.log("✅ Admin config ready, wallet:",la?"configured":"not set")},100);function oo(){return sessionStorage.getItem(dc)==="true"}function pm(){sessionStorage.setItem(dc,"true")}function mm(){return!c.isConnected||!c.userAddress||!la?!1:c.userAddress.toLowerCase()===la}const io={pending:{text:"Pending Review",color:"text-amber-400",bgColor:"bg-amber-900/50",icon:"fa-clock"},auditing:{text:"Auditing",color:"text-blue-400",bgColor:"bg-blue-900/50",icon:"fa-magnifying-glass"},approved:{text:"Approved",color:"text-green-400",bgColor:"bg-green-900/50",icon:"fa-check-circle"},rejected:{text:"Rejected",color:"text-red-400",bgColor:"bg-red-900/50",icon:"fa-times-circle"},flagged_suspicious:{text:"Flagged",color:"text-red-300",bgColor:"bg-red-800/60",icon:"fa-flag"}},Ia={faucet:{icon:"🚰",label:"Claim Faucet",points:1e3,maxCount:1,cooldownHours:0,enabled:!0},delegation:{icon:"📊",label:"Delegate BKC",points:2e3,maxCount:10,cooldownHours:24,enabled:!0},fortune:{icon:"🎰",label:"Play Fortune",points:1500,maxCount:10,cooldownHours:1,enabled:!0},buyNFT:{icon:"🛒",label:"Buy NFT",points:2500,maxCount:10,cooldownHours:0,enabled:!0},sellNFT:{icon:"💰",label:"Sell NFT",points:1500,maxCount:10,cooldownHours:0,enabled:!0},listRental:{icon:"🏷️",label:"List for Rent",points:1e3,maxCount:10,cooldownHours:0,enabled:!0},rentNFT:{icon:"⏰",label:"Rent NFT",points:2e3,maxCount:10,cooldownHours:0,enabled:!0},notarize:{icon:"📜",label:"Notarize Doc",points:2e3,maxCount:10,cooldownHours:0,enabled:!0},claimReward:{icon:"💸",label:"Claim Rewards",points:1e3,maxCount:10,cooldownHours:24,enabled:!0},unstake:{icon:"↩️",label:"Unstake",points:500,maxCount:10,cooldownHours:0,enabled:!0}};let C={allSubmissions:[],dailyTasks:[],ugcBasePoints:null,platformUsageConfig:null,editingTask:null,activeTab:"review-submissions",allUsers:[],selectedUserSubmissions:[],isSubmissionsModalOpen:!1,selectedWallet:null,usersFilter:"all",usersSearch:"",usersPage:1,usersPerPage:100,submissionsPage:1,submissionsPerPage:100,tasksPage:1,tasksPerPage:100};const gn=async()=>{var t;const e=document.getElementById("admin-content-wrapper");if(e){const n=document.createElement("div");e.innerHTML=n.innerHTML}try{c.userAddress&&(await So(c.userAddress),console.log("✅ Firebase Auth: Admin authenticated"));const[n,a,s,r]=await Promise.all([Kd(),jd(),As(),Yd()]);C.allSubmissions=n,C.dailyTasks=a,C.allUsers=r,C.ugcBasePoints=((t=s.config)==null?void 0:t.ugcBasePoints)||{YouTube:5e3,"YouTube Shorts":2500,Instagram:3e3,"X/Twitter":1500,Facebook:2e3,Telegram:1e3,TikTok:3500,Reddit:1800,LinkedIn:2200,Other:1e3},C.platformUsageConfig=s.platformUsageConfig||Ia,C.editingTask&&(C.editingTask=a.find(o=>o.id===C.editingTask.id)||null),$m()}catch(n){if(console.error("Error loading admin data:",n),e){const a=document.createElement("div");fu(a,`Failed to load admin data: ${n.message}`),e.innerHTML=a.innerHTML}else x("Failed to load admin data.","error")}},ar=async()=>{const e=document.getElementById("presale-balance-amount");if(e){e.innerHTML='<span class="loader !w-5 !h-5 inline-block"></span>';try{if(!c.signer||!c.signer.provider)throw new Error("Admin provider not found.");if(!w.publicSale)throw new Error("PublicSale address not configured.");const t=await c.signer.provider.getBalance(w.publicSale),n=cc.formatEther(t);e.textContent=`${parseFloat(n).toFixed(6)} ETH/BNB`}catch(t){console.error("Error loading presale balance:",t),e.textContent="Error"}}},fm=async e=>{if(!c.signer){x("Por favor, conecte a carteira do Owner primeiro.","error");return}if(!window.confirm("Are you sure you want to withdraw ALL funds from the Presale contract to the Treasury wallet?"))return;const t=["function withdrawFunds() external"],n=w.publicSale,a=new cc.Contract(n,t,c.signer),s=e.innerHTML;e.disabled=!0,e.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i> Withdrawing...';try{console.log(`Calling withdrawFunds() on ${n}...`);const r=await a.withdrawFunds();x("Transaction sent. Awaiting confirmation...","info");const o=await r.wait();console.log("Funds withdrawn successfully!",o.hash),x("Funds withdrawn successfully!","success",o.hash),ar()}catch(r){console.error("Error withdrawing funds:",r);const o=r.reason||r.message||"Transaction failed.";x(`Error: ${o}`,"error")}finally{e.disabled=!1,e.innerHTML=s}},bm=async e=>{const t=e.target.closest("button[data-action]");if(!t||t.disabled)return;const n=t.dataset.action,a=t.dataset.submissionId,s=t.dataset.userId;if(!n||!a||!s){console.warn("Missing data attributes for admin action:",t.dataset);return}const r=t.closest("tr"),o=t.closest("td").querySelectorAll("button");r?(r.style.opacity="0.5",r.style.pointerEvents="none"):o.forEach(i=>i.disabled=!0);try{(n==="approved"||n==="rejected")&&(await _o(s,a,n),x(`Submission ${n==="approved"?"APPROVED":"REJECTED"}!`,"success"),C.allSubmissions=C.allSubmissions.filter(i=>i.submissionId!==a),ca())}catch(i){x(`Failed to ${n} submission: ${i.message}`,"error"),console.error(i),r&&(r.style.opacity="1",r.style.pointerEvents="auto")}},gm=async e=>{const t=e.target.closest(".ban-user-btn");if(!t||t.disabled)return;const n=t.dataset.userId,a=t.dataset.action==="ban";if(!n)return;const s=a?`Are you sure you want to PERMANENTLY BAN this user?
(This is reversible)`:`Are you sure you want to UNBAN this user?
(This will reset their rejection count to 0)`;if(!window.confirm(s))return;const r=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await Fo(n,a),x(`User ${a?"BANNED":"UNBANNED"}.`,"success");const o=C.allUsers.findIndex(i=>i.id===n);o>-1&&(C.allUsers[o].isBanned=a,C.allUsers[o].hasPendingAppeal=!1,a===!1&&(C.allUsers[o].rejectedCount=0)),dt()}catch(o){x(`Failed: ${o.message}`,"error"),t.disabled=!1,t.innerHTML=r}},xm=async e=>{const t=e.target.closest(".resolve-appeal-btn");if(!t||t.disabled)return;const n=t.dataset.userId,s=t.dataset.action==="approve";if(!n)return;const r=s?"Are you sure you want to APPROVE this appeal and UNBAN the user?":"Are you sure you want to DENY this appeal? The user will remain banned.";if(!window.confirm(r))return;const o=t.closest("td").querySelectorAll("button"),i=new Map;o.forEach(l=>{i.set(l,l.innerHTML),l.disabled=!0,l.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>'});try{s&&await Fo(n,!1),x(`Appeal ${s?"APPROVED":"DENIED"}.`,"success");const l=C.allUsers.findIndex(d=>d.id===n);l>-1&&(C.allUsers[l].hasPendingAppeal=!1,s&&(C.allUsers[l].isBanned=!1,C.allUsers[l].rejectedCount=0)),dt()}catch(l){x(`Failed: ${l.message}`,"error"),o.forEach(d=>{d.disabled=!1,d.innerHTML=i.get(d)})}},hm=async e=>{const t=e.target.closest(".re-approve-btn");if(!t||t.disabled)return;const n=t.dataset.submissionId,a=t.dataset.userId;if(!n||!a)return;const s=t.closest("tr");s&&(s.style.opacity="0.5"),t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await _o(a,n,"approved"),x("Submission re-approved!","success"),C.selectedUserSubmissions=C.selectedUserSubmissions.filter(o=>o.submissionId!==n),s&&s.remove();const r=C.allUsers.findIndex(o=>o.id===a);if(r>-1){const o=C.allUsers[r];o.rejectedCount=Math.max(0,(o.rejectedCount||0)-1),dt()}if(C.selectedUserSubmissions.length===0){const o=document.querySelector("#admin-user-modal .p-6");o&&(o.innerHTML='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>')}}catch(r){x(`Failed to re-approve: ${r.message}`,"error"),s&&(s.style.opacity="1"),t.disabled=!1,t.innerHTML='<i class="fa-solid fa-check"></i> Re-Approve'}},vm=async e=>{const t=e.target.closest(".view-rejected-btn");if(!t||t.disabled)return;const n=t.dataset.userId,a=t.dataset.wallet;if(n){C.selectedWallet=a,C.isSubmissionsModalOpen=!0,qa(!0,[]);try{const s=await Vd(n,"rejected");C.selectedUserSubmissions=s,qa(!1,s)}catch(s){x(`Error fetching user submissions: ${s.message}`,"error"),qa(!1,[],!0)}}},wm=()=>{C.isSubmissionsModalOpen=!1,C.selectedUserSubmissions=[],C.selectedWallet=null;const e=document.getElementById("admin-user-modal");e&&e.remove(),document.body.style.overflow="auto"},ym=e=>{const t=e.target.closest(".user-profile-link");if(!t)return;e.preventDefault();const n=t.dataset.userId;if(!n)return;const a=C.allUsers.find(s=>s.id===n);if(!a){x("Error: Could not find user data.","error");return}Am(a)},km=()=>{const e=document.getElementById("admin-user-profile-modal");e&&e.remove(),document.body.style.overflow="auto"},Em=async e=>{e.preventDefault();const t=e.target;let n,a;try{if(n=new Date(t.startDate.value+"T00:00:00Z"),a=new Date(t.endDate.value+"T23:59:59Z"),isNaN(n.getTime())||isNaN(a.getTime()))throw new Error("Invalid date format.");if(n>=a)throw new Error("Start Date must be before End Date.")}catch(l){x(l.message,"error");return}const s={title:t.title.value.trim(),url:t.url.value.trim(),description:t.description.value.trim(),points:parseInt(t.points.value,10),cooldownHours:parseInt(t.cooldown.value,10),startDate:n,endDate:a};if(!s.title||!s.description){x("Please fill in Title and Description.","error");return}if(s.points<=0||s.cooldownHours<=0){x("Points and Cooldown must be positive numbers.","error");return}if(s.url&&!s.url.startsWith("http")){x("URL must start with http:// or https://","error");return}C.editingTask&&C.editingTask.id&&(s.id=C.editingTask.id);const r=t.querySelector('button[type="submit"]'),o=r.innerHTML;r.disabled=!0;const i=document.createElement("span");i.classList.add("inline-block"),r.innerHTML="",r.appendChild(i);try{await Wd(s),x(`Task ${s.id?"updated":"created"} successfully!`,"success"),t.reset(),C.editingTask=null,gn()}catch(l){x(`Failed to save task: ${l.message}`,"error"),console.error(l),r.disabled=!1,r.innerHTML=o}},Tm=async e=>{e.preventDefault();const t=e.target,n={YouTube:parseInt(t.youtubePoints.value,10),"YouTube Shorts":parseInt(t.youtubeShortsPoints.value,10),Instagram:parseInt(t.instagramPoints.value,10),"X/Twitter":parseInt(t.xTwitterPoints.value,10),Facebook:parseInt(t.facebookPoints.value,10),Telegram:parseInt(t.telegramPoints.value,10),TikTok:parseInt(t.tiktokPoints.value,10),Reddit:parseInt(t.redditPoints.value,10),LinkedIn:parseInt(t.linkedinPoints.value,10),Other:parseInt(t.otherPoints.value,10)};if(Object.values(n).some(o=>isNaN(o)||o<0)){x("All points must be positive numbers (or 0).","error");return}const a=t.querySelector('button[type="submit"]'),s=a.innerHTML;a.disabled=!0;const r=document.createElement("span");r.classList.add("inline-block"),a.innerHTML="",a.appendChild(r);try{await Ud(n),x("UGC Base Points updated successfully!","success"),C.ugcBasePoints=n}catch(o){x(`Failed to update points: ${o.message}`,"error"),console.error(o)}finally{document.body.contains(a)&&(a.disabled=!1,a.innerHTML=s)}},Cm=e=>{const t=C.dailyTasks.find(n=>n.id===e);t&&(C.editingTask=t,Bn())},Im=async e=>{if(window.confirm("Are you sure you want to delete this task permanently?"))try{await Gd(e),x("Task deleted.","success"),C.editingTask=null,gn()}catch(t){x(`Failed to delete task: ${t.message}`,"error"),console.error(t)}};function qa(e,t,n=!1){var o,i;const a=document.getElementById("admin-user-modal");a&&a.remove(),document.body.style.overflow="hidden";let s="";e?s='<div class="p-8"></div>':n?s='<p class="text-red-400 text-center p-8">Failed to load submissions.</p>':t.length===0?s='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>':s=`
     ...
     `;document.body.insertAdjacentHTML("beforeend",r),e&&document.getElementById("admin-user-modal").querySelector(".p-8"),(o=document.getElementById("close-admin-modal-btn"))==null||o.addEventListener("click",wm),(i=document.getElementById("modal-submissions-tbody"))==null||i.addEventListener("click",hm)}function Am(e){var s;const t=document.getElementById("admin-user-profile-modal");t&&t.remove(),document.body.style.overflow="hidden";const n=e.isBanned?'<span class="text-xs font-bold py-1 px-3 rounded-full bg-red-600 text-white">BANNED</span>':e.hasPendingAppeal?'<span class="text-xs font-bold py-1 px-3 rounded-full bg-yellow-600 text-white">APPEALING</span>':'<span class="text-xs font-bold py-1 px-3 rounded-full bg-green-600 text-white">ACTIVE</span>',a=`
     ...
     `;document.body.insertAdjacentHTML("beforeend",a),(s=document.getElementById("close-admin-profile-modal-btn"))==null||s.addEventListener("click",km)}const Bm=e=>{const t=e.target.closest(".user-filter-btn");!t||t.classList.contains("active")||(C.usersFilter=t.dataset.filter||"all",C.usersPage=1,dt())},Pm=e=>{C.usersSearch=e.target.value,C.usersPage=1,dt()},Nm=e=>{C.usersPage=e,dt()},zm=e=>{C.submissionsPage=e,ca()},Lm=e=>{C.tasksPage=e,Bn()},dt=()=>{var N,z;const e=document.getElementById("manage-users-content");if(!e)return;const t=C.allUsers;if(!t)return;const a=(C.usersSearch||"").toLowerCase().trim().replace(/[^a-z0-9x]/g,""),s=C.usersFilter;let r=t;a&&(r=r.filter(E=>{var F,G;return((F=E.walletAddress)==null?void 0:F.toLowerCase().includes(a))||((G=E.id)==null?void 0:G.toLowerCase().includes(a))})),s==="banned"?r=r.filter(E=>E.isBanned):s==="appealing"&&(r=r.filter(E=>E.hasPendingAppeal===!0));const o=t.length,i=t.filter(E=>E.isBanned).length,l=t.filter(E=>E.hasPendingAppeal===!0).length,d=r.sort((E,F)=>E.hasPendingAppeal!==F.hasPendingAppeal?E.hasPendingAppeal?-1:1:E.isBanned!==F.isBanned?E.isBanned?-1:1:(F.totalPoints||0)-(E.totalPoints||0)),u=C.usersPage,f=C.usersPerPage,m=d.length,b=Math.ceil(m/f),p=(u-1)*f,g=u*f,y=d.slice(p,g),k=y.length>0?y.map(E=>{let F="border-b border-border-color hover:bg-zinc-800/50",G="";return E.hasPendingAppeal?(F+=" bg-yellow-900/40",G='<span class="ml-2 text-xs font-bold text-yellow-300">[APPEALING]</span>'):E.isBanned&&(F+=" bg-red-900/30 opacity-70",G='<span class="ml-2 text-xs font-bold text-red-400">[BANNED]</span>'),`
        <tr class="${F}">
    ...
    `;const T=document.getElementById("admin-users-pagination");T&&b>1&&Ps(T,C.usersPage,b,Nm),(N=document.getElementById("admin-users-tbody"))==null||N.addEventListener("click",E=>{E.target.closest(".user-profile-link")&&ym(E),E.target.closest(".ban-user-btn")&&gm(E),E.target.closest(".view-rejected-btn")&&vm(E),E.target.closest(".resolve-appeal-btn")&&xm(E)}),(z=document.getElementById("user-filters-nav"))==null||z.addEventListener("click",Bm);const I=document.getElementById("user-search-input");if(I){let E;I.addEventListener("keyup",F=>{clearTimeout(E),E=setTimeout(()=>Pm(F),300)})}},lo=()=>{var a;const e=document.getElementById("manage-ugc-points-content");if(!e)return;const t=C.ugcBasePoints;if(!t)return;const n={YouTube:5e3,"YouTube Shorts":2500,Instagram:3e3,"X/Twitter":1500,Facebook:2e3,Telegram:1e3,TikTok:3500,Reddit:1800,LinkedIn:2200,Other:1e3};e.innerHTML=`
    ...
    `,(a=document.getElementById("ugcPointsForm"))==null||a.addEventListener("submit",Tm)},Bn=()=>{var p,g,y;const e=document.getElementById("manage-tasks-content");if(!e)return;const t=C.editingTask,n=!!t,a=k=>{if(!k)return"";try{return(k.toDate?k.toDate():k instanceof Date?k:new Date(k)).toISOString().split("T")[0]}catch{return""}},s=C.tasksPage,r=C.tasksPerPage,o=[...C.dailyTasks].sort((k,T)=>{var z,E;const I=(z=k.startDate)!=null&&z.toDate?k.startDate.toDate():new Date(k.startDate||0);return((E=T.startDate)!=null&&E.toDate?T.startDate.toDate():new Date(T.startDate||0)).getTime()-I.getTime()}),i=o.length,l=Math.ceil(i/r),d=(s-1)*r,u=s*r,f=o.slice(d,u),m=f.length>0?f.map(k=>{var E,F;const T=new Date,I=(E=k.startDate)!=null&&E.toDate?k.startDate.toDate():k.startDate?new Date(k.startDate):null,N=(F=k.endDate)!=null&&F.toDate?k.endDate.toDate():k.endDate?new Date(k.endDate):null;let z="text-zinc-500";return I&&N&&(T>=I&&T<=N?z="text-green-400":T<I&&(z="text-blue-400")),`
    ...
    `}).join(""):document.createElement("div").innerHTML;e.innerHTML=`
        ...
        <h3 class="text-xl font-bold mt-10 mb-4 border-t border-border-color pt-6">Existing Tasks (${i})</h3>
        <div id="existing-tasks-list" class="space-y-3">
            ${m}
        </div>
        <div id="admin-tasks-pagination" class="mt-6"></div>
    `;const b=document.getElementById("admin-tasks-pagination");b&&l>1&&Ps(b,C.tasksPage,l,Lm),(p=document.getElementById("taskForm"))==null||p.addEventListener("submit",Em),(g=document.getElementById("cancelEditBtn"))==null||g.addEventListener("click",()=>{C.editingTask=null,Bn()}),(y=document.getElementById("existing-tasks-list"))==null||y.addEventListener("click",k=>{const T=k.target.closest("button[data-id]");if(!T)return;const I=T.dataset.id;T.dataset.action==="edit"&&Cm(I),T.dataset.action==="delete"&&Im(I)})},ca=()=>{var f;const e=document.getElementById("submissions-content");if(!e)return;if(!C.allSubmissions||C.allSubmissions.length===0){const m=document.createElement("div");e.innerHTML=m.innerHTML;return}const t=C.submissionsPage,n=C.submissionsPerPage,a=[...C.allSubmissions].sort((m,b)=>{var p,g;return(((p=b.submittedAt)==null?void 0:p.getTime())||0)-(((g=m.submittedAt)==null?void 0:g.getTime())||0)}),s=a.length,r=Math.ceil(s/n),o=(t-1)*n,i=t*n,d=a.slice(o,i).map(m=>{var b,p;return`
        <tr class="border-b border-border-color hover:bg-zinc-800/50">
            <td class="p-3 text-xs text-zinc-400 font-mono" title="${m.userId}">${qt(m.walletAddress)}</td>
            ...
            <td class="p-3 text-xs font-semibold ${((b=io[m.status])==null?void 0:b.color)||"text-gray-500"}">${((p=io[m.status])==null?void 0:p.text)||m.status}</td>
            <td class="p-3 text-right">
                <div class="flex items-center justify-end gap-2">
    ...
    `;const u=document.getElementById("admin-submissions-pagination");u&&r>1&&Ps(u,C.submissionsPage,r,zm),(f=document.getElementById("admin-submissions-tbody"))==null||f.addEventListener("click",bm)},da=()=>{var r,o;const e=document.getElementById("platform-usage-content");if(!e)return;const t=C.platformUsageConfig||Ia;let n=0;Object.values(t).forEach(i=>{i.enabled!==!1&&(n+=(i.points||0)*(i.maxCount||1))});const a=Object.entries(t).map(([i,l])=>`
        <tr class="border-b border-zinc-700/50 hover:bg-zinc-800/50" data-action-key="${i}">
            <td class="p-3">
                <div class="flex items-center gap-2">
                    <span class="text-xl">${l.icon||"⚡"}</span>
                    <span class="text-white font-medium">${l.label||i}</span>
                </div>
            </td>
            <td class="p-3">
    ...
    `).join("");e.innerHTML=`
        ...
        <div class="grid grid-cols-3 gap-4 mb-6">
            ...
            <div class="bg-zinc-800 border border-zinc-700 rounded-xl p-4 text-center">
                <span class="text-2xl font-bold text-green-400">${Object.values(t).filter(i=>i.enabled!==!1).length}</span>
    ...
    `;const s=document.getElementById("platform-usage-tbody");s==null||s.addEventListener("input",co),s==null||s.addEventListener("change",co),(r=document.getElementById("save-platform-config-btn"))==null||r.addEventListener("click",Sm),(o=document.getElementById("reset-platform-config-btn"))==null||o.addEventListener("click",Rm)},co=e=>{const t=e.target;if(!t.classList.contains("platform-input")&&!t.classList.contains("platform-toggle"))return;const n=t.closest("tr"),a=n==null?void 0:n.dataset.actionKey,s=t.dataset.field;if(!a||!s)return;C.platformUsageConfig[a]||(C.platformUsageConfig[a]={...Ia[a]}),s==="enabled"?C.platformUsageConfig[a].enabled=t.checked:C.platformUsageConfig[a][s]=parseInt(t.value)||0;const r=C.platformUsageConfig[a],o=n.querySelector("td:last-child");o&&(o.textContent=((r.points||0)*(r.maxCount||1)).toLocaleString())},Sm=async e=>{const t=e.target.closest("button");if(!t)return;const n=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Saving...';try{await Mo(C.platformUsageConfig),x("✅ Platform Usage config saved!","success"),da()}catch(a){console.error("Error saving platform config:",a),x("Failed to save config: "+a.message,"error")}finally{t.disabled=!1,t.innerHTML=n}},Rm=async()=>{if(confirm("Are you sure you want to reset to default values? This will save immediately."))try{C.platformUsageConfig={...Ia},await Mo(C.platformUsageConfig),x("✅ Config reset to defaults!","success"),da()}catch(e){console.error("Error resetting platform config:",e),x("Failed to reset config: "+e.message,"error")}},$m=()=>{var n;const e=document.getElementById("admin-content-wrapper");if(!e)return;e.innerHTML=`
    ...
    `,(n=document.getElementById("withdraw-presale-funds-btn"))==null||n.addEventListener("click",a=>fm(a.target)),ar(),C.activeTab==="manage-ugc-points"?lo():C.activeTab==="manage-tasks"?Bn():C.activeTab==="review-submissions"?ca():C.activeTab==="manage-users"?dt():C.activeTab==="platform-usage"&&da();const t=document.getElementById("admin-tabs");t&&!t._listenerAttached&&(t.addEventListener("click",a=>{const s=a.target.closest(".tab-btn");if(!s||s.classList.contains("active"))return;const r=s.dataset.target;C.activeTab=r,r!=="manage-users"&&(C.usersPage=1,C.usersFilter="all",C.usersSearch=""),r!=="review-submissions"&&(C.submissionsPage=1),r!=="manage-tasks"&&(C.tasksPage=1),document.querySelectorAll("#admin-tabs .tab-btn").forEach(i=>i.classList.remove("active")),s.classList.add("active"),e.querySelectorAll(".tab-content").forEach(i=>i.classList.remove("active"));const o=document.getElementById(r.replace(/-/g,"_")+"_tab");o?(o.classList.add("active"),r==="manage-ugc-points"&&lo(),r==="manage-tasks"&&Bn(),r==="review-submissions"&&ca(),r==="manage-users"&&dt(),r==="platform-usage"&&da()):console.warn(`Tab content container not found for target: ${r}`)}),t._listenerAttached=!0)},_m={render(){const e=document.getElementById("admin");if(e){if(!mm()){e.innerHTML='<div class="text-center text-red-400 p-8 bg-sidebar border border-red-500/50 rounded-lg">Access Denied. This page is restricted to administrators.</div>';return}if(oo()){e.innerHTML='<div id="admin-content-wrapper"></div>',gn();return}e.innerHTML=`
        ...
        `,document.getElementById("admin-login-btn").addEventListener("click",()=>{const t=document.getElementById("admin-key-input"),n=document.getElementById("admin-login-error");t.value===um?(pm(),x("✅ Admin access granted!","success"),e.innerHTML='<div id="admin-content-wrapper"></div>',gn()):(n.classList.remove("hidden"),t.value="",t.focus(),setTimeout(()=>n.classList.add("hidden"),3e3))}),setTimeout(()=>{var t;(t=document.getElementById("admin-key-input"))==null||t.focus()},100)}},refreshData(){const e=document.getElementById("admin");e&&!e.classList.contains("hidden")&&oo()&&(console.log("Refreshing Admin Page data..."),gn(),ar())}},Xa=2e8,uo={airdrop:{amount:7e7},liquidity:{amount:13e7}},Fm=()=>{if(document.getElementById("tokenomics-styles-v5"))return;const e=document.createElement("style");e.id="tokenomics-styles-v5",e.innerHTML=`
    ...
    `,document.head.appendChild(e)},xn=e=>e>=1e6?(e/1e6).toFixed(1)+"M":e>=1e3?(e/1e3).toFixed(0)+"K":e.toLocaleString();function Mm(){return`
    ...
    `}function Dm(){const e=c.totalSupply?_(c.totalSupply):4e7,t=(e/Xa*100).toFixed(1);return`
        <div class="tk-section tk-fade-up" style="animation-delay: 0.1s">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div class="tk-card text-center">
                    ...
                    <p class="text-xl font-black text-white">${xn(Xa)}</p>
            ...
            <p class="text-center text-zinc-600 text-[10px]">
                ...
                Remaining ${xn(Xa-e)} BKC to be mined through ecosystem activity
            </p>
        </div>
    `}function Om(){return`
                ...
                <div class="space-y-3">
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-500 text-[10px]">${xn(uo.airdrop.amount)} BKC</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-500 text-[10px]">${xn(uo.liquidity.amount)} BKC</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    `}function Ym(){const e=document.getElementById("tokenomics");e&&(Fm(),e.innerHTML=`
    ...
    `,e.scrollIntoView({behavior:"smooth",block:"start"}))}const Vm={render:Ym,init:()=>{},update:()=>{}},sr=window.ethers,qm=5*1024*1024,Xm="https://sepolia.arbiscan.io/tx/",po="https://gateway.pinata.cloud/ipfs/",Ke={image:{icon:"fa-regular fa-image",color:"text-emerald-400",bg:"bg-emerald-500/15",label:"Image"},pdf:{icon:"fa-regular fa-file-pdf",color:"text-red-400",bg:"bg-red-500/15",label:"PDF"},audio:{icon:"fa-solid fa-music",color:"text-purple-400",bg:"bg-purple-500/15",label:"Audio"},video:{icon:"fa-regular fa-file-video",color:"text-blue-400",bg:"bg-blue-500/15",label:"Video"},document:{icon:"fa-regular fa-file-word",color:"text-blue-400",bg:"bg-blue-500/15",label:"Document"},spreadsheet:{icon:"fa-regular fa-file-excel",color:"text-green-400",bg:"bg-green-500/15",label:"Spreadsheet"},code:{icon:"fa-solid fa-code",color:"text-cyan-400",bg:"bg-cyan-500/15",label:"Code"},archive:{icon:"fa-regular fa-file-zipper",color:"text-yellow-400",bg:"bg-yellow-500/15",label:"Archive"},default:{icon:"fa-regular fa-file",color:"text-amber-400",bg:"bg-amber-500/15",label:"File"}},O={step:1,file:null,description:"",hash:null,isProcessing:!1,certificates:[],lastFetch:0};function Jm(e){if(!e)return"";let t;if(typeof e=="number")t=new Date(e>1e12?e:e*1e3);else if(typeof e=="string")t=new Date(e);else if(e!=null&&e.toDate)t=e.toDate();else if(e!=null&&e.seconds)t=new Date(e.seconds*1e3);else return"";if(isNaN(t.getTime()))return"";const n=new Date,a=n-t,s=Math.floor(a/(1e3*60*60)),r=Math.floor(a/(1e3*60*60*24));if(s<1){const o=Math.floor(a/6e4);return o<1?"Just now":`${o}m ago`}return s<24?`${s}h ago`:r<7?`${r}d ago`:t.toLocaleDateString("en-US",{month:"short",day:"numeric",year:t.getFullYear()!==n.getFullYear()?"numeric":void 0})}function rr(e="",t=""){const n=e.toLowerCase(),a=t.toLowerCase();return n.includes("image")||/\.(jpg|jpeg|png|gif|webp|svg|bmp|ico)$/.test(a)?Ke.image:n.includes("pdf")||a.endsWith(".pdf")?Ke.pdf:n.includes("audio")||/\.(mp3|wav|ogg|flac|aac|m4a)$/.test(a)?Ke.audio:n.includes("video")||/\.(mp4|avi|mov|mkv|webm|wmv)$/.test(a)?Ke.video:n.includes("word")||n.includes("document")||/\.(doc|docx|odt|rtf)$/.test(a)?Ke.document:n.includes("sheet")||n.includes("excel")||/\.(xls|xlsx|csv|ods)$/.test(a)?Ke.spreadsheet:/\.(js|ts|py|java|cpp|c|h|html|css|json|xml|sol|rs|go|php|rb)$/.test(a)?Ke.code:n.includes("zip")||n.includes("archive")||/\.(zip|rar|7z|tar|gz)$/.test(a)?Ke.archive:Ke.default}function Zm(){if(document.getElementById("notary-styles-v6"))return;const e=document.createElement("style");e.id="notary-styles-v6",e.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(e)}function Qm(){const e=document.getElementById("notary");e&&(Zm(),e.innerHTML=`
        <div class="max-w-5xl mx-auto px-4 py-6">
    ...
    `,ua(),He(),or())}function ua(){const e=document.getElementById("status-badge"),t=document.getElementById("fee-amount"),n=document.getElementById("user-balance"),a=c.notaryFee||0n,s=c.currentUserBalance||0n;t&&(t.textContent=`${_(a)} BKC`),n&&(n.textContent=`${_(s)} BKC`,n.className=`font-mono font-bold ${s>=a?"text-emerald-400":"text-red-400"}`),e&&(c.isConnected?s>=a?(e.innerHTML=`
            ...
            `,e.className="flex items-center gap-2 px-4 py-2 rounded-full bg-zinc-800/50 text-sm"))}function ef(){[1,2,3].forEach(n=>{const a=document.getElementById(`step-${n}`);a&&(n<O.step?(a.className="step-dot done",a.innerHTML='<i class="fa-solid fa-check text-sm"></i>'):n===O.step?(a.className="step-dot active",a.textContent=n):(a.className="step-dot pending",a.textContent=n))});const e=document.getElementById("line-1"),t=document.getElementById("line-2");e&&(e.className=`step-line line-1 ${O.step>1?"done":""}`),t&&(t.className=`step-line line-2 ${O.step>2?"done":""}`)}function He(){const e=document.getElementById("action-panel");if(!e)return;if(ef(),!c.isConnected){e.innerHTML=`
        ...
        `;return}const t=c.notaryFee||sr.parseEther("1"),n=c.currentUserBalance||0n;if(n<t){e.innerHTML=`
            <div class="flex flex-col items-center justify-center h-full py-12">
        ...
        `;return}switch(O.step){case 1:tf(e);break;case 2:af(e);break;case 3:sf(e);break}}function tf(e){e.innerHTML=`
    ...
    `,nf()}function nf(){const e=document.getElementById("dropzone"),t=document.getElementById("file-input");!e||!t||(e.onclick=()=>t.click(),["dragenter","dragover","dragleave","drop"].forEach(n=>{e.addEventListener(n,a=>{a.preventDefault(),a.stopPropagation()})}),e.addEventListener("dragenter",()=>e.classList.add("drag-over")),e.addEventListener("dragover",()=>e.classList.add("drag-over")),e.addEventListener("dragleave",()=>e.classList.remove("drag-over")),e.addEventListener("drop",n=>{var a,s;e.classList.remove("drag-over"),mo((s=(a=n.dataTransfer)==null?void 0:a.files)==null?void 0:s[0])}),t.addEventListener("change",n=>{var a;return mo((a=n.target.files)==null?void 0:a[0])}))}function mo(e){if(e){if(e.size>qm){x("File too large (max 5MB)","error");return}O.file=e,O.step=2,He()}}function af(e){var s,r,o;const t=O.file,n=t?(t.size/1024).toFixed(1):"0",a=rr((t==null?void 0:t.type)||"",(t==null?void 0:t.name)||"");e.innerHTML=`
    ...
    `,(s=document.getElementById("btn-remove"))==null||s.addEventListener("click",()=>{O.file=null,O.description="",O.step=1,He()}),(r=document.getElementById("btn-back"))==null||r.addEventListener("click",()=>{O.step=1,He()}),(o=document.getElementById("btn-next"))==null||o.addEventListener("click",()=>{var i;O.description=((i=document.getElementById("desc-input"))==null?void 0:i.value)||"",O.step=3,He()})}function sf(e){var r,o;const t=O.file,n=O.description||"No description",a=c.notaryFee||sr.parseEther("1"),s=rr((t==null?void 0:t.type)||"",(t==null?void 0:t.name)||"");e.innerHTML=`
    ...
    `,(r=document.getElementById("btn-back"))==null||r.addEventListener("click",()=>{O.step=2,He()}),(o=document.getElementById("btn-mint"))==null||o.addEventListener("click",rf)}async function rf(){if(O.isProcessing)return;O.isProcessing=!0;const e=document.getElementById("btn-mint");e&&(e.disabled=!0,e.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Signing...');const t=document.getElementById("processing-overlay"),n=document.getElementById("process-status"),a=document.getElementById("process-bar"),s=document.getElementById("overlay-icon"),r=(o,i)=>{a&&(a.style.width=`${o}%`),n&&(n.textContent=i)};try{const l=await(await c.provider.getSigner()).signMessage("I am signing to authenticate my file for notarization on Backchain.");t&&t.classList.add("active"),r(10,"UPLOADING TO IPFS...");const d=new FormData;d.append("file",O.file),d.append("signature",l),d.append("address",c.userAddress),d.append("description",O.description||"No description");const u=Ee.uploadFileToIPFS||"/api/upload",f=await fetch(u,{method:"POST",body:d,signal:AbortSignal.timeout(18e4)});if(!f.ok)throw f.status===413?new Error("File too large. Maximum size is 5MB."):f.status===401?new Error("Signature verification failed."):new Error(`Upload failed (${f.status})`);const m=await f.json(),b=m.ipfsUri||m.metadataUri,p=m.contentHash;if(!b)throw new Error("No IPFS URI returned");if(!p)throw new Error("No content hash returned");r(50,"MINTING ON BLOCKCHAIN..."),s&&(s.className="fa-solid fa-stamp text-4xl text-amber-400 stamp-animation"),await Ul.notarize({ipfsCid:b,contentHash:p,description:O.description||"No description",button:e,onSuccess:g=>{r(100,"SUCCESS!"),t&&(t.innerHTML=`
                    ...
                    `),setTimeout(()=>{t&&t.classList.remove("active"),O.file=null,O.description="",O.step=1,O.isProcessing=!1,He(),or(),Pt(!0),x("📜 Document notarized successfully!","success")},3e3)},onError:g=>{if(g.cancelled||g.type==="user_rejected"){O.isProcessing=!1,t&&t.classList.remove("active"),e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-stamp mr-2"></i>Sign & Mint');return}throw g}})}catch(o){console.error("Notary Error:",o),t&&t.classList.remove("active"),e&&(e.disabled=!1,e.innerHTML='<i class="fa-solid fa-stamp mr-2"></i>Sign & Mint'),O.isProcessing=!1,x(o.message||"Notarization failed","error")}}async function or(){const e=document.getElementById("certificates-grid");if(e){if(!c.isConnected){e.innerHTML=`
    ...
    `;try{const t=Ee.getNotarizedDocuments||"https://getnotarizeddocuments-4wvdcuoouq-uc.a.run.app",n=await fetch(`${t}/${c.userAddress}`);if(!n.ok)throw new Error(`API returned ${n.status}`);const a=await n.json();if(!Array.isArray(a)||a.length===0){e.innerHTML=`
            ...
            `;return}const s=a.map(r=>({id:r.tokenId||"?",ipfs:r.ipfsCid||"",description:r.description||"",hash:r.contentHash||"",timestamp:r.createdAt||r.timestamp||"",txHash:r.txHash||""})).sort((r,o)=>parseInt(o.id)-parseInt(r.id));e.innerHTML=s.map(r=>{var f,m;let o="";const i=r.ipfs||"";i.startsWith("ipfs://")?o=`${po}${i.replace("ipfs://","")}`:i.startsWith("https://")?o=i:i.length>0&&(o=`${po}${i}`);let l=((f=r.description)==null?void 0:f.split("---")[0].trim().split(`
`)[0].trim())||"Notarized Document";const d=rr("",l),u=Jm(r.timestamp);return`
                <div class="cert-card">
                    <div class="h-32 bg-gradient-to-br from-zinc-800/50 to-zinc-900/50 flex items-center justify-center relative overflow-hidden">
                        ${o?`
                            <img src="${o}" class="absolute inset-0 w-full h-full object-cover opacity-80"
        ...
        `}}}async function of(){try{if(await Is(),c.isConnected&&c.userAddress)try{if(c.bkcTokenContract||c.bkcTokenContractPublic){const e=c.bkcTokenContract||c.bkcTokenContractPublic,t=await ne(e,"balanceOf",[c.userAddress],0n);t>0n&&(c.currentUserBalance=t)}}catch{}ua()}catch{(!c.notaryFee||c.notaryFee===0n)&&(c.notaryFee=sr.parseEther("1"))}}async function lf(e,t){var n,a;try{const s=["https://dweb.link/ipfs/","https://w3s.link/ipfs/","https://gateway.pinata.cloud/ipfs/","https://ipfs.io/ipfs/"],r=u=>u?u.startsWith("ipfs://")?u.replace("ipfs://","").split("?")[0]:u.includes("/ipfs/")?u.split("/ipfs/")[1].split("?")[0]:u.match(/^Qm[a-zA-Z0-9]{44}/)||u.match(/^bafy[a-zA-Z0-9]+/)?u:"":"",o=u=>{if(!u)return"";if(u.startsWith("https://")&&!u.includes("/ipfs/"))return u;const f=r(u);return f?`${s[0]}${f}`:u};let i=o(t||"");if(c.decentralizedNotaryContract)try{const u=await c.decentralizedNotaryContract.tokenURI(e);if(u!=null&&u.startsWith("data:application/json;base64,")){const f=JSON.parse(atob(u.replace("data:application/json;base64,","")));f.image&&(i=o(f.image))}}catch{}const l=((n=c.decentralizedNotaryContract)==null?void 0:n.target)||((a=c.decentralizedNotaryContract)!=null&&a.getAddress?await c.decentralizedNotaryContract.getAddress():null);if(!l){x("Contract address not found","error");return}x(`Adding NFT #${e} to wallet...`,"info"),await window.ethereum.request({method:"wallet_watchAsset",params:{type:"ERC721",options:{address:l,tokenId:String(e),image:i}}})&&x(`📜 NFT #${e} added to wallet!`,"success")}catch(s){if(s.code===4001)return;x("Could not add NFT","error")}}const uc={async render(e){e&&(Qm(),await of(),c.isConnected&&await Pt(),ua(),He())},reset(){O.file=null,O.description="",O.step=1,He()},update(){ua(),O.isProcessing||He()},refreshHistory(){or()},addToWallet:lf};window.NotaryPage=uc;const Aa=window.ethers,fo=24*60*60,gs={Diamond:{emoji:"💎",color:"#22d3ee",bg:"rgba(34,211,238,0.15)",border:"rgba(34,211,238,0.3)",keepRate:100},Gold:{emoji:"🥇",color:"#fbbf24",bg:"rgba(251,191,36,0.15)",border:"rgba(251,191,36,0.3)",keepRate:90},Silver:{emoji:"🥈",color:"#9ca3af",bg:"rgba(156,163,175,0.15)",border:"rgba(156,163,175,0.3)",keepRate:75},Bronze:{emoji:"🥉",color:"#fb923c",bg:"rgba(251,146,60,0.15)",border:"rgba(251,146,60,0.3)",keepRate:60}},$={activeTab:"marketplace",filterTier:"ALL",sortBy:"featured",selectedListing:null,isLoading:!1,isTransactionPending:!1,countdownIntervals:[],promotions:new Map},Re=e=>e==null?"":String(e),cf=(e,t)=>Re(e)===Re(t),Pn=(e,t)=>e&&t&&e.toLowerCase()===t.toLowerCase();function Fn(e){return ge.find(t=>t.boostBips===Number(e))||{name:"Unknown",boostBips:0}}function Ba(e){return gs[e]||{emoji:"💎",color:"#71717a",bg:"rgba(113,113,122,0.15)",border:"rgba(113,113,122,0.3)",keepRate:50}}function pc(e){const t=e-Math.floor(Date.now()/1e3);if(t<=0)return{text:"Expired",expired:!0,seconds:0};const n=Math.floor(t/3600),a=Math.floor(t%3600/60),s=t%60;return n>0?{text:`${n}h ${a}m`,expired:!1,seconds:t}:a>0?{text:`${a}m ${s}s`,expired:!1,seconds:t}:{text:`${s}s`,expired:!1,seconds:t}}function df(e){const t=Math.floor(Date.now()/1e3),n=e-t;if(n<=0)return null;const a=Math.floor(n/3600),s=Math.floor(n%3600/60);return a>0?`${a}h ${s}m`:`${s}m`}function mc(e){if(e.lastRentalEndTime)return Number(e.lastRentalEndTime)+fo;if(e.rentalEndTime&&!e.isRented){const t=Number(e.rentalEndTime),n=Math.floor(Date.now()/1e3);if(t<n)return t+fo}return null}function bo(e){const t=Math.floor(Date.now()/1e3),n=mc(e);return n&&n>t}function go(e){const t=Math.floor(Date.now()/1e3);if(!e.lastRentalEndTime&&!e.rentalEndTime)return e.createdAt?t-Number(e.createdAt):Number.MAX_SAFE_INTEGER;const n=e.lastRentalEndTime?Number(e.lastRentalEndTime):e.rentalEndTime?Number(e.rentalEndTime):0;return n>t?0:t-n}function uf(){if(document.getElementById("rental-styles-v6"))return;const e=document.createElement("style");e.id="rental-styles-v6",e.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(e)}function xs(){const e=document.getElementById("rental");if(!e)return;uf();const t=c.rentalListings||[],n=t.filter(r=>c.isConnected&&Pn(r.owner,c.userAddress)),a=Math.floor(Date.now()/1e3),s=(c.myRentals||[]).filter(r=>Pn(r.tenant,c.userAddress)&&Number(r.endTime)>a);e.innerHTML=`
        ...
        ${hf()}
        ${vf()}
    `,wf(),hn()}function pf(){return c.isConnected?`
    ...
    `:`
        ...
        `}function hn(){const e=document.getElementById("tab-content");if(e){switch($.activeTab){case"marketplace":e.innerHTML=mf();break;case"my-listings":e.innerHTML=ff();break;case"my-rentals":e.innerHTML=bf();break}document.getElementById("header-stats").innerHTML=pf(),$.activeTab==="my-rentals"&&If()}}function mf(){const e=c.rentalListings||[],t=Math.floor(Date.now()/1e3);let n=e.filter(a=>!(a.isRented||a.rentalEndTime&&Number(a.rentalEndTime)>t||$.filterTier!=="ALL"&&Fn(a.boostBips).name!==$.filterTier));return n.sort((a,s)=>{const r=BigInt(a.promotionFee||"0")||$.promotions.get(Re(a.tokenId))||0n,o=BigInt(s.promotionFee||"0")||$.promotions.get(Re(s.tokenId))||0n,i=bo(a),l=bo(s);if(!i&&l)return-1;if(i&&!l||o>r)return 1;if(o<r)return-1;if($.sortBy==="featured"){const f=go(a),m=go(s);if(m!==f)return m-f}const d=BigInt(a.pricePerHour||0),u=BigInt(s.pricePerHour||0);return $.sortBy==="price-low"?d<u?-1:1:$.sortBy==="price-high"?d>u?-1:1:(s.boostBips||0)-(a.boostBips||0)}),`
        <div>
            <!-- Filters & Sort -->
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
                <div class="flex flex-wrap gap-2">
                    <button class="filter-chip ${$.filterTier==="ALL"?"active":""}" data-filter="ALL">All Tiers</button>
                    ${Object.keys(gs).map(a=>`
            ...
            ${n.length===0?ir("No NFTs Available","Be the first to list your NFT!"):`
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 nft-grid">
                    ${n.map((a,s)=>fc(a,s)).join("")}
                </div>
            `}
        </div>
    `}function fc(e,t){const n=Fn(e.boostBips),a=Ba(n.name),s=_(BigInt(e.pricePerHour||0)).toFixed(2),r=Re(e.tokenId),o=c.isConnected&&Pn(e.owner,c.userAddress),i=mc(e),l=Math.floor(Date.now()/1e3),d=i&&i>l,u=d?df(i):null,f=BigInt(e.promotionFee||"0")||$.promotions.get(r)||0n,m=f>0n,b=m?parseFloat(Aa.formatEther(f)).toFixed(3):"0",p=lt(e.boostBips||0);return`
        <div class="nft-card ${m?"promoted":""} ${o?"owned":""} ${d?"cooldown":""}" 
    ...
    `}function ff(){if(!c.isConnected)return bc("View your listings");const e=c.rentalListings||[],t=e.filter(r=>Pn(r.owner,c.userAddress)),n=new Set(e.map(r=>Re(r.tokenId))),a=(c.myBoosters||[]).filter(r=>!n.has(Re(r.tokenId)));return`
        <div>
            <!-- Earnings Card -->
                    ...
                    <div class="flex items-center gap-5">
                        ...
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white">
                                ${t.reduce((r,o)=>r+Number(Aa.formatEther(BigInt(o.totalEarnings||0))),0).toFixed(4)} <span class="text-lg text-zinc-500">BKC</span>
                            </p>
                        </div>
                    </div>
                    <div class="flex gap-3">
            ...
            ${t.length===0?ir("No Listings Yet","List your first NFT to start earning!"):`
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 nft-grid">
                    ${t.map((r,o)=>fc(r,o)).join("")}
                </div>
            `}
        </div>
    `}function bf(){if(!c.isConnected)return bc("View your active rentals");const e=Math.floor(Date.now()/1e3),t=(c.myRentals||[]).filter(n=>Pn(n.tenant,c.userAddress)&&Number(n.endTime)>e);return`
        <div>
            <!-- Info Card -->
            ...
            ${t.length===0?ir("No Active Rentals","Rent an NFT to reduce your claim burn rate!"):`
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    ${t.map((n,a)=>gf(n,a)).join("")}
                </div>
            `}
        </div>
    `}function gf(e,t){const n=Fn(e.boostBips),a=Ba(n.name),s=pc(Number(e.endTime)),r=lt(e.boostBips||0);let o="active";return s.seconds<3600?o="critical":s.seconds<7200&&(o="warning"),`
        <div class="rental-card-base p-5" style="animation: card-in 0.5s ease-out ${t*60}ms forwards; opacity: 0;">
            <div class="flex items-center justify-between mb-4">
                <div class="tier-badge" style="background:${a.bg};color:${a.color};border:1px solid ${a.border}">
                    ${a.emoji} ${n.name}
                </div>
                <div class="rental-timer ${o}" data-end="${e.endTime}">
    ...
    `}function xf(){const e=c.rentalListings||[],t=new Set(e.map(a=>Re(a.tokenId)));return`
                ...
                <div class="p-5 space-y-5">
                    <div>
                        ...
                        <select id="list-select" class="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-4 py-3 text-white outline-none">
                            ...
                            ${(c.myBoosters||[]).filter(a=>!t.has(Re(a.tokenId))).map(a=>{const s=Fn(a.boostBips),r=Ba(s.name);return`<option value="${a.tokenId}">${r.emoji} ${s.name} Booster #${a.tokenId}</option>`}).join("")}
                        </select>
                    </div>
                    <div>
    ...
    `}function wf(){document.addEventListener("click",e=>{const t=e.target.closest(".rental-tab");if(t){$.activeTab=t.dataset.tab,document.querySelectorAll(".rental-tab").forEach(o=>o.classList.remove("active")),t.classList.add("active"),hn();return}const n=e.target.closest(".filter-chip");if(n){$.filterTier=n.dataset.filter,hn();return}if(e.target.closest("#btn-open-list")){gc();return}const a=e.target.closest(".rent-btn");if(a&&!a.disabled){yf(a.dataset.id);return}const s=e.target.closest(".withdraw-btn");if(s){wc(s);return}const r=e.target.closest(".promote-btn");if(r){kf(r.dataset.id);return}}),document.addEventListener("change",e=>{e.target.id==="sort-select"&&($.sortBy=e.target.value,hn())})}function gc(){document.getElementById("modal-list").classList.add("active")}function xc(){document.getElementById("modal-list").classList.remove("active")}function yf(e){const t=(c.rentalListings||[]).find(o=>cf(o.tokenId,e));if(!t)return;$.selectedListing=t;const n=Fn(t.boostBips),a=Ba(n.name),s=_(BigInt(t.pricePerHour||0)),r=lt(t.boostBips||0);document.getElementById("rent-modal-content").innerHTML=`
    ...
    `,document.getElementById("rent-hours").addEventListener("input",o=>{const i=parseInt(o.target.value)||1,l=Number(s)*i;document.querySelector("#rent-total span:last-child").textContent=`${l.toFixed(2)} BKC`}),document.getElementById("modal-rent").classList.add("active")}function hc(){document.getElementById("modal-rent").classList.remove("active"),$.selectedListing=null}function kf(e){document.getElementById("promote-token-id").value=e,document.getElementById("promote-amount").value="",document.getElementById("modal-promote").classList.add("active")}function vc(){document.getElementById("modal-promote").classList.remove("active")}async function Ef(){if($.isTransactionPending||!$.selectedListing)return;const e=parseInt(document.getElementById("rent-hours").value)||1,t=Re($.selectedListing.tokenId),n=document.getElementById("confirm-rent");$.isTransactionPending=!0;try{await _n.rent({tokenId:t,hours:e,button:n,onSuccess:async()=>{$.isTransactionPending=!1,hc(),x("🎉 NFT Rented Successfully!","success"),await Kt()},onError:a=>{$.isTransactionPending=!1,!a.cancelled&&a.type!=="user_rejected"&&x("Failed: "+(a.message||"Error"),"error")}})}catch(a){$.isTransactionPending=!1,!a.cancelled&&a.type!=="user_rejected"&&x("Failed: "+(a.message||"Error"),"error")}}async function Tf(){var a;if($.isTransactionPending)return;const e=document.getElementById("list-select").value,t=document.getElementById("list-price").value;if(parseFloat((a=document.getElementById("list-promo-amount"))==null?void 0:a.value),!e){x("Select an NFT","error");return}if(!t||parseFloat(t)<=0){x("Enter valid price","error");return}const n=document.getElementById("confirm-list");$.isTransactionPending=!0;try{await _n.list({tokenId:e,pricePerHour:Aa.parseUnits(t,18),minHours:1,maxHours:168,button:n,onSuccess:async()=>{$.isTransactionPending=!1,xc(),x("🏷️ NFT Listed Successfully!","success"),await Kt()},onError:s=>{$.isTransactionPending=!1,!s.cancelled&&s.type!=="user_rejected"&&x("Failed: "+(s.message||"Error"),"error")}})}catch(s){$.isTransactionPending=!1,!s.cancelled&&s.type!=="user_rejected"&&x("Failed: "+(s.message||"Error"),"error")}}async function wc(e){if($.isTransactionPending)return;const t=e.dataset.id;if(confirm("Withdraw this NFT from marketplace?")){$.isTransactionPending=!0;try{await _n.withdraw({tokenId:t,button:e,onSuccess:async()=>{$.isTransactionPending=!1,x("↩️ NFT Withdrawn Successfully!","success"),await Kt()},onError:n=>{$.isTransactionPending=!1,!n.cancelled&&n.type!=="user_rejected"&&x("Failed: "+(n.message||"Error"),"error")}})}catch(n){$.isTransactionPending=!1,!n.cancelled&&n.type!=="user_rejected"&&x("Failed: "+(n.message||"Error"),"error")}}}async function Cf(){if($.isTransactionPending)return;const e=document.getElementById("promote-token-id").value,t=document.getElementById("promote-amount").value;if(!t||parseFloat(t)<=0){x("Enter valid amount","error");return}const n=document.getElementById("confirm-promote");$.isTransactionPending=!0;try{await _n.spotlight({tokenId:e,amount:Aa.parseEther(t),button:n,onSuccess:async()=>{$.isTransactionPending=!1,vc(),x("🚀 Listing Promoted!","success"),await Kt()},onError:a=>{$.isTransactionPending=!1,!a.cancelled&&a.type!=="user_rejected"&&x("Failed: "+(a.message||"Error"),"error")}})}catch(a){$.isTransactionPending=!1,!a.cancelled&&a.type!=="user_rejected"&&x("Failed: "+(a.message||"Error"),"error")}}function If(){$.countdownIntervals.forEach(clearInterval),$.countdownIntervals=[],document.querySelectorAll(".rental-timer[data-end]").forEach(e=>{const t=Number(e.dataset.end),n=setInterval(()=>{const a=pc(t);e.innerHTML=`<i class="fa-solid fa-clock mr-1"></i>${a.text}`,a.expired?(clearInterval(n),hn()):a.seconds<3600?e.className="rental-timer critical":a.seconds<7200&&(e.className="rental-timer warning")},1e3);$.countdownIntervals.push(n)})}async function Kt(){$.isLoading=!0;try{await Promise.all([No(),c.isConnected?Nd():Promise.resolve(),c.isConnected?vt():Promise.resolve()])}catch(e){console.warn("Refresh error:",e)}$.isLoading=!1,xs()}const yc={async render(e){e&&(xs(),await Kt())},update(){xs()},refresh:Kt,openListModal:gc,closeListModal:xc,closeRentModal:hc,closePromoteModal:vc,handleRent:Ef,handleList:Tf,handleWithdraw:wc,handlePromote:Cf};window.RentalPage=yc;const Af={render:async e=>{const t=document.getElementById("socials");if(!t||!e&&t.innerHTML.trim()!=="")return;const n=`
            <style>
        ...
        `},cleanup:()=>{}},kc=document.createElement("style");kc.innerHTML=`
...
`;document.head.appendChild(kc);const Bf={render:async e=>{if(!e)return;const t=document.getElementById("creditcard");t&&(t.innerHTML=`
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    ...
                    <div class="glass-mockup rounded-2xl p-6 h-full flex flex-col">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="space-y-2">
                                ${ln("Starbucks Coffee","Today, 8:30 AM","- $5.40","+ 15 BKC","fa-mug-hot")}
                                ${ln("Uber Ride","Yesterday, 6:15 PM","- $24.50","+ 82 BKC","fa-car")}
                                ${ln("Netflix Subscription","Oct 24, 2025","- $15.99","+ 53 BKC","fa-film")}
                                ${ln("Amazon Purchase","Oct 22, 2025","- $142.00","+ 475 BKC","fa-box-open")}
                                ${ln("Shell Station","Oct 20, 2025","- $45.00","+ 150 BKC","fa-gas-pump")}
                            </div>
                        </div>
                    </div>
    ...
    `}const H={state:{tokens:{ETH:{name:"Ethereum",symbol:"ETH",balance:5.45,price:3050,logo:"https://cryptologos.cc/logos/ethereum-eth-logo.png?v=026"},USDT:{name:"Tether USD",symbol:"USDT",balance:12500,price:1,logo:"https://cryptologos.cc/logos/tether-usdt-logo.png?v=026"},ARB:{name:"Arbitrum",symbol:"ARB",balance:2450,price:1.1,logo:"https://cryptologos.cc/logos/arbitrum-arb-logo.png?v=026"},WBTC:{name:"Wrapped BTC",symbol:"WBTC",balance:.15,price:62e3,logo:"https://cryptologos.cc/logos/wrapped-bitcoin-wbtc-logo.png?v=026"},MATIC:{name:"Polygon",symbol:"MATIC",balance:5e3,price:.85,logo:"https://cryptologos.cc/logos/polygon-matic-logo.png?v=026"},BNB:{name:"BNB Chain",symbol:"BNB",balance:12.5,price:580,logo:"https://cryptologos.cc/logos/bnb-bnb-logo.png?v=026"},BKC:{name:"Backcoin",symbol:"BKC",balance:1500,price:.12,logo:"assets/bkc_logo_3d.png",isNative:!0}},settings:{slippage:.5,deadline:20},swap:{tokenIn:"ETH",tokenOut:"BKC",amountIn:"",loading:!1},mining:{rate:.05}},calculate:()=>{const{tokens:e,swap:t,mining:n}=H.state;if(!t.amountIn||parseFloat(t.amountIn)===0)return null;const a=e[t.tokenIn],s=e[t.tokenOut],o=parseFloat(t.amountIn)*a.price,i=o*.003,l=o-i,d=e.BKC.price,u=i*n.rate/d,f=l/s.price,m=Math.min(o/1e5*100,5).toFixed(2);return{amountOut:f,usdValue:o,feeUsd:i,miningReward:u,priceImpact:m,rate:a.price/s.price}},render:async e=>{if(!e)return;const t=document.getElementById("dex");t&&(t.innerHTML=`
        ...
        `,H.updateUI(),H.bindEvents())},updateUI:()=>{const{tokens:e,swap:t}=H.state,n=e[t.tokenIn],a=e[t.tokenOut],s=(l,d)=>{document.getElementById(`symbol-${l}`).innerText=d.symbol;const u=document.getElementById(`img-${l}-container`);d.logo?u.innerHTML=`<img src="${d.logo}" class="w-6 h-6 rounded-full" onerror="this.style.display='none'">`:u.innerHTML=`<div class="w-6 h-6 rounded-full bg-zinc-700 flex items-center justify-center text-[10px]">${d.symbol[0]}</div>`};s("in",n),s("out",a),document.getElementById("bal-in").innerText=n.balance.toFixed(4),document.getElementById("bal-out").innerText=a.balance.toFixed(4);const r=H.calculate(),o=document.getElementById("btn-swap"),i=document.getElementById("swap-details");if(!t.amountIn)document.getElementById("input-out").value="",document.getElementById("usd-in").innerText="$0.00",document.getElementById("usd-out").innerText="$0.00",i.classList.add("hidden"),o.innerText="Enter an amount",o.className="w-full mt-4 bg-zinc-800 text-zinc-500 font-bold text-lg py-4 rounded-2xl cursor-not-allowed",o.disabled=!0;else if(parseFloat(t.amountIn)>n.balance)o.innerText=`Insufficient ${n.symbol} balance`,o.className="w-full mt-4 bg-[#3d1818] text-red-500 font-bold text-lg py-4 rounded-2xl cursor-not-allowed border border-red-900/30",o.disabled=!0,i.classList.add("hidden");else if(r){document.getElementById("input-out").value=r.amountOut.toFixed(6),document.getElementById("usd-in").innerText=`~$${r.usdValue.toFixed(2)}`,document.getElementById("usd-out").innerText=`~$${(r.usdValue-r.feeUsd).toFixed(2)}`,i.classList.remove("hidden"),document.getElementById("fee-display").innerText=`$${r.feeUsd.toFixed(2)}`,document.getElementById("mining-reward-display").innerText=`+${r.miningReward.toFixed(4)} BKC`;const l=document.getElementById("price-impact");parseFloat(r.priceImpact)>2?(l.classList.remove("hidden"),l.innerText=`Price Impact: -${r.priceImpact}%`):l.classList.add("hidden"),o.innerHTML=t.loading?'<i class="fa-solid fa-circle-notch fa-spin"></i> Swapping...':"Swap",o.className="w-full mt-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-bold text-lg py-4 rounded-2xl shadow-lg shadow-blue-900/20 cursor-pointer border border-blue-500/20",o.disabled=t.loading}},bindEvents:()=>{document.getElementById("input-in").addEventListener("input",t=>{H.state.swap.amountIn=t.target.value,H.updateUI()}),document.getElementById("btn-max-in").addEventListener("click",()=>{const t=H.state.tokens[H.state.swap.tokenIn].balance;H.state.swap.amountIn=t.toString(),document.getElementById("input-in").value=t,H.updateUI()}),document.getElementById("btn-switch").addEventListener("click",()=>{const t=H.state.swap.tokenIn;H.state.swap.tokenIn=H.state.swap.tokenOut,H.state.swap.tokenOut=t,H.state.swap.amountIn="",document.getElementById("input-in").value="",H.updateUI()}),document.getElementById("btn-swap").addEventListener("click",async()=>{const t=document.getElementById("btn-swap");if(t.disabled)return;H.state.swap.loading=!0,H.updateUI(),await new Promise(r=>setTimeout(r,1500));const n=H.calculate(),{tokens:a,swap:s}=H.state;a[s.tokenIn].balance-=parseFloat(s.amountIn),a[s.tokenOut].balance+=n.amountOut,a.BKC.balance+=n.miningReward,H.state.swap.loading=!1,H.state.swap.amountIn="",document.getElementById("input-in").value="",t.className="w-full mt-4 bg-green-600 text-white font-bold text-lg py-4 rounded-2xl shadow-[0_0_20px_rgba(22,163,74,0.4)]",t.innerHTML=`<i class="fa-solid fa-check"></i> Swap Success! +${n.miningReward.toFixed(2)} BKC Mined!`,setTimeout(()=>{H.updateUI()},3e3)});const e=t=>{const n=document.getElementById("token-modal"),a=document.getElementById("token-list");n.classList.remove("hidden"),(()=>{a.innerHTML=Object.values(H.state.tokens).map(r=>{const o=H.state.swap[`token${t==="in"?"In":"Out"}`]===r.symbol;return H.state.swap[`token${t==="in"?"Out":"In"}`]===r.symbol?"":`
                        <div class="token-item flex justify-between items-center p-3 hover:bg-[#2c2c2c] rounded-xl cursor-pointer transition-colors ${o?"opacity-50 pointer-events-none":""}" data-symbol="${r.symbol}">
                            <div class="flex items-center gap-3">
    ...
    `}function Za(e,t,n,a,s,r,o){const i=lr[At];let l=`
        <div class="mb-10">
            <div class="flex items-center gap-3 mb-6 pb-3 border-b border-zinc-700">
                ...
                <div>
                    <h2 class="text-lg font-bold text-white">${i[s]}</h2>
                    <p class="text-xs text-zinc-500">${i[r]}</p>
                </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
    `,d=o;return a.forEach(u=>{l+=Nf(u,d++)}),l+="</div></div>",{html:l,nextIndex:d}}function zf(e){var t,n,a,s,r,o,i,l;At=e,localStorage.setItem("backcoin-tutorials-lang",e),(t=document.getElementById("tutorials-btn-en"))==null||t.classList.toggle("bg-amber-500",e==="en"),(n=document.getElementById("tutorials-btn-en"))==null||n.classList.toggle("text-zinc-900",e==="en"),(a=document.getElementById("tutorials-btn-en"))==null||a.classList.toggle("bg-zinc-700",e!=="en"),(s=document.getElementById("tutorials-btn-en"))==null||s.classList.toggle("text-zinc-300",e!=="en"),(r=document.getElementById("tutorials-btn-pt"))==null||r.classList.toggle("bg-amber-500",e==="pt"),(o=document.getElementById("tutorials-btn-pt"))==null||o.classList.toggle("text-zinc-900",e==="pt"),(i=document.getElementById("tutorials-btn-pt"))==null||i.classList.toggle("bg-zinc-700",e!=="pt"),(l=document.getElementById("tutorials-btn-pt"))==null||l.classList.toggle("text-zinc-300",e!=="pt"),Ec()}function Ec(){const e=document.getElementById("tutorials-content");if(!e)return;const t=lr[At];let n=`
        <!-- Hero -->
        <div class="text-center mb-10">
    ...
    `,a=Za("getting-started","rocket","emerald",Ja.gettingStarted,"catGettingStarted","catGettingStartedDesc",0);n+=a.html,a=Za("ecosystem","cubes","amber",Ja.ecosystem,"catEcosystem","catEcosystemDesc",a.nextIndex),n+=a.html,a=Za("advanced","graduation-cap","cyan",Ja.advanced,"catAdvanced","catAdvancedDesc",a.nextIndex),n+=a.html,e.innerHTML=n}const Tc={render:function(e=!1){const t=document.getElementById("tutorials");t&&(e||t.innerHTML.trim()==="")&&(t.innerHTML=`
            ...
            `,Ec())},update:function(e){},cleanup:function(){},setLang:zf};window.TutorialsPage=Tc;const tn=window.ethers,Lf={ACTIVE:0,COMPLETED:1,CANCELLED:2,WITHDRAWN:3},cr=e=>typeof e=="number"?e:typeof e=="string"?isNaN(parseInt(e))?Lf[e.toUpperCase()]??0:parseInt(e):0,dr=e=>cr(e.status)===0&&Number(e.deadline)>Math.floor(Date.now()/1e3),ur=["function campaigns(uint256) view returns (address creator, string title, string description, uint256 goalAmount, uint256 raisedAmount, uint256 donationCount, uint256 deadline, uint256 createdAt, uint8 status)","function campaignCounter() view returns (uint256)","function totalRaisedAllTime() view returns (uint256)","function totalBurnedAllTime() view returns (uint256)","function totalCampaignsCreated() view returns (uint256)","function totalSuccessfulWithdrawals() view returns (uint256)"],Pa={getCampaigns:"https://getcharitycampaigns-4wvdcuoouq-uc.a.run.app",saveCampaign:"https://savecharitycampaign-4wvdcuoouq-uc.a.run.app",uploadImage:"https://uploadcharityimage-4wvdcuoouq-uc.a.run.app"},Cc="https://sepolia.arbiscan.io/address/",pa={animal:"https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=800&q=80",humanitarian:"https://images.unsplash.com/photo-1469571486292-0ba58a3f068b?w=800&q=80",default:"https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?w=800&q=80"},De={animal:{name:"Animal Welfare",emoji:"🐾",color:"#10b981",gradient:"from-emerald-500/20 to-green-600/20"},humanitarian:{name:"Humanitarian Aid",emoji:"💗",color:"#ec4899",gradient:"from-pink-500/20 to-rose-600/20"}},xo={0:{label:"Active",color:"#10b981",icon:"fa-circle-play",bg:"bg-emerald-500/15"},1:{label:"Ended",color:"#3b82f6",icon:"fa-circle-check",bg:"bg-blue-500/15"},2:{label:"Cancelled",color:"#ef4444",icon:"fa-circle-xmark",bg:"bg-red-500/15"},3:{label:"Completed",color:"#8b5cf6",icon:"fa-circle-dollar-to-slot",bg:"bg-purple-500/15"}},Sf=5*1024*1024,Rf=["image/jpeg","image/png","image/gif","image/webp"],B={campaigns:[],stats:null,currentView:"main",currentCampaign:null,selectedCategory:null,isLoading:!1,pendingImage:null,pendingImageFile:null,editingCampaign:null};function $f(){if(document.getElementById("charity-styles-v6"))return;const e=document.createElement("style");e.id="charity-styles-v6",e.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(e)}const ke=e=>{try{const t=Number(e)/1e18;return t<1e-4?"0":t<1?t.toFixed(4):t<1e3?t.toFixed(2):t.toLocaleString("en-US",{maximumFractionDigits:2})}catch{return"0"}},Ic=e=>e?`${e.slice(0,6)}...${e.slice(-4)}`:"",Mn=(e,t)=>{const n=Number(e||0),a=Number(t||1);return Math.min(100,Math.round(n/a*100))},Ac=e=>{const t=Math.floor(Date.now()/1e3),n=Number(e)-t;if(n<=0)return{text:"Ended",color:"#ef4444"};const a=Math.floor(n/86400);return a>0?{text:`${a}d left`,color:"#10b981"}:{text:`${Math.floor(n/3600)}h left`,color:"#f59e0b"}},Na=e=>(e==null?void 0:e.imageUrl)||pa[e==null?void 0:e.category]||pa.default,Bc=e=>`${window.location.origin}${window.location.pathname}#charity/${e}`,Pc=()=>{const t=window.location.hash.match(/#charity\/(\d+)/);return t?t[1]:null},_f=e=>{window.location.hash=`charity/${e}`},Ff=()=>{window.location.hash.startsWith("#charity/")&&(window.location.hash="charity")},Nc=e=>{const t=cr(e.status),n=Number(e.deadline)<=Math.floor(Date.now()/1e3);return(t===0||t===1)&&n&&!e.withdrawn&&BigInt(e.raisedAmount||0)>0n};async function Lt(){B.isLoading=!0;try{const[e,t]=await Promise.all([fetch(Pa.getCampaigns).then(s=>s.json()).catch(()=>({campaigns:[]})),Mf()]),n=(e==null?void 0:e.campaigns)||[],a=c==null?void 0:c.publicProvider;if(a){const s=new tn.Contract(w.charityPool,ur,a),r=await s.campaignCounter(),o=Number(r),i=await Promise.all(Array.from({length:o},(l,d)=>d+1).map(async l=>{try{const d=await s.campaigns(l),u=n.find(f=>String(f.id)===String(l));return{id:String(l),creator:d[0],title:(u==null?void 0:u.title)||d[1]||`Campaign #${l}`,description:(u==null?void 0:u.description)||d[2]||"",goalAmount:BigInt(d[3].toString()),raisedAmount:BigInt(d[4].toString()),donationCount:Number(d[5]),deadline:Number(d[6]),createdAt:Number(d[7]),status:Number(d[8]),category:(u==null?void 0:u.category)||"humanitarian",imageUrl:(u==null?void 0:u.imageUrl)||null}}catch{return null}}));B.campaigns=i.filter(Boolean)}B.stats=t}catch(e){console.error("Load data:",e)}finally{B.isLoading=!1}}async function Mf(){try{const e=c==null?void 0:c.publicProvider;if(!e)return null;const t=new tn.Contract(w.charityPool,ur,e),[n,a,s,r]=await Promise.all([t.totalRaisedAllTime(),t.totalBurnedAllTime(),t.totalCampaignsCreated(),t.totalSuccessfulWithdrawals()]);return{raised:n,burned:a,created:Number(s),withdrawals:Number(r)}}catch{return null}}function Df(e,t="create"){var s;const n=(s=e.target.files)==null?void 0:s[0];if(!n)return;if(!Rf.includes(n.type)){x("Please select a valid image (JPG, PNG, GIF, WebP)","error");return}if(n.size>Sf){x("Image must be less than 5MB","error");return}B.pendingImageFile=n;const a=new FileReader;a.onload=r=>{const o=t==="edit"?"edit-image-preview":"create-image-preview",i=document.getElementById(t==="edit"?"edit-image-upload":"create-image-upload"),l=document.getElementById(o);l&&(l.innerHTML=`
            ...
            `),i&&i.classList.add("has-image")},a.readAsDataURL(n)}function zc(e="create"){B.pendingImageFile=null,B.pendingImage=null;const t=e==="edit"?"edit-image-preview":"create-image-preview",n=document.getElementById(e==="edit"?"edit-image-upload":"create-image-upload"),a=document.getElementById(t);a&&(a.innerHTML=""),n&&n.classList.remove("has-image");const s=document.getElementById(e==="edit"?"edit-image-file":"create-image-file");s&&(s.value="")}function Of(e,t="create"){document.querySelectorAll(`#${t}-image-tabs .cp-tab`).forEach(r=>r.classList.toggle("active",r.dataset.tab===e));const a=document.getElementById(`${t}-image-upload`),s=document.getElementById(`${t}-image-url-wrap`);a&&(a.style.display=e==="upload"?"block":"none"),s&&(s.style.display=e==="url"?"block":"none")}async function Lc(e){const t=new FormData;t.append("image",e);const n=await fetch(Pa.uploadImage,{method:"POST",body:t});if(!n.ok)throw new Error("Upload failed");return(await n.json()).imageUrl}const Sc=e=>{const t=xo[cr(e)]||xo[0];return`<span class="cp-badge" style="background:${t.color}20;color:${t.color}"><i class="fa-solid ${t.icon}"></i> ${t.label}</span>`},Hf=()=>'<div class="cp-loading"><div class="cp-spinner"></div><span class="text-zinc-500">Loading campaigns...</span></div>',Rc=e=>`<div class="cp-empty"><i class="fa-solid fa-inbox"></i><h3>${e}</h3><p class="text-zinc-600 text-sm">Be the first to create a campaign!</p></div>`,$c=e=>{var s,r,o,i;const t=Mn(e.raisedAmount,e.goalAmount),n=Ac(e.deadline),a=e.category||"humanitarian";return`
        <div class="cp-campaign-card" onclick="CharityPage.viewCampaign('${e.id}')">
            <img src="${Na(e)}" alt="${e.title}" onerror="this.src='${pa.default}'">
            <div class="p-4">
                <div class="flex flex-wrap gap-1.5 mb-2">
                    ${Sc(e.status)}
                    <span class="cp-badge" style="background:${(s=De[a])==null?void 0:s.color}20;color:${(r=De[a])==null?void 0:r.color}">
                        ${(o=De[a])==null?void 0:o.emoji} ${(i=De[a])==null?void 0:i.name}
                    </span>
                </div>
                <h3 class="text-white font-bold text-sm mb-1 line-clamp-2">${e.title}</h3>
                <p class="text-zinc-500 text-xs mb-3">by <a href="${Cc}${e.creator}" target="_blank" class="text-amber-500 hover:text-amber-400">${Ic(e.creator)}</a></p>
    ...
    `},ho=()=>{var a,s,r,o;const e=B.campaigns.filter(i=>dr(i)),t=e.filter(i=>i.category==="animal"),n=e.filter(i=>i.category==="humanitarian");return`
        <div class="charity-page">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6 cp-stats-grid">
                <div class="cp-stat-card">
                    <p class="text-2xl font-bold text-emerald-400 font-mono">
                        <i class="fa-brands fa-ethereum text-lg mr-1"></i>${B.stats?ke(B.stats.raised):"--"}
                    </p>
                    <p class="text-[10px] text-zinc-500 uppercase mt-1">Total Raised</p>
                </div>
                <div class="cp-stat-card">
                    <p class="text-2xl font-bold text-blue-400 font-mono">${B.stats?ke(B.stats.burned):"--"}</p>
                    <p class="text-[10px] text-zinc-500 uppercase mt-1">Platform Fees</p>
                </div>
                <div class="cp-stat-card">
                    <p class="text-2xl font-bold text-amber-400 font-mono">${((a=B.stats)==null?void 0:a.created)??"--"}</p>
                    <p class="text-[10px] text-zinc-500 uppercase mt-1">Campaigns</p>
                </div>
                <div class="cp-stat-card">
                    <p class="text-2xl font-bold text-purple-400 font-mono">${((s=B.stats)==null?void 0:s.withdrawals)??"--"}</p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8 cp-cats-grid">
                <div class="cp-category-card animal ${B.selectedCategory==="animal"?"selected":""}" onclick="CharityPage.selectCat('animal')">
                    ...
                    <div class="flex justify-center gap-6 text-sm text-zinc-400 mb-3">
                        ...
                        <span><i class="fa-brands fa-ethereum"></i> <strong class="text-white">${ke(t.reduce((i,l)=>i+BigInt(l.raisedAmount||0),0n))}</strong></span>
                    </div>
                ...
                <div class="cp-category-card humanitarian ${B.selectedCategory==="humanitarian"?"selected":""}" onclick="CharityPage.selectCat('humanitarian')">
                    ...
                    <div class="flex justify-center gap-6 text-sm text-zinc-400 mb-3">
                        ...
                        <span><i class="fa-brands fa-ethereum"></i> <strong class="text-white">${ke(n.reduce((i,l)=>i+BigInt(l.raisedAmount||0),0n))}</strong></span>
                    </div>
            ...
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-lg font-bold text-white flex items-center gap-2">
                    ${B.selectedCategory?`
                        ...
                        ${(r=De[B.selectedCategory])==null?void 0:r.emoji} ${(o=De[B.selectedCategory])==null?void 0:o.name}
                    `:`
                        <i class="fa-solid fa-fire text-amber-500"></i> Active Campaigns
                    `}
                </h2>
                <span class="text-xs text-zinc-500">${e.filter(i=>!B.selectedCategory||i.category===B.selectedCategory).length} campaigns</span>
            </div>
            
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4" id="cp-grid">
                ${e.length?e.filter(i=>!B.selectedCategory||i.category===B.selectedCategory).sort((i,l)=>Number(l.createdAt||0)-Number(i.createdAt||0)).map(i=>$c(i)).join(""):Rc("No active campaigns")}
            </div>
        </div>
    `},vo=e=>{var i,l,d,u,f,m;if(!e)return`
        <div class="charity-page">
    ...
    `;const t=Mn(e.raisedAmount,e.goalAmount),n=Ac(e.deadline),a=e.category||"humanitarian",s=dr(e),r=((i=e.creator)==null?void 0:i.toLowerCase())===((l=c==null?void 0:c.userAddress)==null?void 0:l.toLowerCase()),o=Nc(e);return`
        <div class="charity-page">
            ${_c()}
            ${Fc()}
            ...
            <div class="cp-detail">
                ...
                <div class="flex flex-wrap items-center gap-2 mb-4">
                    ...
                    ${Sc(e.status)}
                    <span class="cp-badge" style="background:${(d=De[a])==null?void 0:d.color}20;color:${(u=De[a])==null?void 0:u.color}">
                        ${(f=De[a])==null?void 0:f.emoji} ${(m=De[a])==null?void 0:m.name}
                    </span>
                ...
                <img src="${Na(e)}" class="cp-detail-img" onerror="this.src='${pa.default}'">
                ...
                <div class="cp-detail-content">
                    ...
                    <div class="cp-card-base p-6">
                        ...
                        <p class="text-sm text-zinc-500 mb-4">
                            Created by <a href="${Cc}${e.creator}" target="_blank" class="text-amber-500 hover:text-amber-400">${Ic(e.creator)}</a>
                        </p>
...
`;function Dn(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.add("active")}function rt(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.remove("active")}function Wf(e="humanitarian"){var t;B.pendingImage=null,B.pendingImageFile=null,zc("create"),document.querySelectorAll("#modal-create .cp-cat-option").forEach(n=>n.classList.remove("selected")),(t=document.getElementById(`opt-${e}`))==null||t.classList.add("selected"),["campaign-title","campaign-desc","campaign-goal","campaign-duration","campaign-image-url"].forEach(n=>{const a=document.getElementById(n);a&&(a.value="")}),Dn("create")}function Gf(e){const t=B.campaigns.find(s=>s.id===e||s.id===String(e));if(!t)return;const n=document.getElementById("donate-campaign-info");n&&(n.innerHTML=`
        ...
        `);const a=document.getElementById("donate-amount");a&&(a.value=""),B.currentCampaign=t,Dn("donate")}function Kf(){var a;const e=(a=c==null?void 0:c.userAddress)==null?void 0:a.toLowerCase(),t=B.campaigns.filter(s=>{var r;return((r=s.creator)==null?void 0:r.toLowerCase())===e}),n=document.getElementById("my-campaigns-list");n&&(t.length===0?n.innerHTML=`
            <div class="cp-empty">
        ...
        `:n.innerHTML=t.map(s=>{const r=Mn(s.raisedAmount,s.goalAmount),o=Nc(s);return`
            ...
            `}).join(""),Dn("my"))}function Yf(e){var a,s,r;const t=B.campaigns.find(o=>o.id===e||o.id===String(e));if(!t)return;if(((a=t.creator)==null?void 0:a.toLowerCase())!==((s=c==null?void 0:c.userAddress)==null?void 0:s.toLowerCase())){x("Not your campaign","error");return}B.editingCampaign=t,B.pendingImageFile=null,document.getElementById("edit-campaign-id").value=t.id,document.getElementById("edit-title").value=t.title||"",document.getElementById("edit-desc").value=t.description||"",document.getElementById("edit-image-url").value=t.imageUrl||"",document.querySelectorAll("#modal-edit .cp-cat-option").forEach(o=>o.classList.remove("selected")),(r=document.getElementById(`edit-opt-${t.category||"humanitarian"}`))==null||r.classList.add("selected");const n=document.getElementById("edit-image-preview");n&&t.imageUrl?n.innerHTML=`<img src="${t.imageUrl}" class="cp-image-preview">`:n&&(n.innerHTML=""),Dn("edit")}function Vf(e,t="create"){var s;const n=t==="edit"?"edit-opt-":"opt-",a=t==="edit"?"#modal-edit":"#modal-create";document.querySelectorAll(`${a} .cp-cat-option`).forEach(r=>r.classList.remove("selected")),(s=document.getElementById(`${n}${e}`))==null||s.classList.add("selected")}function qf(e){const t=document.getElementById("donate-amount")||document.getElementById("detail-amount");t&&(t.value=e)}async function Xf(){var d,u,f,m,b,p,g,y;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=document.querySelector("#modal-create .cp-cat-option.selected input"),t=(e==null?void 0:e.value)||"humanitarian",n=(u=(d=document.getElementById("campaign-title"))==null?void 0:d.value)==null?void 0:u.trim(),a=(m=(f=document.getElementById("campaign-desc"))==null?void 0:f.value)==null?void 0:m.trim(),s=(b=document.getElementById("campaign-goal"))==null?void 0:b.value,r=(p=document.getElementById("campaign-duration"))==null?void 0:p.value;let o=(y=(g=document.getElementById("campaign-image-url"))==null?void 0:g.value)==null?void 0:y.trim();if(!n)return x("Enter a title","error");if(!a)return x("Enter a description","error");if(!s||parseFloat(s)<.01)return x("Goal must be at least 0.01 ETH","error");if(!r||parseInt(r)<1)return x("Duration must be at least 1 day","error");if(B.pendingImageFile)try{x("Uploading image...","info"),o=await Lc(B.pendingImageFile)}catch(k){console.error("Image upload failed:",k)}const i=tn.parseEther(s),l=parseInt(r)*86400;await Jt.createCampaign({title:n,description:a,goalAmount:i,duration:l,button:document.getElementById("btn-create"),onSuccess:async(k,T)=>{if(T)try{await fetch(Pa.saveCampaign,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:T,title:n,description:a,category:t,imageUrl:o,creator:c.userAddress})})}catch{}x("🎉 Campaign created!","success"),rt("create"),B.pendingImageFile=null,await Lt(),ut()},onError:k=>{var T;!k.cancelled&&k.type!=="user_rejected"&&x(((T=k.message)==null?void 0:T.slice(0,80))||"Failed","error")}})}async function Jf(){var a;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=B.currentCampaign;if(!e)return;const t=(a=document.getElementById("donate-amount"))==null?void 0:a.value;if(!t||parseFloat(t)<.001)return x("Minimum 0.001 ETH","error");const n=tn.parseEther(t);await Jt.donate({campaignId:e.id,amount:n,button:document.getElementById("btn-donate"),onSuccess:async()=>{x("❤️ Thank you for your donation!","success"),rt("donate"),await Lt(),ut()},onError:s=>{var r;!s.cancelled&&s.type!=="user_rejected"&&x(((r=s.message)==null?void 0:r.slice(0,80))||"Failed","error")}})}async function Zf(e){var a;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const t=(a=document.getElementById("detail-amount"))==null?void 0:a.value;if(!t||parseFloat(t)<.001)return x("Minimum 0.001 ETH","error");const n=tn.parseEther(t);await Jt.donate({campaignId:e,amount:n,button:document.getElementById("btn-donate-detail"),onSuccess:async()=>{x("❤️ Thank you for your donation!","success"),await Lt(),await St(e)},onError:s=>{var r;!s.cancelled&&s.type!=="user_rejected"&&x(((r=s.message)==null?void 0:r.slice(0,80))||"Failed","error")}})}async function Qf(e){if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");confirm("Cancel this campaign? This cannot be undone.")&&await Jt.cancel({campaignId:e,button:document.getElementById("btn-cancel"),onSuccess:async()=>{x("Campaign cancelled","success"),await Lt(),ut()},onError:t=>{var n;!t.cancelled&&t.type!=="user_rejected"&&x(((n=t.message)==null?void 0:n.slice(0,80))||"Failed","error")}})}async function eb(e){if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const t=B.campaigns.find(s=>s.id===e||s.id===String(e));if(!t)return;const n=Mn(t.raisedAmount,t.goalAmount);let a=`Withdraw ${ke(t.raisedAmount)} ETH?

5% platform fee applies.`;n<100&&(a+=`
Goal not reached - partial withdrawal.`),confirm(a)&&await Jt.withdraw({campaignId:e,button:document.getElementById(`btn-withdraw-${e}`)||document.getElementById("btn-withdraw"),onSuccess:async()=>{var s;x("✅ Funds withdrawn successfully!","success"),rt("my"),await Lt(),ut(),((s=B.currentCampaign)==null?void 0:s.id)===e&&await St(e)},onError:s=>{var r;!s.cancelled&&s.type!=="user_rejected"&&x(((r=s.message)==null?void 0:r.slice(0,80))||"Failed","error")}})}async function tb(){var i,l,d,u,f,m,b,p;if(!(c!=null&&c.isConnected))return x("Connect wallet","warning");const e=(i=document.getElementById("edit-campaign-id"))==null?void 0:i.value,t=(d=(l=document.getElementById("edit-title"))==null?void 0:l.value)==null?void 0:d.trim(),n=(f=(u=document.getElementById("edit-desc"))==null?void 0:u.value)==null?void 0:f.trim();let a=(b=(m=document.getElementById("edit-image-url"))==null?void 0:m.value)==null?void 0:b.trim();const s=document.querySelector("#modal-edit .cp-cat-option.selected input"),r=(s==null?void 0:s.value)||"humanitarian";if(!t)return x("Enter title","error");if(B.pendingImageFile)try{x("Uploading image...","info"),a=await Lc(B.pendingImageFile)}catch(g){console.error("Image upload failed:",g)}const o=document.getElementById("btn-save-edit");o&&(o.disabled=!0,o.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Saving...');try{await fetch(Pa.saveCampaign,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:e,title:t,description:n,category:r,imageUrl:a,creator:c.userAddress})}),x("✅ Campaign updated!","success"),rt("edit"),B.pendingImageFile=null,await Lt(),((p=B.currentCampaign)==null?void 0:p.id)===e?await St(e):ut()}catch{x("Failed to save","error")}finally{o&&(o.disabled=!1,o.innerHTML='<i class="fa-solid fa-check"></i> Save')}}function nb(e){const t=B.currentCampaign;if(!t)return;const n=Bc(t.id),a=`🙏 Support "${t.title}" on Backcoin Charity!

${ke(t.raisedAmount)} raised of ${ke(t.goalAmount)} goal.

`;let s;e==="twitter"?s=`https://twitter.com/intent/tweet?text=${encodeURIComponent(a)}&url=${encodeURIComponent(n)}`:e==="telegram"?s=`https://t.me/share/url?url=${encodeURIComponent(n)}&text=${encodeURIComponent(a)}`:e==="whatsapp"&&(s=`https://wa.me/?text=${encodeURIComponent(a+n)}`),s&&window.open(s,"_blank","width=600,height=400")}function ab(){const e=B.currentCampaign;e&&navigator.clipboard.writeText(Bc(e.id)).then(()=>x("Link copied!","success")).catch(()=>x("Copy failed","error"))}function Mc(){Ff(),B.currentCampaign=null,B.currentView="main",ut()}function sb(e){rt("my"),rt("donate"),rt("edit"),_f(e),St(e)}function rb(e){B.selectedCategory=B.selectedCategory===e?null:e,pr()}function ob(){B.selectedCategory=null,pr()}function pr(){const e=document.getElementById("cp-grid");if(!e)return;let t=B.campaigns.filter(n=>dr(n));B.selectedCategory&&(t=t.filter(n=>n.category===B.selectedCategory)),t.sort((n,a)=>Number(a.createdAt||0)-Number(n.createdAt||0)),e.innerHTML=t.length?t.map(n=>$c(n)).join(""):Rc("No campaigns")}async function St(e){B.currentView="detail",B.isLoading=!0;const t=hs();t&&(t.innerHTML=Hf());try{let n=B.campaigns.find(a=>a.id===e||a.id===String(e));if(!n){const a=c==null?void 0:c.publicProvider;if(a){const r=await new tn.Contract(w.charityPool,ur,a).campaigns(e);n={id:String(e),creator:r[0],title:r[1],description:r[2],goalAmount:BigInt(r[3].toString()),raisedAmount:BigInt(r[4].toString()),donationCount:Number(r[5]),deadline:Number(r[6]),createdAt:Number(r[7]),status:Number(r[8]),category:"humanitarian",imageUrl:null}}}B.currentCampaign=n,t&&(t.innerHTML=vo(n))}catch{t&&(t.innerHTML=vo(null))}finally{B.isLoading=!1}}function hs(){let e=document.getElementById("charity-container");if(e)return e;const t=document.getElementById("charity");return t?(e=document.createElement("div"),e.id="charity-container",t.innerHTML="",t.appendChild(e),e):null}function ut(){$f();const e=hs();if(!e)return;const t=Pc();t?St(t):(B.currentView="main",B.currentCampaign=null,e.innerHTML=ho(),Lt().then(()=>{if(B.currentView==="main"){const n=hs();n&&(n.innerHTML=ho())}}))}async function ib(){B.campaigns=[],B.stats=null,B.currentView==="detail"&&B.currentCampaign?await St(B.currentCampaign.id):ut()}window.addEventListener("hashchange",()=>{var e;if(window.location.hash.startsWith("#charity")){const t=Pc();t?((e=B.currentCampaign)==null?void 0:e.id)!==t&&St(t):B.currentView!=="main"&&Mc()}});const Dc={render(e){e&&ut()},update(){B.currentView==="main"&&pr()},refresh:ib,openModal:Dn,closeModal:rt,openCreate:Wf,openDonate:Gf,openMyCampaigns:Kf,openEdit:Yf,create:Xf,donate:Jf,donateDetail:Zf,cancel:Qf,withdraw:eb,saveEdit:tb,selCatOpt:Vf,setAmt:qf,goBack:Mc,viewCampaign:sb,selectCat:rb,clearCat:ob,share:nb,copyLink:ab,handleImageSelect:Df,removeImage:zc,switchImageTab:Of};window.CharityPage=Dc;const he=window.ethers,lb="https://sepolia.arbiscan.io/address/",cb=dd;function mr(){return w.backchat||w.Backchat||null}function nn(){return w.operator||w.treasury||null}const P={activeTab:"feed",view:"feed",posts:[],trendingPosts:[],userProfile:null,profiles:new Map,following:new Set,selectedPost:null,selectedProfile:null,fees:{post:0n,reply:0n,like:0n,follow:0n,repost:0n,superLikeMin:0n,boostMin:0n,badge:0n},pendingEth:0n,hasBadge:!1,isBoosted:!1,boostExpiry:0,badgeExpiry:0,referralStats:null,referredBy:null,isLoading:!1,isPosting:!1,contractAvailable:!0,error:null};function db(){if(document.getElementById("backchat-styles-v70"))return;const e=document.getElementById("backchat-styles-v69");e&&e.remove();const t=document.createElement("style");t.id="backchat-styles-v70",t.textContent=`
        /* ═══════════════════════════════════════════════════════════════════
    ...
    `,document.head.appendChild(t)}function fr(e){return e?`${e.slice(0,6)}...${e.slice(-4)}`:""}function ub(e){const n=Date.now()/1e3-e;return n<60?"now":n<3600?`${Math.floor(n/60)}m`:n<86400?`${Math.floor(n/3600)}h`:n<604800?`${Math.floor(n/86400)}d`:new Date(e*1e3).toLocaleDateString("en-US",{month:"short",day:"numeric"})}function Bt(e){if(!e||e===0n)return"0";const t=parseFloat(he.formatEther(e));return t<1e-4?"<0.0001":t<.01?t.toFixed(4):t<1?t.toFixed(3):t.toFixed(2)}function br(e){return e?e.slice(2,4).toUpperCase():"?"}function pb(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}function gr(){if(c.backchatContract)return c.backchatContract;if(c.backchatContractPublic)return c.backchatContractPublic;const e=mr();return e?c.publicProvider?new he.Contract(e,Io,c.publicProvider):null:(console.warn("Backchat address not found in deployment-addresses.json"),null)}function pt(){if(c.backchatContract)return c.backchatContract;const e=mr();return!e||!c.signer?null:new he.Contract(e,Io,c.signer)}async function wo(){try{const e=gr();if(!e)return;const t=await e.getCurrentFees();P.fees={post:t.postFee,reply:t.replyFee,like:t.likeFee,follow:t.followFee,repost:t.repostFee,superLikeMin:t.superLikeMin,boostMin:t.boostMin,badge:t.badgeFee_}}catch(e){console.warn("Failed to load fees:",e.message)}}async function yo(){if(!(!c.isConnected||!c.userAddress)){try{const e=gr();if(!e)return;const[t,n,a,s,r,o,i]=await Promise.all([e.getPendingBalance(c.userAddress).catch(()=>0n),e.hasTrustBadge(c.userAddress).catch(()=>!1),e.isProfileBoosted(c.userAddress).catch(()=>!1),e.boostExpiry(c.userAddress).catch(()=>0),e.badgeExpiry(c.userAddress).catch(()=>0),e.referredBy(c.userAddress).catch(()=>he.ZeroAddress),e.getReferralStats(c.userAddress).catch(()=>({totalReferred:0n,totalEarned:0n}))]);P.pendingEth=t,P.hasBadge=n,P.isBoosted=a,P.boostExpiry=Number(s),P.badgeExpiry=Number(r),P.referredBy=o&&o!==he.ZeroAddress?o:null,P.referralStats={totalReferred:Number(i.totalReferred),totalEarned:i.totalEarned,totalEarnedFormatted:he.formatEther(i.totalEarned)}}catch(e){console.warn("Failed to load user status:",e.message)}await mb()}}async function mb(){var e,t;try{if(!c.isConnected||!c.userAddress||P.referredBy)return;const n=localStorage.getItem("backchain_referrer");if(!n)return;if(n.toLowerCase()===c.userAddress.toLowerCase()){localStorage.removeItem("backchain_referrer");return}const a=pt();if(!a)return;console.log("[Referral] Auto-setting referrer:",n);const s=await a.setReferrer(n);x("Setting your referrer...","info"),await s.wait(),P.referredBy=n,localStorage.removeItem("backchain_referrer"),x("Referrer registered! They earn 30% of your fees.","success"),ze()}catch(n){console.warn("[Referral] Auto-set failed:",n.message),((e=n.message)!=null&&e.includes("ReferrerAlreadySet")||(t=n.message)!=null&&t.includes("already set"))&&localStorage.removeItem("backchain_referrer")}}async function ma(){P.isLoading=!0,ze();try{if(!mr()){P.contractAvailable=!1,P.error='Backchat contract not deployed yet. Add "backchat" to deployment-addresses.json',console.warn("⚠️ Backchat address not found in config");return}const t=gr();if(!t){P.contractAvailable=!1,P.error="Could not connect to Backchat contract";return}P.contractAvailable=!0;const n=await t.postCounter();if(Number(n)===0){P.posts=[];return}const s=t.filters.PostCreated(),r=await t.queryFilter(s,-1e4),o=t.filters.ReplyCreated(),i=await t.queryFilter(o,-1e4),l=t.filters.RepostCreated(),d=await t.queryFilter(l,-1e4),u=t.filters.SuperLiked(),f=await t.queryFilter(u,-1e4),m=new Map;for(const p of f){const g=p.args.postId.toString(),y=p.args.ethAmount,k=m.get(g)||0n;m.set(g,k+y)}const b=[];for(const p of r.slice(-50)){const g=await p.getBlock();b.push({id:p.args.postId.toString(),type:"post",author:p.args.author,content:p.args.content,mediaCID:p.args.mediaCID,timestamp:g.timestamp,superLikes:m.get(p.args.postId.toString())||0n,txHash:p.transactionHash})}for(const p of i.slice(-30)){const g=await p.getBlock();b.push({id:p.args.postId.toString(),type:"reply",parentId:p.args.parentId.toString(),author:p.args.author,content:p.args.content,mediaCID:p.args.mediaCID,tipBkc:p.args.tipBkc,timestamp:g.timestamp,superLikes:m.get(p.args.postId.toString())||0n,txHash:p.transactionHash})}for(const p of d.slice(-20)){const g=await p.getBlock();b.push({id:p.args.newPostId.toString(),type:"repost",originalPostId:p.args.originalPostId.toString(),author:p.args.reposter,timestamp:g.timestamp,txHash:p.transactionHash})}b.sort((p,g)=>g.timestamp-p.timestamp),P.posts=b,P.trendingPosts=[...b].filter(p=>p.superLikes>0n).sort((p,g)=>{const y=BigInt(p.superLikes||0),k=BigInt(g.superLikes||0);return k>y?1:k<y?-1:0})}catch(e){console.error("Failed to load posts:",e),P.error=e.message}finally{P.isLoading=!1,ze()}}async function fb(){var a;const e=document.getElementById("bc-compose-input"),t=(a=e==null?void 0:e.value)==null?void 0:a.trim();if(!t){x("Please write something","error");return}if(t.length>500){x("Post too long (max 500 chars)","error");return}const n=pt();if(!n){x("Please connect wallet","error");return}P.isPosting=!0,ze();try{const s=P.fees.post||await n.calculateFee(5e4),r=await n.createPost(t,"",nn()||he.ZeroAddress,{value:s});x("Posting...","info"),await r.wait(),x("Post created! 🎉","success"),e.value="",await ma()}catch(s){console.error("Post error:",s),s.code!=="ACTION_REJECTED"&&x("Failed: "+(s.reason||s.message),"error")}finally{P.isPosting=!1,ze()}}async function bb(e){var n;const t=pt();if(!t){x("Please connect wallet","error");return}try{const a=P.fees.like||await t.calculateFee(55e3),s=await t.like(e,nn()||he.ZeroAddress,0,{value:a});x("Liking...","info"),await s.wait(),x("Liked! ❤️","success")}catch(a){console.error("Like error:",a),a.code!=="ACTION_REJECTED"&&((n=a.message)!=null&&n.includes("AlreadyLiked")?x("Already liked this post","warning"):x("Failed: "+(a.reason||a.message),"error"))}}async function gb(e,t){const n=pt();if(!n){x("Please connect wallet","error");return}const a=he.parseEther(t);try{const s=await n.superLike(e,nn()||he.ZeroAddress,0,{value:a});x("Super liking...","info"),await s.wait(),x("Super Liked! ⭐","success"),await ma()}catch(s){console.error("Super like error:",s),s.code!=="ACTION_REJECTED"&&x("Failed: "+(s.reason||s.message),"error")}}async function xb(e){const t=pt();if(!t){x("Please connect wallet","error");return}try{const n=P.fees.follow||await t.calculateFee(45e3),a=await t.follow(e,nn()||he.ZeroAddress,0,{value:n});x("Following...","info"),await a.wait(),P.following.add(e.toLowerCase()),x("Followed! 👥","success"),ze()}catch(n){console.error("Follow error:",n),n.code!=="ACTION_REJECTED"&&x("Failed: "+(n.reason||n.message),"error")}}async function hb(){const e=pt();if(!e){x("Please connect wallet","error");return}if(P.pendingEth===0n){x("No earnings to withdraw","warning");return}try{const t=await e.withdraw();x("Withdrawing...","info"),await t.wait(),x(`Withdrawn ${Bt(P.pendingEth)} ETH! 💰`,"success"),P.pendingEth=0n,ze()}catch(t){console.error("Withdraw error:",t),t.code!=="ACTION_REJECTED"&&x("Failed: "+(t.reason||t.message),"error")}}function vb(){return`
        <div class="bc-header">
    ...
    `}function wb(){if(!c.isConnected)return"";const e=Bt(P.fees.post);return`
    ...
    `}function xr(e,t=0){const n=Bt(e.superLikes);return`
        <div class="bc-post" data-post-id="${e.id}" style="animation-delay:${Math.min(t*.04,.4)}s">
            <div class="bc-post-top">
                ...
                <div class="bc-post-head">
                    <div class="bc-post-author-row">
                        <span class="bc-author-name" onclick="BackchatPage.viewProfile('${e.author}')">${fr(e.author)}</span>
                        
                        <span class="bc-post-time">· ${ub(e.timestamp)}</span>
            ...
            ${e.content?`<div class="bc-post-body">${pb(e.content)}</div>`:""}
            
            ${e.mediaCID?`
                <div class="bc-post-media">
                    <img src="${cb}${e.mediaCID}" alt="Media" loading="lazy">
                </div>
            `:""}
    ...
    `}function yb(){return P.contractAvailable?P.isLoading?`
        ...
        `}function kb(){return P.trendingPosts.length===0?`
            <div class="bc-empty">
                <div class="bc-empty-glyph accent">
                    <i class="fa-solid fa-fire"></i>
                </div>
        ...
        ${P.trendingPosts.map((e,t)=>xr(e,t)).join("")}
    `}function Eb(){var t;if(!c.isConnected)return`
            <div class="bc-empty">
                <div class="bc-empty-glyph">
                    <i class="fa-solid fa-wallet"></i>
                </div>
        ...
        <div class="bc-profile-section">
            ...
            <div class="bc-profile-main">
                ...
                <div class="bc-profile-name-row">
                    <span class="bc-profile-name">${fr(c.userAddress)}</span>
                ...
                <div class="bc-profile-handle">
                    <a href="${lb}${c.userAddress}" target="_blank" rel="noopener">
            ...
            ${e.length===0?`<div class="bc-empty" style="padding:40px 20px;">
                  ...
                  </div>`:e.map((n,a)=>xr(n,a)).join("")}
        </div>
    `}function Tb(){var a,s;if(!c.isConnected)return"";const e=`${window.location.origin}/#backchat?ref=${c.userAddress}`,t=((a=P.referralStats)==null?void 0:a.totalReferred)||0,n=((s=P.referralStats)==null?void 0:s.totalEarnedFormatted)||"0.0";return`
        <div class="bc-referral-card">
            ...
            <div class="bc-referral-info" style="margin-top:12px;">
                ...
                ${P.referredBy?`<br>You were referred by <code style="font-size:11px;color:var(--bc-accent);">${fr(P.referredBy)}</code>`:""}
            </div>
        </div>
    `}function ze(){const e=document.getElementById("backchat-content");if(!e)return;let t="";switch(P.activeTab){case"feed":t=wb()+yb();break;case"trending":t=kb();break;case"profile":t=Eb();break}e.innerHTML=t}function Cb(){return`
        <!-- Super Like Modal -->
    ...
    `}function Ib(){db();const e=document.getElementById("backchat");e&&(e.innerHTML=`
        <div class="bc-shell">
            ${vb()}
            <div id="backchat-content"></div>
        </div>
        ${Cb()}
    `,ze())}let Oc=null;function Ab(e){Oc=e,document.getElementById("modal-superlike").classList.add("active")}async function Bb(){var t;const e=((t=document.getElementById("superlike-amount"))==null?void 0:t.value)||"0.001";za("superlike"),await gb(Oc,e)}function Pb(){document.getElementById("modal-badge").classList.add("active")}async function Nb(){za("badge");const e=pt();if(!e){x("Please connect wallet","error");return}try{const t=await e.obtainBadge(nn()||he.ZeroAddress,{value:P.fees.badge});x("Getting badge...","info"),await t.wait(),P.hasBadge=!0,x("Badge obtained! ✅","success"),ze()}catch(t){console.error("Badge error:",t),t.code!=="ACTION_REJECTED"&&x("Failed: "+(t.reason||t.message),"error")}}function zb(){document.getElementById("modal-boost").classList.add("active")}async function Lb(){var n;const e=((n=document.getElementById("boost-amount"))==null?void 0:n.value)||"0.001";za("boost");const t=pt();if(!t){x("Please connect wallet","error");return}try{const a=await t.boostProfile(nn()||he.ZeroAddress,{value:he.parseEther(e)});x("Boosting profile...","info"),await a.wait(),P.isBoosted=!0,x("Profile boosted! 🚀","success"),ze()}catch(a){console.error("Boost error:",a),a.code!=="ACTION_REJECTED"&&x("Failed: "+(a.reason||a.message),"error")}}function za(e){var t;(t=document.getElementById(`modal-${e}`))==null||t.classList.remove("active")}function Sb(e){const t=document.getElementById("bc-char-counter");if(!t)return;const n=e.value.length;t.textContent=`${n}/500`,t.className="bc-char-count",n>450?t.classList.add("danger"):n>350&&t.classList.add("warn")}const Hc={async render(e){e&&(Ib(),await Promise.all([wo(),yo(),ma()]))},async refresh(){await Promise.all([wo(),yo(),ma()])},setTab(e){P.activeTab=e,ze()},createPost:fb,like:bb,openSuperLike:Ab,confirmSuperLike:Bb,follow:xb,withdraw:hb,openBadge:Pb,confirmBadge:Nb,openBoost:zb,confirmBoost:Lb,closeModal:za,openEarnings(){P.activeTab="profile",ze()},_updateCharCount:Sb,copyReferralLink(){const e=`${window.location.origin}/#backchat?ref=${c.userAddress}`;navigator.clipboard.writeText(e).then(()=>x("Referral link copied!","success"),()=>x("Failed to copy","error"))},shareReferral(){const e=`${window.location.origin}/#backchat?ref=${c.userAddress}`,t="Join Backchat — earn crypto by posting, liking, and referring friends! 30% referral rewards.";navigator.share?navigator.share({title:"Backchat Referral",text:t,url:e}).catch(()=>{}):navigator.clipboard.writeText(`${t}
${e}`).then(()=>x("Referral message copied!","success"),()=>x("Failed to copy","error"))},viewProfile(e){x("Profile view coming soon!","info")},openReply(e){x("Reply coming soon!","info")},repost(e){x("Repost coming soon!","info")},openTip(e){x("BKC Tips coming soon!","info")}};window.BackchatPage=Hc;const Rb=window.inject||(()=>{console.warn("Dev Mode: Analytics disabled.")});if(window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1")try{Rb()}catch(e){console.error("Analytics Error:",e)}const hr="".toLowerCase();window.__ADMIN_WALLET__=hr;hr&&console.log("✅ Admin access granted");let kt=null,cn=null,Qa=!1;const pe={dashboard:Kl,mine:Ql,store:Hp,rewards:oa,actions:P0,charity:Dc,backchat:Hc,notary:uc,airdrop:cm,tokenomics:Vm,about:O0,admin:_m,rental:yc,socials:Af,creditcard:Bf,dex:H,dao:Pf,tutorials:Tc};function Uc(e){return!e||e.length<42?"...":`${e.slice(0,6)}...${e.slice(-4)}`}function $b(e){if(!e)return"0.00";const t=_(e);return t>=1e9?(t/1e9).toFixed(2)+"B":t>=1e6?(t/1e6).toFixed(2)+"M":t>=1e4?t.toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):t.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function an(e,t=!1){const n=document.querySelector("main > div.container"),a=document.querySelectorAll(".sidebar-link");if(!n){console.error("❌ Page container not found");return}const s=window.location.hash.includes("/");if(!(kt!==e||t||s)){pe[e]&&typeof pe[e].update=="function"&&pe[e].update(c.isConnected);return}console.log(`📍 Navigating: ${kt} → ${e} (force: ${t})`),cn&&typeof cn=="function"&&(cn(),cn=null),Array.from(n.children).forEach(l=>{l.tagName==="SECTION"&&(l.classList.add("hidden"),l.classList.remove("active"))});const o=document.getElementById("charity-container");o&&e!=="charity"&&(o.innerHTML=""),a.forEach(l=>{l.classList.remove("active"),l.classList.add("text-zinc-400","hover:text-white","hover:bg-zinc-700")});const i=document.getElementById(e);if(i&&pe[e]){i.classList.remove("hidden"),i.classList.add("active");const l=kt!==e;kt=e;const d=document.querySelector(`.sidebar-link[data-target="${e}"]`);d&&(d.classList.remove("text-zinc-400","hover:text-white","hover:bg-zinc-700"),d.classList.add("active")),pe[e]&&typeof pe[e].render=="function"&&pe[e].render(l||t),typeof pe[e].cleanup=="function"&&(cn=pe[e].cleanup),l&&window.scrollTo(0,0)}else e!=="dashboard"&&e!=="faucet"&&(console.warn(`Route '${e}' not found, redirecting to dashboard.`),an("dashboard",!0))}window.navigateTo=an;const ko="wallet-btn text-xs font-mono text-center max-w-fit whitespace-nowrap relative font-bold py-2 px-4 rounded-md transition-colors";function vr(e=!1){Qa||(Qa=!0,requestAnimationFrame(()=>{_b(e),Qa=!1}))}function _b(e){const t=document.getElementById("admin-link-container"),n=document.getElementById("statUserBalance"),a=document.getElementById("connectButtonDesktop"),s=document.getElementById("connectButtonMobile"),r=document.getElementById("mobileAppDisplay");let o=c.userAddress;const i=[a,s];if(c.isConnected&&o){const d=$b(c.currentUserBalance),f=`
            <div class="status-dot"></div>
            <span>${Uc(o)}</span>
            <div class="balance-pill">
                ${d} BKC
            </div>
        `;if(i.forEach(m=>{m&&(m.innerHTML=f,m.className=ko+" wallet-btn-connected")}),r&&(r.textContent="Backcoin.org",r.classList.add("text-white"),r.classList.remove("text-amber-400")),t){const m=o.toLowerCase()===hr;t.style.display=m?"block":"none"}n&&(n.textContent=d)}else{const d='<i class="fa-solid fa-plug"></i> Connect Wallet';i.forEach(u=>{u&&(u.innerHTML=d,u.className=ko+" wallet-btn-disconnected")}),r&&(r.textContent="Backcoin.org",r.classList.add("text-amber-400"),r.classList.remove("text-white")),t&&(t.style.display="none"),n&&(n.textContent="--")}const l=kt||"dashboard";e||!kt?an(l,!0):pe[l]&&typeof pe[l].update=="function"&&pe[l].update(c.isConnected)}function Fb(e){const{isConnected:t,address:n,isNewConnection:a,wasConnected:s}=e,r=a||t!==s;c.isConnected=t,n&&(c.userAddress=n),vr(r),t&&a?x(`Connected: ${Uc(n)}`,"success"):!t&&s&&x("Wallet disconnected.","info")}function Mb(){const e=document.getElementById("testnet-banner"),t=document.getElementById("close-testnet-banner");if(!(!e||!t)){if(localStorage.getItem("hideTestnetBanner")==="true"){e.remove();return}e.style.transform="translateY(0)",t.addEventListener("click",()=>{e.style.transform="translateY(100%)",setTimeout(()=>e.remove(),500),localStorage.setItem("hideTestnetBanner","true")})}}function Db(){const e=document.querySelectorAll(".sidebar-link"),t=document.getElementById("menu-btn"),n=document.getElementById("sidebar"),a=document.getElementById("sidebar-backdrop"),s=document.getElementById("connectButtonDesktop"),r=document.getElementById("connectButtonMobile"),o=document.getElementById("shareProjectBtn");Mb(),e.length>0&&e.forEach(l=>{l.addEventListener("click",async d=>{d.preventDefault();const u=l.dataset.target;if(u==="faucet"){x("Accessing Testnet Faucet...","info"),await zs("BKC")&&vr(!0);return}u&&(window.location.hash=u,an(u,!0),n&&n.classList.contains("translate-x-0")&&(n.classList.remove("translate-x-0"),n.classList.add("-translate-x-full"),a&&a.classList.add("hidden")))})});const i=()=>{jo()};s&&s.addEventListener("click",i),r&&r.addEventListener("click",i),o&&o.addEventListener("click",()=>sd(c.userAddress)),t&&n&&a&&(t.addEventListener("click",()=>{n.classList.contains("translate-x-0")?(n.classList.add("-translate-x-full"),n.classList.remove("translate-x-0"),a.classList.add("hidden")):(n.classList.remove("-translate-x-full"),n.classList.add("translate-x-0"),a.classList.remove("hidden"))}),a.addEventListener("click",()=>{n.classList.add("-translate-x-full"),n.classList.remove("translate-x-0"),a.classList.add("hidden")}))}function jc(){const e=window.location.hash.replace("#","");if(!e)return"dashboard";const t=e.split(/[/?]/)[0];return pe[t]?t:"dashboard"}function Wc(){try{const e=window.location.hash,t=e.indexOf("?");if(t===-1)return;const a=new URLSearchParams(e.substring(t)).get("ref");a&&/^0x[a-fA-F0-9]{40}$/.test(a)&&(localStorage.getItem("backchain_referrer")||(localStorage.setItem("backchain_referrer",a),console.log("[Referral] Captured referrer from URL:",a)))}catch(e){console.warn("[Referral] Failed to parse referral param:",e.message)}}window.addEventListener("load",async()=>{console.log("🚀 App Initializing..."),Be.earn||(Be.earn=document.getElementById("mine"));try{if(!await ud())throw new Error("Failed to load contract addresses")}catch(n){console.error("❌ Critical Initialization Error:",n),x("Initialization failed. Please refresh.","error");return}Db(),await lu(),cu(Fb),rd();const e=document.getElementById("preloader");e&&(e.style.display="none"),Wc();const t=jc();console.log("📍 Initial page from URL:",t,"Hash:",window.location.hash),an(t,!0),console.log("✅ App Ready.")});window.addEventListener("hashchange",()=>{Wc();const e=jc(),t=window.location.hash;console.log("🔄 Hash changed to:",e,"Full hash:",t),e!==kt?an(e,!0):e==="charity"&&pe[e]&&typeof pe[e].render=="function"&&pe[e].render(!0)});window.EarnPage=Ql;window.openConnectModal=jo;window.disconnectWallet=du;window.updateUIState=vr;export{Et as C,q as E,Au as G,oe as N,Pu as T,X as V,Y as _,Fa as a,Ma as b,h as c,Da as d,ee as e,Bu as f,Ls as g,qo as h,zu as i,Lu as j,qe as k,Su as l,Io as m,Mt as n,w as o,R as p,ce as r,Nu as s,Z as t};
