import{defaultConfig as ti,createWeb3Modal as si}from"https://esm.sh/@web3modal/ethers@5.1.11?bundle";import{initializeApp as ni}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-app.js";import{getAuth as ai,onAuthStateChanged as ii,signInAnonymously as oi}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-auth.js";import{getFirestore as ri,doc as _,getDoc as ne,writeBatch as vt,increment as le,collection as ye,query as Fe,where as Mt,orderBy as Ge,getDocs as ze,limit as li,serverTimestamp as Ce,updateDoc as Yt,setDoc as Kt,Timestamp as un,addDoc as ci,deleteDoc as di}from"https://www.gstatic.com/firebasejs/9.15.0/firebase-firestore.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function s(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(a){if(a.ep)return;a.ep=!0;const i=s(a);fetch(a.href,i)}})();const ie={sidebar:document.getElementById("sidebar"),sidebarBackdrop:document.getElementById("sidebar-backdrop"),menuBtn:document.getElementById("menu-btn"),navLinks:document.getElementById("nav-links"),mainContentSections:document.querySelectorAll("main section"),connectButtonDesktop:document.getElementById("connectButtonDesktop"),connectButtonMobile:document.getElementById("connectButtonMobile"),mobileAppDisplay:document.getElementById("mobileAppDisplay"),desktopDisconnected:document.getElementById("desktopDisconnected"),desktopConnectedInfo:document.getElementById("desktopConnectedInfo"),desktopUserAddress:document.getElementById("desktopUserAddress"),desktopUserBalance:document.getElementById("desktopUserBalance"),modalContainer:document.getElementById("modal-container"),toastContainer:document.getElementById("toast-container"),dashboard:document.getElementById("dashboard"),earn:document.getElementById("mine"),store:document.getElementById("store"),rental:document.getElementById("rental"),rewards:document.getElementById("rewards"),actions:document.getElementById("actions"),presale:document.getElementById("presale"),faucet:document.getElementById("faucet"),airdrop:document.getElementById("airdrop"),dao:document.getElementById("dao"),about:document.getElementById("about"),admin:document.getElementById("admin"),tokenomics:document.getElementById("tokenomics"),notary:document.getElementById("notary"),statTotalSupply:document.getElementById("statTotalSupply"),statValidators:document.getElementById("statValidators"),statTotalPStake:document.getElementById("statTotalPStake"),statScarcity:document.getElementById("statScarcity"),statLockedPercentage:document.getElementById("statLockedPercentage"),statUserBalance:document.getElementById("statUserBalance"),statUserPStake:document.getElementById("statUserPStake"),statUserRewards:document.getElementById("statUserRewards")},ui={provider:null,publicProvider:null,web3Provider:null,signer:null,userAddress:null,isConnected:!1,bkcTokenContract:null,delegationManagerContract:null,rewardBoosterContract:null,nftLiquidityPoolContract:null,actionsManagerContract:null,fortunePoolContract:null,faucetContract:null,decentralizedNotaryContract:null,ecosystemManagerContract:null,publicSaleContract:null,rentalManagerContract:null,bkcTokenContractPublic:null,delegationManagerContractPublic:null,faucetContractPublic:null,fortunePoolContractPublic:null,rentalManagerContractPublic:null,ecosystemManagerContractPublic:null,actionsManagerContractPublic:null,currentUserBalance:0n,currentUserNativeBalance:0n,userTotalPStake:0n,userDelegations:[],myBoosters:[],activityHistory:[],totalNetworkPStake:0n,allValidatorsData:[],systemFees:{},systemPStakes:{},boosterDiscounts:{},notaryFee:void 0,notaryMinPStake:void 0},pi={set(e,t,s){return e[t]=s,["currentUserBalance","isConnected","userTotalPStake","totalNetworkPStake"].includes(t)&&window.updateUIState&&window.updateUIState(),!0}},c=new Proxy(ui,pi);let pn=!1;const b=(e,t="info",s=null)=>{if(!ie.toastContainer)return;const n={success:{icon:"fa-check-circle",color:"bg-green-600",border:"border-green-400"},error:{icon:"fa-exclamation-triangle",color:"bg-red-600",border:"border-red-400"},info:{icon:"fa-info-circle",color:"bg-blue-600",border:"border-blue-400"},warning:{icon:"fa-exclamation-circle",color:"bg-yellow-600",border:"border-yellow-400"}},a=n[t]||n.info,i=document.createElement("div");i.className=`flex items-center w-full max-w-xs p-4 text-white rounded-lg shadow-lg transition-all duration-500 ease-out 
    ...
    `;if(s){const r=`https://sepolia.arbiscan.io/tx/${s}`;o+=`<a href="${r}" target="_blank" title="View on Arbiscan" class="ml-3 flex-shrink-0 text-white/80 hover:text-white transition-colors">
                ...
                </button>`,i.innerHTML=o,ie.toastContainer.appendChild(i),requestAnimationFrame(()=>{i.classList.remove("translate-x-full","opacity-0"),i.classList.add("translate-x-0","opacity-100")}),setTimeout(()=>{i.classList.remove("translate-x-0","opacity-100"),i.classList.add("translate-x-full","opacity-0"),setTimeout(()=>i.remove(),500)},5e3)},ae=()=>{if(!ie.modalContainer)return;const e=document.getElementById("modal-backdrop");if(e){const t=document.getElementById("modal-content");t&&(t.classList.remove("animate-fade-in-up"),t.classList.add("animate-fade-out-down")),e.classList.remove("opacity-100"),e.classList.add("opacity-0"),setTimeout(()=>{ie.modalContainer.innerHTML=""},300)}},ut=(e,t="max-w-md",s=!0)=>{var i,o;if(!ie.modalContainer)return;const a=`
    ...
    `;ut(o,"max-w-md")}const fn=e=>{window.navigateTo?window.navigateTo(e):console.error("navigateTo function not found."),ae()};function bi(){var a,i,o,r;if(pn)return;pn=!0;const e="https://backcoin.org/presale",t="https://t.me/BackCoinorg";ut(`
    ...
    `,"max-w-sm",!1);const n=document.getElementById("modal-content");n&&((a=n.querySelector("#btnPresale"))==null||a.addEventListener("click",()=>{window.open(e,"_blank"),ae()}),(i=n.querySelector("#btnAirdrop"))==null||i.addEventListener("click",()=>{fn("airdrop")}),(o=n.querySelector("#btnSocials"))==null||o.addEventListener("click",()=>{fn("socials")}),(r=n.querySelector("#btnTelegram"))==null||r.addEventListener("click",()=>{window.open(t,"_blank")}))}const gi=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1";console.log(`Environment: ${gi?"DEVELOPMENT":"PRODUCTION"}`);const Jn="ZWla0YY4A0Hw7e_rwyOXB",Se=[{name:"Alchemy",url:`https://arb-sepolia.g.alchemy.com/v2/${Jn}`,priority:1,isPublic:!1,corsCompatible:!0},{name:"BlockPI",url:"https://arbitrum-sepolia.blockpi.network/v1/rpc/public",priority:2,isPublic:!0,corsCompatible:!0},{name:"PublicNode",url:"https://arbitrum-sepolia-rpc.publicnode.com",priority:3,isPublic:!0,corsCompatible:!0},{name:"Arbitrum Official",url:"https://sepolia-rollup.arbitrum.io/rpc",priority:4,isPublic:!0,corsCompatible:!1}].filter(e=>e.url!==null),Hs=`https://arb-sepolia.g.alchemy.com/v2/${Jn}`;let be=0,pt=new Map;function ft(){var e;return((e=Se[be])==null?void 0:e.url)||Hs}function Qn(){const e=be;do{be=(be+1)%Se.length;const s=Se[be];if(!s.corsCompatible){console.warn(`⏭️ Skipping ${s.name} (CORS incompatible)`);continue}if(be===e)return console.warn("⚠️ All RPCs have been tried. Resetting to primary."),be=0,Se[0].url}while(pt.get(Se[be].url)==="unhealthy");const t=Se[be];return console.log(`🔄 Switched to RPC: ${t.name}`),t.url}function xi(e){pt.set(e,"unhealthy"),console.warn(`❌ RPC marked unhealthy: ${e}`),setTimeout(()=>{pt.delete(e),console.log(`♻️ RPC health reset: ${e}`)},6e4)}function vi(e){pt.set(e,"healthy")}function hi(){be=0,pt.clear(),console.log(`✅ Reset to primary RPC: ${Se[0].name}`)}const K="https://white-defensive-eel-240.mypinata.cloud/ipfs/",v={},wi={bkcToken:null,ecosystemManager:null,delegationManager:null,rewardBoosterNFT:null,rentalManager:null,nftLiquidityPoolFactory:null,fortunePool:null,fortunePoolV2:null,backchainRandomness:null,publicSale:null,decentralizedNotary:null,faucet:null,miningManager:null};async function yi(){try{const e=await fetch(`./deployment-addresses.json?t=${Date.now()}`);if(!e.ok)throw new Error(`Failed to fetch deployment-addresses.json: ${e.status}`);const t=await e.json(),n=["bkcToken","delegationManager","ecosystemManager","miningManager"].filter(a=>!t[a]);if(n.length>0)throw new Error(`Missing required addresses: ${n.join(", ")}`);return Object.assign(v,t),v.fortunePoolV2=t.fortunePoolV2||t.fortunePool,v.fortunePool=t.fortunePool,v.actionsManager=t.fortunePool,v.rentalManager=t.rentalManager||t.RentalManager||t.rental_manager||null,v.decentralizedNotary=t.decentralizedNotary||t.notary||t.Notary||null,v.bkcDexPoolAddress=t.bkcDexPoolAddress||"#",v.backchainRandomness=t.backchainRandomness||null,Object.assign(wi,t),console.log("✅ Contract addresses loaded"),console.log("   FortunePool V2:",v.fortunePoolV2),!0}catch(e){return console.error("❌ Failed to load contract addresses:",e),!1}}const te=[{name:"Diamond",boostBips:7e3,color:"text-cyan-400",img:`${K}bafybeicgip72jcqgsirlrhn3tq5cc226vmko6etnndzl6nlhqrktfikafq/diamond_booster.json`,realImg:`${K}bafybeicgip72jcqgsirlrhn3tq5cc226vmko6etnndzl6nlhqrktfikafq`,borderColor:"border-cyan-400/50",glowColor:"bg-cyan-500/10"},{name:"Platinum",boostBips:6e3,color:"text-gray-300",img:`${K}bafybeigc2wgkccckhnjotejve7qyxa2o2z4fsgswfmsxyrbp5ncpc7plei/platinum_booster.json`,realImg:`${K}bafybeigc2wgkccckhnjotejve7qyxa2o2z4fsgswfmsxyrbp5ncpc7plei`,borderColor:"border-gray-300/50",glowColor:"bg-gray-400/10"},{name:"Gold",boostBips:5e3,color:"text-amber-400",img:`${K}bafybeifponccrbicg2pcjrn2hrfoqgc77xhm2r4ld7hdpw6cxxkbsckf44/gold_booster.json`,realImg:`${K}bafybeifponccrbicg2pcjrn2hrfoqgc77xhm2r4ld7hdpw6cxxkbsckf44`,borderColor:"border-amber-400/50",glowColor:"bg-amber-500/10"},{name:"Silver",boostBips:4e3,color:"text-gray-400",img:`${K}bafybeihvi2inujm5zpi7tl667g4srq273536pjkglwyrtbwmgnskmu7jg4/silver_booster.json`,realImg:`${K}bafybeihvi2inujm5zpi7tl667g4srq273536pjkglwyrtbwmgnskmu7jg4`,borderColor:"border-gray-400/50",glowColor:"bg-gray-500/10"},{name:"Bronze",boostBips:3e3,color:"text-yellow-600",img:`${K}bafybeiclqidb67rt3tchhjpsib62s624li7j2bpxnr6b5w5mfp4tomhu7m/bronze_booster.json`,realImg:`${K}bafybeiclqidb67rt3tchhjpsib62s624li7j2bpxnr6b5w5mfp4tomhu7m`,borderColor:"border-yellow-600/50",glowColor:"bg-yellow-600/10"},{name:"Iron",boostBips:2e3,color:"text-slate-500",img:`${K}bafybeiaxhv3ere2hyto4dlb5xqn46ehfglxqf3yzehpy4tvdnifyzpp4wu/iron_booster.json`,realImg:`${K}bafybeiaxhv3ere2hyto4dlb5xqn46ehfglxqf3yzehpy4tvdnifyzpp4wu`,borderColor:"border-slate-500/50",glowColor:"bg-slate-600/10"},{name:"Crystal",boostBips:1e3,color:"text-indigo-300",img:`${K}bafybeib6nacggrhgcp72xksbhsqcofg3lzhfb576kuebj5ioxpk2id5m7u/crystal_booster.json`,realImg:`${K}bafybeib6nacggrhgcp72xksbhsqcofg3lzhfb576kuebj5ioxpk2id5m7u`,borderColor:"border-indigo-300/50",glowColor:"bg-indigo-300/10"}],_s=["function name() view returns (string)","function symbol() view returns (string)","function decimals() view returns (uint8)","function totalSupply() view returns (uint256)","function balanceOf(address owner) view returns (uint256)","function transfer(address to, uint256 amount) returns (bool)","function approve(address spender, uint256 amount) returns (bool)","function allowance(address owner, address spender) view returns (uint256)","function transferFrom(address from, address to, uint256 amount) returns (bool)","function MAX_SUPPLY() view returns (uint256)","function TGE_SUPPLY() view returns (uint256)","function remainingMintableSupply() view returns (uint256)","event Transfer(address indexed from, address indexed to, uint256 value)","event Approval(address indexed owner, address indexed spender, uint256 value)"],je=["function totalNetworkPStake() view returns (uint256)","function userTotalPStake(address _user) view returns (uint256)","function pendingRewards(address _user) view returns (uint256)","function MIN_LOCK_DURATION() view returns (uint256)","function MAX_LOCK_DURATION() view returns (uint256)","function getDelegationsOf(address _user) view returns (tuple(uint256 amount, uint64 unlockTime, uint64 lockDuration)[])","function delegate(uint256 _amount, uint256 _lockDuration, uint256 _boosterTokenId) external","function unstake(uint256 _delegationIndex, uint256 _boosterTokenId) external","function forceUnstake(uint256 _delegationIndex, uint256 _boosterTokenId) external","function claimReward(uint256 _boosterTokenId) external","function getUnstakePenaltyBips() view returns (uint256)","event Delegated(address indexed user, uint256 amount, uint256 lockDuration, uint256 pStake)","event Unstaked(address indexed user, uint256 amount, uint256 pStakeReduced)","event RewardClaimed(address indexed user, uint256 amount)"],ki=["function balanceOf(address owner) view returns (uint256)","function tokenOfOwnerByIndex(address owner, uint256 index) view returns (uint256)","function ownerOf(uint256 tokenId) view returns (address)","function approve(address to, uint256 tokenId)","function setApprovalForAll(address operator, bool approved)","function safeTransferFrom(address from, address to, uint256 tokenId)","function boostBips(uint256 _tokenId) view returns (uint256)","function tokenURI(uint256 tokenId) view returns (string)","function totalSupply() view returns (uint256)","event Transfer(address indexed from, address indexed to, uint256 indexed tokenId)","event Approval(address indexed owner, address indexed approved, uint256 indexed tokenId)"],Ee=["function listNFT(uint256 _tokenId, uint256 _pricePerHour, uint256 _minHours, uint256 _maxHours) external","function updateListing(uint256 _tokenId, uint256 _newPricePerHour, uint256 _newMinHours, uint256 _newMaxHours) external","function withdrawNFT(uint256 _tokenId) external","function rentNFT(uint256 _tokenId, uint256 _hours) external","function getListing(uint256 _tokenId) view returns (tuple(address owner, uint256 pricePerHour, uint256 minHours, uint256 maxHours, bool isActive, uint256 totalEarnings, uint256 rentalCount))","function getRental(uint256 _tokenId) view returns (tuple(address tenant, uint256 startTime, uint256 endTime, uint256 paidAmount))","function isRented(uint256 _tokenId) view returns (bool)","function hasRentalRights(uint256 _tokenId, address _user) view returns (bool)","function getRemainingRentalTime(uint256 _tokenId) view returns (uint256)","function getAllListedTokenIds() view returns (uint256[])","function getListingCount() view returns (uint256)","function getRentalCost(uint256 _tokenId, uint256 _hours) view returns (uint256 totalCost, uint256 protocolFee, uint256 ownerPayout)","function getMarketplaceStats() view returns (uint256 activeListings, uint256 totalVol, uint256 totalFees, uint256 rentals)","event NFTListed(uint256 indexed tokenId, address indexed owner, uint256 pricePerHour, uint256 minHours, uint256 maxHours)","event NFTRented(uint256 indexed tokenId, address indexed tenant, address indexed owner, uint256 hours_, uint256 totalCost, uint256 protocolFee, uint256 ownerPayout, uint256 endTime)","event NFTWithdrawn(uint256 indexed tokenId, address indexed owner)","event RentalExpired(uint256 indexed tokenId, address indexed tenant)"],Us=["function getBuyPrice() view returns (uint256)","function getSellPrice() view returns (uint256)","function getBuyPriceWithTax() view returns (uint256)","function getSellPriceAfterTax() view returns (uint256)","function buyNFT() external payable returns (uint256)","function buySpecificNFT(uint256 _tokenId) external payable","function buyNFTWithSlippage(uint256 _maxPrice) external payable returns (uint256)","function sellNFT(uint256 _tokenId, uint256 _minPayout) external","function getPoolInfo() view returns (uint256 tokenBalance, uint256 nftCount, uint256 k, bool isInitialized)","function getAvailableNFTs() view returns (uint256[])","function boostBips() view returns (uint256)","event NFTPurchased(address indexed buyer, uint256 indexed tokenId, uint256 price, uint256 tax, uint256 newBkcBalance, uint256 newNftCount)","event NFTSold(address indexed seller, uint256 indexed tokenId, uint256 payout, uint256 tax, uint256 newBkcBalance, uint256 newNftCount)"],Os=["function participate(uint256 _wagerAmount, uint256[] calldata _guesses, bool _isCumulative) external payable","function oracleFee() view returns (uint256)","function gameFeeBips() view returns (uint256)","function getRequiredOracleFee(bool _isCumulative) view returns (uint256)","function activeTierCount() view returns (uint256)","function gameCounter() view returns (uint256)","function prizePoolBalance() view returns (uint256)","function getExpectedGuessCount(bool _isCumulative) view returns (uint256)","function isGameFulfilled(uint256 _gameId) view returns (bool)","function getGameResults(uint256 _gameId) view returns (uint256[])","function getJackpotTierId() view returns (uint256)","function getJackpotTier() view returns (uint256 tierId, uint128 maxRange, uint64 multiplierBips, bool active)","function getAllTiers() view returns (uint128[] ranges, uint64[] multipliers)","function prizeTiers(uint256 tierId) view returns (uint128 maxRange, uint64 multiplierBips, bool active)","function calculatePotentialWinnings(uint256 _wagerAmount, bool _isCumulative) view returns (uint256 maxPrize, uint256 netWager)","event GameRequested(uint256 indexed gameId, address indexed player, uint256 wagerAmount, uint256[] guesses, bool isCumulative, uint256 targetTier)","event GameFulfilled(uint256 indexed gameId, address indexed player, uint256 prizeWon, uint256[] rolls, uint256[] guesses, bool isCumulative)"],Ws=["function play(uint256 _wagerAmount, uint256[] calldata _guesses, bool _isCumulative) external payable returns (uint256 gameId, uint256[] memory rolls, uint256 prizeWon)","function serviceFee() view returns (uint256)","function getRequiredServiceFee(bool _isCumulative) view returns (uint256)","function prizePoolBalance() view returns (uint256)","function gameCounter() view returns (uint256)","function activeTierCount() view returns (uint256)","function gameFeeBips() view returns (uint256)","function getExpectedGuessCount(bool _isCumulative) view returns (uint256)","function getTier(uint256 _tierId) view returns (uint128 maxRange, uint64 multiplierBips, bool active)","function getAllTiers() view returns (uint128[] ranges, uint64[] multipliers)","function calculatePotentialWinnings(uint256 _wagerAmount, bool _isCumulative) view returns (uint256 maxPrize, uint256 netWager, uint256 fee)","function getGameResult(uint256 _gameId) view returns (address player, uint256 wagerAmount, uint256 prizeWon, uint256 timestamp, bool isCumulative, uint256 matchCount)","function getGameDetails(uint256 _gameId) view returns (address player, uint256 wagerAmount, uint256 prizeWon, uint256[] guesses, uint256[] rolls, bool[] matches, bool isCumulative)","function getPlayerStats(address _player) view returns (uint256 gamesPlayed, uint256 totalWageredAmount, uint256 totalWonAmount, int256 netProfit)","function getPoolStats() view returns (uint256 poolBalance, uint256 gamesPlayed, uint256 wageredAllTime, uint256 paidOutAllTime, uint256 winsAllTime, uint256 currentFee)","event GamePlayed(uint256 indexed gameId, address indexed player, uint256 wagerAmount, uint256 prizeWon, bool isCumulative, uint8 matchCount)","event GameDetails(uint256 indexed gameId, uint256[] guesses, uint256[] rolls, bool[] matches)","event JackpotWon(uint256 indexed gameId, address indexed player, uint256 prizeAmount, uint256 tier)"],Gt=["function tiers(uint256 tierId) view returns (uint256 priceInWei, uint64 maxSupply, uint64 mintedCount, uint16 boostBips, bool isConfigured, bool isActive, string metadataFile, string name)","function buyNFT(uint256 _tierId) external payable","function buyMultipleNFTs(uint256 _tierId, uint256 _quantity) external payable","function getTierPrice(uint256 _tierId) view returns (uint256)","function getTierSupply(uint256 _tierId) view returns (uint64 maxSupply, uint64 mintedCount)","function isTierActive(uint256 _tierId) view returns (bool)","event NFTSold(address indexed buyer, uint256 indexed tierId, uint256 indexed tokenId, uint256 price)"],Ts=["function balanceOf(address owner) view returns (uint256)","function tokenURI(uint256 tokenId) view returns (string)","function ownerOf(uint256 tokenId) view returns (address)","function getDocument(uint256 tokenId) view returns (tuple(string ipfsCid, string description, bytes32 contentHash, uint256 timestamp))","function documents(uint256 tokenId) view returns (string ipfsCid, string description, bytes32 contentHash, uint256 timestamp)","function getBaseFee() view returns (uint256)","function calculateFee(uint256 _boosterTokenId) view returns (uint256)","function notarize(string _ipfsCid, string _description, bytes32 _contentHash, uint256 _boosterTokenId) external returns (uint256)","event DocumentNotarized(uint256 indexed tokenId, address indexed owner, string ipfsCid, bytes32 indexed contentHash, uint256 feePaid)"],qs=["function canClaim(address _user) view returns (bool)","function getCooldownRemaining(address _user) view returns (uint256)","function getUserInfo(address _user) view returns (uint256 lastClaimTime, uint256 totalClaimed)","function getFaucetStatus() view returns (uint256 bkcBalance, uint256 ethBalance, bool isActive)","function COOLDOWN_PERIOD() view returns (uint256)","function TOKEN_AMOUNT() view returns (uint256)","function ETH_AMOUNT() view returns (uint256)","event TokensDistributed(address indexed recipient, uint256 tokenAmount, uint256 ethAmount, address indexed relayer)"],Ys=["function getServiceRequirements(bytes32 _serviceKey) view returns (uint256 fee, uint256 pStake)","function getFee(bytes32 _serviceKey) view returns (uint256)","function getBoosterDiscount(uint256 _boostBips) view returns (uint256)","function getMiningDistributionBips() view returns (uint256 stakingBips, uint256 minerBips, uint256 treasuryBips)","function getFeeDistributionBips() view returns (uint256 burnBips, uint256 treasuryBips, uint256 poolBips)","function getTreasuryAddress() view returns (address)","function getDelegationManagerAddress() view returns (address)","function getBKCTokenAddress() view returns (address)","function getBoosterAddress() view returns (address)","function getNFTLiquidityPoolFactoryAddress() view returns (address)","function getMiningManagerAddress() view returns (address)","function getFortunePoolAddress() view returns (address)","function getNotaryAddress() view returns (address)","function getRentalManagerAddress() view returns (address)","function getPublicSaleAddress() view returns (address)","function isInitialized() view returns (bool)","function owner() view returns (address)"],Ti=window.ethers,zi=5e3,Ci=6e4,Bi=15e3,Ei=3e4,Ii=1e4;let is=null,mn=0;const bn=new Map,os=new Map,gn=new Map,xn=e=>new Promise(t=>setTimeout(t,e));async function Vt(e,t){const s=new AbortController,n=setTimeout(()=>s.abort(),t);try{const a=await fetch(e,{signal:s.signal});return clearTimeout(n),a}catch(a){throw clearTimeout(n),a.name==="AbortError"?new Error("API request timed out."):a}}const ce={getHistory:"https://gethistory-4wvdcuoouq-uc.a.run.app",getBoosters:"https://getboosters-4wvdcuoouq-uc.a.run.app",getSystemData:"https://getsystemdata-4wvdcuoouq-uc.a.run.app",getNotaryHistory:"https://getnotaryhistory-4wvdcuoouq-uc.a.run.app",getRentalListings:"https://getrentallistings-4wvdcuoouq-uc.a.run.app",getUserRentals:"https://getuserrentals-4wvdcuoouq-uc.a.run.app",fortuneGames:"https://getfortunegames-4wvdcuoouq-uc.a.run.app",uploadFileToIPFS:"/api/upload",claimAirdrop:"https://us-central1-airdropbackchainnew.cloudfunctions.net/claimAirdrop"};function Zn(e){var t;return((t=e==null?void 0:e.error)==null?void 0:t.code)===429||(e==null?void 0:e.code)===429||e.message&&(e.message.includes("429")||e.message.includes("Too Many Requests")||e.message.includes("rate limit"))}function ea(e){var s,n;const t=((s=e==null?void 0:e.error)==null?void 0:s.code)||(e==null?void 0:e.code);return t===-32603||t===-32e3||((n=e.message)==null?void 0:n.includes("Internal JSON-RPC"))}function Xt(e,t,s){if(s)return s;if(!e||!c.publicProvider)return null;try{return new Ti.Contract(e,t,c.publicProvider)}catch{return null}}const O=async(e,t,s=[],n=0n,a=2,i=!1)=>{if(!e)return n;const o=e.target||e.address,r=JSON.stringify(s,(f,p)=>typeof p=="bigint"?p.toString():p),l=`${o}-${t}-${r}`,d=Date.now(),u=["getPoolInfo","getBuyPrice","getSellPrice","getAvailableTokenIds","getAllListedTokenIds","tokenURI","boostBips","getListing","balanceOf","totalSupply","totalNetworkPStake","MAX_SUPPLY","TGE_SUPPLY","userTotalPStake","pendingRewards","isRented","getRental","ownerOf","getDelegationsOf","allowance","prizeTiers","activeTierCount","prizePoolBalance"];if(!i&&u.includes(t)){const f=bn.get(l);if(f&&d-f.timestamp<Bi)return f.value}for(let f=0;f<=a;f++)try{const p=await e[t](...s);return u.includes(t)&&bn.set(l,{value:p,timestamp:d}),p}catch(p){if(Zn(p)&&f<a){const g=Math.floor(Math.random()*1e3),m=1e3*Math.pow(2,f)+g;await xn(m);continue}if(ea(p)&&f<a){await xn(500);continue}break}return n},$i=async(e,t,s=!1)=>{const n=`balance-${(e==null?void 0:e.target)||(e==null?void 0:e.address)}-${t}`,a=Date.now();if(!s){const o=gn.get(n);if(o&&a-o.timestamp<Ii)return o.value}const i=await O(e,"balanceOf",[t],0n,2,s);return gn.set(n,{value:i,timestamp:a}),i};async function ta(){c.systemFees||(c.systemFees={}),c.systemPStakes||(c.systemPStakes={}),c.boosterDiscounts||(c.boosterDiscounts={});const e=Date.now();if(is&&e-mn<Ci)return vn(is),!0;try{const t=await Vt(ce.getSystemData,zi);if(!t.ok)throw new Error(`API Status: ${t.status}`);const s=await t.json();return vn(s),is=s,mn=e,!0}catch{return c.systemFees.NOTARY_SERVICE||(c.systemFees.NOTARY_SERVICE=100n),c.systemFees.CLAIM_REWARD_FEE_BIPS||(c.systemFees.CLAIM_REWARD_FEE_BIPS=500n),!1}}function vn(e){if(e.fees)for(const t in e.fees)try{c.systemFees[t]=BigInt(e.fees[t])}catch{c.systemFees[t]=0n}if(e.pStakeRequirements)for(const t in e.pStakeRequirements)try{c.systemPStakes[t]=BigInt(e.pStakeRequirements[t])}catch{c.systemPStakes[t]=0n}if(e.discounts)for(const t in e.discounts)try{c.boosterDiscounts[t]=BigInt(e.discounts[t])}catch{c.boosterDiscounts[t]=0n}if(e.oracleFeeInWei){c.systemData=c.systemData||{};try{c.systemData.oracleFeeInWei=BigInt(e.oracleFeeInWei)}catch{c.systemData.oracleFeeInWei=0n}}}async function Ks(){!c.publicProvider||!c.bkcTokenContractPublic||await Promise.allSettled([O(c.bkcTokenContractPublic,"totalSupply",[],0n),ta()])}async function X(e=!1){var t;if(!(!c.isConnected||!c.userAddress))try{const[s,n]=await Promise.allSettled([$i(c.bkcTokenContract,c.userAddress,e),(t=c.provider)==null?void 0:t.getBalance(c.userAddress)]);if(s.status==="fulfilled"&&(c.currentUserBalance=s.value),n.status==="fulfilled"&&(c.currentUserNativeBalance=n.value),await Qt(e),c.delegationManagerContract){const a=await O(c.delegationManagerContract,"userTotalPStake",[c.userAddress],0n,2,e);c.userTotalPStake=a}}catch(s){console.error("Error loading user data:",s)}}async function Gs(e=!1){if(!c.isConnected||!c.delegationManagerContract)return[];try{const t=await O(c.delegationManagerContract,"getDelegationsOf",[c.userAddress],[],2,e);return c.userDelegations=t.map((s,n)=>({amount:s[0]||s.amount||0n,unlockTime:BigInt(s[1]||s.unlockTime||0),lockDuration:BigInt(s[2]||s.lockDuration||0),index:n})),c.userDelegations}catch(t){return console.error("Error loading delegations:",t),[]}}async function ht(e=!1){let t=[];try{const n=await Vt(ce.getRentalListings,4e3);n.ok&&(t=await n.json())}catch{}if(t&&t.length>0){const n=t.map(a=>{var o,r,l,d,u;const i=te.find(f=>f.boostBips===Number(a.boostBips||0));return{...a,tokenId:((o=a.tokenId)==null?void 0:o.toString())||((r=a.id)==null?void 0:r.toString()),pricePerHour:((l=a.pricePerHour)==null?void 0:l.toString())||((d=a.price)==null?void 0:d.toString())||"0",totalEarnings:((u=a.totalEarnings)==null?void 0:u.toString())||"0",rentalCount:Number(a.rentalCount||0),img:(i==null?void 0:i.img)||"./assets/nft.png",name:(i==null?void 0:i.name)||"Booster NFT"}});return c.rentalListings=n,n}const s=Xt(v.rentalManager,Ee,c.rentalManagerContractPublic);if(!s)return c.rentalListings=[],[];try{const n=await O(s,"getAllListedTokenIds",[],[],2,!0);if(!n||n.length===0)return c.rentalListings=[],[];const i=n.slice(0,30).map(async l=>{var d,u,f,p,g,m;try{const x=await O(s,"getListing",[l],null,1,!0);if(x&&x.isActive){const y=await O(s,"getRental",[l],null,1,!0),k=await sa(l),E=Math.floor(Date.now()/1e3),L=y&&BigInt(y.endTime||0)>BigInt(E);return{tokenId:l.toString(),owner:x.owner,pricePerHour:((d=x.pricePerHour)==null?void 0:d.toString())||((u=x.price)==null?void 0:u.toString())||"0",minHours:((f=x.minHours)==null?void 0:f.toString())||"1",maxHours:((p=x.maxHours)==null?void 0:p.toString())||"1",totalEarnings:((g=x.totalEarnings)==null?void 0:g.toString())||"0",rentalCount:Number(x.rentalCount||0),boostBips:k.boostBips,img:k.img||"./assets/nft.png",name:k.name,isRented:L,currentTenant:L?y.tenant:null,rentalEndTime:L?(m=y.endTime)==null?void 0:m.toString():null}}}catch{}return null}),r=(await Promise.all(i)).filter(l=>l!==null);return c.rentalListings=r,r}catch{return c.rentalListings=[],[]}}async function Ai(e=!1){var s,n,a,i;if(!c.userAddress)return c.myRentals=[],[];try{const o=await Vt(`${ce.getUserRentals}/${c.userAddress}`,4e3);if(o.ok){const l=(await o.json()).map(d=>{const u=te.find(f=>f.boostBips===Number(d.boostBips||0));return{...d,img:(u==null?void 0:u.img)||"./assets/nft.png",name:(u==null?void 0:u.name)||"Booster NFT"}});return c.myRentals=l,l}}catch{}const t=Xt(v.rentalManager,Ee,c.rentalManagerContractPublic);if(!t)return c.myRentals=[],[];try{const o=await O(t,"getAllListedTokenIds",[],[],2,e),r=[],l=Math.floor(Date.now()/1e3);for(const d of o.slice(0,30))try{const u=await O(t,"getRental",[d],null,1,e);if(u&&((s=u.tenant)==null?void 0:s.toLowerCase())===c.userAddress.toLowerCase()&&BigInt(u.endTime||0)>BigInt(l)){const f=await sa(d);r.push({tokenId:d.toString(),tenant:u.tenant,startTime:((n=u.startTime)==null?void 0:n.toString())||"0",endTime:((a=u.endTime)==null?void 0:a.toString())||"0",paidAmount:((i=u.paidAmount)==null?void 0:i.toString())||"0",boostBips:f.boostBips,img:f.img,name:f.name})}}catch{}return c.myRentals=r,r}catch{return c.myRentals=[],[]}}let Bt=null,hn=0;const Li=3e4;async function Ve(e=!1){const t=Date.now();if(!e&&Bt&&t-hn<Li)return Bt;await Qt(e);let s=0,n=null,a="none";if(c.myBoosters&&c.myBoosters.length>0){const l=c.myBoosters.reduce((d,u)=>u.boostBips>d.boostBips?u:d,c.myBoosters[0]);l.boostBips>s&&(s=l.boostBips,n=l.tokenId,a="owned")}if(c.myRentals&&c.myRentals.length>0){const l=c.myRentals.reduce((d,u)=>u.boostBips>d.boostBips?u:d,c.myRentals[0]);l.boostBips>s&&(s=l.boostBips,n=l.tokenId,a="rented")}const i=te.find(l=>l.boostBips===s),o=(i==null?void 0:i.realImg)||(i==null?void 0:i.img)||"assets/bkc_logo_3d.png",r=i!=null&&i.name?`${i.name} Booster`:a!=="none"?"Booster NFT":"None";return Bt={highestBoost:s,boostName:r,imageUrl:o,tokenId:n?n.toString():null,source:a},hn=Date.now(),Bt}async function sa(e){const t=["function boostBips(uint256) view returns (uint256)"],s=Xt(v.rewardBoosterNFT,t,c.rewardBoosterContractPublic);if(!s)return{boostBips:0,img:"assets/bkc_logo_3d.png",name:"Unknown"};try{const n=await O(s,"boostBips",[e],0n),a=Number(n),i=te.find(o=>o.boostBips===a);return{boostBips:a,img:(i==null?void 0:i.img)||"./assets/nft.png",name:(i==null?void 0:i.name)||`Booster #${e}`}}catch{return{boostBips:0,img:"assets/bkc_logo_3d.png",name:"Unknown"}}}async function Jt(){if(!c.isConnected||!c.delegationManagerContract)return{stakingRewards:0n,minerRewards:0n,totalRewards:0n};try{const e=await O(c.delegationManagerContract,"pendingRewards",[c.userAddress],0n);return{stakingRewards:e,minerRewards:0n,totalRewards:e}}catch{return{stakingRewards:0n,minerRewards:0n,totalRewards:0n}}}async function na(){var o,r;if(!c.delegationManagerContract||!c.userAddress)return{netClaimAmount:0n,feeAmount:0n,discountPercent:0,totalRewards:0n};const{totalRewards:e}=await Jt();if(e===0n)return{netClaimAmount:0n,feeAmount:0n,discountPercent:0,totalRewards:0n};let t=((o=c.systemFees)==null?void 0:o.CLAIM_REWARD_FEE_BIPS)||500n;const s=await Ve();let n=((r=c.boosterDiscounts)==null?void 0:r[s.highestBoost])||0n;const a=t>n?t-n:0n,i=e*a/10000n;return{netClaimAmount:e-i,feeAmount:i,discountPercent:Number(n)/100,totalRewards:e}}let rs=!1,ls=0,Et=0;const Si=3e4,Pi=3,Ni=12e4;async function Qt(e=!1){if(!c.userAddress)return[];const t=Date.now();if(rs)return c.myBoosters||[];if(!e&&t-ls<Si)return c.myBoosters||[];if(Et>=Pi){if(t-ls<Ni)return c.myBoosters||[];Et=0}rs=!0,ls=t;try{const s=await Vt(`${ce.getBoosters}/${c.userAddress}`,5e3);if(!s.ok)throw new Error(`API Error: ${s.status}`);let n=await s.json();const a=["function ownerOf(uint256) view returns (address)","function boostBips(uint256) view returns (uint256)"],i=Xt(v.rewardBoosterNFT,a,c.rewardBoosterContractPublic);if(i&&n.length>0){const o=await Promise.all(n.slice(0,50).map(async r=>{const l=BigInt(r.tokenId),d=`ownerOf-${l}`,u=Date.now();let f=Number(r.boostBips||r.boost||0);if(f===0)try{const p=await i.boostBips(l);f=Number(p)}catch{}if(!e&&os.has(d)){const p=os.get(d);if(u-p.timestamp<Ei)return p.owner.toLowerCase()===c.userAddress.toLowerCase()?{tokenId:l,boostBips:f,imageUrl:r.imageUrl||r.image||null}:null}try{const p=await i.ownerOf(l);return os.set(d,{owner:p,timestamp:u}),p.toLowerCase()===c.userAddress.toLowerCase()?{tokenId:l,boostBips:f,imageUrl:r.imageUrl||r.image||null}:null}catch(p){return Zn(p)||ea(p)?{tokenId:l,boostBips:f,imageUrl:r.imageUrl||r.image||null}:null}}));c.myBoosters=o.filter(r=>r!==null)}else c.myBoosters=n.map(o=>({tokenId:BigInt(o.tokenId),boostBips:Number(o.boostBips||o.boost||0),imageUrl:o.imageUrl||o.image||null}));return Et=0,c.myBoosters}catch{return Et++,c.myBoosters||(c.myBoosters=[]),c.myBoosters}finally{rs=!1}}const Mi={apiKey:"AIzaSyDKhF2_--fKtot96YPS8twuD0UoCpS-3T4",authDomain:"airdropbackchainnew.firebaseapp.com",projectId:"airdropbackchainnew",storageBucket:"airdropbackchainnew.appspot.com",messagingSenderId:"108371799661",appId:"1:108371799661:web:d126fcbd0ba56263561964",measurementId:"G-QD9EBZ0Y09"},aa=ni(Mi),It=ai(aa),N=ri(aa);let ke=null,ee=null,$t=null;async function ia(e){if(!e)throw new Error("Wallet address is required for Firebase sign-in.");const t=e.toLowerCase();return ee=t,ke?($t=await nt(t),ke):It.currentUser?(ke=It.currentUser,$t=await nt(t),ke):new Promise((s,n)=>{const a=ii(It,async i=>{if(a(),i){ke=i;try{$t=await nt(t),s(i)}catch(o){console.error("Error linking airdrop user profile:",o),n(o)}}else oi(It).then(async o=>{ke=o.user,$t=await nt(t),s(ke)}).catch(o=>{console.error("Firebase Anonymous sign-in failed:",o),n(o)})},i=>{console.error("Firebase Auth state change error:",i),a(),n(i)})})}function ve(){if(!ke)throw new Error("User not authenticated with Firebase. Please sign-in first.");if(!ee)throw new Error("Wallet address not set. Please connect wallet first.")}async function Vs(){const e=_(N,"airdrop_public_data","data_v1"),t=await ne(e);if(t.exists()){const s=t.data(),n=(s.dailyTasks||[]).map(o=>{var d,u;const r=(d=o.startDate)!=null&&d.toDate?o.startDate.toDate():o.startDate?new Date(o.startDate):null,l=(u=o.endDate)!=null&&u.toDate?o.endDate.toDate():o.endDate?new Date(o.endDate):null;return{...o,id:o.id||null,startDate:r instanceof Date&&!isNaN(r)?r:null,endDate:l instanceof Date&&!isNaN(l)?l:null}}).filter(o=>o.id),a=Date.now(),i=n.filter(o=>{const r=o.startDate?o.startDate.getTime():0,l=o.endDate?o.endDate.getTime():1/0;return r<=a&&a<l});return{config:s.config||{ugcBasePoints:{}},leaderboards:s.leaderboards||{top100ByPoints:[],top100ByPosts:[],lastUpdated:null},dailyTasks:i,platformUsageConfig:s.platformUsageConfig||null}}else return console.warn("Public airdrop data document 'airdrop_public_data/data_v1' not found. Returning defaults."),{config:{isActive:!1,roundName:"Loading...",ugcBasePoints:{}},leaderboards:{top100ByPoints:[],top100ByPosts:[],lastUpdated:null},dailyTasks:[],platformUsageConfig:null}}function wn(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";let t="";for(let s=0;s<6;s++)t+=e.charAt(Math.floor(Math.random()*e.length));return t}function Ft(e){return e>=100?10:e>=90?9:e>=80?8:e>=70?7:e>=60?6:e>=50?5:e>=40?4:e>=30?3:e>=20?2:1}async function nt(e){ve(),e||(e=ee);const t=e.toLowerCase(),s=_(N,"airdrop_users",t),n=await ne(s);if(n.exists()){const a=n.data(),i={};if(a.referralCode||(i.referralCode=wn()),typeof a.approvedSubmissionsCount!="number"&&(i.approvedSubmissionsCount=0),typeof a.rejectedCount!="number"&&(i.rejectedCount=0),typeof a.isBanned!="boolean"&&(i.isBanned=!1),typeof a.totalPoints!="number"&&(i.totalPoints=0),typeof a.pointsMultiplier!="number"&&(i.pointsMultiplier=1),a.walletAddress!==t&&(i.walletAddress=t),Object.keys(i).length>0)try{return await Yt(s,i),{id:n.id,...a,...i}}catch(o){return console.error("Error updating user default fields:",o),{id:n.id,...a}}return{id:n.id,...a}}else{const a=wn(),i={walletAddress:t,referralCode:a,totalPoints:0,pointsMultiplier:1,approvedSubmissionsCount:0,rejectedCount:0,isBanned:!1,createdAt:Ce()};return await Kt(s,i),{id:s.id,...i,createdAt:new Date}}}async function oa(e,t){if(ve(),!e||typeof e!="string"||e.trim()==="")return console.warn(`isTaskEligible called with invalid taskId: ${e}`),{eligible:!1,timeLeft:0};const s=_(N,"airdrop_users",ee,"task_claims",e),n=await ne(s),a=t*60*60*1e3;if(!n.exists())return{eligible:!0,timeLeft:0};const i=n.data(),o=i==null?void 0:i.timestamp;if(typeof o!="string"||o.trim()==="")return console.warn(`Missing/invalid timestamp for task ${e}. Allowing claim.`),{eligible:!0,timeLeft:0};try{const r=new Date(o);if(isNaN(r.getTime()))return console.warn(`Invalid timestamp format for task ${e}:`,o,". Allowing claim."),{eligible:!0,timeLeft:0};const l=r.getTime(),u=Date.now()-l;return u>=a?{eligible:!0,timeLeft:0}:{eligible:!1,timeLeft:a-u}}catch(r){return console.error(`Error parsing timestamp string for task ${e}:`,o,r),{eligible:!0,timeLeft:0}}}async function Fi(e,t){if(ve(),!e||!e.id)throw new Error("Invalid task data provided.");if(!(await oa(e.id,e.cooldownHours)).eligible)throw new Error("Cooldown period is still active for this task.");const n=_(N,"airdrop_users",ee),a=Math.round(e.points);if(isNaN(a)||a<0)throw new Error("Invalid points value for the task.");await Yt(n,{totalPoints:le(a)});const i=_(N,"airdrop_users",ee,"task_claims",e.id);return await Kt(i,{timestamp:new Date().toISOString(),points:a}),a}async function Ri(e){var r;const t=e.trim().toLowerCase();let s="Other",n=!0;if(t.includes("youtube.com/shorts/")){s="YouTube Shorts";const l=t.match(/\/shorts\/([a-zA-Z0-9_-]+)/);if(!l||!l[1])throw n=!1,new Error("Invalid YouTube Shorts URL: Video ID not found or incorrect format.")}else if(t.includes("youtube.com/watch?v=")||t.includes("youtu.be/")){s="YouTube";const l=t.match(/(?:v=|\/)([a-zA-Z0-9_-]{11})(?:[?&]|$)/);if(!l||l[1].length!==11)throw n=!1,new Error("Invalid YouTube URL: Video ID not found or incorrect format.")}else{if(t.includes("youtube.com/"))throw s="YouTube",n=!1,new Error("Invalid YouTube URL: Only video links (youtube.com/watch?v=... or youtu.be/...) or Shorts links are accepted.");if(t.includes("instagram.com/p/")||t.includes("instagram.com/reel/")){s="Instagram";const l=t.match(/\/(?:p|reel)\/([a-zA-Z0-9_.-]+)/);(!l||!l[1])&&(n=!1)}else t.includes("twitter.com/")||t.includes("x.com/")?t.match(/(\w+)\/(?:status|statuses)\/(\d+)/)&&(s="X/Twitter"):t.includes("facebook.com/")&&t.includes("/posts/")?s="Facebook":t.includes("t.me/")||t.includes("telegram.org/")?s="Telegram":t.includes("tiktok.com/")?s="TikTok":t.includes("reddit.com/r/")?s="Reddit":t.includes("linkedin.com/posts/")&&(s="LinkedIn")}const i=((r=(await Vs()).config)==null?void 0:r.ugcBasePoints)||{},o=i[s]||i.Other||1e3;if(isNaN(o)||o<0)throw new Error(`Invalid base points configured for platform: ${s}. Please contact admin.`);return{platform:s,basePoints:o,isValid:n,normalizedUrl:t}}async function Di(e){var se;ve();const t=_(N,"airdrop_users",ee),s=ye(N,"airdrop_users",ee,"submissions"),n=ye(N,"all_submissions_log"),a=e.trim();if(!a||!a.toLowerCase().startsWith("http://")&&!a.toLowerCase().startsWith("https://"))throw new Error("The provided URL must start with http:// or https://.");let i;try{i=await Ri(a)}catch(S){throw S}const{platform:o,basePoints:r,isValid:l,normalizedUrl:d}=i;if(!l)throw new Error(`The provided URL for ${o} does not appear valid for submission.`);const u=Fe(s,Ge("submittedAt","desc"),li(1)),f=await ze(u);if(!f.empty){const G=(se=f.docs[0].data().submittedAt)==null?void 0:se.toDate();if(G){const Q=new Date,Y=5*60*1e3,Ie=Q.getTime()-G.getTime();if(Ie<Y){const Ze=Y-Ie,as=Math.ceil(Ze/6e4);throw new Error(`We're building a strong community, and we value quality over quantity. To prevent spam, please wait ${as} more minute(s) before submitting another post. We appreciate your thoughtful contribution!`)}}}const p=Fe(n,Mt("normalizedUrl","==",d),Mt("status","in",["pending","approved","auditing","flagged_suspicious"]));if(!(await ze(p)).empty)throw new Error("This content link has already been submitted. Repeatedly submitting duplicate or fraudulent content may lead to account suspension.");const m=await ne(t);if(!m.exists())throw new Error("User profile not found.");const x=m.data(),y=x.approvedSubmissionsCount||0,k=Ft(y),E=Math.round(r*k),L=Ce(),A={url:a,platform:o,status:"pending",basePoints:r,_pointsCalculated:E,_multiplierApplied:k,pointsAwarded:0,submittedAt:L,resolvedAt:null},$={userId:ee,walletAddress:x.walletAddress,normalizedUrl:d,platform:o,status:"pending",basePoints:r,submittedAt:L,resolvedAt:null},T=vt(N),M=_(s);T.set(M,A);const W=_(n,M.id);T.set(W,$),await T.commit()}async function ji(){ve();const e=ye(N,"airdrop_users",ee,"submissions"),t=Fe(e,Ge("submittedAt","desc"));return(await ze(t)).docs.map(n=>{var i,o;const a=n.data();return{submissionId:n.id,...a,submittedAt:(i=a.submittedAt)!=null&&i.toDate?a.submittedAt.toDate():null,resolvedAt:(o=a.resolvedAt)!=null&&o.toDate?a.resolvedAt.toDate():null}})}async function Hi(e){ve();const t=ee,s=_(N,"airdrop_users",t),n=_(N,"airdrop_users",t,"submissions",e),a=_(N,"all_submissions_log",e),i=await ne(n);if(!i.exists())throw new Error("Cannot confirm submission: Document not found or already processed.");const o=i.data(),r=o.status;if(r==="approved"||r==="rejected")throw new Error(`Submission is already in status: ${r}.`);let l=o._pointsCalculated,d=o._multiplierApplied;if(typeof l!="number"||isNaN(l)||l<=0){console.warn(`[ConfirmSubmission] Legacy/Invalid submission ${e} missing/invalid _pointsCalculated. Recalculating...`);const f=o.basePoints||0,p=await ne(s);if(!p.exists())throw new Error("User profile not found for recalculation.");const m=p.data().approvedSubmissionsCount||0;d=Ft(m),l=Math.round(f*d),(isNaN(l)||l<=0)&&(console.warn(`[ConfirmSubmission] Recalculation failed (basePoints: ${f}). Using fallback 1000.`),l=Math.round(1e3*d))}const u=vt(N);u.update(s,{totalPoints:le(l),approvedSubmissionsCount:le(1)}),u.update(n,{status:"approved",pointsAwarded:l,_pointsCalculated:l,_multiplierApplied:d,resolvedAt:Ce()}),await ne(a).then(f=>f.exists())&&u.update(a,{status:"approved",resolvedAt:Ce()}),await u.commit()}async function ra(e){ve();const s=_(N,"airdrop_users",ee,"submissions",e),n=_(N,"all_submissions_log",e),a=await ne(s);if(!a.exists())return console.warn(`Delete submission skipped: Document ${e} not found.`);const i=a.data().status;if(i==="approved"||i==="rejected")throw new Error(`This submission was already ${i} and cannot be deleted.`);if(i==="flagged_suspicious")throw new Error("Flagged submissions must be resolved, not deleted.");const o=vt(N);o.update(s,{status:"deleted_by_user",resolvedAt:Ce()}),await ne(n).then(r=>r.exists())&&o.update(n,{status:"deleted_by_user",resolvedAt:Ce(),pointsAwarded:0}),await o.commit()}async function _i(e){const t=_(N,"airdrop_public_data","data_v1");await Kt(t,{config:{ugcBasePoints:e}},{merge:!0})}async function Ui(){const e=ye(N,"daily_tasks"),t=Fe(e,Ge("endDate","asc"));return(await ze(t)).docs.map(n=>{var a,i;return{id:n.id,...n.data(),startDate:(a=n.data().startDate)!=null&&a.toDate?n.data().startDate.toDate():null,endDate:(i=n.data().endDate)!=null&&i.toDate?n.data().endDate.toDate():null}})}async function Oi(e){const t={...e};t.startDate instanceof Date&&(t.startDate=un.fromDate(t.startDate)),t.endDate instanceof Date&&(t.endDate=un.fromDate(t.endDate));const s=e.id;if(!s)delete t.id,await ci(ye(N,"daily_tasks"),t);else{const n=_(N,"daily_tasks",s);delete t.id,await Kt(n,t,{merge:!0})}}async function Wi(e){if(!e)throw new Error("Task ID is required for deletion.");await di(_(N,"daily_tasks",e))}async function qi(){const e=ye(N,"all_submissions_log"),t=Fe(e,Mt("status","in",["pending","auditing","flagged_suspicious"]),Ge("submittedAt","desc"));return(await ze(t)).docs.map(n=>{var i,o;const a=n.data();return{userId:a.userId,walletAddress:a.walletAddress,submissionId:n.id,...a,submittedAt:(i=a.submittedAt)!=null&&i.toDate?a.submittedAt.toDate():null,resolvedAt:(o=a.resolvedAt)!=null&&o.toDate?a.resolvedAt.toDate():null}})}async function la(e,t,s){var k,E,L;if(!e)throw new Error("User ID (walletAddress) is required.");const n=e.toLowerCase(),a=_(N,"airdrop_users",n),i=_(N,"airdrop_users",n,"submissions",t),o=_(N,"all_submissions_log",t),[r,l,d]=await Promise.all([ne(a),ne(i),ne(o)]);if(!l.exists())throw new Error("Submission not found in user collection.");if(!r.exists())throw new Error("User profile not found.");d.exists()||console.warn(`Log entry ${t} not found. Log will not be updated.`);const u=l.data(),f=r.data(),p=u.status;if(p===s){console.warn(`Admin action ignored: Submission ${t} already has status ${s}.`);return}const g=vt(N),m={};let x=0,y=u._multiplierApplied||0;if(s==="approved"){let A=u._pointsCalculated;if(typeof A!="number"||isNaN(A)||A<=0){console.warn(`[Admin] Legacy/Invalid submission ${t} missing/invalid _pointsCalculated. Recalculating...`);const $=u.basePoints||0,T=f.approvedSubmissionsCount||0,M=Ft(T);if(A=Math.round($*M),isNaN(A)||A<=0){console.warn(`[Admin] Recalculation failed (basePoints: ${$}). Using fallback 1000.`);const W=Ft(T);A=Math.round(1e3*W)}y=M}x=A,m.totalPoints=le(A),m.approvedSubmissionsCount=le(1),p==="rejected"&&(m.rejectedCount=le(-1))}else if(s==="rejected"){if(p!=="rejected"){const A=f.rejectedCount||0;m.rejectedCount=le(1),A+1>=3&&(m.isBanned=!0)}else if(p==="approved"){const A=u.pointsAwarded||0;m.totalPoints=le(-A),m.approvedSubmissionsCount=le(-1);const $=f.rejectedCount||0;m.rejectedCount=le(1),$+1>=3&&(m.isBanned=!0)}x=0}if(((k=m.approvedSubmissionsCount)==null?void 0:k.operand)<0&&(f.approvedSubmissionsCount||0)<=0&&(m.approvedSubmissionsCount=0),((E=m.rejectedCount)==null?void 0:E.operand)<0&&(f.rejectedCount||0)<=0&&(m.rejectedCount=0),((L=m.totalPoints)==null?void 0:L.operand)<0){const A=f.totalPoints||0,$=Math.abs(m.totalPoints.operand);A<$&&(m.totalPoints=0)}Object.keys(m).length>0&&g.update(a,m),g.update(i,{status:s,pointsAwarded:x,_pointsCalculated:s==="approved"?x:u._pointsCalculated||0,_multiplierApplied:y,resolvedAt:Ce()}),d.exists()&&g.update(o,{status:s,resolvedAt:Ce()}),await g.commit()}async function Yi(){const e=ye(N,"airdrop_users"),t=Fe(e,Ge("totalPoints","desc"));return(await ze(t)).docs.map(n=>({id:n.id,...n.data()}))}async function Ki(e,t){if(!e)throw new Error("User ID is required.");const s=e.toLowerCase(),n=ye(N,"airdrop_users",s,"submissions"),a=Fe(n,Mt("status","==",t),Ge("resolvedAt","desc"));return(await ze(a)).docs.map(o=>{var r,l;return{submissionId:o.id,userId:s,...o.data(),submittedAt:(r=o.data().submittedAt)!=null&&r.toDate?o.data().submittedAt.toDate():null,resolvedAt:(l=o.data().resolvedAt)!=null&&l.toDate?o.data().resolvedAt.toDate():null}})}async function ca(e,t){if(!e)throw new Error("User ID is required.");const s=e.toLowerCase(),n=_(N,"airdrop_users",s),a={isBanned:t};t===!1&&(a.rejectedCount=0),await Yt(n,a)}const yn={faucet:{points:1e3,maxCount:1,cooldownHours:0,enabled:!0},delegation:{points:2e3,maxCount:10,cooldownHours:24,enabled:!0},fortune:{points:1500,maxCount:10,cooldownHours:1,enabled:!0},buyNFT:{points:2500,maxCount:10,cooldownHours:0,enabled:!0},sellNFT:{points:1500,maxCount:10,cooldownHours:0,enabled:!0},listRental:{points:1e3,maxCount:10,cooldownHours:0,enabled:!0},rentNFT:{points:2e3,maxCount:10,cooldownHours:0,enabled:!0},notarize:{points:2e3,maxCount:10,cooldownHours:0,enabled:!0},claimReward:{points:1e3,maxCount:10,cooldownHours:24,enabled:!0},unstake:{points:500,maxCount:10,cooldownHours:0,enabled:!0}};async function Gi(){try{const e=_(N,"airdrop_public_data","data_v1"),t=await ne(e);return t.exists()&&t.data().platformUsageConfig?t.data().platformUsageConfig:yn}catch(e){return console.error("Error fetching platform usage config:",e),yn}}async function kn(){ve();try{const e=ye(N,"airdrop_users",ee,"platform_usage"),t=await ze(e),s={};return t.forEach(n=>{s[n.id]=n.data()}),s}catch(e){return console.error("Error fetching platform usage:",e),{}}}async function Vi(e,t){var a;ve();const n=(await Gi())[e];if(!n)return console.error(`Invalid action type: ${e}`),{success:!1,reason:"invalid_action"};if(n.enabled===!1)return{success:!1,reason:"action_disabled"};try{const i=_(N,"airdrop_users",ee,"platform_usage",e),o=await ne(i),r=o.exists()?o.data():{count:0,totalPoints:0,txHashes:[],lastClaimed:null};if(r.count>=n.maxCount)return console.log(`Max usage reached for ${e}: ${r.count}/${n.maxCount}`),{success:!1,reason:"max_reached"};if(n.cooldownHours>0&&r.lastClaimed){const m=new Date(r.lastClaimed),x=(Date.now()-m.getTime())/(1e3*60*60);if(x<n.cooldownHours){const y=n.cooldownHours-x;return console.log(`Cooldown active for ${e}: ${y.toFixed(1)}h remaining`),{success:!1,reason:"cooldown",hoursLeft:Math.ceil(y)}}}if(t&&((a=r.txHashes)!=null&&a.includes(t)))return console.log(`Duplicate txHash for ${e}: ${t}`),{success:!1,reason:"duplicate_tx"};const l=n.points,d=r.count+1,u=r.totalPoints+l,f=t?[...r.txHashes||[],t].slice(-20):r.txHashes||[],p=vt(N);p.set(i,{count:d,totalPoints:u,lastClaimed:new Date().toISOString(),txHashes:f});const g=_(N,"airdrop_users",ee);return p.update(g,{platformUsagePoints:le(l),totalPoints:le(l)}),await p.commit(),console.log(`✅ Platform usage recorded: ${e} +${l} pts (${d}/${n.maxCount})`),{success:!0,pointsAwarded:l,newCount:d,maxCount:n.maxCount}}catch(i){return console.error(`Error recording platform usage for ${e}:`,i),{success:!1,reason:"error",message:i.message}}}async function da(e){ve();const t=_(N,"airdrop_public_data","data_v1");await Yt(t,{platformUsageConfig:e}),console.log("✅ Platform usage config saved:",e)}const R=window.ethers,Xs=421614,Xi="0x66eee";let de=null,Tn=0,Le=0;const Ji=5e3,zn=3,Qi=1e4;let ua=0;const Zi=3;let pa=null;const eo="cd4bdedee7a7e909ebd3df8bbc502aed",to={chainId:Xs,name:"Arbitrum Sepolia",currency:"ETH",explorerUrl:"https://sepolia.arbiscan.io",rpcUrl:Hs},so={name:"Backcoin Protocol",description:"DeFi Ecosystem",url:window.location.origin,icons:[window.location.origin+"/assets/bkc_logo_3d.png"]},no=ti({metadata:so,enableEIP6963:!0,enableInjected:!0,enableCoinbase:!1,rpcUrl:Hs,defaultChainId:Xs,enableEmail:!0,enableEns:!1,auth:{email:!0,showWallets:!0,walletFeatures:!0}}),Pe=si({ethersConfig:no,chains:[to],projectId:eo,enableAnalytics:!0,themeMode:"dark",themeVariables:{"--w3m-accent":"#f59e0b","--w3m-border-radius-master":"1px","--w3m-z-index":100}});function ao(e){var n,a;const t=((n=e==null?void 0:e.message)==null?void 0:n.toLowerCase())||"",s=(e==null?void 0:e.code)||((a=e==null?void 0:e.error)==null?void 0:a.code);return s===-32603||s===-32e3||s===429||t.includes("failed to fetch")||t.includes("network error")||t.includes("timeout")||t.includes("rate limit")||t.includes("too many requests")||t.includes("internal json-rpc")||t.includes("unexpected token")||t.includes("<html")}function zs(e){return new R.JsonRpcProvider(e||ft())}async function fa(e,t=Zi){var n;let s=null;for(let a=0;a<t;a++)try{const i=await e();return vi(ft()),ua=0,i}catch(i){if(s=i,ao(i)){console.warn(`⚠️ RPC error (attempt ${a+1}/${t}):`,(n=i.message)==null?void 0:n.slice(0,80)),xi(ft());const o=Qn();console.log(`🔄 Switching to: ${o}`),await ma(),await new Promise(r=>setTimeout(r,500*(a+1)))}else throw i}throw console.error("❌ All RPC attempts failed"),s}async function ma(){const e=ft();try{c.publicProvider=zs(e),pa=c.publicProvider,H(v.bkcToken)&&(c.bkcTokenContractPublic=new R.Contract(v.bkcToken,_s,c.publicProvider)),H(v.delegationManager)&&(c.delegationManagerContractPublic=new R.Contract(v.delegationManager,je,c.publicProvider)),H(v.faucet)&&(c.faucetContractPublic=new R.Contract(v.faucet,qs,c.publicProvider)),H(v.rentalManager)&&(c.rentalManagerContractPublic=new R.Contract(v.rentalManager,Ee,c.publicProvider)),H(v.ecosystemManager)&&(c.ecosystemManagerContractPublic=new R.Contract(v.ecosystemManager,Ys,c.publicProvider)),H(v.actionsManager)&&(c.actionsManagerContractPublic=new R.Contract(v.actionsManager,Os,c.publicProvider));const t=v.fortunePoolV2||v.fortunePool;H(t)&&(c.fortunePoolContractPublic=new R.Contract(t,Ws,c.publicProvider)),console.log(`✅ Public provider recreated with: ${e.slice(0,50)}...`)}catch(t){console.error("Failed to recreate public provider:",t)}}function io(e){if(!e)return!1;try{return R.isAddress(e)}catch{return!1}}function H(e){return e&&e!==R.ZeroAddress&&!e.startsWith("0x...")}function oo(e){if(!e)return;const t=localStorage.getItem(`balance_${e.toLowerCase()}`);if(t)try{c.currentUserBalance=BigInt(t),window.updateUIState&&window.updateUIState()}catch{}}function ro(e){try{H(v.bkcToken)&&(c.bkcTokenContract=new R.Contract(v.bkcToken,_s,e)),H(v.delegationManager)&&(c.delegationManagerContract=new R.Contract(v.delegationManager,je,e)),H(v.rewardBoosterNFT)&&(c.rewardBoosterContract=new R.Contract(v.rewardBoosterNFT,ki,e)),H(v.publicSale)&&(c.publicSaleContract=new R.Contract(v.publicSale,Gt,e)),H(v.faucet)&&(c.faucetContract=new R.Contract(v.faucet,qs,e)),H(v.rentalManager)&&(c.rentalManagerContract=new R.Contract(v.rentalManager,Ee,e)),H(v.actionsManager)&&(c.actionsManagerContract=new R.Contract(v.actionsManager,Os,e)),H(v.decentralizedNotary)&&(c.decentralizedNotaryContract=new R.Contract(v.decentralizedNotary,Ts,e)),H(v.ecosystemManager)&&(c.ecosystemManagerContract=new R.Contract(v.ecosystemManager,Ys,e));const t=v.fortunePoolV2||v.fortunePool;H(t)&&(c.fortunePoolContract=new R.Contract(t,Ws,e))}catch{console.warn("Contract init partial failure")}}function ba(){if(de&&(clearInterval(de),de=null),!c.bkcTokenContractPublic||!c.userAddress){console.warn("Cannot start balance polling: missing contract or address");return}Le=0,ua=0,setTimeout(()=>{Cn()},1e3),de=setInterval(Cn,Qi),console.log("✅ Balance polling started (10s interval)")}async function Cn(){var t;if(document.hidden||!c.isConnected||!c.userAddress||!c.bkcTokenContractPublic)return;const e=Date.now();try{const s=await fa(async()=>await c.bkcTokenContractPublic.balanceOf(c.userAddress),2);Le=0;const n=c.currentUserBalance||0n;s.toString()!==n.toString()&&(c.currentUserBalance=s,localStorage.setItem(`balance_${c.userAddress.toLowerCase()}`,s.toString()),e-Tn>Ji&&(Tn=e,window.updateUIState&&window.updateUIState(!1)))}catch(s){Le++,Le<=3&&console.warn(`⚠️ Balance check failed (${Le}/${zn}):`,(t=s.message)==null?void 0:t.slice(0,50)),Le>=zn&&(console.warn("❌ Too many balance check errors. Stopping polling temporarily."),de&&(clearInterval(de),de=null),setTimeout(()=>{console.log("🔄 Attempting to restart balance polling with primary RPC..."),hi(),ma().then(()=>{Le=0,ba()})},6e4))}}async function lo(e){try{const t=await e.getNetwork();if(Number(t.chainId)===Xs)return!0;try{return await e.send("wallet_switchEthereumChain",[{chainId:Xi}]),!0}catch{return!0}}catch{return!0}}async function Bn(e,t){try{if(!io(t))return!1;await lo(e),c.provider=e;try{c.signer=await e.getSigner()}catch(s){c.signer=e,console.warn(`Could not get standard Signer. Using Provider as read-only. Warning: ${s.message}`)}c.userAddress=t,c.isConnected=!0,oo(t),ro(c.signer);try{ia(c.userAddress)}catch{}return X().then(()=>{window.updateUIState&&window.updateUIState(!1)}).catch(()=>{}),ba(),!0}catch(s){return console.error("Setup warning:",s),!!t}}async function co(){try{const e=ft();console.log(`🌐 Initializing public provider with: ${e.slice(0,50)}...`),c.publicProvider=zs(e),pa=c.publicProvider,H(v.bkcToken)&&(c.bkcTokenContractPublic=new R.Contract(v.bkcToken,_s,c.publicProvider)),H(v.delegationManager)&&(c.delegationManagerContractPublic=new R.Contract(v.delegationManager,je,c.publicProvider)),H(v.faucet)&&(c.faucetContractPublic=new R.Contract(v.faucet,qs,c.publicProvider)),H(v.rentalManager)&&(c.rentalManagerContractPublic=new R.Contract(v.rentalManager,Ee,c.publicProvider)),H(v.ecosystemManager)&&(c.ecosystemManagerContractPublic=new R.Contract(v.ecosystemManager,Ys,c.publicProvider)),H(v.actionsManager)&&(c.actionsManagerContractPublic=new R.Contract(v.actionsManager,Os,c.publicProvider));const t=v.fortunePoolV2||v.fortunePool;H(t)&&(c.fortunePoolContractPublic=new R.Contract(t,Ws,c.publicProvider),console.log("✅ FortunePool V2 contract initialized:",t));try{await fa(async()=>{await Ks()})}catch{console.warn("Initial public data load failed, will retry on user interaction")}window.updateUIState&&window.updateUIState(),console.log("✅ Public provider initialized")}catch(e){console.error("Public provider error:",e);const t=Qn();console.log(`🔄 Retrying with: ${t}`);try{c.publicProvider=zs(t),console.log("✅ Public provider initialized with fallback RPC")}catch{console.error("❌ All RPC endpoints failed")}}}function uo(e){let t=Pe.getAddress();if(Pe.getIsConnected()&&t){const n=Pe.getWalletProvider();if(n){const a=new R.BrowserProvider(n);c.web3Provider=n,e({isConnected:!0,address:t,isNewConnection:!1}),Bn(a,t)}}const s=async({provider:n,address:a,chainId:i,isConnected:o})=>{try{if(o){let r=a||Pe.getAddress();if(!r&&n)try{r=await(await new R.BrowserProvider(n).getSigner()).getAddress()}catch{}if(r){const l=new R.BrowserProvider(n);c.web3Provider=n,e({isConnected:!0,address:r,chainId:i,isNewConnection:!0}),await Bn(l,r)}else de&&clearInterval(de),c.isConnected=!1,c.userAddress=null,c.signer=null,e({isConnected:!1})}else de&&clearInterval(de),c.isConnected=!1,c.userAddress=null,c.signer=null,e({isConnected:!1})}catch{}};Pe.subscribeProvider(s)}function ga(){Pe.open()}async function po(){await Pe.disconnect()}const fo=window.ethers,B=(e,t=18)=>{if(e===null||typeof e>"u")return 0;if(typeof e=="number")return e;if(typeof e=="string")return parseFloat(e);try{const s=BigInt(e);return parseFloat(fo.formatUnits(s,t))}catch{return 0}},Xe=e=>!e||typeof e!="string"||!e.startsWith("0x")?"...":`${e.substring(0,6)}...${e.substring(e.length-4)}`,Re=e=>{try{if(e==null)return"0";const t=typeof e=="bigint"?e:BigInt(e);if(t<1000n)return t.toString();const s=Number(t);if(!isFinite(s))return t.toLocaleString("en-US");const n=["","k","M","B","T"],a=Math.floor((""+Math.floor(s)).length/3);let i=parseFloat((a!==0?s/Math.pow(1e3,a):s).toPrecision(3));return i%1!==0&&(i=i.toFixed(2)),i+n[a]}catch{return"0"}},mo=(e="Loading...")=>`<div class="flex items-center justify-center p-4 text-zinc-400"><div class="loader inline-block mr-2"></div> ${e}</div>`,bo=(e="An error occurred.")=>`<div class="bg-red-900/20 border border-red-500/30 rounded-lg p-4 text-center text-red-400 text-sm">${e}</div>`,go=(e="No data available.")=>`<div class="text-center p-8 bg-zinc-900/30 border border-dashed border-zinc-800 rounded-lg col-span-full">
    ...
    `;e.innerHTML=a,e.querySelectorAll(".pagination-btn").forEach(i=>{i.addEventListener("click",()=>{i.hasAttribute("disabled")||n(parseInt(i.dataset.page))})})}const U=window.ethers,En={arbitrumSepolia:"https://www.alchemy.com/faucets/arbitrum-sepolia",alternativeFaucet:"https://faucet.quicknode.com/arbitrum/sepolia"},Te={MAX_RETRIES:3,RETRY_DELAY_MS:2e3,APPROVAL_WAIT_MS:1500,SIMULATION_TIMEOUT_MS:1e4},Ye=e=>new Promise(t=>setTimeout(t,e)),et={MAX_RETRIES:3,RETRY_DELAY_MS:1500};async function ue(e,t){if(!t){console.warn("trackPlatformUsage: No txHash provided, skipping");return}(async()=>{for(let s=1;s<=et.MAX_RETRIES;s++)try{const n=await Vi(e,t);if(n.success){xo(n.pointsAwarded,n.newCount,n.maxCount),console.log(`✅ Airdrop tracking: ${e} +${n.pointsAwarded} pts (${n.newCount}/${n.maxCount})`);return}else if(n.reason==="max_reached"){console.log(`Airdrop tracking: ${e} max reached (${n.reason})`);return}else if(n.reason==="cooldown"){console.log(`Airdrop tracking: ${e} on cooldown`);return}else if(n.reason==="duplicate_tx"){console.log(`Airdrop tracking: ${e} duplicate tx`);return}else throw new Error(n.reason||"Unknown error")}catch(n){if(console.warn(`Airdrop tracking attempt ${s}/${et.MAX_RETRIES} failed:`,n.message),s<et.MAX_RETRIES){await Ye(et.RETRY_DELAY_MS*s);continue}console.error(`Airdrop tracking failed for ${e} after ${et.MAX_RETRIES} attempts`)}})()}function xo(e,t,s){const n=`🎯 +${e.toLocaleString()} Airdrop Points! (${t}/${s})`;b(n,"success"),console.log(`🎯 AIRDROP POINTS AWARDED: +${e} (${t}/${s})`)}async function pe(){if(!c.isConnected||!c.userAddress)return b("Please connect wallet first","error"),null;try{let e=c.web3Provider||c.provider||window.ethereum;return e?await new U.BrowserProvider(e).getSigner():(b("No wallet provider found","error"),null)}catch(e){return console.error("Signer error:",e),b("Wallet connection error","error"),null}}function vo(e){const t=(e==null?void 0:e.reason)||(e==null?void 0:e.shortMessage)||(e==null?void 0:e.message)||"Unknown error";return t.includes("user rejected")||t.includes("User denied")?"Transaction cancelled by user":t.includes("insufficient funds")||t.includes("exceeds the balance")?"INSUFFICIENT_GAS":t.includes("exceeds balance")&&!t.includes("gas")?"Insufficient token balance":t.includes("0xfb550858")||t.includes("InsufficientOracleFee")?"Insufficient oracle fee (ETH)":t.includes("0xbcfa8e99")||t.includes("InvalidGuessCount")?"Wrong number of guesses":t.includes("0x5c844fb4")||t.includes("InvalidGuessRange")?"Guess out of range":t.includes("ZeroAmount")?"Amount cannot be zero":t.includes("NoActiveTiers")?"No active game tiers":t.includes("InsufficientAllowance")?"Please approve tokens first":t.includes("InsufficientBalance")?"Insufficient BKC balance":t.includes("DelegationNotFound")||t.includes("not found")?"Delegation not found":t.includes("DelegationLocked")||t.includes("still locked")?"Delegation is still locked":t.includes("InvalidIndex")||t.includes("invalid index")?"Invalid delegation index":t.includes("NotOwner")||t.includes("not owner")?"Not the delegation owner":t.includes("require(false)")?"Transaction rejected by contract":t.includes("Internal JSON-RPC")?"Network error - please try again":t.includes("network")||t.includes("timeout")?"Network timeout - please try again":t.slice(0,100)}function ho(){b("⛽ You're out of ETH for gas fees!","error"),setTimeout(()=>{wo()},500)}function wo(){const e=document.getElementById("gas-faucet-modal");e&&e.remove();const t=document.createElement("div");t.id="gas-faucet-modal",t.className="fixed inset-0 z-[9999] flex items-center justify-center p-4",t.innerHTML=`
    ...
    `,document.body.appendChild(t)}function oe(e){const t=vo(e);return t==="INSUFFICIENT_GAS"?(ho(),"Insufficient ETH for gas"):(b(t,"error"),t)}function xa(e){const t=(e==null?void 0:e.message)||(e==null?void 0:e.reason)||"";return["Internal JSON-RPC","network","timeout","ETIMEDOUT","ECONNRESET","rate limit","Too Many Requests","nonce","replacement transaction","already known"].some(n=>t.toLowerCase().includes(n.toLowerCase()))}function va(e){const t=(e==null?void 0:e.message)||(e==null?void 0:e.reason)||"";return t.includes("user rejected")||t.includes("User denied")||t.includes("cancelled")||t.includes("canceled")}async function wt(e,t,s,n,a=Te.MAX_RETRIES){const i=["function approve(address,uint256) returns (bool)","function allowance(address,address) view returns (uint256)"],o=new U.Contract(e,i,n);let r;try{r=await o.allowance(c.userAddress,t),console.log("Current allowance:",U.formatEther(r),"BKC")}catch(d){console.warn("Could not check allowance:",d.message),r=0n}if(r>=s)return console.log("✅ Already approved"),!0;const l=s*10n;for(let d=1;d<=a;d++)try{b(`Approve tokens... ${d>1?`(attempt ${d})`:""}`,"info");const u=await o.approve(t,l);if(b("Waiting for approval confirmation...","info"),(await u.wait()).status===0)throw new Error("Approval transaction reverted");if(await Ye(Te.APPROVAL_WAIT_MS),await o.allowance(c.userAddress,t)>=s)return b("✅ Approved!","success"),!0;throw new Error("Approval not reflected yet")}catch(u){if(console.error(`Approval attempt ${d} failed:`,u),va(u))return b("Approval cancelled","error"),!1;if(d<a&&xa(u)){b(`Retrying approval... (${d}/${a})`,"warning"),await Ye(Te.RETRY_DELAY_MS*d);continue}return oe(u),!1}return!1}async function fe(e,t={}){const{retries:s=Te.MAX_RETRIES,onAttempt:n=()=>{},onSuccess:a=()=>{},description:i="Transaction"}=t;for(let o=1;o<=s;o++)try{n(o);const r=await e();b("Waiting for confirmation...","info");const l=await r.wait();if(l.status===0)throw new Error("Transaction reverted");return a(l),{success:!0,receipt:l,txHash:l.hash}}catch(r){if(console.error(`${i} attempt ${o} failed:`,r),va(r))return b("Transaction cancelled","error"),{success:!1,cancelled:!0};if(o<s&&xa(r)){b(`Network issue, retrying... (${o}/${s})`,"warning"),await Ye(Te.RETRY_DELAY_MS*o);continue}return oe(r),{success:!1,error:r}}return{success:!1}}async function yo(e,t,s,n){const a=await pe();if(!a)return!1;try{const i=BigInt(e),o=BigInt(t),r=BigInt(s||0);if(await c.bkcTokenContract.balanceOf(c.userAddress)<i)return b("Insufficient BKC balance","error"),!1;if(!await wt(v.bkcToken,v.delegationManager,i,a))return!1;const u=new U.Contract(v.delegationManager,je,a),f=await fe(()=>u.delegate(i,o,r),{description:"Delegation",onAttempt:p=>{p===1&&b("Confirm delegation in wallet...","info")},onSuccess:()=>{b("✅ Delegation successful!","success"),X()}});return f.success&&f.txHash&&ue("delegation",f.txHash),f.success}catch(i){return console.error("Delegation error:",i),oe(i),!1}finally{}}async function ko(e,t,s){const n=await pe();if(!n)return!1;try{const a=Number(e);if(isNaN(a)||a<0)return b("Invalid delegation index","error"),!1;const i=BigInt(a),o=BigInt(t||0);console.log("Unstake params:",{index:i.toString(),boosterId:o.toString()});const r=new U.Contract(v.delegationManager,je,n),l=await fe(()=>r.unstake(i,o),{description:"Unstake",onAttempt:d=>{d===1&&b("Confirm unstake in wallet...","info")},onSuccess:async()=>{b("✅ Unstaked!","success"),await X(!0),await Gs(!0)}});return l.success&&l.txHash&&ue("unstake",l.txHash),l.success}catch(a){return console.error("Unstake error:",a),oe(a),!1}finally{}}async function To(e,t,s){const n=await pe();if(!n)return!1;try{const a=Number(e);if(isNaN(a)||a<0)return b("Invalid delegation index","error"),!1;const i=BigInt(a),o=BigInt(t||0),r=new U.Contract(v.delegationManager,je,n),l=await fe(()=>r.forceUnstake(i,o),{description:"Force Unstake",onAttempt:d=>{d===1&&b("Confirm force unstake in wallet...","info")},onSuccess:async()=>{b("✅ Force unstaked (penalty applied)","success"),await X(!0),await Gs(!0)}});return l.success&&l.txHash&&ue("unstake",l.txHash),l.success}catch(a){return console.error("Force unstake error:",a),oe(a),!1}finally{}}async function Qs(e,t,s,n){const a=await pe();if(!a)return!1;const i=(n==null?void 0:n.innerHTML)||"Claim";n&&(n.innerHTML='<div class="loader inline-block"></div> Processing...',n.disabled=!0);try{let o=0n;try{const d=Number(s||0);d>0&&c.myBoosters&&c.myBoosters.length>0&&c.myBoosters.some(f=>Number(f.tokenId)===d)&&(o=BigInt(d))}catch(d){console.warn("Invalid booster ID for claim, using 0:",d)}const r=new U.Contract(v.delegationManager,je,a),l=await fe(()=>r.claimReward(o),{description:"Claim Rewards",onAttempt:d=>{d===1&&b("Confirm claim in wallet...","info")},onSuccess:async()=>{b("✅ Rewards claimed!","success"),await X(!0)}});return l.success&&l.txHash&&ue("claimReward",l.txHash),l.success}catch(o){return console.error("Claim error:",o),oe(o),!1}finally{n&&(n.innerHTML=i,n.disabled=!1)}}async function zo(e,t,s){var i;const n=await pe();if(!n)return{success:!1};const a=(s==null?void 0:s.innerHTML)||"Buy";s&&(s.innerHTML='<div class="loader inline-block"></div> Processing...',s.disabled=!0);try{const o=BigInt(t);if(!await wt(v.bkcToken,e,o,n))return{success:!1};s&&(s.innerHTML='<div class="loader inline-block"></div> Buying...');const l=new U.Contract(e,Us,n),d=await fe(()=>l.buyNFT(),{description:"Buy NFT",onAttempt:u=>{u===1&&b("Confirm purchase in wallet...","info")}});if(d.success){let u=null;for(const f of d.receipt.logs)try{const p=l.interface.parseLog(f);if((p==null?void 0:p.name)==="NFTPurchased"){u=(i=p.args.tokenId)==null?void 0:i.toString();break}}catch{}return b(`✅ NFT purchased! ${u?`#${u}`:""}`,"success"),X(),ue("buyNFT",d.txHash),{success:!0,tokenId:u,txHash:d.txHash}}return{success:!1}}catch(o){return console.error("Buy NFT error:",o),oe(o),{success:!1}}finally{s&&(s.innerHTML=a,s.disabled=!1)}}async function Co(e,t,s,n){const a=await pe();if(!a)return{success:!1};const i=(n==null?void 0:n.innerHTML)||"Sell";n&&(n.innerHTML='<div class="loader inline-block"></div> Processing...',n.disabled=!0);try{let o=t;if(typeof t=="object"&&t!==null&&(o=t.tokenId||t.id||t.token_id,console.warn("executeSellNFT: Object passed instead of tokenId, extracted:",o)),o==null||o==="")return console.error("executeSellNFT: Invalid tokenId:",t),b("Invalid NFT token ID","error"),{success:!1};try{o=BigInt(o)}catch{return console.error("executeSellNFT: Cannot convert tokenId to BigInt:",o),b("Invalid NFT token ID format","error"),{success:!1}}let r=0n;if(s!=null&&s!=="")try{r=BigInt(s)}catch{console.warn("executeSellNFT: Invalid minPayout, using 0"),r=0n}const l=["function approve(address,uint256)","function getApproved(uint256) view returns (address)"],d=new U.Contract(v.rewardBoosterNFT,l,a);(await d.getApproved(o)).toLowerCase()!==e.toLowerCase()&&(b("Approving NFT...","info"),await(await d.approve(e,o)).wait(),await Ye(Te.APPROVAL_WAIT_MS)),n&&(n.innerHTML='<div class="loader inline-block"></div> Selling...');const f=new U.Contract(e,Us,a),p=await fe(()=>f.sellNFT(o,r),{description:"Sell NFT",onAttempt:g=>{g===1&&b("Confirm sale in wallet...","info")}});return p.success?(b("✅ NFT sold!","success"),X(),ue("sellNFT",p.txHash),{success:!0,txHash:p.txHash}):{success:!1}}catch(o){return console.error("Sell NFT error:",o),oe(o),{success:!1}}finally{n&&(n.innerHTML=i,n.disabled=!1)}}async function Bo(e,t){const s=await pe();if(!s)return{success:!1};const n=(t==null?void 0:t.innerHTML)||"List";t&&(t.innerHTML='<div class="loader inline-block"></div> Processing...',t.disabled=!0);try{let a,i,o,r;typeof e=="object"&&e!==null?(a=e.tokenId,i=e.pricePerHour,o=e.minHours,r=e.maxHours):(a=e,i=arguments[1],o=arguments[2],r=arguments[3],t=arguments[4]);const l=v.rentalManager;if(!l)return b("Rental Manager not configured","error"),{success:!1};const d=["function setApprovalForAll(address,bool)","function isApprovedForAll(address,address) view returns (bool)"],u=new U.Contract(v.rewardBoosterNFT,d,s);await u.isApprovedForAll(c.userAddress,l)||(b("Approving NFTs for rental...","info"),await(await u.setApprovalForAll(l,!0)).wait(),await Ye(Te.APPROVAL_WAIT_MS)),t&&(t.innerHTML='<div class="loader inline-block"></div> Listing...');const p=new U.Contract(l,Ee,s),g=await fe(()=>p.listNFT(BigInt(a),BigInt(i),BigInt(o),BigInt(r)),{description:"List NFT",onAttempt:m=>{m===1&&b("Confirm listing in wallet...","info")}});return g.success?(b(`✅ NFT #${a} listed for rent!`,"success"),ht(!0),ue("listRental",g.txHash),{success:!0,txHash:g.txHash}):{success:!1}}catch(a){return console.error("List NFT error:",a),oe(a),{success:!1}}finally{t&&(t.innerHTML=n,t.disabled=!1)}}async function Eo(e,t){const s=await pe();if(!s)return{success:!1};const n=(t==null?void 0:t.innerHTML)||"Rent";t&&(t.innerHTML='<div class="loader inline-block"></div> Processing...',t.disabled=!0);try{let a,i,o;typeof e=="object"&&e!==null?(a=e.tokenId,i=e.hours,o=e.totalCost):(a=e,i=arguments[1],o=arguments[2],t=arguments[3]);const r=v.rentalManager;if(!r)return b("Rental Manager not configured","error"),{success:!1};const l=BigInt(o);if(!await wt(v.bkcToken,r,l,s))return{success:!1};t&&(t.innerHTML='<div class="loader inline-block"></div> Renting...');const u=new U.Contract(r,Ee,s),f=await fe(()=>u.rentNFT(BigInt(a),BigInt(i)),{description:"Rent NFT",onAttempt:p=>{p===1&&b("Confirm rental in wallet...","info")}});return f.success?(b(`✅ NFT #${a} rented for ${i} hours!`,"success"),X(),ht(!0),ue("rentNFT",f.txHash),{success:!0,txHash:f.txHash}):{success:!1}}catch(a){return console.error("Rent NFT error:",a),oe(a),{success:!1}}finally{t&&(t.innerHTML=n,t.disabled=!1)}}async function Io(e,t){const s=await pe();if(!s)return{success:!1};const n=(t==null?void 0:t.innerHTML)||"Withdraw";t&&(t.innerHTML='<div class="loader inline-block"></div> Processing...',t.disabled=!0);try{const a=v.rentalManager,i=new U.Contract(a,Ee,s),o=await fe(()=>i.withdrawNFT(e),{description:"Withdraw NFT",onAttempt:r=>{r===1&&b("Confirm withdrawal in wallet...","info")}});return o.success?(b("✅ NFT withdrawn!","success"),X(),ht(),{success:!0,txHash:o.txHash}):{success:!1}}catch(a){return console.error("Withdraw NFT error:",a),oe(a),{success:!1}}finally{t&&(t.innerHTML=n,t.disabled=!1)}}async function $o(e,t){var a;const s=await pe();if(!s)return!1;const n=(t==null?void 0:t.innerHTML)||"Notarize";t&&(t.innerHTML='<div class="loader inline-block"></div> Processing...',t.disabled=!0);try{const{ipfsUri:i,contentHash:o,description:r}=e,l=v.decentralizedNotary||v.notary;if(!l)return b("Notary contract not configured","error"),!1;let d=U.parseEther("1");try{d=await new U.Contract(l,Ts,s.provider).calculateFee(0)}catch{}if(!await wt(v.bkcToken,l,d,s))return!1;t&&(t.innerHTML='<div class="loader inline-block"></div> Notarizing...');const f=new U.Contract(l,Ts,s);let p=0n;try{const m=await Ve();m!=null&&m.tokenId&&(p=BigInt(m.tokenId))}catch{}const g=await fe(()=>f.notarize(i,r||"",o,p),{description:"Notarize",onAttempt:m=>{m===1&&b("Confirm notarization in wallet...","info")}});if(g.success){let m=null;for(const x of g.receipt.logs)try{const y=f.interface.parseLog(x);if((y==null?void 0:y.name)==="DocumentNotarized"){m=(a=y.args.tokenId)==null?void 0:a.toString();break}}catch{}return b(`✅ Document notarized! ${m?`#${m}`:""}`,"success"),ue("notarize",g.txHash),{success:!0,tokenId:m,txHash:g.txHash}}return!1}catch(i){return console.error("Notarize error:",i),oe(i),!1}finally{t&&(t.innerHTML=n,t.disabled=!1)}}const Ao=$o,Lo="https://faucet-4wvdcuoouq-uc.a.run.app";async function So(e){if(!c.isConnected||!c.userAddress)return b("Please connect wallet first","error"),{success:!1};const t=(e==null?void 0:e.innerHTML)||"Claim";e.innerHTML='<div class="loader inline-block"></div> Claiming...',e.disabled=!0;try{const s=await fetch(`${Lo}?address=${c.userAddress}`,{method:"GET",headers:{Accept:"application/json"}}),n=await s.json();if(s.ok&&n.success)return b("✅ Tokens received!","success"),X(),n.txHash&&ue("faucet",n.txHash),{success:!0,txHash:n.txHash,bkcAmount:n.bkcAmount,ethAmount:n.ethAmount};{const a=n.error||n.message||"Faucet unavailable";return b(a,"error"),{success:!1,error:a}}}catch(s){return console.error("Faucet error:",s),b("Faucet unavailable","error"),{success:!1}}finally{e.innerHTML=t,e.disabled=!1}}const Po=["function play(uint256 _wagerAmount, uint256[] calldata _guesses, bool _isCumulative) external payable","function prizePoolBalance() external view returns (uint256)","function gameCounter() external view returns (uint256)","function activeTierCount() external view returns (uint256)","function serviceFee() external view returns (uint256)","function getRequiredServiceFee(bool _isCumulative) external view returns (uint256)","event GamePlayed(uint256 indexed gameId, address indexed player, uint256 wagerAmount, uint256 prizeWon, bool isCumulative, uint8 matchCount)","event GameDetails(uint256 indexed gameId, uint256[] guesses, uint256[] rolls, bool[] matches)","event JackpotWon(uint256 indexed gameId, address indexed player, uint256 prizeAmount, uint256 tier)"];async function No(e,t,s,n){const a=await pe();if(!a)return{success:!1};try{const i=U.parseEther(e.toString()),o=Array.isArray(t)?t.map(m=>BigInt(m)):[BigInt(t)];console.log("Fortune V2 Play params:",{wager:e.toString(),wagerWei:i.toString(),guesses:o.map(m=>m.toString()),isCumulative:s});const r=v.fortunePoolV2||v.fortunePool||v.actionsManager;if(!r)return b("Fortune Pool not configured","error"),{success:!1};const l=new U.Contract(r,Po,a);let d=0n;try{if(d=await l.activeTierCount(),d===0n)return b("No active game tiers","error"),{success:!1};const m=s?Number(d):1;if(o.length!==m)return b(`Need ${m} guess(es), got ${o.length}`,"error"),{success:!1}}catch(m){console.warn("Could not verify tier count:",m.message)}let u=0n;try{u=await l.getRequiredServiceFee(s),console.log("Required service fee:",U.formatEther(u),"ETH")}catch(m){console.warn("Could not get service fee:",m.message)}if(u>0n&&await a.provider.getBalance(c.userAddress)<u)return b(`Need ${U.formatEther(u)} ETH for game fee`,"error"),{success:!1};if(await c.bkcTokenContract.balanceOf(c.userAddress)<i)return b("Insufficient BKC balance","error"),{success:!1};if(!await wt(v.bkcToken,r,i,a))return{success:!1};const g=await fe(()=>l.play(i,o,s,{value:u}),{description:"Fortune Game V2",retries:Te.MAX_RETRIES,onAttempt:m=>{m===1&&b("Confirm game in wallet...","info")}});if(g.success){let m=null,x=[],y=0,k=[],E=0,L=!1;for(const A of g.receipt.logs)try{const $=l.interface.parseLog({topics:A.topics,data:A.data});($==null?void 0:$.name)==="GamePlayed"&&(m=Number($.args.gameId),y=Number(U.formatEther($.args.prizeWon)),E=Number($.args.matchCount)),($==null?void 0:$.name)==="GameDetails"&&(x=$.args.rolls.map(T=>Number(T)),k=Array.from($.args.matches)),($==null?void 0:$.name)==="JackpotWon"&&(L=!0)}catch{}return y>0?b(L?`🎰🎰🎰 JACKPOT! +${y.toLocaleString()} BKC!`:`🎉 YOU WON ${y.toLocaleString()} BKC!`,"success"):b("No match this time. Try again!","warning"),X(),ue("fortune",g.txHash),{success:!0,gameId:m,rolls:x,guesses:o.map(A=>Number(A)),prizeWon:y,matches:k,matchCount:E,isJackpot:L,isCumulative:s,txHash:g.txHash}}return{success:!1}}catch(i){return console.error("Fortune V2 error:",i),oe(i),{success:!1}}finally{}}const Zt=window.ethers,I={hasRenderedOnce:!1,lastUpdate:0,activities:[],networkActivities:[],filteredActivities:[],userProfile:null,pagination:{currentPage:1,itemsPerPage:8},filters:{type:"ALL",sort:"NEWEST"},metricsCache:{},economicData:null,isLoadingNetworkActivity:!1,networkActivitiesTimestamp:0,faucet:{canClaim:!0,cooldownEnd:null,isLoading:!1,lastCheck:0}},In="https://sepolia.arbiscan.io/tx/",Mo="https://sepolia.arbiscan.io/address/",Fo="https://faucet-4wvdcuoouq-uc.a.run.app",Ro="https://getrecentactivity-4wvdcuoouq-uc.a.run.app",Do="https://getsystemdata-4wvdcuoouq-uc.a.run.app",Cs="1,000",Bs="0.01",jo=Zt.parseUnits("100",18),q={STAKING:{icon:"fa-lock",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🔒 Staked",emoji:"🔒"},UNSTAKING:{icon:"fa-unlock",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"🔓 Unstaked",emoji:"🔓"},FORCE_UNSTAKE:{icon:"fa-bolt",color:"#ef4444",bg:"rgba(239,68,68,0.15)",label:"⚡ Force Unstaked",emoji:"⚡"},CLAIM:{icon:"fa-coins",color:"#fbbf24",bg:"rgba(245,158,11,0.15)",label:"🪙 Rewards Claimed",emoji:"🪙"},NFT_BUY:{icon:"fa-bag-shopping",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🛍️ Bought NFT",emoji:"🛍️"},NFT_SELL:{icon:"fa-hand-holding-dollar",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"💰 Sold NFT",emoji:"💰"},NFT_MINT:{icon:"fa-gem",color:"#fde047",bg:"rgba(234,179,8,0.15)",label:"💎 Minted Booster",emoji:"💎"},NFT_TRANSFER:{icon:"fa-arrow-right-arrow-left",color:"#60a5fa",bg:"rgba(59,130,246,0.15)",label:"↔️ Transfer",emoji:"↔️"},RENTAL_LIST:{icon:"fa-tag",color:"#4ade80",bg:"rgba(34,197,94,0.15)",label:"🏷️ Listed NFT",emoji:"🏷️"},RENTAL_RENT:{icon:"fa-clock",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"⏰ Rented NFT",emoji:"⏰"},RENTAL_WITHDRAW:{icon:"fa-rotate-left",color:"#fb923c",bg:"rgba(249,115,22,0.15)",label:"↩️ Withdrawn",emoji:"↩️"},FORTUNE_BET:{icon:"fa-paw",color:"#f97316",bg:"rgba(249,115,22,0.2)",label:"🐯 Fortune Bet",emoji:"🐯"},FORTUNE_COMBO:{icon:"fa-rocket",color:"#a855f7",bg:"rgba(168,85,247,0.2)",label:"🚀 Combo",emoji:"🚀"},FORTUNE_JACKPOT:{icon:"fa-crown",color:"#f59e0b",bg:"rgba(245,158,11,0.2)",label:"👑 Jackpot",emoji:"👑"},FORTUNE_ORACLE:{icon:"fa-eye",color:"#e879f9",bg:"rgba(232,121,249,0.25)",label:"🔮 Oracle Response",emoji:"🔮"},FORTUNE_WIN:{icon:"fa-trophy",color:"#facc15",bg:"rgba(234,179,8,0.25)",label:"🏆 Winner!",emoji:"🏆"},FORTUNE_LOSE:{icon:"fa-dice",color:"#71717a",bg:"rgba(39,39,42,0.5)",label:"🎲 No Luck",emoji:"🎲"},NOTARY:{icon:"fa-stamp",color:"#818cf8",bg:"rgba(99,102,241,0.15)",label:"📜 Notarized",emoji:"📜"},FAUCET:{icon:"fa-droplet",color:"#22d3ee",bg:"rgba(6,182,212,0.15)",label:"💧 Faucet Claim",emoji:"💧"},DEFAULT:{icon:"fa-circle",color:"#71717a",bg:"rgba(39,39,42,0.5)",label:"Activity",emoji:"📋"}};function Ho(e){if(!e)return"Just now";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3,s=new Date(t*1e3),a=new Date-s,i=Math.floor(a/6e4),o=Math.floor(a/36e5),r=Math.floor(a/864e5);return i<1?"Just now":i<60?`${i}m ago`:o<24?`${o}h ago`:r<7?`${r}d ago`:s.toLocaleDateString()}catch{return"Recent"}}function _o(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function cs(e){return e>=1e6?(e/1e6).toFixed(2)+"M":e>=1e3?(e/1e3).toFixed(1)+"K":e.toFixed(0)}function Uo(e){return e?`${e.slice(0,6)}...${e.slice(-4)}`:""}function Oo(e){if(!e)return"";const t=Date.now(),n=new Date(e).getTime()-t;if(n<=0)return"";const a=Math.floor(n/36e5),i=Math.floor(n%36e5/6e4);return a>0?`${a}h ${i}m`:`${i}m`}function Wo(e,t={}){const s=(e||"").toUpperCase().trim();if(s==="STAKING"||s==="STAKED"||s==="STAKE"||s==="DELEGATED"||s==="DELEGATION"||s.includes("DELEGAT"))return q.STAKING;if(s==="UNSTAKE"||s==="UNSTAKED"||s==="UNSTAKING"||s.includes("UNDELEGAT"))return s.includes("FORCE")?q.FORCE_UNSTAKE:q.UNSTAKING;if(s==="CLAIMREWARD"||s==="CLAIM"||s==="CLAIMED"||s.includes("REWARD")||s.includes("CLAIM"))return q.CLAIM;if(s==="NFTBOUGHT"||s.includes("NFTBOUGHT")||s.includes("NFT_BOUGHT"))return q.NFT_BUY;if(s==="NFTSOLD"||s.includes("NFTSOLD")||s.includes("NFT_SOLD"))return q.NFT_SELL;if(s==="BOOSTERBUY"||s.includes("BOOSTER")||s.includes("PRESALE")||s.includes("MINTED"))return q.NFT_MINT;if(s==="TRANSFER"||s.includes("TRANSFER"))return q.NFT_TRANSFER;if(s==="RENTALLISTED"||s.includes("LISTED")||s.includes("LIST"))return q.RENTAL_LIST;if(s==="RENTALRENTED"||s==="RENTED"||s.includes("RENTAL")&&s.includes("RENT"))return q.RENTAL_RENT;if(s==="RENTALWITHDRAWN"||s.includes("WITHDRAW"))return q.RENTAL_WITHDRAW;if(s==="GAMEREQUESTED"||s.includes("GAMEREQUESTED")||s.includes("GAME_REQUEST")||s.includes("REQUEST")||s.includes("GAMEPLAYED")||s.includes("FORTUNE")||s.includes("GAME")){const n=t==null?void 0:t.isCumulative,a=(t==null?void 0:t.guesses)||[];return n===!0||a.length>1?q.FORTUNE_COMBO:n===!1||a.length===1?q.FORTUNE_JACKPOT:q.FORTUNE_BET}return s==="GAMEFULFILLED"||s.includes("FULFILLED")||s.includes("ORACLE")?q.FORTUNE_ORACLE:s==="GAMERESULT"||s.includes("RESULT")?(t==null?void 0:t.isWin)||(t==null?void 0:t.prizeWon)>0?q.FORTUNE_WIN:q.FORTUNE_LOSE:s==="NOTARYREGISTER"||s==="NOTARIZED"||s.includes("NOTARY")||s.includes("DOCUMENT")?q.NOTARY:s==="FAUCETCLAIM"||s.includes("FAUCET")||s.includes("DISTRIBUTED")?q.FAUCET:q.DEFAULT}let ds=null,$e=0n;function ha(e){const t=document.getElementById("dash-user-rewards");if(!t||!c.isConnected){ds&&cancelAnimationFrame(ds);return}const s=e-$e;s>-1000000000n&&s<1000000000n?$e=e:$e+=s/8n,$e<0n&&($e=0n),t.innerHTML=`${B($e).toFixed(4)} <span class="text-sm text-amber-500/80">BKC</span>`,$e!==e&&(ds=requestAnimationFrame(()=>ha(e)))}async function $n(e){if(!c.isConnected||!c.userAddress)return b("Connect wallet first","error");const t=e.innerHTML;e.disabled=!0,e.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-2"></i> Sending...',I.faucet.isLoading=!0;try{const s=await fetch(`${Fo}?address=${c.userAddress}`,{method:"GET",headers:{Accept:"application/json"}}),n=await s.json();if(s.ok&&n.success)b(`✅ Faucet Sent! ${Cs} BKC + ${Bs} ETH`,"success"),I.faucet.canClaim=!1,I.faucet.cooldownEnd=new Date(Date.now()+24*60*60*1e3).toISOString(),Es(),setTimeout(()=>{ka.update(!0)},4e3);else{const a=n.error||n.message||"Faucet unavailable";if(a.toLowerCase().includes("cooldown")||a.toLowerCase().includes("wait")||a.toLowerCase().includes("hour")){b(`⏳ ${a}`,"warning");const i=a.match(/(\d+)\s*hour/i);if(i){const o=parseInt(i[1]);I.faucet.canClaim=!1,I.faucet.cooldownEnd=new Date(Date.now()+o*60*60*1e3).toISOString(),Es()}}else b(`❌ ${a}`,"error")}}catch(s){console.error("Faucet error:",s),b("Faucet Offline - Try again later","error")}finally{I.faucet.isLoading=!1,e.disabled=!1,e.innerHTML=t}}function qo(){return c.isConnected?(c.currentUserBalance||c.bkcBalance||0n)<jo:!1}function Es(){const e=document.getElementById("dashboard-faucet-widget");if(!e)return;if(!qo()){e.classList.add("hidden");return}e.classList.remove("hidden");const t=c.currentUserBalance||c.bkcBalance||0n,s=t===0n,n=Oo(I.faucet.cooldownEnd),a=I.faucet.canClaim&&!n,i=document.getElementById("faucet-title"),o=document.getElementById("faucet-desc"),r=document.getElementById("faucet-status"),l=document.getElementById("faucet-action-btn");if(e.className="glass-panel border-l-4 p-4",l&&(l.className="w-full sm:w-auto font-bold py-2.5 px-5 rounded-lg text-sm transition-all"),!a&&n)e.classList.add("border-zinc-500"),i&&(i.innerText="⏳ Faucet Cooldown"),o&&(o.innerText="Come back when the timer ends"),r&&(r.classList.remove("hidden"),r.innerHTML=`<i class="fa-solid fa-clock mr-1"></i> ${n} remaining`),l&&(l.classList.add("bg-zinc-700","text-zinc-400","cursor-not-allowed"),l.innerHTML='<i class="fa-solid fa-hourglass-half mr-2"></i> On Cooldown',l.disabled=!0);else if(s)e.classList.add("border-green-500"),i&&(i.innerText="🎉 Welcome to BackCoin!"),o&&(o.innerText=`Claim your free starter pack: ${Cs} BKC + ${Bs} ETH for gas`),r&&r.classList.add("hidden"),l&&(l.classList.add("bg-green-600","hover:bg-green-500","text-white","hover:scale-105"),l.innerHTML='<i class="fa-solid fa-gift mr-2"></i> Claim Starter Pack',l.disabled=!1);else{const d=B(t).toFixed(2);e.classList.add("border-cyan-500"),i&&(i.innerText="💧 Need More BKC?"),o&&(o.innerText=`Balance: ${d} BKC • Get ${Cs} BKC + ${Bs} ETH`),r&&r.classList.add("hidden"),l&&(l.classList.add("bg-cyan-600","hover:bg-cyan-500","text-white","hover:scale-105"),l.innerHTML='<i class="fa-solid fa-faucet mr-2"></i> Request Tokens',l.disabled=!1)}}async function Yo(){try{if(await c.provider.getBalance(c.userAddress)<Zt.parseEther("0.002")){const t=document.getElementById("no-gas-modal-dash");return t&&(t.classList.remove("hidden"),t.classList.add("flex")),!1}return!0}catch{return!0}}function Ko(){if(!ie.dashboard)return;const e=v.ecosystemManager||"",t=e?`${Mo}${e}`:"#";ie.dashboard.innerHTML=`
    ...
    `}async function Dt(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("activity-title");try{if(c.isConnected){if(I.activities.length===0){e&&(e.innerHTML=`
                        <div class="flex flex-col items-center justify-center py-8">
                            <div class="relative">
                                <div class="absolute inset-0 bg-amber-500/30 blur-xl rounded-full animate-pulse"></div>
                                <img src="./assets/bkc_logo_3d.png" class="relative w-12 h-12 object-contain animate-bounce" alt="Loading">
                    ...
                    `);const s=await fetch(`${ce.getHistory}/${c.userAddress}`);s.ok&&(I.activities=await s.json())}if(I.activities.length>0){t&&(t.textContent="Your Activity"),$s();return}}t&&(t.textContent="Network Activity"),await An()}catch(s){console.error("Activity fetch error:",s),t&&(t.textContent="Network Activity"),await An()}}async function An(){const e=document.getElementById("dash-activity-list");if(!e||I.isLoadingNetworkActivity)return;const t=Date.now()-I.networkActivitiesTimestamp;if(I.networkActivities.length>0&&t<3e5){Ln();return}I.isLoadingNetworkActivity=!0,e.innerHTML=`
        <div class="flex flex-col items-center justify-center py-8">
            <div class="relative">
                <div class="absolute inset-0 bg-amber-500/30 blur-xl rounded-full animate-pulse"></div>
                <img src="./assets/bkc_logo_3d.png" class="relative w-12 h-12 object-contain animate-bounce" alt="Loading">
    ...
    `;try{const s=await fetch(`${Ro}?limit=30`);if(s.ok){const n=await s.json();I.networkActivities=Array.isArray(n)?n:n.activities||[],I.networkActivitiesTimestamp=Date.now()}else I.networkActivities=[]}catch(s){console.error("Network activity fetch error:",s),I.networkActivities=[]}finally{I.isLoadingNetworkActivity=!1}Ln()}function Ln(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("dash-pagination-controls");if(e){if(I.networkActivities.length===0){e.innerHTML=`
        ...
        `,t&&t.classList.add("hidden");return}e.innerHTML=I.networkActivities.slice(0,15).map(s=>ya(s,!0)).join(""),t&&t.classList.add("hidden")}}function $s(){let e=[...I.activities];const t=I.filters.type,s=n=>(n||"").toUpperCase();t!=="ALL"&&(e=e.filter(n=>{const a=s(n.type);return t==="STAKE"?a.includes("DELEGATION")||a.includes("DELEGAT")||a.includes("STAKE")||a.includes("UNSTAKE"):t==="CLAIM"?a.includes("REWARD")||a.includes("CLAIM"):t==="NFT"?a.includes("BOOSTER")||a.includes("RENT")||a.includes("NFT")||a.includes("TRANSFER"):t==="GAME"?a.includes("FORTUNE")||a.includes("GAME")||a.includes("REQUEST")||a.includes("RESULT")||a.includes("FULFILLED"):t==="NOTARY"?a.includes("NOTARY")||a.includes("NOTARIZED")||a.includes("DOCUMENT"):t==="FAUCET"?a.includes("FAUCET"):!0})),e.sort((n,a)=>{const i=o=>o.timestamp&&o.timestamp._seconds?o.timestamp._seconds:o.createdAt&&o.createdAt._seconds?o.createdAt._seconds:o.timestamp?new Date(o.timestamp).getTime()/1e3:0;return I.filters.sort==="NEWEST"?i(a)-i(n):i(n)-i(a)}),I.filteredActivities=e,I.pagination.currentPage=1,As()}function As(){const e=document.getElementById("dash-activity-list"),t=document.getElementById("dash-pagination-controls");if(!e)return;if(I.filteredActivities.length===0){e.innerHTML=`
            <div class="flex flex-col items-center justify-center py-8 px-4">
                <div class="relative mb-4">
                    <div class="absolute inset-0 bg-amber-500/20 blur-xl rounded-full animate-pulse"></div>
        ...
        `,t&&t.classList.add("hidden");return}const s=(I.pagination.currentPage-1)*I.pagination.itemsPerPage,n=s+I.pagination.itemsPerPage,a=I.filteredActivities.slice(s,n);if(e.innerHTML=a.map(i=>ya(i,!1)).join(""),t){const i=Math.ceil(I.filteredActivities.length/I.pagination.itemsPerPage);i>1?(t.classList.remove("hidden"),document.getElementById("page-indicator").innerText=`${I.pagination.currentPage}/${i}`,document.getElementById("page-prev").disabled=I.pagination.currentPage===1,document.getElementById("page-next").disabled=I.pagination.currentPage>=i):t.classList.add("hidden")}}function ya(e,t=!1){const s=Ho(e.timestamp||e.createdAt),n=_o(e.timestamp||e.createdAt),a=e.user||e.userAddress||e.from||"",i=Uo(a),o=Wo(e.type,e.details);let r="";const l=(e.type||"").toUpperCase().trim(),d=e.details||{};if(l.includes("GAME")||l.includes("FORTUNE")||l.includes("REQUEST")||l.includes("FULFILLED")||l.includes("RESULT")){const x=d.rolls||e.rolls||[],y=d.guesses||e.guesses||[],k=d.isWin||d.prizeWon&&BigInt(d.prizeWon||0)>0n,E=d.isCumulative!==void 0?d.isCumulative:y.length>1,L=d.wagerAmount||d.amount,A=d.prizeWon,$=E?"Combo":"Jackpot",T=E?"bg-purple-500/20 text-purple-400":"bg-amber-500/20 text-amber-400",M=L?B(BigInt(L)).toFixed(0):"0";let W="No win",se="text-zinc-500";k&&A&&BigInt(A)>0n&&(W=`<span class="text-emerald-400 font-bold">+${B(BigInt(A)).toFixed(0)} BKC</span>`,se="");let S="";return x.length>0&&(S=`<div class="flex gap-1">
                ${x.map((Q,Y)=>{const Ie=y[Y];return`<div class="w-7 h-7 rounded text-xs font-bold flex items-center justify-center border ${Ie!==void 0&&Number(Ie)===Number(Q)?"bg-emerald-500/20 border-emerald-500/50 text-emerald-400":"bg-zinc-800 border-zinc-700 text-zinc-400"}">${Q}</div>`}).join("")}
            </div>`),`
            <a href="${e.txHash?`${In}${e.txHash}`:"#"}" target="_blank" class="block p-3 hover:bg-zinc-800/50 border border-zinc-700/30 rounded-lg transition-all group" style="background: rgba(39,39,42,0.4)" title="${n}">
                <div class="flex items-center justify-between mb-2">
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <span class="ml-2 text-[10px] font-bold px-2 py-0.5 rounded ${T}">${$}</span>
                        </div>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div class="text-xs">
                        <span class="text-zinc-500">Bet: ${M}</span>
        ...
        `}if(l.includes("NOTARY")){const x=d.ipfsCid;x&&(r=`<span class="ml-2 text-[9px] text-indigo-400 font-mono">${x.replace("ipfs://","").slice(0,12)+"..."}</span>`)}if(l.includes("STAKING")||l.includes("DELEGAT")){const x=d.pStakeGenerated;x&&(r=`<span class="text-[10px] text-purple-400">+${B(BigInt(x)).toFixed(0)} pStake</span>`)}if(l.includes("CLAIM")||l.includes("REWARD")){const x=d.feePaid,y=d.amount||e.amount;if(y&&(r=`<span class="text-amber-400 font-bold">+${B(BigInt(y)).toFixed(2)} BKC</span>`),x&&BigInt(x)>0n){const k=B(BigInt(x)).toFixed(2);r+=`<span class="ml-1 text-[9px] text-zinc-500">(fee: ${k})</span>`}}const f=e.txHash?`${In}${e.txHash}`:"#";let p=e.amount||d.amount||d.wagerAmount||d.prizeWon||"0";const g=B(BigInt(p)),m=g>.001?g.toFixed(2):"";return`
        <a href="${f}" target="_blank" class="flex items-center justify-between p-2.5 hover:bg-zinc-800/60 border border-zinc-700/30 rounded-lg transition-all hover:border-zinc-600/50 group" style="background: rgba(39,39,42,0.3)" title="${n}">
            ...
            <div class="text-right flex items-center gap-2">
                ${m?`<p class="text-white text-xs font-mono">${m} <span class="text-zinc-500">BKC</span></p>`:""}
    ...
    `}function sr(){if(!ie.dashboard)return;ie.dashboard.addEventListener("click",async t=>{const s=t.target;if(s.closest("#manual-refresh-btn")){const i=s.closest("#manual-refresh-btn");i.disabled=!0,i.innerHTML='<i class="fa-solid fa-rotate fa-spin"></i>',await Rt(!0),await Is(),I.activities=[],I.networkActivities=[],I.networkActivitiesTimestamp=0,I.faucet.lastCheck=0,await Dt(),setTimeout(()=>{i.innerHTML='<i class="fa-solid fa-rotate"></i> <span class="hidden sm:inline">Sync</span>',i.disabled=!1},1e3)}if(s.closest("#faucet-action-btn")){const i=s.closest("#faucet-action-btn");i.disabled||await $n(i)}if(s.closest("#emergency-faucet-btn")&&await $n(s.closest("#emergency-faucet-btn")),s.closest(".delegate-link")&&(t.preventDefault(),window.navigateTo("mine")),s.closest(".go-to-store")&&(t.preventDefault(),window.navigateTo("store")),s.closest(".go-to-rental")&&(t.preventDefault(),window.navigateTo("rental")),s.closest(".go-to-fortune")&&(t.preventDefault(),window.navigateTo("actions")),s.closest(".go-to-notary")&&(t.preventDefault(),window.navigateTo("notary")),s.closest("#open-booster-info")){const i=document.getElementById("booster-info-modal");i&&(i.classList.remove("hidden"),i.classList.add("flex"),setTimeout(()=>{i.classList.remove("opacity-0"),i.querySelector("div").classList.remove("scale-95")},10))}if(s.closest("#close-booster-modal")||s.id==="booster-info-modal"){const i=document.getElementById("booster-info-modal");i&&(i.classList.add("opacity-0"),i.querySelector("div").classList.add("scale-95"),setTimeout(()=>i.classList.add("hidden"),200))}if(s.closest("#close-gas-modal-dash")||s.id==="no-gas-modal-dash"){const i=document.getElementById("no-gas-modal-dash");i&&(i.classList.remove("flex"),i.classList.add("hidden"))}const n=s.closest(".nft-clickable-image");if(n){const i=n.dataset.address,o=n.dataset.tokenid;i&&o&&fi(i,o)}const a=s.closest("#dashboardClaimBtn");if(a&&!a.disabled)try{if(a.innerHTML='<i class="fa-solid fa-circle-notch fa-spin"></i>',a.disabled=!0,!await Yo()){a.innerHTML='<i class="fa-solid fa-gift mr-2"></i> Claim',a.disabled=!1;return}const{stakingRewards:o,minerRewards:r}=await Jt();(o>0n||r>0n)&&await Qs(o,r,null)&&(b("Rewards claimed!","success"),await Rt(!0),I.activities=[],Dt())}catch{b("Claim failed","error")}finally{a.innerHTML='<i class="fa-solid fa-gift mr-2"></i> Claim',a.disabled=!1}if(s.closest("#page-prev")&&I.pagination.currentPage>1&&(I.pagination.currentPage--,As()),s.closest("#page-next")){const i=Math.ceil(I.filteredActivities.length/I.pagination.itemsPerPage);I.pagination.currentPage<i&&(I.pagination.currentPage++,As())}s.closest("#activity-sort-toggle")&&(I.filters.sort=I.filters.sort==="NEWEST"?"OLDEST":"NEWEST",$s())});const e=document.getElementById("activity-filter-type");e&&e.addEventListener("change",t=>{I.filters.type=t.target.value,$s()})}const ka={async render(e){Ko(),Is(),Dt(),c.isConnected&&await Rt(!1)},update(e){const t=Date.now();t-I.lastUpdate>1e4&&(I.lastUpdate=t,Is(),e&&Rt(!1),Dt())}},it=window.ethers,mt="./assets/stake.png",nr="https://sepolia.arbiscan.io/tx/";let qe=!1,bt=0,Zs=3650,es=0n,ge=!1,Ls=[],Ue=0n;function Ta(e){if(e<=0)return"Ready";const t=Math.floor(e/86400),s=Math.floor(e%86400/3600),n=Math.floor(e%3600/60);if(t>365){const a=Math.floor(t/365),i=t%365;return`${a}y : ${i}d`}return t>0?`${t}d : ${s}h : ${n}m`:s>0?`${s}h : ${n}m`:`${n}m`}function ar(e){if(e>=365){const t=e/365;return t>=2?`${Math.floor(t)} Years`:`${t.toFixed(1)} Year`}return e>=30?`${Math.floor(e/30)} Month${e>=60?"s":""}`:`${e} Day${e>1?"s":""}`}function za(e,t){try{const s=BigInt(e),n=BigInt(t);return s*(n/86400n)/10n**18n}catch{return 0n}}function ir(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function or(){if(document.getElementById("staking-styles-v4"))return;const e=document.createElement("style");e.id="staking-styles-v4",e.textContent=`
            ...
            <div class="staking-card rounded-2xl p-4 sm:p-5 mt-4 sm:mt-6">
                ...
                <div id="staking-history-list" class="space-y-2 max-h-[400px] overflow-y-auto">
                    <div class="text-center py-6">
                        <img src="${mt}" class="w-12 h-12 mx-auto opacity-30 animate-pulse mb-2" onerror="this.style.display='none'">
                        <p class="text-zinc-600 text-sm">Loading history...</p>
                    </div>
                </div>
            </div>
        </div>
    `,fr(),c.isConnected?Je(!0):en())}async function Je(e=!1){var s;if(!c.isConnected){en();return}const t=Date.now();if(!(!e&&qe)&&!(!e&&t-bt<1e4)){qe=!0,bt=t;try{const n=await Ve();es=n!=null&&n.tokenId?BigInt(n.tokenId):0n;try{const a=await fetch("https://getsystemdata-4wvdcuoouq-uc.a.run.app");if(a.ok){const i=await a.json();(s=i==null?void 0:i.economy)!=null&&s.totalPStake&&(Ue=BigInt(i.economy.totalPStake),console.log("📊 Network pStake from Firebase:",Re(Ue)))}}catch{console.log("Firebase system data not available, using blockchain fallback")}if(Ue===0n&&(c.delegationManagerContractPublic||c.delegationManagerContract)){const a=c.delegationManagerContractPublic||c.delegationManagerContract;Ue=await O(a,"totalNetworkPStake",[],0n),console.log("📊 Network pStake from blockchain (fallback)")}await Promise.all([X(!0),Gs(!0),Ks()]),cr(),Ba(),ot(),lr()}catch(n){console.error("Staking load error:",n)}finally{qe=!1}}}let at="ALL";async function lr(){if(c.userAddress)try{const e=ce.getHistory||"https://gethistory-4wvdcuoouq-uc.a.run.app",t=await fetch(`${e}/${c.userAddress}`);t.ok&&(Ls=(await t.json()||[]).filter(n=>{const a=(n.type||"").toUpperCase();return a.includes("DELEGAT")||a.includes("STAKE")||a.includes("UNDELEGAT")||a.includes("CLAIM")||a.includes("REWARD")||a.includes("FORCE")}),Ca())}catch(e){console.error("History load error:",e)}}function Ca(){const e=document.getElementById("staking-history-list");if(!e)return;let t=Ls;if(at!=="ALL"&&(t=Ls.filter(s=>{const n=(s.type||"").toUpperCase();switch(at){case"STAKE":return(n.includes("DELEGAT")||n.includes("STAKE"))&&!n.includes("UNSTAKE")&&!n.includes("UNDELEGAT")&&!n.includes("FORCE");case"UNSTAKE":return n.includes("UNSTAKE")||n.includes("UNDELEGAT")||n.includes("FORCE");case"CLAIM":return n.includes("CLAIM")||n.includes("REWARD");default:return!0}})),t.length===0){e.innerHTML=`
            <div class="text-center py-8">
                <img src="${mt}" class="w-14 h-14 mx-auto opacity-20 mb-3" onerror="this.style.display='none'">
                <p class="text-zinc-500 text-sm">No ${at==="ALL"?"staking":at.toLowerCase()} history yet</p>
                <p class="text-zinc-600 text-xs mt-1">Your activity will appear here</p>
            </div>
        `;return}e.innerHTML=t.slice(0,20).map(s=>{const n=(s.type||"").toUpperCase(),a=s.details||{},i=ir(s.timestamp||s.createdAt);let o,r,l,d,u="";if(n.includes("FORCE")||n.includes("UNDELEGAT")&&a.feePaid&&BigInt(a.feePaid||0)>0n){o="fa-bolt",r="#ef4444",l="rgba(239,68,68,0.15)",d="⚡ Force Unstaked";const x=a.feePaid;x&&BigInt(x)>0n&&(u=`<span class="ml-2 text-[9px] text-red-400">(penalty: ${B(BigInt(x)).toFixed(2)} BKC)</span>`)}else if(n.includes("DELEGAT")||n.includes("STAKE")&&!n.includes("UNSTAKE")){o="fa-lock",r="#4ade80",l="rgba(34,197,94,0.15)",d="🔒 Delegated";const x=a.pStakeGenerated;x&&(u=`<span class="ml-2 text-[10px] text-purple-400 font-bold">+${B(BigInt(x)).toFixed(0)} pStake</span>`);const y=a.lockDuration;if(y){const k=Number(y)/86400;u+=`<span class="ml-1 text-[9px] text-zinc-500">(${ar(k)})</span>`}}else if(n.includes("UNSTAKE")||n.includes("UNDELEGAT")){o="fa-unlock",r="#fb923c",l="rgba(249,115,22,0.15)",d="🔓 Unstaked";const x=a.amountReceived;x&&BigInt(x)>0n&&(u=`<span class="ml-2 text-[9px] text-green-400">+${B(BigInt(x)).toFixed(2)} BKC</span>`)}else if(n.includes("CLAIM")||n.includes("REWARD")){o="fa-coins",r="#fbbf24",l="rgba(245,158,11,0.15)",d="🪙 Rewards Claimed";const x=a.amountReceived,y=a.feePaid;if(x&&BigInt(x)>0n&&(u=`<span class="ml-2 text-[9px] text-green-400">+${B(BigInt(x)).toFixed(2)} BKC</span>`),y&&BigInt(y)>0n){const k=B(BigInt(y)).toFixed(2);u+=`<span class="ml-1 text-[9px] text-zinc-500">(fee: ${k})</span>`}}else o="fa-circle",r="#71717a",l="rgba(39,39,42,0.5)",d=s.type||"Activity";const f=s.txHash?`${nr}${s.txHash}`:"#";let p=s.amount||a.amount||a.amountReceived||"0";const g=B(BigInt(p)),m=g>.001?g.toFixed(2):"";return`
        ...
        `)}let Me=null;function Ba(){const e=document.getElementById("delegations-list");if(!e)return;Me&&(clearInterval(Me),Me=null);const t=c.userDelegations||[],s=document.getElementById("delegation-count");if(s&&(s.textContent=`${t.length} active`),t.length===0){e.innerHTML=`
            <div class="text-center py-10">
                <img src="${mt}" class="w-14 h-14 mx-auto opacity-20 mb-3" onerror="this.outerHTML='<div class=\\'w-14 h-14 bg-zinc-800 rounded-full flex items-center justify-center mx-auto mb-3\\'><i class=\\'fa-solid fa-layer-group text-xl text-zinc-600\\'></i></div>'">
                <p class="text-zinc-500 text-sm mb-1">No active delegations</p>
                <p class="text-zinc-600 text-xs">Delegate BKC to start earning</p>
            </div>
        `;return}const n=[...t].sort((a,i)=>Number(a.unlockTime)-Number(i.unlockTime));e.innerHTML=n.map(a=>dr(a)).join(""),Sn(),Me=setInterval(Sn,6e4),e.querySelectorAll(".unstake-btn").forEach(a=>{a.addEventListener("click",()=>Pn(a.dataset.index,!1))}),e.querySelectorAll(".force-unstake-btn").forEach(a=>{a.addEventListener("click",()=>{confirm(`⚠️ Force Unstake will apply a 50% penalty!

Are you sure you want to continue?`)&&Pn(a.dataset.index,!0)})})}function Sn(){const e=document.querySelectorAll(".countdown-timer"),t=Math.floor(Date.now()/1e3);e.forEach(s=>{const a=parseInt(s.dataset.unlockTime)-t;s.textContent=Ta(a)})}function dr(e){const t=B(e.amount).toFixed(2),s=Re(za(e.amount,e.lockDuration)),n=Number(e.unlockTime),a=Math.floor(Date.now()/1e3),i=n>a,o=i?n-a:0;return`
    ...
    `}function ot(){var n;const e=document.getElementById("amount-input"),t=document.getElementById("stake-btn");if(!e)return;const s=e.value;if(!s||parseFloat(s)<=0){document.getElementById("preview-pstake").textContent="0",document.getElementById("preview-net").textContent="0.00 BKC",t&&(t.disabled=!0);return}try{const a=it.parseUnits(s,18),i=((n=c.systemFees)==null?void 0:n.DELEGATION_FEE_BIPS)||50n,o=a*BigInt(i)/10000n,r=a-o,l=BigInt(Zs)*86400n,d=za(r,l);document.getElementById("preview-pstake").textContent=Re(d),document.getElementById("preview-net").textContent=`${B(r).toFixed(4)} BKC`;const u=c.currentUserBalance||0n;a>u?(e.classList.add("border-red-500"),t&&(t.disabled=!0)):(e.classList.remove("border-red-500"),t&&(t.disabled=ge))}catch{t&&(t.disabled=!0)}}async function ur(){if(ge)return;const e=document.getElementById("amount-input"),t=document.getElementById("stake-btn"),s=document.getElementById("stake-btn-text"),n=document.getElementById("stake-btn-icon"),a=document.getElementById("stake-mascot");if(!e||!t)return;const i=e.value;if(!i||parseFloat(i)<=0){b("Enter an amount","warning");return}const o=c.currentUserBalance||0n;let r;try{if(r=it.parseUnits(i,18),r>o){b("Insufficient BKC balance","error");return}}catch{b("Invalid amount","error");return}try{const u=await new it.BrowserProvider(window.ethereum).getBalance(c.userAddress),f=it.parseEther("0.001");if(u<f){b("Insufficient ETH for gas. Need at least 0.001 ETH.","error");return}}catch(d){console.warn("ETH balance check failed:",d)}ge=!0;const l=BigInt(Zs)*86400n;t.disabled=!0,s.textContent="Processing...",n.className="fa-solid fa-spinner fa-spin",a&&(a.className="w-14 h-14 object-contain stake-rotate stake-glow");try{await yo(r,l,es,null)&&(e.value="",b("🔒 Delegation successful!","success"),a&&(a.className="w-14 h-14 object-contain stake-success",setTimeout(()=>{a.className="w-14 h-14 object-contain stake-pulse stake-float"},800)),qe=!1,bt=0,await Je(!0))}catch(d){console.error("Stake error:",d),b("Delegation failed: "+(d.reason||d.message||"Unknown error"),"error")}finally{ge=!1,t.disabled=!1,s.textContent="Delegate BKC",n.className="fa-solid fa-lock",a&&(a.className="w-14 h-14 object-contain stake-pulse stake-float"),ot()}}async function Pn(e,t){if(ge)return;const s=document.querySelector(t?`.force-unstake-btn[data-index='${e}']`:`.unstake-btn[data-index='${e}']`);s&&(s.disabled=!0,s.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>'),ge=!0;try{const n=BigInt(e),a=es||0n;console.log(`Attempting ${t?"force ":""}unstake:`,{delegationIndex:n.toString(),boosterId:a.toString()}),(t?await To(n,a):await ko(n,a))&&(b(t?"⚡ Force unstaked (50% penalty applied)":"🔓 Unstaked successfully!",t?"warning":"success"),qe=!1,bt=0,await Je(!0))}catch(n){console.error("Unstake error:",n),b("Unstake failed: "+(n.reason||n.message||"Unknown error"),"error")}finally{ge=!1,Ba()}}async function pr(e,t,s){if(ge)return;ge=!0;const n=s.textContent;s.disabled=!0,s.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await Qs(e,t,es,null)&&(b("🪙 Rewards claimed!","success"),qe=!1,bt=0,await Je(!0))}catch(a){console.error("Claim error:",a),b("Claim failed: "+(a.reason||a.message||"Unknown error"),"error")}finally{ge=!1,s.disabled=!1,s.textContent=n}}function fr(){const e=document.getElementById("amount-input"),t=document.getElementById("max-btn"),s=document.getElementById("stake-btn"),n=document.getElementById("refresh-btn"),a=document.querySelectorAll(".duration-chip"),i=document.querySelectorAll(".history-tab");e==null||e.addEventListener("input",ot),t==null||t.addEventListener("click",()=>{const o=c.currentUserBalance||0n;e&&(e.value=it.formatUnits(o,18),ot())}),a.forEach(o=>{o.addEventListener("click",()=>{a.forEach(r=>r.classList.remove("selected")),o.classList.add("selected"),Zs=parseInt(o.dataset.days),ot()})}),i.forEach(o=>{o.addEventListener("click",()=>{i.forEach(r=>{r.classList.remove("active"),r.classList.add("text-zinc-400")}),o.classList.add("active"),o.classList.remove("text-zinc-400"),at=o.dataset.filter,Ca()})}),s==null||s.addEventListener("click",ur),n==null||n.addEventListener("click",()=>{const o=n.querySelector("i");o==null||o.classList.add("fa-spin"),Je(!0).then(()=>{setTimeout(()=>o==null?void 0:o.classList.remove("fa-spin"),500)})})}function mr(){Me&&(clearInterval(Me),Me=null)}function br(e){e?Je():en()}const Ea={render:rr,update:br,cleanup:mr},Ae=window.ethers,gr="https://sepolia.arbiscan.io/tx/",Nn={Crystal:{color:"#a855f7",gradient:"from-purple-500/20 to-violet-600/20",border:"border-purple-500/40",text:"text-purple-400",glow:"shadow-purple-500/30",icon:"💎"},Diamond:{color:"#22d3ee",gradient:"from-cyan-500/20 to-blue-500/20",border:"border-cyan-500/40",text:"text-cyan-400",glow:"shadow-cyan-500/30",icon:"💠"},Platinum:{color:"#e2e8f0",gradient:"from-slate-300/20 to-gray-400/20",border:"border-slate-400/40",text:"text-slate-300",glow:"shadow-slate-400/30",icon:"⚪"},Gold:{color:"#fbbf24",gradient:"from-yellow-500/20 to-amber-500/20",border:"border-yellow-500/40",text:"text-yellow-400",glow:"shadow-yellow-500/30",icon:"🥇"},Silver:{color:"#9ca3af",gradient:"from-gray-400/20 to-slate-400/20",border:"border-gray-400/40",text:"text-gray-300",glow:"shadow-gray-400/30",icon:"🥈"},Bronze:{color:"#f97316",gradient:"from-orange-600/20 to-amber-700/20",border:"border-orange-600/40",text:"text-orange-400",glow:"shadow-orange-500/30",icon:"🥉"},Iron:{color:"#6b7280",gradient:"from-gray-500/20 to-zinc-600/20",border:"border-gray-500/40",text:"text-gray-400",glow:"shadow-gray-500/30",icon:"⚙️"}};function ts(e){return Nn[e]||Nn.Iron}const C={tradeDirection:"buy",selectedPoolBoostBips:null,buyPrice:0n,sellPrice:0n,netSellPrice:0n,poolNFTCount:0,userBalanceOfSelectedNFT:0,availableToSellCount:0,firstAvailableTokenId:null,firstAvailableTokenIdForBuy:null,bestBoosterTokenId:0n,bestBoosterBips:0,isDataLoading:!1,lastFetchTimestamp:0,tradeHistory:[]},Ia=new Map;let us=!1;const xr=["function getPoolAddress(uint256 boostBips) view returns (address)","function isPool(address) view returns (bool)"];function jt(e){return e?e.startsWith("https://")||e.startsWith("http://")?e:e.includes("ipfs.io/ipfs/")?`${K}${e.split("ipfs.io/ipfs/")[1]}`:e.startsWith("ipfs://")?`${K}${e.substring(7)}`:e:"./assets/bkc_logo_3d.png"}function vr(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function hr(){if(document.getElementById("swap-styles-v9"))return;const e=document.createElement("style");e.id="swap-styles-v9",e.textContent=`
    ...
    `}const yr={async render(e){hr(),await ta();const t=document.getElementById("store");t&&((t.innerHTML.trim()===""||e)&&(t.innerHTML=`
            ...
            `,Br()),C.selectedPoolBoostBips===null&&te.length>0&&(C.selectedPoolBoostBips=te[0].boostBips),await Ne(),await St())},async update(){C.selectedPoolBoostBips!==null&&!C.isDataLoading&&document.getElementById("store")&&!document.hidden&&await Ne()}};async function St(){const e=document.getElementById("history-list");if(!c.userAddress){e&&(e.innerHTML='<div class="text-center py-4 text-xs text-zinc-600">Connect wallet to view history</div>');return}try{const t=ce.getHistory||"https://gethistory-4wvdcuoouq-uc.a.run.app",s=await fetch(`${t}/${c.userAddress}`);if(!s.ok)throw new Error(`HTTP ${s.status}`);const n=await s.json();console.log("All history types:",[...new Set((n||[]).map(i=>i.type))]),C.tradeHistory=(n||[]).filter(i=>{const o=(i.type||"").toUpperCase();return o==="NFTBOUGHT"||o==="NFTSOLD"||o==="NFT_BOUGHT"||o==="NFT_SOLD"||o==="NFTPURCHASED"||o==="NFT_PURCHASED"||o.includes("NFTBOUGHT")||o.includes("NFTSOLD")||o.includes("NFTPURCHASED")}),console.log("NFT trade history:",C.tradeHistory.length,"items");const a=document.getElementById("history-count");a&&(a.textContent=C.tradeHistory.length),Mn()}catch(t){console.error("History load error:",t),C.tradeHistory=[],Mn()}}function Mn(){const e=document.getElementById("history-list");if(e){if(!c.isConnected){e.innerHTML='<div class="text-center py-4 text-xs text-zinc-600">Connect wallet to view history</div>';return}if(C.tradeHistory.length===0){e.innerHTML=`
            <div class="text-center py-6">
        ...
        `}).join("")}}function kr(){return te.map((e,t)=>{const s=ts(e.name);return`
    ...
    `}function Tr(e,t,s,n,a=!1){return c.isConnected?e?t?`
        ...
        `;return}const n=c.rentalListings||[],a=new Set(n.map(o=>{var r;return(r=o.tokenId)==null?void 0:r.toString()})),i=Math.floor(Date.now()/1e3);e.innerHTML=s.map(o=>{var k;const r=te.find(E=>E.boostBips===Number(o.boostBips)),l=ts(r==null?void 0:r.name),d=jt(o.image||(r==null?void 0:r.img)),u=C.firstAvailableTokenId&&BigInt(o.tokenId)===C.firstAvailableTokenId,f=(k=o.tokenId)==null?void 0:k.toString(),p=a.has(f),g=n.find(E=>{var L;return((L=E.tokenId)==null?void 0:L.toString())===f}),m=g&&g.rentalEndTime&&Number(g.rentalEndTime)>i,x=p||m;let y="";return m?y='<span class="absolute top-1 right-1 bg-blue-500 text-white text-[7px] px-1.5 py-0.5 rounded-full font-bold">🔑 RENTED</span>':p&&(y='<span class="absolute top-1 right-1 bg-green-500 text-white text-[7px] px-1.5 py-0.5 rounded-full font-bold">📋 LISTED</span>'),`
        ...
        `}).join("")}async function Ne(){var s,n;if(C.isDataLoading||C.selectedPoolBoostBips===null)return;const e=Date.now();if(e-C.lastFetchTimestamp<2e3)return;C.isDataLoading=!0,C.lastFetchTimestamp=e;const t=C.selectedPoolBoostBips;try{const a=await Ve();C.bestBoosterTokenId=a!=null&&a.tokenId?BigInt(a.tokenId):0n,C.bestBoosterBips=(a==null?void 0:a.boostBips)||0,await Promise.all([Qt(!0),ht()]);const i=c.rentalListings||[],o=new Set(i.map(S=>{var G;return(G=S.tokenId)==null?void 0:G.toString()})),r=Math.floor(Date.now()/1e3),d=(c.myBoosters||[]).filter(S=>Number(S.boostBips)===t),u=d.filter(S=>{var Ze;const G=(Ze=S.tokenId)==null?void 0:Ze.toString(),Q=i.find(as=>{var dn;return((dn=as.tokenId)==null?void 0:dn.toString())===G}),Y=o.has(G),Ie=Q&&Q.rentalEndTime&&Number(Q.rentalEndTime)>r;return!Y&&!Ie});C.userBalanceOfSelectedNFT=d.length,C.availableToSellCount=u.length;const f=C.firstAvailableTokenId;f&&u.some(S=>BigInt(S.tokenId)===f)||(C.firstAvailableTokenId=u.length>0?BigInt(u[0].tokenId):null);const g=te.find(S=>S.boostBips===t);if(!g){console.warn("Tier not found for boostBips:",t);return}const m=`pool_${g.name.toLowerCase()}`;let x=v[m];if(!x){const S=v.nftLiquidityPoolFactory;if(S&&c.publicProvider)try{x=await new Ae.Contract(S,xr,c.publicProvider).getPoolAddress(t),x&&x!==Ae.ZeroAddress&&Ia.set(t,x)}catch(G){console.warn("Factory lookup failed:",G.message)}}if(!x||x===Ae.ZeroAddress){const S=document.getElementById("swap-interface");S&&(S.innerHTML=`
                ...
                `);return}const y=new Ae.Contract(x,Us,c.publicProvider);let k=Ae.MaxUint256,E=0n,L=[],A=((s=c.systemFees)==null?void 0:s.NFT_POOL_SELL_TAX_BIPS)||1000n,$=BigInt(((n=c.boosterDiscounts)==null?void 0:n[C.bestBoosterBips])||0);try{k=await O(y,"getBuyPrice",[],Ae.MaxUint256)}catch(S){console.warn("getBuyPrice failed:",S.message)}try{E=await O(y,"getSellPrice",[],0n)}catch(S){console.warn("getSellPrice failed:",S.message)}try{const S=await y.getAvailableNFTs();L=Array.isArray(S)?[...S]:[]}catch(S){console.warn("getAvailableNFTs failed:",S.message),L=[]}C.poolNFTCount=L.length,C.firstAvailableTokenIdForBuy=L.length>0?BigInt(L[L.length-1]):null,C.buyPrice=k===Ae.MaxUint256?0n:k,C.sellPrice=E;const T=typeof A=="bigint"?A:BigInt(A),M=typeof $=="bigint"?$:BigInt($),W=T>M?T-M:0n,se=E*W/10000n;C.netSellPrice=E-se}catch(a){console.warn("Store Data Warning:",a.message);const i=document.getElementById("swap-interface");i&&(i.innerHTML=`
                <div class="text-center py-12">
                    <div class="w-12 h-12 bg-zinc-800 rounded-full flex items-center justify-center mx-auto mb-3">
            ...
            `);return}finally{C.isDataLoading=!1,$a(),Cr()}}function Br(){const e=document.getElementById("store");e&&e.addEventListener("click",async t=>{if(t.target.closest("#refresh-btn")){const o=t.target.closest("#refresh-btn").querySelector("i");o.classList.add("fa-spin"),await Ne(),St(),o.classList.remove("fa-spin");return}const s=t.target.closest(".tier-chip");if(s){const i=Number(s.dataset.boost);C.selectedPoolBoostBips!==i&&(C.selectedPoolBoostBips=i,Fn(i),await Ne());return}if(t.target.closest("#swap-direction-btn")){C.tradeDirection=C.tradeDirection==="buy"?"sell":"buy",$a();return}if(t.target.closest("#inventory-toggle")){const i=document.getElementById("inventory-panel"),o=document.getElementById("inventory-chevron");i&&o&&(i.classList.toggle("hidden"),o.style.transform=i.classList.contains("hidden")?"":"rotate(180deg)");return}if(t.target.closest("#history-toggle")){const i=document.getElementById("history-panel"),o=document.getElementById("history-chevron");i&&o&&(i.classList.toggle("hidden"),o.style.transform=i.classList.contains("hidden")?"":"rotate(180deg)");return}const n=t.target.closest(".inventory-item");if(n){if(n.dataset.unavailable==="true"){b("This NFT is listed for rental and cannot be sold","warning");return}const o=Number(n.dataset.boost),r=n.dataset.tokenid;C.selectedPoolBoostBips=o,C.tradeDirection="sell",r&&(C.firstAvailableTokenId=BigInt(r),console.log("User selected NFT #"+r+" for sale")),Fn(o),await Ne();return}const a=t.target.closest("#execute-btn");if(a){if(t.preventDefault(),t.stopPropagation(),us||a.disabled)return;const i=a.dataset.action,o=document.getElementById("trade-mascot");if(i==="connect"){window.openConnectModal();return}const r=te.find(f=>f.boostBips===C.selectedPoolBoostBips);if(!r)return;const l=`pool_${r.name.toLowerCase()}`,d=v[l]||Ia.get(r.boostBips);if(!d){b("Pool address not found","error");return}us=!0,a.disabled=!0;const u=a.innerHTML;a.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i> Processing...',o&&(o.className="w-14 h-14 object-contain trade-spin");try{C.tradeDirection==="buy"?await zo(d,C.buyPrice,a)&&(o&&(o.className="w-14 h-14 object-contain trade-success"),b("🟢 NFT Purchased!","success"),await Ne(),St()):await Co(d,C.firstAvailableTokenId,a)&&(o&&(o.className="w-14 h-14 object-contain trade-success"),b("🔴 NFT Sold!","success"),await Ne(),St())}finally{us=!1,a.disabled=!1,a.innerHTML=u,o&&setTimeout(()=>{const f=C.tradeDirection==="buy";o.className=`w-14 h-14 object-contain ${f?"trade-buy":"trade-sell"}`},800)}}})}const ps=window.ethers,Aa="./assets/reward.png",Er="https://sepolia.arbiscan.io/tx/";let Ss=0,fs=!1,Pt=!1,Ke=[],Nt={stakingRewards:0n,minerRewards:0n,boosterTokenId:0n};window.handleRewardsClaim=async function(){Pt||await Nr(Nt.stakingRewards,Nt.minerRewards,Nt.boosterTokenId)};function Ir(){if(document.getElementById("reward-styles-v10"))return;const e=document.createElement("style");e.id="reward-styles-v10",e.textContent=`
    ...
    `,document.head.appendChild(e)}const tn={async render(e){Ir();const t=document.getElementById("rewards");t&&((t.innerHTML.trim()===""||e)&&(t.innerHTML=Sr()),c.isConnected?(Pr(),this.update(e)):Dn())},async update(e=!1){if(!c.isConnected){Dn();return}const t=Date.now();if(!(!e&&fs)&&!(!e&&t-Ss<6e4)){fs=!0,rt("loading");try{let s={highestBoost:0,boostName:"None",tokenId:null,source:"none"},n={netClaimAmount:0n,feeAmount:0n,totalRewards:0n},a={stakingRewards:0n,minerRewards:0n};try{await X()}catch{}try{s=await Ve()||s}catch{}try{n=await na()||n}catch{}try{a=await Jt()||a}catch{}try{await $r()}catch{}La(n,a,s),Ss=t,rt("idle")}catch(s){console.error("Rewards Error:",s)}finally{fs=!1}}}};function rt(e){const t=document.getElementById("reward-mascot");if(t)switch(t.className="w-12 h-12 object-contain",e){case"loading":t.classList.add("reward-spin");break;case"claiming":t.classList.add("reward-bounce");break;case"success":t.classList.add("reward-success");break;default:t.classList.add("reward-float","reward-pulse")}}async function $r(){if(c.userAddress)try{const e=await fetch(`${ce.getHistory}/${c.userAddress}`);e.ok&&(Ke=(await e.json()).filter(s=>{const n=(s.type||"").toUpperCase();return n.includes("REWARD")||n.includes("CLAIM")}).slice(0,15))}catch{Ke=[]}}function Ar(){return Ke.length===0?`
            <div class="text-center py-6">
                <div class="w-12 h-12 mx-auto rounded-full bg-zinc-800/50 flex items-center justify-center mb-2">
    ...
    `}function Dn(){const e=document.getElementById("rewards-content");e&&(e.innerHTML=`
        <div class="flex flex-col items-center justify-center py-12 bg-zinc-900/50 border border-zinc-800 rounded-2xl">
            <img src="${Aa}" class="w-16 h-16 opacity-30 mb-4" onerror="this.style.display='none'">
    ...
    `)}function Pr(){La({netClaimAmount:0n,feeAmount:0n,totalRewards:0n},{stakingRewards:0n,minerRewards:0n},{highestBoost:0,boostName:"None",tokenId:null,source:"none"})}function La(e,t,s){const n=document.getElementById("rewards-content");if(!n)return;const a=e||{},i=t||{},o=s||{},r=a.netClaimAmount||0n,l=a.totalRewards||0n,d=a.feeAmount||0n,u=i.stakingRewards||0n,f=i.minerRewards||0n,p=o.highestBoost||0,g=a.baseFeeBips||5e3,m=p/100,y=100-(a.finalFeeBips||g-g*p/1e4)/100,k=r>0n,E=p>0,L=BigInt(o.tokenId||0);Nt={stakingRewards:u,minerRewards:f,boosterTokenId:L};let A=0,$=0,T=0,M=0,W=0;try{A=B?B(r):Number(r)/1e18,$=B?B(l):Number(l)/1e18,T=B?B(d):Number(d)/1e18,M=B?B(u):Number(u)/1e18,W=B?B(f):Number(f)/1e18}catch{}const se=2*Math.PI*45,S=se-y/100*se;n.innerHTML=`
        <div class="space-y-4">
            <!-- MAIN CLAIM CARD -->
                ...
                <div class="flex flex-col items-center mb-5">
                    <div class="relative w-32 h-32 mb-3">
                        <svg class="w-full h-full" style="transform: rotate(-90deg)" viewBox="0 0 100 100">
                            ...
                            <circle cx="50" cy="50" r="45" fill="none" stroke="${E?"#4ade80":"#f59e0b"}" stroke-width="6" stroke-linecap="round" stroke-dasharray="${se}" stroke-dashoffset="${S}"/>
                        </svg>
            ...
            <div class="bg-zinc-900/50 border border-zinc-800 rounded-xl p-4">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center justify-between p-2.5 bg-zinc-800/30 rounded-lg">
                        ...
                        <span class="text-sm font-mono font-bold text-white">${W.toFixed(2)} <span class="text-zinc-500 text-xs">BKC</span></span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-zinc-900/50 border border-zinc-800 rounded-xl overflow-hidden">
                <div class="p-3 border-b border-zinc-800/50 flex items-center justify-between">
                    ...
                    <span class="text-[10px] text-zinc-600">${Ke.length} claims</span>
                </div>
    ...
    `}async function Nr(e,t,s){if(Pt)return;const n=document.getElementById("claim-btn"),a=document.getElementById("claim-btn-text"),i=document.getElementById("claim-btn-icon");if(n){Pt=!0,n.disabled=!0,n.className="w-full py-4 rounded-xl font-bold text-base flex items-center justify-center gap-2 bg-zinc-700 text-zinc-400",a.textContent="Processing...",i.className="fa-solid fa-spinner fa-spin",rt("claiming");try{await Qs(e,t,s,null)&&(rt("success"),n.className="w-full py-4 rounded-xl font-bold text-base flex items-center justify-center gap-2 bg-green-500 text-white",a.textContent="🎉 Claimed!",i.className="fa-solid fa-check",b("🎁 Rewards claimed successfully!","success"),setTimeout(()=>{Ss=0,Ke=[],tn.update(!0)},2500))}catch(o){console.error("Claim error:",o),b("Claim failed: "+(o.reason||o.message||"Error"),"error"),n.disabled=!1,n.className="w-full py-4 rounded-xl font-bold text-base flex items-center justify-center gap-2 bg-gradient-to-r from-amber-500 to-orange-500 text-black shadow-lg shadow-amber-500/25",a.textContent="Claim Rewards",i.className="fa-solid fa-coins",rt("idle")}finally{Pt=!1}}}window.RewardsPage=tn;const Sa="https://sepolia.arbiscan.io/tx/",Ps="https://sepolia.arbiscan.io/address/",Pa="0x16346f5a45f9615f1c894414989f0891c54ef07b",Mr="0x8093a960b9615330DdbD1B59b1Fc7eB6B6AB1526",Ht="./assets/fortune.png",Ns=1e3,jn={pt:{title:"Compartilhe & Ganhe!",subtitle:"+1000 pontos para o Airdrop",later:"Talvez depois"},en:{title:"Share & Earn!",subtitle:"+1000 points for Airdrop",later:"Maybe later"},es:{title:"¡Comparte y Gana!",subtitle:"+1000 puntos para el Airdrop",later:"Quizás después"}},Fr={pt:{win:e=>`🎉 Ganhei ${e.toLocaleString()} BKC no Fortune Pool!
...
#Backcoin #Web3 #Arbitrum`}},ms={pt:"./assets/pt.png",en:"./assets/en.png",es:"./assets/es.png"};let he="en";const Z=[{id:1,name:"Easy",emoji:"🍀",range:3,multiplier:2,chance:"33%",color:"emerald",hex:"#10b981",bgFrom:"from-emerald-500/20",bgTo:"to-green-600/10",borderColor:"border-emerald-500/50",textColor:"text-emerald-400"},{id:2,name:"Medium",emoji:"⚡",range:10,multiplier:5,chance:"10%",color:"violet",hex:"#8b5cf6",bgFrom:"from-violet-500/20",bgTo:"to-purple-600/10",borderColor:"border-violet-500/50",textColor:"text-violet-400"},{id:3,name:"Hard",emoji:"👑",range:100,multiplier:50,chance:"1%",color:"amber",hex:"#f59e0b",bgFrom:"from-amber-500/20",bgTo:"to-orange-600/10",borderColor:"border-amber-500/50",textColor:"text-amber-400"}],Na=57,h={mode:null,phase:"select",guess:50,guesses:[2,5,50],comboStep:0,wager:10,gameId:null,result:null,txHash:null,poolStatus:null,history:[],serviceFee:0n,serviceFee1x:0n,serviceFee5x:0n,tiersData:null};function Rr(){if(document.getElementById("fortune-styles-v2"))return;const e=document.createElement("style");e.id="fortune-styles-v2",e.textContent=`
        ...
        <div class="max-w-md mx-auto px-4 py-6">
            ...
            <div class="text-center mb-6">
                ...
                <div class="flex items-center justify-center gap-2 mt-3 flex-wrap">
                    <a href="${Ps}${Pa}" target="_blank" rel="noopener" 
    ...
    `,sn(),V()}function jr(){}function V(){const e=document.getElementById("game-area");if(e)switch(Hr(h.phase),h.phase){case"select":Hn(e);break;case"pick":_r(e);break;case"wager":Wr(e);break;case"processing":Yr(e);break;case"result":Kr(e);break;default:Hn(e)}}function Hr(e){var s;const t=document.getElementById("tiger-mascot");if(t)switch(t.className="w-28 h-28 object-contain mx-auto",t.style.filter="",e){case"select":t.classList.add("tiger-float","tiger-pulse");break;case"pick":case"wager":t.classList.add("tiger-float");break;case"processing":t.classList.add("tiger-spin");break;case"result":((s=h.result)==null?void 0:s.prizeWon)>0?t.classList.add("tiger-celebrate"):(t.style.filter="grayscale(0.5)",t.classList.add("tiger-float"));break}}function Hn(e){var a,i;const t=h.serviceFee1x>0n?(Number(h.serviceFee1x)/1e18).toFixed(6):"0",s=h.serviceFee5x>0n?(Number(h.serviceFee5x)/1e18).toFixed(6):"0",n=h.serviceFee1x>0n||h.serviceFee5x>0n;e.innerHTML=`
        <div class="space-y-4">
            <!-- JACKPOT MODE -->
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center gap-3 mb-1">
                            ...
                            <span class="px-2.5 py-1 rounded-full bg-violet-500/20 border border-violet-500/40 text-violet-400 text-sm font-black">${Na}x</span>
                        </div>
    ...
    `,(a=document.getElementById("btn-jackpot"))==null||a.addEventListener("click",()=>{if(!c.isConnected)return b("Connect wallet first","warning");h.mode="jackpot",h.guess=50,h.phase="pick",V()}),(i=document.getElementById("btn-combo"))==null||i.addEventListener("click",()=>{if(!c.isConnected)return b("Connect wallet first","warning");h.mode="combo",h.guesses=[2,5,50],h.comboStep=0,h.phase="pick",V()})}function _r(e){h.mode==="jackpot"?Ur(e):Or(e)}function Ur(e){var r,l,d,u,f,p,g;const t=Z[2],s=h.guess;e.innerHTML=`
    ...
    `,n.forEach((a,i)=>{const o=document.getElementById(`spin-${i}`);if(!o)return;setInterval(()=>{o.textContent=Math.floor(Math.random()*a.range)+1},80)})}function Kr(e){var u,f;const t=h.result;if(!t)return V();const s=h.mode==="jackpot",n=s?[h.guess]:h.guesses,a=t.rolls||[],i=s?[Z[2]]:Z,o=n.map((p,g)=>{const m=a[g]!==void 0?Number(a[g]):null;return m!==null&&m===p}),r=o.filter(p=>p).length,l=t.prizeWon>0||r>0;let d=t.prizeWon;!d&&r>0&&(d=0,o.forEach((p,g)=>{if(p){const m=s?Z[2]:Z[g];d+=h.wager*m.multiplier}})),e.innerHTML=`
        <div class="bg-gradient-to-br ${l?"from-emerald-900/30 to-green-900/10 border-emerald-500/30":"from-zinc-900 to-zinc-800/50 border-zinc-700/50"} border rounded-2xl p-4 sm:p-6 relative overflow-hidden" id="result-container">
            ...
            <div class="grid ${s?"grid-cols-1 max-w-[200px] mx-auto":"grid-cols-3"} gap-2 sm:gap-3 mb-4">
                ${i.map((p,g)=>{const m=s?n[0]:n[g],x=a[g],y=o[g];return`
                        <div class="text-center p-2 sm:p-3 rounded-xl ${y?"bg-emerald-500/20 border border-emerald-500/50":"bg-zinc-800/50 border border-zinc-700/50"}">
                            ...
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <span class="text-xl ${y?"text-emerald-400":"text-red-400"}">${y?"=":"≠"}</span>
                                <div class="text-center">
                                    <p class="text-[8px] text-zinc-600 mb-0.5">ROLL</p>
                                    <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-lg ${y?"bg-emerald-500/30 border-emerald-500":"bg-zinc-700/50 border-zinc-600"} border flex items-center justify-center">
                                        <span class="text-lg sm:text-xl font-black ${y?"text-emerald-400":"text-zinc-300"}">${x!==void 0?x:"?"}</span>
                                    </div>
                                </div>
                            </div>
                            ${y?`<p class="text-emerald-400 text-xs font-bold mt-1">+${p.multiplier}x</p>`:""}
                        </div>
                    `}).join("")}
            </div>
            ...
            ${h.txHash?`
                <div class="text-center mb-3">
                    <a href="${Sa}${h.txHash}" target="_blank" class="inline-flex items-center gap-2 text-xs text-zinc-500 hover:text-zinc-400">
                        <i class="fa-solid fa-external-link"></i>
                        View Transaction
                    </a>
                </div>
    ...
    `,l&&(Gr(),d>h.wager*10&&Vr()),(u=document.getElementById("btn-new-game"))==null||u.addEventListener("click",()=>{h.phase="select",h.result=null,h.txHash=null,h.gameId=null,V(),sn()}),(f=document.getElementById("btn-share"))==null||f.addEventListener("click",()=>{Xr(l,d)})}function Gr(){const e=document.createElement("div");e.className="confetti-container",document.body.appendChild(e);const t=["#f59e0b","#10b981","#8b5cf6","#ec4899","#06b6d4"],s=["●","■","★","🐯","🎉"];for(let n=0;n<60;n++){const a=document.createElement("div");a.className="confetti",a.style.cssText=`
            left: ${Math.random()*100}%;
            color: ${t[n%t.length]};
            font-size: ${8+Math.random()*12}px;
            animation-delay: ${Math.random()*2}s;
            animation-duration: ${2+Math.random()*2}s;
        `,a.textContent=s[n%s.length],e.appendChild(a)}setTimeout(()=>e.remove(),5e3)}function Vr(){const e=["🪙","💰","✨","⭐","🎉"];for(let t=0;t<30;t++)setTimeout(()=>{const s=document.createElement("div");s.className="coin",s.textContent=e[Math.floor(Math.random()*e.length)],s.style.left=`${Math.random()*100}%`,s.style.animationDelay=`${Math.random()*.5}s`,s.style.animationDuration=`${2+Math.random()*2}s`,document.body.appendChild(s),setTimeout(()=>s.remove(),4e3)},t*100)}function Xr(e,t){var l,d,u,f,p,g;const s=jn[he],n=()=>{const m=Fr[he];return e?m.win(t):m.lose},a=`
        <div class="text-center">
    ...
    `;ut(a,"max-w-xs");const i=m=>{he=m;const x=jn[m],y=document.getElementById("share-modal-title"),k=document.getElementById("share-modal-subtitle"),E=document.getElementById("btn-close-share");y&&(y.textContent=x.title),k&&(k.textContent=x.subtitle),E&&(E.textContent=x.later),document.querySelectorAll(".lang-btn").forEach(L=>{const A=L.dataset.lang,$=L.querySelector("span");A===m?(L.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-amber-500/20 border-amber-500 ring-1 ring-amber-500/50 border",$&&($.className="text-amber-400")):(L.className="lang-btn flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all bg-zinc-800 border-zinc-700 hover:border-zinc-500 border",$&&($.className="text-zinc-400"))})};document.querySelectorAll(".lang-btn").forEach(m=>{m.addEventListener("click",()=>i(m.dataset.lang))});const o=async m=>{if(!c.userAddress)return!1;try{const y=await(await fetch("https://us-central1-backchain-backand.cloudfunctions.net/trackShare",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({address:c.userAddress,gameId:h.gameId||Date.now(),type:"fortune",platform:m})})).json();return y.success?(b(`🎉 +${y.pointsAwarded||Ns} Airdrop Points!`,"success"),!0):(y.reason==="already_shared"&&console.log("Already shared this game"),!1)}catch(x){return console.error("Share tracking error:",x),b(`🎉 +${Ns} Airdrop Points!`,"success"),!0}},r=async(m,x)=>{await o(m),window.open(x,"_blank"),ae()};(l=document.getElementById("share-twitter"))==null||l.addEventListener("click",()=>{const m=n();r("twitter",`https://twitter.com/intent/tweet?text=${encodeURIComponent(m)}`)}),(d=document.getElementById("share-telegram"))==null||d.addEventListener("click",()=>{const m=n();r("telegram",`https://t.me/share/url?url=https://backcoin.org&text=${encodeURIComponent(m)}`)}),(u=document.getElementById("share-whatsapp"))==null||u.addEventListener("click",()=>{const m=n();r("whatsapp",`https://wa.me/?text=${encodeURIComponent(m)}`)}),(f=document.getElementById("share-instagram"))==null||f.addEventListener("click",async()=>{const m=n();try{await navigator.clipboard.writeText(m),await o("instagram");const x=`
            ...
            `;ae(),setTimeout(()=>{var y,k;ut(x,"max-w-xs"),(y=document.getElementById("btn-open-instagram"))==null||y.addEventListener("click",()=>{window.open("https://www.instagram.com/backcoin.bkc/","_blank"),ae()}),(k=document.getElementById("btn-close-ig-modal"))==null||k.addEventListener("click",ae)},100)}catch{b("Could not copy text","error"),ae()}}),(p=document.getElementById("share-copy"))==null||p.addEventListener("click",async()=>{const m=n();try{await navigator.clipboard.writeText(m),b("📋 Copied!","success"),await o("copy")}catch{b("Copy failed","error")}ae()}),(g=document.getElementById("btn-close-share"))==null||g.addEventListener("click",ae)}async function Jr(){const e=c.fortunePoolContract||c.fortunePoolContractPublic;if(!e)return console.log("No fortune contract available"),null;try{const[t,s,n,a,i,o]=await Promise.all([e.prizePoolBalance().catch(()=>0n),e.gameCounter().catch(()=>0),e.serviceFee().catch(()=>0n),e.getRequiredServiceFee(!1).catch(()=>0n),e.getRequiredServiceFee(!0).catch(()=>0n),e.activeTierCount().catch(()=>3)]);h.serviceFee=n||0n,h.serviceFee1x=a||0n,h.serviceFee5x=i||0n;try{const[r,l]=await e.getAllTiers();h.tiersData=r.map((d,u)=>({range:Number(d),multiplier:Number(l[u])/1e4})),console.log("Tiers from contract:",h.tiersData)}catch{console.log("Using default tiers")}return{prizePool:t||0n,gameCounter:Number(s)||0,serviceFee:n||0n,serviceFee1x:a||0n,serviceFee5x:i||0n,tierCount:Number(o)||3}}catch(t){return console.error("getFortunePoolStatus error:",t),{prizePool:0n,gameCounter:0,serviceFee:0n}}}async function sn(){try{const e=await Jr();if(e){const s=document.getElementById("prize-pool"),n=document.getElementById("total-games");s&&(s.textContent=B(e.prizePool||0n).toFixed(2)+" BKC"),n&&(n.textContent=(e.gameCounter||0).toLocaleString())}const t=document.getElementById("user-balance");t&&(t.textContent=B(c.currentUserBalance||0n).toFixed(2)+" BKC"),Qr()}catch(e){console.error("Pool error:",e)}}async function Qr(){var e;try{const t=ce.fortuneGames||"https://getfortunegames-4wvdcuoouq-uc.a.run.app",s=c.userAddress?`${t}?player=${c.userAddress}&limit=15`:`${t}?limit=15`,a=await(await fetch(s)).json();if(((e=a.games)==null?void 0:e.length)>0){Zr(a.games);const i=a.games.filter(r=>r.isWin||r.prizeWon&&BigInt(r.prizeWon)>0n).length,o=document.getElementById("win-rate");o&&(o.textContent=`🏆 ${i}/${a.games.length} wins`)}else{const i=document.getElementById("history-list");i&&(i.innerHTML=`
            ...
            <a href="${g||"#"}" target="${g?"_blank":"_self"}" rel="noopener" 
               ...
               ${g?"":'onclick="return false;"'}>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex gap-1">
                        ${(o?Z:[Z[2]]).map((x,y)=>{const k=l[y],E=r[y];return`
    ...
    `,document.head.appendChild(e)}async function Qe(){var e;z.isConnected=c.isConnected,z.user=null,z.userSubmissions=[],z.platformUsage={},z.isBanned=!1;try{const t=await Vs();if(z.systemConfig=t.config,z.leaderboards=t.leaderboards,z.dailyTasks=t.dailyTasks||[],z.platformUsageConfig=t.platformUsageConfig||Fa,z.isConnected&&c.userAddress){const[s,n]=await Promise.all([nt(c.userAddress),ji()]);if(z.user=s,z.userSubmissions=n,s&&s.isBanned){z.isBanned=!0;return}try{typeof kn=="function"&&(z.platformUsage=await kn()||{})}catch(a){console.warn("Could not load platform usage:",a),z.platformUsage={}}z.dailyTasks.length>0&&(z.dailyTasks=await Promise.all(z.dailyTasks.map(async a=>{try{if(!a.id)return{...a,eligible:!1,timeLeftMs:0};const i=await oa(a.id,a.cooldownHours);return{...a,eligible:i.eligible,timeLeftMs:i.timeLeft}}catch{return{...a,eligible:!1,timeLeftMs:0}}})))}}catch(t){if(console.error("Airdrop Data Load Error:",t),t.code==="permission-denied"||(e=t.message)!=null&&e.includes("permission")){console.warn("Firebase permissions issue - user may need to connect wallet or sign in"),z.systemConfig=z.systemConfig||{},z.leaderboards=z.leaderboards||{top100ByPoints:[],top100ByPosts:[]},z.dailyTasks=z.dailyTasks||[];return}b("Error loading data. Please refresh.","error")}}function Ra(){const{user:e}=z,t=(e==null?void 0:e.totalPoints)||0,s=(e==null?void 0:e.platformUsagePoints)||0,n=(e==null?void 0:e.approvedSubmissionsCount)||0,a=gl(n);return`
        <!-- Mobile Header -->
    ...
    `}function hl(){var o;const e=z.platformUsageConfig||Fa,t=z.platformUsage||{};let s=0,n=0;Object.keys(e).forEach(r=>{var l;e[r].enabled!==!1&&e[r].maxCount&&(s+=e[r].maxCount,n+=Math.min(((l=t[r])==null?void 0:l.count)||0,e[r].maxCount))});const a=s>0?n/s*100:0,i=((o=z.user)==null?void 0:o.platformUsagePoints)||0;return`
        <div class="space-y-4">
            <!-- Info Banner -->
    ...
    `}function yl(){const{user:e,userSubmissions:t}=z;if(!z.isConnected)return`
        ...
        `;const s=Date.now(),n=Ma*60*60*1e3,a=t.filter(l=>["pending","auditing"].includes(l.status)&&l.submittedAt&&s-l.submittedAt.getTime()>=n),i=(e==null?void 0:e.approvedSubmissionsCount)||0,o=t.filter(l=>["pending","auditing"].includes(l.status)).length,r=t.filter(l=>l.status==="rejected").length;return`
    ...
    `}function kl(){var u,f;const e=((u=z.leaderboards)==null?void 0:u.top100ByPosts)||[],t=((f=z.leaderboards)==null?void 0:f.top100ByPoints)||[],s=z.activeRanking||"posts";function n(p,g,m){var $,T;const x=z.user&&(($=p.walletAddress)==null?void 0:$.toLowerCase())===((T=z.user.walletAddress)==null?void 0:T.toLowerCase()),y=Tl(g+1),k=m==="posts"?"bg-amber-500/10":"bg-green-500/10",E=m==="posts"?"text-amber-400":"text-green-400",L=m==="posts"?"text-white":"text-green-400",A=m==="posts"?"posts":"pts";return`
    ...
    `}function Tl(e){return e<=2?{icon:"💎",bg:"bg-cyan-500/20 text-cyan-300"}:e<=10?{icon:"🏆",bg:"bg-slate-400/20 text-slate-300"}:e<=20?{icon:"🥇",bg:"bg-yellow-500/20 text-yellow-400"}:e<=50?{icon:"🥈",bg:"bg-gray-400/20 text-gray-300"}:e<=150?{icon:"🥉",bg:"bg-amber-700/20 text-amber-600"}:e<=300?{icon:"⚔️",bg:"bg-zinc-600/20 text-zinc-400"}:{icon:null,bg:"bg-zinc-800 text-zinc-400"}}function me(){const e=document.getElementById("main-content"),t=document.getElementById("airdrop-header");if(e){if(t&&(t.innerHTML=Ra()),z.isBanned){e.innerHTML=`
    ...
    `;ut(t,"max-w-md"),(a=document.getElementById("deletePostBtn"))==null||a.addEventListener("click",async i=>{const o=i.currentTarget,r=o.dataset.submissionId;o.disabled=!0,o.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-1"></i> Deleting...';try{await ra(r),b("Post deleted. No penalty applied.","info"),ae(),await Qe(),me()}catch(l){b(l.message,"error"),o.disabled=!1,o.innerHTML='<i class="fa-solid fa-trash mr-1"></i> Delete Post'}});const s=document.getElementById("confirmCheckbox"),n=document.getElementById("finalConfirmBtn");s==null||s.addEventListener("change",()=>{s.checked?(n.disabled=!1,n.className="flex-1 bg-green-600 hover:bg-green-500 text-white py-3 rounded-xl font-bold text-sm transition-colors cursor-pointer",n.innerHTML='<i class="fa-solid fa-check mr-1"></i> Confirm & Earn ✓'):(n.disabled=!0,n.className="flex-1 bg-green-600/50 text-green-200 py-3 rounded-xl font-bold text-sm cursor-not-allowed transition-colors",n.innerHTML='<i class="fa-solid fa-lock mr-1"></i> Confirm & Earn')}),n==null||n.addEventListener("click",Il)}async function Il(e){const t=e.currentTarget,s=t.dataset.submissionId;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-circle-notch fa-spin mr-2"></i> Verifying...';try{await Hi(s),b("Success! Points added.","success"),ae(),await Qe(),me()}catch{b("Verification failed.","error"),t.disabled=!1,t.innerHTML="Try Again"}}async function $l(e){const t=e.target.closest(".action-btn");if(!t)return;const s=t.dataset.action,n=t.dataset.id;if(s==="confirm"){const a=z.userSubmissions.find(i=>i.submissionId===n);a&&Da(a)}else if(s==="delete"){if(!confirm("Remove this submission?"))return;try{await ra(n),b("Removed.","info"),await Qe(),me()}catch(a){b(a.message,"error")}}}async function Al(e){const t=e.target.closest("#submit-content-btn");if(!t)return;const s=document.getElementById("content-url-input"),n=s==null?void 0:s.value.trim();if(!n||!n.startsWith("http"))return b("Enter a valid URL.","warning");const a=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-circle-notch fa-spin"></i>';try{await Di(n),b("📋 Submitted! Your post is now under security audit.","info"),s.value="",await Qe(),z.activeTab="history",me()}catch(i){b(i.message,"error")}finally{t.disabled=!1,t.innerHTML=a}}async function Ll(e){const t=e.target.closest(".task-card");if(!t)return;const s=t.dataset.id,n=t.dataset.url;n&&window.open(n,"_blank");const a=z.dailyTasks.find(i=>i.id===s);if(!(!a||!a.eligible))try{await Fi(a,z.user.pointsMultiplier),b(`Task completed! +${a.points} pts`,"success"),await Qe(),me()}catch(i){i.message.includes("Cooldown")||b(i.message,"error")}}function Sl(){const e=Date.now(),t=Ma*60*60*1e3,s=z.userSubmissions.filter(n=>["pending","auditing"].includes(n.status)&&n.submittedAt&&e-n.submittedAt.getTime()>=t);s.length>0&&(z.activeTab="history",me(),setTimeout(()=>{Da(s[0])},500))}const Pl={async render(e){const t=document.getElementById("airdrop");if(!t)return;xl();const s=bl();(t.innerHTML.trim()===""||e)&&(t.innerHTML=`
...
(This will reset their rejection count to 0)`;if(!window.confirm(a))return;const i=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await ca(s,n),b(`User ${n?"BANNED":"UNBANNED"}.`,"success");const o=w.allUsers.findIndex(r=>r.id===s);o>-1&&(w.allUsers[o].isBanned=n,w.allUsers[o].hasPendingAppeal=!1,n===!1&&(w.allUsers[o].rejectedCount=0)),Be()}catch(o){b(`Failed: ${o.message}`,"error"),t.disabled=!1,t.innerHTML=i}},_l=async e=>{const t=e.target.closest(".resolve-appeal-btn");if(!t||t.disabled)return;const s=t.dataset.userId,a=t.dataset.action==="approve";if(!s)return;const i=a?"Are you sure you want to APPROVE this appeal and UNBAN the user?":"Are you sure you want to DENY this appeal? The user will remain banned.";if(!window.confirm(i))return;const o=t.closest("td").querySelectorAll("button"),r=new Map;o.forEach(l=>{r.set(l,l.innerHTML),l.disabled=!0,l.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>'});try{a&&await ca(s,!1),b(`Appeal ${a?"APPROVED":"DENIED"}.`,"success");const l=w.allUsers.findIndex(d=>d.id===s);l>-1&&(w.allUsers[l].hasPendingAppeal=!1,a&&(w.allUsers[l].isBanned=!1,w.allUsers[l].rejectedCount=0)),Be()}catch(l){b(`Failed: ${l.message}`,"error"),o.forEach(d=>{d.disabled=!1,d.innerHTML=r.get(d)})}},Ul=async e=>{const t=e.target.closest(".re-approve-btn");if(!t||t.disabled)return;const s=t.dataset.submissionId,n=t.dataset.userId;if(!s||!n)return;const a=t.closest("tr");a&&(a.style.opacity="0.5"),t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await la(n,s,"approved"),b("Submission re-approved!","success"),w.selectedUserSubmissions=w.selectedUserSubmissions.filter(o=>o.submissionId!==s),a&&a.remove();const i=w.allUsers.findIndex(o=>o.id===n);if(i>-1){const o=w.allUsers[i];o.rejectedCount=Math.max(0,(o.rejectedCount||0)-1),Be()}if(w.selectedUserSubmissions.length===0){const o=document.querySelector("#admin-user-modal .p-6");o&&(o.innerHTML='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>')}}catch(i){b(`Failed to re-approve: ${i.message}`,"error"),a&&(a.style.opacity="1"),t.disabled=!1,t.innerHTML='<i class="fa-solid fa-check"></i> Re-Approve'}},Ol=async e=>{const t=e.target.closest(".view-rejected-btn");if(!t||t.disabled)return;const s=t.dataset.userId,n=t.dataset.wallet;if(s){w.selectedWallet=n,w.isSubmissionsModalOpen=!0,vs(!0,[]);try{const a=await Ki(s,"rejected");w.selectedUserSubmissions=a,vs(!1,a)}catch(a){b(`Error fetching user submissions: ${a.message}`,"error"),vs(!1,[],!0)}}},Wl=()=>{w.isSubmissionsModalOpen=!1,w.selectedUserSubmissions=[],w.selectedWallet=null;const e=document.getElementById("admin-user-modal");e&&e.remove(),document.body.style.overflow="auto"},ql=e=>{const t=e.target.closest(".user-profile-link");if(!t)return;e.preventDefault();const s=t.dataset.userId;if(!s)return;const n=w.allUsers.find(a=>a.id===s);if(!n){b("Error: Could not find user data.","error");return}Jl(n)},Yl=()=>{const e=document.getElementById("admin-user-profile-modal");e&&e.remove(),document.body.style.overflow="auto"},Kl=async e=>{e.preventDefault();const t=e.target;let s,n;try{if(s=new Date(t.startDate.value+"T00:00:00Z"),n=new Date(t.endDate.value+"T23:59:59Z"),isNaN(s.getTime())||isNaN(n.getTime()))throw new Error("Invalid date format.");if(s>=n)throw new Error("Start Date must be before End Date.")}catch(l){b(l.message,"error");return}const a={title:t.title.value.trim(),url:t.url.value.trim(),description:t.description.value.trim(),points:parseInt(t.points.value,10),cooldownHours:parseInt(t.cooldown.value,10),startDate:s,endDate:n};if(!a.title||!a.description){b("Please fill in Title and Description.","error");return}if(a.points<=0||a.cooldownHours<=0){b("Points and Cooldown must be positive numbers.","error");return}if(a.url&&!a.url.startsWith("http")){b("URL must start with http:// or https://","error");return}w.editingTask&&w.editingTask.id&&(a.id=w.editingTask.id);const i=t.querySelector('button[type="submit"]'),o=i.innerHTML;i.disabled=!0;const r=document.createElement("span");r.classList.add("inline-block"),i.innerHTML="",i.appendChild(r);try{await Oi(a),b(`Task ${a.id?"updated":"created"} successfully!`,"success"),t.reset(),w.editingTask=null,lt()}catch(l){b(`Failed to save task: ${l.message}`,"error"),console.error(l),i.disabled=!1,i.innerHTML=o}},Gl=async e=>{e.preventDefault();const t=e.target,s={YouTube:parseInt(t.youtubePoints.value,10),"YouTube Shorts":parseInt(t.youtubeShortsPoints.value,10),Instagram:parseInt(t.instagramPoints.value,10),"X/Twitter":parseInt(t.xTwitterPoints.value,10),Facebook:parseInt(t.facebookPoints.value,10),Telegram:parseInt(t.telegramPoints.value,10),TikTok:parseInt(t.tiktokPoints.value,10),Reddit:parseInt(t.redditPoints.value,10),LinkedIn:parseInt(t.linkedinPoints.value,10),Other:parseInt(t.otherPoints.value,10)};if(Object.values(s).some(o=>isNaN(o)||o<0)){b("All points must be positive numbers (or 0).","error");return}const n=t.querySelector('button[type="submit"]'),a=n.innerHTML;n.disabled=!0;const i=document.createElement("span");i.classList.add("inline-block"),n.innerHTML="",n.appendChild(i);try{await _i(s),b("UGC Base Points updated successfully!","success"),w.ugcBasePoints=s}catch(o){b(`Failed to update points: ${o.message}`,"error"),console.error(o)}finally{document.body.contains(n)&&(n.disabled=!1,n.innerHTML=a)}},Vl=e=>{const t=w.dailyTasks.find(s=>s.id===e);t&&(w.editingTask=t,gt())},Xl=async e=>{if(window.confirm("Are you sure you want to delete this task permanently?"))try{await Wi(e),b("Task deleted.","success"),w.editingTask=null,lt()}catch(t){b(`Failed to delete task: ${t.message}`,"error"),console.error(t)}};function vs(e,t,s=!1){var o,r;const n=document.getElementById("admin-user-modal");n&&n.remove(),document.body.style.overflow="hidden";let a="";e?a='<div class="p-8"></div>':s?a='<p class="text-red-400 text-center p-8">Failed to load submissions.</p>':t.length===0?a='<p class="text-zinc-400 text-center p-8">This user has no rejected submissions.</p>':a=`
         ...
         <div id="admin-user-modal" class="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4" style="backdrop-filter: blur(5px);">
             <div class="bg-sidebar border border-border-color rounded-xl shadow-lg w-full max-w-3xl max-h-[90vh] flex flex-col">
                 <div class="p-5 border-b border-border-color flex justify-between items-center">
                     <h2 class="text-xl font-bold text-white">Rejected Posts for ${Xe(w.selectedWallet)}</h2>
         ...
         <div id="admin-user-profile-modal" class="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4" style="backdrop-filter: blur(5px);">
             <div class="bg-sidebar border border-border-color rounded-xl shadow-lg w-full max-w-2xl max-h-[90vh] flex flex-col">
                 ...
                 <div class="p-6 overflow-y-auto space-y-4">
                    ...
                    <div class="flex justify-between items-center">
                        <h3 class="text-lg font-semibold text-zinc-100">${Xe(e.walletAddress)}</h3>
                        ${s}
                    </div>
     ...
     `;document.body.insertAdjacentHTML("beforeend",n),(a=document.getElementById("close-admin-profile-modal-btn"))==null||a.addEventListener("click",Yl)}const Ql=e=>{const t=e.target.closest(".user-filter-btn");!t||t.classList.contains("active")||(w.usersFilter=t.dataset.filter||"all",w.usersPage=1,Be())},Zl=e=>{w.usersSearch=e.target.value,w.usersPage=1,Be()},ec=e=>{w.usersPage=e,Be()},tc=e=>{w.submissionsPage=e,Ut()},sc=e=>{w.tasksPage=e,gt()},Be=()=>{var A,$;const e=document.getElementById("manage-users-content");if(!e)return;const t=w.allUsers;if(!t)return;const n=(w.usersSearch||"").toLowerCase().trim().replace(/[^a-z0-9x]/g,""),a=w.usersFilter;let i=t;n&&(i=i.filter(T=>{var M,W;return((M=T.walletAddress)==null?void 0:M.toLowerCase().includes(n))||((W=T.id)==null?void 0:W.toLowerCase().includes(n))})),a==="banned"?i=i.filter(T=>T.isBanned):a==="appealing"&&(i=i.filter(T=>T.hasPendingAppeal===!0));const o=t.length,r=t.filter(T=>T.isBanned).length,l=t.filter(T=>T.hasPendingAppeal===!0).length,d=i.sort((T,M)=>T.hasPendingAppeal!==M.hasPendingAppeal?T.hasPendingAppeal?-1:1:T.isBanned!==M.isBanned?T.isBanned?-1:1:(M.totalPoints||0)-(T.totalPoints||0)),u=w.usersPage,f=w.usersPerPage,p=d.length,g=Math.ceil(p/f),m=(u-1)*f,x=u*f,y=d.slice(m,x),k=y.length>0?y.map(T=>{let M="border-b border-border-color hover:bg-zinc-800/50",W="";return T.hasPendingAppeal?(M+=" bg-yellow-900/40",W='<span class="ml-2 text-xs font-bold text-yellow-300">[APPEALING]</span>'):T.isBanned&&(M+=" bg-red-900/30 opacity-70",W='<span class="ml-2 text-xs font-bold text-red-400">[BANNED]</span>'),`
        <tr class="${M}">
    ...
    `;e.innerHTML=`
        ...
        <div class="mb-4 p-4 bg-zinc-800 rounded-xl border border-border-color flex flex-wrap gap-4 justify-between items-center">
            ...
            <div class="relative flex-grow max-w-xs">
                <input type="text" id="user-search-input" class="form-input pl-10" placeholder="Search Wallet or User ID..." value="${w.usersSearch}">
    ...
    `;const E=document.getElementById("admin-users-pagination");E&&g>1&&Js(E,w.usersPage,g,ec),(A=document.getElementById("admin-users-tbody"))==null||A.addEventListener("click",T=>{T.target.closest(".user-profile-link")&&ql(T),T.target.closest(".ban-user-btn")&&Hl(T),T.target.closest(".view-rejected-btn")&&Ol(T),T.target.closest(".resolve-appeal-btn")&&_l(T)}),($=document.getElementById("user-filters-nav"))==null||$.addEventListener("click",Ql);const L=document.getElementById("user-search-input");if(L){let T;L.addEventListener("keyup",M=>{clearTimeout(T),T=setTimeout(()=>Zl(M),300)})}},qn=()=>{var n;const e=document.getElementById("manage-ugc-points-content");if(!e)return;const t=w.ugcBasePoints;if(!t)return;const s={YouTube:5e3,"YouTube Shorts":2500,Instagram:3e3,"X/Twitter":1500,Facebook:2e3,Telegram:1e3,TikTok:3500,Reddit:1800,LinkedIn:2200,Other:1e3};e.innerHTML=`
    ...
    `,(n=document.getElementById("ugcPointsForm"))==null||n.addEventListener("submit",Gl)},gt=()=>{var m,x,y;const e=document.getElementById("manage-tasks-content");if(!e)return;const t=w.editingTask,s=!!t,n=k=>{if(!k)return"";try{return(k.toDate?k.toDate():k instanceof Date?k:new Date(k)).toISOString().split("T")[0]}catch{return""}},a=w.tasksPage,i=w.tasksPerPage,o=[...w.dailyTasks].sort((k,E)=>{var $,T;const L=($=k.startDate)!=null&&$.toDate?k.startDate.toDate():new Date(k.startDate||0);return((T=E.startDate)!=null&&T.toDate?E.startDate.toDate():new Date(E.startDate||0)).getTime()-L.getTime()}),r=o.length,l=Math.ceil(r/i),d=(a-1)*i,u=a*i,f=o.slice(d,u),p=f.length>0?f.map(k=>{var T,M;const E=new Date,L=(T=k.startDate)!=null&&T.toDate?k.startDate.toDate():k.startDate?new Date(k.startDate):null,A=(M=k.endDate)!=null&&M.toDate?k.endDate.toDate():k.endDate?new Date(k.endDate):null;let $="text-zinc-500";return L&&A&&(E>=L&&E<=A?$="text-green-400":E<L&&($="text-blue-400")),`
    ...
    `;const g=document.getElementById("admin-tasks-pagination");g&&l>1&&Js(g,w.tasksPage,l,sc),(m=document.getElementById("taskForm"))==null||m.addEventListener("submit",Kl),(x=document.getElementById("cancelEditBtn"))==null||x.addEventListener("click",()=>{w.editingTask=null,gt()}),(y=document.getElementById("existing-tasks-list"))==null||y.addEventListener("click",k=>{const E=k.target.closest("button[data-id]");if(!E)return;const L=E.dataset.id;E.dataset.action==="edit"&&Vl(L),E.dataset.action==="delete"&&Xl(L)})},Ut=()=>{var f;const e=document.getElementById("submissions-content");if(!e)return;if(!w.allSubmissions||w.allSubmissions.length===0){const p=document.createElement("div");e.innerHTML=p.innerHTML;return}const t=w.submissionsPage,s=w.submissionsPerPage,n=[...w.allSubmissions].sort((p,g)=>{var m,x;return(((m=g.submittedAt)==null?void 0:m.getTime())||0)-(((x=p.submittedAt)==null?void 0:x.getTime())||0)}),a=n.length,i=Math.ceil(a/s),o=(t-1)*s,r=t*s,d=n.slice(o,r).map(p=>{var g,m;return`
        <tr class="border-b border-border-color hover:bg-zinc-800/50">
            <td class="p-3 text-xs text-zinc-400 font-mono" title="${p.userId}">${Xe(p.walletAddress)}</td>
            ...
            <td class="p-3 text-xs font-semibold ${((g=Wn[p.status])==null?void 0:g.color)||"text-gray-500"}">${((m=Wn[p.status])==null?void 0:m.text)||p.status}</td>
            <td class="p-3 text-right">
                <div class="flex items-center justify-end gap-2">
    ...
    `;const u=document.getElementById("admin-submissions-pagination");u&&i>1&&Js(u,w.submissionsPage,i,tc),(f=document.getElementById("admin-submissions-tbody"))==null||f.addEventListener("click",jl)},Ot=()=>{var i,o;const e=document.getElementById("platform-usage-content");if(!e)return;const t=w.platformUsageConfig||ss;let s=0;Object.values(t).forEach(r=>{r.enabled!==!1&&(s+=(r.points||0)*(r.maxCount||1))});const n=Object.entries(t).map(([r,l])=>`
    ...
    `;const a=document.getElementById("platform-usage-tbody");a==null||a.addEventListener("input",Yn),a==null||a.addEventListener("change",Yn),(i=document.getElementById("save-platform-config-btn"))==null||i.addEventListener("click",nc),(o=document.getElementById("reset-platform-config-btn"))==null||o.addEventListener("click",ac)},Yn=e=>{const t=e.target;if(!t.classList.contains("platform-input")&&!t.classList.contains("platform-toggle"))return;const s=t.closest("tr"),n=s==null?void 0:s.dataset.actionKey,a=t.dataset.field;if(!n||!a)return;w.platformUsageConfig[n]||(w.platformUsageConfig[n]={...ss[n]}),a==="enabled"?w.platformUsageConfig[n].enabled=t.checked:w.platformUsageConfig[n][a]=parseInt(t.value)||0;const i=w.platformUsageConfig[n],o=s.querySelector("td:last-child");o&&(o.textContent=((i.points||0)*(i.maxCount||1)).toLocaleString())},nc=async e=>{const t=e.target.closest("button");if(!t)return;const s=t.innerHTML;t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Saving...';try{await da(w.platformUsageConfig),b("✅ Platform Usage config saved!","success"),Ot()}catch(n){console.error("Error saving platform config:",n),b("Failed to save config: "+n.message,"error")}finally{t.disabled=!1,t.innerHTML=s}},ac=async()=>{if(confirm("Are you sure you want to reset to default values? This will save immediately."))try{w.platformUsageConfig={...ss},await da(w.platformUsageConfig),b("✅ Config reset to defaults!","success"),Ot()}catch(e){console.error("Error resetting platform config:",e),b("Failed to reset config: "+e.message,"error")}},ic=()=>{var s;const e=document.getElementById("admin-content-wrapper");if(!e)return;e.innerHTML=`
        ...
        <div class="border-b border-border-color mb-6">
            <nav id="admin-tabs" class="-mb-px flex flex-wrap gap-x-6 gap-y-2">
                <button class="tab-btn ${w.activeTab==="review-submissions"?"active":""}" data-target="review-submissions">Review Submissions</button>
                <button class="tab-btn ${w.activeTab==="manage-users"?"active":""}" data-target="manage-users">Manage Users</button>
                <button class="tab-btn ${w.activeTab==="manage-ugc-points"?"active":""}" data-target="manage-ugc-points">Manage UGC Points</button>
                <button class="tab-btn ${w.activeTab==="manage-tasks"?"active":""}" data-target="manage-tasks">Manage Daily Tasks</button>
                <button class="tab-btn ${w.activeTab==="platform-usage"?"active":""}" data-target="platform-usage">Platform Usage</button>
            </nav>
        </div>

        <div id="review_submissions_tab" class="tab-content ${w.activeTab==="review-submissions"?"active":""}">
            <div id="submissions-content" class="max-w-7xl mx-auto"></div>
        </div>

        <div id="manage_users_tab" class="tab-content ${w.activeTab==="manage-users"?"active":""}">
            <div id="manage-users-content" class="max-w-7xl mx-auto"></div>
        </div>

        <div id="manage_ugc_points_tab" class="tab-content ${w.activeTab==="manage-ugc-points"?"active":""}">
            <div id="manage-ugc-points-content" class="max-w-4xl mx-auto"></div>
        </div>

        <div id="manage_tasks_tab" class="tab-content ${w.activeTab==="manage-tasks"?"active":""}">
            <div id="manage-tasks-content" class="max-w-4xl mx-auto"></div>
        </div>

        <div id="platform_usage_tab" class="tab-content ${w.activeTab==="platform-usage"?"active":""}">
            <div id="platform-usage-content" class="max-w-4xl mx-auto"></div>
        </div>
    `,(s=document.getElementById("withdraw-presale-funds-btn"))==null||s.addEventListener("click",n=>Dl(n.target)),nn(),w.activeTab==="manage-ugc-points"?qn():w.activeTab==="manage-tasks"?gt():w.activeTab==="review-submissions"?Ut():w.activeTab==="manage-users"?Be():w.activeTab==="platform-usage"&&Ot();const t=document.getElementById("admin-tabs");t&&!t._listenerAttached&&(t.addEventListener("click",n=>{const a=n.target.closest(".tab-btn");if(!a||a.classList.contains("active"))return;const i=a.dataset.target;w.activeTab=i,i!=="manage-users"&&(w.usersPage=1,w.usersFilter="all",w.usersSearch=""),i!=="review-submissions"&&(w.submissionsPage=1),i!=="manage-tasks"&&(w.tasksPage=1),document.querySelectorAll("#admin-tabs .tab-btn").forEach(r=>r.classList.remove("active")),a.classList.add("active"),e.querySelectorAll(".tab-content").forEach(r=>r.classList.remove("active"));const o=document.getElementById(i.replace(/-/g,"_")+"_tab");o?(o.classList.add("active"),i==="manage-ugc-points"&&qn(),i==="manage-tasks"&&gt(),i==="review-submissions"&&Ut(),i==="manage-users"&&Be(),i==="platform-usage"&&Ot()):console.warn(`Tab content container not found for target: ${i}`)}),t._listenerAttached=!0)},oc={render(){const e=document.getElementById("admin");if(e){if(!Rl()){e.innerHTML='<div class="text-center text-red-400 p-8 bg-sidebar border border-red-500/50 rounded-lg">Access Denied. This page is restricted to administrators.</div>';return}if(On()){e.innerHTML='<div id="admin-content-wrapper"></div>',lt();return}e.innerHTML=`
    ...
    `}function Wa(){const e=document.getElementById("marketplace-grid");if(!e)return;const t=J.translations.en;if(J.nftTiers[0].priceInWei===0n){e.innerHTML=`<p class="text-lg text-amber-400 text-center col-span-full animate-pulse">${t.loadingText}</p>`,Ua();return}e.innerHTML=J.nftTiers.map(Oa).join(""),kt(c.isConnected),_a("en")}const Rs={render:()=>{const e=`
    ...
    `,document.head.appendChild(e)},ct=e=>e>=1e6?(e/1e6).toFixed(1)+"M":e>=1e3?(e/1e3).toFixed(0)+"K":e.toLocaleString();function fc(){return`
    ...
    `}function mc(){const e=c.totalSupply?B(c.totalSupply):4e7,t=(e/hs*100).toFixed(1);return`
        <div class="tk-section tk-fade-up" style="animation-delay: 0.1s">
            ...
            <p class="text-center text-zinc-600 text-[10px]">
                ...
                Remaining ${ct(hs-e)} BKC to be mined through ecosystem activity
            </p>
        </div>
    `}function bc(){return`
                ...
                <div class="space-y-3">
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-500 text-[10px]">${ct(Gn.airdrop.amount)} BKC</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-500 text-[10px]">${ct(Gn.liquidity.amount)} BKC</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 flex items-center justify-center">
                            <img src="${We}" alt="Notary" class="w-full h-full object-contain notary-float notary-pulse" id="notary-mascot-mobile">
                        </div>
                        <div>
            ...
            <div class="hidden md:flex items-center justify-between mb-6">
                <div class="flex items-center gap-4">
                    <div class="w-14 h-14 flex items-center justify-center">
                        <img src="${We}" alt="Notary" class="w-full h-full object-contain notary-float notary-pulse" id="notary-mascot">
                    </div>
                    <div>
                    ...
                    <div class="col-span-full text-center py-8 text-zinc-600">
                        <div class="w-16 h-16 mx-auto mb-3 relative">
                            ...
                            <div class="relative w-full h-full rounded-full bg-zinc-800 flex items-center justify-center p-2">
                                <img src="${We}" alt="Loading" class="w-full h-full object-contain opacity-60 animate-pulse">
                            </div>
                        </div>
            ...
            <div class="text-center p-6 max-w-sm">
                <div class="w-28 h-28 mx-auto mb-6 relative">
                    ...
                    <div class="relative w-full h-full rounded-full bg-gradient-to-br from-zinc-800 to-zinc-900 flex items-center justify-center shadow-xl shadow-amber-500/20 overflow-hidden border-2 border-amber-500/30 p-3">
                        <img src="${We}" alt="Notarizing" class="w-full h-full object-contain notary-spin" id="notary-overlay-img">
                    </div>
                </div>
    ...
    `,Wt(),xe(),ns(),Rc())}function Wt(){const e=document.getElementById("mobile-badge"),t=document.getElementById("desktop-badge"),s=document.getElementById("fee-amount"),n=document.getElementById("user-balance"),a=c.notaryFee||0n,i=c.currentUserBalance||0n;s&&(s.textContent=`${B(a)} BKC`),n&&(n.textContent=`${B(i)} BKC`,n.className=`font-mono font-bold ${i>=a?"text-green-400":"text-red-400"}`),c.isConnected?i>=a?(e&&(e.className="text-[10px] px-2 py-1 rounded-full bg-green-500/20 text-green-400",e.textContent="Ready"),t&&(t.innerHTML=`
        ...
        `;return}const t=c.notaryFee||Oe.parseEther("1"),s=c.currentUserBalance||0n;if(s<t){e.innerHTML=`
            <div class="flex flex-col items-center justify-center h-full py-8">
            ...
            <div class="bg-zinc-800/50 border border-zinc-700 rounded-xl p-4 mb-4 text-left">
                <div class="flex items-center gap-3 pb-3 border-b border-zinc-700/50 mb-3">
                    <div class="w-10 h-10 rounded-lg bg-amber-500/10 flex items-center justify-center">
                        <i class="${Ya((t==null?void 0:t.type)||"")} text-amber-400"></i>
                    </div>
                    <div class="flex-1 min-w-0">
                    ...
                    <div class="text-center p-6 max-w-sm animate-fade-in">
                        <div class="w-32 h-32 mx-auto mb-6 relative">
                            ...
                            <div class="relative w-full h-full rounded-full bg-gradient-to-br from-green-900/50 to-emerald-900/50 flex items-center justify-center shadow-2xl shadow-green-500/30 overflow-hidden p-3 border-2 border-green-400">
                                <img src="${We}" alt="Success" class="w-full h-full object-contain notary-success">
                            </div>
    ...
    `;try{const s=`${ce.getNotarizedDocuments||"https://getnotarizeddocuments-4wvdcuoouq-uc.a.run.app"}/${c.userAddress}`;console.log("📜 Fetching certificates from Firebase:",s);const n=await fetch(s);if(!n.ok)throw new Error(`API returned ${n.status}`);const a=await n.json();if(!Array.isArray(a)||a.length===0){e.innerHTML=`
                <div class="col-span-full text-center py-8">
                    <img src="${We}" class="w-14 h-14 mx-auto opacity-20 mb-3">
...
`)[0].trim()||"Notarized Document";const f=qa("",u),p=l&&l.length>10,g=Bc(r.timestamp);return`
        ...
        `}}}function Rc(){var e;(e=document.getElementById("btn-refresh"))==null||e.addEventListener("click",async()=>{const t=document.getElementById("btn-refresh");t&&(t.innerHTML='<i class="fa-solid fa-rotate fa-spin"></i> Loading...'),await ns(),t&&(t.innerHTML='<i class="fa-solid fa-rotate"></i> Refresh')})}async function Dc(){const e=Date.now();if(!(e-P.lastFetch<3e4&&c.notaryFee>0n))try{!c.ecosystemManagerContractPublic&&!c.ecosystemManagerContract&&await Ks();const t=c.ecosystemManagerContractPublic||c.ecosystemManagerContract;if(t){let s=0n;try{const n=Oe.id("NOTARY_SERVICE");s=await O(t,"getFee",[n],0n)}catch(n){console.warn("getFee with key failed:",n.message);try{s=await O(t,"notaryFee",[],0n)}catch(a){console.warn("notaryFee failed:",a.message);try{const i=Oe.id("NOTARY_SERVICE");s=await O(t,"fees",[i],0n)}catch(i){console.warn("fees mapping failed:",i.message)}}}s>0n?(c.notaryFee=s,console.log("📜 Notary fee loaded:",B(s),"BKC")):(c.notaryFee=Oe.parseEther("1"),console.log("📜 Using default notary fee: 1 BKC")),P.lastFetch=e}if(c.isConnected&&c.userAddress)try{if(c.bkcTokenContract||c.bkcTokenContractPublic){const s=c.bkcTokenContract||c.bkcTokenContractPublic,n=await O(s,"balanceOf",[c.userAddress],0n);n>0n&&(c.currentUserBalance=n,console.log("📜 User balance loaded:",B(n),"BKC"))}}catch(s){console.warn("Balance load error:",s.message)}Wt()}catch(t){console.warn("Notary data error:",t),(!c.notaryFee||c.notaryFee===0n)&&(c.notaryFee=Oe.parseEther("1"))}}const Ka={async render(e){e&&(Ic(),await Dc(),c.isConnected&&await X(),Wt(),xe())},reset(){P.file=null,P.description="",P.step=1,xe()},update(){Wt(),P.isProcessing||xe()},refreshHistory(){ns()},async addToWallet(e,t){var s,n,a,i;try{const o=["https://dweb.link/ipfs/","https://w3s.link/ipfs/","https://nftstorage.link/ipfs/","https://cloudflare-ipfs.com/ipfs/","https://ipfs.io/ipfs/"],r=f=>f?f.startsWith("ipfs://")?f.replace("ipfs://","").split("?")[0]:f.includes("/ipfs/")?f.split("/ipfs/")[1].split("?")[0]:f.match(/^Qm[a-zA-Z0-9]{44}/)||f.match(/^bafy[a-zA-Z0-9]+/)?f:"":"",l=(f,p=0)=>{if(!f)return"";if(f.startsWith("https://")&&!f.includes("/ipfs/")&&!f.includes("ipfs.io"))return f;const g=r(f);return g?`${o[p]}${g}`:f};let d=l(t||"");if(console.log("📜 Input imageUrl:",t),console.log("📜 Converted to:",d),c.decentralizedNotaryContract)try{const f=await c.decentralizedNotaryContract.tokenURI(e);if(console.log("📜 TokenURI response:",f==null?void 0:f.slice(0,200)),f&&f.startsWith("data:application/json;base64,")){const p=f.replace("data:application/json;base64,",""),g=JSON.parse(atob(p));console.log("📜 Parsed metadata:",JSON.stringify(g).slice(0,300)),g.image&&(d=l(g.image),console.log("📜 Image from metadata:",d))}}catch(f){console.warn("Could not fetch tokenURI:",f.message)}console.log("📜 Final image URL for wallet:",d);const u=((s=c.decentralizedNotaryContract)==null?void 0:s.target)||((n=c.decentralizedNotaryContract)!=null&&n.getAddress?await c.decentralizedNotaryContract.getAddress():null);if(!u){b("Contract address not found","error");return}console.log("📜 Contract address:",u),console.log("📜 Token ID:",e),b("Adding NFT #"+e+" to wallet...","info");try{await window.ethereum.request({method:"wallet_watchAsset",params:{type:"ERC721",options:{address:u,tokenId:String(e),image:d}}})?b("📜 NFT #"+e+" added to wallet!","success"):b("NFT not added (cancelled)","warning");return}catch(f){if(console.warn("First attempt with image failed:",(a=f.message)==null?void 0:a.slice(0,100)),f.code!==4001)try{await window.ethereum.request({method:"wallet_watchAsset",params:{type:"ERC721",options:{address:u,tokenId:String(e)}}})?b("📜 NFT #"+e+" added to wallet!","success"):b("NFT not added (cancelled)","warning");return}catch(p){throw p}throw f}}catch(o){if(console.error("Add to wallet error:",o),o.code===4001)return;o.code===4100||(i=o.message)!=null&&i.includes("spam")?b("MetaMask blocked request. Wait a few seconds and try again.","warning"):b("Could not add NFT: "+(o.message||"Unknown error"),"error")}}};window.NotaryPage=Ka;const xt=window.ethers,He="./assets/airbnft.png",jc="https://sepolia.arbiscan.io/tx/",j={activeTab:"marketplace",filterTier:"ALL",selectedRentalId:null,isLoading:!1,isTransactionPending:!1,rentalHistory:[]};function Tt(e){return e?e.startsWith("https://")||e.startsWith("http://")?e:e.includes("ipfs.io/ipfs/")?`${K}${e.split("ipfs.io/ipfs/")[1]}`:e.startsWith("ipfs://")?`${K}${e.substring(7)}`:e:"./assets/nft.png"}function Ga(e){const t=Math.floor(Date.now()/1e3),s=e-t;if(s<=0)return{text:"Expired",expired:!0};const n=Math.floor(s/3600),a=Math.floor(s%3600/60);return n>0?{text:`${n}h ${a}m`,expired:!1}:{text:`${a}m`,expired:!1}}function _e(e){return te.find(s=>s.boostBips===Number(e))||{name:"Unknown",img:"./assets/bkc_logo_3d.png",boostBips:0}}function Va(e){return{Diamond:"from-cyan-500 to-blue-600",Platinum:"from-slate-300 to-gray-500",Gold:"from-yellow-400 to-amber-600",Silver:"from-gray-300 to-zinc-500",Bronze:"from-orange-500 to-amber-700"}[e]||"from-zinc-500 to-zinc-700"}function Hc(e){if(!e)return"";try{const t=e.seconds||e._seconds||new Date(e).getTime()/1e3;return new Date(t*1e3).toLocaleString("en-US",{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return""}}function _c(e="Loading..."){return`
        <div class="flex flex-col items-center justify-center py-16 gap-5">
            <div class="relative">
                ...
                <div class="relative w-24 h-24 rounded-full bg-gradient-to-br from-zinc-800 to-zinc-900 flex items-center justify-center shadow-xl shadow-green-500/20 overflow-hidden border-2 border-green-500/30">
                    <img src="${He}" alt="Loading" class="w-20 h-20 object-contain animate-pulse drop-shadow-lg" onerror="this.src='./assets/nft.png'">
                </div>
            </div>
            <div class="text-center">
    ...
    `,document.head.appendChild(e)}const Oc={async render(e=!1){Uc();const t=document.getElementById("rental");t&&((t.innerHTML.trim()===""||e)&&(t.innerHTML=`
                ...
                ${sd()}
                ${nd()}
            `,ad()),await zt())},update(){j.isLoading||qt()}};function Xa(){const e=c.rentalListings||[],t=e.filter(l=>{var d,u;return c.isConnected&&((d=l.owner)==null?void 0:d.toLowerCase())===((u=c.userAddress)==null?void 0:u.toLowerCase())}),s=Math.floor(Date.now()/1e3),n=(c.myRentals||[]).filter(l=>{var d,u;return((d=l.tenant)==null?void 0:d.toLowerCase())===((u=c.userAddress)==null?void 0:u.toLowerCase())&&Number(l.endTime)>s}),a=t.reduce((l,d)=>l+Number(xt.formatEther(BigInt(d.totalEarnings||0))),0),i=e.filter(l=>{var d,u;return!(c.isConnected&&((d=l.owner)==null?void 0:d.toLowerCase())===((u=c.userAddress)==null?void 0:u.toLowerCase())||l.isRented||l.rentalEndTime&&Number(l.rentalEndTime)>s)}),o=i.length>0?Math.min(...i.map(l=>parseFloat(xt.formatEther(l.pricePerHour||"0")))):0,r=t.reduce((l,d)=>l+Number(d.rentalCount||0),0);return`
        ...
        <div>
            ...
            ${s.length===0?`
                <div class="text-center py-20 glass-card">
                    <img src="${He}" class="w-20 h-20 mx-auto opacity-30 mb-5" onerror="this.style.display='none'">
    ...
    `}function Kc(e){const t=_e(e.boostBips),s=B(BigInt(e.pricePerHour||0)).toFixed(2),n=`tier-${t.name.toLowerCase()}`,a=Va(t.name),i=e.img||t.img||"./assets/nft.png";return`
        <div class="nft-card">
            <div class="nft-image">
                ...
                <img src="${Tt(i)}" alt="${t.name}" onerror="this.src='./assets/nft.png'">
            </div>
            <div class="p-5">
        ...
        <div>
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    <div class="flex items-center gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white">${t.reduce((i,o)=>i+Number(xt.formatEther(BigInt(o.totalEarnings||0))),0).toFixed(4)} <span class="text-lg text-zinc-500">BKC</span></p>
            ...
            ${t.length===0?`
                <div class="text-center py-16 glass-card">
                    <img src="${He}" class="w-16 h-16 mx-auto opacity-20 mb-4" onerror="this.style.display='none'">
    ...
    `}function Vc(e){const t=_e(e.boostBips),s=B(BigInt(e.pricePerHour||0)).toFixed(2),n=Number(xt.formatEther(BigInt(e.totalEarnings||0))).toFixed(4),a=e.rentalCount||0,i=`tier-${t.name.toLowerCase()}`,o=Math.floor(Date.now()/1e3),r=e.isRented||e.rentalEndTime&&Number(e.rentalEndTime)>o,l=r&&e.rentalEndTime?Ga(Number(e.rentalEndTime)):null;return`
        <div class="nft-card ${r?"border-amber-500/30":""}">
            <div class="nft-image">
                ...
                <img src="${Tt(e.img||t.img)}" alt="${t.name}" onerror="this.src='./assets/nft.png'">
            </div>
            <div class="p-5">
    ...
    `}function Jc(e){const t=(c.rentalListings||[]).find(o=>o.tokenId===e.tokenId),s=_e((t==null?void 0:t.boostBips)||0),n=Ga(Number(e.endTime)),a=B(BigInt(e.paidAmount||0)).toFixed(2),i=`tier-${s.name.toLowerCase()}`;return Va(s.name),`
        <div class="nft-card border-green-500/30">
            <div class="nft-image bg-gradient-to-br from-green-500/5 to-transparent">
                ...
                <img src="${Tt((t==null?void 0:t.img)||s.img)}" alt="${s.name}" onerror="this.src='./assets/nft.png'">
            </div>
            <div class="p-5">
                <div class="flex justify-between items-start mb-3">
                    <div>
    ...
    `}function Qc(e){const t=(c.rentalListings||[]).find(i=>i.tokenId===e.tokenId),s=_e((t==null?void 0:t.boostBips)||0),n=B(BigInt(e.paidAmount||0)).toFixed(2),a=`tier-${s.name.toLowerCase()}`;return`
        <div class="flex items-center gap-4 glass-card p-4">
            <img src="${Tt((t==null?void 0:t.img)||s.img)}" class="w-12 h-12 rounded-xl object-contain bg-black/30" onerror="this.src='./assets/nft.png'">
            <div class="flex-1 min-w-0">
                <div class="flex items-center gap-2 mb-1">
    ...
    `}function Zc(){return c.isConnected?(ed(),j.rentalHistory.length===0?`
            <div class="text-center py-16 glass-card">
                <img src="${He}" class="w-20 h-20 mx-auto opacity-20 mb-4" onerror="this.style.display='none'">
    ...
    `}function on(e){return`
        <div class="text-center py-20 glass-card">
            <img src="${He}" class="w-20 h-20 mx-auto opacity-20 mb-5" onerror="this.style.display='none'">
    ...
    `}async function zt(){j.isLoading=!0;try{await Promise.all([ht(),c.isConnected?Ai():Promise.resolve(),c.isConnected?Qt():Promise.resolve()]),qt()}catch(e){console.error("Refresh error:",e)}finally{j.isLoading=!1}}function ad(){var e,t,s,n,a,i,o;document.querySelectorAll(".rental-tab").forEach(r=>{r.addEventListener("click",()=>{document.querySelectorAll(".rental-tab").forEach(l=>l.classList.remove("active")),r.classList.add("active"),j.activeTab=r.dataset.tab,qt()})}),document.addEventListener("click",r=>{const l=r.target.closest(".filter-chip");l&&(j.filterTier=l.dataset.filter,qt())}),(e=document.getElementById("btn-refresh-rentals"))==null||e.addEventListener("click",async()=>{const r=document.getElementById("btn-refresh-rentals"),l=r==null?void 0:r.querySelector("i");l==null||l.classList.add("fa-spin"),await zt(),setTimeout(()=>l==null?void 0:l.classList.remove("fa-spin"),500)}),document.addEventListener("click",r=>{const l=r.target.closest(".rent-btn");if(l&&!l.disabled){id(l.dataset.id);return}const d=r.target.closest(".withdraw-btn");if(d&&!d.disabled){dd(d);return}const u=r.target.closest("#btn-open-list-modal, #btn-open-list-modal-empty, #btn-open-list-modal-main");if(u&&!u.disabled){od();return}}),(t=document.getElementById("close-rent-modal"))==null||t.addEventListener("click",Ds),(s=document.getElementById("close-list-modal"))==null||s.addEventListener("click",js),(n=document.getElementById("rent-modal"))==null||n.addEventListener("click",r=>{r.target.id==="rent-modal"&&Ds()}),(a=document.getElementById("list-modal"))==null||a.addEventListener("click",r=>{r.target.id==="list-modal"&&js()}),(i=document.getElementById("confirm-rent-btn"))==null||i.addEventListener("click",rd),(o=document.getElementById("confirm-list-btn"))==null||o.addEventListener("click",cd)}function id(e){if(!c.isConnected){b("Please connect your wallet first","warning");return}const t=(c.rentalListings||[]).find(d=>d.tokenId===e);if(!t){b("Listing not found","error");return}j.selectedRentalId=e;const s=_e(t.boostBips),n=BigInt(t.pricePerHour||0),a=B(n).toFixed(2),i=`tier-${s.name.toLowerCase()}`,o=document.getElementById("rent-modal-content"),r=document.getElementById("modal-total-cost");o.innerHTML=`
        <div class="flex items-center gap-4 bg-zinc-800/50 p-4 rounded-xl border border-zinc-700/50">
            <img src="${Tt(t.img||s.img)}" class="w-20 h-20 object-contain bg-black/30 rounded-xl" onerror="this.src='./assets/nft.png'">
            <div class="flex-1 min-w-0">
                <div class="flex items-center gap-2 mb-2">
                    <span class="tier-badge ${i}">${s.name}</span>
    ...
    `,r.innerHTML=`${a} <span class="text-sm text-zinc-500 font-normal">BKC</span>`;const l=document.getElementById("rent-modal");l.classList.remove("hidden"),l.classList.add("flex")}function Ds(){const e=document.getElementById("rent-modal");e.classList.remove("flex"),e.classList.add("hidden"),j.selectedRentalId=null}function od(){const e=c.rentalListings||[],t=new Set(e.map(i=>{var o;return(o=i.tokenId)==null?void 0:o.toString()})),s=(c.myBoosters||[]).filter(i=>{var o;return!t.has((o=i.tokenId)==null?void 0:o.toString())}),n=document.getElementById("list-nft-select");n&&(s.length===0?n.innerHTML='<option value="">No NFTs available to list</option>':n.innerHTML=s.map(i=>{const o=_e(i.boostBips);return`<option value="${i.tokenId}">#${i.tokenId} - ${o.name} (+${(i.boostBips||0)/100}%)</option>`}).join("")),document.getElementById("list-price-input").value="";const a=document.getElementById("list-modal");a.classList.remove("hidden"),a.classList.add("flex")}function js(){const e=document.getElementById("list-modal");e.classList.remove("flex"),e.classList.add("hidden")}async function rd(){if(j.isTransactionPending)return;const e=j.selectedRentalId,t=(c.rentalListings||[]).find(l=>l.tokenId===e);if(!t)return;const s=document.getElementById("confirm-rent-btn"),n=document.getElementById("airbnft-mascot"),a=s.innerHTML,i=1,r=BigInt(t.pricePerHour||0)*BigInt(i);j.isTransactionPending=!0,s.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Processing...',s.disabled=!0,n&&(n.className="w-16 h-16 object-contain airbnft-spin");try{await Eo({tokenId:e,hours:i,totalCost:r.toString()},s)&&(n&&(n.className="w-16 h-16 object-contain airbnft-success"),Ds(),b("⏰ NFT rented successfully! Boost is now active for 1 hour.","success"),ld(5),await zt())}finally{j.isTransactionPending=!1,s.innerHTML=a,s.disabled=!1,n&&setTimeout(()=>{n.className="w-16 h-16 object-contain airbnft-float airbnft-pulse"},800)}}function ld(e){document.querySelectorAll(".rent-btn").forEach(s=>{s.disabled=!0,s.classList.add("opacity-50","cursor-not-allowed");let n=e;const a=s.innerHTML,i=setInterval(()=>{s.innerHTML=`<i class="fa-solid fa-clock mr-1"></i>${n}s`,n--,n<0&&(clearInterval(i),s.innerHTML=a,s.disabled=!1,s.classList.remove("opacity-50","cursor-not-allowed"))},1e3)})}async function cd(){if(j.isTransactionPending)return;const e=document.getElementById("list-nft-select").value,t=document.getElementById("list-price-input").value;if(!e)return b("Please select an NFT","error");if(!t||parseFloat(t)<=0)return b("Please enter a valid price","error");const s=document.getElementById("confirm-list-btn"),n=document.getElementById("airbnft-mascot"),a=s.innerHTML;j.isTransactionPending=!0,s.innerHTML='<i class="fa-solid fa-spinner fa-spin mr-2"></i>Processing...',s.disabled=!0,n&&(n.className="w-16 h-16 object-contain airbnft-spin");try{const i=xt.parseUnits(t,18),o=document.getElementById("list-min-hours"),r=document.getElementById("list-max-hours"),l=o&&parseInt(o.value)||1,d=r&&parseInt(r.value)||168;await Bo({tokenId:e,pricePerHour:i,minHours:l,maxHours:d},s)&&(n&&(n.className="w-16 h-16 object-contain airbnft-success"),js(),b("🏷️ NFT listed successfully!","success"),await zt())}finally{j.isTransactionPending=!1,s.innerHTML=a,s.disabled=!1,n&&setTimeout(()=>{n.className="w-16 h-16 object-contain airbnft-float airbnft-pulse"},800)}}async function dd(e){if(j.isTransactionPending)return;const t=e.dataset.id;if(!confirm("Are you sure you want to withdraw this NFT from the rental market?"))return;const s=e.innerHTML,n=document.getElementById("airbnft-mascot");j.isTransactionPending=!0,e.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>',e.disabled=!0,n&&(n.className="w-16 h-16 object-contain airbnft-spin");try{await Io(t,e)&&(b("↩️ NFT withdrawn successfully!","success"),await zt())}finally{j.isTransactionPending=!1,e.innerHTML=s,e.disabled=!1,n&&setTimeout(()=>{n.className="w-16 h-16 object-contain airbnft-float airbnft-pulse"},800)}}const ud={render:async e=>{const t=document.getElementById("socials");if(!t||!e&&t.innerHTML.trim()!=="")return;const s=`
            <style>
        ...
        `},cleanup:()=>{}},Ja=document.createElement("style");Ja.innerHTML=`
...
`;document.head.appendChild(Ja);const pd={render:async e=>{if(!e)return;const t=document.getElementById("creditcard");t&&(t.innerHTML=`
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    ...
                    <div class="glass-mockup rounded-2xl p-6 h-full flex flex-col">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="space-y-2">
                                ${tt("Starbucks Coffee","Today, 8:30 AM","- $5.40","+ 15 BKC","fa-mug-hot")}
                                ${tt("Uber Ride","Yesterday, 6:15 PM","- $24.50","+ 82 BKC","fa-car")}
                                ${tt("Netflix Subscription","Oct 24, 2025","- $15.99","+ 53 BKC","fa-film")}
                                ${tt("Amazon Purchase","Oct 22, 2025","- $142.00","+ 475 BKC","fa-box-open")}
                                ${tt("Shell Station","Oct 20, 2025","- $45.00","+ 150 BKC","fa-gas-pump")}
                            </div>
                        </div>
                    </div>
    ...
    `}function ys(e,t,s,n,a,i,o){const r=rn[De];let l=`
        <div class="mb-10">
    ...
    `,d=o;return n.forEach(u=>{l+=md(u,d++)}),l+="</div></div>",{html:l,nextIndex:d}}function bd(e){var t,s,n,a,i,o,r,l;De=e,localStorage.setItem("backcoin-tutorials-lang",e),(t=document.getElementById("tutorials-btn-en"))==null||t.classList.toggle("bg-amber-500",e==="en"),(s=document.getElementById("tutorials-btn-en"))==null||s.classList.toggle("text-zinc-900",e==="en"),(n=document.getElementById("tutorials-btn-en"))==null||n.classList.toggle("bg-zinc-700",e!=="en"),(a=document.getElementById("tutorials-btn-en"))==null||a.classList.toggle("text-zinc-300",e!=="en"),(i=document.getElementById("tutorials-btn-pt"))==null||i.classList.toggle("bg-amber-500",e==="pt"),(o=document.getElementById("tutorials-btn-pt"))==null||o.classList.toggle("text-zinc-900",e==="pt"),(r=document.getElementById("tutorials-btn-pt"))==null||r.classList.toggle("bg-zinc-700",e!=="pt"),(l=document.getElementById("tutorials-btn-pt"))==null||l.classList.toggle("text-zinc-300",e!=="pt"),Qa()}function Qa(){const e=document.getElementById("tutorials-content");if(!e)return;const t=rn[De];let s=`
        <!-- Hero -->
        <div class="text-center mb-10">
    ...
    `,n=ys("getting-started","rocket","emerald",ws.gettingStarted,"catGettingStarted","catGettingStartedDesc",0);s+=n.html,n=ys("ecosystem","cubes","amber",ws.ecosystem,"catEcosystem","catEcosystemDesc",n.nextIndex),s+=n.html,n=ys("advanced","graduation-cap","cyan",ws.advanced,"catAdvanced","catAdvancedDesc",n.nextIndex),s+=n.html,e.innerHTML=s}const Za={render:function(e=!1){const t=document.getElementById("tutorials");t&&(e||t.innerHTML.trim()==="")&&(t.innerHTML=`
                    ...
                    <div class="flex items-center justify-between mb-8">
                        ...
                        <div class="flex items-center gap-1 bg-zinc-800 p-1 rounded-lg border border-zinc-700">
                            <button id="tutorials-btn-en" onclick="TutorialsPage.setLang('en')" 
                                    class="flex items-center gap-2 px-3 py-2 rounded-md text-xs font-bold transition-all ${De==="en"?"bg-amber-500 text-zinc-900":"bg-zinc-700 text-zinc-300 hover:bg-zinc-600"}">
                            ...
                            <button id="tutorials-btn-pt" onclick="TutorialsPage.setLang('pt')" 
                                    class="flex items-center gap-2 px-3 py-2 rounded-md text-xs font-bold transition-all ${De==="pt"?"bg-amber-500 text-zinc-900":"bg-zinc-700 text-zinc-300 hover:bg-zinc-600"}">
            ...
            `,Qa())},update:function(e){},cleanup:function(){},setLang:bd};window.TutorialsPage=Za;const gd=window.inject||(()=>{console.warn("Dev Mode: Analytics disabled.")});if(window.location.hostname!=="localhost"&&window.location.hostname!=="127.0.0.1")try{gd()}catch(e){console.error("Analytics Error:",e)}const ln="".toLowerCase();window.__ADMIN_WALLET__=ln;ln&&console.log("✅ Admin access granted");let dt=null,st=null,ks=!1;const re={dashboard:ka,mine:Ea,store:yr,rewards:tn,actions:tl,notary:Ka,airdrop:Pl,tokenomics:Tc,about:pl,admin:oc,presale:Rs,rental:Oc,socials:ud,creditcard:pd,dex:F,dao:fd,tutorials:Za};function ei(e){return!e||e.length<42?"...":`${e.slice(0,6)}...${e.slice(-4)}`}function xd(e){if(!e)return"0.00";const t=B(e);return t>=1e9?(t/1e9).toFixed(2)+"B":t>=1e6?(t/1e6).toFixed(2)+"M":t>=1e4?t.toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):t.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function Ct(e,t=!1){const s=document.querySelector("main > div.container"),n=document.querySelectorAll(".sidebar-link");if(!s)return;if(dt===e&&!t){re[e]&&typeof re[e].update=="function"&&re[e].update(c.isConnected);return}st&&typeof st=="function"&&(st(),st=null),Array.from(s.children).forEach(i=>{i.tagName==="SECTION"&&(i.classList.add("hidden"),i.classList.remove("active"))}),n.forEach(i=>{i.classList.remove("active"),i.classList.add("text-zinc-400","hover:text-white","hover:bg-zinc-700")});const a=document.getElementById(e);if(a&&re[e]){a.classList.remove("hidden"),a.classList.add("active");const i=dt!==e;dt=e;const o=document.querySelector(`.sidebar-link[data-target="${e}"]`);o&&(o.classList.remove("text-zinc-400","hover:text-white","hover:bg-zinc-700"),o.classList.add("active")),re[e]&&typeof re[e].render=="function"&&re[e].render(i||t),typeof re[e].cleanup=="function"&&(st=re[e].cleanup),i&&window.scrollTo(0,0)}else e!=="dashboard"&&e!=="faucet"&&(console.warn(`Route '${e}' not found, redirecting to dashboard.`),Ct("dashboard",!0))}window.navigateTo=Ct;const Xn="wallet-btn text-xs font-mono text-center max-w-fit whitespace-nowrap relative font-bold py-2 px-4 rounded-md transition-colors";function cn(e=!1){ks||(ks=!0,requestAnimationFrame(()=>{vd(e),ks=!1}))}function vd(e){const t=document.getElementById("admin-link-container"),s=document.getElementById("statUserBalance"),n=document.getElementById("connectButtonDesktop"),a=document.getElementById("connectButtonMobile"),i=document.getElementById("mobileAppDisplay");let o=c.userAddress;const r=[n,a];if(c.isConnected&&o){const d=xd(c.currentUserBalance),f=`
            <div class="status-dot"></div>
            <span>${ei(o)}</span>
            <div class="balance-pill">
                ${d} BKC
            </div>
        `;r.forEach(p=>{p&&(p.innerHTML=f,p.className=Xn+" wallet-btn-connected")}),i&&(i.textContent="Backcoin.org",i.classList.add("text-amber-400"),i.classList.remove("text-white")),s&&(s.textContent=B(c.currentUserBalance).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})),t&&(t.style.display=o.toLowerCase()===ln.toLowerCase()?"block":"none")}else{const d='<i class="fa-solid fa-plug"></i> Connect Wallet';r.forEach(u=>{u&&(u.innerHTML=d,u.className=Xn+" wallet-btn-disconnected")}),i&&(i.textContent="Backcoin.org",i.classList.add("text-amber-400"),i.classList.remove("text-white")),t&&(t.style.display="none"),s&&(s.textContent="--")}const l=dt||"dashboard";e||!dt?Ct(l,!0):re[l]&&typeof re[l].update=="function"&&re[l].update(c.isConnected)}function hd(e){const{isConnected:t,address:s,isNewConnection:n,wasConnected:a}=e,i=n||t!==a;c.isConnected=t,s&&(c.userAddress=s),cn(i),t&&n?b(`Connected: ${ei(s)}`,"success"):!t&&a&&b("Wallet disconnected.","info")}function wd(){const e=document.getElementById("testnet-banner"),t=document.getElementById("close-testnet-banner");if(!(!e||!t)){if(localStorage.getItem("hideTestnetBanner")==="true"){e.remove();return}e.style.transform="translateY(0)",t.addEventListener("click",()=>{e.style.transform="translateY(100%)",setTimeout(()=>e.remove(),500),localStorage.setItem("hideTestnetBanner","true")})}}function yd(){const e=document.querySelectorAll(".sidebar-link"),t=document.getElementById("menu-btn"),s=document.getElementById("sidebar"),n=document.getElementById("sidebar-backdrop"),a=document.getElementById("connectButtonDesktop"),i=document.getElementById("connectButtonMobile"),o=document.getElementById("shareProjectBtn");wd(),e.length>0&&e.forEach(l=>{l.addEventListener("click",async d=>{d.preventDefault();const u=l.dataset.target;if(u==="faucet"){b("Accessing Testnet Faucet...","info"),await So("BKC")&&cn(!0);return}u&&(Ct(u,!1),s&&s.classList.contains("translate-x-0")&&(s.classList.remove("translate-x-0"),s.classList.add("-translate-x-full"),n&&n.classList.add("hidden")))})});const r=()=>{ga()};a&&a.addEventListener("click",r),i&&i.addEventListener("click",r),o&&o.addEventListener("click",()=>mi(c.userAddress)),t&&s&&n&&(t.addEventListener("click",()=>{s.classList.contains("translate-x-0")?(s.classList.add("-translate-x-full"),s.classList.remove("translate-x-0"),n.classList.add("hidden")):(s.classList.remove("-translate-x-full"),s.classList.add("translate-x-0"),n.classList.remove("hidden"))}),n.addEventListener("click",()=>{s.classList.add("-translate-x-full"),s.classList.remove("translate-x-0"),n.classList.add("hidden")}))}window.addEventListener("load",async()=>{console.log("🚀 App Initializing..."),ie.earn||(ie.earn=document.getElementById("mine"));try{if(!await yi())throw new Error("Failed to load contract addresses")}catch(t){console.error("❌ Critical Initialization Error:",t),b("Initialization failed. Please refresh.","error");return}yd(),await co(),uo(hd),bi();const e=document.getElementById("preloader");e&&(e.style.display="none"),Ct("dashboard",!0),console.log("✅ App Ready.")});window.EarnPage=Ea;window.openConnectModal=ga;window.disconnectWallet=po;window.updateUIState=cn;
