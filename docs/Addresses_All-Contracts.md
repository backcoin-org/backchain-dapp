...
Todos os contratos do Backcoin estao deployados na Arbitrum Sepolia (Chain ID: 421614).

Cada contrato listado abaixo (exceto o Faucet) e totalmente imutavel — nenhum admin pode pausar, fazer upgrade ou modificar. O unico contrato configuravel e o BackchainEcosystem, que controla parametros de taxas e esta sujeito a descentralizacao progressiva pela governanca.

---

## Contratos Core

| Contrato | Endereco | Suporte a Operador |
|----------|---------|:------------------:|
...
Contratos marcados com "Sim" na coluna de Suporte a Operador aceitam parametro "operator". Quando usuarios interagem pelo seu frontend, passe seu endereco de carteira como operador pra ganhar comissao em cada transacao.

Leia o [Guia do Operador](./Operators_Build-and-Earn.md) pra aprender como construir e ganhar.
...
Compilador: Solidity 0.8.28 | Otimizador: runs=1, viaIR=true
